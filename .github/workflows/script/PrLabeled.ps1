...
"@
    "codegen-survey" = @"
Thanks for using autorest.powershell to develop your PowerShell module! Would you like to take [a ?-minute (or ?-question) survey](?) to help us improve the tool? Much appreciated :)
"@
}
