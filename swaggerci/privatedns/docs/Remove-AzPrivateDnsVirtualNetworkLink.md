...
### Delete (Default)
```
Remove-AzPrivateDnsVirtualNetworkLink -Name <String> -PrivateZoneName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzPrivateDnsVirtualNetworkLink -InputObject <IPrivateDnsIdentity> [-IfMatch <String>]
