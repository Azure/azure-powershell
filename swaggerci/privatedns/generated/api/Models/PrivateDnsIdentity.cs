...
namespace Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Models.IPrivateDnsIdentityInternal
    {
        ...
        /// <summary>Creates an new <see cref="PrivateDnsIdentity" /> instance.</summary>
        public PrivateDnsIdentity()
        {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string PrivateZoneName { get; set; }
        /// <summary>
        /// The type of DNS record in this record set. Record sets of type SOA can be updated but not created (they are created when
        /// the Private DNS zone is created).
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Support.RecordType? RecordType { get; set; }
        /// <summary>The name of the record set, relative to the name of the zone.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    internal partial interface IPrivateDnsIdentityInternal
