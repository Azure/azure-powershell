...
namespace Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Network/privateDnsZones"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPrivateDnsPrivateZone_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Description(@"Lists the Private DNS zones in all resource groups in a subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Generated]
    public partial class GetAzPrivateDnsPrivateZone_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The maximum number of Private DNS zones to return. If not specified, returns up to 100 zones.")]
        [Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzPrivateDnsPrivateZone_List" /> cmdlet class.
        /// </summary>
        public GetAzPrivateDnsPrivateZone_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.PrivateZonesList(this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.PrivateZonesList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
