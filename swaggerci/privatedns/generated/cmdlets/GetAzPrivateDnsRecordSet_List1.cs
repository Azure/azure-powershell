...
namespace Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/ALL"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPrivateDnsRecordSet_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Description(@"Lists all record sets in a Private DNS zone.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Generated]
    public partial class GetAzPrivateDnsRecordSet_List1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="Recordsetnamesuffix" /> property.</summary>
        private string _recordsetnamesuffix;

        /// <summary>
        /// The suffix label of the record set name to be used to filter the record set enumeration. If this parameter is specified,
        /// the returned enumeration will only contain records that end with ".<recordsetnamesuffix>".
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The suffix label of the record set name to be used to filter the record set enumeration. If this parameter is specified, the returned enumeration will only contain records that end with \".<recordsetnamesuffix>\".")]
        [Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string Recordsetnamesuffix { get => this._recordsetnamesuffix; set => this._recordsetnamesuffix = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Models.Api20200601.IRecordSetListResult"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Models.Api20200601.IRecordSetListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzPrivateDnsRecordSet_List1" /> cmdlet class.
        /// </summary>
        public GetAzPrivateDnsRecordSet_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.RecordSetsList(ResourceGroupName, PrivateZoneName, this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Recordsetnamesuffix") ? Recordsetnamesuffix : null, SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,PrivateZoneName=PrivateZoneName,Top=this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?),Recordsetnamesuffix=this.InvocationInformation.BoundParameters.ContainsKey("Recordsetnamesuffix") ? Recordsetnamesuffix : null,SubscriptionId=SubscriptionId})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Models.Api20200601.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, PrivateZoneName=PrivateZoneName, Top=this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), Recordsetnamesuffix=this.InvocationInformation.BoundParameters.ContainsKey("Recordsetnamesuffix") ? Recordsetnamesuffix : null, SubscriptionId=SubscriptionId })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, PrivateZoneName=PrivateZoneName, Top=this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), Recordsetnamesuffix=this.InvocationInformation.BoundParameters.ContainsKey("Recordsetnamesuffix") ? Recordsetnamesuffix : null, SubscriptionId=SubscriptionId })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Models.Api20200601.IRecordSetListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.RecordSetsList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
