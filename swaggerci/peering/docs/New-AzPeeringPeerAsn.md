...
online version: https://docs.microsoft.com/en-us/powershell/module/az.peering/new-azpeeringpeerasn
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.IContactDetail[]
Parameter Sets: (All)
Aliases:
