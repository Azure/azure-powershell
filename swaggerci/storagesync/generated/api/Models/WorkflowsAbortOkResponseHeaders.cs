...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models
{
    ...
    public partial class WorkflowsAbortOkResponseHeaders :
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.IWorkflowsAbortOkResponseHeaders,
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.IWorkflowsAbortOkResponseHeadersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IHeaderSerializable
    {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.IWorkflowsAbortOkResponseHeadersInternal)this).XmsRequestId = System.Linq.Enumerable.FirstOrDefault(__xMSRequestIdHeader0) is string __headerXMSRequestIdHeader0 ? __headerXMSRequestIdHeader0 : (string)null;
            }
            if (headers.TryGetValues("x-ms-correlation-request-id", out var __xMSCorrelationRequestIdHeader1))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.IWorkflowsAbortOkResponseHeadersInternal)this).XmsCorrelationRequestId = System.Linq.Enumerable.FirstOrDefault(__xMSCorrelationRequestIdHeader1) is string __headerXMSCorrelationRequestIdHeader1 ? __headerXMSCorrelationRequestIdHeader1 : (string)null;
            }
        }

        /// <summary>Creates an new <see cref="WorkflowsAbortOkResponseHeaders" /> instance.</summary>
        public WorkflowsAbortOkResponseHeaders()
        {
    ...
    internal partial interface IWorkflowsAbortOkResponseHeadersInternal
