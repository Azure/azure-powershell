...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models
{
    ...
    public partial class RegisteredServersTriggerRolloverOkResponseHeaders :
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.IRegisteredServersTriggerRolloverOkResponseHeaders,
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.IRegisteredServersTriggerRolloverOkResponseHeadersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IHeaderSerializable
    {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.IRegisteredServersTriggerRolloverOkResponseHeadersInternal)this).XmsRequestId = System.Linq.Enumerable.FirstOrDefault(__xMSRequestIdHeader0) is string __headerXMSRequestIdHeader0 ? __headerXMSRequestIdHeader0 : (string)null;
            }
            if (headers.TryGetValues("x-ms-correlation-request-id", out var __xMSCorrelationRequestIdHeader1))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.IRegisteredServersTriggerRolloverOkResponseHeadersInternal)this).XmsCorrelationRequestId = System.Linq.Enumerable.FirstOrDefault(__xMSCorrelationRequestIdHeader1) is string __headerXMSCorrelationRequestIdHeader1 ? __headerXMSCorrelationRequestIdHeader1 : (string)null;
            }
        }

        /// <summary>
        /// Creates an new <see cref="RegisteredServersTriggerRolloverOkResponseHeaders" /> instance.
        /// </summary>
        public RegisteredServersTriggerRolloverOkResponseHeaders()
        {

        }
    }
    public partial interface IRegisteredServersTriggerRolloverOkResponseHeaders
    ...
    internal partial interface IRegisteredServersTriggerRolloverOkResponseHeadersInternal
