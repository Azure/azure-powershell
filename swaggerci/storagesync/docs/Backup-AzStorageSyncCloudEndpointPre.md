...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storagesync/backup-azstoragesynccloudendpointpre
schema: 2.0.0
---

# Backup-AzStorageSyncCloudEndpointPre
...
```
Backup-AzStorageSyncCloudEndpointPre -CloudEndpointName <String> -ResourceGroupName <String>
 -StorageSyncServiceName <String> -SyncGroupName <String> [-SubscriptionId <String>]
 [-AzureFileShare <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Backup-AzStorageSyncCloudEndpointPre -CloudEndpointName <String> -ResourceGroupName <String>
 -StorageSyncServiceName <String> -SyncGroupName <String> -Parameter <IBackupRequest>
...
### BackupViaIdentity
```
Backup-AzStorageSyncCloudEndpointPre -InputObject <IStorageSyncIdentity> -Parameter <IBackupRequest>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### BackupViaIdentityExpanded
```
Backup-AzStorageSyncCloudEndpointPre -InputObject <IStorageSyncIdentity> [-AzureFileShare <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20200901.IBackupRequest
