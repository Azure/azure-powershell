...
```
New-AzStorageSyncGroup -Name <String> -ResourceGroupName <String> -StorageSyncServiceName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.IAny
Parameter Sets: (All)
Aliases:
