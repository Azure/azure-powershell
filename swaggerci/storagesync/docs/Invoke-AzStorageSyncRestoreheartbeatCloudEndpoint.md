...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storagesync/invoke-azstoragesyncrestoreheartbeatcloudendpoint
schema: 2.0.0
---

# Invoke-AzStorageSyncRestoreheartbeatCloudEndpoint
...
### Restoreheartbeat (Default)
```
Invoke-AzStorageSyncRestoreheartbeatCloudEndpoint -CloudEndpointName <String> -ResourceGroupName <String>
 -StorageSyncServiceName <String> -SyncGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestoreheartbeatViaIdentity
```
Invoke-AzStorageSyncRestoreheartbeatCloudEndpoint -InputObject <IStorageSyncIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Restoreheartbeat
Aliases:
...
Parameter Sets: RestoreheartbeatViaIdentity
Aliases:
