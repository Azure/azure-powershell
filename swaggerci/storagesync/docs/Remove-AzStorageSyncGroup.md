...
### Delete (Default)
```
Remove-AzStorageSyncGroup -Name <String> -ResourceGroupName <String> -StorageSyncServiceName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzStorageSyncGroup -InputObject <IStorageSyncIdentity> [-DefaultProfile <PSObject>] [-PassThru]
