...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.sqlvirtualmachine/get-azsqlvirtualmachinesqlvirtualmachinegroup
#>
function Get-AzSqlVirtualMachineSqlVirtualMachineGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.SqlVirtualMachine.private\Get-AzSqlVirtualMachineSqlVirtualMachineGroup_Get';
            GetViaIdentity = 'Az.SqlVirtualMachine.private\Get-AzSqlVirtualMachineSqlVirtualMachineGroup_GetViaIdentity';
            List = 'Az.SqlVirtualMachine.private\Get-AzSqlVirtualMachineSqlVirtualMachineGroup_List';
            List1 = 'Az.SqlVirtualMachine.private\Get-AzSqlVirtualMachineSqlVirtualMachineGroup_List1';
        }
