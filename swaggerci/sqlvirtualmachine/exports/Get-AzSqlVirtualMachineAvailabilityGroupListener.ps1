...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.sqlvirtualmachine/get-azsqlvirtualmachineavailabilitygrouplistener
#>
function Get-AzSqlVirtualMachineAvailabilityGroupListener {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20211101Preview.IAvailabilityGroupListener])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.SqlVirtualMachine.private\Get-AzSqlVirtualMachineAvailabilityGroupListener_Get';
            GetViaIdentity = 'Az.SqlVirtualMachine.private\Get-AzSqlVirtualMachineAvailabilityGroupListener_GetViaIdentity';
            List = 'Az.SqlVirtualMachine.private\Get-AzSqlVirtualMachineAvailabilityGroupListener_List';
        }
