...
online version: https://docs.microsoft.com/en-us/powershell/module/az.sqlvirtualmachine/update-azsqlvirtualmachinesqlvirtualmachinegroup
schema: 2.0.0
---

# Update-AzSqlVirtualMachineSqlVirtualMachineGroup
...
```
Update-AzSqlVirtualMachineSqlVirtualMachineGroup -Name <String> -ResourceGroupName <String>
...
```
Update-AzSqlVirtualMachineSqlVirtualMachineGroup -InputObject <ISqlVirtualMachineIdentity> [-Tag <Hashtable>]
