...
online version: https://docs.microsoft.com/en-us/powershell/module/az.sqlvirtualmachine/remove-azsqlvirtualmachinesqlvirtualmachinegroup
schema: 2.0.0
---

# Remove-AzSqlVirtualMachineSqlVirtualMachineGroup
...
### Delete (Default)
```
Remove-AzSqlVirtualMachineSqlVirtualMachineGroup -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzSqlVirtualMachineSqlVirtualMachineGroup -InputObject <ISqlVirtualMachineIdentity>
