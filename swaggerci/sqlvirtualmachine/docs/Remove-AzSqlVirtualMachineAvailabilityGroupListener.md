...
online version: https://docs.microsoft.com/en-us/powershell/module/az.sqlvirtualmachine/remove-azsqlvirtualmachineavailabilitygrouplistener
schema: 2.0.0
---

# Remove-AzSqlVirtualMachineAvailabilityGroupListener
...
### Delete (Default)
```
Remove-AzSqlVirtualMachineAvailabilityGroupListener -Name <String> -ResourceGroupName <String>
 -SqlVirtualMachineGroupName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzSqlVirtualMachineAvailabilityGroupListener -InputObject <ISqlVirtualMachineIdentity>
