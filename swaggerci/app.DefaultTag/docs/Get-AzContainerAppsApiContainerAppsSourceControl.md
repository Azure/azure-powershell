...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapicontainerappssourcecontrol
schema: 2.0.0
---

# Get-AzContainerAppsApiContainerAppsSourceControl
...
### Get (Default)
```
Get-AzContainerAppsApiContainerAppsSourceControl -ContainerAppName <String> -ResourceGroupName <String>
 -SourceControlName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzContainerAppsApiContainerAppsSourceControl -InputObject <IContainerAppsApiIdentity>
