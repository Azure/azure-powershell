...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/remove-azcontainerappsapiconnectedenvironmentsstorage
schema: 2.0.0
---

# Remove-AzContainerAppsApiConnectedEnvironmentsStorage
...
### Delete (Default)
```
Remove-AzContainerAppsApiConnectedEnvironmentsStorage -ConnectedEnvironmentName <String>
...
### DeleteViaIdentity
```
Remove-AzContainerAppsApiConnectedEnvironmentsStorage -InputObject <IContainerAppsApiIdentity>
