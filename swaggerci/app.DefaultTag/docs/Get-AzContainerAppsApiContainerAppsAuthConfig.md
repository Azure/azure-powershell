...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapicontainerappsauthconfig
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzContainerAppsApiContainerAppsAuthConfig -AuthConfigName <String> -ContainerAppName <String>
