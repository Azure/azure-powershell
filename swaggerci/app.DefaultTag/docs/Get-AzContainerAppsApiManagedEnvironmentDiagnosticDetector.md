...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapimanagedenvironmentdiagnosticdetector
schema: 2.0.0
---

# Get-AzContainerAppsApiManagedEnvironmentDiagnosticDetector
...
### List (Default)
```
Get-AzContainerAppsApiManagedEnvironmentDiagnosticDetector -EnvironmentName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzContainerAppsApiManagedEnvironmentDiagnosticDetector -DetectorName <String> -EnvironmentName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzContainerAppsApiManagedEnvironmentDiagnosticDetector -InputObject <IContainerAppsApiIdentity>
