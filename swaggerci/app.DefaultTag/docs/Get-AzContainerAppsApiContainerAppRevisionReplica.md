...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapicontainerapprevisionreplica
schema: 2.0.0
---
...
### Get
```
Get-AzContainerAppsApiContainerAppRevisionReplica -ContainerAppName <String> -ReplicaName <String>
