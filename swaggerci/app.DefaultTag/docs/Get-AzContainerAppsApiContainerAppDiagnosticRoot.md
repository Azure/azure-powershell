...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapicontainerappdiagnosticroot
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzContainerAppsApiContainerAppDiagnosticRoot -ContainerAppName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzContainerAppsApiContainerAppDiagnosticRoot -InputObject <IContainerAppsApiIdentity>
