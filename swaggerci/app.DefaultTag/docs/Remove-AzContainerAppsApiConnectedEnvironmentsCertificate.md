...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/remove-azcontainerappsapiconnectedenvironmentscertificate
schema: 2.0.0
---

# Remove-AzContainerAppsApiConnectedEnvironmentsCertificate
...
### Delete (Default)
```
Remove-AzContainerAppsApiConnectedEnvironmentsCertificate -CertificateName <String>
...
### DeleteViaIdentity
```
Remove-AzContainerAppsApiConnectedEnvironmentsCertificate -InputObject <IContainerAppsApiIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
