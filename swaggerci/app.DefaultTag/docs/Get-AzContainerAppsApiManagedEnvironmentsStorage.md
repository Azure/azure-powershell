...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapimanagedenvironmentsstorage
schema: 2.0.0
---

# Get-AzContainerAppsApiManagedEnvironmentsStorage
...
### List (Default)
```
Get-AzContainerAppsApiManagedEnvironmentsStorage -EnvironmentName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzContainerAppsApiManagedEnvironmentsStorage -InputObject <IContainerAppsApiIdentity>
