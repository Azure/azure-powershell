...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapiconnectedenvironmentsdaprcomponent
schema: 2.0.0
---

# Get-AzContainerAppsApiConnectedEnvironmentsDaprComponent
...
### List (Default)
```
Get-AzContainerAppsApiConnectedEnvironmentsDaprComponent -ConnectedEnvironmentName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzContainerAppsApiConnectedEnvironmentsDaprComponent -ComponentName <String>
...
### GetViaIdentity
```
Get-AzContainerAppsApiConnectedEnvironmentsDaprComponent -InputObject <IContainerAppsApiIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
