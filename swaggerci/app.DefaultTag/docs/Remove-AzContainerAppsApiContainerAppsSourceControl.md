...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/remove-azcontainerappsapicontainerappssourcecontrol
schema: 2.0.0
---

# Remove-AzContainerAppsApiContainerAppsSourceControl
...
### Delete (Default)
```
Remove-AzContainerAppsApiContainerAppsSourceControl -ContainerAppName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzContainerAppsApiContainerAppsSourceControl -InputObject <IContainerAppsApiIdentity>
