...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/test-azcontainerappsapiconnectedenvironmentnameavailability
schema: 2.0.0
---

# Test-AzContainerAppsApiConnectedEnvironmentNameAvailability
...
```
Test-AzContainerAppsApiConnectedEnvironmentNameAvailability -ConnectedEnvironmentName <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-Name <String>] [-Type <String>]
...
```
Test-AzContainerAppsApiConnectedEnvironmentNameAvailability -ConnectedEnvironmentName <String>
 -ResourceGroupName <String> -CheckNameAvailabilityRequest <ICheckNameAvailabilityRequest>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentity
```
Test-AzContainerAppsApiConnectedEnvironmentNameAvailability -InputObject <IContainerAppsApiIdentity>
