...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/remove-azcontainerappsapidaprcomponent
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzContainerAppsApiDaprComponent -ComponentName <String> -EnvironmentName <String>
...
### DeleteViaIdentity
```
Remove-AzContainerAppsApiDaprComponent -InputObject <IContainerAppsApiIdentity> [-DefaultProfile <PSObject>]
