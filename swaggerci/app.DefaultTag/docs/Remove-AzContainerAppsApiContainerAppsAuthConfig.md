...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/remove-azcontainerappsapicontainerappsauthconfig
schema: 2.0.0
---

# Remove-AzContainerAppsApiContainerAppsAuthConfig
...
### Delete (Default)
```
Remove-AzContainerAppsApiContainerAppsAuthConfig -AuthConfigName <String> -ContainerAppName <String>
...
### DeleteViaIdentity
```
Remove-AzContainerAppsApiContainerAppsAuthConfig -InputObject <IContainerAppsApiIdentity>
