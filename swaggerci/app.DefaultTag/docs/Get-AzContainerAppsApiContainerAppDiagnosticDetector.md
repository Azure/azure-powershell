...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapicontainerappdiagnosticdetector
schema: 2.0.0
---

# Get-AzContainerAppsApiContainerAppDiagnosticDetector
...
### List (Default)
```
Get-AzContainerAppsApiContainerAppDiagnosticDetector -ContainerAppName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzContainerAppsApiContainerAppDiagnosticDetector -ContainerAppName <String> -DetectorName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzContainerAppsApiContainerAppDiagnosticDetector -InputObject <IContainerAppsApiIdentity>
