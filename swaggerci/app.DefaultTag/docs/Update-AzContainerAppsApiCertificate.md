...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/update-azcontainerappsapicertificate
schema: 2.0.0
---
...
```
Update-AzContainerAppsApiCertificate -EnvironmentName <String> -Name <String> -ResourceGroupName <String>
