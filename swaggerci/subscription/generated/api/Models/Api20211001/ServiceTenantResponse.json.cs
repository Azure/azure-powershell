...
namespace Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001
{
    ...
    public partial class ServiceTenantResponse
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001.IServiceTenantResponse.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001.IServiceTenantResponse.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001.IServiceTenantResponse FromJson(Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonObject json ? new ServiceTenantResponse(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonObject into a new instance of <see cref="ServiceTenantResponse" />.
        /// </summary>
        ...
        internal ServiceTenantResponse(Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonObject json)
        {
            ...
            {_tenantName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonString>("tenantName"), out var __jsonTenantName) ? (string)__jsonTenantName : (string)TenantName;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="ServiceTenantResponse" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ServiceTenantResponse" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._tenantName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonString(this._tenantName.ToString()) : null, "tenantName" ,container.Add );
