...
online version: https://docs.microsoft.com/en-us/powershell/module/az.datalakeanalyticsaccount/remove-azdatalakeanalyticsaccountdatalakestoreaccount
schema: 2.0.0
---

# Remove-AzDataLakeAnalyticsAccountDataLakeStoreAccount
...
### Delete (Default)
```
Remove-AzDataLakeAnalyticsAccountDataLakeStoreAccount -AccountName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzDataLakeAnalyticsAccountDataLakeStoreAccount -InputObject <IDataLakeAnalyticsAccountIdentity>
