...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Models.Api20191101Preview
{
    ...
    public partial class SasTokenInformation
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Models.Api20191101Preview.ISasTokenInformation.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Models.Api20191101Preview.ISasTokenInformation.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Models.Api20191101Preview.ISasTokenInformation FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Runtime.Json.JsonObject json ? new SasTokenInformation(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Runtime.Json.JsonObject into a new instance of <see cref="SasTokenInformation" />.
        /// </summary>
        ...
        internal SasTokenInformation(Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Runtime.Json.JsonObject json)
        {
            ...
            {_accessToken = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Runtime.Json.JsonString>("accessToken"), out var __jsonAccessToken) ? (string)__jsonAccessToken : (string)AccessToken;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SasTokenInformation" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SasTokenInformation" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != (((object)this._accessToken)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Runtime.Json.JsonString(this._accessToken.ToString()) : null, "accessToken" ,container.Add );
            }
