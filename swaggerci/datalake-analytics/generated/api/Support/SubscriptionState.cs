...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Support.SubscriptionState Deleted = @"Deleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Support.SubscriptionState Registered = @"Registered";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Support.SubscriptionState Suspended = @"Suspended";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Support.SubscriptionState Unregistered = @"Unregistered";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Support.SubscriptionState Warned = @"Warned";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Support.SubscriptionState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Support.SubscriptionState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Support.SubscriptionState e1, Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Support.SubscriptionState e2)
        {
            return !e2.Equals(e1);
        }
