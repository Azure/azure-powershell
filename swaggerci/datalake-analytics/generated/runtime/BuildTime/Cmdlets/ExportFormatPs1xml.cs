...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Support";
