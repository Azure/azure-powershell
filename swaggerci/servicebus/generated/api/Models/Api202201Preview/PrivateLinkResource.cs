...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview
{
    ...
    public partial class PrivateLinkResource :
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IPrivateLinkResource,
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IPrivateLinkResourceInternal
    {
        ...
        public string GroupId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IPrivateLinkResourcePropertiesInternal)Property).GroupId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IPrivateLinkResourcePropertiesInternal)Property).GroupId = value ?? null; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IPrivateLinkResourceProperties _property;

        /// <summary>Properties of the private link resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IPrivateLinkResourceProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.PrivateLinkResourceProperties()); set => this._property = value; }
...

    {
        ...
        string Name { get; set; }
        /// <summary>Properties of the private link resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IPrivateLinkResourceProperties Property { get; set; }
        /// <summary>Required Members</summary>
        string[] RequiredMember { get; set; }
        /// <summary>Required Zone Names</summary>
        string[] RequiredZoneName { get; set; }
