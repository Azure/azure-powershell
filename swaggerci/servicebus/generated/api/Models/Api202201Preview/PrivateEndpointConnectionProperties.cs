...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview
{
    ...
    public partial class PrivateEndpointConnectionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IPrivateEndpointConnectionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IPrivateEndpointConnectionPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IPrivateEndpoint _privateEndpoint;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IPrivateEndpoint PrivateEndpoint { get => (this._privateEndpoint = this._privateEndpoint ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.PrivateEndpoint()); set => this._privateEndpoint = value; }
        ...
        public string PrivateEndpointId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IPrivateEndpointInternal)PrivateEndpoint).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IPrivateEndpointInternal)PrivateEndpoint).Id = value ?? null; }

        /// <summary>Backing field for <see cref="PrivateLinkServiceConnectionState" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IConnectionState _privateLinkServiceConnectionState;
    ...
    {
        /// <summary>The Private Endpoint resource for this Connection.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IPrivateEndpoint PrivateEndpoint { get; set; }
        /// <summary>The ARM identifier for Private Endpoint.</summary>
        string PrivateEndpointId { get; set; }
        /// <summary>Details about the state of the connection.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IConnectionState PrivateLinkServiceConnectionState { get; set; }
        /// <summary>Description of the connection state.</summary>
        string PrivateLinkServiceConnectionStateDescription { get; set; }
        /// <summary>Status of the connection.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Support.PrivateLinkConnectionStatus? PrivateLinkServiceConnectionStateStatus { get; set; }
