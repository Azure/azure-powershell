...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview
{
    ...
    public partial class FailoverProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IFailoverPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IFailoverPropertiesAutoGenerated _property;

        /// <summary>
        /// Safe failover is to indicate the service should wait for pending replication to finish before switching to the secondary.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IFailoverPropertiesAutoGenerated Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.FailoverPropertiesAutoGenerated()); set => this._property = value; }
...

    {
        ...
        /// Safe failover is to indicate the service should wait for pending replication to finish before switching to the secondary.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IFailoverPropertiesAutoGenerated Property { get; set; }
