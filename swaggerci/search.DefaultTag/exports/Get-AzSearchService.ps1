...
.Link
https://learn.microsoft.com/powershell/module/az.search/get-azsearchservice
#>
function Get-AzSearchService {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.ISearchService])]
