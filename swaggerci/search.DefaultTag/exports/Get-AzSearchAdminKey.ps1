...
.Link
https://learn.microsoft.com/powershell/module/az.search/get-azsearchadminkey
#>
function Get-AzSearchAdminKey {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IAdminKeyResult])]
