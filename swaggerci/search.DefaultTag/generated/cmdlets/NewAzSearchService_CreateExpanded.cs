...
namespace Microsoft.Azure.PowerShell.Cmdlets.Search.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices/{searchServiceName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzSearchService_CreateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Search.Description(@"Creates or updates a search service in the given resource group. If the search service already exists, all properties will be updated with the given values.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Search.Generated]
    public partial class NewAzSearchService_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.ISearchService _serviceBody = new Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.SearchService();
        ...
        /// <summary>
        /// The name of the Azure Cognitive Search service to create or update. Search service names must only contain lowercase letters,
        /// digits or dashes, cannot use dash as the first two or last one characters, cannot contain consecutive dashes, and must
        /// be between 2 and 60 characters in length. Search service names must be globally unique since they are part of the service
        /// URI (https://<name>.search.windows.net). You cannot change the service name after the service is created.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the Azure Cognitive Search service to create or update. Search service names must only contain lowercase letters, digits or dashes, cannot use dash as the first two or last one characters, cannot contain consecutive dashes, and must be between 2 and 60 characters in length. Search service names must be globally unique since they are part of the service URI (https://<name>.search.windows.net). You cannot change the service name after the service is created.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20.ITrackedResourceTags) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20.ITrackedResourceTags Tag { get => _serviceBody.Tag ?? null /* object */; set => _serviceBody.Tag = value; }
        ...
        /// <returns>a duplicate instance of NewAzSearchService_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Search.Cmdlets.NewAzSearchService_CreateExpanded Clone()
        {
            var clone = new NewAzSearchService_CreateExpanded();
            ...
            clone._serviceBody = this._serviceBody;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzSearchService_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzSearchService_CreateExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ServicesCreateOrUpdate(ResourceGroupName, SearchServiceName, this.InvocationInformation.BoundParameters.ContainsKey("ClientRequestId") ? ClientRequestId : null, SubscriptionId, _serviceBody, onOk, onDefault, this, Pipeline);
