...
namespace Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901
{
    ...
    public partial class Operation :
        Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IOperation,
        Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IOperationInternal
    {

        /// <summary>Backing field for <see cref="Display" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IOperationDisplay _display;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IOperationDisplay Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.OperationDisplay()); }
        ...
        public string DisplayDescription { get => ((Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IOperationDisplayInternal)Display).Description; }

        /// <summary>The operation type: read, write, delete, listKeys/action, etc.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Search.Origin(Microsoft.Azure.PowerShell.Cmdlets.Search.PropertyOrigin.Inlined)]
        public string DisplayOperation { get => ((Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IOperationDisplayInternal)Display).Operation; }

        /// <summary>The friendly name of the resource provider.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Search.Origin(Microsoft.Azure.PowerShell.Cmdlets.Search.PropertyOrigin.Inlined)]
        public string DisplayProvider { get => ((Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IOperationDisplayInternal)Display).Provider; }

        /// <summary>The resource type on which the operation is performed.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Search.Origin(Microsoft.Azure.PowerShell.Cmdlets.Search.PropertyOrigin.Inlined)]
        public string DisplayResource { get => ((Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IOperationDisplayInternal)Display).Resource; }

        /// <summary>Internal Acessors for Display</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IOperationDisplay Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IOperationInternal.Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.OperationDisplay()); set { {_display = value;} } }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IOperationInternal.Name { get => this._name; set { {_name = value;} } }
    ...
    {
        /// <summary>The object that describes the operation.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IOperationDisplay Display { get; set; }
        /// <summary>The friendly name of the operation.</summary>
