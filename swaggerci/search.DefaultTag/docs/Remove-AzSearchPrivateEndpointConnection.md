...
### Delete (Default)
```
Remove-AzSearchPrivateEndpointConnection -Name <String> -ResourceGroupName <String>
 -SearchServiceName <String> [-SubscriptionId <String>] [-ClientRequestId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzSearchPrivateEndpointConnection -InputObject <ISearchIdentity> [-ClientRequestId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
