...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridnetwork/stop-azhybridnetworkroleinstance
schema: 2.0.0
---

# Stop-AzHybridNetworkRoleInstance
...
### Stop (Default)
```
Stop-AzHybridNetworkRoleInstance -LocationName <String> -Name <String> -ServiceKey <String>
...
### StopViaIdentity
```
Stop-AzHybridNetworkRoleInstance -InputObject <IHybridNetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob]
