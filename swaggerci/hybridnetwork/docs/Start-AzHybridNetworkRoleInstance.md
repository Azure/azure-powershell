...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridnetwork/start-azhybridnetworkroleinstance
schema: 2.0.0
---

# Start-AzHybridNetworkRoleInstance
...
### Start (Default)
```
Start-AzHybridNetworkRoleInstance -LocationName <String> -Name <String> -ServiceKey <String>
...
### StartViaIdentity
```
Start-AzHybridNetworkRoleInstance -InputObject <IHybridNetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob]
