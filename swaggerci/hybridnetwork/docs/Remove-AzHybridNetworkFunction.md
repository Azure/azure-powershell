...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridnetwork/remove-azhybridnetworkfunction
schema: 2.0.0
---

# Remove-AzHybridNetworkFunction
...
### Delete (Default)
```
Remove-AzHybridNetworkFunction -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzHybridNetworkFunction -InputObject <IHybridNetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob]
