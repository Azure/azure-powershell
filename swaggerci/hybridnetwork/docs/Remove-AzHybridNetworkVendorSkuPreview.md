...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridnetwork/remove-azhybridnetworkvendorskupreview
schema: 2.0.0
---

# Remove-AzHybridNetworkVendorSkuPreview
...
### Delete (Default)
```
Remove-AzHybridNetworkVendorSkuPreview -PreviewSubscription <String> -SkuName <String> -VendorName <String>
...
### DeleteViaIdentity
```
Remove-AzHybridNetworkVendorSkuPreview -InputObject <IHybridNetworkIdentity> [-DefaultProfile <PSObject>]
