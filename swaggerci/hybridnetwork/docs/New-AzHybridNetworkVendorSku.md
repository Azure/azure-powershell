...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridnetwork/new-azhybridnetworkvendorsku
schema: 2.0.0
---

# New-AzHybridNetworkVendorSku
...
```
New-AzHybridNetworkVendorSku -SkuName <String> -VendorName <String> [-SubscriptionId <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.SkuDeploymentMode
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.INetworkFunctionRoleConfiguration[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.NetworkFunctionType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.SkuType
Parameter Sets: (All)
Aliases:
