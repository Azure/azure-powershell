...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridnetwork/remove-azhybridnetworkvendorsku
schema: 2.0.0
---

# Remove-AzHybridNetworkVendorSku
...
### Delete (Default)
```
Remove-AzHybridNetworkVendorSku -SkuName <String> -VendorName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzHybridNetworkVendorSku -InputObject <IHybridNetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob]
