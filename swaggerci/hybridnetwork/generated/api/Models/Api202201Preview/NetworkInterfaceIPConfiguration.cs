...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview
{
    ...
    public partial class NetworkInterfaceIPConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.INetworkInterfaceIPConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.INetworkInterfaceIPConfigurationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.IPAllocationMethod? _iPAllocationMethod;

        /// <summary>IP address allocation method.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Origin(Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.IPAllocationMethod? IPAllocationMethod { get => this._iPAllocationMethod; set => this._iPAllocationMethod = value; }

        /// <summary>Backing field for <see cref="IPVersion" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.IPVersion? _iPVersion;

        /// <summary>IP address version.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Origin(Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.IPVersion? IPVersion { get => this._iPVersion; set => this._iPVersion = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.IPAllocationMethod) })]
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.IPAllocationMethod? IPAllocationMethod { get; set; }
        /// <summary>IP address version.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.IPVersion) })]
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.IPVersion? IPVersion { get; set; }
        /// <summary>The value of the subnet.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Runtime.Info(
        Required = false,
        ReadOnly = false,
