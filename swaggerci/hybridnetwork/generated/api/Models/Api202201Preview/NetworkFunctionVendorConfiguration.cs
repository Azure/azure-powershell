...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview
{
    ...
    public partial class NetworkFunctionVendorConfiguration :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.INetworkFunctionVendorConfigurationInternal
    {

        /// <summary>Internal Acessors for LinuxConfigurationSsh</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.ISshConfiguration Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.INetworkFunctionVendorConfigurationInternal.LinuxConfigurationSsh { get => ((Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IOSProfileInternal)OSProfile).LinuxConfigurationSsh; set => ((Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IOSProfileInternal)OSProfile).LinuxConfigurationSsh = value; }

        /// <summary>Internal Acessors for OSProfile</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IOSProfile Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.INetworkFunctionVendorConfigurationInternal.OSProfile { get => (this._oSProfile = this._oSProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.OSProfile()); set { {_oSProfile = value;} } }

        /// <summary>Internal Acessors for OSProfileLinuxConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.ILinuxConfiguration Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.INetworkFunctionVendorConfigurationInternal.OSProfileLinuxConfiguration { get => ((Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IOSProfileInternal)OSProfile).LinuxConfiguration; set => ((Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IOSProfileInternal)OSProfile).LinuxConfiguration = value; }

        /// <summary>Internal Acessors for UserDataParameter</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.IAny Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.INetworkFunctionVendorConfigurationInternal.UserDataParameter { get => (this._userDataParameter = this._userDataParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Any()); set { {_userDataParameter = value;} } }

        /// <summary>Backing field for <see cref="NetworkInterface" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.INetworkInterface[] _networkInterface;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.INetworkInterface[] NetworkInterface { get => this._networkInterface; set => this._networkInterface = value; }

        /// <summary>Backing field for <see cref="OSProfile" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IOSProfile _oSProfile;

        /// <summary>Specifies the operating system settings for the role instance.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Origin(Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IOSProfile OSProfile { get => (this._oSProfile = this._oSProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.OSProfile()); set => this._oSProfile = value; }
        ...
        public string OSProfileAdminUsername { get => ((Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IOSProfileInternal)OSProfile).AdminUsername; set => ((Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IOSProfileInternal)OSProfile).AdminUsername = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Origin(Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.PropertyOrigin.Inlined)]
        public string OSProfileCustomData { get => ((Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IOSProfileInternal)OSProfile).CustomData; set => ((Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IOSProfileInternal)OSProfile).CustomData = value ?? null; }

        /// <summary>Indicates if custom data is required to deploy this role.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Origin(Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.PropertyOrigin.Inlined)]
        public bool? OSProfileCustomDataRequired { get => ((Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IOSProfileInternal)OSProfile).CustomDataRequired; set => ((Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IOSProfileInternal)OSProfile).CustomDataRequired = value ?? default(bool); }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Origin(Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.ISshPublicKey[] SshPublicKey { get => ((Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IOSProfileInternal)OSProfile).SshPublicKey; set => ((Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IOSProfileInternal)OSProfile).SshPublicKey = value ?? null /* arrayOf */; }

        /// <summary>Backing field for <see cref="UserDataParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.IAny _userDataParameter;

        /// <summary>The user parameters from the customer.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Origin(Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.IAny UserDataParameter { get => (this._userDataParameter = this._userDataParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Any()); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.INetworkInterface) })]
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.INetworkInterface[] NetworkInterface { get; set; }
        /// <summary>
        /// Specifies the name of the administrator account. <br><br> **Windows-only restriction:** Cannot end in "." <br><br> **Disallowed
        /// values:** "administrator", "admin", "user", "user1", "test", "user2", "test1", "user3", "admin1", "1", "123", "a", "actuser",
        /// "adm", "admin2", "aspnet", "backup", "console", "david", "guest", "john", "owner", "root", "server", "sql", "support",
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.IAny UserDataParameter { get;  }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.ISshConfiguration LinuxConfigurationSsh { get; set; }
        /// <summary>The network interface configurations.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.INetworkInterface[] NetworkInterface { get; set; }
        /// <summary>Specifies the operating system settings for the role instance.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IOSProfile OSProfile { get; set; }
        /// <summary>
        /// Specifies the name of the administrator account. <br><br> **Windows-only restriction:** Cannot end in "." <br><br> **Disallowed
        /// values:** "administrator", "admin", "user", "user1", "test", "user2", "test1", "user3", "admin1", "1", "123", "a", "actuser",
        /// "adm", "admin2", "aspnet", "backup", "console", "david", "guest", "john", "owner", "root", "server", "sql", "support",
        ...
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.ILinuxConfiguration OSProfileLinuxConfiguration { get; set; }
        /// <summary>The name of the vendor network function role.</summary>
        string RoleName { get; set; }
        /// <summary>The list of SSH public keys used to authenticate with linux based VMs.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.ISshPublicKey[] SshPublicKey { get; set; }
        /// <summary>The user parameters from the customer.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.IAny UserDataParameter { get; set; }
