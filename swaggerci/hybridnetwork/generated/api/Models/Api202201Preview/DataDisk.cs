...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview
{
    ...
    public partial class DataDisk :
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IDataDisk,
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api202201Preview.IDataDiskInternal
    {

        /// <summary>Backing field for <see cref="CreateOption" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.DiskCreateOptionTypes? _createOption;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.DiskCreateOptionTypes? CreateOption { get => this._createOption; set => this._createOption = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.DiskCreateOptionTypes) })]
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.DiskCreateOptionTypes? CreateOption { get; set; }
        /// <summary>
        /// Specifies the size of an empty disk in gigabytes. This element can be used to overwrite the size of the disk in a virtual
        /// machine image.
        /// </summary>
