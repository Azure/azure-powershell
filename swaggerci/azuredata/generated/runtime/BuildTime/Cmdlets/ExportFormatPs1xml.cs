...
namespace Microsoft.Azure.PowerShell.Cmdlets.AzureDataManagementClient.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.AzureDataManagementClient.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.AzureDataManagementClient.Support";
