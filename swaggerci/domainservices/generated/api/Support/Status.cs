...
namespace Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.Status Failure = @"Failure";

        public static Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.Status None = @"None";

        public static Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.Status Ok = @"OK";

        public static Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.Status Running = @"Running";

        public static Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.Status Skipped = @"Skipped";

        public static Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.Status Warning = @"Warning";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
