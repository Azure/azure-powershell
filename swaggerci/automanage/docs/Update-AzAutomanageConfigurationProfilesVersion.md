...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automanage/update-azautomanageconfigurationprofilesversion
schema: 2.0.0
---
...
```
Update-AzAutomanageConfigurationProfilesVersion -ConfigurationProfileName <String> -ResourceGroupName <String>
 -VersionName <String> [-SubscriptionId <String>] [-Configuration <IAny>] [-Override <IAny[]>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAutomanageConfigurationProfilesVersion -InputObject <IAutomanageIdentity> [-Configuration <IAny>]
 [-Override <IAny[]>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
