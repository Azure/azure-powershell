...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20221201
{
    ...
    public partial class CapabilityProperties
    {
        ...
        internal CapabilityProperties(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonObject json)
        {
            ...
            {_supportedHaMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonArray>("supportedHAMode"), out var __jsonSupportedHaMode) ? If( __jsonSupportedHaMode as Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : SupportedHaMode;}
            ...
            {_supportedFlexibleServerEdition = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonArray>("supportedFlexibleServerEditions"), out var __jsonSupportedFlexibleServerEditions) ? If( __jsonSupportedFlexibleServerEditions as Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20221201.IFlexibleServerEditionCapability[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20221201.IFlexibleServerEditionCapability) (Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20221201.FlexibleServerEditionCapability.FromJson(__p) )) ))() : null : SupportedFlexibleServerEdition;}
            {_supportedHyperscaleNodeEdition = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonArray>("supportedHyperscaleNodeEditions"), out var __jsonSupportedHyperscaleNodeEditions) ? If( __jsonSupportedHyperscaleNodeEditions as Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20221201.IHyperscaleNodeEditionCapability[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20221201.IHyperscaleNodeEditionCapability) (Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20221201.HyperscaleNodeEditionCapability.FromJson(__k) )) ))() : null : SupportedHyperscaleNodeEdition;}
            {_fastProvisioningSupported = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonBoolean>("fastProvisioningSupported"), out var __jsonFastProvisioningSupported) ? (bool?)__jsonFastProvisioningSupported : FastProvisioningSupported;}
            {_supportedFastProvisioningEdition = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonArray>("supportedFastProvisioningEditions"), out var __jsonSupportedFastProvisioningEditions) ? If( __jsonSupportedFastProvisioningEditions as Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20221201.IFastProvisioningEditionCapability[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__g, (__f)=>(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20221201.IFastProvisioningEditionCapability) (Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20221201.FastProvisioningEditionCapability.FromJson(__f) )) ))() : null : SupportedFastProvisioningEdition;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20221201.ICapabilityProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20221201.ICapabilityProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20221201.ICapabilityProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.SerializationMode.IncludeReadOnly))
            {
                if (null != this._supportedHyperscaleNodeEdition)
                {
                    ...
                    foreach( var __n in this._supportedHyperscaleNodeEdition )
                    {
                        AddIf(__n?.ToJson(null, serializationMode) ,__m.Add);
                    }
                    container.Add("supportedHyperscaleNodeEditions",__m);
                }
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != this._fastProvisioningSupported ? (Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonBoolean((bool)this._fastProvisioningSupported) : null, "fastProvisioningSupported" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.SerializationMode.IncludeReadOnly))
            {
