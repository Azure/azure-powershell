...
online version: https://docs.microsoft.com/en-us/powershell/module/az.deviceupdate/new-azdeviceupdateaccount
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20200301Preview.IPrivateEndpointConnection[]
Parameter Sets: (All)
Aliases:
