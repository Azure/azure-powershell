...
online version: https://docs.microsoft.com/en-us/powershell/module/az.deviceupdate/remove-azdeviceupdateaccount
schema: 2.0.0
---

# Remove-AzDeviceUpdateAccount
...
### Delete (Default)
```
Remove-AzDeviceUpdateAccount -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDeviceUpdateAccount -InputObject <IDeviceUpdateIdentity> [-DefaultProfile <PSObject>] [-AsJob]
