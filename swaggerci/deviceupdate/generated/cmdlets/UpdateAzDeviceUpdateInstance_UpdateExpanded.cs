...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.IEventListener
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20200301Preview.ITagUpdateTags Tag { get => TagUpdatePayloadBody.Tag ?? null /* object */; set => TagUpdatePayloadBody.Tag = value; }

        /// <summary>Backing field for <see cref="TagUpdatePayloadBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20200301Preview.ITagUpdate _tagUpdatePayloadBody= new Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20200301Preview.TagUpdate();

        /// <summary>Request payload used to update an existing resource's tags.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20200301Preview.ITagUpdate TagUpdatePayloadBody { get => this._tagUpdatePayloadBody; set => this._tagUpdatePayloadBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.InstancesUpdate(ResourceGroupName, SubscriptionId, AccountName, Name, TagUpdatePayloadBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,SubscriptionId=SubscriptionId,AccountName=AccountName,Name=Name,body=TagUpdatePayloadBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, SubscriptionId=SubscriptionId, AccountName=AccountName, Name=Name, body=TagUpdatePayloadBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, SubscriptionId=SubscriptionId, AccountName=AccountName, Name=Name, body=TagUpdatePayloadBody })
                    {
