...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Validate=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeviceUpdate/accounts/{accountName}/privateEndpointConnectionProxies/{privateEndpointConnectionProxyId}/validate"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzDeviceUpdatePrivateEndpointConnectionProxy_ValidateViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Description(@"(INTERNAL - DO NOT USE) Validates a private endpoint connection proxy object.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Generated]
    public partial class TestAzDeviceUpdatePrivateEndpointConnectionProxy_ValidateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="PrivateEndpointConnectionProxy" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20200301Preview.IPrivateEndpointConnectionProxy _privateEndpointConnectionProxy;

        /// <summary>Private endpoint connection proxy details.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Private endpoint connection proxy details.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Private endpoint connection proxy details.",
        SerializedName = @"privateEndpointConnectionProxy",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20200301Preview.IPrivateEndpointConnectionProxy) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20200301Preview.IPrivateEndpointConnectionProxy PrivateEndpointConnectionProxy { get => this._privateEndpointConnectionProxy; set => this._privateEndpointConnectionProxy = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PrivateEndpointConnectionProxiesValidate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PrivateEndpointConnectionProxiesValidateViaIdentity(InputObject.Id, PrivateEndpointConnectionProxy, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.PrivateEndpointConnectionProxyId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.PrivateEndpointConnectionProxyId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.PrivateEndpointConnectionProxiesValidate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.PrivateEndpointConnectionProxyId ?? null, PrivateEndpointConnectionProxy, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=PrivateEndpointConnectionProxy})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzDeviceUpdatePrivateEndpointConnectionProxy_ValidateViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public TestAzDeviceUpdatePrivateEndpointConnectionProxy_ValidateViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=PrivateEndpointConnectionProxy })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=PrivateEndpointConnectionProxy })
                    {
