...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api30.ICheckNameAvailabilityRequest RequestBody { get => this._requestBody; set => this._requestBody = value; }
        ...
        SerializedName = @"type",
        PossibleTypes = new [] { typeof(string) })]
        public string Type { get => RequestBody.Type ?? null; set => RequestBody.Type = value; }
