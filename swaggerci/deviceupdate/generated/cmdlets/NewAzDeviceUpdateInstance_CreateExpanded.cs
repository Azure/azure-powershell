...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.IEventListener
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string DiagnosticStoragePropertyConnectionString { get => InstanceBody.DiagnosticStoragePropertyConnectionString ?? null; set => InstanceBody.DiagnosticStoragePropertyConnectionString = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string DiagnosticStoragePropertyResourceId { get => InstanceBody.DiagnosticStoragePropertyResourceId ?? null; set => InstanceBody.DiagnosticStoragePropertyResourceId = value; }
        ...
        public global::System.Management.Automation.SwitchParameter EnableDiagnostic { get => InstanceBody.EnableDiagnostic ?? default(global::System.Management.Automation.SwitchParameter); set => InstanceBody.EnableDiagnostic = value; }
        ...
        /// <summary>Backing field for <see cref="InstanceBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20200301Preview.IInstance _instanceBody= new Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20200301Preview.Instance();

        /// <summary>Device Update instance details.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20200301Preview.IInstance InstanceBody { get => this._instanceBody; set => this._instanceBody = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20200301Preview.IIotHubSettings[] IotHub { get => InstanceBody.IotHub ?? null /* arrayOf */; set => InstanceBody.IotHub = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => InstanceBody.Location ?? null; set => InstanceBody.Location = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api30.ITrackedResourceTags Tag { get => InstanceBody.Tag ?? null /* object */; set => InstanceBody.Tag = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Cmdlets.NewAzDeviceUpdateInstance_CreateExpanded Clone()
        {
            ...
            clone.InstanceBody = this.InstanceBody;
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.InstancesCreate(ResourceGroupName, SubscriptionId, AccountName, Name, InstanceBody, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,SubscriptionId=SubscriptionId,AccountName=AccountName,Name=Name,body=InstanceBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, SubscriptionId=SubscriptionId, AccountName=AccountName, Name=Name, body=InstanceBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, SubscriptionId=SubscriptionId, AccountName=AccountName, Name=Name, body=InstanceBody })
                    {
