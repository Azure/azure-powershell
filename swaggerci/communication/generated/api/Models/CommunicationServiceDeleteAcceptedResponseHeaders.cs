...
namespace Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models
{
    ...
    public partial class CommunicationServiceDeleteAcceptedResponseHeaders :
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.ICommunicationServiceDeleteAcceptedResponseHeaders,
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.ICommunicationServiceDeleteAcceptedResponseHeadersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.IHeaderSerializable
    {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.ICommunicationServiceDeleteAcceptedResponseHeadersInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader0) is string __headerLocationHeader0 ? __headerLocationHeader0 : (string)null;
            }
        }
    }
