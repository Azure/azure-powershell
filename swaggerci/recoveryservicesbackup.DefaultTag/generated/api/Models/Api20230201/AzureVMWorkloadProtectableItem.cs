...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230201
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IValidates
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230201.IPreBackupValidation _prebackupvalidation;

        /// <summary>Pre-backup validation for protectable objects</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230201.IPreBackupValidation Prebackupvalidation { get => (this._prebackupvalidation = this._prebackupvalidation ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230201.PreBackupValidation()); set => this._prebackupvalidation = value; }
        ...
        public string PrebackupvalidationCode { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230201.IPreBackupValidationInternal)Prebackupvalidation).Code; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230201.IPreBackupValidationInternal)Prebackupvalidation).Code = value ?? null; }

        /// <summary>Message corresponding to the error code for the protectable item</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inlined)]
        public string PrebackupvalidationMessage { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230201.IPreBackupValidationInternal)Prebackupvalidation).Message; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230201.IPreBackupValidationInternal)Prebackupvalidation).Message = value ?? null; }

        /// <summary>Status of protectable item, i.e. InProgress,Succeeded,Failed</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Support.InquiryStatus? PrebackupvalidationStatus { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230201.IPreBackupValidationInternal)Prebackupvalidation).Status; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230201.IPreBackupValidationInternal)Prebackupvalidation).Status = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Support.InquiryStatus)""); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230201.IWorkloadProtectableItemInternal
    {
        ...
        string ParentUniqueName { get; set; }
        /// <summary>Pre-backup validation for protectable objects</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230201.IPreBackupValidation Prebackupvalidation { get; set; }
        /// <summary>Error code of protectable item</summary>
        string PrebackupvalidationCode { get; set; }
        /// <summary>Message corresponding to the error code for the protectable item</summary>
        string PrebackupvalidationMessage { get; set; }
