...
using Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json;
using System;

namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.JsonSerializable.ToJson(dict, null);
            }
