...
online version: https://docs.microsoft.com/en-us/powershell/module/az.application/remove-azapplicationdefinition
schema: 2.0.0
---

# Remove-AzApplicationDefinition
...
### Delete (Default)
```
Remove-AzApplicationDefinition -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzApplicationDefinition -InputObject <IApplicationIdentity> [-DefaultProfile <PSObject>] [-AsJob]
