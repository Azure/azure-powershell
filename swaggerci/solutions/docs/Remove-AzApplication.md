...
online version: https://docs.microsoft.com/en-us/powershell/module/az.application/remove-azapplication
schema: 2.0.0
---

# Remove-AzApplication
...
### Delete (Default)
```
Remove-AzApplication -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzApplication -InputObject <IApplicationIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
