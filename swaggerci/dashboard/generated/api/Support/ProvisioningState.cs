...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Support.ProvisioningState Accepted = @"Accepted";

        public static Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Support.ProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Support.ProvisioningState Deleted = @"Deleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Support.ProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Support.ProvisioningState NotSpecified = @"NotSpecified";

        public static Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Support.ProvisioningState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Support.ProvisioningState e)
        {
            return e._value;
        }
