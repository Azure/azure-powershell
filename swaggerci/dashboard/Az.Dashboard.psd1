@{
  GUID = 'd817444c-cf4d-470a-86b6-81230cae8069'
  ...
  FunctionsToExport = 'Get-AzDashboardGrafana', 'New-AzDashboardGrafana', 'Remove-AzDashboardGrafana', 'Update-AzDashboardGrafana', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
