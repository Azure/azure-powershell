...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview
{
    ...
    public partial class DisplayInfo :
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IDisplayInfo,
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IDisplayInfoInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IDisplayInfoInternal.ConfigurationDisplayName { get => this._configurationDisplayName; set { {_configurationDisplayName = value;} } }

        /// <summary>Internal Acessors for ProductFamilyDisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IDisplayInfoInternal.ProductFamilyDisplayName { get => this._productFamilyDisplayName; set { {_productFamilyDisplayName = value;} } }
