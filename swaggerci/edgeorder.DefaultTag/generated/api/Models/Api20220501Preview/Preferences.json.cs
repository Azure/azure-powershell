...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview
{
    ...
    public partial class Preferences
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IPreferences.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IPreferences.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IPreferences FromJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject json ? new Preferences(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject into a new instance of <see cref="Preferences" />.
        /// </summary>
        ...
        internal Preferences(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject json)
        {
            ...
            {_transportPreference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("transportPreferences"), out var __jsonTransportPreferences) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.TransportPreferences.FromJson(__jsonTransportPreferences) : TransportPreference;}
            {_encryptionPreference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("encryptionPreferences"), out var __jsonEncryptionPreferences) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.EncryptionPreferences.FromJson(__jsonEncryptionPreferences) : EncryptionPreference;}
            {_managementResourcePreference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("managementResourcePreferences"), out var __jsonManagementResourcePreferences) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.ManagementResourcePreferences.FromJson(__jsonManagementResourcePreferences) : ManagementResourcePreference;}
            {_notificationPreference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray>("notificationPreferences"), out var __jsonNotificationPreferences) ? If( __jsonNotificationPreferences as Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.INotificationPreference[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.INotificationPreference) (Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.NotificationPreference.FromJson(__u) )) ))() : null : NotificationPreference;}
            AfterFromJson(json);
        }
