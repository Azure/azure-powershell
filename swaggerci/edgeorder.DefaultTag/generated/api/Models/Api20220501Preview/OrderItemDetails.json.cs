...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview
{
    ...
    public partial class OrderItemDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IOrderItemDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IOrderItemDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IOrderItemDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode node)
        {
        ...
        internal OrderItemDetails(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject json)
        {
            ...
            {_productDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("productDetails"), out var __jsonProductDetails) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.ProductDetails.FromJson(__jsonProductDetails) : ProductDetail;}
            {_currentStage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("currentStage"), out var __jsonCurrentStage) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.StageDetails.FromJson(__jsonCurrentStage) : CurrentStage;}
            {_preference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("preferences"), out var __jsonPreferences) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.Preferences.FromJson(__jsonPreferences) : Preference;}
            {_forwardShippingDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("forwardShippingDetails"), out var __jsonForwardShippingDetails) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.ForwardShippingDetails.FromJson(__jsonForwardShippingDetails) : ForwardShippingDetail;}
            {_reverseShippingDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("reverseShippingDetails"), out var __jsonReverseShippingDetails) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.ReverseShippingDetails.FromJson(__jsonReverseShippingDetails) : ReverseShippingDetail;}
            ...
            {_orderItemMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("orderItemMode"), out var __jsonOrderItemMode) ? (string)__jsonOrderItemMode : (string)OrderItemMode;}
            {_orderItemStageHistory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray>("orderItemStageHistory"), out var __jsonOrderItemStageHistory) ? If( __jsonOrderItemStageHistory as Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IStageDetails[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IStageDetails) (Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.StageDetails.FromJson(__u) )) ))() : null : OrderItemStageHistory;}
            ...
            {_managementRpDetailsList = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray>("managementRpDetailsList"), out var __jsonManagementRpDetailsList) ? If( __jsonManagementRpDetailsList as Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IResourceProviderDetails[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IResourceProviderDetails) (Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.ResourceProviderDetails.FromJson(__k) )) ))() : null : ManagementRpDetailsList;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._orderItemMode)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString(this._orderItemMode.ToString()) : null, "orderItemMode" ,container.Add );
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.SerializationMode.IncludeReadOnly))
            {
