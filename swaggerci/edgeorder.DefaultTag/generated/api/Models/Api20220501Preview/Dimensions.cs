...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview
{
    ...
    public partial class Dimensions :
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IDimensions,
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IDimensionsInternal
    {
        ...
        double? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IDimensionsInternal.Depth { get => this._depth; set { {_depth = value;} } }

        /// <summary>Internal Acessors for Height</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IDimensionsInternal.Height { get => this._height; set { {_height = value;} } }

        /// <summary>Internal Acessors for Length</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IDimensionsInternal.Length { get => this._length; set { {_length = value;} } }

        /// <summary>Internal Acessors for LengthHeightUnit</summary>
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.LengthHeightUnit? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IDimensionsInternal.LengthHeightUnit { get => this._lengthHeightUnit; set { {_lengthHeightUnit = value;} } }

        /// <summary>Internal Acessors for Weight</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IDimensionsInternal.Weight { get => this._weight; set { {_weight = value;} } }

        /// <summary>Internal Acessors for WeightUnit</summary>
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.WeightMeasurementUnit? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IDimensionsInternal.WeightUnit { get => this._weightUnit; set { {_weightUnit = value;} } }

        /// <summary>Internal Acessors for Width</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IDimensionsInternal.Width { get => this._width; set { {_width = value;} } }
