...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzEdgeOrderProductAndConfigurationProductFamily_List", SupportsShouldProcess = true)]
    ...
    public partial class GetAzEdgeOrderProductAndConfigurationProductFamily_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ProductFamiliesRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IProductFamiliesRequest _productFamiliesRequest;

        /// <summary>The filters for showing the product families.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The filters for showing the product families.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The filters for showing the product families.",
        SerializedName = @"productFamiliesRequest",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IProductFamiliesRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IProductFamiliesRequest ProductFamiliesRequest { get => this._productFamiliesRequest; set => this._productFamiliesRequest = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzEdgeOrderProductAndConfigurationProductFamily_List" /> cmdlet class.
        /// </summary>
        public GetAzEdgeOrderProductAndConfigurationProductFamily_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ProductsAndConfigurationsListProductFamilies(SubscriptionId, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, this.InvocationInformation.BoundParameters.ContainsKey("SkipToken") ? SkipToken : null, ProductFamiliesRequest, onOk, onDefault, this, Pipeline);
