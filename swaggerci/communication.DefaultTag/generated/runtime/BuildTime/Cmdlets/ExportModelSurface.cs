...
namespace Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support";
