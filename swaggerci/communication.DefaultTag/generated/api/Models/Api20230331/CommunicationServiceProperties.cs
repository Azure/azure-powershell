...
namespace Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20230331
{
    ...
    public partial class CommunicationServiceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20230331.ICommunicationServiceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20230331.ICommunicationServicePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20230331.ICommunicationServicePropertiesInternal.HostName { get => this._hostName; set { {_hostName = value;} } }

        /// <summary>Internal Acessors for ImmutableResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20230331.ICommunicationServicePropertiesInternal.ImmutableResourceId { get => this._immutableResourceId; set { {_immutableResourceId = value;} } }

        /// <summary>Internal Acessors for NotificationHubId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20230331.ICommunicationServicePropertiesInternal.NotificationHubId { get => this._notificationHubId; set { {_notificationHubId = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.CommunicationServicesProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20230331.ICommunicationServicePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20230331.ICommunicationServicePropertiesInternal.Version { get => this._version; set { {_version = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.CommunicationServicesProvisioningState? _provisioningState;

        /// <summary>Provisioning state of the resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Origin(Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.CommunicationServicesProvisioningState? ProvisioningState { get => this._provisioningState; }
