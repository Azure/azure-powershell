...
namespace Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models
{
    ...
    public partial class DomainsInitiateVerificationAcceptedResponseHeaders :
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.IDomainsInitiateVerificationAcceptedResponseHeaders,
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.IDomainsInitiateVerificationAcceptedResponseHeadersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.IHeaderSerializable
    {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.IDomainsInitiateVerificationAcceptedResponseHeadersInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader0) is string __headerLocationHeader0 ? __headerLocationHeader0 : (string)null;
            }
        }
    }
