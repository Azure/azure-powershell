...
online version: https://learn.microsoft.com/powershell/module/az.communicationservice/remove-azcommunicationserviceemailservice
schema: 2.0.0
---

# Remove-AzCommunicationServiceEmailService
...
### Delete (Default)
```
Remove-AzCommunicationServiceEmailService -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzCommunicationServiceEmailService -InputObject <ICommunicationServiceIdentity>
