...
online version: https://docs.microsoft.com/en-us/powershell/module/az.serialconsole/disable-azserialconsole
schema: 2.0.0
---

# Disable-AzSerialConsole
...
### Disable (Default)
```
Disable-AzSerialConsole -Default <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-AzSerialConsole -InputObject <ISerialConsoleIdentity> [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
