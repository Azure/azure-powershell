...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.redhatopenshift/get-azredhatopenshiftoperation
#>
function Get-AzRedHatOpenShiftOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20220401.IOperation])]
