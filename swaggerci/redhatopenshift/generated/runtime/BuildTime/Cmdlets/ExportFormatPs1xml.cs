...
namespace Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Support";
