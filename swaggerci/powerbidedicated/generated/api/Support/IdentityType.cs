...
namespace Microsoft.Azure.PowerShell.Cmdlets.PowerBiDedicated.Support
{
    ...
    /// <summary>The type of identity that created/modified the resource.</summary>
    public partial struct IdentityType :
        System.IEquatable<IdentityType>
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.PowerBiDedicated.Support.IdentityType Application = @"Application";

        public static Microsoft.Azure.PowerShell.Cmdlets.PowerBiDedicated.Support.IdentityType Key = @"Key";

        public static Microsoft.Azure.PowerShell.Cmdlets.PowerBiDedicated.Support.IdentityType ManagedIdentity = @"ManagedIdentity";

        public static Microsoft.Azure.PowerShell.Cmdlets.PowerBiDedicated.Support.IdentityType User = @"User";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.PowerBiDedicated.Support.IdentityType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.PowerBiDedicated.Support.IdentityType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.PowerBiDedicated.Support.IdentityType e1, Microsoft.Azure.PowerShell.Cmdlets.PowerBiDedicated.Support.IdentityType e2)
        {
            return !e2.Equals(e1);
        }
