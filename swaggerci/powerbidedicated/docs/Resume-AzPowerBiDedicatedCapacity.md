...
online version: https://docs.microsoft.com/en-us/powershell/module/az.powerbidedicated/resume-azpowerbidedicatedcapacity
schema: 2.0.0
---

# Resume-AzPowerBiDedicatedCapacity
...
### Resume (Default)
```
Resume-AzPowerBiDedicatedCapacity -DedicatedCapacityName <String> -ResourceGroupName <String>
...
### ResumeViaIdentity
```
Resume-AzPowerBiDedicatedCapacity -InputObject <IPowerBiDedicatedIdentity> [-DefaultProfile <PSObject>]
