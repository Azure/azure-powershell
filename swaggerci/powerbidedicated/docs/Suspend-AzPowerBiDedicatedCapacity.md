...
online version: https://docs.microsoft.com/en-us/powershell/module/az.powerbidedicated/suspend-azpowerbidedicatedcapacity
schema: 2.0.0
---

# Suspend-AzPowerBiDedicatedCapacity
...
### Suspend (Default)
```
Suspend-AzPowerBiDedicatedCapacity -DedicatedCapacityName <String> -ResourceGroupName <String>
...
### SuspendViaIdentity
```
Suspend-AzPowerBiDedicatedCapacity -InputObject <IPowerBiDedicatedIdentity> [-DefaultProfile <PSObject>]
