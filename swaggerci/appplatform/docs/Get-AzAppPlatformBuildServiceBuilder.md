...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appplatform/get-azappplatformbuildservicebuilder
schema: 2.0.0
---

# Get-AzAppPlatformBuildServiceBuilder
...
### List (Default)
```
Get-AzAppPlatformBuildServiceBuilder -BuildServiceName <String> -ResourceGroupName <String>
 -ServiceName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzAppPlatformBuildServiceBuilder -BuilderName <String> -BuildServiceName <String>
...
### GetViaIdentity
```
Get-AzAppPlatformBuildServiceBuilder -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
