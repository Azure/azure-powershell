...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appplatform/get-azappplatformbuildservicebuildresult
schema: 2.0.0
---
...
### List (Default)
```
Get-AzAppPlatformBuildServiceBuildResult -BuildName <String> -BuildServiceName <String>
...
### Get
```
Get-AzAppPlatformBuildServiceBuildResult -BuildName <String> -BuildResultName <String>
 -BuildServiceName <String> -ResourceGroupName <String> -ServiceName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAppPlatformBuildServiceBuildResult -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
