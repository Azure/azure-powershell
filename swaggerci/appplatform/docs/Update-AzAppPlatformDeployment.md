...
Update-AzAppPlatformDeployment -AppName <String> -Name <String> -ResourceGroupName <String>
 -ServiceName <String> [-SubscriptionId <String>] [-Active] [-ContainerProbeSettingDisableProbe]
...
Update-AzAppPlatformDeployment -InputObject <IAppPlatformIdentity> [-Active]
 [-ContainerProbeSettingDisableProbe] [-DeploymentSettingAddonConfig <Hashtable>]
