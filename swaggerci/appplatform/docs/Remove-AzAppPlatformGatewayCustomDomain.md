...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appplatform/remove-azappplatformgatewaycustomdomain
schema: 2.0.0
---

# Remove-AzAppPlatformGatewayCustomDomain
...
### Delete (Default)
```
Remove-AzAppPlatformGatewayCustomDomain -DomainName <String> -GatewayName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzAppPlatformGatewayCustomDomain -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
