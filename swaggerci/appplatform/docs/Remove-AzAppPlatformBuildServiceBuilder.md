...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appplatform/remove-azappplatformbuildservicebuilder
schema: 2.0.0
---

# Remove-AzAppPlatformBuildServiceBuilder
...
### Delete (Default)
```
Remove-AzAppPlatformBuildServiceBuilder -BuilderName <String> -BuildServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzAppPlatformBuildServiceBuilder -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
