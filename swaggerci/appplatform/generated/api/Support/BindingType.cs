...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.BindingType ApacheSkyWalking = @"ApacheSkyWalking";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.BindingType AppDynamics = @"AppDynamics";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.BindingType ApplicationInsights = @"ApplicationInsights";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.BindingType Dynatrace = @"Dynatrace";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.BindingType ElasticApm = @"ElasticAPM";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.BindingType NewRelic = @"NewRelic";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.BindingType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.BindingType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.BindingType e1, Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.BindingType e2)
        {
            return !e2.Equals(e1);
        }
