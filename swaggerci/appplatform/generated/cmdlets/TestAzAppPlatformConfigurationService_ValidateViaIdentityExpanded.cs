...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IEventListener
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220301Preview.IConfigurationServiceGitRepository[] GitPropertyRepository { get => SettingsBody.GitPropertyRepository ?? null /* arrayOf */; set => SettingsBody.GitPropertyRepository = value; }
        ...
        /// <summary>Backing field for <see cref="SettingsBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220301Preview.IConfigurationServiceSettings _settingsBody= new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220301Preview.ConfigurationServiceSettings();

        /// <summary>The settings of Application Configuration Service.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220301Preview.IConfigurationServiceSettings SettingsBody { get => this._settingsBody; set => this._settingsBody = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets.TestAzAppPlatformConfigurationService_ValidateViaIdentityExpanded Clone()
        {
            ...
            clone.SettingsBody = this.SettingsBody;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ConfigurationServicesValidateViaIdentity(InputObject.Id, SettingsBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ConfigurationServicesValidate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServiceName ?? null, InputObject.ConfigurationServiceName ?? null, SettingsBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=SettingsBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220301Preview.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=SettingsBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=SettingsBody })
                    {
