...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220301Preview.ICustomDomainValidatePayload _validatePayloadBody= new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220301Preview.CustomDomainValidatePayload();

        /// <summary>Custom domain validate payload.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220301Preview.ICustomDomainValidatePayload ValidatePayloadBody { get => this._validatePayloadBody; set => this._validatePayloadBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ApiPortalsValidateDomainViaIdentity(InputObject.Id, ValidatePayloadBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ApiPortalsValidateDomain(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServiceName ?? null, InputObject.ApiPortalName ?? null, ValidatePayloadBody, onOk, onDefault, this, Pipeline);
                    }
