...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The resource Id of the Azure Spring Cloud app, required unless route defines `uri`.")]
        ...
        public string AppResourceId { get => GatewayRouteConfigResourceBody.AppResourceId ?? null; set => GatewayRouteConfigResourceBody.AppResourceId = value; }
        ...
        /// <summary>Backing field for <see cref="GatewayRouteConfigResourceBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220301Preview.IGatewayRouteConfigResource _gatewayRouteConfigResourceBody= new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220301Preview.GatewayRouteConfigResource();

        /// <summary>Spring Cloud Gateway route config resource</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220301Preview.IGatewayRouteConfigResource GatewayRouteConfigResourceBody { get => this._gatewayRouteConfigResourceBody; set => this._gatewayRouteConfigResourceBody = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220301Preview.IGatewayApiRoute[] Route { get => GatewayRouteConfigResourceBody.Route ?? null /* arrayOf */; set => GatewayRouteConfigResourceBody.Route = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets.NewAzAppPlatformGatewayRouteConfig_CreateExpanded Clone()
        {
            ...
            clone.GatewayRouteConfigResourceBody = this.GatewayRouteConfigResourceBody;
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GatewayRouteConfigsCreateOrUpdate(SubscriptionId, ResourceGroupName, ServiceName, GatewayName, RouteConfigName, GatewayRouteConfigResourceBody, onOk, onDefault, this, Pipeline);
