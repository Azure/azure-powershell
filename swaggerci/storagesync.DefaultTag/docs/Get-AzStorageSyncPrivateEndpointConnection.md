...
online version: https://learn.microsoft.com/powershell/module/az.storagesync/get-azstoragesyncprivateendpointconnection
schema: 2.0.0
---
...
### List (Default)
```
Get-AzStorageSyncPrivateEndpointConnection -ResourceGroupName <String> -StorageSyncServiceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzStorageSyncPrivateEndpointConnection -Name <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzStorageSyncPrivateEndpointConnection -InputObject <IStorageSyncIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
