...
online version: https://learn.microsoft.com/powershell/module/az.storagesync/remove-azstoragesyncprivateendpointconnection
schema: 2.0.0
---

# Remove-AzStorageSyncPrivateEndpointConnection
...
### Delete (Default)
```
Remove-AzStorageSyncPrivateEndpointConnection -Name <String> -ResourceGroupName <String>
 -StorageSyncServiceName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzStorageSyncPrivateEndpointConnection -InputObject <IStorageSyncIdentity> [-DefaultProfile <PSObject>]
