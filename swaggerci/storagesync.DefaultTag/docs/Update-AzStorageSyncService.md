...
online version: https://learn.microsoft.com/powershell/module/az.storagesync/update-azstoragesyncservice
schema: 2.0.0
---

# Update-AzStorageSyncService
...
```
Update-AzStorageSyncService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-IncomingTrafficPolicy <IncomingTrafficPolicy>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzStorageSyncService -InputObject <IStorageSyncIdentity>
 [-IncomingTrafficPolicy <IncomingTrafficPolicy>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
