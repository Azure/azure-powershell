...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models
{
    ...
    public partial class RegisteredServersDeleteOkResponseHeaders :
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.IRegisteredServersDeleteOkResponseHeaders,
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.IRegisteredServersDeleteOkResponseHeadersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IHeaderSerializable
    {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.IRegisteredServersDeleteOkResponseHeadersInternal)this).XmsRequestId = System.Linq.Enumerable.FirstOrDefault(__xMSRequestIdHeader0) is string __headerXMSRequestIdHeader0 ? __headerXMSRequestIdHeader0 : (string)null;
            }
        ...
        /// <summary>
        /// Creates an new <see cref="RegisteredServersDeleteOkResponseHeaders" /> instance.
        /// </summary>
        public RegisteredServersDeleteOkResponseHeaders()
        {
    ...
    internal partial interface IRegisteredServersDeleteOkResponseHeadersInternal
