...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601
{
    ...
    public partial class SyncGroup :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ISyncGroupInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IHeaderSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ISyncGroupProperties Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ISyncGroupInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.SyncGroupProperties()); set { {_property = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ISyncGroupInternal.Status { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ISyncGroupPropertiesInternal)Property).SyncGroupStatus; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ISyncGroupPropertiesInternal)Property).SyncGroupStatus = value; }

        /// <summary>Internal Acessors for UniqueId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ISyncGroupInternal.UniqueId { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ISyncGroupPropertiesInternal)Property).UniqueId; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ISyncGroupPropertiesInternal)Property).UniqueId = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ISyncGroupProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ISyncGroupProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.SyncGroupProperties()); set => this._property = value; }
        ...
        public string Status { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ISyncGroupPropertiesInternal)Property).SyncGroupStatus; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.PropertyOrigin.Inlined)]
        public string UniqueId { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ISyncGroupPropertiesInternal)Property).UniqueId; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ISyncGroupInternal)this).XmsRequestId = System.Linq.Enumerable.FirstOrDefault(__xMSRequestIdHeader0) is string __headerXMSRequestIdHeader0 ? __headerXMSRequestIdHeader0 : (string)null;
            }
            if (headers.TryGetValues("x-ms-correlation-request-id", out var __xMSCorrelationRequestIdHeader1))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ISyncGroupInternal)this).XmsCorrelationRequestId = System.Linq.Enumerable.FirstOrDefault(__xMSCorrelationRequestIdHeader1) is string __headerXMSCorrelationRequestIdHeader1 ? __headerXMSCorrelationRequestIdHeader1 : (string)null;
            }
        }
    ...
    {
        /// <summary>SyncGroup properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ISyncGroupProperties Property { get; set; }
        /// <summary>Sync group status</summary>
