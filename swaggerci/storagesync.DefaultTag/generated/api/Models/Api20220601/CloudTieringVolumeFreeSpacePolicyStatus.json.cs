...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601
{
    ...
    public partial class CloudTieringVolumeFreeSpacePolicyStatus
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject into a new instance of <see cref="CloudTieringVolumeFreeSpacePolicyStatus" />.
        /// </summary>
        ...
        internal CloudTieringVolumeFreeSpacePolicyStatus(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject json)
        {
            ...
            {_effectiveVolumeFreeSpacePolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNumber>("effectiveVolumeFreeSpacePolicy"), out var __jsonEffectiveVolumeFreeSpacePolicy) ? (int?)__jsonEffectiveVolumeFreeSpacePolicy : EffectiveVolumeFreeSpacePolicy;}
            {_currentVolumeFreeSpacePercent = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNumber>("currentVolumeFreeSpacePercent"), out var __jsonCurrentVolumeFreeSpacePercent) ? (int?)__jsonCurrentVolumeFreeSpacePercent : CurrentVolumeFreeSpacePercent;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ICloudTieringVolumeFreeSpacePolicyStatus.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ICloudTieringVolumeFreeSpacePolicyStatus.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.ICloudTieringVolumeFreeSpacePolicyStatus FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject json ? new CloudTieringVolumeFreeSpacePolicyStatus(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CloudTieringVolumeFreeSpacePolicyStatus" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CloudTieringVolumeFreeSpacePolicyStatus" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != this._effectiveVolumeFreeSpacePolicy ? (Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNumber((int)this._effectiveVolumeFreeSpacePolicy) : null, "effectiveVolumeFreeSpacePolicy" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != this._currentVolumeFreeSpacePercent ? (Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNumber((int)this._currentVolumeFreeSpacePercent) : null, "currentVolumeFreeSpacePercent" ,container.Add );
            }
