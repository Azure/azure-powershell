...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/get-azdevtestlabsartifact
schema: 2.0.0
---

# Get-AzDevTestLabsArtifact
...
### List (Default)
```
Get-AzDevTestLabsArtifact -LabName <String> -ResourceGroupName <String> -SourceName <String>
...
### Get
```
Get-AzDevTestLabsArtifact -LabName <String> -Name <String> -ResourceGroupName <String> -SourceName <String>
 [-SubscriptionId <String[]>] [-Expand <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDevTestLabsArtifact -InputObject <IDevTestLabsIdentity> [-Expand <String>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
