...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/invoke-azdevtestlabsexecuteservicefabricschedule
schema: 2.0.0
---
...
### Execute (Default)
```
Invoke-AzDevTestLabsExecuteServiceFabricSchedule -LabName <String> -Name <String> -ResourceGroupName <String>
...
### ExecuteViaIdentity
```
Invoke-AzDevTestLabsExecuteServiceFabricSchedule -InputObject <IDevTestLabsIdentity>
