...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabsformula
schema: 2.0.0
---

# Remove-AzDevTestLabsFormula
...
### Delete (Default)
```
Remove-AzDevTestLabsFormula -LabName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDevTestLabsFormula -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-PassThru]
