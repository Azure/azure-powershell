...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/invoke-azdevtestlabsdetachdisk
schema: 2.0.0
---

# Invoke-AzDevTestLabsDetachDisk
...
```
Invoke-AzDevTestLabsDetachDisk -LabName <String> -Name <String> -ResourceGroupName <String> -UserName <String>
...
```
Invoke-AzDevTestLabsDetachDisk -LabName <String> -Name <String> -ResourceGroupName <String> -UserName <String>
 -DetachDiskProperty <IDetachDiskProperties> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DetachViaIdentity
```
Invoke-AzDevTestLabsDetachDisk -InputObject <IDevTestLabsIdentity> -DetachDiskProperty <IDetachDiskProperties>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DetachViaIdentityExpanded
```
Invoke-AzDevTestLabsDetachDisk -InputObject <IDevTestLabsIdentity> [-LeasedByLabVMId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.IDetachDiskProperties
