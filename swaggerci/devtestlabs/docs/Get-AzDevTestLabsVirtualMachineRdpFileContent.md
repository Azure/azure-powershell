...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/get-azdevtestlabsvirtualmachinerdpfilecontent
schema: 2.0.0
---

# Get-AzDevTestLabsVirtualMachineRdpFileContent
...
### Get (Default)
```
Get-AzDevTestLabsVirtualMachineRdpFileContent -LabName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDevTestLabsVirtualMachineRdpFileContent -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>]
