...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/invoke-azdevtestlabsexecutevirtualmachineschedule
schema: 2.0.0
---

# Invoke-AzDevTestLabsExecuteVirtualMachineSchedule
...
### Execute (Default)
```
Invoke-AzDevTestLabsExecuteVirtualMachineSchedule -LabName <String> -Name <String> -ResourceGroupName <String>
...
### ExecuteViaIdentity
```
Invoke-AzDevTestLabsExecuteVirtualMachineSchedule -InputObject <IDevTestLabsIdentity>
