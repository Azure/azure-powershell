...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/invoke-azdevtestlabsclaimvirtualmachineun
schema: 2.0.0
---

# Invoke-AzDevTestLabsClaimVirtualMachineUn
...
### Claim (Default)
```
Invoke-AzDevTestLabsClaimVirtualMachineUn -LabName <String> -Name <String> -ResourceGroupName <String>
...
### ClaimViaIdentity
```
Invoke-AzDevTestLabsClaimVirtualMachineUn -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>]
