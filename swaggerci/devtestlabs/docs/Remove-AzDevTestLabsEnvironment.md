...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabsenvironment
schema: 2.0.0
---

# Remove-AzDevTestLabsEnvironment
...
### Delete (Default)
```
Remove-AzDevTestLabsEnvironment -LabName <String> -Name <String> -ResourceGroupName <String>
 -UserName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDevTestLabsEnvironment -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
