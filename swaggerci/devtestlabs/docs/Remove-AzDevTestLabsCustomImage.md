...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabscustomimage
schema: 2.0.0
---

# Remove-AzDevTestLabsCustomImage
...
### Delete (Default)
```
Remove-AzDevTestLabsCustomImage -LabName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDevTestLabsCustomImage -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
