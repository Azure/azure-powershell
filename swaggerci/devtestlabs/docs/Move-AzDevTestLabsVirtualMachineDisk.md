...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/move-azdevtestlabsvirtualmachinedisk
schema: 2.0.0
---

# Move-AzDevTestLabsVirtualMachineDisk
...
### Transfer (Default)
```
Move-AzDevTestLabsVirtualMachineDisk -LabName <String> -Name <String> -ResourceGroupName <String>
...
### TransferViaIdentity
```
Move-AzDevTestLabsVirtualMachineDisk -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
...
Parameter Sets: TransferViaIdentity
Aliases:
