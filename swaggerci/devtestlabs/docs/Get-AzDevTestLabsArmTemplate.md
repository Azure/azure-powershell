...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/get-azdevtestlabsarmtemplate
schema: 2.0.0
---

# Get-AzDevTestLabsArmTemplate
...
### List (Default)
```
Get-AzDevTestLabsArmTemplate -ArtifactSourceName <String> -LabName <String> -ResourceGroupName <String>
...
### Get
```
Get-AzDevTestLabsArmTemplate -ArtifactSourceName <String> -LabName <String> -Name <String>
...
### GetViaIdentity
```
Get-AzDevTestLabsArmTemplate -InputObject <IDevTestLabsIdentity> [-Expand <String>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
