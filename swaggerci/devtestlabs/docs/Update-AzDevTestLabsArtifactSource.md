...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/update-azdevtestlabsartifactsource
schema: 2.0.0
---
...
```
Update-AzDevTestLabsArtifactSource -LabName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzDevTestLabsArtifactSource -InputObject <IDevTestLabsIdentity> [-Tag <Hashtable>]
