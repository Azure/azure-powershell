...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/stop-azdevtestlabsvirtualmachine
schema: 2.0.0
---

# Stop-AzDevTestLabsVirtualMachine
...
### Stop (Default)
```
Stop-AzDevTestLabsVirtualMachine -LabName <String> -Name <String> -ResourceGroupName <String>
...
### StopViaIdentity
```
Stop-AzDevTestLabsVirtualMachine -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
