...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/invoke-azdevtestlabsexecuteschedule
schema: 2.0.0
---
...
### Execute (Default)
```
Invoke-AzDevTestLabsExecuteSchedule -LabName <String> -Name <String> -ResourceGroupName <String>
...
### ExecuteViaIdentity
```
Invoke-AzDevTestLabsExecuteSchedule -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
