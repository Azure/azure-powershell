...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users/{userName}/disks/{name}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzDevTestLabsDisk_CreateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Description(@"Create or replace an existing disk. This operation can take a while to complete.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Generated]
    public partial class NewAzDevTestLabsDisk_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "When backed by a blob, the name of the VHD blob without extension.")]
        ...
        public string DiskBlobName { get => DiskBody.BlobName ?? null; set => DiskBody.BlobName = value; }

        /// <summary>Backing field for <see cref="DiskBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.IDisk _diskBody= new Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.Disk();

        /// <summary>A Disk.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.IDisk DiskBody { get => this._diskBody; set => this._diskBody = value; }

        /// <summary>The size of the disk in Gibibytes.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The size of the disk in Gibibytes.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public int DiskSizeGiB { get => DiskBody.SizeGiB ?? default(int); set => DiskBody.SizeGiB = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Support.StorageType DiskType { get => DiskBody.DiskType ?? ((Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Support.StorageType)""); set => DiskBody.DiskType = value; }

        /// <summary>When backed by a blob, the URI of underlying blob.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "When backed by a blob, the URI of underlying blob.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string DiskUri { get => DiskBody.Uri ?? null; set => DiskBody.Uri = value; }

        /// <summary>The host caching policy of the disk (i.e. None, ReadOnly, ReadWrite).</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The host caching policy of the disk (i.e. None, ReadOnly, ReadWrite).")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string HostCaching { get => DiskBody.HostCaching ?? null; set => DiskBody.HostCaching = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The resource ID of the VM to which this disk is leased.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string LeasedByLabVMId { get => DiskBody.LeasedByLabVMId ?? null; set => DiskBody.LeasedByLabVMId = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => DiskBody.Location ?? null; set => DiskBody.Location = value; }

        /// <summary>When backed by managed disk, this is the ID of the compute disk resource.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "When backed by managed disk, this is the ID of the compute disk resource.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ManagedDiskId { get => DiskBody.ManagedDiskId ?? null; set => DiskBody.ManagedDiskId = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "When backed by a blob, the storage account where the blob is.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string StorageAccountId { get => DiskBody.StorageAccountId ?? null; set => DiskBody.StorageAccountId = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.IResourceTags Tag { get => DiskBody.Tag ?? null /* object */; set => DiskBody.Tag = value; }
        ...
        /// <returns>a duplicate instance of NewAzDevTestLabsDisk_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets.NewAzDevTestLabsDisk_CreateExpanded Clone()
        {
            var clone = new NewAzDevTestLabsDisk_CreateExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzDevTestLabsDisk_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzDevTestLabsDisk_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DisksCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DisksCreateOrUpdate(SubscriptionId, ResourceGroupName, LabName, UserName, Name, DiskBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,LabName=LabName,UserName=UserName,Name=Name,body=DiskBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, LabName=LabName, UserName=UserName, Name=Name, body=DiskBody })
                    {
