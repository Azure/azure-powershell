...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IEventListener
    {
        ...
        public string Description { get => FormulaBody.Description ?? null; set => FormulaBody.Description = value; }

        /// <summary>Backing field for <see cref="FormulaBody" /> property.</summary>
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.IFormula FormulaBody { get => this._formulaBody; set => this._formulaBody = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.ILabVirtualMachineCreationParameter FormulaContent { get => FormulaBody.Content ?? null /* object */; set => FormulaBody.Content = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => FormulaBody.Location ?? null; set => FormulaBody.Location = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string OSType { get => FormulaBody.OSType ?? null; set => FormulaBody.OSType = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.IResourceTags Tag { get => FormulaBody.Tag ?? null /* object */; set => FormulaBody.Tag = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string VMLabVmid { get => FormulaBody.VMLabVmid ?? null; set => FormulaBody.VMLabVmid = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets.NewAzDevTestLabsFormula_CreateExpanded Clone()
        {
            ...
            clone.FormulaBody = this.FormulaBody;
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FormulasCreateOrUpdate(SubscriptionId, ResourceGroupName, LabName, Name, FormulaBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,LabName=LabName,Name=Name,body=FormulaBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, LabName=LabName, Name=Name, body=FormulaBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, LabName=LabName, Name=Name, body=FormulaBody })
                    {
