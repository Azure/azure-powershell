...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IEventListener
    {
        ...
        public string BlobStorageAbsoluteSasUri { get => ExportResourceUsageParametersBody.BlobStorageAbsoluteSasUri ?? null; set => ExportResourceUsageParametersBody.BlobStorageAbsoluteSasUri = value; }
        ...
        /// <summary>Backing field for <see cref="ExportResourceUsageParametersBody" /> property.</summary>
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.IExportResourceUsageParameters ExportResourceUsageParametersBody { get => this._exportResourceUsageParametersBody; set => this._exportResourceUsageParametersBody = value; }
        ...
        public global::System.DateTime UsageStartDate { get => ExportResourceUsageParametersBody.UsageStartDate ?? default(global::System.DateTime); set => ExportResourceUsageParametersBody.UsageStartDate = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets.ExportAzDevTestLabsLabResourceUsage_ExportViaIdentityExpanded Clone()
        {
            ...
            clone.ExportResourceUsageParametersBody = this.ExportResourceUsageParametersBody;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.LabsExportResourceUsageViaIdentity(InputObject.Id, ExportResourceUsageParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.LabsExportResourceUsage(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.Name ?? null, ExportResourceUsageParametersBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ExportResourceUsageParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ExportResourceUsageParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ExportResourceUsageParametersBody })
                    {
