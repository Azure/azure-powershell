...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Execute=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users/{userName}/servicefabrics/{serviceFabricName}/schedules/{name}/execute"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzDevTestLabsExecuteServiceFabricSchedule_Execute", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzDevTestLabsExecuteServiceFabricSchedule_Execute : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of InvokeAzDevTestLabsExecuteServiceFabricSchedule_Execute</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets.InvokeAzDevTestLabsExecuteServiceFabricSchedule_Execute Clone()
        {
            var clone = new InvokeAzDevTestLabsExecuteServiceFabricSchedule_Execute();
            ...
            clone.ServiceFabricName = this.ServiceFabricName;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzDevTestLabsExecuteServiceFabricSchedule_Execute" /> cmdlet class.
        /// </summary>
        public InvokeAzDevTestLabsExecuteServiceFabricSchedule_Execute()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ServiceFabricSchedulesExecute' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ServiceFabricSchedulesExecute(SubscriptionId, ResourceGroupName, LabName, UserName, ServiceFabricName, Name, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,LabName=LabName,UserName=UserName,ServiceFabricName=ServiceFabricName,Name=Name})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, LabName=LabName, UserName=UserName, ServiceFabricName=ServiceFabricName, Name=Name })
                    {
