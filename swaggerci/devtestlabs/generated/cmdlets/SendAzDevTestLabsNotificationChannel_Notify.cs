...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommunications.Send, @"AzDevTestLabsNotificationChannel_Notify", SupportsShouldProcess = true)]
    ...
    public partial class SendAzDevTestLabsNotificationChannel_Notify : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="NotifyParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.INotifyParameters _notifyParameter;

        /// <summary>Properties for generating a Notification.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Properties for generating a Notification.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Properties for generating a Notification.",
        SerializedName = @"notifyParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.INotifyParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.INotifyParameters NotifyParameter { get => this._notifyParameter; set => this._notifyParameter = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.NotificationChannelsNotify(SubscriptionId, ResourceGroupName, LabName, Name, NotifyParameter, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,LabName=LabName,Name=Name,body=NotifyParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SendAzDevTestLabsNotificationChannel_Notify" /> cmdlet class.
        /// </summary>
        public SendAzDevTestLabsNotificationChannel_Notify()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, LabName=LabName, Name=Name, body=NotifyParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, LabName=LabName, Name=Name, body=NotifyParameter })
                    {
