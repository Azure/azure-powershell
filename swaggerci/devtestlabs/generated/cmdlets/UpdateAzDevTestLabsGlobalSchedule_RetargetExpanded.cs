...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzDevTestLabsGlobalSchedule_RetargetExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzDevTestLabsGlobalSchedule_RetargetExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IEventListener
    {
        ...
        public string CurrentResourceId { get => RetargetSchedulePropertiesBody.CurrentResourceId ?? null; set => RetargetSchedulePropertiesBody.CurrentResourceId = value; }
        ...
        /// <summary>Backing field for <see cref="RetargetSchedulePropertiesBody" /> property.</summary>
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.IRetargetScheduleProperties RetargetSchedulePropertiesBody { get => this._retargetSchedulePropertiesBody; set => this._retargetSchedulePropertiesBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string TargetResourceId { get => RetargetSchedulePropertiesBody.TargetResourceId ?? null; set => RetargetSchedulePropertiesBody.TargetResourceId = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzDevTestLabsGlobalSchedule_RetargetExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets.UpdateAzDevTestLabsGlobalSchedule_RetargetExpanded Clone()
        {
            var clone = new UpdateAzDevTestLabsGlobalSchedule_RetargetExpanded();
            ...
            clone.RetargetSchedulePropertiesBody = this.RetargetSchedulePropertiesBody;
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GlobalSchedulesRetarget(SubscriptionId, ResourceGroupName, Name, RetargetSchedulePropertiesBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Name=Name,body=RetargetSchedulePropertiesBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzDevTestLabsGlobalSchedule_RetargetExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzDevTestLabsGlobalSchedule_RetargetExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=RetargetSchedulePropertiesBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=RetargetSchedulePropertiesBody })
                    {
