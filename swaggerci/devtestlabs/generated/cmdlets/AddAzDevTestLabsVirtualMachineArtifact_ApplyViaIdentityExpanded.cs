...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ApplyArtifacts=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/virtualmachines/{name}/applyArtifacts"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Add, @"AzDevTestLabsVirtualMachineArtifact_ApplyViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Description(@"Apply artifacts to virtual machine. This operation can take a while to complete.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Generated]
    public partial class AddAzDevTestLabsVirtualMachineArtifact_ApplyViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ApplyArtifactsRequestBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.IApplyArtifactsRequest _applyArtifactsRequestBody= new Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.ApplyArtifactsRequest();

        /// <summary>Request body for applying artifacts to a virtual machine.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.IApplyArtifactsRequest ApplyArtifactsRequestBody { get => this._applyArtifactsRequestBody; set => this._applyArtifactsRequestBody = value; }

        /// <summary>The list of artifacts to apply.</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The list of artifacts to apply.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.IArtifactInstallProperties[] Artifact { get => ApplyArtifactsRequestBody.Artifact ?? null /* arrayOf */; set => ApplyArtifactsRequestBody.Artifact = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="AddAzDevTestLabsVirtualMachineArtifact_ApplyViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public AddAzDevTestLabsVirtualMachineArtifact_ApplyViaIdentityExpanded()
        {
        ...
        /// <returns>
        /// a duplicate instance of AddAzDevTestLabsVirtualMachineArtifact_ApplyViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets.AddAzDevTestLabsVirtualMachineArtifact_ApplyViaIdentityExpanded Clone()
        {
            var clone = new AddAzDevTestLabsVirtualMachineArtifact_ApplyViaIdentityExpanded();
            ...
            clone.ApplyArtifactsRequestBody = this.ApplyArtifactsRequestBody;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualMachinesApplyArtifacts' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualMachinesApplyArtifactsViaIdentity(InputObject.Id, ApplyArtifactsRequestBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualMachinesApplyArtifacts(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.LabName ?? null, InputObject.Name ?? null, ApplyArtifactsRequestBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ApplyArtifactsRequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ApplyArtifactsRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ApplyArtifactsRequestBody })
                    {
