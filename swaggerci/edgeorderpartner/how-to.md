# How-To
This document describes how to develop for `Az.EdgeOrderPartnerApiS`.

## Building `Az.EdgeOrderPartnerApiS`
...
## Testing `Az.EdgeOrderPartnerApiS`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Az.EdgeOrderPartnerApiS` into the session.
