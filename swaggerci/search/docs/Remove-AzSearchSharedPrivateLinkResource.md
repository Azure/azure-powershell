...
### Delete (Default)
```
Remove-AzSearchSharedPrivateLinkResource -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzSearchSharedPrivateLinkResource -InputObject <ISearchIdentity> [-ClientRequestId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
