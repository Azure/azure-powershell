...
New-AzSearchService -ResourceGroupName <String> -SearchServiceName <String> -Location <String>
 [-SubscriptionId <String>] [-ClientRequestId <String>] [-HostingMode <HostingMode>]
 [-IdentityType <IdentityType>] [-NetworkRuleSetIPRule <IIPRule[]>] [-PartitionCount <Int32>]
 [-PublicNetworkAccess <PublicNetworkAccess>] [-ReplicaCount <Int32>] [-SkuName <SkuName>] [-Tag <Hashtable>]
