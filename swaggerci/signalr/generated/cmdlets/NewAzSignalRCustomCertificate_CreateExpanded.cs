...
namespace Microsoft.Azure.PowerShell.Cmdlets.SignalR.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/signalR/{resourceName}/customCertificates/{certificateName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzSignalRCustomCertificate_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220201.ICustomCertificate))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SignalR.Description(@"Create or update a custom certificate.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SignalR.Generated]
    public partial class NewAzSignalRCustomCertificate_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220201.ICustomCertificate _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220201.CustomCertificate();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Custom certificate name")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Base uri of the KeyVault that stores certificate.")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string KeyVaultBaseUri { get => _parametersBody.KeyVaultBaseUri ?? null; set => _parametersBody.KeyVaultBaseUri = value; }

        /// <summary>Certificate secret name.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Certificate secret name.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.SignalR.Category(global::Microsoft.Azure.PowerShell.Cmdlets.SignalR.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.SignalR.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string KeyVaultSecretName { get => _parametersBody.KeyVaultSecretName ?? null; set => _parametersBody.KeyVaultSecretName = value; }

        /// <summary>Certificate secret version.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Certificate secret version.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.SignalR.Category(global::Microsoft.Azure.PowerShell.Cmdlets.SignalR.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.SignalR.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string KeyVaultSecretVersion { get => _parametersBody.KeyVaultSecretVersion ?? null; set => _parametersBody.KeyVaultSecretVersion = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220201.ICustomCertificate">Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220201.ICustomCertificate</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220201.ICustomCertificate> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzSignalRCustomCertificate_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.SignalR.Cmdlets.NewAzSignalRCustomCertificate_CreateExpanded Clone()
        {
            var clone = new NewAzSignalRCustomCertificate_CreateExpanded();
            ...
            clone.CertificateName = this.CertificateName;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzSignalRCustomCertificate_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzSignalRCustomCertificate_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SignalRCustomCertificatesCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SignalRCustomCertificatesCreateOrUpdate(SubscriptionId, ResourceGroupName, ResourceName, CertificateName, _parametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ResourceName=ResourceName,CertificateName=CertificateName,body=_parametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ResourceName=ResourceName, CertificateName=CertificateName, body=_parametersBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220201.ICustomCertificate> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220201.ICustomCertificate
