...
namespace Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.SharedPrivateLinkResourceStatus Approved = @"Approved";

        public static Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.SharedPrivateLinkResourceStatus Disconnected = @"Disconnected";

        public static Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.SharedPrivateLinkResourceStatus Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.SharedPrivateLinkResourceStatus Rejected = @"Rejected";

        public static Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.SharedPrivateLinkResourceStatus Timeout = @"Timeout";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.SharedPrivateLinkResourceStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.SharedPrivateLinkResourceStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.SharedPrivateLinkResourceStatus e1, Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.SharedPrivateLinkResourceStatus e2)
        {
            return !e2.Equals(e1);
        }
