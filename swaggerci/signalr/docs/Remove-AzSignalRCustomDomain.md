...
online version: https://docs.microsoft.com/en-us/powershell/module/az.signalr/remove-azsignalrcustomdomain
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzSignalRCustomDomain -Name <String> -ResourceGroupName <String> -ResourceName <String>
...
### DeleteViaIdentity
```
Remove-AzSignalRCustomDomain -InputObject <ISignalRIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
