...
### Restart (Default)
```
Restart-AzSignalR -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestartViaIdentity
```
Restart-AzSignalR -InputObject <ISignalRIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
