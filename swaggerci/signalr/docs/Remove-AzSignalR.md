...
### Delete (Default)
```
Remove-AzSignalR -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzSignalR -InputObject <ISignalRIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
