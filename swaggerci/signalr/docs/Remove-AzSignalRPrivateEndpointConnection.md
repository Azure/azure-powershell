...
online version: https://docs.microsoft.com/en-us/powershell/module/az.signalr/remove-azsignalrprivateendpointconnection
schema: 2.0.0
---

# Remove-AzSignalRPrivateEndpointConnection
...
### Delete (Default)
```
Remove-AzSignalRPrivateEndpointConnection -PrivateEndpointConnectionName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzSignalRPrivateEndpointConnection -InputObject <ISignalRIdentity> [-DefaultProfile <PSObject>]
