...
online version: https://docs.microsoft.com/en-us/powershell/module/az.enterpriseknowledgegraphservice/remove-azenterpriseknowledgegraphserviceenterpriseknowledgegraph
schema: 2.0.0
---

# Remove-AzEnterpriseKnowledgeGraphServiceEnterpriseKnowledgeGraph
...
### Delete (Default)
```
Remove-AzEnterpriseKnowledgeGraphServiceEnterpriseKnowledgeGraph -ResourceGroupName <String>
...
```
Remove-AzEnterpriseKnowledgeGraphServiceEnterpriseKnowledgeGraph
 -InputObject <IEnterpriseKnowledgeGraphServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
