...
namespace Microsoft.Azure.PowerShell.Cmdlets.Datadog.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Datadog/monitors/{monitorName}/tagRules/{ruleSetName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzDatadogTagRule_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20220601.IMonitoringTagRules))]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20220601.IMonitoringTagRules _body = new Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20220601.MonitoringTagRules();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Datadog.MicrosoftDatadogClient Client => Microsoft.Azure.PowerShell.Cmdlets.Datadog.Module.Instance.ClientAPI;
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of filtering tags to be used for capturing logs. This only takes effect if SendResourceLogs flag is enabled. If empty, all resources will be captured. If only Exclude action is specified, the rules will apply to the list of all available resources. If Include actions are specified, the rules will only include resources with the associated tags.")]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20220601.IFilteringTag) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20220601.IFilteringTag[] LogRuleFilteringTag { get => _body.LogRuleFilteringTag ?? null /* arrayOf */; set => _body.LogRuleFilteringTag = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Flag specifying if Azure subscription logs should be sent for the Monitor resource.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Datadog.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Datadog.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"filteringTags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20220601.IFilteringTag) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20220601.IFilteringTag[] MetricRuleFilteringTag { get => _body.MetricRuleFilteringTag ?? null /* arrayOf */; set => _body.MetricRuleFilteringTag = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Rule set name")]
        [Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20220601.IMonitoringTagRules">Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20220601.IMonitoringTagRules</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20220601.IMonitoringTagRules> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzDatadogTagRule_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzDatadogTagRule_CreateExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.TagRulesCreateOrUpdate(SubscriptionId, ResourceGroupName, MonitorName, RuleSetName, _body, onOk, onDefault, this, Pipeline);
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, MonitorName=MonitorName, RuleSetName=RuleSetName, body=_body })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20220601.IMonitoringTagRules> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20220601.IMonitoringTagRules
