...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601
{
    ...
    public partial class RedisUpdateProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.IRedisUpdateProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.IRedisUpdatePropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IValidates
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.ISku Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.IRedisUpdatePropertiesInternal.Sku { get => (this._sku = this._sku ?? new Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.Sku()); set { {_sku = value;} } }
        ...
        public int? SkuCapacity { get => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.ISkuInternal)Sku).Capacity; set => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.ISkuInternal)Sku).Capacity = value ?? default(int); }

        /// <summary>The SKU family to use. Valid values: (C, P). (C = Basic/Standard, P = Premium).</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Origin(Microsoft.Azure.PowerShell.Cmdlets.Redis.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.SkuFamily? SkuFamily { get => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.ISkuInternal)Sku).Family; set => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.ISkuInternal)Sku).Family = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.SkuFamily)""); }

        /// <summary>The type of Redis cache to deploy. Valid values: (Basic, Standard, Premium)</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Origin(Microsoft.Azure.PowerShell.Cmdlets.Redis.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.SkuName? SkuName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.ISkuInternal)Sku).Name; set => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.ISkuInternal)Sku).Name = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.SkuName)""); }
    ...
    /// Patchable properties of the redis cache.
    internal partial interface IRedisUpdatePropertiesInternal :
