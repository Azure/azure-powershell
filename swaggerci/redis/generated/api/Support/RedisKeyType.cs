...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Support
{
    ...
    public partial struct RedisKeyType :
        System.IEquatable<RedisKeyType>
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.RedisKeyType Primary = @"Primary";

        public static Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.RedisKeyType Secondary = @"Secondary";

        /// <summary>the value for an instance of the <see cref="RedisKeyType" /> Enum.</summary>
        private string _value { get; set; }

        /// <summary>Conversion from arbitrary object to RedisKeyType</summary>
        /// <param name="value">the value to convert to an instance of <see cref="RedisKeyType" />.</param>
        internal static object CreateFrom(object value)
        {
            return new RedisKeyType(global::System.Convert.ToString(value));
        }

        /// <summary>Compares values of enum type RedisKeyType</summary>
        /// <param name="e">the value to compare against this instance.</param>
        /// <returns><c>true</c> if the two instances are equal to the same value</returns>
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.RedisKeyType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.RedisKeyType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.RedisKeyType e1, Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.RedisKeyType e2)
        {
            return !e2.Equals(e1);
        }
