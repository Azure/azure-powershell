...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ImportData=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/redis/{name}/import"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Import, @"AzRedisData_ImportExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Description(@"Import data into Redis cache.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Generated]
    public partial class ImportAzRedisData_ImportExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.IImportRdbParameters _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.ImportRdbParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "files to import.")]
        ...
        public string[] File { get => _parametersBody.File ?? null /* arrayOf */; set => _parametersBody.File = value; }

        /// <summary>File format.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "File format.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Redis.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <returns>a duplicate instance of ImportAzRedisData_ImportExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets.ImportAzRedisData_ImportExpanded Clone()
        {
            var clone = new ImportAzRedisData_ImportExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ImportAzRedisData_ImportExpanded" /> cmdlet class.
        /// </summary>
        public ImportAzRedisData_ImportExpanded()
        {
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.Events.DelayBeforePolling:
                    {
                        if (true == MyInvocation?.BoundParameters?.ContainsKey("NoWait"))
                        {
                            ...
                            if (data.ResponseMessage is System.Net.Http.HttpResponseMessage response)
                            {
                                ...
                                WriteObject(new Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.PowerShell.AsyncOperationResponse { Target = uri });
                                // do nothing more.
                                data.Cancel();
                                return;
                            }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'RedisImportData' operation"))
                {
                    if (true == MyInvocation?.BoundParameters?.ContainsKey("AsJob"))
                    {
                        var instance = this.Clone();
                        var job = new Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.PowerShell.AsyncJob(instance, this.MyInvocation.Line, this.MyInvocation.MyCommand.Name, this._cancellationTokenSource.Token, this._cancellationTokenSource.Cancel);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisImportData(ResourceGroupName, Name, SubscriptionId, _parametersBody, onOk, onNoContent, onDefault, this, Pipeline);
