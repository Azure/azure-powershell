...
online version: https://docs.microsoft.com/en-us/powershell/module/az.redis/remove-azredisfirewallrule
schema: 2.0.0
---

# Remove-AzRedisFirewallRule
...
### Delete (Default)
```
Remove-AzRedisFirewallRule -CacheName <String> -ResourceGroupName <String> -RuleName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzRedisFirewallRule -InputObject <IRedisIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
