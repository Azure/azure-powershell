...
online version: https://docs.microsoft.com/en-us/powershell/module/az.redis/import-azredisdata
schema: 2.0.0
---
...
```
Import-AzRedisData -Name <String> -ResourceGroupName <String> -File <String[]> [-SubscriptionId <String>]
 [-Format <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Import
```
Import-AzRedisData -Name <String> -ResourceGroupName <String> -Parameter <IImportRdbParameters>
...
### ImportViaIdentity
```
Import-AzRedisData -InputObject <IRedisIdentity> -Parameter <IImportRdbParameters>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ImportViaIdentityExpanded
```
Import-AzRedisData -InputObject <IRedisIdentity> -File <String[]> [-Format <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.IImportRdbParameters
