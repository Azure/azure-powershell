...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appliances/update-azappliancesappliance
schema: 2.0.0
---

# Update-AzAppliancesAppliance
...
```
Update-AzAppliancesAppliance -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAppliancesAppliance -InputObject <IAppliancesIdentity> [-Tag <Hashtable>]
