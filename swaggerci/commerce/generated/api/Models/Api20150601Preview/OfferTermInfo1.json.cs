...
namespace Microsoft.Azure.PowerShell.Cmdlets.Usage.Models.Api20150601Preview
{
    ...
    public partial class OfferTermInfo1
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Usage.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Usage.Models.Api20150601Preview.IOfferTermInfo1.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.Usage.Models.Api20150601Preview.IOfferTermInfo1 interface is polymorphic,
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Usage.Models.Api20150601Preview.IOfferTermInfo1.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Usage.Models.Api20150601Preview.IOfferTermInfo1 FromJson(Microsoft.Azure.PowerShell.Cmdlets.Usage.Runtime.Json.JsonNode node)
        {
            if (!(node is Microsoft.Azure.PowerShell.Cmdlets.Usage.Runtime.Json.JsonObject json))
            {
                return null;
            }
            ...
            switch ( json.StringProperty("Name") )
            {
                ...
                {
                    return new MonetaryCredit(json);
                }
                case "Monetary Commitment":
                {
                    return new MonetaryCommitment(json);
                }
                case "Recurring Charge":
                {
                    return new RecurringCharge(json);
                }
            }
            return new OfferTermInfo1(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Usage.Runtime.Json.JsonObject into a new instance of <see cref="OfferTermInfo1" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Usage.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal OfferTermInfo1(Microsoft.Azure.PowerShell.Cmdlets.Usage.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="OfferTermInfo1" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Usage.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="OfferTermInfo1" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Usage.Runtime.Json.JsonNode" />.
        /// </returns>
