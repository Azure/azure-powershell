...
namespace Microsoft.Azure.PowerShell.Cmdlets.Logz.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListVmHostUpdate=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logz/monitors/{monitorName}/accounts/{subAccountName}/vmHostUpdate"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzLogzSubAccountVMHostUpdate_ListExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IVMResources))]
    ...
    public partial class GetAzLogzSubAccountVMHostUpdate_ListExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IVMHostUpdateRequest _body = new Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.VMHostUpdateRequest();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Logz.Support.VMHostUpdateStates State { get => _body.State ?? ((Microsoft.Azure.PowerShell.Cmdlets.Logz.Support.VMHostUpdateStates)""); set => _body.State = value; }
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IVMResources) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IVMResources[] VMResourceId { get => _body.VMResourceId ?? null /* arrayOf */; set => _body.VMResourceId = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IVMResourcesListResponse">Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IVMResourcesListResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IVMResourcesListResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzLogzSubAccountVMHostUpdate_ListExpanded" /> cmdlet class.
        /// </summary>
        public GetAzLogzSubAccountVMHostUpdate_ListExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SubAccountListVMHostUpdate' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SubAccountListVMHostUpdate(SubscriptionId, ResourceGroupName, MonitorName, SubAccountName, _body, onOk, onDefault, this, Pipeline);
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, MonitorName=MonitorName, SubAccountName=SubAccountName, body=_body })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IVMResourcesListResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        ...
                        {
                            requestMessage = requestMessage.Clone(new global::System.Uri( _nextLink ),Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Method.Get );
                            ...
                            await this.Client.SubAccountListVMHostUpdate_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
