...
namespace Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401
{
    ...
    public partial class SupportTicketDetailsProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.ISupportTicketDetailsProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.ISupportTicketDetailsProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.ISupportTicketDetailsProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode node)
        {
        ...
        internal SupportTicketDetailsProperties(Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject json)
        {
            ...
            {_contactDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject>("contactDetails"), out var __jsonContactDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.ContactProfile.FromJson(__jsonContactDetails) : ContactDetail;}
            {_serviceLevelAgreement = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject>("serviceLevelAgreement"), out var __jsonServiceLevelAgreement) ? Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.ServiceLevelAgreement.FromJson(__jsonServiceLevelAgreement) : ServiceLevelAgreement;}
            {_supportEngineer = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject>("supportEngineer"), out var __jsonSupportEngineer) ? Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.SupportEngineer.FromJson(__jsonSupportEngineer) : SupportEngineer;}
            {_technicalTicketDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject>("technicalTicketDetails"), out var __jsonTechnicalTicketDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.TechnicalTicketDetails.FromJson(__jsonTechnicalTicketDetails) : TechnicalTicketDetail;}
            {_quotaTicketDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject>("quotaTicketDetails"), out var __jsonQuotaTicketDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.QuotaTicketDetails.FromJson(__jsonQuotaTicketDetails) : QuotaTicketDetail;}
            {_supportTicketId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonString>("supportTicketId"), out var __jsonSupportTicketId) ? (string)__jsonSupportTicketId : (string)SupportTicketId;}
            ...
            {_problemClassificationId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonString>("problemClassificationId"), out var __jsonProblemClassificationId) ? (string)__jsonProblemClassificationId : (string)ProblemClassificationId;}
            {_problemClassificationDisplayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonString>("problemClassificationDisplayName"), out var __jsonProblemClassificationDisplayName) ? (string)__jsonProblemClassificationDisplayName : (string)ProblemClassificationDisplayName;}
            ...
            {_enrollmentId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonString>("enrollmentId"), out var __jsonEnrollmentId) ? (string)__jsonEnrollmentId : (string)EnrollmentId;}
            {_require24X7Response = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonBoolean>("require24X7Response"), out var __jsonRequire24X7Response) ? (bool?)__jsonRequire24X7Response : Require24X7Response;}
            {_supportPlanType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonString>("supportPlanType"), out var __jsonSupportPlanType) ? (string)__jsonSupportPlanType : (string)SupportPlanType;}
            {_title = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonString>("title"), out var __jsonTitle) ? (string)__jsonTitle : (string)Title;}
            {_problemStartTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonString>("problemStartTime"), out var __jsonProblemStartTime) ? global::System.DateTime.TryParse((string)__jsonProblemStartTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonProblemStartTimeValue) ? __jsonProblemStartTimeValue : ProblemStartTime : ProblemStartTime;}
            {_serviceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonString>("serviceId"), out var __jsonServiceId) ? (string)__jsonServiceId : (string)ServiceId;}
            {_serviceDisplayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonString>("serviceDisplayName"), out var __jsonServiceDisplayName) ? (string)__jsonServiceDisplayName : (string)ServiceDisplayName;}
