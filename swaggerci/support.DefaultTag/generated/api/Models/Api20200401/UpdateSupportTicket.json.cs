...
namespace Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401
{
    ...
    public partial class UpdateSupportTicket
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.IUpdateSupportTicket.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.IUpdateSupportTicket.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.IUpdateSupportTicket FromJson(Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject json ? new UpdateSupportTicket(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UpdateSupportTicket" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UpdateSupportTicket" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode" />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject into a new instance of <see cref="UpdateSupportTicket" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal UpdateSupportTicket(Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_contactDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject>("contactDetails"), out var __jsonContactDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.UpdateContactProfile.FromJson(__jsonContactDetails) : ContactDetail;}
            {_severity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonString>("severity"), out var __jsonSeverity) ? (string)__jsonSeverity : (string)Severity;}
            {_status = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonString>("status"), out var __jsonStatus) ? (string)__jsonStatus : (string)Status;}
            AfterFromJson(json);
        }
    }
}