...
namespace Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401
{
    ...
    public partial class TechnicalTicketDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.ITechnicalTicketDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.ITechnicalTicketDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.ITechnicalTicketDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject json ? new TechnicalTicketDetails(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject into a new instance of <see cref="TechnicalTicketDetails" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal TechnicalTicketDetails(Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject json)
        {
            ...
            {_resourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonString>("resourceId"), out var __jsonResourceId) ? (string)__jsonResourceId : (string)ResourceId;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="TechnicalTicketDetails" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="TechnicalTicketDetails" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._resourceId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonString(this._resourceId.ToString()) : null, "resourceId" ,container.Add );
