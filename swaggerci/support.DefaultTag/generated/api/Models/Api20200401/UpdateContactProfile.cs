...
namespace Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401
{
    ...
    public partial class UpdateContactProfile :
        Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.IUpdateContactProfile,
        Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.IUpdateContactProfileInternal
    {

        /// <summary>Backing field for <see cref="AdditionalEmailAddress" /> property.</summary>
        private string[] _additionalEmailAddress;
        ...
        public string[] AdditionalEmailAddress { get => this._additionalEmailAddress; set => this._additionalEmailAddress = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Support.Support.PreferredContactMethod? _preferredContactMethod;

        /// <summary>Preferred contact method.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Support.Origin(Microsoft.Azure.PowerShell.Cmdlets.Support.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Support.Support.PreferredContactMethod? PreferredContactMethod { get => this._preferredContactMethod; set => this._preferredContactMethod = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.IJsonSerializable
    {
        ...
        string[] AdditionalEmailAddress { get; set; }
        /// <summary>Country of the user. This is the ISO 3166-1 alpha-3 code.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Support.Support.PreferredContactMethod? PreferredContactMethod { get; set; }
        /// <summary>
        /// Preferred language of support from Azure. Support languages vary based on the severity you choose for your support ticket.
        /// Learn more at [Azure Severity and responsiveness](https://azure.microsoft.com/support/plans/response/). Use the standard
        /// language-country code. Valid values are 'en-us' for English, 'zh-hans' for Chinese, 'es-es' for Spanish, 'fr-fr' for French,
