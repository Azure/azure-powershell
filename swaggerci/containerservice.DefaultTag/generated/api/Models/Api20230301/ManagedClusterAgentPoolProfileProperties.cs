...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301
{
    ...
    public partial class ManagedClusterAgentPoolProfileProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IManagedClusterAgentPoolProfileProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IManagedClusterAgentPoolProfilePropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ICreationData _creationData;

        /// <summary>
        /// CreationData to be used to specify the source Snapshot ID if the node pool will be created/upgraded using a snapshot.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ICreationData CreationData { get => (this._creationData = this._creationData ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.CreationData()); set => this._creationData = value; }
        ...
        public string CreationDataSourceResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ICreationDataInternal)CreationData).SourceResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ICreationDataInternal)CreationData).SourceResourceId = value ?? null; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfig _kubeletConfig;

        /// <summary>The Kubelet configuration on the agent pool nodes.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfig KubeletConfig { get => (this._kubeletConfig = this._kubeletConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.KubeletConfig()); set => this._kubeletConfig = value; }

        /// <summary>Allowed list of unsafe sysctls or unsafe sysctl patterns (ending in `*`).</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string[] KubeletConfigAllowedUnsafeSysctl { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).AllowedUnsafeSysctl; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).AllowedUnsafeSysctl = value ?? null /* arrayOf */; }

        /// <summary>
        /// The maximum number of container log files that can be present for a container. The number must be ≥ 2.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public int? KubeletConfigContainerLogMaxFile { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).ContainerLogMaxFile; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).ContainerLogMaxFile = value ?? default(int); }

        /// <summary>The maximum size (e.g. 10Mi) of container log file before it is rotated.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public int? KubeletConfigContainerLogMaxSizeMb { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).ContainerLogMaxSizeMb; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).ContainerLogMaxSizeMb = value ?? default(int); }

        /// <summary>The default is true.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public bool? KubeletConfigCpuCfsQuota { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).CpuCfsQuota; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).CpuCfsQuota = value ?? default(bool); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string KubeletConfigCpuCfsQuotaPeriod { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).CpuCfsQuotaPeriod; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).CpuCfsQuotaPeriod = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string KubeletConfigCpuManagerPolicy { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).CpuManagerPolicy; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).CpuManagerPolicy = value ?? null; }

        /// <summary>
        /// If set to true it will make the Kubelet fail to start if swap is enabled on the node.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public bool? KubeletConfigFailSwapOn { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).FailSwapOn; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).FailSwapOn = value ?? default(bool); }

        /// <summary>To disable image garbage collection, set to 100. The default is 85%</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public int? KubeletConfigImageGcHighThreshold { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).ImageGcHighThreshold; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).ImageGcHighThreshold = value ?? default(int); }

        /// <summary>This cannot be set higher than imageGcHighThreshold. The default is 80%</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public int? KubeletConfigImageGcLowThreshold { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).ImageGcLowThreshold; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).ImageGcLowThreshold = value ?? default(int); }

        /// <summary>The maximum number of processes per pod.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public int? KubeletConfigPodMaxPid { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).PodMaxPid; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).PodMaxPid = value ?? default(int); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string KubeletConfigTopologyManagerPolicy { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).TopologyManagerPolicy; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfigInternal)KubeletConfig).TopologyManagerPolicy = value ?? null; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ILinuxOSConfig _linuxOSConfig;

        /// <summary>The OS configuration of Linux agent nodes.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ILinuxOSConfig LinuxOSConfig { get => (this._linuxOSConfig = this._linuxOSConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.LinuxOSConfig()); set => this._linuxOSConfig = value; }

        /// <summary>The size in MB of a swap file that will be created on each node.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public int? LinuxOSConfigSwapFileSizeMb { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ILinuxOSConfigInternal)LinuxOSConfig).SwapFileSizeMb; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ILinuxOSConfigInternal)LinuxOSConfig).SwapFileSizeMb = value ?? default(int); }

        /// <summary>Sysctl settings for Linux agent nodes.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ISysctlConfig LinuxOSConfigSysctl { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ILinuxOSConfigInternal)LinuxOSConfig).Sysctl; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ILinuxOSConfigInternal)LinuxOSConfig).Sysctl = value ?? null /* model class */; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string LinuxOSConfigTransparentHugePageDefrag { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ILinuxOSConfigInternal)LinuxOSConfig).TransparentHugePageDefrag; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ILinuxOSConfigInternal)LinuxOSConfig).TransparentHugePageDefrag = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string LinuxOSConfigTransparentHugePageEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ILinuxOSConfigInternal)LinuxOSConfig).TransparentHugePageEnabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ILinuxOSConfigInternal)LinuxOSConfig).TransparentHugePageEnabled = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ICreationData Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IManagedClusterAgentPoolProfilePropertiesInternal.CreationData { get => (this._creationData = this._creationData ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.CreationData()); set { {_creationData = value;} } }

        /// <summary>Internal Acessors for CurrentOrchestratorVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IManagedClusterAgentPoolProfilePropertiesInternal.CurrentOrchestratorVersion { get => this._currentOrchestratorVersion; set { {_currentOrchestratorVersion = value;} } }

        /// <summary>Internal Acessors for KubeletConfig</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfig Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IManagedClusterAgentPoolProfilePropertiesInternal.KubeletConfig { get => (this._kubeletConfig = this._kubeletConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.KubeletConfig()); set { {_kubeletConfig = value;} } }

        /// <summary>Internal Acessors for LinuxOSConfig</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ILinuxOSConfig Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IManagedClusterAgentPoolProfilePropertiesInternal.LinuxOSConfig { get => (this._linuxOSConfig = this._linuxOSConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.LinuxOSConfig()); set { {_linuxOSConfig = value;} } }

        /// <summary>Internal Acessors for NodeImageVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IManagedClusterAgentPoolProfilePropertiesInternal.NodeImageVersion { get => this._nodeImageVersion; set { {_nodeImageVersion = value;} } }

        /// <summary>Internal Acessors for PowerState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IPowerState Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IManagedClusterAgentPoolProfilePropertiesInternal.PowerState { get => (this._powerState = this._powerState ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.PowerState()); set { {_powerState = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IManagedClusterAgentPoolProfilePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for UpgradeSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IAgentPoolUpgradeSettings Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IManagedClusterAgentPoolProfilePropertiesInternal.UpgradeSetting { get => (this._upgradeSetting = this._upgradeSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.AgentPoolUpgradeSettings()); set { {_upgradeSetting = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IManagedClusterAgentPoolProfilePropertiesNodeLabels _nodeLabel;

        /// <summary>The node labels to be persisted across all nodes in agent pool.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IManagedClusterAgentPoolProfilePropertiesNodeLabels NodeLabel { get => (this._nodeLabel = this._nodeLabel ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ManagedClusterAgentPoolProfilePropertiesNodeLabels()); set => this._nodeLabel = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IPowerState PowerState { get => (this._powerState = this._powerState ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.PowerState()); set => this._powerState = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IManagedClusterAgentPoolProfilePropertiesTags _tag;

        /// <summary>The tags to be persisted on the agent pool virtual machine scale set.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IManagedClusterAgentPoolProfilePropertiesTags Tag { get => (this._tag = this._tag ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ManagedClusterAgentPoolProfilePropertiesTags()); set => this._tag = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IAgentPoolUpgradeSettings _upgradeSetting;

        /// <summary>Settings for upgrading the agentpool</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IAgentPoolUpgradeSettings UpgradeSetting { get => (this._upgradeSetting = this._upgradeSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.AgentPoolUpgradeSettings()); set => this._upgradeSetting = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string UpgradeSettingMaxSurge { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IAgentPoolUpgradeSettingsInternal)UpgradeSetting).MaxSurge; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IAgentPoolUpgradeSettingsInternal)UpgradeSetting).MaxSurge = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ISysctlConfig LinuxOSConfigSysctl { get; set; }
        /// <summary>
        /// Valid values are 'always', 'defer', 'defer+madvise', 'madvise' and 'never'. The default is 'madvise'. For more information
        /// see [Transparent Hugepages](https://www.kernel.org/doc/html/latest/admin-guide/mm/transhuge.html#admin-guide-transhuge).
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IManagedClusterAgentPoolProfilePropertiesNodeLabels NodeLabel { get; set; }
        /// <summary>
        /// This is of the form: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/publicIPPrefixes/{publicIPPrefixName}
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IManagedClusterAgentPoolProfilePropertiesTags Tag { get; set; }
        /// <summary>The type of Agent Pool.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        /// CreationData to be used to specify the source Snapshot ID if the node pool will be created/upgraded using a snapshot.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ICreationData CreationData { get; set; }
        /// <summary>This is the ARM ID of the source object to be used to create the target object.</summary>
        string CreationDataSourceResourceId { get; set; }
        /// <summary>
        /// If orchestratorVersion is a fully specified version <major.minor.patch>, this field will be exactly equal to it. If orchestratorVersion
        ...
        string HostGroupId { get; set; }
        /// <summary>The Kubelet configuration on the agent pool nodes.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IKubeletConfig KubeletConfig { get; set; }
        /// <summary>Allowed list of unsafe sysctls or unsafe sysctl patterns (ending in `*`).</summary>
        string[] KubeletConfigAllowedUnsafeSysctl { get; set; }
        /// <summary>
        /// The maximum number of container log files that can be present for a container. The number must be ≥ 2.
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.KubeletDiskType? KubeletDiskType { get; set; }
        /// <summary>The OS configuration of Linux agent nodes.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ILinuxOSConfig LinuxOSConfig { get; set; }
        /// <summary>The size in MB of a swap file that will be created on each node.</summary>
        int? LinuxOSConfigSwapFileSizeMb { get; set; }
        /// <summary>Sysctl settings for Linux agent nodes.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ISysctlConfig LinuxOSConfigSysctl { get; set; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.AgentPoolType? Type { get; set; }
        /// <summary>Settings for upgrading the agentpool</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IAgentPoolUpgradeSettings UpgradeSetting { get; set; }
        /// <summary>
        /// This can either be set to an integer (e.g. '5') or a percentage (e.g. '50%'). If a percentage is specified, it is the
        /// percentage of the total agent pool size at the time of the upgrade. For percentages, fractional nodes are rounded up.
        /// If not specified, the default is 1. For more information, including best practices, see: https://docs.microsoft.com/azure/aks/upgrade-cluster#customize-node-surge-upgrade
