...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.ConnectionStatus Approved = @"Approved";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.ConnectionStatus Disconnected = @"Disconnected";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.ConnectionStatus Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.ConnectionStatus Rejected = @"Rejected";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.ConnectionStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.ConnectionStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.ConnectionStatus e1, Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.ConnectionStatus e2)
        {
            return !e2.Equals(e1);
        }
