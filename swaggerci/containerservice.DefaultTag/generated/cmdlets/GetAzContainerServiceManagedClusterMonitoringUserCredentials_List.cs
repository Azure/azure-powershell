...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListClusterMonitoringUserCredentials=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/listClusterMonitoringUserCredential"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzContainerServiceManagedClusterMonitoringUserCredentials_List", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ICredentialResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Description(@"Lists the cluster monitoring user credentials of a managed cluster.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Generated]
    public partial class GetAzContainerServiceManagedClusterMonitoringUserCredentials_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ServerFqdn" /> property.</summary>
        private string _serverFqdn;

        /// <summary>server fqdn type for credentials to be returned</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "server fqdn type for credentials to be returned")]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Query)]
        public string ServerFqdn { get => this._serverFqdn; set => this._serverFqdn = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ICredentialResults">Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ICredentialResults</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ICredentialResults> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzContainerServiceManagedClusterMonitoringUserCredentials_List" /> cmdlet
        /// class.
        /// </summary>
        public GetAzContainerServiceManagedClusterMonitoringUserCredentials_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ManagedClustersListClusterMonitoringUserCredentials' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ManagedClustersListClusterMonitoringUserCredentials(SubscriptionId, ResourceGroupName, ResourceName, this.InvocationInformation.BoundParameters.ContainsKey("ServerFqdn") ? ServerFqdn : null, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ICredentialResults> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // nested-array / kubeconfigs / <none>
                WriteObject((await response).Kubeconfig, true);
            }
        }
    }
}