...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzContainerServiceManagedClusterCommand_Run", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IRunCommandResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Description(@"AKS will create a pod to run the command. This is primarily useful for private clusters. For more information see [AKS Run Command](https://docs.microsoft.com/azure/aks/private-clusters#aks-run-command-preview).")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Generated]
    public partial class StartAzContainerServiceManagedClusterCommand_Run : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="RequestPayload" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IRunCommandRequest _requestPayload;

        /// <summary>A run command request</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "A run command request", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IRunCommandRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IRunCommandRequest RequestPayload { get => this._requestPayload; set => this._requestPayload = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IRunCommandResult">Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IRunCommandResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IRunCommandResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of StartAzContainerServiceManagedClusterCommand_Run</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Cmdlets.StartAzContainerServiceManagedClusterCommand_Run Clone()
        {
            var clone = new StartAzContainerServiceManagedClusterCommand_Run();
            ...
            clone.RequestPayload = this.RequestPayload;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ManagedClustersRunCommand(SubscriptionId, ResourceGroupName, ResourceName, RequestPayload, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ResourceName=ResourceName,body=RequestPayload})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzContainerServiceManagedClusterCommand_Run" /> cmdlet class.
        /// </summary>
        public StartAzContainerServiceManagedClusterCommand_Run()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ResourceName=ResourceName, body=RequestPayload })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ResourceName=ResourceName, body=RequestPayload })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IRunCommandResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20230301.IRunCommandResult
