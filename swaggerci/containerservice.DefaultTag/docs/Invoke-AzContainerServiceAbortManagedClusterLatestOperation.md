...
online version: https://learn.microsoft.com/powershell/module/az.containerservice/invoke-azcontainerserviceabortmanagedclusterlatestoperation
schema: 2.0.0
---

# Invoke-AzContainerServiceAbortManagedClusterLatestOperation
...
### Abort (Default)
```
Invoke-AzContainerServiceAbortManagedClusterLatestOperation -ResourceGroupName <String> -ResourceName <String>
...
### AbortViaIdentity
```
Invoke-AzContainerServiceAbortManagedClusterLatestOperation -InputObject <IContainerServiceIdentity>
