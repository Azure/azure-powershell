...
online version: https://learn.microsoft.com/powershell/module/az.containerservice/update-azcontainerserviceagentpoolnodeimageversion
schema: 2.0.0
---
...
### Upgrade (Default)
```
Update-AzContainerServiceAgentPoolNodeImageVersion -AgentPoolName <String> -ResourceGroupName <String>
...
### UpgradeViaIdentity
```
Update-AzContainerServiceAgentPoolNodeImageVersion -InputObject <IContainerServiceIdentity>
