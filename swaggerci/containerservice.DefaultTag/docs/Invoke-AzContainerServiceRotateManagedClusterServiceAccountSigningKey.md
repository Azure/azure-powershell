...
online version: https://learn.microsoft.com/powershell/module/az.containerservice/invoke-azcontainerservicerotatemanagedclusterserviceaccountsigningkey
schema: 2.0.0
---
...
### Rotate (Default)
```
Invoke-AzContainerServiceRotateManagedClusterServiceAccountSigningKey -ResourceGroupName <String>
...
### RotateViaIdentity
```
Invoke-AzContainerServiceRotateManagedClusterServiceAccountSigningKey -InputObject <IContainerServiceIdentity>
