...
online version: https://learn.microsoft.com/powershell/module/az.containerservice/start-azcontainerservicemanagedcluster
schema: 2.0.0
---

# Start-AzContainerServiceManagedCluster
...
### Start (Default)
```
Start-AzContainerServiceManagedCluster -ResourceGroupName <String> -ResourceName <String>
...
### StartViaIdentity
```
Start-AzContainerServiceManagedCluster -InputObject <IContainerServiceIdentity> [-DefaultProfile <PSObject>]
