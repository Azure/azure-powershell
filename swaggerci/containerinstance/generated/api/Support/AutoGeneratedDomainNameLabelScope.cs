...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.AutoGeneratedDomainNameLabelScope Noreuse = @"Noreuse";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.AutoGeneratedDomainNameLabelScope ResourceGroupReuse = @"ResourceGroupReuse";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.AutoGeneratedDomainNameLabelScope SubscriptionReuse = @"SubscriptionReuse";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.AutoGeneratedDomainNameLabelScope TenantReuse = @"TenantReuse";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.AutoGeneratedDomainNameLabelScope Unsecure = @"Unsecure";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.AutoGeneratedDomainNameLabelScope e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.AutoGeneratedDomainNameLabelScope e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.AutoGeneratedDomainNameLabelScope e1, Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.AutoGeneratedDomainNameLabelScope e2)
        {
            return !e2.Equals(e1);
        }
