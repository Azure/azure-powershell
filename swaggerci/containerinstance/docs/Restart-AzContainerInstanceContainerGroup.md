...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerinstance/restart-azcontainerinstancecontainergroup
schema: 2.0.0
---

# Restart-AzContainerInstanceContainerGroup
...
### Restart (Default)
```
Restart-AzContainerInstanceContainerGroup -Name <String> -ResourceGroupName <String>
...
### RestartViaIdentity
```
Restart-AzContainerInstanceContainerGroup -InputObject <IContainerInstanceIdentity>
