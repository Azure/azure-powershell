...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api202101
{
    ...
    public partial class Export :
        Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api202101.IExport,
        Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api202101.IExportInternal
    {

        /// <summary>Backing field for <see cref="BlobList" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api202101.IExportBlobList _blobList;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api202101.IExportBlobList BlobList { get => (this._blobList = this._blobList ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api202101.ExportBlobList()); set => this._blobList = value; }
        ...
        public string[] BlobListBlobPathPrefix { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api202101.IExportBlobListInternal)BlobList).BlobPathPrefix; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api202101.IExportBlobListInternal)BlobList).BlobPathPrefix = value ?? null /* arrayOf */; }

        /// <summary>A collection of blob-path strings.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.PropertyOrigin.Inlined)]
        public string[] BlobPath { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api202101.IExportBlobListInternal)BlobList).BlobPath; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api202101.IExportBlobListInternal)BlobList).BlobPath = value ?? null /* arrayOf */; }

        /// <summary>Internal Acessors for BlobList</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api202101.IExportBlobList Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api202101.IExportInternal.BlobList { get => (this._blobList = this._blobList ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api202101.ExportBlobList()); set { {_blobList = value;} } }
    ...
    {
        /// <summary>A list of the blobs to be exported.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api202101.IExportBlobList BlobList { get; set; }
        /// <summary>
        /// The relative URI to the block blob that contains the list of blob paths or blob path prefixes as defined above, beginning
        /// with the container name. If the blob is in root container, the URI must begin with $root.
        /// </summary>
