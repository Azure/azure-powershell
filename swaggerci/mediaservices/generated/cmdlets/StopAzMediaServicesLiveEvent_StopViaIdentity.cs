...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Stop=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/mediaservices/{accountName}/liveEvents/{liveEventName}/stop"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Stop, @"AzMediaServicesLiveEvent_StopViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Description(@"Stops a running live event.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Generated]
    public partial class StopAzMediaServicesLiveEvent_StopViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.ILiveEventActionInput _parameter;

        /// <summary>The LiveEvent action input parameter definition.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The LiveEvent action input parameter definition.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The LiveEvent action input parameter definition.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.ILiveEventActionInput) })]
        public Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.ILiveEventActionInput Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <returns>a duplicate instance of StopAzMediaServicesLiveEvent_StopViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Cmdlets.StopAzMediaServicesLiveEvent_StopViaIdentity Clone()
        {
            var clone = new StopAzMediaServicesLiveEvent_StopViaIdentity();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'LiveEventsStop' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.LiveEventsStopViaIdentity(InputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.LiveEventsStop(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.LiveEventName ?? null, Parameter, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StopAzMediaServicesLiveEvent_StopViaIdentity" /> cmdlet class.
        /// </summary>
        public StopAzMediaServicesLiveEvent_StopViaIdentity()
        {
