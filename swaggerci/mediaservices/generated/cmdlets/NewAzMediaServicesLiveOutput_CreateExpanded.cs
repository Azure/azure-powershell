...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Create=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/mediaservices/{accountName}/liveEvents/{liveEventName}/liveOutputs/{liveOutputName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzMediaServicesLiveOutput_CreateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Description(@"Creates a new live output.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Generated]
    public partial class NewAzMediaServicesLiveOutput_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.ILiveOutput _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.LiveOutput();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "ISO 8601 time between 1 minute to 25 hours to indicate the maximum content length that can be archived in the asset for this live output. This also sets the maximum content length for the rewind window. For example, use PT1H30M to indicate 1 hour and 30 minutes of archive window.")]
        ...
        public global::System.TimeSpan ArchiveWindowLength { get => _parametersBody.ArchiveWindowLength ?? default(global::System.TimeSpan); set => _parametersBody.ArchiveWindowLength = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The asset that the live output will write to.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AssetName { get => _parametersBody.AssetName ?? null; set => _parametersBody.AssetName = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The description of the live output.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The number of fragments in an HTTP Live Streaming (HLS) TS segment in the output of the live event. This value does not affect the packing ratio for HLS CMAF output.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public int HlFragmentsPerTsSegment { get => _parametersBody.HlFragmentsPerTsSegment ?? default(int); set => _parametersBody.HlFragmentsPerTsSegment = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The manifest file name. If not provided, the service will generate one automatically.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ManifestName { get => _parametersBody.ManifestName ?? null; set => _parametersBody.ManifestName = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The initial timestamp that the live output will start at, any content before this value will not be archived.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public long OutputSnapTime { get => _parametersBody.OutputSnapTime ?? default(long); set => _parametersBody.OutputSnapTime = value; }
        ...
        /// <returns>a duplicate instance of NewAzMediaServicesLiveOutput_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Cmdlets.NewAzMediaServicesLiveOutput_CreateExpanded Clone()
        {
            var clone = new NewAzMediaServicesLiveOutput_CreateExpanded();
            ...
            clone.LiveEventName = this.LiveEventName;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzMediaServicesLiveOutput_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzMediaServicesLiveOutput_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'LiveOutputsCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.LiveOutputsCreate(SubscriptionId, ResourceGroupName, AccountName, LiveEventName, Name, _parametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,AccountName=AccountName,LiveEventName=LiveEventName,Name=Name,body=_parametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, AccountName=AccountName, LiveEventName=LiveEventName, Name=Name, body=_parametersBody })
                    {
