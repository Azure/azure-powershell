...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/mediaServices/{accountName}/transforms/{transformName}/jobs/{jobName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMediaServicesJob_UpdateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IJob))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Description(@"Update is only supported for description and priority. Updating Priority will take effect when the Job state is Queued or Scheduled and depending on the timing the priority update may be ignored.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Generated]
    public partial class UpdateAzMediaServicesJob_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.IEventListener
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IJob _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.Job();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Customer provided key, value pairs that will be returned in Job and JobOutput state events.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IJobPropertiesCorrelationData CorrelationData { get => _parametersBody.CorrelationData ?? null /* object */; set => _parametersBody.CorrelationData = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Optional customer supplied description of the Job.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The discriminator for derived types.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string InputOdataType { get => _parametersBody.InputOdataType ?? null; set => _parametersBody.InputOdataType = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The Job name.")]
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The outputs for the Job.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IJobOutput[] Output { get => _parametersBody.Output ?? null /* arrayOf */; set => _parametersBody.Output = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Priority with which the job should be processed. Higher priority jobs are processed before lower priority jobs. If not set, the default is normal.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support.Priority))]
        public Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support.Priority Priority { get => _parametersBody.Priority ?? ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support.Priority)""); set => _parametersBody.Priority = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The Transform name.")]
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IJob">Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IJob</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IJob> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.JobsUpdate(SubscriptionId, ResourceGroupName, AccountName, TransformName, Name, _parametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,AccountName=AccountName,TransformName=TransformName,Name=Name,body=_parametersBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzMediaServicesJob_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzMediaServicesJob_UpdateExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, AccountName=AccountName, TransformName=TransformName, Name=Name, body=_parametersBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IJob> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IJob
