...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support";
