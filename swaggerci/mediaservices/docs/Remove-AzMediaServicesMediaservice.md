...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/remove-azmediaservicesmediaservice
schema: 2.0.0
---

# Remove-AzMediaServicesMediaservice
...
### Delete (Default)
```
Remove-AzMediaServicesMediaservice -AccountName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMediaServicesMediaservice -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
