...
### Get (Default)
```
Get-AzMediaServicesOperationResult -AccountName <String> -AssetName <String> -OperationId <String>
...
### GetViaIdentity
```
Get-AzMediaServicesOperationResult -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [<CommonParameters>]
```
