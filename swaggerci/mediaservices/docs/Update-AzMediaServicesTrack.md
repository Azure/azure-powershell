...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/update-azmediaservicestrack
schema: 2.0.0
---

# Update-AzMediaServicesTrack
...
```
Update-AzMediaServicesTrack -AccountName <String> -AssetName <String> -Name <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-TrackOdataType <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzMediaServicesTrack -InputObject <IMediaServicesIdentity> [-TrackOdataType <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
