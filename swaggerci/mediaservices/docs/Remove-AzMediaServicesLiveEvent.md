...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/remove-azmediaservicesliveevent
schema: 2.0.0
---

# Remove-AzMediaServicesLiveEvent
...
### Delete (Default)
```
Remove-AzMediaServicesLiveEvent -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzMediaServicesLiveEvent -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>] [-AsJob]
