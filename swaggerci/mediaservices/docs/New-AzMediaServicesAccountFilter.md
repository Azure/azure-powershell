...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/new-azmediaservicesaccountfilter
schema: 2.0.0
---

# New-AzMediaServicesAccountFilter
...
```
New-AzMediaServicesAccountFilter -AccountName <String> -FilterName <String> -ResourceGroupName <String>
