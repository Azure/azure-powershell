...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/start-azmediaservicesliveevent
schema: 2.0.0
---

# Start-AzMediaServicesLiveEvent
...
### Start (Default)
```
Start-AzMediaServicesLiveEvent -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### StartViaIdentity
```
Start-AzMediaServicesLiveEvent -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>] [-AsJob]
