...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/remove-azmediaservicesasset
schema: 2.0.0
---

# Remove-AzMediaServicesAsset
...
### Delete (Default)
```
Remove-AzMediaServicesAsset -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMediaServicesAsset -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>] [-PassThru]
