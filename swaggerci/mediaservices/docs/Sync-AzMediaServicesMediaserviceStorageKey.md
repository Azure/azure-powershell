...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/sync-azmediaservicesmediaservicestoragekey
schema: 2.0.0
---
...
```
Sync-AzMediaServicesMediaserviceStorageKey -AccountName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-Id <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### SyncViaIdentity
```
Sync-AzMediaServicesMediaserviceStorageKey -InputObject <IMediaServicesIdentity>
 -Parameter <ISyncStorageKeysInput> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SyncViaIdentityExpanded
```
Sync-AzMediaServicesMediaserviceStorageKey -InputObject <IMediaServicesIdentity> [-Id <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20210601.ISyncStorageKeysInput
