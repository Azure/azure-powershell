...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/get-azmediaservicesstreamingpolicy
schema: 2.0.0
---

# Get-AzMediaServicesStreamingPolicy
...
### List (Default)
```
Get-AzMediaServicesStreamingPolicy -AccountName <String> -ResourceGroupName <String>
...
### Get
```
Get-AzMediaServicesStreamingPolicy -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMediaServicesStreamingPolicy -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
