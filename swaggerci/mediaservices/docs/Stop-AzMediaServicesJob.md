...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/stop-azmediaservicesjob
schema: 2.0.0
---

# Stop-AzMediaServicesJob
...
### Cancel (Default)
```
Stop-AzMediaServicesJob -AccountName <String> -Name <String> -ResourceGroupName <String>
 -TransformName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-AzMediaServicesJob -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>] [-PassThru]
