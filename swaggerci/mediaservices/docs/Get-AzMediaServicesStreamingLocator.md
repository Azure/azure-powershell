...
### List (Default)
```
Get-AzMediaServicesStreamingLocator -AccountName <String> -ResourceGroupName <String>
...
### Get
```
Get-AzMediaServicesStreamingLocator -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMediaServicesStreamingLocator -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
