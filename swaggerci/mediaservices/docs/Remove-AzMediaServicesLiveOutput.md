...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/remove-azmediaservicesliveoutput
schema: 2.0.0
---

# Remove-AzMediaServicesLiveOutput
...
### Delete (Default)
```
Remove-AzMediaServicesLiveOutput -AccountName <String> -LiveEventName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzMediaServicesLiveOutput -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>] [-AsJob]
