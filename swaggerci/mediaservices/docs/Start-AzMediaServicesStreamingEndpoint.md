...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/start-azmediaservicesstreamingendpoint
schema: 2.0.0
---

# Start-AzMediaServicesStreamingEndpoint
...
### Start (Default)
```
Start-AzMediaServicesStreamingEndpoint -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### StartViaIdentity
```
Start-AzMediaServicesStreamingEndpoint -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
