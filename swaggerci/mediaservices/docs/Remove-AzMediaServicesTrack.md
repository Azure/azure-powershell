...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/remove-azmediaservicestrack
schema: 2.0.0
---

# Remove-AzMediaServicesTrack
...
### Delete (Default)
```
Remove-AzMediaServicesTrack -AccountName <String> -AssetName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzMediaServicesTrack -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>] [-AsJob]
