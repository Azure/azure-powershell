...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/remove-azmediaservicesaccountfilter
schema: 2.0.0
---

# Remove-AzMediaServicesAccountFilter
...
### Delete (Default)
```
Remove-AzMediaServicesAccountFilter -AccountName <String> -FilterName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMediaServicesAccountFilter -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
