...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/remove-azmediaservicesstreamingpolicy
schema: 2.0.0
---

# Remove-AzMediaServicesStreamingPolicy
...
### Delete (Default)
```
Remove-AzMediaServicesStreamingPolicy -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMediaServicesStreamingPolicy -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
