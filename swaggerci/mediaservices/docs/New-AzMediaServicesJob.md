...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/new-azmediaservicesjob
schema: 2.0.0
---

# New-AzMediaServicesJob
...
```
New-AzMediaServicesJob -AccountName <String> -Name <String> -ResourceGroupName <String>
