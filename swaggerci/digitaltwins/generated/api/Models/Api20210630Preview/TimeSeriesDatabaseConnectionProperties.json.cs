...
namespace Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview
{
    ...
    public partial class TimeSeriesDatabaseConnectionProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.ITimeSeriesDatabaseConnectionProperties.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.ITimeSeriesDatabaseConnectionProperties
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.ITimeSeriesDatabaseConnectionProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.ITimeSeriesDatabaseConnectionProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("connectionType") )
            {
                case "AzureDataExplorer":
                {
                    return new AzureDataExplorerConnectionProperties(json);
                }
            }
            return new TimeSeriesDatabaseConnectionProperties(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonObject into a new instance of <see cref="TimeSeriesDatabaseConnectionProperties" />.
        /// </summary>
        ...
        internal TimeSeriesDatabaseConnectionProperties(Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonObject json)
        {
            ...
            {_connectionType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonString>("connectionType"), out var __jsonConnectionType) ? (string)__jsonConnectionType : (string)ConnectionType;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="TimeSeriesDatabaseConnectionProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="TimeSeriesDatabaseConnectionProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._connectionType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonString(this._connectionType.ToString()) : null, "connectionType" ,container.Add );
