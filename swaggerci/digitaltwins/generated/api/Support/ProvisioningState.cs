...
namespace Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support.ProvisioningState Deleted = @"Deleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support.ProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support.ProvisioningState Moving = @"Moving";

        public static Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support.ProvisioningState Provisioning = @"Provisioning";

        public static Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support.ProvisioningState Restoring = @"Restoring";

        public static Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support.ProvisioningState e)
        {
            return e._value;
        }
