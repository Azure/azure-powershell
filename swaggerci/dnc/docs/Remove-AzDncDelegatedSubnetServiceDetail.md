...
external help file:
Module Name: Az.Dnc
online version: https://docs.microsoft.com/en-us/powershell/module/az.dnc/remove-azdncdelegatedsubnetservicedetail
schema: 2.0.0
---

# Remove-AzDncDelegatedSubnetServiceDetail
...
### Delete (Default)
```
Remove-AzDncDelegatedSubnetServiceDetail -ResourceGroupName <String> -ResourceName <String>
...
### DeleteViaIdentity
```
Remove-AzDncDelegatedSubnetServiceDetail -InputObject <IDncIdentity> [-ForceDelete]
