...
external help file:
Module Name: Az.Dnc
online version: https://docs.microsoft.com/en-us/powershell/module/az.dnc/get-azdncdelegatedsubnetservicedetail
schema: 2.0.0
---

# Get-AzDncDelegatedSubnetServiceDetail
...
### Get (Default)
```
Get-AzDncDelegatedSubnetServiceDetail -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDncDelegatedSubnetServiceDetail -InputObject <IDncIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
