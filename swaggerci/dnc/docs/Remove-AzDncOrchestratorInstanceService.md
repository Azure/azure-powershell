...
external help file:
Module Name: Az.Dnc
online version: https://docs.microsoft.com/en-us/powershell/module/az.dnc/remove-azdncorchestratorinstanceservice
schema: 2.0.0
---

# Remove-AzDncOrchestratorInstanceService
...
### Delete (Default)
```
Remove-AzDncOrchestratorInstanceService -ResourceGroupName <String> -ResourceName <String>
...
### DeleteViaIdentity
```
Remove-AzDncOrchestratorInstanceService -InputObject <IDncIdentity> [-ForceDelete]
