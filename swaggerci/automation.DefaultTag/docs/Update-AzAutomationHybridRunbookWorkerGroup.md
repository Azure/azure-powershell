...
online version: https://learn.microsoft.com/powershell/module/az.automation/update-azautomationhybridrunbookworkergroup
schema: 2.0.0
---
...
```
Update-AzAutomationHybridRunbookWorkerGroup -AutomationAccountName <String>
 -HybridRunbookWorkerGroupName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-CredentialName <String>] [-Name <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAutomationHybridRunbookWorkerGroup -InputObject <IAutomationIdentity> [-CredentialName <String>]
...
### Microsoft.Azure.PowerShell.Cmdlets.Automation.Models.Api202208.IHybridRunbookWorkerGroup
