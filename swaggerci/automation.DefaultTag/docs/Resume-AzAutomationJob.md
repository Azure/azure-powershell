...
### Resume (Default)
```
Resume-AzAutomationJob -AutomationAccountName <String> -Name <String> -ResourceGroupName <String>
...
### ResumeViaIdentity
```
Resume-AzAutomationJob -InputObject <IAutomationIdentity> [-ClientRequestId <String>]
