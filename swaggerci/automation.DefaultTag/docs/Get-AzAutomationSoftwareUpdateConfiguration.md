...
online version: https://learn.microsoft.com/powershell/module/az.automation/get-azautomationsoftwareupdateconfiguration
schema: 2.0.0
---
...
### List (Default)
```
Get-AzAutomationSoftwareUpdateConfiguration -AutomationAccountName <String> -ResourceGroupName <String>
...
### Get
```
Get-AzAutomationSoftwareUpdateConfiguration -AutomationAccountName <String> -Name <String>
...
### GetViaIdentity
```
Get-AzAutomationSoftwareUpdateConfiguration -InputObject <IAutomationIdentity> [-ClientRequestId <String>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Automation.Models.Api20190601.ISoftwareUpdateConfigurationCollectionItem
