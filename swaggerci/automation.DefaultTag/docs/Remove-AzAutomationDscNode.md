...
online version: https://learn.microsoft.com/powershell/module/az.automation/remove-azautomationdscnode
schema: 2.0.0
---

# Remove-AzAutomationDscNode
...
### Delete (Default)
```
Remove-AzAutomationDscNode -AutomationAccountName <String> -NodeId <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzAutomationDscNode -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>] [-PassThru]
