...
### Delete (Default)
```
Remove-AzAutomationPython3Package -AutomationAccountName <String> -PackageName <String>
...
### DeleteViaIdentity
```
Remove-AzAutomationPython3Package -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>] [-PassThru]
