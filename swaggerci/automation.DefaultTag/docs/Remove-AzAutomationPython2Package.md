...
online version: https://learn.microsoft.com/powershell/module/az.automation/remove-azautomationpython2package
schema: 2.0.0
---

# Remove-AzAutomationPython2Package
...
### Delete (Default)
```
Remove-AzAutomationPython2Package -AutomationAccountName <String> -PackageName <String>
...
### DeleteViaIdentity
```
Remove-AzAutomationPython2Package -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>] [-PassThru]
