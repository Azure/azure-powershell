...
online version: https://learn.microsoft.com/powershell/module/az.automation/remove-azautomationaccount
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzAutomationAccount -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzAutomationAccount -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>] [-PassThru]
