...
### Delete (Default)
```
Remove-AzAutomationDscConfiguration -AutomationAccountName <String> -ConfigurationName <String>
...
### DeleteViaIdentity
```
Remove-AzAutomationDscConfiguration -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>]
