...
online version: https://learn.microsoft.com/powershell/module/az.automation/update-azautomationmodule
schema: 2.0.0
---
...
```
Update-AzAutomationModule -AutomationAccountName <String> -ModuleName <String> -ResourceGroupName <String>
...
```
Update-AzAutomationModule -InputObject <IAutomationIdentity> [-ContentHashAlgorithm <String>]
