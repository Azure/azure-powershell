...
### List (Default)
```
Get-AzAutomationDscConfiguration -AutomationAccountName <String> -ResourceGroupName <String>
...
### Get
```
Get-AzAutomationDscConfiguration -AutomationAccountName <String> -ConfigurationName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAutomationDscConfiguration -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Automation.Models.Api202208.IDscConfiguration
