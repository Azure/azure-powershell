...
online version: https://learn.microsoft.com/powershell/module/az.automation/remove-azautomationwatcher
schema: 2.0.0
---

# Remove-AzAutomationWatcher
...
### Delete (Default)
```
Remove-AzAutomationWatcher -AutomationAccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzAutomationWatcher -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>] [-PassThru]
