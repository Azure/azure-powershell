...
### Get (Default)
```
Get-AzAutomationJobOutput -AutomationAccountName <String> -JobName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-ClientRequestId <String>] [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAutomationJobOutput -InputObject <IAutomationIdentity> [-ClientRequestId <String>]
