...
external help file:
Module Name: Az.Dfp
online version: https://docs.microsoft.com/en-us/powershell/module/az.dfp/remove-azdfpinstance
schema: 2.0.0
---

# Remove-AzDfpInstance
...
### Delete (Default)
```
Remove-AzDfpInstance -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDfpInstance -InputObject <IDfpIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
