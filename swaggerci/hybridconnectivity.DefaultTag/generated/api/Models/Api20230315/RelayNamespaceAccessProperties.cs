...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Models.Api20230315
{
    ...
    public partial class RelayNamespaceAccessProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Models.Api20230315.IRelayNamespaceAccessPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Models.Api20230315.IRelayNamespaceAccessPropertiesInternal.AccessKey { get => this._accessKey; set { {_accessKey = value;} } }
        ...
        /// <summary>Backing field for <see cref="ServiceConfigurationToken" /> property.</summary>
        private string _serviceConfigurationToken;

        /// <summary>The token to access the enabled service.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.PropertyOrigin.Owned)]
        public string ServiceConfigurationToken { get => this._serviceConfigurationToken; set => this._serviceConfigurationToken = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string ServiceConfigurationToken { get; set; }
