...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Support";
