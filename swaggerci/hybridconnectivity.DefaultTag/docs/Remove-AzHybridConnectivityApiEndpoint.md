...
online version: https://learn.microsoft.com/powershell/module/az.hybridconnectivityapi/remove-azhybridconnectivityapiendpoint
schema: 2.0.0
---

# Remove-AzHybridConnectivityApiEndpoint
...
### Delete (Default)
```
Remove-AzHybridConnectivityApiEndpoint -Name <String> -ResourceUri <String> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzHybridConnectivityApiEndpoint -InputObject <IHybridConnectivityApiIdentity>
