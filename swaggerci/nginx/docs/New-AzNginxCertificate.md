...
online version: https://docs.microsoft.com/en-us/powershell/module/az.nginx/new-aznginxcertificate
schema: 2.0.0
---
...
New-AzNginxCertificate -DeploymentName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-KeyVirtualPath <String>] [-Location <String>] [-ProvisioningState <ProvisioningState>] [-Tag <Hashtable>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Nginx.Support.ProvisioningState
Parameter Sets: (All)
Aliases:
