...
namespace Microsoft.Azure.PowerShell.Cmdlets.Orbital.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListAvailableContacts=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Orbital/spacecrafts/{spacecraftName}/listAvailableContacts"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzOrbitalSpacecraftAvailableContact_ListExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api20221101.IAvailableContacts))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Description(@"Returns list of available contacts. A contact is available if the spacecraft is visible from the ground station for more than the minimum viable contact duration provided in the contact profile.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Generated]
    public partial class GetAzOrbitalSpacecraftAvailableContact_ListExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api20221101.IContactParameters _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api20221101.ContactParameters();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Orbital.AzureOrbital Client => Microsoft.Azure.PowerShell.Cmdlets.Orbital.Module.Instance.ClientAPI;
        ...
        public string ContactProfileId { get => _parametersBody.ContactProfileId ?? null; set => _parametersBody.ContactProfileId = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "End time of a contact (ISO 8601 UTC standard).")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public global::System.DateTime EndTime { get => _parametersBody.EndTime; set => _parametersBody.EndTime = value; }

        /// <summary>Name of Azure Ground Station.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of Azure Ground Station.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string GroundStationName { get => _parametersBody.GroundStationName ?? null; set => _parametersBody.GroundStationName = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Start time of a contact (ISO 8601 UTC standard).")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.DateTime) })]
        public global::System.DateTime StartTime { get => _parametersBody.StartTime; set => _parametersBody.StartTime = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api20221101.IAvailableContactsListResult">Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api20221101.IAvailableContactsListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api20221101.IAvailableContactsListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of GetAzOrbitalSpacecraftAvailableContact_ListExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Orbital.Cmdlets.GetAzOrbitalSpacecraftAvailableContact_ListExpanded Clone()
        {
            var clone = new GetAzOrbitalSpacecraftAvailableContact_ListExpanded();
            ...
            clone.SpacecraftName = this.SpacecraftName;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzOrbitalSpacecraftAvailableContact_ListExpanded" /> cmdlet class.
        /// </summary>
        public GetAzOrbitalSpacecraftAvailableContact_ListExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SpacecraftsListAvailableContacts' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SpacecraftsListAvailableContacts(ResourceGroupName, SubscriptionId, SpacecraftName, _parametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,SubscriptionId=SubscriptionId,SpacecraftName=SpacecraftName,body=_parametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, SubscriptionId=SubscriptionId, SpacecraftName=SpacecraftName, body=_parametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, SubscriptionId=SubscriptionId, SpacecraftName=SpacecraftName, body=_parametersBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api20221101.IAvailableContactsListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        ...
                        {
                            requestMessage = requestMessage.Clone(new global::System.Uri( _nextLink ),Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Method.Get );
                            await ((Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.IEventListener)this).Signal(Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Events.FollowingNextLink); if( ((Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.IEventListener)this).Token.IsCancellationRequested ) { return; }
                            await this.Client.SpacecraftsListAvailableContacts_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
