...
namespace Microsoft.Azure.PowerShell.Cmdlets.Orbital.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of UpdateAzOrbitalContactProfileTag_UpdateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Orbital.Cmdlets.UpdateAzOrbitalContactProfileTag_UpdateExpanded Clone()
        {
            var clone = new UpdateAzOrbitalContactProfileTag_UpdateExpanded();
            ...
            clone.ContactProfileName = this.ContactProfileName;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ContactProfilesUpdateTags(ResourceGroupName, SubscriptionId, ContactProfileName, _parametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,SubscriptionId=SubscriptionId,ContactProfileName=ContactProfileName,body=_parametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, SubscriptionId=SubscriptionId, ContactProfileName=ContactProfileName, body=_parametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, SubscriptionId=SubscriptionId, ContactProfileName=ContactProfileName, body=_parametersBody })
                    {
