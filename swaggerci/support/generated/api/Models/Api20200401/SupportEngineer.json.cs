...
namespace Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401
{
    ...
    public partial class SupportEngineer
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.ISupportEngineer.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.ISupportEngineer.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.ISupportEngineer FromJson(Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject json ? new SupportEngineer(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject into a new instance of <see cref="SupportEngineer" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SupportEngineer(Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject json)
        {
            ...
            {_emailAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonString>("emailAddress"), out var __jsonEmailAddress) ? (string)__jsonEmailAddress : (string)EmailAddress;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SupportEngineer" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SupportEngineer" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != (((object)this._emailAddress)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonString(this._emailAddress.ToString()) : null, "emailAddress" ,container.Add );
            }
