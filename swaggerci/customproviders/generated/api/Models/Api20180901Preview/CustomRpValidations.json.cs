...
namespace Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview
{
    ...
    public partial class CustomRpValidations
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.ICustomRpValidations.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.ICustomRpValidations.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.ICustomRpValidations FromJson(Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Runtime.Json.JsonObject json ? new CustomRpValidations(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CustomRpValidations" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CustomRpValidations" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._validationType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Runtime.Json.JsonString(this._validationType.ToString()) : null, "validationType" ,container.Add );
            AddIf( null != (((object)this._specification)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Runtime.Json.JsonString(this._specification.ToString()) : null, "specification" ,container.Add );
