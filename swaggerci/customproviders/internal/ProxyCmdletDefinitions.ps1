...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.customproviders/get-azcustomprovidersoperation
#>
function Get-AzCustomprovidersOperation {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.Customproviders.private\Get-AzCustomprovidersOperation_List';
        }
