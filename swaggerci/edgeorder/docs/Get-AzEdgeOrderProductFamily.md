...
### List
```
Get-AzEdgeOrderProductFamily -ProductFamiliesRequest <IProductFamiliesRequest> [-SubscriptionId <String[]>]
 [-Expand <String>] [-SkipToken <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
