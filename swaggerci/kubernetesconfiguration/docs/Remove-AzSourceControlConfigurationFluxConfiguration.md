...
online version: https://docs.microsoft.com/en-us/powershell/module/az.sourcecontrolconfiguration/remove-azsourcecontrolconfigurationfluxconfiguration
schema: 2.0.0
---

# Remove-AzSourceControlConfigurationFluxConfiguration
...
### Delete (Default)
```
Remove-AzSourceControlConfigurationFluxConfiguration -ClusterName <String> -ClusterResourceName <String>
...
### DeleteViaIdentity
```
Remove-AzSourceControlConfigurationFluxConfiguration -InputObject <ISourceControlConfigurationIdentity>
