...
online version: https://docs.microsoft.com/en-us/powershell/module/az.sourcecontrolconfiguration/get-azsourcecontrolconfigurationfluxconfiguration
schema: 2.0.0
---

# Get-AzSourceControlConfigurationFluxConfiguration
...
### List (Default)
```
Get-AzSourceControlConfigurationFluxConfiguration -ClusterName <String> -ClusterResourceName <String>
...
### GetViaIdentity
```
Get-AzSourceControlConfigurationFluxConfiguration -InputObject <ISourceControlConfigurationIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
