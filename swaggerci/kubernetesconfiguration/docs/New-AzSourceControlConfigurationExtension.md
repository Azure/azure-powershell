...
New-AzSourceControlConfigurationExtension -ClusterName <String> -ClusterResourceName <String>
 ...
 [-ConfigurationProtectedSetting <Hashtable>] [-ConfigurationSetting <Hashtable>] [-ExtensionType <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.AksIdentityType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20220301.IExtensionStatus[]
Parameter Sets: (All)
Aliases:
