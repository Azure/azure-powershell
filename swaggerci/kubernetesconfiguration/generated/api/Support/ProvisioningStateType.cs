...
namespace Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ProvisioningStateType Accepted = @"Accepted";

        public static Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ProvisioningStateType Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ProvisioningStateType Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ProvisioningStateType Running = @"Running";

        public static Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ProvisioningStateType Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ProvisioningStateType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ProvisioningStateType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ProvisioningStateType e1, Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ProvisioningStateType e2)
        {
            return !e2.Equals(e1);
        }
