...
namespace Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ComplianceStateType Compliant = @"Compliant";

        public static Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ComplianceStateType Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ComplianceStateType Installed = @"Installed";

        public static Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ComplianceStateType Noncompliant = @"Noncompliant";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ComplianceStateType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ComplianceStateType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ComplianceStateType e1, Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ComplianceStateType e2)
        {
            return !e2.Equals(e1);
        }
