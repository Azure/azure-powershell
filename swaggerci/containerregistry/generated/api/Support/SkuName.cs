...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.SkuName Basic = @"Basic";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.SkuName Classic = @"Classic";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.SkuName Premium = @"Premium";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.SkuName Standard = @"Standard";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.SkuName e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.SkuName e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.SkuName e1, Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.SkuName e2)
        {
            return !e2.Equals(e1);
        }
