...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.IEventListener
    {
        ...
        public string[] Action { get => ScopeMapUpdateParametersBody.Action ?? null /* arrayOf */; set => ScopeMapUpdateParametersBody.Action = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Description { get => ScopeMapUpdateParametersBody.Description ?? null; set => ScopeMapUpdateParametersBody.Description = value; }
        ...
        /// <summary>Backing field for <see cref="ScopeMapUpdateParametersBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20211201Preview.IScopeMapUpdateParameters _scopeMapUpdateParametersBody= new Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20211201Preview.ScopeMapUpdateParameters();

        /// <summary>The properties for updating the scope map.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20211201Preview.IScopeMapUpdateParameters ScopeMapUpdateParametersBody { get => this._scopeMapUpdateParametersBody; set => this._scopeMapUpdateParametersBody = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets.UpdateAzContainerRegistryScopeMap_UpdateViaIdentityExpanded Clone()
        {
            ...
            clone.ScopeMapUpdateParametersBody = this.ScopeMapUpdateParametersBody;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ScopeMapsUpdateViaIdentity(InputObject.Id, ScopeMapUpdateParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ScopeMapsUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.RegistryName ?? null, InputObject.ScopeMapName ?? null, ScopeMapUpdateParametersBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ScopeMapUpdateParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20190601Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ScopeMapUpdateParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ScopeMapUpdateParametersBody })
                    {
