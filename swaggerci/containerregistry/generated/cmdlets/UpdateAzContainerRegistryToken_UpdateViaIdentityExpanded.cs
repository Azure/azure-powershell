...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.IEventListener
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20211201Preview.ITokenCertificate[] CredentialsCertificate { get => TokenUpdateParametersBody.CredentialsCertificate ?? null /* arrayOf */; set => TokenUpdateParametersBody.CredentialsCertificate = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20211201Preview.ITokenPassword[] CredentialsPassword { get => TokenUpdateParametersBody.CredentialsPassword ?? null /* arrayOf */; set => TokenUpdateParametersBody.CredentialsPassword = value; }
        ...
        public string ScopeMapId { get => TokenUpdateParametersBody.ScopeMapId ?? null; set => TokenUpdateParametersBody.ScopeMapId = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.TokenStatus Status { get => TokenUpdateParametersBody.Status ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.TokenStatus)""); set => TokenUpdateParametersBody.Status = value; }

        /// <summary>Backing field for <see cref="TokenUpdateParametersBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20211201Preview.ITokenUpdateParameters _tokenUpdateParametersBody= new Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20211201Preview.TokenUpdateParameters();

        /// <summary>The parameters for updating a token.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20211201Preview.ITokenUpdateParameters TokenUpdateParametersBody { get => this._tokenUpdateParametersBody; set => this._tokenUpdateParametersBody = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets.UpdateAzContainerRegistryToken_UpdateViaIdentityExpanded Clone()
        {
            ...
            clone.TokenUpdateParametersBody = this.TokenUpdateParametersBody;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.TokensUpdateViaIdentity(InputObject.Id, TokenUpdateParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.TokensUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.RegistryName ?? null, InputObject.TokenName ?? null, TokenUpdateParametersBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=TokenUpdateParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20190601Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=TokenUpdateParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=TokenUpdateParametersBody })
                    {
