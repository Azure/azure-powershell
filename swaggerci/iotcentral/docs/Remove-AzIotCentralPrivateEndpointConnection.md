...
online version: https://docs.microsoft.com/en-us/powershell/module/az.iotcentral/remove-aziotcentralprivateendpointconnection
schema: 2.0.0
---

# Remove-AzIotCentralPrivateEndpointConnection
...
### Delete (Default)
```
Remove-AzIotCentralPrivateEndpointConnection -Name <String> -ResourceGroupName <String> -ResourceName <String>
...
### DeleteViaIdentity
```
Remove-AzIotCentralPrivateEndpointConnection -InputObject <IIotCentralIdentity> [-DefaultProfile <PSObject>]
