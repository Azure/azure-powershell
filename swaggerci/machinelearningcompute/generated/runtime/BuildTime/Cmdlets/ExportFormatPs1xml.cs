...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningCompute.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MachineLearningCompute.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MachineLearningCompute.Support";
