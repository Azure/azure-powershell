...
New-AzOrbitalContactProfile -Name <String> -ResourceGroupName <String> -Link <IContactProfileLink[]>
 ...
 [-MinimumElevationDegree <Single>] [-MinimumViableContactDuration <String>] [-ProvisioningState <String>]
 [-Tag <Hashtable>] [-ThirdPartyConfiguration <IContactProfileThirdPartyConfiguration[]>]
