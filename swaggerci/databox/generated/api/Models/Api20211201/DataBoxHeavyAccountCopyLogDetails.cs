...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201
{
    ...
    public partial class DataBoxHeavyAccountCopyLogDetails :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IDataBoxHeavyAccountCopyLogDetails,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IDataBoxHeavyAccountCopyLogDetailsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.ICopyLogDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.ICopyLogDetails __copyLogDetails = new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.CopyLogDetails();
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IDataBoxHeavyAccountCopyLogDetailsInternal.AccountName { get => this._accountName; set { {_accountName = value;} } }

        /// <summary>Internal Acessors for CopyLogLink</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IDataBoxHeavyAccountCopyLogDetailsInternal.CopyLogLink { get => this._copyLogLink; set { {_copyLogLink = value;} } }

        /// <summary>Internal Acessors for CopyVerboseLogLink</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IDataBoxHeavyAccountCopyLogDetailsInternal.CopyVerboseLogLink { get => this._copyVerboseLogLink; set { {_copyVerboseLogLink = value;} } }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.ClassDiscriminator Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.ICopyLogDetailsInternal)__copyLogDetails).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.ICopyLogDetailsInternal)__copyLogDetails).Type = value ; }
