...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201
{
    ...
    public partial class ValidateAddress
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IValidateAddress.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IValidateAddress.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IValidateAddress FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode node)
        {
        ...
        internal ValidateAddress(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject json)
        {
            ...
            __validationInputRequest = new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.ValidationInputRequest(json);
            {_shippingAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("shippingAddress"), out var __jsonShippingAddress) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.ShippingAddress.FromJson(__jsonShippingAddress) : ShippingAddress;}
            {_transportPreference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("transportPreferences"), out var __jsonTransportPreferences) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.TransportPreferences.FromJson(__jsonTransportPreferences) : TransportPreference;}
