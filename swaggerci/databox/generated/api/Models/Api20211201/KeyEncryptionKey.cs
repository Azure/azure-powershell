...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201
{
    ...
    public partial class KeyEncryptionKey :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IKeyEncryptionKey,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IKeyEncryptionKeyInternal
    {

        /// <summary>Backing field for <see cref="IdentityProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IIdentityProperties _identityProperty;

        /// <summary>Managed identity properties used for key encryption.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IIdentityProperties IdentityProperty { get => (this._identityProperty = this._identityProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IdentityProperties()); set => this._identityProperty = value; }
        ...
        public string IdentityPropertyType { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IIdentityPropertiesInternal)IdentityProperty).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IIdentityPropertiesInternal)IdentityProperty).Type = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IIdentityProperties Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IKeyEncryptionKeyInternal.IdentityProperty { get => (this._identityProperty = this._identityProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IdentityProperties()); set { {_identityProperty = value;} } }

        /// <summary>Internal Acessors for IdentityPropertyUserAssigned</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IUserAssignedProperties Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IKeyEncryptionKeyInternal.IdentityPropertyUserAssigned { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IIdentityPropertiesInternal)IdentityProperty).UserAssigned; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IIdentityPropertiesInternal)IdentityProperty).UserAssigned = value; }

        /// <summary>Arm resource id for user assigned identity to be used to fetch MSI token.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Inlined)]
        public string UserAssignedResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IIdentityPropertiesInternal)IdentityProperty).UserAssignedResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IIdentityPropertiesInternal)IdentityProperty).UserAssignedResourceId = value ?? null; }
    ...
    {
        /// <summary>Managed identity properties used for key encryption.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IIdentityProperties IdentityProperty { get; set; }
        /// <summary>Managed service identity type.</summary>
        string IdentityPropertyType { get; set; }
