...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Resolution code for the job")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.CustomerResolutionCode CustomerResolutionCode { get => MitigateJobRequestBody.CustomerResolutionCode; set => MitigateJobRequestBody.CustomerResolutionCode = value; }
        ...
        /// <summary>Backing field for <see cref="MitigateJobRequestBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IMitigateJobRequest _mitigateJobRequestBody= new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.MitigateJobRequest();

        /// <summary>The Mitigate Job captured from request body for Mitigate API</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IMitigateJobRequest MitigateJobRequestBody { get => this._mitigateJobRequestBody; set => this._mitigateJobRequestBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.Mitigate(JobName, SubscriptionId, ResourceGroupName, MitigateJobRequestBody, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  JobName=JobName,SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,body=MitigateJobRequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { JobName=JobName, SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, body=MitigateJobRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { JobName=JobName, SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, body=MitigateJobRequestBody })
                    {
