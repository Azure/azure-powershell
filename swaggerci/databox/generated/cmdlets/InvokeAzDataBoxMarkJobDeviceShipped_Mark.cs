...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] MarkDevicesShipped=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBox/jobs/{jobName}/markDevicesShipped"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzDataBoxMarkJobDeviceShipped_Mark", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataBox.Description(@"Request to mark devices for a given job as shipped")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataBox.Generated]
    public partial class InvokeAzDataBoxMarkJobDeviceShipped_Mark : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="MarkDevicesShippedRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IMarkDevicesShippedRequest _markDevicesShippedRequest;

        /// <summary>The request body to provide the delivery package details of job</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The request body to provide the delivery package details of job", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The request body to provide the delivery package details of job",
        SerializedName = @"markDevicesShippedRequest",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IMarkDevicesShippedRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IMarkDevicesShippedRequest MarkDevicesShippedRequest { get => this._markDevicesShippedRequest; set => this._markDevicesShippedRequest = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzDataBoxMarkJobDeviceShipped_Mark" /> cmdlet class.
        /// </summary>
        public InvokeAzDataBoxMarkJobDeviceShipped_Mark()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'JobsMarkDevicesShipped' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.JobsMarkDevicesShipped(JobName, SubscriptionId, ResourceGroupName, MarkDevicesShippedRequest, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  JobName=JobName,SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,body=MarkDevicesShippedRequest})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { JobName=JobName, SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, body=MarkDevicesShippedRequest })
                    {
