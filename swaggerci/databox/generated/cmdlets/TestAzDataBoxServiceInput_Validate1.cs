...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ValidateInputs=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.DataBox/locations/{location}/validateInputs"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzDataBoxServiceInput_Validate1", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataBox.Description(@"This method does all necessary pre-job creation validation under subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataBox.Generated]
    public partial class TestAzDataBoxServiceInput_Validate1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ValidationRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IValidationRequest _validationRequest;

        /// <summary>Minimum request requirement of any validation category.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Minimum request requirement of any validation category.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Minimum request requirement of any validation category.",
        SerializedName = @"validationRequest",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IValidationRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IValidationRequest ValidationRequest { get => this._validationRequest; set => this._validationRequest = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ServiceValidateInputs' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ServiceValidateInputs(SubscriptionId, Location, ValidationRequest, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,Location=Location,body=ValidationRequest})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzDataBoxServiceInput_Validate1" /> cmdlet class.
        /// </summary>
        public TestAzDataBoxServiceInput_Validate1()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, body=ValidationRequest })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, body=ValidationRequest })
                    {
