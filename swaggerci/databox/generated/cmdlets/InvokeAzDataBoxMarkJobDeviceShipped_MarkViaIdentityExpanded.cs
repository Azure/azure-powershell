...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzDataBoxMarkJobDeviceShipped_MarkViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzDataBoxMarkJobDeviceShipped_MarkViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IEventListener
    {
        ...
        public string DeliverToDcPackageDetailCarrierName { get => MarkDevicesShippedRequestBody.DeliverToDcPackageDetailCarrierName ?? null; set => MarkDevicesShippedRequestBody.DeliverToDcPackageDetailCarrierName = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string DeliverToDcPackageDetailTrackingId { get => MarkDevicesShippedRequestBody.DeliverToDcPackageDetailTrackingId ?? null; set => MarkDevicesShippedRequestBody.DeliverToDcPackageDetailTrackingId = value; }
        ...
        /// <summary>Backing field for <see cref="MarkDevicesShippedRequestBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IMarkDevicesShippedRequest _markDevicesShippedRequestBody= new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.MarkDevicesShippedRequest();

        /// <summary>The request body to provide the delivery package details of job</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IMarkDevicesShippedRequest MarkDevicesShippedRequestBody { get => this._markDevicesShippedRequestBody; set => this._markDevicesShippedRequestBody = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzDataBoxMarkJobDeviceShipped_MarkViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public InvokeAzDataBoxMarkJobDeviceShipped_MarkViaIdentityExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.JobsMarkDevicesShippedViaIdentity(InputObject.Id, MarkDevicesShippedRequestBody, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.JobsMarkDevicesShipped(InputObject.JobName ?? null, InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, MarkDevicesShippedRequestBody, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=MarkDevicesShippedRequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20211201.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=MarkDevicesShippedRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=MarkDevicesShippedRequestBody })
                    {
