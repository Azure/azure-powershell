...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purview.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzPurviewAccountNameAvailability_Check", SupportsShouldProcess = true)]
    ...
    public partial class TestAzPurviewAccountNameAvailability_Check : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.ICheckNameAvailabilityRequest _checkNameAvailabilityRequest;

        /// <summary>The request payload for CheckNameAvailability API</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The request payload for CheckNameAvailability API", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.ICheckNameAvailabilityRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.ICheckNameAvailabilityRequest CheckNameAvailabilityRequest { get => this._checkNameAvailabilityRequest; set => this._checkNameAvailabilityRequest = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AccountsCheckNameAvailability(SubscriptionId, CheckNameAvailabilityRequest, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,body=CheckNameAvailabilityRequest})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzPurviewAccountNameAvailability_Check" /> cmdlet class.
        /// </summary>
        public TestAzPurviewAccountNameAvailability_Check()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.IErrorResponseModel> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, body=CheckNameAvailabilityRequest })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, body=CheckNameAvailabilityRequest })
                    {
