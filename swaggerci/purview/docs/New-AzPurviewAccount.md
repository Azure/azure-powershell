...
online version: https://docs.microsoft.com/en-us/powershell/module/az.purview/new-azpurviewaccount
schema: 2.0.0
---
...
```
New-AzPurviewAccount -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-IdentityType <Type>] [-IdentityUserAssignedIdentity <Hashtable>] [-Location <String>]
