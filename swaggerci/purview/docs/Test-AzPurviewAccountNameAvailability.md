...
online version: https://docs.microsoft.com/en-us/powershell/module/az.purview/test-azpurviewaccountnameavailability
schema: 2.0.0
---
...
### Check
```
Test-AzPurviewAccountNameAvailability -CheckNameAvailabilityRequest <ICheckNameAvailabilityRequest>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentity
```
Test-AzPurviewAccountNameAvailability -InputObject <IPurviewIdentity>
...
```
Test-AzPurviewAccountNameAvailability -InputObject <IPurviewIdentity> [-Name <String>] [-Type <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.ICheckNameAvailabilityRequest
