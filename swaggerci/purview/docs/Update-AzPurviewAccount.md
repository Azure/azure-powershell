...
online version: https://docs.microsoft.com/en-us/powershell/module/az.purview/update-azpurviewaccount
schema: 2.0.0
---
...
Update-AzPurviewAccount -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-IdentityType <Type>] [-IdentityUserAssignedIdentity <Hashtable>] [-ManagedResourceGroupName <String>]
...
```
Update-AzPurviewAccount -InputObject <IPurviewIdentity> [-IdentityType <Type>]
 [-IdentityUserAssignedIdentity <Hashtable>] [-ManagedResourceGroupName <String>]
 [-PublicNetworkAccess <PublicNetworkAccess>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
