...
online version: https://docs.microsoft.com/en-us/powershell/module/az.purview/add-azpurviewaccountrootcollectionadmin
schema: 2.0.0
---
...
```
Add-AzPurviewAccountRootCollectionAdmin -AccountName <String> -ResourceGroupName <String>
 -CollectionAdminUpdate <ICollectionAdminUpdate> [-SubscriptionId <String>] [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AddViaIdentity
```
Add-AzPurviewAccountRootCollectionAdmin -InputObject <IPurviewIdentity>
 -CollectionAdminUpdate <ICollectionAdminUpdate> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.ICollectionAdminUpdate
