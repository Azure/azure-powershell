...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dynatraceobservability/get-azdynatraceobservabilitymonitorvmhostpayload
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzDynatraceObservabilityMonitorVMHostPayload -MonitorName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDynatraceObservabilityMonitorVMHostPayload -InputObject <IDynatraceObservabilityIdentity>
