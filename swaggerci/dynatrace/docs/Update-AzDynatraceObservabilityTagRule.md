...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dynatraceobservability/update-azdynatraceobservabilitytagrule
schema: 2.0.0
---

# Update-AzDynatraceObservabilityTagRule
...
```
Update-AzDynatraceObservabilityTagRule -MonitorName <String> -ResourceGroupName <String> -RuleSetName <String>
...
```
Update-AzDynatraceObservabilityTagRule -InputObject <IDynatraceObservabilityIdentity>
