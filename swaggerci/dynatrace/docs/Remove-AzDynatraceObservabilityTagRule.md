...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dynatraceobservability/remove-azdynatraceobservabilitytagrule
schema: 2.0.0
---

# Remove-AzDynatraceObservabilityTagRule
...
### Delete (Default)
```
Remove-AzDynatraceObservabilityTagRule -MonitorName <String> -ResourceGroupName <String> -RuleSetName <String>
...
### DeleteViaIdentity
```
Remove-AzDynatraceObservabilityTagRule -InputObject <IDynatraceObservabilityIdentity>
