...
namespace Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDynatraceObservabilityMonitorLinkableEnvironment_ListExpanded", SupportsShouldProcess = true)]
    ...
    public partial class GetAzDynatraceObservabilityMonitorLinkableEnvironment_ListExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.Api20210901Preview.ILinkableEnvironmentRequest _requestBody = new Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.Api20210901Preview.LinkableEnvironmentRequest();
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Region { get => _requestBody.Region ?? null; set => _requestBody.Region = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string UserPrincipal { get => _requestBody.UserPrincipal ?? null; set => _requestBody.UserPrincipal = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzDynatraceObservabilityMonitorLinkableEnvironment_ListExpanded" /> cmdlet
        /// class.
        /// </summary>
        public GetAzDynatraceObservabilityMonitorLinkableEnvironment_ListExpanded()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.MonitorsListLinkableEnvironments(SubscriptionId, ResourceGroupName, MonitorName, _requestBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,MonitorName=MonitorName,body=_requestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, MonitorName=MonitorName, body=_requestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, MonitorName=MonitorName, body=_requestBody })
                    {
