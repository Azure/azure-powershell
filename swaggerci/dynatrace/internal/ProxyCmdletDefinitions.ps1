...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.dynatraceobservability/get-azdynatraceobservabilityoperation
#>
function Get-AzDynatraceObservabilityOperation {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.DynatraceObservability.private\Get-AzDynatraceObservabilityOperation_List';
        }
