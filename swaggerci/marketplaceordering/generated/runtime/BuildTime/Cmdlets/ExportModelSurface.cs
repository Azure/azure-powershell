...
namespace Microsoft.Azure.PowerShell.Cmdlets.MarketplaceOrderingAgreements.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MarketplaceOrderingAgreements.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MarketplaceOrderingAgreements.Support";
