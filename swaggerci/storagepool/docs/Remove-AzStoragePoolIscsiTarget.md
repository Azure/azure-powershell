...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storagepool/remove-azstoragepooliscsitarget
schema: 2.0.0
---

# Remove-AzStoragePoolIscsiTarget
...
### Delete (Default)
```
Remove-AzStoragePoolIscsiTarget -DiskPoolName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzStoragePoolIscsiTarget -InputObject <IStoragePoolIdentity> [-DefaultProfile <PSObject>] [-AsJob]
