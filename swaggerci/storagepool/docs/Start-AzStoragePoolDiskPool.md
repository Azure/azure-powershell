...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storagepool/start-azstoragepooldiskpool
schema: 2.0.0
---

# Start-AzStoragePoolDiskPool
...
### Start (Default)
```
Start-AzStoragePoolDiskPool -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-AzStoragePoolDiskPool -InputObject <IStoragePoolIdentity> [-DefaultProfile <PSObject>] [-AsJob]
