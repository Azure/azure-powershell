...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storagepool/invoke-azstoragepooldeallocatediskpool
schema: 2.0.0
---

# Invoke-AzStoragePoolDeallocateDiskPool
...
### Deallocate (Default)
```
Invoke-AzStoragePoolDeallocateDiskPool -DiskPoolName <String> -ResourceGroupName <String>
...
```
Invoke-AzStoragePoolDeallocateDiskPool -InputObject <IStoragePoolIdentity> [-DefaultProfile <PSObject>]
