...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storagepool/new-azstoragepooliscsitarget
schema: 2.0.0
---

# New-AzStoragePoolIscsiTarget
...
```
New-AzStoragePoolIscsiTarget -DiskPoolName <String> -Name <String> -ResourceGroupName <String>
 -AclMode <IscsiTargetAclMode> [-SubscriptionId <String>] [-Lun <IIscsiLun[]>] [-ManagedBy <String>]
 [-ManagedByExtended <String[]>] [-StaticAcls <IAcl[]>] [-TargetIqn <String>] [-DefaultProfile <PSObject>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.StoragePool.Support.IscsiTargetAclMode
Parameter Sets: (All)
Aliases:
