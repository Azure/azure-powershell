...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storagepool/update-azstoragepooldiskpool
schema: 2.0.0
---
...
```
Update-AzStoragePoolDiskPool -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Disk <IDisk[]>] [-ManagedBy <String>] [-ManagedByExtended <String[]>] [-SkuName <String>]
...
```
Update-AzStoragePoolDiskPool -InputObject <IStoragePoolIdentity> [-Disk <IDisk[]>] [-ManagedBy <String>]
...
### UpgradeViaIdentity
```
Update-AzStoragePoolDiskPool -InputObject <IStoragePoolIdentity> [-DefaultProfile <PSObject>] [-AsJob]
