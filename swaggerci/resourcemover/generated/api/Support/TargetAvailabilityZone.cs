...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Support.TargetAvailabilityZone Na = @"NA";

        public static Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Support.TargetAvailabilityZone One = @"1";

        public static Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Support.TargetAvailabilityZone Three = @"3";

        public static Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Support.TargetAvailabilityZone Two = @"2";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Support.TargetAvailabilityZone e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Support.TargetAvailabilityZone e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Support.TargetAvailabilityZone e1, Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Support.TargetAvailabilityZone e2)
        {
            return !e2.Equals(e1);
        }
