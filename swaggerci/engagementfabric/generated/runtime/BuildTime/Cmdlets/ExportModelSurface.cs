...
namespace Microsoft.Azure.PowerShell.Cmdlets.EngagementFabric.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.EngagementFabric.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.EngagementFabric.Support";
