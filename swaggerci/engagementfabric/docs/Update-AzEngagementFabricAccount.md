...
online version: https://docs.microsoft.com/en-us/powershell/module/az.engagementfabric/update-azengagementfabricaccount
schema: 2.0.0
---

# Update-AzEngagementFabricAccount
...
```
Update-AzEngagementFabricAccount -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzEngagementFabricAccount -InputObject <IEngagementFabricIdentity> [-Tag <Hashtable>]
