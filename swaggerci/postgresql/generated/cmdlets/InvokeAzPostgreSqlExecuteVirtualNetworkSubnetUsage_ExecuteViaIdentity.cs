...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Execute=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.DBforPostgreSQL/locations/{locationName}/checkVirtualNetworkSubnetUsage"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzPostgreSqlExecuteVirtualNetworkSubnetUsage_ExecuteViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzPostgreSqlExecuteVirtualNetworkSubnetUsage_ExecuteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20210601.IVirtualNetworkSubnetUsageParameter _parameter;

        /// <summary>Virtual network subnet usage parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Virtual network subnet usage parameter", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Virtual network subnet usage parameter",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20210601.IVirtualNetworkSubnetUsageParameter) })]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20210601.IVirtualNetworkSubnetUsageParameter Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20210601.IVirtualNetworkSubnetUsageResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzPostgreSqlExecuteVirtualNetworkSubnetUsage_ExecuteViaIdentity" />
        /// cmdlet class.
        /// </summary>
        public InvokeAzPostgreSqlExecuteVirtualNetworkSubnetUsage_ExecuteViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkSubnetUsageExecute' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualNetworkSubnetUsageExecuteViaIdentity(InputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualNetworkSubnetUsageExecute(InputObject.SubscriptionId ?? null, InputObject.LocationName ?? null, Parameter, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20210601.IVirtualNetworkSubnetUsageResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // nested-array / delegatedSubnetsUsage / <none>
                WriteObject((await response).DelegatedSubnetsUsage, true);
            }
        }
    }
}