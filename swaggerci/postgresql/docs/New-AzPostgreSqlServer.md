...
New-AzPostgreSqlServer -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-AvailabilityZone <String>] [-BackupGeoRedundantBackup <GeoRedundantBackupEnum>]
 [-BackupRetentionDay <Int32>] [-CreateMode <CreateMode>] [-HighAvailabilityMode <HighAvailabilityMode>]
 ...
 [-NetworkPrivateDnsZoneArmResourceId <String>] [-PointInTimeUtc <DateTime>] [-SkuName <String>]
 [-SkuTier <SkuTier>] [-SourceServerResourceId <String>] [-StorageSizeGb <Int32>] [-Tag <Hashtable>]
