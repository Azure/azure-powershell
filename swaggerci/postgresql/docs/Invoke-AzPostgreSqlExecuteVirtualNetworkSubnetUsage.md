...
online version: https://docs.microsoft.com/en-us/powershell/module/az.postgresql/invoke-azpostgresqlexecutevirtualnetworksubnetusage
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20210601.IVirtualNetworkSubnetUsageParameter
