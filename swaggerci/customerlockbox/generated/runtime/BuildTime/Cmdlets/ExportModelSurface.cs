...
namespace Microsoft.Azure.PowerShell.Cmdlets.CustomerLockbox.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.CustomerLockbox.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.CustomerLockbox.Support";
