...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.ProtectionHealth Critical = @"Critical";

        public static Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.ProtectionHealth None = @"None";

        public static Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.ProtectionHealth Normal = @"Normal";

        public static Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.ProtectionHealth Warning = @"Warning";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.ProtectionHealth e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.ProtectionHealth e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.ProtectionHealth e1, Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.ProtectionHealth e2)
        {
            return !e2.Equals(e1);
        }
