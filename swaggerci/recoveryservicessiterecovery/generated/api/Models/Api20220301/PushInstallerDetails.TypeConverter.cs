...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301
{
    ...
    public partial class PushInstallerDetailsTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <see cref="sourceValue"/> parameter to the <see cref="PushInstallerDetails"
        /// type/>.
        /// </summary>
        ...
        /// an instance of <see cref="PushInstallerDetails" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IPushInstallerDetails ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IPushInstallerDetails).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
