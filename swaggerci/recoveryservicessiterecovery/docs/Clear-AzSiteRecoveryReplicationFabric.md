...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/clear-azsiterecoveryreplicationfabric
schema: 2.0.0
---
...
### Purge (Default)
```
Clear-AzSiteRecoveryReplicationFabric -FabricName <String> -ResourceGroupName <String> -ResourceName <String>
...
### PurgeViaIdentity
```
Clear-AzSiteRecoveryReplicationFabric -InputObject <ISiteRecoveryIdentity> [-DefaultProfile <PSObject>]
