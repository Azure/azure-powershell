...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/new-azsiterecoveryreplicationrecoveryplan
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IRecoveryPlanGroup[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IRecoveryPlanProviderSpecificInput[]
Parameter Sets: (All)
Aliases:
