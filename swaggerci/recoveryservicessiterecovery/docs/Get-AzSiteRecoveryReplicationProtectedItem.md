...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoveryreplicationprotecteditem
schema: 2.0.0
---
...
### List1 (Default)
```
Get-AzSiteRecoveryReplicationProtectedItem -ResourceGroupName <String> -ResourceName <String>
...
### Get
```
Get-AzSiteRecoveryReplicationProtectedItem -FabricName <String> -ProtectionContainerName <String>
...
### GetViaIdentity
```
Get-AzSiteRecoveryReplicationProtectedItem -InputObject <ISiteRecoveryIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
