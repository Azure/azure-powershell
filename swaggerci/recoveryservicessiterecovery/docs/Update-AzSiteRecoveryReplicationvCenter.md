...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/update-azsiterecoveryreplicationvcenter
schema: 2.0.0
---
...
```
Update-AzSiteRecoveryReplicationvCenter -FabricName <String> -ResourceGroupName <String>
...
```
Update-AzSiteRecoveryReplicationvCenter -InputObject <ISiteRecoveryIdentity> [-FriendlyName <String>]
 [-IPAddress <String>] [-Port <String>] [-ProcessServerId <String>] [-RunAsAccountId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
