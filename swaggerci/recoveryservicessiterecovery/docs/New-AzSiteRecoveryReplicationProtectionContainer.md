...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/new-azsiterecoveryreplicationprotectioncontainer
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IReplicationProviderSpecificContainerCreationInput[]
Parameter Sets: (All)
Aliases:
