...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/remove-azsiterecoveryreplicationnetworkmapping
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzSiteRecoveryReplicationNetworkMapping -FabricName <String> -NetworkMappingName <String>
...
### DeleteViaIdentity
```
Remove-AzSiteRecoveryReplicationNetworkMapping -InputObject <ISiteRecoveryIdentity>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
