...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/restart-azsiterecoveryreplicationjob
schema: 2.0.0
---

# Restart-AzSiteRecoveryReplicationJob
...
### Restart (Default)
```
Restart-AzSiteRecoveryReplicationJob -JobName <String> -ResourceGroupName <String> -ResourceName <String>
...
### RestartViaIdentity
```
Restart-AzSiteRecoveryReplicationJob -InputObject <ISiteRecoveryIdentity> [-DefaultProfile <PSObject>]
