...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/remove-azsiterecoveryreplicationstorageclassificationmapping
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzSiteRecoveryReplicationStorageClassificationMapping -FabricName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzSiteRecoveryReplicationStorageClassificationMapping -InputObject <ISiteRecoveryIdentity>
