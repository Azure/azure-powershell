...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/new-azsiterecoveryreplicationmigrationitem
schema: 2.0.0
---

# New-AzSiteRecoveryReplicationMigrationItem
...
```
New-AzSiteRecoveryReplicationMigrationItem -FabricName <String> -MigrationItemName <String>
