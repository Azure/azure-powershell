...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoveryreplicationstorageclassificationmapping
#>
function Get-AzSiteRecoveryReplicationStorageClassificationMapping {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IStorageClassificationMapping])]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            List1 = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationStorageClassificationMapping_List1';
        }
