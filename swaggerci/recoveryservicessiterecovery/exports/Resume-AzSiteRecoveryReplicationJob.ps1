...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IResumeJobParams
.Inputs
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/resume-azsiterecoveryreplicationjob
#>
function Resume-AzSiteRecoveryReplicationJob {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IJob])]
...
begin {
    try {
        ...
        $mapping = @{
            Resume = 'Az.SiteRecovery.private\Resume-AzSiteRecoveryReplicationJob_Resume';
            ResumeExpanded = 'Az.SiteRecovery.private\Resume-AzSiteRecoveryReplicationJob_ResumeExpanded';
            ResumeViaIdentity = 'Az.SiteRecovery.private\Resume-AzSiteRecoveryReplicationJob_ResumeViaIdentity';
            ResumeViaIdentityExpanded = 'Az.SiteRecovery.private\Resume-AzSiteRecoveryReplicationJob_ResumeViaIdentityExpanded';
        }
