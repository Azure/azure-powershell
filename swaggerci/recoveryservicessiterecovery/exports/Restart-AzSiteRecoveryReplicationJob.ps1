...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/restart-azsiterecoveryreplicationjob
#>
function Restart-AzSiteRecoveryReplicationJob {
...
begin {
    try {
        ...
        $mapping = @{
            Restart = 'Az.SiteRecovery.private\Restart-AzSiteRecoveryReplicationJob_Restart';
            RestartViaIdentity = 'Az.SiteRecovery.private\Restart-AzSiteRecoveryReplicationJob_RestartViaIdentity';
        }
