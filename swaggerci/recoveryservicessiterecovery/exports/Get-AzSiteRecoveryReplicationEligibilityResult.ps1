...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoveryreplicationeligibilityresult
#>
function Get-AzSiteRecoveryReplicationEligibilityResult {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IReplicationEligibilityResults])]
