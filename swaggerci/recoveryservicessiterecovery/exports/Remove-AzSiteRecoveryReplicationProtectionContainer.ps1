...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/remove-azsiterecoveryreplicationprotectioncontainer
#>
function Remove-AzSiteRecoveryReplicationProtectionContainer {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.SiteRecovery.private\Remove-AzSiteRecoveryReplicationProtectionContainer_Delete';
            DeleteViaIdentity = 'Az.SiteRecovery.private\Remove-AzSiteRecoveryReplicationProtectionContainer_DeleteViaIdentity';
        }
