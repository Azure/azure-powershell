...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoveryreplicationprotectionintent
#>
...
begin {
    try {
        ...
        $mapping = @{
            ...
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationProtectionIntent_List';
        }
