...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/remove-azsiterecoveryreplicationfabric
#>
function Remove-AzSiteRecoveryReplicationFabric {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.SiteRecovery.private\Remove-AzSiteRecoveryReplicationFabric_Delete';
            DeleteViaIdentity = 'Az.SiteRecovery.private\Remove-AzSiteRecoveryReplicationFabric_DeleteViaIdentity';
        }
