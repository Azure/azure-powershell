...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/remove-azsiterecoveryreplicationvcenter
#>
function Remove-AzSiteRecoveryReplicationvCenter {
