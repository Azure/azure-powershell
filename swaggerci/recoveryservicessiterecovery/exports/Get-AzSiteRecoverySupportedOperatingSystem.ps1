...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoverysupportedoperatingsystem
#>
function Get-AzSiteRecoverySupportedOperatingSystem {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.ISupportedOperatingSystems])]
