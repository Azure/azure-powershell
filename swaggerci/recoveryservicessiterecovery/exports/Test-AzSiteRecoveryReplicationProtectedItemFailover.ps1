...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/test-azsiterecoveryreplicationprotecteditemfailover
#>
function Test-AzSiteRecoveryReplicationProtectedItemFailover {
...
begin {
    try {
        ...
        $mapping = @{
            Test = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationProtectedItemFailover_Test';
            TestExpanded = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationProtectedItemFailover_TestExpanded';
            TestViaIdentity = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationProtectedItemFailover_TestViaIdentity';
            TestViaIdentityExpanded = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationProtectedItemFailover_TestViaIdentityExpanded';
        }
