...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IUnplannedFailoverInput
.Inputs
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/invoke-azsiterecoveryunplannedreplicationprotecteditemfailover
#>
...
begin {
    try {
        ...
        $mapping = @{
            Unplanned = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryUnplannedReplicationProtectedItemFailover_Unplanned';
            UnplannedExpanded = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryUnplannedReplicationProtectedItemFailover_UnplannedExpanded';
            UnplannedViaIdentity = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryUnplannedReplicationProtectedItemFailover_UnplannedViaIdentity';
            UnplannedViaIdentityExpanded = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryUnplannedReplicationProtectedItemFailover_UnplannedViaIdentityExpanded';
        }
