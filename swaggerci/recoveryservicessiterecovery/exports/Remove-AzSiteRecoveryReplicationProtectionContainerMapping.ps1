...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/remove-azsiterecoveryreplicationprotectioncontainermapping
#>
...
begin {
    try {
        ...
        $mapping = @{
            ...
            DeleteExpanded = 'Az.SiteRecovery.private\Remove-AzSiteRecoveryReplicationProtectionContainerMapping_DeleteExpanded';
            DeleteViaIdentity = 'Az.SiteRecovery.private\Remove-AzSiteRecoveryReplicationProtectionContainerMapping_DeleteViaIdentity';
