...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/repair-azsiterecoveryreplicationprotecteditemreplication
#>
function Repair-AzSiteRecoveryReplicationProtectedItemReplication {
...
begin {
    try {
        ...
        $mapping = @{
            Repair = 'Az.SiteRecovery.private\Repair-AzSiteRecoveryReplicationProtectedItemReplication_Repair';
            RepairViaIdentity = 'Az.SiteRecovery.private\Repair-AzSiteRecoveryReplicationProtectedItemReplication_RepairViaIdentity';
        }
