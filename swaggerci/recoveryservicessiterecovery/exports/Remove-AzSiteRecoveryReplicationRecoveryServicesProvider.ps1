...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/remove-azsiterecoveryreplicationrecoveryservicesprovider
#>
function Remove-AzSiteRecoveryReplicationRecoveryServicesProvider {
...
begin {
    try {
        ...
        $mapping = @{
            ...
            DeleteViaIdentity = 'Az.SiteRecovery.private\Remove-AzSiteRecoveryReplicationRecoveryServicesProvider_DeleteViaIdentity';
        }
