...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/test-azsiterecoveryreplicationprotecteditemfailovercleanup
#>
function Test-AzSiteRecoveryReplicationProtectedItemFailoverCleanup {
...
begin {
    try {
        ...
        $mapping = @{
            Test = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationProtectedItemFailoverCleanup_Test';
            TestExpanded = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationProtectedItemFailoverCleanup_TestExpanded';
            TestViaIdentity = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationProtectedItemFailoverCleanup_TestViaIdentity';
            TestViaIdentityExpanded = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationProtectedItemFailoverCleanup_TestViaIdentityExpanded';
        }
