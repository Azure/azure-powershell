...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoveryreplicationstorageclassification
#>
function Get-AzSiteRecoveryReplicationStorageClassification {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IStorageClassification])]
