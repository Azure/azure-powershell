...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/update-azsiterecoveryreplicationmigrationitem
#>
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.SiteRecovery.private\Update-AzSiteRecoveryReplicationMigrationItem_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.SiteRecovery.private\Update-AzSiteRecoveryReplicationMigrationItem_UpdateViaIdentityExpanded';
        }
