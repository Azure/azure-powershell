...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.ITestMigrateCleanupInput
.Inputs
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/test-azsiterecoveryreplicationmigrationitemmigratecleanup
#>
