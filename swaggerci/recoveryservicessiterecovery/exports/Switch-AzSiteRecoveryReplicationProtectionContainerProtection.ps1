...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/switch-azsiterecoveryreplicationprotectioncontainerprotection
#>
function Switch-AzSiteRecoveryReplicationProtectionContainerProtection {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IProtectionContainer])]
