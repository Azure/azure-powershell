...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoveryreplicationmigrationitem
#>
function Get-AzSiteRecoveryReplicationMigrationItem {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationMigrationItem_Get';
            GetViaIdentity = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationMigrationItem_GetViaIdentity';
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationMigrationItem_List';
            List1 = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationMigrationItem_List1';
        }
