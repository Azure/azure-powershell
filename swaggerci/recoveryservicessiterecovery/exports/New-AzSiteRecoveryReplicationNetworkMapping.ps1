...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.INetworkMapping
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/new-azsiterecoveryreplicationnetworkmapping
#>
function New-AzSiteRecoveryReplicationNetworkMapping {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.INetworkMapping])]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.SiteRecovery.private\New-AzSiteRecoveryReplicationNetworkMapping_CreateExpanded';
        }
