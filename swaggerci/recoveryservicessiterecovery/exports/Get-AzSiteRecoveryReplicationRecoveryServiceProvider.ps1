...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoveryreplicationrecoveryserviceprovider
#>
function Get-AzSiteRecoveryReplicationRecoveryServiceProvider {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationRecoveryServiceProvider_List';
        }
