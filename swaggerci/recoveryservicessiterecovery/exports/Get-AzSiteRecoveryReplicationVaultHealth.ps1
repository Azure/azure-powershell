...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IVaultHealthDetails
.Notes
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoveryreplicationvaulthealth
#>
function Get-AzSiteRecoveryReplicationVaultHealth {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IVaultHealthDetails])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationVaultHealth_Get';
            GetViaIdentity = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationVaultHealth_GetViaIdentity';
        }
