...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoverytargetcomputesize
#>
function Get-AzSiteRecoveryTargetComputeSize {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.ITargetComputeSize])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryTargetComputeSize_List';
        }
