...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IMigrationRecoveryPoint
.Notes
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoverymigrationrecoverypoint
#>
function Get-AzSiteRecoveryMigrationRecoveryPoint {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IMigrationRecoveryPoint])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.SiteRecovery.private\Get-AzSiteRecoveryMigrationRecoveryPoint_Get';
            GetViaIdentity = 'Az.SiteRecovery.private\Get-AzSiteRecoveryMigrationRecoveryPoint_GetViaIdentity';
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryMigrationRecoveryPoint_List';
        }
