...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/move-azsiterecoveryreplicationfabricgateway
#>
...
[CmdletBinding(DefaultParameterSetName='ReassociateExpanded', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Reassociate', Mandatory)]
    [Parameter(ParameterSetName='ReassociateExpanded', Mandatory)]
    ...
    [Parameter(ParameterSetName='Reassociate')]
    [Parameter(ParameterSetName='ReassociateExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Path')]
    ...
    [Parameter(ParameterSetName='ReassociateViaIdentity', Mandatory, ValueFromPipeline)]
    [Parameter(ParameterSetName='ReassociateViaIdentityExpanded', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.ISiteRecoveryIdentity]
    # Identity Parameter
    ...
    [Parameter(ParameterSetName='Reassociate', Mandatory, ValueFromPipeline)]
    [Parameter(ParameterSetName='ReassociateViaIdentity', Mandatory, ValueFromPipeline)]
    ...
    [Parameter(ParameterSetName='ReassociateExpanded')]
    [Parameter(ParameterSetName='ReassociateViaIdentityExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Body')]
    [System.String]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            ReassociateExpanded = 'Az.SiteRecovery.private\Move-AzSiteRecoveryReplicationFabricGateway_ReassociateExpanded';
            ReassociateViaIdentity = 'Az.SiteRecovery.private\Move-AzSiteRecoveryReplicationFabricGateway_ReassociateViaIdentity';
            ReassociateViaIdentityExpanded = 'Az.SiteRecovery.private\Move-AzSiteRecoveryReplicationFabricGateway_ReassociateViaIdentityExpanded';
        }
        if (('Reassociate', 'ReassociateExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
