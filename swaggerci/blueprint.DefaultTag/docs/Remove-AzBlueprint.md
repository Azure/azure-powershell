...
online version: https://learn.microsoft.com/powershell/module/az.blueprint/remove-azblueprint
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzBlueprint -Name <String> -ResourceScope <String> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzBlueprint -InputObject <IBlueprintIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
