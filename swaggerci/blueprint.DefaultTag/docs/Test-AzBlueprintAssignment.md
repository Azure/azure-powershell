...
online version: https://learn.microsoft.com/powershell/module/az.blueprint/test-azblueprintassignment
schema: 2.0.0
---

# Test-AzBlueprintAssignment
...
### Is (Default)
```
Test-AzBlueprintAssignment -Name <String> -ResourceScope <String> [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### IsViaIdentity
```
Test-AzBlueprintAssignment -InputObject <IBlueprintIdentity> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
