...
online version: https://learn.microsoft.com/powershell/module/az.containerregistry/get-azcontainerregistryconnectedregistry
schema: 2.0.0
---

# Get-AzContainerRegistryConnectedRegistry
...
### List (Default)
```
Get-AzContainerRegistryConnectedRegistry -RegistryName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-Filter <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzContainerRegistryConnectedRegistry -Name <String> -RegistryName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzContainerRegistryConnectedRegistry -InputObject <IContainerRegistryIdentity>
