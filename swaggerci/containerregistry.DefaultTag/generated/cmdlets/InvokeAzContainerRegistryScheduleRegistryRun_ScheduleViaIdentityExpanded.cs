...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.IEventListener
    {
        ...
        public string AgentPoolName { get => _runRequestBody.AgentPoolName ?? null; set => _runRequestBody.AgentPoolName = value; }
        ...
        public global::System.Management.Automation.SwitchParameter IsArchiveEnabled { get => _runRequestBody.IsArchiveEnabled ?? default(global::System.Management.Automation.SwitchParameter); set => _runRequestBody.IsArchiveEnabled = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string LogTemplate { get => _runRequestBody.LogTemplate ?? null; set => _runRequestBody.LogTemplate = value; }
        ...
        SerializedName = @"type",
        PossibleTypes = new [] { typeof(string) })]
        public string Type { get => _runRequestBody.Type ?? null; set => _runRequestBody.Type = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20190601Preview.IRun">Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20190601Preview.IRun</see>
        /// from the remote call</param>
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets.InvokeAzContainerRegistryScheduleRegistryRun_ScheduleViaIdentityExpanded Clone()
        {
            ...
            clone._runRequestBody = this._runRequestBody;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.RegistriesScheduleRunViaIdentity(InputObject.Id, _runRequestBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.RegistriesScheduleRun(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.RegistryName ?? null, _runRequestBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_runRequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20190601Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_runRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_runRequestBody })
                    {
