...
namespace Microsoft.Azure.PowerShell.Cmdlets.PowerPlatform.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.PowerPlatform.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.PowerPlatform.Support";
