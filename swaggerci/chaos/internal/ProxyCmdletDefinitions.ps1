...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20.IOperation
.Link
https://docs.microsoft.com/en-us/powershell/module/az.chaos/get-azchaosoperation
#>
function Get-AzChaosOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20.IOperation])]
