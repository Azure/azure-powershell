...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SessionState Active = @"Active";

        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SessionState Disconnected = @"Disconnected";

        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SessionState LogOff = @"LogOff";

        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SessionState Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SessionState Unknown = @"Unknown";

        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SessionState UserProfileDiskMounted = @"UserProfileDiskMounted";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SessionState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SessionState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SessionState e1, Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SessionState e2)
        {
            return !e2.Equals(e1);
        }
