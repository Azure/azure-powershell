...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support";
