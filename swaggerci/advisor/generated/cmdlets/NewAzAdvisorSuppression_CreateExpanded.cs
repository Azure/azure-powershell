...
namespace Microsoft.Azure.PowerShell.Cmdlets.Advisor.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="SuppressionContractBody" /> property.</summary>
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api202001.ISuppressionContract SuppressionContractBody { get => this._suppressionContractBody; set => this._suppressionContractBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SuppressionId { get => SuppressionContractBody.SuppressionId ?? null; set => SuppressionContractBody.SuppressionId = value; }
        ...
        SerializedName = @"ttl",
        PossibleTypes = new [] { typeof(string) })]
        public string Ttl { get => SuppressionContractBody.Ttl ?? null; set => SuppressionContractBody.Ttl = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api202001.ISuppressionContract"
        /// /> from the remote call</param>
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SuppressionsCreate(ResourceUri, RecommendationId, Name, SuppressionContractBody, onOk, onNotFound, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceUri=ResourceUri,RecommendationId=RecommendationId,Name=Name,body=SuppressionContractBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api202001.IArmErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceUri=ResourceUri, RecommendationId=RecommendationId, Name=Name, body=SuppressionContractBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceUri=ResourceUri, RecommendationId=RecommendationId, Name=Name, body=SuppressionContractBody })
                    {
