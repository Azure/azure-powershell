...
### Delete (Default)
```
Remove-AzDataBoxEdgeUser -DeviceName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDataBoxEdgeUser -InputObject <IDataBoxEdgeIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
