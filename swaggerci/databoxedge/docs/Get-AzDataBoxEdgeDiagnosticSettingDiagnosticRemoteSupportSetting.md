...
### Get (Default)
```
Get-AzDataBoxEdgeDiagnosticSettingDiagnosticRemoteSupportSetting -DeviceName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDataBoxEdgeDiagnosticSettingDiagnosticRemoteSupportSetting -InputObject <IDataBoxEdgeIdentity>
