...
online version: https://docs.microsoft.com/en-us/powershell/module/az.databoxedge/install-azdataboxedgedeviceupdate
schema: 2.0.0
---
...
### Install (Default)
```
Install-AzDataBoxEdgeDeviceUpdate -DeviceName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### InstallViaIdentity
```
Install-AzDataBoxEdgeDeviceUpdate -InputObject <IDataBoxEdgeIdentity> [-DefaultProfile <PSObject>] [-AsJob]
