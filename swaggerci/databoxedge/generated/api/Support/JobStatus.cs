...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.JobStatus Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.JobStatus Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.JobStatus Invalid = @"Invalid";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.JobStatus Paused = @"Paused";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.JobStatus Running = @"Running";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.JobStatus Scheduled = @"Scheduled";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.JobStatus Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.JobStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.JobStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.JobStatus e1, Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.JobStatus e2)
        {
            return !e2.Equals(e1);
        }
