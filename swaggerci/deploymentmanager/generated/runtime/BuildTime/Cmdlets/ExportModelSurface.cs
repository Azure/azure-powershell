...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeploymentManager.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DeploymentManager.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DeploymentManager.Support";
