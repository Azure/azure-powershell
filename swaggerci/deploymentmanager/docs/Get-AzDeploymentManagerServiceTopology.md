...
### List (Default)
```
Get-AzDeploymentManagerServiceTopology -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzDeploymentManagerServiceTopology -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDeploymentManagerServiceTopology -InputObject <IDeploymentManagerIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
