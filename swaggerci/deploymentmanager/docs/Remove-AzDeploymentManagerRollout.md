...
### Delete (Default)
```
Remove-AzDeploymentManagerRollout -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDeploymentManagerRollout -InputObject <IDeploymentManagerIdentity> [-DefaultProfile <PSObject>]
