...
### Restart (Default)
```
Restart-AzDeploymentManagerRollout -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-SkipSucceeded] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestartViaIdentity
```
Restart-AzDeploymentManagerRollout -InputObject <IDeploymentManagerIdentity> [-SkipSucceeded]
