...
online version: https://docs.microsoft.com/en-us/powershell/module/az.connectedkubernetes/new-azconnectedkubernetesconnectedcluster
schema: 2.0.0
---
...
New-AzConnectedKubernetesConnectedCluster -ClusterName <String> -ResourceGroupName <String>
 ...
 [-SubscriptionId <String>] [-Distribution <String>] [-Infrastructure <String>]
