...
online version: https://docs.microsoft.com/en-us/powershell/module/az.connectedkubernetes/update-azconnectedkubernetesconnectedcluster
schema: 2.0.0
---

# Update-AzConnectedKubernetesConnectedCluster
...
```
Update-AzConnectedKubernetesConnectedCluster -ClusterName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-Property <IAny>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzConnectedKubernetesConnectedCluster -InputObject <IConnectedKubernetesIdentity> [-Property <IAny>]
