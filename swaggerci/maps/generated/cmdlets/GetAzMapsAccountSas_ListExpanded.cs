...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Cmdlets
{
    ...
    /// <summary>
    /// Create and list an account shared access signature token. Use this SAS token for authentication to Azure Maps REST APIs
    /// through various Azure Maps SDKs. As prerequisite to create a SAS Token. \n\nPrerequisites:\n1. Create or have an existing
    /// User Assigned Managed Identity in the same Azure region as the account. \n2. Create or update an Azure Map account with
    /// the same Azure region as the User Assigned Managed Identity is placed.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListSas=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Maps/accounts/{accountName}/listSas"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMapsAccountSas_ListExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(string))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Maps.Description(@"Create and list an account shared access signature token. Use this SAS token for authentication to Azure Maps REST APIs through various Azure Maps SDKs. As prerequisite to create a SAS Token. \n\nPrerequisites:\n1. Create or have an existing User Assigned Managed Identity in the same Azure region as the account. \n2. Create or update an Azure Map account with the same Azure region as the User Assigned Managed Identity is placed.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Maps.Generated]
    public partial class GetAzMapsAccountSas_ListExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.IEventListener
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.IAccountSasParameters _mapsAccountSasParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.AccountSasParameters();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The date time offset of when the token validity expires. For example \"2017-05-24T10:42:03.1567373Z\"")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Expiry { get => _mapsAccountSasParametersBody.Expiry ?? null; set => _mapsAccountSasParametersBody.Expiry = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Required parameter which represents the desired maximum request per second to allowed for the given SAS token. This does not guarantee perfect accuracy in measurements but provides application safe guards of abuse with eventual enforcement.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Maps.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Maps.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public int MaxRatePerSecond { get => _mapsAccountSasParametersBody.MaxRatePerSecond; set => _mapsAccountSasParametersBody.MaxRatePerSecond = value; }
        ...
        /// Id.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The principal Id also known as the object Id of a User Assigned Managed Identity currently assigned to the Map Account. To assign a Managed Identity of the account, use operation Create or Update an assign a User Assigned Identity resource Id.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Maps.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Maps.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string PrincipalId { get => _mapsAccountSasParametersBody.PrincipalId ?? null; set => _mapsAccountSasParametersBody.PrincipalId = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Optional, allows control of which region locations are permitted access to Azure Maps REST APIs with the SAS token. Example: \"eastus\", \"westus2\". Omitting this parameter will allow all region locations to be accessible.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Maps.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Maps.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] Region { get => _mapsAccountSasParametersBody.Region ?? null /* arrayOf */; set => _mapsAccountSasParametersBody.Region = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The Map account key to use for signing.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Maps.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Maps.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Maps.Support.SigningKey))]
        public Microsoft.Azure.PowerShell.Cmdlets.Maps.Support.SigningKey SigningKey { get => _mapsAccountSasParametersBody.SigningKey; set => _mapsAccountSasParametersBody.SigningKey = value; }

        /// <summary>
        /// The date time offset of when the token validity begins. For example "2017-05-24T10:42:03.1567373Z".
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The date time offset of when the token validity begins. For example \"2017-05-24T10:42:03.1567373Z\".")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Maps.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Maps.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Start { get => _mapsAccountSasParametersBody.Start ?? null; set => _mapsAccountSasParametersBody.Start = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.IMapsAccountSasToken">Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.IMapsAccountSasToken</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.IMapsAccountSasToken> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzMapsAccountSas_ListExpanded" /> cmdlet class.
        /// </summary>
        public GetAzMapsAccountSas_ListExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'AccountsListSas' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AccountsListSas(SubscriptionId, ResourceGroupName, AccountName, _mapsAccountSasParametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,AccountName=AccountName,body=_mapsAccountSasParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, AccountName=AccountName, body=_mapsAccountSasParametersBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.IMapsAccountSasToken> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.IMapsAccountSasToken
                WriteObject((await response).AccountSasToken);
            }
        }
    }
}