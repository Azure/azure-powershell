...
online version: https://docs.microsoft.com/en-us/powershell/module/az.stack/remove-azstackregistration
schema: 2.0.0
---

# Remove-AzStackRegistration
...
### Delete (Default)
```
Remove-AzStackRegistration -Name <String> -ResourceGroup <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzStackRegistration -InputObject <IStackIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
