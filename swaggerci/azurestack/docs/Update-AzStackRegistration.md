...
online version: https://docs.microsoft.com/en-us/powershell/module/az.stack/update-azstackregistration
schema: 2.0.0
---

# Update-AzStackRegistration
...
```
Update-AzStackRegistration -Name <String> -ResourceGroup <String> -RegistrationToken <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzStackRegistration -InputObject <IStackIdentity> -RegistrationToken <String>
