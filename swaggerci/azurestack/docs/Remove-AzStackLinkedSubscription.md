...
online version: https://docs.microsoft.com/en-us/powershell/module/az.stack/remove-azstacklinkedsubscription
schema: 2.0.0
---

# Remove-AzStackLinkedSubscription
...
### Delete (Default)
```
Remove-AzStackLinkedSubscription -Name <String> -ResourceGroup <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzStackLinkedSubscription -InputObject <IStackIdentity> [-DefaultProfile <PSObject>] [-PassThru]
...
Aliases: LinkedSubscriptionName
