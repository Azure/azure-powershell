...
online version: https://docs.microsoft.com/en-us/powershell/module/az.stack/enable-azstackregistrationremotemanagement
schema: 2.0.0
---

# Enable-AzStackRegistrationRemoteManagement
...
### Enable (Default)
```
Enable-AzStackRegistrationRemoteManagement -RegistrationName <String> -ResourceGroup <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### EnableViaIdentity
```
Enable-AzStackRegistrationRemoteManagement -InputObject <IStackIdentity> [-DefaultProfile <PSObject>]
