...
online version: https://docs.microsoft.com/en-us/powershell/module/az.stack/get-azstackregistrationactivationkey
schema: 2.0.0
---

# Get-AzStackRegistrationActivationKey
...
### Get (Default)
```
Get-AzStackRegistrationActivationKey -RegistrationName <String> -ResourceGroup <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzStackRegistrationActivationKey -InputObject <IStackIdentity> [-DefaultProfile <PSObject>] [-Confirm]
