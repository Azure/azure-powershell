...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.Status Accepted = @"Accepted";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.Status Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.Status Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.Status InProgress = @"InProgress";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.Status Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.Status TransientFailure = @"TransientFailure";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
