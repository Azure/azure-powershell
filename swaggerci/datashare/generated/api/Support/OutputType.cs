...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.OutputType Csv = @"Csv";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.OutputType Parquet = @"Parquet";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.OutputType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.OutputType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.OutputType e1, Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.OutputType e2)
        {
            return !e2.Equals(e1);
        }
