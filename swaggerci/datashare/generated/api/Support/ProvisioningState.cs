...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.ProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.ProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.ProvisioningState Moving = @"Moving";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
