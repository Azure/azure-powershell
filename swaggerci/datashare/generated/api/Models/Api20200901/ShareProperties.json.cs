...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20200901
{
    ...
    public partial class ShareProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20200901.IShareProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20200901.IShareProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20200901.IShareProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonObject json ? new ShareProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonObject into a new instance of <see cref="ShareProperties" />.
        /// </summary>
        ...
        internal ShareProperties(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonObject json)
        {
            ...
            {_description = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonString>("description"), out var __jsonDescription) ? (string)__jsonDescription : (string)Description;}
            ...
            {_term = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonString>("terms"), out var __jsonTerms) ? (string)__jsonTerms : (string)Term;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="ShareProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ShareProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._description)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonString(this._description.ToString()) : null, "description" ,container.Add );
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            AddIf( null != (((object)this._term)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonString(this._term.ToString()) : null, "terms" ,container.Add );
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.SerializationMode.IncludeReadOnly))
            {
