...
### List (Default)
```
Get-AzDataShareTrigger -AccountName <String> -ResourceGroupName <String> -ShareSubscriptionName <String>
 [-SubscriptionId <String[]>] [-SkipToken <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzDataShareTrigger -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzDataShareTrigger -InputObject <IDataShareIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
