...
### Delete (Default)
```
Remove-AzDataShareTrigger -AccountName <String> -Name <String> -ResourceGroupName <String>
 -ShareSubscriptionName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDataShareTrigger -InputObject <IDataShareIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
