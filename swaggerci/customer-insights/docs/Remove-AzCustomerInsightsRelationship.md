...
online version: https://docs.microsoft.com/en-us/powershell/module/az.customerinsights/remove-azcustomerinsightsrelationship
schema: 2.0.0
---

# Remove-AzCustomerInsightsRelationship
...
### Delete (Default)
```
Remove-AzCustomerInsightsRelationship -HubName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzCustomerInsightsRelationship -InputObject <ICustomerInsightsIdentity> [-DefaultProfile <PSObject>]
