...
online version: https://docs.microsoft.com/en-us/powershell/module/az.customerinsights/get-azcustomerinsightspredictiontrainingresult
schema: 2.0.0
---

# Get-AzCustomerInsightsPredictionTrainingResult
...
### Get (Default)
```
Get-AzCustomerInsightsPredictionTrainingResult -HubName <String> -PredictionName <String>
...
### GetViaIdentity
```
Get-AzCustomerInsightsPredictionTrainingResult -InputObject <ICustomerInsightsIdentity>
