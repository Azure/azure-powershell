...
online version: https://docs.microsoft.com/en-us/powershell/module/az.customerinsights/remove-azcustomerinsightskpi
schema: 2.0.0
---

# Remove-AzCustomerInsightsKpi
...
### Delete (Default)
```
Remove-AzCustomerInsightsKpi -HubName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzCustomerInsightsKpi -InputObject <ICustomerInsightsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
