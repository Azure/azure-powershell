...
namespace Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426
{
    ...
    public partial class GetImageUploadUrlInput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IGetImageUploadUrlInput.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IGetImageUploadUrlInput.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IGetImageUploadUrlInput FromJson(Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.Json.JsonObject json ? new GetImageUploadUrlInput(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.Json.JsonObject into a new instance of <see cref="GetImageUploadUrlInput" />.
        /// </summary>
        ...
        internal GetImageUploadUrlInput(Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.Json.JsonObject json)
        {
            ...
            {_relativePath = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.Json.JsonString>("relativePath"), out var __jsonRelativePath) ? (string)__jsonRelativePath : (string)RelativePath;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="GetImageUploadUrlInput" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetImageUploadUrlInput" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._relativePath)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.Json.JsonString(this._relativePath.ToString()) : null, "relativePath" ,container.Add );
