...
namespace Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Support";
