...
namespace Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByHub=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CustomerInsights/hubs/{hubName}/authorizationPolicies"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzCustomerInsightsAuthorizationPolicy_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IAuthorizationPolicyResourceFormat))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Description(@"Gets all the authorization policies in a specified hub.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Generated]
    public partial class GetAzCustomerInsightsAuthorizationPolicy_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.IEventListener
    {
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IAuthorizationPolicyListResult"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IAuthorizationPolicyListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzCustomerInsightsAuthorizationPolicy_List" /> cmdlet class.
        /// </summary>
        public GetAzCustomerInsightsAuthorizationPolicy_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AuthorizationPoliciesListByHub(ResourceGroupName, HubName, SubscriptionId, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,HubName=HubName,SubscriptionId=SubscriptionId})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IAuthorizationPolicyListResult> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        ...
                        {
                            requestMessage = requestMessage.Clone(new global::System.Uri( _nextLink ),Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.Method.Get );
                            await ((Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.IEventListener)this).Signal(Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.Events.FollowingNextLink); if( ((Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.IEventListener)this).Token.IsCancellationRequested ) { return; }
                            await this.Client.AuthorizationPoliciesListByHub_Call(requestMessage, onOk, this, Pipeline);
                        }
                    }
                }
            }
