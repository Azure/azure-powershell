...
namespace Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetUploadUrlForEntityType=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CustomerInsights/hubs/{hubName}/images/getEntityTypeImageUploadUrl"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzCustomerInsightsImageUploadUrl_Get", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Description(@"Gets entity type (profile or interaction) image upload URL.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Generated]
    public partial class GetAzCustomerInsightsImageUploadUrl_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IGetImageUploadUrlInput _parameter;

        /// <summary>Input type for getting image upload url.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Input type for getting image upload url.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Input type for getting image upload url.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IGetImageUploadUrlInput) })]
        public Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IGetImageUploadUrlInput Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzCustomerInsightsImageUploadUrl_Get" /> cmdlet class.
        /// </summary>
        public GetAzCustomerInsightsImageUploadUrl_Get()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ImagesGetUploadUrlForEntityType' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ImagesGetUploadUrlForEntityType(ResourceGroupName, HubName, SubscriptionId, Parameter, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,HubName=HubName,SubscriptionId=SubscriptionId,body=Parameter})
                    {
