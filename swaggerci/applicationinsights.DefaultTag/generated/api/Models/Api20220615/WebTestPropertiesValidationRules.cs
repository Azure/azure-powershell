...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20220615
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20220615.IWebTestPropertiesValidationRulesInternal
    {
        ...
        /// <summary>Backing field for <see cref="IgnoreHttpStatusCode" /> property.</summary>
        private bool? _ignoreHttpStatusCode;

        /// <summary>When set, validation will ignore the status code.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Origin(Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.PropertyOrigin.Owned)]
        public bool? IgnoreHttpStatusCode { get => this._ignoreHttpStatusCode; set => this._ignoreHttpStatusCode = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(bool) })]
        bool? IgnoreHttpStatusCode { get; set; }
        /// <summary>
        /// A number of days to check still remain before the the existing SSL cert expires. Value must be positive and the SSLCheck
        /// must be set to true.
        /// </summary>
