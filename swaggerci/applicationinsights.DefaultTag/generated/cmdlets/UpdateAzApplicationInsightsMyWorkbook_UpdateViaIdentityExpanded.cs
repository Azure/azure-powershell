...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzApplicationInsightsMyWorkbook_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzApplicationInsightsMyWorkbook_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.IEventListener
    {
        ...
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(string) })]
        public string Name { get => _workbookPropertiesBody.Name ?? null; set => _workbookPropertiesBody.Name = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string PropertiesSourceId { get => _workbookPropertiesBody.SourceId ?? null; set => _workbookPropertiesBody.SourceId = value; }
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(string) })]
        public string[] PropertiesTag { get => _workbookPropertiesBody.PropertiesTag ?? null /* arrayOf */; set => _workbookPropertiesBody.PropertiesTag = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.MyWorkbooksUpdateViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("SourceId") ? SourceId : null, _workbookPropertiesBody, onCreated, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.MyWorkbooksUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ResourceName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("SourceId") ? SourceId : null, _workbookPropertiesBody, onCreated, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SourceId=this.InvocationInformation.BoundParameters.ContainsKey("SourceId") ? SourceId : null,body=_workbookPropertiesBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzApplicationInsightsMyWorkbook_UpdateViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzApplicationInsightsMyWorkbook_UpdateViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20210308.IMyWorkbookError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SourceId=this.InvocationInformation.BoundParameters.ContainsKey("SourceId") ? SourceId : null, body=_workbookPropertiesBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SourceId=this.InvocationInformation.BoundParameters.ContainsKey("SourceId") ? SourceId : null, body=_workbookPropertiesBody })
                    {
