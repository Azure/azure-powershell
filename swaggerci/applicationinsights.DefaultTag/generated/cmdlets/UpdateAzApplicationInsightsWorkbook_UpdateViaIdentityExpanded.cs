        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.WorkbooksUpdateViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("SourceId") ? SourceId : null, _workbookUpdateParametersBody, onOk, onCreated, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.WorkbooksUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ResourceName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("SourceId") ? SourceId : null, _workbookUpdateParametersBody, onOk, onCreated, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SourceId=this.InvocationInformation.BoundParameters.ContainsKey("SourceId") ? SourceId : null,body=_workbookUpdateParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20220401.IWorkbookError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SourceId=this.InvocationInformation.BoundParameters.ContainsKey("SourceId") ? SourceId : null, body=_workbookUpdateParametersBody })
                    {
