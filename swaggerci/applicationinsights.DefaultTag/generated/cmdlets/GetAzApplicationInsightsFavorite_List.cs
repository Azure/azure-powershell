...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/components/{resourceName}/favorites"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzApplicationInsightsFavorite_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Description(@"Gets a list of favorites defined within an Application Insights component.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Generated]
    public partial class GetAzApplicationInsightsFavorite_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Flag indicating whether or not to return the full content for each applicable favorite. If false, only return summary
        /// content for favorites.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Flag indicating whether or not to return the full content for each applicable favorite. If false, only return summary content for favorites.")]
        ...
        /// <summary>The type of favorite. Value can be either shared or user.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The type of favorite. Value can be either shared or user.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.FavoriteSourceType _sourceType;

        /// <summary>
        /// Source type of favorite to return. When left out, the source type defaults to 'other' (not present in this enum).
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Source type of favorite to return. When left out, the source type defaults to 'other' (not present in this enum).")]
        [Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.FavoriteSourceType) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.ParameterCategory.Query)]
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.FavoriteSourceType))]
        public Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.FavoriteSourceType SourceType { get => this._sourceType; set => this._sourceType = value; }
        ...
        /// <summary>Tags that must be present on each favorite returned.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Tags that must be present on each favorite returned.")]
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzApplicationInsightsFavorite_List" /> cmdlet class.
        /// </summary>
        public GetAzApplicationInsightsFavorite_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.FavoritesList(ResourceGroupName, SubscriptionId, ResourceName, this.InvocationInformation.BoundParameters.ContainsKey("FavoriteType") ? FavoriteType : null, this.InvocationInformation.BoundParameters.ContainsKey("SourceType") ? SourceType : null, this.InvocationInformation.BoundParameters.ContainsKey("CanFetchContent") ? CanFetchContent : default(global::System.Management.Automation.SwitchParameter?), this.InvocationInformation.BoundParameters.ContainsKey("Tag") ? Tag : null /* arrayOf */, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,SubscriptionId=SubscriptionId,ResourceName=ResourceName,FavoriteType=this.InvocationInformation.BoundParameters.ContainsKey("FavoriteType") ? FavoriteType : null,SourceType=this.InvocationInformation.BoundParameters.ContainsKey("SourceType") ? SourceType : null,CanFetchContent=this.InvocationInformation.BoundParameters.ContainsKey("CanFetchContent") ? CanFetchContent : default(global::System.Management.Automation.SwitchParameter?),Tag=this.InvocationInformation.BoundParameters.ContainsKey("Tag") ? Tag : null /* arrayOf */})
                    {
