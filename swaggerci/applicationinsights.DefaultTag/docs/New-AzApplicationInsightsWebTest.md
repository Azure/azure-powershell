...
New-AzApplicationInsightsWebTest -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-ValidationRuleExpectedHttpStatusCode <Int32>] [-ValidationRuleIgnoreHttpStatusCode]
 [-ValidationRuleSslCertRemainingLifetimeCheck <Int32>] [-ValidationRuleSslCheck] [-WebTestKind <WebTestKind>]
