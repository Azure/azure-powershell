...
online version: https://learn.microsoft.com/powershell/module/az.applicationinsights/remove-azapplicationinsightsexportconfiguration
schema: 2.0.0
---

# Remove-AzApplicationInsightsExportConfiguration
...
### Delete (Default)
```
Remove-AzApplicationInsightsExportConfiguration -ExportId <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzApplicationInsightsExportConfiguration -InputObject <IApplicationInsightsIdentity>
