...
online version: https://learn.microsoft.com/powershell/module/az.applicationinsights/get-azapplicationinsightscomponentlinkedstorageaccount
schema: 2.0.0
---

# Get-AzApplicationInsightsComponentLinkedStorageAccount
...
### Get (Default)
```
Get-AzApplicationInsightsComponentLinkedStorageAccount -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzApplicationInsightsComponentLinkedStorageAccount -InputObject <IApplicationInsightsIdentity>
