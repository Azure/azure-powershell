...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlHyperscale.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlHyperscale.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlHyperscale.Support";
