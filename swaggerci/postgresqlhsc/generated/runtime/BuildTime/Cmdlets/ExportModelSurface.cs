...
namespace Microsoft.Azure.PowerShell.Cmdlets.CosmosDbForPostgreSql.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.CosmosDbForPostgreSql.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.CosmosDbForPostgreSql.Support";
