# How-To
This document describes how to develop for `Az.PostgreSqlHyperscale`.

## Building `Az.PostgreSqlHyperscale`
...
## Testing `Az.PostgreSqlHyperscale`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Az.PostgreSqlHyperscale` into the session.
