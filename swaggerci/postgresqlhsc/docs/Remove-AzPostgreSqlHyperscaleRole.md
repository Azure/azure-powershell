...
online version: https://docs.microsoft.com/en-us/powershell/module/az.postgresqlhyperscale/remove-azpostgresqlhyperscalerole
schema: 2.0.0
---

# Remove-AzPostgreSqlHyperscaleRole
...
### Delete (Default)
```
Remove-AzPostgreSqlHyperscaleRole -Name <String> -ResourceGroupName <String> -ServerGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzPostgreSqlHyperscaleRole -InputObject <IPostgreSqlHyperscaleIdentity> [-DefaultProfile <PSObject>]
