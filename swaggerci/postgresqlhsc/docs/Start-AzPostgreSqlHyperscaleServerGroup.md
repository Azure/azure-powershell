...
online version: https://docs.microsoft.com/en-us/powershell/module/az.postgresqlhyperscale/start-azpostgresqlhyperscaleservergroup
schema: 2.0.0
---

# Start-AzPostgreSqlHyperscaleServerGroup
...
### Start (Default)
```
Start-AzPostgreSqlHyperscaleServerGroup -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-AzPostgreSqlHyperscaleServerGroup -InputObject <IPostgreSqlHyperscaleIdentity>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
