...
online version: https://learn.microsoft.com/powershell/module/az.cosmosdbforpostgresql/remove-azcosmosdbforpostgresqlfirewallrule
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzCosmosDbForPostgreSqlFirewallRule -ClusterName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzCosmosDbForPostgreSqlFirewallRule -InputObject <ICosmosDbForPostgreSqlIdentity>
