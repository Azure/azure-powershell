...
online version: https://docs.microsoft.com/en-us/powershell/module/az.postgresqlhyperscale/restart-azpostgresqlhyperscaleservergroup
schema: 2.0.0
---

# Restart-AzPostgreSqlHyperscaleServerGroup
...
### Restart (Default)
```
Restart-AzPostgreSqlHyperscaleServerGroup -Name <String> -ResourceGroupName <String>
...
### RestartViaIdentity
```
Restart-AzPostgreSqlHyperscaleServerGroup -InputObject <IPostgreSqlHyperscaleIdentity>
