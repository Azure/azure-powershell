...
online version: https://learn.microsoft.com/powershell/module/az.cosmosdbforpostgresql/remove-azcosmosdbforpostgresqlrole
schema: 2.0.0
---

# Remove-AzCosmosDbForPostgreSqlRole
...
### Delete (Default)
```
Remove-AzCosmosDbForPostgreSqlRole -ClusterName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzCosmosDbForPostgreSqlRole -InputObject <ICosmosDbForPostgreSqlIdentity> [-DefaultProfile <PSObject>]
