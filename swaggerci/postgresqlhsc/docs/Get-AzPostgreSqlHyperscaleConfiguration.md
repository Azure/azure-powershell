...
online version: https://docs.microsoft.com/en-us/powershell/module/az.postgresqlhyperscale/get-azpostgresqlhyperscaleconfiguration
schema: 2.0.0
---

# Get-AzPostgreSqlHyperscaleConfiguration
...
### List1 (Default)
```
Get-AzPostgreSqlHyperscaleConfiguration -ResourceGroupName <String> -ServerGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzPostgreSqlHyperscaleConfiguration -Name <String> -ResourceGroupName <String> -ServerGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzPostgreSqlHyperscaleConfiguration -InputObject <IPostgreSqlHyperscaleIdentity>
