...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support";
