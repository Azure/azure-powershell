...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview
{
    ...
    public partial class ValidateMigrationInputSqlServerSqlDbSyncTaskProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateMigrationInputSqlServerSqlDbSyncTaskProperties,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.IValidates
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateSyncMigrationInputSqlServerTaskInput _input;

        /// <summary>Task input</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateSyncMigrationInputSqlServerTaskInput Input { get => (this._input = this._input ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.ValidateSyncMigrationInputSqlServerTaskInput()); set => this._input = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateSyncMigrationInputSqlServerTaskOutput[] Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesInternal.Output { get => this._output; set { {_output = value;} } }

        /// <summary>Backing field for <see cref="Output" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateSyncMigrationInputSqlServerTaskOutput[] _output;

        /// <summary>Task output. This is ignored if submitted.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateSyncMigrationInputSqlServerTaskOutput[] Output { get => this._output; }
        ...
        /// <summary>
        /// Creates an new <see cref="ValidateMigrationInputSqlServerSqlDbSyncTaskProperties" /> instance.
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IProjectTaskProperties
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateSyncMigrationInputSqlServerTaskInput) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateSyncMigrationInputSqlServerTaskInput Input { get; set; }
        /// <summary>Task output. This is ignored if submitted.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateSyncMigrationInputSqlServerTaskOutput) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateSyncMigrationInputSqlServerTaskOutput[] Output { get;  }

    }
    /// Properties for task that validates migration input for SQL to Azure SQL DB sync migrations
    internal partial interface IValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesInternal :
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IProjectTaskPropertiesInternal
    {
        /// <summary>Task input</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateSyncMigrationInputSqlServerTaskInput Input { get; set; }
        /// <summary>Task output. This is ignored if submitted.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateSyncMigrationInputSqlServerTaskOutput[] Output { get; set; }
