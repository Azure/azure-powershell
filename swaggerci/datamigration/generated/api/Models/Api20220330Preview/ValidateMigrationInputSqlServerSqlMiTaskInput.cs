...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview
{
    ...
    public partial class ValidateMigrationInputSqlServerSqlMiTaskInput :
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateMigrationInputSqlServerSqlMiTaskInput,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateMigrationInputSqlServerSqlMiTaskInputInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IBlobShare Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateMigrationInputSqlServerSqlMiTaskInputInternal.BackupBlobShare { get => (this._backupBlobShare = this._backupBlobShare ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.BlobShare()); set { {_backupBlobShare = value;} } }

        /// <summary>Internal Acessors for BackupFileShare</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IFileShare Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateMigrationInputSqlServerSqlMiTaskInputInternal.BackupFileShare { get => (this._backupFileShare = this._backupFileShare ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.FileShare()); set { {_backupFileShare = value;} } }

        /// <summary>Internal Acessors for SourceConnectionInfo</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.ISqlConnectionInfo Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateMigrationInputSqlServerSqlMiTaskInputInternal.SourceConnectionInfo { get => (this._sourceConnectionInfo = this._sourceConnectionInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.SqlConnectionInfo()); set { {_sourceConnectionInfo = value;} } }

        /// <summary>Internal Acessors for TargetConnectionInfo</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.ISqlConnectionInfo Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IValidateMigrationInputSqlServerSqlMiTaskInputInternal.TargetConnectionInfo { get => (this._targetConnectionInfo = this._targetConnectionInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.SqlConnectionInfo()); set { {_targetConnectionInfo = value;} } }
