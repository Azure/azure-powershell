...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview
{
    ...
    public partial class MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputMigrationLevel
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputMigrationLevel.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputMigrationLevel.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputMigrationLevel FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json ? new MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputMigrationLevel(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject into a new instance of <see cref="MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputMigrationLevel"
        /// />.
        /// </summary>
        ...
        internal MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputMigrationLevel(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
            ...
            {_sourceServerType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonString>("sourceServerType"), out var __jsonSourceServerType) ? (string)__jsonSourceServerType : (string)SourceServerType;}
            {_targetServerType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonString>("targetServerType"), out var __jsonTargetServerType) ? (string)__jsonTargetServerType : (string)TargetServerType;}
            ...
            {_databaseCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNumber>("databaseCount"), out var __jsonDatabaseCount) ? (float?)__jsonDatabaseCount : DatabaseCount;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputMigrationLevel" /> into a <see
        ...
        /// <returns>
        /// a serialized instance of <see cref="MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputMigrationLevel" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._sourceServerType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonString(this._sourceServerType.ToString()) : null, "sourceServerType" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._targetServerType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonString(this._targetServerType.ToString()) : null, "targetServerType" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            AddIf( null != this._databaseCount ? (Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNumber((float)this._databaseCount) : null, "databaseCount" ,container.Add );
