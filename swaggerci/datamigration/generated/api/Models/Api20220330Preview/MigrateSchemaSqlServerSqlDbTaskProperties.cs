...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview
{
    ...
    public partial class MigrateSchemaSqlServerSqlDbTaskProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateSchemaSqlServerSqlDbTaskProperties,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.IValidates
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateSchemaSqlServerSqlDbTaskInput _input;

        /// <summary>Task input</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateSchemaSqlServerSqlDbTaskInput Input { get => (this._input = this._input ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.MigrateSchemaSqlServerSqlDbTaskInput()); set => this._input = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateSchemaSqlServerSqlDbTaskOutput[] Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateSchemaSqlServerSqlDbTaskPropertiesInternal.Output { get => this._output; set { {_output = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateSchemaSqlServerSqlDbTaskOutput[] _output;

        /// <summary>Task output. This is ignored if submitted.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateSchemaSqlServerSqlDbTaskOutput[] Output { get => this._output; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IProjectTaskProperties
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateSchemaSqlServerSqlDbTaskInput) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateSchemaSqlServerSqlDbTaskInput Input { get; set; }
        /// <summary>whether the task can be cloned or not</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateSchemaSqlServerSqlDbTaskOutput) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateSchemaSqlServerSqlDbTaskOutput[] Output { get;  }
        /// <summary>Task id</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IProjectTaskPropertiesInternal
    {
        ...
        bool? IsCloneable { get; set; }
        /// <summary>Task output. This is ignored if submitted.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateSchemaSqlServerSqlDbTaskOutput[] Output { get; set; }
        /// <summary>Task id</summary>
        string TaskId { get; set; }
