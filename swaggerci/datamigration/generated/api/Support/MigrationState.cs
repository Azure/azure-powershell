...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.MigrationState Completed = @"Completed";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.MigrationState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.MigrationState InProgress = @"InProgress";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.MigrationState None = @"None";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.MigrationState Skipped = @"Skipped";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.MigrationState Stopped = @"Stopped";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.MigrationState Warning = @"Warning";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.MigrationState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.MigrationState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.MigrationState e1, Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.MigrationState e2)
        {
            return !e2.Equals(e1);
        }
