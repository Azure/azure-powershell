...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.DataMigration/services/{serviceName}/projects/{projectName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzDataMigrationProject_UpdateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Description(@"The project resource is a nested resource representing a stored migration project. The PATCH method updates an existing project.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Generated]
    public partial class UpdateAzDataMigrationProject_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Key used to authenticate to the Azure Active Directory Application")]
        ...
        public string AzureAuthenticationInfoAppKey { get => ParametersBody.AzureAuthenticationInfoAppKey ?? null; set => ParametersBody.AzureAuthenticationInfoAppKey = value; }

        /// <summary>Application ID of the Azure Active Directory Application</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Application ID of the Azure Active Directory Application")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AzureAuthenticationInfoApplicationId { get => ParametersBody.AzureAuthenticationInfoApplicationId ?? null; set => ParametersBody.AzureAuthenticationInfoApplicationId = value; }

        /// <summary>Ignore checking azure permissions on the AAD app</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Ignore checking azure permissions on the AAD app")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public global::System.Management.Automation.SwitchParameter AzureAuthenticationInfoIgnoreAzurePermission { get => ParametersBody.AzureAuthenticationInfoIgnoreAzurePermission ?? default(global::System.Management.Automation.SwitchParameter); set => ParametersBody.AzureAuthenticationInfoIgnoreAzurePermission = value; }

        /// <summary>Tenant id of the customer</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Tenant id of the customer")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AzureAuthenticationInfoTenantId { get => ParametersBody.AzureAuthenticationInfoTenantId ?? null; set => ParametersBody.AzureAuthenticationInfoTenantId = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of DatabaseInfo")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IDatabaseInfo[] DatabasesInfo { get => ParametersBody.DatabasesInfo ?? null /* arrayOf */; set => ParametersBody.DatabasesInfo = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IProject _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.Project();

        /// <summary>A project resource</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IProject ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Password credential.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SourceConnectionInfoPassword { get => ParametersBody.SourceConnectionInfoPassword ?? null; set => ParametersBody.SourceConnectionInfoPassword = value; }

        /// <summary>Type of connection info</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Type of connection info")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"type",
        PossibleTypes = new [] { typeof(string) })]
        public string SourceConnectionInfoType { get => ParametersBody.SourceConnectionInfoType ?? null; set => ParametersBody.SourceConnectionInfoType = value; }

        /// <summary>User name</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "User name")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SourceConnectionInfoUserName { get => ParametersBody.SourceConnectionInfoUserName ?? null; set => ParametersBody.SourceConnectionInfoUserName = value; }

        /// <summary>Source platform for the project</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Source platform for the project")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.ProjectSourcePlatform))]
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.ProjectSourcePlatform SourcePlatform { get => ParametersBody.SourcePlatform ?? ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.ProjectSourcePlatform)""); set => ParametersBody.SourcePlatform = value; }
        ...
        SerializedName = @"type",
        PossibleTypes = new [] { typeof(string) })]
        public string TargetConnectionInfoType { get => ParametersBody.TargetConnectionInfoType ?? null; set => ParametersBody.TargetConnectionInfoType = value; }
        ...
        SerializedName = @"userName",
        PossibleTypes = new [] { typeof(string) })]
        public string TargetConnectionInfoUserName { get => ParametersBody.TargetConnectionInfoUserName ?? null; set => ParametersBody.TargetConnectionInfoUserName = value; }

        /// <summary>Target platform for the project</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Target platform for the project")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.ProjectTargetPlatform))]
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.ProjectTargetPlatform TargetPlatform { get => ParametersBody.TargetPlatform ?? ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.ProjectTargetPlatform)""); set => ParametersBody.TargetPlatform = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ProjectsUpdate(SubscriptionId, GroupName, ServiceName, Name, ParametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,GroupName=GroupName,ServiceName=ServiceName,Name=Name,body=ParametersBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzDataMigrationProject_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzDataMigrationProject_UpdateExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, GroupName=GroupName, ServiceName=ServiceName, Name=Name, body=ParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, GroupName=GroupName, ServiceName=ServiceName, Name=Name, body=ParametersBody })
                    {
