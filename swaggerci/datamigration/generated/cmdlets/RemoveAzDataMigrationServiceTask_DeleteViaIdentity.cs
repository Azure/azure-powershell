...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets
{
    ...
    /// <summary>
    /// The service tasks resource is a nested, proxy-only resource representing work performed by a DMS instance. The DELETE
    /// method deletes a service task, canceling it first if it's running.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.DataMigration/services/{serviceName}/serviceTasks/{taskName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzDataMigrationServiceTask_DeleteViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Description(@"The service tasks resource is a nested, proxy-only resource representing work performed by a DMS instance. The DELETE method deletes a service task, canceling it first if it's running.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Generated]
    public partial class RemoveAzDataMigrationServiceTask_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="DeleteRunningTask" /> property.</summary>
        private global::System.Management.Automation.SwitchParameter _deleteRunningTask;

        /// <summary>Delete the resource even if it contains running tasks</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Delete the resource even if it contains running tasks")]
        ...
        public global::System.Management.Automation.SwitchParameter DeleteRunningTask { get => this._deleteRunningTask; set => this._deleteRunningTask = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ServiceTasksDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServiceTasksDeleteViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("DeleteRunningTask") ? DeleteRunningTask : default(global::System.Management.Automation.SwitchParameter?), onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServiceTasksDelete(InputObject.SubscriptionId ?? null, InputObject.GroupName ?? null, InputObject.ServiceName ?? null, InputObject.TaskName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("DeleteRunningTask") ? DeleteRunningTask : default(global::System.Management.Automation.SwitchParameter?), onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzDataMigrationServiceTask_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzDataMigrationServiceTask_DeleteViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { DeleteRunningTask=this.InvocationInformation.BoundParameters.ContainsKey("DeleteRunningTask") ? DeleteRunningTask : default(global::System.Management.Automation.SwitchParameter?) })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { DeleteRunningTask=this.InvocationInformation.BoundParameters.ContainsKey("DeleteRunningTask") ? DeleteRunningTask : default(global::System.Management.Automation.SwitchParameter?) })
                    {
