...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Cancel=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{sqlDbInstanceName}/providers/Microsoft.DataMigration/databaseMigrations/{targetDbName}/cancel"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Stop, @"AzDataMigrationDatabaseMigrationsSqlDb_Cancel", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Description(@"Stop on going migration for the database.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Generated]
    public partial class StopAzDataMigrationDatabaseMigrationsSqlDb_Cancel : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrationOperationInput _parameter;

        /// <summary>Migration Operation Input</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Migration Operation Input", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Migration Operation Input",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrationOperationInput) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrationOperationInput Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <returns>a duplicate instance of StopAzDataMigrationDatabaseMigrationsSqlDb_Cancel</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets.StopAzDataMigrationDatabaseMigrationsSqlDb_Cancel Clone()
        {
            var clone = new StopAzDataMigrationDatabaseMigrationsSqlDb_Cancel();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DatabaseMigrationsSqlDbCancel' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DatabaseMigrationsSqlDbCancel(ResourceGroupName, SqlDbInstanceName, TargetDbName, SubscriptionId, Parameter, onOk, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StopAzDataMigrationDatabaseMigrationsSqlDb_Cancel" /> cmdlet class.
        /// </summary>
        public StopAzDataMigrationDatabaseMigrationsSqlDb_Cancel()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage)
        {
            using( NoSynchronizationContext )
            {
                ...
                WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, SqlDbInstanceName=SqlDbInstanceName, TargetDbName=TargetDbName, SubscriptionId=SubscriptionId, body=Parameter })
                {
