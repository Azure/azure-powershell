...
### List (Default)
```
Get-AzDataMigrationFile -GroupName <String> -ProjectName <String> -ServiceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzDataMigrationFile -GroupName <String> -Name <String> -ProjectName <String> -ServiceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDataMigrationFile -InputObject <IDataMigrationIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
