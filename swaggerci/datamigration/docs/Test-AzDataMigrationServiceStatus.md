...
online version: https://docs.microsoft.com/en-us/powershell/module/az.datamigration/test-azdatamigrationservicestatus
schema: 2.0.0
---

# Test-AzDataMigrationServiceStatus
...
### Check (Default)
```
Test-AzDataMigrationServiceStatus -GroupName <String> -ServiceName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentity
```
Test-AzDataMigrationServiceStatus -InputObject <IDataMigrationIdentity> [-DefaultProfile <PSObject>]
