...
### Delete (Default)
```
Remove-AzDataMigrationProject -GroupName <String> -Name <String> -ServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzDataMigrationProject -InputObject <IDataMigrationIdentity> [-DeleteRunningTask]
