...
online version: https://docs.microsoft.com/en-us/powershell/module/az.datamigration/new-azdatamigrationsqlmigrationservice
schema: 2.0.0
---
...
```
New-AzDataMigrationSqlMigrationService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
