...
### Get (Default)
```
Get-AzDataMigrationDatabaseMigrationsSqlMi -ManagedInstanceName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzDataMigrationDatabaseMigrationsSqlMi -InputObject <IDataMigrationIdentity> [-Expand <String>]
