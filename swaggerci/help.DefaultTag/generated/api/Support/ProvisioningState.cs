...
namespace Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support
{
        ...
        System.IEquatable<ProvisioningState>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.ProvisioningState Canceled = @"Canceled";

        /// <summary>All Diagnostics failed to run.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.ProvisioningState Failed = @"Failed";

        /// <summary>Some Diagnostics are still running or failed.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.ProvisioningState PartialComplete = @"PartialComplete";

        /// <summary>All Diagnostics in the Batch succeeded.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
