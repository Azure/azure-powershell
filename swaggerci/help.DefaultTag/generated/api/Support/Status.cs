...
namespace Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support
{
        ...
        System.IEquatable<Status>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Status Failed = @"Failed";

        /// <summary>Request is missing required inputs to run.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Status MissingInputs = @"MissingInputs";

        /// <summary>Diagnostic is still running.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Status Running = @"Running";

        /// <summary>Diagnostic creation succeeded.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Status Succeeded = @"Succeeded";

        /// <summary>Diagnostic was timed out.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Status Timeout = @"Timeout";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
