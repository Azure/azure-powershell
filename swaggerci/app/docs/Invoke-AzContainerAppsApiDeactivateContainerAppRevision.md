...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/invoke-azcontainerappsapideactivatecontainerapprevision
schema: 2.0.0
---

# Invoke-AzContainerAppsApiDeactivateContainerAppRevision
...
### Deactivate (Default)
```
Invoke-AzContainerAppsApiDeactivateContainerAppRevision -ContainerAppName <String> -Name <String>
...
```
Invoke-AzContainerAppsApiDeactivateContainerAppRevision -InputObject <IContainerAppsApiIdentity>
