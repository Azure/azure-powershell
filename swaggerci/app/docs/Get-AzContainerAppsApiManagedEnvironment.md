...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/get-azcontainerappsapimanagedenvironment
schema: 2.0.0
---
...
### Get
```
Get-AzContainerAppsApiManagedEnvironment -Name <String> -ResourceGroupName <String>
