...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/get-azcontainerappsapicontainerappssourcecontrol
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzContainerAppsApiContainerAppsSourceControl -ContainerAppName <String> -Name <String>
