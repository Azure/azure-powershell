...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/update-azcontainerappsapicertificate
schema: 2.0.0
---

# Update-AzContainerAppsApiCertificate
...
```
Update-AzContainerAppsApiCertificate -ManagedEnvironmentName <String> -Name <String>
...
```
Update-AzContainerAppsApiCertificate -InputObject <IContainerAppsApiIdentity> [-Tag <Hashtable>]
