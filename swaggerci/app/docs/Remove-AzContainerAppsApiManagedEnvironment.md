...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/remove-azcontainerappsapimanagedenvironment
schema: 2.0.0
---

# Remove-AzContainerAppsApiManagedEnvironment
...
### Delete (Default)
```
Remove-AzContainerAppsApiManagedEnvironment -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzContainerAppsApiManagedEnvironment -InputObject <IContainerAppsApiIdentity>
