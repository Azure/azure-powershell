...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/remove-azcontainerappsapicertificate
schema: 2.0.0
---

# Remove-AzContainerAppsApiCertificate
...
### Delete (Default)
```
Remove-AzContainerAppsApiCertificate -ManagedEnvironmentName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzContainerAppsApiCertificate -InputObject <IContainerAppsApiIdentity> [-DefaultProfile <PSObject>]
