...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/get-azcontainerappsapicontainerapprevision
schema: 2.0.0
---
...
### Get
```
Get-AzContainerAppsApiContainerAppRevision -ContainerAppName <String> -Name <String>
