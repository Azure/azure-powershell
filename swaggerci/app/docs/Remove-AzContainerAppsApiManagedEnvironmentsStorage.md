...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/remove-azcontainerappsapimanagedenvironmentsstorage
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzContainerAppsApiManagedEnvironmentsStorage -EnvName <String> -Name <String>
