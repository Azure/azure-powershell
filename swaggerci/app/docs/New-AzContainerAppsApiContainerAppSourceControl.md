...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/new-azcontainerappsapicontainerappsourcecontrol
schema: 2.0.0
---

# New-AzContainerAppsApiContainerAppSourceControl
...
```
New-AzContainerAppsApiContainerAppSourceControl -ContainerAppName <String> -Name <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-AzureCredentialsClientId <String>]
