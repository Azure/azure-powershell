...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/get-azcontainerappsapicontainerappsauthconfig
schema: 2.0.0
---

# Get-AzContainerAppsApiContainerAppsAuthConfig
...
### Get (Default)
```
Get-AzContainerAppsApiContainerAppsAuthConfig -ContainerAppName <String> -Name <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzContainerAppsApiContainerAppsAuthConfig -InputObject <IContainerAppsApiIdentity>
