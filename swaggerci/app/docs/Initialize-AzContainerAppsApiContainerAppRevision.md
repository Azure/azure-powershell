...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/initialize-azcontainerappsapicontainerapprevision
schema: 2.0.0
---
...
### Activate (Default)
```
Initialize-AzContainerAppsApiContainerAppRevision -ContainerAppName <String> -Name <String>
