...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/test-azcontainerappsapinamespacenameavailability
schema: 2.0.0
---
...
```
Test-AzContainerAppsApiNamespaceNameAvailability -ManagedEnvironmentName <String> -ResourceGroupName <String>
