...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Support.StatusTypes Connected = @"Connected";

        public static Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Support.StatusTypes Disconnected = @"Disconnected";

        public static Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Support.StatusTypes Error = @"Error";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Support.StatusTypes e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Support.StatusTypes e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Support.StatusTypes e1, Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Support.StatusTypes e2)
        {
            return !e2.Equals(e1);
        }
