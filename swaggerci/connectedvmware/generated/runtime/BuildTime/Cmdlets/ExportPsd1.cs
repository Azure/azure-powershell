...
using static Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Runtime.PowerShell.PsHelpers;

namespace Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Runtime.PowerShell
{
    ...
    public class ExportPsd1 : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                sb.AppendLine($@"{Indent}RootModule = '{"./Az.ArcVMwareServiceApi.psm1"}'");
                ...
                sb.AppendLine($@"{Indent}Description = '{"Microsoft Azure PowerShell: ArcVMwareServiceApi cmdlets"}'");
                ...
                {
                    sb.AppendLine($@"{Indent}RequiredAssemblies = '{"./bin/Az.ArcVMwareServiceApi.private.dll"}'");
                }
                ...
                else
                {
                    ...
                    var formatList = customFormatPs1xmlFiles.Prepend("./Az.ArcVMwareServiceApi.format.ps1xml").ToPsList();
                ...
                sb.AppendLine($@"{Indent}{Indent}{Indent}Tags = {"Azure ResourceManager ARM PSModule ArcVMwareServiceApi".Split(' ').ToPsList().NullIfEmpty() ?? "''"}");
