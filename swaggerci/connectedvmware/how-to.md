# How-To
This document describes how to develop for `Az.ArcVMwareServiceApi`.

## Building `Az.ArcVMwareServiceApi`
...
## Testing `Az.ArcVMwareServiceApi`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Az.ArcVMwareServiceApi` into the session.
