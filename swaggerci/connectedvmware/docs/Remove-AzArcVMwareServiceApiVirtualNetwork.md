...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/remove-azarcvmwareserviceapivirtualnetwork
schema: 2.0.0
---

# Remove-AzArcVMwareServiceApiVirtualNetwork
...
### Delete (Default)
```
Remove-AzArcVMwareServiceApiVirtualNetwork -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzArcVMwareServiceApiVirtualNetwork -InputObject <IArcVMwareServiceApiIdentity> [-Force]
