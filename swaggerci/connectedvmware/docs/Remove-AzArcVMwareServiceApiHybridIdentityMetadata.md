...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/remove-azarcvmwareserviceapihybrididentitymetadata
schema: 2.0.0
---

# Remove-AzArcVMwareServiceApiHybridIdentityMetadata
...
### Delete (Default)
```
Remove-AzArcVMwareServiceApiHybridIdentityMetadata -MetadataName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzArcVMwareServiceApiHybridIdentityMetadata -InputObject <IArcVMwareServiceApiIdentity>
