...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/remove-azarcvmwareserviceapivirtualmachine
schema: 2.0.0
---

# Remove-AzArcVMwareServiceApiVirtualMachine
...
### Delete (Default)
```
Remove-AzArcVMwareServiceApiVirtualMachine -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzArcVMwareServiceApiVirtualMachine -InputObject <IArcVMwareServiceApiIdentity> [-Force]
