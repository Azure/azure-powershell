...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/start-azarcvmwareserviceapivirtualmachine
schema: 2.0.0
---

# Start-AzArcVMwareServiceApiVirtualMachine
...
### Start (Default)
```
Start-AzArcVMwareServiceApiVirtualMachine -Name <String> -ResourceGroupName <String>
...
### StartViaIdentity
```
Start-AzArcVMwareServiceApiVirtualMachine -InputObject <IArcVMwareServiceApiIdentity>
