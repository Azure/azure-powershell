...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/remove-azarcvmwareserviceapiinventoryitem
schema: 2.0.0
---

# Remove-AzArcVMwareServiceApiInventoryItem
...
### Delete (Default)
```
Remove-AzArcVMwareServiceApiInventoryItem -Name <String> -ResourceGroupName <String> -VcenterName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzArcVMwareServiceApiInventoryItem -InputObject <IArcVMwareServiceApiIdentity>
