...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/remove-azarcvmwareserviceapicluster
schema: 2.0.0
---

# Remove-AzArcVMwareServiceApiCluster
...
### Delete (Default)
```
Remove-AzArcVMwareServiceApiCluster -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzArcVMwareServiceApiCluster -InputObject <IArcVMwareServiceApiIdentity> [-Force]
