...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/update-azarcvmwareserviceapidatastore
schema: 2.0.0
---

# Update-AzArcVMwareServiceApiDatastore
...
```
Update-AzArcVMwareServiceApiDatastore -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzArcVMwareServiceApiDatastore -InputObject <IArcVMwareServiceApiIdentity> [-Tag <Hashtable>]
