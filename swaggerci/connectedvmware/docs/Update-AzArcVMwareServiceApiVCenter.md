...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/update-azarcvmwareserviceapivcenter
schema: 2.0.0
---

# Update-AzArcVMwareServiceApiVCenter
...
```
Update-AzArcVMwareServiceApiVCenter -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzArcVMwareServiceApiVCenter -InputObject <IArcVMwareServiceApiIdentity> [-Tag <Hashtable>]
