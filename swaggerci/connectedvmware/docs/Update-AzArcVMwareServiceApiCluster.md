...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/update-azarcvmwareserviceapicluster
schema: 2.0.0
---
...
```
Update-AzArcVMwareServiceApiCluster -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzArcVMwareServiceApiCluster -InputObject <IArcVMwareServiceApiIdentity> [-Tag <Hashtable>]
