...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/restart-azarcvmwareserviceapivirtualmachine
schema: 2.0.0
---

# Restart-AzArcVMwareServiceApiVirtualMachine
...
### Restart (Default)
```
Restart-AzArcVMwareServiceApiVirtualMachine -Name <String> -ResourceGroupName <String>
...
### RestartViaIdentity
```
Restart-AzArcVMwareServiceApiVirtualMachine -InputObject <IArcVMwareServiceApiIdentity>
