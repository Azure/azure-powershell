...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/update-azarcvmwareserviceapihost
schema: 2.0.0
---

# Update-AzArcVMwareServiceApiHost
...
```
Update-AzArcVMwareServiceApiHost -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzArcVMwareServiceApiHost -InputObject <IArcVMwareServiceApiIdentity> [-Tag <Hashtable>]
