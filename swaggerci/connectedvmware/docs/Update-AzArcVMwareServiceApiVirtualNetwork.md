...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/update-azarcvmwareserviceapivirtualnetwork
schema: 2.0.0
---

# Update-AzArcVMwareServiceApiVirtualNetwork
...
```
Update-AzArcVMwareServiceApiVirtualNetwork -Name <String> -ResourceGroupName <String>
...
```
Update-AzArcVMwareServiceApiVirtualNetwork -InputObject <IArcVMwareServiceApiIdentity> [-Tag <Hashtable>]
