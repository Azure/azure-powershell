...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/stop-azarcvmwareserviceapivirtualmachine
schema: 2.0.0
---

# Stop-AzArcVMwareServiceApiVirtualMachine
...
```
Stop-AzArcVMwareServiceApiVirtualMachine -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### Stop
```
Stop-AzArcVMwareServiceApiVirtualMachine -Name <String> -ResourceGroupName <String>
...
### StopViaIdentity
```
Stop-AzArcVMwareServiceApiVirtualMachine -InputObject <IArcVMwareServiceApiIdentity>
...
```
Stop-AzArcVMwareServiceApiVirtualMachine -InputObject <IArcVMwareServiceApiIdentity> [-SkipShutdown]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20201001Preview.IStopVirtualMachineOptions
