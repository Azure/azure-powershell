...
namespace Microsoft.Azure.PowerShell.Cmdlets.Arc.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlAvailabilityGroups/{sqlAvailabilityGroupName}/databases/{sqlAvailabilityGroupDatabaseName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzArcSqlAvailabilityGroupDatabase_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20230315Preview.ISqlAvailabilityGroupDatabaseResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Arc.Description(@"Updates an existing Availability Group Database.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Arc.Generated]
    public partial class UpdateAzArcSqlAvailabilityGroupDatabase_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Arc.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20230315Preview.ISqlAvailabilityGroupDatabaseUpdate _sqlAvailabilityGroupDatabaseUpdateBody = new Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20230315Preview.SqlAvailabilityGroupDatabaseUpdate();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "ID GUID of the database for availability group.")]
        ...
        public string GroupDatabaseId { get => _sqlAvailabilityGroupDatabaseUpdateBody.GroupDatabaseId ?? null; set => _sqlAvailabilityGroupDatabaseUpdateBody.GroupDatabaseId = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20230315Preview.ISqlAvailabilityGroupDatabaseUpdateTags Tag { get => _sqlAvailabilityGroupDatabaseUpdateBody.Tag ?? null /* object */; set => _sqlAvailabilityGroupDatabaseUpdateBody.Tag = value; }

        /// <summary>Array of Arc Sql Availability Group Database Replicas.</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Array of Arc Sql Availability Group Database Replicas.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Arc.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Arc.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Arc.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20230315Preview.ISqlAvailabilityGroupDatabaseReplicaResourceProperties[] Value { get => _sqlAvailabilityGroupDatabaseUpdateBody.Value ?? null /* arrayOf */; set => _sqlAvailabilityGroupDatabaseUpdateBody.Value = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20230315Preview.ISqlAvailabilityGroupDatabaseResource">Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20230315Preview.ISqlAvailabilityGroupDatabaseResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20230315Preview.ISqlAvailabilityGroupDatabaseResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SqlAvailabilityGroupDatabasesUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.SqlAvailabilityGroupDatabasesUpdateViaIdentity(InputObject.Id, _sqlAvailabilityGroupDatabaseUpdateBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.SqlAvailabilityGroupDatabaseName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.SqlAvailabilityGroupDatabaseName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        ...
                        await this.Client.SqlAvailabilityGroupDatabasesUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.SqlAvailabilityGroupDatabaseName ?? null, InputObject.SqlAvailabilityGroupName ?? null, _sqlAvailabilityGroupDatabaseUpdateBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_sqlAvailabilityGroupDatabaseUpdateBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzArcSqlAvailabilityGroupDatabase_UpdateViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzArcSqlAvailabilityGroupDatabase_UpdateViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20230315Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_sqlAvailabilityGroupDatabaseUpdateBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_sqlAvailabilityGroupDatabaseUpdateBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20230315Preview.ISqlAvailabilityGroupDatabaseResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20230315Preview.ISqlAvailabilityGroupDatabaseResource
