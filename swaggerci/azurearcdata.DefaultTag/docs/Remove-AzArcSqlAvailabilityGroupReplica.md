...
external help file:
Module Name: Az.Arc
online version: https://learn.microsoft.com/powershell/module/az.arc/remove-azarcsqlavailabilitygroupreplica
schema: 2.0.0
---

# Remove-AzArcSqlAvailabilityGroupReplica
...
### Delete (Default)
```
Remove-AzArcSqlAvailabilityGroupReplica -ResourceGroupName <String> -SqlAvailabilityGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzArcSqlAvailabilityGroupReplica -InputObject <IArcIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
