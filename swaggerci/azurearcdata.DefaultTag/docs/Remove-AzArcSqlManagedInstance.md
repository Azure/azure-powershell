...
external help file:
Module Name: Az.Arc
online version: https://learn.microsoft.com/powershell/module/az.arc/remove-azarcsqlmanagedinstance
schema: 2.0.0
---

# Remove-AzArcSqlManagedInstance
...
### Delete (Default)
```
Remove-AzArcSqlManagedInstance -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzArcSqlManagedInstance -InputObject <IArcIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
