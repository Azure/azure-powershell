...
external help file:
Module Name: Az.Arc
online version: https://learn.microsoft.com/powershell/module/az.arc/get-azarcsqlavailabilitygroupreplica
schema: 2.0.0
---

# Get-AzArcSqlAvailabilityGroupReplica
...
### List (Default)
```
Get-AzArcSqlAvailabilityGroupReplica -ResourceGroupName <String> -SqlAvailabilityGroupName <String>
...
### GetViaIdentity
```
Get-AzArcSqlAvailabilityGroupReplica -InputObject <IArcIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
