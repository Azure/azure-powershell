...
external help file:
Module Name: Az.Arc
online version: https://learn.microsoft.com/powershell/module/az.arc/remove-azarcsqlavailabilitygroup
schema: 2.0.0
---

# Remove-AzArcSqlAvailabilityGroup
...
### Delete (Default)
```
Remove-AzArcSqlAvailabilityGroup -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzArcSqlAvailabilityGroup -InputObject <IArcIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
