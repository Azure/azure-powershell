...
external help file:
Module Name: Az.Arc
online version: https://learn.microsoft.com/powershell/module/az.arc/remove-azarcactivedirectoryconnector
schema: 2.0.0
---

# Remove-AzArcActiveDirectoryConnector
...
### Delete (Default)
```
Remove-AzArcActiveDirectoryConnector -DataControllerName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzArcActiveDirectoryConnector -InputObject <IArcIdentity> [-DefaultProfile <PSObject>] [-AsJob]
