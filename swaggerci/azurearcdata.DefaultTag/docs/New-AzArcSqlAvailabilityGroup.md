...
external help file:
Module Name: Az.Arc
online version: https://learn.microsoft.com/powershell/module/az.arc/new-azarcsqlavailabilitygroup
schema: 2.0.0
---

# New-AzArcSqlAvailabilityGroup
...
```
New-AzArcSqlAvailabilityGroup -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-AvailabilityGroupId <String>] [-AvailabilityGroupName <String>] [-BasicFeature]
 [-ClusterTypeDesc <String>] [-CollectionTimestamp <DateTime>] [-DbFailover] [-DtcSupport]
 [-InstanceName <String>] [-IsContained] [-IsDistributed] [-RequiredSynchronizedSecondariesCommit <Int32>]
 [-Tag <Hashtable>] [-Version <Int32>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
