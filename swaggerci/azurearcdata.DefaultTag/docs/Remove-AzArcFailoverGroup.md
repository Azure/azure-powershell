...
external help file:
Module Name: Az.Arc
online version: https://learn.microsoft.com/powershell/module/az.arc/remove-azarcfailovergroup
schema: 2.0.0
---

# Remove-AzArcFailoverGroup
...
### Delete (Default)
```
Remove-AzArcFailoverGroup -Name <String> -ResourceGroupName <String> -SqlManagedInstanceName <String>
...
### DeleteViaIdentity
```
Remove-AzArcFailoverGroup -InputObject <IArcIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
