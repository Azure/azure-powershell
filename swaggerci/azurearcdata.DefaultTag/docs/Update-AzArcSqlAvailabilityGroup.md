...
external help file:
Module Name: Az.Arc
online version: https://learn.microsoft.com/powershell/module/az.arc/update-azarcsqlavailabilitygroup
schema: 2.0.0
---

# Update-AzArcSqlAvailabilityGroup
...
```
Update-AzArcSqlAvailabilityGroup -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzArcSqlAvailabilityGroup -InputObject <IArcIdentity> [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
...
Aliases: SqlAvailabilityGroupName
