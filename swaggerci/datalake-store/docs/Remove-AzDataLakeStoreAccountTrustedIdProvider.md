...
online version: https://docs.microsoft.com/en-us/powershell/module/az.datalakestoreaccount/remove-azdatalakestoreaccounttrustedidprovider
schema: 2.0.0
---

# Remove-AzDataLakeStoreAccountTrustedIdProvider
...
### Delete (Default)
```
Remove-AzDataLakeStoreAccountTrustedIdProvider -AccountName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzDataLakeStoreAccountTrustedIdProvider -InputObject <IDataLakeStoreAccountIdentity>
