...
online version: https://docs.microsoft.com/en-us/powershell/module/az.datalakestoreaccount/test-azdatalakestoreaccountnameavailability
schema: 2.0.0
---

# Test-AzDataLakeStoreAccountNameAvailability
...
```
Test-AzDataLakeStoreAccountNameAvailability -Location <String> -Name <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Check
```
Test-AzDataLakeStoreAccountNameAvailability -Location <String> -Parameter <ICheckNameAvailabilityParameters>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentity
```
Test-AzDataLakeStoreAccountNameAvailability -InputObject <IDataLakeStoreAccountIdentity>
...
```
Test-AzDataLakeStoreAccountNameAvailability -InputObject <IDataLakeStoreAccountIdentity> -Name <String>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Models.Api20161101.ICheckNameAvailabilityParameters
