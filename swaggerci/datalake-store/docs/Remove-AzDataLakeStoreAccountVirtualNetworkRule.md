...
online version: https://docs.microsoft.com/en-us/powershell/module/az.datalakestoreaccount/remove-azdatalakestoreaccountvirtualnetworkrule
schema: 2.0.0
---

# Remove-AzDataLakeStoreAccountVirtualNetworkRule
...
### Delete (Default)
```
Remove-AzDataLakeStoreAccountVirtualNetworkRule -AccountName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzDataLakeStoreAccountVirtualNetworkRule -InputObject <IDataLakeStoreAccountIdentity>
