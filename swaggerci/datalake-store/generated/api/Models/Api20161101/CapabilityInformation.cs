...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Models.Api20161101
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Models.Api20161101.ICapabilityInformationInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Models.Api20161101.ICapabilityInformationInternal.AccountCount { get => this._accountCount; set { {_accountCount = value;} } }

        /// <summary>Internal Acessors for MaxAccountCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Models.Api20161101.ICapabilityInformationInternal.MaxAccountCount { get => this._maxAccountCount; set { {_maxAccountCount = value;} } }

        /// <summary>Internal Acessors for MigrationState</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Models.Api20161101.ICapabilityInformationInternal.MigrationState { get => this._migrationState; set { {_migrationState = value;} } }

        /// <summary>Internal Acessors for State</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Support.SubscriptionState? Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Models.Api20161101.ICapabilityInformationInternal.State { get => this._state; set { {_state = value;} } }

        /// <summary>Internal Acessors for SubscriptionId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Models.Api20161101.ICapabilityInformationInternal.SubscriptionId { get => this._subscriptionId; set { {_subscriptionId = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Support.SubscriptionState? _state;

        /// <summary>The subscription state.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Support.SubscriptionState? State { get => this._state; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Support.SubscriptionState) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Support.SubscriptionState? State { get;  }
        /// <summary>The subscription credentials that uniquely identifies the subscription.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        /// <summary>The subscription state.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataLakeStoreAccount.Support.SubscriptionState? State { get; set; }
        /// <summary>The subscription credentials that uniquely identifies the subscription.</summary>
