...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support";
