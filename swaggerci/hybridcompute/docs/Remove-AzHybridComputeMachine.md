...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridcompute/remove-azhybridcomputemachine
schema: 2.0.0
---

# Remove-AzHybridComputeMachine
...
### Delete (Default)
```
Remove-AzHybridComputeMachine -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzHybridComputeMachine -InputObject <IHybridComputeIdentity> [-DefaultProfile <PSObject>] [-PassThru]
