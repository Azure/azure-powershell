...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridcompute/remove-azhybridcomputeprivatelinkscope
schema: 2.0.0
---

# Remove-AzHybridComputePrivateLinkScope
...
### Delete (Default)
```
Remove-AzHybridComputePrivateLinkScope -ResourceGroupName <String> -ScopeName <String>
...
### DeleteViaIdentity
```
Remove-AzHybridComputePrivateLinkScope -InputObject <IHybridComputeIdentity> [-DefaultProfile <PSObject>]
