...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.State Deprovisioning = @"Deprovisioning";

        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.State Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.State NetworkSourceDeleted = @"NetworkSourceDeleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.State Provisioning = @"Provisioning";

        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.State Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.State e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.State e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.State e1, Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.State e2)
        {
            return !e2.Equals(e1);
        }
