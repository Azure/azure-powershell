...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storage/get-azstoragelocaluserkey
schema: 2.0.0
---
...
```
Get-AzStorageLocalUserKey -AccountName <String> -ResourceGroupName <String> -Username <String>
