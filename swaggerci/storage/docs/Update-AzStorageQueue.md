...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storage/update-azstoragequeue
schema: 2.0.0
---

# Update-AzStorageQueue
...
```
Update-AzStorageQueue -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-QueuePropertyMetadata <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzStorageQueue -InputObject <IStorageIdentity> [-QueuePropertyMetadata <Hashtable>]
