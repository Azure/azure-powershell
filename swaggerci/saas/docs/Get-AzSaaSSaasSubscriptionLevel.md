...
external help file:
Module Name: Az.SaaS
online version: https://docs.microsoft.com/en-us/powershell/module/az.saas/get-azsaassaassubscriptionlevel
schema: 2.0.0
---

# Get-AzSaaSSaasSubscriptionLevel
...
### Get (Default)
```
Get-AzSaaSSaasSubscriptionLevel -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzSaaSSaasSubscriptionLevel -InputObject <ISaaSIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
