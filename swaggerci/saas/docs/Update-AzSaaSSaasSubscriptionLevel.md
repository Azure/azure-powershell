...
external help file:
Module Name: Az.SaaS
online version: https://docs.microsoft.com/en-us/powershell/module/az.saas/update-azsaassaassubscriptionlevel
schema: 2.0.0
---
...
Update-AzSaaSSaasSubscriptionLevel -ResourceGroupName <String> -ResourceName <String>
 ...
 [-TermId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
