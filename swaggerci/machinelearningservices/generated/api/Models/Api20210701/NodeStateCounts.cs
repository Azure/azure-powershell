...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701
{
    ...
    public partial class NodeStateCounts :
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.INodeStateCounts,
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.INodeStateCountsInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.INodeStateCountsInternal.IdleNodeCount { get => this._idleNodeCount; set { {_idleNodeCount = value;} } }

        /// <summary>Internal Acessors for LeavingNodeCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.INodeStateCountsInternal.LeavingNodeCount { get => this._leavingNodeCount; set { {_leavingNodeCount = value;} } }

        /// <summary>Internal Acessors for PreemptedNodeCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.INodeStateCountsInternal.PreemptedNodeCount { get => this._preemptedNodeCount; set { {_preemptedNodeCount = value;} } }

        /// <summary>Internal Acessors for PreparingNodeCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.INodeStateCountsInternal.PreparingNodeCount { get => this._preparingNodeCount; set { {_preparingNodeCount = value;} } }

        /// <summary>Internal Acessors for RunningNodeCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.INodeStateCountsInternal.RunningNodeCount { get => this._runningNodeCount; set { {_runningNodeCount = value;} } }

        /// <summary>Internal Acessors for UnusableNodeCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.INodeStateCountsInternal.UnusableNodeCount { get => this._unusableNodeCount; set { {_unusableNodeCount = value;} } }
