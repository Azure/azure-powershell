...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701
{
    ...
    public partial class UserAssignedIdentity :
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.IUserAssignedIdentity,
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.IUserAssignedIdentityInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.IUserAssignedIdentityInternal.ClientId { get => this._clientId; set { {_clientId = value;} } }

        /// <summary>Internal Acessors for PrincipalId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.IUserAssignedIdentityInternal.PrincipalId { get => this._principalId; set { {_principalId = value;} } }

        /// <summary>Internal Acessors for TenantId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.IUserAssignedIdentityInternal.TenantId { get => this._tenantId; set { {_tenantId = value;} } }
