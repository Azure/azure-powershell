...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701
{
    ...
    public partial class Restriction :
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.IRestriction,
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.IRestrictionInternal
    {

        /// <summary>Internal Acessors for Type</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.IRestrictionInternal.Type { get => this._type; set { {_type = value;} } }

        /// <summary>Internal Acessors for Value</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.IRestrictionInternal.Value { get => this._value; set { {_value = value;} } }

        /// <summary>Backing field for <see cref="ReasonCode" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.ReasonCode? _reasonCode;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.ReasonCode? ReasonCode { get => this._reasonCode; set => this._reasonCode = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.ReasonCode) })]
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.ReasonCode? ReasonCode { get; set; }
        /// <summary>The type of restrictions. As of now only possible value for this is location.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Runtime.Info(
        Required = false,
        ReadOnly = true,
