...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701
{
    ...
    public partial class ComputeInstanceCreatedBy :
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.IComputeInstanceCreatedBy,
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.IComputeInstanceCreatedByInternal
    {

        /// <summary>Internal Acessors for UserId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.IComputeInstanceCreatedByInternal.UserId { get => this._userId; set { {_userId = value;} } }

        /// <summary>Internal Acessors for UserName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.IComputeInstanceCreatedByInternal.UserName { get => this._userName; set { {_userName = value;} } }

        /// <summary>Internal Acessors for UserOrgId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20210701.IComputeInstanceCreatedByInternal.UserOrgId { get => this._userOrgId; set { {_userOrgId = value;} } }
