...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support";
