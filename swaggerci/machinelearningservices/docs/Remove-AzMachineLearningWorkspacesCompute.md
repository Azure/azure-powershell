...
online version: https://docs.microsoft.com/en-us/powershell/module/az.machinelearningworkspaces/remove-azmachinelearningworkspacescompute
schema: 2.0.0
---

# Remove-AzMachineLearningWorkspacesCompute
...
### Delete (Default)
```
Remove-AzMachineLearningWorkspacesCompute -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
...
### DeleteViaIdentity
```
Remove-AzMachineLearningWorkspacesCompute -InputObject <IMachineLearningWorkspacesIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.UnderlyingResourceAction
Parameter Sets: (All)
Aliases:
