...
online version: https://learn.microsoft.com/powershell/module/az.servicebus/get-azservicebusdisasterrecoveryconfig
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzServiceBusDisasterRecoveryConfig -InputObject <IServiceBusIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
