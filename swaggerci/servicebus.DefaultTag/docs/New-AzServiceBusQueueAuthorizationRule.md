...
online version: https://learn.microsoft.com/powershell/module/az.servicebus/new-azservicebusqueueauthorizationrule
schema: 2.0.0
---
...
New-AzServiceBusQueueAuthorizationRule -AuthorizationRuleName <String> -NamespaceName <String>
 -QueueName <String> -ResourceGroupName <String> [-SubscriptionId <String>] [-Rights <AccessRights[]>]
