...
online version: https://learn.microsoft.com/powershell/module/az.servicebus/complete-azservicebusmigrationconfigmigration
schema: 2.0.0
---
...
### CompleteViaIdentity
```
Complete-AzServiceBusMigrationConfigMigration -InputObject <IServiceBusIdentity> [-DefaultProfile <PSObject>]
