...
online version: https://learn.microsoft.com/powershell/module/az.servicebus/get-azservicebusnamespaceauthorizationrule
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzServiceBusNamespaceAuthorizationRule -InputObject <IServiceBusIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
