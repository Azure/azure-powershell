...
online version: https://learn.microsoft.com/powershell/module/az.servicebus/get-azservicebusdisasterrecoveryconfigkey
schema: 2.0.0
---
...
```
Get-AzServiceBusDisasterRecoveryConfigKey -Alias <String> -AuthorizationRuleName <String>
