...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Description(@"Creates or updates a Service Bus queue. This operation is idempotent.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.ISbQueue _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.SbQueue();

        /// <summary>
        /// ISO 8061 timeSpan idle interval after which the queue is automatically deleted. The minimum duration is 5 minutes.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "ISO 8061 timeSpan idle interval after which the queue is automatically deleted. The minimum duration is 5 minutes.")]
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "ISO 8601 timespan duration of a peek-lock; that is, the amount of time that the message is locked for other receivers. The maximum value for LockDuration is 5 minutes; the default value is 1 minute.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public long MaxMessageSizeInKilobyte { get => _parametersBody.MaxMessageSizeInKilobyte ?? default(long); set => _parametersBody.MaxMessageSizeInKilobyte = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int MaxSizeInMegabyte { get => _parametersBody.MaxSizeInMegabyte ?? default(int); set => _parametersBody.MaxSizeInMegabyte = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzServiceBusQueue_CreateExpanded" /> cmdlet class.
        /// </summary>
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.QueuesCreateOrUpdate(ResourceGroupName, NamespaceName, Name, SubscriptionId, _parametersBody, onOk, onDefault, this, Pipeline);
