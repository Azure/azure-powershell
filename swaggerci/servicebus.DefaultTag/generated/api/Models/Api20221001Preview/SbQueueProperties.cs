...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.ISbQueuePropertiesInternal
    {
        ...
        /// <summary>Backing field for <see cref="EnableBatchedOperation" /> property.</summary>
        private bool? _enableBatchedOperation;

        /// <summary>Value that indicates whether server-side batched operations are enabled.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.PropertyOrigin.Owned)]
        public bool? EnableBatchedOperation { get => this._enableBatchedOperation; set => this._enableBatchedOperation = value; }
        ...
        /// <summary>Backing field for <see cref="MaxMessageSizeInKilobyte" /> property.</summary>
        private long? _maxMessageSizeInKilobyte;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.PropertyOrigin.Owned)]
        public long? MaxMessageSizeInKilobyte { get => this._maxMessageSizeInKilobyte; set => this._maxMessageSizeInKilobyte = value; }

        /// <summary>Backing field for <see cref="MaxSizeInMegabyte" /> property.</summary>
        private int? _maxSizeInMegabyte;

        /// <summary>
        /// The maximum size of the queue in megabytes, which is the size of memory allocated for the queue. Default is 1024.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.PropertyOrigin.Owned)]
        public int? MaxSizeInMegabyte { get => this._maxSizeInMegabyte; set => this._maxSizeInMegabyte = value; }
