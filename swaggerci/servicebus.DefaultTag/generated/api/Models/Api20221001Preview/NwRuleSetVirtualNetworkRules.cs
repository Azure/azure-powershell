...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview
{
    ...
    public partial class NwRuleSetVirtualNetworkRules :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.INwRuleSetVirtualNetworkRulesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.ISubnet Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.INwRuleSetVirtualNetworkRulesInternal.Subnet { get => (this._subnet = this._subnet ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.Subnet()); set { {_subnet = value;} } }

        /// <summary>Backing field for <see cref="Subnet" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.ISubnet _subnet;

        /// <summary>Subnet properties</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.ISubnet Subnet { get => (this._subnet = this._subnet ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.Subnet()); set => this._subnet = value; }
        ...
        public string SubnetId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.ISubnetInternal)Subnet).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.ISubnetInternal)Subnet).Id = value ?? null; }
...

    {
        ...
        bool? IgnoreMissingVnetServiceEndpoint { get; set; }
        /// <summary>Subnet properties</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.ISubnet Subnet { get; set; }
        /// <summary>Resource ID of Virtual Network Subnet</summary>
        string SubnetId { get; set; }
