...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storsimple/backup-azstorsimplefileservernow
schema: 2.0.0
---

# Backup-AzStorSimpleFileServerNow
...
### Backup (Default)
```
Backup-AzStorSimpleFileServerNow -DeviceName <String> -FileServerName <String> -ManagerName <String>
...
### BackupViaIdentity
```
Backup-AzStorSimpleFileServerNow -InputObject <IStorSimpleIdentity> [-DefaultProfile <PSObject>] [-AsJob]
