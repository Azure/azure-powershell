...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storsimple/install-azstorsimpledeviceupdate
schema: 2.0.0
---

# Install-AzStorSimpleDeviceUpdate
...
### Install (Default)
```
Install-AzStorSimpleDeviceUpdate -DeviceName <String> -ManagerName <String> -ResourceGroupName <String>
...
### InstallViaIdentity
```
Install-AzStorSimpleDeviceUpdate -InputObject <IStorSimpleIdentity> [-DefaultProfile <PSObject>] [-AsJob]
