...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storsimple/get-azstorsimpleaccesscontrolrecord
schema: 2.0.0
---

# Get-AzStorSimpleAccessControlRecord
...
### List (Default)
```
Get-AzStorSimpleAccessControlRecord -ManagerName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzStorSimpleAccessControlRecord -ManagerName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzStorSimpleAccessControlRecord -InputObject <IStorSimpleIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
Type: System.String
Parameter Sets: Get
Aliases: AccessControlRecordName
