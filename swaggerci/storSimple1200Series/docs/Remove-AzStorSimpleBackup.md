...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storsimple/remove-azstorsimplebackup
schema: 2.0.0
---

# Remove-AzStorSimpleBackup
...
### Delete (Default)
```
Remove-AzStorSimpleBackup -DeviceName <String> -ManagerName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzStorSimpleBackup -InputObject <IStorSimpleIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
