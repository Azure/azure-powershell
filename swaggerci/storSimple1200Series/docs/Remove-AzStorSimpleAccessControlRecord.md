...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storsimple/remove-azstorsimpleaccesscontrolrecord
schema: 2.0.0
---

# Remove-AzStorSimpleAccessControlRecord
...
### Delete (Default)
```
Remove-AzStorSimpleAccessControlRecord -ManagerName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzStorSimpleAccessControlRecord -InputObject <IStorSimpleIdentity> [-DefaultProfile <PSObject>]
