...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storsimple/remove-azstorsimplechapsetting
schema: 2.0.0
---

# Remove-AzStorSimpleChapSetting
...
### Delete (Default)
```
Remove-AzStorSimpleChapSetting -ChapUserName <String> -DeviceName <String> -ManagerName <String>
...
### DeleteViaIdentity
```
Remove-AzStorSimpleChapSetting -InputObject <IStorSimpleIdentity> [-DefaultProfile <PSObject>] [-AsJob]
