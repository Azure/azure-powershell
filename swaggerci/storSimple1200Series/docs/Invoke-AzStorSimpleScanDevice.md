...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storsimple/invoke-azstorsimplescandevice
schema: 2.0.0
---

# Invoke-AzStorSimpleScanDevice
...
### Scan (Default)
```
Invoke-AzStorSimpleScanDevice -DeviceName <String> -ManagerName <String> -ResourceGroupName <String>
...
### ScanViaIdentity
```
Invoke-AzStorSimpleScanDevice -InputObject <IStorSimpleIdentity> [-DefaultProfile <PSObject>] [-AsJob]
...
Parameter Sets: ScanViaIdentity
Aliases:
