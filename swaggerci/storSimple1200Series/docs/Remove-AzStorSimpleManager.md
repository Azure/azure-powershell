...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storsimple/remove-azstorsimplemanager
schema: 2.0.0
---

# Remove-AzStorSimpleManager
...
### Delete (Default)
```
Remove-AzStorSimpleManager -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzStorSimpleManager -InputObject <IStorSimpleIdentity> [-DefaultProfile <PSObject>] [-PassThru]
