...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storsimple/remove-azstorsimplefileshare
schema: 2.0.0
---

# Remove-AzStorSimpleFileShare
...
### Delete (Default)
```
Remove-AzStorSimpleFileShare -DeviceName <String> -FileServerName <String> -ManagerName <String>
...
### DeleteViaIdentity
```
Remove-AzStorSimpleFileShare -InputObject <IStorSimpleIdentity> [-DefaultProfile <PSObject>] [-AsJob]
