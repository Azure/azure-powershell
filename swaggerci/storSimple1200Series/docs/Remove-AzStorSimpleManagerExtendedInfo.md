...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storsimple/remove-azstorsimplemanagerextendedinfo
schema: 2.0.0
---

# Remove-AzStorSimpleManagerExtendedInfo
...
### Delete (Default)
```
Remove-AzStorSimpleManagerExtendedInfo -ManagerName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzStorSimpleManagerExtendedInfo -InputObject <IStorSimpleIdentity> [-DefaultProfile <PSObject>]
