...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storsimple/get-azstorsimpleiscsidisk
schema: 2.0.0
---

# Get-AzStorSimpleIscsiDisk
...
### List (Default)
```
Get-AzStorSimpleIscsiDisk -DeviceName <String> -ManagerName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzStorSimpleIscsiDisk -DeviceName <String> -DiskName <String> -IscsiServerName <String>
...
### GetViaIdentity
```
Get-AzStorSimpleIscsiDisk -InputObject <IStorSimpleIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### List1
```
Get-AzStorSimpleIscsiDisk -DeviceName <String> -IscsiServerName <String> -ManagerName <String>
