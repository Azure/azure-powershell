...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storsimple/get-azstorsimplechapsetting
schema: 2.0.0
---

# Get-AzStorSimpleChapSetting
...
### List (Default)
```
Get-AzStorSimpleChapSetting -DeviceName <String> -ManagerName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzStorSimpleChapSetting -ChapUserName <String> -DeviceName <String> -ManagerName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzStorSimpleChapSetting -InputObject <IStorSimpleIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
