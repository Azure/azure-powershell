...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Models.Api20161001
{
    ...
    public partial class UploadCertificateResponse
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Models.Api20161001.IUploadCertificateResponse.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Models.Api20161001.IUploadCertificateResponse.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Models.Api20161001.IUploadCertificateResponse FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonObject json ? new UploadCertificateResponse(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UploadCertificateResponse" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UploadCertificateResponse" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.SerializationMode serializationMode)
        {
            ...
            __baseModel?.ToJson(container, serializationMode);
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonObject into a new instance of <see cref="UploadCertificateResponse" />.
        /// </summary>
        ...
        internal UploadCertificateResponse(Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            __baseModel = new Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Models.Api20161001.BaseModel(json);
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Models.Api20161001.ResourceCertificateAndAadDetails.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }
    }
}