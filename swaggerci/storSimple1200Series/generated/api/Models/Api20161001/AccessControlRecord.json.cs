...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Models.Api20161001
{
    ...
    public partial class AccessControlRecord
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonObject into a new instance of <see cref="AccessControlRecord" />.
        /// </summary>
        ...
        internal AccessControlRecord(Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Models.Api20161001.AccessControlRecordProperties.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Models.Api20161001.IAccessControlRecord.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Models.Api20161001.IAccessControlRecord.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Models.Api20161001.IAccessControlRecord FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonObject json ? new AccessControlRecord(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AccessControlRecord" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AccessControlRecord" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Runtime.Json.JsonNode" />.
        /// </returns>
