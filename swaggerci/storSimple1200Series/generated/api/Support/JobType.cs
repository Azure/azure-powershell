...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Support.JobType Backup = @"Backup";

        public static Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Support.JobType Clone = @"Clone";

        public static Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Support.JobType DownloadUpdates = @"DownloadUpdates";

        public static Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Support.JobType Failover = @"Failover";

        public static Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Support.JobType InstallUpdates = @"InstallUpdates";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Support.JobType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Support.JobType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Support.JobType e1, Microsoft.Azure.PowerShell.Cmdlets.StorSimple.Support.JobType e2)
        {
            return !e2.Equals(e1);
        }
