...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/providers/Microsoft.Authorization/accessReviewScheduleDefinitions"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzAuthorizationAccessReviewScheduleDefinitionsAssignedForMyApproval_List")]
    ...
    public partial class GetAzAuthorizationAccessReviewScheduleDefinitionsAssignedForMyApproval_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20211116Preview.IAccessReviewScheduleDefinitionListResult"
        /// /> from the remote call</param>
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzAuthorizationAccessReviewScheduleDefinitionsAssignedForMyApproval_List"
        /// /> cmdlet class.
        /// </summary>
        public GetAzAuthorizationAccessReviewScheduleDefinitionsAssignedForMyApproval_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AccessReviewScheduleDefinitionsAssignedForMyApprovalList(this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.AccessReviewScheduleDefinitionsAssignedForMyApprovalList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
