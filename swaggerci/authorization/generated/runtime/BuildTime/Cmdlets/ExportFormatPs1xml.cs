...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support";
