...
online version: https://docs.microsoft.com/en-us/powershell/module/az.authorization/reset-azauthorizationaccessreviewinstancedecision
schema: 2.0.0
---
...
### Reset (Default)
```
Reset-AzAuthorizationAccessReviewInstanceDecision -Id <String> -ScheduleDefinitionId <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-AzAuthorizationAccessReviewInstanceDecision -InputObject <IAuthorizationIdentity>
