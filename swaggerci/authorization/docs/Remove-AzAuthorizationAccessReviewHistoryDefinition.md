...
online version: https://docs.microsoft.com/en-us/powershell/module/az.authorization/remove-azauthorizationaccessreviewhistorydefinition
schema: 2.0.0
---

# Remove-AzAuthorizationAccessReviewHistoryDefinition
...
### Delete (Default)
```
Remove-AzAuthorizationAccessReviewHistoryDefinition -HistoryDefinitionId <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzAuthorizationAccessReviewHistoryDefinition -InputObject <IAuthorizationIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
