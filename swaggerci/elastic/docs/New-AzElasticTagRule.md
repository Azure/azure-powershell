...
online version: https://docs.microsoft.com/en-us/powershell/module/az.elastic/new-azelastictagrule
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20200701Preview.IFilteringTag[]
Parameter Sets: (All)
Aliases:
