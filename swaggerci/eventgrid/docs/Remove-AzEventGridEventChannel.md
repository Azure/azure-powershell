...
online version: https://docs.microsoft.com/en-us/powershell/module/az.eventgrid/remove-azeventgrideventchannel
schema: 2.0.0
---

# Remove-AzEventGridEventChannel
...
### Delete (Default)
```
Remove-AzEventGridEventChannel -Name <String> -PartnerNamespaceName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzEventGridEventChannel -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-AsJob]
