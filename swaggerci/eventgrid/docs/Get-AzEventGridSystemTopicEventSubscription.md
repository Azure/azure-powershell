...
online version: https://docs.microsoft.com/en-us/powershell/module/az.eventgrid/get-azeventgridsystemtopiceventsubscription
schema: 2.0.0
---
...
### List (Default)
```
Get-AzEventGridSystemTopicEventSubscription -ResourceGroupName <String> -SystemTopicName <String>
...
Get-AzEventGridSystemTopicEventSubscription -EventSubscriptionName <String> -ResourceGroupName <String>
 -SystemTopicName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
