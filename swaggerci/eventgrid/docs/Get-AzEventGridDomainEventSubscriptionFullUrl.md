...
### Get (Default)
```
Get-AzEventGridDomainEventSubscriptionFullUrl -DomainName <String> -EventSubscriptionName <String>
...
### GetViaIdentity
```
Get-AzEventGridDomainEventSubscriptionFullUrl -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>]
