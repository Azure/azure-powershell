...
online version: https://docs.microsoft.com/en-us/powershell/module/az.eventgrid/get-azeventgrideventsubscriptionregional
schema: 2.0.0
---
...
### List1
```
Get-AzEventGridEventSubscriptionRegional -Location <String> -ResourceGroupName <String>
...
### List2
```
Get-AzEventGridEventSubscriptionRegional -Location <String> -TopicTypeName <String>
 [-SubscriptionId <String[]>] [-Filter <String>] [-Top <Int32>] [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
...
```
Get-AzEventGridEventSubscriptionRegional -Location <String> -ResourceGroupName <String>
 -TopicTypeName <String> [-SubscriptionId <String[]>] [-Filter <String>] [-Top <Int32>]
