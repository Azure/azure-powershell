...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/partnerNamespaces/{partnerNamespaceName}/channels/{channelName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzEventGridChannel_UpdateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Description(@"Synchronously updates a channel with the specified parameters.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Generated]
    public partial class UpdateAzEventGridChannel_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.IChannelUpdateParameters _channelUpdateParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.ChannelUpdateParameters();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.IEventTypeInfoInlineEventTypes EventTypeInfoInlineEventType { get => _channelUpdateParametersBody.EventTypeInfoInlineEventType ?? null /* object */; set => _channelUpdateParametersBody.EventTypeInfoInlineEventType = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Support.EventDefinitionKind EventTypeInfoKind { get => _channelUpdateParametersBody.EventTypeInfoKind ?? ((Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Support.EventDefinitionKind)""); set => _channelUpdateParametersBody.EventTypeInfoKind = value; }

        /// <summary>
        /// Expiration time of the event channel. If this timer expires while the corresponding partner topic or partner destination
        /// is never activated,the channel and corresponding partner topic or partner destination are deleted.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Expiration time of the event channel. If this timer expires while the corresponding partner topic or partner destination is never activated,the channel and corresponding partner topic or partner destination are deleted.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Expiration time of the event channel. If this timer expires while the corresponding partner topic or partner destination is never activated,the channel and corresponding partner topic or partner destination are deleted.",
        SerializedName = @"expirationTimeIfNotActivatedUtc",
        PossibleTypes = new [] { typeof(global::System.DateTime) })]
        public global::System.DateTime ExpirationTimeIfNotActivatedUtc { get => _channelUpdateParametersBody.ExpirationTimeIfNotActivatedUtc ?? default(global::System.DateTime); set => _channelUpdateParametersBody.ExpirationTimeIfNotActivatedUtc = value; }
        ...
        /// <summary>The name of the resource group within the partners subscription.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the resource group within the partners subscription.")]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ChannelsUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ChannelsUpdate(SubscriptionId, ResourceGroupName, PartnerNamespaceName, Name, _channelUpdateParametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,PartnerNamespaceName=PartnerNamespaceName,Name=Name,body=_channelUpdateParametersBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzEventGridChannel_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzEventGridChannel_UpdateExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage)
        {
            using( NoSynchronizationContext )
            {
                ...
                WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, PartnerNamespaceName=PartnerNamespaceName, Name=Name, body=_channelUpdateParametersBody })
                {
