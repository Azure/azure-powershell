...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.IPartnerRegistration _partnerRegistrationInfoBody = new Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.PartnerRegistration();
        ...
        Required = false,
        ReadOnly = false,
        Description = @"List of Azure subscription Ids that are authorized to create a partner namespaceassociated with this partner registration. This is an optional property. Creatingpartner namespaces is always permitted under the same Azure subscription as the one usedfor creating the partner registration.",
        SerializedName = @"authorizedAzureSubscriptionIds",
        PossibleTypes = new [] { typeof(string) })]
        public string[] AuthorizedAzureSubscriptionId { get => _partnerRegistrationInfoBody.AuthorizedAzureSubscriptionId ?? null /* arrayOf */; set => _partnerRegistrationInfoBody.AuthorizedAzureSubscriptionId = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The extension of the customer service URI of the publisher.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string CustomerServiceUri { get => _partnerRegistrationInfoBody.CustomerServiceUri ?? null; set => _partnerRegistrationInfoBody.CustomerServiceUri = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "URI of the logo.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string LogoUri { get => _partnerRegistrationInfoBody.LogoUri ?? null; set => _partnerRegistrationInfoBody.LogoUri = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Long description for the custom scenarios and integration to be displayed in the portal if needed.Length of this description should not exceed 2048 characters.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Long description for the custom scenarios and integration to be displayed in the portal if needed.Length of this description should not exceed 2048 characters.",
        SerializedName = @"longDescription",
        PossibleTypes = new [] { typeof(string) })]
        public string LongDescription { get => _partnerRegistrationInfoBody.LongDescription ?? null; set => _partnerRegistrationInfoBody.LongDescription = value; }
        ...
        /// exceed 10.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The extension of the customer service number of the publisher. Only digits are allowed and number of digits should not exceed 10.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// code. The remaining digits are then followed. Only digits and spaces are allowed and itslength cannot exceed 16 digits
        /// including country code. Examples of valid phone numbers are: +1 515 123 4567 and+966 7 5115 2471. Examples of invalid
        ...
        Required = false,
        ReadOnly = false,
        Description = @"The customer service number of the publisher. The expected phone format should start with a '+' sign followed by the country code. The remaining digits are then followed. Only digits and spaces are allowed and itslength cannot exceed 16 digits including country code. Examples of valid phone numbers are: +1 515 123 4567 and+966 7 5115 2471. Examples of invalid phone numbers are: +1 (515) 123-4567, 1 515 123 4567 and +966 121 5115 24 7 551 1234 43",
        SerializedName = @"partnerCustomerServiceNumber",
        PossibleTypes = new [] { typeof(string) })]
        public string PartnerCustomerServiceNumber { get => _partnerRegistrationInfoBody.PartnerCustomerServiceNumber ?? null; set => _partnerRegistrationInfoBody.PartnerCustomerServiceNumber = value; }

        /// <summary>Official name of the partner name. For example: "Contoso".</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Official name of the partner name. For example: \"Contoso\".")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string PartnerName { get => _partnerRegistrationInfoBody.PartnerName ?? null; set => _partnerRegistrationInfoBody.PartnerName = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Short description of the partner resource type. The length of this description should not exceed 256 characters.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string PartnerResourceTypeDescription { get => _partnerRegistrationInfoBody.PartnerResourceTypeDescription ?? null; set => _partnerRegistrationInfoBody.PartnerResourceTypeDescription = value; }

        /// <summary>Display name of the partner resource type.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Display name of the partner resource type.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string PartnerResourceTypeDisplayName { get => _partnerRegistrationInfoBody.PartnerResourceTypeDisplayName ?? null; set => _partnerRegistrationInfoBody.PartnerResourceTypeDisplayName = value; }

        /// <summary>Name of the partner resource type.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of the partner resource type.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string PartnerResourceTypeName { get => _partnerRegistrationInfoBody.PartnerResourceTypeName ?? null; set => _partnerRegistrationInfoBody.PartnerResourceTypeName = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SetupUri { get => _partnerRegistrationInfoBody.SetupUri ?? null; set => _partnerRegistrationInfoBody.SetupUri = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.ITrackedResourceTags Tag { get => _partnerRegistrationInfoBody.Tag ?? null /* object */; set => _partnerRegistrationInfoBody.Tag = value; }

        /// <summary>Visibility state of the partner registration.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Visibility state of the partner registration.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Support.PartnerRegistrationVisibilityState))]
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Support.PartnerRegistrationVisibilityState VisibilityState { get => _partnerRegistrationInfoBody.VisibilityState ?? ((Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Support.PartnerRegistrationVisibilityState)""); set => _partnerRegistrationInfoBody.VisibilityState = value; }
