...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IEventGridIdentityInternal
    {
        ...
        /// <summary>Backing field for <see cref="EventChannelName" /> property.</summary>
        private string _eventChannelName;

        /// <summary>Name of the event channel.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Origin(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.PropertyOrigin.Owned)]
        public string EventChannelName { get => this._eventChannelName; set => this._eventChannelName = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string EventChannelName { get; set; }
        /// <summary>Name of the event subscription.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Support.ParentType? ParentType { get; set; }
        /// <summary>Name of the partner destination.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
