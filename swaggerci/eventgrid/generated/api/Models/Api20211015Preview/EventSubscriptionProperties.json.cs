...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview
{
    ...
    public partial class EventSubscriptionProperties
    {
        ...
        internal EventSubscriptionProperties(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject json)
        {
            ...
            {_deliveryWithResourceIdentity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject>("deliveryWithResourceIdentity"), out var __jsonDeliveryWithResourceIdentity) ? Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.DeliveryWithResourceIdentity.FromJson(__jsonDeliveryWithResourceIdentity) : DeliveryWithResourceIdentity;}
            {_filter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject>("filter"), out var __jsonFilter) ? Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.EventSubscriptionFilter.FromJson(__jsonFilter) : Filter;}
            {_retryPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject>("retryPolicy"), out var __jsonRetryPolicy) ? Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.RetryPolicy.FromJson(__jsonRetryPolicy) : RetryPolicy;}
            ...
            {_topic = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonString>("topic"), out var __jsonTopic) ? (string)__jsonTopic : (string)Topic;}
            ...
            {_expirationTimeUtc = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonString>("expirationTimeUtc"), out var __jsonExpirationTimeUtc) ? global::System.DateTime.TryParse((string)__jsonExpirationTimeUtc, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonExpirationTimeUtcValue) ? __jsonExpirationTimeUtcValue : ExpirationTimeUtc : ExpirationTimeUtc;}
            {_eventDeliverySchema = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonString>("eventDeliverySchema"), out var __jsonEventDeliverySchema) ? (string)__jsonEventDeliverySchema : (string)EventDeliverySchema;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.IEventSubscriptionProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.IEventSubscriptionProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.IEventSubscriptionProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonNode node)
        {
