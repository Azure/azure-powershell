...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20230401Preview.IExperimentStatus
.Link
https://learn.microsoft.com/powershell/module/az.chaos/get-azchaosexperimentstatuses
#>
function Get-AzChaosExperimentStatuses {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20230401Preview.IExperimentStatus])]
