...
### CancelViaIdentity
```
Stop-AzChaosExperiment -InputObject <IChaosIdentity> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20230401Preview.IExperimentCancelOperationResult
