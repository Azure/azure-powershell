...
online version: https://docs.microsoft.com/en-us/powershell/module/az.agrifoodrpservice/update-azagrifoodrpservicefarmbeatsmodel
schema: 2.0.0
---

# Update-AzAgriFoodRpServiceFarmBeatsModel
...
```
Update-AzAgriFoodRpServiceFarmBeatsModel -FarmBeatsResourceName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-Location <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAgriFoodRpServiceFarmBeatsModel -InputObject <IAgriFoodRpServiceIdentity> [-Location <String>]
