...
online version: https://docs.microsoft.com/en-us/powershell/module/az.agrifoodrpservice/remove-azagrifoodrpserviceextension
schema: 2.0.0
---

# Remove-AzAgriFoodRpServiceExtension
...
### Delete (Default)
```
Remove-AzAgriFoodRpServiceExtension -FarmBeatsResourceName <String> -Id <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzAgriFoodRpServiceExtension -InputObject <IAgriFoodRpServiceIdentity> [-DefaultProfile <PSObject>]
