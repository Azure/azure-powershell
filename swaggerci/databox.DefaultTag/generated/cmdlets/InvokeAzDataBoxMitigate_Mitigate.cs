...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Mitigate=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBox/jobs/{jobName}/mitigate"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzDataBoxMitigate_Mitigate", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataBox.Description(@"Request to mitigate for a given job")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataBox.Generated]
    public partial class InvokeAzDataBoxMitigate_Mitigate : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="MitigateJobRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221201.IMitigateJobRequest _mitigateJobRequest;

        /// <summary>The Mitigate Job captured from request body for Mitigate API</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The Mitigate Job captured from request body for Mitigate API", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The Mitigate Job captured from request body for Mitigate API",
        SerializedName = @"mitigateJobRequest",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221201.IMitigateJobRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221201.IMitigateJobRequest MitigateJobRequest { get => this._mitigateJobRequest; set => this._mitigateJobRequest = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzDataBoxMitigate_Mitigate" /> cmdlet class.
        /// </summary>
        public InvokeAzDataBoxMitigate_Mitigate()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'Mitigate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.Mitigate(JobName, SubscriptionId, ResourceGroupName, MitigateJobRequest, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  JobName=JobName,SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,body=MitigateJobRequest})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221201.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { JobName=JobName, SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, body=MitigateJobRequest })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { JobName=JobName, SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, body=MitigateJobRequest })
                    {
