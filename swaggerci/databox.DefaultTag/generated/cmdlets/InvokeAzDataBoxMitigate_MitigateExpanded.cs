...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzDataBoxMitigate_MitigateExpanded", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzDataBoxMitigate_MitigateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221201.IMitigateJobRequest _mitigateJobRequestBody = new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221201.MitigateJobRequest();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221201.IMitigateJobRequestSerialNumberCustomerResolutionMap SerialNumberCustomerResolutionMap { get => _mitigateJobRequestBody.SerialNumberCustomerResolutionMap ?? null /* object */; set => _mitigateJobRequestBody.SerialNumberCustomerResolutionMap = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzDataBoxMitigate_MitigateExpanded" /> cmdlet class.
        /// </summary>
        public InvokeAzDataBoxMitigate_MitigateExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.Mitigate(JobName, SubscriptionId, ResourceGroupName, _mitigateJobRequestBody, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  JobName=JobName,SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,body=_mitigateJobRequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221201.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { JobName=JobName, SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, body=_mitigateJobRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { JobName=JobName, SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, body=_mitigateJobRequestBody })
                    {
