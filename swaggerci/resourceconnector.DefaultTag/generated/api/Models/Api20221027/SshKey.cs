...
namespace Microsoft.Azure.PowerShell.Cmdlets.Appliances.Models.Api20221027
{
    ...
    public partial class SshKey :
        Microsoft.Azure.PowerShell.Cmdlets.Appliances.Models.Api20221027.ISshKey,
        Microsoft.Azure.PowerShell.Cmdlets.Appliances.Models.Api20221027.ISshKeyInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Appliances.Models.Api20221027.ISshKeyInternal.Certificate { get => this._certificate; set { {_certificate = value;} } }

        /// <summary>Internal Acessors for CreationTimeStamp</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Appliances.Models.Api20221027.ISshKeyInternal.CreationTimeStamp { get => this._creationTimeStamp; set { {_creationTimeStamp = value;} } }

        /// <summary>Internal Acessors for ExpirationTimeStamp</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Appliances.Models.Api20221027.ISshKeyInternal.ExpirationTimeStamp { get => this._expirationTimeStamp; set { {_expirationTimeStamp = value;} } }

        /// <summary>Internal Acessors for PrivateKey</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Appliances.Models.Api20221027.ISshKeyInternal.PrivateKey { get => this._privateKey; set { {_privateKey = value;} } }

        /// <summary>Internal Acessors for PublicKey</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Appliances.Models.Api20221027.ISshKeyInternal.PublicKey { get => this._publicKey; set { {_publicKey = value;} } }
