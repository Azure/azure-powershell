...
namespace Microsoft.Azure.PowerShell.Cmdlets.Appliances.Models.Api20221027
{
    ...
    public partial class SupportedVersionCatalogVersionTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="SupportedVersionCatalogVersion" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Appliances.Models.Api20221027.ISupportedVersionCatalogVersion ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Appliances.Models.Api20221027.ISupportedVersionCatalogVersion).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
