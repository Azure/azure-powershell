...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListCachedImages=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.ContainerInstance/locations/{location}/cachedImages"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzContainerInstanceLocationCachedImage_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230201Preview.ICachedImages))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Description(@"Get the list of cached images on specific OS type for a subscription in a region.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Generated]
    public partial class GetAzContainerInstanceLocationCachedImage_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The identifier for the physical azure location.")]
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230201Preview.ICachedImagesListResult">Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230201Preview.ICachedImagesListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230201Preview.ICachedImagesListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzContainerInstanceLocationCachedImage_List" /> cmdlet class.
        /// </summary>
        public GetAzContainerInstanceLocationCachedImage_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.LocationListCachedImages(SubscriptionId, Location, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230201Preview.ICachedImagesListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.LocationListCachedImages_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
