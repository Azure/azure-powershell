...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybrid/stop-azhybridjob
schema: 2.0.0
---
...
### Cancel (Default)
```
Stop-AzHybridJob -DataManagerName <String> -DataServiceName <String> -DefinitionName <String> -Id <String>
...
### CancelViaIdentity
```
Stop-AzHybridJob -InputObject <IHybridIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
