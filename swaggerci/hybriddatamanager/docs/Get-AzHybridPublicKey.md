...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybrid/get-azhybridpublickey
schema: 2.0.0
---

# Get-AzHybridPublicKey
...
### List (Default)
```
Get-AzHybridPublicKey -DataManagerName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzHybridPublicKey -DataManagerName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzHybridPublicKey -InputObject <IHybridIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
