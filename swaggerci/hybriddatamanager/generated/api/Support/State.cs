...
namespace Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Support.State Disabled = @"Disabled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Support.State Enabled = @"Enabled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Support.State Supported = @"Supported";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Support.State e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Support.State e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Support.State e1, Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Support.State e2)
        {
            return !e2.Equals(e1);
        }
