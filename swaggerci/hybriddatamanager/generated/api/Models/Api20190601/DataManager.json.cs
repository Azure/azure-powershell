...
namespace Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Models.Api20190601
{
    ...
    public partial class DataManager
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.Json.JsonObject into a new instance of <see cref="DataManager" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal DataManager(Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.Json.JsonObject json)
        {
            ...
            __resource = new Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Models.Api20190601.Resource(json);
            {_etag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.Json.JsonString>("etag"), out var __jsonEtag) ? (string)__jsonEtag : (string)Etag;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Models.Api20190601.IDataManager.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Models.Api20190601.IDataManager.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Models.Api20190601.IDataManager FromJson(Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.Json.JsonObject json ? new DataManager(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="DataManager" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="DataManager" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._etag)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.Json.JsonString(this._etag.ToString()) : null, "etag" ,container.Add );
