...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Support.HealthStatus ActionRequired = @"ActionRequired";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Support.HealthStatus ActionSuggested = @"ActionSuggested";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Support.HealthStatus Invalid = @"Invalid";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Support.HealthStatus Passed = @"Passed";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Support.HealthStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Support.HealthStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Support.HealthStatus e1, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Support.HealthStatus e2)
        {
            return !e2.Equals(e1);
        }
