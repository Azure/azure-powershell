...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001
{
    ...
    public partial class ReservationRecommendation
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.IReservationRecommendation.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.IReservationRecommendation interface is polymorphic,
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.IReservationRecommendation.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.IReservationRecommendation FromJson(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonNode node)
        {
            if (!(node is Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject json))
            {
                return null;
            }
            ...
            switch ( json.StringProperty("kind") )
            {
                case "legacy":
                {
                    return new LegacyReservationRecommendation(json);
                }
                case "modern":
                {
                    return new ModernReservationRecommendation(json);
                }
            }
            return new ReservationRecommendation(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject into a new instance of <see cref="ReservationRecommendation" />.
        /// </summary>
        ...
        internal ReservationRecommendation(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject json)
        {
            ...
            __resource = new Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.Resource(json);
            __resourceAttributes = new Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.ResourceAttributes(json);
        ...
        /// <summary>
        /// Serializes this instance of <see cref="ReservationRecommendation" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ReservationRecommendation" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonNode" />.
        /// </returns>
