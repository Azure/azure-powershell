...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.Type AzureResource = @"AzureResource";

        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.Type ConfluentBootstrapServer = @"ConfluentBootstrapServer";

        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.Type ConfluentSchemaRegistry = @"ConfluentSchemaRegistry";

        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.Type KeyVault = @"KeyVault";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.Type e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.Type e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.Type e1, Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.Type e2)
        {
            return !e2.Equals(e1);
        }
