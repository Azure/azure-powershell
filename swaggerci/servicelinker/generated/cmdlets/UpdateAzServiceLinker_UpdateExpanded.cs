...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Cmdlets
{
    ...
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20220501.ILinkerResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Description(@"Operation to update an existing link.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.AuthType))]
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.AuthType AuthInfoAuthType { get => ParametersBody.AuthInfoAuthType ?? ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.AuthType)""); set => ParametersBody.AuthInfoAuthType = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.ServiceLinkerManagementClient Client => Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Module.Instance.ClientAPI;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.ClientType ClientType { get => ParametersBody.ClientType ?? ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.ClientType)""); set => ParametersBody.ClientType = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20220501.ILinkerPatch _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20220501.LinkerPatch();

        /// <summary>A linker to be updated.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20220501.ILinkerPatch ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SecretStoreKeyVaultId { get => ParametersBody.SecretStoreKeyVaultId ?? null; set => ParametersBody.SecretStoreKeyVaultId = value; }

        /// <summary>The target service type.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The target service type.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.Type))]
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.Type TargetServiceType { get => ParametersBody.TargetServiceType ?? ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.Type)""); set => ParametersBody.TargetServiceType = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.VNetSolutionType VNetSolutionType { get => ParametersBody.VNetSolutionType ?? ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.VNetSolutionType)""); set => ParametersBody.VNetSolutionType = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20.IErrorResponse"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20.IErrorResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20220501.ILinkerResource"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20220501.ILinkerResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.LinkerUpdate(ResourceUri, Name, ParametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceUri=ResourceUri,Name=Name,body=ParametersBody})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20.IErrorResponse>(responseMessage, await response);
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceUri=ResourceUri, Name=Name, body=ParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceUri=ResourceUri, Name=Name, body=ParametersBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20220501.ILinkerResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20220501.ILinkerResource
