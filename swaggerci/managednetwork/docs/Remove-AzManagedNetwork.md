...
### Delete (Default)
```
Remove-AzManagedNetwork -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzManagedNetwork -InputObject <IManagedNetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
