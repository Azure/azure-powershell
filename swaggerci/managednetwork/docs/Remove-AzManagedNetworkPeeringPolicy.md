...
### Delete (Default)
```
Remove-AzManagedNetworkPeeringPolicy -ManagedNetworkName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzManagedNetworkPeeringPolicy -InputObject <IManagedNetworkIdentity> [-DefaultProfile <PSObject>]
