...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hdinsight/disable-azhdinsightextensionmonitoring
schema: 2.0.0
---

# Disable-AzHdInsightExtensionMonitoring
...
### Disable (Default)
```
Disable-AzHdInsightExtensionMonitoring -ClusterName <String> -ResourceGroupName <String>
...
### DisableViaIdentity
```
Disable-AzHdInsightExtensionMonitoring -InputObject <IHdInsightIdentity> [-DefaultProfile <PSObject>] [-AsJob]
