...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hdinsight/remove-azhdinsightscriptaction
schema: 2.0.0
---

# Remove-AzHdInsightScriptAction
...
### Delete (Default)
```
Remove-AzHdInsightScriptAction -ClusterName <String> -ResourceGroupName <String> -ScriptName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzHdInsightScriptAction -InputObject <IHdInsightIdentity> [-DefaultProfile <PSObject>] [-PassThru]
