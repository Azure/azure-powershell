...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hdinsight/get-azhdinsightconfiguration
schema: 2.0.0
---

# Get-AzHdInsightConfiguration
...
### List (Default)
```
Get-AzHdInsightConfiguration -ClusterName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Get
```
Get-AzHdInsightConfiguration -ClusterName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzHdInsightConfiguration -InputObject <IHdInsightIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
