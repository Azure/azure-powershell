...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hdinsight/remove-azhdinsightextension
schema: 2.0.0
---

# Remove-AzHdInsightExtension
...
### Delete (Default)
```
Remove-AzHdInsightExtension -ClusterName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzHdInsightExtension -InputObject <IHdInsightIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
