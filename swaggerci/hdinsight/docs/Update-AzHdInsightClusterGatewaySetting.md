...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hdinsight/update-azhdinsightclustergatewaysetting
schema: 2.0.0
---

# Update-AzHdInsightClusterGatewaySetting
...
```
Update-AzHdInsightClusterGatewaySetting -ClusterName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-IsCredentialEnabled] [-Password <String>] [-UserName <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzHdInsightClusterGatewaySetting -InputObject <IHdInsightIdentity> [-IsCredentialEnabled]
 [-Password <String>] [-UserName <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
