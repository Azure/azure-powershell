...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hdinsight/update-azhdinsightclusterautoscaleconfiguration
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20210601.IAutoscaleSchedule[]
Parameter Sets: (All)
Aliases:
