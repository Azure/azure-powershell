...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hdinsight/get-azhdinsightapplication
schema: 2.0.0
---

# Get-AzHdInsightApplication
...
### List (Default)
```
Get-AzHdInsightApplication -ClusterName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzHdInsightApplication -ClusterName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzHdInsightApplication -InputObject <IHdInsightIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
