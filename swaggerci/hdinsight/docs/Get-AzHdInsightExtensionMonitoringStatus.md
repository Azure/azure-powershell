...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hdinsight/get-azhdinsightextensionmonitoringstatus
schema: 2.0.0
---

# Get-AzHdInsightExtensionMonitoringStatus
...
### Get (Default)
```
Get-AzHdInsightExtensionMonitoringStatus -ClusterName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzHdInsightExtensionMonitoringStatus -InputObject <IHdInsightIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
