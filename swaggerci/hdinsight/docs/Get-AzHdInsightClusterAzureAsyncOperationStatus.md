...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hdinsight/get-azhdinsightclusterazureasyncoperationstatus
schema: 2.0.0
---

# Get-AzHdInsightClusterAzureAsyncOperationStatus
...
### Get (Default)
```
Get-AzHdInsightClusterAzureAsyncOperationStatus -ClusterName <String> -OperationId <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzHdInsightClusterAzureAsyncOperationStatus -InputObject <IHdInsightIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
