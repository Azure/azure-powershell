...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hdinsight/get-azhdinsightscriptactionexecutionasyncoperationstatus
schema: 2.0.0
---

# Get-AzHdInsightScriptActionExecutionAsyncOperationStatus
...
### Get (Default)
```
Get-AzHdInsightScriptActionExecutionAsyncOperationStatus -ClusterName <String> -OperationId <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzHdInsightScriptActionExecutionAsyncOperationStatus -InputObject <IHdInsightIdentity>
