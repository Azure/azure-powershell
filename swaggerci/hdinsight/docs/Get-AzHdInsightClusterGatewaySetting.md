...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hdinsight/get-azhdinsightclustergatewaysetting
schema: 2.0.0
---

# Get-AzHdInsightClusterGatewaySetting
...
### Get (Default)
```
Get-AzHdInsightClusterGatewaySetting -ClusterName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzHdInsightClusterGatewaySetting -InputObject <IHdInsightIdentity> [-DefaultProfile <PSObject>] [-Confirm]
