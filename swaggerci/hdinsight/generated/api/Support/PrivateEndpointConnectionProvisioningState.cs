...
namespace Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Support.PrivateEndpointConnectionProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Support.PrivateEndpointConnectionProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Support.PrivateEndpointConnectionProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Support.PrivateEndpointConnectionProvisioningState InProgress = @"InProgress";

        public static Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Support.PrivateEndpointConnectionProvisioningState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Support.PrivateEndpointConnectionProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Support.PrivateEndpointConnectionProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Support.PrivateEndpointConnectionProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Support.PrivateEndpointConnectionProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Support.PrivateEndpointConnectionProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
