...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.TimeframeType BillingMonthToDate = @"BillingMonthToDate";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.TimeframeType Custom = @"Custom";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.TimeframeType MonthToDate = @"MonthToDate";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.TimeframeType TheLastBillingMonth = @"TheLastBillingMonth";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.TimeframeType TheLastMonth = @"TheLastMonth";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.TimeframeType WeekToDate = @"WeekToDate";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.TimeframeType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.TimeframeType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.TimeframeType e1, Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.TimeframeType e2)
        {
            return !e2.Equals(e1);
        }
