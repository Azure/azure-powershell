...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001
{
    ...
    public partial class ReportConfigGrouping :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001.IReportConfigGrouping,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001.IReportConfigGroupingInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.ReportConfigColumnType _type;

        /// <summary>Has type of the column to group.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.ReportConfigColumnType Type { get => this._type; set => this._type = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"type",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.ReportConfigColumnType) })]
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.ReportConfigColumnType Type { get; set; }

    }
    /// The group by expression to be used in the report.
    internal partial interface IReportConfigGroupingInternal
