...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001
{
    ...
    public partial class ReportConfigSorting :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001.IReportConfigSorting,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001.IReportConfigSortingInternal
    {

        /// <summary>Backing field for <see cref="Direction" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.ReportConfigSortingType? _direction;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.ReportConfigSortingType? Direction { get => this._direction; set => this._direction = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.ReportConfigSortingType) })]
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.ReportConfigSortingType? Direction { get; set; }
        /// <summary>The name of the column to sort.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = true,
        ReadOnly = false,
    ...
    /// The order by expression to be used in the report.
    internal partial interface IReportConfigSortingInternal
