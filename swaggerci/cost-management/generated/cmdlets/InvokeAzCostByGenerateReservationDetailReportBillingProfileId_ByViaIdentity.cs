...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzCostByGenerateReservationDetailReportBillingProfileId_ByViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzCostByGenerateReservationDetailReportBillingProfileId_ByViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzCostByGenerateReservationDetailReportBillingProfileId_ByViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets.InvokeAzCostByGenerateReservationDetailReportBillingProfileId_ByViaIdentity Clone()
        {
            var clone = new InvokeAzCostByGenerateReservationDetailReportBillingProfileId_ByViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzCostByGenerateReservationDetailReportBillingProfileId_ByViaIdentity"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzCostByGenerateReservationDetailReportBillingProfileId_ByViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.GenerateReservationDetailsReportByBillingProfileIdViaIdentity(InputObject.Id, StartDate, EndDate, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.GenerateReservationDetailsReportByBillingProfileId(InputObject.BillingAccountId ?? null, InputObject.BillingProfileId ?? null, StartDate, EndDate, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  StartDate=StartDate,EndDate=EndDate})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { StartDate=StartDate, EndDate=EndDate })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { StartDate=StartDate, EndDate=EndDate })
                    {
