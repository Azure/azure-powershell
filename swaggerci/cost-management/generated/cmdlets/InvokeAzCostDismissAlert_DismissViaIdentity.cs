...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzCostDismissAlert_DismissViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzCostDismissAlert_DismissViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001.IDismissAlertPayload _parameter;

        /// <summary>The request payload to update an alert</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The request payload to update an alert", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The request payload to update an alert",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001.IDismissAlertPayload) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001.IDismissAlertPayload Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzCostDismissAlert_DismissViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeAzCostDismissAlert_DismissViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.AlertsDismissViaIdentity(InputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.AlertId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.AlertId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.AlertsDismiss(InputObject.Scope ?? null, InputObject.AlertId ?? null, Parameter, onOk, onDefault, this, Pipeline);
                    }
