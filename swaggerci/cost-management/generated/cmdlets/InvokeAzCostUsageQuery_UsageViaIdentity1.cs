...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UsageByExternalCloudProviderType=>POST:"/providers/Microsoft.CostManagement/{externalCloudProviderType}/{externalCloudProviderId}/query"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzCostUsageQuery_UsageViaIdentity1", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Description(@"Query the usage data for external cloud provider type defined.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Generated]
    public partial class InvokeAzCostUsageQuery_UsageViaIdentity1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001.IQueryDefinition _parameter;

        /// <summary>The definition of a query.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The definition of a query.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The definition of a query.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001.IQueryDefinition) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001.IQueryDefinition Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzCostUsageQuery_UsageViaIdentity1" /> cmdlet class.
        /// </summary>
        public InvokeAzCostUsageQuery_UsageViaIdentity1()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'QueryUsageByExternalCloudProviderType' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.QueryUsageByExternalCloudProviderTypeViaIdentity(InputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == InputObject.ExternalCloudProviderType)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.ExternalCloudProviderType"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        if (null == InputObject.ExternalCloudProviderId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.ExternalCloudProviderId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.QueryUsageByExternalCloudProviderType(InputObject.ExternalCloudProviderType ?? ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.ExternalCloudProviderType)""), InputObject.ExternalCloudProviderId ?? null, Parameter, onOk, onDefault, this, Pipeline);
                    }
