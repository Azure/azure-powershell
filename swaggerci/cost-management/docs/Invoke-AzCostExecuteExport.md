...
external help file:
Module Name: Az.Cost
online version: https://docs.microsoft.com/en-us/powershell/module/az.cost/invoke-azcostexecuteexport
schema: 2.0.0
---

# Invoke-AzCostExecuteExport
...
### Execute (Default)
```
Invoke-AzCostExecuteExport -ExportName <String> -Scope <String> [-DefaultProfile <PSObject>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ExecuteViaIdentity
```
Invoke-AzCostExecuteExport -InputObject <ICostIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
