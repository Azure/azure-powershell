...
### Get (Default)
```
Get-AzCostGenerateDetailedCostReportOperationResult -OperationId <String> -Scope <String>
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzCostGenerateDetailedCostReportOperationResult -InputObject <ICostIdentity> [-DefaultProfile <PSObject>]
