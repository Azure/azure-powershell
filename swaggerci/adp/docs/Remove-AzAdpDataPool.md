...
external help file:
Module Name: Az.Adp
online version: https://docs.microsoft.com/en-us/powershell/module/az.adp/remove-azadpdatapool
schema: 2.0.0
---

# Remove-AzAdpDataPool
...
### Delete (Default)
```
Remove-AzAdpDataPool -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzAdpDataPool -InputObject <IAdpIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
