...
external help file:
Module Name: Az.Adp
online version: https://docs.microsoft.com/en-us/powershell/module/az.adp/update-azadpaccount
schema: 2.0.0
---
...
```
Update-AzAdpAccount -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAdpAccount -InputObject <IAdpIdentity> [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob]
