...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.AgentVersionStatus Deprecated = @"Deprecated";

        public static Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.AgentVersionStatus NotSupported = @"NotSupported";

        public static Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.AgentVersionStatus SecurityUpdateRequired = @"SecurityUpdateRequired";

        public static Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.AgentVersionStatus Supported = @"Supported";

        public static Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.AgentVersionStatus UpdateRequired = @"UpdateRequired";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.AgentVersionStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.AgentVersionStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.AgentVersionStatus e1, Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.AgentVersionStatus e2)
        {
            return !e2.Equals(e1);
        }
