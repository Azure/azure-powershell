...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201
{
    ...
    public partial class PushInstallerDetailsTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <paramref name="sourceValue"/> parameter to the <see cref="PushInstallerDetails"/>
        /// type.
        /// </summary>
        ...
        /// <summary>
        /// Converts the <paramref name="sourceValue" /> parameter into an instance of <see cref="PushInstallerDetails" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="PushInstallerDetails" />.</param>
        /// <returns>
        /// an instance of <see cref="PushInstallerDetails" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IPushInstallerDetails ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IPushInstallerDetails).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
