...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support";
