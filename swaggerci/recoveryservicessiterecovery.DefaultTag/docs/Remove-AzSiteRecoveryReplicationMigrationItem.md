...
online version: https://learn.microsoft.com/powershell/module/az.siterecovery/remove-azsiterecoveryreplicationmigrationitem
schema: 2.0.0
---

# Remove-AzSiteRecoveryReplicationMigrationItem
...
### Delete (Default)
```
Remove-AzSiteRecoveryReplicationMigrationItem -FabricName <String> -MigrationItemName <String>
...
### DeleteViaIdentity
```
Remove-AzSiteRecoveryReplicationMigrationItem -InputObject <ISiteRecoveryIdentity> [-DeleteOption <String>]
