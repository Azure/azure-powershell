...
### Purge (Default)
```
Clear-AzSiteRecoveryReplicationProtectedItem -FabricName <String> -ProtectionContainerName <String>
...
### PurgeViaIdentity
```
Clear-AzSiteRecoveryReplicationProtectedItem -InputObject <ISiteRecoveryIdentity> [-DefaultProfile <PSObject>]
