...
online version: https://learn.microsoft.com/powershell/module/az.siterecovery/update-azsiterecoveryreplicationvaulthealth
schema: 2.0.0
---
...
### Refresh (Default)
```
Update-AzSiteRecoveryReplicationVaultHealth -ResourceGroupName <String> -ResourceName <String>
...
### RefreshViaIdentity
```
Update-AzSiteRecoveryReplicationVaultHealth -InputObject <ISiteRecoveryIdentity> [-DefaultProfile <PSObject>]
...
### Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IVaultHealthDetails
