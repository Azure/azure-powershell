...
online version: https://learn.microsoft.com/powershell/module/az.siterecovery/invoke-azsiterecoveryunplannedreplicationrecoveryplanfailover
schema: 2.0.0
---

# Invoke-AzSiteRecoveryUnplannedReplicationRecoveryPlanFailover
...
```
Invoke-AzSiteRecoveryUnplannedReplicationRecoveryPlanFailover -RecoveryPlanName <String>
...
```
Invoke-AzSiteRecoveryUnplannedReplicationRecoveryPlanFailover -InputObject <ISiteRecoveryIdentity>
 -Input <IRecoveryPlanUnplannedFailoverInput> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
...
```
Invoke-AzSiteRecoveryUnplannedReplicationRecoveryPlanFailover -InputObject <ISiteRecoveryIdentity>
 -FailoverDirection <PossibleOperationsDirections> -SourceSiteOperation <SourceSiteOperations>
 [-ProviderSpecificDetail <IRecoveryPlanProviderSpecificFailoverInput[]>] [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IRecoveryPlanUnplannedFailoverInput
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.SourceSiteOperations
Parameter Sets: UnplannedExpanded, UnplannedViaIdentityExpanded
Aliases:
