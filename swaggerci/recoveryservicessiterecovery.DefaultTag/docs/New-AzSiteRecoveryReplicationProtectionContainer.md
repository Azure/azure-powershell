...
online version: https://learn.microsoft.com/powershell/module/az.siterecovery/new-azsiterecoveryreplicationprotectioncontainer
schema: 2.0.0
---

# New-AzSiteRecoveryReplicationProtectionContainer
...
```
New-AzSiteRecoveryReplicationProtectionContainer -FabricName <String> -ProtectionContainerName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IReplicationProviderSpecificContainerCreationInput[]
Parameter Sets: (All)
Aliases:
