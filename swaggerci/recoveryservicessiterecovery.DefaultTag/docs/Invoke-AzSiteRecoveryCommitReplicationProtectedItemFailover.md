...
online version: https://learn.microsoft.com/powershell/module/az.siterecovery/invoke-azsiterecoverycommitreplicationprotecteditemfailover
schema: 2.0.0
---

# Invoke-AzSiteRecoveryCommitReplicationProtectedItemFailover
...
### Commit (Default)
```
Invoke-AzSiteRecoveryCommitReplicationProtectedItemFailover -FabricName <String>
...
### CommitViaIdentity
```
Invoke-AzSiteRecoveryCommitReplicationProtectedItemFailover -InputObject <ISiteRecoveryIdentity>
