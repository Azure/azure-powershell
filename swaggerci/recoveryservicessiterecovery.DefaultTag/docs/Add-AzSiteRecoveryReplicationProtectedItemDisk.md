...
### AddExpanded (Default)
```
Add-AzSiteRecoveryReplicationProtectedItemDisk -FabricName <String> -ProtectionContainerName <String>
...
### AddViaIdentity
```
Add-AzSiteRecoveryReplicationProtectedItemDisk -InputObject <ISiteRecoveryIdentity>
 -AddDisksInput <IAddDisksInput> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IAddDisksInput
...
### Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IAddDisksInput
