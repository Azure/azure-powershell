...
online version: https://learn.microsoft.com/powershell/module/az.siterecovery/move-azsiterecoveryreplicationfabrictoaad
schema: 2.0.0
---

# Move-AzSiteRecoveryReplicationFabricToAad
...
### Migrate (Default)
```
Move-AzSiteRecoveryReplicationFabricToAad -FabricName <String> -ResourceGroupName <String>
...
### MigrateViaIdentity
```
Move-AzSiteRecoveryReplicationFabricToAad -InputObject <ISiteRecoveryIdentity> [-DefaultProfile <PSObject>]
