...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/update-azsiterecoveryreplicationvaulthealth
#>
function Update-AzSiteRecoveryReplicationVaultHealth {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IVaultHealthDetails])]
...
begin {
    try {
        ...
        $mapping = @{
            Refresh = 'Az.SiteRecovery.private\Update-AzSiteRecoveryReplicationVaultHealth_Refresh';
            RefreshViaIdentity = 'Az.SiteRecovery.private\Update-AzSiteRecoveryReplicationVaultHealth_RefreshViaIdentity';
        }
