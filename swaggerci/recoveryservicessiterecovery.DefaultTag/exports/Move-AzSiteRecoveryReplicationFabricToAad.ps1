...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/move-azsiterecoveryreplicationfabrictoaad
#>
function Move-AzSiteRecoveryReplicationFabricToAad {
...
begin {
    try {
        ...
        $mapping = @{
            ...
            MigrateViaIdentity = 'Az.SiteRecovery.private\Move-AzSiteRecoveryReplicationFabricToAad_MigrateViaIdentity';
        }
