...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/get-azsiterecoveryreplicationprotectioncontainer
#>
function Get-AzSiteRecoveryReplicationProtectionContainer {
...
begin {
    try {
        ...
        $mapping = @{
            ...
            GetViaIdentity = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationProtectionContainer_GetViaIdentity';
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationProtectionContainer_List';
            List1 = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationProtectionContainer_List1';
        }
