...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IRecoveryServicesProvider
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/new-azsiterecoveryreplicationrecoveryservicesprovider
#>
function New-AzSiteRecoveryReplicationRecoveryServicesProvider {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IRecoveryServicesProvider])]
