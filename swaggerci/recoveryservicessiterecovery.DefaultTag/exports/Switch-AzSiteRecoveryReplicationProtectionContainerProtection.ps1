...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.ISwitchProtectionInput
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.ISiteRecoveryIdentity
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IProtectionContainer
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/switch-azsiterecoveryreplicationprotectioncontainerprotection
#>
function Switch-AzSiteRecoveryReplicationProtectionContainerProtection {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IProtectionContainer])]
...
begin {
    try {
        ...
        $mapping = @{
            Switch = 'Az.SiteRecovery.private\Switch-AzSiteRecoveryReplicationProtectionContainerProtection_Switch';
            SwitchExpanded = 'Az.SiteRecovery.private\Switch-AzSiteRecoveryReplicationProtectionContainerProtection_SwitchExpanded';
            ...
            SwitchViaIdentityExpanded = 'Az.SiteRecovery.private\Switch-AzSiteRecoveryReplicationProtectionContainerProtection_SwitchViaIdentityExpanded';
        }
