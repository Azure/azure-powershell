...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.ISwitchProviderInput
.Inputs
...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/switch-azsiterecoveryreplicationprotecteditemprovider
#>
