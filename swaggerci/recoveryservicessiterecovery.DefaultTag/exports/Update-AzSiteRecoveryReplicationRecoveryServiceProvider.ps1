...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/update-azsiterecoveryreplicationrecoveryserviceprovider
#>
...
begin {
    try {
        ...
        $mapping = @{
            Refresh = 'Az.SiteRecovery.private\Update-AzSiteRecoveryReplicationRecoveryServiceProvider_Refresh';
            RefreshViaIdentity = 'Az.SiteRecovery.private\Update-AzSiteRecoveryReplicationRecoveryServiceProvider_RefreshViaIdentity';
        }
