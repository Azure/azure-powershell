...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/clear-azsiterecoveryreplicationprotecteditem
#>
function Clear-AzSiteRecoveryReplicationProtectedItem {
...
begin {
    try {
        ...
        $mapping = @{
            Purge = 'Az.SiteRecovery.private\Clear-AzSiteRecoveryReplicationProtectedItem_Purge';
            PurgeViaIdentity = 'Az.SiteRecovery.private\Clear-AzSiteRecoveryReplicationProtectedItem_PurgeViaIdentity';
        }
