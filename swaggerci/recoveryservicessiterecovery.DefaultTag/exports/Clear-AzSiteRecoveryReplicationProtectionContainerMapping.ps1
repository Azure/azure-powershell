...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/clear-azsiterecoveryreplicationprotectioncontainermapping
#>
function Clear-AzSiteRecoveryReplicationProtectionContainerMapping {
...
begin {
    try {
        ...
        $mapping = @{
            Purge = 'Az.SiteRecovery.private\Clear-AzSiteRecoveryReplicationProtectionContainerMapping_Purge';
            PurgeViaIdentity = 'Az.SiteRecovery.private\Clear-AzSiteRecoveryReplicationProtectionContainerMapping_PurgeViaIdentity';
        }
