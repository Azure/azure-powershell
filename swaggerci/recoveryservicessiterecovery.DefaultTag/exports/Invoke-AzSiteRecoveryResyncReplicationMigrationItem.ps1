...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IResyncInput
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.ISiteRecoveryIdentity
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IMigrationItem
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/invoke-azsiterecoveryresyncreplicationmigrationitem
#>
function Invoke-AzSiteRecoveryResyncReplicationMigrationItem {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IMigrationItem])]
...
param(
    ...
    [Parameter(ParameterSetName='ResyncExpanded', Mandatory)]
    ...
    [Parameter(ParameterSetName='ResyncExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Path')]
    ...
    [Parameter(ParameterSetName='ResyncViaIdentityExpanded', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.ISiteRecoveryIdentity]
    # Identity Parameter
    ...
    [Parameter(ParameterSetName='Resync', Mandatory, ValueFromPipeline)]
    [Parameter(ParameterSetName='ResyncViaIdentity', Mandatory, ValueFromPipeline)]
    ...
    [Parameter(ParameterSetName='ResyncExpanded', Mandatory)]
    [Parameter(ParameterSetName='ResyncViaIdentityExpanded', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Body')]
    [System.String]
    # The class type.
...
begin {
    try {
        ...
        $mapping = @{
            Resync = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryResyncReplicationMigrationItem_Resync';
            ResyncExpanded = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryResyncReplicationMigrationItem_ResyncExpanded';
            ResyncViaIdentity = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryResyncReplicationMigrationItem_ResyncViaIdentity';
            ResyncViaIdentityExpanded = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryResyncReplicationMigrationItem_ResyncViaIdentityExpanded';
        }
        if (('Resync', 'ResyncExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
