...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IRecoveryPoint
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/get-azsiterecoverypoint
#>
function Get-AzSiteRecoveryPoint {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IRecoveryPoint])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.SiteRecovery.private\Get-AzSiteRecoveryPoint_Get';
            GetViaIdentity = 'Az.SiteRecovery.private\Get-AzSiteRecoveryPoint_GetViaIdentity';
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryPoint_List';
        }
