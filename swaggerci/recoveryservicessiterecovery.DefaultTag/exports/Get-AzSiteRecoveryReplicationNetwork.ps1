...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/get-azsiterecoveryreplicationnetwork
#>
function Get-AzSiteRecoveryReplicationNetwork {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.INetwork])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationNetwork_Get';
            GetViaIdentity = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationNetwork_GetViaIdentity';
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationNetwork_List';
            List1 = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationNetwork_List1';
        }
