...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/stop-azsiterecoveryreplicationrecoveryplanfailover
#>
function Stop-AzSiteRecoveryReplicationRecoveryPlanFailover {
