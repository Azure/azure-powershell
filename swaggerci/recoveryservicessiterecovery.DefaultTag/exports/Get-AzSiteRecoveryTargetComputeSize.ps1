...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/get-azsiterecoverytargetcomputesize
#>
function Get-AzSiteRecoveryTargetComputeSize {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.ITargetComputeSize])]
