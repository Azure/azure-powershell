...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IReplicationEligibilityResults
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/get-azsiterecoveryreplicationeligibilityresult
#>
function Get-AzSiteRecoveryReplicationEligibilityResult {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IReplicationEligibilityResults])]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationEligibilityResult_List';
        }
