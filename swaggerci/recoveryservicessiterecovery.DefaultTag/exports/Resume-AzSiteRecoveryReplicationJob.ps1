...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/resume-azsiterecoveryreplicationjob
#>
function Resume-AzSiteRecoveryReplicationJob {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IJob])]
