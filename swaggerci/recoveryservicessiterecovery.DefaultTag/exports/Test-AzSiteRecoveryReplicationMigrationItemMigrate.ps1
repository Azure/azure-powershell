...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/test-azsiterecoveryreplicationmigrationitemmigrate
#>
function Test-AzSiteRecoveryReplicationMigrationItemMigrate {
...
begin {
    try {
        ...
        $mapping = @{
            Test = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationMigrationItemMigrate_Test';
            TestExpanded = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationMigrationItemMigrate_TestExpanded';
            TestViaIdentity = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationMigrationItemMigrate_TestViaIdentity';
            TestViaIdentityExpanded = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationMigrationItemMigrate_TestViaIdentityExpanded';
        }
