...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IMigrateInput
.Inputs
...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/move-azsiterecoveryreplicationmigrationitem
#>
function Move-AzSiteRecoveryReplicationMigrationItem {
...
begin {
    try {
        ...
        $mapping = @{
            Migrate = 'Az.SiteRecovery.private\Move-AzSiteRecoveryReplicationMigrationItem_Migrate';
            MigrateExpanded = 'Az.SiteRecovery.private\Move-AzSiteRecoveryReplicationMigrationItem_MigrateExpanded';
            MigrateViaIdentity = 'Az.SiteRecovery.private\Move-AzSiteRecoveryReplicationMigrationItem_MigrateViaIdentity';
            MigrateViaIdentityExpanded = 'Az.SiteRecovery.private\Move-AzSiteRecoveryReplicationMigrationItem_MigrateViaIdentityExpanded';
        }
