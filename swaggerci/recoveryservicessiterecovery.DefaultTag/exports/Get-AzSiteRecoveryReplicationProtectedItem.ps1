...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/get-azsiterecoveryreplicationprotecteditem
#>
function Get-AzSiteRecoveryReplicationProtectedItem {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IReplicationProtectedItem])]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationProtectedItem_List';
            List1 = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationProtectedItem_List1';
        }
