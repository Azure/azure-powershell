...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IApplyRecoveryPointInput
.Inputs
...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/add-azsiterecoveryreplicationprotecteditemrecoverypoint
#>
