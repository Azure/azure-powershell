...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IProtectionContainerMapping
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/update-azsiterecoveryreplicationprotectioncontainermapping
#>
function Update-AzSiteRecoveryReplicationProtectionContainerMapping {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.IProtectionContainerMapping])]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            UpdateViaIdentityExpanded = 'Az.SiteRecovery.private\Update-AzSiteRecoveryReplicationProtectionContainerMapping_UpdateViaIdentityExpanded';
        }
