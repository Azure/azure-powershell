...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/get-azsiterecoveryreplicationnetworkmapping
#>
function Get-AzSiteRecoveryReplicationNetworkMapping {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230201.INetworkMapping])]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            GetViaIdentity = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationNetworkMapping_GetViaIdentity';
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationNetworkMapping_List';
            List1 = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationNetworkMapping_List1';
        }
