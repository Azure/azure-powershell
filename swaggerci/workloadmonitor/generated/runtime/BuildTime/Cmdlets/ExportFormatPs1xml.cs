...
namespace Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Support";
