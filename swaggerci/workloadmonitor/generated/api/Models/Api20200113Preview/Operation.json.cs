...
namespace Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Models.Api20200113Preview
{
    ...
    public partial class Operation
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Models.Api20200113Preview.IOperation.
        /// </summary>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.Json.JsonObject into a new instance of <see cref="Operation" />.
        /// </summary>
        ...
        internal Operation(Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.Json.JsonObject json)
        {
            ...
            {_display = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.Json.JsonObject>("display"), out var __jsonDisplay) ? Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Models.Api20200113Preview.OperationDisplay.FromJson(__jsonDisplay) : Display;}
            {_name = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.Json.JsonString>("name"), out var __jsonName) ? (string)__jsonName : (string)Name;}
            {_origin = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.Json.JsonString>("origin"), out var __jsonOrigin) ? (string)__jsonOrigin : (string)Origin;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Operation" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Operation" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.Json.JsonNode" />.
        /// </returns>
