...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mlteamaccount/get-azmlteamaccountproject
schema: 2.0.0
---

# Get-AzMlTeamAccountProject
...
### List (Default)
```
Get-AzMlTeamAccountProject -AccountName <String> -ResourceGroupName <String> -WorkspaceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzMlTeamAccountProject -AccountName <String> -Name <String> -ResourceGroupName <String>
 -WorkspaceName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMlTeamAccountProject -InputObject <IMlTeamAccountIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
