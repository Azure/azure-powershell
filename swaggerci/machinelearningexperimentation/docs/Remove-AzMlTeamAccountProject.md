...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mlteamaccount/remove-azmlteamaccountproject
schema: 2.0.0
---

# Remove-AzMlTeamAccountProject
...
### Delete (Default)
```
Remove-AzMlTeamAccountProject -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzMlTeamAccountProject -InputObject <IMlTeamAccountIdentity> [-DefaultProfile <PSObject>] [-PassThru]
