...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mlteamaccount/update-azmlteamaccount
schema: 2.0.0
---

# Update-AzMlTeamAccount
...
```
Update-AzMlTeamAccount -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Description <String>] [-FriendlyName <String>] [-Seat <String>] [-StorageAccountKey <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzMlTeamAccount -InputObject <IMlTeamAccountIdentity> [-Description <String>] [-FriendlyName <String>]
 [-Seat <String>] [-StorageAccountKey <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm]
