...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mlteamaccount/update-azmlteamaccountworkspace
schema: 2.0.0
---

# Update-AzMlTeamAccountWorkspace
...
```
Update-AzMlTeamAccountWorkspace -AccountName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzMlTeamAccountWorkspace -InputObject <IMlTeamAccountIdentity> [-Description <String>]
