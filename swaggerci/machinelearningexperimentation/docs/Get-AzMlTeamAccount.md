...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mlteamaccount/get-azmlteamaccount
schema: 2.0.0
---
...
### List1 (Default)
```
Get-AzMlTeamAccount [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzMlTeamAccount -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMlTeamAccount -InputObject <IMlTeamAccountIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### List
```
Get-AzMlTeamAccount -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
