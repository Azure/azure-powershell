...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mlteamaccount/remove-azmlteamaccount
schema: 2.0.0
---

# Remove-AzMlTeamAccount
...
### Delete (Default)
```
Remove-AzMlTeamAccount -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMlTeamAccount -InputObject <IMlTeamAccountIdentity> [-DefaultProfile <PSObject>] [-PassThru]
