...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mlteamaccount/new-azmlteamaccountproject
schema: 2.0.0
---

# New-AzMlTeamAccountProject
...
```
New-AzMlTeamAccountProject -AccountName <String> -Name <String> -ResourceGroupName <String>
 -WorkspaceName <String> -Location <String> [-SubscriptionId <String>] [-Description <String>]
