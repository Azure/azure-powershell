...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricMesh.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricMesh.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricMesh.Support";
