...
online version: https://docs.microsoft.com/en-us/powershell/module/az.servicefabricmesh/remove-azservicefabricmeshgateway
schema: 2.0.0
---

# Remove-AzServiceFabricMeshGateway
...
### Delete (Default)
```
Remove-AzServiceFabricMeshGateway -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzServiceFabricMeshGateway -InputObject <IServiceFabricMeshIdentity> [-DefaultProfile <PSObject>]
