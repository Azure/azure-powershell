...
online version: https://docs.microsoft.com/en-us/powershell/module/az.servicefabricmesh/remove-azservicefabricmeshvolume
schema: 2.0.0
---

# Remove-AzServiceFabricMeshVolume
...
### Delete (Default)
```
Remove-AzServiceFabricMeshVolume -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzServiceFabricMeshVolume -InputObject <IServiceFabricMeshIdentity> [-DefaultProfile <PSObject>]
