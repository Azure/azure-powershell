...
online version: https://docs.microsoft.com/en-us/powershell/module/az.servicefabricmesh/remove-azservicefabricmeshnetwork
schema: 2.0.0
---

# Remove-AzServiceFabricMeshNetwork
...
### Delete (Default)
```
Remove-AzServiceFabricMeshNetwork -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzServiceFabricMeshNetwork -InputObject <IServiceFabricMeshIdentity> [-DefaultProfile <PSObject>]
