...
online version: https://learn.microsoft.com/powershell/module/az.servicefabricmesh/get-azservicefabricmeshservicereplica
schema: 2.0.0
---

# Get-AzServiceFabricMeshServiceReplica
...
### List (Default)
```
Get-AzServiceFabricMeshServiceReplica -ApplicationResourceName <String> -ResourceGroupName <String>
 -ServiceResourceName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzServiceFabricMeshServiceReplica -ApplicationResourceName <String> -ReplicaName <String>
 -ResourceGroupName <String> -ServiceResourceName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzServiceFabricMeshServiceReplica -InputObject <IServiceFabricMeshIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
