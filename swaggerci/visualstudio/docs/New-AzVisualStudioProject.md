...
online version: https://docs.microsoft.com/en-us/powershell/module/az.visualstudio/new-azvisualstudioproject
schema: 2.0.0
---

# New-AzVisualStudioProject
...
```
New-AzVisualStudioProject -ResourceGroupName <String> -ResourceName <String> -RootResourceName <String>
 [-SubscriptionId <String>] [-Validating <String>] [-Location <String>] [-Property <Hashtable>]
