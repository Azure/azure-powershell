...
online version: https://docs.microsoft.com/en-us/powershell/module/az.visualstudio/get-azvisualstudioprojectjobstatus
schema: 2.0.0
---

# Get-AzVisualStudioProjectJobStatus
...
### Get (Default)
```
Get-AzVisualStudioProjectJobStatus -ResourceGroupName <String> -ResourceName <String>
 -RootResourceName <String> -SubContainerName <String> -Operation <String> [-SubscriptionId <String[]>]
 [-JobId <String>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzVisualStudioProjectJobStatus -InputObject <IVisualStudioIdentity> -Operation <String> [-JobId <String>]
