...
online version: https://docs.microsoft.com/en-us/powershell/module/az.visualstudio/remove-azvisualstudioaccount
schema: 2.0.0
---

# Remove-AzVisualStudioAccount
...
### Delete (Default)
```
Remove-AzVisualStudioAccount -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzVisualStudioAccount -InputObject <IVisualStudioIdentity> [-DefaultProfile <PSObject>] [-PassThru]
