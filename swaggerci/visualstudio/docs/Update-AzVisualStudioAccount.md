...
online version: https://docs.microsoft.com/en-us/powershell/module/az.visualstudio/update-azvisualstudioaccount
schema: 2.0.0
---

# Update-AzVisualStudioAccount
...
```
Update-AzVisualStudioAccount -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzVisualStudioAccount -InputObject <IVisualStudioIdentity> [-Tag <Hashtable>]
