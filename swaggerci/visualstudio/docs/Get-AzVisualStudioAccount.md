...
online version: https://docs.microsoft.com/en-us/powershell/module/az.visualstudio/get-azvisualstudioaccount
schema: 2.0.0
---

# Get-AzVisualStudioAccount
...
### List (Default)
```
Get-AzVisualStudioAccount -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzVisualStudioAccount -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzVisualStudioAccount -InputObject <IVisualStudioIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
