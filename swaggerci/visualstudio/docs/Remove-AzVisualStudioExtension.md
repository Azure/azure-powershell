...
online version: https://docs.microsoft.com/en-us/powershell/module/az.visualstudio/remove-azvisualstudioextension
schema: 2.0.0
---

# Remove-AzVisualStudioExtension
...
### Delete (Default)
```
Remove-AzVisualStudioExtension -AccountResourceName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzVisualStudioExtension -InputObject <IVisualStudioIdentity> [-DefaultProfile <PSObject>] [-PassThru]
