...
online version: https://docs.microsoft.com/en-us/powershell/module/az.visualstudio/new-azvisualstudioextension
schema: 2.0.0
---

# New-AzVisualStudioExtension
...
```
New-AzVisualStudioExtension -AccountResourceName <String> -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String>] [-Location <String>] [-PlanName <String>] [-PlanProduct <String>]
 [-PlanPromotionCode <String>] [-PlanPublisher <String>] [-PlanVersion <String>] [-Property <Hashtable>]
