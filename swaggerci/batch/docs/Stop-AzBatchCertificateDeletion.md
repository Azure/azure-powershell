...
### Cancel (Default)
```
Stop-AzBatchCertificateDeletion -AccountName <String> -CertificateName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-AzBatchCertificateDeletion -InputObject <IBatchIdentity> [-DefaultProfile <PSObject>] [-Confirm]
