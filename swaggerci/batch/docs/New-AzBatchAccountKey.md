...
```
New-AzBatchAccountKey -AccountName <String> -ResourceGroupName <String> -KeyName <AccountKeyType>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Regenerate
```
New-AzBatchAccountKey -AccountName <String> -ResourceGroupName <String>
 -Parameter <IBatchAccountRegenerateKeyParameters> [-SubscriptionId <String>] [-DefaultProfile <PSObject>]
...
```
New-AzBatchAccountKey -InputObject <IBatchIdentity> -KeyName <AccountKeyType> [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.AccountKeyType
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api202201.IBatchAccountRegenerateKeyParameters
