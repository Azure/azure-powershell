...
### Delete (Default)
```
Remove-AzBatchApplicationPackage -AccountName <String> -ApplicationName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzBatchApplicationPackage -InputObject <IBatchIdentity> [-DefaultProfile <PSObject>] [-PassThru]
