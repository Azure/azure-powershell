...
online version: https://docs.microsoft.com/en-us/powershell/module/az.batch/sync-azbatchaccountautostoragekey
schema: 2.0.0
---

# Sync-AzBatchAccountAutoStorageKey
...
### Synchronize (Default)
```
Sync-AzBatchAccountAutoStorageKey -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SynchronizeViaIdentity
```
Sync-AzBatchAccountAutoStorageKey -InputObject <IBatchIdentity> [-DefaultProfile <PSObject>] [-PassThru]
