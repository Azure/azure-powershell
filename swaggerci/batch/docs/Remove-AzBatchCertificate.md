...
### Delete (Default)
```
Remove-AzBatchCertificate -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzBatchCertificate -InputObject <IBatchIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
