...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzBatchCertificate_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzBatchCertificate_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzBatchCertificate_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets.RemoveAzBatchCertificate_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzBatchCertificate_DeleteViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.CertificateDeleteViaIdentity(InputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.CertificateDelete(InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.CertificateName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzBatchCertificate_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzBatchCertificate_DeleteViaIdentity()
        {
