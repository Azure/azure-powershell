...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Support
{
        ...
        System.IEquatable<ResourceIdentityType>
    {
        ...
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ResourceIdentityType None = @"None";

        /// <summary>Batch account has a system assigned identity with it.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ResourceIdentityType SystemAssigned = @"SystemAssigned";

        /// <summary>Batch account has user assigned identities with it.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ResourceIdentityType UserAssigned = @"UserAssigned";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ResourceIdentityType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ResourceIdentityType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ResourceIdentityType e1, Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ResourceIdentityType e2)
        {
            return !e2.Equals(e1);
        }
