...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.BillingBenefitsRp.Support.SavingsPlanTerm])]
    [Microsoft.Azure.PowerShell.Cmdlets.BillingBenefitsRp.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.BillingBenefitsRp.Support.SavingsPlanTerm]
