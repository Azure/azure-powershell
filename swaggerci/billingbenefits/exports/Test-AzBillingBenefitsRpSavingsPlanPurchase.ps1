...
BODY <ISavingsPlanPurchaseValidateRequest>: .
  [Benefit <ISavingsPlanOrderAliasModel[]>]: 
    ...
    [Term <SavingsPlanTerm?>]: Represent SavingsPlan term in ISO 8601 format.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.billingbenefitsrp/test-azbillingbenefitsrpsavingsplanpurchase
#>
function Test-AzBillingBenefitsRpSavingsPlanPurchase {
...
begin {
    try {
        ...
        $mapping = @{
            Validate = 'Az.BillingBenefitsRp.private\Test-AzBillingBenefitsRpSavingsPlanPurchase_Validate';
            ValidateExpanded = 'Az.BillingBenefitsRp.private\Test-AzBillingBenefitsRpSavingsPlanPurchase_ValidateExpanded';
        }
