...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.billingbenefitsrp/get-azbillingbenefitsrpsavingsplansinorder
#>
function Get-AzBillingBenefitsRpSavingsPlansInOrder {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.BillingBenefitsRp.private\Get-AzBillingBenefitsRpSavingsPlansInOrder_List';
        }
