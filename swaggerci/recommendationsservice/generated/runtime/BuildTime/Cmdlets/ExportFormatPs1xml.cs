...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecommendationsService.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.RecommendationsService.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.RecommendationsService.Support";
