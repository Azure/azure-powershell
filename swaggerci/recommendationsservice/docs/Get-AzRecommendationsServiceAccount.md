...
online version: https://docs.microsoft.com/en-us/powershell/module/az.recommendationsservice/get-azrecommendationsserviceaccount
schema: 2.0.0
---

# Get-AzRecommendationsServiceAccount
...
### List (Default)
```
Get-AzRecommendationsServiceAccount [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### Get
```
Get-AzRecommendationsServiceAccount -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRecommendationsServiceAccount -InputObject <IRecommendationsServiceIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### List1
```
Get-AzRecommendationsServiceAccount -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
