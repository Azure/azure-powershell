...
online version: https://docs.microsoft.com/en-us/powershell/module/az.recommendationsservice/remove-azrecommendationsservicemodeling
schema: 2.0.0
---

# Remove-AzRecommendationsServiceModeling
...
### Delete (Default)
```
Remove-AzRecommendationsServiceModeling -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzRecommendationsServiceModeling -InputObject <IRecommendationsServiceIdentity>
