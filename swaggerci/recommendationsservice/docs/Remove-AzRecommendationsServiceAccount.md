...
online version: https://docs.microsoft.com/en-us/powershell/module/az.recommendationsservice/remove-azrecommendationsserviceaccount
schema: 2.0.0
---

# Remove-AzRecommendationsServiceAccount
...
### Delete (Default)
```
Remove-AzRecommendationsServiceAccount -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzRecommendationsServiceAccount -InputObject <IRecommendationsServiceIdentity>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
