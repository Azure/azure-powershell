...
.Link
https://learn.microsoft.com/powershell/module/az.healthbot/get-azhealthbotbotsecret
#>
function Get-AzHealthbotBotSecret {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.Healthbot.private\Get-AzHealthbotBotSecret_List';
        }
