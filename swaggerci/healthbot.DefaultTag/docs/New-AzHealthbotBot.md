...
online version: https://learn.microsoft.com/powershell/module/az.healthbot/new-azhealthbotbot
schema: 2.0.0
---
...
New-AzHealthbotBot -Name <String> -ResourceGroupName <String> -Location <String> -SkuName <SkuName>
 ...
 [-KeyVaultPropertyKeyVersion <String>] [-KeyVaultPropertyUserIdentity <String>] [-Tag <Hashtable>]
