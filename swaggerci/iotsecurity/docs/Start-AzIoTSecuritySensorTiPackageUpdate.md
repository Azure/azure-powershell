...
online version: https://docs.microsoft.com/en-us/powershell/module/az.iotsecurity/start-aziotsecuritysensortipackageupdate
schema: 2.0.0
---

# Start-AzIoTSecuritySensorTiPackageUpdate
...
### Trigger (Default)
```
Start-AzIoTSecuritySensorTiPackageUpdate -Scope <String> -SensorName <String> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### TriggerViaIdentity
```
Start-AzIoTSecuritySensorTiPackageUpdate -InputObject <IIoTSecurityIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
