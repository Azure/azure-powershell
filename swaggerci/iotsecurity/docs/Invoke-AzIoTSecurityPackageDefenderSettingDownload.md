...
online version: https://docs.microsoft.com/en-us/powershell/module/az.iotsecurity/invoke-aziotsecuritypackagedefendersettingdownload
schema: 2.0.0
---

# Invoke-AzIoTSecurityPackageDefenderSettingDownload
...
### Package (Default)
```
Invoke-AzIoTSecurityPackageDefenderSettingDownload [-SubscriptionId <String>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PackageViaIdentity
```
Invoke-AzIoTSecurityPackageDefenderSettingDownload -InputObject <IIoTSecurityIdentity>
...
Parameter Sets: PackageViaIdentity
Aliases:
