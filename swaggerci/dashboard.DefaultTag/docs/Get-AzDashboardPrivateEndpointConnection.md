...
online version: https://learn.microsoft.com/powershell/module/az.dashboard/get-azdashboardprivateendpointconnection
schema: 2.0.0
---

# Get-AzDashboardPrivateEndpointConnection
...
### List (Default)
```
Get-AzDashboardPrivateEndpointConnection -ResourceGroupName <String> -WorkspaceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzDashboardPrivateEndpointConnection -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDashboardPrivateEndpointConnection -InputObject <IDashboardIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
