...
namespace Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20180301
{
    ...
    public partial class CanonicalSupportPlanInfoDefinition
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Addons.Runtime.Json.JsonObject into a new instance of <see cref="CanonicalSupportPlanInfoDefinition" />.
        /// </summary>
        ...
        internal CanonicalSupportPlanInfoDefinition(Microsoft.Azure.PowerShell.Cmdlets.Addons.Runtime.Json.JsonObject json)
        {
            ...
            {_supportPlanType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Addons.Runtime.Json.JsonString>("supportPlanType"), out var __jsonSupportPlanType) ? (string)__jsonSupportPlanType : (string)SupportPlanType;}
            {_enabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Addons.Runtime.Json.JsonBoolean>("enabled"), out var __jsonEnabled) ? (bool?)__jsonEnabled : Enabled;}
            {_oneTimeCharge = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Addons.Runtime.Json.JsonString>("oneTimeCharge"), out var __jsonOneTimeCharge) ? (string)__jsonOneTimeCharge : (string)OneTimeCharge;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Addons.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20180301.ICanonicalSupportPlanInfoDefinition.
        /// </summary>
        ...
        /// <summary>
        /// Serializes this instance of <see cref="CanonicalSupportPlanInfoDefinition" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Addons.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CanonicalSupportPlanInfoDefinition" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Addons.Runtime.Json.JsonNode" />.
        /// </returns>
