...
Import-Module -Name (Join-Path $PSScriptRoot './bin/Az.NotificationHubs.private.dll')
$instance = [Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Module]::Instance
