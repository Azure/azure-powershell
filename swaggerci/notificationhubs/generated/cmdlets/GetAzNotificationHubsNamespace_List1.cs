...
namespace Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListAll=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.NotificationHubs/namespaces"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzNotificationHubsNamespace_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Description(@"Lists all the available namespaces within the subscription irrespective of the resourceGroups.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Generated]
    public partial class GetAzNotificationHubsNamespace_List1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzNotificationHubsNamespace_List1" /> cmdlet class.
        /// </summary>
        public GetAzNotificationHubsNamespace_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.NamespacesListAll(SubscriptionId, onOk, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.NamespacesListAll_Call(requestMessage, onOk, this, Pipeline);
                        }
                    }
                }
            }
