...
namespace Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzNotificationHubsNotificationHub_PatchViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzNotificationHubsNotificationHub_PatchViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.INotificationHubPatchParameters _parameter;

        /// <summary>Parameters supplied to the patch NotificationHub operation.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters supplied to the patch NotificationHub operation.", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.INotificationHubPatchParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.INotificationHubPatchParameters Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.NotificationHubsPatchViaIdentity(InputObject.Id, Parameter, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NotificationHubsPatch(InputObject.ResourceGroupName ?? null, InputObject.NamespaceName ?? null, InputObject.NotificationHubName ?? null, InputObject.SubscriptionId ?? null, Parameter, onOk, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzNotificationHubsNotificationHub_PatchViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzNotificationHubsNotificationHub_PatchViaIdentity()
        {
