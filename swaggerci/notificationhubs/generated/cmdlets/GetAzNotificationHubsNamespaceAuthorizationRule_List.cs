...
namespace Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzNotificationHubsNamespaceAuthorizationRule_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Description(@"Gets the authorization rules for a namespace.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Generated]
    public partial class GetAzNotificationHubsNamespaceAuthorizationRule_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzNotificationHubsNamespaceAuthorizationRule_List" /> cmdlet class.
        /// </summary>
        public GetAzNotificationHubsNamespaceAuthorizationRule_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.NamespacesListAuthorizationRules(ResourceGroupName, NamespaceName, SubscriptionId, onOk, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.NamespacesListAuthorizationRules_Call(requestMessage, onOk, this, Pipeline);
                        }
                    }
                }
            }
