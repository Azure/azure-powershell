...
namespace Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Patch=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzNotificationHubsNamespace_PatchViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Description(@"Patches the existing namespace")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Generated]
    public partial class UpdateAzNotificationHubsNamespace_PatchViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.INamespacePatchParameters _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.NamespacePatchParameters();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.INamespacePatchParametersTags Tag { get => _parametersBody.Tag ?? null /* object */; set => _parametersBody.Tag = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NamespacesPatch' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.NamespacesPatchViaIdentity(InputObject.Id, _parametersBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NamespacesPatch(InputObject.ResourceGroupName ?? null, InputObject.NamespaceName ?? null, InputObject.SubscriptionId ?? null, _parametersBody, onOk, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzNotificationHubsNamespace_PatchViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzNotificationHubsNamespace_PatchViaIdentityExpanded()
        {
