...
namespace Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Support";
