...
namespace Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401
{
    ...
    public partial class BaiduCredential
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonObject into a new instance of <see cref="BaiduCredential" />.
        /// </summary>
        ...
        internal BaiduCredential(Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.BaiduCredentialProperties.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.IBaiduCredential.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.IBaiduCredential.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.IBaiduCredential FromJson(Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonObject json ? new BaiduCredential(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="BaiduCredential" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="BaiduCredential" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonNode" />.
        /// </returns>
