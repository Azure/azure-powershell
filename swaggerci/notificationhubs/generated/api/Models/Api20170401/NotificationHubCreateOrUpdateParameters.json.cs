...
namespace Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401
{
    ...
    public partial class NotificationHubCreateOrUpdateParameters
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.INotificationHubCreateOrUpdateParameters.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.INotificationHubCreateOrUpdateParameters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.INotificationHubCreateOrUpdateParameters FromJson(Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonObject json ? new NotificationHubCreateOrUpdateParameters(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonObject into a new instance of <see cref="NotificationHubCreateOrUpdateParameters" />.
        /// </summary>
        ...
        internal NotificationHubCreateOrUpdateParameters(Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonObject json)
        {
            ...
            __resource = new Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.Resource(json);
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.NotificationHubProperties.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="NotificationHubCreateOrUpdateParameters" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="NotificationHubCreateOrUpdateParameters" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._property ? (Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Json.JsonNode) this._property.ToJson(null,serializationMode) : null, "properties" ,container.Add );
