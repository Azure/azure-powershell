...
online version: https://docs.microsoft.com/en-us/powershell/module/az.notificationhubs/get-aznotificationhubsnotificationhub
schema: 2.0.0
---

# Get-AzNotificationHubsNotificationHub
...
### List (Default)
```
Get-AzNotificationHubsNotificationHub -NamespaceName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzNotificationHubsNotificationHub -Name <String> -NamespaceName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzNotificationHubsNotificationHub -InputObject <INotificationHubsIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
