...
### Delete (Default)
```
Remove-AzNotificationHubsNamespaceAuthorizationRule -AuthorizationRuleName <String> -NamespaceName <String>
...
### DeleteViaIdentity
```
Remove-AzNotificationHubsNamespaceAuthorizationRule -InputObject <INotificationHubsIdentity>
