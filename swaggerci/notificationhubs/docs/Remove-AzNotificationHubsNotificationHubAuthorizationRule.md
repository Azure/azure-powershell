...
online version: https://docs.microsoft.com/en-us/powershell/module/az.notificationhubs/remove-aznotificationhubsnotificationhubauthorizationrule
schema: 2.0.0
---

# Remove-AzNotificationHubsNotificationHubAuthorizationRule
...
### Delete (Default)
```
Remove-AzNotificationHubsNotificationHubAuthorizationRule -AuthorizationRuleName <String>
...
### DeleteViaIdentity
```
Remove-AzNotificationHubsNotificationHubAuthorizationRule -InputObject <INotificationHubsIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
