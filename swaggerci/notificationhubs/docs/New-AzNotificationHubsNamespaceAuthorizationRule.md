...
```
New-AzNotificationHubsNamespaceAuthorizationRule -AuthorizationRuleName <String> -NamespaceName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Support.AccessRights[]
Parameter Sets: (All)
Aliases:
