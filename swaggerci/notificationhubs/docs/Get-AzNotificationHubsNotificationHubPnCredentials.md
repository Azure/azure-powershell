...
online version: https://docs.microsoft.com/en-us/powershell/module/az.notificationhubs/get-aznotificationhubsnotificationhubpncredentials
schema: 2.0.0
---

# Get-AzNotificationHubsNotificationHubPnCredentials
...
### Get (Default)
```
Get-AzNotificationHubsNotificationHubPnCredentials -NamespaceName <String> -NotificationHubName <String>
...
### GetViaIdentity
```
Get-AzNotificationHubsNotificationHubPnCredentials -InputObject <INotificationHubsIdentity>
