...
namespace Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.SubscriptionState Deleted = @"Deleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.SubscriptionState Disabled = @"Disabled";

        public static Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.SubscriptionState Enabled = @"Enabled";

        public static Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.SubscriptionState PastDue = @"PastDue";

        public static Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.SubscriptionState Warned = @"Warned";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.SubscriptionState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.SubscriptionState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.SubscriptionState e1, Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.SubscriptionState e2)
        {
            return !e2.Equals(e1);
        }
