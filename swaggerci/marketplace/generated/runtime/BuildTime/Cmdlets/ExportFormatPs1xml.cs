...
namespace Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support";
