...
online version: https://docs.microsoft.com/en-us/powershell/module/az.marketplacerpservice/invoke-azmarketplacerpservicebillingprivatestoreaccount
schema: 2.0.0
---
...
### Billing (Default)
```
Invoke-AzMarketplaceRpServiceBillingPrivateStoreAccount -PrivateStoreId <String> [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### BillingViaIdentity
```
Invoke-AzMarketplaceRpServiceBillingPrivateStoreAccount -InputObject <IMarketplaceRpServiceIdentity>
