...
online version: https://docs.microsoft.com/en-us/powershell/module/az.marketplacerpservice/new-azmarketplacerpserviceprivatestore
schema: 2.0.0
---

# New-AzMarketplaceRpServicePrivateStore
...
```
New-AzMarketplaceRpServicePrivateStore -Id <String> [-Availability <Availability>] [-Branding <Hashtable>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.Availability
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api20220301.IRecipient[]
Parameter Sets: (All)
Aliases:
