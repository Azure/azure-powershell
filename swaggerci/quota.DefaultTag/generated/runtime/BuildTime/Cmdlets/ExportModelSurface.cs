...
namespace Microsoft.Azure.PowerShell.Cmdlets.QuotaExtensionApi.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.QuotaExtensionApi.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.QuotaExtensionApi.Support";
