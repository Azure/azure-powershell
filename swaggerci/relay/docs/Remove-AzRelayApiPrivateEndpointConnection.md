...
online version: https://docs.microsoft.com/en-us/powershell/module/az.relayapi/remove-azrelayapiprivateendpointconnection
schema: 2.0.0
---

# Remove-AzRelayApiPrivateEndpointConnection
...
### Delete (Default)
```
Remove-AzRelayApiPrivateEndpointConnection -Name <String> -NamespaceName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzRelayApiPrivateEndpointConnection -InputObject <IRelayApiIdentity> [-DefaultProfile <PSObject>]
