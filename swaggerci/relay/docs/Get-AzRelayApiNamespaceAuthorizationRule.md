...
online version: https://docs.microsoft.com/en-us/powershell/module/az.relayapi/get-azrelayapinamespaceauthorizationrule
schema: 2.0.0
---

# Get-AzRelayApiNamespaceAuthorizationRule
...
### List (Default)
```
Get-AzRelayApiNamespaceAuthorizationRule -NamespaceName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzRelayApiNamespaceAuthorizationRule -AuthorizationRuleName <String> -NamespaceName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRelayApiNamespaceAuthorizationRule -InputObject <IRelayApiIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
