...
online version: https://docs.microsoft.com/en-us/powershell/module/az.relayapi/get-azrelayapihybridconnectionauthorizationrule
schema: 2.0.0
---

# Get-AzRelayApiHybridConnectionAuthorizationRule
...
### List (Default)
```
Get-AzRelayApiHybridConnectionAuthorizationRule -HybridConnectionName <String> -NamespaceName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzRelayApiHybridConnectionAuthorizationRule -AuthorizationRuleName <String> -HybridConnectionName <String>
...
### GetViaIdentity
```
Get-AzRelayApiHybridConnectionAuthorizationRule -InputObject <IRelayApiIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
