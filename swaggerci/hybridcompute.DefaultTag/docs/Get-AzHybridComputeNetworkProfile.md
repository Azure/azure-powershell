...
online version: https://learn.microsoft.com/powershell/module/az.hybridcompute/get-azhybridcomputenetworkprofile
schema: 2.0.0
---

# Get-AzHybridComputeNetworkProfile
...
### Get (Default)
```
Get-AzHybridComputeNetworkProfile -MachineName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzHybridComputeNetworkProfile -InputObject <IHybridComputeIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
