...
namespace Microsoft.Azure.PowerShell.Cmdlets.QumuloStorage.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.QumuloStorage.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.QumuloStorage.Support";
