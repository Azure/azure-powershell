...
namespace Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Models.Api20210201Preview
{
    ...
    public partial class ResetPasswordInput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Models.Api20210201Preview.IResetPasswordInput.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Models.Api20210201Preview.IResetPasswordInput.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Models.Api20210201Preview.IResetPasswordInput FromJson(Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Runtime.Json.JsonObject json ? new ResetPasswordInput(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Runtime.Json.JsonObject into a new instance of <see cref="ResetPasswordInput" />.
        /// </summary>
        ...
        internal ResetPasswordInput(Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Runtime.Json.JsonObject json)
        {
            ...
            {_applianceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Runtime.Json.JsonString>("applianceId"), out var __jsonApplianceId) ? (string)__jsonApplianceId : (string)ApplianceId;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="ResetPasswordInput" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ResetPasswordInput" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._applianceId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.IoTSecurity.Runtime.Json.JsonString(this._applianceId.ToString()) : null, "applianceId" ,container.Add );
