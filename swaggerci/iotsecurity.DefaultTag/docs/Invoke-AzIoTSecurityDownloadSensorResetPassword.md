...
online version: https://learn.microsoft.com/powershell/module/az.iotsecurity/invoke-aziotsecuritydownloadsensorresetpassword
schema: 2.0.0
---

# Invoke-AzIoTSecurityDownloadSensorResetPassword
...
```
Invoke-AzIoTSecurityDownloadSensorResetPassword -Scope <String> -SensorName <String> -OutFile <String>
 [-ApplianceId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Download
```
Invoke-AzIoTSecurityDownloadSensorResetPassword -Scope <String> -SensorName <String>
...
### DownloadViaIdentity
```
Invoke-AzIoTSecurityDownloadSensorResetPassword -InputObject <IIoTSecurityIdentity>
 -Body <IResetPasswordInput> -OutFile <String> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Invoke-AzIoTSecurityDownloadSensorResetPassword -InputObject <IIoTSecurityIdentity> -OutFile <String>
 [-ApplianceId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
