...
online version: https://learn.microsoft.com/powershell/module/az.iotsecurity/remove-aziotsecuritydevicegroup
schema: 2.0.0
---

# Remove-AzIoTSecurityDeviceGroup
...
### Delete (Default)
```
Remove-AzIoTSecurityDeviceGroup -IotDefenderLocation <String> -Name <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzIoTSecurityDeviceGroup -InputObject <IIoTSecurityIdentity> [-DefaultProfile <PSObject>] [-PassThru]
