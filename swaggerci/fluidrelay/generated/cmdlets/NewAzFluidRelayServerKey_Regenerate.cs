...
namespace Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzFluidRelayServerKey_Regenerate", SupportsShouldProcess = true)]
    ...
    public partial class NewAzFluidRelayServerKey_Regenerate : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20210615Preview.IRegenerateKeyRequest _parameter;

        /// <summary>Specifies which key should be generated.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Specifies which key should be generated.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Specifies which key should be generated.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20210615Preview.IRegenerateKeyRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20210615Preview.IRegenerateKeyRequest Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzFluidRelayServerKey_Regenerate" /> cmdlet class.
        /// </summary>
        public NewAzFluidRelayServerKey_Regenerate()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FluidRelayServersRegenerateKey(SubscriptionId, ResourceGroup, Name, Parameter, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroup=ResourceGroup,Name=Name,body=Parameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroup=ResourceGroup, Name=Name, body=Parameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroup=ResourceGroup, Name=Name, body=Parameter })
                    {
