...
online version: https://docs.microsoft.com/en-us/powershell/module/az.fluidrelay/get-azfluidrelayserverkey
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzFluidRelayServerKey -Name <String> -ResourceGroup <String> [-SubscriptionId <String[]>]
