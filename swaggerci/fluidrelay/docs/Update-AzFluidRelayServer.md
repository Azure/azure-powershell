...
online version: https://docs.microsoft.com/en-us/powershell/module/az.fluidrelay/update-azfluidrelayserver
schema: 2.0.0
---
...
```
Update-AzFluidRelayServer -InputObject <IFluidRelayIdentity> [-IdentityType <ResourceIdentityType>]
