...
namespace Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support
{
        ...
        System.IEquatable<SkuName>
    {
        ...
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.SkuName BatchS1 = @"Batch_S1";

        /// <summary>
        /// Represents the Live S1 SKU name. Using this SKU you can create live pipelines to capture, record, and stream live video
        /// from RTSP-capable cameras at bitrate settings from 0.5 Kbps to 3000 Kbps.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.SkuName LiveS1 = @"Live_S1";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.SkuName e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.SkuName e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.SkuName e1, Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.SkuName e2)
        {
            return !e2.Equals(e1);
        }
