...
namespace Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Models.Api30
{
    ...
    public partial class PrivateLinkResourceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Models.Api30.IPrivateLinkResourceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Models.Api30.IPrivateLinkResourcePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Models.Api30.IPrivateLinkResourcePropertiesInternal.GroupId { get => this._groupId; set { {_groupId = value;} } }

        /// <summary>Internal Acessors for RequiredMember</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Models.Api30.IPrivateLinkResourcePropertiesInternal.RequiredMember { get => this._requiredMember; set { {_requiredMember = value;} } }
