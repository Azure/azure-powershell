...
```
Update-AzStreamAnalyticsTransformation -JobName <String> -ResourceGroupName <String>
 -TransformationName <String> [-SubscriptionId <String>] [-IfMatch <String>] [-Name <String>]
 [-Query <String>] [-StreamingUnit <Int32>] [-ValidStreamingUnit <Int32[]>] [-DefaultProfile <PSObject>]
...
Update-AzStreamAnalyticsTransformation -InputObject <IStreamAnalyticsIdentity> [-IfMatch <String>]
 [-Name <String>] [-Query <String>] [-StreamingUnit <Int32>] [-ValidStreamingUnit <Int32[]>]
