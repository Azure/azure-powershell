...
```
Update-AzStreamAnalyticsInput -InputName <String> -JobName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-IfMatch <String>] [-CompressionType <CompressionType>] [-Name <String>]
...
Update-AzStreamAnalyticsInput -InputObject <IStreamAnalyticsIdentity> [-IfMatch <String>]
 [-CompressionType <CompressionType>] [-Name <String>] [-PartitionKey <String>] [-PropertiesType <String>]
