...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzEventHubConfiguration_Patch", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzEventHubConfiguration_Patch : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202201Preview.IClusterQuotaConfigurationProperties _parameter;

        /// <summary>Contains all settings for the cluster.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Contains all settings for the cluster.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Contains all settings for the cluster.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202201Preview.IClusterQuotaConfigurationProperties) })]
        public Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202201Preview.IClusterQuotaConfigurationProperties Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ConfigurationPatch(SubscriptionId, ResourceGroupName, ClusterName, Parameter, onOk, onCreated, onAccepted, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ClusterName=ClusterName,body=Parameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzEventHubConfiguration_Patch" /> cmdlet class.
        /// </summary>
        public UpdateAzEventHubConfiguration_Patch()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, body=Parameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, body=Parameter })
                    {
