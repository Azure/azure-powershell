...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202201Preview
{
    ...
    public partial class CaptureDescription
    {
        ...
        internal CaptureDescription(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonObject json)
        {
            ...
            {_destination = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonObject>("destination"), out var __jsonDestination) ? Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202201Preview.Destination.FromJson(__jsonDestination) : Destination;}
            {_enabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonBoolean>("enabled"), out var __jsonEnabled) ? (bool?)__jsonEnabled : Enabled;}
            {_encoding = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonString>("encoding"), out var __jsonEncoding) ? (string)__jsonEncoding : (string)Encoding;}
            {_intervalInSecond = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonNumber>("intervalInSeconds"), out var __jsonIntervalInSeconds) ? (int?)__jsonIntervalInSeconds : IntervalInSecond;}
            {_sizeLimitInByte = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonNumber>("sizeLimitInBytes"), out var __jsonSizeLimitInBytes) ? (int?)__jsonSizeLimitInBytes : SizeLimitInByte;}
            {_skipEmptyArchive = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonBoolean>("skipEmptyArchives"), out var __jsonSkipEmptyArchives) ? (bool?)__jsonSkipEmptyArchives : SkipEmptyArchive;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202201Preview.ICaptureDescription.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202201Preview.ICaptureDescription.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202201Preview.ICaptureDescription FromJson(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonNode node)
        {
