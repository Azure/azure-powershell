...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.PrivateLinkConnectionStatus Approved = @"Approved";

        public static Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.PrivateLinkConnectionStatus Disconnected = @"Disconnected";

        public static Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.PrivateLinkConnectionStatus Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.PrivateLinkConnectionStatus Rejected = @"Rejected";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.PrivateLinkConnectionStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.PrivateLinkConnectionStatus e)
        {
            return e._value;
        }
