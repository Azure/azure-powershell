...
online version: https://docs.microsoft.com/en-us/powershell/module/az.eventhub/new-azeventhubschemaregistry
schema: 2.0.0
---

# New-AzEventHubSchemaRegistry
...
```
New-AzEventHubSchemaRegistry -NamespaceName <String> -ResourceGroupName <String> -SchemaGroupName <String>
