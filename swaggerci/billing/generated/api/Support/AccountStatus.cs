...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.AccountStatus Active = @"Active";

        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.AccountStatus Deleted = @"Deleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.AccountStatus Disabled = @"Disabled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.AccountStatus Expired = @"Expired";

        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.AccountStatus Extended = @"Extended";

        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.AccountStatus Terminated = @"Terminated";

        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.AccountStatus Transferred = @"Transferred";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.AccountStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.AccountStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.AccountStatus e1, Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.AccountStatus e2)
        {
            return !e2.Equals(e1);
        }
