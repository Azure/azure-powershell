...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.IHeaderSerializable
    {
        ...
        /// <summary>
        /// Creates an new <see cref="InvoicesDownloadBillingSubscriptionInvoiceAcceptedResponseHeaders" /> instance.
        /// </summary>
        public InvoicesDownloadBillingSubscriptionInvoiceAcceptedResponseHeaders()
        {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IInvoicesDownloadBillingSubscriptionInvoiceAcceptedResponseHeadersInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader0) is string __headerLocationHeader0 ? __headerLocationHeader0 : (string)null;
            }
            if (headers.TryGetValues("Retry-After", out var __retryAfterHeader1))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IInvoicesDownloadBillingSubscriptionInvoiceAcceptedResponseHeadersInternal)this).RetryAfter = System.Linq.Enumerable.FirstOrDefault(__retryAfterHeader1) is string __headerRetryAfterHeader1 ? __headerRetryAfterHeader1 : (string)null;
            }
        }
    }
    ...
    internal partial interface IInvoicesDownloadBillingSubscriptionInvoiceAcceptedResponseHeadersInternal
