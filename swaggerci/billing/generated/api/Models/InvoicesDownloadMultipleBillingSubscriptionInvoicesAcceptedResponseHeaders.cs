...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models
{
    ...
    public partial class InvoicesDownloadMultipleBillingSubscriptionInvoicesAcceptedResponseHeaders :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IInvoicesDownloadMultipleBillingSubscriptionInvoicesAcceptedResponseHeadersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.IHeaderSerializable
    {
        ...
        /// <summary>
        /// Creates an new <see cref="InvoicesDownloadMultipleBillingSubscriptionInvoicesAcceptedResponseHeaders" /> instance.
        /// </summary>
        public InvoicesDownloadMultipleBillingSubscriptionInvoicesAcceptedResponseHeaders()
        {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IInvoicesDownloadMultipleBillingSubscriptionInvoicesAcceptedResponseHeadersInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader0) is string __headerLocationHeader0 ? __headerLocationHeader0 : (string)null;
            }
            if (headers.TryGetValues("Retry-After", out var __retryAfterHeader1))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IInvoicesDownloadMultipleBillingSubscriptionInvoicesAcceptedResponseHeadersInternal)this).RetryAfter = System.Linq.Enumerable.FirstOrDefault(__retryAfterHeader1) is string __headerRetryAfterHeader1 ? __headerRetryAfterHeader1 : (string)null;
            }
        }
    }
    ...
    internal partial interface IInvoicesDownloadMultipleBillingSubscriptionInvoicesAcceptedResponseHeadersInternal
