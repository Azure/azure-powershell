...
online version: https://docs.microsoft.com/en-us/powershell/module/az.billing/invoke-azbillingdownloadinvoice
schema: 2.0.0
---

# Invoke-AzBillingDownloadInvoice
...
### Download (Default)
```
Invoke-AzBillingDownloadInvoice -BillingAccountName <String> -InvoiceName <String> -DownloadToken <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DownloadViaIdentity
```
Invoke-AzBillingDownloadInvoice -InputObject <IBillingIdentity> -DownloadToken <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
