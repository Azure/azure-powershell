...
namespace Microsoft.Azure.PowerShell.Cmdlets.AceProvisioningPartnerApi.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.AceProvisioningPartnerApi.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.AceProvisioningPartnerApi.Support";
