...
using static Microsoft.Azure.PowerShell.Cmdlets.AceProvisioningPartnerApi.Runtime.PowerShell.PsHelpers;

namespace Microsoft.Azure.PowerShell.Cmdlets.AceProvisioningPartnerApi.Runtime.PowerShell
{
    ...
    public class ExportPsd1 : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                sb.AppendLine($@"{Indent}RootModule = '{"./Az.AceProvisioningPartnerApi.psm1"}'");
                ...
                sb.AppendLine($@"{Indent}Description = '{"Microsoft Azure PowerShell: AceProvisioningPartnerApi cmdlets"}'");
                ...
                {
                    sb.AppendLine($@"{Indent}RequiredAssemblies = '{"./bin/Az.AceProvisioningPartnerApi.private.dll"}'");
                }
                ...
                else
                {
                    ...
                    var formatList = customFormatPs1xmlFiles.Prepend("./Az.AceProvisioningPartnerApi.format.ps1xml").ToPsList();
                ...
                sb.AppendLine($@"{Indent}{Indent}{Indent}Tags = {"Azure ResourceManager ARM PSModule AceProvisioningPartnerApi".Split(' ').ToPsList().NullIfEmpty() ?? "''"}");
