...
namespace Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview
{
    ...
    public partial class TestSummaryProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.ITestSummaryProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.ITestSummaryProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.ITestSummaryProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonObject json ? new TestSummaryProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonObject into a new instance of <see cref="TestSummaryProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal TestSummaryProperties(Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonObject json)
        {
            ...
            {_featureUpdatesTestSummary = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonObject>("featureUpdatesTestSummary"), out var __jsonFeatureUpdatesTestSummary) ? Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.OSUpdatesTestSummary.FromJson(__jsonFeatureUpdatesTestSummary) : FeatureUpdatesTestSummary;}
            {_securityUpdatesTestSummary = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonObject>("securityUpdatesTestSummary"), out var __jsonSecurityUpdatesTestSummary) ? Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.OSUpdatesTestSummary.FromJson(__jsonSecurityUpdatesTestSummary) : SecurityUpdatesTestSummary;}
            {_testSummaryId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonString>("testSummaryId"), out var __jsonTestSummaryId) ? (string)__jsonTestSummaryId : (string)TestSummaryId;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="TestSummaryProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="TestSummaryProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._featureUpdatesTestSummary ? (Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonNode) this._featureUpdatesTestSummary.ToJson(null,serializationMode) : null, "featureUpdatesTestSummary" ,container.Add );
            AddIf( null != this._securityUpdatesTestSummary ? (Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonNode) this._securityUpdatesTestSummary.ToJson(null,serializationMode) : null, "securityUpdatesTestSummary" ,container.Add );
            AddIf( null != (((object)this._testSummaryId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonString(this._testSummaryId.ToString()) : null, "testSummaryId" ,container.Add );
