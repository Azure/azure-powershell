...
namespace Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview
{
    ...
    /// <summary>The usage data of a Test Base Account.</summary>
    public partial class TestBaseAccountUsageData :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.ITestBaseAccountUsageDataInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.ITestBaseAccountUsageName Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.ITestBaseAccountUsageDataInternal.Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.TestBaseAccountUsageName()); set { {_name = value;} } }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.ITestBaseAccountUsageName _name;

        /// <summary>Localizable String object containing the name and a localized value.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.TestBase.Origin(Microsoft.Azure.PowerShell.Cmdlets.TestBase.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.ITestBaseAccountUsageName Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.TestBaseAccountUsageName()); set => this._name = value; }
        ...
        public string NameLocalizedValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.ITestBaseAccountUsageNameInternal)Name).LocalizedValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.ITestBaseAccountUsageNameInternal)Name).LocalizedValue = value ?? null; }

        /// <summary>The identifier of the usage.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.TestBase.Origin(Microsoft.Azure.PowerShell.Cmdlets.TestBase.PropertyOrigin.Inlined)]
        public string NameValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.ITestBaseAccountUsageNameInternal)Name).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.ITestBaseAccountUsageNameInternal)Name).Value = value ?? null; }
        ...
        /// <summary>Creates an new <see cref="TestBaseAccountUsageData" /> instance.</summary>
    ...
    public partial interface ITestBaseAccountUsageData :
    ...
    /// The usage data of a Test Base Account.
    internal partial interface ITestBaseAccountUsageDataInternal

    {
        ...
        long? Limit { get; set; }
        /// <summary>Localizable String object containing the name and a localized value.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.ITestBaseAccountUsageName Name { get; set; }
        /// <summary>Localized name of the usage.</summary>
        string NameLocalizedValue { get; set; }
        /// <summary>The identifier of the usage.</summary>
        string NameValue { get; set; }
