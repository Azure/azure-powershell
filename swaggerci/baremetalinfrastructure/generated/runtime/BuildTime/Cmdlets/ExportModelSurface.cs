...
namespace Microsoft.Azure.PowerShell.Cmdlets.BareMetalInfrastructure.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.BareMetalInfrastructure.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.BareMetalInfrastructure.Support";
