...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwarecloudsimple/get-azvmwarecloudsimpleresourcepool
schema: 2.0.0
---

# Get-AzVMwareCloudSimpleResourcePool
...
### List (Default)
```
Get-AzVMwareCloudSimpleResourcePool -PcName <String> -RegionId <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzVMwareCloudSimpleResourcePool -Name <String> -PcName <String> -RegionId <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzVMwareCloudSimpleResourcePool -InputObject <IVMwareCloudSimpleIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
