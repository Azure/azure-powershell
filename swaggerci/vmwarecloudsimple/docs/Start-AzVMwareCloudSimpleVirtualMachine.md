...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwarecloudsimple/start-azvmwarecloudsimplevirtualmachine
schema: 2.0.0
---

# Start-AzVMwareCloudSimpleVirtualMachine
...
### Start (Default)
```
Start-AzVMwareCloudSimpleVirtualMachine -Name <String> -ResourceGroupName <String> -Referer <String>
...
### StartViaIdentity
```
Start-AzVMwareCloudSimpleVirtualMachine -InputObject <IVMwareCloudSimpleIdentity> -Referer <String>
