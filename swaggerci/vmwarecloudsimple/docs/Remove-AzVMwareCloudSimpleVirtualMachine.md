...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwarecloudsimple/remove-azvmwarecloudsimplevirtualmachine
schema: 2.0.0
---

# Remove-AzVMwareCloudSimpleVirtualMachine
...
### Delete (Default)
```
Remove-AzVMwareCloudSimpleVirtualMachine -Name <String> -ResourceGroupName <String> -Referer <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareCloudSimpleVirtualMachine -InputObject <IVMwareCloudSimpleIdentity> -Referer <String>
