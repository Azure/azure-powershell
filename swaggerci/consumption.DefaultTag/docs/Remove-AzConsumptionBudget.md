...
online version: https://learn.microsoft.com/powershell/module/az.consumption/remove-azconsumptionbudget
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzConsumptionBudget -Name <String> -Scope <String> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzConsumptionBudget -InputObject <IConsumptionIdentity> [-DefaultProfile <PSObject>] [-PassThru]
