...
online version: https://learn.microsoft.com/powershell/module/az.consumption/get-azconsumptiontag
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzConsumptionTag -Scope <String> [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzConsumptionTag -InputObject <IConsumptionIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
