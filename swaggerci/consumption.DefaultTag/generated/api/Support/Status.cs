...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Consumption.Support.Status Active = @"Active";

        public static Microsoft.Azure.PowerShell.Cmdlets.Consumption.Support.Status Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Consumption.Support.Status Complete = @"Complete";

        public static Microsoft.Azure.PowerShell.Cmdlets.Consumption.Support.Status Expired = @"Expired";

        public static Microsoft.Azure.PowerShell.Cmdlets.Consumption.Support.Status Inactive = @"Inactive";

        public static Microsoft.Azure.PowerShell.Cmdlets.Consumption.Support.Status None = @"None";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.Consumption.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
