...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITagsResultInternal.NextLink { get => ((Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITagPropertiesInternal)Property).NextLink; set => ((Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITagPropertiesInternal)Property).NextLink = value; }

        /// <summary>Internal Acessors for PreviousLink</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITagsResultInternal.PreviousLink { get => ((Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITagPropertiesInternal)Property).PreviousLink; set => ((Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITagPropertiesInternal)Property).PreviousLink = value; }

        /// <summary>Internal Acessors for Property</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITagProperties Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITagsResultInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.TagProperties()); set { {_property = value;} } }
        ...
        public string NextLink { get => ((Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITagPropertiesInternal)Property).NextLink; }

        /// <summary>The link (url) to the previous page of results.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Consumption.Origin(Microsoft.Azure.PowerShell.Cmdlets.Consumption.PropertyOrigin.Inlined)]
        public string PreviousLink { get => ((Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITagPropertiesInternal)Property).PreviousLink; }

        /// <summary>Backing field for <see cref="Property" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITagProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITagProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.TagProperties()); set => this._property = value; }

        /// <summary>A list of Tag.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Consumption.Origin(Microsoft.Azure.PowerShell.Cmdlets.Consumption.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITag[] Tag { get => ((Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITagPropertiesInternal)Property).Tag; set => ((Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITagPropertiesInternal)Property).Tag = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.IProxyResource
    {
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITag) })]
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITag[] Tag { get; set; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.IProxyResourceInternal
    {
        ...
        /// <summary>The properties of the tag.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITagProperties Property { get; set; }
        /// <summary>A list of Tag.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.ITag[] Tag { get; set; }
