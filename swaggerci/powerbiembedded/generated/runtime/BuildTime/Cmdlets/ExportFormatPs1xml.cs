...
namespace Microsoft.Azure.PowerShell.Cmdlets.PowerBiEmbedded.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.PowerBiEmbedded.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.PowerBiEmbedded.Support";
