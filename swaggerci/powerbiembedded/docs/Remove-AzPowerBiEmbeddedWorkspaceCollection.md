...
online version: https://docs.microsoft.com/en-us/powershell/module/az.powerbiembedded/remove-azpowerbiembeddedworkspacecollection
schema: 2.0.0
---

# Remove-AzPowerBiEmbeddedWorkspaceCollection
...
### Delete (Default)
```
Remove-AzPowerBiEmbeddedWorkspaceCollection -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzPowerBiEmbeddedWorkspaceCollection -InputObject <IPowerBiEmbeddedIdentity>
