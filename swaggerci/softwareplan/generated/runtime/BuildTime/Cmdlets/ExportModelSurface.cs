...
namespace Microsoft.Azure.PowerShell.Cmdlets.SoftwarePlanRp.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.SoftwarePlanRp.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.SoftwarePlanRp.Support";
