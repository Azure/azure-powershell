...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ConnectionStatus Connected = @"Connected";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ConnectionStatus Degraded = @"Degraded";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ConnectionStatus Disconnected = @"Disconnected";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ConnectionStatus Unknown = @"Unknown";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ConnectionStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ConnectionStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ConnectionStatus e1, Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ConnectionStatus e2)
        {
            return !e2.Equals(e1);
        }
