...
namespace Microsoft.Azure.PowerShell.Cmdlets.Vi.Support
{
    ...
    /// <summary>
    /// Gets the reason that a Video Indexer account name could not be used. The Reason element is only returned if NameAvailable
    /// is false.
    /// </summary>
    public partial struct Reason :
        System.IEquatable<Reason>
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Vi.Support.Reason AlreadyExists = @"AlreadyExists";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Vi.Support.Reason e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Vi.Support.Reason e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Vi.Support.Reason e1, Microsoft.Azure.PowerShell.Cmdlets.Vi.Support.Reason e2)
        {
            return !e2.Equals(e1);
        }
