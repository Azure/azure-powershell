...
online version: https://learn.microsoft.com/powershell/module/az.billingbenefitsrp/get-azbillingbenefitsrpsavingsplanorder
schema: 2.0.0
---

# Get-AzBillingBenefitsRpSavingsPlanOrder
...
### List (Default)
```
Get-AzBillingBenefitsRpSavingsPlanOrder [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzBillingBenefitsRpSavingsPlanOrder -Id <String> [-Expand <String>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzBillingBenefitsRpSavingsPlanOrder -InputObject <IBillingBenefitsRpIdentity> [-Expand <String>]
