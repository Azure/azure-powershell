...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models
{
    ...
    public partial class BackendGetEntityTagOkResponseHeaders :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IBackendGetEntityTagOkResponseHeaders,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        /// <summary>Creates an new <see cref="BackendGetEntityTagOkResponseHeaders" /> instance.</summary>
        public BackendGetEntityTagOkResponseHeaders()
        {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IBackendGetEntityTagOkResponseHeadersInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
    }
    public partial interface IBackendGetEntityTagOkResponseHeaders
    ...
    internal partial interface IBackendGetEntityTagOkResponseHeadersInternal
