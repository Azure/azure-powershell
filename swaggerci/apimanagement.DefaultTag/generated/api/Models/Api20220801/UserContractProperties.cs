...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801
{
    ...
    public partial class UserContractProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IUserContractProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IUserContractPropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IUserEntityBaseParameters"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IUserEntityBaseParameters __userEntityBaseParameters = new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.UserEntityBaseParameters();
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IGroupContractProperties[] _group;

        /// <summary>Collection of groups user is part of.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IGroupContractProperties[] Group { get => this._group; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IUserIdentityContract[] Identity { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IUserEntityBaseParametersInternal)__userEntityBaseParameters).Identity; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IUserEntityBaseParametersInternal)__userEntityBaseParameters).Identity = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IGroupContractProperties[] Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IUserContractPropertiesInternal.Group { get => this._group; set { {_group = value;} } }

        /// <summary>Optional note about a user set by the administrator.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inherited)]
        public string Note { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IUserEntityBaseParametersInternal)__userEntityBaseParameters).Note; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IUserEntityBaseParametersInternal)__userEntityBaseParameters).Note = value ?? null; }
    ...
    public partial interface IUserContractProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IUserEntityBaseParameters
    {
        /// <summary>Email address.</summary>
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IGroupContractProperties) })]
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IGroupContractProperties[] Group { get;  }
        /// <summary>Last name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    internal partial interface IUserContractPropertiesInternal :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IUserEntityBaseParametersInternal
    {
        /// <summary>Email address.</summary>
        string Email { get; set; }
        /// <summary>First name.</summary>
        string FirstName { get; set; }
        /// <summary>Collection of groups user is part of.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IGroupContractProperties[] Group { get; set; }
        /// <summary>Last name.</summary>
        string LastName { get; set; }
        /// <summary>
        /// Date of user registration. The date conforms to the following format: `yyyy-MM-ddTHH:mm:ssZ` as specified by the ISO 8601
