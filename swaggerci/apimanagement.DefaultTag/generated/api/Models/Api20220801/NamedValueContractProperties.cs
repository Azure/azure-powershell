...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801
{
    ...
    public partial class NamedValueContractProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.INamedValueContractProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.INamedValueContractPropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.INamedValueEntityBaseParameters"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.INamedValueEntityBaseParameters __namedValueEntityBaseParameters = new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.NamedValueEntityBaseParameters();
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IKeyVaultContractProperties _keyVault;

        /// <summary>KeyVault location details of the namedValue.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IKeyVaultContractProperties KeyVault { get => (this._keyVault = this._keyVault ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.KeyVaultContractProperties()); set => this._keyVault = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string KeyVaultSecretIdentifier { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IKeyVaultContractCreatePropertiesInternal)KeyVault).SecretIdentifier; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IKeyVaultContractCreatePropertiesInternal)KeyVault).SecretIdentifier = value ?? null; }

        /// <summary>Last status code for sync and refresh of secret from key vault.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string LastStatusCode { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IKeyVaultContractPropertiesInternal)KeyVault).LastStatusCode; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IKeyVaultContractPropertiesInternal)KeyVault).LastStatusCode = value ?? null; }

        /// <summary>Details of the error else empty.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string LastStatusMessage { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IKeyVaultContractPropertiesInternal)KeyVault).LastStatusMessage; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IKeyVaultContractPropertiesInternal)KeyVault).LastStatusMessage = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IKeyVaultContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.INamedValueContractPropertiesInternal.KeyVault { get => (this._keyVault = this._keyVault ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.KeyVaultContractProperties()); set { {_keyVault = value;} } }

        /// <summary>Internal Acessors for KeyVaultLastStatus</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IKeyVaultLastAccessStatusContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.INamedValueContractPropertiesInternal.KeyVaultLastStatus { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IKeyVaultContractPropertiesInternal)KeyVault).LastStatus; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IKeyVaultContractPropertiesInternal)KeyVault).LastStatus = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.INamedValueEntityBaseParametersInternal
    {
        ...
        string DisplayName { get; set; }
        /// <summary>KeyVault location details of the namedValue.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IKeyVaultContractProperties KeyVault { get; set; }
        /// <summary>
        /// Null for SystemAssignedIdentity or Client Id for UserAssignedIdentity , which will be used to access key vault secret.
        /// </summary>
        string KeyVaultIdentityClientId { get; set; }
        /// <summary>Last time sync and refresh status of secret from key vault.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IKeyVaultLastAccessStatusContractProperties KeyVaultLastStatus { get; set; }
        /// <summary>
        /// Key vault secret identifier for fetching secret. Providing a versioned secret will prevent auto-refresh. This requires
        /// API Management service to be configured with aka.ms/apimmsi
        /// </summary>
