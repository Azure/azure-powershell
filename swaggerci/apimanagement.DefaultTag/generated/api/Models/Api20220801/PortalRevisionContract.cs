...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801
{
    ...
    public partial class PortalRevisionContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IPortalRevisionContract,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public global::System.DateTime? CreatedDateTime { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IPortalRevisionContractPropertiesInternal)Property).CreatedDateTime; }

        /// <summary>Portal revision description.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Description { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IPortalRevisionContractPropertiesInternal)Property).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IPortalRevisionContractPropertiesInternal)Property).Description = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public bool? IsCurrent { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IPortalRevisionContractPropertiesInternal)Property).IsCurrent; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IPortalRevisionContractPropertiesInternal)Property).IsCurrent = value ?? default(bool); }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IPortalRevisionContractProperties _property;

        /// <summary>Properties of the portal revisions.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IPortalRevisionContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.PortalRevisionContractProperties()); set => this._property = value; }

        /// <summary>Status of the portal's revision.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Support.PortalRevisionStatus? Status { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IPortalRevisionContractPropertiesInternal)Property).Status; }

        /// <summary>Portal revision publishing status details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string StatusDetail { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IPortalRevisionContractPropertiesInternal)Property).StatusDetail; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public global::System.DateTime? UpdatedDateTime { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IPortalRevisionContractPropertiesInternal)Property).UpdatedDateTime; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IPortalRevisionContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        bool? IsCurrent { get; set; }
        /// <summary>Properties of the portal revisions.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IPortalRevisionContractProperties Property { get; set; }
        /// <summary>Status of the portal's revision.</summary>
