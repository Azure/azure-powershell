...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801
{
    ...
    public partial class ApiManagementSkuRestrictionInfo :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IApiManagementSkuRestrictionInfo,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IApiManagementSkuRestrictionInfoInternal
    {
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IApiManagementSkuRestrictionInfoInternal.Location { get => this._location; set { {_location = value;} } }

        /// <summary>Internal Acessors for Zone</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220801.IApiManagementSkuRestrictionInfoInternal.Zone { get => this._zone; set { {_zone = value;} } }
