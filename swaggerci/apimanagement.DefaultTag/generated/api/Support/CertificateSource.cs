...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.CertificateSource BuiltIn = @"BuiltIn";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.CertificateSource Custom = @"Custom";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.CertificateSource KeyVault = @"KeyVault";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.CertificateSource Managed = @"Managed";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Api.Support.CertificateSource e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Api.Support.CertificateSource e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Api.Support.CertificateSource e1, Microsoft.Azure.PowerShell.Cmdlets.Api.Support.CertificateSource e2)
        {
            return !e2.Equals(e1);
        }
