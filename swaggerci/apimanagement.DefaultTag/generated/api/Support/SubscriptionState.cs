...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.SubscriptionState Active = @"active";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.SubscriptionState Cancelled = @"cancelled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.SubscriptionState Expired = @"expired";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.SubscriptionState Rejected = @"rejected";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.SubscriptionState Submitted = @"submitted";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.SubscriptionState Suspended = @"suspended";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Api.Support.SubscriptionState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Api.Support.SubscriptionState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Api.Support.SubscriptionState e1, Microsoft.Azure.PowerShell.Cmdlets.Api.Support.SubscriptionState e2)
        {
            return !e2.Equals(e1);
        }
