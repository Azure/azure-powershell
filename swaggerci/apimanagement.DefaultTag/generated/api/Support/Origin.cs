...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.Origin Inbound = @"Inbound";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.Origin Local = @"Local";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.Origin Outbound = @"Outbound";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Api.Support.Origin e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Api.Support.Origin e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Api.Support.Origin e1, Microsoft.Azure.PowerShell.Cmdlets.Api.Support.Origin e2)
        {
            return !e2.Equals(e1);
        }
