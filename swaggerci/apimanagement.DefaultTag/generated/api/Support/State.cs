...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Support
{
        ...
        System.IEquatable<State>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.State Closed = @"closed";

        /// <summary>The issue is opened.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.State Open = @"open";

        /// <summary>The issue is proposed.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.State Proposed = @"proposed";

        /// <summary>The issue was removed.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.State Removed = @"removed";

        /// <summary>The issue is now resolved.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.State Resolved = @"resolved";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Api.Support.State e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Api.Support.State e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Api.Support.State e1, Microsoft.Azure.PowerShell.Cmdlets.Api.Support.State e2)
        {
            return !e2.Equals(e1);
        }
