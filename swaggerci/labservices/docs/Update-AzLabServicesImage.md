...
online version: https://docs.microsoft.com/en-us/powershell/module/az.labservices/update-azlabservicesimage
schema: 2.0.0
---

# Update-AzLabServicesImage
...
```
Update-AzLabServicesImage -LabPlanName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzLabServicesImage -InputObject <ILabServicesIdentity> [-EnabledState <EnableState>]
