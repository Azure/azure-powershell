...
online version: https://docs.microsoft.com/en-us/powershell/module/az.labservices/new-azlabservicesimage
schema: 2.0.0
---

# New-AzLabServicesImage
...
```
New-AzLabServicesImage -LabPlanName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-AvailableRegion <String[]>] [-EnabledState <EnableState>]
