...
online version: https://docs.microsoft.com/en-us/powershell/module/az.labservices/start-azlabservicesvirtualmachine
schema: 2.0.0
---

# Start-AzLabServicesVirtualMachine
...
### Start (Default)
```
Start-AzLabServicesVirtualMachine -LabName <String> -Name <String> -ResourceGroupName <String>
...
### StartViaIdentity
```
Start-AzLabServicesVirtualMachine -InputObject <ILabServicesIdentity> [-DefaultProfile <PSObject>] [-AsJob]
