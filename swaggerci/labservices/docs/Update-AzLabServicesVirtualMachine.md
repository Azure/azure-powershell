...
online version: https://docs.microsoft.com/en-us/powershell/module/az.labservices/update-azlabservicesvirtualmachine
schema: 2.0.0
---

# Update-AzLabServicesVirtualMachine
...
### Reimage (Default)
```
Update-AzLabServicesVirtualMachine -LabName <String> -Name <String> -ResourceGroupName <String>
...
### ReimageViaIdentity
```
Update-AzLabServicesVirtualMachine -InputObject <ILabServicesIdentity> [-DefaultProfile <PSObject>] [-AsJob]
