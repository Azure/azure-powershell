...
namespace Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview
{
    ...
    public partial class UserProperties :
        Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.IUserProperties,
        Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.IUserPropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.IUserUpdateProperties"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.IUserUpdateProperties __userUpdateProperties = new Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.UserUpdateProperties();
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.IUserPropertiesInternal.DisplayName { get => this._displayName; set { {_displayName = value;} } }

        /// <summary>Internal Acessors for InvitationSent</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.IUserPropertiesInternal.InvitationSent { get => this._invitationSent; set { {_invitationSent = value;} } }

        /// <summary>Internal Acessors for InvitationState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.LabServices.Support.InvitationState? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.IUserPropertiesInternal.InvitationState { get => this._invitationState; set { {_invitationState = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.LabServices.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.IUserPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for RegistrationState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.LabServices.Support.RegistrationState? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.IUserPropertiesInternal.RegistrationState { get => this._registrationState; set { {_registrationState = value;} } }

        /// <summary>Internal Acessors for TotalUsage</summary>
        global::System.TimeSpan? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.IUserPropertiesInternal.TotalUsage { get => this._totalUsage; set { {_totalUsage = value;} } }
    ...
    public partial interface IUserProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.IUserUpdateProperties
    {
        /// <summary>Display name of the user, for example user's full name.</summary>
