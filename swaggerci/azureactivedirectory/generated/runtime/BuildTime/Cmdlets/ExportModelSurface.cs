...
namespace Microsoft.Azure.PowerShell.Cmdlets.Activedirectory.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.Activedirectory.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.Activedirectory.Support";
