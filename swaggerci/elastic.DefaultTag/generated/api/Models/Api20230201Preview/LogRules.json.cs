...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20230201Preview
{
    ...
    public partial class LogRules
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20230201Preview.ILogRules.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20230201Preview.ILogRules.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20230201Preview.ILogRules FromJson(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject json ? new LogRules(json) : null;
        }
        ...
        internal LogRules(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject json)
        {
            ...
            {_filteringTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonArray>("filteringTags"), out var __jsonFilteringTags) ? If( __jsonFilteringTags as Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20230201Preview.IFilteringTag[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20230201Preview.IFilteringTag) (Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20230201Preview.FilteringTag.FromJson(__u) )) ))() : null : FilteringTag;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="LogRules" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="LogRules" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._sendAadLog ? (Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonBoolean((bool)this._sendAadLog) : null, "sendAadLogs" ,container.Add );
            AddIf( null != this._sendSubscriptionLog ? (Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonBoolean((bool)this._sendSubscriptionLog) : null, "sendSubscriptionLogs" ,container.Add );
            AddIf( null != this._sendActivityLog ? (Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonBoolean((bool)this._sendActivityLog) : null, "sendActivityLogs" ,container.Add );
