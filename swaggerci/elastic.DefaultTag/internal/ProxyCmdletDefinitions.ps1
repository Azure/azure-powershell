...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20230201Preview.IOperationResult
.Link
https://learn.microsoft.com/powershell/module/az.elastic/get-azelasticoperation
#>
function Get-AzElasticOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20230201Preview.IOperationResult])]
