...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20230201Preview.IElasticMonitorResource], [System.Boolean])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20230201Preview.IElasticMonitorResourceUpdateParametersTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            UpgradeViaIdentityExpanded = 'Az.Elastic.private\Update-AzElasticMonitor_UpgradeViaIdentityExpanded';
        }
