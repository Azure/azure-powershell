...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/remove-azappplatformapiportalcustomdomain
schema: 2.0.0
---

# Remove-AzAppPlatformApiPortalCustomDomain
...
### Delete (Default)
```
Remove-AzAppPlatformApiPortalCustomDomain -ApiPortalName <String> -DomainName <String>
...
### DeleteViaIdentity
```
Remove-AzAppPlatformApiPortalCustomDomain -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
