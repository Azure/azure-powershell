...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/restart-azappplatformgateway
schema: 2.0.0
---

# Restart-AzAppPlatformGateway
...
### Restart (Default)
```
Restart-AzAppPlatformGateway -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
### RestartViaIdentity
```
Restart-AzAppPlatformGateway -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>] [-AsJob]
