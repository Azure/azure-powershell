...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/remove-azappplatformdevtoolportal
schema: 2.0.0
---

# Remove-AzAppPlatformDevToolPortal
...
### Delete (Default)
```
Remove-AzAppPlatformDevToolPortal -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzAppPlatformDevToolPortal -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>] [-AsJob]
