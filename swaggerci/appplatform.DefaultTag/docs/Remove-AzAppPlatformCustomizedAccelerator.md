...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/remove-azappplatformcustomizedaccelerator
schema: 2.0.0
---

# Remove-AzAppPlatformCustomizedAccelerator
...
### Delete (Default)
```
Remove-AzAppPlatformCustomizedAccelerator -ApplicationAcceleratorName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzAppPlatformCustomizedAccelerator -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
