...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/new-azappplatformservice
schema: 2.0.0
---
...
New-AzAppPlatformService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-InfraResourceGroup <String>] [-IngressConfigReadTimeoutInSecond <Int32>] [-Location <String>]
 [-ManagedEnvironmentId <String>] [-MarketplaceResourcePlan <String>] [-MarketplaceResourceProduct <String>]
