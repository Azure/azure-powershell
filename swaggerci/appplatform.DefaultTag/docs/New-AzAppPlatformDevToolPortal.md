...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/new-azappplatformdevtoolportal
schema: 2.0.0
---

# New-AzAppPlatformDevToolPortal
...
```
New-AzAppPlatformDevToolPortal -Name <String> -ResourceGroupName <String> -ServiceName <String>
 [-SubscriptionId <String>] [-ApplicationAcceleratorState <DevToolPortalFeatureState>]
 [-ApplicationLiveViewState <DevToolPortalFeatureState>] [-Public] [-SsoPropertyClientId <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.DevToolPortalFeatureState
Parameter Sets: (All)
Aliases:
