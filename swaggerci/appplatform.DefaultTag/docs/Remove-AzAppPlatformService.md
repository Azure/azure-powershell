...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/remove-azappplatformservice
schema: 2.0.0
---

# Remove-AzAppPlatformService
...
### Delete (Default)
```
Remove-AzAppPlatformService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzAppPlatformService -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>] [-AsJob]
