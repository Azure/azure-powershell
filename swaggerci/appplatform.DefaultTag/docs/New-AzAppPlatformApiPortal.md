...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/new-azappplatformapiportal
schema: 2.0.0
---

# New-AzAppPlatformApiPortal
...
```
New-AzAppPlatformApiPortal -Name <String> -ResourceGroupName <String> -ServiceName <String>
