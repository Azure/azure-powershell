...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/remove-azappplatformcertificate
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzAppPlatformCertificate -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzAppPlatformCertificate -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>] [-AsJob]
