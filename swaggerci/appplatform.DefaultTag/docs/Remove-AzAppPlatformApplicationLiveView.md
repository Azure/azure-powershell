...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/remove-azappplatformapplicationliveview
schema: 2.0.0
---

# Remove-AzAppPlatformApplicationLiveView
...
### Delete (Default)
```
Remove-AzAppPlatformApplicationLiveView -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzAppPlatformApplicationLiveView -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
