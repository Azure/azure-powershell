...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/new-azappplatformgatewaycustomdomain
schema: 2.0.0
---

# New-AzAppPlatformGatewayCustomDomain
...
```
New-AzAppPlatformGatewayCustomDomain -DomainName <String> -GatewayName <String> -ResourceGroupName <String>
