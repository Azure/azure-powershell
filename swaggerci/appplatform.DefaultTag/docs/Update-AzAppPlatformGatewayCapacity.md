...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/update-azappplatformgatewaycapacity
schema: 2.0.0
---

# Update-AzAppPlatformGatewayCapacity
...
```
Update-AzAppPlatformGatewayCapacity -GatewayName <String> -ResourceGroupName <String> -ServiceName <String>
...
```
Update-AzAppPlatformGatewayCapacity -InputObject <IAppPlatformIdentity> [-SkuCapacity <Int32>]
