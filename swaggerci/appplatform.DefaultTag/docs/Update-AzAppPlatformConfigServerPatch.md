...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/update-azappplatformconfigserverpatch
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230301Preview.IGitPatternRepository[]
Parameter Sets: (All)
Aliases:
