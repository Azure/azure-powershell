...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/get-azappplatformcustomizedaccelerator
schema: 2.0.0
---

# Get-AzAppPlatformCustomizedAccelerator
...
### List (Default)
```
Get-AzAppPlatformCustomizedAccelerator -ApplicationAcceleratorName <String> -ResourceGroupName <String>
 -ServiceName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzAppPlatformCustomizedAccelerator -ApplicationAcceleratorName <String> -Name <String>
...
### GetViaIdentity
```
Get-AzAppPlatformCustomizedAccelerator -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
