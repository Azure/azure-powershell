...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/remove-azappplatformapplicationaccelerator
schema: 2.0.0
---

# Remove-AzAppPlatformApplicationAccelerator
...
### Delete (Default)
```
Remove-AzAppPlatformApplicationAccelerator -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzAppPlatformApplicationAccelerator -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
