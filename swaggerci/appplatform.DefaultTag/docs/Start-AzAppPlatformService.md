...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/start-azappplatformservice
schema: 2.0.0
---

# Start-AzAppPlatformService
...
### Start (Default)
```
Start-AzAppPlatformService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-AzAppPlatformService -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
