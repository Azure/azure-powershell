...
New-AzAppPlatformGateway -Name <String> -ResourceGroupName <String> -ServiceName <String>
 ...
 [-ApiMetadataPropertyTitle <String>] [-ApiMetadataPropertyVersion <String>] [-ApmType <ApmType[]>]
 [-ClientAuthCertificate <String[]>] [-ClientAuthCertificateVerification <GatewayCertificateVerification>]
