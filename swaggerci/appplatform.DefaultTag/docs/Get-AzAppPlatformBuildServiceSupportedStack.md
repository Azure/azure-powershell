...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/get-azappplatformbuildservicesupportedstack
schema: 2.0.0
---

# Get-AzAppPlatformBuildServiceSupportedStack
...
### List (Default)
```
Get-AzAppPlatformBuildServiceSupportedStack -BuildServiceName <String> -ResourceGroupName <String>
...
```
Get-AzAppPlatformBuildServiceSupportedStack -BuildServiceName <String> -ResourceGroupName <String>
 -ServiceName <String> -StackName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAppPlatformBuildServiceSupportedStack -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
