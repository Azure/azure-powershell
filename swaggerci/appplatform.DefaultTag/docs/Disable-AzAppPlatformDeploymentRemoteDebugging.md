...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/disable-azappplatformdeploymentremotedebugging
schema: 2.0.0
---

# Disable-AzAppPlatformDeploymentRemoteDebugging
...
### Disable (Default)
```
Disable-AzAppPlatformDeploymentRemoteDebugging -AppName <String> -DeploymentName <String>
...
### DisableViaIdentity
```
Disable-AzAppPlatformDeploymentRemoteDebugging -InputObject <IAppPlatformIdentity>
