...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/remove-azappplatformapiportal
schema: 2.0.0
---

# Remove-AzAppPlatformApiPortal
...
### Delete (Default)
```
Remove-AzAppPlatformApiPortal -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzAppPlatformApiPortal -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>] [-AsJob]
