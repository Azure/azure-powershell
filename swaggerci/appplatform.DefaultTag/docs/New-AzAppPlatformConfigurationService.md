...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/new-azappplatformconfigurationservice
schema: 2.0.0
---

# New-AzAppPlatformConfigurationService
...
```
New-AzAppPlatformConfigurationService -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230301Preview.IConfigurationServiceGitRepository[]
Parameter Sets: (All)
Aliases:
