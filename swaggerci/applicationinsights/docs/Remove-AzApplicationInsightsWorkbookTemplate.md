...
online version: https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/remove-azapplicationinsightsworkbooktemplate
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzApplicationInsightsWorkbookTemplate -ResourceGroupName <String> -ResourceName <String>
