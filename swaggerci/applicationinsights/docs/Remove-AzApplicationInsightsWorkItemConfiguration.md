...
online version: https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/remove-azapplicationinsightsworkitemconfiguration
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzApplicationInsightsWorkItemConfiguration -ResourceGroupName <String> -ResourceName <String>
 -WorkItemConfigId <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzApplicationInsightsWorkItemConfiguration -InputObject <IApplicationInsightsIdentity>
