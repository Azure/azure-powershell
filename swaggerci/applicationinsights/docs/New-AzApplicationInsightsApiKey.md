...
```
New-AzApplicationInsightsApiKey -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
 [-LinkedReadProperty <String[]>] [-LinkedWriteProperty <String[]>] [-Name <String>]
