...
online version: https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/get-azapplicationinsightscomponentfeaturecapability
schema: 2.0.0
---

# Get-AzApplicationInsightsComponentFeatureCapability
...
### Get (Default)
```
Get-AzApplicationInsightsComponentFeatureCapability -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzApplicationInsightsComponentFeatureCapability -InputObject <IApplicationInsightsIdentity>
