...
online version: https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/new-azapplicationinsightsmyworkbook
schema: 2.0.0
---
...
```
New-AzApplicationInsightsMyWorkbook -ResourceGroupName <String> -ResourceName <String>
