...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/microsoft.insights/components/{resourceName}/{scopePath}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzApplicationInsightsAnalyticsItem_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20150501.IApplicationInsightsComponentAnalyticsItem))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Description(@"Gets a list of Analytics Items defined within an Application Insights component.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Generated]
    public partial class GetAzApplicationInsightsAnalyticsItem_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="IncludeContent" /> property.</summary>
        private global::System.Management.Automation.SwitchParameter _includeContent;

        /// <summary>
        /// Flag indicating whether or not to return the content of each applicable item. If false, only return the item information.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Flag indicating whether or not to return the content of each applicable item. If false, only return the item information.")]
        ...
        public global::System.Management.Automation.SwitchParameter IncludeContent { get => this._includeContent; set => this._includeContent = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Enum indicating if this item definition is owned by a specific user or is shared between all users with access to the Application Insights component.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.ParameterCategory.Query)]
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.ItemScope))]
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.ItemTypeParameter _type;

        /// <summary>Enum indicating the type of the Analytics item.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Enum indicating the type of the Analytics item.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Enum indicating the type of the Analytics item.",
        SerializedName = @"type",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.ItemTypeParameter) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.ParameterCategory.Query)]
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.ItemTypeParameter))]
        public Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.ItemTypeParameter Type { get => this._type; set => this._type = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20150501.IApplicationInsightsComponentAnalyticsItem[]"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20150501.IApplicationInsightsComponentAnalyticsItem[]> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzApplicationInsightsAnalyticsItem_List" /> cmdlet class.
        /// </summary>
        public GetAzApplicationInsightsAnalyticsItem_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AnalyticsItemsList(SubscriptionId, ResourceGroupName, ResourceName, ScopePath, this.InvocationInformation.BoundParameters.ContainsKey("Scope") ? Scope : null, this.InvocationInformation.BoundParameters.ContainsKey("Type") ? Type : null, this.InvocationInformation.BoundParameters.ContainsKey("IncludeContent") ? IncludeContent : default(global::System.Management.Automation.SwitchParameter?), onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ResourceName=ResourceName,ScopePath=ScopePath,Scope=this.InvocationInformation.BoundParameters.ContainsKey("Scope") ? Scope : null,Type=this.InvocationInformation.BoundParameters.ContainsKey("Type") ? Type : null,IncludeContent=this.InvocationInformation.BoundParameters.ContainsKey("IncludeContent") ? IncludeContent : default(global::System.Management.Automation.SwitchParameter?)})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20150501.IApplicationInsightsComponentAnalyticsItem[]> response)
        {
            using( NoSynchronizationContext )
            {
