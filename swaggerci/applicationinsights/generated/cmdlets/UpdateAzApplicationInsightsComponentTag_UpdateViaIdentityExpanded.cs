...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] UpdateTags=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/components/{resourceName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzApplicationInsightsComponentTag_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Description(@"Updates an existing component's tags. To update other fields use the CreateOrUpdate method.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Generated]
    public partial class UpdateAzApplicationInsightsComponentTag_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ComponentTagsBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20150501.ITagsResource _componentTagsBody= new Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20150501.TagsResource();

        /// <summary>
        /// A container holding only the Tags for a resource, allowing the user to update the tags on a WebTest instance.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20150501.ITagsResource ComponentTagsBody { get => this._componentTagsBody; set => this._componentTagsBody = value; }
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20150501.ITagsResourceTags) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20150501.ITagsResourceTags Tag { get => ComponentTagsBody.Tag ?? null /* object */; set => ComponentTagsBody.Tag = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ComponentsUpdateTags' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ComponentsUpdateTagsViaIdentity(InputObject.Id, ComponentTagsBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ComponentsUpdateTags(InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.ResourceName ?? null, ComponentTagsBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ComponentTagsBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzApplicationInsightsComponentTag_UpdateViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzApplicationInsightsComponentTag_UpdateViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api202002.IErrorResponseComponents> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ComponentTagsBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ComponentTagsBody })
                    {
