...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.IEventListener
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Description { get => WorkbookPropertiesBody.Description ?? null; set => WorkbookPropertiesBody.Description = value; }
        ...
        SerializedName = @"etag",
        PossibleTypes = new [] { typeof(string) })]
        public string Etag { get => WorkbookPropertiesBody.Etag ?? null; set => WorkbookPropertiesBody.Etag = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.ManagedServiceIdentityType IdentityType { get => WorkbookPropertiesBody.IdentityType ?? ((Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.ManagedServiceIdentityType)""); set => WorkbookPropertiesBody.IdentityType = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api30.IUserAssignedIdentities IdentityUserAssignedIdentity { get => WorkbookPropertiesBody.IdentityUserAssignedIdentity ?? null /* object */; set => WorkbookPropertiesBody.IdentityUserAssignedIdentity = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api10.ITrackedResourceTags Tag { get => WorkbookPropertiesBody.Tag ?? null /* object */; set => WorkbookPropertiesBody.Tag = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20210801.IWorkbook WorkbookPropertiesBody { get => this._workbookPropertiesBody; set => this._workbookPropertiesBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.WorkbooksCreateOrUpdate(SubscriptionId, ResourceGroupName, ResourceName, this.InvocationInformation.BoundParameters.ContainsKey("SourceId") ? SourceId : null, WorkbookPropertiesBody, onOk, onCreated, onDefault, this, Pipeline);
