...
online version: https://docs.microsoft.com/en-us/powershell/module/az.externalidentitiesconfiguration/remove-azexternalidentitiesconfigurationb2ctenant
schema: 2.0.0
---

# Remove-AzExternalIdentitiesConfigurationB2CTenant
...
### Delete (Default)
```
Remove-AzExternalIdentitiesConfigurationB2CTenant -ResourceGroupName <String> -ResourceName <String>
...
### DeleteViaIdentity
```
Remove-AzExternalIdentitiesConfigurationB2CTenant -InputObject <IExternalIdentitiesConfigurationIdentity>
