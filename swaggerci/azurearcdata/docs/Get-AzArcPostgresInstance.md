...
external help file:
Module Name: Az.Arc
online version: https://docs.microsoft.com/en-us/powershell/module/az.arc/get-azarcpostgresinstance
schema: 2.0.0
---

# Get-AzArcPostgresInstance
...
### List (Default)
```
Get-AzArcPostgresInstance [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzArcPostgresInstance -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzArcPostgresInstance -InputObject <IArcIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
