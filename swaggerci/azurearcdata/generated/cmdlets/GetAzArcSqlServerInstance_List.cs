...
namespace Microsoft.Azure.PowerShell.Cmdlets.Arc.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.AzureArcData/sqlServerInstances"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzArcSqlServerInstance_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Arc.Description(@"List sqlServerInstance resources in the subscription")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Arc.Generated]
    public partial class GetAzArcSqlServerInstance_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Arc.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzArcSqlServerInstance_List" /> cmdlet class.
        /// </summary>
        public GetAzArcSqlServerInstance_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SqlServerInstancesList(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.SqlServerInstancesList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
