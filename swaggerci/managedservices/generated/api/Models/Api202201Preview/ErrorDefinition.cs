...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api202201Preview
{
    ...
    public partial class ErrorDefinition :
        Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api202201Preview.IErrorDefinition,
        Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api202201Preview.IErrorDefinitionInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api202201Preview.IErrorDefinition[] _detail;

        /// <summary>The internal error details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api202201Preview.IErrorDefinition[] Detail { get => this._detail; set => this._detail = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api202201Preview.IErrorDefinition) })]
        Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api202201Preview.IErrorDefinition[] Detail { get; set; }
        /// <summary>The error message indicating why the operation failed.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
