...
online version: https://docs.microsoft.com/en-us/powershell/module/az.managedservices/remove-azmanagedservicesregistrationdefinition
schema: 2.0.0
---

# Remove-AzManagedServicesRegistrationDefinition
...
### Delete (Default)
```
Remove-AzManagedServicesRegistrationDefinition -Id <String> -Scope <String> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzManagedServicesRegistrationDefinition -InputObject <IManagedServicesIdentity>
