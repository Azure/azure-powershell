...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api202201Preview.IAuthorization[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api202201Preview.IEligibleAuthorization[]
Parameter Sets: (All)
Aliases:
