...
### Delete (Default)
```
Remove-AzAutomationDscNodeConfiguration -AutomationAccountName <String> -NodeConfigurationName <String>
...
### DeleteViaIdentity
```
Remove-AzAutomationDscNodeConfiguration -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>]
