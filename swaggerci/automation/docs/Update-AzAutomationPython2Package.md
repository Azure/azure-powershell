...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/update-azautomationpython2package
schema: 2.0.0
---

# Update-AzAutomationPython2Package
...
```
Update-AzAutomationPython2Package -AutomationAccountName <String> -PackageName <String>
...
```
Update-AzAutomationPython2Package -InputObject <IAutomationIdentity> [-Tag <Hashtable>]
...
### Microsoft.Azure.PowerShell.Cmdlets.Automation.Models.Api20200113Preview.IModule
