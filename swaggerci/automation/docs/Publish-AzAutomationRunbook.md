...
### Publish (Default)
```
Publish-AzAutomationRunbook -AutomationAccountName <String> -Name <String> -ResourceGroupName <String>
...
### PublishViaIdentity
```
Publish-AzAutomationRunbook -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
