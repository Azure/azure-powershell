...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/remove-azautomationhybridrunbookworkergroup
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzAutomationHybridRunbookWorkerGroup -AutomationAccountName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzAutomationHybridRunbookWorkerGroup -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>]
