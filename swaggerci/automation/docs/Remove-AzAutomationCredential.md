...
### Delete (Default)
```
Remove-AzAutomationCredential -AutomationAccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzAutomationCredential -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>] [-PassThru]
