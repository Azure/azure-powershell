...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/get-azautomationprivateendpointconnection
schema: 2.0.0
---
...
### List (Default)
```
Get-AzAutomationPrivateEndpointConnection -AutomationAccountName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzAutomationPrivateEndpointConnection -AutomationAccountName <String> -Name <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAutomationPrivateEndpointConnection -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
