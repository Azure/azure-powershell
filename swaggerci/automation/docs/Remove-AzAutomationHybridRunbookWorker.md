...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/remove-azautomationhybridrunbookworker
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzAutomationHybridRunbookWorker -AutomationAccountName <String> -GroupName <String> -Id <String>
...
### DeleteViaIdentity
```
Remove-AzAutomationHybridRunbookWorker -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>]
