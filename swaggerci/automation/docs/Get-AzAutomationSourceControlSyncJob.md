...
### List (Default)
```
Get-AzAutomationSourceControlSyncJob -AutomationAccountName <String> -ResourceGroupName <String>
 -SourceControlName <String> [-SubscriptionId <String[]>] [-Filter <String>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### Get
```
Get-AzAutomationSourceControlSyncJob -AutomationAccountName <String> -Id <String> -ResourceGroupName <String>
 -SourceControlName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAutomationSourceControlSyncJob -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Automation.Models.Api20200113Preview.ISourceControlSyncJobById
