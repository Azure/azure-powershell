...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/update-azautomationcredential
schema: 2.0.0
---

# Update-AzAutomationCredential
...
```
Update-AzAutomationCredential -AutomationAccountName <String> -CredentialName <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-Description <String>] [-Name <String>]
 [-Password <String>] [-UserName <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAutomationCredential -InputObject <IAutomationIdentity> [-Description <String>] [-Name <String>]
 [-Password <String>] [-UserName <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Automation.Models.Api20200113Preview.ICredential
