...
### Stop (Default)
```
Stop-AzAutomationJob -AutomationAccountName <String> -Name <String> -ResourceGroupName <String>
...
### StopViaIdentity
```
Stop-AzAutomationJob -InputObject <IAutomationIdentity> [-ClientRequestId <String>]
