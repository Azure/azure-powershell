...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/get-azautomationjobrunbookcontent
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzAutomationJobRunbookContent -AutomationAccountName <String> -JobName <String>
...
### GetViaIdentity
```
Get-AzAutomationJobRunbookContent -InputObject <IAutomationIdentity> [-ClientRequestId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```
