...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devops/remove-azdevopspipeline
schema: 2.0.0
---

# Remove-AzDevOpsPipeline
...
### Delete (Default)
```
Remove-AzDevOpsPipeline -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDevOpsPipeline -InputObject <IDevOpsIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
