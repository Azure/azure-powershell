...
namespace Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Support.SkuTier Basic = @"Basic";

        public static Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Support.SkuTier Enterprise = @"Enterprise";

        public static Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Support.SkuTier Free = @"Free";

        public static Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Support.SkuTier Premium = @"Premium";

        public static Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Support.SkuTier Standard = @"Standard";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Support.SkuTier e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Support.SkuTier e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Support.SkuTier e1, Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Support.SkuTier e2)
        {
            return !e2.Equals(e1);
        }
