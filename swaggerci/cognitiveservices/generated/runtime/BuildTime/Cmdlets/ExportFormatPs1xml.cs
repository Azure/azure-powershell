...
namespace Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Support";
