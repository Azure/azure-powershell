...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cognitiveservices/remove-azcognitiveservicescommitmentplan
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzCognitiveServicesCommitmentPlan -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzCognitiveServicesCommitmentPlan -InputObject <ICognitiveServicesIdentity>
