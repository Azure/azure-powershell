...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cognitiveservices/remove-azcognitiveservicesdeployment
schema: 2.0.0
---

# Remove-AzCognitiveServicesDeployment
...
### Delete (Default)
```
Remove-AzCognitiveServicesDeployment -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzCognitiveServicesDeployment -InputObject <ICognitiveServicesIdentity> [-DefaultProfile <PSObject>]
