...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migratev2/remove-azmigratev2servercollector
schema: 2.0.0
---

# Remove-AzMigrateV2ServerCollector
...
### Delete (Default)
```
Remove-AzMigrateV2ServerCollector -Name <String> -ProjectName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMigrateV2ServerCollector -InputObject <IMigrateV2Identity> [-DefaultProfile <PSObject>] [-PassThru]
