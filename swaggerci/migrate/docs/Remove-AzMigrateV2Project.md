...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migratev2/remove-azmigratev2project
schema: 2.0.0
---

# Remove-AzMigrateV2Project
...
### Delete (Default)
```
Remove-AzMigrateV2Project -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMigrateV2Project -InputObject <IMigrateV2Identity> [-DefaultProfile <PSObject>] [-PassThru]
