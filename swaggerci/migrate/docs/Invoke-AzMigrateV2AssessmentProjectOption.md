...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migratev2/invoke-azmigratev2assessmentprojectoption
schema: 2.0.0
---

# Invoke-AzMigrateV2AssessmentProjectOption
...
### Assessment (Default)
```
Invoke-AzMigrateV2AssessmentProjectOption -AssessmentOptionsName <String> -ProjectName <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### AssessmentViaIdentity
```
Invoke-AzMigrateV2AssessmentProjectOption -InputObject <IMigrateV2Identity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
Parameter Sets: AssessmentViaIdentity
Aliases:
