...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migratev2/remove-azmigratev2vmwarecollector
schema: 2.0.0
---

# Remove-AzMigrateV2VMwareCollector
...
### Delete (Default)
```
Remove-AzMigrateV2VMwareCollector -Name <String> -ProjectName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMigrateV2VMwareCollector -InputObject <IMigrateV2Identity> [-DefaultProfile <PSObject>] [-PassThru]
