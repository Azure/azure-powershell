...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migratev2/remove-azmigratev2privateendpointconnection
schema: 2.0.0
---

# Remove-AzMigrateV2PrivateEndpointConnection
...
### Delete (Default)
```
Remove-AzMigrateV2PrivateEndpointConnection -Name <String> -ProjectName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMigrateV2PrivateEndpointConnection -InputObject <IMigrateV2Identity> [-DefaultProfile <PSObject>]
