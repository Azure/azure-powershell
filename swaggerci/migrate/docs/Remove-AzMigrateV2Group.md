...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migratev2/remove-azmigratev2group
schema: 2.0.0
---

# Remove-AzMigrateV2Group
...
### Delete (Default)
```
Remove-AzMigrateV2Group -Name <String> -ProjectName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMigrateV2Group -InputObject <IMigrateV2Identity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
