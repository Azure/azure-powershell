...
namespace Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Models.Api20191001
{
    ...
    public partial class Operation
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Models.Api20191001.IOperation.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Models.Api20191001.IOperation.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Models.Api20191001.IOperation FromJson(Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.Json.JsonObject json ? new Operation(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.Json.JsonObject into a new instance of <see cref="Operation" />.
        /// </summary>
        ...
        internal Operation(Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.Json.JsonObject json)
        {
            ...
            {_display = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.Json.JsonObject>("display"), out var __jsonDisplay) ? Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Models.Api20191001.OperationDisplay.FromJson(__jsonDisplay) : Display;}
            ...
            {_origin = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.Json.JsonString>("origin"), out var __jsonOrigin) ? (string)__jsonOrigin : (string)Origin;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Operation" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Operation" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != this._display ? (Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.Json.JsonNode) this._display.ToJson(null,serializationMode) : null, "display" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._origin)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.Json.JsonString(this._origin.ToString()) : null, "origin" ,container.Add );
            }
