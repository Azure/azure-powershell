...
> [!NOTE]  
> Azure PoweShell modules doesn't depend on the data types of Azure.Identity that cause the vulnerabiltity. Therefore it is safe to use Azure PoweShell modules even it depends on Azure.Identity 1.6.1.
