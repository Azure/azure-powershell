...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "AnfSnapshot"), OutputType(typeof(PSAnfSnapshot))]
    public class RemoveAzureRmAnSnapshot : AzureAnfCmdletBase
    {
        [Parameter(
            Mandatory = true,
        ...
        public override void ExecuteCmdlet()
        {
            ...
            AzureNetAppFilesManagementClient.Snapshots.Delete(ResourceGroupName, AccountName, PoolName, VolumeName, SnapshotName);
        }
    }
}
