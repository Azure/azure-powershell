...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "AnfVolume"), OutputType(typeof(PSAnfVolume))]
    public class RemoveAzureRmAnfVolume : AzureAnfCmdletBase
    {
        [Parameter(
            Mandatory = true,
        ...
        public override void ExecuteCmdlet()
        {
            ...
            AzureNetAppFilesManagementClient.Volumes.Delete(ResourceGroupName, AccountName, PoolName, VolumeName);
        }
    }
}
