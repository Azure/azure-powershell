...
{
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "AnfVolume"), OutputType(typeof(PSAnfVolume))]
    public class NewAzureRmAnfVolume : AzureAnfCmdletBase
    {
        [Parameter(
            Mandatory = true,
