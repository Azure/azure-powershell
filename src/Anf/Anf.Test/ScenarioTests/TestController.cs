...
namespace Microsoft.Azure.Commands.Anf.Test.ScenarioTests.ScenarioTest
{
    public class TestController : RMTestBase
    {
        ...
        public AzureNetAppFilesManagementClient AnfManagementClient { get; private set; }
        ...
        protected void SetupManagementClients(MockContext context)
        {
            ...
            AnfManagementClient = GetAnfManagementClient(context);
            ...
            string mockName)
        {
            ...
            using (var context = MockContext.Start(callingClassType, mockName))
            {
                ...
                _helper.SetupModules(AzureModule.AzureResourceManager,
                    ...
                    _helper.GetRMModulePath("AzureRM.Anf.psd1"),
        ...
        private static AzureNetAppFilesManagementClient GetAnfManagementClient(MockContext context)
        {
