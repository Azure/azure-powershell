...
online version: https://learn.microsoft.com/powershell/module/az.batch/get-aznoderemoteloginsetting
schema: 2.0.0
---

# Get-AzNodeRemoteLoginSetting
...
### Get (Default)
```
Get-AzNodeRemoteLoginSetting -Endpoint <String> -NodeId <String> -PoolId <String> [-TimeOut <Int32>]
...
### GetViaIdentityPool
```
Get-AzNodeRemoteLoginSetting -Endpoint <String> -NodeId <String> -PoolInputObject <IBatchIdentity>
