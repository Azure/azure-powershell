...
### List (Default)
```
Get-AzApplication -Endpoint <String> [-Maxresult <Int32>] [-TimeOut <Int32>] [-ClientRequestId <String>]
 [-Ocpdate <String>] [-ReturnClientRequestId] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzApplication -Endpoint <String> -Id <String> [-TimeOut <Int32>] [-ClientRequestId <String>]
 [-Ocpdate <String>] [-ReturnClientRequestId] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
