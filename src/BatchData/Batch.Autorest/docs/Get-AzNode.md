...
online version: https://learn.microsoft.com/powershell/module/az.batch/get-aznode
schema: 2.0.0
---
...
### List (Default)
```
Get-AzNode -Endpoint <String> -PoolId <String> [-Filter <String>] [-Maxresult <Int32>]
...
### Get
```
Get-AzNode -Endpoint <String> -Id <String> -PoolId <String> [-Select <List<String>>] [-TimeOut <Int32>]
...
### GetViaIdentityPool
```
Get-AzNode -Endpoint <String> -Id <String> -PoolInputObject <IBatchIdentity> [-Select <List<String>>]
...
```yaml
Type: System.String
Parameter Sets: Get, GetViaIdentityPool
Aliases: NodeId
