...
online version: https://learn.microsoft.com/powershell/module/az.batch/get-aztask
schema: 2.0.0
---
...
### List (Default)
```
Get-AzTask -Endpoint <String> -JobId <String> [-Expand <List<String>>] [-Filter <String>] [-Maxresult <Int32>]
...
### Get
```
Get-AzTask -Endpoint <String> -Id <String> -JobId <String> [-Expand <List<String>>] [-Select <List<String>>]
...
### GetViaIdentityJob
```
Get-AzTask -Endpoint <String> -Id <String> -JobInputObject <IBatchIdentity> [-Expand <List<String>>]
 [-Select <List<String>>] [-TimeOut <Int32>] [-ClientRequestId <String>] [-IfMatch <String>]
 [-IfModifiedSince <String>] [-IfNoneMatch <String>] [-IfUnmodifiedSince <String>] [-Ocpdate <String>]
 [-ReturnClientRequestId] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Get, GetViaIdentityJob
Aliases: TaskId
...
Parameter Sets: GetViaIdentityJob
Aliases:
