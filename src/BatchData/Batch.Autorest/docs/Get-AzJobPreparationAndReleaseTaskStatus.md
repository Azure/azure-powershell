...
online version: https://learn.microsoft.com/powershell/module/az.batch/get-azjobpreparationandreleasetaskstatus
schema: 2.0.0
---

# Get-AzJobPreparationAndReleaseTaskStatus
...
```
Get-AzJobPreparationAndReleaseTaskStatus -Endpoint <String> -JobId <String> [-Filter <String>]
