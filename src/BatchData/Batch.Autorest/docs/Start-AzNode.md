...
online version: https://learn.microsoft.com/powershell/module/az.batch/start-aznode
schema: 2.0.0
---
...
### Start (Default)
```
Start-AzNode -Endpoint <String> -Id <String> -PoolId <String> [-TimeOut <Int32>] [-ClientRequestId <String>]
...
### StartViaIdentity
```
Start-AzNode -Endpoint <String> -InputObject <IBatchIdentity> [-TimeOut <Int32>] [-ClientRequestId <String>]
 [-Ocpdate <String>] [-ReturnClientRequestId] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### StartViaIdentityPool
```
Start-AzNode -Endpoint <String> -Id <String> -PoolInputObject <IBatchIdentity> [-TimeOut <Int32>]
...
```yaml
Type: System.String
Parameter Sets: Start, StartViaIdentityPool
Aliases: NodeId
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchIdentity
Parameter Sets: StartViaIdentityPool
Aliases:
