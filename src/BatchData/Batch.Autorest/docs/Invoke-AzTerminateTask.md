...
online version: https://learn.microsoft.com/powershell/module/az.batch/invoke-azterminatetask
schema: 2.0.0
---

# Invoke-AzTerminateTask
...
### Terminate (Default)
```
Invoke-AzTerminateTask -Endpoint <String> -JobId <String> -TaskId <String> [-TimeOut <Int32>]
...
```
Invoke-AzTerminateTask -Endpoint <String> -InputObject <IBatchIdentity> [-TimeOut <Int32>]
 [-ClientRequestId <String>] [-IfMatch <String>] [-IfModifiedSince <String>] [-IfNoneMatch <String>]
 [-IfUnmodifiedSince <String>] [-Ocpdate <String>] [-ReturnClientRequestId] [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### TerminateViaIdentityJob
```
Invoke-AzTerminateTask -Endpoint <String> -JobInputObject <IBatchIdentity> -TaskId <String> [-TimeOut <Int32>]
 [-ClientRequestId <String>] [-IfMatch <String>] [-IfModifiedSince <String>] [-IfNoneMatch <String>]
 [-IfUnmodifiedSince <String>] [-Ocpdate <String>] [-ReturnClientRequestId] [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchIdentity
Parameter Sets: TerminateViaIdentityJob
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Terminate, TerminateViaIdentityJob
Aliases:
