...
online version: https://learn.microsoft.com/powershell/module/az.batch/get-aztasksubtask
schema: 2.0.0
---
...
```
Get-AzTaskSubTask -Endpoint <String> -JobId <String> -TaskId <String> [-Select <List<String>>]
