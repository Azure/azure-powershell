...
### Delete (Default)
```
Remove-AzPool -Endpoint <String> -Id <String> [-TimeOut <Int32>] [-ClientRequestId <String>]
...
### DeleteViaIdentity
```
Remove-AzPool -Endpoint <String> -InputObject <IBatchIdentity> [-TimeOut <Int32>] [-ClientRequestId <String>]
 [-IfMatch <String>] [-IfModifiedSince <String>] [-IfNoneMatch <String>] [-IfUnmodifiedSince <String>]
 [-Ocpdate <String>] [-ReturnClientRequestId] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
