...
online version: https://learn.microsoft.com/powershell/module/az.batch/get-azjobtaskcount
schema: 2.0.0
---
...
```
Get-AzJobTaskCount -Endpoint <String> -JobId <String> [-TimeOut <Int32>] [-ClientRequestId <String>]
