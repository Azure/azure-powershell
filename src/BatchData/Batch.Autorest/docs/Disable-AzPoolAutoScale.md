...
### Disable (Default)
```
Disable-AzPoolAutoScale -Endpoint <String> -PoolId <String> [-TimeOut <Int32>] [-ClientRequestId <String>]
...
### DisableViaIdentity
```
Disable-AzPoolAutoScale -Endpoint <String> -InputObject <IBatchIdentity> [-TimeOut <Int32>]
