...
online version: https://learn.microsoft.com/powershell/module/az.batch/get-azjobschedule
schema: 2.0.0
---
...
### List (Default)
```
Get-AzJobSchedule -Endpoint <String> [-Expand <List<String>>] [-Filter <String>] [-Maxresult <Int32>]
...
### Get
```
Get-AzJobSchedule -Endpoint <String> -Id <String> [-Expand <List<String>>] [-Select <List<String>>]
