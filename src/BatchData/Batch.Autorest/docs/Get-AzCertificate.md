...
### List (Default)
```
Get-AzCertificate -Endpoint <String> [-Filter <String>] [-Maxresult <Int32>] [-Select <List<String>>]
...
### Get
```
Get-AzCertificate -Endpoint <String> -Thumbprint <String> -ThumbprintAlgorithm <String>
