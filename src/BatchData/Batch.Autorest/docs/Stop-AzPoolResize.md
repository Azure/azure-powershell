...
### Stop (Default)
```
Stop-AzPoolResize -Endpoint <String> -PoolId <String> [-TimeOut <Int32>] [-ClientRequestId <String>]
...
### StopViaIdentity
```
Stop-AzPoolResize -Endpoint <String> -InputObject <IBatchIdentity> [-TimeOut <Int32>]
