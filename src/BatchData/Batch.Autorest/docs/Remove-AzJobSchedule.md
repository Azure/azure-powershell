...
online version: https://learn.microsoft.com/powershell/module/az.batch/remove-azjobschedule
schema: 2.0.0
---

# Remove-AzJobSchedule
...
### Delete (Default)
```
Remove-AzJobSchedule -Endpoint <String> -Id <String> [-Force] [-TimeOut <Int32>] [-ClientRequestId <String>]
...
### DeleteViaIdentity
```
Remove-AzJobSchedule -Endpoint <String> -InputObject <IBatchIdentity> [-Force] [-TimeOut <Int32>]
