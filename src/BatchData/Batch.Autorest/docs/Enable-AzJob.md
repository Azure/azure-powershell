...
online version: https://learn.microsoft.com/powershell/module/az.batch/enable-azjob
schema: 2.0.0
---
...
### Enable (Default)
```
Enable-AzJob -Endpoint <String> -Id <String> [-TimeOut <Int32>] [-ClientRequestId <String>]
...
### EnableViaIdentity
```
Enable-AzJob -Endpoint <String> -InputObject <IBatchIdentity> [-TimeOut <Int32>] [-ClientRequestId <String>]
 [-IfMatch <String>] [-IfModifiedSince <String>] [-IfNoneMatch <String>] [-IfUnmodifiedSince <String>]
 [-Ocpdate <String>] [-ReturnClientRequestId] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
