...
online version: https://learn.microsoft.com/powershell/module/az.batch/get-azpoolsupportedimage
schema: 2.0.0
---

# Get-AzPoolSupportedImage
...
```
Get-AzPoolSupportedImage -Endpoint <String> [-Filter <String>] [-Maxresult <Int32>] [-TimeOut <Int32>]
