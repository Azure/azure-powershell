...
online version: https://learn.microsoft.com/powershell/module/az.batch/disable-azjobschedule
schema: 2.0.0
---

# Disable-AzJobSchedule
...
### Disable (Default)
```
Disable-AzJobSchedule -Endpoint <String> -Id <String> [-TimeOut <Int32>] [-ClientRequestId <String>]
...
### DisableViaIdentity
```
Disable-AzJobSchedule -Endpoint <String> -InputObject <IBatchIdentity> [-TimeOut <Int32>]
