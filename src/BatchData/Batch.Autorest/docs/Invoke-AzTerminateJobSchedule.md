...
online version: https://learn.microsoft.com/powershell/module/az.batch/invoke-azterminatejobschedule
schema: 2.0.0
---

# Invoke-AzTerminateJobSchedule
...
### Terminate (Default)
```
Invoke-AzTerminateJobSchedule -Endpoint <String> -JobScheduleId <String> [-Force] [-TimeOut <Int32>]
...
```
Invoke-AzTerminateJobSchedule -Endpoint <String> -InputObject <IBatchIdentity> [-Force] [-TimeOut <Int32>]
 [-ClientRequestId <String>] [-IfMatch <String>] [-IfModifiedSince <String>] [-IfNoneMatch <String>]
 [-IfUnmodifiedSince <String>] [-Ocpdate <String>] [-ReturnClientRequestId] [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
