...
online version: https://learn.microsoft.com/powershell/module/az.batch/get-azpoolusagemetric
schema: 2.0.0
---

# Get-AzPoolUsageMetric
...
```
Get-AzPoolUsageMetric -Endpoint <String> [-Endtime <DateTime>] [-Filter <String>] [-Maxresult <Int32>]
...
### -Endtime
The latest time from which to include metrics.
This must be at least two hours
before the current time.
If not specified this defaults to the end time of the
...
### -StartTime
The earliest time from which to include metrics.
This must be at least two and
