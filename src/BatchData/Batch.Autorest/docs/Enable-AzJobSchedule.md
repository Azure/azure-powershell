...
online version: https://learn.microsoft.com/powershell/module/az.batch/enable-azjobschedule
schema: 2.0.0
---

# Enable-AzJobSchedule
...
### Enable (Default)
```
Enable-AzJobSchedule -Endpoint <String> -Id <String> [-TimeOut <Int32>] [-ClientRequestId <String>]
...
### EnableViaIdentity
```
Enable-AzJobSchedule -Endpoint <String> -InputObject <IBatchIdentity> [-TimeOut <Int32>]
