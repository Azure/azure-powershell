...
online version: https://learn.microsoft.com/powershell/module/az.batch/invoke-azreactivatetask
schema: 2.0.0
---

# Invoke-AzReactivateTask
...
### Reactivate (Default)
```
Invoke-AzReactivateTask -Endpoint <String> -JobId <String> -TaskId <String> [-TimeOut <Int32>]
...
```
Invoke-AzReactivateTask -Endpoint <String> -InputObject <IBatchIdentity> [-TimeOut <Int32>]
 [-ClientRequestId <String>] [-IfMatch <String>] [-IfModifiedSince <String>] [-IfNoneMatch <String>]
 [-IfUnmodifiedSince <String>] [-Ocpdate <String>] [-ReturnClientRequestId] [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReactivateViaIdentityJob
```
Invoke-AzReactivateTask -Endpoint <String> -JobInputObject <IBatchIdentity> -TaskId <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchIdentity
Parameter Sets: ReactivateViaIdentityJob
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Reactivate, ReactivateViaIdentityJob
Aliases:
