...
online version: https://learn.microsoft.com/powershell/module/az.batch/get-azjob
schema: 2.0.0
---
...
### List (Default)
```
Get-AzJob -Endpoint <String> [-Expand <List<String>>] [-Filter <String>] [-Maxresult <Int32>]
...
### Get
```
Get-AzJob -Endpoint <String> -Id <String> [-Expand <List<String>>] [-Select <List<String>>] [-TimeOut <Int32>]
