...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets
{
    ...
    /// <summary>
    /// You can reinstall the operating system on a Compute Node only if it is in an\nidle or running state. This API can be invoked
    /// only on Pools created with the\ncloud service configuration property.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ReimageNode=>POST:"/pools/{poolId}/nodes/{nodeId}/reimage"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzNode_ReimageViaIdentityPool", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Description(@"You can reinstall the operating system on a Compute Node only if it is in an\nidle or running state. This API can be invoked only on Pools created with the\ncloud service configuration property.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.HttpPath(Path = "/pools/{poolId}/nodes/{nodeId}/reimage", ApiVersion = "2024-07-01.20.0")]
    public partial class UpdateAzNode_ReimageViaIdentityPool : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The ID of the Compute Node that you want to restart.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchNodeReimageOptions _option;

        /// <summary>Parameters for reimaging an Azure Batch Compute Node.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters for reimaging an Azure Batch Compute Node.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Parameters for reimaging an Azure Batch Compute Node.",
        SerializedName = @"options",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchNodeReimageOptions) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchNodeReimageOptions Option { get => this._option; set => this._option = value; }
        ...
        /// <param name="headers">the header result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INodesReimageNodeAcceptedResponseHeaders"
        ...
        partial void overrideOnAccepted(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INodesReimageNodeAcceptedResponseHeaders> headers, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NodesReimageNode' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.NodesReimageNode(PoolInputObject.PoolId ?? null, Id, this.InvocationInformation.BoundParameters.ContainsKey("ClientRequestId") ? ClientRequestId : null, this.InvocationInformation.BoundParameters.ContainsKey("ReturnClientRequestId") ? ReturnClientRequestId : default(global::System.Management.Automation.SwitchParameter?), this.InvocationInformation.BoundParameters.ContainsKey("Ocpdate") ? Ocpdate : null, this.InvocationInformation.BoundParameters.ContainsKey("TimeOut") ? TimeOut : default(int?), Endpoint, Option, onAccepted, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzNode_ReimageViaIdentityPool" /> cmdlet class.
        /// </summary>
        public UpdateAzNode_ReimageViaIdentityPool()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onAccepted(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INodesReimageNodeAcceptedResponseHeaders> headers)
        {
            using( NoSynchronizationContext )
            {
