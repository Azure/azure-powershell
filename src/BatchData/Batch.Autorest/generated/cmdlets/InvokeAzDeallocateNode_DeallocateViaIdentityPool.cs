...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzDeallocateNode_DeallocateViaIdentityPool", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzDeallocateNode_DeallocateViaIdentityPool : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchNodeDeallocateOptions _option;

        /// <summary>Options for deallocating a Compute Node.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Options for deallocating a Compute Node.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Options for deallocating a Compute Node.",
        SerializedName = @"options",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchNodeDeallocateOptions) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchNodeDeallocateOptions Option { get => this._option; set => this._option = value; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzDeallocateNode_DeallocateViaIdentityPool" /> cmdlet class.
        /// </summary>
        public InvokeAzDeallocateNode_DeallocateViaIdentityPool()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.NodesDeallocateNode(PoolInputObject.PoolId ?? null, NodeId, this.InvocationInformation.BoundParameters.ContainsKey("ClientRequestId") ? ClientRequestId : null, this.InvocationInformation.BoundParameters.ContainsKey("ReturnClientRequestId") ? ReturnClientRequestId : default(global::System.Management.Automation.SwitchParameter?), this.InvocationInformation.BoundParameters.ContainsKey("Ocpdate") ? Ocpdate : null, this.InvocationInformation.BoundParameters.ContainsKey("TimeOut") ? TimeOut : default(int?), Endpoint, Option, onAccepted, onDefault, this, Pipeline);
                    }
