...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] DisableNodeScheduling=>POST:"/pools/{poolId}/nodes/{nodeId}/disablescheduling"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Disable, @"AzNodeScheduling_DisableViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Description(@"You can disable Task scheduling on a Compute Node only if its current\nscheduling state is enabled.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.HttpPath(Path = "/pools/{poolId}/nodes/{nodeId}/disablescheduling", ApiVersion = "2024-07-01.20.0")]
    public partial class DisableAzNodeScheduling_DisableViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchNodeDisableSchedulingOptions _optionsBody = new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.BatchNodeDisableSchedulingOptions();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "What to do with currently running Tasks when disabling Task scheduling on the Compute Node. The default value is requeue.")]
        ...
        public string NodeDisableSchedulingOption { get => _optionsBody.NodeDisableSchedulingOption ?? null; set => _optionsBody.NodeDisableSchedulingOption = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="headers">the header result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INodesDisableNodeSchedulingOkResponseHeaders"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INodesDisableNodeSchedulingOkResponseHeaders> headers, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DisableAzNodeScheduling_DisableViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public DisableAzNodeScheduling_DisableViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NodesDisableNodeScheduling' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.NodesDisableNodeScheduling(InputObject.PoolId ?? null, InputObject.NodeId ?? null, this.InvocationInformation.BoundParameters.ContainsKey("ClientRequestId") ? ClientRequestId : null, this.InvocationInformation.BoundParameters.ContainsKey("ReturnClientRequestId") ? ReturnClientRequestId : default(global::System.Management.Automation.SwitchParameter?), this.InvocationInformation.BoundParameters.ContainsKey("Ocpdate") ? Ocpdate : null, this.InvocationInformation.BoundParameters.ContainsKey("TimeOut") ? TimeOut : default(int?), Endpoint, _optionsBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INodesDisableNodeSchedulingOkResponseHeaders> headers)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
