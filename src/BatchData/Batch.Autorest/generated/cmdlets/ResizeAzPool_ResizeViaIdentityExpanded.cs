...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Resize, @"AzPool_ResizeViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class ResizeAzPool_ResizeViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolResizeOptions _resizeOptionsBody = new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.BatchPoolResizeOptions();
        ...
        /// requeue.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Determines what to do with a Compute Node and its running task(s) if the Pool size is decreasing. The default value is requeue.")]
        ...
        public string NodeDeallocationOption { get => _resizeOptionsBody.NodeDeallocationOption ?? null; set => _resizeOptionsBody.NodeDeallocationOption = value; }
        ...
        public global::System.TimeSpan ResizeTimeout { get => _resizeOptionsBody.ResizeTimeout ?? default(global::System.TimeSpan); set => _resizeOptionsBody.ResizeTimeout = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The desired number of dedicated Compute Nodes in the Pool.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Batch.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public int TargetDedicatedNode { get => _resizeOptionsBody.TargetDedicatedNode ?? default(int); set => _resizeOptionsBody.TargetDedicatedNode = value; }

        /// <summary>The desired number of Spot/Low-priority Compute Nodes in the Pool.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The desired number of Spot/Low-priority Compute Nodes in the Pool.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Batch.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int TargetLowPriorityNode { get => _resizeOptionsBody.TargetLowPriorityNode ?? default(int); set => _resizeOptionsBody.TargetLowPriorityNode = value; }
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.PoolsResizePool(InputObject.PoolId ?? null, this.InvocationInformation.BoundParameters.ContainsKey("ClientRequestId") ? ClientRequestId : null, this.InvocationInformation.BoundParameters.ContainsKey("ReturnClientRequestId") ? ReturnClientRequestId : default(global::System.Management.Automation.SwitchParameter?), this.InvocationInformation.BoundParameters.ContainsKey("Ocpdate") ? Ocpdate : null, this.InvocationInformation.BoundParameters.ContainsKey("IfModifiedSince") ? IfModifiedSince : null, this.InvocationInformation.BoundParameters.ContainsKey("IfUnmodifiedSince") ? IfUnmodifiedSince : null, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, this.InvocationInformation.BoundParameters.ContainsKey("IfNoneMatch") ? IfNoneMatch : null, this.InvocationInformation.BoundParameters.ContainsKey("TimeOut") ? TimeOut : default(int?), Endpoint, _resizeOptionsBody, onAccepted, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResizeAzPool_ResizeViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public ResizeAzPool_ResizeViaIdentityExpanded()
        {
