...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets
{
    ...
    /// <summary>
    /// This is for gathering Azure Batch service log files in an automated fashion\nfrom Compute Nodes if you are experiencing
    /// an error and wish to escalate to\nAzure support. The Azure Batch service log files should be shared with Azure\nsupport
    /// to aid in debugging issues with the Batch service.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] UploadNodeLogs=>POST:"/pools/{poolId}/nodes/{nodeId}/uploadbatchservicelogs"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzUploadNodeLog_UploadExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IUploadBatchServiceLogsResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Description(@"This is for gathering Azure Batch service log files in an automated fashion\nfrom Compute Nodes if you are experiencing an error and wish to escalate to\nAzure support. The Azure Batch service log files should be shared with Azure\nsupport to aid in debugging issues with the Batch service.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.HttpPath(Path = "/pools/{poolId}/nodes/{nodeId}/uploadbatchservicelogs", ApiVersion = "2024-07-01.20.0")]
    public partial class InvokeAzUploadNodeLog_UploadExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IUploadBatchServiceLogsOptions _uploadOptionsBody = new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.UploadBatchServiceLogsOptions();
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ContainerUrl { get => _uploadOptionsBody.ContainerUrl ?? null; set => _uploadOptionsBody.ContainerUrl = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The end of the time range from which to upload Batch Service log file(s). Any log file containing a log message in the time range will be uploaded. This means that the operation might retrieve more logs than have been requested since the entire log file is always uploaded, but the operation should not retrieve fewer logs than have been requested. If omitted, the default is to upload all logs available after the startTime.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Batch.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public global::System.DateTime EndTime { get => _uploadOptionsBody.EndTime ?? default(global::System.DateTime); set => _uploadOptionsBody.EndTime = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string IdentityReferenceResourceId { get => _uploadOptionsBody.IdentityReferenceResourceId ?? null; set => _uploadOptionsBody.IdentityReferenceResourceId = value; }
        ...
        /// Protocol file.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The ID of the Compute Node for which you want to get the Remote Desktop\nProtocol file.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The ID of the Pool that contains the Compute Node.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.DateTime) })]
        public global::System.DateTime StartTime { get => _uploadOptionsBody.StartTime; set => _uploadOptionsBody.StartTime = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IUploadBatchServiceLogsResult">Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IUploadBatchServiceLogsResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IUploadBatchServiceLogsResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzUploadNodeLog_UploadExpanded" /> cmdlet class.
        /// </summary>
        public InvokeAzUploadNodeLog_UploadExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NodesUploadNodeLogs' operation"))
                {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IUploadBatchServiceLogsResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IUploadBatchServiceLogsResult
