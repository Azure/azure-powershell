...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets
{
    ...
    /// <summary>
    /// If you try to delete a Certificate that is being used by a Pool or Compute\nNode, the status of the Certificate changes
    /// to deleteFailed. If you decide that\nyou want to continue using the Certificate, you can use this operation to set\nthe
    /// status of the Certificate back to active. If you intend to delete the\nCertificate, you do not need to run this operation
    /// after the deletion failed.\nYou must make sure that the Certificate is not being used by any resources, and\nthen you
    /// can try again to delete the Certificate.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CancelCertificateDeletion=>POST:"/certificates(thumbprintAlgorithm={thumbprintAlgorithm},thumbprint={thumbprint})/canceldelete"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Stop, @"AzCertificateDeletion_Cancel", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.HttpPath(Path = "/certificates(thumbprintAlgorithm={thumbprintAlgorithm},thumbprint={thumbprint})/canceldelete", ApiVersion = "2024-07-01.20.0")]
    public partial class StopAzCertificateDeletion_Cancel : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IContext
    {
        ...
        /// <summary>The thumbprint of the Certificate being deleted.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The thumbprint of the Certificate being deleted.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The algorithm used to derive the thumbprint parameter. This must be sha1.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="headers">the header result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.ICertificatesCancelCertificateDeletionNoContentResponseHeaders"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onNoContent method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnNoContent(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.ICertificatesCancelCertificateDeletionNoContentResponseHeaders> headers, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CertificatesCancelCertificateDeletion' operation"))
                {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StopAzCertificateDeletion_Cancel" /> cmdlet class.
        /// </summary>
        public StopAzCertificateDeletion_Cancel()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onNoContent(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.ICertificatesCancelCertificateDeletionNoContentResponseHeaders> headers)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
