...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets
{
    ...
    /// <summary>
    /// This API returns the Job Preparation and Job Release Task status on all Compute\nNodes that have run the Job Preparation
    /// or Job Release Task. This includes\nCompute Nodes which have since been removed from the Pool. If this API is\ninvoked
    /// on a Job which has no Job Preparation or Job Release Task, the Batch\nservice returns HTTP status code 409 (Conflict)
    /// with an error code of\nJobPreparationTaskNotSpecified.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListJobPreparationAndReleaseTaskStatus=>GET:"/jobs/{jobId}/jobpreparationandreleasetaskstatus"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzJobPreparationAndReleaseTaskStatus_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobPreparationAndReleaseTaskStatus))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Description(@"This API returns the Job Preparation and Job Release Task status on all Compute\nNodes that have run the Job Preparation or Job Release Task. This includes\nCompute Nodes which have since been removed from the Pool. If this API is\ninvoked on a Job which has no Job Preparation or Job Release Task, the Batch\nservice returns HTTP status code 409 (Conflict) with an error code of\nJobPreparationTaskNotSpecified.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.HttpPath(Path = "/jobs/{jobId}/jobpreparationandreleasetaskstatus", ApiVersion = "2024-07-01.20.0")]
    public partial class GetAzJobPreparationAndReleaseTaskStatus_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobPreparationAndReleaseTaskStatusListResult">Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobPreparationAndReleaseTaskStatusListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobPreparationAndReleaseTaskStatusListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzJobPreparationAndReleaseTaskStatus_List" /> cmdlet class.
        /// </summary>
        public GetAzJobPreparationAndReleaseTaskStatus_List()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobPreparationAndReleaseTaskStatusListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobPreparationAndReleaseTaskStatusListResult
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.JobsListJobPreparationAndReleaseTaskStatus_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
