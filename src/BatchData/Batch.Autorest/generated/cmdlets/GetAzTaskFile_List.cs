...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListTaskFiles=>GET:"/jobs/{jobId}/tasks/{taskId}/files"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzTaskFile_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchNodeFile))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Description(@"Lists the files in a Task's directory on its Compute Node.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.HttpPath(Path = "/jobs/{jobId}/tasks/{taskId}/files", ApiVersion = "2024-07-01.20.0")]
    public partial class GetAzTaskFile_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IContext
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Whether to list children of the Task directory. This parameter can be used in\ncombination with the filter parameter to list specific type of files.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>The ID of the Task whose files you want to list.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The ID of the Task whose files you want to list.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzTaskFile_List" /> cmdlet class.
        /// </summary>
        public GetAzTaskFile_List()
        {
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.TasksListTaskFiles_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
