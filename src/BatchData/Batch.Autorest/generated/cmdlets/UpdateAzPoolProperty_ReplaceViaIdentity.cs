...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzPoolProperty_ReplaceViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzPoolProperty_ReplaceViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolReplaceOptions _pool;

        /// <summary>Parameters for replacing properties on an Azure Batch Pool.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters for replacing properties on an Azure Batch Pool.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Parameters for replacing properties on an Azure Batch Pool.",
        SerializedName = @"pool",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolReplaceOptions) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolReplaceOptions Pool { get => this._pool; set => this._pool = value; }
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.PoolsReplacePoolProperties(InputObject.PoolId ?? null, this.InvocationInformation.BoundParameters.ContainsKey("ClientRequestId") ? ClientRequestId : null, this.InvocationInformation.BoundParameters.ContainsKey("ReturnClientRequestId") ? ReturnClientRequestId : default(global::System.Management.Automation.SwitchParameter?), this.InvocationInformation.BoundParameters.ContainsKey("Ocpdate") ? Ocpdate : null, this.InvocationInformation.BoundParameters.ContainsKey("TimeOut") ? TimeOut : default(int?), Endpoint, Pool, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzPoolProperty_ReplaceViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzPoolProperty_ReplaceViaIdentity()
        {
