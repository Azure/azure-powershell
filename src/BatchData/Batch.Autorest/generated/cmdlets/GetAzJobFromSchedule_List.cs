...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListJobsFromSchedule=>GET:"/jobschedules/{jobScheduleId}/jobs"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzJobFromSchedule_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJob))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Description(@"Lists the Jobs that have been created under the specified Job Schedule.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.HttpPath(Path = "/jobschedules/{jobScheduleId}/jobs", ApiVersion = "2024-07-01.20.0")]
    public partial class GetAzJobFromSchedule_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The ID of the Job Schedule from which you want to get a list of Jobs.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzJobFromSchedule_List" /> cmdlet class.
        /// </summary>
        public GetAzJobFromSchedule_List()
        {
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.JobsListJobsFromSchedule_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
