...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models
{
    ...
    /// </summary>
    public partial class BatchJobPreparationTaskUpdate :
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobPreparationTaskUpdate,
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobPreparationTaskUpdateInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchTaskConstraints Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobPreparationTaskUpdateInternal.Constraint { get => (this._constraint = this._constraint ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.BatchTaskConstraints()); set { {_constraint = value;} } }

        /// <summary>Internal Acessors for ContainerSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchTaskContainerSettingsUpdate Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobPreparationTaskUpdateInternal.ContainerSetting { get => (this._containerSetting = this._containerSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.BatchTaskContainerSettingsUpdate()); set { {_containerSetting = value;} } }

        /// <summary>Internal Acessors for ContainerSettingRegistry</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IContainerRegistryReference Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobPreparationTaskUpdateInternal.ContainerSettingRegistry { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchTaskContainerSettingsUpdateInternal)ContainerSetting).Registry; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchTaskContainerSettingsUpdateInternal)ContainerSetting).Registry = value ?? null /* model class */; }

        /// <summary>Internal Acessors for RegistryIdentityReference</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchNodeIdentityReference Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobPreparationTaskUpdateInternal.RegistryIdentityReference { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchTaskContainerSettingsUpdateInternal)ContainerSetting).RegistryIdentityReference; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchTaskContainerSettingsUpdateInternal)ContainerSetting).RegistryIdentityReference = value ?? null /* model class */; }

        /// <summary>Internal Acessors for UserIdentity</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IUserIdentity Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobPreparationTaskUpdateInternal.UserIdentity { get => (this._userIdentity = this._userIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.UserIdentity()); set { {_userIdentity = value;} } }

        /// <summary>Internal Acessors for UserIdentityAutoUser</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IAutoUserSpecification Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobPreparationTaskUpdateInternal.UserIdentityAutoUser { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IUserIdentityInternal)UserIdentity).AutoUser; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IUserIdentityInternal)UserIdentity).AutoUser = value ?? null /* model class */; }
        ...
        /// <summary>Creates an new <see cref="BatchJobPreparationTaskUpdate" /> instance.</summary>
        public BatchJobPreparationTaskUpdate()
        {
    ...
    /// without causing any corruption or duplicate data. The best practice for long
    /// running Tasks is to use some form of checkpointing.
    public partial interface IBatchJobPreparationTaskUpdate :
    ...
    /// without causing any corruption or duplicate data. The best practice for long
    /// running Tasks is to use some form of checkpointing.
    internal partial interface IBatchJobPreparationTaskUpdateInternal
