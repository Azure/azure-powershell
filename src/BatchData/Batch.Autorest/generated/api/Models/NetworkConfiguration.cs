...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models
{
    ...
    public partial class NetworkConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INetworkConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INetworkConfigurationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolEndpointConfiguration _endpointConfiguration;

        /// <summary>The configuration for endpoints on Compute Nodes in the Batch Pool.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolEndpointConfiguration EndpointConfiguration { get => (this._endpointConfiguration = this._endpointConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.BatchPoolEndpointConfiguration()); set => this._endpointConfiguration = value; }
        ...
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchInboundNatPool> EndpointConfigurationInboundNatPool { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolEndpointConfigurationInternal)EndpointConfiguration).InboundNatPool; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolEndpointConfigurationInternal)EndpointConfiguration).InboundNatPool = value ?? null /* arrayOf */; }

        /// <summary>Internal Acessors for EndpointConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolEndpointConfiguration Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INetworkConfigurationInternal.EndpointConfiguration { get => (this._endpointConfiguration = this._endpointConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.BatchPoolEndpointConfiguration()); set { {_endpointConfiguration = value;} } }

        /// <summary>Internal Acessors for PublicIPAddressConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPublicIPAddressConfiguration Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INetworkConfigurationInternal.PublicIPAddressConfiguration { get => (this._publicIPAddressConfiguration = this._publicIPAddressConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.BatchPublicIPAddressConfiguration()); set { {_publicIPAddressConfiguration = value;} } }
...

    {
        ...
        bool? EnableAcceleratedNetworking { get; set; }
        /// <summary>The configuration for endpoints on Compute Nodes in the Batch Pool.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolEndpointConfiguration EndpointConfiguration { get; set; }
        /// <summary>
        /// A list of inbound NAT Pools that can be used to address specific ports on an individual Compute Node externally. The maximum
        /// number of inbound NAT Pools per Batch Pool is 5. If the maximum number of inbound NAT Pools is exceeded the request fails
        /// with HTTP status code 400. This cannot be specified if the IPAddressProvisioningType is NoPublicIPAddresses.
