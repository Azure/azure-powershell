...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models
{
    ...
    public partial class NodesGetNodeFileOkResponseHeaders :
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INodesGetNodeFileOkResponseHeaders,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IHeaderSerializable
    {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INodesGetNodeFileOkResponseHeadersInternal)this).ContentLength = System.Linq.Enumerable.FirstOrDefault(__contentLengthHeader0) is string __headerContentLengthHeader0 ? __headerContentLengthHeader0 : (string)null;
            }
            if (headers.TryGetValues("ETag", out var __eTagHeader1))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INodesGetNodeFileOkResponseHeadersInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader1) is string __headerETagHeader1 ? __headerETagHeader1 : (string)null;
            }
            if (headers.TryGetValues("Last-Modified", out var __lastModifiedHeader2))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INodesGetNodeFileOkResponseHeadersInternal)this).LastModified = System.Linq.Enumerable.FirstOrDefault(__lastModifiedHeader2) is string __headerLastModifiedHeader2 ? __headerLastModifiedHeader2 : (string)null;
            }
            if (headers.TryGetValues("client-request-id", out var __clientRequestIdHeader3))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INodesGetNodeFileOkResponseHeadersInternal)this).ClientRequestId = System.Linq.Enumerable.FirstOrDefault(__clientRequestIdHeader3) is string __headerClientRequestIdHeader3 ? __headerClientRequestIdHeader3 : (string)null;
            }
            if (headers.TryGetValues("ocp-batch-file-isdirectory", out var __ocpBatchFileIsdirectoryHeader4))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INodesGetNodeFileOkResponseHeadersInternal)this).OcpBatchFileIsdirectory = System.Linq.Enumerable.FirstOrDefault(__ocpBatchFileIsdirectoryHeader4) is string __headerOcpBatchFileIsdirectoryHeader4 ? bool.TryParse( __headerOcpBatchFileIsdirectoryHeader4, out bool __headerOcpBatchFileIsdirectoryHeader4Value ) ? __headerOcpBatchFileIsdirectoryHeader4Value : default(bool?) : default(bool?);
            }
            if (headers.TryGetValues("ocp-batch-file-mode", out var __ocpBatchFileModeHeader5))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INodesGetNodeFileOkResponseHeadersInternal)this).OcpBatchFileMode = System.Linq.Enumerable.FirstOrDefault(__ocpBatchFileModeHeader5) is string __headerOcpBatchFileModeHeader5 ? __headerOcpBatchFileModeHeader5 : (string)null;
            }
            if (headers.TryGetValues("ocp-batch-file-url", out var __ocpBatchFileUrlHeader6))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INodesGetNodeFileOkResponseHeadersInternal)this).OcpBatchFileUrl = System.Linq.Enumerable.FirstOrDefault(__ocpBatchFileUrlHeader6) is string __headerOcpBatchFileUrlHeader6 ? __headerOcpBatchFileUrlHeader6 : (string)null;
            }
            if (headers.TryGetValues("ocp-creation-time", out var __ocpCreationTimeHeader7))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INodesGetNodeFileOkResponseHeadersInternal)this).OcpCreationTime = System.Linq.Enumerable.FirstOrDefault(__ocpCreationTimeHeader7) is string __headerOcpCreationTimeHeader7 ? __headerOcpCreationTimeHeader7 : (string)null;
            }
            if (headers.TryGetValues("request-id", out var __requestIdHeader8))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.INodesGetNodeFileOkResponseHeadersInternal)this).RequestId = System.Linq.Enumerable.FirstOrDefault(__requestIdHeader8) is string __headerRequestIdHeader8 ? __headerRequestIdHeader8 : (string)null;
            }
        }

        /// <summary>Creates an new <see cref="NodesGetNodeFileOkResponseHeaders" /> instance.</summary>
        public NodesGetNodeFileOkResponseHeaders()
        {
    ...
    internal partial interface INodesGetNodeFileOkResponseHeadersInternal
