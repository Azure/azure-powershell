...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models
{
    ...
    public partial class BatchPoolInfoUpdate :
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolInfoUpdate,
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolInfoUpdateInternal
    {

        /// <summary>Backing field for <see cref="AutoPoolSpecification" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchAutoPoolSpecificationUpdate _autoPoolSpecification;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchAutoPoolSpecificationUpdate AutoPoolSpecification { get => (this._autoPoolSpecification = this._autoPoolSpecification ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.BatchAutoPoolSpecificationUpdate()); set => this._autoPoolSpecification = value; }
        ...
        public string AutoPoolSpecificationAutoPoolIdPrefix { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchAutoPoolSpecificationUpdateInternal)AutoPoolSpecification).AutoPoolIdPrefix; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchAutoPoolSpecificationUpdateInternal)AutoPoolSpecification).AutoPoolIdPrefix = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Inlined)]
        public bool? AutoPoolSpecificationKeepAlive { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchAutoPoolSpecificationUpdateInternal)AutoPoolSpecification).KeepAlive; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchAutoPoolSpecificationUpdateInternal)AutoPoolSpecification).KeepAlive = value ?? default(bool); }

        /// <summary>The Pool specification for the auto Pool.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolSpecificationUpdate AutoPoolSpecificationPool { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchAutoPoolSpecificationUpdateInternal)AutoPoolSpecification).Pool; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchAutoPoolSpecificationUpdateInternal)AutoPoolSpecification).Pool = value ?? null /* model class */; }

        /// <summary>
        /// The minimum lifetime of created auto Pools, and how multiple Jobs on a schedule are assigned to Pools.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Inlined)]
        public string AutoPoolSpecificationPoolLifetimeOption { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchAutoPoolSpecificationUpdateInternal)AutoPoolSpecification).PoolLifetimeOption; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchAutoPoolSpecificationUpdateInternal)AutoPoolSpecification).PoolLifetimeOption = value ?? null; }

        /// <summary>Internal Acessors for AutoPoolSpecification</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchAutoPoolSpecificationUpdate Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolInfoUpdateInternal.AutoPoolSpecification { get => (this._autoPoolSpecification = this._autoPoolSpecification ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.BatchAutoPoolSpecificationUpdate()); set { {_autoPoolSpecification = value;} } }
        ...
        /// <summary>Creates an new <see cref="BatchPoolInfoUpdate" /> instance.</summary>
        public BatchPoolInfoUpdate()
        {
    ...
    /// Specifies how a Job should be assigned to a Pool.
    internal partial interface IBatchPoolInfoUpdateInternal

    {
        ...
        /// in unexpected behavior. You must specify either the Pool ID or the auto Pool specification, but not both.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchAutoPoolSpecificationUpdate AutoPoolSpecification { get; set; }
        /// <summary>
        /// A prefix to be added to the unique identifier when a Pool is automatically created. The Batch service assigns each auto
        /// Pool a unique identifier on creation. To distinguish between Pools created for different purposes, you can specify this
        /// element to add a prefix to the ID that is assigned. The prefix can be up to 20 characters long.
