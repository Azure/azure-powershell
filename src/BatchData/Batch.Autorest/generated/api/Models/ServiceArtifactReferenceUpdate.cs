...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models
{
    ...
    public partial class ServiceArtifactReferenceUpdate :
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IServiceArtifactReferenceUpdate,
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IServiceArtifactReferenceUpdateInternal
    {
        ...
        /// <summary>Creates an new <see cref="ServiceArtifactReferenceUpdate" /> instance.</summary>
        public ServiceArtifactReferenceUpdate()
        {
    ...
    /// Specifies the service artifact reference id used to set same image version
    /// for all virtual machines in the scale set when using 'latest' image version.
    internal partial interface IServiceArtifactReferenceUpdateInternal
