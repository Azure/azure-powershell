...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models
{
    ...
    public partial class BatchJobCreateOptions :
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobCreateOptions,
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobCreateOptionsInternal
    {
        ...
        /// the Job Release Task is to undo changes to Compute Nodes made by the Job Preparation Task. Example activities include
        /// deleting local files, or shutting down services that were started as part of Job preparation.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Owned)]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobConstraints Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobCreateOptionsInternal.Constraint { get => (this._constraint = this._constraint ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.BatchJobConstraints()); set { {_constraint = value;} } }

        /// <summary>Internal Acessors for ContainerSettingRegistry</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IContainerRegistryReference Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobCreateOptionsInternal.ContainerSettingRegistry { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobReleaseTaskInternal)JobReleaseTask).ContainerSettingRegistry; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobReleaseTaskInternal)JobReleaseTask).ContainerSettingRegistry = value ?? null /* model class */; }

        /// <summary>Internal Acessors for JobReleaseTask</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobReleaseTask Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobCreateOptionsInternal.JobReleaseTask { get => (this._jobReleaseTask = this._jobReleaseTask ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.BatchJobReleaseTask()); set { {_jobReleaseTask = value;} } }

        /// <summary>Internal Acessors for JobReleaseTaskContainerSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchTaskContainerSettings Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobCreateOptionsInternal.JobReleaseTaskContainerSetting { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobReleaseTaskInternal)JobReleaseTask).ContainerSetting; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobReleaseTaskInternal)JobReleaseTask).ContainerSetting = value ?? null /* model class */; }

        /// <summary>Internal Acessors for JobReleaseTaskUserIdentity</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IUserIdentity Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobCreateOptionsInternal.JobReleaseTaskUserIdentity { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobReleaseTaskInternal)JobReleaseTask).UserIdentity; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobReleaseTaskInternal)JobReleaseTask).UserIdentity = value ?? null /* model class */; }

        /// <summary>Internal Acessors for NetworkConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobNetworkConfiguration Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobCreateOptionsInternal.NetworkConfiguration { get => (this._networkConfiguration = this._networkConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.BatchJobNetworkConfiguration()); set { {_networkConfiguration = value;} } }

        /// <summary>Internal Acessors for PoolInfo</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolInfo Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobCreateOptionsInternal.PoolInfo { get => (this._poolInfo = this._poolInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.BatchPoolInfo()); set { {_poolInfo = value;} } }

        /// <summary>Internal Acessors for PoolInfoAutoPoolSpecification</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchAutoPoolSpecification Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobCreateOptionsInternal.PoolInfoAutoPoolSpecification { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolInfoInternal)PoolInfo).AutoPoolSpecification; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchPoolInfoInternal)PoolInfo).AutoPoolSpecification = value ?? null /* model class */; }

        /// <summary>Internal Acessors for RegistryIdentityReference</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchNodeIdentityReference Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobCreateOptionsInternal.RegistryIdentityReference { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobReleaseTaskInternal)JobReleaseTask).RegistryIdentityReference; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobReleaseTaskInternal)JobReleaseTask).RegistryIdentityReference = value ?? null /* model class */; }

        /// <summary>Internal Acessors for UserIdentityAutoUser</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IAutoUserSpecification Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobCreateOptionsInternal.UserIdentityAutoUser { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobReleaseTaskInternal)JobReleaseTask).UserIdentityAutoUser; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.IBatchJobReleaseTaskInternal)JobReleaseTask).UserIdentityAutoUser = value ?? null /* model class */; }
        ...
        /// <summary>Creates an new <see cref="BatchJobCreateOptions" /> instance.</summary>
    ...
    /// Parameters for creating an Azure Batch Job.
    internal partial interface IBatchJobCreateOptionsInternal
