...
### List (Default)
```
Get-AzMdpPool [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-AzMdpPool -InputObject <IMdpIdentity> [-DefaultProfile <PSObject>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
