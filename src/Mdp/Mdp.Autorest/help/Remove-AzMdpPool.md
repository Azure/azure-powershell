...
external help file:
Module Name: Az.Mdp
online version: https://learn.microsoft.com/powershell/module/az.mdp/remove-azmdppool
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzMdpPool -InputObject <IMdpIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
