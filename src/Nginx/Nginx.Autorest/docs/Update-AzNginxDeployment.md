...
Update-AzNginxDeployment -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-UserAssignedIdentity <String[]>] [-UserProfilePreferredEmail <String>] [-DefaultProfile <PSObject>]
...
Update-AzNginxDeployment -InputObject <INginxIdentity> [-AutoScaleSettingProfile <IScaleProfile[]>]
 [-AutoUpgradeProfileUpgradeChannel <String>] [-EnableDiagnosticsSupport]
 [-EnableSystemAssignedIdentity <Boolean?>] [-Location <String>] [-NetworkProfile <INginxNetworkProfile>]
...
```
Update-AzNginxDeployment -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### UpdateViaJsonString
```
Update-AzNginxDeployment -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
