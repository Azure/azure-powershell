...
Describe 'New-AzNginxDeployment' {
    It 'CreateExpanded' {
        ...
        $nginxDeployment = New-AzNginxDeployment -Name $env.nginxDeployment2 -ResourceGroupName $env.resourceGroup -Location eastus -NetworkProfile $networkProfile -SkuName preview_Monthly_gmz7xq9ge3py
