...
$psd1 = Join-Path $PSScriptRoot './Az.Nginx.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: Nginx cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.Nginx.format.ps1xml'
