...
namespace Microsoft.Azure.Management.NotificationHubs
{
    ...
    public partial class NotificationHubsManagementClient : Microsoft.Rest.ServiceClient<NotificationHubsManagementClient>, INotificationHubsManagementClient, IAzureClient
    {
        ...
        protected NotificationHubsManagementClient(System.Net.Http.HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            this.Initialize();
        }
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public NotificationHubsManagementClient(Microsoft.Rest.ServiceClientCredentials credentials, System.Net.Http.HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
        ...
        private void Initialize()
        {
            ...
            this.Name = new NameOperations(this);
