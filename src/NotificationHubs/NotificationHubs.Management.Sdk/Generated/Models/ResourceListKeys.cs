...
namespace Microsoft.Azure.Management.NotificationHubs.Models
{
    ...
    public partial class ResourceListKeys
    {
        ...
        /// <param name="primaryConnectionString">PrimaryConnectionString of the AuthorizationRule.
        /// </param>

        /// <param name="secondaryConnectionString">SecondaryConnectionString of the created AuthorizationRule
        /// </param>

        /// <param name="primaryKey">PrimaryKey of the created AuthorizationRule.
        /// </param>

        /// <param name="secondaryKey">SecondaryKey of the created AuthorizationRule
        /// </param>

        /// <param name="keyName">KeyName of the created AuthorizationRule
        /// </param>
