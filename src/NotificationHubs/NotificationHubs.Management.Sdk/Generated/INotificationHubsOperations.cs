...
namespace Microsoft.Azure.Management.NotificationHubs
{
    ...
    public partial interface INotificationHubsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<CheckAvailabilityResult>> CheckAvailabilityWithHttpMessagesAsync(string resourceGroupName, string namespaceName, CheckAvailabilityParameters parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
