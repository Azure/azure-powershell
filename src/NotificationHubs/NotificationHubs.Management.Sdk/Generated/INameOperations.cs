...
namespace Microsoft.Azure.Management.NotificationHubs
{
    ...
    public partial interface INameOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<CheckNameAvailabilityResponse>> CheckAvailabilityWithHttpMessagesAsync(CheckNameAvailabilityRequestParameters parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
