...
namespace Microsoft.Azure.Management.NotificationHubs
{
    ...
    public static partial class NotificationHubsOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<CheckAvailabilityResult> CheckAvailabilityAsync(this INotificationHubsOperations operations, string resourceGroupName, string namespaceName, CheckAvailabilityParameters parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
