...
namespace Microsoft.Azure.Management.NotificationHubs
{
    ...
    internal partial class NameOperations : IServiceOperations<NotificationHubsManagementClient>, INameOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<CheckNameAvailabilityResponse>> CheckAvailabilityWithHttpMessagesAsync(CheckNameAvailabilityRequestParameters parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (parameters == null)
            {
