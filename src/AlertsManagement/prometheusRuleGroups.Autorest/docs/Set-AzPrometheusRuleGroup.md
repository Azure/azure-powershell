...
online version: https://learn.microsoft.com/powershell/module/az.alertsmanagement/set-azprometheusrulegroup
schema: 2.0.0
---

# Set-AzPrometheusRuleGroup
...
### Update (Default)
```
Set-AzPrometheusRuleGroup -ResourceGroupName <String> -RuleGroupName <String>
...
### UpdateExpanded
```
Set-AzPrometheusRuleGroup -ResourceGroupName <String> -RuleGroupName <String> -Location <String>
