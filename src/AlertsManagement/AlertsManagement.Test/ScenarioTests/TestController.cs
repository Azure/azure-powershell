...
namespace Microsoft.Azure.Commands.AlertsManagement.Test.ScenarioTests
{
    public class TestController : RMTestBase
    {
        ...
        public AlertsManagementClient AlertsManagementClient { get; private set; }
        ...
        protected void SetupManagementClients(MockContext context)
        {
            ...
            AlertsManagementClient = GetBillingManagementClient(context);
        ...
        private static AlertsManagementClient GetBillingManagementClient(MockContext context)
        {
            return context.GetServiceClient<AlertsManagementClient>(TestEnvironmentFactory.GetTestEnvironment());
        }
    }
}
