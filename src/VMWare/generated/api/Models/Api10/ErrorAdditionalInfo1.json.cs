namespace Microsoft.Azure.PowerShell.Cmdlets.VMWare.Models.Api10
{
    ...
    public partial class ErrorAdditionalInfo1
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.VMWare.Runtime.Json.JsonObject into a new instance of <see cref="ErrorAdditionalInfo1" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.VMWare.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ErrorAdditionalInfo1(Microsoft.Azure.PowerShell.Cmdlets.VMWare.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMWare.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.VMWare.Models.Api10.IErrorAdditionalInfo1.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMWare.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.VMWare.Models.Api10.IErrorAdditionalInfo1.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.VMWare.Models.Api10.IErrorAdditionalInfo1 FromJson(Microsoft.Azure.PowerShell.Cmdlets.VMWare.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.VMWare.Runtime.Json.JsonObject json ? new ErrorAdditionalInfo1(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ErrorAdditionalInfo1" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMWare.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ErrorAdditionalInfo1" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMWare.Runtime.Json.JsonNode" />.
        /// </returns>
