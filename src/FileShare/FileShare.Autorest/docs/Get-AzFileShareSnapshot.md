...
### GetViaIdentity
```
Get-AzFileShareSnapshot -InputObject <IFileShareIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityFileShare
```
Get-AzFileShareSnapshot -FileShareInputObject <IFileShareIdentity> -Name <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Get, GetViaIdentityFileShare
Aliases:
