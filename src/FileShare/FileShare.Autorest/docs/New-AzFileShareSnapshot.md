...
online version: https://learn.microsoft.com/powershell/module/az.fileshare/new-azfilesharesnapshot
schema: 2.0.0
---
...
```
New-AzFileShareSnapshot -FileShareInputObject <IFileShareIdentity> -Name <String> [-Metadata <Hashtable>]
...
### CreateViaJsonString
```
New-AzFileShareSnapshot -Name <String> -ResourceGroupName <String> -ResourceName <String> -JsonString <String>
...
Parameter Sets: CreateViaIdentityFileShareExpanded
Aliases:
