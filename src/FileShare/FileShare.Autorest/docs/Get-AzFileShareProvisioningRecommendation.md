...
### GetExpanded (Default)
```
Get-AzFileShareProvisioningRecommendation -Location <String> -ProvisionedStorageGiB <Int32>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Get
```
Get-AzFileShareProvisioningRecommendation -Location <String>
...
### GetViaJsonFilePath
```
Get-AzFileShareProvisioningRecommendation -Location <String> -JsonFilePath <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaJsonString
```
Get-AzFileShareProvisioningRecommendation -Location <String> -JsonString <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
