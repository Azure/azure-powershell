...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.FileShare.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.FileShare.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: FileShare cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.FileShare.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.FileShare","ModuleRootName":"$(root-module-name)"}' -AsHashtable
