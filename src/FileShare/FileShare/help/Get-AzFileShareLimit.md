...
online version: https://learn.microsoft.com/powershell/module/az.fileshare/get-azfilesharelimit
schema: 2.0.0
---

# Get-AzFileShareLimit
...
### Get (Default)
```
Get-AzFileShareLimit -Location <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzFileShareLimit -InputObject <IFileShareIdentity> [-DefaultProfile <PSObject>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
