...
### GetExpanded (Default)
```
Get-AzFileShareInformationalOperationProvisioningRecommendation -Location <String> [-SubscriptionId <String[]>]
 -ProvisionedStorageGiB <Int32> [-DefaultProfile <PSObject>] [-WhatIf]
...
```
Get-AzFileShareInformationalOperationProvisioningRecommendation -Location <String> [-SubscriptionId <String[]>]
 -Body <IFileShareProvisioningRecommendationRequest> [-DefaultProfile <PSObject>]
