...
{
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzurePrefix + "BatchSubtask", DefaultParameterSetName = Constants.ODataFilterParameterSet),OutputType(typeof(PSSubtaskInformation))]
