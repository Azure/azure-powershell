...
-->
## Upcoming Release
* Updated the implementation of NewBatchApplicationPackage command to not call GetBatchApplicationPackage to retrieve storage keys for security improvements. No behavior changes to the command.
