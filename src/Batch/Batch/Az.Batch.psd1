...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated the implementation of ''New-AzBatchApplicationPackage'' cmdlet to not call ''Get-AzBatchApplicationPackage'' to retrieve storage keys for security improvements. No behavior changes to the cmdlet.'
