...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed module load conflict by aligning ''Microsoft.ApplicationInsights'' to the common 2.18.0 dependency version, resolving ''Assembly with same name is already loaded'' error.'
