...
```
New-AzBatchAccount -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Location <String> [-AccountAccessDefaultAction <String>] [-AccountAccessIPRule <IIPRule[]>]
