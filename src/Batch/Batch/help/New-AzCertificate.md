...
```
New-AzCertificate -Name <String> -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-IfMatch <String>] [-IfNoneMatch <String>] [-Format <String>] [-Password <String>] [-Tag <Hashtable>]
 [-Thumbprint <String>] [-ThumbprintAlgorithm <String>] [-DefaultProfile <PSObject>]
...
```
New-AzCertificate -Name <String> -BatchAccountInputObject <IBatchIdentity> [-IfMatch <String>]
