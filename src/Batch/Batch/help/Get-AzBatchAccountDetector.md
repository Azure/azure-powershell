...
```
Get-AzBatchAccountDetector -DetectorId <String> -BatchAccountInputObject <IBatchIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzBatchAccountDetector -InputObject <IBatchIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
