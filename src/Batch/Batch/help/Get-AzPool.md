...
Get-AzPool -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>] [-Filter <String>]
 [-Maxresult <Int32>] [-Select <String>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
```
Get-AzPool -Name <String> -BatchAccountInputObject <IBatchIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzPool -InputObject <IBatchIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
