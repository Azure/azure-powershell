...
```
Stop-AzCertificateDeletion -CertificateName <String> -BatchAccountInputObject <IBatchIdentity>
 [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-AzCertificateDeletion -InputObject <IBatchIdentity> [-DefaultProfile <PSObject>]
