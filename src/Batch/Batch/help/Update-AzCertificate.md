...
```
Update-AzCertificate -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-IfMatch <String>] -JsonString <String> [-DefaultProfile <PSObject>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
Update-AzCertificate -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-IfMatch <String>] -JsonFilePath <String> [-DefaultProfile <PSObject>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityBatchAccountExpanded
```
Update-AzCertificate -Name <String> -BatchAccountInputObject <IBatchIdentity> [-IfMatch <String>]
 [-Data <String>] [-Format <String>] [-Password <String>] [-Tag <Hashtable>] [-Thumbprint <String>]
 [-ThumbprintAlgorithm <String>] [-DefaultProfile <PSObject>] [-WhatIf]
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaJsonString, UpdateViaJsonFilePath, UpdateViaIdentityBatchAccountExpanded
