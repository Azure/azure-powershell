...
online version: https://learn.microsoft.com/powershell/module/az.batch/new-azapplicationpackage
schema: 2.0.0
---

# New-AzApplicationPackage
...
```
New-AzApplicationPackage -VersionName <String> -AccountName <String> -ApplicationName <String>
...
```
New-AzApplicationPackage -VersionName <String> -ApplicationName <String>
...
```
New-AzApplicationPackage -VersionName <String> -ApplicationInputObject <IBatchIdentity> [-Tag <Hashtable>]
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded, CreateViaJsonString, CreateViaJsonFilePath, CreateViaIdentityBatchAccountExpanded
Aliases:
...
Parameter Sets: CreateExpanded, CreateViaIdentityBatchAccountExpanded, CreateViaIdentityApplicationExpanded
Aliases:
