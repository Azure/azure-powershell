...
```
Test-AzLocationNameAvailability -LocationName <String> [-SubscriptionId <String>] -Name <String>
 [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CheckViaJsonString
```
Test-AzLocationNameAvailability -LocationName <String> [-SubscriptionId <String>] -JsonString <String>
 [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CheckViaJsonFilePath
```
Test-AzLocationNameAvailability -LocationName <String> [-SubscriptionId <String>] -JsonFilePath <String>
 [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Check
```
Test-AzLocationNameAvailability -LocationName <String> [-SubscriptionId <String>]
 -Parameter <ICheckNameAvailabilityParameters> [-DefaultProfile <PSObject>]
