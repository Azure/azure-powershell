...
### Get
```
Get-AzApplication -AccountName <String> -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityBatchAccount
```
Get-AzApplication -Name <String> -BatchAccountInputObject <IBatchIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzApplication -InputObject <IBatchIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
