...
namespace Microsoft.Azure.Commands.Batch.Models
{
    ...
    public partial class PSComputeNode
    {
        ...
        private PSVirtualMachineInfo virtualMachineInfo;
        ...
        public System.Int32? RunningTaskSlotsCount
        {
            get
            {
                return this.omObject.RunningTaskSlotsCount;
            }
        }
        ...
        public PSVirtualMachineInfo VirtualMachineInfo
        {
            get
            {
                if (((this.virtualMachineInfo == null) 
                            && (this.omObject.VirtualMachineInfo != null)))
                {
                    this.virtualMachineInfo = new PSVirtualMachineInfo(this.omObject.VirtualMachineInfo);
                }
