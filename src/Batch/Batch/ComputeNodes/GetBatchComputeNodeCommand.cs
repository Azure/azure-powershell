...
{
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzurePrefix + "BatchComputeNode", DefaultParameterSetName = Constants.ODataFilterParameterSet),OutputType(typeof(PSComputeNode))]
