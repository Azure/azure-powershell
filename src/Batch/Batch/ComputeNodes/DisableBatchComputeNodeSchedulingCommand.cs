...
{
    [Cmdlet("Disable", ResourceManager.Common.AzureRMConstants.AzurePrefix + "BatchComputeNodeScheduling", DefaultParameterSetName = Constants.IdParameterSet), OutputType(typeof(void))]
