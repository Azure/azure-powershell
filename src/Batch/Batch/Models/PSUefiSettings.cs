...
namespace Microsoft.Azure.Commands.Batch.Models
{
    ...
    {
        internal static PSUefiSettings fromMgmtUefiSettings(UefiSettings uefiSettings)
        {
            if (uefiSettings == null)
            {
                return null;
            }
            return new PSUefiSettings()
            {
        ...
        internal UefiSettings toMgmtUefiSettings()
        {
            return new UefiSettings()
            {
