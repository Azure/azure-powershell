...
namespace Microsoft.Azure.Management.Batch
{
    ...
    /// </summary>
    internal partial class NetworkSecurityPerimeterOperations : Microsoft.Rest.IServiceOperations<BatchManagementClient>, INetworkSecurityPerimeterOperations
    {
        /// <summary>
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationHeaderResponse<NetworkSecurityPerimeterReconcileConfigurationHeaders> _response = await BeginReconcileConfigurationWithHttpMessagesAsync(resourceGroupName, accountName, networkSecurityPerimeterConfigurationName, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationHeaderResponse<NetworkSecurityPerimeterReconcileConfigurationHeaders>> BeginReconcileConfigurationWithHttpMessagesAsync(string resourceGroupName, string accountName, string networkSecurityPerimeterConfigurationName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationHeaderResponse<NetworkSecurityPerimeterReconcileConfigurationHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<NetworkSecurityPerimeterReconcileConfigurationHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
            catch (Newtonsoft.Json.JsonException ex)
            {
                _httpRequest.Dispose();
