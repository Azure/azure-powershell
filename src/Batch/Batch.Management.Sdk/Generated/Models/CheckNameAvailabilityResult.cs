...
namespace Microsoft.Azure.Management.Batch.Models
{
    ...
    public partial class CheckNameAvailabilityResult
    {
        ...
        /// <param name="nameAvailable">Gets a boolean value that indicates whether the name is available for you
        /// to use. If true, the name is available. If false, the name has already been
        /// taken or invalid and cannot be used.
        /// </param>

        /// <param name="reason">Gets the reason that a Batch account name could not be used. The Reason
        ...
        /// <summary>
        /// Gets gets a boolean value that indicates whether the name is available for
        /// you to use. If true, the name is available. If false, the name has already
        ...
        /// <summary>
        /// Gets gets the reason that a Batch account name could not be used. The
        /// Reason element is only returned if NameAvailable is false. Possible values include: &#39;Invalid&#39;, &#39;AlreadyExists&#39;
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "reason")]
        public NameAvailabilityReason? Reason {get; private set; }

        /// <summary>
        /// Gets gets an error message explaining the Reason value in more detail.
        /// </summary>
