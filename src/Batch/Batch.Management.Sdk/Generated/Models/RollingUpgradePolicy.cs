...
namespace Microsoft.Azure.Management.Batch.Models
{
    ...
    public partial class RollingUpgradePolicy
    {
        ...
        /// <param name="enableCrossZoneUpgrade">Allow VMSS to ignore AZ boundaries when constructing upgrade batches. Take
        ...
        /// <param name="maxBatchInstancePercent">The maximum percent of total virtual machine instances that will be
        ...
        /// <param name="maxUnhealthyInstancePercent">The maximum percentage of the total virtual machine instances in the scale
        ...
        /// <param name="maxUnhealthyUpgradedInstancePercent">The maximum percentage of upgraded virtual machine instances that can be
        ...
        /// <param name="pauseTimeBetweenBatches">The wait time between completing the update for all virtual machines in one
        /// batch and starting the next batch. The time duration should be specified in
        /// ISO 8601 format.
        /// </param>

        /// <param name="prioritizeUnhealthyInstances">Upgrade all unhealthy instances in a scale set before any healthy
        /// instances.
        /// </param>

        /// <param name="rollbackFailedInstancesOnPolicyBreach">Rollback failed instances to previous model if the Rolling Upgrade policy
        /// is violated.
        /// </param>
