...
### GetViaIdentity
```
Get-AzApplicationPackage -InputObject <IBatchIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityApplication
```
Get-AzApplicationPackage -ApplicationInputObject <IBatchIdentity> -VersionName <String>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityBatchAccount
```
Get-AzApplicationPackage -ApplicationName <String> -BatchAccountInputObject <IBatchIdentity>
...
```yaml
Type: System.String
Parameter Sets: Get, GetViaIdentityBatchAccount, List
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Get, GetViaIdentityApplication, GetViaIdentityBatchAccount
Aliases:
