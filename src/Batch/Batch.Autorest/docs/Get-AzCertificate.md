...
### Get
```
Get-AzCertificate -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzCertificate -InputObject <IBatchIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityBatchAccount
```
Get-AzCertificate -BatchAccountInputObject <IBatchIdentity> -Name <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
