...
### StopViaIdentity
```
Stop-AzPoolResize -InputObject <IBatchIdentity> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### StopViaIdentityBatchAccount
```
Stop-AzPoolResize -BatchAccountInputObject <IBatchIdentity> -PoolName <String> [-DefaultProfile <PSObject>]
