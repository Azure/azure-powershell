...
online version: https://learn.microsoft.com/powershell/module/az.batch/update-azapplication
schema: 2.0.0
---
...
```
Update-AzApplication -AccountName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzApplication -BatchAccountInputObject <IBatchIdentity> -Name <String> [-AllowUpdate]
...
```
Update-AzApplication -InputObject <IBatchIdentity> [-AllowUpdate] [-DefaultVersion <String>]
...
```
Update-AzApplication -AccountName <String> -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaJsonString
```
Update-AzApplication -AccountName <String> -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
