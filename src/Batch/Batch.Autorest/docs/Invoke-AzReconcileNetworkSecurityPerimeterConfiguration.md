...
```
Invoke-AzReconcileNetworkSecurityPerimeterConfiguration -BatchAccountInputObject <IBatchIdentity>
 -NetworkSecurityPerimeterConfigurationName <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
