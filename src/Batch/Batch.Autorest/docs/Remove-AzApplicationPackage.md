...
### DeleteViaIdentity
```
Remove-AzApplicationPackage -InputObject <IBatchIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentityApplication
```
Remove-AzApplicationPackage -ApplicationInputObject <IBatchIdentity> -VersionName <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentityBatchAccount
```
Remove-AzApplicationPackage -ApplicationName <String> -BatchAccountInputObject <IBatchIdentity>
 -VersionName <String> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Delete, DeleteViaIdentityApplication, DeleteViaIdentityBatchAccount
Aliases:
