if(($null -eq $TestName) -or ($TestName -contains 'New-AzEdgeOrderOrderItemDetailsObject'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-AzEdgeOrderOrderItemDetailsObject.Recording.json'
...
Describe 'New-AzEdgeOrderOrderItemDetailsObject' {
