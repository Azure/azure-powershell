...
.Link
https://learn.microsoft.com/powershell/module/az.astro/remove-azastroorganization
#>
function Remove-AzAstroOrganization {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.Astro.private\Remove-AzAstroOrganization_Delete';
