...
namespace Microsoft.Azure.PowerShell.Cmdlets.Astro.Models
{
    ...
    public partial class LiftrBaseDataOrganizationProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Astro.Models.ILiftrBaseDataOrganizationProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Astro.Models.ILiftrBaseDataOrganizationProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Astro.Models.ILiftrBaseDataOrganizationProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonObject json ? new LiftrBaseDataOrganizationProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonObject into a new instance of <see cref="LiftrBaseDataOrganizationProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal LiftrBaseDataOrganizationProperties(Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonObject json)
        {
            ...
            {_marketplace = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonObject>("marketplace"), out var __jsonMarketplace) ? Microsoft.Azure.PowerShell.Cmdlets.Astro.Models.LiftrBaseMarketplaceDetails.FromJson(__jsonMarketplace) : _marketplace;}
            {_user = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonObject>("user"), out var __jsonUser) ? Microsoft.Azure.PowerShell.Cmdlets.Astro.Models.LiftrBaseUserDetails.FromJson(__jsonUser) : _user;}
            {_partnerOrganizationProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonObject>("partnerOrganizationProperties"), out var __jsonPartnerOrganizationProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Astro.Models.LiftrBaseDataPartnerOrganizationProperties.FromJson(__jsonPartnerOrganizationProperties) : _partnerOrganizationProperty;}
            {_provisioningState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonString>("provisioningState"), out var __jsonProvisioningState) ? (string)__jsonProvisioningState : (string)_provisioningState;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="LiftrBaseDataOrganizationProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="LiftrBaseDataOrganizationProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.SerializationMode.IncludeRead)||serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.SerializationMode.IncludeCreate))
            {
            ...
            {
                AddIf( null != (((object)this._provisioningState)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonString(this._provisioningState.ToString()) : null, "provisioningState" ,container.Add );
            }
