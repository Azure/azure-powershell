...
external help file:
Module Name: Az.Logz
online version: https://docs.microsoft.com/powershell/module/az.logz/get-azlogzaccountvmhostupdate
schema: 2.0.0
---

# Get-AzLogzAccountVMHostUpdate
...
```
Get-AzLogzAccountVMHostUpdate -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
