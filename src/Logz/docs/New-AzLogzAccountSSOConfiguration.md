...
external help file:
Module Name: Az.Logz
online version: https://docs.microsoft.com/powershell/module/az.logz/new-azlogzaccountssoconfiguration
schema: 2.0.0
---

# New-AzLogzAccountSSOConfiguration
...
```
New-AzLogzAccountSSOConfiguration -AccountName <String> -Name <String> -ResourceGroupName <String>
