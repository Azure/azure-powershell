...
external help file:
Module Name: Az.Logz
online version: https://docs.microsoft.com/powershell/module/az.logz/update-azlogzaccount
schema: 2.0.0
---

# Update-AzLogzAccount
...
```
Update-AzLogzAccount -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzLogzAccount -InputObject <ILogzIdentity> [-MonitoringStatus <MonitoringStatus>] [-Tag <Hashtable>]
