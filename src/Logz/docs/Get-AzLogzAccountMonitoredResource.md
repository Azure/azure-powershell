...
# Get-AzLogzAccountMonitoredResource
...
### ListByAccount (Default)
```
Get-AzLogzAccountMonitoredResource -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ListBySubAccount
```
Get-AzLogzAccountMonitoredResource -Name <String> -ResourceGroupName <String> -SubAccountName <String>
