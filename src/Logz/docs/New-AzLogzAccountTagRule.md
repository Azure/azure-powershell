...
external help file:
Module Name: Az.Logz
online version: https://docs.microsoft.com/powershell/module/az.logz/new-azlogzaccounttagrule
schema: 2.0.0
---

# New-AzLogzAccountTagRule
...
```
New-AzLogzAccountTagRule -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
