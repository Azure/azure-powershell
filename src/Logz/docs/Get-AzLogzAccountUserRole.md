...
external help file:
Module Name: Az.Logz
online version: https://docs.microsoft.com/powershell/module/az.logz/get-azlogzaccountuserrole
schema: 2.0.0
---

# Get-AzLogzAccountUserRole
...
```
Get-AzLogzAccountUserRole -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
