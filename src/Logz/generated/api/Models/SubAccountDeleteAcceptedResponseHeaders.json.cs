...
namespace Microsoft.Azure.PowerShell.Cmdlets.Logz.Models
{
    ...
    public partial class SubAccountDeleteAcceptedResponseHeaders
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.ISubAccountDeleteAcceptedResponseHeaders.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.ISubAccountDeleteAcceptedResponseHeaders.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.ISubAccountDeleteAcceptedResponseHeaders FromJson(Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject json ? new SubAccountDeleteAcceptedResponseHeaders(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject into a new instance of <see cref="SubAccountDeleteAcceptedResponseHeaders" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SubAccountDeleteAcceptedResponseHeaders(Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SubAccountDeleteAcceptedResponseHeaders" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SubAccountDeleteAcceptedResponseHeaders" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
