...
namespace Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001Preview
{
    ...
    public partial class VMResources
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001Preview.IVMResources.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001Preview.IVMResources.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001Preview.IVMResources FromJson(Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject json ? new VMResources(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="VMResources" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="VMResources" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._agentVersion)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonString(this._agentVersion.ToString()) : null, "agentVersion" ,container.Add );
            AfterToJson(ref container);
            return container;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject into a new instance of <see cref="VMResources" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal VMResources(Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_agentVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonString>("agentVersion"), out var __jsonAgentVersion) ? (string)__jsonAgentVersion : (string)AgentVersion;}
            AfterFromJson(json);
        }
    }
}