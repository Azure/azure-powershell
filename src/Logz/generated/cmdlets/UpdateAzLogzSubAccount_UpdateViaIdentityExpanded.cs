...
namespace Microsoft.Azure.PowerShell.Cmdlets.Logz.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logz/monitors/{monitorName}/accounts/{subAccountName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzLogzSubAccount_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Logz.Description(@"Update a monitor resource.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Logz.Generated]
    public partial class UpdateAzLogzSubAccount_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001Preview.ILogzMonitorResourceUpdateParameters _body= new Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001Preview.LogzMonitorResourceUpdateParameters();

        /// <summary>The parameters for a PATCH request to a monitor resource.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001Preview.ILogzMonitorResourceUpdateParameters Body { get => this._body; set => this._body = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.ILogzIdentity _inputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.ILogzIdentity InputObject { get => this._inputObject; set => this._inputObject = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001Preview.ILogzMonitorResourceUpdateParametersTags Tag { get => Body.Tag ?? null /* object */; set => Body.Tag = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SubAccountUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.SubAccountUpdateViaIdentity(InputObject.Id, Body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.SubAccountName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.SubAccountName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.SubAccountUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.MonitorName ?? null, InputObject.SubAccountName ?? null, Body, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzLogzSubAccount_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzLogzSubAccount_UpdateViaIdentityExpanded()
        {
