...
namespace Microsoft.Azure.PowerShell.Cmdlets.Logz.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Logz.Support.ProvisioningState Accepted = @"Accepted";

        public static Microsoft.Azure.PowerShell.Cmdlets.Logz.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Logz.Support.ProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.Logz.Support.ProvisioningState Deleted = @"Deleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.Logz.Support.ProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.Logz.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Logz.Support.ProvisioningState NotSpecified = @"NotSpecified";

        public static Microsoft.Azure.PowerShell.Cmdlets.Logz.Support.ProvisioningState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.Logz.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Logz.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Logz.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Logz.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.Logz.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
