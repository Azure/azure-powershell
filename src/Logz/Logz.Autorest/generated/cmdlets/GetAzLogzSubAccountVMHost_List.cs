...
namespace Microsoft.Azure.PowerShell.Cmdlets.Logz.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Logz.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logz/monitors/{monitorName}/accounts/{subAccountName}/listVMHosts", ApiVersion = "2020-10-01-preview")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SubAccountListVMHosts(SubscriptionId, ResourceGroupName, MonitorName, Name, onOk, onDefault, this, Pipeline);
