...
namespace Microsoft.Azure.PowerShell.Cmdlets.Logz.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001Preview.IUserRoleRequest Body { get => this._body; set => this._body = value; }
        ...
        public string EmailAddress { get => Body.EmailAddress ?? null; set => Body.EmailAddress = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001Preview.IUserRoleListResponse"
        /// /> from the remote call</param>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.MonitorsListUserRoles(SubscriptionId, ResourceGroupName, Name, Body, onOk, onDefault, this, Pipeline);
