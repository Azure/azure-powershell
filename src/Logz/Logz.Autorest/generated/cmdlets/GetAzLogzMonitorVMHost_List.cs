...
namespace Microsoft.Azure.PowerShell.Cmdlets.Logz.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Logz.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logz/monitors/{monitorName}/listVMHosts", ApiVersion = "2020-10-01-preview")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001Preview.IVMResourcesListResponse">Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001Preview.IVMResourcesListResponse</see>
        /// from the remote call</param>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.MonitorListVMHosts(SubscriptionId, ResourceGroupName, Name, onOk, onDefault, this, Pipeline);
