...
### CreateViaIdentity
```
New-AzAlbFrontend -InputObject <IAlbIdentity> -Resource <IFrontend> [-DefaultProfile <PSObject>] [-AsJob]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Alb.Models.Api20230501Preview.IFrontend
Parameter Sets: CreateViaIdentity
Aliases:
...
`RESOURCE <IFrontend>`: Frontend Subresource of Traffic Controller.
