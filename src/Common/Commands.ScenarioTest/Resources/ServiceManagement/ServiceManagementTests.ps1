...
function Run-AutoGeneratedHostedServiceCmdletTests
{
    ...
    {
        # Create Parameters
        $svcCreateParams = New-AzureComputeArgumentList -TypeName 'HostedServiceCreateParameters';
        ...
        # Update Parameters
        $svcUpdateParams = New-AzureComputeArgumentList -TypeName 'HostedServiceUpdateParameters';
...
function Run-AutoGeneratedVirtualMachineCmdletTests
{
    ...
    try
    {
        ...
        $vmDeployment.Roles = New-AzureComputeArgumentList -TypeName 'VirtualMachineRoleList';
        $vmDeployment.Roles.Add((New-AzureComputeArgumentList -TypeName 'VirtualMachineRole'));
        ...
        $vmDeployment.Roles[0].OSVirtualHardDisk = New-AzureComputeArgumentList -TypeName 'VirtualMachineOSVirtualHardDisk';
        ...
        $vmDeployment.Roles[0].ConfigurationSets = New-AzureComputeArgumentList -TypeName 'VirtualMachineConfigurationSetList';
        $vmDeployment.Roles[0].ConfigurationSets.Add((New-AzureComputeArgumentList -TypeName 'VirtualMachineConfigurationSet'));
