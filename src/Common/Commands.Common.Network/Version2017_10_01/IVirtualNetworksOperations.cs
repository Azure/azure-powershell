...
namespace Microsoft.Azure.Management.Internal.Network.Version2017_10_01
{
    ...
    public partial interface IVirtualNetworksOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<VirtualNetwork>> BeginUpdateTagsWithHttpMessagesAsync(string resourceGroupName, string virtualNetworkName, TagsObject parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets all virtual networks in a subscription.
        /// </summary>
