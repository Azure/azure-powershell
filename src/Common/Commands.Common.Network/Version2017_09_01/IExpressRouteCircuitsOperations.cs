...
namespace Microsoft.Azure.Management.Internal.Network.Version2017_09_01
{
    ...
    public partial interface IExpressRouteCircuitsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<ExpressRouteCircuit>> BeginUpdateTagsWithHttpMessagesAsync(string resourceGroupName, string circuitName, TagsObject parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets the currently advertised ARP table associated with the express
        /// route circuit in a resource group.
        /// </summary>
