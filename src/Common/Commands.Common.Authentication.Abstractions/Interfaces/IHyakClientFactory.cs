...
namespace Microsoft.Azure.Commands.Common.Authentication
{
    ...
    public interface IHyakClientFactory
    {
        ...
        TClient CreateClient<TClient>(AzureContext context, string endpoint) where TClient : ServiceClient<TClient>;
        ...
        /// <returns>A client properly authenticated in the given context, properly configured for use with Azure PowerShell, 
        /// targeting the given named endpoint in the targeted environment</returns>
        TClient CreateClient<TClient>(IAzureContextContainer profile, AzureSubscription subscription, string endpoint) where TClient : ServiceClient<TClient>;
