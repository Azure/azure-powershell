...
namespace Microsoft.Azure.Commands.Common.Compute.Version2016_04_preview.Models
{
    ...
    public partial class CreationData
    {
        ...
        /// <param name="sourceUri">If createOption is Import, this is a SAS
        /// URI to a blob to be imported into a managed disk. If createOption
        ...
        /// ARM id of the source snapshot or disk. If createOption is Restore,
        /// this is the ARM-like id of the source disk restore point.</param>
        ...
        /// <summary>
        /// Gets or sets if createOption is Import, this is a SAS URI to a blob
        /// to be imported into a managed disk. If createOption is Copy, this
        /// is a relative Uri containing the id of the source snapshot to be
