...
namespace Microsoft.Azure.Management.WebSites.Version2016_09_01.Models
{
    ...
    public partial class SnapshotRecoveryRequest : ProxyOnlyResource
    {
        ...
        /// enabled.</param>
        public SnapshotRecoveryRequest(bool overwrite, string id = default(string), string name = default(string), string kind = default(string), string type = default(string), string snapshotTime = default(string), SnapshotRecoveryTarget recoveryTarget = default(SnapshotRecoveryTarget), bool? recoverConfiguration = default(bool?), bool? ignoreConflictingHostNames = default(bool?))
