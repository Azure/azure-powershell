...
namespace Microsoft.Azure.Management.WebSites.Version2016_09_01.Models
{
    ...
    public partial class BillingMeter : ProxyOnlyResource
    {
        ...
        /// <param name="resourceType">App Service resource type meter used
        /// for</param>
        public BillingMeter(string id = default(string), string name = default(string), string kind = default(string), string type = default(string), string meterId = default(string), string billingLocation = default(string), string shortName = default(string), string friendlyName = default(string), string resourceType = default(string))
        ...
        /// <summary>
        /// Gets or sets app Service resource type meter used for
        /// </summary>
