...
namespace Microsoft.Azure.Management.WebSites.Version2016_09_01
{
    ...
    public static partial class WebSiteManagementClientExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<Identifier>> ListSiteIdentifiersAssignedToHostNameAsync(this IWebSiteManagementClient operations, string name = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static void Move(this IWebSiteManagementClient operations, string resourceGroupName, string targetResourceGroup = default(string), IList<string> resources = default(IList<string>))
            {
                operations.MoveAsync(resourceGroupName, targetResourceGroup, resources).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task MoveAsync(this IWebSiteManagementClient operations, string resourceGroupName, string targetResourceGroup = default(string), IList<string> resources = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.MoveWithHttpMessagesAsync(resourceGroupName, targetResourceGroup, resources, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            /// <param name='resources'>
            /// </param>
            public static void ValidateMove(this IWebSiteManagementClient operations, string resourceGroupName, string targetResourceGroup = default(string), IList<string> resources = default(IList<string>))
            {
                operations.ValidateMoveAsync(resourceGroupName, targetResourceGroup, resources).GetAwaiter().GetResult();
            }
