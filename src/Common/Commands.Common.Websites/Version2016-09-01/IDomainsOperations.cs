...
namespace Microsoft.Azure.Management.WebSites.Version2016_09_01
{
    ...
    public partial interface IDomainsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<DomainAvailablilityCheckResult>> CheckAvailabilityWithHttpMessagesAsync(string name = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<IPage<NameIdentifier>>> ListRecommendationsWithHttpMessagesAsync(string keywords = default(string), int? maxDomainRecommendations = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
