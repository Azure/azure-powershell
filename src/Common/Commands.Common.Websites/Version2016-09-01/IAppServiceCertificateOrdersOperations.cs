...
namespace Microsoft.Azure.Management.WebSites.Version2016_09_01
{
    ...
    public partial interface IAppServiceCertificateOrdersOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<SiteSeal>> RetrieveSiteSealWithHttpMessagesAsync(string resourceGroupName, string certificateOrderName, bool? lightTheme = default(bool?), string locale = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Verify domain ownership for this certificate order.
        /// </summary>
        /// <remarks>
