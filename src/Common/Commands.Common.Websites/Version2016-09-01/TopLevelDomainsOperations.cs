...
namespace Microsoft.Azure.Management.WebSites.Version2016_09_01
{
    ...
    internal partial class TopLevelDomainsOperations : IServiceOperations<WebSiteManagementClient>, ITopLevelDomainsOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<TldLegalAgreement>>> ListAgreementsWithHttpMessagesAsync(string name, bool? includePrivacy = default(bool?), bool? forTransfer = default(bool?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (name == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "name");
            ...
            if (includePrivacy != null || forTransfer != null)
            {
                agreementOption.IncludePrivacy = includePrivacy;
                agreementOption.ForTransfer = forTransfer;
            }
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
