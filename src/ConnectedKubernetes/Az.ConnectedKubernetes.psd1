@{
  ...
  FunctionsToExport = 'Get-AzConnectedClusterUserCredential', 'Get-AzConnectedKubernetes', 'New-AzConnectedKubernetes', 'Remove-AzConnectedKubernetes', 'Update-AzConnectedKubernetes', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
