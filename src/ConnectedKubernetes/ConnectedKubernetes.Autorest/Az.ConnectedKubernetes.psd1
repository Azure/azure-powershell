@{
  ...
  FunctionsToExport = 'Get-AZCloudMetadataResourceId', 'Get-AzConnectedKubernetes', 'Get-AzConnectedKubernetesUserCredential', 'Get-ConfigDpDefaultEndpoint', 'Get-ConfigDPEndpoint', 'Get-HelmValues', 'New-AzConnectedKubernetes', 'Remove-AzConnectedKubernetes', 'Set-AzConnectedKubernetes', 'Update-AzConnectedKubernetes', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
