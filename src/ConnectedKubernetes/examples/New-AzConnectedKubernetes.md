...
### Example 2: Using [-AcceptEULA] will default to your acceptance of the terms of our legal agreement and create a connected kubernetes.
```powershell
...
Using [-AcceptEULA] will default to your acceptance of the terms of our legal agreement
...
### Example 4: Create a connected kubernetes with parameters kubeConfig and kubeContext
```powershell
