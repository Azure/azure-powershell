...
online version: https://docs.microsoft.com/powershell/module/az.kubernetesconfiguration/get-azoperationstatus
schema: 2.0.0
---

# Get-AzOperationStatus
...
### List (Default)
```
Get-AzOperationStatus -ClusterName <String> -ClusterRp <String> -ClusterType <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzOperationStatus -ClusterName <String> -ClusterRp <String> -ClusterType <String> -ExtensionName <String>
...
### GetViaIdentity
```
Get-AzOperationStatus -InputObject <IKubernetesConfigurationIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
