# How-To
This document describes how to develop for `Az.KubernetesConfiguration`.

## Building `Az.KubernetesConfiguration`
...
## Testing `Az.KubernetesConfiguration`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Az.KubernetesConfiguration` into the session.
