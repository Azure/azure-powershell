...
function Get-AzExtension {
    ...
    begin {
        try {
            ...
            $mapping = @{
                Get = 'Az.KubernetesConfiguration.private\Get-AzExtension_Get';
                GetViaIdentity = 'Az.KubernetesConfiguration.private\Get-AzExtension_GetViaIdentity';
                List = 'Az.KubernetesConfiguration.private\Get-AzExtension_List';
            }
