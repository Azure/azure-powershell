...
# .Link
# https://docs.microsoft.com/en-us/powershell/module/az.kubernetesconfiguration/set-azsourcecontrolconfiguration
# #>
...
#             $mapping = @{
#                 UpdateExpanded = 'Az.KubernetesConfiguration.custom\Update-AzConnectedKubernetes';
#             }
