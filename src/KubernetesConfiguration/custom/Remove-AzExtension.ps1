...
function Remove-AzExtension {
    ...
    begin {
        try {
            ...
            $mapping = @{
                Delete = 'Az.KubernetesConfiguration.private\Remove-AzExtension_Delete';
                DeleteViaIdentity = 'Az.KubernetesConfiguration.private\Remove-AzExtension_DeleteViaIdentity';
            }
