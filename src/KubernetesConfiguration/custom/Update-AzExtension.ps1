...
.Link
https://docs.microsoft.com/powershell/module/az.kubernetesconfiguration/update-azextension
#>
function Update-AzExtension {
    ...
    begin {
        try {
            ...
            $mapping = @{
                UpdateExpanded = 'Az.KubernetesConfiguration.private\Update-AzExtension_UpdateExpanded';
                UpdateViaIdentityExpanded = 'Az.KubernetesConfiguration.private\Update-AzExtension_UpdateViaIdentityExpanded';
            }
