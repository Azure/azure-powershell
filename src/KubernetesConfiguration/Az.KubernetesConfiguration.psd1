@{
  ...
  FunctionsToExport = 'Get-AzExtension', 'Get-AzOperationStatus', 'New-AzExtension', 'New-AzKubernetesConfiguration', 'Remove-AzExtension', 'Remove-AzKubernetesConfiguration', 'Update-AzExtension', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
