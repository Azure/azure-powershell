...
namespace Microsoft.Azure.Commands.Storage.File.Cmdlet
{
    ...
    using System;
    using LocalConstants = Microsoft.Azure.Commands.Storage.File.Constants;
            ...
            if (ShouldProcess(targetFile, "Download"))
            {
                this.RunTask(async taskId =>
                {
                    ...
                    var progressRecord = new ProgressRecord(
                        ...
                        string.Format(CultureInfo.CurrentCulture, ResourceV2.ReceiveAzureFileActivity,
                            fileToBeDownloaded.GetFullPath(), targetFile),
                        ResourceV2.PrepareDownloadingFile);
