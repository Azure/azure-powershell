...
- `build-module.ps1`
  - Builds the module DLL (`./bin/Az.Blockchain.private.dll`), creates the exported cmdlets, generates custom cmdlet test stubs, and updates `./Az.Blockchain.psd1` with Azure profile information.
