...
Describe 'Update-AzBlockchainTransactionNode' {
    ...
    It 'UpdateViaIdentityExpanded' {
        ...
        { Get-AzBlockchainTransactionNode -BlockchainMemberName $env.blockchainMember -ResourceGroupName $env.resourceGroup -Name $env.blockchainTransactionNode | Update-AzBlockchainTransactionNode -Password $passwd3 } | Should -Not -Throw
