...
#>
function Set-AzDnsRecordSet_UpdateMX {
...
param(
    ...
    [Parameter(Mandatory, HelpMessage='The list of MX records in the record set. To construct, see NOTES section for MXRECORD properties and create a hash table.')]
    [Microsoft.Azure.PowerShell.Cmdlets.Dns.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Info(SerializedName='MXRecords', PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.Api20150504Preview.IMxRecord]), Description='The list of MX records in the record set.')]
...
process {
    ...
    $PSBoundParameters['RecordType'] = [Microsoft.Azure.PowerShell.Cmdlets.Dns.Support.RecordType]::Mx
