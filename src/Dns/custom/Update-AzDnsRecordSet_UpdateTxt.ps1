...
#>
function Update-AzDnsRecordSet_UpdateTxt {
...
param(
    ...
    [Parameter(Mandatory, HelpMessage='The list of TXT records in the record set. To construct, see NOTES section for TXTRECORD properties and create a hash table.')]
    [Microsoft.Azure.PowerShell.Cmdlets.Dns.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Info(SerializedName='TXTRecords', PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.Api20150504Preview.ITxtRecord]), Description='The list of TXT records in the record set.')]
...
process {
    ...
    $PSBoundParameters['RecordType'] = [Microsoft.Azure.PowerShell.Cmdlets.Dns.Support.RecordType]::Txt
