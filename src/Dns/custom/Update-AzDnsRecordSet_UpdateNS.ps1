...
#>
function Update-AzDnsRecordSet_UpdateNS {
...
param(
    ...
    [Parameter(Mandatory, HelpMessage='The list of NS records in the record set. To construct, see NOTES section for NSRECORD properties and create a hash table.')]
    [Microsoft.Azure.PowerShell.Cmdlets.Dns.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Info(SerializedName='NSRecords', PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.Api20150504Preview.INsRecord]), Description='The list of NS records in the record set.')]
...
process {
    ...
    $PSBoundParameters['RecordType'] = [Microsoft.Azure.PowerShell.Cmdlets.Dns.Support.RecordType]::Ns
