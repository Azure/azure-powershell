...
Creates or updates a DNS zone. Does not modify DNS records within the zone.
.Example
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/powershell/module/az.dns/set-azdnszone
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.Api20180501.IZone
.Link
https://docs.microsoft.com/powershell/module/az.dns/set-azdnszone
#>
function Set-AzDnsZone {
[OutputType('Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.Api20180501.IZone')]
[CmdletBinding(DefaultParameterSetName='UpdatePublic', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
...
param(
    ...
    [Parameter(ParameterSetName='UpdatePrivate', Mandatory, HelpMessage='When provided, creates a private DNS zone.')]
    [Microsoft.Azure.PowerShell.Cmdlets.Dns.Category('Body')]
    [System.Management.Automation.SwitchParameter]
    # When provided, creates a private DNS zone.
    ${Private},

    [Parameter(ParameterSetName='UpdatePrivate', HelpMessage='A list of references to virtual networks that register hostnames in this DNS zone.')]
    [Microsoft.Azure.PowerShell.Cmdlets.Dns.Category('Body')]
    ...
    [Parameter(ParameterSetName='UpdatePrivate', HelpMessage='A list of references to virtual networks that resolve records in this DNS zone.')]
    [Microsoft.Azure.PowerShell.Cmdlets.Dns.Category('Body')]
...
process {
    ...
    Az.Dns.internal\Set-AzDnsZone @PSBoundParameters
}
}
