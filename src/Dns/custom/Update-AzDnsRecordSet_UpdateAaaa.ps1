...
#>
function Update-AzDnsRecordSet_UpdateAaaa {
...
param(
    ...
    [Parameter(Mandatory, HelpMessage='The list of AAAA records in the record set. To construct, see NOTES section for AAAARECORD properties and create a hash table.')]
    [Microsoft.Azure.PowerShell.Cmdlets.Dns.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Info(SerializedName='AAAARecords', PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.Api20150504Preview.IAaaaRecord]), Description='The list of AAAA records in the record set.')]
...
process {
    ...
    $PSBoundParameters['RecordType'] = [Microsoft.Azure.PowerShell.Cmdlets.Dns.Support.RecordType]::Aaaa
