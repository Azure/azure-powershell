...
#>
function Set-AzDnsRecordSet_UpdateCname {
...
param(
    ...
    [Parameter(Mandatory, HelpMessage='The canonical name for this CNAME record.')]
    [Microsoft.Azure.PowerShell.Cmdlets.Dns.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Info(SerializedName='cname', PossibleTypes=([System.String]), Description='The canonical name for this CNAME record.')]
    [System.String]
...
process {
    ...
    $PSBoundParameters['RecordType'] = [Microsoft.Azure.PowerShell.Cmdlets.Dns.Support.RecordType]::Cname
