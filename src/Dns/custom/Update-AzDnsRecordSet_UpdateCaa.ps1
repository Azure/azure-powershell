...
#>
function Update-AzDnsRecordSet_UpdateCaa {
...
param(
    ...
    [Parameter(Mandatory, HelpMessage='The list of CAA records in the record set. To construct, see NOTES section for CAARECORD properties and create a hash table.')]
    [Microsoft.Azure.PowerShell.Cmdlets.Dns.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Info(SerializedName='caaRecords', PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.Api20180501.ICaaRecord]), Description='The list of CAA records in the record set.')]
...
process {
    ...
    $PSBoundParameters['RecordType'] = [Microsoft.Azure.PowerShell.Cmdlets.Dns.Support.RecordType]::Caa
