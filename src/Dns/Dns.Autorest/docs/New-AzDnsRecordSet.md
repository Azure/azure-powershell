...
New-AzDnsRecordSet -RecordType <RecordType> -RelativeRecordSetName <String> -ResourceGroupName <String>
 -ZoneName <String> [-SubscriptionId <String>] [-IfMatch <String>] [-IfNoneMatch <String>]
 [-AaaaRecord <IAaaaRecord[]>] [-ARecord <IARecord[]>] [-CaaRecord <ICaaRecord[]>]
 [-CnameRecordCname <String>] [-DsRecord <IDsRecord[]>] [-Etag <String>] [-Metadata <Hashtable>]
 [-MxRecord <IMxRecord[]>] [-NaptrRecord <INaptrRecord[]>] [-NsRecord <INsRecord[]>]
 ...
 [-TargetResourceId <String>] [-TlsaRecord <ITlsaRecord[]>] [-Ttl <Int64>] [-TxtRecord <ITxtRecord[]>]
