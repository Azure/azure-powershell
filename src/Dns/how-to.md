...
- `build-module.ps1`
  - Builds the module DLL (`./bin/Az.Dns.private.dll`), creates the exported cmdlets, generates custom cmdlet test stubs, and updates `./Az.Dns.psd1` with Azure profile information.
