...
namespace Microsoft.Azure.Management.Dns.Models
{
    ...
    public partial class RecordSet : IResource
    {
        ...
        /// </summary>
        [JsonProperty(PropertyName = "properties.DSRecords")]
        public IList<DsRecord> DsRecords { get; set; }

        /// <summary>
        /// Gets or sets the list of TLSA records in the record set.
        /// </summary>
        [JsonProperty(PropertyName = "properties.TLSARecords")]
        public IList<TlsaRecord> TlsaRecords { get; set; }

        /// <summary>
        /// Gets or sets the list of NAPTR records in the record set.
        /// </summary>
        [JsonProperty(PropertyName = "properties.NAPTRRecords")]
        public IList<NaptrRecord> NaptrRecords { get; set; }
