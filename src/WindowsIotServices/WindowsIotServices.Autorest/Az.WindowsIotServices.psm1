# region Generated 
  ...
  $null = Import-Module -Name (Join-Path $PSScriptRoot './bin/Az.WindowsIotServices.private.dll')
  ...
  $customModulePath = Join-Path $PSScriptRoot './custom/Az.WindowsIotServices.custom.psm1'
