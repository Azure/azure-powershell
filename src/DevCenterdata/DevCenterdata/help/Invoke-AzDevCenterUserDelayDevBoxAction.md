...
Invoke-AzDevCenterUserDelayDevBoxAction -Endpoint <String> -DevBoxName <String> -ProjectName <String>
 [-UserId <String>] -DelayUntil <DateTime> [-DefaultProfile <PSObject>]
...
Invoke-AzDevCenterUserDelayDevBoxAction -Endpoint <String> -DevBoxName <String> -Name <String>
 -ProjectName <String> [-UserId <String>] -DelayUntil <DateTime> [-DefaultProfile <PSObject>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Invoke-AzDevCenterUserDelayDevBoxAction -Endpoint <String> -InputObject <IDevCenterdataIdentity>
 -DelayUntil <DateTime> [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Parameter Sets: DelayViaIdentity1, DelayViaIdentity
Aliases:
...
[https://learn.microsoft.com/powershell/module/az.devcenterdata/invoke-azdevcenteruserdelaydevboxaction](https://learn.microsoft.com/powershell/module/az.devcenterdata/invoke-azdevcenteruserdelaydevboxaction)
