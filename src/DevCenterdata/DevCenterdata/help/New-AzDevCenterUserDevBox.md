...
```
New-AzDevCenterUserDevBox -Endpoint <String> -Name <String> -ProjectName <String> [-UserId <String>]
 -PoolName <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
[https://learn.microsoft.com/powershell/module/az.devcenterdata/new-azdevcenteruserdevbox](https://learn.microsoft.com/powershell/module/az.devcenterdata/new-azdevcenteruserdevbox)
