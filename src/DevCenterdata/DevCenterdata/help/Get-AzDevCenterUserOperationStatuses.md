...
online version: https://learn.microsoft.com/powershell/module/az.devcenterdata/get-azdevcenteruseroperationstatuses
schema: 2.0.0
---

# Get-AzDevCenterUserOperationStatuses
...
### Get (Default)
```
Get-AzDevCenterUserOperationStatuses -Endpoint <String> -OperationId <String> -ProjectName <String>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDevCenterUserOperationStatuses -Endpoint <String> -InputObject <IDevCenterdataIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/az.devcenterdata/get-azdevcenteruseroperationstatuses](https://learn.microsoft.com/powershell/module/az.devcenterdata/get-azdevcenteruseroperationstatuses)
