#
# Module manifest for module 'Az.DevCenterdata'
#
...
RequiredAssemblies = 'DevCenterdata.Autorest/bin/Az.DevCenterdata.private.dll'
...
FormatsToProcess = 'DevCenterdata.Autorest/Az.DevCenterdata.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('DevCenterdata.Autorest/Az.DevCenterdata.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Approve-AzDevCenterUserDevBox', 
               'Disable-AzDevCenterUserDevBoxAddOn', 
               'Enable-AzDevCenterUserDevBoxAddOn', 
               'Export-AzDevCenterUserDevBoxSnapshot', 
               'Get-AzDevCenterUserCatalog', 'Get-AzDevCenterUserDevBox', 
               'Get-AzDevCenterUserDevBoxAction', 'Get-AzDevCenterUserDevBoxAddon', 
               ...
               'Get-AzDevCenterUserOperationStatuses', 'Get-AzDevCenterUserPool', 
               'Get-AzDevCenterUserProject', 'Get-AzDevCenterUserProjectAbility', 
               'Get-AzDevCenterUserSchedule', 'Invoke-AzDevCenterUserAlignDevBox', 
               'Invoke-AzDevCenterUserDelayDevBoxAction', 
               'Invoke-AzDevCenterUserDelayEnvironmentAction', 
               'Invoke-AzDevCenterUserPool', 'New-AzDevCenterUserDevBox', 
               'New-AzDevCenterUserDevBoxAddOn', 
               'New-AzDevCenterUserDevBoxCustomizationGroup', 
               'New-AzDevCenterUserEnvironment', 'Remove-AzDevCenterUserDevBox', 
