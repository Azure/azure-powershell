#
# Module manifest for module 'Az.Informatica'
#
...
RequiredAssemblies = 'Informatica.Autorest/bin/Az.Informatica.private.dll'
...
FormatsToProcess = 'Informatica.Autorest/Az.Informatica.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('Informatica.Autorest/Az.Informatica.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Get-AzInformaticaOrganization', 
