...
```
Start-AzInformaticaServerlessRuntimeFailedServerlessRuntime -OrganizationInputObject <IInformaticaIdentity>
 -ServerlessRuntimeName <String> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
