...
$dll = Join-Path $PSScriptRoot 'bin\Az.Informatica.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.Informatica.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.Informatica.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: Informatica cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.Informatica.format.ps1xml'
