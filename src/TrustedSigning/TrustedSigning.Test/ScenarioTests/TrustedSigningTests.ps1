...
function Test-GetCodeSigningRootCert {
    ...
    try {
        ...
        $cert = Get-AzTrustedSigningCertificateRoot -AccountName $accountName -ProfileName $profileName -EndpointUrl $endPointUrl -Destination $destination
...
function Test-GetCodeSigningCertChain {
    ...
    try {
        ...
        $chain = Get-AzTrustedSigningCertificateChain -AccountName $accountName -ProfileName $profileName -EndpointUrl $endPointUrl -Destination $destination
