...
$dll = Join-Path $PSScriptRoot 'bin\Az.TrustedSigning.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.TrustedSigning.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.TrustedSigning.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.TrustedSigning'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: TrustedSigning cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.TrustedSigning.format.ps1xml'
