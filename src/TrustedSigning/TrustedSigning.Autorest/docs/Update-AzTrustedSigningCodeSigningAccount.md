...
online version: https://learn.microsoft.com/powershell/module/az.trustedsigning/update-aztrustedsigningcodesigningaccount
schema: 2.0.0
---

# Update-AzTrustedSigningCodeSigningAccount
...
```
Update-AzTrustedSigningCodeSigningAccount -AccountName <String> -ResourceGroupName <String>
...
```
Update-AzTrustedSigningCodeSigningAccount -InputObject <ITrustedSigningIdentity> [-SkuName <String>]
