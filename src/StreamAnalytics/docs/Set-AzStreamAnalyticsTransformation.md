...
online version: https://docs.microsoft.com/en-us/powershell/module/az.streamanalytics/set-azstreamanalyticstransformation
schema: 2.0.0
---

# Set-AzStreamAnalyticsTransformation
...
```
Set-AzStreamAnalyticsTransformation -JobName <String> -Name <String> -ResourceGroupName <String>
...
```
Set-AzStreamAnalyticsTransformation -JobName <String> -Name <String> -ResourceGroupName <String>
 -Transformation <ITransformation> [-SubscriptionId <String>] [-IfMatch <String>] [-IfNoneMatch <String>]
