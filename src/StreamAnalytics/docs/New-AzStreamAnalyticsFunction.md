...
```powershell
PS C:\> New-AzStreamAnalyticsFunction -ResourceGroupName lucas-rg-test -JobName sajob-02-pwsh -Name function-01 -File .\test\template-json\Function_JavascriptUdf.json
