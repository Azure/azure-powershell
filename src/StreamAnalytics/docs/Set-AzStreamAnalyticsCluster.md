...
online version: https://docs.microsoft.com/en-us/powershell/module/az.streamanalytics/set-azstreamanalyticscluster
schema: 2.0.0
---

# Set-AzStreamAnalyticsCluster
...
```
Set-AzStreamAnalyticsCluster -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### Update
```
Set-AzStreamAnalyticsCluster -Name <String> -ResourceGroupName <String> -Cluster <ICluster>
