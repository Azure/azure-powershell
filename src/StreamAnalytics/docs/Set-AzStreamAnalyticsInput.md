...
online version: https://docs.microsoft.com/en-us/powershell/module/az.streamanalytics/set-azstreamanalyticsinput
schema: 2.0.0
---

# Set-AzStreamAnalyticsInput
...
```
Set-AzStreamAnalyticsInput -JobName <String> -Name <String> -ResourceGroupName <String>
...
### Replace
```
Set-AzStreamAnalyticsInput -JobName <String> -Name <String> -ResourceGroupName <String> -Input <IInput>
