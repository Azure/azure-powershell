...
### Update
```
Update-AzStreamAnalyticsStreamingJob -JobName <String> -ResourceGroupName <String>
 -StreamingJob <IStreamingJob> [-SubscriptionId <String>] [-IfMatch <String>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-AzStreamAnalyticsStreamingJob -InputObject <IStreamAnalyticsIdentity> -StreamingJob <IStreamingJob>
