...
namespace Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Support";
