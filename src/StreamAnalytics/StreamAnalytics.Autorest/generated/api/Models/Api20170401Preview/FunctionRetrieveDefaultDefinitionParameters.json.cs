namespace Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.Api20170401Preview
{
    ...
    public partial class FunctionRetrieveDefaultDefinitionParameters
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.Api20170401Preview.IFunctionRetrieveDefaultDefinitionParameters.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.Api20170401Preview.IFunctionRetrieveDefaultDefinitionParameters
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.Api20170401Preview.IFunctionRetrieveDefaultDefinitionParameters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.Api20170401Preview.IFunctionRetrieveDefaultDefinitionParameters FromJson(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("bindingType") )
            {
                case "Microsoft.MachineLearning/WebService":
                {
                    return new AzureMachineLearningStudioFunctionRetrieveDefaultDefinitionParameters(json);
                }
                case "Microsoft.MachineLearningServices":
                {
                    return new AzureMachineLearningServiceFunctionRetrieveDefaultDefinitionParameters(json);
                }
                case "Microsoft.StreamAnalytics/JavascriptUdf":
                {
                    return new JavaScriptFunctionRetrieveDefaultDefinitionParameters(json);
                }
                case "Microsoft.StreamAnalytics/CLRUdf":
                {
                    return new CSharpFunctionRetrieveDefaultDefinitionParameters(json);
                }
            }
            return new FunctionRetrieveDefaultDefinitionParameters(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonObject into a new instance of <see cref="FunctionRetrieveDefaultDefinitionParameters" />.
        /// </summary>
        ...
        internal FunctionRetrieveDefaultDefinitionParameters(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonObject json)
        {
            ...
            {_bindingType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("bindingType"), out var __jsonBindingType) ? (string)__jsonBindingType : (string)BindingType;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="FunctionRetrieveDefaultDefinitionParameters" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="FunctionRetrieveDefaultDefinitionParameters" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._bindingType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString(this._bindingType.ToString()) : null, "bindingType" ,container.Add );
