...
namespace Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StreamAnalytics/streamingjobs/{jobName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzStreamAnalyticsJob_GetViaIdentity")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Description(@"Gets details about the specified streaming job.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Generated]
    public partial class GetAzStreamAnalyticsJob_GetViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.IEventListener
    {
        ...
        /// the response, beyond the default set returned when this parameter is absent. The default set is all streaming job properties
        /// other than 'inputs', 'transformation', 'outputs', and 'functions'.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The $expand OData query parameter. This is a comma-separated list of additional streaming job properties to include in the response, beyond the default set returned when this parameter is absent. The default set is all streaming job properties other than 'inputs', 'transformation', 'outputs', and 'functions'.")]
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Category(global::Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.ParameterCategory.Query)]
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzStreamAnalyticsJob_GetViaIdentity" /> cmdlet class.
        /// </summary>
        public GetAzStreamAnalyticsJob_GetViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.StreamingJobsGetViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.StreamingJobsGet(this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.JobName ?? null, onOk, this, Pipeline);
                    }
