...
namespace Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzStreamAnalyticsInput_UpdateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzStreamAnalyticsInput_UpdateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.IEventListener
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.InputsUpdateViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, Input, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.InputsUpdate(this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.JobName ?? null, InputObject.InputName ?? null, Input, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  IfMatch=this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null,body=Input})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzStreamAnalyticsInput_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzStreamAnalyticsInput_UpdateViaIdentity()
        {
