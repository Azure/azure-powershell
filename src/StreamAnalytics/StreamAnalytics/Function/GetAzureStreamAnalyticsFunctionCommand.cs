...
namespace Microsoft.Azure.Commands.StreamAnalytics
{
    ...
    public class GetAzureStreamAnalyticsFunctionCommand : StreamAnalyticsResourceProviderBaseCmdlet
    {
        ...
        [Parameter(Position = 2, Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = "The azure stream analytics function name.")]
        [ValidateNotNullOrEmpty]
        ...
        public override void ExecuteCmdlet()
        {
            ...
            FunctionFilterOptions filterOptions = new FunctionFilterOptions()
            {
                Name = Name,
                JobName = JobName,
            ...
            WriteObject(StreamAnalyticsClient.FilterPSFunctions(filterOptions), true);
        }
    }
}
