...
online version: https://learn.microsoft.com/powershell/module/az.datadog/set-azdatadogmonitoredsubscriptioncreateor
schema: 2.0.0
---
...
```
Set-AzDatadogMonitoredSubscriptionCreateor -ConfigurationName <String> -MonitorName <String>
