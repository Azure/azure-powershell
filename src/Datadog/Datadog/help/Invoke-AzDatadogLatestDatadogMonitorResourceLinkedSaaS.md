...
online version: https://learn.microsoft.com/powershell/module/az.datadog/invoke-azdatadoglatestdatadogmonitorresourcelinkedsaas
schema: 2.0.0
---

# Invoke-AzDatadogLatestDatadogMonitorResourceLinkedSaaS
...
### Latest (Default)
```
Invoke-AzDatadogLatestDatadogMonitorResourceLinkedSaaS -MonitorName <String> -ResourceGroupName <String>
...
### LatestViaIdentity
```
Invoke-AzDatadogLatestDatadogMonitorResourceLinkedSaaS -InputObject <IDatadogIdentity>
...
### Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.ILatestLinkedSaaSResponse
