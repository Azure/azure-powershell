...
online version: https://learn.microsoft.com/powershell/module/az.datadog/remove-azdatadogmonitoredsubscription
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzDatadogMonitoredSubscription -ConfigurationName <String> -MonitorName <String>
...
```
Remove-AzDatadogMonitoredSubscription -ConfigurationName <String> -MonitorInputObject <IDatadogIdentity>
...
### DeleteViaIdentity
```
Remove-AzDatadogMonitoredSubscription -InputObject <IDatadogIdentity> [-DefaultProfile <PSObject>] [-AsJob]
