...
Invoke-AzDatadogManageMonitorSreAgentConnector -InputObject <IDatadogIdentity>
 -Request <ISreAgentConnectorRequest> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Manage
```
Invoke-AzDatadogManageMonitorSreAgentConnector -MonitorName <String> -ResourceGroupName <String>
 -Request <ISreAgentConnectorRequest> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm]
...
```
Invoke-AzDatadogManageMonitorSreAgentConnector -MonitorName <String> -ResourceGroupName <String>
 -Action <String> -McpConnectorResourceIdList <ISreAgentConfiguration[]> [-SubscriptionId <String>]
...
Invoke-AzDatadogManageMonitorSreAgentConnector -InputObject <IDatadogIdentity> -Action <String>
 -McpConnectorResourceIdList <ISreAgentConfiguration[]> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
