...
```
Initialize-AzDatadogSaaSOperationGroupResource -SaaSResourceId <String> [-SubscriptionId <String>]
...
### Activate
```
Initialize-AzDatadogSaaSOperationGroupResource -Body <IActivateSaaSParameterRequest>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ActivateViaJsonFilePath
```
Initialize-AzDatadogSaaSOperationGroupResource -JsonFilePath <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ActivateViaJsonString
```
Initialize-AzDatadogSaaSOperationGroupResource -JsonString <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
