...
Invoke-AzDatadogResubscribeOrganization -InputObject <IDatadogIdentity> [-AzureSubscriptionId <String>]
 [-ResourceGroup <String>] [-SkuName <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
...
```
Invoke-AzDatadogResubscribeOrganization -MonitorName <String> -ResourceGroupName <String> -JsonString <String>
