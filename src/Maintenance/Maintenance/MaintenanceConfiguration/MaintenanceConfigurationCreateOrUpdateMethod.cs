...
namespace Microsoft.Azure.Commands.Maintenance
{
    ...
    public partial class NewAzureRmMaintenanceConfiguration : MaintenanceAutomationBaseCmdlet
    {
        ...
        [CmdletParameterBreakingChange("PreTask", ChangeDescription = "Parameter is being deprecated without being replaced")]
        [Parameter(
            Mandatory = false,
        ...
        [CmdletParameterBreakingChange("PostTask", ChangeDescription = "Parameter is being deprecated without being replaced")]
        [Parameter(
            Mandatory = false,
