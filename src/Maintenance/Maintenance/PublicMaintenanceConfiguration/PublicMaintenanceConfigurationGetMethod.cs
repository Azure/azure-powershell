...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "MaintenancePublicConfiguration", DefaultParameterSetName = "DefaultParameter")]
    [OutputType(typeof(PSMaintenanceConfiguration))]
    public partial class GetAzureRmMaintenancePublicConfiguration : MaintenanceAutomationBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            ExecuteClientAction(() =>
            {
                ...
                {
                    var result = PublicMaintenanceConfigurationsClient.Get(name);
                    WriteObject(result);
                }
                ...
                else
                {
                    ...
                    var result = PublicMaintenanceConfigurationsClient.List();
                    while (result != null)
                    {
                        ...
                        result = string.IsNullOrEmpty(result.NextPageLink) ? null : PublicMaintenanceConfigurationsClient.ListNext(result.NextPageLink);
                    }
        ...
        [Parameter(
            ...
            Position = 1,
            Mandatory = false,
            HelpMessage = "The public maintenance configuration Name.",
            ValueFromPipelineByPropertyName = true)]
