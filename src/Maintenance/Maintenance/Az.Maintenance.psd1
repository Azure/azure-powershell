...
CmdletsToExport = 'Get-AzApplyUpdate', 'Get-AzConfigurationAssignment', 
               ...
               'Remove-AzMaintenanceConfiguration', 'Approve-AzScheduledEvent', 
               'Approve-AzScheduledEventList', 'Update-AzMaintenanceConfiguration'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added ''Approve-AzScheduledEvent'' and ''Approve-AzScheduledEventList'' to approve scheduled events.
