...
{
    public class SetAzureRmScheduledEventsTests : RMTestBase
    {
        ...
        private const string ScheduledEventsId = "00000000-0000-0000-0000-000000000001";
        ...
        private readonly SetAzureRmScheduledEvents cmdlet;

        public SetAzureRmScheduledEventsTests()
        {
            ...
            cmdlet = new SetAzureRmScheduledEvents
            {
