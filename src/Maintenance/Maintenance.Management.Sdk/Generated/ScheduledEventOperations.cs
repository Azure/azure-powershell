...
namespace Microsoft.Azure.Management.Maintenance
{
    ...
    /// </summary>
    internal partial class ScheduledEventOperations : IServiceOperations<MaintenanceManagementClient>, IScheduledEventOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<ScheduledEventApproveResponse>> AcknowledgeWithHttpMessagesAsync(string resourceGroupName, string resourceType, string resourceName, string scheduledEventId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "scheduledEventId");
            }
            ...
            // Create Result
            var _result = new AzureOperationResponse<ScheduledEventApproveResponse>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ScheduledEventApproveResponse>(_responseContent, Client.DeserializationSettings);
                }
