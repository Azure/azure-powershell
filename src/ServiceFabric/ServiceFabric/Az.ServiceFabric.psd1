#
# Module manifest for module 'PSGet_Az.ServiceFabric'
#
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Rollback when a certificate is added to VMSS model but an exception is thrown this is to fix bug: https://github.com/Azure/service-fabric-issues/issues/932
