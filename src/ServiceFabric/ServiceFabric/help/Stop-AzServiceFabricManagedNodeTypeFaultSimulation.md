...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ServiceFabric.Models.IServiceFabricIdentity
Parameter Sets: StopViaIdentityManagedClusterExpanded, StopViaIdentityManagedCluster
Aliases:
...
```yaml
Type: System.String
Parameter Sets: StopExpanded, StopViaJsonString, StopViaJsonFilePath, Stop, StopViaIdentityManagedClusterExpanded, StopViaIdentityManagedCluster
Aliases:
...
Parameter Sets: Stop, StopViaIdentityManagedCluster, StopViaIdentity
Aliases:
...
```yaml
Type: System.String
Parameter Sets: StopExpanded, StopViaIdentityManagedClusterExpanded, StopViaIdentityExpanded
Aliases:
