...
New-AzServiceFabricManagedCluster [-ResourceGroupName] <String> [-Name] <String> -Location <String>
 ...
 [-EnableOutboundOnlyNodeType] [-SkipManagedNsgAssignment] [-AllowRdpAccess]
 ...
 [-HttpGatewayTokenAuthConnectionPort <Int32>] [-MaxPercentUnhealthyApplication <Int32>]
 [-MaxPercentUnhealthyNode <Int32>] [-MaxUnusedVersionsToKeep <Int32>] [-AsJob] [-Tag <Hashtable>]
...
### -MaxPercentUnhealthyApplication
