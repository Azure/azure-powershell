...
New-AzServiceFabricManagedCluster [-ResourceGroupName] <String> [-Name] <String> -Location <String>
 ...
 [-AutoGeneratedDomainNameLabelScope <String>] [-EnableAutoOsUpgrade] [-AllowRdpAccess] [-AsJob]
...
New-AzServiceFabricManagedCluster [-ResourceGroupName] <String> [-Name] <String> -Location <String>
 ...
 [-ZonalResiliency] [-AutoGeneratedDomainNameLabelScope <String>] [-EnableAutoOsUpgrade] [-AllowRdpAccess]
