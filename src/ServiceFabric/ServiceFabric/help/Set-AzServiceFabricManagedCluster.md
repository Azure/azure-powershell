...
Set-AzServiceFabricManagedCluster [-ResourceGroupName] <String> [-Name] <String>
 ...
 [-EnableAutoOsUpgrade <Boolean>] [-AllowRdpAccess <Boolean>] [-AsJob] [-Tag <Hashtable>]
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Set-AzServiceFabricManagedCluster [-ResourceId] <String> [-UpgradeMode <ClusterUpgradeMode>]
 ...
 [-DnsName <String>] [-AutoGeneratedDomainNameLabelScope <String>] [-EnableAutoOsUpgrade <Boolean>]
 [-AllowRdpAccess <Boolean>] [-AsJob] [-Tag <Hashtable>] [-DefaultProfile <IAzureContextContainer>]
