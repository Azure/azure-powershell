...
Remove nodes from the specific node type from a cluster. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Remove-AzServiceFabricNode -Name 'Contoso01SFCluster' -NodeType 'n2' -NumberOfNodesToRemove 2 -ResourceGroupName 'Group1'
```
