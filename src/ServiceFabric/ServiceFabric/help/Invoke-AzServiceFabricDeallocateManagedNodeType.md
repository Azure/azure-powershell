...
```
Invoke-AzServiceFabricDeallocateManagedNodeType -InputObject <IServiceFabricIdentity> [-Force]
...
```yaml
Type: System.String
Parameter Sets: DeallocateExpanded, DeallocateViaJsonString, DeallocateViaJsonFilePath, Deallocate
Aliases:
...
```yaml
Type: System.Management.Automation.SwitchParameter
Parameter Sets: DeallocateExpanded, DeallocateViaIdentityManagedClusterExpanded, DeallocateViaIdentityExpanded
Aliases:
...
Parameter Sets: DeallocateViaIdentityExpanded, DeallocateViaIdentity
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ServiceFabric.Models.IServiceFabricIdentity
Parameter Sets: DeallocateViaIdentityManagedClusterExpanded, DeallocateViaIdentityManagedCluster
Aliases:
...
```yaml
Type: System.String
Parameter Sets: DeallocateExpanded, DeallocateViaJsonString, DeallocateViaJsonFilePath, Deallocate, DeallocateViaIdentityManagedClusterExpanded, DeallocateViaIdentityManagedCluster
Aliases:
...
Parameter Sets: Deallocate, DeallocateViaIdentityManagedCluster, DeallocateViaIdentity
Aliases:
