...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ManagedCluster : Resource
    {
        ...
        /// <param name="publicIPPrefixId">Specify the resource id of a public
        /// IP prefix that the load balancer will allocate a public IP address
        /// from. Only supports IPv4.</param>
        ...
        /// <summary>
        /// Gets or sets specify the resource id of a public IP prefix that the
        /// load balancer will allocate a public IP address from. Only supports
        /// IPv4.
        /// </summary>
        ...
        public override void Validate()
        {
            ...
            {
                foreach (var element1 in this.NetworkSecurityRules)
                {
                    if (element1 != null)
                    {
                        element1.Validate();
            ...
            {
                foreach (var element2 in this.Clients)
                {
                    if (element2 != null)
                    {
                        element2.Validate();
            ...
            {
                foreach (var element3 in this.FabricSettings)
                {
                    if (element3 != null)
                    {
                        element3.Validate();
            ...
            if (this.IpTags != null)
            {
                foreach (var element4 in this.IpTags)
                {
                    if (element4 != null)
                    {
                        element4.Validate();
            ...
            {
                foreach (var element5 in this.AuxiliarySubnets)
                {
                    if (element5 != null)
                    {
                        element5.Validate();
            ...
            {
                foreach (var element6 in this.ServiceEndpoints)
                {
                    if (element6 != null)
                    {
                        element6.Validate();
