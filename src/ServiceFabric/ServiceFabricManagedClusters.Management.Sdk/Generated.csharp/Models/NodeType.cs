...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters.Models
{
    ...
    public partial class NodeType : ManagedProxyResource
    {
        ...
        /// <param name="securityType">Specifies the security type of the
        /// nodeType. Only TrustedLaunch is currently supported. Possible
        /// values include: 'TrustedLaunch'</param>
        /// <param name="secureBootEnabled">Specifies whether secure boot
        /// should be enabled on the nodeType. Can only be used with
        /// TrustedLaunch SecurityType</param>
        /// <param name="enableNodePublicIP">Specifies whether each node is
        /// allocated its own public IP address. This is only supported on
        /// secondary node types with custom Load Balancers.</param>
        /// <param name="vmSharedGalleryImageId">Indicates the resource id of
        /// the vm shared galleries image. This parameter is used for custom vm
        /// image.</param>
        /// <param name="natGatewayId">Specifies the resource id of a NAT
        /// Gateway to attach to the subnet of this node type. Node type must
        /// use custom load balancer.</param>
        /// <param name="vmImagePlan">Specifies information about the
        /// marketplace image used to create the virtual machine. This element
        /// is only used for marketplace images. Before you can use a
        /// marketplace image from an API, you must enable the image for
        /// programmatic use. In the Azure portal, find the marketplace image
        /// that you want to use and then click Want to deploy
        /// programmatically, Get Started -&gt;. Enter any required information
        /// and then click Save.</param>
        ...
        /// TrustedLaunch is currently supported. Possible values include:
        /// 'TrustedLaunch'
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets specifies whether each node is allocated its own
        /// public IP address. This is only supported on secondary node types
        /// with custom Load Balancers.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.enableNodePublicIP")]
        public bool? EnableNodePublicIP { get; set; }

        /// <summary>
        /// Gets or sets indicates the resource id of the vm shared galleries
        ...
        /// <summary>
        /// Gets or sets specifies the resource id of a NAT Gateway to attach
        /// to the subnet of this node type. Node type must use custom load
        /// balancer.
        /// </summary>
        ...
        /// click Want to deploy programmatically, Get Started -&amp;gt;. Enter
        ...
        public virtual void Validate()
        {
            ...
            {
                foreach (var element1 in this.VmExtensions)
                {
                    if (element1 != null)
                    {
                        element1.Validate();
            ...
            {
                foreach (var element2 in this.NetworkSecurityRules)
                {
                    if (element2 != null)
                    {
                        element2.Validate();
            ...
            {
                foreach (var element3 in this.AdditionalDataDisks)
                {
                    if (element3 != null)
                    {
                        element3.Validate();
