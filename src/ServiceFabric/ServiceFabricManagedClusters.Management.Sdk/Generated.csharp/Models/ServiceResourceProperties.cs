...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ServiceResourceProperties : ServiceResourcePropertiesBase
    {
        ...
        /// is specified, then the DNS name can be used to return the IP
        /// addresses of service endpoints for application layer protocols
        /// (e.g., HTTP).
        /// When updating serviceDnsName, old name may be temporarily
        /// resolvable. However, rely on new name.
        /// When removing serviceDnsName, removed name may temporarily be
        /// resolvable. Do not rely on the name being unresolvable.
        /// </param>
        ...
        /// then the DNS name can be used to return the IP addresses of service
