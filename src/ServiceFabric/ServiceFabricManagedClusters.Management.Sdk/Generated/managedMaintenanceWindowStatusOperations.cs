...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters
{
    ...
    /// </summary>
    internal partial class ManagedMaintenanceWindowStatusOperations : Microsoft.Rest.IServiceOperations<ServiceFabricManagedClustersManagementClient>, IManagedMaintenanceWindowStatusOperations
    {
        /// <summary>
        /// Initializes a new instance of the ManagedMaintenanceWindowStatusOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ManagedMaintenanceWindowStatusOperations (ServiceFabricManagedClustersManagementClient client)
        {
            if (client == null) 
            {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<ManagedMaintenanceWindowStatus>> GetWithHttpMessagesAsync(string resourceGroupName, string clusterName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/getMaintenanceWindowStatus").ToString();
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<ManagedMaintenanceWindowStatus>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<ManagedMaintenanceWindowStatus>(_responseContent, this.Client.DeserializationSettings);
                }
