...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters
{
    ...
    /// </summary>
    internal partial class ManagedMaintenanceWindowStatusOperations : Microsoft.Rest.IServiceOperations<ServiceFabricManagementClient>, IManagedMaintenanceWindowStatusOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ManagedMaintenanceWindowStatusOperations (ServiceFabricManagementClient client)
        {
            if (client == null) 
            {
