...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ApplicationTypeResource : ProxyResource
    {
        ...
        /// response.
        /// </param>
        public ApplicationTypeResource(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), SystemData systemData = default(SystemData), string provisioningState = default(string))
