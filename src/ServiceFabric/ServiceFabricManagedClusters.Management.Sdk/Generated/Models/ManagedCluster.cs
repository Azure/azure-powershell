...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ManagedCluster : TrackedResource
    {
        ...
        /// <param name="enableOutboundOnlyNodeTypes">Enable the creation of node types with only outbound traffic enabled. If
        /// set, a separate load balancer backend pool will be created for node types
        /// with inbound traffic enabled. Can only be set at the time of cluster
        /// creation.
        /// </param>

        /// <param name="skipManagedNsgAssignment">Determines whether to skip the assignment of the managed network security
        ...
        /// <summary>
        /// Gets or sets enable the creation of node types with only outbound traffic
        /// enabled. If set, a separate load balancer backend pool will be created for
        /// node types with inbound traffic enabled. Can only be set at the time of
        /// cluster creation.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.enableOutboundOnlyNodeTypes")]
        public bool? EnableOutboundOnlyNodeTypes {get; set; }

        /// <summary>
        /// Gets or sets determines whether to skip the assignment of the managed
        /// network security group (SF-NSG) to the cluster subnet when using a
        /// bring-your-own virtual network (BYOVNET) configuration. The default value
        /// is false.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.skipManagedNsgAssignment")]
