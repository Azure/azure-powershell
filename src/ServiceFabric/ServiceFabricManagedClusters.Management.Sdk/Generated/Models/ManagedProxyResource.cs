...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters.Models
{
    ...
    /// </summary>
    public partial class ManagedProxyResource : Microsoft.Rest.Azure.IResource
    {
        /// <summary>
        ...
        /// </param>
        public ManagedProxyResource(string id = default(string), string name = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), SystemData systemData = default(SystemData))
