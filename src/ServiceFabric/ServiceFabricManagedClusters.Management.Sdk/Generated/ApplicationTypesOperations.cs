...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters
{
    ...
    /// </summary>
    internal partial class ApplicationTypesOperations : Microsoft.Rest.IServiceOperations<ServiceFabricManagedClustersManagementClient>, IApplicationTypesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ApplicationTypesOperations (ServiceFabricManagedClustersManagementClient client)
        {
            if (client == null) 
            {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationHeaderResponse<ApplicationTypesDeleteHeaders> _response = await BeginDeleteWithHttpMessagesAsync(resourceGroupName, clusterName, applicationTypeName, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationHeaderResponse<ApplicationTypesDeleteHeaders>> BeginDeleteWithHttpMessagesAsync(string resourceGroupName, string clusterName, string applicationTypeName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationHeaderResponse<ApplicationTypesDeleteHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<ApplicationTypesDeleteHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
            catch (Newtonsoft.Json.JsonException ex)
            {
                _httpRequest.Dispose();
