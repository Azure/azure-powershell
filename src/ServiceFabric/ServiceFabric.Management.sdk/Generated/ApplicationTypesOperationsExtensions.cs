...
namespace Microsoft.Azure.Management.ServiceFabric
{
    ...
    public static partial class ApplicationTypesOperationsExtensions
    {
        ...
        {
                return ((IApplicationTypesOperations)operations).CreateOrUpdateAsync(resourceGroupName, clusterName, applicationTypeName, id, name, type, location, tags, etag, systemData, provisioningState).GetAwaiter().GetResult();
        }
        ...
        {
            using (var _result = await operations.CreateOrUpdateWithHttpMessagesAsync(resourceGroupName, clusterName, applicationTypeName, id, name, type, location, tags, etag, systemData, provisioningState, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
            }
        }
