...
namespace Microsoft.Azure.Management.ServiceFabric
{
    ...
    public partial class ServiceFabricManagementClient : Microsoft.Rest.ServiceClient<ServiceFabricManagementClient>, IServiceFabricManagementClient, IAzureClient
    {
        ...
        private void Initialize()
        {
            ...
            SerializationSettings.Converters.Add(new Microsoft.Rest.Serialization.PolymorphicSerializeJsonConverter<PartitionSchemeDescription>("partitionScheme"));
            DeserializationSettings.Converters.Add(new Microsoft.Rest.Serialization.PolymorphicDeserializeJsonConverter<PartitionSchemeDescription>("partitionScheme"));
            SerializationSettings.Converters.Add(new Microsoft.Rest.Serialization.PolymorphicSerializeJsonConverter<ServicePlacementPolicyDescription>("type"));
            DeserializationSettings.Converters.Add(new Microsoft.Rest.Serialization.PolymorphicDeserializeJsonConverter<ServicePlacementPolicyDescription>("type"));
            SerializationSettings.Converters.Add(new Microsoft.Rest.Serialization.PolymorphicSerializeJsonConverter<ServiceResourceUpdateProperties>("serviceKind"));
            DeserializationSettings.Converters.Add(new Microsoft.Rest.Serialization.PolymorphicDeserializeJsonConverter<ServiceResourceUpdateProperties>("serviceKind"));
            CustomInitialize();
