...
namespace Microsoft.Azure.Management.ServiceFabric.Models
{
    ...
    public partial class ServiceTypeDeltaHealthPolicy
    {
        ...
        /// <param name="maxPercentDeltaUnhealthyServices">The maximum allowed percentage of services health degradation allowed
        ...
        /// <summary>
        /// Gets or sets the maximum allowed percentage of services health degradation
        ...
        {
            if (this.MaxPercentDeltaUnhealthyServices != null)
            {
                if (this.MaxPercentDeltaUnhealthyServices > 100)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.InclusiveMaximum, "MaxPercentDeltaUnhealthyServices", 100);
                }
                if (this.MaxPercentDeltaUnhealthyServices < 0)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.InclusiveMinimum, "MaxPercentDeltaUnhealthyServices", 0);
                }
            }
        }
    }
