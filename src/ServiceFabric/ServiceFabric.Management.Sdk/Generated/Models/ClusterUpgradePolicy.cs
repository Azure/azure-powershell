...
namespace Microsoft.Azure.Management.ServiceFabric.Models
{
    ...
    public partial class ClusterUpgradePolicy
    {
        ...
        /// <param name="healthPolicy">The cluster health policy used when upgrading the cluster.
        /// </param>

        /// <param name="deltaHealthPolicy">The cluster delta health policy used when upgrading the cluster.
        /// </param>
        ...
        /// of each upgrade domain. The timeout can be in either hh:mm:ss or in
        /// d.hh:mm:ss.ms format.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the cluster delta health policy used when upgrading the
        /// cluster.
        /// </summary>
        ...
        {
            if (this.UpgradeReplicaSetCheckTimeout == null)
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "UpgradeReplicaSetCheckTimeout");
            }
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "HealthPolicy");
            }
