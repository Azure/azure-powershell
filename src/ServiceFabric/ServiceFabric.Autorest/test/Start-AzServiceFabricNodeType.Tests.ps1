if(($null -eq $TestName) -or ($TestName -contains 'Start-AzServiceFabricNodeType'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Start-AzServiceFabricNodeType.Recording.json'
...
Describe 'Start-AzServiceFabricNodeType' {
