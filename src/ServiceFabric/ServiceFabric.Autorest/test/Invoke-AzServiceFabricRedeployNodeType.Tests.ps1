if(($null -eq $TestName) -or ($TestName -contains 'Invoke-AzServiceFabricRedeployNodeType'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Invoke-AzServiceFabricRedeployNodeType.Recording.json'
...
Describe 'Invoke-AzServiceFabricRedeployNodeType' {
