if(($null -eq $TestName) -or ($TestName -contains 'Start-AzServiceFabricManagedNodeType'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Start-AzServiceFabricManagedNodeType.Recording.json'
...
Describe 'Start-AzServiceFabricManagedNodeType' {
