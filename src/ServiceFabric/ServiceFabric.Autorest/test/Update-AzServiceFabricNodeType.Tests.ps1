if(($null -eq $TestName) -or ($TestName -contains 'Update-AzServiceFabricNodeType'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Update-AzServiceFabricNodeType.Recording.json'
...
Describe 'Update-AzServiceFabricNodeType' {
