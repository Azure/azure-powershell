if(($null -eq $TestName) -or ($TestName -contains 'Invoke-AzServiceFabricDeallocateNodeType'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Invoke-AzServiceFabricDeallocateNodeType.Recording.json'
...
Describe 'Invoke-AzServiceFabricDeallocateNodeType' {
