...
```
Restart-AzServiceFabricManagedNodeType -ManagedClusterInputObject <IServiceFabricIdentity> -Name <String>
 -Parameter <INodeTypeActionParameters> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.Management.Automation.SwitchParameter
Parameter Sets: RestartExpanded, RestartViaIdentityExpanded, RestartViaIdentityManagedClusterExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ServiceFabric.Models.IServiceFabricIdentity
Parameter Sets: RestartViaIdentityManagedCluster, RestartViaIdentityManagedClusterExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Restart, RestartExpanded, RestartViaIdentityManagedCluster, RestartViaIdentityManagedClusterExpanded, RestartViaJsonFilePath, RestartViaJsonString
...
Parameter Sets: Restart, RestartViaIdentity, RestartViaIdentityManagedCluster
Aliases:
