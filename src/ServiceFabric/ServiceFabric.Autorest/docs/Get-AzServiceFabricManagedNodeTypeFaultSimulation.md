...
```
Get-AzServiceFabricManagedNodeTypeFaultSimulation -ManagedClusterInputObject <IServiceFabricIdentity>
 -NodeTypeName <String> -Parameter <IFaultSimulationIdContent> [-DefaultProfile <PSObject>] [-Confirm]
...
```
Get-AzServiceFabricManagedNodeTypeFaultSimulation -ManagedClusterInputObject <IServiceFabricIdentity>
 -NodeTypeName <String> -SimulationId <String> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ServiceFabric.Models.IServiceFabricIdentity
Parameter Sets: GetViaIdentityManagedCluster, GetViaIdentityManagedClusterExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Get, GetExpanded, GetViaIdentityManagedCluster, GetViaIdentityManagedClusterExpanded, GetViaJsonFilePath, GetViaJsonString, List
Aliases:
...
Parameter Sets: Get, GetViaIdentity, GetViaIdentityManagedCluster
Aliases:
...
```yaml
Type: System.String
Parameter Sets: GetExpanded, GetViaIdentityExpanded, GetViaIdentityManagedClusterExpanded
Aliases:
