...
### Delete (Default)
```
Remove-AzServiceFabricManagedClusterService -ApplicationName <String> -ClusterName <String> -Name <String>
...
```
Remove-AzServiceFabricManagedClusterService -ApplicationInputObject <IServiceFabricIdentity> -Name <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentityManagedCluster
```
Remove-AzServiceFabricManagedClusterService -ApplicationName <String>
 -ManagedClusterInputObject <IServiceFabricIdentity> -Name <String> [-DefaultProfile <PSObject>] [-AsJob]
...
```yaml
Type: System.String
Parameter Sets: Delete, DeleteViaIdentityApplication, DeleteViaIdentityManagedCluster
Aliases: ServiceName
