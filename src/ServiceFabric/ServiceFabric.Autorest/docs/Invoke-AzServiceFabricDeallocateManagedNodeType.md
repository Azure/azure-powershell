...
```
Invoke-AzServiceFabricDeallocateManagedNodeType -ManagedClusterInputObject <IServiceFabricIdentity>
...
```yaml
Type: System.Management.Automation.SwitchParameter
Parameter Sets: DeallocateExpanded, DeallocateViaIdentityExpanded, DeallocateViaIdentityManagedClusterExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ServiceFabric.Models.IServiceFabricIdentity
Parameter Sets: DeallocateViaIdentityManagedCluster, DeallocateViaIdentityManagedClusterExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Deallocate, DeallocateExpanded, DeallocateViaIdentityManagedCluster, DeallocateViaIdentityManagedClusterExpanded, DeallocateViaJsonFilePath, DeallocateViaJsonString
Aliases:
...
Parameter Sets: Deallocate, DeallocateViaIdentity, DeallocateViaIdentityManagedCluster
Aliases:
