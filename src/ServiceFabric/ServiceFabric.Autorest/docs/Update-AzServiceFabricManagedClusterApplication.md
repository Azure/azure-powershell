...
online version: https://learn.microsoft.com/powershell/module/az.servicefabric/update-azservicefabricmanagedclusterapplication
schema: 2.0.0
---
...
```
Update-AzServiceFabricManagedClusterApplication -ClusterName <String> -Name <String>
...
```
Update-AzServiceFabricManagedClusterApplication -InputObject <IServiceFabricIdentity> [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityManagedClusterExpanded
```
Update-AzServiceFabricManagedClusterApplication -ManagedClusterInputObject <IServiceFabricIdentity>
