...
### Delete (Default)
```
Remove-AzServiceFabricManagedClusterApplicationTypeVersion -ApplicationTypeName <String> -ClusterName <String>
...
```
Remove-AzServiceFabricManagedClusterApplicationTypeVersion
 -ApplicationTypeInputObject <IServiceFabricIdentity> -Version <String> [-DefaultProfile <PSObject>] [-AsJob]
...
Remove-AzServiceFabricManagedClusterApplicationTypeVersion -ApplicationTypeName <String>
 -ManagedClusterInputObject <IServiceFabricIdentity> -Version <String> [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Delete, DeleteViaIdentityApplicationType, DeleteViaIdentityManagedCluster
Aliases:
