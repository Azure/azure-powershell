...
Start-AzServiceFabricManagedNodeTypeFaultSimulation -ClusterName <String> -NodeTypeName <String>
 ...
 [-ParameterForce] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Start
```
Start-AzServiceFabricManagedNodeTypeFaultSimulation -ClusterName <String> -NodeTypeName <String>
 -ResourceGroupName <String> -Parameter <IFaultSimulationContentWrapper> [-SubscriptionId <String>]
...
```
Start-AzServiceFabricManagedNodeTypeFaultSimulation -ManagedClusterInputObject <IServiceFabricIdentity>
 -NodeTypeName <String> -Parameter <IFaultSimulationContentWrapper> [-DefaultProfile <PSObject>] [-AsJob]
...
```
Start-AzServiceFabricManagedNodeTypeFaultSimulation -ManagedClusterInputObject <IServiceFabricIdentity>
 -NodeTypeName <String> [-ConstraintExpirationTime <DateTime>] [-ParameterForce] [-DefaultProfile <PSObject>]
