...
Get-AzServiceFabricManagedClusterVersion -ClusterVersion <String>
 -LocationInputObject <IServiceFabricIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Get, Get1, GetViaIdentityLocation, GetViaIdentityLocation1
Aliases:
