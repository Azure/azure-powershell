...
```
Start-AzServiceFabricManagedNodeType -ManagedClusterInputObject <IServiceFabricIdentity> -Name <String>
 -Parameter <INodeTypeActionParameters> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.Management.Automation.SwitchParameter
Parameter Sets: StartExpanded, StartViaIdentityExpanded, StartViaIdentityManagedClusterExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ServiceFabric.Models.IServiceFabricIdentity
Parameter Sets: StartViaIdentityManagedCluster, StartViaIdentityManagedClusterExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Start, StartExpanded, StartViaIdentityManagedCluster, StartViaIdentityManagedClusterExpanded, StartViaJsonFilePath, StartViaJsonString
...
Parameter Sets: Start, StartViaIdentity, StartViaIdentityManagedCluster
Aliases:
