...
```
Invoke-AzServiceFabricRedeployManagedNodeType -InputObject <IServiceFabricIdentity> [-Force]
 [-Node <String[]>] [-UpdateType <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RedeployViaIdentityManagedCluster
```
Invoke-AzServiceFabricRedeployManagedNodeType -ManagedClusterInputObject <IServiceFabricIdentity>
...
```yaml
Type: System.String
Parameter Sets: Redeploy, RedeployExpanded, RedeployViaJsonFilePath, RedeployViaJsonString
Aliases:
...
```yaml
Type: System.Management.Automation.SwitchParameter
Parameter Sets: RedeployExpanded, RedeployViaIdentityExpanded, RedeployViaIdentityManagedClusterExpanded
Aliases:
...
Parameter Sets: RedeployViaIdentity, RedeployViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ServiceFabric.Models.IServiceFabricIdentity
Parameter Sets: RedeployViaIdentityManagedCluster, RedeployViaIdentityManagedClusterExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Redeploy, RedeployExpanded, RedeployViaIdentityManagedCluster, RedeployViaIdentityManagedClusterExpanded, RedeployViaJsonFilePath, RedeployViaJsonString
Aliases:
...
Parameter Sets: Redeploy, RedeployViaIdentity, RedeployViaIdentityManagedCluster
Aliases:
