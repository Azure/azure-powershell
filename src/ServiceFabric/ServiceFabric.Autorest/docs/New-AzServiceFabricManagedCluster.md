...
```
New-AzServiceFabricManagedCluster -ClusterName <String> -ResourceGroupName <String> -Location <String>
 -SkuName <String> [-SubscriptionId <String>] [-AddonFeature <String[]>] [-AdminPassword <SecureString>]
 [-AdminUserName <String>] [-AllocatedOutboundPort <Int32>] [-AllowRdpAccess]
 ...
 [-ZonalResiliency] [-ZonalUpdateMode <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaJsonFilePath
```
New-AzServiceFabricManagedCluster -ClusterName <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### CreateViaJsonString
```
New-AzServiceFabricManagedCluster -ClusterName <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
