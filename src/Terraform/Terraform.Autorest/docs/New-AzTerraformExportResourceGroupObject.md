...
```
New-AzTerraformExportResourceGroupObject -ResourceGroupName <String> [-FullProperty <Boolean>]
 [-MaskSensitive <Boolean>] [-NamePattern <String>] [-TargetProvider <String>] [<CommonParameters>]
```
