...
using Microsoft.Azure.PowerShell.Cmdlets.Terraform.Runtime.Json;
using System;

namespace Microsoft.Azure.PowerShell.Cmdlets.Terraform.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.Terraform.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.Terraform.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return Microsoft.Azure.PowerShell.Cmdlets.Terraform.Runtime.JsonSerializable.ToJson(dict, null);
            }
