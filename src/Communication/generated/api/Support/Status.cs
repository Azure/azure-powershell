...
namespace Microsoft.Azure.PowerShell.Cmdlets.Communication.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.Status Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.Status Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.Status Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.Status Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.Status Moving = @"Moving";

        public static Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.Status Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
