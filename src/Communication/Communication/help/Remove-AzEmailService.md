...
online version: https://learn.microsoft.com/powershell/module/az.communication/remove-azemailservice
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzEmailService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzEmailService -InputObject <IEmailServiceIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
