            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (EmailServiceInputObject?.Id != null)
                    {
                        ...
                        await this.Client.SenderUsernamesCreateOrUpdateViaIdentity(EmailServiceInputObject.Id, _parametersBody, onOk, onCreated, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        this.Update_parametersBody();
                        await this.Client.SenderUsernamesCreateOrUpdate(EmailServiceInputObject.SubscriptionId ?? null, EmailServiceInputObject.ResourceGroupName ?? null, EmailServiceInputObject.EmailServiceName ?? null, DomainName, SenderUsername, _parametersBody, onOk, onCreated, onDefault, this, Pipeline);
                    }
