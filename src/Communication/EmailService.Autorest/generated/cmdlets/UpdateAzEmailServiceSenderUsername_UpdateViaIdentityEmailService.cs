...
namespace Microsoft.Azure.PowerShell.Cmdlets.EmailService.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EmailService.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (EmailServiceInputObject?.Id != null)
                    {
                        ...
                        await this.Client.SenderUsernamesCreateOrUpdateViaIdentity(EmailServiceInputObject.Id, Parameter, onOk, onCreated, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        this.UpdateParameter();
                        await this.Client.SenderUsernamesCreateOrUpdate(EmailServiceInputObject.SubscriptionId ?? null, EmailServiceInputObject.ResourceGroupName ?? null, EmailServiceInputObject.EmailServiceName ?? null, DomainName, SenderUsername, Parameter, onOk, onCreated, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzEmailServiceSenderUsername_UpdateViaIdentityEmailService" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzEmailServiceSenderUsername_UpdateViaIdentityEmailService()
        {
