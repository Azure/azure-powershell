...
namespace Microsoft.Azure.PowerShell.Cmdlets.EmailService.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListBySubscription=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Communication/emailServices"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzEmailService_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.EmailService.Description(@"Handles requests to list all resources in a subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EmailService.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EmailService.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Communication/emailServices", ApiVersion = "2023-06-01-preview")]
    public partial class GetAzEmailService_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EmailService.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzEmailService_List" /> cmdlet class.
        /// </summary>
        public GetAzEmailService_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.EmailServicesListBySubscription(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.EmailServicesListBySubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
