...
Get the Domains resource and its properties.
.Example
PS C:\> Get-AzEmailServiceDomain -EmailServiceName ContosoAcsResource1 -ResourceGroupName ContosoResourceProvider1
...
.Example
PS C:\> Get-AzEmailServiceDomain -Name AzureManagedDomain -EmailServiceName ContosoAcsResource1 -ResourceGroupName ContosoResourceProvider1
...
INPUTOBJECT <IEmailServiceIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/az.emailservice/get-azemailservicedomain
#>
...
Get a valid sender username for a domains resource.
.Example
PS C:\> Get-AzEmailServiceSenderUsername -SenderUsername donotreply -DomainName AzureManagedDomain -EmailServiceName ContosoAcsResource1 -ResourceGroupName ContosoResourceProvider1
...
Username                     : donotreply
.Example
PS C:\> Get-AzEmailServiceSenderUsername -DomainName AzureManagedDomain -EmailServiceName ContosoAcsResource1 -ResourceGroupName ContosoResourceProvider1
...
INPUTOBJECT <IEmailServiceIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/az.emailservice/get-azemailservicesenderusername
#>
...
.Example
PS C:\> Get-AzEmailService -Name ContosoAcsResource1 -ResourceGroupName ContosoResourceProvider1
...
INPUTOBJECT <IEmailServiceIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/az.emailservice/get-azemailservice
#>
...
Initiate verification of DNS record.
.Example
PS C:\> Invoke-AzEmailServiceInitiateDomainVerification -DomainName testcustomdomain1.net -EmailServiceName ContosoAcsResource1 -ResourceGroupName ContosoResourceProvider1 -VerificationType Domain
...
.Link
https://learn.microsoft.com/powershell/module/az.emailservice/invoke-azemailserviceinitiatedomainverification
#>
...
Add a new Domains resource under the parent EmailService resource or update an existing Domains resource.
.Example
PS C:\> New-AzEmailServiceDomain -Name testcustomdomain2.net -EmailServiceName ContosoAcsResource1 -ResourceGroupName ContosoResourceProvider1 -DomainManagement CustomerManaged
...
.Example
PS C:\> New-AzEmailServiceDomain -Name AzureManagedDomain -EmailServiceName ContosoAcsResource1 -ResourceGroupName ContosoResourceProvider1 -DomainManagement AzureManaged
...
.Link
https://learn.microsoft.com/powershell/module/az.emailservice/new-azemailservicedomain
#>
...
Add a new SenderUsername resource under the parent Domains resource or update an existing SenderUsername resource.
.Example
PS C:\> New-AzEmailServiceSenderUsername -SenderUsername test -Username test -DomainName testcustomdomain2.net -EmailServiceName ContosoAcsResource1 -ResourceGroupName ContosoResourceProvider1
...
Username                     : test
.Example
PS C:\> New-AzEmailServiceSenderUsername -SenderUsername test -Username test -DomainName AzureManagedDomain -EmailServiceName ContosoAcsResource1 -ResourceGroupName ContosoResourceProvider1							   
...
.Link
https://learn.microsoft.com/powershell/module/az.emailservice/new-azemailservicesenderusername
#>
...
Create a new EmailService or update an existing EmailService.
.Example
PS C:\> New-AzEmailService -Name ContosoAcsResource1 -ResourceGroupName ContosoResourceProvider1 -DataLocation "United States"
...
Microsoft.Azure.PowerShell.Cmdlets.EmailService.Models.IEmailServiceResource
.Link
https://learn.microsoft.com/powershell/module/az.emailservice/new-azemailservice
#>
...
INPUTOBJECT <IEmailServiceIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/az.emailservice/remove-azemailservicesenderusername
#>
...
INPUTOBJECT <IEmailServiceIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/az.emailservice/remove-azemailservice
#>
...
.Example
PS C:\> Update-AzEmailServiceDomain -Name AzureManagedDomain -EmailServiceName ContosoAcsResource1 -ResourceGroupName ContosoResourceProvider1 -Tag @{ExampleKey1="ExampleValue1updated"} -UserEngagementTracking 1
...
PARAMETER <IUpdateDomainRequestParameters>: A class that describes the PATCH request parameters of a Domains resource.
  ...
  [UserEngagementTracking <String>]: Describes whether user engagement tracking is enabled or disabled.
.Link
https://learn.microsoft.com/powershell/module/az.emailservice/update-azemailservicedomain
#>
...
Operation to update an existing EmailService.
.Example
PS C:\> Update-AzEmailService -Name ContosoAcsResource1 -ResourceGroupName ContosoResourceProvider1 -Tag @{ExampleKey1="UpdatedTagValue"}
...
INPUTOBJECT <IEmailServiceIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/az.emailservice/update-azemailservice
#>
