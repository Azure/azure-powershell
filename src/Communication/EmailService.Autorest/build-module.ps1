...
$dll = Join-Path $PSScriptRoot 'bin\Az.EmailService.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.EmailService.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.EmailService.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.EmailService'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: EmailService cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.EmailService.format.ps1xml'
