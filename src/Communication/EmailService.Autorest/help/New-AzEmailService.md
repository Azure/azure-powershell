...
```
New-AzEmailService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
New-AzEmailService -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### CreateViaJsonString
```
New-AzEmailService -Name <String> -ResourceGroupName <String> -JsonString <String> [-SubscriptionId <String>]
