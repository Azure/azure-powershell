...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.EmailServicedata.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.EmailServicedata.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: EmailServicedata cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.EmailServicedata.format.ps1xml'
