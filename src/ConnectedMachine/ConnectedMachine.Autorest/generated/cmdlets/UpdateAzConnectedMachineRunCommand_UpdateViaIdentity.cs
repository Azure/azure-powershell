...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzConnectedMachineRunCommand_UpdateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzConnectedMachineRunCommand_UpdateViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="RunCommandProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Models.IMachineRunCommand _runCommandProperty;

        /// <summary>Describes a Run Command</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Describes a Run Command", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Describes a Run Command",
        SerializedName = @"runCommandProperties",
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Models.IMachineRunCommand RunCommandProperty { get => this._runCommandProperty; set => this._runCommandProperty = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzConnectedMachineRunCommand_UpdateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Cmdlets.UpdateAzConnectedMachineRunCommand_UpdateViaIdentity Clone()
        {
            var clone = new UpdateAzConnectedMachineRunCommand_UpdateViaIdentity();
            ...
            clone.RunCommandProperty = this.RunCommandProperty;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        RunCommandProperty = await this.Client.MachineRunCommandsGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.UpdateRunCommandProperty();
                        await this.Client.MachineRunCommandsCreateOrUpdateViaIdentity(InputObject.Id, RunCommandProperty, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.RunCommandName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.RunCommandName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        RunCommandProperty = await this.Client.MachineRunCommandsGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.MachineName ?? null, InputObject.RunCommandName ?? null, this, Pipeline);
                        this.UpdateRunCommandProperty();
                        await this.Client.MachineRunCommandsCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.MachineName ?? null, InputObject.RunCommandName ?? null, RunCommandProperty, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzConnectedMachineRunCommand_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzConnectedMachineRunCommand_UpdateViaIdentity()
        {

        }

        private void UpdateRunCommandProperty()
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("RunCommandProperty")))
            {
