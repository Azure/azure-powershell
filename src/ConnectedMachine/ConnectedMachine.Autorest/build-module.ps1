...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.ConnectedMachine.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.ConnectedMachine.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: ConnectedMachine cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.ConnectedMachine.format.ps1xml'
