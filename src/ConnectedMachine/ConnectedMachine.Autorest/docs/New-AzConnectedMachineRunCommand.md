...
```powershell
New-AzConnectedMachineRunCommand -ResourceGroupName "az-sdk-test" -Location "eastus2euap" -SourceScript "Write-Host Hello World!" -RunCommandName "myRunCommand3" -MachineName "testmachine" -SubscriptionId $env.SubcriptionId
```
...
ErrorBlobUri                      :
Id                                : /subscriptions/subcriptionid/resourceGroups/az-sdk-test/prov
