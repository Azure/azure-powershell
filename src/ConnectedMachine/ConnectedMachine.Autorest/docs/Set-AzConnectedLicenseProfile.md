...
online version: https://learn.microsoft.com/powershell/module/az.connectedmachine/set-azconnectedlicenseprofile
schema: 2.0.0
---

# Set-AzConnectedLicenseProfile
...
```
Set-AzConnectedLicenseProfile -MachineName <String> -ResourceGroupName <String> -Location <String>
...
### Update
```
Set-AzConnectedLicenseProfile -MachineName <String> -ResourceGroupName <String> -Parameter <ILicenseProfile>
...
```
Set-AzConnectedLicenseProfile -MachineName <String> -ResourceGroupName <String> -JsonFilePath <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### UpdateViaJsonString
```
Set-AzConnectedLicenseProfile -MachineName <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
