@{
  ...
  FunctionsToExport = 'Connect-AzConnectedMachine', 'Get-AzConnectedMachine', 'Get-AzConnectedMachineExtension', 'Remove-AzConnectedMachine', 'Remove-AzConnectedMachineExtension', 'Set-AzConnectedMachineExtension', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
