...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] MachineExtensions_Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridCompute/machines/{name}/extensions/{extensionName}"
    /// </remarks>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzConnectedMachineExtension_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.MachineExtensionsGet(ResourceGroupName, MachineName, Name, SubscriptionId, onOk, this, Pipeline);
