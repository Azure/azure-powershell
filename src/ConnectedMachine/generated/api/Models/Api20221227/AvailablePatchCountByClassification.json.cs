namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Models.Api20221227
{
    ...
    public partial class AvailablePatchCountByClassification
    {
        ...
        internal AvailablePatchCountByClassification(Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.Json.JsonObject json)
        {
            ...
            {_security = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.Json.JsonNumber>("security"), out var __jsonSecurity) ? (int?)__jsonSecurity : Security;}
            {_critical = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.Json.JsonNumber>("critical"), out var __jsonCritical) ? (int?)__jsonCritical : Critical;}
            {_definition = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.Json.JsonNumber>("definition"), out var __jsonDefinition) ? (int?)__jsonDefinition : Definition;}
            {_updateRollup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.Json.JsonNumber>("updateRollup"), out var __jsonUpdateRollup) ? (int?)__jsonUpdateRollup : UpdateRollup;}
            {_featurePack = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.Json.JsonNumber>("featurePack"), out var __jsonFeaturePack) ? (int?)__jsonFeaturePack : FeaturePack;}
            {_servicePack = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.Json.JsonNumber>("servicePack"), out var __jsonServicePack) ? (int?)__jsonServicePack : ServicePack;}
            {_tool = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.Json.JsonNumber>("tools"), out var __jsonTools) ? (int?)__jsonTools : Tool;}
            {_update = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.Json.JsonNumber>("updates"), out var __jsonUpdates) ? (int?)__jsonUpdates : Update;}
            {_other = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.Json.JsonNumber>("other"), out var __jsonOther) ? (int?)__jsonOther : Other;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Models.Api20221227.IAvailablePatchCountByClassification.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Models.Api20221227.IAvailablePatchCountByClassification.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Models.Api20221227.IAvailablePatchCountByClassification FromJson(Microsoft.Azure.PowerShell.Cmdlets.ConnectedMachine.Runtime.Json.JsonNode node)
        {
