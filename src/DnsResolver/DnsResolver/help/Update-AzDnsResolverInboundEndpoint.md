...
```
Update-AzDnsResolverInboundEndpoint -DnsResolverName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-IfMatch <String>] -JsonString <String> [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
Update-AzDnsResolverInboundEndpoint -DnsResolverName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-IfMatch <String>] -JsonFilePath <String> [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityDnsResolverExpanded
```
Update-AzDnsResolverInboundEndpoint -Name <String> -DnsResolverInputObject <IDnsResolverIdentity>
...
Parameter Sets: UpdateViaIdentityDnsResolverExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaJsonString, UpdateViaJsonFilePath, UpdateViaIdentityDnsResolverExpanded
...
Parameter Sets: UpdateExpanded, UpdateViaIdentityDnsResolverExpanded, UpdateViaIdentityExpanded
Aliases:
