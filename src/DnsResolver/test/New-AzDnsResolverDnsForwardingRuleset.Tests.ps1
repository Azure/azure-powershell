...
Describe 'New-AzDnsResolverDnsForwardingRuleset ' {
    It 'Create DNS forwarding ruleset with new outbound endpoint' -skip {
    ...
    It 'Create DNS forwarding ruleset with a malformed outbound endpoint id' -skip {
        $dnsForwardingRulesetName = "forwardingRulesetForGet" + (RandomString -allChars $false -len 6)
    ...
    It 'Create DNS forwarding ruleset with tags, expect DNS forwarding ruleset created' -skip{
    ...
    It 'Create DNS forwarding ruleset with a non-existant outbound endpoint' -skip{
        $dnsForwardingRulesetName = "forwardingRulesetForGet" + (RandomString -allChars $false -len 6)
