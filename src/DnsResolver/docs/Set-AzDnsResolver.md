...
online version: https://docs.microsoft.com/powershell/module/az.dnsresolver/set-azdnsresolver
schema: 2.0.0
---
...
```
Set-AzDnsResolver -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
