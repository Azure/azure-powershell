...
online version: https://docs.microsoft.com/powershell/module/az.dnsresolver/set-azdnsresolverinboundendpoint
schema: 2.0.0
---

# Set-AzDnsResolverInboundEndpoint
...
```
Set-AzDnsResolverInboundEndpoint -DnsResolverName <String> -Name <String> -ResourceGroupName <String>
