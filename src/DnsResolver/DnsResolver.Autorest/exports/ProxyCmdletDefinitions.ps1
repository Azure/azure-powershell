...
.Link
https://learn.microsoft.com/powershell/module/az.dnsresolver/get-azdnsforwardingrulesetdnsresolverpolicyvirtualnetworklink
#>
function Get-AzDnsForwardingRulesetDnsResolverPolicyVirtualNetworkLink {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DnsResolver.private\Get-AzDnsForwardingRulesetDnsResolverPolicyVirtualNetworkLink_Get';
            GetViaIdentity = 'Az.DnsResolver.private\Get-AzDnsForwardingRulesetDnsResolverPolicyVirtualNetworkLink_GetViaIdentity';
            List = 'Az.DnsResolver.private\Get-AzDnsForwardingRulesetDnsResolverPolicyVirtualNetworkLink_List';
        }
...
INPUTOBJECT <IDnsResolverIdentity>: Identity Parameter
  ...
  [VirtualNetworkName <String>]: The name of the virtual network.
.Link
https://learn.microsoft.com/powershell/module/az.dnsresolver/get-azdnsresolverdnssecurityrule
#>
function Get-AzDnsResolverDnsSecurityRule {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DnsResolver.private\Get-AzDnsResolverDnsSecurityRule_Get';
            GetViaIdentity = 'Az.DnsResolver.private\Get-AzDnsResolverDnsSecurityRule_GetViaIdentity';
            List = 'Az.DnsResolver.private\Get-AzDnsResolverDnsSecurityRule_List';
        }
        if (('Get', 'List') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
...
Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20230701Preview.IDnsResolverPolicyVirtualNetworkLink
.Link
https://learn.microsoft.com/powershell/module/az.dnsresolver/new-azdnsforwardingrulesetdnsresolverpolicyvirtualnetworklink
#>
function New-AzDnsForwardingRulesetDnsResolverPolicyVirtualNetworkLink {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20230701Preview.IDnsResolverPolicyVirtualNetworkLink])]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.DnsResolver.private\New-AzDnsForwardingRulesetDnsResolverPolicyVirtualNetworkLink_CreateExpanded';
        }
...
DNSRESOLVERDOMAINLIST <ISubResource[]>: DNS resolver policy domains lists that the DNS security rule applies to.
  Id <String>: Resource ID.
.Link
https://learn.microsoft.com/powershell/module/az.dnsresolver/new-azdnsresolverdnssecurityrule
#>
function New-AzDnsResolverDnsSecurityRule {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20230701Preview.IDnsSecurityRule])]
[CmdletBinding(DefaultParameterSetName='CreateExpanded', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory)]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.DnsResolver.private\New-AzDnsResolverDnsSecurityRule_CreateExpanded';
        }
        if (('CreateExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
...
INPUTOBJECT <IDnsResolverIdentity>: Identity Parameter
  ...
  [VirtualNetworkName <String>]: The name of the virtual network.
.Link
https://learn.microsoft.com/powershell/module/az.dnsresolver/remove-azdnsforwardingrulesetdnsresolverpolicyvirtualnetworklink
#>
function Remove-AzDnsForwardingRulesetDnsResolverPolicyVirtualNetworkLink {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.DnsResolver.private\Remove-AzDnsForwardingRulesetDnsResolverPolicyVirtualNetworkLink_Delete';
            DeleteViaIdentity = 'Az.DnsResolver.private\Remove-AzDnsForwardingRulesetDnsResolverPolicyVirtualNetworkLink_DeleteViaIdentity';
        }
...
INPUTOBJECT <IDnsResolverIdentity>: Identity Parameter
  ...
  [VirtualNetworkName <String>]: The name of the virtual network.
.Link
https://learn.microsoft.com/powershell/module/az.dnsresolver/remove-azdnsresolverdnssecurityrule
#>
function Remove-AzDnsResolverDnsSecurityRule {
[OutputType([System.Boolean])]
[CmdletBinding(DefaultParameterSetName='Delete', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Delete', Mandatory)]
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.DnsResolver.private\Remove-AzDnsResolverDnsSecurityRule_Delete';
            DeleteViaIdentity = 'Az.DnsResolver.private\Remove-AzDnsResolverDnsSecurityRule_DeleteViaIdentity';
        }
        if (('Delete') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
...
INPUTOBJECT <IDnsResolverIdentity>: Identity Parameter
  ...
  [VirtualNetworkName <String>]: The name of the virtual network.
.Link
https://learn.microsoft.com/powershell/module/az.dnsresolver/update-azdnsforwardingrulesetdnsresolverpolicyvirtualnetworklink
#>
function Update-AzDnsForwardingRulesetDnsResolverPolicyVirtualNetworkLink {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20230701Preview.IDnsResolverPolicyVirtualNetworkLink])]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.DnsResolver.private\Update-AzDnsForwardingRulesetDnsResolverPolicyVirtualNetworkLink_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.DnsResolver.private\Update-AzDnsForwardingRulesetDnsResolverPolicyVirtualNetworkLink_UpdateViaIdentityExpanded';
        }
...
INPUTOBJECT <IDnsResolverIdentity>: Identity Parameter
  ...
  [VirtualNetworkName <String>]: The name of the virtual network.
.Link
https://learn.microsoft.com/powershell/module/az.dnsresolver/update-azdnsresolverdnssecurityrule
#>
function Update-AzDnsResolverDnsSecurityRule {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20230701Preview.IDnsSecurityRule])]
[CmdletBinding(DefaultParameterSetName='UpdateExpanded', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='UpdateExpanded', Mandatory)]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.DnsResolver.private\Update-AzDnsResolverDnsSecurityRule_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.DnsResolver.private\Update-AzDnsResolverDnsSecurityRule_UpdateViaIdentityExpanded';
        }
        if (('UpdateExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
