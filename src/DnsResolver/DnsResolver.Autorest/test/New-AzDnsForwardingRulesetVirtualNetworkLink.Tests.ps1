...
Describe 'New-AzDnsForwardingRulesetVirtualNetworkLink' {
    BeforeAll {
        ...
        $rgName = "ps-frs-vnl-new-$(Get-Random -Max 99999)"
    ...
    It 'Create a VNet link' {
        $vnetId = "/subscriptions/$subscriptionId/resourceGroups/$rgName/providers/Microsoft.Network/virtualNetworks/vnet-frs"
        $link = New-AzDnsForwardingRulesetVirtualNetworkLink -DnsForwardingRulesetName "frs-vnl" -Name "vnl-new-1" -ResourceGroupName $rgName -VirtualNetworkId $vnetId
