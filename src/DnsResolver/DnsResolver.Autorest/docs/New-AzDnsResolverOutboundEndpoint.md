...
```
New-AzDnsResolverOutboundEndpoint -DnsResolverInputObject <IDnsResolverIdentity> -Name <String>
 -Location <String> -SubnetId <String> [-IfMatch <String>] [-IfNoneMatch <String>] [-Tag <Hashtable>]
