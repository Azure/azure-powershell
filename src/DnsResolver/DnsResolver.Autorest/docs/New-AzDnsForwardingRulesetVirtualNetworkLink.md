...
```
New-AzDnsForwardingRulesetVirtualNetworkLink -DnsForwardingRulesetInputObject <IDnsResolverIdentity>
 -Name <String> -VirtualNetworkId <String> [-IfMatch <String>] [-IfNoneMatch <String>] [-Metadata <Hashtable>]
