...
```
New-AzDnsResolverPolicyVirtualNetworkLink -DnsResolverPolicyInputObject <IDnsResolverIdentity> -Name <String>
 -Location <String> -VirtualNetworkId <String> [-IfMatch <String>] [-IfNoneMatch <String>] [-Tag <Hashtable>]
