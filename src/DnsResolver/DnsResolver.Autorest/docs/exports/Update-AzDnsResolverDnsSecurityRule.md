...
online version: https://learn.microsoft.com/powershell/module/az.dnsresolver/update-azdnsresolverdnssecurityrule
schema: 2.0.0
---

# Update-AzDnsResolverDnsSecurityRule
...
```
Update-AzDnsResolverDnsSecurityRule -DnsResolverPolicyName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-IfMatch <String>] [-ActionBlockResponseCode <BlockResponseCode>]
...
```
Update-AzDnsResolverDnsSecurityRule -InputObject <IDnsResolverIdentity> [-IfMatch <String>]
