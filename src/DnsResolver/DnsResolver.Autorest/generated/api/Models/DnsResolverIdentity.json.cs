...
namespace Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models
{
    ...
    public partial class DnsResolverIdentity
    {
        ...
        internal DnsResolverIdentity(Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonObject json)
        {
            ...
            {_dnsResolverPolicyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("dnsResolverPolicyName"), out var __jsonDnsResolverPolicyName) ? (string)__jsonDnsResolverPolicyName : (string)DnsResolverPolicyName;}
            {_dnsSecurityRuleName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("dnsSecurityRuleName"), out var __jsonDnsSecurityRuleName) ? (string)__jsonDnsSecurityRuleName : (string)DnsSecurityRuleName;}
            {_dnsResolverPolicyVirtualNetworkLinkName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("dnsResolverPolicyVirtualNetworkLinkName"), out var __jsonDnsResolverPolicyVirtualNetworkLinkName) ? (string)__jsonDnsResolverPolicyVirtualNetworkLinkName : (string)DnsResolverPolicyVirtualNetworkLinkName;}
            {_dnsResolverDomainListName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("dnsResolverDomainListName"), out var __jsonDnsResolverDomainListName) ? (string)__jsonDnsResolverDomainListName : (string)DnsResolverDomainListName;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._dnsResolverPolicyName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString(this._dnsResolverPolicyName.ToString()) : null, "dnsResolverPolicyName" ,container.Add );
            AddIf( null != (((object)this._dnsSecurityRuleName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString(this._dnsSecurityRuleName.ToString()) : null, "dnsSecurityRuleName" ,container.Add );
            AddIf( null != (((object)this._dnsResolverPolicyVirtualNetworkLinkName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString(this._dnsResolverPolicyVirtualNetworkLinkName.ToString()) : null, "dnsResolverPolicyVirtualNetworkLinkName" ,container.Add );
            AddIf( null != (((object)this._dnsResolverDomainListName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString(this._dnsResolverDomainListName.ToString()) : null, "dnsResolverDomainListName" ,container.Add );
