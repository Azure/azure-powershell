...
online version: https://learn.microsoft.com/powershell/module/az.orbital/remove-azorbitalspacecraftcontact
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzOrbitalSpacecraftContact -Name <String> -ResourceGroupName <String> -SpacecraftName <String>
