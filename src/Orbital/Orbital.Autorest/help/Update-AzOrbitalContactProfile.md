...
online version: https://learn.microsoft.com/powershell/module/az.orbital/update-azorbitalcontactprofile
schema: 2.0.0
---
...
```
Update-AzOrbitalContactProfile -InputObject <IOrbitalIdentity> [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
