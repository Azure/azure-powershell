...
namespace Microsoft.Azure.PowerShell.Cmdlets.Orbital.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Orbital.Support.Status Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Orbital.Support.Status Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Orbital.Support.Status Running = @"Running";

        public static Microsoft.Azure.PowerShell.Cmdlets.Orbital.Support.Status Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Orbital.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Orbital.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Orbital.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.Orbital.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
