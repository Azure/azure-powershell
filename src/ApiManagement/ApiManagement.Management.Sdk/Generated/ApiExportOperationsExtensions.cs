...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    public static partial class ApiExportOperationsExtensions
    {
        ...
        {
                return ((IApiExportOperations)operations).GetAsync(resourceGroupName, serviceName, apiId, format).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<ApiExportResult> GetAsync(this IApiExportOperations operations, string resourceGroupName, string serviceName, string apiId, string format, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
