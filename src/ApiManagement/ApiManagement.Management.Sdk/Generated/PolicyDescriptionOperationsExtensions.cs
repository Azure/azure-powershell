...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    public static partial class PolicyDescriptionOperationsExtensions
    {
        ...
        {
                return ((IPolicyDescriptionOperations)operations).ListByServiceAsync(resourceGroupName, serviceName, scope).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<PolicyDescriptionCollection> ListByServiceAsync(this IPolicyDescriptionOperations operations, string resourceGroupName, string serviceName, PolicyScopeContract? scope = default(PolicyScopeContract?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
