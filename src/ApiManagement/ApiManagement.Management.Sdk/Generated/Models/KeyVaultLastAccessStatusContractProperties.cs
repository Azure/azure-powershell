...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class KeyVaultLastAccessStatusContractProperties
    {
        ...
        /// <param name="code">Last status code for sync and refresh of secret from key vault.
        /// </param>

        /// <param name="message">Details of the error else empty.
        /// </param>

        /// <param name="timeStampUtc">Last time secret was accessed. The date conforms to the following format:
        ...
        /// <summary>
        /// Gets or sets last status code for sync and refresh of secret from key
        /// vault.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets last time secret was accessed. The date conforms to the
