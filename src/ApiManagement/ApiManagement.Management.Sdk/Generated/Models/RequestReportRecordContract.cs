...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class RequestReportRecordContract
    {
        ...
        /// <param name="method">The HTTP method associated with this request..
        /// </param>

        /// <param name="url">The full URL associated with this request.
        /// </param>

        /// <param name="ipAddress">The client IP address associated with this request.
        /// </param>

        /// <param name="backendResponseCode">The HTTP status code received by the gateway as a result of forwarding this
        /// request to the backend.
        /// </param>

        /// <param name="responseCode">The HTTP status code returned by the gateway.
        /// </param>

        /// <param name="responseSize">The size of the response returned by the gateway.
        /// </param>

        /// <param name="timestamp">The date and time when this request was received by the gateway in ISO 8601
        /// format.
        /// </param>

        /// <param name="cache">Specifies if response cache was involved in generating the response. If the
        /// value is none, the cache was not used. If the value is hit, cached response
        /// was returned. If the value is miss, the cache was used but lookup resulted
        /// in a miss and request was fulfilled by the backend.
        /// </param>

        /// <param name="apiTime">The total time it took to process this request.
        /// </param>

        /// <param name="serviceTime">he time it took to forward this request to the backend and get the response
        /// back.
        /// </param>

        /// <param name="apiRegion">Azure region where the gateway that processed this request is located.
        /// </param>
        ...
        /// <param name="requestSize">The size of this request..
        /// </param>
        ...
        /// <summary>
        /// Gets or sets the HTTP status code received by the gateway as a result of
        /// forwarding this request to the backend.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "backendResponseCode")]
        ...
        /// <summary>
        /// Gets or sets the date and time when this request was received by the
        ...
        /// <summary>
        /// Gets or sets specifies if response cache was involved in generating the
        /// response. If the value is none, the cache was not used. If the value is
        /// hit, cached response was returned. If the value is miss, the cache was used
        /// but lookup resulted in a miss and request was fulfilled by the backend.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets he time it took to forward this request to the backend and get
        /// the response back.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets azure region where the gateway that processed this request is
        /// located.
        /// </summary>
