...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class GroupCreateParameters
    {
        ...
        /// value is null.
        /// </param>
        public GroupCreateParameters(string displayName = default(string), string description = default(string), GroupType? type = default(GroupType?), string externalId = default(string))
