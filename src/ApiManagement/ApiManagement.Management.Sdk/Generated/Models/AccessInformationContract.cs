...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class AccessInformationContract : ProxyResource
    {
        ...
        /// <param name="propertiesId">Access Information type (&#39;access&#39; or &#39;gitAccess&#39;)
        /// </param>
        ...
        /// </param>
        public AccessInformationContract(string id = default(string), string name = default(string), string type = default(string), string propertiesId = default(string), string principalId = default(string), bool? enabled = default(bool?))
