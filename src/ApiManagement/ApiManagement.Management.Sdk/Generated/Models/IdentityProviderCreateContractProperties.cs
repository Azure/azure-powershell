...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    /// </summary>
    public partial class IdentityProviderCreateContractProperties : IdentityProviderBaseParameters
    {
        /// <summary>
        /// Initializes a new instance of the IdentityProviderCreateContractProperties class.
        /// </summary>
        ...
        /// get the value.
        /// </param>
        public IdentityProviderCreateContractProperties(string clientId, string clientSecret, string type = default(string), string signinTenant = default(string), System.Collections.Generic.IList<string> allowedTenants = default(System.Collections.Generic.IList<string>), string authority = default(string), string signupPolicyName = default(string), string signinPolicyName = default(string), string profileEditingPolicyName = default(string), string passwordResetPolicyName = default(string))
        ...
        public override void Validate()
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "ClientSecret");
            }
            if (this.ClientId != null)
            {
