...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class EmailTemplateUpdateParameters
    {
        ...
        /// </param>
        public EmailTemplateUpdateParameters(string subject = default(string), string title = default(string), string description = default(string), string body = default(string), System.Collections.Generic.IList<EmailTemplateParametersContractProperties> parameters = default(System.Collections.Generic.IList<EmailTemplateParametersContractProperties>))
