...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class OpenidConnectProviderUpdateContractProperties
    {
        ...
        /// </param>
        public OpenidConnectProviderUpdateContractProperties(string displayName = default(string), string description = default(string), string metadataEndpoint = default(string), string clientId = default(string), string clientSecret = default(string), bool? useInTestConsole = default(bool?), bool? useInApiDocumentation = default(bool?))
