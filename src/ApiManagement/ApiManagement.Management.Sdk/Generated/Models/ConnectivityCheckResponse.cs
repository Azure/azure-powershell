...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class ConnectivityCheckResponse
    {
        ...
        /// </param>
        public ConnectivityCheckResponse(System.Collections.Generic.IList<ConnectivityHop> hops = default(System.Collections.Generic.IList<ConnectivityHop>), string connectionStatus = default(string), long? avgLatencyInMS = default(long?), long? minLatencyInMS = default(long?), long? maxLatencyInMS = default(long?), long? probesSent = default(long?), long? probesFailed = default(long?))
