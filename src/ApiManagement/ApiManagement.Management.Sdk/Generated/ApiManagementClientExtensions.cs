...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    public static partial class ApiManagementClientExtensions
    {
        ...
        {
                return ((IApiManagementClient)operations).PerformConnectivityCheckAsyncAsync(resourceGroupName, serviceName, connectivityCheckRequestParams).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<ConnectivityCheckResponse> PerformConnectivityCheckAsyncAsync(this IApiManagementClient operations, string resourceGroupName, string serviceName, ConnectivityCheckRequest connectivityCheckRequestParams, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
                return ((IApiManagementClient)operations).BeginPerformConnectivityCheckAsyncAsync(resourceGroupName, serviceName, connectivityCheckRequestParams).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<ConnectivityCheckResponse> BeginPerformConnectivityCheckAsyncAsync(this IApiManagementClient operations, string resourceGroupName, string serviceName, ConnectivityCheckRequest connectivityCheckRequestParams, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
