...
namespace Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Commands
{
    ...
    [Cmdlet("Update", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "ApiManagementKeyVaultBasedObject", SupportsShouldProcess = true, DefaultParameterSetName = ContextParameterSet)]
    [OutputType(typeof(PsApiManagementKeyVaultEntity), ParameterSetName = new[] { ContextParameterSet, ResourceIdParameterSet })]
    public class UpdateAzureApiManagementKeyVaultBasedObject : AzureApiManagementCmdletBase
    {
