...
namespace Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Commands
{
    ...
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "ApiManagementGateway", SupportsShouldProcess = true)]
    ...
    public class RemoveAzureApiManagementGateway : AzureApiManagementCmdletBase
    {
        ...
        public override void ExecuteApiManagementCmdlet()
        {
            ...
            Client.GatewayRemove(Context, GatewayId);
