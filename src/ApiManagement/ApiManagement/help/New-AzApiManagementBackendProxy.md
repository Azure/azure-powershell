...
online version: https://learn.microsoft.com/powershell/module/az.apimanagement/new-azapimanagementbackendproxy
schema: 2.0.0
---
...
```powershell
$secpassword = ConvertTo-SecureString -String $passwordString -AsPlainText -Force
