...
Modifies an API Management Property. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
Set-AzApiManagementProperty -Context $apimContext -Name 'ContosoApi' -PropertyId 'Property11' -Secret $true -Value 'Property Value'
```
