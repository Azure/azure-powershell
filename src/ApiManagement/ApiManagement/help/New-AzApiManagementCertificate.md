...
### Example 2: Create an API Management certificate to be used during Authentication with Backend. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
New-AzApiManagementCertificate -CertificateId '0123456789' -Context $ApiMgmtContext -PfxFilePath 'C:\contoso\certificates\apimanagement.pfx' -PfxPassword '1111'
```
