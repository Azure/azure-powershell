...
### Example 2: Update a Backend. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
Set-AzApiManagementBackend -BackendId 123 -Context $apimContext -Credential $credential -Protocol http -ResourceId /subscriptions/subid/resourceGroups/Api-Default-West-US/providers/Microsoft.ApiManagement/service/contoso -Url 'https://contoso.com/awesomeapi'
```
