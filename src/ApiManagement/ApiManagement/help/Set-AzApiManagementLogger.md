...
### Example 2: Modify an API Management Logger. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
Set-AzApiManagementLogger -Confirm -Context $apimContext -InstrumentationKey <String> -LoggerId 'Logger123'
```
