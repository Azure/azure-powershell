#
# Module manifest for module 'Az.ManagedNetwork'
#
...
NestedModules = @('.\Microsoft.Azure.PowerShell.Cmdlets.ManagedNetwork.dll')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Create cmdlets for Az.ManagedNetwork.
