...
namespace Microsoft.Azure.Commands.ManagedNetwork
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Remove, "AzManagedNetworkGroup", DefaultParameterSetName = Constants.NameParameterSet)]
    [OutputType(typeof(PSManagedNetwork))]
    public class RemoveAzureManagedNetworkGroup : AzureManagedNetworkCmdletBase
    {
        /// <summary>
