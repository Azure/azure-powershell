...
param(
    ...
    [Parameter(HelpMessage="The source code path of the Jar or Zip according to the SourceType parameter.")]
    [Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Category('Path')]
    [System.String]
    ${SourceFilePath},

    [Parameter(HelpMessage="Type of the source uploaded.")]
    ...
    process {
        if ($PSBoundParameters.ContainsKey('SourceFilePath'))
        {
