...
.Outputs
.Link
https://docs.microsoft.com/powershell/module/az.SpringCloud/deploy-azSpringCloudAppSourceFile
#>
function Deploy-AzSpringCloudAppSourceFile {
...
param(
    ...
    process {
        ...
        Write-Host '[1/2] Requesting for upload URL' -ForegroundColor Yellow
        ...
        Write-Host '[2/2] Uploading package to blob' -ForegroundColor Yellow
        ...
        $uploadSource = New-Object PSObject
        Add-Member -InputObject $uploadSource -MemberType NoteProperty -Name RelativePath -Value $UploadInfo.RelativePath
        return $uploadSource
    }
}
