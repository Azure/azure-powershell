...
namespace Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Support.SkuScaleType Automatic = @"Automatic";

        public static Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Support.SkuScaleType Manual = @"Manual";

        public static Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Support.SkuScaleType None = @"None";
        ...
        {
            return new SkuScaleType(System.Convert.ToString(value));
        }

        /// <summary>Compares values of enum type SkuScaleType</summary>
        /// <param name="e">the value to compare against this instance.</param>
        /// <returns><c>true</c> if the two instances are equal to the same value</returns>
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Support.SkuScaleType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Support.SkuScaleType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Support.SkuScaleType e1, Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Support.SkuScaleType e2)
        {
            return !e2.Equals(e1);
        }
