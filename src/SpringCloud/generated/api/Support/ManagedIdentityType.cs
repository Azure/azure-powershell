...
namespace Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Support.ManagedIdentityType None = @"None";

        public static Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Support.ManagedIdentityType SystemAssigned = @"SystemAssigned";

        public static Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Support.ManagedIdentityType SystemAssignedUserAssigned = @"SystemAssigned,UserAssigned";

        public static Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Support.ManagedIdentityType UserAssigned = @"UserAssigned";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Support.ManagedIdentityType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Support.ManagedIdentityType e)
        {
            return e._value;
        }
