if(($null -eq $TestName) -or ($TestName -contains 'Update-AzSpringCloudAppActiveDeployment'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Update-AzSpringCloudAppActiveDeployment.Recording.json'
