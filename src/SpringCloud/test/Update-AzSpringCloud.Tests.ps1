if(($null -eq $TestName) -or ($TestName -contains 'Update-AzSpringCloud'))
{
...
Describe 'Update-AzSpringCloud' {
    It 'UpdateExpanded' {
        $spring = Update-AzSpringCloud -ResourceGroupName $env.resourceGroup -Name $env.standardSpringName01 -Tag @{"key01" = "value01"; "key02" = "value02"}
