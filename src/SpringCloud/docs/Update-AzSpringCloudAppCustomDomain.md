...
```
Update-AzSpringCloudAppCustomDomain -AppInputObject <ISpringCloudIdentity> -Name <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.ICustomDomainResource
