...
online version: https://learn.microsoft.com/powershell/module/az.springcloud/remove-azspringcloudcertificate
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzSpringCloudCertificate -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzSpringCloudCertificate -InputObject <ISpringCloudIdentity> [-DefaultProfile <PSObject>] [-AsJob]
