...
online version: https://docs.microsoft.com/powershell/module/az.springcloud/get-azspringcloudregistry
schema: 2.0.0
---
...
### Get
```
Get-AzSpringCloudRegistry -Name <String> -ResourceGroupName <String> -ServiceName <String>
