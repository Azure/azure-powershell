...
```
New-AzSpringCloudBuildServiceAgentPool -SpringInputObject <ISpringCloudIdentity>
 -AgentPoolResource <IBuildServiceAgentPoolResource> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.IBuildServiceAgentPoolResource
