...
online version: https://docs.microsoft.com/powershell/module/az.SpringCloud/deploy-azSpringCloudAppSourceFile
schema: 2.0.0
---
...
```
Deploy-AzSpringCloudAppSourceFile -FilePath <String> -Name <String> -ResourceGroupName <String>
