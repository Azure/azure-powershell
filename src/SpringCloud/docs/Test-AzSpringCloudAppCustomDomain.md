...
```
Test-AzSpringCloudAppCustomDomain -AppName <String> -SpringInputObject <ISpringCloudIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.ICustomDomainValidatePayload
...
### Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.ICustomDomainValidatePayload
