...
online version: https://docs.microsoft.com/powershell/module/az.springcloud/new-azspringcloudappdeploymentthreaddump
schema: 2.0.0
---

# New-AzSpringCloudAppDeploymentThreadDump
...
```
New-AzSpringCloudAppDeploymentThreadDump -AppName <String> -Name <String> -ResourceGroupName <String>
