...
```
Update-AzSpringCloudApp -Name <String> -SpringInputObject <ISpringCloudIdentity> -AppResource <IAppResource>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.IAppResource
