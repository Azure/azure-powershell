...
Update-AzSpringCloudAppActiveDeployment -Name <String> -SpringInputObject <ISpringCloudIdentity>
 [-DeploymentName <String[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: System.String[]
Parameter Sets: SetExpanded, SetViaIdentitySpringExpanded, SetViaIdentityExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: SetExpanded, SetViaJsonString, SetViaJsonFilePath, SetViaIdentitySpringExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: SetExpanded, SetViaJsonString, SetViaJsonFilePath
Aliases:
