...
```
New-AzSpringCloudConfigurationService -SpringInputObject <ISpringCloudIdentity>
...
----    ------------------- -------------------     ----------------------- ------------------------ ------------------
default 2022/7/13 3:26:33   tester@microsoft.com    User                    2022/7/13 7:46:06        tester@microsoft.com
```
