...
### UpdateViaJsonString
```
Update-AzSpringCloud -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] -JsonString <String>
...
```
Update-AzSpringCloud -InputObject <ISpringCloudIdentity> [-Location <String>] [-SkuCapacity <Int32>]
