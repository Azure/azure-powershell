...
namespace Microsoft.Azure.PowerShell.Ssh.Helpers.Network.Models
{
    ...
    public partial class ApplicationGatewayBackendAddressPool : SubResource
    {
        ...
        /// <param name="name">Name of the backend address pool that is unique within an Application
        /// Gateway.
        /// </param>
        ...
        /// </param>
        public ApplicationGatewayBackendAddressPool(string id = default(string), string name = default(string), string etag = default(string), string type = default(string), string provisioningState = default(string), System.Collections.Generic.IList<NetworkInterfaceIPConfiguration> backendIPConfigurations = default(System.Collections.Generic.IList<NetworkInterfaceIPConfiguration>), System.Collections.Generic.IList<ApplicationGatewayBackendAddress> backendAddresses = default(System.Collections.Generic.IList<ApplicationGatewayBackendAddress>))
        ...
        /// <summary>
        /// Gets or sets name of the backend address pool that is unique within an
        /// Application Gateway.
        /// </summary>
