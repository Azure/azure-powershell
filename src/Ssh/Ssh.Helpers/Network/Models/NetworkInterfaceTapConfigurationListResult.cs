...
namespace Microsoft.Azure.PowerShell.Ssh.Helpers.Network.Models
{
    ...
    public partial class NetworkInterfaceTapConfigurationListResult
    {
        ...
        /// NetworkInterfaceTapConfigurationListResult class.
        /// </summary>
        ...
        /// results.</param>
        public NetworkInterfaceTapConfigurationListResult(IList<NetworkInterfaceTapConfiguration> value = default(IList<NetworkInterfaceTapConfiguration>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
