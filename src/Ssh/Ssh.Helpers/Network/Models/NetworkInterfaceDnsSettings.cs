...
namespace Microsoft.Azure.PowerShell.Ssh.Helpers.Network.Models
{
    ...
    public partial class NetworkInterfaceDnsSettings
    {
        ...
        /// <param name="dnsServers">List of DNS servers IP addresses. Use &#39;AzureProvidedDNS&#39; to switch to azure
        /// provided DNS resolution. &#39;AzureProvidedDNS&#39; value cannot be combined with
        /// other IPs, it must be the only value in dnsServers collection.
        /// </param>

        /// <param name="appliedDnsServers">If the VM that uses this NIC is part of an Availability Set, then this list
        /// will have the union of all DNS servers from all NICs that are part of the
        /// Availability Set. This property is what is configured on each of those VMs.
        /// </param>

        /// <param name="internalDnsNameLabel">Relative DNS name for this NIC used for internal communications between VMs
        /// in the same virtual network.
        /// </param>

        /// <param name="internalFqdn">Fully qualified DNS name supporting internal communications between VMs in
        /// the same virtual network.
        /// </param>

        /// <param name="internalDomainNameSuffix">Even if internalDnsNameLabel is not specified, a DNS entry is created for
        ...
        /// <summary>
        /// Gets or sets list of DNS servers IP addresses. Use &#39;AzureProvidedDNS&#39; to
        /// switch to azure provided DNS resolution. &#39;AzureProvidedDNS&#39; value cannot be
        ...
        /// <summary>
        /// Gets if the VM that uses this NIC is part of an Availability Set, then this
        /// list will have the union of all DNS servers from all NICs that are part of
        /// the Availability Set. This property is what is configured on each of those
        /// VMs.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "appliedDnsServers")]
        public System.Collections.Generic.IList<string> AppliedDnsServers {get; private set; }
        ...
        /// <summary>
        /// Gets fully qualified DNS name supporting internal communications between
        ...
        /// <summary>
        /// Gets even if internalDnsNameLabel is not specified, a DNS entry is created
