...
namespace Microsoft.Azure.PowerShell.Ssh.Helpers.Network.Models
{
    ...
    public partial class NetworkInterfaceListResult
    {
        ...
        /// Initializes a new instance of the NetworkInterfaceListResult class.
        /// </summary>
        /// <param name="value">A list of network interfaces in a resource
        /// group.</param>
        /// <param name="nextLink">The URL to get the next set of
        /// results.</param>
        public NetworkInterfaceListResult(IList<NetworkInterface> value = default(IList<NetworkInterface>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
