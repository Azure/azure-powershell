...
namespace Microsoft.Azure.PowerShell.Ssh.Helpers.HybridCompute
{
    ...
    /// </summary>
    internal partial class MachinesOperations : IServiceOperations<HybridComputeManagementClient>, IMachinesOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<Machine>> GetWithHttpMessagesAsync(string resourceGroupName, string machineName, string expand = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<Machine>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Machine>(_responseContent, Client.DeserializationSettings);
                }
