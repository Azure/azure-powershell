...
namespace Microsoft.Azure.PowerShell.Ssh.Helpers.HybridCompute.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the OSProfileWindowsConfiguration class.
        /// </summary>
        ...
        public OSProfileWindowsConfiguration(string assessmentMode = default(string), string patchMode = default(string))
