...
namespace Microsoft.Azure.PowerShell.Ssh.Helpers.HybridCompute.Models
{
    ...
    public partial class OSProfile
    {
        ...
        /// <param name="computerName">Specifies the host OS name of the hybrid machine.
        /// </param>

        /// <param name="windowsConfiguration">Specifies the windows configuration for update management.
        /// </param>

        /// <param name="linuxConfiguration">Specifies the linux configuration for update management.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets specifies the windows configuration for update management.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets specifies the linux configuration for update management.
        /// </summary>
