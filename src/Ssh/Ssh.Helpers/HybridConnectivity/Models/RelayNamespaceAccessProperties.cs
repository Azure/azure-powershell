...
namespace Microsoft.Azure.PowerShell.Ssh.Helpers.HybridConnectivity.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the RelayNamespaceAccessProperties class.
        /// </summary>
        ...
        /// </param>
        public RelayNamespaceAccessProperties(string namespaceName, string namespaceNameSuffix, string hybridConnectionName, string accessKey = default(string), long? expiresOn = default(long?), string serviceConfigurationToken = default(string))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "namespaceNameSuffix")]
        public string NamespaceNameSuffix {get; set; }

        /// <summary>
        /// Gets or sets azure Relay hybrid connection name for the resource.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "hybridConnectionName")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "serviceConfigurationToken")]
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "NamespaceNameSuffix");
            }
            if (this.HybridConnectionName == null)
            {
