...
namespace Microsoft.Azure.PowerShell.Ssh.Helpers.Compute.Models
{
    ...
    public partial class SshPublicKey
    {
        ...
        /// <param name="path">Specifies the full path on the created VM where ssh public key is stored.
        /// If the file already exists, the specified key is appended to the file.
        /// Example: /home/user/.ssh/authorized_keys
        /// </param>

        /// <param name="keyData">SSH public key certificate used to authenticate with the VM through ssh.
        /// The key needs to be at least 2048-bit and in ssh-rsa format. &lt;br&gt;&lt;br&gt; For
        ...
        /// <summary>
        /// Gets or sets specifies the full path on the created VM where ssh public key
        /// is stored. If the file already exists, the specified key is appended to the
        ...
        /// <summary>
        /// Gets or sets sSH public key certificate used to authenticate with the VM
        /// through ssh. The key needs to be at least 2048-bit and in ssh-rsa format.
        /// &lt;br&gt;&lt;br&gt; For creating ssh keys, see [Create SSH keys on Linux and Mac for
        /// Linux VMs in
        /// Azure]https://docs.microsoft.com/azure/virtual-machines/linux/create-ssh-keys-detailed).
        /// </summary>
