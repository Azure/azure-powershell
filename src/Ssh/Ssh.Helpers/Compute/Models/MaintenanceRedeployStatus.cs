...
namespace Microsoft.Azure.PowerShell.Ssh.Helpers.Compute.Models
{
    ...
    public partial class MaintenanceRedeployStatus
    {
        ...
        /// <param name="isCustomerInitiatedMaintenanceAllowed">True, if customer is allowed to perform Maintenance.
        /// </param>

        /// <param name="preMaintenanceWindowStartTime">Start Time for the Pre Maintenance Window.
        /// </param>

        /// <param name="preMaintenanceWindowEndTime">End Time for the Pre Maintenance Window.
        /// </param>

        /// <param name="maintenanceWindowStartTime">Start Time for the Maintenance Window.
        /// </param>

        /// <param name="maintenanceWindowEndTime">End Time for the Maintenance Window.
        /// </param>

        /// <param name="lastOperationResultCode">The Last Maintenance Operation Result Code.
        /// Possible values include: &#39;None&#39;, &#39;RetryLater&#39;, &#39;MaintenanceAborted&#39;,
        /// &#39;MaintenanceCompleted&#39;</param>

        /// <param name="lastOperationMessage">Message returned for the last Maintenance Operation.
        /// </param>
