...
namespace Microsoft.Azure.PowerShell.Ssh.Helpers.Compute.Models
{
    ...
    public partial class BootDiagnosticsInstanceView
    {
        ...
        /// <param name="consoleScreenshotBlobUri">The console screenshot blob URI. &lt;br&gt;&lt;br&gt;NOTE: This will **not** be set if
        /// boot diagnostics is currently enabled with managed storage.
        /// </param>

        /// <param name="serialConsoleLogBlobUri">The serial console log blob Uri. &lt;br&gt;&lt;br&gt;NOTE: This will **not** be set if
        /// boot diagnostics is currently enabled with managed storage.
        /// </param>

        /// <param name="status">The boot diagnostics status information for the VM. &lt;br&gt;&lt;br&gt; NOTE: It will
        ...
        /// <summary>
        /// Gets the console screenshot blob URI. &lt;br&gt;&lt;br&gt;NOTE: This will **not** be
        ...
        /// <summary>
        /// Gets the serial console log blob Uri. &lt;br&gt;&lt;br&gt;NOTE: This will **not** be
        /// set if boot diagnostics is currently enabled with managed storage.
        /// </summary>
        ...
        /// <summary>
        /// Gets the boot diagnostics status information for the VM. &lt;br&gt;&lt;br&gt; NOTE: It
