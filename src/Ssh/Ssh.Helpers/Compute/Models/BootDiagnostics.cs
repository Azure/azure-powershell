...
namespace Microsoft.Azure.PowerShell.Ssh.Helpers.Compute.Models
{
    ...
    public partial class BootDiagnostics
    {
        ...
        /// <param name="enabled">Whether boot diagnostics should be enabled on the Virtual Machine.
        /// </param>

        /// <param name="storageUri">Uri of the storage account to use for placing the console output and
        ...
        /// <summary>
        /// Gets or sets uri of the storage account to use for placing the console
        /// output and screenshot. &lt;br&gt;&lt;br&gt;If storageUri is not specified while
