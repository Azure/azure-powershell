if(($null -eq $TestName) -or ($TestName -contains 'Enable-AzSpringDeploymentRemoteDebugging'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Enable-AzSpringDeploymentRemoteDebugging.Recording.json'
...
Describe 'Enable-AzSpringDeploymentRemoteDebugging' {
