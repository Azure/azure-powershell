if(($null -eq $TestName) -or ($TestName -contains 'Test-AzSpringAppsConfigurationService'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Test-AzSpringAppsConfigurationService.Recording.json'
...
Describe 'Test-AzSpringAppsConfigurationService' {
