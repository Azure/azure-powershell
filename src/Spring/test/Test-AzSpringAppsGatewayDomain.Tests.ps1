if(($null -eq $TestName) -or ($TestName -contains 'Test-AzSpringAppsGatewayDomain'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Test-AzSpringAppsGatewayDomain.Recording.json'
...
Describe 'Test-AzSpringAppsGatewayDomain' {
