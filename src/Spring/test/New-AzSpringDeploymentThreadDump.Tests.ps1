if(($null -eq $TestName) -or ($TestName -contains 'New-AzSpringDeploymentThreadDump'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-AzSpringDeploymentThreadDump.Recording.json'
...
Describe 'New-AzSpringDeploymentThreadDump' {
