if(($null -eq $TestName) -or ($TestName -contains 'Test-AzSpringAppDomain'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Test-AzSpringAppDomain.Recording.json'
...
Describe 'Test-AzSpringAppDomain' {
