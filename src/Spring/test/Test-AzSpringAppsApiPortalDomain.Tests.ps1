if(($null -eq $TestName) -or ($TestName -contains 'Test-AzSpringAppsApiPortalDomain'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Test-AzSpringAppsApiPortalDomain.Recording.json'
...
Describe 'Test-AzSpringAppsApiPortalDomain' {
