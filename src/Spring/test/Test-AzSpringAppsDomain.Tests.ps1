if(($null -eq $TestName) -or ($TestName -contains 'Test-AzSpringAppsDomain'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Test-AzSpringAppsDomain.Recording.json'
...
Describe 'Test-AzSpringAppsDomain' {
