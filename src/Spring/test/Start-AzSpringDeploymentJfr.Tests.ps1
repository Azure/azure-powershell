if(($null -eq $TestName) -or ($TestName -contains 'Start-AzSpringDeploymentJfr'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Start-AzSpringDeploymentJfr.Recording.json'
...
Describe 'Start-AzSpringDeploymentJfr' {
