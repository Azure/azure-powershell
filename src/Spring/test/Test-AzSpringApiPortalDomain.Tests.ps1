if(($null -eq $TestName) -or ($TestName -contains 'Test-AzSpringApiPortalDomain'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Test-AzSpringApiPortalDomain.Recording.json'
...
Describe 'Test-AzSpringApiPortalDomain' {
