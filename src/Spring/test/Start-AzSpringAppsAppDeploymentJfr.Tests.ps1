if(($null -eq $TestName) -or ($TestName -contains 'Start-AzSpringAppsAppDeploymentJfr'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Start-AzSpringAppsAppDeploymentJfr.Recording.json'
...
Describe 'Start-AzSpringAppsAppDeploymentJfr' {
