if(($null -eq $TestName) -or ($TestName -contains 'Test-AzSpringGatewayDomain'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Test-AzSpringGatewayDomain.Recording.json'
...
Describe 'Test-AzSpringGatewayDomain' {
