if(($null -eq $TestName) -or ($TestName -contains 'Test-AzSpringContainerRegistry'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Test-AzSpringContainerRegistry.Recording.json'
...
Describe 'Test-AzSpringContainerRegistry' {
