...
online version: https://learn.microsoft.com/powershell/module/az.springapps/update-azspringcustomizedaccelerator
schema: 2.0.0
---

# Update-AzSpringCustomizedAccelerator
...
```
Update-AzSpringCustomizedAccelerator -ApplicationAcceleratorName <String> -Name <String>
...
### UpdateViaIdentityApplicationAcceleratorExpanded
```
Update-AzSpringCustomizedAccelerator -ApplicationAcceleratorInputObject <ISpringAppsIdentity> -Name <String>
...
```
Update-AzSpringCustomizedAccelerator -InputObject <ISpringAppsIdentity> [-AcceleratorTag <String[]>]
 [-AcceleratorType <String>] [-Description <String>] [-DisplayName <String>] [-GitRepositoryBranch <String>]
 [-GitRepositoryCommit <String>] [-GitRepositoryGitTag <String>] [-GitRepositoryIntervalInSecond <Int32>]
 [-GitRepositorySubPath <String>] [-GitRepositoryUrl <String>] [-IconUrl <String>] [-SkuCapacity <Int32>]
 [-SkuName <String>] [-SkuTier <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
...
Parameter Sets: UpdateViaIdentityApplicationAcceleratorExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityApplicationAcceleratorExpanded, UpdateViaIdentitySpringExpanded
