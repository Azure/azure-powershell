...
online version: https://learn.microsoft.com/powershell/module/az.springapps/get-azspringappcustomdomain
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzSpringAppCustomDomain -InputObject <ISpringAppsIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentityApp
```
Get-AzSpringAppCustomDomain -AppInputObject <ISpringAppsIdentity> -Name <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentitySpring
```
Get-AzSpringAppCustomDomain -AppName <String> -Name <String> -SpringInputObject <ISpringAppsIdentity>
