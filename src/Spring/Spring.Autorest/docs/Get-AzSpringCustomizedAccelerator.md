...
online version: https://learn.microsoft.com/powershell/module/az.springapps/get-azspringcustomizedaccelerator
schema: 2.0.0
---

# Get-AzSpringCustomizedAccelerator
...
### List (Default)
```
Get-AzSpringCustomizedAccelerator -ApplicationAcceleratorName <String> -ResourceGroupName <String>
 -ServiceName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzSpringCustomizedAccelerator -ApplicationAcceleratorName <String> -Name <String>
...
### GetViaIdentity
```
Get-AzSpringCustomizedAccelerator -InputObject <ISpringAppsIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentityApplicationAccelerator
```
Get-AzSpringCustomizedAccelerator -ApplicationAcceleratorInputObject <ISpringAppsIdentity> -Name <String>
