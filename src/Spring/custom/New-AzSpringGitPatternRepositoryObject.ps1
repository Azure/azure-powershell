...
.Link
https://learn.microsoft.com/powershell/module/Az.Spring/new-azspringgitpatternrepositoryobject
#>
function New-AzSpringGitPatternRepositoryObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Spring.Models.GitPatternRepository')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Spring.Models.GitPatternRepository]::New()
