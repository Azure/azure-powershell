...
.Link
https://learn.microsoft.com/powershell/module/Az.Spring/new-azspringconfigurationservicegitrepositoryobject
#>
function New-AzSpringConfigurationServiceGitRepositoryObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Spring.Models.ConfigurationServiceGitRepository')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Spring.Models.ConfigurationServiceGitRepository]::New()
