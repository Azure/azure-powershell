...
online version: https://learn.microsoft.com/powershell/module/az.spring/restart-azspringappdeployment
schema: 2.0.0
---
...
### RestartViaIdentity
```
Restart-AzSpringAppDeployment -InputObject <ISpringIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestartViaIdentityApp
```
Restart-AzSpringAppDeployment -AppInputObject <ISpringIdentity> -Name <String> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestartViaIdentitySpring
```
Restart-AzSpringAppDeployment -AppName <String> -Name <String> -SpringInputObject <ISpringIdentity>
