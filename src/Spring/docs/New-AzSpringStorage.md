...
online version: https://learn.microsoft.com/powershell/module/az.spring/new-azspringstorage
schema: 2.0.0
---
...
```
New-AzSpringStorage -Name <String> -SpringInputObject <ISpringIdentity> [-DefaultProfile <PSObject>] [-AsJob]
