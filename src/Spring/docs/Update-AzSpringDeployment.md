...
online version: https://learn.microsoft.com/powershell/module/az.springapps/update-azspringdeployment
schema: 2.0.0
---

# Update-AzSpringDeployment
...
```
Update-AzSpringDeployment -AppName <String> -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
```
Update-AzSpringDeployment -AppInputObject <ISpringAppsIdentity> -Name <String> [-Active]
...
```
Update-AzSpringDeployment -InputObject <ISpringAppsIdentity> [-Active]
 [-DeploymentSetting <IDeploymentSettings>] [-SkuCapacity <Int32>] [-SkuName <String>] [-SkuTier <String>]
 [-Source <IUserSourceInfo>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-AzSpringDeployment -AppName <String> -Name <String> -SpringInputObject <ISpringAppsIdentity> [-Active]
 [-DeploymentSetting <IDeploymentSettings>] [-SkuCapacity <Int32>] [-SkuName <String>] [-SkuTier <String>]
 [-Source <IUserSourceInfo>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
