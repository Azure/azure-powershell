...
online version: https://learn.microsoft.com/powershell/module/az.springapps/new-azspringappbinding
schema: 2.0.0
---
...
```
New-AzSpringAppBinding -AppInputObject <ISpringAppsIdentity> -Name <String> [-BindingParameter <Hashtable>]
...
```
New-AzSpringAppBinding -InputObject <ISpringAppsIdentity> [-BindingParameter <Hashtable>] [-Key <String>]
...
```
New-AzSpringAppBinding -AppName <String> -Name <String> -SpringInputObject <ISpringAppsIdentity>
