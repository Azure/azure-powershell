...
# Remove-AzSpringApiPortalCustomDomain
...
### Delete (Default)
```
Remove-AzSpringApiPortalCustomDomain -ApiPortalName <String> -DomainName <String> -ResourceGroupName <String>
...
```yaml
Type: System.String
Parameter Sets: Delete, DeleteViaIdentityApiPortal, DeleteViaIdentitySpring
Aliases:
