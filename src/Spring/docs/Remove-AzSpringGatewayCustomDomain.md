...
online version: https://learn.microsoft.com/powershell/module/az.springapps/remove-azspringgatewaycustomdomain
schema: 2.0.0
---

# Remove-AzSpringGatewayCustomDomain
...
### Delete (Default)
```
Remove-AzSpringGatewayCustomDomain -DomainName <String> -GatewayName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzSpringGatewayCustomDomain -InputObject <ISpringAppsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentityGateway
```
Remove-AzSpringGatewayCustomDomain -DomainName <String> -GatewayInputObject <ISpringAppsIdentity>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentitySpring
```
Remove-AzSpringGatewayCustomDomain -DomainName <String> -GatewayName <String>
