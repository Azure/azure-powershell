...
online version: https://learn.microsoft.com/powershell/module/az.springapps/start-azspringdeploymentjfr
schema: 2.0.0
---

# Start-AzSpringDeploymentJfr
...
```
Start-AzSpringDeploymentJfr -AppName <String> -DeploymentName <String> -ResourceGroupName <String>
...
### StartViaIdentity
```
Start-AzSpringDeploymentJfr -InputObject <ISpringAppsIdentity> -DiagnosticParameter <IDiagnosticParameters>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaIdentityApp
```
Start-AzSpringDeploymentJfr -AppInputObject <ISpringAppsIdentity> -DeploymentName <String>
...
```
Start-AzSpringDeploymentJfr -InputObject <ISpringAppsIdentity> [-AppInstance <String>] [-Duration <String>]
 [-FilePath <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Start-AzSpringDeploymentJfr -AppName <String> -DeploymentName <String>
 -SpringInputObject <ISpringAppsIdentity> -DiagnosticParameter <IDiagnosticParameters>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Start-AzSpringDeploymentJfr -AppName <String> -DeploymentName <String>
 -SpringInputObject <ISpringAppsIdentity> [-AppInstance <String>] [-Duration <String>] [-FilePath <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
