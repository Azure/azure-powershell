...
online version: https://learn.microsoft.com/powershell/module/az.springapps/test-azspringcustomdomainnameavailability
schema: 2.0.0
---

# Test-AzSpringCustomDomainNameAvailability
...
```
Test-AzSpringCustomDomainNameAvailability -AppName <String> -ResourceGroupName <String> -ServiceName <String>
...
### ValidateViaIdentity
```
Test-AzSpringCustomDomainNameAvailability -InputObject <ISpringAppsIdentity>
...
```
Test-AzSpringCustomDomainNameAvailability -InputObject <ISpringAppsIdentity> -Name <String>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ValidateViaIdentitySpring
```
Test-AzSpringCustomDomainNameAvailability -AppName <String> -SpringInputObject <ISpringAppsIdentity>
 -ValidatePayload <ICustomDomainValidatePayload> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
