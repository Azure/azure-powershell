...
```
Test-AzSpringConfigServer -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Spring.Models.Api20220401.IGitPatternRepository[]
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.Spring.Models.Api20220401.IConfigServerSettingsValidateResult
