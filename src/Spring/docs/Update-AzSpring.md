...
```
Update-AzSpring -InputObject <ISpringIdentity> [-Location <String>] [-NetworkProfileResourceGroup <String>]
 ...
 [-SkuName <String>] [-SkuTier <String>] [-Tag <Hashtable>] [-ZoneRedundant] [-DefaultProfile <PSObject>]
