...
online version: https://learn.microsoft.com/powershell/module/az.springapps/update-azspringappcustomdomain
schema: 2.0.0
---

# Update-AzSpringAppCustomDomain
...
```
Update-AzSpringAppCustomDomain -AppName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzSpringAppCustomDomain -AppInputObject <ISpringAppsIdentity> -Name <String> [-CertName <String>]
...
```
Update-AzSpringAppCustomDomain -InputObject <ISpringAppsIdentity> [-CertName <String>] [-Thumbprint <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentitySpringExpanded
```
Update-AzSpringAppCustomDomain -AppName <String> -Name <String> -SpringInputObject <ISpringAppsIdentity>
