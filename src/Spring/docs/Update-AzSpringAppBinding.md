...
online version: https://learn.microsoft.com/powershell/module/az.springapps/update-azspringappbinding
schema: 2.0.0
---
...
```
Update-AzSpringAppBinding -AppInputObject <ISpringAppsIdentity> -Name <String> [-BindingParameter <Hashtable>]
...
```
Update-AzSpringAppBinding -InputObject <ISpringAppsIdentity> [-BindingParameter <Hashtable>] [-Key <String>]
...
```
Update-AzSpringAppBinding -AppName <String> -Name <String> -SpringInputObject <ISpringAppsIdentity>
...
### Microsoft.Azure.PowerShell.Cmdlets.SpringApps.Models.IBindingResource
