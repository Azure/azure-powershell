...
online version: https://learn.microsoft.com/powershell/module/az.springapps/update-azspringcustomdomain
schema: 2.0.0
---

# Update-AzSpringCustomDomain
...
```
Update-AzSpringCustomDomain -AppName <String> -DomainName <String> -ResourceGroupName <String>
...
```
Update-AzSpringCustomDomain -AppInputObject <ISpringAppsIdentity> -DomainName <String> [-CertName <String>]
...
```
Update-AzSpringCustomDomain -InputObject <ISpringAppsIdentity> [-CertName <String>] [-Thumbprint <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentitySpringExpanded
```
Update-AzSpringCustomDomain -AppName <String> -DomainName <String> -SpringInputObject <ISpringAppsIdentity>
