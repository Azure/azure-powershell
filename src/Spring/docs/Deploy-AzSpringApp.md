...
online version: https://learn.microsoft.com/powershell/module/az.Spring/deploy-azSpringapp
schema: 2.0.0
---
...
```
Deploy-AzSpringApp -FilePath <String> -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
```
Deploy-AzSpringApp -AgentPoolId <String> -BuilderId <String> -FilePath <String> -Name <String>
