...
online version: https://learn.microsoft.com/powershell/module/az.springapps/new-azspringregistry
schema: 2.0.0
---
...
```
New-AzSpringRegistry -Name <String> -ResourceGroupName <String> -ServiceName <String>
