...
# Update-AzSpringMonitoringSetting
...
```
Update-AzSpringMonitoringSetting -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzSpringMonitoringSetting -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### UpdateViaJsonString
```
Update-AzSpringMonitoringSetting -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
