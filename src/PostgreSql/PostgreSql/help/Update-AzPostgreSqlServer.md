...
Update-AzPostgreSqlServer -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-SkuFamily <String>] [-Sku <String>] [-SkuTier <String>] [-SslEnforcement <String>]
 [-MinimalTlsVersion <String>] [-BackupRetentionDay <Int32>] [-StorageAutogrow <String>] [-StorageInMb <Int32>]
 [-Tag <Hashtable>] [-PublicNetworkAccess <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
Update-AzPostgreSqlServer -InputObject <IPostgreSqlIdentity> [-AdministratorLoginPassword <SecureString>]
 [-ReplicationRole <String>] [-SkuCapacity <Int32>] [-SkuFamily <String>] [-Sku <String>] [-SkuTier <String>]
 [-SslEnforcement <String>] [-MinimalTlsVersion <String>] [-BackupRetentionDay <Int32>]
 [-StorageAutogrow <String>] [-StorageInMb <Int32>] [-Tag <Hashtable>] [-PublicNetworkAccess <String>]
