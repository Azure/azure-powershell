...
NestedModules = @('PostgreSql.Autorest/Az.PostgreSql.psm1')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '- Aligned with SimplySql, use a PSCredential object instead of UserName/Password parameters when calling Open-PostGreConnection
