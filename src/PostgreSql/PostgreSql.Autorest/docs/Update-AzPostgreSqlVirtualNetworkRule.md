...
```
Update-AzPostgreSqlVirtualNetworkRule -InputObject <IPostgreSqlIdentity> [-IgnoreMissingVnetServiceEndpoint]
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateExpanded1, UpdateViaIdentityServerExpanded, UpdateViaIdentityServerExpanded1
