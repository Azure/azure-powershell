  ...
  - where:
    ...
    set:
      breaking-change:
        ...
        change-description: This module will be retired and replaced with a new one called Az.PostgreSqlFlexibleServer. For more information, see details on https://azure.microsoft.com/en-us/updates?id=<TO-DO>.
