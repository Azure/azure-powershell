...
function New-AzPostgreSqlFlexibleServer {
    [OutputType([Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20220120Preview.IServerAutoGenerated])]
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Category('Body')]
        [Validateset('ZoneRedundant', 'SameZone', 'Enabled', 'Disabled')]
        [System.String]
        ${HaEnabled},
    ...
    process {
        try {
            ...
            if ($PSBoundParameters.ContainsKey('HaEnabled')){
                if ($PSBoundParameters["HaEnabled"].ToLower() -eq "enabled") {
                    $PSBoundParameters["HaEnabled"] = "ZoneRedundant"
                }
                if ($PSBoundParameters["HaEnabled"].ToLower() -eq "disabled"){
                ...
                elseif ($PSBoundParameters["HaEnabled"].ToLower() -eq "zoneredundant") {
                ...
                elseif ($PSBoundParameters["HaEnabled"].ToLower() -eq "samezone") {
                    $PSBoundParameters.HighAvailabilityMode = [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.HighAvailabilityMode]::SameZone
                }
            ...
            if (![string]::IsNullOrEmpty($RuleName)) {
                ...
                $Server | Add-Member -MemberType NoteProperty -Name FirewallRuleName -Value $FirewallRuleName
            }
            $Server | Add-Member -MemberType NoteProperty -Name SecuredPassword -Value $PSBoundParameters.AdministratorLoginPassword
