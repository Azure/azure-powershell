...
online version: https://docs.microsoft.com/en-us/powershell/module/az.postgresql/new-azpostgresqlserverreplica
schema: 2.0.0
---

# New-AzPostgreSqlServerReplica
...
```
New-AzPostgreSqlServerReplica -Name <String> -ResourceGroupName <String> -InputObject <IServer>
