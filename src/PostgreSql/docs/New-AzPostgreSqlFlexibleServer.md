...
Create Postgres server with default values.
The default values of location is East US, Sku is Standard_D2s_v3, Sku tier is general purpose, and storage size is 128GiB.
