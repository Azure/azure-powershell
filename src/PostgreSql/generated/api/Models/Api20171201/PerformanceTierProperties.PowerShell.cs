namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20171201
{
    ...
    public partial class PerformanceTierProperties
    {
        ...
        internal PerformanceTierProperties(global::System.Collections.IDictionary content)
        {
            ...
            ((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20171201.IPerformanceTierPropertiesInternal)this).MaxBackupRetentionDay = (int?) content.GetValueForProperty("MaxBackupRetentionDay",((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20171201.IPerformanceTierPropertiesInternal)this).MaxBackupRetentionDay, (__y)=> (int) global::System.Convert.ChangeType(__y, typeof(int)));
            ((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20171201.IPerformanceTierPropertiesInternal)this).MinBackupRetentionDay = (int?) content.GetValueForProperty("MinBackupRetentionDay",((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20171201.IPerformanceTierPropertiesInternal)this).MinBackupRetentionDay, (__y)=> (int) global::System.Convert.ChangeType(__y, typeof(int)));
            ((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20171201.IPerformanceTierPropertiesInternal)this).MaxStorageMb = (int?) content.GetValueForProperty("MaxStorageMb",((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20171201.IPerformanceTierPropertiesInternal)this).MaxStorageMb, (__y)=> (int) global::System.Convert.ChangeType(__y, typeof(int)));
            ((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20171201.IPerformanceTierPropertiesInternal)this).MinLargeStorageMb = (int?) content.GetValueForProperty("MinLargeStorageMb",((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20171201.IPerformanceTierPropertiesInternal)this).MinLargeStorageMb, (__y)=> (int) global::System.Convert.ChangeType(__y, typeof(int)));
            ((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20171201.IPerformanceTierPropertiesInternal)this).MaxLargeStorageMb = (int?) content.GetValueForProperty("MaxLargeStorageMb",((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20171201.IPerformanceTierPropertiesInternal)this).MaxLargeStorageMb, (__y)=> (int) global::System.Convert.ChangeType(__y, typeof(int)));
            ((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20171201.IPerformanceTierPropertiesInternal)this).MinStorageMb = (int?) content.GetValueForProperty("MinStorageMb",((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20171201.IPerformanceTierPropertiesInternal)this).MinStorageMb, (__y)=> (int) global::System.Convert.ChangeType(__y, typeof(int)));
