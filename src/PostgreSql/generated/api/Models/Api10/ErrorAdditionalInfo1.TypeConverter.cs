namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api10
{
    ...
    public partial class ErrorAdditionalInfo1TypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="ErrorAdditionalInfo1" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api10.IErrorAdditionalInfo1 ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api10.IErrorAdditionalInfo1).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
