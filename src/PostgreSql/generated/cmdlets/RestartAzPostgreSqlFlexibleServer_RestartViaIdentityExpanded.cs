...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.IEventListener
    {
        ...
        public string FailoverMode { get => ParametersBody.FailoverMode ?? null; set => ParametersBody.FailoverMode = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20210601.IRestartParameter _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20210601.RestartParameter();

        /// <summary>Represents server restart parameters.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20210601.IRestartParameter ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        public global::System.Management.Automation.SwitchParameter RestartWithFailover { get => ParametersBody.RestartWithFailover ?? default(global::System.Management.Automation.SwitchParameter); set => ParametersBody.RestartWithFailover = value; }
        ...
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Cmdlets.RestartAzPostgreSqlFlexibleServer_RestartViaIdentityExpanded Clone()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.FlexibleServersRestartViaIdentity(InputObject.Id, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.FlexibleServersRestart(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServerName ?? null, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RestartAzPostgreSqlFlexibleServer_RestartViaIdentityExpanded" /> cmdlet class.
        /// </summary>
