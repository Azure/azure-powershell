...
Describe 'New-AzPostgreSqlVirtualNetworkRule' {
    It 'CreateExpanded' {
        $ID = "/subscriptions/$($env.SubscriptionId)/resourceGroups/$($env.resourceGroup)/providers/Microsoft.Network/virtualNetworks/PostgreSqlVnet/subnets/PostgresqlSubnet1"
