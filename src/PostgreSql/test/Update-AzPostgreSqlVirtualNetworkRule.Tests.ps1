...
Describe 'Update-AzPostgreSqlVirtualNetworkRule' {
    It 'UpdateExpanded' {
        $ID1 = "/subscriptions/$($env.SubscriptionId)/resourceGroups/$($env.resourceGroup)/providers/Microsoft.Network/virtualNetworks/PostgreSqlVnet/subnets/PostgresqlSubnet1"
        ...
        $ID2 = "/subscriptions/$($env.SubscriptionId)/resourceGroups/$($env.resourceGroup)/providers/Microsoft.Network/virtualNetworks/PostgreSqlVnet/subnets/PostgresqlSubnet2"
