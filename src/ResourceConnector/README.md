<!-- region Generated -->
# Az.ResourceConnector
This directory contains the PowerShell module for the ResourceConnector service.

---
## Status
[![Az.ResourceConnector](https://img.shields.io/powershellgallery/v/Az.ResourceConnector.svg?style=flat-square&label=Az.ResourceConnector "Az.ResourceConnector")](https://www.powershellgallery.com/packages/Az.ResourceConnector/)
...
## Development
For information on how to develop for `Az.ResourceConnector`, see [how-to.md](how-to.md).
<!-- endregion -->
...
directive:
  ...
  - where:
    ...
    set:
      subject: BridgeTelemetryConfig
  - where:
      subject: ApplianceUpgradeGraph
    set:
      subject: BridgeUpgradeGraph
  - where:
