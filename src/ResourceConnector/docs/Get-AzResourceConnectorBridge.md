...
online version: https://learn.microsoft.com/powershell/module/az.resourceconnector/get-azresourceconnectorbridge
schema: 2.0.0
---
...
### List (Default)
```
Get-AzResourceConnectorBridge [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzResourceConnectorBridge -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzResourceConnectorBridge -InputObject <IResourceConnectorIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### List1
```
Get-AzResourceConnectorBridge -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
