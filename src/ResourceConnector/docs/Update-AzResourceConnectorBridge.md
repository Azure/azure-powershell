...
online version: https://learn.microsoft.com/powershell/module/az.resourceconnector/update-azresourceconnectorbridge
schema: 2.0.0
---

# Update-AzResourceConnectorBridge
...
```
Update-AzResourceConnectorBridge -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzResourceConnectorBridge -InputObject <IResourceConnectorIdentity> [-Tag <Hashtable>]
...
### Microsoft.Azure.PowerShell.Cmdlets.ResourceConnector.Models.Api20221027.IAppliance
