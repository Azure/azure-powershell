...
online version: https://learn.microsoft.com/powershell/module/az.resourceconnector/remove-azresourceconnectorbridge
schema: 2.0.0
---

# Remove-AzResourceConnectorBridge
...
### Delete (Default)
```
Remove-AzResourceConnectorBridge -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzResourceConnectorBridge -InputObject <IResourceConnectorIdentity> [-DefaultProfile <PSObject>]
