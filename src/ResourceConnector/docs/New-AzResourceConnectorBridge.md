...
online version: https://learn.microsoft.com/powershell/module/az.resourceconnector/new-azresourceconnectorbridge
schema: 2.0.0
---

# New-AzResourceConnectorBridge
...
```
New-AzResourceConnectorBridge -Name <String> -ResourceGroupName <String> -Location <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ResourceConnector.Support.Distro
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ResourceConnector.Support.ResourceIdentityType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ResourceConnector.Support.Provider
Parameter Sets: (All)
Aliases:
