...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Runtime.IEventListener
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Query { get => _propertiesBody.Query ?? null; set => _propertiesBody.Query = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.GraphQueryCreateOrUpdateViaIdentity(InputObject.Id, _propertiesBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.GraphQueryCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ResourceName ?? null, _propertiesBody, onOk, onDefault, this, Pipeline);
                    }
