@{
  ...
  FunctionsToExport = 'Get-AzBillingBenefitsReservationOrderAlias', 'Get-AzBillingBenefitsSavingPlan', 'Get-AzBillingBenefitsSavingsPlan', 'Get-AzBillingBenefitsSavingsPlanOrder', 'Get-AzBillingBenefitsSavingsPlanOrderAlias', 'Invoke-AzBillingBenefitsElevateSavingPlanOrder', 'New-AzBillingBenefitsReservationOrderAlias', 'New-AzBillingBenefitsSavingsPlanOrderAlias', 'Test-AzBillingBenefitsPurchase', 'Test-AzBillingBenefitsSavingPlanUpdate', 'Update-AzBillingBenefitsSavingsPlan', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
