...
```powershell
Update-AzDeviceRegistryPolicy -ResourceGroupName "my-resource-group" -NamespaceName "my-namespace" -Name "my-policy" -LeafCertificateConfigurationValidityPeriodInDay 30
```
