...
```
New-AzDeviceRegistryCredentials -NamespaceName <String> -ResourceGroupName <String> -Location <String>
...
```
New-AzDeviceRegistryCredentials -NamespaceName <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### CreateViaJsonString
```
New-AzDeviceRegistryCredentials -NamespaceName <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
