...
Updates a Device Registry Namespace Device using a complete device identity object that includes subscription, resource group, namespace, and device name. This approach is useful in automation scenarios where resource identifiers are constructed programmatically.
