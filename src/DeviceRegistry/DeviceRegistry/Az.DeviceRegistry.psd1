...
FunctionsToExport = 'Get-AzDeviceRegistryAsset', 
               ...
               'Get-AzDeviceRegistrySchema', 'Get-AzDeviceRegistrySchemaRegistry', 
               ...
               'New-AzDeviceRegistrySchema', 'New-AzDeviceRegistrySchemaRegistry', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Public preview release of API version 2025-07-01-preview for Az.DeviceRegistry. New resources included:
    - Schema Registry
    - Schema 
    - Schema Version
    - Namespaces
