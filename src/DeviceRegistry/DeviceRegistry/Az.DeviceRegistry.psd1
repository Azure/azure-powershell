#
# Module manifest for module 'Az.DeviceRegistry'
#
...
RequiredAssemblies = 'DeviceRegistry.Autorest/bin/Az.DeviceRegistry.private.dll'
...
FormatsToProcess = 'DeviceRegistry.Autorest/Az.DeviceRegistry.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('DeviceRegistry.Autorest/Az.DeviceRegistry.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Get-AzDeviceRegistryAsset', 
               'Get-AzDeviceRegistryAssetEndpointProfile', 
               'Get-AzDeviceRegistryBillingContainer', 
               'Get-AzDeviceRegistryCredentials', 'Get-AzDeviceRegistryNamespace', 
               ...
               'Get-AzDeviceRegistryPolicy', 'Get-AzDeviceRegistrySchema', 
               'Get-AzDeviceRegistrySchemaRegistry', 
               'Get-AzDeviceRegistrySchemaVersion', 
               'Initialize-AzDeviceRegistryPolicyBringYourOwnRoot', 
               'Move-AzDeviceRegistryNamespace', 'New-AzDeviceRegistryAsset', 
               'New-AzDeviceRegistryAssetEndpointProfile', 
               'New-AzDeviceRegistryCredentials', 'New-AzDeviceRegistryNamespace', 
               ...
               'New-AzDeviceRegistryPolicy', 'New-AzDeviceRegistrySchema', 
               'New-AzDeviceRegistrySchemaRegistry', 
               'New-AzDeviceRegistrySchemaVersion', 'Remove-AzDeviceRegistryAsset', 
               ...
               'Remove-AzDeviceRegistryPolicy', 'Remove-AzDeviceRegistrySchema', 
               'Remove-AzDeviceRegistrySchemaRegistry', 
               'Remove-AzDeviceRegistrySchemaVersion', 
               'Revoke-AzDeviceRegistryNamespaceDevice', 
               'Revoke-AzDeviceRegistryPolicyIssuer', 
               'Sync-AzDeviceRegistryCredentials', 'Update-AzDeviceRegistryAsset', 
               ...
               'Update-AzDeviceRegistryPolicy', 'Update-AzDeviceRegistrySchema', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Preview release of API version 2026-03-01-preview for Az.DeviceRegistry. New cmdlets include:
