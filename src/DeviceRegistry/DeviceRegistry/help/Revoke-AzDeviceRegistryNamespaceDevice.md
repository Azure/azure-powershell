...
```
Revoke-AzDeviceRegistryNamespaceDevice -DeviceName <String> -NamespaceName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-Disable] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
Revoke-AzDeviceRegistryNamespaceDevice -DeviceName <String> -NamespaceInputObject <IDeviceRegistryIdentity>
 [-Disable] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf]
...
```
Revoke-AzDeviceRegistryNamespaceDevice -DeviceName <String> -NamespaceInputObject <IDeviceRegistryIdentity>
 -Body <IDeviceCredentialsRevokeRequest> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
Revoke-AzDeviceRegistryNamespaceDevice -DeviceName <String> -NamespaceName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -Body <IDeviceCredentialsRevokeRequest> [-DefaultProfile <PSObject>] [-AsJob]
...
Parameter Sets: RevokeViaIdentityNamespace, Revoke, RevokeViaIdentity
Aliases:
...
```yaml
Type: System.String
Parameter Sets: RevokeExpanded, RevokeViaJsonString, RevokeViaJsonFilePath, RevokeViaIdentityNamespaceExpanded, RevokeViaIdentityNamespace, Revoke
Aliases:
...
```yaml
Type: System.Management.Automation.SwitchParameter
Parameter Sets: RevokeExpanded, RevokeViaIdentityNamespaceExpanded, RevokeViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IDeviceRegistryIdentity
Parameter Sets: RevokeViaIdentityNamespaceExpanded, RevokeViaIdentityNamespace
Aliases:
...
```yaml
Type: System.String
Parameter Sets: RevokeExpanded, RevokeViaJsonString, RevokeViaJsonFilePath, Revoke
Aliases:
