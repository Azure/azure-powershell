...
online version: https://learn.microsoft.com/powershell/module/az.deviceregistry/new-azdeviceregistrycredentials
schema: 2.0.0
---

# New-AzDeviceRegistryCredentials
...
```
New-AzDeviceRegistryCredentials -NamespaceName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
Creates credentials for the namespace with specified location and tags.
Note: Only one credential resource can exist per namespace.
