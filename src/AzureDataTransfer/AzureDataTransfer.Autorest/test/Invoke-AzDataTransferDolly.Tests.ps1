if(($null -eq $TestName) -or ($TestName -contains 'Invoke-AzDataTransferDolly'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Invoke-AzDataTransferDolly.Recording.json'
...
Describe 'Invoke-AzDataTransferDolly' {
