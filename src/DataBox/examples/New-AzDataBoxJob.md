...
PS C:\> $resource = New-AzDataBoxJob -Name "ImportTest" -SubscriptionId "fa68082f-8ff7-4a25-95c7-ce9da541242f" -ResourceGroupName "dhja" -TransferType "ImportToAzure" -Detail $details -Location "WestUS" -SkuName "DataBox"
PS C:\> $resource
...
PS C:\> $resource = New-AzDataBoxJob -Name "ExportTest" -SubscriptionId "fa68082f-8ff7-4a25-95c7-ce9da541242f" -ResourceGroupName "dhja" -TransferType "ExportFromAzure" -Detail $details -Location "WestUS" -SkuName "DataBox"
...
PS C:\> New-AzDataBoxJob -Name "PwshManagedDisk" -SubscriptionId "fa68082f-8ff7-4a25-95c7-ce9da541242f" -ResourceGroupName "dhja" -TransferType "ImportToAzure" -Detail $details -Location "WestUS" -SkuName "DataBox"
...
PS C:\> New-AzDataBoxJob -Name "PowershellMSI" -SubscriptionId "fa68082f-8ff7-4a25-95c7-ce9da541242f" -ResourceGroupName "dhja" -TransferType "ImportToAzure" -Detail $details -Location "WestUS" -SkuName "DataBox"  -IdentityType "UserAssigned" -UserAssignedIdentity @{"/subscriptions/fa68082f-8ff7-4a25-95c7-ce9da541242f/resourceGroups/akvenkat/providers/Microsoft.ManagedIdentity/userAssignedIdentities/sdkIdentity" = @{}}
...
PS C:\> $resource = New-AzDataBoxJob -Name "pwshScheduleJob" -SubscriptionId "fa68082f-8ff7-4a25-95c7-ce9da541242f" -ResourceGroupName "dhja" -TransferType "ImportToAzure" -Detail $details -Location "WestUS" -SkuName "DataBox" -DeliveryType "Scheduled" -DeliveryInfoScheduledDateTime $scheduleDate
...
PS C:\> $resource = New-AzDataBoxJob -Name "PowershellBYOK" -SubscriptionId "fa68082f-8ff7-4a25-95c7-ce9da541242f" -ResourceGroupName "dhja" -TransferType "ImportToAzure" -Detail $details -Location "WestUS" -SkuName "DataBox"
...
PS C:\> $resource = New-AzDataBoxJob -Name "DbxHeavy" -SubscriptionId "fa68082f-8ff7-4a25-95c7-ce9da541242f" -ResourceGroupName "dhja" -TransferType "ImportToAzure" -Detail $details -Location "WestUS" -SkuName "DataBoxHeavy"
...
PS C:\> New-AzDataBoxJob -Name "pwshDisk" -SubscriptionId "fa68082f-8ff7-4a25-95c7-ce9da541242f" -ResourceGroupName "dhja" -TransferType "ImportToAzure" -Detail $details -Location "WestUS" -SkuName "DataBoxDisk"
