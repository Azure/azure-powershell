...
JobSecret                               : Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.DataBoxHeavyJobSecrets
...
CabinetPodSecret                        : {, }
Code                                    :
DcAccessSecurityCode                    : Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.DcAccessSecurityCode
DcAccessSecurityCodeForwardDcAccessCode :
DcAccessSecurityCodeReverseDcAccessCode :
Detail                                  :
Error                                   : Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.CloudError
Message                                 :
Target                                  :
Type                                    : DataBoxHeavy
