...
New-AzDataBoxDiskJobDetailsObject -ContactDetailEmailList <String[]> -ContactDetailsContactName <String>
 -ContactDetailsPhone <String> [-Passkey <String>] [-PreferredDisk <IDataBoxDiskJobDetailsPreferredDisks>]
 [-City <String>] [-CompanyName <String>] [-ContactDetailNotificationPreference <INotificationPreference[]>]
 [-ContactDetailsMobile <String>] [-ContactDetailsPhoneExtension <String>] [-Country <String>]
