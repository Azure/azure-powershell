...
Describe 'New-AzDataBoxJob' {
    ...
    It 'Schedule Job Test' {    
        ...
        $details = New-AzDataBoxDiskJobDetailsObject -DataImportDetail  @(@{AccountDetail=$dataAccount; AccountDetailDataAccountType = "StorageAccount"} ) -ContactDetail $contactDetail -ShippingAddress $ShippingDetails -ExpectedDataSizeInTeraByte 10
