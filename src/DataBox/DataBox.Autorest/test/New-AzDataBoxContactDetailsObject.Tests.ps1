...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'New-AzDataBoxContactDetailsObject.Recording.json'
...
Describe 'New-AzDataBoxContactDetailsObject' {
    It 'Create contact object'{
