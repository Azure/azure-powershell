...
$modelCmdlets = @('DataBoxDiskJobDetails', 'DataBoxHeavyJobDetails', 'DataBoxJobDetails', 'StorageAccountDetails', 'ManagedDiskDetails', 'KeyEncryptionKey', 'ShippingAddress', 'ContactDetails', 'TransferConfiguration')
