namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20210301
{
    ...
    public partial class SystemData :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20210301.ISystemData,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20210301.ISystemDataInternal
    {
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20210301.ISystemDataInternal.CreatedAt { get => this._createdAt; set { {_createdAt = value;} } }

        /// <summary>Internal Acessors for CreatedBy</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20210301.ISystemDataInternal.CreatedBy { get => this._createdBy; set { {_createdBy = value;} } }

        /// <summary>Internal Acessors for CreatedByType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20210301.ISystemDataInternal.CreatedByType { get => this._createdByType; set { {_createdByType = value;} } }

        /// <summary>Internal Acessors for LastModifiedAt</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20210301.ISystemDataInternal.LastModifiedAt { get => this._lastModifiedAt; set { {_lastModifiedAt = value;} } }

        /// <summary>Internal Acessors for LastModifiedBy</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20210301.ISystemDataInternal.LastModifiedBy { get => this._lastModifiedBy; set { {_lastModifiedBy = value;} } }

        /// <summary>Internal Acessors for LastModifiedByType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20210301.ISystemDataInternal.LastModifiedByType { get => this._lastModifiedByType; set { {_lastModifiedByType = value;} } }
