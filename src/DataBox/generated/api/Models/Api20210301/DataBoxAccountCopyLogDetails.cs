namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20210301
{
    ...
    public partial class DataBoxAccountCopyLogDetails :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20210301.IDataBoxAccountCopyLogDetails,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20210301.IDataBoxAccountCopyLogDetailsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20210301.IDataBoxAccountCopyLogDetailsInternal.AccountName { get => this._accountName; set { {_accountName = value;} } }

        /// <summary>Internal Acessors for CopyLogLink</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20210301.IDataBoxAccountCopyLogDetailsInternal.CopyLogLink { get => this._copyLogLink; set { {_copyLogLink = value;} } }

        /// <summary>Internal Acessors for CopyVerboseLogLink</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20210301.IDataBoxAccountCopyLogDetailsInternal.CopyVerboseLogLink { get => this._copyVerboseLogLink; set { {_copyVerboseLogLink = value;} } }
        ...
        /// <summary>Creates an new <see cref="DataBoxAccountCopyLogDetails" /> instance.</summary>
    ...
    /// Copy log details for a storage account of a DataBox job
    internal partial interface IDataBoxAccountCopyLogDetailsInternal :
