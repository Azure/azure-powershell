...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="CassandraTableGetResultResource" /> using the GetDatabaseAccountCassandraKeyspaceTableThroughputSetting method.
    /// </summary>
    public partial class DatabaseAccountCassandraKeyspaceTableThroughputSettingResource : ArmResource
    {
        ...
        internal DatabaseAccountCassandraKeyspaceTableThroughputSettingResource(ArmClient client, ThroughputSettingsGetResultData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            _databaseAccountCassandraKeyspaceTableThroughputSettingCassandraResourcesClientDiagnostics = new ClientDiagnostics("Microsoft.Azure.Management.CosmosDB", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<DatabaseAccountCassandraKeyspaceTableThroughputSettingResource>> CreateOrUpdateAsync(WaitUntil waitUntil, ThroughputSettingsUpdateParameters updateThroughputParameters, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="updateThroughputParameters"/> is null. </exception>
        public virtual ArmOperation<DatabaseAccountCassandraKeyspaceTableThroughputSettingResource> CreateOrUpdate(WaitUntil waitUntil, ThroughputSettingsUpdateParameters updateThroughputParameters, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(updateThroughputParameters, nameof(updateThroughputParameters));
