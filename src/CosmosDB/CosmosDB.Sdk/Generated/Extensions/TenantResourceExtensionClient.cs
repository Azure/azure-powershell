...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    internal partial class TenantResourceExtensionClient : ArmResource
    {
        ...
        {
            using var scope = DatabaseAccountGetResultDatabaseAccountsClientDiagnostics.CreateScope("TenantResourceExtensionClient.CheckNameExistsDatabaseAccount");
            scope.Start();
            try
            {
                var response = await DatabaseAccountGetResultDatabaseAccountsRestClient.CheckNameExistsAsync(accountName, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<bool> CheckNameExistsDatabaseAccount(string accountName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = DatabaseAccountGetResultDatabaseAccountsRestClient.CheckNameExists(accountName, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
