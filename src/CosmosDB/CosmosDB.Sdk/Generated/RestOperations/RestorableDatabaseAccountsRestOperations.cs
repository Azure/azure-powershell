...
namespace Microsoft.Azure.Management.CosmosDB
{
    internal partial class RestorableDatabaseAccountsRestOperations
    {
        ...
        public async Task<Response<RestorableDatabaseAccountGetResultData>> GetByLocationAsync(string subscriptionId, string location, string instanceId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(location, nameof(location));
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        RestorableDatabaseAccountGetResultData value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = RestorableDatabaseAccountGetResultData.DeserializeRestorableDatabaseAccountGetResultData(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                case 404:
                    return Response.FromValue((RestorableDatabaseAccountGetResultData)null, message.Response);
                default:
                    throw new RequestFailedException(message.Response);
            }
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="location"/> or <paramref name="instanceId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="location"/> or <paramref name="instanceId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<RestorableDatabaseAccountGetResultData> GetByLocation(string subscriptionId, string location, string instanceId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(location, nameof(location));
            Argument.AssertNotNullOrEmpty(instanceId, nameof(instanceId));
