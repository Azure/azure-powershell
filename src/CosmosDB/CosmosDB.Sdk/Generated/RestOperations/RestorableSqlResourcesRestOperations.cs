...
namespace Microsoft.Azure.Management.CosmosDB
{
    internal partial class RestorableSqlResourcesRestOperations
    {
        ...
        public RestorableSqlResourcesRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        public async Task<Response<RestorableSqlResourcesListResult>> ListAsync(string subscriptionId, string location, string instanceId, string restoreLocation = null, string restoreTimestampInUtc = null, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        RestorableSqlResourcesListResult value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = RestorableSqlResourcesListResult.DeserializeRestorableSqlResourcesListResult(document.RootElement);
