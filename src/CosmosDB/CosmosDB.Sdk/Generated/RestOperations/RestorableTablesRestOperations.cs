...
namespace Microsoft.Azure.Management.CosmosDB
{
    internal partial class RestorableTablesRestOperations
    {
        ...
        internal HttpMessage CreateListRequest(string subscriptionId, string location, string instanceId, string startTime, string endTime)
        {
        ...
        public async Task<Response<RestorableTablesListResult>> ListAsync(string subscriptionId, string location, string instanceId, string startTime = null, string endTime = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="location"/> or <paramref name="instanceId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="location"/> or <paramref name="instanceId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<RestorableTablesListResult> List(string subscriptionId, string location, string instanceId, string startTime = null, string endTime = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(location, nameof(location));
            Argument.AssertNotNullOrEmpty(instanceId, nameof(instanceId));
