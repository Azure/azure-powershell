...
{
    /// <summary> A class representing the SqlRoleAssignmentGetResult data model. </summary>
    public partial class SqlRoleAssignmentGetResultData : ResourceData
    {
        /// <summary> Initializes a new instance of SqlRoleAssignmentGetResultData. </summary>
        public SqlRoleAssignmentGetResultData()
        {
        }
        ...
        internal SqlRoleAssignmentGetResultData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string roleDefinitionId, string scope, string principalId) : base(id, name, resourceType, systemData)
        {
