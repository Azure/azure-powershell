...
{
    /// <summary> A class representing the SqlRoleDefinitionGetResult data model. </summary>
    public partial class SqlRoleDefinitionGetResultData : ResourceData
    {
        /// <summary> Initializes a new instance of SqlRoleDefinitionGetResultData. </summary>
        public SqlRoleDefinitionGetResultData()
        {
        ...
        internal SqlRoleDefinitionGetResultData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string roleName, RoleDefinitionType? typePropertiesType, IList<string> assignableScopes, IList<Permission> permissions) : base(id, name, resourceType, systemData)
        {
            RoleName = roleName;
