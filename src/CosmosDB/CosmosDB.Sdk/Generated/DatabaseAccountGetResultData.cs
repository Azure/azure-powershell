...
{
    /// <summary> A class representing the DatabaseAccountGetResult data model. </summary>
    public partial class DatabaseAccountGetResultData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of DatabaseAccountGetResultData. </summary>
        /// <param name="location"> The location. </param>
        public DatabaseAccountGetResultData(AzureLocation location) : base(location)
        {
        ...
        internal DatabaseAccountGetResultData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, DatabaseAccountKind? kind, string provisioningState, string documentEndpoint, DatabaseAccountOfferType? databaseAccountOfferType, IList<IpAddressOrRange> ipRules, bool? isVirtualNetworkFilterEnabled, bool? enableAutomaticFailover, ConsistencyPolicy consistencyPolicy, IList<Capability> capabilities, IReadOnlyList<Location> writeLocations, IReadOnlyList<Location> readLocations, IReadOnlyList<Location> locations, IReadOnlyList<FailoverPolicy> failoverPolicies, IList<VirtualNetworkRule> virtualNetworkRules, IReadOnlyList<CosmosDBPrivateEndpointConnection> privateEndpointConnections, bool? enableMultipleWriteLocations, bool? enableCassandraConnector, ConnectorOffer? connectorOffer, bool? disableKeyBasedMetadataWriteAccess, string keyVaultKeyUri, string defaultIdentity, PublicNetworkAccess? publicNetworkAccess, bool? enableFreeTier, ApiProperties apiProperties, bool? enableAnalyticalStorage, AnalyticalStorageConfiguration analyticalStorageConfiguration, string instanceId, CreateMode? createMode, RestoreParameters restoreParameters, BackupPolicy backupPolicy, IList<CorsPolicy> cors, NetworkAclBypass? networkAclBypass, IList<string> networkAclBypassResourceIds, DiagnosticLogSettings diagnosticLogSettings, bool? disableLocalAuth, Capacity capacity, bool? enableMaterializedViews, DatabaseAccountKeysMetadata keysMetadata, bool? enablePartitionMerge, ManagedServiceIdentity identity) : base(id, name, resourceType, systemData, tags, location)
        {
            Kind = kind;
        ...
        public IReadOnlyList<CosmosDBPrivateEndpointConnection> PrivateEndpointConnections { get; }
