...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    public partial class ClusterResource : ArmResource
    {
        ...
        {
            _clusterResourceCassandraClustersClientDiagnostics = new ClientDiagnostics("Microsoft.Azure.Management.CosmosDB", ResourceType.Namespace, Diagnostics);
        ...
        /// <summary> Gets a collection of BackupResources in the ClusterResource. </summary>
        ...
        public virtual async Task<Response<ClusterResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var patch = new ClusterResourceData(current.Location);
