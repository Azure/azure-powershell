...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    /// </summary>
    internal partial class PartitionKeyRangeIdOperations : Microsoft.Rest.IServiceOperations<CosmosDBManagementClient>, IPartitionKeyRangeIdOperations
    {
        /// <summary>
        /// Initializes a new instance of the PartitionKeyRangeIdOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal PartitionKeyRangeIdOperations (CosmosDBManagementClient client)
        {
            if (client == null) 
            {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<System.Collections.Generic.IEnumerable<PartitionMetric>>> ListMetricsWithHttpMessagesAsync(string resourceGroupName, string accountName, string databaseRid, string collectionRid, string partitionKeyRangeId, string filter, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "partitionKeyRangeId");
            }
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<System.Collections.Generic.IEnumerable<PartitionMetric>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<PartitionMetric>>(_responseContent, this.Client.DeserializationSettings);
                }
