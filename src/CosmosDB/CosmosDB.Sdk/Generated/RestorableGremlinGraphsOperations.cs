...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    /// </summary>
    internal partial class RestorableGremlinGraphsOperations : Microsoft.Rest.IServiceOperations<CosmosDBManagementClient>, IRestorableGremlinGraphsOperations
    {
        /// <summary>
        /// Initializes a new instance of the RestorableGremlinGraphsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal RestorableGremlinGraphsOperations (CosmosDBManagementClient client)
        {
            if (client == null) 
            {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<System.Collections.Generic.IEnumerable<RestorableGremlinGraphGetResult>>> ListWithHttpMessagesAsync(string location, string instanceId, string restorableGremlinDatabaseRid = default(string), string startTime = default(string), string endTime = default(string), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("restorableGremlinDatabaseRid", restorableGremlinDatabaseRid);
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableGraphs").ToString();
            ...
            {
                _queryParameters.Add(string.Format("restorableGremlinDatabaseRid={0}", System.Uri.EscapeDataString(restorableGremlinDatabaseRid)));
            }
            if (startTime != null)
            {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<System.Collections.Generic.IEnumerable<RestorableGremlinGraphGetResult>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<RestorableGremlinGraphGetResult>>(_responseContent, this.Client.DeserializationSettings);
                }
