...
{
    public partial class SqlDatabaseGetResultCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static SqlDatabaseGetResultCreateOrUpdateContent DeserializeSqlDatabaseGetResultCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new SqlDatabaseGetResultCreateOrUpdateContent(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource, options.Value, identity);
        }
    }
}
