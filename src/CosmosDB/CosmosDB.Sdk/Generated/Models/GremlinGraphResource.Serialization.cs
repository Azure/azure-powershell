...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    public partial class GremlinGraphResource : IUtf8JsonSerializable
    {
        ...
        internal static GremlinGraphResource DeserializeGremlinGraphResource(JsonElement element)
        {
            ...
            return new GremlinGraphResource(id, indexingPolicy.Value, partitionKey.Value, Optional.ToNullable(defaultTtl), uniqueKeyPolicy.Value, conflictResolutionPolicy.Value, Optional.ToNullable(analyticalStorageTtl));
        }
    }
}
