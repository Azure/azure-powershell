...
{
    public partial class SqlContainerGetPropertiesOptions : IUtf8JsonSerializable
    {
        ...
        internal static SqlContainerGetPropertiesOptions DeserializeSqlContainerGetPropertiesOptions(JsonElement element)
        {
            ...
            return new SqlContainerGetPropertiesOptions(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
