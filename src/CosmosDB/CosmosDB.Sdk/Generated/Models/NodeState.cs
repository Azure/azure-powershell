...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public readonly partial struct NodeState : IEquatable<NodeState>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="NodeState"/>. </summary>
        ...
        public static NodeState Normal { get; } = new NodeState(NormalValue);
        /// <summary> Leaving. </summary>
        public static NodeState Leaving { get; } = new NodeState(LeavingValue);
        /// <summary> Joining. </summary>
        public static NodeState Joining { get; } = new NodeState(JoiningValue);
        /// <summary> Moving. </summary>
        public static NodeState Moving { get; } = new NodeState(MovingValue);
        /// <summary> Stopped. </summary>
        public static NodeState Stopped { get; } = new NodeState(StoppedValue);
