...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    public partial class GremlinGraphGetPropertiesResource : IUtf8JsonSerializable
    {
        ...
        internal static GremlinGraphGetPropertiesResource DeserializeGremlinGraphGetPropertiesResource(JsonElement element)
        {
            ...
            return new GremlinGraphGetPropertiesResource(id, indexingPolicy.Value, partitionKey.Value, Optional.ToNullable(defaultTtl), uniqueKeyPolicy.Value, conflictResolutionPolicy.Value, Optional.ToNullable(analyticalStorageTtl), rid.Value, Optional.ToNullable(ts), etag.Value);
        }
    }
}
