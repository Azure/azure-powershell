...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class GremlinDatabaseGetResultCreateOrUpdateContent : TrackedResourceData
    {
        /// <summary> Initializes a new instance of GremlinDatabaseGetResultCreateOrUpdateContent. </summary>
        /// <param name="location"> The location. </param>
        /// <param name="resource"> The standard JSON format of a Gremlin database. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public GremlinDatabaseGetResultCreateOrUpdateContent(AzureLocation location, WritableSubResource resource) : base(location)
        {
            if (resource == null)
            {
