...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class RestorableGremlinDatabasePropertiesResource
    {
        ...
        internal RestorableGremlinDatabasePropertiesResource(string rid, OperationType? operationType, string eventTimestamp, string ownerId, string ownerResourceId)
        {
            Rid = rid;
