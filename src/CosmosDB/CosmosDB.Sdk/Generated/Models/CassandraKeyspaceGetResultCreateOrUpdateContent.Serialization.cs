...
{
    public partial class CassandraKeyspaceGetResultCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static CassandraKeyspaceGetResultCreateOrUpdateContent DeserializeCassandraKeyspaceGetResultCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new CassandraKeyspaceGetResultCreateOrUpdateContent(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource, options.Value, identity);
        }
    }
}
