...
{
    public partial class RestorableDatabaseAccountGetResultData
    {
        internal static RestorableDatabaseAccountGetResultData DeserializeRestorableDatabaseAccountGetResultData(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("oldestRestorableTime"))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                property0.ThrowNonNullablePropertyIsNull();
            ...
            return new RestorableDatabaseAccountGetResultData(id, name, type, systemData.Value, location.Value, accountName.Value, Optional.ToNullable(creationTime), Optional.ToNullable(oldestRestorableTime), Optional.ToNullable(deletionTime), Optional.ToNullable(apiType), Optional.ToList(restorableLocations));
        }
    }
}
