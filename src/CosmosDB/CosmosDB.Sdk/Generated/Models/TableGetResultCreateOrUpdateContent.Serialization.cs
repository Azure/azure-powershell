...
{
    public partial class TableGetResultCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static TableGetResultCreateOrUpdateContent DeserializeTableGetResultCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new TableGetResultCreateOrUpdateContent(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource, options.Value, identity);
        }
    }
}
