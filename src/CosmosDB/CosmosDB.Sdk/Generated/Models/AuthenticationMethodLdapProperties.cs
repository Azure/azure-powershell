...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class AuthenticationMethodLdapProperties
    {
        ...
        {
            ServerCertificates = new ChangeTrackingList<Certificate>();
        }
        ...
        internal AuthenticationMethodLdapProperties(string serverHostname, int? serverPort, string serviceUserDistinguishedName, string serviceUserPassword, string searchBaseDistinguishedName, string searchFilterTemplate, IList<Certificate> serverCertificates)
        {
        ...
        public IList<Certificate> ServerCertificates { get; }
    }
}
