...
{
    public partial class CassandraTableGetPropertiesOptions : IUtf8JsonSerializable
    {
        ...
        internal static CassandraTableGetPropertiesOptions DeserializeCassandraTableGetPropertiesOptions(JsonElement element)
        {
            ...
            return new CassandraTableGetPropertiesOptions(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
