...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    {
        internal static CosmosDBUsage DeserializeCosmosDBUsage(JsonElement element)
        {
            ...
            return new CosmosDBUsage(Optional.ToNullable(unit), name.Value, quotaPeriod.Value, Optional.ToNullable(limit), Optional.ToNullable(currentValue));
        }
    }
}
