...
{
    public partial class ThroughputSettingsUpdateParameters : IUtf8JsonSerializable
    {
        ...
        internal static ThroughputSettingsUpdateParameters DeserializeThroughputSettingsUpdateParameters(JsonElement element)
        {
            ...
            return new ThroughputSettingsUpdateParameters(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource, identity);
        }
    }
}
