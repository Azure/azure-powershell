...
{
    public partial class GremlinDatabaseGetResultData : IUtf8JsonSerializable
    {
        ...
        internal static GremlinDatabaseGetResultData DeserializeGremlinDatabaseGetResultData(JsonElement element)
        {
            ...
            return new GremlinDatabaseGetResultData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource.Value, options.Value, identity);
        }
    }
}
