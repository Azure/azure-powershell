...
{
    public partial class SqlDatabaseGetPropertiesOptions : IUtf8JsonSerializable
    {
        ...
        internal static SqlDatabaseGetPropertiesOptions DeserializeSqlDatabaseGetPropertiesOptions(JsonElement element)
        {
            ...
            return new SqlDatabaseGetPropertiesOptions(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
