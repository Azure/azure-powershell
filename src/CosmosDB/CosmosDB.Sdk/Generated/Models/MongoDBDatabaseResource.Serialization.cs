...
{
    public partial class MongoDBDatabaseResource : IUtf8JsonSerializable
    {
        ...
        internal static MongoDBDatabaseResource DeserializeMongoDBDatabaseResource(JsonElement element)
        {
            string id = default;
            ...
            return new MongoDBDatabaseResource(id, restoreParameters.Value, Optional.ToNullable(createMode));
        }
    }
}
