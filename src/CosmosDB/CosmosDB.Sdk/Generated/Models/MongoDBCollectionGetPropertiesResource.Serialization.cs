...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    public partial class MongoDBCollectionGetPropertiesResource : IUtf8JsonSerializable
    {
        ...
        internal static MongoDBCollectionGetPropertiesResource DeserializeMongoDBCollectionGetPropertiesResource(JsonElement element)
        {
            ...
            return new MongoDBCollectionGetPropertiesResource(id, Optional.ToDictionary(shardKey), Optional.ToList(indexes), Optional.ToNullable(analyticalStorageTtl), restoreParameters.Value, Optional.ToNullable(createMode), rid.Value, Optional.ToNullable(ts), etag.Value);
        }
    }
}
