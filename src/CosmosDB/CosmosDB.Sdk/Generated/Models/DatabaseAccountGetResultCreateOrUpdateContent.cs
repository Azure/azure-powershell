...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class DatabaseAccountGetResultCreateOrUpdateContent : TrackedResourceData
    {
        /// <summary> Initializes a new instance of DatabaseAccountGetResultCreateOrUpdateContent. </summary>
        ...
        public DatabaseAccountGetResultCreateOrUpdateContent(AzureLocation location, IEnumerable<Location> locations) : base(location)
        {
            if (locations == null)
            {
        ...
        internal DatabaseAccountGetResultCreateOrUpdateContent(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, DatabaseAccountKind? kind, ConsistencyPolicy consistencyPolicy, IList<Location> locations, DatabaseAccountOfferType databaseAccountOfferType, IList<IpAddressOrRange> ipRules, bool? isVirtualNetworkFilterEnabled, bool? enableAutomaticFailover, IList<Capability> capabilities, IList<VirtualNetworkRule> virtualNetworkRules, bool? enableMultipleWriteLocations, bool? enableCassandraConnector, ConnectorOffer? connectorOffer, bool? disableKeyBasedMetadataWriteAccess, string keyVaultKeyUri, string defaultIdentity, PublicNetworkAccess? publicNetworkAccess, bool? enableFreeTier, ApiProperties apiProperties, bool? enableAnalyticalStorage, AnalyticalStorageConfiguration analyticalStorageConfiguration, CreateMode? createMode, BackupPolicy backupPolicy, IList<CorsPolicy> cors, NetworkAclBypass? networkAclBypass, IList<string> networkAclBypassResourceIds, DiagnosticLogSettings diagnosticLogSettings, bool? disableLocalAuth, RestoreParameters restoreParameters, Capacity capacity, bool? enableMaterializedViews, DatabaseAccountKeysMetadata keysMetadata, bool? enablePartitionMerge, ManagedServiceIdentity identity) : base(id, name, resourceType, systemData, tags, location)
        {
            Kind = kind;
