...
{
    public partial class SqlRoleDefinitionGetResultData : IUtf8JsonSerializable
    {
        ...
        internal static SqlRoleDefinitionGetResultData DeserializeSqlRoleDefinitionGetResultData(JsonElement element)
        {
            ...
            return new SqlRoleDefinitionGetResultData(id, name, type, systemData.Value, roleName.Value, Optional.ToNullable(type0), Optional.ToList(assignableScopes), Optional.ToList(permissions));
        }
    }
}
