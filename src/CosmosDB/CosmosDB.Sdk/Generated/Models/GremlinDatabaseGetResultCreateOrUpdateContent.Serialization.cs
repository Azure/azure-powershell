...
{
    public partial class GremlinDatabaseGetResultCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static GremlinDatabaseGetResultCreateOrUpdateContent DeserializeGremlinDatabaseGetResultCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new GremlinDatabaseGetResultCreateOrUpdateContent(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource, options.Value, identity);
        }
    }
}
