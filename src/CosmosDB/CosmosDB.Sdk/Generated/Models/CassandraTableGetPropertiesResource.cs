...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class CassandraTableGetPropertiesResource : CassandraTableResource
    {
        ...
        internal CassandraTableGetPropertiesResource(string id, int? defaultTtl, CassandraSchema schema, int? analyticalStorageTtl, string rid, float? ts, string etag) : base(id, defaultTtl, schema, analyticalStorageTtl)
        {
            Rid = rid;
            Ts = ts;
            Etag = etag;
