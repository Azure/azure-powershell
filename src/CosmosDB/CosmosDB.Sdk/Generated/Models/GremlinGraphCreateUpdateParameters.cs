...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class GremlinGraphCreateUpdateParameters : ARMResourceProperties
    {
        ...
        /// </param>
        public GremlinGraphCreateUpdateParameters(GremlinGraphResource resource, string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), CreateUpdateOptions options = default(CreateUpdateOptions))
