...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class SqlStoredProcedureGetResults : ARMResourceProperties
    {
        ...
        /// <param name="resource">
        /// </param>
        public SqlStoredProcedureGetResults(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), ManagedServiceIdentity identity = default(ManagedServiceIdentity), SqlStoredProcedureGetPropertiesResource resource = default(SqlStoredProcedureGetPropertiesResource))
