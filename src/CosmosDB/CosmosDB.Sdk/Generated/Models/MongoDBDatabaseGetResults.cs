...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class MongoDBDatabaseGetResults : ARMResourceProperties
    {
        ...
        /// <param name="options">
        /// </param>
        public MongoDBDatabaseGetResults(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), MongoDBDatabaseGetPropertiesResource resource = default(MongoDBDatabaseGetPropertiesResource), MongoDBDatabaseGetPropertiesOptions options = default(MongoDBDatabaseGetPropertiesOptions))
