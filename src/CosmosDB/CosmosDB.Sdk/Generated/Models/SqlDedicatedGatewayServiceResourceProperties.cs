...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SqlDedicatedGatewayServiceResourceProperties. </summary>
        ...
        internal SqlDedicatedGatewayServiceResourceProperties(DateTimeOffset? createdOn, ServiceSize? instanceSize, int? instanceCount, ServiceType serviceType, ServiceStatus? status, IDictionary<string, BinaryData> additionalProperties, string sqlDedicatedGatewayEndpoint, IReadOnlyList<SqlDedicatedGatewayRegionalServiceResource> locations) : base(createdOn, instanceSize, instanceCount, serviceType, status, additionalProperties)
        {
        ...
        public IReadOnlyList<SqlDedicatedGatewayRegionalServiceResource> Locations { get; }
    }
}
