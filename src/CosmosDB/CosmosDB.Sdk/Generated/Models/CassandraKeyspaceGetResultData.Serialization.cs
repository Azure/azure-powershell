...
{
    public partial class CassandraKeyspaceGetResultData : IUtf8JsonSerializable
    {
        ...
        internal static CassandraKeyspaceGetResultData DeserializeCassandraKeyspaceGetResultData(JsonElement element)
        {
            ...
            return new CassandraKeyspaceGetResultData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource.Value, options.Value, identity);
        }
    }
}
