...
{
    public partial class SqlDatabaseResource : IUtf8JsonSerializable
    {
        ...
        internal static SqlDatabaseResource DeserializeSqlDatabaseResource(JsonElement element)
        {
            string id = default;
            ...
            return new SqlDatabaseResource(id, restoreParameters.Value, Optional.ToNullable(createMode));
        }
    }
}
