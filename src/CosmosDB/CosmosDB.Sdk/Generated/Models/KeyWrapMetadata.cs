...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class KeyWrapMetadata
    {
        ...
        /// <param name="name">The name of associated KeyEncryptionKey (aka CustomerManagedKey).
        /// </param>

        /// <param name="type">ProviderName of KeyStoreProvider.
        /// </param>

        /// <param name="value">Reference / link to the KeyEncryptionKey.
        /// </param>

        /// <param name="algorithm">Algorithm used in wrapping and unwrapping of the data encryption key.
        /// </param>
