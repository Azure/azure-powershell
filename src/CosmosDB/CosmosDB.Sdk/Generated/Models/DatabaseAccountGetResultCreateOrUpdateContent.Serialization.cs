...
{
    public partial class DatabaseAccountGetResultCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static DatabaseAccountGetResultCreateOrUpdateContent DeserializeDatabaseAccountGetResultCreateOrUpdateContent(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("enableMaterializedViews"))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                property0.ThrowNonNullablePropertyIsNull();
