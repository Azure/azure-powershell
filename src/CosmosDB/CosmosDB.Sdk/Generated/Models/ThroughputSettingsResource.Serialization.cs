...
{
    public partial class ThroughputSettingsResource : IUtf8JsonSerializable
    {
        ...
        internal static ThroughputSettingsResource DeserializeThroughputSettingsResource(JsonElement element)
        {
            ...
            return new ThroughputSettingsResource(Optional.ToNullable(throughput), autoscaleSettings.Value, minimumThroughput.Value, offerReplacePending.Value);
        }
    }
}
