...
{
    public partial class TableGetResultData : IUtf8JsonSerializable
    {
        ...
        internal static TableGetResultData DeserializeTableGetResultData(JsonElement element)
        {
            ...
            return new TableGetResultData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource.Value, options.Value, identity);
        }
    }
}
