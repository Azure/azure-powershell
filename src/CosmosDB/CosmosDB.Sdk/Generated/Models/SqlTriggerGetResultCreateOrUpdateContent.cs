...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class SqlTriggerGetResultCreateOrUpdateContent : TrackedResourceData
    {
        /// <summary> Initializes a new instance of SqlTriggerGetResultCreateOrUpdateContent. </summary>
        /// <param name="location"> The location. </param>
        /// <param name="resource"> The standard JSON format of a trigger. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public SqlTriggerGetResultCreateOrUpdateContent(AzureLocation location, SqlTriggerResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal SqlTriggerGetResultCreateOrUpdateContent(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, SqlTriggerResource resource, CreateUpdateOptions options, ManagedServiceIdentity identity) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
            Identity = identity;
