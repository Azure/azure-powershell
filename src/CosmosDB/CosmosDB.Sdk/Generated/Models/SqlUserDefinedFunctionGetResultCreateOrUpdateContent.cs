...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class SqlUserDefinedFunctionGetResultCreateOrUpdateContent : TrackedResourceData
    {
        /// <summary> Initializes a new instance of SqlUserDefinedFunctionGetResultCreateOrUpdateContent. </summary>
        /// <param name="location"> The location. </param>
        /// <param name="resource"> The standard JSON format of a userDefinedFunction. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public SqlUserDefinedFunctionGetResultCreateOrUpdateContent(AzureLocation location, SqlUserDefinedFunctionResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal SqlUserDefinedFunctionGetResultCreateOrUpdateContent(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, SqlUserDefinedFunctionResource resource, CreateUpdateOptions options, ManagedServiceIdentity identity) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
            Identity = identity;
