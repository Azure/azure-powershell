...
{
    public partial class SqlUserDefinedFunctionGetResultCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static SqlUserDefinedFunctionGetResultCreateOrUpdateContent DeserializeSqlUserDefinedFunctionGetResultCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new SqlUserDefinedFunctionGetResultCreateOrUpdateContent(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource, options.Value, identity);
        }
    }
}
