...
{
    public partial class GraphAPIComputeServiceResourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static GraphAPIComputeServiceResourceProperties DeserializeGraphAPIComputeServiceResourceProperties(JsonElement element)
        {
            Optional<string> graphApiComputeEndpoint = default;
            Optional<IReadOnlyList<GraphAPIComputeRegionalServiceResource>> locations = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("locations"))
                {
                    ...
                    {
                        array.Add(GraphAPIComputeRegionalServiceResource.DeserializeGraphAPIComputeRegionalServiceResource(item));
                    }
                    locations = array;
                    continue;
                }
            ...
            return new GraphAPIComputeServiceResourceProperties(Optional.ToNullable(creationTime), Optional.ToNullable(instanceSize), Optional.ToNullable(instanceCount), serviceType, Optional.ToNullable(status), additionalProperties, graphApiComputeEndpoint.Value, Optional.ToList(locations));
        }
    }
}
