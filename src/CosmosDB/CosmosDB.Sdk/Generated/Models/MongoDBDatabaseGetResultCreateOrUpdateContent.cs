...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class MongoDBDatabaseGetResultCreateOrUpdateContent : TrackedResourceData
    {
        /// <summary> Initializes a new instance of MongoDBDatabaseGetResultCreateOrUpdateContent. </summary>
        /// <param name="location"> The location. </param>
        /// <param name="resource"> The standard JSON format of a MongoDB database. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public MongoDBDatabaseGetResultCreateOrUpdateContent(AzureLocation location, MongoDBDatabaseResource resource) : base(location)
        {
            if (resource == null)
            {
