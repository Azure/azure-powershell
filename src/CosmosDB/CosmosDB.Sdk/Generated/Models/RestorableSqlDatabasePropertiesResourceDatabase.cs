...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class RestorableSqlDatabasePropertiesResourceDatabase : SqlDatabaseResource
    {
        ...
        internal RestorableSqlDatabasePropertiesResourceDatabase(string id, ResourceRestoreParameters restoreParameters, CreateMode? createMode, string colls, string users, string self, string rid, float? ts, string etag) : base(id, restoreParameters, createMode)
        {
            Colls = colls;
            Users = users;
            Self = self;
