...
{
    public partial class SqlTriggerGetResultCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static SqlTriggerGetResultCreateOrUpdateContent DeserializeSqlTriggerGetResultCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new SqlTriggerGetResultCreateOrUpdateContent(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource, options.Value, identity);
        }
    }
}
