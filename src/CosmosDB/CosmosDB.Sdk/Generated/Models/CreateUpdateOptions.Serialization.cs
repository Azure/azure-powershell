...
{
    public partial class CreateUpdateOptions : IUtf8JsonSerializable
    {
        ...
        internal static CreateUpdateOptions DeserializeCreateUpdateOptions(JsonElement element)
        {
            ...
            return new CreateUpdateOptions(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
