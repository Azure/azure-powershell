...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class MongoDBCollectionResource
    {
        ...
        internal MongoDBCollectionResource(string id, IDictionary<string, string> shardKey, IList<MongoIndex> indexes, int? analyticalStorageTtl, ResourceRestoreParameters restoreParameters, CreateMode? createMode)
        {
            Id = id;
            ShardKey = shardKey;
            Indexes = indexes;
