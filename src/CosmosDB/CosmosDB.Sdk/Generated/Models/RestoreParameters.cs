...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class RestoreParameters : RestoreParametersBase
    {
        ...
        internal RestoreParameters(string restoreSource, DateTimeOffset? restoreTimestampInUtc, RestoreMode? restoreMode, IList<DatabaseRestoreResource> databasesToRestore, IList<GremlinDatabaseRestoreResource> gremlinDatabasesToRestore, IList<string> tablesToRestore) : base(restoreSource, restoreTimestampInUtc)
        {
