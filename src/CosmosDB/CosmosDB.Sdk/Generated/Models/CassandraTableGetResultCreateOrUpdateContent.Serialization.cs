...
{
    public partial class CassandraTableGetResultCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static CassandraTableGetResultCreateOrUpdateContent DeserializeCassandraTableGetResultCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new CassandraTableGetResultCreateOrUpdateContent(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource, options.Value, identity);
        }
    }
}
