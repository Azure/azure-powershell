    ...
    public partial class ServiceResourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static ServiceResourceProperties DeserializeServiceResourceProperties(JsonElement element)
        {
            if (element.TryGetProperty("serviceType", out JsonElement discriminator))
            {
                ...
                {
                    case "DataTransfer": return DataTransferServiceResourceProperties.DeserializeDataTransferServiceResourceProperties(element);
                    case "GraphAPICompute": return GraphAPIComputeServiceResourceProperties.DeserializeGraphAPIComputeServiceResourceProperties(element);
                    case "MaterializedViewsBuilder": return MaterializedViewsBuilderServiceResourceProperties.DeserializeMaterializedViewsBuilderServiceResourceProperties(element);
                    case "SqlDedicatedGateway": return SqlDedicatedGatewayServiceResourceProperties.DeserializeSqlDedicatedGatewayServiceResourceProperties(element);
                }
            }
            ...
            return new ServiceResourceProperties(Optional.ToNullable(creationTime), Optional.ToNullable(instanceSize), Optional.ToNullable(instanceCount), serviceType, Optional.ToNullable(status), additionalProperties);
        }
    }
}
