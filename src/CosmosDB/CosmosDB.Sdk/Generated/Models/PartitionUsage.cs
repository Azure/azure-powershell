...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class PartitionUsage : Usage
    {
        ...
        /// <param name="partitionId">The partition id (GUID identifier) of the usages.
        /// </param>

        /// <param name="partitionKeyRangeId">The partition key range id (integer identifier) of the usages.
        /// </param>
