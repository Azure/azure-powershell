...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class RestorableSqlResourcesGetResult : ResourceData
    {
        /// <summary> Initializes a new instance of RestorableSqlResourcesGetResult. </summary>
        internal RestorableSqlResourcesGetResult()
        {
        ...
        internal RestorableSqlResourcesGetResult(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string databaseName, IReadOnlyList<string> collectionNames) : base(id, name, resourceType, systemData)
        {
