...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class TableGetResultCreateOrUpdateContent : TrackedResourceData
    {
        /// <summary> Initializes a new instance of TableGetResultCreateOrUpdateContent. </summary>
        /// <param name="location"> The location. </param>
        /// <param name="resource"> The standard JSON format of a Table. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public TableGetResultCreateOrUpdateContent(AzureLocation location, WritableSubResource resource) : base(location)
        {
            if (resource == null)
            {
