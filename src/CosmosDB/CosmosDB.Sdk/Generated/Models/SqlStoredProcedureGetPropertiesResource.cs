...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SqlStoredProcedureGetPropertiesResource. </summary>
        /// <param name="id"> Name of the Cosmos DB SQL storedProcedure. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="id"/> is null. </exception>
        public SqlStoredProcedureGetPropertiesResource(string id) : base(id)
        {
            if (id == null)
            {
        ...
        internal SqlStoredProcedureGetPropertiesResource(string id, string body, string rid, float? ts, string etag) : base(id, body)
        {
            Rid = rid;
            Ts = ts;
            Etag = etag;
