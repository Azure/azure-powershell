...
{
    public partial class MongoDBDatabaseGetPropertiesOptions : IUtf8JsonSerializable
    {
        ...
        internal static MongoDBDatabaseGetPropertiesOptions DeserializeMongoDBDatabaseGetPropertiesOptions(JsonElement element)
        {
            ...
            return new MongoDBDatabaseGetPropertiesOptions(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
