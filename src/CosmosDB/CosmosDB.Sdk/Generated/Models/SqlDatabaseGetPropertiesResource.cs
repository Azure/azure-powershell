...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SqlDatabaseGetPropertiesResource. </summary>
        /// <param name="id"> Name of the Cosmos DB SQL database. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="id"/> is null. </exception>
        public SqlDatabaseGetPropertiesResource(string id) : base(id)
        {
            if (id == null)
            {
        ...
        internal SqlDatabaseGetPropertiesResource(string id, ResourceRestoreParameters restoreParameters, CreateMode? createMode, string colls, string users, string rid, float? ts, string etag) : base(id, restoreParameters, createMode)
        {
            Colls = colls;
            Users = users;
            Rid = rid;
