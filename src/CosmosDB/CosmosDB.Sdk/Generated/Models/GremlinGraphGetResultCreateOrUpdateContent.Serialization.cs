...
{
    public partial class GremlinGraphGetResultCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static GremlinGraphGetResultCreateOrUpdateContent DeserializeGremlinGraphGetResultCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new GremlinGraphGetResultCreateOrUpdateContent(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource, options.Value, identity);
        }
    }
}
