...
#pragma warning disable SA1649 // File name should match first type name
    internal class CosmosDBArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal CosmosDBArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal<T>(clientDiagnostics, nextLinkOperation, response, "CosmosDBArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
