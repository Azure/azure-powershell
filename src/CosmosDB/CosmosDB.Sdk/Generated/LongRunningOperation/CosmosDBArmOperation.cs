...
#pragma warning disable SA1649 // File name should match first type name
    internal class CosmosDBArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal CosmosDBArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "CosmosDBArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
