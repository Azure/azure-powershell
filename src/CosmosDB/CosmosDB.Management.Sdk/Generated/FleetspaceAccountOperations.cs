    ...
    internal partial class FleetspaceAccountOperations : Microsoft.Rest.IServiceOperations<CosmosDBManagementClient>, IFleetspaceAccountOperations
    {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<FleetspaceAccountResource>>> ListWithHttpMessagesAsync(string resourceGroupName, string fleetName, string fleetspaceName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<FleetspaceAccountResource>>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<FleetspaceAccountResource,FleetspaceAccountCreateHeaders> _response = await BeginCreateWithHttpMessagesAsync(resourceGroupName, fleetName, fleetspaceName, fleetspaceAccountName, body, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<FleetspaceAccountResource,FleetspaceAccountCreateHeaders>> BeginCreateWithHttpMessagesAsync(string resourceGroupName, string fleetName, string fleetspaceName, string fleetspaceAccountName, FleetspaceAccountResource body, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<FleetspaceAccountResource,FleetspaceAccountCreateHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<FleetspaceAccountCreateHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
            catch (Newtonsoft.Json.JsonException ex)
            {
                _httpRequest.Dispose();
