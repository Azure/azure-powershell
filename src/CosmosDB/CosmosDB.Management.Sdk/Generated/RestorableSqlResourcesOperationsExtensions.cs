...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    public static partial class RestorableSqlResourcesOperationsExtensions
    {
        ...
        /// </param>
        public static System.Collections.Generic.IEnumerable<RestorableSqlResourcesGetResult> List(this IRestorableSqlResourcesOperations operations, string location, string instanceId, string restoreLocation = default(string), string restoreTimestampInUtc = default(string))
        {
