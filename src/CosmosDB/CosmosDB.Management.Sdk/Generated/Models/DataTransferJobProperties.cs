...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class DataTransferJobProperties
    {
        ...
        public DataTransferJobProperties(DataTransferDataSourceSink source, DataTransferDataSourceSink destination, string jobName = default(string), string status = default(string), long? processedCount = default(long?), long? totalCount = default(long?), System.DateTime? lastUpdatedUtcTime = default(System.DateTime?), int? workerCount = default(int?), ErrorResponseAutoGenerated error = default(ErrorResponseAutoGenerated), string duration = default(string), string mode = default(string))
