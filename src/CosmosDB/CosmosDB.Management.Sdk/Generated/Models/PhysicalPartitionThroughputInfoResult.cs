...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the PhysicalPartitionThroughputInfoResult class.
        /// </summary>
        public PhysicalPartitionThroughputInfoResult()
        {
            CustomInit();
        }
        ...
        /// </param>
        public PhysicalPartitionThroughputInfoResult(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), ManagedServiceIdentity identity = default(ManagedServiceIdentity), PhysicalPartitionThroughputInfoResultPropertiesResource resource = default(PhysicalPartitionThroughputInfoResultPropertiesResource))
