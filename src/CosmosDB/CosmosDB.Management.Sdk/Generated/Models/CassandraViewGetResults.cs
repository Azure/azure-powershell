...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class CassandraViewGetResults : ARMResourceProperties
    {
        /// <summary>
        /// Initializes a new instance of the CassandraViewGetResults class.
        /// </summary>
        public CassandraViewGetResults()
        {
            CustomInit();
        }
        ...
        /// <param name="options">
        /// </param>
        public CassandraViewGetResults(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), ManagedServiceIdentity identity = default(ManagedServiceIdentity), CassandraViewGetPropertiesResource resource = default(CassandraViewGetPropertiesResource), CassandraViewGetPropertiesOptions options = default(CassandraViewGetPropertiesOptions))
        ...
        public CassandraViewGetPropertiesResource Resource {get; set; }

        /// <summary>
        /// Gets or sets
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.options")]
        public CassandraViewGetPropertiesOptions Options {get; set; }
        /// <summary>
        /// Validate the object.
        /// </summary>
