...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class CassandraRoleAssignmentResource : ProxyResourceAutoGenerated2
    {
        /// <summary>
        /// Initializes a new instance of the CassandraRoleAssignmentResource class.
        /// </summary>
        public CassandraRoleAssignmentResource()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CassandraRoleAssignmentResource(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string roleDefinitionId = default(string), string scope = default(string), string principalId = default(string), string provisioningState = default(string))
