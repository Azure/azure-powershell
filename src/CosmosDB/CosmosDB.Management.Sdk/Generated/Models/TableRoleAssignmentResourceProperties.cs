...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    /// </summary>
    public partial class TableRoleAssignmentResourceProperties
    {
        /// <summary>
        /// Initializes a new instance of the TableRoleAssignmentResourceProperties class.
        /// </summary>
        ...
        /// </param>
        public TableRoleAssignmentResourceProperties(string roleDefinitionId = default(string), string scope = default(string), string principalId = default(string), string provisioningState = default(string))
