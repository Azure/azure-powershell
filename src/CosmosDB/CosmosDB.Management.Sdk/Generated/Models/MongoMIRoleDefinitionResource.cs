...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class MongoMIRoleDefinitionResource : ProxyResourceAutoGenerated2
    {
        /// <summary>
        /// Initializes a new instance of the MongoMIRoleDefinitionResource class.
        /// </summary>
        ...
        /// </param>
        public MongoMIRoleDefinitionResource(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string propertiesId = default(string), string roleName = default(string), RoleDefinitionType? propertiesType = default(RoleDefinitionType?), System.Collections.Generic.IList<string> assignableScopes = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<PermissionAutoGenerated4> permissions = default(System.Collections.Generic.IList<PermissionAutoGenerated4>))
