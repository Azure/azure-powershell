...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class PeriodicModeProperties
    {
        ...
        /// <param name="backupIntervalInMinutes">An integer representing the interval in minutes between two backups
        /// </param>

        /// <param name="backupRetentionIntervalInHours">An integer representing the time (in hours) that each backup is retained
        /// </param>
        ...
        /// <summary>
        /// Gets or sets an integer representing the interval in minutes between two
        /// backups
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets an integer representing the time (in hours) that each backup
        /// is retained
        /// </summary>
        ...
        public virtual void Validate()
        {
            ...
            {
                if (this.BackupIntervalInMinutes < 0)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.InclusiveMinimum, "BackupIntervalInMinutes", 0);
                }
            }
            if (this.BackupRetentionIntervalInHours != null)
            {
                if (this.BackupRetentionIntervalInHours < 0)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.InclusiveMinimum, "BackupRetentionIntervalInHours", 0);
                }
            }
