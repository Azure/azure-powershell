...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    /// <summary>
    /// Parameters to create and update an Azure Cosmos DB Cassandra Role
    /// Definition.
    /// </summary>
    [Microsoft.Rest.Serialization.JsonTransformation]
    public partial class CassandraRoleDefinitionResource : ProxyResourceAutoGenerated2
    {
        /// <summary>
        /// Initializes a new instance of the CassandraRoleDefinitionResource class.
        /// </summary>
        public CassandraRoleDefinitionResource()
        {
            CustomInit();
        }
        ...
        /// <param name="assignableScopes">A set of fully qualified Scopes at or below which Cassandra Role
        ...
        /// </param>
        public CassandraRoleDefinitionResource(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string propertiesId = default(string), string roleName = default(string), RoleDefinitionType? propertiesType = default(RoleDefinitionType?), System.Collections.Generic.IList<string> assignableScopes = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<PermissionAutoGenerated3> permissions = default(System.Collections.Generic.IList<PermissionAutoGenerated3>))
        ...
        /// <summary>
        /// Gets or sets a set of fully qualified Scopes at or below which Cassandra
        /// Role Assignments may be created using this Role Definition. This will allow
        /// application of this Role Definition on the entire database account or any
        /// underlying Database / Collection. Must have at least one element. Scopes
        /// higher than Database account are not enforceable as assignable Scopes. Note
        /// that resources referenced in assignable Scopes need not exist.
        ...
        public System.Collections.Generic.IList<PermissionAutoGenerated3> Permissions {get; set; }
    }
}