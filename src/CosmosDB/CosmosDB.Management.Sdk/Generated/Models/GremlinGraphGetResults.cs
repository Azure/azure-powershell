...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class GremlinGraphGetResults : ARMResourceProperties
    {
        ...
        /// <param name="options">
        /// </param>
        public GremlinGraphGetResults(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), ManagedServiceIdentity identity = default(ManagedServiceIdentity), GremlinGraphGetPropertiesResource resource = default(GremlinGraphGetPropertiesResource), GremlinGraphGetPropertiesOptions options = default(GremlinGraphGetPropertiesOptions))
