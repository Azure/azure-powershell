...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class CopyJobProperties
    {
        ...
        public CopyJobProperties(BaseCopyJobProperties jobProperties, string status = default(string), long? processedCount = default(long?), long? totalCount = default(long?), System.DateTime? lastUpdatedUtcTime = default(System.DateTime?), int? workerCount = default(int?), ErrorResponse error = default(ErrorResponse), string duration = default(string), string mode = default(string))
