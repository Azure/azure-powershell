...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class RestorableSqlContainerGetResult
    {
        ...
        /// </param>
        public RestorableSqlContainerGetResult(string id = default(string), string name = default(string), string type = default(string), RestorableSqlContainerPropertiesResource resource = default(RestorableSqlContainerPropertiesResource))
