...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    /// </summary>
    public partial class MongoMIRoleAssignmentResourceProperties
    {
        /// <summary>
        /// Initializes a new instance of the MongoMIRoleAssignmentResourceProperties class.
        /// </summary>
        ...
        /// </param>
        public MongoMIRoleAssignmentResourceProperties(string roleDefinitionId = default(string), string scope = default(string), string principalId = default(string), string provisioningState = default(string))
