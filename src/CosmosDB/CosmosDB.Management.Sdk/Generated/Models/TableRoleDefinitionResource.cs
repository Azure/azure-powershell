...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class TableRoleDefinitionResource : ProxyResourceAutoGenerated2
    {
        /// <summary>
        ...
        /// </param>
        public TableRoleDefinitionResource(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string propertiesId = default(string), string roleName = default(string), RoleDefinitionType? propertiesType = default(RoleDefinitionType?), System.Collections.Generic.IList<string> assignableScopes = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<PermissionAutoGenerated> permissions = default(System.Collections.Generic.IList<PermissionAutoGenerated>))
