...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class RestorableGremlinDatabaseGetResult
    {
        ...
        /// </summary>
        public RestorableGremlinDatabaseGetResult()
        {
            CustomInit();
        }
        ...
        /// <param name="resource">The resource of an Azure Cosmos DB Gremlin database event
        /// </param>
        public RestorableGremlinDatabaseGetResult(string id = default(string), string name = default(string), string type = default(string), RestorableGremlinDatabasePropertiesResource resource = default(RestorableGremlinDatabasePropertiesResource))
        ...
        public RestorableGremlinDatabasePropertiesResource Resource {get; set; }
    }
}