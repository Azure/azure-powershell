...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class SqlUserDefinedFunctionGetResults : ARMResourceProperties
    {
        ...
        /// <param name="resource">
        /// </param>
        public SqlUserDefinedFunctionGetResults(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), ManagedServiceIdentity identity = default(ManagedServiceIdentity), SqlUserDefinedFunctionGetPropertiesResource resource = default(SqlUserDefinedFunctionGetPropertiesResource))
