...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class TableRoleDefinitionGetResults : ARMProxyResource
    {
        /// <summary>
        /// Initializes a new instance of the TableRoleDefinitionGetResults class.
        /// </summary>
        public TableRoleDefinitionGetResults()
        {
            CustomInit();
        }
        ...
        /// </param>
        public TableRoleDefinitionGetResults(string id = default(string), string name = default(string), string type = default(string), string roleName = default(string), RoleDefinitionType? propertiesType = default(RoleDefinitionType?), System.Collections.Generic.IList<string> assignableScopes = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<Permission> permissions = default(System.Collections.Generic.IList<Permission>))
