...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class CassandraKeyspaceGetResults : ARMResourceProperties
    {
        ...
        /// <param name="options">
        /// </param>
        public CassandraKeyspaceGetResults(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), CassandraKeyspaceGetPropertiesResource resource = default(CassandraKeyspaceGetPropertiesResource), CassandraKeyspaceGetPropertiesOptions options = default(CassandraKeyspaceGetPropertiesOptions))
