...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class TableGetResults : ARMResourceProperties
    {
        ...
        /// <param name="options">
        /// </param>
        public TableGetResults(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), TableGetPropertiesResource resource = default(TableGetPropertiesResource), TableGetPropertiesOptions options = default(TableGetPropertiesOptions))
