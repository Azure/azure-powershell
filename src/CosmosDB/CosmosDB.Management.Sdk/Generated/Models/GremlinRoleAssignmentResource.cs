...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class GremlinRoleAssignmentResource : ProxyResourceAutoGenerated2
    {
        /// <summary>
        /// Initializes a new instance of the GremlinRoleAssignmentResource class.
        /// </summary>
        public GremlinRoleAssignmentResource()
        {
            CustomInit();
        }
        ...
        /// which access is being granted through this Gremlin Role Assignment. Tenant
        ...
        /// </param>
        public GremlinRoleAssignmentResource(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string roleDefinitionId = default(string), string scope = default(string), string principalId = default(string), string provisioningState = default(string))
        ...
        /// through this Gremlin Role Assignment.
        /// </summary>
        ...
        /// AAD graph to which access is being granted through this Gremlin Role
