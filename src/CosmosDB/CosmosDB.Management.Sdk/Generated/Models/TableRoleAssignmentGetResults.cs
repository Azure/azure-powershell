...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class TableRoleAssignmentGetResults : ARMProxyResource
    {
        /// <summary>
        /// Initializes a new instance of the TableRoleAssignmentGetResults class.
        /// </summary>
        public TableRoleAssignmentGetResults()
        {
            CustomInit();
        }
        ...
        /// subscription.
        /// </param>
        public TableRoleAssignmentGetResults(string id = default(string), string name = default(string), string type = default(string), string roleDefinitionId = default(string), string scope = default(string), string principalId = default(string))
