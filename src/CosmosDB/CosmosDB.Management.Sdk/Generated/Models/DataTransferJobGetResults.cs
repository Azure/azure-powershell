...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class DataTransferJobGetResults : ProxyResource
    {
        /// <summary>
        ...
        public DataTransferJobGetResults(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string jobName = default(string), DataTransferDataSourceSink source = default(DataTransferDataSourceSink), DataTransferDataSourceSink destination = default(DataTransferDataSourceSink), string status = default(string), long? processedCount = default(long?), long? totalCount = default(long?), System.DateTime? lastUpdatedUtcTime = default(System.DateTime?), int? workerCount = default(int?), ErrorResponseAutoGenerated error = default(ErrorResponseAutoGenerated), string duration = default(string), string mode = default(string))
