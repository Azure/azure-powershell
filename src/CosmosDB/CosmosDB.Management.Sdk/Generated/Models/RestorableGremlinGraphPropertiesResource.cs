...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class RestorableGremlinGraphPropertiesResource
    {
        ...
        /// <param name="canUndelete">A state of this graph to identify if this graph is restorable in same
        /// account.
        /// </param>

        /// <param name="canUndeleteReason">The reason why this graph can not be restored in same account.
        /// </param>

        /// <param name="eventTimestamp">The time when this graph event happened.
        /// </param>

        /// <param name="ownerId">The name of this Gremlin graph.
        /// </param>

        /// <param name="ownerResourceId">The resource ID of this Gremlin graph.
        /// </param>
        public RestorableGremlinGraphPropertiesResource(string rid = default(string), string operationType = default(string), string canUndelete = default(string), string canUndeleteReason = default(string), string eventTimestamp = default(string), string ownerId = default(string), string ownerResourceId = default(string))
        ...
        /// <summary>
        /// Gets a state of this graph to identify if this graph is restorable in same
        /// account.
        /// </summary>
