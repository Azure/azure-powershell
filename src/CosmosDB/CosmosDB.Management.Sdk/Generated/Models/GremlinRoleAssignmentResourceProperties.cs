...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    /// </summary>
    public partial class GremlinRoleAssignmentResourceProperties
    {
        /// <summary>
        /// Initializes a new instance of the GremlinRoleAssignmentResourceProperties class.
        /// </summary>
        ...
        /// </param>
        public GremlinRoleAssignmentResourceProperties(string roleDefinitionId = default(string), string scope = default(string), string principalId = default(string), string provisioningState = default(string))
