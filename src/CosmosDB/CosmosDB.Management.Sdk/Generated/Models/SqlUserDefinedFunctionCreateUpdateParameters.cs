...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the SqlUserDefinedFunctionCreateUpdateParameters class.
        /// </summary>
        ...
        /// <param name="resource">The standard JSON format of a userDefinedFunction
        /// </param>
        ...
        /// </param>
        public SqlUserDefinedFunctionCreateUpdateParameters(SqlUserDefinedFunctionResource resource, string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), CreateUpdateOptions options = default(CreateUpdateOptions))
