...
namespace Microsoft.Azure.Commands.CosmosDB
{
    ...
    public class UpdateAzCosmosDBAccount : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            DatabaseAccountInner cosmosDBAccount = CosmosClient.DatabaseAccounts.BeginCreateOrUpdateAsync(ResourceGroupName, Name, databaseAccountCreateUpdateParameters).Result;
