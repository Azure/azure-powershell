...
namespace Microsoft.Azure.Commands.CosmosDB
{
    ...
    public class NewAzCosmosDBAccount : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            try
            {
                DatabaseAccountInner cosmosDBAccount = CosmosClient.DatabaseAccounts.BeginCreateOrUpdateAsync(ResourceGroupName, Name, databaseAccountCreateUpdateParameters).GetAwaiter().GetResult();
