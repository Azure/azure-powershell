...
namespace Microsoft.Azure.Commands.CosmosDB.Helpers
{
    internal static class Constants
    {
        ...
        public const string DisableTtlHelpMessage = "Whether or not restored account is going to have Time-To-Live disabled. Possible values include: 'Enabled', 'Disabled'";
