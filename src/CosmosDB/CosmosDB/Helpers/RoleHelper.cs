...
namespace Microsoft.Azure.Commands.CosmosDB.Helpers
{
    public static class RoleHelper
    {
        ...
        internal const string RoleDefinitionId = "id";
        internal const string RoleAssignmentId = "id";
        internal const string Scope = "scope";

        internal const string DatabaseAccount = "resourceName";
        ...
        public static string ParseToFullyQualifiedRoleDefinitionId(string id, string subscription, string resourceGroup, string databaseAccount)
        {
            ...
            {
                return string.Concat("/subscriptions/", subscription, "/resourceGroups/", resourceGroup, "/providers/Microsoft.DocumentDB/databaseAccounts/", databaseAccount, "/sqlRoleDefinitions/", id);
            }
        }
        ...
        public static string ParseToFullyQualifiedScope(string scope, string subscription, string resourceGroup, string accountName)
        {
            ...
            {
                return string.Concat("/subscriptions/", subscription, "/resourceGroups/", resourceGroup, "/providers/Microsoft.DocumentDB/databaseAccounts/", accountName, scope);
            }
        }
    }
}