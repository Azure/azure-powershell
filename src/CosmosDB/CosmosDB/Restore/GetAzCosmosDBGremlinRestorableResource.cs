...
namespace Microsoft.Azure.Commands.CosmosDB
{
    ...
    public class GetAzCosmosDBGremlinRestorableResource : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            foreach (GremlinDatabaseRestoreResource restorableGremlinResource in restorableGremlinResources)
            {
                WriteObject(new PSGremlinDatabaseToRestore(restorableGremlinResource));
            }
        }
    }
}
