...
namespace Microsoft.Azure.Commands.CosmosDB
{
    ...
    public class GetAzCosmosDBTableRestorableResource : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            IEnumerable<string> restorableTables = CosmosDBManagementClient.RestorableTableResources.ListWithHttpMessagesAsync(Location, DatabaseAccountInstanceId, RestoreLocation, dateTimeInUtc.ToString()).GetAwaiter().GetResult().Body;
            WriteObject(new PSTablesToRestore(restorableTables));
        }
    }
}
