...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBMongoMIRoleAssignment", DefaultParameterSetName = NameParameterSet), OutputType(typeof(PSMongoMIRoleAssignmentGetResults))]
    public class GetAzCosmosDBMongoMIRoleAssignment : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            else
            {
                ...
                {
                    WriteObject(new PSMongoMIRoleAssignmentGetResults(mongoMIRoleAssignment));
                }
            }
