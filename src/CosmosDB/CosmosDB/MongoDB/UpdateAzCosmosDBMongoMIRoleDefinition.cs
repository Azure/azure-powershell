...
namespace Microsoft.Azure.Commands.CosmosDB
{
    ...
    public class UpdateAzCosmosDBMongoMIRoleDefinition : AzureCosmosDBCmdletBase
    {
        ...
        {
            List<PermissionAutoGenerated4> permissions = null;
            ...
            else if (ParameterSetName.Equals(ObjectParameterSet))
            {
                ...
                Id = InputObject.Id;
                permissions = new List<PermissionAutoGenerated4>(InputObject.Permissions);
            ...
            if (DataAction != null)
            {
                permissions = new List<PermissionAutoGenerated4>
                {
                    new PermissionAutoGenerated4
                    {
            ...
            {
                permissions = new List<PermissionAutoGenerated4>(Permission.Select(p => new PermissionAutoGenerated4(dataActions: p.DataActions)));
            }
