...
{
    [Cmdlet(VerbsCommon.New, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBMongoMIRoleDefinition", DefaultParameterSetName = FieldsDataActionsParameterSet, SupportsShouldProcess = true), OutputType(typeof(PSMongoMIRoleDefinitionGetResults))]
    public class NewAzCosmosDBMongoMIRoleDefinition : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            Id = string.IsNullOrWhiteSpace(Id) ? Guid.NewGuid().ToString() : MongoMIRoleHelper.ParseToRoleDefinitionId(Id);
            ...
            if (readMongoMIRoleDefinitionGetResults != null)
            {
                throw new ConflictingResourceException(message: string.Format(ExceptionMessage.ConflictMongoMIRoleResourceId, "Definition", Id));
            }
            ...
            if (ShouldProcess(Id, "Creating a new CosmosDB MongoMI Role Definition"))
            {
