...
{
    [Cmdlet("Update", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBMongoDBDatabasePerPartitionThroughput", DefaultParameterSetName = NameParameterSet, SupportsShouldProcess = true), OutputType(typeof(PSPhysicalPartitionThroughputInfo))]
    public class UpdateAzCosmosDBMongoDBDatabasePerPartitionThroughput : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(DatabaseName, "Updating throughput"))
            {
                ...
                PhysicalPartitionThroughputInfoResult physicalPartitionThroughputInfoResult =
                    CosmosDBManagementClient.MongoDbResources.MongoDBDatabaseRedistributeThroughput(this.ResourceGroupName, this.AccountName, this.DatabaseName,
