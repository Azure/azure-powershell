...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBMongoMIRoleDefinition", DefaultParameterSetName = ResourceIdParameterSet, SupportsShouldProcess = true), OutputType(typeof(void))]
    public class RemoveAzCosmosDBMongoMIRoleDefinition : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(Id, "Deleting CosmosDB MongoMI Role Definition"))
            {
                CosmosDBManagementClient.MongoMiResources.DeleteMongoMIRoleDefinitionWithHttpMessagesAsync(ResourceGroupName, AccountName, MongoMIRoleHelper.ParseToRoleDefinitionId(Id)).GetAwaiter().GetResult();
