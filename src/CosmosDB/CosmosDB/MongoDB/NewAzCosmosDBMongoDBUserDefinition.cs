...
namespace Microsoft.Azure.Commands.CosmosDB
{
    ...
    public class NewAzCosmosDBMongoDBUserDefinition : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            {
                MongoUserDefinitionGetResults mongoUserDefinitionGetResults = CosmosDBManagementClient.MongoDbResources.CreateUpdateMongoUserDefinitionWithHttpMessagesAsync(ResourceGroupName, AccountName, Id, mongoUserDefinitionCreateUpdateParameters).GetAwaiter().GetResult().Body;
