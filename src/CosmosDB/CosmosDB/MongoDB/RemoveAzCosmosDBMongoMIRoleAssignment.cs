...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBMongoMIRoleAssignment", DefaultParameterSetName = ResourceIdParameterSet, SupportsShouldProcess = true), OutputType(typeof(void))]
    public class RemoveAzCosmosDBMongoMIRoleAssignment : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(Id, "Deleting CosmosDB MongoMI Role Assignment"))
            {
                CosmosDBManagementClient.MongoMiResources.DeleteMongoMIRoleAssignmentWithHttpMessagesAsync(ResourceGroupName, AccountName, MongoMIRoleHelper.ParseToRoleAssignmentId(Id)).GetAwaiter().GetResult();
