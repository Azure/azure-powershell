...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBCopyJob", DefaultParameterSetName = NameParameterSet), OutputType(typeof(PSCopyJobGetResults))]
    public class GetAzCosmosDBCopyJob : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            {
                CopyJobGetResults result = CosmosDBManagementClient.CopyJobs.GetWithHttpMessagesAsync(
