...
{
    [Cmdlet(VerbsLifecycle.Complete, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBCopyJob", DefaultParameterSetName = NameParameterSet, SupportsShouldProcess = true), OutputType(typeof(PSCopyJobGetResults))]
    public class CompleteAzCosmosDBCopyJob : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(JobName, "Completing CosmosDB Copy Job"))
            {
                CopyJobGetResults result = CosmosDBManagementClient.CopyJobs.CompleteWithHttpMessagesAsync(
