...
CmdletsToExport = 'Get-AzCosmosDBAccount', 'Get-AzCosmosDBAccountKey', 
               ...
               'Restore-AzCosmosDBMongoDBCollection', 'Restore-AzCosmosDBMongoDBDatabase',
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added new parameter ''EnableBurstCapacity'' to ''Update-AzCosmosDBAccount'' and ''New-AzCosmosDBAccount''.
