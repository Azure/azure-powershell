...
CmdletsToExport = 'Get-AzCosmosDBAccount', 'Get-AzCosmosDBAccountKey', 
               ...
               'Update-AzManagedCassandraDatacenter', 'New-AzCosmosDBFleet', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Regenerated the Cosmos DB management SDK against the stable 2026-03-15 API version.'
