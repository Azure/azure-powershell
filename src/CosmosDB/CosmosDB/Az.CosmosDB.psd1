...
CmdletsToExport = 'Get-AzCosmosDBSqlContainer', 'Get-AzCosmosDBSqlContainerThroughput',
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Released cmdlets to access and modify RP Resources.'
