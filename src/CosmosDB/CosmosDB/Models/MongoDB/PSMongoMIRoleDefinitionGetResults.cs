...
namespace Microsoft.Azure.Commands.CosmosDB.Models
{
    public class PSMongoMIRoleDefinitionGetResults
    {
        ...
        public PSMongoMIRoleDefinitionGetResults(MongoMIRoleDefinitionResource cassandraRoleDefinitionGetResults)
        {
            ...
            Permissions = new List<PermissionAutoGenerated4>(cassandraRoleDefinitionGetResults.Permissions.ToList());
        ...
        public IList<PermissionAutoGenerated4> Permissions { get; set; }
    }
}