...
{
    public class PSMongoMIRoleDefinitionGetResults
    {

        public PSMongoMIRoleDefinitionGetResults()
        {
        }

        public PSMongoMIRoleDefinitionGetResults(MongoMIRoleDefinitionResource cassandraRoleDefinitionGetResults)
        {
