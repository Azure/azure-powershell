...
{
    public class PSCassandraRoleDefinitionGetResults
    {

        public PSCassandraRoleDefinitionGetResults()
        {
        }

        public PSCassandraRoleDefinitionGetResults(CassandraRoleDefinitionResource cassandraRoleDefinitionGetResults)
        {
            if (cassandraRoleDefinitionGetResults == null)
            {
                return;
            }

            RoleName = cassandraRoleDefinitionGetResults.RoleName;
            Id = cassandraRoleDefinitionGetResults.Id;
            Type = cassandraRoleDefinitionGetResults.PropertiesType.ToString();
            Permissions = new List<Permission>(cassandraRoleDefinitionGetResults.Permissions.ToList());
            AssignableScopes = new List<string>(cassandraRoleDefinitionGetResults.AssignableScopes);
        }
