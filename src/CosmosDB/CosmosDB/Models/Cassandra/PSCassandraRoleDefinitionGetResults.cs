...
namespace Microsoft.Azure.Commands.CosmosDB.Models
{
    public class PSCassandraRoleDefinitionGetResults
    {
        ...
        public PSCassandraRoleDefinitionGetResults(CassandraRoleDefinitionResource cassandraRoleDefinitionGetResults)
        {
            ...
            Permissions = new List<PermissionAutoGenerated3>(cassandraRoleDefinitionGetResults.Permissions.ToList());
        ...
        public IList<PermissionAutoGenerated3> Permissions { get; set; }
    }
}