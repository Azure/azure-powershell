...
{
    public class PSTableRoleAssignmentGetResults
    {

        public PSTableRoleAssignmentGetResults()
        {
        }
        ...
        public PSTableRoleAssignmentGetResults(TableRoleAssignmentResource tableRoleAssignmentGetResults)
        {
            ...
            Id = tableRoleAssignmentGetResults.Id;
            Scope = tableRoleAssignmentGetResults.Scope;
            RoleDefinitionId = tableRoleAssignmentGetResults.RoleDefinitionId;
            PrincipalId = tableRoleAssignmentGetResults.PrincipalId;
        }
