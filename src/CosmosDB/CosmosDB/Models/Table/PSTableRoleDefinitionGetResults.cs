...
namespace Microsoft.Azure.Commands.CosmosDB.Models
{
    public class PSTableRoleDefinitionGetResults
    {
        ...
        public PSTableRoleDefinitionGetResults(TableRoleDefinitionGetResults tableRoleDefinitionGetResults)
        {
            ...
            Permissions = new List<Permission>(tableRoleDefinitionGetResults.Permissions);
