...
namespace Microsoft.Azure.Commands.CosmosDB.Models
{
    ...
    public class PSSqlContainer : PSResource
    {
        public PSSqlContainer()
        {
        }        
        
        public PSSqlContainer(SqlContainerInner sqlContainerInner)
        {
            SqlContainerId = sqlContainerInner.SqlContainerId;
            IndexingPolicy = sqlContainerInner.IndexingPolicy;
            PartitionKey = sqlContainerInner.PartitionKey;
            DefaultTtl = sqlContainerInner.DefaultTtl;
            UniqueKeyPolicy = sqlContainerInner.UniqueKeyPolicy;
            ConflictResolutionPolicy = sqlContainerInner.ConflictResolutionPolicy;
            _rid = sqlContainerInner._rid;
            _ts = sqlContainerInner._ts;
            _etag = sqlContainerInner._etag;
        }
        ...
        //
        // Summary:
        //     Gets or sets a system generated property that denotes the last updated timestamp
        //     of the resource.
        public object _ts { get; set; }
        //
        // Summary:
        //     Gets or sets a system generated property representing the resource etag required
