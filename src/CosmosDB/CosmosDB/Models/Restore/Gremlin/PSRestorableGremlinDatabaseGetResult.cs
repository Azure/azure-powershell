...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    {
        public PSRestorableGremlinDatabaseGetResult()
        {
        }

        public PSRestorableGremlinDatabaseGetResult(RestorableGremlinDatabaseGetResult restorableGremlinDatabaseGetResult)
        {
            if (restorableGremlinDatabaseGetResult == null)
            {
                return;
            }
            ...
            OwnerResourceId = restorableGremlinDatabaseGetResult.Resource.OwnerResourceId;
        }
