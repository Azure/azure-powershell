...
namespace Microsoft.Azure.Commands.CosmosDB.Models
{
    public class PSGremlinRoleDefinitionGetResults
    {
        ...
        public PSGremlinRoleDefinitionGetResults(GremlinRoleDefinitionResource gremlinRoleDefinitionGetResults)
        {
            ...
            Permissions = new List<PermissionAutoGenerated2>(gremlinRoleDefinitionGetResults.Permissions.ToList());
        ...
        public IList<PermissionAutoGenerated2> Permissions { get; set; }
    }
}