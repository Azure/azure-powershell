...
{
    public class PSGremlinRoleDefinitionGetResults
    {

        public PSGremlinRoleDefinitionGetResults()
        {
        }

        public PSGremlinRoleDefinitionGetResults(GremlinRoleDefinitionResource gremlinRoleDefinitionGetResults)
        {
            if (gremlinRoleDefinitionGetResults == null)
            {
                return;
            }

            RoleName = gremlinRoleDefinitionGetResults.RoleName;
            Id = gremlinRoleDefinitionGetResults.Id;
            Type = gremlinRoleDefinitionGetResults.PropertiesType.ToString();
            Permissions = new List<Permission>(gremlinRoleDefinitionGetResults.Permissions.ToList());
            AssignableScopes = new List<string>(gremlinRoleDefinitionGetResults.AssignableScopes);
        }
