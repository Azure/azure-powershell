...
namespace Microsoft.Azure.Commands.CosmosDB.Models
{
    ...
    public class PSDatabaseAccountListReadOnlyKeysResult : PSResource
    {
        public PSDatabaseAccountListReadOnlyKeysResult()
        {
        }        
        
        public PSDatabaseAccountListReadOnlyKeysResult(DatabaseAccountListReadOnlyKeysResultInner databaseAccountListReadOnlyKeysResultInner)
        {
