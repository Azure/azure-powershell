...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBCassandraRoleDefinition", DefaultParameterSetName = ResourceIdParameterSet, SupportsShouldProcess = true), OutputType(typeof(void))]
    public class RemoveAzCosmosDBCassandraRoleDefinition : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(Id, "Deleting CosmosDB Cassandra Role Definition"))
            {
                CosmosDBManagementClient.CassandraResources.DeleteCassandraRoleDefinitionWithHttpMessagesAsync(ResourceGroupName, AccountName, CassandraRoleHelper.ParseToRoleDefinitionId(Id)).GetAwaiter().GetResult();
