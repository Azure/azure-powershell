...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBCassandraRoleAssignment", DefaultParameterSetName = ResourceIdParameterSet, SupportsShouldProcess = true), OutputType(typeof(void))]
    public class RemoveAzCosmosDBCassandraRoleAssignment : AzureCosmosDBCmdletBase
    {
        ...
        public PSCassandraRoleAssignmentGetResults InputObject { get; set; }
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(Id, "Deleting CosmosDB Cassandra Role Assignment"))
            {
                CosmosDBManagementClient.CassandraResources.DeleteCassandraRoleAssignmentWithHttpMessagesAsync(ResourceGroupName, AccountName, CassandraRoleHelper.ParseToRoleAssignmentId(Id)).GetAwaiter().GetResult();
