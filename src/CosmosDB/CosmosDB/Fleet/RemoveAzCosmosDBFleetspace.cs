...
{
    [Cmdlet(VerbsCommon.Remove, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBFleetspace", DefaultParameterSetName = NameParameterSet, SupportsShouldProcess = true), OutputType(typeof(void), typeof(bool))]
    public class RemoveAzCosmosDBFleetspace : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(Name, "Deleting CosmosDB Fleetspace"))
            {
                CosmosDBManagementClient.Fleetspace.DeleteWithHttpMessagesAsync(ResourceGroupName, FleetName, Name).GetAwaiter().GetResult();
