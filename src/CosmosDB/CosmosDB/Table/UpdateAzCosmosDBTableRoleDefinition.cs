...
namespace Microsoft.Azure.Commands.CosmosDB
{
    ...
    public class UpdateAzCosmosDBTableRoleDefinition : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            {
                TableRoleDefinitionResource tableRoleDefinitionGetResults = CosmosDBManagementClient.TableResources.CreateUpdateTableRoleDefinitionWithHttpMessagesAsync(Id, ResourceGroupName, AccountName, tableRoleDefinitionCreateUpdateParameters).GetAwaiter().GetResult().Body;
