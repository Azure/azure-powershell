...
namespace Microsoft.Azure.Commands.CosmosDB
{
    ...
    public class UpdateAzCosmosDBTableRoleDefinition : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            try
            {
                readTableRoleDefinitionGetResults = CosmosDBManagementClient.TableResources.GetTableRoleDefinition(Id, ResourceGroupName, AccountName);
            }
            ...
            TableRoleDefinitionCreateUpdateParameters tableRoleDefinitionCreateUpdateParameters = new TableRoleDefinitionCreateUpdateParameters
            {
                ...
                Type = (RoleDefinitionType)Enum.Parse(typeof(RoleDefinitionType), Type ?? readTableRoleDefinitionGetResults.Type),
            ...
            {
                TableRoleDefinitionGetResults tableRoleDefinitionGetResults = CosmosDBManagementClient.TableResources.CreateUpdateTableRoleDefinitionWithHttpMessagesAsync(Id, ResourceGroupName, AccountName, tableRoleDefinitionCreateUpdateParameters).GetAwaiter().GetResult().Body;
