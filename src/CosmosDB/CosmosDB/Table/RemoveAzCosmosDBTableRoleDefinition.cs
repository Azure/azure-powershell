...
namespace Microsoft.Azure.Commands.CosmosDB
{
    ...
    public class RemoveAzCosmosDBTableRoleDefinition : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            {
                CosmosDBManagementClient.TableResources.DeleteTableRoleDefinitionWithHttpMessagesAsync(RoleHelper.ParseToRoleDefinitionId(Id), ResourceGroupName, AccountName).GetAwaiter().GetResult();
