...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBGarnetCluster", DefaultParameterSetName = NameParameterSet), OutputType(typeof(PSGarnetClusterResource))]
    public class GetAzCosmosDBGarnetCluster : AzureCosmosDBCmdletBase
    {
        ...
        [Parameter(Mandatory = false, ParameterSetName = NameParameterSet, HelpMessage = Constants.GarnetClusterNameHelpMessage)]
        [ValidateNotNullOrEmpty]
        ...
        public override void ExecuteCmdlet()
        {
            ...
            {
                GarnetClusterResource garnetCluster = CosmosDBManagementClient.GarnetClusters.GetWithHttpMessagesAsync(ResourceGroupName, ClusterName).GetAwaiter().GetResult().Body;
