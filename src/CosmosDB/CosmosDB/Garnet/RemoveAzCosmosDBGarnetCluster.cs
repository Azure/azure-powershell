...
{
    [Cmdlet(VerbsCommon.Remove, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBGarnetCluster", DefaultParameterSetName = NameParameterSet, SupportsShouldProcess = true), OutputType(typeof(void), typeof(bool))]
    public class RemoveAzCosmosDBGarnetCluster : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(ClusterName, "Removing Garnet Cluster."))
            {
                CosmosDBManagementClient.GarnetClusters.DeleteWithHttpMessagesAsync(ResourceGroupName, ClusterName).GetAwaiter().GetResult();
