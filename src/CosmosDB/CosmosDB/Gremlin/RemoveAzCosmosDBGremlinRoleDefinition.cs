...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBGremlinRoleDefinition", DefaultParameterSetName = ResourceIdParameterSet, SupportsShouldProcess = true), OutputType(typeof(void))]
    public class RemoveAzCosmosDBGremlinRoleDefinition : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(Id, "Deleting CosmosDB Gremlin Role Definition"))
            {
                CosmosDBManagementClient.GremlinResources.DeleteGremlinRoleDefinitionWithHttpMessagesAsync(ResourceGroupName, AccountName, GremlinRoleHelper.ParseToRoleDefinitionId(Id)).GetAwaiter().GetResult();
