...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBGremlinRoleAssignment", DefaultParameterSetName = ResourceIdParameterSet, SupportsShouldProcess = true), OutputType(typeof(void))]
    public class RemoveAzCosmosDBGremlinRoleAssignment : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(Id, "Deleting CosmosDB Gremlin Role Assignment"))
            {
                CosmosDBManagementClient.GremlinResources.DeleteGremlinRoleAssignmentWithHttpMessagesAsync(ResourceGroupName, AccountName, GremlinRoleHelper.ParseToRoleAssignmentId(Id)).GetAwaiter().GetResult();
