...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBGremlinGraphBackupInformation", DefaultParameterSetName = NameParameterSet), OutputType(typeof(PSGraphBackupInformation))]
    public class GetAzCosmosDBGremlinGraphBackupInformation : AzureCosmosDBCmdletBase
    {
        ...
        [Parameter(Mandatory = true, ParameterSetName = NameParameterSet, HelpMessage = Constants.GremlinDatabaseNameHelpMessage)]
        [ValidateNotNullOrEmpty]
        ...
        public override void ExecuteCmdlet()
        {
            ...
            BackupInformation backupInformation = CosmosDBManagementClient.GremlinResources.RetrieveContinuousBackupInformation(ResourceGroupName, AccountName, DatabaseName, Name, continuousBackupRestoreLocation);
            WriteObject(new PSGraphBackupInformation(backupInformation));
