...
Updates the CosmosDB Sql Database. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Update-AzCosmosDBSqlDatabase -AccountName myAccountName -Name myDatabaseName -ResourceGroupName myResourcegroupName -Throughput 600
```
