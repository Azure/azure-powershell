...
online version: https://learn.microsoft.com/powershell/module/az.cosmosdb/new-azcosmosdbmongoMIroledefinition
schema: 2.0.0
---
...
```
New-AzCosmosDBMongoMIRoleDefinition -ResourceGroupName <String> -AccountName <String> [-Id <String>]
...
```
New-AzCosmosDBMongoMIRoleDefinition [-Id <String>] -RoleName <String> [-Type <String>]
...
New-AzCosmosDBMongoMIRoleDefinition `
	...
	-Type CustomRole `
	-RoleName roleName `
	-DataAction "Microsoft.DocumentDB/databaseAccounts/mongoMIDatabases/containers/items/create" `
	-AssignableScope "/"
```
...
$Permission = New-AzCosmosDBPermission -DataAction "Microsoft.DocumentDB/databaseAccounts/mongoMIDatabases/containers/items/create"
New-AzCosmosDBMongoMIRoleDefinition `
	-Type CustomRole `
	-RoleName roleName `
