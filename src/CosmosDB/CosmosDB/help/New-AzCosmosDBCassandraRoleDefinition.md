...
online version: https://learn.microsoft.com/powershell/module/az.cosmosdb/new-azcosmosdbcassandraroledefinition
schema: 2.0.0
---
...
```
New-AzCosmosDBCassandraRoleDefinition -ResourceGroupName <String> -AccountName <String> [-Id <String>]
...
```
New-AzCosmosDBCassandraRoleDefinition [-Id <String>] -RoleName <String> [-Type <String>]
...
New-AzCosmosDBCassandraRoleDefinition `
	...
	-Type CustomRole `
	-RoleName roleName `
	-DataAction "Microsoft.DocumentDB/databaseAccounts/cassandraDatabases/containers/items/create" `
	-AssignableScope "/"
```

```output
RoleName         : roleName
Id               : /subscriptions/subId/resourceGroups/resourceGroupName/providers/Microsoft.DocumentDB/databaseAccounts/accountName/cassandraRoleDefinitions/id
Type             : CustomRole
...
$Permission = New-AzCosmosDBPermission -DataAction "Microsoft.DocumentDB/databaseAccounts/cassandraDatabases/containers/items/create"
New-AzCosmosDBCassandraRoleDefinition `
	-Type CustomRole `
	-RoleName roleName `
...
### Microsoft.Azure.Commands.CosmosDB.Models.PSCassandraRoleDefinitionGetResults
## OUTPUTS
