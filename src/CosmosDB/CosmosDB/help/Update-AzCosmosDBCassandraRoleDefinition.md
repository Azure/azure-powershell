...
online version: https://learn.microsoft.com/powershell/module/az.cosmosdb/update-azcosmosdbcassandraroledefinition
schema: 2.0.0
---
...
```
Update-AzCosmosDBCassandraRoleDefinition -ResourceGroupName <String> -AccountName <String> -Id <String>
...
```
Update-AzCosmosDBCassandraRoleDefinition -Id <String> [-Type <String>] [-RoleName <String>]
...
```
Update-AzCosmosDBCassandraRoleDefinition -InputObject <PSCassandraRoleDefinitionGetResults>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
