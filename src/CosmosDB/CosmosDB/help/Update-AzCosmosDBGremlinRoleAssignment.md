...
online version: https://learn.microsoft.com/powershell/module/az.cosmosdb/update-azcosmosdbgremlinroleassignment
schema: 2.0.0
---
...
```
Update-AzCosmosDBGremlinRoleAssignment -ResourceGroupName <String> -AccountName <String> -Id <String>
...
```
Update-AzCosmosDBGremlinRoleAssignment -Id <String> [-Scope <String>] [-PrincipalId <String>]
...
```
Update-AzCosmosDBGremlinRoleAssignment -InputObject <PSGremlinRoleAssignmentGetResults>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.Commands.CosmosDB.Models.PSGremlinRoleAssignmentGetResults
