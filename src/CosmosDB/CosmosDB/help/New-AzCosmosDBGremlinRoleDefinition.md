...
online version: https://learn.microsoft.com/powershell/module/az.cosmosdb/new-azcosmosdbgremlinroledefinition
schema: 2.0.0
---
...
```
New-AzCosmosDBGremlinRoleDefinition -ResourceGroupName <String> -AccountName <String> [-Id <String>]
...
```
New-AzCosmosDBGremlinRoleDefinition [-Id <String>] -RoleName <String> [-Type <String>]
