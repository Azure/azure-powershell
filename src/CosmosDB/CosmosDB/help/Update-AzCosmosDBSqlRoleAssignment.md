...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cosmosdb/update-azcosmosdbsqlroleassignment
schema: 2.0.0
---
...
```
Update-AzCosmosDBSqlRoleAssignment -ResourceGroupName <String> -AccountName <String> -RoleDefinitionId <String>
 -Id <String> [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### ByNameParameterSet
```
Update-AzCosmosDBSqlRoleAssignment -ResourceGroupName <String> -AccountName <String>
 -RoleDefinitionName <String> -Id <String> [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### ByParentObjectParameterSet
```
Update-AzCosmosDBSqlRoleAssignment -Id <String> -ParentObject <PSSqlRoleDefinitionGetResults>
...
## DESCRIPTION
Updates an existing CosmosDB Sql Role Assignment. Scope can be either fully qualified (ie. /subscriptions/subId/resourceGroups/resourceGroupName/providers/Microsoft.DocumentDB/databaseAccounts/accountName/dbs/dbName) or start with the database name (ie. /dbs/dbName). RoleDefinitionId and Id can be either fully qualified or just the Guid.
...
```yaml
Type: System.String
Parameter Sets: ByFieldsParameterSet, ByNameParameterSet, ByParentObjectParameterSet
Aliases:
