...
online version: https://learn.microsoft.com/powershell/module/az.cosmosdb/update-azcosmosdbgremlinroledefinition
schema: 2.0.0
---
...
```
Update-AzCosmosDBGremlinRoleDefinition -ResourceGroupName <String> -AccountName <String> -Id <String>
...
```
Update-AzCosmosDBGremlinRoleDefinition -Id <String> [-Type <String>] [-RoleName <String>]
...
```
Update-AzCosmosDBGremlinRoleDefinition -InputObject <PSGremlinRoleDefinitionGetResults>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Update-AzCosmosDBGremlinRoleDefinition `
	...
	-Type CustomRole `
	-RoleName roleName `
	-DataAction "Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/containers/items/create" `
	-AssignableScope "/"
```

```output
RoleName         : roleName
Id               : /subscriptions/subId/resourceGroups/resourceGroupName/providers/Microsoft.DocumentDB/databaseAccounts/accountName/gremlinRoleDefinitions/id
Type             : CustomRole
...
$Permission = New-AzCosmosDBPermission -DataAction "Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/containers/items/create"
Update-AzCosmosDBGremlinRoleDefinition `
	-Type CustomRole `
	-Id id `
	-RoleName roleName `
