...
```
Update-AzCosmosDBAccountFailoverPriority [-ResourceGroupName <String>] [-Name <String>]
 -FailoverPolicy <String[]> [-AsJob] [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
