...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cosmosdb/get-azcosmosdbmongodbrestorablecollection
schema: 2.0.0
---
...
{name}  {id}	{Type}		Microsoft.Azure.Management.CosmosDB.Models.PSRestorableMongoDBCollectionPropertiesResource
```
