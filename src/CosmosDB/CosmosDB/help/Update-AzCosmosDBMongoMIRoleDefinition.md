...
online version: https://learn.microsoft.com/powershell/module/az.cosmosdb/update-azcosmosdbmongoMIroledefinition
schema: 2.0.0
---
...
```
Update-AzCosmosDBMongoMIRoleDefinition -ResourceGroupName <String> -AccountName <String> -Id <String>
...
```
Update-AzCosmosDBMongoMIRoleDefinition -Id <String> [-Type <String>] [-RoleName <String>]
...
```
Update-AzCosmosDBMongoMIRoleDefinition -InputObject <PSMongoMIRoleDefinitionGetResults>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
