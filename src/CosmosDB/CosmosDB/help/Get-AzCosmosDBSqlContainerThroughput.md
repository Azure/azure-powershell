...
### ByNameParameterSet
```
Get-AzCosmosDBSqlContainerThroughput [-ResourceGroupName <String>] [-AccountName <String>]
...
```
Get-AzCosmosDBSqlContainerThroughput [-InputObject <PSSqlContainerGetResults>]
