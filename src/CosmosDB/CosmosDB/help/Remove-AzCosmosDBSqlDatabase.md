...
```
Remove-AzCosmosDBSqlDatabase [-AccountName <String>] [-Name <String>] [-ResourceGroupName <String>]
 [-InputObject <PSSqlDatabaseGetResults>] [-PassThru] [-AsJob] [-DefaultProfile <IAzureContextContainer>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

## DESCRIPTION
The **Remove-AzCosmosDBSqlDatabase** cmdlet deletes the CosmosDB Sql Database corresponding to the given ResourceGroupName, AccountName and DatabaseName.
