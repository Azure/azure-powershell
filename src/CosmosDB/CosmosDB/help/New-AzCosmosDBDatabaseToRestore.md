...
## DESCRIPTION
Creates a new CosmosDB DatabaseToRestore object(PSDatabaseToRestore). This returned object can be uses to specify the subset of databases and collections to restore.
