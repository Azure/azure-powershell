...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cosmosdb/remove-azmanagedcassandradatacenter
schema: 2.0.0
---
...
## DESCRIPTION
This cmdlet is used to delete a ManagedCassandra Datacenter.

## EXAMPLES

### Example 1: Delete a Managed Cassandra Datacenter
```powershell
