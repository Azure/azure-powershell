...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cosmosdb/get-azcosmosdbsqlroledefinition
schema: 2.0.0
---
...
```
Get-AzCosmosDBSqlRoleDefinition [-Id <String>] -ResourceGroupName <String> -AccountName <String>
