...
namespace Microsoft.Azure.Commands.CosmosDB
{
    ...
    public class NewAzCosmosDBSqlIndexingPolicy : AzureCosmosDBCmdletBase
    {
        ...
        [Parameter(Mandatory = false, HelpMessage = Constants.IndexingPolicyCompositeIndexHelpMessage)]
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (IncludedPath != null)
                sqlIndexingPolicy.IncludedPath = IncludedPath;
            if (ExcludedPath != null)
                sqlIndexingPolicy.ExcludedPath = ExcludedPath;
            if (CompositeIndex != null)
                sqlIndexingPolicy.CompositeIndex = CompositeIndex;
            if (SpatialIndex != null)
                sqlIndexingPolicy.SpatialIndex = SpatialIndex;
