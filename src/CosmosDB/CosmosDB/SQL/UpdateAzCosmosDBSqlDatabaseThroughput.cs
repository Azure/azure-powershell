...
namespace Microsoft.Azure.Commands.CosmosDB
{
    ...
    public class UpdateAzCosmosDBSqlDatabaseThroughput : AzureCosmosDBCmdletBase
    {
        ...
        [Parameter(Mandatory = true, HelpMessage = Constants.SqlDatabaseThroughputHelpMessage)]
        [ValidateNotNull]
