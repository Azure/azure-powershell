...
{
    [Cmdlet(VerbsCommon.New, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBSqlUniqueKeyPolicy", SupportsShouldProcess = true), OutputType(typeof(PSSqlUniqueKeyPolicy))]
