...
{
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBSqlDatabasePerPartitionThroughput", DefaultParameterSetName = NameParameterSet, SupportsShouldProcess = true), OutputType(typeof(PSPhysicalPartitionThroughputInfo))]
    public class GetAzCosmosDBSqlDatabasePerPartitionThroughput : AzureCosmosDBCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(DatabaseName, "Retrieving throughput distribution."))
            {
                ...
                PhysicalPartitionThroughputInfoResult physicalPartitionThroughputInfoResult = 
                    CosmosDBManagementClient.SqlResources.SqlDatabaseRetrieveThroughputDistribution(
