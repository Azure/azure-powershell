...
function Test-RestoreFromNewAccountCmdlets
{
  ...
  $location = "EAST US 2"
  $restoreTimestampInUtc = "2021-06-07T19:55:00+00:00"
  $cosmosDBAccountName = "restored-cosmosdb-1212"
  $sourceCosmosDBAccountName = "pitr-sql-stage-source"
  ...
  $databaseRid=$restorableSqlDatabases[1].OwnerResourceId
...
function Test-RestoreAccountCmdlets
{
  ...
  $rgName = "CosmosDBResourceGroup3668"
  $location = "EAST US 2"
  $restoreTimestampInUtc = "2021-06-08T04:30:00+00:00"
  $cosmosDBAccountName = "restored2-cosmosdb-1212-2"
  $sourceCosmosDBAccountName = "restored-cosmosdb-1212"
  $databaseName = "TestDB1";
