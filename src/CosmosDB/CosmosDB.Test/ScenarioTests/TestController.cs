...
namespace Microsoft.Azure.Commands.CosmosDB.Test.ScenarioTests.ScenarioTest
{
    public class TestController : RMTestBase
    {
        ...
        public CosmosClient CosmosDBManagementClient { get; private set; }
        ...
        private static CosmosClient GetCosmosDBManagementClient(MockContext context)
        {
            return context.GetServiceClient<CosmosClient>(TestEnvironmentFactory.GetTestEnvironment());
        }
    }
}
