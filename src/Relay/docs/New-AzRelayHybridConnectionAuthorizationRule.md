...
online version: https://learn.microsoft.com/powershell/module/az.relay/new-azrelayhybridconnectionauthorizationrule
schema: 2.0.0
---

# New-AzRelayHybridConnectionAuthorizationRule
...
```
New-AzRelayHybridConnectionAuthorizationRule -AuthorizationRuleName <String> -HybridConnectionName <String>
...
### CreateViaIdentity
```
New-AzRelayHybridConnectionAuthorizationRule -InputObject <IRelayIdentity> -Parameter <IAuthorizationRule>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzRelayHybridConnectionAuthorizationRule -InputObject <IRelayIdentity> [-Rights <AccessRights[]>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
