...
online version: https://learn.microsoft.com/powershell/module/az.relay/set-azrelaywcfrelayauthorizationrule
schema: 2.0.0
---
...
```
Set-AzRelayWcfRelayAuthorizationRule -AuthorizationRuleName <String> -NamespaceName <String>
...
```
Set-AzRelayWcfRelayAuthorizationRule -AuthorizationRuleName <String> -NamespaceName <String>
 -RelayName <String> -ResourceGroupName <String> -Parameter <IAuthorizationRule> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
