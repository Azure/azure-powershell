...
online version: https://learn.microsoft.com/powershell/module/az.relay/remove-azrelayhybridconnectionauthorizationrule
schema: 2.0.0
---

# Remove-AzRelayHybridConnectionAuthorizationRule
...
### Delete (Default)
```
Remove-AzRelayHybridConnectionAuthorizationRule -AuthorizationRuleName <String> -HybridConnectionName <String>
...
### DeleteViaIdentity
```
Remove-AzRelayHybridConnectionAuthorizationRule -InputObject <IRelayIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
