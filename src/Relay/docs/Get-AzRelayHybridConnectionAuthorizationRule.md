...
online version: https://learn.microsoft.com/powershell/module/az.relay/get-azrelayhybridconnectionauthorizationrule
schema: 2.0.0
---

# Get-AzRelayHybridConnectionAuthorizationRule
...
### List (Default)
```
Get-AzRelayHybridConnectionAuthorizationRule -HybridConnectionName <String> -NamespaceName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzRelayHybridConnectionAuthorizationRule -AuthorizationRuleName <String> -HybridConnectionName <String>
...
### GetViaIdentity
```
Get-AzRelayHybridConnectionAuthorizationRule -InputObject <IRelayIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
