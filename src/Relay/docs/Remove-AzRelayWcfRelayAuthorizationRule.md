...
online version: https://learn.microsoft.com/powershell/module/az.relay/remove-azrelaywcfrelayauthorizationrule
schema: 2.0.0
---

# Remove-AzRelayWcfRelayAuthorizationRule
...
### Delete (Default)
```
Remove-AzRelayWcfRelayAuthorizationRule -AuthorizationRuleName <String> -NamespaceName <String>
...
### DeleteViaIdentity
```
Remove-AzRelayWcfRelayAuthorizationRule -InputObject <IRelayIdentity> [-DefaultProfile <PSObject>] [-PassThru]
