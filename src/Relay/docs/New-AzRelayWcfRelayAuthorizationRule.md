...
online version: https://learn.microsoft.com/powershell/module/az.relay/new-azrelaywcfrelayauthorizationrule
schema: 2.0.0
---

# New-AzRelayWcfRelayAuthorizationRule
...
```
New-AzRelayWcfRelayAuthorizationRule -AuthorizationRuleName <String> -NamespaceName <String>
...
### CreateViaIdentity
```
New-AzRelayWcfRelayAuthorizationRule -InputObject <IRelayIdentity> -Parameter <IAuthorizationRule>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzRelayWcfRelayAuthorizationRule -InputObject <IRelayIdentity> [-Rights <AccessRights[]>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
