...
```
New-AzRelayNamespaceNetworkRuleSet -NamespaceName <String> -ResourceGroupName <String>
 -Parameter <INetworkRuleSet> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzRelayNamespaceNetworkRuleSet -InputObject <IRelayIdentity> -Parameter <INetworkRuleSet>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzRelayNamespaceNetworkRuleSet -InputObject <IRelayIdentity> [-DefaultAction <DefaultAction>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.Api20211101.INetworkRuleSet
