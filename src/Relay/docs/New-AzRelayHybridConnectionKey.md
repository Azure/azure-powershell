...
online version: https://learn.microsoft.com/powershell/module/az.relay/new-azrelayhybridconnectionkey
schema: 2.0.0
---

# New-AzRelayHybridConnectionKey
...
```
New-AzRelayHybridConnectionKey -AuthorizationRuleName <String> -HybridConnectionName <String>
...
```
New-AzRelayHybridConnectionKey -InputObject <IRelayIdentity> -Parameter <IRegenerateAccessKeyParameters>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RegenerateViaIdentityExpanded
```
New-AzRelayHybridConnectionKey -InputObject <IRelayIdentity> -KeyType <KeyType> [-Key <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.Api20211101.IRegenerateAccessKeyParameters
