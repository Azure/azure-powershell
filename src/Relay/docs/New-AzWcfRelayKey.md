...
online version: https://learn.microsoft.com/powershell/module/az.relay/new-azwcfrelaykey
schema: 2.0.0
---
...
```
New-AzWcfRelayKey -AuthorizationRuleName <String> -NamespaceName <String> -RelayName <String>
...
```
New-AzWcfRelayKey -InputObject <IRelayIdentity> -Parameter <IRegenerateAccessKeyParameters>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RegenerateViaIdentityExpanded
```
New-AzWcfRelayKey -InputObject <IRelayIdentity> -KeyType <KeyType> [-Key <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
