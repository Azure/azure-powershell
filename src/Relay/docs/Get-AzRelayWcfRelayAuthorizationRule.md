...
online version: https://learn.microsoft.com/powershell/module/az.relay/get-azrelaywcfrelayauthorizationrule
schema: 2.0.0
---

# Get-AzRelayWcfRelayAuthorizationRule
...
### List (Default)
```
Get-AzRelayWcfRelayAuthorizationRule -NamespaceName <String> -RelayName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzRelayWcfRelayAuthorizationRule -AuthorizationRuleName <String> -NamespaceName <String>
...
### GetViaIdentity
```
Get-AzRelayWcfRelayAuthorizationRule -InputObject <IRelayIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
