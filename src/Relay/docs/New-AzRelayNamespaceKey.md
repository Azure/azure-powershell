...
online version: https://learn.microsoft.com/powershell/module/az.relay/new-azrelaynamespacekey
schema: 2.0.0
---

# New-AzRelayNamespaceKey
...
```
New-AzRelayNamespaceKey -AuthorizationRuleName <String> -NamespaceName <String> -ResourceGroupName <String>
...
```
New-AzRelayNamespaceKey -InputObject <IRelayIdentity> -Parameter <IRegenerateAccessKeyParameters>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RegenerateViaIdentityExpanded
```
New-AzRelayNamespaceKey -InputObject <IRelayIdentity> -KeyType <KeyType> [-Key <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
