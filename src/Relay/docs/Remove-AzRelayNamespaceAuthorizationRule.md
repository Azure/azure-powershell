...
online version: https://learn.microsoft.com/powershell/module/az.relay/remove-azrelaynamespaceauthorizationrule
schema: 2.0.0
---

# Remove-AzRelayNamespaceAuthorizationRule
...
### Delete (Default)
```
Remove-AzRelayNamespaceAuthorizationRule -AuthorizationRuleName <String> -NamespaceName <String>
...
### DeleteViaIdentity
```
Remove-AzRelayNamespaceAuthorizationRule -InputObject <IRelayIdentity> [-DefaultProfile <PSObject>]
