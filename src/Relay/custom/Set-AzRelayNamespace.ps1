...
.Link
https://learn.microsoft.com/powershell/module/az.relay/set-azrelaynamespace
#>
function Set-AzRelayNamespace {
...
process {
    try {
        Az.Relay.internal\Update-AzRelayNamespace @PSBoundParameters
    } catch {
