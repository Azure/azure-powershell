...
namespace Microsoft.Azure.PowerShell.Cmdlets.Relay.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Relay/namespaces/{namespaceName}/wcfRelays/{relayName}/authorizationRules"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Relay.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRelayAuthorizationRule_List2")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Relay.Description(@"Authorization rules for a WCF relay.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Relay.Generated]
    public partial class GetAzRelayAuthorizationRule_List2 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRelayAuthorizationRule_List2" /> cmdlet class.
        /// </summary>
        public GetAzRelayAuthorizationRule_List2()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AuthorizationRuleList2(ResourceGroupName, Namespace, WcfRelay, SubscriptionId, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Namespace=Namespace,WcfRelay=WcfRelay,SubscriptionId=SubscriptionId})
                    {
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.AuthorizationRuleList2_Call(requestMessage, onOk, this, Pipeline);
                        }
                    }
                }
            }
