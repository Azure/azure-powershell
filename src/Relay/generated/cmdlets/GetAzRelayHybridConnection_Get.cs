...
namespace Microsoft.Azure.PowerShell.Cmdlets.Relay.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRelayHybridConnection_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.HybridConnectionsGet(ResourceGroupName, Namespace, Name, SubscriptionId, onOk, onDefault, this, Pipeline);
