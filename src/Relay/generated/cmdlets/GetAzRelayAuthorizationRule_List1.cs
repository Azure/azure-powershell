...
namespace Microsoft.Azure.PowerShell.Cmdlets.Relay.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Relay/namespaces/{namespaceName}/hybridConnections/{hybridConnectionName}/authorizationRules"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Relay.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRelayAuthorizationRule_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Relay.Description(@"Authorization rules for a hybrid connection.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Relay.Generated]
    public partial class GetAzRelayAuthorizationRule_List1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRelayAuthorizationRule_List1" /> cmdlet class.
        /// </summary>
        public GetAzRelayAuthorizationRule_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AuthorizationRuleList1(ResourceGroupName, Namespace, HybridConnection, SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Namespace=Namespace,HybridConnection=HybridConnection,SubscriptionId=SubscriptionId})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, Namespace=Namespace, HybridConnection=HybridConnection, SubscriptionId=SubscriptionId })
                    {
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.AuthorizationRuleList1_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
