namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210
{
    ...
    public partial class DisableProtectionInputProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.IDisableProtectionInputProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.IDisableProtectionInputPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.IDisableProtectionProviderSpecificInput Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.IDisableProtectionInputPropertiesInternal.ReplicationProviderInput { get => (this._replicationProviderInput = this._replicationProviderInput ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.DisableProtectionProviderSpecificInput()); set { {_replicationProviderInput = value;} } }

        /// <summary>Backing field for <see cref="ReplicationProviderInput" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.IDisableProtectionProviderSpecificInput _replicationProviderInput;

        /// <summary>Replication provider specific input.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.IDisableProtectionProviderSpecificInput ReplicationProviderInput { get => (this._replicationProviderInput = this._replicationProviderInput ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.DisableProtectionProviderSpecificInput()); set => this._replicationProviderInput = value; }
