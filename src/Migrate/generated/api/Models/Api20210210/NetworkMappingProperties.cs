namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210
{
    ...
    public partial class NetworkMappingProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.INetworkMappingPropertiesInternal
    {

        /// <summary>Backing field for <see cref="FabricSpecificSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.INetworkMappingFabricSpecificSettings _fabricSpecificSetting;

        /// <summary>The fabric specific settings.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.INetworkMappingFabricSpecificSettings FabricSpecificSetting { get => (this._fabricSpecificSetting = this._fabricSpecificSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.NetworkMappingFabricSpecificSettings()); set => this._fabricSpecificSetting = value; }

        /// <summary>Gets the Instance type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public string FabricSpecificSettingInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.INetworkMappingFabricSpecificSettingsInternal)FabricSpecificSetting).InstanceType; }

        /// <summary>Internal Acessors for FabricSpecificSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.INetworkMappingFabricSpecificSettings Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.INetworkMappingPropertiesInternal.FabricSpecificSetting { get => (this._fabricSpecificSetting = this._fabricSpecificSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.NetworkMappingFabricSpecificSettings()); set { {_fabricSpecificSetting = value;} } }

        /// <summary>Internal Acessors for FabricSpecificSettingInstanceType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.INetworkMappingPropertiesInternal.FabricSpecificSettingInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.INetworkMappingFabricSpecificSettingsInternal)FabricSpecificSetting).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.INetworkMappingFabricSpecificSettingsInternal)FabricSpecificSetting).InstanceType = value; }
