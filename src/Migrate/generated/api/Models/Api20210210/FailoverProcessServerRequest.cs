namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210
{
    ...
    public partial class FailoverProcessServerRequest :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.IFailoverProcessServerRequest,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.IFailoverProcessServerRequestInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.IFailoverProcessServerRequestProperties Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.IFailoverProcessServerRequestInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.FailoverProcessServerRequestProperties()); set { {_property = value;} } }

        /// <summary>Backing field for <see cref="Property" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.IFailoverProcessServerRequestProperties _property;

        /// <summary>The properties of the PS Failover request.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.IFailoverProcessServerRequestProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.FailoverProcessServerRequestProperties()); set => this._property = value; }
...

    {
        ...
        string ContainerName { get; set; }
        /// <summary>The properties of the PS Failover request.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.IFailoverProcessServerRequestProperties Property { get; set; }
        /// <summary>The source process server.</summary>
        string SourceProcessServerId { get; set; }
        /// <summary>The new process server.</summary>
        string TargetProcessServerId { get; set; }
