...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501
{
    ...
    public partial class InMageEnableProtectionInput :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IInMageEnableProtectionInput,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IInMageEnableProtectionInputInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IValidates
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IInMageDiskExclusionInput _diskExclusionInput;

        /// <summary>The enable disk exclusion input.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IInMageDiskExclusionInput DiskExclusionInput { get => (this._diskExclusionInput = this._diskExclusionInput ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.InMageDiskExclusionInput()); set => this._diskExclusionInput = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IEnableProtectionProviderSpecificInput
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IInMageDiskSignatureExclusionOptions) })]
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IInMageDiskSignatureExclusionOptions[] DiskExclusionInputDiskSignatureOption { get; set; }
        /// <summary>The volume label based option for disk exclusion.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IInMageVolumeExclusionOptions) })]
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IInMageVolumeExclusionOptions[] DiskExclusionInputVolumeOption { get; set; }
        /// <summary>The disks to include list.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IEnableProtectionProviderSpecificInputInternal
    {
        ...
        string DatastoreName { get; set; }
        /// <summary>The enable disk exclusion input.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IInMageDiskExclusionInput DiskExclusionInput { get; set; }
        /// <summary>The guest disk signature based option for disk exclusion.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IInMageDiskSignatureExclusionOptions[] DiskExclusionInputDiskSignatureOption { get; set; }
        /// <summary>The volume label based option for disk exclusion.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IInMageVolumeExclusionOptions[] DiskExclusionInputVolumeOption { get; set; }
