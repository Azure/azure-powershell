...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501
{
    ...
    public partial class CurrentJobDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.ICurrentJobDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.ICurrentJobDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.ICurrentJobDetailsInternal.JobId { get => this._jobId; set { {_jobId = value;} } }

        /// <summary>Internal Acessors for JobName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.ICurrentJobDetailsInternal.JobName { get => this._jobName; set { {_jobName = value;} } }

        /// <summary>Internal Acessors for StartTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.ICurrentJobDetailsInternal.StartTime { get => this._startTime; set { {_startTime = value;} } }
