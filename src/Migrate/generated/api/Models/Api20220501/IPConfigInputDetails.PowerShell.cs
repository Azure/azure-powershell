...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501
{
    ...
    public partial class IPConfigInputDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="global::System.Collections.IDictionary" /> into an instance of <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IPConfigInputDetails"
        /// />.
        /// </summary>
        /// <param name="content">The global::System.Collections.IDictionary content that should be used.</param>
        /// <returns>
        /// an instance of <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IIPConfigInputDetails" />.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IIPConfigInputDetails DeserializeFromDictionary(global::System.Collections.IDictionary content)
        {
            return new IPConfigInputDetails(content);
        }

        /// <summary>
        /// Deserializes a <see cref="global::System.Management.Automation.PSObject" /> into an instance of <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IPConfigInputDetails"
        /// />.
        /// </summary>
        /// <param name="content">The global::System.Management.Automation.PSObject content that should be used.</param>
        /// <returns>
        /// an instance of <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IIPConfigInputDetails" />.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IIPConfigInputDetails DeserializeFromPSObject(global::System.Management.Automation.PSObject content)
        {
            return new IPConfigInputDetails(content);
        }
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IIPConfigInputDetails FromJsonString(string jsonText) => FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode.Parse(jsonText));

        /// <summary>
        /// Deserializes a <see cref="global::System.Collections.IDictionary" /> into a new instance of <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IPConfigInputDetails"
        /// />.
        /// </summary>
        /// <param name="content">The global::System.Collections.IDictionary content that should be used.</param>
        internal IPConfigInputDetails(global::System.Collections.IDictionary content)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IIPConfigInputDetailsInternal)this).IPConfigName = (string) content.GetValueForProperty("IPConfigName",((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IIPConfigInputDetailsInternal)this).IPConfigName, global::System.Convert.ToString);
            }
            if (content.Contains("IsPrimary"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IIPConfigInputDetailsInternal)this).IsPrimary = (bool?) content.GetValueForProperty("IsPrimary",((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IIPConfigInputDetailsInternal)this).IsPrimary, (__y)=> (bool) global::System.Convert.ChangeType(__y, typeof(bool)));
            }
            if (content.Contains("IsSeletedForFailover"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IIPConfigInputDetailsInternal)this).IsSeletedForFailover = (bool?) content.GetValueForProperty("IsSeletedForFailover",((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IIPConfigInputDetailsInternal)this).IsSeletedForFailover, (__y)=> (bool) global::System.Convert.ChangeType(__y, typeof(bool)));
            }
