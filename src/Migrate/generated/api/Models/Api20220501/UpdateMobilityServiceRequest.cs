...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501
{
    ...
    public partial class UpdateMobilityServiceRequest :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IUpdateMobilityServiceRequest,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IUpdateMobilityServiceRequestInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IUpdateMobilityServiceRequestProperties _property;

        /// <summary>The properties of the update mobility service request.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IUpdateMobilityServiceRequestProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.UpdateMobilityServiceRequestProperties()); set => this._property = value; }
    ...
    {
        /// <summary>The properties of the update mobility service request.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IUpdateMobilityServiceRequestProperties Property { get; set; }
        /// <summary>The CS run as account Id.</summary>
        string RunAsAccountId { get; set; }
