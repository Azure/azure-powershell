...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501
{
    ...
    public partial class FabricProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IFabricProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IFabricPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IFabricSpecificDetails _customDetail;

        /// <summary>Fabric specific settings.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IFabricSpecificDetails CustomDetail { get => (this._customDetail = this._customDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.FabricSpecificDetails()); set => this._customDetail = value; }

        /// <summary>Backing field for <see cref="EncryptionDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IEncryptionDetails _encryptionDetail;

        /// <summary>Encryption details for the fabric.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IEncryptionDetails EncryptionDetail { get => (this._encryptionDetail = this._encryptionDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.EncryptionDetails()); set => this._encryptionDetail = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IEncryptionDetails _rolloverEncryptionDetail;
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IFabricSpecificDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IFabricSpecificDetails CustomDetail { get; set; }
        /// <summary>Encryption details for the fabric.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IEncryptionDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IEncryptionDetails EncryptionDetail { get; set; }
        /// <summary>Friendly name of the fabric.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IEncryptionDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IEncryptionDetails RolloverEncryptionDetail { get; set; }
