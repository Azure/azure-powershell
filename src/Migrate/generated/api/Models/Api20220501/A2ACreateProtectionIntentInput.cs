...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501
{
    ...
    public partial class A2ACreateProtectionIntentInput :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IA2ACreateProtectionIntentInput,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IA2ACreateProtectionIntentInputInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.ICreateProtectionIntentProviderSpecificDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.ICreateProtectionIntentProviderSpecificDetails __createProtectionIntentProviderSpecificDetails = new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.CreateProtectionIntentProviderSpecificDetails();
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IDiskEncryptionInfo _diskEncryptionInfo;

        /// <summary>The recovery disk encryption information (for two pass flows).</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IDiskEncryptionInfo DiskEncryptionInfo { get => (this._diskEncryptionInfo = this._diskEncryptionInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.DiskEncryptionInfo()); set => this._diskEncryptionInfo = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IStorageAccountCustomDetails _recoveryBootDiagStorageAccount;

        /// <summary>The boot diagnostic storage account.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IStorageAccountCustomDetails RecoveryBootDiagStorageAccount { get => (this._recoveryBootDiagStorageAccount = this._recoveryBootDiagStorageAccount ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.StorageAccountCustomDetails()); set => this._recoveryBootDiagStorageAccount = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IRecoveryVirtualNetworkCustomDetails _recoveryVirtualNetworkCustomInput;

        /// <summary>The recovery virtual network input.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IRecoveryVirtualNetworkCustomDetails RecoveryVirtualNetworkCustomInput { get => (this._recoveryVirtualNetworkCustomInput = this._recoveryVirtualNetworkCustomInput ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.RecoveryVirtualNetworkCustomDetails()); set => this._recoveryVirtualNetworkCustomInput = value; }

        /// <summary>The class type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public string RecoveryVirtualNetworkCustomInputResourceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IRecoveryVirtualNetworkCustomDetailsInternal)RecoveryVirtualNetworkCustomInput).ResourceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IRecoveryVirtualNetworkCustomDetailsInternal)RecoveryVirtualNetworkCustomInput).ResourceType = value ?? null; }

        /// <summary>Backing field for <see cref="VMDisk" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IA2AProtectionIntentDiskInputDetails[] _vMDisk;

        /// <summary>The list of vm disk inputs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IA2AProtectionIntentDiskInputDetails[] VMDisk { get => this._vMDisk; set => this._vMDisk = value; }

        /// <summary>Backing field for <see cref="VMManagedDisk" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IA2AProtectionIntentManagedDiskInputDetails[] _vMManagedDisk;

        /// <summary>The list of vm managed disk inputs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IA2AProtectionIntentManagedDiskInputDetails[] VMManagedDisk { get => this._vMManagedDisk; set => this._vMManagedDisk = value; }
    ...
    public partial interface IA2ACreateProtectionIntentInput :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.ICreateProtectionIntentProviderSpecificDetails
    {
        /// <summary>A value indicating whether the auto update is enabled.</summary>
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IA2AProtectionIntentDiskInputDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IA2AProtectionIntentDiskInputDetails[] VMDisk { get; set; }
        /// <summary>The list of vm managed disk inputs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IA2AProtectionIntentManagedDiskInputDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IA2AProtectionIntentManagedDiskInputDetails[] VMManagedDisk { get; set; }

    }
    /// A2A create protection intent input.
    internal partial interface IA2ACreateProtectionIntentInputInternal :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.ICreateProtectionIntentProviderSpecificDetailsInternal
    {
        /// <summary>A value indicating whether the auto update is enabled.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.AgentAutoUpdateStatus? AgentAutoUpdateStatus { get; set; }
        /// <summary>A value indicating whether the auto protection is enabled.</summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.AutomationAccountAuthenticationType? AutomationAccountAuthenticationType { get; set; }
        /// <summary>The recovery disk encryption information (for two pass flows).</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IDiskEncryptionInfo DiskEncryptionInfo { get; set; }
        /// <summary>The recovery KeyVault reference for secret.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IDiskEncryptionKeyInfo DiskEncryptionInfoDiskEncryptionKeyInfo { get; set; }
        /// <summary>The recovery KeyVault reference for key.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IKeyEncryptionKeyInfo DiskEncryptionInfoKeyEncryptionKeyInfo { get; set; }
        /// <summary>The KeyVault resource ARM id for secret.</summary>
        string DiskEncryptionKeyInfoKeyVaultResourceArmId { get; set; }
        /// <summary>The secret url / identifier.</summary>
        string DiskEncryptionKeyInfoSecretIdentifier { get; set; }
        ...
        string PrimaryLocation { get; set; }
        /// <summary>The primary staging storage account input.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IStorageAccountCustomDetails PrimaryStagingStorageAccountCustomInput { get; set; }
        /// <summary>The class type.</summary>
        string PrimaryStagingStorageAccountCustomInputResourceType { get; set; }
        /// <summary>The protection profile custom inputs.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IProtectionProfileCustomDetails ProtectionProfileCustomInput { get; set; }
        /// <summary>The class type.</summary>
        string ProtectionProfileCustomInputResourceType { get; set; }
        /// <summary>The recovery availability set input.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IRecoveryAvailabilitySetCustomDetails RecoveryAvailabilitySetCustomInput { get; set; }
        /// <summary>The class type.</summary>
        string RecoveryAvailabilitySetCustomInputResourceType { get; set; }
        /// <summary>The recovery availability type of the virtual machine.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.A2ARecoveryAvailabilityType RecoveryAvailabilityType { get; set; }
        ...
        string RecoveryAvailabilityZone { get; set; }
        /// <summary>The boot diagnostic storage account.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IStorageAccountCustomDetails RecoveryBootDiagStorageAccount { get; set; }
        /// <summary>The class type.</summary>
        string RecoveryBootDiagStorageAccountResourceType { get; set; }
        /// <summary>The recovery location for the virtual machine.</summary>
        string RecoveryLocation { get; set; }
        /// <summary>The recovery proximity placement group custom input.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IRecoveryProximityPlacementGroupCustomDetails RecoveryProximityPlacementGroupCustomInput { get; set; }
        /// <summary>The class type.</summary>
        string RecoveryProximityPlacementGroupCustomInputResourceType { get; set; }
        /// <summary>The recovery resource group Id. Valid for V2 scenarios.</summary>
        string RecoveryResourceGroupId { get; set; }
        ...
        string RecoverySubscriptionId { get; set; }
        /// <summary>The recovery virtual network input.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IRecoveryVirtualNetworkCustomDetails RecoveryVirtualNetworkCustomInput { get; set; }
        /// <summary>The class type.</summary>
        string RecoveryVirtualNetworkCustomInputResourceType { get; set; }
        /// <summary>The list of vm disk inputs.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IA2AProtectionIntentDiskInputDetails[] VMDisk { get; set; }
