...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501
{
    ...
    public partial class FabricCreationInputProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IFabricCreationInputProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IFabricCreationInputPropertiesInternal
    {

        /// <summary>Backing field for <see cref="CustomDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IFabricSpecificCreationInput _customDetail;

        /// <summary>Fabric provider specific creation input.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IFabricSpecificCreationInput CustomDetail { get => (this._customDetail = this._customDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.FabricSpecificCreationInput()); set => this._customDetail = value; }

        /// <summary>Gets the class type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public string CustomDetailInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IFabricSpecificCreationInputInternal)CustomDetail).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IFabricSpecificCreationInputInternal)CustomDetail).InstanceType = value ?? null; }
    ...
    {
        /// <summary>Fabric provider specific creation input.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IFabricSpecificCreationInput CustomDetail { get; set; }
        /// <summary>Gets the class type.</summary>
        string CustomDetailInstanceType { get; set; }
