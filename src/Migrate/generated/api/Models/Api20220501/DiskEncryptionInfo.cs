...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IDiskEncryptionInfoInternal
    {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public string DiskEncryptionKeyInfoSecretIdentifier { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IDiskEncryptionKeyInfoInternal)DiskEncryptionKeyInfo).SecretIdentifier; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IDiskEncryptionKeyInfoInternal)DiskEncryptionKeyInfo).SecretIdentifier = value ?? null; }

        /// <summary>Backing field for <see cref="KeyEncryptionKeyInfo" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IKeyEncryptionKeyInfo _keyEncryptionKeyInfo;

        /// <summary>The recovery KeyVault reference for key.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IKeyEncryptionKeyInfo KeyEncryptionKeyInfo { get => (this._keyEncryptionKeyInfo = this._keyEncryptionKeyInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.KeyEncryptionKeyInfo()); set => this._keyEncryptionKeyInfo = value; }

        /// <summary>The key URL / identifier.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public string KeyEncryptionKeyInfoKeyIdentifier { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IKeyEncryptionKeyInfoInternal)KeyEncryptionKeyInfo).KeyIdentifier; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IKeyEncryptionKeyInfoInternal)KeyEncryptionKeyInfo).KeyIdentifier = value ?? null; }

        /// <summary>The KeyVault resource ARM Id for key.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public string KeyEncryptionKeyInfoKeyVaultResourceArmId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IKeyEncryptionKeyInfoInternal)KeyEncryptionKeyInfo).KeyVaultResourceArmId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IKeyEncryptionKeyInfoInternal)KeyEncryptionKeyInfo).KeyVaultResourceArmId = value ?? null; }
    ...
    {
        /// <summary>The recovery KeyVault reference for secret.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IDiskEncryptionKeyInfo DiskEncryptionKeyInfo { get; set; }
        /// <summary>The KeyVault resource ARM id for secret.</summary>
        string DiskEncryptionKeyInfoKeyVaultResourceArmId { get; set; }
        /// <summary>The secret url / identifier.</summary>
        string DiskEncryptionKeyInfoSecretIdentifier { get; set; }
        /// <summary>The recovery KeyVault reference for key.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IKeyEncryptionKeyInfo KeyEncryptionKeyInfo { get; set; }
        /// <summary>The key URL / identifier.</summary>
        string KeyEncryptionKeyInfoKeyIdentifier { get; set; }
        /// <summary>The KeyVault resource ARM Id for key.</summary>
        string KeyEncryptionKeyInfoKeyVaultResourceArmId { get; set; }
