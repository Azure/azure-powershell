...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501
{
    ...
    public partial class VaultHealthProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IVaultHealthProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IVaultHealthProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IVaultHealthProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
        ...
        internal VaultHealthProperties(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_protectedItemsHealth = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("protectedItemsHealth"), out var __jsonProtectedItemsHealth) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.ResourceHealthSummary.FromJson(__jsonProtectedItemsHealth) : ProtectedItemsHealth;}
            {_fabricsHealth = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("fabricsHealth"), out var __jsonFabricsHealth) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.ResourceHealthSummary.FromJson(__jsonFabricsHealth) : FabricsHealth;}
            {_containersHealth = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("containersHealth"), out var __jsonContainersHealth) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.ResourceHealthSummary.FromJson(__jsonContainersHealth) : ContainersHealth;}
            {_vaultError = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("vaultErrors"), out var __jsonVaultErrors) ? If( __jsonVaultErrors as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IHealthError[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IHealthError) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.HealthError.FromJson(__u) )) ))() : null : VaultError;}
            AfterFromJson(json);
        }
    }
}