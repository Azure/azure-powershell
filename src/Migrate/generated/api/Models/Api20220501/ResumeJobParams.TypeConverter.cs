...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501
{
    ...
    public partial class ResumeJobParamsTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="ResumeJobParams" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IResumeJobParams ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20220501.IResumeJobParams).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
