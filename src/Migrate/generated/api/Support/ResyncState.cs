...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.ResyncState None = @"None";

        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.ResyncState PreparedForResynchronization = @"PreparedForResynchronization";

        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.ResyncState StartedResynchronization = @"StartedResynchronization";
        ...
        {
            return new ResyncState(System.Convert.ToString(value));
        }

        /// <summary>Compares values of enum type ResyncState</summary>
        /// <param name="e">the value to compare against this instance.</param>
        /// <returns><c>true</c> if the two instances are equal to the same value</returns>
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.ResyncState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.ResyncState e)
        {
            return e._value;
        }
