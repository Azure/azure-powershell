...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzMigrateReplicationProtectionIntent_CreateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class NewAzMigrateReplicationProtectionIntent_CreateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.ICreateProtectionIntentInput _inputBody= new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.CreateProtectionIntentInput();

        /// <summary>Create protection intent input.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.ICreateProtectionIntentInput InputBody { get => this._inputBody; set => this._inputBody = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzMigrateReplicationProtectionIntent_CreateViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public NewAzMigrateReplicationProtectionIntent_CreateViaIdentityExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ReplicationProtectionIntentsCreateViaIdentity(InputObject.Id, InputBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ReplicationProtectionIntentsCreate(InputObject.ResourceName ?? null, InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.IntentObjectName ?? null, InputBody, onOk, this, Pipeline);
                    }
