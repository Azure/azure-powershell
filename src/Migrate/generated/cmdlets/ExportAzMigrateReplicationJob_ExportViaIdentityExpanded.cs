...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ReplicationJobs_Export=>POST:"/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationJobs/export"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Export, @"AzMigrateReplicationJob_ExportViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20180110.IJob))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Description(@"The operation to export the details of the Azure Site Recovery jobs of the vault.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Generated]
    public partial class ExportAzMigrateReplicationJob_ExportViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The type of objects.")]
        ...
        public string AffectedObjectType { get => JobQueryParameterBody.AffectedObjectType ?? null; set => JobQueryParameterBody.AffectedObjectType = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Date time to get jobs up to.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string EndTime { get => JobQueryParameterBody.EndTime ?? null; set => JobQueryParameterBody.EndTime = value; }

        /// <summary>The Id of the fabric to search jobs under.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The Id of the fabric to search jobs under.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string FabricId { get => JobQueryParameterBody.FabricId ?? null; set => JobQueryParameterBody.FabricId = value; }
        ...
        /// <summary>Backing field for <see cref="JobQueryParameterBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20180110.IJobQueryParameter _jobQueryParameterBody= new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20180110.JobQueryParameter();

        /// <summary>Query parameter to enumerate jobs.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20180110.IJobQueryParameter JobQueryParameterBody { get => this._jobQueryParameterBody; set => this._jobQueryParameterBody = value; }

        /// <summary>The states of the job to be filtered can be in.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The states of the job to be filtered can be in.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string JobStatus { get => JobQueryParameterBody.JobStatus ?? null; set => JobQueryParameterBody.JobStatus = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Date time to get jobs from.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string StartTime { get => JobQueryParameterBody.StartTime ?? null; set => JobQueryParameterBody.StartTime = value; }
        ...
        /// <returns>a duplicate instance of ExportAzMigrateReplicationJob_ExportViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets.ExportAzMigrateReplicationJob_ExportViaIdentityExpanded Clone()
        {
            var clone = new ExportAzMigrateReplicationJob_ExportViaIdentityExpanded();
            ...
            clone.JobQueryParameterBody = this.JobQueryParameterBody;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ExportAzMigrateReplicationJob_ExportViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public ExportAzMigrateReplicationJob_ExportViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ReplicationJobsExport' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ReplicationJobsExportViaIdentity(InputObject.Id, JobQueryParameterBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ReplicationJobsExport(InputObject.ResourceName ?? null, InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, JobQueryParameterBody, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=JobQueryParameterBody})
                    {
