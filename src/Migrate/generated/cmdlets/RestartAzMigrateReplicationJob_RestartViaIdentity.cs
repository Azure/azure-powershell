...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ReplicationJobs_Restart=>POST:"/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationJobs/{jobName}/restart"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Restart, @"AzMigrateReplicationJob_RestartViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20180110.IJob))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Description(@"The operation to restart an Azure Site Recovery job.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Generated]
    public partial class RestartAzMigrateReplicationJob_RestartViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RestartAzMigrateReplicationJob_RestartViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets.RestartAzMigrateReplicationJob_RestartViaIdentity Clone()
        {
            var clone = new RestartAzMigrateReplicationJob_RestartViaIdentity();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ReplicationJobsRestart' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ReplicationJobsRestartViaIdentity(InputObject.Id, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ReplicationJobsRestart(InputObject.ResourceName ?? null, InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.JobName ?? null, onOk, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RestartAzMigrateReplicationJob_RestartViaIdentity" /> cmdlet class.
        /// </summary>
        public RestartAzMigrateReplicationJob_RestartViaIdentity()
        {
