...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzMigrateReplicationVaultSetting_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzMigrateReplicationVaultSetting_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.IVaultSettingCreationInput _input;

        /// <summary>Input to create vault setting.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Input to create vault setting.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Input to create vault setting.",
        SerializedName = @"input",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.IVaultSettingCreationInput) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210210.IVaultSettingCreationInput Input { get => this._input; set => this._input = value; }
        ...
        /// <returns>a duplicate instance of NewAzMigrateReplicationVaultSetting_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets.NewAzMigrateReplicationVaultSetting_CreateViaIdentity Clone()
        {
            var clone = new NewAzMigrateReplicationVaultSetting_CreateViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzMigrateReplicationVaultSetting_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzMigrateReplicationVaultSetting_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ReplicationVaultSettingCreateViaIdentity(InputObject.Id, Input, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ReplicationVaultSettingCreate(InputObject.ResourceName ?? null, InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.VaultSettingName ?? null, Input, onOk, this, Pipeline);
                    }
