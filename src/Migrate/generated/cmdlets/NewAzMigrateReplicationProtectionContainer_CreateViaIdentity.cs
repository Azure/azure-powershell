...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzMigrateReplicationProtectionContainer_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzMigrateReplicationProtectionContainer_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="CreationInput" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20180110.ICreateProtectionContainerInput _creationInput;

        /// <summary>Create protection container input.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Create protection container input.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Create protection container input.",
        SerializedName = @"creationInput",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20180110.ICreateProtectionContainerInput) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20180110.ICreateProtectionContainerInput CreationInput { get => this._creationInput; set => this._creationInput = value; }
        ...
        /// <returns>
        /// a duplicate instance of NewAzMigrateReplicationProtectionContainer_CreateViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets.NewAzMigrateReplicationProtectionContainer_CreateViaIdentity Clone()
        {
            var clone = new NewAzMigrateReplicationProtectionContainer_CreateViaIdentity();
            ...
            clone.CreationInput = this.CreationInput;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzMigrateReplicationProtectionContainer_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzMigrateReplicationProtectionContainer_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ReplicationProtectionContainersCreateViaIdentity(InputObject.Id, CreationInput, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ReplicationProtectionContainersCreate(InputObject.ResourceName ?? null, InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.FabricName ?? null, InputObject.ProtectionContainerName ?? null, CreationInput, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=CreationInput})
                    {
