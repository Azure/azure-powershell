...
```
New-AzMigrateReplicationProtectionCluster -FabricName <String> -Name <String> -ProtectionContainerName <String>
 -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>] [-ActiveLocation <String>]
