...
* Validated user login with Microsoft Managed System Identity (MSI) in Initialize-AzMigrateHCIReplicationInfrastructure command
* Passed appropriate Hyper-V Generation value based on source VMware firmware type in New-AzMigrateHCIServerReplication command
