...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/new-azmigratevmwarecollector
schema: 2.0.0
---

# New-AzMigrateVMwareCollector
...
```
New-AzMigrateVMwareCollector -Name <String> -ProjectName <String> -ResourceGroupName <String>
