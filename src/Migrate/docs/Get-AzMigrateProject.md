...
### List (Default)
```
Get-AzMigrateProject [-SubscriptionId <String[]>] [-AcceptLanguage <String>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### List1
```
Get-AzMigrateProject -ResourceGroupName <String> [-SubscriptionId <String[]>] [-AcceptLanguage <String>]
