...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/new-azmigratehypervsite
schema: 2.0.0
---

# New-AzMigrateHyperVSite
...
```
New-AzMigrateHyperVSite -ResourceGroupName <String> -SiteName <String> [-SubscriptionId <String>]
