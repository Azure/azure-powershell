...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/update-azmigratevcenter
schema: 2.0.0
---

# Update-AzMigrateVCenter
...
```
Update-AzMigrateVCenter -ResourceGroupName <String> -SiteName <String> -VcenterName <String>
...
```
Update-AzMigrateVCenter -InputObject <IMigrateIdentity> [-Fqdn <String>] [-Name <String>] [-Port <String>]
