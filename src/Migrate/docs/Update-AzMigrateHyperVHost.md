...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/update-azmigratehypervhost
schema: 2.0.0
---

# Update-AzMigrateHyperVHost
...
```
Update-AzMigrateHyperVHost -HostName <String> -ResourceGroupName <String> -SiteName <String>
 [-SubscriptionId <String>] [-Fqdn <String>] [-Name <String>] [-RunAsAccountId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzMigrateHyperVHost -InputObject <IMigrateIdentity> [-Fqdn <String>] [-Name <String>]
 [-RunAsAccountId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
