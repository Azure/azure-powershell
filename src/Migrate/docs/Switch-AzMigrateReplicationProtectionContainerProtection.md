...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/switch-azmigratereplicationprotectioncontainerprotection
schema: 2.0.0
---

# Switch-AzMigrateReplicationProtectionContainerProtection
...
```
Switch-AzMigrateReplicationProtectionContainerProtection -FabricName <String>
...
### SwitchViaIdentity
```
Switch-AzMigrateReplicationProtectionContainerProtection -InputObject <IMigrateIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20180110.ISwitchProtectionInput
