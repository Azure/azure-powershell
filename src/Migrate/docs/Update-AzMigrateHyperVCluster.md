...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/update-azmigratehypervcluster
schema: 2.0.0
---

# Update-AzMigrateHyperVCluster
...
```
Update-AzMigrateHyperVCluster -ClusterName <String> -ResourceGroupName <String> -SiteName <String>
...
```
Update-AzMigrateHyperVCluster -InputObject <IMigrateIdentity> [-Fqdn <String>] [-HostFqdnList <String[]>]
 [-Name <String>] [-RunAsAccountId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
