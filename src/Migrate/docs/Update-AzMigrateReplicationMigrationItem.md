...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/update-azmigratereplicationmigrationitem
schema: 2.0.0
---

# Update-AzMigrateReplicationMigrationItem
...
```
Update-AzMigrateReplicationMigrationItem -FabricName <String> -MigrationItemName <String>
...
Update-AzMigrateReplicationMigrationItem -FabricName <String> -MigrationItemName <String>
 -ProtectionContainerName <String> -ResourceGroupName <String> -ResourceName <String>
 -Input <IUpdateMigrationItemInput> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-AzMigrateReplicationMigrationItem -InputObject <IMigrateIdentity> -Input <IUpdateMigrationItemInput>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzMigrateReplicationMigrationItem -InputObject <IMigrateIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20180110.IUpdateMigrationItemInput
