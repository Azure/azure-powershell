...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/get-azmigrateassessmentreportdownloadurl
schema: 2.0.0
---

# Get-AzMigrateAssessmentReportDownloadUrl
...
### Get (Default)
```
Get-AzMigrateAssessmentReportDownloadUrl -AssessmentName <String> -GroupName <String> -ProjectName <String>
...
### GetViaIdentity
```
Get-AzMigrateAssessmentReportDownloadUrl -InputObject <IMigrateIdentity> [-AcceptLanguage <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20191001.IDownloadUrl
