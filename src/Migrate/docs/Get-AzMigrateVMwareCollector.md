...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/get-azmigratevmwarecollector
schema: 2.0.0
---

# Get-AzMigrateVMwareCollector
...
### List (Default)
```
Get-AzMigrateVMwareCollector -ProjectName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-AcceptLanguage <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzMigrateVMwareCollector -Name <String> -ProjectName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-AcceptLanguage <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMigrateVMwareCollector -InputObject <IMigrateIdentity> [-AcceptLanguage <String>]
...
### Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20191001.IVMwareCollector
