...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/remove-azmigrategroup
schema: 2.0.0
---

# Remove-AzMigrateGroup
...
### Delete (Default)
```
Remove-AzMigrateGroup -Name <String> -ProjectName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzMigrateGroup -InputObject <IMigrateIdentity> [-AcceptLanguage <String>] [-DefaultProfile <PSObject>]
