...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/remove-azmigratevmwarecollector
schema: 2.0.0
---

# Remove-AzMigrateVMwareCollector
...
### Delete (Default)
```
Remove-AzMigrateVMwareCollector -Name <String> -ProjectName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-AcceptLanguage <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMigrateVMwareCollector -InputObject <IMigrateIdentity> [-AcceptLanguage <String>]
