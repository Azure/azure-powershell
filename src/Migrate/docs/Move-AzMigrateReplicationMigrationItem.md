...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/move-azmigratereplicationmigrationitem
schema: 2.0.0
---

# Move-AzMigrateReplicationMigrationItem
...
```
Move-AzMigrateReplicationMigrationItem -FabricName <String> -MigrationItemName <String>
...
### MigrateViaIdentity
```
Move-AzMigrateReplicationMigrationItem -InputObject <IMigrateIdentity> -MigrateInput <IMigrateInput>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### MigrateViaIdentityExpanded
```
Move-AzMigrateReplicationMigrationItem -InputObject <IMigrateIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20180110.IMigrateInput
