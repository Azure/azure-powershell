...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/resume-azmigratereplicationjob
schema: 2.0.0
---

# Resume-AzMigrateReplicationJob
...
```
Resume-AzMigrateReplicationJob -JobName <String> -ResourceGroupName <String> -ResourceName <String>
...
### ResumeViaIdentity
```
Resume-AzMigrateReplicationJob -InputObject <IMigrateIdentity> -ResumeJobParam <IResumeJobParams>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ResumeViaIdentityExpanded
```
Resume-AzMigrateReplicationJob -InputObject <IMigrateIdentity> [-Comment <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20180110.IResumeJobParams
