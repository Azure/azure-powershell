...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/get-azmigratehypervcollector
schema: 2.0.0
---

# Get-AzMigrateHyperVCollector
...
### List (Default)
```
Get-AzMigrateHyperVCollector -ProjectName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-AcceptLanguage <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzMigrateHyperVCollector -Name <String> -ProjectName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-AcceptLanguage <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMigrateHyperVCollector -InputObject <IMigrateIdentity> [-AcceptLanguage <String>]
