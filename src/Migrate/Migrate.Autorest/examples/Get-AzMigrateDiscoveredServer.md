...
```
Get All HyperV servers in a migrate project. Similarly, specify "HyperV" for -SourceMachineType in all the above examples can retrieve HyperV machine(s) in different ways.
