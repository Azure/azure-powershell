...
function Set-AzMigrateServerReplication {
    ...
    process {
        ...
        if ($ReplicationMigrationItem -and ($ReplicationMigrationItem.ProviderSpecificDetail.InstanceType -eq 'VMwarecbt')) {
            $ProviderSpecificDetails = [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.VMwareCbtUpdateMigrationItemInput]::new()
            ...
            if ($HasDiskToUpdate) {
                ...
                if ($changeOsDiskId -ne $null -and $changeOsDiskId -ne $previousOsDiskId) {
                    if ($diskIdDiskTypeMap.ContainsKey($previousOsDiskId)) {
                        ...
                        $updateDisk = [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.VMwareCbtUpdateDiskInput]::new()
            ...
            if ($HasTargetDiskName) {
                ...
                [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IVMwareCbtUpdateDiskInput[]]$updateDisksArray = @()
                $originalDisks = $ReplicationMigrationItem.ProviderSpecificDetail.ProtectedDisk
                foreach ($DiskObject in $originalDisks) {
                    if ( $DiskObject.IsOSDisk) {
                        $updateDisk = [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.VMwareCbtUpdateDiskInput]::new()
            ...
            [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IVMwareCbtNicInput[]]$updateNicsArray = @()
            ...
            foreach ($storedNic in $originalNics) {
                $updateNic = [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.VMwareCbtNicInput]::new()
