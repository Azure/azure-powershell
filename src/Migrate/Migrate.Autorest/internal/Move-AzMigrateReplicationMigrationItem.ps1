...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IMigrationItem])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IMigrateProviderSpecificInput]
