...
input-file:
    ...
    - $(repo)/specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2023-06-01/service.json
...
directive:
  ...
  - from: Microsoft.RecoveryServices/stable/2023-06-01/service.json
    where:
      verb: Test$
