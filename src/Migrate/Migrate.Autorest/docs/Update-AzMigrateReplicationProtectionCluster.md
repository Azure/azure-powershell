...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityReplicationFabricExpanded, UpdateViaIdentityReplicationProtectionContainerExpanded, UpdateViaIdentityVaultExpanded
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityReplicationFabricExpanded, UpdateViaIdentityVaultExpanded
Aliases:
