...
Describe 'New-AzMigrateReplicationPolicy' {
    It 'CreateExpanded' {
        ...
        $output = New-AzMigrateReplicationPolicy -PolicyName $env.srsTestPolicy -ResourceGroupName $env.migResourceGroup -ResourceName $env.migPolicyVaultName -SubscriptionId $env.migSubscriptionId -ProviderSpecificInput $providerSpecificPolicy
