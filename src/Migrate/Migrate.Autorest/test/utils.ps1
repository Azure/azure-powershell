...
function setupEnv() {
    ...
    $env.hciSubscriptionId = "d41eb627-825d-4419-a14d-c6ad485f4110"
    $env.hciMigResourceGroup = "aszmige2etestscratchkpihyp"
    ...
    $env.hciSourceReplicationFabricName = "HyperV-1c041dbbf3areplicationfabric"
