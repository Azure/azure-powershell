...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzMigratePolicy_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzMigratePolicy_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210216Preview.IPolicyModel _body;

        /// <summary>Policy model.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Policy model.", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20210216Preview.IPolicyModel Body { get => this._body; set => this._body = value; }
        ...
        /// <returns>a duplicate instance of NewAzMigratePolicy_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets.NewAzMigratePolicy_CreateViaIdentity Clone()
        {
            var clone = new NewAzMigratePolicy_CreateViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzMigratePolicy_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzMigratePolicy_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PolicyCreateViaIdentity(InputObject.Id, Body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PolicyCreate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VaultName ?? null, InputObject.PolicyName ?? null, Body, onOk, onDefault, this, Pipeline);
                    }
