...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzMigrateDra_Delete", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzMigrateDra_Delete : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The fabric agent (Dra) name.")]
        ...
        /// <returns>a duplicate instance of RemoveAzMigrateDra_Delete</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets.RemoveAzMigrateDra_Delete Clone()
        {
            var clone = new RemoveAzMigrateDra_Delete();
            ...
            clone.FabricAgentName = this.FabricAgentName;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DraDelete(SubscriptionId, ResourceGroupName, FabricName, FabricAgentName, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,FabricName=FabricName,FabricAgentName=FabricAgentName})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzMigrateDra_Delete" /> cmdlet class.
        /// </summary>
        public RemoveAzMigrateDra_Delete()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api40.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, FabricName=FabricName, FabricAgentName=FabricAgentName })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, FabricName=FabricName, FabricAgentName=FabricAgentName })
                    {
