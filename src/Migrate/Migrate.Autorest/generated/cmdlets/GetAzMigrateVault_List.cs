...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.DataReplication/replicationVaults", ApiVersion = "2021-02-16-preview")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VaultListBySubscription(SubscriptionId, this.InvocationInformation.BoundParameters.ContainsKey("ContinuationToken") ? ContinuationToken : null, onOk, onDefault, this, Pipeline);
