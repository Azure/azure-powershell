...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401
{
    ...
    public partial class RecoveryPlanAction :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRecoveryPlanAction,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRecoveryPlanActionInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRecoveryPlanActionDetails _customDetail;

        /// <summary>The custom details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRecoveryPlanActionDetails CustomDetail { get => (this._customDetail = this._customDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.RecoveryPlanActionDetails()); set => this._customDetail = value; }

        /// <summary>
        /// Gets the type of action details (see RecoveryPlanActionDetailsTypes enum for possible values).
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public string CustomDetailInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRecoveryPlanActionDetailsInternal)CustomDetail).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRecoveryPlanActionDetailsInternal)CustomDetail).InstanceType = value ; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRecoveryPlanActionDetails Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRecoveryPlanActionInternal.CustomDetail { get => (this._customDetail = this._customDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.RecoveryPlanActionDetails()); set { {_customDetail = value;} } }
...

    {
        ...
        string ActionName { get; set; }
        /// <summary>The custom details.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRecoveryPlanActionDetails CustomDetail { get; set; }
        /// <summary>
        /// Gets the type of action details (see RecoveryPlanActionDetailsTypes enum for possible values).
        /// </summary>
        string CustomDetailInstanceType { get; set; }
