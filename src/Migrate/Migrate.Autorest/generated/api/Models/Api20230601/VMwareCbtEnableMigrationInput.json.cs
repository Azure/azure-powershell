...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601
{
    ...
    public partial class VMwareCbtEnableMigrationInput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IVMwareCbtEnableMigrationInput.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IVMwareCbtEnableMigrationInput.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IVMwareCbtEnableMigrationInput FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
        ...
        internal VMwareCbtEnableMigrationInput(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            __enableMigrationProviderSpecificInput = new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.EnableMigrationProviderSpecificInput(json);
            {_targetVMSecurityProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("targetVmSecurityProfile"), out var __jsonTargetVMSecurityProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.VMwareCbtSecurityProfileProperties.FromJson(__jsonTargetVMSecurityProfile) : TargetVMSecurityProfile;}
            ...
            {_disksToInclude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("disksToInclude"), out var __jsonDisksToInclude) ? If( __jsonDisksToInclude as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IVMwareCbtDiskInput[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IVMwareCbtDiskInput) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.VMwareCbtDiskInput.FromJson(__u) )) ))() : null : DisksToInclude;}
            ...
            {_targetVMTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("targetVmTags"), out var __jsonTargetVMTags) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.VMwareCbtEnableMigrationInputTargetVmtags.FromJson(__jsonTargetVMTags) : TargetVMTag;}
            {_seedDiskTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("seedDiskTags"), out var __jsonSeedDiskTags) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.VMwareCbtEnableMigrationInputSeedDiskTags.FromJson(__jsonSeedDiskTags) : SeedDiskTag;}
            {_targetDiskTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("targetDiskTags"), out var __jsonTargetDiskTags) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.VMwareCbtEnableMigrationInputTargetDiskTags.FromJson(__jsonTargetDiskTags) : TargetDiskTag;}
            {_targetNicTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("targetNicTags"), out var __jsonTargetNicTags) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.VMwareCbtEnableMigrationInputTargetNicTags.FromJson(__jsonTargetNicTags) : TargetNicTag;}
            AfterFromJson(json);
        }
    }
}