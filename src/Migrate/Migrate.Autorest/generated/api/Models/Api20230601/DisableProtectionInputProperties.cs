...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601
{
    ...
    public partial class DisableProtectionInputProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IDisableProtectionInputProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IDisableProtectionInputPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IDisableProtectionProviderSpecificInput Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IDisableProtectionInputPropertiesInternal.ReplicationProviderInput { get => (this._replicationProviderInput = this._replicationProviderInput ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.DisableProtectionProviderSpecificInput()); set { {_replicationProviderInput = value;} } }

        /// <summary>Backing field for <see cref="ReplicationProviderInput" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IDisableProtectionProviderSpecificInput _replicationProviderInput;

        /// <summary>Replication provider specific input.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IDisableProtectionProviderSpecificInput ReplicationProviderInput { get => (this._replicationProviderInput = this._replicationProviderInput ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.DisableProtectionProviderSpecificInput()); set => this._replicationProviderInput = value; }

        /// <summary>The class type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public string ReplicationProviderInputInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IDisableProtectionProviderSpecificInputInternal)ReplicationProviderInput).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IDisableProtectionProviderSpecificInputInternal)ReplicationProviderInput).InstanceType = value ?? null; }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.DisableProtectionReason? DisableProtectionReason { get; set; }
        /// <summary>Replication provider specific input.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IDisableProtectionProviderSpecificInput ReplicationProviderInput { get; set; }
        /// <summary>The class type.</summary>
        string ReplicationProviderInputInstanceType { get; set; }
