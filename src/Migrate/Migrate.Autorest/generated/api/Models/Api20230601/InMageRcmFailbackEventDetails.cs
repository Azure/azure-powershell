...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601
{
    ...
    public partial class InMageRcmFailbackEventDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IInMageRcmFailbackEventDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IInMageRcmFailbackEventDetailsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IEventProviderSpecificDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IEventProviderSpecificDetails __eventProviderSpecificDetails = new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.EventProviderSpecificDetails();
        ...
        public string InstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IEventProviderSpecificDetailsInternal)__eventProviderSpecificDetails).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IEventProviderSpecificDetailsInternal)__eventProviderSpecificDetails).InstanceType = value ; }

        /// <summary>Internal Acessors for ApplianceName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IInMageRcmFailbackEventDetailsInternal.ApplianceName { get => this._applianceName; set { {_applianceName = value;} } }

        /// <summary>Internal Acessors for ComponentDisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IInMageRcmFailbackEventDetailsInternal.ComponentDisplayName { get => this._componentDisplayName; set { {_componentDisplayName = value;} } }

        /// <summary>Internal Acessors for ProtectedItemName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IInMageRcmFailbackEventDetailsInternal.ProtectedItemName { get => this._protectedItemName; set { {_protectedItemName = value;} } }

        /// <summary>Internal Acessors for ServerType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IInMageRcmFailbackEventDetailsInternal.ServerType { get => this._serverType; set { {_serverType = value;} } }

        /// <summary>Internal Acessors for VMName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IInMageRcmFailbackEventDetailsInternal.VMName { get => this._vMName; set { {_vMName = value;} } }
    ...
    public partial interface IInMageRcmFailbackEventDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IEventProviderSpecificDetails
    {
        /// <summary>The appliance name.</summary>
    ...
    internal partial interface IInMageRcmFailbackEventDetailsInternal :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IEventProviderSpecificDetailsInternal
    {
        /// <summary>The appliance name.</summary>
