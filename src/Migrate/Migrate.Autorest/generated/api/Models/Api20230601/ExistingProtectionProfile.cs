...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601
{
    ...
    public partial class ExistingProtectionProfile :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IExistingProtectionProfile,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IExistingProtectionProfileInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IProtectionProfileCustomDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IProtectionProfileCustomDetails __protectionProfileCustomDetails = new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.ProtectionProfileCustomDetails();
        ...
        public string ResourceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IProtectionProfileCustomDetailsInternal)__protectionProfileCustomDetails).ResourceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IProtectionProfileCustomDetailsInternal)__protectionProfileCustomDetails).ResourceType = value ; }
    ...
    public partial interface IExistingProtectionProfile :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IProtectionProfileCustomDetails
    {
        /// <summary>The protection profile Arm Id. Throw error, if resource does not exists.</summary>
    ...
    internal partial interface IExistingProtectionProfileInternal :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IProtectionProfileCustomDetailsInternal
    {
        /// <summary>The protection profile Arm Id. Throw error, if resource does not exists.</summary>
        string ProtectionProfileId { get; set; }
