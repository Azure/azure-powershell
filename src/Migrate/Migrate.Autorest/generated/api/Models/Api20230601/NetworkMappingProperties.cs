...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601
{
    ...
    public partial class NetworkMappingProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.INetworkMappingPropertiesInternal
    {

        /// <summary>Backing field for <see cref="FabricSpecificSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.INetworkMappingFabricSpecificSettings _fabricSpecificSetting;

        /// <summary>The fabric specific settings.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.INetworkMappingFabricSpecificSettings FabricSpecificSetting { get => (this._fabricSpecificSetting = this._fabricSpecificSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.NetworkMappingFabricSpecificSettings()); set => this._fabricSpecificSetting = value; }

        /// <summary>Gets the Instance type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public string FabricSpecificSettingInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.INetworkMappingFabricSpecificSettingsInternal)FabricSpecificSetting).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.INetworkMappingFabricSpecificSettingsInternal)FabricSpecificSetting).InstanceType = value ?? null; }

        /// <summary>Internal Acessors for FabricSpecificSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.INetworkMappingFabricSpecificSettings Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.INetworkMappingPropertiesInternal.FabricSpecificSetting { get => (this._fabricSpecificSetting = this._fabricSpecificSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.NetworkMappingFabricSpecificSettings()); set { {_fabricSpecificSetting = value;} } }
