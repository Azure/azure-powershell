...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601
{
    ...
    public partial class MarsAgentDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IMarsAgentDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IMarsAgentDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IMarsAgentDetailsInternal.BiosId { get => this._biosId; set { {_biosId = value;} } }

        /// <summary>Internal Acessors for FabricObjectId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IMarsAgentDetailsInternal.FabricObjectId { get => this._fabricObjectId; set { {_fabricObjectId = value;} } }

        /// <summary>Internal Acessors for Fqdn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IMarsAgentDetailsInternal.Fqdn { get => this._fqdn; set { {_fqdn = value;} } }

        /// <summary>Internal Acessors for Health</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.ProtectionHealth? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IMarsAgentDetailsInternal.Health { get => this._health; set { {_health = value;} } }

        /// <summary>Internal Acessors for HealthError</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IHealthError[] Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IMarsAgentDetailsInternal.HealthError { get => this._healthError; set { {_healthError = value;} } }

        /// <summary>Internal Acessors for Id</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IMarsAgentDetailsInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for LastHeartbeatUtc</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IMarsAgentDetailsInternal.LastHeartbeatUtc { get => this._lastHeartbeatUtc; set { {_lastHeartbeatUtc = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IMarsAgentDetailsInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230601.IMarsAgentDetailsInternal.Version { get => this._version; set { {_version = value;} } }
