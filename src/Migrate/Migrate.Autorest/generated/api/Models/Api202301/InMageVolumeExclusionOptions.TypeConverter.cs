...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202301
{
    ...
    public partial class InMageVolumeExclusionOptionsTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="InMageVolumeExclusionOptions" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202301.IInMageVolumeExclusionOptions ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202301.IInMageVolumeExclusionOptions).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
