...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202301
{
    ...
    public partial class HyperVReplicaAzureUpdateReplicationProtectedItemInput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202301.IHyperVReplicaAzureUpdateReplicationProtectedItemInput.
        /// </summary>
        ...
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202301.IHyperVReplicaAzureUpdateReplicationProtectedItemInput FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
        ...
        internal HyperVReplicaAzureUpdateReplicationProtectedItemInput(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_diskIdToDiskEncryptionMap = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("diskIdToDiskEncryptionMap"), out var __jsonDiskIdToDiskEncryptionMap) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202301.HyperVReplicaAzureUpdateReplicationProtectedItemInputDiskIdToDiskEncryptionMap.FromJson(__jsonDiskIdToDiskEncryptionMap) : DiskIdToDiskEncryptionMap;}
            ...
            {_targetVMTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("targetVmTags"), out var __jsonTargetVMTags) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202301.HyperVReplicaAzureUpdateReplicationProtectedItemInputTargetVmtags.FromJson(__jsonTargetVMTags) : TargetVMTag;}
            {_targetManagedDiskTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("targetManagedDiskTags"), out var __jsonTargetManagedDiskTags) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202301.HyperVReplicaAzureUpdateReplicationProtectedItemInputTargetManagedDiskTags.FromJson(__jsonTargetManagedDiskTags) : TargetManagedDiskTag;}
            {_targetNicTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("targetNicTags"), out var __jsonTargetNicTags) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202301.HyperVReplicaAzureUpdateReplicationProtectedItemInputTargetNicTags.FromJson(__jsonTargetNicTags) : TargetNicTag;}
