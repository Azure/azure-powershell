...
#>
function Mock-AzMigrateGetSolution {
	...
	$response = Invoke-RestMethod 'https://management.azure.com/subscriptions/7c943c1b-5122-4097-90c8-861411bdd574/resourceGroups/azmigratepwshtestasr13072020/providers/Microsoft.Migrate/migrateProjects/AzMigrateTestProjectPWSH/solutions?api-version=2018-09-01-preview' -Method 'GET' -Headers $headers -Body $body
	return $response
    }
