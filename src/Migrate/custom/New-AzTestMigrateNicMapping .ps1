...
.Description
The New-AzTestMigrateNicMapping cmdlet creates a mapping of the source NIC attached to the server to be test migrated. This object is provided as an input to the Start-AzMigrateTestMigration cmdlet to update the NIC and its properties for a test migrating server.
.Link
https://docs.microsoft.com/powershell/module/az.migrate/new-azmigratetestnicmapping
#>
function New-AzTestMigrateNicMapping {
