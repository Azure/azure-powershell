...
#>
function Mock-AzMigrateGetSite {
    [OutputType([System.Management.Automation.PSObject])]
    [CmdletBinding(DefaultParameterSetName='VMwareCbts', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
    param(
        [Parameter(Mandatory)]
    ...
    process {
        ...
        $response = Invoke-RestMethod 'https://management.azure.com/subscriptions/7c943c1b-5122-4097-90c8-861411bdd574/resourceGroups/azmigratepwshtestasr13072020/providers/Microsoft.OffAzure/VMwareSites/AzMigratePWSHTc8d1site?api-version=2020-01-01' -Method 'GET' -Headers $headers -Body $body
        return $response 
    }
