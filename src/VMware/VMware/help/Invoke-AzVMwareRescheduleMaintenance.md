...
Invoke-AzVMwareRescheduleMaintenance -MaintenanceName <String> -PrivateCloudInputObject <IVMwareIdentity>
 [-Message <String>] [-RescheduleTime <DateTime>] [-DefaultProfile <PSObject>]
...
```
Invoke-AzVMwareRescheduleMaintenance -MaintenanceName <String> -PrivateCloudInputObject <IVMwareIdentity>
 -Body <IMaintenanceReschedule> [-DefaultProfile <PSObject>] [-WhatIf]
...
```
Invoke-AzVMwareRescheduleMaintenance -MaintenanceName <String> -PrivateCloudName <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] -Body <IMaintenanceReschedule>
 [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Invoke-AzVMwareRescheduleMaintenance -InputObject <IVMwareIdentity> [-Message <String>]
 [-RescheduleTime <DateTime>] [-DefaultProfile <PSObject>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
Parameter Sets: RescheduleViaIdentityPrivateCloud, Reschedule, RescheduleViaIdentity
Aliases:
...
Parameter Sets: RescheduleViaIdentityExpanded, RescheduleViaIdentity
Aliases:
...
```yaml
Type: System.String
Parameter Sets: RescheduleExpanded, RescheduleViaIdentityPrivateCloudExpanded, RescheduleViaIdentityPrivateCloud, Reschedule
Aliases:
...
```yaml
Type: System.String
Parameter Sets: RescheduleExpanded, RescheduleViaIdentityPrivateCloudExpanded, RescheduleViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IVMwareIdentity
Parameter Sets: RescheduleViaIdentityPrivateCloudExpanded, RescheduleViaIdentityPrivateCloud
Aliases:
...
```yaml
Type: System.String
Parameter Sets: RescheduleExpanded, Reschedule
Aliases:
