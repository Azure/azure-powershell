...
online version: https://learn.microsoft.com/powershell/module/az.vmware/remove-azvmwarecluster
schema: 2.0.0
---
...
```
Remove-AzVMwareCluster -Name <String> -PrivateCloudInputObject <IVMwareIdentity> [-DefaultProfile <PSObject>]
