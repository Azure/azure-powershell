...
online version: https://learn.microsoft.com/powershell/module/az.vmware/update-azvmwarelicense
schema: 2.0.0
---
...
```
Update-AzVMwareLicense -PrivateCloudName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzVMwareLicense -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
