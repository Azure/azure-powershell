...
online version: https://learn.microsoft.com/powershell/module/az.vmware/get-azvmwareprivatecloudvcflicense
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzVMwarePrivateCloudVcfLicense -PrivateCloudName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzVMwarePrivateCloudVcfLicense -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>]
