...
online version: https://learn.microsoft.com/powershell/module/az.vmware/new-azvmwarelicense
schema: 2.0.0
---
...
```
New-AzVMwareLicense -PrivateCloudName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
New-AzVMwareLicense -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
### Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.ILicense
