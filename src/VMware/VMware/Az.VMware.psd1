...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added ''-VcfLicense'' parameter to ''New-AzVMwarePrivateCloud'' to support setting a VMware Cloud Foundation (VCF) license during private cloud provisioning
