...
FunctionsToExport = 'Get-AzVMwareAddon', 'Get-AzVMwareAuthorization', 
               ...
               'Get-AzVMwareIscsiPath', 'Get-AzVMwareLicense', 
               'Get-AzVMwareLicenseProperty', 'Get-AzVMwareMaintenance', 
               ...
               'Get-AzVMwareSku', 'Get-AzVMwareVirtualMachine', 
               'Invoke-AzVMwareInitiateMaintenanceCheck', 
               'Invoke-AzVMwareRescheduleMaintenance', 
               'Invoke-AzVMwareScheduleMaintenance', 'New-AzVMwareAddon', 
               ...
               'New-AzVMwareIscsiPath', 'New-AzVMwareLicense', 
               ...
               'Remove-AzVMwareIscsiPath', 'Remove-AzVMwareLicense', 
               ...
               'Update-AzVMwareLicense', 'Update-AzVMwarePlacementPolicy', 
               'Update-AzVMwarePrivateCloud', 'Update-AzVMwarePureStoragePolicy'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed ''New-AzVMwareVcf5LicenseObject'' and the ''-VcfLicense'' parameter on ''New-AzVMwarePrivateCloud'' missing from the ''0.9.1'' package; both are now generated and exported.'
