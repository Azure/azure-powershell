...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed missing ''New-AzVMwareVcf5LicenseObject'' and ''-VcfLicense'' on ''New-AzVMwarePrivateCloud'' in package ''0.9.1''; both are now generated and exported.'
