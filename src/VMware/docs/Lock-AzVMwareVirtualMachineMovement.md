...
online version: https://docs.microsoft.com/powershell/module/az.vmware/lock-azvmwarevirtualmachinemovement
schema: 2.0.0
---

# Lock-AzVMwareVirtualMachineMovement
...
### RestrictExpanded (Default)
```
Lock-AzVMwareVirtualMachineMovement -ClusterName <String> -PrivateCloudName <String>
 -ResourceGroupName <String> -VirtualMachineId <String> [-SubscriptionId <String>]
 [-RestrictMovement <VirtualMachineRestrictMovementState>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestrictViaIdentityExpanded
```
Lock-AzVMwareVirtualMachineMovement -InputObject <IVMwareIdentity>
 [-RestrictMovement <VirtualMachineRestrictMovementState>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: RestrictExpanded
Aliases:
...
Parameter Sets: RestrictViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.VMware.Support.VirtualMachineRestrictMovementState
Parameter Sets: (All)
Aliases:
