...
online version: https://docs.microsoft.com/powershell/module/az.vmware/new-azvmwareworkloadnetworkportmirroring
schema: 2.0.0
---

# New-AzVMwareWorkloadNetworkPortMirroring
...
```
New-AzVMwareWorkloadNetworkPortMirroring -PortMirroringName <String> -PrivateCloudName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.VMware.Support.PortMirroringDirectionEnum
Parameter Sets: (All)
Aliases:
