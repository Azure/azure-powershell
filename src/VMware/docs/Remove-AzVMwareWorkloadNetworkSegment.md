...
online version: https://docs.microsoft.com/powershell/module/az.vmware/remove-azvmwareworkloadnetworksegment
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzVMwareWorkloadNetworkSegment -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>] [-AsJob]
