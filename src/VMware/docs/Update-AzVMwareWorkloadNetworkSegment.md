...
online version: https://docs.microsoft.com/powershell/module/az.vmware/update-azvmwareworkloadnetworksegment
schema: 2.0.0
---

# Update-AzVMwareWorkloadNetworkSegment
...
```
Update-AzVMwareWorkloadNetworkSegment -InputObject <IVMwareIdentity> [-ConnectedGateway <String>]
 [-DisplayName <String>] [-Revision <Int64>] [-SubnetDhcpRange <String[]>] [-SubnetGatewayAddress <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
