...
online version: https://docs.microsoft.com/powershell/module/az.vmware/get-azvmwareworkloadnetworkdnsservice
schema: 2.0.0
---
...
### List (Default)
```
Get-AzVMwareWorkloadNetworkDnsService -PrivateCloudName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzVMwareWorkloadNetworkDnsService -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
