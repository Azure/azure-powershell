...
online version: https://docs.microsoft.com/powershell/module/az.vmware/update-azvmwareworkloadnetworkdnsservice
schema: 2.0.0
---

# Update-AzVMwareWorkloadNetworkDnsService
...
```
Update-AzVMwareWorkloadNetworkDnsService -InputObject <IVMwareIdentity> [-DefaultDnsZone <String>]
 [-DisplayName <String>] [-DnsServiceIP <String>] [-FqdnZone <String[]>] [-LogLevel <DnsServiceLogLevelEnum>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.VMware.Support.DnsServiceLogLevelEnum
Parameter Sets: (All)
Aliases:
