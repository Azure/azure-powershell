...
online version: https://docs.microsoft.com/powershell/module/az.vmware/remove-azvmwareworkloadnetworkvmgroup
schema: 2.0.0
---

# Remove-AzVMwareWorkloadNetworkVMGroup
...
### DeleteViaIdentity
```
Remove-AzVMwareWorkloadNetworkVMGroup -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>] [-AsJob]
