...
online version: https://docs.microsoft.com/powershell/module/az.vmware/remove-azvmwareworkloadnetworkpublicip
schema: 2.0.0
---

# Remove-AzVMwareWorkloadNetworkPublicIP
...
### DeleteViaIdentity
```
Remove-AzVMwareWorkloadNetworkPublicIP -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>] [-AsJob]
