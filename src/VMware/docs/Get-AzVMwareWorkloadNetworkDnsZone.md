...
online version: https://docs.microsoft.com/powershell/module/az.vmware/get-azvmwareworkloadnetworkdnszone
schema: 2.0.0
---

# Get-AzVMwareWorkloadNetworkDnsZone
...
### List (Default)
```
Get-AzVMwareWorkloadNetworkDnsZone -PrivateCloudName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzVMwareWorkloadNetworkDnsZone -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
