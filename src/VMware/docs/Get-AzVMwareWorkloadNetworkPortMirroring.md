...
online version: https://docs.microsoft.com/powershell/module/az.vmware/get-azvmwareworkloadnetworkportmirroring
schema: 2.0.0
---

# Get-AzVMwareWorkloadNetworkPortMirroring
...
### List (Default)
```
Get-AzVMwareWorkloadNetworkPortMirroring -PrivateCloudName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzVMwareWorkloadNetworkPortMirroring -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
