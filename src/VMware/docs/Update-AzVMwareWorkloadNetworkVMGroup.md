...
online version: https://docs.microsoft.com/powershell/module/az.vmware/update-azvmwareworkloadnetworkvmgroup
schema: 2.0.0
---

# Update-AzVMwareWorkloadNetworkVMGroup
...
```
Update-AzVMwareWorkloadNetworkVMGroup -InputObject <IVMwareIdentity> [-DisplayName <String>]
 [-Member <String[]>] [-Revision <Int64>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
