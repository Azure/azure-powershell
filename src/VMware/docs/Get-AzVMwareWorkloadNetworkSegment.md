...
online version: https://docs.microsoft.com/powershell/module/az.vmware/get-azvmwareworkloadnetworksegment
schema: 2.0.0
---

# Get-AzVMwareWorkloadNetworkSegment
...
### GetViaIdentity
```
Get-AzVMwareWorkloadNetworkSegment -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
