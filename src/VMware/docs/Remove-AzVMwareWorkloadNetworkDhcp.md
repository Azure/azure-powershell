...
online version: https://docs.microsoft.com/powershell/module/az.vmware/remove-azvmwareworkloadnetworkdhcp
schema: 2.0.0
---

# Remove-AzVMwareWorkloadNetworkDhcp
...
### Delete (Default)
```
Remove-AzVMwareWorkloadNetworkDhcp -DhcpName <String> -PrivateCloudName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareWorkloadNetworkDhcp -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>] [-AsJob]
