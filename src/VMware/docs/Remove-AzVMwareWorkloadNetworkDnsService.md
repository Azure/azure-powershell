...
online version: https://docs.microsoft.com/powershell/module/az.vmware/remove-azvmwareworkloadnetworkdnsservice
schema: 2.0.0
---

# Remove-AzVMwareWorkloadNetworkDnsService
...
### DeleteViaIdentity
```
Remove-AzVMwareWorkloadNetworkDnsService -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>] [-AsJob]
