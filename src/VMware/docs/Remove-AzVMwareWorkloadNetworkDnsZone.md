...
online version: https://docs.microsoft.com/powershell/module/az.vmware/remove-azvmwareworkloadnetworkdnszone
schema: 2.0.0
---

# Remove-AzVMwareWorkloadNetworkDnsZone
...
### Delete (Default)
```
Remove-AzVMwareWorkloadNetworkDnsZone -DnsZoneName <String> -PrivateCloudName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareWorkloadNetworkDnsZone -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>] [-AsJob]
