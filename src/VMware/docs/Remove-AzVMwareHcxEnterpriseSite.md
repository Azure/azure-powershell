...
online version: https://docs.microsoft.com/powershell/module/az.vmware/remove-azvmwarehcxenterprisesite
schema: 2.0.0
---

# Remove-AzVMwareHcxEnterpriseSite
...
### Delete (Default)
```
Remove-AzVMwareHcxEnterpriseSite -Name <String> -PrivateCloudName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzVMwareHcxEnterpriseSite -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>] [-PassThru]
