...
online version: https://docs.microsoft.com/powershell/module/az.vmware/remove-azvmwareworkloadnetworkportmirroring
schema: 2.0.0
---

# Remove-AzVMwareWorkloadNetworkPortMirroring
...
### DeleteViaIdentity
```
Remove-AzVMwareWorkloadNetworkPortMirroring -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>]
