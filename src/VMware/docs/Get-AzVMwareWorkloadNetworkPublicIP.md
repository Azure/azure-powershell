...
online version: https://docs.microsoft.com/powershell/module/az.vmware/get-azvmwareworkloadnetworkpublicip
schema: 2.0.0
---

# Get-AzVMwareWorkloadNetworkPublicIP
...
### List (Default)
```
Get-AzVMwareWorkloadNetworkPublicIP -PrivateCloudName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzVMwareWorkloadNetworkPublicIP -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
