...
online version: https://docs.microsoft.com/powershell/module/az.vmware/get-azvmwarescriptexecutionlog
schema: 2.0.0
---

# Get-AzVMwareScriptExecutionLog
...
### Get (Default)
```
Get-AzVMwareScriptExecutionLog -PrivateCloudName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzVMwareScriptExecutionLog -InputObject <IVMwareIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.VMware.Support.ScriptOutputStreamType[]
Parameter Sets: (All)
Aliases:
