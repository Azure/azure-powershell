...
online version: https://docs.microsoft.com/powershell/module/az.vmware/remove-azvmwarescriptexecution
schema: 2.0.0
---

# Remove-AzVMwareScriptExecution
...
### Delete (Default)
```
Remove-AzVMwareScriptExecution -Name <String> -PrivateCloudName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareScriptExecution -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
