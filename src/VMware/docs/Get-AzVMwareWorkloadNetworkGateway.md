...
online version: https://docs.microsoft.com/powershell/module/az.vmware/get-azvmwareworkloadnetworkgateway
schema: 2.0.0
---

# Get-AzVMwareWorkloadNetworkGateway
...
### List (Default)
```
Get-AzVMwareWorkloadNetworkGateway -PrivateCloudName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzVMwareWorkloadNetworkGateway -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
