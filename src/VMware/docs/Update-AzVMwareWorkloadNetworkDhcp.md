...
online version: https://docs.microsoft.com/powershell/module/az.vmware/update-azvmwareworkloadnetworkdhcp
schema: 2.0.0
---

# Update-AzVMwareWorkloadNetworkDhcp
...
```
Update-AzVMwareWorkloadNetworkDhcp -DhcpId <String> -PrivateCloudName <String> -ResourceGroupName <String>
...
```
Update-AzVMwareWorkloadNetworkDhcp -InputObject <IVMwareIdentity> [-DhcpType <DhcpTypeEnum>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.VMware.Support.DhcpTypeEnum
Parameter Sets: (All)
Aliases:
