...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RestrictMovement=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/clusters/{clusterName}/virtualMachines/{virtualMachineId}/restrictMovement"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Lock, @"AzVMwareVirtualMachineMovement_RestrictViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class LockAzVMwareVirtualMachineMovement_RestrictViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Whether VM DRS-driven movement is restricted (enabled) or not (disabled)")]
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.VMware.Support.VirtualMachineRestrictMovementState))]
        public Microsoft.Azure.PowerShell.Cmdlets.VMware.Support.VirtualMachineRestrictMovementState RestrictMovement { get => RestrictMovementBody.RestrictMovement ?? ((Microsoft.Azure.PowerShell.Cmdlets.VMware.Support.VirtualMachineRestrictMovementState)""); set => RestrictMovementBody.RestrictMovement = value; }

        /// <summary>Backing field for <see cref="RestrictMovementBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20211201.IVirtualMachineRestrictMovement _restrictMovementBody= new Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20211201.VirtualMachineRestrictMovement();

        /// <summary>Set VM DRS-driven movement to restricted (enabled) or not (disabled)</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20211201.IVirtualMachineRestrictMovement RestrictMovementBody { get => this._restrictMovementBody; set => this._restrictMovementBody = value; }
        ...
        /// <returns>
        /// a duplicate instance of LockAzVMwareVirtualMachineMovement_RestrictViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets.LockAzVMwareVirtualMachineMovement_RestrictViaIdentityExpanded Clone()
        {
            var clone = new LockAzVMwareVirtualMachineMovement_RestrictViaIdentityExpanded();
            ...
            clone.RestrictMovementBody = this.RestrictMovementBody;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="LockAzVMwareVirtualMachineMovement_RestrictViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public LockAzVMwareVirtualMachineMovement_RestrictViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualMachinesRestrictMovement' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualMachinesRestrictMovementViaIdentity(InputObject.Id, RestrictMovementBody, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualMachinesRestrictMovement(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.PrivateCloudName ?? null, InputObject.ClusterName ?? null, InputObject.VirtualMachineId ?? null, RestrictMovementBody, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=RestrictMovementBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20211201.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=RestrictMovementBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=RestrictMovementBody })
                    {
