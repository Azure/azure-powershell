...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20210601
{
    ...
    public partial class DatastoreProperties
    {
        ...
        internal DatastoreProperties(Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject json)
        {
            ...
            {_netAppVolume = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject>("netAppVolume"), out var __jsonNetAppVolume) ? Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20210601.NetAppVolume.FromJson(__jsonNetAppVolume) : NetAppVolume;}
            {_diskPoolVolume = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject>("diskPoolVolume"), out var __jsonDiskPoolVolume) ? Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20210601.DiskPoolVolume.FromJson(__jsonDiskPoolVolume) : DiskPoolVolume;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20210601.IDatastoreProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20210601.IDatastoreProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20210601.IDatastoreProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode node)
        {
