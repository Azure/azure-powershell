    ...
    It 'UpdateExpanded' -skip {
        {
            ...
            $job_cluster_update = Update-AzVMwareCluster -Name $env.rstr3 -PrivateCloudName $env.privatecloudname1 -ResourceGroupName $env.resourceGroup -ClusterSize 4 -AsJob
            $job_cluster_update | Wait-Job
            $job_cluster_update | Receive-Job
    ...
    It 'UpdateViaIdentityExpanded' -skip {
        {
            ...
            $job_cluster_update = Update-AzVMwareCluster -InputObject $ID -ClusterSize 4 -AsJob
            $job_cluster_update | Wait-Job
            $job_cluster_update | Receive-Job
