...
function setupEnv() {
    ...
    $privateCloudName1 = "azps_test_cloud_1" #+ (RandomString -allChars $false -len 3)
    ...
    $resourceGroup1 = "azps_test_group_1" #"testgroup" + $env.rstr4
    $resourceGroup2 = "azps_test_group_2" #"testgroup" + $env.rstr4
    $resourceGroup3 = "azps_test_group_3" #"testgroup" + $env.rstr4
