...
function New-AzVMwareVMPlacementPolicyPropertiesObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20230301.VMPlacementPolicyProperties')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20230301.VMPlacementPolicyProperties]::New()
