...
function New-AzVMwareVmHostPlacementPolicyPropertiesObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20230301.VmHostPlacementPolicyProperties')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20230301.VmHostPlacementPolicyProperties]::New()
