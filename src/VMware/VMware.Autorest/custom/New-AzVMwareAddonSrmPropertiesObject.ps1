    ...
    .Outputs
    Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20230301.AddonSrmProperties
    .Link
    ...
    function New-AzVMwareAddonSrmPropertiesObject {
        [OutputType('Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20230301.AddonSrmProperties')]
        ...
        process {
            $Object = [Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20230301.AddonSrmProperties]::New()
