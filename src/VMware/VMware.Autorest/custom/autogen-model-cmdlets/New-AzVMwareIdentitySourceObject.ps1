...
function New-AzVMwareIdentitySourceObject {
    ...
    Param(
        ...
        [string]
        $Name,
        [Parameter(HelpMessage="The password of the Active Directory user with a minimum of read-only access to
        ...
        [string]
        $Ssl,
        [Parameter(HelpMessage="The ID of an Active Directory user with a minimum of read-only access to Base
