...
### GetViaIdentity
```
Get-AzVMwareHost -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityCluster
```
Get-AzVMwareHost -ClusterInputObject <IVMwareIdentity> -Id <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
