...
directive:
  ...
  - model-cmdlet:
      - model-name: VMPlacementPolicyProperties
        cmdlet-name: New-AzVMwareVMPlacementPolicyPropertieObject
      - model-name: VmHostPlacementPolicyProperties
        cmdlet-name: New-AzVMwareVmHostPlacementPolicyPropertieObject
      ## Re-name and custom it
      ...
      #   cmdlet-name: New-AzVMwareAddonSrmPropertieObject
      # - model-name: AddonVrProperties
      #   cmdlet-name: New-AzVMwareAddonVrPropertieObject
  - where:
      verb: Get
