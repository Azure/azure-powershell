...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/clusters/{clusterName}/placementPolicies/{placementPolicyName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzVMwarePlacementPolicy_UpdateViaIdentityClusterExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPlacementPolicy))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.Description(@"Update a placement policy in a private cloud cluster")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/clusters/{clusterName}/placementPolicies/{placementPolicyName}", ApiVersion = "2023-03-01")]
    public partial class UpdateAzVMwarePlacementPolicy_UpdateViaIdentityClusterExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPlacementPolicyUpdate _placementPolicyUpdateBody = new Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.PlacementPolicyUpdate();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "vm-host placement policy affinity strength (should/must)")]
        ...
        public string AffinityStrength { get => _placementPolicyUpdateBody.AffinityStrength ?? null; set => _placementPolicyUpdateBody.AffinityStrength = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "placement policy azure hybrid benefit opt-in type")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.Category(global::Microsoft.Azure.PowerShell.Cmdlets.VMware.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string AzureHybridBenefitType { get => _placementPolicyUpdateBody.AzureHybridBenefitType ?? null; set => _placementPolicyUpdateBody.AzureHybridBenefitType = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IVMwareIdentity _clusterInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IVMwareIdentity ClusterInputObject { get => this._clusterInputObject; set => this._clusterInputObject = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Host members list")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.Category(global::Microsoft.Azure.PowerShell.Cmdlets.VMware.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] HostMember { get => _placementPolicyUpdateBody.HostMember?.ToArray() ?? null /* fixedArrayOf */; set => _placementPolicyUpdateBody.HostMember = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of the VMware vSphere Distributed Resource Scheduler (DRS) placement policy")]
        [Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("PlacementPolicyName")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.Category(global::Microsoft.Azure.PowerShell.Cmdlets.VMware.ParameterCategory.Path)]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Whether the placement policy is enabled or disabled")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.Category(global::Microsoft.Azure.PowerShell.Cmdlets.VMware.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string State { get => _placementPolicyUpdateBody.State ?? null; set => _placementPolicyUpdateBody.State = value; }

        /// <summary>Virtual machine members list</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Virtual machine members list")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.Category(global::Microsoft.Azure.PowerShell.Cmdlets.VMware.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] VMMember { get => _placementPolicyUpdateBody.VMMember?.ToArray() ?? null /* fixedArrayOf */; set => _placementPolicyUpdateBody.VMMember = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPlacementPolicy">Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPlacementPolicy</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPlacementPolicy> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzVMwarePlacementPolicy_UpdateViaIdentityClusterExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets.UpdateAzVMwarePlacementPolicy_UpdateViaIdentityClusterExpanded Clone()
        {
            var clone = new UpdateAzVMwarePlacementPolicy_UpdateViaIdentityClusterExpanded();
            ...
            clone._placementPolicyUpdateBody = this._placementPolicyUpdateBody;
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PlacementPoliciesUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.ClusterInputObject.Id += $"/placementPolicies/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.PlacementPoliciesUpdateViaIdentity(ClusterInputObject.Id, _placementPolicyUpdateBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        if (null == ClusterInputObject.PrivateCloudName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ClusterInputObject has null value for ClusterInputObject.PrivateCloudName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ClusterInputObject) );
                        }
                        if (null == ClusterInputObject.ClusterName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ClusterInputObject has null value for ClusterInputObject.ClusterName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ClusterInputObject) );
                        }
                        await this.Client.PlacementPoliciesUpdate(ClusterInputObject.SubscriptionId ?? null, ClusterInputObject.ResourceGroupName ?? null, ClusterInputObject.PrivateCloudName ?? null, ClusterInputObject.ClusterName ?? null, Name, _placementPolicyUpdateBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzVMwarePlacementPolicy_UpdateViaIdentityClusterExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzVMwarePlacementPolicy_UpdateViaIdentityClusterExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPlacementPolicy> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPlacementPolicy
