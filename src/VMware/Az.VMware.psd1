@{
  ...
  FunctionsToExport = 'Get-AzVMwareAddon', 'Get-AzVMwareCloudLink', 'Get-AzVMwareCluster', 'Get-AzVMwareExpressRouteAuthorization', 'Get-AzVMwareGlobalReachConnection', 'Get-AzVMwarePrivateCloud', 'Get-AzVMwarePrivateCloudAdminCredential', 'New-AzVMwareAddon', 'New-AzVMwareAddonSrmPropertiesObject', 'New-AzVMwareAddonVrPropertiesObject', 'New-AzVMwareCloudLink', 'New-AzVMwareCluster', 'New-AzVMwareExpressRouteAuthorization', 'New-AzVMwareGlobalReachConnection', 'New-AzVMwarePrivateCloud', 'New-AzVMwarePrivateCloudNsxtPassword', 'New-AzVMwarePrivateCloudVcenterPassword', 'New-AzVMwarePSCredentialExecutionParameterObject', 'New-AzVMwareScriptSecureStringExecutionParameterObject', 'New-AzVMwareScriptStringExecutionParameterObject', 'Remove-AzVMwareAddon', 'Remove-AzVMwareCloudLink', 'Remove-AzVMwareCluster', 'Remove-AzVMwareExpressRouteAuthorization', 'Remove-AzVMwareGlobalReachConnection', 'Remove-AzVMwarePrivateCloud', 'Test-AzVMwareLocationQuotaAvailability', 'Test-AzVMwareLocationTrialAvailability', 'Update-AzVMwareCluster', 'Update-AzVMwarePrivateCloud', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
