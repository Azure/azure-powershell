    ...
    function New-AzVMwareAddonVrPropertiesObject {
        [OutputType('Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20230301.AddonVrProperties')]
        ...
        process {
            $Object = [Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20230301.AddonVrProperties]::New()
