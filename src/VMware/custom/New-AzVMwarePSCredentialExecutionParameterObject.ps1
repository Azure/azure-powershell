    ...
    function New-AzVMwarePSCredentialExecutionParameterObject {
        [OutputType('Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20230301.PSCredentialExecutionParameter')]
        ...
        process {
            $Object = [Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20230301.PSCredentialExecutionParameter]::New()
