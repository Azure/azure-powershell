    ...
    function New-AzVMwareScriptStringExecutionParameterObject {
        [OutputType('Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20230301.ScriptStringExecutionParameter')]
        ...
        process {
            $Object = [Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Api20230301.ScriptStringExecutionParameter]::New()
