...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="SapAvailabilityZoneDetailsResult" />
    /// </summary>
    public partial class SapAvailabilityZoneDetailsResultTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <paramref name="sourceValue"/> parameter to the <see cref="SapAvailabilityZoneDetailsResult"/>
        /// type.
        /// </summary>
        /// <param name="sourceValue">the <see cref="System.Object" /> instance to check if it can be converted to the <see cref="SapAvailabilityZoneDetailsResult"
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="SapAvailabilityZoneDetailsResult" /> type, otherwise <c>false</c>
        /// </returns>
        ...
        /// <returns>
        /// an instance of <see cref="SapAvailabilityZoneDetailsResult" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public override object ConvertFrom(object sourceValue, global::System.Type destinationType, global::System.IFormatProvider formatProvider, bool ignoreCase) => ConvertFrom(sourceValue);

        /// <summary>
        /// Converts the <paramref name="sourceValue" /> parameter into an instance of <see cref="SapAvailabilityZoneDetailsResult"
        /// />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="SapAvailabilityZoneDetailsResult" />.</param>
        /// <returns>
        /// an instance of <see cref="SapAvailabilityZoneDetailsResult" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISapAvailabilityZoneDetailsResult ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                return SapAvailabilityZoneDetailsResult.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());;
            }
            catch
            {
            ...
            if (typeof(global::System.Management.Automation.PSObject).IsAssignableFrom(type))
            {
                return SapAvailabilityZoneDetailsResult.DeserializeFromPSObject(sourceValue);
            }
            if (typeof(global::System.Collections.IDictionary).IsAssignableFrom(type))
            {
                return SapAvailabilityZoneDetailsResult.DeserializeFromDictionary(sourceValue);
            }
            return null;
        }
