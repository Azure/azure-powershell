...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401
{
    ...
    public partial class VirtualMachineResourceNames :
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNames,
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesInternal
    {

        /// <summary>Backing field for <see cref="DataDiskName" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesDataDiskNames _dataDiskName;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesDataDiskNames DataDiskName { get => (this._dataDiskName = this._dataDiskName ?? new Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.VirtualMachineResourceNamesDataDiskNames()); set => this._dataDiskName = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.INetworkInterfaceResourceNames[] _networkInterface;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Workloads.Origin(Microsoft.Azure.PowerShell.Cmdlets.Workloads.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.INetworkInterfaceResourceNames[] NetworkInterface { get => this._networkInterface; set => this._networkInterface = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesDataDiskNames DataDiskName { get; set; }
        /// <summary>
        /// The full name for virtual-machine's host (computer name). Currently, ACSS only supports host names which are less than
        /// or equal to 13 characters long. If this value is not provided, vmName will be used as host name.
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.INetworkInterfaceResourceNames[] NetworkInterface { get; set; }
        /// <summary>
        /// The full name for OS disk attached to the VM. If this value is not provided, it will be named by ARM as per its default
        /// naming standards (prefixed with vm name). There is only one OS disk attached per Virtual Machine.
        /// </summary>
