...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401
{
    ...
    public partial class SapInstallWithoutOsconfigSoftwareConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISapInstallWithoutOsconfigSoftwareConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISapInstallWithoutOsconfigSoftwareConfigurationInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISoftwareConfiguration"
        /// />
        /// </summary>
        ...
        public string HighAvailabilitySoftwareConfigurationFencingClientId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IHighAvailabilitySoftwareConfigurationInternal)HighAvailabilitySoftwareConfiguration).FencingClientId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IHighAvailabilitySoftwareConfigurationInternal)HighAvailabilitySoftwareConfiguration).FencingClientId = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Workloads.Origin(Microsoft.Azure.PowerShell.Cmdlets.Workloads.PropertyOrigin.Inlined)]
        public string HighAvailabilitySoftwareConfigurationFencingClientPassword { get => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IHighAvailabilitySoftwareConfigurationInternal)HighAvailabilitySoftwareConfiguration).FencingClientPassword; set => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IHighAvailabilitySoftwareConfigurationInternal)HighAvailabilitySoftwareConfiguration).FencingClientPassword = value ?? null; }

        /// <summary>Internal Acessors for HighAvailabilitySoftwareConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IHighAvailabilitySoftwareConfiguration Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISapInstallWithoutOsconfigSoftwareConfigurationInternal.HighAvailabilitySoftwareConfiguration { get => (this._highAvailabilitySoftwareConfiguration = this._highAvailabilitySoftwareConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.HighAvailabilitySoftwareConfiguration()); set { {_highAvailabilitySoftwareConfiguration = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISoftwareConfigurationInternal
    {
        ...
        string BomUrl { get; set; }
        /// <summary>Gets or sets the HA software configuration.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IHighAvailabilitySoftwareConfiguration HighAvailabilitySoftwareConfiguration { get; set; }
        /// <summary>The fencing client id.</summary>
        string HighAvailabilitySoftwareConfigurationFencingClientId { get; set; }
        /// <summary>
        /// The fencing client id secret/password. The secret should never expire. This will be used pacemaker to start/stop the cluster
