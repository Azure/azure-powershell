...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401
{
    ...
    public partial class LinuxConfiguration
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ILinuxConfiguration.
        /// </summary>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject into a new instance of <see cref="LinuxConfiguration" />.
        /// </summary>
        ...
        internal LinuxConfiguration(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject json)
        {
            ...
            {_ssh = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject>("ssh"), out var __jsonSsh) ? Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.SshConfiguration.FromJson(__jsonSsh) : Ssh;}
            {_sshKeyPair = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject>("sshKeyPair"), out var __jsonSshKeyPair) ? Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.SshKeyPair.FromJson(__jsonSshKeyPair) : SshKeyPair;}
            {_disablePasswordAuthentication = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonBoolean>("disablePasswordAuthentication"), out var __jsonDisablePasswordAuthentication) ? (bool?)__jsonDisablePasswordAuthentication : DisablePasswordAuthentication;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="LinuxConfiguration" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="LinuxConfiguration" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.SerializationMode serializationMode)
        {
            ...
            __osConfiguration?.ToJson(container, serializationMode);
            AddIf( null != this._ssh ? (Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode) this._ssh.ToJson(null,serializationMode) : null, "ssh" ,container.Add );
            AddIf( null != this._sshKeyPair ? (Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode) this._sshKeyPair.ToJson(null,serializationMode) : null, "sshKeyPair" ,container.Add );
            AddIf( null != this._disablePasswordAuthentication ? (Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonBoolean((bool)this._disablePasswordAuthentication) : null, "disablePasswordAuthentication" ,container.Add );
