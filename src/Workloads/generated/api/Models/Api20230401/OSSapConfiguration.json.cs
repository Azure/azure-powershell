...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401
{
    ...
    public partial class OSSapConfiguration
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IOSSapConfiguration.
        /// </summary>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject into a new instance of <see cref="OSSapConfiguration" />.
        /// </summary>
        ...
        internal OSSapConfiguration(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject json)
        {
            ...
            {_deployerVMPackage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject>("deployerVmPackages"), out var __jsonDeployerVMPackages) ? Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.DeployerVMPackages.FromJson(__jsonDeployerVMPackages) : DeployerVMPackage;}
            {_sapFqdn = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonString>("sapFqdn"), out var __jsonSapFqdn) ? (string)__jsonSapFqdn : (string)SapFqdn;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="OSSapConfiguration" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="OSSapConfiguration" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._deployerVMPackage ? (Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode) this._deployerVMPackage.ToJson(null,serializationMode) : null, "deployerVmPackages" ,container.Add );
            AddIf( null != (((object)this._sapFqdn)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonString(this._sapFqdn.ToString()) : null, "sapFqdn" ,container.Add );
