...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401
{
    ...
    public partial class SingleServerFullResourceNames :
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISingleServerFullResourceNames,
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISingleServerFullResourceNamesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISingleServerCustomResourceNames"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISingleServerCustomResourceNames __singleServerCustomResourceNames = new Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.SingleServerCustomResourceNames();

        /// <summary>Internal Acessors for NamingPatternType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISingleServerCustomResourceNamesInternal.NamingPatternType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISingleServerCustomResourceNamesInternal)__singleServerCustomResourceNames).NamingPatternType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISingleServerCustomResourceNamesInternal)__singleServerCustomResourceNames).NamingPatternType = value; }

        /// <summary>Internal Acessors for VirtualMachine</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNames Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISingleServerFullResourceNamesInternal.VirtualMachine { get => (this._virtualMachine = this._virtualMachine ?? new Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.VirtualMachineResourceNames()); set { {_virtualMachine = value;} } }
        ...
        public string NamingPatternType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISingleServerCustomResourceNamesInternal)__singleServerCustomResourceNames).NamingPatternType; }
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNames VirtualMachine { get => (this._virtualMachine = this._virtualMachine ?? new Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.VirtualMachineResourceNames()); set => this._virtualMachine = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesDataDiskNames VirtualMachineDataDiskName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesInternal)VirtualMachine).DataDiskName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesInternal)VirtualMachine).DataDiskName = value ?? null /* model class */; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Workloads.Origin(Microsoft.Azure.PowerShell.Cmdlets.Workloads.PropertyOrigin.Inlined)]
        public string VirtualMachineHostName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesInternal)VirtualMachine).HostName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesInternal)VirtualMachine).HostName = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Workloads.Origin(Microsoft.Azure.PowerShell.Cmdlets.Workloads.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.INetworkInterfaceResourceNames[] VirtualMachineNetworkInterface { get => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesInternal)VirtualMachine).NetworkInterface; set => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesInternal)VirtualMachine).NetworkInterface = value ?? null /* arrayOf */; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Workloads.Origin(Microsoft.Azure.PowerShell.Cmdlets.Workloads.PropertyOrigin.Inlined)]
        public string VirtualMachineOSDiskName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesInternal)VirtualMachine).OSDiskName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesInternal)VirtualMachine).OSDiskName = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Workloads.Origin(Microsoft.Azure.PowerShell.Cmdlets.Workloads.PropertyOrigin.Inlined)]
        public string VirtualMachineVMName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesInternal)VirtualMachine).VMName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesInternal)VirtualMachine).VMName = value ?? null; }
    ...
    public partial interface ISingleServerFullResourceNames :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISingleServerCustomResourceNames
    {
        /// <summary>
        /// The full resource names for virtual machine data disks. This is a dictionary containing list of names of data disks per
        /// volume. Currently supported volumes for database layer are ['hana/data', 'hana/log', hana/shared', 'usr/sap', 'os', 'backup'].
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesDataDiskNames) })]
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IVirtualMachineResourceNamesDataDiskNames VirtualMachineDataDiskName { get; set; }
        /// <summary>
        /// The full name for virtual-machine's host (computer name). Currently, ACSS only supports host names which are less than
        /// or equal to 13 characters long. If this value is not provided, vmName will be used as host name.
        /// </summary>
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.INetworkInterfaceResourceNames) })]
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.INetworkInterfaceResourceNames[] VirtualMachineNetworkInterface { get; set; }
        /// <summary>
        /// The full name for OS disk attached to the VM. If this value is not provided, it will be named by ARM as per its default
        /// naming standards (prefixed with vm name). There is only one OS disk attached per Virtual Machine.
        /// </summary>
    ...
    internal partial interface ISingleServerFullResourceNamesInternal :
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISingleServerCustomResourceNamesInternal
    {
        /// <summary>The resource names object for virtual machine and related resources.</summary>
