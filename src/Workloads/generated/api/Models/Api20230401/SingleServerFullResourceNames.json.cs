...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401
{
    ...
    public partial class SingleServerFullResourceNames
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISingleServerFullResourceNames.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISingleServerFullResourceNames.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISingleServerFullResourceNames FromJson(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject json ? new SingleServerFullResourceNames(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject into a new instance of <see cref="SingleServerFullResourceNames" />.
        /// </summary>
        ...
        internal SingleServerFullResourceNames(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject json)
        {
            ...
            __singleServerCustomResourceNames = new Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.SingleServerCustomResourceNames(json);
            {_virtualMachine = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject>("virtualMachine"), out var __jsonVirtualMachine) ? Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.VirtualMachineResourceNames.FromJson(__jsonVirtualMachine) : VirtualMachine;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SingleServerFullResourceNames" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SingleServerFullResourceNames" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._virtualMachine ? (Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode) this._virtualMachine.ToJson(null,serializationMode) : null, "virtualMachine" ,container.Add );
