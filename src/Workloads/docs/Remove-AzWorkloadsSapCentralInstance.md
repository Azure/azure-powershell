...
online version: https://learn.microsoft.com/powershell/module/az.workloads/remove-azworkloadssapcentralinstance
schema: 2.0.0
---

# Remove-AzWorkloadsSapCentralInstance
...
### DeleteViaIdentity
```
Remove-AzWorkloadsSapCentralInstance -InputObject <IWorkloadsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
