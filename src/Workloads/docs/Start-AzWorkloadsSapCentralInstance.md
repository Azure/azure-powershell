...
### Start (Default)
```
Start-AzWorkloadsSapCentralInstance -CentralInstanceName <String> -ResourceGroupName <String>
...
### StartViaIdentity
```
Start-AzWorkloadsSapCentralInstance -InputObject <IWorkloadsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
