...
online version: https://learn.microsoft.com/powershell/module/az.workloads/new-azworkloadssapcentralinstance
schema: 2.0.0
---

# New-AzWorkloadsSapCentralInstance
...
```
New-AzWorkloadsSapCentralInstance -Name <String> -ResourceGroupName <String> -SapVirtualInstanceName <String>
