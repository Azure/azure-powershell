...
online version: https://learn.microsoft.com/powershell/module/az.workloads/stop-azworkloadssapapplicationserverinstance
schema: 2.0.0
---

# Stop-AzWorkloadsSapApplicationServerInstance
...
```
Stop-AzWorkloadsSapApplicationServerInstance -ApplicationInstanceName <String> -ResourceGroupName <String>
...
### StopViaIdentity
```
Stop-AzWorkloadsSapApplicationServerInstance -InputObject <IWorkloadsIdentity> -Body <IStopRequest>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopViaIdentityExpanded
```
Stop-AzWorkloadsSapApplicationServerInstance -InputObject <IWorkloadsIdentity>
