...
online version: https://learn.microsoft.com/powershell/module/az.workloads/remove-azworkloadssapdatabaseinstance
schema: 2.0.0
---

# Remove-AzWorkloadsSapDatabaseInstance
...
### DeleteViaIdentity
```
Remove-AzWorkloadsSapDatabaseInstance -InputObject <IWorkloadsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
