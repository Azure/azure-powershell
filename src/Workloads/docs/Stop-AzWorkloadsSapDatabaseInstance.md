...
```
Stop-AzWorkloadsSapDatabaseInstance -DatabaseInstanceName <String> -ResourceGroupName <String>
...
### StopViaIdentity
```
Stop-AzWorkloadsSapDatabaseInstance -InputObject <IWorkloadsIdentity> -Body <IStopRequest>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
