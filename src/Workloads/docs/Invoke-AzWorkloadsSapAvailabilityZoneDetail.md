...
online version: https://learn.microsoft.com/powershell/module/az.workloads/invoke-azworkloadssapavailabilityzonedetail
schema: 2.0.0
---

# Invoke-AzWorkloadsSapAvailabilityZoneDetail
...
### SapExpanded (Default)
```
Invoke-AzWorkloadsSapAvailabilityZoneDetail -Location <String> -AppLocation <String>
 -DatabaseType <SapDatabaseType> -SapProduct <SapProductType> [-SubscriptionId <String>]
...
Invoke-AzWorkloadsSapAvailabilityZoneDetail -InputObject <IWorkloadsIdentity> -AppLocation <String>
 -DatabaseType <SapDatabaseType> -SapProduct <SapProductType> [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISapAvailabilityZonePair
