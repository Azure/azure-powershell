...
.Link
https://learn.microsoft.com/powershell/module/az./new-AzWorkloadsMsSqlServerProviderInstanceObject
#>
function New-AzWorkloadsMsSqlServerProviderInstanceObject {
