...
function setupEnv() {
    ...
    $env.SapApplicationInstanceName = "vacssps1vm-2"
    $env.SapCentralInstanceName = "vacssps1vm-1"
    $env.SapDatabseInstanceName = "DS1"
    ...
    $env.CreateSingleSystemWithCustomResourceTrustedAccessSIDAlias = "AL1"
    $env.CreateDistributedSystemWithTrustedAccessNoTransShareSID = "PS2"
    $env.CreateDistributedSystemWithTrustedAccessNoTransShareSIDAlias = "AL2"
    $env.CreateDistributedHAAvZoneWithCustomResourceTrustedAccessTransShareSID = "PS3"
    $env.CreateDistributedHAAvZoneWithCustomResourceTrustedAccessTransShareSIDAlias = "AL3"
    $env.CreateDistributedHAAvSetDiffTransRgShareSID = "PS4"
    $env.CreateDistributedHAAvSetDiffTransRgShareSIDAlias = "AL4"
    $env.CreateSingleSystemWithNoTrustedAccessSID = "PS5"
    $env.CreateSingleSystemWithNoTrustedAccessSIDAlias = "AL5"
    ...
    $env.MrgRGName = "PS1-RG"
    $env.MrgSAName = "acssstoragel46"
    $env.MrgNetAccTypPrvt = "Private"
    $env.MrgNetAccTypPub = "Public"
    $env.CentralServerVmId = "/subscriptions/49d64d54-e966-4c46-a868-1999802b762c/resourcegroups/ps_cli_tf_rg/providers/microsoft.compute/virtualmachines/acssps1vm"
    $env.DeletionRG = "PS_CLI_TF_RG"
    $env.DeletionVIS = "PS1"
    $env.DeletionVISAlias = "AL1"
