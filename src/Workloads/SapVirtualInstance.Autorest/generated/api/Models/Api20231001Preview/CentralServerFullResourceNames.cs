...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview
{
    ...
    public partial class CentralServerFullResourceNames :
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.ICentralServerFullResourceNames,
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.ICentralServerFullResourceNamesInternal
    {
...

    {
        ...
        string AvailabilitySetName { get; set; }
        /// <summary>The resource names object for load balancer and related resources.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.ILoadBalancerResourceNames LoadBalancer { get; set; }
        /// <summary>
        /// The list of backend pool names. Currently, ACSS deploys only one backend pool and hence, size of this list should be 1
        /// </summary>
        string[] LoadBalancerBackendPoolName { get; set; }
