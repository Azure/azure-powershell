...
Import-Module -Name (Join-Path $PSScriptRoot './bin/Az.SapVirtualInstance.private.dll')
$instance = [Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Module]::Instance
