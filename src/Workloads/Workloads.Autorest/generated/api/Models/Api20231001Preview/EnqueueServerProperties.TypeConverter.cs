...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="EnqueueServerProperties" />
    /// </summary>
    public partial class EnqueueServerPropertiesTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <paramref name="sourceValue"/> parameter to the <see cref="EnqueueServerProperties"/>
        /// type.
        /// </summary>
        /// <param name="sourceValue">the <see cref="System.Object" /> instance to check if it can be converted to the <see cref="EnqueueServerProperties"
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="EnqueueServerProperties" /> type, otherwise <c>false</c>
        /// </returns>
        ...
        /// <returns>
        /// an instance of <see cref="EnqueueServerProperties" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public override object ConvertFrom(object sourceValue, global::System.Type destinationType, global::System.IFormatProvider formatProvider, bool ignoreCase) => ConvertFrom(sourceValue);

        /// <summary>
        /// Converts the <paramref name="sourceValue" /> parameter into an instance of <see cref="EnqueueServerProperties" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="EnqueueServerProperties" />.</param>
        /// <returns>
        /// an instance of <see cref="EnqueueServerProperties" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview.IEnqueueServerProperties ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                return EnqueueServerProperties.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());;
            }
            catch
            {
            ...
            if (typeof(global::System.Management.Automation.PSObject).IsAssignableFrom(type))
            {
                return EnqueueServerProperties.DeserializeFromPSObject(sourceValue);
            }
            if (typeof(global::System.Collections.IDictionary).IsAssignableFrom(type))
            {
                return EnqueueServerProperties.DeserializeFromDictionary(sourceValue);
            }
            return null;
        }
