...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview
{
    ...
    public partial class DiscoveryConfiguration
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject into a new instance of <see cref="DiscoveryConfiguration" />.
        /// </summary>
        ...
        internal DiscoveryConfiguration(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject json)
        {
            ...
            {_centralServerVMId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonString>("centralServerVmId"), out var __jsonCentralServerVMId) ? (string)__jsonCentralServerVMId : (string)CentralServerVMId;}
            {_managedRgStorageAccountName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonString>("managedRgStorageAccountName"), out var __jsonManagedRgStorageAccountName) ? (string)__jsonManagedRgStorageAccountName : (string)ManagedRgStorageAccountName;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview.IDiscoveryConfiguration.
        /// </summary>
        ...
        /// <summary>
        /// Serializes this instance of <see cref="DiscoveryConfiguration" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="DiscoveryConfiguration" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._centralServerVMId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonString(this._centralServerVMId.ToString()) : null, "centralServerVmId" ,container.Add );
            AddIf( null != (((object)this._managedRgStorageAccountName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonString(this._managedRgStorageAccountName.ToString()) : null, "managedRgStorageAccountName" ,container.Add );
