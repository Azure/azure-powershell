...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401
{
    ...
    public partial class SshPublicKey
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISshPublicKey.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISshPublicKey.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.ISshPublicKey FromJson(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject json ? new SshPublicKey(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject into a new instance of <see cref="SshPublicKey" />.
        /// </summary>
        ...
        internal SshPublicKey(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject json)
        {
            ...
            {_keyData = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonString>("keyData"), out var __jsonKeyData) ? (string)__jsonKeyData : (string)KeyData;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SshPublicKey" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SshPublicKey" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._keyData)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Workloads.Runtime.Json.JsonString(this._keyData.ToString()) : null, "keyData" ,container.Add );
