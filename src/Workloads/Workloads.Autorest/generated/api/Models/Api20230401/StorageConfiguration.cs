...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401
{
    ...
    public partial class StorageConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IStorageConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IStorageConfigurationInternal
    {

        /// <summary>Internal Acessors for TransportFileShareConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IFileShareConfiguration Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IStorageConfigurationInternal.TransportFileShareConfiguration { get => (this._transportFileShareConfiguration = this._transportFileShareConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.FileShareConfiguration()); set { {_transportFileShareConfiguration = value;} } }

        /// <summary>Backing field for <see cref="TransportFileShareConfiguration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IFileShareConfiguration _transportFileShareConfiguration;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support.ConfigurationType? TransportFileShareConfigurationType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IFileShareConfigurationInternal)TransportFileShareConfiguration).ConfigurationType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IFileShareConfigurationInternal)TransportFileShareConfiguration).ConfigurationType = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support.ConfigurationType)""); }
...

    {
        ...
        /// createAndMount flow if storage configuration is missing.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20230401.IFileShareConfiguration TransportFileShareConfiguration { get; set; }
        /// <summary>The type of file share config.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support.ConfigurationType? TransportFileShareConfigurationType { get; set; }
