...
Describe 'New-AzWorkloadsProviderSapNetWeaverInstanceObject' {
    It '__AllParameterSets' {
        $providerSetting = New-AzWorkloadsProviderSapNetWeaverInstanceObject -SapClientId 400 -SapPortNumber 8000 -SapHostFileEntry '["10.8.1.35 chascs00cl1.sap.contoso.com chascs00cl1","10.8.1.36 chaers01cl2.sap.contoso.com chaers01cl2","10.8.1.9 vchaa02l0c.sap.contoso.com vchaa02l0c","10.8.1.38 vchaa01l0c.sap.contoso.com vchaa01l0c"]' -SapHostname 10.8.1.9 -SapInstanceNr 00 -SapPassword 'Welcome@123' -SapSid CHA -SapUsername AMS_USER -SslPreference Disabled
