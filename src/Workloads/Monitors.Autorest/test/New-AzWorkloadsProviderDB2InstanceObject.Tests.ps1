...
Describe 'New-AzWorkloadsProviderDB2InstanceObject' {
    It '__AllParameterSets' {
        $providerSetting = New-AzWorkloadsProviderDB2InstanceObject -Name KLN -Password '' -Port 5912 -Username db2kln -Hostname 10.170.200.4 -SapSid KLN -SslPreference Disabled
