...
function setupEnv() {
    ...
    $env.WaaSSubscriptionId = "40449e6d-a5d2-40f1-a151-0b76f21a48c0"
    ...
    $env.HaMonitorSubnetRg = "AMS-E2E-Portal"
    $env.MonitorSubnetRg = "AMS-E2E-Portal"
    $env.MonitorRg = "ams-e2e-infra-rg-sql"
    $env.MonitorName = "ak-sql-test"
    $env.HaMonitorName = "ps-create-ha1"
    $env.CreateHaMonitorName = "tp-create-ha"
    $env.CreateMonitorName = "ps-create"
    $env.MonitorSubnet = "/subscriptions/$($env.WaaSSubscriptionId)/resourceGroups/$($env.MonitorSubnetRg)/providers/Microsoft.Network/virtualNetworks/ams-portal-e2e-vnet/subnets/ps-create-mon"
    $env.HaMonitorSubnet = "/subscriptions/$($env.WaaSSubscriptionId)/resourceGroups/$($env.HaMonitorSubnetRg)/providers/Microsoft.Network/virtualNetworks/ams-portal-e2e-vnet/subnets/ps-create-ha-mon"
    $env.haProviderName = "ha"
    $env.sqlProviderName = "sql"
    $env.nwProviderName = "nw"
    $env.hanaProviderName = "hana"
    $env.db2ProviderName = "db2"
    $env.osProviderName = "os"
