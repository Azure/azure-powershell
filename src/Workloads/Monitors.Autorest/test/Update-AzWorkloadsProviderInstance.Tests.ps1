if(($null -eq $TestName) -or ($TestName -contains 'Update-AzWorkloadsProviderInstance'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Update-AzWorkloadsProviderInstance.Recording.json'
