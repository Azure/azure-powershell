...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.Monitors.custom.psm1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: Monitors cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.Monitors.format.ps1xml'
