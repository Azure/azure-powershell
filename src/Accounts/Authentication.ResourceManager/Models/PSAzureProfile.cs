...
#endif
{
    ...
    public class PSAzureProfile
    {
        ...
        /// </summary>
        [Ps1Xml(Label = "Subscription name", Target = ViewControl.Table, ScriptBlock = "$_.Context.Subscription.Name", Position = 0)]
        [Ps1Xml(Label = "Tenant domain name", Target = ViewControl.Table, ScriptBlock = "$_.Context.Tenant.DefaultDomain", Position = 1)]
