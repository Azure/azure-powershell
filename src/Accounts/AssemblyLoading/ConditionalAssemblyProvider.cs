    ...
    public static class ConditionalAssemblyProvider
    {
        ...
        public static void Initialize(string rootPath, IConditionalAssemblyContext context)
        {
            ...
            _assemblies = new List<IConditionalAssembly>()
            {
                ...
                CreateAssembly("netstandard2.0", "Azure.Identity", "1.17.2.0"),
                CreateAssembly("netstandard2.0", "Microsoft.Bcl.AsyncInterfaces", "8.0.0.0"),
                CreateAssembly("netstandard2.0", "Microsoft.Identity.Client.Broker", "4.83.1.0"),
                CreateAssembly("netstandard2.0", "Microsoft.Identity.Client", "4.83.1.0"),
                CreateAssembly("netstandard2.0", "Microsoft.Identity.Client.Extensions.Msal", "4.83.1.0"),
                CreateAssembly("netstandard2.0", "Microsoft.Identity.Client.NativeInterop", "0.20.2.0"),
