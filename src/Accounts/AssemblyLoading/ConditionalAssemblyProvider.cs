    ...
    public static class ConditionalAssemblyProvider
    {
        ...
        public static void Initialize(string rootPath, IConditionalAssemblyContext context)
        {
            ...
            _assemblies = new List<IConditionalAssembly>()
            {
                ...
                #region AssemblyList
                CreateAssembly("netcoreapp2.1", "Azure.Core", "1.34.0.0").WithPowerShellCore(),
                CreateAssembly("netcoreapp2.1", "Microsoft.Identity.Client", "4.54.1.0").WithPowerShellCore(),
                CreateAssembly("netcoreapp3.1", "Microsoft.Identity.Client.Extensions.Msal", "2.31.0.0").WithPowerShellCore(),

                CreateAssembly("netstandard2.0", "Azure.Identity", "1.10.0.0"),
                ...
                CreateAssembly("netstandard2.0", "Microsoft.Identity.Client.Broker", "4.54.1.0"),
                ...
                CreateAssembly("netfx", "Azure.Core", "1.34.0.0").WithWindowsPowerShell(),
                CreateAssembly("netfx", "Microsoft.Identity.Client", "4.54.1.0").WithWindowsPowerShell(),
                CreateAssembly("netfx", "Microsoft.Identity.Client.Extensions.Msal", "2.31.0.0").WithWindowsPowerShell(),
