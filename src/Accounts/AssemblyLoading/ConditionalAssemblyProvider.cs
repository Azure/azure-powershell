    ...
    public static class ConditionalAssemblyProvider
    {
        ...
        public static void Initialize(string rootPath, IConditionalAssemblyContext context)
        {
            ...
            _assemblies = new List<IConditionalAssembly>()
            {
                ...
                CreateAssembly("netstandard2.0", "Microsoft.Identity.Client", "4.62.0.0"),
                CreateAssembly("netstandard2.0", "Microsoft.Identity.Client.Extensions.Msal", "4.62.0.0"),
                CreateAssembly("netstandard2.0", "Microsoft.Identity.Client.Broker", "4.62.0.0"),
