    ...
    public static class ConditionalAssemblyProvider
    {
        ...
        public static void Initialize(string rootPath, IConditionalAssemblyContext context)
        {
            ...
            _assemblies = new List<IConditionalAssembly>()
            {
                ...
                CreateAssembly("netstandard2.0", "Azure.Core", "1.54.0.0"),
                ...
                CreateAssembly("netstandard2.0", "Microsoft.Identity.Client.Broker", "4.83.3.0"),
                CreateAssembly("netstandard2.0", "Microsoft.Identity.Client", "4.83.3.0"),
                CreateAssembly("netstandard2.0", "Microsoft.Identity.Client.Extensions.Msal", "4.83.3.0"),
                ...
                CreateAssembly("netstandard2.0", "System.ClientModel", "1.10.0.0"),
