...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated the ''-AzureKeyVaultDnsSuffix'' help text of ''Add-AzEnvironment'' and ''Set-AzEnvironment'' to describe the expected format instead of a specific host name.
