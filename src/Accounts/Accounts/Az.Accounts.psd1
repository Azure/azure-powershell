...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed ''Get-AzSubscription'' to throw a clear error instead of silently returning nothing when ''-TenantId'' does not match the current context under Managed Service Identity (MSI) authentication. [#25710]'
