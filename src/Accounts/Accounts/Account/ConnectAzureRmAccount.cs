...
namespace Microsoft.Azure.Commands.Profile
{
    ...
    public class ConnectAzureRmAccountCommand : AzureContextModificationCmdlet, IModuleAssemblyInitializer
    {
        ...
        [Parameter(ParameterSetName = ManagedServiceParameterSet,
                    Mandatory = false, HelpMessage = "Account Id for managed service is the associated client id of UserAssigned identity. To use the SystemAssigned identity, leave this field blank.")]
        [ValidateNotNullOrEmpty]
