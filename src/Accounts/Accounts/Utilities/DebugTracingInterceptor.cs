...
{
    public class DebugTracingInterceptor : ICloudTracingInterceptor
    {
        public DebugTracingInterceptor(Action<string> output)
        {
            traceOutput = output;
        }

        public Action<string> traceOutput;
        ...
        public static void AddToContext(DebugTracingInterceptor interceptor)
        {
            RemoveFromContext(interceptor);
            TracingAdapter.AddTracingInterceptor(interceptor);
        }

        public static void RemoveFromContext(DebugTracingInterceptor interceptor)
        {
            try
            {
