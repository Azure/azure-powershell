...
online version: https://learn.microsoft.com/powershell/module/az.discovery/update-azdiscoverybookshelfprivateendpointconnection
schema: 2.0.0
---

# Update-AzDiscoveryBookshelfPrivateEndpointConnection
...
```
Update-AzDiscoveryBookshelfPrivateEndpointConnection -BookshelfName <String>
...
### UpdateViaIdentityBookshelfExpanded
```
Update-AzDiscoveryBookshelfPrivateEndpointConnection -BookshelfInputObject <IDiscoveryIdentity>
...
```
Update-AzDiscoveryBookshelfPrivateEndpointConnection -InputObject <IDiscoveryIdentity>
 [-PrivateLinkServiceConnectionStateActionsRequired <String>]
 [-PrivateLinkServiceConnectionStateDescription <String>] [-PrivateLinkServiceConnectionStateStatus <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Parameter Sets: UpdateViaIdentityBookshelfExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityBookshelfExpanded
Aliases:
