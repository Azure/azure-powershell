...
```
Update-AzDiscoveryChatModelDeployment -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
 [-SubscriptionId <String>] [-Capacity <Int32>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob]
...
Update-AzDiscoveryChatModelDeployment -Name <String> -WorkspaceInputObject <IDiscoveryIdentity>
 [-Capacity <Int32>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
