...
### List (Default)
```
Get-AzDiscoveryWorkspacePrivateLinkResource -ResourceGroupName <String> -WorkspaceName <String>
...
Get-AzDiscoveryWorkspacePrivateLinkResource -PrivateLinkResourceName <String>
 -WorkspaceInputObject <IDiscoveryIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
