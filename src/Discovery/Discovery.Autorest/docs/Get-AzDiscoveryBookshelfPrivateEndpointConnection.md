...
```
Get-AzDiscoveryBookshelfPrivateEndpointConnection -BookshelfInputObject <IDiscoveryIdentity>
 -PrivateEndpointConnectionName <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
