...
New-AzDiscoveryStorageAsset -Name <String> -ResourceGroupName <String> -StorageContainerName <String>
 -Location <String> [-SubscriptionId <String>] [-Description <String>] [-Path <String>] [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityStorageContainerExpanded
```
New-AzDiscoveryStorageAsset -Name <String> -StorageContainerInputObject <IDiscoveryIdentity>
 -Location <String> [-Description <String>] [-Path <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
