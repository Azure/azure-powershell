...
```
New-AzDiscoveryNodePool -Name <String> -ResourceGroupName <String> -SupercomputerName <String>
 -Location <String> [-SubscriptionId <String>] [-ImageCacheLowerThreshold <Int32>]
