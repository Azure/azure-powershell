...
online version: https://learn.microsoft.com/powershell/module/az.discovery/update-azdiscoverystorageasset
schema: 2.0.0
---

# Update-AzDiscoveryStorageAsset
...
```
Update-AzDiscoveryStorageAsset -Name <String> -ResourceGroupName <String> -StorageContainerName <String>
...
```
Update-AzDiscoveryStorageAsset -InputObject <IDiscoveryIdentity> [-Description <String>] [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityStorageContainerExpanded
```
Update-AzDiscoveryStorageAsset -Name <String> -StorageContainerInputObject <IDiscoveryIdentity>
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded, UpdateViaIdentityStorageContainerExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityStorageContainerExpanded, UpdateViaJsonFilePath, UpdateViaJsonString
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Discovery.Models.IDiscoveryIdentity
Parameter Sets: UpdateViaIdentityStorageContainerExpanded
Aliases:
