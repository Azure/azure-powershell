...
online version: https://learn.microsoft.com/powershell/module/az.discovery/get-azdiscoverybookshelfprivatelinkresource
schema: 2.0.0
---

# Get-AzDiscoveryBookshelfPrivateLinkResource
...
### List (Default)
```
Get-AzDiscoveryBookshelfPrivateLinkResource -BookshelfName <String> -ResourceGroupName <String>
...
### Get
```
Get-AzDiscoveryBookshelfPrivateLinkResource -BookshelfName <String> -PrivateLinkResourceName <String>
...
```
Get-AzDiscoveryBookshelfPrivateLinkResource -PrivateLinkResourceName <String>
...
### GetViaIdentity
```
Get-AzDiscoveryBookshelfPrivateLinkResource -InputObject <IDiscoveryIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
