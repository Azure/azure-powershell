...
```
New-AzDiscoveryStorageContainer -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Location <String> [-StorageStoreKind <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob]
