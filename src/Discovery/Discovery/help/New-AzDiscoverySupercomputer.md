...
```
New-AzDiscoverySupercomputer -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Location <String> [-ClusterIdentityId <String>] [-CustomerManagedKey <String>]
