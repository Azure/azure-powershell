...
```
New-AzDiscoveryBookshelfPrivateEndpointConnection -PrivateEndpointConnectionName <String>
 -BookshelfName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
New-AzDiscoveryBookshelfPrivateEndpointConnection -PrivateEndpointConnectionName <String>
 -BookshelfName <String> -ResourceGroupName <String> [-SubscriptionId <String>] -JsonString <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
New-AzDiscoveryBookshelfPrivateEndpointConnection -PrivateEndpointConnectionName <String>
 -BookshelfName <String> -ResourceGroupName <String> [-SubscriptionId <String>] -JsonFilePath <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
New-AzDiscoveryBookshelfPrivateEndpointConnection -PrivateEndpointConnectionName <String>
 -BookshelfInputObject <IDiscoveryIdentity> [-PrivateLinkServiceConnectionStateActionsRequired <String>]
 [-PrivateLinkServiceConnectionStateDescription <String>] [-PrivateLinkServiceConnectionStateStatus <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
