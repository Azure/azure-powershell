...
online version: https://learn.microsoft.com/powershell/module/az.discovery/update-azdiscoverysupercomputer
schema: 2.0.0
---

# Update-AzDiscoverySupercomputer
...
```
Update-AzDiscoverySupercomputer -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-EnableSystemAssignedIdentity <Boolean>] [-IdentityWorkloadIdentity <Hashtable>] [-Tag <Hashtable>]
...
```
Update-AzDiscoverySupercomputer -InputObject <IDiscoveryIdentity> [-EnableSystemAssignedIdentity <Boolean>]
 [-IdentityWorkloadIdentity <Hashtable>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
