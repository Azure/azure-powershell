...
online version: https://learn.microsoft.com/powershell/module/az.discovery/update-azdiscoverystoragecontainer
schema: 2.0.0
---

# Update-AzDiscoveryStorageContainer
...
```
Update-AzDiscoveryStorageContainer -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzDiscoveryStorageContainer -InputObject <IDiscoveryIdentity> [-Tag <Hashtable>]
