...
online version: https://learn.microsoft.com/powershell/module/az.discovery/update-azdiscoverychatmodeldeployment
schema: 2.0.0
---

# Update-AzDiscoveryChatModelDeployment
...
```
Update-AzDiscoveryChatModelDeployment -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -WorkspaceName <String> [-Capacity <Int32>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```
Update-AzDiscoveryChatModelDeployment -Name <String> -WorkspaceInputObject <IDiscoveryIdentity>
 [-Capacity <Int32>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzDiscoveryChatModelDeployment -InputObject <IDiscoveryIdentity> [-Capacity <Int32>] [-Tag <Hashtable>]
