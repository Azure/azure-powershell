...
### List (Default)
```
Get-AzDiscoveryNodePool -ResourceGroupName <String> [-SubscriptionId <String[]>] -SupercomputerName <String>
...
### Get
```
Get-AzDiscoveryNodePool -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 -SupercomputerName <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDiscoveryNodePool -InputObject <IDiscoveryIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: GetViaIdentitySupercomputer, Get
