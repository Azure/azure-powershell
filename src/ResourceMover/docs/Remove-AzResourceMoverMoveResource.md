...
## SYNOPSIS
Deletes a Move Resource from the move collection. The 'Remove-AzResourceMoverMoveResource' command remains same for both 'RegionToRegion' and 'RegionToZone' type move collections.
