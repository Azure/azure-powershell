...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801
{
    ...
    public partial class NetworkInterfaceResourceSettings :
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.INetworkInterfaceResourceSettings,
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.INetworkInterfaceResourceSettingsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.IValidates
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.INicIPConfigurationResourceSettings[] _iPConfiguration;

        /// <summary>Gets or sets the IP configurations of the NIC.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Origin(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.INicIPConfigurationResourceSettings[] IPConfiguration { get => this._iPConfiguration; set => this._iPConfiguration = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.INetworkInterfaceResourceSettingsTags _tag;

        /// <summary>Gets or sets the Resource tags.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Origin(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.INetworkInterfaceResourceSettingsTags Tag { get => (this._tag = this._tag ?? new Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.NetworkInterfaceResourceSettingsTags()); set => this._tag = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IResourceSettings
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.INicIPConfigurationResourceSettings) })]
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.INicIPConfigurationResourceSettings[] IPConfiguration { get; set; }
        /// <summary>Gets or sets the Resource tags.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.INetworkInterfaceResourceSettingsTags) })]
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.INetworkInterfaceResourceSettingsTags Tag { get; set; }
