...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801
{
    ...
    public partial class MoveResourceDependency :
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IMoveResourceDependency,
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IMoveResourceDependencyInternal
    {

        /// <summary>Backing field for <see cref="AutomaticResolution" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IAutomaticResolutionProperties _automaticResolution;

        /// <summary>Defines the properties for automatic resolution.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Origin(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IAutomaticResolutionProperties AutomaticResolution { get => (this._automaticResolution = this._automaticResolution ?? new Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.AutomaticResolutionProperties()); set => this._automaticResolution = value; }
        ...
        public string AutomaticResolutionMoveResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IAutomaticResolutionPropertiesInternal)AutomaticResolution).MoveResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IAutomaticResolutionPropertiesInternal)AutomaticResolution).MoveResourceId = value ?? null; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IManualResolutionProperties _manualResolution;

        /// <summary>Defines the properties for manual resolution.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Origin(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IManualResolutionProperties ManualResolution { get => (this._manualResolution = this._manualResolution ?? new Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.ManualResolutionProperties()); set => this._manualResolution = value; }

        /// <summary>
        /// Gets or sets the target resource ARM ID of the dependent resource if the resource type is Manual.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Origin(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.PropertyOrigin.Inlined)]
        public string ManualResolutionTargetId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IManualResolutionPropertiesInternal)ManualResolution).TargetId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IManualResolutionPropertiesInternal)ManualResolution).TargetId = value ?? null; }

        /// <summary>Internal Acessors for AutomaticResolution</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IAutomaticResolutionProperties Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IMoveResourceDependencyInternal.AutomaticResolution { get => (this._automaticResolution = this._automaticResolution ?? new Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.AutomaticResolutionProperties()); set { {_automaticResolution = value;} } }

        /// <summary>Internal Acessors for ManualResolution</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IManualResolutionProperties Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IMoveResourceDependencyInternal.ManualResolution { get => (this._manualResolution = this._manualResolution ?? new Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.ManualResolutionProperties()); set { {_manualResolution = value;} } }
    ...
    {
        /// <summary>Defines the properties for automatic resolution.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IAutomaticResolutionProperties AutomaticResolution { get; set; }
        /// <summary>
        /// Gets the MoveResource ARM ID of
        /// the dependent resource if the resolution type is Automatic.
        /// </summary>
        ...
        string IsOptional { get; set; }
        /// <summary>Defines the properties for manual resolution.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.Api20210801.IManualResolutionProperties ManualResolution { get; set; }
        /// <summary>
        /// Gets or sets the target resource ARM ID of the dependent resource if the resource type is Manual.
        /// </summary>
        string ManualResolutionTargetId { get; set; }
