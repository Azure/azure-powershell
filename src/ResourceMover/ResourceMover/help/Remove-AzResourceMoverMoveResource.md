...
### Delete (Default)
```
Remove-AzResourceMoverMoveResource -Name <String> -MoveCollectionName <String> -ResourceGroupName <String>
...
```
Remove-AzResourceMoverMoveResource -Name <String> -MoveCollectionInputObject <IResourceMoverIdentity>
