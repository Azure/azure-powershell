...
online version: https://learn.microsoft.com/powershell/module/az.lambdatest/remove-azlambdatestorganization
schema: 2.0.0
---

# Remove-AzLambdaTestOrganization
...
### Delete (Default)
```
Remove-AzLambdaTestOrganization -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzLambdaTestOrganization -InputObject <ILambdaTestIdentity> [-DefaultProfile <PSObject>] [-AsJob]
