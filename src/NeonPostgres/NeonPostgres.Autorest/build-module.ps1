...
$dll = Join-Path $PSScriptRoot 'bin\Az.NeonPostgres.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.NeonPostgres.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.NeonPostgres.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.NeonPostgres'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: NeonPostgres cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.NeonPostgres.format.ps1xml'
