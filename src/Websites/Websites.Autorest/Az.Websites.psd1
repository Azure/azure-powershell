@{
  ...
  FunctionsToExport = 'Get-AzStaticWebApp', 'Get-AzStaticWebAppBuild', 'Get-AzStaticWebAppBuildAppSetting', 'Get-AzStaticWebAppBuildFunction', 'Get-AzStaticWebAppBuildFunctionAppSetting', 'Get-AzStaticWebAppConfiguredRole', 'Get-AzStaticWebAppCustomDomain', 'Get-AzStaticWebAppFunction', 'Get-AzStaticWebAppFunctionAppSetting', 'Get-AzStaticWebAppSecret', 'Get-AzStaticWebAppSetting', 'Get-AzStaticWebAppUser', 'Get-AzStaticWebAppUserProvidedFunctionApp', 'Get-AzWebAppContinuousWebJob', 'Get-AzWebAppSlotContinuousWebJob', 'New-AzStaticWebApp', 'New-AzStaticWebAppBuildAppSetting', 'New-AzStaticWebAppBuildFunctionAppSetting', 'New-AzStaticWebAppCustomDomain', 'New-AzStaticWebAppFunctionAppSetting', 'New-AzStaticWebAppSetting', 'New-AzStaticWebAppUserRoleInvitationLink', 'Register-AzStaticWebAppUserProvidedFunctionApp', 'Remove-AzStaticWebApp', 'Remove-AzStaticWebAppAttachedRepository', 'Remove-AzStaticWebAppBuild', 'Remove-AzStaticWebAppCustomDomain', 'Remove-AzStaticWebAppUser', 'Remove-AzWebAppContinuousWebJob', 'Remove-AzWebAppSlotContinuousWebJob', 'Reset-AzStaticWebAppApiKey', 'Start-AzWebAppContinuousWebJob', 'Start-AzWebAppSlotContinuousWebJob', 'Stop-AzWebAppContinuousWebJob', 'Stop-AzWebAppSlotContinuousWebJob', 'Test-AzStaticWebAppCustomDomain', 'Unregister-AzStaticWebAppBuildUserProvidedFunctionApp', 'Unregister-AzStaticWebAppUserProvidedFunctionApp', 'Update-AzStaticWebApp', 'Update-AzStaticWebAppUser', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
