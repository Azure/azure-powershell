...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListTriggeredWebJobsSlot=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/triggeredwebjobs"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzWebAppSlotTriggeredWebJob_List")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzWebAppSlotTriggeredWebJob_List" /> cmdlet class.
        /// </summary>
        public GetAzWebAppSlotTriggeredWebJob_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.WebAppsListTriggeredWebJobsSlot(ResourceGroupName, AppName, SlotName, SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.WebAppsListTriggeredWebJobsSlot_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
