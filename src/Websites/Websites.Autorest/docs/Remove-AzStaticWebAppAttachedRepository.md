...
online version: https://docs.microsoft.com/en-us/powershell/module/az.websites/remove-azstaticwebappattachedrepository
schema: 2.0.0
---
...
### DetachViaIdentity
```
Remove-AzStaticWebAppAttachedRepository -InputObject <IWebsitesIdentity> [-DefaultProfile <PSObject>]
