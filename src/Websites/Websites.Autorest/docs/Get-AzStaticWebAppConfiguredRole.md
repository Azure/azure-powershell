...
online version: https://docs.microsoft.com/en-us/powershell/module/az.websites/get-azstaticwebappconfiguredrole
schema: 2.0.0
---
...
```powershell
PS C:\\> Get-AzStaticWebAppConfiguredRole -ResourceGroupName lucas-rg-test -Name staticweb-portal04
