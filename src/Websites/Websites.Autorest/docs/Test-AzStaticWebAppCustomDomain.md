...
```yaml
Type: System.String
Parameter Sets: Validate, ValidateExpanded, ValidateViaIdentityStaticSite, ValidateViaIdentityStaticSiteExpanded, ValidateViaJsonFilePath, ValidateViaJsonString
Aliases:
...
```yaml
Type: System.String
Parameter Sets: ValidateExpanded, ValidateViaIdentityExpanded, ValidateViaIdentityStaticSiteExpanded
Aliases:
...
Parameter Sets: Validate, ValidateViaIdentity, ValidateViaIdentityStaticSite
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IWebsitesIdentity
Parameter Sets: ValidateViaIdentityStaticSite, ValidateViaIdentityStaticSiteExpanded
Aliases:
