...
online version: https://docs.microsoft.com/en-us/powershell/module/az.websites/set-azwebsitesstaticsitebuildfunctionappsetting
schema: 2.0.0
---

# Set-AzWebsitesStaticSiteBuildFunctionAppSetting
...
```
Set-AzWebsitesStaticSiteBuildFunctionAppSetting -Name <String> -PrId <String> -ResourceGroupName <String>
