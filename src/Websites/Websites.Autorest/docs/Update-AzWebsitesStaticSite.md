...
online version: https://docs.microsoft.com/en-us/powershell/module/az.websites/update-azwebsitesstaticsite
schema: 2.0.0
---

# Update-AzWebsitesStaticSite
...
```
Update-AzWebsitesStaticSite -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### Update
```
Update-AzWebsitesStaticSite -Name <String> -ResourceGroupName <String>
...
### UpdateViaIdentity
```
Update-AzWebsitesStaticSite -InputObject <IWebsitesIdentity> -StaticSiteEnvelope <IStaticSitePatchResource>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzWebsitesStaticSite -InputObject <IWebsitesIdentity> [-Branch <String>]
