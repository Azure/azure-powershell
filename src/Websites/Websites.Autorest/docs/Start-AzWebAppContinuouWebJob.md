...
online version: https://docs.microsoft.com/powershell/module/az.websites/start-azwebappcontinuouwebjob
schema: 2.0.0
---

# Start-AzWebAppContinuouWebJob
...
### StartViaIdentity
```
Start-AzWebAppContinuouWebJob -InputObject <IWebsitesIdentity> [-DefaultProfile <PSObject>] [-PassThru]
