...
online version: https://docs.microsoft.com/en-us/powershell/module/az.websites/new-azwebsitesstaticsitefunctionappsetting
schema: 2.0.0
---
...
```
New-AzWebsitesStaticSiteFunctionAppSetting -Name <String> -ResourceGroupName <String>
...
### CreateViaIdentity
```
New-AzWebsitesStaticSiteFunctionAppSetting -InputObject <IWebsitesIdentity> -AppSetting <IStringDictionary>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzWebsitesStaticSiteFunctionAppSetting -InputObject <IWebsitesIdentity> [-Kind <String>]
