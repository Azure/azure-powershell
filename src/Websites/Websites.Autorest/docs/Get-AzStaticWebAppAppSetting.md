...
online version: https://docs.microsoft.com/en-us/powershell/module/az.websites/get-azstaticwebappappsetting
schema: 2.0.0
---

# Get-AzStaticWebAppAppSetting
...
```
Get-AzStaticWebAppAppSetting -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
