...
online version: https://docs.microsoft.com/en-us/powershell/module/az.websites/set-azwebsitesstaticsitefunctionappsetting
schema: 2.0.0
---

# Set-AzWebsitesStaticSiteFunctionAppSetting
...
```
Set-AzWebsitesStaticSiteFunctionAppSetting -Name <String> -ResourceGroupName <String>
