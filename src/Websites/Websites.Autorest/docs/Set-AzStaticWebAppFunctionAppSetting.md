...
online version: https://docs.microsoft.com/en-us/powershell/module/az.websites/set-azstaticwebappfunctionappsetting
schema: 2.0.0
---

# Set-AzStaticWebAppFunctionAppSetting
...
```
Set-AzStaticWebAppFunctionAppSetting -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### Update
```
Set-AzStaticWebAppFunctionAppSetting -Name <String> -ResourceGroupName <String>
