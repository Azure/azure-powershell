...
online version: https://docs.microsoft.com/en-us/powershell/module/az.websites/set-azstaticwebapp
schema: 2.0.0
---
...
```
Set-AzStaticWebApp -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
...
### Update
```
Set-AzStaticWebApp -Name <String> -ResourceGroupName <String> -StaticSiteEnvelope <IStaticSiteArmResource>
