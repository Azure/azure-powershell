...
online version: https://docs.microsoft.com/en-us/powershell/module/az.websites/new-azwebsitesstaticsite
schema: 2.0.0
---

# New-AzWebsitesStaticSite
...
```
New-AzWebsitesStaticSite -Name <String> -ResourceGroupName <String> -Location <String>
...
### Create
```
New-AzWebsitesStaticSite -Name <String> -ResourceGroupName <String>
...
### CreateViaIdentity
```
New-AzWebsitesStaticSite -InputObject <IWebsitesIdentity> -StaticSiteEnvelope <IStaticSiteArmResource>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzWebsitesStaticSite -InputObject <IWebsitesIdentity> -Location <String> [-Branch <String>]
