...
online version: https://docs.microsoft.com/en-us/powershell/module/az.websites/new-azwebsitesstaticsitebuildfunctionappsetting
schema: 2.0.0
---

# New-AzWebsitesStaticSiteBuildFunctionAppSetting
...
```
New-AzWebsitesStaticSiteBuildFunctionAppSetting -Name <String> -PrId <String> -ResourceGroupName <String>
...
### CreateViaIdentity
```
New-AzWebsitesStaticSiteBuildFunctionAppSetting -InputObject <IWebsitesIdentity>
 -AppSetting <IStringDictionary> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzWebsitesStaticSiteBuildFunctionAppSetting -InputObject <IWebsitesIdentity> [-Kind <String>]
