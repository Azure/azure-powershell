...
online version: https://docs.microsoft.com/en-us/powershell/module/az.websites/invoke-azwebsitespreviewstaticsiteworkflow
schema: 2.0.0
---

# Invoke-AzWebsitesPreviewStaticSiteWorkflow
...
```
Invoke-AzWebsitesPreviewStaticSiteWorkflow -Location <String> [-SubscriptionId <String>] [-Branch <String>]
...
### Preview
```
Invoke-AzWebsitesPreviewStaticSiteWorkflow -Location <String>
...
### PreviewViaIdentity
```
Invoke-AzWebsitesPreviewStaticSiteWorkflow -InputObject <IWebsitesIdentity>
...
```
Invoke-AzWebsitesPreviewStaticSiteWorkflow -InputObject <IWebsitesIdentity> [-Branch <String>]
 [-BuildPropertyApiLocation <String>] [-BuildPropertyAppArtifactLocation <String>]
 [-BuildPropertyAppLocation <String>] [-Kind <String>] [-RepositoryUrl <String>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
