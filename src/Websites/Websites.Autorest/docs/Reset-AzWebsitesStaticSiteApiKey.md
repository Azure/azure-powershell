...
online version: https://docs.microsoft.com/en-us/powershell/module/az.websites/reset-azwebsitesstaticsiteapikey
schema: 2.0.0
---

# Reset-AzWebsitesStaticSiteApiKey
...
```
Reset-AzWebsitesStaticSiteApiKey -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### Reset
```
Reset-AzWebsitesStaticSiteApiKey -Name <String> -ResourceGroupName <String>
...
### ResetViaIdentity
```
Reset-AzWebsitesStaticSiteApiKey -InputObject <IWebsitesIdentity>
...
```
Reset-AzWebsitesStaticSiteApiKey -InputObject <IWebsitesIdentity> [-Kind <String>] [-RepositoryToken <String>]
