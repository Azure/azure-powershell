...
online version: https://docs.microsoft.com/en-us/powershell/module/az.websites/remove-azstaticwebapp
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzStaticWebApp -InputObject <IWebsitesIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
