...
online version: https://docs.microsoft.com/en-us/powershell/module/az.websites/remove-azstaticwebappcustomdomain
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzStaticWebAppCustomDomain -InputObject <IWebsitesIdentity> [-DefaultProfile <PSObject>] [-PassThru]
