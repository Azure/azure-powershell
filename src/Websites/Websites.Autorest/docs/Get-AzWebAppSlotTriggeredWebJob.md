...
Get-AzWebAppSlotTriggeredWebJob -AppName <String> -Name <String> -ResourceGroupName <String>
 -SlotName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### GetViaIdentitySite
```
Get-AzWebAppSlotTriggeredWebJob -Name <String> -SiteInputObject <IWebsitesIdentity> -SlotName <String>
