...
online version: https://docs.microsoft.com/en-us/powershell/module/az.websites/new-azwebsitesstaticsiteuserroleinvitationlink
schema: 2.0.0
---

# New-AzWebsitesStaticSiteUserRoleInvitationLink
...
```
New-AzWebsitesStaticSiteUserRoleInvitationLink -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-Domain <String>] [-Kind <String>] [-NumHoursToExpiration <Int32>]
 [-Provider <String>] [-Role <String>] [-UserDetail <String>] [-DefaultProfile <PSObject>] [-Confirm]
...
### CreateViaIdentity
```
New-AzWebsitesStaticSiteUserRoleInvitationLink -InputObject <IWebsitesIdentity>
...
```
New-AzWebsitesStaticSiteUserRoleInvitationLink -InputObject <IWebsitesIdentity> [-Domain <String>]
 [-Kind <String>] [-NumHoursToExpiration <Int32>] [-Provider <String>] [-Role <String>] [-UserDetail <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
