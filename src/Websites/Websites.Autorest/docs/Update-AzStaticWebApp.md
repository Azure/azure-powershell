...
```
Update-AzStaticWebApp -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] [-Branch <String>]
 [-BuildPropertyApiLocation <String>] [-BuildPropertyAppArtifactLocation <String>]
 [-BuildPropertyAppLocation <String>] [-Kind <String>] [-RepositoryToken <String>] [-RepositoryUrl <String>]
...
Update-AzStaticWebApp -InputObject <IWebsitesIdentity> [-Branch <String>] [-BuildPropertyApiLocation <String>]
 [-BuildPropertyAppArtifactLocation <String>] [-BuildPropertyAppLocation <String>] [-Kind <String>]
 [-RepositoryToken <String>] [-RepositoryUrl <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
