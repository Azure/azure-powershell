...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Helper.Network.Models
{
    ...
    public partial class ServiceTagInformationPropertiesFormat
    {
        ...
        /// </param>
        public ServiceTagInformationPropertiesFormat(string changeNumber = default(string), string region = default(string), string systemService = default(string), System.Collections.Generic.IList<string> addressPrefixes = default(System.Collections.Generic.IList<string>))
