...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Helper.Network.Models
{
    ...
    public partial class SecurityRulePropertiesFormat
    {
        ...
        public SecurityRulePropertiesFormat(string protocol, string access, string direction, string description = default(string), string sourcePortRange = default(string), string destinationPortRange = default(string), string sourceAddressPrefix = default(string), System.Collections.Generic.IList<string> sourceAddressPrefixes = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<ApplicationSecurityGroup> sourceApplicationSecurityGroups = default(System.Collections.Generic.IList<ApplicationSecurityGroup>), string destinationAddressPrefix = default(string), System.Collections.Generic.IList<string> destinationAddressPrefixes = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<ApplicationSecurityGroup> destinationApplicationSecurityGroups = default(System.Collections.Generic.IList<ApplicationSecurityGroup>), System.Collections.Generic.IList<string> sourcePortRanges = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<string> destinationPortRanges = default(System.Collections.Generic.IList<string>), int? priority = default(int?), string provisioningState = default(string))
