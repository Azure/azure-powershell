...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Helper.PrivateDns.Models
{
    ...
    public partial class VirtualNetworkLinkProperties
    {
        ...
        public VirtualNetworkLinkProperties(SubResource virtualNetwork = default(SubResource), bool? registrationEnabled = default(bool?), string virtualNetworkLinkState = default(string), string provisioningState = default(string))
