    ...
    public class PSSite : Site
    {
        public PSSite(Site other)
            : base(
                  ...
                  daprConfig: other.DaprConfig,
                  resourceConfig: other.ResourceConfig,
                  ipMode: other.IPMode,
                  dnsConfiguration: other.DnsConfiguration,
                  outboundVnetRouting: other.OutboundVnetRouting,
                  functionAppConfig: other.FunctionAppConfig,
                  workloadProfileName: other.WorkloadProfileName,
                  ...
                  clientAffinityPartitioningEnabled: other.ClientAffinityPartitioningEnabled,
                  clientAffinityProxyEnabled: other.ClientAffinityProxyEnabled,
                  ...
                  autoGeneratedDomainNameLabelScope: other.AutoGeneratedDomainNameLabelScope,
