...
namespace Microsoft.Azure.Commands.WebApps.Utilities
{
    public static class CmdletHelpers
    {
        ...
        internal static string GetKeyVaultCertificates(ResourceClient resourceClient, WebsitesClient websitesClient, string resourceGroupName, string webApp, string keyVault, string certname)
        {
