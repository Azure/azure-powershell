...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed ''Add-AzWebAppAccessRestrictionRule'' failing when users does not have permissions to get Service Tag list #15316 and #14862'
