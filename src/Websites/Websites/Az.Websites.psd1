...
AliasesToExport = 'Swap-AzWebAppSlot', 'Get-AzWebAppSlotMetrics', 'Get-AzAppServicePlanMetrics', 'Get-AzWebAppMetrics'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fix ARM template bug that breaks cloning all slots using ''New-AzWebApp -IncludeSourceWebAppSlots'' '
