...
### Example 3: Change an App Service plan to a memory-optimized Isolated v4 SKU
```powershell
Set-AzAppServicePlan -ResourceGroupName "Default-Web-WestUS" -Name "ContosoASP" -Tier "IsolatedMV4" -WorkerSize "ExtraExtraLarge"
```

This command changes an App Service plan in an App Service Environment to the I5MV4 memory-optimized SKU.
