...
online version: https://learn.microsoft.com/powershell/module/az.websites/remove-azwebappslot
schema: 2.0.0
---
...
### S2
```
Remove-AzWebAppSlot [-Force] [-AsJob] [-WebApp] <PSSite> [-DefaultProfile <IAzureContextContainer>]
