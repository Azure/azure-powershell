...
namespace Microsoft.Azure.Commands.WebApps.Cmdlets.WebApps
{
    ...
    /// </summary>
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "WebAppAccessRestriction")]
    [OutputType(typeof(PSAccessRestrictionSettings))]
    public class GetAzureWebAppAccessRestrictionCmdlet : WebAppBaseClientCmdLet
    {
