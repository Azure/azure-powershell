...
namespace Microsoft.Azure.Management.WebSites.Version2016_09_01
{
    ...
    public static partial class AppServiceCertificateOrdersOperationsExtensions
    {
            ...
            /// Locale of site seal.
            /// </param>
            public static SiteSeal RetrieveSiteSeal(this IAppServiceCertificateOrdersOperations operations, string resourceGroupName, string certificateOrderName, bool? lightTheme = default(bool?), string locale = default(string))
            {
                return operations.RetrieveSiteSealAsync(resourceGroupName, certificateOrderName, lightTheme, locale).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SiteSeal> RetrieveSiteSealAsync(this IAppServiceCertificateOrdersOperations operations, string resourceGroupName, string certificateOrderName, bool? lightTheme = default(bool?), string locale = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.RetrieveSiteSealWithHttpMessagesAsync(resourceGroupName, certificateOrderName, lightTheme, locale, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
