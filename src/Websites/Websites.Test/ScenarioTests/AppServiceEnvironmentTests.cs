...
{
    public partial class AppServiceEnvironmentTests : WebsitesTestRunner
    {
        public AppServiceEnvironmentTests(ITestOutputHelper output)
            : base(output)
        {
        }
        ...
        {
            TestRunner.RunTestScript("Test-E2EAppServiceEnvironment");
        }
    }
}
