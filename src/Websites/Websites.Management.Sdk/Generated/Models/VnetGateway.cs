...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class VnetGateway : ProxyResource
    {
        /// <summary>
        ...
        /// </param>
        public VnetGateway(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string kind = default(string), string vnetName = default(string), string vpnPackageUri = default(string))
