...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class OpenIdConnectConfig : ProxyOnlyResource
    {
        ...
        /// <param name="tokenEndpoint">The endpoint to be used to request a token.
        /// </param>

        /// <param name="issuer">The endpoint that issues the token.
        /// </param>

        /// <param name="certificationUri">The endpoint that provides the keys necessary to validate the token.
        /// </param>
