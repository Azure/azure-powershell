...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class VirtualIPMapping
    {
        ...
        /// <param name="virtualIP">Virtual IP address.
        /// </param>

        /// <param name="internalHttpPort">Internal HTTP port.
        /// </param>

        /// <param name="internalHttpsPort">Internal HTTPS port.
        /// </param>

        /// <param name="inUse">Is virtual IP mapping in use.
        /// </param>

        /// <param name="serviceName">name of the service that virtual IP is assigned to
        /// </param>
