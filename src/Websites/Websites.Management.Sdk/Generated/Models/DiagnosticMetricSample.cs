...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class DiagnosticMetricSample
    {
        ...
        /// <param name="timestamp">Time at which metric is measured
        /// </param>

        /// <param name="roleInstance">Role Instance. Null if this counter is not per instance
        ...
        /// <param name="total">Total value of the metric. If multiple measurements are made this will have
        /// sum of all.
        /// </param>

        /// <param name="maximum">Maximum of the metric sampled during the time period
        /// </param>

        /// <param name="minimum">Minimum of the metric sampled during the time period
        /// </param>

        /// <param name="isAggregated">Whether the values are aggregates across all workers or not
        /// </param>
        ...
        /// <summary>
        /// Gets or sets role Instance. Null if this counter is not per instance
        /// This is returned and should be whichever instance name we desire to be
        /// returned
        /// i.e. CPU and Memory return RDWORKERNAME (LargeDed..._IN_0)
        /// where RDWORKERNAME is Machine name below and RoleInstance name in
        ...
        /// <summary>
        /// Gets or sets total value of the metric. If multiple measurements are made
