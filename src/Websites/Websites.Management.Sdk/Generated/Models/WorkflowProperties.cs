...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class WorkflowProperties
    {
        ...
        public WorkflowProperties(string provisioningState = default(string), System.DateTime? createdTime = default(System.DateTime?), System.DateTime? changedTime = default(System.DateTime?), string state = default(string), string version = default(string), string accessEndpoint = default(string), FlowEndpointsConfiguration endpointsConfiguration = default(FlowEndpointsConfiguration), FlowAccessControlConfiguration accessControl = default(FlowAccessControlConfiguration), WorkflowSku sku = default(WorkflowSku), ResourceReference integrationAccount = default(ResourceReference), ResourceReference integrationServiceEnvironment = default(ResourceReference), object definition = default(object), System.Collections.Generic.IDictionary<string, WorkflowParameter> parameters = default(System.Collections.Generic.IDictionary<string, WorkflowParameter>), string kind = default(string))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "integrationServiceEnvironment")]
