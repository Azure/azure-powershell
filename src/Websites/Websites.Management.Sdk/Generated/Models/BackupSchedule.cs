...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class BackupSchedule
    {
        ...
        /// <param name="frequencyInterval">How often the backup should be executed (e.g. for weekly backup, this
        /// should be set to 7 and FrequencyUnit should be set to Day)
        /// </param>

        /// <param name="frequencyUnit">The unit of time for how often the backup should be executed (e.g. for
        /// weekly backup, this should be set to Day and FrequencyInterval should be
        /// set to 7)
        /// Possible values include: &#39;Day&#39;, &#39;Hour&#39;</param>

        /// <param name="keepAtLeastOneBackup">True if the retention policy should always keep at least one backup in the
        /// storage account, regardless how old it is; false otherwise.
        /// </param>

        /// <param name="retentionPeriodInDays">After how many days backups should be deleted.
        /// </param>

        /// <param name="startTime">When the schedule should start working.
        /// </param>

        /// <param name="lastExecutionTime">Last time when this schedule was triggered.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets how often the backup should be executed (e.g. for weekly
        ...
        /// <summary>
        /// Gets or sets the unit of time for how often the backup should be executed
        ...
        /// <summary>
        /// Gets or sets true if the retention policy should always keep at least one
