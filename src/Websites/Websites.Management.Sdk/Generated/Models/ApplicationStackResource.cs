...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class ApplicationStackResource : ProxyOnlyResource
    {
        ...
        /// <param name="applicationStackResourceName">Application stack name.
        /// </param>
        ...
        /// &lt;code&gt;false&lt;/code&gt;.
        /// </param>
        public ApplicationStackResource(string id = default(string), string name = default(string), string kind = default(string), string type = default(string), string applicationStackResourceName = default(string), string display = default(string), string dependency = default(string), System.Collections.Generic.IList<StackMajorVersion> majorVersions = default(System.Collections.Generic.IList<StackMajorVersion>), System.Collections.Generic.IList<ApplicationStack> frameworks = default(System.Collections.Generic.IList<ApplicationStack>), System.Collections.Generic.IList<ApplicationStack> isDeprecated = default(System.Collections.Generic.IList<ApplicationStack>))
