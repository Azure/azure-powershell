...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the CertificatePatchResourceProperties class.
        /// </summary>
        ...
        /// </param>
        public CertificatePatchResourceProperties(string password = default(string), string friendlyName = default(string), string subjectName = default(string), System.Collections.Generic.IList<string> hostNames = default(System.Collections.Generic.IList<string>), byte[] pfxBlob = default(byte[]), string siteName = default(string), string selfLink = default(string), string issuer = default(string), System.DateTime? issueDate = default(System.DateTime?), System.DateTime? expirationDate = default(System.DateTime?), string thumbprint = default(string), bool? valid = default(bool?), byte[] cerBlob = default(byte[]), string publicKeyHash = default(string), HostingEnvironmentProfile hostingEnvironmentProfile = default(HostingEnvironmentProfile), string keyVaultId = default(string), string keyVaultSecretName = default(string), KeyVaultSecretStatus? keyVaultSecretStatus = default(KeyVaultSecretStatus?), string serverFarmId = default(string), string canonicalName = default(string), string domainValidationMethod = default(string))
