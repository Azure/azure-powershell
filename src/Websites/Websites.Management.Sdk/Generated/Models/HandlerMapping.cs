...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class HandlerMapping
    {
        ...
        /// <param name="extension">Requests with this extension will be handled using the specified FastCGI
        /// application.
        /// </param>

        /// <param name="scriptProcessor">The absolute path to the FastCGI application.
        /// </param>

        /// <param name="arguments">Command-line arguments to be passed to the script processor.
        /// </param>
