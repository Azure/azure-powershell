...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class RampUpRule
    {
        ...
        /// <param name="actionHostName">Hostname of a slot to which the traffic will be redirected if decided to.
        /// E.g. myapp-stage.azurewebsites.net.
        /// </param>

        /// <param name="reroutePercentage">Percentage of the traffic which will be redirected to
        /// &lt;code&gt;ActionHostName&lt;/code&gt;.
        /// </param>

        /// <param name="changeStep">In auto ramp up scenario this is the step to add/remove from
        ...
        /// specified in &lt;code&gt;ChangeIntervalInMinutes&lt;/code&gt;.\nCustom decision
        /// algorithm
        /// can be provided in TiPCallback site extension which URL can be specified in
        /// &lt;code&gt;ChangeDecisionCallbackUrl&lt;/code&gt;.
        /// </param>

        /// <param name="changeIntervalInMinutes">Specifies interval in minutes to reevaluate ReroutePercentage.
        /// </param>

        /// <param name="minReroutePercentage">Specifies lower boundary above which ReroutePercentage will stay.
        /// </param>

        /// <param name="maxReroutePercentage">Specifies upper boundary below which ReroutePercentage will stay.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets hostname of a slot to which the traffic will be redirected if
        ...
        /// <summary>
        /// Gets or sets in auto ramp up scenario this is the step to add/remove from
        /// &lt;code&gt;ReroutePercentage&lt;/code&gt; until it reaches
        /// \n&lt;code&gt;MinReroutePercentage&lt;/code&gt; or
        /// &lt;code&gt;MaxReroutePercentage&lt;/code&gt;. Site metrics are checked every N minutes
        /// specified in &lt;code&gt;ChangeIntervalInMinutes&lt;/code&gt;.\nCustom decision
        ...
        /// <summary>
        /// Gets or sets specifies lower boundary above which ReroutePercentage will
        /// stay.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets specifies upper boundary below which ReroutePercentage will
        /// stay.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets name of the routing rule. The recommended name would be to
