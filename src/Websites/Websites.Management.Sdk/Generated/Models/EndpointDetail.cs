...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class EndpointDetail
    {
        ...
        /// <param name="latency">The time in milliseconds it takes for a TCP connection to be created from
        /// the App Service Environment to this IpAddress at this Port.
        /// </param>

        /// <param name="isAccessible">Whether it is possible to create a TCP connection from the App Service
        ...
        /// <summary>
        /// Gets or sets the time in milliseconds it takes for a TCP connection to be
        /// created from the App Service Environment to this IpAddress at this Port.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "latency")]
        public double? Latency {get; set; }

        /// <summary>
        /// Gets or sets whether it is possible to create a TCP connection from the App
