...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class VnetInfoResource : ProxyResource
    {
        /// <summary>
        ...
        /// <param name="certThumbprint">The client certificate thumbprint.
        /// </param>
        ...
        /// <param name="resyncRequired">&lt;code&gt;true&lt;/code&gt; if a resync is required; otherwise, &lt;code&gt;false&lt;/code&gt;.
        /// </param>

        /// <param name="dnsServers">DNS servers to be used by this Virtual Network. This should be a
        /// comma-separated list of IP addresses.
        /// </param>

        /// <param name="isSwift">Flag that is used to denote if this is VNET injection
        /// </param>
        public VnetInfoResource(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string kind = default(string), string vnetResourceId = default(string), string certThumbprint = default(string), string certBlob = default(string), System.Collections.Generic.IList<VnetRoute> routes = default(System.Collections.Generic.IList<VnetRoute>), bool? resyncRequired = default(bool?), string dnsServers = default(string), bool? isSwift = default(bool?))
