...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    /// </summary>
    public partial class DetectorInfoAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the DetectorInfoAutoGenerated class.
        /// </summary>
        public DetectorInfoAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public DetectorInfoAutoGenerated(string id = default(string), string name = default(string), string description = default(string), string author = default(string), string category = default(string), System.Collections.Generic.IList<SupportTopic> supportTopicList = default(System.Collections.Generic.IList<SupportTopic>), System.Collections.Generic.IList<string> analysisType = default(System.Collections.Generic.IList<string>), DetectorType? type = default(DetectorType?), double? score = default(double?))
