...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ProcessInfoProperties class.
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "deployment_name")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "minidump")]
        public string Minidump {get; set; }

        /// <summary>
        /// Gets or sets is profile running?
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "is_profile_running")]
        public bool? IsProfileRunning {get; set; }

        /// <summary>
        /// Gets or sets is the IIS Profile running?
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "is_iis_profile_running")]
        public bool? IsIisProfileRunning {get; set; }

        /// <summary>
        /// Gets or sets iIS Profile timeout (seconds).
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "iis_profile_timeout_in_seconds")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "open_file_handles")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "command_line")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "handle_count")]
        public int? HandleCount {get; set; }

        /// <summary>
        /// Gets or sets module count.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "module_count")]
        public int? ModuleCount {get; set; }

        /// <summary>
        /// Gets or sets thread count.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "thread_count")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "total_cpu_time")]
        public string TotalCpuTime {get; set; }

        /// <summary>
        /// Gets or sets user CPU time.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "user_cpu_time")]
        public string UserCpuTime {get; set; }

        /// <summary>
        /// Gets or sets privileged CPU time.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "privileged_cpu_time")]
        public string PrivilegedCpuTime {get; set; }

        /// <summary>
        /// Gets or sets working set.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "working_set")]
        public long? WorkingSet {get; set; }

        /// <summary>
        /// Gets or sets peak working set.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "peak_working_set")]
        public long? PeakWorkingSet {get; set; }

        /// <summary>
        /// Gets or sets private memory size.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "private_memory")]
        public long? PrivateMemory {get; set; }

        /// <summary>
        /// Gets or sets virtual memory size.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "virtual_memory")]
        public long? VirtualMemory {get; set; }

        /// <summary>
        /// Gets or sets peak virtual memory usage.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "peak_virtual_memory")]
        public long? PeakVirtualMemory {get; set; }

        /// <summary>
        /// Gets or sets paged system memory.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "paged_system_memory")]
        public long? PagedSystemMemory {get; set; }

        /// <summary>
        /// Gets or sets non-paged system memory.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "non_paged_system_memory")]
        public long? NonPagedSystemMemory {get; set; }

        /// <summary>
        /// Gets or sets paged memory.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "paged_memory")]
        public long? PagedMemory {get; set; }

        /// <summary>
        /// Gets or sets peak paged memory.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "peak_paged_memory")]
        public long? PeakPagedMemory {get; set; }

        /// <summary>
        /// Gets or sets time stamp.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "time_stamp")]
        public System.DateTime? TimeStamp {get; set; }

        /// <summary>
        /// Gets or sets list of environment variables.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "environment_variables")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "is_scm_site")]
        public bool? IsScmSite {get; set; }

        /// <summary>
        /// Gets or sets is this a Web Job?
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "is_webjob")]
