...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class CertificateProperties
    {
        ...
        /// </param>
        public CertificateProperties(string password = default(string), string friendlyName = default(string), string subjectName = default(string), System.Collections.Generic.IList<string> hostNames = default(System.Collections.Generic.IList<string>), byte[] pfxBlob = default(byte[]), string siteName = default(string), string selfLink = default(string), string issuer = default(string), System.DateTime? issueDate = default(System.DateTime?), System.DateTime? expirationDate = default(System.DateTime?), string thumbprint = default(string), bool? valid = default(bool?), byte[] cerBlob = default(byte[]), string publicKeyHash = default(string), HostingEnvironmentProfile hostingEnvironmentProfile = default(HostingEnvironmentProfile), string keyVaultId = default(string), string keyVaultSecretName = default(string), KeyVaultSecretStatus? keyVaultSecretStatus = default(KeyVaultSecretStatus?), string serverFarmId = default(string), string canonicalName = default(string), string domainValidationMethod = default(string))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "pfxBlob")]
        ...
        /// Gets self link.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "selfLink")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "cerBlob")]
        public byte[] CerBlob {get; private set; }

        /// <summary>
        /// Gets public key hash.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "publicKeyHash")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "keyVaultSecretStatus")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "canonicalName")]
        public string CanonicalName {get; set; }

        /// <summary>
        /// Gets or sets method of domain validation for free cert
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "domainValidationMethod")]
