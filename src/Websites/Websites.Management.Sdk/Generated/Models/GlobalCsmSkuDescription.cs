...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class GlobalCsmSkuDescription
    {
        ...
        /// <param name="name">Name of the resource SKU.
        /// </param>

        /// <param name="tier">Service Tier of the resource SKU.
        /// </param>

        /// <param name="size">Size specifier of the resource SKU.
        /// </param>

        /// <param name="family">Family code of the resource SKU.
        /// </param>

        /// <param name="capacity">Min, max, and default scale values of the SKU.
        /// </param>

        /// <param name="locations">Locations of the SKU.
        /// </param>

        /// <param name="capabilities">Capabilities of the SKU, e.g., is traffic manager enabled?
        /// </param>
        public GlobalCsmSkuDescription(string name = default(string), string tier = default(string), string size = default(string), string family = default(string), SkuCapacity capacity = default(SkuCapacity), System.Collections.Generic.IList<string> locations = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<Capability> capabilities = default(System.Collections.Generic.IList<Capability>))
