...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    /// <summary>
    /// Information regarding availability of a resource name for DNL apps with
    /// regionalized default hostnames.
    /// </summary>
    public partial class DnlResourceNameAvailability
    {
        /// <summary>
        /// Initializes a new instance of the DnlResourceNameAvailability class.
        /// </summary>
        public DnlResourceNameAvailability()
        {
            CustomInit();
        }
        ...
        /// </param>
        public DnlResourceNameAvailability(string hostName = default(string), bool? nameAvailable = default(bool?), string reason = default(string), string message = default(string))
