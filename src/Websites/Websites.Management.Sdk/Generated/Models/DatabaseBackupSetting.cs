...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class DatabaseBackupSetting
    {
        ...
        /// Possible values include: &#39;SqlAzure&#39;, &#39;MySql&#39;, &#39;LocalMySql&#39;, &#39;PostgreSql&#39;</param>

        /// <param name="name">
        /// </param>

        /// <param name="connectionStringName">Contains a connection string name that is linked to the
        /// SiteConfig.ConnectionStrings.
        /// This is used during restore with overwrite connection strings options.
        /// </param>

        /// <param name="connectionString">Contains a connection string to a database which is being backed up or
        /// restored. If the restore should happen to a new database, the database name
        /// inside is the new one.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets contains a connection string name that is linked to the
        /// SiteConfig.ConnectionStrings.
        /// This is used during restore with overwrite connection strings options.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets contains a connection string to a database which is being
        /// backed up or restored. If the restore should happen to a new database, the
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "DatabaseType");
            }
