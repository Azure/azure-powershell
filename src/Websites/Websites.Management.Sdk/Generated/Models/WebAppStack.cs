...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class WebAppStack : ProxyOnlyResource
    {
        ...
        /// <param name="location">Web App stack location.
        /// </param>
        ...
        public WebAppStack(string id = default(string), string name = default(string), string kind = default(string), string type = default(string), string location = default(string), string displayText = default(string), string value = default(string), System.Collections.Generic.IList<WebAppMajorVersion> majorVersions = default(System.Collections.Generic.IList<WebAppMajorVersion>), StackPreferredOs? preferredOS = default(StackPreferredOs?))
