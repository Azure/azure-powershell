...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the PremierAddOnPatchResourceProperties class.
        /// </summary>
        ...
        /// </param>
        public PremierAddOnPatchResourceProperties(string sku = default(string), string product = default(string), string vendor = default(string), string marketplacePublisher = default(string), string marketplaceOffer = default(string))
