...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class NetworkTrace
    {
        ...
        /// <param name="path">Local file path for the captured network trace file.
        /// </param>

        /// <param name="status">Current status of the network trace operation, same as Operation.Status
        /// (InProgress/Succeeded/Failed).
        /// </param>

        /// <param name="message">Detailed message of a network trace operation, e.g. error message in case
        /// of failure.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets detailed message of a network trace operation, e.g. error
