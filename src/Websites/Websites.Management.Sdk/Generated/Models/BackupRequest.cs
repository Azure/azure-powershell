...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class BackupRequest : ProxyOnlyResource
    {
        ...
        /// </param>
        public BackupRequest(string id = default(string), string name = default(string), string kind = default(string), string type = default(string), BackupSchedule backupSchedule = default(BackupSchedule), string backupName = default(string), bool? enabled = default(bool?), string storageAccountUrl = default(string), System.Collections.Generic.IList<DatabaseBackupSetting> databases = default(System.Collections.Generic.IList<DatabaseBackupSetting>))
