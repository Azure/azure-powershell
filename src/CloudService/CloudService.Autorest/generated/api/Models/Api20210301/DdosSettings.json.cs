...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20210301
{
    ...
    public partial class DdosSettings
    {
        ...
        internal DdosSettings(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject json)
        {
            ...
            {_ddosCustomPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject>("ddosCustomPolicy"), out var __jsonDdosCustomPolicy) ? Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20210301.SubResourceAutoGenerated.FromJson(__jsonDdosCustomPolicy) : DdosCustomPolicy;}
            {_protectionCoverage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("protectionCoverage"), out var __jsonProtectionCoverage) ? (string)__jsonProtectionCoverage : (string)ProtectionCoverage;}
            {_protectedIP = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonBoolean>("protectedIP"), out var __jsonProtectedIP) ? (bool?)__jsonProtectedIP : ProtectedIP;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20210301.IDdosSettings.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20210301.IDdosSettings.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20210301.IDdosSettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._ddosCustomPolicy ? (Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode) this._ddosCustomPolicy.ToJson(null,serializationMode) : null, "ddosCustomPolicy" ,container.Add );
            AddIf( null != (((object)this._protectionCoverage)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString(this._protectionCoverage.ToString()) : null, "protectionCoverage" ,container.Add );
            AddIf( null != this._protectedIP ? (Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonBoolean((bool)this._protectedIP) : null, "protectedIP" ,container.Add );
