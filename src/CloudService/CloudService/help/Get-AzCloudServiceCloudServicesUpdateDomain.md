...
```
Get-AzCloudServiceCloudServicesUpdateDomain -CloudServiceName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] -UpdateDomain <Int32> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentityCloudService
```
Get-AzCloudServiceCloudServicesUpdateDomain -UpdateDomain <Int32>
 -CloudServiceInputObject <ICloudServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
