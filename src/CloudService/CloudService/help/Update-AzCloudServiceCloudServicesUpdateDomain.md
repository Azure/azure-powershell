...
Update-AzCloudServiceCloudServicesUpdateDomain -CloudServiceName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -UpdateDomain <Int32> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
...
```
Update-AzCloudServiceCloudServicesUpdateDomain -CloudServiceName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -UpdateDomain <Int32> -Parameter <IUpdateDomain> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityCloudServiceExpanded
```
Update-AzCloudServiceCloudServicesUpdateDomain -UpdateDomain <Int32>
 -CloudServiceInputObject <ICloudServiceIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
Update-AzCloudServiceCloudServicesUpdateDomain -UpdateDomain <Int32>
 -CloudServiceInputObject <ICloudServiceIdentity> -Parameter <IUpdateDomain> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Parameter Sets: UpdateViaIdentityCloudServiceExpanded, UpdateViaIdentityCloudService
Aliases:
...
Parameter Sets: Update, UpdateViaIdentityCloudService, UpdateViaIdentity
Aliases:
...
```yaml
Type: System.Int32
Parameter Sets: UpdateExpanded, Update, UpdateViaIdentityCloudServiceExpanded, UpdateViaIdentityCloudService
Aliases:
