namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20201001Preview
{
    ...
    public partial class RoleInstanceView :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20201001Preview.IRoleInstanceViewInternal
    {

        /// <summary>Internal Acessors for PlatformFaultDomain</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20201001Preview.IRoleInstanceViewInternal.PlatformFaultDomain { get => this._platformFaultDomain; set { {_platformFaultDomain = value;} } }

        /// <summary>Internal Acessors for PlatformUpdateDomain</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20201001Preview.IRoleInstanceViewInternal.PlatformUpdateDomain { get => this._platformUpdateDomain; set { {_platformUpdateDomain = value;} } }

        /// <summary>Internal Acessors for PrivateId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20201001Preview.IRoleInstanceViewInternal.PrivateId { get => this._privateId; set { {_privateId = value;} } }

        /// <summary>Internal Acessors for Statuses</summary>
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20201001Preview.IResourceInstanceViewStatus[] Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20201001Preview.IRoleInstanceViewInternal.Statuses { get => this._statuses; set { {_statuses = value;} } }
