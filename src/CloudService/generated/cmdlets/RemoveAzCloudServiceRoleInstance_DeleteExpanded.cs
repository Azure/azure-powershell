...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CloudServices_DeleteInstances=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/cloudServices/{cloudServiceName}/delete"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzCloudServiceRoleInstance_DeleteExpanded", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzCloudServiceRoleInstance_DeleteExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20201001Preview.IRoleInstances _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20201001Preview.RoleInstances();

        /// <summary>Specifies a list of role instances from the cloud service.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20201001Preview.IRoleInstances ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] RoleInstance { get => ParametersBody.RoleInstance ?? null /* arrayOf */; set => ParametersBody.RoleInstance = value; }
        ...
        /// <returns>a duplicate instance of RemoveAzCloudServiceRoleInstance_DeleteExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.CloudService.Cmdlets.RemoveAzCloudServiceRoleInstance_DeleteExpanded Clone()
        {
            var clone = new RemoveAzCloudServiceRoleInstance_DeleteExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CloudServicesDeleteInstances(ResourceGroupName, CloudServiceName, SubscriptionId, ParametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,CloudServiceName=CloudServiceName,SubscriptionId=SubscriptionId,body=ParametersBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzCloudServiceRoleInstance_DeleteExpanded" /> cmdlet class.
        /// </summary>
        public RemoveAzCloudServiceRoleInstance_DeleteExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20201001Preview.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, CloudServiceName=CloudServiceName, SubscriptionId=SubscriptionId, body=ParametersBody })
                    {
