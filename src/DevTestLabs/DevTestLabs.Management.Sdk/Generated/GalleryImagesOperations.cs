...
namespace Microsoft.Azure.Management.DevTestLabs
{
    ...
    /// </summary>
    internal partial class GalleryImagesOperations : IServiceOperations<DevTestLabsClient>, IGalleryImagesOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<GalleryImage>>> ListWithHttpMessagesAsync(string labName, ODataQuery<GalleryImage> odataQuery = default(ODataQuery<GalleryImage>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
