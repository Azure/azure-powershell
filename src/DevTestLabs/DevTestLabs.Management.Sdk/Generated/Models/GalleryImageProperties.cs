...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class GalleryImageProperties
    {
        ...
        /// </param>
        public GalleryImageProperties(string author = default(string), System.DateTime? createdDate = default(System.DateTime?), string description = default(string), GalleryImageReference imageReference = default(GalleryImageReference), string icon = default(string), bool? enabled = default(bool?))
