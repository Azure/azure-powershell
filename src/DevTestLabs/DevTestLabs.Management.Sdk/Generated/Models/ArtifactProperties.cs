...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class ArtifactProperties
    {
        ...
        /// </param>
        public ArtifactProperties(string title = default(string), string description = default(string), string publisher = default(string), string filePath = default(string), string icon = default(string), string targetOSType = default(string), object parameters = default(object), System.DateTime? createdDate = default(System.DateTime?))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "targetOsType")]
