...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class LabResourceCostProperties
    {
        ...
        /// <param name="resourceUId">The unique identifier of the resource.
        /// </param>

        /// <param name="resourceCost">The cost component of the resource cost item.
        /// </param>

        /// <param name="resourceType">The logical resource type (ex. virtualmachine, storageaccount)
        /// </param>

        /// <param name="resourceOwner">The owner of the resource (ex. janedoe@microsoft.com)
        /// </param>

        /// <param name="resourcePricingTier">The category of the resource (ex. Premium_LRS, Standard_DS1)
        /// </param>

        /// <param name="resourceStatus">The status of the resource (ex. Active)
        /// </param>

        /// <param name="resourceId">The ID of the resource
        /// </param>

        /// <param name="externalResourceId">The ID of the external resource
        /// </param>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "resourceCost")]
        public double? ResourceCost {get; set; }

        /// <summary>
        /// Gets or sets the logical resource type (ex. virtualmachine, storageaccount)
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "resourceOwner")]
        public string ResourceOwner {get; set; }

        /// <summary>
        /// Gets or sets the category of the resource (ex. Premium_LRS, Standard_DS1)
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "resourcePricingTier")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "externalResourceId")]
