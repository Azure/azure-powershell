...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    /// </summary>
    public partial class PolicyPropertiesFragment
    {
        /// <summary>
        /// Initializes a new instance of the PolicyPropertiesFragment class.
        /// </summary>
        ...
        /// </param>
        public PolicyPropertiesFragment(string description = default(string), string status = default(string), string factName = default(string), string factData = default(string), string threshold = default(string), string evaluatorType = default(string), string provisioningState = default(string), string uniqueIdentifier = default(string))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "evaluatorType")]
