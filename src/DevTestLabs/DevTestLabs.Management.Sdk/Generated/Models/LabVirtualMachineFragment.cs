...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class LabVirtualMachineFragment : Resource
    {
        ...
        /// </param>
        public LabVirtualMachineFragment(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string notes = default(string), string ownerObjectId = default(string), string ownerUserPrincipalName = default(string), string createdByUserId = default(string), string createdByUser = default(string), System.DateTime? createdDate = default(System.DateTime?), string customImageId = default(string), string osType = default(string), string size = default(string), string userName = default(string), string password = default(string), string sshKey = default(string), bool? isAuthenticationWithSshKey = default(bool?), string fqdn = default(string), string labSubnetName = default(string), string labVirtualNetworkId = default(string), bool? disallowPublicIPAddress = default(bool?), System.Collections.Generic.IList<ArtifactInstallPropertiesFragment> artifacts = default(System.Collections.Generic.IList<ArtifactInstallPropertiesFragment>), ArtifactDeploymentStatusPropertiesFragment artifactDeploymentStatus = default(ArtifactDeploymentStatusPropertiesFragment), GalleryImageReferenceFragment galleryImageReference = default(GalleryImageReferenceFragment), ComputeVmPropertiesFragment computeVM = default(ComputeVmPropertiesFragment), NetworkInterfacePropertiesFragment networkInterface = default(NetworkInterfacePropertiesFragment), ApplicableScheduleFragment applicableSchedule = default(ApplicableScheduleFragment), System.DateTime? expirationDate = default(System.DateTime?), bool? allowClaim = default(bool?), string storageType = default(string), string virtualMachineCreationSource = default(string), string environmentId = default(string), string provisioningState = default(string), string uniqueIdentifier = default(string))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.customImageId")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.sshKey")]
        ...
        /// authentication.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.isAuthenticationWithSshKey")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.labSubnetName")]
        public string LabSubnetName {get; set; }

        /// <summary>
        /// Gets or sets the lab virtual network identifier of the virtual machine.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.labVirtualNetworkId")]
        ...
        /// a public IP address.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.disallowPublicIpAddress")]
        ...
        public System.Collections.Generic.IList<ArtifactInstallPropertiesFragment> Artifacts {get; set; }

        /// <summary>
        /// Gets or sets the artifact deployment status for the virtual machine.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.artifactDeploymentStatus")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.applicableSchedule")]
        ...
        /// virtual machine
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.allowClaim")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.virtualMachineCreationSource")]
        ...
        /// machine, if any.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.environmentId")]
