...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class ServiceRunner : Resource
    {
        ...
        /// </param>
        public ServiceRunner(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), IdentityProperties identity = default(IdentityProperties))
