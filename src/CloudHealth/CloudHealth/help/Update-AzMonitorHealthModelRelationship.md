...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.cloudhealth/update-azmonitorhealthmodelrelationship
...
```
Update-AzMonitorHealthModelRelationship -HealthModelName <string> -Name <string>
 -ResourceGroupName <string> [-SubscriptionId <string>] [-DisplayName <string>] [-Tag <hashtable>]
...
Update-AzMonitorHealthModelRelationship -InputObject <ICloudHealthIdentity> [-DisplayName <string>]
 [-Tag <hashtable>] [-DefaultProfile <psobject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
```

### UpdateViaIdentityHealthmodelExpanded

```
Update-AzMonitorHealthModelRelationship -Name <string>
 -HealthmodelInputObject <ICloudHealthIdentity> [-DisplayName <string>] [-Tag <hashtable>]
 [-DefaultProfile <psobject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
```
