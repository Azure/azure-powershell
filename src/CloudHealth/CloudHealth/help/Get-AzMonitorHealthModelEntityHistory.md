...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.cloudhealth/get-azmonitorhealthmodelentityhistory
...
Get-AzMonitorHealthModelEntityHistory -EntityName <string> -HealthModelName <string>
 ...
 [-StartAt <datetime>] [-Top <int>] [-DefaultProfile <psobject>] [-WhatIf] [-Confirm]
```
...
```
Get-AzMonitorHealthModelEntityHistory -InputObject <ICloudHealthIdentity>
 -Body <IEntityHistoryRequest> [-DefaultProfile <psobject>] [-WhatIf] [-Confirm]
```
...
```
Get-AzMonitorHealthModelEntityHistory -EntityName <string>
 -HealthmodelInputObject <ICloudHealthIdentity> -Body <IEntityHistoryRequest>
 [-DefaultProfile <psobject>] [-WhatIf] [-Confirm]
```
