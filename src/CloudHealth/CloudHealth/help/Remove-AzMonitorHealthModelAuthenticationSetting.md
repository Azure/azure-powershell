...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.cloudhealth/remove-azmonitorhealthmodelauthenticationsetting
...
Remove-AzMonitorHealthModelAuthenticationSetting -HealthModelName <string> -Name <string>
 -ResourceGroupName <string> [-SubscriptionId <string>] [-DefaultProfile <psobject>] [-AsJob]
...
```
Remove-AzMonitorHealthModelAuthenticationSetting -Name <string>
 -HealthmodelInputObject <ICloudHealthIdentity> [-DefaultProfile <psobject>] [-AsJob] [-NoWait]
...
Aliases: []
ParameterSets:
- Name: DeleteViaIdentityHealthmodel
  Position: Named
  IsRequired: true
