...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.cloudhealth/new-azmonitorhealthmodelsignaldefinition
...
```
New-AzMonitorHealthModelSignalDefinition -HealthModelName <string> -Name <string>
