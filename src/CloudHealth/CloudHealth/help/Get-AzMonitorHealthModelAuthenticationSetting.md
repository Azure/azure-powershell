...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.cloudhealth/get-azmonitorhealthmodelauthenticationsetting
...
```
Get-AzMonitorHealthModelAuthenticationSetting -InputObject <ICloudHealthIdentity>
...
```
Get-AzMonitorHealthModelAuthenticationSetting -Name <string>
