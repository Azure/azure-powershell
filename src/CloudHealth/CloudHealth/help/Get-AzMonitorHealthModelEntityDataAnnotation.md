...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.cloudhealth/get-azmonitorhealthmodelentitydataannotation
...
Get-AzMonitorHealthModelEntityDataAnnotation -InputObject <ICloudHealthIdentity>
 -Body <IGetDataAnnotationsRequest> [-DefaultProfile <psobject>] [-WhatIf] [-Confirm]
```
