...
online version: https://learn.microsoft.com/powershell/module/az.cloudhealth/remove-azmonitorhealthmodelsignaldefinition
schema: 2.0.0
---

# Remove-AzMonitorHealthModelSignalDefinition
...
### Delete (Default)
```
Remove-AzMonitorHealthModelSignalDefinition -HealthModelName <String> -Name <String>
...
```
Remove-AzMonitorHealthModelSignalDefinition -Name <String> -HealthmodelInputObject <ICloudHealthIdentity>
...
### DeleteViaIdentity
```
Remove-AzMonitorHealthModelSignalDefinition -InputObject <ICloudHealthIdentity> [-DefaultProfile <PSObject>]
