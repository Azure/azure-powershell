...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.cloudhealth/remove-azmonitorhealthmodel
...
```
Remove-AzMonitorHealthModel -InputObject <ICloudHealthIdentity> [-DefaultProfile <psobject>]
