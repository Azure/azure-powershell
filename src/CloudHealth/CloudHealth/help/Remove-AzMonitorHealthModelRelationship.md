...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.cloudhealth/remove-azmonitorhealthmodelrelationship
...
```
Remove-AzMonitorHealthModelRelationship -HealthModelName <string> -Name <string>
...
```
Remove-AzMonitorHealthModelRelationship -InputObject <ICloudHealthIdentity>
...
```
Remove-AzMonitorHealthModelRelationship -Name <string>
