...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.cloudhealth/new-azmonitorhealthmodeldiscoveryrule
...
```
New-AzMonitorHealthModelDiscoveryRule -HealthModelName <string> -Name <string>
