...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.cloudhealth/new-azmonitorhealthmodelentity
...
New-AzMonitorHealthModelEntity -HealthModelName <string> -Name <string> -ResourceGroupName <string>
 [-SubscriptionId <string>] [-CanvaPositionX <float>] [-CanvaPositionY <float>]
 [-DegradedActionGroupId <string[]>] [-DegradedDescription <string>] [-DegradedSeverity <string>]
 [-DisplayName <string>] [-HealthObjective <float>] [-IconCustomData <string>] [-IconName <string>]
 [-Impact <string>] [-SignalGroup <ISignalGroups>] [-Tag <hashtable>]
