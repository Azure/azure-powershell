...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.cloudhealth/get-azmonitorhealthmodeldiscoveryrule
...
```
Get-AzMonitorHealthModelDiscoveryRule -HealthModelName <String> -Name <String>
...
```
Get-AzMonitorHealthModelDiscoveryRule -InputObject <ICloudHealthIdentity>
