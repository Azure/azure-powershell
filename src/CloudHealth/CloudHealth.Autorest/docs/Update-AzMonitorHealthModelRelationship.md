...
```
Update-AzMonitorHealthModelRelationship -HealthmodelInputObject <ICloudHealthIdentity> -Name <String>
 [-DisplayName <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
