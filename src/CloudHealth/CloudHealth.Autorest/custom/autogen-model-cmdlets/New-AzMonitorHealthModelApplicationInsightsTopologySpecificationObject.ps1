...
function New-AzMonitorHealthModelApplicationInsightsTopologySpecificationObject {
    ...
    Param(
        ...
        [Parameter(Mandatory, HelpMessage="Application Insights resource ID.")]
        [string]
        $ApplicationInsightsResourceId
    )

    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.CloudHealth.Models.ApplicationInsightsTopologySpecification]::New()

        if ($PSBoundParameters.ContainsKey('ApplicationInsightsResourceId')) {
            $Object.ApplicationInsightsResourceId = $ApplicationInsightsResourceId
        }
        return $Object
    }
}
