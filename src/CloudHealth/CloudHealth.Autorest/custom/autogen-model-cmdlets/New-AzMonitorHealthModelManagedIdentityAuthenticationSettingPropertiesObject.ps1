...
function New-AzMonitorHealthModelManagedIdentityAuthenticationSettingPropertiesObject {
    ...
    Param(
        ...
        [Parameter(Mandatory, HelpMessage="Name of the managed identity to use. Either 'SystemAssigned' or the resourceId of a user-assigned identity.")]
        [string]
        $ManagedIdentityName,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.CloudHealth.Models.ManagedIdentityAuthenticationSettingProperties]::New()

        if ($PSBoundParameters.ContainsKey('ManagedIdentityName')) {
            $Object.ManagedIdentityName = $ManagedIdentityName
        }
