if(($null -eq $TestName) -or ($TestName -contains 'Get-AzMonitorHealthModelEntityHistory'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Get-AzMonitorHealthModelEntityHistory.Recording.json'
