...
```
Initialize-AzNapsterSaaSOperationGroupResource [-SubscriptionId <String>] -SaasGuid <String>
 [-PublisherId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Activate
```
Initialize-AzNapsterSaaSOperationGroupResource [-SubscriptionId <String>] -Body <IActivateSaaSParameterRequest>
...
```
Initialize-AzNapsterSaaSOperationGroupResource [-SubscriptionId <String>] -JsonFilePath <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Initialize-AzNapsterSaaSOperationGroupResource [-SubscriptionId <String>] -JsonString <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
