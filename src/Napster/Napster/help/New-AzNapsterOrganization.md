...
```
New-AzNapsterOrganization -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Location <String> [-EnableSystemAssignedIdentity] [-MarketplaceSaasResourceId <String>]
