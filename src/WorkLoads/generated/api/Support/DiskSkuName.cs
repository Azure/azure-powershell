...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support.DiskSkuName PremiumLrs = @"Premium_LRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support.DiskSkuName PremiumV2Lrs = @"PremiumV2_LRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support.DiskSkuName PremiumZrs = @"Premium_ZRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support.DiskSkuName StandardLrs = @"Standard_LRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support.DiskSkuName StandardSsdLrs = @"StandardSSD_LRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support.DiskSkuName StandardSsdZrs = @"StandardSSD_ZRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support.DiskSkuName UltraSsdLrs = @"UltraSSD_LRS";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support.DiskSkuName e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support.DiskSkuName e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support.DiskSkuName e1, Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support.DiskSkuName e2)
        {
            return !e2.Equals(e1);
        }
