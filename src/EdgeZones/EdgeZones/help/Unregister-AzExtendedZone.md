...
online version: https://learn.microsoft.com/powershell/module/edgezones/unregister-azextendedzone
schema: 2.0.0
---

# Unregister-AzExtendedZone
...
### Unregister (Default)
```
Unregister-AzExtendedZone -AzureExtendedZoneName <String> -SubscriptionId <String> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UnregisterViaIdentity
```
Unregister-AzExtendedZone -InputObject <IEdgeZonesIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
