...
$dll = Join-Path $PSScriptRoot 'bin\EdgeZones.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\EdgeZones.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './EdgeZones.psd1'
...
$formatPs1xml = Join-Path $PSScriptRoot './EdgeZones.format.ps1xml'
