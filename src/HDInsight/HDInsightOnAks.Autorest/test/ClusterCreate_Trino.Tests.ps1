...
Describe 'ClusterCreate_Trino' {
    ...
    It "New-AzHdInsightOnAksSecretReference"{
        ...
        [Console]::WriteLine("New-AzHdInsightOnAksSecretReference done")
    }

    It "New-AzHdInsightOnAksTrinoHiveCatalog"{
        ...
        $trinoHiveCatalogOption=New-AzHdInsightOnAksTrinoHiveCatalog -CatalogName $catalogName -MetastoreDbConnectionUrl $metastoreDbConnectionURL -MetastoreDbConnectionUserName $metastoreDbUserName -MetastoreDbConnectionPasswordSecret $metastoreDbPasswordSecret

        [Console]::WriteLine("New-AzHdInsightOnAksTrinoHiveCatalog done")
    }
