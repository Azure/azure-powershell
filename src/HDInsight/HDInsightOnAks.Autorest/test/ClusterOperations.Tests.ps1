...
Describe 'ClusterOperations' {
    ...
    It 'New AzHdInsightOnAksCluster' {
        { $script:ComputeProfileNode = New-AzHdInsightOnAksNodeProfile -Type "Worker" -Count 3 -VMSize "Standard_D8d_v5" } | Should -Not -Throw
        ...
        [Console]::WriteLine("New-AzHdInsightOnAksNodeProfile done")
