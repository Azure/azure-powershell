...
{
    public class AzureHDInsightSshProfile
    {
        public AzureHDInsightSshProfile() { }

        public AzureHDInsightSshProfile(IList<AzureHDInsightSshPublicKey> publicKeys)
        {
        ...
        /// </summary>
        public IList<AzureHDInsightSshPublicKey> PublicKeys { get; set; }
    }
}
