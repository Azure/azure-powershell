...
{
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "HDInsightStreamingMapReduceJobDefinition"),OutputType(typeof(AzureHDInsightStreamingMapReduceJobDefinition))]
