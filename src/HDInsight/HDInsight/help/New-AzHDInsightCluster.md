...
$domainPassword = ConvertTo-SecureString -String $passwordString -AsPlainText -Force
...
$databasePassword=ConvertTo-SecureString -String $passwordString -AsPlainText -Force
