...
Since Api-version 2018-06-01-preview has been [discontinued](https://azure.microsoft.com/en-us/updates?id=azure-hdinsight-is-releasing-a-new-api-version), Az.HDInsight versions before 5.0.0 will not be available normally. Please update to the latest version to get the best service.
