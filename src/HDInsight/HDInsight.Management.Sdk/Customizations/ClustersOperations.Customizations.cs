...
namespace Microsoft.Azure.Management.HDInsight
{
    ...
    internal partial class ClustersOperations : IServiceOperations<HDInsightManagementClient>, IClustersOperations
    {
        ...
        {
            return await ResizeWithHttpMessagesAsync(resourceGroupName, clusterName, targetInstanceCount, null, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return await BeginResizeWithHttpMessagesAsync(resourceGroupName, clusterName, targetInstanceCount, null, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return await ExecuteScriptActionsWithHttpMessagesAsync(resourceGroupName, clusterName, persistOnSuccess, scriptActions, null, cancellationToken: cancellationToken).ConfigureAwait(false);
        }
        ...
        public async Task<AzureOperationResponse> BeginExecuteScriptActionsAsync(string resourceGroupName, string clusterName, IList<RuntimeScriptAction> scriptActions,
            bool persistOnSuccess, CancellationToken cancellationToken)
        {
            return await BeginExecuteScriptActionsWithHttpMessagesAsync(resourceGroupName, clusterName, persistOnSuccess, scriptActions, null, cancellationToken: cancellationToken).ConfigureAwait(false);
        }
    }
}
