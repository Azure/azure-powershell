...
namespace Microsoft.Azure.Management.HDInsight.Models
{
    ...
    public partial class ScriptActionPersistedGetResponseSpec
    {
        ...
        /// <param name="name">The name of script action.
        /// </param>

        /// <param name="uri">The URI to the script.
        /// </param>

        /// <param name="parameters">The parameters for the script provided.
        /// </param>

        /// <param name="roles">The list of roles where script will be executed.
        /// </param>

        /// <param name="applicationName">The application name for the script action.
        /// </param>
        public ScriptActionPersistedGetResponseSpec(string name = default(string), string uri = default(string), string parameters = default(string), System.Collections.Generic.IList<string> roles = default(System.Collections.Generic.IList<string>), string applicationName = default(string))
