...
namespace Microsoft.Azure.Management.HDInsight.Models
{
    ...
    public partial class AaddsResourceDetails
    {
        ...
        /// <param name="domainName">The Azure active directory domain service name.
        /// </param>

        /// <param name="initialSyncComplete">This indicates whether initial sync complete or not.
        /// </param>

        /// <param name="ldapsEnabled">This indicates whether enable ldaps or not.
        /// </param>

        /// <param name="ldapsPublicCertificateInBase64">The base 64 format string of public ldap certificate.
        /// </param>

        /// <param name="resourceId">The resource id of azure active directory domain service.
        /// </param>

        /// <param name="subnetId">The subnet resource id.
        /// </param>

        /// <param name="tenantId">The tenant id of azure active directory domain service .
        /// </param>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "initialSyncComplete")]
