...
namespace Microsoft.Azure.Management.HDInsight
{
    ...
    public static partial class ExtensionsOperationsExtensions
    {
            ...
            {
                operations.EnableMonitoringAsync(resourceGroupName, clusterName, workspaceId, primaryKey).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task EnableMonitoringAsync(this IExtensionsOperations operations, string resourceGroupName, string clusterName, string workspaceId = default(string), string primaryKey = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                operations.CreateAsync(resourceGroupName, clusterName, extensionName, workspaceId, primaryKey).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task CreateAsync(this IExtensionsOperations operations, string resourceGroupName, string clusterName, string extensionName, string workspaceId = default(string), string primaryKey = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                operations.BeginEnableMonitoringAsync(resourceGroupName, clusterName, workspaceId, primaryKey).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginEnableMonitoringAsync(this IExtensionsOperations operations, string resourceGroupName, string clusterName, string workspaceId = default(string), string primaryKey = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                operations.BeginCreateAsync(resourceGroupName, clusterName, extensionName, workspaceId, primaryKey).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginCreateAsync(this IExtensionsOperations operations, string resourceGroupName, string clusterName, string extensionName, string workspaceId = default(string), string primaryKey = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
