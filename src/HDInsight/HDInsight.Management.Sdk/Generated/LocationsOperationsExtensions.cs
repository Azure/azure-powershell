...
namespace Microsoft.Azure.Management.HDInsight
{
    ...
    public static partial class LocationsOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<NameAvailabilityCheckResult> CheckNameAvailabilityAsync(this ILocationsOperations operations, string location, string name = default(string), string type = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
