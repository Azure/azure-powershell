...
namespace Microsoft.Azure.Management.HDInsight
{
    ...
    public partial interface ILocationsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<NameAvailabilityCheckResult>> CheckNameAvailabilityWithHttpMessagesAsync(string location, string name = default(string), string type = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
