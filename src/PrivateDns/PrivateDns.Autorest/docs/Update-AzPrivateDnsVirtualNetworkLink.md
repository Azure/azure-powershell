...
online version: https://learn.microsoft.com/powershell/module/az.privatedns/update-azprivatednsvirtualnetworklink
schema: 2.0.0
---
...
Update-AzPrivateDnsVirtualNetworkLink -Name <String> -PrivateZoneName <String> -ResourceGroupName <String>
 ...
 [-ResolutionPolicy <ResolutionPolicy>] [-Tag <Hashtable>] [-VirtualNetworkId <String>]
...
Update-AzPrivateDnsVirtualNetworkLink -InputObject <IPrivateDnsIdentity> [-IfMatch <String>] [-Etag <String>]
 [-Location <String>] [-RegistrationEnabled] [-ResolutionPolicy <ResolutionPolicy>] [-Tag <Hashtable>]
