...
namespace Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/virtualNetworkLinks/{virtualNetworkLinkName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzPrivateDnsVirtualNetworkLink_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Description(@"Deletes a virtual network link to the specified Private DNS zone. WARNING: In case of a registration virtual network, all auto-registered DNS records in the zone for the virtual network will also be deleted. This operation cannot be undone.")]
    ...
    public partial class RemoveAzPrivateDnsVirtualNetworkLink_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The ETag of the virtual network link to the Private DNS zone. Omit this value to always delete the current zone. Specify the last-seen ETag value to prevent accidentally deleting any concurrent changes.")]
        ...
        /// <returns>a duplicate instance of RemoveAzPrivateDnsVirtualNetworkLink_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Cmdlets.RemoveAzPrivateDnsVirtualNetworkLink_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzPrivateDnsVirtualNetworkLink_DeleteViaIdentity();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.VirtualNetworkLinksDelete(InputObject.ResourceGroupName ?? null, InputObject.PrivateZoneName ?? null, InputObject.VirtualNetworkLinkName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, InputObject.SubscriptionId ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzPrivateDnsVirtualNetworkLink_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzPrivateDnsVirtualNetworkLink_DeleteViaIdentity()
        {
