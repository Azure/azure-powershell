...
namespace Microsoft.Azure.Management.PrivateDns.Models
{
    ...
    public partial class SrvRecord
    {
        ...
        /// <param name="priority">The priority value for this SRV record.
        /// </param>

        /// <param name="weight">The weight value for this SRV record.
        /// </param>

        /// <param name="port">The port value for this SRV record.
        /// </param>

        /// <param name="target">The target domain name for this SRV record.
        /// </param>
