...
namespace Microsoft.Azure.Management.PrivateDns.Models
{
    ...
    public partial class SoaRecord
    {
        ...
        /// <param name="host">The domain name of the authoritative name server for this SOA record.
        /// </param>

        /// <param name="email">The email contact for this SOA record.
        /// </param>

        /// <param name="serialNumber">The serial number for this SOA record.
        /// </param>

        /// <param name="refreshTime">The refresh value for this SOA record.
        /// </param>

        /// <param name="retryTime">The retry time for this SOA record.
        /// </param>

        /// <param name="expireTime">The expire time for this SOA record.
        /// </param>

        /// <param name="minimumTtl">The minimum value for this SOA record. By convention this is used to
        ...
        /// <summary>
        /// Gets or sets the domain name of the authoritative name server for this SOA
        /// record.
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "refreshTime")]
        ...
        /// <summary>
        /// Gets or sets the minimum value for this SOA record. By convention this is
