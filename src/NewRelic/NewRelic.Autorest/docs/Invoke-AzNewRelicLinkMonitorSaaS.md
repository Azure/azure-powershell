...
Invoke-AzNewRelicLinkMonitorSaaS -MonitorName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-SaaSResourceId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Link
```
Invoke-AzNewRelicLinkMonitorSaaS -MonitorName <String> -ResourceGroupName <String> -Body <ISaaSData>
...
### LinkViaJsonFilePath
```
Invoke-AzNewRelicLinkMonitorSaaS -MonitorName <String> -ResourceGroupName <String> -JsonFilePath <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### LinkViaJsonString
```
Invoke-AzNewRelicLinkMonitorSaaS -MonitorName <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
