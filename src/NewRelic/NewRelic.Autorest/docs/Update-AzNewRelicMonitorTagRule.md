...
```
Update-AzNewRelicMonitorTagRule -MonitorInputObject <INewRelicIdentity> -RuleSetName <String>
 ...
 [-MetricRuleSendMetric <String>] [-MetricRuleUserEmail <String>] [-DefaultProfile <PSObject>] [-Confirm]
