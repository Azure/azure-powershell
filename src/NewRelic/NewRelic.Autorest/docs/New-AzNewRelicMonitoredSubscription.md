...
```
New-AzNewRelicMonitoredSubscription -MonitorName <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### CreateViaJsonString
```
New-AzNewRelicMonitoredSubscription -MonitorName <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-AzNewRelicMonitoredSubscription -MonitorName test-01 -ResourceGroupName group-test -MonitoredSubscriptionList $sub1
```
