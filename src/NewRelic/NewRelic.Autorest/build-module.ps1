...
$dll = Join-Path $PSScriptRoot 'bin\Az.NewRelic.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.NewRelic.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.NewRelic.psd1'
...
$modelCmdlets = @(@{modelName="MonitoredSubscription"; cmdletName=""}, @{modelName="FilteringTag"; cmdletName=""})
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: NewRelic cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.NewRelic.format.ps1xml'
