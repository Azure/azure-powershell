...
online version: https://learn.microsoft.com/powershell/module/az.newrelic/update-aznewrelicmonitoringestionkey
schema: 2.0.0
---
...
### Refresh (Default)
```
Update-AzNewRelicMonitorIngestionKey -MonitorName <String> -ResourceGroupName <String>
...
### RefreshViaIdentity
```
Update-AzNewRelicMonitorIngestionKey -InputObject <INewRelicIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
