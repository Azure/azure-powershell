if(($null -eq $TestName) -or ($TestName -contains 'New-AzWeightsAndBiasesInstance'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-AzWeightsAndBiasesInstance.Recording.json'
