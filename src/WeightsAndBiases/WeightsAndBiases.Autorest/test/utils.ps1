...
function setupEnv() {
    ...
    $env.OfferDetailOfferId = "wandb_liftr"
    $env.OfferDetailPlanId = "liftr0plan"
    $env.OfferDetailPlanName = "WandB Liftr"
    $env.OfferDetailPublisherId = "weightsandbiasesinc1641502883483"
