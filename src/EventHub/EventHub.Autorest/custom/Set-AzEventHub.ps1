...
function Set-AzEventHub{
	...
	param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.ParameterBreakingChangeAttribute("Encoding","12.0.0", "7.0.0","2024-05-21" )]
        ${Encoding},
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.ParameterBreakingChangeAttribute("Status","12.0.0", "7.0.0","2024-05-21" )]
        ${Status},
