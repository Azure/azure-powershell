...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.ProvisioningState Active = @"Active";

        public static Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.ProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.ProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.ProvisioningState Scaling = @"Scaling";

        public static Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.ProvisioningState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.ProvisioningState Unknown = @"Unknown";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
