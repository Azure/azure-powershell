...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models
{
    ...
    public partial class Identity :
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.IIdentity,
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.IIdentityInternal
    {

        /// <summary>Internal Acessors for PrincipalId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.IIdentityInternal.PrincipalId { get => this._principalId; set { {_principalId = value;} } }

        /// <summary>Internal Acessors for TenantId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.IIdentityInternal.TenantId { get => this._tenantId; set { {_tenantId = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.IIdentityUserAssignedIdentities _userAssignedIdentity;

        /// <summary>Properties for User Assigned Identities</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Origin(Microsoft.Azure.PowerShell.Cmdlets.EventHub.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.IIdentityUserAssignedIdentities UserAssignedIdentity { get => (this._userAssignedIdentity = this._userAssignedIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.IdentityUserAssignedIdentities()); set => this._userAssignedIdentity = value; }
