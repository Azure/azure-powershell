...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview
{
    ...
    public partial class NetworkRuleSetProperties :
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview.INetworkRuleSetProperties,
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview.INetworkRuleSetPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview.INwRuleSetIPRules[] _iPRule;

        /// <summary>List of IpRules</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Origin(Microsoft.Azure.PowerShell.Cmdlets.EventHub.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview.INwRuleSetIPRules[] IPRule { get => this._iPRule; set => this._iPRule = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview.INwRuleSetVirtualNetworkRules[] _virtualNetworkRule;

        /// <summary>List VirtualNetwork Rules</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Origin(Microsoft.Azure.PowerShell.Cmdlets.EventHub.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview.INwRuleSetVirtualNetworkRules[] VirtualNetworkRule { get => this._virtualNetworkRule; set => this._virtualNetworkRule = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview.INwRuleSetIPRules[] IPRule { get; set; }
        /// <summary>
        /// This determines if traffic is allowed over public network. By default it is enabled. If value is SecuredByPerimeter then
        /// Inbound and Outbound communication is controlled by the network security perimeter and profile's access rules.
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview.INwRuleSetVirtualNetworkRules[] VirtualNetworkRule { get; set; }
