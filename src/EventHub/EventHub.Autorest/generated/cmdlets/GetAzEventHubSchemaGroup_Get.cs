...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzEventHubSchemaGroup_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SchemaRegistryGet(ResourceGroupName, NamespaceName, Name, SubscriptionId, onOk, onDefault, this, Pipeline);
