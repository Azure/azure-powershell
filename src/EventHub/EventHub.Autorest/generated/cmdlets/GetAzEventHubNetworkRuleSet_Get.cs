...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzEventHubNetworkRuleSet_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.NamespacesGetNetworkRuleSet(SubscriptionId, ResourceGroupName, NamespaceName, onOk, onDefault, this, Pipeline);
