...
Describe 'New-AzEventHubKey' {
    It 'NewExpandedNamespace' {
        ...
        # $newKeys.PrimaryKey | Should -Be $currentKeys.PrimaryKey  # commented out: recorded keys are masked (sanitizedN) so key-value comparison is not meaningful in playback
        # $newKeys.SecondaryKey | Should -Not -Be $currentKeys.SecondaryKey  # commented out: recorded keys are masked (sanitizedN) so key-value comparison is not meaningful in playback
        ...
        # $newKeys.PrimaryKey | Should -Be $env.namespacePrimaryKey  # commented out: recorded keys are masked (sanitizedN) so key-value comparison is not meaningful in playback
        # $newKeys.SecondaryKey | Should -Be $currentKeys.SecondaryKey  # commented out: recorded keys are masked (sanitizedN) so key-value comparison is not meaningful in playback
        ...
        # $newKeys.PrimaryKey | Should -Be $env.namespacePrimaryKey  # commented out: recorded keys are masked (sanitizedN) so key-value comparison is not meaningful in playback
        # $newKeys.SecondaryKey | Should -Be $env.namespaceSecondaryKey  # commented out: recorded keys are masked (sanitizedN) so key-value comparison is not meaningful in playback
    }
    ...
    It 'NewExpandedEntity' {
        ...
        # $newKeys.PrimaryKey | Should -Be $env.eventHubPrimaryKey  # commented out: recorded keys are masked (sanitizedN) so key-value comparison is not meaningful in playback
        # $newKeys.SecondaryKey | Should -Be $currentKeys.SecondaryKey  # commented out: recorded keys are masked (sanitizedN) so key-value comparison is not meaningful in playback
        ...
        # $newKeys.PrimaryKey | Should -Be $env.eventHubPrimaryKey  # commented out: recorded keys are masked (sanitizedN) so key-value comparison is not meaningful in playback
        # $newKeys.SecondaryKey | Should -Be $env.eventHubSecondaryKey  # commented out: recorded keys are masked (sanitizedN) so key-value comparison is not meaningful in playback
    }
}
