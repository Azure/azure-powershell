...
Describe 'New-AzEventHubKey' {
    It 'NewExpandedNamespace' {
        ...
        ($newKeys.PrimaryKey | ConvertFrom-SecureString -AsPlainText)  | Should -Not -Be ($currentKeys.PrimaryKey | ConvertFrom-SecureString -AsPlainText) 
        ...
        ($newKeys.PrimaryKey | ConvertFrom-SecureString -AsPlainText)  | Should -Be ($currentKeys.PrimaryKey | ConvertFrom-SecureString -AsPlainText) 
        ...
        ($newKeys.PrimaryKey | ConvertFrom-SecureString -AsPlainText)  | Should -Be $env.namespacePrimaryKey
        $newKeys.SecondaryKey  | Should -Be $currentKeys.SecondaryKey
    ...
    It 'NewExpandedEntity' {
        ...
        ($newKeys.PrimaryKey | ConvertFrom-SecureString -AsPlainText)  | Should -Be $env.eventHubPrimaryKey
        $newKeys.SecondaryKey  | Should -Be $currentKeys.SecondaryKey
