...
function assertNamespaceUpdates{
    param([Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20230101Preview.IEhNamespace]$expectedNamespace,[Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview.IEhNamespace]$namespace)
