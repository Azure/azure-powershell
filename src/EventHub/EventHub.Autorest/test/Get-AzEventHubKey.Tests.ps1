...
Describe 'Get-AzEventHubKey' {
    It 'GetExpandedNamespace'  {
		...
		($namespaceKeys.PrimaryKey | ConvertFrom-SecureString -AsPlainText) | Should -Not -Be $null
    ...
    It 'GetExpandedEntity'  {
		...
		($eventHubKeys.PrimaryKey | ConvertFrom-SecureString -AsPlainText) | Should -Not -Be $null
