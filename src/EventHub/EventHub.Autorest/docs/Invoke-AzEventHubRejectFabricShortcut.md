...
### RejectViaIdentity
```
Invoke-AzEventHubRejectFabricShortcut -InputObject <IEventHubIdentity> [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RejectViaIdentityEventhub
```
Invoke-AzEventHubRejectFabricShortcut -EventhubInputObject <IEventHubIdentity> -FabricShortcutName <String>
...
```yaml
Type: System.String
Parameter Sets: Reject, RejectViaIdentityEventhub, RejectViaIdentityNamespace
Aliases:
