...
```
Remove-AzEventHubConsumerGroup -EventhubInputObject <IEventHubIdentity> -Name <String>
...
```yaml
Type: System.String
Parameter Sets: Delete, DeleteViaIdentityEventhub, DeleteViaIdentityNamespace
