...
namespace Microsoft.Azure.Management.EventHub.Models
{
    ...
    public partial class CaptureDescription
    {
        ...
        /// <param name="enabled">A value that indicates whether capture description is enabled.
        /// </param>

        /// <param name="encoding">Enumerates the possible values for the encoding format of capture
        /// description. Note: &#39;AvroDeflate&#39; will be deprecated in New API Version
        /// Possible values include: &#39;Avro&#39;, &#39;AvroDeflate&#39;</param>

        /// <param name="intervalInSeconds">The time window allows you to set the frequency with which the capture to
        /// Azure Blobs will happen, value should between 60 to 900 seconds
        /// </param>

        /// <param name="sizeLimitInBytes">The size window defines the amount of data built up in your Event Hub
        /// before an capture operation, value should be between 10485760 to 524288000
        /// bytes
        /// </param>

        /// <param name="destination">Properties of Destination where capture will be stored. (Storage Account,
        /// Blob Names)
        /// </param>

        /// <param name="skipEmptyArchives">A value that indicates whether to Skip Empty Archives
        /// </param>
        ...
        /// <summary>
        /// Gets or sets enumerates the possible values for the encoding format of
        ...
        /// <summary>
        /// Gets or sets the time window allows you to set the frequency with which the
        ...
        /// <summary>
        /// Gets or sets the size window defines the amount of data built up in your
        ...
        /// <summary>
        /// Gets or sets properties of Destination where capture will be stored.
