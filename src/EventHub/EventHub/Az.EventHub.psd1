...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added new cmdlets for Eventhubnetworksecurityperimeterconfiguration - ''Get-AzEventHubNetworkSecurityPerimeterConfigurationsForAssociation'', ''Get-AzEventHubNetworkSecurityPerimeterConfiguration'''
