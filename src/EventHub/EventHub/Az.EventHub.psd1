...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added breaking change description for parameter ''MessageRetentionInDays'', which would be deprecated and would be replaced by ''RetentionTimeInHours'''
