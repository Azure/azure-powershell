...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added new Cluster cmdlets - ''New-AzEventHubCluster'', ''Set-AzEventHubCluster'', ''Get-AzEventHubCluster'', ''Remove-AzEventHubCluster'', ''Get-AzEventHubClustersAvailableRegions''.
