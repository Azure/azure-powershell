...
CmdletsToExport = 'New-AzEventHubNamespace', 'Get-AzEventHubNamespace', 
			   ...
			   'New-AzEventHubCluster','Set-AzEventHubCluster','Get-AzEventHubCluster','Remove-AzEventHubCluster','Get-AzEventHubClustersAvailableRegion'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added Managed Identity parameters to ''New-AzEventHubNamespace'' and ''Set-AzEventHubNamespace'' cmdlets'
