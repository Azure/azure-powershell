...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added support for Premium sku and namesapce and optional switch parameter ''DisableLocalAuth'' to ''New-AzEventHubNamespace'' and ''Set-AzEventHubNamespace'' '
