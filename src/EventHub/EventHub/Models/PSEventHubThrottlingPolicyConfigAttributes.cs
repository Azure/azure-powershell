...
{
    public class PSEventHubThrottlingPolicyConfigAttributes
    {
        public PSEventHubThrottlingPolicyConfigAttributes()
        {

        }

        public PSEventHubThrottlingPolicyConfigAttributes(ThrottlingPolicy throttlingPolicy)
        {
