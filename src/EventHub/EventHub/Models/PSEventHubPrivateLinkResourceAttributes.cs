...
namespace Microsoft.Azure.Commands.EventHub.Models
{
    ...
    public class PSEventHubPrivateLinkResourceAttributes
    {
        public PSEventHubPrivateLinkResourceAttributes()
        { }

        public PSEventHubPrivateLinkResourceAttributes(Microsoft.Azure.Management.EventHub.Models.PrivateLinkResource privateLink)
        {
            if (privateLink != null)
            {
