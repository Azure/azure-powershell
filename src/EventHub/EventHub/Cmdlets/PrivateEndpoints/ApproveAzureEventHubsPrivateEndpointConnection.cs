...
namespace Microsoft.Azure.Commands.EventHub.Commands.PrivateEndpoints
{
    ...
    /// </summary>
    [Cmdlet("Approve", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "EventHubPrivateEndpointConnection", SupportsShouldProcess = true, DefaultParameterSetName = PrivateEndpointPropertiesParameterSet), OutputType(typeof(PSEventHubPrivateEndpointAttributes))]
    public class ApproveAzureEventHubsPrivateEndpointConnection : AzureEventHubsCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(target: Name, action: string.Format(Resources.ApproveNamespacePrivateEndpoints, Name, NamespaceName, ResourceGroupName)))
            {
                try
                {
