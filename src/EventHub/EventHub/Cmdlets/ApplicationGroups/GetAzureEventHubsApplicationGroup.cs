...
{
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "EventHubApplicationGroup", SupportsShouldProcess = true), OutputType(typeof(PSEventHubApplicationGroupAttributes))]
