...
-->
## Upcoming Release
* Added new cmdlets for Eventhubnetworksecurityperimeterconfiguration - 'Get-AzEventHubNetworkSecurityPerimeterConfigurationResourceAssociationName', 'Get-AzEventHubNetworkSecurityPerimeterConfiguration'
