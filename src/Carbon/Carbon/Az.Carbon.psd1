#
# Module manifest for module 'Az.Carbon'
#
...
RequiredAssemblies = 'Carbon.Autorest/bin/Az.Carbon.private.dll'
...
FormatsToProcess = 'Carbon.Autorest/Az.Carbon.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('Carbon.Autorest/Az.Carbon.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Get-AzCarbonEmissionDataAvailableDateRange', 
               'Get-AzCarbonEmissionReport', 'New-AzCarbonItemDetailsQueryFilter', 
