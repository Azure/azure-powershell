...
.Link
https://learn.microsoft.com/powershell/module/Az.Carbon/new-azcarbontopitemsmonthlysummaryreportqueryfilter
#>
function New-AzCarbonTopItemsMonthlySummaryReportQueryFilter {
