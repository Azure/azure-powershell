...
online version: https://learn.microsoft.com/powershell/module/Az.Carbon/new-azcarbonmonthlysummaryreportqueryfilter
schema: 2.0.0
---

# New-AzCarbonMonthlySummaryReportQueryFilter
...
```
New-AzCarbonMonthlySummaryReportQueryFilter -CarbonScopeList <String[]> -DateRangeEnd <DateTime>
...
### Example 1: Create new MonthlySummaryReportQueryFilter object
```powershell
 New-AzCarbonMonthlySummaryReportQueryFilter -CarbonScopeList ('Scope1', 'Scope2', 'Scope3') -DateRangeEnd 2025-03-01 -DateRangeStart 2024-03-01 -SubscriptionList ('00000000-0000-0000-0000-000000000000','00000000-0000-0000-0000-000000000001')
```
