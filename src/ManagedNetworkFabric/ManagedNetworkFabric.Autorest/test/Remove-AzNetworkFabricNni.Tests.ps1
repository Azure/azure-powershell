if(($null -eq $TestName) -or ($TestName -contains 'Remove-AzNetworkFabricNni'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Remove-AzNetworkFabricNni.Recording.json'
...
Describe 'Remove-AzNetworkFabricNni' {
    ...
    It 'DeleteViaIdentityNetworkFabric' -skip {
