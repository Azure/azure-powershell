if(($null -eq $TestName) -or ($TestName -contains 'Get-AzNetworkFabricNni'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Get-AzNetworkFabricNni.Recording.json'
...
Describe 'Get-AzNetworkFabricNni' {
    ...
    It 'GetViaIdentityNetworkFabric' -skip {
