if(($null -eq $TestName) -or ($TestName -contains 'Remove-AzNetworkFabricTapRule'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Remove-AzNetworkFabricTapRule.Recording.json'
