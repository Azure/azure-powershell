...
Describe 'Restart-AzNetworkFabricDevice' {
    It 'RebootExpanded' {
        {
            Restart-AzNetworkFabricDevice -Name $global:config.networkDevice.name -ResourceGroupName $global:config.common.resourceGroupName -SubscriptionId $global:config.common.subscriptionId
        } | Should -Not -Throw
    }
