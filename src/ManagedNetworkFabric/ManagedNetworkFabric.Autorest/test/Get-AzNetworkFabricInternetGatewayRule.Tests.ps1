if(($null -eq $TestName) -or ($TestName -contains 'Get-AzNetworkFabricInternetGatewayRule'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Get-AzNetworkFabricInternetGatewayRule.Recording.json'
...
Describe 'Get-AzNetworkFabricInternetGatewayRule' {
