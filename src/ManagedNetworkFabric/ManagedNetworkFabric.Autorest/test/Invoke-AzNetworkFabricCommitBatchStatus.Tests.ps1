...
Describe 'Invoke-AzNetworkFabricCommitBatchStatus' {
    It 'CommitExpanded' {
        {
            Invoke-AzNetworkFabricCommitBatchStatus -NetworkFabricName $global:config.fabric.name -ResourceGroupName $global:config.common.resourceGroupName -SubscriptionId $global:config.common.subscriptionId
        } | Should -Not -Throw
    }
