    ...
    It 'Create' {
        {
            ...
            New-AzNetworkFabricInternalNetwork -Name $global:config.internalnetwork.name -L3IsolationDomainName $global:config.internalnetwork.l3domainName -ResourceGroupName $global:config.common.resourceGroupName -VlanId $global:config.internalnetwork.vlanId -BgpConfiguration $bgpConfiguration -ConnectedIPv4Subnet $connectedIPv4Subnet -EgressAclId $global:config.internalnetwork.egressAclId -ExportRoutePolicy $exportRoutePolicy -Extension $global:config.internalnetwork.extension -ImportRoutePolicy $importRoutePolicy -IngressAclId $global:config.internalnetwork.ingressAclId -IsMonitoringEnabled $global:config.internalnetwork.isMonitoringEnabled -Mtu $global:config.internalnetwork.mtu -StaticRouteConfigurationBfdConfiguration $staticRouteConfigurationBfdConfiguration -StaticRouteConfigurationExtension $global:config.internalnetwork.staticRouteConfigurationExtension -StaticRouteConfigurationIpv4Route $staticRouteConfigurationIpv4Route
