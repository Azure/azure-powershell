if(($null -eq $TestName) -or ($TestName -contains 'Update-AzNetworkFabricDevice'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Update-AzNetworkFabricDevice.Recording.json'
