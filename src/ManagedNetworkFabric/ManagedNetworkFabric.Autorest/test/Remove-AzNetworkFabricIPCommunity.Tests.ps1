if(($null -eq $TestName) -or ($TestName -contains 'Remove-AzNetworkFabricIPCommunity'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Remove-AzNetworkFabricIPCommunity.Recording.json'
