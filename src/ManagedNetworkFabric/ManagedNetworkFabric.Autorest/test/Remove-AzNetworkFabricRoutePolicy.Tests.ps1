if(($null -eq $TestName) -or ($TestName -contains 'Remove-AzNetworkFabricRoutePolicy'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Remove-AzNetworkFabricRoutePolicy.Recording.json'
