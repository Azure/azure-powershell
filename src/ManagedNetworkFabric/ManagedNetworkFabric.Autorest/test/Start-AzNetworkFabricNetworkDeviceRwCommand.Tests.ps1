...
Describe 'Start-AzNetworkFabricNetworkDeviceRwCommand' {
    It 'RunExpanded' {
        {
            Start-AzNetworkFabricNetworkDeviceRwCommand -NetworkDeviceName $global:config.networkDevice.name -ResourceGroupName $global:config.common.resourceGroupName -SubscriptionId $global:config.common.subscriptionId
        } | Should -Not -Throw
    }
