...
Describe 'Remove-AzNetworkFabricController' {
    It 'Delete' {
        {
            Remove-AzNetworkFabricController -Name $global:config.controller.name -ResourceGroupName $global:config.controller.resourceGroupName -SubscriptionId $global:config.controller.subscriptionId
        } | Should -Not -Throw
    }
