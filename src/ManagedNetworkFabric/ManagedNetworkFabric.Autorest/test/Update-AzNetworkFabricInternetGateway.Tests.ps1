if(($null -eq $TestName) -or ($TestName -contains 'Update-AzNetworkFabricInternetGateway'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Update-AzNetworkFabricInternetGateway.Recording.json'
