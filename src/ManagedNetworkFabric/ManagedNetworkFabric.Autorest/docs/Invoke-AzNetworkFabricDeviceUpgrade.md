...
```
Invoke-AzNetworkFabricDeviceUpgrade -Name <String> -ResourceGroupName <String> -Version <String>
 [-SubscriptionId <String>] [-RwDeviceConfigUrl <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Upgrade
```
Invoke-AzNetworkFabricDeviceUpgrade -Name <String> -ResourceGroupName <String>
 -Body <INetworkDeviceUpgradeRequest> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpgradeViaIdentity
```
Invoke-AzNetworkFabricDeviceUpgrade -InputObject <IManagedNetworkFabricIdentity>
 -Body <INetworkDeviceUpgradeRequest> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Invoke-AzNetworkFabricDeviceUpgrade -InputObject <IManagedNetworkFabricIdentity> -Version <String>
 [-RwDeviceConfigUrl <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```powershell
Invoke-AzNetworkFabricDeviceUpgrade -Name $name -ResourceGroupName $resourceGroupName -Version $version
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkDeviceUpgradeRequest
...
### Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkDeviceUpgradeResponse
