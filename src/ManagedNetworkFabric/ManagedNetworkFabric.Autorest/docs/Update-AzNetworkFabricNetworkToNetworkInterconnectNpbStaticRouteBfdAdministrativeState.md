...
online version: https://learn.microsoft.com/powershell/module/az.managednetworkfabric/update-aznetworkfabricnetworktonetworkinterconnectnpbstaticroutebfdadministrativestate
schema: 2.0.0
---

# Update-AzNetworkFabricNetworkToNetworkInterconnectNpbStaticRouteBfdAdministrativeState
...
```
Update-AzNetworkFabricNetworkToNetworkInterconnectNpbStaticRouteBfdAdministrativeState
 -NetworkFabricName <String> -NetworkToNetworkInterconnectName <String> -ResourceGroupName <String>
...
```
Update-AzNetworkFabricNetworkToNetworkInterconnectNpbStaticRouteBfdAdministrativeState
 -NetworkFabricInputObject <IManagedNetworkFabricIdentity> -NetworkToNetworkInterconnectName <String>
 -Body <IUpdateAdministrativeState> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
