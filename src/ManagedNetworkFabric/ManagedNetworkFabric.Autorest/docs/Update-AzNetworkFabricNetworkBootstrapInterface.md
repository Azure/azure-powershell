...
Update-AzNetworkFabricNetworkBootstrapInterface -InputObject <IManagedNetworkFabricIdentity>
 [-AdditionalDescription <String>] [-Annotation <String>] [-SerialNumber <String>]
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded, UpdateViaIdentityNetworkBootstrapDeviceExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityNetworkBootstrapDevice, UpdateViaIdentityNetworkBootstrapDeviceExpanded, UpdateViaJsonFilePath, UpdateViaJsonString
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IManagedNetworkFabricIdentity
Parameter Sets: UpdateViaIdentityNetworkBootstrapDevice, UpdateViaIdentityNetworkBootstrapDeviceExpanded
Aliases:
