...
Invoke-AzNetworkFabricNniBfdAdministrativeState -NetworkFabricInputObject <IManagedNetworkFabricIdentity>
 -NetworkToNetworkInterconnectName <String> -Body <INniUpdateBfdAdministrativeStateRequest>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INniUpdateBfdAdministrativeStateRequest
...
### Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INniUpdateBfdAdministrativeStateRequest

## OUTPUTS

### Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INniUpdateBfdAdministrativeStateResponse
