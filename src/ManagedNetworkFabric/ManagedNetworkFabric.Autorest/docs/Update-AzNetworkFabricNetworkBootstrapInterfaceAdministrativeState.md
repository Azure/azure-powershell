...
```
Update-AzNetworkFabricNetworkBootstrapInterfaceAdministrativeState
 -NetworkBootstrapDeviceInputObject <IManagedNetworkFabricIdentity> -NetworkBootstrapInterfaceName <String>
...
```
Update-AzNetworkFabricNetworkBootstrapInterfaceAdministrativeState -NetworkBootstrapDeviceName <String>
 -NetworkBootstrapInterfaceName <String> -ResourceGroupName <String> -JsonFilePath <String>
...
```
Update-AzNetworkFabricNetworkBootstrapInterfaceAdministrativeState -NetworkBootstrapDeviceName <String>
 -NetworkBootstrapInterfaceName <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
