...
$dll = Join-Path $PSScriptRoot 'bin\Az.ManagedNetworkFabric.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.ManagedNetworkFabric.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.ManagedNetworkFabric.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: ManagedNetworkFabric cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.ManagedNetworkFabric.format.ps1xml'
