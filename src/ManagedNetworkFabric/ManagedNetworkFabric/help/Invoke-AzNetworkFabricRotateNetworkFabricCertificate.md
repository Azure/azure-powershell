...
online version: https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricrotatenetworkfabriccertificate
schema: 2.0.0
---

# Invoke-AzNetworkFabricRotateNetworkFabricCertificate
...
### Rotate (Default)
```
Invoke-AzNetworkFabricRotateNetworkFabricCertificate -NetworkFabricName <String> -ResourceGroupName <String>
...
### RotateViaIdentity
```
Invoke-AzNetworkFabricRotateNetworkFabricCertificate -InputObject <IManagedNetworkFabricIdentity>
