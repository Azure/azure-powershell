...
```
New-AzNetworkFabricIPCommunity -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Location <String> [-Annotation <String>] [-IPCommunityRule <IIPCommunityRule[]>] [-Tag <Hashtable>]
...
[https://learn.microsoft.com/powershell/module/az.managednetworkfabric/new-aznetworkfabricipcommunity](https://learn.microsoft.com/powershell/module/az.managednetworkfabric/new-aznetworkfabricipcommunity)
