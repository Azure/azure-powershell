...
Invoke-AzNetworkFabricExternalNetworkBfdAdministrativeState -ExternalNetworkName <String>
 ...
 -Body <IExternalNetworkUpdateBfdAdministrativeStateRequest> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IExternalNetworkUpdateBfdAdministrativeStateRequest
