...
online version: https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricresyncnetworkdevicepassword
schema: 2.0.0
---

# Invoke-AzNetworkFabricResyncNetworkDevicePassword
...
### Resync (Default)
```
Invoke-AzNetworkFabricResyncNetworkDevicePassword -NetworkDeviceName <String> -ResourceGroupName <String>
...
### ResyncViaIdentity
```
Invoke-AzNetworkFabricResyncNetworkDevicePassword -InputObject <IManagedNetworkFabricIdentity>
...
### Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkDeviceResyncPasswordsResponse
