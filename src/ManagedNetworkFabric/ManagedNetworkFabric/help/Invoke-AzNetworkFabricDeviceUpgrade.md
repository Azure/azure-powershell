...
Invoke-AzNetworkFabricDeviceUpgrade -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Version <String> [-RwDeviceConfigUrl <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```
Invoke-AzNetworkFabricDeviceUpgrade -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Body <INetworkDeviceUpgradeRequest> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Invoke-AzNetworkFabricDeviceUpgrade -InputObject <IManagedNetworkFabricIdentity> -Version <String>
 [-RwDeviceConfigUrl <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
