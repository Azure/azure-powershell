...
### List1 (Default)
```
Get-AzNetworkFabricTapRule [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Break]
...
### GetViaIdentity
```
Get-AzNetworkFabricTapRule -InputObject <IManagedNetworkFabricIdentity> [-DefaultProfile <PSObject>] [-Break]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <Uri>]
 [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/az.managednetworkfabric/get-aznetworkfabrictaprule](https://learn.microsoft.com/powershell/module/az.managednetworkfabric/get-aznetworkfabrictaprule)
