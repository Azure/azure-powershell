...
online version: https://learn.microsoft.com/powershell/module/az.managednetworkfabric/update-aznetworkfabricinternalnetworkstaticroutebfdadministrativestate
schema: 2.0.0
---

# Update-AzNetworkFabricInternalNetworkStaticRouteBfdAdministrativeState
...
```
Update-AzNetworkFabricInternalNetworkStaticRouteBfdAdministrativeState -InternalNetworkName <String>
...
```
Update-AzNetworkFabricInternalNetworkStaticRouteBfdAdministrativeState
 -InputObject <IManagedNetworkFabricIdentity> [-ResourceId <String[]>] [-State <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
