...
online version: https://learn.microsoft.com/powershell/module/az.managednetworkfabric/remove-aznetworkfabricipcommunity
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzNetworkFabricIPCommunity -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzNetworkFabricIPCommunity -InputObject <IManagedNetworkFabricIdentity> [-DefaultProfile <PSObject>]
...
[https://learn.microsoft.com/powershell/module/az.managednetworkfabric/remove-aznetworkfabricipcommunity](https://learn.microsoft.com/powershell/module/az.managednetworkfabric/remove-aznetworkfabricipcommunity)
