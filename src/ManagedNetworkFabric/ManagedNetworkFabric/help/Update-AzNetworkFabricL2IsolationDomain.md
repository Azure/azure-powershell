...
Update-AzNetworkFabricL2IsolationDomain -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Annotation <String>] [-ExtendedVlan <String>] [-Mtu <Int32>] [-NetworkToNetworkInterconnectId <String>]
...
```
Update-AzNetworkFabricL2IsolationDomain -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### UpdateViaJsonString
```
Update-AzNetworkFabricL2IsolationDomain -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
