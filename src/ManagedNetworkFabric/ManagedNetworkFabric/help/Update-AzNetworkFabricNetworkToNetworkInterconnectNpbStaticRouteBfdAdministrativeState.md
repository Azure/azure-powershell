...
```
Update-AzNetworkFabricNetworkToNetworkInterconnectNpbStaticRouteBfdAdministrativeState
 -NetworkToNetworkInterconnectName <String> -NetworkFabricInputObject <IManagedNetworkFabricIdentity>
...
Update-AzNetworkFabricNetworkToNetworkInterconnectNpbStaticRouteBfdAdministrativeState
 -NetworkToNetworkInterconnectName <String> -NetworkFabricInputObject <IManagedNetworkFabricIdentity>
 -Body <IUpdateAdministrativeState> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
