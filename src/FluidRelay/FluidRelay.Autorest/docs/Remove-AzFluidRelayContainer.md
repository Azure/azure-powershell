...
```
Remove-AzFluidRelayContainer -FluidRelayServerInputObject <IFluidRelayIdentity> -Name <String>
...
Remove-AzFluidRelayContainer -FluidRelayServerName <String> -Name <String>
 -ResourceGroupInputObject <IFluidRelayIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Delete, DeleteViaIdentityFluidRelayServer, DeleteViaIdentityResourceGroup
