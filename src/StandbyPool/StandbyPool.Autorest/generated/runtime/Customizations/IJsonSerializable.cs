...
using Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.JsonSerializable.ToJson(dict, null);
            }
