...
namespace Microsoft.Azure.Management.IotCentral.Models
{
    ...
    public partial class Operation
    {
        ...
        /// <param name="name">Operation name: {provider}/{resource}/{read | write | action | delete}
        /// </param>

        /// <param name="display">The object that represents the operation.
        /// </param>

        /// <param name="origin">The intended executor of the operation.
        /// </param>

        /// <param name="properties">Additional descriptions for the operation.
        /// </param>
        ...
        /// <summary>
        /// Gets operation name: {provider}/{resource}/{read | write | action | delete}
        /// </summary>
