...
namespace Microsoft.Azure.Management.IotCentral.Models
{
    ...
    public partial class OperationDisplay
    {
        ...
        /// <param name="provider">Service provider: Microsoft IoT Central
        /// </param>

        /// <param name="resource">Resource Type: IoT Central
        /// </param>

        /// <param name="operation">Name of the operation
        /// </param>

        /// <param name="description">Friendly description for the operation,
        /// </param>
        ...
        /// <summary>
        /// Gets service provider: Microsoft IoT Central
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "provider")]
        public string Provider {get; private set; }

        /// <summary>
        /// Gets resource Type: IoT Central
        /// </summary>
