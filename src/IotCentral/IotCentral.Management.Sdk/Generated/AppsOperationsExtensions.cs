...
namespace Microsoft.Azure.Management.IotCentral
{
    ...
    public static partial class AppsOperationsExtensions
    {
            ...
            /// </param>
            public static AppAvailabilityInfo CheckNameAvailability(this IAppsOperations operations, string name, string type = "IoTApps")
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<AppAvailabilityInfo> CheckNameAvailabilityAsync(this IAppsOperations operations, string name, string type = "IoTApps", CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The type of the IoT Central resource to query.
            /// </param>
            public static AppAvailabilityInfo CheckSubdomainAvailability(this IAppsOperations operations, string name, string type = "IoTApps")
            {
                return operations.CheckSubdomainAvailabilityAsync(name, type).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<AppAvailabilityInfo> CheckSubdomainAvailabilityAsync(this IAppsOperations operations, string name, string type = "IoTApps", CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CheckSubdomainAvailabilityWithHttpMessagesAsync(name, type, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
