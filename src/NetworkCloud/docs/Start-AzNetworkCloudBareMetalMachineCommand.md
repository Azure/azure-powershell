...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/start-aznetworkcloudbaremetalmachinecommand
schema: 2.0.0
---

# Start-AzNetworkCloudBareMetalMachineCommand
...
### RunExpanded (Default)
```
Start-AzNetworkCloudBareMetalMachineCommand -BareMetalMachineName <String> -ResourceGroupName <String>
 -LimitTimeSecond <Int64> -Script <String> [-SubscriptionId <String>] [-Argument <String[]>]
...
```
Start-AzNetworkCloudBareMetalMachineCommand -BareMetalMachineName <String> -ResourceGroupName <String>
 -BareMetalMachineRunCommandParameter <IBareMetalMachineRunCommandParameters> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RunViaIdentity
```
Start-AzNetworkCloudBareMetalMachineCommand -InputObject <INetworkCloudIdentity>
...
```
Start-AzNetworkCloudBareMetalMachineCommand -InputObject <INetworkCloudIdentity> -LimitTimeSecond <Int64>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230501Preview.IBareMetalMachineRunCommandParameters
...
### Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230501Preview.IBareMetalMachineRunCommandParameters
