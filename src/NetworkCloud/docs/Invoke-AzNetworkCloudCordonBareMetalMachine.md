...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/invoke-aznetworkcloudcordonbaremetalmachine
schema: 2.0.0
---

# Invoke-AzNetworkCloudCordonBareMetalMachine
...
```
Invoke-AzNetworkCloudCordonBareMetalMachine -BareMetalMachineName <String> -ResourceGroupName <String>
...
### CordonViaIdentity
```
Invoke-AzNetworkCloudCordonBareMetalMachine -InputObject <INetworkCloudIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230501Preview.IBareMetalMachineCordonParameters
...
```yaml
Type: System.String
Parameter Sets: Cordon, CordonExpanded
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230501Preview.IBareMetalMachineCordonParameters
