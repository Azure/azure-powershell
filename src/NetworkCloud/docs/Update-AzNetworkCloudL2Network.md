...
### Update Layer 2 (L2) network
```powershell
Update-AzNetworkCloudL2Network -ResourceGroupName resourceGroupName -Name l2Network -Tag @{ tag1 = "tag1"; tag2 = "tag2" }
```
...
This command updates the properties of the existing layer 2 (L2) network.
...
### Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230501Preview.IL2Network
