...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/invoke-aznetworkclouddetachvirtualmachinevolume
schema: 2.0.0
---

# Invoke-AzNetworkCloudDetachVirtualMachineVolume
...
```
Invoke-AzNetworkCloudDetachVirtualMachineVolume -ResourceGroupName <String> -VirtualMachineName <String>
...
```
Invoke-AzNetworkCloudDetachVirtualMachineVolume -ResourceGroupName <String> -VirtualMachineName <String>
 -VirtualMachineDetachVolumeParameter <IVirtualMachineVolumeParameters> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DetachViaIdentity
```
Invoke-AzNetworkCloudDetachVirtualMachineVolume -InputObject <INetworkCloudIdentity>
 -VirtualMachineDetachVolumeParameter <IVirtualMachineVolumeParameters> [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DetachViaIdentityExpanded
```
Invoke-AzNetworkCloudDetachVirtualMachineVolume -InputObject <INetworkCloudIdentity> -VolumeId <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
