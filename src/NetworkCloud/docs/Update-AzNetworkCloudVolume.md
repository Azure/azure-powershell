...
```
Update-AzNetworkCloudVolume -InputObject <INetworkCloudIdentity> [-Tag <Hashtable>]
...
### Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230501Preview.IVolume
