...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/start-aznetworkcloudbaremetalmachinereadcommand
schema: 2.0.0
---

# Start-AzNetworkCloudBareMetalMachineReadCommand
...
```
Start-AzNetworkCloudBareMetalMachineReadCommand -InputObject <INetworkCloudIdentity>
...
### Run
```
Start-AzNetworkCloudBareMetalMachineReadCommand -BareMetalMachineName <String> -ResourceGroupName <String>
 -BareMetalMachineRunReadCommandsParameter <IBareMetalMachineRunReadCommandsParameters>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230501Preview.IBareMetalMachineRunReadCommandsParameters
...
### Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230501Preview.IBareMetalMachineRunReadCommandsParameters
