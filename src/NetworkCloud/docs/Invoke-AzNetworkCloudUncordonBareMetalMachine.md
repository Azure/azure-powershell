...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/invoke-aznetworkclouduncordonbaremetalmachine
schema: 2.0.0
---

# Invoke-AzNetworkCloudUncordonBareMetalMachine
...
### Uncordon (Default)
```
Invoke-AzNetworkCloudUncordonBareMetalMachine -BareMetalMachineName <String> -ResourceGroupName <String>
...
### UncordonViaIdentity
```
Invoke-AzNetworkCloudUncordonBareMetalMachine -InputObject <INetworkCloudIdentity>
