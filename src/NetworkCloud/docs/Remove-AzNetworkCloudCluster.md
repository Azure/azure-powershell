...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/remove-aznetworkcloudcluster
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzNetworkCloudCluster -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzNetworkCloudCluster -InputObject <INetworkCloudIdentity> [-DefaultProfile <PSObject>] [-AsJob]
