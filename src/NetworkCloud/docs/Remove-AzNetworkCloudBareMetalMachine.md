...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/remove-aznetworkcloudbaremetalmachine
schema: 2.0.0
---

# Remove-AzNetworkCloudBareMetalMachine
...
### Delete (Default)
```
Remove-AzNetworkCloudBareMetalMachine -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzNetworkCloudBareMetalMachine -InputObject <INetworkCloudIdentity> [-DefaultProfile <PSObject>]
