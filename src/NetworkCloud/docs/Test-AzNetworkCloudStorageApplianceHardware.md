...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/test-aznetworkcloudstorageappliancehardware
schema: 2.0.0
---

# Test-AzNetworkCloudStorageApplianceHardware
...
```
Test-AzNetworkCloudStorageApplianceHardware -ResourceGroupName <String> -StorageApplianceName <String>
...
```
Test-AzNetworkCloudStorageApplianceHardware -ResourceGroupName <String> -StorageApplianceName <String>
 -StorageApplianceValidateHardwareParameter <IStorageApplianceValidateHardwareParameters>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### ValidateViaIdentity
```
Test-AzNetworkCloudStorageApplianceHardware -InputObject <INetworkCloudIdentity>
 -StorageApplianceValidateHardwareParameter <IStorageApplianceValidateHardwareParameters>
...
```
Test-AzNetworkCloudStorageApplianceHardware -InputObject <INetworkCloudIdentity> [-DefaultProfile <PSObject>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IStorageApplianceValidateHardwareParameters
