...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/remove-aznetworkcloudl3network
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzNetworkCloudL3Network -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzNetworkCloudL3Network -InputObject <INetworkCloudIdentity> [-DefaultProfile <PSObject>] [-AsJob]
