...
```
Update-AzNetworkCloudVirtualMachine -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-VMImageRepositoryCredentialsPassword <String>]
...
Update-AzNetworkCloudVirtualMachine -InputObject <INetworkCloudIdentity> [-Tag <Hashtable>]
 [-VMImageRepositoryCredentialsPassword <String>] [-VMImageRepositoryCredentialsRegistryUrl <String>]
...
Parameter Sets: ReimageViaIdentity, UpdateViaIdentityExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Reimage, UpdateExpanded
