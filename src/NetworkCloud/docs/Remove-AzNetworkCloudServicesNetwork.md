...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/remove-aznetworkcloudservicesnetwork
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzNetworkCloudServicesNetwork -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzNetworkCloudServicesNetwork -InputObject <INetworkCloudIdentity> [-DefaultProfile <PSObject>]
...
### Example 1: Delete cloud services network
```powershell
...
This command deletes an existing cloud services network.
