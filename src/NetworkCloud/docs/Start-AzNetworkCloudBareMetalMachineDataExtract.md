...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/start-aznetworkcloudbaremetalmachinedataextract
schema: 2.0.0
---

# Start-AzNetworkCloudBareMetalMachineDataExtract
...
```
Start-AzNetworkCloudBareMetalMachineDataExtract -InputObject <INetworkCloudIdentity>
...
### Run
```
Start-AzNetworkCloudBareMetalMachineDataExtract -BareMetalMachineName <String> -ResourceGroupName <String>
 -BareMetalMachineRunDataExtractsParameter <IBareMetalMachineRunDataExtractsParameters>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230501Preview.IBareMetalMachineRunDataExtractsParameters
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230501Preview.IBareMetalMachineCommandSpecification[]
...
### Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230501Preview.IBareMetalMachineRunDataExtractsParameters
