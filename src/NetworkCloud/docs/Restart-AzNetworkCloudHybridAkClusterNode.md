...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/restart-aznetworkcloudhybridakclusternode
schema: 2.0.0
---

# Restart-AzNetworkCloudHybridAkClusterNode
...
```
Restart-AzNetworkCloudHybridAkClusterNode -HybridAksClusterName <String> -ResourceGroupName <String>
...
```
Restart-AzNetworkCloudHybridAkClusterNode -HybridAksClusterName <String> -ResourceGroupName <String>
 -HybridAksClusterRestartNodeParameter <IHybridAksClusterRestartNodeParameters> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestartViaIdentity
```
Restart-AzNetworkCloudHybridAkClusterNode -InputObject <INetworkCloudIdentity>
 -HybridAksClusterRestartNodeParameter <IHybridAksClusterRestartNodeParameters> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestartViaIdentityExpanded
```
Restart-AzNetworkCloudHybridAkClusterNode -InputObject <INetworkCloudIdentity> -NodeName <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IHybridAksClusterRestartNodeParameters
