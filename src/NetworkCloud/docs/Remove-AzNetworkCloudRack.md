...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/remove-aznetworkcloudrack
schema: 2.0.0
---

# Remove-AzNetworkCloudRack
...
### Delete (Default)
```
Remove-AzNetworkCloudRack -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzNetworkCloudRack -InputObject <INetworkCloudIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
