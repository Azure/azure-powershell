...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/remove-aznetworkclouddefaultcninetwork
schema: 2.0.0
---

# Remove-AzNetworkCloudDefaultCniNetwork
...
### Delete (Default)
```
Remove-AzNetworkCloudDefaultCniNetwork -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzNetworkCloudDefaultCniNetwork -InputObject <INetworkCloudIdentity> [-DefaultProfile <PSObject>]
