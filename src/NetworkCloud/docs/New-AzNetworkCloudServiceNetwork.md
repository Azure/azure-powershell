...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/new-aznetworkcloudservicenetwork
schema: 2.0.0
---

# New-AzNetworkCloudServiceNetwork
...
```
New-AzNetworkCloudServiceNetwork -CloudServicesNetworkName <String> -ResourceGroupName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IEgressEndpoint[]
Parameter Sets: (All)
Aliases:
