...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/update-aznetworkcloudclusterversion
schema: 2.0.0
---

# Update-AzNetworkCloudClusterVersion
...
```
Update-AzNetworkCloudClusterVersion -ClusterName <String> -ResourceGroupName <String>
 -TargetClusterVersion <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzNetworkCloudClusterVersion -InputObject <INetworkCloudIdentity> -TargetClusterVersion <String>
