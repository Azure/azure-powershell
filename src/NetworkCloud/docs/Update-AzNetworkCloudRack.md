...
Update-AzNetworkCloudRack -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-RackLocation <String>] [-RackSerialNumber <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
...
Update-AzNetworkCloudRack -InputObject <INetworkCloudIdentity> [-RackLocation <String>]
 [-RackSerialNumber <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
...
### Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230501Preview.IRack
