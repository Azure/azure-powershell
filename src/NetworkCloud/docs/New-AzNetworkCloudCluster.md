...
New-AzNetworkCloudCluster -Name <String> -ResourceGroupName <String>
 ...
 -AggregatorOrSingleRackDefinitionRackSkuId <String> -AnalyticsWorkspaceId <String> -ClusterType <ClusterType>
 -ClusterVersion <String> -ExtendedLocationName <String> -ExtendedLocationType <String> -Location <String>
