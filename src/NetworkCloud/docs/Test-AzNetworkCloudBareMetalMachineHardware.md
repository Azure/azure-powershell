...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/test-aznetworkcloudbaremetalmachinehardware
schema: 2.0.0
---

# Test-AzNetworkCloudBareMetalMachineHardware
...
```
Test-AzNetworkCloudBareMetalMachineHardware -BareMetalMachineName <String> -ResourceGroupName <String>
...
```
Test-AzNetworkCloudBareMetalMachineHardware -BareMetalMachineName <String> -ResourceGroupName <String>
 -BareMetalMachineValidateHardwareParameter <IBareMetalMachineValidateHardwareParameters>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### ValidateViaIdentity
```
Test-AzNetworkCloudBareMetalMachineHardware -InputObject <INetworkCloudIdentity>
 -BareMetalMachineValidateHardwareParameter <IBareMetalMachineValidateHardwareParameters>
...
```
Test-AzNetworkCloudBareMetalMachineHardware -InputObject <INetworkCloudIdentity> [-DefaultProfile <PSObject>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230501Preview.IBareMetalMachineValidateHardwareParameters
...
### Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230501Preview.IBareMetalMachineValidateHardwareParameters
