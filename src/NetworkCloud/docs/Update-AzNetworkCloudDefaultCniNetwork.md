...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/update-aznetworkclouddefaultcninetwork
schema: 2.0.0
---

# Update-AzNetworkCloudDefaultCniNetwork
...
```
Update-AzNetworkCloudDefaultCniNetwork -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzNetworkCloudDefaultCniNetwork -InputObject <INetworkCloudIdentity> [-Tag <Hashtable>]
