...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230501Preview.INetworkAttachment[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230501Preview.IVirtualMachinePlacementHint[]
Parameter Sets: (All)
Aliases:
