...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/restart-aznetworkcloudvirtualmachine
schema: 2.0.0
---
...
### Restart (Default)
```
Restart-AzNetworkCloudVirtualMachine -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestartViaIdentity
```
Restart-AzNetworkCloudVirtualMachine -InputObject <INetworkCloudIdentity> [-DefaultProfile <PSObject>]
