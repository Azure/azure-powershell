...
```
Get-AzNetworkCloudAgentPool -Name <String> -KubernetesCluster1InputObject <INetworkCloudIdentity>
...
```yaml
Type: System.String
Parameter Sets: Get1, Get, GetViaIdentityKubernetesCluster1, GetViaIdentityKubernetesCluster
