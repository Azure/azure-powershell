...
```
New-AzNetworkCloudVolume -InputObject <INetworkCloudIdentity> [-IfMatch <String>] [-IfNoneMatch <String>]
 -ExtendedLocationName <String> -ExtendedLocationType <String> -Location <String> -SizeMiB <Int64>
 [-StorageApplianceId <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
