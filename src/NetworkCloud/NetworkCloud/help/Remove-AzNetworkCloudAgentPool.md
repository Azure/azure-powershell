...
```
Remove-AzNetworkCloudAgentPool -Name <String> -KubernetesCluster1InputObject <INetworkCloudIdentity>
...
```yaml
Type: System.String
Parameter Sets: Delete, Delete1, DeleteViaIdentityKubernetesCluster1, DeleteViaIdentityKubernetesCluster
