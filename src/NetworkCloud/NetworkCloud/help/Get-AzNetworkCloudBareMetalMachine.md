...
### List (Default)
```
Get-AzNetworkCloudBareMetalMachine [-SubscriptionId <String[]>] [-SkipToken <String>] [-Top <Int32>]
...
### Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250901.IBareMetalMachine
