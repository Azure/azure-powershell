...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/remove-aznetworkcloudbaremetalmachinekeyset
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzNetworkCloudBareMetalMachineKeySet -ClusterName <String> -Name <String> -ResourceGroupName <String>
...
```
Remove-AzNetworkCloudBareMetalMachineKeySet -Name <String> -Cluster1InputObject <INetworkCloudIdentity>
...
### DeleteViaIdentity1
```
Remove-AzNetworkCloudBareMetalMachineKeySet -InputObject <INetworkCloudIdentity> [-IfMatch <String>]
...
### Example 1: Delete Cluster's bare metal machine key set
```powershell
...
This command deletes the bare metal machine key set of a cluster.
