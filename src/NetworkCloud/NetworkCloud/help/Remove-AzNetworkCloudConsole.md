...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/remove-aznetworkcloudconsole
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzNetworkCloudConsole -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -VirtualMachineName <String> [-IfMatch <String>] [-IfNoneMatch <String>] [-DefaultProfile <PSObject>] [-AsJob]
...
### Example 1: Delete virtual machine's console
```powershell
...
This command deletes the existing console for a virtual machine.
...
```yaml
Type: System.String
Parameter Sets: Delete, DeleteViaIdentityVirtualMachine1, DeleteViaIdentityVirtualMachine, Delete1
Aliases: ConsoleName
