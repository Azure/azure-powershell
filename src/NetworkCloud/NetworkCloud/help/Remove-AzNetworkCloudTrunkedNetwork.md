...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/remove-aznetworkcloudtrunkednetwork
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzNetworkCloudTrunkedNetwork -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzNetworkCloudTrunkedNetwork -InputObject <INetworkCloudIdentity> [-IfMatch <String>]
...
### Example 1: Delete trunked network
```powershell
...
This command deletes an existing trunked network.
