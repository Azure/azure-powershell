...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/remove-aznetworkcloudclustermanager
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzNetworkCloudClusterManager -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzNetworkCloudClusterManager -InputObject <INetworkCloudIdentity> [-IfMatch <String>]
