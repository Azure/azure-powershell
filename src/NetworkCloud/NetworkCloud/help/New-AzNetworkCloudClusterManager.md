...
```
New-AzNetworkCloudClusterManager -InputObject <INetworkCloudIdentity> [-IfMatch <String>]
 [-IfNoneMatch <String>] -FabricControllerId <String> -Location <String> [-AnalyticsWorkspaceId <String>]
