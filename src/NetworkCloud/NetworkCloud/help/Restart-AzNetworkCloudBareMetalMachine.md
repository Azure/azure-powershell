...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/restart-aznetworkcloudbaremetalmachine
schema: 2.0.0
---
...
### Example 1: Restart bare metal machine
```powershell
...
This command restarts a bare metal machine.
