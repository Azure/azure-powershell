...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzNetworkCloudStorageApplianceReadCommand_RunViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class StartAzNetworkCloudStorageApplianceReadCommand_RunViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Backing field for <see cref="StorageApplianceRunReadCommandsParameter" /> property.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IStorageApplianceRunReadCommandsParameters _storageApplianceRunReadCommandsParameter;
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "StorageApplianceRunReadCommandsParameters represents the body of request containing list of read-only commands to run for a storage appliance.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"StorageApplianceRunReadCommandsParameters represents the body of request containing list of read-only commands to run for a storage appliance.",
        SerializedName = @"storageApplianceRunReadCommandsParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IStorageApplianceRunReadCommandsParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IStorageApplianceRunReadCommandsParameters StorageApplianceRunReadCommandsParameter { get => this._storageApplianceRunReadCommandsParameter; set => this._storageApplianceRunReadCommandsParameter = value; }
        ...
        /// <returns>
        /// a duplicate instance of StartAzNetworkCloudStorageApplianceReadCommand_RunViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.StartAzNetworkCloudStorageApplianceReadCommand_RunViaIdentity Clone()
        {
            var clone = new StartAzNetworkCloudStorageApplianceReadCommand_RunViaIdentity();
            ...
            clone.StorageApplianceRunReadCommandsParameter = this.StorageApplianceRunReadCommandsParameter;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.StorageAppliancesRunReadCommandsViaIdentity(InputObject.Id, StorageApplianceRunReadCommandsParameter, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.StorageAppliancesRunReadCommands(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.StorageApplianceName ?? null, StorageApplianceRunReadCommandsParameter, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=StorageApplianceRunReadCommandsParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzNetworkCloudStorageApplianceReadCommand_RunViaIdentity" /> cmdlet class.
        /// </summary>
        public StartAzNetworkCloudStorageApplianceReadCommand_RunViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=StorageApplianceRunReadCommandsParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=StorageApplianceRunReadCommandsParameter })
                    {
