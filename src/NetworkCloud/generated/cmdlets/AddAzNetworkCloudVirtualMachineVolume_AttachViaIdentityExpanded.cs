...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] AttachVolume=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/virtualMachines/{virtualMachineName}/attachVolume"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Add, @"AzNetworkCloudVirtualMachineVolume_AttachViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Description(@"Attach volume to the provided virtual machine.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Generated]
    public partial class AddAzNetworkCloudVirtualMachineVolume_AttachViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// virtual machine.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IVirtualMachineVolumeParameters _virtualMachineAttachVolumeParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.VirtualMachineVolumeParameters();
        ...
        public string VolumeId { get => _virtualMachineAttachVolumeParametersBody.VolumeId ?? null; set => _virtualMachineAttachVolumeParametersBody.VolumeId = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="AddAzNetworkCloudVirtualMachineVolume_AttachViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public AddAzNetworkCloudVirtualMachineVolume_AttachViaIdentityExpanded()
        {
        ...
        /// <returns>
        /// a duplicate instance of AddAzNetworkCloudVirtualMachineVolume_AttachViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.AddAzNetworkCloudVirtualMachineVolume_AttachViaIdentityExpanded Clone()
        {
            var clone = new AddAzNetworkCloudVirtualMachineVolume_AttachViaIdentityExpanded();
            ...
            clone._virtualMachineAttachVolumeParametersBody = this._virtualMachineAttachVolumeParametersBody;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualMachinesAttachVolume' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualMachinesAttachVolumeViaIdentity(InputObject.Id, _virtualMachineAttachVolumeParametersBody, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualMachinesAttachVolume(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VirtualMachineName ?? null, _virtualMachineAttachVolumeParametersBody, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_virtualMachineAttachVolumeParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_virtualMachineAttachVolumeParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_virtualMachineAttachVolumeParametersBody })
                    {
