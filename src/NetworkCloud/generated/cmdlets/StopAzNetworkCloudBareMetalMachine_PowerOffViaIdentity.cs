...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] PowerOff=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/bareMetalMachines/{bareMetalMachineName}/powerOff"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Stop, @"AzNetworkCloudBareMetalMachine_PowerOffViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Description(@"Power off the provided bare metal machine.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Generated]
    public partial class StopAzNetworkCloudBareMetalMachine_PowerOffViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="BareMetalMachinePowerOffParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachinePowerOffParameters _bareMetalMachinePowerOffParameter;

        /// <summary>
        /// BareMetalMachinePowerOffParameters represents the body of the request to power off bare metal machine.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "BareMetalMachinePowerOffParameters represents the body of the request to power off bare metal machine.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"BareMetalMachinePowerOffParameters represents the body of the request to power off bare metal machine.",
        SerializedName = @"bareMetalMachinePowerOffParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachinePowerOffParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachinePowerOffParameters BareMetalMachinePowerOffParameter { get => this._bareMetalMachinePowerOffParameter; set => this._bareMetalMachinePowerOffParameter = value; }
        ...
        /// <returns>a duplicate instance of StopAzNetworkCloudBareMetalMachine_PowerOffViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.StopAzNetworkCloudBareMetalMachine_PowerOffViaIdentity Clone()
        {
            var clone = new StopAzNetworkCloudBareMetalMachine_PowerOffViaIdentity();
            ...
            clone.BareMetalMachinePowerOffParameter = this.BareMetalMachinePowerOffParameter;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BareMetalMachinesPowerOff' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BareMetalMachinesPowerOffViaIdentity(InputObject.Id, BareMetalMachinePowerOffParameter, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BareMetalMachinesPowerOff(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.BareMetalMachineName ?? null, BareMetalMachinePowerOffParameter, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=BareMetalMachinePowerOffParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StopAzNetworkCloudBareMetalMachine_PowerOffViaIdentity" /> cmdlet class.
        /// </summary>
        public StopAzNetworkCloudBareMetalMachine_PowerOffViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=BareMetalMachinePowerOffParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=BareMetalMachinePowerOffParameter })
                    {
