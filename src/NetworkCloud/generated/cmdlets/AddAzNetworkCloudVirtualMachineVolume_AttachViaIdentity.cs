...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Add, @"AzNetworkCloudVirtualMachineVolume_AttachViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class AddAzNetworkCloudVirtualMachineVolume_AttachViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="VirtualMachineAttachVolumeParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IVirtualMachineVolumeParameters _virtualMachineAttachVolumeParameter;
        ...
        SerializedName = @"virtualMachineAttachVolumeParameters",
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IVirtualMachineVolumeParameters VirtualMachineAttachVolumeParameter { get => this._virtualMachineAttachVolumeParameter; set => this._virtualMachineAttachVolumeParameter = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="AddAzNetworkCloudVirtualMachineVolume_AttachViaIdentity" /> cmdlet class.
        /// </summary>
        public AddAzNetworkCloudVirtualMachineVolume_AttachViaIdentity()
        {
        ...
        /// <returns>a duplicate instance of AddAzNetworkCloudVirtualMachineVolume_AttachViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.AddAzNetworkCloudVirtualMachineVolume_AttachViaIdentity Clone()
        {
            var clone = new AddAzNetworkCloudVirtualMachineVolume_AttachViaIdentity();
            ...
            clone.VirtualMachineAttachVolumeParameter = this.VirtualMachineAttachVolumeParameter;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualMachinesAttachVolumeViaIdentity(InputObject.Id, VirtualMachineAttachVolumeParameter, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualMachinesAttachVolume(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VirtualMachineName ?? null, VirtualMachineAttachVolumeParameter, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=VirtualMachineAttachVolumeParameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=VirtualMachineAttachVolumeParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=VirtualMachineAttachVolumeParameter })
                    {
