...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// <summary>Validate the hardware of the provided storage appliance.</summary>
    /// <remarks>
    /// [OpenAPI] ValidateHardware=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/storageAppliances/{storageApplianceName}/validateHardware"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzNetworkCloudStorageApplianceHardware_Validate", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Description(@"Validate the hardware of the provided storage appliance.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Generated]
    public partial class TestAzNetworkCloudStorageApplianceHardware_Validate : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Backing field for <see cref="StorageApplianceValidateHardwareParameter" /> property.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IStorageApplianceValidateHardwareParameters _storageApplianceValidateHardwareParameter;
        ...
        /// appliance.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "StorageApplianceValidateHardwareParameters represents the body of the request to validate the physical hardware of a storage appliance.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"StorageApplianceValidateHardwareParameters represents the body of the request to validate the physical hardware of a storage appliance.",
        SerializedName = @"storageApplianceValidateHardwareParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IStorageApplianceValidateHardwareParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IStorageApplianceValidateHardwareParameters StorageApplianceValidateHardwareParameter { get => this._storageApplianceValidateHardwareParameter; set => this._storageApplianceValidateHardwareParameter = value; }
        ...
        /// <returns>a duplicate instance of TestAzNetworkCloudStorageApplianceHardware_Validate</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.TestAzNetworkCloudStorageApplianceHardware_Validate Clone()
        {
            var clone = new TestAzNetworkCloudStorageApplianceHardware_Validate();
            ...
            clone.StorageApplianceValidateHardwareParameter = this.StorageApplianceValidateHardwareParameter;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'StorageAppliancesValidateHardware' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.StorageAppliancesValidateHardware(SubscriptionId, ResourceGroupName, StorageApplianceName, StorageApplianceValidateHardwareParameter, onNoContent, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzNetworkCloudStorageApplianceHardware_Validate" /> cmdlet class.
        /// </summary>
        public TestAzNetworkCloudStorageApplianceHardware_Validate()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, StorageApplianceName=StorageApplianceName, body=StorageApplianceValidateHardwareParameter })
                    {
