...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Restart, @"AzNetworkCloudHybridAkClusterNode_RestartViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class RestartAzNetworkCloudHybridAkClusterNode_RestartViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of RestartAzNetworkCloudHybridAkClusterNode_RestartViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.RestartAzNetworkCloudHybridAkClusterNode_RestartViaIdentityExpanded Clone()
        {
            var clone = new RestartAzNetworkCloudHybridAkClusterNode_RestartViaIdentityExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.HybridAksClustersRestartNodeViaIdentity(InputObject.Id, _hybridAksClusterRestartNodeParametersBody, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.HybridAksClustersRestartNode(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.HybridAksClusterName ?? null, _hybridAksClusterRestartNodeParametersBody, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_hybridAksClusterRestartNodeParametersBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RestartAzNetworkCloudHybridAkClusterNode_RestartViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public RestartAzNetworkCloudHybridAkClusterNode_RestartViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_hybridAksClusterRestartNodeParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_hybridAksClusterRestartNodeParametersBody })
                    {
