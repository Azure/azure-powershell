...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// <summary>
    /// Run one or more read-only commands on the provided bare metal machine. The URL to storage account with the command execution
    /// results and the command exit code can be retrieved from the operation status API once available.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] RunReadCommands=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/bareMetalMachines/{bareMetalMachineName}/runReadCommands"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzNetworkCloudBareMetalMachineRunReadCommand_RunViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Description(@"Run one or more read-only commands on the provided bare metal machine. The URL to storage account with the command execution results and the command exit code can be retrieved from the operation status API once available.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Generated]
    public partial class InvokeAzNetworkCloudBareMetalMachineRunReadCommand_RunViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IBareMetalMachineRunReadCommandsParameters _bareMetalMachineRunReadCommandsParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.BareMetalMachineRunReadCommandsParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The list of read-only commands to be executed directly against the target machine.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IBareMetalMachineCommandSpecification[] Command { get => _bareMetalMachineRunReadCommandsParametersBody.Command ?? null /* arrayOf */; set => _bareMetalMachineRunReadCommandsParametersBody.Command = value; }
        ...
        public long LimitTimeSecond { get => _bareMetalMachineRunReadCommandsParametersBody.LimitTimeSecond; set => _bareMetalMachineRunReadCommandsParametersBody.LimitTimeSecond = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzNetworkCloudBareMetalMachineRunReadCommand_RunViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.InvokeAzNetworkCloudBareMetalMachineRunReadCommand_RunViaIdentityExpanded Clone()
        {
            var clone = new InvokeAzNetworkCloudBareMetalMachineRunReadCommand_RunViaIdentityExpanded();
            ...
            clone._bareMetalMachineRunReadCommandsParametersBody = this._bareMetalMachineRunReadCommandsParametersBody;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzNetworkCloudBareMetalMachineRunReadCommand_RunViaIdentityExpanded"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzNetworkCloudBareMetalMachineRunReadCommand_RunViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BareMetalMachinesRunReadCommands' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BareMetalMachinesRunReadCommandsViaIdentity(InputObject.Id, _bareMetalMachineRunReadCommandsParametersBody, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BareMetalMachinesRunReadCommands(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.BareMetalMachineName ?? null, _bareMetalMachineRunReadCommandsParametersBody, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_bareMetalMachineRunReadCommandsParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api40.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_bareMetalMachineRunReadCommandsParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_bareMetalMachineRunReadCommandsParametersBody })
                    {
