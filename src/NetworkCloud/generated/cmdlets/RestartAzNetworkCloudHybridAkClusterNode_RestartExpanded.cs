...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RestartNode=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/hybridAksClusters/{hybridAksClusterName}/restartNode"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Restart, @"AzNetworkCloudHybridAkClusterNode_RestartExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Description(@"Restart a targeted node of a Hybrid AKS cluster.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Generated]
    public partial class RestartAzNetworkCloudHybridAkClusterNode_RestartExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IHybridAksClusterRestartNodeParameters _hybridAksClusterRestartNodeParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.HybridAksClusterRestartNodeParameters();
        ...
        /// <summary>Backing field for <see cref="HybridAksClusterName" /> property.</summary>
        private string _hybridAksClusterName;

        /// <summary>The name of the Hybrid AKS cluster.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the Hybrid AKS cluster.")]
        ...
        public string HybridAksClusterName { get => this._hybridAksClusterName; set => this._hybridAksClusterName = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the node to restart.")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string NodeName { get => _hybridAksClusterRestartNodeParametersBody.NodeName ?? null; set => _hybridAksClusterRestartNodeParametersBody.NodeName = value; }
        ...
        /// <returns>
        /// a duplicate instance of RestartAzNetworkCloudHybridAkClusterNode_RestartExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.RestartAzNetworkCloudHybridAkClusterNode_RestartExpanded Clone()
        {
            var clone = new RestartAzNetworkCloudHybridAkClusterNode_RestartExpanded();
            ...
            clone._hybridAksClusterRestartNodeParametersBody = this._hybridAksClusterRestartNodeParametersBody;
            clone.SubscriptionId = this.SubscriptionId;
            clone.ResourceGroupName = this.ResourceGroupName;
            clone.HybridAksClusterName = this.HybridAksClusterName;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'HybridAksClustersRestartNode' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.HybridAksClustersRestartNode(SubscriptionId, ResourceGroupName, HybridAksClusterName, _hybridAksClusterRestartNodeParametersBody, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,HybridAksClusterName=HybridAksClusterName,body=_hybridAksClusterRestartNodeParametersBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RestartAzNetworkCloudHybridAkClusterNode_RestartExpanded" /> cmdlet class.
        /// </summary>
        public RestartAzNetworkCloudHybridAkClusterNode_RestartExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, HybridAksClusterName=HybridAksClusterName, body=_hybridAksClusterRestartNodeParametersBody })
                    {
