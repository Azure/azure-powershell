...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Stop, @"AzNetworkCloudVirtualMachine_PowerOff", SupportsShouldProcess = true)]
    ...
    public partial class StopAzNetworkCloudVirtualMachine_PowerOff : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="VirtualMachinePowerOffParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IVirtualMachinePowerOffParameters _virtualMachinePowerOffParameter;

        /// <summary>
        /// VirtualMachinePowerOffParameters represents the body of the request to power off virtual machine.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "VirtualMachinePowerOffParameters represents the body of the request to power off virtual machine.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"VirtualMachinePowerOffParameters represents the body of the request to power off virtual machine.",
        SerializedName = @"virtualMachinePowerOffParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IVirtualMachinePowerOffParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IVirtualMachinePowerOffParameters VirtualMachinePowerOffParameter { get => this._virtualMachinePowerOffParameter; set => this._virtualMachinePowerOffParameter = value; }
        ...
        /// <returns>a duplicate instance of StopAzNetworkCloudVirtualMachine_PowerOff</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.StopAzNetworkCloudVirtualMachine_PowerOff Clone()
        {
            var clone = new StopAzNetworkCloudVirtualMachine_PowerOff();
            ...
            clone.VirtualMachinePowerOffParameter = this.VirtualMachinePowerOffParameter;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VirtualMachinesPowerOff(SubscriptionId, ResourceGroupName, Name, VirtualMachinePowerOffParameter, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Name=Name,body=VirtualMachinePowerOffParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StopAzNetworkCloudVirtualMachine_PowerOff" /> cmdlet class.
        /// </summary>
        public StopAzNetworkCloudVirtualMachine_PowerOff()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=VirtualMachinePowerOffParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=VirtualMachinePowerOffParameter })
                    {
