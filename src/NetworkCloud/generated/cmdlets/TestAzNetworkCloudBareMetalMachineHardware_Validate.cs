...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ValidateHardware=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/bareMetalMachines/{bareMetalMachineName}/validateHardware"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzNetworkCloudBareMetalMachineHardware_Validate", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Description(@"Validate the hardware of the provided bare metal machine.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Generated]
    public partial class TestAzNetworkCloudBareMetalMachineHardware_Validate : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Backing field for <see cref="BareMetalMachineValidateHardwareParameter" /> property.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineValidateHardwareParameters _bareMetalMachineValidateHardwareParameter;
        ...
        /// metal machine.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "BareMetalMachineValidateHardwareParameters represents the body of the request to validate the physical hardware of a bare metal machine.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"BareMetalMachineValidateHardwareParameters represents the body of the request to validate the physical hardware of a bare metal machine.",
        SerializedName = @"bareMetalMachineValidateHardwareParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineValidateHardwareParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineValidateHardwareParameters BareMetalMachineValidateHardwareParameter { get => this._bareMetalMachineValidateHardwareParameter; set => this._bareMetalMachineValidateHardwareParameter = value; }
        ...
        /// <returns>a duplicate instance of TestAzNetworkCloudBareMetalMachineHardware_Validate</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.TestAzNetworkCloudBareMetalMachineHardware_Validate Clone()
        {
            var clone = new TestAzNetworkCloudBareMetalMachineHardware_Validate();
            ...
            clone.BareMetalMachineValidateHardwareParameter = this.BareMetalMachineValidateHardwareParameter;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BareMetalMachinesValidateHardware' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BareMetalMachinesValidateHardware(SubscriptionId, ResourceGroupName, BareMetalMachineName, BareMetalMachineValidateHardwareParameter, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,BareMetalMachineName=BareMetalMachineName,body=BareMetalMachineValidateHardwareParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzNetworkCloudBareMetalMachineHardware_Validate" /> cmdlet class.
        /// </summary>
        public TestAzNetworkCloudBareMetalMachineHardware_Validate()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, BareMetalMachineName=BareMetalMachineName, body=BareMetalMachineValidateHardwareParameter })
                    {
