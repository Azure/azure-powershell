...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzNetworkCloudBareMetalMachineReadCommand_RunViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class StartAzNetworkCloudBareMetalMachineReadCommand_RunViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of StartAzNetworkCloudBareMetalMachineReadCommand_RunViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.StartAzNetworkCloudBareMetalMachineReadCommand_RunViaIdentity Clone()
        {
            var clone = new StartAzNetworkCloudBareMetalMachineReadCommand_RunViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BareMetalMachinesRunReadCommandsViaIdentity(InputObject.Id, BareMetalMachineRunReadCommandsParameter, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BareMetalMachinesRunReadCommands(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.BareMetalMachineName ?? null, BareMetalMachineRunReadCommandsParameter, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=BareMetalMachineRunReadCommandsParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzNetworkCloudBareMetalMachineReadCommand_RunViaIdentity" /> cmdlet class.
        /// </summary>
        public StartAzNetworkCloudBareMetalMachineReadCommand_RunViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=BareMetalMachineRunReadCommandsParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=BareMetalMachineRunReadCommandsParameter })
                    {
