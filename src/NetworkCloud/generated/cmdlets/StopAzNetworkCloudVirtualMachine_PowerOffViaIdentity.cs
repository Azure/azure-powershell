...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Stop, @"AzNetworkCloudVirtualMachine_PowerOffViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class StopAzNetworkCloudVirtualMachine_PowerOffViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of StopAzNetworkCloudVirtualMachine_PowerOffViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.StopAzNetworkCloudVirtualMachine_PowerOffViaIdentity Clone()
        {
            var clone = new StopAzNetworkCloudVirtualMachine_PowerOffViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualMachinesPowerOffViaIdentity(InputObject.Id, VirtualMachinePowerOffParameter, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualMachinesPowerOff(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VirtualMachineName ?? null, VirtualMachinePowerOffParameter, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=VirtualMachinePowerOffParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StopAzNetworkCloudVirtualMachine_PowerOffViaIdentity" /> cmdlet class.
        /// </summary>
        public StopAzNetworkCloudVirtualMachine_PowerOffViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=VirtualMachinePowerOffParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=VirtualMachinePowerOffParameter })
                    {
