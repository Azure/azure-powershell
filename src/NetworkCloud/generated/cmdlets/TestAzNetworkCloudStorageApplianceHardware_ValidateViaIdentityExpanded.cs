...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzNetworkCloudStorageApplianceHardware_ValidateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class TestAzNetworkCloudStorageApplianceHardware_ValidateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of TestAzNetworkCloudStorageApplianceHardware_ValidateViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.TestAzNetworkCloudStorageApplianceHardware_ValidateViaIdentityExpanded Clone()
        {
            var clone = new TestAzNetworkCloudStorageApplianceHardware_ValidateViaIdentityExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.StorageAppliancesValidateHardwareViaIdentity(InputObject.Id, _storageApplianceValidateHardwareParametersBody, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.StorageAppliancesValidateHardware(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.StorageApplianceName ?? null, _storageApplianceValidateHardwareParametersBody, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_storageApplianceValidateHardwareParametersBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzNetworkCloudStorageApplianceHardware_ValidateViaIdentityExpanded" />
        /// cmdlet class.
        /// </summary>
        public TestAzNetworkCloudStorageApplianceHardware_ValidateViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_storageApplianceValidateHardwareParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_storageApplianceValidateHardwareParametersBody })
                    {
