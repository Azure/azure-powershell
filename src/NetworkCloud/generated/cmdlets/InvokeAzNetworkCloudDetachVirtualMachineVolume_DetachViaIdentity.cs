...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzNetworkCloudDetachVirtualMachineVolume_DetachViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzNetworkCloudDetachVirtualMachineVolume_DetachViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzNetworkCloudDetachVirtualMachineVolume_DetachViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.InvokeAzNetworkCloudDetachVirtualMachineVolume_DetachViaIdentity Clone()
        {
            var clone = new InvokeAzNetworkCloudDetachVirtualMachineVolume_DetachViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzNetworkCloudDetachVirtualMachineVolume_DetachViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public InvokeAzNetworkCloudDetachVirtualMachineVolume_DetachViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualMachinesDetachVolumeViaIdentity(InputObject.Id, VirtualMachineDetachVolumeParameter, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualMachinesDetachVolume(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VirtualMachineName ?? null, VirtualMachineDetachVolumeParameter, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=VirtualMachineDetachVolumeParameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=VirtualMachineDetachVolumeParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=VirtualMachineDetachVolumeParameter })
                    {
