...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzNetworkCloudBareMetalMachine_ReplaceViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzNetworkCloudBareMetalMachine_ReplaceViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of UpdateAzNetworkCloudBareMetalMachine_ReplaceViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.UpdateAzNetworkCloudBareMetalMachine_ReplaceViaIdentity Clone()
        {
            var clone = new UpdateAzNetworkCloudBareMetalMachine_ReplaceViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BareMetalMachinesReplaceViaIdentity(InputObject.Id, BareMetalMachineReplaceParameter, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BareMetalMachinesReplace(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.BareMetalMachineName ?? null, BareMetalMachineReplaceParameter, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=BareMetalMachineReplaceParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzNetworkCloudBareMetalMachine_ReplaceViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzNetworkCloudBareMetalMachine_ReplaceViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=BareMetalMachineReplaceParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=BareMetalMachineReplaceParameter })
                    {
