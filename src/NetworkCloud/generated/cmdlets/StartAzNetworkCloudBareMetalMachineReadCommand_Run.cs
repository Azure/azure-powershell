...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzNetworkCloudBareMetalMachineReadCommand_Run", SupportsShouldProcess = true)]
    ...
    public partial class StartAzNetworkCloudBareMetalMachineReadCommand_Run : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Backing field for <see cref="BareMetalMachineRunReadCommandsParameter" /> property.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineRunReadCommandsParameters _bareMetalMachineRunReadCommandsParameter;
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "BareMetalMachineRunReadCommandsParameters represents the body of request containing list of read-only commands to run on the bare metal machine.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"BareMetalMachineRunReadCommandsParameters represents the body of request containing list of read-only commands to run on the bare metal machine.",
        SerializedName = @"bareMetalMachineRunReadCommandsParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineRunReadCommandsParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineRunReadCommandsParameters BareMetalMachineRunReadCommandsParameter { get => this._bareMetalMachineRunReadCommandsParameter; set => this._bareMetalMachineRunReadCommandsParameter = value; }
        ...
        /// <returns>a duplicate instance of StartAzNetworkCloudBareMetalMachineReadCommand_Run</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.StartAzNetworkCloudBareMetalMachineReadCommand_Run Clone()
        {
            var clone = new StartAzNetworkCloudBareMetalMachineReadCommand_Run();
            ...
            clone.BareMetalMachineRunReadCommandsParameter = this.BareMetalMachineRunReadCommandsParameter;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BareMetalMachinesRunReadCommands(SubscriptionId, ResourceGroupName, BareMetalMachineName, BareMetalMachineRunReadCommandsParameter, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,BareMetalMachineName=BareMetalMachineName,body=BareMetalMachineRunReadCommandsParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzNetworkCloudBareMetalMachineReadCommand_Run" /> cmdlet class.
        /// </summary>
        public StartAzNetworkCloudBareMetalMachineReadCommand_Run()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, BareMetalMachineName=BareMetalMachineName, body=BareMetalMachineRunReadCommandsParameter })
                    {
