...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzNetworkCloudBareMetalMachineDataExtract_Run", SupportsShouldProcess = true)]
    ...
    public partial class StartAzNetworkCloudBareMetalMachineDataExtract_Run : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Backing field for <see cref="BareMetalMachineRunDataExtractsParameter" /> property.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineRunDataExtractsParameters _bareMetalMachineRunDataExtractsParameter;
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "BareMetalMachineRunDataExtractsParameters represents the body of request containing list of curated data extraction commands to run on the bare metal machine.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"BareMetalMachineRunDataExtractsParameters represents the body of request containing list of curated data extraction commands to run on the bare metal machine.",
        SerializedName = @"bareMetalMachineRunDataExtractsParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineRunDataExtractsParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineRunDataExtractsParameters BareMetalMachineRunDataExtractsParameter { get => this._bareMetalMachineRunDataExtractsParameter; set => this._bareMetalMachineRunDataExtractsParameter = value; }
        ...
        /// <returns>a duplicate instance of StartAzNetworkCloudBareMetalMachineDataExtract_Run</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.StartAzNetworkCloudBareMetalMachineDataExtract_Run Clone()
        {
            var clone = new StartAzNetworkCloudBareMetalMachineDataExtract_Run();
            ...
            clone.BareMetalMachineRunDataExtractsParameter = this.BareMetalMachineRunDataExtractsParameter;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BareMetalMachinesRunDataExtracts(SubscriptionId, ResourceGroupName, BareMetalMachineName, BareMetalMachineRunDataExtractsParameter, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,BareMetalMachineName=BareMetalMachineName,body=BareMetalMachineRunDataExtractsParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzNetworkCloudBareMetalMachineDataExtract_Run" /> cmdlet class.
        /// </summary>
        public StartAzNetworkCloudBareMetalMachineDataExtract_Run()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, BareMetalMachineName=BareMetalMachineName, body=BareMetalMachineRunDataExtractsParameter })
                    {
