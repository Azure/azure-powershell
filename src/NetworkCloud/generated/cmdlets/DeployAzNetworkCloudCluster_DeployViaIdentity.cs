...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet("Deploy", @"AzNetworkCloudCluster_DeployViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class DeployAzNetworkCloudCluster_DeployViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ClusterDeployParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IClusterDeployParameters _clusterDeployParameter;

        /// <summary>ClusterDeployParameters represents the body of the request to deploy cluster.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ClusterDeployParameters represents the body of the request to deploy cluster.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"ClusterDeployParameters represents the body of the request to deploy cluster.",
        SerializedName = @"clusterDeployParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IClusterDeployParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IClusterDeployParameters ClusterDeployParameter { get => this._clusterDeployParameter; set => this._clusterDeployParameter = value; }
        ...
        /// <returns>a duplicate instance of DeployAzNetworkCloudCluster_DeployViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.DeployAzNetworkCloudCluster_DeployViaIdentity Clone()
        {
            var clone = new DeployAzNetworkCloudCluster_DeployViaIdentity();
            ...
            clone.ClusterDeployParameter = this.ClusterDeployParameter;
            return clone;
        }

        /// <summary>
        /// Intializes a new instance of the <see cref="DeployAzNetworkCloudCluster_DeployViaIdentity" /> cmdlet class.
        /// </summary>
        public DeployAzNetworkCloudCluster_DeployViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ClustersDeployViaIdentity(InputObject.Id, ClusterDeployParameter, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ClustersDeploy(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, ClusterDeployParameter, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ClusterDeployParameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ClusterDeployParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ClusterDeployParameter })
                    {
