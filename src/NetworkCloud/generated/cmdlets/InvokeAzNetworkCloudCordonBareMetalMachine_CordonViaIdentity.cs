...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzNetworkCloudCordonBareMetalMachine_CordonViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzNetworkCloudCordonBareMetalMachine_CordonViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="BareMetalMachineCordonParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineCordonParameters _bareMetalMachineCordonParameter;
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "BareMetalMachineCordonParameters represents the body of the request to evacuate workloads from node on a bare metal machine.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"BareMetalMachineCordonParameters represents the body of the request to evacuate workloads from node on a bare metal machine.",
        SerializedName = @"bareMetalMachineCordonParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineCordonParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineCordonParameters BareMetalMachineCordonParameter { get => this._bareMetalMachineCordonParameter; set => this._bareMetalMachineCordonParameter = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzNetworkCloudCordonBareMetalMachine_CordonViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.InvokeAzNetworkCloudCordonBareMetalMachine_CordonViaIdentity Clone()
        {
            var clone = new InvokeAzNetworkCloudCordonBareMetalMachine_CordonViaIdentity();
            ...
            clone.BareMetalMachineCordonParameter = this.BareMetalMachineCordonParameter;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzNetworkCloudCordonBareMetalMachine_CordonViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeAzNetworkCloudCordonBareMetalMachine_CordonViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BareMetalMachinesCordonViaIdentity(InputObject.Id, BareMetalMachineCordonParameter, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BareMetalMachinesCordon(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.BareMetalMachineName ?? null, BareMetalMachineCordonParameter, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=BareMetalMachineCordonParameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=BareMetalMachineCordonParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=BareMetalMachineCordonParameter })
                    {
