...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzNetworkCloudBareMetalMachineCommand_RunViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class StartAzNetworkCloudBareMetalMachineCommand_RunViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="BareMetalMachineRunCommandParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineRunCommandParameters _bareMetalMachineRunCommandParameter;

        /// <summary>
        /// BareMetalMachineRunCommandParameters represents the body of the request to execute a script on the bare metal machine.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "BareMetalMachineRunCommandParameters represents the body of the request to execute a script on the bare metal machine.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"BareMetalMachineRunCommandParameters represents the body of the request to execute a script on the bare metal machine.",
        SerializedName = @"bareMetalMachineRunCommandParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineRunCommandParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineRunCommandParameters BareMetalMachineRunCommandParameter { get => this._bareMetalMachineRunCommandParameter; set => this._bareMetalMachineRunCommandParameter = value; }
        ...
        /// <returns>
        /// a duplicate instance of StartAzNetworkCloudBareMetalMachineCommand_RunViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.StartAzNetworkCloudBareMetalMachineCommand_RunViaIdentity Clone()
        {
            var clone = new StartAzNetworkCloudBareMetalMachineCommand_RunViaIdentity();
            ...
            clone.BareMetalMachineRunCommandParameter = this.BareMetalMachineRunCommandParameter;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BareMetalMachinesRunCommandViaIdentity(InputObject.Id, BareMetalMachineRunCommandParameter, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BareMetalMachinesRunCommand(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.BareMetalMachineName ?? null, BareMetalMachineRunCommandParameter, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=BareMetalMachineRunCommandParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzNetworkCloudBareMetalMachineCommand_RunViaIdentity" /> cmdlet class.
        /// </summary>
        public StartAzNetworkCloudBareMetalMachineCommand_RunViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=BareMetalMachineRunCommandParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=BareMetalMachineRunCommandParameter })
                    {
