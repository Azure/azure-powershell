...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// <summary>
    /// Run the command or the script on the provided bare metal machine. The URL to storage account with the command execution
    /// results and the command exit code can be retrieved from the operation status API once available.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] RunCommand=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/bareMetalMachines/{bareMetalMachineName}/runCommand"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzNetworkCloudBareMetalMachineCommand_RunViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Description(@"Run the command or the script on the provided bare metal machine. The URL to storage account with the command execution results and the command exit code can be retrieved from the operation status API once available.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Generated]
    public partial class StartAzNetworkCloudBareMetalMachineCommand_RunViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineRunCommandParameters _bareMetalMachineRunCommandParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.BareMetalMachineRunCommandParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The list of string arguments that will be passed to the script in order as separate arguments.")]
        ...
        public string[] Argument { get => _bareMetalMachineRunCommandParametersBody.Argument ?? null /* arrayOf */; set => _bareMetalMachineRunCommandParametersBody.Argument = value; }
        ...
        /// <summary>
        /// The maximum time the script is allowed to run.If the execution time exceeds the maximum, the script will be stopped, any
        /// output produced until then will be captured, and the exit code matching a timeout will be returned (252).
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The maximum time the script is allowed to run.If the execution time exceeds the maximum, the script will be stopped, any output produced until then will be captured, and the exit code matching a timeout will be returned (252).")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public long LimitTimeSecond { get => _bareMetalMachineRunCommandParametersBody.LimitTimeSecond; set => _bareMetalMachineRunCommandParametersBody.LimitTimeSecond = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The base64 encoded script to execute on the bare metal machine.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Script { get => _bareMetalMachineRunCommandParametersBody.Script ?? null; set => _bareMetalMachineRunCommandParametersBody.Script = value; }
        ...
        /// <returns>
        /// a duplicate instance of StartAzNetworkCloudBareMetalMachineCommand_RunViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.StartAzNetworkCloudBareMetalMachineCommand_RunViaIdentityExpanded Clone()
        {
            var clone = new StartAzNetworkCloudBareMetalMachineCommand_RunViaIdentityExpanded();
            ...
            clone._bareMetalMachineRunCommandParametersBody = this._bareMetalMachineRunCommandParametersBody;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BareMetalMachinesRunCommand' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BareMetalMachinesRunCommandViaIdentity(InputObject.Id, _bareMetalMachineRunCommandParametersBody, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BareMetalMachinesRunCommand(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.BareMetalMachineName ?? null, _bareMetalMachineRunCommandParametersBody, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_bareMetalMachineRunCommandParametersBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzNetworkCloudBareMetalMachineCommand_RunViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public StartAzNetworkCloudBareMetalMachineCommand_RunViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_bareMetalMachineRunCommandParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_bareMetalMachineRunCommandParametersBody })
                    {
