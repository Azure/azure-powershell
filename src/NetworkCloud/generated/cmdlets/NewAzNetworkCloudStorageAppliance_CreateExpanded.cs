...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// <summary>
    /// Create a new storage appliance or update the properties of the existing one.\nAll customer initiated requests will be
    /// rejected as the life cycle of this resource is managed by the system.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/storageAppliances/{storageApplianceName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzNetworkCloudStorageAppliance_CreateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Description(@"Create a new storage appliance or update the properties of the existing one.\nAll customer initiated requests will be rejected as the life cycle of this resource is managed by the system.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Generated]
    public partial class NewAzNetworkCloudStorageAppliance_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IStorageAppliance _storageApplianceParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.StorageAppliance();

        /// <summary>The password of the administrator of the device used during initialization.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The password of the administrator of the device used during initialization.")]
        ...
        public string AdministratorCredentialsPassword { get => _storageApplianceParametersBody.AdministratorCredentialsPassword ?? null; set => _storageApplianceParametersBody.AdministratorCredentialsPassword = value; }

        /// <summary>The username of the administrator of the device used during initialization.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The username of the administrator of the device used during initialization.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AdministratorCredentialsUsername { get => _storageApplianceParametersBody.AdministratorCredentialsUsername ?? null; set => _storageApplianceParametersBody.AdministratorCredentialsUsername = value; }
        ...
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(string) })]
        public string ExtendedLocationName { get => _storageApplianceParametersBody.ExtendedLocationName ?? null; set => _storageApplianceParametersBody.ExtendedLocationName = value; }
        ...
        SerializedName = @"type",
        PossibleTypes = new [] { typeof(string) })]
        public string ExtendedLocationType { get => _storageApplianceParametersBody.ExtendedLocationType ?? null; set => _storageApplianceParametersBody.ExtendedLocationType = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => _storageApplianceParametersBody.Location ?? null; set => _storageApplianceParametersBody.Location = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The resource ID of the rack where this storage appliance resides.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string RackId { get => _storageApplianceParametersBody.RackId ?? null; set => _storageApplianceParametersBody.RackId = value; }

        /// <summary>The slot the storage appliance is in the rack based on the BOM configuration.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The slot the storage appliance is in the rack based on the BOM configuration.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public long RackSlot { get => _storageApplianceParametersBody.RackSlot; set => _storageApplianceParametersBody.RackSlot = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The serial number for the storage appliance.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SerialNumber { get => _storageApplianceParametersBody.SerialNumber ?? null; set => _storageApplianceParametersBody.SerialNumber = value; }

        /// <summary>The SKU for the storage appliance.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The SKU for the storage appliance.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string StorageApplianceSkuId { get => _storageApplianceParametersBody.SkuId ?? null; set => _storageApplianceParametersBody.SkuId = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.ITrackedResourceTags Tag { get => _storageApplianceParametersBody.Tag ?? null /* object */; set => _storageApplianceParametersBody.Tag = value; }
        ...
        /// <returns>a duplicate instance of NewAzNetworkCloudStorageAppliance_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.NewAzNetworkCloudStorageAppliance_CreateExpanded Clone()
        {
            var clone = new NewAzNetworkCloudStorageAppliance_CreateExpanded();
            ...
            clone._storageApplianceParametersBody = this._storageApplianceParametersBody;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzNetworkCloudStorageAppliance_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzNetworkCloudStorageAppliance_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'StorageAppliancesCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.StorageAppliancesCreateOrUpdate(SubscriptionId, ResourceGroupName, Name, _storageApplianceParametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Name=Name,body=_storageApplianceParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=_storageApplianceParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=_storageApplianceParametersBody })
                    {
