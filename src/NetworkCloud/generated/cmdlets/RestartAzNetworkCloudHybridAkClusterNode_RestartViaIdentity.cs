...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Restart, @"AzNetworkCloudHybridAkClusterNode_RestartViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RestartAzNetworkCloudHybridAkClusterNode_RestartViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="HybridAksClusterRestartNodeParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IHybridAksClusterRestartNodeParameters _hybridAksClusterRestartNodeParameter;

        /// <summary>
        /// HybridAksClusterRestartNodeParameters represents the body of the request to restart the node of a Hybrid AKS cluster.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "HybridAksClusterRestartNodeParameters represents the body of the request to restart the node of a Hybrid AKS cluster.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"HybridAksClusterRestartNodeParameters represents the body of the request to restart the node of a Hybrid AKS cluster.",
        SerializedName = @"hybridAksClusterRestartNodeParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IHybridAksClusterRestartNodeParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IHybridAksClusterRestartNodeParameters HybridAksClusterRestartNodeParameter { get => this._hybridAksClusterRestartNodeParameter; set => this._hybridAksClusterRestartNodeParameter = value; }
        ...
        /// <returns>
        /// a duplicate instance of RestartAzNetworkCloudHybridAkClusterNode_RestartViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.RestartAzNetworkCloudHybridAkClusterNode_RestartViaIdentity Clone()
        {
            var clone = new RestartAzNetworkCloudHybridAkClusterNode_RestartViaIdentity();
            ...
            clone.HybridAksClusterRestartNodeParameter = this.HybridAksClusterRestartNodeParameter;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.HybridAksClustersRestartNodeViaIdentity(InputObject.Id, HybridAksClusterRestartNodeParameter, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.HybridAksClustersRestartNode(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.HybridAksClusterName ?? null, HybridAksClusterRestartNodeParameter, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=HybridAksClusterRestartNodeParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RestartAzNetworkCloudHybridAkClusterNode_RestartViaIdentity" /> cmdlet class.
        /// </summary>
        public RestartAzNetworkCloudHybridAkClusterNode_RestartViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=HybridAksClusterRestartNodeParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=HybridAksClusterRestartNodeParameter })
                    {
