...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzNetworkCloudDetachVirtualMachineVolume_Detach", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzNetworkCloudDetachVirtualMachineVolume_Detach : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="VirtualMachineDetachVolumeParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IVirtualMachineVolumeParameters _virtualMachineDetachVolumeParameter;

        /// <summary>
        /// VirtualMachineVolumeParameters represents the body of the request to handle attachment and detachment of volumes for the
        /// virtual machine.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "VirtualMachineVolumeParameters represents the body of the request to handle attachment and detachment of volumes for the virtual machine.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"VirtualMachineVolumeParameters represents the body of the request to handle attachment and detachment of volumes for the virtual machine.",
        SerializedName = @"virtualMachineDetachVolumeParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IVirtualMachineVolumeParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IVirtualMachineVolumeParameters VirtualMachineDetachVolumeParameter { get => this._virtualMachineDetachVolumeParameter; set => this._virtualMachineDetachVolumeParameter = value; }
        ...
        /// <returns>a duplicate instance of InvokeAzNetworkCloudDetachVirtualMachineVolume_Detach</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.InvokeAzNetworkCloudDetachVirtualMachineVolume_Detach Clone()
        {
            var clone = new InvokeAzNetworkCloudDetachVirtualMachineVolume_Detach();
            ...
            clone.VirtualMachineDetachVolumeParameter = this.VirtualMachineDetachVolumeParameter;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzNetworkCloudDetachVirtualMachineVolume_Detach" /> cmdlet class.
        /// </summary>
        public InvokeAzNetworkCloudDetachVirtualMachineVolume_Detach()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VirtualMachinesDetachVolume(SubscriptionId, ResourceGroupName, VirtualMachineName, VirtualMachineDetachVolumeParameter, onNoContent, onDefault, this, Pipeline);
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, VirtualMachineName=VirtualMachineName, body=VirtualMachineDetachVolumeParameter })
                    {
