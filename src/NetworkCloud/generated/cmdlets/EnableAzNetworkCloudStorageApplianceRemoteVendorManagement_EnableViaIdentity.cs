...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] EnableRemoteVendorManagement=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/storageAppliances/{storageApplianceName}/enableRemoteVendorManagement"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Enable, @"AzNetworkCloudStorageApplianceRemoteVendorManagement_EnableViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class EnableAzNetworkCloudStorageApplianceRemoteVendorManagement_EnableViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Backing field for <see cref="StorageApplianceEnableRemoteVendorManagementParameter" /> property.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IStorageApplianceEnableRemoteVendorManagementParameters _storageApplianceEnableRemoteVendorManagementParameter;
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "StorageApplianceEnableRemoteVendorManagementParameters represents the body of the request to enable remote vendor management of a storage appliance.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"StorageApplianceEnableRemoteVendorManagementParameters represents the body of the request to enable remote vendor management of a storage appliance.",
        SerializedName = @"storageApplianceEnableRemoteVendorManagementParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IStorageApplianceEnableRemoteVendorManagementParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IStorageApplianceEnableRemoteVendorManagementParameters StorageApplianceEnableRemoteVendorManagementParameter { get => this._storageApplianceEnableRemoteVendorManagementParameter; set => this._storageApplianceEnableRemoteVendorManagementParameter = value; }
        ...
        /// <returns>
        /// a duplicate instance of EnableAzNetworkCloudStorageApplianceRemoteVendorManagement_EnableViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.EnableAzNetworkCloudStorageApplianceRemoteVendorManagement_EnableViaIdentity Clone()
        {
            var clone = new EnableAzNetworkCloudStorageApplianceRemoteVendorManagement_EnableViaIdentity();
            ...
            clone.StorageApplianceEnableRemoteVendorManagementParameter = this.StorageApplianceEnableRemoteVendorManagementParameter;
            return clone;
        }

        /// <summary>
        /// Intializes a new instance of the <see cref="EnableAzNetworkCloudStorageApplianceRemoteVendorManagement_EnableViaIdentity"
        /// /> cmdlet class.
        /// </summary>
        public EnableAzNetworkCloudStorageApplianceRemoteVendorManagement_EnableViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'StorageAppliancesEnableRemoteVendorManagement' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.StorageAppliancesEnableRemoteVendorManagementViaIdentity(InputObject.Id, StorageApplianceEnableRemoteVendorManagementParameter, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.StorageApplianceName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.StorageApplianceName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.StorageAppliancesEnableRemoteVendorManagement(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.StorageApplianceName ?? null, StorageApplianceEnableRemoteVendorManagementParameter, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=StorageApplianceEnableRemoteVendorManagementParameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=StorageApplianceEnableRemoteVendorManagementParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=StorageApplianceEnableRemoteVendorManagementParameter })
                    {
