...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701
{
    ...
    public partial class ConsoleProperties :
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IConsoleProperties,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IConsolePropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Support.ConsoleDetailedStatus? Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IConsolePropertiesInternal.DetailedStatus { get => this._detailedStatus; set { {_detailedStatus = value;} } }

        /// <summary>Internal Acessors for DetailedStatusMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IConsolePropertiesInternal.DetailedStatusMessage { get => this._detailedStatusMessage; set { {_detailedStatusMessage = value;} } }

        /// <summary>Internal Acessors for PrivateLinkServiceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IConsolePropertiesInternal.PrivateLinkServiceId { get => this._privateLinkServiceId; set { {_privateLinkServiceId = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Support.ConsoleProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IConsolePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for SshPublicKey</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.ISshPublicKey Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IConsolePropertiesInternal.SshPublicKey { get => (this._sshPublicKey = this._sshPublicKey ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.SshPublicKey()); set { {_sshPublicKey = value;} } }

        /// <summary>Internal Acessors for VirtualMachineAccessId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IConsolePropertiesInternal.VirtualMachineAccessId { get => this._virtualMachineAccessId; set { {_virtualMachineAccessId = value;} } }
