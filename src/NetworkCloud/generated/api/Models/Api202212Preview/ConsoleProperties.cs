...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview
{
    ...
    public partial class ConsoleProperties :
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IConsoleProperties,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IConsolePropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Support.ConsoleDetailedStatus? Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IConsolePropertiesInternal.DetailedStatus { get => this._detailedStatus; set { {_detailedStatus = value;} } }

        /// <summary>Internal Acessors for DetailedStatusMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IConsolePropertiesInternal.DetailedStatusMessage { get => this._detailedStatusMessage; set { {_detailedStatusMessage = value;} } }

        /// <summary>Internal Acessors for PrivateLinkServiceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IConsolePropertiesInternal.PrivateLinkServiceId { get => this._privateLinkServiceId; set { {_privateLinkServiceId = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Support.ConsoleProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IConsolePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for SshPublicKey</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.ISshPublicKey Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IConsolePropertiesInternal.SshPublicKey { get => (this._sshPublicKey = this._sshPublicKey ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.SshPublicKey()); set { {_sshPublicKey = value;} } }

        /// <summary>Internal Acessors for VirtualMachineAccessId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IConsolePropertiesInternal.VirtualMachineAccessId { get => this._virtualMachineAccessId; set { {_virtualMachineAccessId = value;} } }
