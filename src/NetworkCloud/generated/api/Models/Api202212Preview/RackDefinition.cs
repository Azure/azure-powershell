...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview
{
    ...
    public partial class RackDefinition :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IRackDefinitionInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineConfigurationData[] _bareMetalMachineConfigurationData;

        /// <summary>The unordered list of bare metal machine configuration.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineConfigurationData[] BareMetalMachineConfigurationData { get => this._bareMetalMachineConfigurationData; set => this._bareMetalMachineConfigurationData = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IStorageApplianceConfigurationData[] _storageApplianceConfigurationData;

        /// <summary>The list of storage appliance configuration data for this rack.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IStorageApplianceConfigurationData[] StorageApplianceConfigurationData { get => this._storageApplianceConfigurationData; set => this._storageApplianceConfigurationData = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IBareMetalMachineConfigurationData[] BareMetalMachineConfigurationData { get; set; }
        /// <summary>The resource ID of the network rack that matches this rack definition.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IStorageApplianceConfigurationData[] StorageApplianceConfigurationData { get; set; }
