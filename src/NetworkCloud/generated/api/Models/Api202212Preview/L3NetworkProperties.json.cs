...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview
{
    ...
    public partial class L3NetworkProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IL3NetworkProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IL3NetworkProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api202212Preview.IL3NetworkProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonObject json ? new L3NetworkProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonObject into a new instance of <see cref="L3NetworkProperties" />.
        /// </summary>
        ...
        internal L3NetworkProperties(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonObject json)
        {
            ...
            {_hybridAksClustersAssociatedId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonArray>("hybridAksClustersAssociatedIds"), out var __jsonHybridAksClustersAssociatedIds) ? If( __jsonHybridAksClustersAssociatedIds as Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : HybridAksClustersAssociatedId;}
            {_hybridAksIpamEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("hybridAksIpamEnabled"), out var __jsonHybridAksIpamEnabled) ? (string)__jsonHybridAksIpamEnabled : (string)HybridAksIpamEnabled;}
            ...
            {_iPAllocationType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("ipAllocationType"), out var __jsonIPAllocationType) ? (string)__jsonIPAllocationType : (string)IPAllocationType;}
            {_ipv4ConnectedPrefix = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("ipv4ConnectedPrefix"), out var __jsonIpv4ConnectedPrefix) ? (string)__jsonIpv4ConnectedPrefix : (string)Ipv4ConnectedPrefix;}
            {_ipv6ConnectedPrefix = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("ipv6ConnectedPrefix"), out var __jsonIpv6ConnectedPrefix) ? (string)__jsonIpv6ConnectedPrefix : (string)Ipv6ConnectedPrefix;}
            {_l3IsolationDomainId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("l3IsolationDomainId"), out var __jsonL3IsolationDomainId) ? (string)__jsonL3IsolationDomainId : (string)L3IsolationDomainId;}
            ...
            {_virtualMachinesAssociatedId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonArray>("virtualMachinesAssociatedIds"), out var __jsonVirtualMachinesAssociatedIds) ? If( __jsonVirtualMachinesAssociatedIds as Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : VirtualMachinesAssociatedId;}
            {_vlan = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNumber>("vlan"), out var __jsonVlan) ? (long)__jsonVlan : Vlan;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="L3NetworkProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="L3NetworkProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.SerializationMode.IncludeReadOnly))
            {
                if (null != this._hybridAksClustersAssociatedId)
                {
                    ...
                    foreach( var __x in this._hybridAksClustersAssociatedId )
                    {
                    ...
                    container.Add("hybridAksClustersAssociatedIds",__w);
                }
            }
            AddIf( null != (((object)this._hybridAksIpamEnabled)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString(this._hybridAksIpamEnabled.ToString()) : null, "hybridAksIpamEnabled" ,container.Add );
            ...
            AddIf( null != (((object)this._iPAllocationType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString(this._iPAllocationType.ToString()) : null, "ipAllocationType" ,container.Add );
            AddIf( null != (((object)this._ipv4ConnectedPrefix)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString(this._ipv4ConnectedPrefix.ToString()) : null, "ipv4ConnectedPrefix" ,container.Add );
            AddIf( null != (((object)this._ipv6ConnectedPrefix)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString(this._ipv6ConnectedPrefix.ToString()) : null, "ipv6ConnectedPrefix" ,container.Add );
            AddIf( null != (((object)this._l3IsolationDomainId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString(this._l3IsolationDomainId.ToString()) : null, "l3IsolationDomainId" ,container.Add );
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.SerializationMode.IncludeReadOnly))
            {
                if (null != this._virtualMachinesAssociatedId)
                {
                    ...
                    foreach( var __s in this._virtualMachinesAssociatedId )
                    {
                    ...
                    container.Add("virtualMachinesAssociatedIds",__r);
                }
            }
            AddIf( (Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNumber(this._vlan), "vlan" ,container.Add );
