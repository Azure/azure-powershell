...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/remove-aznetworkcloudbmckeyset
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzNetworkCloudBmcKeySet -InputObject <INetworkCloudIdentity> [-DefaultProfile <PSObject>] [-AsJob]
...
### Example 1: Delete Cluster's baseboard management controller key set
```powershell
