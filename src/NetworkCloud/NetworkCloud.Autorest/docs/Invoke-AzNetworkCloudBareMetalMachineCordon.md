...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/invoke-aznetworkcloudbaremetalmachinecordon
schema: 2.0.0
---
...
Invoke-AzNetworkCloudBareMetalMachineCordon -InputObject <INetworkCloudIdentity>
 [-Evacuate <BareMetalMachineEvacuate>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm]
