...
### Update
```
Update-AzNetworkCloudKubernetesCluster -Name <String> -ResourceGroupName <String>
 -KubernetesClusterUpdateParameter <IKubernetesClusterPatchParameters> [-SubscriptionId <String>]
...
Update-AzNetworkCloudKubernetesCluster -InputObject <INetworkCloudIdentity>
 -KubernetesClusterUpdateParameter <IKubernetesClusterPatchParameters> [-IfMatch <String>]
