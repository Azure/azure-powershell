...
```
Get-AzNetworkCloudBareMetalMachineKeySet -Cluster1InputObject <INetworkCloudIdentity> -Name <String>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Get, Get1, GetViaIdentityCluster, GetViaIdentityCluster1
