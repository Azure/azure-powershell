...
### GetViaIdentityKubernetesCluster1
```
Get-AzNetworkCloudAgentPool -KubernetesCluster1InputObject <INetworkCloudIdentity> -Name <String>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.INetworkCloudIdentity
Parameter Sets: GetViaIdentityKubernetesCluster1
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Get, Get1, GetViaIdentityKubernetesCluster, GetViaIdentityKubernetesCluster1
