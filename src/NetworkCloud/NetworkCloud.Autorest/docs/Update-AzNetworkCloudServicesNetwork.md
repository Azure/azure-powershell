...
Update-AzNetworkCloudServicesNetwork -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-StorageOptionStorageApplianceId <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-AzNetworkCloudServicesNetwork -Name <String> -ResourceGroupName <String>
 -CloudServicesNetworkUpdateParameter <ICloudServicesNetworkPatchParameters> [-SubscriptionId <String>]
...
Update-AzNetworkCloudServicesNetwork -InputObject <INetworkCloudIdentity>
 -CloudServicesNetworkUpdateParameter <ICloudServicesNetworkPatchParameters> [-IfMatch <String>]
...
```
Update-AzNetworkCloudServicesNetwork -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### UpdateViaJsonString
```
Update-AzNetworkCloudServicesNetwork -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-IfMatch <String>] [-IfNoneMatch <String>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
