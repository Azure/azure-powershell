...
### Update
```
Update-AzNetworkCloudVolume -Name <String> -ResourceGroupName <String>
 -VolumeUpdateParameter <IVolumePatchParameters> [-SubscriptionId <String>] [-IfMatch <String>]
 [-IfNoneMatch <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-AzNetworkCloudVolume -InputObject <INetworkCloudIdentity>
 -VolumeUpdateParameter <IVolumePatchParameters> [-IfMatch <String>] [-IfNoneMatch <String>]
