...
Invoke-AzNetworkCloudBareMetalMachineReplace -Name <String> -ResourceGroupName <String>
 ...
 [-SerialNumber <String>] [-StoragePolicy <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
Invoke-AzNetworkCloudBareMetalMachineReplace -InputObject <INetworkCloudIdentity>
 ...
 [-StoragePolicy <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Parameter Sets: ReplaceExpanded, ReplaceExpanded1, ReplaceViaIdentityExpanded, ReplaceViaIdentityExpanded1
Aliases:
...
Parameter Sets: ReplaceViaIdentityExpanded, ReplaceViaIdentityExpanded1
Aliases:
...
```yaml
Type: System.String
Parameter Sets: ReplaceViaJsonFilePath, ReplaceViaJsonFilePath1
Aliases:
...
```yaml
Type: System.String
Parameter Sets: ReplaceViaJsonString, ReplaceViaJsonString1
Aliases:
...
```yaml
Type: System.String
Parameter Sets: ReplaceExpanded, ReplaceExpanded1, ReplaceViaJsonFilePath, ReplaceViaJsonFilePath1, ReplaceViaJsonString, ReplaceViaJsonString1
