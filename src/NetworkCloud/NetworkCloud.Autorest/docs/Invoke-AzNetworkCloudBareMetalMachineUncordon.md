...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/invoke-aznetworkcloudbaremetalmachineuncordon
schema: 2.0.0
---
...
### UncordonViaIdentity
```
Invoke-AzNetworkCloudBareMetalMachineUncordon -InputObject <INetworkCloudIdentity>
...
### Example 1: Uncordon a bare metal machine
```powershell
...
This command uncordons a bare metal machine.
...
Parameter Sets: UncordonViaIdentity, UncordonViaIdentity1
Aliases:
