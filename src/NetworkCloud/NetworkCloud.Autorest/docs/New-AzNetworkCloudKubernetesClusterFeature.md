...
New-AzNetworkCloudKubernetesClusterFeature -FeatureName <String>
 ...
 -KubernetesClusterFeatureParameter <IKubernetesClusterFeature> [-IfMatch <String>] [-IfNoneMatch <String>]
...
Parameter Sets: CreateViaIdentityKubernetesCluster, CreateViaIdentityKubernetesClusterExpanded
Aliases:
