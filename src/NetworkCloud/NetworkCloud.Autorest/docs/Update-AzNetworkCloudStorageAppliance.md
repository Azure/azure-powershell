...
```
Update-AzNetworkCloudStorageAppliance -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### UpdateViaJsonString
```
Update-AzNetworkCloudStorageAppliance -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-IfMatch <String>] [-IfNoneMatch <String>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
