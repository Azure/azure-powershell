...
### List (Default)
```
Get-AzNetworkCloudCluster [-SubscriptionId <String[]>] [-SkipToken <String>] [-Top <Int32>]
...
### List1
```
Get-AzNetworkCloudCluster -ResourceGroupName <String> [-SubscriptionId <String[]>] [-SkipToken <String>]
...
### Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250901.ICluster
