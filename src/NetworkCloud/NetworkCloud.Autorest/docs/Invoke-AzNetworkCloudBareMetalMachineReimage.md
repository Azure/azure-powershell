...
online version: https://learn.microsoft.com/powershell/module/az.networkcloud/invoke-aznetworkcloudbaremetalmachinereimage
schema: 2.0.0
---
...
### Example 1: Reimage bare metal machine
```powershell
...
This command reimages a bare metal machine.
