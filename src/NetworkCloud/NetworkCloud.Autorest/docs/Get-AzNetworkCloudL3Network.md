...
### List (Default)
```
Get-AzNetworkCloudL3Network [-SubscriptionId <String[]>] [-SkipToken <String>] [-Top <Int32>]
...
### List1
```
Get-AzNetworkCloudL3Network -ResourceGroupName <String> [-SubscriptionId <String[]>] [-SkipToken <String>]
...
### Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250901.IL3Network
