...
New-AzNetworkCloudL2Network -Name <String> -ResourceGroupName <String> -ExtendedLocationName <String>
 ...
 [-IfMatch <String>] [-IfNoneMatch <String>] [-HybridAksPluginType <HybridAksPluginType>]
 [-InterfaceName <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
