...
$dll = Join-Path $PSScriptRoot 'bin\Az.NetworkCloud.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.NetworkCloud.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.NetworkCloud.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: NetworkCloud cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.NetworkCloud.format.ps1xml'
