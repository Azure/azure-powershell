...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// <summary>
    /// Run one or more data extractions on the provided bare metal machine. The URL to storage account with the command execution
    /// results and the command exit code can be retrieved from the operation status API once available.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] RunDataExtracts=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/bareMetalMachines/{bareMetalMachineName}/runDataExtracts"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzNetworkCloudBareMetalMachineDataExtract_RunExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Description(@"Run one or more data extractions on the provided bare metal machine. The URL to storage account with the command execution results and the command exit code can be retrieved from the operation status API once available.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/bareMetalMachines/{bareMetalMachineName}/runDataExtracts", ApiVersion = "2023-07-01")]
    public partial class InvokeAzNetworkCloudBareMetalMachineDataExtract_RunExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IBareMetalMachineRunDataExtractsParameters _bareMetalMachineRunDataExtractsParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.BareMetalMachineRunDataExtractsParameters();
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IBareMetalMachineCommandSpecification) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IBareMetalMachineCommandSpecification[] Command { get => _bareMetalMachineRunDataExtractsParametersBody.Command ?? null /* arrayOf */; set => _bareMetalMachineRunDataExtractsParametersBody.Command = value; }
        ...
        public long LimitTimeSecond { get => _bareMetalMachineRunDataExtractsParametersBody.LimitTimeSecond; set => _bareMetalMachineRunDataExtractsParametersBody.LimitTimeSecond = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzNetworkCloudBareMetalMachineDataExtract_RunExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.InvokeAzNetworkCloudBareMetalMachineDataExtract_RunExpanded Clone()
        {
            var clone = new InvokeAzNetworkCloudBareMetalMachineDataExtract_RunExpanded();
            ...
            clone._bareMetalMachineRunDataExtractsParametersBody = this._bareMetalMachineRunDataExtractsParametersBody;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzNetworkCloudBareMetalMachineDataExtract_RunExpanded" /> cmdlet class.
        /// </summary>
        public InvokeAzNetworkCloudBareMetalMachineDataExtract_RunExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BareMetalMachinesRunDataExtracts' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BareMetalMachinesRunDataExtracts(SubscriptionId, ResourceGroupName, BareMetalMachineName, _bareMetalMachineRunDataExtractsParametersBody, onOk, onNoContent, onDefault, this, Pipeline);
