...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Enable, @"AzNetworkCloudStorageApplianceRemoteVendorManagement_EnableViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/storageAppliances/{storageApplianceName}/enableRemoteVendorManagement", ApiVersion = "2023-07-01")]
    public partial class EnableAzNetworkCloudStorageApplianceRemoteVendorManagement_EnableViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IStorageApplianceEnableRemoteVendorManagementParameters _storageApplianceEnableRemoteVendorManagementParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.StorageApplianceEnableRemoteVendorManagementParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Field Deprecated. This field is not used and will be rejected if provided. The list of IPv4 subnets (in CIDR format), IPv6 subnets (in CIDR format), or hostnames that the storage appliance needs accessible in order to turn on the remote vendor management.")]
        ...
        public string[] SupportEndpoint { get => _storageApplianceEnableRemoteVendorManagementParametersBody.SupportEndpoint ?? null /* arrayOf */; set => _storageApplianceEnableRemoteVendorManagementParametersBody.SupportEndpoint = value; }
        ...
        /// <returns>
        /// a duplicate instance of EnableAzNetworkCloudStorageApplianceRemoteVendorManagement_EnableViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.EnableAzNetworkCloudStorageApplianceRemoteVendorManagement_EnableViaIdentityExpanded Clone()
        {
            var clone = new EnableAzNetworkCloudStorageApplianceRemoteVendorManagement_EnableViaIdentityExpanded();
            ...
            clone._storageApplianceEnableRemoteVendorManagementParametersBody = this._storageApplianceEnableRemoteVendorManagementParametersBody;
            return clone;
        }

        /// <summary>
        /// Intializes a new instance of the <see cref="EnableAzNetworkCloudStorageApplianceRemoteVendorManagement_EnableViaIdentityExpanded"
        /// /> cmdlet class.
        /// </summary>
        public EnableAzNetworkCloudStorageApplianceRemoteVendorManagement_EnableViaIdentityExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.StorageAppliancesEnableRemoteVendorManagementViaIdentity(InputObject.Id, _storageApplianceEnableRemoteVendorManagementParametersBody, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.StorageAppliancesEnableRemoteVendorManagement(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.StorageApplianceName ?? null, _storageApplianceEnableRemoteVendorManagementParametersBody, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_storageApplianceEnableRemoteVendorManagementParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api40.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_storageApplianceEnableRemoteVendorManagementParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_storageApplianceEnableRemoteVendorManagementParametersBody })
                    {
