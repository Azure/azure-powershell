...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzNetworkCloudL2Network_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzNetworkCloudL2Network_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzNetworkCloudL2Network_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.RemoveAzNetworkCloudL2Network_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzNetworkCloudL2Network_DeleteViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.L2NetworksDeleteViaIdentity(InputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.L2NetworksDelete(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.L2NetworkName ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzNetworkCloudL2Network_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzNetworkCloudL2Network_DeleteViaIdentity()
        {
