...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701
{
    ...
    public partial class HardwareInventory :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IHardwareInventoryInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IHardwareInventoryNetworkInterface[] _interface;

        /// <summary>
        /// The list of network interfaces and associated details for the bare metal machine.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IHardwareInventoryNetworkInterface[] Interface { get => this._interface; }

        /// <summary>Internal Acessors for AdditionalHostInformation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IHardwareInventoryInternal.AdditionalHostInformation { get => this._additionalHostInformation; set { {_additionalHostInformation = value;} } }

        /// <summary>Internal Acessors for Interface</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IHardwareInventoryNetworkInterface[] Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IHardwareInventoryInternal.Interface { get => this._interface; set { {_interface = value;} } }

        /// <summary>Internal Acessors for Nic</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.INic[] Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IHardwareInventoryInternal.Nic { get => this._nic; set { {_nic = value;} } }

        /// <summary>Backing field for <see cref="Nic" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.INic[] _nic;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.INic[] Nic { get => this._nic; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IHardwareInventoryNetworkInterface[] Interface { get;  }
        /// <summary>
        /// Field Deprecated. Will be removed in an upcoming version. The list of network interface cards and associated details for
        /// the bare metal machine.
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.INic[] Nic { get;  }
...

    {
        ...
        /// The list of network interfaces and associated details for the bare metal machine.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IHardwareInventoryNetworkInterface[] Interface { get; set; }
        /// <summary>
        /// Field Deprecated. Will be removed in an upcoming version. The list of network interface cards and associated details for
        /// the bare metal machine.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.INic[] Nic { get; set; }
