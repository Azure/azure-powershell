...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20240701
{
    ...
    public partial class CommandOutputSettings
    {
        ...
        internal CommandOutputSettings(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonObject json)
        {
            ...
            {_associatedIdentity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonObject>("associatedIdentity"), out var __jsonAssociatedIdentity) ? Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20240701.IdentitySelector.FromJson(__jsonAssociatedIdentity) : AssociatedIdentity;}
            {_containerUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("containerUrl"), out var __jsonContainerUrl) ? (string)__jsonContainerUrl : (string)ContainerUrl;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20240701.ICommandOutputSettings.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20240701.ICommandOutputSettings.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20240701.ICommandOutputSettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode node)
        {
