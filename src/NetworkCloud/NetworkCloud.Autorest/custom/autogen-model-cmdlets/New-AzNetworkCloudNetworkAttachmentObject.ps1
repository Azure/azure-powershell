...
function New-AzNetworkCloudNetworkAttachmentObject {
    ...
    Param(
        ...
        [Parameter(HelpMessage="The resource ID of the associated network attached to the virtual machine. It can be one of cloudServicesNetwork, l3Network, l2Network or trunkedNetwork resources.")]
        [string]
        $AttachedNetworkId,
        ...
        [string]
        $DefaultGateway,
        [Parameter(HelpMessage="The IP allocation mechanism for the virtual machine. Dynamic and Static are only valid for l3Network which may also specify Disabled. Otherwise, Disabled is the only permitted value.")]
