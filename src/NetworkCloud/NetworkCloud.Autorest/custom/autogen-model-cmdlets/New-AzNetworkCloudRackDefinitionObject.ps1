...
function New-AzNetworkCloudRackDefinitionObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250901.RackDefinition')]
    ...
    Param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250901.IBareMetalMachineConfigurationData[]]
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250901.IStorageApplianceConfigurationData[]]
        $StorageApplianceConfigurationData
    )

    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250901.RackDefinition]::New()
