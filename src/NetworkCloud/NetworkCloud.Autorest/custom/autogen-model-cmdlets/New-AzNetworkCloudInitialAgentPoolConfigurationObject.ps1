...
function New-AzNetworkCloudInitialAgentPoolConfigurationObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250901.InitialAgentPoolConfiguration')]
    ...
    Param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250901.IL3NetworkAttachmentConfiguration[]]
        $AttachedNetworkConfigurationL3Network,
        [Parameter(HelpMessage="The list of Trunked Networks and related configuration for attachment.")]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250901.ITrunkedNetworkAttachmentConfiguration[]]
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250901.IKubernetesLabel[]]
        $Label,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250901.InitialAgentPoolConfiguration]::New()
