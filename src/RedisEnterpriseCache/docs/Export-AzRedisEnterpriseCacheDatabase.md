...
```
Export-AzRedisEnterpriseCacheDatabase -ClusterName <String> -DatabaseName <String> -ResourceGroupName <String>
 -SasUri <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
