...
namespace Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Support.ActionType Internal = @"Internal";
        ...
        {
            return new ActionType(System.Convert.ToString(value));
        }

        /// <summary>Compares values of enum type ActionType</summary>
        /// <param name="e">the value to compare against this instance.</param>
        /// <returns><c>true</c> if the two instances are equal to the same value</returns>
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Support.ActionType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Support.ActionType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Support.ActionType e1, Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Support.ActionType e2)
        {
            return !e2.Equals(e1);
        }
