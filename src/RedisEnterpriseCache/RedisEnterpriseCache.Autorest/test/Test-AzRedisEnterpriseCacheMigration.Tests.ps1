if(($null -eq $TestName) -or ($TestName -contains 'Test-AzRedisEnterpriseCacheMigration'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Test-AzRedisEnterpriseCacheMigration.Recording.json'
