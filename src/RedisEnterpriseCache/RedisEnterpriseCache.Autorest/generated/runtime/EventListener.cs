...
namespace Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime
{
    ...
    {
        Task Validate(Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.IEventListener listener);
    }
    ...
    internal static partial class Extensions
    {
        ...
        {
            await (inst as Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.IValidates)?.Validate(instance);
        }
