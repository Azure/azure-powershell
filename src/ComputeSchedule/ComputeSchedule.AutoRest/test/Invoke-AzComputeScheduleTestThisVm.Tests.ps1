if(($null -eq $TestName) -or ($TestName -contains 'Invoke-AzComputeScheduleTestThisVm'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Invoke-AzComputeScheduleTestThisVm.Recording.json'
...
Describe 'Invoke-AzComputeScheduleTestThisVm' {
