if(($null -eq $TestName) -or ($TestName -contains 'Submit-AzComputeScheduleScheduledAction'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Submit-AzComputeScheduleScheduledAction.Recording.json'
...
Describe 'Submit-AzComputeScheduleScheduledAction' {
