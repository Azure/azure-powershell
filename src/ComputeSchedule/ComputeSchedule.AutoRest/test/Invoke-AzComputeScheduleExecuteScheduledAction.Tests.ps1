if(($null -eq $TestName) -or ($TestName -contains 'Invoke-AzComputeScheduleExecuteScheduledAction'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Invoke-AzComputeScheduleExecuteScheduledAction.Recording.json'
...
Describe 'Invoke-AzComputeScheduleExecuteScheduledAction' {
