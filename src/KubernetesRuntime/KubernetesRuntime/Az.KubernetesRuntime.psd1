#
# Module manifest for module 'Az.KubernetesRuntime'
#
...
RequiredAssemblies = 'KubernetesRuntime.Autorest/bin/Az.KubernetesRuntime.private.dll'
...
FormatsToProcess = 'KubernetesRuntime.Autorest/Az.KubernetesRuntime.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('KubernetesRuntime.Autorest/Az.KubernetesRuntime.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Disable-AzKubernetesRuntimeLoadBalancer', 
