...
namespace Microsoft.Azure.Management.FrontDoor.Models
{
    ...
    public partial class PolicySettings
    {
        ...
        /// <param name="captchaExpirationInMinutes">Defines the Captcha cookie validity lifetime in minutes. This setting is
        /// only applicable to Premium_AzureFrontDoor. Value must be an integer between
...

        {
            ...
            this.CaptchaExpirationInMinutes = captchaExpirationInMinutes;
        ...
        /// <summary>
        /// Gets or sets defines the Captcha cookie validity lifetime in minutes. This
        /// setting is only applicable to Premium_AzureFrontDoor. Value must be an
        /// integer between 5 and 1440 with the default value being 30.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "captchaExpirationInMinutes")]
        ...
        public virtual void Validate()
        {
            ...
            if (this.CaptchaExpirationInMinutes != null)
            {
                if (this.CaptchaExpirationInMinutes > 1440)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.InclusiveMaximum, "CaptchaExpirationInMinutes", 1440);
                }
                if (this.CaptchaExpirationInMinutes < 5)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.InclusiveMinimum, "CaptchaExpirationInMinutes", 5);
                }
            }
