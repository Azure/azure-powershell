...
namespace Microsoft.Azure.Management.FrontDoor
{
    ...
    /// </summary>
    internal partial class ManagedRuleSetsOperations : IServiceOperations<FrontDoorClient>, IManagedRuleSetsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ManagedRuleSetsOperations(FrontDoorClient client)
        {
            if (client == null)
            {
