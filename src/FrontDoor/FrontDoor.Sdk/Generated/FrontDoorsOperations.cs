...
namespace Microsoft.Azure.Management.FrontDoor
{
    ...
    /// </summary>
    internal partial class FrontDoorsOperations : IServiceOperations<FrontDoorClient>, IFrontDoorsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal FrontDoorsOperations(FrontDoorClient client)
        {
            if (client == null)
            {
