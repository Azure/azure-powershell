...
namespace Microsoft.Azure.Management.FrontDoor
{
    ...
    /// </summary>
    internal partial class RulesEnginesOperations : IServiceOperations<FrontDoorClient>, IRulesEnginesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal RulesEnginesOperations(FrontDoorClient client)
        {
            if (client == null)
            {
