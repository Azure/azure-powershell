...
namespace Microsoft.Azure.Management.FrontDoor
{
    ...
    /// </summary>
    internal partial class FrontDoorNameAvailabilityWithSubscriptionOperations : IServiceOperations<FrontDoorClient>, IFrontDoorNameAvailabilityWithSubscriptionOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal FrontDoorNameAvailabilityWithSubscriptionOperations(FrontDoorClient client)
        {
            if (client == null)
            {
