...
namespace Microsoft.Azure.Management.FrontDoor
{
    ...
    /// </summary>
    internal partial class ReportsOperations : IServiceOperations<FrontDoorClient>, IReportsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ReportsOperations(FrontDoorClient client)
        {
            if (client == null)
            {
        ...
        /// <summary>
        /// Gets a reference to the FrontDoorClient
        /// </summary>
        public FrontDoorClient Client { get; private set; }
