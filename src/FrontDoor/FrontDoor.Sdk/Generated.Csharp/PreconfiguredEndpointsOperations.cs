...
namespace Microsoft.Azure.Management.FrontDoor
{
    ...
    /// </summary>
    internal partial class PreconfiguredEndpointsOperations : IServiceOperations<FrontDoorClient>, IPreconfiguredEndpointsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal PreconfiguredEndpointsOperations(FrontDoorClient client)
        {
            if (client == null)
            {
