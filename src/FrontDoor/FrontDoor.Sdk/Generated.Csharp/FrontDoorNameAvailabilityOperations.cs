...
namespace Microsoft.Azure.Management.FrontDoor
{
    ...
    /// </summary>
    internal partial class FrontDoorNameAvailabilityOperations : IServiceOperations<FrontDoorClient>, IFrontDoorNameAvailabilityOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal FrontDoorNameAvailabilityOperations(FrontDoorClient client)
        {
            if (client == null)
            {
