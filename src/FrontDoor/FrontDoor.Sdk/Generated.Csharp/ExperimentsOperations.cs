...
namespace Microsoft.Azure.Management.FrontDoor
{
    ...
    /// </summary>
    internal partial class ExperimentsOperations : IServiceOperations<FrontDoorClient>, IExperimentsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ExperimentsOperations(FrontDoorClient client)
        {
            if (client == null)
            {
