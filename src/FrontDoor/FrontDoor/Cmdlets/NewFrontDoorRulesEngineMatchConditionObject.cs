...
namespace Microsoft.Azure.Commands.FrontDoor.Cmdlets
{
    ...
    public class NewFrontDoorRulesEngineMatchConditionObject : AzureFrontDoorCmdletBase
    {
        ...
        [CmdletParameterBreakingChangeWithVersion("Operator", "15.0.0", "6.0.0", OldParameterType = typeof(PSRulesEngineOperator), NewParameterTypeName = "System.String", ChangeDescription = "no longer supports the type 'Microsoft.Azure.Commands.FrontDoor.Models.PSRulesEngineOperator' for parameter 'Operator'.")]
        ...
        [CmdletParameterBreakingChangeWithVersion("Transform", "15.0.0", "6.0.0", OldParameterType = typeof(PSTransform), NewParameterTypeName = "System.String[]", ChangeDescription = "The element type for parameter 'Transform' has been changed from 'Microsoft.Azure.Commands.FrontDoor.Models.PSTransform' to 'System.String'.")]
        [Parameter(Mandatory = false,
