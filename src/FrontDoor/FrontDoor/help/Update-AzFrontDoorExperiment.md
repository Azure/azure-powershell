...
```
Update-AzFrontDoorExperiment -InputObject <IFrontDoorIdentity> [-Description <String>] [-EnabledState <String>]
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityNetworkExperimentProfileExpanded, UpdateViaIdentityExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaJsonString, UpdateViaJsonFilePath, UpdateViaIdentityNetworkExperimentProfileExpanded
