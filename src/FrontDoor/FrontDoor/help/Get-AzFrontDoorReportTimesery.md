...
Get-AzFrontDoorReportTimesery -ExperimentName <String> -ProfileName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] -AggregationInterval <String> -EndDateTimeUtc <DateTime>
 -StartDateTimeUtc <DateTime> -TimeseriesType <String> [-Country <String>] [-Endpoint <String>]
