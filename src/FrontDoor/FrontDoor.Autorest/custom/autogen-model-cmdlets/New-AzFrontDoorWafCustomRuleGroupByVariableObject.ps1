...
function New-AzFrontDoorWafCustomRuleGroupByVariableObject {
    ...
    Param(
        ...
        [Parameter(Mandatory, HelpMessage="Describes the supported variable for group by.")]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.GroupByVariable]::New()
