...
online version: https://learn.microsoft.com/powershell/module/az.frontdoor/new-azfrontdoorexperiment
schema: 2.0.0
---

# New-AzFrontDoorExperiment
...
```
New-AzFrontDoorExperiment -Name <String> -ProfileName <String> -ResourceGroupName <String>
