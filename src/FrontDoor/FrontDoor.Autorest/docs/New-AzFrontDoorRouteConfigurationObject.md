...
online version: https://learn.microsoft.com/powershell/module/Az.FrontDoor/new-azfrontdoorrouteconfigurationobject
schema: 2.0.0
---
...
```
New-AzFrontDoorRouteConfigurationObject -OdataType <String> [-BackendPoolId <String>]
 ...
 [-CustomQueryString <String>] [-ForwardingProtocol <String>] [-RedirectProtocol <String>]
