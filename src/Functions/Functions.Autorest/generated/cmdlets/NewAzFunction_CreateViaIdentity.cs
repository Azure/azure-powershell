...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzFunction_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzFunction_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="FunctionEnvelope" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.IFunctionEnvelope _functionEnvelope;

        /// <summary>Function information.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Function information.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Function information.",
        SerializedName = @"functionEnvelope",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.IFunctionEnvelope) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.IFunctionEnvelope FunctionEnvelope { get => this._functionEnvelope; set => this._functionEnvelope = value; }
        ...
        /// <returns>a duplicate instance of NewAzFunction_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets.NewAzFunction_CreateViaIdentity Clone()
        {
            var clone = new NewAzFunction_CreateViaIdentity();
            ...
            clone.FunctionEnvelope = this.FunctionEnvelope;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzFunction_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzFunction_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.WebAppsCreateFunctionViaIdentity(InputObject.Id, FunctionEnvelope, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.WebAppsCreateFunction(InputObject.ResourceGroupName ?? null, InputObject.Name ?? null, InputObject.FunctionName ?? null, InputObject.SubscriptionId ?? null, FunctionEnvelope, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=FunctionEnvelope})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.IDefaultErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=FunctionEnvelope })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=FunctionEnvelope })
                    {
