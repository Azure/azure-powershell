...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Restore, @"AzFunctionApp_Restore", SupportsShouldProcess = true)]
    ...
    public partial class RestoreAzFunctionApp_Restore : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ID of the backup.")]
        ...
        /// <returns>a duplicate instance of RestoreAzFunctionApp_Restore</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets.RestoreAzFunctionApp_Restore Clone()
        {
            var clone = new RestoreAzFunctionApp_Restore();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.WebAppsRestore(ResourceGroupName, Name, BackupId, SubscriptionId, Request, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,BackupId=BackupId,SubscriptionId=SubscriptionId,body=Request})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RestoreAzFunctionApp_Restore" /> cmdlet class.
        /// </summary>
        public RestoreAzFunctionApp_Restore()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20190801.IDefaultErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, Name=Name, BackupId=BackupId, SubscriptionId=SubscriptionId, body=Request })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, Name=Name, BackupId=BackupId, SubscriptionId=SubscriptionId, body=Request })
                    {
