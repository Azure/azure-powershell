...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.ProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.ProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.ProvisioningState InProgress = @"InProgress";

        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.ProvisioningState ResolvingDns = @"ResolvingDNS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
