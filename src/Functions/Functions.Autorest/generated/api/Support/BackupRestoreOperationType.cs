...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.BackupRestoreOperationType Clone = @"Clone";

        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.BackupRestoreOperationType CloudFs = @"CloudFS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.BackupRestoreOperationType Default = @"Default";

        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.BackupRestoreOperationType Relocation = @"Relocation";

        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.BackupRestoreOperationType Snapshot = @"Snapshot";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.BackupRestoreOperationType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.BackupRestoreOperationType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.BackupRestoreOperationType e1, Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.BackupRestoreOperationType e2)
        {
            return !e2.Equals(e1);
        }
