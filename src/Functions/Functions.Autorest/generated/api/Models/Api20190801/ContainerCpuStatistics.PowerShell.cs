...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20190801
{
    ...
    public partial class ContainerCpuStatistics
    {
        ...
        internal ContainerCpuStatistics(global::System.Collections.IDictionary content)
        {
            ...
            if (content.Contains("ThrottlingData"))
            {
            ...
            if (content.Contains("SystemCpuUsage"))
            {
            ...
            if (content.Contains("OnlineCpuCount"))
            {
            ...
            if (content.Contains("CpuUsageTotalUsage"))
            {
            ...
            if (content.Contains("CpuUsagePerCpuUsage"))
            {
            ...
            if (content.Contains("CpuUsageKernelModeUsage"))
            {
            ...
            if (content.Contains("CpuUsageUserModeUsage"))
            {
            ...
            if (content.Contains("ThrottlingDataPeriod"))
            {
            ...
            if (content.Contains("ThrottlingDataThrottledPeriod"))
            {
            ...
            if (content.Contains("ThrottlingDataThrottledTime"))
            {
        ...
        /// <returns>an instance of the <see cref="ContainerCpuStatistics" /> model class.</returns>
