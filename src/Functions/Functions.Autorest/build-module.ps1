...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom/Az.Functions.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.Functions.psd1'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.Functions.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Functions","ModuleRootName":"$(root-module-name)"}' -AsHashtable
