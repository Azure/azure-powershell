...
### AllRuntimes (Default)
```
Get-AzFunctionAppFlexConsumptionRuntime -Location <String>
 [<CommonParameters>]
```

### AllVersions
```
Get-AzFunctionAppFlexConsumptionRuntime -Location <String> -Runtime <String>
 [<CommonParameters>]
```
...
### DefaultOrLatest
```
Get-AzFunctionAppFlexConsumptionRuntime -Location <String> -Runtime <String> [-DefaultOrLatest]
 [<CommonParameters>]
```
