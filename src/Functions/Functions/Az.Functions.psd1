...
FunctionsToExport = 'Get-AzFunctionApp', 'Get-AzFunctionAppAvailableLocation', 
               'Get-AzFunctionAppFlexConsumptionRuntime', 'Get-AzFunctionAppPlan', 
               'Get-AzFunctionAppSetting', 'New-AzFunctionApp', 
               'New-AzFunctionAppPlan', 'Remove-AzFunctionApp', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated the Function App stacks parser to handle a runtime definition that does not include a ''FUNCTIONS_WORKER_RUNTIME'' app setting. [#29630]
