...
online version: https://docs.microsoft.com/powershell/module/az.functions/get-azwebappftpallowed
schema: 2.0.0
---

# Get-AzWebAppFtpAllowed
...
### Get (Default)
```
Get-AzWebAppFtpAllowed -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzWebAppFtpAllowed -InputObject <IFunctionsIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
