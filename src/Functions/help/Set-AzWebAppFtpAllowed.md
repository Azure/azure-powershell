...
online version: https://docs.microsoft.com/powershell/module/az.functions/set-azwebappftpallowed
schema: 2.0.0
---

# Set-AzWebAppFtpAllowed
...
```
Set-AzWebAppFtpAllowed -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] [-Allow]
 [-Kind <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Set-AzWebAppFtpAllowed -Name <String> -ResourceGroupName <String>
