...
online version: https://docs.microsoft.com/powershell/module/az.functions/get-azwebappbasicpublishingcredentialspolicy
schema: 2.0.0
---

# Get-AzWebAppBasicPublishingCredentialsPolicy
...
### Get (Default)
```
Get-AzWebAppBasicPublishingCredentialsPolicy -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzWebAppBasicPublishingCredentialsPolicy -InputObject <IFunctionsIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
