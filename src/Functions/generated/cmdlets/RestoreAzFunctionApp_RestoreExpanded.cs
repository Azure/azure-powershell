...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] WebApps_Restore=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/backups/{backupId}/restore"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Restore, @"AzFunctionApp_RestoreExpanded", SupportsShouldProcess = true)]
    ...
    public partial class RestoreAzFunctionApp_RestoreExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<code>true</code> if SiteConfig.ConnectionStrings should be set in new app; otherwise, <code>false</code>.")]
        ...
        public global::System.Management.Automation.SwitchParameter AdjustConnectionString { get => RequestBody.AdjustConnectionString ?? default(global::System.Management.Automation.SwitchParameter); set => RequestBody.AdjustConnectionString = value; }

        /// <summary>Specify app service plan that will own restored site.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Specify app service plan that will own restored site.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Functions.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string AppServicePlan { get => RequestBody.AppServicePlan ?? null; set => RequestBody.AppServicePlan = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of a blob which contains the backup.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Functions.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string BlobName { get => RequestBody.BlobName ?? null; set => RequestBody.BlobName = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Collection of databases which should be restored. This list has to match the list of databases included in the backup.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Functions.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "App Service Environment name, if needed (only when restoring an app to an App Service Environment).")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Functions.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string HostingEnvironment { get => RequestBody.HostingEnvironment ?? null; set => RequestBody.HostingEnvironment = value; }
        ...
        /// <code>false</code>, custom domains are added to the app's object when it is being restored, but that might fail due to
        /// conflicts during the operation.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Changes a logic when restoring an app with custom domains. <code>true</code> to remove custom domains automatically. If <code>false</code>, custom domains are added to the app's object when it is being restored, but that might fail due to conflicts during the operation.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Functions.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Changes a logic when restoring an app with custom domains. <code>true</code> to remove custom domains automatically. If <code>false</code>, custom domains are added to the app's object when it is being restored, but that might fail due to conflicts during the operation.",
        SerializedName = @"ignoreConflictingHostNames",
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter IgnoreConflictingHostName { get => RequestBody.IgnoreConflictingHostName ?? default(global::System.Management.Automation.SwitchParameter); set => RequestBody.IgnoreConflictingHostName = value; }

        /// <summary>Ignore the databases and only restore the site content</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Ignore the databases and only restore the site content")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Functions.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter IgnoreDatabase { get => RequestBody.IgnoreDatabase ?? default(global::System.Management.Automation.SwitchParameter); set => RequestBody.IgnoreDatabase = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Operation type.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Functions.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.BackupRestoreOperationType))]
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.BackupRestoreOperationType OperationType { get => RequestBody.OperationType ?? ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.BackupRestoreOperationType)""); set => RequestBody.OperationType = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<code>true</code> if the restore operation can overwrite target app; otherwise, <code>false</code>. <code>true</code> is needed if trying to restore over an existing app.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Functions.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20190801.IRestoreRequest _requestBody= new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20190801.RestoreRequest();

        /// <summary>Description of a restore request.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20190801.IRestoreRequest RequestBody { get => this._requestBody; set => this._requestBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of an app.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Functions.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SiteName { get => RequestBody.SiteName ?? null; set => RequestBody.SiteName = value; }
        ...
        /// <returns>a duplicate instance of RestoreAzFunctionApp_RestoreExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets.RestoreAzFunctionApp_RestoreExpanded Clone()
        {
            var clone = new RestoreAzFunctionApp_RestoreExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.WebAppsRestore(ResourceGroupName, Name, BackupId, SubscriptionId, RequestBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,BackupId=BackupId,SubscriptionId=SubscriptionId,body=RequestBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RestoreAzFunctionApp_RestoreExpanded" /> cmdlet class.
        /// </summary>
        public RestoreAzFunctionApp_RestoreExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20190801.IDefaultErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, Name=Name, BackupId=BackupId, SubscriptionId=SubscriptionId, body=RequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, Name=Name, BackupId=BackupId, SubscriptionId=SubscriptionId, body=RequestBody })
                    {
