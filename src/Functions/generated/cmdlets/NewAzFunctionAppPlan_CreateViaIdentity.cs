...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzFunctionAppPlan_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzFunctionAppPlan_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20190801.IAppServicePlan _appServicePlan;

        /// <summary>App Service plan.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "App Service plan.", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20190801.IAppServicePlan AppServicePlan { get => this._appServicePlan; set => this._appServicePlan = value; }
        ...
        /// <returns>a duplicate instance of NewAzFunctionAppPlan_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets.NewAzFunctionAppPlan_CreateViaIdentity Clone()
        {
            var clone = new NewAzFunctionAppPlan_CreateViaIdentity();
            ...
            clone.AppServicePlan = this.AppServicePlan;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzFunctionAppPlan_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzFunctionAppPlan_CreateViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'AppServicePlansCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.AppServicePlansCreateOrUpdateViaIdentity(InputObject.Id, AppServicePlan, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.AppServicePlansCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.Name ?? null, InputObject.SubscriptionId ?? null, AppServicePlan, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=AppServicePlan})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20190801.IDefaultErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=AppServicePlan })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=AppServicePlan })
                    {
