        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.WebAppsUpdateViaIdentity(InputObject.Id, SiteEnvelopeBody, onOk, onAccepted, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.WebAppsUpdate(InputObject.ResourceGroupName ?? null, InputObject.Name ?? null, InputObject.SubscriptionId ?? null, SiteEnvelopeBody, onOk, onAccepted, onDefault, this, Pipeline);
                    }
