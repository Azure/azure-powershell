...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListGeoRegions=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Web/geoRegions"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzFunctionAppAvailableLocation_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20190801.IGeoRegion))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Description(@"Get a list of available geographical regions.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Generated]
    public partial class GetAzFunctionAppAvailableLocation_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="LinuxDynamicWorkersEnabled" /> property.</summary>
        private global::System.Management.Automation.SwitchParameter _linuxDynamicWorkersEnabled;

        /// <summary>
        /// Specify <code>true</code> if you want to filter to only regions that support Linux Consumption Workers.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Specify <code>true</code> if you want to filter to only regions that support Linux Consumption Workers.")]
        ...
        public global::System.Management.Automation.SwitchParameter LinuxDynamicWorkersEnabled { get => this._linuxDynamicWorkersEnabled; set => this._linuxDynamicWorkersEnabled = value; }

        /// <summary>Backing field for <see cref="LinuxWorkersEnabled" /> property.</summary>
        private global::System.Management.Automation.SwitchParameter _linuxWorkersEnabled;

        /// <summary>
        /// Specify <code>true</code> if you want to filter to only regions that support Linux workers.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Specify <code>true</code> if you want to filter to only regions that support Linux workers.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Functions.ParameterCategory.Query)]
        public global::System.Management.Automation.SwitchParameter LinuxWorkersEnabled { get => this._linuxWorkersEnabled; set => this._linuxWorkersEnabled = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.SkuName _sku;

        /// <summary>Name of SKU used to filter the regions.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of SKU used to filter the regions.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Functions.ParameterCategory.Query)]
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.SkuName))]
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.SkuName Sku { get => this._sku; set => this._sku = value; }
        ...
        /// <summary>Backing field for <see cref="XenonWorkersEnabled" /> property.</summary>
        private global::System.Management.Automation.SwitchParameter _xenonWorkersEnabled;

        /// <summary>
        /// Specify <code>true</code> if you want to filter to only regions that support Xenon workers.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Specify <code>true</code> if you want to filter to only regions that support Xenon workers.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Functions.ParameterCategory.Query)]
        public global::System.Management.Automation.SwitchParameter XenonWorkersEnabled { get => this._xenonWorkersEnabled; set => this._xenonWorkersEnabled = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20190801.IGeoRegionCollection">Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20190801.IGeoRegionCollection</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20190801.IGeoRegionCollection> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzFunctionAppAvailableLocation_List" /> cmdlet class.
        /// </summary>
        public GetAzFunctionAppAvailableLocation_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ListGeoRegions(this.InvocationInformation.BoundParameters.ContainsKey("Sku") ? Sku : null, this.InvocationInformation.BoundParameters.ContainsKey("LinuxWorkersEnabled") ? LinuxWorkersEnabled : default(global::System.Management.Automation.SwitchParameter?), this.InvocationInformation.BoundParameters.ContainsKey("XenonWorkersEnabled") ? XenonWorkersEnabled : default(global::System.Management.Automation.SwitchParameter?), this.InvocationInformation.BoundParameters.ContainsKey("LinuxDynamicWorkersEnabled") ? LinuxDynamicWorkersEnabled : default(global::System.Management.Automation.SwitchParameter?), SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Sku=this.InvocationInformation.BoundParameters.ContainsKey("Sku") ? Sku : null,LinuxWorkersEnabled=this.InvocationInformation.BoundParameters.ContainsKey("LinuxWorkersEnabled") ? LinuxWorkersEnabled : default(global::System.Management.Automation.SwitchParameter?),XenonWorkersEnabled=this.InvocationInformation.BoundParameters.ContainsKey("XenonWorkersEnabled") ? XenonWorkersEnabled : default(global::System.Management.Automation.SwitchParameter?),LinuxDynamicWorkersEnabled=this.InvocationInformation.BoundParameters.ContainsKey("LinuxDynamicWorkersEnabled") ? LinuxDynamicWorkersEnabled : default(global::System.Management.Automation.SwitchParameter?),SubscriptionId=SubscriptionId})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20190801.IDefaultErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Sku=this.InvocationInformation.BoundParameters.ContainsKey("Sku") ? Sku : null, LinuxWorkersEnabled=this.InvocationInformation.BoundParameters.ContainsKey("LinuxWorkersEnabled") ? LinuxWorkersEnabled : default(global::System.Management.Automation.SwitchParameter?), XenonWorkersEnabled=this.InvocationInformation.BoundParameters.ContainsKey("XenonWorkersEnabled") ? XenonWorkersEnabled : default(global::System.Management.Automation.SwitchParameter?), LinuxDynamicWorkersEnabled=this.InvocationInformation.BoundParameters.ContainsKey("LinuxDynamicWorkersEnabled") ? LinuxDynamicWorkersEnabled : default(global::System.Management.Automation.SwitchParameter?), SubscriptionId=SubscriptionId })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Sku=this.InvocationInformation.BoundParameters.ContainsKey("Sku") ? Sku : null, LinuxWorkersEnabled=this.InvocationInformation.BoundParameters.ContainsKey("LinuxWorkersEnabled") ? LinuxWorkersEnabled : default(global::System.Management.Automation.SwitchParameter?), XenonWorkersEnabled=this.InvocationInformation.BoundParameters.ContainsKey("XenonWorkersEnabled") ? XenonWorkersEnabled : default(global::System.Management.Automation.SwitchParameter?), LinuxDynamicWorkersEnabled=this.InvocationInformation.BoundParameters.ContainsKey("LinuxDynamicWorkersEnabled") ? LinuxDynamicWorkersEnabled : default(global::System.Management.Automation.SwitchParameter?), SubscriptionId=SubscriptionId })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20190801.IGeoRegionCollection> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ListGeoRegions_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
