...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20181130
{
    ...
    public partial class OperationListResultAutoGeneratedTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <paramref name="sourceValue"/> parameter to the <see cref="OperationListResultAutoGenerated"/>
        /// type.
        /// </summary>
        ...
        /// <summary>
        /// Converts the <paramref name="sourceValue" /> parameter into an instance of <see cref="OperationListResultAutoGenerated"
        /// />
        /// </summary>
        ...
        /// an instance of <see cref="OperationListResultAutoGenerated" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20181130.IOperationListResultAutoGenerated ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20181130.IOperationListResultAutoGenerated).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
