...
namespace Microsoft.Azure.Management.TrafficManager
{
    ...
    /// </summary>
    internal partial class HeatMapOperations : Microsoft.Rest.IServiceOperations<TrafficManagerManagementClient>, IHeatMapOperations
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<HeatMapModel>> GetWithHttpMessagesAsync(string resourceGroupName, string profileName, System.Collections.Generic.IList<double?> topLeft = default(System.Collections.Generic.IList<double?>), System.Collections.Generic.IList<double?> botRight = default(System.Collections.Generic.IList<double?>), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (topLeft != null)
            {
                if (topLeft.Count > 2)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.MaxItems, "topLeft", 2);
                }
                if (topLeft.Count < 2)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.MinItems, "topLeft", 2);
                }
            }
            if (botRight != null)
            {
                if (botRight.Count > 2)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.MaxItems, "botRight", 2);
                }
                if (botRight.Count < 2)
                {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<HeatMapModel>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<HeatMapModel>(_responseContent, this.Client.DeserializationSettings);
                }
