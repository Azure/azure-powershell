...
namespace Microsoft.Azure.Management.TrafficManager
{
    ...
    internal partial class ProfilesOperations : IServiceOperations<TrafficManagerManagementClient>, IProfilesOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<TrafficManagerNameAvailability>> CheckTrafficManagerNameAvailabilityV2WithHttpMessagesAsync(string name = default(string), string type = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("parameters", parameters);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "CheckTrafficManagerNameAvailabilityV2", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
