...
online version: https://learn.microsoft.com/powershell/module/az.trafficmanager/enable-aztrafficmanagerprofile
schema: 2.0.0
---
...
### Fields (Default)
```
Enable-AzTrafficManagerProfile -Name <String> -ResourceGroupName <String> [-DefaultProfile <PSObject>]
 [-SubscriptionId <String[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Object
```
Enable-AzTrafficManagerProfile -TrafficManagerProfile <IProfile> [-DefaultProfile <PSObject>]
 [-SubscriptionId <String[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Example 1: Enable a Traffic Manager profile by name
```powershell
Enable-AzTrafficManagerProfile -Name "myprofile" -ResourceGroupName "myRG"
```
...
Enables a Traffic Manager profile by specifying the profile name and resource group.

### Example 2: Enable a profile using pipeline
```powershell
Get-AzTrafficManagerProfile -ProfileName "myprofile" -ResourceGroupName "myRG" | Enable-AzTrafficManagerProfile
```
...
Gets a disabled profile and pipes it to Enable-AzTrafficManagerProfile to enable it.
