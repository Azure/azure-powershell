...
```
New-AzTrafficManagerEndpoint -EndpointName <String> -EndpointType <String> -ProfileName <String>
...
### CreateViaIdentity
```
New-AzTrafficManagerEndpoint -InputObject <ITrafficManagerIdentity> -Parameters <IEndpoint> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzTrafficManagerEndpoint -InputObject <ITrafficManagerIdentity> [-AlwaysServe <String>]
 [-CustomHeaders <IEndpointPropertiesCustomHeadersItem[]>] [-EndpointLocation <String>]
 [-EndpointMonitorStatus <String>] [-EndpointStatus <String>] [-GeoMapping <String[]>] [-Id <String>]
 [-MinChildEndpoints <Int64>] [-MinChildEndpointsIPv4 <Int64>] [-MinChildEndpointsIPv6 <Int64>]
 [-Name <String>] [-Priority <Int64>] [-Subnets <IEndpointPropertiesSubnetsItem[]>] [-Target <String>]
...
### Example 1: Create a new external endpoint
```powershell
New-AzTrafficManagerEndpoint -EndpointName "myendpoint" -EndpointType "ExternalEndpoints" -ProfileName "myprofile" -ResourceGroupName "myRG" -Target "www.contoso.com" -EndpointStatus "Enabled" -Weight 10
```
...
Creates a new external endpoint in an existing Traffic Manager profile.

### Example 2: Create an Azure endpoint targeting a web app
```powershell
$webAppId = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myRG/providers/Microsoft.Web/sites/mywebapp"
New-AzTrafficManagerEndpoint -EndpointName "azureendpoint" -EndpointType "AzureEndpoints" -ProfileName "myprofile" -ResourceGroupName "myRG" -TargetResourceId $webAppId -EndpointStatus "Enabled"
```

Creates a new Azure endpoint pointing to a web app resource.
