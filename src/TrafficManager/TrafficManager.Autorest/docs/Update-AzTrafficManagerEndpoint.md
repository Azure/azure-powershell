...
online version: https://learn.microsoft.com/powershell/module/az.trafficmanager/update-aztrafficmanagerendpoint
schema: 2.0.0
---

# Update-AzTrafficManagerEndpoint
...
```
Update-AzTrafficManagerEndpoint -EndpointName <String> -EndpointType <String> -ProfileName <String>
...
### UpdateViaIdentity
```
Update-AzTrafficManagerEndpoint -InputObject <ITrafficManagerIdentity> -Parameters <IEndpoint> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzTrafficManagerEndpoint -InputObject <ITrafficManagerIdentity> [-AlwaysServe <String>]
 [-CustomHeaders <IEndpointPropertiesCustomHeadersItem[]>] [-EndpointLocation <String>]
 [-EndpointMonitorStatus <String>] [-EndpointStatus <String>] [-GeoMapping <String[]>] [-Id <String>]
 [-MinChildEndpoints <Int64>] [-MinChildEndpointsIPv4 <Int64>] [-MinChildEndpointsIPv6 <Int64>]
 [-Name <String>] [-Priority <Int64>] [-Subnets <IEndpointPropertiesSubnetsItem[]>] [-Target <String>]
...
### Example 1: Update endpoint weight
```powershell
Update-AzTrafficManagerEndpoint -EndpointName "myendpoint" -EndpointType "ExternalEndpoints" -ProfileName "myprofile" -ResourceGroupName "myRG" -Weight 20
```
...
Updates the weight of an endpoint using a PATCH request.

### Example 2: Update endpoint target
```powershell
Update-AzTrafficManagerEndpoint -EndpointName "myendpoint" -EndpointType "ExternalEndpoints" -ProfileName "myprofile" -ResourceGroupName "myRG" -Target "www.contoso2.com"
```

Updates the target of an existing endpoint.
