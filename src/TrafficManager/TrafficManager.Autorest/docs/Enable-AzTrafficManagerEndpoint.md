...
### Fields (Default)
```
Enable-AzTrafficManagerEndpoint -Name <String> -ProfileName <String> -ResourceGroupName <String>
 -Type <String> [-DefaultProfile <PSObject>] [-SubscriptionId <String[]>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Object
```
Enable-AzTrafficManagerEndpoint -TrafficManagerEndpoint <IEndpoint> [-DefaultProfile <PSObject>]
...
### Example 1: Enable a Traffic Manager endpoint
```powershell
Enable-AzTrafficManagerEndpoint -Name "myendpoint" -Type "ExternalEndpoints" -ProfileName "myprofile" -ResourceGroupName "myRG"
```
...
Enables a specific endpoint in a Traffic Manager profile.

### Example 2: Enable an endpoint using pipeline
```powershell
Get-AzTrafficManagerEndpoint -EndpointName "myendpoint" -EndpointType "ExternalEndpoints" -ProfileName "myprofile" -ResourceGroupName "myRG" | Enable-AzTrafficManagerEndpoint
```
...
Gets an endpoint and pipes it to Enable-AzTrafficManagerEndpoint to enable it.
