...
namespace Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzCustomLocationResourceSyncRule_UpdateViaIdentityCustomlocationExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzCustomLocationResourceSyncRule_UpdateViaIdentityCustomlocationExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="CustomlocationInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Models.ICustomLocationIdentity _customlocationInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Models.ICustomLocationIdentity CustomlocationInputObject { get => this._customlocationInputObject; set => this._customlocationInputObject = value; }
        ...
        [global::System.Management.Automation.ValidateNotNull]
        [global::Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Category(global::Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.ParameterCategory.Runtime)]
        public Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.SendAsyncStep[] HttpPipelineAppend { get; set; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Resource Sync Rule name.")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Priority represents a priority of the Resource Sync Rule")]
        ...
        public int Priority { get => _parametersBody.Priority ?? default(int); set => _parametersBody.Priority = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "MatchExpressions is a list of resource selector requirements. Valid operators include In, NotIn, Exists, and DoesNotExist. The values set must be non-empty in the case of In and NotIn. The values set must be empty in the case of Exists and DoesNotExist.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Category(global::Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Models.IMatchExpressionsProperties[] SelectorMatchExpression { get => _parametersBody.SelectorMatchExpression?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.SelectorMatchExpression = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Models.IMatchExpressionsProperties>(value) : null); }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "MatchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is 'key', the operator is 'In', and the values array contains only 'value'.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Category(global::Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Models.IResourceSyncRulePropertiesSelectorMatchLabels SelectorMatchLabel { get => _parametersBody.SelectorMatchLabel ?? null /* object */; set => _parametersBody.SelectorMatchLabel = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Models.IPatchableResourceSyncRuleTags Tag { get => _parametersBody.Tag ?? null /* object */; set => _parametersBody.Tag = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "For an unmapped custom resource, its labels will be used to find matching resource sync rules. If this resource sync rule is one of the matching rules with highest priority, then the unmapped custom resource will be projected to the target resource group associated with this resource sync rule. The user creating this resource sync rule should have write permissions on the target resource group and this write permission will be validated when creating the resource sync rule.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Category(global::Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string TargetResourceGroup { get => _parametersBody.TargetResourceGroup ?? null; set => _parametersBody.TargetResourceGroup = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Models.IResourceSyncRule">Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Models.IResourceSyncRule</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Models.IResourceSyncRule> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void BeginProcessing()
        {
            ...
            if (Break)
            {
                Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.AttachDebugger.Break();
            }
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzCustomLocationResourceSyncRule_UpdateViaIdentityCustomlocationExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Cmdlets.UpdateAzCustomLocationResourceSyncRule_UpdateViaIdentityCustomlocationExpanded Clone()
        {
            var clone = new UpdateAzCustomLocationResourceSyncRule_UpdateViaIdentityCustomlocationExpanded();
        ...
        /// </returns>
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    case Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Events.Verbose:
                    {
                        WriteVerbose($"{(messageData().Message ?? global::System.String.Empty)}");
                        return ;
                    }
                    case Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Events.Warning:
                    {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Events.Error:
                    {
        ...
        {
            ((Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.IEventListener)this).Signal(Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Events.CmdletProcessRecordStart).Wait(); if( ((Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.IEventListener)this).Token.IsCancellationRequested ) { return; }
            __processRecordId = System.Guid.NewGuid().ToString();
            try
            {
                // work
                if (ShouldProcess($"Call remote 'ResourceSyncRulesUpdate' operation"))
                {
            ...
            catch (global::System.AggregateException aggregateException)
            {
                ...
                {
                    ((Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.IEventListener)this).Signal(Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Events.CmdletException, $"{innerException.GetType().Name} - {innerException.Message} : {innerException.StackTrace}").Wait(); if( ((Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.IEventListener)this).Token.IsCancellationRequested ) { return; }
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.IEventListener)this).Signal(Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Events.CmdletException, $"{exception.GetType().Name} - {exception.Message} : {exception.StackTrace}").Wait(); if( ((Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.IEventListener)this).Token.IsCancellationRequested ) { return; }
                // Write exception out to error channel.
                WriteError( new global::System.Management.Automation.ErrorRecord(exception,string.Empty, global::System.Management.Automation.ErrorCategory.NotSpecified, null) );
            }
            finally
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.IEventListener)this).Signal(Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Events.CmdletProcessRecordEnd).Wait();
            }
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (CustomlocationInputObject?.Id != null)
                    {
                        this.CustomlocationInputObject.Id += $"/resourceSyncRules/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.ResourceSyncRulesUpdateViaIdentity(CustomlocationInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == CustomlocationInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("CustomlocationInputObject has null value for CustomlocationInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, CustomlocationInputObject) );
                        }
                        if (null == CustomlocationInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("CustomlocationInputObject has null value for CustomlocationInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, CustomlocationInputObject) );
                        }
                        if (null == CustomlocationInputObject.ResourceName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("CustomlocationInputObject has null value for CustomlocationInputObject.ResourceName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, CustomlocationInputObject) );
                        }
                        await this.Client.ResourceSyncRulesUpdate(CustomlocationInputObject.SubscriptionId ?? null, CustomlocationInputObject.ResourceGroupName ?? null, CustomlocationInputObject.ResourceName ?? null, Name, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.SerializationMode.IncludeUpdate);
                    }
                ...
                {
                    await ((Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.IEventListener)this).Signal(Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Events.CmdletProcessRecordAsyncEnd);
                }
            }
        }
        ...
        {
            ((Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.IEventListener)this).Cancel();
            base.StopProcessing();
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzCustomLocationResourceSyncRule_UpdateViaIdentityCustomlocationExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzCustomLocationResourceSyncRule_UpdateViaIdentityCustomlocationExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Models.IResourceSyncRule> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
