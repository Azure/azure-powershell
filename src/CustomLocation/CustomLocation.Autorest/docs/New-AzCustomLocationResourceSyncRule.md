...
New-AzCustomLocationResourceSyncRule -CustomLocationName <String> -Name <String> -ResourceGroupName <String>
 -Location <String> [-SubscriptionId <String>] [-Priority <Int32>]
...
```
New-AzCustomLocationResourceSyncRule -CustomlocationInputObject <ICustomLocationIdentity> -Name <String>
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded, CreateViaIdentityCustomlocationExpanded, CreateViaJsonFilePath, CreateViaJsonString
Aliases:
