...
### List (Default)
```
Get-AzFleetGate -FleetName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>] [-Filter <String>]
...
### GetViaIdentityFleet
```
Get-AzFleetGate -Name <String> -FleetInputObject <IFleetIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzFleetGate -InputObject <IFleetIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
