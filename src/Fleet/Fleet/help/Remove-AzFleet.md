...
### DeleteViaIdentity
```
Remove-AzFleet -InputObject <IFleetIdentity> [-IfMatch <String>] [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.fleet/remove-azfleet](https://learn.microsoft.com/powershell/module/az.fleet/remove-azfleet)
