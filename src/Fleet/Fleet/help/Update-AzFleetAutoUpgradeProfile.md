...
```
Update-AzFleetAutoUpgradeProfile -Name <String> -FleetInputObject <IFleetIdentity> [-IfMatch <String>]
 [-IfNoneMatch <String>] [-Channel <String>] [-Disabled] [-LongTermSupport] [-TargetKubernetesVersion <String>]
