...
```
Update-AzFleetGate -FleetName <String> -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-IfMatch <String>] [-IfNoneMatch <String>] -State <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```
Update-AzFleetGate -Name <String> -FleetInputObject <IFleetIdentity> [-IfMatch <String>]
 [-IfNoneMatch <String>] -State <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzFleetGate -InputObject <IFleetIdentity> [-IfMatch <String>] [-IfNoneMatch <String>] -State <String>
