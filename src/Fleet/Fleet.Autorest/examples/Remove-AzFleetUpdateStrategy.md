...
Remove-AzFleetUpdateStrategy -FleetInputObject $f -Name strartegy3
```
...
```powershell
Remove-AzFleetUpdateStrategy -FleetName testfleet01 -ResourceGroupName K8sFleet-Test -Name strartegy2
```
