...
```
New-AzFleetManagedNamespace -InputObject <IFleetIdentity> -Location <String> [-IfMatch <String>]
 [-IfNoneMatch <String>] [-AdoptionPolicy <String>] [-DefaultNetworkPolicyEgress <String>]
...
```
New-AzFleetManagedNamespace -FleetInputObject <IFleetIdentity> -ManagedNamespaceName <String>
 -Location <String> [-IfMatch <String>] [-IfNoneMatch <String>] [-AdoptionPolicy <String>]
