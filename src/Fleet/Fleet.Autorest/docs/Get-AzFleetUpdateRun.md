...
online version: https://learn.microsoft.com/powershell/module/az.fleet/get-azfleetupdaterun
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzFleetUpdateRun -InputObject <IFleetIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityFleet
```
Get-AzFleetUpdateRun -FleetInputObject <IFleetIdentity> -Name <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
