...
online version: https://learn.microsoft.com/powershell/module/az.fleet/remove-azfleetmanagednamespace
schema: 2.0.0
---

# Remove-AzFleetManagedNamespace
...
### Delete (Default)
```
Remove-AzFleetManagedNamespace -FleetName <String> -ManagedNamespaceName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzFleetManagedNamespace -InputObject <IFleetIdentity> [-IfMatch <String>] [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentityFleet
```
Remove-AzFleetManagedNamespace -FleetInputObject <IFleetIdentity> -ManagedNamespaceName <String>
