...
### GetViaIdentity
```
Get-AzFleetManagedNamespace -InputObject <IFleetIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityFleet
```
Get-AzFleetManagedNamespace -FleetInputObject <IFleetIdentity> -ManagedNamespaceName <String>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
