...
online version: https://learn.microsoft.com/powershell/module/az.fleet/new-azfleetautoupgradeprofile
schema: 2.0.0
---

# New-AzFleetAutoUpgradeProfile
...
```
New-AzFleetAutoUpgradeProfile -FleetName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-IfMatch <String>] [-IfNoneMatch <String>] [-Channel <String>] [-Disabled]
 [-LongTermSupport] [-NodeImageSelectionType <String>] [-TargetKubernetesVersion <String>]
 [-UpdateStrategyId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzFleetAutoUpgradeProfile -InputObject <IFleetIdentity> [-IfMatch <String>] [-IfNoneMatch <String>]
 [-Channel <String>] [-Disabled] [-LongTermSupport] [-NodeImageSelectionType <String>]
 [-TargetKubernetesVersion <String>] [-UpdateStrategyId <String>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityFleetExpanded
```
New-AzFleetAutoUpgradeProfile -FleetInputObject <IFleetIdentity> -Name <String> [-IfMatch <String>]
 [-IfNoneMatch <String>] [-Channel <String>] [-Disabled] [-LongTermSupport] [-NodeImageSelectionType <String>]
 [-TargetKubernetesVersion <String>] [-UpdateStrategyId <String>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
