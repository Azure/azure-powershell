...
online version: https://learn.microsoft.com/powershell/module/az.fleet/remove-azfleetmember
schema: 2.0.0
---

# Remove-AzFleetMember
...
```
Remove-AzFleetMember -FleetInputObject <IFleetIdentity> -Name <String> [-IfMatch <String>]
