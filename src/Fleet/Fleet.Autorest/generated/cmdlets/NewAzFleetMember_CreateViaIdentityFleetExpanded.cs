...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Create=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/fleets/{fleetName}/members/{fleetMemberName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzFleetMember_CreateViaIdentityFleetExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IFleetMember))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Fleet.Description(@"Create a FleetMember")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Fleet.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Fleet.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/fleets/{fleetName}/members/{fleetMemberName}", ApiVersion = "2023-10-15")]
    public partial class NewAzFleetMember_CreateViaIdentityFleetExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.IEventListener,
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.IContext
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IFleetMember _resourceBody = new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.FleetMember();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Fleet.Fleet Client => Microsoft.Azure.PowerShell.Cmdlets.Fleet.Module.Instance.ClientAPI;

        /// <summary>
        /// The ARM resource id of the cluster that joins the Fleet. Must be a valid Azure resource id. e.g.: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{clusterName}'.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The ARM resource id of the cluster that joins the Fleet. Must be a valid Azure resource id. e.g.: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{clusterName}'.")]
        ...
        public string ClusterResourceId { get => _resourceBody.ClusterResourceId ?? null; set => _resourceBody.ClusterResourceId = value; }
        ...
        /// <summary>Backing field for <see cref="FleetInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IFleetIdentity _fleetInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IFleetIdentity FleetInputObject { get => this._fleetInputObject; set => this._fleetInputObject = value; }

        /// <summary>The group this member belongs to for multi-cluster update management.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The group this member belongs to for multi-cluster update management.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Fleet.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Fleet.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Group { get => _resourceBody.Group ?? null; set => _resourceBody.Group = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Fleet.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Fleet.ParameterCategory.Header)]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the Fleet member resource.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("FleetMemberName")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Fleet.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Fleet.ParameterCategory.Path)]
        ...
        /// </summary>
        public Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.HttpPipeline Pipeline { get; set; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IErrorResponse">Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IErrorResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IErrorResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IFleetMember">Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IFleetMember</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IFleetMember> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzFleetMember_CreateViaIdentityFleetExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Fleet.Cmdlets.NewAzFleetMember_CreateViaIdentityFleetExpanded Clone()
        {
            var clone = new NewAzFleetMember_CreateViaIdentityFleetExpanded();
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.Events.Progress:
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzFleetMember_CreateViaIdentityFleetExpanded" /> cmdlet class.
        /// </summary>
        public NewAzFleetMember_CreateViaIdentityFleetExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'FleetMembersCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                Pipeline = Microsoft.Azure.PowerShell.Cmdlets.Fleet.Module.Instance.CreatePipeline(InvocationInformation, __correlationId, __processRecordId, this.ParameterSetName, this.ExtensibleParameters);
                ...
                try
                {
                    ...
                    if (FleetInputObject?.Id != null)
                    {
                        this.FleetInputObject.Id += $"/members/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.FleetMembersCreateViaIdentity(FleetInputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, this.InvocationInformation.BoundParameters.ContainsKey("IfNoneMatch") ? IfNoneMatch : null, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == FleetInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("FleetInputObject has null value for FleetInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, FleetInputObject) );
                        }
                        if (null == FleetInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("FleetInputObject has null value for FleetInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, FleetInputObject) );
                        }
                        if (null == FleetInputObject.FleetName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("FleetInputObject has null value for FleetInputObject.FleetName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, FleetInputObject) );
                        }
                        await this.Client.FleetMembersCreate(FleetInputObject.SubscriptionId ?? null, FleetInputObject.ResourceGroupName ?? null, FleetInputObject.FleetName ?? null, Name, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, this.InvocationInformation.BoundParameters.ContainsKey("IfNoneMatch") ? IfNoneMatch : null, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.SerializationMode.IncludeCreate);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IErrorResponse>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IFleetMember> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IFleetMember
