            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (FleetInputObject?.Id != null)
                    {
                        ...
                        await this.Client.UpdateRunsCreateOrUpdateViaIdentity(FleetInputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, this.InvocationInformation.BoundParameters.ContainsKey("IfNoneMatch") ? IfNoneMatch : null, _resourceBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
