...
namespace Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Support.ProvisioningState Created = @"Created";

        public static Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
