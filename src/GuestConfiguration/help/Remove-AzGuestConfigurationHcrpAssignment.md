...
online version: https://docs.microsoft.com/powershell/module/az.guestconfiguration/remove-azguestconfigurationhcrpassignment
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzGuestConfigurationHcrpAssignment -GuestConfigurationAssignmentName <String> -MachineName <String>
...
### DeleteViaIdentity
```
Remove-AzGuestConfigurationHcrpAssignment -InputObject <IGuestConfigurationIdentity>
