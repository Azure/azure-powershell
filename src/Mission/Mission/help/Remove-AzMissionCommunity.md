...
online version: https://learn.microsoft.com/powershell/module/az.mission/remove-azmissioncommunity
schema: 2.0.0
---

# Remove-AzMissionCommunity
...
### Delete (Default)
```
Remove-AzMissionCommunity -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzMissionCommunity -InputObject <IMissionIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
