...
Invoke-AzMissionHandleEnclaveConnectionApprovalDeletion -EnclaveConnectionName <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] -ResourceRequestAction <String>
...
```
Invoke-AzMissionHandleEnclaveConnectionApprovalDeletion -EnclaveConnectionName <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] -Body <IApprovalDeletionCallbackRequest>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
