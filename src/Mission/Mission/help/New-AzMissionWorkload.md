...
online version: https://learn.microsoft.com/powershell/module/az.mission/new-azmissionworkload
schema: 2.0.0
---

# New-AzMissionWorkload
...
```
New-AzMissionWorkload -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -VirtualEnclaveName <String> -Location <String> [-ResourceGroupCollection <String[]>] [-Tag <Hashtable>]
...
```
New-AzMissionWorkload -Name <String> -VirtualEnclaveInputObject <IMissionIdentity> -Location <String>
