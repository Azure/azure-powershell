...
online version: https://learn.microsoft.com/powershell/module/az.mission/new-azmissionenclaveconnection
schema: 2.0.0
---

# New-AzMissionEnclaveConnection
...
```
New-AzMissionEnclaveConnection -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
