...
```
New-AzMissionCommunity -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] -Location <String>
 [-AddressSpace <String>] [-AddressSpaceList <String[]>] [-CommunityRoleAssignment <IRoleAssignmentItem[]>]
...
```
New-AzMissionCommunity -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
