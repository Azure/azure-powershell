...
online version: https://learn.microsoft.com/powershell/module/az.mission/remove-azmissionenclaveconnection
schema: 2.0.0
---

# Remove-AzMissionEnclaveConnection
...
### Delete (Default)
```
Remove-AzMissionEnclaveConnection -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzMissionEnclaveConnection -InputObject <IMissionIdentity> [-DefaultProfile <PSObject>] [-AsJob]
...
Deletes the `contoso-connection` enclave connection from the `mission-rg` resource group.
