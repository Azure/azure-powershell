...
```
Invoke-AzMissionHandleVirtualEnclaveApprovalDeletion -ResourceGroupName <String> [-SubscriptionId <String>]
 -VirtualEnclaveName <String> -ResourceRequestAction <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```
Invoke-AzMissionHandleVirtualEnclaveApprovalDeletion -ResourceGroupName <String> [-SubscriptionId <String>]
 -VirtualEnclaveName <String> -Body <IApprovalDeletionCallbackRequest> [-DefaultProfile <PSObject>] [-AsJob]
