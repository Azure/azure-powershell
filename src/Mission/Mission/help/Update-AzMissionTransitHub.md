...
```
Update-AzMissionTransitHub -Name <String> -CommunityInputObject <IMissionIdentity>
...
Update-AzMissionTransitHub -InputObject <IMissionIdentity> [-ParamRemoteVirtualNetworkId <String>]
 ...
 [-TransitOptionType <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaJsonString, UpdateViaJsonFilePath, UpdateViaIdentityCommunityExpanded
