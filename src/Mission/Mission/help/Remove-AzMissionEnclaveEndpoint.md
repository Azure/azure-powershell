...
online version: https://learn.microsoft.com/powershell/module/az.mission/remove-azmissionenclaveendpoint
schema: 2.0.0
---

# Remove-AzMissionEnclaveEndpoint
...
### Delete (Default)
```
Remove-AzMissionEnclaveEndpoint -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Remove-AzMissionEnclaveEndpoint -Name <String> -VirtualEnclaveInputObject <IMissionIdentity>
...
### DeleteViaIdentity
```
Remove-AzMissionEnclaveEndpoint -InputObject <IMissionIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
