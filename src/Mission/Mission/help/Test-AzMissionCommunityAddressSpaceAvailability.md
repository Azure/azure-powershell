...
Test-AzMissionCommunityAddressSpaceAvailability -CommunityName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -CommunityResourceId <String> [-EnclaveVirtualNetworkAllowSubnetCommunication]
...
```
Test-AzMissionCommunityAddressSpaceAvailability -CommunityName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -CheckAddressSpaceAvailabilityRequest <ICheckAddressSpaceAvailabilityRequest>
 [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Test-AzMissionCommunityAddressSpaceAvailability -InputObject <IMissionIdentity> -CommunityResourceId <String>
 ...
 [-EnclaveVirtualNetworkSubnetConfiguration <ISubnetConfiguration[]>] [-DefaultProfile <PSObject>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
