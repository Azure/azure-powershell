...
```
New-AzMissionTransitHub -Name <String> -CommunityName <String> -ResourceGroupName <String>
...
```
New-AzMissionTransitHub -Name <String> -CommunityInputObject <IMissionIdentity> -Location <String>
