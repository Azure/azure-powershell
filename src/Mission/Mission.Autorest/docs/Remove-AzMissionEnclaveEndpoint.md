...
### Delete (Default)
```
Remove-AzMissionEnclaveEndpoint -Name <String> -ResourceGroupName <String> -VirtualEnclaveName <String>
...
### DeleteViaIdentity
```
Remove-AzMissionEnclaveEndpoint -InputObject <IMissionIdentity> [-DefaultProfile <PSObject>] [-AsJob]
