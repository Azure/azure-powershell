...
### GetViaIdentity
```
Get-AzMissionTransitHub -InputObject <IMissionIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityCommunity
```
Get-AzMissionTransitHub -CommunityInputObject <IMissionIdentity> -Name <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
