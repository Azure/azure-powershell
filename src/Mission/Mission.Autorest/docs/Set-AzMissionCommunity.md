...
online version: https://learn.microsoft.com/powershell/module/az.mission/set-azmissioncommunity
schema: 2.0.0
---

# Set-AzMissionCommunity
...
```
Set-AzMissionCommunity -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### UpdateViaJsonString
```
Set-AzMissionCommunity -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
