...
### List (Default)
```
Get-AzMissionVirtualEnclave [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-AzMissionVirtualEnclave -InputObject <IMissionIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
