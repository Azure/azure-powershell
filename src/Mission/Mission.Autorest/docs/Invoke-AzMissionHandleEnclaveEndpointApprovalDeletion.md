...
Invoke-AzMissionHandleEnclaveEndpointApprovalDeletion -EnclaveEndpointName <String>
 -ResourceGroupName <String> -VirtualEnclaveName <String> -ResourceRequestAction <String>
...
```
Invoke-AzMissionHandleEnclaveEndpointApprovalDeletion -EnclaveEndpointName <String>
 -ResourceGroupName <String> -VirtualEnclaveName <String> -Body <IApprovalDeletionCallbackRequest>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Invoke-AzMissionHandleEnclaveEndpointApprovalDeletion -EnclaveEndpointName <String>
 -ResourceGroupName <String> -VirtualEnclaveName <String> -JsonFilePath <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-AzMissionHandleEnclaveEndpointApprovalDeletion -EnclaveEndpointName <String>
 -ResourceGroupName <String> -VirtualEnclaveName <String> -JsonString <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Parameter Sets: Handle, HandleViaIdentity, HandleViaIdentityVirtualEnclave
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Handle, HandleExpanded, HandleViaIdentityVirtualEnclave, HandleViaIdentityVirtualEnclaveExpanded, HandleViaJsonFilePath, HandleViaJsonString
Aliases:
...
```yaml
Type: System.String
Parameter Sets: HandleExpanded, HandleViaIdentityExpanded, HandleViaIdentityVirtualEnclaveExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Mission.Models.IMissionIdentity
Parameter Sets: HandleViaIdentityVirtualEnclave, HandleViaIdentityVirtualEnclaveExpanded
Aliases:
