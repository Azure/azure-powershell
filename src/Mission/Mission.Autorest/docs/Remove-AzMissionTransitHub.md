...
online version: https://learn.microsoft.com/powershell/module/az.mission/remove-azmissiontransithub
schema: 2.0.0
---

# Remove-AzMissionTransitHub
...
### Delete (Default)
```
Remove-AzMissionTransitHub -CommunityName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzMissionTransitHub -InputObject <IMissionIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentityCommunity
```
Remove-AzMissionTransitHub -CommunityInputObject <IMissionIdentity> -Name <String>
