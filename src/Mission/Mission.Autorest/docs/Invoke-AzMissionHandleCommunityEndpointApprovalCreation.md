...
Invoke-AzMissionHandleCommunityEndpointApprovalCreation -CommunityEndpointName <String>
 -CommunityName <String> -ResourceGroupName <String> -ApprovalStatus <String> -ResourceRequestAction <String>
...
```
Invoke-AzMissionHandleCommunityEndpointApprovalCreation -CommunityEndpointName <String>
 -CommunityName <String> -ResourceGroupName <String> -Body <IApprovalCallbackRequest>
...
```
Invoke-AzMissionHandleCommunityEndpointApprovalCreation -CommunityEndpointName <String>
 -CommunityName <String> -ResourceGroupName <String> -JsonFilePath <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-AzMissionHandleCommunityEndpointApprovalCreation -CommunityEndpointName <String>
 -CommunityName <String> -ResourceGroupName <String> -JsonString <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Parameter Sets: Handle, HandleViaIdentity, HandleViaIdentityCommunity
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Handle, HandleExpanded, HandleViaIdentityCommunity, HandleViaIdentityCommunityExpanded, HandleViaJsonFilePath, HandleViaJsonString
Aliases:
...
Parameter Sets: HandleViaIdentityCommunity, HandleViaIdentityCommunityExpanded
Aliases:
