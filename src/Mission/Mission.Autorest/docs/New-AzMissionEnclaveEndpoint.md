...
```
New-AzMissionEnclaveEndpoint -Name <String> -ResourceGroupName <String> -VirtualEnclaveName <String>
 -Location <String> [-SubscriptionId <String>] [-RuleCollection <IEnclaveEndpointDestinationRule[]>]
