...
online version: https://learn.microsoft.com/powershell/module/az.mission/remove-azmissiondedicatedhub
schema: 2.0.0
---

# Remove-AzMissionDedicatedHub
...
### Delete (Default)
```
Remove-AzMissionDedicatedHub -CommunityName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzMissionDedicatedHub -InputObject <IMissionIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentityCommunity
```
Remove-AzMissionDedicatedHub -CommunityInputObject <IMissionIdentity> -Name <String>
...
Deletes the `contoso-dedicatedhub` dedicated hub from the `contoso-community` community.
