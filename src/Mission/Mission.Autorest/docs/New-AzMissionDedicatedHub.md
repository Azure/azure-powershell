...
```
New-AzMissionDedicatedHub -CommunityName <String> -Name <String> -ResourceGroupName <String>
...
```
New-AzMissionDedicatedHub -CommunityInputObject <IMissionIdentity> -Name <String> -Location <String>
 [-Designation <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
