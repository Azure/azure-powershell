...
```
Update-AzMissionEnclaveEndpoint -Name <String> -ResourceGroupName <String> -VirtualEnclaveName <String>
 [-SubscriptionId <String>] [-RuleCollection <IEnclaveEndpointDestinationRule[]>] [-Tag <Hashtable>]
