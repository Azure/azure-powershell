...
online version: https://learn.microsoft.com/powershell/module/az.mission/update-azmissioncommunityendpoint
schema: 2.0.0
---

# Update-AzMissionCommunityEndpoint
...
```
Update-AzMissionCommunityEndpoint -CommunityName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-RuleCollection <ICommunityEndpointDestinationRule[]>] [-Tag <Hashtable>]
 [-UpdateMode <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityCommunityExpanded
```
Update-AzMissionCommunityEndpoint -CommunityInputObject <IMissionIdentity> -Name <String>
 [-RuleCollection <ICommunityEndpointDestinationRule[]>] [-Tag <Hashtable>] [-UpdateMode <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzMissionCommunityEndpoint -InputObject <IMissionIdentity>
 [-RuleCollection <ICommunityEndpointDestinationRule[]>] [-Tag <Hashtable>] [-UpdateMode <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Parameter Sets: UpdateViaIdentityCommunityExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityCommunityExpanded, UpdateViaJsonFilePath, UpdateViaJsonString
...
Parameter Sets: UpdateExpanded, UpdateViaIdentityCommunityExpanded, UpdateViaIdentityExpanded
Aliases:
