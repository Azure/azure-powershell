...
online version: https://learn.microsoft.com/powershell/module/az.mission/get-azmissionenclaveconnection
schema: 2.0.0
---

# Get-AzMissionEnclaveConnection
...
### List (Default)
```
Get-AzMissionEnclaveConnection [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzMissionEnclaveConnection -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMissionEnclaveConnection -InputObject <IMissionIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### List1
```
Get-AzMissionEnclaveConnection -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
