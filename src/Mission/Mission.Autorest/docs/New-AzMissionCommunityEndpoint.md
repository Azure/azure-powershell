...
```
New-AzMissionCommunityEndpoint -CommunityName <String> -Name <String> -ResourceGroupName <String>
...
```
New-AzMissionCommunityEndpoint -CommunityInputObject <IMissionIdentity> -Name <String> -Location <String>
