...
```
Update-AzMissionApproval -Name <String> -ResourceUri <String> [-Approver <IApprover[]>]
 [-CreatedAt <DateTime>] [-GrandparentResourceId <String>] [-ParentResourceId <String>]
...
### UpdateViaJsonString
```
Update-AzMissionApproval -Name <String> -ResourceUri <String> -JsonString <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
