...
Set-AzMissionCommunityEndpoint -CommunityName <String> -Name <String> -ResourceGroupName <String>
 -Location <String> [-SubscriptionId <String>] [-RuleCollection <ICommunityEndpointDestinationRule[]>]
 [-Tag <Hashtable>] [-UpdateMode <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
