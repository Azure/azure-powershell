...
Invoke-AzMissionHandleCommunityEndpointApprovalDeletion -CommunityEndpointName <String>
 -CommunityName <String> -ResourceGroupName <String> -ResourceRequestAction <String>
...
```
Invoke-AzMissionHandleCommunityEndpointApprovalDeletion -CommunityEndpointName <String>
 -CommunityName <String> -ResourceGroupName <String> -Body <IApprovalDeletionCallbackRequest>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Invoke-AzMissionHandleCommunityEndpointApprovalDeletion -CommunityEndpointName <String>
 -CommunityInputObject <IMissionIdentity> -Body <IApprovalDeletionCallbackRequest>
...
```
Invoke-AzMissionHandleCommunityEndpointApprovalDeletion -CommunityEndpointName <String>
 -CommunityInputObject <IMissionIdentity> -ResourceRequestAction <String> [-DefaultProfile <PSObject>]
