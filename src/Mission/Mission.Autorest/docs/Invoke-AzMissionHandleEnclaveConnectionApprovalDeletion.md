...
online version: https://learn.microsoft.com/powershell/module/az.mission/invoke-azmissionhandleenclaveconnectionapprovaldeletion
schema: 2.0.0
---
...
```
Invoke-AzMissionHandleEnclaveConnectionApprovalDeletion -EnclaveConnectionName <String>
 -ResourceGroupName <String> -ResourceRequestAction <String> [-SubscriptionId <String>]
...
```
Invoke-AzMissionHandleEnclaveConnectionApprovalDeletion -EnclaveConnectionName <String>
 -ResourceGroupName <String> -Body <IApprovalDeletionCallbackRequest> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### HandleViaIdentity
```
Invoke-AzMissionHandleEnclaveConnectionApprovalDeletion -InputObject <IMissionIdentity>
