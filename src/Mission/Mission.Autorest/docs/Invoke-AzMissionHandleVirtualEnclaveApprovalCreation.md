...
```
Invoke-AzMissionHandleVirtualEnclaveApprovalCreation -ResourceGroupName <String> -VirtualEnclaveName <String>
 -ApprovalStatus <String> -ResourceRequestAction <String> [-SubscriptionId <String>]
 [-ApprovalCallbackPayload <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Invoke-AzMissionHandleVirtualEnclaveApprovalCreation -ResourceGroupName <String> -VirtualEnclaveName <String>
 -Body <IApprovalCallbackRequest> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
