...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.importexport/get-azoperation
#>
function Get-AzOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.Api20161101.IOperation])]
