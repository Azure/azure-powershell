...
```
Remove-AzTimeSeriesInsightsAccessPolicy -Name <String> -EnvironmentInputObject <ITimeSeriesInsightsIdentity>
...
### DeleteViaIdentity
```
Remove-AzTimeSeriesInsightsAccessPolicy -InputObject <ITimeSeriesInsightsIdentity> [-DefaultProfile <PSObject>]
