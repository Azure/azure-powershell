...
PARAMETER <IEventSourceCreateOrUpdateParameters>: Parameters supplied to the Create or Update Event Source operation.
  ...
  [LocalTimestampFormat <String>]: An enum that represents the format of the local timestamp property that needs to be set.
...
param(
    ...
    [Parameter(Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.TimeSeriesInsights.PSArgumentCompleterAttribute("Microsoft.EventHub", "Microsoft.IoTHub")]
