...
```
Update-AzTimeSeriesInsightsEventSource -EnvironmentInputObject <ITimeSeriesInsightsIdentity> -Name <String>
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityEnvironmentExpanded, UpdateViaJsonFilePath, UpdateViaJsonString
