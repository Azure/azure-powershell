...
function setupEnv() {
    ...
    $env.ResourceName = 'testorg4'
    $env.NewResourceName = 'test-mongodb-1'
    $env.PartnerPropertyOrganizationName = 'test-mongodb-1'
    $env.PartnerPropertyOrganizationId = '6825d3e6bb11af624c2baaef'
    ...
    $env.DeleteResourceName = "mongodbtest2"
    $envFile = 'env.json'
    if ($TestMode -eq 'live') {
