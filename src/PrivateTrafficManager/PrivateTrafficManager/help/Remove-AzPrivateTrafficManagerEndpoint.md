...
online version: https://learn.microsoft.com/powershell/module/az.privatetrafficmanager/remove-azprivatetrafficmanagerendpoint
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzPrivateTrafficManagerEndpoint -Name <String> -PrivateTrafficManagerProfileName <String>
...
```
Remove-AzPrivateTrafficManagerEndpoint -Name <String>
...
### DeleteViaIdentity
```
Remove-AzPrivateTrafficManagerEndpoint -InputObject <IPrivateTrafficManagerIdentity>
