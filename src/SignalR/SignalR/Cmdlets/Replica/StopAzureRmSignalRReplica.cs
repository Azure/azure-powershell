...
{
    [Cmdlet("Stop", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "SignalRReplica", SupportsShouldProcess = true, DefaultParameterSetName = ResourceGroupParameterSet)]
    [OutputType(typeof(PSReplicaResource))]
    public class StopAzureRmSignalRReplica : SignalRCmdletBase, ISignalRChildResource
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            RunCmdlet(() =>
            {
                ...
                if (ShouldProcess($"SignalR replica {ResourceGroupName}/{SignalRName}/{Name}", "stop"))
                {
                    ...
                    // Set ResourceStopped to "true" to stop the replica
                    replica.ResourceStopped = "true";
