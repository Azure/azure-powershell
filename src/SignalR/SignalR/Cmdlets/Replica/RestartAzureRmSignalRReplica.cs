...
{
    [Cmdlet("Restart", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "SignalRReplica", SupportsShouldProcess = true, DefaultParameterSetName = ResourceGroupParameterSet)]
    [OutputType(typeof(bool))]
    public class RestartAzureRmSignalRReplica : SignalRCmdletBase, ISignalRChildResource
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            RunCmdlet(() =>
            {
                ...
                if (ShouldProcess($"SignalR replica {ResourceGroupName}/{SignalRName}/{Name}", "restart"))
                {
                    Microsoft.Azure.Management.SignalR.SignalRReplicasOperationsExtensions.Restart(Client.SignalRReplicas, ResourceGroupName, SignalRName, Name);
