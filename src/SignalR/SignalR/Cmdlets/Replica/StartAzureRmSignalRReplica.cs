...
{
    [Cmdlet("Start", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "SignalRReplica", SupportsShouldProcess = true, DefaultParameterSetName = ResourceGroupParameterSet)]
    [OutputType(typeof(PSReplicaResource))]
    public class StartAzureRmSignalRReplica : SignalRCmdletBase, ISignalRChildResource
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            RunCmdlet(() =>
            {
                ...
                if (ShouldProcess($"SignalR replica {ResourceGroupName}/{SignalRName}/{Name}", "start"))
                {
                    ...
                    // Set ResourceStopped to "false" to start the replica
                    replica.ResourceStopped = "false";
