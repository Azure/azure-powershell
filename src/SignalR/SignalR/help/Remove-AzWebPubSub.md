...
online version: https://learn.microsoft.com/powershell/module/az.signalr/remove-azwebpubsub
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzWebPubSub -InputObject <IWebPubSubIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
