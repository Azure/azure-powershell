...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added cmdlets for managing custom domains: ''New-AzSignalRCustomDomain'', ''Get-AzSignalRCustomDomain'', ''Remove-AzSignalRCustomDomain'', ''Update-AzSignalRCustomDomain''
