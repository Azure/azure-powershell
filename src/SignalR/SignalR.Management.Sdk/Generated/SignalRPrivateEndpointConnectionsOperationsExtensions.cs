...
namespace Microsoft.Azure.Management.SignalR
{
    ...
    public static partial class SignalRPrivateEndpointConnectionsOperationsExtensions
    {
            ...
            /// Connection state
            /// </param>
            public static PrivateEndpointConnection Update(this ISignalRPrivateEndpointConnectionsOperations operations, string privateEndpointConnectionName, string resourceGroupName, string resourceName, PrivateEndpoint privateEndpoint = default(PrivateEndpoint), PrivateLinkServiceConnectionState privateLinkServiceConnectionState = default(PrivateLinkServiceConnectionState))
            {
                return operations.UpdateAsync(privateEndpointConnectionName, resourceGroupName, resourceName, privateEndpoint, privateLinkServiceConnectionState).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<PrivateEndpointConnection> UpdateAsync(this ISignalRPrivateEndpointConnectionsOperations operations, string privateEndpointConnectionName, string resourceGroupName, string resourceName, PrivateEndpoint privateEndpoint = default(PrivateEndpoint), PrivateLinkServiceConnectionState privateLinkServiceConnectionState = default(PrivateLinkServiceConnectionState), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.UpdateWithHttpMessagesAsync(privateEndpointConnectionName, resourceGroupName, resourceName, privateEndpoint, privateLinkServiceConnectionState, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
