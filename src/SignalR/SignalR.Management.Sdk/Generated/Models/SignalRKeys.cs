...
namespace Microsoft.Azure.Management.SignalR.Models
{
    ...
    public partial class SignalRKeys
    {
        ...
        /// <param name="primaryKey">The primary access key.
        /// </param>

        /// <param name="secondaryKey">The secondary access key.
        /// </param>

        /// <param name="primaryConnectionString">Connection string constructed via the primaryKey
        /// </param>

        /// <param name="secondaryConnectionString">Connection string constructed via the secondaryKey
        /// </param>
