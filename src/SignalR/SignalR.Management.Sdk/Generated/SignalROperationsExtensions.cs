...
namespace Microsoft.Azure.Management.SignalR
{
    ...
    public static partial class SignalROperationsExtensions
    {
            ...
            /// </param>
            public static NameAvailability CheckNameAvailability(this ISignalROperations operations, string location, string type, string name)
            {
                return operations.CheckNameAvailabilityAsync(location, type, name).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<NameAvailability> CheckNameAvailabilityAsync(this ISignalROperations operations, string location, string type, string name, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CheckNameAvailabilityWithHttpMessagesAsync(location, type, name, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// 'Secondary'
            /// </param>
            public static SignalRKeys RegenerateKey(this ISignalROperations operations, string resourceGroupName, string resourceName, string keyType = default(string))
            {
                return operations.RegenerateKeyAsync(resourceGroupName, resourceName, keyType).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SignalRKeys> RegenerateKeyAsync(this ISignalROperations operations, string resourceGroupName, string resourceName, string keyType = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.RegenerateKeyWithHttpMessagesAsync(resourceGroupName, resourceName, keyType, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// 'Secondary'
            /// </param>
            public static SignalRKeys BeginRegenerateKey(this ISignalROperations operations, string resourceGroupName, string resourceName, string keyType = default(string))
            {
                return operations.BeginRegenerateKeyAsync(resourceGroupName, resourceName, keyType).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SignalRKeys> BeginRegenerateKeyAsync(this ISignalROperations operations, string resourceGroupName, string resourceName, string keyType = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginRegenerateKeyWithHttpMessagesAsync(resourceGroupName, resourceName, keyType, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
