...
online version: https://learn.microsoft.com/powershell/module/az.computefleet/new-azcomputefleetorganization
schema: 2.0.0
---

# New-AzComputeFleetOrganization
...
```
New-AzComputeFleetOrganization -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
