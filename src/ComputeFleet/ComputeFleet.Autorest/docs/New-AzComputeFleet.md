...
```
New-AzComputeFleet -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
 ...
 [-DataDiskCountMax <Int32>] [-DataDiskCountMin <Int32>] [-EnableSystemAssignedIdentity]
...
```
New-AzComputeFleet -InputObject <IComputeFleetIdentity> -Location <String> [-AcceleratorCountMax <Int32>]
...
```
New-AzComputeFleet -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### CreateViaJsonString
```
New-AzComputeFleet -Name <String> -ResourceGroupName <String> -JsonString <String> [-SubscriptionId <String>]
