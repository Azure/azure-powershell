...
online version: https://learn.microsoft.com/powershell/module/az.computefleet/remove-azcomputefleetorganization
schema: 2.0.0
---

# Remove-AzComputeFleetOrganization
...
### Delete (Default)
```
Remove-AzComputeFleetOrganization -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzComputeFleetOrganization -InputObject <IComputeFleetIdentity> [-DefaultProfile <PSObject>] [-AsJob]
