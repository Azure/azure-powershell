...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"Fleet_Update", SupportsShouldProcess = true)]
    ...
    public partial class UpdateFleet_Update : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IFleetUpdate _properties;
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IFleetUpdate) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IFleetUpdate Properties { get => this._properties; set => this._properties = value; }
        ...
        /// <returns>a duplicate instance of UpdateFleet_Update</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Cmdlets.UpdateFleet_Update Clone()
        {
            var clone = new UpdateFleet_Update();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FleetsUpdate(SubscriptionId, ResourceGroupName, FleetName, Properties, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,FleetName=FleetName,body=Properties})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateFleet_Update" /> cmdlet class.
        /// </summary>
        public UpdateFleet_Update()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, FleetName=FleetName, body=Properties })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, FleetName=FleetName, body=Properties })
                    {
