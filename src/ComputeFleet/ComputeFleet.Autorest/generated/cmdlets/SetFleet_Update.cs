...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"Fleet_Update", SupportsShouldProcess = true)]
    ...
    public partial class SetFleet_Update : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of SetFleet_Update</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Cmdlets.SetFleet_Update Clone()
        {
            var clone = new SetFleet_Update();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FleetsCreateOrUpdate(SubscriptionId, ResourceGroupName, FleetName, Resource, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,FleetName=FleetName,body=Resource})
                    {
        ...
        /// <summary>Intializes a new instance of the <see cref="SetFleet_Update" /> cmdlet class.</summary>
        public SetFleet_Update()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, FleetName=FleetName, body=Resource })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, FleetName=FleetName, body=Resource })
                    {
