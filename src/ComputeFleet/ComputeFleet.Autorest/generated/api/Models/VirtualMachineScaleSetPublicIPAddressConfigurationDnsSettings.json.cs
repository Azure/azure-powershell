...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models
{
    ...
    public partial class VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettings
    {
        ...
        internal VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettings(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_domainNameLabel = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("domainNameLabel"), out var __jsonDomainNameLabel) ? (string)__jsonDomainNameLabel : (string)DomainNameLabel;}
            {_domainNameLabelScope = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("domainNameLabelScope"), out var __jsonDomainNameLabelScope) ? (string)__jsonDomainNameLabelScope : (string)DomainNameLabelScope;}
            AfterFromJson(json);
        }
    }
}