...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models
{
    ...
    public partial class FleetProperties
    {
        ...
        internal FleetProperties(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_spotPriorityProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("spotPriorityProfile"), out var __jsonSpotPriorityProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.SpotPriorityProfile.FromJson(__jsonSpotPriorityProfile) : SpotPriorityProfile;}
            {_regularPriorityProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("regularPriorityProfile"), out var __jsonRegularPriorityProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.RegularPriorityProfile.FromJson(__jsonRegularPriorityProfile) : RegularPriorityProfile;}
            {_additionalLocationsProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("additionalLocationsProfile"), out var __jsonAdditionalLocationsProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.AdditionalLocationsProfile.FromJson(__jsonAdditionalLocationsProfile) : AdditionalLocationsProfile;}
            {_computeProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("computeProfile"), out var __jsonComputeProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.ComputeProfile.FromJson(__jsonComputeProfile) : ComputeProfile;}
            ...
            {_uniqueId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("uniqueId"), out var __jsonUniqueId) ? (string)__jsonUniqueId : (string)UniqueId;}
            {_vMAttributes = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("vmAttributes"), out var __jsonVMAttributes) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.VMAttributes.FromJson(__jsonVMAttributes) : VMAttributes;}
            AfterFromJson(json);
        }
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IFleetProperties.</returns>
