...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models
{
    ...
    public partial class ProxyAgentSettings
    {
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IProxyAgentSettings.</returns>
        ...
        internal ProxyAgentSettings(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_enabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonBoolean>("enabled"), out var __jsonEnabled) ? (bool?)__jsonEnabled : Enabled;}
            {_mode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("mode"), out var __jsonMode) ? (string)__jsonMode : (string)Mode;}
            {_keyIncarnationId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNumber>("keyIncarnationId"), out var __jsonKeyIncarnationId) ? (int?)__jsonKeyIncarnationId : KeyIncarnationId;}
            AfterFromJson(json);
        }
