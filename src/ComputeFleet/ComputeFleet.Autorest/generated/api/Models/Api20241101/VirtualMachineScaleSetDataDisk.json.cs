...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101
{
    ...
    public partial class VirtualMachineScaleSetDataDisk
    {
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IVirtualMachineScaleSetDataDisk.</returns>
        ...
        internal VirtualMachineScaleSetDataDisk(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_lun = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNumber>("lun"), out var __jsonLun) ? (int)__jsonLun : Lun;}
            ...
            {_diskIopsReadWrite = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNumber>("diskIOPSReadWrite"), out var __jsonDiskIopsReadWrite) ? (long?)__jsonDiskIopsReadWrite : DiskIopsReadWrite;}
            {_diskMBpsReadWrite = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNumber>("diskMBpsReadWrite"), out var __jsonDiskMBpsReadWrite) ? (long?)__jsonDiskMBpsReadWrite : DiskMBpsReadWrite;}
