...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101
{
    ...
    public partial class DiffDiskSettings
    {
        ...
        internal DiffDiskSettings(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_option = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("option"), out var __jsonOption) ? (string)__jsonOption : (string)Option;}
            {_placement = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("placement"), out var __jsonPlacement) ? (string)__jsonPlacement : (string)Placement;}
            AfterFromJson(json);
        }
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IDiffDiskSettings.</returns>
