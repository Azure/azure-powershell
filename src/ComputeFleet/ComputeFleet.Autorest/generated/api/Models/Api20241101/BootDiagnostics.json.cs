...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101
{
    ...
    public partial class BootDiagnostics
    {
        ...
        internal BootDiagnostics(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_storageUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("storageUri"), out var __jsonStorageUri) ? (string)__jsonStorageUri : (string)StorageUri;}
            AfterFromJson(json);
        }
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IBootDiagnostics.</returns>
