...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IWindowsConfigurationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IAdditionalUnattendContent[] _additionalUnattendContent;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IAdditionalUnattendContent[] AdditionalUnattendContent { get => this._additionalUnattendContent; set => this._additionalUnattendContent = value; }
        ...
        public bool? AutomaticByPlatformSettingBypassPlatformSafetyChecksOnUserSchedule { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IPatchSettingsInternal)PatchSettings).AutomaticByPlatformSettingBypassPlatformSafetyChecksOnUserSchedule; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IPatchSettingsInternal)PatchSettings).AutomaticByPlatformSettingBypassPlatformSafetyChecksOnUserSchedule = value ?? default(bool); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Support.WindowsPatchAssessmentMode? PatchSettingAssessmentMode { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IPatchSettingsInternal)PatchSettings).AssessmentMode; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IPatchSettingsInternal)PatchSettings).AssessmentMode = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Support.WindowsPatchAssessmentMode)""); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.PropertyOrigin.Inlined)]
        public bool? PatchSettingEnableHotpatching { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IPatchSettingsInternal)PatchSettings).EnableHotpatching; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IPatchSettingsInternal)PatchSettings).EnableHotpatching = value ?? default(bool); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Support.WindowsVMGuestPatchMode? PatchSettingPatchMode { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IPatchSettingsInternal)PatchSettings).PatchMode; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IPatchSettingsInternal)PatchSettings).PatchMode = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Support.WindowsVMGuestPatchMode)""); }

        /// <summary>Backing field for <see cref="PatchSettings" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IPatchSettings _patchSettings;

        /// <summary>[Preview Feature] Specifies settings related to VM Guest Patching on Windows.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IPatchSettings PatchSettings { get => (this._patchSettings = this._patchSettings ?? new Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.PatchSettings()); set => this._patchSettings = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IWindowsVMGuestPatchAutomaticByPlatformSettings Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IWindowsConfigurationInternal.PatchSettingAutomaticByPlatformSettings { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IPatchSettingsInternal)PatchSettings).AutomaticByPlatformSettings; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IPatchSettingsInternal)PatchSettings).AutomaticByPlatformSettings = value; }

        /// <summary>Internal Acessors for PatchSettings</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IPatchSettings Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IWindowsConfigurationInternal.PatchSettings { get => (this._patchSettings = this._patchSettings ?? new Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.PatchSettings()); set { {_patchSettings = value;} } }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IWinRmListener[] WinRmListeners { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IWinRmConfigurationInternal)WinRm).Listeners; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IWinRmConfigurationInternal)WinRm).Listeners = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IAdditionalUnattendContent[] AdditionalUnattendContent { get; set; }
        /// <summary>Enables customer to schedule patching without accidental upgrades</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        **AutomaticByPlatform** - The platform will trigger periodic patch assessments.
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Support.WindowsPatchAssessmentMode? PatchSettingAssessmentMode { get; set; }
        /// <summary>
        /// Enables customers to patch their Azure VMs without requiring a reboot. For
        /// enableHotpatching, the 'provisionVMAgent' must be set to true and 'patchMode'
        /// must be set to 'AutomaticByPlatform'.
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Support.WindowsVMGuestPatchMode? PatchSettingPatchMode { get; set; }
        /// <summary>
        /// Indicates whether virtual machine agent should be provisioned on the virtual
        /// machine. When this property is not specified in the request body, it is set to
        /// true by default. This will ensure that VM Agent is installed on the VM so that
...

    {
        ...
        /// Patching on Windows.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IWindowsVMGuestPatchAutomaticByPlatformSettings PatchSettingAutomaticByPlatformSettings { get; set; }
        /// <summary>
        /// Enables customers to patch their Azure VMs without requiring a reboot. For
        /// enableHotpatching, the 'provisionVMAgent' must be set to true and 'patchMode'
        /// must be set to 'AutomaticByPlatform'.
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Support.WindowsVMGuestPatchMode? PatchSettingPatchMode { get; set; }
        /// <summary>[Preview Feature] Specifies settings related to VM Guest Patching on Windows.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IPatchSettings PatchSettings { get; set; }
        /// <summary>
        /// Indicates whether virtual machine agent should be provisioned on the virtual
        /// machine. When this property is not specified in the request body, it is set to
        /// true by default. This will ensure that VM Agent is installed on the VM so that
