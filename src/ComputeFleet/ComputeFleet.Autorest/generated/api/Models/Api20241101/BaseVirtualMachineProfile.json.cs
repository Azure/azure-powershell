...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101
{
    ...
    public partial class BaseVirtualMachineProfile
    {
        ...
        internal BaseVirtualMachineProfile(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_networkProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("networkProfile"), out var __jsonNetworkProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.VirtualMachineScaleSetNetworkProfile.FromJson(__jsonNetworkProfile) : NetworkProfile;}
            {_securityProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("securityProfile"), out var __jsonSecurityProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.SecurityProfile.FromJson(__jsonSecurityProfile) : SecurityProfile;}
            {_diagnosticsProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("diagnosticsProfile"), out var __jsonDiagnosticsProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.DiagnosticsProfile.FromJson(__jsonDiagnosticsProfile) : DiagnosticsProfile;}
            {_extensionProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("extensionProfile"), out var __jsonExtensionProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.VirtualMachineScaleSetExtensionProfile.FromJson(__jsonExtensionProfile) : ExtensionProfile;}
            {_scheduledEventsProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("scheduledEventsProfile"), out var __jsonScheduledEventsProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.ScheduledEventsProfile.FromJson(__jsonScheduledEventsProfile) : ScheduledEventsProfile;}
            ...
            {_applicationProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("applicationProfile"), out var __jsonApplicationProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.ApplicationProfile.FromJson(__jsonApplicationProfile) : ApplicationProfile;}
            {_hardwareProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("hardwareProfile"), out var __jsonHardwareProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.VirtualMachineScaleSetHardwareProfile.FromJson(__jsonHardwareProfile) : HardwareProfile;}
            {_serviceArtifactReference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("serviceArtifactReference"), out var __jsonServiceArtifactReference) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.ServiceArtifactReference.FromJson(__jsonServiceArtifactReference) : ServiceArtifactReference;}
            {_securityPostureReference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("securityPostureReference"), out var __jsonSecurityPostureReference) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.SecurityPostureReference.FromJson(__jsonSecurityPostureReference) : SecurityPostureReference;}
            {_licenseType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("licenseType"), out var __jsonLicenseType) ? (string)__jsonLicenseType : (string)LicenseType;}
            {_userData = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("userData"), out var __jsonUserData) ? (string)__jsonUserData : (string)UserData;}
            ...
            {_oSProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("osProfile"), out var __jsonOSProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.VirtualMachineScaleSetOSProfile.FromJson(__jsonOSProfile) : OSProfile;}
            {_storageProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("storageProfile"), out var __jsonStorageProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.VirtualMachineScaleSetStorageProfile.FromJson(__jsonStorageProfile) : StorageProfile;}
            AfterFromJson(json);
        }
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IBaseVirtualMachineProfile.</returns>
