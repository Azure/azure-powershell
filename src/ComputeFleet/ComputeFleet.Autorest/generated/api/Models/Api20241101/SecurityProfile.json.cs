...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101
{
    ...
    public partial class SecurityProfile
    {
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.ISecurityProfile.</returns>
        ...
        internal SecurityProfile(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_uefiSettings = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("uefiSettings"), out var __jsonUefiSettings) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.UefiSettings.FromJson(__jsonUefiSettings) : UefiSettings;}
            {_encryptionIdentity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("encryptionIdentity"), out var __jsonEncryptionIdentity) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.EncryptionIdentity.FromJson(__jsonEncryptionIdentity) : EncryptionIdentity;}
            {_proxyAgentSettings = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("proxyAgentSettings"), out var __jsonProxyAgentSettings) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.ProxyAgentSettings.FromJson(__jsonProxyAgentSettings) : ProxyAgentSettings;}
            {_encryptionAtHost = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonBoolean>("encryptionAtHost"), out var __jsonEncryptionAtHost) ? (bool?)__jsonEncryptionAtHost : EncryptionAtHost;}
            {_securityType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("securityType"), out var __jsonSecurityType) ? (string)__jsonSecurityType : (string)SecurityType;}
            AfterFromJson(json);
        }
