...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models
{
    ...
    public partial class VMGalleryApplication
    {
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IVMGalleryApplication.</returns>
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._tags)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString(this._tags.ToString()) : null, "tags" ,container.Add );
        ...
        internal VMGalleryApplication(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_tags = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("tags"), out var __jsonTags) ? (string)__jsonTags : (string)Tags;}
            {_order = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNumber>("order"), out var __jsonOrder) ? (int?)__jsonOrder : Order;}
            {_packageReferenceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("packageReferenceId"), out var __jsonPackageReferenceId) ? (string)__jsonPackageReferenceId : (string)PackageReferenceId;}
            {_configurationReference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("configurationReference"), out var __jsonConfigurationReference) ? (string)__jsonConfigurationReference : (string)ConfigurationReference;}
            {_treatFailureAsDeploymentFailure = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonBoolean>("treatFailureAsDeploymentFailure"), out var __jsonTreatFailureAsDeploymentFailure) ? (bool?)__jsonTreatFailureAsDeploymentFailure : TreatFailureAsDeploymentFailure;}
