...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models
{
    ...
    public partial class VirtualMachineScaleSetPublicIPAddressConfigurationProperties
    {
        ...
        internal VirtualMachineScaleSetPublicIPAddressConfigurationProperties(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_dnsSettings = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("dnsSettings"), out var __jsonDnsSettings) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettings.FromJson(__jsonDnsSettings) : DnsSettings;}
            {_publicIPPrefix = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("publicIPPrefix"), out var __jsonPublicIPPrefix) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.SubResource.FromJson(__jsonPublicIPPrefix) : PublicIPPrefix;}
            {_idleTimeoutInMinutes = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNumber>("idleTimeoutInMinutes"), out var __jsonIdleTimeoutInMinutes) ? (int?)__jsonIdleTimeoutInMinutes : IdleTimeoutInMinutes;}
            ...
            {_publicIPAddressVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("publicIPAddressVersion"), out var __jsonPublicIPAddressVersion) ? (string)__jsonPublicIPAddressVersion : (string)PublicIPAddressVersion;}
