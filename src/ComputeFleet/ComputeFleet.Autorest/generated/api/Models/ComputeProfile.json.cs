...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models
{
    ...
    public partial class ComputeProfile
    {
        ...
        internal ComputeProfile(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_additionalVirtualMachineCapabilities = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("additionalVirtualMachineCapabilities"), out var __jsonAdditionalVirtualMachineCapabilities) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.AdditionalCapabilities.FromJson(__jsonAdditionalVirtualMachineCapabilities) : AdditionalVirtualMachineCapabilities;}
            {_computeApiVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("computeApiVersion"), out var __jsonComputeApiVersion) ? (string)__jsonComputeApiVersion : (string)ComputeApiVersion;}
            {_platformFaultDomainCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNumber>("platformFaultDomainCount"), out var __jsonPlatformFaultDomainCount) ? (int?)__jsonPlatformFaultDomainCount : PlatformFaultDomainCount;}
            {_baseVirtualMachineProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("baseVirtualMachineProfile"), out var __jsonBaseVirtualMachineProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.BaseVirtualMachineProfile.FromJson(__jsonBaseVirtualMachineProfile) : BaseVirtualMachineProfile;}
            AfterFromJson(json);
        }
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IComputeProfile.</returns>
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._additionalVirtualMachineCapabilities ? (Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode) this._additionalVirtualMachineCapabilities.ToJson(null,serializationMode) : null, "additionalVirtualMachineCapabilities" ,container.Add );
