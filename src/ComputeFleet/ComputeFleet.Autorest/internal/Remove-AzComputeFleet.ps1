...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ComputeFleet.private\Remove-AzComputeFleetOrganization_Delete';
            DeleteViaIdentity = 'Az.ComputeFleet.private\Remove-AzComputeFleetOrganization_DeleteViaIdentity';
        }
