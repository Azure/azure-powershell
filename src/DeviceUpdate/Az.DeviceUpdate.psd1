@{
  ...
  FunctionsToExport = 'Get-AzDeviceUpdateAccount', 'Get-AzDeviceUpdateInstance', 'Invoke-AzDeviceUpdateHeadAccount', 'Invoke-AzDeviceUpdateHeadInstance', 'New-AzDeviceUpdateAccount', 'New-AzDeviceUpdateCheckNameAvailabilityRequestObject', 'New-AzDeviceUpdateInstance', 'New-AzDeviceUpdateIotHubSettingsObject', 'Remove-AzDeviceUpdateAccount', 'Remove-AzDeviceUpdateInstance', 'Test-AzDeviceUpdateNameAvailability', 'Update-AzDeviceUpdateAccount', 'Update-AzDeviceUpdateInstance', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
