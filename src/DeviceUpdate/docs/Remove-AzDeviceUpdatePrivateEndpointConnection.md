...
online version: https://docs.microsoft.com/powershell/module/az.deviceupdate/remove-azdeviceupdateprivateendpointconnection
schema: 2.0.0
---

# Remove-AzDeviceUpdatePrivateEndpointConnection
...
### Delete (Default)
```
Remove-AzDeviceUpdatePrivateEndpointConnection -AccountName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzDeviceUpdatePrivateEndpointConnection -InputObject <IDeviceUpdateIdentity>
