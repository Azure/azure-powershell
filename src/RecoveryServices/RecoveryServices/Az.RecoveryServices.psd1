...
AliasesToExport = 'Get-AzRecoveryServicesBackupProperties', 
               ...
               'Get-AzRecoveryServicesAsrVaultSettings', 'New-ASRFabric', 'New-AsrInMageAzureV2DiskInput',
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Support for Cross subscription Azure to Azure site recovery.
