...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added Cross Region Restore for Azure File Share backup items through ''Get-AzRecoveryServicesBackupItem -UseSecondaryRegion'', ''Get-AzRecoveryServicesBackupRecoveryPoint -UseSecondaryRegion'', and ''Restore-AzRecoveryServicesBackupItem -RestoreToSecondaryRegion''.
