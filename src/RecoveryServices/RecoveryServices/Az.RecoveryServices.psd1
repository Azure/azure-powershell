...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed security issue with SQL restore, this is a necessary breaking change. TargetContainer becomes mandatory for Alternate Location Restore.
