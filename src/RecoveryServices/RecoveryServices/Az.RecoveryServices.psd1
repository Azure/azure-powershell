...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added Cross Region Restore support for Azure File Share backup items (''Get-AzRecoveryServicesBackupItem -UseSecondaryRegion'', ''Get-AzRecoveryServicesBackupRecoveryPoint -UseSecondaryRegion'', ''Restore-AzRecoveryServicesBackupItem -RestoreToSecondaryRegion'')
