...
AliasesToExport = 'Get-AzRecoveryServicesBackupProperties', 
               ...
               'New-ASRStorageClassificationMapping', 'New-ASRvCenter', 'New-ASRVMNicConfig', 
               ...
               'Remove-ASRServicesProvider', 'Remove-ASRReplicationProtectedItemDisk', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Azure Site Recovery change support for managed disk vms encrypted at rest with customer managed leys for Azure to Azure provider.
