...
```
Edit-AzRecoveryServicesBackupRetentionPolicyClientObject -Policy <IProtectionPolicy>
 -DatasourceType <DatasourceTypes> [-ModifyFullBackup] [-ModifyDifferentialBackup] [-ModifyIncrementalBackup]
 [-ModifyLogBackup] [-EnableDailyRetention <Boolean>] [-EnableWeeklyRetention <Boolean>]
 [-EnableMonthlyRetention <Boolean>] [-EnableYearlyRetention <Boolean>] [-DailyRetentionDurationInDays <Int32>]
 [-WeeklyRetentionDurationInWeeks <Int32>] [-WeeklyRetentionDaysOfTheWeek <String[]>]
 [-MonthlyRetentionScheduleType <String>] [-YearlyRetentionScheduleType <String>]
 [-MonthlyRetentionDurationInMonths <Int32>] [-MonthlyRetentionDaysOfTheMonth <Int32[]>]
 [-MonthlyRetentionIsLastDayIncluded <Boolean>] [-MonthlyRetentionDaysOfTheWeek <String[]>]
 [-MonthlyRetentionWeeksOfTheMonth <String[]>] [-YearlyRetentionDurationInYears <Int32>]
 [-YearlyRetentionMonthsOfTheYear <String[]>] [-YearlyRetentionDaysOfTheWeek <String[]>]
 [-YearlyRetentionDaysOfTheMonth <Int32[]>] [-YearlyRetentionIsLastDayIncluded <Boolean>]
 [-YearlyRetentionWeeksOfTheMonth <String[]>] [-DifferentialRetentionPeriodInDays <Int32>]
 [-IncrementalRetentionPeriodInDays <Int32>] [-LogRetentionPeriodInDays <Int32>] [<CommonParameters>]
```
