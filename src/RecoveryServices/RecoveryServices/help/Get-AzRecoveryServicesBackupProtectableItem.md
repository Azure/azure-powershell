...
This command will retrieve all protectable items within a certain container or across all registered containers. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
Get-AzRecoveryServicesBackupProtectableItem -Container $container -ItemType SQLDataBase -VaultId $vault.ID -WorkloadType AzureVM
```
