...
Edit-AzRecoveryServicesBackupSchedulePolicyClientObject -Policy <IProtectionPolicy>
 [-PolicySubType <PolicySubTypes>] [-HourlyInterval <Int32>] [-HourlyScheduleWindowDuration <Int32>]
 [-EnableLogBackup <Boolean>] [-LogBackupFrequencyInMin <Int32>] [-EnableDifferentialBackup <Boolean>]
 [-DifferentialRunDay <String[]>] [-DifferentialScheduleTime <String>] [-EnableIncrementalBackup <Boolean>]
 [-IncrementalRunDay <String[]>] [-IncrementalScheduleTime <String>] [-BackupFrequency <String>]
