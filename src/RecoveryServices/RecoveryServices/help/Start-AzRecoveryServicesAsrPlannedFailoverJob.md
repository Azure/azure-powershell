...
Starts a planned failover operation. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
Start-AzRecoveryServicesAsrPlannedFailoverJob -Direction PrimaryToRecovery -Optimize <> -ReplicationProtectedItem $ReplicationProtectedItem
```
