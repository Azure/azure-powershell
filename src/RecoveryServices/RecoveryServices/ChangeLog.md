...
-->
## Upcoming Release
* Azure Backup added support for Trusted VM backup and Enhanced policy for WorkloadType AzureVM.
* Added support for disable hybrid backup security features in Set-AzRecoveryServicesVaultProperty cmdlet, can be re-enabled by setting DisableHybridBackupSecurityFeature flag to $false.
