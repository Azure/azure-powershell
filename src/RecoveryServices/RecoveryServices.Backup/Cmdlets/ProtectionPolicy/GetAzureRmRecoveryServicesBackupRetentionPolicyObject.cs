...
namespace Microsoft.Azure.Commands.RecoveryServices.Backup.Cmdlets
{
    ...
    public class GetAzureRmRecoveryServicesBackupRetentionPolicyObject : RecoveryServicesBackupCmdletBase
    {
        ...
        /// </summary>
        private const string validBackupManagementTypes = "AzureVM, AzureSQL, AzureWorkload, AzureStorage";

        /// <summary>
        /// List of supported WorkloadTypes for this cmdlet. Used in help text creation.
        /// </summary>
        private const string validWorkloadTypes = "AzureVM, AzureSQLDatabase, AzureFiles, MSSQL";
