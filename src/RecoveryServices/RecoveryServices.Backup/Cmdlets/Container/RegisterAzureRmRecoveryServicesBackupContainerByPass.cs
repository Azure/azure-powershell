...
namespace Microsoft.Azure.Commands.RecoveryServices.Backup.Cmdlets
{
    ...
    /// </summary>
    [Cmdlet("Register", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "RecoveryServicesBackupContainerByPass", DefaultParameterSetName = RegisterParamSet, SupportsShouldProcess = true), OutputType(typeof(ContainerBase))]
    public class RegisterAzureRmRecoveryServicesBackupContainerByPass
        : RSBackupVaultCmdletBase
    {
        ...
        /// Azure Vm Id.
        /// </summary>
        [Parameter(Mandatory = true, Position = 0, ParameterSetName = RegisterParamSet, HelpMessage = ParamHelpMsgs.Container.ResourceId)]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 3, HelpMessage = "Use this parameter to decide to refresh or not to refresh protectable containers")]
            ...
            ExecutionBlock(() =>
            {
                ...
                ConfirmAction(
                    ...
                    containerName, () =>
                    {
                        ...
                        AzureWorkloadProviderHelper.RegisterContainerByPass(VaultId, vaultName, vaultResourceGroupName, ResourceId, Refresh);
