...
namespace Microsoft.Azure.Commands.RecoveryServices.Backup.Cmdlets
{
    ...
    /// </summary>
    [Cmdlet("Move", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "RecoveryServicesBackupRecoveryPoint"), OutputType(typeof(RecoveryPointBase))]
    public class MoveAzureRmRecoveryServicesBackupRecoveryPoint : RSBackupVaultCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ExecutionBlock(() =>
            {
                ...
                var moveRecoveryPointJob = MoveRecoveryPoint(providerParameters);
            });
        }

        private List<RecoveryPointBase> MoveRecoveryPoint(Dictionary<Enum, object> ProviderData)
        {
            ...
            // ServiceClientModel.MoveRPAcrossTiersRequestResource moveRPAcrossTiersRequestResource = new MoveRPAcrossTiersRequestResource();
            ...
            var response = ServiceClientAdapter.BmsAdapter.Client.BeginMoveRecoveryPointWithHttpMessagesAsync(
                vaultName,
                resourceGroupName,
                "Azure", // Add actual fabric name 
                containerUri,
                protectedItemName,
                recoveryPointId,
