...
namespace Microsoft.Azure.Commands.RecoveryServices.Backup.Cmdlets
{
    ...
    internal static class ParamHelpMsgs
    {
        ...
        internal static class Encryption
        {
            ...
            public const string CVMOsDiskEncryptionSetId = "Disk Encryption Set Id to be used for OS disk encryption of Confidential VMs. This is applicable only for secured VMs with managed disks.";
        }
