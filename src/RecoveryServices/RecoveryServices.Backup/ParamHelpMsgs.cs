...
namespace Microsoft.Azure.Commands.RecoveryServices.Backup.Cmdlets
{
    ...
    internal static class ParamHelpMsgs
    {
        ...
        internal static class RestoreFS
        {
            ...
            public const string MultipleSourceFilePaths = "Used for Multiple files restore from a file share. The paths of the items to be restored within the file share.";
        }
