...
namespace Microsoft.Azure.Commands.RecoveryServices.Backup.Cmdlets.Models
{
    ...
    public class AzureWorkloadSQLDatabaseProtectedItem : AzureItem
    {
        ...
        /// </summary>
        public ErrorDetailAutoGenerated LastBackupErrorDetail { get; set; }
            ...
            : base(protectedItemResource, containerName, containerType, policyName)
        {
            ...
            {
                LastBackupErrorDetail = new ErrorDetailAutoGenerated(protectedItem.LastBackupErrorDetail.Code, protectedItem.LastBackupErrorDetail.Message, protectedItem.LastBackupErrorDetail.Recommendations);
            }            
