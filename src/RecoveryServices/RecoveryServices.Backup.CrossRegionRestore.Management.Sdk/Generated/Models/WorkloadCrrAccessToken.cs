...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.CrossRegionRestore.Models
{
    ...
    public partial class WorkloadCrrAccessToken : CrrAccessToken
    {
        ...
        /// Gets or sets
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "protectableObjectUniqueName")]
        public string ProtectableObjectUniqueName {get; set; }

        /// <summary>
        /// Gets or sets
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "protectableObjectFriendlyName")]
        public string ProtectableObjectFriendlyName {get; set; }

        /// <summary>
        /// Gets or sets
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "protectableObjectWorkloadType")]
        public string ProtectableObjectWorkloadType {get; set; }

        /// <summary>
        /// Gets or sets
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "protectableObjectProtectionState")]
        public string ProtectableObjectProtectionState {get; set; }

        /// <summary>
        /// Gets or sets
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "protectableObjectContainerHostOsName")]
        public string ProtectableObjectContainerHostOSName {get; set; }

        /// <summary>
        /// Gets or sets
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "protectableObjectParentLogicalContainerName")]
