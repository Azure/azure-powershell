...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.CrossRegionRestore.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the CrossRegionRestoreRequestResource class.
        /// </summary>
        ...
        /// <param name="properties">CrossRegionRestoreRequestResource properties
        /// </param>
        public CrossRegionRestoreRequestResource(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string eTag = default(string), CrossRegionRestoreRequest properties = default(CrossRegionRestoreRequest))
