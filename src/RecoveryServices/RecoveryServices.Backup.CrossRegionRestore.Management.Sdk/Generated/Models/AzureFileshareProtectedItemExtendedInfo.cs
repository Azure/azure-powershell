...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.CrossRegionRestore.Models
{
    ...
    public partial class AzureFileshareProtectedItemExtendedInfo
    {
        ...
        /// <param name="oldestRecoveryPoint">The oldest backup copy available for this item in the service.
        /// </param>

        /// <param name="recoveryPointCount">Number of available backup copies associated with this backup item.
        /// </param>

        /// <param name="policyState">Indicates consistency of policy object and policy applied to this backup
        /// item.
        /// </param>

        /// <param name="resourceState">Indicates the state of this resource. Possible values are from enum
        /// ResourceState {Invalid, Active, SoftDeleted, Deleted}
        /// </param>

        /// <param name="resourceStateSyncTime">The resource state sync time for this backup item.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets number of available backup copies associated with this backup
        /// item.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets indicates consistency of policy object and policy applied to
        /// this backup item.
        /// </summary>
        ...
        /// <summary>
        /// Gets indicates the state of this resource. Possible values are from enum
        /// ResourceState {Invalid, Active, SoftDeleted, Deleted}
        /// </summary>
