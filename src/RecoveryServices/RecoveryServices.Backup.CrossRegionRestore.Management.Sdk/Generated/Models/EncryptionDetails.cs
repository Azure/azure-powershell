...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.CrossRegionRestore.Models
{
    ...
    public partial class EncryptionDetails
    {
        ...
        /// <param name="encryptionEnabled">Identifies whether this backup copy represents an encrypted VM at the time
        /// of backup.
        /// </param>

        /// <param name="kekUrl">Key Url.
        /// </param>

        /// <param name="secretKeyUrl">Secret Url.
        /// </param>

        /// <param name="kekVaultId">ID of Key Vault where KEK is stored.
        /// </param>

        /// <param name="secretKeyVaultId">ID of Key Vault where Secret is stored.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets identifies whether this backup copy represents an encrypted VM
