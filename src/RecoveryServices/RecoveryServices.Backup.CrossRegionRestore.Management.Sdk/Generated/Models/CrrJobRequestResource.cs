...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.CrossRegionRestore.Models
{
    ...
    public partial class CrrJobRequestResource : Resource
    {
        ...
        /// <param name="properties">CrrJobRequestResource properties
        /// </param>
        public CrrJobRequestResource(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string eTag = default(string), CrrJobRequest properties = default(CrrJobRequest))
