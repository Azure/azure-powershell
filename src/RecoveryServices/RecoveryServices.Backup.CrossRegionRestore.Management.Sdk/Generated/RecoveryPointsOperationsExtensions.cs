...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.CrossRegionRestore
{
    ...
    public static partial class RecoveryPointsOperationsExtensions
    {
        ...
        {
                return ((IRecoveryPointsOperations)operations).GetAccessTokenAsync(vaultName, resourceGroupName, fabricName, containerName, protectedItemName, recoveryPointId, parameters).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<CrrAccessTokenResource> GetAccessTokenAsync(this IRecoveryPointsOperations operations, string vaultName, string resourceGroupName, string fabricName, string containerName, string protectedItemName, string recoveryPointId, AADPropertiesResource parameters, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
