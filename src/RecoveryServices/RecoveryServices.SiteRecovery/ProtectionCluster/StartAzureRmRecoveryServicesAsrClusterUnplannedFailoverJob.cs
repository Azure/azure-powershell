...
namespace Microsoft.Azure.Commands.RecoveryServices.SiteRecovery
{
    ...
    public class StartAzureRmRecoveryServicesAsrClusterUnplannedFailoverJob : SiteRecoveryCmdletBase
    {
        ...
        {
            List<string> clusterProtectedItemIds = 
            ...
            Parallel.ForEach(
                ...
                node =>
                {
                    List<RecoveryPoint> recoveryPoints = this.RecoveryServicesClient
                    ...
                    var sortedRecoveryPoints = recoveryPoints
                        .OrderByDescending(rp => rp.Properties.RecoveryPointTime).ToList();
