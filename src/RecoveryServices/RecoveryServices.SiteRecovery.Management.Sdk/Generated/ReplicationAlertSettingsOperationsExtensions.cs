...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery
{
    ...
    public static partial class ReplicationAlertSettingsOperationsExtensions
    {
            ...
            {
                return operations.CreateAsync(alertSettingName, properties).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Alert> CreateAsync(this IReplicationAlertSettingsOperations operations, string alertSettingName, ConfigureAlertRequestProperties properties = default(ConfigureAlertRequestProperties), CancellationToken cancellationToken = default(CancellationToken))
            {
