...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery
{
    ...
    /// </summary>
    internal partial class ReplicationEventsOperations : Microsoft.Rest.IServiceOperations<SiteRecoveryManagementClient>, IReplicationEventsOperations
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<EventModel>>> ListWithHttpMessagesAsync(string resourceGroupName, string resourceName, Microsoft.Rest.Azure.OData.ODataQuery<EventQueryParameter> odataQuery = default(Microsoft.Rest.Azure.OData.ODataQuery<EventQueryParameter>), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (odataQuery != null)
            {
                var _eventQueryParameter = odataQuery.ToString();
                if (!string.IsNullOrEmpty(_eventQueryParameter))
                {
                    _queryParameters.Add(_eventQueryParameter);
                }
            }
            if (this.Client.ApiVersion != null)
            {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<EventModel>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<EventModel>>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<EventModel>> GetWithHttpMessagesAsync(string resourceGroupName, string resourceName, string eventName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (eventName == null)
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "eventName");
            }
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<EventModel>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<EventModel>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (Newtonsoft.Json.JsonException ex)
                {
                    _httpRequest.Dispose();
