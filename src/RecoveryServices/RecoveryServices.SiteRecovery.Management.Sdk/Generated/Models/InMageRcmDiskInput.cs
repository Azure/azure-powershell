...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery.Models
{
    ...
    public partial class InMageRcmDiskInput
    {
        ...
        /// </param>
        public InMageRcmDiskInput(string diskId, string logStorageAccountId, string diskType, string diskEncryptionSetId = default(string), int? sectorSizeInBytes = default(int?))
