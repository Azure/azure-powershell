...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery.Models
{
    ...
    public partial class DataStore
    {
        ...
        /// <param name="symbolicName">The symbolic name of data store.
        /// </param>

        /// <param name="uuid">The uuid of data store.
        /// </param>

        /// <param name="capacity">The capacity of data store in GBs.
        /// </param>

        /// <param name="freeSpace">The free space of data store in GBs.
        /// </param>

        /// <param name="type">The type of data store.
        /// </param>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "freeSpace")]
