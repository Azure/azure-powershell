...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery.Models
{
    ...
    public partial class DiskEncryptionInfo
    {
        ...
        /// <param name="diskEncryptionKeyInfo">The recovery KeyVault reference for secret.
        /// </param>

        /// <param name="keyEncryptionKeyInfo">The recovery KeyVault reference for key.
        /// </param>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "diskEncryptionKeyInfo")]
        public DiskEncryptionKeyInfo DiskEncryptionKeyInfo {get; set; }

        /// <summary>
        /// Gets or sets the recovery KeyVault reference for key.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "keyEncryptionKeyInfo")]
