...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery.Models
{
    ...
    public partial class InMageRcmApplianceDetails
    {
        ...
        /// <param name="id">The appliance Id.
        /// </param>

        /// <param name="name">The appliance name.
        /// </param>

        /// <param name="fabricArmId">The fabric ARM Id.
        /// </param>

        /// <param name="processServer">The process server.
        /// </param>

        /// <param name="rcmProxy">The of RCM proxy.
        /// </param>

        /// <param name="pushInstaller">The push installer.
        /// </param>

        /// <param name="replicationAgent">The replication agent.
        /// </param>

        /// <param name="reprotectAgent">The reprotect agent.
        /// </param>

        /// <param name="marsAgent">The Mars agent.
        /// </param>

        /// <param name="dra">The DRA.
        /// </param>

        /// <param name="switchProviderBlockingErrorDetails">The switch provider blocking error information.
        /// </param>
        public InMageRcmApplianceDetails(string id = default(string), string name = default(string), string fabricArmId = default(string), ProcessServerDetails processServer = default(ProcessServerDetails), RcmProxyDetails rcmProxy = default(RcmProxyDetails), PushInstallerDetails pushInstaller = default(PushInstallerDetails), ReplicationAgentDetails replicationAgent = default(ReplicationAgentDetails), ReprotectAgentDetails reprotectAgent = default(ReprotectAgentDetails), MarsAgentDetails marsAgent = default(MarsAgentDetails), DraDetails dra = default(DraDetails), System.Collections.Generic.IList<InMageRcmFabricSwitchProviderBlockingErrorDetails> switchProviderBlockingErrorDetails = default(System.Collections.Generic.IList<InMageRcmFabricSwitchProviderBlockingErrorDetails>))

        {
            this.Id = id;
            this.Name = name;
            this.FabricArmId = fabricArmId;
            this.ProcessServer = processServer;
            this.RcmProxy = rcmProxy;
            this.PushInstaller = pushInstaller;
            this.ReplicationAgent = replicationAgent;
            this.ReprotectAgent = reprotectAgent;
        ...
        public System.Collections.Generic.IList<InMageRcmFabricSwitchProviderBlockingErrorDetails> SwitchProviderBlockingErrorDetails {get; private set; }
    }
}