...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery.Models
{
    ...
    public partial class ReplicationAgentDetails
    {
        ...
        /// <param name="id">The replication agent Id.
        /// </param>

        /// <param name="name">The replication agent name.
        /// </param>

        /// <param name="biosId">The replication agent Bios Id.
        /// </param>

        /// <param name="fabricObjectId">The fabric object Id.
        /// </param>

        /// <param name="fqdn">The replication agent Fqdn.
        /// </param>

        /// <param name="version">The version.
        /// </param>

        /// <param name="lastHeartbeatUtc">The last heartbeat received from the replication agent.
        /// </param>

        /// <param name="health">The health of the replication agent.
        /// Possible values include: 'None', 'Normal', 'Warning', 'Critical'</param>

        /// <param name="healthErrors">The health errors.
        /// </param>
        public ReplicationAgentDetails(string id = default(string), string name = default(string), string biosId = default(string), string fabricObjectId = default(string), string fqdn = default(string), string version = default(string), System.DateTime? lastHeartbeatUtc = default(System.DateTime?), string health = default(string), System.Collections.Generic.IList<HealthError> healthErrors = default(System.Collections.Generic.IList<HealthError>))
