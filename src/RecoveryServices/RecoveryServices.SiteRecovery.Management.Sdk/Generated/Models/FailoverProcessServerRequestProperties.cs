...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery.Models
{
    ...
    public partial class FailoverProcessServerRequestProperties
    {
        ...
        /// <param name="containerName">The container identifier.
        /// </param>

        /// <param name="sourceProcessServerId">The source process server.
        /// </param>

        /// <param name="targetProcessServerId">The new process server.
        /// </param>

        /// <param name="vmsToMigrate">The VMS to migrate.
        /// </param>

        /// <param name="updateType">A value for failover type. It can be systemlevel/serverlevel.
        /// </param>
        public FailoverProcessServerRequestProperties(string containerName = default(string), string sourceProcessServerId = default(string), string targetProcessServerId = default(string), System.Collections.Generic.IList<string> vmsToMigrate = default(System.Collections.Generic.IList<string>), string updateType = default(string))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "sourceProcessServerId")]
        public string SourceProcessServerId {get; set; }

        /// <summary>
        /// Gets or sets the new process server.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "targetProcessServerId")]
        ...
        /// <summary>
        /// Gets or sets a value for failover type. It can be systemlevel/serverlevel.
        /// </summary>
