...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery.Models
{
    ...
    public partial class InMageDiskDetails
    {
        ...
        /// <param name="diskSizeInMb">The disk size in MB.
        /// </param>

        /// <param name="diskType">Whether disk is system disk or data disk.
        /// </param>

        /// <param name="diskConfiguration">Whether disk is dynamic disk or basic disk.
        /// </param>

        /// <param name="volumeList">Volumes of the disk.
        /// </param>
        public InMageDiskDetails(string diskId = default(string), string diskName = default(string), string diskSizeInMb = default(string), string diskType = default(string), string diskConfiguration = default(string), System.Collections.Generic.IList<DiskVolumeDetails> volumeList = default(System.Collections.Generic.IList<DiskVolumeDetails>))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "diskSizeInMB")]
        ...
        public System.Collections.Generic.IList<DiskVolumeDetails> VolumeList {get; set; }
    }
}