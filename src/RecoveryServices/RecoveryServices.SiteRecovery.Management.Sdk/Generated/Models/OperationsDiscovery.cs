...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery.Models
{
    ...
    public partial class OperationsDiscovery
    {
        ...
        /// <param name="name">Name of the API. The name of the operation being performed on this
        ...
        /// <param name="display">Object type.
        /// </param>

        /// <param name="origin">Origin. The intended executor of the operation; governs the display of the
        /// operation in the RBAC UX and the audit logs UX. Default value is
        /// &#34;user,system&#34;.
        /// </param>

        /// <param name="properties">Properties. Reserved for future use.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets name of the API. The name of the operation being performed on
        ...
        /// <summary>
        /// Gets or sets origin. The intended executor of the operation; governs the
