...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery.Models
{
    ...
    public partial class InMageVolumeExclusionOptions
    {
        ...
        /// <param name="volumeLabel">The volume label. The disk having any volume with this label will be
        /// excluded from replication.
        /// </param>

        /// <param name="onlyExcludeIfSingleVolume">The value indicating whether to exclude multi volume disk or not. If a disk
        /// has multiple volumes and one of the volume has label matching with
        ...
        /// <summary>
        /// Gets or sets the volume label. The disk having any volume with this label
        /// will be excluded from replication.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "volumeLabel")]
        public string VolumeLabel {get; set; }

        /// <summary>
        /// Gets or sets the value indicating whether to exclude multi volume disk or
        /// not. If a disk has multiple volumes and one of the volume has label
        /// matching with VolumeLabel this disk will be excluded from replication if
        /// OnlyExcludeIfSingleVolume is false.
        /// </summary>
