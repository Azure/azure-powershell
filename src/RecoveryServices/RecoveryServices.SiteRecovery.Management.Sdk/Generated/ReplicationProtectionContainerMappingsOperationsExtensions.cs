...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery
{
    ...
    public static partial class ReplicationProtectionContainerMappingsOperationsExtensions
    {
            ...
            {
                return operations.CreateAsync(fabricName, protectionContainerName, mappingName, properties).GetAwaiter().GetResult();
            }
            ...
            {
                return operations.UpdateAsync(fabricName, protectionContainerName, mappingName, properties).GetAwaiter().GetResult();
            }
            ...
            {
                operations.DeleteAsync(fabricName, protectionContainerName, mappingName, properties).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task DeleteAsync(this IReplicationProtectionContainerMappingsOperations operations, string fabricName, string protectionContainerName, string mappingName, RemoveProtectionContainerMappingInputProperties properties = default(RemoveProtectionContainerMappingInputProperties), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.BeginCreateAsync(fabricName, protectionContainerName, mappingName, properties).GetAwaiter().GetResult();
            }
            ...
            {
                return operations.BeginUpdateAsync(fabricName, protectionContainerName, mappingName, properties).GetAwaiter().GetResult();
            }
            ...
            {
                operations.BeginDeleteAsync(fabricName, protectionContainerName, mappingName, properties).GetAwaiter().GetResult();
            }
