...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery
{
    ...
    public static partial class ReplicationProtectionIntentsOperationsExtensions
    {
            ...
            {
                return operations.CreateAsync(intentObjectName, properties).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ReplicationProtectionIntent> CreateAsync(this IReplicationProtectionIntentsOperations operations, string intentObjectName, CreateProtectionIntentProperties properties = default(CreateProtectionIntentProperties), CancellationToken cancellationToken = default(CancellationToken))
            {
