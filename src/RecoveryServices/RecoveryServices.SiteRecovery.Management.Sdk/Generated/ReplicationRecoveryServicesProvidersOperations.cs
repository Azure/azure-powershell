...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery
{
    ...
    internal partial class ReplicationRecoveryServicesProvidersOperations : IServiceOperations<SiteRecoveryManagementClient>, IReplicationRecoveryServicesProvidersOperations
    {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<RecoveryServicesProvider>> CreateWithHttpMessagesAsync(string fabricName, string providerName, AddRecoveryServicesProviderInputProperties properties, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send Request
            AzureOperationResponse<RecoveryServicesProvider> _response = await BeginCreateWithHttpMessagesAsync(fabricName, providerName, properties, customHeaders, cancellationToken).ConfigureAwait(false);
