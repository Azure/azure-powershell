...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery
{
    ...
    public partial interface IReplicationAlertSettingsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<Alert>> CreateWithHttpMessagesAsync(string alertSettingName, ConfigureAlertRequestProperties properties = default(ConfigureAlertRequestProperties), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets the list of configured email notification(alert)
        /// configurations.
        /// </summary>
