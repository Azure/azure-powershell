...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery
{
    ...
    internal partial class ReplicationAlertSettingsOperations : IServiceOperations<SiteRecoveryManagementClient>, IReplicationAlertSettingsOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<Alert>> CreateWithHttpMessagesAsync(string alertSettingName, ConfigureAlertRequestProperties properties = default(ConfigureAlertRequestProperties), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
