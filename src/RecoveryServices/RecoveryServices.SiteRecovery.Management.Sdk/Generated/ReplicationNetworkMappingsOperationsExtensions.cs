...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery
{
    ...
    public static partial class ReplicationNetworkMappingsOperationsExtensions
    {
            ...
            {
                return operations.CreateAsync(fabricName, networkName, networkMappingName, properties).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<NetworkMapping> CreateAsync(this IReplicationNetworkMappingsOperations operations, string fabricName, string networkName, string networkMappingName, CreateNetworkMappingInputProperties properties, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.UpdateAsync(fabricName, networkName, networkMappingName, properties).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<NetworkMapping> UpdateAsync(this IReplicationNetworkMappingsOperations operations, string fabricName, string networkName, string networkMappingName, UpdateNetworkMappingInputProperties properties = default(UpdateNetworkMappingInputProperties), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.BeginCreateAsync(fabricName, networkName, networkMappingName, properties).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<NetworkMapping> BeginCreateAsync(this IReplicationNetworkMappingsOperations operations, string fabricName, string networkName, string networkMappingName, CreateNetworkMappingInputProperties properties, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.BeginUpdateAsync(fabricName, networkName, networkMappingName, properties).GetAwaiter().GetResult();
            }
