...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery
{
    ...
    public static partial class ReplicationRecoveryServicesProvidersOperationsExtensions
    {
            ...
            {
                return operations.CreateAsync(fabricName, providerName, properties).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<RecoveryServicesProvider> CreateAsync(this IReplicationRecoveryServicesProvidersOperations operations, string fabricName, string providerName, AddRecoveryServicesProviderInputProperties properties, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.BeginCreateAsync(fabricName, providerName, properties).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<RecoveryServicesProvider> BeginCreateAsync(this IReplicationRecoveryServicesProvidersOperations operations, string fabricName, string providerName, AddRecoveryServicesProviderInputProperties properties, CancellationToken cancellationToken = default(CancellationToken))
            {
