...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery
{
    ...
    public static partial class ReplicationStorageClassificationMappingsOperationsExtensions
    {
            ...
            {
                return operations.CreateAsync(fabricName, storageClassificationName, storageClassificationMappingName, properties).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<StorageClassificationMapping> CreateAsync(this IReplicationStorageClassificationMappingsOperations operations, string fabricName, string storageClassificationName, string storageClassificationMappingName, StorageMappingInputProperties properties = default(StorageMappingInputProperties), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.BeginCreateAsync(fabricName, storageClassificationName, storageClassificationMappingName, properties).GetAwaiter().GetResult();
            }
