...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    /// </summary>
    internal partial class BackupEnginesOperations : Microsoft.Rest.IServiceOperations<RecoveryServicesBackupClient>, IBackupEnginesOperations
    {
        /// <summary>
        ...
        /// </return>
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<BackupEngineBaseResource>>> ListWithHttpMessagesAsync(string vaultName, string resourceGroupName, Microsoft.Rest.Azure.OData.ODataQuery<BMSBackupEnginesQueryObject> odataQuery = default(Microsoft.Rest.Azure.OData.ODataQuery<BMSBackupEnginesQueryObject>), string skipToken = default(string), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (odataQuery != null)
            {
                var _bmsBackupEnginesQueryObject = odataQuery.ToString();
                if (!string.IsNullOrEmpty(_bmsBackupEnginesQueryObject))
                {
                    _queryParameters.Add(_bmsBackupEnginesQueryObject);
                }
            }
            if (this.Client.ApiVersion != null)
            {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<BackupEngineBaseResource>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<BackupEngineBaseResource>>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<BackupEngineBaseResource>> GetWithHttpMessagesAsync(string vaultName, string resourceGroupName, string backupEngineName, Microsoft.Rest.Azure.OData.ODataQuery<BMSBackupEngineQueryObject> odataQuery = default(Microsoft.Rest.Azure.OData.ODataQuery<BMSBackupEngineQueryObject>), string skipToken = default(string), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "backupEngineName");
            }
            ...
            if (odataQuery != null)
            {
                var _bmsBackupEngineQueryObject = odataQuery.ToString();
                if (!string.IsNullOrEmpty(_bmsBackupEngineQueryObject))
                {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<BackupEngineBaseResource>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<BackupEngineBaseResource>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (Newtonsoft.Json.JsonException ex)
                {
                    _httpRequest.Dispose();
