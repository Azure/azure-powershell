...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    internal partial class RestoresOperations : Microsoft.Rest.IServiceOperations<RecoveryServicesBackupClient>, IRestoresOperations
    {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationHeaderResponse<RestoresTriggerHeaders> _response = await BeginTriggerWithHttpMessagesAsync(resourceGroupName, vaultName, fabricName, containerName, protectedItemName, recoveryPointId, parameters, xMsAuthorizationAuxiliary, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationHeaderResponse<RestoresTriggerHeaders>> BeginTriggerWithHttpMessagesAsync(string resourceGroupName, string vaultName, string fabricName, string containerName, string protectedItemName, string recoveryPointId, RestoreRequestResource parameters, string xMsAuthorizationAuxiliary = default(string), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationHeaderResponse<RestoresTriggerHeaders>();
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<RestoresTriggerHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
