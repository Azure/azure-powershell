...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    /// </summary>
    internal partial class ConfigureSourceScanOperations : Microsoft.Rest.IServiceOperations<RecoveryServicesBackupClient>, IConfigureSourceScanOperations
    {
        /// <summary>
        /// Initializes a new instance of the ConfigureSourceScanOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ConfigureSourceScanOperations (RecoveryServicesBackupClient client)
        {
            if (client == null) 
            {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<OperationStatus,ConfigureSourceScanExecuteHeaders> _response = await BeginExecuteWithHttpMessagesAsync(resourceGroupName, vaultName, fabricName, containerName, protectedItemName, sourceScanAction, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<OperationStatus,ConfigureSourceScanExecuteHeaders>> BeginExecuteWithHttpMessagesAsync(string resourceGroupName, string vaultName, string fabricName, string containerName, string protectedItemName, string sourceScanAction = default(string), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            ProtectedItemConfigureSourceScanRequest body = new ProtectedItemConfigureSourceScanRequest();
            if(sourceScanAction != null)
            {
                body.SourceScanAction = sourceScanAction;
            }
            // Tracing
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<OperationStatus,ConfigureSourceScanExecuteHeaders>();
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<ConfigureSourceScanExecuteHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
            catch (Newtonsoft.Json.JsonException ex)
            {
                _httpRequest.Dispose();
