...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class MabFileFolderProtectedItemExtendedInfo
    {
        ...
        /// <param name="lastRefreshedAt">Last time when the agent data synced to service.
        /// </param>

        /// <param name="oldestRecoveryPoint">The oldest backup copy available.
        /// </param>

        /// <param name="recoveryPointCount">Number of backup copies associated with the backup item.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets number of backup copies associated with the backup item.
        /// </summary>
