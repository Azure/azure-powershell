...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class AzureBackupServerContainer : DpmContainer
    {
        ...
        : base(friendlyName, backupManagementType, registrationStatus, healthStatus, protectableObjectType, sourceLocation, canReRegister, containerId, protectedItemCount, dpmAgentVersion, dpmServers, upgradeAvailable, protectionStatus, extendedInfo)
        {
            CustomInit();
        }
