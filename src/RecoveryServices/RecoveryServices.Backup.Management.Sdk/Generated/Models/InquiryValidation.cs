...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class InquiryValidation
    {
        ...
        /// </param>
        public InquiryValidation(string status = default(string), ErrorDetailAutoGenerated errorDetail = default(ErrorDetailAutoGenerated), string additionalDetail = default(string), object protectableItemCount = default(object))
