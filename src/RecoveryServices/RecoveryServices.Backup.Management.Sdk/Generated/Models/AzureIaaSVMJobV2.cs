...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("AzureIaaSVMJobV2")]
    public partial class AzureIaaSVMJobV2 : Job
    {
        ...
        /// </param>
        public AzureIaaSVMJobV2(string entityFriendlyName = default(string), string backupManagementType = default(string), string operation = default(string), string status = default(string), System.DateTime? startTime = default(System.DateTime?), System.DateTime? endTime = default(System.DateTime?), string activityId = default(string), System.Collections.Generic.IList<JobSupportedAction?> actionsInfo = default(System.Collections.Generic.IList<JobSupportedAction?>), string containerName = default(string), System.TimeSpan? duration = default(System.TimeSpan?), System.Collections.Generic.IList<AzureIaaSVMErrorInfo> errorDetails = default(System.Collections.Generic.IList<AzureIaaSVMErrorInfo>), string virtualMachineVersion = default(string), AzureIaaSVMJobExtendedInfo extendedInfo = default(AzureIaaSVMJobExtendedInfo))
