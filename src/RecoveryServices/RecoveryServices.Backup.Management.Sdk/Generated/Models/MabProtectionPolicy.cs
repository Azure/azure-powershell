...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class MabProtectionPolicy : ProtectionPolicy
    {
        ...
        /// <param name="schedulePolicy">Backup schedule of backup policy.
        /// </param>

        /// <param name="retentionPolicy">Retention policy details.
        /// </param>
        public MabProtectionPolicy(int? protectedItemsCount = default(int?), System.Collections.Generic.IList<string> resourceGuardOperationRequests = default(System.Collections.Generic.IList<string>), SchedulePolicy schedulePolicy = default(SchedulePolicy), RetentionPolicy retentionPolicy = default(RetentionPolicy))
