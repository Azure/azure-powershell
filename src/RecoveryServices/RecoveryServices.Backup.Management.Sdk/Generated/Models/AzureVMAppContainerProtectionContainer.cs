...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class AzureVMAppContainerProtectionContainer : AzureWorkloadContainer
    {
        ...
        : base(friendlyName, backupManagementType, registrationStatus, healthStatus, protectableObjectType, sourceLocation, sourceResourceId, lastUpdatedTime, extendedInfo, workloadType, operationType)
        {
            CustomInit();
        }
