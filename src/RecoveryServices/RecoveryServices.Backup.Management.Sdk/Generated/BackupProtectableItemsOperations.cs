...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    /// </summary>
    internal partial class BackupProtectableItemsOperations : Microsoft.Rest.IServiceOperations<RecoveryServicesBackupClient>, IBackupProtectableItemsOperations
    {
        /// <summary>
        /// Initializes a new instance of the BackupProtectableItemsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal BackupProtectableItemsOperations (RecoveryServicesBackupClient client)
        {
            if (client == null) 
            {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<WorkloadProtectableItemResource>>> ListWithHttpMessagesAsync(string vaultName, string resourceGroupName, Microsoft.Rest.Azure.OData.ODataQuery<BmspoQueryObject> odataQuery = default(Microsoft.Rest.Azure.OData.ODataQuery<BmspoQueryObject>), string skipToken = default(string), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (odataQuery != null)
            {
                var _bmspoQueryObject = odataQuery.ToString();
                if (!string.IsNullOrEmpty(_bmspoQueryObject))
                {
                    _queryParameters.Add(_bmspoQueryObject);
                }
            }
            if (this.Client.ApiVersion != null)
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<WorkloadProtectableItemResource>>(_responseContent, this.Client.DeserializationSettings);
                }
