...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.HealthStatus ActionRequired = @"ActionRequired";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.HealthStatus ActionSuggested = @"ActionSuggested";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.HealthStatus Invalid = @"Invalid";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.HealthStatus Passed = @"Passed";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.HealthStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.HealthStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.HealthStatus e1, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.HealthStatus e2)
        {
            return !e2.Equals(e1);
        }
