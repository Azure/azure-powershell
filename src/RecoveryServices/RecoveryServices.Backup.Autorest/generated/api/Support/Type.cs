...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.Type BackupProtectedItemCountSummary = @"BackupProtectedItemCountSummary";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.Type BackupProtectionContainerCountSummary = @"BackupProtectionContainerCountSummary";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.Type Invalid = @"Invalid";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.Type e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.Type e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.Type e1, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.Type e2)
        {
            return !e2.Equals(e1);
        }
