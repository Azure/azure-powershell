...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionState BackupsSuspended = @"BackupsSuspended";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionState Invalid = @"Invalid";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionState IrPending = @"IRPending";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionState Protected = @"Protected";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionState ProtectionError = @"ProtectionError";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionState ProtectionPaused = @"ProtectionPaused";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionState ProtectionStopped = @"ProtectionStopped";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionState e1, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionState e2)
        {
            return !e2.Equals(e1);
        }
