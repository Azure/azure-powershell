...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Register, @"AzRecoveryServicesProtectionContainer_Register", SupportsShouldProcess = true)]
    ...
    public partial class RegisterAzRecoveryServicesProtectionContainer_Register : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.IEventListener
    {
        ...
        /// <summary>Name of the container to be registered.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of the container to be registered.")]
        ...
        /// <summary>Fabric name associated with the container.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Fabric name associated with the container.")]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IProtectionContainerResource _parameter;

        /// <summary>
        /// Base class for container with backup items. Containers with specific workloads are derived from this class.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Base class for container with backup items. Containers with specific workloads are derived from this class.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IProtectionContainerResource) })]
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IProtectionContainerResource Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <returns>a duplicate instance of RegisterAzRecoveryServicesProtectionContainer_Register</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets.RegisterAzRecoveryServicesProtectionContainer_Register Clone()
        {
            var clone = new RegisterAzRecoveryServicesProtectionContainer_Register();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ProtectionContainersRegister(VaultName, ResourceGroupName, SubscriptionId, FabricName, ContainerName, Parameter, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  VaultName=VaultName,ResourceGroupName=ResourceGroupName,SubscriptionId=SubscriptionId,FabricName=FabricName,ContainerName=ContainerName,body=Parameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RegisterAzRecoveryServicesProtectionContainer_Register" /> cmdlet class.
        /// </summary>
        public RegisterAzRecoveryServicesProtectionContainer_Register()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { VaultName=VaultName, ResourceGroupName=ResourceGroupName, SubscriptionId=SubscriptionId, FabricName=FabricName, ContainerName=ContainerName, body=Parameter })
                    {
