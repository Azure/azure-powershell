...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzRecoveryServicesProtectionContainer_RefreshViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Description(@"Discovers all the containers in the subscription that can be backed up to Recovery Services Vault. This is an\r\nasynchronous operation. To know the status of the operation, call GetRefreshOperationResult API.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/refreshContainers", ApiVersion = "2023-02-01")]
    public partial class UpdateAzRecoveryServicesProtectionContainer_RefreshViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzRecoveryServicesProtectionContainer_RefreshViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets.UpdateAzRecoveryServicesProtectionContainer_RefreshViaIdentity Clone()
        {
            var clone = new UpdateAzRecoveryServicesProtectionContainer_RefreshViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ProtectionContainersRefreshViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ProtectionContainersRefresh(InputObject.VaultName ?? null, InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.FabricName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzRecoveryServicesProtectionContainer_RefreshViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzRecoveryServicesProtectionContainer_RefreshViaIdentity()
        {
