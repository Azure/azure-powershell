...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support";
