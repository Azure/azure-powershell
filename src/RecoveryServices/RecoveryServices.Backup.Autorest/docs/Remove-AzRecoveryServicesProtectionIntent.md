...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/remove-azrecoveryservicesprotectionintent
schema: 2.0.0
---

# Remove-AzRecoveryServicesProtectionIntent
...
### Delete (Default)
```
Remove-AzRecoveryServicesProtectionIntent -FabricName <String> -IntentObjectName <String>
...
### DeleteViaIdentity
```
Remove-AzRecoveryServicesProtectionIntent -InputObject <IRecoveryServicesIdentity>
