...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/start-azrecoveryservicesbackup
schema: 2.0.0
---

# Start-AzRecoveryServicesBackup
...
```
Start-AzRecoveryServicesBackup -ContainerName <String> -FabricName <String> -ProtectedItemName <String>
 -ResourceGroupName <String> -VaultName <String> [-SubscriptionId <String>] [-ETag <String>]
...
```
Start-AzRecoveryServicesBackup -ContainerName <String> -FabricName <String> -ProtectedItemName <String>
 -ResourceGroupName <String> -VaultName <String> -Parameter <IBackupRequestResource>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### TriggerViaIdentity
```
Start-AzRecoveryServicesBackup -InputObject <IRecoveryServicesIdentity> -Parameter <IBackupRequestResource>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### TriggerViaIdentityExpanded
```
Start-AzRecoveryServicesBackup -InputObject <IRecoveryServicesIdentity> [-ETag <String>] [-Location <String>]
 [-ObjectType <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IBackupRequestResource
...
### Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IBackupRequestResource
...
`PARAMETER <IBackupRequestResource>`: Base class for backup request. Workload-specific backup requests are derived from this class.
