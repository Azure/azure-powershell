...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesprivateendpointoperationstatus
schema: 2.0.0
---

# Get-AzRecoveryServicesPrivateEndpointOperationStatus
...
### Get (Default)
```
Get-AzRecoveryServicesPrivateEndpointOperationStatus -OperationId <String>
 -PrivateEndpointConnectionName <String> -ResourceGroupName <String> -VaultName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRecoveryServicesPrivateEndpointOperationStatus -InputObject <IRecoveryServicesIdentity>
