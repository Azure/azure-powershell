...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzRecoveryServicesReplicationProtectedItem_Create", SupportsShouldProcess = true)]
    ...
    public partial class NewAzRecoveryServicesReplicationProtectedItem_Create : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IEnableProtectionInput _input;

        /// <summary>Enable protection input.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Enable protection input.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Enable protection input.",
        SerializedName = @"input",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IEnableProtectionInput) })]
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IEnableProtectionInput Input { get => this._input; set => this._input = value; }
        ...
        /// <returns>a duplicate instance of NewAzRecoveryServicesReplicationProtectedItem_Create</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets.NewAzRecoveryServicesReplicationProtectedItem_Create Clone()
        {
            var clone = new NewAzRecoveryServicesReplicationProtectedItem_Create();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzRecoveryServicesReplicationProtectedItem_Create" /> cmdlet class.
        /// </summary>
        public NewAzRecoveryServicesReplicationProtectedItem_Create()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ReplicationProtectedItemsCreate(ResourceName, ResourceGroupName, SubscriptionId, FabricName, ProtectionContainerName, ReplicatedProtectedItemName, Input, onOk, this, Pipeline);
