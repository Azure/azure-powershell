...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzRecoveryServicesReplicationNetworkMapping_Create", SupportsShouldProcess = true)]
    ...
    public partial class NewAzRecoveryServicesReplicationNetworkMapping_Create : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.ICreateNetworkMappingInput _input;

        /// <summary>Create network mappings input.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Create network mappings input.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Create network mappings input.",
        SerializedName = @"input",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.ICreateNetworkMappingInput) })]
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.ICreateNetworkMappingInput Input { get => this._input; set => this._input = value; }
        ...
        /// <returns>a duplicate instance of NewAzRecoveryServicesReplicationNetworkMapping_Create</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets.NewAzRecoveryServicesReplicationNetworkMapping_Create Clone()
        {
            var clone = new NewAzRecoveryServicesReplicationNetworkMapping_Create();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzRecoveryServicesReplicationNetworkMapping_Create" /> cmdlet class.
        /// </summary>
        public NewAzRecoveryServicesReplicationNetworkMapping_Create()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ReplicationNetworkMappingsCreate(ResourceName, ResourceGroupName, SubscriptionId, FabricName, NetworkName, NetworkMappingName, Input, onOk, this, Pipeline);
