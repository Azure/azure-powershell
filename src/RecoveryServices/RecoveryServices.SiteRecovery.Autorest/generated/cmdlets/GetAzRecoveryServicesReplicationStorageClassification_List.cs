...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByReplicationFabrics=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationStorageClassifications"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRecoveryServicesReplicationStorageClassification_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Description(@"Lists the storage classifications available in the specified fabric.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Generated]
    public partial class GetAzRecoveryServicesReplicationStorageClassification_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.IEventListener
    {
        ...
        /// <summary>Site name of interest.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Site name of interest.")]
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRecoveryServicesReplicationStorageClassification_List" /> cmdlet class.
        /// </summary>
        public GetAzRecoveryServicesReplicationStorageClassification_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ReplicationStorageClassificationsListByReplicationFabrics(ResourceName, ResourceGroupName, SubscriptionId, FabricName, onOk, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ReplicationStorageClassificationsListByReplicationFabrics_Call(requestMessage, onOk, this, Pipeline);
                        }
                    }
                }
            }
