...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzRecoveryServicesReplicationProtectedItemAppliance_Update", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Description(@"The operation to update appliance of an ASR replication protected item.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Generated]
    public partial class UpdateAzRecoveryServicesReplicationProtectedItemAppliance_Update : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ApplianceUpdateInput" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IUpdateApplianceForReplicationProtectedItemInput _applianceUpdateInput;

        /// <summary>Update appliance for replication protected item input.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Update appliance for replication protected item input.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Update appliance for replication protected item input.",
        SerializedName = @"applianceUpdateInput",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IUpdateApplianceForReplicationProtectedItemInput) })]
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IUpdateApplianceForReplicationProtectedItemInput ApplianceUpdateInput { get => this._applianceUpdateInput; set => this._applianceUpdateInput = value; }
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzRecoveryServicesReplicationProtectedItemAppliance_Update
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets.UpdateAzRecoveryServicesReplicationProtectedItemAppliance_Update Clone()
        {
            var clone = new UpdateAzRecoveryServicesReplicationProtectedItemAppliance_Update();
            ...
            clone.ApplianceUpdateInput = this.ApplianceUpdateInput;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ReplicationProtectedItemsUpdateAppliance(ResourceName, ResourceGroupName, SubscriptionId, FabricName, ProtectionContainerName, ReplicatedProtectedItemName, ApplianceUpdateInput, onOk, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzRecoveryServicesReplicationProtectedItemAppliance_Update" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzRecoveryServicesReplicationProtectedItemAppliance_Update()
        {
