...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzRecoveryServicesReplicationProtectedItemMobilityService_Update", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Description(@"The operation to update(push update) the installed mobility service software on a replication protected item to the latest available version.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Generated]
    public partial class UpdateAzRecoveryServicesReplicationProtectedItemMobilityService_Update : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IUpdateMobilityServiceRequest _updateMobilityServiceRequest;

        /// <summary>Request to update the mobility service on a protected item.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Request to update the mobility service on a protected item.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Request to update the mobility service on a protected item.",
        SerializedName = @"updateMobilityServiceRequest",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IUpdateMobilityServiceRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IUpdateMobilityServiceRequest UpdateMobilityServiceRequest { get => this._updateMobilityServiceRequest; set => this._updateMobilityServiceRequest = value; }
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzRecoveryServicesReplicationProtectedItemMobilityService_Update
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets.UpdateAzRecoveryServicesReplicationProtectedItemMobilityService_Update Clone()
        {
            var clone = new UpdateAzRecoveryServicesReplicationProtectedItemMobilityService_Update();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ReplicationProtectedItemsUpdateMobilityService(ResourceName, ResourceGroupName, SubscriptionId, FabricName, ProtectionContainerName, ReplicatedProtectedItemName, UpdateMobilityServiceRequest, onOk, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzRecoveryServicesReplicationProtectedItemMobilityService_Update" />
        /// cmdlet class.
        /// </summary>
        public UpdateAzRecoveryServicesReplicationProtectedItemMobilityService_Update()
        {
