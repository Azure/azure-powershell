...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzRecoveryServicesReplicationProtectedItem_Update", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzRecoveryServicesReplicationProtectedItem_Update : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="UpdateProtectionInput" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IUpdateReplicationProtectedItemInput _updateProtectionInput;

        /// <summary>Update replication protected item input.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Update replication protected item input.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Update replication protected item input.",
        SerializedName = @"updateProtectionInput",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IUpdateReplicationProtectedItemInput) })]
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IUpdateReplicationProtectedItemInput UpdateProtectionInput { get => this._updateProtectionInput; set => this._updateProtectionInput = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzRecoveryServicesReplicationProtectedItem_Update</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets.UpdateAzRecoveryServicesReplicationProtectedItem_Update Clone()
        {
            var clone = new UpdateAzRecoveryServicesReplicationProtectedItem_Update();
            ...
            clone.UpdateProtectionInput = this.UpdateProtectionInput;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ReplicationProtectedItemsUpdate(ResourceName, ResourceGroupName, SubscriptionId, FabricName, ProtectionContainerName, ReplicatedProtectedItemName, UpdateProtectionInput, onOk, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzRecoveryServicesReplicationProtectedItem_Update" /> cmdlet class.
        /// </summary>
        public UpdateAzRecoveryServicesReplicationProtectedItem_Update()
        {
