...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201
{
    ...
    public partial class DraDetails :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IDraDetails,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IDraDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IDraDetailsInternal.BiosId { get => this._biosId; set { {_biosId = value;} } }

        /// <summary>Internal Acessors for ForwardProtectedItemCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IDraDetailsInternal.ForwardProtectedItemCount { get => this._forwardProtectedItemCount; set { {_forwardProtectedItemCount = value;} } }

        /// <summary>Internal Acessors for Health</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionHealth? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IDraDetailsInternal.Health { get => this._health; set { {_health = value;} } }

        /// <summary>Internal Acessors for HealthError</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IHealthError[] Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IDraDetailsInternal.HealthError { get => this._healthError; set { {_healthError = value;} } }

        /// <summary>Internal Acessors for Id</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IDraDetailsInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for LastHeartbeatUtc</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IDraDetailsInternal.LastHeartbeatUtc { get => this._lastHeartbeatUtc; set { {_lastHeartbeatUtc = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IDraDetailsInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for ReverseProtectedItemCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IDraDetailsInternal.ReverseProtectedItemCount { get => this._reverseProtectedItemCount; set { {_reverseProtectedItemCount = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IDraDetailsInternal.Version { get => this._version; set { {_version = value;} } }
