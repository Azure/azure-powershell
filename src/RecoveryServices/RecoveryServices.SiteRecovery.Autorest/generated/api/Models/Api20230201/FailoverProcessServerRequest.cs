...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201
{
    ...
    public partial class FailoverProcessServerRequest :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IFailoverProcessServerRequest,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IFailoverProcessServerRequestInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IFailoverProcessServerRequestProperties Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IFailoverProcessServerRequestInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.FailoverProcessServerRequestProperties()); set { {_property = value;} } }

        /// <summary>Backing field for <see cref="Property" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IFailoverProcessServerRequestProperties _property;

        /// <summary>The properties of the PS Failover request.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IFailoverProcessServerRequestProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.FailoverProcessServerRequestProperties()); set => this._property = value; }
...

    {
        ...
        string ContainerName { get; set; }
        /// <summary>The properties of the PS Failover request.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IFailoverProcessServerRequestProperties Property { get; set; }
        /// <summary>The source process server.</summary>
        string SourceProcessServerId { get; set; }
        /// <summary>The new process server.</summary>
        string TargetProcessServerId { get; set; }
