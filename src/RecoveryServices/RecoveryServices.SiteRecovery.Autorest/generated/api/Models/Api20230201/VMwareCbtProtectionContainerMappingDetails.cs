...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201
{
    ...
    public partial class VMwareCbtProtectionContainerMappingDetails :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IVMwareCbtProtectionContainerMappingDetails,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IVMwareCbtProtectionContainerMappingDetailsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IVMwareCbtProtectionContainerMappingDetailsInternal.KeyVaultId { get => this._keyVaultId; set { {_keyVaultId = value;} } }

        /// <summary>Internal Acessors for KeyVaultUri</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IVMwareCbtProtectionContainerMappingDetailsInternal.KeyVaultUri { get => this._keyVaultUri; set { {_keyVaultUri = value;} } }

        /// <summary>Internal Acessors for RoleSizeToNicCountMap</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IVMwareCbtProtectionContainerMappingDetailsRoleSizeToNicCountMap Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IVMwareCbtProtectionContainerMappingDetailsInternal.RoleSizeToNicCountMap { get => (this._roleSizeToNicCountMap = this._roleSizeToNicCountMap ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.VMwareCbtProtectionContainerMappingDetailsRoleSizeToNicCountMap()); set { {_roleSizeToNicCountMap = value;} } }

        /// <summary>Internal Acessors for ServiceBusConnectionStringSecretName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IVMwareCbtProtectionContainerMappingDetailsInternal.ServiceBusConnectionStringSecretName { get => this._serviceBusConnectionStringSecretName; set { {_serviceBusConnectionStringSecretName = value;} } }

        /// <summary>Internal Acessors for StorageAccountId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IVMwareCbtProtectionContainerMappingDetailsInternal.StorageAccountId { get => this._storageAccountId; set { {_storageAccountId = value;} } }

        /// <summary>Internal Acessors for StorageAccountSasSecretName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IVMwareCbtProtectionContainerMappingDetailsInternal.StorageAccountSasSecretName { get => this._storageAccountSasSecretName; set { {_storageAccountSasSecretName = value;} } }

        /// <summary>Internal Acessors for TargetLocation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IVMwareCbtProtectionContainerMappingDetailsInternal.TargetLocation { get => this._targetLocation; set { {_targetLocation = value;} } }

        /// <summary>Backing field for <see cref="RoleSizeToNicCountMap" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IVMwareCbtProtectionContainerMappingDetailsRoleSizeToNicCountMap _roleSizeToNicCountMap;

        /// <summary>The role size to NIC count map.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IVMwareCbtProtectionContainerMappingDetailsRoleSizeToNicCountMap RoleSizeToNicCountMap { get => (this._roleSizeToNicCountMap = this._roleSizeToNicCountMap ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.VMwareCbtProtectionContainerMappingDetailsRoleSizeToNicCountMap()); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IProtectionContainerMappingProviderSpecificDetails
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IVMwareCbtProtectionContainerMappingDetailsRoleSizeToNicCountMap) })]
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IVMwareCbtProtectionContainerMappingDetailsRoleSizeToNicCountMap RoleSizeToNicCountMap { get;  }
        /// <summary>The secret name of the service bus connection string.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IProtectionContainerMappingProviderSpecificDetailsInternal
    {
        ...
        /// <summary>The role size to NIC count map.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IVMwareCbtProtectionContainerMappingDetailsRoleSizeToNicCountMap RoleSizeToNicCountMap { get; set; }
        /// <summary>The secret name of the service bus connection string.</summary>
