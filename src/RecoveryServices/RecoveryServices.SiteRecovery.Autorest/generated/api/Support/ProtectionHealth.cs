...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionHealth Critical = @"Critical";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionHealth None = @"None";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionHealth Normal = @"Normal";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionHealth Warning = @"Warning";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionHealth e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionHealth e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionHealth e1, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.ProtectionHealth e2)
        {
            return !e2.Equals(e1);
        }
