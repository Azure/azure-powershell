...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.Severity Error = @"Error";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.Severity Info = @"Info";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.Severity None = @"NONE";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.Severity Warning = @"Warning";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.Severity e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.Severity e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.Severity e1, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.Severity e2)
        {
            return !e2.Equals(e1);
        }
