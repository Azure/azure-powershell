...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.DiskReplicationProgressHealth InProgress = @"InProgress";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.DiskReplicationProgressHealth NoProgress = @"NoProgress";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.DiskReplicationProgressHealth None = @"None";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.DiskReplicationProgressHealth Queued = @"Queued";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.DiskReplicationProgressHealth SlowProgress = @"SlowProgress";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.DiskReplicationProgressHealth e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.DiskReplicationProgressHealth e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.DiskReplicationProgressHealth e1, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.DiskReplicationProgressHealth e2)
        {
            return !e2.Equals(e1);
        }
