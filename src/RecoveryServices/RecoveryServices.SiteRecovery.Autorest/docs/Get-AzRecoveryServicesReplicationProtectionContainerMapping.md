...
### Get
```
Get-AzRecoveryServicesReplicationProtectionContainerMapping -FabricName <String> -MappingName <String>
...
### List
```
Get-AzRecoveryServicesReplicationProtectionContainerMapping -FabricName <String>
 -ProtectionContainerName <String> -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
