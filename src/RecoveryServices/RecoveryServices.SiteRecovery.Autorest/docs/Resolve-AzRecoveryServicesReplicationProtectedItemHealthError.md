...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/resolve-azrecoveryservicesreplicationprotecteditemhealtherror
schema: 2.0.0
---

# Resolve-AzRecoveryServicesReplicationProtectedItemHealthError
...
```
Resolve-AzRecoveryServicesReplicationProtectedItemHealthError -FabricName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IResolveHealthError[]
Parameter Sets: ResolveExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IResolveHealthInput
