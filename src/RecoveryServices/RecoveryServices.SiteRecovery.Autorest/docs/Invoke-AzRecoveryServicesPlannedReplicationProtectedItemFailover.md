...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/invoke-azrecoveryservicesplannedreplicationprotecteditemfailover
schema: 2.0.0
---

# Invoke-AzRecoveryServicesPlannedReplicationProtectedItemFailover
...
```
Invoke-AzRecoveryServicesPlannedReplicationProtectedItemFailover -FabricName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IPlannedFailoverInput
