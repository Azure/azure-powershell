...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/new-azrecoveryservicesreplicationmigrationitem
schema: 2.0.0
---

# New-AzRecoveryServicesReplicationMigrationItem
...
```
New-AzRecoveryServicesReplicationMigrationItem -FabricName <String> -MigrationItemName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IEnableMigrationInput
