...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/move-azrecoveryservicesreplicationfabricgateway
schema: 2.0.0
---
...
```
Move-AzRecoveryServicesReplicationFabricGateway -FabricName <String> -ResourceGroupName <String>
...
```yaml
Type: System.String
Parameter Sets: ReassociateExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IFailoverProcessServerRequest
Parameter Sets: Reassociate
Aliases:
