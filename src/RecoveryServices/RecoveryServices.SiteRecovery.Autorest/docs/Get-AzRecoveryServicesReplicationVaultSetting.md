...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesreplicationvaultsetting
schema: 2.0.0
---
...
### List (Default)
```
Get-AzRecoveryServicesReplicationVaultSetting -ResourceGroupName <String> -ResourceName <String>
