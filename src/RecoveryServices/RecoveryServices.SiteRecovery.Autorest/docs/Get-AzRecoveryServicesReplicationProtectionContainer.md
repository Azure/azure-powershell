...
### Get
```
Get-AzRecoveryServicesReplicationProtectionContainer -FabricName <String> -ProtectionContainerName <String>
...
### List
```
Get-AzRecoveryServicesReplicationProtectionContainer -FabricName <String> -ResourceGroupName <String>
