...
### List (Default)
```
Get-AzRecoveryServicesRecoveryPoint -FabricName <String> -ProtectionContainerName <String>
...
### Get
```
Get-AzRecoveryServicesRecoveryPoint -FabricName <String> -Name <String> -ProtectionContainerName <String>
 -ReplicatedProtectedItemName <String> -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
