...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/clear-azrecoveryservicesreplicationprotecteditem
schema: 2.0.0
---

# Clear-AzRecoveryServicesReplicationProtectedItem
...
```
Clear-AzRecoveryServicesReplicationProtectedItem -FabricName <String> -ProtectionContainerName <String>
