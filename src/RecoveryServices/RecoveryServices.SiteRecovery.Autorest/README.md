...
directive:
  ...
  - where:
      verb: Switch
      subject: ReplicationProtectionContainerProtection
      variant: Switch
    remove: true
  - where:
      verb: Switch
