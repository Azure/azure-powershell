...
namespace Microsoft.Azure.Management.RecoveryServices.Models
{
    ...
    public partial class MonitoringSummary
    {
        ...
        /// <param name="unHealthyVMCount">Count of unhealthy VMs.
        /// </param>

        /// <param name="unHealthyProviderCount">Count of unhealthy replication providers.
        /// </param>

        /// <param name="eventsCount">Count of all critical warnings.
        /// </param>

        /// <param name="deprecatedProviderCount">Count of all deprecated recovery service providers.
        /// </param>

        /// <param name="supportedProviderCount">Count of all the supported recovery service providers.
        /// </param>

        /// <param name="unsupportedProviderCount">Count of all the unsupported recovery service providers.
        /// </param>
