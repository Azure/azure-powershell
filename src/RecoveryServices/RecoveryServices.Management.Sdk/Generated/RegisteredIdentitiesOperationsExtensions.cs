...
namespace Microsoft.Azure.Management.RecoveryServices
{
    ...
    public static partial class RegisteredIdentitiesOperationsExtensions
    {
        ...
        {
                ((IRegisteredIdentitiesOperations)operations).DeleteAsync(resourceGroupName, vaultName, identityName).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task DeleteAsync(this IRegisteredIdentitiesOperations operations, string resourceGroupName, string vaultName, string identityName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
