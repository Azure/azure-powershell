...
namespace Microsoft.Azure.Management.RecoveryServices
{
    ...
    /// </summary>
    public partial class RecoveryServicesClient : Microsoft.Rest.ServiceClient<RecoveryServicesClient>, IRecoveryServicesClient, IAzureClient
    {
        /// <summary>
        ...
        /// </summary>
        public virtual IDeletedVaultsOperations DeletedVaults { get; private set; }
        /// <summary>
        ...
        protected RecoveryServicesClient(System.Net.Http.HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            this.Initialize();
        }
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public RecoveryServicesClient(Microsoft.Rest.ServiceClientCredentials credentials, params System.Net.Http.DelegatingHandler[] handlers) : this(handlers)
        {
            if (credentials == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public RecoveryServicesClient(Microsoft.Rest.ServiceClientCredentials credentials, System.Net.Http.HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public RecoveryServicesClient(Microsoft.Rest.ServiceClientCredentials credentials, System.Net.Http.HttpClientHandler rootHandler, params System.Net.Http.DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public RecoveryServicesClient(System.Uri baseUri, Microsoft.Rest.ServiceClientCredentials credentials, params System.Net.Http.DelegatingHandler[] handlers) : this(handlers) 
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public RecoveryServicesClient(System.Uri baseUri, Microsoft.Rest.ServiceClientCredentials credentials, System.Net.Http.HttpClientHandler rootHandler, params System.Net.Http.DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
        ...
        private void Initialize()
        {
            ...
            this.RecoveryServices = new RecoveryServicesOperations(this);
            this.DeletedVaults = new DeletedVaultsOperations(this);
            this.Vaults = new VaultsOperations(this);
            this.VaultCertificates = new VaultCertificatesOperations(this);
            ...
            this.RegisteredIdentities = new RegisteredIdentitiesOperations(this);
            ...
            SerializationSettings.Converters.Add(new Microsoft.Rest.Serialization.PolymorphicSerializeJsonConverter<ResourceCertificateDetails>("authType"));
            DeserializationSettings.Converters.Add(new Microsoft.Rest.Serialization.PolymorphicDeserializeJsonConverter<ResourceCertificateDetails>("authType"));
            CustomInitialize();
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Vault>> GetOperationResultWithHttpMessagesAsync(string resourceGroupName, string vaultName, string operationId, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                var ex = new CloudErrorRecoveryServiceException(string.Format("Operation returned an invalid status code '{0}'", _statusCode));
                try
                {
                    _responseContent = await _httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                    CloudErrorRecoveryService _errorBody =  Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<CloudErrorRecoveryService>(_responseContent, this.DeserializationSettings);
                    if (_errorBody != null)
                    {
                        ex.Body = _errorBody;
                    }
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Vault>(_responseContent, this.DeserializationSettings);
                }
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<OperationResource>> GetOperationStatusWithHttpMessagesAsync(string resourceGroupName, string vaultName, string operationId, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<OperationResource>(_responseContent, this.DeserializationSettings);
                }
                catch (Newtonsoft.Json.JsonException ex)
                {
                    _httpRequest.Dispose();
