...
namespace Microsoft.Azure.Management.RecoveryServices
{
    ...
    /// </summary>
    internal partial class VaultCertificatesOperations : Microsoft.Rest.IServiceOperations<RecoveryServicesClient>, IVaultCertificatesOperations
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<VaultCertificateResponse>> CreateWithHttpMessagesAsync(string resourceGroupName, string vaultName, string certificateName, RawCertificateData properties = default(RawCertificateData), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                _requestContent = Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(certificateRequest, this.Client.SerializationSettings);
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<VaultCertificateResponse>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<VaultCertificateResponse>(_responseContent, this.Client.DeserializationSettings);
                }
