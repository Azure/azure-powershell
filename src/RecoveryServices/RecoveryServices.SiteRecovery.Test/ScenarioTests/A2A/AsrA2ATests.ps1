...
function Test-A2AEnableProtectionWithPlatformFaultDomain {
    ...
    # Add your tags
    $vmssConfig.Tags.Add("DeleteBy", "12-2025")
    ...
    $vmConfig = New-AzVMConfig -VMName $vmName -VMSize $VMSize -SecurityType $stnd
    ...
    $vhdid = $recvm.StorageProfile.OSDisk.ManagedDisk.Id
    $v = New-AzRecoveryServicesAsrAzureToAzureDiskReplicationConfig -ManagedDisk -LogStorageAccountId $recLogStg `
        -DiskId $vhdid -RecoveryResourceGroupId $recoveryRgName -RecoveryReplicaDiskAccountType $RecoveryReplicaDiskAccountType `
        -RecoveryTargetDiskAccountType $RecoveryTargetDiskAccountType
    ...
    $reprotectJob = Update-AzRecoveryServicesAsrProtectionDirection -AzureToAzure -ProtectionContainerMapping $revMapping[0] `
            -RecoveryResourceGroupId $primaryRg.ResourceId -ReplicationProtectedItem $pe `
            -AzureToAzureDiskReplicationConfiguration $v -PlatformFaultDomain $reprotectPlatformFaultDomain
    WaitForJobCompletion -JobId $reprotectJob.Name
