...
//#endif
        ...
        {
            this.RunPowerShellTest(_logger, Constants.NewModel, "Test-EdgeZoneToAzureRecoveryPlanReplication");
        }
        ...
        {
            this.RunPowerShellTest(_logger, Constants.NewModel, "Test-EdgeZoneToEdgeZoneRecoveryPlanReplication");
        }
