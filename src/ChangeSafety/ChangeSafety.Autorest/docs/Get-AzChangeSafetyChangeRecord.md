...
### List (Default)
```
Get-AzChangeSafetyChangeRecord [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### Get1
```
Get-AzChangeSafetyChangeRecord -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
...
### List1
```
Get-AzChangeSafetyChangeRecord -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
