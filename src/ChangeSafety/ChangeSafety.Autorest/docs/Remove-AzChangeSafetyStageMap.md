...
### Delete2
```
Remove-AzChangeSafetyStageMap -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Remove-AzChangeSafetyStageMap -ManagementGroupInputObject <IChangeSafetyIdentity> -Name <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Delete, Delete1, Delete2, DeleteViaIdentityManagementGroup
