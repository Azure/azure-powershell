...
### UpdateExpanded1
```
Update-AzChangeSafetyStageProgression -ChangeRecordName <String> -ResourceGroupName <String>
 -StageProgressionName <String> [-SubscriptionId <String>] [-AdditionalData <IAny>] [-Comment <String>]
 [-Link <ILink[]>] [-Parameter <Hashtable>] [-StageReference <String>] [-StageVariable <Hashtable>]
 [-Status <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityChangeRecordExpanded
```
Update-AzChangeSafetyStageProgression -ChangeRecordInputObject <IChangeSafetyIdentity>
 -StageProgressionName <String> [-AdditionalData <IAny>] [-Comment <String>] [-Link <ILink[]>]
 [-Parameter <Hashtable>] [-StageReference <String>] [-StageVariable <Hashtable>] [-Status <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-AzChangeSafetyStageProgression -InputObject <IChangeSafetyIdentity> [-AdditionalData <IAny>]
 ...
 [-StageVariable <Hashtable>] [-Status <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-AzChangeSafetyStageProgression -ChangeRecordName <String> -ResourceGroupName <String>
 -StageProgressionName <String> -JsonFilePath <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>]
...
```
Update-AzChangeSafetyStageProgression -ChangeRecordName <String> -ResourceGroupName <String>
 -StageProgressionName <String> -JsonString <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Parameter Sets: UpdateExpanded, UpdateExpanded1, UpdateViaIdentityChangeRecordExpanded, UpdateViaIdentityChangeRecordExpanded1, UpdateViaIdentityExpanded, UpdateViaIdentityExpanded1
Aliases:
...
Parameter Sets: UpdateViaIdentityChangeRecordExpanded, UpdateViaIdentityChangeRecordExpanded1
Aliases:
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded1, UpdateViaJsonFilePath1, UpdateViaJsonString1
Aliases:
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateExpanded1, UpdateViaIdentityChangeRecordExpanded, UpdateViaIdentityChangeRecordExpanded1, UpdateViaJsonFilePath, UpdateViaJsonFilePath1, UpdateViaJsonString, UpdateViaJsonString1
Aliases:
