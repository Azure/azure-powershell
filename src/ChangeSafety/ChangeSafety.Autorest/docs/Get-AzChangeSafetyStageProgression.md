...
### Get1
```
Get-AzChangeSafetyStageProgression -ChangeRecordName <String> -ResourceGroupName <String>
 -StageProgressionName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
```
Get-AzChangeSafetyStageProgression -ChangeRecordInputObject <IChangeSafetyIdentity>
 -StageProgressionName <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityChangeRecord1
```
Get-AzChangeSafetyStageProgression -ChangeRecord1InputObject <IChangeSafetyIdentity>
 -StageProgressionName <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Get, Get1, GetViaIdentityChangeRecord, GetViaIdentityChangeRecord1
Aliases:
