...
### Delete1
```
Remove-AzChangeSafetyStageProgression -ChangeRecordName <String> -ResourceGroupName <String>
 -StageProgressionName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
...
```
Remove-AzChangeSafetyStageProgression -ChangeRecordInputObject <IChangeSafetyIdentity>
 -StageProgressionName <String> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentityChangeRecord1
```
Remove-AzChangeSafetyStageProgression -ChangeRecord1InputObject <IChangeSafetyIdentity>
 -StageProgressionName <String> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Delete, Delete1, DeleteViaIdentityChangeRecord, DeleteViaIdentityChangeRecord1
Aliases:
