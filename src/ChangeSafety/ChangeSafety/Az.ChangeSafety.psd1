#
# Module manifest for module 'Az.ChangeSafety'
#
...
RequiredAssemblies = 'ChangeSafety.Autorest/bin/Az.ChangeSafety.private.dll'
...
FormatsToProcess = 'ChangeSafety.Autorest/Az.ChangeSafety.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('ChangeSafety.Autorest/Az.ChangeSafety.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Get-AzChangeSafetyChangeRecord', 'Get-AzChangeSafetyStageMap', 
               'Get-AzChangeSafetyStageProgression', 
               'New-AzChangeSafetyChangeRecord', 'New-AzChangeSafetyStageMap', 
