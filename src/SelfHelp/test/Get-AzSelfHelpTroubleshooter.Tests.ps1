if(($null -eq $TestName) -or ($TestName -contains 'Get-AzSelfHelpTroubleshooter'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Get-AzSelfHelpTroubleshooter.Recording.json'
...
Describe 'Get-AzSelfHelpTroubleshooter' -Tag 'LiveOnly' {
    It 'Get' {
