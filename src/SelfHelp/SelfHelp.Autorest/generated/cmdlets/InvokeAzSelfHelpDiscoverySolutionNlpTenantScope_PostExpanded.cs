...
namespace Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Post=>POST:"/providers/Microsoft.Help/discoverSolutions"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzSelfHelpDiscoverySolutionNlpTenantScope_PostExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api20240301Preview.ISolutionNlpMetadataResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Description(@"Solution discovery using natural language processing.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.HttpPath(Path = "/providers/Microsoft.Help/discoverSolutions", ApiVersion = "2024-03-01-preview")]
    public partial class InvokeAzSelfHelpDiscoverySolutionNlpTenantScope_PostExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api20240301Preview.IDiscoveryNlpRequest _discoverSolutionRequestBody = new Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api20240301Preview.DiscoveryNlpRequest();

        /// <summary>Additional information in the form of a string.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Additional information in the form of a string.")]
        ...
        public string AdditionalContext { get => _discoverSolutionRequestBody.AdditionalContext ?? null; set => _discoverSolutionRequestBody.AdditionalContext = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Describe the issue with the affected resource.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Category(global::Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string IssueSummary { get => _discoverSolutionRequestBody.IssueSummary ?? null; set => _discoverSolutionRequestBody.IssueSummary = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Provide resourceId of affected resource")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Category(global::Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ResourceId { get => _discoverSolutionRequestBody.ResourceId ?? null; set => _discoverSolutionRequestBody.ResourceId = value; }

        /// <summary>
        /// Service Classification id for the resource. You can find required serviceId from Services API: https://learn.microsoft.com/rest/api/support/services/listtabs=HTTP
        /// Service Id is the GUID which can be found under name field in Services List response
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Service Classification id for the resource. You can find required serviceId from Services API: https://learn.microsoft.com/rest/api/support/services/listtabs=HTTP Service Id is the GUID which can be found under name field in Services List response")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Category(global::Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Service Classification id for the resource. You can find required serviceId from Services API: https://learn.microsoft.com/rest/api/support/services/listtabs=HTTP Service Id is the GUID which can be found under name field in Services List response",
        SerializedName = @"serviceId",
        PossibleTypes = new [] { typeof(string) })]
        public string ServiceId { get => _discoverSolutionRequestBody.ServiceId ?? null; set => _discoverSolutionRequestBody.ServiceId = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api20240301Preview.IDiscoveryNlpResponse">Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api20240301Preview.IDiscoveryNlpResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api20240301Preview.IDiscoveryNlpResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzSelfHelpDiscoverySolutionNlpTenantScope_PostExpanded" /> cmdlet class.
        /// </summary>
        public InvokeAzSelfHelpDiscoverySolutionNlpTenantScope_PostExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DiscoverySolutionNlpTenantScopePost' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DiscoverySolutionNlpTenantScopePost(_discoverSolutionRequestBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_discoverSolutionRequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api40.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_discoverSolutionRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_discoverSolutionRequestBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api20240301Preview.IDiscoveryNlpResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
