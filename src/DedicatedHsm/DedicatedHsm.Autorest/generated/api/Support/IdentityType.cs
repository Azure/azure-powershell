...
namespace Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Support.IdentityType Application = @"Application";

        public static Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Support.IdentityType Key = @"Key";

        public static Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Support.IdentityType ManagedIdentity = @"ManagedIdentity";

        public static Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Support.IdentityType User = @"User";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Support.IdentityType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Support.IdentityType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Support.IdentityType e1, Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Support.IdentityType e2)
        {
            return !e2.Equals(e1);
        }
