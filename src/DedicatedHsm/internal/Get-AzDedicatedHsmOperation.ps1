...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.dedicatedhsm/get-azdedicatedhsmoperation
#>
function Get-AzDedicatedHsmOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Models.Api20181031.IDedicatedHsmOperation])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.DedicatedHsm.private\Get-AzDedicatedHsmOperation_List';
        }
