...
$gwSubnet = New-AzVirtualNetworkSubnetConfig   -Name GatewaySubnet   -AddressPrefix 10.2.255.0/26 # gateway subnet name MUST be "GatewaySubnet"
New-AzVirtualNetwork   -Name $VNetName   -ResourceGroupName $RG   -Location $Location   -AddressPrefix 10.2.0.0/16   -Subnet $compute, $hsmSubnet, $gwSubnet
