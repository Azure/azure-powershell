...
## DESCRIPTION
The **Remove-AzSearchQueryKey** cmdlet removes the query key from the Azure AI Search service.
...
The example removes the query key from the Azure AI Search service.
...
### -KeyValue
Azure AI Search Service query key value.
