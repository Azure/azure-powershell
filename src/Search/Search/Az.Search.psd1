...
CmdletsToExport = 'Get-AzSearchAdminKeyPair', 'Get-AzSearchPrivateEndpointConnection', 
               'Get-AzSearchPrivateLinkResource', 'Get-AzSearchQueryKey', 
               'Get-AzSearchService', 'Get-AzSearchSharedPrivateLinkResource', 
               'New-AzSearchAdminKey', 'New-AzSearchQueryKey', 'New-AzSearchService', 
               'New-AzSearchSharedPrivateLinkResource', 
               'Remove-AzSearchPrivateEndpointConnection', 
               'Remove-AzSearchQueryKey', 'Remove-AzSearchService', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated Search service identity casts to explicitly use the Search SDK ''Identity'' model.'
