...
namespace Microsoft.Azure.Management.StorageSync.Models
{
    ...
    public partial class ServerEndpointsRecallActionHeaders
    {
        ...
        /// </param>
        public ServerEndpointsRecallActionHeaders(string xmsCorrelationRequestId = default(string), string xmsRequestId = default(string), string location = default(string), int? retryAfter = default(int?))
