...
namespace Microsoft.Azure.Management.StorageSync.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the CloudEndpointsPostRestoreHeaders class.
        /// </summary>
        ...
        /// </param>
        public CloudEndpointsPostRestoreHeaders(string location = default(string), int? retryAfter = default(int?), string xmsCorrelationRequestId = default(string), string xmsRequestId = default(string))
