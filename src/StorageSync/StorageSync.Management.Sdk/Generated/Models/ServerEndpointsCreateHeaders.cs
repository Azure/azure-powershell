...
namespace Microsoft.Azure.Management.StorageSync.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ServerEndpointsCreateHeaders class.
        /// </summary>
        ...
        /// </param>
        public ServerEndpointsCreateHeaders(string xmsCorrelationRequestId = default(string), string xmsRequestId = default(string), string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?))
