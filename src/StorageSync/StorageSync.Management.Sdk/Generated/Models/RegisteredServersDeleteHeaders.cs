...
namespace Microsoft.Azure.Management.StorageSync.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the RegisteredServersDeleteHeaders class.
        /// </summary>
        ...
        /// </param>
        public RegisteredServersDeleteHeaders(string xmsCorrelationRequestId = default(string), string xmsRequestId = default(string), string location = default(string), int? retryAfter = default(int?))
