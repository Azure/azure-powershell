...
namespace Microsoft.Azure.Management.StorageSync.Models
{
    ...
    public partial class RegisteredServersUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the RegisteredServersUpdateHeaders class.
        /// </summary>
        public RegisteredServersUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// </param>
        public RegisteredServersUpdateHeaders(string xmsCorrelationRequestId = default(string), string xmsRequestId = default(string), string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?))
