...
namespace Microsoft.Azure.Management.StorageSync.Models
{
    ...
    public partial class StorageSyncServicesCreateHeaders
    {
        ...
        /// </param>
        public StorageSyncServicesCreateHeaders(string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?), string xmsCorrelationRequestId = default(string), string xmsRequestId = default(string))
