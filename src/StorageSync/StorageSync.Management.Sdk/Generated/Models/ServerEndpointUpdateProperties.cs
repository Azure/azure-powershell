...
namespace Microsoft.Azure.Management.StorageSync.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ServerEndpointUpdateProperties class.
        /// </summary>
        ...
        public ServerEndpointUpdateProperties(string cloudTiering = default(string), int? volumeFreeSpacePercent = default(int?), int? tierFilesOlderThanDays = default(int?), string offlineDataTransfer = default(string), string offlineDataTransferShareName = default(string), string localCacheMode = default(string))
