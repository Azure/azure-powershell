...
namespace Microsoft.Azure.Management.StorageSync.Models
{
    ...
    public partial class StorageSyncErrorDetails
    {
        ...
        /// <param name="target">Target of the given entry.
        /// </param>

        /// <param name="requestUri">Request URI of the given entry.
        /// </param>

        /// <param name="exceptionType">Exception type of the given entry.
        /// </param>

        /// <param name="httpMethod">HTTP method of the given entry.
        /// </param>

        /// <param name="hashedMessage">Hashed message of the given entry.
        /// </param>

        /// <param name="httpErrorCode">HTTP error code of the given entry.
        /// </param>
