...
namespace Microsoft.Azure.Management.StorageSync.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the CloudEndpointsDeleteHeaders class.
        /// </summary>
        ...
        /// </param>
        public CloudEndpointsDeleteHeaders(string xmsCorrelationRequestId = default(string), string xmsRequestId = default(string), string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?))
