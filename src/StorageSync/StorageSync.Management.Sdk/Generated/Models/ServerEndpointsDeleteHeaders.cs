...
namespace Microsoft.Azure.Management.StorageSync.Models
{
    ...
    public partial class ServerEndpointsDeleteHeaders
    {
        ...
        /// </param>
        public ServerEndpointsDeleteHeaders(string xmsCorrelationRequestId = default(string), string xmsRequestId = default(string), string location = default(string), int? retryAfter = default(int?))
