...
namespace Microsoft.Azure.Management.StorageSync
{
    ...
    /// </summary>
    internal partial class OperationStatusOperations : Microsoft.Rest.IServiceOperations<StorageSyncManagementClient>, IOperationStatusOperations
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<OperationStatus,OperationStatusGetHeaders>> GetWithHttpMessagesAsync(string resourceGroupName, string locationName, string workflowId, string operationId, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<OperationStatus,OperationStatusGetHeaders>();
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<OperationStatusGetHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
            catch (Newtonsoft.Json.JsonException ex)
            {
                _httpRequest.Dispose();
