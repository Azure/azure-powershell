...
namespace Microsoft.Azure.Management.StorageSync
{
    ...
    public static partial class StorageSyncManagementClientExtensions
    {
            ...
            {
                return ((IStorageSyncManagementClient)operations).LocationOperationStatusMethodAsync(locationName, operationId).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async System.Threading.Tasks.Task<LocationOperationStatus> LocationOperationStatusMethodAsync(this IStorageSyncManagementClient operations, string locationName, string operationId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
