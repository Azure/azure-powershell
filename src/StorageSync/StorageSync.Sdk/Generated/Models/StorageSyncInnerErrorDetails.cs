...
namespace Microsoft.Azure.Management.StorageSync.Models
{
    ...
    public partial class StorageSyncInnerErrorDetails
    {
        ...
        /// <param name="callStack">Call stack of the error.
        /// </param>

        /// <param name="message">Error message of the error.
        /// </param>

        /// <param name="innerException">Exception of the inner error.
        /// </param>

        /// <param name="innerExceptionCallStack">Call stack of the inner error.
        /// </param>
