...
namespace Microsoft.Azure.Management.StorageSync.Models
{
    ...
    /// </summary>
    public partial class OperationStatusGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the OperationStatusGetHeaders class.
        /// </summary>
        public OperationStatusGetHeaders()
        {
            CustomInit();
        }
        ...
        /// id.</param>
        public OperationStatusGetHeaders(string xMsRequestId = default(string), string xMsCorrelationRequestId = default(string))
        {
