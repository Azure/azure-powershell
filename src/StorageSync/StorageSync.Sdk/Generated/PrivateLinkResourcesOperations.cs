...
namespace Microsoft.Azure.Management.StorageSync
{
    ...
    /// </summary>
    internal partial class PrivateLinkResourcesOperations : IServiceOperations<StorageSyncManagementClient>, IPrivateLinkResourcesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal PrivateLinkResourcesOperations(StorageSyncManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<PrivateLinkResourceListResult>> ListByStorageSyncServiceWithHttpMessagesAsync(string resourceGroupName, string storageSyncServiceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/privateLinkResources").ToString();
