...
namespace Microsoft.Azure.Commands.StorageSync.Common.Converters
{
    ...
    public class CloudEndpointLastChangeEnumerationStatusConverter : ConverterBase<PSCloudEndpointLastChangeEnumerationStatus, StorageSyncModels.CloudEndpointLastChangeEnumerationStatus>
    {
        ...
        /// <returns>StorageSyncModels.CloudEndpointLastChangeEnumerationStatus.</returns>
        ...
        {
            // Last change enumeration status properties are read-only
        ...
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns>PSCloudEndpointLastChangeEnumerationStatus.</returns>
