...
-->
## Upcoming Release
* Adding support for authoritative upload as part of New-AzStorageSyncServerEndpoint.
* Adding cloud change enumeration status information in Cloud Endpoint object.
* Updating Server Endpoint object with various health properties
* Adding "ServerName" property in Server Endpoint and Registered Server objects to support rename of servers.
