...
* Add RoleAssignmentExists check
* Add AssignIdentity to Set-AzStorageSyncServer
* Add a default behavior of system assigned identity to StorageSyncService provisioning
