...
New-AzStorageSyncServerEndpoint [-ResourceGroupName] <String> [-StorageSyncServiceName] <String>
 ...
 [-OfflineDataTransferShareName <String>] [InitialDownloadPolicy] [LocalCacheMode] [InitialUploadPolicy] [-AsJob] [-DefaultProfile <IAzureContextContainer>] [-WhatIf]
...
New-AzStorageSyncServerEndpoint [-ParentObject] <PSSyncGroup> -Name <String> -ServerResourceId <String>
 ...
 [-TierFilesOlderThanDays <Int32>] [-OfflineDataTransferShareName <String>] [InitialDownloadPolicy] [LocalCacheMode] [InitialUploadPolicy] [-AsJob]
