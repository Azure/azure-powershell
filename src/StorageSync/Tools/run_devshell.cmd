...
@set DevShellCustomizations=ipmo %~dp0\StorageSyncDevOps.psm1 -DisableNameChecking; Set-LibraryInfo -LibraryName Utils -LibraryVersion '1.0' -LibraryDisplayName StorageSyncSdkUtils -LibraryDescription StorageSyncDevOps;
