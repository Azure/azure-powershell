...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    [OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20190301.IVirtualMachineScaleSet))]
    public partial class NewAzVmss_SimpleParameterSet : AzureRMAsyncCmdlet
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Compute.ImageName  Image { get; set; } = "Win2016Datacenter";
        ...
        async Task SimpleParameterSetExecuteCmdlet(IAsyncCmdlet asyncCmdlet)
        {
            ...
            if (result != null)
            {
                ...
                // TODO: create custom type for FQDN
                IVirtualMachineScaleSet psObject = result;
                ...
                asyncCmdlet.WriteVerbose(
                    Microsoft.Azure.PowerShell.Cmdlets.Compute.Resources.VmssUseConnectionString,
                    connectionString);
                asyncCmdlet.WriteVerbose(
                    Microsoft.Azure.PowerShell.Cmdlets.Compute.Resources.VmssPortRange,
                    port,
                    range);
        ...
        {
            var identity = new VirtualMachineScaleSetIdentity();
            if (this.IsParameterBound(c => c.SystemAssignedIdentity))
            {
                identity = new VirtualMachineScaleSetIdentity();
