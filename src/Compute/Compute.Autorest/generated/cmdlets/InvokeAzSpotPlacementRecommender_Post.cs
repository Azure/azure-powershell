...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzSpotPlacementRecommender_Post", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzSpotPlacementRecommender_Post : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="SpotPlacementRecommenderInput" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20240301Preview.ISpotPlacementRecommenderInput _spotPlacementRecommenderInput;

        /// <summary>SpotPlacementRecommender API Input.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "SpotPlacementRecommender API Input.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"SpotPlacementRecommender API Input.",
        SerializedName = @"spotPlacementRecommenderInput",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20240301Preview.ISpotPlacementRecommenderInput) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20240301Preview.ISpotPlacementRecommenderInput SpotPlacementRecommenderInput { get => this._spotPlacementRecommenderInput; set => this._spotPlacementRecommenderInput = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzSpotPlacementRecommender_Post" /> cmdlet class.
        /// </summary>
        public InvokeAzSpotPlacementRecommender_Post()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SpotPlacementRecommenderPost(SubscriptionId, Location, SpotPlacementRecommenderInput, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,Location=Location,body=SpotPlacementRecommenderInput})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api40.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, body=SpotPlacementRecommenderInput })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, body=SpotPlacementRecommenderInput })
                    {
