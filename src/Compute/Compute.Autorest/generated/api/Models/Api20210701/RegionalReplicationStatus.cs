...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20210701
{
    ...
    public partial class RegionalReplicationStatus :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20210701.IRegionalReplicationStatusInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20210701.IRegionalReplicationStatusInternal.Detail { get => this._detail; set { {_detail = value;} } }

        /// <summary>Internal Acessors for Progress</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20210701.IRegionalReplicationStatusInternal.Progress { get => this._progress; set { {_progress = value;} } }

        /// <summary>Internal Acessors for Region</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20210701.IRegionalReplicationStatusInternal.Region { get => this._region; set { {_region = value;} } }

        /// <summary>Internal Acessors for State</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.ReplicationState? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20210701.IRegionalReplicationStatusInternal.State { get => this._state; set { {_state = value;} } }
