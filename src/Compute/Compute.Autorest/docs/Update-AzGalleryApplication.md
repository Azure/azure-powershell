...
```
Update-AzGalleryApplication -GalleryInputObject <IComputeIdentity> -Name <String> [-Description <String>]
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded, UpdateViaIdentityGalleryExpanded
Aliases:
