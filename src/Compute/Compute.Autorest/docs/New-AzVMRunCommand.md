...
online version: https://docs.microsoft.com/powershell/module/az.compute/new-azvmruncommand
schema: 2.0.0
---
...
```
New-AzVMRunCommand -ResourceGroupName <String> -RunCommandName <String> -VMName <String> -Location <String>
