if(($null -eq $TestName) -or ($TestName -contains 'New-AzGalleryApplicationVersion'))
{
...
Describe 'New-AzGalleryApplicationVersion' -Tag 'LiveOnly'{
    It 'CreateExpanded' {
        $env.RandomString = $env.RandomString + "1"
