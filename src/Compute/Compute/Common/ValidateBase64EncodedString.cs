...
namespace Microsoft.Azure.Commands.Compute.Common
{
    public static class ValidateBase64EncodedString
    {
        ...
        {
            var bytesToEncode = System.Text.Encoding.Unicode.GetBytes(toBeEncoded);//System.Text.Encoding.Unicode.GetBytes(toBeEncoded);//System.Text.ASCIIEncoding.ASCII.GetBytes(toBeEncoded);
