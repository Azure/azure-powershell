...
Update-AzGalleryImageVersion -GalleryImageDefinitionName image1 -GalleryName <String> -Name <String> -ReplicaCount 2 -ResourceGroupName <String> -TargetRegion <Hashtable[]>
```
