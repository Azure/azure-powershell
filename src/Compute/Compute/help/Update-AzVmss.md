...
Update-AzVmss [-ResourceGroupName] <String> [-VMScaleSetName] <String>
 ...
 [-UpgradePolicyMode <UpgradeMode>] [-CapacityReservationGroupId <String>]
 [-DisableCapacityReservationAssignment] [-VhdContainer <String[]>] [-AsJob]
...
### Example 3: Update VMSS processor mode
```powershell
$vmss = Get-AzVmss -ResourceGroupName "myResourceGroup" -VMScaleSetName "myVMSS"
Update-AzVmss -ResourceGroupName "myResourceGroup" -VMScaleSetName "myVMSS" -VirtualMachineScaleSet $vmss -ProcessorMode "Opportunistic"
```
