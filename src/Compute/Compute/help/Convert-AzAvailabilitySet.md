...
```powershell
Convert-AzAvailabilitySet -ResourceGroupName "MyResourceGroup" -Name "MyAvailabilitySet" -VirtualMachineScaleSetName "MyScaleSet" -NoWait
```
...
The name of the Virtual Machine Scale Set to create.
