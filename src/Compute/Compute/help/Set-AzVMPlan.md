...
Sets the Marketplace plan information on a virtual machine. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
Set-AzVMPlan -Name 'AgentPool01' -Product <String> -Publisher <String> -VM <PSVirtualMachine>
```
