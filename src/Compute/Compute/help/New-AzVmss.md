...
New-AzVmss [[-ResourceGroupName] <String>] [-VMScaleSetName] <String> [-AsJob] [-UserData <String>]
 [-DisableIntegrityMonitoring] [-ImageName <String>] [-SecurityType <String>] [-EnableVtpm <Boolean>]
 [-EnableSecureBoot <Boolean>] -Credential <PSCredential> [-InstanceCount <Int32>]
...
#$res.VirtualMachineProfile.SecurityProfile.UefiSettings.VTpmEnabled $true;
#$res.VirtualMachineProfile.SecurityProfile.UefiSettings.SecureBootEnabled $true;
```
This example Creates a new VMSS (Simple Parameterset) with the Trusted Launch Security Type and validates flags SecureBoot and Vtpm as True by default.
...
### -SecurityType
Specifies the SecurityType of the virtual machine. It has to be set to any specified value to enable UefiSettings. <br> Default: UefiSettings will not be enabled unless this property is set.
