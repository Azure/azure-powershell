...
Enables disk encryption on a VM scale set. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
Set-AzVmssDiskEncryptionExtension -DiskEncryptionKeyVaultId <String> -DiskEncryptionKeyVaultUrl <String> -KeyEncryptionKeyUrl <String> -KeyEncryptionKeyVaultId <String> -ResourceGroupName <String> -VMScaleSetName <String> -VolumeType <>
```
