...
online version: https://learn.microsoft.com/powershell/module/az.compute/set-azvmssbootdiagnostic
schema: 2.0.0
---
...
Set-AzVmssBootDiagnostic [-VirtualMachineScaleSet] <PSVirtualMachineScaleSet> [[-Enabled] <Boolean>]
 [[-StorageUri] <String>] [-DefaultProfile <IAzureContextContainer>] [-ProgressAction <ActionPreference>]
