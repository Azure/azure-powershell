...
### Example 1
```powershell
Get-AzCapacityReservation -ResourceGroupName "myRG" -ReservationGroupName "CRGroup1"
```
...
### Example 2
```powershell
Get-AzCapacityReservation -ResourceGroupName "myRG" -ReservationGroupName "CRGroup1" -Name "resource1" -InstanceView
```
