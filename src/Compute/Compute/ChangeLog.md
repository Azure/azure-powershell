...
* Updated New-AzVM feature for `vCPUsAvailable` and `vCPUsPerCore` parameters. This edit ensures the cmdlet does not try and use the new `VMCustomizationPreview` feature if the user does not have access to that feature.
