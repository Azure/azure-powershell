...
* [Breaking Change] Removed the GuestAttestation extension installation by default for VM and VMSS resources. The feature team wants this rolled back. Removed the associated `DisableIntegrityMonitoring` parameter from `New-AzVM` and `New-AzVmss` cmdlets.
