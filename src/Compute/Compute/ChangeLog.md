...
-->
## Upcoming Release
* Added `-InstantAccess` to `New-AzRestorePointCollection` and `Update-AzRestorePointCollection` for instant access snapshots on Premium SSD v2/Ultra disks
* Added `-InstantAccessDurationInMinutes` to `New-AzRestorePoint` (1-300 minutes)
## Version 11.5.0
