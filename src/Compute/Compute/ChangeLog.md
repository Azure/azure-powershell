...
* Removed unversioned and outdated linux image aliases of `CentOS`, `RHEL`, `UbuntuLTS` and `Debian`.
* Remove messaging regarding the removed unversioned Linux aliases.
