...
-->
## Upcoming Release
* Added `SpotPlus` as a supported VM (Virtual Machine) and VMSS (Virtual Machine Scale Set) priority value in `New-AzVM`, `New-AzVMConfig`, `New-AzVmss`, and `New-AzVmssConfig`. [#1572]
