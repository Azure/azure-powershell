...
* Added `-RegularPriorityCount` int parameter to the following cmdlets: `New-AzVmssConfig`, `Update-AzVmss` 
* Added `-RegularPriorityPercentage` int parameter to the following cmdlets: `New-AzVmssConfig`, `Update-AzVmss` 
