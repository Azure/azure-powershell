...
namespace Microsoft.Azure.Commands.Compute.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to There are more than {0} VMs in the result.  Only the statuses of 8000 VMs are shown to avoid throttling.  To get the actual status of each VM, please provide a VM name with -Status parameter..
        /// </summary>
