...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added new switch parameter ''OSImageScheduledEventEnabled'' and string parameter ''OSImageScheduledEventNotBeforeTimeoutInMinutes'' to the cmdlets ''New-AzVmssConfig'' and ''Update-AzVmss''.
