...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added new cmdlets ''Add-AzVmssSkuProfileVMSize'' and ''Remove-AzVmssSkuProfileVMSize'' to add and remove VM sizes to and from the VMSS SkuProfile.
