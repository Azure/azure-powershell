...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added new parameters ''ZonePlacementPolicy'', ''IncludeZone'', ''ExcludeZone'', ''MaxZoneCount'', ''EnableMaxInstancePercentPerZone'' and ''MaxInstancePercentPerZoneValue'' to ''New-AzVmssConfig'' cmdlet.
