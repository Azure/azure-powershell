...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added new parameters ''EnableAutomaticZoneRebalance'', ''AutomaticZoneRebalanceStrategy'' and ''AutomaticZoneRebalanceBehavior'' to ''New-AzVmssConfig'' and ''Update-AzVmss'' cmdlets for VMSS Automatic Zone Rebalancing. '
