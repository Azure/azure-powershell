...
CmdletsToExport = 'Remove-AzAvailabilitySet', 'Get-AzAvailabilitySet', 
               ...
               'Set-AzVmssOrchestrationServiceState', 'New-AzDiskAccess', 'Remove-AzDiskAssess', 'Get-AzDiskAccess'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added warning when using ''New-AzVmss'' without ''latest'' image version'
