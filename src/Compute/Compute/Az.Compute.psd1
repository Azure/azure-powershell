...
CmdletsToExport = 'Remove-AzAvailabilitySet', 'Get-AzAvailabilitySet', 
               ...
               'Get-AzSshKey', 'Remove-AzSshkey', 'Update-AzSshKey', 'New-AzSshKey',
                'New-AzDiskPurchasePlanConfig', 'New-AzDiskUpdateConfig', 'Set-AzDiskSecurityProfile'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated Compute module to use the latest .Net SDK version 47.0.0.'
