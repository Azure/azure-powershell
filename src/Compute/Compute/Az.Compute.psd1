...
RequiredAssemblies = 'Microsoft.Azure.PowerShell.AutoMapper.dll', 'Microsoft.Azure.PowerShell.Compute.Management.Sdk.dll', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added a breaking change warning to the ''Get-AzVM'' cmdlet to show that the ''NextLink'' parameter and parameter set will be removed in June 2023. The parameter has been non-functional for a long time. 
