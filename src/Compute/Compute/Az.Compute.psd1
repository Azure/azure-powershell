...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Deprecated installing the legacy Azure Enhanced Monitoring (AEM) extension for SAP on Virtual Machines (VMs); ''Set-AzVMAEMExtension'' now installs the new extension by default.
