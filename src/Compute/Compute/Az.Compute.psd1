...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated New-AzVM feature for ''vCPUsAvailable'' and ''vCPUsPerCore'' parameters. Cmdlets will not try to use the new ''VMCustomizationPreview'' feature if the user does not have access to that feature. [#17370]'
