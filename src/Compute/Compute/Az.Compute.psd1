...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added ''-WireServerUseLocalFileRules'' and ''-ImdsUseLocalFileRules'' parameters to ''Set-AzVMProxyAgentSetting'' and ''Set-AzVmssProxyAgentSetting'' so users can configure local file rules for Virtual Machine (VM) and Virtual Machine Scale Set (VMSS) host endpoints. [#30055]
