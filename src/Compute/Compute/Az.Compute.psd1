...
FunctionsToExport = 'Get-AzGalleryApplication', 'Get-AzGalleryApplicationVersion', 
               'Invoke-AzSpotPlacementRecommender', 'New-AzGalleryApplication', 
               ...
               'Update-AzGalleryApplicationVersion', 'Invoke-AzSpotPlacementScore'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added new optional parameter ''SecureVMGuestStateSAS'' to cmdlet ''Grant-AzDiskAccess''.
