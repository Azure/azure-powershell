...
CmdletsToExport = 'Add-AzGalleryInVMAccessControlProfileVersionRulesIdentity', 
               ...
               'Add-AzVMNetworkInterfaceConfiguration', 'Add-AzVMSecret', 'Add-AzVmssAdditionalUnattendContent',
               ...
               'Get-AzRestorePointCollection', 'Get-AzSnapshot', 'Get-AzSshKey', 
               'Get-AzVM', 'Get-AzVMAccessExtension', 'Get-AzVMADDomainExtension', 
               'Get-AzVMAEMExtension', 'Get-AzVMBootDiagnosticsData', 
               'Get-AzVMChefExtension', 'Get-AzVMCustomScriptExtension', 
               'Get-AzVMDiagnosticsExtension', 'Get-AzVMDiskEncryptionStatus', 
               'Get-AzVMDscExtension', 'Get-AzVMDscExtensionStatus', 
               'Get-AzVMExtension', 'Get-AzVMExtensionImage', 
               'Get-AzVMExtensionImageType', 'Get-AzVMImage', 'Get-AzVMImageOffer', 
               'Get-AzVMImagePublisher', 'Get-AzVMImageSku', 'Get-AzVMRunCommand', 
               'Get-AzVMRunCommandDocument', 'Get-AzVMSize', 
               'Get-AzVMSqlServerExtension', 'Get-AzVmss', 
               'Get-AzVmssDiskEncryption', 'Get-AzVmssLifecycleHookEvent', 
               'Get-AzVmssRollingUpgrade', 'Get-AzVmssSku', 'Get-AzVmssVM', 
               'Get-AzVmssVMDiskEncryption', 'Get-AzVmssVMRunCommand', 
               'Get-AzVMUsage', 'Grant-AzDiskAccess', 'Grant-AzSnapshotAccess', 
               'Invoke-AzVMInstallPatch', 'Invoke-AzVMPatchAssessment', 
               'Invoke-AzVMReimage', 'Invoke-AzVMRunCommand', 
               'Invoke-AzVmssVMRunCommand', 'Move-AzVirtualMachineToVmss', 
               ...
               'New-AzInterconnectBlock', 'New-AzProximityPlacementGroup', 
               'New-AzRestorePoint', 'New-AzRestorePointCollection', 
               'New-AzSnapshot', 'New-AzSnapshotConfig', 
               'New-AzSnapshotUpdateConfig', 'New-AzSshKey', 'New-AzVM', 
               'New-AzVMConfig', 'New-AzVMDataDisk', 'New-AzVmGalleryApplication', 
               'New-AzVMIpConfig', 'New-AzVMIpTagConfig',
               ...
               'New-AzVmssLifecycleHookConfig', 'New-AzVmssVaultCertificateConfig', 
               'Publish-AzVMDscConfiguration', 'Remove-AzAvailabilitySet', 
               'Remove-AzCapacityReservation', 'Remove-AzCapacityReservationGroup', 
               'Remove-AzDisk', 'Remove-AzDiskAccess', 'Remove-AzDiskEncryptionSet', 
               ...
               'Remove-AzInterconnectBlock', 'Remove-AzImageDataDisk', 
               ...
               'Set-AzVMZoneMovement', 'Start-AzVM', 'Start-AzVmss', 
               ...
               'Update-AzImage', 'Update-AzInterconnectBlock', 
               'Update-AzRestorePointCollection', 'Update-AzSnapshot', 
               'Update-AzSshKey', 'Update-AzVM', 'Update-AzVmss', 
               'Update-AzVmssInstance', 'Update-AzVmssLifecycleHookEvent', 
               'Update-AzVmssVM'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added ''-WireServerUseLocalFileRules'' and ''-ImdsUseLocalFileRules'' to ''Set-AzVMProxyAgentSetting'' and ''Set-AzVmssProxyAgentSetting'' to configure local file rules for Virtual Machine (VM) and Virtual Machine Scale Set (VMSS) host endpoints. [#30055]
