...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added new parameters ''-LinuxConfigurationPatchMode'', ''-WindowsConfigurationPatchMode'', and ''-LinuxConfigurationProvisionVMAgent'' to ''Set-AzVmssOSProfile''
