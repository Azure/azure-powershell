        ...
        public override void ExecuteCmdlet()
        {
            ...
            ExecuteClientAction(() =>
            {
                if (ShouldProcess(this.DiskName, VerbsSecurity.Revoke))
                {
                    ...
                    if (NoWait.IsPresent)
                    {
                        result = DisksClient.BeginRevokeAccessWithHttpMessagesAsync(resourceGroupName, diskName).GetAwaiter().GetResult();
                    }
                    else
                    {
                        result = DisksClient.RevokeAccessWithHttpMessagesAsync(resourceGroupName, diskName).GetAwaiter().GetResult();
                    }
