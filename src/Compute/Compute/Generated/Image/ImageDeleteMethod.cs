...
{
    [Cmdlet(VerbsCommon.Remove, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "Image", DefaultParameterSetName = "DefaultParameter", SupportsShouldProcess = true)]
        ...
        public override void ExecuteCmdlet()
        {
            ...
            ExecuteClientAction(() =>
            {
                                            ...
                                            "Remove-AzImage operation")))
                {
                    ...
                    if (NoWait.IsPresent)
                    {
                        result = ImagesClient.BeginDeleteWithHttpMessagesAsync(resourceGroupName, imageName).GetAwaiter().GetResult();
                    }
                    else
                    {
                        result = ImagesClient.DeleteWithHttpMessagesAsync(resourceGroupName, imageName).GetAwaiter().GetResult();
                    }
