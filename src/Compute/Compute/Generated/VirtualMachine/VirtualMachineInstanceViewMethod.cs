...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateVirtualMachineInstanceViewDynamicParameters()
        {
        ...
        protected void ExecuteVirtualMachineInstanceViewMethod(object[] invokeMethodInputParameters)
        {
            string resourceGroupName = (string)ParseParameter(invokeMethodInputParameters[0]);
            string vmName = (string)ParseParameter(invokeMethodInputParameters[1]);

            var result = VirtualMachinesClient.InstanceView(resourceGroupName, vmName);
            WriteObject(result);
        }
    }
    ...
    {
        protected PSArgument[] CreateVirtualMachineInstanceViewParameters()
        {
