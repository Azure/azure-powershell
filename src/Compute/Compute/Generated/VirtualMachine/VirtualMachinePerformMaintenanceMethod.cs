...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateVirtualMachinePerformMaintenanceDynamicParameters()
        {
        ...
        protected void ExecuteVirtualMachinePerformMaintenanceMethod(object[] invokeMethodInputParameters)
        {
    ...
    {
        protected PSArgument[] CreateVirtualMachinePerformMaintenanceParameters()
        {
