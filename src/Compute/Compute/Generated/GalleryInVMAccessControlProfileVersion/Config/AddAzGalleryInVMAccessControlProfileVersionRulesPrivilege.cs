...
{
    [Cmdlet(VerbsCommon.Add, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "GalleryInVMAccessControlProfileVersionRulesPrivilege")]
    [OutputType(typeof(PSGalleryInVMAccessControlProfileVersion))]
    public partial class AddAzureRmAzGalleryInVMAccessControlProfileVersionRulesPrivilege : ComputeAutomationBaseCmdlet
    {
        [Parameter(
            Mandatory = true,
        ...
        [Parameter(
            Mandatory = true,
            ValueFromPipelineByPropertyName = true,
            HelpMessage = "The HTTP path corresponding to the privilege.")]
