                    ...
                    ExecuteClientAction(() =>
                    {
                        if (ShouldProcess(this.VMScaleSetName, VerbsCommon.New))
                        {
                            ...
                            if (shouldGuestAttestationExtBeInstalled(parameters))
                            {
                                ...
                                parametersupdate.VirtualMachineProfile.ExtensionProfile = this.VirtualMachineScaleSet.VirtualMachineProfile.ExtensionProfile;
                                VirtualMachineScaleSet parameters = new VirtualMachineScaleSet();
                                ComputeAutomationAutoMapperProfile.Mapper.Map<PSVirtualMachineScaleSet, VirtualMachineScaleSet>(this.VirtualMachineScaleSet, parameters);
                                ComputeClient.ComputeManagementClient.VirtualMachineScaleSets.UpdateWithHttpMessagesAsync();
                                */
                                ...
                                */
                                //ComputeClient.ComputeManagementClient.VirtualMachineScaleSetExtensions.BeginCreateOrUpdateWithHttpMessagesAsync(this.ResourceGroupName, this.VMScaleSetName, "GuestAttestation", extensionDirect);
                            }
