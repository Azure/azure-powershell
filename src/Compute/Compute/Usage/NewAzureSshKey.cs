    ...
    public partial class NewAzureSshKey : ComputeAutomationBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            ExecuteClientAction(() =>
            {
                ...
                string generateSshKeyType = this.GenerateSshKeyType;
                ...
                else
                {
                    ...
                    result = SshPublicKeyClient.Create(resourceGroupName, sshKeyName, sshkey);
                    SshPublicKeyGenerateKeyPairResult keypair = SshPublicKeyClient.GenerateKeyPair(resourceGroupName, sshKeyName, generateSshKeyType);
