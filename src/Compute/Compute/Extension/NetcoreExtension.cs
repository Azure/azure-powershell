...
namespace Microsoft.Azure.Commands.Compute
{
    public static class StorageExtensions
    {
        ...
        {
            return account.Sku.Name == Microsoft.Azure.Commands.Compute.Helpers.Storage.Models.SkuName.PremiumLRS;
        }

        public static void SetAsStandardGRS(this StorageAccountCreateParameters createParams)
        {
            createParams.Sku = new Sku(Microsoft.Azure.Commands.Compute.Helpers.Storage.Models.SkuName.StandardGRS);
        }
