...
### Update (Default)
```
Update-AzImage -Name <String> -ResourceGroupName <String> -SubscriptionId <String> [-Image <IImageUpdate>]
...
### UpdateViaIdentity
```
Update-AzImage -InputObject <IComputeIdentity> [-Image <IImageUpdate>] [-DefaultProfile <PSObject>] [-AsJob]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20171201.IImageUpdate
...
### Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20171201.IImageUpdate
