...
### Delete (Default)
```
Remove-AzAvailabilitySet -Name <String> -ResourceGroupName <String> -SubscriptionId <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzAvailabilitySet -InputObject <IComputeIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
