...
### GetViaIdentity
```
Get-AzVmssRollingUpgrade -InputObject <IComputeIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20171201.IRollingUpgradeStatusInfo
