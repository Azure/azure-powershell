...
### Delete1 (Default)
```
Remove-AzDisk -Name <String> -ResourceGroupName <String> -SubscriptionId <String> [-PassThru]
 [-DefaultProfile <PSObject>] [-AsJob] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity1
```
Remove-AzDisk -InputObject <IComputeIdentity> [-PassThru] [-DefaultProfile <PSObject>] [-AsJob] [-Confirm]
