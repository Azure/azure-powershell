...
### Revoke1 (Default)
```
Revoke-AzDiskAccess -DiskName <String> -ResourceGroupName <String> -SubscriptionId <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RevokeViaIdentity1
```
Revoke-AzDiskAccess -InputObject <IComputeIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
