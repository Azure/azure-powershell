...
```
New-AzImage -InputObject <IComputeIdentity> -Location <String> -OSDiskOsstate <OperatingSystemStateTypes>
...
### CreateViaIdentity
```
New-AzImage -InputObject <IComputeIdentity> [-Image <IImage>] [-DefaultProfile <PSObject>] [-AsJob] [-Confirm]
