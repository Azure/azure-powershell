...
online version: https://docs.microsoft.com/powershell/module/az.compute/restart-azvmssvm
schema: 2.0.0
---
...
### RestartViaIdentity
```
Restart-AzVmssVM -InputObject <IComputeIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
