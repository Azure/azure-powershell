...
online version: https://docs.microsoft.com/powershell/module/az.compute/new-azvmextension
schema: 2.0.0
---
...
```
New-AzVMExtension -Name <String> -ResourceGroupName <String> -VMName <String> -Location <String>
