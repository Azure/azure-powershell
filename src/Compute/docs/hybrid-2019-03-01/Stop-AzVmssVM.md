...
online version: https://docs.microsoft.com/powershell/module/az.compute/stop-azvmssvm
schema: 2.0.0
---
...
### PowerOffViaIdentity
```
Stop-AzVmssVM -InputObject <IComputeIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
