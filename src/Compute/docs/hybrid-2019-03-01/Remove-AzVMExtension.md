...
### Delete (Default)
```
Remove-AzVMExtension -Name <String> -ResourceGroupName <String> -SubscriptionId <String> -VMName <String>
 [-PassThru] [-DefaultProfile <PSObject>] [-AsJob] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzVMExtension -InputObject <IComputeIdentity> [-PassThru] [-DefaultProfile <PSObject>] [-AsJob]
