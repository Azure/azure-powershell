...
Set-AzVmssVM -InstanceId <String> -ResourceGroupName <String> -SubscriptionId <String>
 ...
 [-BootDiagnosticStorageUri <String>] [-HardwareProfileVMSize <VirtualMachineSizeTypes>]
 [-InstanceView <IVirtualMachineScaleSetVMInstanceView>] [-LicenseType <String>]
 ...
 [-PlanProduct <String>] [-PlanPromotionCode <String>] [-PlanPublisher <String>] [-SkuCapacity <Int64>]
 [-SkuName <String>] [-SkuTier <String>] [-SshPublicKey <ISshPublicKey[]>] [-StorageProfile <IStorageProfile>]
...
Set-AzVmssVM -InputObject <IComputeIdentity> -Location <String> [-AvailabilitySetId <String>]
 ...
 [-HardwareProfileVMSize <VirtualMachineSizeTypes>] [-InstanceView <IVirtualMachineScaleSetVMInstanceView>]
 ...
 [-PlanPromotionCode <String>] [-PlanPublisher <String>] [-SkuCapacity <Int64>] [-SkuName <String>]
 [-SkuTier <String>] [-SshPublicKey <ISshPublicKey[]>] [-StorageProfile <IStorageProfile>]
 [-Tag <IResourceTags>] [-WinRmListener <IWinRmListener[]>]
 [-WindowConfigurationAdditionalUnattendContent <IAdditionalUnattendContent[]>]
 [-WindowConfigurationEnableAutomaticUpdate] [-WindowConfigurationProvisionVMAgent]
 [-WindowConfigurationTimeZone <String>] [-DefaultProfile <PSObject>] [-AsJob] [-Confirm] [-WhatIf]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20171201.IVirtualMachineScaleSetVMInstanceView
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded
Aliases:
