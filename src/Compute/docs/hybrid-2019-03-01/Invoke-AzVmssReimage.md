...
online version: https://docs.microsoft.com/powershell/module/az.compute/invoke-azvmssreimage
schema: 2.0.0
---
...
Invoke-AzVmssReimage -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-InstanceId <String[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Parameter Sets: ReimageViaIdentityExpanded, ReimageViaIdentityExpanded1
Aliases:
