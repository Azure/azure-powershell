...
online version: https://docs.microsoft.com/powershell/module/az.compute/set-azdisk
schema: 2.0.0
---
...
```
Set-AzDisk -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
