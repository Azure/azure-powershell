...
online version: https://docs.microsoft.com/en-us/powershell/module/az.compute/start-azvmssrollingupgradeextensionupgrade
schema: 2.0.0
---

# Start-AzVmssRollingUpgradeExtensionUpgrade
...
### StartViaIdentity
```
Start-AzVmssRollingUpgradeExtensionUpgrade -InputObject <IComputeIdentity> [-DefaultProfile <PSObject>]
