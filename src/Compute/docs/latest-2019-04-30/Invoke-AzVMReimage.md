...
```
Invoke-AzVMReimage -InputObject <IComputeIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
...
```
Invoke-AzVMReimage -InputObject <IComputeIdentity> [-TempDisk] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
Parameter Sets: RedeployViaIdentity1, ReimageViaIdentityExpanded
Aliases:
