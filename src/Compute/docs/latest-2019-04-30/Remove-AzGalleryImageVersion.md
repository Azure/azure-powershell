...
### Delete (Default)
```
Remove-AzGalleryImageVersion -GalleryImageDefinitionName <String> -GalleryName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzGalleryImageVersion -InputObject <IComputeIdentity> [-PassThru] [-DefaultProfile <PSObject>] [-AsJob]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
