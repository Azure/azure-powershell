...
online version: https://docs.microsoft.com/powershell/module/az.compute/remove-azvmssvm
schema: 2.0.0
---
...
### Delete1 (Default)
```
Remove-AzVmssVM -InstanceId <String> -ResourceGroupName <String> -VMScaleSetName <String>
...
### DeleteViaIdentity1
```
Remove-AzVmssVM -InputObject <IComputeIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
