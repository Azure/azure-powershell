...
### Delete (Default)
```
Remove-AzGalleryImageDefinition -GalleryName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzGalleryImageDefinition -InputObject <IComputeIdentity> [-PassThru] [-DefaultProfile <PSObject>]
