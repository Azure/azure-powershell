...
online version: https://docs.microsoft.com/en-us/powershell/module/az.compute/set-azvmssextension
schema: 2.0.0
---
...
### Update1 (Default)
```
Set-AzVmssExtension -ResourceGroupName <String> -SubscriptionId <String> -VmssExtensionName <String>
