...
### PowerOff1 (Default)
```
Stop-AzVM -Name <String> -ResourceGroupName <String> -SubscriptionId <String> [-SkipShutdown] [-PassThru]
 [-DefaultProfile <PSObject>] [-AsJob] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PowerOffViaIdentity1
```
Stop-AzVM -InputObject <IComputeIdentity> [-SkipShutdown] [-PassThru] [-DefaultProfile <PSObject>] [-AsJob]
