...
online version: https://docs.microsoft.com/en-us/powershell/module/az.compute/set-azgalleryapplicationversion
schema: 2.0.0
---

# Set-AzGalleryApplicationVersion
...
```
Set-AzGalleryApplicationVersion -GalleryApplicationName <String> -GalleryName <String> -Name <String>
