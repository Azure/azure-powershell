...
online version: https://docs.microsoft.com/powershell/module/az.compute/invoke-azvmssvmreimage
schema: 2.0.0
---
...
```
Invoke-AzVmssVMReimage -InstanceId <String> -ResourceGroupName <String> -VMScaleSetName <String>
 [-SubscriptionId <String>] [-TempDisk] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ReimageViaIdentityExpanded
```
Invoke-AzVmssVMReimage -InputObject <IComputeIdentity> [-TempDisk] [-DefaultProfile <PSObject>] [-AsJob]
