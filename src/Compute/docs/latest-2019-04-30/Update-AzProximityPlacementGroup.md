...
online version: https://docs.microsoft.com/powershell/module/az.compute/update-azproximityplacementgroup
schema: 2.0.0
---
...
```
Update-AzProximityPlacementGroup -InputObject <IComputeIdentity> [-Tag <Hashtable>]
