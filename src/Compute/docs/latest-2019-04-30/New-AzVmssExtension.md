...
online version: https://docs.microsoft.com/powershell/module/az.compute/new-azvmssextension
schema: 2.0.0
---
...
```
New-AzVmssExtension -ExtensionName <String> -ResourceGroupName <String> -VmssName <String>
