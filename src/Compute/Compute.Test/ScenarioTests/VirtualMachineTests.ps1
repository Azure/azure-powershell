...
function Test-VirtualMachineHibernate
{
    ...
    try
    {
        ...
        $password = "Testing1234567";# $PLACEHOLDER
        $securePassword = ConvertTo-SecureString $password -AsPlainText -Force;
        $cred = New-Object System.Management.Automation.PSCredential ($user, $securePassword);
        $computerName = 'test';
        ...
        $vmUp = Set-AzVMOperatingSystem -VM $vm -ComputerName "newcomp" -Credential $cred -Windows;
        Update-AzVM -ResourceGroupName $rgname -VM $vmUp;
    }
    finally 
    {
        # Cleanup
