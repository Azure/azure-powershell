...
function Test-VirtualMachineStopForceDeallocate
{
    ...
    Assert-False { $resourceGroupHibernateSet.Parameters.Name -contains "ForceDeallocate" };
    Assert-False { $idHibernateSet.Parameters.Name -contains "ForceDeallocate" };
    ...
    Assert-ThrowsContains { Stop-AzVM -ResourceGroupName "rg" -Name "vm" -ForceDeallocate -Hibernate -Force -ErrorAction Stop; } "Parameter set cannot be resolved";
}
