...
<#
.SYNOPSIS
Test that the SecurityProfile property is filled when looking at a snapshot of 
a Trusted Launch VM disk.
#>
function Test-SnapshotTrustedLaunchSecurityProfile
{
    $rgname = Get-ComputeTestResourceName;
	$loc = 'northeurope';
...
<#
.SYNOPSIS
Test the new disk CreateOption values of ImportSecure and UploadPreparedSecure
#>
function Test-DiskImportSecureUploadPreparedSecure
{
    $rgname = Get-ComputeTestResourceName;
	$loc = 'northeurope';
    #$snapLoc = 'Central US';
