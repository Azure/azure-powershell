...
function Test-DiagnosticsExtensionSepcifyStorageAccountName
{
    ...
    try
    {
        ...
        Set-AzVMDiagnosticsExtension -ResourceGroupName $rgname -VMName $vmname -DiagnosticsConfigurationPath "$TestOutputRoot\ConfigFiles\DiagnosticsExtensionConfig.xml" -StorageAccountName $storagename
        $extension = Get-AzVMDiagnosticsExtension -ResourceGroupName $rgname -VMName $vmname
...
function Test-DiagnosticsExtensionSupportJsonConfig
{
    ...
    try
    {
        ...
        Set-AzVMDiagnosticsExtension -ResourceGroupName $rgname -VMName $vmname -DiagnosticsConfigurationPath "$TestOutputRoot\ConfigFiles\DiagnosticsExtensionConfig.json" -StorageAccountName $storagename
        $extension = Get-AzVMDiagnosticsExtension -ResourceGroupName $rgname -VMName $vmname
