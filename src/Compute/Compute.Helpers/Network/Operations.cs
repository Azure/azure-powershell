...
namespace Microsoft.Azure.Commands.Compute.Helpers.Network
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<NetworkManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(NetworkManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Network/operations").ToString();
