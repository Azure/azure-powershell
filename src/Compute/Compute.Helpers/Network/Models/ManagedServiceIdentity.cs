...
namespace Microsoft.Azure.Commands.Compute.Helpers.Network.Models
{
    ...
    public partial class ManagedServiceIdentity
    {
        ...
        public ManagedServiceIdentity(string principalId = default(string), string tenantId = default(string), ResourceIdentityType? type = default(ResourceIdentityType?), IDictionary<string, ManagedServiceIdentityUserAssignedIdentitiesValue> userAssignedIdentities = default(IDictionary<string, ManagedServiceIdentityUserAssignedIdentitiesValue>))
        {
