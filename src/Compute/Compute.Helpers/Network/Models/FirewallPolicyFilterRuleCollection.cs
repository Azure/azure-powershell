...
namespace Microsoft.Azure.Commands.Compute.Helpers.Network.Models
{
    ...
    public partial class FirewallPolicyFilterRuleCollection : FirewallPolicyRuleCollection
    {
        ...
        /// <param name="action">The action type of a Filter rule
        /// collection.</param>
        /// <param name="rules">List of rules included in a rule
        /// collection.</param>
        public FirewallPolicyFilterRuleCollection(string name = default(string), int? priority = default(int?), FirewallPolicyFilterRuleCollectionAction action = default(FirewallPolicyFilterRuleCollectionAction), IList<FirewallPolicyRule> rules = default(IList<FirewallPolicyRule>))
            : base(name, priority)
        {
            Action = action;
            Rules = rules;
