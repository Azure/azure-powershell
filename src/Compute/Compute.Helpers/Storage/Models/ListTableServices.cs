...
namespace Microsoft.Azure.Commands.Compute.Helpers.Storage.Models
{
    ...
    public partial class ListTableServices
    {
        ...
        public ListTableServices(IList<TableServiceProperties> value = default(IList<TableServiceProperties>))
        {
            Value = value;
            CustomInit();
        }
        ...
        public IList<TableServiceProperties> Value { get; private set; }
