@{
  ...
  CmdletsToExport = 'ConvertTo-AzVMManagedDisk', 'ConvertTo-AzVmssSinglePlacementGroup', 'Export-AzLogAnalyticRequestRateByInterval', 'Export-AzLogAnalyticThrottledRequest', 'Get-AzAvailabilitySet', 'Get-AzComputeResourceSku', 'Get-AzDisk', 'Get-AzGallery', 'Get-AzGalleryApplication', 'Get-AzGalleryApplicationVersion', 'Get-AzGalleryImageDefinition', 'Get-AzGalleryImageVersion', 'Get-AzImage', 'Get-AzProximityPlacementGroup', 'Get-AzSnapshot', 'Get-AzVM', 'Get-AzVMExtension', 'Get-AzVMExtensionImage', 'Get-AzVMExtensionImageType', 'Get-AzVMImage', 'Get-AzVMImageOffer', 'Get-AzVMImagePublisher', 'Get-AzVMImageSku', 'Get-AzVMRunCommandDocument', 'Get-AzVMSize', 'Get-AzVmss', 'Get-AzVmssExtension', 'Get-AzVmssRollingUpgrade', 'Get-AzVmssSku', 'Get-AzVmssVM', 'Get-AzVMUsage', 'Grant-AzDiskAccess', 'Grant-AzSnapshotAccess', 'Invoke-AzVMCommand', 'Invoke-AzVMReimage', 'Invoke-AzVmssReimage', 'Invoke-AzVmssVMCommand', 'Invoke-AzVmssVMReimage', 'New-AzAvailabilitySet', 'New-AzDisk', 'New-AzGallery', 'New-AzGalleryApplication', 'New-AzGalleryApplicationVersion', 'New-AzGalleryImageDefinition', 'New-AzGalleryImageVersion', 'New-AzImage', 'New-AzProximityPlacementGroup', 'New-AzSnapshot', 'New-AzVM', 'New-AzVMExtension', 'New-AzVmss', 'New-AzVmssExtension', 'Remove-AzAvailabilitySet', 'Remove-AzDisk', 'Remove-AzGallery', 'Remove-AzGalleryApplication', 'Remove-AzGalleryApplicationVersion', 'Remove-AzGalleryImageDefinition', 'Remove-AzGalleryImageVersion', 'Remove-AzImage', 'Remove-AzProximityPlacementGroup', 'Remove-AzSnapshot', 'Remove-AzVM', 'Remove-AzVMExtension', 'Remove-AzVmss', 'Remove-AzVmssExtension', 'Remove-AzVmssInstance', 'Remove-AzVmssVM', 'Repair-AzVmssServiceFabricUpdateDomain', 'Restart-AzVM', 'Restart-AzVmss', 'Restart-AzVmssVM', 'Revoke-AzDiskAccess', 'Revoke-AzSnapshotAccess', 'Save-AzVMImage', 'Set-AzAvailabilitySet', 'Set-AzDisk', 'Set-AzGalleryApplication', 'Set-AzGalleryApplicationVersion', 'Set-AzImage', 'Set-AzProximityPlacementGroup', 'Set-AzSnapshot', 'Set-AzVM', 'Set-AzVMExtension', 'Set-AzVmss', 'Set-AzVmssExtension', 'Set-AzVmssVM', 'Start-AzVM', 'Start-AzVmss', 'Start-AzVmssRollingOSUpgrade', 'Start-AzVmssRollingUpgradeExtensionUpgrade', 'Start-AzVmssVM', 'Stop-AzVM', 'Stop-AzVmss', 'Stop-AzVmssRollingUpgrade', 'Stop-AzVmssVM', 'Update-AzAvailabilitySet', 'Update-AzDisk', 'Update-AzGallery', 'Update-AzGalleryImageDefinition', 'Update-AzGalleryImageVersion', 'Update-AzImage', 'Update-AzProximityPlacementGroup', 'Update-AzSnapshot', 'Update-AzVM', 'Update-AzVMExtension', 'Update-AzVmss', 'Update-AzVmssInstance', '*'
