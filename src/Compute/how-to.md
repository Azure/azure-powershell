...
- `build-module.ps1`
  - Builds the module DLL (`./bin/Az.Compute.private.dll`), creates the exported cmdlets, generates custom cmdlet test stubs, and updates `./Az.Compute.psd1` with Azure profile information.
