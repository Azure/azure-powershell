...
namespace Microsoft.Azure.Management.Compute
{
    ...
    internal partial class DedicatedHostsOperations : Microsoft.Rest.IServiceOperations<ComputeManagementClient>, IDedicatedHostsOperations
    {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<DedicatedHost> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, hostGroupName, hostName, parameters, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<DedicatedHost> _response = await BeginUpdateWithHttpMessagesAsync(resourceGroupName, hostGroupName, hostName, parameters, customHeaders, cancellationToken).ConfigureAwait(false);
                return await this.Client.GetPutOrPatchOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse _response = await BeginRestartWithHttpMessagesAsync(resourceGroupName, hostGroupName, hostName, customHeaders, cancellationToken).ConfigureAwait(false);
                return await this.Client.GetPostOrDeleteOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<System.Collections.Generic.IEnumerable<string>>> ListAvailableSizesWithHttpMessagesAsync(string resourceGroupName, string hostGroupName, string hostName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (hostGroupName != null)
            {
                if (!System.Text.RegularExpressions.Regex.IsMatch(hostGroupName, "^[-\\w\\._]+$"))
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.Pattern, "hostGroupName", "^[-\\w\\._]+$");
                }
            }
            if (hostName == null)
            {
            ...
            if (hostName != null)
            {
                if (!System.Text.RegularExpressions.Regex.IsMatch(hostName, "^[-\\w\\._]+$"))
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.Pattern, "hostName", "^[-\\w\\._]+$");
                }
            }
            if (this.Client.SubscriptionId == null)
            {
