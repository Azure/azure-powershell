...
namespace Microsoft.Azure.Management.Compute
{
    ...
    public partial interface IRestorePointsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationHeaderResponse<RestorePointsDeleteHeaders>> DeleteWithHttpMessagesAsync(string resourceGroupName, string restorePointCollectionName, string restorePointName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// The operation to create the restore point. Updating properties of
        /// an existing restore point is not allowed
        /// </summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<RestorePoint,RestorePointsCreateHeaders>> BeginCreateWithHttpMessagesAsync(string resourceGroupName, string restorePointCollectionName, string restorePointName, RestorePoint parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// The operation to delete the restore point.
        /// </summary>
        /// <param name='resourceGroupName'>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationHeaderResponse<RestorePointsDeleteHeaders>> BeginDeleteWithHttpMessagesAsync(string resourceGroupName, string restorePointCollectionName, string restorePointName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
