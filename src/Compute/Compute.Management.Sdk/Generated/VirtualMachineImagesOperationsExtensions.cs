...
namespace Microsoft.Azure.Management.Compute
{
    ...
    public static partial class VirtualMachineImagesOperationsExtensions
    {
            ...
            /// <param name='orderby'>
            /// </param>
            public static IPage<VirtualMachineImage> ListWithProperties(this IVirtualMachineImagesOperations operations, string location, string publisherName, string offer, string skus, string expand, int? top = default(int?), string orderby = default(string))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<VirtualMachineImage>> ListWithPropertiesAsync(this IVirtualMachineImagesOperations operations, string location, string publisherName, string offer, string skus, string expand, int? top = default(int?), string orderby = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
