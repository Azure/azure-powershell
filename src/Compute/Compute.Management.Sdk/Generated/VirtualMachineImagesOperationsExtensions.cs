...
namespace Microsoft.Azure.Management.Compute
{
    ...
    public static partial class VirtualMachineImagesOperationsExtensions
    {
        ...
        {
                return ((IVirtualMachineImagesOperations)operations).ListByEdgeZoneAsync(location, edgeZone).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<VmImagesInEdgeZoneListResult> ListByEdgeZoneAsync(this IVirtualMachineImagesOperations operations, string location, string edgeZone, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
                return ((IVirtualMachineImagesOperations)operations).ListPublishersAsync(location).GetAwaiter().GetResult();
        }
        ...
        {
                return ((IVirtualMachineImagesOperations)operations).ListOffersAsync(location, publisherName).GetAwaiter().GetResult();
        }
        ...
        {
                return ((IVirtualMachineImagesOperations)operations).ListSkusAsync(location, publisherName, offer).GetAwaiter().GetResult();
        }
        ...
        /// 
        /// </param>
        public static System.Collections.Generic.IList<VirtualMachineImageResource> List(this IVirtualMachineImagesOperations operations, string location, string publisherName, string offer, string skus, string expand = default(string), int? top = default(int?), string orderby = default(string))
        {
                return ((IVirtualMachineImagesOperations)operations).ListAsync(location, publisherName, offer, skus, expand, top, orderby).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<System.Collections.Generic.IList<VirtualMachineImageResource>> ListAsync(this IVirtualMachineImagesOperations operations, string location, string publisherName, string offer, string skus, string expand = default(string), int? top = default(int?), string orderby = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
                return ((IVirtualMachineImagesOperations)operations).GetAsync(location, publisherName, offer, skus, version).GetAwaiter().GetResult();
        }
        ...
        /// 
        /// </param>
        public static System.Collections.Generic.IList<VirtualMachineImage> ListWithProperties(this IVirtualMachineImagesOperations operations, string location, string publisherName, string offer, string skus, string expand, int? top = default(int?), string orderby = default(string))
        {
                return ((IVirtualMachineImagesOperations)operations).ListWithPropertiesAsync(location, publisherName, offer, skus, expand, top, orderby).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<System.Collections.Generic.IList<VirtualMachineImage>> ListWithPropertiesAsync(this IVirtualMachineImagesOperations operations, string location, string publisherName, string offer, string skus, string expand, int? top = default(int?), string orderby = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
