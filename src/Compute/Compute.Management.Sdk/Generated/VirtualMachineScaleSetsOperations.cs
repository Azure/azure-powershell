...
namespace Microsoft.Azure.Management.Compute
{
    ...
    internal partial class VirtualMachineScaleSetsOperations : Microsoft.Rest.IServiceOperations<ComputeManagementClient>, IVirtualMachineScaleSetsOperations
    {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationHeaderResponse<VirtualMachineScaleSetsMigrateVMAvailabilityZoneHeaders> _response = await BeginMigrateVMAvailabilityZoneWithHttpMessagesAsync(resourceGroupName, vmScaleSetName, body, customHeaders, cancellationToken).ConfigureAwait(false);
                return await this.Client.GetPostOrDeleteOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationHeaderResponse<VirtualMachineScaleSetsMigrateVMAvailabilityZoneHeaders>> BeginMigrateVMAvailabilityZoneWithHttpMessagesAsync(string resourceGroupName, string vmScaleSetName, MigrateVMAvailabilityZoneInput body, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("cancellationToken", cancellationToken);
                Microsoft.Rest.ServiceClientTracing.Enter(_invocationId, this, "BeginMigrateVMAvailabilityZone", tracingParameters);
            }
            // Construct URL

            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/migrateVMAvailabilityZone").ToString();
            _url = _url.Replace("{subscriptionId}", System.Uri.EscapeDataString(this.Client.SubscriptionId));
            _url = _url.Replace("{resourceGroupName}", System.Uri.EscapeDataString(resourceGroupName));
            _url = _url.Replace("{vmScaleSetName}", System.Uri.EscapeDataString(vmScaleSetName));
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationHeaderResponse<VirtualMachineScaleSetsMigrateVMAvailabilityZoneHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<VirtualMachineScaleSetsMigrateVMAvailabilityZoneHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
            catch (Newtonsoft.Json.JsonException ex)
            {
                _httpRequest.Dispose();
