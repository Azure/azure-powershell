...
namespace Microsoft.Azure.Management.Compute
{
    ...
    internal partial class VirtualMachineScaleSetsOperations : Microsoft.Rest.IServiceOperations<ComputeManagementClient>, IVirtualMachineScaleSetsOperations
    {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<VirtualMachineScaleSet> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, vmScaleSetName, parameters, ifMatch, ifNoneMatch, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<VirtualMachineScaleSet> _response = await BeginUpdateWithHttpMessagesAsync(resourceGroupName, vmScaleSetName, parameters, ifMatch, ifNoneMatch, customHeaders, cancellationToken).ConfigureAwait(false);
                return await this.Client.GetPutOrPatchOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
