...
namespace Microsoft.Azure.Management.Compute
{
    ...
    internal partial class RestorePointCollectionsOperations : IServiceOperations<ComputeManagementClient>, IRestorePointCollectionsOperations
    {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationHeaderResponse<RestorePointCollectionsDeleteHeaders>> DeleteWithHttpMessagesAsync(string resourceGroupName, string restorePointCollectionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
            AzureOperationHeaderResponse<RestorePointCollectionsDeleteHeaders> _response = await BeginDeleteWithHttpMessagesAsync(resourceGroupName, restorePointCollectionName, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationHeaderResponse<RestorePointCollectionsDeleteHeaders>> BeginDeleteWithHttpMessagesAsync(string resourceGroupName, string restorePointCollectionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
            ...
            // Create Result
            var _result = new AzureOperationHeaderResponse<RestorePointCollectionsDeleteHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<RestorePointCollectionsDeleteHeaders>(JsonSerializer.Create(Client.DeserializationSettings));
            }
            catch (JsonException ex)
            {
                _httpRequest.Dispose();
