...
namespace Microsoft.Azure.Management.Compute
{
    ...
    public static partial class CommunityGalleriesOperationsExtensions
    {
        ...
        {
                return ((ICommunityGalleriesOperations)operations).GetAsync(location, publicGalleryName).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<CommunityGallery> GetAsync(this ICommunityGalleriesOperations operations, string location, string publicGalleryName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
