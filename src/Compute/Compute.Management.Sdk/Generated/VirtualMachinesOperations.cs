...
namespace Microsoft.Azure.Management.Compute
{
    ...
    internal partial class VirtualMachinesOperations : Microsoft.Rest.IServiceOperations<ComputeManagementClient>, IVirtualMachinesOperations
    {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<VirtualMachine> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, vmName, parameters, ifMatch, ifNoneMatch, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<VirtualMachine> _response = await BeginUpdateWithHttpMessagesAsync(resourceGroupName, vmName, parameters, ifMatch, ifNoneMatch, customHeaders, cancellationToken).ConfigureAwait(false);
                return await this.Client.GetPutOrPatchOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
