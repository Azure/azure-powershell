...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for PerformMaintenance operation.
    /// </summary>
    public partial class VirtualMachinesPerformMaintenanceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachinesPerformMaintenanceHeaders class.
        /// </summary>
        public VirtualMachinesPerformMaintenanceHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachinesPerformMaintenanceHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
