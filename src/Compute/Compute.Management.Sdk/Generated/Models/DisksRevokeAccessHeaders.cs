...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class DisksRevokeAccessHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DisksRevokeAccessHeaders class.
        /// </summary>
        public DisksRevokeAccessHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DisksRevokeAccessHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
