...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class DiskEncryptionSetsCreateOrUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DiskEncryptionSetsCreateOrUpdateHeaders class.
        /// </summary>
        public DiskEncryptionSetsCreateOrUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DiskEncryptionSetsCreateOrUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
