...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetsDeleteHeaders class.
        /// </summary>
        public VirtualMachineScaleSetsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
