...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for ConvertToVirtualMachineScaleSet operation.
    /// </summary>
    public partial class AvailabilitySetsConvertToVirtualMachineScaleSetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// AvailabilitySetsConvertToVirtualMachineScaleSetHeaders class.
        /// </summary>
        public AvailabilitySetsConvertToVirtualMachineScaleSetHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public AvailabilitySetsConvertToVirtualMachineScaleSetHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
