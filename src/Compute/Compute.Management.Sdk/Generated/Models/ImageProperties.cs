...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class ImageProperties
    {
        ...
        public ImageProperties(SubResource sourceVirtualMachine = default(SubResource), ImageStorageProfile storageProfile = default(ImageStorageProfile), string provisioningState = default(string), string hyperVGeneration = default(string))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "sourceVirtualMachine")]
