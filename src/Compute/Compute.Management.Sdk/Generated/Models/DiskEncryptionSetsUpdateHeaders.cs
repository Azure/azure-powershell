...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class DiskEncryptionSetsUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DiskEncryptionSetsUpdateHeaders
        /// class.
        /// </summary>
        public DiskEncryptionSetsUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DiskEncryptionSetsUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
