...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class DedicatedHost : TrackedResource
    {
        ...
        /// <param name="sku">SKU of the dedicated host for Hardware Generation and VM family. Only name
        ...
        /// </param>
        public DedicatedHost(string location, Sku sku, string id = default(string), string name = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), int? platformFaultDomain = default(int?), bool? autoReplaceOnFailure = default(bool?), string hostId = default(string), System.Collections.Generic.IList<SubResourceReadOnly> virtualMachines = default(System.Collections.Generic.IList<SubResourceReadOnly>), DedicatedHostLicenseTypes? licenseType = default(DedicatedHostLicenseTypes?), System.DateTime? provisioningTime = default(System.DateTime?), string provisioningState = default(string), DedicatedHostInstanceView instanceView = default(DedicatedHostInstanceView), System.DateTime? timeCreated = default(System.DateTime?))
        ...
        /// <summary>
        /// Gets or sets sKU of the dedicated host for Hardware Generation and VM
        /// family. Only name is required to be set. List Microsoft.Compute SKUs for a
