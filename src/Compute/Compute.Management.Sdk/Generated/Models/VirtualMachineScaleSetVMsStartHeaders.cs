...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetVMsStartHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetVMsStartHeaders class.
        /// </summary>
        public VirtualMachineScaleSetVMsStartHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetVMsStartHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
