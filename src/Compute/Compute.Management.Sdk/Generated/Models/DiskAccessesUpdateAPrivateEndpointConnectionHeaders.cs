...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateAPrivateEndpointConnection operation.
    /// </summary>
    public partial class DiskAccessesUpdateAPrivateEndpointConnectionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DiskAccessesUpdateAPrivateEndpointConnectionHeaders class.
        /// </summary>
        public DiskAccessesUpdateAPrivateEndpointConnectionHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DiskAccessesUpdateAPrivateEndpointConnectionHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
