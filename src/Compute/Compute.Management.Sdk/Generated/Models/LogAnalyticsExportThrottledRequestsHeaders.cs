...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for ExportThrottledRequests operation.
    /// </summary>
    public partial class LogAnalyticsExportThrottledRequestsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// LogAnalyticsExportThrottledRequestsHeaders class.
        /// </summary>
        public LogAnalyticsExportThrottledRequestsHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public LogAnalyticsExportThrottledRequestsHeaders(string azureAsyncOperation = default(string), int? retryAfter = default(int?))
        {
