...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetVMsRunCommandHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetVMsRunCommandHeaders class.
        /// </summary>
        public VirtualMachineScaleSetVMsRunCommandHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetVMsRunCommandHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
