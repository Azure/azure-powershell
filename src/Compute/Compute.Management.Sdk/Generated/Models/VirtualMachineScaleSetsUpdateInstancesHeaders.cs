...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateInstances operation.
    /// </summary>
    public partial class VirtualMachineScaleSetsUpdateInstancesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetsUpdateInstancesHeaders class.
        /// </summary>
        public VirtualMachineScaleSetsUpdateInstancesHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetsUpdateInstancesHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
