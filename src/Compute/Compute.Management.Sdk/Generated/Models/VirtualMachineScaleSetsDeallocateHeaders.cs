...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetsDeallocateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetsDeallocateHeaders class.
        /// </summary>
        public VirtualMachineScaleSetsDeallocateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetsDeallocateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
