...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetsRedeployHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetsRedeployHeaders class.
        /// </summary>
        public VirtualMachineScaleSetsRedeployHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetsRedeployHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
