...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class RollingUpgradeProgressInfo
    {
        ...
        /// <param name="successfulInstanceCount">The number of instances that have been successfully upgraded.
        /// </param>

        /// <param name="failedInstanceCount">The number of instances that have failed to be upgraded successfully.
        /// </param>

        /// <param name="inProgressInstanceCount">The number of instances that are currently being upgraded.
        /// </param>

        /// <param name="pendingInstanceCount">The number of instances that have not yet begun to be upgraded.
        /// </param>
