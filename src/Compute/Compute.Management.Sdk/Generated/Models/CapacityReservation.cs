...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class CapacityReservation : Resource
    {
        ...
        /// <param name="zones">Availability Zone to use for this capacity reservation. The zone has to be
        /// single value and also should be part for the list of zones specified during
        /// the capacity reservation group creation. The zone can be assigned only
        /// during creation. If not provided, the reservation supports only non-zonal
        /// deployments. If provided, enforces VM/VMSS using this capacity reservation
        /// to be in same zone.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets availability Zone to use for this capacity reservation. The
        /// zone has to be single value and also should be part for the list of zones
        /// specified during the capacity reservation group creation. The zone can be
