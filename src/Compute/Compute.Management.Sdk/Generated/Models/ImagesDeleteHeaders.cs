...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class ImagesDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ImagesDeleteHeaders class.
        /// </summary>
        public ImagesDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public ImagesDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
