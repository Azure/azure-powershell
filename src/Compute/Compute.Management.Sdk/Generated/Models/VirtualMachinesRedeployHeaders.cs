...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachinesRedeployHeaders
    {
        /// <summary>
        /// Initializes a new instance of the VirtualMachinesRedeployHeaders
        /// class.
        /// </summary>
        public VirtualMachinesRedeployHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachinesRedeployHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
