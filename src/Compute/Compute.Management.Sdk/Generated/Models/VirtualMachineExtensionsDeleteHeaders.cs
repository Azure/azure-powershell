...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineExtensionsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineExtensionsDeleteHeaders class.
        /// </summary>
        public VirtualMachineExtensionsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineExtensionsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
