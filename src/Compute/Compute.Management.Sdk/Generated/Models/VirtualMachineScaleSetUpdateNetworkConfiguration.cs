...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class VirtualMachineScaleSetUpdateNetworkConfiguration
    {
        ...
        public VirtualMachineScaleSetUpdateNetworkConfiguration(string name = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), bool? primary = default(bool?), bool? enableAcceleratedNetworking = default(bool?), bool? disableTcpStateTracking = default(bool?), bool? enableFpga = default(bool?), SubResource networkSecurityGroup = default(SubResource), VirtualMachineScaleSetNetworkConfigurationDnsSettings dnsSettings = default(VirtualMachineScaleSetNetworkConfigurationDnsSettings), System.Collections.Generic.IList<VirtualMachineScaleSetUpdateIPConfiguration> ipConfigurations = default(System.Collections.Generic.IList<VirtualMachineScaleSetUpdateIPConfiguration>), bool? enableIPForwarding = default(bool?), string deleteOption = default(string), string auxiliaryMode = default(string), string auxiliarySku = default(string))
