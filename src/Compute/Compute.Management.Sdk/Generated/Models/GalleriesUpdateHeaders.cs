...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class GalleriesUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GalleriesUpdateHeaders class.
        /// </summary>
        public GalleriesUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public GalleriesUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
