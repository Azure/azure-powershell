...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class GalleryImagesDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GalleryImagesDeleteHeaders class.
        /// </summary>
        public GalleryImagesDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public GalleryImagesDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
