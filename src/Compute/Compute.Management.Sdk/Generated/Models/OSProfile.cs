...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class OSProfile
    {
        ...
        /// <param name="computerName">Specifies the host OS name of the virtual machine. This name cannot be
        ...
        /// <summary>
        /// Gets or sets specifies the host OS name of the virtual machine. This name
        /// cannot be updated after the VM is created. **Max-length (Windows):** 15
        /// characters. **Max-length (Linux):** 64 characters. For naming conventions
        /// and restrictions see [Azure infrastructure services implementation
        /// guidelines](https://docs.microsoft.com/azure/azure-resource-manager/management/resource-name-rules).
        /// </summary>
        ...
        /// property cannot be updated after the VM is created. The property
        ...
        /// the virtual machine. This may only be set to False when no extensions are
