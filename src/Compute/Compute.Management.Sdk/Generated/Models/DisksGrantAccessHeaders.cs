...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for GrantAccess operation.
    /// </summary>
    public partial class DisksGrantAccessHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DisksGrantAccessHeaders class.
        /// </summary>
        public DisksGrantAccessHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DisksGrantAccessHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
