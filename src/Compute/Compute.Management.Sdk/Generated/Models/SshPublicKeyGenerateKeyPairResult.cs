...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class SshPublicKeyGenerateKeyPairResult
    {
        ...
        /// <param name="privateKey">Private key portion of the key pair used to authenticate to a virtual
        /// machine through ssh. The private key is returned in RFC3447 format and
        /// should be treated as a secret.
        /// </param>

        /// <param name="publicKey">Public key portion of the key pair used to authenticate to a virtual
        ...
        /// <summary>
        /// Gets or sets private key portion of the key pair used to authenticate to a
        /// virtual machine through ssh. The private key is returned in RFC3447 format
        ...
        /// <summary>
        /// Gets or sets public key portion of the key pair used to authenticate to a
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "PublicKey");
            }
            if (this.Id == null)
            {
