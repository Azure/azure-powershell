...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachinesReimageHeaders
    {
        /// <summary>
        /// Initializes a new instance of the VirtualMachinesReimageHeaders
        /// class.
        /// </summary>
        public VirtualMachinesReimageHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachinesReimageHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
