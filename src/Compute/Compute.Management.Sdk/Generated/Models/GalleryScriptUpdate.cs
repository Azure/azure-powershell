...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Specifies information about the gallery Script Definition that you want to
    /// update.
    /// </summary>
    [Microsoft.Rest.Serialization.JsonTransformation]
    public partial class GalleryScriptUpdate : UpdateResourceDefinition
    {
        /// <summary>
        /// Initializes a new instance of the GalleryScriptUpdate class.
        /// </summary>
        ...
        public GalleryScriptUpdate(string id = default(string), string name = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string description = default(string), string eula = default(string), string privacyStatementUri = default(string), string releaseNoteUri = default(string), System.DateTime? endOfLifeDate = default(System.DateTime?), OperatingSystemTypes? supportedOSType = default(OperatingSystemTypes?), string provisioningState = default(string))
