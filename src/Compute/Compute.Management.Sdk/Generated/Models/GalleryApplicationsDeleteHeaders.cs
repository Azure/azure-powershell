...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class GalleryApplicationsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GalleryApplicationsDeleteHeaders
        /// class.
        /// </summary>
        public GalleryApplicationsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public GalleryApplicationsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
