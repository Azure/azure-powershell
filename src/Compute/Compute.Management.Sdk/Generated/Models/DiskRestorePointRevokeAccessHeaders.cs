...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class DiskRestorePointRevokeAccessHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DiskRestorePointRevokeAccessHeaders class.
        /// </summary>
        public DiskRestorePointRevokeAccessHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DiskRestorePointRevokeAccessHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
