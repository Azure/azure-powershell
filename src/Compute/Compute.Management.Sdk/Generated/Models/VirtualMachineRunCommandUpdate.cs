...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class VirtualMachineRunCommandUpdate : UpdateResource
    {
        ...
        /// https://aka.ms/runcommandmanaged#get-execution-status-and-results
        /// </param>
        public VirtualMachineRunCommandUpdate(System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), VirtualMachineRunCommandScriptSource source = default(VirtualMachineRunCommandScriptSource), System.Collections.Generic.IList<RunCommandInputParameter> parameters = default(System.Collections.Generic.IList<RunCommandInputParameter>), System.Collections.Generic.IList<RunCommandInputParameter> protectedParameters = default(System.Collections.Generic.IList<RunCommandInputParameter>), bool? asyncExecution = default(bool?), string runAsUser = default(string), string runAsPassword = default(string), int? timeoutInSeconds = default(int?), string outputBlobUri = default(string), string errorBlobUri = default(string), RunCommandManagedIdentity outputBlobManagedIdentity = default(RunCommandManagedIdentity), RunCommandManagedIdentity errorBlobManagedIdentity = default(RunCommandManagedIdentity), string provisioningState = default(string), VirtualMachineRunCommandInstanceView instanceView = default(VirtualMachineRunCommandInstanceView), bool? treatFailureAsDeploymentFailure = default(bool?))
