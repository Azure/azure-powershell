...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachinesReapplyHeaders
    {
        /// <summary>
        /// Initializes a new instance of the VirtualMachinesReapplyHeaders
        /// class.
        /// </summary>
        public VirtualMachinesReapplyHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachinesReapplyHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
