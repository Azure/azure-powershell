...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class VirtualMachineScaleSetVMProtectionPolicy
    {
        ...
        /// <param name="protectFromScaleIn">Indicates that the virtual machine scale set VM shouldn&#39;t be considered for
        /// deletion during a scale-in operation.
        /// </param>

        /// <param name="protectFromScaleSetActions">Indicates that model updates or actions (including scale-in) initiated on
        /// the virtual machine scale set should not be applied to the virtual machine
        /// scale set VM.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets indicates that the virtual machine scale set VM shouldn&#39;t be
        ...
        /// <summary>
        /// Gets or sets indicates that model updates or actions (including scale-in)
        /// initiated on the virtual machine scale set should not be applied to the
