...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class GalleryApplicationVersion : TrackedResource
    {
        ...
        public GalleryApplicationVersion(string location, string id = default(string), string name = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), ReplicationStatus replicationStatus = default(ReplicationStatus), GalleryApplicationVersionPublishingProfile publishingProfile = default(GalleryApplicationVersionPublishingProfile), GalleryApplicationVersionSafetyProfile safetyProfile = default(GalleryApplicationVersionSafetyProfile), string provisioningState = default(string))
