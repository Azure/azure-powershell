...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class RestorePointCollectionsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// RestorePointCollectionsDeleteHeaders class.
        /// </summary>
        public RestorePointCollectionsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public RestorePointCollectionsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
