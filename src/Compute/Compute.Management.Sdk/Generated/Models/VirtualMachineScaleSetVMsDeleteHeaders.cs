...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetVMsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetVMsDeleteHeaders class.
        /// </summary>
        public VirtualMachineScaleSetVMsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetVMsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
