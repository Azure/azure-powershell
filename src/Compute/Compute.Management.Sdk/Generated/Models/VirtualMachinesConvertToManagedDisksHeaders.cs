...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for ConvertToManagedDisks operation.
    /// </summary>
    public partial class VirtualMachinesConvertToManagedDisksHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachinesConvertToManagedDisksHeaders class.
        /// </summary>
        public VirtualMachinesConvertToManagedDisksHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachinesConvertToManagedDisksHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
