...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for Capture operation.
    /// </summary>
    public partial class VirtualMachinesCaptureHeaders
    {
        /// <summary>
        /// Initializes a new instance of the VirtualMachinesCaptureHeaders
        /// class.
        /// </summary>
        public VirtualMachinesCaptureHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachinesCaptureHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
