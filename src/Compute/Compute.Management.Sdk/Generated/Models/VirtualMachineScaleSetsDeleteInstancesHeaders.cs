...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteInstances operation.
    /// </summary>
    public partial class VirtualMachineScaleSetsDeleteInstancesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetsDeleteInstancesHeaders class.
        /// </summary>
        public VirtualMachineScaleSetsDeleteInstancesHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetsDeleteInstancesHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
