...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetVMsPowerOffHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetVMsPowerOffHeaders class.
        /// </summary>
        public VirtualMachineScaleSetVMsPowerOffHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetVMsPowerOffHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
