...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachinesRunCommandHeaders
    {
        /// <summary>
        /// Initializes a new instance of the VirtualMachinesRunCommandHeaders
        /// class.
        /// </summary>
        public VirtualMachinesRunCommandHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachinesRunCommandHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
