...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetVMExtensionsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetVMExtensionsDeleteHeaders class.
        /// </summary>
        public VirtualMachineScaleSetVMExtensionsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetVMExtensionsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
