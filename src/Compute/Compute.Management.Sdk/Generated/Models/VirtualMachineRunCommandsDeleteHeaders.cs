...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineRunCommandsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineRunCommandsDeleteHeaders class.
        /// </summary>
        public VirtualMachineRunCommandsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineRunCommandsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
