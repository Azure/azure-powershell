...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetVMRunCommandsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetVMRunCommandsDeleteHeaders class.
        /// </summary>
        public VirtualMachineScaleSetVMRunCommandsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetVMRunCommandsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
