...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for AssessPatches operation.
    /// </summary>
    public partial class VirtualMachinesAssessPatchesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachinesAssessPatchesHeaders class.
        /// </summary>
        public VirtualMachinesAssessPatchesHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachinesAssessPatchesHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
