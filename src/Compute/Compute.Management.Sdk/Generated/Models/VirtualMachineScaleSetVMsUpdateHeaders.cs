...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetVMsUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetVMsUpdateHeaders class.
        /// </summary>
        public VirtualMachineScaleSetVMsUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetVMsUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
