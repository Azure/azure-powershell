...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class SnapshotsUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SnapshotsUpdateHeaders class.
        /// </summary>
        public SnapshotsUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public SnapshotsUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
