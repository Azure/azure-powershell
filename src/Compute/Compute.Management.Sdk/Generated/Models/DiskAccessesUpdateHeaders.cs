...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class DiskAccessesUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DiskAccessesUpdateHeaders class.
        /// </summary>
        public DiskAccessesUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DiskAccessesUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
