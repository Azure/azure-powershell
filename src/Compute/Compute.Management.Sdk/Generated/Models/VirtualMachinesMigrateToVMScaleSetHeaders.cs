...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for migrateToVMScaleSet operation.
    /// </summary>
    public partial class VirtualMachinesMigrateToVMScaleSetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachinesMigrateToVMScaleSetHeaders class.
        /// </summary>
        public VirtualMachinesMigrateToVMScaleSetHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachinesMigrateToVMScaleSetHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
