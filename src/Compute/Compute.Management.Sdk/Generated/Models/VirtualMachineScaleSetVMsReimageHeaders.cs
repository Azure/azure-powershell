...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetVMsReimageHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetVMsReimageHeaders class.
        /// </summary>
        public VirtualMachineScaleSetVMsReimageHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetVMsReimageHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
