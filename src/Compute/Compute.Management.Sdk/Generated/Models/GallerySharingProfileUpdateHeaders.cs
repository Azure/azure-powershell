...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class GallerySharingProfileUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GallerySharingProfileUpdateHeaders class.
        /// </summary>
        public GallerySharingProfileUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public GallerySharingProfileUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
