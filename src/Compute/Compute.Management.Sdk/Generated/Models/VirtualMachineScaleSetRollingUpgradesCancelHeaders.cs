...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for Cancel operation.
    /// </summary>
    public partial class VirtualMachineScaleSetRollingUpgradesCancelHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetRollingUpgradesCancelHeaders class.
        /// </summary>
        public VirtualMachineScaleSetRollingUpgradesCancelHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetRollingUpgradesCancelHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
