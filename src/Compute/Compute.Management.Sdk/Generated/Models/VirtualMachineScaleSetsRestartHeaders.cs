...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetsRestartHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetsRestartHeaders class.
        /// </summary>
        public VirtualMachineScaleSetsRestartHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetsRestartHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
