...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for Restart operation.
    /// </summary>
    public partial class VirtualMachineScaleSetVMsRestartHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetVMsRestartHeaders class.
        /// </summary>
        public VirtualMachineScaleSetVMsRestartHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetVMsRestartHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
