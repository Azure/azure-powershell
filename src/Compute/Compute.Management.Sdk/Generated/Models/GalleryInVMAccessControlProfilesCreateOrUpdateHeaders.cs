...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class GalleryInVMAccessControlProfilesCreateOrUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GalleryInVMAccessControlProfilesCreateOrUpdateHeaders class.
        /// </summary>
        ...
        /// status.</param>
        public GalleryInVMAccessControlProfilesCreateOrUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
