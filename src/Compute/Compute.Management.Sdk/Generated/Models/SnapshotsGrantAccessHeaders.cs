...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class SnapshotsGrantAccessHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SnapshotsGrantAccessHeaders
        /// class.
        /// </summary>
        public SnapshotsGrantAccessHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public SnapshotsGrantAccessHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
