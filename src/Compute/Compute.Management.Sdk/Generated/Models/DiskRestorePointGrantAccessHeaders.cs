...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class DiskRestorePointGrantAccessHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DiskRestorePointGrantAccessHeaders class.
        /// </summary>
        public DiskRestorePointGrantAccessHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DiskRestorePointGrantAccessHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
