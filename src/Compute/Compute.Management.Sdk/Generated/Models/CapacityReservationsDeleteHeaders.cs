...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class CapacityReservationsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CapacityReservationsDeleteHeaders
        /// class.
        /// </summary>
        public CapacityReservationsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public CapacityReservationsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
