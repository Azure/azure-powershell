...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetsStartHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetsStartHeaders class.
        /// </summary>
        public VirtualMachineScaleSetsStartHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetsStartHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
