...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class VirtualMachineNetworkInterfaceConfiguration
    {
        ...
        public VirtualMachineNetworkInterfaceConfiguration(string name, System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), bool? primary = default(bool?), string deleteOption = default(string), bool? enableAcceleratedNetworking = default(bool?), bool? disableTcpStateTracking = default(bool?), bool? enableFpga = default(bool?), bool? enableIPForwarding = default(bool?), SubResource networkSecurityGroup = default(SubResource), VirtualMachineNetworkInterfaceDnsSettingsConfiguration dnsSettings = default(VirtualMachineNetworkInterfaceDnsSettingsConfiguration), System.Collections.Generic.IList<VirtualMachineNetworkInterfaceIPConfiguration> ipConfigurations = default(System.Collections.Generic.IList<VirtualMachineNetworkInterfaceIPConfiguration>), SubResource dscpConfiguration = default(SubResource), string auxiliaryMode = default(string), string auxiliarySku = default(string))
