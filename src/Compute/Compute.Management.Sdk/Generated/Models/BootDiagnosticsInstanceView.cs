...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class BootDiagnosticsInstanceView
    {
        ...
        /// <param name="consoleScreenshotBlobUri">The console screenshot blob URI. **Note:** This will **not** be set if boot
        /// diagnostics is currently enabled with managed storage.
        /// </param>

        /// <param name="serialConsoleLogBlobUri">The serial console log blob Uri. **Note:** This will **not** be set if boot
        /// diagnostics is currently enabled with managed storage.
        /// </param>

        /// <param name="status">The boot diagnostics status information for the VM. **Note:** It will be
        ...
        /// <summary>
        /// Gets the console screenshot blob URI. **Note:** This will **not** be set if
        ...
        /// <summary>
        /// Gets the serial console log blob Uri. **Note:** This will **not** be set if
        /// boot diagnostics is currently enabled with managed storage.
        /// </summary>
        ...
        /// <summary>
        /// Gets the boot diagnostics status information for the VM. **Note:** It will
