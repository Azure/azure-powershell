...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class EncryptionSetIdentity
    {
        ...
        public EncryptionSetIdentity(string type = default(string), string principalId = default(string), string tenantId = default(string), IDictionary<string, UserAssignedIdentitiesValueModel> userAssignedIdentities = default(IDictionary<string, UserAssignedIdentitiesValueModel>))
        {
            Type = type;
