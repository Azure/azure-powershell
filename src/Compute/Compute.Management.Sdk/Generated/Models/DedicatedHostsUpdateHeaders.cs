...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class DedicatedHostsUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DedicatedHostsUpdateHeaders
        /// class.
        /// </summary>
        public DedicatedHostsUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DedicatedHostsUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
