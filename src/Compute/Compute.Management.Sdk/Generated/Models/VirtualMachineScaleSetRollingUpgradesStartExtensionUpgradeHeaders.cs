...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for StartExtensionUpgrade operation.
    /// </summary>
    public partial class VirtualMachineScaleSetRollingUpgradesStartExtensionUpgradeHeaders
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public VirtualMachineScaleSetRollingUpgradesStartExtensionUpgradeHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetRollingUpgradesStartExtensionUpgradeHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
