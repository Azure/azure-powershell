...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class LinuxConfiguration
    {
        ...
        /// <param name="disablePasswordAuthentication">Specifies whether password authentication should be disabled.
        /// </param>

        /// <param name="ssh">Specifies the ssh key configuration for a Linux OS.
        /// </param>
        ...
        /// <param name="patchSettings">[Preview Feature] Specifies settings related to VM Guest Patching on Linux.
        /// </param>

        /// <param name="enableVMAgentPlatformUpdates">Indicates whether VMAgent Platform Updates is enabled for the Linux virtual
        ...
        /// is installed on the VM so that extensions can be added to the VM later.
        /// </summary>
