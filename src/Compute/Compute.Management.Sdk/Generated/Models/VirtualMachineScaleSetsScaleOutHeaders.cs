...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for ScaleOut operation.
    /// </summary>
    public partial class VirtualMachineScaleSetsScaleOutHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetsScaleOutHeaders class.
        /// </summary>
        public VirtualMachineScaleSetsScaleOutHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetsScaleOutHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
