...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class AvailabilitySetUpdate : UpdateResource
    {
        ...
        /// </param>
        public AvailabilitySetUpdate(System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), Sku sku = default(Sku), int? platformUpdateDomainCount = default(int?), int? platformFaultDomainCount = default(int?), System.Collections.Generic.IList<SubResource> virtualMachines = default(System.Collections.Generic.IList<SubResource>), SubResource proximityPlacementGroup = default(SubResource), System.Collections.Generic.IList<InstanceViewStatus> statuses = default(System.Collections.Generic.IList<InstanceViewStatus>))
