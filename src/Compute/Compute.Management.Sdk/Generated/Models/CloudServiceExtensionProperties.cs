...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class CloudServiceExtensionProperties
    {
        ...
        /// <param name="type">Specifies the type of the extension.
        /// </param>

        /// <param name="typeHandlerVersion">Specifies the version of the extension. Specifies the version of the
        ...
        /// <param name="autoUpgradeMinorVersion">Explicitly specify whether platform can automatically upgrade
        /// typeHandlerVersion to higher minor versions when they become available.
        /// </param>

        /// <param name="settings">Public settings for the extension. For JSON extensions, this is the JSON
        /// settings for the extension. For XML Extension (like RDP), this is the XML
        /// setting for the extension.
        /// </param>

        /// <param name="protectedSettings">Protected settings for the extension which are encrypted before sent to the
        /// role instance.
        /// </param>

        /// <param name="protectedSettingsFromKeyVault">Protected settings for the extension, referenced using KeyVault which are
        /// encrypted before sent to the role instance.
        /// </param>

        /// <param name="forceUpdateTag">Tag to force apply the provided public and protected settings.
        /// Changing the tag value allows for re-running the extension without changing
        /// any of the public or protected settings.
        ...
        /// <summary>
        /// Gets or sets specifies the version of the extension. Specifies the version
        /// of the extension. If this element is not specified or an asterisk (*) is
        /// used as the value, the latest version of the extension is used. If the
        /// value is specified with a major version number and an asterisk as the minor
        ...
        /// <summary>
        /// Gets or sets explicitly specify whether platform can automatically upgrade
        /// typeHandlerVersion to higher minor versions when they become available.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets public settings for the extension. For JSON extensions, this
        /// is the JSON settings for the extension. For XML Extension (like RDP), this
        /// is the XML setting for the extension.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "settings")]
        public object Settings {get; set; }

        /// <summary>
        /// Gets or sets protected settings for the extension which are encrypted
        ...
        /// <summary>
        /// Gets or sets protected settings for the extension, referenced using
        ...
        /// <summary>
        /// Gets or sets tag to force apply the provided public and protected settings.
        /// Changing the tag value allows for re-running the extension without changing
        /// any of the public or protected settings.
        /// If forceUpdateTag is not changed, updates to public or protected settings
        /// would still be applied by the handler.
        ...
        /// <summary>
        /// Gets or sets optional list of roles to apply this extension. If property is
        /// not specified or &#39;*&#39; is specified, extension is applied to all roles in the
        /// cloud service.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "rolesAppliedTo")]
        public System.Collections.Generic.IList<string> RolesAppliedTo {get; set; }
    }
}