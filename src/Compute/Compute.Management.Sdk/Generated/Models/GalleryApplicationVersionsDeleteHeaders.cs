...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class GalleryApplicationVersionsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GalleryApplicationVersionsDeleteHeaders class.
        /// </summary>
        public GalleryApplicationVersionsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public GalleryApplicationVersionsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
