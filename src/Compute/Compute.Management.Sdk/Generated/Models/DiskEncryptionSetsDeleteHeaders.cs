...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class DiskEncryptionSetsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DiskEncryptionSetsDeleteHeaders
        /// class.
        /// </summary>
        public DiskEncryptionSetsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DiskEncryptionSetsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
