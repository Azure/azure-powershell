...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the VirtualMachineScaleSetNetworkConfigurationProperties class.
        /// </summary>
        ...
        public VirtualMachineScaleSetNetworkConfigurationProperties(System.Collections.Generic.IList<VirtualMachineScaleSetIPConfiguration> ipConfigurations, bool? primary = default(bool?), bool? enableAcceleratedNetworking = default(bool?), bool? disableTcpStateTracking = default(bool?), bool? enableFpga = default(bool?), SubResource networkSecurityGroup = default(SubResource), VirtualMachineScaleSetNetworkConfigurationDnsSettings dnsSettings = default(VirtualMachineScaleSetNetworkConfigurationDnsSettings), bool? enableIPForwarding = default(bool?), string deleteOption = default(string), string auxiliaryMode = default(string), string auxiliarySku = default(string))
