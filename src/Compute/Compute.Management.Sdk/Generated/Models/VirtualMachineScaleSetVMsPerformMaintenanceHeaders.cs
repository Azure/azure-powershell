...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetVMsPerformMaintenanceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetVMsPerformMaintenanceHeaders class.
        /// </summary>
        public VirtualMachineScaleSetVMsPerformMaintenanceHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetVMsPerformMaintenanceHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
