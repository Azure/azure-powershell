...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class GalleryImageVersionsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GalleryImageVersionsDeleteHeaders
        /// class.
        /// </summary>
        public GalleryImageVersionsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public GalleryImageVersionsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
