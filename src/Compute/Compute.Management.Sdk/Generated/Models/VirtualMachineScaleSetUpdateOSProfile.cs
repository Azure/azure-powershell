...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class VirtualMachineScaleSetUpdateOSProfile
    {
        ...
        /// <param name="customData">A base-64 encoded string of custom data.
        /// </param>

        /// <param name="windowsConfiguration">The Windows Configuration of the OS profile.
        /// </param>

        /// <param name="linuxConfiguration">The Linux Configuration of the OS profile.
        /// </param>

        /// <param name="secrets">The List of certificates for addition to the VM.
        /// </param>
        public VirtualMachineScaleSetUpdateOSProfile(string customData = default(string), WindowsConfiguration windowsConfiguration = default(WindowsConfiguration), LinuxConfiguration linuxConfiguration = default(LinuxConfiguration), System.Collections.Generic.IList<VaultSecretGroup> secrets = default(System.Collections.Generic.IList<VaultSecretGroup>))
