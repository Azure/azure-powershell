...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachinesPowerOffHeaders
    {
        /// <summary>
        /// Initializes a new instance of the VirtualMachinesPowerOffHeaders
        /// class.
        /// </summary>
        public VirtualMachinesPowerOffHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachinesPowerOffHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
