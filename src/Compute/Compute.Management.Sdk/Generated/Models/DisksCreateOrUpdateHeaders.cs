...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class DisksCreateOrUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DisksCreateOrUpdateHeaders class.
        /// </summary>
        public DisksCreateOrUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DisksCreateOrUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
