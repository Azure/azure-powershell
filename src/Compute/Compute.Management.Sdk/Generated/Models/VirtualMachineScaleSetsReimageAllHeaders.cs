...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for ReimageAll operation.
    /// </summary>
    public partial class VirtualMachineScaleSetsReimageAllHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetsReimageAllHeaders class.
        /// </summary>
        public VirtualMachineScaleSetsReimageAllHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetsReimageAllHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
