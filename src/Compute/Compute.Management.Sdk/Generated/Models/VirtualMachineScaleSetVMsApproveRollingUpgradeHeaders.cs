...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for ApproveRollingUpgrade operation.
    /// </summary>
    public partial class VirtualMachineScaleSetVMsApproveRollingUpgradeHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetVMsApproveRollingUpgradeHeaders class.
        /// </summary>
        public VirtualMachineScaleSetVMsApproveRollingUpgradeHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetVMsApproveRollingUpgradeHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
