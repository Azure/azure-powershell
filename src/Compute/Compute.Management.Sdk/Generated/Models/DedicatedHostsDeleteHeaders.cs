...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class DedicatedHostsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DedicatedHostsDeleteHeaders
        /// class.
        /// </summary>
        public DedicatedHostsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DedicatedHostsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
