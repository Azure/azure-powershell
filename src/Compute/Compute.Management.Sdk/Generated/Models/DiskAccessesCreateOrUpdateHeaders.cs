...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class DiskAccessesCreateOrUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DiskAccessesCreateOrUpdateHeaders
        /// class.
        /// </summary>
        public DiskAccessesCreateOrUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DiskAccessesCreateOrUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
