...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class DisksUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DisksUpdateHeaders class.
        /// </summary>
        public DisksUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DisksUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
