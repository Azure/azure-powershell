...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for InstallPatches operation.
    /// </summary>
    public partial class VirtualMachinesInstallPatchesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachinesInstallPatchesHeaders class.
        /// </summary>
        public VirtualMachinesInstallPatchesHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachinesInstallPatchesHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
