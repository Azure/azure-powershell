...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for PowerOff operation.
    /// </summary>
    public partial class VirtualMachineScaleSetsPowerOffHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetsPowerOffHeaders class.
        /// </summary>
        public VirtualMachineScaleSetsPowerOffHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetsPowerOffHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
