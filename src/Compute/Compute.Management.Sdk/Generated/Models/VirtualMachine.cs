...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class VirtualMachine : Resource
    {
        ...
        /// <param name="managedBy">ManagedBy is set to Virtual Machine Scale Set(VMSS) flex ARM resourceID, if
        /// the VM is part of the VMSS. This property is used by platform for internal
        /// resource group delete optimization.
        /// </param>

        /// <param name="etag">Etag is property returned in Create/Update/Get response of the VM, so that
        ...
        /// <summary>
        /// Gets etag is property returned in Create/Update/Get response of the VM, so
