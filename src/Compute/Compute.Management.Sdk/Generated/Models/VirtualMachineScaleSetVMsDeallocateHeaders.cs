...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetVMsDeallocateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetVMsDeallocateHeaders class.
        /// </summary>
        public VirtualMachineScaleSetVMsDeallocateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetVMsDeallocateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
