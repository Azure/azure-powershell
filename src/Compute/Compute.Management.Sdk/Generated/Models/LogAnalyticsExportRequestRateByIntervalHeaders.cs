...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for ExportRequestRateByInterval operation.
    /// </summary>
    public partial class LogAnalyticsExportRequestRateByIntervalHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// LogAnalyticsExportRequestRateByIntervalHeaders class.
        /// </summary>
        public LogAnalyticsExportRequestRateByIntervalHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public LogAnalyticsExportRequestRateByIntervalHeaders(string azureAsyncOperation = default(string), int? retryAfter = default(int?))
        {
