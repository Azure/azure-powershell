...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteAPrivateEndpointConnection operation.
    /// </summary>
    public partial class DiskAccessesDeleteAPrivateEndpointConnectionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DiskAccessesDeleteAPrivateEndpointConnectionHeaders class.
        /// </summary>
        public DiskAccessesDeleteAPrivateEndpointConnectionHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DiskAccessesDeleteAPrivateEndpointConnectionHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
