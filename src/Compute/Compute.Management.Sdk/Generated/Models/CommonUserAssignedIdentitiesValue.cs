...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class CommonUserAssignedIdentitiesValue
    {
        /// <summary>
        /// Initializes a new instance of the CommonUserAssignedIdentitiesValue class.
        /// </summary>
        public CommonUserAssignedIdentitiesValue()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CommonUserAssignedIdentitiesValue(string principalId = default(string), string clientId = default(string))
