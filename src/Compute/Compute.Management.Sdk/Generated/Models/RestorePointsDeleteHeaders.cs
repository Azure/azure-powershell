...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class RestorePointsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the RestorePointsDeleteHeaders class.
        /// </summary>
        public RestorePointsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public RestorePointsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
