...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetVMsRedeployHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetVMsRedeployHeaders class.
        /// </summary>
        public VirtualMachineScaleSetVMsRedeployHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetVMsRedeployHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
