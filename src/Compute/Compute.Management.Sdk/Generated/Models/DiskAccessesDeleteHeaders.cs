...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class DiskAccessesDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DiskAccessesDeleteHeaders class.
        /// </summary>
        public DiskAccessesDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DiskAccessesDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
