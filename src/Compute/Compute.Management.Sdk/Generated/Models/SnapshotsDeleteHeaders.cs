...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class SnapshotsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SnapshotsDeleteHeaders class.
        /// </summary>
        public SnapshotsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public SnapshotsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
