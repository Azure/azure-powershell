...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetExtensionsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetExtensionsDeleteHeaders class.
        /// </summary>
        public VirtualMachineScaleSetExtensionsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetExtensionsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
