...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class VirtualMachineScaleSetVM : Resource
    {
        ...
        /// <param name="instanceId">The virtual machine instance ID.
        /// </param>

        /// <param name="sku">The virtual machine SKU.
        /// </param>
        ...
        /// <param name="etag">Etag is property returned in Update/Get response of the VMSS VM, so that
        ...
        /// <summary>
        /// Gets etag is property returned in Update/Get response of the VMSS VM, so
