...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class WindowsParameters
    {
        ...
        /// <param name="patchNameMasksToInclude">This is used to include patches that match the given patch name masks.
        /// Alphanumeric strings and wildcard expressions consisting of * and ? are
        /// only supported as input values in the list. Null, empty and only
        /// whitespaces strings as inputs values are not supported.
        /// </param>

        /// <param name="patchNameMasksToExclude">This is used to exclude patches that match the given patch name masks.
        /// Alphanumeric strings and wildcard expressions consisting of * and ? are
        /// only supported as input values in the list. Null, empty and only
        /// whitespaces strings as inputs values are not supported.
        /// </param>
        public WindowsParameters(System.Collections.Generic.IList<string> classificationsToInclude = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<string> kbNumbersToInclude = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<string> kbNumbersToExclude = default(System.Collections.Generic.IList<string>), bool? excludeKbsRequiringReboot = default(bool?), System.DateTime? maxPatchPublishDate = default(System.DateTime?), System.Collections.Generic.IList<string> patchNameMasksToInclude = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<string> patchNameMasksToExclude = default(System.Collections.Generic.IList<string>))
        ...
        /// <summary>
        /// Gets or sets this is used to include patches that match the given patch
        /// name masks. Alphanumeric strings and wildcard expressions consisting of *
        /// and ? are only supported as input values in the list. Null, empty and only
        /// whitespaces strings as inputs values are not supported.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "patchNameMasksToInclude")]
        public System.Collections.Generic.IList<string> PatchNameMasksToInclude {get; set; }

        /// <summary>
        /// Gets or sets this is used to exclude patches that match the given patch
        /// name masks. Alphanumeric strings and wildcard expressions consisting of *
        /// and ? are only supported as input values in the list. Null, empty and only
        /// whitespaces strings as inputs values are not supported.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "patchNameMasksToExclude")]
        public System.Collections.Generic.IList<string> PatchNameMasksToExclude {get; set; }
    }
}