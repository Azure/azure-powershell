...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class DiagnosticsProfile
    {
        ...
        /// Output and Screenshot to diagnose VM status. **NOTE**: If storageUri is
        /// being specified then ensure that the storage account is in the same region
        /// and subscription as the VM. You can easily view the output of your console
        ...
        /// view Console Output and Screenshot to diagnose VM status. **NOTE**: If
        /// storageUri is being specified then ensure that the storage account is in
        /// the same region and subscription as the VM. You can easily view the output
