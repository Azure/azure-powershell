...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class GalleriesDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GalleriesDeleteHeaders class.
        /// </summary>
        public GalleriesDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public GalleriesDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
