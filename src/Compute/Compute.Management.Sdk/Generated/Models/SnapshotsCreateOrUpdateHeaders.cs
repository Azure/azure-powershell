...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class SnapshotsCreateOrUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SnapshotsCreateOrUpdateHeaders
        /// class.
        /// </summary>
        public SnapshotsCreateOrUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public SnapshotsCreateOrUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
