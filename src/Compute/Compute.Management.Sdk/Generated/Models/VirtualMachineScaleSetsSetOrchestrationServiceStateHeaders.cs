...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for SetOrchestrationServiceState operation.
    /// </summary>
    public partial class VirtualMachineScaleSetsSetOrchestrationServiceStateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetsSetOrchestrationServiceStateHeaders class.
        /// </summary>
        public VirtualMachineScaleSetsSetOrchestrationServiceStateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetsSetOrchestrationServiceStateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
