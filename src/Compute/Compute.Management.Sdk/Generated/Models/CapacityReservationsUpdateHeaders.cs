...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class CapacityReservationsUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CapacityReservationsUpdateHeaders
        /// class.
        /// </summary>
        public CapacityReservationsUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public CapacityReservationsUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
