...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class ImagesUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ImagesUpdateHeaders class.
        /// </summary>
        public ImagesUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public ImagesUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
