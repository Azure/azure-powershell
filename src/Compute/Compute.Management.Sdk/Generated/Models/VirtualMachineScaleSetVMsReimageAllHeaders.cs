...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetVMsReimageAllHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetVMsReimageAllHeaders class.
        /// </summary>
        public VirtualMachineScaleSetVMsReimageAllHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetVMsReimageAllHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
