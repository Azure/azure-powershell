...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for StartOSUpgrade operation.
    /// </summary>
    public partial class VirtualMachineScaleSetRollingUpgradesStartOSUpgradeHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetRollingUpgradesStartOSUpgradeHeaders class.
        /// </summary>
        public VirtualMachineScaleSetRollingUpgradesStartOSUpgradeHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetRollingUpgradesStartOSUpgradeHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
