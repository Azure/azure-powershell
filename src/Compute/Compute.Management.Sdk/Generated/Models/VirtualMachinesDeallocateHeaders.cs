...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachinesDeallocateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the VirtualMachinesDeallocateHeaders
        /// class.
        /// </summary>
        public VirtualMachinesDeallocateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachinesDeallocateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
