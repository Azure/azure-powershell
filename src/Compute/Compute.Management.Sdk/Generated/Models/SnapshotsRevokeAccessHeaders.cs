...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for RevokeAccess operation.
    /// </summary>
    public partial class SnapshotsRevokeAccessHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SnapshotsRevokeAccessHeaders
        /// class.
        /// </summary>
        public SnapshotsRevokeAccessHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public SnapshotsRevokeAccessHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
