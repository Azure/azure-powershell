...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetsPerformMaintenanceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetsPerformMaintenanceHeaders class.
        /// </summary>
        public VirtualMachineScaleSetsPerformMaintenanceHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetsPerformMaintenanceHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
