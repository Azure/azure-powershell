...
namespace Microsoft.Azure.Management.Compute
{
    ...
    public partial interface IVirtualMachineScaleSetExtensionsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationHeaderResponse<VirtualMachineScaleSetExtensionsDeleteHeaders>> DeleteWithHttpMessagesAsync(string resourceGroupName, string vmScaleSetName, string vmssExtensionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// The operation to create or update an extension.
        /// </summary>
        /// <param name='resourceGroupName'>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationHeaderResponse<VirtualMachineScaleSetExtensionsDeleteHeaders>> BeginDeleteWithHttpMessagesAsync(string resourceGroupName, string vmScaleSetName, string vmssExtensionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets a list of all extensions in a VM scale set.
        /// </summary>
