...
input-file:
  ...
  - $(repo)/specification/mysql/resource-manager/Microsoft.DBforMySQL/preview/2020-07-01-privatepreview/mysql.json
...
directive:
  ...
  - from: Microsoft.DBforMySQL/preview/2020-07-01-privatepreview/mysql.json
    where: $.paths..operationId
    transform: return $.replace(/^(Servers|ServerKeys)_/g, "flexible$1_")
  - from: Microsoft.DBforMySQL/preview/2020-07-01-privatepreview/mysql.json
    where: $.paths..operationId
    transform: return $.replace(/^(Replicas|FirewallRules|Databases|Configurations)_/g, "flexibleServers$1_")
  - where:
      verb: Set
