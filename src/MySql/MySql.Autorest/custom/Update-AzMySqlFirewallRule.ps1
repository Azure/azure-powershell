...
function Update-AzMySqlFirewallRule {
    ...
    param(
        ...
        [Parameter(ParameterSetName = 'UpdateViaIdentityServerExpanded', Mandatory)]
        ...
        [Parameter(ParameterSetName = 'UpdateViaIdentityServerExpanded', Mandatory, ValueFromPipeline)]
        [Microsoft.Azure.PowerShell.Cmdlets.MySql.Category('Path')]
        [Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IMySqlIdentity]
        # Identity Parameter
        ${ServerInputObject},
