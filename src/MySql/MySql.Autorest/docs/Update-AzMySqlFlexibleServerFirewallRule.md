...
```
Update-AzMySqlFlexibleServerFirewallRule -FlexibleServerInputObject <IMySqlIdentity> -Name <String>
...
```yaml
Type: System.String
Parameter Sets: ClientIPAddress, UpdateExpanded, UpdateViaIdentityFlexibleServerExpanded, UpdateViaJsonFilePath, UpdateViaJsonString
...
```yaml
Type: System.String
Parameter Sets: ClientIPAddress, UpdateExpanded, UpdateViaJsonFilePath, UpdateViaJsonString
Aliases:
