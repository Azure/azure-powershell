...
online version: https://learn.microsoft.com/powershell/module/az.mysql/set-azmysqladvancedthreatprotectionsettingput
schema: 2.0.0
---

# Set-AzMySqlAdvancedThreatProtectionSettingPut
...
```
Set-AzMySqlAdvancedThreatProtectionSettingPut -ResourceGroupName <String> -ServerName <String>
