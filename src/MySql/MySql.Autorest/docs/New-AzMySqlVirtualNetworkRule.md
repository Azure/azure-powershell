...
```
New-AzMySqlVirtualNetworkRule -InputObject <IMySqlIdentity> -SubnetId <String>
...
```
New-AzMySqlVirtualNetworkRule -Name <String> -ServerInputObject <IMySqlIdentity> -SubnetId <String>
 [-IgnoreMissingVnetServiceEndpoint] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.Management.Automation.SwitchParameter
Parameter Sets: CreateExpanded, CreateViaIdentityExpanded, CreateViaIdentityServerExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded, CreateViaIdentityServerExpanded, CreateViaJsonFilePath, CreateViaJsonString
