...
Invoke-AzMySqlBatchConfigurationUpdate -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String>] [-ResetAllToDefault <String>] [-Value <IConfigurationForBatchUpdate[]>]
...
```
Invoke-AzMySqlBatchConfigurationUpdate -InputObject <IMySqlIdentity> [-ResetAllToDefault <String>]
 [-Value <IConfigurationForBatchUpdate[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### BatchViaJsonFilePath
```
Invoke-AzMySqlBatchConfigurationUpdate -ResourceGroupName <String> -ServerName <String> -JsonFilePath <String>
...
### BatchViaJsonString
```
Invoke-AzMySqlBatchConfigurationUpdate -ResourceGroupName <String> -ServerName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: BatchViaJsonFilePath
Aliases:
...
```yaml
Type: System.String
Parameter Sets: BatchViaJsonString
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IConfigurationListForBatchUpdate
...
```yaml
Type: System.String
Parameter Sets: Batch, BatchExpanded, BatchViaJsonFilePath, BatchViaJsonString
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IConfigurationForBatchUpdate[]
Parameter Sets: BatchExpanded, BatchViaIdentityExpanded
Aliases:
