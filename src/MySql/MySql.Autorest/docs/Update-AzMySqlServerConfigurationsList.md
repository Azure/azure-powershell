...
```
Update-AzMySqlServerConfigurationsList -ResourceGroupName <String> -ServerName <String> -JsonFilePath <String>
...
### UpdateViaJsonString
```
Update-AzMySqlServerConfigurationsList -ResourceGroupName <String> -ServerName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
