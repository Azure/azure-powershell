...
function Restore-AzMySqlServerWithGeo {
    ...
    process {
        try {
          ...
          $Parameter.Property = [Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20171201Preview.ServerPropertiesForGeoRestore]::new()
