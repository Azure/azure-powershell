...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20210501Preview.IServerAutoGenerated])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20210501Preview.IServerAutoGenerated]
    ${Master},
