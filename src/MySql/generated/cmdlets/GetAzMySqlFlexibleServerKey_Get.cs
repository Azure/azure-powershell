...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets
{
    ...
    public partial class GetAzMySqlFlexibleServerKey_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzMySqlFlexibleServerKey_Get" /> cmdlet class.
        /// </summary>
        public GetAzMySqlFlexibleServerKey_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.FlexibleServerKeysGet(SubscriptionId, ResourceGroupName, ServerName, KeyName, onOk, onDefault, this, Pipeline);
