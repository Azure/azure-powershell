...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMySqlServerConfigurationsList_UpdateExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzMySqlServerConfigurationsList_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IEventListener
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20171201.IConfiguration[] Value { get => ValueBody.Value ?? null /* arrayOf */; set => ValueBody.Value = value; }

        /// <summary>Backing field for <see cref="ValueBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20171201.IConfigurationListResult _valueBody= new Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20171201.ConfigurationListResult();

        /// <summary>A list of server configurations.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20171201.IConfigurationListResult ValueBody { get => this._valueBody; set => this._valueBody = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzMySqlServerConfigurationsList_UpdateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets.UpdateAzMySqlServerConfigurationsList_UpdateExpanded Clone()
        {
            var clone = new UpdateAzMySqlServerConfigurationsList_UpdateExpanded();
            ...
            clone.ValueBody = this.ValueBody;
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ServerConfigurationsListUpdate(SubscriptionId, ResourceGroupName, ServerName, ValueBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ServerName=ServerName,body=ValueBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzMySqlServerConfigurationsList_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzMySqlServerConfigurationsList_UpdateExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20171201.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ServerName=ServerName, body=ValueBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ServerName=ServerName, body=ValueBody })
                    {
