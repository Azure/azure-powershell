...
Describe 'Get-AzMySqlConnectionString' {
    ...
    It 'GetViaIdentity' {
        $PHPConnectionString = Get-AzMySqlServer -ResourceGroupName $env.resourceGroup -ServerName $env.serverName | Get-AzMySqlConnectionString -Client PHP
        ...
        $JDBCConnectionString = Get-AzMySqlServer -ResourceGroupName $env.resourceGroup -ServerName $env.serverName | Get-AzMySqlConnectionString -Client JDBC
        ...
        $NodeConnectionString = Get-AzMySqlServer -ResourceGroupName $env.resourceGroup -ServerName $env.serverName | Get-AzMySqlConnectionString -Client Node.js
        ...
        $PythonConnectionString = Get-AzMySqlServer -ResourceGroupName $env.resourceGroup -ServerName $env.serverName | Get-AzMySqlConnectionString -Client Python
