...
Update-AzMySqlFlexibleServer -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-AdministratorLoginPassword <SecureString>] [-ReplicationRole <String>] [-Sku <String>] [-SkuTier <String>]
 [-HighAvailability <String>] [-BackupRetentionDay <Int32>] [-StorageAutogrow <String>] [-StorageInMb <Int32>]
 [-Tag <Hashtable>] [-MaintenanceWindow <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
Update-AzMySqlFlexibleServer -InputObject <IMySqlIdentity> [-AdministratorLoginPassword <SecureString>]
 [-ReplicationRole <String>] [-Sku <String>] [-SkuTier <String>] [-HighAvailability <String>]
 [-BackupRetentionDay <Int32>] [-StorageAutogrow <String>] [-StorageInMb <Int32>] [-Tag <Hashtable>]
