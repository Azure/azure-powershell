...
online version: https://learn.microsoft.com/powershell/module/az.mysql/remove-azmysqlflexibleserverfirewallrule
schema: 2.0.0
---
...
```
Remove-AzMySqlFlexibleServerFirewallRule -Name <String> -FlexibleServerInputObject <IMySqlIdentity>
