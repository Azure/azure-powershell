...
online version: https://learn.microsoft.com/powershell/module/az.mysql/new-azmysqlfirewallrule
schema: 2.0.0
---
...
```
New-AzMySqlFirewallRule -ResourceGroupName <String> -ServerName <String> [-Name <String>]
