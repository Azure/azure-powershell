...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Update-AzMySqlFlexibleServer -Name net_retry_count -ResourceGroupName PowershellMySqlTest -ServerName mysql-test -Value 15
```
...
INPUTOBJECT <IMySqlIdentity>: To construct, see NOTES section for INPUTOBJECT properties and create a hash table.
