...
```
New-AzMySqlFlexibleServerDatabase -FlexibleServerInputObject <IMySqlIdentity> -Name <String>
...
### Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IDatabaseAutoGenerated
