...
INPUTOBJECT <IServer>: The server for the connection string.
  ...
  - `[InfrastructureEncryption <String>]`: Status showing whether the server enabled infrastructure encryption.
  ...
  - `[SkuTier <String>]`: The tier of the particular SKU, e.g. Basic.
  ...
  - `[StorageProfileGeoRedundantBackup <String>]`: Enable Geo-redundant or not for server backup.
  - `[StorageProfileStorageAutogrow <String>]`: Enable Storage Auto Grow.
