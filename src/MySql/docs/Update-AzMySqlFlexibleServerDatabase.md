...
### UpdateViaIdentity
```
Update-AzMySqlFlexibleServerDatabase -InputObject <IMySqlIdentity> -Parameter <IDatabase>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20171201.IDatabase
