...
namespace Microsoft.Azure.Commands.AzureStack
{
    ...
    [Cmdlet("Get", AzureStackClient.ActivationKeyCmdletName), OutputType(typeof(ActivationKeyResult))]
    public class GetAzureStackActivationKey : AzureStackCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            var resource = AzsClient.GetActivationKey(ResourceGroupName, Name);
            WriteObject(new ActivationKeyResult(resource));
        }
    }
}