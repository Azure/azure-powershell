...
namespace Microsoft.Azure.Commands.AzureStack
{
    ...
    [Cmdlet("New", AzureStackClient.RegistrationsCmdletName, SupportsShouldProcess = true), OutputType(typeof(RegistrationResult))]
    public class NewAzureStackRegistration : AzureStackCmdletBase
    {
        [Parameter(ValueFromPipelineByPropertyName = true, Mandatory = true, HelpMessage = "Name of resource group under which you want to create Azure Stack registration.")]
        ...
        public override void ExecuteCmdlet()
        {
            ...
            ConfirmAction(
              string.Format(Resources.CreateRegistration, this.Name),
              this.Name,
              () =>
              {
                  var registration = AzsClient.CreateRegistration(this.ResourceGroupName, this.Name, this.RegistrationToken);
