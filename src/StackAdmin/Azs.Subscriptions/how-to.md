# How-To
This document describes how to develop for `Azs.Subscriptions`.

## Building `Azs.Subscriptions`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Azs.Subscriptions` into the session.
