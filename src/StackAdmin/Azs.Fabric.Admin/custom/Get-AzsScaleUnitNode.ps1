...
Return the requested scale unit node.
.Example
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/azs.fabric.admin/get-azsscaleunitnode
.Inputs
...
process {
    ...
    Azs.Fabric.Admin.internal\Get-AzsScaleUnitNode @PSBoundParameters
}
}
