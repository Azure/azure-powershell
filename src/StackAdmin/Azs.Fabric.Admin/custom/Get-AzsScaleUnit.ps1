...
Returns the requested scale unit.
.Example
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/azs.fabric.admin/get-azsscaleunit
.Inputs
...
process {
    ...
    Azs.Fabric.Admin.internal\Get-AzsScaleUnit @PSBoundParameters
}
}
