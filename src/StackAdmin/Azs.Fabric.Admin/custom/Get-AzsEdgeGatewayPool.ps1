...
Returns the requested edge gateway pool object.
.Example
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/azs.fabric.admin/get-azsedgegatewaypool
.Inputs
...
process {
    ...
    Azs.Fabric.Admin.internal\Get-AzsEdgeGatewayPool @PSBoundParameters
}
}
