...
.EXAMPLE
    ...
    PS C:\> Get-AzsDrive -ScaleUnit S-Cluster -StorageSubSystem S-Cluster.azurestack.local -Name '{0488db4c-41c8-46a7-b551-4cde69820f90}:PD:{025b8d76-b2cc-d02f-e8d7-38522847fa0b}'
