...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.fabric.admin/get-azsinfrastructureroleinstance
schema: 2.0.0
---
...
### Get
```
Get-AzsInfrastructureRoleInstance -InfraRoleInstance <String> [-Location <String>]
