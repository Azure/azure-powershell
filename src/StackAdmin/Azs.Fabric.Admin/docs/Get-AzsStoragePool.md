...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.fabric.admin/get-azsstoragepool
schema: 2.0.0
---
...
### List (Default)
```
Get-AzsStoragePool -StorageSubSystem <String> [-Location <String>] [-ResourceGroupName <String>]
 [-SubscriptionId <String[]>] [-Filter <String>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### Get
```
Get-AzsStoragePool -StoragePool <String> -StorageSubSystem <String> [-Location <String>]
...
### GetViaIdentity
```
Get-AzsStoragePool -InputObject <IFabricAdminIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IStoragePool
