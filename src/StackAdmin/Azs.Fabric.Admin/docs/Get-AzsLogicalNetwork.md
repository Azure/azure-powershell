...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.fabric.admin/get-azslogicalnetwork
schema: 2.0.0
---
...
### Get
```
Get-AzsLogicalNetwork -LogicalNetwork <String> [-Location <String>] [-ResourceGroupName <String>]
