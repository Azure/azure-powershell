...
### PowerOn (Default)
```
Start-AzsInfrastructureRoleInstance -InfraRoleInstance <String> [-Location <String>]
...
### PowerOnViaIdentity
```
Start-AzsInfrastructureRoleInstance -InputObject <IFabricAdminIdentity> [-DefaultProfile <PSObject>] [-AsJob]
