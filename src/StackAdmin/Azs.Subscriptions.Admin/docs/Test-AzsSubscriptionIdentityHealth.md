...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.subscriptions.admin/test-azssubscriptionidentityhealth
schema: 2.0.0
---

# Test-AzsSubscriptionIdentityHealth
...
### Check (Default)
```
Test-AzsSubscriptionIdentityHealth [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentity
```
Test-AzsSubscriptionIdentityHealth -InputObject <ISubscriptionsAdminIdentity> [-DefaultProfile <PSObject>]
