...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.subscriptions.admin/restore-azssubscriptiondata
schema: 2.0.0
---

# Restore-AzsSubscriptionData
...
### Restore (Default)
```
Restore-AzsSubscriptionData [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-AzsSubscriptionData -InputObject <ISubscriptionsAdminIdentity> [-DefaultProfile <PSObject>] [-Confirm]
