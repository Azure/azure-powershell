...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.subscriptions.admin/move-azssubscription
schema: 2.0.0
---
...
### MoveViaIdentity
```
Move-AzsSubscription -InputObject <ISubscriptionsAdminIdentity>
