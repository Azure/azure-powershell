...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.subscriptions.admin/new-azsdirectorytenant
schema: 2.0.0
---

# New-AzsDirectoryTenant
...
### CreateViaIdentity
```
New-AzsDirectoryTenant -InputObject <ISubscriptionsAdminIdentity> -NewTenant <IDirectoryTenant>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzsDirectoryTenant -InputObject <ISubscriptionsAdminIdentity> [-Location <String>] [-TenantId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
