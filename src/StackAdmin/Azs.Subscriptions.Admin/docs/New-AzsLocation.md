...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.subscriptions.admin/new-azslocation
schema: 2.0.0
---
...
```
New-AzsLocation [-Location <String>] [-SubscriptionId <String>] [-DisplayName <String>] [-Id <String>]
...
### Create
```
New-AzsLocation -NewLocation <ILocation> [-Location <String>] [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzsLocation -InputObject <ISubscriptionsAdminIdentity> -NewLocation <ILocation>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzsLocation -InputObject <ISubscriptionsAdminIdentity> [-DisplayName <String>] [-Id <String>]
 [-Latitude <String>] [-Longitude <String>] [-Name <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
