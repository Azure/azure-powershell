...
### CreateViaIdentity
```
New-AzsPlan -InputObject <ISubscriptionsAdminIdentity> -NewPlan <IPlan> [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
To construct, see NOTES section for NEWPLAN properties and create a hash table.
...
#### NEWPLAN <IPlan>: A plan represents a package of quotas and capabilities that are offered tenants. A tenant can acquire this plan through an offer to upgrade his access to underlying cloud services.
