...
```
Invoke-AzsLinkOffer -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### Link
```
Invoke-AzsLinkOffer -Name <String> -ResourceGroupName <String> -PlanLink <IPlanLinkDefinition>
