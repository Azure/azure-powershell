...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.subscriptions.admin/update-azssubscriptionencryption
schema: 2.0.0
---

# Update-AzsSubscriptionEncryption
...
### Update (Default)
```
Update-AzsSubscriptionEncryption [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-AzsSubscriptionEncryption -InputObject <ISubscriptionsAdminIdentity> [-DefaultProfile <PSObject>]
