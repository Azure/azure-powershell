...
param(
    ...
    process {
        # PlanAcquisitionId and AcquisitionId are duplicate parameters generated by autorest. 
        # PlanAcquisitionId is a mandatory parameter while if AcquisitionId is not set, rest call fails with missing AcquisitionId property error
