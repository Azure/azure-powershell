...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateAvailabilitySetListAvailableSizesDynamicParameters()
        {
        ...
        protected void ExecuteAvailabilitySetListAvailableSizesMethod(object[] invokeMethodInputParameters)
        {
            string resourceGroupName = (string)ParseParameter(invokeMethodInputParameters[0]);
            string availabilitySetName = (string)ParseParameter(invokeMethodInputParameters[1]);

            var result = AvailabilitySetsClient.ListAvailableSizes(resourceGroupName, availabilitySetName);
            WriteObject(result);
        }
    }
    ...
    {
        protected PSArgument[] CreateAvailabilitySetListAvailableSizesParameters()
        {
