...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateVirtualMachineScaleSetVMDeleteDynamicParameters()
        {
        ...
        protected void ExecuteVirtualMachineScaleSetVMDeleteMethod(object[] invokeMethodInputParameters)
        {
            string resourceGroupName = (string)ParseParameter(invokeMethodInputParameters[0]);
            string vmScaleSetName = (string)ParseParameter(invokeMethodInputParameters[1]);
            string instanceId = (string)ParseParameter(invokeMethodInputParameters[2]);

            var result = VirtualMachineScaleSetVMsClient.Delete(resourceGroupName, vmScaleSetName, instanceId);
            WriteObject(result);
        }
    }
    ...
    {
        protected PSArgument[] CreateVirtualMachineScaleSetVMDeleteParameters()
        {
