...
InModuleScope Azs.Storage.Admin {
    ...
    Describe "Farm" -Tags @('Farm', 'Azs.Storage.Admin') {
        ...
        It "TestListFarms" -Skip:$('TestListFarms' -in $global:SkippedTests) {
        ...
        It "TestListAllFarmMetricDefinitions" -Skip:$('TestListAllFarmMetricDefinitions' -in $global:SkippedTests) {
        ...
        It "TestListAllFarmMetrics" -Skip:$('TestListAllFarmMetrics' -in $global:SkippedTests) {
        ...
        # Record new tests
        It "TestForAllFarmsStartGarbageCollection" -Skip:$('TestForAllFarmsStartGarbageCollection' -in $global:SkippedTests) {
