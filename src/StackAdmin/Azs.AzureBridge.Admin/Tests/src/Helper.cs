...
namespace Test
{
    ...
    [Cmdlet(VerbsCommon.Get, "MockClient"), OutputType(typeof(AzureBridgeAdminClient))]
    public class Helper : PSCmdlet {
        ...
        protected override void ProcessRecord() {
            ...
            WriteObject(context.GetServiceClient<AzureBridgeAdminClient>(handlers: handler));
        }
    }
}
