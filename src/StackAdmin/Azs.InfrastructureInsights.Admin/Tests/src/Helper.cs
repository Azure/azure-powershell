...
namespace Test
{
    ...
    [Cmdlet(VerbsCommon.Get, "MockClient"), OutputType(typeof(InfrastructureInsightsAdminClient))]
    public class Helper : PSCmdlet {
        ...
        protected override void ProcessRecord() {
            ...
            WriteObject(context.GetServiceClient<InfrastructureInsightsAdminClient>(handlers: handler));
        }
    }
}