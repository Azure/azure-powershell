...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.update.admin/get-azsupdateruntoplevel
schema: 2.0.0
---

# Get-AzsUpdateRunTopLevel
...
### GetViaIdentity
```
Get-AzsUpdateRunTopLevel -InputObject <IUpdateAdminIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
