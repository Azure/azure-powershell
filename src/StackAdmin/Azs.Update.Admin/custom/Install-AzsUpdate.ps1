...
[OutputType([System.Boolean], [Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Models.Api20160501.IUpdateRunAutoGenerated])]
...
process {
    ...
    if ($PSBoundParameters.ContainsKey(('Name')))
    {
        ...
        if ($selectedUpdate.State -notin "PreparationFailed","HealthCheckFailed","ReadyToInstall","Ready") {
            Throw "Can't install update " + $PSBoundParameters['Name'] + " because the state of this update is " + $selectedUpdate.State
        }
