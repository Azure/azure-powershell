...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Models.Api20160501.IUpdateRunAutoGenerated
.Outputs
...
.Link
https://docs.microsoft.com/en-us/powershell/module/azs.update.admin/get-azsupdateruntoplevel
#>
function Get-AzsUpdateRunTopLevel {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Models.Api20210701.IUpdateRun], [Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Models.Api20160501.IUpdateRunAutoGenerated])]
...
process {
    ...
    Azs.Update.Admin.internal\Get-AzsUpdateRunTopLevel @PSBoundParameters   
}
}
