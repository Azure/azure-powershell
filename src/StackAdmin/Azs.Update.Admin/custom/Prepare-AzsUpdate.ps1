...
process {
    ...
    if ($PSBoundParameters.ContainsKey(('Name')))
    {
        ...
        if ($selectedUpdate.State -notin "Ready","PreparationFailed") {
            Throw "Can't run preparation for " + $PSBoundParameters['Name'] + " because the state of this update is " + $selectedUpdate.State
        }
