...
namespace Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.Api20211120Preview
{
    ...
    public partial class VirtualNetworkRule :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.Api20211120Preview.IVirtualNetworkRuleInternal
    {

        /// <summary>Backing field for <see cref="Action" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Support.Action? _action;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Support.Action? Action { get => this._action; set => this._action = value; }

        /// <summary>Internal Acessors for State</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Support.State? Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.Api20211120Preview.IVirtualNetworkRuleInternal.State { get => this._state; set { {_state = value;} } }

        /// <summary>Backing field for <see cref="State" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Support.State? _state;

        /// <summary>Gets the state of virtual network rule.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Origin(Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Support.State? State { get => this._state; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Support.Action) })]
        Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Support.Action? Action { get; set; }
        /// <summary>Gets the state of virtual network rule.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Support.State) })]
        Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Support.State? State { get;  }
        /// <summary>
        /// Resource ID of a subnet, for example: /subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.Network/virtualNetworks/{vnetName}/subnets/{subnetName}.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Info(
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Support.Action? Action { get; set; }
        /// <summary>Gets the state of virtual network rule.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Support.State? State { get; set; }
        /// <summary>
        /// Resource ID of a subnet, for example: /subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.Network/virtualNetworks/{vnetName}/subnets/{subnetName}.
        /// </summary>
        string VirtualNetworkResourceId { get; set; }
