...
namespace Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.Api20221201Preview
{
    ...
    public partial class ElasticSanUpdateProperties
    {
        ...
        internal ElasticSanUpdateProperties(Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Json.JsonObject json)
        {
            ...
            {_baseSizeTiB = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Json.JsonNumber>("baseSizeTiB"), out var __jsonBaseSizeTiB) ? (long?)__jsonBaseSizeTiB : BaseSizeTiB;}
            {_extendedCapacitySizeTiB = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Json.JsonNumber>("extendedCapacitySizeTiB"), out var __jsonExtendedCapacitySizeTiB) ? (long?)__jsonExtendedCapacitySizeTiB : ExtendedCapacitySizeTiB;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.Api20221201Preview.IElasticSanUpdateProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.Api20221201Preview.IElasticSanUpdateProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.Api20221201Preview.IElasticSanUpdateProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Json.JsonNode node)
        {
