            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ElasticSanInputObject?.Id != null)
                    {
                        ...
                        await this.Client.VolumeGroupsUpdateViaIdentity(ElasticSanInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
