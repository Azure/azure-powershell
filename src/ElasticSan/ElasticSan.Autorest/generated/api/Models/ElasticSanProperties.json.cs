...
namespace Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models
{
    ...
    public partial class ElasticSanProperties
    {
        ...
        internal ElasticSanProperties(Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Json.JsonObject json)
        {
            ...
            {_sku = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Json.JsonObject>("sku"), out var __jsonSku) ? Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.Sku.FromJson(__jsonSku) : Sku;}
            ...
            {_totalVolumeSizeGiB = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Json.JsonNumber>("totalVolumeSizeGiB"), out var __jsonTotalVolumeSizeGiB) ? (long?)__jsonTotalVolumeSizeGiB : TotalVolumeSizeGiB;}
            {_volumeGroupCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Json.JsonNumber>("volumeGroupCount"), out var __jsonVolumeGroupCount) ? (long?)__jsonVolumeGroupCount : VolumeGroupCount;}
            {_totalIops = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Json.JsonNumber>("totalIops"), out var __jsonTotalIops) ? (long?)__jsonTotalIops : TotalIops;}
            {_totalMBps = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Json.JsonNumber>("totalMBps"), out var __jsonTotalMBps) ? (long?)__jsonTotalMBps : TotalMBps;}
            {_totalSizeTiB = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Json.JsonNumber>("totalSizeTiB"), out var __jsonTotalSizeTiB) ? (long?)__jsonTotalSizeTiB : TotalSizeTiB;}
            ...
            {_publicNetworkAccess = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Json.JsonString>("publicNetworkAccess"), out var __jsonPublicNetworkAccess) ? (string)__jsonPublicNetworkAccess : (string)PublicNetworkAccess;}
            AfterFromJson(json);
        }
