...
Describe 'Update-AzElasticSanVolume' {
    It 'UpdateExpanded' {
        $volume = Update-AzElasticSanVolume -ResourceGroupName $env.ResourceGroupName -ElasticSanName $env.ElasticSanName1 -VolumeGroupName $env.VolumeGroupName -Name $env.VolumeName -SizeGib 120
