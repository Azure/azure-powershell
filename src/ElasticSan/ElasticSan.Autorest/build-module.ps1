...
$dll = Join-Path $PSScriptRoot 'bin/Az.ElasticSan.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom/Az.ElasticSan.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.ElasticSan.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: ElasticSan cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.ElasticSan.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"ElasticSan","ModuleRootName":"$(root-module-name)"}' -AsHashtable
