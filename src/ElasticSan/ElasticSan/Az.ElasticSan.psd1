...
FunctionsToExport = 'Add-AzElasticSanVolumeGroupNetworkRule', 
               'Backup-AzElasticSanVolumePre', 'Get-AzElasticSan', 
               ...
               'Restore-AzElasticSanVolumePre', 'Update-AzElasticSan', 
