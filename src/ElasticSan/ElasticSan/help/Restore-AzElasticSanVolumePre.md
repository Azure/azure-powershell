...
online version: https://learn.microsoft.com/powershell/module/az.elasticsan/restore-azelasticsanvolumepre
schema: 2.0.0
---

# Restore-AzElasticSanVolumePre
...
```
Restore-AzElasticSanVolumePre -ElasticSanName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Restore-AzElasticSanVolumePre -VolumeGroupName <String> -ElasticSanInputObject <IElasticSanIdentity>
...
```
Restore-AzElasticSanVolumePre -InputObject <IElasticSanIdentity> -DiskSnapshotId <String[]>
...
### RestoreViaIdentity
```
Restore-AzElasticSanVolumePre -InputObject <IElasticSanIdentity> -Parameter <IDiskSnapshotList>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
