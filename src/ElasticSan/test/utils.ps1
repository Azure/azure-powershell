...
function setupEnv() {
    ...
    $env.Keyvaultname = "testyifanz1vault2"
    $env.Keyname = "testkey1"
    $env.KeyvaultUri = "https://testyifanz1vault2.vault.azure.net:443"
    $uai1 = "elasticsantestuid1"
    $uai2 = "elasticsantestuid2"
