...
namespace Microsoft.Azure.Commands.ArtifactSigning.Test.ScenarioTests
{
    public class ArtifactSigningTests: ArtifactSigningTestRunner
    {
        public ArtifactSigningTests(Xunit.Abstractions.ITestOutputHelper output) : base(output)
        {
        }
