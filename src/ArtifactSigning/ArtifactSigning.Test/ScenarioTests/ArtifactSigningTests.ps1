...
function Test-CodeSigningEku {
    ...
    try {
        ...
        $eku = Get-AzArtifactSigningCustomerEku -AccountName $accountName -ProfileName $profileName -EndpointUrl $endPointUrl
...
function Test-GetCodeSigningRootCert {
    ...
    try {
        ...
        $cert = Get-AzArtifactSigningCertificateRoot -AccountName $accountName -ProfileName $profileName -EndpointUrl $endPointUrl -Destination $destination
...
function Test-GetCodeSigningCertChain {
    ...
    try {
        ...
        $chain = Get-AzArtifactSigningCertificateChain -AccountName $accountName -ProfileName $profileName -EndpointUrl $endPointUrl -Destination $destination
