...
using Microsoft.Azure.Commands.ArtifactSigning.Helpers;
...
namespace Microsoft.Azure.Commands.ArtifactSigning
{
    ...
    public class InvokeCIPolicySigning : ArtifactSigningCmdletBase
    {
        ...
        [Parameter(Mandatory = true,
            ...
            HelpMessage = "The account name of Azure ArtifactSigning.")]
        ...
        [Parameter(Mandatory = true,
            ...
            ParameterSetName = ByAccountProfileNameParameterSet,
            ValueFromPipelineByPropertyName = true,
            HelpMessage = "The certificate profile name of Azure ArtifactSigning account.")]
        [ValidateNotNullOrEmpty()]
