...
online version: https://learn.microsoft.com/powershell/module/az.artifactsigning/remove-azartifactsigningaccount
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzArtifactSigningAccount -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzArtifactSigningAccount -InputObject <IArtifactSigningIdentity> [-DefaultProfile <PSObject>] [-AsJob]
