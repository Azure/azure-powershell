...
online version: https://learn.microsoft.com/powershell/module/az.artifactsigning/get-azartifactsigningcertificateprofile
schema: 2.0.0
---

# Get-AzArtifactSigningCertificateProfile
...
### List (Default)
```
Get-AzArtifactSigningCertificateProfile -AccountName <String> -ResourceGroupName <String>
...
### Get
```
Get-AzArtifactSigningCertificateProfile -AccountName <String> -ProfileName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
```
Get-AzArtifactSigningCertificateProfile -ProfileName <String>
 -CodeSigningAccountInputObject <IArtifactSigningIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzArtifactSigningCertificateProfile -InputObject <IArtifactSigningIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Example 1: Get Artifact signing Certificate Profile
```powershell
...
### Example 2: List Artifact signing Certificate Profiles
```powershell
...
This command lists artifact signing certificate profiles
