...
{
    public class ArtifactSigningCmdletBase : AzureRMCmdlet
    {
        ...
        internal IArtifactSigningServiceClient CodeSigningServiceClient
        {
            get
            {
                if (codeSigningServiceClient == null)
                {
                    this.codeSigningServiceClient = new ArtifactSigningServiceClient(
        ...
        private IArtifactSigningServiceClient codeSigningServiceClient;
