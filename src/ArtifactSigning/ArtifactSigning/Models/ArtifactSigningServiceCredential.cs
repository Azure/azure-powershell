...
{
    internal class ArtifactSigningServiceCredential
    {
        private readonly IAuthenticationFactory _authenticationFactory;
        private readonly IAzureContext _context;
        private readonly string _endpointName;

        public ArtifactSigningServiceCredential(IAuthenticationFactory authFactory, IAzureContext context, string resourceIdEndpoint)
        {
            if (authFactory == null)
