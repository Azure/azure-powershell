...
namespace Microsoft.Azure.Commands.ArtifactSigning.Models
{
    ...
    {
        private readonly ArtifactSigningServiceCredential codeSigningServiceCredential;

        public UserSuppliedCredential(ArtifactSigningServiceCredential codeSigningServiceCredential)
        {
