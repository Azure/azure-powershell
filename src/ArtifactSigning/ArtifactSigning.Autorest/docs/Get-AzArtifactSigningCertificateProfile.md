...
### Get
```
Get-AzArtifactSigningCertificateProfile -AccountName <String> -ProfileName <String>
...
```
Get-AzArtifactSigningCertificateProfile -CodeSigningAccountInputObject <IArtifactSigningIdentity>
...
This command gets an Artifact Signing Certificate Profile.
