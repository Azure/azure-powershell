...
online version: https://learn.microsoft.com/powershell/module/az.artifactsigning/update-azartifactsigningaccount
schema: 2.0.0
---
...
```
Update-AzArtifactSigningAccount -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzArtifactSigningAccount -InputObject <IArtifactSigningIdentity> [-SkuName <String>] [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaJsonFilePath
```
Update-AzArtifactSigningAccount -AccountName <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### UpdateViaJsonString
```
Update-AzArtifactSigningAccount -AccountName <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
This command updates an Artifact Signing Account SKU from Basic to Premium
...
This command updates an Artifact Signing Account SKU from Premium to Basic
