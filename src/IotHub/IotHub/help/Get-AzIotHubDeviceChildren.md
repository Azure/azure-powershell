...
online version: https://learn.microsoft.com/powershell/module/az.iothub/get-aziothubdevicechildren
schema: 2.0.0
---
...
## DESCRIPTION
Show all assigned non-edge devices as comma-separated list of all edge devices or specified device.
...
Show all assigned non-edge devices as comma-separated list of all edge devices.
