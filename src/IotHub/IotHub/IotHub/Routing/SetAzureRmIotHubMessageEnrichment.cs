...
namespace Microsoft.Azure.Commands.Management.IotHub
{
    ...
    [Cmdlet("Set", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "IotHubMessageEnrichment", DefaultParameterSetName = ResourceParameterSet, SupportsShouldProcess = true), OutputType(typeof(PSEnrichmentMetadata))]
    [Alias("Set-" + ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "IotHubMsgEnrich")]
    public class SetAzureRmIotHubMessageEnrichment : IotHubBaseCmdlet
    {
        ...
        [Parameter(Mandatory = false, ParameterSetName = InputObjectParameterSet, HelpMessage = "The enrichment's value.")]
        [Parameter(Mandatory = false, ParameterSetName = ResourceIdParameterSet, HelpMessage = "The enrichment's value.")]
        [Parameter(Mandatory = false, ParameterSetName = ResourceParameterSet, HelpMessage = "The enrichment's value.")]
        [ValidateNotNullOrEmpty]
        public string Value { get; set; }

        [Parameter(Mandatory = false, ParameterSetName = InputObjectParameterSet, HelpMessage = "Endpoint(s) to apply enrichments to.")]
        [Parameter(Mandatory = false, ParameterSetName = ResourceIdParameterSet, HelpMessage = "Endpoint(s) to apply enrichments to.")]
        [Parameter(Mandatory = false, ParameterSetName = ResourceParameterSet, HelpMessage = "Endpoint(s) to apply enrichments to.")]
        [ValidateNotNullOrEmpty]
