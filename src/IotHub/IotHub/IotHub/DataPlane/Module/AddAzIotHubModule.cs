...
namespace Microsoft.Azure.Commands.Management.IotHub
{
    ...
    [Cmdlet("Add", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "IotHubModule", DefaultParameterSetName = ResourceParameterSet, SupportsShouldProcess = true)]
    [OutputType(typeof(PSModule))]
    public class AddAzIotHubModule : IotHubBaseCmdlet, IDynamicParameters
    {
