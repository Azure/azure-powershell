...
namespace Microsoft.Azure.Commands.Management.IotHub
{
    ...
    [Cmdlet("Invoke", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "IotHubConfigurationMetricsQuery", DefaultParameterSetName = ResourceParameterSet, SupportsShouldProcess = true)]
    [Alias("Invoke-" + ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "IotHubConfigMetric")]
    [OutputType(typeof(PSConfigurationMetricsResult))]
    public class InvokeAzIotHubConfigurationMetricsQuery : IotHubBaseCmdlet
    {
