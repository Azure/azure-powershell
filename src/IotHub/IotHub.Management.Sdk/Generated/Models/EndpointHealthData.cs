...
namespace Microsoft.Azure.Management.IotHub.Models
{
    ...
    public partial class EndpointHealthData
    {
        ...
        /// <param name="endpointId">Id of the endpoint
        /// </param>

        /// <param name="healthStatus">Health statuses have following meanings. The &#39;healthy&#39; status shows that
        ...
        /// established a connection with the endpoint. No messages have been delivered
        /// to or rejected from this endpoint
        /// Possible values include: &#39;unknown&#39;, &#39;healthy&#39;, &#39;degraded&#39;, &#39;unhealthy&#39;,
        /// &#39;dead&#39;</param>

        /// <param name="lastKnownError">Last error obtained when a message failed to be delivered to iot hub
        /// </param>

        /// <param name="lastKnownErrorTime">Time at which the last known error occurred
        /// </param>

        /// <param name="lastSuccessfulSendAttemptTime">Last time iot hub successfully sent a message to the endpoint
        /// </param>

        /// <param name="lastSendAttemptTime">Last time iot hub tried to send a message to the endpoint
        /// </param>
...

        {
            ...
            this.LastKnownErrorTime = lastKnownErrorTime;
            this.LastSuccessfulSendAttemptTime = lastSuccessfulSendAttemptTime;
            this.LastSendAttemptTime = lastSendAttemptTime;
            CustomInit();
        }
        ...
        /// <summary>
        /// Gets or sets health statuses have following meanings. The &#39;healthy&#39; status
        ...
        /// IoT Hub is retrying to send data to this endpoint. The status of an
        /// unhealthy endpoint will be updated to healthy when IoT Hub has established
        /// an eventually consistent state of health. The &#39;dead&#39; status shows that the
        /// endpoint is not accepting messages, after IoT Hub retried sending messages
        /// for the retrial period. See IoT Hub metrics to identify errors and monitor
        /// issues with endpoints. The &#39;unknown&#39; status shows that the IoT Hub has not
        /// established a connection with the endpoint. No messages have been delivered
        /// to or rejected from this endpoint Possible values include: &#39;unknown&#39;, &#39;healthy&#39;, &#39;degraded&#39;, &#39;unhealthy&#39;, &#39;dead&#39;
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "healthStatus")]
        public string HealthStatus {get; set; }

        /// <summary>
        /// Gets or sets last error obtained when a message failed to be delivered to
        /// iot hub
        /// </summary>
        ...
        public System.DateTimeOffset? LastKnownErrorTime {get; set; }
        ...
        public System.DateTimeOffset? LastSuccessfulSendAttemptTime {get; set; }
        ...
        public System.DateTimeOffset? LastSendAttemptTime {get; set; }
    }
}