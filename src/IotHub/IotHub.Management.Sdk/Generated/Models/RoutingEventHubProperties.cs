...
namespace Microsoft.Azure.Management.IotHub.Models
{
    ...
    public partial class RoutingEventHubProperties
    {
        ...
        /// <param name="id">Id of the event hub endpoint
        /// </param>

        /// <param name="connectionString">The connection string of the event hub endpoint.
        /// </param>

        /// <param name="endpointUri">The url of the event hub endpoint. It must include the protocol sb://
        /// </param>

        /// <param name="entityPath">Event hub name on the event hub namespace
        /// </param>

        /// <param name="authenticationType">Method used to authenticate against the event hub endpoint
        /// Possible values include: &#39;keyBased&#39;, &#39;identityBased&#39;</param>

        /// <param name="identity">Managed identity properties of routing event hub endpoint.
        /// </param>
        ...
        /// <param name="subscriptionId">The subscription identifier of the event hub endpoint.
        /// </param>

        /// <param name="resourceGroup">The name of the resource group of the event hub endpoint.
        /// </param>
