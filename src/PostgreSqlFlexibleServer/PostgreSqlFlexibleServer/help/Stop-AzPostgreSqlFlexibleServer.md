...
online version: https://learn.microsoft.com/powershell/module/az.postgresqlflexibleserver/stop-azpostgresqlflexibleserver
schema: 2.0.0
---
...
### StopViaIdentity
```
Stop-AzPostgreSqlFlexibleServer -InputObject <IPostgreSqlFlexibleServerIdentity> [-DefaultProfile <PSObject>]
...
Stops an Azure Database for PostgreSQL flexible server that is in ready state.
