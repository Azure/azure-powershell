...
online version: https://learn.microsoft.com/powershell/module/az.postgresqlflexibleserver/remove-azpostgresqlflexibleserverfirewallrule
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzPostgreSqlFlexibleServerFirewallRule -Name <String> -ResourceGroup <String> -ServerName <String>
...
```
Remove-AzPostgreSqlFlexibleServerFirewallRule -Name <String>
...
### DeleteViaIdentity
```
Remove-AzPostgreSqlFlexibleServerFirewallRule -InputObject <IPostgreSqlFlexibleServerIdentity>
...
```powershell
Remove-AzPostgreSqlFlexibleServerFirewallRule -SubscriptionId aaaa0a0a-bb1b-cc2c-dd3d-eeeeee4e4e4e -ResourceGroup example-resource-group -ServerName example-server -Name example-firewall-rule
```

Removes a firewall rule from an Azure Database for PostgreSQL flexible server.
