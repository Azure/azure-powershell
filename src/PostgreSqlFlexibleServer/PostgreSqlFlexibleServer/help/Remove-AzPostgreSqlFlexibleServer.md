...
online version: https://learn.microsoft.com/powershell/module/az.postgresqlflexibleserver/remove-azpostgresqlflexibleserver
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzPostgreSqlFlexibleServer -Name <String> -ResourceGroup <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzPostgreSqlFlexibleServer -InputObject <IPostgreSqlFlexibleServerIdentity> [-DefaultProfile <PSObject>]
