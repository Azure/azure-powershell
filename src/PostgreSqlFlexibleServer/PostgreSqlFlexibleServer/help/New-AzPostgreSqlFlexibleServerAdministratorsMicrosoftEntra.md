...
```
New-AzPostgreSqlFlexibleServerAdministratorsMicrosoftEntra -ObjectId <String> -ResourceGroup <String>
...
Adds a Microsoft Entra administrator to an Azure Database for PostgreSQL flexible server that has Microsoft Entra authentication enabled.
