...
online version: https://learn.microsoft.com/powershell/module/az.postgresqlflexibleserver/start-azpostgresqlflexibleserver
schema: 2.0.0
---
...
### Start (Default)
```
Start-AzPostgreSqlFlexibleServer -Name <String> -ResourceGroup <String> [-SubscriptionId <String>]
...
### StartViaIdentity
```
Start-AzPostgreSqlFlexibleServer -InputObject <IPostgreSqlFlexibleServerIdentity> [-DefaultProfile <PSObject>]
