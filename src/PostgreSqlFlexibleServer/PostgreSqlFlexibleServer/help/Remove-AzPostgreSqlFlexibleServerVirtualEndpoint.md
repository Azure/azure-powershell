...
online version: https://learn.microsoft.com/powershell/module/az.postgresqlflexibleserver/remove-azpostgresqlflexibleservervirtualendpoint
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzPostgreSqlFlexibleServerVirtualEndpoint -Name <String> -ResourceGroupName <String>
...
```
Remove-AzPostgreSqlFlexibleServerVirtualEndpoint -Name <String>
...
### DeleteViaIdentity
```
Remove-AzPostgreSqlFlexibleServerVirtualEndpoint -InputObject <IPostgreSqlFlexibleServerIdentity>
...
Removes virtual endpoints from an Azure Database for PostgreSQL flexible server with virtual endpoint name, server name, resource group, and subscription explicitly passed as arguments.
