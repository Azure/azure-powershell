...
Checks if a name is available or already used for an Azure Database for PostgreSQL flexible server with server name, location, and subscription explicitly passed as arguments.
