### Example 1: Get capabilities in a location
```powershell
...
Gets capabilities in a location for a subscription explicitly passed as an arguments. If subscription is not passed explicitly, it's taken from default context.
