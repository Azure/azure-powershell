...
Checks if a name is available or already used for an Azure Database for PostgreSQL flexible server with server name, and subscription explicitly passed as arguments. If subscription is not passed explicitly, it's taken from default context.
