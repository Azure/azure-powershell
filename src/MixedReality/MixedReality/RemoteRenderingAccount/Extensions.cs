...
namespace Microsoft.Azure.Commands.MixedReality.RemoteRenderingAccount
{
    ...
    internal static class Extensions
    {
        ...
        internal static IEnumerable<RemoteRenderingAccount> EnumerateBySubscription(this IRemoteRenderingAccountsOperations operations)
        {
            return Enumerate(() => operations.ListBySubscription(), link => operations.ListBySubscriptionNext(link)).ToList();
        }

        internal static IEnumerable<RemoteRenderingAccount> EnumerateByResourceGroup(this IRemoteRenderingAccountsOperations operations, string resourceGroupName)
        {
