...
### Get (Default)
```
Get-AzMixedRealitySpatialAnchorsAccount -AccountName <String> -ResourceGroupName <String>
...
### Example 1: Retrieve a Spatial Anchors Account.
```powershell
Get-AzMixedRealitySpatialAnchorsAccount -AccountName azpstestanchorsaccount -ResourceGroupName azps_test_group
```
