...
```
New-AzMixedRealityObjectAnchorsAccount -AccountName <String> -ResourceGroupName <String> -Location <String>
...
```powershell
New-AzMixedRealityObjectAnchorsAccount -AccountName azpstestanchorsaccount-object -ResourceGroupName azps_test_group -Location eastus2
```
