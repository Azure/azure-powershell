...
online version: https://docs.microsoft.com/powershell/module/az.mixedreality/get-azmixedrealityremoterenderingaccount
schema: 2.0.0
---
...
### Get
```
Get-AzMixedRealityRemoteRenderingAccount -AccountName <String> -ResourceGroupName <String>
