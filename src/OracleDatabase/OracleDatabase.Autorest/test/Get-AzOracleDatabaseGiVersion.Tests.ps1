if(($null -eq $TestName) -or ($TestName -contains 'Get-AzOracleDatabaseGiVersion'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Get-AzOracleDatabaseGiVersion.Recording.json'
