if(($null -eq $TestName) -or ($TestName -contains 'Get-AzOracleDatabaseAutonomousDatabaseVersion'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Get-AzOracleDatabaseAutonomousDatabaseVersion.Recording.json'
