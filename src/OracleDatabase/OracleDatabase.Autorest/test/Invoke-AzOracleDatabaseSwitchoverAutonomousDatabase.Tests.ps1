if(($null -eq $TestName) -or ($TestName -contains 'Invoke-AzOracleDatabaseSwitchoverAutonomousDatabase'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Invoke-AzOracleDatabaseSwitchoverAutonomousDatabase.Recording.json'
