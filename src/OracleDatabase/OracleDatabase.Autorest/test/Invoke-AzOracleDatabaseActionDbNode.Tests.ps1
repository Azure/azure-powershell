if(($null -eq $TestName) -or ($TestName -contains 'Invoke-AzOracleDatabaseActionDbNode'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Invoke-AzOracleDatabaseActionDbNode.Recording.json'
...
Describe 'Invoke-AzOracleDatabaseActionDbNode' {
