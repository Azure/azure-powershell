if(($null -eq $TestName) -or ($TestName -contains 'Restore-AzOracleDatabaseAutonomousDatabase'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Restore-AzOracleDatabaseAutonomousDatabase.Recording.json'
