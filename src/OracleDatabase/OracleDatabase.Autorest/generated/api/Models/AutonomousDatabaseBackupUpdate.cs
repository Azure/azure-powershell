...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models
{
    ...
    public partial class AutonomousDatabaseBackupUpdate :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IAutonomousDatabaseBackupUpdateInternal
    {

        /// <summary>Internal Acessors for Property</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IAutonomousDatabaseBackupUpdateProperties Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IAutonomousDatabaseBackupUpdateInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.AutonomousDatabaseBackupUpdateProperties()); set { {_property = value;} } }

        /// <summary>Backing field for <see cref="Property" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IAutonomousDatabaseBackupUpdateProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IAutonomousDatabaseBackupUpdateProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.AutonomousDatabaseBackupUpdateProperties()); set => this._property = value; }
    ...
    {
        /// <summary>The updatable properties of the AutonomousDatabaseBackup.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IAutonomousDatabaseBackupUpdateProperties Property { get; set; }
        /// <summary>Retention period, in days, for long-term backups.</summary>
        int? RetentionPeriodInDay { get; set; }
