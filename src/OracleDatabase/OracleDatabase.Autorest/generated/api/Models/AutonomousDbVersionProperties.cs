...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models
{
    ...
    public partial class AutonomousDbVersionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IAutonomousDbVersionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IAutonomousDbVersionPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IAutonomousDbVersionPropertiesInternal.DbWorkload { get => this._dbWorkload; set { {_dbWorkload = value;} } }

        /// <summary>Internal Acessors for IsDefaultForFree</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IAutonomousDbVersionPropertiesInternal.IsDefaultForFree { get => this._isDefaultForFree; set { {_isDefaultForFree = value;} } }

        /// <summary>Internal Acessors for IsDefaultForPaid</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IAutonomousDbVersionPropertiesInternal.IsDefaultForPaid { get => this._isDefaultForPaid; set { {_isDefaultForPaid = value;} } }

        /// <summary>Internal Acessors for IsFreeTierEnabled</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IAutonomousDbVersionPropertiesInternal.IsFreeTierEnabled { get => this._isFreeTierEnabled; set { {_isFreeTierEnabled = value;} } }

        /// <summary>Internal Acessors for IsPaidEnabled</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IAutonomousDbVersionPropertiesInternal.IsPaidEnabled { get => this._isPaidEnabled; set { {_isPaidEnabled = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IAutonomousDbVersionPropertiesInternal.Version { get => this._version; set { {_version = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.IJsonSerializable
    {
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.PSArgumentCompleterAttribute("OLTP", "DW", "AJD", "APEX")]
