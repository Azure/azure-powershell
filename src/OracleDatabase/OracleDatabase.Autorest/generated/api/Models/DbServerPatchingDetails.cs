...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models
{
    ...
    public partial class DbServerPatchingDetails :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbServerPatchingDetails,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbServerPatchingDetailsInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbServerPatchingDetailsInternal.EstimatedPatchDuration { get => this._estimatedPatchDuration; set { {_estimatedPatchDuration = value;} } }

        /// <summary>Internal Acessors for PatchingStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbServerPatchingDetailsInternal.PatchingStatus { get => this._patchingStatus; set { {_patchingStatus = value;} } }

        /// <summary>Internal Acessors for TimePatchingEnded</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbServerPatchingDetailsInternal.TimePatchingEnded { get => this._timePatchingEnded; set { {_timePatchingEnded = value;} } }

        /// <summary>Internal Acessors for TimePatchingStarted</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbServerPatchingDetailsInternal.TimePatchingStarted { get => this._timePatchingStarted; set { {_timePatchingStarted = value;} } }
