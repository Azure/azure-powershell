...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models
{
    ...
    public partial class OracleSubscriptionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IOracleSubscriptionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IOracleSubscriptionPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IOracleSubscriptionPropertiesInternal.CloudAccountId { get => this._cloudAccountId; set { {_cloudAccountId = value;} } }

        /// <summary>Internal Acessors for CloudAccountState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IOracleSubscriptionPropertiesInternal.CloudAccountState { get => this._cloudAccountState; set { {_cloudAccountState = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IOracleSubscriptionPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for SaasSubscriptionId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IOracleSubscriptionPropertiesInternal.SaasSubscriptionId { get => this._saasSubscriptionId; set { {_saasSubscriptionId = value;} } }
