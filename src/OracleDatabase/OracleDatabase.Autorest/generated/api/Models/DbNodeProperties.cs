...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models
{
    ...
    public partial class DbNodeProperties :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodeProperties,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.AdditionalDetail { get => this._additionalDetail; set { {_additionalDetail = value;} } }

        /// <summary>Internal Acessors for BackupIPId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.BackupIPId { get => this._backupIPId; set { {_backupIPId = value;} } }

        /// <summary>Internal Acessors for BackupVnic2Id</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.BackupVnic2Id { get => this._backupVnic2Id; set { {_backupVnic2Id = value;} } }

        /// <summary>Internal Acessors for BackupVnicId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.BackupVnicId { get => this._backupVnicId; set { {_backupVnicId = value;} } }

        /// <summary>Internal Acessors for CpuCoreCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.CpuCoreCount { get => this._cpuCoreCount; set { {_cpuCoreCount = value;} } }

        /// <summary>Internal Acessors for DbNodeStorageSizeInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.DbNodeStorageSizeInGb { get => this._dbNodeStorageSizeInGb; set { {_dbNodeStorageSizeInGb = value;} } }

        /// <summary>Internal Acessors for DbServerId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.DbServerId { get => this._dbServerId; set { {_dbServerId = value;} } }

        /// <summary>Internal Acessors for DbSystemId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.DbSystemId { get => this._dbSystemId; set { {_dbSystemId = value;} } }

        /// <summary>Internal Acessors for FaultDomain</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.FaultDomain { get => this._faultDomain; set { {_faultDomain = value;} } }

        /// <summary>Internal Acessors for HostIPId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.HostIPId { get => this._hostIPId; set { {_hostIPId = value;} } }

        /// <summary>Internal Acessors for Hostname</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.Hostname { get => this._hostname; set { {_hostname = value;} } }

        /// <summary>Internal Acessors for LifecycleDetail</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.LifecycleDetail { get => this._lifecycleDetail; set { {_lifecycleDetail = value;} } }

        /// <summary>Internal Acessors for LifecycleState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.LifecycleState { get => this._lifecycleState; set { {_lifecycleState = value;} } }

        /// <summary>Internal Acessors for MaintenanceType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.MaintenanceType { get => this._maintenanceType; set { {_maintenanceType = value;} } }

        /// <summary>Internal Acessors for MemorySizeInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.MemorySizeInGb { get => this._memorySizeInGb; set { {_memorySizeInGb = value;} } }

        /// <summary>Internal Acessors for Ocid</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.Ocid { get => this._ocid; set { {_ocid = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for SoftwareStorageSizeInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.SoftwareStorageSizeInGb { get => this._softwareStorageSizeInGb; set { {_softwareStorageSizeInGb = value;} } }

        /// <summary>Internal Acessors for TimeCreated</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.TimeCreated { get => this._timeCreated; set { {_timeCreated = value;} } }

        /// <summary>Internal Acessors for TimeMaintenanceWindowEnd</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.TimeMaintenanceWindowEnd { get => this._timeMaintenanceWindowEnd; set { {_timeMaintenanceWindowEnd = value;} } }

        /// <summary>Internal Acessors for TimeMaintenanceWindowStart</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.TimeMaintenanceWindowStart { get => this._timeMaintenanceWindowStart; set { {_timeMaintenanceWindowStart = value;} } }

        /// <summary>Internal Acessors for Vnic2Id</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.Vnic2Id { get => this._vnic2Id; set { {_vnic2Id = value;} } }

        /// <summary>Internal Acessors for VnicId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDbNodePropertiesInternal.VnicId { get => this._vnicId; set { {_vnicId = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.PSArgumentCompleterAttribute("Provisioning", "Available", "Updating", "Stopping", "Stopped", "Starting", "Terminating", "Terminated", "Failed")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.PSArgumentCompleterAttribute("VmdbRebootMigration")]
