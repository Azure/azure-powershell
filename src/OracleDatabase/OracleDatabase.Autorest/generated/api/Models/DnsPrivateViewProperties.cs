...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models
{
    ...
    public partial class DnsPrivateViewProperties :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateViewProperties,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateViewPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateViewPropertiesInternal.DisplayName { get => this._displayName; set { {_displayName = value;} } }

        /// <summary>Internal Acessors for IsProtected</summary>
        bool Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateViewPropertiesInternal.IsProtected { get => this._isProtected; set { {_isProtected = value;} } }

        /// <summary>Internal Acessors for LifecycleState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateViewPropertiesInternal.LifecycleState { get => this._lifecycleState; set { {_lifecycleState = value;} } }

        /// <summary>Internal Acessors for Ocid</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateViewPropertiesInternal.Ocid { get => this._ocid; set { {_ocid = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateViewPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for Self</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateViewPropertiesInternal.Self { get => this._self; set { {_self = value;} } }

        /// <summary>Internal Acessors for TimeCreated</summary>
        global::System.DateTime Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateViewPropertiesInternal.TimeCreated { get => this._timeCreated; set { {_timeCreated = value;} } }

        /// <summary>Internal Acessors for TimeUpdated</summary>
        global::System.DateTime Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateViewPropertiesInternal.TimeUpdated { get => this._timeUpdated; set { {_timeUpdated = value;} } }
