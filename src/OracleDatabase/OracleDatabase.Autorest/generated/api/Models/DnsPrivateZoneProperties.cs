...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models
{
    ...
    public partial class DnsPrivateZoneProperties :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateZoneProperties,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateZonePropertiesInternal
    {
        ...
        bool Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateZonePropertiesInternal.IsProtected { get => this._isProtected; set { {_isProtected = value;} } }

        /// <summary>Internal Acessors for LifecycleState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateZonePropertiesInternal.LifecycleState { get => this._lifecycleState; set { {_lifecycleState = value;} } }

        /// <summary>Internal Acessors for Ocid</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateZonePropertiesInternal.Ocid { get => this._ocid; set { {_ocid = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateZonePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for Self</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateZonePropertiesInternal.Self { get => this._self; set { {_self = value;} } }

        /// <summary>Internal Acessors for Serial</summary>
        int Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateZonePropertiesInternal.Serial { get => this._serial; set { {_serial = value;} } }

        /// <summary>Internal Acessors for TimeCreated</summary>
        global::System.DateTime Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateZonePropertiesInternal.TimeCreated { get => this._timeCreated; set { {_timeCreated = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateZonePropertiesInternal.Version { get => this._version; set { {_version = value;} } }

        /// <summary>Internal Acessors for ViewId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateZonePropertiesInternal.ViewId { get => this._viewId; set { {_viewId = value;} } }

        /// <summary>Internal Acessors for ZoneType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateZonePropertiesInternal.ZoneType { get => this._zoneType; set { {_zoneType = value;} } }
