...
### CreateViaIdentity
```
New-AzOracleDatabaseResourceManagerCloudVMCluster -InputObject <IOracleDatabaseResourceManagerIdentity>
 -Resource <ICloudVMCluster> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
