...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/update-azoracledatabaseautonomousdatabase
schema: 2.0.0
---

# Update-AzOracleDatabaseAutonomousDatabase
...
```
Update-AzOracleDatabaseAutonomousDatabase -Name <String> -ResourceGroupName <String>
...
### UpdateViaIdentity
```
Update-AzOracleDatabaseAutonomousDatabase -InputObject <IOracleDatabaseIdentity>
...
```
Update-AzOracleDatabaseAutonomousDatabase -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### UpdateViaJsonString
```
Update-AzOracleDatabaseAutonomousDatabase -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IAutonomousDatabaseUpdate
