...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/new-azoracledatabasecloudexadatainfrastructure
schema: 2.0.0
---

# New-AzOracleDatabaseCloudExadataInfrastructure
...
```
New-AzOracleDatabaseCloudExadataInfrastructure -Name <String> -ResourceGroupName <String> -Location <String>
...
### Create
```
New-AzOracleDatabaseCloudExadataInfrastructure -Name <String> -ResourceGroupName <String>
...
### CreateViaIdentity
```
New-AzOracleDatabaseCloudExadataInfrastructure -InputObject <IOracleDatabaseIdentity>
 -Resource <ICloudExadataInfrastructure> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzOracleDatabaseCloudExadataInfrastructure -InputObject <IOracleDatabaseIdentity> -Location <String>
 -Zone <String[]> [-ComputeCount <Int32>] [-CustomerContact <ICustomerContact[]>] [-DisplayName <String>]
...
### CreateViaJsonString
```
New-AzOracleDatabaseCloudExadataInfrastructure -Name <String> -ResourceGroupName <String> -JsonString <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDayOfWeek[]
Parameter Sets: CreateExpanded, CreateViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IMonth[]
Parameter Sets: CreateExpanded, CreateViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.ICloudExadataInfrastructure
