...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/remove-azoracledatabaseautonomousdatabasebackup
schema: 2.0.0
---

# Remove-AzOracleDatabaseAutonomousDatabaseBackup
...
### Delete (Default)
```
Remove-AzOracleDatabaseAutonomousDatabaseBackup -Adbbackupid <String> -Autonomousdatabasename <String>
...
### DeleteViaIdentity
```
Remove-AzOracleDatabaseAutonomousDatabaseBackup -InputObject <IOracleDatabaseIdentity>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentityAutonomousDatabase
```
Remove-AzOracleDatabaseAutonomousDatabaseBackup -Adbbackupid <String>
 -AutonomousDatabaseInputObject <IOracleDatabaseIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
