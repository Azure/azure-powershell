...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/set-azoracledatabaseautonomousdatabase
schema: 2.0.0
---
...
```
Set-AzOracleDatabaseAutonomousDatabase -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-PeerDbId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Failover
```
Set-AzOracleDatabaseAutonomousDatabase -Name <String> -ResourceGroupName <String> -Body <IPeerDbDetails>
...
```
Set-AzOracleDatabaseAutonomousDatabase -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Set-AzOracleDatabaseAutonomousDatabase -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### Update
```
Set-AzOracleDatabaseAutonomousDatabase -Name <String> -ResourceGroupName <String>
...
### UpdateExpanded
```
Set-AzOracleDatabaseAutonomousDatabase -Name <String> -ResourceGroupName <String> -Location <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IPeerDbDetails
