...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanager/remove-azoracledatabaseresourcemanagercloudvmcluster
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzOracleDatabaseResourceManagerCloudVMCluster -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzOracleDatabaseResourceManagerCloudVMCluster -InputObject <IOracleDatabaseResourceManagerIdentity>
