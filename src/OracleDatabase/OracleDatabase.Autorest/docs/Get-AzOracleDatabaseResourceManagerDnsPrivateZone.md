...
```
Get-AzOracleDatabaseResourceManagerDnsPrivateZone
 -LocationInputObject <IOracleDatabaseResourceManagerIdentity> -Name <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDnsPrivateZone
