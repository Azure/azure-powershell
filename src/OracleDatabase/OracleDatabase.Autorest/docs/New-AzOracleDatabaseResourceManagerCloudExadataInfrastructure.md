...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanager/new-azoracledatabaseresourcemanagercloudexadatainfrastructure
schema: 2.0.0
---
...
```
New-AzOracleDatabaseResourceManagerCloudExadataInfrastructure -Name <String> -ResourceGroupName <String>
 -Location <String> -Zone <String[]> [-SubscriptionId <String>] [-ComputeCount <Int32>]
...
```
New-AzOracleDatabaseResourceManagerCloudExadataInfrastructure
 -InputObject <IOracleDatabaseResourceManagerIdentity> -Resource <ICloudExadataInfrastructure>
...
```
New-AzOracleDatabaseResourceManagerCloudExadataInfrastructure
 -InputObject <IOracleDatabaseResourceManagerIdentity> -Location <String> -Zone <String[]>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IDayOfWeek[]
Parameter Sets: CreateExpanded, CreateViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.IMonth[]
Parameter Sets: CreateExpanded, CreateViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.ICloudExadataInfrastructure
