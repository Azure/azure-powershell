...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/invoke-azoracledatabaseswitchoverautonomousdatabase
schema: 2.0.0
---

# Invoke-AzOracleDatabaseSwitchoverAutonomousDatabase
...
```
Invoke-AzOracleDatabaseSwitchoverAutonomousDatabase -Autonomousdatabasename <String>
...
```
Invoke-AzOracleDatabaseSwitchoverAutonomousDatabase -InputObject <IOracleDatabaseIdentity>
 -Body <IPeerDbDetails> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
