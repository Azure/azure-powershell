...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/set-azoracledatabasecloudexadatainfrastructure
schema: 2.0.0
---

# Set-AzOracleDatabaseCloudExadataInfrastructure
...
```
Set-AzOracleDatabaseCloudExadataInfrastructure -Name <String> -ResourceGroupName <String> -Location <String>
...
### Update
```
Set-AzOracleDatabaseCloudExadataInfrastructure -Name <String> -ResourceGroupName <String>
...
### UpdateViaJsonString
```
Set-AzOracleDatabaseCloudExadataInfrastructure -Name <String> -ResourceGroupName <String> -JsonString <String>
