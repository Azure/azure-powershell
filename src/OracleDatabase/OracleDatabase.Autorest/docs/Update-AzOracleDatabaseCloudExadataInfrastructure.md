...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/update-azoracledatabasecloudexadatainfrastructure
schema: 2.0.0
---

# Update-AzOracleDatabaseCloudExadataInfrastructure
...
```
Update-AzOracleDatabaseCloudExadataInfrastructure -Name <String> -ResourceGroupName <String>
...
### UpdateViaIdentity
```
Update-AzOracleDatabaseCloudExadataInfrastructure -InputObject <IOracleDatabaseIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.ICloudExadataInfrastructureUpdate
