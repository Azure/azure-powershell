...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/set-azoracledatabaseautonomousdatabasebackup
schema: 2.0.0
---

# Set-AzOracleDatabaseAutonomousDatabaseBackup
...
```
Set-AzOracleDatabaseAutonomousDatabaseBackup -Adbbackupid <String> -Autonomousdatabasename <String>
