...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/set-azoracledatabasecloudvmcluster
schema: 2.0.0
---

# Set-AzOracleDatabaseCloudVMCluster
...
```
Set-AzOracleDatabaseCloudVMCluster -Name <String> -ResourceGroupName <String> -Location <String>
...
### Update
```
Set-AzOracleDatabaseCloudVMCluster -Name <String> -ResourceGroupName <String> -Resource <ICloudVMCluster>
...
```
Set-AzOracleDatabaseCloudVMCluster -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### UpdateViaJsonString
```
Set-AzOracleDatabaseCloudVMCluster -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
