...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanager/set-azoracledatabaseresourcemanagerautonomousdatabase
schema: 2.0.0
---

# Set-AzOracleDatabaseResourceManagerAutonomousDatabase
...
```
Set-AzOracleDatabaseResourceManagerAutonomousDatabase -Name <String> -ResourceGroupName <String>
...
```yaml
Type: System.String
Parameter Sets: FailoverViaJsonFilePath, UpdateViaJsonFilePath
Aliases:
...
```yaml
Type: System.String
Parameter Sets: FailoverViaJsonString, UpdateViaJsonString
Aliases:
