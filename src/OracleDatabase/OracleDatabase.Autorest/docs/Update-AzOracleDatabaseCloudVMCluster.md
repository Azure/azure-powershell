...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/update-azoracledatabasecloudvmcluster
schema: 2.0.0
---

# Update-AzOracleDatabaseCloudVMCluster
...
```
Update-AzOracleDatabaseCloudVMCluster -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### Update
```
Update-AzOracleDatabaseCloudVMCluster -Name <String> -ResourceGroupName <String>
...
### UpdateViaIdentity
```
Update-AzOracleDatabaseCloudVMCluster -InputObject <IOracleDatabaseIdentity> -Property <ICloudVMClusterUpdate>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzOracleDatabaseCloudVMCluster -InputObject <IOracleDatabaseIdentity> [-ComputeNode <String[]>]
...
```
Update-AzOracleDatabaseCloudVMCluster -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### UpdateViaJsonString
```
Update-AzOracleDatabaseCloudVMCluster -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.ICloudVMClusterUpdate
