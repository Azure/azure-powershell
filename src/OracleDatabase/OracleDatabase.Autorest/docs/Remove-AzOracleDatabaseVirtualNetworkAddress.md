...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/remove-azoracledatabasevirtualnetworkaddress
schema: 2.0.0
---

# Remove-AzOracleDatabaseVirtualNetworkAddress
...
### Delete (Default)
```
Remove-AzOracleDatabaseVirtualNetworkAddress -Cloudvmclustername <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzOracleDatabaseVirtualNetworkAddress -InputObject <IOracleDatabaseIdentity>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentityCloudVMCluster
```
Remove-AzOracleDatabaseVirtualNetworkAddress -CloudVMClusterInputObject <IOracleDatabaseIdentity>
...
### Example 1: Delete a Virtual Network Address on a Cloud VM Cluster resource
```powershell
...
Parameter Sets: DeleteViaIdentityCloudVMCluster
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Delete, DeleteViaIdentityCloudVMCluster
