...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/get-azoracledatabaseoraclesubscriptionactivationlink
schema: 2.0.0
---
...
```
Get-AzOracleDatabaseOracleSubscriptionActivationLink [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
...
### Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IActivationLinks
