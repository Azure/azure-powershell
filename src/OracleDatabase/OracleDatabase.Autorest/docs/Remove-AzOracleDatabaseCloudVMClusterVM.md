...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/remove-azoracledatabasecloudvmclustervm
schema: 2.0.0
---

# Remove-AzOracleDatabaseCloudVMClusterVM
...
```
Remove-AzOracleDatabaseCloudVMClusterVM -Cloudvmclustername <String> -ResourceGroupName <String>
...
### RemoveViaIdentity
```
Remove-AzOracleDatabaseCloudVMClusterVM -InputObject <IOracleDatabaseIdentity> -Body <IAddRemoveDbNode>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentityExpanded
```
Remove-AzOracleDatabaseCloudVMClusterVM -InputObject <IOracleDatabaseIdentity> -DbServer <String[]>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
