...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/update-azoracledatabasevirtualnetworkaddress
schema: 2.0.0
---

# Update-AzOracleDatabaseVirtualNetworkAddress
...
```
Update-AzOracleDatabaseVirtualNetworkAddress -Cloudvmclustername <String> -Name <String>
...
### UpdateViaIdentity
```
Update-AzOracleDatabaseVirtualNetworkAddress -InputObject <IOracleDatabaseIdentity>
...
```
Update-AzOracleDatabaseVirtualNetworkAddress -CloudVMClusterInputObject <IOracleDatabaseIdentity>
 -Name <String> -Resource <IVirtualNetworkAddress> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
...
### Example 1: Updates a Virtual Network Address on a Cloud VM Cluster resource
```powershell
