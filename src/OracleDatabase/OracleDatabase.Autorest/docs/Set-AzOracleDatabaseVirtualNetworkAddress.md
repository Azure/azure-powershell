...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/set-azoracledatabasevirtualnetworkaddress
schema: 2.0.0
---

# Set-AzOracleDatabaseVirtualNetworkAddress
...
```
Set-AzOracleDatabaseVirtualNetworkAddress -Cloudvmclustername <String> -Name <String>
