...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanager/set-azoracledatabaseresourcemanagercloudvmcluster
schema: 2.0.0
---

# Set-AzOracleDatabaseResourceManagerCloudVMCluster
...
```
Set-AzOracleDatabaseResourceManagerCloudVMCluster -Name <String> -ResourceGroupName <String>
...
```
Set-AzOracleDatabaseResourceManagerCloudVMCluster -Name <String> -ResourceGroupName <String>
 -Resource <ICloudVMCluster> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.INsgCidr[]
Parameter Sets: UpdateExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.ICloudVMCluster
