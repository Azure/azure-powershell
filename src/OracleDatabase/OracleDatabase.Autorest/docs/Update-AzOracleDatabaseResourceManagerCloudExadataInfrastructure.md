...
```
Update-AzOracleDatabaseResourceManagerCloudExadataInfrastructure
 -InputObject <IOracleDatabaseResourceManagerIdentity> -Property <ICloudExadataInfrastructureUpdate>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.ICloudExadataInfrastructureUpdate
...
### Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.ICloudExadataInfrastructureUpdate
