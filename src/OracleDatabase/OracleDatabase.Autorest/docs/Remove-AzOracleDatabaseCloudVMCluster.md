...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/remove-azoracledatabasecloudvmcluster
schema: 2.0.0
---

# Remove-AzOracleDatabaseCloudVMCluster
...
### Delete (Default)
```
Remove-AzOracleDatabaseCloudVMCluster -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzOracleDatabaseCloudVMCluster -InputObject <IOracleDatabaseIdentity> [-DefaultProfile <PSObject>]
