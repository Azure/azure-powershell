...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabase/add-azoracledatabasecloudvmclustervm
schema: 2.0.0
---

# Add-AzOracleDatabaseCloudVMClusterVM
...
### AddExpanded (Default)
```
Add-AzOracleDatabaseCloudVMClusterVM -Cloudvmclustername <String> -ResourceGroupName <String>
...
### AddViaIdentity
```
Add-AzOracleDatabaseCloudVMClusterVM -InputObject <IOracleDatabaseIdentity> -Body <IAddRemoveDbNode>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AddViaIdentityExpanded
```
Add-AzOracleDatabaseCloudVMClusterVM -InputObject <IOracleDatabaseIdentity> -DbServer <String[]>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IAddRemoveDbNode
...
### Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IAddRemoveDbNode
