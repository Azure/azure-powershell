...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom/Az.OracleDatabaseResourceManager.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.OracleDatabaseResourceManager.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: OracleDatabaseResourceManager cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.OracleDatabaseResourceManager.format.ps1xml'
