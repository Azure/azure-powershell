if(($null -eq $TestName) -or ($TestName -contains 'OracleExadbVMCluster'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'OracleExadbVMCluster.Recording.json'
