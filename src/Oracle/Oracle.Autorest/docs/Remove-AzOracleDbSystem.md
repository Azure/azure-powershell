...
online version: https://learn.microsoft.com/powershell/module/az.oracle/remove-azoracledbsystem
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzOracleDbSystem -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzOracleDbSystem -InputObject <IOracleIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
