...
online version: https://learn.microsoft.com/powershell/module/az.oracle/update-azoraclegoldengatedeployment
schema: 2.0.0
---
...
```
Update-AzOracleGoldenGateDeployment -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-BackupScheduleBucketName <String>] [-BackupScheduleCompartmentId <String>]
 [-BackupScheduleFrequencyBackupScheduled <String>] [-BackupScheduleIsMetadataOnly]
 [-BackupScheduleNamespaceName <String>] [-BackupScheduleTimeBackupScheduled <String>] [-CpuCoreCount <Int32>]
 [-LicenseModel <String>] [-MaintenanceConfigurationBundleReleaseUpgradePeriodInDay <Int32>]
 ...
 [-MaintenanceWindowStartHour <Int32>] [-Tag <Hashtable>] [-Zone <String[]>] [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzOracleGoldenGateDeployment -InputObject <IOracleIdentity> [-BackupScheduleBucketName <String>]
 [-BackupScheduleCompartmentId <String>] [-BackupScheduleFrequencyBackupScheduled <String>]
 [-BackupScheduleIsMetadataOnly] [-BackupScheduleNamespaceName <String>]
 [-BackupScheduleTimeBackupScheduled <String>] [-CpuCoreCount <Int32>] [-LicenseModel <String>]
...
```
Update-AzOracleGoldenGateDeployment -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### UpdateViaJsonString
```
Update-AzOracleGoldenGateDeployment -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
