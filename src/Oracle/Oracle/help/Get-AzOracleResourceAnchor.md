...
### List (Default)
```
Get-AzOracleResourceAnchor [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-AzOracleResourceAnchor -InputObject <IOracleIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
