...
namespace Microsoft.Azure.Management.RedisCache
{
    ...
    /// </summary>
    internal partial class PrivateLinkResourcesOperations : Microsoft.Rest.IServiceOperations<RedisManagementClient>, IPrivateLinkResourcesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal PrivateLinkResourcesOperations (RedisManagementClient client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<System.Collections.Generic.IEnumerable<PrivateLinkResource>>> ListByRedisCacheWithHttpMessagesAsync(string resourceGroupName, string cacheName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                Microsoft.Rest.ServiceClientTracing.Enter(_invocationId, this, "ListByRedisCache", tracingParameters);
            }
            // Construct URL

            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/redis/{cacheName}/privateLinkResources").ToString();
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<System.Collections.Generic.IEnumerable<PrivateLinkResource>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page1<PrivateLinkResource>>(_responseContent, this.Client.DeserializationSettings);
                }
