...
namespace Microsoft.Azure.Management.RedisCache
{
    ...
    public partial interface IRedisOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse> CheckNameAvailabilityWithHttpMessagesAsync(string name, string type, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<RedisAccessKeys>> RegenerateKeyWithHttpMessagesAsync(string resourceGroupName, string name, RedisKeyType keyType, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
