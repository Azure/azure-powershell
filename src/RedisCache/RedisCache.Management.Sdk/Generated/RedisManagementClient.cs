...
namespace Microsoft.Azure.Management.RedisCache
{
    ...
    public partial class RedisManagementClient : Microsoft.Rest.ServiceClient<RedisManagementClient>, IRedisManagementClient, IAzureClient
    {
        ...
        protected RedisManagementClient(System.Net.Http.HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            this.Initialize();
        }
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public RedisManagementClient(Microsoft.Rest.ServiceClientCredentials credentials, System.Net.Http.HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
        ...
        private void Initialize()
        {
            ...
            this.LinkedServer = new LinkedServerOperations(this);
