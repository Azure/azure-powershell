...
namespace Microsoft.Azure.Management.RedisCache
{
    ...
    public static partial class PatchSchedulesOperationsExtensions
    {
            ...
            /// </param>
            public static RedisPatchSchedule CreateOrUpdate(this IPatchSchedulesOperations operations, string resourceGroupName, string name, IList<ScheduleEntry> scheduleEntries)
            {
                return operations.CreateOrUpdateAsync(resourceGroupName, name, scheduleEntries).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<RedisPatchSchedule> CreateOrUpdateAsync(this IPatchSchedulesOperations operations, string resourceGroupName, string name, IList<ScheduleEntry> scheduleEntries, CancellationToken cancellationToken = default(CancellationToken))
            {
