...
namespace Microsoft.Azure.Management.RedisCache
{
    ...
    public static partial class FirewallRulesOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<RedisFirewallRule> CreateOrUpdateAsync(this IFirewallRulesOperations operations, string resourceGroupName, string cacheName, string ruleName, string startIP, string endIP, CancellationToken cancellationToken = default(CancellationToken))
            {
