...
namespace Microsoft.Azure.Management.RedisCache
{
    ...
    public static partial class RedisOperationsExtensions
    {
            ...
            {
                operations.CheckNameAvailabilityAsync(name, type).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task CheckNameAvailabilityAsync(this IRedisOperations operations, string name, string type, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<RedisAccessKeys> RegenerateKeyAsync(this IRedisOperations operations, string resourceGroupName, string name, RedisKeyType keyType, CancellationToken cancellationToken = default(CancellationToken))
            {
