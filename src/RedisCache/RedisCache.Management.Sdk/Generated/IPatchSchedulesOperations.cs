...
namespace Microsoft.Azure.Management.RedisCache
{
    ...
    public partial interface IPatchSchedulesOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<RedisPatchSchedule>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string name, IList<ScheduleEntry> scheduleEntries, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
