...
CmdletsToExport = 'Remove-AzRedisCachePatchSchedule', 'New-AzRedisCacheScheduleEntry', 
               ...
               'Remove-AzRedisPrivateEndpointConnection','Set-AzRedisPrivateEndpointConnectionStatus',
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added ''RedisVersion'' parameter in ''New-AzRedisCache'' and ''Set-AzRedisCache'''
