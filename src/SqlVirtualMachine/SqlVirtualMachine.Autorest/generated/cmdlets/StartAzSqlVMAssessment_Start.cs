...
namespace Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] StartAssessment=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SqlVirtualMachine/sqlVirtualMachines/{sqlVirtualMachineName}/startAssessment"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzSqlVMAssessment_Start", SupportsShouldProcess = true)]
    ...
    public partial class StartAzSqlVMAssessment_Start : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of StartAzSqlVMAssessment_Start</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Cmdlets.StartAzSqlVMAssessment_Start Clone()
        {
            var clone = new StartAzSqlVMAssessment_Start();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SqlVirtualMachinesStartAssessment' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SqlVirtualMachinesStartAssessment(ResourceGroupName, SqlVirtualMachineName, SubscriptionId, onOk, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzSqlVMAssessment_Start" /> cmdlet class.
        /// </summary>
        public StartAzSqlVMAssessment_Start()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, SqlVirtualMachineName=SqlVirtualMachineName, SubscriptionId=SubscriptionId })
                    {
