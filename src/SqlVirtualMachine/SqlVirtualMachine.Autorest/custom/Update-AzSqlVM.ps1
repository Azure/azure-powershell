...
process {
	try {
        ...
        if($hasInputObject){
            $sqlvm = Az.SqlVirtualMachine.private\Get-AzSqlVM_GetViaIdentity -InputObject $InputObject @PSBoundParameters
        }else{
		    $sqlvm = Az.SqlVirtualMachine.private\Get-AzSqlVM_Get @PSBoundParameters
        }
