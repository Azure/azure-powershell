...
Update-AzSqlVM -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-AssessmentSettingRunImmediately] [-LicenseType <String>] [-Offer <String>] [-ScheduleDayOfWeek <String>]
 [-ScheduleEnable] [-ScheduleMonthlyOccurrence <Int32>] [-ScheduleStartTime <String>]
 [-ScheduleWeeklyInterval <Int32>] [-Sku <String>] [-SqlManagementType <String>]
...
### UpdateViaIdentity
```
Update-AzSqlVM -InputObject <ISqlVirtualMachineIdentity> [-AutoBackupSettingBackupScheduleType <String>]
