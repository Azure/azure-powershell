...
FormatsToProcess = '.\Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.generated.format.ps1xml'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated cmdlets to support rulesEngine feature based on API version 2017-03-01.'
