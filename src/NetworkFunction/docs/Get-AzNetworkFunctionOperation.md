...
online version: https://docs.microsoft.com/en-us/powershell/module/az.networkfunction/get-aznetworkfunctionoperation
schema: 2.0.0
---
...
```
Get-AzNetworkFunctionOperation [<CommonParameters>]
```
