...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.NetworkFunction/azureTrafficCollectors"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzNetworkFunctionAzureTrafficCollectorsBySubscription_List")]
    ...
    public partial class GetAzNetworkFunctionAzureTrafficCollectorsBySubscription_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzNetworkFunctionAzureTrafficCollectorsBySubscription_List" /> cmdlet class.
        /// </summary>
        public GetAzNetworkFunctionAzureTrafficCollectorsBySubscription_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AzureTrafficCollectorsBySubscriptionList(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.AzureTrafficCollectorsBySubscriptionList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
