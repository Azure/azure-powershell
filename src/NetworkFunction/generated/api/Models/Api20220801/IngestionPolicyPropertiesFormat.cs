...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801
{
    ...
    public partial class IngestionPolicyPropertiesFormat :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.IIngestionPolicyPropertiesFormatInternal
    {

        /// <summary>Backing field for <see cref="IngestionSource" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.IIngestionSourcesPropertiesFormat[] _ingestionSource;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.IIngestionSourcesPropertiesFormat[] IngestionSource { get => this._ingestionSource; set => this._ingestionSource = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.IIngestionSourcesPropertiesFormat[] IngestionSource { get; set; }
        /// <summary>The ingestion type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Runtime.Info(
        Required = false,
        ReadOnly = false,
