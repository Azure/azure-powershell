...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801
{
    ...
    public partial class EmissionPoliciesPropertiesFormat :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.IEmissionPoliciesPropertiesFormatInternal
    {

        /// <summary>Backing field for <see cref="EmissionDestination" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.IEmissionPolicyDestination[] _emissionDestination;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.IEmissionPolicyDestination[] EmissionDestination { get => this._emissionDestination; set => this._emissionDestination = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.IEmissionPolicyDestination) })]
        Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.IEmissionPolicyDestination[] EmissionDestination { get; set; }
        /// <summary>Emission format type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Runtime.Info(
        Required = false,
        ReadOnly = false,
