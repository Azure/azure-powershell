...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801
{
    ...
    public partial class EmissionPolicyDestinationTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="EmissionPolicyDestination" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.IEmissionPolicyDestination ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.IEmissionPolicyDestination).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
