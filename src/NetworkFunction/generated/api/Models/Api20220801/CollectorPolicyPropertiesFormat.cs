...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801
{
    ...
    public partial class CollectorPolicyPropertiesFormat :
        Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.ICollectorPolicyPropertiesFormat,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.ICollectorPolicyPropertiesFormatInternal
    {

        /// <summary>Backing field for <see cref="EmissionPolicy" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.IEmissionPoliciesPropertiesFormat[] _emissionPolicy;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.IEmissionPoliciesPropertiesFormat[] EmissionPolicy { get => this._emissionPolicy; set => this._emissionPolicy = value; }

        /// <summary>Backing field for <see cref="IngestionPolicy" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.IIngestionPolicyPropertiesFormat _ingestionPolicy;

        /// <summary>Ingestion policies.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.IIngestionPolicyPropertiesFormat IngestionPolicy { get => (this._ingestionPolicy = this._ingestionPolicy ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.IngestionPolicyPropertiesFormat()); set => this._ingestionPolicy = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Models.Api20220801.ICollectorPolicyPropertiesFormatInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }
