if(($null -eq $TestName) -or ($TestName -contains 'Complete-AzResiliencyDrillRun'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Complete-AzResiliencyDrillRun.Recording.json'
...
Describe 'Complete-AzResiliencyDrillRun' {
