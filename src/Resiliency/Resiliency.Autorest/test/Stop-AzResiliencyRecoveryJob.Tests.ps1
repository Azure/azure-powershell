if(($null -eq $TestName) -or ($TestName -contains 'Stop-AzResiliencyRecoveryJob'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Stop-AzResiliencyRecoveryJob.Recording.json'
...
Describe 'Stop-AzResiliencyRecoveryJob' {
