if(($null -eq $TestName) -or ($TestName -contains 'Resume-AzResiliencyRecoveryJob'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Resume-AzResiliencyRecoveryJob.Recording.json'
...
Describe 'Resume-AzResiliencyRecoveryJob' {
