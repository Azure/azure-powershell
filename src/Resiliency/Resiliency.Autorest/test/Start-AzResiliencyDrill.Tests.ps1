if(($null -eq $TestName) -or ($TestName -contains 'Start-AzResiliencyDrill'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Start-AzResiliencyDrill.Recording.json'
...
Describe 'Start-AzResiliencyDrill' {
