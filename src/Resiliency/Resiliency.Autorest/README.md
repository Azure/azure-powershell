<!-- region Generated -->
# Az.Resiliency
This directory contains the PowerShell module for the Resiliency service.
...
## Development
For information on how to develop for `Az.Resiliency`, see [how-to.md](how-to.md).
<!-- endregion -->
...
commit: b5b147180eade9be82f886ef97efbe12ea74c5f9
require:
# readme.azure.noprofile.md is the common configuration file
  - $(this-folder)/../../readme.azure.noprofile.md
  - $(repo)/specification/azureresiliencemanagement/resource-manager/Microsoft.AzureResilienceManagement/AzureResilienceManagement/readme.md

try-require:
  - $(repo)/specification/azureresiliencemanagement/resource-manager/Microsoft.AzureResilienceManagement/AzureResilienceManagement/readme.powershell.md
...
directive:
  ...
  # subject, yielding Invoke-AzResiliencyInvokeRecoveryPlanFailover. Strip the duplicate.
  - where:
      subject: ^Invoke(?<name>.*)$
    set:
      subject: $<name>
  ...
  # the other Invoke-AzResiliency<Resource><Action> cmdlets.
  - where:
