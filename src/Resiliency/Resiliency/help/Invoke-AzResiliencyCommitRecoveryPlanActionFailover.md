...
online version: https://learn.microsoft.com/powershell/module/az.resiliency/invoke-azresiliencycommitrecoveryplanactionfailover
schema: 2.0.0
---
...
### Commit (Default)
```
Invoke-AzResiliencyCommitRecoveryPlanActionFailover -RecoveryPlanName <String> -ServiceGroupName <String>
...
### CommitViaIdentity
```
Invoke-AzResiliencyCommitRecoveryPlanActionFailover -InputObject <IResiliencyIdentity> -OperationId <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CommitViaIdentityServiceGroup
```
Invoke-AzResiliencyCommitRecoveryPlanActionFailover -RecoveryPlanName <String>
