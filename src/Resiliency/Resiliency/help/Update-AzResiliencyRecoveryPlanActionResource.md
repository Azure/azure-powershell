...
online version: https://learn.microsoft.com/powershell/module/az.resiliency/update-azresiliencyrecoveryplanactionresource
schema: 2.0.0
---
...
```
Update-AzResiliencyRecoveryPlanActionResource -RecoveryPlanName <String> -ServiceGroupName <String>
...
```
Update-AzResiliencyRecoveryPlanActionResource -InputObject <IResiliencyIdentity> -OperationId <String>
...
```
Update-AzResiliencyRecoveryPlanActionResource -RecoveryPlanName <String>
