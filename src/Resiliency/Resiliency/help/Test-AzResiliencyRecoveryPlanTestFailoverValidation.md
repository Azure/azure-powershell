...
online version: https://learn.microsoft.com/powershell/module/az.resiliency/test-azresiliencyrecoveryplantestfailovervalidation
schema: 2.0.0
---
...
```
Test-AzResiliencyRecoveryPlanTestFailoverValidation -RecoveryPlanName <String> -ServiceGroupName <String>
...
### TestViaIdentity
```
Test-AzResiliencyRecoveryPlanTestFailoverValidation -InputObject <IResiliencyIdentity> -OperationId <String>
...
```
Test-AzResiliencyRecoveryPlanTestFailoverValidation -RecoveryPlanName <String>
