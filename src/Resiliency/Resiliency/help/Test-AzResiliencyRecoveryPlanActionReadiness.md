...
online version: https://learn.microsoft.com/powershell/module/az.resiliency/test-azresiliencyrecoveryplanactionreadiness
schema: 2.0.0
---
...
### Check (Default)
```
Test-AzResiliencyRecoveryPlanActionReadiness -RecoveryPlanName <String> -ServiceGroupName <String>
...
### CheckViaIdentity
```
Test-AzResiliencyRecoveryPlanActionReadiness -InputObject <IResiliencyIdentity> -OperationId <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentityServiceGroup
```
Test-AzResiliencyRecoveryPlanActionReadiness -RecoveryPlanName <String>
