...
online version: https://learn.microsoft.com/powershell/module/az.resiliency/invoke-azresiliencyretryrecoveryjob
schema: 2.0.0
---

# Invoke-AzResiliencyRetryRecoveryJob
...
### Retry (Default)
```
Invoke-AzResiliencyRetryRecoveryJob -RecoveryJobName <String> -RecoveryPlanName <String>
...
### RetryViaIdentity
```
Invoke-AzResiliencyRetryRecoveryJob -InputObject <IResiliencyIdentity> -OperationId <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RetryViaIdentityRecoveryPlan
```
Invoke-AzResiliencyRetryRecoveryJob -RecoveryJobName <String> -RecoveryPlanInputObject <IResiliencyIdentity>
