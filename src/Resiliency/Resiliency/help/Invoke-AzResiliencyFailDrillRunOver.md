...
online version: https://learn.microsoft.com/powershell/module/az.resiliency/invoke-azresiliencyfaildrillrunover
schema: 2.0.0
---
...
```
Invoke-AzResiliencyFailDrillRunOver -DrillName <String> -DrillRunName <String> -ServiceGroupName <String>
...
### FailViaIdentity
```
Invoke-AzResiliencyFailDrillRunOver -InputObject <IResiliencyIdentity> -OperationId <String>
...
```
Invoke-AzResiliencyFailDrillRunOver -DrillInputObject <IResiliencyIdentity> -DrillRunName <String>
 -OperationId <String> -Body <IDrillRunFailoverRequest> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-AzResiliencyFailDrillRunOver -DrillName <String> -DrillRunName <String>
