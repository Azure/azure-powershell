...
online version: https://learn.microsoft.com/powershell/module/az.resiliency/invoke-azresiliencymarkdrillrunascomplete
schema: 2.0.0
---
...
```
Invoke-AzResiliencyMarkDrillRunAsComplete -DrillName <String> -DrillRunName <String>
...
### MarkViaIdentity
```
Invoke-AzResiliencyMarkDrillRunAsComplete -InputObject <IResiliencyIdentity> -OperationId <String>
...
```
Invoke-AzResiliencyMarkDrillRunAsComplete -DrillInputObject <IResiliencyIdentity> -DrillRunName <String>
