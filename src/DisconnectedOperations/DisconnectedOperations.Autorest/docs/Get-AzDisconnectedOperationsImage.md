...
```
Get-AzDisconnectedOperationsImage -DisconnectedOperationInputObject <IDisconnectedOperationsIdentity>
 -ImageName <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
