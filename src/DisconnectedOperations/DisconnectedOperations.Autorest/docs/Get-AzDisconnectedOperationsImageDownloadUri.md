...
online version: https://learn.microsoft.com/powershell/module/az.disconnectedoperations/get-azdisconnectedoperationsimagedownloaduri
schema: 2.0.0
---
...
```
Get-AzDisconnectedOperationsImageDownloadUri -ImageName <String> -Name <String> -ResourceGroupName <String>
