...
### Example 2: Update a DisconnectedOperation by identity
```powershell
...
### Example 3: Update a DisconnectedOperation by json file path
```powershell
Update-AzDisconnectedOperationsDisconnectedOperation -Name "Resource-1" -ResourceGroupName "ResourceGroup-1" -JsonFilePath "path/to/jsonFiles/CreateDisconnectedOperations.json"
```
...
### Example 4: Update a DisconnectedOperation by json file path
```powershell
