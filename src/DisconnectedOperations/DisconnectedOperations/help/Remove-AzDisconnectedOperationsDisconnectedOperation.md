...
online version: https://learn.microsoft.com/powershell/module/az.disconnectedoperations/remove-azdisconnectedoperationsdisconnectedoperation
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzDisconnectedOperationsDisconnectedOperation -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDisconnectedOperationsDisconnectedOperation -InputObject <IDisconnectedOperationsIdentity>
