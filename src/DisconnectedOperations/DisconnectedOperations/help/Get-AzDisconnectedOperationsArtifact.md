...
### GetViaIdentityImage
```
Get-AzDisconnectedOperationsArtifact -ArtifactName <String> -ImageInputObject <IDisconnectedOperationsIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityDisconnectedOperation
```
Get-AzDisconnectedOperationsArtifact -ArtifactName <String> -ImageName <String>
...
```yaml
Type: System.String
Parameter Sets: GetViaIdentityImage, GetViaIdentityDisconnectedOperation, Get
Aliases:
...
```yaml
Type: System.String
Parameter Sets: List, GetViaIdentityDisconnectedOperation, Get
Aliases:
