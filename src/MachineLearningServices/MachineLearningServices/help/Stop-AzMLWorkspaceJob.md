...
online version: https://learn.microsoft.com/powershell/module/az.machinelearningservices/stop-azmlworkspacejob
schema: 2.0.0
---
...
### Cancel (Default)
```
Stop-AzMLWorkspaceJob -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Stop-AzMLWorkspaceJob -Name <String> -WorkspaceInputObject <IMachineLearningServicesIdentity>
...
### CancelViaIdentity
```
Stop-AzMLWorkspaceJob -InputObject <IMachineLearningServicesIdentity> [-DefaultProfile <PSObject>] [-AsJob]
