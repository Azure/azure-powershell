...
```
Update-AzMLWorkspaceEnvironmentVersion -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Version <String> -WorkspaceName <String> [-Description <String>] [-IsArchived]
...
```
Update-AzMLWorkspaceEnvironmentVersion -Version <String>
 -EnvironmentInputObject <IMachineLearningServicesIdentity> [-Description <String>] [-IsArchived]
 [-ResourceBaseProperty <Hashtable>] [-Stage <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityWorkspaceExpanded, UpdateViaIdentityEnvironmentExpanded
Aliases:
