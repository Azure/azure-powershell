...
```
New-AzMLWorkspaceDataContainer -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -WorkspaceName <String> -DataType <String> [-Description <String>] [-IsArchived]
...
```
New-AzMLWorkspaceDataContainer -Name <String> -WorkspaceInputObject <IMachineLearningServicesIdentity>
 -DataType <String> [-Description <String>] [-IsArchived] [-ResourceBaseProperty <Hashtable>]
