...
online version: https://learn.microsoft.com/powershell/module/az.machinelearningservices/remove-azmlworkspacejob
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzMLWorkspaceJob -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Remove-AzMLWorkspaceJob -Name <String> -WorkspaceInputObject <IMachineLearningServicesIdentity>
...
### DeleteViaIdentity
```
Remove-AzMLWorkspaceJob -InputObject <IMachineLearningServicesIdentity> [-DefaultProfile <PSObject>] [-AsJob]
