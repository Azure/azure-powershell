...
online version: https://learn.microsoft.com/powershell/module/az.machinelearningservices/remove-azmlworkspacemodelcontainer
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzMLWorkspaceModelContainer -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Remove-AzMLWorkspaceModelContainer -Name <String> -WorkspaceInputObject <IMachineLearningServicesIdentity>
...
### DeleteViaIdentity
```
Remove-AzMLWorkspaceModelContainer -InputObject <IMachineLearningServicesIdentity> [-DefaultProfile <PSObject>]
