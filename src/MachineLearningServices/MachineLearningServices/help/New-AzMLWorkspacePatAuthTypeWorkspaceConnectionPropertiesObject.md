...
```
New-AzMLWorkspacePatAuthTypeWorkspaceConnectionPropertiesObject [-CredentialsPat <String>] [-Category <String>]
...
### Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.PatAuthTypeWorkspaceConnectionProperties
