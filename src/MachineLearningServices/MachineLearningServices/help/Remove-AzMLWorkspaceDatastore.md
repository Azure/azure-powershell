...
### Delete (Default)
```
Remove-AzMLWorkspaceDatastore -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Remove-AzMLWorkspaceDatastore -Name <String> -WorkspaceInputObject <IMachineLearningServicesIdentity>
