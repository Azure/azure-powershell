...
### List (Default)
```
Get-AzMLWorkspaceEnvironmentVersion -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 -WorkspaceName <String> [-ListViewType <String>] [-OrderBy <String>] [-Skip <String>] [-Top <Int32>]
...
```
Get-AzMLWorkspaceEnvironmentVersion -Version <String>
 -EnvironmentInputObject <IMachineLearningServicesIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: GetViaIdentityWorkspace, Get, GetViaIdentityEnvironment
Aliases:
