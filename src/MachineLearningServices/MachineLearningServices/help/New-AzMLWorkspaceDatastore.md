...
New-AzMLWorkspaceDatastore -Name <String> -WorkspaceInputObject <IMachineLearningServicesIdentity>
 [-SkipValidation] -Datastore <IDatastoreProperties> [-DefaultProfile <PSObject>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaJsonString
```
New-AzMLWorkspaceDatastore -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -WorkspaceName <String> [-SkipValidation] -JsonString <String> [-DefaultProfile <PSObject>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
New-AzMLWorkspaceDatastore -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -WorkspaceName <String> [-SkipValidation] -JsonFilePath <String> [-DefaultProfile <PSObject>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
New-AzMLWorkspaceDatastore -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -WorkspaceName <String> [-SkipValidation] -Datastore <IDatastoreProperties> [-DefaultProfile <PSObject>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Parameter Sets: CreateViaIdentityWorkspaceExpanded, CreateExpanded
Aliases:
