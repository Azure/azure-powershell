...
```
New-AzMLWorkspaceServicePrincipalAuthTypeWorkspaceConnectionPropertiesObject [-CredentialsClientId <String>]
 [-CredentialsClientSecret <String>] [-CredentialsTenantId <String>] [-Category <ConnectionCategory>]
