...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support
{
        ...
        System.IEquatable<WeekDay>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.WeekDay Friday = @"Friday";

        /// <summary>Monday weekday</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.WeekDay Monday = @"Monday";

        /// <summary>Saturday weekday</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.WeekDay Saturday = @"Saturday";

        /// <summary>Sunday weekday</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.WeekDay Sunday = @"Sunday";

        /// <summary>Thursday weekday</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.WeekDay Thursday = @"Thursday";

        /// <summary>Tuesday weekday</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.WeekDay Tuesday = @"Tuesday";

        /// <summary>Wednesday weekday</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.WeekDay Wednesday = @"Wednesday";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.WeekDay e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.WeekDay e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.WeekDay e1, Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.WeekDay e2)
        {
            return !e2.Equals(e1);
        }
