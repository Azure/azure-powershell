...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/computes/{computeName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzMLWorkspaceCompute_DeleteViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Description(@"Deletes specified Machine Learning compute.")]
    ...
    public partial class RemoveAzMLWorkspaceCompute_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="UnderlyingResourceAction" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.UnderlyingResourceAction _underlyingResourceAction;

        /// <summary>
        /// Delete the underlying compute if 'Delete', or detach the underlying compute from workspace if 'Detach'.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Delete the underlying compute if 'Delete', or detach the underlying compute from workspace if 'Detach'.")]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.UnderlyingResourceAction) })]
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.UnderlyingResourceAction))]
        public Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.UnderlyingResourceAction UnderlyingResourceAction { get => this._underlyingResourceAction; set => this._underlyingResourceAction = value; }
        ...
        /// <returns>a duplicate instance of RemoveAzMLWorkspaceCompute_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets.RemoveAzMLWorkspaceCompute_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzMLWorkspaceCompute_DeleteViaIdentity();
            ...
            clone.UnderlyingResourceAction = this.UnderlyingResourceAction;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ComputeDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ComputeDeleteViaIdentity(InputObject.Id, UnderlyingResourceAction, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ComputeDelete(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.WorkspaceName ?? null, InputObject.ComputeName ?? null, UnderlyingResourceAction, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  UnderlyingResourceAction=UnderlyingResourceAction})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzMLWorkspaceCompute_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzMLWorkspaceCompute_DeleteViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { UnderlyingResourceAction=UnderlyingResourceAction })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { UnderlyingResourceAction=UnderlyingResourceAction })
                    {
