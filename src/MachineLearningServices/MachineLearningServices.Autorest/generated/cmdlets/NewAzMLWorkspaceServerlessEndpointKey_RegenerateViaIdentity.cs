...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] RegenerateKeys=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/serverlessEndpoints/{name}/regenerateKeys"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzMLWorkspaceServerlessEndpointKey_RegenerateViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/serverlessEndpoints/{name}/regenerateKeys", ApiVersion = "2024-04-01")]
    public partial class NewAzMLWorkspaceServerlessEndpointKey_RegenerateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20240401.IRegenerateEndpointKeysRequest _body;
        ...
        Description = @"",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20240401.IRegenerateEndpointKeysRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20240401.IRegenerateEndpointKeysRequest Body { get => this._body; set => this._body = value; }
        ...
        /// <returns>
        /// a duplicate instance of NewAzMLWorkspaceServerlessEndpointKey_RegenerateViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets.NewAzMLWorkspaceServerlessEndpointKey_RegenerateViaIdentity Clone()
        {
            var clone = new NewAzMLWorkspaceServerlessEndpointKey_RegenerateViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzMLWorkspaceServerlessEndpointKey_RegenerateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzMLWorkspaceServerlessEndpointKey_RegenerateViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ServerlessEndpointsRegenerateKeys' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServerlessEndpointsRegenerateKeysViaIdentity(InputObject.Id, Body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServerlessEndpointsRegenerateKeys(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.WorkspaceName ?? null, InputObject.Name ?? null, Body, onOk, onDefault, this, Pipeline);
                    }
