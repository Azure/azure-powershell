...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/featurestoreEntities/{name}/versions/{version}"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzMLWorkspaceFeaturestoreEntityVersion_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/featurestoreEntities/{name}/versions/{version}", ApiVersion = "2024-04-01")]
    public partial class RemoveAzMLWorkspaceFeaturestoreEntityVersion_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of RemoveAzMLWorkspaceFeaturestoreEntityVersion_DeleteViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets.RemoveAzMLWorkspaceFeaturestoreEntityVersion_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzMLWorkspaceFeaturestoreEntityVersion_DeleteViaIdentity();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'FeaturestoreEntityVersionsDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.FeaturestoreEntityVersionsDeleteViaIdentity(InputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.FeaturestoreEntityVersionsDelete(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.WorkspaceName ?? null, InputObject.Name ?? null, InputObject.Version ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzMLWorkspaceFeaturestoreEntityVersion_DeleteViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public RemoveAzMLWorkspaceFeaturestoreEntityVersion_DeleteViaIdentity()
        {
