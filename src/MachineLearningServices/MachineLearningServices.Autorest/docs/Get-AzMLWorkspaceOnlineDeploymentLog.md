...
Get-AzMLWorkspaceOnlineDeploymentLog -EndpointName <String> -Name <String> -ResourceGroupName <String>
 -WorkspaceName <String> [-SubscriptionId <String[]>] [-ContainerType <String>] [-Tail <Int32>]
...
Get-AzMLWorkspaceOnlineDeploymentLog -InputObject <IMachineLearningServicesIdentity> [-ContainerType <String>]
 [-Tail <Int32>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: GetExpanded, GetViaIdentityOnlineEndpointExpanded, GetViaIdentityWorkspaceExpanded
Aliases:
