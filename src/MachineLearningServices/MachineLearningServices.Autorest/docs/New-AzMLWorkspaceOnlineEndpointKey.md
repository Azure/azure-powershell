...
```
New-AzMLWorkspaceOnlineEndpointKey -Name <String> -WorkspaceInputObject <IMachineLearningServicesIdentity>
 -KeyType <String> [-KeyValue <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
Parameter Sets: RegenerateViaIdentityWorkspace, RegenerateViaIdentityWorkspaceExpanded
Aliases:
