...
```
Remove-AzMLWorkspaceModelVersion -ModelInputObject <IMachineLearningServicesIdentity> -Version <String>
...
```yaml
Type: System.String
Parameter Sets: Delete, DeleteViaIdentityModel, DeleteViaIdentityWorkspace
Aliases:
