...
New-AzMLWorkspaceDatastoreDataLakeGen1Object -Credentials <IDatastoreCredentials> -StoreName <String>
 [-Description <String>] [-Property <IResourceBaseProperties>] [-ResourceGroup <String>]
 [-ServiceDataAccessAuthIdentity <String>] [-SubscriptionId <String>] [-Tag <IResourceBaseTags>]
 [<CommonParameters>]
```
