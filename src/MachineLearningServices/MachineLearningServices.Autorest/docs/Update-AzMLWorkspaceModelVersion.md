...
```
Update-AzMLWorkspaceModelVersion -Name <String> -ResourceGroupName <String> -Version <String>
...
```
Update-AzMLWorkspaceModelVersion -ModelInputObject <IMachineLearningServicesIdentity> -Version <String>
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityModelExpanded, UpdateViaIdentityWorkspaceExpanded
Aliases:
