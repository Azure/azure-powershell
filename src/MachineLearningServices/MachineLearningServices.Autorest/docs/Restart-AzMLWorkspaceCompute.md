...
online version: https://learn.microsoft.com/powershell/module/az.machinelearningservices/restart-azmlworkspacecompute
schema: 2.0.0
---
...
### RestartViaIdentity
```
Restart-AzMLWorkspaceCompute -InputObject <IMachineLearningServicesIdentity> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestartViaIdentityWorkspace
```
Restart-AzMLWorkspaceCompute -Name <String> -WorkspaceInputObject <IMachineLearningServicesIdentity>
...
```yaml
Type: System.String
Parameter Sets: Restart, RestartViaIdentityWorkspace
Aliases: ComputeName
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IMachineLearningServicesIdentity
Parameter Sets: RestartViaIdentityWorkspace
Aliases:
