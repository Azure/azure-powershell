...
```
New-AzMLWorkspaceManagedIdentityAuthTypeWorkspaceConnectionPropertiesObject [-Category <ConnectionCategory>]
 [-CredentialsClientId <String>] [-CredentialsResourceId <String>] [-ExpiryTime <DateTime>]
