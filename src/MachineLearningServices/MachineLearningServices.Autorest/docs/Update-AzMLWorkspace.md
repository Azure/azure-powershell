...
Update-AzMLWorkspace -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-ApplicationInsightId <String>] [-ComputeRuntimeSparkRuntimeVersion <String>]
 [-ContainerRegistryId <String>] [-CosmoDbCollectionsThroughput <Int32>] [-Description <String>]
 [-EnableDataIsolation] [-FeatureStoreSettingOfflineStoreConnectionName <String>]
 ...
 [-ImageBuildCompute <String>] [-KeyVaultKeyIdentifier <String>]
 [-ManagedNetworkIsolationMode <IsolationMode>] [-ManagedNetworkOutboundRule <Hashtable>]
