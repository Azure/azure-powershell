...
```
New-AzMLWorkspaceUsernamePasswordAuthTypeWorkspaceConnectionPropertiesObject [-Category <ConnectionCategory>]
 [-CredentialsPassword <String>] [-CredentialsSecurityToken <String>] [-CredentialsUsername <String>]
