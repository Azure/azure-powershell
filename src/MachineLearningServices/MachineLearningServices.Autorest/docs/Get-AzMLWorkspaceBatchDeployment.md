...
```
Get-AzMLWorkspaceBatchDeployment -BatchEndpointInputObject <IMachineLearningServicesIdentity> -Name <String>
...
```yaml
Type: System.String
Parameter Sets: Get, GetViaIdentityBatchEndpoint, GetViaIdentityWorkspace
Aliases:
