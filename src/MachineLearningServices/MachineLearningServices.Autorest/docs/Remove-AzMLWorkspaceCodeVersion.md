...
```
Remove-AzMLWorkspaceCodeVersion -CodeInputObject <IMachineLearningServicesIdentity> -Version <String>
...
```yaml
Type: System.String
Parameter Sets: Delete, DeleteViaIdentityCode, DeleteViaIdentityWorkspace
Aliases:
