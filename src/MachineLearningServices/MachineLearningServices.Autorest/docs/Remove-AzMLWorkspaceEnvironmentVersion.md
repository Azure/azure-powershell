...
online version: https://learn.microsoft.com/powershell/module/az.machinelearningservices/remove-azmlworkspaceenvironmentversion
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzMLWorkspaceEnvironmentVersion -InputObject <IMachineLearningServicesIdentity>
