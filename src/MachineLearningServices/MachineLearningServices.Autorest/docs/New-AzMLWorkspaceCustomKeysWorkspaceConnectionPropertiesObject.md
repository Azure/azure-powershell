...
```
New-AzMLWorkspaceCustomKeysWorkspaceConnectionPropertiesObject [-Category <ConnectionCategory>]
 [-CredentialsKey <ICustomKeys>] [-ExpiryTime <DateTime>] [-IsSharedToAll <Boolean>]
