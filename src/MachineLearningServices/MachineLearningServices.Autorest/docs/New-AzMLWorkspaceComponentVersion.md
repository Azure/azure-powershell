...
```
New-AzMLWorkspaceComponentVersion -ComponentInputObject <IMachineLearningServicesIdentity> -Version <String>
...
```
New-AzMLWorkspaceComponentVersion -Name <String> -Version <String>
...
Parameter Sets: CreateExpanded, CreateViaIdentityComponentExpanded, CreateViaIdentityWorkspaceExpanded
Aliases:
