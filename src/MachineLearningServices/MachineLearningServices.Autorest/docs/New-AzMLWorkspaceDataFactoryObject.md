...
```
New-AzMLWorkspaceDataFactoryObject [-Description <String>] [-DisableLocalAuth <Boolean>] [-Location <String>]
...
### Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.DataFactory
