...
begin {
    try {
        ...
        $mapping = @{
            Cancel = 'Az.MachineLearningServices.private\Stop-AzMLWorkspaceJob_Cancel';
            CancelViaIdentity = 'Az.MachineLearningServices.private\Stop-AzMLWorkspaceJob_CancelViaIdentity';
        }
