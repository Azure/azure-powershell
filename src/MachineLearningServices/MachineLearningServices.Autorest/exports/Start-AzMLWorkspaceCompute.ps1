...
begin {
    try {
        ...
        $mapping = @{
            Start = 'Az.MachineLearningServices.private\Start-AzMLWorkspaceCompute_Start';
            StartViaIdentity = 'Az.MachineLearningServices.private\Start-AzMLWorkspaceCompute_StartViaIdentity';
        }
