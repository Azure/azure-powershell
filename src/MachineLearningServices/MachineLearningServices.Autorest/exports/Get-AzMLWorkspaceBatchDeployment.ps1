...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceBatchDeployment_Get';
            GetViaIdentity = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceBatchDeployment_GetViaIdentity';
            List = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceBatchDeployment_List';
        }
