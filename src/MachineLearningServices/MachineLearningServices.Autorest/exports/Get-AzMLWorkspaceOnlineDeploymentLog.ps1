...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.ContainerType])]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Support.ContainerType]
...
begin {
    try {
        ...
        $mapping = @{
            GetExpanded = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceOnlineDeploymentLog_GetExpanded';
        }
