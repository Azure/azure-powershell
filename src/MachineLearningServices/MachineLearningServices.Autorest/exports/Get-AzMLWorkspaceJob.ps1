...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20240401.IJobBase])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceJob_Get';
            GetViaIdentity = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceJob_GetViaIdentity';
            List = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceJob_List';
        }
