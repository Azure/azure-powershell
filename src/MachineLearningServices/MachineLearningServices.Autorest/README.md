...
directive:
  - from: swagger-document
    where: $.paths["/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/featuresets/{featuresetName}/versions/{featuresetVersion}/features"].get
    transform: >-
      $["operationId"] = "FeaturesetFeature_List"
  - from: swagger-document
    where: $.paths["/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/featuresets/{featuresetName}/versions/{featuresetVersion}/features/{featureName}"].get
    transform: >-
      $["operationId"] = "FeaturesetFeature_Get"
  - from: swagger-document
  ...
  # 
  - where:
      subject: CodeVersionStartPendingUpload|RegistryCodeVersionStartPendingUpload|RegistryDataReferenceBlobReferenceSas|RegistryDataVersionStartPendingUpload|RegistryModelVersionStartPendingUpload
      variant: ^Get(?!.*?Expanded)
    remove: true
  - where:
      subject: BackfillFeaturesetVersion
      variant: ^Backfill(?!.*?Expanded)
    remove: true
  - where:
      subject: FeaturesetVersion|FeaturestoreEntityVersion|ManagedNetworkSettingRule|Schedule
      variant: ^Create(?!.*?Expanded)
    remove: true
  - where:
      subject: ManagedNetworkProvisionManagedNetwork
      variant: ^Provision(?!.*?Expanded)
    remove: true
  - where:
      subject: CodeVersion|ComponentVersion|DataVersion|EnvironmentVersion|ModelVersion
      variant: ^Publish(?!.*?Expanded)
    remove: true
  ...
  - where:
      subject: ManagedNetworkProvisionManagedNetwork
    set: 
      subject: ProvisionManagedNetwork
