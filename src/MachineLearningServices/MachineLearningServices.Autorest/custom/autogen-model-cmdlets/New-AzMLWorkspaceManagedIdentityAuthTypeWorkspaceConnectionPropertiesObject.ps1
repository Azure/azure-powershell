...
function New-AzMLWorkspaceManagedIdentityAuthTypeWorkspaceConnectionPropertiesObject {
    ...
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.ManagedIdentityAuthTypeWorkspaceConnectionProperties')]
    ...
    ***************************************************************************************************")]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.ManagedIdentityAuthTypeWorkspaceConnectionProperties]::New()
