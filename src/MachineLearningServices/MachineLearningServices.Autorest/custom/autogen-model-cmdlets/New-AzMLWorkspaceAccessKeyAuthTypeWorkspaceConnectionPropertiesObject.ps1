...
function New-AzMLWorkspaceAccessKeyAuthTypeWorkspaceConnectionPropertiesObject {
    ...
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.AccessKeyAuthTypeWorkspaceConnectionProperties')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.AccessKeyAuthTypeWorkspaceConnectionProperties]::New()
