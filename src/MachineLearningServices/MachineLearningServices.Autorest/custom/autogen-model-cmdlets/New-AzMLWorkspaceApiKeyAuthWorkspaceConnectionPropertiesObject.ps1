...
function New-AzMLWorkspaceApiKeyAuthWorkspaceConnectionPropertiesObject {
    ...
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.ApiKeyAuthWorkspaceConnectionProperties')]
    ...
    ***************************************************************************************************")]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.ApiKeyAuthWorkspaceConnectionProperties]::New()
