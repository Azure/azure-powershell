...
.Link
https://learn.microsoft.com/powershell/module/Az.MachineLearningServices/new-azmlworkspacenoneauthtypeworkspaceconnectionpropertiesobject
#>
function New-AzMLWorkspaceNoneAuthTypeWorkspaceConnectionPropertiesObject {
    ...
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.NoneAuthTypeWorkspaceConnectionProperties')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.NoneAuthTypeWorkspaceConnectionProperties]::New()
