...
function New-AzMLWorkspaceUriFileJobOutputObject {
    ...
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.UriFileJobOutput')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.UriFileJobOutput]::New()
