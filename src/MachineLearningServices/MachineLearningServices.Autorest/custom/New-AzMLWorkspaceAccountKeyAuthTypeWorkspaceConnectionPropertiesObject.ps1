...
function New-AzMLWorkspaceAccountKeyAuthTypeWorkspaceConnectionPropertiesObject {
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20240401.AccountKeyAuthTypeWorkspaceConnectionProperties]::New()
        $object.AuthType = "AccountKey"
