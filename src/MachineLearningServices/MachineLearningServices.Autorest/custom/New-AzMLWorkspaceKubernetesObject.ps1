...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.Kubernetes
.Link
...
function New-AzMLWorkspaceKubernetesObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.Kubernetes')]
    ...
    Param(
        ...
        # [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.IKubernetesPropertiesInstanceTypes]
        # $InstanceType,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.Kubernetes]::New()
        ...
        {
            $NodeSelectorObj = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.InstanceTypeSchemaNodeSelector]::New()
            $NodeSelectorObj.CopyFrom($InstanceNodeSelector)
        }
        if ($PSBoundParameters.ContainsKey('InstanceLimit'))
        {
            $ResourceLimitObj = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.InstanceResourceSchema]::New()
            $ResourceLimitObj.CopyFrom($InstanceLimit)
        }
        if ($PSBoundParameters.ContainsKey('InstanceRequest'))
        {
            $ResourceRequestObj = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.InstanceResourceSchema]::New()
        ...
        {
            $InstanceType = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.InstanceTypeSchema]::New() 
            $KubInstance = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.KubernetesPropertiesInstanceTypes]::New()
