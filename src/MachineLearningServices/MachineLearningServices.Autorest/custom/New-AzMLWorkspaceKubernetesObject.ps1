...
function New-AzMLWorkspaceKubernetesObject {
    ...
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Kubernetes')]
    ...
    Param(
        ...
        # [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IKubernetesPropertiesInstanceTypes]
        # $InstanceType,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Kubernetes]::New()
        ...
        {
            $NodeSelectorObj = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.InstanceTypeSchemaNodeSelector]::New()
            $NodeSelectorObj.CopyFrom($InstanceNodeSelector)
        }
        if ($PSBoundParameters.ContainsKey('InstanceLimit'))
        {
            $ResourceLimitObj = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.InstanceResourceSchema]::New()
            $ResourceLimitObj.CopyFrom($InstanceLimit)
        }
        if ($PSBoundParameters.ContainsKey('InstanceRequest'))
        {
            $ResourceRequestObj = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.InstanceResourceSchema]::New()
        ...
        {
            $InstanceType = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.InstanceTypeSchema]::New() 
            $KubInstance = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.KubernetesPropertiesInstanceTypes]::New()
