...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.AzureFileDatastore
.Link
...
function New-AzMLWorkspaceDatastoreFileObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.AzureFileDatastore')]
    ...
    Param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.IResourceBaseProperties]
        $Property,
        [Parameter(HelpMessage="Tag dictionary. Tags can be added, removed, and updated.")]
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.IResourceBaseTags]
        $Tag
    )

    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.AzureFileDatastore]::New()
