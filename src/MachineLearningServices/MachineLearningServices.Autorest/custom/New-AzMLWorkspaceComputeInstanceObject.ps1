...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.ComputeInstance
.Link
...
function New-AzMLWorkspaceComputeInstanceObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.ComputeInstance')]
    ...
    Param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.IComputeStartStopSchedule[]]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.ComputeInstance]::New()
