...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.ServicePrincipalDatastoreCredentials
.Link
...
function New-AzMLWorkspaceDatastoreServicePrincipalCredentialObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.ServicePrincipalDatastoreCredentials')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.ServicePrincipalDatastoreCredentials]::New()
        $Object.CredentialsType = 'ServicePrincipal'
        $Secret = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.ServicePrincipalDatastoreSecrets]::New()
