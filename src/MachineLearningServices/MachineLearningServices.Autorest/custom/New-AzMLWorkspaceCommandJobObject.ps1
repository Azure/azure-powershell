...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.CommandJob
.Link
...
function New-AzMLWorkspaceCommandJobObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.CommandJob')]
    ...
    Param(
        ...
        # [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.ICommandJobEnvironmentVariables]
        [hashtable]
        $EnvironmentVariable,
        [Parameter(HelpMessage="Mapping of input data bindings used in the job.")]
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.ICommandJobInputs]
        $JobInput,
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.ICommandJobOutputs]
        $JobOutput,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.CommandJob]::New()
        ...
        if ($PSBoundParameters.ContainsKey('EnvironmentVariable')) {
            $EnvironmentVariableObj = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.ICommandJobEnvironmentVariables]::New()
