...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.DataFactory
.Link
...
function New-AzMLWorkspaceDataFactoryObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.DataFactory')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.DataFactory]::New()
