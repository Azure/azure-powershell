...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.PipelineJob
.Link
...
function New-AzMLWorkspacePipelineJobObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.PipelineJob')]
    [CmdletBinding(PositionalBinding=$false)]
    Param(

        [Parameter(HelpMessage="Inputs for the pipeline job.")]
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.IPipelineJobInputs]
        $JobInput,
        [Parameter(HelpMessage="Jobs construct the Pipeline Job.")]
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.IPipelineJobJobs]
        $Job,
        [Parameter(HelpMessage="Outputs for the pipeline job.")]
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.IPipelineJobOutputs]
        $JobOutput,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20231001.PipelineJob]::New()
