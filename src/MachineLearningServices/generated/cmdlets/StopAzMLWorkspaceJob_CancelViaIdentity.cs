...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Stop, @"AzMLWorkspaceJob_CancelViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class StopAzMLWorkspaceJob_CancelViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of StopAzMLWorkspaceJob_CancelViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets.StopAzMLWorkspaceJob_CancelViaIdentity Clone()
        {
            var clone = new StopAzMLWorkspaceJob_CancelViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.JobsCancelViaIdentity(InputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.JobsCancel(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.WorkspaceName ?? null, InputObject.Id ?? null, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StopAzMLWorkspaceJob_CancelViaIdentity" /> cmdlet class.
        /// </summary>
        public StopAzMLWorkspaceJob_CancelViaIdentity()
        {
