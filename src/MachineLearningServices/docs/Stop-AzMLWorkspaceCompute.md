...
online version: https://learn.microsoft.com/powershell/module/az.machinelearningservices/stop-azmlworkspacecompute
schema: 2.0.0
---
...
### StopViaIdentity
```
Stop-AzMLWorkspaceCompute -InputObject <IMachineLearningServicesIdentity> [-DefaultProfile <PSObject>]
