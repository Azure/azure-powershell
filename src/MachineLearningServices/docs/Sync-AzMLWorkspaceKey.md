...
online version: https://learn.microsoft.com/powershell/module/az.machinelearningservices/sync-azmlworkspacekey
schema: 2.0.0
---
...
### ResyncViaIdentity
```
Sync-AzMLWorkspaceKey -InputObject <IMachineLearningServicesIdentity> [-DefaultProfile <PSObject>] [-AsJob]
