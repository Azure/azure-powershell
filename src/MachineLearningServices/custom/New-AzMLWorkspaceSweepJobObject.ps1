...
function New-AzMLWorkspaceSweepJobObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20220501.SweepJob')]
    ...
    Param(
        ...
        [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.EarlyTerminationPolicyType])]
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.EarlyTerminationPolicyType]
        ...
        [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.Goal])]
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.Goal]
        $ObjectiveGoal,
        ...
        [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.SamplingAlgorithmType])]
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.SamplingAlgorithmType]
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20220501.ITrialComponentEnvironmentVariables]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20220501.SweepJob]::New()
