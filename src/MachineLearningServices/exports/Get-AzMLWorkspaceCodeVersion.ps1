...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceCodeVersion_Get';
            GetViaIdentity = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceCodeVersion_GetViaIdentity';
        }
