...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceCompute_Get';
            GetViaIdentity = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceCompute_GetViaIdentity';
            List = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceCompute_List';
        }
