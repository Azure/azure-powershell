...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceBatchEndpoint_Get';
            GetViaIdentity = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceBatchEndpoint_GetViaIdentity';
            List = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceBatchEndpoint_List';
        }
