...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceDatastore_Get';
            GetViaIdentity = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceDatastore_GetViaIdentity';
            List = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceDatastore_List';
        }
