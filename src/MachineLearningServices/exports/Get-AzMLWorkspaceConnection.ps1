...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceConnection_Get';
            GetViaIdentity = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceConnection_GetViaIdentity';
            List = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceConnection_List';
        }
