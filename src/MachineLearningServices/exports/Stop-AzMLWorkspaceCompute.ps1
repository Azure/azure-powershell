...
begin {
    try {
        ...
        $mapping = @{
            Stop = 'Az.MachineLearningServices.private\Stop-AzMLWorkspaceCompute_Stop';
            StopViaIdentity = 'Az.MachineLearningServices.private\Stop-AzMLWorkspaceCompute_StopViaIdentity';
        }
