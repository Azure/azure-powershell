...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceDataVersion_Get';
            GetViaIdentity = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceDataVersion_GetViaIdentity';
            List = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceDataVersion_List';
        }
