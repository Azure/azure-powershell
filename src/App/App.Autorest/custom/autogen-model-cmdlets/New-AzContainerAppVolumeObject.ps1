...
function New-AzContainerAppVolumeObject {
    ...
    Param(
        ...
        [Parameter(HelpMessage="Mount options used while mounting the AzureFile. Must be a comma-separated string.")]
        [string]
        $MountOption,
        [Parameter(HelpMessage="Volume name.")]
        [string]
        $Name,
        [Parameter(HelpMessage="List of secrets to be added in volume. If no secrets are provided, all secrets in collection will be added to volume.")]
        [Microsoft.Azure.PowerShell.Cmdlets.App.Models.ISecretVolumeItem[]]
        $Secret,
        [Parameter(HelpMessage="Name of storage resource. No need to provide for EmptyDir and Secret.")]
        [string]
        $StorageName,
    ...
    process {
        ...
        if ($PSBoundParameters.ContainsKey('MountOption')) {
            $Object.MountOption = $MountOption
        }
