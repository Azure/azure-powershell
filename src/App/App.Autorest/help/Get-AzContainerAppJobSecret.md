...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/get-azcontainerappjobsecret
schema: 2.0.0
---
...
```
Get-AzContainerAppJobSecret -JobName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
