...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301
{
    ...
    public partial class ContainerAppProperties
    {
        ...
        internal ContainerAppProperties(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject json)
        {
            ...
            {_configuration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("configuration"), out var __jsonConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.Configuration.FromJson(__jsonConfiguration) : Configuration;}
            ...
            {_managedEnvironmentId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("managedEnvironmentId"), out var __jsonManagedEnvironmentId) ? (string)__jsonManagedEnvironmentId : (string)ManagedEnvironmentId;}
            {_latestRevisionName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("latestRevisionName"), out var __jsonLatestRevisionName) ? (string)__jsonLatestRevisionName : (string)LatestRevisionName;}
            {_latestRevisionFqdn = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("latestRevisionFqdn"), out var __jsonLatestRevisionFqdn) ? (string)__jsonLatestRevisionFqdn : (string)LatestRevisionFqdn;}
            {_customDomainVerificationId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("customDomainVerificationId"), out var __jsonCustomDomainVerificationId) ? (string)__jsonCustomDomainVerificationId : (string)CustomDomainVerificationId;}
            {_outboundIPAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray>("outboundIPAddresses"), out var __jsonOutboundIPAddresses) ? If( __jsonOutboundIPAddresses as Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : OutboundIPAddress;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IContainerAppProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IContainerAppProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IContainerAppProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode node)
        {
