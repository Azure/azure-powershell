...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301
{
    ...
    public partial class Login :
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ILogin,
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ILoginInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ICookieExpiration _cookieExpiration;

        /// <summary>The configuration settings of the session cookie's expiration.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ICookieExpiration CookieExpiration { get => (this._cookieExpiration = this._cookieExpiration ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.CookieExpiration()); set => this._cookieExpiration = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Inlined)]
        public string CookieExpirationTimeToExpiration { get => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ICookieExpirationInternal)CookieExpiration).TimeToExpiration; set => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ICookieExpirationInternal)CookieExpiration).TimeToExpiration = value ?? null; }

        /// <summary>Internal Acessors for CookieExpiration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ICookieExpiration Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ILoginInternal.CookieExpiration { get => (this._cookieExpiration = this._cookieExpiration ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.CookieExpiration()); set { {_cookieExpiration = value;} } }

        /// <summary>Internal Acessors for Nonce</summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.INonce Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ILoginInternal.Nonce { get => (this._nonce = this._nonce ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.Nonce()); set { {_nonce = value;} } }

        /// <summary>Internal Acessors for Route</summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ILoginRoutes Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ILoginInternal.Route { get => (this._route = this._route ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.LoginRoutes()); set { {_route = value;} } }

        /// <summary>Backing field for <see cref="Nonce" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.INonce _nonce;

        /// <summary>The configuration settings of the nonce used in the login flow.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.INonce Nonce { get => (this._nonce = this._nonce ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.Nonce()); set => this._nonce = value; }

        /// <summary>The time after the request is made when the nonce should expire.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Inlined)]
        public string NonceExpirationInterval { get => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.INonceInternal)Nonce).ExpirationInterval; set => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.INonceInternal)Nonce).ExpirationInterval = value ?? null; }

        /// <summary>
        /// <code>false</code> if the nonce should not be validated while completing the login flow; otherwise, <code>true</code>.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Inlined)]
        public bool? NonceValidateNonce { get => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.INonceInternal)Nonce).ValidateNonce; set => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.INonceInternal)Nonce).ValidateNonce = value ?? default(bool); }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ILoginRoutes _route;

        /// <summary>The routes that specify the endpoints used for login and logout requests.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ILoginRoutes Route { get => (this._route = this._route ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.LoginRoutes()); set => this._route = value; }

        /// <summary>The endpoint at which a logout request should be made.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Inlined)]
        public string RouteLogoutEndpoint { get => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ILoginRoutesInternal)Route).LogoutEndpoint; set => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ILoginRoutesInternal)Route).LogoutEndpoint = value ?? null; }
...

    {
        ...
        string[] AllowedExternalRedirectUrl { get; set; }
        /// <summary>The configuration settings of the session cookie's expiration.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ICookieExpiration CookieExpiration { get; set; }
        /// <summary>The convention used when determining the session cookie's expiration.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Support.CookieExpirationConvention? CookieExpirationConvention { get; set; }
        /// <summary>The time after the request is made when the session cookie should expire.</summary>
        string CookieExpirationTimeToExpiration { get; set; }
        /// <summary>The configuration settings of the nonce used in the login flow.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.INonce Nonce { get; set; }
        /// <summary>The time after the request is made when the nonce should expire.</summary>
        string NonceExpirationInterval { get; set; }
        /// <summary>
        /// <code>false</code> if the nonce should not be validated while completing the login flow; otherwise, <code>true</code>.
        ...
        bool? PreserveUrlFragmentsForLogin { get; set; }
        /// <summary>The routes that specify the endpoints used for login and logout requests.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ILoginRoutes Route { get; set; }
        /// <summary>The endpoint at which a logout request should be made.</summary>
        string RouteLogoutEndpoint { get; set; }
