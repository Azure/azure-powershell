...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models
{
    ...
    public partial class Container
    {
        ...
        internal Container(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject json)
        {
            ...
            __baseContainer = new Microsoft.Azure.PowerShell.Cmdlets.App.Models.BaseContainer(json);
            {_probe = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray>("probes"), out var __jsonProbes) ? If( __jsonProbes as Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.App.Models.IContainerAppProbe>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.App.Models.IContainerAppProbe) (Microsoft.Azure.PowerShell.Cmdlets.App.Models.ContainerAppProbe.FromJson(__u) )) ))() : null : _probe;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.IContainer.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.IContainer.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.App.Models.IContainer FromJson(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode serializationMode)
        {
            ...
            __baseContainer?.ToJson(container, serializationMode);
            if (null != this._probe)
            {
                var __w = new Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.XNodeArray();
                foreach( var __x in this._probe )
                {
                    AddIf(__x?.ToJson(null, serializationMode) ,__w.Add);
                }
                container.Add("probes",__w);
            }
