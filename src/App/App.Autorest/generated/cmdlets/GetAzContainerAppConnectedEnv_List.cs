...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListBySubscription=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.App/connectedEnvironments"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzContainerAppConnectedEnv_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.App.Description(@"Get all connectedEnvironments for a subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.App.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.App.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.App/connectedEnvironments", ApiVersion = "2023-05-01")]
    public partial class GetAzContainerAppConnectedEnv_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzContainerAppConnectedEnv_List" /> cmdlet class.
        /// </summary>
        public GetAzContainerAppConnectedEnv_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ConnectedEnvironmentsListBySubscription(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ConnectedEnvironmentsListBySubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
