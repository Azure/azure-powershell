            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ContainerAppInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ContainerAppsAuthConfigsCreateOrUpdateViaIdentity(ContainerAppInputObject.Id, _authConfigEnvelopeBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        this.Update_authConfigEnvelopeBody();
                        await this.Client.ContainerAppsAuthConfigsCreateOrUpdate(ContainerAppInputObject.SubscriptionId ?? null, ContainerAppInputObject.ResourceGroupName ?? null, ContainerAppInputObject.ContainerAppName ?? null, Name, _authConfigEnvelopeBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeUpdate);
                    }
