            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ManagedEnvironmentInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ManagedCertificatesCreateOrUpdateViaIdentity(ManagedEnvironmentInputObject.Id, _managedCertificateEnvelopeBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
