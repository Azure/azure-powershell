            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (InputObject?.Id != null)
                    {
                        ...
                        await this.Client.ContainerAppsCreateOrUpdateViaIdentity(InputObject.Id, _containerAppEnvelopeBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_containerAppEnvelopeBody();
                        await this.Client.ContainerAppsCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ContainerAppName ?? null, _containerAppEnvelopeBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeUpdate);
                    }
