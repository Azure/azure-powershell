            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (InputObject?.Id != null)
                    {
                        ...
                        await this.Client.DaprComponentsCreateOrUpdateViaIdentity(InputObject.Id, _daprComponentEnvelopeBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
