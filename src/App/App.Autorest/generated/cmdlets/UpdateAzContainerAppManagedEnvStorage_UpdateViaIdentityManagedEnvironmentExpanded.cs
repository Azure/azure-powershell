            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ManagedEnvironmentInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ManagedEnvironmentsStoragesCreateOrUpdateViaIdentity(ManagedEnvironmentInputObject.Id, _storageEnvelopeBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        this.Update_storageEnvelopeBody();
                        await this.Client.ManagedEnvironmentsStoragesCreateOrUpdate(ManagedEnvironmentInputObject.SubscriptionId ?? null, ManagedEnvironmentInputObject.ResourceGroupName ?? null, ManagedEnvironmentInputObject.EnvironmentName ?? null, Name, _storageEnvelopeBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeUpdate);
                    }
