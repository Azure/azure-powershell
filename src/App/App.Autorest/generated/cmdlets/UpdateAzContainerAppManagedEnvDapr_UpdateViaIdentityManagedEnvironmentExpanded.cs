...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.App.Description(@"Create a Dapr Component in a Managed Environment.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.IContext
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DaprComponentsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.ManagedEnvironmentInputObject.Id += $"/daprComponents/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        _daprComponentEnvelopeBody = await this.Client.DaprComponentsGetViaIdentityWithResult(ManagedEnvironmentInputObject.Id, this, Pipeline);
                        this.Update_daprComponentEnvelopeBody();
                        await this.Client.DaprComponentsCreateOrUpdateViaIdentity(ManagedEnvironmentInputObject.Id, _daprComponentEnvelopeBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _daprComponentEnvelopeBody = await this.Client.DaprComponentsGetWithResult(ManagedEnvironmentInputObject.SubscriptionId ?? null, ManagedEnvironmentInputObject.ResourceGroupName ?? null, ManagedEnvironmentInputObject.EnvironmentName ?? null, Name, this, Pipeline);
                        this.Update_daprComponentEnvelopeBody();
                        await this.Client.DaprComponentsCreateOrUpdate(ManagedEnvironmentInputObject.SubscriptionId ?? null, ManagedEnvironmentInputObject.ResourceGroupName ?? null, ManagedEnvironmentInputObject.EnvironmentName ?? null, Name, _daprComponentEnvelopeBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzContainerAppManagedEnvDapr_UpdateViaIdentityManagedEnvironmentExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzContainerAppManagedEnvDapr_UpdateViaIdentityManagedEnvironmentExpanded()
        {

        }

        private void Update_daprComponentEnvelopeBody()
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ComponentType")))
            {
                this.ComponentType = (string)(this.MyInvocation?.BoundParameters["ComponentType"]);
            }
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("IgnoreError")))
            {
                this.IgnoreError = (global::System.Management.Automation.SwitchParameter)(this.MyInvocation?.BoundParameters["IgnoreError"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("InitTimeout")))
            {
                this.InitTimeout = (string)(this.MyInvocation?.BoundParameters["InitTimeout"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Secret")))
            {
                this.Secret = (Microsoft.Azure.PowerShell.Cmdlets.App.Models.ISecret[])(this.MyInvocation?.BoundParameters["Secret"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SecretStoreComponent")))
            {
                this.SecretStoreComponent = (string)(this.MyInvocation?.BoundParameters["SecretStoreComponent"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Metadata")))
            {
                this.Metadata = (Microsoft.Azure.PowerShell.Cmdlets.App.Models.IDaprMetadata[])(this.MyInvocation?.BoundParameters["Metadata"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Scope")))
            {
