...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzContainerAppConnectedEnvStorage_UpdateViaIdentityConnectedEnvironmentExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzContainerAppConnectedEnvStorage_UpdateViaIdentityConnectedEnvironmentExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ConnectedEnvironmentInputObject?.Id != null)
                    {
                        ...
                        _storageEnvelopeBody = await this.Client.ConnectedEnvironmentsStoragesGetViaIdentityWithResult(ConnectedEnvironmentInputObject.Id, this, Pipeline);
                        this.Update_storageEnvelopeBody();
                        await this.Client.ConnectedEnvironmentsStoragesCreateOrUpdateViaIdentity(ConnectedEnvironmentInputObject.Id, _storageEnvelopeBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _storageEnvelopeBody = await this.Client.ConnectedEnvironmentsStoragesGetWithResult(ConnectedEnvironmentInputObject.SubscriptionId ?? null, ConnectedEnvironmentInputObject.ResourceGroupName ?? null, ConnectedEnvironmentInputObject.ConnectedEnvironmentName ?? null, Name, this, Pipeline);
                        this.Update_storageEnvelopeBody();
                        await this.Client.ConnectedEnvironmentsStoragesCreateOrUpdate(ConnectedEnvironmentInputObject.SubscriptionId ?? null, ConnectedEnvironmentInputObject.ResourceGroupName ?? null, ConnectedEnvironmentInputObject.ConnectedEnvironmentName ?? null, Name, _storageEnvelopeBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzContainerAppConnectedEnvStorage_UpdateViaIdentityConnectedEnvironmentExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzContainerAppConnectedEnvStorage_UpdateViaIdentityConnectedEnvironmentExpanded()
        {

        }

        private void Update_storageEnvelopeBody()
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("AzureFileAccessMode")))
            {
                this.AzureFileAccessMode = (string)(this.MyInvocation?.BoundParameters["AzureFileAccessMode"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("AzureFileAccountName")))
            {
                this.AzureFileAccountName = (string)(this.MyInvocation?.BoundParameters["AzureFileAccountName"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("AzureFileAccountKey")))
            {
                this.AzureFileAccountKey = (string)(this.MyInvocation?.BoundParameters["AzureFileAccountKey"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("AzureFileShareName")))
            {
