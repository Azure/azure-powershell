...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.App.custom\New-AzContainerAppJob';
            CreateViaJsonString = 'Az.App.custom\New-AzContainerAppJob';
            CreateViaJsonFilePath = 'Az.App.custom\New-AzContainerAppJob';
