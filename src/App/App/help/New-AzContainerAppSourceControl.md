...
```powershell
$AzureClientSecret = ConvertTo-SecureString -String $passwordString -AsPlainText -Force
$RegistryPassword = ConvertTo-SecureString -String $passwordString -AsPlainText -Force
$GithubAccessToken = ConvertTo-SecureString -String $passwordString -AsPlainText -Force
