...
RequiredAssemblies = 'App.Autorest/bin/Az.App.private.dll'
...
FormatsToProcess = 'App.Autorest/Az.App.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('App.Autorest/Az.App.psm1')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* The parameters of the ''New-AzContainerApp'', ''New-AzContainerAppJob'', ''Update-AzContainerApp'', ''Update-AzContainerAppJob'' commands have changed.
