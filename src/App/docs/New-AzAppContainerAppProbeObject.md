...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/Az.App/new-azappcontainerappprobeobject
schema: 2.0.0
---

# New-AzAppContainerAppProbeObject
...
```
New-AzAppContainerAppProbeObject [-FailureThreshold <Int32>] [-HttpGetHost <String>]
