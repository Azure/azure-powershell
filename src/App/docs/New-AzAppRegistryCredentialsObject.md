...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/Az.App/new-azappregistrycredentialsobject
schema: 2.0.0
---

# New-AzAppRegistryCredentialsObject
...
```
New-AzAppRegistryCredentialsObject [-Identity <String>] [-PasswordSecretRef <String>] [-Server <String>]
