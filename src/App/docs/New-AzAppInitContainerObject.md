...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/Az.App/new-azappinitcontainerobject
schema: 2.0.0
---

# New-AzAppInitContainerObject
...
```
New-AzAppInitContainerObject [-Arg <String[]>] [-Command <String[]>] [-Env <IEnvironmentVar[]>]
