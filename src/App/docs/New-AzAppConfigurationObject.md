...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/Az.App/new-azappconfigurationobject
schema: 2.0.0
---

# New-AzAppConfigurationObject
...
```
New-AzAppConfigurationObject [-ActiveRevisionsMode <String>] [-CorPolicyAllowCredentials <Boolean>]
