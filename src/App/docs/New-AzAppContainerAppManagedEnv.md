...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/new-azappcontainerappmanagedenv
schema: 2.0.0
---

# New-AzAppContainerAppManagedEnv
...
```
New-AzAppContainerAppManagedEnv -EnvName <String> -ResourceGroupName <String> -Location <String>
...
### Create
```
New-AzAppContainerAppManagedEnv -EnvName <String> -ResourceGroupName <String>
...
### CreateViaIdentity
```
New-AzAppContainerAppManagedEnv -InputObject <IAppIdentity> -EnvironmentEnvelope <IManagedEnvironment>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzAppContainerAppManagedEnv -InputObject <IAppIdentity> -Location <String>
...
```
New-AzAppContainerAppManagedEnv -EnvName <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### CreateViaJsonString
```
New-AzAppContainerAppManagedEnv -EnvName <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
