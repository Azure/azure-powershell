...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/update-azappconnectedenvironmentsdaprcomponent
schema: 2.0.0
---

# Update-AzAppConnectedEnvironmentsDaprComponent
...
```
Update-AzAppConnectedEnvironmentsDaprComponent -ConnectedEnvironmentName <String> -DaprName <String>
...
### UpdateViaIdentity
```
Update-AzAppConnectedEnvironmentsDaprComponent -InputObject <IAppIdentity>
...
```
Update-AzAppConnectedEnvironmentsDaprComponent -ConnectedEnvironmentInputObject <IAppIdentity>
 -DaprName <String> -DaprComponentEnvelope <IDaprComponent> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-AzAppConnectedEnvironmentsDaprComponent -ConnectedEnvironmentInputObject <IAppIdentity>
 -DaprName <String> [-ComponentType <String>] [-IgnoreError] [-InitTimeout <String>]
...
```
Update-AzAppConnectedEnvironmentsDaprComponent -InputObject <IAppIdentity> [-ComponentType <String>]
