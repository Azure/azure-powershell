...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/get-azappmanagedenvironmentdiagnosticdetector
schema: 2.0.0
---

# Get-AzAppManagedEnvironmentDiagnosticDetector
...
### List (Default)
```
Get-AzAppManagedEnvironmentDiagnosticDetector -EnvName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzAppManagedEnvironmentDiagnosticDetector -DetectorName <String> -EnvName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAppManagedEnvironmentDiagnosticDetector -InputObject <IAppIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentityManagedEnvironment
```
Get-AzAppManagedEnvironmentDiagnosticDetector -DetectorName <String>
