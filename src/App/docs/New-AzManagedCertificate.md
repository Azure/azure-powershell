...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/new-azmanagedcertificate
schema: 2.0.0
---

# New-AzManagedCertificate
...
```
New-AzManagedCertificate -EnvName <String> -Name <String> -ResourceGroupName <String> -Location <String>
...
```
New-AzManagedCertificate -ManagedEnvironmentInputObject <IAppIdentity> -Name <String>
...
```
New-AzManagedCertificate -ManagedEnvironmentInputObject <IAppIdentity> -Name <String> -Location <String>
...
```
New-AzManagedCertificate -EnvName <String> -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### CreateViaJsonString
```
New-AzManagedCertificate -EnvName <String> -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
