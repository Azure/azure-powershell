...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/update-azconnectedenvironmentscertificate
schema: 2.0.0
---

# Update-AzConnectedEnvironmentsCertificate
...
```
Update-AzConnectedEnvironmentsCertificate -CertificateName <String> -ConnectedEnvironmentName <String>
...
```
Update-AzConnectedEnvironmentsCertificate -CertificateName <String>
...
```
Update-AzConnectedEnvironmentsCertificate -InputObject <IAppIdentity> [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityConnectedEnvironment, UpdateViaIdentityConnectedEnvironmentExpanded, UpdateViaJsonFilePath, UpdateViaJsonString
Aliases:
