...
external help file:
Module Name: Az.App
online version: https://docs.microsoft.com/powershell/module/az./new-AzDaprMetadata
schema: 2.0.0
---
...
```
New-AzDaprMetadata [-Name <String>] [-SecretRef <String>] [-Value <String>] [<CommonParameters>]
```
