...
external help file:
Module Name: Az.App
online version: https://docs.microsoft.com/powershell/module/az.app/get-azcontainerappsauthconfig
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzContainerAppsAuthConfig -AuthConfigName <String> -ContainerAppName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzContainerAppsAuthConfig -InputObject <IAppIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
