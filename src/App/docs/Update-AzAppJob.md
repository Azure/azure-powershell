...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/update-azappjob
schema: 2.0.0
---
...
```
Update-AzAppJob -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### Update
```
Update-AzAppJob -Name <String> -ResourceGroupName <String> -JobEnvelope <IJobPatchProperties>
...
### UpdateViaIdentity
```
Update-AzAppJob -InputObject <IAppIdentity> -JobEnvelope <IJobPatchProperties> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAppJob -InputObject <IAppIdentity> [-ConfigurationRegistry <IRegistryCredentials[]>]
...
```
Update-AzAppJob -Name <String> -ResourceGroupName <String> -JsonFilePath <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaJsonString
```
Update-AzAppJob -Name <String> -ResourceGroupName <String> -JsonString <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
To construct, see NOTES section for JOBENVELOPE properties and create a hash table.

```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.App.Models.IJobPatchProperties
