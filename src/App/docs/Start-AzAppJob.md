...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/start-azappjob
schema: 2.0.0
---
...
```
Start-AzAppJob -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### Start
```
Start-AzAppJob -Name <String> -ResourceGroupName <String> -Template <IJobExecutionTemplate>
...
### StartViaIdentity
```
Start-AzAppJob -InputObject <IAppIdentity> -Template <IJobExecutionTemplate> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaIdentityExpanded
```
Start-AzAppJob -InputObject <IAppIdentity> [-Container <IJobExecutionContainer[]>]
...
```
Start-AzAppJob -Name <String> -ResourceGroupName <String> -JsonFilePath <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaJsonString
```
Start-AzAppJob -Name <String> -ResourceGroupName <String> -JsonString <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
