...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/Az.App/new-azappscaleruleobject
schema: 2.0.0
---

# New-AzAppScaleRuleObject
...
```
New-AzAppScaleRuleObject [-AzureQueueAuth <IScaleRuleAuth[]>] [-AzureQueueLength <Int32>]
