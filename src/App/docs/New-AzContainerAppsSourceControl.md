...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/new-azcontainerappssourcecontrol
schema: 2.0.0
---

# New-AzContainerAppsSourceControl
...
```
New-AzContainerAppsSourceControl -ContainerAppName <String> -ResourceGroupName <String>
...
```
New-AzContainerAppsSourceControl -ContainerAppInputObject <IAppIdentity> -SourceControlName <String>
