...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/new-azappconnectedenvdapr
schema: 2.0.0
---

# New-AzAppConnectedEnvDapr
...
```
New-AzAppConnectedEnvDapr -ConnectedEnvironmentName <String> -DaprName <String> -ResourceGroupName <String>
...
```
New-AzAppConnectedEnvDapr -ConnectedEnvironmentInputObject <IAppIdentity> -DaprName <String>
...
```
New-AzAppConnectedEnvDapr -InputObject <IAppIdentity> [-ComponentType <String>] [-IgnoreError]
