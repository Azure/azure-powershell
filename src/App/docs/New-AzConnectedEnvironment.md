...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/new-azconnectedenvironment
schema: 2.0.0
---

# New-AzConnectedEnvironment
...
```
New-AzConnectedEnvironment -Name <String> -ResourceGroupName <String> -Location <String>
...
```
New-AzConnectedEnvironment -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### CreateViaJsonString
```
New-AzConnectedEnvironment -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
