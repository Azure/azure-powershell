...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/get-azconnectedenvironmentsstorage
schema: 2.0.0
---

# Get-AzConnectedEnvironmentsStorage
...
### List (Default)
```
Get-AzConnectedEnvironmentsStorage -ConnectedEnvironmentName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzConnectedEnvironmentsStorage -InputObject <IAppIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentityConnectedEnvironment
```
Get-AzConnectedEnvironmentsStorage -ConnectedEnvironmentInputObject <IAppIdentity> -StorageName <String>
