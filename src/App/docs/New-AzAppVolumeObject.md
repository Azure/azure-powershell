...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/Az.App/new-azappvolumeobject
schema: 2.0.0
---

# New-AzAppVolumeObject
...
```
New-AzAppVolumeObject [-MountOption <String>] [-Name <String>] [-Secret <ISecretVolumeItem[]>]
