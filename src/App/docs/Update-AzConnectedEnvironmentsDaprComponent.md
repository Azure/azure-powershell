...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/update-azconnectedenvironmentsdaprcomponent
schema: 2.0.0
---

# Update-AzConnectedEnvironmentsDaprComponent
...
```
Update-AzConnectedEnvironmentsDaprComponent -ConnectedEnvironmentName <String> -DaprName <String>
...
```
Update-AzConnectedEnvironmentsDaprComponent -ConnectedEnvironmentInputObject <IAppIdentity> -DaprName <String>
...
```
Update-AzConnectedEnvironmentsDaprComponent -InputObject <IAppIdentity> [-ComponentType <String>]
...
Parameter Sets: UpdateViaIdentityConnectedEnvironment
Aliases:
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityConnectedEnvironment, UpdateViaIdentityConnectedEnvironmentExpanded
Aliases:
