...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/new-azappconnectedenvstorage
schema: 2.0.0
---

# New-AzAppConnectedEnvStorage
...
```
New-AzAppConnectedEnvStorage -ConnectedEnvironmentName <String> -ResourceGroupName <String>
...
```
New-AzAppConnectedEnvStorage -ConnectedEnvironmentInputObject <IAppIdentity> -StorageName <String>
...
```
New-AzAppConnectedEnvStorage -InputObject <IAppIdentity> [-AzureFileAccessMode <String>]
 [-AzureFileAccountKey <String>] [-AzureFileAccountName <String>] [-AzureFileShareName <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
