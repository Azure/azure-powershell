...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/get-azappconnectedenvstorage
schema: 2.0.0
---
...
### List (Default)
```
Get-AzAppConnectedEnvStorage -ConnectedEnvironmentName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzAppConnectedEnvStorage -InputObject <IAppIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityConnectedEnvironment
```
Get-AzAppConnectedEnvStorage -ConnectedEnvironmentInputObject <IAppIdentity> -StorageName <String>
