...
external help file:
Module Name: Az.App
online version: https://docs.microsoft.com/powershell/module/az.app/get-azcontainerappssourcecontrol
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzContainerAppsSourceControl -ContainerAppName <String> -ResourceGroupName <String>
 -SourceControlName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzContainerAppsSourceControl -InputObject <IAppIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
