...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/new-azconnectedenvironmentsdaprcomponent
schema: 2.0.0
---

# New-AzConnectedEnvironmentsDaprComponent
...
```
New-AzConnectedEnvironmentsDaprComponent -ConnectedEnvironmentName <String> -DaprName <String>
...
```
New-AzConnectedEnvironmentsDaprComponent -ConnectedEnvironmentInputObject <IAppIdentity> -DaprName <String>
