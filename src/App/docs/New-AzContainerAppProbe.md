...
external help file:
Module Name: Az.App
online version: https://docs.microsoft.com/powershell/module/az./new-AzContainerAppProbe
schema: 2.0.0
---

# New-AzContainerAppProbe
...
```
New-AzContainerAppProbe [-FailureThreshold <Int32>] [-HttpGetHost <String>]
