...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/update-azappconnectedenvdapr
schema: 2.0.0
---

# Update-AzAppConnectedEnvDapr
...
```
Update-AzAppConnectedEnvDapr -ConnectedEnvironmentName <String> -DaprName <String> -ResourceGroupName <String>
...
```
Update-AzAppConnectedEnvDapr -ConnectedEnvironmentInputObject <IAppIdentity> -DaprName <String>
...
```
Update-AzAppConnectedEnvDapr -InputObject <IAppIdentity> [-ComponentType <String>] [-IgnoreError]
