...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/Az.App/new-azappcontainerobject
schema: 2.0.0
---

# New-AzAppContainerObject
...
```
New-AzAppContainerObject [-Arg <String[]>] [-Command <String[]>] [-Env <IEnvironmentVar[]>] [-Image <String>]
