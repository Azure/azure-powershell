...
external help file:
Module Name: Az.App
online version: https://docs.microsoft.com/powershell/module/az./new-AzIdentityProviders
schema: 2.0.0
---

# New-AzIdentityProviders
...
```
New-AzIdentityProviders [-AllowedPrincipalGroup <String[]>] [-AllowedPrincipalIdentity <String[]>]
