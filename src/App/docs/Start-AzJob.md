...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/start-azjob
schema: 2.0.0
---
...
```
Start-AzJob -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### Start
```
Start-AzJob -Name <String> -ResourceGroupName <String> -Template <IJobExecutionTemplate>
...
### StartViaIdentity
```
Start-AzJob -InputObject <IAppIdentity> -Template <IJobExecutionTemplate> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaIdentityExpanded
```
Start-AzJob -InputObject <IAppIdentity> [-Container <IJobExecutionContainer[]>]
...
```
Start-AzJob -Name <String> -ResourceGroupName <String> -JsonFilePath <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaJsonString
```
Start-AzJob -Name <String> -ResourceGroupName <String> -JsonString <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
