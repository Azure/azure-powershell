...
external help file:
Module Name: Az.App
online version: https://docs.microsoft.com/powershell/module/az./new-AzContainer
schema: 2.0.0
---
...
```
New-AzContainer [-Arg <String[]>] [-Command <String[]>] [-Env <IEnvironmentVar[]>] [-Image <String>]
