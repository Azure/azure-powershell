...
external help file:
Module Name: Az.App
online version: https://docs.microsoft.com/powershell/module/az.app/new-azcontainerappsourcecontrol
schema: 2.0.0
---
...
New-AzContainerAppSourceControl -ContainerAppName <String> -ResourceGroupName <String>
 ...
 [-AzureCredentialsClientSecret <String>] [-AzureCredentialsSubscriptionId <String>]
 ...
 [-GithubActionConfigurationRuntimeVersion <String>] [-RegistryInfoRegistryPassword <String>]
