...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/test-azconnectedenvironmentnameavailability
schema: 2.0.0
---

# Test-AzConnectedEnvironmentNameAvailability
...
```
Test-AzConnectedEnvironmentNameAvailability -ConnectedEnvironmentName <String> -ResourceGroupName <String>
...
### CheckViaIdentity
```
Test-AzConnectedEnvironmentNameAvailability -InputObject <IAppIdentity>
...
```
Test-AzConnectedEnvironmentNameAvailability -InputObject <IAppIdentity> [-Name <String>] [-Type <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
