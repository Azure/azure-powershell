...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/Az.App/new-azappsecretvolumeitemobject
schema: 2.0.0
---

# New-AzAppSecretVolumeItemObject
...
```
New-AzAppSecretVolumeItemObject [-Path <String>] [-SecretRef <String>] [<CommonParameters>]
```
