...
external help file:
Module Name: Az.App
online version: https://learn.microsoft.com/powershell/module/az.app/update-azjob
schema: 2.0.0
---
...
```
Update-AzJob -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzJob -InputObject <IAppIdentity> [-ConfigurationRegistry <IRegistryCredentials[]>]
...
```
Update-AzJob -Name <String> -ResourceGroupName <String> -JsonFilePath <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaJsonString
```
Update-AzJob -Name <String> -ResourceGroupName <String> -JsonString <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
