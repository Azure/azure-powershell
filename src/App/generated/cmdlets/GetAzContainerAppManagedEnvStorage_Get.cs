...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzContainerAppManagedEnvStorage_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ManagedEnvironmentsStoragesGet(SubscriptionId, ResourceGroupName, EnvName, StorageName, onOk, onDefault, this, Pipeline);
