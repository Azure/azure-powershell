...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzContainerAppRevision_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ContainerAppsRevisionsGetRevision(SubscriptionId, ResourceGroupName, ContainerAppName, RevisionName, onOk, onDefault, this, Pipeline);
