...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301
{
    ...
    public partial class Login
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ILogin.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ILogin.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ILogin FromJson(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject json ? new Login(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject into a new instance of <see cref="Login" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Login(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject json)
        {
            ...
            {_route = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("routes"), out var __jsonRoutes) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.LoginRoutes.FromJson(__jsonRoutes) : Route;}
            {_cookieExpiration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("cookieExpiration"), out var __jsonCookieExpiration) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.CookieExpiration.FromJson(__jsonCookieExpiration) : CookieExpiration;}
            {_nonce = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("nonce"), out var __jsonNonce) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.Nonce.FromJson(__jsonNonce) : Nonce;}
            {_preserveUrlFragmentsForLogin = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonBoolean>("preserveUrlFragmentsForLogins"), out var __jsonPreserveUrlFragmentsForLogins) ? (bool?)__jsonPreserveUrlFragmentsForLogins : PreserveUrlFragmentsForLogin;}
            {_allowedExternalRedirectUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray>("allowedExternalRedirectUrls"), out var __jsonAllowedExternalRedirectUrls) ? If( __jsonAllowedExternalRedirectUrls as Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : AllowedExternalRedirectUrl;}
            AfterFromJson(json);
        }
