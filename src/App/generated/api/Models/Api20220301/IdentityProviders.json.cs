...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301
{
    ...
    public partial class IdentityProviders
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IIdentityProviders.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IIdentityProviders.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IIdentityProviders FromJson(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode node)
        {
        ...
        internal IdentityProviders(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject json)
        {
            ...
            {_azureActiveDirectory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("azureActiveDirectory"), out var __jsonAzureActiveDirectory) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.AzureActiveDirectory.FromJson(__jsonAzureActiveDirectory) : AzureActiveDirectory;}
            {_facebook = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("facebook"), out var __jsonFacebook) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.Facebook.FromJson(__jsonFacebook) : Facebook;}
            {_gitHub = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("gitHub"), out var __jsonGitHub) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.GitHub.FromJson(__jsonGitHub) : GitHub;}
            {_google = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("google"), out var __jsonGoogle) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.Google.FromJson(__jsonGoogle) : Google;}
            {_twitter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("twitter"), out var __jsonTwitter) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.Twitter.FromJson(__jsonTwitter) : Twitter;}
            {_apple = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("apple"), out var __jsonApple) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.Apple.FromJson(__jsonApple) : Apple;}
            {_azureStaticWebApp = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("azureStaticWebApps"), out var __jsonAzureStaticWebApps) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.AzureStaticWebApps.FromJson(__jsonAzureStaticWebApps) : AzureStaticWebApp;}
            {_customOpenIdConnectProvider = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("customOpenIdConnectProviders"), out var __jsonCustomOpenIdConnectProviders) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IdentityProvidersCustomOpenIdConnectProviders.FromJson(__jsonCustomOpenIdConnectProviders) : CustomOpenIdConnectProvider;}
            AfterFromJson(json);
        }
