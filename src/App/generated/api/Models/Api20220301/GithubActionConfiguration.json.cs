...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301
{
    ...
    public partial class GithubActionConfiguration
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IGithubActionConfiguration.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IGithubActionConfiguration.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IGithubActionConfiguration FromJson(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode node)
        {
        ...
        internal GithubActionConfiguration(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject json)
        {
            ...
            {_registryInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("registryInfo"), out var __jsonRegistryInfo) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.RegistryInfo.FromJson(__jsonRegistryInfo) : RegistryInfo;}
            {_azureCredentials = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("azureCredentials"), out var __jsonAzureCredentials) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.AzureCredentials.FromJson(__jsonAzureCredentials) : AzureCredentials;}
            {_contextPath = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("contextPath"), out var __jsonContextPath) ? (string)__jsonContextPath : (string)ContextPath;}
            ...
            {_publishType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("publishType"), out var __jsonPublishType) ? (string)__jsonPublishType : (string)PublishType;}
            {_oS = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("os"), out var __jsonOS) ? (string)__jsonOS : (string)OS;}
            {_runtimeStack = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("runtimeStack"), out var __jsonRuntimeStack) ? (string)__jsonRuntimeStack : (string)RuntimeStack;}
            {_runtimeVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("runtimeVersion"), out var __jsonRuntimeVersion) ? (string)__jsonRuntimeVersion : (string)RuntimeVersion;}
            AfterFromJson(json);
        }
