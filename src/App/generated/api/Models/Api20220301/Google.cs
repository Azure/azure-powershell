...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301
{
    ...
    public partial class Google :
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IGoogle,
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IGoogleInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ILoginScopes Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IGoogleInternal.Login { get => (this._login = this._login ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.LoginScopes()); set { {_login = value;} } }

        /// <summary>Internal Acessors for Registration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IClientRegistration Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IGoogleInternal.Registration { get => (this._registration = this._registration ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ClientRegistration()); set { {_registration = value;} } }

        /// <summary>Internal Acessors for Validation</summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IAllowedAudiencesValidation Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IGoogleInternal.Validation { get => (this._validation = this._validation ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.AllowedAudiencesValidation()); set { {_validation = value;} } }

        /// <summary>Backing field for <see cref="Registration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IClientRegistration _registration;

        /// <summary>The configuration settings of the app registration for the Google provider.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IClientRegistration Registration { get => (this._registration = this._registration ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.ClientRegistration()); set => this._registration = value; }

        /// <summary>The Client ID of the app used for login.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Inlined)]
        public string RegistrationClientId { get => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IClientRegistrationInternal)Registration).ClientId; set => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IClientRegistrationInternal)Registration).ClientId = value ?? null; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IAllowedAudiencesValidation _validation;

        /// <summary>The configuration settings of the Azure Active Directory token validation flow.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IAllowedAudiencesValidation Validation { get => (this._validation = this._validation ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.AllowedAudiencesValidation()); set => this._validation = value; }
...

    {
        ...
        string[] LoginScope { get; set; }
        /// <summary>The configuration settings of the app registration for the Google provider.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IClientRegistration Registration { get; set; }
        /// <summary>The Client ID of the app used for login.</summary>
        string RegistrationClientId { get; set; }
        /// <summary>The app setting name that contains the client secret.</summary>
        string RegistrationClientSecretSettingName { get; set; }
        /// <summary>The configuration settings of the Azure Active Directory token validation flow.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.IAllowedAudiencesValidation Validation { get; set; }
        /// <summary>
        /// The configuration settings of the allowed list of audiences from which to validate the JWT token.
        /// </summary>
        string[] ValidationAllowedAudience { get; set; }
