...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301
{
    ...
    public partial class HttpSettingsRoutes
    {
        ...
        internal HttpSettingsRoutes(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject json)
        {
            ...
            {_apiPrefix = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("apiPrefix"), out var __jsonApiPrefix) ? (string)__jsonApiPrefix : (string)ApiPrefix;}
            AfterFromJson(json);
        }
