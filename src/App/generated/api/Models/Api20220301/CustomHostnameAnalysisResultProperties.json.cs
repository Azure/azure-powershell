...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301
{
    ...
    public partial class CustomHostnameAnalysisResultProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject into a new instance of <see cref="CustomHostnameAnalysisResultProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal CustomHostnameAnalysisResultProperties(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject json)
        {
            ...
            {_customDomainVerificationFailureInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("customDomainVerificationFailureInfo"), out var __jsonCustomDomainVerificationFailureInfo) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.DefaultErrorResponse.FromJson(__jsonCustomDomainVerificationFailureInfo) : CustomDomainVerificationFailureInfo;}
            {_hostName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("hostName"), out var __jsonHostName) ? (string)__jsonHostName : (string)HostName;}
            {_isHostnameAlreadyVerified = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonBoolean>("isHostnameAlreadyVerified"), out var __jsonIsHostnameAlreadyVerified) ? (bool?)__jsonIsHostnameAlreadyVerified : IsHostnameAlreadyVerified;}
            {_customDomainVerificationTest = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("customDomainVerificationTest"), out var __jsonCustomDomainVerificationTest) ? (string)__jsonCustomDomainVerificationTest : (string)CustomDomainVerificationTest;}
            {_hasConflictOnManagedEnvironment = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonBoolean>("hasConflictOnManagedEnvironment"), out var __jsonHasConflictOnManagedEnvironment) ? (bool?)__jsonHasConflictOnManagedEnvironment : HasConflictOnManagedEnvironment;}
            {_conflictingContainerAppResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("conflictingContainerAppResourceId"), out var __jsonConflictingContainerAppResourceId) ? (string)__jsonConflictingContainerAppResourceId : (string)ConflictingContainerAppResourceId;}
            {_cNameRecord = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray>("cNameRecords"), out var __jsonCNameRecords) ? If( __jsonCNameRecords as Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : CNameRecord;}
            {_txtRecord = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray>("txtRecords"), out var __jsonTxtRecords) ? If( __jsonTxtRecords as Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : TxtRecord;}
            {_aRecord = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray>("aRecords"), out var __jsonARecords) ? If( __jsonARecords as Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(string) (__k is Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString __j ? (string)(__j.ToString()) : null)) ))() : null : ARecord;}
            {_alternateCNameRecord = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray>("alternateCNameRecords"), out var __jsonAlternateCNameRecords) ? If( __jsonAlternateCNameRecords as Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__g, (__f)=>(string) (__f is Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString __e ? (string)(__e.ToString()) : null)) ))() : null : AlternateCNameRecord;}
            {_alternateTxtRecord = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray>("alternateTxtRecords"), out var __jsonAlternateTxtRecords) ? If( __jsonAlternateTxtRecords as Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray, out var __b) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__b, (__a)=>(string) (__a is Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString ___z ? (string)(___z.ToString()) : null)) ))() : null : AlternateTxtRecord;}
            AfterFromJson(json);
        }
