...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301
{
    ...
    public partial class ManagedEnvironmentStorageProperties
    {
        ...
        internal ManagedEnvironmentStorageProperties(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject json)
        {
            ...
            {_azureFile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("azureFile"), out var __jsonAzureFile) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301.AzureFileProperties.FromJson(__jsonAzureFile) : AzureFile;}
            AfterFromJson(json);
        }
