...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models.Api20220301
{
    ...
    public partial class QueueScaleRule
    {
        ...
        internal QueueScaleRule(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject json)
        {
            ...
            {_queueName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("queueName"), out var __jsonQueueName) ? (string)__jsonQueueName : (string)QueueName;}
            {_queueLength = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNumber>("queueLength"), out var __jsonQueueLength) ? (int?)__jsonQueueLength : QueueLength;}
