...
.Link
https://learn.microsoft.com/powershell/module/Az.App/new-azappcontainerappprobehttpgethttpheadersitemobject
#>
function New-AzAppContainerAppProbeHttpGetHttpHeadersItemObject {
