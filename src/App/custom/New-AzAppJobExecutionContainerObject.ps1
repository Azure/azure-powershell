...
.Link
https://learn.microsoft.com/powershell/module/Az.App/new-azappjobexecutioncontainerobject
#>
function New-AzAppJobExecutionContainerObject {
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.App.Models.JobExecutionContainer]::New()
