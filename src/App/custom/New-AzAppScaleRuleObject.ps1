...
.Link
https://learn.microsoft.com/powershell/module/Az.App/new-azappscaleruleobject
#>
function New-AzAppScaleRuleObject {
    ...
    Param(
        ...
        [string]
        $Name,
        [Parameter(HelpMessage="Authentication secrets for the tcp scale rule.")]
        [Microsoft.Azure.PowerShell.Cmdlets.App.Models.IScaleRuleAuth[]]
        $TcpAuth,
        [Parameter(HelpMessage="Metadata properties to describe tcp scale rule.")]
    ...
    process {
        ...
        if ($PSBoundParameters.ContainsKey('TcpAuth')) {
            $Object.TcpAuth = $TcpAuth
        }
        if ($PSBoundParameters.ContainsKey('TcpMetadata')) {
            $Object.TcpMetadata = $TcpMetadata
        }
        return $Object
    }
}
