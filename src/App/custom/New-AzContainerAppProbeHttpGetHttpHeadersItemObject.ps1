...
.Link
https://learn.microsoft.com/powershell/module/Az.App/new-azcontainerappprobehttpgethttpheadersitemobject
#>
function New-AzContainerAppProbeHttpGetHttpHeadersItemObject {
