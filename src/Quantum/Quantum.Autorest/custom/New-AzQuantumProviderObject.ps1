...
function New-AzQuantumProviderObject {
    ...
    Param(
        ...
        [Parameter(HelpMessage="The provider's marketplace application display name.")]
        [string]
        $ApplicationName,
        [Parameter(HelpMessage="Unique id of this provider.")]
        [string]
        $Id,
        [Parameter(HelpMessage="A Uri identifying the specific instance of this provider.")]
        [string]
        $InstanceUri,
        ...
        [string]
        $ResourceUsageId,
        [Parameter(HelpMessage="The sku associated with pricing information for this provider.")]
        [string]
        $Sku
    )
    ...
    process {
        ...
        if ($PSBoundParameters.ContainsKey('InstanceUri')) {
            $Object.InstanceUri = $InstanceUri
        }
        if ($PSBoundParameters.ContainsKey('ProvisioningState')) {
            $Object.ProvisioningState = $ProvisioningState
        }
        if ($PSBoundParameters.ContainsKey('ResourceUsageId')) {
            $Object.ResourceUsageId = $ResourceUsageId
        }
