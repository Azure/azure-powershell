...
New-AzGrafana -Name <String> -ResourceGroupName <String> -ApiKey <String>
 -AutoGeneratedDomainNameLabelScope <String> -DeterministicOutboundIP <String> -Location <String>
 -PublicNetworkAccess <String> -SkuName <String> -ZoneRedundancy <String> [-SubscriptionId <String>]
 [-EnableSystemAssignedIdentity] [-MonitorWorkspaceIntegration <IAzureMonitorWorkspaceIntegration[]>]
