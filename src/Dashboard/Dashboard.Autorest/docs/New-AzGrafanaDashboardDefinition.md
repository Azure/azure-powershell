...
```
New-AzGrafanaDashboardDefinition -DashboardName <String> -DefinitionName <String> -ResourceGroupName <String>
 -SubscriptionId <String> [-SerializedData <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentityDashboardExpanded
```
New-AzGrafanaDashboardDefinition -DashboardInputObject <IDashboardIdentity> -DefinitionName <String>
...
```
New-AzGrafanaDashboardDefinition -DashboardName <String> -DefinitionName <String> -ResourceGroupName <String>
 -SubscriptionId <String> -JsonFilePath <String> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-AzGrafanaDashboardDefinition -DashboardName <String> -DefinitionName <String> -ResourceGroupName <String>
 -SubscriptionId <String> -JsonString <String> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
