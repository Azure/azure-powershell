...
### Refresh (Default)
```
Update-AzGrafanaManagedPrivateEndpoint -ResourceGroupName <String> -WorkspaceName <String>
...
### UpdateExpanded
```
Update-AzGrafanaManagedPrivateEndpoint -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
...
```
Update-AzGrafanaManagedPrivateEndpoint -GrafanaInputObject <IDashboardIdentity> -Name <String>
