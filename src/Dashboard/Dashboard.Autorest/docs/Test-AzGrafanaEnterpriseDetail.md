...
### Check (Default)
```
Test-AzGrafanaEnterpriseDetail -ResourceGroupName <String> -WorkspaceName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentity
```
Test-AzGrafanaEnterpriseDetail -InputObject <IDashboardIdentity> [-DefaultProfile <PSObject>] [-Confirm]
