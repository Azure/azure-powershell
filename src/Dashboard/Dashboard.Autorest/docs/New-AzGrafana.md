...
```
New-AzGrafana -Name <String> -ResourceGroupName <String> -ApiKey <String>
 -AutoGeneratedDomainNameLabelScope <String> -DeterministicOutboundIP <String> -EnableSystemAssignedIdentity
 -Location <String> -PublicNetworkAccess <String> -SkuName <String> -ZoneRedundancy <String>
 [-SubscriptionId <String>] [-MonitorWorkspaceIntegration <IAzureMonitorWorkspaceIntegration[]>]
...
```
New-AzGrafana -Name <String> -ResourceGroupName <String> -JsonFilePath <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaJsonString
```
New-AzGrafana -Name <String> -ResourceGroupName <String> -JsonString <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
