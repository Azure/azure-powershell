...
```
Update-AzGrafanaDashboardDefinition -DashboardInputObject <IDashboardIdentity> -DefinitionName <String>
 [-SerializedData <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
