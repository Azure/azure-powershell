...
RequiredAssemblies = 'Dashboard.Autorest/bin/Az.Dashboard.private.dll'
...
FormatsToProcess = 'Dashboard.Autorest/Az.Dashboard.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('Dashboard.Autorest/Az.Dashboard.psm1')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated swagger version to 2025-08-01 to include dashboard operations.'
