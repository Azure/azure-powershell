...
online version: https://learn.microsoft.com/powershell/module/az.dashboard/remove-azgrafanamanagedprivateendpoint
schema: 2.0.0
---

# Remove-AzGrafanaManagedPrivateEndpoint
...
### Delete (Default)
```
Remove-AzGrafanaManagedPrivateEndpoint -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Remove-AzGrafanaManagedPrivateEndpoint -Name <String> -GrafanaInputObject <IDashboardIdentity>
...
### DeleteViaIdentity
```
Remove-AzGrafanaManagedPrivateEndpoint -InputObject <IDashboardIdentity> [-DefaultProfile <PSObject>] [-AsJob]
