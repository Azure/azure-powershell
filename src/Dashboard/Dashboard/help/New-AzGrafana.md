...
```
New-AzGrafana -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] -ApiKey <String>
 ...
 [-UserAssignedIdentity <String[]>] [-MonitorWorkspaceIntegration <IAzureMonitorWorkspaceIntegration[]>]
...
```
New-AzGrafana -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] -JsonFilePath <String>
...
### CreateViaJsonString
```
New-AzGrafana -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] -JsonString <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
