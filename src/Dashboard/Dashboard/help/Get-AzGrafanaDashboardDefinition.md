...
### List (Default)
```
Get-AzGrafanaDashboardDefinition -DashboardName <String> -ResourceGroupName <String> -SubscriptionId <String[]>
...
```
Get-AzGrafanaDashboardDefinition -DefinitionName <String> -DashboardInputObject <IDashboardIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
