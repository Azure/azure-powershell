...
```
New-AzGrafanaManagedPrivateEndpoint -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -WorkspaceName <String> -Location <String> [-GroupId <String[]>] [-PrivateLinkResourceId <String>]
...
```
New-AzGrafanaManagedPrivateEndpoint -Name <String> -GrafanaInputObject <IDashboardIdentity> -Location <String>
