...
online version: https://learn.microsoft.com/powershell/module/az.edgeaction/update-azedgeaction
schema: 2.0.0
---
...
```
Update-AzEdgeAction -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### UpdateViaJsonString
```
Update-AzEdgeAction -Name <String> -ResourceGroupName <String> -JsonString <String> [-SubscriptionId <String>]
...
This command updates the tags on the specified edge action.

### Example 2: Update edge action SKU
```powershell
Update-AzEdgeAction -Name "myEdgeAction" -ResourceGroupName "myResourceGroup" -SkuName "Standard" -SkuTier "Standard"
```

This command updates the SKU configuration of the specified edge action.
