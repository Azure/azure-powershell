...
- `build-module.ps1`
  - Builds the module DLL (`./bin/Az.Hana.private.dll`), creates the exported cmdlets, generates custom cmdlet test stubs, and updates `./Az.Hana.psd1` with Azure profile information.
