...
online version: https://learn.microsoft.com/powershell/module/az.agricultureplatform/remove-azagricultureplatformagriservice
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzAgriculturePlatformAgriService -ResourceGroupName <String> -ResourceName <String>
...
### DeleteViaIdentity
```
Remove-AzAgriculturePlatformAgriService -InputObject <IAgriculturePlatformIdentity>
