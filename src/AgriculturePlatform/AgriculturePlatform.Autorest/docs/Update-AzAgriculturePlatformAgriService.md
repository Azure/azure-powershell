...
online version: https://learn.microsoft.com/powershell/module/az.agricultureplatform/update-azagricultureplatformagriservice
schema: 2.0.0
---
...
```
Update-AzAgriculturePlatformAgriService -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String>] [-DataConnectorCredentials <IDataConnectorCredentialMap[]>]
 [-EnableSystemAssignedIdentity <Boolean?>] [-InstalledSolution <IInstalledSolutionMap[]>]
...
```
Update-AzAgriculturePlatformAgriService -InputObject <IAgriculturePlatformIdentity>
 [-DataConnectorCredentials <IDataConnectorCredentialMap[]>] [-EnableSystemAssignedIdentity <Boolean?>]
