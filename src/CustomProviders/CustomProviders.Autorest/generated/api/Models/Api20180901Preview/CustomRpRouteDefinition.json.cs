namespace Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.Api20180901Preview
{
    ...
    public partial class CustomRpRouteDefinition
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.Api20180901Preview.ICustomRpRouteDefinition.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.Api20180901Preview.ICustomRpRouteDefinition.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.Api20180901Preview.ICustomRpRouteDefinition FromJson(Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonObject json ? new CustomRpRouteDefinition(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CustomRpRouteDefinition" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CustomRpRouteDefinition" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._endpoint)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonString(this._endpoint.ToString()) : null, "endpoint" ,container.Add );
