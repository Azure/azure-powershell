...
namespace Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Support";
