@{
  ...
  FunctionsToExport = 'Get-AzCustomProvider', 'Get-AzCustomProviderAssociation', 'New-AzCustomProvider', 'New-AzCustomProviderAssociation', 'Remove-AzCustomProvider', 'Remove-AzCustomProviderAssociation', 'Set-AzCustomProviderAssociation', 'Update-AzCustomProvider', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
