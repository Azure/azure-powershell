...
namespace Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Support.ProvisioningState Accepted = @"Accepted";

        public static Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Support.ProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Support.ProvisioningState Running = @"Running";

        public static Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
