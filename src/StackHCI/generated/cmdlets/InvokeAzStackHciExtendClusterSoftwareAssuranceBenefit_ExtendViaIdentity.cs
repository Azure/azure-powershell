...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzStackHciExtendClusterSoftwareAssuranceBenefit_ExtendViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzStackHciExtendClusterSoftwareAssuranceBenefit_ExtendViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzStackHciExtendClusterSoftwareAssuranceBenefit_ExtendViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Cmdlets.InvokeAzStackHciExtendClusterSoftwareAssuranceBenefit_ExtendViaIdentity Clone()
        {
            var clone = new InvokeAzStackHciExtendClusterSoftwareAssuranceBenefit_ExtendViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzStackHciExtendClusterSoftwareAssuranceBenefit_ExtendViaIdentity" />
        /// cmdlet class.
        /// </summary>
        public InvokeAzStackHciExtendClusterSoftwareAssuranceBenefit_ExtendViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ClustersExtendSoftwareAssuranceBenefitViaIdentity(InputObject.Id, SoftwareAssuranceChangeRequest, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ClustersExtendSoftwareAssuranceBenefit(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, SoftwareAssuranceChangeRequest, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=SoftwareAssuranceChangeRequest})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=SoftwareAssuranceChangeRequest })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=SoftwareAssuranceChangeRequest })
                    {
