...
* Registration process improvements to Register-AzStackHCI cmdlet
...
* Adding support to register hybridConnectivity RP in Canary and Public clouds
* Support for Region Specific ServiceEndpoints
    -Service endpoints are now specified by HCI Cloud services instead of it being hardcoded in the PS module
* Adding support to specify ArcServerResourceGroupName to Register-AzStackHCI cmdlet
...
* Support for writing event log entries from registration cmdlets
