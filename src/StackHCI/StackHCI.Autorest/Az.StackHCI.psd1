@{
  ...
  FunctionsToExport = 'Add-AzStackHCIVMAttestation', 'Disable-AzStackHCIAttestation', 'Disable-AzStackHCIRemoteSupport', 'Enable-AzStackHCIAttestation', 'Enable-AzStackHCIRemoteSupport', 'Get-AzStackHciArcSetting', 'Get-AzStackHciCluster', 'Get-AzStackHciDeploymentSetting', 'Get-AzStackHciEdgeDevice', 'Get-AzStackHciExtension', 'Get-AzStackHCILogsDirectory', 'Get-AzStackHCIRemoteSupportAccess', 'Get-AzStackHCIRemoteSupportSessionHistory', 'Get-AzStackHciSecuritySetting', 'Get-AzStackHCIVMAttestation', 'Install-AzStackHCIRemoteSupport', 'Invoke-AzStackHciConsentAndInstallDefaultExtension', 'Invoke-AzStackHciExtendClusterSoftwareAssuranceBenefit', 'New-AzStackHciArcSetting', 'New-AzStackHciCluster', 'New-AzStackHciDeploymentSetting', 'New-AzStackHciEdgeDevice', 'New-AzStackHciExtension', 'New-AzStackHciSecuritySetting', 'Register-AzStackHCI', 'Remove-AzStackHciArcSetting', 'Remove-AzStackHciCluster', 'Remove-AzStackHciDeploymentSetting', 'Remove-AzStackHciEdgeDevice', 'Remove-AzStackHciExtension', 'Remove-AzStackHCIRemoteSupport', 'Remove-AzStackHciSecuritySetting', 'Remove-AzStackHCIVMAttestation', 'Set-AzStackHCI', 'Set-AzStackHciClusterRemoteSupport', 'Set-AzStackHciDeploymentSetting', 'Set-AzStackHciEdgeDevice', 'Set-AzStackHciSecuritySetting', 'Start-AzStackHciClusterLogCollection', 'Test-AzStackHciEdgeDevice', 'Unregister-AzStackHCI', 'Update-AzStackHciCluster', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
