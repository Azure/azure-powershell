...
function Remove-AzStackHciVMVirtualNetwork {
    ...
    Write-Warning("Running this command will delete the virtual network.")
    ...
    if ($PSCmdlet.ShouldProcess($PSBoundParameters['Name']) -and ($Force -or $PSCmdlet.ShouldContinue("Delete this virtual network?", "Confirm")))
    {
        if ($PSBoundParameters.ContainsKey("Force")) {
            $null = $PSBoundParameters.Remove("Force")
        }

        Az.StackHciVM.internal\Remove-AzStackHciVMVirtualNetwork @PSBoundParameters
    }
