...
.Link
https://learn.microsoft.com/powershell/module/az.stackhcivm/set-azstackhcivmvirtualnetwork
#>
function Set-AzStackHciVMVirtualNetwork {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.StackHCIVm.private\Set-AzStackHciVMVirtualNetwork_UpdateExpanded';
        }
