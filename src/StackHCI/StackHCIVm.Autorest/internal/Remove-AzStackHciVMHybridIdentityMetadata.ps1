...
.Link
https://learn.microsoft.com/powershell/module/az.stackhcivm/remove-azstackhcivmhybrididentitymetadata
#>
function Remove-AzStackHciVMHybridIdentityMetadata {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.StackHCIVm.private\Remove-AzStackHciVMHybridIdentityMetadata_Delete';
            DeleteViaIdentity = 'Az.StackHCIVm.private\Remove-AzStackHciVMHybridIdentityMetadata_DeleteViaIdentity';
        }
