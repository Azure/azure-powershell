...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.StackHCIVm.private\Remove-AzStackHciVMVirtualNetwork_Delete';
            DeleteViaIdentity = 'Az.StackHCIVm.private\Remove-AzStackHciVMVirtualNetwork_DeleteViaIdentity';
        }
