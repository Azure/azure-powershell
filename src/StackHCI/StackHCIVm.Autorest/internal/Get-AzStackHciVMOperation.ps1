...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Models.Api20.IOperationListResult
.Link
https://learn.microsoft.com/powershell/module/az.stackhcivm/get-azstackhcivmoperation
#>
function Get-AzStackHciVMOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Models.Api20.IOperationListResult])]
