if(($null -eq $TestName) -or ($TestName -contains 'New-AzStackHCIVMVirtualNetwork'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-AzStackHCIVMVirtualNetwork.Recording.json'
