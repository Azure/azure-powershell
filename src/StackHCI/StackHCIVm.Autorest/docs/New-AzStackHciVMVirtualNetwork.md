...
# New-AzStackHciVMVirtualNetwork
...
```
New-AzStackHciVMVirtualNetwork -Name <String> -ResourceGroupName <String> -CustomLocationId <String>
 ...
 [-IpPoolType <String>] [-NetworkType <NetworkTypeEnum>] [-Routes <Hashtable[]>] [-SubnetName <String>]
 [-Subnets <Hashtable[]>] [-Tags <Hashtable>] [-Vlan <Int32>] [-VMSwitchName <String>]
