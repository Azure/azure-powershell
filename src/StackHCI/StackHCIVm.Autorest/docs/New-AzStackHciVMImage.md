...
New-AzStackHciVMImage -Name <String> -ResourceGroupName <String> -CustomLocationId <String> -Location <String>
 ...
 [-ContainerName <String>] [-OSType <OperatingSystemTypes>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
New-AzStackHciVMImage -Name <String> -ResourceGroupName <String> -CustomLocationId <String>
 ...
 [-CloudInitDataSource <CloudInitDataSource>] [-ContainerName <String>] [-OSType <OperatingSystemTypes>]
