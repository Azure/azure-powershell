...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/remove-azstackhcivmhybrididentitymetadata
schema: 2.0.0
---

# Remove-AzStackHciVMHybridIdentityMetadata
...
### Delete (Default)
```
Remove-AzStackHciVMHybridIdentityMetadata -MetadataName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzStackHciVMHybridIdentityMetadata -InputObject <IStackHciVMIdentity> [-DefaultProfile <PSObject>]
