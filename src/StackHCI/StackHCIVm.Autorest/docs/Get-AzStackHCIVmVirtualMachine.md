...
```
Get-AzStackHCIVmVirtualMachine [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
### ByResourceId
```
Get-AzStackHCIVmVirtualMachine -ResourceId <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
