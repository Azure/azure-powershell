...
# Remove-AzStackHciVMVirtualNetwork
...
### ByName (Default)
```
Remove-AzStackHciVMVirtualNetwork [-InputObject <IStackHciVMIdentity>] [-Force] [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ByResourceId
```
Remove-AzStackHciVMVirtualNetwork -ResourceId <String> [-InputObject <IStackHciVMIdentity>] [-Force]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Delete
```
Remove-AzStackHciVMVirtualNetwork -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
