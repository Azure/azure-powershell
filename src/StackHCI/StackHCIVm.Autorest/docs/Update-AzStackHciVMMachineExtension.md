...
```
Update-AzStackHciVMMachineExtension -ExtensionName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-AutoUpgradeMinorVersion] [-ForceUpdateTag <String>] [-ProtectedSetting <IAny>]
 [-Publisher <String>] [-Setting <IAny>] [-Tags <Hashtable>] [-Type <String>] [-TypeHandlerVersion <String>]
...
Update-AzStackHciVMMachineExtension -InputObject <IStackHciVMIdentity> [-AutoUpgradeMinorVersion]
 ...
 [-Tags <Hashtable>] [-Type <String>] [-TypeHandlerVersion <String>] [-DefaultProfile <PSObject>] [-AsJob]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Models.IAny
Parameter Sets: (All)
Aliases:
