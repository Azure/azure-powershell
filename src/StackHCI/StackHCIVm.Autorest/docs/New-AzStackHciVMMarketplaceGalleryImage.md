...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/new-azstackhcivmmarketplacegalleryimage
schema: 2.0.0
---

# New-AzStackHciVMMarketplaceGalleryImage
...
```
New-AzStackHciVMMarketplaceGalleryImage -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-CloudInitDataSource <CloudInitDataSource>] [-ContainerName <String>]
 [-CustomLocationId <String>] [-HyperVGeneration <HyperVGeneration>] [-Offer <String>]
