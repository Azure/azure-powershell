...
### List (Default)
```
Get-AzStackHciVMHybridIdentityMetadata -ResourceGroupName <String> -VirtualMachineName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzStackHciVMHybridIdentityMetadata -MetadataName <String> -ResourceGroupName <String>
