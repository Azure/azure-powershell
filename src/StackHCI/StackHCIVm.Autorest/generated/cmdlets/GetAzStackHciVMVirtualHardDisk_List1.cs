...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListBySubscription=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.AzureStackHCI/virtualHardDisks"
    /// </remarks>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzStackHciVMVirtualHardDisk_List1" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VirtualHardDisksListBySubscription(SubscriptionId, onOk, onDefault, this, Pipeline);
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.VirtualHardDisksListBySubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                    }
                }
            }
        }
