...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.Status Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.Status InProgress = @"InProgress";

        public static Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.Status Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
