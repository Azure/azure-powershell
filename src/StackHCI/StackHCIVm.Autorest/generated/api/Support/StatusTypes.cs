...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.StatusTypes Connected = @"Connected";

        public static Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.StatusTypes Disconnected = @"Disconnected";

        public static Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.StatusTypes Error = @"Error";

        public static Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.StatusTypes Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.StatusTypes InProgress = @"InProgress";

        public static Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.StatusTypes Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.StatusTypes e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.StatusTypes e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.StatusTypes e1, Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.StatusTypes e2)
        {
            return !e2.Equals(e1);
        }
