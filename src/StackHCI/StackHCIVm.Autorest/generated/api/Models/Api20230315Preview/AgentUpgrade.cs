...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Models.Api20230315Preview
{
    ...
    public partial class AgentUpgrade :
        Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Models.Api20230315Preview.IAgentUpgrade,
        Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Models.Api20230315Preview.IAgentUpgradeInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.LastAttemptStatusEnum? _lastAttemptStatus;

        /// <summary>Specifies the status of Agent Upgrade.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.LastAttemptStatusEnum? LastAttemptStatus { get => this._lastAttemptStatus; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Models.Api20230315Preview.IAgentUpgradeInternal.LastAttemptDesiredVersion { get => this._lastAttemptDesiredVersion; set { {_lastAttemptDesiredVersion = value;} } }

        /// <summary>Internal Acessors for LastAttemptMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Models.Api20230315Preview.IAgentUpgradeInternal.LastAttemptMessage { get => this._lastAttemptMessage; set { {_lastAttemptMessage = value;} } }

        /// <summary>Internal Acessors for LastAttemptStatus</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.LastAttemptStatusEnum? Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Models.Api20230315Preview.IAgentUpgradeInternal.LastAttemptStatus { get => this._lastAttemptStatus; set { {_lastAttemptStatus = value;} } }

        /// <summary>Internal Acessors for LastAttemptTimestamp</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Models.Api20230315Preview.IAgentUpgradeInternal.LastAttemptTimestamp { get => this._lastAttemptTimestamp; set { {_lastAttemptTimestamp = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.LastAttemptStatusEnum? LastAttemptStatus { get;  }
        /// <summary>Timestamp of last upgrade attempt</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        /// <summary>Specifies the status of Agent Upgrade.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.LastAttemptStatusEnum? LastAttemptStatus { get; set; }
        /// <summary>Timestamp of last upgrade attempt</summary>
