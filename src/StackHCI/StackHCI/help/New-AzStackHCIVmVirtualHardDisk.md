...
New-AzStackHCIVmVirtualHardDisk -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-StoragePathName <String>] [-StoragePathResourceGroup <String>] [-DiskFileFormat <DiskFileFormat>]
 [-SizeGb <Int64>] [-Dynamic] [-HyperVGeneration <HyperVGeneration>] [-LogicalSectorByte <Int32>]
 [-PhysicalSectorByte <Int32>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf]
