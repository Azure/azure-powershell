...
online version: https://learn.microsoft.com/powershell/module/az.stackhci/remove-azstackhcivmvirtualharddisk
schema: 2.0.0
---
...
```
Remove-AzStackHCIVmVirtualHardDisk [-SubscriptionId <String>] -ResourceId <String> [-Force] [-WhatIf]
