...
online version: https://learn.microsoft.com/powershell/module/az.stackhci/update-azstackhcivmnetworkinterface
schema: 2.0.0
---
...
```
Update-AzStackHCIVmNetworkInterface [-ResourceId <String>] [-Tag <Hashtable>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
