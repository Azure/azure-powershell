...
```
Get-AzStackHCIVmVirtualMachine [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-NoWait] [-WhatIf]
...
Get-AzStackHCIVmVirtualMachine -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-NoWait] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### ByResourceId
```
Get-AzStackHCIVmVirtualMachine -ResourceId <String> [-DefaultProfile <PSObject>] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
