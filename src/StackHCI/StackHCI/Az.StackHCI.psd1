...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added commands for image, virtual hard disk, storager path, logical network, network interface, and virtual machine creations.
