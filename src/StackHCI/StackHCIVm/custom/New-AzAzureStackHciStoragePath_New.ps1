...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AzureStackHCI.Models.Api20221215Preview.IStorageContainers
.Link
https://learn.microsoft.com/powershell/module/az.azurestackhci/new-azazurestackhcistoragecontainer
#>
function New-AzAzureStackHciStoragePath{
...
param(
    ...
    return Az.AzureStackHCI.internal\New-AzAzureStackHciStoragePath @PSBoundParameters
