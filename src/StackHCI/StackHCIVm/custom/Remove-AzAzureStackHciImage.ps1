function Remove-AzAzureStackHciImage{
    ...
    process {
        ...
        if ($PSCmdlet.ParameterSetName -eq "ByName"){
            ...
            {
                return Az.AzureStackHci\Remove-AzAzureStackHciMarketplaceGalleryImage @PSBoundParameters
            }

            if ($isGalleryImage)
            {
                return Az.AzureStackHci\Remove-AzAzureStackHciGalleryImage @PSBoundParameters
            }
