...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AzureStackHCI.Models.Api20221215Preview.INetworkInterfaces
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.azurestackhci/new-azazurestackhcinetworkinterface
#>
function New-AzAzureStackHciNetworkInterface {
...
<# IPCONFIGURATION <IIPConfiguration[]>: IPConfigurations - A list of IPConfigurations of the network interface.
  ...
  [SubnetId <String>]: ID - The ARM resource id in the form of /su #>
    ...
    return Az.AzureStackHCI.internal\New-AzAzureStackHciNetworkInterface @PSBoundParameters
