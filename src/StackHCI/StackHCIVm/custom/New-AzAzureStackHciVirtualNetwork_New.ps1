...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AzureStackHCI.Models.Api20221215Preview.IVirtualNetworks
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.azurestackhci/new-azazurestackhcivirtualnetwork
#>
function New-AzAzureStackHciVirtualNetwork {
...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.AzureStackHCI.Support.NetworkTypeEnum])]
    [Microsoft.Azure.PowerShell.Cmdlets.AzureStackHCI.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AzureStackHCI.Support.NetworkTypeEnum]
    # Type of the network
    ${NetworkType},
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.AzureStackHCI.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AzureStackHCI.Models.Api20221215Preview.IVirtualNetworkPropertiesSubnetsItem[]]
    ...
    return Az.AzureStackHCI.internal\New-AzAzureStackHciVirtualNetwork @PSBoundParameters
}
