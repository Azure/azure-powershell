...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/update-azstackhcivmextension
schema: 2.0.0
---

# Update-AzStackHciVMExtension
...
```
Update-AzStackHciVMExtension -MachineName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### Upgrade
```
Update-AzStackHciVMExtension -MachineName <String> -ResourceGroupName <String>
...
### UpgradeViaIdentity
```
Update-AzStackHciVMExtension -InputObject <IStackHciVMIdentity>
...
```
Update-AzStackHciVMExtension -InputObject <IStackHciVMIdentity> [-ExtensionTarget <Hashtable>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Models.Api20230315Preview.IMachineExtensionUpgrade
