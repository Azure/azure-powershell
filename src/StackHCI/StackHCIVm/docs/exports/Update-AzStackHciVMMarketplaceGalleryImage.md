...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/update-azstackhcivmmarketplacegalleryimage
schema: 2.0.0
---

# Update-AzStackHciVMMarketplaceGalleryImage
...
```
Update-AzStackHciVMMarketplaceGalleryImage -Name <String> -ResourceGroupName <String>
...
```
Update-AzStackHciVMMarketplaceGalleryImage -InputObject <IStackHciVMIdentity> [-Tag <Hashtable>]
