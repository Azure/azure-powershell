...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/set-azstackhcivmvirtualharddisk
schema: 2.0.0
---

# Set-AzStackHciVMVirtualHardDisk
...
```
Set-AzStackHciVMVirtualHardDisk -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-BlockSizeByte <Int32>] [-ContainerId <String>]
 [-DiskFileFormat <DiskFileFormat>] [-DiskSizeGb <Int64>] [-Dynamic] [-ExtendedLocationName <String>]
 [-ExtendedLocationType <ExtendedLocationTypes>] [-HyperVGeneration <HyperVGeneration>]
 [-LogicalSectorByte <Int32>] [-PhysicalSectorByte <Int32>] [-SystemDataCreatedAt <DateTime>]
