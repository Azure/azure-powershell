...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/new-azstackhcivmguestagent
schema: 2.0.0
---

# New-AzStackHciVMGuestAgent
...
```
New-AzStackHciVMGuestAgent -ResourceUri <String> [-CredentialsPassword <String>]
 [-CredentialsUsername <String>] [-ProvisioningAction <ProvisioningAction>] [-SystemDataCreatedAt <DateTime>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Support.ProvisioningAction
Parameter Sets: (All)
Aliases:
