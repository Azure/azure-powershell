...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/remove-azstackhcivmmachineextension
schema: 2.0.0
---

# Remove-AzStackHciVMMachineExtension
...
### Delete (Default)
```
Remove-AzStackHciVMMachineExtension -ExtensionName <String> -MachineName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzStackHciVMMachineExtension -InputObject <IStackHciVMIdentity> [-DefaultProfile <PSObject>] [-AsJob]
