...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/new-azstackhcivmmachine
schema: 2.0.0
---

# New-AzStackHciVMMachine
...
```
New-AzStackHciVMMachine -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-SystemDataLastModifiedBy <String>] [-SystemDataLastModifiedByType <CreatedByType>] [-Tags <Hashtable>]
