...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/set-azstackhcivmstoragecontainer
schema: 2.0.0
---

# Set-AzStackHciVMStorageContainer
...
```
Set-AzStackHciVMStorageContainer -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-ExtendedLocationName <String>] [-ExtendedLocationType <ExtendedLocationTypes>]
 [-Path <String>] [-SystemDataCreatedAt <DateTime>] [-SystemDataCreatedBy <String>]
