...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/set-azstackhcivmnetworkinterface
schema: 2.0.0
---

# Set-AzStackHciVMNetworkInterface
...
```
Set-AzStackHciVMNetworkInterface -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-DnsSettingDnsServer <String[]>] [-ExtendedLocationName <String>]
 [-ExtendedLocationType <ExtendedLocationTypes>] [-IPConfiguration <IIPConfiguration[]>]
 [-MacAddress <String>] [-SystemDataCreatedAt <DateTime>] [-SystemDataCreatedBy <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.StackHCIVm.Models.Api20230901Preview.IIPConfiguration[]
Parameter Sets: (All)
Aliases:
