...
### [Get-AzStackHciVMAgentVersion](Get-AzStackHciVMAgentVersion.md)
Gets an Agent Version along with the download link currently present.

### [Get-AzStackHciVMExtensionMetadata](Get-AzStackHciVMExtensionMetadata.md)
...
### [Get-AzStackHciVMMachine](Get-AzStackHciVMMachine.md)
Retrieves information about the model view or the instance view of a hybrid machine.

### [Get-AzStackHciVMMachineExtension](Get-AzStackHciVMMachineExtension.md)
The operation to get the extension.

### [Get-AzStackHciVMNetworkInterface](Get-AzStackHciVMNetworkInterface.md)
Gets a network interface

### [Get-AzStackHciVMNetworkProfile](Get-AzStackHciVMNetworkProfile.md)
...
### [New-AzStackHciVMMachine](New-AzStackHciVMMachine.md)
The operation to create or update a hybrid machine.
Please note some properties can be set only during machine creation.

### [New-AzStackHciVMMachineExtension](New-AzStackHciVMMachineExtension.md)
...
### [Remove-AzStackHciVMMachine](Remove-AzStackHciVMMachine.md)
The operation to delete a hybrid machine.

### [Remove-AzStackHciVMMachineExtension](Remove-AzStackHciVMMachineExtension.md)
...
### [Set-AzStackHciVMMachine](Set-AzStackHciVMMachine.md)
The operation to create or update a hybrid machine.
Please note some properties can be set only during machine creation.

### [Set-AzStackHciVMMachineExtension](Set-AzStackHciVMMachineExtension.md)
The operation to create or update the extension.
...
### [Set-AzStackHciVMVirtualMachineInstance](Set-AzStackHciVMVirtualMachineInstance.md)
...
### [Update-AzStackHciVMExtension](Update-AzStackHciVMExtension.md)
...
### [Update-AzStackHciVMMachine](Update-AzStackHciVMMachine.md)
The operation to update a hybrid machine.

### [Update-AzStackHciVMMachineExtension](Update-AzStackHciVMMachineExtension.md)
The operation to create or update the extension.
