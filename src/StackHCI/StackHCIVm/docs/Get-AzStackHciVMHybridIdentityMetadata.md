...
### Get1
```
Get-AzStackHciVMHybridIdentityMetadata -MachineName <String> -MetadataName <String>
...
### List1
```
Get-AzStackHciVMHybridIdentityMetadata -MachineName <String> -ResourceGroupName <String>
