...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/new-azstackhcivmmachineextension
schema: 2.0.0
---

# New-AzStackHciVMMachineExtension
...
```
New-AzStackHciVMMachineExtension -ExtensionName <String> -MachineName <String> -ResourceGroupName <String>
 ...
 [-SystemDataLastModifiedByType <CreatedByType>] [-Tags <Hashtable>] [-TypeHandlerVersion <String>]
