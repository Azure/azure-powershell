...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/update-azstackhcivmmachineextension
schema: 2.0.0
---

# Update-AzStackHciVMMachineExtension
...
```
Update-AzStackHciVMMachineExtension -ExtensionName <String> -MachineName <String> -ResourceGroupName <String>
...
```
Update-AzStackHciVMMachineExtension -InputObject <IStackHciVMIdentity> [-AutoUpgradeMinorVersion]
 [-EnableAutomaticUpgrade] [-ForceUpdateTag <String>] [-ProtectedSetting <Hashtable>] [-Publisher <String>]
