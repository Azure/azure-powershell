...
namespace Microsoft.Azure.Management.Blueprint.Models
{
    ...
    public partial class PublishedBlueprint : AzureResourceBase
    {
        ...
        /// <param name="blueprintName">Name of the published blueprint definition.
        /// </param>

        /// <param name="changeNotes">Version-specific change notes.
        /// </param>
        public PublishedBlueprint(string id = default(string), string type = default(string), string name = default(string), string displayName = default(string), string description = default(string), BlueprintStatus status = default(BlueprintStatus), string targetScope = default(string), System.Collections.Generic.IDictionary<string, ParameterDefinition> parameters = default(System.Collections.Generic.IDictionary<string, ParameterDefinition>), System.Collections.Generic.IDictionary<string, ResourceGroupDefinition> resourceGroups = default(System.Collections.Generic.IDictionary<string, ResourceGroupDefinition>), string blueprintName = default(string), string changeNotes = default(string))
        ...
        public virtual void Validate()
        {
            ...
            {
                if (this.ChangeNotes.Length > 500)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.MaxLength, "ChangeNotes", 500);
                }
            }
        }
    }
