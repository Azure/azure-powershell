...
namespace Microsoft.Azure.Management.Blueprint.Models
{
    ...
    /// </summary>
    public partial class AssignmentProperties : BlueprintResourcePropertiesBaseAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the AssignmentProperties class.
        /// </summary>
        ...
        public AssignmentProperties(System.Collections.Generic.IDictionary<string, ParameterValue> parameters, System.Collections.Generic.IDictionary<string, ResourceGroupValue> resourceGroups, string displayName = default(string), string description = default(string), string blueprintId = default(string), string scope = default(string), AssignmentStatus status = default(AssignmentStatus), AssignmentLockSettings locks = default(AssignmentLockSettings), string provisioningState = default(string))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "blueprintId")]
        ...
        /// locked.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "locks")]
