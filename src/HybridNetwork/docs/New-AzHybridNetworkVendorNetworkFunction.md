...
online version: https://docs.microsoft.com/powershell/module/az.hybridnetwork/new-azhybridnetworkvendornetworkfunction
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-AzHybridNetworkVendorNetworkFunction -InputObject <IHybridNetworkIdentity>
