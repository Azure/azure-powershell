...
online version: https://docs.microsoft.com/powershell/module/az.hybridnetwork/set-azhybridnetworkvendornetworkfunction
schema: 2.0.0
---

# Set-AzHybridNetworkVendorNetworkFunction
...
```
Set-AzHybridNetworkVendorNetworkFunction -LocationName <String> -ServiceKey <String> -VendorName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20210501.INetworkFunctionVendorConfiguration[]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20210501.IVendorNetworkFunction
...
### Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20210501.IVendorNetworkFunction
