...
online version: https://docs.microsoft.com/powershell/module/az.hybridnetwork/set-azhybridnetworkvendorsku
schema: 2.0.0
---

# Set-AzHybridNetworkVendorSku
...
```
Set-AzHybridNetworkVendorSku -SkuName <String> -VendorName <String> [-SubscriptionId <String>]
...
### Update
```
Set-AzHybridNetworkVendorSku -SkuName <String> -VendorName <String> -Parameter <IVendorSku>
