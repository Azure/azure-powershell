...
online version: https://docs.microsoft.com/powershell/module/az.hybridnetwork/new-azhybridnetworkvendorsku
schema: 2.0.0
---
...
### Create
```
New-AzHybridNetworkVendorSku -SkuName <String> -VendorName <String> -Parameter <IVendorSku>
...
### CreateViaIdentity
```
New-AzHybridNetworkVendorSku -InputObject <IHybridNetworkIdentity> -Parameter <IVendorSku>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzHybridNetworkVendorSku -InputObject <IHybridNetworkIdentity> [-DeploymentMode <SkuDeploymentMode>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20210501.INetworkFunctionRoleConfiguration[]
Parameter Sets: CreateExpanded, CreateViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20210501.IVendorSku
