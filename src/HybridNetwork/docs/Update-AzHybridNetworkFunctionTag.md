...
online version: https://docs.microsoft.com/powershell/module/az.hybridnetwork/update-azhybridnetworkfunctiontag
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-AzHybridNetworkFunctionTag -InputObject <IHybridNetworkIdentity> -Parameter <ITagsObject>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20210501.ITagsObject
...
### Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20210501.ITagsObject
