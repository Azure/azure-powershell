...
online version: https://learn.microsoft.com/powershell/module/az.appnetwork/new-azappnetworkapplinkmember
schema: 2.0.0
---
...
```
New-AzAppNetworkAppLinkMember -AppLinkName <String> -Name <String> -ResourceGroupName <String>
...
```
New-AzAppNetworkAppLinkMember -AppLinkInputObject <IAppNetworkIdentity> -Name <String> -Location <String>
