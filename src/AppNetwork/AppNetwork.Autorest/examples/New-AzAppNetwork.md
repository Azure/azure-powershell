...
```powershell
New-AzAppNetwork -Name appnet-test-01 -ResourceGroupName test_rg -Location westus2
```
...
```powershell
New-AzAppNetwork -Name appnet-test-01 -ResourceGroupName test_rg -Location westus2 -EnableSystemAssignedIdentity
```
