...
```
New-AzAppNetworkAppLinkMember -Name <String> -AppLinkName <String> -ResourceGroupName <String>
...
```
New-AzAppNetworkAppLinkMember -Name <String> -AppLinkInputObject <IAppNetworkIdentity> -Location <String>
