#
# Module manifest for module 'Az.PostgreSqlFlexibleServer'
#
# Generated by: Microsoft Corporation
#
# Generated on: 01/22/2026
#
...
Description = 'Microsoft Azure PowerShell: PostgreSqlFlexibleServer cmdlets'
...
RequiredAssemblies = 
               'PostgreSQLFlexibleServer.Autorest/bin/Az.PostgreSqlFlexibleServer.private.dll'
...
FormatsToProcess = 
               'PostgreSQLFlexibleServer.Autorest/Az.PostgreSqlFlexibleServer.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('PostgreSQLFlexibleServer.Autorest/Az.PostgreSqlFlexibleServer.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Get-AzPostgreSqlFlexibleServer', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Azure', 'ResourceManager', 'ARM', 'PSModule', 'PostgreSqlFlexibleServer'
