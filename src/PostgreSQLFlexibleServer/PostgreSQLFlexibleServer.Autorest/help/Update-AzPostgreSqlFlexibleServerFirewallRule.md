...
```
Update-AzPostgreSqlFlexibleServerFirewallRule -FlexibleServerInputObject <IPostgreSqlFlexibleServerIdentity>
 -Name <String> [-EndIPAddress <String>] [-StartIPAddress <String>] [-DefaultProfile <PSObject>] [-AsJob]
