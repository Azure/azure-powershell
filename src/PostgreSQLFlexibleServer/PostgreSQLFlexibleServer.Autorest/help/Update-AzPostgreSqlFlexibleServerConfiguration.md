...
```
Update-AzPostgreSqlFlexibleServerConfiguration -FlexibleServerInputObject <IPostgreSqlFlexibleServerIdentity>
 -Name <String> [-Source <String>] [-Value <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
