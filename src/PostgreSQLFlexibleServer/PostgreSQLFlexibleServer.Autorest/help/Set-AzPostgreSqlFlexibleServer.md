...
```
Set-AzPostgreSqlFlexibleServer -Name <String> -ResourceGroupName <String> -Location <String>
...
```
Set-AzPostgreSqlFlexibleServer -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### UpdateViaJsonString
```
Set-AzPostgreSqlFlexibleServer -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
