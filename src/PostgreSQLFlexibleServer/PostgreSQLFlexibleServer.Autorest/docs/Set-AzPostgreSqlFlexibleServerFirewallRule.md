...
online version: https://learn.microsoft.com/powershell/module/az.postgresqlflexibleserver/set-azpostgresqlflexibleserverfirewallrule
schema: 2.0.0
---

# Set-AzPostgreSqlFlexibleServerFirewallRule
...
```
Set-AzPostgreSqlFlexibleServerFirewallRule -Name <String> -ResourceGroupName <String> -ServerName <String>
