...
### Example 1: Update max_connections parameter
```powershell
Update-AzPostgreSqlFlexibleServerConfiguration -ResourceGroupName "myResourceGroup" -ServerName "myPostgreSqlServer" -Name "max_connections" -Value "200"
```
...
### Example 2: Update a configuration requiring restart
```powershell
Update-AzPostgreSqlFlexibleServerConfiguration -ResourceGroupName "production-rg" -ServerName "prod-postgresql-01" -Name "shared_preload_libraries" -Value "pg_stat_statements"
```
...
Updates the shared_preload_libraries parameter. This change requires a server restart to take effect.
