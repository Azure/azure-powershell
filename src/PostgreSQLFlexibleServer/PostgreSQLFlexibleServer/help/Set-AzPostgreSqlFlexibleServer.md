...
online version: https://learn.microsoft.com/powershell/module/az.postgresqlflexibleserver/set-azpostgresqlflexibleserver
schema: 2.0.0
---

# Set-AzPostgreSqlFlexibleServer
...
```
Set-AzPostgreSqlFlexibleServer -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Location <String> [-AdministratorLogin <String>] [-AdministratorLoginPassword <SecureString>]
