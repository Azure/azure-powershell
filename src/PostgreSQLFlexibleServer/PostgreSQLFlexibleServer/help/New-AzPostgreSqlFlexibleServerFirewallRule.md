...
```
New-AzPostgreSqlFlexibleServerFirewallRule -Name <String>
 -FlexibleServerInputObject <IPostgreSqlFlexibleServerIdentity> -EndIPAddress <String> -StartIPAddress <String>
