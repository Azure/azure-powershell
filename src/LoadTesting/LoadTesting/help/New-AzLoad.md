...
New-AzLoad -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] -Location <String>
 [-EncryptionIdentity <String>] [-EnableSystemAssignedIdentity] [-EncryptionKey <String>] [-Tag <Hashtable>]
...
```
New-AzLoad -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] -JsonFilePath <String>
...
### CreateViaJsonString
```
New-AzLoad -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] -JsonString <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
