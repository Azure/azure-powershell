...
namespace Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.Api20221201
{
    ...
    public partial class CheckQuotaAvailabilityResponseProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.Json.JsonObject into a new instance of <see cref="CheckQuotaAvailabilityResponseProperties" />.
        /// </summary>
        ...
        internal CheckQuotaAvailabilityResponseProperties(Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.Json.JsonObject json)
        {
            ...
            {_isAvailable = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.Json.JsonBoolean>("isAvailable"), out var __jsonIsAvailable) ? (bool?)__jsonIsAvailable : IsAvailable;}
            {_availabilityStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.Json.JsonString>("availabilityStatus"), out var __jsonAvailabilityStatus) ? (string)__jsonAvailabilityStatus : (string)AvailabilityStatus;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.Api20221201.ICheckQuotaAvailabilityResponseProperties.
        /// </summary>
        ...
        /// <summary>
        /// Serializes this instance of <see cref="CheckQuotaAvailabilityResponseProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CheckQuotaAvailabilityResponseProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
