...
Module Name: Az.Dell
online version: https://learn.microsoft.com/powershell/module/az.dell/remove-azdellfilesystem
schema: 2.0.0
---

# Remove-AzDellFileSystem
...
### Delete (Default)
```
Remove-AzDellFileSystem -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzDellFileSystem -InputObject <IDellIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
