...
### List (Default)
```
Get-AzDellFileSystem [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-AzDellFileSystem -InputObject <IDellIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
