...
online version: https://docs.microsoft.com/powershell/module/az.reservations/invoke-azreservationsexchange
schema: 2.0.0
---

# Invoke-AzReservationsExchange
...
```
Invoke-AzReservationsExchange [-SessionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Post
```
Invoke-AzReservationsExchange -Body <IExchangeRequest> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
