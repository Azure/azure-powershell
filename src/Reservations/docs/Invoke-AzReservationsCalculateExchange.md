...
online version: https://docs.microsoft.com/powershell/module/az.reservations/invoke-azreservationscalculateexchange
schema: 2.0.0
---

# Invoke-AzReservationsCalculateExchange
...
```
Invoke-AzReservationsCalculateExchange [-ReservationsToExchange <IReservationToReturn[]>]
...
### Post
```
Invoke-AzReservationsCalculateExchange -Body <ICalculateExchangeRequest> [-DefaultProfile <PSObject>] [-AsJob]
