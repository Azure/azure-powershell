...
Describe 'Get-AzReservationAvailableScope' {
    ...
    It 'Available' {
        ...
        $response = Get-AzReservationAvailableScope -ReservationId "10000000-aaaa-bbbb-cccc-100000000001" -ReservationOrderId "50000000-aaaa-bbbb-cccc-100000000003" -JsonString $param
