...
Describe 'Invoke-AzReservationReturn' {
    ...
    It 'Post' {
        ...
        $jsonString = "Id=/providers/microsoft.capacity/reservationOrders/984f6907-4d2c-4411-a5d9-0e2e72d0e06a;ReservationToReturnQuantity=1;ReservationToReturnReservationId=/providers/microsoft.capacity/reservationOrders/984f6907-4d2c-4411-a5d9-0e2e72d0e06a/reservations/e188ea59-e105-493f-86be-64b4af4907a7;Scope=Reservation"
        $res = Invoke-AzReservationCalculateRefund -ReservationOrderId $orderId -JsonString $jsonString
        $res | Should -Not -Be $null
        $res.SessionId | Should -Not -Be $null

        $jsonString2 = "ReservationToReturnQuantity=1;ReservationToReturnReservationId=/providers/microsoft.capacity/reservationOrders/984f6907-4d2c-4411-a5d9-0e2e72d0e06a/reservations/e188ea59-e105-493f-86be-64b4af4907a7;Scope=Reservation;ReturnReason=Sample reason;SessionId=$($res.SessionId)"

        $response = Invoke-AzReservationReturn -ReservationOrderId $orderId -JsonString $jsonString2
        ExecuteTestCases($response)
    }
