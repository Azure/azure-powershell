...
namespace Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301
{
    ...
    public partial class ReservationMergeProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IReservationMergeProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IReservationMergeProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IReservationMergeProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject json ? new ReservationMergeProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject into a new instance of <see cref="ReservationMergeProperties" />.
        /// </summary>
        ...
        internal ReservationMergeProperties(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject json)
        {
            ...
            {_mergeDestination = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonString>("mergeDestination"), out var __jsonMergeDestination) ? (string)__jsonMergeDestination : (string)MergeDestination;}
            {_mergeSources = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonArray>("mergeSources"), out var __jsonMergeSources) ? If( __jsonMergeSources as Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : MergeSources;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="ReservationMergeProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ReservationMergeProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._mergeDestination)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonString(this._mergeDestination.ToString()) : null, "mergeDestination" ,container.Add );
            if (null != this._mergeSources)
            {
                var __w = new Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.XNodeArray();
                foreach( var __x in this._mergeSources )
                {
