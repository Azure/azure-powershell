...
namespace Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301
{
    ...
    public partial class PatchPropertiesRenewProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IPatchPropertiesRenewProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IPatchPropertiesRenewProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IPatchPropertiesRenewProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject json ? new PatchPropertiesRenewProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject into a new instance of <see cref="PatchPropertiesRenewProperties" />.
        /// </summary>
        ...
        internal PatchPropertiesRenewProperties(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject json)
        {
            ...
            {_purchaseProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject>("purchaseProperties"), out var __jsonPurchaseProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.PurchaseRequest.FromJson(__jsonPurchaseProperties) : PurchaseProperty;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PatchPropertiesRenewProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PatchPropertiesRenewProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._purchaseProperty ? (Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode) this._purchaseProperty.ToJson(null,serializationMode) : null, "purchaseProperties" ,container.Add );
