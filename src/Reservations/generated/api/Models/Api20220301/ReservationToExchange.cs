...
namespace Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301
{
    ...
    public partial class ReservationToExchange :
        Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IReservationToExchange,
        Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IReservationToExchangeInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IBillingInformation _billingInformation;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IBillingInformation BillingInformation { get => (this._billingInformation = this._billingInformation ?? new Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.BillingInformation()); set => this._billingInformation = value; }

        /// <summary>Backing field for <see cref="BillingRefundAmount" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IPrice _billingRefundAmount;

        [Microsoft.Azure.PowerShell.Cmdlets.Reservations.Origin(Microsoft.Azure.PowerShell.Cmdlets.Reservations.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IPrice BillingRefundAmount { get => (this._billingRefundAmount = this._billingRefundAmount ?? new Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.Price()); set => this._billingRefundAmount = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IBillingInformation) })]
        Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IBillingInformation BillingInformation { get; set; }
