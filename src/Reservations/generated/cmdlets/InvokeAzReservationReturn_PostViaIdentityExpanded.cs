...
namespace Microsoft.Azure.PowerShell.Cmdlets.Reservations.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Post=>POST:"/providers/Microsoft.Capacity/reservationOrders/{reservationOrderId}/return"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzReservationReturn_PostViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IRefundResponse))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Reservations.Description(@"Return a reservation.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Reservations.Generated]
    public partial class InvokeAzReservationReturn_PostViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IRefundRequest _body = new Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.RefundRequest();
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IReservationsIdentity _inputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IReservationsIdentity InputObject { get => this._inputObject; set => this._inputObject = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Quantity to be returned. Must be greater than zero.")]
        ...
        public int ReservationToReturnQuantity { get => _body.ReservationToReturnQuantity ?? default(int); set => _body.ReservationToReturnQuantity = value; }

        /// <summary>Fully qualified identifier of the Reservation being returned</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Fully qualified identifier of the Reservation being returned")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Reservations.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Reservations.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string ReservationToReturnReservationId { get => _body.ReservationToReturnReservationId ?? null; set => _body.ReservationToReturnReservationId = value; }

        /// <summary>The reason of returning the reservation</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The reason of returning the reservation")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Reservations.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Reservations.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ReturnReason { get => _body.ReturnReason ?? null; set => _body.ReturnReason = value; }

        /// <summary>The scope of the refund, e.g. Reservation</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The scope of the refund, e.g. Reservation")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Reservations.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Reservations.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Scope { get => _body.Scope ?? null; set => _body.Scope = value; }

        /// <summary>SessionId that was returned by CalculateRefund API.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "SessionId that was returned by CalculateRefund API.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Reservations.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Reservations.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SessionId { get => _body.SessionId ?? null; set => _body.SessionId = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IRefundResponse">Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IRefundResponse</see>
        ...
        partial void overrideOnAccepted(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IRefundResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzReservationReturn_PostViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public InvokeAzReservationReturn_PostViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ReturnPost' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ReturnPostViaIdentity(InputObject.Id, _body, onAccepted, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ReturnPost(InputObject.ReservationOrderId ?? null, _body, onAccepted, onDefault, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onAccepted(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IRefundResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20220301.IRefundResponse
