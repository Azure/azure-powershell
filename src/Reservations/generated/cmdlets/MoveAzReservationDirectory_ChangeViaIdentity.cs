...
namespace Microsoft.Azure.PowerShell.Cmdlets.Reservations.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Move, @"AzReservationDirectory_ChangeViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class MoveAzReservationDirectory_ChangeViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20221101.IChangeDirectoryRequest _body;

        /// <summary>Request body for change directory of a reservation.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Request body for change directory of a reservation.", ValueFromPipeline = true)]
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20221101.IChangeDirectoryRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20221101.IChangeDirectoryRequest Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="MoveAzReservationDirectory_ChangeViaIdentity" /> cmdlet class.
        /// </summary>
        public MoveAzReservationDirectory_ChangeViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ReservationOrderChangeDirectoryViaIdentity(InputObject.Id, Body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ReservationOrderChangeDirectory(InputObject.ReservationOrderId ?? null, Body, onOk, onDefault, this, Pipeline);
                    }
