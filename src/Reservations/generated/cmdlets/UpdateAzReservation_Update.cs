...
namespace Microsoft.Azure.PowerShell.Cmdlets.Reservations.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzReservation_Update", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzReservation_Update : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20221101.IPatch _reservation;

        /// <summary>The request for reservation patch</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The request for reservation patch", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The request for reservation patch",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20221101.IPatch) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20221101.IPatch Reservation { get => this._reservation; set => this._reservation = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzReservation_Update</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Reservations.Cmdlets.UpdateAzReservation_Update Clone()
        {
            var clone = new UpdateAzReservation_Update();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ReservationUpdate(OrderId, Id, Reservation, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  OrderId=OrderId,Id=Id,body=Reservation})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzReservation_Update" /> cmdlet class.
        /// </summary>
        public UpdateAzReservation_Update()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Api20221101.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { OrderId=OrderId, Id=Id, body=Reservation })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { OrderId=OrderId, Id=Id, body=Reservation })
                    {
