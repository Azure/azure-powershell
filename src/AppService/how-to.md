...
- `build-module.ps1`
  - Builds the module DLL (`./bin/Az.AppService.private.dll`), creates the exported cmdlets, generates custom cmdlet test stubs, and updates `./Az.AppService.psd1` with Azure profile information.
