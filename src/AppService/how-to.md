...
- `build-module.ps1`
  - Builds the module DLL (`./bin/Az.WebSite.private.dll`), creates the exported cmdlets, generates custom cmdlet test stubs, and updates `./Az.WebSite.psd1` with Azure profile information.
