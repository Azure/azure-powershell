function New-AzWebAppPublishingPassword_GenerateBySiteObject {
    [OutputType('System.Boolean')]
    [CmdletBinding(PositionalBinding=$false, SupportsShouldProcess)]
    [Microsoft.Azure.PowerShell.Cmdlets.AppService.Profile('latest-2019-04-30')]
    [Microsoft.Azure.PowerShell.Cmdlets.AppService.Description('Generates a new publishing password for an app (or deployment slot, if specified).')]
    param(
    ...
    process {
        ...
        Az.WebSite\New-AzWebAppPublishingPassword-AzWebApp @PSBoundParameters
    }
}