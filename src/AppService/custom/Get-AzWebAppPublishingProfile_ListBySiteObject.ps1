function Get-AzWebAppPublishingProfile_ListBySiteObject {
    ...
    param(
        ...
        [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.AppService.Support.PublishingProfileFormat])]
        [Microsoft.Azure.PowerShell.Cmdlets.AppService.Category('Body')]
        [Microsoft.Azure.PowerShell.Cmdlets.AppService.Support.PublishingProfileFormat]
        ${Format},
