function Stop-AzWebApp_StopBySiteObject {
    [OutputType('System.Boolean')]
    [CmdletBinding(PositionalBinding=$false, SupportsShouldProcess)]
    [Microsoft.Azure.PowerShell.Cmdlets.AppService.Profile('latest-2019-04-30')]
    [Microsoft.Azure.PowerShell.Cmdlets.AppService.Description('Stops an app (or deployment slot, if specified).')]
    param(
    ...
    process {
        ...
        Az.WebSite\Stop-AzWebApp @PSBoundParameters
    }
}