function Remove-AzWebAppBackup_DeleteBySiteObject {
    [OutputType('System.Boolean')]
    [CmdletBinding(PositionalBinding=$false, SupportsShouldProcess)]
    [Microsoft.Azure.PowerShell.Cmdlets.AppService.Profile('latest-2019-04-30')]
    [Microsoft.Azure.PowerShell.Cmdlets.AppService.Description('Deletes a backup of an app by its ID.')]
    param(
        [Parameter(Mandatory, HelpMessage='ID of the backup.')]
    ...
    process {
        ...
        Az.WebSite\Remove-AzWebAppBackup @PSBoundParameters
    }
}