...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappslot
schema: 2.0.0
---
...
### Update (Default)
```
Set-AzWebAppSlot -Name <String> -ResourceGroupName <String> -Slot <String> -SubscriptionId <String>
...
```
Set-AzWebAppSlot -InputObject <IWebSiteIdentity> [-ClientAffinityEnabled <Boolean>]
...
### UpdateViaIdentity
```
Set-AzWebAppSlot -InputObject <IWebSiteIdentity> [-SiteEnvelope <ISite>] [-DefaultProfile <PSObject>] [-AsJob]
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappslot](https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappslot)
