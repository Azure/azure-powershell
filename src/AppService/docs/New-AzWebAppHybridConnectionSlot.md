...
```
New-AzWebAppHybridConnectionSlot [-RelayName <String>] -InputObject <IWebSiteIdentity> [-Hostname <String>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/new-azwebapphybridconnectionslot](https://docs.microsoft.com/en-us/powershell/module/az.website/new-azwebapphybridconnectionslot)
