...
# Get-AzAppServiceEnvironmentMultiRoleMetric
...
```
Get-AzAppServiceEnvironmentMultiRoleMetric -Name <String> -ResourceGroupName <String>
 -SubscriptionId <String[]> [-Detail <Boolean>] [-EndTime <String>] [-Filter <String>] [-StartTime <String>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/get-azappserviceenvironmentmultirolemetric](https://docs.microsoft.com/en-us/powershell/module/az.website/get-azappserviceenvironmentmultirolemetric)
