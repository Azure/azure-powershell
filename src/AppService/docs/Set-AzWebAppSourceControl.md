...
Set-AzWebAppSourceControl -Name <String> -ResourceGroupName <String> -SubscriptionId <String>
 [-SiteSourceControl <ISiteSourceControl>] [-DefaultProfile <PSObject>] [-AsJob] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Set-AzWebAppSourceControl -Name <String> -ResourceGroupName <String> -SubscriptionId <String>
 ...
 [-IsMercurial <Boolean>] [-Kind <String>] [-RepoUrl <String>] [-DefaultProfile <PSObject>] [-AsJob] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-AzWebAppSourceControl -InputObject <IWebSiteIdentity> [-Branch <String>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappsourcecontrol](https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappsourcecontrol)
