...
```
Set-AzWebAppRelayServiceConnection [-EntityName <String>] -InputObject <IWebSiteIdentity>
...
Set-AzWebAppRelayServiceConnection -EntityName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-ResourceType <String>] [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebapprelayserviceconnection](https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebapprelayserviceconnection)
