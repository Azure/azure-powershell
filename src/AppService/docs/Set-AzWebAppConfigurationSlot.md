...
```
Set-AzWebAppConfigurationSlot -InputObject <IWebSiteIdentity> [-ActionMinProcessExecutionTime <String>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappconfigurationslot](https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappconfigurationslot)
