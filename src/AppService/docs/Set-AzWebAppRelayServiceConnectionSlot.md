...
```
Set-AzWebAppRelayServiceConnectionSlot [-EntityName <String>] -InputObject <IWebSiteIdentity>
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebapprelayserviceconnectionslot](https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebapprelayserviceconnectionslot)
