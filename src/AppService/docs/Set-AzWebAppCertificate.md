...
```
Set-AzWebAppCertificate -InputObject <IWebSiteIdentity> [-HostName <String[]>]
...
### UpdateViaIdentity
```
Set-AzWebAppCertificate -InputObject <IWebSiteIdentity> [-Envelope <ICertificate>] [-DefaultProfile <PSObject>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappcertificate](https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappcertificate)
