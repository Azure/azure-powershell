...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/new-azwebappvnetconnectiongatewayslot
schema: 2.0.0
---

# New-AzWebAppVnetConnectionGatewaySlot
...
### Create (Default)
```
New-AzWebAppVnetConnectionGatewaySlot -GatewayName <String> -Name <String> -ResourceGroupName <String>
...
```
New-AzWebAppVnetConnectionGatewaySlot [-VnetName <String>] -InputObject <IWebSiteIdentity> [-Kind <String>]
 -VpnPackageUri <String> [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzWebAppVnetConnectionGatewaySlot -InputObject <IWebSiteIdentity> [-ConnectionEnvelope <IVnetGateway>]
 [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/new-azwebappvnetconnectiongatewayslot](https://docs.microsoft.com/en-us/powershell/module/az.website/new-azwebappvnetconnectiongatewayslot)
