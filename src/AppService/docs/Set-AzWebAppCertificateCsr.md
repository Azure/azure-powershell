...
```
Set-AzWebAppCertificateCsr [-Name <String>] -InputObject <IWebSiteIdentity> [-CsrString <String>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappcertificatecsr](https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappcertificatecsr)
