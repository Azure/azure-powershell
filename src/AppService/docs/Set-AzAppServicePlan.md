...
### UpdateExpanded
```
Set-AzAppServicePlan -Name <String> -ResourceGroupName <String> -SubscriptionId <String> [-Capacity <Int32>]
...
```
Set-AzAppServicePlan -InputObject <IWebSiteIdentity> [-Capacity <Int32>] [-FreeOfferExpirationTime <DateTime>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/set-azappserviceplan](https://docs.microsoft.com/en-us/powershell/module/az.website/set-azappserviceplan)
