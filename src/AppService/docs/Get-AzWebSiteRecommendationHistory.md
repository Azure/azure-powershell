...
Get-AzWebSiteRecommendationHistory -ResourceGroupName <String> -SubscriptionId <String[]>
 -HostingEnvironmentName <String> [-ExpiredOnly <Boolean>] [-Filter <String>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
Get-AzWebSiteRecommendationHistory -ResourceGroupName <String> -SubscriptionId <String[]> -SiteName <String>
 [-ExpiredOnly <Boolean>] [-Filter <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/get-azwebsiterecommendationhistory](https://docs.microsoft.com/en-us/powershell/module/az.website/get-azwebsiterecommendationhistory)
