...
### List (Default)
```
Get-AzWebSiteDiagnosticSiteAnalysis -DiagnosticCategory <String> -ResourceGroupName <String> -SiteName <String>
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/get-azwebsitediagnosticsiteanalysis](https://docs.microsoft.com/en-us/powershell/module/az.website/get-azwebsitediagnosticsiteanalysis)
