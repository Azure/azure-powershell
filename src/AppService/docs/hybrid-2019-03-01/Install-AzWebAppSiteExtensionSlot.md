...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/install-azwebappsiteextensionslot
schema: 2.0.0
---
...
### InstallViaIdentity
```
Install-AzWebAppSiteExtensionSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-AsJob]
