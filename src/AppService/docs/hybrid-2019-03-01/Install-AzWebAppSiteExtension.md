...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/install-azwebappsiteextension
schema: 2.0.0
---
...
### InstallViaIdentity
```
Install-AzWebAppSiteExtension -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-AsJob]
