...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappinstancefunctionslot
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppInstanceFunctionSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
