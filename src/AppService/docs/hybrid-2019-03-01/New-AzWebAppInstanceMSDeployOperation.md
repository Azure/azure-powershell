...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/new-azwebappinstancemsdeployoperation
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-AzWebAppInstanceMSDeployOperation -InputObject <IAppServiceIdentity> -MSDeploy <IMSDeploy>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzWebAppInstanceMSDeployOperation -InputObject <IAppServiceIdentity> [-AppOffline]
