...
```
Set-AzAppServicePlan -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
...
### Update
```
Set-AzAppServicePlan -Name <String> -ResourceGroupName <String> -AppServicePlan <IAppServicePlan>
