...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azappservicediagnosticsitedetectorslot
schema: 2.0.0
---

# Get-AzAppServiceDiagnosticSiteDetectorSlot
...
### GetViaIdentity
```
Get-AzAppServiceDiagnosticSiteDetectorSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20160301.IDetectorDefinition
