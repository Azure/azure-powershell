...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/start-azwebappwebsitenetworktraceoperation
schema: 2.0.0
---
...
### Start (Default)
```
Start-AzWebAppWebSiteNetworkTraceOperation -Name <String> -ResourceGroupName <String>
...
### StartViaIdentity
```
Start-AzWebAppWebSiteNetworkTraceOperation -InputObject <IAppServiceIdentity> [-DurationInSecond <Int32>]
