...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/new-azwebappswiftvirtualnetworkconnectionslot
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-AzWebAppSwiftVirtualNetworkConnectionSlot -InputObject <IAppServiceIdentity>
...
```
New-AzWebAppSwiftVirtualNetworkConnectionSlot -InputObject <IAppServiceIdentity> [-Kind <String>]
