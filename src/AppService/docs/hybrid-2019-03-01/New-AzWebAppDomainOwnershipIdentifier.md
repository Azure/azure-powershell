...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/new-azwebappdomainownershipidentifier
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-AzWebAppDomainOwnershipIdentifier -InputObject <IAppServiceIdentity>
...
```
New-AzWebAppDomainOwnershipIdentifier -InputObject <IAppServiceIdentity> [-Kind <String>]
