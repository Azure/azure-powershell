...
online version: https://docs.microsoft.com/powershell/module/az.appservice/update-azwebapp
schema: 2.0.0
---
...
### Update
```
Update-AzWebApp -Name <String> -ResourceGroupName <String> -SiteEnvelope <ISitePatchResource>
