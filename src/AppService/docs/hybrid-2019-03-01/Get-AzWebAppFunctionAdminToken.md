...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappfunctionadmintoken
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppFunctionAdminToken -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
