...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/update-azappserviceplanvnetroute
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-AzAppServicePlanVnetRoute -InputObject <IAppServiceIdentity> -Route <IVnetRoute>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAppServicePlanVnetRoute -InputObject <IAppServiceIdentity> [-EndAddress <String>] [-Kind <String>]
