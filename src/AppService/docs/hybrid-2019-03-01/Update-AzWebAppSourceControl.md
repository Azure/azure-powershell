...
online version: https://docs.microsoft.com/powershell/module/az.appservice/update-azwebappsourcecontrol
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-AzWebAppSourceControl -InputObject <IAppServiceIdentity> -SiteSourceControl <ISiteSourceControl>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzWebAppSourceControl -InputObject <IAppServiceIdentity> [-Branch <String>]
