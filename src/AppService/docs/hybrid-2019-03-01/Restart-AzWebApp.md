...
online version: https://docs.microsoft.com/powershell/module/az.appservice/restart-azwebapp
schema: 2.0.0
---
...
### RestartViaIdentity
```
Restart-AzWebApp -InputObject <IAppServiceIdentity> [-SoftRestart] [-Synchronou] [-DefaultProfile <PSObject>]
