...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/restore-azwebappsnapshot
schema: 2.0.0
---
...
### RestoreViaIdentity
```
Restore-AzWebAppSnapshot -InputObject <IAppServiceIdentity> -RestoreRequest <ISnapshotRestoreRequest>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentityExpanded
```
Restore-AzWebAppSnapshot -InputObject <IAppServiceIdentity> [-IgnoreConflictingHostName] [-Kind <String>]
 [-Overwrite] [-RecoverConfiguration] [-RecoverySourceId <String>] [-RecoverySourceLocation <String>]
 [-SnapshotTime <String>] [-UseDrSecondary] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20180201.ISnapshotRestoreRequest
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20180201.ISnapshotRestoreRequest
