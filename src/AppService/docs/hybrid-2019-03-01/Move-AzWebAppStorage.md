...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/move-azwebappstorage
schema: 2.0.0
---
...
### MigrateViaIdentity
```
Move-AzWebAppStorage -InputObject <IAppServiceIdentity> -SubscriptionName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20160801.IStorageMigrationOptions
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20160801.IStorageMigrationOptions

### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.IAppServiceIdentity

## OUTPUTS

### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20160801.IStorageMigrationResponse
