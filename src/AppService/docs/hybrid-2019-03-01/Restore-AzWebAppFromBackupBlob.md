...
online version: https://docs.microsoft.com/powershell/module/az.appservice/restore-azwebappfrombackupblob
schema: 2.0.0
---
...
### Restore
```
Restore-AzWebAppFromBackupBlob -Name <String> -ResourceGroupName <String> -Request <IRestoreRequest>
