...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappinstanceprocessdumpslot
schema: 2.0.0
---
...
Get-AzWebAppInstanceProcessDumpSlot -InstanceId <String> -Name <String> -ProcessId <String>
 -ResourceGroupName <String> -Slot <String> -SubscriptionId <String[]> -OutFile <String>
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzWebAppInstanceProcessDumpSlot -InputObject <IAppServiceIdentity> -OutFile <String>
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```
