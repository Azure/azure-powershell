...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappconfigurationslot
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppConfigurationSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
