...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebapppremieraddonslot
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppPremierAddOnSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
If a slot is not specified, the API will get the named add-on for the production slot.
