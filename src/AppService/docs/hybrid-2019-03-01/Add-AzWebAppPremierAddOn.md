...
online version: https://docs.microsoft.com/powershell/module/az.appservice/add-azwebapppremieraddon
schema: 2.0.0
---
...
Add-AzWebAppPremierAddOn -Name <String> -PremierAddOnName <String> -ResourceGroupName <String>
 -Location <String> [-SubscriptionId <String>] [-Kind <String>] [-MarketplaceOffer <String>]
...
```
Add-AzWebAppPremierAddOn -Name <String> -PremierAddOnName <String> -ResourceGroupName <String>
 -PremierAddOn <IPremierAddOn> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### AddViaIdentity
```
Add-AzWebAppPremierAddOn -InputObject <IAppServiceIdentity> -PremierAddOn <IPremierAddOn>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AddViaIdentityExpanded
```
Add-AzWebAppPremierAddOn -InputObject <IAppServiceIdentity> -Location <String> [-Kind <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20180201.IPremierAddOn
