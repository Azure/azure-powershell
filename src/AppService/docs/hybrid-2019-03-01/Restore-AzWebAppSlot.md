...
### Restore (Default)
```
Restore-AzWebAppSlot -BackupId <String> -Name <String> -ResourceGroupName <String> -Slot <String>
...
Restore-AzWebAppSlot -BackupId <String> -Name <String> -ResourceGroupName <String> -Slot <String>
 ...
 [-HostingEnvironment <String>] [-IgnoreConflictingHostName] [-IgnoreDatabas] [-Kind <String>]
