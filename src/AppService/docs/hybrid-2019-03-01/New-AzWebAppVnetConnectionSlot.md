...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/new-azwebappvnetconnectionslot
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-AzWebAppVnetConnectionSlot -InputObject <IAppServiceIdentity> -ConnectionEnvelope <IVnetInfo>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzWebAppVnetConnectionSlot -InputObject <IAppServiceIdentity> [-CertBlob <String>] [-DnsServer <String>]
