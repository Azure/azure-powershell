...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/update-azwebappswiftvirtualnetworkconnectionslot
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-AzWebAppSwiftVirtualNetworkConnectionSlot -InputObject <IAppServiceIdentity>
...
```
Update-AzWebAppSwiftVirtualNetworkConnectionSlot -InputObject <IAppServiceIdentity> [-Kind <String>]
