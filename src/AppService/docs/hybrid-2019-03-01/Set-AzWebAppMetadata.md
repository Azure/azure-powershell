...
online version: https://docs.microsoft.com/powershell/module/az.appservice/set-azwebappmetadata
schema: 2.0.0
---
...
### Update
```
Set-AzWebAppMetadata -Name <String> -ResourceGroupName <String> -Metadata <IStringDictionary>
