...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappinstanceprocessthreadslot
schema: 2.0.0
---
...
### List (Default)
```
Get-AzWebAppInstanceProcessThreadSlot -InstanceId <String> -Name <String> -ProcessId <String>
...
```
Get-AzWebAppInstanceProcessThreadSlot -InstanceId <String> -Name <String> -ProcessId <String>
 -ResourceGroupName <String> -Slot <String> -SubscriptionId <String[]> -ThreadId <String>
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzWebAppInstanceProcessThreadSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20180201.IProcessThreadInfo
