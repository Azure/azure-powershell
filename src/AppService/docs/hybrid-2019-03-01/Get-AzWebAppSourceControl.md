...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappsourcecontrol
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppSourceControl -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
