...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/start-azwebapp
schema: 2.0.0
---
...
### Start (Default)
```
Start-AzWebApp -Name <String> -ResourceGroupName <String> -SubscriptionId <String> [-PassThru]
