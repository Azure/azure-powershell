...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/start-azwebapp
schema: 2.0.0
---
...
### StartViaIdentity
```
Start-AzWebApp -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
