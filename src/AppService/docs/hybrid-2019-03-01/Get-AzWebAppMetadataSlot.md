...
online version: https://docs.microsoft.com/powershell/module/az.appservice/get-azwebappmetadataslot
schema: 2.0.0
---
...
```
Get-AzWebAppMetadataSlot -Name <String> -ResourceGroupName <String> -Slot <String>
