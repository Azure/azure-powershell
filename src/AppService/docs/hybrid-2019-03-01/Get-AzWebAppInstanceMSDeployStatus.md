...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappinstancemsdeploystatus
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppInstanceMSDeployStatus -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20160801.IMSDeployStatus
