...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azappserviceplanvnetfromserverfarm
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzAppServicePlanVnetFromServerFarm -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
