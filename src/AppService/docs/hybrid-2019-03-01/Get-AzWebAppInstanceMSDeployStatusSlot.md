...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/get-azwebappinstancemsdeploystatusslot
schema: 2.0.0
---

# Get-AzWebAppInstanceMSDeployStatusSlot
...
### GetViaIdentity
```
Get-AzWebAppInstanceMSDeployStatusSlot -InputObject <IWebSiteIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
