...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappdeployment
schema: 2.0.0
---

# Get-AzWebAppDeployment
...
### GetViaIdentity
```
Get-AzWebAppDeployment -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
