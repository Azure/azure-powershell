...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/get-azwebappvnetconnectiongateway
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppVnetConnectionGateway -InputObject <IWebSiteIdentity> [-PassThru] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
