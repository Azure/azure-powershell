...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappvnetconnectiongateway
schema: 2.0.0
---

# Get-AzWebAppVnetConnectionGateway
...
### GetViaIdentity
```
Get-AzWebAppVnetConnectionGateway -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
