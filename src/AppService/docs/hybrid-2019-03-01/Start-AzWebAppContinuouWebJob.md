...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/start-azwebappcontinuouwebjob
schema: 2.0.0
---
...
### StartViaIdentity
```
Start-AzWebAppContinuouWebJob -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
