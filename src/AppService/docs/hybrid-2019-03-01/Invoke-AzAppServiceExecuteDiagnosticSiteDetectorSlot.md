...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/invoke-azappserviceexecutediagnosticsitedetectorslot
schema: 2.0.0
---

# Invoke-AzAppServiceExecuteDiagnosticSiteDetectorSlot
...
### ExecuteViaIdentity
```
Invoke-AzAppServiceExecuteDiagnosticSiteDetectorSlot -InputObject <IAppServiceIdentity> [-EndTime <DateTime>]
 [-StartTime <DateTime>] [-TimeGrain <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
