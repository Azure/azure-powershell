...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azappservicediagnosticsitedetectorresponseslot
schema: 2.0.0
---

# Get-AzAppServiceDiagnosticSiteDetectorResponseSlot
...
### GetViaIdentity
```
Get-AzAppServiceDiagnosticSiteDetectorResponseSlot -InputObject <IAppServiceIdentity> [-EndTime <DateTime>]
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20180201.IDetectorResponse
