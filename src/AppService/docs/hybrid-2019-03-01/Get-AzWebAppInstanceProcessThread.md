...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/get-azwebappinstanceprocessthread
schema: 2.0.0
---

# Get-AzWebAppInstanceProcessThread
...
```
Get-AzWebAppInstanceProcessThread -InstanceId <String> -Name <String> -ProcessId <String>
 -ResourceGroupName <String> -SubscriptionId <String[]> -ThreadId <String> [-PassThru]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzWebAppInstanceProcessThread -InputObject <IWebSiteIdentity> [-PassThru] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
