...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/update-azwebapprelayserviceconnection
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-AzWebAppRelayServiceConnection -InputObject <IAppServiceIdentity>
...
```
Update-AzWebAppRelayServiceConnection -InputObject <IAppServiceIdentity> [-EntityName <String>]
