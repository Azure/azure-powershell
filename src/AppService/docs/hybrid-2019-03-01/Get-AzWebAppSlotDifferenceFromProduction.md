...
online version: https://docs.microsoft.com/powershell/module/az.appservice/get-azwebappslotdifferencefromproduction
schema: 2.0.0
---

# Get-AzWebAppSlotDifferenceFromProduction
...
```
Get-AzWebAppSlotDifferenceFromProduction -Name <String> -ResourceGroupName <String> -PreserveVnet
...
### List
```
Get-AzWebAppSlotDifferenceFromProduction -Name <String> -ResourceGroupName <String>
