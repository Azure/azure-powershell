...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/test-azwebappcloneable
schema: 2.0.0
---
...
### IsViaIdentity
```
Test-AzWebAppCloneable -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20180201.ISiteCloneability
