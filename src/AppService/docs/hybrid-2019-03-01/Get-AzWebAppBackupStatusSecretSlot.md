...
### List (Default)
```
Get-AzWebAppBackupStatusSecretSlot -BackupId <String> -Name <String> -ResourceGroupName <String>
 -Slot <String> -SubscriptionId <String[]> [-Request <IBackupRequest>] [-DefaultProfile <PSObject>] [-Confirm]
...
```
Get-AzWebAppBackupStatusSecretSlot -BackupId <String> -Name <String> -ResourceGroupName <String>
 -Slot <String> -SubscriptionId <String[]> -BackupScheduleFrequencyInterval <Int32>
