...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappbackupconfiguration
schema: 2.0.0
---
...
### GetSlot
```
Get-AzWebAppBackupConfiguration -Name <String> -ResourceGroupName <String> -Slot <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzWebAppBackupConfiguration -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-Confirm]
