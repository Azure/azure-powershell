...
online version: https://docs.microsoft.com/powershell/module/az.appservice/new-azwebappswiftvirtualnetworkconnection
schema: 2.0.0
---
...
```
New-AzWebAppSwiftVirtualNetworkConnection -Name <String> -ResourceGroupName <String>
