...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/restore-azwebappsiteconfigurationsnapshot
schema: 2.0.0
---
...
### RecoverViaIdentity
```
Restore-AzWebAppSiteConfigurationSnapshot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
