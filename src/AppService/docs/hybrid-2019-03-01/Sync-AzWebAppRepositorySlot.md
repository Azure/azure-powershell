...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/sync-azwebapprepositoryslot
schema: 2.0.0
---
...
### Sync (Default)
```
Sync-AzWebAppRepositorySlot -Name <String> -ResourceGroupName <String> -Slot <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SyncViaIdentity
```
Sync-AzWebAppRepositorySlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
