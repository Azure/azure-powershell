...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/get-azwebappcertificate
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppCertificate -InputObject <IWebSiteIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
