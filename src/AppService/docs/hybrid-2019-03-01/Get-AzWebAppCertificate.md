...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappcertificate
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppCertificate -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
