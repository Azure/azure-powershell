...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebapphostnamebinding
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppHostNameBinding -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
