...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappsiteextension
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppSiteExtension -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20180201.ISiteExtensionInfo
