...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/stop-azwebappwebsitenetworktraceslot
schema: 2.0.0
---
...
### StopViaIdentity
```
Stop-AzWebAppWebSiteNetworkTraceSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
