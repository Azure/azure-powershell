...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappprocessmoduleslot
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppProcessModuleSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
