...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/invoke-azappserviceexecutediagnosticsitedetector
schema: 2.0.0
---

# Invoke-AzAppServiceExecuteDiagnosticSiteDetector
...
### ExecuteViaIdentity
```
Invoke-AzAppServiceExecuteDiagnosticSiteDetector -InputObject <IAppServiceIdentity> [-EndTime <DateTime>]
 [-StartTime <DateTime>] [-TimeGrain <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20160301.IDiagnosticDetectorResponse
