...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebapphybridconnection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppHybridConnection -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
