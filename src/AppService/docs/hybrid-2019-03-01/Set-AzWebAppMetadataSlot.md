...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappmetadataslot
schema: 2.0.0
---
...
```
Set-AzWebAppMetadataSlot -InputObject <IWebSiteIdentity> [-Kind <String>]
...
### UpdateViaIdentity
```
Set-AzWebAppMetadataSlot -InputObject <IWebSiteIdentity> [-Metadata <IStringDictionary>]
