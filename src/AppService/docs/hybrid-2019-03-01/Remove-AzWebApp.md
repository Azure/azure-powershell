...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/remove-azwebapp
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzWebApp -InputObject <IAppServiceIdentity> [-DeleteEmptyServerFarm] [-DeleteMetric]
