...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/update-azwebappslot
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-AzWebAppSlot -InputObject <IAppServiceIdentity> -SiteEnvelope <ISitePatchResource>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzWebAppSlot -InputObject <IAppServiceIdentity> [-ClientAffinityEnabled] [-ClientCertEnabled]
