...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/update-azwebappslot
schema: 2.0.0
---
...
```
Update-AzWebAppSlot -Name <String> -ResourceGroupName <String> -Slot <String> -SubscriptionId <String>
 -CloningInfoSourceWebAppId <String> [-ClientAffinityEnabled] [-ClientCertEnabled]
 ...
 [-SiteConfig <ISiteConfig>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzWebAppSlot -InputObject <IWebSiteIdentity> -CloningInfoSourceWebAppId <String>
...
### UpdateViaIdentity
```
Update-AzWebAppSlot -InputObject <IWebSiteIdentity> [-SiteEnvelope <ISitePatchResource>]
