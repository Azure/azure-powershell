...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/get-azwebappusageslot
schema: 2.0.0
---

# Get-AzWebAppUsageSlot
...
```
Get-AzWebAppUsageSlot -Name <String> -ResourceGroupName <String> -Slot <String> -SubscriptionId <String[]>
...
If a slot is not specified, the API will get quota information of the production slot.
