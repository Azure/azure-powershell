...
online version: https://docs.microsoft.com/powershell/module/az.appservice/get-azwebapppubliccertificateslot
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppPublicCertificateSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
