...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/update-azwebapppremieraddonslot
schema: 2.0.0
---
...
```
Update-AzWebAppPremierAddOnSlot -Name <String> -PremierAddOnName <String> -ResourceGroupName <String>
 -Slot <String> -PremierAddOn <IPremierAddOnPatchResource> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-AzWebAppPremierAddOnSlot -InputObject <IAppServiceIdentity> -PremierAddOn <IPremierAddOnPatchResource>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzWebAppPremierAddOnSlot -InputObject <IAppServiceIdentity> [-Kind <String>]
