...
### Create
```
New-AzWebAppDeployment -Id <String> -Name <String> -ResourceGroupName <String> -Deployment <IDeployment>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzWebAppDeployment -InputObject <IAppServiceIdentity> -Deployment <IDeployment>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzWebAppDeployment -InputObject <IAppServiceIdentity> [-Active] [-Author <String>] [-AuthorEmail <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20180201.IDeployment
