...
Update-AzWebAppConfiguration -Name <String> -ResourceGroupName <String> -SubscriptionId <String>
 ...
 [-Http20Enabled] [-HttpLoggingEnabled] [-IPSecurityRestriction <IIPSecurityRestriction[]>]
...
```
Update-AzWebAppConfiguration -InputObject <IWebSiteIdentity> -ActionType <AutoHealActionType> -IsPushEnabled
