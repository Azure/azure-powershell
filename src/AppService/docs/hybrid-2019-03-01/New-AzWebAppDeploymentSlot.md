...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/new-azwebappdeploymentslot
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-AzWebAppDeploymentSlot -InputObject <IAppServiceIdentity> -Deployment <IDeployment>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzWebAppDeploymentSlot -InputObject <IAppServiceIdentity> [-Active] [-Author <String>]
