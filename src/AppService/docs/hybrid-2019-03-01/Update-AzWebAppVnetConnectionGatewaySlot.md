...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/update-azwebappvnetconnectiongatewayslot
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-AzWebAppVnetConnectionGatewaySlot -InputObject <IAppServiceIdentity> -ConnectionEnvelope <IVnetGateway>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzWebAppVnetConnectionGatewaySlot -InputObject <IAppServiceIdentity> [-VnetName <String>]
 [-Kind <String>] [-VpnPackageUri <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
