...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/start-azwebappwebsitenetworktraceoperationslot
schema: 2.0.0
---
...
### StartViaIdentity
```
Start-AzWebAppWebSiteNetworkTraceOperationSlot -InputObject <IAppServiceIdentity> [-DurationInSecond <Int32>]
