...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/set-azwebappvnetconnectionslot
schema: 2.0.0
---
...
```
Set-AzWebAppVnetConnectionSlot -Name <String> -ResourceGroupName <String> -Slot <String> -VnetName <String>
