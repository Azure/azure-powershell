...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappvnetconnectionslot
schema: 2.0.0
---

# Set-AzWebAppVnetConnectionSlot
...
### Update (Default)
```
Set-AzWebAppVnetConnectionSlot -Name <String> -ResourceGroupName <String> -Slot <String>
...
```
Set-AzWebAppVnetConnectionSlot -InputObject <IWebSiteIdentity> [-CertBlob <String>] [-DnsServer <String>]
...
### UpdateViaIdentity
```
Set-AzWebAppVnetConnectionSlot -InputObject <IWebSiteIdentity> [-ConnectionEnvelope <IVnetInfo>]
