...
Update-AzWebAppPremierAddOn -Name <String> -PremierAddOnName <String> -ResourceGroupName <String>
 -SubscriptionId <String> [-PremierAddOn <IPremierAddOnPatchResource>] [-DefaultProfile <PSObject>] [-WhatIf]
...
Update-AzWebAppPremierAddOn -Name <String> -PremierAddOnName <String> -ResourceGroupName <String>
 ...
 [-Product <String>] [-Sku <String>] [-Vendor <String>] [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/update-azwebapppremieraddon](https://docs.microsoft.com/en-us/powershell/module/az.website/update-azwebapppremieraddon)
