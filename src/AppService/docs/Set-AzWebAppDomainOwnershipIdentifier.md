...
```
Set-AzWebAppDomainOwnershipIdentifier -InputObject <IWebSiteIdentity> [-Kind <String>] [-PropertiesId <String>]
 [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappdomainownershipidentifier](https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappdomainownershipidentifier)
