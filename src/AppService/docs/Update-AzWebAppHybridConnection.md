...
### Update (Default)
```
Update-AzWebAppHybridConnection -Name <String> -NamespaceName <String> -RelayName <String>
...
```
Update-AzWebAppHybridConnection [-RelayName <String>] -InputObject <IWebSiteIdentity> [-Hostname <String>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/update-azwebapphybridconnection](https://docs.microsoft.com/en-us/powershell/module/az.website/update-azwebapphybridconnection)
