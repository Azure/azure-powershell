...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/new-azwebappconfiguration
schema: 2.0.0
---
...
### Create (Default)
```
New-AzWebAppConfiguration -Name <String> -ResourceGroupName <String> -SubscriptionId <String>
...
```
New-AzWebAppConfiguration -InputObject <IWebSiteIdentity> [-ActionMinProcessExecutionTime <String>]
...
### CreateViaIdentity
```
New-AzWebAppConfiguration -InputObject <IWebSiteIdentity> [-SiteConfig <ISiteConfigResource>]
 [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/new-azwebappconfiguration](https://docs.microsoft.com/en-us/powershell/module/az.website/new-azwebappconfiguration)
