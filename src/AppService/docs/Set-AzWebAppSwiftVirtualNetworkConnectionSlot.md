...
```
Set-AzWebAppSwiftVirtualNetworkConnectionSlot -InputObject <IWebSiteIdentity> [-Kind <String>]
...
### UpdateViaIdentity
```
Set-AzWebAppSwiftVirtualNetworkConnectionSlot -InputObject <IWebSiteIdentity>
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappswiftvirtualnetworkconnectionslot](https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebappswiftvirtualnetworkconnectionslot)
