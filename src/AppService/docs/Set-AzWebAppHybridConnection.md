...
```
Set-AzWebAppHybridConnection [-RelayName <String>] -InputObject <IWebSiteIdentity> [-Hostname <String>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebapphybridconnection](https://docs.microsoft.com/en-us/powershell/module/az.website/set-azwebapphybridconnection)
