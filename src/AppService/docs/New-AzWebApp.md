...
```
New-AzWebApp -InputObject <IWebSiteIdentity> [-ClientAffinityEnabled <Boolean>] [-ClientCertEnabled <Boolean>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/new-azwebapp](https://docs.microsoft.com/en-us/powershell/module/az.website/new-azwebapp)
