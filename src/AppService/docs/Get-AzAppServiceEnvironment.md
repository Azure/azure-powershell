...
### List1
```
Get-AzAppServiceEnvironment -ResourceGroupName <String> -SubscriptionId <String[]> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/get-azappserviceenvironment](https://docs.microsoft.com/en-us/powershell/module/az.website/get-azappserviceenvironment)
