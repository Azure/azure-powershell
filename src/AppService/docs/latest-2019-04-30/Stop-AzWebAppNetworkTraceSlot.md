...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/stop-azwebappnetworktraceslot
schema: 2.0.0
---
...
### StopViaIdentity
```
Stop-AzWebAppNetworkTraceSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
