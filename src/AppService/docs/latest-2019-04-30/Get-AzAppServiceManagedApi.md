...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azappservicemanagedapi
schema: 2.0.0
---

# Get-AzAppServiceManagedApi
...
### GetViaIdentity
```
Get-AzAppServiceManagedApi -InputObject <IAppServiceIdentity> [-Export] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20150801Preview.IApiEntity
