...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azappservicerecommendationruledetail
schema: 2.0.0
---

# Get-AzAppServiceRecommendationRuleDetail
...
### GetViaIdentity
```
Get-AzAppServiceRecommendationRuleDetail -InputObject <IAppServiceIdentity> [-RecommendationId <String>]
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20180201.IRecommendationRule
