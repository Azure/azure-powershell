...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azappservicecertificateordercertificate
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzAppServiceCertificateOrderCertificate -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
