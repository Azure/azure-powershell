...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/invoke-azappserviceexecutediagnosticsiteanalysisslot
schema: 2.0.0
---

# Invoke-AzAppServiceExecuteDiagnosticSiteAnalysisSlot
...
### Execute (Default)
```
Invoke-AzAppServiceExecuteDiagnosticSiteAnalysisSlot -AnalysisName <String> -DiagnosticCategory <String>
...
### ExecuteViaIdentity
```
Invoke-AzAppServiceExecuteDiagnosticSiteAnalysisSlot -InputObject <IAppServiceIdentity> [-EndTime <DateTime>]
