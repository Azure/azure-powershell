...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/remove-azappservicesiteinstancedeploymentslot
schema: 2.0.0
---

# Remove-AzAppServiceSiteInstanceDeploymentSlot
...
### Delete (Default)
```
Remove-AzAppServiceSiteInstanceDeploymentSlot -Id <String> -InstanceId <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzAppServiceSiteInstanceDeploymentSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
