...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/update-azappserviceenvironmentmultirolepool
schema: 2.0.0
---
...
Update-AzAppServiceEnvironmentMultiRolePool -Name <String> -ResourceGroupName <String>
 ...
 [-WorkerSize <String>] [-WorkerSizeId <Int32>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-AzAppServiceEnvironmentMultiRolePool -InputObject <IAppServiceIdentity>
 -MultiRolePoolEnvelope <IWorkerPoolResource> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAppServiceEnvironmentMultiRolePool -InputObject <IAppServiceIdentity> [-Capacity <Int32>]
