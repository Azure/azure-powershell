...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/stop-azwebappcontinuouwebjob
schema: 2.0.0
---
...
### StopViaIdentity
```
Stop-AzWebAppContinuouWebJob -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
