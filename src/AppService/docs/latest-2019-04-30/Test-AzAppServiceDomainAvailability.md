...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/test-azappservicedomainavailability
schema: 2.0.0
---

# Test-AzAppServiceDomainAvailability
...
### CheckViaIdentity
```
Test-AzAppServiceDomainAvailability -InputObject <IAppServiceIdentity> -Identifier <INameIdentifier>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentityExpanded
```
Test-AzAppServiceDomainAvailability -InputObject <IAppServiceIdentity> [-Name <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20180201.IDomainAvailablilityCheckResult
