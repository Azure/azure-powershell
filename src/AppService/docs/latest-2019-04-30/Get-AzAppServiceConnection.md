...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azappserviceconnection
schema: 2.0.0
---

# Get-AzAppServiceConnection
...
### GetViaIdentity
```
Get-AzAppServiceConnection -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
