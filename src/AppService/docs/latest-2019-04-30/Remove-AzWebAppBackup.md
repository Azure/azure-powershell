...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/remove-azwebappbackup
schema: 2.0.0
---
...
### DeleteBySiteObject
```
Remove-AzWebAppBackup -BackupId <String> -SiteObject <ISite> [-SubscriptionId <String>] [-PassThru]
...
### DeleteViaIdentity
```
Remove-AzWebAppBackup -InputObject <IAppServiceIdentity> [-PassThru] [-DefaultProfile <PSObject>] [-Confirm]
...
```yaml
Type: System.String
Parameter Sets: Delete, DeleteBySiteObject, DeleteSlot
Aliases:
...
Parameter Sets: DeleteBySiteObject
...
If a slot is not specified, the API will delete a backup of the production slot.
