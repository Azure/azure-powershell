...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/start-azwebappwebsitenetworktrace
schema: 2.0.0
---

# Start-AzWebAppWebSiteNetworkTrace
...
### StartViaIdentity
```
Start-AzWebAppWebSiteNetworkTrace -InputObject <IAppServiceIdentity> [-DurationInSecond <Int32>]
 [-MaxFrameLength <Int32>] [-SasUrl <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
