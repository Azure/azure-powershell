...
online version: https://docs.microsoft.com/powershell/module/az.appservice/remove-azappserviceplanvnetroute
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzAppServicePlanVnetRoute -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
