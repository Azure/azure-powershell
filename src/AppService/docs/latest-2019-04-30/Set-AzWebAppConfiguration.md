...
online version: https://docs.microsoft.com/powershell/module/az.appservice/set-azwebappconfiguration
schema: 2.0.0
---
...
### Update
```
Set-AzWebAppConfiguration -Name <String> -ResourceGroupName <String> -SiteConfig <ISiteConfigResource>
