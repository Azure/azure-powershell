...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/remove-azwebappinstanceprocess
schema: 2.0.0
---

# Remove-AzWebAppInstanceProcess
...
### Delete (Default)
```
Remove-AzWebAppInstanceProcess -InstanceId <String> -Name <String> -ProcessId <String>
...
### DeleteViaIdentity
```
Remove-AzWebAppInstanceProcess -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
