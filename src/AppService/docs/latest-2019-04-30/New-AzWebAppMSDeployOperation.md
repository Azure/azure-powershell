...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/new-azwebappmsdeployoperation
schema: 2.0.0
---
...
New-AzWebAppMSDeployOperation -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-AppOffline] [-ConnectionString <String>] [-DbType <String>] [-Kind <String>] [-PackageUri <String>]
...
### Create
```
New-AzWebAppMSDeployOperation -Name <String> -ResourceGroupName <String> -MSDeploy <IMSDeploy>
...
### CreateViaIdentity
```
New-AzWebAppMSDeployOperation -InputObject <IAppServiceIdentity> -MSDeploy <IMSDeploy>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzWebAppMSDeployOperation -InputObject <IAppServiceIdentity> [-AppOffline] [-ConnectionString <String>]
 [-DbType <String>] [-Kind <String>] [-PackageUri <String>] [-SetParameter <Hashtable>]
 [-SetParametersXmlFileUri <String>] [-SkipAppData] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
