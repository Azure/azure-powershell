...
```
Set-AzWebAppVnetConnection -InputObject <IWebSiteIdentity> [-CertBlob <String>] [-DnsServer <String>]
...
### UpdateViaIdentity
```
Set-AzWebAppVnetConnection -InputObject <IWebSiteIdentity> [-ConnectionEnvelope <IVnetInfo>]
