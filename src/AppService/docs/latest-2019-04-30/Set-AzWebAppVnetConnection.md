...
online version: https://docs.microsoft.com/powershell/module/az.appservice/set-azwebappvnetconnection
schema: 2.0.0
---
...
```
Set-AzWebAppVnetConnection -Name <String> -ResourceGroupName <String> -VnetName <String>
