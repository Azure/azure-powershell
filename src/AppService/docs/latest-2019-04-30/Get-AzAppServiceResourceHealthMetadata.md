...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azappserviceresourcehealthmetadata
schema: 2.0.0
---

# Get-AzAppServiceResourceHealthMetadata
...
### GetViaIdentity
```
Get-AzAppServiceResourceHealthMetadata -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20160301.IResourceHealthMetadata
