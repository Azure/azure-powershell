...
online version: https://docs.microsoft.com/powershell/module/az.appservice/set-azappserviceenvironmentmultirolepool
schema: 2.0.0
---
...
### Update
```
Set-AzAppServiceEnvironmentMultiRolePool -Name <String> -ResourceGroupName <String>
