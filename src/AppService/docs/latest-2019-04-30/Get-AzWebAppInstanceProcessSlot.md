...
online version: https://docs.microsoft.com/powershell/module/az.appservice/get-azwebappinstanceprocessslot
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppInstanceProcessSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
