...
### Update (Default)
```
Update-AzWebAppHybridConnectionSlot -Name <String> -NamespaceName <String> -ResourceGroupName <String>
 -Slot <String> -SubscriptionId <String> [-RelayName <String>] [-ConnectionEnvelope <IHybridConnection>]
...
```
Update-AzWebAppHybridConnectionSlot -Name <String> -NamespaceName <String> -ResourceGroupName <String>
 -Slot <String> -SubscriptionId <String> [-RelayName <String>] [-Hostname <String>] [-Kind <String>]
...
```
Update-AzWebAppHybridConnectionSlot -InputObject <IWebSiteIdentity> [-RelayName <String>] [-Hostname <String>]
