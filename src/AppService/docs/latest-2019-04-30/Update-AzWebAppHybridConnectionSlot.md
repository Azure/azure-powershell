...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/update-azwebapphybridconnectionslot
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-AzWebAppHybridConnectionSlot -InputObject <IAppServiceIdentity> -ConnectionEnvelope <IHybridConnection>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzWebAppHybridConnectionSlot -InputObject <IAppServiceIdentity> [-RelayName <String>]
 [-Hostname <String>] [-Kind <String>] [-Port <Int32>] [-RelayArmUri <String>] [-SendKeyName <String>]
 [-SendKeyValue <String>] [-ServiceBusNamespace <String>] [-ServiceBusSuffix <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
