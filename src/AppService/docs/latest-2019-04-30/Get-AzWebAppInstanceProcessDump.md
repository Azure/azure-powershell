...
online version: https://docs.microsoft.com/powershell/module/az.appservice/get-azwebappinstanceprocessdump
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppInstanceProcessDump -InputObject <IAppServiceIdentity> -OutFile <String>
