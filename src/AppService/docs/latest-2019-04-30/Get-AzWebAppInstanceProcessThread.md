...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappinstanceprocessthread
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppInstanceProcessThread -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
