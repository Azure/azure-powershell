...
online version: https://docs.microsoft.com/powershell/module/az.appservice/update-azwebappvnetconnectionslot
schema: 2.0.0
---
...
```
Update-AzWebAppVnetConnectionSlot -Name <String> -ResourceGroupName <String> -Slot <String> -VnetName <String>
