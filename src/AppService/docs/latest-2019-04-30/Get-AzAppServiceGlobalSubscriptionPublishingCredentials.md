...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azappserviceglobalsubscriptionpublishingcredentials
schema: 2.0.0
---

# Get-AzAppServiceGlobalSubscriptionPublishingCredentials
...
### GetViaIdentity
```
Get-AzAppServiceGlobalSubscriptionPublishingCredentials -InputObject <IAppServiceIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
