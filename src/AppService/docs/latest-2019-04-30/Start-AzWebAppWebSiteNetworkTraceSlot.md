...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/start-azwebappwebsitenetworktraceslot
schema: 2.0.0
---
...
### Start (Default)
```
Start-AzWebAppWebSiteNetworkTraceSlot -Name <String> -ResourceGroupName <String> -Slot <String>
...
### StartViaIdentity
```
Start-AzWebAppWebSiteNetworkTraceSlot -InputObject <IAppServiceIdentity> [-DurationInSecond <Int32>]
