...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azappserviceenvironment
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzAppServiceEnvironment -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
