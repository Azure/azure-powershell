...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/remove-azwebappsourcecontrol
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzWebAppSourceControl -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
