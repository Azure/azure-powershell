...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/start-azwebappnetworktrace
schema: 2.0.0
---
...
### StartViaIdentity
```
Start-AzWebAppNetworkTrace -InputObject <IAppServiceIdentity> [-DurationInSecond <Int32>]
