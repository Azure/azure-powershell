...
```
New-AzAppServiceDomain -Name <String> -ResourceGroupName <String> -SubscriptionId <String> -Location <String>
...
### Create
```
New-AzAppServiceDomain -Name <String> -ResourceGroupName <String> -SubscriptionId <String> -Domain <IDomain>
