...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/new-azappservicedomain
schema: 2.0.0
---

# New-AzAppServiceDomain
...
```
New-AzAppServiceDomain -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-AuthCode <String>] [-AutoRenew] [-ConsentAgreedAt <DateTime>]
 [-ConsentAgreedBy <String>] [-ConsentAgreementKey <String[]>] [-ContactAdminAddressMailingAddress1 <String>]
...
### Create
```
New-AzAppServiceDomain -Name <String> -ResourceGroupName <String> -Domain <IDomain> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzAppServiceDomain -InputObject <IAppServiceIdentity> -Domain <IDomain> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzAppServiceDomain -InputObject <IAppServiceIdentity> -Location <String> [-AuthCode <String>] [-AutoRenew]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20180201.IDomain
