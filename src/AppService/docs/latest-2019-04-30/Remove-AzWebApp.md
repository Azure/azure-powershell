...
### DeleteBySiteObject
```
Remove-AzWebApp -SiteObject <ISite> [-SubscriptionId <String>] [-DeleteEmptyServerFarm] [-DeleteMetric]
...
### DeleteViaIdentity
```
Remove-AzWebApp -InputObject <IAppServiceIdentity> [-DeleteEmptyServerFarm] [-DeleteMetric] [-PassThru]
