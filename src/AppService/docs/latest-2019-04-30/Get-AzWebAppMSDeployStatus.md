...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappmsdeploystatus
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppMSDeployStatus -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
