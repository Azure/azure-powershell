...
online version: https://docs.microsoft.com/powershell/module/az.appservice/start-azwebappnetworktraceslot
schema: 2.0.0
---
...
### StartViaIdentity
```
Start-AzWebAppNetworkTraceSlot -InputObject <IAppServiceIdentity> [-DurationInSecond <Int32>]
