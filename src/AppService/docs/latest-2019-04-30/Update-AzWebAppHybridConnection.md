...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/update-azwebapphybridconnection
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-AzWebAppHybridConnection -InputObject <IAppServiceIdentity> -ConnectionEnvelope <IHybridConnection>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzWebAppHybridConnection -InputObject <IAppServiceIdentity> [-RelayName <String>] [-Hostname <String>]
