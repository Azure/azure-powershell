...
online version: https://docs.microsoft.com/powershell/module/az.appservice/get-azwebappcontainerlogzipslot
schema: 2.0.0
---

# Get-AzWebAppContainerLogZipSlot
...
### Get (Default)
```
Get-AzWebAppContainerLogZipSlot -Name <String> -ResourceGroupName <String> -Slot <String> -OutFile <String>
...
### GetViaIdentity
```
Get-AzWebAppContainerLogZipSlot -InputObject <IAppServiceIdentity> -OutFile <String>
