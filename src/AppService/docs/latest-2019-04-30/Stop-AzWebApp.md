...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/stop-azwebapp
schema: 2.0.0
---
...
### Stop (Default)
```
Stop-AzWebApp -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] [-PassThru]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopBySiteObject
```
Stop-AzWebApp -SiteObject <ISite> [-SubscriptionId <String>] [-PassThru] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopSlot
```
Stop-AzWebApp -Name <String> -ResourceGroupName <String> -Slot <String> [-SubscriptionId <String>] [-PassThru]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopViaIdentity
```
Stop-AzWebApp -InputObject <IAppServiceIdentity> [-PassThru] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Parameter Sets: StopBySiteObject
...
```yaml
Type: System.String
Parameter Sets: Stop, StopBySiteObject, StopSlot
Aliases:
