...
### RestoreBySiteObject
```
Restore-AzWebAppSnapshot -SiteObject <ISite> [-SubscriptionId <String>] [-IgnoreConflictingHostName]
 [-Kind <String>] [-Overwrite] [-PassThru] [-RecoverConfiguration] [-RecoverySourceId <String>]
...
Restore-AzWebAppSnapshot -Name <String> -ResourceGroupName <String> -Slot <String>
 -RestoreRequest <ISnapshotRestoreRequest> [-SubscriptionId <String>] [-PassThru] [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Restore-AzWebAppSnapshot -InputObject <IAppServiceIdentity> [-IgnoreConflictingHostName] [-Kind <String>]
 [-Overwrite] [-PassThru] [-RecoverConfiguration] [-RecoverySourceId <String>]
 [-RecoverySourceLocation <String>] [-SnapshotTime <String>] [-UseDrSecondary] [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Parameter Sets: RestoreBySiteObject
