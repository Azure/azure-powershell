...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebapptriggeredwebjobhistory
schema: 2.0.0
---
...
Get-AzWebAppTriggeredWebJobHistory -Id <String> -Name <String> -ResourceGroupName <String>
 -SubscriptionId <String[]> -WebJobName <String> [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzWebAppTriggeredWebJobHistory -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
