...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/reset-azwebappproductionslotconfig
schema: 2.0.0
---

# Reset-AzWebAppProductionSlotConfig
...
### ResetViaIdentity
```
Reset-AzWebAppProductionSlotConfig -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
