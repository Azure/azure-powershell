...
online version: https://docs.microsoft.com/powershell/module/az.appservice/get-azwebappwebsitecontainerlog
schema: 2.0.0
---

# Get-AzWebAppWebSiteContainerLog
...
### GetViaIdentity
```
Get-AzWebAppWebSiteContainerLog -InputObject <IAppServiceIdentity> -OutFile <String>
