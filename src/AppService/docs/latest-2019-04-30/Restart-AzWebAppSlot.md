...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/restart-azwebappslot
schema: 2.0.0
---
...
### Restart (Default)
```
Restart-AzWebAppSlot -Name <String> -ResourceGroupName <String> -Slot <String> -SubscriptionId <String>
...
### RestartViaIdentity
```
Restart-AzWebAppSlot -InputObject <IWebSiteIdentity> [-SoftRestart] [-Synchronou] [-PassThru]
