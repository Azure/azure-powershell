...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/start-azwebappcontinuouwebjobslot
schema: 2.0.0
---

# Start-AzWebAppContinuouWebJobSlot
...
### Start (Default)
```
Start-AzWebAppContinuouWebJobSlot -Name <String> -ResourceGroupName <String> -Slot <String>
...
### StartViaIdentity
```
Start-AzWebAppContinuouWebJobSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
