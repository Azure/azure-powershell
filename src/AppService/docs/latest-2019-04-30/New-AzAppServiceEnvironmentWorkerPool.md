...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/new-azappserviceenvironmentworkerpool
schema: 2.0.0
---
...
```
New-AzAppServiceEnvironmentWorkerPool -InputObject <IWebSiteIdentity> [-PassThru] [-Capacity <Int32>]
