...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/new-azappserviceenvironmentworkerpool
schema: 2.0.0
---

# New-AzAppServiceEnvironmentWorkerPool
...
```
New-AzAppServiceEnvironmentWorkerPool -Name <String> -ResourceGroupName <String> -WorkerPoolName <String>
 ...
 [-WorkerSize <String>] [-WorkerSizeId <Int32>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
...
```
New-AzAppServiceEnvironmentWorkerPool -Name <String> -ResourceGroupName <String> -WorkerPoolName <String>
 -WorkerPoolEnvelope <IWorkerPoolResource> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzAppServiceEnvironmentWorkerPool -InputObject <IAppServiceIdentity>
 -WorkerPoolEnvelope <IWorkerPoolResource> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzAppServiceEnvironmentWorkerPool -InputObject <IAppServiceIdentity> [-Capacity <Int32>]
