...
### GetViaIdentity
```
Get-AzWebSiteDiagnosticHostingEnvironmentDetectorResponse -InputObject <IWebSiteIdentity>
 [-EndTime <DateTime>] [-StartTime <DateTime>] [-TimeGrain <String>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
