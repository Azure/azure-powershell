...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/remove-azappservicecertificateordercertificate
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzAppServiceCertificateOrderCertificate -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
