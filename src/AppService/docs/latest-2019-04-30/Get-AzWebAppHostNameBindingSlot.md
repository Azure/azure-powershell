...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebapphostnamebindingslot
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppHostNameBindingSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
