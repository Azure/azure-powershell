...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/restart-azappserviceplanworker
schema: 2.0.0
---
...
### RebootViaIdentity
```
Restart-AzAppServicePlanWorker -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
