...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/add-azwebappslotconfigurationslot
schema: 2.0.0
---
...
### ApplyViaIdentity
```
Add-AzWebAppSlotConfigurationSlot -InputObject <IAppServiceIdentity> -SlotSwapEntity <ICsmSlotEntity>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ApplyViaIdentityExpanded
```
Add-AzWebAppSlotConfigurationSlot -InputObject <IAppServiceIdentity> -PreserveVnet -TargetSlot <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
