...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/update-azwebappdomainownershipidentifierslot
schema: 2.0.0
---

# Update-AzWebAppDomainOwnershipIdentifierSlot
...
```
Update-AzWebAppDomainOwnershipIdentifierSlot -DomainOwnershipIdentifierName <String> -Name <String>
...
### UpdateViaIdentity
```
Update-AzWebAppDomainOwnershipIdentifierSlot -InputObject <IAppServiceIdentity>
...
```
Update-AzWebAppDomainOwnershipIdentifierSlot -InputObject <IAppServiceIdentity> [-Kind <String>]
 [-PropertiesId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
