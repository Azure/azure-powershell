...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/update-azwebappswiftvirtualnetworkconnection
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-AzWebAppSwiftVirtualNetworkConnection -InputObject <IAppServiceIdentity>
...
```
Update-AzWebAppSwiftVirtualNetworkConnection -InputObject <IAppServiceIdentity> [-Kind <String>]
