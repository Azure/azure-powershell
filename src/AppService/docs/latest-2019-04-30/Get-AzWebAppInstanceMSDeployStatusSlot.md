...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappinstancemsdeploystatusslot
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppInstanceMSDeployStatusSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
