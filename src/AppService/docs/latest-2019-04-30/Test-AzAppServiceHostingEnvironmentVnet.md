...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/test-azappservicehostingenvironmentvnet
schema: 2.0.0
---

# Test-AzAppServiceHostingEnvironmentVnet
...
### VerifyViaIdentity
```
Test-AzAppServiceHostingEnvironmentVnet -InputObject <IAppServiceIdentity> -Parameter <IVnetParameters>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### VerifyViaIdentityExpanded
```
Test-AzAppServiceHostingEnvironmentVnet -InputObject <IAppServiceIdentity> [-Kind <String>]
 [-VnetName <String>] [-VnetResourceGroup <String>] [-VnetSubnetName <String>] [-DefaultProfile <PSObject>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20160301.IVnetParameters
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20160301.IVnetParameters

### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.IAppServiceIdentity

## OUTPUTS

### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20160301.IVnetValidationFailureDetails
