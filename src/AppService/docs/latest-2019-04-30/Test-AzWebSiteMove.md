...
```
Test-AzWebSiteMove -ResourceGroupName <String> -SubscriptionId <String> [-Resource <String[]>]
...
```
Test-AzWebSiteMove -InputObject <IWebSiteIdentity> [-Resource <String[]>] [-TargetResourceGroup <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
