...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azappservicemanagedhostingenvironmentmanagedhostingenvironmentoperation
schema: 2.0.0
---

# Get-AzAppServiceManagedHostingEnvironmentManagedHostingEnvironmentOperation
...
### Get (Default)
```
Get-AzAppServiceManagedHostingEnvironmentManagedHostingEnvironmentOperation -Name <String>
...
### GetViaIdentity
```
Get-AzAppServiceManagedHostingEnvironmentManagedHostingEnvironmentOperation -InputObject <IAppServiceIdentity>
