...
### GetBySiteObject
```
Get-AzWebAppBackupConfiguration -SiteObject <ISite> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
...
Parameter Sets: GetBySiteObject
...
```yaml
Type: System.String[]
Parameter Sets: Get, GetBySiteObject, GetSlot
Aliases:
