...
online version: https://docs.microsoft.com/powershell/module/az.appservice/set-azwebappazurestorageaccount
schema: 2.0.0
---
...
### Update
```
Set-AzWebAppAzureStorageAccount -Name <String> -ResourceGroupName <String>
