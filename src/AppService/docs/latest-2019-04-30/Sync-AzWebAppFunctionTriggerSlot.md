...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/sync-azwebappfunctiontriggerslot
schema: 2.0.0
---
...
### SyncViaIdentity
```
Sync-AzWebAppFunctionTriggerSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
