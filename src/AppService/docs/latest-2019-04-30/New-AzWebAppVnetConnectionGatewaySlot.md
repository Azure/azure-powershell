...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/new-azwebappvnetconnectiongatewayslot
schema: 2.0.0
---
...
New-AzWebAppVnetConnectionGatewaySlot -GatewayName <String> -Name <String> -ResourceGroupName <String>
 -Slot <String> -VnetName <String> [-SubscriptionId <String>] [-Kind <String>] [-PropertiesVnetName <String>]
...
```
New-AzWebAppVnetConnectionGatewaySlot -GatewayName <String> -Name <String> -ResourceGroupName <String>
 -Slot <String> -VnetName <String> -ConnectionEnvelope <IVnetGateway> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzWebAppVnetConnectionGatewaySlot -InputObject <IAppServiceIdentity> -ConnectionEnvelope <IVnetGateway>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzWebAppVnetConnectionGatewaySlot -InputObject <IAppServiceIdentity> [-VnetName <String>] [-Kind <String>]
 [-VpnPackageUri <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
