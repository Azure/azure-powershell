...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/add-azwebapppremieraddonslot
schema: 2.0.0
---
...
### AddViaIdentity
```
Add-AzWebAppPremierAddOnSlot -InputObject <IAppServiceIdentity> -PremierAddOn <IPremierAddOn>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AddViaIdentityExpanded
```
Add-AzWebAppPremierAddOnSlot -InputObject <IAppServiceIdentity> -Location <String> [-Kind <String>]
