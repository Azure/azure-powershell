...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/update-azwebapprelayserviceconnectionslot
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-AzWebAppRelayServiceConnectionSlot -InputObject <IAppServiceIdentity>
...
```
Update-AzWebAppRelayServiceConnectionSlot -InputObject <IAppServiceIdentity> [-EntityName <String>]
