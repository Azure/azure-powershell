...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/new-azappservicemanagedhostingenvironmentmanagedhostingenvironment
schema: 2.0.0
---

# New-AzAppServiceManagedHostingEnvironmentManagedHostingEnvironment
...
```
New-AzAppServiceManagedHostingEnvironmentManagedHostingEnvironment -Name <String> -ResourceGroupName <String>
...
### CreateViaIdentity
```
New-AzAppServiceManagedHostingEnvironmentManagedHostingEnvironment -InputObject <IAppServiceIdentity>
