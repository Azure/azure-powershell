...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/remove-azwebapppubliccertificateslot
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzWebAppPublicCertificateSlot -Name <String> -PublicCertificateName <String>
...
### DeleteViaIdentity
```
Remove-AzWebAppPublicCertificateSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
