...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/new-azappserviceplanvnetroute
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-AzAppServicePlanVnetRoute -InputObject <IAppServiceIdentity> -Route <IVnetRoute>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzAppServicePlanVnetRoute -InputObject <IAppServiceIdentity> [-EndAddress <String>] [-Kind <String>]
 [-RouteType <RouteType>] [-StartAddress <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
