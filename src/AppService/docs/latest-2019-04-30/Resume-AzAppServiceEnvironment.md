...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/resume-azappserviceenvironment
schema: 2.0.0
---
...
### ResumeViaIdentity
```
Resume-AzAppServiceEnvironment -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-AsJob]
