...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/suspend-azappserviceenvironment
schema: 2.0.0
---

# Suspend-AzAppServiceEnvironment
...
### Suspend (Default)
```
Suspend-AzAppServiceEnvironment -Name <String> -ResourceGroupName <String> -SubscriptionId <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SuspendViaIdentity
```
Suspend-AzAppServiceEnvironment -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-AsJob]
