...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/new-azappservicedomainownershipidentifier
schema: 2.0.0
---

# New-AzAppServiceDomainOwnershipIdentifier
...
### CreateViaIdentity
```
New-AzAppServiceDomainOwnershipIdentifier -InputObject <IAppServiceIdentity>
...
```
New-AzAppServiceDomainOwnershipIdentifier -InputObject <IAppServiceIdentity> [-Kind <String>]
