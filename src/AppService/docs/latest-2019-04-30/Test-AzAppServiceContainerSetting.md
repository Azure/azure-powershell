...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/test-azappservicecontainersetting
schema: 2.0.0
---

# Test-AzAppServiceContainerSetting
...
### ValidateViaIdentity
```
Test-AzAppServiceContainerSetting -InputObject <IAppServiceIdentity>
 -ValidateContainerSettingsRequest <IValidateContainerSettingsRequest> [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
```
Test-AzAppServiceContainerSetting -InputObject <IAppServiceIdentity> [-BaseUrl <String>] [-Password <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20180201.IValidateContainerSettingsRequest
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20180201.IValidateContainerSettingsRequest

### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.IAppServiceIdentity

## OUTPUTS

### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20180201.IPathsSubscriptionsSubscriptionidResourcegroupsResourcegroupnameProvidersMicrosoftWebValidatecontainersettingsPostResponses200ContentApplicationJsonSchema
