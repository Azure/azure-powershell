...
online version: https://docs.microsoft.com/powershell/module/az.appservice/new-azwebappvnetconnection
schema: 2.0.0
---
...
```
New-AzWebAppVnetConnection -Name <String> -ResourceGroupName <String> -VnetName <String>
