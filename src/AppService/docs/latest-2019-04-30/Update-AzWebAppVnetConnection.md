...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/update-azwebappvnetconnection
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-AzWebAppVnetConnection -InputObject <IAppServiceIdentity> -ConnectionEnvelope <IVnetInfo>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzWebAppVnetConnection -InputObject <IAppServiceIdentity> [-CertBlob <String>] [-DnsServer <String>]
