...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/set-azappserviceenvironmentworkerpool
schema: 2.0.0
---
...
```
Set-AzAppServiceEnvironmentWorkerPool -Name <String> -ResourceGroupName <String> -WorkerPoolName <String>
