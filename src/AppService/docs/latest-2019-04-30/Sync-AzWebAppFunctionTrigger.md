...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/sync-azwebappfunctiontrigger
schema: 2.0.0
---
...
### Sync (Default)
```
Sync-AzWebAppFunctionTrigger -Name <String> -ResourceGroupName <String> -SubscriptionId <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SyncViaIdentity
```
Sync-AzWebAppFunctionTrigger -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
