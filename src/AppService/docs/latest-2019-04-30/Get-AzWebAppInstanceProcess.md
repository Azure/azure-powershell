...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/get-azwebappinstanceprocess
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppInstanceProcess -InputObject <IWebSiteIdentity> [-PassThru] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
