...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/test-azappserviceglobalhostingenvironment
schema: 2.0.0
---

# Test-AzAppServiceGlobalHostingEnvironment
...
### IsViaIdentity
```
Test-AzAppServiceGlobalHostingEnvironment -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
