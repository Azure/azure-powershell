...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/get-azappserviceplanvnetgateway
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzAppServicePlanVnetGateway -InputObject <IWebSiteIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
