...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/get-azappserviceplanhybridconnection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzAppServicePlanHybridConnection -InputObject <IWebSiteIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
