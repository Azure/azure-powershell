...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azappserviceplanhybridconnection
schema: 2.0.0
---

# Get-AzAppServicePlanHybridConnection
...
### GetViaIdentity
```
Get-AzAppServicePlanHybridConnection -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
