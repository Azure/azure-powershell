...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/new-azwebapprelayserviceconnection
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-AzWebAppRelayServiceConnection -InputObject <IAppServiceIdentity>
...
```
New-AzWebAppRelayServiceConnection -InputObject <IAppServiceIdentity> [-EntityName <String>]
