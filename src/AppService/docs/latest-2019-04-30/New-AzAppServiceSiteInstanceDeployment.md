...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/new-azappservicesiteinstancedeployment
schema: 2.0.0
---

# New-AzAppServiceSiteInstanceDeployment
...
### CreateViaIdentity
```
New-AzAppServiceSiteInstanceDeployment -InputObject <IAppServiceIdentity> -Deployment <IDeployment>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzAppServiceSiteInstanceDeployment -InputObject <IAppServiceIdentity> -Location <String> [-Id <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20150801.IDeployment
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20150801.IDeployment
