...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/update-azappservicedomainownershipidentifier
schema: 2.0.0
---

# Update-AzAppServiceDomainOwnershipIdentifier
...
```
Update-AzAppServiceDomainOwnershipIdentifier -DomainName <String> -Name <String> -ResourceGroupName <String>
...
### UpdateViaIdentity
```
Update-AzAppServiceDomainOwnershipIdentifier -InputObject <IAppServiceIdentity>
...
```
Update-AzAppServiceDomainOwnershipIdentifier -InputObject <IAppServiceIdentity> [-Kind <String>]
