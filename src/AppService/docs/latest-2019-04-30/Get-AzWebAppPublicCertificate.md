...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebapppubliccertificate
schema: 2.0.0
---

# Get-AzWebAppPublicCertificate
...
### GetViaIdentity
```
Get-AzWebAppPublicCertificate -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
