...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/get-azwebapppubliccertificate
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppPublicCertificate -InputObject <IWebSiteIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
