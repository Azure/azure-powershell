...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/test-azappservicemove
schema: 2.0.0
---

# Test-AzAppServiceMove
...
### ValidateViaIdentity
```
Test-AzAppServiceMove -InputObject <IAppServiceIdentity> -MoveResourceEnvelope <ICsmMoveResourceEnvelope>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ValidateViaIdentityExpanded
```
Test-AzAppServiceMove -InputObject <IAppServiceIdentity> [-Resource <String[]>]
 [-TargetResourceGroup <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20180201.ICsmMoveResourceEnvelope
...
### Microsoft.Azure.PowerShell.Cmdlets.AppService.Models.Api20180201.ICsmMoveResourceEnvelope
