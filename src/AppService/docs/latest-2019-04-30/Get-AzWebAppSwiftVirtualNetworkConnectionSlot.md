...
online version: https://docs.microsoft.com/powershell/module/az.appservice/get-azwebappswiftvirtualnetworkconnectionslot
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppSwiftVirtualNetworkConnectionSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
