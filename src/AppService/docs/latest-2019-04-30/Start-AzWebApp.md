...
### StartBySiteObject
```
Start-AzWebApp -SiteObject <ISite> [-SubscriptionId <String>] [-PassThru] [-DefaultProfile <PSObject>]
...
### StartViaIdentity
```
Start-AzWebApp -InputObject <IAppServiceIdentity> [-PassThru] [-DefaultProfile <PSObject>] [-Confirm]
...
Parameter Sets: StartBySiteObject
...
```yaml
Type: System.String
Parameter Sets: Start, StartBySiteObject, StartSlot
Aliases:
