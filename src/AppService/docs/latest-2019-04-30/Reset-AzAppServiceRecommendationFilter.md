...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/reset-azappservicerecommendationfilter
schema: 2.0.0
---

# Reset-AzAppServiceRecommendationFilter
...
### ResetViaIdentity
```
Reset-AzAppServiceRecommendationFilter -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ResetViaIdentity1
```
Reset-AzAppServiceRecommendationFilter -InputObject <IAppServiceIdentity> -EnvironmentName <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
