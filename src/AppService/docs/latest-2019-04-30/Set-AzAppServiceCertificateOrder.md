...
online version: https://docs.microsoft.com/powershell/module/az.appservice/set-azappservicecertificateorder
schema: 2.0.0
---
...
```
Set-AzAppServiceCertificateOrder -CertificateOrderName <String> -ResourceGroupName <String> -Location <String>
