...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/test-azwebappcustomhostnameslot
schema: 2.0.0
---
...
### AnalyzeViaIdentity
```
Test-AzWebAppCustomHostnameSlot -InputObject <IAppServiceIdentity> [-HostName <String>]
