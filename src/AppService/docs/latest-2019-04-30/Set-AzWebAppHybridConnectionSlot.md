...
### Update (Default)
```
Set-AzWebAppHybridConnectionSlot -Name <String> -NamespaceName <String> -ResourceGroupName <String>
...
```
Set-AzWebAppHybridConnectionSlot -InputObject <IWebSiteIdentity> [-RelayName <String>] [-Hostname <String>]
