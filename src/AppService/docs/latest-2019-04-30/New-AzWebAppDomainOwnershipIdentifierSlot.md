...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/new-azwebappdomainownershipidentifierslot
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-AzWebAppDomainOwnershipIdentifierSlot -InputObject <IAppServiceIdentity>
...
```
New-AzWebAppDomainOwnershipIdentifierSlot -InputObject <IAppServiceIdentity> [-Kind <String>]
 [-PropertiesId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
