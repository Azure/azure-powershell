...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/get-azwebappslotmetric
schema: 2.0.0
---
...
```
Get-AzWebAppSlotMetric -Name <String> -ResourceGroupName <String> -Slot <String> -SubscriptionId <String[]>
