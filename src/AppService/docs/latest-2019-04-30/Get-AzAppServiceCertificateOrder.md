...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azappservicecertificateorder
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzAppServiceCertificateOrder -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
