...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azappserviceenvironmentworkerpool
schema: 2.0.0
---

# Get-AzAppServiceEnvironmentWorkerPool
...
### GetViaIdentity
```
Get-AzAppServiceEnvironmentWorkerPool -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
