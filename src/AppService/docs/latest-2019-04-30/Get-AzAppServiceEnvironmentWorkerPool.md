...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/get-azappserviceenvironmentworkerpool
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzAppServiceEnvironmentWorkerPool -InputObject <IWebSiteIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
