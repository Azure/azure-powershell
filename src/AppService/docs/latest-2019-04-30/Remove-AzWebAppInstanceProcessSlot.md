...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/remove-azwebappinstanceprocessslot
schema: 2.0.0
---

# Remove-AzWebAppInstanceProcessSlot
...
### DeleteViaIdentity
```
Remove-AzWebAppInstanceProcessSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
