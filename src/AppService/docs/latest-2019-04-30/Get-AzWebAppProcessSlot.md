...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/get-azwebappprocessslot
schema: 2.0.0
---

# Get-AzWebAppProcessSlot
...
### GetViaIdentity
```
Get-AzWebAppProcessSlot -InputObject <IWebSiteIdentity> [-PassThru] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.WebSite.Models.Api20180201.IProcessInfo
