...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azwebappprivateaccess
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzWebAppPrivateAccess -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
