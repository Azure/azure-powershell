...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/new-azwebapppublishingpassword
schema: 2.0.0
---

# New-AzWebAppPublishingPassword
...
### GenerateBySiteObject
```
New-AzWebAppPublishingPassword -SiteObject <ISite> [-SubscriptionId <String>] [-PassThru]
...
### GenerateViaIdentity
```
New-AzWebAppPublishingPassword -InputObject <IAppServiceIdentity> [-PassThru] [-DefaultProfile <PSObject>]
...
Parameter Sets: GenerateBySiteObject
...
If a slot is not specified, the API generate a new publishing password for the production slot.

```yaml
Type: System.String
Parameter Sets: GenerateSlot
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Generate, GenerateBySiteObject, GenerateSlot
Aliases:
