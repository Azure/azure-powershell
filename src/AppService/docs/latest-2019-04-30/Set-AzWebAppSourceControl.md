...
online version: https://docs.microsoft.com/powershell/module/az.appservice/set-azwebappsourcecontrol
schema: 2.0.0
---
...
### Update
```
Set-AzWebAppSourceControl -Name <String> -ResourceGroupName <String> -SiteSourceControl <ISiteSourceControl>
