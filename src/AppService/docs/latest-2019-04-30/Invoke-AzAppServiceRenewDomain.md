...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/invoke-azappservicerenewdomain
schema: 2.0.0
---

# Invoke-AzAppServiceRenewDomain
...
### RenewViaIdentity
```
Invoke-AzAppServiceRenewDomain -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
