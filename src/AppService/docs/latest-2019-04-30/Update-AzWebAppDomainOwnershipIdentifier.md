...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/update-azwebappdomainownershipidentifier
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-AzWebAppDomainOwnershipIdentifier -InputObject <IAppServiceIdentity>
...
```
Update-AzWebAppDomainOwnershipIdentifier -InputObject <IAppServiceIdentity> [-Kind <String>]
