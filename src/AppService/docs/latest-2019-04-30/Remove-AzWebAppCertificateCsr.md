...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/remove-azwebappcertificatecsr
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzWebAppCertificateCsr -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-Confirm]
