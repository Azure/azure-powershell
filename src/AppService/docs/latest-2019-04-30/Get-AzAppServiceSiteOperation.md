...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/get-azappservicesiteoperation
schema: 2.0.0
---

# Get-AzAppServiceSiteOperation
...
### GetViaIdentity
```
Get-AzAppServiceSiteOperation -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
