...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appservice/stop-azwebappcontinuouwebjobslot
schema: 2.0.0
---

# Stop-AzWebAppContinuouWebJobSlot
...
### Stop (Default)
```
Stop-AzWebAppContinuouWebJobSlot -Name <String> -ResourceGroupName <String> -Slot <String>
...
### StopViaIdentity
```
Stop-AzWebAppContinuouWebJobSlot -InputObject <IAppServiceIdentity> [-DefaultProfile <PSObject>] [-PassThru]
