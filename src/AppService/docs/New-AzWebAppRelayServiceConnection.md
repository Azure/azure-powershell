...
### Create (Default)
```
New-AzWebAppRelayServiceConnection -EntityName <String> -Name <String> -ResourceGroupName <String>
...
```
New-AzWebAppRelayServiceConnection [-EntityName <String>] -InputObject <IWebSiteIdentity>
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/new-azwebapprelayserviceconnection](https://docs.microsoft.com/en-us/powershell/module/az.website/new-azwebapprelayserviceconnection)
