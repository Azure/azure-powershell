...
New-AzWebAppDeploymentSlot -Id <String> -Name <String> -ResourceGroupName <String> -Slot <String>
 ...
 [-Status <Int32>] [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzWebAppDeploymentSlot -InputObject <IWebSiteIdentity> [-Active <Boolean>] [-Author <String>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/new-azwebappdeploymentslot](https://docs.microsoft.com/en-us/powershell/module/az.website/new-azwebappdeploymentslot)
