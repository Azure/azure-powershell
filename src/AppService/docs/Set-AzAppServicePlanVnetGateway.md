...
```
Set-AzAppServicePlanVnetGateway [-VnetName <String>] -InputObject <IWebSiteIdentity> [-Kind <String>]
 -VpnPackageUri <String> [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/set-azappserviceplanvnetgateway](https://docs.microsoft.com/en-us/powershell/module/az.website/set-azappserviceplanvnetgateway)
