...
```
Update-AzWebAppSlot -InputObject <IWebSiteIdentity> [-ClientAffinityEnabled <Boolean>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/update-azwebappslot](https://docs.microsoft.com/en-us/powershell/module/az.website/update-azwebappslot)
