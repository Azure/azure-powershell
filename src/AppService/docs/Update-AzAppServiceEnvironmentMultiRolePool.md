...
### Update (Default)
```
Update-AzAppServiceEnvironmentMultiRolePool -Name <String> -ResourceGroupName <String> -SubscriptionId <String>
 [-MultiRolePoolEnvelope <IWorkerPoolResource>] [-PassThru] [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Update-AzAppServiceEnvironmentMultiRolePool -Name <String> -ResourceGroupName <String> -SubscriptionId <String>
 ...
 [-WorkerSizeId <Int32>] [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/update-azappserviceenvironmentmultirolepool](https://docs.microsoft.com/en-us/powershell/module/az.website/update-azappserviceenvironmentmultirolepool)
