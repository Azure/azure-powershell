...
```
Get-AzWebSiteGeoRegion -SubscriptionId <String[]> [-LinuxDynamicWorkersEnabled <Boolean>]
 [-LinuxWorkersEnabled <Boolean>] [-Sku <SkuName>] [-XenonWorkersEnabled <Boolean>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/get-azwebsitegeoregion](https://docs.microsoft.com/en-us/powershell/module/az.website/get-azwebsitegeoregion)
