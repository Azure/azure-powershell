...
online version: https://docs.microsoft.com/en-us/powershell/module/az.website/get-azappserviceenvironmentmetric
schema: 2.0.0
---

# Get-AzAppServiceEnvironmentMetric
...
Get-AzAppServiceEnvironmentMetric -Name <String> -ResourceGroupName <String> -SubscriptionId <String[]>
 [-Detail <Boolean>] [-Filter <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/az.website/get-azappserviceenvironmentmetric](https://docs.microsoft.com/en-us/powershell/module/az.website/get-azappserviceenvironmentmetric)
