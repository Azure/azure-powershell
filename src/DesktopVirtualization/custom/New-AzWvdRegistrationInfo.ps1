...
function New-AzWvdRegistrationInfo {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20210903preview.IRegistrationInfo')]
    ...
    process {
        ...
        New-Object -TypeName 'Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20210903preview.RegistrationInfo' `
            -Property @{ `
