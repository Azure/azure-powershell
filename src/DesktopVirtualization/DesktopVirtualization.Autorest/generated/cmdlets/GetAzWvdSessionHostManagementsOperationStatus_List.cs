...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHostManagements/default/operationStatuses"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzWvdSessionHostManagementsOperationStatus_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHostManagements/default/operationStatuses", ApiVersion = "2024-01-16-preview")]
    public partial class GetAzWvdSessionHostManagementsOperationStatus_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Action type for the Operation Status list to be filtered on. Valid actions are: start | retry | pause | resume | cancel).")]
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Action type for the Operation Status list to be filtered on. Valid actions are: start | retry | pause | resume | cancel).",
        ...
        /// <summary>CorrelationId of the sessionHostManagement operations to be returned.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "CorrelationId of the sessionHostManagement operations to be returned.")]
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"CorrelationId of the sessionHostManagement operations to be returned.",
        ...
        /// <summary>Backing field for <see cref="IsInitiatingOperation" /> property.</summary>
        private global::System.Management.Automation.SwitchParameter _isInitiatingOperation;

        /// <summary>
        /// Filter option to only return operations that initiated a sessionHostManagement operation.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Filter option to only return operations that initiated a sessionHostManagement operation.")]
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Filter option to only return operations that initiated a sessionHostManagement operation.",
        SerializedName = @"isInitiatingOperation",
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.ParameterCategory.Query)]
        public global::System.Management.Automation.SwitchParameter IsInitiatingOperation { get => this._isInitiatingOperation; set => this._isInitiatingOperation = value; }
        ...
        /// <summary>Returns the most recent sessionHostManagement operation.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Returns the most recent sessionHostManagement operation.")]
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Returns the most recent sessionHostManagement operation.",
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Filter based on the type of sessionHostManagement operation. Valid values are 'InitiateSessionHostUpdate' and 'ValidateSessionHostUpdate'")]
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Filter based on the type of sessionHostManagement operation. Valid values are 'InitiateSessionHostUpdate' and 'ValidateSessionHostUpdate'",
        SerializedName = @"type",
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.ParameterCategory.Query)]
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20240116Preview.ISessionHostManagementOperationStatusList">Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20240116Preview.ISessionHostManagementOperationStatusList</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20240116Preview.ISessionHostManagementOperationStatusList> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzWvdSessionHostManagementsOperationStatus_List" /> cmdlet class.
        /// </summary>
        public GetAzWvdSessionHostManagementsOperationStatus_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SessionHostManagementsOperationStatusList(SubscriptionId, ResourceGroupName, HostPoolName, this.InvocationInformation.BoundParameters.ContainsKey("IsLatest") ? IsLatest : default(global::System.Management.Automation.SwitchParameter?), this.InvocationInformation.BoundParameters.ContainsKey("Type") ? Type : null, this.InvocationInformation.BoundParameters.ContainsKey("IsNonTerminal") ? IsNonTerminal : default(global::System.Management.Automation.SwitchParameter?), this.InvocationInformation.BoundParameters.ContainsKey("CorrelationId") ? CorrelationId : null, this.InvocationInformation.BoundParameters.ContainsKey("Action") ? Action : null, this.InvocationInformation.BoundParameters.ContainsKey("IsInitiatingOperation") ? IsInitiatingOperation : default(global::System.Management.Automation.SwitchParameter?), onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,HostPoolName=HostPoolName,IsLatest=this.InvocationInformation.BoundParameters.ContainsKey("IsLatest") ? IsLatest : default(global::System.Management.Automation.SwitchParameter?),Type=this.InvocationInformation.BoundParameters.ContainsKey("Type") ? Type : null,IsNonTerminal=this.InvocationInformation.BoundParameters.ContainsKey("IsNonTerminal") ? IsNonTerminal : default(global::System.Management.Automation.SwitchParameter?),CorrelationId=this.InvocationInformation.BoundParameters.ContainsKey("CorrelationId") ? CorrelationId : null,Action=this.InvocationInformation.BoundParameters.ContainsKey("Action") ? Action : null,IsInitiatingOperation=this.InvocationInformation.BoundParameters.ContainsKey("IsInitiatingOperation") ? IsInitiatingOperation : default(global::System.Management.Automation.SwitchParameter?)})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20240116Preview.ISessionHostManagementOperationStatusList> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.SessionHostManagementsOperationStatusList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
