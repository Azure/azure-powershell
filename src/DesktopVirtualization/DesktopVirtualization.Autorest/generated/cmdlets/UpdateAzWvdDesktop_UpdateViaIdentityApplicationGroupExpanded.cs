...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/applicationGroups/{applicationGroupName}/desktops/{desktopName}", ApiVersion = "2024-04-03")]
    public partial class UpdateAzWvdDesktop_UpdateViaIdentityApplicationGroupExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IDesktopPatch _desktopBody = new Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.DesktopPatch();
        ...
        /// <summary>Backing field for <see cref="ApplicationGroupInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IDesktopVirtualizationIdentity _applicationGroupInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IDesktopVirtualizationIdentity ApplicationGroupInputObject { get => this._applicationGroupInputObject; set => this._applicationGroupInputObject = value; }
        ...
        public string Description { get => _desktopBody.Description ?? null; set => _desktopBody.Description = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string FriendlyName { get => _desktopBody.FriendlyName ?? null; set => _desktopBody.FriendlyName = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IDesktop">Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IDesktop</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IDesktop> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ApplicationGroupInputObject?.Id != null)
                    {
                        this.ApplicationGroupInputObject.Id += $"/desktops/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.DesktopsUpdateViaIdentity(ApplicationGroupInputObject.Id, _desktopBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == ApplicationGroupInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ApplicationGroupInputObject has null value for ApplicationGroupInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ApplicationGroupInputObject) );
                        }
                        if (null == ApplicationGroupInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ApplicationGroupInputObject has null value for ApplicationGroupInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ApplicationGroupInputObject) );
                        }
                        if (null == ApplicationGroupInputObject.ApplicationGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ApplicationGroupInputObject has null value for ApplicationGroupInputObject.ApplicationGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ApplicationGroupInputObject) );
                        }
                        await this.Client.DesktopsUpdate(ApplicationGroupInputObject.SubscriptionId ?? null, ApplicationGroupInputObject.ResourceGroupName ?? null, ApplicationGroupInputObject.ApplicationGroupName ?? null, Name, _desktopBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzWvdDesktop_UpdateViaIdentityApplicationGroupExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzWvdDesktop_UpdateViaIdentityApplicationGroupExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IDesktop> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IDesktop
