...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzWvdInitiateSessionHostUpdate_PostViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Description(@"Initiates a hostpool update or schedule an update for the future.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHostManagements/default/initiateSessionHostUpdate", ApiVersion = "2024-01-16-preview")]
    public partial class InvokeAzWvdInitiateSessionHostUpdate_PostViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="UpdateSessionHostsRequestBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20240116Preview.IUpdateSessionHostsRequestBody _updateSessionHostsRequestBody;

        /// <summary>
        /// Object containing the definition for properties to be used for a sessionHostUpdate operation.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Object containing the definition for properties to be used for a sessionHostUpdate operation.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Object containing the definition for properties to be used for a sessionHostUpdate operation.",
        SerializedName = @"updateSessionHostsRequestBody",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20240116Preview.IUpdateSessionHostsRequestBody) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20240116Preview.IUpdateSessionHostsRequestBody UpdateSessionHostsRequestBody { get => this._updateSessionHostsRequestBody; set => this._updateSessionHostsRequestBody = value; }
        ...
        /// <returns>a duplicate instance of InvokeAzWvdInitiateSessionHostUpdate_PostViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Cmdlets.InvokeAzWvdInitiateSessionHostUpdate_PostViaIdentity Clone()
        {
            var clone = new InvokeAzWvdInitiateSessionHostUpdate_PostViaIdentity();
            ...
            clone.UpdateSessionHostsRequestBody = this.UpdateSessionHostsRequestBody;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzWvdInitiateSessionHostUpdate_PostViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeAzWvdInitiateSessionHostUpdate_PostViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.InitiateSessionHostUpdatePostViaIdentity(InputObject.Id, UpdateSessionHostsRequestBody, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.InitiateSessionHostUpdatePost(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.HostPoolName ?? null, UpdateSessionHostsRequestBody, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=UpdateSessionHostsRequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api40.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=UpdateSessionHostsRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=UpdateSessionHostsRequestBody })
                    {
