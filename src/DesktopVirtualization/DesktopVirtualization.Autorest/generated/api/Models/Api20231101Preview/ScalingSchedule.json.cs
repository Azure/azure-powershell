...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview
{
    ...
    public partial class ScalingSchedule
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.IScalingSchedule.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.IScalingSchedule.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.IScalingSchedule FromJson(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonNode node)
        {
        ...
        internal ScalingSchedule(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonObject json)
        {
            ...
            {_rampUpStartTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonObject>("rampUpStartTime"), out var __jsonRampUpStartTime) ? Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.Time.FromJson(__jsonRampUpStartTime) : RampUpStartTime;}
            {_peakStartTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonObject>("peakStartTime"), out var __jsonPeakStartTime) ? Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.Time.FromJson(__jsonPeakStartTime) : PeakStartTime;}
            {_rampDownStartTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonObject>("rampDownStartTime"), out var __jsonRampDownStartTime) ? Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.Time.FromJson(__jsonRampDownStartTime) : RampDownStartTime;}
            {_offPeakStartTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonObject>("offPeakStartTime"), out var __jsonOffPeakStartTime) ? Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.Time.FromJson(__jsonOffPeakStartTime) : OffPeakStartTime;}
