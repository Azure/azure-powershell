...
``` yaml
commit: e68adf57cd106969943259100859283004f6d56c
require:
  - $(this-folder)/../../readme.azure.noprofile.md
sanitize-names: true
subject-prefix: 'Wvd'
input-file:
- $(repo)/specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/DesktopVirtualization/preview/2025-11-01-preview/desktopvirtualization.json
