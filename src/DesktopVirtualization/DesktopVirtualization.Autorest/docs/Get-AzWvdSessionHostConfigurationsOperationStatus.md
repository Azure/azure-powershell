...
```
Get-AzWvdSessionHostConfigurationsOperationStatus -HostPoolInputObject <IDesktopVirtualizationIdentity>
...
### Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.ISessionHostConfigurationOperationStatus
