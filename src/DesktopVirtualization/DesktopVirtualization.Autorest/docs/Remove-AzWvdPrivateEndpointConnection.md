...
```
Remove-AzWvdPrivateEndpointConnection -HostPoolInputObject <IDesktopVirtualizationIdentity> -Name <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Delete, Delete1, DeleteViaIdentityHostPool, DeleteViaIdentityWorkspace
