...
online version: https://learn.microsoft.com/powershell/module/az.desktopvirtualization/remove-azwvdworkspace
schema: 2.0.0
---
...
### Example 1: Delete a Azure Virtual Desktop Workspace by name
```powershell
