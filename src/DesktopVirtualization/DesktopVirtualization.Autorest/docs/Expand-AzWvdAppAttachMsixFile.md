...
Expand-AzWvdAppAttachMsixFile -AppAttachPackageName <String> -ResourceGroupName <String>
 ...
 [-OutputFileType <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Expand-AzWvdAppAttachMsixFile -AppAttachPackageName <String> -ResourceGroupName <String>
 -Body <IExpandMsixFileRequest> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
### ExpandViaJsonString
```
Expand-AzWvdAppAttachMsixFile -AppAttachPackageName <String> -ResourceGroupName <String> -JsonString <String>
