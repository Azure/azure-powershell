...
Identity Parameter
To construct, see NOTES section for SCALINGPLANINPUTOBJECT properties and create a hash table.
...
To construct, see NOTES section for SCALINGPLANSCHEDULE properties and create a hash table.
