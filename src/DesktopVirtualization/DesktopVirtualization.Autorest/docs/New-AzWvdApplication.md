...
```
New-AzWvdApplication -ApplicationGroupInputObject <IDesktopVirtualizationIdentity>
 -CommandLineSetting <String> -Name <String> [-Description <String>] [-FriendlyName <String>] [-ShowInPortal]
