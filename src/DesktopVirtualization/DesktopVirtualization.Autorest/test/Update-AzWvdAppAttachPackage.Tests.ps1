...
Describe 'Update-AzWvdAppAttachPackage' {
    It 'UpdateWithNewFields' {
        # Covers the 2026-04-16 patch fields: CustomData, PackageLookbackUrl, Tag.
        # Self-contained (only needs ResourceGroup).
        try {
            ...
            $null = New-AzWvdAppAttachPackage -Name "TestPackageNewFields" `
            ...
            Update-AzWvdAppAttachPackage -Name "TestPackageNewFields" `
                -ResourceGroupName $env.ResourceGroup `
                -SubscriptionId $env.SubscriptionId `
    ...
    It 'UpdateExpanded' {
        try {
            ...
            $apps2 = @( [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IMsixPackageApplications]@{appId = 'MsixTest_Application_Id2'; description = 'testing from ps'; appUserModelID = 'MsixTest_Application_ModelID'; friendlyName = 'some name'; iconImageName = 'Apptile'; rawIcon = $data1; rawPng = $data1 })
            $deps2 = @( [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IMsixPackageDependencies]@{dependencyName = 'MsixTest_Dependency_Name2'; publisher = 'MsixTest_Dependency_Publisher'; minVersion = '0.0.0.42' })   
