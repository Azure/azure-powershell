...
Describe 'Update-AzWvdAppAttachPackage' {
    It 'UpdateExpanded' {
        try {
            ...
            $apps2 = @( [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20240306Preview.IMsixPackageApplications]@{appId = 'MsixTest_Application_Id2'; description = 'testing from ps'; appUserModelID = 'MsixTest_Application_ModelID'; friendlyName = 'some name'; iconImageName = 'Apptile'; rawIcon = $data1; rawPng = $data1 })
            $deps2 = @( [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20240306Preview.IMsixPackageDependencies]@{dependencyName = 'MsixTest_Dependency_Name2'; publisher = 'MsixTest_Dependency_Publisher'; minVersion = '0.0.0.42' })   
