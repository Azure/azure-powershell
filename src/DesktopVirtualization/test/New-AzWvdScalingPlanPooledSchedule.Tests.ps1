if(($null -eq $TestName) -or ($TestName -contains 'New-AzWvdScalingPlanPooledSchedule'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-AzWvdScalingPlanPooledSchedule.Recording.json'
