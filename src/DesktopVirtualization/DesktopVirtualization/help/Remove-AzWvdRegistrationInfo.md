...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.desktopvirtualization/remove-azwvdregistrationinfo
...
```
Remove-AzWvdRegistrationInfo -HostPoolName <String> -ResourceGroupName <String>
...
```
Remove-AzWvdRegistrationInfo -ResourceGroupName <string> -HostPoolName <string>
