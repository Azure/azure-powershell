...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.desktopvirtualization/get-azwvddesktop
...
```
Get-AzWvdDesktop -ApplicationGroupName <string> -ResourceGroupName <string>
