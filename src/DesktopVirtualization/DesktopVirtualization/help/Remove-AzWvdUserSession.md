...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.desktopvirtualization/remove-azwvdusersession
...
Remove-AzWvdUserSession -HostPoolName <string> -Id <string> -ResourceGroupName <string>
 -SessionHostName <string> [-SubscriptionId <string>] [-Force] [-DefaultProfile <psobject>]
...
```
Remove-AzWvdUserSession -InputObject <IDesktopVirtualizationIdentity> [-Force]
...
Remove-AzWvdUserSession -Id <string> -SessionHostName <string>
 -HostPoolInputObject <IDesktopVirtualizationIdentity> [-Force] [-DefaultProfile <psobject>]
 [-PassThru] [-WhatIf] [-Confirm]
```
...
```
Remove-AzWvdUserSession -Id <string> -SessionHostInputObject <IDesktopVirtualizationIdentity>
...
- UserSessionId
ParameterSets:
- Name: DeleteViaIdentitySessionHost
  Position: Named
  IsRequired: true
  ValueFromPipeline: false
  ValueFromPipelineByPropertyName: false
