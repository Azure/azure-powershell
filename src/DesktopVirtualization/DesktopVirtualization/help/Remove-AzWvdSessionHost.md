...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.desktopvirtualization/remove-azwvdsessionhost
...
```
Remove-AzWvdSessionHost -InputObject <IDesktopVirtualizationIdentity> [-Force]
...
```
Remove-AzWvdSessionHost -Name <string> -HostPoolInputObject <IDesktopVirtualizationIdentity>
 [-Force] [-DefaultProfile <psobject>] [-PassThru] [-WhatIf] [-Confirm]
```
