...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.desktopvirtualization/update-azwvddesktop
...
Update-AzWvdDesktop -Name <string> -ApplicationGroupInputObject <IDesktopVirtualizationIdentity>
 -Desktop <IDesktopPatch> [-DefaultProfile <psobject>] [-WhatIf] [-Confirm]
```
...
```
Update-AzWvdDesktop -Name <string> -ApplicationGroupInputObject <IDesktopVirtualizationIdentity>
 [-Description <string>] [-FriendlyName <string>] [-DefaultProfile <psobject>] [-WhatIf] [-Confirm]
```
...
Update-AzWvdDesktop -InputObject <IDesktopVirtualizationIdentity> [-Description <string>]
 [-FriendlyName <string>] [-DefaultProfile <psobject>] [-WhatIf] [-Confirm]
```
