...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.desktopvirtualization/get-azwvdsessionhostmanagement
...
```
Get-AzWvdSessionHostManagement -HostPoolName <String> -ResourceGroupName <String>
...
```
Get-AzWvdSessionHostManagement -InputObject <IDesktopVirtualizationIdentity>
