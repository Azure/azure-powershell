...
New-AzWvdSessionHostManagement -HostPoolName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-UpdateDeleteOriginalVM] [-UpdateLogOffMessage <String>] [-DefaultProfile <PSObject>]
...
[https://learn.microsoft.com/powershell/module/az.desktopvirtualization/new-azwvdsessionhostmanagement](https://learn.microsoft.com/powershell/module/az.desktopvirtualization/new-azwvdsessionhostmanagement)
