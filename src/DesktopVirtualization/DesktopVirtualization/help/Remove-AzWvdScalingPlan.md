...
external help file: 
HelpUri: https://learn.microsoft.com/powershell/module/az.desktopvirtualization/remove-azwvdscalingplan
...
```
Remove-AzWvdScalingPlan -InputObject <IDesktopVirtualizationIdentity> [-DefaultProfile <psobject>]
