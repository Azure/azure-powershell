...
-->
## Upcoming Release
* Upgrade API version to 2025-09-01-preview
    - Added MSI Identity definition in HostPool update command.
    - Support AllowRDPShortPathWithPrivateLink in HostPool Resource.
    - Build on top of the API-Spec which generated by TypeSpec.
