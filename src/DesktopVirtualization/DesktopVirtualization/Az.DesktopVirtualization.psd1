...
FunctionsToExport = 'Disconnect-AzWvdUserSession', 'Expand-AzWvdAppAttachMsixFile', 
               'Expand-AzWvdMsixImage', 'Get-AzWvdActiveSessionHostConfiguration', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Upgrade API version to 2025-11-01-preview
