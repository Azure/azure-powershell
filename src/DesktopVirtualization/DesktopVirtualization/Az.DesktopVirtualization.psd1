...
FunctionsToExport = 'Disconnect-AzWvdUserSession', 'Expand-AzWvdMsixImage', 
               ...
               'Get-AzWvdSessionHostProvisioningStatus', 'Get-AzWvdStartMenuItem', 
               'Get-AzWvdUserSession', 'Get-AzWvdWorkspace', 
               ...
               'Update-AzWvdPrivateEndpointConnection', 'Update-AzWvdScalingPlan', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Upgrade API version to 2024-11-01-preview
