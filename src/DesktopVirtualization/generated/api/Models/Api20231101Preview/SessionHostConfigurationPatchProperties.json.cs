...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview
{
    ...
    public partial class SessionHostConfigurationPatchProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.ISessionHostConfigurationPatchProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.ISessionHostConfigurationPatchProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.ISessionHostConfigurationPatchProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonNode node)
        {
        ...
        internal SessionHostConfigurationPatchProperties(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonObject json)
        {
            ...
            {_diskInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonObject>("diskInfo"), out var __jsonDiskInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.DiskInfoPatchProperties.FromJson(__jsonDiskInfo) : DiskInfo;}
            {_imageInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonObject>("imageInfo"), out var __jsonImageInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.ImageInfoPatchProperties.FromJson(__jsonImageInfo) : ImageInfo;}
            {_domainInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonObject>("domainInfo"), out var __jsonDomainInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.DomainInfoPatchProperties.FromJson(__jsonDomainInfo) : DomainInfo;}
            {_securityInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonObject>("securityInfo"), out var __jsonSecurityInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.SecurityInfoPatchProperties.FromJson(__jsonSecurityInfo) : SecurityInfo;}
            {_vMAdminCredentials = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonObject>("vmAdminCredentials"), out var __jsonVMAdminCredentials) ? Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.KeyVaultCredentialsPatchProperties.FromJson(__jsonVMAdminCredentials) : VMAdminCredentials;}
            {_bootDiagnosticsInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonObject>("bootDiagnosticsInfo"), out var __jsonBootDiagnosticsInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.BootDiagnosticsInfoPatchProperties.FromJson(__jsonBootDiagnosticsInfo) : BootDiagnosticsInfo;}
            ...
            {_vMTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Json.JsonObject>("vmTags"), out var __jsonVMTags) ? Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20231101Preview.SessionHostConfigurationPatchPropertiesVMTags.FromJson(__jsonVMTags) : VMTag;}
