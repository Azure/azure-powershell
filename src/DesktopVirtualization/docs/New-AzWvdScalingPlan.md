...
Please create a scaling plan, and then use New-AzWvdScalingPersonalSchedule and New-AzWvdScalingPooledSchedule to assign schedules after scaling plan creation.
