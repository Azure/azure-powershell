...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20200921Preview.IMsixPackageApplications[]
Parameter Sets: CreateExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api20200921Preview.IMsixPackageDependencies[]
Parameter Sets: CreateExpanded
Aliases:
