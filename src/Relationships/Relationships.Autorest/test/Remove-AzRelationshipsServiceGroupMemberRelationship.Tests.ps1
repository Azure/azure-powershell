if(($null -eq $TestName) -or ($TestName -contains 'Remove-AzRelationshipsServiceGroupMemberRelationship'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Remove-AzRelationshipsServiceGroupMemberRelationship.Recording.json'
