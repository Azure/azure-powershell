            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.WorkbooksGet(SubscriptionId, ResourceGroupName, Name, this.InvocationInformation.BoundParameters.ContainsKey("CanFetchContent") ? CanFetchContent : default(global::System.Management.Automation.SwitchParameter?), onOk, onDefault, this, Pipeline);
