...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20150501
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="ApplicationInsightsComponentQuotaStatus"
    /// />
    /// </summary>
    public partial class ApplicationInsightsComponentQuotaStatusTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <paramref name="sourceValue"/> parameter to the <see cref="ApplicationInsightsComponentQuotaStatus"/>
        /// type.
        /// </summary>
        /// <param name="sourceValue">the <see cref="System.Object" /> instance to check if it can be converted to the <see cref="ApplicationInsightsComponentQuotaStatus"
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="ApplicationInsightsComponentQuotaStatus" /> type, otherwise
        /// <c>false</c>
        /// </returns>
