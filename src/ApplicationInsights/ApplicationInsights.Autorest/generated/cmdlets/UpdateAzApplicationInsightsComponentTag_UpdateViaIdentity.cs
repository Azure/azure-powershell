...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzApplicationInsightsComponentTag_UpdateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzApplicationInsightsComponentTag_UpdateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ComponentTag" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api202002.ITagsResource _componentTag;

        /// <summary>
        /// A container holding only the Tags for a resource, allowing the user to update the tags on a WebTest instance.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "A container holding only the Tags for a resource, allowing the user to update the tags on a WebTest instance.", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api202002.ITagsResource) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api202002.ITagsResource ComponentTag { get => this._componentTag; set => this._componentTag = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ComponentsUpdateTagsViaIdentity(InputObject.Id, ComponentTag, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ComponentsUpdateTags(InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.ResourceName ?? null, ComponentTag, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ComponentTag})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzApplicationInsightsComponentTag_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzApplicationInsightsComponentTag_UpdateViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api202002.IErrorResponseComponents> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ComponentTag })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ComponentTag })
                    {
