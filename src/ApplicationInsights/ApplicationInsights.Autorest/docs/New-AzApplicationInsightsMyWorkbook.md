...
New-AzApplicationInsightsMyWorkbook -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-LinkedSourceId <String>] [-Category <String>] [-DisplayName <String>] [-EnableSystemAssignedIdentity]
 [-Etag <Hashtable>] [-Id <String>] [-Location <String>] [-SerializedData <String>] [-SourceId <String>]
...
```
New-AzApplicationInsightsMyWorkbook -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
 [-SubscriptionId <String>] [-LinkedSourceId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaJsonString
```
New-AzApplicationInsightsMyWorkbook -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-LinkedSourceId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
