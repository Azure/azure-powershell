...
```
Update-AzApplicationInsightsWorkbook -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### UpdateViaJsonString
```
Update-AzApplicationInsightsWorkbook -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-LinkedSourceId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
