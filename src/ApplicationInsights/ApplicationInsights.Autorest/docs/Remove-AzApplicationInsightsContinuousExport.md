...
```
Remove-AzApplicationInsightsContinuousExport -ComponentInputObject <IApplicationInsightsIdentity>
 -ExportId <String> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
