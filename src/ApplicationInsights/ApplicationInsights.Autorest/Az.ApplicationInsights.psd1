@{
  ...
  FunctionsToExport = 'Get-AzApplicationInsightsWebTest', 'New-AzApplicationInsightsHeaderFieldObject', 'New-AzApplicationInsightsWebTest', 'New-AzApplicationInsightsWebTestGeolocationObject', 'Remove-AzApplicationInsightsWebTest', 'Update-AzApplicationInsightsWebTestTag', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
