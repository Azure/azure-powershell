@{
  ...
  FunctionsToExport = 'Clear-AzApplicationInsights', 'Get-AzApplicationInsights', 'Get-AzApplicationInsightsAnnotation', 'Get-AzApplicationInsightsApiKey', 'Get-AzApplicationInsightsComponentAvailableFeature', 'Get-AzApplicationInsightsComponentFeatureCapability', 'Get-AzApplicationInsightsComponentPurgeStatus', 'Get-AzApplicationInsightsContinuousExport', 'Get-AzApplicationInsightsLinkedStorageAccount', 'Get-AzApplicationInsightsWebTest', 'New-AzApplicationInsights', 'New-AzApplicationInsightsAnnotation', 'New-AzApplicationInsightsApiKey', 'New-AzApplicationInsightsContinuousExport', 'New-AzApplicationInsightsLinkedStorageAccount', 'New-AzApplicationInsightsWebTest', 'New-AzApplicationInsightsWebTestGeolocationObject', 'New-AzApplicationInsightsWebTestHeaderFieldObject', 'Remove-AzApplicationInsights', 'Remove-AzApplicationInsightsAnnotation', 'Remove-AzApplicationInsightsApiKey', 'Remove-AzApplicationInsightsContinuousExport', 'Remove-AzApplicationInsightsLinkedStorageAccount', 'Remove-AzApplicationInsightsWebTest', 'Set-AzApplicationInsights', 'Set-AzApplicationInsightsContinuousExport', 'Set-AzApplicationInsightsDailyCap', 'Set-AzApplicationInsightsPricingPlan', 'Set-AzApplicationInsightsWebTest', 'Update-AzApplicationInsights', 'Update-AzApplicationInsightsComponentTag', 'Update-AzApplicationInsightsLinkedStorageAccount', 'Update-AzApplicationInsightsWebTestTag', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
