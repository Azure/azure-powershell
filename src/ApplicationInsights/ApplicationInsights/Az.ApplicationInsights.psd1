...
FunctionsToExport = 'Get-AzApplicationInsightsWebTest', 
               ...
               'Get-AzApplicationInsights', 'Get-AzApplicationInsightsApiKey', 
               ...
               'Set-AzApplicationInsightsWebTest', 'Update-AzApplicationInsights', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added breaking change warnings for upcoming Az.ApplicationInsights 2.0.0'
