...
{
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "ApplicationInsightsLinkedStorageAccount", SupportsShouldProcess = true), OutputType(typeof(PSComponentLinkedStorageAccounts))]
