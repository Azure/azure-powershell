...
```
Set-AzApplicationInsightsWebTest -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Location <String> [-ConfigurationWebTest <String>] [-ContentValidationContentMatch <String>]
 ...
 [-WebTestKind <WebTestKindEnum>] [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
