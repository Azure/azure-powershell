...
```
Set-AzInterfaceEndpoint -Name <String> -ResourceGroupName <String> [-Parameter <IInterfaceEndpoint>]
...
```
Set-AzInterfaceEndpoint -Name <String> -ResourceGroupName <String> [-EndpointServiceId <String>]
