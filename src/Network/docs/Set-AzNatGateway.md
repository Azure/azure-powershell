...
```
Set-AzNatGateway -Name <String> -ResourceGroupName <String> [-Parameter <INatGateway>]
...
```
Set-AzNatGateway -Name <String> -ResourceGroupName <String> [-Etag <String>] [-Id <String>]
