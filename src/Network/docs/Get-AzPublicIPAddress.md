...
```
Get-AzPublicIPAddress [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetSubscriptionIdViaHost
```
Get-AzPublicIPAddress -Name <String> -ResourceGroupName <String> [-Expand <String>]
...
```
Get-AzPublicIPAddress -ResourceGroupName <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
