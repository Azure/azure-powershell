...
```
New-AzPublicIPPrefix -Name <String> -ResourceGroupName <String> [-Parameter <IPublicIPPrefix>]
...
```
New-AzPublicIPPrefix -Name <String> -ResourceGroupName <String> [-Etag <String>] [-IPPrefix <String>]
