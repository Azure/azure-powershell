...
```
Set-AzVirtualWan -Name <String> -ResourceGroupName <String> [-WanParameter <IVirtualWan>]
...
```
Set-AzVirtualWan -Name <String> -ResourceGroupName <String> [-AllowBranchToBranchTraffic <Boolean>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.network/set-azvirtualwan](https://docs.microsoft.com/en-us/powershell/module/az.network/set-azvirtualwan)
