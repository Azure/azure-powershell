...
```
New-AzVpnSite -InputObject <INetworkIdentity> [-AddressSpaceAddressPrefix <String[]>] [-BgpPropertyAsn <Int64>]
...
### CreateViaIdentity
```
New-AzVpnSite -InputObject <INetworkIdentity> [-Parameter <IVpnSite>] [-DefaultProfile <PSObject>] [-AsJob]
