...
```
Set-AzDdoCustomPolicy -InputObject <INetworkIdentity> [-Id <String>] [-Location <String>]
...
### UpdateViaIdentity
```
Set-AzDdoCustomPolicy -InputObject <INetworkIdentity> [-Parameter <IDdosCustomPolicy>]
