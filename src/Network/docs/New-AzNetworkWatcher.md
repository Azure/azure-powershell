...
```
New-AzNetworkWatcher -Name <String> -ResourceGroupName <String> [-Parameter <INetworkWatcher>]
...
```
New-AzNetworkWatcher -Name <String> -ResourceGroupName <String> [-Etag <String>] [-Id <String>]
