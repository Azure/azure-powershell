...
```
New-AzNetworkSecurityGroup -Name <String> -ResourceGroupName <String> [-Parameter <INetworkSecurityGroup>]
...
```
New-AzNetworkSecurityGroup -Name <String> -ResourceGroupName <String> [-DefaultSecurityRule <ISecurityRule[]>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.network/new-aznetworksecuritygroup](https://docs.microsoft.com/en-us/powershell/module/az.network/new-aznetworksecuritygroup)
