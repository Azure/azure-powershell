...
```
Update-AzServiceEndpointPolicy -Name <String> -ResourceGroupName <String> [-Parameter <ITagsObject>]
...
```
Update-AzServiceEndpointPolicy -Name <String> -ResourceGroupName <String> [-Tag <ITagsObjectTags>]
 [-DefaultProfile <PSObject>] [-AsJob] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/az.network/update-azserviceendpointpolicy](https://docs.microsoft.com/en-us/powershell/module/az.network/update-azserviceendpointpolicy)
