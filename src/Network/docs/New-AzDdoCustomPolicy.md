...
```
New-AzDdoCustomPolicy -DdosCustomPolicyName <String> -ResourceGroupName <String>
...
```
New-AzDdoCustomPolicy -DdosCustomPolicyName <String> -ResourceGroupName <String> [-Id <String>]
