...
```
New-AzDdoProtectionPlan -InputObject <INetworkIdentity> [-Location <String>] [-Tag <IDdosProtectionPlanTags>]
 [-DefaultProfile <PSObject>] [-AsJob] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzDdoProtectionPlan -InputObject <INetworkIdentity> [-Parameter <IDdosProtectionPlan>]
 [-DefaultProfile <PSObject>] [-AsJob] [-WhatIf] [-Confirm] [<CommonParameters>]
```
