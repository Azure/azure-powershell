...
```
Set-AzRouteFilter -Name <String> -ResourceGroupName <String> [-Parameter <IRouteFilter>]
...
```
Set-AzRouteFilter -Name <String> -ResourceGroupName <String> [-Id <String>] [-Location <String>]
