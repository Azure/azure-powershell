...
```
Set-AzRouteFilter -InputObject <INetworkIdentity> [-Id <String>] [-Location <String>]
...
### UpdateViaIdentity
```
Set-AzRouteFilter -InputObject <INetworkIdentity> [-Parameter <IRouteFilter>] [-DefaultProfile <PSObject>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.network/set-azroutefilter](https://docs.microsoft.com/en-us/powershell/module/az.network/set-azroutefilter)
