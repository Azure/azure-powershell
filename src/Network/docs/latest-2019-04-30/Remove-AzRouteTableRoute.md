...
Remove-AzRouteTableRoute -Name <String> -ResourceGroupName <String> -SubscriptionId <String>
 -TableName <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzRouteTableRoute -InputObject <INetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
