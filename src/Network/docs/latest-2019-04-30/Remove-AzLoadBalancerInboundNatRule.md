...
online version: https://docs.microsoft.com/powershell/module/az.network/remove-azloadbalancerinboundnatrule
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzLoadBalancerInboundNatRule -InputObject <INetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob]
