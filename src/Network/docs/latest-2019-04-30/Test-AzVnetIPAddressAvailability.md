...
online version: https://docs.microsoft.com/powershell/module/az.network/test-azvnetipaddressavailability
schema: 2.0.0
---
...
### Check (Default)
```
Test-AzVnetIPAddressAvailability -ResourceGroupName <String> -VnetName <String> -IPAddress <String>
