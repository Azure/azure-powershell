...
online version: https://docs.microsoft.com/en-us/powershell/module/az.network/remove-azvnettap
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzVnetTap -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzVnetTap -InputObject <INetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
