...
To construct, see NOTES section for SECURITYGROUP properties and create a hash table.
...
#### SECURITYGROUP <IApplicationSecurityGroup>: An application security group in a resource group.
