...
### Delete (Default)
```
Remove-AzNetworkWatcherConnectionMonitor -Name <String> -NetworkWatcherName <String>
...
### DeleteViaIdentity
```
Remove-AzNetworkWatcherConnectionMonitor -InputObject <INetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob]
