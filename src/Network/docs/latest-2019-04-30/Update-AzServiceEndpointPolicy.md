...
online version: https://docs.microsoft.com/powershell/module/az.network/update-azserviceendpointpolicy
schema: 2.0.0
---
...
### Update
```
Update-AzServiceEndpointPolicy -Name <String> -ResourceGroupName <String> -ServiceEndpointPolicy <ITagsObject>
...
```
Update-AzServiceEndpointPolicy -InputObject <INetworkIdentity> [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
