...
online version: https://docs.microsoft.com/powershell/module/az.network/remove-azroutefilterrule
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzRouteFilterRule -InputObject <INetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
