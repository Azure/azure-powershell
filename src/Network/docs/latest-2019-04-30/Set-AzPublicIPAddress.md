...
Set-AzPublicIPAddress -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-IPConfigurationPropertiesProvisioningState <String>] [-IPTag <IIPTag[]>] [-Location <String>]
 [-PrefixId <String>] [-PrivateIPAddress <String>] [-PrivateIPAllocationMethod <IPAllocationMethod>]
 [-ProvisioningState <String>] [-ResourceGuid <String>] [-ReverseFqdn <String>]
 [-SkuName <PublicIPAddressSkuName>] [-Subnet <ISubnet_Reference>] [-Tag <Hashtable>] [-Zone <String[]>]
