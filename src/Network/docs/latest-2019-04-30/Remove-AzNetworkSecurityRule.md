...
online version: https://docs.microsoft.com/en-us/powershell/module/az.network/remove-aznetworksecurityrule
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzNetworkSecurityRule -InputObject <INetworkIdentity> [-PassThru] [-DefaultProfile <PSObject>] [-AsJob]
