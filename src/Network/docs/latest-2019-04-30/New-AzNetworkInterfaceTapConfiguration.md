...
online version: https://docs.microsoft.com/powershell/module/az.network/new-aznetworkinterfacetapconfiguration
schema: 2.0.0
---
...
```
New-AzNetworkInterfaceTapConfiguration -Name <String> -NetworkInterfaceName <String>
