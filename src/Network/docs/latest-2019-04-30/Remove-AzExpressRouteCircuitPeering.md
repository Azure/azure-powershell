...
online version: https://docs.microsoft.com/en-us/powershell/module/az.network/remove-azexpressroutecircuitpeering
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzExpressRouteCircuitPeering -InputObject <INetworkIdentity> [-PassThru] [-DefaultProfile <PSObject>]
