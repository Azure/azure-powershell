...
### Delete (Default)
```
Remove-AzExpressRouteGateway -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzExpressRouteGateway -InputObject <INetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
