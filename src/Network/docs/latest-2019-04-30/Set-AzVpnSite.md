...
```
Set-AzVpnSite -InputObject <INetworkIdentity> [-AddressSpaceAddressPrefix <String[]>]
...
### UpdateViaIdentity
```
Set-AzVpnSite -InputObject <INetworkIdentity> [-VpnSiteParameter <IVpnSite>] [-DefaultProfile <PSObject>]
