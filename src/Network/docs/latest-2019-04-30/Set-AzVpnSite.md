...
online version: https://docs.microsoft.com/powershell/module/az.network/set-azvpnsite
schema: 2.0.0
---
...
```
Set-AzVpnSite -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
