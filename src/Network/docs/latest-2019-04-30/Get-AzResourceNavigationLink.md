...
online version: https://docs.microsoft.com/en-us/powershell/module/az.network/get-azresourcenavigationlink
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzResourceNavigationLink -InputObject <INetworkIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
