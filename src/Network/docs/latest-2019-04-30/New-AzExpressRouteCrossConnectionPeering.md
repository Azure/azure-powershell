...
online version: https://docs.microsoft.com/powershell/module/az.network/new-azexpressroutecrossconnectionpeering
schema: 2.0.0
---
...
```
New-AzExpressRouteCrossConnectionPeering -CrossConnectionName <String> -Name <String>
