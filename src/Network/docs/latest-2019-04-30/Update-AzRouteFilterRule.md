...
online version: https://docs.microsoft.com/powershell/module/az.network/update-azroutefilterrule
schema: 2.0.0
---
...
```
Update-AzRouteFilterRule -Name <String> -ResourceGroupName <String> -RouteFilterName <String>
 -RouteFilterRule <IPatchRouteFilterRule> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob]
