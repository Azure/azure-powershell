...
### Stop (Default)
```
Stop-AzNetworkWatcherConnectionMonitor -Name <String> -NetworkWatcherName <String> -ResourceGroupName <String>
...
### StopViaIdentity
```
Stop-AzNetworkWatcherConnectionMonitor -InputObject <INetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob]
