...
### Start (Default)
```
Start-AzNetworkWatcherConnectionMonitor -Name <String> -NetworkWatcherName <String>
...
### StartViaIdentity
```
Start-AzNetworkWatcherConnectionMonitor -InputObject <INetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob]
