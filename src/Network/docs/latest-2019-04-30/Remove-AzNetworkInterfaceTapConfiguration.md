...
online version: https://docs.microsoft.com/powershell/module/az.network/remove-aznetworkinterfacetapconfiguration
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzNetworkInterfaceTapConfiguration -InputObject <INetworkIdentity> [-DefaultProfile <PSObject>]
