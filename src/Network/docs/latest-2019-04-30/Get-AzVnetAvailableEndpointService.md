...
online version: https://docs.microsoft.com/powershell/module/az.network/get-azvnetavailableendpointservice
schema: 2.0.0
---
...
```
Get-AzVnetAvailableEndpointService -Location <String> [-SubscriptionId <String[]>]
