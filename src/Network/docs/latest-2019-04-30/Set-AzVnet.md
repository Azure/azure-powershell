...
```
Set-AzVnet -InputObject <INetworkIdentity> [-AddressSpaceAddressPrefix <String[]>]
...
### UpdateViaIdentity
```
Set-AzVnet -InputObject <INetworkIdentity> [-Parameter <IVirtualNetwork>] [-DefaultProfile <PSObject>]
