...
online version: https://docs.microsoft.com/powershell/module/az.network/new-azvnetpeering
schema: 2.0.0
---
...
```
New-AzVnetPeering -Name <String> -ResourceGroupName <String> -VnetName <String> [-SubscriptionId <String>]
...
### Create
```
New-AzVnetPeering -Name <String> -ResourceGroupName <String> -VnetName <String>
