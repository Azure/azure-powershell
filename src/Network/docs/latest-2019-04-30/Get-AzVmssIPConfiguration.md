...
online version: https://docs.microsoft.com/en-us/powershell/module/az.network/get-azvmssipconfiguration
schema: 2.0.0
---
...
### List (Default)
```
Get-AzVmssIPConfiguration -NetworkInterfaceName <String> -ResourceGroupName <String>
...
### Get
```
Get-AzVmssIPConfiguration -IPConfigurationName <String> -NetworkInterfaceName <String>
...
### GetViaIdentity
```
Get-AzVmssIPConfiguration -InputObject <INetworkIdentity> [-Expand <String>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
