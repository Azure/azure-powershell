...
online version: https://docs.microsoft.com/powershell/module/az.network/remove-azp2svpnserverconfiguration
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzP2SVpnServerConfiguration -InputObject <INetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob]
