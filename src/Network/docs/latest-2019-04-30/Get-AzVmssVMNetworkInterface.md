...
online version: https://docs.microsoft.com/en-us/powershell/module/az.network/get-azvmssvmnetworkinterface
schema: 2.0.0
---
...
```
Get-AzVmssVMNetworkInterface -ResourceGroupName <String> -SubscriptionId <String[]>
