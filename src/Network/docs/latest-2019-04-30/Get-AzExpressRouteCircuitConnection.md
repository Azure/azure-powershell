...
online version: https://docs.microsoft.com/powershell/module/az.network/get-azexpressroutecircuitconnection
schema: 2.0.0
---
...
### Get
```
Get-AzExpressRouteCircuitConnection -CircuitName <String> -Name <String> -PeeringName <String>
