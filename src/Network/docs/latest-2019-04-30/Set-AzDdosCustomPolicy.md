...
online version: https://docs.microsoft.com/powershell/module/az.network/set-azddoscustompolicy
schema: 2.0.0
---
...
### Update
```
Set-AzDdosCustomPolicy -Name <String> -ResourceGroupName <String> -DdosCustomPolicy <IDdosCustomPolicy>
