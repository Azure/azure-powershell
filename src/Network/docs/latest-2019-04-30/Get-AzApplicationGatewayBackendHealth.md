...
```
Get-AzApplicationGatewayBackendHealth -AsOnDemand -InputObject <INetworkIdentity> [-Expand <String>]
...
Parameter Sets: BackendViaIdentity, DemandViaIdentityExpanded
Aliases:
