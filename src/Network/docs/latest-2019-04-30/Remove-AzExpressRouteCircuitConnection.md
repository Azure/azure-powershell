...
online version: https://docs.microsoft.com/powershell/module/az.network/remove-azexpressroutecircuitconnection
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzExpressRouteCircuitConnection -CircuitName <String> -Name <String> -PeeringName <String>
...
### DeleteViaIdentity
```
Remove-AzExpressRouteCircuitConnection -InputObject <INetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob]
