...
```
Remove-AzVpnConnection -ConnectionName <String> -GatewayName <String> -ResourceGroupName <String> [-PassThru]
...
[https://docs.microsoft.com/en-us/powershell/module/az.network/remove-azvpnconnection](https://docs.microsoft.com/en-us/powershell/module/az.network/remove-azvpnconnection)
