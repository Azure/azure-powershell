...
```
Update-AzVirtualNetworkTag -ResourceGroupName <String> -VirtualNetworkName <String> [-Parameter <ITagsObject>]
...
```
Update-AzVirtualNetworkTag -ResourceGroupName <String> -VirtualNetworkName <String> [-Tag <ITagsObjectTags>]
 [-DefaultProfile <PSObject>] [-AsJob] [-WhatIf] [-Confirm] [<CommonParameters>]
```
