...
```
Set-AzExpressRouteConnection -InputObject <INetworkIdentity> [-AuthorizationKey <String>]
 [-ExpressRouteCircuitPeeringId <String>] [-Id <String>] -Name <String> [-RoutingWeight <Int32>]
 [-DefaultProfile <PSObject>] [-AsJob] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/az.network/set-azexpressrouteconnection](https://docs.microsoft.com/en-us/powershell/module/az.network/set-azexpressrouteconnection)
