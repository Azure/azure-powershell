...
```
New-AzVirtualNetworkGatewayConnection -Name <String> -ResourceGroupName <String>
...
```
New-AzVirtualNetworkGatewayConnection -Name <String> -ResourceGroupName <String> [-AuthorizationKey <String>]
