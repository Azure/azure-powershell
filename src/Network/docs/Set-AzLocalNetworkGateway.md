...
```
Set-AzLocalNetworkGateway -Name <String> -ResourceGroupName <String> [-Parameter <ILocalNetworkGateway>]
...
```
Set-AzLocalNetworkGateway -Name <String> -ResourceGroupName <String> [-BgpSettingsAsn <Int64>]
