...
```
Set-AzRouteTable -Name <String> -ResourceGroupName <String> [-Parameter <IRouteTable>]
...
```
Set-AzRouteTable -Name <String> -ResourceGroupName <String> [-DisableBgpRoutePropagation <Boolean>]
