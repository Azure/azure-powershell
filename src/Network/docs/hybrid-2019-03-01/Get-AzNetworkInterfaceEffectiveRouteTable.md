...
online version: https://docs.microsoft.com/powershell/module/az.network/get-aznetworkinterfaceeffectiveroutetable
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-AzNetworkInterfaceEffectiveRouteTable -InputObject <INetworkIdentity> [-DefaultProfile <PSObject>]
