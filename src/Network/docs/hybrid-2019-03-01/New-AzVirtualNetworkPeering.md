...
online version: https://docs.microsoft.com/en-us/powershell/module/az.network/new-azvirtualnetworkpeering
schema: 2.0.0
---
...
### Create1 (Default)
```
New-AzVirtualNetworkPeering -ResourceGroupName <String> -SubscriptionId <String> -VirtualNetworkName <String>
...
```
New-AzVirtualNetworkPeering -InputObject <INetworkIdentity> [-Name <String>] [-AllowForwardedTraffic]
...
### CreateViaIdentity1
```
New-AzVirtualNetworkPeering -InputObject <INetworkIdentity>
