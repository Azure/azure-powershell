...
```
New-AzNsg -InputObject <INetworkIdentity> [-DefaultSecurityRule <ISecurityRule[]>] [-Etag <String>]
...
### CreateViaIdentity1
```
New-AzNsg -InputObject <INetworkIdentity> [-Parameter <INetworkSecurityGroup>] [-DefaultProfile <PSObject>]
