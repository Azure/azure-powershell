...
online version: https://docs.microsoft.com/en-us/powershell/module/az.network/new-azvirtualnetworksubnet
schema: 2.0.0
---
...
### Create1 (Default)
```
New-AzVirtualNetworkSubnet -ResourceGroupName <String> -SubscriptionId <String> -VirtualNetworkName <String>
...
```
New-AzVirtualNetworkSubnet -InputObject <INetworkIdentity> [-Name <String>] [-AddressPrefix <String>]
...
### CreateViaIdentity1
```
New-AzVirtualNetworkSubnet -InputObject <INetworkIdentity> [-SubnetParameter <ISubnet>]
 [-DefaultProfile <PSObject>] [-AsJob] [-Confirm] [-WhatIf] [<CommonParameters>]
```
