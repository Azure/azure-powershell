...
Set-AzPublicIPAddress -Name <String> -ResourceGroupName <String> -SubscriptionId <String>
 [-AddressParameter <IPublicIPAddress>] [-AllocationMethod <IPAllocationMethod>] [-DomainNameLabel <String>]
...
#### ADDRESSPARAMETER <IPublicIPAddress>: The reference of the public IP resource.
