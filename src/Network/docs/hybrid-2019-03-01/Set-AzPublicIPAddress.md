...
Set-AzPublicIPAddress -Name <String> -ResourceGroupName <String> -SubscriptionId <String>
 [-AddressParameter <IPublicIPAddress_Reference>] [-AllocationMethod <IPAllocationMethod>]
...
To construct, see NOTES section for ADDRESSPARAMETER properties and create a hash table.
...
#### ADDRESSPARAMETER <IPublicIPAddress_Reference>: The reference of the public IP resource.
...
#### SUBNET <ISubnet_Reference>: The reference of the subnet resource.
  - `[AddressPrefix <String>]`: The address prefix for the subnet.
  - `[Etag <String>]`: A unique read-only string that changes whenever the resource is updated.
  - `[Name <String>]`: The name of the resource that is unique within a resource group. This name can be used to access the resource.
  - `[Nsg <INetworkSecurityGroup>]`: The reference of the NetworkSecurityGroup resource.
