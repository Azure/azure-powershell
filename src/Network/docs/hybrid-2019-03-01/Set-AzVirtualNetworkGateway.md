...
### UpdateExpanded1
```
Set-AzVirtualNetworkGateway -Name <String> -ResourceGroupName <String> -SubscriptionId <String> [-Active]
...
```
Set-AzVirtualNetworkGateway -InputObject <INetworkIdentity> [-Active] [-BgpSettingAsn <Int64>]
