...
online version: https://docs.microsoft.com/powershell/module/az.network/new-azvnetgatewayvpnprofile
schema: 2.0.0
---
...
New-AzVnetGatewayVpnProfile -InputObject <INetworkIdentity> [-AuthenticationMethod <AuthenticationMethod>]
 ...
 [-RadiusServerAuthenticationCertificate <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
...
Parameter Sets: GenerateViaIdentity1, GenerateViaIdentityExpanded1
Aliases:
