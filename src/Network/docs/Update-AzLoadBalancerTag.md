...
```
Update-AzLoadBalancerTag -InputObject <INetworkIdentity> [-Tag <ITagsObjectTags>] [-DefaultProfile <PSObject>]
 [-AsJob] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-AzLoadBalancerTag -InputObject <INetworkIdentity> [-Parameter <ITagsObject>]
