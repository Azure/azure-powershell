...
```
Set-AzLoadBalancer -Name <String> -ResourceGroupName <String> [-Parameter <ILoadBalancer>]
...
```
Set-AzLoadBalancer -Name <String> -ResourceGroupName <String> [-BackendAddressPool <IBackendAddressPool[]>]
