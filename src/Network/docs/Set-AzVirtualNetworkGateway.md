...
```
Set-AzVirtualNetworkGateway -Name <String> -ResourceGroupName <String> [-Parameter <IVirtualNetworkGateway>]
...
```
Set-AzVirtualNetworkGateway -Name <String> -ResourceGroupName <String> [-Active <Boolean>]
