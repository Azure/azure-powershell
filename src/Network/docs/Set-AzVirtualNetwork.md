...
```
Set-AzVirtualNetwork -Name <String> -ResourceGroupName <String> [-Parameter <IVirtualNetwork>]
...
```
Set-AzVirtualNetwork -Name <String> -ResourceGroupName <String> [-AddressSpaceAddressPrefix <String[]>]
