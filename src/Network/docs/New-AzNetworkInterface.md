...
```
New-AzNetworkInterface -Name <String> -ResourceGroupName <String> [-Parameter <INetworkInterface>]
...
```
New-AzNetworkInterface -Name <String> -ResourceGroupName <String> [-DefaultSecurityRule <ISecurityRule[]>]
