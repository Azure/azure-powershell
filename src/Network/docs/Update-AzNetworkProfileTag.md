...
```
Update-AzNetworkProfileTag -NetworkProfileName <String> -ResourceGroupName <String> [-Parameter <ITagsObject>]
...
```
Update-AzNetworkProfileTag -NetworkProfileName <String> -ResourceGroupName <String> [-Tag <ITagsObjectTags>]
 [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
