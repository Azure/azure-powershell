...
```
New-AzVirtualWan -Name <String> -ResourceGroupName <String> [-WanParameter <IVirtualWan>]
...
```
New-AzVirtualWan -Name <String> -ResourceGroupName <String> [-AllowBranchToBranchTraffic <Boolean>]
