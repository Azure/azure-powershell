...
```
Set-AzVpnGateway -GatewayName <String> -ResourceGroupName <String> [-Parameter <IVpnGateway>]
...
```
Set-AzVpnGateway -GatewayName <String> -ResourceGroupName <String> [-BgpSettingsAsn <Int64>]
