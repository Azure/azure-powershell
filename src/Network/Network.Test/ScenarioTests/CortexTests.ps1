...
.SYNOPSIS
 ...
 param 
    ...
    try
	{
		...
		$vpnSiteLinkConnection = New-AzVpnSiteLinkConnection -Name $vpnSiteLinkConnection -VpnSiteLink $vpnSite.VpnSiteLinks[0] -ConnectionBandwidth 100 -VpnGatewayCustomBgpAddresses $address,$address2 -EnableBgp
