...
<# .SYNOPSIS
 ...
 param 
    ...
    try
	{
		...
		$expected = Disconnect-AzVirtualNetworkGatewayVpnConnection -ResourceGroupName $rgname -ResourceName $P2SvpnGatewayName -VpnConnectionId "IKEv2_7e1cfe59-5c7c-4315-a876-b11fbfdfeed4"
