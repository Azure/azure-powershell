...
<#
.SYNOPSIS
Application gateway v2 top level waf tests in ManagedRuleGroupOverride with high sensitivity
#>
function Test-ApplicationGatewayFirewallPolicyManagedRuleGroupOverrideWithHighSensitivity
...
<#
.SYNOPSIS
Application gateway v2 top level waf tests in ManagedRuleGroupOverride with low sensitivity
#>
function Test-ApplicationGatewayFirewallPolicyManagedRuleGroupOverrideWithLowSensitivity

{
	...
	try
	{
		...
		$rule = New-AzApplicationGatewayFirewallCustomRule -Name example -Priority 2 -RuleType MatchRule -MatchCondition $condition -Action Block
		$policySettings = New-AzApplicationGatewayFirewallPolicySetting -Mode Prevention -State Enabled -MaxFileUploadInMb 70 -MaxRequestBodySizeInKb 70
		$ruleOverrideEntry1 = New-AzApplicationGatewayFirewallPolicyManagedRuleOverride -RuleId 500100 -State Enabled -Action Block -Sensitivity Low
		$ruleOverrideEntry2 = New-AzApplicationGatewayFirewallPolicyManagedRuleOverride -RuleId 500110 -State Enabled -Action Block -Sensitivity Low
		$ruleGroupOverrideEntry = New-AzApplicationGatewayFirewallPolicyManagedRuleGroupOverride -RuleGroupName ExcessiveRequests -Rule $ruleOverrideEntry1,$ruleOverrideEntry2
		$primarymanagedRuleSet = New-AzApplicationGatewayFirewallPolicyManagedRuleSet -RuleSetType "OWASP" -RuleSetVersion "3.2"
		$ddosmanagedRuleSet = New-AzApplicationGatewayFirewallPolicyManagedRuleSet -RuleSetType "Microsoft_HTTPDDoSRuleSet" -RuleSetVersion "1.0" -RuleGroupOverride $ruleGroupOverrideEntry
		$managedRule = New-AzApplicationGatewayFirewallPolicyManagedRule -ManagedRuleSet $primarymanagedRuleSet,$ddosmanagedRuleSet
...
<#
.SYNOPSIS
Application gateway v2 top level waf tests in ManagedRuleGroupOverride with Medium sensitivity
#>
function Test-ApplicationGatewayFirewallPolicyManagedRuleGroupOverrideWithMediumSensitivity

{
	...
	try
	{
		...
		$rule = New-AzApplicationGatewayFirewallCustomRule -Name example -Priority 2 -RuleType MatchRule -MatchCondition $condition -Action Block
		$policySettings = New-AzApplicationGatewayFirewallPolicySetting -Mode Prevention -State Enabled -MaxFileUploadInMb 70 -MaxRequestBodySizeInKb 70
		$ruleOverrideEntry1 = New-AzApplicationGatewayFirewallPolicyManagedRuleOverride -RuleId 500100 -State Enabled -Action Block -Sensitivity Medium
