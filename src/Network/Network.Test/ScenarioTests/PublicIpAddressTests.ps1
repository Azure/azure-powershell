...
function Test-PublicIpAddressCRUD-DdosCustomPolicy
{
    ...
    try
    {
        ...
        $actual = New-AzPublicIpAddress -ResourceGroupName $rgname -Name $rname -Location $location -AllocationMethod Static -Sku Standard -DdosProtectionMode "VirtualNetworkInherited"
        ...
        Assert-AreEqual $expected.ResourceGroupName $actual.ResourceGroupName
        Assert-AreEqual $expected.Name $actual.Name
        Assert-AreEqual "VirtualNetworkInherited" $expected.DdosSettings.ProtectionMode
