...
- `build-module.ps1`
  - Builds the module DLL (`./bin/Az.Network.private.dll`), creates the exported cmdlets, generates custom cmdlet test stubs, and updates `./Az.Network.psd1` with Azure profile information.
