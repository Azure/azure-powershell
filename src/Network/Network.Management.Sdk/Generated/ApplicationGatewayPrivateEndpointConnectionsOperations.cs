...
namespace Microsoft.Azure.Management.Network
{
    ...
    internal partial class ApplicationGatewayPrivateEndpointConnectionsOperations : Microsoft.Rest.IServiceOperations<NetworkManagementClient>, IApplicationGatewayPrivateEndpointConnectionsOperations
    {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse _response = await BeginDeleteWithHttpMessagesAsync(resourceGroupName, applicationGatewayName, connectionName, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<ApplicationGatewayPrivateEndpointConnection> _response = await BeginUpdateWithHttpMessagesAsync(resourceGroupName, applicationGatewayName, connectionName, parameters, customHeaders, cancellationToken).ConfigureAwait(false);
