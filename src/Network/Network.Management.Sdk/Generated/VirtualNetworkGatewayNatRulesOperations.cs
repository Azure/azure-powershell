...
namespace Microsoft.Azure.Management.Network
{
    ...
    internal partial class VirtualNetworkGatewayNatRulesOperations : Microsoft.Rest.IServiceOperations<NetworkManagementClient>, IVirtualNetworkGatewayNatRulesOperations
    {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<VirtualNetworkGatewayNatRule> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, virtualNetworkGatewayName, natRuleName, natRuleParameters, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse _response = await BeginDeleteWithHttpMessagesAsync(resourceGroupName, virtualNetworkGatewayName, natRuleName, customHeaders, cancellationToken).ConfigureAwait(false);
