...
namespace Microsoft.Azure.Management.Network
{
    ...
    /// <summary>
    /// Extension methods for VirtualNetworksOperations - MoveIpConfigurations
    /// </summary>
    public static partial class VirtualNetworksOperationsMoveIpConfigurationsExtensions
    {
        /// <summary>
        ...
        /// </param>
        public static void MoveIpConfigurations(this IVirtualNetworksOperations operations, string resourceGroupName, string virtualNetworkName, MoveIpConfigurationsRequest parameters)
        {
            ((IVirtualNetworksOperations)operations).MoveIpConfigurationsAsync(resourceGroupName, virtualNetworkName, parameters).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task MoveIpConfigurationsAsync(this IVirtualNetworksOperations operations, string resourceGroupName, string virtualNetworkName, MoveIpConfigurationsRequest parameters, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            (await operations.MoveIpConfigurationsWithHttpMessagesAsync(resourceGroupName, virtualNetworkName, parameters, null, cancellationToken).ConfigureAwait(false)).Dispose();
        }
        ...
        /// Parameters supplied to the move IP configurations operation.
        /// </param>
        public static void BeginMoveIpConfigurations(this IVirtualNetworksOperations operations, string resourceGroupName, string virtualNetworkName, MoveIpConfigurationsRequest parameters)
        {
            ((IVirtualNetworksOperations)operations).BeginMoveIpConfigurationsAsync(resourceGroupName, virtualNetworkName, parameters).GetAwaiter().GetResult();
        }
        ...
        {
            (await operations.BeginMoveIpConfigurationsWithHttpMessagesAsync(resourceGroupName, virtualNetworkName, parameters, null, cancellationToken).ConfigureAwait(false)).Dispose();
        }
    }
}
