...
namespace Microsoft.Azure.Management.Network
{
    ...
    /// </summary>
    internal partial class VirtualNetworkApplianceCapabilitiesOperations : Microsoft.Rest.IServiceOperations<NetworkManagementClient>, IVirtualNetworkApplianceCapabilitiesOperations
    {
        /// <summary>
        /// Initializes a new instance of the VirtualNetworkApplianceCapabilitiesOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal VirtualNetworkApplianceCapabilitiesOperations (NetworkManagementClient client)
        {
            if (client == null) 
            {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<VirtualNetworkApplianceCapability>>> ListWithHttpMessagesAsync(string resourceGroupName, string virtualNetworkApplianceName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<VirtualNetworkApplianceCapability>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<VirtualNetworkApplianceCapability>>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<VirtualNetworkApplianceCapability>> GetWithHttpMessagesAsync(string resourceGroupName, string virtualNetworkApplianceName, string capabilityName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "capabilityName");
            }
            if (capabilityName != null)
            {
                if (!System.Text.RegularExpressions.Regex.IsMatch(capabilityName, "^[0-9a-zA-Z]([0-9a-zA-Z_.-]{0,62}[0-9a-zA-Z_])?$"))
                {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<VirtualNetworkApplianceCapability>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (Newtonsoft.Json.JsonException ex)
                {
                    _httpRequest.Dispose();
