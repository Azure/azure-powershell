...
namespace Microsoft.Azure.Management.Network
{
    ...
    internal partial class FlowLogsOperations : Microsoft.Rest.IServiceOperations<NetworkManagementClient>, IFlowLogsOperations
    {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<CommonFlowLog> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, networkWatcherName, flowLogName, parameters, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse _response = await BeginDeleteWithHttpMessagesAsync(resourceGroupName, networkWatcherName, flowLogName, customHeaders, cancellationToken).ConfigureAwait(false);
