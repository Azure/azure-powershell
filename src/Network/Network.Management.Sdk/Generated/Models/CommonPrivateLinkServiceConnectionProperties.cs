...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class CommonPrivateLinkServiceConnectionProperties
    {
        /// <summary>
        /// Initializes a new instance of the CommonPrivateLinkServiceConnectionProperties class.
        /// </summary>
        public CommonPrivateLinkServiceConnectionProperties()
        {
            CustomInit();
        }
        ...
        /// the remote resource.
        /// </param>
        public CommonPrivateLinkServiceConnectionProperties(string provisioningState = default(string), string privateLinkServiceId = default(string), System.Collections.Generic.IList<string> groupIds = default(System.Collections.Generic.IList<string>), string requestMessage = default(string), CommonPrivateLinkServiceConnectionState privateLinkServiceConnectionState = default(CommonPrivateLinkServiceConnectionState))
