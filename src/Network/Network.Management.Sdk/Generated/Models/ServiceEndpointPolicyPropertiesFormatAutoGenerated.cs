...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class ServiceEndpointPolicyPropertiesFormatAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the ServiceEndpointPolicyPropertiesFormatAutoGenerated class.
        /// </summary>
        public ServiceEndpointPolicyPropertiesFormatAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public ServiceEndpointPolicyPropertiesFormatAutoGenerated(System.Collections.Generic.IList<ServiceEndpointPolicyDefinition> serviceEndpointPolicyDefinitions = default(System.Collections.Generic.IList<ServiceEndpointPolicyDefinition>), System.Collections.Generic.IList<SubnetAutoGenerated> subnets = default(System.Collections.Generic.IList<SubnetAutoGenerated>), string resourceGuid = default(string), string provisioningState = default(string), string serviceAlias = default(string), System.Collections.Generic.IList<string> contextualServiceEndpointPolicies = default(System.Collections.Generic.IList<string>))
