...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class VirtualHubEffectiveRoute
    {
        ...
        /// <param name="addressPrefixes">The list of address prefixes.
        /// </param>

        /// <param name="nextHops">The list of next hops.
        /// </param>

        /// <param name="nextHopType">The type of the next hop.
        /// </param>

        /// <param name="asPath">The ASPath of this route.
        /// </param>

        /// <param name="routeOrigin">The origin of this route.
        /// </param>
        public VirtualHubEffectiveRoute(System.Collections.Generic.IList<string> addressPrefixes = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<string> nextHops = default(System.Collections.Generic.IList<string>), string nextHopType = default(string), string asPath = default(string), string routeOrigin = default(string))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "routeOrigin")]
