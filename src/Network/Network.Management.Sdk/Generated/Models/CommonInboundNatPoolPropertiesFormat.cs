...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class CommonInboundNatPoolPropertiesFormat
    {
        /// <summary>
        /// Initializes a new instance of the CommonInboundNatPoolPropertiesFormat class.
        /// </summary>
        public CommonInboundNatPoolPropertiesFormat()
        {
            CustomInit();
        }
        ...
        public CommonInboundNatPoolPropertiesFormat(string protocol, int frontendPortRangeStart, int frontendPortRangeEnd, int backendPort, CommonSubResource frontendIPConfiguration = default(CommonSubResource), int? idleTimeoutInMinutes = default(int?), bool? enableFloatingIP = default(bool?), bool? enableTcpReset = default(bool?), string provisioningState = default(string))
