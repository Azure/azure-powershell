...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class SubnetPropertiesFormatAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the SubnetPropertiesFormatAutoGenerated class.
        /// </summary>
        public SubnetPropertiesFormatAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public SubnetPropertiesFormatAutoGenerated(string addressPrefix = default(string), System.Collections.Generic.IList<string> addressPrefixes = default(System.Collections.Generic.IList<string>), NetworkSecurityGroupAutoGenerated networkSecurityGroup = default(NetworkSecurityGroupAutoGenerated), RouteTableAutoGenerated routeTable = default(RouteTableAutoGenerated), SubResource natGateway = default(SubResource), System.Collections.Generic.IList<ServiceEndpointPropertiesFormat> serviceEndpoints = default(System.Collections.Generic.IList<ServiceEndpointPropertiesFormat>), System.Collections.Generic.IList<ServiceEndpointPolicyAutoGenerated> serviceEndpointPolicies = default(System.Collections.Generic.IList<ServiceEndpointPolicyAutoGenerated>), System.Collections.Generic.IList<PrivateEndpointAutoGenerated> privateEndpoints = default(System.Collections.Generic.IList<PrivateEndpointAutoGenerated>), System.Collections.Generic.IList<IPConfigurationAutoGenerated> ipConfigurations = default(System.Collections.Generic.IList<IPConfigurationAutoGenerated>), System.Collections.Generic.IList<IPConfigurationProfileAutoGenerated> ipConfigurationProfiles = default(System.Collections.Generic.IList<IPConfigurationProfileAutoGenerated>), System.Collections.Generic.IList<SubResource> ipAllocations = default(System.Collections.Generic.IList<SubResource>), System.Collections.Generic.IList<ResourceNavigationLink> resourceNavigationLinks = default(System.Collections.Generic.IList<ResourceNavigationLink>), System.Collections.Generic.IList<ServiceAssociationLink> serviceAssociationLinks = default(System.Collections.Generic.IList<ServiceAssociationLink>), System.Collections.Generic.IList<Delegation> delegations = default(System.Collections.Generic.IList<Delegation>), string purpose = default(string), string provisioningState = default(string), string privateEndpointNetworkPolicies = default(string), string privateLinkServiceNetworkPolicies = default(string), System.Collections.Generic.IList<ApplicationGatewayIPConfiguration> applicationGatewayIPConfigurations = default(System.Collections.Generic.IList<ApplicationGatewayIPConfiguration>), string sharingScope = default(string), bool? defaultOutboundAccess = default(bool?), System.Collections.Generic.IList<IpamPoolPrefixAllocation> ipamPoolPrefixAllocations = default(System.Collections.Generic.IList<IpamPoolPrefixAllocation>), SubResource serviceGateway = default(SubResource))
        ...
        public NetworkSecurityGroupAutoGenerated NetworkSecurityGroup {get; set; }

        /// <summary>
        /// Gets or sets the reference to the RouteTable resource.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "routeTable")]
        public RouteTableAutoGenerated RouteTable {get; set; }
        ...
        public System.Collections.Generic.IList<ServiceEndpointPolicyAutoGenerated> ServiceEndpointPolicies {get; set; }

        /// <summary>
        /// Gets an array of references to private endpoints.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "privateEndpoints")]
        public System.Collections.Generic.IList<PrivateEndpointAutoGenerated> PrivateEndpoints {get; private set; }
        ...
        public System.Collections.Generic.IList<IPConfigurationAutoGenerated> IPConfigurations {get; private set; }
        ...
        public System.Collections.Generic.IList<IPConfigurationProfileAutoGenerated> IPConfigurationProfiles {get; private set; }
