...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonRoute : CommonSubResourceModel
    {
        /// <summary>
        /// Initializes a new instance of the CommonRoute class.
        /// </summary>
        public CommonRoute()
        {
            CustomInit();
        ...
        /// regardless of LPM.
        /// </param>
        public CommonRoute(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), string provisioningState = default(string), string addressPrefix = default(string), string nextHopType = default(string), string nextHopIPAddress = default(string), CommonRouteNextHopEcmp nextHop = default(CommonRouteNextHopEcmp), bool? hasBgpOverride = default(bool?))
        ...
        public CommonRouteNextHopEcmp NextHop {get; set; }
