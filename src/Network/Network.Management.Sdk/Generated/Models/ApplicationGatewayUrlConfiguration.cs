...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayUrlConfiguration
    {
        ...
        /// <param name="modifiedPath">Url path which user has provided for url rewrite. Null means no path will
        /// be updated. Default value is null.
        /// </param>

        /// <param name="modifiedQueryString">Query string which user has provided for url rewrite. Null means no query
        /// string will be updated. Default value is null.
        /// </param>

        /// <param name="reroute">If set as true, it will re-evaluate the url path map provided in path based
        ...
        /// <summary>
        /// Gets or sets url path which user has provided for url rewrite. Null means
        /// no path will be updated. Default value is null.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "modifiedPath")]
        public string ModifiedPath {get; set; }

        /// <summary>
        /// Gets or sets query string which user has provided for url rewrite. Null
        ...
        /// <summary>
        /// Gets or sets if set as true, it will re-evaluate the url path map provided
        /// in path based request routing rules using modified path. Default value is
        /// false.
        /// </summary>
