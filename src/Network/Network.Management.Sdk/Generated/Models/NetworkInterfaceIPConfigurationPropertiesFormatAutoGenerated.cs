...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class NetworkInterfaceIPConfigurationPropertiesFormatAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the NetworkInterfaceIPConfigurationPropertiesFormatAutoGenerated class.
        /// </summary>
        public NetworkInterfaceIPConfigurationPropertiesFormatAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public NetworkInterfaceIPConfigurationPropertiesFormatAutoGenerated(SubResource gatewayLoadBalancer = default(SubResource), System.Collections.Generic.IList<VirtualNetworkTapAutoGenerated> virtualNetworkTaps = default(System.Collections.Generic.IList<VirtualNetworkTapAutoGenerated>), System.Collections.Generic.IList<ApplicationGatewayBackendAddressPoolAutoGenerated> applicationGatewayBackendAddressPools = default(System.Collections.Generic.IList<ApplicationGatewayBackendAddressPoolAutoGenerated>), System.Collections.Generic.IList<BackendAddressPoolAutoGenerated> loadBalancerBackendAddressPools = default(System.Collections.Generic.IList<BackendAddressPoolAutoGenerated>), System.Collections.Generic.IList<InboundNatRuleAutoGenerated> loadBalancerInboundNatRules = default(System.Collections.Generic.IList<InboundNatRuleAutoGenerated>), string privateIPAddress = default(string), int? privateIPAddressPrefixLength = default(int?), string privateIPAllocationMethod = default(string), string privateIPAddressVersion = default(string), SubnetAutoGenerated subnet = default(SubnetAutoGenerated), bool? primary = default(bool?), PublicIPAddressAutoGenerated publicIPAddress = default(PublicIPAddressAutoGenerated), System.Collections.Generic.IList<ApplicationSecurityGroup> applicationSecurityGroups = default(System.Collections.Generic.IList<ApplicationSecurityGroup>), string provisioningState = default(string), NetworkInterfaceIPConfigurationPrivateLinkConnectionProperties privateLinkConnectionProperties = default(NetworkInterfaceIPConfigurationPrivateLinkConnectionProperties))
        ...
        public System.Collections.Generic.IList<VirtualNetworkTapAutoGenerated> VirtualNetworkTaps {get; set; }
        ...
        public System.Collections.Generic.IList<ApplicationGatewayBackendAddressPoolAutoGenerated> ApplicationGatewayBackendAddressPools {get; set; }
        ...
        public System.Collections.Generic.IList<BackendAddressPoolAutoGenerated> LoadBalancerBackendAddressPools {get; set; }
        ...
        public System.Collections.Generic.IList<InboundNatRuleAutoGenerated> LoadBalancerInboundNatRules {get; set; }
        ...
        public SubnetAutoGenerated Subnet {get; set; }
        ...
        public PublicIPAddressAutoGenerated PublicIPAddress {get; set; }
