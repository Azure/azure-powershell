...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonPrivateEndpointConnection : CommonSubResourceModel
    {
        /// <summary>
        /// Initializes a new instance of the CommonPrivateEndpointConnection class.
        /// </summary>
        public CommonPrivateEndpointConnection()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CommonPrivateEndpointConnection(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), string provisioningState = default(string), CommonPrivateEndpoint privateEndpoint = default(CommonPrivateEndpoint), CommonPrivateLinkServiceConnectionState privateLinkServiceConnectionState = default(CommonPrivateLinkServiceConnectionState), string linkIdentifier = default(string), string privateEndpointLocation = default(string))
