...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonVirtualNetworkTap : CommonResource
    {
        /// <summary>
        /// Initializes a new instance of the CommonVirtualNetworkTap class.
        /// </summary>
        public CommonVirtualNetworkTap()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CommonVirtualNetworkTap(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string etag = default(string), string provisioningState = default(string), System.Collections.Generic.IList<CommonNetworkInterfaceTapConfiguration> networkInterfaceTapConfigurations = default(System.Collections.Generic.IList<CommonNetworkInterfaceTapConfiguration>), string resourceGuid = default(string), CommonNetworkInterfaceIPConfiguration destinationNetworkInterfaceIPConfiguration = default(CommonNetworkInterfaceIPConfiguration), CommonFrontendIPConfiguration destinationLoadBalancerFrontEndIPConfiguration = default(CommonFrontendIPConfiguration), int? destinationPort = default(int?))
