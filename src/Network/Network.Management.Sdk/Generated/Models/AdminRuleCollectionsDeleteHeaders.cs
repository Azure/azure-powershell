...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class AdminRuleCollectionsDeleteHeaders
    {
        /// <summary>
        ...
        /// </param>
        public AdminRuleCollectionsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
