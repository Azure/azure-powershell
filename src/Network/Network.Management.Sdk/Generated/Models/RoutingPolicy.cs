...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class RoutingPolicy
    {
        ...
        /// <param name="name">The unique name for the routing policy.
        /// </param>

        /// <param name="destinations">List of all destinations which this routing policy is applicable to (for
        /// example: Internet, PrivateTraffic).
        /// </param>

        /// <param name="nextHop">The next hop resource id on which this routing policy is applicable to.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets the next hop resource id on which this routing policy is
        /// applicable to.
        /// </summary>
