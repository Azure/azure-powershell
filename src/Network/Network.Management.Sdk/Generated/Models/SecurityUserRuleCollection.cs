...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class SecurityUserRuleCollection : ChildResource
    {
        /// <summary>
        /// Initializes a new instance of the SecurityUserRuleCollection class.
        /// </summary>
        public SecurityUserRuleCollection()
        {
            CustomInit();
        }
        ...
        /// </param>
        public SecurityUserRuleCollection(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), SystemData systemData = default(SystemData), string provisioningState = default(string), string description = default(string), System.Collections.Generic.IList<SecurityUserGroupItem> appliesToGroups = default(System.Collections.Generic.IList<SecurityUserGroupItem>), string resourceGuid = default(string))
