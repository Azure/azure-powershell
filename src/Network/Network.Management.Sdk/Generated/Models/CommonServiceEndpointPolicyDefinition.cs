...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonServiceEndpointPolicyDefinition : CommonSubResourceModel
    {
        /// <summary>
        /// Initializes a new instance of the CommonServiceEndpointPolicyDefinition class.
        /// </summary>
        public CommonServiceEndpointPolicyDefinition()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CommonServiceEndpointPolicyDefinition(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), string provisioningState = default(string), string description = default(string), string service = default(string), System.Collections.Generic.IList<string> serviceResources = default(System.Collections.Generic.IList<string>))
