...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonPrivateLinkService : CommonResource
    {
        /// <summary>
        /// Initializes a new instance of the CommonPrivateLinkService class.
        /// </summary>
        public CommonPrivateLinkService()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CommonPrivateLinkService(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), CommonExtendedLocation extendedLocation = default(CommonExtendedLocation), string etag = default(string), string accessMode = default(string), string provisioningState = default(string), System.Collections.Generic.IList<CommonFrontendIPConfiguration> loadBalancerFrontendIPConfigurations = default(System.Collections.Generic.IList<CommonFrontendIPConfiguration>), System.Collections.Generic.IList<CommonPrivateLinkServiceIpConfiguration> ipConfigurations = default(System.Collections.Generic.IList<CommonPrivateLinkServiceIpConfiguration>), string destinationIPAddress = default(string), System.Collections.Generic.IList<CommonNetworkInterface> networkInterfaces = default(System.Collections.Generic.IList<CommonNetworkInterface>), System.Collections.Generic.IList<CommonPrivateEndpointConnection> privateEndpointConnections = default(System.Collections.Generic.IList<CommonPrivateEndpointConnection>), CommonPrivateLinkServicePropertiesVisibility visibility = default(CommonPrivateLinkServicePropertiesVisibility), CommonPrivateLinkServicePropertiesAutoApproval autoApproval = default(CommonPrivateLinkServicePropertiesAutoApproval), System.Collections.Generic.IList<string> fqdns = default(System.Collections.Generic.IList<string>), string alias = default(string), bool? enableProxyProtocol = default(bool?))
