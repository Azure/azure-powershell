...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class FrontendIPConfigurationAutoGenerated : SubResourceModel
    {
        /// <summary>
        /// Initializes a new instance of the FrontendIPConfigurationAutoGenerated class.
        /// </summary>
        public FrontendIPConfigurationAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public FrontendIPConfigurationAutoGenerated(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), System.Collections.Generic.IList<string> zones = default(System.Collections.Generic.IList<string>), string provisioningState = default(string), System.Collections.Generic.IList<SubResource> inboundNatRules = default(System.Collections.Generic.IList<SubResource>), System.Collections.Generic.IList<SubResource> inboundNatPools = default(System.Collections.Generic.IList<SubResource>), System.Collections.Generic.IList<SubResource> outboundRules = default(System.Collections.Generic.IList<SubResource>), System.Collections.Generic.IList<SubResource> loadBalancingRules = default(System.Collections.Generic.IList<SubResource>), string privateIPAddress = default(string), string privateIPAllocationMethod = default(string), string privateIPAddressVersion = default(string), SubnetAutoGenerated subnet = default(SubnetAutoGenerated), PublicIPAddressAutoGenerated publicIPAddress = default(PublicIPAddressAutoGenerated), SubResource publicIPPrefix = default(SubResource), SubResource gatewayLoadBalancer = default(SubResource), DdosFrontendIpConfigurationSettings ddosSettings = default(DdosFrontendIpConfigurationSettings))
