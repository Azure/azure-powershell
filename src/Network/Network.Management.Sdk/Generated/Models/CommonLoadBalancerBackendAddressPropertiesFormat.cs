...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class CommonLoadBalancerBackendAddressPropertiesFormat
    {
        /// <summary>
        /// Initializes a new instance of the CommonLoadBalancerBackendAddressPropertiesFormat class.
        /// </summary>
        public CommonLoadBalancerBackendAddressPropertiesFormat()
        {
            CustomInit();
        }
        ...
        public CommonLoadBalancerBackendAddressPropertiesFormat(CommonSubResource virtualNetwork = default(CommonSubResource), CommonSubResource subnet = default(CommonSubResource), string ipAddress = default(string), CommonSubResource networkInterfaceIPConfiguration = default(CommonSubResource), CommonSubResource loadBalancerFrontendIPConfiguration = default(CommonSubResource), System.Collections.Generic.IList<CommonNatRulePortMapping> inboundNatRulesPortMapping = default(System.Collections.Generic.IList<CommonNatRulePortMapping>), string adminState = default(string))
        ...
        public CommonSubResource NetworkInterfaceIPConfiguration {get; private set; }
        ...
        public CommonSubResource LoadBalancerFrontendIPConfiguration {get; set; }

        /// <summary>
        /// Gets collection of inbound NAT rule port mappings.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "inboundNatRulesPortMapping")]
        public System.Collections.Generic.IList<CommonNatRulePortMapping> InboundNatRulesPortMapping {get; private set; }
