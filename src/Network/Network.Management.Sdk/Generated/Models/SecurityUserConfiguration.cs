...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class SecurityUserConfiguration : ChildResource
    {
        /// <summary>
        ...
        /// </param>
        public SecurityUserConfiguration(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), SystemData systemData = default(SystemData), string provisioningState = default(string), string description = default(string), string resourceGuid = default(string))
