...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class CommonIPConfigurationPropertiesFormat
    {
        /// <summary>
        /// Initializes a new instance of the CommonIPConfigurationPropertiesFormat class.
        /// </summary>
        public CommonIPConfigurationPropertiesFormat()
        {
            CustomInit();
        }
        ...
        public CommonIPConfigurationPropertiesFormat(string privateIPAddress = default(string), string privateIPAllocationMethod = default(string), CommonSubnet subnet = default(CommonSubnet), CommonPublicIPAddress publicIPAddress = default(CommonPublicIPAddress), string provisioningState = default(string))
