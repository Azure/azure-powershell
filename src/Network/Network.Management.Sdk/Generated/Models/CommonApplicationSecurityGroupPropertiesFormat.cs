...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class CommonApplicationSecurityGroupPropertiesFormat
    {
        /// <summary>
        /// Initializes a new instance of the CommonApplicationSecurityGroupPropertiesFormat class.
        /// </summary>
        public CommonApplicationSecurityGroupPropertiesFormat()
        {
            CustomInit();
        }
        ...
        public CommonApplicationSecurityGroupPropertiesFormat(string resourceGuid = default(string), string provisioningState = default(string))
