...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the CommonIPConfiguration class.
        /// </summary>
        ...
        /// </param>
        public CommonIPConfiguration(string id = default(string), string name = default(string), string etag = default(string), string provisioningState = default(string), string privateIPAddress = default(string), string privateIPAllocationMethod = default(string), CommonSubnet subnet = default(CommonSubnet), CommonPublicIPAddress publicIPAddress = default(CommonPublicIPAddress))
