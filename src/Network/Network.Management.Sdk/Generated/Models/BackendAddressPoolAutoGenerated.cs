...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class BackendAddressPoolAutoGenerated : SubResourceModel
    {
        /// <summary>
        /// Initializes a new instance of the BackendAddressPoolAutoGenerated class.
        /// </summary>
        public BackendAddressPoolAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public BackendAddressPoolAutoGenerated(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), string provisioningState = default(string), string syncMode = default(string), string location = default(string), System.Collections.Generic.IList<GatewayLoadBalancerTunnelInterface> tunnelInterfaces = default(System.Collections.Generic.IList<GatewayLoadBalancerTunnelInterface>), System.Collections.Generic.IList<LoadBalancerBackendAddress> loadBalancerBackendAddresses = default(System.Collections.Generic.IList<LoadBalancerBackendAddress>), System.Collections.Generic.IList<NetworkInterfaceIPConfigurationAutoGenerated> backendIPConfigurations = default(System.Collections.Generic.IList<NetworkInterfaceIPConfigurationAutoGenerated>), System.Collections.Generic.IList<SubResource> loadBalancingRules = default(System.Collections.Generic.IList<SubResource>), SubResource outboundRule = default(SubResource), System.Collections.Generic.IList<SubResource> outboundRules = default(System.Collections.Generic.IList<SubResource>), System.Collections.Generic.IList<SubResource> inboundNatRules = default(System.Collections.Generic.IList<SubResource>), int? drainPeriodInSeconds = default(int?), SubResource virtualNetwork = default(SubResource))
