...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonRouteTable : CommonResource
    {
        /// <summary>
        /// Initializes a new instance of the CommonRouteTable class.
        /// </summary>
        public CommonRouteTable()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CommonRouteTable(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string etag = default(string), string provisioningState = default(string), System.Collections.Generic.IList<CommonRoute> routes = default(System.Collections.Generic.IList<CommonRoute>), System.Collections.Generic.IList<CommonSubnet> subnets = default(System.Collections.Generic.IList<CommonSubnet>), bool? disableBgpRoutePropagation = default(bool?), string disablePeeringRoute = default(string), string resourceGuid = default(string))
