...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class VirtualNetworkPropertiesFormatAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the VirtualNetworkPropertiesFormatAutoGenerated class.
        /// </summary>
        public VirtualNetworkPropertiesFormatAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// virtual network.
        /// </param>
        public VirtualNetworkPropertiesFormatAutoGenerated(AddressSpace addressSpace = default(AddressSpace), DhcpOptions dhcpOptions = default(DhcpOptions), int? flowTimeoutInMinutes = default(int?), System.Collections.Generic.IList<SubnetAutoGenerated> subnets = default(System.Collections.Generic.IList<SubnetAutoGenerated>), System.Collections.Generic.IList<VirtualNetworkPeeringAutoGenerated> virtualNetworkPeerings = default(System.Collections.Generic.IList<VirtualNetworkPeeringAutoGenerated>), string resourceGuid = default(string), string provisioningState = default(string), bool? enableDdosProtection = default(bool?), bool? enableVMProtection = default(bool?), SubResource ddosProtectionPlan = default(SubResource), VirtualNetworkBgpCommunities bgpCommunities = default(VirtualNetworkBgpCommunities), VirtualNetworkEncryption encryption = default(VirtualNetworkEncryption), System.Collections.Generic.IList<SubResource> ipAllocations = default(System.Collections.Generic.IList<SubResource>), System.Collections.Generic.IList<FlowLog> flowLogs = default(System.Collections.Generic.IList<FlowLog>), string privateEndpointVNetPolicies = default(string), SubResource defaultPublicNatGateway = default(SubResource), AddressSpace summarizedGatewayPrefixes = default(AddressSpace))
        ...
        public System.Collections.Generic.IList<SubnetAutoGenerated> Subnets {get; set; }

        /// <summary>
        /// Gets or sets a list of peerings in a Virtual Network.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "virtualNetworkPeerings")]
        public System.Collections.Generic.IList<VirtualNetworkPeeringAutoGenerated> VirtualNetworkPeerings {get; set; }
