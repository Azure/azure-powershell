...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonProbe : CommonSubResourceModel
    {
        /// <summary>
        /// Initializes a new instance of the CommonProbe class.
        /// </summary>
        public CommonProbe()
        {
            CustomInit();
        ...
        /// default value.
        /// </param>
        public CommonProbe(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), string provisioningState = default(string), System.Collections.Generic.IList<CommonSubResource> loadBalancingRules = default(System.Collections.Generic.IList<CommonSubResource>), string protocol = default(string), int? port = default(int?), int? intervalInSeconds = default(int?), string noHealthyBackendsBehavior = default(string), int? numberOfProbes = default(int?), int? probeThreshold = default(int?), string requestPath = default(string))
