...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the CommonTrafficAnalyticsConfigurationProperties class.
        /// </summary>
        ...
        /// do flow analytics.
        /// </param>
        public CommonTrafficAnalyticsConfigurationProperties(bool? enabled = default(bool?), string workspaceId = default(string), string workspaceRegion = default(string), string workspaceResourceId = default(string), int? trafficAnalyticsInterval = default(int?))
