...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonPrivateLinkServiceIpConfiguration : CommonSubResource
    {
        /// <summary>
        /// Initializes a new instance of the CommonPrivateLinkServiceIpConfiguration class.
        /// </summary>
        public CommonPrivateLinkServiceIpConfiguration()
        {
            CustomInit();
        }
        ...
        public CommonPrivateLinkServiceIpConfiguration(string id = default(string), string name = default(string), string etag = default(string), string type = default(string), string provisioningState = default(string), string privateIPAddress = default(string), string privateIPAllocationMethod = default(string), CommonSubnet subnet = default(CommonSubnet), bool? primary = default(bool?), string privateIPAddressVersion = default(string))
