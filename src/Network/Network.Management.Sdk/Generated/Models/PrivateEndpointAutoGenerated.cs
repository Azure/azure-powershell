...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class PrivateEndpointAutoGenerated : Resource
    {
        /// <summary>
        /// Initializes a new instance of the PrivateEndpointAutoGenerated class.
        /// </summary>
        ...
        public PrivateEndpointAutoGenerated(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), ExtendedLocation extendedLocation = default(ExtendedLocation), string etag = default(string), string provisioningState = default(string), SubnetAutoGenerated subnet = default(SubnetAutoGenerated), System.Collections.Generic.IList<NetworkInterfaceAutoGenerated> networkInterfaces = default(System.Collections.Generic.IList<NetworkInterfaceAutoGenerated>), string ipVersionType = default(string), System.Collections.Generic.IList<PrivateLinkServiceConnectionAutoGenerated> privateLinkServiceConnections = default(System.Collections.Generic.IList<PrivateLinkServiceConnectionAutoGenerated>), System.Collections.Generic.IList<PrivateLinkServiceConnectionAutoGenerated> manualPrivateLinkServiceConnections = default(System.Collections.Generic.IList<PrivateLinkServiceConnectionAutoGenerated>), System.Collections.Generic.IList<CustomDnsConfigPropertiesFormat> customDnsConfigs = default(System.Collections.Generic.IList<CustomDnsConfigPropertiesFormat>), System.Collections.Generic.IList<ApplicationSecurityGroup> applicationSecurityGroups = default(System.Collections.Generic.IList<ApplicationSecurityGroup>), System.Collections.Generic.IList<PrivateEndpointIPConfiguration> ipConfigurations = default(System.Collections.Generic.IList<PrivateEndpointIPConfiguration>), string customNetworkInterfaceName = default(string), string billingSku = default(string))
