...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class CommonLoadBalancingRulePropertiesFormat
    {
        /// <summary>
        /// Initializes a new instance of the CommonLoadBalancingRulePropertiesFormat class.
        /// </summary>
        public CommonLoadBalancingRulePropertiesFormat()
        {
            CustomInit();
        }
        ...
        public CommonLoadBalancingRulePropertiesFormat(string protocol, int frontendPort, CommonSubResource frontendIPConfiguration = default(CommonSubResource), CommonSubResource backendAddressPool = default(CommonSubResource), System.Collections.Generic.IList<CommonSubResource> backendAddressPools = default(System.Collections.Generic.IList<CommonSubResource>), CommonSubResource probe = default(CommonSubResource), string loadDistribution = default(string), int? backendPort = default(int?), int? idleTimeoutInMinutes = default(int?), bool? enableFloatingIP = default(bool?), bool? enableTcpReset = default(bool?), bool? disableOutboundSnat = default(bool?), bool? enableConnectionTracking = default(bool?), string provisioningState = default(string))
