...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ConnectionMonitorSuccessThreshold
    {
        ...
        /// <param name="checksFailedPercent">The maximum percentage of failed checks permitted for a test to evaluate as
        /// successful.
        /// </param>

        /// <param name="roundTripTimeMS">The maximum round-trip time in milliseconds permitted for a test to
        ...
        /// <summary>
        /// Gets or sets the maximum percentage of failed checks permitted for a test
        ...
        /// <summary>
        /// Gets or sets the maximum round-trip time in milliseconds permitted for a
