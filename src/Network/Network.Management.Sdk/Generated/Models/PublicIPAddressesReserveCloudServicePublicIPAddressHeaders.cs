...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class PublicIPAddressesReserveCloudServicePublicIPAddressHeaders
    {
        /// <summary>
        ...
        /// </param>
        public PublicIPAddressesReserveCloudServicePublicIPAddressHeaders(string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?))
