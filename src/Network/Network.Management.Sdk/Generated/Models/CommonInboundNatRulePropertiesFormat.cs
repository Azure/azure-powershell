...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class CommonInboundNatRulePropertiesFormat
    {
        /// <summary>
        /// Initializes a new instance of the CommonInboundNatRulePropertiesFormat class.
        /// </summary>
        public CommonInboundNatRulePropertiesFormat()
        {
            CustomInit();
        }
        ...
        public CommonInboundNatRulePropertiesFormat(CommonSubResource frontendIPConfiguration = default(CommonSubResource), CommonNetworkInterfaceIPConfiguration backendIPConfiguration = default(CommonNetworkInterfaceIPConfiguration), string protocol = default(string), int? frontendPort = default(int?), int? backendPort = default(int?), int? idleTimeoutInMinutes = default(int?), bool? enableFloatingIP = default(bool?), bool? enableTcpReset = default(bool?), int? frontendPortRangeStart = default(int?), int? frontendPortRangeEnd = default(int?), CommonSubResource backendAddressPool = default(CommonSubResource), string provisioningState = default(string))
        ...
        public CommonNetworkInterfaceIPConfiguration BackendIPConfiguration {get; private set; }
