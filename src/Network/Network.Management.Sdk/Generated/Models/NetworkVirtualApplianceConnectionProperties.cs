...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class NetworkVirtualApplianceConnectionProperties
    {
        ...
        /// </param>
        public NetworkVirtualApplianceConnectionProperties(string name = default(string), string provisioningState = default(string), long? asn = default(long?), long? tunnelIdentifier = default(long?), System.Collections.Generic.IList<string> bgpPeerAddress = default(System.Collections.Generic.IList<string>), bool? enableInternetSecurity = default(bool?), RoutingConfigurationNfv routingConfiguration = default(RoutingConfigurationNfv))
