...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayIPConfiguration : SubResource
    {
        ...
        /// </param>
        public ApplicationGatewayIPConfiguration(string id = default(string), string name = default(string), string etag = default(string), string type = default(string), string provisioningState = default(string), SubResource subnet = default(SubResource))
