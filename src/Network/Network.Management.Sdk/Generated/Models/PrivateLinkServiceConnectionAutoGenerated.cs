...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class PrivateLinkServiceConnectionAutoGenerated : SubResource
    {
        /// <summary>
        /// Initializes a new instance of the PrivateLinkServiceConnectionAutoGenerated class.
        /// </summary>
        public PrivateLinkServiceConnectionAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// the remote resource.
        /// </param>
        public PrivateLinkServiceConnectionAutoGenerated(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), string provisioningState = default(string), ApprovalReference approvalReference = default(ApprovalReference), string privateLinkServiceId = default(string), System.Collections.Generic.IList<string> groupIds = default(System.Collections.Generic.IList<string>), string requestMessage = default(string), PrivateLinkServiceConnectionState privateLinkServiceConnectionState = default(PrivateLinkServiceConnectionState))
