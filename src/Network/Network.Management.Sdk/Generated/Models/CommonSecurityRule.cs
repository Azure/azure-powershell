...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonSecurityRule : CommonSubResourceModel
    {
        /// <summary>
        /// Initializes a new instance of the CommonSecurityRule class.
        /// </summary>
        public CommonSecurityRule()
        {
            CustomInit();
        }
        ...
        public CommonSecurityRule(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), string provisioningState = default(string), string description = default(string), string protocol = default(string), string sourcePortRange = default(string), string destinationPortRange = default(string), string sourceAddressPrefix = default(string), System.Collections.Generic.IList<string> sourceAddressPrefixes = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<CommonApplicationSecurityGroup> sourceApplicationSecurityGroups = default(System.Collections.Generic.IList<CommonApplicationSecurityGroup>), string destinationAddressPrefix = default(string), System.Collections.Generic.IList<string> destinationAddressPrefixes = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<CommonApplicationSecurityGroup> destinationApplicationSecurityGroups = default(System.Collections.Generic.IList<CommonApplicationSecurityGroup>), System.Collections.Generic.IList<string> sourcePortRanges = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<string> destinationPortRanges = default(System.Collections.Generic.IList<string>), string access = default(string), int? priority = default(int?), string direction = default(string))
        ...
        public System.Collections.Generic.IList<CommonApplicationSecurityGroup> SourceApplicationSecurityGroups {get; set; }
        ...
        public System.Collections.Generic.IList<CommonApplicationSecurityGroup> DestinationApplicationSecurityGroups {get; set; }
