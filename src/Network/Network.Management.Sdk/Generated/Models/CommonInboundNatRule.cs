...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonInboundNatRule : CommonSubResourceModel
    {
        /// <summary>
        /// Initializes a new instance of the CommonInboundNatRule class.
        /// </summary>
        public CommonInboundNatRule()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CommonInboundNatRule(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), string provisioningState = default(string), CommonSubResource frontendIPConfiguration = default(CommonSubResource), CommonNetworkInterfaceIPConfiguration backendIPConfiguration = default(CommonNetworkInterfaceIPConfiguration), string protocol = default(string), int? frontendPort = default(int?), int? backendPort = default(int?), int? idleTimeoutInMinutes = default(int?), bool? enableFloatingIP = default(bool?), bool? enableTcpReset = default(bool?), int? frontendPortRangeStart = default(int?), int? frontendPortRangeEnd = default(int?), CommonSubResource backendAddressPool = default(CommonSubResource))
