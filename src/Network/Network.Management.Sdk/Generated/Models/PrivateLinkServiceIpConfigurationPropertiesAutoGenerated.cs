...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class PrivateLinkServiceIpConfigurationPropertiesAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the PrivateLinkServiceIpConfigurationPropertiesAutoGenerated class.
        /// </summary>
        public PrivateLinkServiceIpConfigurationPropertiesAutoGenerated()
        {
            CustomInit();
        }
        ...
        public PrivateLinkServiceIpConfigurationPropertiesAutoGenerated(string privateIPAddress = default(string), string privateIPAllocationMethod = default(string), SubnetAutoGenerated subnet = default(SubnetAutoGenerated), bool? primary = default(bool?), string provisioningState = default(string), string privateIPAddressVersion = default(string))
