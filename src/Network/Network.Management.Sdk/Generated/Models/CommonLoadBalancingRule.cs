...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonLoadBalancingRule : CommonSubResourceModel
    {
        /// <summary>
        /// Initializes a new instance of the CommonLoadBalancingRule class.
        /// </summary>
        public CommonLoadBalancingRule()
        {
            CustomInit();
        }
        ...
        /// UDP protocol.
        /// </param>
        public CommonLoadBalancingRule(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), string loadDistribution = default(string), string provisioningState = default(string), CommonSubResource frontendIPConfiguration = default(CommonSubResource), CommonSubResource backendAddressPool = default(CommonSubResource), System.Collections.Generic.IList<CommonSubResource> backendAddressPools = default(System.Collections.Generic.IList<CommonSubResource>), CommonSubResource probe = default(CommonSubResource), string protocol = default(string), int? frontendPort = default(int?), int? backendPort = default(int?), int? idleTimeoutInMinutes = default(int?), bool? enableFloatingIP = default(bool?), bool? enableTcpReset = default(bool?), bool? disableOutboundSnat = default(bool?), bool? enableConnectionTracking = default(bool?))
        ...
        public System.Collections.Generic.IList<CommonSubResource> BackendAddressPools {get; set; }
