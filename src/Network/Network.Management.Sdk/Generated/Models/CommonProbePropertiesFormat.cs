...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class CommonProbePropertiesFormat
    {
        /// <summary>
        /// Initializes a new instance of the CommonProbePropertiesFormat class.
        /// </summary>
        public CommonProbePropertiesFormat()
        {
            CustomInit();
        }
        ...
        public CommonProbePropertiesFormat(string protocol, int port, System.Collections.Generic.IList<CommonSubResource> loadBalancingRules = default(System.Collections.Generic.IList<CommonSubResource>), int? intervalInSeconds = default(int?), string noHealthyBackendsBehavior = default(string), int? numberOfProbes = default(int?), int? probeThreshold = default(int?), string requestPath = default(string), string provisioningState = default(string))
