...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonLoadBalancer : CommonResource
    {
        /// <summary>
        /// Initializes a new instance of the CommonLoadBalancer class.
        /// </summary>
        public CommonLoadBalancer()
        {
            CustomInit();
        }
        ...
        public CommonLoadBalancer(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string etag = default(string), CommonExtendedLocation extendedLocation = default(CommonExtendedLocation), CommonLoadBalancerSku sku = default(CommonLoadBalancerSku), string provisioningState = default(string), System.Collections.Generic.IList<CommonFrontendIPConfiguration> frontendIPConfigurations = default(System.Collections.Generic.IList<CommonFrontendIPConfiguration>), System.Collections.Generic.IList<CommonBackendAddressPool> backendAddressPools = default(System.Collections.Generic.IList<CommonBackendAddressPool>), System.Collections.Generic.IList<CommonLoadBalancingRule> loadBalancingRules = default(System.Collections.Generic.IList<CommonLoadBalancingRule>), System.Collections.Generic.IList<CommonProbe> probes = default(System.Collections.Generic.IList<CommonProbe>), System.Collections.Generic.IList<CommonInboundNatRule> inboundNatRules = default(System.Collections.Generic.IList<CommonInboundNatRule>), System.Collections.Generic.IList<CommonInboundNatPool> inboundNatPools = default(System.Collections.Generic.IList<CommonInboundNatPool>), System.Collections.Generic.IList<CommonOutboundRule> outboundRules = default(System.Collections.Generic.IList<CommonOutboundRule>), string resourceGuid = default(string), string scope = default(string))
        ...
        public System.Collections.Generic.IList<CommonFrontendIPConfiguration> FrontendIPConfigurations {get; set; }
        ...
        public System.Collections.Generic.IList<CommonBackendAddressPool> BackendAddressPools {get; set; }
        ...
        public System.Collections.Generic.IList<CommonLoadBalancingRule> LoadBalancingRules {get; set; }
        ...
        public System.Collections.Generic.IList<CommonProbe> Probes {get; set; }
        ...
        public System.Collections.Generic.IList<CommonInboundNatRule> InboundNatRules {get; set; }
        ...
        public System.Collections.Generic.IList<CommonInboundNatPool> InboundNatPools {get; set; }

        /// <summary>
        /// Gets or sets the outbound rules.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.outboundRules")]
        public System.Collections.Generic.IList<CommonOutboundRule> OutboundRules {get; set; }
