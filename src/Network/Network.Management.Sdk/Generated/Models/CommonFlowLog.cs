...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonFlowLog : CommonResource
    {
        /// <summary>
        /// Initializes a new instance of the CommonFlowLog class.
        /// </summary>
        public CommonFlowLog()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CommonFlowLog(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string etag = default(string), CommonManagedServiceIdentity identity = default(CommonManagedServiceIdentity), string provisioningState = default(string), string targetResourceId = default(string), string targetResourceGuid = default(string), string storageId = default(string), string enabledFilteringCriteria = default(string), string recordTypes = default(string), bool? enabled = default(bool?), CommonRetentionPolicyParameters retentionPolicy = default(CommonRetentionPolicyParameters), CommonFlowLogFormatParameters format = default(CommonFlowLogFormatParameters), CommonTrafficAnalyticsProperties flowAnalyticsConfiguration = default(CommonTrafficAnalyticsProperties))
