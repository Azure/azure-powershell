...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonNetworkInterface : CommonResource
    {
        /// <summary>
        /// Initializes a new instance of the CommonNetworkInterface class.
        /// </summary>
        public CommonNetworkInterface()
        {
            CustomInit();
        }
        ...
        public CommonNetworkInterface(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), CommonExtendedLocation extendedLocation = default(CommonExtendedLocation), string etag = default(string), string provisioningState = default(string), CommonSubResource virtualMachine = default(CommonSubResource), CommonNetworkSecurityGroup networkSecurityGroup = default(CommonNetworkSecurityGroup), CommonPrivateEndpoint privateEndpoint = default(CommonPrivateEndpoint), System.Collections.Generic.IList<CommonNetworkInterfaceIPConfiguration> ipConfigurations = default(System.Collections.Generic.IList<CommonNetworkInterfaceIPConfiguration>), System.Collections.Generic.IList<CommonNetworkInterfaceTapConfiguration> tapConfigurations = default(System.Collections.Generic.IList<CommonNetworkInterfaceTapConfiguration>), CommonNetworkInterfaceDnsSettings dnsSettings = default(CommonNetworkInterfaceDnsSettings), string macAddress = default(string), bool? primary = default(bool?), bool? vnetEncryptionSupported = default(bool?), bool? defaultOutboundConnectivityEnabled = default(bool?), bool? enableAcceleratedNetworking = default(bool?), bool? disableTcpStateTracking = default(bool?), bool? enableIPForwarding = default(bool?), System.Collections.Generic.IList<string> hostedWorkloads = default(System.Collections.Generic.IList<string>), CommonSubResource dscpConfiguration = default(CommonSubResource), string resourceGuid = default(string), string workloadType = default(string), string nicType = default(string), CommonPrivateLinkService privateLinkService = default(CommonPrivateLinkService), string migrationPhase = default(string), string auxiliaryMode = default(string), string auxiliarySku = default(string))
        ...
        public CommonSubResource VirtualMachine {get; private set; }
        ...
        public System.Collections.Generic.IList<CommonNetworkInterfaceIPConfiguration> IPConfigurations {get; set; }
        ...
        public System.Collections.Generic.IList<CommonNetworkInterfaceTapConfiguration> TapConfigurations {get; private set; }

        /// <summary>
        /// Gets or sets the DNS settings in network interface.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.dnsSettings")]
        public CommonNetworkInterfaceDnsSettings DnsSettings {get; set; }
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.defaultOutboundConnectivityEnabled")]
        ...
        public CommonSubResource DscpConfiguration {get; private set; }
        ...
        public CommonPrivateLinkService PrivateLinkService {get; set; }
