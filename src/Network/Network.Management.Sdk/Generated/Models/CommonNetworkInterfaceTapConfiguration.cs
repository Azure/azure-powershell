...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonNetworkInterfaceTapConfiguration : CommonSubResourceModel
    {
        /// <summary>
        /// Initializes a new instance of the CommonNetworkInterfaceTapConfiguration class.
        /// </summary>
        public CommonNetworkInterfaceTapConfiguration()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CommonNetworkInterfaceTapConfiguration(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), string provisioningState = default(string), CommonVirtualNetworkTap virtualNetworkTap = default(CommonVirtualNetworkTap))
        ...
        public CommonVirtualNetworkTap VirtualNetworkTap {get; set; }
        /// <summary>
        /// Validate the object.
        /// </summary>
