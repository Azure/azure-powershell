...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class PrivateLinkServiceAutoGenerated : Resource
    {
        /// <summary>
        /// Initializes a new instance of the PrivateLinkServiceAutoGenerated class.
        /// </summary>
        public PrivateLinkServiceAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public PrivateLinkServiceAutoGenerated(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), ExtendedLocation extendedLocation = default(ExtendedLocation), string etag = default(string), string accessMode = default(string), string provisioningState = default(string), System.Collections.Generic.IList<FrontendIPConfigurationAutoGenerated> loadBalancerFrontendIPConfigurations = default(System.Collections.Generic.IList<FrontendIPConfigurationAutoGenerated>), System.Collections.Generic.IList<PrivateLinkServiceIpConfigurationAutoGenerated> ipConfigurations = default(System.Collections.Generic.IList<PrivateLinkServiceIpConfigurationAutoGenerated>), string destinationIPAddress = default(string), System.Collections.Generic.IList<NetworkInterfaceAutoGenerated> networkInterfaces = default(System.Collections.Generic.IList<NetworkInterfaceAutoGenerated>), System.Collections.Generic.IList<PrivateEndpointConnectionAutoGenerated> privateEndpointConnections = default(System.Collections.Generic.IList<PrivateEndpointConnectionAutoGenerated>), PrivateLinkServicePropertiesVisibility visibility = default(PrivateLinkServicePropertiesVisibility), PrivateLinkServicePropertiesAutoApproval autoApproval = default(PrivateLinkServicePropertiesAutoApproval), System.Collections.Generic.IList<string> fqdns = default(System.Collections.Generic.IList<string>), string alias = default(string), bool? enableProxyProtocol = default(bool?))
