...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the CommonPrivateLinkServiceConnection class.
        /// </summary>
        ...
        /// the remote resource.
        /// </param>
        public CommonPrivateLinkServiceConnection(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), string provisioningState = default(string), string privateLinkServiceId = default(string), System.Collections.Generic.IList<string> groupIds = default(System.Collections.Generic.IList<string>), string requestMessage = default(string), CommonPrivateLinkServiceConnectionState privateLinkServiceConnectionState = default(CommonPrivateLinkServiceConnectionState))
