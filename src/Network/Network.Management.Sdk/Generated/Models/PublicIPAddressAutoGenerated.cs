...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class PublicIPAddressAutoGenerated : Resource
    {
        /// <summary>
        /// Initializes a new instance of the PublicIPAddressAutoGenerated class.
        /// </summary>
        public PublicIPAddressAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// StandardV2.
        /// </param>
        public PublicIPAddressAutoGenerated(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), ExtendedLocation extendedLocation = default(ExtendedLocation), PublicIPAddressSku sku = default(PublicIPAddressSku), string etag = default(string), System.Collections.Generic.IList<string> zones = default(System.Collections.Generic.IList<string>), DdosSettings ddosSettings = default(DdosSettings), string provisioningState = default(string), NatGateway natGateway = default(NatGateway), string publicIPAllocationMethod = default(string), string publicIPAddressVersion = default(string), IPConfigurationAutoGenerated ipConfiguration = default(IPConfigurationAutoGenerated), PublicIPAddressDnsSettings dnsSettings = default(PublicIPAddressDnsSettings), System.Collections.Generic.IList<IpTag> ipTags = default(System.Collections.Generic.IList<IpTag>), string ipAddress = default(string), SubResource publicIPPrefix = default(SubResource), int? idleTimeoutInMinutes = default(int?), string resourceGuid = default(string), PublicIPAddressAutoGenerated servicePublicIPAddress = default(PublicIPAddressAutoGenerated), string migrationPhase = default(string), PublicIPAddressAutoGenerated linkedPublicIPAddress = default(PublicIPAddressAutoGenerated), string deleteOption = default(string), bool? upgradedToV2 = default(bool?))
        ...
        public IPConfigurationAutoGenerated IPConfiguration {get; private set; }
        ...
        public PublicIPAddressAutoGenerated ServicePublicIPAddress {get; set; }
        ...
        public PublicIPAddressAutoGenerated LinkedPublicIPAddress {get; set; }
