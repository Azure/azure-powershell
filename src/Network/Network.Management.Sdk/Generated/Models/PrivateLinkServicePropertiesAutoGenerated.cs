...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class PrivateLinkServicePropertiesAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the PrivateLinkServicePropertiesAutoGenerated class.
        /// </summary>
        public PrivateLinkServicePropertiesAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public PrivateLinkServicePropertiesAutoGenerated(System.Collections.Generic.IList<FrontendIPConfigurationAutoGenerated> loadBalancerFrontendIPConfigurations = default(System.Collections.Generic.IList<FrontendIPConfigurationAutoGenerated>), System.Collections.Generic.IList<PrivateLinkServiceIpConfigurationAutoGenerated> ipConfigurations = default(System.Collections.Generic.IList<PrivateLinkServiceIpConfigurationAutoGenerated>), string destinationIPAddress = default(string), string accessMode = default(string), System.Collections.Generic.IList<NetworkInterfaceAutoGenerated> networkInterfaces = default(System.Collections.Generic.IList<NetworkInterfaceAutoGenerated>), string provisioningState = default(string), System.Collections.Generic.IList<PrivateEndpointConnectionAutoGenerated> privateEndpointConnections = default(System.Collections.Generic.IList<PrivateEndpointConnectionAutoGenerated>), PrivateLinkServicePropertiesVisibility visibility = default(PrivateLinkServicePropertiesVisibility), PrivateLinkServicePropertiesAutoApproval autoApproval = default(PrivateLinkServicePropertiesAutoApproval), System.Collections.Generic.IList<string> fqdns = default(System.Collections.Generic.IList<string>), string alias = default(string), bool? enableProxyProtocol = default(bool?))
        ...
        public System.Collections.Generic.IList<FrontendIPConfigurationAutoGenerated> LoadBalancerFrontendIPConfigurations {get; set; }
        ...
        public System.Collections.Generic.IList<PrivateLinkServiceIpConfigurationAutoGenerated> IPConfigurations {get; set; }
        ...
        public System.Collections.Generic.IList<PrivateEndpointConnectionAutoGenerated> PrivateEndpointConnections {get; private set; }
