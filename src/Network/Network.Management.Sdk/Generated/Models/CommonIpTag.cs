...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class CommonIpTag
    {
        /// <summary>
        /// Initializes a new instance of the CommonIpTag class.
        /// </summary>
        public CommonIpTag()
        {
            CustomInit();
        ...
        /// <param name="ipTagType">The IP tag type. Example: FirstPartyUsage.
        /// </param>

        /// <param name="tag">The value of the IP tag associated with the public IP. Example: SQL.
        /// </param>
        public CommonIpTag(string ipTagType = default(string), string tag = default(string))
