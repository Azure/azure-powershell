...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class AzureFirewallNetworkRuleCollection : CommonSubResource
    {
        /// <summary>
        ...
        /// </param>
        public AzureFirewallNetworkRuleCollection(string id = default(string), string name = default(string), string etag = default(string), string provisioningState = default(string), int? priority = default(int?), AzureFirewallRCAction action = default(AzureFirewallRCAction), System.Collections.Generic.IList<AzureFirewallNetworkRule> rules = default(System.Collections.Generic.IList<AzureFirewallNetworkRule>))
