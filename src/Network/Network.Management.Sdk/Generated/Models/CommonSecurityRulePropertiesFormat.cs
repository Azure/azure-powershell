...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class CommonSecurityRulePropertiesFormat
    {
        /// <summary>
        /// Initializes a new instance of the CommonSecurityRulePropertiesFormat class.
        /// </summary>
        public CommonSecurityRulePropertiesFormat()
        {
            CustomInit();
        }
        ...
        public CommonSecurityRulePropertiesFormat(string protocol, string access, int priority, string direction, string description = default(string), string sourcePortRange = default(string), string destinationPortRange = default(string), string sourceAddressPrefix = default(string), System.Collections.Generic.IList<string> sourceAddressPrefixes = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<CommonApplicationSecurityGroup> sourceApplicationSecurityGroups = default(System.Collections.Generic.IList<CommonApplicationSecurityGroup>), string destinationAddressPrefix = default(string), System.Collections.Generic.IList<string> destinationAddressPrefixes = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<CommonApplicationSecurityGroup> destinationApplicationSecurityGroups = default(System.Collections.Generic.IList<CommonApplicationSecurityGroup>), System.Collections.Generic.IList<string> sourcePortRanges = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<string> destinationPortRanges = default(System.Collections.Generic.IList<string>), string provisioningState = default(string))
