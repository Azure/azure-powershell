...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class BackendAddressPoolPropertiesFormatAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the BackendAddressPoolPropertiesFormatAutoGenerated class.
        /// </summary>
        public BackendAddressPoolPropertiesFormatAutoGenerated()
        {
            CustomInit();
        }
        ...
        public BackendAddressPoolPropertiesFormatAutoGenerated(string location = default(string), System.Collections.Generic.IList<GatewayLoadBalancerTunnelInterface> tunnelInterfaces = default(System.Collections.Generic.IList<GatewayLoadBalancerTunnelInterface>), System.Collections.Generic.IList<LoadBalancerBackendAddress> loadBalancerBackendAddresses = default(System.Collections.Generic.IList<LoadBalancerBackendAddress>), System.Collections.Generic.IList<NetworkInterfaceIPConfigurationAutoGenerated> backendIPConfigurations = default(System.Collections.Generic.IList<NetworkInterfaceIPConfigurationAutoGenerated>), System.Collections.Generic.IList<SubResource> loadBalancingRules = default(System.Collections.Generic.IList<SubResource>), SubResource outboundRule = default(SubResource), System.Collections.Generic.IList<SubResource> outboundRules = default(System.Collections.Generic.IList<SubResource>), System.Collections.Generic.IList<SubResource> inboundNatRules = default(System.Collections.Generic.IList<SubResource>), string provisioningState = default(string), int? drainPeriodInSeconds = default(int?), SubResource virtualNetwork = default(SubResource), string syncMode = default(string))
        ...
        public System.Collections.Generic.IList<NetworkInterfaceIPConfigurationAutoGenerated> BackendIPConfigurations {get; private set; }
