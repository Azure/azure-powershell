...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonServiceAssociationLink : CommonSubResource
    {
        /// <summary>
        /// Initializes a new instance of the CommonServiceAssociationLink class.
        /// </summary>
        public CommonServiceAssociationLink()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CommonServiceAssociationLink(string id = default(string), string name = default(string), string etag = default(string), string type = default(string), string provisioningState = default(string), string linkedResourceType = default(string), string link = default(string), bool? allowDelete = default(bool?), System.Collections.Generic.IList<string> locations = default(System.Collections.Generic.IList<string>))
