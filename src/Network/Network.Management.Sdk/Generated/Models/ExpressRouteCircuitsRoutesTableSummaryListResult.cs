...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ExpressRouteCircuitsRoutesTableSummaryListResult
    {
        ...
        /// <param name="value">A list of the routes table.
        /// </param>

        /// <param name="nextLink">The URL to get the next set of results.
        /// </param>
        public ExpressRouteCircuitsRoutesTableSummaryListResult(System.Collections.Generic.IList<ExpressRouteCircuitRoutesTableSummary> value = default(System.Collections.Generic.IList<ExpressRouteCircuitRoutesTableSummary>), string nextLink = default(string))
