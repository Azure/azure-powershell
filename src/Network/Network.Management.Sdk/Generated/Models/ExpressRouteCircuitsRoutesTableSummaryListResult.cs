...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ExpressRouteCircuitsRoutesTableSummaryListResult
    {
        ...
        /// <param name="value">The ExpressRouteCircuitRoutesTableSummary items on this page
        /// </param>

        /// <param name="nextLink">The link to the next page of items
        /// </param>
        public ExpressRouteCircuitsRoutesTableSummaryListResult(System.Collections.Generic.IList<ExpressRouteCircuitRoutesTableSummary> value, string nextLink = default(string))
        ...
        /// <summary>
        /// Gets or sets the ExpressRouteCircuitRoutesTableSummary items on this page
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "value")]
        public System.Collections.Generic.IList<ExpressRouteCircuitRoutesTableSummary> Value {get; set; }
