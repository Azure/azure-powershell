...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class FrontendIPConfigurationPropertiesFormatAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the FrontendIPConfigurationPropertiesFormatAutoGenerated class.
        /// </summary>
        public FrontendIPConfigurationPropertiesFormatAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public FrontendIPConfigurationPropertiesFormatAutoGenerated(System.Collections.Generic.IList<SubResource> inboundNatRules = default(System.Collections.Generic.IList<SubResource>), System.Collections.Generic.IList<SubResource> inboundNatPools = default(System.Collections.Generic.IList<SubResource>), System.Collections.Generic.IList<SubResource> outboundRules = default(System.Collections.Generic.IList<SubResource>), System.Collections.Generic.IList<SubResource> loadBalancingRules = default(System.Collections.Generic.IList<SubResource>), string privateIPAddress = default(string), string privateIPAllocationMethod = default(string), string privateIPAddressVersion = default(string), SubnetAutoGenerated subnet = default(SubnetAutoGenerated), PublicIPAddressAutoGenerated publicIPAddress = default(PublicIPAddressAutoGenerated), SubResource publicIPPrefix = default(SubResource), SubResource gatewayLoadBalancer = default(SubResource), string provisioningState = default(string), DdosFrontendIpConfigurationSettings ddosSettings = default(DdosFrontendIpConfigurationSettings))
