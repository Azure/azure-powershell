...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class VirtualNetworkTapAutoGenerated : Resource
    {
        /// <summary>
        /// Initializes a new instance of the VirtualNetworkTapAutoGenerated class.
        /// </summary>
        public VirtualNetworkTapAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public VirtualNetworkTapAutoGenerated(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string etag = default(string), string provisioningState = default(string), System.Collections.Generic.IList<NetworkInterfaceTapConfigurationAutoGenerated> networkInterfaceTapConfigurations = default(System.Collections.Generic.IList<NetworkInterfaceTapConfigurationAutoGenerated>), string resourceGuid = default(string), NetworkInterfaceIPConfigurationAutoGenerated destinationNetworkInterfaceIPConfiguration = default(NetworkInterfaceIPConfigurationAutoGenerated), FrontendIPConfigurationAutoGenerated destinationLoadBalancerFrontEndIPConfiguration = default(FrontendIPConfigurationAutoGenerated), int? destinationPort = default(int?))
        ...
        public System.Collections.Generic.IList<NetworkInterfaceTapConfigurationAutoGenerated> NetworkInterfaceTapConfigurations {get; private set; }
        ...
        public NetworkInterfaceIPConfigurationAutoGenerated DestinationNetworkInterfaceIPConfiguration {get; set; }
        ...
        public FrontendIPConfigurationAutoGenerated DestinationLoadBalancerFrontEndIPConfiguration {get; set; }
