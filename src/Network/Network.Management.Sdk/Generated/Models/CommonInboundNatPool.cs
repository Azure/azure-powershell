...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonInboundNatPool : CommonSubResource
    {
        /// <summary>
        /// Initializes a new instance of the CommonInboundNatPool class.
        /// </summary>
        public CommonInboundNatPool()
        {
            CustomInit();
        }
        ...
        /// to TCP.
        /// </param>
        public CommonInboundNatPool(string id = default(string), string name = default(string), string etag = default(string), string type = default(string), string provisioningState = default(string), CommonSubResource frontendIPConfiguration = default(CommonSubResource), string protocol = default(string), int? frontendPortRangeStart = default(int?), int? frontendPortRangeEnd = default(int?), int? backendPort = default(int?), int? idleTimeoutInMinutes = default(int?), bool? enableFloatingIP = default(bool?), bool? enableTcpReset = default(bool?))
