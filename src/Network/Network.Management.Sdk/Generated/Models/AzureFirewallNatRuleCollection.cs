...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class AzureFirewallNatRuleCollection : SubResource
    {
        ...
        /// <param name="priority">Priority of the NAT rule collection resource.
        /// </param>

        /// <param name="action">The action type of a NAT rule collection.
        /// </param>

        /// <param name="rules">Collection of rules used by a NAT rule collection.
        /// </param>
        public AzureFirewallNatRuleCollection(string id = default(string), string name = default(string), string etag = default(string), string provisioningState = default(string), int? priority = default(int?), AzureFirewallNatRCAction action = default(AzureFirewallNatRCAction), System.Collections.Generic.IList<AzureFirewallNatRule> rules = default(System.Collections.Generic.IList<AzureFirewallNatRule>))
