...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the CommonNatRulePortMapping class.
        /// </summary>
        public CommonNatRulePortMapping()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CommonNatRulePortMapping(string inboundNatRuleName = default(string), int? frontendPort = default(int?), int? backendPort = default(int?))
