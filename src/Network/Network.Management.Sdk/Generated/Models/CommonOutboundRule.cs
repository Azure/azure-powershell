...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonOutboundRule : CommonSubResourceModel
    {
        /// <summary>
        /// Initializes a new instance of the CommonOutboundRule class.
        /// </summary>
        public CommonOutboundRule()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CommonOutboundRule(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), string provisioningState = default(string), int? allocatedOutboundPorts = default(int?), System.Collections.Generic.IList<CommonSubResource> frontendIPConfigurations = default(System.Collections.Generic.IList<CommonSubResource>), CommonSubResource backendAddressPool = default(CommonSubResource), string protocol = default(string), bool? enableTcpReset = default(bool?), int? idleTimeoutInMinutes = default(int?))
