...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class CommonServiceEndpointPolicyDefinitionPropertiesFormat
    {
        /// <summary>
        /// Initializes a new instance of the CommonServiceEndpointPolicyDefinitionPropertiesFormat class.
        /// </summary>
        public CommonServiceEndpointPolicyDefinitionPropertiesFormat()
        {
            CustomInit();
        }
        ...
        public CommonServiceEndpointPolicyDefinitionPropertiesFormat(string description = default(string), string service = default(string), System.Collections.Generic.IList<string> serviceResources = default(System.Collections.Generic.IList<string>), string provisioningState = default(string))
