...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class CommonPrivateLinkServiceIpConfigurationProperties
    {
        /// <summary>
        /// Initializes a new instance of the CommonPrivateLinkServiceIpConfigurationProperties class.
        /// </summary>
        public CommonPrivateLinkServiceIpConfigurationProperties()
        {
            CustomInit();
        }
        ...
        public CommonPrivateLinkServiceIpConfigurationProperties(string privateIPAddress = default(string), string privateIPAllocationMethod = default(string), CommonSubnet subnet = default(CommonSubnet), bool? primary = default(bool?), string provisioningState = default(string), string privateIPAddressVersion = default(string))
