...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class CommonPrivateLinkServiceConnectionState
    {
        /// <summary>
        /// Initializes a new instance of the CommonPrivateLinkServiceConnectionState class.
        /// </summary>
        public CommonPrivateLinkServiceConnectionState()
        {
            CustomInit();
        }
        ...
        /// on the consumer.
        /// </param>
        public CommonPrivateLinkServiceConnectionState(string status = default(string), string description = default(string), string actionsRequired = default(string))
