...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class CommonServiceDelegationPropertiesFormat
    {
        /// <summary>
        /// Initializes a new instance of the CommonServiceDelegationPropertiesFormat class.
        /// </summary>
        public CommonServiceDelegationPropertiesFormat()
        {
            CustomInit();
        }
        ...
        public CommonServiceDelegationPropertiesFormat(string serviceName = default(string), System.Collections.Generic.IList<string> actions = default(System.Collections.Generic.IList<string>), string provisioningState = default(string))
