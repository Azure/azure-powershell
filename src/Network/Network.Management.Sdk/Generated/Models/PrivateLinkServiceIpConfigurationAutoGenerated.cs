...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class PrivateLinkServiceIpConfigurationAutoGenerated : SubResource
    {
        /// <summary>
        /// Initializes a new instance of the PrivateLinkServiceIpConfigurationAutoGenerated class.
        /// </summary>
        public PrivateLinkServiceIpConfigurationAutoGenerated()
        {
            CustomInit();
        }
        ...
        public PrivateLinkServiceIpConfigurationAutoGenerated(string id = default(string), string name = default(string), string etag = default(string), string type = default(string), string provisioningState = default(string), string privateIPAddress = default(string), string privateIPAllocationMethod = default(string), SubnetAutoGenerated subnet = default(SubnetAutoGenerated), bool? primary = default(bool?), string privateIPAddressVersion = default(string))
