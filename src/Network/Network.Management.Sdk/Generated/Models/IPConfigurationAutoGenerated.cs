...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class IPConfigurationAutoGenerated : SubResource
    {
        /// <summary>
        /// Initializes a new instance of the IPConfigurationAutoGenerated class.
        /// </summary>
        public IPConfigurationAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public IPConfigurationAutoGenerated(string id = default(string), string name = default(string), string etag = default(string), string provisioningState = default(string), string privateIPAddress = default(string), string privateIPAllocationMethod = default(string), SubnetAutoGenerated subnet = default(SubnetAutoGenerated), PublicIPAddressAutoGenerated publicIPAddress = default(PublicIPAddressAutoGenerated))
