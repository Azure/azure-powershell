...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class NetworkInterfaceIPConfigurationAutoGenerated : SubResourceModel
    {
        /// <summary>
        /// Initializes a new instance of the NetworkInterfaceIPConfigurationAutoGenerated class.
        /// </summary>
        public NetworkInterfaceIPConfigurationAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public NetworkInterfaceIPConfigurationAutoGenerated(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), string provisioningState = default(string), SubResource gatewayLoadBalancer = default(SubResource), System.Collections.Generic.IList<VirtualNetworkTapAutoGenerated> virtualNetworkTaps = default(System.Collections.Generic.IList<VirtualNetworkTapAutoGenerated>), System.Collections.Generic.IList<ApplicationGatewayBackendAddressPoolAutoGenerated> applicationGatewayBackendAddressPools = default(System.Collections.Generic.IList<ApplicationGatewayBackendAddressPoolAutoGenerated>), System.Collections.Generic.IList<BackendAddressPoolAutoGenerated> loadBalancerBackendAddressPools = default(System.Collections.Generic.IList<BackendAddressPoolAutoGenerated>), System.Collections.Generic.IList<InboundNatRuleAutoGenerated> loadBalancerInboundNatRules = default(System.Collections.Generic.IList<InboundNatRuleAutoGenerated>), string privateIPAddress = default(string), int? privateIPAddressPrefixLength = default(int?), string privateIPAllocationMethod = default(string), string privateIPAddressVersion = default(string), SubnetAutoGenerated subnet = default(SubnetAutoGenerated), bool? primary = default(bool?), PublicIPAddressAutoGenerated publicIPAddress = default(PublicIPAddressAutoGenerated), System.Collections.Generic.IList<ApplicationSecurityGroup> applicationSecurityGroups = default(System.Collections.Generic.IList<ApplicationSecurityGroup>), NetworkInterfaceIPConfigurationPrivateLinkConnectionProperties privateLinkConnectionProperties = default(NetworkInterfaceIPConfigurationPrivateLinkConnectionProperties))
