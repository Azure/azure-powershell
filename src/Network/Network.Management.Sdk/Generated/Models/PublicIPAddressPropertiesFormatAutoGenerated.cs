...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class PublicIPAddressPropertiesFormatAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the PublicIPAddressPropertiesFormatAutoGenerated class.
        /// </summary>
        public PublicIPAddressPropertiesFormatAutoGenerated()
        {
            CustomInit();
        }
        ...
        public PublicIPAddressPropertiesFormatAutoGenerated(string publicIPAllocationMethod = default(string), string publicIPAddressVersion = default(string), IPConfigurationAutoGenerated ipConfiguration = default(IPConfigurationAutoGenerated), PublicIPAddressDnsSettings dnsSettings = default(PublicIPAddressDnsSettings), DdosSettings ddosSettings = default(DdosSettings), System.Collections.Generic.IList<IpTag> ipTags = default(System.Collections.Generic.IList<IpTag>), string ipAddress = default(string), SubResource publicIPPrefix = default(SubResource), int? idleTimeoutInMinutes = default(int?), string resourceGuid = default(string), string provisioningState = default(string), PublicIPAddressAutoGenerated servicePublicIPAddress = default(PublicIPAddressAutoGenerated), NatGateway natGateway = default(NatGateway), string migrationPhase = default(string), PublicIPAddressAutoGenerated linkedPublicIPAddress = default(PublicIPAddressAutoGenerated), string deleteOption = default(string))
