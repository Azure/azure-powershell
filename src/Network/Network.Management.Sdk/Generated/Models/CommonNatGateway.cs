...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonNatGateway : CommonResource
    {
        /// <summary>
        /// Initializes a new instance of the CommonNatGateway class.
        /// </summary>
        public CommonNatGateway()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CommonNatGateway(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), CommonNatGatewaySku sku = default(CommonNatGatewaySku), System.Collections.Generic.IList<string> zones = default(System.Collections.Generic.IList<string>), string etag = default(string), string provisioningState = default(string), int? idleTimeoutInMinutes = default(int?), System.Collections.Generic.IList<CommonSubResource> publicIPAddresses = default(System.Collections.Generic.IList<CommonSubResource>), System.Collections.Generic.IList<CommonSubResource> publicIPAddressesV6 = default(System.Collections.Generic.IList<CommonSubResource>), System.Collections.Generic.IList<CommonSubResource> publicIPPrefixes = default(System.Collections.Generic.IList<CommonSubResource>), System.Collections.Generic.IList<CommonSubResource> publicIPPrefixesV6 = default(System.Collections.Generic.IList<CommonSubResource>), System.Collections.Generic.IList<CommonSubResource> subnets = default(System.Collections.Generic.IList<CommonSubResource>), CommonSubResource sourceVirtualNetwork = default(CommonSubResource), CommonSubResource serviceGateway = default(CommonSubResource), string nat64 = default(string), string resourceGuid = default(string))
        ...
        public CommonNatGatewaySku Sku {get; set; }
