...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class VpnDeviceScriptParameters
    {
        ...
        /// <param name="vendor">The vendor for the vpn device.
        /// </param>

        /// <param name="deviceFamily">The device family for the vpn device.
        /// </param>

        /// <param name="firmwareVersion">The firmware version for the vpn device.
        /// </param>
