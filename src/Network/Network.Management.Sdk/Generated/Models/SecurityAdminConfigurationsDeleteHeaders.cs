...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class SecurityAdminConfigurationsDeleteHeaders
    {
        /// <summary>
        ...
        /// </param>
        public SecurityAdminConfigurationsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
