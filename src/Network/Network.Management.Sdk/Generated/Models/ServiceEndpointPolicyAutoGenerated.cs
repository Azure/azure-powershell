...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ServiceEndpointPolicyAutoGenerated : Resource
    {
        /// <summary>
        /// Initializes a new instance of the ServiceEndpointPolicyAutoGenerated class.
        /// </summary>
        public ServiceEndpointPolicyAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public ServiceEndpointPolicyAutoGenerated(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string etag = default(string), string kind = default(string), string provisioningState = default(string), System.Collections.Generic.IList<ServiceEndpointPolicyDefinition> serviceEndpointPolicyDefinitions = default(System.Collections.Generic.IList<ServiceEndpointPolicyDefinition>), System.Collections.Generic.IList<SubnetAutoGenerated> subnets = default(System.Collections.Generic.IList<SubnetAutoGenerated>), string resourceGuid = default(string), string serviceAlias = default(string), System.Collections.Generic.IList<string> contextualServiceEndpointPolicies = default(System.Collections.Generic.IList<string>))
