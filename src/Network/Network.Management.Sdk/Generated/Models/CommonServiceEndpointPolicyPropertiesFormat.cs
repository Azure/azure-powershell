...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class CommonServiceEndpointPolicyPropertiesFormat
    {
        /// <summary>
        /// Initializes a new instance of the CommonServiceEndpointPolicyPropertiesFormat class.
        /// </summary>
        public CommonServiceEndpointPolicyPropertiesFormat()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CommonServiceEndpointPolicyPropertiesFormat(System.Collections.Generic.IList<CommonServiceEndpointPolicyDefinition> serviceEndpointPolicyDefinitions = default(System.Collections.Generic.IList<CommonServiceEndpointPolicyDefinition>), System.Collections.Generic.IList<CommonSubnet> subnets = default(System.Collections.Generic.IList<CommonSubnet>), string resourceGuid = default(string), string provisioningState = default(string), string serviceAlias = default(string), System.Collections.Generic.IList<string> contextualServiceEndpointPolicies = default(System.Collections.Generic.IList<string>))
