...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CommonRoutePropertiesFormat
    {
        ...
        /// regardless of LPM.
        /// </param>
        public CommonRoutePropertiesFormat(string nextHopType, string addressPrefix = default(string), string nextHopIPAddress = default(string), string provisioningState = default(string), bool? hasBgpOverride = default(bool?))
