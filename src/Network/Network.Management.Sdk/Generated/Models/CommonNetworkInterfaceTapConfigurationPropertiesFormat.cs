...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class CommonNetworkInterfaceTapConfigurationPropertiesFormat
    {
        /// <summary>
        /// Initializes a new instance of the CommonNetworkInterfaceTapConfigurationPropertiesFormat class.
        /// </summary>
        public CommonNetworkInterfaceTapConfigurationPropertiesFormat()
        {
            CustomInit();
        }
        ...
        public CommonNetworkInterfaceTapConfigurationPropertiesFormat(CommonVirtualNetworkTap virtualNetworkTap = default(CommonVirtualNetworkTap), string provisioningState = default(string))
