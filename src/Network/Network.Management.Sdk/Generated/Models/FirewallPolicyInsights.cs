...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class FirewallPolicyInsights
    {
        ...
        /// <param name="isEnabled">A flag to indicate if the insights are enabled on the policy.
        /// </param>

        /// <param name="retentionDays">Number of days the insights should be enabled on the policy.
        /// </param>

        /// <param name="logAnalyticsResources">Workspaces needed to configure the Firewall Policy Insights.
        /// </param>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "logAnalyticsResources")]
