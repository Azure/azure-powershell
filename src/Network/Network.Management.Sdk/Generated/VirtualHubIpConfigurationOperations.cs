...
namespace Microsoft.Azure.Management.Network
{
    ...
    internal partial class VirtualHubIPConfigurationOperations : Microsoft.Rest.IServiceOperations<NetworkManagementClient>, IVirtualHubIPConfigurationOperations
    {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<HubIpConfiguration> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, virtualHubName, ipConfigName, parameters, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse _response = await BeginDeleteWithHttpMessagesAsync(resourceGroupName, virtualHubName, ipConfigName, customHeaders, cancellationToken).ConfigureAwait(false);
