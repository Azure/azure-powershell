...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class VpnSiteLinksOperationsExtensions
    {
        ...
        {
                return ((IVpnSiteLinksOperations)operations).ListByVpnSiteAsync(resourceGroupName, vpnSiteName).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static Microsoft.Rest.Azure.IPage<VpnSiteLink> ListByVpnSiteNext(this IVpnSiteLinksOperations operations, string nextPageLink)
        {
                return ((IVpnSiteLinksOperations)operations).ListByVpnSiteNextAsync(nextPageLink).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<VpnSiteLink>> ListByVpnSiteNextAsync(this IVpnSiteLinksOperations operations, string nextPageLink, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
