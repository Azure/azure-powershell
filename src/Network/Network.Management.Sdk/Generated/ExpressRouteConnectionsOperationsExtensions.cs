...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class ExpressRouteConnectionsOperationsExtensions
    {
        ...
        {
                return ((IExpressRouteConnectionsOperations)operations).CreateOrUpdateAsync(resourceGroupName, expressRouteGatewayName, connectionName, putExpressRouteConnectionParameters).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<ExpressRouteConnection> CreateOrUpdateAsync(this IExpressRouteConnectionsOperations operations, string resourceGroupName, string expressRouteGatewayName, string connectionName, ExpressRouteConnection putExpressRouteConnectionParameters, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
                return ((IExpressRouteConnectionsOperations)operations).GetAsync(resourceGroupName, expressRouteGatewayName, connectionName).GetAwaiter().GetResult();
        }
        ...
        {
                return ((IExpressRouteConnectionsOperations)operations).ListAsync(resourceGroupName, expressRouteGatewayName).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<ExpressRouteConnectionList> ListAsync(this IExpressRouteConnectionsOperations operations, string resourceGroupName, string expressRouteGatewayName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
                return ((IExpressRouteConnectionsOperations)operations).BeginCreateOrUpdateAsync(resourceGroupName, expressRouteGatewayName, connectionName, putExpressRouteConnectionParameters).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<ExpressRouteConnection> BeginCreateOrUpdateAsync(this IExpressRouteConnectionsOperations operations, string resourceGroupName, string expressRouteGatewayName, string connectionName, ExpressRouteConnection putExpressRouteConnectionParameters, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
