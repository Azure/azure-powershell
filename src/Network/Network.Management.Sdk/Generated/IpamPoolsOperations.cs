...
namespace Microsoft.Azure.Management.Network
{
    ...
    internal partial class IpamPoolsOperations : Microsoft.Rest.IServiceOperations<NetworkManagementClient>, IIpamPoolsOperations
    {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<IpamPool> _response = await BeginCreateWithHttpMessagesAsync(resourceGroupName, networkManagerName, poolName, body, ifMatch, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse _response = await BeginDeleteWithHttpMessagesAsync(resourceGroupName, networkManagerName, poolName, ifMatch, customHeaders, cancellationToken).ConfigureAwait(false);
