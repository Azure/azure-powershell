...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class IpAllocationsOperationsExtensions
    {
            ...
            /// Resource tags.
            /// </param>
            public static IpAllocation UpdateTags(this IIpAllocationsOperations operations, string resourceGroupName, string ipAllocationName, IDictionary<string, string> tags = default(IDictionary<string, string>))
            {
                return operations.UpdateTagsAsync(resourceGroupName, ipAllocationName, tags).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IpAllocation> UpdateTagsAsync(this IIpAllocationsOperations operations, string resourceGroupName, string ipAllocationName, IDictionary<string, string> tags = default(IDictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.UpdateTagsWithHttpMessagesAsync(resourceGroupName, ipAllocationName, tags, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
