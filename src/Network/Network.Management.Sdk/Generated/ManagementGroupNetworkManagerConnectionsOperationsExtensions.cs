...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class ManagementGroupNetworkManagerConnectionsOperationsExtensions
    {
        ...
        /// </param>
        public static Microsoft.Rest.Azure.IPage<NetworkManagerConnection> List(this IManagementGroupNetworkManagerConnectionsOperations operations, string managementGroupId, int? top = default(int?), string skipToken = default(string))
        {
                return ((IManagementGroupNetworkManagerConnectionsOperations)operations).ListAsync(managementGroupId, top, skipToken).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static Microsoft.Rest.Azure.IPage<NetworkManagerConnection> ListNext(this IManagementGroupNetworkManagerConnectionsOperations operations, string nextPageLink)
        {
                return ((IManagementGroupNetworkManagerConnectionsOperations)operations).ListNextAsync(nextPageLink).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<NetworkManagerConnection>> ListNextAsync(this IManagementGroupNetworkManagerConnectionsOperations operations, string nextPageLink, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
