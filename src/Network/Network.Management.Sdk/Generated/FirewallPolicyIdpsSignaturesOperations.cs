...
namespace Microsoft.Azure.Management.Network
{
    ...
    /// </summary>
    internal partial class FirewallPolicyIdpsSignaturesOperations : Microsoft.Rest.IServiceOperations<NetworkManagementClient>, IFirewallPolicyIdpsSignaturesOperations
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<QueryResults>> ListWithHttpMessagesAsync(string resourceGroupName, string firewallPolicyName, IdpsQueryObject parameters, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<QueryResults>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<QueryResults>(_responseContent, this.Client.DeserializationSettings);
                }
