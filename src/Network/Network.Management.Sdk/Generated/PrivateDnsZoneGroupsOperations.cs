...
namespace Microsoft.Azure.Management.Network
{
    ...
    internal partial class PrivateDnsZoneGroupsOperations : Microsoft.Rest.IServiceOperations<NetworkManagementClient>, IPrivateDnsZoneGroupsOperations
    {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse _response = await BeginDeleteWithHttpMessagesAsync(resourceGroupName, privateEndpointName, privateDnsZoneGroupName, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<PrivateDnsZoneGroup> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, privateEndpointName, privateDnsZoneGroupName, parameters, customHeaders, cancellationToken).ConfigureAwait(false);
