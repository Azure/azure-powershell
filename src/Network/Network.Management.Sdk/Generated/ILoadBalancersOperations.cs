...
namespace Microsoft.Azure.Management.Network
{
    ...
    public partial interface ILoadBalancersOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<MigratedPools>> MigrateToIpBasedWithHttpMessagesAsync(string groupName, string loadBalancerName, MigrateLoadBalancerToIpBasedRequest parameters = default(MigrateLoadBalancerToIpBasedRequest), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Deletes the specified load balancer.
        /// </summary>
        /// <param name='resourceGroupName'>
