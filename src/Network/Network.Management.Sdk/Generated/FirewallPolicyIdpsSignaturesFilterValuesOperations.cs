...
namespace Microsoft.Azure.Management.Network
{
    ...
    /// </summary>
    internal partial class FirewallPolicyIdpsSignaturesFilterValuesOperations : IServiceOperations<NetworkManagementClient>, IFirewallPolicyIdpsSignaturesFilterValuesOperations
    {
        /// <summary>
        ...
        public async Task<AzureOperationResponse<SignatureOverridesFilterValuesResponse>> ListWithHttpMessagesAsync(SignatureOverridesFilterValuesQuery parameters, string resourceGroupName, string firewallPolicyName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<SignatureOverridesFilterValuesResponse>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<SignatureOverridesFilterValuesResponse>(_responseContent, Client.DeserializationSettings);
                }
