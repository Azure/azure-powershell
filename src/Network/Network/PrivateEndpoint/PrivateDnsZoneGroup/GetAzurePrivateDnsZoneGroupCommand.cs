...
{
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "PrivateDnsZoneGroup", DefaultParameterSetName = "List"), OutputType(typeof(PSPrivateDnsZoneGroup))]
