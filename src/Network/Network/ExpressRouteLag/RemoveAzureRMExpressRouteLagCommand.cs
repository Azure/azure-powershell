...
{
    [Cmdlet(VerbsCommon.Remove, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "ExpressRouteLag", SupportsShouldProcess = true, DefaultParameterSetName = ResourceNameParameterSet), OutputType(typeof(bool))]
    public partial class RemoveAzureRmExpressRouteLag : NetworkBaseCmdlet
    {
        ...
        public PSExpressRouteLag InputObject { get; set; }
        ...
        public override void Execute()
        {
            ...
            ConfirmAction(
                ...
                () =>
                {
                    this.NetworkClient.NetworkManagementClient.ExpressRouteLags.Delete(ResourceGroupName, Name);
                    if (PassThru)
                    {
                        WriteObject(true);
                    }
