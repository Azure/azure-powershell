...
{
    [Cmdlet("Set", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "NetworkManager", SupportsShouldProcess = true), OutputType(typeof(PSNetworkManager))]
    public class SetAzNetworkManagerCommand : NetworkManagerBaseCmdlet
    {
        [Parameter(
            Mandatory = true,
        ...
        public override void Execute()
        {
            if (this.ShouldProcess(this.InputObject.Name, VerbsLifecycle.Restart))
            {
                ...
                this.NetworkManagerClient.CreateOrUpdate(this.InputObject.ResourceGroupName, this.InputObject.Name, networkManagerModel);
