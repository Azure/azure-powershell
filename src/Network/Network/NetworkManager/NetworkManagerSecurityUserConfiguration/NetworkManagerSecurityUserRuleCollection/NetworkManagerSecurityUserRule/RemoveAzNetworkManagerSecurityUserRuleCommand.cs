...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "NetworkManagerSecurityUserRule", SupportsShouldProcess = true), OutputType(typeof(bool))]
     ...
     HelpMessage = "The resource name.")]
        ...
        public override void Execute()
        {
            ...
            ConfirmAction(
                ...
                () =>
                {
                    this.NetworkManagerSecurityUserRuleOperationClient.Delete(this.ResourceGroupName, this.NetworkManagerName, this.SecurityUserConfigurationName, this.RuleCollectionName, this.Name);
                    if (PassThru)
                    {
                        WriteObject(true);
                    }
