...
{
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "NetworkManagerSecurityUserRuleCollection", SupportsShouldProcess = true), OutputType(typeof(PSNetworkManagerSecurityRuleCollection))]
    public class NewAzNetworkManagerSecurityUserRuleCollectionCommand : NetworkManagerSecurityUserRuleCollectionBaseCmdlet
    {
        ...
        public override void Execute()
        {
            ...
            ConfirmAction(
                ...
                () =>
                {
                    var networkManagerSecurityRuleCollection = this.CreateNetworkManagerSecurityUserRuleCollection();
                    WriteObject(networkManagerSecurityRuleCollection);
                },
                () => present);
        }

        private PSNetworkManagerSecurityRuleCollection CreateNetworkManagerSecurityUserRuleCollection()
        {
            ...
            this.NullifyNetworkManagerSecurityUserRuleCollectionIfAbsent(ruleCollectionModel);
            

            // Execute the Create Security Rule Collection call
            var securityRuleCollectionResponse = this.NetworkManagerSecurityUserRuleCollectionClient.CreateOrUpdate(ruleCollectionModel, this.ResourceGroupName, this.NetworkManagerName, this.SecurityUserConfigurationName, this.Name);
            var psSecuirtyRuleCollection = this.ToPsNetworkManagerSecurityUserRuleCollection(securityRuleCollectionResponse);
