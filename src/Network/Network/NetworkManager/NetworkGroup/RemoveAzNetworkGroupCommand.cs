...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "NetworkManagerGroup", SupportsShouldProcess = true), OutputType(typeof(bool))]
    public class RemoveAzNetworkGroupCommand : NetworkGroupBaseCmdlet
    {
        [Alias("ResourceName")]
        [Parameter(
            Mandatory = true,
        ...
        public override void Execute()
        {
            ...
            ConfirmAction(
                ...
                () =>
                {
                    ...
                    this.NetworkGroupClient.Delete(this.ResourceGroupName, this.NetworkManagerName, this.Name, forceDelete);
