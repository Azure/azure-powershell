...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public class NewAzNetworkManagerStaticMemberCommand : NetworkManagerStaticMemberBaseCmdlet
    {
        ...
        private PSNetworkManagerStaticMember CreateNetworkManagerStaticMember()
        {
            ...
            this.NetworkManagerStaticMemberClient.CreateOrUpdate(this.ResourceGroupName, this.NetworkManagerName, this.NetworkGroupName, this.Name, networkManagerStaticMemberModel);
