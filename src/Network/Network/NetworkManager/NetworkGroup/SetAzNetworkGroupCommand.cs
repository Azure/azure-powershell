...
{
    [Cmdlet("Set", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "NetworkManagerGroup", SupportsShouldProcess = true), OutputType(typeof(PSNetworkManagerGroup))]
