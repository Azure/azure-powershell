...
{
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "NetworkManagerRoutingRuleCollection", DefaultParameterSetName = "NoExpand"), OutputType(typeof(PSNetworkManagerRoutingRuleCollection))]
    public class GetAzNetworkManagerRoutingRuleCollectionCommand : NetworkManagerRoutingRuleCollectionBaseCmdlet
    {
        ...
        public override void Execute()
        {
            ...
            if (this.Name != null)
            {
                var ruleCollection = this.GetNetworkManagerRoutingRuleCollection(this.ResourceGroupName, this.NetworkManagerName, this.RoutingConfigurationName, this.Name);
