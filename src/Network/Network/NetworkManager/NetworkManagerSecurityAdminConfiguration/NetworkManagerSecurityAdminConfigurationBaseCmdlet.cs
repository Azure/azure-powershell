...
namespace Microsoft.Azure.Commands.Network
{
    public abstract class NetworkManagerSecurityAdminConfigurationBaseCmdlet : NetworkBaseCmdlet
    {
        ...
        public PSNetworkManagerSecurityConfiguration GetNetworkManagerSecurityAdminConfiguration(string resourceGroupName, string networkManagerName, string name)
        {
        ...
        public void NullifyNetworkManagerSecurityAdminConfigurationIfAbsent(SecurityConfiguration nmsc)
        {
            if (nmsc == null)
            {
                return;
        ...
        public PSNetworkManagerSecurityConfiguration ToPsNetworkManagerSecurityAdminConfiguration(SecurityConfiguration nmsc)
        {
