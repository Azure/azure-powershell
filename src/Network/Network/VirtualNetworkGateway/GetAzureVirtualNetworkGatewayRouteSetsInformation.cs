...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "VirtualNetworkGatewayRouteSetsInformation", DefaultParameterSetName = "GetByNameParameterSet"), OutputType(typeof(PSGatewayRouteSetsInformation))]
    public partial class GetAzureVirtualNetworkGatewayRouteSetsInformation : NetworkBaseCmdlet
    {
