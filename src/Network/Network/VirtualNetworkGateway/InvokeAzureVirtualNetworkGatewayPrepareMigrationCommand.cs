...
{
    [Cmdlet("Invoke", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "VirtualNetworkGatewayPrepareMigration", 
        DefaultParameterSetName = ParameterSetNames.ByName, SupportsShouldProcess = true), OutputType(typeof(PSVirtualNetworkGateway))]
    public class InvokeAzureVirtualNetworkGatewayPrepareMigrationCommand : VirtualNetworkGatewayBaseCmdlet
    {
        [Parameter(
            Mandatory = true,
        ...
        public override void Execute()
        {
            ...
            {
                this.VirtualNetworkGatewayClient.InvokePrepareMigration(this.ResourceGroupName, this.Name, migrationParamaterModel);
