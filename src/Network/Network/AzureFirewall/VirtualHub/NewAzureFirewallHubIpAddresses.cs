...
{
    [Cmdlet(VerbsCommon.New, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "FirewallHubIpAddresses", SupportsShouldProcess = true), OutputType(typeof(PSAzureFirewallHubIpAddresses))]
