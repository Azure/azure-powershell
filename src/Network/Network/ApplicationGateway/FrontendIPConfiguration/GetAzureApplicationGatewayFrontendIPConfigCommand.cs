...
{
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "ApplicationGatewayFrontendIPConfig"),OutputType(typeof(PSApplicationGatewayFrontendIPConfiguration))]
