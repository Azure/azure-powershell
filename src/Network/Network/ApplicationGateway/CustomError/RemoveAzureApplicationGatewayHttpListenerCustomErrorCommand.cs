...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "ApplicationGatewayHttpListenerCustomError"),
        OutputType(typeof(PSApplicationGatewayCustomError))]
    public class RemoveAzureApplicationGatewayHttpListenerCustomErrorCommand : NetworkBaseCmdlet
    {
        [Parameter(
                Mandatory = true,
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (customError != null)
            {
                this.HttpListener.CustomErrorConfigurations.Remove(customError);
            }
