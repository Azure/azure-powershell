...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public class RemoveAzureVirtualRouterCommand : NetworkBaseCmdlet
    {
        ...
        public override void Execute()
        {
            ...
            ConfirmAction(
                Force.IsPresent,
                string.Format(Properties.Resources.RemovingResource, RouterName),
                Properties.Resources.RemoveResourceMessage,
                RouterName,
                () =>
                {
                    WriteVerbose(String.Format(Properties.Resources.CreatingLongRunningOperationMessage, ResourceGroupName, RouterName));
