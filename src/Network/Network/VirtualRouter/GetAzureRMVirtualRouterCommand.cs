        ...
        public override void Execute()
        {
            ...
            if (ShouldGetByName(ResourceGroupName, RouterName))
            {
                ...
                if (vVirtualRouter.Peerings != null && vVirtualRouter.Peerings.Count > 0)
                {
                    ...
                    var vVirtualRouterPeeringList = ListNextLink<VirtualRouterPeering>.GetAllResourcesByPollingNextLink(vVirtualRouterPeering,
this.NetworkClient.NetworkManagementClient.VirtualRouterPeerings.ListNext);
