...
{
    [Cmdlet("Update", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "VirtualNetworkSubnetConfig", DefaultParameterSetName = "SetByResource"), OutputType(typeof(PSVirtualNetwork))]
    public class UpdateAzureVirtualNetworkSubnetConfigCommand : AzureVirtualNetworkSubnetConfigBase
    {
        [Parameter(
            Mandatory = true,
        ...
        [ValidateNotNullOrEmpty]
        public override string[] AddressPrefix { get; set; }
        ...
        public override void Execute()
        {
            ...
            if (this.ServiceEndpoint != null)
            {
                ...
                foreach (var item in this.ServiceEndpoint)
                {
                    ...
                    this.MyInvocation.BoundParameters.ContainsKey("ServiceEndpoint"))
            {
            ...
            else if(ServiceEndpointPolicy == null &&
                    this.MyInvocation.BoundParameters.ContainsKey("ServiceEndpointPolicy"))
            {
            ...
            if (this.Delegation != null)
            {
                subnet.Delegations = this.Delegation?.ToList();
                     ...
                     this.MyInvocation.BoundParameters.ContainsKey("Delegation"))
            {
