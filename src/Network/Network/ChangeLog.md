...
* Fixed an issue where `VerifyClientAuthMode` was preserved during PowerShell ↔ SDK model conversions for Application Gateway client authentication configuration.
