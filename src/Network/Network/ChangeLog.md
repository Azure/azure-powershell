...
* Changed `-EnableOnlyIPv6Peering` on `New-AzVirtualHubVnetConnection`, and the corresponding output property, from a string to a boolean to match the service contract, which returns a boolean `enableOnlyIPv6Peering`.
