...
## Upcoming Release
* Added the WAF managed rule set display name and the rule paranoia level to Application Gateway WAF cmdlet output.
    ...
    - Both properties are read only and are populated from api-version 2026-01-01 onwards.
