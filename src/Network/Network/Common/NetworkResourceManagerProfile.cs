    ...
    public class NetworkResourceManagerProfile : Profile
    {
        ...
        private static void Initialize()
        {
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<CNM.PSConnectionMonitorEndpointFilter, MNM.ConnectionMonitorEndpointFilter>();
                cfg.CreateMap<CNM.PSConnectionMonitorEndpointFilterItem, MNM.ConnectionMonitorEndpointFilterItem>();
                ...
                cfg.CreateMap<MNM.ConnectionMonitorEndpointFilter, CNM.PSConnectionMonitorEndpointFilter>();
                cfg.CreateMap<MNM.ConnectionMonitorEndpointFilterItem, CNM.PSConnectionMonitorEndpointFilterItem>();
