    ...
    public class NetworkResourceManagerProfile : Profile
    {
        ...
        private static void Initialize()
        {
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<MNM.SubnetAutoGenerated, CNM.PSSubnet>()
                    .ForMember(dest => dest.AddressPrefix, opt => opt.Ignore())
                    .ForMember(
                        dest => dest.IpConfigurations,
                        opt => opt.MapFrom(src => src.IPConfigurations)
                ...
                cfg.CreateMap<MNM.IPConfigurationAutoGenerated, CNM.PSIPConfiguration>();
                ...
                */
                ...
                cfg.CreateMap<MNM.PublicIPAddressAutoGenerated, CNM.PSPublicIpAddress>()
                    .ForMember(
                        dest => dest.IpConfiguration,
                        opt => opt.MapFrom(src => src.IPConfiguration)
                    )
                ...
                cfg.CreateMap<MNM.NetworkInterfaceAutoGenerated, CNM.PSNetworkInterface>()
                    .ForMember(
                        dest => dest.IpConfigurations,
                        opt => opt.MapFrom(src => src.IPConfigurations)
                    )
                ...
                cfg.CreateMap<MNM.NetworkInterfaceIPConfigurationAutoGenerated, CNM.PSNetworkInterfaceIPConfiguration>();
                cfg.CreateMap<MNM.NetworkInterfaceTapConfiguration, CNM.PSNetworkInterfaceTapConfiguration>();
                cfg.CreateMap<MNM.NetworkInterfaceTapConfigurationAutoGenerated, CNM.PSNetworkInterfaceTapConfiguration>();
                cfg.CreateMap<MNM.SubResource, CNM.PSNetworkInterfaceIPConfiguration>();
                cfg.CreateMap<MNM.BackendAddressPoolAutoGenerated, CNM.PSBackendAddressPool>();
                cfg.CreateMap<MNM.InboundNatRuleAutoGenerated, CNM.PSInboundNatRule>();
                cfg.CreateMap<MNM.ApplicationGatewayBackendAddressPoolAutoGenerated, CNM.PSApplicationGatewayBackendAddressPool>();
                cfg.CreateMap<MNM.VirtualNetworkTapAutoGenerated, CNM.PSVirtualNetworkTap>();
                cfg.CreateMap<MNM.PrivateEndpointAutoGenerated, CNM.PSResourceId>();
                cfg.CreateMap<MNM.PrivateEndpointAutoGenerated, CNM.PSPrivateEndpoint>();
                cfg.CreateMap<MNM.NetworkSecurityGroupAutoGenerated, CNM.PSNetworkSecurityGroup>();
                cfg.CreateMap<MNM.RouteTableAutoGenerated, CNM.PSRouteTable>();
                cfg.CreateMap<MNM.ServiceEndpointPolicyAutoGenerated, CNM.PSServiceEndpointPolicy>();
                cfg.CreateMap<MNM.IPConfigurationProfileAutoGenerated, CNM.PSIPConfigurationProfile>();
