                ...
                */
                ...
                cfg.CreateMap<CNM.PSAzureFirewall, MNM.AzureFirewall>().AfterMap((src, dest) =>
                {
                    dest.AdditionalProperties = new Dictionary<string, string>()
                    {
                        ...
                        { "Network.AdditionalLogs.IdentifyTopFatFlows", src.IdentifyTopFatFlows },
                ...
                cfg.CreateMap<MNM.AzureFirewall, CNM.PSAzureFirewall>().AfterMap((src, dest) =>
                {
                    ...
                    dest.IdentifyTopFatFlows = src.AdditionalProperties?.SingleOrDefault(kvp => kvp.Key.Equals("Network.AdditionalLogs.IdentifyTopFatFlows", StringComparison.OrdinalIgnoreCase)).Value;
                    try
                    {
