        ...
        private static void Initialize()
        {
            var config = new MapperConfiguration(cfg =>
            {
                ...
                */
                ...
                // CNM to MNM
                cfg.CreateMap<CNM.PSAzureFirewallPolicyExplicitProxy, MNM.ExplicitProxySettings>();
                ...
                // MNM to CNM
                cfg.CreateMap<MNM.ExplicitProxySettings, CNM.PSAzureFirewallPolicyExplicitProxy>();
