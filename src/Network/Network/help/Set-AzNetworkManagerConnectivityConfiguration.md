...
### Example 1
```powershell
PS C:\> Set-AzNetworkManagerConnectivityConfiguration -NetworkManagerName TestNMName -ResourceGroupName TestRGName
 -NetworkManagerConnectivityConfiguration $ConnectivityConfiguraiton
```
