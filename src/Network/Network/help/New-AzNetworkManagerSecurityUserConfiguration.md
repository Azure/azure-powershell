...
online version: https://docs.microsoft.com/powershell/module/az.network/new-aznetworkmanagersecurityuserconfiguration
schema: 2.0.0
---
...
### Example 1
```powershell
PS C:\> New-AzNetworkManagerSecurityUserConfiguration -ResourceGroupName TestRGName -NetworkManagerName TestNMName -Name "TestConfigName" -DisplayName "TestDisplayName" -Description "TestDescription" -DeleteExistingNSG
