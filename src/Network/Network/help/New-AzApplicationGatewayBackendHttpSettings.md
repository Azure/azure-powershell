...
online version: https://docs.microsoft.com/powershell/module/az.network/new-azapplicationgatewaybackendhttpsettings
schema: 2.0.0
---
...
```
New-AzApplicationGatewayBackendHttpSettings -Name <String> -Port <Int32> -Protocol <String>
