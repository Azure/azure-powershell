...
Creates a network security rule configuration. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzNetworkSecurityRuleConfig -Access Allow -DestinationAddressPrefix * -DestinationPortRange 3389 -Direction Inbound -Name 'rdp-rule' -Priority 100 -Protocol Tcp -SourceAddressPrefix 'Internet' -SourcePortRange *
```
