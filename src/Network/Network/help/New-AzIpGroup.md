...
```
New-AzIpGroup -ResourceGroupName <String> -Name <String>
 -Location <String> [-IpAddress <String[]>] [-Tag <Hashtable>] [-Force] [-AsJob] [-DefaultProfile <IAzureContextContainer>] [-WhatIf]
...
### -IpAdress
A list of ipAddresses belonging to the ipGroup.
