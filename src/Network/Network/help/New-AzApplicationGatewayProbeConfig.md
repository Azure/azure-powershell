...
[Create custom probe for Application Gateway using PowerShell for Azure Resource Manager](https://azure.microsoft.com/documentation/articles/application-gateway-create-probe-ps/#)
