...
Update-AzNetworkSecurityPerimeterAccessRule -ResourceGroupName <String> -Name <String>
 ...
 [-EmailAddress <String[]>] [-PhoneNumber <String[]>] [-Direction <String>] [-Subscription <ISubscriptionId[]>]
...
[https://learn.microsoft.com/powershell/module/az.network/update-aznetworksecurityperimeteraccessrule](https://learn.microsoft.com/powershell/module/az.network/update-aznetworksecurityperimeteraccessrule)
