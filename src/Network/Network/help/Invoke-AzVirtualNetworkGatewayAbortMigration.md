...
online version: https://learn.microsoft.com/powershell/module/az.network/invoke-azvirtualnetworkgatewayabortmigration
schema: 2.0.0
---
...
## DESCRIPTION
Abort the migration for virtual network gateway.
