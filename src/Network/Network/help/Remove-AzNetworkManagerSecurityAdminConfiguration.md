...
online version: https://docs.microsoft.com/powershell/module/az.network/remove-aznetworkmanagersecurityadminconfiguration
schema: 2.0.0
---
...
Remove-AzNetworkManagerSecurityAdminConfiguration -Name <String> -NetworkManagerName <String>
 -ResourceGroupName <String> [-Force] [-ForceDelete] [-PassThru] [-AsJob] [-DefaultProfile <IAzureContextContainer>] [-WhatIf]
