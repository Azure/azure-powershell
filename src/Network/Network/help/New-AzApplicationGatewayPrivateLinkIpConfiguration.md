...
This command creates an PrivateLink IP Configuration named 'ipConfig01' stores the result in the variable named $PrivateLinkIpConfiguration.  (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzApplicationGatewayPrivateLinkIpConfiguration -Name 'cert01' -Primary -Subnet <PSSubnet>
```
