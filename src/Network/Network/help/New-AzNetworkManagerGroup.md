...
### Example 1
```powershell
PS C:\> New-AzNetworkManagerGroup -ResourceGroupName TestRGName -NetworkManagerName TestNetworkManagerName -Name TestNetworkGroupName -MemberType "Microsoft.Network/VirtualNetwork" -Description "TestDescription"
