...
Creates a StaticRoute object which can then be added to a RoutingConfiguration object. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzStaticRoute -AddressPrefix <String[]> -Name 'route1' -NextHopIpAddress '12.0.0.5'
```
