...
```
Set-AzNetworkManagerManagementGroupConnection -ManagementGroupId <String> -NetworkManagerManagementGroupConnection <PSNetworkManagerConnection>
...
### Example 1
```powershell
PS C:\> Set-AzNetworkManagerManagementGroupConnection -ManagementGroupId $managementGroupId -NetworkManagerManagementGroupConnection $networkManagerConnection
```
