...
Creates a rule configuration for a load balancer. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzLoadBalancerRuleConfig -BackendAddressPool <PSBackendAddressPool> -BackendPort 80 -FrontendIpConfiguration <PSFrontendIPConfiguration> -FrontendPort 80 -Name 'MyLBrule' -Probe <PSProbe> -Protocol 'Tcp'
```
