...
```powershell
Set-AzLoadBalancerRuleConfig -BackendPort 0 -FrontendIpConfiguration <PSFrontendIPConfiguration> -FrontendPort 0 -Name 'NewRule' -Protocol 'All' -LoadBalancer <PSLoadBalancer>
```
