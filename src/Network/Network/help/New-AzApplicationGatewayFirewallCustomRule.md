...
Creates a new custom rule for the application gateway firewall policy. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzApplicationGatewayFirewallCustomRule -Action Allow -MatchCondition <PSApplicationGatewayFirewallCondition[]> -Name example-rule -Priority 1 -RuleType MatchRule
```
