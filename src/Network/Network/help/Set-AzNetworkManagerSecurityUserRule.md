...
online version: https://docs.microsoft.com/powershell/module/az.network/set-aznetworkmanagersecurityuserrule
schema: 2.0.0
---
...
```
Set-AzNetworkManagerSecurityUserRule -RuleCollectionName <String> -SecurityUserConfigurationName <String>
 -NetworkManagerName <String> -ResourceGroupName <String>
 -SecurityUserRule <PSNetworkManagerSecurityBaseUserRule> [-AsJob] [-DefaultProfile <IAzureContextContainer>]
...
### Example 1
```powershell
PS C:\> Set-AzNetworkManagerSecurityAdminRule -RuleCollectionName TestRuleCollectionName -SecurityUserConfigurationName TestSecurityUserConfigurationName -NetworkManagerName TestNMName -ResourceGroupName TestRGName -SecurityUserRule $SecurityUserRule
```
