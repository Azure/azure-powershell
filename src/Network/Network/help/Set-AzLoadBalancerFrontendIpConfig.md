...
Updates a front-end IP configuration for a load balancer. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzLoadBalancerFrontendIpConfig -Name 'NewFrontend' -PrivateIpAddress '10.0.1.10' -Subnet <PSSubnet>
```
