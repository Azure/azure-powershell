...
Update-AzVpnGateway -ResourceGroupName <String> -Name <String> [-VpnConnection <PSVpnConnection[]>]
 ...
 [-BgpPeeringAddress <PSIpConfigurationBgpPeeringAddress[]>] [-EnableBgpRouteTranslationForNat]
 [-DisableBgpRouteTranslationForNat] [-Tag <Hashtable>] [-AsJob] [-DefaultProfile <IAzureContextContainer>]
...
### -DisableBgpRouteTranslationForNat
Flag to disable Bgp route translation for NAT on this VpnGateway.
