...
online version: https://docs.microsoft.com/en-us/powershell/module/az.network/get-aznatgateway.md
schema: 2.0.0
---
...
### Expand
```
Get-AzNatGateway -ResourceGroupName <String> -Name <String> -ExpandResource <String>
