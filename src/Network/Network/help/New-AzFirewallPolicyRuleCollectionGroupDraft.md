...
```
New-AzFirewallPolicyRuleCollectionGroupDraft -AzureFirewallPolicyRuleCollectionGroupName <String> -Priority <UInt32>
...
This example creates a Rule Collection Group draft associated with the a Rule Collection Group rg1 in the Azure Firewall Policy $fp.
