...
```powershell
Get-AzExpressRouteConnection -ResourceGroupName ps9361 -ParentResourceId /subscriptions/{subscriptionId}/resourceGroups/ps9361/providers/Microsoft.Network/ExpressRouteGateways/testExpressRoutegw -Name test*
```
