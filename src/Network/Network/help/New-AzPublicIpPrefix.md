...
### Example 4: Create a public IP prefix associated with a first party service tag
```powershell
...
$publicIpPrefix = New-AzPublicIpPrefix -Name "ContosoPublicIpPrefix" -ResourceGroupName "ContosoResourceGroup" -Location "eastus" -PrefixLength 30 -IpTag $ipTag
```

This command creates a public IP prefix whose IP tag is associated with a first party service tag.
