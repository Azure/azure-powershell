...
Gets a VirtualRouter peer in an Azure VirtualRouter. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Get-AzVirtualRouterPeer -PeerName csr -ResourceGroupName testVirtualRouter -VirtualRouterName virtualRouter
```
