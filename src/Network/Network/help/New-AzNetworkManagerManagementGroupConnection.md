...
online version: https://docs.microsoft.com/powershell/module/az.network/new-aznetworkmanagermanagementgroupconnection
schema: 2.0.0
---
...
```
New-AzNetworkManagerManagementGroupConnection -ManagementGroupId <String> -Name <String> -NetworkManagerId <String> [-Description <String>]
