...
Removes an existing VPN client root certificate. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Remove-AzVpnClientRootCertificate -PublicCertData <String> -ResourceGroupName 'ContosoResourceGroup' -VirtualNetworkGatewayName 'ContosoVirtualGateway' -VpnClientRootCertificateName 'ContosoRootCertificate'
```
