...
New-AzFirewall -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-Zone <String[]>] [-SkuName <String>] [-SkuTier <String>] [-VirtualHubId <String>] [-HubIPAddresses <PSAzureFirewallHubIpAddresses>]
...
New-AzFirewall -Name "azFw" -ResourceGroupName $rgName -Location centralus -SkuName AZFW_Hub -SkuTier Standard -VirtualHubId $vHubId -FirewallPolicyId -$fpId
```
