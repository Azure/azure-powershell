...
online version: https://docs.microsoft.com/powershell/module/az.network/remove-aznetworkmanagersecurityuserrulecollection
schema: 2.0.0
---
...
### Example 1
```powershell
PS C:\> Remove-AzNetworkManagerSecurityUserRuleCollection -Name TestRuleCollectionName -SecurityUserConfigurationName TestUserConfigName
