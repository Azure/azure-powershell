...
```powershell
New-AzNetworkWatcherConnectionMonitor -Name cm -NetworkWatcherName nw1 -Output <PSNetworkWatcherConnectionMonitorOutputObject[]> -ResourceGroupName myresourcegroup -TestGroup <PSNetworkWatcherConnectionMonitorTestGroupObject[]>
```
