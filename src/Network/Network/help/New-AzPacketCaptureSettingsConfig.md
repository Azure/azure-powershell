...
### Example 1
```powershell
PS C:\> New-AzPacketCaptureSettingsConfig -FileCount 2 -FileSizeInBytes 100 -SessionTimeLimitInSeconds 60
```

In the above example, passing file count with file size and session time (in seconds). It will create an object like,
