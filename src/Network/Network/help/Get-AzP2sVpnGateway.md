...
online version: https://learn.microsoft.com/powershell/module/az.network/get-azp2svpngateway
schema: 2.0.0
---
...
```
Get-AzP2sVpnGateway [-DefaultProfile <IAzureContextContainer>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
