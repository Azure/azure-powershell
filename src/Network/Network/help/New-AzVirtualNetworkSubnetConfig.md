...
New-AzVirtualNetworkSubnetConfig -Name <String> -AddressPrefix <String[]>
 ...
 [-ServiceEndpoint <String[]>] [-SENetworkIdentifier <PSServiceEndpoint[]>] [-ServiceEndpointPolicy <PSServiceEndpointPolicy[]>]
...
New-AzVirtualNetworkSubnetConfig -Name <String> -AddressPrefix <String[]> [-NetworkSecurityGroupId <String>]
 [-RouteTableId <String>] [-ResourceId <String>] [-ServiceEndpoint <String[]>] [-SENetworkIdentifier <PSServiceEndpoint[]>]
