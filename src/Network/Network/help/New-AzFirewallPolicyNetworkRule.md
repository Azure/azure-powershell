...
Create a new Azure Firewall Policy Network Rule. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzFirewallPolicyNetworkRule -Description 'Allow RDP' -DestinationAddress * -DestinationPort * -Name NRC1 -Protocol Any -SourceAddress '192.168.0.0/16'
```
