...
### Example 1
```powershell
PS C:\> Remove-AzBastionShareableLink -ResourceGroupName $RgName -Name $bastionName -TargetVmId $vm.Id
Confirm
...
### Example 2
```powershell
PS C:\> Remove-AzBastionShareableLink -InputObject $bastion -TargetVmId $vm.Id -Force
```
