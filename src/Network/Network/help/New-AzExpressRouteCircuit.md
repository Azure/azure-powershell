...
```powershell
New-AzExpressRouteCircuit -BandwidthInMbps 200 -Location 'West Central US' -Name 'testExpressRouteCircuit' -PeeringLocation 'Silicon Valley' -ResourceGroupName 'testRG' -ServiceProviderName 'Equinix' -SkuFamily MeteredData -SkuTier Standard
```
