...
Creates a new peering configuration to be added to an ExpressRoute circuit. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzExpressRouteCircuitPeeringConfig -Name 'cert01' -PeerASN 100 -PeeringType AzurePrivatePeering -PrimaryPeerAddressPrefix '123.0.0.0/30' -SecondaryPeerAddressPrefix '123.0.0.4/30' -SharedKey <String> -VlanId 300
```
