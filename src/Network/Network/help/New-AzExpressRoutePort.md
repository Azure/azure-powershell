...
Creates an Azure ExpressRoutePort. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzExpressRoutePort -BandwidthInGbps <Int32> -Encapsulation <String> -Location westus -Name 'cert01' -PeeringLocation westus -ResourceGroupName myresourcegroup
```
