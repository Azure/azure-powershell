...
Adds a VPN client-revocation certificate. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Add-AzVpnClientRevokedCertificate -ResourceGroupName 'ContosoResourceGroup' -Thumbprint 'E3A38EBA60CAA1C162785A2E1C44A15AD450199C3' -VirtualNetworkGatewayName 'ContosoVirtualNetwork' -VpnClientRevokedCertificateName 'ContosoRevokedClientCertificate'
```
