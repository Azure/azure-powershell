...
Removes a VPN client-revocation certificate. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Remove-AzVpnClientRevokedCertificate -ResourceGroupName myresourcegroup -Thumbprint 'E3A38EBA60CAA1C162785A2E1C44A15AD450199C3' -VirtualNetworkGatewayName 'ContosoVirtualNetwork' -VpnClientRevokedCertificateName 'ContosoRevokedClientCertificate'
```
