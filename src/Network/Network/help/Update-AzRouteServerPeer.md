...
online version: https://learn.microsoft.com/powershell/module/az.network/update-azrouteserverpeer
schema: 2.0.0
---
...
## DESCRIPTION
The **Update-AzRouteServerPeer** cmdlet updates a RouteServer Peer to an Azure RouteServer
