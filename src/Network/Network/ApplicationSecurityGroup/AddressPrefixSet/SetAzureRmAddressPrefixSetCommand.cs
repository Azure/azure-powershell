...
namespace Microsoft.Azure.Commands.Network
{
    ...
    [Cmdlet(
        ...
        HelpUri = "https://learn.microsoft.com/powershell/module/az.network/set-azaddressprefixset"),
        OutputType(typeof(PSAddressPrefixSet))]
    public class SetAzureRmAddressPrefixSetCommand : AddressPrefixSetBaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipeline = true, ParameterSetName = ByAddressPrefixSetObject, HelpMessage = "The address prefix set to update.")]
