...
namespace Microsoft.Azure.Commands.Network.PrivateLinkService.PrivateLinkServiceProvider
{
    internal class ProviderConfiguration
    {
        ...
        static ProviderConfiguration()
        {
            ...
            RegisterConfiguration("Microsoft.DesktopVirtualization/hostpools", "2021-09-03-preview", true, true);
            RegisterConfiguration("Microsoft.DesktopVirtualization/workspaces", "2021-09-03-preview", true, true);
