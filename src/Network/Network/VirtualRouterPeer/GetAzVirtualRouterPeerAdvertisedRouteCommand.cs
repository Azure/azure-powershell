...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public class GetVirtualRouterPeerAdvertisedRouteCommand : NetworkBaseCmdlet
    {
        ...
        public override void Execute()
        {
            ...
            foreach (var route in this.NetworkClient.NetworkManagementClient.VirtualHubBgpConnections.ListAdvertisedRoutes(this.ResourceGroupName, this.VirtualRouterName, this.PeerName).Value)
            {
                advertisedRoutes.Add(NetworkResourceManagerProfile.Mapper.Map<PSPeerRoute>(route));
            }
