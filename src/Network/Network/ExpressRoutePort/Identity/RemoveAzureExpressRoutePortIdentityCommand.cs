...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "ExpressRoutePortIdentity", SupportsShouldProcess = true), OutputType(typeof(PSExpressRoutePort))]
