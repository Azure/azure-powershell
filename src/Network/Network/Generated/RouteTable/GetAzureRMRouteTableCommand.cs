...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "RouteTable", DefaultParameterSetName = "NoExpand"), OutputType(typeof(PSRouteTable))]
