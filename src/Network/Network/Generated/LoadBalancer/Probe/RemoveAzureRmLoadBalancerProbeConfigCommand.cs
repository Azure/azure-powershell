...
{
    [Cmdlet(VerbsCommon.Remove, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "LoadBalancerProbeConfig", DefaultParameterSetName = "ByParentResource", SupportsShouldProcess = true), OutputType(typeof(PSLoadBalancer))]
    public partial class RemoveAzureRmLoadBalancerProbeConfigCommand : NetworkBaseCmdlet
    {
        [Parameter(
            Mandatory = true,
        ...
        public override void Execute()
        {
            ...
            if (vProbes != null)
            {
                this.LoadBalancer.Probes.Remove(vProbes);
            }

            if (this.LoadBalancer.Probes.Count == 0)
            {
                this.LoadBalancer.Probes = null;
            }
