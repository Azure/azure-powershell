...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "LoadBalancerBackendAddressPoolConfig", DefaultParameterSetName = "ByParentResource"), OutputType(typeof(PSBackendAddressPool))]
    public partial class GetAzureRmLoadBalancerBackendAddressPoolConfigCommand : NetworkBaseCmdlet
    {
        [Parameter(
            Mandatory = true,
        ...
        public override void Execute()
        {
            ...
            {
                var vBackendAddressPools =
                        this.LoadBalancer.BackendAddressPools.First(
                            resource =>
                                string.Equals(resource.Name, this.Name, System.StringComparison.CurrentCultureIgnoreCase));
                WriteObject(vBackendAddressPools);
            }
            else
            {
                WriteObject(LoadBalancer.BackendAddressPools, true);
            }
        }
    }
}
