...
{
    [Cmdlet(VerbsCommon.Remove, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "LoadBalancerRuleConfig", DefaultParameterSetName = "ByParentResource", SupportsShouldProcess = true), OutputType(typeof(PSLoadBalancer))]
    public partial class RemoveAzureRmLoadBalancerRuleConfigCommand : NetworkBaseCmdlet
    {
        ...
        public override void Execute()
        {
            ...
            var vLoadBalancingRules = this.LoadBalancer.LoadBalancingRules.SingleOrDefault
                (e =>
