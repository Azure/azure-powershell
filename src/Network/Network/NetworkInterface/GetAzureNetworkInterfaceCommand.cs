    ...
    public class GetAzureNetworkInterfaceCommand : NetworkInterfaceBaseCmdlet
    {
        ...
        public override void Execute()
        {
            ...
            else
            {
                ...
                if (ParameterSetName.Contains("ScaleSetNic"))
                {
                    IPage<MNM.NetworkInterfaceAutoGenerated> nicPage;
                    List<MNM.NetworkInterfaceAutoGenerated> nicList;
                    ...
                    if (string.IsNullOrEmpty(this.VirtualMachineIndex))
                    {
                        ...
                        nicList = ListNextLink<MNM.NetworkInterfaceAutoGenerated>.GetAllResourcesByPollingNextLink(nicPage, this.NetworkInterfaceClient.ListVirtualMachineScaleSetNetworkInterfacesNext);
                    }
                    else
                    {
                        nicPage =
                        ...
                        nicList = ListNextLink<MNM.NetworkInterfaceAutoGenerated>.GetAllResourcesByPollingNextLink(nicPage, this.NetworkInterfaceClient.ListVirtualMachineScaleSetVMNetworkInterfacesNext);
                    }
                ...
                else
                {
                    ...
                    var nicList = ListNextLink<MNM.NetworkInterface>.GetAllResourcesByPollingNextLink(nicPage, this.NetworkInterfaceClient.ListNext);
