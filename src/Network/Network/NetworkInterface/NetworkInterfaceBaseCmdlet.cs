...
namespace Microsoft.Azure.Commands.Network
{
    public abstract class NetworkInterfaceBaseCmdlet : NetworkBaseCmdlet
    {
        ...
        public PSNetworkInterface ToPsNetworkInterface(NetworkInterface nic)
        {
            ...
            SetDefaultNetworkInterfaceIpConfigurationReferences(psNic);

            return psNic;
        }

        public PSNetworkInterface ToPsNetworkInterface(NetworkInterfaceAutoGenerated nic)
        {
            var psNic = NetworkResourceManagerProfile.Mapper.Map<PSNetworkInterface>(nic);
        ...
        private static void SetDefaultNetworkInterfaceIpConfigurationReferences(PSNetworkInterface psNic)
        {
            if (psNic?.IpConfigurations == null)
            {
                return;
            }
