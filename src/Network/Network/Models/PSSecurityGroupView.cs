...
{
    public class PSSecurityGroupView
    {
        public string NetworkInterfaceId { get; set; }

        public List<PSSecurityRule> NetworkInterfaceSecurityRules{ get; set; }

        public string SubnetId { get; set; }

        public List<PSSecurityRule> SubnetSecurityRules { get; set; }
