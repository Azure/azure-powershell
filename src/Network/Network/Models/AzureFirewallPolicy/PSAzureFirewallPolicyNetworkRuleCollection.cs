...
{
    public class PSAzureFirewallPolicyNetworkRuleCollection : PSAzureFirewallPolicyBaseRuleCollection
    {
        [JsonProperty(Order = 3)]
        public PSAzureFirewallRCAction Action { get; set; }

        [JsonProperty(Order = 4)]
        public List<PSAzureFirewallPolicyNetworkRule> Rules { get; set; }
        ...
        public void AddRule(PSAzureFirewallPolicyNetworkRule rule)
        {
            // Validate
            if (this.Rules != null)
            {
            ...
            {
                this.Rules = new List<PSAzureFirewallPolicyNetworkRule>();
            }
