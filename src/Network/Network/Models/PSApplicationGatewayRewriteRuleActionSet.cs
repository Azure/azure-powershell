...
{
    public partial class PSApplicationGatewayRewriteRuleActionSet
    {
        ...
        {
            get { return JsonConvert.SerializeObject(RequestHeaderConfigurations, Formatting.Indented, new JsonSerializerSettings() { NullValueHandling = NullValueHandling.Ignore }); }
        }

        [JsonIgnore]
        public string ResponseHeaderConfigurationsText
        {
