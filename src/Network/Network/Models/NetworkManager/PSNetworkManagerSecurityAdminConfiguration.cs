...
namespace Microsoft.Azure.Commands.Network.Models.NetworkManager
{
    ...
    public class PSNetworkManagerSecurityAdminConfiguration : PSNetworkManagerBaseResource
    {
        ...
        public List<string> NetworkGroupAddressSpaceAggregationOption { get; set; }

        [JsonIgnore]
        public string NetworkGroupAddressSpaceAggregationOptionText
        {
            get { return JsonConvert.SerializeObject(NetworkGroupAddressSpaceAggregationOption, Formatting.Indented, new JsonSerializerSettings() { NullValueHandling = NullValueHandling.Ignore }); }
        }
