    ...
    public class PSIPTraffic
    {
        ...
        public string IpTrafficText
        {
            get
            {
                ...
                return JsonConvert.SerializeObject(trafficDetails, Formatting.Indented, new JsonSerializerSettings() { NullValueHandling = NullValueHandling.Ignore });
            }
        }
    }
}