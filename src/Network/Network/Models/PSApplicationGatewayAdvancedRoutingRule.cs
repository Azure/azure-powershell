...
namespace Microsoft.Azure.Commands.Network.Models
{
    ...
    public class PSApplicationGatewayAdvancedRoutingRule : PSChildResource
    {
        [Ps1Xml(Target = ViewControl.Table)]
        public int Priority { get; set; }

        public PSResourceId AdvancedRoutingConditionSet { get; set; }
        ...
        [JsonIgnore]
        public string AdvancedRoutingConditionSetText
        {
            get { return JsonConvert.SerializeObject(AdvancedRoutingConditionSet, Formatting.Indented, new JsonSerializerSettings() { NullValueHandling = NullValueHandling.Ignore }); }
        }
