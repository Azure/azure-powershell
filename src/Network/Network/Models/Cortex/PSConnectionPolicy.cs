...
namespace Microsoft.Azure.Commands.Network.Models
{
    ...
    public class PSConnectionPolicy : PSChildResource
    {
        [Ps1Xml(Label = "Provisioning State", Target = ViewControl.Table)]
        public string ProvisioningState { get; set; }

        [Ps1Xml(Label = "Enable Internet Security", Target = ViewControl.Table)]
        ...
        public IList<string> AssociatedConnections { get; set; }
