...
CmdletsToExport = 'Add-AzApplicationGatewayAuthenticationCertificate', 
			   ...
			   'Get-EffectiveRoutes', 'Get-InboundRoutes', 'Get-OutboundRoutes',
			   'Get-AzRouteMapRule', 'Get-AzRouteMap', 'Add-AzRouteMapRule',
			   'New-AzRouteMapMatchCriteria', 'New-AzRouteMapActionParameter',
			   'New-AzRouteMapAction', 'New-AzRouteMapRule', 'New-AzRouteMap',
			   'Set-AzRouteMapRule', 'Set-AzRouteMap', 
			   'Remove-AzRouteMapRule', 'Remove-AzRouteMap',
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated cmdlets to add new property of ''Snat'' in Azure Firewall Policy.
    - ''New-AzFirewallPolicySnat''
