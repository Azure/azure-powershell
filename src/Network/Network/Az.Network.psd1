...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added ''-IpVersionType'' parameter to ''New-AzPrivateEndpoint'' cmdlet to specify the IP version type for private IPs of the private endpoint. Allowed values are IPv4, IPv6, or DualStack.
