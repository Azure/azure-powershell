...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added ''GeoLocationXFFHeader'' and ''ClientAddrXFFHeader'' as valid VariableNames in ''NewAzureApplicationGatewayFirewallCustomRuleGroupByVariable''.
