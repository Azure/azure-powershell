...
CmdletsToExport = 'Add-AzApplicationGatewayAuthenticationCertificate', 
               ...
               'Remove-AzVirtualHubVnetConnection', 'Get-AzVpnServerConfiguration',
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Add new cmdlet Get-AzAvailableServiceAlias which can be called to get the aliases that can be used for Service Endpoint Policies.
