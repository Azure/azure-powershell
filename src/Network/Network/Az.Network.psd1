...
CmdletsToExport = 'Add-AzApplicationGatewayAuthenticationCertificate', 
               ...
               'New-AzRouteServer', 
               'Remove-AzRouteServer', 'Get-AzRouteServer', 
               'Update-AzRouteServer', 'Add-AzRouteServerPeer', 
               'Update-AzRouteServerPeer', 'Remove-AzRouteServerPeer', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added new cmdlets for CRUD of VpnGatewayNATRule.
