...
CmdletsToExport = 'Add-AzApplicationGatewayAuthenticationCertificate', 
               ...
               'Set-AzRoutingIntent', 'Get-AzRouteMap', 'New-AzRouteMapRuleCriterion', 
               'New-AzRouteMapRuleActionParameter', 'New-AzRouteMapRuleAction', 
               'New-AzRouteMapRule', 'New-AzRouteMap','Remove-AzRouteMap',
               'Update-AzRouteMap', 'Remove-AzRoutingIntent', 'New-AzVpnGateway', 
               ...
               'Update-AzNetworkVirtualAppliance','Get-AzNetworkVirtualApplianceConnection',
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Onboarded ''Microsoft.HardwareSecurityModules/cloudHsmClusters'' to private link cmdlets
