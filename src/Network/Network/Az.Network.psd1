...
CmdletsToExport = 'Add-AzApplicationGatewayAuthenticationCertificate', 
			   ...
			   'Remove-AzVirtualHubRouteTable', 'Update-AzVirtualHubRouteTable', 
               ...
               'Set-AzExpressRouteGateway', 'Get-AzExpressRouteConnectin', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fix incorrect example in ''New-AzApplicationGateway'' reference documentation 
