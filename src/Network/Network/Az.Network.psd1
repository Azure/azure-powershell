...
CmdletsToExport = 'Add-AzApplicationGatewayAuthenticationCertificate', 
               ...
               'New-AzFirewallPolicyDnsSetting', 'New-AzFirewallPolicyExplicitProxySetting', 'New-AzVirtualRouter', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated cmdlet to add ''Subnet'' property for IP based load balancer backend address pool.
    - ''New-AzLoadBalancerBackendAddressConfig''
