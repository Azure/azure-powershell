...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public class SetAzureFirewallPolicyCommand : AzureFirewallPolicyBaseCmdlet
    {
        ...
        [Parameter(
            Mandatory = false,
            HelpMessage = "The Explicit Proxy"
        )]
        ...
        public override void Execute()
        {
            ...
            if (this.IsParameterBound(c => c.InputObject))
            {
                ...
                this.ExplicitProxySettings = this.IsParameterBound(c => c.ExplicitProxySettings) ? ExplicitProxySettings : (InputObject.ExplicitProxySettings != null ? InputObject.ExplicitProxySettings : null);
