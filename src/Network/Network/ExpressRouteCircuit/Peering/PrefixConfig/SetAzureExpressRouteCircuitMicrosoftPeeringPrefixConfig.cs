...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public class SetAzureExpressRouteCircuitMicrosoftPeeringPrefixConfigCommand : AzureExpressRouteCircuitMicrosoftPeeringPrefixConfigBase
    {
        ...
        public override void Execute()
        {
            ...
            // Update the prefixInfo list and update the circuit object
            var prefix = new PSPeeringPrefixConfig();
            prefix.Prefix = this.Prefix;
            prefix.ValidationId = !string.IsNullOrEmpty(this.ValidationId) ? this.ValidationId : prefixes[prefixIndex].ValidationId;
            prefix.Signature = !string.IsNullOrEmpty(this.Signature) ? this.Signature : prefixes[prefixIndex].Signature;
