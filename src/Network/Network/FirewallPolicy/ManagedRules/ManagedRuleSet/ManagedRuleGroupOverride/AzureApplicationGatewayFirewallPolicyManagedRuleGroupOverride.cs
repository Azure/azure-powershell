...
{
    public class AzureApplicationGatewayFirewallPolicyManagedRuleGroupOverride : NetworkBaseCmdlet
    {
        [Parameter(
            Mandatory = true,
        ...
        {
            return new PSApplicationGatewayFirewallPolicyManagedRuleGroupOverride()
            {
