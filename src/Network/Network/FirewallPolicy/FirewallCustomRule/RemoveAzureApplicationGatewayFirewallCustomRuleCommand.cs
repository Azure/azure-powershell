...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public class RemoveAzureApplicationGatewayFirewallCustomRuleCommand : NetworkBaseCmdlet
    {
        [Alias("ResourceName")]
        [Parameter(
            Mandatory = true,
        ...
        [ResourceNameCompleter("Microsoft.Network/applicationGatewayWebApplicationFirewallCustomRules", "ResourceGroupName")]
