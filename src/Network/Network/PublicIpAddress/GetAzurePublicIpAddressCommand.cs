    ...
    public class GetAzurePublicIpAddressCommand : PublicIpAddressBaseCmdlet
    {
        ...
        public override void Execute()
        {
            ...
            else
            {
                ...
                if (ParameterSetName.Contains("ScaleSetIp"))
                {
                    IPage<PublicIPAddressAutoGenerated> publicipPage;
                    List<PublicIPAddressAutoGenerated> publicIPList;
                    ...
                    if (string.IsNullOrEmpty(this.VirtualMachineIndex))
                    {
                        ...
                        publicIPList = ListNextLink<PublicIPAddressAutoGenerated>.GetAllResourcesByPollingNextLink(publicipPage, this.PublicIpAddressClient.ListVirtualMachineScaleSetPublicIPAddressesNext);
                    }
                    else
                    {
                        publicipPage =
                        ...
                        publicIPList = ListNextLink<PublicIPAddressAutoGenerated>.GetAllResourcesByPollingNextLink(publicipPage, this.PublicIpAddressClient.ListVirtualMachineScaleSetVMPublicIPAddressesNext);
                    }
