...
namespace Microsoft.Azure.Commands.Network
{
    ...
    [GenericBreakingChange("It is recommended to use parameter '-Sku Standard' to create new IP address. Please note that it will become the default behavior for IP address creation in the next PS release 2023-05-23.")]
