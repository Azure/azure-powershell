...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public class GetAzureRmVpnServerConfigurationCommand : VpnServerConfigurationBaseCmdlet
    {
        ...
        public override void Execute()
        {
            ...
            {
                WriteObject(this.GetVpnServerConfiguration(this.ResourceGroupName, this.Name));
            }
            else
            {
                WriteObject(TopLevelWildcardFilter(ResourceGroupName, Name, this.ListVpnServerConfigurations(this.ResourceGroupName)), true);
            }
        }
    }
}
