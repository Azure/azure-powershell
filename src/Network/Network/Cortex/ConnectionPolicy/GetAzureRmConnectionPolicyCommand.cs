...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public class GetAzureRmConnectionPolicyCommand : ConnectionPolicyBaseCmdlet
    {
        [Parameter(
            Mandatory = true,
        ...
        [ResourceNameCompleter("Microsoft.Network/virtualHubs/connectionPolicies", "ResourceGroupName", "HubName")]
        [ValidateNotNullOrEmpty]
        [SupportsWildcards]
        ...
        public override void Execute()
        {
            ...
            {
                WriteObject(GetConnectionPolicy(this.ResourceGroupName, this.HubName, this.Name));
            }
            else
            {
                WriteObject(SubResourceWildcardFilter(Name, this.ListConnectionPolicies(this.ResourceGroupName, this.HubName)), true);
            }
        }
    }
}
