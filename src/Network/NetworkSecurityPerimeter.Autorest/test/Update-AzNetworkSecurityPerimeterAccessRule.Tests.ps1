...
Describe 'Update-AzNetworkSecurityPerimeterAccessRule' {
    ...
    It 'UpdateViaIdentityExpandedServiceTag' {
        {
           # this test case is dependent on the above test case
           $GETObj = Get-AzNetworkSecurityPerimeterAccessRule -Name $env.tmpAccessRule5 -ResourceGroupName $env.rgname -SecurityPerimeterName $env.tmpNsp1 -ProfileName $env.tmpProfile1
