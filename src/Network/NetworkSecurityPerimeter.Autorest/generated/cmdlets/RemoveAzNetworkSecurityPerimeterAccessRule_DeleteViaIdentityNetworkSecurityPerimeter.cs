            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (NetworkSecurityPerimeterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.NspAccessRulesDeleteViaIdentity(NetworkSecurityPerimeterInputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NspAccessRulesDelete(NetworkSecurityPerimeterInputObject.SubscriptionId ?? null, NetworkSecurityPerimeterInputObject.ResourceGroupName ?? null, NetworkSecurityPerimeterInputObject.NetworkSecurityPerimeterName ?? null, ProfileName, Name, onOk, onNoContent, onDefault, this, Pipeline);
                    }
