            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (NetworkSecurityPerimeterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.NspProfilesCreateOrUpdateViaIdentity(NetworkSecurityPerimeterInputObject.Id, _parametersBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
