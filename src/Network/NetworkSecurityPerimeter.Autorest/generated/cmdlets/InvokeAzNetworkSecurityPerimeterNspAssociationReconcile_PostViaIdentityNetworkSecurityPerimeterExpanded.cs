...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Post=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityPerimeters/{networkSecurityPerimeterName}/resourceAssociations/{associationName}/reconcile"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzNetworkSecurityPerimeterNspAssociationReconcile_PostViaIdentityNetworkSecurityPerimeterExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Description(@"Reconcile NSP association")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityPerimeters/{networkSecurityPerimeterName}/resourceAssociations/{associationName}/reconcile", ApiVersion = "2023-08-01-preview")]
    public partial class InvokeAzNetworkSecurityPerimeterNspAssociationReconcile_PostViaIdentityNetworkSecurityPerimeterExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.IAny _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.Any();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the NSP association.")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzNetworkSecurityPerimeterNspAssociationReconcile_PostViaIdentityNetworkSecurityPerimeterExpanded"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzNetworkSecurityPerimeterNspAssociationReconcile_PostViaIdentityNetworkSecurityPerimeterExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NspAssociationReconcilePost' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.NetworkSecurityPerimeterInputObject.Id += $"/resourceAssociations/{(global::System.Uri.EscapeDataString(this.AssociationName.ToString()))}";
                        await this.Client.NspAssociationReconcilePostViaIdentity(NetworkSecurityPerimeterInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NspAssociationReconcilePost(NetworkSecurityPerimeterInputObject.SubscriptionId ?? null, NetworkSecurityPerimeterInputObject.ResourceGroupName ?? null, NetworkSecurityPerimeterInputObject.NetworkSecurityPerimeterName ?? null, AssociationName, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { AssociationName=AssociationName})
                    {
