...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzNetworkSecurityPerimeter_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzNetworkSecurityPerimeter_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.Api20210201Preview.INetworkSecurityPerimeterRequest _parameter;

        /// <summary>The Network Security Perimeter resource</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The Network Security Perimeter resource", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.Api20210201Preview.INetworkSecurityPerimeterRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.Api20210201Preview.INetworkSecurityPerimeterRequest Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzNetworkSecurityPerimeter_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzNetworkSecurityPerimeter_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.NetworkSecurityPerimetersCreateOrUpdateViaIdentity(InputObject.Id, Parameter, onOk, onCreated, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NetworkSecurityPerimetersCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.NetworkSecurityPerimeterName ?? null, Parameter, onOk, onCreated, onDefault, this, Pipeline);
                    }
