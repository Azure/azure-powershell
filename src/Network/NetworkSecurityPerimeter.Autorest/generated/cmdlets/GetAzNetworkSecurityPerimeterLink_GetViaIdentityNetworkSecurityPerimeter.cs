            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (NetworkSecurityPerimeterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.NspLinksGetViaIdentity(NetworkSecurityPerimeterInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NspLinksGet(NetworkSecurityPerimeterInputObject.SubscriptionId ?? null, NetworkSecurityPerimeterInputObject.ResourceGroupName ?? null, NetworkSecurityPerimeterInputObject.NetworkSecurityPerimeterName ?? null, Name, onOk, onDefault, this, Pipeline);
                    }
