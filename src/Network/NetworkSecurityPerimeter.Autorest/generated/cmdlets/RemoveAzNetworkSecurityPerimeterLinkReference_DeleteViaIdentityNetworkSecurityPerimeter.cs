...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.IContext
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NspLinkReferencesDelete' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (NetworkSecurityPerimeterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.NspLinkReferencesDeleteViaIdentity(NetworkSecurityPerimeterInputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NspLinkReferencesDelete(NetworkSecurityPerimeterInputObject.SubscriptionId ?? null, NetworkSecurityPerimeterInputObject.ResourceGroupName ?? null, NetworkSecurityPerimeterInputObject.NetworkSecurityPerimeterName ?? null, Name, onOk, onNoContent, onDefault, this, Pipeline);
                    }
