...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Cmdlets
{
    ...
    /// <summary>Create NSP link resource.</summary>
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityPerimeters/{networkSecurityPerimeterName}/links/{linkName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzNetworkSecurityPerimeterLink_CreateViaIdentityNetworkSecurityPerimeterExpanded", SupportsShouldProcess = true)]
    ...
    public partial class NewAzNetworkSecurityPerimeterLink_CreateViaIdentityNetworkSecurityPerimeterExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.INspLink _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.NspLink();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Perimeter ARM Id for the remote NSP with which the link gets created in Auto-approval mode. It should be used when the NSP admin have Microsoft.Network/networkSecurityPerimeters/linkPerimeter/action permission on the remote NSP resource.")]
        ...
        public string AutoApprovedRemotePerimeterResourceId { get => _parametersBody.AutoApprovedRemotePerimeterResourceId ?? null; set => _parametersBody.AutoApprovedRemotePerimeterResourceId = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "A message passed to the owner of the remote NSP link resource with this connection request. In case of Auto-approved flow, it is default to 'Auto Approved'. Restricted to 140 chars.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>Backing field for <see cref="NetworkSecurityPerimeterInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.INetworkSecurityPerimeterIdentity _networkSecurityPerimeterInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.INetworkSecurityPerimeterIdentity NetworkSecurityPerimeterInputObject { get => this._networkSecurityPerimeterInputObject; set => this._networkSecurityPerimeterInputObject = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.INspLink">Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.INspLink</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.INspLink> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.INspLink> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzNetworkSecurityPerimeterLink_CreateViaIdentityNetworkSecurityPerimeterExpanded"
        /// /> cmdlet class.
        /// </summary>
        public NewAzNetworkSecurityPerimeterLink_CreateViaIdentityNetworkSecurityPerimeterExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NspLinksCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (NetworkSecurityPerimeterInputObject?.Id != null)
                    {
                        this.NetworkSecurityPerimeterInputObject.Id += $"/links/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.NspLinksCreateOrUpdateViaIdentity(NetworkSecurityPerimeterInputObject.Id, _parametersBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == NetworkSecurityPerimeterInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("NetworkSecurityPerimeterInputObject has null value for NetworkSecurityPerimeterInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, NetworkSecurityPerimeterInputObject) );
                        }
                        if (null == NetworkSecurityPerimeterInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("NetworkSecurityPerimeterInputObject has null value for NetworkSecurityPerimeterInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, NetworkSecurityPerimeterInputObject) );
                        }
                        if (null == NetworkSecurityPerimeterInputObject.NetworkSecurityPerimeterName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("NetworkSecurityPerimeterInputObject has null value for NetworkSecurityPerimeterInputObject.NetworkSecurityPerimeterName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, NetworkSecurityPerimeterInputObject) );
                        }
                        await this.Client.NspLinksCreateOrUpdate(NetworkSecurityPerimeterInputObject.SubscriptionId ?? null, NetworkSecurityPerimeterInputObject.ResourceGroupName ?? null, NetworkSecurityPerimeterInputObject.NetworkSecurityPerimeterName ?? null, Name, _parametersBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.SerializationMode.IncludeCreate);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.INspLink> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.INspLink
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.INspLink> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
