            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ProfileInputObject?.Id != null)
                    {
                        ...
                        await this.Client.NspAccessRulesGetViaIdentity(ProfileInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NspAccessRulesGet(ProfileInputObject.SubscriptionId ?? null, ProfileInputObject.ResourceGroupName ?? null, ProfileInputObject.NetworkSecurityPerimeterName ?? null, ProfileInputObject.ProfileName ?? null, Name, onOk, onDefault, this, Pipeline);
                    }
