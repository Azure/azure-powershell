            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (NetworkSecurityPerimeterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.NspLinksCreateOrUpdateViaIdentity(NetworkSecurityPerimeterInputObject.Id, Parameter, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
