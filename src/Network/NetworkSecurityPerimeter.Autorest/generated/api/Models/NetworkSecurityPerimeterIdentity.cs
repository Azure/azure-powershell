...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.INetworkSecurityPerimeterIdentityInternal
    {
        ...
        /// <summary>Backing field for <see cref="LinkReferenceName" /> property.</summary>
        private string _linkReferenceName;

        /// <summary>The name of the NSP linkReference.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.PropertyOrigin.Owned)]
        public string LinkReferenceName { get => this._linkReferenceName; set => this._linkReferenceName = value; }
        ...
        /// <summary>Backing field for <see cref="LoggingConfigurationName" /> property.</summary>
        private string _loggingConfigurationName;

        /// <summary>The name of the NSP logging configuration. Accepts 'instance' as name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.PropertyOrigin.Owned)]
        public string LoggingConfigurationName { get => this._loggingConfigurationName; set => this._loggingConfigurationName = value; }
