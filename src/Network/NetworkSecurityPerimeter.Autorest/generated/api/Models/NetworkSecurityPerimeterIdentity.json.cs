...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models
{
    ...
    public partial class NetworkSecurityPerimeterIdentity
    {
        ...
        internal NetworkSecurityPerimeterIdentity(Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.Json.JsonObject json)
        {
            ...
            {_linkName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.Json.JsonString>("linkName"), out var __jsonLinkName) ? (string)__jsonLinkName : (string)LinkName;}
            {_linkReferenceName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.Json.JsonString>("linkReferenceName"), out var __jsonLinkReferenceName) ? (string)__jsonLinkReferenceName : (string)LinkReferenceName;}
