...
New-AzCostManagementExport -Debug -Scope "subscriptions/6b085460-5f21-477e-ba44-1035046e9101" -Name "TestExportDatasetAggregationInfo" `
    ...
    -DatasetGranularity "Daily" -ETag "test" # -DatasetAggregation $AggregationDict
