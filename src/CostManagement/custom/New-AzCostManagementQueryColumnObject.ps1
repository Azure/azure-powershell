...
function New-AzCostManagementQueryColumnObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20191101.QueryColumn')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20191101.QueryColumn]::New()
