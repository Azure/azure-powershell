...
namespace Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Enrollment ID (Legacy BillingAccount ID)")]
        ...
        /// <returns>a duplicate instance of InvokeAzCostManagementReservationDetailReport_By</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Cmdlets.InvokeAzCostManagementReservationDetailReport_By Clone()
        {
            var clone = new InvokeAzCostManagementReservationDetailReport_By();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzCostManagementReservationDetailReport_By" /> cmdlet class.
        /// </summary>
        public InvokeAzCostManagementReservationDetailReport_By()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'GenerateReservationDetailsReportByBillingAccountId' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GenerateReservationDetailsReportByBillingAccountId(BillingAccountId, StartDate, EndDate, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  BillingAccountId=BillingAccountId,StartDate=StartDate,EndDate=EndDate})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { BillingAccountId=BillingAccountId, StartDate=StartDate, EndDate=EndDate })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { BillingAccountId=BillingAccountId, StartDate=StartDate, EndDate=EndDate })
                    {
