#
# Module manifest for module 'Az.CostManagement'
#
...
FunctionsToExport = 'Get-AzCostManagementExport', 
               ...
               'New-AzCostManagementDetailReport', 'New-AzCostManagementExport', 
               'New-AzCostManagementQueryComparisonExpressionObject', 
               'New-AzCostManagementQueryFilterObject', 
               'Remove-AzCostManagementExport', 'Update-AzCostManagementExport'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed an error that values in row could be null when grouping by the value of TagKey in Invoke-AzCostManagementQuery cmdlet. Fix in 0.3.1 accidentally removed from 0.3.2, added it back. [#25948]'
