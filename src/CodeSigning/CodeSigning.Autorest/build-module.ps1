...
if ($isAzure -And '') {
  ...
  $header = '// Code generated by Microsoft (R) AutoRest Code Generator (autorest: 3.10.2, generator: @autorest/powershell@4.0.718)
// Changes may cause incorrect behavior and will be lost if the code is regenerated.'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\CodeSigning.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './CodeSigning.psd1'
...
$formatPs1xml = Join-Path $PSScriptRoot './CodeSigning.format.ps1xml'
