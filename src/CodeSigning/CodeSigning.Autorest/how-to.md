# How-To
This document describes how to develop for `CodeSigning`.
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `CodeSigning` into the session.
