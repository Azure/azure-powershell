...
namespace Sample.API.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"CodeSigningAccount_Update", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.ICodeSigningAccount))]
    [global::Sample.API.Description(@"update a trusted signing account.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CodeSigning/codeSigningAccounts/{accountName}", ApiVersion = "2024-09-30-preview")]
    public partial class UpdateCodeSigningAccount_Update : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.ICodeSigningAccountPatch _properties;

        /// <summary>Parameters for creating or updating a trusted signing account.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters for creating or updating a trusted signing account.", ValueFromPipeline = true)]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Parameters for creating or updating a trusted signing account.",
        SerializedName = @"properties",
        PossibleTypes = new [] { typeof(Sample.API.Models.ICodeSigningAccountPatch) })]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        public Sample.API.Models.ICodeSigningAccountPatch Properties { get => this._properties; set => this._properties = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.ICodeSigningAccount">Sample.API.Models.ICodeSigningAccount</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.ICodeSigningAccount> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of UpdateCodeSigningAccount_Update</returns>
        public Sample.API.Cmdlets.UpdateCodeSigningAccount_Update Clone()
        {
            var clone = new UpdateCodeSigningAccount_Update();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CodeSigningAccountsUpdate(SubscriptionId, ResourceGroupName, AccountName, Properties, onOk, onDefault, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeUpdate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCodeSigningAccount_Update" /> cmdlet class.
        /// </summary>
        public UpdateCodeSigningAccount_Update()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.ICodeSigningAccount> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.ICodeSigningAccount
