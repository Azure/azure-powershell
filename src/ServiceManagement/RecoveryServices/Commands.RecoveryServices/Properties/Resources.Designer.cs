...
namespace Microsoft.Azure.Commands.RecoveryServices.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to ClientRequestId: {0}{1}.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to It is recommended that you use the Azure Site Recovery PowerShell cmdlets for Azure Resource Manager (https://msdn.microsoft.com/library/mt637930.aspx) to perform
        ///this action. The &apos;{0}&apos; cmdlet will be deprecated at some point in the future..
        /// </summary>
        ...
        ///    {1}.
        /// </summary>
        internal static string ConfirmVaultUpgradePrereqFailed {
            get {
                return ResourceManager.GetString("ConfirmVaultUpgradePrereqFailed", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to An internal error has occured. Please contact Microsoft support for further assistance..
        /// </summary>
        internal static string NullVaultUpgradeClient {
            get {
                return ResourceManager.GetString("NullVaultUpgradeClient", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Vault is ready for upgrade. Are you sure you want to continue?.
        /// </summary>
        internal static string PrerequisitesCheckPassed {
            get {
                return ResourceManager.GetString("PrerequisitesCheckPassed", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Vault upgrade prerequisites failed with warnings. Are you sure you want to continue with the upgrade?.
        /// </summary>
        internal static string PrerequisitesCheckReturnedWarnings {
            get {
                return ResourceManager.GetString("PrerequisitesCheckReturnedWarnings", resourceCulture);
            }
        }
        ...
        ///{0}Message: {1}.
        /// </summary>
        internal static string StartVaultUpgradeExceptionDetails {
            get {
                return ResourceManager.GetString("StartVaultUpgradeExceptionDetails", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Starting vault upgrade.
        /// </summary>
        internal static string StartVaultUpgradeWhatIfMessage {
            get {
                return ResourceManager.GetString("StartVaultUpgradeWhatIfMessage", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to OperationResult : {0}
        ///OperationStatus : {1}.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Couldn&apos;t find vault - {0} in region {1} under the current subscription context..
        /// </summary>
        internal static string VaultNotFoundInGeo {
            get {
                return ResourceManager.GetString("VaultNotFoundInGeo", resourceCulture);
            }
        }
        ...
        ///   Looks up a localized string similar to Operation Failed..
        /// </summary>
        internal static string VaultUpgradeExceptionDetails {
            get {
                return ResourceManager.GetString("VaultUpgradeExceptionDetails", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Vault upgrade is in progress....
        /// </summary>
        internal static string VaultUpgradeInProgress {
            get {
                return ResourceManager.GetString("VaultUpgradeInProgress", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The vault upgrade has failed. Please contact Microsoft support for further assistance..
        /// </summary>
        internal static string VaultUpgradeNotSucceded {
            get {
                return ResourceManager.GetString("VaultUpgradeNotSucceded", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to {0} &apos;{1}&apos; has been successfully upgraded to Recovery Services vault and is now accessible through the new Azure portal at http://portal.azure.com..
        /// </summary>
        internal static string VaultUpgradeSucceded {
            get {
                return ResourceManager.GetString("VaultUpgradeSucceded", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The vault upgrade operation has been terminated from powershell but the operation will continue in the background..
        /// </summary>
        internal static string VaultUpgradeTerminated {
            get {
                return ResourceManager.GetString("VaultUpgradeTerminated", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The vault upgrade operation has timed out. Please contact Microsoft support for further assistance..
        /// </summary>
        internal static string VaultUpgradeTimedOut {
            get {
                return ResourceManager.GetString("VaultUpgradeTimedOut", resourceCulture);
            }
        }
