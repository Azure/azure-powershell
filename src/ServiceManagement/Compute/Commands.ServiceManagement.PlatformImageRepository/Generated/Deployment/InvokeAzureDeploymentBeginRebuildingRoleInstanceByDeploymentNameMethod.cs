...
{
    [Cmdlet("Invoke", "AzureDeploymentBeginRebuildingRoleInstanceByDeploymentNameMethod")]
    public class InvokeAzureDeploymentBeginRebuildingRoleInstanceByDeploymentNameMethod : ComputeAutomationBaseCmdlet
    {
