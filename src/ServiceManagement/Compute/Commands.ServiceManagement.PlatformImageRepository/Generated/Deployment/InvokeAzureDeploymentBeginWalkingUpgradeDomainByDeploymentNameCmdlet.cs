...
{
    [Cmdlet("Invoke", "AzureDeploymentBeginWalkingUpgradeDomainByDeploymentName")]
    public class InvokeAzureDeploymentBeginWalkingUpgradeDomainByDeploymentNameCmdlet : ComputeAutomationBaseCmdlet
    {
        ...
        protected override void OnProcessRecord()
        {
            ...
            ExecuteClientActionNewSM(
                ...
                () => DeploymentClient.BeginWalkingUpgradeDomainByDeploymentName(ServiceName, DeploymentName, Parameters),
                (s, response) => response);
        }
    }
}
