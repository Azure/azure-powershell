...
{
    [Cmdlet("Invoke", "AzureDeploymentWalkUpgradeDomainByDeploymentSlot")]
    public class InvokeAzureDeploymentWalkUpgradeDomainByDeploymentSlotCmdlet : ComputeAutomationBaseCmdlet
    {
