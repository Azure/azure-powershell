...
{
    [Cmdlet("Invoke", "AzureDeploymentBeginRebuildingRoleInstanceByDeploymentName")]
    public class InvokeAzureDeploymentBeginRebuildingRoleInstanceByDeploymentNameCmdlet : ComputeAutomationBaseCmdlet
    {
