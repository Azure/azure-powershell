...
{
    [Cmdlet(VerbsLifecycle.Invoke, "AzureServiceCertificateListMethod")]
    [OutputType(typeof(ServiceCertificateListResponse))]
    public class InvokeAzureServiceCertificateListMethod : ComputeAutomationBaseCmdlet
    {
