...
{
    [Cmdlet(VerbsLifecycle.Invoke, "AzureHostedServiceListExtensionsMethod")]
    [OutputType(typeof(HostedServiceListExtensionsResponse))]
    public class InvokeAzureHostedServiceListExtensionsMethod : ComputeAutomationBaseCmdlet
    {
