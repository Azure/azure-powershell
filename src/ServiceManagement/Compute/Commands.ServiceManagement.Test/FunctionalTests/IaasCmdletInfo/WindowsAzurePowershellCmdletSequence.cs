...
namespace Microsoft.WindowsAzure.Commands.ServiceManagement.Test.FunctionalTests.IaasCmdletInfo
{
    internal class WindowsAzurePowershellCmdletSequence : PowershellCmdletSequence
    {
        ...
        public WindowsAzurePowershellCmdletSequence(List<CmdletsInfo> cmdlets) : base(cmdlets, ConstructModules())
        {
        }

        public WindowsAzurePowershellCmdletSequence() : base(ConstructModules())
        {
        }
