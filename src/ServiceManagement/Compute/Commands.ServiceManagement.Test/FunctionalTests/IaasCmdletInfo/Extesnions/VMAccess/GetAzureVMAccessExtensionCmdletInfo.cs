...
{
    public class GetAzureVMAccessExtensionCmdletInfo:CmdletsInfo
    {
        public GetAzureVMAccessExtensionCmdletInfo(IPersistentVM vm,string userName, string password, string version,string referenceName)
        {
            this.cmdletName = Utilities.GetAzureVMAccessExtensionCmdletName;
