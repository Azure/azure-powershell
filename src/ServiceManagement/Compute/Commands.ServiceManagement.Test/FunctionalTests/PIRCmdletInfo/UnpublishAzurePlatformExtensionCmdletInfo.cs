...
{
    public class UnpublishAzurePlatformExtensionCmdletInfo : CmdletsInfo
    {
        public UnpublishAzurePlatformExtensionCmdletInfo(string extensionName, string publisher, string version, bool force)
        {
            this.cmdletName = Utilities.UnpublishAzurePlatformExtensionCmdletName;
