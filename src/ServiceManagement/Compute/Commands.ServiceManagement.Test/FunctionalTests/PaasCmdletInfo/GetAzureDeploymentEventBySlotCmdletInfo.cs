...
{
    public class GetAzureDeploymentEventBySlotCmdletInfo : CmdletsInfo
    {
        public GetAzureDeploymentEventBySlotCmdletInfo(string serviceName, string deploymentSlot, DateTime startTime, DateTime endTime)
        {
            ...
            {
                cmdletParams.Add(new CmdletParam("Slot", deploymentSlot));
            }
