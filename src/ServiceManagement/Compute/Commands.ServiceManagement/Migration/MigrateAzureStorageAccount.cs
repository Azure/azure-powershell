...
namespace Microsoft.WindowsAzure.Commands.ServiceManagement.HostedServices
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Move, "AzureStrorageAccount"), OutputType(typeof(OperationStatusResponse))]
    public class MigrateAzureStorageAccountCommand : ServiceManagementBaseCmdlet
    {
