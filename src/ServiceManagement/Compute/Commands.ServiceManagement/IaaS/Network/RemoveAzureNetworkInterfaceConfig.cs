...
{
    [Cmdlet(VerbsCommon.Remove, NetworkInterfaceConfig), OutputType(typeof(IPersistentVM))]
    public class RemoveAzureNetworkInterfaceConfig : VirtualMachineConfigurationCmdletBase
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                networkConfiguration.NetworkInterfaces.RemoveAll(e => string.Equals(e.Name, this.Name, StringComparison.OrdinalIgnoreCase));
            }
