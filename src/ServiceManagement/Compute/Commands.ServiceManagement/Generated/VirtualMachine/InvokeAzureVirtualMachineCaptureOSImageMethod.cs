...
{
    [Cmdlet(VerbsLifecycle.Invoke, "AzureVirtualMachineCaptureOSImageMethod")]
    [OutputType(typeof(OperationStatusResponse))]
    public class InvokeAzureVirtualMachineCaptureOSImageMethod : ComputeAutomationBaseCmdlet
    {
        ...
        [Parameter(Mandatory = true)]
        public VirtualMachineCaptureOSImageParameters Parameters { get; set; }
    ...
    public partial class InvokeAzureComputeMethodCmdlet : ComputeAutomationBaseCmdlet
    {
        protected void ExecuteVirtualMachineCaptureOSImageMethod(object[] invokeMethodInputParameters)
        {
            ...
            VirtualMachineCaptureOSImageParameters parameters = (VirtualMachineCaptureOSImageParameters)invokeMethodInputParameters[3];
