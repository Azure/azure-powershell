...
{
    [Cmdlet(VerbsLifecycle.Invoke, "AzureVirtualMachineStartRolesMethod")]
    ...
    public class InvokeAzureVirtualMachineStartRolesMethod : ComputeAutomationBaseCmdlet
    {
        ...
        public VirtualMachineStartRolesParameters Parameters { get; set; }
    ...
    public partial class InvokeAzureComputeMethodCmdlet : ComputeAutomationBaseCmdlet
    {
        protected void ExecuteVirtualMachineStartRolesMethod(object[] invokeMethodInputParameters)
        {
            ...
            VirtualMachineStartRolesParameters parameters = (VirtualMachineStartRolesParameters)invokeMethodInputParameters[2];
