...
{
    [Cmdlet(VerbsLifecycle.Invoke, "AzureVirtualMachineGetMethod")]
    [OutputType(typeof(VirtualMachineGetResponse))]
    public class InvokeAzureVirtualMachineGetMethod : ComputeAutomationBaseCmdlet
    {
