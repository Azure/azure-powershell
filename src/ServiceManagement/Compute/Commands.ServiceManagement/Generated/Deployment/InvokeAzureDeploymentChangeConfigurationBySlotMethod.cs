...
{
    [Cmdlet(VerbsLifecycle.Invoke, "AzureDeploymentChangeConfigurationBySlotMethod")]
    [OutputType(typeof(OperationStatusResponse))]
    public class InvokeAzureDeploymentChangeConfigurationBySlotMethod : ComputeAutomationBaseCmdlet
    {
        ...
        [Parameter(Mandatory = true)]
        public DeploymentChangeConfigurationParameters Parameters { get; set; }
    ...
    public partial class InvokeAzureComputeMethodCmdlet : ComputeAutomationBaseCmdlet
    {
        protected void ExecuteDeploymentChangeConfigurationBySlotMethod(object[] invokeMethodInputParameters)
        {
            ...
            DeploymentChangeConfigurationParameters parameters = (DeploymentChangeConfigurationParameters)invokeMethodInputParameters[2];
