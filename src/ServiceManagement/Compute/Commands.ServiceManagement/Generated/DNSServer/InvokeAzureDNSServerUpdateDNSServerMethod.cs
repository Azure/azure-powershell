...
{
    [Cmdlet(VerbsLifecycle.Invoke, "AzureDNSServerUpdateDNSServerMethod")]
    [OutputType(typeof(OperationStatusResponse))]
    public class InvokeAzureDNSServerUpdateDNSServerMethod : ComputeAutomationBaseCmdlet
    {
        ...
        [Parameter(Mandatory = true)]
        public DNSUpdateParameters Parameters { get; set; }
    ...
    public partial class InvokeAzureComputeMethodCmdlet : ComputeAutomationBaseCmdlet
    {
        protected void ExecuteDNSServerUpdateDNSServerMethod(object[] invokeMethodInputParameters)
        {
            ...
            string dnsServerName = (string)invokeMethodInputParameters[2];
            DNSUpdateParameters parameters = (DNSUpdateParameters)invokeMethodInputParameters[3];
