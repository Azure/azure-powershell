...
function Test-SetResources-DirectInput
{
	...
	$output = Select-AzureStorSimpleResource -ResourceName $resourceName -RegistrationKey "1975530557201809476:eOqMQdvHon3lGwKVYctxZVnwpZcqi8ZS1uyCLJAl6Wg=:JovQDqP1KyWdh4m3mYkdzQ==#4edfc1cde41104e5"
...
function Test-SetResources-PipedInput
{
	...
	# Set the resource Name
	$output = $resource | Select-AzureStorSimpleResource -RegistrationKey "1975530557201809476:eOqMQdvHon3lGwKVYctxZVnwpZcqi8ZS1uyCLJAl6Wg=:JovQDqP1KyWdh4m3mYkdzQ==#4edfc1cde41104e5"
