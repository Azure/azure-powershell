...
namespace Microsoft.WindowsAzure.Commands.StorSimple.Cmdlets
{
    ...
    public class NewAzureStorSimpleNetworkConfig : StorSimpleCmdletBase
    {
        ...
        /// </summary>
        [Parameter(Mandatory=false, Position = 0, HelpMessage = StorSimpleCmdletHelpMessage.HelpMessageIsIscsiEnabled)]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 1, HelpMessage = StorSimpleCmdletHelpMessage.HelpMessageIsCloudEnabled)]
        [ValidateNotNullOrEmptyAttribute]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 2, HelpMessage = StorSimpleCmdletHelpMessage.HelpMessageController0IPv4Address)]
        [ValidateNotNullOrEmptyAttribute]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 3, HelpMessage = StorSimpleCmdletHelpMessage.HelpMessageController1IPv4Address)]
        [ValidateNotNullOrEmptyAttribute]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 4, HelpMessage = StorSimpleCmdletHelpMessage.HelpMessageIPv6Gateway)]
        [ValidateNotNullOrEmptyAttribute]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 5, HelpMessage = StorSimpleCmdletHelpMessage.HelpMessageIPv4Gateway)]
        [ValidateNotNullOrEmptyAttribute]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 6, HelpMessage = StorSimpleCmdletHelpMessage.HelpMessageIPv4Address)]
        [ValidateNotNullOrEmptyAttribute]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 7, HelpMessage = StorSimpleCmdletHelpMessage.HelpMessageIPv6Prefix)]
        [ValidateNotNullOrEmptyAttribute]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 8, HelpMessage = StorSimpleCmdletHelpMessage.HelpMessageIPv4Netmask)]
        [ValidateNotNullOrEmptyAttribute]
