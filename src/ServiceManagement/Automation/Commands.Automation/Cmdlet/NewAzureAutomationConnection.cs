...
namespace Microsoft.Azure.Commands.Automation.Cmdlet
{
    ...
    public class NewAzureAutomationConnection : AzureAutomationBaseCmdlet
    {
        ...
        protected override void AutomationExecuteCmdlet()
        {
            ...
            var createdConnection = this.AutomationClient.CreateConnection(this.AutomationAccountName, this.Name, this.ConnectionTypeName, this.ConnectionFieldValues, this.Description);
