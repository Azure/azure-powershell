...
namespace Microsoft.Azure.Commands.Automation.Cmdlet
{
    ...
    public class RemoveAzureAutomationConnection : AzureAutomationBaseCmdlet
    {
        ...
        /// </summary>
        [Parameter(ParameterSetName = AutomationCmdletParameterSets.ByName, Position = 1, Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = "The connection name.")]
        [ValidateNotNullOrEmpty]
        public string Name { get; set; }

        [Parameter(ParameterSetName = AutomationCmdletParameterSets.ByName, Position = 2, HelpMessage = "Confirm the removal of the connection")]
        ...
        protected override void AutomationExecuteCmdlet()
        {
            ConfirmAction(
                       ...
                       () =>
                       {
                           this.AutomationClient.DeleteConnection(this.AutomationAccountName, Name);
                       });
        }
    }
}
