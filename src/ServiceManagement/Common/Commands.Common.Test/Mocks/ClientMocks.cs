...
namespace Microsoft.WindowsAzure.Commands.Common.Test.Mocks
{
    ...
    public class ClientMocks
    {
        ...
        public Mock<WindowsAzure.Management.Storage.StorageManagementClient> StorageManagementClientMock { get; private set; }
        public Mock<WindowsAzure.Management.Compute.ComputeManagementClient> ComputeManagementClientMock { get; private set; }
        ...
        public ClientMocks(Guid subscriptionId)
        {
            ...
            ComputeManagementClientMock = repository.Create<WindowsAzure.Management.Compute.ComputeManagementClient>(creds);
            StorageManagementClientMock = repository.Create<WindowsAzure.Management.Storage.StorageManagementClient>(creds);
