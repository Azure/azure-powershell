...
{
    /// <summary>
    /// Cmdlet to create a new scheduler job collection
    /// </summary>
    [Cmdlet(VerbsCommon.New, "AzureSchedulerJobCollection"), OutputType(typeof(PSJobCollection))]
    public class NewSchedulerJobCollectionCommand : SchedulerBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            WriteObject(SMClient.CreateJobCollection(new PSCreateJobCollectionParams
            {
                Region = Location,
