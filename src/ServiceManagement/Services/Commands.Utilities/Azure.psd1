...
RequiredModules = @(@{ModuleName = 'Azure.Storage'; ModuleVersion = '2.8.0'; })
...
AliasesToExport = 'Add-WAPackEnvironment', 
               ...
               'Get-SSFailoverVolumeContainers', 'Get-SSJob', 'Get-SSResource', 
               'Get-SSResourceContext', 'Get-SSStorageAccountCredential', 
               'Get-SSTask', 'New-SSAccessControlRecord', 'New-SSDeviceBackupPolicy', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Update the output object of migration cmdlets (Move-AzureService, Move-AzureStorageAccount, Move-AzureVirtualNetwork, Move-AzureNetworkSecurityGroup, Move-AzureReservedIP, Move-AzureRouteTable):
