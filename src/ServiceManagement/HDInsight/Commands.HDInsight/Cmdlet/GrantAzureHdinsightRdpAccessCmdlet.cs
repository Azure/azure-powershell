...
{
    /// <summary>
    /// Cmdlet that grants RDP access to an HDInsight cluster.
    /// </summary>
    [Cmdlet(VerbsSecurity.Grant, AzureHdInsightPowerShellConstants.AzureHdinsightRdpAccess)]
    public class GrantAzureHdinsightRdpAccessCmdlet : AzureHDInsightCmdlet, IManageAzureHDInsightRdpAccessBase
    {
        private readonly IManageAzureHDInsightRdpAccessCommand command;
        private bool enableRdpAccess = true;

        public GrantAzureHdinsightRdpAccessCmdlet()
        {
        ...
        /// <inheritdoc />
        [Parameter(Position = 3, Mandatory = true, HelpMessage = "The credentials to use when connecting to Azure HDInsight cluster using RDP.",
            ParameterSetName = AzureHdInsightPowerShellConstants.ParameterSetClusterByNameWithSpecificSubscriptionCredentials)]
        ...
        /// <inheritdoc />
        [Parameter(Position = 3, Mandatory = true, HelpMessage = "The RDP access expiry for connecting to Azure HDInsight cluster.",
            ParameterSetName = AzureHdInsightPowerShellConstants.ParameterSetClusterByNameWithSpecificSubscriptionCredentials)]
        ...
        public bool Enable
        {
            get { return this.enableRdpAccess; }
            set { this.enableRdpAccess = value; }
        }
        ...
        /// <inheritdoc />
        [Parameter(Position = 1, Mandatory = true, HelpMessage = "The Location of the HDInsight cluster to grant rdp access to.")]
        ...
        /// <inheritdoc />
        [Parameter(Position = 0, Mandatory = true, HelpMessage = "The name of the HDInsight cluster to grant rdp access to.",
        ...
        {
            this.WriteWarning(string.Format(AzureHdInsightPowerShellConstants.AsmWarning, "Grant-AzHDInsightRdpServicesAccess"));
