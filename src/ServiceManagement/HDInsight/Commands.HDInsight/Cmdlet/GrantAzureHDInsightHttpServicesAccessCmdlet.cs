...
namespace Microsoft.WindowsAzure.Management.HDInsight.Cmdlet.PSCmdlets
{
    ...
    public class GrantAzureHDInsightHttpServicesAccessCmdlet : AzureHDInsightCmdlet, IManageAzureHDInsightHttpAccessBase
    {
        ...
        /// <inheritdoc />
        [Parameter(Position = 3, Mandatory = true, HelpMessage = "The credentials to use when connecting to Azure.",
            ParameterSetName = AzureHdInsightPowerShellConstants.ParameterSetClusterByNameWithSpecificSubscriptionCredentials)]
        ...
        /// <inheritdoc />
        [Parameter(Position = 0, Mandatory = true, HelpMessage = "The name of the HDInsight cluster to grant http access to.",
        ...
        {
            this.WriteWarning(string.Format(AzureHdInsightPowerShellConstants.AsmWarning, "Grant-AzHDInsightHttpServicesAccess"));
