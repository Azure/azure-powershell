...
namespace Microsoft.Azure.Management.RemoteApp.Cmdlets
{
    ...
    public class GetAzureRemoteAppUser : RdsCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            response = CallClient(() => Client.Principals.List(CollectionName, null), Client.Principals);
            ...
            if (response != null && response.SecurityPrincipalInfoList != null && response.SecurityPrincipalInfoList.Count != 0)
            {
                ...
                while (response != null && response.SecurityPrincipalInfoList != null && response.SecurityPrincipalInfoList.Count != 0)
                {
