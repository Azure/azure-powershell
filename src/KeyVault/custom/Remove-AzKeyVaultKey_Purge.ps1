function Remove-AzKeyVaultKey_Purge {
    ...
    param(
        ...
        [Parameter(ParameterSetName='Purge', Mandatory, HelpMessage='The name of the key')]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category('Path')]
        [System.String]
        # The name of the key
        ${Name},

        [Parameter(Mandatory, HelpMessage='Signals that the given deleted vault key should be purged.')]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category('Path')]
    ...
    process {
        ...
        Az.KeyVault.internal\Clear-AzKeyVaultDeletedKey @PSBoundParameters
    }
}