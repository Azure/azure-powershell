function Get-AzKeyVaultStorageAccount {
    ...
    param(
        ...
        [Parameter(Mandatory, HelpMessage='Signals that deleted key vault storage accounts should be returned.')]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category('Path')]
    ...
    process {
        ...
        Az.KeyVault.internal\Get-AzKeyVaultDeletedStorageAccount @PSBoundParameters
    }
}