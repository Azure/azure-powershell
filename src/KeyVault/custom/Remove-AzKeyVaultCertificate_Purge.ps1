function Remove-AzKeyVaultCertificate_Purge {
    ...
    param(
        ...
        [Parameter(Mandatory, HelpMessage='The name of the certificate')]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category('Path')]
        [System.String]
        # The name of the certificate
        ${Name},

        [Parameter(Mandatory, HelpMessage='Signals that the given deleted vault certificate should be purged.')]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category('Path')]
    ...
    process {
        ...
        Az.KeyVault.internal\Clear-AzKeyVaultDeletedCertificate @PSBoundParameters
    }
}