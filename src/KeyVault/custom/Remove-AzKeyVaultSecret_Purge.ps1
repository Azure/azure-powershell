function Remove-AzKeyVaultSecret_Purge {
    ...
    param(
        ...
        [Parameter(Mandatory, HelpMessage='Signals that the given deleted vault secret should be purged.')]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category('Path')]
    ...
    process {
        $null = $PSBoundParameters.Add("SecretName", $Name)
        $null = $PSBoundParameters.Remove("Name")
        $null = $PSBoundParameters.Remove("InRemovedState")
        Az.KeyVault.internal\Clear-AzKeyVaultDeletedSecret @PSBoundParameters
    }
}