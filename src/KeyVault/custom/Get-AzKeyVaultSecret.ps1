function Get-AzKeyVaultSecret {
    ...
    param(
        ...
        [Parameter(ParameterSetName='GetDeleted1', Mandatory, HelpMessage='The name of the secret.')]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category('Path')]
        [System.String]
        # The name of the secret.
        ${Name},

        [Parameter(Mandatory, HelpMessage='Signals that deleted key vault secrets should be returned.')]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category('Path')]
    ...
    process {
        ...
        Az.KeyVault.internal\Get-AzKeyVaultDeletedSecret @PSBoundParameters
    }
}