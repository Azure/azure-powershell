...
namespace Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListByResource=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.KeyVault/managedHSMs/{name}/regions"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzKeyVaultManagedHsmRegion_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IMhsmGeoReplicatedRegion))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Description(@"The List operation gets information about the regions associated with the managed HSM Pool.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.KeyVault/managedHSMs/{name}/regions", ApiVersion = "2023-02-01")]
    public partial class GetAzKeyVaultManagedHsmRegion_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="HsmName" /> property.</summary>
        ...
        public string HsmName { get => this._hsmName; set => this._hsmName = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IMhsmRegionsListResult">Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IMhsmRegionsListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IMhsmRegionsListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzKeyVaultManagedHsmRegion_List" /> cmdlet class.
        /// </summary>
        public GetAzKeyVaultManagedHsmRegion_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.MhsmRegionsListByResource(SubscriptionId, ResourceGroupName, HsmName, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,HsmName=HsmName})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IMhsmRegionsListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IMhsmRegionsListResult
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.MhsmRegionsListByResource_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
