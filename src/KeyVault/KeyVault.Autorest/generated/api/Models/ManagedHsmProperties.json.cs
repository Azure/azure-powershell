...
namespace Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models
{
    ...
    public partial class ManagedHsmProperties
    {
        ...
        internal ManagedHsmProperties(Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Json.JsonObject json)
        {
            ...
            {_networkAcls = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Json.JsonObject>("networkAcls"), out var __jsonNetworkAcls) ? Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.MhsmNetworkRuleSet.FromJson(__jsonNetworkAcls) : NetworkAcls;}
            {_securityDomainProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Json.JsonObject>("securityDomainProperties"), out var __jsonSecurityDomainProperties) ? Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.ManagedHsmSecurityDomainProperties.FromJson(__jsonSecurityDomainProperties) : SecurityDomainProperty;}
            ...
            {_initialAdminObjectId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Json.JsonArray>("initialAdminObjectIds"), out var __jsonInitialAdminObjectIds) ? If( __jsonInitialAdminObjectIds as Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : InitialAdminObjectId;}
            {_hsmUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Json.JsonString>("hsmUri"), out var __jsonHsmUri) ? (string)__jsonHsmUri : (string)HsmUri;}
            {_enableSoftDelete = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Json.JsonBoolean>("enableSoftDelete"), out var __jsonEnableSoftDelete) ? (bool?)__jsonEnableSoftDelete : EnableSoftDelete;}
            {_softDeleteRetentionInDay = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Json.JsonNumber>("softDeleteRetentionInDays"), out var __jsonSoftDeleteRetentionInDays) ? (int?)__jsonSoftDeleteRetentionInDays : SoftDeleteRetentionInDay;}
            {_enablePurgeProtection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Json.JsonBoolean>("enablePurgeProtection"), out var __jsonEnablePurgeProtection) ? (bool?)__jsonEnablePurgeProtection : EnablePurgeProtection;}
            {_statusMessage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Json.JsonString>("statusMessage"), out var __jsonStatusMessage) ? (string)__jsonStatusMessage : (string)StatusMessage;}
