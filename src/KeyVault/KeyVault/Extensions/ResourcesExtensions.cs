...
using ProjectResources = Microsoft.Azure.Commands.KeyVault.Properties.Resources; 
...
namespace Microsoft.Azure.Commands.KeyVault.Extensions
{
    public static class ResourcesExtensions
    {
        ...
        public static string ToFormattedString(this ErrorResponse error, int level = 0)
        {
            if (error.Details == null)
            {
                return string.Format("DeploymentOperationErrorMessageNoDetails", error.Message, error.Code);
            }
            ...
            return string.Format("DeploymentOperationErrorMessage", error.Message, error.Code, errorDetail);
        }
