...
{
    [Cmdlet("Undo", ResourceManager.Common.AzureRMConstants.AzurePrefix + "KeyVaultManagedStorageAccountRemoval",SupportsShouldProcess = true,DefaultParameterSetName = DefaultParameterSet)]
