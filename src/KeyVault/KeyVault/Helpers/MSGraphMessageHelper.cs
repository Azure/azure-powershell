...
Visit https://go.microsoft.com/fwlink/?linkid=2181475 for troubleshooting information.";
        ...
        /// </summary>
        internal static void WriteMessageForCmdletsSwallowException(Cmdlet cmdlet) =>
        ...
        /// </summary>
        internal static void WriteMessageForCmdletsThrowException(Cmdlet cmdlet) =>
            WriteMessage(cmdlet, MessageForCmdletsThrowException);

        private static void WriteMessage(Cmdlet cmdlet, string message)
        {
