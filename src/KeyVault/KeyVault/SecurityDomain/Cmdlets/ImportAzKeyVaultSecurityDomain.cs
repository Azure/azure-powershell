...
namespace Microsoft.Azure.Commands.KeyVault.SecurityDomain.Cmdlets
{
    ...
    public class RestoreSecurityDomain : SecurityDomainCmdlet
    {
        ...
        [Parameter(HelpMessage = "The exchange key used to encrypt the security domain data. Generated by running this command with -DownloadExchangeKey.", Mandatory = true, ParameterSetName=DoRestoreBlob)]
        [ValidateNotNullOrEmpty]
