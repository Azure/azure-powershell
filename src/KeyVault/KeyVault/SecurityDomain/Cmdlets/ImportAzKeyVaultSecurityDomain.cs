...
namespace Microsoft.Azure.Commands.KeyVault.SecurityDomain.Cmdlets
{
    ...
    public class ImportAzKeyVaultSecurityDomain : SecurityDomainCmdlet
    {
        ...
        [Parameter(HelpMessage = "The exchange key used to encrypt the security domain data. Generated by running Import-AzKeyVaultSecurityDomain with -DownloadExchangeKey.", Mandatory = true, ParameterSetName=DoRestoreBlob)]
        [ValidateNotNullOrEmpty]
