...
namespace Microsoft.Azure.Commands.KeyVault.SecurityDomain.Cmdlets
{
    ...
    public class RestoreSecurityDomain : SecurityDomainCmdlet
    {
        ...
        [Parameter(HelpMessage = "Specify the path to the encrypted security domain data generated by Restore-AzKeyVaultSecurityDomainBlob.", Mandatory = true, ParameterSetName = ByRestoreBlob)]
        [Alias("Path")]
        [ValidateNotNullOrEmpty]
        public string SecurityDomainPath { get; set; }

        [Parameter(HelpMessage = "When specified, a boolean will be returned when cmdlet succeeds.", Mandatory = true, ParameterSetName = ByRestoreBlob)]
