...
PS C:> Remove-AzKeyVaultManagedStorageSasDefinition -AccountName $sa.StorageAccountName -Name "TestCert01" -VaultName "ContosoKV01"
```

Removes a Key Vault managed Azure Storage SAS definitions. (autogenerated)
