...
PS C:> Update-AzKeyVaultManagedStorageAccount -AccountName 'mystorageaccount' -AutoRegenerateKey $False -RegenerationPeriod $regenerationPeriod -VaultName 'myvault'
```
