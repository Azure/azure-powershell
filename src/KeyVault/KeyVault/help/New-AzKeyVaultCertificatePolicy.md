...
PS C:> New-AzKeyVaultCertificatePolicy -IssuerName "Self" -KeyType RSA -RenewAtNumberOfDaysBeforeExpiry {RenewAtNumberOfDaysBeforeExpiry} -SecretContentType application/x-pkcs12 -SubjectName "CN=contoso.com" -ValidityInMonths 6
```
