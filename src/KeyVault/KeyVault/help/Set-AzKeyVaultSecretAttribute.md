...
## DESCRIPTION
The **Set-AzKeyVaultSecretAttribute** cmdlet updates editable attributes of a secret in a key vault.
...
match the filter to the Set-AzKeyVaultSecretAttribute cmdlet, which disables them.
...
specified keys, and pipes the keys to the Set-AzKeyVaultSecretAttribute cmdlet to set their
content type to XML.
