...
PS C:> Set-AzKeyVaultCertificatePolicy -Name "TestCert01" -RenewAtNumberOfDaysBeforeExpiry {RenewAtNumberOfDaysBeforeExpiry} -ValidityInMonths 6 -VaultName "ContosoKV01"
```
