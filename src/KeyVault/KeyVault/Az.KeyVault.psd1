...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* ''New-AzKeyVaultManagedHsm'': supported specifying how long a deleted managed hsm is retained by ''SoftDeleteRetentionInDays'' and enabling purge protection by ''EnablePurgeProtection''
