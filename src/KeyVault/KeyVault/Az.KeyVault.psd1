...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* [Breaking change] Removed the offline fallback policy if specify parameter ''UseDefaultCVMPolicy'' in ''Add-AzKeyVaultKey''. Key creation will fail if unable to get regional default CVM SKR policy from MAA Service Discovery API.
