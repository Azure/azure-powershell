...
CmdletsToExport = 'Add-AzKeyVaultCertificate', 'Update-AzKeyVaultCertificate', 
               ...
               'Restore-AzKeyVaultKey', 'Update-AzKeyVaultKey', 'Invoke-AzKeyVaultKeyRotation',
               'Get-AzKeyVaultKeyRotationPolicy', 'Update-AzKeyVaultKeyRotationPolicy',
               'Invoke-AzKeyVaultKeyOperation', 'Set-AzKeyVaultSecret', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added warning message of upcoming breaking change to ''New-AzKeyVaultRoleDefinition'' and ''Get-AzKeyVaultRoleDefinition''.
