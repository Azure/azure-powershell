...
namespace Microsoft.Azure.Commands.KeyVault.Models
{
    ...
    public class VaultManagementClient
    {
        ...
        /// <returns></returns>
        public PSKeyVault CreateNewVault(VaultCreationOrUpdateParameters parameters, MicrosoftGraphClient graphClient = null, PSKeyVaultNetworkRuleSet networkRuleSet = null)
        {
            if (parameters == null)
        ...
        public PSKeyVault GetVault(string vaultName, string resourceGroupName, MicrosoftGraphClient graphClient = null)
        {
        ...
        public PSKeyVault UpdateVault(
            ...
            MicrosoftGraphClient graphClient = null)
        {
        ...
        /// <param name="graphClient">the active directory client</param>
        /// <returns></returns>
        public PSManagedHsm CreateNewManagedHsm(VaultCreationOrUpdateParameters parameters, MicrosoftGraphClient graphClient = null)
        {
            if (parameters == null)
                throw new ArgumentNullException("parameters");
            if (string.IsNullOrWhiteSpace(parameters.Name))
        ...
        public PSManagedHsm GetManagedHsm(string managedHsmName, string resourceGroupName, MicrosoftGraphClient graphClient = null)
        {
        ...
        /// <param name="graphClient">the active directory client</param>
        /// <returns>the retrieved Managed HSM</returns>
        public List<PSManagedHsm> ListManagedHsms(string resourceGroupName, MicrosoftGraphClient graphClient = null)
        {
        ...
        private List<PSManagedHsm> ListManagedHsmsByResourceGroup(string resourceGroupName, MicrosoftGraphClient graphClient = null)
        {
        ...
        private List<PSManagedHsm> ListManagedHsmsBySubscription(MicrosoftGraphClient graphClient = null)
        {
            List<PSManagedHsm> managedHsms = new List<PSManagedHsm>(); ;
        ...
        public PSManagedHsm UpdateManagedHsm(PSManagedHsm existingManagedHsm, VaultCreationOrUpdateParameters parameters, MicrosoftGraphClient graphClient = null)
        {
