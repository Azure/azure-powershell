...
- `build-module.ps1`
  - Builds the module DLL (`./bin/Az.KeyVault.private.dll`), creates the exported cmdlets, generates custom cmdlet test stubs, and updates `./Az.KeyVault.psd1` with Azure profile information.
