Invoke-LiveTestScenario -Name "Get and update key vault setting in a MSHM" -Description "Get and update a key vault setting in a MSHM" -ScenarioScript `
{
    ...
    $adminId = "2f153a9e-5be9-4f43-abd2-04561777c8b0" #(Get-AzADUser -StartsWith Beisi).Id
    ...
    Export-AzKeyVaultSecurityDomain -Certificates "$PSScriptRoot\sd1.cer", "$PSScriptRoot\sd2.cer", "$PSScriptRoot\sd3.cer" -Quorum 2 -OutputPath ./sd.ps.json -Name $hsmName
