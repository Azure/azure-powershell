...
### CreateExpanded
```
New-AzKeyVaultCertificate -Name <String> [-AttributeEnabled <Boolean>] [-AttributeExpire <DateTime>]
...
```
New-AzKeyVaultCertificate -InputObject <IKeyVaultIdentity> [-AttributeEnabled <Boolean>]
