...
online version: https://docs.microsoft.com/powershell/module/az.keyvault/undo-azkeyvaultstoragesasdefinitionremoval
schema: 2.0.0
---
...
### RecoverViaIdentity
```
Undo-AzKeyVaultStorageSasDefinitionRemoval -InputObject <IKeyVaultIdentity> [-KeyVaultDnsSuffix <String>]
