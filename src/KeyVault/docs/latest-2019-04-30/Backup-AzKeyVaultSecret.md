...
### Backup (Default)
```
Backup-AzKeyVaultSecret -Name <String> -OutFile <String> [-KeyVaultDnsSuffix <String>] [-VaultName <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### BackupViaIdentity
```
Backup-AzKeyVaultSecret -InputObject <IKeyVaultIdentity> -OutFile <String> [-KeyVaultDnsSuffix <String>]
