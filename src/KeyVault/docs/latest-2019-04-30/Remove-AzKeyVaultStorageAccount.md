...
online version: https://docs.microsoft.com/powershell/module/az.keyvault/remove-azkeyvaultstorageaccount
schema: 2.0.0
---
...
### Purge
```
Remove-AzKeyVaultStorageAccount -InRemovedState -Name <String> [-KeyVaultDnsSuffix <String>]
