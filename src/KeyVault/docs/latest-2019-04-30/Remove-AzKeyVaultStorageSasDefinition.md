...
online version: https://docs.microsoft.com/powershell/module/az.keyvault/remove-azkeyvaultstoragesasdefinition
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzKeyVaultStorageSasDefinition -InputObject <IKeyVaultIdentity> [-KeyVaultDnsSuffix <String>]
