...
### Backup (Default)
```
Backup-AzKeyVaultCertificate -Name <String> [-VaultBaseUrl <String>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### BackupViaIdentity
```
Backup-AzKeyVaultCertificate -InputObject <IKeyVaultIdentity> [-VaultBaseUrl <String>]
