...
online version: https://docs.microsoft.com/powershell/module/az.keyvault/update-azkeyvaultstoragesasdefinition
schema: 2.0.0
---
...
Update-AzKeyVaultStorageSasDefinition -SasDefinitionName <String> -StorageAccountName <String>
 [-KeyVaultDnsSuffix <String>] [-VaultName <String>] [-DefinitionMetadata <Hashtable>] [-Enabled]
...
```
Update-AzKeyVaultStorageSasDefinition -SasDefinitionName <String> -StorageAccountName <String>
 -Parameter <ISasDefinitionUpdateParameters> [-KeyVaultDnsSuffix <String>] [-VaultName <String>]
...
Update-AzKeyVaultStorageSasDefinition -InputObject <IKeyVaultIdentity> [-KeyVaultDnsSuffix <String>]
 [-VaultName <String>] [-DefinitionMetadata <Hashtable>] [-Enabled] [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
