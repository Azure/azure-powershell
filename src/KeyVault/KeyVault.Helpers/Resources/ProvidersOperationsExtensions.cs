...
namespace Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Helpers.Resources
{
    ...
    public static partial class ProvidersOperationsExtensions
    {
            ...
            /// </param>
            public static Provider Register(this IProvidersOperations operations, string resourceProviderNamespace, ProviderConsentDefinition thirdPartyProviderConsent = default(ProviderConsentDefinition))
            {
                return operations.RegisterAsync(resourceProviderNamespace, thirdPartyProviderConsent).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Provider> RegisterAsync(this IProvidersOperations operations, string resourceProviderNamespace, ProviderConsentDefinition thirdPartyProviderConsent = default(ProviderConsentDefinition), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.RegisterWithHttpMessagesAsync(resourceProviderNamespace, thirdPartyProviderConsent, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
