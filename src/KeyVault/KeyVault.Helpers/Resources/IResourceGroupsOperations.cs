...
namespace Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Helpers.Resources
{
    ...
    public partial interface IResourceGroupsOperations
    {
        ...
        /// </param>
        /// <param name='options'>
        /// The export template options. A CSV-formatted list containing zero
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<ResourceGroupExportResult>> ExportTemplateWithHttpMessagesAsync(string resourceGroupName, IList<string> resources = default(IList<string>), string options = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<ResourceGroupExportResult>> BeginExportTemplateWithHttpMessagesAsync(string resourceGroupName, IList<string> resources = default(IList<string>), string options = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets all the resource groups for a subscription.
        /// </summary>
