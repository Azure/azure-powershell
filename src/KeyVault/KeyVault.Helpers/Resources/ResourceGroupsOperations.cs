...
namespace Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Helpers.Resources
{
    ...
    internal partial class ResourceGroupsOperations : IServiceOperations<ResourceManagementClient>, IResourceGroupsOperations
    {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<ResourceGroupExportResult>> ExportTemplateWithHttpMessagesAsync(string resourceGroupName, IList<string> resources = default(IList<string>), string options = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
            AzureOperationResponse<ResourceGroupExportResult> _response = await BeginExportTemplateWithHttpMessagesAsync(resourceGroupName, resources, options, customHeaders, cancellationToken).ConfigureAwait(false);
            return await Client.GetPostOrDeleteOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        public async Task<AzureOperationResponse<ResourceGroupExportResult>> BeginExportTemplateWithHttpMessagesAsync(string resourceGroupName, IList<string> resources = default(IList<string>), string options = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            ExportTemplateRequest parameters = new ExportTemplateRequest();
            if (resources != null || options != null)
            {
