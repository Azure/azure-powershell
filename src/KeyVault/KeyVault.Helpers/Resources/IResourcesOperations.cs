...
namespace Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Helpers.Resources
{
    ...
    public partial interface IResourcesOperations
    {
        ...
        /// </summary>
        /// <remarks>
        /// The resources to be moved must be in the same source resource group
        /// in the source subscription being used. The target resource group
        /// may be in a different subscription. When moving resources, both the
        /// source group and the target group are locked for the duration of
        /// the operation. Write and delete operations are blocked on the
        /// groups until the move completes.
        /// </remarks>
        /// <param name='sourceResourceGroupName'>
        /// The name of the resource group from the source subscription
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse> MoveResourcesWithHttpMessagesAsync(string sourceResourceGroupName, IList<string> resources = default(IList<string>), string targetResourceGroup = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// to the target. The resources to be moved must be in the same source
        ...
        /// succeeds, it returns HTTP response code 204 (no content). If
        /// validation fails, it returns HTTP response code 409 (Conflict) with
        /// an error message. Retrieve the URL in the Location header value to
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse> ValidateMoveResourcesWithHttpMessagesAsync(string sourceResourceGroupName, IList<string> resources = default(IList<string>), string targetResourceGroup = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// <summary>
        /// Checks by ID whether a resource exists. This API currently works
        /// only for a limited set of Resource providers. In the event that a
        /// Resource provider does not implement this API, ARM will respond
        /// with a 405. The alternative then is to use the GET API to check for
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse> BeginMoveResourcesWithHttpMessagesAsync(string sourceResourceGroupName, IList<string> resources = default(IList<string>), string targetResourceGroup = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Validates whether resources can be moved from one resource group to
        /// another resource group.
        /// </summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse> BeginValidateMoveResourcesWithHttpMessagesAsync(string sourceResourceGroupName, IList<string> resources = default(IList<string>), string targetResourceGroup = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Deletes a resource.
        /// </summary>
        /// <param name='resourceGroupName'>
