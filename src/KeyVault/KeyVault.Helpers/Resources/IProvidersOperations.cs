...
namespace Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Helpers.Resources
{
    ...
    public partial interface IProvidersOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<Provider>> RegisterWithHttpMessagesAsync(string resourceProviderNamespace, ProviderConsentDefinition thirdPartyProviderConsent = default(ProviderConsentDefinition), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
