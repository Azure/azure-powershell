...
namespace Microsoft.Azure.Management.Automation
{
    ...
    /// </summary>
    internal partial class NodeCountInformationOperations : Microsoft.Rest.IServiceOperations<AutomationClient>, INodeCountInformationOperations
    {
        /// <summary>
        ...
        /// </return>
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<NodeCounts>> GetWithHttpMessagesAsync(string resourceGroupName, string automationAccountName, string countType, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (countType == null)
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "countType");
            }
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<NodeCounts>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<NodeCounts>(_responseContent, this.Client.DeserializationSettings);
                }
