...
namespace Microsoft.Azure.Management.Automation
{
    ...
    public static partial class LinkedWorkspaceOperationsExtensions
    {
        ...
        {
                return ((ILinkedWorkspaceOperations)operations).GetAsync(resourceGroupName, automationAccountName).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<LinkedWorkspace> GetAsync(this ILinkedWorkspaceOperations operations, string resourceGroupName, string automationAccountName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
