...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class SourceControlSyncJobStream
    {
        ...
        /// </param>
        public SourceControlSyncJobStream(string id = default(string), string streamType = default(string), string sourceControlSyncJobStreamId = default(string), string summary = default(string), System.DateTimeOffset? time = default(System.DateTimeOffset?))
