...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    /// </summary>
    public partial class RunbookCreateOrUpdateDraftPropertiesAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the RunbookCreateOrUpdateDraftPropertiesAutoGenerated class.
        /// </summary>
        public RunbookCreateOrUpdateDraftPropertiesAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public RunbookCreateOrUpdateDraftPropertiesAutoGenerated(string runbookType, RunbookDraftAutoGenerated draft, bool? logVerbose = default(bool?), bool? logProgress = default(bool?), string runtimeEnvironment = default(string), string description = default(string), int? logActivityTrace = default(int?))
