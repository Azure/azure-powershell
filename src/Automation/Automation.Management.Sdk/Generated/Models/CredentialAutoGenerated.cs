...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class CredentialAutoGenerated : ProxyResourceAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the CredentialAutoGenerated class.
        /// </summary>
        public CredentialAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CredentialAutoGenerated(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string userName = default(string), System.DateTimeOffset? creationTime = default(System.DateTimeOffset?), System.DateTimeOffset? lastModifiedTime = default(System.DateTimeOffset?), string description = default(string))
