...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class SourceControlUpdateParametersAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the SourceControlUpdateParametersAutoGenerated class.
        /// </summary>
        public SourceControlUpdateParametersAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// <param name="branch">The repo branch of the source control.
        /// </param>
        ...
        /// </param>
        public SourceControlUpdateParametersAutoGenerated(string branch = default(string), string folderPath = default(string), bool? autoSync = default(bool?), bool? publishRunbook = default(bool?), SourceControlSecurityTokenPropertiesAutoGenerated securityToken = default(SourceControlSecurityTokenPropertiesAutoGenerated), string description = default(string))
        ...
        public SourceControlSecurityTokenPropertiesAutoGenerated SecurityToken {get; set; }
