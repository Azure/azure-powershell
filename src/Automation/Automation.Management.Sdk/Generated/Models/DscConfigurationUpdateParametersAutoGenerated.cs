...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class DscConfigurationUpdateParametersAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the DscConfigurationUpdateParametersAutoGenerated class.
        /// </summary>
        public DscConfigurationUpdateParametersAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public DscConfigurationUpdateParametersAutoGenerated(string name = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), bool? logVerbose = default(bool?), bool? logProgress = default(bool?), ContentSourceAutoGenerated source = default(ContentSourceAutoGenerated), System.Collections.Generic.IDictionary<string, DscConfigurationParameter> parameters = default(System.Collections.Generic.IDictionary<string, DscConfigurationParameter>), string description = default(string))
