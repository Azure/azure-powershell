...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class KeyVaultProperties
    {
        ...
        /// <param name="keyvaultUri">The URI of the key vault key used to encrypt data.
        /// </param>

        /// <param name="keyName">The name of key used to encrypt data.
        /// </param>

        /// <param name="keyVersion">The key version of the key used to encrypt data.
        /// </param>
