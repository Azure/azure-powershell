...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class RunbookCreateOrUpdateProperties
    {
        ...
        /// </param>
        public RunbookCreateOrUpdateProperties(string runbookType, bool? logVerbose = default(bool?), bool? logProgress = default(bool?), string runtimeEnvironment = default(string), RunbookDraft draft = default(RunbookDraft), ContentLink publishContentLink = default(ContentLink), string description = default(string), int? logActivityTrace = default(int?))
