...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class SourceControlSyncJobStreamByIdAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the SourceControlSyncJobStreamByIdAutoGenerated class.
        /// </summary>
        public SourceControlSyncJobStreamByIdAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public SourceControlSyncJobStreamByIdAutoGenerated(string id = default(string), string streamType = default(string), string sourceControlSyncJobStreamId = default(string), string summary = default(string), System.DateTimeOffset? time = default(System.DateTimeOffset?), string streamText = default(string), System.Collections.Generic.IDictionary<string, object> value = default(System.Collections.Generic.IDictionary<string, object>))
