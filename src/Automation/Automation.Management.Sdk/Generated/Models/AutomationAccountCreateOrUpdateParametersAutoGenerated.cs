...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class AutomationAccountCreateOrUpdateParametersAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the AutomationAccountCreateOrUpdateParametersAutoGenerated class.
        /// </summary>
        public AutomationAccountCreateOrUpdateParametersAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public AutomationAccountCreateOrUpdateParametersAutoGenerated(string name = default(string), string location = default(string), IdentityAutoGenerated identity = default(IdentityAutoGenerated), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), SkuAutoGenerated sku = default(SkuAutoGenerated), EncryptionPropertiesAutoGenerated encryption = default(EncryptionPropertiesAutoGenerated), bool? publicNetworkAccess = default(bool?), bool? disableLocalAuth = default(bool?))
