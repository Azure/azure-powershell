...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class ConnectionAutoGenerated : ProxyResourceAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the ConnectionAutoGenerated class.
        /// </summary>
        public ConnectionAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public ConnectionAutoGenerated(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), ConnectionTypeAssociationProperty connectionType = default(ConnectionTypeAssociationProperty), System.Collections.Generic.IDictionary<string, string> fieldDefinitionValues = default(System.Collections.Generic.IDictionary<string, string>), System.DateTimeOffset? creationTime = default(System.DateTimeOffset?), System.DateTimeOffset? lastModifiedTime = default(System.DateTimeOffset?), string description = default(string))
