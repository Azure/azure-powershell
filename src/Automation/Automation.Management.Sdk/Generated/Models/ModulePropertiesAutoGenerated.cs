...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    /// </summary>
    public partial class ModulePropertiesAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the ModulePropertiesAutoGenerated class.
        /// </summary>
        public ModulePropertiesAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public ModulePropertiesAutoGenerated(bool? isGlobal = default(bool?), string version = default(string), long? sizeInBytes = default(long?), int? activityCount = default(int?), string provisioningState = default(string), ContentLinkAutoGenerated contentLink = default(ContentLinkAutoGenerated), ModuleErrorInfoAutoGenerated error = default(ModuleErrorInfoAutoGenerated), System.DateTimeOffset? creationTime = default(System.DateTimeOffset?), System.DateTimeOffset? lastModifiedTime = default(System.DateTimeOffset?), string description = default(string), bool? isComposite = default(bool?))
        ...
        public ModuleErrorInfoAutoGenerated Error {get; set; }
