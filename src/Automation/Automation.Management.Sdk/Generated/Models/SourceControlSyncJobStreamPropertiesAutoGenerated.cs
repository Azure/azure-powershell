...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    /// </summary>
    public partial class SourceControlSyncJobStreamPropertiesAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the SourceControlSyncJobStreamPropertiesAutoGenerated class.
        /// </summary>
        public SourceControlSyncJobStreamPropertiesAutoGenerated()
        {
            CustomInit();
        }
        ...
        public SourceControlSyncJobStreamPropertiesAutoGenerated(string sourceControlSyncJobStreamId = default(string), string summary = default(string), System.DateTimeOffset? time = default(System.DateTimeOffset?), string streamType = default(string))
