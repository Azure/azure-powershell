...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    /// </summary>
    public partial class UpdateConfigurationAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the UpdateConfigurationAutoGenerated class.
        /// </summary>
        public UpdateConfigurationAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public UpdateConfigurationAutoGenerated(OperatingSystemType operatingSystem, WindowsPropertiesAutoGenerated windows = default(WindowsPropertiesAutoGenerated), LinuxPropertiesAutoGenerated linux = default(LinuxPropertiesAutoGenerated), System.TimeSpan? duration = default(System.TimeSpan?), System.Collections.Generic.IList<string> azureVirtualMachines = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<string> nonAzureComputerNames = default(System.Collections.Generic.IList<string>), TargetPropertiesAutoGenerated targets = default(TargetPropertiesAutoGenerated))
        ...
        public WindowsPropertiesAutoGenerated Windows {get; set; }

        /// <summary>
        /// Gets or sets linux specific update configuration.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "linux")]
        public LinuxPropertiesAutoGenerated Linux {get; set; }
        ...
        public TargetPropertiesAutoGenerated Targets {get; set; }
        /// <summary>
        /// Validate the object.
        /// </summary>
