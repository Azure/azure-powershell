...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class SourceControlCreateOrUpdateParametersAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the SourceControlCreateOrUpdateParametersAutoGenerated class.
        /// </summary>
        public SourceControlCreateOrUpdateParametersAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public SourceControlCreateOrUpdateParametersAutoGenerated(string sourceType = default(string), string repoUrl = default(string), string branch = default(string), string folderPath = default(string), bool? autoSync = default(bool?), bool? publishRunbook = default(bool?), SourceControlSecurityTokenPropertiesAutoGenerated securityToken = default(SourceControlSecurityTokenPropertiesAutoGenerated), string description = default(string))
