...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class WebhookAutoGenerated : ProxyResourceAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the WebhookAutoGenerated class.
        /// </summary>
        public WebhookAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// <param name="isEnabled">Gets or sets the value of the enabled flag of the webhook.
        /// </param>

        /// <param name="uri">Gets or sets the webhook uri.
        /// </param>

        /// <param name="expiryTime">Gets or sets the expiry time.
        /// </param>

        /// <param name="lastInvokedTime">Gets or sets the last invoked time.
        /// </param>

        /// <param name="parameters">Gets or sets the parameters of the job that is created when the webhook
        /// calls the runbook it is associated with.
        /// </param>

        /// <param name="runbook">Gets or sets the runbook the webhook is associated with.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets gets or sets the value of the enabled flag of the webhook.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.isEnabled")]
        public bool? IsEnabled {get; set; }

        /// <summary>
        /// Gets or sets gets or sets the webhook uri.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets gets or sets the parameters of the job that is created when
        /// the webhook calls the runbook it is associated with.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.parameters")]
        public System.Collections.Generic.IDictionary<string, string> Parameters {get; set; }

        /// <summary>
        /// Gets or sets gets or sets the runbook the webhook is associated with.
        /// </summary>
