...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class DscConfigurationCreateOrUpdateParametersAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the DscConfigurationCreateOrUpdateParametersAutoGenerated class.
        /// </summary>
        public DscConfigurationCreateOrUpdateParametersAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public DscConfigurationCreateOrUpdateParametersAutoGenerated(ContentSourceAutoGenerated source, string name = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), bool? logVerbose = default(bool?), bool? logProgress = default(bool?), System.Collections.Generic.IDictionary<string, DscConfigurationParameter> parameters = default(System.Collections.Generic.IDictionary<string, DscConfigurationParameter>), string description = default(string))
