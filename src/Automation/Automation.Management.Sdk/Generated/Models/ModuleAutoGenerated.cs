...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class ModuleAutoGenerated : TrackedResourceAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the ModuleAutoGenerated class.
        /// </summary>
        public ModuleAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public ModuleAutoGenerated(string location, string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string etag = default(string), bool? isGlobal = default(bool?), string version = default(string), long? sizeInBytes = default(long?), int? activityCount = default(int?), string provisioningState = default(string), ContentLinkAutoGenerated contentLink = default(ContentLinkAutoGenerated), ModuleErrorInfoAutoGenerated error = default(ModuleErrorInfoAutoGenerated), System.DateTimeOffset? creationTime = default(System.DateTimeOffset?), System.DateTimeOffset? lastModifiedTime = default(System.DateTimeOffset?), string description = default(string), bool? isComposite = default(bool?))
