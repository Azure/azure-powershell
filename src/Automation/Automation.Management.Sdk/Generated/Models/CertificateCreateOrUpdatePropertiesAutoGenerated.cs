...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    /// </summary>
    public partial class CertificateCreateOrUpdatePropertiesAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the CertificateCreateOrUpdatePropertiesAutoGenerated class.
        /// </summary>
        public CertificateCreateOrUpdatePropertiesAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CertificateCreateOrUpdatePropertiesAutoGenerated(string base64Value, string description = default(string), string thumbprint = default(string), bool? isExportable = default(bool?))
