...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    /// </summary>
    public partial class SourceControlCreateOrUpdatePropertiesAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the SourceControlCreateOrUpdatePropertiesAutoGenerated class.
        /// </summary>
        public SourceControlCreateOrUpdatePropertiesAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public SourceControlCreateOrUpdatePropertiesAutoGenerated(string repoUrl = default(string), string branch = default(string), string folderPath = default(string), bool? autoSync = default(bool?), bool? publishRunbook = default(bool?), string sourceType = default(string), SourceControlSecurityTokenPropertiesAutoGenerated securityToken = default(SourceControlSecurityTokenPropertiesAutoGenerated), string description = default(string))
