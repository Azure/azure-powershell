...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class RunbookAutoGenerated : TrackedResourceAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the RunbookAutoGenerated class.
        /// </summary>
        public RunbookAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public RunbookAutoGenerated(string location, string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string etag = default(string), string runtimeEnvironment = default(string), string runbookType = default(string), ContentLinkAutoGenerated publishContentLink = default(ContentLinkAutoGenerated), string state = default(string), bool? logVerbose = default(bool?), bool? logProgress = default(bool?), int? logActivityTrace = default(int?), int? jobCount = default(int?), System.Collections.Generic.IDictionary<string, RunbookParameter> parameters = default(System.Collections.Generic.IDictionary<string, RunbookParameter>), System.Collections.Generic.IList<string> outputTypes = default(System.Collections.Generic.IList<string>), RunbookDraftAutoGenerated draft = default(RunbookDraftAutoGenerated), RunbookPropertiesProvisioningState? provisioningState = default(RunbookPropertiesProvisioningState?), string lastModifiedBy = default(string), System.DateTimeOffset? creationTime = default(System.DateTimeOffset?), System.DateTimeOffset? lastModifiedTime = default(System.DateTimeOffset?), string description = default(string))
