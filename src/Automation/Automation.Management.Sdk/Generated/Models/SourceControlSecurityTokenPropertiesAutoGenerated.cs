...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class SourceControlSecurityTokenPropertiesAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the SourceControlSecurityTokenPropertiesAutoGenerated class.
        /// </summary>
        public SourceControlSecurityTokenPropertiesAutoGenerated()
        {
            CustomInit();
        }
        ...
        public SourceControlSecurityTokenPropertiesAutoGenerated(string accessToken = default(string), string refreshToken = default(string), string tokenType = default(string))
