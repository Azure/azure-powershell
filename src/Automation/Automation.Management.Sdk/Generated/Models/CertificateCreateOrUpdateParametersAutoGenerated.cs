...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class CertificateCreateOrUpdateParametersAutoGenerated
    {
        /// <summary>
        /// Initializes a new instance of the CertificateCreateOrUpdateParametersAutoGenerated class.
        /// </summary>
        public CertificateCreateOrUpdateParametersAutoGenerated()
        {
            CustomInit();
        }
        ...
        /// </param>
        public CertificateCreateOrUpdateParametersAutoGenerated(string name, string base64Value, string description = default(string), string thumbprint = default(string), bool? isExportable = default(bool?))
