...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    /// </summary>
    public partial class SourceControlUpdateProperties
    {
        /// <summary>
        /// Initializes a new instance of the SourceControlUpdateProperties class.
        /// </summary>
        ...
        /// </param>
        public SourceControlUpdateProperties(string branch = default(string), string folderPath = default(string), bool? autoSync = default(bool?), bool? publishRunbook = default(bool?), SourceControlSecurityTokenProperties securityToken = default(SourceControlSecurityTokenProperties), string description = default(string))
