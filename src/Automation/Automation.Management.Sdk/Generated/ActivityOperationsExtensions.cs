...
namespace Microsoft.Azure.Management.Automation
{
    ...
    public static partial class ActivityOperationsExtensions
    {
        ...
        /// The module name.
        /// </param>
        public static Microsoft.Rest.Azure.IPage<ActivityAutoGenerated> ListByModule(this IActivityOperations operations, string resourceGroupName, string automationAccountName, string moduleName)
        {
                return ((IActivityOperations)operations).ListByModuleAsync(resourceGroupName, automationAccountName, moduleName).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<ActivityAutoGenerated>> ListByModuleAsync(this IActivityOperations operations, string resourceGroupName, string automationAccountName, string moduleName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.ListByModuleWithHttpMessagesAsync(resourceGroupName, automationAccountName, moduleName, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
        ...
        /// The name of activity.
        /// </param>
        public static ActivityAutoGenerated Get(this IActivityOperations operations, string resourceGroupName, string automationAccountName, string moduleName, string activityName)
        {
                return ((IActivityOperations)operations).GetAsync(resourceGroupName, automationAccountName, moduleName, activityName).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<ActivityAutoGenerated> GetAsync(this IActivityOperations operations, string resourceGroupName, string automationAccountName, string moduleName, string activityName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.GetWithHttpMessagesAsync(resourceGroupName, automationAccountName, moduleName, activityName, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
        ...
        /// The NextLink from the previous successful call to List operation.
        /// </param>
        public static Microsoft.Rest.Azure.IPage<ActivityAutoGenerated> ListByModuleNext(this IActivityOperations operations, string nextPageLink)
        {
                return ((IActivityOperations)operations).ListByModuleNextAsync(nextPageLink).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<ActivityAutoGenerated>> ListByModuleNextAsync(this IActivityOperations operations, string nextPageLink, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.ListByModuleNextWithHttpMessagesAsync(nextPageLink, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
