...
namespace Microsoft.Azure.Management.Automation
{
    ...
    public static partial class ConnectionOperationsExtensions
    {
        ...
        /// The name of the automation account.
        /// </param>
        public static Microsoft.Rest.Azure.IPage<ConnectionAutoGenerated> ListByAutomationAccount(this IConnectionOperations operations, string resourceGroupName, string automationAccountName)
        {
                return ((IConnectionOperations)operations).ListByAutomationAccountAsync(resourceGroupName, automationAccountName).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<ConnectionAutoGenerated>> ListByAutomationAccountAsync(this IConnectionOperations operations, string resourceGroupName, string automationAccountName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.ListByAutomationAccountWithHttpMessagesAsync(resourceGroupName, automationAccountName, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
        ...
        /// The name of connection.
        /// </param>
        public static ConnectionAutoGenerated Get(this IConnectionOperations operations, string resourceGroupName, string automationAccountName, string connectionName)
        {
                return ((IConnectionOperations)operations).GetAsync(resourceGroupName, automationAccountName, connectionName).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<ConnectionAutoGenerated> GetAsync(this IConnectionOperations operations, string resourceGroupName, string automationAccountName, string connectionName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.GetWithHttpMessagesAsync(resourceGroupName, automationAccountName, connectionName, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
        ...
        /// The name of connection.
        /// </param>
        public static ConnectionAutoGenerated CreateOrUpdate(this IConnectionOperations operations, string resourceGroupName, string automationAccountName, string connectionName, ConnectionCreateOrUpdateParameters parameters)
        {
                return ((IConnectionOperations)operations).CreateOrUpdateAsync(resourceGroupName, automationAccountName, connectionName, parameters).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<ConnectionAutoGenerated> CreateOrUpdateAsync(this IConnectionOperations operations, string resourceGroupName, string automationAccountName, string connectionName, ConnectionCreateOrUpdateParameters parameters, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.CreateOrUpdateWithHttpMessagesAsync(resourceGroupName, automationAccountName, connectionName, parameters, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
        ...
        /// The name of connection.
        /// </param>
        public static ConnectionAutoGenerated Update(this IConnectionOperations operations, string resourceGroupName, string automationAccountName, string connectionName, ConnectionUpdateParameters parameters)
        {
                return ((IConnectionOperations)operations).UpdateAsync(resourceGroupName, automationAccountName, connectionName, parameters).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<ConnectionAutoGenerated> UpdateAsync(this IConnectionOperations operations, string resourceGroupName, string automationAccountName, string connectionName, ConnectionUpdateParameters parameters, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.UpdateWithHttpMessagesAsync(resourceGroupName, automationAccountName, connectionName, parameters, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
        ...
        /// The NextLink from the previous successful call to List operation.
        /// </param>
        public static Microsoft.Rest.Azure.IPage<ConnectionAutoGenerated> ListByAutomationAccountNext(this IConnectionOperations operations, string nextPageLink)
        {
                return ((IConnectionOperations)operations).ListByAutomationAccountNextAsync(nextPageLink).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<ConnectionAutoGenerated>> ListByAutomationAccountNextAsync(this IConnectionOperations operations, string nextPageLink, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.ListByAutomationAccountNextWithHttpMessagesAsync(nextPageLink, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
