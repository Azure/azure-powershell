...
namespace Microsoft.Azure.Management.Automation
{
    ...
    public static partial class SourceControlSyncJobStreamsOperationsExtensions
    {
        ...
        /// The filter to apply on the operation.
        /// </param>
        public static Microsoft.Rest.Azure.IPage<SourceControlSyncJobStreamAutoGenerated> ListBySyncJob(this ISourceControlSyncJobStreamsOperations operations, string resourceGroupName, string automationAccountName, string sourceControlName, System.Guid sourceControlSyncJobId, string filter = default(string))
        {
                return ((ISourceControlSyncJobStreamsOperations)operations).ListBySyncJobAsync(resourceGroupName, automationAccountName, sourceControlName, sourceControlSyncJobId, filter).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<SourceControlSyncJobStreamAutoGenerated>> ListBySyncJobAsync(this ISourceControlSyncJobStreamsOperations operations, string resourceGroupName, string automationAccountName, string sourceControlName, System.Guid sourceControlSyncJobId, string filter = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.ListBySyncJobWithHttpMessagesAsync(resourceGroupName, automationAccountName, sourceControlName, sourceControlSyncJobId, filter, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
        ...
        /// The id of the sync job stream.
        /// </param>
        public static SourceControlSyncJobStreamByIdAutoGenerated Get(this ISourceControlSyncJobStreamsOperations operations, string resourceGroupName, string automationAccountName, string sourceControlName, System.Guid sourceControlSyncJobId, string streamId)
        {
                return ((ISourceControlSyncJobStreamsOperations)operations).GetAsync(resourceGroupName, automationAccountName, sourceControlName, sourceControlSyncJobId, streamId).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<SourceControlSyncJobStreamByIdAutoGenerated> GetAsync(this ISourceControlSyncJobStreamsOperations operations, string resourceGroupName, string automationAccountName, string sourceControlName, System.Guid sourceControlSyncJobId, string streamId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.GetWithHttpMessagesAsync(resourceGroupName, automationAccountName, sourceControlName, sourceControlSyncJobId, streamId, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
        ...
        /// The NextLink from the previous successful call to List operation.
        /// </param>
        public static Microsoft.Rest.Azure.IPage<SourceControlSyncJobStreamAutoGenerated> ListBySyncJobNext(this ISourceControlSyncJobStreamsOperations operations, string nextPageLink)
        {
                return ((ISourceControlSyncJobStreamsOperations)operations).ListBySyncJobNextAsync(nextPageLink).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<SourceControlSyncJobStreamAutoGenerated>> ListBySyncJobNextAsync(this ISourceControlSyncJobStreamsOperations operations, string nextPageLink, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.ListBySyncJobNextWithHttpMessagesAsync(nextPageLink, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
