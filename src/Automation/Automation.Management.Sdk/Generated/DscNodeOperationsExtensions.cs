...
namespace Microsoft.Azure.Management.Automation
{
    ...
    public static partial class DscNodeOperationsExtensions
    {
        ...
        /// Return total rows.
        /// </param>
        public static Microsoft.Rest.Azure.IPage<DscNodeAutoGenerated> ListByAutomationAccount(this IDscNodeOperations operations, string resourceGroupName, string automationAccountName, string filter = default(string), int? skip = default(int?), int? top = default(int?), string inlinecount = default(string))
        {
                return ((IDscNodeOperations)operations).ListByAutomationAccountAsync(resourceGroupName, automationAccountName, filter, skip, top, inlinecount).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<DscNodeAutoGenerated>> ListByAutomationAccountAsync(this IDscNodeOperations operations, string resourceGroupName, string automationAccountName, string filter = default(string), int? skip = default(int?), int? top = default(int?), string inlinecount = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// The node id.
        /// </param>
        public static DscNodeAutoGenerated Get(this IDscNodeOperations operations, string resourceGroupName, string automationAccountName, string nodeId)
        {
                return ((IDscNodeOperations)operations).GetAsync(resourceGroupName, automationAccountName, nodeId).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<DscNodeAutoGenerated> GetAsync(this IDscNodeOperations operations, string resourceGroupName, string automationAccountName, string nodeId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.GetWithHttpMessagesAsync(resourceGroupName, automationAccountName, nodeId, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
        ...
        /// The node id.
        /// </param>
        public static DscNodeAutoGenerated Update(this IDscNodeOperations operations, string resourceGroupName, string automationAccountName, string nodeId, DscNodeUpdateParametersAutoGenerated dscNodeUpdateParameters)
        {
                return ((IDscNodeOperations)operations).UpdateAsync(resourceGroupName, automationAccountName, nodeId, dscNodeUpdateParameters).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<DscNodeAutoGenerated> UpdateAsync(this IDscNodeOperations operations, string resourceGroupName, string automationAccountName, string nodeId, DscNodeUpdateParametersAutoGenerated dscNodeUpdateParameters, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.UpdateWithHttpMessagesAsync(resourceGroupName, automationAccountName, nodeId, dscNodeUpdateParameters, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
        ...
        /// The NextLink from the previous successful call to List operation.
        /// </param>
        public static Microsoft.Rest.Azure.IPage<DscNodeAutoGenerated> ListByAutomationAccountNext(this IDscNodeOperations operations, string nextPageLink)
        {
                return ((IDscNodeOperations)operations).ListByAutomationAccountNextAsync(nextPageLink).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<DscNodeAutoGenerated>> ListByAutomationAccountNextAsync(this IDscNodeOperations operations, string nextPageLink, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.ListByAutomationAccountNextWithHttpMessagesAsync(nextPageLink, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
