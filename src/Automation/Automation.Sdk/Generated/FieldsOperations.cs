...
namespace Microsoft.Azure.Management.Automation
{
    ...
    /// </summary>
    internal partial class FieldsOperations : IServiceOperations<AutomationClient>, IFieldsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<TypeField>>> ListByTypeWithHttpMessagesAsync(string resourceGroupName, string automationAccountName, string moduleName, string typeName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<TypeField>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page1<TypeField>>(_responseContent, Client.DeserializationSettings);
                }
