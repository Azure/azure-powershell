...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class DscConfigurationCreateOrUpdateParameters
    {
        ...
        /// </param>
        public DscConfigurationCreateOrUpdateParameters(ContentSource source, string name = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), bool? logVerbose = default(bool?), bool? logProgress = default(bool?), System.Collections.Generic.IDictionary<string, DscConfigurationParameter> parameters = default(System.Collections.Generic.IDictionary<string, DscConfigurationParameter>), string description = default(string))
