...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class DscNodeExtensionHandlerAssociationProperty
    {
        ...
        /// <param name="name">Gets or sets the name of the extension handler.
        /// </param>

        /// <param name="version">Gets or sets the version of the extension handler.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets gets or sets the name of the extension handler.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "name")]
        public string Name {get; set; }

        /// <summary>
        /// Gets or sets gets or sets the version of the extension handler.
        /// </summary>
