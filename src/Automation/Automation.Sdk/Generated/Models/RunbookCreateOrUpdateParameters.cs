...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class RunbookCreateOrUpdateParameters
    {
        ...
        /// </param>
        public RunbookCreateOrUpdateParameters(string runbookType, string name = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), bool? logVerbose = default(bool?), bool? logProgress = default(bool?), RunbookDraft draft = default(RunbookDraft), ContentLink publishContentLink = default(ContentLink), string description = default(string), int? logActivityTrace = default(int?))
