...
```powershell
Start-AzAutomationRunbook -AutomationAccountName "Contoso17" -Name "RunbkPy01" -ResourceGroupName "ResourceGroup01" -Parameters [ordered]@{"Key1"="ValueForPosition1";"Key2"="ValueForPosition2"}
```
