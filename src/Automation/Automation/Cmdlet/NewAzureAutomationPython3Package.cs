...
namespace Microsoft.Azure.Commands.Automation.Cmdlet
{
    ...
    [Alias("Import-" + ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "AutomationPython3Package")]
    class NewAzureAutomationPython3Package : AzureAutomationBaseCmdlet
    {
        /// <summary>
