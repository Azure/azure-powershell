...
namespace Microsoft.Azure.Commands.Automation.Cmdlet
{
    ...
    /// </summary>
    [Cmdlet("Update", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "AutomationPython3package", DefaultParameterSetName = AutomationCmdletParameterSets.ByName, SupportsShouldProcess = true)]
    ...
    public class UpdateAzureAutomationPython3Package : AzureAutomationBaseCmdlet
    {
        ...
        [Parameter(ParameterSetName = AutomationCmdletParameterSets.ByName, Mandatory = true, Position = 2, ValueFromPipelineByPropertyName = true,
            HelpMessage = "The Python 3 package name.")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true,
            HelpMessage = "The url to python 3  package.")]
        [Alias("ContentLink")]
