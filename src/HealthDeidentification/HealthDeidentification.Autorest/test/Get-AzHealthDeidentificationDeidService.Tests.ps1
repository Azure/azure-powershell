if(($null -eq $TestName) -or ($TestName -contains 'Get-AzHealthDeidentificationDeidService'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Get-AzHealthDeidentificationDeidService.Recording.json'
