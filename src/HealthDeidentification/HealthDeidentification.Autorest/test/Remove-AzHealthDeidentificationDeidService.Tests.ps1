if(($null -eq $TestName) -or ($TestName -contains 'Remove-AzHealthDeidentificationDeidService'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Remove-AzHealthDeidentificationDeidService.Recording.json'
