...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.HealthDeidentification.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.HealthDeidentification.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: HealthDeidentification cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.HealthDeidentification.format.ps1xml'
