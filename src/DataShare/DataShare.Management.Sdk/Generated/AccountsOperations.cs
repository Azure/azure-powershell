...
namespace Microsoft.Azure.Management.DataShare
{
    ...
    /// </summary>
    internal partial class AccountsOperations : Microsoft.Rest.IServiceOperations<DataShareManagementClient>, IAccountsOperations
    {
        /// <summary>
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<OperationResponse> _response = await BeginDeleteWithHttpMessagesAsync(resourceGroupName, accountName, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Account>> UpdateWithHttpMessagesAsync(string resourceGroupName, string accountName, AccountUpdateParameters accountUpdateParameters, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "accountUpdateParameters");
            }
            if (this.Client.SubscriptionId == null)
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
            ...
            if(accountUpdateParameters != null)
            {
                _requestContent = Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(accountUpdateParameters, this.Client.SerializationSettings);
