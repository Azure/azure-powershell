...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the BlobFolderProperties class.
        /// </summary>
        ...
        /// <param name="prefix">Prefix for blob folder
        /// </param>
        ...
        /// </param>
        public BlobFolderProperties(string containerName, string prefix, string resourceGroup, string storageAccountName, string subscriptionId, string dataSetId = default(string))
