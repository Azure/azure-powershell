...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    public partial class KustoClusterDataSetMapping : DataSetMapping
    {
        /// <summary>
        ...
        /// </param>
        public KustoClusterDataSetMapping(string dataSetId, string kustoClusterResourceId, string id = default(string), string name = default(string), string type = default(string), string provisioningState = default(string), string dataSetMappingStatus = default(string), string location = default(string))
