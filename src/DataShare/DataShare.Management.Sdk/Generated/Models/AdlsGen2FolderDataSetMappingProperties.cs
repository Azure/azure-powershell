...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the AdlsGen2FolderDataSetMappingProperties class.
        /// </summary>
        ...
        /// </param>
        public AdlsGen2FolderDataSetMappingProperties(string dataSetId, string fileSystem, string folderPath, string resourceGroup, string storageAccountName, string subscriptionId, string dataSetMappingStatus = default(string), string provisioningState = default(string))
