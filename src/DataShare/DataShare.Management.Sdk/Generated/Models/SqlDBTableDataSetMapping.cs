...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    public partial class SqlDBTableDataSetMapping : DataSetMapping
    {
        ...
        /// </param>
        public SqlDBTableDataSetMapping(string databaseName, string dataSetId, string schemaName, string sqlServerResourceId, string tableName, string id = default(string), string name = default(string), string type = default(string), string provisioningState = default(string), string dataSetMappingStatus = default(string))
