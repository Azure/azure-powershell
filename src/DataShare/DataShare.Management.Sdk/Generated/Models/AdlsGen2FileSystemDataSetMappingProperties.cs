...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the AdlsGen2FileSystemDataSetMappingProperties class.
        /// </summary>
        ...
        /// </param>
        public AdlsGen2FileSystemDataSetMappingProperties(string dataSetId, string fileSystem, string resourceGroup, string storageAccountName, string subscriptionId, string dataSetMappingStatus = default(string), string provisioningState = default(string))
