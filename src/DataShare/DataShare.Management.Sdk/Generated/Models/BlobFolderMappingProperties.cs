...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the BlobFolderMappingProperties class.
        /// </summary>
        ...
        /// </param>
        public BlobFolderMappingProperties(string containerName, string dataSetId, string prefix, string resourceGroup, string storageAccountName, string subscriptionId, string dataSetMappingStatus = default(string), string provisioningState = default(string))
