...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    /// </summary>
    public partial class BlobContainerMappingProperties
    {
        /// <summary>
        /// Initializes a new instance of the BlobContainerMappingProperties class.
        /// </summary>
        ...
        /// <param name="containerName">BLOB Container name.
        /// </param>
        ...
        /// </param>
        public BlobContainerMappingProperties(string containerName, string dataSetId, string resourceGroup, string storageAccountName, string subscriptionId, string dataSetMappingStatus = default(string), string provisioningState = default(string))
