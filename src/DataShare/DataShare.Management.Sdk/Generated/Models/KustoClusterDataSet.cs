...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    public partial class KustoClusterDataSet : DataSet
    {
        ...
        /// </param>
        public KustoClusterDataSet(string kustoClusterResourceId, string id = default(string), string name = default(string), string type = default(string), string provisioningState = default(string), string dataSetId = default(string), string location = default(string))
