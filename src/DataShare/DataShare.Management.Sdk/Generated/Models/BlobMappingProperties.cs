...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the BlobMappingProperties class.
        /// </summary>
        ...
        /// </param>
        public BlobMappingProperties(string containerName, string dataSetId, string filePath, string resourceGroup, string storageAccountName, string subscriptionId, string dataSetMappingStatus = default(string), string outputType = default(string), string provisioningState = default(string))
