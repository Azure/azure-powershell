...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    public partial class BlobDataSetMapping : DataSetMapping
    {
        ...
        /// <param name="outputType">File output type
        ...
        /// </param>
        public BlobDataSetMapping(string containerName, string dataSetId, string filePath, string resourceGroup, string storageAccountName, string subscriptionId, string id = default(string), string name = default(string), string type = default(string), string outputType = default(string), string provisioningState = default(string), string dataSetMappingStatus = default(string))
        ...
        /// <summary>
        /// Gets or sets file output type Possible values include: &#39;Csv&#39;, &#39;Parquet&#39;
        /// </summary>
