...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ShareSubscriptionProperties class.
        /// </summary>
        ...
        /// </param>
        public ShareSubscriptionProperties(string invitationId, string sourceShareLocation, System.DateTime? createdAt = default(System.DateTime?), string providerEmail = default(string), string providerName = default(string), string providerTenantName = default(string), string provisioningState = default(string), string shareDescription = default(string), string shareKind = default(string), string shareName = default(string), string shareSubscriptionStatus = default(string), string shareTerms = default(string), string userEmail = default(string), string userName = default(string))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "shareDescription")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "shareTerms")]
        public string ShareTerms {get; private set; }

        /// <summary>
        /// Gets or sets source share location.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "sourceShareLocation")]
