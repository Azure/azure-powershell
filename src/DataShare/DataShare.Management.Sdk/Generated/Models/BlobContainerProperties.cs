...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    public partial class BlobContainerProperties
    {
        ...
        /// </param>
        public BlobContainerProperties(string containerName, string resourceGroup, string storageAccountName, string subscriptionId, string dataSetId = default(string))
