...
online version: https://learn.microsoft.com/powershell/module/az.resiliencemanagement/start-azresiliencemanagementdrillrunfailover
schema: 2.0.0
---

# Start-AzResilienceManagementDrillRunFailover
...
```
Start-AzResilienceManagementDrillRunFailover -DrillName <String> -DrillRunName <String>
...
### TriggerViaIdentity
```
Start-AzResilienceManagementDrillRunFailover -InputObject <IResilienceManagementIdentity>
...
```
Start-AzResilienceManagementDrillRunFailover -DrillInputObject <IResilienceManagementIdentity>
