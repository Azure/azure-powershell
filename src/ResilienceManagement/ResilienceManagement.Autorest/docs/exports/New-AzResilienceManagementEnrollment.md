...
```
New-AzResilienceManagementEnrollment -Name <String> -ResourceGroupName <String> -UsagePlanName <String>
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded, CreateViaIdentityUsagePlanExpanded
Aliases:
...
Parameter Sets: CreateViaIdentityUsagePlanExpanded
Aliases:
