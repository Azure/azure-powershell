...
online version: https://learn.microsoft.com/powershell/module/az.resiliencemanagement/start-azresiliencemanagementrecoveryplanreprotect
schema: 2.0.0
---

# Start-AzResilienceManagementRecoveryPlanReprotect
...
```
Start-AzResilienceManagementRecoveryPlanReprotect -RecoveryPlanName <String> -ServiceGroupName <String>
...
### TriggerViaIdentity
```
Start-AzResilienceManagementRecoveryPlanReprotect -InputObject <IResilienceManagementIdentity>
 -OperationId <String> -Body <IReprotectRequest> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
```
Start-AzResilienceManagementRecoveryPlanReprotect -RecoveryPlanName <String>
