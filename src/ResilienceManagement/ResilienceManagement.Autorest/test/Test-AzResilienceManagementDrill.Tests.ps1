if(($null -eq $TestName) -or ($TestName -contains 'Test-AzResilienceManagementDrill'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Test-AzResilienceManagementDrill.Recording.json'
...
Describe 'Test-AzResilienceManagementDrill' {
