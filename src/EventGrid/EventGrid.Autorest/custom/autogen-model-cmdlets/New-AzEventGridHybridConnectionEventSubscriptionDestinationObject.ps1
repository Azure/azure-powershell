...
function New-AzEventGridHybridConnectionEventSubscriptionDestinationObject {
    ...
    Param(
        ...
        [Parameter(HelpMessage="The Azure Resource ID of an hybrid connection that is the destination of an event subscription.")]
        [string]
        $ResourceId
    )

    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.HybridConnectionEventSubscriptionDestination]::New()
