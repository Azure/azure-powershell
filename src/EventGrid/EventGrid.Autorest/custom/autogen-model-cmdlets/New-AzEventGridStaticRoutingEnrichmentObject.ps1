...
function New-AzEventGridStaticRoutingEnrichmentObject {
    ...
    Param(
        ...
        [Parameter(HelpMessage="Static routing enrichment key.")]
        [string]
        $Key,
        [Parameter(HelpMessage="Static routing enrichment value type. For e.g. this property value can be 'String'.")]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.StaticRoutingEnrichment]::New()
