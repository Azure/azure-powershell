...
function New-AzEventGridEventHubEventSubscriptionDestinationObject {
    ...
    Param(
        ...
        [Parameter(HelpMessage="The Azure Resource Id that represents the endpoint of an Event Hub destination of an event subscription.")]
        [string]
        $ResourceId
    )

    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.EventHubEventSubscriptionDestination]::New()
