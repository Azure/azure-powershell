...
function New-AzEventGridDynamicRoutingEnrichmentObject {
    ...
    Param(
        ...
        [Parameter(HelpMessage="Dynamic routing enrichment key.")]
        [string]
        $Key,
        [Parameter(HelpMessage="Dynamic routing enrichment value.")]
        [string]
        $Value
    )

    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.DynamicRoutingEnrichment]::New()
