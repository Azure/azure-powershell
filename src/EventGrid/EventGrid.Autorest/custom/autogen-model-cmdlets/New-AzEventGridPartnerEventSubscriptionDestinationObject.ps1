...
function New-AzEventGridPartnerEventSubscriptionDestinationObject {
    ...
    Param(
        ...
        [Parameter(HelpMessage="The Azure Resource Id that represents the endpoint of a Partner Destination of an event subscription.")]
        [string]
        $ResourceId
    )

    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.PartnerEventSubscriptionDestination]::New()
