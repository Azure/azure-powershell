...
PARTNERTOPICINPUTOBJECT <IEventGridIdentity>: Identity Parameter
  ...
  [VerifiedPartnerName <String>]: Name of the verified partner.
.Link
https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridpartnertopiceventsubscriptionfullurl
#>
...
begin {
    try {
        ...
        $mapping = @{
            ...
            GetViaIdentityPartnerTopic = 'Az.EventGrid.private\Get-AzEventGridPartnerTopicEventSubscriptionFullUrl_GetViaIdentityPartnerTopic';
        }
