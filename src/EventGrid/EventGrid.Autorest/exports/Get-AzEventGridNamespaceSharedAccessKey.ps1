...
.Link
https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridnamespacesharedaccesskey
#>
function Get-AzEventGridNamespaceSharedAccessKey {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.EventGrid.private\Get-AzEventGridNamespaceSharedAccessKey_List';
        }
