...
.Link
https://learn.microsoft.com/powershell/module/az.eventgrid/new-azeventgrideventsubscription
#>
...
begin {
    try {
        ...
        $mapping = @{
            ...
            CreateViaIdentityExpanded = 'Az.EventGrid.private\New-AzEventGridEventSubscription_CreateViaIdentityExpanded';
            CreateViaJsonFilePath = 'Az.EventGrid.private\New-AzEventGridEventSubscription_CreateViaJsonFilePath';
            CreateViaJsonString = 'Az.EventGrid.private\New-AzEventGridEventSubscription_CreateViaJsonString';
        }
