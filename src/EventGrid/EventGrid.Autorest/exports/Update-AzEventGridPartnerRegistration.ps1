...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IPartnerRegistrationUpdateParametersTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            UpdateViaJsonFilePath = 'Az.EventGrid.private\Update-AzEventGridPartnerRegistration_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.EventGrid.private\Update-AzEventGridPartnerRegistration_UpdateViaJsonString';
        }
