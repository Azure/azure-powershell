...
.Link
https://learn.microsoft.com/powershell/module/az.eventgrid/enable-azeventgridpartnerconfiguration
#>
function Enable-AzEventGridPartnerConfiguration {
...
begin {
    try {
        ...
        $mapping = @{
            Authorize = 'Az.EventGrid.private\Enable-AzEventGridPartnerConfiguration_Authorize';
            AuthorizeExpanded = 'Az.EventGrid.private\Enable-AzEventGridPartnerConfiguration_AuthorizeExpanded';
            AuthorizeViaJsonFilePath = 'Az.EventGrid.private\Enable-AzEventGridPartnerConfiguration_AuthorizeViaJsonFilePath';
            AuthorizeViaJsonString = 'Az.EventGrid.private\Enable-AzEventGridPartnerConfiguration_AuthorizeViaJsonString';
        }
