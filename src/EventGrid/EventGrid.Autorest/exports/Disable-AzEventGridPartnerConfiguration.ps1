...
.Link
https://learn.microsoft.com/powershell/module/az.eventgrid/disable-azeventgridpartnerconfiguration
#>
function Disable-AzEventGridPartnerConfiguration {
...
begin {
    try {
        ...
        $mapping = @{
            Partner = 'Az.EventGrid.private\Disable-AzEventGridPartnerConfiguration_Partner';
            PartnerExpanded = 'Az.EventGrid.private\Disable-AzEventGridPartnerConfiguration_PartnerExpanded';
            PartnerViaJsonFilePath = 'Az.EventGrid.private\Disable-AzEventGridPartnerConfiguration_PartnerViaJsonFilePath';
            PartnerViaJsonString = 'Az.EventGrid.private\Disable-AzEventGridPartnerConfiguration_PartnerViaJsonString';
        }
