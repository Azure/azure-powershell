...
Update-AzEventGridEventSubscription -Name azps-eventsub -Scope "subscriptions/XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX" -Destination $obj -FilterIsSubjectCaseSensitive:$false
...
.Link
https://learn.microsoft.com/powershell/module/az.eventgrid/update-azeventgrideventsubscription
#>
...
begin {
    try {
        ...
        $mapping = @{
            ...
            UpdateViaJsonFilePath = 'Az.EventGrid.private\Update-AzEventGridEventSubscription_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.EventGrid.private\Update-AzEventGridEventSubscription_UpdateViaJsonString';
        }
