...
.Link
https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridnamespacetopicsharedaccesskey
#>
function Get-AzEventGridNamespaceTopicSharedAccessKey {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.EventGrid.private\Get-AzEventGridNamespaceTopicSharedAccessKey_List';
        }
