...
List the two keys used to publish to a partner namespace.
.Example
Get-AzEventGridPartnerNamespaceSharedAccessKey -PartnerNamespaceName azps-partnernamespace -ResourceGroupName azps_test_group_eventgrid

.Outputs
Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IPartnerNamespaceSharedAccessKeys
.Link
https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridpartnernamespacesharedaccesskey
#>
