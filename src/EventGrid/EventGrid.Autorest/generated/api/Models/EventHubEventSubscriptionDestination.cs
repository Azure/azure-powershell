...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models
{
    ...
    public partial class EventHubEventSubscriptionDestination :
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IEventHubEventSubscriptionDestination,
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IEventHubEventSubscriptionDestinationInternal,
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IValidates
    {
        ...
        public string EndpointType { get => "EventHub"; set => ((Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IEventSubscriptionDestinationInternal)__eventSubscriptionDestination).EndpointType = "EventHub"; }

        /// <summary>Internal Acessors for Property</summary>
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IEventHubEventSubscriptionDestinationProperties Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IEventHubEventSubscriptionDestinationInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.EventHubEventSubscriptionDestinationProperties()); set { {_property = value;} } }

        /// <summary>Backing field for <see cref="Property" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IEventHubEventSubscriptionDestinationProperties _property;

        /// <summary>Event Hub Properties of the event subscription destination.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Origin(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IEventHubEventSubscriptionDestinationProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.EventHubEventSubscriptionDestinationProperties()); set => this._property = value; }

        /// <summary>
        /// The Azure Resource Id that represents the endpoint of an Event Hub destination of an event subscription.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Origin(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.PropertyOrigin.Inlined)]
        public string ResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IEventHubEventSubscriptionDestinationPropertiesInternal)Property).ResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IEventHubEventSubscriptionDestinationPropertiesInternal)Property).ResourceId = value ?? null; }
        ...
        {
            this.__eventSubscriptionDestination.EndpointType = "EventHub";
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IEventSubscriptionDestinationInternal
    {
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IDeliveryAttributeMapping> DeliveryAttributeMapping { get; set; }
        /// <summary>Event Hub Properties of the event subscription destination.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IEventHubEventSubscriptionDestinationProperties Property { get; set; }
        /// <summary>
        /// The Azure Resource Id that represents the endpoint of an Event Hub destination of an event subscription.
        /// </summary>
        string ResourceId { get; set; }
