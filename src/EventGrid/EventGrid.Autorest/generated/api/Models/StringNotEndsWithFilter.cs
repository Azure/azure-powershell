...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models
{
    ...
    public partial class StringNotEndsWithFilter :
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IStringNotEndsWithFilter,
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IStringNotEndsWithFilterInternal,
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IValidates
    {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Origin(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.PropertyOrigin.Inherited)]
        public string OperatorType { get => "StringNotEndsWith"; set => ((Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IFilterInternal)__filter).OperatorType = "StringNotEndsWith"; }
        ...
        /// <summary>Creates an new <see cref="StringNotEndsWithFilter" /> instance.</summary>
        public StringNotEndsWithFilter()
        {
            this.__filter.OperatorType = "StringNotEndsWith";
        }
    ...
    public partial interface IStringNotEndsWithFilter :
    ...
    /// StringNotEndsWith Filter.
    internal partial interface IStringNotEndsWithFilterInternal :
