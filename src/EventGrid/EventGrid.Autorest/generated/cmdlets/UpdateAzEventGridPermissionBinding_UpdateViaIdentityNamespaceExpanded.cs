...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/namespaces/{namespaceName}/permissionBindings/{permissionBindingName}"
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzEventGridPermissionBinding_UpdateViaIdentityNamespaceExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Description(@"update a permission binding with the specified parameters.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Generated]
    public partial class UpdateAzEventGridPermissionBinding_UpdateViaIdentityNamespaceExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IPermissionBinding _permissionBindingInfoBody = new Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.PermissionBinding();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The name of the client group resource that the permission is bound to.The client group needs to be a resource under the same namespace the permission binding is a part of.")]
        ...
        Required = false,
        ReadOnly = false,
        Description = @"The name of the client group resource that the permission is bound to.The client group needs to be a resource under the same namespace the permission binding is a part of.",
        SerializedName = @"clientGroupName",
        PossibleTypes = new [] { typeof(string) })]
        public string ClientGroupName { get => _permissionBindingInfoBody.ClientGroupName ?? null; set => _permissionBindingInfoBody.ClientGroupName = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Description for the Permission Binding resource.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Description { get => _permissionBindingInfoBody.Description ?? null; set => _permissionBindingInfoBody.Description = value; }
        ...
        /// <summary>The permission binding name.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The permission binding name.")]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("PermissionBindingName")]
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IEventGridIdentity _namespaceInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IEventGridIdentity NamespaceInputObject { get => this._namespaceInputObject; set => this._namespaceInputObject = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The allowed permission.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string Permission { get => _permissionBindingInfoBody.Permission ?? null; set => _permissionBindingInfoBody.Permission = value; }
        ...
        /// same namespace the permission binding is a part of.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The name of the Topic Space resource that the permission is bound to.The Topic space needs to be a resource under the same namespace the permission binding is a part of.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"The name of the Topic Space resource that the permission is bound to.The Topic space needs to be a resource under the same namespace the permission binding is a part of.",
        SerializedName = @"topicSpaceName",
        PossibleTypes = new [] { typeof(string) })]
        public string TopicSpaceName { get => _permissionBindingInfoBody.TopicSpaceName ?? null; set => _permissionBindingInfoBody.TopicSpaceName = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IPermissionBinding">Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IPermissionBinding</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IPermissionBinding> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzEventGridPermissionBinding_UpdateViaIdentityNamespaceExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets.UpdateAzEventGridPermissionBinding_UpdateViaIdentityNamespaceExpanded Clone()
        {
            var clone = new UpdateAzEventGridPermissionBinding_UpdateViaIdentityNamespaceExpanded();
            ...
            clone._permissionBindingInfoBody = this._permissionBindingInfoBody;
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PermissionBindingsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.NamespaceInputObject.Id += $"/permissionBindings/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        _permissionBindingInfoBody = await this.Client.PermissionBindingsGetViaIdentityWithResult(NamespaceInputObject.Id, this, Pipeline);
                        this.Update_permissionBindingInfoBody();
                        await this.Client.PermissionBindingsCreateOrUpdateViaIdentity(NamespaceInputObject.Id, _permissionBindingInfoBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _permissionBindingInfoBody = await this.Client.PermissionBindingsGetWithResult(NamespaceInputObject.SubscriptionId ?? null, NamespaceInputObject.ResourceGroupName ?? null, NamespaceInputObject.NamespaceName ?? null, Name, this, Pipeline);
                        this.Update_permissionBindingInfoBody();
                        await this.Client.PermissionBindingsCreateOrUpdate(NamespaceInputObject.SubscriptionId ?? null, NamespaceInputObject.ResourceGroupName ?? null, NamespaceInputObject.NamespaceName ?? null, Name, _permissionBindingInfoBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzEventGridPermissionBinding_UpdateViaIdentityNamespaceExpanded" />
        /// cmdlet class.
        /// </summary>
        public UpdateAzEventGridPermissionBinding_UpdateViaIdentityNamespaceExpanded()
        {

        }

        private void Update_permissionBindingInfoBody()
        {
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("TopicSpaceName")))
            {
                this.TopicSpaceName = (string)(this.MyInvocation?.BoundParameters["TopicSpaceName"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Permission")))
            {
                this.Permission = (string)(this.MyInvocation?.BoundParameters["Permission"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ClientGroupName")))
            {
                this.ClientGroupName = (string)(this.MyInvocation?.BoundParameters["ClientGroupName"]);
            }
        }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IPermissionBinding> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IPermissionBinding
