            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (NamespaceInputObject?.Id != null)
                    {
                        ...
                        await this.Client.PermissionBindingsCreateOrUpdateViaIdentity(NamespaceInputObject.Id, _permissionBindingInfoBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
