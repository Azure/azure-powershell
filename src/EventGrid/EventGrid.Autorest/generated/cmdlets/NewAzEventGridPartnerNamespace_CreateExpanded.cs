...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/partnerNamespaces/{partnerNamespaceName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzEventGridPartnerNamespace_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IPartnerNamespace))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Description(@"Asynchronously creates a new partner namespace with the specified parameters.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/partnerNamespaces/{partnerNamespaceName}", ApiVersion = "2023-06-01-preview")]
    public partial class NewAzEventGridPartnerNamespace_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IPartnerNamespace _partnerNamespaceInfoBody = new Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.PartnerNamespace();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "This boolean is used to enable or disable local auth. Default value is false. When the property is set to true, only AAD token will be used to authenticate if user is allowed to publish to the partner namespace.")]
        ...
        public global::System.Management.Automation.SwitchParameter DisableLocalAuth { get => _partnerNamespaceInfoBody.DisableLocalAuth ?? default(global::System.Management.Automation.SwitchParameter); set => _partnerNamespaceInfoBody.DisableLocalAuth = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IInboundIPRule[] InboundIPRule { get => _partnerNamespaceInfoBody.InboundIPRule?.ToArray() ?? null /* fixedArrayOf */; set => _partnerNamespaceInfoBody.InboundIPRule = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IInboundIPRule>(value) : null); }
        ...
        public string Location { get => _partnerNamespaceInfoBody.Location ?? null; set => _partnerNamespaceInfoBody.Location = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Minimum TLS version of the publisher allowed to publish to this partner namespace")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string MinimumTlsVersionAllowed { get => _partnerNamespaceInfoBody.MinimumTlsVersionAllowed ?? null; set => _partnerNamespaceInfoBody.MinimumTlsVersionAllowed = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("PartnerNamespaceName")]
        ...
        /// the following format:/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/partnerRegistrations/{partnerRegistrationName}.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The fully qualified ARM Id of the partner registration that should be associated with this partner namespace. This takes the following format:/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/partnerRegistrations/{partnerRegistrationName}.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string PartnerRegistrationFullyQualifiedId { get => _partnerNamespaceInfoBody.PartnerRegistrationFullyQualifiedId ?? null; set => _partnerNamespaceInfoBody.PartnerRegistrationFullyQualifiedId = value; }

        /// <summary>
        /// This determines if events published to this partner namespace should use the source attribute in the event payloador use
        /// the channel name in the header when matching to the partner topic. If none is specified, source attribute routing will
        /// be used to match the partner topic.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "This determines if events published to this partner namespace should use the source attribute in the event payloador use the channel name in the header when matching to the partner topic. If none is specified, source attribute routing will be used to match the partner topic.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"This determines if events published to this partner namespace should use the source attribute in the event payloador use the channel name in the header when matching to the partner topic. If none is specified, source attribute routing will be used to match the partner topic.",
        ...
        public string PartnerTopicRoutingMode { get => _partnerNamespaceInfoBody.PartnerTopicRoutingMode ?? null; set => _partnerNamespaceInfoBody.PartnerTopicRoutingMode = value; }
        ...
        /// IPs by configuring <seealso cref="P:Microsoft.Azure.Events.ResourceProvider.Common.Contracts.PartnerNamespaceProperties.InboundIpRules"
        /// />
        /// </summary>
        ...
        Required = false,
        ReadOnly = false,
        Description = @"This determines if traffic is allowed over public network. By default it is enabled.You can further restrict to specific IPs by configuring <seealso cref=""P:Microsoft.Azure.Events.ResourceProvider.Common.Contracts.PartnerNamespaceProperties.InboundIpRules"" />",
        SerializedName = @"publicNetworkAccess",
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.PSArgumentCompleterAttribute("Enabled", "Disabled")]
        public string PublicNetworkAccess { get => _partnerNamespaceInfoBody.PublicNetworkAccess ?? null; set => _partnerNamespaceInfoBody.PublicNetworkAccess = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.ITrackedResourceTags Tag { get => _partnerNamespaceInfoBody.Tag ?? null /* object */; set => _partnerNamespaceInfoBody.Tag = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IPartnerNamespace">Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IPartnerNamespace</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IPartnerNamespace> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzEventGridPartnerNamespace_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets.NewAzEventGridPartnerNamespace_CreateExpanded Clone()
        {
            var clone = new NewAzEventGridPartnerNamespace_CreateExpanded();
            ...
            clone._partnerNamespaceInfoBody = this._partnerNamespaceInfoBody;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzEventGridPartnerNamespace_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzEventGridPartnerNamespace_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PartnerNamespacesCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PartnerNamespacesCreateOrUpdate(SubscriptionId, ResourceGroupName, Name, _partnerNamespaceInfoBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeCreate);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IPartnerNamespace> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IPartnerNamespace
