            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (NamespaceInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ClientGroupsCreateOrUpdateViaIdentity(NamespaceInputObject.Id, _clientGroupInfoBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
