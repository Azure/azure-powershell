...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzEventGridChannel_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzEventGridChannel_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IChannelUpdateParameters _channelUpdateParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.ChannelUpdateParameters();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IEventTypeInfoInlineEventTypes EventTypeInfoInlineEventType { get => _channelUpdateParametersBody.EventTypeInfoInlineEventType ?? null /* object */; set => _channelUpdateParametersBody.EventTypeInfoInlineEventType = value; }
        ...
        public string EventTypeInfoKind { get => _channelUpdateParametersBody.EventTypeInfoKind ?? null; set => _channelUpdateParametersBody.EventTypeInfoKind = value; }

        /// <summary>
        /// Expiration time of the channel. If this timer expires while the corresponding partner topic or partner destination is
        /// never activated,the channel and corresponding partner topic or partner destination are deleted.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Expiration time of the channel. If this timer expires while the corresponding partner topic or partner destination is never activated,the channel and corresponding partner topic or partner destination are deleted.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Expiration time of the channel. If this timer expires while the corresponding partner topic or partner destination is never activated,the channel and corresponding partner topic or partner destination are deleted.",
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ChannelsUpdateViaIdentity(InputObject.Id, _channelUpdateParametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.PartnerNamespaceName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.PartnerNamespaceName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        if (null == InputObject.ChannelName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.ChannelName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.ChannelsUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.PartnerNamespaceName ?? null, InputObject.ChannelName ?? null, _channelUpdateParametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzEventGridChannel_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzEventGridChannel_UpdateViaIdentityExpanded()
        {
