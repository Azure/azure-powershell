...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/partnerTopics/{partnerTopicName}"
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IContext
    {
        ...
        {
            bool supportsSystemAssignedIdentity = (true == this.EnableSystemAssignedIdentity || null == this.EnableSystemAssignedIdentity && true == _partnerTopicInfoBody?.IdentityType?.Contains("SystemAssigned"));
            ...
            supportsUserAssignedIdentity = true == this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && this.UserAssignedIdentity?.Length > 0 ||
                    true != this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && true == _partnerTopicInfoBody.IdentityType?.Contains("UserAssigned");
            if (!supportsUserAssignedIdentity)
            {
                _partnerTopicInfoBody.IdentityUserAssignedIdentity = null;
            }
            ...
            {
                _partnerTopicInfoBody.IdentityType = "SystemAssigned";
            }
            else
            {
                _partnerTopicInfoBody.IdentityType = "None";
            }
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _partnerTopicInfoBody = await this.Client.PartnerTopicsGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_partnerTopicInfoBody();
                        await this.Client.PartnerTopicsCreateOrUpdateViaIdentity(InputObject.Id, _partnerTopicInfoBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _partnerTopicInfoBody = await this.Client.PartnerTopicsGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.PartnerTopicName ?? null, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_partnerTopicInfoBody();
                        await this.Client.PartnerTopicsCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.PartnerTopicName ?? null, _partnerTopicInfoBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzEventGridPartnerTopic_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        ...
        private void Update_partnerTopicInfoBody()
        {
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("PartnerRegistrationImmutableId")))
            {
                this.PartnerRegistrationImmutableId = (string)(this.MyInvocation?.BoundParameters["PartnerRegistrationImmutableId"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Source")))
            {
                this.Source = (string)(this.MyInvocation?.BoundParameters["Source"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ExpirationTimeIfNotActivatedUtc")))
            {
                this.ExpirationTimeIfNotActivatedUtc = (global::System.DateTime)(this.MyInvocation?.BoundParameters["ExpirationTimeIfNotActivatedUtc"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ActivationState")))
            {
                this.ActivationState = (string)(this.MyInvocation?.BoundParameters["ActivationState"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("PartnerTopicFriendlyDescription")))
            {
                this.PartnerTopicFriendlyDescription = (string)(this.MyInvocation?.BoundParameters["PartnerTopicFriendlyDescription"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("MessageForActivation")))
            {
                this.MessageForActivation = (string)(this.MyInvocation?.BoundParameters["MessageForActivation"]);
            }
