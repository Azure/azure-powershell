...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets
{
    ...
    /// <summary>Create a topic space with the specified parameters.</summary>
    /// <remarks>
    ...
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/namespaces/{namespaceName}/topicSpaces/{topicSpaceName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzEventGridTopicSpace_UpdateViaIdentityNamespaceExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.ITopicSpace))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Description(@"Create a topic space with the specified parameters.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Generated]
    public partial class UpdateAzEventGridTopicSpace_UpdateViaIdentityNamespaceExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.ITopicSpace _topicSpaceInfoBody = new Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.TopicSpace();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Description for the Topic Space resource.")]
        ...
        public string Description { get => _topicSpaceInfoBody.Description ?? null; set => _topicSpaceInfoBody.Description = value; }
        ...
        /// <summary>The topic space name.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The topic space name.")]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The topic filters in the topic space.Example: \"topicTemplates\": [ \"devices/foo/bar\", \"devices/topic1/+\", \"devices/${principal.name}/${principal.attributes.keyName}\" ].")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"The topic filters in the topic space.Example: ""topicTemplates"": [ ""devices/foo/bar"", ""devices/topic1/+"", ""devices/${principal.name}/${principal.attributes.keyName}"" ].",
        SerializedName = @"topicTemplates",
        PossibleTypes = new [] { typeof(string) })]
        public string[] TopicTemplate { get => _topicSpaceInfoBody.TopicTemplate?.ToArray() ?? null /* fixedArrayOf */; set => _topicSpaceInfoBody.TopicTemplate = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzEventGridTopicSpace_UpdateViaIdentityNamespaceExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets.UpdateAzEventGridTopicSpace_UpdateViaIdentityNamespaceExpanded Clone()
        {
            var clone = new UpdateAzEventGridTopicSpace_UpdateViaIdentityNamespaceExpanded();
            ...
            clone._topicSpaceInfoBody = this._topicSpaceInfoBody;
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'TopicSpacesCreateOrUpdate' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (NamespaceInputObject?.Id != null)
                    {
                        ...
                        _topicSpaceInfoBody = await this.Client.TopicSpacesGetViaIdentityWithResult(NamespaceInputObject.Id, this, Pipeline);
                        this.Update_topicSpaceInfoBody();
                        await this.Client.TopicSpacesCreateOrUpdateViaIdentity(NamespaceInputObject.Id, _topicSpaceInfoBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _topicSpaceInfoBody = await this.Client.TopicSpacesGetWithResult(NamespaceInputObject.SubscriptionId ?? null, NamespaceInputObject.ResourceGroupName ?? null, NamespaceInputObject.NamespaceName ?? null, Name, this, Pipeline);
                        this.Update_topicSpaceInfoBody();
                        await this.Client.TopicSpacesCreateOrUpdate(NamespaceInputObject.SubscriptionId ?? null, NamespaceInputObject.ResourceGroupName ?? null, NamespaceInputObject.NamespaceName ?? null, Name, _topicSpaceInfoBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzEventGridTopicSpace_UpdateViaIdentityNamespaceExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzEventGridTopicSpace_UpdateViaIdentityNamespaceExpanded()
        {

        }

        private void Update_topicSpaceInfoBody()
        {
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("TopicTemplate")))
            {
                this.TopicTemplate = (string[])(this.MyInvocation?.BoundParameters["TopicTemplate"]);
            }
        }
