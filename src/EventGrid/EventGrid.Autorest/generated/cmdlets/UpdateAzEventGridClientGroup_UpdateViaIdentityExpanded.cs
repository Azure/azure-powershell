...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets
{
    ...
    /// <summary>Create a client group with the specified parameters.</summary>
    /// <remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Description(@"Create a client group with the specified parameters.")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (InputObject?.Id != null)
                    {
                        ...
                        await this.Client.ClientGroupsCreateOrUpdateViaIdentity(InputObject.Id, _clientGroupInfoBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
