...
online version: https://learn.microsoft.com/powershell/module/az.eventgrid/new-azeventgridtopiceventsubscription
schema: 2.0.0
---
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded, CreateViaIdentityTopicExpanded, CreateViaJsonFilePath, CreateViaJsonString
Aliases:
