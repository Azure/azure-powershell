...
```
Get-AzEventGridDomainTopicEventSubscription -DomainInputObject <IEventGridIdentity>
 -EventSubscriptionName <String> -TopicName <String> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
...
Get-AzEventGridDomainTopicEventSubscription -EventSubscriptionName <String>
 -TopicInputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Get, GetViaIdentityDomain, List
Aliases:
