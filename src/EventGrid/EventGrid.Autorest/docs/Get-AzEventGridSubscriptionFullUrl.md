...
online version: https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridsubscriptionfullurl
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzEventGridSubscriptionFullUrl -EventSubscriptionName <String> -Scope <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzEventGridSubscriptionFullUrl -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-PassThru]
