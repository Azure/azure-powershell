...
### Get
```
Get-AzEventGridNamespaceTopic -NamespaceName <String> -ResourceGroupName <String> -TopicName <String>
...
```
Get-AzEventGridNamespaceTopic -NamespaceInputObject <IEventGridIdentity> -TopicName <String>
