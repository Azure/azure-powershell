...
online version: https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridtopicsharedaccesskey
schema: 2.0.0
---

# Get-AzEventGridTopicSharedAccessKey
...
```
Get-AzEventGridTopicSharedAccessKey -ResourceGroupName <String> -TopicName <String>
