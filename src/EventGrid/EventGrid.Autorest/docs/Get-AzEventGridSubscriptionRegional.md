...
### List1
```
Get-AzEventGridSubscriptionRegional -Location <String> -ResourceGroupName <String>
...
### List2
```
Get-AzEventGridSubscriptionRegional -Location <String> -TopicTypeName <String> [-SubscriptionId <String[]>]
 [-Filter <String>] [-Top <Int32>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### List3
```
Get-AzEventGridSubscriptionRegional -Location <String> -ResourceGroupName <String> -TopicTypeName <String>
 [-SubscriptionId <String[]>] [-Filter <String>] [-Top <Int32>] [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
