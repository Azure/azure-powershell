...
### GetViaIdentity
```
Get-AzEventGridPermissionBinding -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-Break]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <Uri>]
 [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridpermissionbinding](https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridpermissionbinding)
