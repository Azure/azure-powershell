...
```
Disable-AzEventGridPartnerTopic -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/disable-azeventgridpartnertopic](https://learn.microsoft.com/powershell/module/az.eventgrid/disable-azeventgridpartnertopic)
