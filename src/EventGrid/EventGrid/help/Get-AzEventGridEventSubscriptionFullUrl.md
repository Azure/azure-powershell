...
### GetViaIdentity
```
Get-AzEventGridEventSubscriptionFullUrl -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgrideventsubscriptionfullurl](https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgrideventsubscriptionfullurl)
