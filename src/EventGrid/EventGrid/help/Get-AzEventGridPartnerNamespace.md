...
Get-AzEventGridPartnerNamespace [-SubscriptionId <String[]>] [-Filter <String>] [-Top <Int32>]
 ...
 [-ProxyUseDefaultCredentials] [-PassThru] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-AzEventGridPartnerNamespace -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridpartnernamespace](https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridpartnernamespace)
