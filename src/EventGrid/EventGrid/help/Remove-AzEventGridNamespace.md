...
### DeleteViaIdentity
```
Remove-AzEventGridNamespace -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/remove-azeventgridnamespace](https://learn.microsoft.com/powershell/module/az.eventgrid/remove-azeventgridnamespace)
