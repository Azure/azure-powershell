...
### DeleteViaIdentity
```
Remove-AzEventGridSystemTopic -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/remove-azeventgridsystemtopic](https://learn.microsoft.com/powershell/module/az.eventgrid/remove-azeventgridsystemtopic)
