...
### List3
```
Get-AzEventGridEventSubscriptionGlobal [-SubscriptionId <String[]>] -TopicTypeName <String>
...
### List1
```
Get-AzEventGridEventSubscriptionGlobal [-SubscriptionId <String[]>] -TopicTypeName <String> [-Filter <String>]
...
### List2
```
Get-AzEventGridEventSubscriptionGlobal [-SubscriptionId <String[]>] -ResourceGroupName <String>
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgrideventsubscriptionglobal](https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgrideventsubscriptionglobal)
