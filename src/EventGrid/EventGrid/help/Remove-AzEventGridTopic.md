...
### DeleteViaIdentity
```
Remove-AzEventGridTopic -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/remove-azeventgridtopic](https://learn.microsoft.com/powershell/module/az.eventgrid/remove-azeventgridtopic)
