...
```
New-AzEventGridDomainTopicEventSubscription -EventSubscriptionName <String> -TopicName <String>
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded, CreateViaIdentityTopicExpanded, CreateViaIdentityDomainExpanded, CreateViaIdentityExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded, CreateViaJsonString, CreateViaJsonFilePath, CreateViaIdentityTopicExpanded, CreateViaIdentityDomainExpanded
Aliases:
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/new-azeventgriddomaintopiceventsubscription](https://learn.microsoft.com/powershell/module/az.eventgrid/new-azeventgriddomaintopiceventsubscription)
