...
### GetViaIdentity
```
Get-AzEventGridTopic -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridtopic](https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridtopic)
