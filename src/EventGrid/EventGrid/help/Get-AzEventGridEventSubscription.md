...
### Get (Default)
```
Get-AzEventGridEventSubscription -Name <String> -Scope <String> [-DefaultProfile <PSObject>] [-Break]
...
### GetViaIdentity
```
Get-AzEventGridEventSubscription -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-Break]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <Uri>]
 [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
### List
```
Get-AzEventGridEventSubscription -ProviderNamespace <String> -ResourceGroupName <String> -ResourceName <String>
...
### List1
```
Get-AzEventGridEventSubscription -ResourceGroupName <String> [-SubscriptionId <String[]>] -DomainName <String>
 -TopicName <String> [-Filter <String>] [-Top <Int32>] [-DefaultProfile <PSObject>] [-Break]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <Uri>]
 [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgrideventsubscription](https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgrideventsubscription)
