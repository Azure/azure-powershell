...
### GetViaIdentity
```
Get-AzEventGridPartnerDestination -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridpartnerdestination](https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridpartnerdestination)
