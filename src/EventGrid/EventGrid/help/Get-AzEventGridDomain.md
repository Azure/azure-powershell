...
### GetViaIdentity
```
Get-AzEventGridDomain -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgriddomain](https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgriddomain)
