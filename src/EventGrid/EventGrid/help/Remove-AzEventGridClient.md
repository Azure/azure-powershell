...
online version: https://learn.microsoft.com/powershell/module/az.eventgrid/remove-azeventgridclient
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzEventGridClient -Name <String> -NamespaceName <String> -ResourceGroupName <String>
...
```
Remove-AzEventGridClient -Name <String> -NamespaceInputObject <IEventGridIdentity> [-DefaultProfile <PSObject>]
...
### DeleteViaIdentity
```
Remove-AzEventGridClient -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-NoWait] [-PassThru]
 [-Proxy <Uri>] [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/remove-azeventgridclient](https://learn.microsoft.com/powershell/module/az.eventgrid/remove-azeventgridclient)
