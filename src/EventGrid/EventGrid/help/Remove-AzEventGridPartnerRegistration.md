...
### Delete (Default)
```
Remove-AzEventGridPartnerRegistration -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzEventGridPartnerRegistration -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-AsJob]
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/remove-azeventgridpartnerregistration](https://learn.microsoft.com/powershell/module/az.eventgrid/remove-azeventgridpartnerregistration)
