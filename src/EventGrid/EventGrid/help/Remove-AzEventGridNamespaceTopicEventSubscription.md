...
Remove-AzEventGridNamespaceTopicEventSubscription -EventSubscriptionName <String>
 -TopicInputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
...
Remove-AzEventGridNamespaceTopicEventSubscription -EventSubscriptionName <String> -TopicName <String>
 -NamespaceInputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### Example 1: Delete an existing event subscription of a namespace topic.
```powershell
