...
### GetViaIdentity
```
Get-AzEventGridPartnerTopic -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridpartnertopic](https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridpartnertopic)
