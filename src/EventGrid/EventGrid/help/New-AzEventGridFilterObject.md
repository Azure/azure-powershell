...
```
New-AzEventGridFilterObject -OperatorType <String> [-Key <String>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/Az.EventGrid/new-azeventgridfilterobject](https://learn.microsoft.com/powershell/module/Az.EventGrid/new-azeventgridfilterobject)
