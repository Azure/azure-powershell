...
### GetViaIdentity
```
Get-AzEventGridChannelFullUrl -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridchannelfullurl](https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridchannelfullurl)
