...
namespace Microsoft.Azure.Commands.EventGrid
{
    ...
    public class RevokeAzureEventGridPartnerConfiguration : AzureEventGridCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (this.ShouldProcess(this.ResourceGroupName, $"Revoke partner for EventGrid partner configuration in Resource Group {resourceGroupName}"))
            {
                PartnerConfiguration partnerConfiguration = this.Client.UnauthorizePartnerConfiguration(
                    resourceGroupName,
