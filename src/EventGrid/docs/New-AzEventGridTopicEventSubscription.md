...
```
New-AzEventGridTopicEventSubscription -EventSubscriptionName <String> -ResourceGroupName <String>
 -TopicName <String> -EventSubscriptionInfo <IEventSubscription> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Parameter Sets: Create, CreateViaIdentity, CreateViaIdentityTopic
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Create, CreateExpanded, CreateViaIdentityTopic, CreateViaIdentityTopicExpanded, CreateViaJsonFilePath, CreateViaJsonString
Aliases:
