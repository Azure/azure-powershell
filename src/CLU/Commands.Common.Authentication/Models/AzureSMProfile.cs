...
namespace Microsoft.Azure.Commands.Common.Authentication.Models
{
    ...
    public sealed class AzureSMProfile : IAzureProfile
    {
        ...
        { 
            get
            {
                ...
                if (DefaultSubscription != null)
                {
                    ...
                    {
                        ServiceClientTracing.Information(Resources.NoAccountInContext, DefaultSubscription.Account, DefaultSubscription.Id);
                    }
                    ...
                    {
                        ServiceClientTracing.Information(Resources.NoEnvironmentInContext, DefaultSubscription.Environment, DefaultSubscription.Id);                       
                    }
        ...
        public AzureSMProfile() : this(new DiskDataStore())
        {
            ...
            Accounts = new Dictionary<string, AzureAccount>(StringComparer.CurrentCultureIgnoreCase);
