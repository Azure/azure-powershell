...
namespace Microsoft.Azure.Management.Internal.Resources
{
    ...
    internal partial class ResourceProviderOperationDetailsOperations : IServiceOperations<ResourceManagementClient>, IResourceProviderOperationDetailsOperations
    {
        ...
        public async Task<AzureOperationResponse<IPage<ResourceProviderOperationDefinition>>> ListWithHttpMessagesAsync(string resourceProviderNamespace, string apiVersion, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/{resourceProviderNamespace}/operations").ToString();
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<ResourceProviderOperationDefinition>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                {
                    string _responseContent = await _httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                    _result.Body = SafeJsonConvert.DeserializeObject<Page<ResourceProviderOperationDefinition>>(_responseContent, this.Client.DeserializationSettings);
                }
