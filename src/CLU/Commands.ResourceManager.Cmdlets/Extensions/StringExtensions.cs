...
namespace Microsoft.Azure.Commands.ResourceManager.Cmdlets.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        {
            return string.Equals(original, otherString, StringComparison.OrdinalIgnoreCase);
        }
        ...
        {
            return original.CoalesceString().StartsWith(otherString.CoalesceString(), StringComparison.OrdinalIgnoreCase);
        }
