...
namespace Microsoft.Azure.Commands.ResourceManager.Cmdlets.Components
{
    ...
    internal static class ApiVersionHelper
    {
        ...
        private class ApiVersionCache: IDisposable
        {
            /// <summary>
            ...
            internal MemoryCache Cache { get; set; }
            ...
            {
                return this.Cache.Get(cacheKey).Cast<string[]>();
            }
            ...
            {
                this.Cache.Set(cacheKey, data, new MemoryCacheEntryOptions()
                                            {
