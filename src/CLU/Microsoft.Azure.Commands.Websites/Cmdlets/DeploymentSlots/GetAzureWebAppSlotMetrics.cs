...
namespace Microsoft.Azure.Commands.WebApps.Cmdlets.DeploymentSlots
{
    ...
    [CliCommandAlias("webapp;slot;metrics;ls")]
    public class GetAzureWebAppSlotMetricsCmdlet : WebAppSlotBaseCmdlet
    {
        ...
        [Parameter(Position = 4, Mandatory = true, HelpMessage = "Metrics start time")]
        [ValidateNotNullOrEmpty]
        public DateTime StartTime { get; set; }

        [Parameter(Position = 5, Mandatory = false, HelpMessage = "Metrics end time")]
        [ValidateNotNullOrEmpty]
        public DateTime? EndTime { get; set; }

        [Parameter(Position = 6, Mandatory = true, HelpMessage = "Metric granularity. Allowed values: [PT1M|PT1H|P1D]")]
