        ...
        protected override void ProcessRecord()
        {
            ...
            ExecuteClientAction(() =>
            {
                if (Status.IsPresent)
                {
                    ...
                    if (returnedExtension.Publisher.Equals(VirtualMachineAccessExtensionContext.ExtensionDefaultPublisher, StringComparison.OrdinalIgnoreCase) &&
                        returnedExtension.ExtensionType.Equals(VirtualMachineAccessExtensionContext.ExtensionDefaultName, StringComparison.OrdinalIgnoreCase))
                    {
