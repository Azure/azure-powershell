...
namespace Microsoft.Azure.Commands.Compute
{
    ...
    public class AddAzureVMNetworkInterfaceCommand : Microsoft.Azure.Commands.ResourceManager.Common.AzureRMCmdlet
    {
        ...
        [Parameter(
            ...
            ParameterSetName = NicObjectParamSetName)]
        [ValidateNotNullOrEmpty]
        public List<NetworkInterfaceReference> NetworkInterface { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.ParameterSetName.Equals(NicIdParamSetName))
            {
                ...
                else
                {
                    ...
                    var existingNic = networkProfile.NetworkInterfaces.Where(e => e.Id.Equals(this.Id)).FirstOrDefault();
                    if (existingNic == null)
                    {
            ...
            else
            {
                ...
                {
                    var existingNic = networkProfile.NetworkInterfaces.Where(e => e.Id.Equals(nic.Id)).FirstOrDefault();
