...
namespace Microsoft.Azure.Commands.Network
{
    public partial class NetworkClient
    {
        ...
        public NetworkClient(IClientFactory clientFactory, AzureContext context)
            : this(clientFactory.CreateArmClient<NetworkManagementClient>(context, AzureEnvironment.Endpoint.ResourceManager))
        {
        }
            ...
            while (true)
            {
                ...
                if ((int)newHttpResponse.StatusCode != 200)
                {
                    ...
                    else
                    {
                        ...
                        Microsoft.Azure.Commands.Utilities.Common.TestMockSupport.Delay(15000);
                    }
                }
                else
                {
