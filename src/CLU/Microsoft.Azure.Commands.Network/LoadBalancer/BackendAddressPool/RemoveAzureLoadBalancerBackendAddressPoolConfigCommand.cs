...
{
    [Cmdlet(VerbsCommon.Remove, "AzureRmLoadBalancerBackendAddressPoolConfig"), OutputType(typeof(PSLoadBalancer))]
    [CliCommandAlias("network;loadbalancer;backendaddress;pool;config;rm")]
