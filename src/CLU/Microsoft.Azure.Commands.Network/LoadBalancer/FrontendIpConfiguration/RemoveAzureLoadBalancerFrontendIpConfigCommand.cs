...
{
    [Cmdlet(VerbsCommon.Remove, "AzureRmLoadBalancerFrontendIpConfig"), OutputType(typeof(PSLoadBalancer))]
    [CliCommandAlias("network load balancer frontend ipconfig rm")]
