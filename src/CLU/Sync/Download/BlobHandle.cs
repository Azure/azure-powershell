...
namespace Microsoft.WindowsAzure.Commands.Sync.Download
{
    public class BlobHandle
    {
        ...
        public BlobHandle(BlobUri blobUri, string storageAccountKey)
        {
            ...
            this.container.FetchAttributesAsync().Wait();
            ...
            this.pageBlob.FetchAttributesAsync(new AccessCondition(), blobRequestOptions, null).Wait();
        }
        ...
        private IEnumerable<IndexRange> GetPageRanges()
        {
            ...
            pageBlob.FetchAttributesAsync(new AccessCondition(), blobRequestOptions, null).Wait();
            // TODO: CLU
            //IEnumerable<PageRange> pageRanges = pageBlob.GetPageRanges(null, null, new AccessCondition(), blobRequestOptions);
            IEnumerable<PageRange> pageRanges = pageBlob.GetPageRangesAsync(null, null, new AccessCondition(), blobRequestOptions, null).Result;
        ...
        public Stream OpenStream()
        {
            ...
            return this.container.GetPageBlobReference(blobUri.BlobName).OpenReadAsync(new AccessCondition(), blobRequestOptions, null).Result;
        }
