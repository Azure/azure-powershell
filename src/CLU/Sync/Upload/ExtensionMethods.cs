...
namespace Microsoft.WindowsAzure.Commands.Sync.Upload
{
    internal static class CloudPageBlobExtensions
    {
        ...
        {
            // TODO: CLU
            blob.FetchAttributesAsync(new AccessCondition(), requestOptions, null).Wait();
        ...
        public static VhdFooter GetVhdFooter(this CloudPageBlob basePageBlob)
        {
            ...
            // TODO: CLU
            using (var file = vhdFileFactory.Create(basePageBlob.OpenReadAsync().Result))
        ...
        {
            // TODO: CLU
            var listBlobItems = blob.Container.ListBlobsSegmentedAsync(null).Result.Results;
        ...
        {
            // TODO: CLU
            var listBlobItems = blob.Container.ListBlobsSegmentedAsync(null, false, BlobListingDetails.UncommittedBlobs, null, null, options, null).Result.Results;
