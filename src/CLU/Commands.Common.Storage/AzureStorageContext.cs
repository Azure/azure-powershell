    ...
    public class AzureStorageContext
    {
        ...
        public string EndPointSuffix
        {
            get
            {
                ...
                if (StorageAccountName.EndsWith("blob", StringComparison.CurrentCultureIgnoreCase))
                {
                    ...
                    int tableIndex = TableEndPoint.IndexOf("table.", 0, StringComparison.CurrentCultureIgnoreCase);
                    if (tableIndex <= 0)
                    {
                        suffix = string.Empty;
                    }
                ...
                {
                    int blobIndex = BlobEndPoint.IndexOf("blob.", 0, StringComparison.CurrentCultureIgnoreCase);
                    if (blobIndex <= 0)
                    {
                        suffix = string.Empty;
                    }
