if(($null -eq $TestName) -or ($TestName -contains 'New-AzArcGateway'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-AzArcGateway.Recording.json'
