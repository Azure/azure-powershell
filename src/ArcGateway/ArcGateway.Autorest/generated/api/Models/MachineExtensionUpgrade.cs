...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models
{
    ...
    public partial class MachineExtensionUpgrade :
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IMachineExtensionUpgrade,
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IMachineExtensionUpgradeInternal
    {

        /// <summary>Backing field for <see cref="ExtensionTarget" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IExtensionTarget _extensionTarget;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IExtensionTarget ExtensionTarget { get => (this._extensionTarget = this._extensionTarget ?? new Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.ExtensionTarget()); set => this._extensionTarget = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IExtensionTarget) })]
