...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models
{
    ...
    public partial class PrivateLinkScopeValidationDetails :
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateLinkScopeValidationDetails,
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateLinkScopeValidationDetailsInternal
    {

        /// <summary>Backing field for <see cref="ConnectionDetail" /> property.</summary>
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IConnectionDetail> _connectionDetail;
        ...
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IConnectionDetail> ConnectionDetail { get => this._connectionDetail; set => this._connectionDetail = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateLinkScopeValidationDetailsInternal.Id { get => this._id; set { {_id = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IConnectionDetail) })]
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IConnectionDetail> ConnectionDetail { get; set; }
        /// <summary>Azure resource Id</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Info(
        Required = false,
        ReadOnly = true,
