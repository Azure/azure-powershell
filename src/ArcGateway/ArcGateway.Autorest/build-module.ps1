...
$dll = Join-Path $PSScriptRoot 'bin\Az.ArcGateway.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.ArcGateway.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.ArcGateway.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.ArcGateway'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: ArcGateway cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.ArcGateway.format.ps1xml'
