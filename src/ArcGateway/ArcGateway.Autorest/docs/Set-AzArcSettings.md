...
online version: https://learn.microsoft.com/powershell/module/az.arcgateway/set-azarcsettings
schema: 2.0.0
---
...
```
Set-AzArcSettings -BaseProvider <String> -BaseResourceName <String> -BaseResourceType <String>
