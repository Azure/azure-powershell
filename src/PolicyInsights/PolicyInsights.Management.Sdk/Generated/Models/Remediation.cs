...
namespace Microsoft.Azure.Management.PolicyInsights.Models
{
    ...
    public partial class Remediation : Microsoft.Rest.Azure.IResource
    {
        /// <summary>
        ...
        /// <param name="id">The ID of the remediation.
        /// </param>

        /// <param name="type">The type of the remediation.
        /// </param>

        /// <param name="name">The name of the remediation.
        /// </param>
        ...
        /// </param>
        public Remediation(string id = default(string), string type = default(string), string name = default(string), SystemData systemData = default(SystemData), string policyAssignmentId = default(string), string policyDefinitionReferenceId = default(string), string resourceDiscoveryMode = default(string), string provisioningState = default(string), System.DateTime? createdOn = default(System.DateTime?), System.DateTime? lastUpdatedOn = default(System.DateTime?), RemediationFilters filters = default(RemediationFilters), RemediationDeploymentSummary deploymentStatus = default(RemediationDeploymentSummary), string statusMessage = default(string), string correlationId = default(string), int? resourceCount = default(int?), int? parallelDeployments = default(int?), RemediationPropertiesFailureThreshold failureThreshold = default(RemediationPropertiesFailureThreshold))
