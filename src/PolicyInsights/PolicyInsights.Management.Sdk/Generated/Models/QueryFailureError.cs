...
namespace Microsoft.Azure.Management.PolicyInsights.Models
{
    ...
    public partial class QueryFailureError
    {
        ...
        /// <param name="code">Service specific error code which serves as the substatus for the HTTP
        /// error code.
        /// </param>

        /// <param name="message">Description of the error.
        /// </param>
        ...
        /// <summary>
        /// Gets service specific error code which serves as the substatus for the HTTP
        /// error code.
        /// </summary>
