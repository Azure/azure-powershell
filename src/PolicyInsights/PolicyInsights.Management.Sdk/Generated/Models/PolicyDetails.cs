...
namespace Microsoft.Azure.Management.PolicyInsights.Models
{
    ...
    public partial class PolicyDetails
    {
        ...
        /// <param name="policyDefinitionId">The ID of the policy definition.
        /// </param>

        /// <param name="policyAssignmentId">The ID of the policy assignment.
        /// </param>

        /// <param name="policyAssignmentDisplayName">The display name of the policy assignment.
        /// </param>

        /// <param name="policyAssignmentScope">The scope of the policy assignment.
        /// </param>

        /// <param name="policySetDefinitionId">The ID of the policy set definition.
        /// </param>

        /// <param name="policyDefinitionReferenceId">The policy definition reference ID within the policy set definition.
        /// </param>
