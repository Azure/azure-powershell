...
namespace Microsoft.Azure.Management.PolicyInsights.Models
{
    ...
    public partial class PolicyMetadata
    {
        ...
        /// <param name="id">The ID of the policy metadata.
        /// </param>

        /// <param name="type">The type of the policy metadata.
        /// </param>

        /// <param name="name">The name of the policy metadata.
        /// </param>
        ...
        /// </param>
        public PolicyMetadata(string id = default(string), string type = default(string), string name = default(string), string metadataId = default(string), string category = default(string), string title = default(string), string owner = default(string), string additionalContentUrl = default(string), object metadata = default(object), string description = default(string), string requirements = default(string))
