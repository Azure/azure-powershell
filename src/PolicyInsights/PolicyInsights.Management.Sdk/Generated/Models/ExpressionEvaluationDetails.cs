...
namespace Microsoft.Azure.Management.PolicyInsights.Models
{
    ...
    public partial class ExpressionEvaluationDetails
    {
        ...
        /// <param name="result">Evaluation result.
        /// </param>

        /// <param name="expression">Expression evaluated.
        /// </param>

        /// <param name="expressionKind">The kind of expression that was evaluated.
        /// </param>

        /// <param name="path">Property path if the expression is a field or an alias.
        /// </param>

        /// <param name="expressionValue">Value of the expression.
        /// </param>

        /// <param name="targetValue">Target value to be compared with the expression value.
        /// </param>

        /// <param name="operatorProperty">Operator to compare the expression value and the target value.
        /// </param>
