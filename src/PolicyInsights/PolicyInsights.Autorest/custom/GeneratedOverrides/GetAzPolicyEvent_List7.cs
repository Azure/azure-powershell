...
{
    public partial class GetAzPolicyEvent_List7
    {
        /// <summary>
            ...
            if (_isFirst)
            {
                ...
                while (!String.IsNullOrEmpty(_nextLink))
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage)
                    {
                        ...
                        this.Client.PolicyEventsListQueryResultsForResourceGroupLevelPolicyAssignment_Call(requestMessage, onOk, onDefault, this, Pipeline).Wait();
                    }
                }
            }
        }
