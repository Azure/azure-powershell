...
{
    public partial class GetAzPolicyStateQueryResult_List
    {
        /// <summary>
            ...
            if (_isFirst)
            {
                ...
                while (!String.IsNullOrEmpty(_nextLink))
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage)
                    {
                        ...
                        this.Client.PolicyStatesListQueryResultsForManagementGroup_Call(requestMessage, onOk, onDefault, this, Pipeline).Wait();
                    }
                }
            }
        }
