...
{
    public partial class GetAzPolicyRemediationDeployment_List1
    {
        /// <summary>
            ...
            if (_isFirst)
            {
                ...
                while (!String.IsNullOrEmpty(_nextLink))
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage)
                    {
                        ...
                        this.Client.RemediationsListDeploymentsAtSubscription_Call(requestMessage, onOk, onDefault, this, Pipeline).Wait();
                    }
                }
            }
        }
