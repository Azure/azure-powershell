...
{
    public partial class GetAzPolicyStateQueryResult_List6
  {
        /// <summary>
            ...
            if (_isFirst)
            {
                ...
                while (!String.IsNullOrEmpty(_nextLink))
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage)
                    {
                        ...
                        this.Client.PolicyStatesListQueryResultsForSubscriptionLevelPolicyAssignment_Call(requestMessage, onOk, onDefault, this, Pipeline).Wait();
                    }
                }
            }
        }
