...
{
    public partial class GetAzPolicyStateQueryResult_List7
  {
        /// <summary>
        ...
        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.IPolicyStatesQueryResults> response, ref global::System.Threading.Tasks.Task<bool> returnNow)
        {
            ...
            // if there is a Top value and it has been reached, then we don't need to call the nextLink
            if(this.InvocationInformation.BoundParameters.ContainsKey("Top"))
            {
                ...
                {
                    // set nextLink to null so the method doesn't get caught in a loop
                    _nextLink = null; 
                    return;
                }
            ...
            if (_isFirst)
            {
                ...
                while (!String.IsNullOrEmpty(_nextLink))
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage)
                    {
                        ...
                        this.Client.PolicyStatesListQueryResultsForResourceGroupLevelPolicyAssignment_Call(requestMessage, onOk, onDefault, this, Pipeline).Wait();
                    }
                }
            }
        }
