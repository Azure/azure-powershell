...
```
New-AzPolicyAttestation -Name <String> [-SubscriptionId <String>] -PolicyAssignmentId <String>
 ...
 [-PolicyDefinitionReferenceId <String>] [-DefaultProfile <PSObject>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateByResourceGroup
```
New-AzPolicyAttestation -Name <String> [-SubscriptionId <String>] -ResourceGroupName <String>
 -PolicyAssignmentId <String> [-AssessmentDate <DateTime>] [-Comment <String>] [-ComplianceState <String>]
 [-Evidence <IAttestationEvidence[]>] [-ExpiresOn <DateTime>] [-Metadata <String>] [-Owner <String>]
 [-PolicyDefinitionReferenceId <String>] [-DefaultProfile <PSObject>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: CreateBySubscriptionId, CreateByResourceGroup, CreateByResourceId, CreateByScope
