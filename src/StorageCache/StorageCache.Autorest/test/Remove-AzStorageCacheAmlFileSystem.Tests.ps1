    ...
    It 'Delete' {
        {
            ...
            $result = Remove-AzStorageCacheAmlFileSystem -Name "acctest43511-1" -ResourceGroupName "acctest43511" -PassThru
            ...
            do {
                ...
                try {
                    $filesystem = Get-AzStorageCacheAmlFileSystem -Name "acctest43511-1" -ResourceGroupName "acctest43511" -ErrorAction SilentlyContinue
                } catch {
                    $filesystem = $null
                }
    ...
    It 'DeleteViaIdentity' {
        {
            ...
            $identity = @{
                ...
                AmlFilesystemName = "acctest43511-2"
            }
