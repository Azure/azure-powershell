---
external help file:
<<<<<<<< HEAD:src/StackHCI/StackHCI.Autorest/docs/New-AzStackHciArcSettingIdentity.md
...
online version: https://learn.microsoft.com/powershell/module/az.storagecache/remove-azstoragecacheexpansionjob
schema: 2.0.0
---

# Remove-AzStorageCacheExpansionJob

## SYNOPSIS
Schedules an expansion job for deletion.
>>>>>>>> upstream/main:src/StorageCache/StorageCache.Autorest/docs/Remove-AzStorageCacheExpansionJob.md
...
========
Remove-AzStorageCacheExpansionJob -AmlFilesystemName <String> -Name <String> -ResourceGroupName <String>
...
========
Remove-AzStorageCacheExpansionJob -InputObject <IStorageCacheIdentity> [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentityAmlFilesystem
```
Remove-AzStorageCacheExpansionJob -AmlFilesystemInputObject <IStorageCacheIdentity> -Name <String>
...
### Example 1: Remove an expansion job
```powershell
