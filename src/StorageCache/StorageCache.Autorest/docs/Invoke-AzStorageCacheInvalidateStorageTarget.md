...
online version: https://learn.microsoft.com/powershell/module/az.storagecache/invoke-azstoragecacheinvalidatestoragetarget
schema: 2.0.0
---
...
### InvalidateViaIdentityCach
```
Invoke-AzStorageCacheInvalidateStorageTarget -CachInputObject <IStorageCacheIdentity>
...
### Example 1: Invalidate storage target
```powershell
...
Parameter Sets: InvalidateViaIdentityCach
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Invalidate, InvalidateViaIdentityCach
Aliases:
