...
online version: https://learn.microsoft.com/powershell/module/az.storagecache/remove-azstoragecache
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzStorageCache -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzStorageCache -InputObject <IStorageCacheIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
