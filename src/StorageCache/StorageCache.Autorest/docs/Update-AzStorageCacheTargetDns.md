...
online version: https://learn.microsoft.com/powershell/module/az.storagecache/update-azstoragecachetargetdns
schema: 2.0.0
---
...
### Refresh (Default)
```
Update-AzStorageCacheTargetDns -CacheName <String> -ResourceGroupName <String> -StorageTargetName <String>
...
### RefreshViaIdentity
```
Update-AzStorageCacheTargetDns -InputObject <IStorageCacheIdentity> [-DefaultProfile <PSObject>] [-AsJob]
