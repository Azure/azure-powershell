...
Invoke-AzStorageCacheSpaceCachAllocation -InputObject <IStorageCacheIdentity>
 -SpaceAllocation <System.Collections.Generic.List`1[Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.IStorageTargetSpaceAllocation]>
...
### Example 1: Manage cache space allocation
```powershell
...
```yaml
Type: System.String
Parameter Sets: SpaceViaJsonString, SpaceViaJsonFilePath, Space
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.IStorageTargetSpaceAllocation]
Parameter Sets: SpaceViaIdentity, Space
Aliases:
