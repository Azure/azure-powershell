...
online version: https://learn.microsoft.com/powershell/module/az.storagecache/update-azstoragecachecachfirmware
schema: 2.0.0
---

# Update-AzStorageCacheCachFirmware
...
### Upgrade (Default)
```
Update-AzStorageCacheCachFirmware -CacheName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### UpgradeViaIdentity
```
Update-AzStorageCacheCachFirmware -InputObject <IStorageCacheIdentity> [-DefaultProfile <PSObject>] [-AsJob]
...
### Example 1: Update cache firmware
```powershell
