...
```
Invoke-AzStorageCacheInvalidateStorageTarget -StorageTargetName <String>
 -CachInputObject <IStorageCacheIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
