...
online version: https://learn.microsoft.com/powershell/module/az.storagecache/resume-azstoragecachecachprimingjob
schema: 2.0.0
---

# Resume-AzStorageCacheCachPrimingJob
...
```
Resume-AzStorageCacheCachPrimingJob -CacheName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Resume-AzStorageCacheCachPrimingJob -InputObject <IStorageCacheIdentity> [-PrimingJobId <String>]
...
### Example 1: Resume cache priming job
```powershell
Resume-AzStorageCacheCachPrimingJob -CacheName "myCache" -ResourceGroupName "myResourceGroup" -PrimingJobName "myPrimingJob"
```
...
```yaml
Type: System.String
Parameter Sets: ResumeExpanded, ResumeViaJsonString, ResumeViaJsonFilePath
Aliases:
...
Parameter Sets: ResumeViaIdentityExpanded
Aliases:
