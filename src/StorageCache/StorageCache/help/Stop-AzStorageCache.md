...
online version: https://learn.microsoft.com/powershell/module/az.storagecache/stop-azstoragecache
schema: 2.0.0
---
...
### Stop (Default)
```
Stop-AzStorageCache -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### StopViaIdentity
```
Stop-AzStorageCache -InputObject <IStorageCacheIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
