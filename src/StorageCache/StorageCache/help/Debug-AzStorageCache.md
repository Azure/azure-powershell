...
online version: https://learn.microsoft.com/powershell/module/az.storagecache/debug-azstoragecache
schema: 2.0.0
---
...
### Debug (Default)
```
Debug-AzStorageCache -CacheName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DebugViaIdentity
```
Debug-AzStorageCache -InputObject <IStorageCacheIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
