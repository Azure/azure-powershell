...
online version: https://learn.microsoft.com/powershell/module/az.storagecache/stop-azstoragecachecachprimingjob
schema: 2.0.0
---

# Stop-AzStorageCacheCachPrimingJob
...
```
Stop-AzStorageCacheCachPrimingJob -CacheName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Stop-AzStorageCacheCachPrimingJob -InputObject <IStorageCacheIdentity> [-PrimingJobId <String>]
