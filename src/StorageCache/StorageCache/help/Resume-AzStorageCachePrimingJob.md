...
online version: https://learn.microsoft.com/powershell/module/az.storagecache/resume-azstoragecacheprimingjob
schema: 2.0.0
---
...
```
Resume-AzStorageCachePrimingJob -CacheName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Resume-AzStorageCachePrimingJob -InputObject <IStorageCacheIdentity> -PrimingJobId <String>
