...
online version: https://docs.microsoft.com/powershell/module/hpccache/get-azhpccachestoragetarget
schema: 2.0.0
---
...
### List (Default)
```
Get-AzHpcCacheStorageTarget -CacheName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzHpcCacheStorageTarget -CacheName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzHpcCacheStorageTarget -InputObject <IHpcCacheIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
