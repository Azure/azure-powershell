...
online version: https://docs.microsoft.com/powershell/module/hpccache/update-azhpccachestoragetargetdns
schema: 2.0.0
---
...
### Refresh (Default)
```
Update-AzHpcCacheStorageTargetDns -CacheName <String> -ResourceGroupName <String> -StorageTargetName <String>
...
### RefreshViaIdentity
```
Update-AzHpcCacheStorageTargetDns -InputObject <IHpcCacheIdentity> [-DefaultProfile <PSObject>] [-AsJob]
