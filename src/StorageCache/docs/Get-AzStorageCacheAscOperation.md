...
online version: https://learn.microsoft.com/powershell/module/az.storagecache/get-azstoragecacheascoperation
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzStorageCacheAscOperation -Id <String> -Location <String> [-SubscriptionId <String[]>]
