...
online version: https://learn.microsoft.com/powershell/module/az.storagecache/clear-azstoragecachetarget
schema: 2.0.0
---
...
### Flush (Default)
```
Clear-AzStorageCacheTarget -CacheName <String> -Name <String> -ResourceGroupName <String>
...
### FlushViaIdentity
```
Clear-AzStorageCacheTarget -InputObject <IStorageCacheIdentity> [-DefaultProfile <PSObject>] [-AsJob]
