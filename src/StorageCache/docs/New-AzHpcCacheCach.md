...
online version: https://docs.microsoft.com/powershell/module/hpccache/new-azhpccachecach
schema: 2.0.0
---
...
```
New-AzHpcCacheCach -EName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### Create
```
New-AzHpcCacheCach -EName <String> -ResourceGroupName <String> -Cache <ICache> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzHpcCacheCach -InputObject <IHpcCacheIdentity> -Cache <ICache> [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzHpcCacheCach -InputObject <IHpcCacheIdentity> [-CacheSizeGb <Int32>]
