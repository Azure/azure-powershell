...
online version: https://docs.microsoft.com/powershell/module/hpccache/remove-azhpccachestoragetarget
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzHpcCacheStorageTarget -CacheName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzHpcCacheStorageTarget -InputObject <IHpcCacheIdentity> [-DefaultProfile <PSObject>] [-AsJob]
