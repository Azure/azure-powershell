...
online version: https://docs.microsoft.com/powershell/module/hpccache/remove-azhpccache
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzHpcCache -InputObject <IHpcCacheIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
