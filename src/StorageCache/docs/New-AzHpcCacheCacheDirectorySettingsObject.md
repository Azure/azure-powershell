...
online version: https://docs.microsoft.com/powershell/module//az.HpcCache/new-AzHpcCacheCacheDirectorySettingsObject
schema: 2.0.0
---

# New-AzHpcCacheCacheDirectorySettingsObject
...
```
New-AzHpcCacheCacheDirectorySettingsObject [-ActiveDirectoryCacheNetBiosName <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HpcCache.Support.UsernameSource
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.HpcCache.Models.Api20210301.CacheDirectorySettings
