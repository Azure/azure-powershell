...
online version: https://docs.microsoft.com/powershell/module/hpccache/debug-azhpccachecachinfo
schema: 2.0.0
---

# Debug-AzHpcCacheCachInfo
...
### Debug (Default)
```
Debug-AzHpcCacheCachInfo -CacheName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DebugViaIdentity
```
Debug-AzHpcCacheCachInfo -InputObject <IHpcCacheIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
