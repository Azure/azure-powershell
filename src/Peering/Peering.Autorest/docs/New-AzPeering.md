...
```
New-AzPeering -Name <String> -ResourceGroupName <String> -Kind <String> -Location <String>
 ...
 [-PeeringLocation <String>] [-Sku <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm]
