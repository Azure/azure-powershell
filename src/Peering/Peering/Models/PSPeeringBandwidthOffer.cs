...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models
{
    ...
    /// </summary>
    public partial class PSPeeringBandwidthOffer
    {
        /// <summary>
        /// Initializes a new instance of the PSPeeringBandwidthOffer class.
        /// </summary>
        public PSPeeringBandwidthOffer()
        {
            CustomInit();
        }
        ...
        /// Mbps.</param>
        public PSPeeringBandwidthOffer(string offerName = default(string), int? valueInMbps = default(int?))
        {
            OfferName = offerName;
