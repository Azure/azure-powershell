...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models
{
    ...
    public partial class PSPeeringServicePrefix
    {
        ...
        public PSPeeringServicePrefix(string prefix = default(string), string prefixValidationState = default(string), string learnedType = default(string), string provisioningState = default(string), string name = default(string), string id = default(string), string type = default(string))
        {
            Prefix = prefix;
