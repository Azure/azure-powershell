...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models
{
    ...
    public partial class PSPeeringRegisteredPrefix
    {
        /// <summary>
        /// Initializes a new instance of the PSPeeringRegisteredPrefix class.
        /// </summary>
        public PSPeeringRegisteredPrefix()
        {
            CustomInit();
        }
        ...
        public PSPeeringRegisteredPrefix(string prefix = default(string), string prefixValidationState = default(string), string peeringServicePrefixKey = default(string), string errorMessage = default(string), string provisioningState = default(string), string name = default(string), string id = default(string), string type = default(string))
        {
            Prefix = prefix;
