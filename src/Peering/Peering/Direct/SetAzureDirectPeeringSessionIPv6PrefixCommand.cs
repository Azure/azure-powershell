...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Direct
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "AzDirectPeeringSessionIPv6Prefix", DefaultParameterSetName = Constants.ParameterSetNameDefault, SupportsShouldProcess = true)]
    [OutputType(typeof(PSPeering))]
    public class SetAzureDirectPeeringSessionIPv6PrefixCommand : PeeringBaseCmdlet
    {
        /// <summary>
