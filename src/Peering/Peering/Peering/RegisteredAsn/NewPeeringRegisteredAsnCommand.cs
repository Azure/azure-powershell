...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Peering
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, Constants.AzPeeringRegisteredAsn,
        DefaultParameterSetName = Constants.ParameterSetNameByResourceAndName,
        SupportsShouldProcess = true)]
    [OutputType(typeof(PSPeeringRegisteredAsn))]
    public class NewAzPeeringRegisteredAsnCommand : PeeringBaseCmdlet
    {
        /// <summary>
        ...
        private PSPeeringRegisteredAsn CreateParameterSetNameByResourceId()
        {
            ...
            try
            {
                return PeeringResourceManagerProfile.Mapper.Map<PSPeeringRegisteredAsn>(this.RegisteredAsnClient.CreateOrUpdate(resource.ResourceGroupName, resource.ResourceName, this.Name, this.Asn));
            }
            catch (ErrorResponseException ex)
            {
                var error = this.GetErrorCodeAndMessageFromArmOrErm(ex);
