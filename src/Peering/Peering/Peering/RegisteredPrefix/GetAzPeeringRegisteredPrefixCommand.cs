...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Peering
{
    ...
    public class GetAzPeeringRegisteredPrefixCommand : PeeringBaseCmdlet
    {
        ...
        {
            return this.RegisteredPrefixesClient.ListByPeering(this.ResourceGroupName, this.PeeringName).Select(p => PeeringResourceManagerProfile.Mapper.Map<PSPeeringRegisteredPrefix>(p)).ToList();
        }
        ...
        {
            var prefix = this.RegisteredPrefixesClient.Get(this.ResourceGroupName, this.PeeringName, this.Name);
            if (prefix != null)
            {
                return PeeringResourceManagerProfile.Mapper.Map<PSPeeringRegisteredPrefix>(prefix);
            }
            return null;
        }
    }
