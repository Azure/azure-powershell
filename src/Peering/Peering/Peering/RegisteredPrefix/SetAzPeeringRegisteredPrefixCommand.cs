...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Peering
{
    ...
    public class SetAzPeeringRegisteredPrefixCommand : PeeringBaseCmdlet
    {
        /// <summary>
        ...
        public PSPeeringRegisteredPrefix InputObject { get; set; }
        ...
        private PSPeeringRegisteredPrefix CreateParameterSetNameByResourceId()
        {
            ...
            try
            {
                return PeeringResourceManagerProfile.Mapper.Map<PSPeeringRegisteredPrefix>(this.RegisteredPrefixesClient.CreateOrUpdate(resource.ResourceGroupName, resource.ParentResource.Split('/')?[1], resource.ResourceName, this.Prefix));
            }
            catch (ErrorResponseException ex)
            {
                var error = this.GetErrorCodeAndMessageFromArmOrErm(ex);
