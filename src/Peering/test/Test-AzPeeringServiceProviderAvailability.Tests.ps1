if(($null -eq $TestName) -or ($TestName -contains 'Test-AzPeeringServiceProviderAvailability'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Test-AzPeeringServiceProviderAvailability.Recording.json'
