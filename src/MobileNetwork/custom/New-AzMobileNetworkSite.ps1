    ...
    process {
        try {
            ...
            if ($hasPlatformType -And $hasControlPlaneAccessInterfaceName `
                    ...
                    -And $hasControlPlaneAccessInterfaceIpv4Subnet) -Or $hasAzureStackEdgeDeviceId) -And $hasAzureStackEdgeDeviceId `
