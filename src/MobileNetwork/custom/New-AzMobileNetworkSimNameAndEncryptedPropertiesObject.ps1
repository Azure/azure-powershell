...
.Link
https://learn.microsoft.com/powershell/module/az.MobileNetwork/new-AzMobileNetworkSimNameAndEncryptedPropertiesObject
#>
function New-AzMobileNetworkSimNameAndEncryptedPropertiesObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20221101.SimNameAndEncryptedProperties')]
    ...
    Param(
        ...
        [string]
        $DeviceType,
        [Parameter(HelpMessage="The encrypted SIM credentials.")]
        [string]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20221101.SimNameAndEncryptedProperties]::New()

        if ($PSBoundParameters.ContainsKey('DeviceType')) {
            $Object.DeviceType = $DeviceType
        }
        if ($PSBoundParameters.ContainsKey('EncryptedCredentials')) {
            $Object.EncryptedCredentials = $EncryptedCredentials
        }
