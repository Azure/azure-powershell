...
Update-AzMobileNetworkSimPolicy -MobileNetworkName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-UeAmbrUplink <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-AzMobileNetworkSimPolicy -MobileNetworkInputObject <IMobileNetworkIdentity> -Name <String>
