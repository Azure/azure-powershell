...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] BulkUploadEncrypted=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/simGroups/{simGroupName}/uploadEncryptedSims"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMobileNetworkBulkSimUploadEncrypted_BulkViaIdentityExpanded", SupportsShouldProcess = true)]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20221101.IEncryptedSimUploadList _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20221101.EncryptedSimUploadList();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "An identifier for the Azure SIM onboarding public key used for encrypted upload.")]
        ...
        public int AzureKeyIdentifier { get => _parametersBody.AzureKeyIdentifier; set => _parametersBody.AzureKeyIdentifier = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The transport key used for encrypting SIM credentials, encrypted using the SIM onboarding public key.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public string EncryptedTransportKey { get => _parametersBody.EncryptedTransportKey ?? null; set => _parametersBody.EncryptedTransportKey = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IMobileNetworkIdentity _inputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IMobileNetworkIdentity InputObject { get => this._inputObject; set => this._inputObject = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The encrypted transport key, signed using the SIM vendor private key.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SignedTransportKey { get => _parametersBody.SignedTransportKey ?? null; set => _parametersBody.SignedTransportKey = value; }

        /// <summary>A list of SIMs to upload, with encrypted properties.</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "A list of SIMs to upload, with encrypted properties.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20221101.ISimNameAndEncryptedProperties[] Sim { get => _parametersBody.Sim ?? null /* arrayOf */; set => _parametersBody.Sim = value; }

        /// <summary>
        /// The fingerprint of the SIM vendor public key. The private counterpart is used for signing the encrypted transport key.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The fingerprint of the SIM vendor public key. The private counterpart is used for signing the encrypted transport key.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string VendorKeyFingerprint { get => _parametersBody.VendorKeyFingerprint ?? null; set => _parametersBody.VendorKeyFingerprint = value; }

        /// <summary>The upload file format version.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The upload file format version.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int Version { get => _parametersBody.Version; set => _parametersBody.Version = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20221101.IAsyncOperationStatus">Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20221101.IAsyncOperationStatus</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20221101.IAsyncOperationStatus> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzMobileNetworkBulkSimUploadEncrypted_BulkViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets.UpdateAzMobileNetworkBulkSimUploadEncrypted_BulkViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzMobileNetworkBulkSimUploadEncrypted_BulkViaIdentityExpanded();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SimsBulkUploadEncrypted' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.SimsBulkUploadEncryptedViaIdentity(InputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.SimGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.SimGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.SimsBulkUploadEncrypted(InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.SimGroupName ?? null, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzMobileNetworkBulkSimUploadEncrypted_BulkViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzMobileNetworkBulkSimUploadEncrypted_BulkViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20221101.IAsyncOperationStatus> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20221101.IAsyncOperationStatus
