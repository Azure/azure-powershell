...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/invoke-azmobilenetworkrollbackpacketcorecontrolplane
schema: 2.0.0
---

# Invoke-AzMobileNetworkRollbackPacketCoreControlPlane
...
### Rollback (Default)
```
Invoke-AzMobileNetworkRollbackPacketCoreControlPlane -PacketCoreControlPlaneName <String>
...
### RollbackViaIdentity
```
Invoke-AzMobileNetworkRollbackPacketCoreControlPlane -InputObject <IMobileNetworkIdentity>
