...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/update-azmobilenetworkdatanetworktag
schema: 2.0.0
---

# Update-AzMobileNetworkDataNetworkTag
...
```
Update-AzMobileNetworkDataNetworkTag -DataNetworkName <String> -MobileNetworkName <String>
...
```
Update-AzMobileNetworkDataNetworkTag -InputObject <IMobileNetworkIdentity> [-Tag <Hashtable>]
