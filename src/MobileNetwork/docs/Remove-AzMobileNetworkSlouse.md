...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/remove-azmobilenetworkslouse
schema: 2.0.0
---

# Remove-AzMobileNetworkSlouse
...
### Delete (Default)
```
Remove-AzMobileNetworkSlouse -MobileNetworkName <String> -ResourceGroupName <String> -SliceName <String>
...
### DeleteViaIdentity
```
Remove-AzMobileNetworkSlouse -InputObject <IMobileNetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob]
