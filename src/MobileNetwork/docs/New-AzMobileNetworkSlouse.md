...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/new-azmobilenetworkslouse
schema: 2.0.0
---

# New-AzMobileNetworkSlouse
...
```
New-AzMobileNetworkSlouse -MobileNetworkName <String> -ResourceGroupName <String> -SliceName <String>
