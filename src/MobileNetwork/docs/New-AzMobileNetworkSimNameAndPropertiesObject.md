...
online version: https://learn.microsoft.com/powershell/module/az.MobileNetwork/new-AzMobileNetworkSimNameAndPropertiesObject
schema: 2.0.0
---
...
```
New-AzMobileNetworkSimNameAndPropertiesObject -InternationalMobileSubscriberIdentity <String> -Name <String>
