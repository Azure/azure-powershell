...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/update-azmobilenetworksimgrouptag
schema: 2.0.0
---

# Update-AzMobileNetworkSimGroupTag
...
```
Update-AzMobileNetworkSimGroupTag -ResourceGroupName <String> -SimGroupName <String>
...
```
Update-AzMobileNetworkSimGroupTag -InputObject <IMobileNetworkIdentity> [-Tag <Hashtable>]
