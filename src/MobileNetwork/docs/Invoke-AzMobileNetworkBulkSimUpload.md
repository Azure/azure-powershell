...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/invoke-azmobilenetworkbulksimupload
schema: 2.0.0
---

# Invoke-AzMobileNetworkBulkSimUpload
...
### BulkViaIdentity (Default)
```
Invoke-AzMobileNetworkBulkSimUpload -InputObject <IMobileNetworkIdentity> -Parameter <ISimUploadList>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Bulk
```
Invoke-AzMobileNetworkBulkSimUpload -ResourceGroupName <String> -SimGroupName <String>
 -Parameter <ISimUploadList> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```
Invoke-AzMobileNetworkBulkSimUpload -InputObject <IMobileNetworkIdentity> -Sim <ISimNameAndProperties[]>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20221101.ISimUploadList
...
PARAMETER <ISimUploadList>: The SIMs to upload.
