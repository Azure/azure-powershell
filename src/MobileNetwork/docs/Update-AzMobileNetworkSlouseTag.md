...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/update-azmobilenetworkslousetag
schema: 2.0.0
---

# Update-AzMobileNetworkSlouseTag
...
```
Update-AzMobileNetworkSlouseTag -MobileNetworkName <String> -ResourceGroupName <String> -SliceName <String>
...
```
Update-AzMobileNetworkSlouseTag -InputObject <IMobileNetworkIdentity> [-Tag <Hashtable>]
