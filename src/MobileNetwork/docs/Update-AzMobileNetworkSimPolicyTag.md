...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/update-azmobilenetworksimpolicytag
schema: 2.0.0
---

# Update-AzMobileNetworkSimPolicyTag
...
```
Update-AzMobileNetworkSimPolicyTag -MobileNetworkName <String> -ResourceGroupName <String>
 -SimPolicyName <String> [-SubscriptionId <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzMobileNetworkSimPolicyTag -InputObject <IMobileNetworkIdentity> [-Tag <Hashtable>]
