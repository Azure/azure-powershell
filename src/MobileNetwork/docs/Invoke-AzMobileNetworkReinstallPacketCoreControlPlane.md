...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/invoke-azmobilenetworkreinstallpacketcorecontrolplane
schema: 2.0.0
---

# Invoke-AzMobileNetworkReinstallPacketCoreControlPlane
...
### Reinstall (Default)
```
Invoke-AzMobileNetworkReinstallPacketCoreControlPlane -PacketCoreControlPlaneName <String>
...
```
Invoke-AzMobileNetworkReinstallPacketCoreControlPlane -InputObject <IMobileNetworkIdentity>
