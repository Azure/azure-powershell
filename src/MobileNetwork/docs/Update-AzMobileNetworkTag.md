...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/update-azmobilenetworktag
schema: 2.0.0
---

# Update-AzMobileNetworkTag
...
```
Update-AzMobileNetworkTag -MobileNetworkName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzMobileNetworkTag -InputObject <IMobileNetworkIdentity> [-Tag <Hashtable>]
