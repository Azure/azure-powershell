...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/remove-azmobilenetworkpacketcorecontrolplane
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzMobileNetworkPacketCoreControlPlane -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzMobileNetworkPacketCoreControlPlane -InputObject <IMobileNetworkIdentity>
