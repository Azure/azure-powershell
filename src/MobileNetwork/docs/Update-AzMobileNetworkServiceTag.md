...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/update-azmobilenetworkservicetag
schema: 2.0.0
---

# Update-AzMobileNetworkServiceTag
...
```
Update-AzMobileNetworkServiceTag -MobileNetworkName <String> -ResourceGroupName <String> -ServiceName <String>
...
```
Update-AzMobileNetworkServiceTag -InputObject <IMobileNetworkIdentity> [-Tag <Hashtable>]
