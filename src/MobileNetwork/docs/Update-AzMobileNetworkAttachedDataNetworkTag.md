...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/update-azmobilenetworkattacheddatanetworktag
schema: 2.0.0
---

# Update-AzMobileNetworkAttachedDataNetworkTag
...
```
Update-AzMobileNetworkAttachedDataNetworkTag -AttachedDataNetworkName <String>
...
```
Update-AzMobileNetworkAttachedDataNetworkTag -InputObject <IMobileNetworkIdentity> [-Tag <Hashtable>]
