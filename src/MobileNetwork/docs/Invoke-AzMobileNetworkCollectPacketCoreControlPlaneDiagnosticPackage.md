...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/invoke-azmobilenetworkcollectpacketcorecontrolplanediagnosticpackage
schema: 2.0.0
---

# Invoke-AzMobileNetworkCollectPacketCoreControlPlaneDiagnosticPackage
...
```
Invoke-AzMobileNetworkCollectPacketCoreControlPlaneDiagnosticPackage -PacketCoreControlPlaneName <String>
...
```
Invoke-AzMobileNetworkCollectPacketCoreControlPlaneDiagnosticPackage -PacketCoreControlPlaneName <String>
 -ResourceGroupName <String> -Parameter <IPacketCoreControlPlaneCollectDiagnosticsPackage>
...
### CollectViaIdentity
```
Invoke-AzMobileNetworkCollectPacketCoreControlPlaneDiagnosticPackage -InputObject <IMobileNetworkIdentity>
 -Parameter <IPacketCoreControlPlaneCollectDiagnosticsPackage> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
Parameter Sets: CollectViaIdentity, CollectViaIdentityExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Collect, CollectExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20221101.IPacketCoreControlPlaneCollectDiagnosticsPackage
Parameter Sets: Collect, CollectViaIdentity
Aliases:
...
PARAMETER <IPacketCoreControlPlaneCollectDiagnosticsPackage>: Packet core control plane collect diagnostics package options
  - `StorageAccountBlobUrl <String>`: The Storage Account Blob URL to upload the diagnostics package to.
