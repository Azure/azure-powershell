...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/invoke-azmobilenetworkbulksimdelete
schema: 2.0.0
---

# Invoke-AzMobileNetworkBulkSimDelete
...
```
Invoke-AzMobileNetworkBulkSimDelete -ResourceGroupName <String> -SimGroupName <String> -Sim <String[]>
...
### Bulk
```
Invoke-AzMobileNetworkBulkSimDelete -ResourceGroupName <String> -SimGroupName <String>
 -Parameter <ISimDeleteList> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### BulkViaIdentity
```
Invoke-AzMobileNetworkBulkSimDelete -InputObject <IMobileNetworkIdentity> -Parameter <ISimDeleteList>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### BulkViaIdentityExpanded
```
Invoke-AzMobileNetworkBulkSimDelete -InputObject <IMobileNetworkIdentity> -Sim <String[]>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20221101.ISimDeleteList
...
PARAMETER <ISimDeleteList>: The SIMs to delete.
  - `Sim <String[]>`: A list of SIM resource names to delete.
