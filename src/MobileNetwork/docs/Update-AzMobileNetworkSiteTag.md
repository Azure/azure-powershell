...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/update-azmobilenetworksitetag
schema: 2.0.0
---

# Update-AzMobileNetworkSiteTag
...
```
Update-AzMobileNetworkSiteTag -MobileNetworkName <String> -ResourceGroupName <String> -SiteName <String>
...
```
Update-AzMobileNetworkSiteTag -InputObject <IMobileNetworkIdentity> [-Tag <Hashtable>]
