...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/remove-azmobilenetworksite
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzMobileNetworkSite -MobileNetworkName <String> -Name <String> -ResourceGroupName <String>
