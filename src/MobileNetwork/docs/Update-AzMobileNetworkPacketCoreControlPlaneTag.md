...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/update-azmobilenetworkpacketcorecontrolplanetag
schema: 2.0.0
---

# Update-AzMobileNetworkPacketCoreControlPlaneTag
...
```
Update-AzMobileNetworkPacketCoreControlPlaneTag -PacketCoreControlPlaneName <String>
...
```
Update-AzMobileNetworkPacketCoreControlPlaneTag -InputObject <IMobileNetworkIdentity> [-Tag <Hashtable>]
