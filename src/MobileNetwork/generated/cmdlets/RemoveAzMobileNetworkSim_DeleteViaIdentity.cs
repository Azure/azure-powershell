...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzMobileNetworkSim_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzMobileNetworkSim_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzMobileNetworkSim_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets.RemoveAzMobileNetworkSim_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzMobileNetworkSim_DeleteViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.SimsDeleteViaIdentity(InputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.SimName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.SimName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.SimsDelete(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.SimGroupName ?? null, InputObject.SimName ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzMobileNetworkSim_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzMobileNetworkSim_DeleteViaIdentity()
        {
