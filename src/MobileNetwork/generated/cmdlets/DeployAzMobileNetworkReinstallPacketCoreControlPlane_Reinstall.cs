...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Reinstall=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/packetCoreControlPlanes/{packetCoreControlPlaneName}/reinstall"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet("Deploy", @"AzMobileNetworkReinstallPacketCoreControlPlane_Reinstall", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Description(@"Reinstall the specified packet core control plane. This action will remove any transaction state from the packet core to return it to a known state. This action will cause a service outage.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Generated]
    public partial class DeployAzMobileNetworkReinstallPacketCoreControlPlane_Reinstall : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of DeployAzMobileNetworkReinstallPacketCoreControlPlane_Reinstall
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets.DeployAzMobileNetworkReinstallPacketCoreControlPlane_Reinstall Clone()
        {
            var clone = new DeployAzMobileNetworkReinstallPacketCoreControlPlane_Reinstall();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="DeployAzMobileNetworkReinstallPacketCoreControlPlane_Reinstall" /> cmdlet
        /// class.
        /// </summary>
        public DeployAzMobileNetworkReinstallPacketCoreControlPlane_Reinstall()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PacketCoreControlPlanesReinstall' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PacketCoreControlPlanesReinstall(ResourceGroupName, PacketCoreControlPlaneName, SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,PacketCoreControlPlaneName=PacketCoreControlPlaneName,SubscriptionId=SubscriptionId})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, PacketCoreControlPlaneName=PacketCoreControlPlaneName, SubscriptionId=SubscriptionId })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, PacketCoreControlPlaneName=PacketCoreControlPlaneName, SubscriptionId=SubscriptionId })
                    {
