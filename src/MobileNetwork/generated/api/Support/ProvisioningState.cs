...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Support.ProvisioningState Accepted = @"Accepted";

        public static Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Support.ProvisioningState Deleted = @"Deleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Support.ProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Support.ProvisioningState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Support.ProvisioningState Unknown = @"Unknown";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
