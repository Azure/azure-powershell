...
<<<<<<< HEAD
            $SliceConfiguration = New-AzMobileNetworkSliceConfigurationObject -DataNetworkConfiguration $DataNetworkConfiguration -DefaultDataNetworkId "/subscriptions/$($env.SubscriptionId)/resourceGroups/$($env.resourceGroup)/providers/Microsoft.MobileNetwork/mobileNetworks/$($env.testNetwork2)/dataNetworks/$($env.testDataNetwork)" -SlouseId "/subscriptions/$($env.SubscriptionId)/resourceGroups/$($env.resourceGroup)/providers/Microsoft.MobileNetwork/mobileNetworks/$($env.testNetwork2)/slices/$($env.testSlice)"
            $config = New-AzMobileNetworkSimPolicy -MobileNetworkName $env.testNetwork2 -Name $env.testSimPolicy -ResourceGroupName $env.resourceGroup -Location $env.location -DefaultSlouseId "/subscriptions/$($env.SubscriptionId)/resourceGroups/$($env.resourceGroup)/providers/Microsoft.MobileNetwork/mobileNetworks/$($env.testNetwork2)/slices/$($env.testSlice)" -SliceConfiguration $SliceConfiguration -UeAmbrDownlink "1 Gbps" -UeAmbrUplink "500 Mbps" -RegistrationTimer 3240
=======
