...
New-AzMobileNetworkSlice -MobileNetworkName <String> -ResourceGroupName <String> -SliceName <String>
 [-SubscriptionId <String>] -Location <String> -SnssaiSst <Int32> [-Description <String>] [-SnssaiSd <String>]
...
```
New-AzMobileNetworkSlice -SliceName <String> -MobileNetworkInputObject <IMobileNetworkIdentity>
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded, CreateViaIdentityMobileNetworkExpanded, CreateViaIdentityExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded, CreateViaJsonString, CreateViaJsonFilePath, CreateViaIdentityMobileNetworkExpanded
Aliases:
