...
```
Update-AzMobileNetworkSlice -SliceName <String> -MobileNetworkInputObject <IMobileNetworkIdentity>
 -SnssaiSst <Int32> [-Description <String>] [-SnssaiSd <String>] [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Update-AzMobileNetworkSlice -InputObject <IMobileNetworkIdentity> -SnssaiSst <Int32> [-Description <String>]
 [-SnssaiSd <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
