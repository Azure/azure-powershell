...
online version: https://learn.microsoft.com/powershell/module/az.mobilenetwork/remove-azmobilenetworkdatanetwork
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzMobileNetworkDataNetwork -MobileNetworkName <String> -Name <String> -ResourceGroupName <String>
...
```
Remove-AzMobileNetworkDataNetwork -Name <String> -MobileNetworkInputObject <IMobileNetworkIdentity>
...
### DeleteViaIdentity
```
Remove-AzMobileNetworkDataNetwork -InputObject <IMobileNetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob]
