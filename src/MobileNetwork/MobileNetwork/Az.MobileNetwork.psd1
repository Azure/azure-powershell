...
RequiredAssemblies = 'MobileNetwork.Autorest/bin/Az.MobileNetwork.private.dll'
...
FormatsToProcess = 'MobileNetwork.Autorest\Az.MobileNetwork.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('MobileNetwork.Autorest/Az.MobileNetwork.psm1')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Three cmdlets were added: ''Remove-AzMobileNetworkBulkSimDelete'', ''Update-AzMobileNetworkBulkSimUpload'', ''Update-AzMobileNetworkBulkSimUploadEncrypted''.'
