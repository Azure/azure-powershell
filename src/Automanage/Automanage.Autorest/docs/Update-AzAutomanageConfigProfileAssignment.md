...
```
Update-AzAutomanageConfigProfileAssignment -ResourceGroupName <String> -VMName <String>
...
```
Update-AzAutomanageConfigProfileAssignment -ConfigurationProfileAssignmentInputObject <IAutomanageIdentity>
