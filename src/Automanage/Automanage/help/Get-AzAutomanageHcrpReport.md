...
```
Get-AzAutomanageHcrpReport -Name <String> -MachineInputObject <IAutomanageIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityConfigurationProfileAssignment
```
Get-AzAutomanageHcrpReport -Name <String> -ConfigurationProfileAssignmentInputObject <IAutomanageIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Get, GetViaIdentityMachine, GetViaIdentityConfigurationProfileAssignment
Aliases:
