...
```
New-AzAlbSecurityPolicyWaf -AlbName <String> -Name <String> -ResourceGroupName <String> -Location <String>
 -WafPolicyId <String> [-SubscriptionId <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob]
