...
```
Update-AzAlbFrontend -Name <String> -TrafficControllerInputObject <IAlbIdentity> -Property <IFrontendUpdate>
...
```
Update-AzAlbFrontend -AlbName <String> -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaJsonString
```
Update-AzAlbFrontend -AlbName <String> -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Alb.Models.IFrontendUpdate
