...
.Link
https://docs.microsoft.com/powershell/module/az.webpubsub/get-azoperation
#>
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.WebPubSub.private\Get-AzOperation_List';
        }
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            RegenerateExpanded = 'Az.WebPubSub.private\New-AzWebPubSubKey_RegenerateExpanded';
            RegenerateViaIdentityExpanded = 'Az.WebPubSub.private\New-AzWebPubSubKey_RegenerateViaIdentityExpanded';
        }
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            CreateExpanded = 'Az.WebPubSub.private\New-AzWebPubSub_CreateExpanded';
        }
