...
.Link
https://docs.microsoft.com/powershell/module/az.webpubsub/get-azwebpubsubhub
#>
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.WebPubSub.private\Get-AzWebPubSubHub_Get';
            GetViaIdentity = 'Az.WebPubSub.private\Get-AzWebPubSubHub_GetViaIdentity';
            List = 'Az.WebPubSub.private\Get-AzWebPubSubHub_List';
        }
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            List = 'Az.WebPubSub.private\Get-AzWebPubSubKey_List';
            ListViaIdentity = 'Az.WebPubSub.custom\Get-AzWebPubSubKey_ListViaIdentity';
        }
...
.Link
https://docs.microsoft.com/powershell/module/az.webpubsub/get-azwebpubsubsku
#>
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            List = 'Az.WebPubSub.private\Get-AzWebPubSubSku_List';
        }
        if (('List') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
...
.Link
https://docs.microsoft.com/powershell/module/az.webpubsub/get-azwebpubsubusage
#>
...
INPUTOBJECT <IWebPubSubIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: Gets subscription Id which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
.Link
https://docs.microsoft.com/powershell/module/az.webpubsub/get-azwebpubsub
#>
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Get = 'Az.WebPubSub.private\Get-AzWebPubSub_Get';
            GetViaIdentity = 'Az.WebPubSub.private\Get-AzWebPubSub_GetViaIdentity';
            List = 'Az.WebPubSub.private\Get-AzWebPubSub_List';
            List1 = 'Az.WebPubSub.private\Get-AzWebPubSub_List1';
        }
...
.Link
https://docs.microsoft.com/powershell/module/az.webpubsub/new-azwebpubsubhub
#>
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            CreateExpanded = 'Az.WebPubSub.private\New-AzWebPubSubHub_CreateExpanded';
        }
...
INPUTOBJECT <IWebPubSubIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: Gets subscription Id which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
.Link
https://docs.microsoft.com/powershell/module/az.webpubsub/restart-azwebpubsub
#>
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Restart = 'Az.WebPubSub.private\Restart-AzWebPubSub_Restart';
            RestartViaIdentity = 'Az.WebPubSub.private\Restart-AzWebPubSub_RestartViaIdentity';
        }
...
.Link
https://docs.microsoft.com/powershell/module/az.webpubsub/test-azwebpubsubnameavailability
#>
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            CheckExpanded = 'Az.WebPubSub.private\Test-AzWebPubSubNameAvailability_CheckExpanded';
        }
...
.Link
https://docs.microsoft.com/powershell/module/az.webpubsub/update-azwebpubsub
#>
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            UpdateExpanded = 'Az.WebPubSub.private\Update-AzWebPubSub_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.WebPubSub.private\Update-AzWebPubSub_UpdateViaIdentityExpanded';
        }
