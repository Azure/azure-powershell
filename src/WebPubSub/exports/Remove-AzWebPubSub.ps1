...
.Link
https://docs.microsoft.com/powershell/module/az.webpubsub/remove-azwebpubsub
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.WebPubSub.private\Remove-AzWebPubSub_Delete';
            DeleteViaIdentity = 'Az.WebPubSub.private\Remove-AzWebPubSub_DeleteViaIdentity';
        }
