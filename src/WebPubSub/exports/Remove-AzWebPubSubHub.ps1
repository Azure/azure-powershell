...
.Link
https://docs.microsoft.com/powershell/module/az.webpubsub/remove-azwebpubsubhub
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.WebPubSub.private\Remove-AzWebPubSubHub_Delete';
            DeleteViaIdentity = 'Az.WebPubSub.private\Remove-AzWebPubSubHub_DeleteViaIdentity';
        }
