...
online version: https://docs.microsoft.com/powershell/module/az.webpubsub/remove-azwebpubsubeventhandler
schema: 2.0.0
---

# Remove-AzWebPubSubEventHandler
...
### Delete (Default)
```
Remove-AzWebPubSubEventHandler -HubName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzWebPubSubEventHandler -InputObject <IWebPubSubIdentity> [-DefaultProfile <PSObject>] [-AsJob]
