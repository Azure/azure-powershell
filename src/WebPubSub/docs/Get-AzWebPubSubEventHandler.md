...
online version: https://docs.microsoft.com/powershell/module/az.webpubsub/get-azwebpubsubeventhandler
schema: 2.0.0
---

# Get-AzWebPubSubEventHandler
...
### List (Default)
```
Get-AzWebPubSubEventHandler -HubName <String> -ResourceGroupName <String> -ResourceName <String>
...
### GetViaIdentity
```
Get-AzWebPubSubEventHandler -InputObject <IWebPubSubIdentity> -Name <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
