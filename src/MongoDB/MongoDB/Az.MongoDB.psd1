...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added cmdlets for MongoDB Atlas Project management: ''Get-AzMongoDBProject'', ''New-AzMongoDBProject'', ''Remove-AzMongoDBProject''
...
* Added cmdlet ''Limit-AzMongoDBProject'' to retrieve project resource limits'
