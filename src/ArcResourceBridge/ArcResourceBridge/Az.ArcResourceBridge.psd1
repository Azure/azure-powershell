#
# Module manifest for module 'Az.ArcResourceBridge'
#
...
FunctionsToExport = 'Get-AzArcResourceBridge', 
               'Get-AzArcResourceBridgeApplianceCredential', 
               'Get-AzArcResourceBridgeCredential', 
               'Get-AzArcResourceBridgeTelemetryConfig', 
               'Get-AzArcResourceBridgeUpgradeGraph', 'New-AzArcResourceBridge', 
               'Remove-AzArcResourceBridge', 'Update-AzArcResourceBridge'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* General availability for module Az.ArcResourceBridge'
