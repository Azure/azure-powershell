...
.Link
https://learn.microsoft.com/powershell/module/az.devcenter/get-azdevcenterdevenvironmentdefinition
#>
function Get-AzDevCenterDevEnvironmentDefinition {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20230401.IEnvironmentDefinition])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DevCenter.private\Get-AzDevCenterDevEnvironmentDefinition_Get';
            GetViaIdentity = 'Az.DevCenter.private\Get-AzDevCenterDevEnvironmentDefinition_GetViaIdentity';
            List = 'Az.DevCenter.private\Get-AzDevCenterDevEnvironmentDefinition_List';
            List1 = 'Az.DevCenter.private\Get-AzDevCenterDevEnvironmentDefinition_List1';
        }
