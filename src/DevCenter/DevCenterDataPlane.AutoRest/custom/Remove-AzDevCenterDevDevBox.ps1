...
#>
function Remove-AzDevCenterDevDevBox {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.DevCenter.private\Remove-AzDevCenterDevDevBox_Delete';
            DeleteViaIdentity = 'Az.DevCenter.private\Remove-AzDevCenterDevDevBox_DeleteViaIdentity';
        }
