...
#>
function Start-AzDevCenterDevDevBox {
...
begin {
    try {
        ...
        $mapping = @{
            Start = 'Az.DevCenter.private\Start-AzDevCenterDevDevBox_Start';
            StartViaIdentity = 'Az.DevCenter.private\Start-AzDevCenterDevDevBox_StartViaIdentity';
        }
