...
#>
function Get-AzDevCenterDevDevBoxAction {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20230401.IDevBoxAction])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DevCenter.private\Get-AzDevCenterDevDevBoxAction_Get';
            GetViaIdentity = 'Az.DevCenter.private\Get-AzDevCenterDevDevBoxAction_GetViaIdentity';
            List = 'Az.DevCenter.private\Get-AzDevCenterDevDevBoxAction_List';
        }
