...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DevCenter.private\Get-AzDevCenterDevProject_Get';
            GetViaIdentity = 'Az.DevCenter.private\Get-AzDevCenterDevProject_GetViaIdentity';
            List = 'Az.DevCenter.private\Get-AzDevCenterDevProject_List';
        }
