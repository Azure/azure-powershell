...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.DevCenter.private\Remove-AzDevCenterDevEnvironment_Delete';
            DeleteViaIdentity = 'Az.DevCenter.private\Remove-AzDevCenterDevEnvironment_DeleteViaIdentity';
        }
