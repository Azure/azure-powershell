...
begin {
    try {
        ...
        $mapping = @{
            Create = 'Az.DevCenter.private\New-AzDevCenterDevEnvironment_Create';
            CreateExpanded = 'Az.DevCenter.private\New-AzDevCenterDevEnvironment_CreateExpanded';
            CreateViaIdentity = 'Az.DevCenter.private\New-AzDevCenterDevEnvironment_CreateViaIdentity';
            CreateViaIdentityExpanded = 'Az.DevCenter.private\New-AzDevCenterDevEnvironment_CreateViaIdentityExpanded';
        }
