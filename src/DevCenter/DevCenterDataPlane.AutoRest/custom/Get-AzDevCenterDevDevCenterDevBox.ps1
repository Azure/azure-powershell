...
.Link
https://learn.microsoft.com/powershell/module/az.devcenter/get-azdevcenterdevdevcenterdevbox
#>
function Get-AzDevCenterDevDevCenterDevBox {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.DevCenter.private\Get-AzDevCenterDevDevCenterDevBox_List';
            List1 = 'Az.DevCenter.private\Get-AzDevCenterDevDevCenterDevBox_List1';
        }
