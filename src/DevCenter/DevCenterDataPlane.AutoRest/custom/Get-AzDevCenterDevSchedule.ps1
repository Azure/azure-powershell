...
.Link
https://learn.microsoft.com/powershell/module/az.devcenter/get-azdevcenterdevschedule
#>
function Get-AzDevCenterDevSchedule {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DevCenter.private\Get-AzDevCenterDevSchedule_Get';
            GetViaIdentity = 'Az.DevCenter.private\Get-AzDevCenterDevSchedule_GetViaIdentity';
            List = 'Az.DevCenter.private\Get-AzDevCenterDevSchedule_List';
        }
