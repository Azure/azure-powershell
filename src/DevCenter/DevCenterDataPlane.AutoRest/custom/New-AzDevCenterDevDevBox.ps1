...
begin {
    try {
        ...
        $mapping = @{
            Create = 'Az.DevCenter.private\New-AzDevCenterDevDevBox_Create';
            CreateExpanded = 'Az.DevCenter.private\New-AzDevCenterDevDevBox_CreateExpanded';
            CreateViaIdentity = 'Az.DevCenter.private\New-AzDevCenterDevDevBox_CreateViaIdentity';
            CreateViaIdentityExpanded = 'Az.DevCenter.private\New-AzDevCenterDevDevBox_CreateViaIdentityExpanded';
        }
