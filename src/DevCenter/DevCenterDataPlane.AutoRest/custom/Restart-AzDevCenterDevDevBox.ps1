...
begin {
    try {
        ...
        $mapping = @{
            Restart = 'Az.DevCenter.private\Restart-AzDevCenterDevDevBox_Restart';
            RestartViaIdentity = 'Az.DevCenter.private\Restart-AzDevCenterDevDevBox_RestartViaIdentity';
        }
