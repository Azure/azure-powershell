...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DevCenter.private\Get-AzDevCenterDevEnvironment_Get';
            GetViaIdentity = 'Az.DevCenter.private\Get-AzDevCenterDevEnvironment_GetViaIdentity';
            List = 'Az.DevCenter.private\Get-AzDevCenterDevEnvironment_List';
            List1 = 'Az.DevCenter.private\Get-AzDevCenterDevEnvironment_List1';
        }
