...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/get-azdevcenterdevdevboxaction
schema: 2.0.0
---

# Get-AzDevCenterDevDevBoxAction
...
### GetViaIdentity
```
Get-AzDevCenterDevDevBoxAction -Endpoint <String> -InputObject <IDevCenterIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityByDevCenter
```
Get-AzDevCenterDevDevBoxAction -DevCenter <String> -InputObject <IDevCenterIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
