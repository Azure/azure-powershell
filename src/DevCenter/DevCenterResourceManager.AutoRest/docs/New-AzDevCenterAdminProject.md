...
### Create
```
New-AzDevCenterAdminProject -Name <String> -ResourceGroupName <String> -Body <IProject>
...
### CreateViaIdentity
```
New-AzDevCenterAdminProject -InputObject <IDevCenterIdentity> -Body <IProject> [-DefaultProfile <PSObject>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20230401.IProject
