...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/set-azdevcenteradminnetworkconnection
schema: 2.0.0
---

# Set-AzDevCenterAdminNetworkConnection
...
```
Set-AzDevCenterAdminNetworkConnection -Name <String> -ResourceGroupName <String> -Location <String>
...
### Update
```
Set-AzDevCenterAdminNetworkConnection -Name <String> -ResourceGroupName <String> -Body <INetworkConnection>
