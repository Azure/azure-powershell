...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/set-azadmindevcenter
schema: 2.0.0
---

# Set-AzAdminDevCenter
...
```
Set-AzAdminDevCenter -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
...
### Update
```
Set-AzAdminDevCenter -Name <String> -ResourceGroupName <String> -Body <IDevCenter> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api202301Preview.IDevCenter
...
### Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api202301Preview.IDevCenter
