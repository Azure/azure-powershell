...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/new-azadminproject
schema: 2.0.0
---
...
```
New-AzAdminProject -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
...
### Create
```
New-AzAdminProject -Name <String> -ResourceGroupName <String> -Body <IProject> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzAdminProject -InputObject <IDevCenterIdentity> -Body <IProject> [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzAdminProject -InputObject <IDevCenterIdentity> -Location <String> [-Description <String>]
