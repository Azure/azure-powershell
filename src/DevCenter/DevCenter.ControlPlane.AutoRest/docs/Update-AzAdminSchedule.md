...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/update-azadminschedule
schema: 2.0.0
---

# Update-AzAdminSchedule
...
```
Update-AzAdminSchedule -Name <String> -PoolName <String> -ProjectName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-Top <Int32>] [-Frequency <ScheduledFrequency>] [-Location <String>]
...
```
Update-AzAdminSchedule -Name <String> -PoolName <String> -ProjectName <String> -ResourceGroupName <String>
 -Body <IScheduleUpdate> [-SubscriptionId <String>] [-Top <Int32>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-AzAdminSchedule -InputObject <IDevCenterIdentity> -Body <IScheduleUpdate> [-Top <Int32>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAdminSchedule -InputObject <IDevCenterIdentity> [-Top <Int32>] [-Frequency <ScheduledFrequency>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api202301Preview.IScheduleUpdate
...
### Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api202301Preview.IScheduleUpdate
