...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/update-azadminprojectenvironmenttype
schema: 2.0.0
---

# Update-AzAdminProjectEnvironmentType
...
```
Update-AzAdminProjectEnvironmentType -EnvironmentTypeName <String> -ProjectName <String>
...
### UpdateViaIdentity
```
Update-AzAdminProjectEnvironmentType -InputObject <IDevCenterIdentity> -Body <IProjectEnvironmentTypeUpdate>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAdminProjectEnvironmentType -InputObject <IDevCenterIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api202301Preview.IProjectEnvironmentTypeUpdate
...
### Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api202301Preview.IProjectEnvironmentTypeUpdate
