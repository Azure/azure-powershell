...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/set-azadminnetworkconnection
schema: 2.0.0
---

# Set-AzAdminNetworkConnection
...
```
Set-AzAdminNetworkConnection -Name <String> -ResourceGroupName <String> -Location <String>
...
### Update
```
Set-AzAdminNetworkConnection -Name <String> -ResourceGroupName <String> -Body <INetworkConnection>
