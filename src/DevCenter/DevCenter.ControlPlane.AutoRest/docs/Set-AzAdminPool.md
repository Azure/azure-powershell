...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/set-azadminpool
schema: 2.0.0
---
...
```
Set-AzAdminPool -Name <String> -ProjectName <String> -ResourceGroupName <String> -Location <String>
...
### Update
```
Set-AzAdminPool -Name <String> -ProjectName <String> -ResourceGroupName <String> -Body <IPool>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api202301Preview.IPool
