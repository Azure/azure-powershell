...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/set-azadmindevboxdefinition
schema: 2.0.0
---

# Set-AzAdminDevBoxDefinition
...
```
Set-AzAdminDevBoxDefinition -DevCenterName <String> -Name <String> -ResourceGroupName <String>
