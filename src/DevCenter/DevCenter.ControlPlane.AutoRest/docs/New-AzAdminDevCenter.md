...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/new-azadmindevcenter
schema: 2.0.0
---

# New-AzAdminDevCenter
...
```
New-AzAdminDevCenter -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
...
### Create
```
New-AzAdminDevCenter -Name <String> -ResourceGroupName <String> -Body <IDevCenter> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzAdminDevCenter -InputObject <IDevCenterIdentity> -Body <IDevCenter> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzAdminDevCenter -InputObject <IDevCenterIdentity> -Location <String>
 [-IdentityType <ManagedServiceIdentityType>] [-IdentityUserAssignedIdentity <Hashtable>] [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
