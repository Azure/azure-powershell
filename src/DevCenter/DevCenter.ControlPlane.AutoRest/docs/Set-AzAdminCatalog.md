...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/set-azadmincatalog
schema: 2.0.0
---
...
```
Set-AzAdminCatalog -DevCenterName <String> -Name <String> -ResourceGroupName <String>
...
### Update
```
Set-AzAdminCatalog -DevCenterName <String> -Name <String> -ResourceGroupName <String> -Body <ICatalog>
