...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/new-azadminpool
schema: 2.0.0
---
...
```
New-AzAdminPool -Name <String> -ProjectName <String> -ResourceGroupName <String> -Location <String>
...
### Create
```
New-AzAdminPool -Name <String> -ProjectName <String> -ResourceGroupName <String> -Body <IPool>
...
### CreateViaIdentity
```
New-AzAdminPool -InputObject <IDevCenterIdentity> -Body <IPool> [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzAdminPool -InputObject <IDevCenterIdentity> -Location <String> [-DevBoxDefinitionName <String>]
