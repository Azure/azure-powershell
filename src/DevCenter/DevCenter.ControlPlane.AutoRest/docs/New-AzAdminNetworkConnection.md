...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/new-azadminnetworkconnection
schema: 2.0.0
---

# New-AzAdminNetworkConnection
...
```
New-AzAdminNetworkConnection -Name <String> -ResourceGroupName <String> -Location <String>
...
### Create
```
New-AzAdminNetworkConnection -Name <String> -ResourceGroupName <String> -Body <INetworkConnection>
...
### CreateViaIdentity
```
New-AzAdminNetworkConnection -InputObject <IDevCenterIdentity> -Body <INetworkConnection>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzAdminNetworkConnection -InputObject <IDevCenterIdentity> -Location <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api202301Preview.INetworkConnection
