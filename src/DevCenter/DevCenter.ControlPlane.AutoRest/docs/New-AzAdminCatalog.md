...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/new-azadmincatalog
schema: 2.0.0
---
...
```
New-AzAdminCatalog -DevCenterName <String> -Name <String> -ResourceGroupName <String>
...
### Create
```
New-AzAdminCatalog -DevCenterName <String> -Name <String> -ResourceGroupName <String> -Body <ICatalog>
...
### CreateViaIdentity
```
New-AzAdminCatalog -InputObject <IDevCenterIdentity> -Body <ICatalog> [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzAdminCatalog -InputObject <IDevCenterIdentity> [-AdoGitBranch <String>] [-AdoGitPath <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api202301Preview.ICatalog
