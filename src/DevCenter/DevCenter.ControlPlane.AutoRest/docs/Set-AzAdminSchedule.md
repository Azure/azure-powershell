...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/set-azadminschedule
schema: 2.0.0
---
...
```
Set-AzAdminSchedule -Name <String> -PoolName <String> -ProjectName <String> -ResourceGroupName <String>
