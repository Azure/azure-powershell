...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/update-azadmindevcenter
schema: 2.0.0
---

# Update-AzAdminDevCenter
...
```
Update-AzAdminDevCenter -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### Update
```
Update-AzAdminDevCenter -Name <String> -ResourceGroupName <String> -Body <IDevCenterUpdate>
...
### UpdateViaIdentity
```
Update-AzAdminDevCenter -InputObject <IDevCenterIdentity> -Body <IDevCenterUpdate>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAdminDevCenter -InputObject <IDevCenterIdentity> [-IdentityType <ManagedServiceIdentityType>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api202301Preview.IDevCenterUpdate
...
### Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api202301Preview.IDevCenterUpdate
