...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/sync-azdevcenteradmincatalog
schema: 2.0.0
---
...
### Sync (Default)
```
Sync-AzDevCenterAdminCatalog -DevCenterName <String> -Name <String> -ResourceGroupName <String>
