...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/new-azdevcenteradminplan
schema: 2.0.0
---
...
```
New-AzDevCenterAdminPlan -Name <String> -ResourceGroupName <String> -Location <String>
...
```
New-AzDevCenterAdminPlan -InputObject <IDevCenterIdentity> -Location <String> [-SkuCapacity <Int32>]
