...
```
New-AzDevCenterAdminEnvironmentType -DevcenterInputObject <IDevCenterIdentity> -Name <String>
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded, CreateViaIdentityDevcenterExpanded, CreateViaJsonFilePath, CreateViaJsonString
