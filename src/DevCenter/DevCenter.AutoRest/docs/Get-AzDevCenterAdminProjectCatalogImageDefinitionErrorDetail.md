...
```
Get-AzDevCenterAdminProjectCatalogImageDefinitionErrorDetail -CatalogInputObject <IDevCenterIdentity>
 -ImageDefinitionName <String> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
