...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/get-azdevcenteradminprojectenvironmentdefinitionerrordetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzDevCenterAdminProjectEnvironmentDefinitionErrorDetail -CatalogName <String>
 -EnvironmentDefinitionName <String> -ProjectName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDevCenterAdminProjectEnvironmentDefinitionErrorDetail -InputObject <IDevCenterIdentity>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentityCatalog
```
Get-AzDevCenterAdminProjectEnvironmentDefinitionErrorDetail -CatalogInputObject <IDevCenterIdentity>
...
```
Get-AzDevCenterAdminProjectEnvironmentDefinitionErrorDetail -CatalogName <String>
 -EnvironmentDefinitionName <String> -ProjectInputObject <IDevCenterIdentity> [-DefaultProfile <PSObject>]
...
```yaml
Type: System.String
Parameter Sets: Get, GetViaIdentityCatalog, GetViaIdentityProject
Aliases:
