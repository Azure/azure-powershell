...
```
Get-AzDevCenterAdminProjectEnvironmentDefinition -CatalogInputObject <IDevCenterIdentity>
 -EnvironmentDefinitionName <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
