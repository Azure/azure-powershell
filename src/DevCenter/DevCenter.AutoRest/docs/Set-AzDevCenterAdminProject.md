...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/set-azdevcenteradminproject
schema: 2.0.0
---

# Set-AzDevCenterAdminProject
...
```
Set-AzDevCenterAdminProject -Name <String> -ResourceGroupName <String> -Location <String>
...
### Update
```
Set-AzDevCenterAdminProject -Name <String> -ResourceGroupName <String> -Body <IProject>
