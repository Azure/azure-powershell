...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/connect-azdevcenteradminprojectcatalog
schema: 2.0.0
---
...
### Connect (Default)
```
Connect-AzDevCenterAdminProjectCatalog -CatalogName <String> -ProjectName <String> -ResourceGroupName <String>
