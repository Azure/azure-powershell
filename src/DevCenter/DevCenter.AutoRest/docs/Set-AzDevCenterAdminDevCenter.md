...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/set-azdevcenteradmindevcenter
schema: 2.0.0
---

# Set-AzDevCenterAdminDevCenter
...
```
Set-AzDevCenterAdminDevCenter -Name <String> -ResourceGroupName <String> -Location <String>
...
### Update
```
Set-AzDevCenterAdminDevCenter -Name <String> -ResourceGroupName <String> -Body <IDevCenter>
