...
### Create
```
New-AzDevCenterAdminDevCenter -Name <String> -ResourceGroupName <String> -Body <IDevCenter>
...
### CreateViaIdentity
```
New-AzDevCenterAdminDevCenter -InputObject <IDevCenterIdentity> -Body <IDevCenter>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20230401.IDevCenter
