...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview
{
    ...
    public partial class Encryption
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonObject into a new instance of <see cref="Encryption" />.
        /// </summary>
        ...
        internal Encryption(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonObject json)
        {
            ...
            {_customerManagedKeyEncryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonObject>("customerManagedKeyEncryption"), out var __jsonCustomerManagedKeyEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api40.CustomerManagedKeyEncryption.FromJson(__jsonCustomerManagedKeyEncryption) : CustomerManagedKeyEncryption;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IEncryption.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IEncryption.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IEncryption FromJson(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonObject json ? new Encryption(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="Encryption" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Encryption" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._customerManagedKeyEncryption ? (Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode) this._customerManagedKeyEncryption.ToJson(null,serializationMode) : null, "customerManagedKeyEncryption" ,container.Add );
