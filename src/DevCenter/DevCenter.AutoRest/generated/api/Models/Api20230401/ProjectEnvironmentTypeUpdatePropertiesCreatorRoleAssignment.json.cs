...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20230401
{
    ...
    public partial class ProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignment
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20230401.IProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignment.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20230401.IProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignment.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20230401.IProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignment FromJson(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode node)
        {
        ...
        internal ProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignment(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonObject json)
        {
            ...
            {_role = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonObject>("roles"), out var __jsonRoles) ? Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20230401.ProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignmentRoles.FromJson(__jsonRoles) : Role;}
            AfterFromJson(json);
        }
