...
Describe 'Get-AzDevCenterAdminProjectEnvironmentDefinition' {
    It 'List' {
        $listOfEnvironmentDefinitions = Get-AzDevCenterAdminProjectEnvironmentDefinition -ProjectName $env.projectName20 -CatalogName $env.catalogName20 -ResourceGroupName $env.resourceGroupName20
