...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/approve-azdevcenteruserdevbox
schema: 2.0.0
---

# Approve-AzDevCenterUserDevBox
...
### Approve (Default)
```
Approve-AzDevCenterUserDevBox -Endpoint <String> -Name <String> -ProjectName <String> -UserId <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ApproveByDevCenter
```
Approve-AzDevCenterUserDevBox -DevCenterName <String> -Name <String> -ProjectName <String> -UserId <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ApproveViaIdentity
```
Approve-AzDevCenterUserDevBox -Endpoint <String> -InputObject <IDevCenterdataIdentity>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ApproveViaIdentityByDevCenter
```
Approve-AzDevCenterUserDevBox -DevCenterName <String> -InputObject <IDevCenterdataIdentity>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: ApproveByDevCenter, ApproveViaIdentityByDevCenter
Aliases: DevCenter
...
Parameter Sets: ApproveViaIdentity, ApproveViaIdentityByDevCenter
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Approve, ApproveByDevCenter
Aliases: DevBoxName
