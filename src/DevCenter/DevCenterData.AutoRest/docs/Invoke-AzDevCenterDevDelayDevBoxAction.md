...
### DelayViaIdentity
```
Invoke-AzDevCenterDevDelayDevBoxAction -Endpoint <String> -InputObject <IDevCenterdataIdentity>
 -DelayTime <TimeSpan> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DelayViaIdentityByDevCenter
```
Invoke-AzDevCenterDevDelayDevBoxAction -DevCenter <String> -InputObject <IDevCenterdataIdentity>
 -DelayTime <TimeSpan> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
