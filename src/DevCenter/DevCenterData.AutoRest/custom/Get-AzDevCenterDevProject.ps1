...
.Link
https://learn.microsoft.com/powershell/module/az.devcenter/get-azdevcenterdevproject
#>
function Get-AzDevCenterDevProject {
    ...
    process {
        ...
        Az.DevCenterdata.internal\Get-AzDevCenterDevProject @PSBoundParameters
    }
}
