...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20230701Preview.IPool
.Notes
...
function Get-AzDevCenterUserPool {
    [OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20230701Preview.IPool])]
    ...
    process {
        ...
        Az.DevCenterdata.internal\Get-AzDevCenterUserPool @PSBoundParameters
    }
}
