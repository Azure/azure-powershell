...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview
{
    ...
    public partial class HardwareProfile :
        Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IHardwareProfile,
        Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IHardwareProfileInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IHardwareProfileInternal.MemoryGb { get => this._memoryGb; set { {_memoryGb = value;} } }

        /// <summary>Internal Acessors for SkuName</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Support.SkuName? Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IHardwareProfileInternal.SkuName { get => this._skuName; set { {_skuName = value;} } }

        /// <summary>Internal Acessors for VCpUs</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IHardwareProfileInternal.VCpUs { get => this._vCpUs; set { {_vCpUs = value;} } }

        /// <summary>Backing field for <see cref="SkuName" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Support.SkuName? _skuName;

        /// <summary>The name of the SKU.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Origin(Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Support.SkuName? SkuName { get => this._skuName; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Support.SkuName? SkuName { get;  }
        /// <summary>The number of vCPUs available for the Dev Box.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        /// <summary>The name of the SKU.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Support.SkuName? SkuName { get; set; }
        /// <summary>The number of vCPUs available for the Dev Box.</summary>
        int? VCpUs { get; set; }
