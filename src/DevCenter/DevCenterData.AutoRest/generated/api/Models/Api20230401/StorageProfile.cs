...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20230401
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20230401.IStorageProfileInternal
    {
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20230401.IOSDisk OSDisk { get => (this._oSDisk = this._oSDisk ?? new Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20230401.OSDisk()); set => this._oSDisk = value; }
        ...
        public int? OSDiskSizeGb { get => ((Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20230401.IOSDiskInternal)OSDisk).DiskSizeGb; }
    ...
    {
        /// <summary>Settings for the operating system disk.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20230401.IOSDisk OSDisk { get; set; }
        /// <summary>The size of the OS Disk in gigabytes.</summary>
