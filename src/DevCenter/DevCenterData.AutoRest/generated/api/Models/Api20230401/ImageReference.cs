...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20230401
{
    ...
    public partial class ImageReference :
        Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20230401.IImageReference,
        Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20230401.IImageReferenceInternal
    {

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20230401.IImageReferenceInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for OSBuildNumber</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20230401.IImageReferenceInternal.OSBuildNumber { get => this._oSBuildNumber; set { {_oSBuildNumber = value;} } }

        /// <summary>Internal Acessors for OperatingSystem</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20230401.IImageReferenceInternal.OperatingSystem { get => this._operatingSystem; set { {_operatingSystem = value;} } }

        /// <summary>Internal Acessors for PublishedDate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20230401.IImageReferenceInternal.PublishedDate { get => this._publishedDate; set { {_publishedDate = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20230401.IImageReferenceInternal.Version { get => this._version; set { {_version = value;} } }
