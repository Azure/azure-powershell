...
Describe 'New-AzDevCenterUserDevBox' {
    ...
    It 'Create' -skip {
        ...
        $devBox = New-AzDevCenterUserDevBox -Endpoint $env.endpoint -Name "devbox3" -ProjectName $env.projectName -Body $devBoxBody
        ...
        $devBox = New-AzDevCenterUserDevBox -DevCenter $env.devCenterName -Name "devbox4" -ProjectName $env.projectName -Body $devBoxBody
    ...
    It 'CreateViaIdentity' -skip {
        ...
        $devBox = New-AzDevCenterUserDevBox -Endpoint $env.endpoint -InputObject  $devBoxInput -Body $devBoxBody
        ...
        $devBox = New-AzDevCenterUserDevBox -DevCenter $env.devCenterName -InputObject  $devBoxInput2 -Body $devBoxBody
