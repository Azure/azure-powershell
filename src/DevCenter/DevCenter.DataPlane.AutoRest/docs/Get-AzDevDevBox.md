...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/get-azdevdevbox
schema: 2.0.0
---
...
### Get
```
Get-AzDevDevBox -Endpoint <String> -Name <String> -ProjectName <String> -UserId <String>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
