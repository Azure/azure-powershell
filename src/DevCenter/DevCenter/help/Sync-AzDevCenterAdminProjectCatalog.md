...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/sync-azdevcenteradminprojectcatalog
schema: 2.0.0
---
...
### Sync (Default)
```
Sync-AzDevCenterAdminProjectCatalog -CatalogName <String> -ProjectName <String> -ResourceGroupName <String>
...
### SyncViaIdentity
```
Sync-AzDevCenterAdminProjectCatalog -InputObject <IDevCenterIdentity> [-DefaultProfile <PSObject>] [-AsJob]
