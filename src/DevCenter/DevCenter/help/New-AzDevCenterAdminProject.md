...
New-AzDevCenterAdminProject -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Location <String> -DevCenterId <String> [-CatalogSettingCatalogItemSyncType <CatalogItemType[]>]
 [-Description <String>] [-DisplayName <String>] [-IdentityType <ManagedServiceIdentityType>]
 [-IdentityUserAssignedIdentity <Hashtable>] [-MaxDevBoxesPerUser <Int32>] [-Tag <Hashtable>]
