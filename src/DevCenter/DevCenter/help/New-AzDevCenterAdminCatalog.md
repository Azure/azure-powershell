...
New-AzDevCenterAdminCatalog -DevCenterName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-AdoGitPath <String>] [-SyncType <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```
New-AzDevCenterAdminCatalog -DevCenterName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-SyncType <String>] [-Tag <Hashtable>] -GitHubSecretIdentifier <String>
...
```
New-AzDevCenterAdminCatalog -InputObject <IDevCenterIdentity> [-SyncType <String>] [-Tag <Hashtable>]
