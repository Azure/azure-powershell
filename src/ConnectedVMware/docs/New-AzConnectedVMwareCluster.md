...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConnectedVMware.Models.Api20220110Preview.ICluster
...
`BODY <ICluster>`: Define the cluster.
  ...
  - `[Tag <IClusterTags>]`: Gets or sets the Resource tags.
