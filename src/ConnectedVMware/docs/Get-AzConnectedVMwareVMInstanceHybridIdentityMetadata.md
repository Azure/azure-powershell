...
### GetViaIdentity
```
Get-AzConnectedVMwareVMInstanceHybridIdentityMetadata -InputObject <IConnectedVMwareIdentity>
...
### Microsoft.Azure.PowerShell.Cmdlets.ConnectedVMware.Models.Api20231001.IVMInstanceHybridIdentityMetadata
