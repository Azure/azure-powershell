...
online version: https://docs.microsoft.com/powershell/module/az.connectedvmware/new-azconnectedvmwarevirtualmachinetemplate
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConnectedVMware.Models.Api20220110Preview.IVirtualMachineTemplate
...
`BODY <IVirtualMachineTemplate>`: Define the virtualMachineTemplate.
  ...
  - `[Tag <IVirtualMachineTemplateTags>]`: Gets or sets the Resource tags.
