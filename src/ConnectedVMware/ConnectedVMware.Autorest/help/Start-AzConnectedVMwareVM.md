...
online version: https://learn.microsoft.com/powershell/module/az.connectedvmware/start-azconnectedvmwarevm
schema: 2.0.0
---
...
```
Start-AzConnectedVMwareVM -MachineId <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
