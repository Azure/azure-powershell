...
online version: https://learn.microsoft.com/powershell/module/az.connectedvmware/remove-azconnectedvmwarehost
schema: 2.0.0
---
...
This command delete a Host named `test-host` from a resource group named `test-rg`.
