...
online version: https://learn.microsoft.com/powershell/module/az.connectedvmware/update-azconnectedvmwarevmguestagent
schema: 2.0.0
---
...
```
Update-AzConnectedVMwareVMGuestAgent -MachineId <String> [-CredentialsPassword <SecureString>]
