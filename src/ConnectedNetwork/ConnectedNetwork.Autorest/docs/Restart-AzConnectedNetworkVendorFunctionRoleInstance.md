...
online version: https://learn.microsoft.com/powershell/module/az.connectednetwork/restart-azconnectednetworkvendorfunctionroleinstance
schema: 2.0.0
---
...
```
Restart-AzConnectedNetworkVendorFunctionRoleInstance -LocationInputObject <IConnectedNetworkIdentity>
...
```yaml
Type: System.String
Parameter Sets: Restart, RestartViaIdentityLocation, RestartViaIdentityNetworkFunction, RestartViaIdentityVendor
...
```yaml
Type: System.String
Parameter Sets: Restart, RestartViaIdentityLocation, RestartViaIdentityVendor
Aliases:
