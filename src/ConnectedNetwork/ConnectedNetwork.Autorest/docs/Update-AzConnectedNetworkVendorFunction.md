...
```
Update-AzConnectedNetworkVendorFunction -LocationName <String> -ServiceKey <String> -VendorName <String>
...
```
Update-AzConnectedNetworkVendorFunction -LocationInputObject <IConnectedNetworkIdentity> -ServiceKey <String>
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityLocationExpanded, UpdateViaIdentityVendorExpanded
Aliases:
