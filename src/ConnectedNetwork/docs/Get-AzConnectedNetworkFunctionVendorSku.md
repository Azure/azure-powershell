...
online version: https://docs.microsoft.com/powershell/module/az.connectednetwork/get-azconnectednetworkfunctionvendorsku
schema: 2.0.0
---

# Get-AzConnectedNetworkFunctionVendorSku
...
### List (Default)
```
Get-AzConnectedNetworkFunctionVendorSku -VendorName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### List1
```
Get-AzConnectedNetworkFunctionVendorSku -VendorName <String> -VendorSkuName <String>
