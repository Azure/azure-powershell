...
Describe 'AzConnectedNetworkVendorSkuPreview' {
    It 'CreateExpanded' {
        {
            ...
            $config = New-AzConnectedNetworkVendorSkuPreview -PreviewSubscription $env.PreviewSubscription -SkuName "sku123" -VendorName $env.VendorName3 -SubscriptionId $env.subscriptionId
    ...
    It 'Get' {
        {
            $config = Get-AzConnectedNetworkVendorSkuPreview -PreviewSubscription $env.PreviewSubscription -SkuName "sku123" -VendorName $env.VendorName3
            $config.Count | Should -BeGreaterThan 0
        } | Should -Not -Throw
    }
    ...
    It 'Delete' {
        {
            Remove-AzConnectedNetworkVendorSkuPreview -PreviewSubscription $env.PreviewSubscription -SkuName "sku123" -VendorName $env.VendorName3
        } | Should -Not -Throw
    }
}
