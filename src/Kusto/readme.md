...
directive:
  ...
  - where:
      variant: ^Add$|^AddViaIdentity$|^Check$|^CheckViaIdentity$|^Create$|^CreateViaIdentity$|^CreateViaIdentityExpanded$|^DataExpanded$|^DataViaIdentityExpanded$|^Detach$|^DetachViaIdentity$|^Update$|^UpdateViaIdentity$
    remove: true
