Describe 'New-AzKustoManagedPrivateEndpoint' {
    ...
    It 'CreateExpanded' {        
        $privateLinkResourceId = "/subscriptions/" + $env.networkClustersTestsSubscriptionId + "/resourceGroups/" + $env.resourceGroupNamefordc + "/providers/Microsoft.EventHub/namespaces/" + $env.eventhubNameformpe
