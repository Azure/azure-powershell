...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzKustoSandboxCustomImage_List" /> cmdlet class.
        /// </summary>
        public GetAzKustoSandboxCustomImage_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SandboxCustomImagesListByCluster(ResourceGroupName, ClusterName, SubscriptionId, onOk, onDefault, this, Pipeline);
