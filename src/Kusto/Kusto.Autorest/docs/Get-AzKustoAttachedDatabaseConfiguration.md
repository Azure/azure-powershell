...
online version: https://learn.microsoft.com/powershell/module/az.kusto/get-azkustoattacheddatabaseconfiguration
schema: 2.0.0
---
...
```
Get-AzKustoAttachedDatabaseConfiguration -ClusterInputObject <IKustoIdentity> -Name <String>
