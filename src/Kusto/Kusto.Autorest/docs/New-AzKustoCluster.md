...
```
New-AzKustoCluster -Name <String> -ResourceGroupName <String> -Location <String> -SkuName <String>
 -SkuTier <String> [-SubscriptionId <String>] [-IfMatch <String>] [-IfNoneMatch <String>]
 ...
 [-EnablePurge] [-EnableStreamingIngest] [-EnableSystemAssignedIdentity] [-EngineType <String>]
 ...
 [-RestrictOutboundNetworkAccess <String>] [-SkuCapacity <Int32>] [-Tag <Hashtable>]
 ...
 [-VirtualNetworkConfigurationEnginePublicIPId <String>] [-VirtualNetworkConfigurationState <String>]
...
```
New-AzKustoCluster -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### CreateViaJsonString
```
New-AzKustoCluster -Name <String> -ResourceGroupName <String> -JsonString <String> [-SubscriptionId <String>]
