...
```
New-AzKustoManagedPrivateEndpoint -ClusterInputObject <IKustoIdentity> -Name <String>
...
```
New-AzKustoManagedPrivateEndpoint -ClusterInputObject <IKustoIdentity> -Name <String> [-GroupId <String>]
