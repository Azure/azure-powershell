...
online version: https://learn.microsoft.com/powershell/module/az.kusto/remove-azkustoclusterprincipalassignment
schema: 2.0.0
---
...
```
Remove-AzKustoClusterPrincipalAssignment -ClusterInputObject <IKustoIdentity>
 -PrincipalAssignmentName <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm]
