...
online version: https://learn.microsoft.com/powershell/module/az.kusto/remove-azkustosandboxcustomimage
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzKustoSandboxCustomImage -ClusterName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzKustoSandboxCustomImage -InputObject <IKustoIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentityCluster
```
Remove-AzKustoSandboxCustomImage -ClusterInputObject <IKustoIdentity> -Name <String>
