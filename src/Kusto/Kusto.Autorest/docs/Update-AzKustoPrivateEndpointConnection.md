...
```
Update-AzKustoPrivateEndpointConnection -ClusterInputObject <IKustoIdentity> -Name <String>
...
```yaml
Type: System.String
Parameter Sets: Update, UpdateExpanded, UpdateViaIdentityCluster, UpdateViaIdentityClusterExpanded
