...
```
Test-AzKustoScriptNameAvailability -ClusterInputObject <IKustoIdentity> -DatabaseName <String> -Name <String>
...
```yaml
Type: System.String
Parameter Sets: CheckExpanded, CheckViaIdentityClusterExpanded, CheckViaJsonFilePath, CheckViaJsonString
Aliases:
