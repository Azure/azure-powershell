...
```
Remove-AzKustoDatabasePrincipalAssignment -ClusterInputObject <IKustoIdentity> -DatabaseName <String>
...
```
Remove-AzKustoDatabasePrincipalAssignment -DatabaseInputObject <IKustoIdentity>
 -PrincipalAssignmentName <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
