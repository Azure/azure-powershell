...
```
Get-AzKustoScript -ClusterInputObject <IKustoIdentity> -DatabaseName <String> -Name <String>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityDatabase
```
Get-AzKustoScript -DatabaseInputObject <IKustoIdentity> -Name <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
