...
```
Remove-AzKustoScript -ClusterInputObject <IKustoIdentity> -DatabaseName <String> -Name <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentityDatabase
```
Remove-AzKustoScript -DatabaseInputObject <IKustoIdentity> -Name <String> [-DefaultProfile <PSObject>]
