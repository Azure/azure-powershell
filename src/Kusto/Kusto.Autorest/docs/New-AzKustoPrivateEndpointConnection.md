...
```
New-AzKustoPrivateEndpointConnection -ClusterInputObject <IKustoIdentity> -Name <String>
 -Parameter <IPrivateEndpointConnection> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
