...
```
Test-AzKustoDatabasePrincipalAssignmentNameAvailability -ClusterInputObject <IKustoIdentity>
 -DatabaseName <String> -Name <String> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
