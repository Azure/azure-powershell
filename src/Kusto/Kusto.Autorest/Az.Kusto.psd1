#
# Module manifest for module 'Az.Kusto'
#
...
FunctionsToExport = 'Add-AzKustoClusterLanguageExtension', 
               'Add-AzKustoDatabasePrincipal', 
               'Get-AzKustoAttachedDatabaseConfiguration', 'Get-AzKustoCluster', 
               ...
               'Get-AzKustoDataConnection', 'Get-AzKustoManagedPrivateEndpoint', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Supported sandbox custom image
