...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.BlobStorageEventType MicrosoftStorageBlobCreated = @"Microsoft.Storage.BlobCreated";

        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.BlobStorageEventType MicrosoftStorageBlobRenamed = @"Microsoft.Storage.BlobRenamed";
        ...
        {
            return new BlobStorageEventType(System.Convert.ToString(value));
        }

        /// <summary>Compares values of enum type BlobStorageEventType</summary>
        /// <param name="e">the value to compare against this instance.</param>
        /// <returns><c>true</c> if the two instances are equal to the same value</returns>
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.BlobStorageEventType e)
        {
