namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614
{
    ...
    public partial class AzureResourceSku :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.IAzureResourceSkuInternal
    {

        /// <summary>Backing field for <see cref="Capacity" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.IAzureCapacity _capacity;

        /// <summary>The number of instances of the cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.IAzureCapacity Capacity { get => (this._capacity = this._capacity ?? new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.AzureCapacity()); set => this._capacity = value; }
        ...
        public int CapacityDefault { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.IAzureCapacityInternal)Capacity).Default; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.IAzureCapacityInternal)Capacity).Default = value; }

        /// <summary>Maximum allowed capacity.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Inlined)]
        public int CapacityMaximum { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.IAzureCapacityInternal)Capacity).Maximum; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.IAzureCapacityInternal)Capacity).Maximum = value; }

        /// <summary>Minimum allowed capacity.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Inlined)]
        public int CapacityMinimum { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.IAzureCapacityInternal)Capacity).Minimum; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.IAzureCapacityInternal)Capacity).Minimum = value; }

        /// <summary>Scale type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.AzureScaleType CapacityScaleType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.IAzureCapacityInternal)Capacity).ScaleType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.IAzureCapacityInternal)Capacity).ScaleType = value; }

        /// <summary>Internal Acessors for Capacity</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.IAzureCapacity Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.IAzureResourceSkuInternal.Capacity { get => (this._capacity = this._capacity ?? new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.AzureCapacity()); set { {_capacity = value;} } }

        /// <summary>Internal Acessors for Sku</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.IAzureSku Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.IAzureResourceSkuInternal.Sku { get => (this._sku = this._sku ?? new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.AzureSku()); set { {_sku = value;} } }
    ...
    {
        /// <summary>The number of instances of the cluster.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200614.IAzureCapacity Capacity { get; set; }
        /// <summary>The default capacity that would be used.</summary>
        int CapacityDefault { get; set; }
        /// <summary>Maximum allowed capacity.</summary>
        int CapacityMaximum { get; set; }
