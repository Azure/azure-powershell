namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200215
{
    ...
    public partial class ReadOnlyFollowingDatabaseProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200215.IReadOnlyFollowingDatabaseProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200215.IReadOnlyFollowingDatabasePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200215.IReadOnlyFollowingDatabasePropertiesInternal.AttachedDatabaseConfigurationName { get => this._attachedDatabaseConfigurationName; set { {_attachedDatabaseConfigurationName = value;} } }

        /// <summary>Internal Acessors for LeaderClusterResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200215.IReadOnlyFollowingDatabasePropertiesInternal.LeaderClusterResourceId { get => this._leaderClusterResourceId; set { {_leaderClusterResourceId = value;} } }

        /// <summary>Internal Acessors for PrincipalsModificationKind</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.PrincipalsModificationKind? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200215.IReadOnlyFollowingDatabasePropertiesInternal.PrincipalsModificationKind { get => this._principalsModificationKind; set { {_principalsModificationKind = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200215.IReadOnlyFollowingDatabasePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for SoftDeletePeriod</summary>
        global::System.TimeSpan? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200215.IReadOnlyFollowingDatabasePropertiesInternal.SoftDeletePeriod { get => this._softDeletePeriod; set { {_softDeletePeriod = value;} } }

        /// <summary>Internal Acessors for Statistics</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200215.IDatabaseStatistics Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200215.IReadOnlyFollowingDatabasePropertiesInternal.Statistics { get => (this._statistics = this._statistics ?? new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200215.DatabaseStatistics()); set { {_statistics = value;} } }
