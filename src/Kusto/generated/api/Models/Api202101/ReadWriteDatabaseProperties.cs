namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101
{
    ...
    public partial class ReadWriteDatabaseProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IReadWriteDatabaseProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IReadWriteDatabasePropertiesInternal
    {
        ...
        bool? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IReadWriteDatabasePropertiesInternal.IsFollowed { get => this._isFollowed; set { {_isFollowed = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IReadWriteDatabasePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for Statistics</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IDatabaseStatistics Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IReadWriteDatabasePropertiesInternal.Statistics { get => (this._statistics = this._statistics ?? new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.DatabaseStatistics()); set { {_statistics = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IDatabaseStatistics _statistics;

        /// <summary>The statistics of the database.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IDatabaseStatistics Statistics { get => (this._statistics = this._statistics ?? new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.DatabaseStatistics()); }
        ...
        public float? StatisticsSize { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IDatabaseStatisticsInternal)Statistics).Size; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IDatabaseStatisticsInternal)Statistics).Size = value ?? default(float); }
...

    {
        ...
        global::System.TimeSpan? SoftDeletePeriod { get; set; }
        /// <summary>The statistics of the database.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IDatabaseStatistics Statistics { get; set; }
        /// <summary>The database size - the total size of compressed data and index in bytes.</summary>
        float? StatisticsSize { get; set; }
