namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101
{
    ...
    public partial class ClusterProperties
    {
        ...
        internal ClusterProperties(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject json)
        {
            ...
            {_optimizedAutoscale = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject>("optimizedAutoscale"), out var __jsonOptimizedAutoscale) ? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.OptimizedAutoscale.FromJson(__jsonOptimizedAutoscale) : OptimizedAutoscale;}
            {_virtualNetworkConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject>("virtualNetworkConfiguration"), out var __jsonVirtualNetworkConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.VirtualNetworkConfiguration.FromJson(__jsonVirtualNetworkConfiguration) : VirtualNetworkConfiguration;}
            {_keyVaultProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject>("keyVaultProperties"), out var __jsonKeyVaultProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.KeyVaultProperties.FromJson(__jsonKeyVaultProperties) : KeyVaultProperty;}
            {_languageExtension = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject>("languageExtensions"), out var __jsonLanguageExtensions) ? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.LanguageExtensionsList.FromJson(__jsonLanguageExtensions) : LanguageExtension;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IClusterProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IClusterProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IClusterProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode node)
        {
