namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101
{
    ...
    public partial class IdentityUserAssignedIdentities
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IIdentityUserAssignedIdentities.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IIdentityUserAssignedIdentities.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IIdentityUserAssignedIdentities FromJson(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject json ? new IdentityUserAssignedIdentities(json) : null;
        }
        ...
        internal IdentityUserAssignedIdentities(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject json, global::System.Collections.Generic.HashSet<string> exclusions = null)
        {
            ...
            Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.JsonSerializable.FromJson( json, ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IAssociativeArray<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IComponentsSgqdofSchemasIdentityPropertiesUserassignedidentitiesAdditionalproperties>)this).AdditionalProperties, (j) => Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ComponentsSgqdofSchemasIdentityPropertiesUserassignedidentitiesAdditionalproperties.FromJson(j) ,exclusions );
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="IdentityUserAssignedIdentities" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="IdentityUserAssignedIdentities" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode" />.
        /// </returns>
