...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201
{
    ...
    public partial class ReadWriteDatabaseProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IReadWriteDatabaseProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IReadWriteDatabasePropertiesInternal
    {
        ...
        bool? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IReadWriteDatabasePropertiesInternal.IsFollowed { get => this._isFollowed; set { {_isFollowed = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IReadWriteDatabasePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for Statistics</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IDatabaseStatistics Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IReadWriteDatabasePropertiesInternal.Statistics { get => (this._statistics = this._statistics ?? new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.DatabaseStatistics()); set { {_statistics = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IDatabaseStatistics _statistics;

        /// <summary>The statistics of the database.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IDatabaseStatistics Statistics { get => (this._statistics = this._statistics ?? new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.DatabaseStatistics()); }
        ...
        public float? StatisticsSize { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IDatabaseStatisticsInternal)Statistics).Size; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IDatabaseStatisticsInternal)Statistics).Size = value ?? default(float); }
