...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IAzureResourceSkuInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IAzureCapacity _capacity;

        /// <summary>The number of instances of the cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IAzureCapacity Capacity { get => (this._capacity = this._capacity ?? new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.AzureCapacity()); set => this._capacity = value; }
        ...
        public int? CapacityDefault { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IAzureCapacityInternal)Capacity).Default; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IAzureCapacityInternal)Capacity).Default = value ?? default(int); }

        /// <summary>Maximum allowed capacity.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Inlined)]
        public int? CapacityMaximum { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IAzureCapacityInternal)Capacity).Maximum; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IAzureCapacityInternal)Capacity).Maximum = value ?? default(int); }

        /// <summary>Minimum allowed capacity.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Inlined)]
        public int? CapacityMinimum { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IAzureCapacityInternal)Capacity).Minimum; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IAzureCapacityInternal)Capacity).Minimum = value ?? default(int); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IAzureCapacity Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IAzureResourceSkuInternal.Capacity { get => (this._capacity = this._capacity ?? new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.AzureCapacity()); set { {_capacity = value;} } }

        /// <summary>Internal Acessors for Sku</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IAzureSku Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IAzureResourceSkuInternal.Sku { get => (this._sku = this._sku ?? new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.AzureSku()); set { {_sku = value;} } }
    ...
    {
        /// <summary>The number of instances of the cluster.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20220201.IAzureCapacity Capacity { get; set; }
        /// <summary>The default capacity that would be used.</summary>
        int? CapacityDefault { get; set; }
        /// <summary>Maximum allowed capacity.</summary>
        int? CapacityMaximum { get; set; }
