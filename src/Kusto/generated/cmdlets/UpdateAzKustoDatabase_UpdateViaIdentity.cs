...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzKustoDatabase_UpdateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzKustoDatabase_UpdateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of UpdateAzKustoDatabase_UpdateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets.UpdateAzKustoDatabase_UpdateViaIdentity Clone()
        {
            var clone = new UpdateAzKustoDatabase_UpdateViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DatabasesUpdateViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("CallerRole") ? CallerRole : null, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.DatabasesUpdate(InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, InputObject.DatabaseName ?? null, InputObject.SubscriptionId ?? null, this.InvocationInformation.BoundParameters.ContainsKey("CallerRole") ? CallerRole : null, Parameter, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  CallerRole=this.InvocationInformation.BoundParameters.ContainsKey("CallerRole") ? CallerRole : null,body=Parameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzKustoDatabase_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzKustoDatabase_UpdateViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20221229.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { CallerRole=this.InvocationInformation.BoundParameters.ContainsKey("CallerRole") ? CallerRole : null, body=Parameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { CallerRole=this.InvocationInformation.BoundParameters.ContainsKey("CallerRole") ? CallerRole : null, body=Parameter })
                    {
