...
```
New-AzKustoAttachedDatabaseConfiguration -Name <String> -ClusterName <String> -ResourceGroupName <String>
...
```
New-AzKustoAttachedDatabaseConfiguration -Name <String> -ClusterInputObject <IKustoIdentity>
