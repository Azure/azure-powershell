...
```
Remove-AzKustoDataConnection -DatabaseName <String> -Name <String> -ClusterInputObject <IKustoIdentity>
...
```
Remove-AzKustoDataConnection -Name <String> -DatabaseInputObject <IKustoIdentity> [-DefaultProfile <PSObject>]
