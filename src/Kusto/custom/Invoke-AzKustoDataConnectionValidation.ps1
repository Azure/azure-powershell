...
Checks that the data connection parameters are valid.
.Example
PS C:\>  $dataConnectionProperties = New-Object -Type Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210101.EventHubDataConnection -Property @{Location=$location; Kind=$kind; EventHubResourceId=$eventHubResourceId; DataFormat=$dataFormat; ConsumerGroup='$Default'; Compression= "None"; TableName = $tableName; MappingRuleName = $tableMappingName}
PS C:\>  $dataConnectionValidation = New-Object -Type Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210101.DataConnectionValidation -Property @{DataConnectionName=$dataConnectionName; Property=$dataConnectionProperties}
...
function Invoke-AzKustoDataConnectionValidation {
    [OutputType([Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210101.IDataConnectionValidationResult])]
    ...
    process {
        try {
            $Parameter = [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210101.DataConnectionValidation]::new()
            ...
            if ($PSBoundParameters['Kind'] -eq 'EventHub') {
                $Parameter.Property = [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210101.EventHubDataConnection]::new()
            ...
            elseif ($PSBoundParameters['Kind'] -eq 'EventGrid') {
                $Parameter.Property = [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210101.EventGridDataConnection]::new()
                ...
                $Parameter.Property = [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210101.IotHubDataConnection]::new()
