    ...
    process {
        try {
            if ($PSBoundParameters['Kind'] -eq 'EventHub') {
                $Parameter = [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.EventHubDataConnection]::new()
            ...
            elseif ($PSBoundParameters['Kind'] -eq 'EventGrid') {
                $Parameter = [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.EventGridDataConnection]::new()
                ...
                $Parameter = [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IotHubDataConnection]::new()
