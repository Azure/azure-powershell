...
online version: https://docs.microsoft.com/en-us/powershell/module/az.kusto/set-azkustoattacheddatabaseconfiguration
schema: 2.0.0
---

# Set-AzKustoAttachedDatabaseConfiguration
...
```
Set-AzKustoAttachedDatabaseConfiguration -ClusterName <String> -Name <String> -ResourceGroupName <String>
