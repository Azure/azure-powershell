...
online version: https://docs.microsoft.com/en-us/powershell/module/az.kusto/set-azkustoclusterprincipalassignment
schema: 2.0.0
---

# Set-AzKustoClusterPrincipalAssignment
...
```
Set-AzKustoClusterPrincipalAssignment -ClusterName <String> -PrincipalAssignmentName <String>
...
```
Set-AzKustoClusterPrincipalAssignment -ClusterName <String> -PrincipalAssignmentName <String>
 -ResourceGroupName <String> -Parameter <IClusterPrincipalAssignment> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200215.IClusterPrincipalAssignment
...
#### PARAMETER <IClusterPrincipalAssignment>: Class representing a cluster principal assignment.
  ...
  - `Role <ClusterPrincipalRole>`: Cluster principal role.
