...
online version: https://docs.microsoft.com/en-us/powershell/module/az.kusto/set-azkustodatabaseprincipalassignment
schema: 2.0.0
---

# Set-AzKustoDatabasePrincipalAssignment
...
```
Set-AzKustoDatabasePrincipalAssignment -ClusterName <String> -DatabaseName <String>
