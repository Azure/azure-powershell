...
online version: https://docs.microsoft.com/powershell/module/az.kusto/remove-azkustomanagedprivateendpoint
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzKustoManagedPrivateEndpoint -ClusterName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzKustoManagedPrivateEndpoint -InputObject <IKustoIdentity> [-DefaultProfile <PSObject>] [-AsJob]
...
```powershell
PS C:\> Remove-AzKustoManagedPrivateEndpoint -ClusterName "mycluster" -ResourceGroupName "testrg" -Name "ManagedPrivateEndpointName"
```
