...
### CreateViaIdentity
```
New-AzKustoClusterPrincipalAssignment -InputObject <IKustoIdentity> -Parameter <IClusterPrincipalAssignment>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzKustoClusterPrincipalAssignment -InputObject <IKustoIdentity> [-PrincipalId <String>]
 [-PrincipalType <PrincipalType>] [-Role <ClusterPrincipalRole>] [-TenantId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
