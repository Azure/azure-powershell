...
### CreateViaIdentity
```
New-AzKustoAttachedDatabaseConfiguration -InputObject <IKustoIdentity>
 -Parameter <IAttachedDatabaseConfiguration> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzKustoAttachedDatabaseConfiguration -InputObject <IKustoIdentity> [-ClusterResourceId <String>]
