...
online version: https://docs.microsoft.com/en-us/powershell/module/az.kusto/set-azkustodataconnection
schema: 2.0.0
---

# Set-AzKustoDataConnection
...
```
Set-AzKustoDataConnection -ClusterName <String> -DatabaseName <String> -Name <String>
