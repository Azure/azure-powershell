...
online version: https://docs.microsoft.com/en-us/powershell/module/az.kusto/set-azkustodatabase
schema: 2.0.0
---
...
```
Set-AzKustoDatabase -ClusterName <String> -Name <String> -ResourceGroupName <String> -Kind <Kind>
...
### Update
```
Set-AzKustoDatabase -ClusterName <String> -Name <String> -ResourceGroupName <String> -Parameter <IDatabase>
