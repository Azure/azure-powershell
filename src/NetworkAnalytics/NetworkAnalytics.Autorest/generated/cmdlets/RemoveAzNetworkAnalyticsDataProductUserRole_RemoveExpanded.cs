...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzNetworkAnalyticsDataProductUserRole_RemoveExpanded", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzNetworkAnalyticsDataProductUserRole_RemoveExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20231115.IRoleAssignmentDetail _body = new Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20231115.RoleAssignmentDetail();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Id of role assignment request")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Id of role assignment request",
        SerializedName = @"roleAssignmentId",
        PossibleTypes = new [] { typeof(string) })]
        public string RoleAssignmentId { get => _body.RoleAssignmentId ?? null; set => _body.RoleAssignmentId = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DataProductsRemoveUserRole(SubscriptionId, ResourceGroupName, DataProductName, _body, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,DataProductName=DataProductName,body=_body})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzNetworkAnalyticsDataProductUserRole_RemoveExpanded" /> cmdlet class.
        /// </summary>
        public RemoveAzNetworkAnalyticsDataProductUserRole_RemoveExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, DataProductName=DataProductName, body=_body })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, DataProductName=DataProductName, body=_body })
                    {
