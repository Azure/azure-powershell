...
Update-AzServiceLinkerForWebapp -ResourceGroupName servicelinker-test-linux-group -Webapp servicelinker-portal-e2e -TargetService $target -AuthInfo $authInfo -ClientType 'none' -Name postgres_connection
```
