...
online version: https://learn.microsoft.com/powershell/module/az.servicelinker/test-azservicelinkerconnector
schema: 2.0.0
---

# Test-AzServiceLinkerConnector
...
### Validate (Default)
```
Test-AzServiceLinkerConnector -Location <String> -Name <String> -ResourceGroupName <String>
...
### ValidateViaIdentity
```
Test-AzServiceLinkerConnector -InputObject <IServiceLinkerIdentity> [-DefaultProfile <PSObject>] [-AsJob]
