...
### Delete (Default)
```
Remove-AzServiceLinkerConnectorDryrun -DryrunName <String> -Location <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzServiceLinkerConnectorDryrun -InputObject <IServiceLinkerIdentity> [-DefaultProfile <PSObject>]
