...
```
Update-AzServiceLinkerForWebApp -Name <String> -AuthInfo <IAuthInfoBase> -ClientType <String>
 -TargetService <ITargetServiceBase> -ResourceGroupName <String> -WebApp <String> [-ResourceUri <String>]
 [-Scope <String>] [-SecretStoreKeyVaultId <String>] [-VNetSolutionType <String>] [-DefaultProfile <PSObject>]
