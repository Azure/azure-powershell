...
```
Update-AzServiceLinkerForSpringCloud -Name <String> -AuthInfo <IAuthInfoBase> -ClientType <String>
 -TargetService <ITargetServiceBase> -AppName <String> -ResourceGroupName <String> -ServiceName <String>
 [-ResourceUri <String>] [-Scope <String>] [-SecretStoreKeyVaultId <String>] [-VNetSolutionType <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-DeploymentName <String>] [-NoWait] [-SubscriptionId <String>]
