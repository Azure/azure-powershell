#
# Module manifest for module 'Az.ServiceLinker'
#
...
FormatsToProcess = 'ServiceLinker.Autorest\Az.ServiceLinker.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('ServiceLinker.Autorest/Az.ServiceLinker.psm1')
...
FunctionsToExport = 'Get-AzServiceLinkerConfigurationForContainerApp', 
               ...
               'New-AzServiceLinkerForSpringCloud', 'New-AzServiceLinkerForWebApp', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated API version to 2022-11-01-preview'
