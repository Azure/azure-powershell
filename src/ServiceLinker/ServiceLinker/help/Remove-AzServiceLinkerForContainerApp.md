...
### Delete (Default)
```
Remove-AzServiceLinkerForContainerApp -Name <String> [-ResourceUri <String>] [-DefaultProfile <PSObject>]
 -ContainerApp <String> -ResourceGroupName <String> [-SubscriptionId <String>] [-AsJob] [-NoWait] [-PassThru]
