...
online version: https://learn.microsoft.com/powershell/module/az.servicelinker/remove-azservicelinkerforspringcloud
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzServiceLinkerForSpringCloud -Name <String> [-ResourceUri <String>] [-DefaultProfile <PSObject>]
