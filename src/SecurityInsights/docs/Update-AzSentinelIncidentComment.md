...
online version: https://docs.microsoft.com/powershell/module/az.securityinsights/update-azsentinelincidentcomment
schema: 2.0.0
---
...
```
Update-AzSentinelIncidentComment -Id <String> -IncidentId <String> -ResourceGroupName <String>
 -WorkspaceName <String> -IncidentComment <IIncidentComment> [-OperationalInsightsResourceProvider <String>]
