...
online version: https://docs.microsoft.com/powershell/module/az.securityinsights/expand-azsentinelbookmark
schema: 2.0.0
---

# Expand-AzSentinelBookmark
...
```
Expand-AzSentinelBookmark -Id <String> -ResourceGroupName <String> -WorkspaceName <String>
 [-SubscriptionId <String>] [-EndTime <DateTime>] [-ExpansionId <String>] [-StartTime <DateTime>]
