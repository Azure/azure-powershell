...
online version: https://learn.microsoft.com/powershell/module/az.securityinsights/new-azsentinelsecuritymlanalyticssetting
schema: 2.0.0
---
...
```yaml
Type: System.String
Parameter Sets: Create, CreateViaIdentityWorkspace
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISecurityInsightsIdentity
Parameter Sets: CreateViaIdentityWorkspace
Aliases:
