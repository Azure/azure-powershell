...
online version: https://docs.microsoft.com/powershell/module/az.securityinsights/update-azsentinelthreatintelligenceindicator
schema: 2.0.0
---

# Update-AzSentinelThreatIntelligenceIndicator
...
```
Update-AzSentinelThreatIntelligenceIndicator -InputObject <ISecurityInsightsIdentity> [-Confidence <Int32>]
