...
function Update-AzSentinelAlertRule {
    [Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.CmdletBreakingChange("4.0.0", "11.0.0", "2023/11/15", ChangeDescription="Parameters of NRT set will be deprecated.")]
