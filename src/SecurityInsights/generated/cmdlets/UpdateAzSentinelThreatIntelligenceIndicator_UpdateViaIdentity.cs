...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzSentinelThreatIntelligenceIndicator_UpdateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzSentinelThreatIntelligenceIndicator_UpdateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ThreatIntelligenceProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.Api20210901Preview.IThreatIntelligenceIndicatorModelForRequestBody _threatIntelligenceProperty;

        /// <summary>Threat intelligence indicator entity used in request body.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Threat intelligence indicator entity used in request body.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Threat intelligence indicator entity used in request body.",
        SerializedName = @"threatIntelligenceProperties",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.Api20210901Preview.IThreatIntelligenceIndicatorModelForRequestBody) })]
        public Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.Api20210901Preview.IThreatIntelligenceIndicatorModelForRequestBody ThreatIntelligenceProperty { get => this._threatIntelligenceProperty; set => this._threatIntelligenceProperty = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ThreatIntelligenceIndicatorCreateViaIdentity(InputObject.Id, ThreatIntelligenceProperty, onOk, onCreated, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ThreatIntelligenceIndicatorCreate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.WorkspaceName ?? null, InputObject.Name ?? null, ThreatIntelligenceProperty, onOk, onCreated, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ThreatIntelligenceProperty})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzSentinelThreatIntelligenceIndicator_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzSentinelThreatIntelligenceIndicator_UpdateViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.Api20.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ThreatIntelligenceProperty })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ThreatIntelligenceProperty })
                    {
