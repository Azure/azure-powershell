...
```
New-AzSentinelIncident -ResourceGroupName <String> -WorkspaceName <String> -JsonFilePath <String>
...
### CreateViaJsonString
```
New-AzSentinelIncident -ResourceGroupName <String> -WorkspaceName <String> -JsonString <String> [-Id <String>]
