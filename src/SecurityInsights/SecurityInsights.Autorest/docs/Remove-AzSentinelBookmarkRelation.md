...
### DeleteViaIdentityBookmark
```
Remove-AzSentinelBookmarkRelation -BookmarkInputObject <ISecurityInsightsIdentity> -RelationName <String>
...
Parameter Sets: DeleteViaIdentityBookmark
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Delete, DeleteViaIdentityBookmark
Aliases:
