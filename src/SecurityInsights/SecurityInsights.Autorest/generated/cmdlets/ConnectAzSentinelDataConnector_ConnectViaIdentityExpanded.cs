...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Connect=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/dataConnectors/{dataConnectorId}/connect"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommunications.Connect, @"AzSentinelDataConnector_ConnectViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Description(@"Connects a data connector.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/dataConnectors/{dataConnectorId}/connect", ApiVersion = "2021-09-01-preview")]
    public partial class ConnectAzSentinelDataConnector_ConnectViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.Api20210901Preview.IDataConnectorConnectBody _connectBody = new Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.Api20210901Preview.DataConnectorConnectBody();

        /// <summary>The API key of the audit server.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The API key of the audit server.")]
        ...
        public string ApiKey { get => _connectBody.ApiKey ?? null; set => _connectBody.ApiKey = value; }

        /// <summary>The authorization code used in OAuth 2.0 code flow to issue a token.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The authorization code used in OAuth 2.0 code flow to issue a token.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AuthorizationCode { get => _connectBody.AuthorizationCode ?? null; set => _connectBody.AuthorizationCode = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The client id of the OAuth 2.0 application.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ClientId { get => _connectBody.ClientId ?? null; set => _connectBody.ClientId = value; }

        /// <summary>The client secret of the OAuth 2.0 application.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The client secret of the OAuth 2.0 application.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ClientSecret { get => _connectBody.ClientSecret ?? null; set => _connectBody.ClientSecret = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The authentication kind used to poll the data")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Support.ConnectAuthKind))]
        public Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Support.ConnectAuthKind Kind { get => _connectBody.Kind ?? ((Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Support.ConnectAuthKind)""); set => _connectBody.Kind = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The user password in the audit log server.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Password { get => _connectBody.Password ?? null; set => _connectBody.Password = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IAny[] RequestConfigUserInputValue { get => _connectBody.RequestConfigUserInputValue ?? null /* arrayOf */; set => _connectBody.RequestConfigUserInputValue = value; }

        /// <summary>The user name in the audit log server.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The user name in the audit log server.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string UserName { get => _connectBody.UserName ?? null; set => _connectBody.UserName = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ConnectAzSentinelDataConnector_ConnectViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public ConnectAzSentinelDataConnector_ConnectViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DataConnectorsConnect' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DataConnectorsConnectViaIdentity(InputObject.Id, _connectBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.DataConnectorsConnect(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.WorkspaceName ?? null, InputObject.DataConnectorId ?? null, _connectBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_connectBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.Api20.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_connectBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_connectBody })
                    {
