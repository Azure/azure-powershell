...
Remove-AzSentinelAlertRuleAction -Id <String> -ResourceGroupName <String> -RuleId <String>
 [-SubscriptionId <String>] -WorkspaceName <String> [-DefaultProfile <PSObject>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentityAlertRule
```
Remove-AzSentinelAlertRuleAction -Id <String> -AlertRuleInputObject <ISecurityInsightsIdentity>
...
```yaml
Type: System.String
Parameter Sets: Delete, DeleteViaIdentityAlertRule
Aliases: ActionId
