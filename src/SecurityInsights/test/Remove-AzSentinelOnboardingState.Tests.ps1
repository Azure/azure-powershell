if(($null -eq $TestName) -or ($TestName -contains 'Remove-AzSentinelOnboardingState'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Remove-AzSentinelOnboardingState.Recording.json'
