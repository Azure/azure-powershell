...
namespace Microsoft.Azure.PowerShell.Cmdlets.VoiceServices.Support
{
    ...
    {
        /// <summary>
        /// The resource has been created or updated, but the CommunicationsGateway service has not yet been updated to reflect the
        /// changes.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.VoiceServices.Support.Status ChangePending = @"ChangePending";

        /// <summary>
        /// The CommunicationsGateway service is up and running with the parameters specified in the resource.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.VoiceServices.Support.Status Complete = @"Complete";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.VoiceServices.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.VoiceServices.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.VoiceServices.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.VoiceServices.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
