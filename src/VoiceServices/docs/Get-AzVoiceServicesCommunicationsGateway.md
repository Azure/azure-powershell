...
westcentralus vsc-gateway-pwsh02 12/7/2022 7:09:45 AM v-diya@microsoft.com User                    12/7/2022 7:09:45 AM     v-diya@microsoft.com     User                         lucas-communication-rg 
```
...
```powershell
Get-AzVoiceServicesCommunicationsGateway -ResourceGroupName lucas-communication-rg
```
...
```powershell
Get-AzVoiceServicesCommunicationsGateway -ResourceGroupName lucas-communication-rg -Name vsc-gateway-pwsh01
```
...
New-AzVoiceServicesCommunicationsGateway -ResourceGroupName 'lucas-communication-rg' -Name vsc-gateway-pwsh01 -Location 'westcentralus' -Codec 'PCMA' -E911Type 'Standard' -Platform 'OperatorConnect' -ServiceLocation $region | Get-AzVoiceServicesCommunicationsGateway
```
