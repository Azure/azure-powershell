...
online version: https://learn.microsoft.com/powershell/module/az.aksarc/update-azaksarc
schema: 2.0.0
---
...
```
Update-AzAksArc -CustomLocationResourceUri <String> [-ExtendedLocationName <String>]
