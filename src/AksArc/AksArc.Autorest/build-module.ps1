...
$psd1 = Join-Path $PSScriptRoot './Az.AksArc.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: AksArc cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.AksArc.format.ps1xml'
