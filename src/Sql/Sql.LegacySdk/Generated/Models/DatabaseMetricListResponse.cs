...
namespace Microsoft.Azure.Management.Sql.LegacySdk.Models
{
    ...
    /// </summary>
    public partial class DatabaseMetricListResponse : AzureOperationResponse, IEnumerable<DatabaseMetric>
    {
        private IList<DatabaseMetric> _metrics;
        
        /// <summary>
        /// Optional. Gets or sets the list of Azure Sql Database metrics for
        /// the database.
        /// </summary>
        public IList<DatabaseMetric> Metrics
        {
        ...
        {
            this.Metrics = new LazyList<DatabaseMetric>();
        }
        
        /// <summary>
        /// Gets the sequence of Metrics.
        /// </summary>
        public IEnumerator<DatabaseMetric> GetEnumerator()
        {
