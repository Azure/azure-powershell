...
namespace Microsoft.Azure.Management.Sql.LegacySdk.Models
{
    ...
    {
        private ServerUpgradeProperties _properties;
        
        /// <summary>
        /// Required. Gets or sets the properties of the Azure SQL Database
        /// Server Upgrade.
        /// </summary>
        public ServerUpgradeProperties Properties
        {
        ...
        /// </summary>
        public ServerUpgradeStartParameters(ServerUpgradeProperties properties)
            : this()
        {
            if (properties == null)
            {
