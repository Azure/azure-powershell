...
function Test-ShortTermRetentionPolicy
{
 	...
 	try
	{
		...
		$defaultRetention = 7
		# After we configure Backup Service's default DiffBackupIntervalInHour to 24 hours for new created databases, $defaultDiffbackupinterval should be changed to 24.
