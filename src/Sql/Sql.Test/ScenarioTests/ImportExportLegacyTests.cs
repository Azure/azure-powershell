...
{
    public class ImportExportLegacyTests : SqlTestsBase
    {
        public ImportExportLegacyTests(ITestOutputHelper output) : base(output)
        {
        ...
        {
            RunPowerShellTest("Test-ExportDatabaseLegacy");
        }
        ...
        {
            RunPowerShellTest("Test-ImportDatabaseLegacy");
        }
    }
}
