...
namespace Microsoft.Azure.Management.Sql.DataSyncV2.Models
{
    ...
    public partial class SyncFullSchemaTableColumn
    {
        ...
        /// <param name="errorId">Error id of the column.
        /// </param>

        /// <param name="hasError">If there is error in the table.
        /// </param>

        /// <param name="isPrimaryKey">If it is the primary key of the table.
        /// </param>

        /// <param name="name">Name of the column.
        /// </param>

        /// <param name="quotedName">Quoted name of the column.
        /// </param>
