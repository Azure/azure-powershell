...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ServerDnsAlias : ProxyResource
    {
        ...
        /// <param name="azureDnsRecord">The fully qualified DNS record for alias
        /// </param>
        public ServerDnsAlias(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string azureDnsRecord = default(string))
