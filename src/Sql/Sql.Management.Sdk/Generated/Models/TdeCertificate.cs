...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class TdeCertificate : ProxyResource
    {
        ...
        /// </param>
        public TdeCertificate(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string privateBlob = default(string), string certPassword = default(string))
