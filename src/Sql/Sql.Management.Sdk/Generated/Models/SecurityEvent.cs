...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class SecurityEvent : ProxyResource
    {
        ...
        /// </param>
        public SecurityEvent(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), System.DateTime? eventTime = default(System.DateTime?), SecurityEventType? securityEventType = default(SecurityEventType?), string subscription = default(string), string server = default(string), string database = default(string), string clientIP = default(string), string applicationName = default(string), string principalName = default(string), SecurityEventSqlInjectionAdditionalProperties securityEventSqlInjectionAdditionalProperties = default(SecurityEventSqlInjectionAdditionalProperties))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.securityEventSqlInjectionAdditionalProperties")]
