...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class DataMaskingRuleProperties
    {
        ...
        /// </param>
        public DataMaskingRuleProperties(string schemaName, string tableName, string columnName, DataMaskingFunction maskingFunction, string id = default(string), DataMaskingRuleState? ruleState = default(DataMaskingRuleState?), string aliasName = default(string), string numberFrom = default(string), string numberTo = default(string), string prefixSize = default(string), string suffixSize = default(string), string replacementString = default(string))
