...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ManagedServerDnsAlias : ProxyResource
    {
        ...
        /// </param>
        public ManagedServerDnsAlias(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string azureDnsRecord = default(string), string publicAzureDnsRecord = default(string))
