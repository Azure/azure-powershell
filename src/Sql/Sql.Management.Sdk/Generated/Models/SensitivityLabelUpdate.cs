...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class SensitivityLabelUpdate : ProxyResource
    {
        ...
        /// </param>
        public SensitivityLabelUpdate(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), SensitivityLabel sensitivityLabel = default(SensitivityLabel), SensitivityLabelUpdateKind? op = default(SensitivityLabelUpdateKind?), string schema = default(string), string table = default(string), string column = default(string))
