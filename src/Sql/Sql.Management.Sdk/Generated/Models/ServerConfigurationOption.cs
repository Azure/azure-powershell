...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ServerConfigurationOption : ProxyResource
    {
        ...
        /// </param>
        public ServerConfigurationOption(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string provisioningState = default(string), int? serverConfigurationOptionValue = default(int?))
