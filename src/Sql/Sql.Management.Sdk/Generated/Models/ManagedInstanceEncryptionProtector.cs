...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ManagedInstanceEncryptionProtector : ProxyResource
    {
        ...
        /// </param>
        public ManagedInstanceEncryptionProtector(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string kind = default(string), string serverKeyName = default(string), string serverKeyType = default(string), string uri = default(string), string thumbprint = default(string), bool? autoRotationEnabled = default(bool?))
