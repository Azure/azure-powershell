...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ManagedDatabaseAdvancedThreatProtection : ProxyResource
    {
        /// <summary>
        ...
        /// </param>
        public ManagedDatabaseAdvancedThreatProtection(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), AdvancedThreatProtectionState? state = default(AdvancedThreatProtectionState?), System.DateTime? creationTime = default(System.DateTime?))
