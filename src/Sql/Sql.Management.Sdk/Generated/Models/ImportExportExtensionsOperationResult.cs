...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ImportExportExtensionsOperationResult : ProxyResource
    {
        ...
        /// </param>
        public ImportExportExtensionsOperationResult(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), System.Guid? requestId = default(System.Guid?), string requestType = default(string), string lastModifiedTime = default(string), string serverName = default(string), string databaseName = default(string), string status = default(string), string errorMessage = default(string), string queuedTime = default(string), string blobUri = default(string), System.Collections.Generic.IList<PrivateEndpointConnectionRequestStatus> privateEndpointConnections = default(System.Collections.Generic.IList<PrivateEndpointConnectionRequestStatus>))
