...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ManagedInstanceLongTermRetentionPolicyProperties
    {
        ...
        /// </param>
        public ManagedInstanceLongTermRetentionPolicyProperties(string backupStorageAccessTier = default(string), string timeBasedImmutability = default(string), string timeBasedImmutabilityMode = default(string), string weeklyRetention = default(string), string monthlyRetention = default(string), string yearlyRetention = default(string), int? weekOfYear = default(int?))
