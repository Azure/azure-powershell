...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class DataMaskingRule : ProxyResource
    {
        ...
        /// <param name="location">The location of the data masking rule.
        /// </param>

        /// <param name="kind">The kind of Data Masking Rule. Metadata, used for Azure portal.
        /// </param>

        /// <param name="propertiesId">The rule Id.
        /// </param>
        ...
        /// </param>
        public DataMaskingRule(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string location = default(string), string kind = default(string), string propertiesId = default(string), DataMaskingRuleState? ruleState = default(DataMaskingRuleState?), string schemaName = default(string), string tableName = default(string), string columnName = default(string), string aliasName = default(string), DataMaskingFunction? maskingFunction = default(DataMaskingFunction?), string numberFrom = default(string), string numberTo = default(string), string prefixSize = default(string), string suffixSize = default(string), string replacementString = default(string))
        ...
        /// provided value of ruleState. Possible values include: &#39;Enabled&#39;, &#39;Disabled&#39;
        /// </summary>
