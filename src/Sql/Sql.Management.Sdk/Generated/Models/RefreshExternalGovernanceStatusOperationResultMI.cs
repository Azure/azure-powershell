...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class RefreshExternalGovernanceStatusOperationResultMI : ProxyResource
    {
        /// <summary>
        /// Initializes a new instance of the RefreshExternalGovernanceStatusOperationResultMI class.
        /// </summary>
        ...
        /// </param>
        public RefreshExternalGovernanceStatusOperationResultMI(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), System.Guid? requestId = default(System.Guid?), string requestType = default(string), string queuedTime = default(string), string managedInstanceName = default(string), string status = default(string), string errorMessage = default(string))
