...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    /// </summary>
    public partial class ServerOperationProperties
    {
        /// <summary>
        /// Initializes a new instance of the ServerOperationProperties class.
        /// </summary>
        ...
        /// </param>
        public ServerOperationProperties(string operation = default(string), string operationFriendlyName = default(string), int? percentComplete = default(int?), string serverName = default(string), System.DateTime? startTime = default(System.DateTime?), string state = default(string), int? errorCode = default(int?), string errorDescription = default(string), int? errorSeverity = default(int?), bool? isUserError = default(bool?), System.DateTime? estimatedCompletionTime = default(System.DateTime?), string description = default(string), bool? isCancellable = default(bool?))
