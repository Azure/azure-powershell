...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class BackupShortTermRetentionPolicy : ProxyResourceAutoGenerated
    {
        /// <summary>
        ...
        /// retention policy.
        /// </param>
        public BackupShortTermRetentionPolicy(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string immutabilityStatus = default(string), int? retentionDays = default(int?), double? diffBackupIntervalInHours = default(double?), bool? lockImmutability = default(bool?))
