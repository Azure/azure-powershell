...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class LedgerDigestUploads : ProxyResource
    {
        ...
        public LedgerDigestUploads(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string digestStorageEndpoint = default(string), LedgerDigestUploadsState? state = default(LedgerDigestUploadsState?))
