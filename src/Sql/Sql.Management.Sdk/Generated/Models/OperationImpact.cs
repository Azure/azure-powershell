...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class OperationImpact
    {
        ...
        /// <param name="name">The name of the impact dimension.
        /// </param>

        /// <param name="unit">The unit in which estimated impact to dimension is measured.
        /// </param>

        /// <param name="changeValueAbsolute">The absolute impact to dimension.
        /// </param>

        /// <param name="changeValueRelative">The relative impact to dimension (null if not applicable)
        /// </param>
