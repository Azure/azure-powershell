...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ServerAzureADAdministrator : ProxyResource
    {
        ...
        /// </param>
        public ServerAzureADAdministrator(string id = default(string), string name = default(string), string type = default(string), string administratorType = default(string), string login = default(string), System.Guid? sid = default(System.Guid?), System.Guid? tenantId = default(System.Guid?), bool? azureAdOnlyAuthentication = default(bool?))
