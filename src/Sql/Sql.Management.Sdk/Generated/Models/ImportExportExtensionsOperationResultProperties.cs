...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    /// </summary>
    public partial class ImportExportExtensionsOperationResultProperties
    {
        /// <summary>
        /// Initializes a new instance of the ImportExportExtensionsOperationResultProperties class.
        /// </summary>
        ...
        /// </param>
        public ImportExportExtensionsOperationResultProperties(System.Guid? requestId = default(System.Guid?), string requestType = default(string), string lastModifiedTime = default(string), string serverName = default(string), string databaseName = default(string), string status = default(string), string errorMessage = default(string), string queuedTime = default(string), string blobUri = default(string), System.Collections.Generic.IList<PrivateEndpointConnectionRequestStatus> privateEndpointConnections = default(System.Collections.Generic.IList<PrivateEndpointConnectionRequestStatus>))
