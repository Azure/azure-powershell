...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class DatabaseBlobAuditingPolicy : ProxyResourceAutoGenerated
    {
        /// <summary>
        ...
        /// <param name="queueDelayMS">Specifies the amount of time in milliseconds that can elapse before audit
        ...
        /// </param>
        public DatabaseBlobAuditingPolicy(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string kind = default(string), int? retentionDays = default(int?), System.Collections.Generic.IList<string> auditActionsAndGroups = default(System.Collections.Generic.IList<string>), bool? isStorageSecondaryKeyInUse = default(bool?), bool? isAzureMonitorTargetEnabled = default(bool?), int? queueDelayMS = default(int?), bool? isManagedIdentityInUse = default(bool?), System.Collections.Generic.IList<string> requiredFields = default(System.Collections.Generic.IList<string>), BlobAuditingPolicyState? state = default(BlobAuditingPolicyState?), string storageEndpoint = default(string), string storageAccountAccessKey = default(string), System.Guid? storageAccountSubscriptionId = default(System.Guid?))
        ...
        /// <summary>
        /// Gets or sets specifies the amount of time in milliseconds that can elapse
        ...
        /// schema documentation.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.requiredFields")]
