...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class RecommendedSensitivityLabelUpdate : ProxyResource
    {
        ...
        /// </param>
        public RecommendedSensitivityLabelUpdate(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), RecommendedSensitivityLabelUpdateKind? op = default(RecommendedSensitivityLabelUpdateKind?), string schema = default(string), string table = default(string), string column = default(string))
