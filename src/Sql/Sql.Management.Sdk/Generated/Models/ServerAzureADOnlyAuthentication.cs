...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ServerAzureADOnlyAuthentication class.
        /// </summary>
        ...
        /// </param>
        public ServerAzureADOnlyAuthentication(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), bool? azureAdOnlyAuthentication = default(bool?))
