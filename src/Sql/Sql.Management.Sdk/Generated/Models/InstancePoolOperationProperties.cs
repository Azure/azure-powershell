...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    /// </summary>
    public partial class InstancePoolOperationProperties
    {
        /// <summary>
        /// Initializes a new instance of the InstancePoolOperationProperties class.
        /// </summary>
        ...
        /// </param>
        public InstancePoolOperationProperties(string instancePoolName = default(string), string operation = default(string), string operationFriendlyName = default(string), int? percentComplete = default(int?), System.DateTime? startTime = default(System.DateTime?), string state = default(string), int? errorCode = default(int?), string errorDescription = default(string), int? errorSeverity = default(int?), string errorType = default(string), System.DateTime? estimatedCompletionTime = default(System.DateTime?), string description = default(string), bool? isCancellable = default(bool?))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "instancePoolName")]
