...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class MaintenanceWindowOptions : ProxyResource
    {
        ...
        /// </param>
        public MaintenanceWindowOptions(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), bool? isEnabled = default(bool?), System.Collections.Generic.IList<MaintenanceWindowTimeRange> maintenanceWindowCycles = default(System.Collections.Generic.IList<MaintenanceWindowTimeRange>), int? minDurationInMinutes = default(int?), int? defaultDurationInMinutes = default(int?), int? minCycles = default(int?), int? timeGranularityInMinutes = default(int?), bool? allowMultipleMaintenanceWindowsPerCycle = default(bool?))
