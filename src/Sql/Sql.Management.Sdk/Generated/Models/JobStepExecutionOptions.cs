...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class JobStepExecutionOptions
    {
        ...
        /// <param name="timeoutSeconds">Execution timeout for the job step.
        /// </param>

        /// <param name="retryAttempts">Maximum number of times the job step will be reattempted if the first
        /// attempt fails.
        /// </param>

        /// <param name="initialRetryIntervalSeconds">Initial delay between retries for job step execution.
        /// </param>

        /// <param name="maximumRetryIntervalSeconds">The maximum amount of time to wait between retries for job step execution.
        /// </param>

        /// <param name="retryIntervalBackoffMultiplier">The backoff multiplier for the time between retries.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets maximum number of times the job step will be reattempted if
        ...
        /// <summary>
        /// Gets or sets the maximum amount of time to wait between retries for job
        /// step execution.
        /// </summary>
