...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ManagedDatabaseMoveOperationResult : ProxyResource
    {
        ...
        /// </param>
        public ManagedDatabaseMoveOperationResult(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string operation = default(string), string operationFriendlyName = default(string), System.DateTime? startTime = default(System.DateTime?), string state = default(string), string operationMode = default(string), string sourceManagedInstanceName = default(string), string targetManagedInstanceName = default(string), string sourceManagedInstanceId = default(string), string targetManagedInstanceId = default(string), string sourceDatabaseName = default(string), string targetDatabaseName = default(string), bool? isCancellable = default(bool?), int? errorCode = default(int?), string errorDescription = default(string), int? errorSeverity = default(int?), bool? isUserError = default(bool?))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.sourceManagedInstanceName")]
        public string SourceManagedInstanceName {get; private set; }

        /// <summary>
        /// Gets target Managed Instance name.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.targetManagedInstanceName")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.targetManagedInstanceId")]
