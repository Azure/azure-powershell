...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    /// </summary>
    public partial class ServerImportExportOperationResultProperties
    {
        /// <summary>
        /// Initializes a new instance of the ServerImportExportOperationResultProperties class.
        /// </summary>
        public ServerImportExportOperationResultProperties()
        {
            CustomInit();
        }
        ...
        /// </param>
        public ServerImportExportOperationResultProperties(System.Guid? requestId = default(System.Guid?), string requestType = default(string), string queuedTime = default(string), string lastModifiedTime = default(string), string blobUri = default(string), string serverName = default(string), string databaseName = default(string), string status = default(string), string errorMessage = default(string), System.Collections.Generic.IList<PrivateEndpointConnectionRequestStatus> privateEndpointConnections = default(System.Collections.Generic.IList<PrivateEndpointConnectionRequestStatus>))
