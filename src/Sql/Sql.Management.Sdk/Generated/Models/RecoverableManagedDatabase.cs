...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class RecoverableManagedDatabase : ProxyResource
    {
        ...
        /// </param>
        public RecoverableManagedDatabase(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string lastAvailableBackupDate = default(string))
