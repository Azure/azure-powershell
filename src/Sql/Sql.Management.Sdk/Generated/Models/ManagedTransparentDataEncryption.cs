...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ManagedTransparentDataEncryption : ProxyResource
    {
        ...
        public ManagedTransparentDataEncryption(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), TransparentDataEncryptionState? state = default(TransparentDataEncryptionState?))
