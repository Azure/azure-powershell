...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class SubscriptionUsage : ProxyResource
    {
        ...
        /// </param>
        public SubscriptionUsage(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string displayName = default(string), double? currentValue = default(double?), double? limit = default(double?), string unit = default(string))
