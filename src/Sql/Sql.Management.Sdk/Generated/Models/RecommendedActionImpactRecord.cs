...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class RecommendedActionImpactRecord
    {
        ...
        /// <param name="dimensionName">Gets the name of the impact dimension. e.g., CPUChange, DiskSpaceChange,
        /// NumberOfQueriesAffected.
        /// </param>

        /// <param name="unit">Gets the name of the impact dimension. e.g., CPUChange, DiskSpaceChange,
        /// NumberOfQueriesAffected.
        /// </param>

        /// <param name="absoluteValue">Gets the absolute value of this dimension if applicable. e.g., Number of
        /// Queries affected
        /// </param>

        /// <param name="changeValueAbsolute">Gets the absolute change in the value of this dimension. e.g., Absolute
        /// Disk space change in Megabytes
        /// </param>

        /// <param name="changeValueRelative">Gets the relative change in the value of this dimension. e.g., Relative
        ...
        /// <summary>
        /// Gets gets the name of the impact dimension. e.g., CPUChange,
        ...
        /// <summary>
        /// Gets gets the absolute value of this dimension if applicable. e.g., Number
        /// of Queries affected
        /// </summary>
        ...
        /// <summary>
        /// Gets gets the absolute change in the value of this dimension. e.g.,
        ...
        /// <summary>
        /// Gets gets the relative change in the value of this dimension. e.g.,
