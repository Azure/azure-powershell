...
namespace Microsoft.Azure.Management.Sql
{
    ...
    /// </summary>
    internal partial class TdeCertificatesOperations : Microsoft.Rest.IServiceOperations<SqlManagementClient>, ITdeCertificatesOperations
    {
        /// <summary>
        /// Initializes a new instance of the TdeCertificatesOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal TdeCertificatesOperations (SqlManagementClient client)
        {
            if (client == null) 
            {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationHeaderResponse<TdeCertificatesCreateHeaders> _response = await BeginCreateWithHttpMessagesAsync(resourceGroupName, serverName, parameters, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationHeaderResponse<TdeCertificatesCreateHeaders>> BeginCreateWithHttpMessagesAsync(string resourceGroupName, string serverName, TdeCertificate parameters, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/tdeCertificates").ToString();
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationHeaderResponse<TdeCertificatesCreateHeaders>();
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<TdeCertificatesCreateHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
