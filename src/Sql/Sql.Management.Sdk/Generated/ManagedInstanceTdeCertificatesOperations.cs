...
namespace Microsoft.Azure.Management.Sql
{
    ...
    /// </summary>
    internal partial class ManagedInstanceTdeCertificatesOperations : Microsoft.Rest.IServiceOperations<SqlManagementClient>, IManagedInstanceTdeCertificatesOperations
    {
        /// <summary>
        /// Initializes a new instance of the ManagedInstanceTdeCertificatesOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ManagedInstanceTdeCertificatesOperations (SqlManagementClient client)
        {
            if (client == null) 
            {
        ...
        /// </param>
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationHeaderResponse<ManagedInstanceTdeCertificatesCreateHeaders>> CreateWithHttpMessagesAsync(string resourceGroupName, string managedInstanceName, TdeCertificate parameters, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationHeaderResponse<ManagedInstanceTdeCertificatesCreateHeaders> _response = await BeginCreateWithHttpMessagesAsync(resourceGroupName, managedInstanceName, parameters, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        /// </return>
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationHeaderResponse<ManagedInstanceTdeCertificatesCreateHeaders>> BeginCreateWithHttpMessagesAsync(string resourceGroupName, string managedInstanceName, TdeCertificate parameters, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/tdeCertificates").ToString();
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationHeaderResponse<ManagedInstanceTdeCertificatesCreateHeaders>();
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<ManagedInstanceTdeCertificatesCreateHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
