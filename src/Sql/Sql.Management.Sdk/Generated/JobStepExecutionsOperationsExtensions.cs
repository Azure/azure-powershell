...
namespace Microsoft.Azure.Management.Sql
{
    ...
    public static partial class JobStepExecutionsOperationsExtensions
    {
        ...
        {
                return ((IJobStepExecutionsOperations)operations).GetAsync(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, stepName).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<JobExecution> GetAsync(this IJobStepExecutionsOperations operations, string resourceGroupName, string serverName, string jobAgentName, string jobName, System.Guid jobExecutionId, string stepName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// </param>
        public static Microsoft.Rest.Azure.IPage<JobExecution> ListByJobExecutionNext(this IJobStepExecutionsOperations operations, string nextPageLink)
        {
                return ((IJobStepExecutionsOperations)operations).ListByJobExecutionNextAsync(nextPageLink).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<JobExecution>> ListByJobExecutionNextAsync(this IJobStepExecutionsOperations operations, string nextPageLink, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
