...
namespace Microsoft.Azure.Commands.Sql.ImportExport.Cmdlet
{
    ...
    /// </summary>
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "SqlDatabaseImportExportOperation", SupportsShouldProcess = true)]
    [OutputType(typeof(AzureSqlDatabaseImportExportStatusModel))]
    public class GetAzureSqlDatabaseImportExportOperation : AzureRMCmdlet
    {
        /// <summary>
        ...
        /// </summary>
        public ImportExportDatabaseArmAdapter ModelAdapter
        {
            get; internal set;
        }
        ...
        protected ImportExportDatabaseArmAdapter InitModelAdapter()
        {
