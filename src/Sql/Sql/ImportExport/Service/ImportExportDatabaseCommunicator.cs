...
namespace Microsoft.Azure.Commands.Sql.Database.Services
{
    ...
    public class ImportExportDatabaseCommunicator
    {
        ...
        /// Creates new export request
        /// </summary>
        public ImportExportOperationResult Export(string resourceGroupName, string serverName, string databaseName, ExportDatabaseDefinition parameters)
        {
        ...
        /// Creates new import request
        /// </summary>
        public ImportExportOperationResult ImportNewDatabase(string resourceGroupName, string serverName, ImportNewDatabaseDefinition parameters)
        {
            return GetCurrentSqlClient().Servers.BeginImportDatabase(resourceGroupName, serverName, parameters);
        }
        ...
        /// Creates new import request for existing database
        /// </summary>
        public ImportExportOperationResult ImportExistingDatabase(string resourceGroupName, string serverName, string databaseName, ImportExistingDatabaseDefinition parameters)
        {
            return GetCurrentSqlClient().ImportExport.BeginImport(resourceGroupName, serverName, databaseName, parameters);
        }
