...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "SqlDatabaseLongTermRetentionBackupImmutability", DefaultParameterSetName = RemoveBackupImmutabilityDefaultSet, SupportsShouldProcess = true), OutputType(typeof(AzureSqlDatabaseLongTermRetentionBackupModel))]
    public class RemoveAzureRmSqlDatabaseLongTermRetentionBackupImmutability : AzureSqlDatabaseLongTermRetentionBackupCmdletBase<AzureSqlDatabaseLongTermRetentionBackupModel>
    {
        /// <summary>
        /// Parameter set name for the default remove.
        /// </summary>
        private const string RemoveBackupImmutabilityDefaultSet = "RemoveBackupImmutabilityDefault";

        /// <summary>
        /// Parameter set name for remove with an input object.
        /// </summary>
        private const string RemoveBackupImmutabilityByInputObjectSet = "RemoveBackupImmutabilityByInputObject";

        /// <summary>
        /// Parameter set name for remove with a resource ID.
        /// </summary>
        private const string RemoveBackupImmutabilityByResourceIdSet = "RemoveBackupImmutabilityByResourceId";

        /// <summary>
        /// Gets or sets the name of the location the backup is in.
        /// </summary>
        [Parameter(Mandatory = true,
            ParameterSetName = RemoveBackupImmutabilityDefaultSet,
            Position = 0,
        ...
        /// </summary>
        [Parameter(ParameterSetName = RemoveBackupImmutabilityByInputObjectSet,
            Mandatory = true,
            Position = 0,
            ValueFromPipeline = true,
            HelpMessage = "The Database Long Term Retention Backup for which to remove time-based immutability.")]
        [ValidateNotNullOrEmpty]
        ...
        /// </summary>
        [Parameter(ParameterSetName = RemoveBackupImmutabilityByResourceIdSet,
            Mandatory = true,
            Position = 0,
            ValueFromPipelineByPropertyName = true,
            HelpMessage = "The Resource ID of the Database Long Term Retention Backup for which to remove time-based immutability")]
        [ValidateNotNullOrEmpty]
            ...
            IEnumerable<AzureSqlDatabaseLongTermRetentionBackupModel> entity)
        {
            ...
            {
                ModelAdapter.RemoveDatabaseLongTermRetentionBackupImmutabilityByResourceGroup(ResourceGroupName, Location, ServerName, DatabaseName, BackupName);
            }
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(this.BackupName))
            {
                if (Force.IsPresent || ShouldContinue(
                    string.Format(CultureInfo.InvariantCulture, Properties.Resources.RemoveImmutabilityAzureSqlDatabaseLongTermRetentionBackupWarning, this.BackupName, this.DatabaseName, this.ServerName, this.Location),
                    string.Format(CultureInfo.InvariantCulture, Properties.Resources.RemoveImmutabilityAzureSqlDatabaseLongTermRetentionBackupDescription, this.BackupName, this.DatabaseName, this.ServerName, this.Location)))
                {
                    base.ExecuteCmdlet();
                }
            }
