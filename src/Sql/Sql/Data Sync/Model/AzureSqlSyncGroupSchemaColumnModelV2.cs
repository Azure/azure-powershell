...
namespace Microsoft.Azure.Commands.Sql.DataSync.Model
{
    ...
    /// </summary>
    public class AzureSqlSyncGroupSchemaColumnModelV2
    {
        /// <summary>
        ...
        /// </summary>
        public AzureSqlSyncGroupSchemaColumnModelV2()
        {
        ...
        public AzureSqlSyncGroupSchemaColumnModelV2(SyncGroupSchemaTableColumn column)
        {
