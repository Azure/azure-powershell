...
namespace Microsoft.Azure.Commands.Sql.DataSync.Model
{
    ...
    /// </summary>
    public class AzureSqlSyncGroupSchemaModelV2
    {
        /// <summary>
        /// Tables in the database
        /// </summary>
        public IList<AzureSqlSyncGroupSchemaTableModelV2> Tables { get; set; }
        ...
        /// </summary>
        public AzureSqlSyncGroupSchemaModelV2()
        {

        }

        public AzureSqlSyncGroupSchemaModelV2(SyncGroupSchema schema)
        {
            if (schema.Tables != null)
            {
                Tables = new List<AzureSqlSyncGroupSchemaTableModelV2>();
                foreach (var table in schema.Tables)
                {
                    Tables.Add(new AzureSqlSyncGroupSchemaTableModelV2(table));
                }
            }
