...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "SqlInstanceDatabaseMoveOperation",
    ...
    public class GetAzureSqlManagedDatabaseMoveOperation : GetMoveCopyAzureSqlManagedDatabaseOperationsBase
    {
