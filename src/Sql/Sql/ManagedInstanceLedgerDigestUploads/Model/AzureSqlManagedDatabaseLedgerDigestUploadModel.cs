...
namespace Microsoft.Azure.Commands.Sql.ManagedInstanceLedgerDigestUploads.Model
{
    /// <summary>
    ...
    public class AzureSqlInstanceDatabaseLedgerDigestUploadModel
    {
        /// <summary>
        ...
        /// <param name="configuration">Management.Sql.ManagedLedgerDigestUploads object</param>
        public AzureSqlInstanceDatabaseLedgerDigestUploadModel(string resourceGroup, string serverName, string databaseName, Management.Sql.Models.ManagedLedgerDigestUploads configuration)
        {
