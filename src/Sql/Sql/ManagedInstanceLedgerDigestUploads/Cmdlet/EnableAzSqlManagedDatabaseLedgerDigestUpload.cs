...
{
    /// <summary>
    /// Defines the Enable-AzSqlDatabaseLedgerDigestUpload cmdlet
    /// </summary>
    [Cmdlet("Enable", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "SqlInstanceDatabaseLedgerDigestUpload", DefaultParameterSetName = DatabaseSet, ConfirmImpact = ConfirmImpact.Low, SupportsShouldProcess = true), OutputType(typeof(AzureSqlInstanceDatabaseLedgerDigestLocationModel))]
    public class EnableAzSqlDatabaseLedgerDigestUpload : AzureSqlInstanceDatabaseLedgerDigestUploadBase
    {
        /// <summary>
