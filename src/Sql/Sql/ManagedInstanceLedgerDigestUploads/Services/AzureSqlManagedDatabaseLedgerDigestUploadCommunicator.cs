...
namespace Microsoft.Azure.Commands.Sql.ManagedInstanceLedgerDigestUploads.Services
{
    ...
    /// </summary>
    public class AzureSqlInstanceDatabaseLedgerDigestUploadCommunicator
    {
        /// <summary>
        ...
        public AzureSqlInstanceDatabaseLedgerDigestUploadCommunicator(IAzureContext context)
        {
            Context = context;
        ...
        /// <returns></returns>
        public Management.Sql.Models.ManagedLedgerDigestUploads GetLedgerDigestUpload(
            string resourceGroupName,
            string managedInstanceName, 
            string databaseName)
        {
            return GetCurrentSqlClient().ManagedLedgerDigestUploads.Get(resourceGroupName, managedInstanceName, databaseName);
        }
        ...
        public void SetLedgerDigestUpload(
            ...
            string managedInstanceName,
            string databaseName,
            Management.Sql.Models.ManagedLedgerDigestUploads parameters)
        {
            GetCurrentSqlClient().ManagedLedgerDigestUploads.CreateOrUpdate(resourceGroupName, managedInstanceName, databaseName, parameters);
        }
        ...
        public void DisableLedgerDigestUpload(
            ...
            string databaseName)
        {
            GetCurrentSqlClient().ManagedLedgerDigestUploads.Disable(resourceGroupName, managedInstanceName, databaseName);
        }
