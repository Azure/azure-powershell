...
namespace Microsoft.Azure.Commands.Sql.AdvancedThreatProtection.Cmdlet
{
    ...
    /// </summary>
    [Cmdlet("Update", AzureRMConstants.AzureRMPrefix + "SqlInstanceAdvancedThreatProtectionSetting", SupportsShouldProcess = true), OutputType(typeof(ManagedInstanceAdvancedThreatProtectionSettingsModel))]
    public class UpdateAzureSqlManagedInstanceAdvancedThreatProtectionSettings : SqlManagedInstanceAdvancedThreatProtectionSettingsCmdletBase
    {
        /// <summary>
        ...
        protected override ManagedInstanceAdvancedThreatProtectionSettingsModel ApplyUserInputToModel(ManagedInstanceAdvancedThreatProtectionSettingsModel model)
        {
