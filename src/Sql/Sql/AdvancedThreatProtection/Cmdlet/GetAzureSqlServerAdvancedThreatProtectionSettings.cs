...
namespace Microsoft.Azure.Commands.Sql.AdvancedThreatProtection.Cmdlet
{
    ...
    /// </summary>
    [Cmdlet("Get", AzureRMConstants.AzureRMPrefix + "SqlServerAdvancedThreatProtectionSetting", SupportsShouldProcess = true), OutputType(typeof(ServerAdvancedThreatProtectionSettingsModel))]
    public class GetAzureSqlServerAdvancedThreatProtectionSettings : SqlServerAdvancedThreatProtectionSettingsCmdletBase
    {
        /// <summary>
