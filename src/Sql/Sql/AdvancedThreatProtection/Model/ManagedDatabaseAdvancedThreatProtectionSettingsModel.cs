...
namespace Microsoft.Azure.Commands.Sql.AdvancedThreatProtection.Model
{
    ...
    /// </summary>
    public class ManagedDatabaseAdvancedThreatProtectionSettingsModel : BaseManagedAdvancedThreatProtectionSettingsModel
    {
        /// <summary>
        /// Gets or sets the managed database name.
        /// </summary>
