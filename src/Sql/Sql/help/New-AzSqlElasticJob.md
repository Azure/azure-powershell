...
### DefaultSet (Default)
```
New-AzSqlElasticJob [-ResourceGroupName] <String> [-ServerName] <String> [-AgentName] <String>
...
```
New-AzSqlElasticJob -ParentObject <AzureSqlElasticJobAgentModel> [-Name] <String>
...
```
New-AzSqlElasticJob -ParentResourceId <String> [-Name] <String> [-IntervalType] <IntervalTypes>
