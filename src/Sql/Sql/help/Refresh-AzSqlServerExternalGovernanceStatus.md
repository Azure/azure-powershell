...
Module Name: Az.Sql
online version: https://learn.microsoft.com/powershell/module/az.sql/refresh-azsqlserverexternalgovernancestatus
schema: 2.0.0
---
...
```
Refresh-AzSqlServerExternalGovernanceStatus [-ServerName] <String> [-ResourceGroupName] <String>
...
### Example 1
```powershell
PS C:\> Refresh-AzSqlServerExternalGovernanceStatus -ServerName MyServer -ResourceGroupName MyResourceGroup 
