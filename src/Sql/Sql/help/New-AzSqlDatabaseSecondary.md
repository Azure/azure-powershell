...
Creates a secondary database for an existing database and starts data replication. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
New-AzSqlDatabaseSecondary -AllowConnections No -PartnerResourceGroupName $secondaryresourcegroupname -PartnerServerName $secondaryservername -SecondaryElasticPoolName <String>
```
