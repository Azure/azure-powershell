...
```
New-AzSqlSyncMemberV2 -Name <String> -MemberDatabaseType <String> -MemberServerName <String>
 -MemberDatabaseName <String> -MemberDatabaseCredential <PSCredential> [-SyncDirection <String>]
 [-UsePrivateLinkConnection] [-SyncMemberAzureDatabaseResourceId <String>]
...
```
New-AzSqlSyncMemberV2 -Name <String> -MemberDatabaseType <String> -SyncAgentResourceGroupName <String>
...
```
New-AzSqlSyncMemberV2 -Name <String> -MemberDatabaseType <String> -SqlServerDatabaseId <String>
 -SyncAgentResourceID <String> [-SyncDirection <String>] [-UsePrivateLinkConnection]
 [-SyncMemberAzureDatabaseResourceId <String>] [-MemberDatabaseAuthenticationType <String>]
 [-IdentityId <String>] [-SyncGroupName] <String> [-ServerName] <String> [-DatabaseName] <String>
...
### Example 1: Create a sync member for an Azure SQL database using user managed identity authentication.
```powershell
$credential = Get-Credential
New-AzSqlSyncMemberV2 -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01" -SyncGroupName "SyncGroup01" -Name "SyncMember01" -SyncDirection "OneWayMemberToHub" `
-MemberDatabaseType "AzureSqlDatabase" -MemberServerName "memberServer01.full.dns.name" -MemberDatabaseName "memberDatabase01" -HubDatabaseAuthenticationType "userAssigned" `
...
[Update-AzSqlSyncMemberV2](./Update-AzSqlSyncMemberV2.md)
