...
```
Stop-AzSqlInstanceDatabaseLogReplay [-Force] -Name <String> -InstanceName <String> -ResourceGroupName <String>
...
```
Stop-AzSqlInstanceDatabaseLogReplay [-Force] -Name <String> [-PassThru]
