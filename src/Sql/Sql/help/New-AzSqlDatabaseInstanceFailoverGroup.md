...
Module Name: Az.Sql
online version: https://learn.microsoft.com/powershell/module/Az.sql/new-Azsqldatabaseinstancefailovergroup
schema: 2.0.0
---
...
New-AzSqlDatabaseInstanceFailoverGroup [-Name] <String> [-PartnerResourceGroupName <String>]
 ...
 [-AllowReadOnlyFailoverToPrimary <String>] [-SecondaryType <String>] [-ResourceGroupName] <String>
