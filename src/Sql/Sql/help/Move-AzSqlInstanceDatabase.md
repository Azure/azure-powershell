...
```
Move-AzSqlInstanceDatabase -DatabaseName <String> -InstanceObject <AzureSqlManagedInstanceModel> [-AsJob]
...
```
Move-AzSqlInstanceDatabase [-TargetResourceGroupName <String>] -TargetInstanceName <String>
