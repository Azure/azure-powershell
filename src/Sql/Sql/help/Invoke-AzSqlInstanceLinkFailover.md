...
# Invoke-AzSqlInstanceLinkFailover
...
```
Invoke-AzSqlInstanceLinkFailover [-ResourceGroupName] <String> [-InstanceName] <String> [-Name] <String>
...
```
Invoke-AzSqlInstanceLinkFailover [-Name] <String> -FailoverType <String>
...
```
Invoke-AzSqlInstanceLinkFailover [-Name] <String> -FailoverType <String> [-ResourceId] <String>
