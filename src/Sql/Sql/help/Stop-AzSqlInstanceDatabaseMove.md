...
```
Stop-AzSqlInstanceDatabaseMove -DatabaseName <String> -InstanceObject <AzureSqlManagedInstanceModel> [-AsJob]
...
```
Stop-AzSqlInstanceDatabaseMove [-TargetResourceGroupName <String>] -TargetInstanceName <String>
