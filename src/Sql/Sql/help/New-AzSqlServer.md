...
### -CreateMode
Specifies the create mode for the server, valid values for this parameter are "Normal" and "Restore".
...
Specifies the soft-delete retention days for the server.
