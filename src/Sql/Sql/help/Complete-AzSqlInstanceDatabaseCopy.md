...
```
Complete-AzSqlInstanceDatabaseCopy -CopyModelObject <MoveCopyManagedDatabaseModel> [-DatabaseName <String>]
...
```yaml
Type: System.String
Parameter Sets: CompleteManagedDatabaseCopyByCopyModelObject, MoveCopyManagedDatabaseByInputObjectParameterSet, MoveCopyManagedDatabaseByResourceIdParameterSet
Aliases: Name
