...
online version: https://learn.microsoft.com/powershell/module/az.sql/Remove-AzSqlServerAudit
schema: 2.0.0
---
...
## DESCRIPTION
The **Remove-AzSqlServerAudit** cmdlet removes the auditing settings of an Azure SQL server.
