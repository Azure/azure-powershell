...
Remove-AzSqlInstanceServerTrustCertificate [-ResourceGroupName] <String> [-InstanceName] <String>
 [-CertificateName] <String> [-AsJob] [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DeleteByParentObjectParameterSet
```
Remove-AzSqlInstanceServerTrustCertificate [-CertificateName] <String>
...
```
Remove-AzSqlInstanceServerTrustCertificate [-Certificate] <AzureSqlInstanceServerTrustCertificateModel>
 [-AsJob] [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteByResourceIdParameterSet
```
Remove-AzSqlInstanceServerTrustCertificate [-ResourceId] <String> [-AsJob]
