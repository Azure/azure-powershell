...
namespace Microsoft.Azure.Commands.Sql.ManagedDatabaseBackup.Cmdlet
{
    ...
    public class SetAzureSqlManagedDatabaseBackupLongTermRetentionPolicy : AzureSqlManagedDatabaseBackupLongTermRetentionPolicyCmdletBase
    {
        ...
        protected override IEnumerable<AzureSqlManagedDatabaseBackupLongTermRetentionPolicyModel> ApplyUserInputToModel(IEnumerable<AzureSqlManagedDatabaseBackupLongTermRetentionPolicyModel> model)
        {
            int temp;
        ...
        protected override IEnumerable<AzureSqlManagedDatabaseBackupLongTermRetentionPolicyModel> PersistChanges(IEnumerable<AzureSqlManagedDatabaseBackupLongTermRetentionPolicyModel> entity)
        {
