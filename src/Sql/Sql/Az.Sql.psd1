...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added warning for BackupStorageRedundancy configuration in select regions in ''New-AzSqlDatabase'' (Ignore Case for BackupStorageRedundancy configuration input)
