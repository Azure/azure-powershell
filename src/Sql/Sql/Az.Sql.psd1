...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added multi-secondary support for ''Get-AzSqlDatabaseFailoverGroup'', ''Remove-AzSqlDatabaseFromFailoverGroup'' and ''Add-AzSqlDatabaseFromFailoverGroup''
