...
CmdletsToExport = 'Get-AzSqlDatabaseTransparentDataEncryption', 
               ...
               'Get-AzSqlServerIpv6FirewallRule', 'New-AzSqlServerIpv6FirewallRule', 
               'Remove-AzSqlServerIpv6FirewallRule', 'Set-AzSqlServerIpv6FirewallRule', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added new fields to the ''Get-AzSqlInstanceDatabaseLogReplay'' cmdlet
