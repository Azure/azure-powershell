...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added multi-database Managed Instance links through ''LinkMode'' on ''New-AzSqlInstanceLink'' and database membership updates on ''Update-AzSqlInstanceLink''.
