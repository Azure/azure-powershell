...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added new cmdlets ''Get-AzSqlInstanceDatabaseLedgerDigestUpload'', ''Disable-AzSqlInstanceDatabaseLedgerDigestUpload'', and ''Enable-AzSqlInstanceDatabaseLedgerDigestUpload''
