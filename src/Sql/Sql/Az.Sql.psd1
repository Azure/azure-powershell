...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added multi-database Managed Instance link support through ''LinkMode'' on ''New-AzSqlInstanceLink'' and database membership updates on ''Update-AzSqlInstanceLink''.
