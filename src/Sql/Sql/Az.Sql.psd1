...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* changed Threat Detection''s cmdlets param (ExcludeDetectionType) from DetectionType to string[] to make it future proof when new DetectionTypes are added and to support autocomplete as well.'
