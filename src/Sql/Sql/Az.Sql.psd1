...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added support for User Assigned Managed Identity (UAMI) authentication in Data Sync cmdlets (''New-AzSqlSyncGroup'', ''Update-AzSqlSyncGroup'', ''New-AzSqlSyncMember'', ''Update-AzSqlSyncMember'')'
