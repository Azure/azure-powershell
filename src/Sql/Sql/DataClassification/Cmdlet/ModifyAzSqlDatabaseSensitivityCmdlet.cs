...
{
    public abstract class ModifyAzSqlDatabaseSensitivityCmdlet : AzureSqlDatabaseCmdletBase<SqlDatabaseSensitivityClassificationModel, DataClassificationAdapter>
    {
        [Parameter(
