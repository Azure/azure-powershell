...
namespace Microsoft.Azure.Management.Sql
{
    ...
    /// </summary>
    internal partial class ExtendedDatabaseBlobAuditingPoliciesOperations : IServiceOperations<SqlManagementClient>, IExtendedDatabaseBlobAuditingPoliciesOperations
    {
        /// <summary>
        /// Initializes a new instance of the ExtendedDatabaseBlobAuditingPoliciesOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ExtendedDatabaseBlobAuditingPoliciesOperations(SqlManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<ExtendedDatabaseBlobAuditingPolicy>>> ListByDatabaseWithHttpMessagesAsync(string resourceGroupName, string serverName, string databaseName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/extendedAuditingSettings").ToString();
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<ExtendedDatabaseBlobAuditingPolicy>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page1<ExtendedDatabaseBlobAuditingPolicy>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<ExtendedDatabaseBlobAuditingPolicy>> GetWithHttpMessagesAsync(string resourceGroupName, string serverName, string databaseName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<ExtendedDatabaseBlobAuditingPolicy>>> ListByDatabaseNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
