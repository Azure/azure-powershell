...
namespace Microsoft.Azure.Management.Sql
{
    ...
    internal partial class RecoverableDatabasesOperations : IServiceOperations<SqlManagementClient>, IRecoverableDatabasesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<RecoverableDatabase>>> ListByServerWithHttpMessagesAsync(string resourceGroupName, string serverName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<RecoverableDatabase>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page1<RecoverableDatabase>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<RecoverableDatabase>>> ListByServerNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
