...
namespace Microsoft.Azure.Management.Sql
{
    ...
    public static partial class RestorableDroppedDatabasesOperationsExtensions
    {
            ...
            /// </param>
            public static RestorableDroppedDatabase Get(this IRestorableDroppedDatabasesOperations operations, string resourceGroupName, string serverName, string restorableDroppedDatabaseId, ODataQuery<RestorableDroppedDatabase> odataQuery = default(ODataQuery<RestorableDroppedDatabase>))
            {
                return operations.GetAsync(resourceGroupName, serverName, restorableDroppedDatabaseId, odataQuery).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<RestorableDroppedDatabase> GetAsync(this IRestorableDroppedDatabasesOperations operations, string resourceGroupName, string serverName, string restorableDroppedDatabaseId, ODataQuery<RestorableDroppedDatabase> odataQuery = default(ODataQuery<RestorableDroppedDatabase>), CancellationToken cancellationToken = default(CancellationToken))
            {
