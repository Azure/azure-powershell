...
namespace Microsoft.Azure.Management.Sql
{
    ...
    public partial interface IRestorableDroppedDatabasesOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<RestorableDroppedDatabase>> GetWithHttpMessagesAsync(string resourceGroupName, string serverName, string restorableDroppedDatabaseId, ODataQuery<RestorableDroppedDatabase> odataQuery = default(ODataQuery<RestorableDroppedDatabase>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets a list of restorable dropped databases.
        /// </summary>
