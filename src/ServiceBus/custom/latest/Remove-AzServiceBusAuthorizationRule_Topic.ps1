...
#>
function Remove-AzServiceBusAuthorizationRule_Topic {
[OutputType('System.Boolean')]
[CmdletBinding(PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
[Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Profile('latest-2019-04-30')]
[Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Description('Deletes a topic authorization rule.')]
param(
...
process {
    Az.ServiceBus.internal\Remove-AzServiceBusTopicAuthorizationRule @PSBoundParameters
}
