...
[Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Description('Regenerates primary or secondary connection strings for the topic.')]
param(
...
process {
    Az.ServiceBus.internal\New-AzServiceBusTopicKey @PSBoundParameters
}
