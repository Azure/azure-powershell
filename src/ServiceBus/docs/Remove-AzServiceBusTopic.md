...
### DeleteViaIdentity
```
Remove-AzServiceBusTopic -InputObject <IServiceBusIdentity> [-PassThru] [-DefaultProfile <PSObject>] [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/az.servicebus/remove-azservicebustopic](https://docs.microsoft.com/en-us/powershell/module/az.servicebus/remove-azservicebustopic)
