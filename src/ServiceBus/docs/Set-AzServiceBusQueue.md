...
Set-AzServiceBusQueue -Name <String> -NamespaceName <String> -ResourceGroupName <String>
 ...
 [-RequiresSession] [-Status <EntityStatus>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
...
Set-AzServiceBusQueue -InputObject <IServiceBusIdentity> [-AutoDeleteOnIdle <TimeSpan>]
 ...
 [-MaxSizeInMegabyte <Int32>] [-RequiresDuplicateDetection] [-RequiresSession] [-Status <EntityStatus>]
