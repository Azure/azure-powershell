...
### RemoveExpandedQueue
```
Remove-AzServiceBusAuthorizationRule -Name <String> -NamespaceName <String> -QueueName <String>
...
```
Remove-AzServiceBusAuthorizationRule -Name <String> -NamespaceName <String> -ResourceGroupName <String>
 -TopicName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
