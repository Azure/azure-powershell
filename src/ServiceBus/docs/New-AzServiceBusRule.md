...
New-AzServiceBusRule -Name <String> -NamespaceName <String> -ResourceGroupName <String>
 ...
 [-CorrelationFilterRequiresPreprocessing] [-CorrelationFilterSessionId <String>] [-CorrelationId <String>]
 [-FilterType <FilterType>] [-Label <String>] [-MessageId <String>] [-ReplyTo <String>]
 [-ReplyToSessionId <String>] [-SqlExpression <String>] [-SqlFilterCompatibilityLevel <Int32>]
