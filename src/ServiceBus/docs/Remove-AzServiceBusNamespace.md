...
### DeleteViaIdentity
```
Remove-AzServiceBusNamespace -InputObject <IServiceBusIdentity> [-PassThru] [-DefaultProfile <PSObject>]
...
[https://docs.microsoft.com/en-us/powershell/module/az.servicebus/remove-azservicebusnamespace](https://docs.microsoft.com/en-us/powershell/module/az.servicebus/remove-azservicebusnamespace)
