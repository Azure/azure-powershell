...
### NewExpandedEntity
```
New-AzServiceBusKey -KeyType <KeyType> [-SubscriptionId <String>] [-KeyValue <String>]
...
New-AzServiceBusKey -Name <String> -NamespaceName <String> -QueueName <String> -ResourceGroupName <String>
 -KeyType <KeyType> [-KeyValue <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: NewExpandedNamespace, NewExpandedQueue, NewExpandedTopic
Aliases:
...
```yaml
Type: System.String
Parameter Sets: NewExpandedEntity, NewExpandedNamespace
Aliases:
