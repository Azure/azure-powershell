...
online version: https://docs.microsoft.com/powershell/module/az.servicebus/new-azservicebusnetworkruleset
schema: 2.0.0
---

# New-AzServiceBusNetworkRuleSet
...
```
New-AzServiceBusNetworkRuleSet -NamespaceName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
