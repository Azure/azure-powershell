...
function Start-AzServiceBusNamespaceFailOver{
    ...
    dynamicparam {
        ...
        $wrapped = Get-Command 'Az.ServiceBus.private\Set-AzServiceBusNamespace_FailoverExpanded' -ErrorAction Ignore
    ...
    process{
		try{
            ...
            if ($PSCmdlet.ShouldProcess("ServiceBus Namespace $($NamespaceName)", "Fail Over")) {
                Az.ServiceBus.private\Set-AzServiceBusNamespace_FailoverExpanded @PSBoundParameters
            }
		}
		catch{
			throw
