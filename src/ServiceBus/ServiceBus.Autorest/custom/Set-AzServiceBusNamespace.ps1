...
function Set-AzServiceBusNamespace{
	...
	param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.ParameterBreakingChangeAttribute("IdentityType","12.0.0", "7.0.0","2024-05-21" )]
        ${IdentityType},
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.ParameterBreakingChangeAttribute("PublicNetworkAccess","12.0.0", "7.0.0","2024-05-21" )]
        ${PublicNetworkAccess},

        [Parameter(HelpMessage = "Name of this SKU.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Category('Body')]
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Support.SkuName]
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.ParameterBreakingChangeAttribute("SkuName","12.0.0", "7.0.0","2024-05-21" )]
        ${SkuName},
