...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Support.PrivateLinkConnectionStatus Approved = @"Approved";

        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Support.PrivateLinkConnectionStatus Disconnected = @"Disconnected";

        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Support.PrivateLinkConnectionStatus Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Support.PrivateLinkConnectionStatus Rejected = @"Rejected";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Support.PrivateLinkConnectionStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Support.PrivateLinkConnectionStatus e)
        {
            return e._value;
        }
