...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models
{
    ...
    public partial class PlatformCapabilities
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IPlatformCapabilities.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IPlatformCapabilities.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IPlatformCapabilities FromJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonObject json ? new PlatformCapabilities(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonObject into a new instance of <see cref="PlatformCapabilities" />.
        /// </summary>
        ...
        internal PlatformCapabilities(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonObject json)
        {
            ...
            {_confidentialCompute = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonObject>("confidentialCompute"), out var __jsonConfidentialCompute) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.ConfidentialCompute.FromJson(__jsonConfidentialCompute) : _confidentialCompute;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PlatformCapabilities" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PlatformCapabilities" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._confidentialCompute ? (Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode) this._confidentialCompute.ToJson(null,serializationMode) : null, "confidentialCompute" ,container.Add );
