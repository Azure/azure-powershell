...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models
{
    ...
    public partial class KeyVaultProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IKeyVaultPropertiesInternal
    {

        /// <summary>Backing field for <see cref="Identity" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IUserAssignedIdentityProperties _identity;

        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IUserAssignedIdentityProperties Identity { get => (this._identity = this._identity ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.UserAssignedIdentityProperties()); set => this._identity = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IUserAssignedIdentityProperties Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IKeyVaultPropertiesInternal.Identity { get => (this._identity = this._identity ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.UserAssignedIdentityProperties()); set { {_identity = value;} } }
        ...
        public string UserAssignedIdentity { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IUserAssignedIdentityPropertiesInternal)Identity).UserAssignedIdentity; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IUserAssignedIdentityPropertiesInternal)Identity).UserAssignedIdentity = value ?? null; }
    ...
    {
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IUserAssignedIdentityProperties Identity { get; set; }
        /// <summary>Name of the Key from KeyVault</summary>
        string KeyName { get; set; }
        /// <summary>Uri of KeyVault</summary>
        string KeyVaultUri { get; set; }
