...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview
{
    ...
    public partial class MigrationConfigPropertiesAutoGenerated :
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.IMigrationConfigPropertiesAutoGenerated,
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.IMigrationConfigPropertiesAutoGeneratedInternal
    {

        /// <summary>Internal Acessors for MigrationState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.IMigrationConfigPropertiesAutoGeneratedInternal.MigrationState { get => this._migrationState; set { {_migrationState = value;} } }

        /// <summary>Internal Acessors for PendingReplicationOperationsCount</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.IMigrationConfigPropertiesAutoGeneratedInternal.PendingReplicationOperationsCount { get => this._pendingReplicationOperationsCount; set { {_pendingReplicationOperationsCount = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20221001Preview.IMigrationConfigPropertiesAutoGeneratedInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }
