...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview
{
    ...
    public partial class NwRuleSetVirtualNetworkRules :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.INwRuleSetVirtualNetworkRulesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.ISubnet _subnet;

        /// <summary>Subnet properties</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.ISubnet Subnet { get => (this._subnet = this._subnet ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.Subnet()); set => this._subnet = value; }
        ...
        public string SubnetId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.ISubnetInternal)Subnet).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.ISubnetInternal)Subnet).Id = value ?? null; }
...

    {
        ...
        bool? IgnoreMissingVnetServiceEndpoint { get; set; }
        /// <summary>Subnet properties</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.ISubnet Subnet { get; set; }
        /// <summary>Resource ID of Virtual Network Subnet</summary>
        string SubnetId { get; set; }
