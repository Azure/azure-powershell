...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview
{
    ...
    public partial class MigrationConfigPropertiesAutoGenerated :
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IMigrationConfigPropertiesAutoGenerated,
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IMigrationConfigPropertiesAutoGeneratedInternal
    {

        /// <summary>Internal Acessors for MigrationState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IMigrationConfigPropertiesAutoGeneratedInternal.MigrationState { get => this._migrationState; set { {_migrationState = value;} } }

        /// <summary>Internal Acessors for PendingReplicationOperationsCount</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IMigrationConfigPropertiesAutoGeneratedInternal.PendingReplicationOperationsCount { get => this._pendingReplicationOperationsCount; set { {_pendingReplicationOperationsCount = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202201Preview.IMigrationConfigPropertiesAutoGeneratedInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }
        ...
        /// <summary>Creates an new <see cref="MigrationConfigPropertiesAutoGenerated" /> instance.</summary>
        public MigrationConfigPropertiesAutoGenerated()
        {
    ...
    /// Properties required to the Create Migration Configuration
    internal partial interface IMigrationConfigPropertiesAutoGeneratedInternal
