...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IArmDisasterRecovery _parameter;

        /// <summary>Single item in List or Get Alias(Disaster Recovery configuration) operation</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Single item in List or Get Alias(Disaster Recovery configuration) operation", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IArmDisasterRecovery Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzServiceBusGeoDRConfiguration_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzServiceBusGeoDRConfiguration_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DisasterRecoveryConfigsCreateOrUpdateViaIdentity(InputObject.Id, Parameter, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        ...
                        await this.Client.DisasterRecoveryConfigsCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.NamespaceName ?? null, InputObject.Alias ?? null, Parameter, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.SerializationMode.IncludeCreate);
                    }
