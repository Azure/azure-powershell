...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.IEventListener
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.DisasterRecoveryConfigsDelete(InputObject.ResourceGroupName ?? null, InputObject.NamespaceName ?? null, InputObject.Alias ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzServiceBusGeoDRConfiguration_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
