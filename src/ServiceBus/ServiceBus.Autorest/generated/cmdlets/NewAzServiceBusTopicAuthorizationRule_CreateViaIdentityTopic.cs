...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Cmdlets
{
    ...
    /// <summary>Create an authorization rule for the specified topic.</summary>
    /// <remarks>
    /// [OpenAPI] CreateOrUpdateAuthorizationRule=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/topics/{topicName}/authorizationRules/{authorizationRuleName}"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzServiceBusTopicAuthorizationRule_CreateViaIdentityTopic", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Description(@"Create an authorization rule for the specified topic.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.ExternalDocs(@"https://msdn.microsoft.com/en-us/library/azure/mt720678.aspx", @"")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/topics/{topicName}/authorizationRules/{authorizationRuleName}", ApiVersion = "2022-10-01-preview")]
    public partial class NewAzServiceBusTopicAuthorizationRule_CreateViaIdentityTopic : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.ISbAuthorizationRule _parameter;

        /// <summary>Description of a namespace authorization rule.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Description of a namespace authorization rule.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.ISbAuthorizationRule Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IServiceBusIdentity _topicInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IServiceBusIdentity TopicInputObject { get => this._topicInputObject; set => this._topicInputObject = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.ISbAuthorizationRule">Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.ISbAuthorizationRule</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.ISbAuthorizationRule> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzServiceBusTopicAuthorizationRule_CreateViaIdentityTopic" /> cmdlet class.
        /// </summary>
        public NewAzServiceBusTopicAuthorizationRule_CreateViaIdentityTopic()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'TopicsCreateOrUpdateAuthorizationRule' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.TopicInputObject.Id += $"/authorizationRules/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.TopicsCreateOrUpdateAuthorizationRuleViaIdentity(TopicInputObject.Id, Parameter, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        ...
                        if (null == TopicInputObject.NamespaceName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("TopicInputObject has null value for TopicInputObject.NamespaceName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, TopicInputObject) );
                        }
                        ...
                        await this.Client.TopicsCreateOrUpdateAuthorizationRule(TopicInputObject.SubscriptionId ?? null, TopicInputObject.ResourceGroupName ?? null, TopicInputObject.NamespaceName ?? null, TopicInputObject.TopicName ?? null, Name, Parameter, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.SerializationMode.IncludeCreate);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.ISbAuthorizationRule> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.ISbAuthorizationRule
