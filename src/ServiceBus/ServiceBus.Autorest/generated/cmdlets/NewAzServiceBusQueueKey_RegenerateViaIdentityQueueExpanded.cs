...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RegenerateKeys=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/queues/{queueName}/authorizationRules/{authorizationRuleName}/regenerateKeys"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzServiceBusQueueKey_RegenerateViaIdentityQueueExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IAccessKeys))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Description(@"Regenerates the primary or secondary connection strings to the queue.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.ExternalDocs(@"https://msdn.microsoft.com/en-us/library/azure/mt705606.aspx", @"")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/queues/{queueName}/authorizationRules/{authorizationRuleName}/regenerateKeys", ApiVersion = "2022-10-01-preview")]
    public partial class NewAzServiceBusQueueKey_RegenerateViaIdentityQueueExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.IContext
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IRegenerateAccessKeyParameters _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.RegenerateAccessKeyParameters();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Optional, if the key value provided, is reset for KeyType value or autogenerate Key value set for keyType")]
        ...
        public string Key { get => _parametersBody.Key ?? null; set => _parametersBody.Key = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.PSArgumentCompleterAttribute("PrimaryKey", "SecondaryKey")]
        public string KeyType { get => _parametersBody.KeyType ?? null; set => _parametersBody.KeyType = value; }
        ...
        /// <summary>Backing field for <see cref="QueueInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IServiceBusIdentity _queueInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IServiceBusIdentity QueueInputObject { get => this._queueInputObject; set => this._queueInputObject = value; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzServiceBusQueueKey_RegenerateViaIdentityQueueExpanded" /> cmdlet class.
        /// </summary>
        public NewAzServiceBusQueueKey_RegenerateViaIdentityQueueExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'QueuesRegenerateKeys' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (QueueInputObject?.Id != null)
                    {
                        this.QueueInputObject.Id += $"/authorizationRules/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.QueuesRegenerateKeysViaIdentity(QueueInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == QueueInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("QueueInputObject has null value for QueueInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, QueueInputObject) );
                        }
                        if (null == QueueInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("QueueInputObject has null value for QueueInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, QueueInputObject) );
                        }
                        if (null == QueueInputObject.NamespaceName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("QueueInputObject has null value for QueueInputObject.NamespaceName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, QueueInputObject) );
                        }
                        if (null == QueueInputObject.QueueName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("QueueInputObject has null value for QueueInputObject.QueueName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, QueueInputObject) );
                        }
                        await this.Client.QueuesRegenerateKeys(QueueInputObject.SubscriptionId ?? null, QueueInputObject.ResourceGroupName ?? null, QueueInputObject.NamespaceName ?? null, QueueInputObject.QueueName ?? null, Name, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
