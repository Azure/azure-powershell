...
Describe 'Set-AzServiceBusRule' {
    It 'SetExpanded' {
        Set-AzServiceBusRule -ResourceGroupName $env.resourceGroup -NamespaceName $env.namespace -TopicName $env.topic -SubscriptionName $env.subscription -Name sqlRule1 -FilterType SqlFilter -SqlExpression x=y
    ...
    It 'SetViaIdentityExpanded' {
        $currentRule = Get-AzServiceBusRule -ResourceGroupName $env.resourceGroup -NamespaceName $env.namespace -TopicName $env.topic -SubscriptionName $env.subscription -Name correlationRule1
