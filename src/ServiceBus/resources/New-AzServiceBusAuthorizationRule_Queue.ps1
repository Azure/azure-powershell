...
[Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Description('Creates an authorization rule for a queue.')]
param(
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'Az.ServiceBus.private\New-AzServiceBusQueueAuthorizationRule_Create';
            CreateExpanded = 'Az.ServiceBus.private\New-AzServiceBusQueueAuthorizationRule_CreateExpanded';
            CreateSubscriptionIdViaHost = 'Az.ServiceBus.private\New-AzServiceBusQueueAuthorizationRule_CreateSubscriptionIdViaHost';
            CreateSubscriptionIdViaHostExpanded = 'Az.ServiceBus.private\New-AzServiceBusQueueAuthorizationRule_CreateSubscriptionIdViaHostExpanded';
        }
