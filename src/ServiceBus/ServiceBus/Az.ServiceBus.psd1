...
CmdletsToExport = 'New-AzServiceBusNamespace', 'Get-AzServiceBusNamespace', 
               ...
               'Set-AzServiceBusNetworkRuleSet', 'New-AzServiceBusAuthorizationRuleSASToken'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fix for issue #4938 - New-AzureRmServiceBusQueue returns BadRequest when setting MaxSizeInMegabytes'
