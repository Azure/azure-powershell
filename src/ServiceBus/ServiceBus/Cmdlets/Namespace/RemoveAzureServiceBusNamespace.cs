...
namespace Microsoft.Azure.Commands.ServiceBus.Commands.Namespace
{
    ...
    public class RemoveAzureRmServiceBusNamespace : AzureServiceBusCmdletBase
    {
        ...
        [GenericBreakingChange("The type of the `-InputObject` parameter would change to `Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202210Preview.ISbNamespace`.", deprecateByVersion: DeprecateByVersion, changeInEfectByDate: ChangeInEffectByDate)]
