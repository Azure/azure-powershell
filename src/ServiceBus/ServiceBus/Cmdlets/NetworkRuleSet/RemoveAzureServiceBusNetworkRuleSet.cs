...
namespace Microsoft.Azure.Commands.ServiceBus.Commands.NetworkruleSet
{
    ...
    public class RemoveAzureServiceBusNetworkRuleSet : AzureServiceBusCmdletBase
    {
        ...
        [Parameter(Mandatory = true, ParameterSetName = NetwrokruleSetPropertiesParameterSet, ValueFromPipelineByPropertyName = true, Position = 1, HelpMessage = "Namespace Name")]
        [ValidateNotNullOrEmpty]
