...
namespace Microsoft.Azure.Commands.ServiceBus.Models
{
    ...
    /// </summary>
    public partial class PSCheckNameQueueTopicResultAttributes
    {
        /// <summary>
        /// Initializes a new instance of the CheckNameAvailability class.
        /// </summary>
        public PSCheckNameQueueTopicResultAttributes() { }
        ...
        public PSCheckNameQueueTopicResultAttributes(string name)
        {
            Name = name;
        }
