...
namespace Microsoft.Azure.Commands.ServiceBus.Models
{
    ...
    public class PSServiceBusPrivateEndpointAttributes
    {
        ...
        public PSServiceBusPrivateEndpointAttributes(Microsoft.Azure.Management.ServiceBus.Models.PrivateEndpointConnection privateEndpoint)
        {
            if (privateEndpoint != null)
            {
                ...
                PrivateEndpointId = privateEndpoint?.PrivateEndpoint?.Id;
