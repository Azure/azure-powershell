...
```
Remove-AzServiceBusPrivateEndpointConnection [-ResourceGroupName] <String> [-NamespaceName] <String>
...
```
Remove-AzServiceBusPrivateEndpointConnection [-ResourceId] <String> [-PassThru]
