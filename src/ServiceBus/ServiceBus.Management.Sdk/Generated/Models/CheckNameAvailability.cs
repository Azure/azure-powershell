...
namespace Microsoft.Azure.Management.ServiceBus.Models
{
    ...
    public partial class CheckNameAvailability
    {
        ...
        /// <param name="name">The Name to check the namespace name availability and The namespace name
        ...
        /// <summary>
        /// Gets or sets the Name to check the namespace name availability and The
