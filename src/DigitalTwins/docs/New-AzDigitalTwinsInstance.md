...
New-AzDigitalTwinsInstance -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
 [-EnableSystemAssignedIdentity] [-Location <String>]
...
```
New-AzDigitalTwinsInstance -InputObject <IDigitalTwinsIdentity> [-EnableSystemAssignedIdentity]
 [-Location <String>] [-PrivateEndpointConnection <IPrivateEndpointConnection[]>]
