...
### Create
```
New-AzDigitalTwinsDigitalTwin -ResourceGroupName <String> -ResourceName <String>
...
```
New-AzDigitalTwinsDigitalTwin -ResourceGroupName <String> -ResourceName <String> -JsonFilePath <String>
...
### CreateViaJsonString
```
New-AzDigitalTwinsDigitalTwin -ResourceGroupName <String> -ResourceName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
