...
```
Update-AzDigitalTwinsTimeSeriesDatabaseConnection -DigitalTwinsInstanceInputObject <IDigitalTwinsIdentity>
 -Name <String> -TimeSeriesDatabaseConnectionDescription <ITimeSeriesDatabaseConnection>
