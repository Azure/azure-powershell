...
New-AzSpringCloud -ResourceGroupName $ResourceGroupName -name $ServiceName -Location eastus

New-AzSpringCloudApp -ResourceGroupName $ResourceGroupName -ServiceName $ServiceName -Name $GatewayAppName
New-AzSpringCloudAppDeployment -ResourceGroupName $ResourceGroupName -ServiceName $ServiceName -AppName $GatewayAppName -Name default -Cpu 1 -InstanceCount 1 -MemoryInGb 1
...
New-AzSpringCloudAppDeployment -ResourceGroupName $ResourceGroupName -ServiceName $ServiceName -AppName $AuthAppName -Name default -Cpu 1 -InstanceCount 1 -MemoryInGb 1
...
New-AzSpringCloudAppDeployment -ResourceGroupName $ResourceGroupName -ServiceName $ServiceName -AppName $AccountAppName -Name default -Cpu 1 -InstanceCount 1 -MemoryInGb 1
