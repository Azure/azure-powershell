...
### GetViaIdentityDrill
```
Get-AzResilienceDrillRunResource -DrillInputObject <IResilienceIdentity> -DrillRunName <String> -Name <String>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityDrillRun
```
Get-AzResilienceDrillRunResource -DrillRunInputObject <IResilienceIdentity> -Name <String>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
