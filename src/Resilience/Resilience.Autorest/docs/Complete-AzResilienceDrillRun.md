...
```
Complete-AzResilienceDrillRun -DrillInputObject <IResilienceIdentity> -Name <String> -OperationId <String>
 -Body <IMarkAsCompleteRequest> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Complete-AzResilienceDrillRun -DrillName <String> -Name <String>
 -ServiceGroupInputObject <IResilienceIdentity> -OperationId <String> -Body <IMarkAsCompleteRequest>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Complete-AzResilienceDrillRun -DrillName <String> -Name <String>
 -ServiceGroupInputObject <IResilienceIdentity> -OperationId <String> -DrillRunStage <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
