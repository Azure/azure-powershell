...
online version: https://learn.microsoft.com/powershell/module/az.resilience/invoke-azresiliencerecoveryplanfailover
schema: 2.0.0
---
...
```
Invoke-AzResilienceRecoveryPlanFailover -RecoveryPlanName <String> -ServiceGroupName <String>
...
### InvokeViaIdentity
```
Invoke-AzResilienceRecoveryPlanFailover -InputObject <IResilienceIdentity> -OperationId <String>
...
```
Invoke-AzResilienceRecoveryPlanFailover -RecoveryPlanName <String>
