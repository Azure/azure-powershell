...
online version: https://learn.microsoft.com/powershell/module/az.resilience/test-azresiliencerecoveryplantestfailovercleanupvalidation
schema: 2.0.0
---
...
### Test (Default)
```
Test-AzResilienceRecoveryPlanTestFailoverCleanupValidation -RecoveryPlanName <String>
...
### TestViaIdentity
```
Test-AzResilienceRecoveryPlanTestFailoverCleanupValidation -InputObject <IResilienceIdentity>
