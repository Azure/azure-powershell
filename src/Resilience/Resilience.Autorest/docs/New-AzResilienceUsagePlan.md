...
```
New-AzResilienceUsagePlan -Name <String> -ResourceGroupName <String> -Location <String>
...
### Create
```
New-AzResilienceUsagePlan -Name <String> -ResourceGroupName <String> -Resource <IUsagePlan>
...
```
New-AzResilienceUsagePlan -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### CreateViaJsonString
```
New-AzResilienceUsagePlan -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
