...
online version: https://learn.microsoft.com/powershell/module/az.resilience/set-azresilienceenrollment
schema: 2.0.0
---
...
```
Set-AzResilienceEnrollment -Name <String> -ResourceGroupName <String> -UsagePlanName <String>
 [-SubscriptionId <String>] [-ServiceGroupId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```
Set-AzResilienceEnrollment -Name <String> -ResourceGroupName <String> -UsagePlanName <String>
 -Resource <IEnrollment> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
...
Replaces the specified enrollment.
