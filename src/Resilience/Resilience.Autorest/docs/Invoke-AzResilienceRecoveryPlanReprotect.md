...
online version: https://learn.microsoft.com/powershell/module/az.resilience/invoke-azresiliencerecoveryplanreprotect
schema: 2.0.0
---
...
```
Invoke-AzResilienceRecoveryPlanReprotect -RecoveryPlanName <String> -ServiceGroupName <String>
...
### InvokeViaIdentity
```
Invoke-AzResilienceRecoveryPlanReprotect -InputObject <IResilienceIdentity> -OperationId <String>
...
```
Invoke-AzResilienceRecoveryPlanReprotect -RecoveryPlanName <String>
 -ServiceGroupInputObject <IResilienceIdentity> -OperationId <String> -Body <IReprotectRequest>
...
### Example 1: Run recovery plan reprotect
```powershell
Invoke-AzResilienceRecoveryPlanReprotect `
...
Starts the recovery plan reprotect operation and returns the job that tracks it.
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Resilience.Models.IReprotectRequest
...
### Microsoft.Azure.PowerShell.Cmdlets.Resilience.Models.IReprotectRequest
