if(($null -eq $TestName) -or ($TestName -contains 'Add-AzResilienceDrillRunNote'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Add-AzResilienceDrillRunNote.Recording.json'
...
Describe 'Add-AzResilienceDrillRunNote' {
    It 'AddExpanded' -skip {
