if(($null -eq $TestName) -or ($TestName -contains 'Start-AzResilienceDrill'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Start-AzResilienceDrill.Recording.json'
...
Describe 'Start-AzResilienceDrill' {
