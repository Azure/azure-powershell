if(($null -eq $TestName) -or ($TestName -contains 'Stop-AzResilienceRecoveryJob'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Stop-AzResilienceRecoveryJob.Recording.json'
...
Describe 'Stop-AzResilienceRecoveryJob' {
