...
### List (Default)
```
Get-AzResilienceEnrollment -ResourceGroupName <String> [-SubscriptionId <String[]>] -UsagePlanName <String>
...
### Get
```
Get-AzResilienceEnrollment -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
...
```yaml
Type: System.String
Parameter Sets: GetViaIdentityUsagePlan, Get
