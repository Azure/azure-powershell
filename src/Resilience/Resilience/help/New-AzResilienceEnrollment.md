...
online version: https://learn.microsoft.com/powershell/module/az.resilience/new-azresilienceenrollment
schema: 2.0.0
---
...
```
New-AzResilienceEnrollment -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
New-AzResilienceEnrollment -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -UsagePlanName <String> -JsonString <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
New-AzResilienceEnrollment -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -UsagePlanName <String> -JsonFilePath <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaIdentityUsagePlanExpanded
```
New-AzResilienceEnrollment -Name <String> -UsagePlanInputObject <IResilienceIdentity>
...
```
New-AzResilienceEnrollment -Name <String> -UsagePlanInputObject <IResilienceIdentity> -Resource <IEnrollment>
...
```
New-AzResilienceEnrollment -InputObject <IResilienceIdentity> [-ServiceGroupId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-AzResilienceEnrollment -InputObject <IResilienceIdentity> -Resource <IEnrollment>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded, CreateViaJsonString, CreateViaJsonFilePath, CreateViaIdentityUsagePlanExpanded, CreateViaIdentityUsagePlan, Create
...
Parameter Sets: CreateViaIdentityUsagePlan, Create, CreateViaIdentity
Aliases:
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded, CreateViaIdentityUsagePlanExpanded, CreateViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Resilience.Models.IResilienceIdentity
Parameter Sets: CreateViaIdentityUsagePlanExpanded, CreateViaIdentityUsagePlan
Aliases:
