...
### Delete (Default)
```
Remove-AzResilienceEnrollment -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -UsagePlanName <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
