...
### Resume (Default)
```
Resume-AzResilienceDrillRun -DrillName <String> -Name <String> -ServiceGroupName <String> -OperationId <String>
...
```
Resume-AzResilienceDrillRun -Name <String> -DrillInputObject <IResilienceIdentity> -OperationId <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Resume, ResumeViaIdentityServiceGroup, ResumeViaIdentityDrill
