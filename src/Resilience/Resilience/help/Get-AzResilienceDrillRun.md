...
### GetViaIdentityDrill
```
Get-AzResilienceDrillRun -Name <String> -DrillInputObject <IResilienceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzResilienceDrillRun -InputObject <IResilienceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
