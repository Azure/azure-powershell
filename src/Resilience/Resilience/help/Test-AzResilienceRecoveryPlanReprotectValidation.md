...
online version: https://learn.microsoft.com/powershell/module/az.resilience/test-azresiliencerecoveryplanreprotectvalidation
schema: 2.0.0
---
...
```
Test-AzResilienceRecoveryPlanReprotectValidation -RecoveryPlanName <String> -ServiceGroupName <String>
...
```
Test-AzResilienceRecoveryPlanReprotectValidation -RecoveryPlanName <String>
...
```
Test-AzResilienceRecoveryPlanReprotectValidation -InputObject <IResilienceIdentity> -OperationId <String>
 [-ReprotectRequestPropertySelectedResourceId <String[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
