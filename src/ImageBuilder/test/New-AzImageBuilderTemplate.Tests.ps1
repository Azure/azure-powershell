...
Describe 'New-AzImageBuilderTemplate' {
    ...
    It 'platformimg-managedimg' {
        #region OS:Linux
        $srcPlatform = New-AzImageBuilderSource -SourceTypePlatformImage -Publisher $env.Source.PlatformImageLinux.publisher -Offer $env.Source.PlatformImageLinux.offer -Sku $env.Source.PlatformImageLinux.sku -Version $env.Source.PlatformImageLinux.version
        $disManagedImg = New-AzImageBuilderDistributor -ManagedImageDistributor -ArtifactTag @{source='azVmPlatform';baseofimg='UbuntuServer'} -ImageId "/subscriptions/$($env.SubscriptionId)/resourceGroups/$($env.ResourceGroup)/providers/Microsoft.Compute/images/$($env.Resources.Distributor.distributorName01)" -Location $env.Location -RunOutputName $env.Resources.RunOutputName.runOutputName21
        ...
        New-AzImageBuilderTemplate -ImageTemplateName $env.Resources.Template.templateName11 -ResourceGroupName $env.ResourceGroup -Source $srcPlatform -Distribute $disManagedImg -Customize $customizer -Location $env.Location 
    ...
    It 'platformimg-vhd' {
        #region OS:Linux
        $srcPlatform = New-AzImageBuilderSource -SourceTypePlatformImage -Publisher $env.Source.PlatformImageLinux.publisher -Offer $env.Source.PlatformImageLinux.offer -Sku $env.Source.PlatformImageLinux.sku -Version $env.Source.PlatformImageLinux.version 
        $disVhd = New-AzImageBuilderDistributor -VhdDistributor -ArtifactTag @{tag='VHD'} -RunOutputName $env.Resources.RunOutputName.runOutputName22
        ...
        New-AzImageBuilderTemplate -ImageTemplateName $env.Resources.Template.templateName12 -ResourceGroupName $env.ResourceGroup -Source $srcPlatform -Distribute $disVhd -Location $env.Location 
    ...
    It 'platformimg-sharedimg' {
        #region OS:Linux
        $srcPlatform = New-AzImageBuilderSource -SourceTypePlatformImage -Publisher $env.Source.PlatformImageLinux.publisher -Offer $env.Source.PlatformImageLinux.offer -Sku $env.Source.PlatformImageLinux.sku -Version $env.Source.PlatformImageLinux.version 
        $disSharedImg = New-AzImageBuilderDistributor -SharedImageDistributor -ArtifactTag @{tag='dis-share'} -GalleryImageId "/subscriptions/$($env.SubscriptionId)/resourceGroups/$($env.ResourceGroup)/providers/Microsoft.Compute/galleries/testsharedgallery/images/imagedefinition-linux/versions/1.0.0" -ReplicationRegion $env.RepLocation -RunOutputName $env.Resources.RunOutputName.runOutputName23 -ExcludeFromLatest $false
        ...
        New-AzImageBuilderTemplate -ImageTemplateName $env.Resources.Template.templateName13 -ResourceGroupName $env.ResourceGroup -Source $srcPlatform -Distribute $disSharedImg -Customize $customizer -Location $env.Location 
    ...
    It 'managedimg-managedimg' {
        #region OS:Linux
        $srcManagedImg = New-AzImageBuilderSource -SourceTypeManagedImage -ImageId $env.Source.ManagedImageLinux.imageId
        ...
        New-AzImageBuilderTemplate -ImageTemplateName $env.Resources.Template.templateName14 -ResourceGroupName $env.ResourceGroup -Source $srcManagedImg -Distribute $disManagedImg -Customize $customizer -Location $env.Location 
    ...
    It 'managedimg-vhd' {
        #region OS:Linux
        $srcManagedImg = New-AzImageBuilderSource -SourceTypeManagedImage -ImageId $env.Source.ManagedImageLinux.imageId
        $disVhd = New-AzImageBuilderDistributor -VhdDistributor -ArtifactTag @{tag='VHD'} -RunOutputName $env.Resources.RunOutputName.runOutputName25
        $customizerName = 'downloadBuildArtifacts'
        $sha256Checksum = 'ade4c5214c3c675e92c66e2d067a870c5b81b9844b3de3cc72c49ff36425fc93'
        $sourceUri = 'https://raw.githubusercontent.com/danielsollondon/azvmimagebuilder/master/quickquickstarts/customizeScript2.sh'
        $customizer = New-AzImageBuilderCustomizer -ShellCustomizer -CustomizerName $customizerName -ScriptUri $sourceUri -Sha256Checksum  $sha256Checksum
        ...
        New-AzImageBuilderTemplate -ImageTemplateName $env.Resources.Template.templateName15 -ResourceGroupName $env.ResourceGroup -Source $srcManagedImg -Distribute $disVhd -Customize $customizer -Location $env.Location 
    ...
    It 'managedimg-sharedimg' {
        ...
        New-AzImageBuilderTemplate -ImageTemplateName $env.Resources.Template.templateName16 -ResourceGroupName $env.ResourceGroup -Source $srcManagedImg -Distribute $disSharedImg -Customize $customizer -Location $env.Location 
    ...
    It 'sharedimg-managedimg' {
        #region OS:Linux
        $srcSharedImg = New-AzImageBuilderSource -SourceTypeSharedImageVersion -ImageVersionId $env.Source.SharedImageLinux.imageVersionId
        ...
        New-AzImageBuilderTemplate -ImageTemplateName $env.Resources.Template.templateName17 -ResourceGroupName $env.ResourceGroup -Source $srcSharedImg -Distribute $disManagedImg -Customize $customizer -Location $env.Location 
    ...
    It 'sharedimg-vhd' {
        #region OS:Linux
        $srcSharedImg = New-AzImageBuilderSource -SourceTypeSharedImageVersion -ImageVersionId $env.Source.SharedImageLinux.imageVersionId
        $disVhd = New-AzImageBuilderDistributor -VhdDistributor -ArtifactTag @{tag='VHD'} -RunOutputName $env.Resources.RunOutputName.runOutputName28
        $customizerName = 'downloadBuildArtifacts'
        $sha256Checksum = 'ade4c5214c3c675e92c66e2d067a870c5b81b9844b3de3cc72c49ff36425fc93'
        $sourceUri = 'https://raw.githubusercontent.com/danielsollondon/azvmimagebuilder/master/quickquickstarts/customizeScript2.sh'
        $customizer = New-AzImageBuilderCustomizer -ShellCustomizer -CustomizerName $customizerName -ScriptUri $sourceUri -Sha256Checksum  $sha256Checksum
        ...
        New-AzImageBuilderTemplate -ImageTemplateName $env.Resources.Template.templateName18 -ResourceGroupName $env.ResourceGroup -Source $srcSharedImg -Distribute $disVhd -Customize $customizer -Location $env.Location 
    ...
    It 'sharedImage-sharedimg' { 
        ...
        New-AzImageBuilderTemplate -ImageTemplateName $env.Resources.Template.templateName19 -ResourceGroupName $env.ResourceGroup -Source $srcSharedImg -Distribute $disSharedImg -Customize $customizer -Location $env.Location 
