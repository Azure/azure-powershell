...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Cmdlets
{
    ...
    public partial class GetAzImageBuilderTemplate_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzImageBuilderTemplate_Get" /> cmdlet class.
        /// </summary>
        public GetAzImageBuilderTemplate_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VirtualMachineImageTemplatesGet(SubscriptionId, ResourceGroupName, Name, onOk, onDefault, this, Pipeline);
