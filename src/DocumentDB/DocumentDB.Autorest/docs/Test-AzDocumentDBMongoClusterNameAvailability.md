...
### Check
```
Test-AzDocumentDBMongoClusterNameAvailability -Location <String> -Body <ICheckNameAvailabilityRequest>
...
```
Test-AzDocumentDBMongoClusterNameAvailability -Location <String> -JsonFilePath <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaJsonString
```
Test-AzDocumentDBMongoClusterNameAvailability -Location <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
