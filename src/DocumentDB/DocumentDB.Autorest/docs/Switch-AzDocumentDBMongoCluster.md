...
```
Switch-AzDocumentDBMongoCluster -MongoClusterName <String> -ResourceGroupName <String> -PromoteOption <String>
 -SourceCluster <String> [-SubscriptionId <String>] [-Mode <String>] [-DefaultProfile <PSObject>] [-AsJob]
