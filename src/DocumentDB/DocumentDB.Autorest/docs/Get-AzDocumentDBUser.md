...
### GetViaIdentity
```
Get-AzDocumentDBUser -InputObject <IDocumentDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityMongoCluster
```
Get-AzDocumentDBUser -MongoClusterInputObject <IDocumentDbIdentity> -Name <String>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
