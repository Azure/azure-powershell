...
```
Restore-AzDocumentDBMongoCluster -Name <String> -ResourceGroupName <String>
 -AdministratorPassword <SecureString> -AdministratorUserName <String> -Location <String>
 -RestoreTime <DateTime> -SourceCluster <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>]
