...
```
New-AzDocumentDBFirewallRule -MongoClusterName <String> -Name <String> -ResourceGroupName <String>
...
```
New-AzDocumentDBFirewallRule -MongoClusterInputObject <IDocumentDbIdentity> -Name <String>
