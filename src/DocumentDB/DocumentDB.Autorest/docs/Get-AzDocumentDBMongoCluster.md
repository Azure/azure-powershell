...
online version: https://learn.microsoft.com/powershell/module/az.documentdb/get-azdocumentdbmongocluster
schema: 2.0.0
---
...
### List1 (Default)
```
Get-AzDocumentDBMongoCluster [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzDocumentDBMongoCluster -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDocumentDBMongoCluster -InputObject <IDocumentDbIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### List
```
Get-AzDocumentDBMongoCluster -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
