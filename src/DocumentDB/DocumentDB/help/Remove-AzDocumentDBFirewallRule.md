...
online version: https://learn.microsoft.com/powershell/module/az.documentdb/remove-azdocumentdbfirewallrule
schema: 2.0.0
---

# Remove-AzDocumentDBFirewallRule
...
### Delete (Default)
```
Remove-AzDocumentDBFirewallRule -MongoClusterName <String> -Name <String> -ResourceGroupName <String>
...
```
Remove-AzDocumentDBFirewallRule -Name <String> -MongoClusterInputObject <IDocumentDbIdentity>
...
### DeleteViaIdentity
```
Remove-AzDocumentDBFirewallRule -InputObject <IDocumentDbIdentity> [-DefaultProfile <PSObject>] [-AsJob]
