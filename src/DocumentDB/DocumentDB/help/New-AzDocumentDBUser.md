...
```
New-AzDocumentDBUser -Name <String> -MongoClusterName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -Type <String> [-Role <Hashtable[]>] [-DefaultProfile <PSObject>] [-AsJob]
