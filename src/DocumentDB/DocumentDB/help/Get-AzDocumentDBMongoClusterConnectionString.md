...
online version: https://learn.microsoft.com/powershell/module/az.documentdb/get-azdocumentdbmongoclusterconnectionstring
schema: 2.0.0
---

# Get-AzDocumentDBMongoClusterConnectionString
...
```
Get-AzDocumentDBMongoClusterConnectionString -MongoClusterName <String> -ResourceGroupName <String>
...
### Microsoft.Azure.PowerShell.Cmdlets.DocumentDB.Models.IListConnectionStringsResult
