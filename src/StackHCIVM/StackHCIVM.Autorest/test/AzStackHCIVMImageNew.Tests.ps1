...
Describe 'AzStackHCIVMImageNew' {
    It 'Create MarketplaceImage  '  {
        ...
        $image = Get-AzStackHCIVMImage -ResourceId "/subscriptions/37908b1f-2848-4c85-b8bf-a2cab2c3b0ba/resourceGroups/vpclus0724-rg/providers/Microsoft.AzureStackHCI/marketplaceGalleryImages/testMkpImage02264" -debug
    ...
    It 'Get'  {
        {
            $config = Get-AzStackHCIVMImage -Name  $env.mkpImageName -ResourceGroupName $env.newResourceGroupName -SubscriptionId $env.newSubscriptionId
