...
$dll = Join-Path $PSScriptRoot 'bin\Az.StackHCIVM.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.StackHCIVM.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.StackHCIVM.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: StackHcivm cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.StackHCIVM.format.ps1xml'
