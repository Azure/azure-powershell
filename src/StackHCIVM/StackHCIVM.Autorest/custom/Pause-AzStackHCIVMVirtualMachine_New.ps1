...
.Link
https://learn.microsoft.com/powershell/module/az.stackhcivm/pause-azstackhcivmvirtualmachine
#>
function Pause-AzStackHCIVMVirtualMachine {
    ...
    if (($ResourceId -match $vmRegex) -or ($Name -and $ResourceGroupName -and $SubscriptionId)){
        ...
        try{
            Az.StackHCIVM.internal\Pause-AzStackHCIVMVirtualMachine -ErrorAction Stop @PSBoundParameters 
        } catch {
            $e = $_
