...
```
Update-AzStackHCIVMStoragePath [-ResourceId <String>] [-Tag <Hashtable>] [-NoWait] [<CommonParameters>]
```
...
```
Update-AzStackHCIVMStoragePath -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### UpdateViaJsonString
```
Update-AzStackHCIVMStoragePath -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
