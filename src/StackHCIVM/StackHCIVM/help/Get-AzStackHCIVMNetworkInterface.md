...
### List1 (Default)
```
Get-AzStackHCIVMNetworkInterface [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Break]
...
### ByResourceId
```
Get-AzStackHCIVMNetworkInterface [-ResourceId <String>] [-DefaultProfile <PSObject>] [-Break]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <Uri>]
