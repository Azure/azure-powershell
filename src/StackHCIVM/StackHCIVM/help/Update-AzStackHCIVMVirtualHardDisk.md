...
```
Update-AzStackHCIVMVirtualHardDisk [-ResourceId <String>] [-Tag <Hashtable>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.stackhcivm/update-azstackhcivmvirtualharddisk](https://learn.microsoft.com/powershell/module/az.stackhcivm/update-azstackhcivmvirtualharddisk)
