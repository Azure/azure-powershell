...
```
Update-AzStackHCIVMImage [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
...
Update-AzStackHCIVMImage -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>]
...
### ByResourceId
```
Update-AzStackHCIVMImage [-SubscriptionId <String>] -ResourceId <String> [-Tag <Hashtable>] [-Break]
