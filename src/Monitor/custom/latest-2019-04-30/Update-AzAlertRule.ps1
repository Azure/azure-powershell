...
param(
    ...
    [Parameter(Mandatory, HelpMessage = "The aggregation operation used to roll up multiple metric values across the window interval.")]
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Info(SerializedName='tags', PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20160301.IAlertRuleResourcePatchTags]), Description='Resource tags')]
...
process {
    ...
    if ($PSBoundParameters.ContainsKey("Threshold")) {
        $PSBoundParameters["Condition"] = [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20160301.ThresholdRuleCondition]@{
                                                ...
                                                TimeAggregation=$PSBoundParameters["TimeAggregationOperator"]
