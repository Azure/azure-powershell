...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Info(SerializedName='days', Required, PossibleTypes=([System.Int32]), Description='the number of days for the retention in days. A value of 0 will retain the events indefinitely.')]
    [System.Int32]
