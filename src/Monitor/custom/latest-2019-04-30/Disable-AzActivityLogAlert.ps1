...
[Microsoft.Azure.PowerShell.Cmdlets.Monitor.Description('Disable an existing ActivityLogAlert')]
param(
    [Parameter(ParameterSetName='Disable', Mandatory, HelpMessage='The name of the activity log alert.')]
    ...
    [Parameter(ParameterSetName='Disable', Mandatory, HelpMessage='The name of the resource group.')]
    [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Category('Path')]
    ...
    [Parameter(ParameterSetName='Disable', Mandatory, HelpMessage='The Azure subscription Id.')]
    [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Category('Path')]
    ...
    [Parameter(ParameterSetName='DisableViaIdentity', Mandatory, ValueFromPipeline, HelpMessage='Identity Parameter')]
    [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Category('Path')]
...
process {
    $PSBoundParameters.Add('Enabled', $false)
