...
Creates or updates an log search rule.
.Example
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azscheduledqueryrule
.Outputs
...
param(
    ...
    [Parameter(Mandatory, HelpMessage='Specifies the action. Supported values - AlertingAction, LogToMetricAction')]
    [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Info(SerializedName='odata.type', Required, PossibleTypes=([System.String]), Description='Specifies the action. Supported values - AlertingAction, LogToMetricAction')]
    [System.String]
