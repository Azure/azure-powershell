...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.Cmdlets
{
    public static class LogFilterHelper
    {
        ...
        private static string AddFilterConditionIfExists(Dictionary<string, object> parameters, string query, string parameter, string filterParameter = "")
        {
            if (String.IsNullOrEmpty(filterParameter)) filterParameter = parameter;
