...
$dll = Join-Path $PSScriptRoot 'bin\Az.PipelineGroup.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.PipelineGroup.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.PipelineGroup.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.PipelineGroup'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: PipelineGroup cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.PipelineGroup.format.ps1xml'
