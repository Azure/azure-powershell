...
Get-AzMetricsBatch -Endpoint $endpoint -Name 'ingress','egress' -Namespace "Microsoft.Storage/storageAccounts" -EndTime $end -StartTime $start -ResourceId /subscriptions/{subid}/resourcegroups/{group}/providers/Microsoft.Storage/storageAccounts/{account}
```
...
Resourceid     : /subscriptions/{subid}/resourcegroups/{group}/providers/Microsoft.Storage/storageAccounts/{account}
