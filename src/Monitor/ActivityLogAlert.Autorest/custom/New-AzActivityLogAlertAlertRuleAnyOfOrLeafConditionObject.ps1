...
function New-AzActivityLogAlertAlertRuleAnyOfOrLeafConditionObject {
    ...
    Param(
        [Microsoft.Azure.PowerShell.Cmdlets.Monitor.ActivityLogAlert.Runtime.ParameterBreakingChange("AnyOf", "15.0.0", "7.0.0", "2025/11/03", OldParameterType="Array", NewParameterType="List")]
        ...
        $AnyOf,
        [Microsoft.Azure.PowerShell.Cmdlets.Monitor.ActivityLogAlert.Runtime.ParameterBreakingChange("ContainsAny", "15.0.0", "7.0.0", "2025/11/03", OldParameterType="Array", NewParameterType="List")]
