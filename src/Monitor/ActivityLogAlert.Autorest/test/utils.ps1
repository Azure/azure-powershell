...
function setupEnv() {
    ...
    $env.Add("actionGroupResourceId", "/subscriptions/$($env['SubscriptionId'])/resourceGroups/$($env['resourceGroupName'])/providers/microsoft.insights/actionGroups/$($env['actionGroupName'])")
