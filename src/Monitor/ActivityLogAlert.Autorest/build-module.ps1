...
$dll = Join-Path $PSScriptRoot 'bin\Az.ActivityLogAlert.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.ActivityLogAlert.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.ActivityLogAlert.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: ActivityLogAlert cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.ActivityLogAlert.format.ps1xml'
