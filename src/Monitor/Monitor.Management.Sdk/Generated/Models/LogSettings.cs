...
namespace Microsoft.Azure.Management.Monitor.Models
{
    ...
    public partial class LogSettings
    {
        ...
        /// <param name="category">Name of a Diagnostic Log category for a resource type this setting is
        /// applied to. To obtain the list of Diagnostic Log categories for a resource,
        /// first perform a GET diagnostic settings operation.
        /// </param>

        /// <param name="enabled">a value indicating whether this log is enabled.
        /// </param>

        /// <param name="retentionPolicy">the retention policy for this log.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets name of a Diagnostic Log category for a resource type this
        /// setting is applied to. To obtain the list of Diagnostic Log categories for
