...
namespace Microsoft.Azure.Management.Monitor.Models
{
    ...
    public partial class EmailNotification
    {
        ...
        /// <param name="sendToSubscriptionAdministrator">a value indicating whether to send email to subscription administrator.
        /// </param>

        /// <param name="sendToSubscriptionCoAdministrators">a value indicating whether to send email to subscription co-administrators.
        /// </param>

        /// <param name="customEmails">the custom e-mails list. This value can be null or empty, in which case
        ...
        /// <summary>
        /// Gets or sets the custom e-mails list. This value can be null or empty, in
