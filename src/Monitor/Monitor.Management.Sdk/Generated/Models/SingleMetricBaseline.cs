...
namespace Microsoft.Azure.Management.Monitor.Models
{
    ...
    public partial class SingleMetricBaseline
    {
        ...
        /// <param name="id">The metric baseline Id.
        /// </param>

        /// <param name="type">The resource type of the metric baseline resource.
        /// </param>

        /// <param name="name">The name of the metric for which the baselines were retrieved.
        /// </param>
        ...
        /// </param>
        public SingleMetricBaseline(string id, string type, string name, string timespan, System.TimeSpan interval, System.Collections.Generic.IList<TimeSeriesBaseline> baselines, string namespaceProperty = default(string))
