...
namespace Microsoft.Azure.Management.Monitor.Models
{
    ...
    public partial class MetricValue
    {
        ...
        /// <param name="timeStamp">the timestamp for the metric value in ISO 8601 format.
        /// </param>

        /// <param name="average">the average value in the time range.
        /// </param>

        /// <param name="minimum">the least value in the time range.
        /// </param>

        /// <param name="maximum">the greatest value in the time range.
        /// </param>

        /// <param name="total">the sum of all of the values in the time range.
        /// </param>

        /// <param name="count">the number of samples in the time range. Can be used to determine the
        ...
        /// <summary>
        /// Gets or sets the number of samples in the time range. Can be used to
