...
namespace Microsoft.Azure.Management.Monitor.Models
{
    ...
    public partial class MetricAlertStatusProperties
    {
        ...
        /// <param name="dimensions">An object describing the type of the dimensions.
        /// </param>

        /// <param name="status">status value
        /// </param>

        /// <param name="timestamp">UTC time when the status was checked.
        /// </param>
        public MetricAlertStatusProperties(System.Collections.Generic.IDictionary<string, string> dimensions = default(System.Collections.Generic.IDictionary<string, string>), string status = default(string), System.DateTime? timestamp = default(System.DateTime?))
