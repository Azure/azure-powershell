...
namespace Microsoft.Azure.Management.Monitor.Models
{
    ...
    public partial class AutoscaleProfile
    {
        ...
        /// <param name="name">the name of the profile.
        /// </param>

        /// <param name="capacity">the number of instances that can be used during this profile.
        /// </param>

        /// <param name="rules">the collection of rules that provide the triggers and parameters for the
        /// scaling action. A maximum of 10 rules can be specified.
        /// </param>

        /// <param name="fixedDate">the specific date-time for the profile. This element is not used if the
        /// Recurrence element is used.
        /// </param>

        /// <param name="recurrence">the repeating times at which this profile begins. This element is not used
        ...
        /// <summary>
        /// Gets or sets the specific date-time for the profile. This element is not
        ...
        /// <summary>
        /// Gets or sets the repeating times at which this profile begins. This element
