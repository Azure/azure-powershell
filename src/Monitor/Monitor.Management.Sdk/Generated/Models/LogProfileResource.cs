...
namespace Microsoft.Azure.Management.Monitor.Models
{
    ...
    public partial class LogProfileResource : Resource
    {
        ...
        /// </param>
        public LogProfileResource(string location, RetentionPolicy retentionPolicy, System.Collections.Generic.IList<string> locations, System.Collections.Generic.IList<string> categories, string id = default(string), string name = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string storageAccountId = default(string), string serviceBusRuleId = default(string))
