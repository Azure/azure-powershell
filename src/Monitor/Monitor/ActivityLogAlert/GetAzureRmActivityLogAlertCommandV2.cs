...
namespace Microsoft.Azure.Commands.Insights.ActivityLogAlert
{
    ...
    /// </summary>
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "ActivityLogAlertV2"), OutputType(typeof(ActivityLogAlertResource))]
    public class GetAzureRmActivityLogAlertCommandV2 : ManagementCmdletBase
    {
        ...
        {
            List<IActivityLogAlertResource> output = null;
