...
namespace Microsoft.Azure.Management.Monitor.Management.Models
{
    ...
    /// It is identical to the RuleMetricDataSource, but in the old namespace
    /// </summary>
    public class RuleMetricDataSource : RuleDataSource
    {
        /// <summary>
        ...
        public RuleMetricDataSource(Monitor.Models.RuleMetricDataSource ruleMetricDataSource)
            : base(ruleDataSource: ruleMetricDataSource)
        {
            this.MetricName = ruleMetricDataSource?.MetricName;
        }
    }
}
