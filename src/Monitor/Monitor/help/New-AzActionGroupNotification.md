...
```
New-AzActionGroupNotification -ActionGroupName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -AlertType <String> [-ArmRoleReceiver <IArmRoleReceiver[]>]
 ...
 [-WebhookReceiver <IWebhookReceiver[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
