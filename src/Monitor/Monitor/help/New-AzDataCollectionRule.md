...
Create a data collection rule. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzDataCollectionRule -Description 'Pura Vida' -Location 'East US 2 EUAP' -ResourceGroupName 'testdcr' -RuleFile <String> -RuleName 'dcrFromPipe95'
```
