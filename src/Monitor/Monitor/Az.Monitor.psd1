...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added parameter ''ResourceGroupName'' back for ''Add-AzAutoscaleSetting'' parameter set ''AddAzureRmAutoscaleSettingUpdateParamGroup'' and made it optional [#15491]'
