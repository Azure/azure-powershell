...
FunctionsToExport = 'Get-AzActivityLogAlert', 'New-AzActionGroupObject', 
               'New-AzActivityLogAlert', 
               'New-AzAlertRuleAnyOfOrLeafConditionObject', 
               'New-AzAlertRuleLeafConditionObject', 'Remove-AzActivityLogAlert', 
               'Update-AzActivityLogAlert', 'Get-AzDiagnosticSetting', 
               'Get-AzDiagnosticSettingCategory', 'Get-AzEventCategory', 
               'Get-AzSubscriptionDiagnosticSetting', 'New-AzDiagnosticSetting', 
               'New-AzLogSettingsObject', 'New-AzMetricSettingsObject', 
               'New-AzSubscriptionDiagnosticSetting', 
               'New-AzSubscriptionLogSettingsObject', 'Remove-AzDiagnosticSetting', 
