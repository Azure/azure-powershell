...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* ''-Location'' parameter was removed from ''Update-AzActionGroup'' and ''Update-AzDataCollectionRule'' because they do not support updating the location.
