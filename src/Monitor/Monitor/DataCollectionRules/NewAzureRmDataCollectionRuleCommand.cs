...
namespace Microsoft.Azure.Commands.Insights.DataCollectionRules
{
    ...
    /// </summary>
    [WindowsAzure.Commands.Common.CustomAttributes.GenericBreakingChangeWithVersion("Parameter RuleFile will be replaced by JsonFilePath. Cmdlet will be available for setting all values using parameters.", "11.0.0", "5.0.0", "2023/11/15")]
