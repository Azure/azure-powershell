...
- `build-module.ps1`
  - Builds the module DLL (`./bin/Az.Monitor.private.dll`), creates the exported cmdlets, generates custom cmdlet test stubs, and updates `./Az.Monitor.psd1` with Azure profile information.
