...
online version: https://docs.microsoft.com/powershell/module/az.monitor/set-azlogprofile
schema: 2.0.0
---
...
```
Set-AzLogProfile -Name <String> -Category <String[]> -Location <String> -PropertiesLocations <String[]>
