...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataCollectionRule.Models
{
    ...
    public partial class SyslogDataSource :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataCollectionRule.Models.ISyslogDataSourceInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataCollectionRule.Runtime.IJsonSerializable
    {
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataCollectionRule.PSArgumentCompleterAttribute("auth", "authpriv", "cron", "daemon", "kern", "lpr", "mail", "mark", "news", "syslog", "user", "uucp", "local0", "local1", "local2", "local3", "local4", "local5", "local6", "local7", "*")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataCollectionRule.PSArgumentCompleterAttribute("Debug", "Info", "Notice", "Warning", "Error", "Critical", "Alert", "Emergency", "*")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataCollectionRule.PSArgumentCompleterAttribute("Microsoft-Syslog")]
