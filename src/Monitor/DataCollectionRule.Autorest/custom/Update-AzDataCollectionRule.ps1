  ...
  process {
    if ($PSBoundParameters.ContainsKey('EnableSystemAssignedIdentity') -or $PSBoundParameters.ContainsKey('UserAssignedIdentity') ) {
      ...
      if (('UpdateExpanded') -contains $parameterSet) {
        $organization = Az.DataCollectionRule.exports\Get-AzDataCollectionRule -Name $Name -ResourceGroupName $ResourceGroupName
      }
      elseif (('UpdateViaIdentityExpanded') -contains $parameterSet) {
        $organization = Az.DataCollectionRule.exports\Get-AzDataCollectionRule -InputObject $InputObject
      }
    ...
    Az.DataCollectionRule.internal\Update-AzDataCollectionRule @PSBoundParameters
  }
}
