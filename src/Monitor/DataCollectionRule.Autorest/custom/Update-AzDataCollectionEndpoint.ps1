    ...
    process {
        if ($PSBoundParameters.ContainsKey('EnableSystemAssignedIdentity') -or $PSBoundParameters.ContainsKey('UserAssignedIdentity') ) {
            ...
            if (('UpdateExpanded') -contains $parameterSet) {
                $organization = Az.DataCollectionRule.exports\Get-AzDataCollectionEndpoint -Name $Name -ResourceGroupName $ResourceGroupName
            }
            elseif (('UpdateViaIdentityExpanded') -contains $parameterSet) {
                $organization = Az.DataCollectionRule.exports\Get-AzDataCollectionEndpoint -InputObject $InputObject
            }
        ...
        Az.DataCollectionRule.internal\Update-AzDataCollectionEndpoint @PSBoundParameters
    }
}
