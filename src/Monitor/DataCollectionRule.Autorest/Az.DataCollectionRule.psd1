@{
  ...
  FunctionsToExport = 'Get-AzDataCollectionEndpoint', 'Get-AzDataCollectionRule', 'Get-AzDataCollectionRuleAssociation', 'New-AzDataCollectionEndpoint', 'New-AzDataCollectionRule', 'New-AzDataCollectionRuleAssociation', 'Remove-AzDataCollectionEndpoint', 'Remove-AzDataCollectionRule', 'Remove-AzDataCollectionRuleAssociation', 'Update-AzDataCollectionEndpoint', 'Update-AzDataCollectionRule', 'Update-AzDataCollectionRuleAssociation'
  PrivateData = @{
    PSData = @{
