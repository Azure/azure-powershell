if(($null -eq $TestName) -or ($TestName -contains 'New-AzWindowsFirewallLogsDataSourceObject'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-AzWindowsFirewallLogsDataSourceObject.Recording.json'
