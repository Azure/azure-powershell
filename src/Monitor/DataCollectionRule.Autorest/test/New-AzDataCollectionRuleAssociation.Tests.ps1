if(($null -eq $TestName) -or ($TestName -contains 'New-AzDataCollectionRuleAssociation'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-AzDataCollectionRuleAssociation.Recording.json'
