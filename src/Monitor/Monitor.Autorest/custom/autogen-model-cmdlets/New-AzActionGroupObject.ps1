...
function New-AzActionGroupObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20201001.ActionGroup')]
    ...
    Param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20201001.IActionGroupWebhookProperties]
        $WebhookProperty
    )

    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20201001.ActionGroup]::New()
