...
function New-AzAlertRuleAnyOfOrLeafConditionObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20201001.AlertRuleAnyOfOrLeafCondition')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20201001.AlertRuleAnyOfOrLeafCondition]::New()
