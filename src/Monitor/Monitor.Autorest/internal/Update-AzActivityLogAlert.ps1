...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.Monitor.private\Update-AzActivityLogAlert_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.Monitor.private\Update-AzActivityLogAlert_UpdateViaIdentityExpanded';
        }
