...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Monitor.private\Get-AzActivityLogAlert_Get';
            GetViaIdentity = 'Az.Monitor.private\Get-AzActivityLogAlert_GetViaIdentity';
            List = 'Az.Monitor.private\Get-AzActivityLogAlert_List';
            List1 = 'Az.Monitor.private\Get-AzActivityLogAlert_List1';
        }
...
begin {
    try {
        ...
        $mapping = @{
            __AllParameterSets = 'Az.Monitor.custom\New-AzActionGroupObject';
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
...
begin {
    try {
        ...
        $mapping = @{
            __AllParameterSets = 'Az.Monitor.custom\New-AzAlertRuleLeafConditionObject';
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.Monitor.custom\Update-AzActivityLogAlert';
            UpdateViaIdentityExpanded = 'Az.Monitor.custom\Update-AzActivityLogAlert';
        }
