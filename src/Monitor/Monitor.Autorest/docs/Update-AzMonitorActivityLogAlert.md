...
online version: https://docs.microsoft.com/powershell/module/az.monitor/update-azmonitoractivitylogalert
schema: 2.0.0
---

# Update-AzMonitorActivityLogAlert
...
```
Update-AzMonitorActivityLogAlert -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Enabled] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzMonitorActivityLogAlert -InputObject <IMonitorIdentity> [-Enabled] [-Tag <Hashtable>]
