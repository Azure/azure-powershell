...
online version: https://docs.microsoft.com/powershell/module/az.monitor/set-azmonitoractivitylogalert
schema: 2.0.0
---

# Set-AzMonitorActivityLogAlert
...
```
Set-AzMonitorActivityLogAlert -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
