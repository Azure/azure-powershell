...
online version: https://docs.microsoft.com/powershell/module/az.monitor/new-azmonitoractivitylogalert
schema: 2.0.0
---

# New-AzMonitorActivityLogAlert
...
```
New-AzMonitorActivityLogAlert -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-ActionGroup <IActionGroup[]>] [-ConditionAllOf <IAlertRuleAnyOfOrLeafCondition[]>] [-Description <String>]
 [-Enabled] [-Location <String>] [-Scope <String[]>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
