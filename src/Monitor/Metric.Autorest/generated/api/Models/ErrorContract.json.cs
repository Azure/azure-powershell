...
namespace Microsoft.Azure.PowerShell.Cmdlets.Metric.Models
{
    ...
    public partial class ErrorContract
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonObject into a new instance of <see cref="ErrorContract" />.
        /// </summary>
        ...
        internal ErrorContract(Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonObject json)
        {
            ...
            {_error = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonObject>("error"), out var __jsonError) ? Microsoft.Azure.PowerShell.Cmdlets.Metric.Models.ErrorResponse.FromJson(__jsonError) : _error;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Metric.Models.IErrorContract.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Metric.Models.IErrorContract.</returns>
        ...
        /// <summary>
        /// Serializes this instance of <see cref="ErrorContract" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ErrorContract" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNode" />.
        /// </returns>
