...
function New-AzActionGroupArmRoleReceiverObject {
    ...
    Param(
        ...
        [Parameter(Mandatory, HelpMessage="The name of the arm role receiver. Names must be unique across all receivers within an action group.")]
        [string]
        $Name,
        [Parameter(Mandatory, HelpMessage="The arm role id.")]
        [string]
        $RoleId,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Monitor.ActionGroup.Models.ArmRoleReceiver]::New()
