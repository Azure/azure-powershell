...
function New-AzActionGroupVoiceReceiverObject {
    ...
    Param(
        ...
        [Parameter(Mandatory, HelpMessage="The country code of the voice receiver.")]
        [string]
        $CountryCode,
        [Parameter(Mandatory, HelpMessage="The name of the voice receiver. Names must be unique across all receivers within an action group.")]
        [string]
        $Name,
        [Parameter(Mandatory, HelpMessage="The phone number of the voice receiver.")]
        [string]
        $PhoneNumber
    )

    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Monitor.ActionGroup.Models.VoiceReceiver]::New()
