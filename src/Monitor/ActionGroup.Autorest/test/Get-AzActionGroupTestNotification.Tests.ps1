if(($null -eq $TestName) -or ($TestName -contains 'Get-AzActionGroupTestNotification'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Get-AzActionGroupTestNotification.Recording.json'
