...
```
New-AzADB2CTenant -Name <String> -ResourceGroupName <String> -CountryCode <String> -DisplayName <String>
 -Location <String> -Sku <B2CResourceSkuname> [-SubscriptionId <String>] [-Tag <Hashtable>]
