...
online version: https://docs.microsoft.com/en-us/powershell/module/az.activedirectoryb2c/remove-azadb2cguestusage
schema: 2.0.0
---

# Remove-AzADB2CGuestUsage
...
### Delete (Default)
```
Remove-AzADB2CGuestUsage -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzADB2CGuestUsage -InputObject <IActiveDirectoryB2CIdentity> [-DefaultProfile <PSObject>] [-PassThru]
