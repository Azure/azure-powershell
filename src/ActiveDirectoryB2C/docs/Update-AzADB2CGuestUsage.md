...
online version: https://docs.microsoft.com/en-us/powershell/module/az.activedirectoryb2c/update-azadb2cguestusage
schema: 2.0.0
---

# Update-AzADB2CGuestUsage
...
```
Update-AzADB2CGuestUsage -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzADB2CGuestUsage -InputObject <IActiveDirectoryB2CIdentity> [-Tag <Hashtable>]
...
INPUTOBJECT <IActiveDirectoryB2CIdentity>: Identity Parameter
  ...
  - `[ResourceName <String>]`: The initial domain name of the AAD tenant.
