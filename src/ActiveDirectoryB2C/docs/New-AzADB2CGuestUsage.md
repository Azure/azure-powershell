...
online version: https://docs.microsoft.com/en-us/powershell/module/az.activedirectoryb2c/new-azadb2cguestusage
schema: 2.0.0
---

# New-AzADB2CGuestUsage
...
```
New-AzADB2CGuestUsage -ResourceGroupName <String> -ResourceName <String> -Location <String> -TenantId <String>
