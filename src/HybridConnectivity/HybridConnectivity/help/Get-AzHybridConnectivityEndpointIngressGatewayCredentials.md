...
Get-AzHybridConnectivityEndpointIngressGatewayCredentials -EndpointName <String> -ResourceUri <String>
 [-Expiresin <Int64>] [-ServiceName <String>] [-DefaultProfile <PSObject>] [-ProgressAction <ActionPreference>]
...
```
Get-AzHybridConnectivityEndpointIngressGatewayCredentials -EndpointName <String> -ResourceUri <String>
 [-Expiresin <Int64>] -ListIngressGatewayCredentialsRequest <IListIngressGatewayCredentialsRequest>
...
```
Get-AzHybridConnectivityEndpointIngressGatewayCredentials -EndpointName <String> -ResourceUri <String>
 [-Expiresin <Int64>] -JsonFilePath <String> [-DefaultProfile <PSObject>] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
Get-AzHybridConnectivityEndpointIngressGatewayCredentials -EndpointName <String> -ResourceUri <String>
 [-Expiresin <Int64>] -JsonString <String> [-DefaultProfile <PSObject>] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
