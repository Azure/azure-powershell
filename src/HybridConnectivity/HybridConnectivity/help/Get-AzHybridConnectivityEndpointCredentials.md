...
Get-AzHybridConnectivityEndpointCredentials -EndpointName <String> -ResourceUri <String> [-Expiresin <Int64>]
 [-ServiceName <String>] [-DefaultProfile <PSObject>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Get-AzHybridConnectivityEndpointCredentials -EndpointName <String> -ResourceUri <String> [-Expiresin <Int64>]
 -ListCredentialsRequest <IListCredentialsRequest> [-DefaultProfile <PSObject>]
