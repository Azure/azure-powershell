...
online version: https://learn.microsoft.com/powershell/module/az.hybridconnectivity/get-azhybridconnectivitysolutionconfiguration
schema: 2.0.0
---
...
### List (Default)
```
Get-AzHybridConnectivitySolutionConfiguration -ResourceUri <String> [-DefaultProfile <PSObject>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Get
```
Get-AzHybridConnectivitySolutionConfiguration -ResourceUri <String> -SolutionConfiguration <String>
 [-DefaultProfile <PSObject>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzHybridConnectivitySolutionConfiguration -InputObject <IHybridConnectivityIdentity>
 [-DefaultProfile <PSObject>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
