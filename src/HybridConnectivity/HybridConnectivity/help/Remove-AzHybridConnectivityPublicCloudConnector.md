...
online version: https://learn.microsoft.com/powershell/module/az.hybridconnectivity/remove-azhybridconnectivitypubliccloudconnector
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzHybridConnectivityPublicCloudConnector -PublicCloudConnector <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzHybridConnectivityPublicCloudConnector -InputObject <IHybridConnectivityIdentity>
