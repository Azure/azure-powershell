...
online version: https://learn.microsoft.com/powershell/module/az.hybridconnectivity/remove-azhybridconnectivitysolutionconfiguration
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzHybridConnectivitySolutionConfiguration -ResourceUri <String> -SolutionConfiguration <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzHybridConnectivitySolutionConfiguration -InputObject <IHybridConnectivityIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
