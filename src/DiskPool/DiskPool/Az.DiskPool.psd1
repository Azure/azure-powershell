...
RequiredAssemblies = 'DiskPool.Autorest/bin/Az.DiskPool.private.dll'
...
FormatsToProcess = 'DiskPool.Autorest\Az.DiskPool.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('DiskPool.Autorest/Az.DiskPool.psm1')
