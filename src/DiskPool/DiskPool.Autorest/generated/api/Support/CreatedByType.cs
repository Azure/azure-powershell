...
namespace Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Support.CreatedByType Application = @"Application";

        public static Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Support.CreatedByType Key = @"Key";

        public static Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Support.CreatedByType ManagedIdentity = @"ManagedIdentity";

        public static Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Support.CreatedByType User = @"User";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Support.CreatedByType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Support.CreatedByType e)
        {
            return e._value;
        }
