...
New-AzOperationalInsightsWorkspace -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-DefaultDataCollectionRuleResourceId <String>] [-ETag <String>]
 [-Feature <IWorkspaceFeatures>] [-ForceCmkForQuery] [-ProvisioningState <WorkspaceEntityStatus>]
