...
{
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "OperationalInsightsDataSource", DefaultParameterSetName = ByWorkspaceNameByKind), OutputType(typeof(PSDataSource))]
