...
```
New-AzOperationalInsightsWorkspace [-Name] <String> [-ResourceGroupName] <String> [-SubscriptionId <String>]
 [-Location] <String> [-DailyQuotaGb <Double>] [-DefaultDataCollectionRuleResourceId <String>] [-ETag <String>]
 [-Feature <IWorkspaceFeatures>] [-ForceCmkForQuery]
