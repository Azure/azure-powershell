...
.Link
https://docs.microsoft.com/powershell/module/az.operationalinsights/move-azoperationalinsightstable
#>
function Move-AzOperationalInsightsTable {
...
begin {
    try {
        ...
        $mapping = @{
            Migrate = 'Az.OperationalInsights.private\Move-AzOperationalInsightsTable_Migrate';
            MigrateViaIdentity = 'Az.OperationalInsights.private\Move-AzOperationalInsightsTable_MigrateViaIdentity';
        }
