...
namespace Microsoft.Azure.Management.OperationalInsights
{
    ...
    public static partial class GatewaysOperationsExtensions
    {
        ...
        {
                ((IGatewaysOperations)operations).DeleteAsync(resourceGroupName, workspaceName, gatewayId).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task DeleteAsync(this IGatewaysOperations operations, string resourceGroupName, string workspaceName, string gatewayId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
