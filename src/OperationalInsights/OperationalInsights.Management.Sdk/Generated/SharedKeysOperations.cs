...
namespace Microsoft.Azure.Management.OperationalInsights
{
    ...
    /// </summary>
    internal partial class SharedKeysOperations : Microsoft.Rest.IServiceOperations<OperationalInsightsManagementClient>, ISharedKeysOperations
    {
        /// <summary>
        /// Initializes a new instance of the SharedKeysOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal SharedKeysOperations (OperationalInsightsManagementClient client)
        {
            if (client == null) 
            {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<SharedKeys>> RegenerateWithHttpMessagesAsync(string resourceGroupName, string workspaceName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/regenerateSharedKey").ToString();
            _url = _url.Replace("{subscriptionId}", System.Uri.EscapeDataString(this.Client.SubscriptionId));
            _url = _url.Replace("{resourceGroupName}", System.Uri.EscapeDataString(resourceGroupName));
            _url = _url.Replace("{workspaceName}", System.Uri.EscapeDataString(workspaceName));
