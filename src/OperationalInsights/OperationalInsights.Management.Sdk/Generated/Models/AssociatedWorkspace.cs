...
namespace Microsoft.Azure.Management.OperationalInsights.Models
{
    ...
    public partial class AssociatedWorkspace
    {
        ...
        /// <param name="workspaceId">The id of the assigned workspace.
        /// </param>

        /// <param name="workspaceName">The name id the assigned workspace.
        /// </param>

        /// <param name="resourceId">The ResourceId id the assigned workspace.
        /// </param>

        /// <param name="associateDate">The time of workspace association.
        /// </param>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "associateDate")]
