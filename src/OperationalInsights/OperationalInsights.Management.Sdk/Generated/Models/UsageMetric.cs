...
namespace Microsoft.Azure.Management.OperationalInsights.Models
{
    ...
    public partial class UsageMetric
    {
        ...
        /// <param name="unit">The units used for the metric.
        /// </param>

        /// <param name="currentValue">The current value of the metric.
        /// </param>

        /// <param name="limit">The quota limit for the metric.
        /// </param>

        /// <param name="nextResetTime">The time that the metric&#39;s value will reset.
        /// </param>

        /// <param name="quotaPeriod">The quota period that determines the length of time between value resets.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets the quota period that determines the length of time between
        /// value resets.
        /// </summary>
