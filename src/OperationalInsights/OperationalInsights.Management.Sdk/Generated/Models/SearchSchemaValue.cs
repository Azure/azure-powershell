...
namespace Microsoft.Azure.Management.OperationalInsights.Models
{
    ...
    public partial class SearchSchemaValue
    {
        ...
        /// <param name="name">The name of the schema.
        /// </param>

        /// <param name="displayName">The display name of the schema.
        /// </param>

        /// <param name="type">The type.
        /// </param>

        /// <param name="indexed">The boolean that indicates the field is searchable as free text.
        /// </param>

        /// <param name="stored">The boolean that indicates whether or not the field is stored.
        /// </param>

        /// <param name="facet">The boolean that indicates whether or not the field is a facet.
        /// </param>

        /// <param name="ownerType">The array of workflows containing the field.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets the boolean that indicates the field is searchable as free
        /// text.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the boolean that indicates whether or not the field is a
        /// facet.
        /// </summary>
