...
namespace Microsoft.Azure.Management.OperationalInsights.Models
{
    ...
    public partial class ResultStatistics
    {
        ...
        /// <param name="progress">Search job completion percentage.
        /// </param>

        /// <param name="ingestedRecords">The number of rows that were returned by the search job.
        /// </param>
        ...
        public virtual void Validate()
        {
            ...
            {
                if (this.Progress % 0.01 != 0)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.MultipleOf, "Progress", 0.01);
                }
            }
        }
    }
