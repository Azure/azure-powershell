...
online version: https://learn.microsoft.com/powershell/module/az.qumulo/remove-azqumulofilesystem
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzQumuloFileSystem -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzQumuloFileSystem -InputObject <IQumuloIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
