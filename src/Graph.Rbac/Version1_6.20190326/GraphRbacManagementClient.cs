...
namespace Microsoft.Azure.Graph.RBAC.Version1_6_20190326
{
    ...
    public partial class GraphRbacManagementClient : ServiceClient<GraphRbacManagementClient>, IGraphRbacManagementClient, IAzureClient
    {
        ...
        /// True: will dispose the provided httpClient on calling GraphRbacManagementClient.Dispose(). False: will not dispose provided httpClient</param>
        protected GraphRbacManagementClient(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public GraphRbacManagementClient(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
