...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purview.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListBySubscription=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Purview/accounts"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPurviewAccount_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Purview.Description(@"List accounts in Subscription")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Purview.Generated]
    public partial class GetAzPurviewAccount_List1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.IAccountList"
        /// /> from the remote call</param>
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzPurviewAccount_List1" /> cmdlet class.
        /// </summary>
        public GetAzPurviewAccount_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AccountsListBySubscription(SubscriptionId, this.InvocationInformation.BoundParameters.ContainsKey("SkipToken") ? SkipToken : null, onOk, onDefault, this, Pipeline);
        ...
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.IAccountList> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    ...
                    {
                        requestMessage = requestMessage.Clone(new global::System.Uri( result.NextLink ),Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Method.Get );
                        ...
                        await this.Client.AccountsListBySubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                    }
                }
            }
        }
