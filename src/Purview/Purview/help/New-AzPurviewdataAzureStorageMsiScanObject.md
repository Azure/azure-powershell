...
online version: https://docs.microsoft.com/powershell/module/az.Purviewdata/new-AzPurviewdataAzureStorageMsiScanObject
schema: 2.0.0
---

# New-AzPurviewdataAzureStorageMsiScanObject
...
```
New-AzPurviewdataAzureStorageMsiScanObject -Kind <ScanAuthorizationType> [-CollectionReferenceName <String>]
