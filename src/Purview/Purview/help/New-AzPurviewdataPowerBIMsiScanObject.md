...
online version: https://docs.microsoft.com/powershell/module/az.Purviewdata/new-AzPurviewdataPowerBIMsiScanObject
schema: 2.0.0
---

# New-AzPurviewdataPowerBIMsiScanObject
...
```
New-AzPurviewdataPowerBIMsiScanObject -Kind <ScanAuthorizationType> [-CollectionReferenceName <String>]
