...
online version: https://docs.microsoft.com/powershell/module/az.Purviewdata/new-AzPurviewdataAmazonS3DataSourceObject
schema: 2.0.0
---

# New-AzPurviewdataAmazonS3DataSourceObject
...
```
New-AzPurviewdataAmazonS3DataSourceObject -Kind <DataSourceType> [-CollectionReferenceName <String>]
