...
function New-AzPurviewAmazonPostgreSqlScanRulesetObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.AmazonPostgreSqlScanRuleset')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.AmazonPostgreSqlScanRuleset]::New()
