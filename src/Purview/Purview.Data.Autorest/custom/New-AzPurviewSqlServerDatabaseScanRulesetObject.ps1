...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.SqlServerDatabaseScanRuleset
.Link
...
function New-AzPurviewSqlServerDatabaseScanRulesetObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.SqlServerDatabaseScanRuleset')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.SqlServerDatabaseScanRuleset]::New()
