...
function New-AzPurviewAzureSqlDatabaseManagedInstanceScanRulesetObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.AzureSqlDatabaseManagedInstanceScanRuleset')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.AzureSqlDatabaseManagedInstanceScanRuleset]::New()
