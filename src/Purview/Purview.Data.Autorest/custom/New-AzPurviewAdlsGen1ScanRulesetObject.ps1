...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.AdlsGen1ScanRuleset
.Link
...
function New-AzPurviewAdlsGen1ScanRulesetObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.AdlsGen1ScanRuleset')]
    ...
    Param(
        ...
        [Parameter()]
        [Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.ICustomFileExtension[]]
        $ScanningRuleCustomFileExtension,
        [Parameter()]
        [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.FileExtensionsType])]
        [Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.FileExtensionsType[]]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.AdlsGen1ScanRuleset]::New()
