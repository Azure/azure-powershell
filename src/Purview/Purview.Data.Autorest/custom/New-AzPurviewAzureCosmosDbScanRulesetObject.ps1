...
function New-AzPurviewAzureCosmosDbScanRulesetObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.AzureCosmosDbScanRuleset')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.AzureCosmosDbScanRuleset]::New()
