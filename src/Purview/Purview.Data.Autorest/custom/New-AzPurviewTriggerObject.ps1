...
function New-AzPurviewTriggerObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.Trigger')]
    ...
    Param(
        ...
        $RecurrenceEndTime,
        [Parameter()]
        [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.TriggerFrequency])]
        [Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.TriggerFrequency]
        $RecurrenceFrequency,
        [Parameter()]
        [string]
        $RecurrenceInterval,
        ...
        $RecurrenceTimeZone,
        [Parameter()]
        [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.ScanLevelType])]
        [Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.ScanLevelType]
        $ScanLevel,
        [Parameter(HelpMessage="Dictionary of <any>.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.IRecurrenceScheduleAdditionalProperties]
        ...
        $ScheduleMonthDay,
        [Parameter()]
        [Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.IRecurrenceScheduleOccurrence[]]
        $ScheduleMonthlyOccurrence,
        [Parameter()]
        [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.DaysOfWeek])]
        [Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.DaysOfWeek[]]
        $ScheduleWeekDay
    )

    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.Trigger]::New()
