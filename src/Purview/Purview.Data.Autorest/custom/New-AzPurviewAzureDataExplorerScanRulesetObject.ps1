...
function New-AzPurviewAzureDataExplorerScanRulesetObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.AzureDataExplorerScanRuleset')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.AzureDataExplorerScanRuleset]::New()
