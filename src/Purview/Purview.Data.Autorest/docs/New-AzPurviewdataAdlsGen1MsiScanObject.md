...
online version: https://docs.microsoft.com/powershell/module/az.Purviewdata/new-AzPurviewdataAdlsGen1MsiScanObject
schema: 2.0.0
---

# New-AzPurviewdataAdlsGen1MsiScanObject
...
```
New-AzPurviewdataAdlsGen1MsiScanObject -Kind <ScanAuthorizationType> [-CollectionReferenceName <String>]
