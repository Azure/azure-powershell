...
### DeleteViaIdentity
```
Remove-AzPurviewKeyVaultConnection -Endpoint <String> -InputObject <IPurviewIdentity>
...
### Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20211001Preview.IAzureKeyVault
