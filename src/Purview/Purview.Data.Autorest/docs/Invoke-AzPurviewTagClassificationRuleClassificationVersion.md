...
### TagViaIdentity
```
Invoke-AzPurviewTagClassificationRuleClassificationVersion -Endpoint <String> -InputObject <IPurviewIdentity>
 -Action <ClassificationAction> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
