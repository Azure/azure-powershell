...
### GetViaIdentity
```
Get-AzPurviewSystemScanRuleset -Endpoint <String> -InputObject <IPurviewIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity1
```
Get-AzPurviewSystemScanRuleset -Endpoint <String> -InputObject <IPurviewIdentity>
