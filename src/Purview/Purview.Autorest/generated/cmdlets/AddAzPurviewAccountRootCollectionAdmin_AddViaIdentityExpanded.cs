...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purview.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] AddRootCollectionAdmin=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Purview/accounts/{accountName}/addRootCollectionAdmin"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Purview.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Add, @"AzPurviewAccountRootCollectionAdmin_AddViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Purview.Description(@"Add the administrator for root collection associated with this account.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Purview.Generated]
    public partial class AddAzPurviewAccountRootCollectionAdmin_AddViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="CollectionAdminUpdateBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.ICollectionAdminUpdate _collectionAdminUpdateBody= new Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.CollectionAdminUpdate();

        /// <summary>Collection administrator update.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.ICollectionAdminUpdate CollectionAdminUpdateBody { get => this._collectionAdminUpdateBody; set => this._collectionAdminUpdateBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Gets or sets the object identifier of the admin.")]
        ...
        public string ObjectId { get => CollectionAdminUpdateBody.ObjectId ?? null; set => CollectionAdminUpdateBody.ObjectId = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="AddAzPurviewAccountRootCollectionAdmin_AddViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public AddAzPurviewAccountRootCollectionAdmin_AddViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'AccountsAddRootCollectionAdmin' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.AccountsAddRootCollectionAdminViaIdentity(InputObject.Id, CollectionAdminUpdateBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.AccountsAddRootCollectionAdmin(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, CollectionAdminUpdateBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=CollectionAdminUpdateBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.IErrorResponseModel> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=CollectionAdminUpdateBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=CollectionAdminUpdateBody })
                    {
