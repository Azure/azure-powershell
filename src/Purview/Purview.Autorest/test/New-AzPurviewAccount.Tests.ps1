...
Describe 'New-AzPurviewAccount' {
    It 'CreateExpanded' {
        $pa = New-AzPurviewAccount -Name $env.accountName3 -ResourceGroupName $env.resourceGroupName -Location eastus -EnableSystemAssignedIdentity -SkuCapacity $env.skuCapacity -SkuName $env.skuName
