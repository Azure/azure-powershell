...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzPurviewTagClassificationRuleClassificationVersion_TagViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzPurviewTagClassificationRuleClassificationVersion_TagViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzPurviewTagClassificationRuleClassificationVersion_TagViaIdentity"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzPurviewTagClassificationRuleClassificationVersion_TagViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ClassificationRulesTagClassificationVersion' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ClassificationRulesTagClassificationVersionViaIdentity(InputObject.Id, Endpoint, Action, onAccepted, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.ClassificationRuleVersion)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.ClassificationRuleVersion"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.ClassificationRulesTagClassificationVersion(Endpoint, InputObject.ClassificationRuleName ?? null, InputObject.ClassificationRuleVersion ?? default(int), Action, onAccepted, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Endpoint=Endpoint,Action=Action})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.Api20211001Preview.IErrorResponseModel> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Endpoint=Endpoint, Action=Action })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Endpoint=Endpoint, Action=Action })
                    {
