...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CancelScan=>POST:"/datasources/{dataSourceName}/scans/{scanName}/runs/{runId}/:cancel"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Stop, @"AzPurviewScanResultScan_Cancel", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Description(@"Cancels a scan")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.HttpPath(Path = "/datasources/{dataSourceName}/scans/{scanName}/runs/{runId}/:cancel", ApiVersion = "2021-10-01-preview")]
    public partial class StopAzPurviewScanResultScan_Cancel : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ScanResultCancelScan' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ScanResultCancelScan(Endpoint, DataSourceName, ScanName, RunId, onAccepted, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Endpoint=Endpoint,DataSourceName=DataSourceName,ScanName=ScanName,RunId=RunId})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StopAzPurviewScanResultScan_Cancel" /> cmdlet class.
        /// </summary>
        public StopAzPurviewScanResultScan_Cancel()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.Api20211001Preview.IErrorResponseModel> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Endpoint=Endpoint, DataSourceName=DataSourceName, ScanName=ScanName, RunId=RunId })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Endpoint=Endpoint, DataSourceName=DataSourceName, ScanName=ScanName, RunId=RunId })
                    {
