...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzPurviewScanResultScan_RunViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class StartAzPurviewScanResultScan_RunViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.IEventListener
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ScanResultRunScanViaIdentity(InputObject.Id, Endpoint, this.InvocationInformation.BoundParameters.ContainsKey("ScanLevel") ? ScanLevel : null, onAccepted, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ScanResultRunScan(Endpoint, InputObject.DataSourceName ?? null, InputObject.ScanName ?? null, InputObject.RunId ?? null, this.InvocationInformation.BoundParameters.ContainsKey("ScanLevel") ? ScanLevel : null, onAccepted, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Endpoint=Endpoint,ScanLevel=this.InvocationInformation.BoundParameters.ContainsKey("ScanLevel") ? ScanLevel : null})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzPurviewScanResultScan_RunViaIdentity" /> cmdlet class.
        /// </summary>
        public StartAzPurviewScanResultScan_RunViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.Api20211001Preview.IErrorResponseModel> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Endpoint=Endpoint, ScanLevel=this.InvocationInformation.BoundParameters.ContainsKey("ScanLevel") ? ScanLevel : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Endpoint=Endpoint, ScanLevel=this.InvocationInformation.BoundParameters.ContainsKey("ScanLevel") ? ScanLevel : null })
                    {
