...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.Api20211001Preview
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.IValidates
    {
        ...
        /// <summary>Backing field for <see cref="SqlEndpoint" /> property.</summary>
        ...
        public string SqlEndpoint { get => this._sqlEndpoint; set => this._sqlEndpoint = value; }

        /// <summary>Backing field for <see cref="SqlOnDemandEndpoint" /> property.</summary>
        private string _sqlOnDemandEndpoint;

        [Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Origin(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.PropertyOrigin.Owned)]
        public string SqlOnDemandEndpoint { get => this._sqlOnDemandEndpoint; set => this._sqlOnDemandEndpoint = value; }
        ...
        /// <summary>Creates an new <see cref="AzureSynapseProperties" /> instance.</summary>
    ...
    public partial interface IAzureSynapseProperties :
    ...
    internal partial interface IAzureSynapsePropertiesInternal :
