...
online version: https://docs.microsoft.com/powershell/module/az.Purviewdata/new-AzPurviewdataAdlsGen2DataSourceObject
schema: 2.0.0
---

# New-AzPurviewdataAdlsGen2DataSourceObject
...
```
New-AzPurviewdataAdlsGen2DataSourceObject -Kind <DataSourceType> [-CollectionReferenceName <String>]
