...
online version: https://docs.microsoft.com/powershell/module/az.Purviewdata/new-AzPurviewdataAdlsGen1DataSourceObject
schema: 2.0.0
---

# New-AzPurviewdataAdlsGen1DataSourceObject
...
```
New-AzPurviewdataAdlsGen1DataSourceObject -Kind <DataSourceType> [-CollectionReferenceName <String>]
