...
online version: https://docs.microsoft.com/powershell/module/az.Purviewdata/new-AzPurviewdataPowerBIDelegatedScanObject
schema: 2.0.0
---

# New-AzPurviewdataPowerBIDelegatedScanObject
...
```
New-AzPurviewdataPowerBIDelegatedScanObject -Kind <ScanAuthorizationType> [-AuthenticationType <String>]
