...
online version: https://docs.microsoft.com/powershell/module/az.Purviewdata/new-AzPurviewdataAzureMySqlDataSourceObject
schema: 2.0.0
---

# New-AzPurviewdataAzureMySqlDataSourceObject
...
```
New-AzPurviewdataAzureMySqlDataSourceObject -Kind <DataSourceType> [-CollectionReferenceName <String>]
