...
online version: https://docs.microsoft.com/powershell/module/az.Purviewdata/new-AzPurviewdataAzureStorageDataSourceObject
schema: 2.0.0
---

# New-AzPurviewdataAzureStorageDataSourceObject
...
```
New-AzPurviewdataAzureStorageDataSourceObject -Kind <DataSourceType> [-CollectionReferenceName <String>]
