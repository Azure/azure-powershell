...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.Purviewdata.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.Purviewdata.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: Purviewdata cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.Purviewdata.format.ps1xml'
