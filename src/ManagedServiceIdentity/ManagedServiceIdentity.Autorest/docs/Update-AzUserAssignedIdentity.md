...
### Update2
```
Update-AzUserAssignedIdentity -Name <String> -ResourceGroupName <String>
 -Parameter <IIdentityUpdateAutoGenerated2> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm]
...
### UpdateViaIdentity2
```
Update-AzUserAssignedIdentity -InputObject <IManagedServiceIdentity>
 -Parameter <IIdentityUpdateAutoGenerated2> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Parameter Sets: UpdateViaIdentity2, UpdateViaIdentityExpanded, UpdateViaIdentityExpanded2
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Update2, UpdateExpanded, UpdateExpanded2
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.Api20230731Preview.IIdentityUpdateAutoGenerated2
...
### Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.Api20230731Preview.IIdentityUpdateAutoGenerated2
