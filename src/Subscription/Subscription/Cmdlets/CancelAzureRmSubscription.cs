...
{
    [Cmdlet("Cancel", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "Subscription", SupportsShouldProcess =
         true), OutputType(typeof(PSAzureSubscription))]
    public class CancelAzureRmSubscription : AzureRmLongRunningCmdlet
    {
        ...
        [Parameter(Mandatory = true, HelpMessage = "Subscription Id to cancel")]
        public string SubscriptionId { get; set; }

        public override void ExecuteCmdlet()
        {
            if (this.ShouldProcess(target: this.SubscriptionId, action: "Cancel subscription"))
            {
