...
namespace Microsoft.Azure.Management.Logic
{
    ...
    /// </summary>
    internal partial class WorkflowRunActionsOperations : Microsoft.Rest.IServiceOperations<LogicManagementClient>, IWorkflowRunActionsOperations
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<WorkflowRunAction>>> ListWithHttpMessagesAsync(string resourceGroupName, string workflowName, string runName, Microsoft.Rest.Azure.OData.ODataQuery<WorkflowRunActionFilter> odataQuery = default(Microsoft.Rest.Azure.OData.ODataQuery<WorkflowRunActionFilter>), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (odataQuery != null)
            {
                var _workflowRunActionFilter = odataQuery.ToString();
                if (!string.IsNullOrEmpty(_workflowRunActionFilter))
                {
                    _queryParameters.Add(_workflowRunActionFilter);
                }
            }
            if (this.Client.ApiVersion != null)
            {
