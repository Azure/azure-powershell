...
namespace Microsoft.Azure.Management.Logic.Models
{
    ...
    public partial class Request
    {
        ...
        /// <param name="headers">A list of all the headers attached to the request.
        /// </param>

        /// <param name="uri">The destination for the request.
        /// </param>

        /// <param name="method">The HTTP method used for the request.
        /// </param>
