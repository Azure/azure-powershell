...
namespace Microsoft.Azure.Management.Logic.Models
{
    ...
    public partial class WorkflowRun : SubResource
    {
        ...
        /// </param>
        public WorkflowRun(string id = default(string), string name = default(string), string type = default(string), Correlation correlation = default(Correlation), System.DateTimeOffset? waitEndTime = default(System.DateTimeOffset?), System.DateTimeOffset? startTime = default(System.DateTimeOffset?), System.DateTimeOffset? endTime = default(System.DateTimeOffset?), string status = default(string), string code = default(string), object error = default(object), string correlationId = default(string), ResourceReference workflow = default(ResourceReference), WorkflowRunTrigger trigger = default(WorkflowRunTrigger), System.Collections.Generic.IDictionary<string, WorkflowOutputParameter> outputs = default(System.Collections.Generic.IDictionary<string, WorkflowOutputParameter>), WorkflowRunTrigger response = default(WorkflowRunTrigger))
