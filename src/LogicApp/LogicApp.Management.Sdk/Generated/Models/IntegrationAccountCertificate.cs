...
namespace Microsoft.Azure.Management.Logic.Models
{
    ...
    public partial class IntegrationAccountCertificate : Resource
    {
        ...
        /// </param>
        public IntegrationAccountCertificate(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), System.DateTimeOffset? createdTime = default(System.DateTimeOffset?), System.DateTimeOffset? changedTime = default(System.DateTimeOffset?), object metadata = default(object), KeyVaultKeyReference key = default(KeyVaultKeyReference), string publicCertificate = default(string))
