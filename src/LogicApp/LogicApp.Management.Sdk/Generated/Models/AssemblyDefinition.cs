...
namespace Microsoft.Azure.Management.Logic.Models
{
    ...
    public partial class AssemblyDefinition : Resource
    {
        ...
        /// <param name="properties">The assembly properties.
        /// </param>
        public AssemblyDefinition(AssemblyProperties properties, string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>))
