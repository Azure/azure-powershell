...
namespace Microsoft.Azure.Management.Logic.Models
{
    ...
    public partial class RequestHistory : Resource
    {
        ...
        /// </param>
        public RequestHistory(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), RequestHistoryProperties properties = default(RequestHistoryProperties))
