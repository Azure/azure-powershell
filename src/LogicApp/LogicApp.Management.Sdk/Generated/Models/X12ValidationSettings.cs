...
namespace Microsoft.Azure.Management.Logic.Models
{
    ...
    public partial class X12ValidationSettings
    {
        ...
        /// <param name="validateCharacterSet">The value indicating whether to validate character set in the message.
        /// </param>

        /// <param name="checkDuplicateInterchangeControlNumber">The value indicating whether to check for duplicate interchange control
        /// number.
        /// </param>

        /// <param name="interchangeControlNumberValidityDays">The validity period of interchange control number.
        /// </param>

        /// <param name="checkDuplicateGroupControlNumber">The value indicating whether to check for duplicate group control number.
        /// </param>

        /// <param name="checkDuplicateTransactionSetControlNumber">The value indicating whether to check for duplicate transaction set control
        /// number.
        /// </param>

        /// <param name="validateEdiTypes">The value indicating whether to Whether to validate EDI types.
        /// </param>

        /// <param name="validateXsdTypes">The value indicating whether to Whether to validate XSD types.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets the value indicating whether to validate character set in the
        /// message.
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "checkDuplicateInterchangeControlNumber")]
        public bool CheckDuplicateInterchangeControlNumber {get; set; }

        /// <summary>
        /// Gets or sets the validity period of interchange control number.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "interchangeControlNumberValidityDays")]
        public int InterchangeControlNumberValidityDays {get; set; }

        /// <summary>
        /// Gets or sets the value indicating whether to check for duplicate group
        /// control number.
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "checkDuplicateTransactionSetControlNumber")]
