...
```powershell
$Definition = [IO.File]::ReadAllText("d:\Workflows\Definition.json")
New-AzLogicApp -ResourceGroupName "ResourceGroup11" -Name "LogicApp05" -Location "westus" -State "Enabled" -Definition $Definition -Parameters @{name1="value1";name2="value2"}
```
