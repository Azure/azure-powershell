...
namespace Microsoft.Azure.Commands.LogicApp.Cmdlets
{
    ...
    public class NewAzureIntegrationAccountPartnerCommand : LogicAppBaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, HelpMessage = "Specifies business identities for the integration account partner. It is a nested array, with inner arrays containing the Qualifier as the first object/string and the Value as the second object/string",
            ValueFromPipelineByPropertyName = false)]
        [ValidateNotNullOrEmpty]
