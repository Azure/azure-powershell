...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/get-testbaseaccount
schema: 2.0.0
---
...
### List (Default)
```
Get-TestBaseAccount -SubscriptionId <String> [-GetDeleted] [<CommonParameters>]
```

### Get
```
Get-TestBaseAccount -ResourceGroupName <String> -SubscriptionId <String> -TestBaseAccountName <String>
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-TestBaseAccount -InputObject <ITestBaseIdentity> [<CommonParameters>]
```

### List1
```
Get-TestBaseAccount -ResourceGroupName <String> -SubscriptionId <String> [-GetDeleted] [<CommonParameters>]
```
