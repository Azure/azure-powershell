...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/get-analysisresult
schema: 2.0.0
---
...
### Get (Default)
```
Get-AnalysisResult -AnalysisResultName <AnalysisResultName> -PackageName <String> -ResourceGroupName <String>
 -SubscriptionId <String> -TestBaseAccountName <String> -TestResultName <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-AnalysisResult -InputObject <ITestBaseIdentity> [<CommonParameters>]
```

### List
```
Get-AnalysisResult -PackageName <String> -ResourceGroupName <String> -SubscriptionId <String>
 -TestBaseAccountName <String> -TestResultName <String> -AnalysisResultType <AnalysisResultType>
 [<CommonParameters>]
```
...
```yaml
Type: Sample.API.Support.AnalysisResultName
Parameter Sets: Get
Aliases:
...
```yaml
Type: Sample.API.Support.AnalysisResultType
Parameter Sets: List
Aliases:
...
### Sample.API.Models.IAnalysisResultSingletonResource
