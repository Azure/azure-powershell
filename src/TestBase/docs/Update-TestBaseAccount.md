...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/update-testbaseaccount
schema: 2.0.0
---
...
```
Update-TestBaseAccount -ResourceGroupName <String> -SubscriptionId <String> -TestBaseAccountName <String>
 [-SkuLocations <String[]>] [-SkuName <String>] [-SkuResourceType <String>] [-Tags <Hashtable>] [-AsJob]
...
```
Update-TestBaseAccount -ResourceGroupName <String> -SubscriptionId <String> -TestBaseAccountName <String>
 -Parameters <ITestBaseAccountUpdateParameters> [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-TestBaseAccount -InputObject <ITestBaseIdentity> -Parameters <ITestBaseAccountUpdateParameters>
 [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-TestBaseAccount -InputObject <ITestBaseIdentity> [-SkuLocations <String[]>] [-SkuName <String>]
 [-SkuResourceType <String>] [-Tags <Hashtable>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Sample.API.Models.ITestBaseAccountUpdateParameters
...
### Sample.API.Models.ITestBaseAccountUpdateParameters
...
PARAMETERS <ITestBaseAccountUpdateParameters>: Parameters supplied to update a Test Base Account.
  ...
  - `[Tags <ITags>]`: The tags of the Test Base Account.
