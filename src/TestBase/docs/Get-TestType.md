...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/get-testtype
schema: 2.0.0
---
...
### List (Default)
```
Get-TestType -ResourceGroupName <String> -SubscriptionId <String> -TestBaseAccountName <String>
 [<CommonParameters>]
```
...
```
Get-TestType -ResourceGroupName <String> -SubscriptionId <String> -TestBaseAccountName <String>
 -TestTypeResourceName <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-TestType -InputObject <ITestBaseIdentity> [<CommonParameters>]
```
...
### Sample.API.Models.ITestTypeResource
