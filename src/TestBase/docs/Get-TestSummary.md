...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/get-testsummary
schema: 2.0.0
---
...
### List (Default)
```
Get-TestSummary -ResourceGroupName <String> -SubscriptionId <String> -TestBaseAccountName <String>
 [<CommonParameters>]
```
...
```
Get-TestSummary -ResourceGroupName <String> -SubscriptionId <String> -TestBaseAccountName <String>
 -TestSummaryName <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-TestSummary -InputObject <ITestBaseIdentity> [<CommonParameters>]
```
...
### Sample.API.Models.ITestSummaryResource
