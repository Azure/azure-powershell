...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/get-testbaseaccountfileuploadurl
schema: 2.0.0
---

# Get-TestBaseAccountFileUploadUrl
...
### GetExpanded (Default)
```
Get-TestBaseAccountFileUploadUrl -ResourceGroupName <String> -SubscriptionId <String>
 -TestBaseAccountName <String> [-BlobName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Get
```
Get-TestBaseAccountFileUploadUrl -ResourceGroupName <String> -SubscriptionId <String>
 -TestBaseAccountName <String> -Parameters <IGetFileUploadUrlParameters> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-TestBaseAccountFileUploadUrl -InputObject <ITestBaseIdentity> -Parameters <IGetFileUploadUrlParameters>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentityExpanded
```
Get-TestBaseAccountFileUploadUrl -InputObject <ITestBaseIdentity> [-BlobName <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Sample.API.Models.IGetFileUploadUrlParameters
...
### Sample.API.Models.IGetFileUploadUrlParameters

### Sample.API.Models.ITestBaseIdentity

## OUTPUTS

### Sample.API.Models.IFileUploadUrlResponse
...
PARAMETERS <IGetFileUploadUrlParameters>: The parameters supplied to the Test Base Account GetFileUploadURL action.
