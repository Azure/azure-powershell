...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/get-testresultdownloadurl
schema: 2.0.0
---

# Get-TestResultDownloadUrl
...
### Get (Default)
```
Get-TestResultDownloadUrl -PackageName <String> -ResourceGroupName <String> -SubscriptionId <String>
 -TestBaseAccountName <String> -TestResultName <String> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-TestResultDownloadUrl -InputObject <ITestBaseIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Sample.API.Models.IDownloadUrlResponse
