...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/get-testresultvideodownloadurl
schema: 2.0.0
---

# Get-TestResultVideoDownloadUrl
...
### Get (Default)
```
Get-TestResultVideoDownloadUrl -PackageName <String> -ResourceGroupName <String> -SubscriptionId <String>
 -TestBaseAccountName <String> -TestResultName <String> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-TestResultVideoDownloadUrl -InputObject <ITestBaseIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
