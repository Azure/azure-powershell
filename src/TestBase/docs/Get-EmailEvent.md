...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/get-emailevent
schema: 2.0.0
---
...
### List (Default)
```
Get-EmailEvent -ResourceGroupName <String> -SubscriptionId <String> -TestBaseAccountName <String>
 [<CommonParameters>]
```

### Get
```
Get-EmailEvent -EmailEventResourceName <String> -ResourceGroupName <String> -SubscriptionId <String>
 -TestBaseAccountName <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-EmailEvent -InputObject <ITestBaseIdentity> [<CommonParameters>]
```
...
### Sample.API.Models.IEmailEventResource
