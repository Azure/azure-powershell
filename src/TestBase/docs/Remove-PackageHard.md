...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/remove-packagehard
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-PackageHard -PackageName <String> -ResourceGroupName <String> -SubscriptionId <String>
 -TestBaseAccountName <String> [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-PackageHard -InputObject <ITestBaseIdentity> [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
