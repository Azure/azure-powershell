...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/get-package
schema: 2.0.0
---
...
### List (Default)
```
Get-Package -ResourceGroupName <String> -SubscriptionId <String> -TestBaseAccountName <String>
 [<CommonParameters>]
```

### Get
```
Get-Package -PackageName <String> -ResourceGroupName <String> -SubscriptionId <String>
 -TestBaseAccountName <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-Package -InputObject <ITestBaseIdentity> [<CommonParameters>]
```
