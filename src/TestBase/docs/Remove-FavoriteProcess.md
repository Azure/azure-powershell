...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/remove-favoriteprocess
schema: 2.0.0
---

# Remove-FavoriteProcess
...
### Delete (Default)
```
Remove-FavoriteProcess -FavoriteProcessResourceName <String> -PackageName <String> -ResourceGroupName <String>
 -SubscriptionId <String> -TestBaseAccountName <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-FavoriteProcess -InputObject <ITestBaseIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
