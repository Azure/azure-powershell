...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/remove-customerevent
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-CustomerEvent -CustomerEventName <String> -ResourceGroupName <String> -SubscriptionId <String>
 -TestBaseAccountName <String> [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CustomerEvent -InputObject <ITestBaseIdentity> [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
