...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/remove-package
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-Package -PackageName <String> -ResourceGroupName <String> -SubscriptionId <String>
 -TestBaseAccountName <String> [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-Package -InputObject <ITestBaseIdentity> [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
