...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/remove-testbaseaccount
schema: 2.0.0
---

# Remove-TestBaseAccount
...
### Delete (Default)
```
Remove-TestBaseAccount -ResourceGroupName <String> -SubscriptionId <String> -TestBaseAccountName <String>
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-TestBaseAccount -InputObject <ITestBaseIdentity> [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
