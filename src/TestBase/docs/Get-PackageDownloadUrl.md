...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/get-packagedownloadurl
schema: 2.0.0
---
...
### Get (Default)
```
Get-PackageDownloadUrl -PackageName <String> -ResourceGroupName <String> -SubscriptionId <String>
 -TestBaseAccountName <String> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-PackageDownloadUrl -InputObject <ITestBaseIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
