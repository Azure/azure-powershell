...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/invoke-offboardtestbaseaccount
schema: 2.0.0
---

# Invoke-OffboardTestBaseAccount
...
### Offboard (Default)
```
Invoke-OffboardTestBaseAccount -ResourceGroupName <String> -SubscriptionId <String>
 -TestBaseAccountName <String> [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### OffboardViaIdentity
```
Invoke-OffboardTestBaseAccount -InputObject <ITestBaseIdentity> [-AsJob] [-NoWait] [-PassThru] [-Confirm]
