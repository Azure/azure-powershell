...
online version: https://docs.microsoft.com/en-us/powershell/module/testbase/get-availableos
schema: 2.0.0
---
...
### Get (Default)
```
Get-AvailableOS -AvailableOSResourceName <String> -ResourceGroupName <String> -SubscriptionId <String>
 -TestBaseAccountName <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-AvailableOS -InputObject <ITestBaseIdentity> [<CommonParameters>]
```

### List
```
Get-AvailableOS -ResourceGroupName <String> -SubscriptionId <String> -TestBaseAccountName <String>
 -OSUpdateType <OSUpdateType> [<CommonParameters>]
```
...
### Sample.API.Models.IAvailableOSResource
