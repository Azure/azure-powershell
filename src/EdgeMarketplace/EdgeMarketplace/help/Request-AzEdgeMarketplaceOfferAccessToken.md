...
```
Request-AzEdgeMarketplaceOfferAccessToken -OfferId <String> -ResourceUri <String>
 ...
 [-MarketplaceSkuVersion <String>] [-PublisherName <String>] [-Timeout <Int32>] [-DefaultProfile <PSObject>]
