...
external help file:
Module Name: Az.Deid
online version: https://learn.microsoft.com/powershell/module/az.deid/remove-azdeidservice
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzDeidService -InputObject <IDeidIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
