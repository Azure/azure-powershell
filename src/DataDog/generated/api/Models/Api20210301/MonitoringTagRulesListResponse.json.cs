namespace Microsoft.Azure.PowerShell.Cmdlets.DataDog.Models.Api20210301
{
    ...
    public partial class MonitoringTagRulesListResponse
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataDog.Models.Api20210301.IMonitoringTagRulesListResponse.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataDog.Models.Api20210301.IMonitoringTagRulesListResponse.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataDog.Models.Api20210301.IMonitoringTagRulesListResponse FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonObject json ? new MonitoringTagRulesListResponse(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonObject into a new instance of <see cref="MonitoringTagRulesListResponse" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal MonitoringTagRulesListResponse(Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonObject json)
        {
            ...
            {_value = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonArray>("value"), out var __jsonValue) ? If( __jsonValue as Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.DataDog.Models.Api20210301.IMonitoringTagRules[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.DataDog.Models.Api20210301.IMonitoringTagRules) (Microsoft.Azure.PowerShell.Cmdlets.DataDog.Models.Api20210301.MonitoringTagRules.FromJson(__u) )) ))() : null : Value;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="MonitoringTagRulesListResponse" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MonitoringTagRulesListResponse" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonNode" />.
        /// </returns>
