namespace Microsoft.Azure.PowerShell.Cmdlets.DataDog.Models.Api20210301
{
    ...
    public partial class DatadogSingleSignOnResource
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonObject into a new instance of <see cref="DatadogSingleSignOnResource" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal DatadogSingleSignOnResource(Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.DataDog.Models.Api20210301.DatadogSingleSignOnProperties.FromJson(__jsonProperties) : Property;}
            {_systemData = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonObject>("systemData"), out var __jsonSystemData) ? Microsoft.Azure.PowerShell.Cmdlets.DataDog.Models.Api20.SystemData.FromJson(__jsonSystemData) : SystemData;}
            ...
            {_type = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonString>("type"), out var __jsonType) ? (string)__jsonType : (string)Type;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataDog.Models.Api20210301.IDatadogSingleSignOnResource.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataDog.Models.Api20210301.IDatadogSingleSignOnResource.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataDog.Models.Api20210301.IDatadogSingleSignOnResource FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonObject json ? new DatadogSingleSignOnResource(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="DatadogSingleSignOnResource" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="DatadogSingleSignOnResource" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != this._systemData ? (Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonNode) this._systemData.ToJson(null,serializationMode) : null, "systemData" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._type)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DataDog.Runtime.Json.JsonString(this._type.ToString()) : null, "type" ,container.Add );
            }
