...
online version: https://docs.microsoft.com/en-us/powershell/module/az.datadog/set-azdatadogtagrule
schema: 2.0.0
---

# Set-AzDataDogTagRule
...
```
Set-AzDataDogTagRule -MonitorName <String> -ResourceGroupName <String> -RuleSetName <String>
