...
```
Update-AzContainerInstanceContainerGroupProfile -Name <String> -ResourceGroupName <String>
 -Property <IContainerGroupProfilePatch> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm]
...
Update-AzContainerInstanceContainerGroupProfile -InputObject <IContainerInstanceIdentity>
 -Property <IContainerGroupProfilePatch> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
