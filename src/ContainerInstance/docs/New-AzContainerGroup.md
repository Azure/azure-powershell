...
## DESCRIPTION
Create or update container groups with specified configurations. For a in-memory object, currently, we support mounting Azure File share as a volume or specifying git repository as volume directory. The empty directory volume and secret volume are not supported yet.
