...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.EnvironmentVariable
.Link
...
function New-AzContainerInstanceEnvironmentVariableObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.EnvironmentVariable')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.EnvironmentVariable]::New()
