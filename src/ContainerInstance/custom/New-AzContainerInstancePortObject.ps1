...
function New-AzContainerInstancePortObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.ContainerPort')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.ContainerPort]::New()
