...
function New-AzContainerInstanceVolumeMountObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.VolumeMount')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.VolumeMount]::New()
