...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.InitContainerDefinition
.Link
...
function New-AzContainerInstanceInitDefinitionObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.InitContainerDefinition')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.InitContainerDefinition]::New()
