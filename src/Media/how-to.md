...
- `build-module.ps1`
  - Builds the module DLL (`./bin/Az.Media.private.dll`), creates the exported cmdlets, generates custom cmdlet test stubs, and updates `./Az.Media.psd1` with Azure profile information.
