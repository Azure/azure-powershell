...
online version: https://learn.microsoft.com/powershell/module/az.media/sync-azmediaservicestoragekey
schema: 2.0.0
---
...
```
Sync-AzMediaServiceStorageKey -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Id <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Sync
```
Sync-AzMediaServiceStorageKey -AccountName <String> -ResourceGroupName <String>
 -Parameter <ISyncStorageKeysInput> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SyncViaIdentity
```
Sync-AzMediaServiceStorageKey -InputObject <IMediaIdentity> -Parameter <ISyncStorageKeysInput>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SyncViaIdentityExpanded
```
Sync-AzMediaServiceStorageKey -InputObject <IMediaIdentity> [-Id <String>] [-DefaultProfile <PSObject>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20211101.ISyncStorageKeysInput
...
### Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20211101.ISyncStorageKeysInput
