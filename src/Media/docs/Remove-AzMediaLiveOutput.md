...
online version: https://learn.microsoft.com/powershell/module/az.media/remove-azmedialiveoutput
schema: 2.0.0
---

# Remove-AzMediaLiveOutput
...
### Delete (Default)
```
Remove-AzMediaLiveOutput -AccountName <String> -LiveEventName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzMediaLiveOutput -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
