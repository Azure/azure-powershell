...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediaoperationresult
schema: 2.0.0
---

# Get-AzMediaOperationResult
...
### Get (Default)
```
Get-AzMediaOperationResult -AccountName <String> -AssetName <String> -OperationId <String>
 -ResourceGroupName <String> -TrackName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMediaOperationResult -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
