...
online version: https://learn.microsoft.com/powershell/module/az.media/test-azmedialocationnameavailability
schema: 2.0.0
---

# Test-AzMediaLocationNameAvailability
...
```
Test-AzMediaLocationNameAvailability -LocationName <String> [-SubscriptionId <String>] [-Name <String>]
 [-Type <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Check
```
Test-AzMediaLocationNameAvailability -LocationName <String> -Parameter <ICheckNameAvailabilityInput>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentity
```
Test-AzMediaLocationNameAvailability -InputObject <IMediaIdentity> -Parameter <ICheckNameAvailabilityInput>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentityExpanded
```
Test-AzMediaLocationNameAvailability -InputObject <IMediaIdentity> [-Name <String>] [-Type <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20211101.ICheckNameAvailabilityInput
...
### Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20211101.ICheckNameAvailabilityInput

### Microsoft.Azure.PowerShell.Cmdlets.Media.Models.IMediaIdentity

## OUTPUTS

### Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20211101.IEntityNameAvailabilityCheckOutput
