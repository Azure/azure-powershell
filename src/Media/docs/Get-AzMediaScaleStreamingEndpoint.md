...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediascalestreamingendpoint
schema: 2.0.0
---

# Get-AzMediaScaleStreamingEndpoint
...
```
Get-AzMediaScaleStreamingEndpoint -AccountName <String> -ResourceGroupName <String>
 -StreamingEndpointName <String> [-SubscriptionId <String[]>] [-ScaleUnit <Int32>]
...
```
Get-AzMediaScaleStreamingEndpoint -AccountName <String> -ResourceGroupName <String>
 -StreamingEndpointName <String> -Parameter <IStreamingEntityScaleUnit> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ScaleViaIdentity
```
Get-AzMediaScaleStreamingEndpoint -InputObject <IMediaIdentity> -Parameter <IStreamingEntityScaleUnit>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ScaleViaIdentityExpanded
```
Get-AzMediaScaleStreamingEndpoint -InputObject <IMediaIdentity> [-ScaleUnit <Int32>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20220801.IStreamingEntityScaleUnit
...
### Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20220801.IStreamingEntityScaleUnit
