...
online version: https://learn.microsoft.com/powershell/module/az.media/update-azmediatrack
schema: 2.0.0
---
...
```
Update-AzMediaTrack -AccountName <String> -AssetName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzMediaTrack -InputObject <IMediaIdentity> [-TrackOdataType <String>] [-DefaultProfile <PSObject>]
