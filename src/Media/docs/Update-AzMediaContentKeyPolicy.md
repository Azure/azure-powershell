...
online version: https://learn.microsoft.com/powershell/module/az.media/update-azmediacontentkeypolicy
schema: 2.0.0
---

# Update-AzMediaContentKeyPolicy
...
```
Update-AzMediaContentKeyPolicy -AccountName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzMediaContentKeyPolicy -InputObject <IMediaIdentity> [-Description <String>]
