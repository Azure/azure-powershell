...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediaskustreamingendpoint
schema: 2.0.0
---

# Get-AzMediaSkuStreamingEndpoint
...
### Skus (Default)
```
Get-AzMediaSkuStreamingEndpoint -AccountName <String> -ResourceGroupName <String>
 -StreamingEndpointName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### SkusViaIdentity
```
Get-AzMediaSkuStreamingEndpoint -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
Parameter Sets: SkusViaIdentity
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20220801.IArmStreamingEndpointSkuInfo
