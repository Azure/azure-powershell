...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediaservicesoperationstatuses
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzMediaServicesOperationStatuses -LocationName <String> -OperationId <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMediaServicesOperationStatuses -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20211101.IMediaServiceOperationStatus
