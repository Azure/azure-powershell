...
online version: https://learn.microsoft.com/powershell/module/az.media/new-azmediatransform
schema: 2.0.0
---

# New-AzMediaTransform
...
```
New-AzMediaTransform -AccountName <String> -Name <String> -ResourceGroupName <String>
