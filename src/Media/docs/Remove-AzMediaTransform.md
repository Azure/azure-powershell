...
online version: https://learn.microsoft.com/powershell/module/az.media/remove-azmediatransform
schema: 2.0.0
---

# Remove-AzMediaTransform
...
### Delete (Default)
```
Remove-AzMediaTransform -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMediaTransform -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
