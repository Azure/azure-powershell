...
online version: https://learn.microsoft.com/powershell/module/az.media/start-azmedialiveevent
schema: 2.0.0
---

# Start-AzMediaLiveEvent
...
### Start (Default)
```
Start-AzMediaLiveEvent -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### StartViaIdentity
```
Start-AzMediaLiveEvent -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
