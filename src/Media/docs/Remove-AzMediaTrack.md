...
online version: https://learn.microsoft.com/powershell/module/az.media/remove-azmediatrack
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzMediaTrack -AccountName <String> -AssetName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzMediaTrack -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
