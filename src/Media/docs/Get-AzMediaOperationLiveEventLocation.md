...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediaoperationliveeventlocation
schema: 2.0.0
---

# Get-AzMediaOperationLiveEventLocation
...
### Operation (Default)
```
Get-AzMediaOperationLiveEventLocation -AccountName <String> -LiveEventName <String> -OperationId <String>
...
```
Get-AzMediaOperationLiveEventLocation -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
