...
online version: https://learn.microsoft.com/powershell/module/az.media/reset-azmedialiveevent
schema: 2.0.0
---
...
### Reset (Default)
```
Reset-AzMediaLiveEvent -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### ResetViaIdentity
```
Reset-AzMediaLiveEvent -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
