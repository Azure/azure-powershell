...
online version: https://learn.microsoft.com/powershell/module/az.media/update-azmediaasset
schema: 2.0.0
---
...
```
Update-AzMediaAsset -AccountName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzMediaAsset -InputObject <IMediaIdentity> [-AlternateId <String>] [-Container <String>]
 [-Description <String>] [-StorageAccountName <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
