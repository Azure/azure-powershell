...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediaasyncliveeventoperation
schema: 2.0.0
---

# Get-AzMediaAsyncLiveEventOperation
...
### Async (Default)
```
Get-AzMediaAsyncLiveEventOperation -AccountName <String> -OperationId <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### AsyncViaIdentity
```
Get-AzMediaAsyncLiveEventOperation -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20220801.IAsyncOperationResult
