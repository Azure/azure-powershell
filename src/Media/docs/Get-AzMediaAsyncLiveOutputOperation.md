...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediaasyncliveoutputoperation
schema: 2.0.0
---

# Get-AzMediaAsyncLiveOutputOperation
...
### Async (Default)
```
Get-AzMediaAsyncLiveOutputOperation -AccountName <String> -OperationId <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### AsyncViaIdentity
```
Get-AzMediaAsyncLiveOutputOperation -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
