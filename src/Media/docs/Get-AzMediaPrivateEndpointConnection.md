...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediaprivateendpointconnection
schema: 2.0.0
---

# Get-AzMediaPrivateEndpointConnection
...
### List (Default)
```
Get-AzMediaPrivateEndpointConnection -AccountName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzMediaPrivateEndpointConnection -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMediaPrivateEndpointConnection -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20.IPrivateEndpointConnection
