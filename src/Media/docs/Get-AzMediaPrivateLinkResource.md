...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediaprivatelinkresource
schema: 2.0.0
---

# Get-AzMediaPrivateLinkResource
...
### List (Default)
```
Get-AzMediaPrivateLinkResource -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzMediaPrivateLinkResource -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMediaPrivateLinkResource -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20.IPrivateLinkResource
