...
online version: https://learn.microsoft.com/powershell/module/az.media/stop-azmediastreamingendpoint
schema: 2.0.0
---
...
### Stop (Default)
```
Stop-AzMediaStreamingEndpoint -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### StopViaIdentity
```
Stop-AzMediaStreamingEndpoint -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
