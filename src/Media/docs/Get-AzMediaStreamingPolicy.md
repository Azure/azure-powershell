...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediastreamingpolicy
schema: 2.0.0
---

# Get-AzMediaStreamingPolicy
...
### List (Default)
```
Get-AzMediaStreamingPolicy -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-Filter <String>] [-Orderby <String>] [-Top <Int32>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzMediaStreamingPolicy -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMediaStreamingPolicy -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
