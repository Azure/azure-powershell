...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediaservicesoperationresult
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzMediaServicesOperationResult -LocationName <String> -OperationId <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMediaServicesOperationResult -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
