...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediaaccountfilter
schema: 2.0.0
---

# Get-AzMediaAccountFilter
...
### List (Default)
```
Get-AzMediaAccountFilter -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzMediaAccountFilter -AccountName <String> -FilterName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMediaAccountFilter -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
