...
online version: https://learn.microsoft.com/powershell/module/az.media/remove-azmedialiveevent
schema: 2.0.0
---

# Remove-AzMediaLiveEvent
...
### Delete (Default)
```
Remove-AzMediaLiveEvent -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzMediaLiveEvent -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
