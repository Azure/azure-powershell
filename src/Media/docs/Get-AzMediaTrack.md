...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediatrack
schema: 2.0.0
---
...
### List (Default)
```
Get-AzMediaTrack -AccountName <String> -AssetName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzMediaTrack -AccountName <String> -AssetName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMediaTrack -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
