...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediaassetfilter
schema: 2.0.0
---

# Get-AzMediaAssetFilter
...
### List (Default)
```
Get-AzMediaAssetFilter -AccountName <String> -AssetName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzMediaAssetFilter -AccountName <String> -AssetName <String> -FilterName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMediaAssetFilter -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
