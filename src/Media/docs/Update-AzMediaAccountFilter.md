...
online version: https://learn.microsoft.com/powershell/module/az.media/update-azmediaaccountfilter
schema: 2.0.0
---

# Update-AzMediaAccountFilter
...
```
Update-AzMediaAccountFilter -AccountName <String> -FilterName <String> -ResourceGroupName <String>
...
```
Update-AzMediaAccountFilter -InputObject <IMediaIdentity> [-FirstQualityBitrate <Int32>]
