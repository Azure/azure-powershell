...
online version: https://learn.microsoft.com/powershell/module/az.media/start-azmediastreamingendpoint
schema: 2.0.0
---

# Start-AzMediaStreamingEndpoint
...
### Start (Default)
```
Start-AzMediaStreamingEndpoint -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### StartViaIdentity
```
Start-AzMediaStreamingEndpoint -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
