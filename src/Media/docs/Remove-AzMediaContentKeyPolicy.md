...
online version: https://learn.microsoft.com/powershell/module/az.media/remove-azmediacontentkeypolicy
schema: 2.0.0
---

# Remove-AzMediaContentKeyPolicy
...
### Delete (Default)
```
Remove-AzMediaContentKeyPolicy -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMediaContentKeyPolicy -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-PassThru]
