...
online version: https://learn.microsoft.com/powershell/module/az.media/remove-azmediaasset
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzMediaAsset -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMediaAsset -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
