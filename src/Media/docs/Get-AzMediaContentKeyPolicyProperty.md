...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediacontentkeypolicyproperty
schema: 2.0.0
---

# Get-AzMediaContentKeyPolicyProperty
...
### Get (Default)
```
Get-AzMediaContentKeyPolicyProperty -AccountName <String> -ContentKeyPolicyName <String>
...
### GetViaIdentity
```
Get-AzMediaContentKeyPolicyProperty -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-Confirm]
...
### Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20220801.IContentKeyPolicyProperties
