...
online version: https://learn.microsoft.com/powershell/module/az.media/remove-azmediastreamingpolicy
schema: 2.0.0
---

# Remove-AzMediaStreamingPolicy
...
### Delete (Default)
```
Remove-AzMediaStreamingPolicy -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMediaStreamingPolicy -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-PassThru]
