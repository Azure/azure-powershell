...
online version: https://learn.microsoft.com/powershell/module/az.media/update-azmediajob
schema: 2.0.0
---
...
```
Update-AzMediaJob -AccountName <String> -Name <String> -ResourceGroupName <String> -TransformName <String>
 [-SubscriptionId <String>] [-CorrelationData <Hashtable>] [-Description <String>] [-InputOdataType <String>]
 [-Output <IJobOutput[]>] [-Priority <Priority>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzMediaJob -InputObject <IMediaIdentity> [-CorrelationData <Hashtable>] [-Description <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20211101.IJobOutput[]
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20211101.IJob
