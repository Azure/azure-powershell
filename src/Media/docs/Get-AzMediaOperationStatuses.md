...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediaoperationstatuses
schema: 2.0.0
---

# Get-AzMediaOperationStatuses
...
### Get (Default)
```
Get-AzMediaOperationStatuses -AccountName <String> -AssetName <String> -OperationId <String>
...
### GetViaIdentity
```
Get-AzMediaOperationStatuses -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20220801.IAssetTrackOperationStatus
