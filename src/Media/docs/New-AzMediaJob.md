...
online version: https://learn.microsoft.com/powershell/module/az.media/new-azmediajob
schema: 2.0.0
---
...
```
New-AzMediaJob -AccountName <String> -Name <String> -ResourceGroupName <String> -TransformName <String>
