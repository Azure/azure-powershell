...
online version: https://learn.microsoft.com/powershell/module/az.media/remove-azmediaassetfilter
schema: 2.0.0
---

# Remove-AzMediaAssetFilter
...
### Delete (Default)
```
Remove-AzMediaAssetFilter -AccountName <String> -AssetName <String> -FilterName <String>
...
### DeleteViaIdentity
```
Remove-AzMediaAssetFilter -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
