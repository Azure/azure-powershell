...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmedialiveoutput
schema: 2.0.0
---

# Get-AzMediaLiveOutput
...
### List (Default)
```
Get-AzMediaLiveOutput -AccountName <String> -LiveEventName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzMediaLiveOutput -AccountName <String> -LiveEventName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMediaLiveOutput -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
