...
online version: https://learn.microsoft.com/powershell/module/az.media/update-azmediatransform
schema: 2.0.0
---

# Update-AzMediaTransform
...
```
Update-AzMediaTransform -AccountName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzMediaTransform -InputObject <IMediaIdentity> [-Description <String>] [-Output <ITransformOutput[]>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20211101.ITransformOutput[]
Parameter Sets: (All)
Aliases:
