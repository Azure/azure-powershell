...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediaasyncstreamingendpointoperation
schema: 2.0.0
---

# Get-AzMediaAsyncStreamingEndpointOperation
...
### Async (Default)
```
Get-AzMediaAsyncStreamingEndpointOperation -AccountName <String> -OperationId <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### AsyncViaIdentity
```
Get-AzMediaAsyncStreamingEndpointOperation -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
