...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediajob
schema: 2.0.0
---
...
### List (Default)
```
Get-AzMediaJob -AccountName <String> -ResourceGroupName <String> -TransformName <String>
...
### Get
```
Get-AzMediaJob -AccountName <String> -Name <String> -ResourceGroupName <String> -TransformName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMediaJob -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
