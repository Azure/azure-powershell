...
online version: https://learn.microsoft.com/powershell/module/az.media/remove-azmediaaccountfilter
schema: 2.0.0
---

# Remove-AzMediaAccountFilter
...
### Delete (Default)
```
Remove-AzMediaAccountFilter -AccountName <String> -FilterName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMediaAccountFilter -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
