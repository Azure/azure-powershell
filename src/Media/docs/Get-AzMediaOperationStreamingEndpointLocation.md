...
online version: https://learn.microsoft.com/powershell/module/az.media/get-azmediaoperationstreamingendpointlocation
schema: 2.0.0
---

# Get-AzMediaOperationStreamingEndpointLocation
...
### Operation (Default)
```
Get-AzMediaOperationStreamingEndpointLocation -AccountName <String> -OperationId <String>
 -ResourceGroupName <String> -StreamingEndpointName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### OperationViaIdentity
```
Get-AzMediaOperationStreamingEndpointLocation -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>]
