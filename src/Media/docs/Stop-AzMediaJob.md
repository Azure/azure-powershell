...
online version: https://learn.microsoft.com/powershell/module/az.media/stop-azmediajob
schema: 2.0.0
---
...
### Cancel (Default)
```
Stop-AzMediaJob -AccountName <String> -Name <String> -ResourceGroupName <String> -TransformName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-AzMediaJob -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
