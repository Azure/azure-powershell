...
online version: https://learn.microsoft.com/powershell/module/az.media/remove-azmediastreamingendpoint
schema: 2.0.0
---

# Remove-AzMediaStreamingEndpoint
...
### Delete (Default)
```
Remove-AzMediaStreamingEndpoint -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzMediaStreamingEndpoint -InputObject <IMediaIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
