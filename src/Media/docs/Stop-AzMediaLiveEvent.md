...
online version: https://learn.microsoft.com/powershell/module/az.media/stop-azmedialiveevent
schema: 2.0.0
---

# Stop-AzMediaLiveEvent
...
```
Stop-AzMediaLiveEvent -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### StopViaIdentity
```
Stop-AzMediaLiveEvent -InputObject <IMediaIdentity> -Parameter <ILiveEventActionInput>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopViaIdentityExpanded
```
Stop-AzMediaLiveEvent -InputObject <IMediaIdentity> [-RemoveOutputsOnStop] [-DefaultProfile <PSObject>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20220801.ILiveEventActionInput
...
### Microsoft.Azure.PowerShell.Cmdlets.Media.Models.Api20220801.ILiveEventActionInput
