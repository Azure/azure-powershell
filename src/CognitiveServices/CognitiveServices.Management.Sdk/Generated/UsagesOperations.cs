...
namespace Microsoft.Azure.Management.CognitiveServices
{
    ...
    /// </summary>
    internal partial class UsagesOperations : IServiceOperations<CognitiveServicesManagementClient>, IUsagesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal UsagesOperations(CognitiveServicesManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<Usage>>> ListWithHttpMessagesAsync(string location, string filter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.CognitiveServices/locations/{location}/usages").ToString();
