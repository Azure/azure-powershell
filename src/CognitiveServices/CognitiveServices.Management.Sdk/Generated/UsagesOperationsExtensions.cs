...
namespace Microsoft.Azure.Management.CognitiveServices
{
    ...
    public static partial class UsagesOperationsExtensions
    {
            ...
            /// multiple names).
            /// </param>
            public static IPage<Usage> List(this IUsagesOperations operations, string location, string filter = default(string))
            {
            ...
            /// </param>
            public static async Task<IPage<Usage>> ListAsync(this IUsagesOperations operations, string location, string filter = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
