...
namespace Microsoft.Azure.Management.CognitiveServices
{
    ...
    public static partial class CommitmentPlansOperationsExtensions
    {
            ...
            /// <param name='sku'>
            /// </param>
            public static CommitmentPlan UpdatePlan(this ICommitmentPlansOperations operations, string resourceGroupName, string commitmentPlanName, IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku))
            {
                return operations.UpdatePlanAsync(resourceGroupName, commitmentPlanName, tags, sku).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<CommitmentPlan> UpdatePlanAsync(this ICommitmentPlansOperations operations, string resourceGroupName, string commitmentPlanName, IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.CreateOrUpdateAssociationAsync(resourceGroupName, commitmentPlanName, commitmentPlanAssociationName, accountId).GetAwaiter().GetResult();
            }
            ...
            /// <param name='sku'>
            /// </param>
            public static CommitmentPlan BeginUpdatePlan(this ICommitmentPlansOperations operations, string resourceGroupName, string commitmentPlanName, IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku))
            {
                return operations.BeginUpdatePlanAsync(resourceGroupName, commitmentPlanName, tags, sku).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<CommitmentPlan> BeginUpdatePlanAsync(this ICommitmentPlansOperations operations, string resourceGroupName, string commitmentPlanName, IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.BeginCreateOrUpdateAssociationAsync(resourceGroupName, commitmentPlanName, commitmentPlanAssociationName, accountId).GetAwaiter().GetResult();
            }
