...
namespace Microsoft.Azure.Management.CognitiveServices
{
    ...
    public static partial class RaiBlocklistItemsOperationsExtensions
    {
        ...
        /// The name of the RaiBlocklist associated with the Cognitive Services Account
        /// </param>
        public static RaiBlocklist BatchAdd(this IRaiBlocklistItemsOperations operations, string resourceGroupName, string accountName, string raiBlocklistName, System.Collections.Generic.IList<RaiBlocklistItemBulkRequest> raiBlocklistItems)
        {
                return ((IRaiBlocklistItemsOperations)operations).BatchAddAsync(resourceGroupName, accountName, raiBlocklistName, raiBlocklistItems).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<RaiBlocklist> BatchAddAsync(this IRaiBlocklistItemsOperations operations, string resourceGroupName, string accountName, string raiBlocklistName, System.Collections.Generic.IList<RaiBlocklistItemBulkRequest> raiBlocklistItems, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.BatchAddWithHttpMessagesAsync(resourceGroupName, accountName, raiBlocklistName, raiBlocklistItems, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
            }
        }
        ...
        /// The name of the RaiBlocklist associated with the Cognitive Services Account
        /// </param>
        public static void BatchDelete(this IRaiBlocklistItemsOperations operations, string resourceGroupName, string accountName, string raiBlocklistName, object raiBlocklistItemsNames)
        {
                ((IRaiBlocklistItemsOperations)operations).BatchDeleteAsync(resourceGroupName, accountName, raiBlocklistName, raiBlocklistItemsNames).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task BatchDeleteAsync(this IRaiBlocklistItemsOperations operations, string resourceGroupName, string accountName, string raiBlocklistName, object raiBlocklistItemsNames, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            (await operations.BatchDeleteWithHttpMessagesAsync(resourceGroupName, accountName, raiBlocklistName, raiBlocklistItemsNames, null, cancellationToken).ConfigureAwait(false)).Dispose();
        }
        /// <summary>
        /// Deletes the specified blocklist Item associated with the custom blocklist.
        /// </summary>
