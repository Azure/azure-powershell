...
namespace Microsoft.Azure.Management.CognitiveServices
{
    ...
    public static partial class PrivateEndpointConnectionsOperationsExtensions
    {
            ...
            {
                return operations.CreateOrUpdateAsync(resourceGroupName, accountName, privateEndpointConnectionName, properties, location).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<PrivateEndpointConnection> CreateOrUpdateAsync(this IPrivateEndpointConnectionsOperations operations, string resourceGroupName, string accountName, string privateEndpointConnectionName, PrivateEndpointConnectionProperties properties = default(PrivateEndpointConnectionProperties), string location = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.BeginCreateOrUpdateAsync(resourceGroupName, accountName, privateEndpointConnectionName, properties, location).GetAwaiter().GetResult();
            }
