...
namespace Microsoft.Azure.Management.CognitiveServices
{
    ...
    public static partial class PrivateEndpointConnectionsOperationsExtensions
    {
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<PrivateEndpointConnectionListResult> ListAsync(this IPrivateEndpointConnectionsOperations operations, string resourceGroupName, string accountName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
                return ((IPrivateEndpointConnectionsOperations)operations).CreateOrUpdateAsync(resourceGroupName, accountName, privateEndpointConnectionName, properties, location).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<PrivateEndpointConnection> CreateOrUpdateAsync(this IPrivateEndpointConnectionsOperations operations, string resourceGroupName, string accountName, string privateEndpointConnectionName, PrivateEndpointConnectionProperties properties = default(PrivateEndpointConnectionProperties), string location = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.CreateOrUpdateWithHttpMessagesAsync(resourceGroupName, accountName, privateEndpointConnectionName, properties, location, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
            }
        }
        ...
        {
                return ((IPrivateEndpointConnectionsOperations)operations).BeginCreateOrUpdateAsync(resourceGroupName, accountName, privateEndpointConnectionName, properties, location).GetAwaiter().GetResult();
        }
        ...
        {
            using (var _result = await operations.BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, accountName, privateEndpointConnectionName, properties, location, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
            }
        }
