...
namespace Microsoft.Azure.Management.CognitiveServices
{
    ...
    internal partial class DeploymentsOperations : Microsoft.Rest.IServiceOperations<CognitiveServicesManagementClient>, IDeploymentsOperations
    {
        ...
        /// The cancellation token.
        /// </param>
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Deployment>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string accountName, string deploymentName, Sku sku = default(Sku), DeploymentProperties properties = default(DeploymentProperties), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<Deployment> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, accountName, deploymentName, sku, properties, customHeaders, cancellationToken).ConfigureAwait(false);
