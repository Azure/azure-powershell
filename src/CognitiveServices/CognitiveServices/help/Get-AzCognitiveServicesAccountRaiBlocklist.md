...
online version: https://docs.microsoft.com/powershell/module/az.cognitiveservices/get-azcognitiveservicesaccountraiblocklist
schema: 2.0.0
---
...
### Example 1
```powershell
PS C:\> Get-AzCognitiveServicesAccountRaiBlocklist -ResourceGroupName "rgname" -AccountName "accountname"
```
