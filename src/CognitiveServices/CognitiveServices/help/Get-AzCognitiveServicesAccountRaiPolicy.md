...
online version: https://docs.microsoft.com/powershell/module/az.cognitiveservices/get-azcognitiveservicesaccountraipolicy
schema: 2.0.0
---
...
### Example 1
```powershell
PS C:\>  Get-AzCognitiveServicesAccountRaiPolicy -ResourceGroupName "rgname" -AccountName "accountname"
```

List Cognitive Services Account Rai Policys.

### Example 2
```powershell
PS C:\>  Get-AzCognitiveServicesAccountRaiPolicy -ResourceGroupName "rgname" -AccountName "accountname" -Name "policyname"
```
