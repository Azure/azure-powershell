...
online version: https://docs.microsoft.com/powershell/module/az.cognitiveservices/remove-azcognitiveservicescommitmentplanassociation
schema: 2.0.0
---
...
```
Remove-AzCognitiveServicesCommitmentPlanAssociation [-ResourceGroupName] <String> [-PlanName] <String>
