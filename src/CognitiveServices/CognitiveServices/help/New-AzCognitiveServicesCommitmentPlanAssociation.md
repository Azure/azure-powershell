...
online version: https://docs.microsoft.com/powershell/module/az.cognitiveservices/new-azcognitiveservicescommitmentplanassociation
schema: 2.0.0
---
...
```
New-AzCognitiveServicesCommitmentPlanAssociation [-ResourceGroupName] <String> [-PlanName] <String>
