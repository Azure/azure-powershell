    ...
    public class NewAzureCognitiveServicesObjectCommand : CognitiveServicesAccountBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (AsList.IsPresent)
            {
                switch (Type)
                {
                    case CognitiveServicesObjectType.CustomBlocklistConfig:
                        {
                            var obj = new List<CustomBlocklistConfig>();
                            WriteObject(obj);
                        }
                        break;
                    default:
            ...
            switch (Type)
            {
                ...
                case CognitiveServicesObjectType.RaiPolicyProperties:
                    {
                        ...
                        obj.CustomBlocklists = new List<CustomBlocklistConfig>();
                ...
                case CognitiveServicesObjectType.CustomBlocklistConfig:
                    {
                        var obj = new CustomBlocklistConfig();
                        WriteObject(obj);
                    }
                    break;
