...
namespace Microsoft.Azure.Commands.Management.CognitiveServices
{
    ...
    /// </summary>
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CognitiveServicesAccountDeployment", DefaultParameterSetName = DefaultParameterSet), OutputType(typeof(Deployment))]
