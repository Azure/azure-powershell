...
{
    /// <summary>
    /// Create a new Cognitive Services Account CommitmentPlan
    /// </summary>
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CognitiveServicesAccountCommitmentPlan", SupportsShouldProcess = true, DefaultParameterSetName = DefaultParameterSet), OutputType(typeof(CommitmentPlan))]
    public class NewAzureCognitiveServicesAccountCommitmentPlanCommand : CognitiveServicesAccountBaseCmdlet
    {
