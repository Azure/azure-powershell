...
namespace Microsoft.Azure.Commands.Management.CognitiveServices
{
    ...
    /// </summary>
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CognitiveServicesAccountRaiBlocklistItem", DefaultParameterSetName = DefaultParameterSet, SupportsShouldProcess = true), OutputType(typeof(bool))]
    public class RemoveAzureCognitiveServicesAccountRaiBlocklistItemCommand : CognitiveServicesAccountBaseCmdlet
    {
                ...
                RunCmdLet(() =>
                {
                    switch (ParameterSetName)
                    {
                        ...
                        case ResourceIdParameterSet:
                            ...
                            Name = resourceId.GetAccountSubSubResourceName();
                            break;
                        case DefaultParameterSet:
                            break;
                    }

                    this.CognitiveServicesClient.RaiBlocklistItems.Delete(ResourceGroupName, AccountName, RaiBlocklistName, Name);
