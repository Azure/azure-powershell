...
{
    /// <summary>
    /// Remove a Cognitive Services Account EncryptionScope
    /// </summary>
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CognitiveServicesAccountEncryptionScope", SupportsShouldProcess = true, DefaultParameterSetName = DefaultParameterSet), OutputType(typeof(EncryptionScope))]
    public class RemoveAzureCognitiveServicesAccountEncryptionScopeCommand : CognitiveServicesAccountBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
               ...
               Force.IsPresent)
            {
                RunCmdLet(() =>
                {
                    ...
                    this.CognitiveServicesClient.EncryptionScopes.Delete(ResourceGroupName, AccountName, Name);
