...
{
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CognitiveServicesAccountNetworkRuleSet"), OutputType(typeof(PSNetworkRuleSet))]
    public class GetAzureCognitiveServicesAccountNetworkRuleSetCommand : CognitiveServicesAccountBaseCmdlet
    {
        [Parameter(
            Position = 0,
            Mandatory = true,
