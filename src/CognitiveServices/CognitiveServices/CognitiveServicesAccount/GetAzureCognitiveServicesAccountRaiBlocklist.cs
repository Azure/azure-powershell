...
namespace Microsoft.Azure.Commands.Management.CognitiveServices
{
    ...
    /// </summary>
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CognitiveServicesAccountRaiBlocklist", DefaultParameterSetName = DefaultParameterSet), OutputType(typeof(RaiBlocklist))]
    public class GetAzureCognitiveServicesAccountRaiBlocklistCommand : CognitiveServicesAccountBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            RunCmdLet(() =>
            {
                ...
                {
                    var getResponse = ListAll(CognitiveServicesClient.RaiBlocklists.List, ResourceGroupName, AccountName, CognitiveServicesClient.RaiBlocklists.ListNext);
                    WriteObject(getResponse);
                }
                else
                {
                    var getResponse = CognitiveServicesClient.RaiBlocklists.Get(ResourceGroupName, AccountName, Name);
                    WriteObject(getResponse);
                }
            });
        }
