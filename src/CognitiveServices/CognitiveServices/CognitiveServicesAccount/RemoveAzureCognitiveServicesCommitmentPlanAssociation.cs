...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CognitiveServicesCommitmentPlanAssociation", SupportsShouldProcess = true), OutputType(typeof(void))]
    public class RemoveAzureCognitiveServicesCommitmentPlanAssociationCommand : CognitiveServicesAccountBaseCmdlet
    {
        [Parameter(
            Position = 0,
            Mandatory = true,
        ...
        public override void ExecuteCmdlet()
        {
              ...
              Force.IsPresent)
            {
                RunCmdLet(() =>
                {
                    this.CognitiveServicesClient.CommitmentPlans.DeleteAssociation(this.ResourceGroupName, this.CommitmentPlanName, Name);
