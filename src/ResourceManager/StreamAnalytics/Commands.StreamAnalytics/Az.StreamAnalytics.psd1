...
Description = 'Microsoft Azure PowerShell - StreamAnalytics service cmdlets for Azure Resource Manager in PowerShell and PowerShell Core'
...
CmdletsToExport = 'Get-AzStreamAnalyticsFunction', 
    ...
    'Get-AzStreamAnalyticsInput', 'New-AzStreamAnalyticsInput', 
