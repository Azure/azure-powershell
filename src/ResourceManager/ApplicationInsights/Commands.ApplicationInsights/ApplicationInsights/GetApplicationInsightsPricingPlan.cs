...
{
    [Cmdlet(VerbsCommon.Get, ApplicationInsightsPricingPlanNounStr), OutputType(typeof(PSPricingTier))]
    public class GetApplicationInsightsPricingPlansCommand : ApplicationInsightsBaseCmdlet
    {
        [Parameter(
            Position = 0,
            Mandatory = true,
        ...
        public override void ExecuteCmdlet()
        {
            ...
            WriteCurrentFeatures(pricingPlanResponse.Body);
        }
    }
}
