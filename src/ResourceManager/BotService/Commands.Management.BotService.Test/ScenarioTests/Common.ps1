...
<#
.SYNOPSIS
Create a Bot Services account
#>
function Test-CreateBot
{
	param([string] $rgname, [string] $botname, [string] $accounttype, [string] $skuname, [string] $loc)
...
<#
.SYNOPSIS
Gets valid resource name for bot service test
#>
function Get-BotServiceTestResourceName
{
