...
namespace Microsoft.Azure.Commands.Management.BotService.Test.ScenarioTests
{
    public class TestController
    {
        ...
        public AzureBotServiceClient AzureBotServiceClient { get; private set; }
            ...
            string mockName)
        {
            ...
            using (RestTestFramework.MockContext context = RestTestFramework.MockContext.Start(callingClassType, mockName))
            {
                ...
                helper.SetupModules(AzureModule.AzureResourceManager,
                    ...
                    helper.GetRMModulePath("AzureRM.BotService.psd1")
                );
        ...
        private void SetupManagementClients(RestTestFramework.MockContext context)
        {
            ...
            AzureBotServiceClient = GetAzureBotServiceManagementClient(context);
        ...
        private SubscriptionClient GetSubscriptionClient(RestTestFramework.MockContext context)
        {
        ...
        private AzureBotServiceClient GetAzureBotServiceManagementClient(RestTestFramework.MockContext context)
        {
            return context.GetServiceClient<AzureBotServiceClient>(RestTestFramework.TestEnvironmentFactory.GetTestEnvironment());
        }
    }
}
