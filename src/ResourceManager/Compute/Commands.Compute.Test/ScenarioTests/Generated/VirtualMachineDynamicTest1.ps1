...
function ps_vm_dynamic_test_func_1_pstestrg2529
{
    # Setup
    $rgname = 'pstestrg2529';
    ...
    try
    {
        ...
        $st = Write-Verbose "Running Test ps_vm_dynamic_test_func_1_pstestrg2529 - Start ${rgname}, ${loc} & ${vmsize}";

        $st = Write-Verbose 'Running Test ps_vm_dynamic_test_func_1_pstestrg2529 - Creating Resource Group';
        ...
        # Virtual Machine
        $st = Write-Verbose 'Running Test ps_vm_dynamic_test_func_1_pstestrg2529 - Creating VM';

        $vmname = 'vm' + $rgname;
        $st = New-AzureVM -ResourceGroupName $rgname -Location $loc -Name $vmname -VM $vmconfig;

        # Get VM
        $st = Write-Verbose 'Running Test ps_vm_dynamic_test_func_1_pstestrg2529 - Getting VM';
        $vm1 = Get-AzureVM -Name $vmname -ResourceGroupName $rgname;

        # Remove
        $st = Write-Verbose 'Running Test ps_vm_dynamic_test_func_1_pstestrg2529 - Removing VM';
        $st = Remove-AzureVM -Name $vmname -ResourceGroupName $rgname -Force;

        $st = Write-Verbose 'Running Test ps_vm_dynamic_test_func_1_pstestrg2529 - End';
    }
    finally
    {
        # Cleanup
