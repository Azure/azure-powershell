...
{
    public class PSVirtualMachineScaleSetIdentity
    {
        ...
        public PSVirtualMachineScaleSetIdentity() { }

        public PSVirtualMachineScaleSetIdentity(VirtualMachineScaleSetIdentity identity)
        {
            if (identity != null)
            {
