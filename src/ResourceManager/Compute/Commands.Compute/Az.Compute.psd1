...
Description = 'Microsoft Azure PowerShell - Compute service cmdlets for Azure Resource Manager in PowerShell and PowerShell Core.  Manages virtual machines, hosted services, and related resources in Azure Resource Manager'
...
CmdletsToExport = 'Remove-AzAvailabilitySet', 'Get-AzAvailabilitySet', 
    ...
    'Remove-AzVMDataDisk', 'Set-AzVMBootDiagnostics', 
    ...
    'Disable-AzVmssDiskEncryption', 'Get-AzVmssDiskEncryption', 
    ...
    'New-AzGallery', 'Update-AzGallery',
    'Get-AzGallery', 'Remove-AzGallery',
