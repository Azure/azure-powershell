...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateVirtualMachineScaleSetVMDeallocateDynamicParameters()
        {
        ...
        protected void ExecuteVirtualMachineScaleSetVMDeallocateMethod(object[] invokeMethodInputParameters)
        {
            string resourceGroupName = (string)ParseParameter(invokeMethodInputParameters[0]);
            string vmScaleSetName = (string)ParseParameter(invokeMethodInputParameters[1]);
            string instanceId = (string)ParseParameter(invokeMethodInputParameters[2]);

            var result = VirtualMachineScaleSetVMsClient.Deallocate(resourceGroupName, vmScaleSetName, instanceId);
            WriteObject(result);
        }
    }
    ...
    {
        protected PSArgument[] CreateVirtualMachineScaleSetVMDeallocateParameters()
        {
