...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateVirtualMachineScaleSetVMGetInstanceViewDynamicParameters()
        {
        ...
        protected void ExecuteVirtualMachineScaleSetVMGetInstanceViewMethod(object[] invokeMethodInputParameters)
        {
    ...
    {
        protected PSArgument[] CreateVirtualMachineScaleSetVMGetInstanceViewParameters()
        {
