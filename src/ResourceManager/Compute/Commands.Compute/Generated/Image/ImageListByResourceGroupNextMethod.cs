...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateImageListByResourceGroupNextDynamicParameters()
        {
        ...
        protected void ExecuteImageListByResourceGroupNextMethod(object[] invokeMethodInputParameters)
        {
            string nextPageLink = (string)ParseParameter(invokeMethodInputParameters[0]);

            var result = ImagesClient.ListByResourceGroupNext(nextPageLink);
            WriteObject(result);
        }
    }
    ...
    {
        protected PSArgument[] CreateImageListByResourceGroupNextParameters()
        {
