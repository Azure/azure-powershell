...
{
    [Cmdlet("Set", "AzureRmSnapshotDiskEncryptionKey")]
    [OutputType(typeof(Snapshot))]
    public class SetAzureRmSnapshotDiskEncryptionKeyCommand : Microsoft.Azure.Commands.ResourceManager.Common.AzureRMCmdlet
    {
        [Parameter(
            Mandatory = true,
            Position = 0,
