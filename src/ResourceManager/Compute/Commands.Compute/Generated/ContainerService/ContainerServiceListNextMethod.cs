...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateContainerServiceListNextDynamicParameters()
        {
        ...
        protected void ExecuteContainerServiceListNextMethod(object[] invokeMethodInputParameters)
        {
            string nextPageLink = (string)ParseParameter(invokeMethodInputParameters[0]);

            var result = ContainerServicesClient.ListNext(nextPageLink);
            WriteObject(result);
        }
    }
    ...
    {
        protected PSArgument[] CreateContainerServiceListNextParameters()
        {
