...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateContainerServiceListByResourceGroupNextDynamicParameters()
        {
    ...
    {
        protected PSArgument[] CreateContainerServiceListByResourceGroupNextParameters()
        {
