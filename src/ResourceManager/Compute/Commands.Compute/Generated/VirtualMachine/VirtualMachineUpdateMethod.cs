...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    public partial class InvokeAzureComputeMethodCmdlet : ComputeAutomationBaseCmdlet
    {
        protected object CreateVirtualMachineUpdateDynamicParameters()
        {
            ...
            pParameters.Name = "VirtualMachineUpdate";
            pParameters.ParameterType = typeof(VirtualMachineUpdate);
            ...
            dynamicParameters.Add("VirtualMachineUpdate", pParameters);
        ...
        protected void ExecuteVirtualMachineUpdateMethod(object[] invokeMethodInputParameters)
        {
            ...
            VirtualMachineUpdate parameters = (VirtualMachineUpdate)ParseParameter(invokeMethodInputParameters[2]);

            var result = VirtualMachinesClient.Update(resourceGroupName, vmName, parameters);
            WriteObject(result);
        }
    }
