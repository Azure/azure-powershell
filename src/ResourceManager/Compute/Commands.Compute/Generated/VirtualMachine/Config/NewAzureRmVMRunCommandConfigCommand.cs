...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    public partial class NewAzureRmVMRunCommandConfigCommand : Microsoft.Azure.Commands.ResourceManager.Common.AzureRMCmdlet
    {
        ...
        [Parameter(
            ...
            Position = 2,
            ValueFromPipelineByPropertyName = true)]
        public RunCommandInputParameter[] Parameter { get; set; }

        protected override void ProcessRecord()
        {
            if (ShouldProcess("RunCommandInput", "New"))
            {
                Run();
            }
        }
        ...
        private void Run()
        {
            ...
            var vRunCommandInput = new PSRunCommandInput
            {
