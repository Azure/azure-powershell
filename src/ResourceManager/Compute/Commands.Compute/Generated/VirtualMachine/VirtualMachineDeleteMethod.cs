...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    public partial class InvokeAzureComputeMethodCmdlet : ComputeAutomationBaseCmdlet
    {
        ...
        protected void ExecuteVirtualMachineDeleteMethod(object[] invokeMethodInputParameters)
        {
            ...
            var result = VirtualMachinesClient.Delete(resourceGroupName, vmName);
            WriteObject(result);
        }
    }
    ...
    [Cmdlet(VerbsCommon.Remove, "AzureRmVM", DefaultParameterSetName = "InvokeByDynamicParameters", SupportsShouldProcess = true)]
    public partial class RemoveAzureRmVM : InvokeAzureComputeMethodCmdlet
    {
        public override string MethodName { get; set; }

        protected override void ProcessRecord()
        {
            this.MethodName = "VirtualMachineDelete";
