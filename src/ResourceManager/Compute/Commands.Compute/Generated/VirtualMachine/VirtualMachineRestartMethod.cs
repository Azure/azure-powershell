...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    [Cmdlet(VerbsLifecycle.Restart, "AzureRmVM", DefaultParameterSetName = "InvokeByDynamicParameters")]
    public partial class RestartAzureRmVM : InvokeAzureComputeMethodCmdlet
    {
        public override string MethodName { get; set; }

        protected override void ProcessRecord()
        {
            this.MethodName = "VirtualMachineRestart";
            base.ProcessRecord();
        }
