...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateVirtualMachineScaleSetGetOSUpgradeHistoryDynamicParameters()
        {
        ...
        protected void ExecuteVirtualMachineScaleSetGetOSUpgradeHistoryMethod(object[] invokeMethodInputParameters)
        {
    ...
    {
        protected PSArgument[] CreateVirtualMachineScaleSetGetOSUpgradeHistoryParameters()
        {
