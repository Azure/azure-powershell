...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateVirtualMachineScaleSetPowerOffDynamicParameters()
        {
        ...
        protected void ExecuteVirtualMachineScaleSetPowerOffMethod(object[] invokeMethodInputParameters)
        {
            ...
            VirtualMachineScaleSetsClient.PowerOff(resourceGroupName, vmScaleSetName, instanceIds);
        }
    }

    public partial class NewAzureComputeArgumentListCmdlet : ComputeAutomationBaseCmdlet
    {
        protected PSArgument[] CreateVirtualMachineScaleSetPowerOffParameters()
        {
