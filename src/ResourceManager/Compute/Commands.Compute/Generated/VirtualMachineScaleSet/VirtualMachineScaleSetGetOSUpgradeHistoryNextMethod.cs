...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateVirtualMachineScaleSetGetOSUpgradeHistoryNextDynamicParameters()
        {
        ...
        protected void ExecuteVirtualMachineScaleSetGetOSUpgradeHistoryNextMethod(object[] invokeMethodInputParameters)
        {
            string nextPageLink = (string)ParseParameter(invokeMethodInputParameters[0]);

            var result = VirtualMachineScaleSetsClient.GetOSUpgradeHistoryNext(nextPageLink);
            WriteObject(result);
        }
    }
    ...
    {
        protected PSArgument[] CreateVirtualMachineScaleSetGetOSUpgradeHistoryNextParameters()
        {
