...
{
    [Cmdlet(VerbsCommon.Remove, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "Vmss", DefaultParameterSetName = "DefaultParameter", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzureRmVmss : ComputeAutomationBaseCmdlet
    {
        ...
        [Parameter(
            ...
            Mandatory = true,
            ValueFromPipelineByPropertyName = true)]
        [ResourceManager.Common.ArgumentCompleters.ResourceNameCompleter("Microsoft.Compute/virtualMachineScaleSets", new string[] { "ResourceGroupName" })]
        [Alias("Name")]
