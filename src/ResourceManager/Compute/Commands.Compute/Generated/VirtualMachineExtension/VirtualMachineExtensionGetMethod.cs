...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateVirtualMachineExtensionGetDynamicParameters()
        {
    ...
    {
        protected PSArgument[] CreateVirtualMachineExtensionGetParameters()
        {
            ...
            return ConvertFromObjectsToArguments(
                 new string[] { "ResourceGroupName", "VMName", "VMExtensionName", "Expand" },
                 new object[] { resourceGroupName, vmName, vmExtensionName, expand });
        }
    }
}
