...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    [Cmdlet(VerbsCommon.Remove, "AzureRmAvailabilitySet", DefaultParameterSetName = "InvokeByDynamicParameters", SupportsShouldProcess = true)]
    public partial class RemoveAzureRmAvailabilitySet : InvokeAzureComputeMethodCmdlet
    {
        public override string MethodName { get; set; }

        protected override void ProcessRecord()
        {
            this.MethodName = "AvailabilitySetDelete";
            if (ShouldProcess(this.dynamicParameters["ResourceGroupName"].Value.ToString(), VerbsCommon.Remove)
                && (this.dynamicParameters["Force"].IsSet ||
                    this.ShouldContinue(Properties.Resources.ResourceRemovalConfirmation,
                                        "Remove-AzureRmAvailabilitySet operation")))
            {
                base.ProcessRecord();
            }
        }
        ...
        public override object GetDynamicParameters()
        {
            ...
            pAvailabilitySetName.Attributes.Add(new AliasAttribute("Name"));
            pAvailabilitySetName.Attributes.Add(new AllowNullAttribute());
            dynamicParameters.Add("AvailabilitySetName", pAvailabilitySetName);
