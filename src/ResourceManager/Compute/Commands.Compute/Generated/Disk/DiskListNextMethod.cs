...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateDiskListNextDynamicParameters()
        {
        ...
        protected void ExecuteDiskListNextMethod(object[] invokeMethodInputParameters)
        {
            string nextPageLink = (string)ParseParameter(invokeMethodInputParameters[0]);

            var result = DisksClient.ListNext(nextPageLink);
            WriteObject(result);
        }
    }
    ...
    {
        protected PSArgument[] CreateDiskListNextParameters()
        {
