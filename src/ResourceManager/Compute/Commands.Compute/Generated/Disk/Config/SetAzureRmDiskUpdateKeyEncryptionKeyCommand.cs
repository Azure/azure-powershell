...
{
    [Cmdlet("Set", "AzureRmDiskUpdateKeyEncryptionKey")]
    [OutputType(typeof(DiskUpdate))]
    public class SetAzureRmDiskUpdateKeyEncryptionKeyCommand : Microsoft.Azure.Commands.ResourceManager.Common.AzureRMCmdlet
    {
        [Parameter(
            Mandatory = true,
            Position = 0,
