...
```
Get-AzureRmVmssDiskEncryptionStatus [[-ResourceGroupName] <String>] [[-VMScaleSetName] <String>]
...
### Example 1
```
PS C:\> Get-AzureRmVmssDiskEncryptionStatus -ResourceGroupName "Group001" -VMScaleSetName "VMSS001"
```
