...
Set-AzureRmVMOSDisk [-VM] <PSVirtualMachine> [[-Name] <String>] [[-VhdUri] <String>]
 ...
 [-ManagedDiskId <String>] [-StorageAccountType <PSStorageAccountTypes>] [-WriteAccelerator]
...
Set-AzureRmVMOSDisk [-VM] <PSVirtualMachine> [[-Name] <String>] [[-VhdUri] <String>]
 ...
 [-DiskSizeInGB <Int32>] [-ManagedDiskId <String>] [-StorageAccountType <PSStorageAccountTypes>]
...
Set-AzureRmVMOSDisk [-VM] <PSVirtualMachine> [[-Name] <String>] [[-VhdUri] <String>]
 ...
 [-StorageAccountType <PSStorageAccountTypes>] [-WriteAccelerator] [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```
