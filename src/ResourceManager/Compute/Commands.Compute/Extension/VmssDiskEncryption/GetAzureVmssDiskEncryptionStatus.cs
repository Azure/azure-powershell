...
{
    [Cmdlet("Get","VmssDiskEncryption"),OutputType(typeof(PSVmssDiskEncryptionStatusContext))]
#if NETSTANDARD
    [Alias(ProfileNouns.GetAzureRmVmssDiskEncryptionAlias, "Get-AzureRmVmssDiskEncryption")]
#else
