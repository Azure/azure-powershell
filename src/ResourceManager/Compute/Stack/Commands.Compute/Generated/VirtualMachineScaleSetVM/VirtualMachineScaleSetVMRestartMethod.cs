...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateVirtualMachineScaleSetVMRestartDynamicParameters()
        {
        ...
        protected void ExecuteVirtualMachineScaleSetVMRestartMethod(object[] invokeMethodInputParameters)
        {
    ...
    {
        protected PSArgument[] CreateVirtualMachineScaleSetVMRestartParameters()
        {
