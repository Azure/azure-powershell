...
----                                            ------- ----------
Add-AzureRmVmssAdditionalUnattendContent        2.2.0   AzureRM.Compute
Add-AzureRmVmssDiagnosticsExtension             2.2.0   AzureRM.Compute
Add-AzureRmVmssExtension                        2.2.0   AzureRM.Compute
Add-AzureRmVMSshPublicKey                       2.2.0   AzureRM.Compute
Add-AzureRmVmssNetworkInterfaceConfiguration    2.2.0   AzureRM.Compute
Add-AzureRmVmssSecret                           2.2.0   AzureRM.Compute
Add-AzureRmVmssSshPublicKey                     2.2.0   AzureRM.Compute
Add-AzureRmVmssWinRMListener                    2.2.0   AzureRM.Compute
Get-AzureRmVmss                                 2.2.0   AzureRM.Compute
Get-AzureRmVmssSku                              2.2.0   AzureRM.Compute
Get-AzureRmVmssVM                               2.2.0   AzureRM.Compute
New-AzureRmVmss                                 2.2.0   AzureRM.Compute
New-AzureRmVmssConfig                           2.2.0   AzureRM.Compute
New-AzureRmVmssIpConfig                         2.2.0   AzureRM.Compute
New-AzureRmVmssVaultCertificateConfig           2.2.0   AzureRM.Compute
Remove-AzureRmVmss                              2.2.0   AzureRM.Compute
Remove-AzureRmVmssDiagnosticsExtension          2.2.0   AzureRM.Compute
Remove-AzureRmVmssExtension                     2.2.0   AzureRM.Compute
Remove-AzureRmVmssNetworkInterfaceConfiguration 2.2.0   AzureRM.Compute
Restart-AzureRmVmss                             2.2.0   AzureRM.Compute
Set-AzureRmVmss                                 2.2.0   AzureRM.Compute
Set-AzureRmVmssOsProfile                        2.2.0   AzureRM.Compute
Set-AzureRmVmssStorageProfile                   2.2.0   AzureRM.Compute
Set-AzureRmVmssVM                               2.2.0   AzureRM.Compute
Start-AzureRmVmss                               2.2.0   AzureRM.Compute
Stop-AzureRmVmss                                2.2.0   AzureRM.Compute
Update-AzureRmVmss                              2.2.0   AzureRM.Compute
Update-AzureRmVmssInstance                      2.2.0   AzureRM.Compute
#>
...
function Test-VirtualMachineScaleSet
{
    ...
    try
    {
        ...
        $vmss = New-AzureRmVmssConfig -Location $loc -SkuCapacity 2 -SkuName 'Standard_A0' -UpgradePolicyMode 'automatic' -NetworkInterfaceConfiguration $netCfg `
            ...
            | Add-AzureRmVmssExtension -Name $extname -Publisher $publisher -VirtualMachineScaleSetExtensionType $exttype -TypeHandlerVersion $extver -AutoUpgradeMinorVersion $true `
...
function Test-VirtualMachineScaleSetReimageUpdate
{
    ...
    try
    {
        ...
        Assert-AreEqual $exttype $result.VirtualMachineProfile.ExtensionProfile.Extensions[0].VirtualMachineScaleSetExtensionType;
