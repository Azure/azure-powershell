...
namespace Microsoft.Azure.Commands.MachineLearning
{
    ...
    [Cmdlet(VerbsCommon.Remove, CommitmentPlansCmdletBase.CommitmentPlanCommandletSuffix, SupportsShouldProcess = true, DefaultParameterSetName = RemoveByNameGroupParameterSet)]
