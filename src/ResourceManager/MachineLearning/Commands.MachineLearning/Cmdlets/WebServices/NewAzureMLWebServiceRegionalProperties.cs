...
namespace Microsoft.Azure.Commands.MachineLearning.Cmdlets
{
    [Cmdlet(
        VerbsCommon.New,
        "AzureRmMlWebServiceRegionalProperties",
        SupportsShouldProcess = true)]
    [OutputType(typeof(void))]
    public class NewAzureMLWebServiceRegionalProperties : WebServicesCmdletBase
    {
        [Parameter(
            Mandatory = true,
        ...
        {
            if (ShouldProcess(this.Name, @"Creating the new web service properties for the specific region.."))
            {
