...
For more information on Machine Learning, please visit the following: https://docs.microsoft.com/en-us/azure/machine-learning/'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'General availability for Az.MachineLearning module.'
