...
{
    public class SearchManagementClientWrapper
    {
        public ISearchManagementClient SearchManagementClient { get; set; }
        public Action<string> VerboseLogger { get; set; }
        public Action<string> ErrorLogger { get; set; }

        public SearchManagementClientWrapper(IAzureContext context)
