...
Description = 'Microsoft Azure PowerShell - Azure Search management cmdlets for PowerShell and PowerShell Core'
...
CmdletsToExport = 'New-AzSearchService', 'Get-AzSearchService', 
               'Set-AzSearchService', 'Remove-AzSearchService', 
               'Get-AzSearchAdminKeyPair', 'New-AzSearchAdminKey', 
               'Get-AzSearchQueryKey', 'New-AzSearchQueryKey', 
