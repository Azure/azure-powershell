...
{
    [Cmdlet("Set","DataLakeStoreTrustedIdProvider", SupportsShouldProcess = true), OutputType(typeof(DataLakeStoreTrustedIdProvider))]
#if NETSTANDARD
    [Alias("Set-AdlStoreTrustedIdProvider", "Set-AzureRmDataLakeStoreTrustedIdProvider")]
#else
