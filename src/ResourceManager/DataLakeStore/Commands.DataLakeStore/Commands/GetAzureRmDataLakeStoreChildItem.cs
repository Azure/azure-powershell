...
namespace Microsoft.Azure.Commands.DataLakeStore
{
    ...
    public class GetAzureDataLakeStoreChildItem : DataLakeStoreFileSystemCmdletBase
    {
        ...
        [Parameter(ValueFromPipelineByPropertyName = true, Position = 0, Mandatory = true, HelpMessage = "The path in the specified dataLake account that should be retrieve. Can be a file or folder " +
