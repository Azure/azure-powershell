...
namespace Microsoft.Azure.Commands.DataLakeStore
{
    ...
    public class GetAzureDataLakeStoreContent : DataLakeStoreFileSystemCmdletBase
    {
        ...
        [Parameter(ValueFromPipelineByPropertyName = true, Position = 1, Mandatory = true, HelpMessage = "The path in the specified dataLake account that should be read from. Can only be a file " +
