...
namespace Microsoft.Azure.Commands.DataLakeStore
{
    ...
    public class SetAzureDataLakeStoreItemPermissions : DataLakeStoreFileSystemCmdletBase
    {
        ...
        [Parameter(ValueFromPipelineByPropertyName = true, Position = 1, Mandatory = true, HelpMessage = "The path in the specified dataLake account that should have its permissions set. Can be a file or folder " +
