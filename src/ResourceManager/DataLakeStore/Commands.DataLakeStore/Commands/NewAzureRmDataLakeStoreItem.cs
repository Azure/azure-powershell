...
namespace Microsoft.Azure.Commands.DataLakeStore
{
    ...
    public class NewAzureDataLakeStoreItem : DataLakeStoreFileSystemCmdletBase
    {
        ...
        [Parameter(ValueFromPipelineByPropertyName = true, Position = 1, Mandatory = true, HelpMessage = "The path in the specified dataLake account where the action should take place. " +
