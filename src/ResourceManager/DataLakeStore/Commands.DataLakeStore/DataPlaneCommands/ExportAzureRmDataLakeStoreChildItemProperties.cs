...
{
    [Cmdlet(VerbsData.Export, "AzureRmDataLakeStoreChildItemProperties", SupportsShouldProcess = true, DefaultParameterSetName = BaseParameterSetName), OutputType(typeof(bool))]
