...
For more information on Data Lake Store, please visit the following: https://docs.microsoft.com/en-us/azure/data-lake-store/'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'General availability for Az.DataLakeStore module.'
