...
function Test-DataLakeStoreFileSystemPermissions
{
	...
	Assert-Throws {Remove-AzureRmDataLakeStoreItemAcl -Account $accountName -Path "/" -Confirm:$false }
	Assert-Throws {Remove-AzureRmDataLakeStoreItemAcl -Account $accountName -Path "/" -Confirm:$false -Default }
