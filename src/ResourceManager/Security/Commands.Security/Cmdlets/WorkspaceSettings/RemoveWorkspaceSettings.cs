...
{
    [Cmdlet(VerbsCommon.Remove, "AzureRmSecurityWorkspaceSetting", DefaultParameterSetName = ParameterSetNames.SubscriptionLevelResource, SupportsShouldProcess = true), OutputType(typeof(bool))]
