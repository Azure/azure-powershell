...
{
    [Cmdlet(VerbsCommon.Get, "AzureRmDiscoveredSecuritySolution", DefaultParameterSetName = ParameterSetNames.SubscriptionScope), OutputType(typeof(PSSecurityDiscoveredSecuritySolution))]
