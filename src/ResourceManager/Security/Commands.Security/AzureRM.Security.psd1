#
# Module manifest for module 'PSGet_AzureRM.Security'
#
...
Description = 'Microsoft Azure PowerShell - Azure Security Center cmdlets. Allows managing and monitoring the security posture of your resources.'
