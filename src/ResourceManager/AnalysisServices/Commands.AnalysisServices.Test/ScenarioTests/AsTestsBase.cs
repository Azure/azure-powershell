    ...
    public class AsTestsBase : RMTestBase
    {
            ...
            string mockName)
        {
            ...
            using (MockContext context = MockContext.Start(callingClassType, mockName))
            {
                ...
                helper.RMProfileModule, helper.RMResourceModule, helper.GetRMModulePath(@"AzureRM.AnalysisServices.psd1"), helper.GetRMModulePath(@"AzureRM.AnalysisServices.Dataplane.psd1"), "AzureRM.Resources.ps1");
