...
namespace Microsoft.Azure.Commands.AnalysisServices.Test.ScenarioTests
{
    public class AsTestsBase : RMTestBase
    {
        ...
        public static AsTestsBase NewInstance
        {
            get
            {
                return new AsTestsBase();
            }
        }
            ...
            string mockName)
        {
            ...
            using (MockContext context = MockContext.Start(callingClassType, mockName))
            {
                ...
                helper.RMProfileModule, helper.RMResourceModule, helper.GetRMModulePath(@"AzureRM.AnalysisServices.psd1"), helper.GetRMModulePath(@"AzureRM.AnalysisServices.ServiceManagement.psd1"), "AzureRM.Resources.ps1");
