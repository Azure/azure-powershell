...
namespace Microsoft.Azure.Commands.SiteRecovery
{
    ...
    [ObsoleteAttribute("'Resume-AzureRmSiteRecoveryJob' cmdlet is mark as obsolete and will be " +
        "depricated in upcoming breaking changes build. Please use the New cmdlet " +
        "'Resume-AzureRmRecoveryServicesAsrJob' module 'AzureRM.RecoveryServices.SiteRecovery'.",
        false)]
