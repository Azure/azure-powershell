...
namespace Microsoft.Azure.Commands.SiteRecovery
{
    ...
    [ObsoleteAttribute("'New-AzureRmSiteRecoveryProtectionContainerMapping' cmdlet is mark as " +
        "obsolete and will be depricated in upcoming breaking changes build. Please use the " +
        "New cmdlet 'New-AzureRmRecoveryServicesAsrProtectionContainerMapping' module 'AzureRM.RecoveryServices.SiteRecovery'.",
        false)]
