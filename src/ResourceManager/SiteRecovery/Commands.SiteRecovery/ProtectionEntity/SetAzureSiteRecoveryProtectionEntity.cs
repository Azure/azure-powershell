...
namespace Microsoft.Azure.Commands.SiteRecovery
{
    ...
    [ObsoleteAttribute("'Set-AzureRmSiteRecoveryProtectionEntity' cmdlet is mark as obsolete and " +
        "will be depricated in upcoming breaking changes build. Please use the New cmdlet " +
        "'Set-AzureRmRecoveryServicesAsrReplicationProtectedItem' module 'AzureRM.RecoveryServices.SiteRecovery'.",
        false)]
