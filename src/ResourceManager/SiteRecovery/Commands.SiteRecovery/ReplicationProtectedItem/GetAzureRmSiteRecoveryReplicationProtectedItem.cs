...
namespace Microsoft.Azure.Commands.SiteRecovery
{
    ...
    [ObsoleteAttribute("'Get-AzureRmSiteRecoveryReplicationProtectedItem' cmdlet is mark as " +
        "obsolete and will be depricated in upcoming breaking changes build. Please use the " +
        "New cmdlet 'Get-AzureRmRecoveryServicesAsrReplicationProtectedItem' module 'AzureRM.RecoveryServices.SiteRecovery'.",
        false)]
