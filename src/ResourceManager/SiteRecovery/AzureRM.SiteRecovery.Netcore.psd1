#
# Module manifest for module 'AzureRM.SiteRecovery'
#
...
GUID = 'f3af8d43-6d2c-4aea-b287-99968275144e'
...
Description = '[PowerShell .Net Core] Microsoft Azure PowerShell - SiteRecovery service cmdlets for Azure Resource Manager'
...
NestedModules = @('.\Microsoft.Azure.Commands.SiteRecovery.dll')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = @()

# Cmdlets to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no cmdlets to export.
CmdletsToExport = 'Get-AzureRmSiteRecoveryFabric', 'New-AzureRmSiteRecoveryFabric', 
    'Remove-AzureRmSiteRecoveryFabric', 'Stop-AzureRmSiteRecoveryJob', 
    'Get-AzureRmSiteRecoveryNetworkMapping', 
    'Get-AzureRmSiteRecoveryNetwork', 'Update-AzureRmSiteRecoveryPolicy', 
    ...
    'Get-AzureRmSiteRecoverySite', 'New-AzureRmSiteRecoverySite', 
    'Remove-AzureRmSiteRecoverySite', 'Get-AzureRmSiteRecoveryJob', 
    'Restart-AzureRmSiteRecoveryJob', 'Resume-AzureRmSiteRecoveryJob', 
    'Get-AzureRmSiteRecoveryProtectionEntity', 
    'Set-AzureRmSiteRecoveryProtectionEntity', 
    'Remove-AzureRmSiteRecoveryPolicy', 'New-AzureRmSiteRecoveryPolicy', 
    ...
    'New-AzureRmSiteRecoveryVault', 'Get-AzureRmSiteRecoveryVM', 
