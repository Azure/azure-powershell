#
# Module manifest for module 'PSGet_AzureRM.SiteRecovery'
#
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Add deprecation warnings for all cmdlets in this module in preparation for the next breaking change release.
