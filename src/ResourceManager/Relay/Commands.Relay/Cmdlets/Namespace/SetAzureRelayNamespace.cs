...
namespace Microsoft.Azure.Commands.Relay.Commands.Namespace
{
    ...
    public class SetAzureRelayNamespace : AzureRelayCmdletBase
    {
        ...
        [ValidateNotNullOrEmpty]
        public RelayNamespaceAttirbutesUpdateParameter RelayNamespaceObj { get; set; }

        public override void ExecuteCmdlet()
        {
            RelayNamespaceAttirbutesUpdateParameter relayNamespace = new RelayNamespaceAttirbutesUpdateParameter();
            
            if (RelayNamespaceObj != null)
            {
                relayNamespace = RelayNamespaceObj;
            }
            else
            {
            ...
            {
                WriteObject(Client.UpdateNamespace(ResourceGroupName, NamespaceName, relayNamespace));
            }
        }
    }
}
