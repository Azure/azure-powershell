...
namespace Microsoft.Azure.Commands.Relay.Commands.HybridConnections
{
    ...
    public class RemoveAzureRelayHybridConnections : AzureRelayCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(target: HybridConnectionsName, action:string.Format("Deleting HybridConnections: {0} of NnameSpace{1}", HybridConnectionsName, NamespaceName)))
            {
                WriteObject(Client.DeleteHybridConnections(ResourceGroupName, NamespaceName, HybridConnectionsName));
            }            
        }
    }
}
