...
{
    /// <summary>
    /// 'Get-AzureRmHybridConnectionsAuthorizationRule' Cmdlet gives the details of a / List of AuthorizationRule(s)
    ...
    public class GetAzureRmRelayHybridConnectionAuthorizationRule : AzureRelayCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            {
                // Get a HybridConnections AuthorizationRule
                AuthorizationRuleAttributes authRule = Client.GetHybridConnectionsAuthorizationRules(ResourceGroupName, NamespaceName, HybridConnectionsName, AuthorizationRuleName);
                WriteObject(authRule);
            }
            else
            {
                // Get all HybridConnections AuthorizationRules
                IEnumerable<AuthorizationRuleAttributes> authRuleList = Client.ListHybridConnectionsAuthorizationRules(ResourceGroupName, NamespaceName, HybridConnectionsName);
