...
{
    /// <summary>
    /// 'Set-AzureRmRelayHybridConnections' Cmdlet updates the specified WcfRelay
    /// </summary>
    [Cmdlet(VerbsCommon.Set, RelayHybridConnectionsVerb, SupportsShouldProcess = true), OutputType(typeof(WcfRelayAttributes))]
