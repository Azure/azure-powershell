...
namespace Microsoft.Azure.Commands.Relay.Commands.WcfRelay
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, RelayWcfRelayVerb, SupportsShouldProcess = true, DefaultParameterSetName = WcfRelayPropertiesParameterSet), OutputType(typeof(WcfRelayAttributes))]
