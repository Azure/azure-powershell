...
{
    /// <summary>
    /// 'New-AzureRmWcfRelayAuthorizationRule' Cmdlet creates a new AuthorizationRule
    /// </summary>
    [Cmdlet(VerbsCommon.New, RelayWcfRelayAuthorizationRuleVerb, SupportsShouldProcess = true), OutputType(typeof(AuthorizationRuleAttributes))]
    public class NewAzureWcfRelayAuthorizationRule : AzureRelayCmdletBase
    {
        ...
        {            
            ...
            if (ShouldProcess(target: sasRule.Name, action: string.Format("Creating new AuthorizationRule named:{0} for WcfRelay: {1}", AuthorizationRuleName, WcfRelayName)))
            {
