...
namespace Microsoft.Azure.Commands.Relay
{
    public class RelayClient
    {
        ...
        public AuthorizationRuleKeysAttributes SetRegenerateKeys(string resourceGroupName, string namespaceName, string authRuleName, string regenerateKeys)
        {
        ...
        public AuthorizationRuleKeysAttributes SetRegenerateKeys(string resourceGroupName, string namespaceName, string wcfRelayName, string authRuleName, string regenerateKeys)
        {
            AuthorizationRuleKeys regenerateKeyslistKeys;
            if (regenerateKeys == "PrimaryKey")
        ...
        public AuthorizationRuleKeysAttributes SethybridConnectionsRegenerateKeys(string resourceGroupName, string namespaceName, string hybridConnectionsName, string authRuleName, string regenerateKeys)
        {
            AuthorizationRuleKeys regenerateKeyslistKeys;
            if (regenerateKeys == "PrimaryKey")
