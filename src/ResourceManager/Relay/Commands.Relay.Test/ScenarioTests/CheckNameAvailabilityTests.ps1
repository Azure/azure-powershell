...
function CheckNameAvailabilityTests 
{
	...
	$ResultCheckNameAvailability = Get-AzureRmCheckNameAvailability -NamespaceName $namespaceName
	...
	$ReCheckNameAvailability = Get-AzureRmCheckNameAvailability -NamespaceName $namespaceName
