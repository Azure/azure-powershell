...
{
    [Cmdlet(VerbsCommon.Remove, CmdletNoun.AzureRmServiceFabricSetting, SupportsShouldProcess = true, DefaultParameterSetName = OneSetting), OutputType(typeof(PSCluster))]
