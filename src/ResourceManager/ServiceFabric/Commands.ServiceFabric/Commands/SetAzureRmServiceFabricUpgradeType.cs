...
{
    [Cmdlet(VerbsCommon.Set, CmdletNoun.AzureRmServiceFabricUpgradeType, SupportsShouldProcess = true, DefaultParameterSetName = AutomaticSet), OutputType(typeof(PSCluster))]
