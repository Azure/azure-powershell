...
{
    [Cmdlet(VerbsCommon.Add, CmdletNoun.AzureRmServiceFabricApplicationCertificate, SupportsShouldProcess = true, DefaultParameterSetName = ByExistingKeyVault), OutputType(typeof(PSKeyVault))]
