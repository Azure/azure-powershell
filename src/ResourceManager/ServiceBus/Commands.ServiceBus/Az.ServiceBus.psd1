...
CmdletsToExport = 'New-ServiceBusNamespace', 'Get-ServiceBusNamespace', 
               'Set-ServiceBusNamespace', 'Remove-ServiceBusNamespace', 
               'New-ServiceBusQueue', 'Get-ServiceBusQueue', 'Set-ServiceBusQueue', 
               'Remove-ServiceBusQueue', 'New-ServiceBusTopic', 
               'Get-ServiceBusTopic', 'Set-ServiceBusTopic', 
               'Remove-ServiceBusTopic', 'New-ServiceBusSubscription', 
               'Get-ServiceBusSubscription', 'Set-ServiceBusSubscription', 
               'Remove-ServiceBusSubscription', 'New-ServiceBusAuthorizationRule', 
               'Get-ServiceBusAuthorizationRule', 
               'Set-ServiceBusAuthorizationRule', 
               'Remove-ServiceBusAuthorizationRule', 'New-ServiceBusKey', 
               'Get-ServiceBusKey', 'Get-ServiceBusOperation', 'New-ServiceBusRule', 
               'Get-ServiceBusRule', 'Set-ServiceBusRule', 'Remove-ServiceBusRule', 
               ...
               'Set-ServiceBusGeoDRConfigurationFailOver', 'Test-ServiceBusName', 
               'Get-ServiceBusMigration', 'Stop-ServiceBusMigration', 
               'Start-ServiceBusMigration', 'Complete-ServiceBusMigration', 
...
AliasesToExport = 'New-AzureRmServiceBusNamespace', 'Get-AzureRmServiceBusNamespace', 
