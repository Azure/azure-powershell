...
namespace Microsoft.Azure.Commands.ServiceBus.Commands.Migration
{
    ...
    /// </summary>
    [Cmdlet("Complete", ServicebusMigrationConfigurationVerb, DefaultParameterSetName = MigrationConfigurationParameterSet, SupportsShouldProcess = true), OutputType(typeof(bool))]
