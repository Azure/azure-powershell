#
# Module manifest for module 'AzureRM.RedisCache'
#
...
Description = 'Microsoft Azure PowerShell - RedisCache service cmdlets for Azure Resource Manager in PowerShell and PowerShell Core'
