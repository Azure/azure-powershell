...
For more information on Redis Cache, please visit the following: RedisCache: https://docs.microsoft.com/en-us/azure/azure-cache-for-redis/'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'General availability for Az.RedisCache module.'
