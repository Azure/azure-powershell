...
Description = '[PowerShell .Net Core] Microsoft Azure PowerShell - RedisCache service cmdlets for Azure Resource Manager'
...
NestedModules = @('.\Microsoft.Azure.Commands.RedisCache.dll')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = @()

# Cmdlets to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no cmdlets to export.
CmdletsToExport = 'Remove-RedisCachePatchSchedule', 'New-RedisCacheScheduleEntry', 
               'Get-RedisCachePatchSchedule', 'New-RedisCachePatchSchedule', 
               'Reset-RedisCache', 'Export-RedisCache', 'Import-RedisCache', 
               'Remove-RedisCacheDiagnostics', 'Set-RedisCacheDiagnostics', 
               'Set-RedisCache', 'New-RedisCacheKey', 'Get-RedisCacheKey', 
               'Get-RedisCache', 'Remove-RedisCache', 'New-RedisCache', 
               'New-RedisCacheLink', 'Remove-RedisCacheLink', 'Get-RedisCacheLink', 
               'New-RedisCacheFirewallRule', 'Remove-RedisCacheFirewallRule', 
...
AliasesToExport = 'Remove-AzureRmRedisCachePatchSchedule', 
