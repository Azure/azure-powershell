...
Description = '[PowerShell .Net Core] Microsoft Azure PowerShell - Container Instance cmdlets for Azure Resource Manager'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Azure', 'ResourceManager', 'ARM', 'Container', 'ContainerInstance', 
            'ContainerGroup'
