...
{
    public class ManagementGroupsResourceTests : ResourceTestRunner
    {
        public ManagementGroupsResourceTests(Xunit.Abstractions.ITestOutputHelper output) : base(output)
        {
        }
