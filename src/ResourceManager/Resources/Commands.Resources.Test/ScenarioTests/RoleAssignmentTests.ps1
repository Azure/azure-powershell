...
function Test-RaValidateInputParameters ($cmdName)
{
    ...
    $invalidResourceType = "Scope '/subscriptions/4004a9fd-d58e-48dc-aeb2-4a4aec58606f/resourceGroups/testservicebusaccount1/providers/Microsoft.KeyVault/testservicebusaccount1' should have even number of parts."
