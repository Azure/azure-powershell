...
namespace Microsoft.Azure.Commands.ResourceManager.Cmdlets.Implementation
{
    ...
    /// </summary>
    [Cmdlet(VerbsDiagnostic.Test, "AzureRmDeployment", DefaultParameterSetName = ParameterlessTemplateFileParameterSetName), OutputType(typeof(List<PSResourceManagerError>))]
    public class TestAzureDeploymentCmdlet : ResourceWithParameterCmdletBase, IDynamicParameters
    {
        ...
        public TestAzureDeploymentCmdlet()
        {
