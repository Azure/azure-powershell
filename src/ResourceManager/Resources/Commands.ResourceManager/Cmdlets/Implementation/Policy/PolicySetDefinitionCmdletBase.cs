...
namespace Microsoft.Azure.Commands.ResourceManager.Cmdlets.Implementation
{
    ...
    /// <summary>
    /// Base class for policy set definition cmdlets.
    /// </summary>
    public abstract class PolicySetDefinitionCmdletBase : ResourceManagerCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Converts the resource object to policy set definition object.
        /// </summary>
        ...
        protected PSObject[] GetOutputObjects(params JToken[] resources)
        {
            return resources
                ...
                .SelectArray(resource =>
                {
                    ...
                    psobject.Properties.Add(new PSNoteProperty("PolicySetDefinitionId", psobject.Properties["ResourceId"].Value));
                    return psobject;
                });
        }
    }
