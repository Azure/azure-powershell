...
namespace Microsoft.Azure.Commands.ResourceManager.Cmdlets.Implementation
{
    ...
    public abstract class PolicyCmdletBase : ResourceManagerCmdletBase
    {
        ...
        protected const string AllFilterParameterSet = "AllFilterParameterSet";
        protected const string EffectiveFilterParameterSet = "EffectiveFilterParameterSet";
        ...
        protected PsPolicyAssignment[] GetOutputPolicyAssignments(params JObject[] resources)
        {
            return resources
                .CoalesceEnumerable()
        ...
        protected PsPolicyDefinition[] GetFilteredOutputPolicyDefinitions(ListFilter filter, params JToken[] resources)
        {
            Func<PsPolicyDefinition, bool> filterLambda = (result) =>
            {
                ...
                var policyType = result.Properties.Properties["PolicyType"];
