...
namespace Microsoft.Azure.Commands.Resources.ProviderFeatures
{
    ...
    /// </summary>
    [Cmdlet(VerbsLifecycle.Register, "AzureRmProviderFeature", SupportsShouldProcess = true, 
        ConfirmImpact = ConfirmImpact.High), OutputType(typeof(List<PSProviderFeature>))]
