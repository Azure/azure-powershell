...
namespace Microsoft.Azure.Commands.Resources.Models
{
    public class GalleryTemplatesClient
    {
        ...
        public GalleryTemplatesClient(IClientFactory clientFactory, AzureContext context)
            : this(clientFactory.CreateClient<GalleryClient>(context, AzureEnvironment.Endpoint.Gallery))
        {
