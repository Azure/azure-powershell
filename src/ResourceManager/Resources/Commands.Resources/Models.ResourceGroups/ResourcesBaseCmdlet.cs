    ...
    public abstract class ResourcesBaseCmdlet : AzurePSCmdlet
    {
        ...
        public ResourcesClient ResourcesClient
        {
            get
            {
                ...
                {
                    resourcesClient = new ResourcesClient(this.Profile.Context)
                    {
        ...
        public GalleryTemplatesClient GalleryTemplatesClient
        {
            get
            {
                ...
                {
                    galleryTemplatesClient = new GalleryTemplatesClient(this.Profile.Context);
                }
        ...
        public AuthorizationClient PoliciesClient
        {
            get
            {
                ...
                {
                    policiesClient = new AuthorizationClient(this.Profile.Context);
                }
