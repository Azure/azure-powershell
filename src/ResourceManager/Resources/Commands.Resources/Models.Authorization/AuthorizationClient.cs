...
namespace Microsoft.Azure.Commands.Resources.Models.Authorization
{
    public class AuthorizationClient
    {
        ...
        {
            var odataQuery = new Rest.Azure.OData.ODataQuery<RoleDefinitionFilter>(filter => filter.AtScopeAndBelow());
            return new PageEnumerable<RoleDefinition>(
                delegate()
                {
        ...
        public IEnumerable<PSRoleDefinition> FilterRoleDefinitionsByCustom(string scope, bool scopeAndBelow, ulong first = ulong.MaxValue, ulong skip = 0)
        {
            var odataQuery = new Rest.Azure.OData.ODataQuery<RoleDefinitionFilter>(filter => filter.AtScopeAndBelow());
            return new PageEnumerable<RoleDefinition>(
                delegate()
                {
                    return AuthorizationManagementClient.RoleDefinitions.List(scope, scopeAndBelow ? odataQuery : null);
                }, AuthorizationManagementClient.RoleDefinitions.ListNext, first, skip)
