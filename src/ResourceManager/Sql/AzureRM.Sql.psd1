...
CmdletsToExport = 'Get-AzureRmSqlDatabaseTransparentDataEncryption', 
			   ...
			   'Get-AzureRmSqlDatabaseBlobAuditingPolicy', 
               'Get-AzureRmSqlServerBlobAuditingPolicy',  
               ...
               'Set-AzureRmSqlServerBlobAuditingPolicy', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added -SampleName parameter to New-AzureRmSqlDatabase
