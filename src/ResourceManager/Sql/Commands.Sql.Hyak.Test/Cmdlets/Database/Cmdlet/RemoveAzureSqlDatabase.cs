    ...
    public class RemoveAzureSqlDatabase : AzureSqlDatabaseCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            if (!Force.IsPresent && !ShouldProcess(
               string.Format(CultureInfo.InvariantCulture, "RemoveAzureSqlDatabaseDescription: {0} {1}", this.DatabaseName, this.ServerName),
               string.Format(CultureInfo.InvariantCulture, "RemoveAzureSqlDatabaseWarning: {0} {1}", this.DatabaseName, this.ServerName),
