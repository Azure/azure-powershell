    ...
    public class RemoveAzureSqlElasticPool : AzureSqlElasticPoolCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            if (!Force.IsPresent && !ShouldProcess(
               string.Format(CultureInfo.InvariantCulture, "RemoveAzureSqlDatabaseElasticPoolDescription: {0} {1}", this.ElasticPoolName, this.ServerName),
               string.Format(CultureInfo.InvariantCulture, "RemoveAzureSqlDatabaseElasticPoolWarning: {0} {1}", this.ElasticPoolName, this.ServerName),
