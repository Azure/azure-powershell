...
{
    /// <summary>
    /// Sets the blob auditing policy properties for a specific database.
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "AzureRmSqlDatabaseBlobAuditingPolicy", SupportsShouldProcess = true), OutputType(typeof(DatabaseBlobAuditingPolicyModelV2))]
    public class SetAzureSqlDatabaseBlobAuditingPolicy : SqlDatabaseBlobAuditingCmdletBase
    {
        /// <summary>
        ...
        protected override DatabaseBlobAuditingPolicyModelV2 ApplyUserInputToModel(DatabaseBlobAuditingPolicyModelV2 model)
        {
