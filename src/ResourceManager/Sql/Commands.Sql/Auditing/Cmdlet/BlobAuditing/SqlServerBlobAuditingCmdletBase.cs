...
{
    /// <summary>
    /// The base class for Azure SQL server blob auditing Management Cmdlets
    /// </summary>
    public abstract class SqlServerBlobAuditingCmdletBase : AzureSqlCmdletBase<ServerBlobAuditingPolicyModelV2, SqlAuditAdapter>
    {
        /// <summary>
        ...
        protected override ServerBlobAuditingPolicyModelV2 GetEntity()
        {
            ServerBlobAuditingPolicyModelV2 model;
        ...
        protected override ServerBlobAuditingPolicyModelV2 PersistChanges(ServerBlobAuditingPolicyModelV2 baseModel)
        {
