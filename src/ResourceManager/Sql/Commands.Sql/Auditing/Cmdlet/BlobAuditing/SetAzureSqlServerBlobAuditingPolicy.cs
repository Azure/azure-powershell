...
{
    /// <summary>
    /// Sets the blob auditing policy properties for a specific database server.
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "AzureRmSqlServerBlobAuditingPolicy", SupportsShouldProcess = true), OutputType(typeof(ServerBlobAuditingPolicyModelV2))]
    public class SetAzureSqlServerBlobAuditingPolicy : SqlServerBlobAuditingCmdletBase
    {
        /// <summary>
        ...
        protected override ServerBlobAuditingPolicyModelV2 ApplyUserInputToModel(ServerBlobAuditingPolicyModelV2 model)
        {
