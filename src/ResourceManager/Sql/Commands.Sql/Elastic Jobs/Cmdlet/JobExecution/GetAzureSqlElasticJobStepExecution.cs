...
namespace Microsoft.Azure.Commands.Sql.ElasticJobs.Cmdlet.JobExecution
{
    ...
    public class GetAzureSqlElasticJobStepExecution : AzureSqlElasticJobExecutionCmdletBase<AzureSqlElasticJobExecutionModel>
    {
        ...
        /// The parameter sets
        /// </summary>
        protected const string GetJobStepExecutionDefaultParam = "WithJobStepName";
        protected const string GetJobStepExecutionJobExecutionModel = "WithJobStepName using ParentObject";
        protected const string GetJobStepExecutionParentResourceId = "WithJobStepName using ParentResourceId";
        ...
        [Parameter(ParameterSetName = GetJobStepExecutionParentResourceId,
            Mandatory = true,
            ValueFromPipelineByPropertyName = true,
            Position = 0,
            HelpMessage = "The job execution resource id.")]
        ...
        [Parameter(
            ...
            HelpMessage = "The job step name.")]
        [Parameter(
            ParameterSetName = GetJobStepExecutionParentResourceId,
            Mandatory = true,
            Position = 1,
            HelpMessage = "The job step name.")]
