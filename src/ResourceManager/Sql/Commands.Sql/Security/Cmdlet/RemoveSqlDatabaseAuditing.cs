...
namespace Microsoft.Azure.Commands.Sql.Security.Cmdlet
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Remove, "AzureSqlDatabaseAuditing"), OutputType(typeof(AuditingPolicy))]
    public class RemoveSqlDatabaseAuditing : SqlDatabaseSecurityCmdletBase
    {
