...
namespace Microsoft.Azure.Commands.Sql.Security.Cmdlet
{
    ...
    /// </summary>
    [Cmdlet(VerbsLifecycle.Enable, "AzureSqlDatabaseDirectAccess"), OutputType(typeof(AuditingPolicy))]
    public class EnableAzureSqlDatabaseDirectAccess : SqlDatabaseSecurityCmdletBase
    {
