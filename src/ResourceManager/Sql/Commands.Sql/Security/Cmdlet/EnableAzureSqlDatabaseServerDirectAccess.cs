...
namespace Microsoft.Azure.Commands.Sql.Security.Cmdlet
{
    ...
    /// </summary>
    [Cmdlet(VerbsLifecycle.Enable, "AzureSqlDatabaseServerDirectAccess"), OutputType(typeof(AuditingPolicy))]
    public class EnableAzureSqlDatabaseServerDirectAccess : SqlDatabaseSecurityCmdletBase
    {
