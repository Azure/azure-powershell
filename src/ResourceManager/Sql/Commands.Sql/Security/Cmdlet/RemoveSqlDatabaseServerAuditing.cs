...
namespace Microsoft.Azure.Commands.Sql.Security.Cmdlet
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Remove, "AzureSqlDatabaseServerAuditing"), OutputType(typeof(AuditingPolicy))]
    public class RemoveSqlDatabaseServerAuditing : SqlDatabaseSecurityCmdletBase
    {
