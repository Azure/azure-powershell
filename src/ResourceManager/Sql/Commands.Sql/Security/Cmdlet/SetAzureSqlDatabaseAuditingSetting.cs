...
namespace Microsoft.Azure.Commands.Sql.Security.Cmdlet
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "AzureSqlDatabaseAuditingSetting"), OutputType(typeof(AuditingPolicy))]
    public class SetAzureSqlDatabaseAuditingSetting : SetAuditingSettingsBase
    {
