...
namespace Microsoft.Azure.Commands.Sql.Security.Cmdlet
{
    ...
    /// </summary>
    [Cmdlet(VerbsLifecycle.Disable, "AzureSqlDatabaseDirectAccess"), OutputType(typeof(AuditingPolicy))]
    public class DisableAzureSqlDatabaseDirectAccess : SqlDatabaseSecurityCmdletBase
    {
