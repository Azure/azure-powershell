...
```
Set-AzureRmSqlDatabaseInstanceFailoverGroup [-Name] <String> [-FailoverPolicy <FailoverPolicy>]
...
```
Set-AzureRmSqlDatabaseInstanceFailoverGroup -InputObject <AzureSqlInstanceFailoverGroupModel>
...
```
Set-AzureRmSqlDatabaseInstanceFailoverGroup [-ResourceId] <String> [-FailoverPolicy <FailoverPolicy>]
 [-GracePeriodWithDataLossHours <Int32>] [-AllowReadOnlyFailoverToPrimary <AllowReadOnlyFailoverToPrimary>]
 [-ResourceGroupName] <String> [-Location] <String> [-DefaultProfile <IAzureContextContainer>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
