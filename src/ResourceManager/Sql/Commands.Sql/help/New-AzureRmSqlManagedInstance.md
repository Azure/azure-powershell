...
online version: https://docs.microsoft.com/en-us/powershell/module/azurerm.sql/new-azurermsqlmanagedinstance
schema: 2.0.0
---
...
## DESCRIPTION
The **New-AzureRmSqlManagedInstance** cmdlet creates an Azure SQL Database Managed instance.
