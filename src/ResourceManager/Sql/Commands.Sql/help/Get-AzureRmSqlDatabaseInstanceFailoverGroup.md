...
online version: https://docs.microsoft.com/en-us/powershell/module/azurerm.sql/get-azurermsqldatabaseinstancefailovergroup
schema: 2.0.0
---
...
```
Get-AzureRmSqlDatabaseInstanceFailoverGroup [[-Name] <String>] [-ResourceGroupName] <String>
