...
Switch-AzureRmSqlDatabaseInstanceFailoverGroup [[-ResourceGroupName] <String>] [-Location] <String>
 [-Name] <String> -InputObject <AzureSqlInstanceFailoverGroupModel> [-AllowDataLoss] [-AsJob]
...
```
Switch-AzureRmSqlDatabaseInstanceFailoverGroup [[-ResourceGroupName] <String>] [-Location] <String>
 [-Name] <String> [-ResourceId] <String> [-AllowDataLoss] [-AsJob] [-DefaultProfile <IAzureContextContainer>]
...
### -Location
The name of the Partner Region from which to failover the Instance Failover Group.
