...
{
    public abstract class AzureSqlDatabaseLongTermRetentionPolicyCmdletBase :
        AzureSqlCmdletBase<IEnumerable<AzureSqlDatabaseLongTermRetentionPolicyModel>, AzureSqlDatabaseBackupAdapter>
    {
        /// <summary>
