...
CmdletsToExport = 'Get-AzureRmSqlDatabaseTransparentDataEncryption', 
			   ...
			   'Get-AzureRmSqlDatabaseExtendedAuditing',
			   'Get-AzureRmSqlServerExtendedAuditing', 
			   ...
			   'Set-AzureRmSqlDatabaseExtendedAuditing',
			   'Set-AzureRmSqlServerExtendedAuditing', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed issue where some backup cmdlets would not recognize the current azure subscription'
