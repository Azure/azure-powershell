...
namespace Microsoft.Azure.Management.Sql.LegacySdk
{
    ...
    /// </summary>
    internal partial class DatabaseAdvisorOperations : IServiceOperations<SqlManagementClient>, IDatabaseAdvisorOperations
    {
        /// <summary>
        ...
        /// </param>
        internal DatabaseAdvisorOperations(SqlManagementClient client)
        {
            this._client = client;
        }
        ...
        /// </returns>
        public async Task<AdvisorGetResponse> GetAsync(string resourceGroupName, string serverName, string databaseName, string advisorName, string expand, CancellationToken cancellationToken)
        {
            // Validate
        ...
        /// request.
        /// </returns>
        public async Task<AdvisorListResponse> ListAsync(string resourceGroupName, string serverName, string databaseName, string expand, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
        ...
        /// </returns>
        public async Task<AdvisorUpdateResponse> UpdateAsync(string resourceGroupName, string serverName, string databaseName, string advisorName, AdvisorUpdateParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
