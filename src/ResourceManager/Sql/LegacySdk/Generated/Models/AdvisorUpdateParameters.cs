...
namespace Microsoft.Azure.Management.Sql.LegacySdk.Models
{
    ...
    /// status.
    /// </summary>
    public partial class AdvisorUpdateParameters
    {
        private AdvisorUpdateProperties _properties;
        ...
        /// </summary>
        public AdvisorUpdateParameters(AdvisorUpdateProperties properties)
            : this()
        {
            if (properties == null)
            {
