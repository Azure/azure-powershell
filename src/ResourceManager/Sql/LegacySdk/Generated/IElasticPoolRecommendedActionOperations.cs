...
namespace Microsoft.Azure.Management.Sql.LegacySdk
{
    ...
    /// </summary>
    public partial interface IElasticPoolRecommendedActionOperations
    {
        /// <summary>
        ...
        /// </returns>
        Task<RecommendedActionGetResponse> GetAsync(string resourceGroupName, string serverName, string elasticPoolName, string advisorName, string recommendedActionName, CancellationToken cancellationToken);
        ...
        /// </returns>
        Task<RecommendedActionListResponse> ListAsync(string resourceGroupName, string serverName, string elasticPoolName, string advisorName, CancellationToken cancellationToken);
        ...
        /// </returns>
        Task<RecommendedActionUpdateResponse> UpdateAsync(string resourceGroupName, string serverName, string elasticPoolName, string advisorName, string recommendedActionName, RecommendedActionUpdateParameters parameters, CancellationToken cancellationToken);
    }
}
