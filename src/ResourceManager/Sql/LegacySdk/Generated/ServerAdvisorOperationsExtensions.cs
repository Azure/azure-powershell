...
namespace Microsoft.Azure.Management.Sql.LegacySdk
{
    ...
    /// </summary>
    public static partial class ServerAdvisorOperationsExtensions
    {
        /// <summary>
        ...
        /// request.
        /// </returns>
        public static AdvisorListResponse List(this IServerAdvisorOperations operations, string resourceGroupName, string serverName, string expand)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IServerAdvisorOperations)s).ListAsync(resourceGroupName, serverName, expand);
            }
            , operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
        ...
        /// request.
        /// </returns>
        public static Task<AdvisorListResponse> ListAsync(this IServerAdvisorOperations operations, string resourceGroupName, string serverName, string expand)
        {
            return operations.ListAsync(resourceGroupName, serverName, expand, CancellationToken.None);
        }
        ...
        /// </returns>
        public static AdvisorUpdateResponse Update(this IServerAdvisorOperations operations, string resourceGroupName, string serverName, string advisorName, AdvisorUpdateParameters parameters)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IServerAdvisorOperations)s).UpdateAsync(resourceGroupName, serverName, advisorName, parameters);
            }
            , operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
