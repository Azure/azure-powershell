...
namespace Microsoft.Azure.Management.Sql.LegacySdk
{
    ...
    /// </summary>
    internal partial class ElasticPoolRecommendedActionOperations : IServiceOperations<SqlManagementClient>, IElasticPoolRecommendedActionOperations
    {
        /// <summary>
        ...
        /// </returns>
        public async Task<RecommendedActionGetResponse> GetAsync(string resourceGroupName, string serverName, string elasticPoolName, string advisorName, string recommendedActionName, CancellationToken cancellationToken)
        {
            // Validate
        ...
        /// </returns>
        public async Task<RecommendedActionListResponse> ListAsync(string resourceGroupName, string serverName, string elasticPoolName, string advisorName, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
        ...
        /// </returns>
        public async Task<RecommendedActionUpdateResponse> UpdateAsync(string resourceGroupName, string serverName, string elasticPoolName, string advisorName, string recommendedActionName, RecommendedActionUpdateParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
