...
namespace Microsoft.Azure.Management.Sql.LegacySdk
{
    ...
    /// </summary>
    public partial interface IServerAdvisorOperations
    {
        /// <summary>
        ...
        /// </returns>
        Task<AdvisorGetResponse> GetAsync(string resourceGroupName, string serverName, string advisorName, string expand, CancellationToken cancellationToken);
        ...
        /// request.
        /// </returns>
        Task<AdvisorListResponse> ListAsync(string resourceGroupName, string serverName, string expand, CancellationToken cancellationToken);
        ...
        /// </returns>
        Task<AdvisorUpdateResponse> UpdateAsync(string resourceGroupName, string serverName, string advisorName, AdvisorUpdateParameters parameters, CancellationToken cancellationToken);
    }
}
