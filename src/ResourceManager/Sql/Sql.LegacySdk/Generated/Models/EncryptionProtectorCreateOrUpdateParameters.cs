...
namespace Microsoft.Azure.Management.Sql.LegacySdk.Models
{
    ...
    /// parameters.
    /// </summary>
    public partial class EncryptionProtectorCreateOrUpdateParameters
    {
        private EncryptionProtectorCreateOrUpdateProperties _properties;
        
        /// <summary>
        /// Required. Gets or sets the properties of the request.
        /// </summary>
        public EncryptionProtectorCreateOrUpdateProperties Properties
        {
        ...
        /// arguments.
        /// </summary>
        public EncryptionProtectorCreateOrUpdateParameters(EncryptionProtectorCreateOrUpdateProperties properties)
            : this()
        {
            if (properties == null)
            {
