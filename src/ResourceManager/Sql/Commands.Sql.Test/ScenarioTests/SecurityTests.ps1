...
function Test-ServerRetentionMissing
{
       # Setup
       $testSuffix = 206
	   $serverNameGuid = [guid]::NewGuid()
	   $serverNameGuid = $serverNameGuid.ToString()

	   $params = Get-SqlAuditingTestEnvironmentParameters $testSuffix
	   $params.serverName = $serverNameGuid 
...
function Test-DatabaseRetentionMissing
{
       # Setup
       $testSuffix = 207
	   $databaseNameGuid = [guid]::NewGuid()
	   $databaseNameGuid = $databaseNameGuid.ToString()

	   $params = Get-SqlAuditingTestEnvironmentParameters $testSuffix
	   $params.databaseName = $databaseNameGuid 
