...
function Test-SetGetManagedInstanceEncryptionProtectorCI
{
	...
	$encryptionProtector = Set-AzureRmSqlInstanceTransparentDataEncryptionProtector  -ResourceGroupName $mangedInstanceRg -InstanceName $managedInstanceName -Type ServiceManaged
	...
	$encryptionProtector2 = Get-AzureRmSqlInstanceTransparentDataEncryptionProtector  -InstanceResourceId $managedInstance.ResourceId
	...
	$byokEncryptionProtector = $managedInstance | Set-AzureRmSqlInstanceTransparentDataEncryptionProtector -Type AzureKeyVault -KeyId $keyResult.KeyId -Force
	...
	$byokEncryptionProtector2 = Get-AzureRmSqlInstanceTransparentDataEncryptionProtector -Instance $managedInstance
...
function Test-SetGetManagedInstanceEncryptionProtectorServiceManaged
{
	...
	$encryptionProtector2 = Get-AzureRmSqlInstanceTransparentDataEncryptionProtector  -ResourceGroupName $mangedInstanceRg -InstanceName $managedInstanceName
...
function Test-SetGetManagedInstanceEncryptionProtectorServiceManagedInputObject
{
	...
	$encryptionProtector = Set-AzureRmSqlInstanceTransparentDataEncryptionProtector -Instance $managedInstance -Type ServiceManaged
	
	Assert-AreEqual ServiceManaged $encryptionProtector.Type "Protector type mismatch after setting managed instance TDE protector"
	Assert-AreEqual ServiceManaged $encryptionProtector.ManagedInstanceKeyVaultKeyName "ManagedInstanceKeyVaultKeyName mismatch after setting managed instance TDE protector"

	$encryptionProtector2 = Get-AzureRmSqlInstanceTransparentDataEncryptionProtector -Instance $managedInstance
...
function Test-SetGetManagedInstanceEncryptionProtectorServiceManagedResourceId
{
	...
	$encryptionProtector = Set-AzureRmSqlInstanceTransparentDataEncryptionProtector -InstanceResourceId $managedInstanceResourceId -Type ServiceManaged
	
	Assert-AreEqual ServiceManaged $encryptionProtector.Type "Protector type mismatch after setting managed instance TDE protector"
	Assert-AreEqual ServiceManaged $encryptionProtector.ManagedInstanceKeyVaultKeyName "ManagedInstanceKeyVaultKeyName mismatch after setting managed instance TDE protector"

	$encryptionProtector2 = Get-AzureRmSqlInstanceTransparentDataEncryptionProtector -InstanceResourceId $managedInstanceResourceId
...
function Test-SetGetManagedInstanceEncryptionProtectorServiceManagedPiping
{
	...
	$encryptionProtector = $managedInstance | Set-AzureRmSqlInstanceTransparentDataEncryptionProtector -Type ServiceManaged
	
	Assert-AreEqual ServiceManaged $encryptionProtector.Type "Protector type mismatch after setting managed instance TDE protector"
	Assert-AreEqual ServiceManaged $encryptionProtector.ManagedInstanceKeyVaultKeyName "ManagedInstanceKeyVaultKeyName mismatch after setting managed instance TDE protector"

	$encryptionProtector2 = $managedInstance | Get-AzureRmSqlInstanceTransparentDataEncryptionProtector
...
function Test-SetGetManagedInstanceEncryptionProtectorByok
{
	...
	$encryptionProtector = Set-AzureRmSqlInstanceTransparentDataEncryptionProtector  -ResourceGroupName $mangedInstanceRg -InstanceName $managedInstanceName -Type AzureKeyVault -KeyId $keyResult.KeyId -Force
...
function Test-SetGetManagedInstanceEncryptionProtectorByokInputObject
{
	...
	$encryptionProtector = Set-AzureRmSqlInstanceTransparentDataEncryptionProtector -Instance $managedInstance -Type AzureKeyVault -KeyId $keyResult.KeyId -Force
...
function Test-SetGetManagedInstanceEncryptionProtectorByokResourceId
{
	...
	$encryptionProtector = Set-AzureRmSqlInstanceTransparentDataEncryptionProtector -InstanceResourceId $managedInstanceResourceId -Type AzureKeyVault -KeyId $keyResult.KeyId -Force
...
function Test-SetGetManagedInstanceEncryptionProtectorByokPiping
{
	...
	$encryptionProtector = $managedInstance | Set-AzureRmSqlInstanceTransparentDataEncryptionProtector -Type AzureKeyVault -KeyId $keyResult.KeyId -Force
...
function Test-SetGetManagedInstanceEncryptionProtectorByokFailsWithoutKeyId
{
	...
	try
	{
		$encryptionProtector = Set-AzureRmSqlInstanceTransparentDataEncryptionProtector  -ResourceGroupName $mangedInstanceRg -InstanceName $managedInstanceName -Type AzureKeyVault -Force
	}
	Catch
	{
	...
	if(!$correctExceptionCaught){
		throw [System.Exception] "Expected exception not thrown for cmdlet Set-AzureRmSqlInstanceTransparentDataEncryptionProtector when encryptor is AzureKeyVault and KeyId is not provided"
	}
}