...
namespace Microsoft.Azure.Commands.PowerBIDedicated.Models
{
    ...
    /// </summary>
    public abstract class PowerBIDedicatedCmdletBase : AzureRMCmdlet
    {
        private PowerBIDedicatedClient powerBIDedicatedClient;
        ...
        public PowerBIDedicatedClient PowerBIDedicatedClient
        {
            get
            {
                if (powerBIDedicatedClient == null)
                {
                    powerBIDedicatedClient = new PowerBIDedicatedClient(DefaultProfile.DefaultContext);
                }
                return powerBIDedicatedClient;
            }

            set { powerBIDedicatedClient = value; }
        }
