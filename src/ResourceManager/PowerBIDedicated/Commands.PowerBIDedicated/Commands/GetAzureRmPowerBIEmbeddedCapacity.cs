...
namespace Microsoft.Azure.Commands.PowerBIDedicated
{
    [Cmdlet(VerbsCommon.Get, "AzureRmPowerBIEmbeddedCapacity"),
     OutputType(typeof(List<AzurePowerBIDedicated>))]
    public class GetAzurePowerBIEmbeddedCapacity : PowerBIDedicatedCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            if (!string.IsNullOrEmpty(Name))
            {
                ...
                var capacity = PowerBIDedicatedClient.GetCapacity(ResourceGroupName, Name);
            ...
            else
            {
                ...
                var list = PowerBIDedicatedClient.ListCapacities(ResourceGroupName);
                WriteObject(AzurePowerBIDedicated.FromPowerBIDedicatedCollection(list), true);
            }
        }
    }
}