...
namespace Microsoft.Azure.Commands.PowerBIDedicated
{
    ...
    public class TestAzurePowerBIEmbeddedCapacity : PowerBIDedicatedCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            WriteObject(PowerBIDedicatedClient.TestCapacity(ResourceGroupName, Name, out capacity));
        }
    }
}