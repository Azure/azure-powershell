...
{
    [Cmdlet(VerbsCommon.New, "AzureRmPowerBIEmbeddedCapacity", SupportsShouldProcess = true), OutputType(typeof(AzurePowerBIDedicated))]
    public class NewPowerBIEmbeddedCapacity : PowerBIDedicatedCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            if (ShouldProcess(Name, Resources.CreateNewPowerBIEmbeddedCapacity))
            {
                try
                {
                    if (PowerBIDedicatedClient.GetCapacity(ResourceGroupName, Name) != null)
                    {
                ...
                var availableSkus = PowerBIDedicatedClient.ListSkusForNew();
