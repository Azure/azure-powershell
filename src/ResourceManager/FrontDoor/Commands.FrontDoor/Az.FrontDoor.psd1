...
NestedModules = @('.\Microsoft.Azure.Commands.FrontDoor.dll')
...
CmdletsToExport = 'New-AzFrontDoor', 'Get-AzFrontDoor', 'Set-AzFrontDoor', 
                'Remove-AzFrontDoor', 'New-AzFrontDoorRoutingRuleObject', 'New-AzFrontDoorBackendObject',
				'New-AzFrontDoorBackendPoolObject', 'New-AzFrontDoorFrontendEndpointObject',
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Add Remove-AzureRmFrontDoorContent for cache purge'
