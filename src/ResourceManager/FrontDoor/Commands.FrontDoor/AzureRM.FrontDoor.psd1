...
CmdletsToExport = 'New-AzureRmFrontDoor', 'Get-AzureRmFrontDoor', 
               'Set-AzureRmFrontDoor', 'Remove-AzureRmFrontDoor', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'Microsoft Azure PowerShell - FrontDoor service cmdlets.
