#
# Module manifest for module 'PSGet_AzureRM.FrontDoor'
#
...
CmdletsToExport = 'New-AzureRmFrontDoor', 'Get-AzureRmFrontDoor', 'Set-AzureRmFrontDoor', 
                'Remove-AzureRmFrontDoor', 'New-AzureRmFrontDoorRoutingRuleObject', 'New-AzureRmFrontDoorBackendObject',
				'New-AzureRmFrontDoorBackendPoolObject', 'New-AzureRmFrontDoorFrontendEndpointObject',
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* PowerShell integration for Azure Front Door service.'
