...
namespace Microsoft.Azure.Commands.FrontDoor.Test.ScenarioTests.ScenarioTest
{
    public class TestController : RMTestBase
    {
        ...
        private FrontDoorManagementClient GetFrontDoorManagementClient(MockContext context)
        {
            return
                context.GetServiceClient<FrontDoorManagementClient>(TestEnvironmentFactory.GetTestEnvironment());
        }
    }
}
