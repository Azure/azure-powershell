...
namespace Microsoft.Azure.Commands.TrafficManager.Test.ScenarioTests
{
    ...
    public class GetAzureTrafficManagerEndpointTests
    {
        public GetAzureTrafficManagerEndpointTests(ITestOutputHelper output)
        {
        ...
        public void TestGetEndpointMissingProfile()
        {
