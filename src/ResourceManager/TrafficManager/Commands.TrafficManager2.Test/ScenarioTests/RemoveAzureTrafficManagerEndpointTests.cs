...
namespace Microsoft.Azure.Commands.TrafficManager.Test.ScenarioTests
{
    ...
    public class RemoveAzureTrafficManagerEndpointTests
    {
        public RemoveAzureTrafficManagerEndpointTests(ITestOutputHelper output)
        {
        ...
        {
            TestController.NewInstance.RunPowerShellTest("Test-RemoveEndpoint");
        }

        [Fact]
        [Trait(Category.AcceptanceType, Category.CheckIn)]
        public void TestRemoveEndpointMissingProfile()
        {
