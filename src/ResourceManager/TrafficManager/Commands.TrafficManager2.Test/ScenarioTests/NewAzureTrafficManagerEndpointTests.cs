...
namespace Microsoft.Azure.Commands.TrafficManager.Test.ScenarioTests
{
    ...
    public class NewAzureTrafficManagerEndpointTests
    {
        public NewAzureTrafficManagerEndpointTests(ITestOutputHelper output)
        {
        ...
        [Fact]
        [Trait(Category.AcceptanceType, Category.CheckIn)]
        public void TestCreateEndpointMissingProfile()
        {
