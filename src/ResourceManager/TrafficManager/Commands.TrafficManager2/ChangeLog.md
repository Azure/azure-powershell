...
-->
## Current Release
* Microsoft Azure PowerShell – TrafficManager service cmdlets.
...
* The Az.TrafficManager module has all the capabilities of AzureRM.TrafficManager and provides the following improvements:
    - Az.TrafficManager takes advantage of greater security with token cache encryption and improved authentication.
