...
Description = '[PowerShell .Net Core] Microsoft Azure PowerShell - TrafficManager service cmdlets for Azure Resource Manager'
...
NestedModules = @('.\Microsoft.Azure.Commands.TrafficManager.dll')
...
CmdletsToExport = 'Disable-AzureRmTrafficManagerEndpoint', 
    ...
    'Get-AzureRmTrafficManagerProfile', 'New-AzureRmTrafficManagerProfile'
