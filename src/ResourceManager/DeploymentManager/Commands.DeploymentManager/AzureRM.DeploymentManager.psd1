#
# Module manifest for module 'PSGet_AzureRM.DeploymentManager'
#
...
Description = 'Microsoft Azure PowerShell - Deployment Manager cmdlets for Azure Resource Manager.  Creates and manages Deployment Manager resources in Azure Resource Manager.'
...
# FormatsToProcess = '.\Microsoft.Azure.Commands.DeploymentManager.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('.\Microsoft.Azure.Commands.DeploymentManager.dll')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'Add support for creating and managing rollouts and other supporting scenarios.'
