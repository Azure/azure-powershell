...
namespace Microsoft.Azure.Commands.DeploymentManager.Models
{
    ...
    public class PSServiceUnit
    {
        public PSServiceUnit(ServiceUnit serviceUnit)
        {
            ...
            this.ParametersArtifactSourceRelativePath = serviceUnit.ParametersArtifactSourceRelativePath;
            this.ParametersUri = serviceUnit.ParametersUri;
            this.TemplateArtifactSourceRelativePath = serviceUnit.TemplateArtifactSourceRelativePath;
            this.TemplateUri = serviceUnit.TemplateUri;
