...
namespace Microsoft.Azure.Commands.DeploymentManager.Commands
{
    ...
    [Cmdlet(VerbsCommon.Set, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "DeploymentManagerServiceTopology"), OutputType(typeof(PSServiceTopologyResource))]
