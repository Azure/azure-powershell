...
Description = '[PowerShell .Net Core] Microsoft Azure PowerShell - DevTestLabs service cmdlets for Azure Resource Manager'
...
CmdletsToExport = 'Get-DtlAllowedVMSizesPolicy', 'Get-DtlAutoShutdownPolicy', 
               'Get-DtlAutoStartPolicy', 'Get-DtlVMsPerLabPolicy', 
               'Get-DtlVMsPerUserPolicy', 'Set-DtlAutoStartPolicy', 
               'Set-DtlAutoShutdownPolicy', 'Set-DtlVMsPerUserPolicy', 
               'Set-DtlAllowedVMSizesPolicy', 'Set-DtlVMsPerLabPolicy'

# Variables to export from this module
# VariablesToExport = @()

# Aliases to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no aliases to export.
AliasesToExport = 'Get-AzureRmDtlAllowedVMSizesPolicy', 
