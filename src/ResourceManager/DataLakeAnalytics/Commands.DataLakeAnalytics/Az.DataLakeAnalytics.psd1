...
For more information on Data Lake Analytics, please visit the following: https://docs.microsoft.com/en-us/azure/data-lake-analytics/'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'General availability for Az.DataLakeAnalytics module.'
