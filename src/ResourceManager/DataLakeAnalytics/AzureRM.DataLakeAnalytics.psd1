#  
# Module manifest for module 'Microsoft.Azure.Commands.DataLakeAnalytics'  
#  
...
FormatsToProcess = @(
	'.\Microsoft.Azure.Commands.DataLakeAnalytics.format.ps1xml'
)
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @("Azure", "ARM", "ResourceManager", "DataLake", "Analytics")
