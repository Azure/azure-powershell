...
namespace Microsoft.Azure.Commands.Automation.Cmdlet
{
    ...
    public class SetAzureAutomationRunbookDefinition : AzureAutomationBaseCmdlet
    {
        ...
        /// </summary>
        [Parameter(Mandatory = true, Position = 3, ValueFromPipelineByPropertyName = true, HelpMessage = "The path to the updated runbook script.")]
        [ValidateNotNullOrEmpty]
        [Alias("RunbookPath")]
        ...
        protected override void AutomationExecuteCmdlet()
        {
            ...
            var runbookDefinition = this.AutomationClient.UpdateRunbookDefinition(
                    this.ResourceGroupName, this.AutomationAccountName, this.Name, this.ResolvePath(this.Path), this.Overwrite);
