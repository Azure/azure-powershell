...
namespace Microsoft.Azure.Commands.Automation.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Hybrid Runbook Worker Group Not Found.
        /// </summary>
        internal static string HybridRunbookWorkerGroupNotFound {
            get {
                return ResourceManager.GetString("HybridRunbookWorkerGroupNotFound", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Input value cannot be serialized to json and the process timedout. Name {0}..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Node configuration creation operation..
        /// </summary>
        internal static string NodeConfigurationAlreadyExistsCaption {
            get {
                return ResourceManager.GetString("NodeConfigurationAlreadyExistsCaption", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to This cmdlet will overwrite the existing NodeConfiguration. Do you want to Continue?.
        /// </summary>
        internal static string NodeConfigurationAlreadyExistsConfirmation {
            get {
                return ResourceManager.GetString("NodeConfigurationAlreadyExistsConfirmation", resourceCulture);
            }
        }
