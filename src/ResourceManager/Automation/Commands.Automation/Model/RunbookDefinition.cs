...
namespace Microsoft.Azure.Commands.Automation.Model
{
    ...
    /// </summary>
    public class RunbookDefinition : BaseProperties
    {
        /// <summary>
        ...
        /// </param>
        public RunbookDefinition(string resourceGroupName, string accountName, AutomationManagement.Models.Runbook runbook, string content, string slot)
        {
