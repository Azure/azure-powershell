...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'Microsoft Azure PowerShell - Automation service cmdlets.
...
* Az.Automation takes advantage of greater security with token cache encryption and improved authentication.
