...
namespace Microsoft.Azure.Commands.Automation.Common
{
    public interface IAutomationClient
    {
        ...
        Module CreateModule(string resourceGroupName, string automationAccountName, Uri contentLink, string moduleName, IDictionary tags);

        Module GetModule(string resourceGroupName, string automationAccountName, string name);

        Module UpdateModule(string resourceGroupName, string automationAccountName, IDictionary tags, string name, Uri contentLink, string contentLinkVersion);
