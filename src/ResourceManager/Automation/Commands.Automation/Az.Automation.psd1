...
For more information on Automation, please visit the following: https://docs.microsoft.com/en-us/azure/automation/'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'General availability for Az.Automation module.'
