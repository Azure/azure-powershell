...
RequiredModules = @(@{ModuleName = 'Az.Profile'; ModuleVersion = '0.13.1'; })
...
CmdletsToExport = 'Get-AutomationHybridWorkerGroup', 'Get-AutomationJobOutputRecord', 
               'Import-AutomationDscNodeConfiguration', 
               'Export-AutomationDscConfiguration', 
               'Export-AutomationDscNodeReportContent', 
               'Get-AutomationCertificate', 'Get-AutomationConnection', 
               'Get-AutomationCredential', 'Get-AutomationDscCompilationJob', 
               'Get-AutomationDscCompilationJobOutput', 
               'Get-AutomationDscNodeConfiguration', 'Get-AutomationDscNodeReport', 
               'Get-AutomationJob', 'Get-AutomationJobOutput', 
               'Get-AutomationModule', 'Get-AutomationRunbook', 
               'Export-AutomationRunbook', 'Get-AutomationSchedule', 
               'Get-AutomationScheduledRunbook', 'Get-AutomationVariable', 
               'Get-AutomationWebhook', 'New-AutomationCertificate', 
               'New-AutomationConnection', 'New-AutomationCredential', 
               'New-AutomationModule', 'New-AutomationRunbook', 
               'New-AutomationSchedule', 'New-AutomationVariable', 
               'New-AutomationWebhook', 'Publish-AutomationRunbook', 
               'Register-AutomationDscNode', 'Register-AutomationScheduledRunbook', 
               'Remove-AutomationCertificate', 'Remove-AutomationConnectionType', 
               'Remove-AutomationConnection', 'Remove-AutomationCredential', 
               'Remove-AutomationDscNodeConfiguration', 'Remove-AutomationModule', 
               'Remove-AutomationRunbook', 'Remove-AutomationSchedule', 
               'Remove-AutomationVariable', 'Remove-AutomationDscConfiguration', 
               'Remove-AutomationWebhook', 'Resume-AutomationJob', 
               'Set-AutomationCertificate', 'Set-AutomationConnectionFieldValue', 
               ...
               'Set-AutomationWebhook', 'Start-AutomationDscCompilationJob', 
               'Get-AutomationRegistrationInfo', 'Get-AutomationDscConfiguration', 
               'Get-AutomationDscNode', 'Get-AutomationDscOnboardingMetaconfig', 
               'Import-AutomationDscConfiguration', 'New-AutomationKey', 
               'Start-AutomationRunbook', 'Stop-AutomationJob', 
               'Suspend-AutomationJob', 'Unregister-AutomationDscNode', 
               'Set-AutomationAccount', 'Remove-AutomationAccount', 
               'New-AutomationAccount', 'Get-AutomationAccount', 
               'Set-AutomationDscNode', 'Unregister-AutomationScheduledRunbook', 
...
AliasesToExport = 'Get-AzureRMAutomationHybridWorkerGroup', 
               ...
               'Import-AzureRmAutomationModule'
