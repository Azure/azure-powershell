...
namespace Microsoft.Azure.Commands.KeyVault.Models
{
    ...
    {
        public VaultAccessPolicy(Guid tenantId, Guid objectId, string[] permissionsToKeys, string[] permissionsToSecrets)
        {
            TenantId = tenantId;
            ObjectId = objectId;
        ...
        public VaultAccessPolicy(KeyVaultManagement.AccessPolicyEntry s, PSResourceManagerModels.ActiveDirectory.ActiveDirectoryClient adClient)
        {            
            ObjectId = s.ObjectId;
