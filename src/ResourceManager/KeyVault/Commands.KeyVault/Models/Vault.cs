...
{
    public class Vault : VaultIdentityItem
    {
        public Vault(KeyVaultManagement.Vault vault, PSResourceManagerModels.ActiveDirectory.ActiveDirectoryClient adClient)
        {
            ...
            AccessPolicies = vault.Properties.AccessPolicies.Select(s => new VaultAccessPolicy(s, adClient)).ToArray();
            OriginalVault = vault;
        }
        ...
        public VaultAccessPolicy[] AccessPolicies { get; private set; }
