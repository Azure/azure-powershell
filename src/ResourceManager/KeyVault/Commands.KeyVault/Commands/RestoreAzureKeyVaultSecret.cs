    ...
    public class RestoreAzureKeyVaultSecret : KeyVaultCmdletBase
    {
        ...
        public override void ExecuteCmdlet( )
        {
            if ( ShouldProcess( VaultName, Properties.Resources.RestoreSecret ) )
            {
                ...
                var restoredSecret = this.DataServiceClient.RestoreSecret(VaultName, filePath);
        ...
        private string ResolvePath( string filePath )
        {
            ...
            {
                throw new FileNotFoundException( string.Format( KeyVaultProperties.Resources.BackupSecretFileNotFound, filePath ) );
            }
            return secretFile.FullName;
        }
    }
}
