...
namespace Microsoft.Azure.Commands.ApiManagement.Helpers
{
    ...
    {
        public static HostnameConfiguration GetHostnameConfiguration(this PsApiManagementCustomHostNameConfiguration hostnameConfig)
        {
            ...
            var hostnameConfiguration = new HostnameConfiguration(HostnameType.Proxy, hostnameConfig.Hostname);
