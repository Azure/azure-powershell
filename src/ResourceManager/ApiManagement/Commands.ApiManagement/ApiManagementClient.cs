...
namespace Microsoft.Azure.Commands.ApiManagement
{
    ...
    public class ApiManagementClient
    {
            ...
            bool createResourceIdentity = false)
        {
            ...
            {
                BuildHostNameConfiguration(customHostnameConfigurations, parameters.HostnameConfigurations);
            }
        ...
        void BuildHostNameConfiguration(PsApiManagementCustomHostNameConfiguration[] pshostnameConfigurations,
        ...
        public ApiManagementServiceResource UpdateService(
            string resourceGroupName,
            string serviceName,
            PsApiManagement apiManagement)
        {
