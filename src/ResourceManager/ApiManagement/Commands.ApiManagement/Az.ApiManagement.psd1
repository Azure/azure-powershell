...
CmdletsToExport = 'Add-AzApiManagementRegion', 'Get-AzApiManagementSsoToken', 
    ...
    'Export-AzApiManagementApi', 'Get-AzApiManagementApi', 
    'Get-AzApiManagementApiRelease', 
    'Get-AzApiManagementApiRevision', 
    'Get-AzApiManagementApiVersionSet', 
    'Get-AzApiManagementAuthorizationServer', 
    'Get-AzApiManagementCertificate', 
    'Get-AzApiManagementGroup', 'Get-AzApiManagementLogger', 
    'Get-AzApiManagementOpenIdConnectProvider', 
    'Get-AzApiManagementOperation', 
    'Get-AzApiManagementPolicy', 'Get-AzApiManagementProduct', 
    'Get-AzApiManagementProperty', 
    'Get-AzApiManagementSubscription', 
    'Get-AzApiManagementTenantSyncState', 
    'Get-AzApiManagementUser', 'Get-AzApiManagementUserSsoUrl', 
    'Get-AzApiManagementTenantAccess', 
    'Get-AzApiManagementTenantGitAccess', 
    'Import-AzApiManagementApi', 'New-AzApiManagementApi', 
    ...
    'New-AzApiManagementContext', 'New-AzApiManagementGroup', 
    ...
    'Set-AzApiManagement', 'Set-AzApiManagementApi', 
    ...
    'Set-AzApiManagementGroup', 'Set-AzApiManagementLogger', 
    'Set-AzApiManagementOpenIdConnectProvider', 
    'Set-AzApiManagementOperation', 
    'Set-AzApiManagementPolicy', 'Set-AzApiManagementProduct', 
