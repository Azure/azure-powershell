...
### System.String
Parameters: ClientId (ByPropertyName), ClientSecret (ByPropertyName), Description (ByPropertyName), MetadataEndpointUri (ByPropertyName), Name (ByPropertyName), OpenIdConnectProviderId (ByPropertyName)
