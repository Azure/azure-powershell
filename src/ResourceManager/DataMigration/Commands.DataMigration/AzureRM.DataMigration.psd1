#
# Module manifest for module 'AzureRM.DataMigration'
#
...
AliasesToExport = 'Get-AzureRmDms', 
                'Get-AzureRmDmsTask', 
                'Get-AzureRmDmsProject', 
               'New-AzureRmDms', 
               'New-AzureRmDmsConnInfo', 
               'New-AzureRmDmsDBInfo', 
               'New-AzureRmDmsTask', 
               'New-AzureRmDmsProject', 
               'Remove-AzureRmDmsProject', 
               'Remove-AzureRmDms', 
               'Remove-AzureRmDmsTask', 
               'Start-AzureRmDmsService', 
               'Stop-AzureRmDmsTask', 
               'Stop-AzureRmDmsService', 
               'New-AzureRmDmsSelectedDB', 
               'New-AzureRmDmsSyncSelectedDB', 
