...
CmdletsToExport = 'New-DataMigrationDatabaseInfo', 'New-DataMigrationConnectionInfo', 
               'New-DataMigrationProject', 'Remove-DataMigrationProject', 
               'Get-DataMigrationProject', 'Get-DataMigrationService', 
               'New-DataMigrationService', 'Remove-DataMigrationService', 
               'New-DataMigrationTask', 'Get-DataMigrationTask', 
               'Remove-DataMigrationTask', 'Start-DataMigrationService', 
               'Stop-DataMigrationService', 'Stop-DataMigrationTask', 
               'New-DataMigrationSelectedDB', 'New-DataMigrationFileShare'

# Variables to export from this module
# VariablesToExport = @()

# Aliases to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no aliases to export.
AliasesToExport = 'New-AzureRmDataMigrationDatabaseInfo', 
               ...
               'New-AzureRmDataMigrationFileShare', 'Get-AzureRmDms', 
               'Get-AzureRmDmsTask', 'Get-AzureRmDmsProject', 'New-AzureRmDms', 
               'New-AzureRmDmsConnInfo', 'New-AzureRmDmsDBInfo', 
