...
Description = 'Microsoft Azure PowerShell - Database Migration Service cmdlets for Azure Sql in PowerShell and PowerShell Core'
...
AliasesToExport = 'Get-AzDms', 'Get-AzDmsTask', 'Get-AzDmsProject', 
    ...
    'New-AzDmsSelectedDB', 'New-AzDmsSyncSelectedDB', 
    'New-AzDmsFileShare', 'Invoke-AzDmsCommand', 
    'New-AzDataMigrationSelectedDB', 'New-AzDataMigrationSyncSelectedDB', 
    'New-AzDmsSelectedDBObject', 'New-AzDmsSyncSelectedDBObject'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Azure', 'ResourceManager', 'ARM', 'Sql', 'Database', 'Data', 
            'Migration', 'Service'
