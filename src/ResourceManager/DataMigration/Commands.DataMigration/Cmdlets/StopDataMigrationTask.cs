...
{
    [Cmdlet("Stop","DataMigrationTask", DefaultParameterSetName = ComponentNameParameterSet, SupportsShouldProcess = true), OutputType(typeof(bool))]
#if NETSTANDARD
    [Alias("Stop-AzureRmDmsTask", "Stop-AzureRmDataMigrationTask")]
#else
