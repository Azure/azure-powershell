...
{
    public class DataLakeTests : HDInsightTestBase
    {
        ...
        public void CanCreateNewHDInsightDataLakeCluster()
        {
            ...
            var configurations = new Dictionary<string, Dictionary<string, string>>
            {
                ...
                {"clusterIdentity", datalakeConfigs}
            };
        ...
        [Fact]
        [Trait(Category.AcceptanceType, Category.CheckIn)]
        public void CanCreateClusterConfigWithDataLakeParameters()
        {
