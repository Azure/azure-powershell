...
-->
## Current Release
Microsoft Azure PowerShell - HDInsight service cmdlets.
...
* Az.HDInsight takes advantage of greater security with token cache encryption and improved authentication.
