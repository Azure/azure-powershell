...
{
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "HDInsightMapReduceJobDefinition"),OutputType(typeof(AzureHDInsightMapReduceJobDefinition))]
