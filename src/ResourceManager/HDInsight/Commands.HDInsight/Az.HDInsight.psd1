...
Description = 'Microsoft Azure PowerShell - HDInsight service cmdlets for Azure Resource Manager in PowerShell and PowerShell Core'
...
CmdletsToExport = 'Get-AzHDInsightJob', 'New-AzHDInsightSqoopJobDefinition', 
    ...
    'Get-AzHDInsightCluster', 'New-AzHDInsightCluster', 
