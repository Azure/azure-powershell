...
For more information on HDInsight, please visit the following: https://docs.microsoft.com/en-us/azure/hdinsight/'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'General availability for Az.HDInsight module.'
