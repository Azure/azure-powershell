...
CmdletsToExport = 'Get-NotificationHub', 'Get-NotificationHubAuthorizationRules', 
               'Get-NotificationHubListKeys', 'Get-NotificationHubPNSCredentials', 
               'New-NotificationHub', 'New-NotificationHubAuthorizationRules', 
               'New-NotificationHubKey', 'Remove-NotificationHub', 
               'Remove-NotificationHubAuthorizationRules', 'Set-NotificationHub', 
               ...
               'Get-NotificationHubsNamespace', 'New-NotificationHubsNamespace', 
               'Remove-NotificationHubsNamespace', 'Set-NotificationHubsNamespace'

# Variables to export from this module
# VariablesToExport = @()

# Aliases to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no aliases to export.
AliasesToExport = 'Get-AzureRmNotificationHub', 
