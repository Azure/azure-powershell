...
For more information on Notification Hubs, please visit the following: https://docs.microsoft.com/en-us/azure/notification-hubs/'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'General availability for Az.NotificationHubs module.'
