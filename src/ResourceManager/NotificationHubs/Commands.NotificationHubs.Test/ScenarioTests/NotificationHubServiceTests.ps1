...
function Test-CRUDNamespaceAuthorizationRules
{
	...
	$result = Remove-AzureNotificationHubsNamespaceAuthorizationRules -ResourceGroupName $resourceGroupName -NamespaceName $namespaceName -AuthorizationRuleName $authRuleName
...
function Test-CRUDNHAuthorizationRules
{
	...
	$namespaceListKeys = Get-AzureNotificationHubListKeys -ResourceGroupName $resourceGroupName -NamespaceName $namespaceName -NotificationHubName $notificationHubName -AuthorizationRuleName $authRuleName
	...
	Write-Debug " Delete the NotificationHub"
	Remove-AzureNotificationHub -ResourceGroupName $resourceGroupName -NamespaceName $namespaceName -NotificationHubName $notificationHubName
