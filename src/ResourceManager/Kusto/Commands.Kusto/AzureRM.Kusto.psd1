#
# Module manifest for module 'PSGet_AzureRM.Kusto'
#
...
GUID = '868389ce-dd36-4f57-a674-0970db085d9b'
...
Description = 'Microsoft Azure PowerShell - Kusto service management cmdlets for Azure Resource Manager.  Creates and manages Kusto Servers and Databases in Azure Resource Manager.'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Azure','ResourceManager','ARM','Kusto'
