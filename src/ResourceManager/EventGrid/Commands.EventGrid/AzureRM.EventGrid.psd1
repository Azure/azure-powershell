...
CmdletsToExport = 'New-EventGridTopic', 'Get-EventGridTopic', 
               'Set-EventGridTopic', 'New-EventGridTopicKey', 
               'Get-EventGridTopicKey', 'Remove-EventGridTopic', 
               'New-EventGridSubscription', 
               'Update-EventGridSubscription', 
               'Remove-EventGridSubscription', 
               'Get-EventGridSubscription', 'Get-EventGridTopicType'
