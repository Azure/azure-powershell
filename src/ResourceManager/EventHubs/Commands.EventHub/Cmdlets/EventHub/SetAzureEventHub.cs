...
namespace Microsoft.Azure.Commands.EventHub.Cmdlets.EventHub
{
    ...
    [Cmdlet(VerbsCommon.Set, EventHubVerb), OutputType(typeof(EventHubAttributes))]
    public class SetAzureEventHub : AzureEventHubsCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            var hubAttributes = Client.CreateOrUpdateEventHub(ResourceGroupName, Name, eventHub.Name, eventHub);
