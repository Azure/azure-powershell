...
namespace Microsoft.Azure.Commands.EventHub.Commands.EventHub
{
    ...
    /// </summary>
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "EventHubIPFilterRule", DefaultParameterSetName = IpFilterRulePropertiesParameterSet, SupportsShouldProcess = true), OutputType(typeof(PSIpFilterRuleAttributes))]
    public class NewAzureEventHubIpFilterRule : AzureEventHubsCmdletBase
    {
