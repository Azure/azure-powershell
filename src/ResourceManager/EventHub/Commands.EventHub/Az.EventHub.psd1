...
CmdletsToExport = 'New-EventHubNamespace', 'Get-EventHubNamespace', 
               ...
               'New-EventHubAuthorizationRule', 'Get-EventHubAuthorizationRule', 
               'Set-EventHubAuthorizationRule', 'Remove-EventHubAuthorizationRule', 
               'Get-EventHubKey', 'New-EventHubKey', 'New-EventHub', 'Get-EventHub', 
               'Set-EventHub', 'Remove-EventHub', 'New-EventHubConsumerGroup', 
               'Get-EventHubConsumerGroup', 'Set-EventHubConsumerGroup', 
               'Remove-EventHubConsumerGroup', 'New-EventHubGeoDRConfiguration', 
               'Get-EventHubGeoDRConfiguration', 
               'Remove-EventHubGeoDRConfiguration', 
               'Set-EventHubGeoDRConfigurationBreakPair', 
               'Set-EventHubGeoDRConfigurationFailOver', 'Test-EventHubName'

# Variables to export from this module
# VariablesToExport = @()

# Aliases to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no aliases to export.
AliasesToExport = 'New-AzureRmEventHubNamespace', 'Get-AzureRmEventHubNamespace', 
