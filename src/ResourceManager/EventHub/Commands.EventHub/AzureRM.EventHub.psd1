...
CmdletsToExport = 'New-AzureRmEventHubNamespace', 'Get-AzureRmEventHubNamespace', 
               ...
               'Remove-AzureRmEventHubIPFilterRule', 'New-AzureRmEventHubVNetRule', 
               'Set-AzureRmEventHubVNetRule', 'Get-AzureRmEventHubVNetRule', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Cmdlets for Namespace CRUD operations
