...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added a readonly property ''PendingReplicationOperationsCount'' to PSEventHubDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress'
