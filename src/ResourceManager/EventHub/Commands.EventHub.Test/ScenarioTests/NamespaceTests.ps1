...
<#
.SYNOPSIS
Tests EventHub Namespace AuthorizationRules Create List Remove operations - old cmdlets .
#>
...
<#
.SYNOPSIS
Tests EventHub Namespace AuthorizationRules Create List Remove operations - New cmdlets .
#>
function NamespaceAuthTests_New
{
    # Setup    
    $location = Get-Location
	$resourceGroupName = Get-ResourceGroupName
