...
function VNetRuleTests
{
	...
	Try
	{
		...
		$result = New-AzureRmEventHubVNetRule -ResourceGroup $resourceGroupName -Namespace $namespaceName -Name $VNetRule -VirtualNetworkSubnetId "/subscriptions/854d368f-1828-428f-8f3c-f2affa9b2f7d/resourceGroups/EventHubClusterRG/providers/Microsoft.Network/virtualNetworks/sbehvnettest1/subnets/sbdefault"
		...
		# Create a VNetRule	-2
		Write-Debug " Create new VNetRule "	
		$result2 = New-AzureRmEventHubVNetRule -ResourceGroup $resourceGroupName -Namespace $namespaceName -Name $VNetRule2 -VirtualNetworkSubnetId "/subscriptions/854d368f-1828-428f-8f3c-f2affa9b2f7d/resourceGroups/EventHubClusterRG/providers/Microsoft.Network/virtualNetworks/sbehvnettest1/subnets/sbvnetruletest"
		...
		$updatedVNetRule = Set-AzureRmEventHubVNetRule -InputObject $createdVNetRule
