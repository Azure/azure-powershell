...
function IpFilterRuleTests
{
	...
	$updatedIpfilterRule = Set-AzureRmEventHubIPFilterRule -ResourceGroup $resourceGroupName -Namespace $namespaceName -Name $createdIpfilterRule2.Name  -InputObject $createdIpfilterRule
	
	# Assert
	Assert-AreEqual $updatedIpfilterRule.Name $createdIpfilterRule2.Name
