...
{
    [Cmdlet("Start", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "DataFactoryV2Trigger", DefaultParameterSetName = ParameterSetNames.ByFactoryName, SupportsShouldProcess = true),OutputType(typeof(PSTrigger))]
        ...
        public override void ExecuteCmdlet()
        {
            ...
            ConfirmAction(
                ...
                string.Format(
                    ...
                    Resources.TriggerStartConfirmation,
                    Name,
                    DataFactoryName),
                string.Format(
                    CultureInfo.InvariantCulture,
                    Resources.TriggerStarting,
                    Name,
                    DataFactoryName),
                Name,
                ()=> DataFactoryClient.StartTrigger(ResourceGroupName, DataFactoryName, Name));
