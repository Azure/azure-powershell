...
Description = 'Microsoft Azure PowerShell - DataFactory service cmdlets for Azure Resource Manager in PowerShell and PowerShell Core'
...
CmdletsToExport = 'Set-AzDataFactoryV2', 'Update-AzDataFactoryV2', 
    ...
    'Remove-AzDataFactory', 'Get-AzDataFactoryRun', 
