...
Description = '[PowerShell .Net Core] Microsoft Azure PowerShell - Power BI Embedded service management cmdlets for Azure Resource Manager.  Creates and manages Power BI Embedded workspace collections and Power BI Dedicated Capacities in Azure Resource Manager.'
...
CmdletsToExport = 'Remove-PowerBIWorkspaceCollection', 
               ...
               'Get-PowerBIWorkspaceCollectionAccessKeys', 'Get-PowerBIWorkspace', 
               'New-PowerBIWorkspaceCollection', 
               'Reset-PowerBIWorkspaceCollectionAccessKeys', 
               'Resume-PowerBIEmbeddedCapacity', 'Suspend-PowerBIEmbeddedCapacity', 
               'Get-PowerBIEmbeddedCapacity', 'Remove-PowerBIEmbeddedCapacity', 
               'Update-PowerBIEmbeddedCapacity', 'Test-PowerBIEmbeddedCapacity', 
...
AliasesToExport = 'Remove-AzureRmPowerBIWorkspaceCollection', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Azure', 'ResourceManager', 'ARM', 'PowerBI', 'PowerBIEmbedded', 
               'PowerBIDedicated', 'PowerBIEmbeddedCapacity'
