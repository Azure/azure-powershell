...
Description = 'Microsoft Azure PowerShell - Power BI Embedded service management cmdlets for Azure Resource Manager in PowerShell and PowerShell Core.  Creates and manages Power BI Embedded workspace collections and Power BI Dedicated Capacities in Azure Resource Manager.'
...
NestedModules = @('.\Microsoft.Azure.PowerShell.Cmdlets.Management.PowerBIEmbedded.dll', 
