...
For more information on Power BI Embedded, please visit the following: https://docs.microsoft.com/en-us/azure/power-bi-embedded/'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'General availability for Az.PowerBIEmbedded module.'
