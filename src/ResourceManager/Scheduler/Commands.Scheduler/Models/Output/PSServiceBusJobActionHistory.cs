...
{
    public class PSServiceBusJobActionHistory : PSJobActionHistory
    {
        /// <summary>
        /// Gets or sets service bus namespace.
        /// </summary>
        public string ServiceBusNamespace { get; internal set; }

        /// <summary>
        /// Gets or sets service bus queue name.
        /// </summary>
        public string ServiceBusQueueName { get; internal set; }

        /// <summary>
        /// Gets or sets service bus topic path.
        /// </summary>
