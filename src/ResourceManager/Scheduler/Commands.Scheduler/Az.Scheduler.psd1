...
CmdletsToExport = 'Disable-AzSchedulerJobCollection', 
               'Enable-AzSchedulerJobCollection', 'Get-AzSchedulerJobCollection', 
               'Get-AzSchedulerJob', 'Get-AzSchedulerJobHistory', 
               'New-AzSchedulerJobCollection', 'New-AzSchedulerHttpJob', 
               'New-AzSchedulerServiceBusQueueJob', 
               'New-AzSchedulerServiceBusTopicJob', 
               'New-AzSchedulerStorageQueueJob', 'Remove-AzSchedulerJobCollection', 
               'Remove-AzSchedulerJob', 'Set-AzSchedulerHttpJob', 
               'Set-AzSchedulerJobCollection', 'Set-AzSchedulerServiceBusQueueJob', 
