...
namespace Microsoft.Azure.Commands.Scheduler.Cmdlets
{
    ...
    /// </summary>
    [Cmdlet("Set", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "SchedulerHttpJob", SupportsShouldProcess = true), OutputType(typeof(PSSchedulerJobDefinition))]
    public class UpdateAzureSchedulerHttpJobCommand : JobBaseCmdlet, IDynamicParameters
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (this.Uri != null)
            {
                ...
                {
                    jobActionType = (SchedulerModels.JobActionType)Enum.Parse(typeof(SchedulerModels.JobActionType), this.Uri.Scheme, ignoreCase: true);
                }
                else
                {
            ...
            this.ConfirmAction(
                processMessage: string.Format(Resources.UpdateHttpJobResourceDescription, this.JobName),
