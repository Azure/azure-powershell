...
namespace Microsoft.Azure.Commands.Scheduler.Cmdlets
{
    ...
    /// </summary>
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "SchedulerStorageQueueJob", SupportsShouldProcess = true), OutputType(typeof(PSSchedulerJobDefinition))]
    public class NewAzureSchedulerStorageQueueJobCommand : JobBaseCmdlet, IDynamicParameters
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = "The Storage account name.")]
        [ValidateNotNullOrEmpty]
        public string StorageQueueAccount { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = "The Storage Queue name.")]
        [ValidateNotNullOrEmpty]
        public string StorageQueueName { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = "The SAS token for storage queue.")]
        [ValidateNotNullOrEmpty]
        public string StorageSASToken { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = false, HelpMessage = "The queue message for storage job.")]
        [ValidateNotNullOrEmpty]
