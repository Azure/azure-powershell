...
RequiredModules = @(@{ModuleName = 'AzureRM.Profile'; ModuleVersion = '4.5.0'; }, 
               @{ModuleName = 'Azure.Storage'; ModuleVersion = '4.2.0'; })
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Obsolete following parameters in new and set Storage Account cmdlets: EnableEncryptionService and DisableEncryptionService, since Encryption at Rest is enabled by default and can''t be disabled.
