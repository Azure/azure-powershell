#  
# Module manifest for module 'Microsoft.Azure.Commands.Management.Storage'  
#  
...
RequiredModules = @(
    @{ ModuleName = 'AzureRM.Profile'; ModuleVersion = '2.0.0'},
    @{ ModuleName = 'Azure.Storage'; ModuleVersion = '2.0.0'}
)
...
PrivateData = @{
    ...
    PSData = @{
        ...
        # Tags applied to this module. These help with module discovery in online galleries.
         Tags = @("Azure", "ARM", "ResourceManager", "Storage")
