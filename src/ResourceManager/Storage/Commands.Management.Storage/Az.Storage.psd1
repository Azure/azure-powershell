...
NestedModules = @('.\Microsoft.Azure.PowerShell.Cmdlets.Management.Storage.dll', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Set the StorageAccountName of Storage context as the real Storage Account Name, when it''s created with Sas Token, OAuth or Anonymous 
