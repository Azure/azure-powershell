...
{
    [Cmdlet("Add", ResourceManager.Common.AzureRMConstants.AzureRMStoragePrefix + "StorageAccountNetworkRule", SupportsShouldProcess = true, DefaultParameterSetName = NetWorkRuleStringParameterSet)]
