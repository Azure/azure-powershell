...
{
    [Cmdlet("Set", ResourceManager.Common.AzureRMConstants.AzureRMStoragePrefix + "CurrentStorageAccount", DefaultParameterSetName = ResourceNameParameterSet),OutputType(typeof(string))]
