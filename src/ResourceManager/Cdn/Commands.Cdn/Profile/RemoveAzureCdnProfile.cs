...
{
    [Cmdlet(VerbsCommon.Remove, "AzureCdnProfile", ConfirmImpact = ConfirmImpact.High), OutputType(typeof(bool))]
    public class RemoveAzureCdnProfile : AzureCdnCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            WriteVerbose(string.Format(Resources.Success_RemoveProfile, ProfileName, ResourceGroupName));
