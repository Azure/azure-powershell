...
{
    [Cmdlet(VerbsLifecycle.Enable, "AzureRmCdnCustomDomainHttps", SupportsShouldProcess = true, DefaultParameterSetName = FieldsParameterSet), OutputType(typeof(bool))]
    public class EnableAzureRmCdnCustomDomain : AzureCdnCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            CdnManagementClient.CustomDomains.EnableCustomHttps(ResourceGroupName, ProfileName, EndpointName, CustomDomainName);

            WriteVerbose(Resources.Success);
            WriteVerbose(string.Format(Resources.Success_EnableCustomDomainHttps, CustomDomainName, EndpointName, ProfileName, ResourceGroupName));
