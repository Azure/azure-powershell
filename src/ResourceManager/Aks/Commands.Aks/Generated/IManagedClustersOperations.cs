...
namespace Microsoft.Azure.Commands.Aks.Generated
{
    ...
    public partial interface IManagedClustersOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<ManagedClusterAccessProfile>> GetAccessProfilesWithHttpMessagesAsync(string resourceGroupName, string resourceName, string roleName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
