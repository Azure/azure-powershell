...
{
    [Cmdlet(VerbsCommon.New, ContainerRegistryCredentialNoun), OutputType(typeof(PSContainerRegistryCredential))]
    public class NewAzureContainerRegistryCredential : ContainerRegistryCmdletBase
    {
        [Parameter(
            Position = 0,
            Mandatory = true,
        ...
        [ValidateNotNullOrEmpty]
        [ValidateSet(PasswordNameStrings.Password, PasswordNameStrings.Password2, IgnoreCase = false)]
