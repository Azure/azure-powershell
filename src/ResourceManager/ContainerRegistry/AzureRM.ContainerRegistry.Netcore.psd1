#
# Module manifest for module 'AzureRM.ContainerRegistry'
#
...
Description = '[PowerShell .Net Core] Microsoft Azure PowerShell - ContainerRegistry service cmdlets for Azure Resource Manager'
