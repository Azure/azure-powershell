...
Description = 'Microsoft Azure PowerShell - Iot Device provisioning service cmdlets for Azure Resource Manager in PowerShell and PowerShell Core'
...
AliasesToExport = 'New-AzIoTDps', 'Get-AzIoTDps', 'Remove-AzIoTDps', 
    'Update-AzIoTDps', 'Get-AzIoTDpsAccessPolicy', 
    'Add-AzIoTDpsAccessPolicy', 'Remove-AzIoTDpsAccessPolicy', 
    'Update-AzIoTDpsAccessPolicy', 'Get-AzIoTDpsHub', 
    'Add-AzIoTDpsHub', 'Remove-AzIoTDpsHub', 
