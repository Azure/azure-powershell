#
# Module manifest for module 'AzureRM.Billing'
#
...
Description = '[PowerShell .Net Core] Microsoft Azure PowerShell - Billing service cmdlets for Azure Resource Manager'
