...
namespace Microsoft.Azure.Commands.Advisor.Test.ScenarioTests
{
    public class TestController : RMTestBase
    {
        ...
        public IAdvisorManagementClient AdvisorClient { get; private set; }
        ...
        {
            AdvisorClient = GetResourceGraphClient(context);
            SubscriptionClient = GetSubscriptionClient(context); 
            _helper.SetupManagementClients(AdvisorClient, SubscriptionClient);
        }
