...
function Test-SsisAzure-IntegrationRuntime
{
    ...
    try
    {
        ...
        $sasuri = "https://ssisazurefileshare.blob.core.windows.net/privatepreview?st=2018-02-04T05%3A08%3A00Z&se=2020-02-05T05%3A08%3A00Z&sp=rwl&sv=2017-04-17&sr=c&sig=1QxUPy4ClSeDoZM4TOgpxFX7idQWpyoL0jDVg3B3Io8%3D"
