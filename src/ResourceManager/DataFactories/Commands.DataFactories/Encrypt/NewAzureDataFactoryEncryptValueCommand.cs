...
{
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "DataFactoryEncryptValue", DefaultParameterSetName = ByFactoryName), OutputType(typeof(string))]
