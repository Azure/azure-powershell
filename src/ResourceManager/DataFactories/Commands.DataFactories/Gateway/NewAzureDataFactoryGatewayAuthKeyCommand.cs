...
{
    [Cmdlet("New","DataFactoryGatewayAuthKey", DefaultParameterSetName = ByFactoryName, SupportsShouldProcess = true), OutputType(typeof(PSDataFactoryGatewayAuthKey))]
#if NETSTANDARD
    [Alias("New-AzureRmDataFactoryGatewayAuthKey")]
#endif
