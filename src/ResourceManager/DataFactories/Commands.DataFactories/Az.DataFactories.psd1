#
# Module manifest for module 'Az.DataFactories'
#
...
CmdletsToExport = 'Remove-DataFactory', 'Get-DataFactoryRun', 'Get-DataFactorySlice', 
               'Save-DataFactoryLog', 'Set-DataFactorySliceStatus', 
               'New-DataFactoryEncryptValue', 'Get-DataFactoryGateway', 
               'New-DataFactoryGateway', 'New-DataFactoryGatewayKey', 
               'Get-DataFactoryGatewayAuthkey', 'New-DataFactoryGatewayAuthkey', 
               'Remove-DataFactoryGateway', 'Set-DataFactoryGateway', 
               'Get-DataFactoryHub', 'New-DataFactoryHub', 'Remove-DataFactoryHub', 
               'Get-DataFactoryLinkedService', 'Get-DataFactoryActivityWindow', 
               'New-DataFactoryLinkedService', 'Remove-DataFactoryLinkedService', 
               'Get-DataFactory', 'New-DataFactory', 'Get-DataFactoryPipeline', 
               'New-DataFactoryPipeline', 'Remove-DataFactoryPipeline', 
               'Resume-DataFactoryPipeline', 'Set-DataFactoryPipelineActivePeriod', 
               'Suspend-DataFactoryPipeline', 'Get-DataFactoryDataset', 
               'New-DataFactoryDataset', 'Remove-DataFactoryDataset'

# Variables to export from this module
# VariablesToExport = @()

# Aliases to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no aliases to export.
AliasesToExport = 'Remove-AzureRmDataFactory', 'Get-AzureRmDataFactoryRun', 
