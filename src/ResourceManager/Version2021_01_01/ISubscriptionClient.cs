...
namespace Microsoft.Azure.Management.ResourceManager.Version2021_01_01
{
    ...
    public partial interface ISubscriptionClient : System.IDisposable
    {
        ...
        /// </param>
        Task<AzureOperationResponse<CheckResourceNameResult>> CheckResourceNameWithHttpMessagesAsync(string name, string type, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
