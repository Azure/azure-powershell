...
Description = 'Microsoft Azure PowerShell - Maps management cmdlets for Azure Resource Manager in PowerShell and PowerShell Core. Creates and manages Maps accounts in Azure Resource Manager.'
