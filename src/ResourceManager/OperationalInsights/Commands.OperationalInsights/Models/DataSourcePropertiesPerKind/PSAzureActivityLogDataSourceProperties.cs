...
namespace Microsoft.Azure.Commands.OperationalInsights.Models
{
    ...
    public class PSAzureActivityLogDataSourceProperties: PSDataSourcePropertiesBase
    {
        [JsonIgnore]
        public override string Kind { get { return PSDataSourceKinds.AzureActivityLog; } }
        ...
        [JsonProperty(PropertyName = "backfillStartTime")]
