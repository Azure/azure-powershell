...
{
    [Cmdlet("Enable","OperationalInsightsLinuxCustomLogCollection", SupportsShouldProcess = true,DefaultParameterSetName = ByWorkspaceName), OutputType(typeof(PSDataSource))]
#if NETSTANDARD
    [Alias("Enable-AzureRmOperationalInsightsLinuxCustomLogCollection")]
#endif
