...
{
    [Cmdlet("Get","OperationalInsightsStorageInsight", DefaultParameterSetName = ByWorkspaceName), OutputType(typeof(PSStorageInsight))]
#if NETSTANDARD
    [Alias("Get-AzureRmOperationalInsightsStorageInsight")]
#endif
