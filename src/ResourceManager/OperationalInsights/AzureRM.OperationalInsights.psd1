...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added support for V2 API querying via Invoke-AzureRmOperationalInsightsQuery. See [https://dev.loganalytics.io/](https://dev.loganalytics.io/) for more info on the new API.'
