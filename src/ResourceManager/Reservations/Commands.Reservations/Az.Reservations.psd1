...
Description = 'Microsoft Azure PowerShell - Reservations service cmdlets for Azure Resource Manager in PowerShell and PowerShell Core.  Manages Reservations, Reservation Orders, and related resources in Azure Resource Manager'
