...
Description = '[PowerShell .Net Core] Microsoft Azure PowerShell - Reservations service cmdlets for Azure Resource Manager.  Manages Reservations, Reservation Orders, and related resources in Azure Resource Manager'
...
CmdletsToExport = 'Get-ReservationOrder', 'Get-Reservation', 'Get-ReservationHistory', 
               'Update-Reservation', 'Merge-Reservation', 'Split-Reservation', 
...
AliasesToExport = 'Get-AzureRmReservationOrder', 'Get-AzureRmReservation', 
