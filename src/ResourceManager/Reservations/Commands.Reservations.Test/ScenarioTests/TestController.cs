...
namespace Microsoft.Azure.Commands.Reservations.Test.ScenarioTests.ScenarioTest
{
    public class TestController : RMTestBase
    {
            ...
            string mockName)
        {
            ...
            using (var context = MockContext.Start(callingClassType, mockName))
            {
                ...
                _helper.SetupModules(AzureModule.AzureResourceManager,
                    ...
                    _helper.GetRMModulePath(@"AzureRM.Reservations.psd1"),
        ...
        private static AzureReservationAPIClient GetAzureReservationAPIClient(MockContext context)
        {
            return context.GetServiceClient<AzureReservationAPIClient>(TestEnvironmentFactory.GetTestEnvironment());
        }
    }
}
