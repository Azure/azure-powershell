...
Description = '[PowerShell .Net Core] Microsoft Azure PowerShell - Media service cmdlets for Azure Resource Manager'
...
NestedModules = @('.\Microsoft.Azure.Commands.Media.dll')
...
CmdletsToExport = 'Sync-AzureRmMediaServiceStorageKeys', 'Set-AzureRmMediaServiceKey', 
    ...
    'New-AzureRmMediaServiceStorageConfig', 'Remove-AzureRmMediaService', 
    'New-AzureRmMediaService', 'Get-AzureRmMediaService', 
