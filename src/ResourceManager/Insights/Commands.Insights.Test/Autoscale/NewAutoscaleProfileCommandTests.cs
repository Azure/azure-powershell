...
{
    public class NewAutoscaleProfileCommandTests
    {
        private Mock<ICommandRuntime> commandRuntimeMock;

        public NewAutoscaleProfileCommand Cmdlet { get; set; }

        public NewAutoscaleProfileCommandTests()
        {
            commandRuntimeMock = new Mock<ICommandRuntime>();
            Cmdlet = new NewAutoscaleProfileCommand()
            {
