...
function Test-GetAzureCorrelationIdLog
{
    ...
    {
        # Test
        $actual = Get-AzureLog -CorrelationId $correlation -starttime 2015-03-02T10:00:00 -endtime 2015-03-02T12:00:00 -detailedOutput
...
function Test-GetAzureResourceGroupLog
{
    ...
    try 
    {
	    $actual = Get-AzureLog -ResourceGroup $rgname -starttime 2015-01-15T04:30:00 -endtime 2015-01-15T12:30:00
...
function Test-GetAzureResourceLog
{
    ...
    try 
    {
		$actual = Get-AzureLog -ResourceId $rname -startTime 2015-03-03T15:42:50Z -endTime 2015-03-03T16:42:50Z
...
function Test-GetAzureResourceProviderLog
{
    ...
    try 
    {
		$actual = Get-AzureLog -ResourceProvider $rpname -startTime 2015-03-03T15:42:50Z -endTime 2015-03-03T16:42:50Z
...
function Test-GetAzureSubscriptionIdLog
{
    ...
    {
        # Test
        $actual = Get-AzureLog -starttime 2015-01-15T04:30:00 -endtime 2015-01-15T12:30:00 
