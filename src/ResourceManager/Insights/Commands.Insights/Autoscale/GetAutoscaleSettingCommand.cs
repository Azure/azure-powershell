...
namespace Microsoft.Azure.Commands.Insights.Autoscale
{
    ...
    /// Get an Alert rule
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AutoscaleSetting"), OutputType(typeof(List<AutoscaleSettingResource>))]
    public class GetAutoscaleSettingCommand : ManagementCmdletBase
    {
        internal const string GetAutoscaleSettingParamGroup = "Parameters for GetAustoscaleSetting cmdlet";
        ...
        /// </summary>
        [Parameter(ParameterSetName = GetAutoscaleSettingParamGroup, Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = "The resource group name")]
        ...
        /// </summary>
        [Parameter(ParameterSetName = GetAutoscaleSettingParamGroup, Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = "The autoscale setting name")]
        [ValidateNotNullOrEmpty]
        ...
        /// </summary>
        [Parameter(ParameterSetName = GetAutoscaleSettingParamGroup, ValueFromPipelineByPropertyName = true, HelpMessage = "Return object with all the details of the records (the default is to return only some attributes, i.e. no detail)")]
