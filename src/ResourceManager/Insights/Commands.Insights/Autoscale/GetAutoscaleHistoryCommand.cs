...
namespace Microsoft.Azure.Commands.Insights.Autoscale
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AutoscaleHistory"), OutputType(typeof(List<IPSEventData>))]
    public class GetAutoscaleHistoryCommand : EventCmdletBase
    {
        private static readonly TimeSpan DefaultQueryTimeRange = TimeSpan.FromHours(24);

        public const string AutoscaleEventSourceName = "microsoft.insights/autoscalesettings";
        ...
        {
            return this.AddConditionIfPResent(currentQueryFilter, "eventSource", AutoscaleEventSourceName);
        }
    }
}
