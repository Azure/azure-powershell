...
namespace Microsoft.Azure.Commands.Insights.Metrics
{
    ...
    public class GetAzureRmMetricDefinitionCommand : InsightsClientCmdletBase
    {
        ...
        protected override void ProcessRecordInternal()
        {
            ...
            var response = this.InsightsClient.MetricDefinitions.ListAsync(resourceUri: this.ResourceId, odataQuery: new ODataQuery<MetricDefinition>(queryFilter), cancellationToken: CancellationToken.None).Result;
