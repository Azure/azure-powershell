...
For more information on Monitor, please visit the following: https://docs.microsoft.com/en-us/azure/monitoring-and-diagnostics/'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'General availability for Az.Monitor module.'
