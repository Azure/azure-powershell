...
namespace Microsoft.Azure.Management.Monitor.Management.Models
{
    ...
    /// It is identical to the RecurrentSchedule, but in the old namespace
    /// </summary>
    public class RecurrentSchedule : Monitor.Models.RecurrentSchedule
    {
        /// <summary>
        ...
        /// Initializes a new instance of the RecurrentSchedule class.
        /// </summary>
        /// <param name="recurrentSchedule">The scale rule</param>
        public RecurrentSchedule(Monitor.Models.RecurrentSchedule recurrentSchedule)
            : base(
