...
namespace Microsoft.Azure.Commands.Insights.Alerts
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AlertHistory"), OutputType(typeof(List<IPSEventData>))]
    public class GetAlertHistoryCommand : EventCmdletBase
    {
        private static readonly TimeSpan DefaultQueryTimeRange = TimeSpan.FromHours(24);

        public const string AlertsEventSourceName = "microsoft.insights/alertrules";
