...
namespace Microsoft.Azure.Commands.Insights.ActivityLogAlert
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AzureRmActivityLogAlert", DefaultParameterSetName = GetActivityLogAlertDefaultParamGroup), OutputType(typeof(PSActivityLogAlertResource))]
