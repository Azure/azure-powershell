...
namespace Microsoft.Azure.Commands.Insights.ActivityLogAlert
{
    ...
    public class DisableAzureRmActivityLogAlertCommand : ManagementCmdletBase
    {
        ...
        /// </summary>
        [Parameter(ParameterSetName = DisableActivityLogAlertDeafultParamGroup, Mandatory = false, ValueFromPipeline = true, HelpMessage = "The tags of the activity log alert resource")]
        [ValidateNotNullOrEmpty]
