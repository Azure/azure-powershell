...
namespace Microsoft.Azure.Commands.Insights.ActivityLogAlert
{
    ...
    public class EnableAzureRmActivityLogAlertCommand : ManagementCmdletBase
    {
        ...
        /// </summary>
        [Parameter(ParameterSetName = EnableActivityLogAlertDeafultParamGroup, Mandatory = false, ValueFromPipeline = true, HelpMessage = "The tags of the activity log alert resource")]
        [ValidateNotNullOrEmpty]
