...
{
    public class DataPlaneCommandTests : PowerBIEmbeddedCapacityTestsBase
    {
        private const string testPBIEnvironment = "westcentralus.pbidedicated.windows.net";

        private const string testCapacity = "testcapacity";
        ...
        public void TestAddAzurePBIEAccountCommand()
        {
            Mock<ICommandRuntime> commandRuntimeMock = new Mock<ICommandRuntime>();
            var addAmdlet = new AddAzurePBIEAccountCommand()
            {
                CommandRuntime = commandRuntimeMock.Object
            };
            var expectedProfile = new PBIProfile
            {
                Context = new PBIContext(
                    new PBIAccount()
                    {
                        Id = testUser,
                        Tenant = null
                    },
                    new PBIEnvironment(testPBIEnvironment))
            };
            expectedProfile.Context.Environment.Endpoints.Add(PBIEnvironment.AsRolloutEndpoints.AdAuthorityBaseUrl, PBIClientSession.GetAuthorityUrlForEnvironment(expectedProfile.Context.Environment));
            expectedProfile.Context.Environment.Endpoints.Add(PBIEnvironment.AsRolloutEndpoints.RestartEndpointFormat, PBIClientSession.RestartEndpointPathFormat);
            expectedProfile.Environments.Add(testPBIEnvironment, expectedProfile.Context.Environment);
            expectedProfile.Context.TokenCache = Encoding.ASCII.GetBytes(testToken);

            // Setup
            // Clear the the current profile
            PBIClientSession.Instance.Profile.Environments.Clear();

            var mockAuthenticationProvider = new Mock<IPBIAuthenticationProvider>();
            ...
            PBIClientSession.Instance.SetPBIAuthenticationProvider(mockAuthenticationProvider.Object);

            addAmdlet.RolloutEnvironment = testPBIEnvironment;
            ...
            Assert.Empty(PBIClientSession.Instance.Profile.Environments);
            addAmdlet.ExecuteCmdlet();
            Assert.True(PBIClientSession.Instance.Profile.Environments.Count == 1);
            ...
            Assert.Equal(environment.Endpoints[PBIEnvironment.AsRolloutEndpoints.AdAuthorityBaseUrl], PBIClientSession.GetAuthorityUrlForEnvironment(environment));
            Assert.NotNull(environment.Endpoints[PBIEnvironment.AsRolloutEndpoints.RestartEndpointFormat]);

            commandRuntimeMock.Verify(f => f.WriteObject(PBIClientSession.Instance.Profile));
            mockAuthenticationProvider.Verify(authProvider => authProvider.GetAadAuthenticatedToken(It.IsAny<PBIContext>(),
                    It.IsAny<SecureString>(),
                    It.IsAny<PromptBehavior>(),
                    It.IsAny<string>(),
                    It.IsAny<string>(),
        ...
        public void RestartAzureASInstance_Succeeds()
        {
            ...
            // Set up PBIHttpClient mock
            var mockPBIHttpClient = new Mock<IPBIHttpClient>();
            mockPBIHttpClient
            ...
            mockTokenCacheItemProvider
                ...
                .Returns(testToken);
            var restartCmdlet = new RestartAzurePowerBIEmbeddedCapacity(mockPBIHttpClient.Object, mockTokenCacheItemProvider.Object)
            {
                CommandRuntime = commandRuntimeMock.Object
            };
            ...
            DoLogin(addAmdlet);
            restartCmdlet.Instance = testCapacity;
        ...
        public void ExportAzureASInstanceLogTest()
        {
            ...
            mockPBIHttpClient
                ...
                .Returns(Task<HttpResponseMessage>.FromResult(
                    ...
                    {
                        Content = new StringContent("{\"clusterFQDN\": \"resolved.westcentralus.pbidedicated.windows.net\"}")
                    }));
            mockPBIHttpClient.Setup(obj => obj.CallGetAsync(It.IsAny<Uri>(), It.IsAny<string>(), It.IsAny<string>())).Returns(
            ...
            var exportLogCmdlet = new ExportAzurePowerBIEmbeddedCapacityLog(mockPBIHttpClient.Object, mockTokenCacheItemProvider.Object)
            {
                CommandRuntime = commandRuntimeMock.Object
            };
            ...
            DoLogin(addAmdlet);
            exportLogCmdlet.Instance = testCapacity;
            try
            {
        ...
        public void SynchronizeAzureASInstance_SingleDB_Succeeds()
        {
            ...
            {
                ClusterFQDN = "resolved.westcentralus.pbidedicated.windows.net",
                CoreCapacityName = testCapacity + ":rw",
            ...
            mockTokenCacheItemProvider
                .Setup(obj => obj.GetTokenFromTokenCache(It.IsAny<TokenCache>(), It.IsAny<string>()))
                .Returns(testToken);
            var syncCmdlet = new SynchronizeAzurePowerBIEmbeddedCapacity(mockPBIHttpClient.Object, mockTokenCacheItemProvider.Object)
            {
                CommandRuntime = commandRuntimeMock.Object
            };
            ...
            DoLogin(addAmdlet);
            syncCmdlet.Instance = testCapacity + ":rw";
        ...
        private void DoLogin(AddAzurePBIEAccountCommand addCmdlet)
        {
            Mock<ICommandRuntime> commandRuntimeMock = new Mock<ICommandRuntime>();

            addCmdlet.RolloutEnvironment = testPBIEnvironment;
            var password = new SecureString();
            var testpwd = testPassword;
            testpwd.All(c => {
                password.AppendChar(c);
            ...
            PBIClientSession.TokenCache.Deserialize(Encoding.ASCII.GetBytes(testToken));
