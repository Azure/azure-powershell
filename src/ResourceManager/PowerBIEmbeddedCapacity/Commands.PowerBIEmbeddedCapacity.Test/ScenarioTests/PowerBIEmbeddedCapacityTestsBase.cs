...
{
    public class PowerBIEmbeddedCapacityTestsBase : RMTestBase
    {
        ...
        public static PowerBIEmbeddedCapacityTestsBase NewInstance
        {
            get
            {
                return new PowerBIEmbeddedCapacityTestsBase();
            }
        }


        public PowerBIEmbeddedCapacityTestsBase()
        {
