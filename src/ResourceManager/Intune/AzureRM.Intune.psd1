#
# Module manifest for module 'PSGet_AzureRM.Intune'
#
...
NestedModules = @('.\Microsoft.Azure.Commands.Intune.dll')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = @()

# Cmdlets to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no cmdlets to export.
CmdletsToExport = 'Get-AzureRmIntuneAndroidMAMApp', 
               ...
               'Get-AzureRmIntuneiOSMAMApp', 'Get-AzureRmIntuneiOSMAMPolicyApp', 
               ...
               'Set-AzureRmIntuneiOSMAMPolicy', 'Get-AzureRmIntuneMAMUserDevice', 
               'Invoke-AzureRmIntuneMAMUserDeviceWipe', 
               'Get-AzureRmIntuneMAMFlaggedUser', 'Get-AzureRmIntuneMAMStatus', 
