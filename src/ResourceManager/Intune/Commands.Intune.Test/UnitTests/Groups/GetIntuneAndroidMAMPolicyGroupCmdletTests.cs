...
{
    /// <summary>
    ///  Unit Tests for the GetIntuneAndroidMAMPolicyGroup Cmdlet.
    /// </summary>
    public class GetIntuneAndroidMAMPolicyGroupCmdletTests
    {
        private Mock<IIntuneResourceManagementClient> intuneClientMock;
        private Mock<ICommandRuntime> commandRuntimeMock;
        private GetIntuneAndroidMAMPolicyGroupCmdlet cmdlet;
        private Location expectedLocation;

        /// <summary>
        ///  C'tor for GetIntuneAndroidMAMPolicyGroupCmdletTests class.
        /// </summary>
        public GetIntuneAndroidMAMPolicyGroupCmdletTests(ITestOutputHelper output)
        {
            XunitTracingInterceptor.AddToContext(new XunitTracingInterceptor(output));
            commandRuntimeMock = new Mock<ICommandRuntime>();
            intuneClientMock = new Mock<IIntuneResourceManagementClient>();

            cmdlet = new GetIntuneAndroidMAMPolicyGroupCmdlet();
        ...
        [Fact]
        [Trait(Category.AcceptanceType, Category.CheckIn)]
        public void GetIntuneAndroidMAMPolicyGroupCmdlet_ReturnsNoItem_Test()
        {
