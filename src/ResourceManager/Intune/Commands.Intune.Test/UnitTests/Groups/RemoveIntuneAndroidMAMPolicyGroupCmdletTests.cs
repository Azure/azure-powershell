...
{
    /// <summary>
    ///  Unit Tests for the RemoveIntuneAndroidMAMPolicyGroup Cmdlet.
    /// </summary> 
    public class RemoveIntuneAndroidMAMPolicyGroupCmdletTests
    {
        private Mock<IIntuneResourceManagementClient> intuneClientMock;
        private Mock<ICommandRuntime> commandRuntimeMock;
        private RemoveIntuneAndroidMAMPolicyGroupCmdlet cmdlet;
        private Location expectedLocation;

        /// <summary>
        ///  C'tor for RemoveIntuneAndroidMAMPolicyGroupCmdletTests class.
        /// </summary>
        public RemoveIntuneAndroidMAMPolicyGroupCmdletTests(ITestOutputHelper output)
        {
            XunitTracingInterceptor.AddToContext(new XunitTracingInterceptor(output));
            commandRuntimeMock = new Mock<ICommandRuntime>();
            intuneClientMock = new Mock<IIntuneResourceManagementClient>();

            cmdlet = new RemoveIntuneAndroidMAMPolicyGroupCmdlet();                         
        ...
        public void RemoveIntuneAndroidMAMPolicyGroupCmdletTests_OneItemDeleted_Test()
        {
            ...
            intuneClientMock.Setup(f => f.Android.DeleteGroupForMAMPolicyWithHttpMessagesAsync(
        ...
        [Fact]
        [Trait(Category.AcceptanceType, Category.CheckIn)]
        public void RemoveIntuneAndroidMAMPolicyGroupCmdletTests_NoItemDeleted_Test()
        {
            // Set up expected response
            var expectedRespose = new Microsoft.Rest.Azure.AzureOperationResponse();
