...
{
    /// <summary>
    ///  Unit Tests for the AddIntuneiOSMAMPolicyGroup Cmdlet.
    /// </summary>
    public class AddIntuneiOSMAMPolicyGroupCmdletTests
    {
        private Mock<IIntuneResourceManagementClient> intuneClientMock;
        private Mock<ICommandRuntime> commandRuntimeMock;
        private AddIntuneiOSMAMPolicyGroupCmdlet cmdlet;
        private Location expectedLocation;

        /// <summary>
        ///  C'tor for AddIntuneiOSMAMPolicyGroupCmdletTests class.
        /// </summary>
        public AddIntuneiOSMAMPolicyGroupCmdletTests(ITestOutputHelper output)
        {
            XunitTracingInterceptor.AddToContext(new XunitTracingInterceptor(output));
            commandRuntimeMock = new Mock<ICommandRuntime>();
            intuneClientMock = new Mock<IIntuneResourceManagementClient>();

            cmdlet = new AddIntuneiOSMAMPolicyGroupCmdlet();
