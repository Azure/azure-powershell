...
{
    /// <summary>
    ///  Unit Tests for the RemoveIntuneAndroidMAMPolicyApp Cmdlet.
    /// </summary> 
    public class RemoveIntuneAndroidMAMPolicyAppCmdletTests
    {
        private Mock<IIntuneResourceManagementClient> intuneClientMock;
        private Mock<ICommandRuntime> commandRuntimeMock;
        private RemoveIntuneAndroidMAMPolicyAppCmdlet cmdlet;
        ...
        public RemoveIntuneAndroidMAMPolicyAppCmdletTests(ITestOutputHelper output)
        {
            ...
            cmdlet = new RemoveIntuneAndroidMAMPolicyAppCmdlet();                         
        ...
        public void RemoveIntuneAndroidMAMPolicyAppCmdletTests_OneItemDeleted_Test()
        {
            ...
            intuneClientMock.Setup(f => f.Android.DeleteAppForMAMPolicyWithHttpMessagesAsync(
        ...
        [Fact]
        [Trait(Category.AcceptanceType, Category.CheckIn)]
        public void RemoveIntuneAndroidMAMPolicyAppCmdletTests_NoItemDeleted_Test()
        {
            // Set up expected response
            var expectedRespose = new Microsoft.Rest.Azure.AzureOperationResponse();
