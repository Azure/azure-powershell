// ----------------------------------------------------------------------------------
//D:\Git\Azure-PowerShell\src\ResourceManager\Intune\Commands.Intune\AppOrGroupPayloadMaker.cs
...
{
    /// <summary>
    ///  Unit Tests for the AddIntuneiOSMAMPolicyApp Cmdlet.
    /// </summary>
    public class AddIntuneiOSMAMPolicyAppCmdletTests
    {
        private Mock<IIntuneResourceManagementClient> intuneClientMock;
        private Mock<ICommandRuntime> commandRuntimeMock;
        private AddIntuneiOSMAMPolicyAppCmdlet cmdlet;
        private Location expectedLocation;

        /// <summary>
        ///  C'tor for AddIntuneiOSMAMPolicyAppCmdletTests class.
        /// </summary>
        public AddIntuneiOSMAMPolicyAppCmdletTests(ITestOutputHelper output)
        {
            XunitTracingInterceptor.AddToContext(new XunitTracingInterceptor(output));
            commandRuntimeMock = new Mock<ICommandRuntime>();
            intuneClientMock = new Mock<IIntuneResourceManagementClient>();

            cmdlet = new AddIntuneiOSMAMPolicyAppCmdlet();
