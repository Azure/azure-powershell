...
{
    /// <summary>
    ///  Unit Tests for the GetIntuneiOSMAMApp Cmdlet.
    /// </summary>
    public class GetIntuneiOSMAMPolicyAppCmdletTests
    {
        private Mock<IIntuneResourceManagementClient> intuneClientMock;
        private Mock<ICommandRuntime> commandRuntimeMock;
        private GetIntuneiOSMAMPolicyAppCmdlet cmdlet;
        private Location expectedLocation;

        /// <summary>
        ///  C'tor for GetIntuneiOSMAMPolicyAppCmdletTests class.
        /// </summary>
        public GetIntuneiOSMAMPolicyAppCmdletTests(ITestOutputHelper output)
        {
            XunitTracingInterceptor.AddToContext(new XunitTracingInterceptor(output));
            commandRuntimeMock = new Mock<ICommandRuntime>();
            intuneClientMock = new Mock<IIntuneResourceManagementClient>();

            cmdlet = new GetIntuneiOSMAMPolicyAppCmdlet();
        ...
        public void GetIntuneiOSMAMPolicyAppCmdlet_ReturnsValidItem_Test()
        {
            ...
            intuneClientMock.Setup(f => f.Ios.GetAppForMAMPolicyWithHttpMessagesAsync(
            ...
            intuneClientMock.Setup(f => f.Ios.GetAppForMAMPolicyNextWithHttpMessagesAsync(
                    It.IsAny<string>(),
        ...
        [Fact]
        [Trait(Category.AcceptanceType, Category.CheckIn)]
        public void GetIntuneiOSMAMPolicyAppCmdlet_ReturnsNoItem_Test()
        {
