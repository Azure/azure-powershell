...
namespace Microsoft.Azure.Commands.Intune.Test
{
    ...
    public class GetIntuneAndroidMAMAppCmdletTests
    {
        ...
        public void GetIntuneAndroidMAMApp_ReturnsValidItem_Test()
        {
        ...
        [Fact]
        [Trait(Category.AcceptanceType, Category.CheckIn)]
        public void GetIntuneAndroidMAMApp_ReturnsNoItem_Test()
        {
