...
{
    /// <summary>
    ///  Unit Tests for the RemoveIntuneiOSMAMPolicyApp Cmdlet.
    /// </summary> 
    public class RemoveIntuneiOSMAMPolicyAppCmdletTests
    {
        private Mock<IIntuneResourceManagementClient> intuneClientMock;
        private Mock<ICommandRuntime> commandRuntimeMock;
        private RemoveIntuneiOSMAMPolicyAppCmdlet cmdlet;
        private Location expectedLocation;

        /// <summary>
        ///  C'tor for RemoveIntuneiOSMAMPolicyCmdletTests class.
        /// </summary>
        public RemoveIntuneiOSMAMPolicyAppCmdletTests(ITestOutputHelper output)
        {
            XunitTracingInterceptor.AddToContext(new XunitTracingInterceptor(output));
            commandRuntimeMock = new Mock<ICommandRuntime>();
            intuneClientMock = new Mock<IIntuneResourceManagementClient>();

            cmdlet = new RemoveIntuneiOSMAMPolicyAppCmdlet();                         
        ...
        public void RemoveIntuneiOSMAMPolicyAppCmdletTests_OneItemDeleted_Test()
        {
            ...
            intuneClientMock.Setup(f => f.Ios.DeleteAppForMAMPolicyWithHttpMessagesAsync(
        ...
        [Fact]
        [Trait(Category.AcceptanceType, Category.CheckIn)]
        public void RemoveIntuneiOSMAMPolicyAppCmdletTests_NoItemDeleted_Test()
        {
            // Set up expected response
            var expectedRespose = new Microsoft.Rest.Azure.AzureOperationResponse();
