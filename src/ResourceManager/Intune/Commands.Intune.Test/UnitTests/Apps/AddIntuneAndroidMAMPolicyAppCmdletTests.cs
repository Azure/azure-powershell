...
{
    /// <summary>
    ///  Unit Tests for the AddIntuneAndroidMAMPolicyApp Cmdlet.
    /// </summary>
    public class AddIntuneAndroidMAMPolicyAppCmdletTests
    {
        private Mock<IIntuneResourceManagementClient> intuneClientMock;
        private Mock<ICommandRuntime> commandRuntimeMock;
        private AddIntuneAndroidMAMPolicyAppCmdlet cmdlet;
        private Location expectedLocation;

        /// <summary>
        ///  C'tor for AddIntuneAndroidMAMPolicyAppCmdletTests class.
        /// </summary>
        public AddIntuneAndroidMAMPolicyAppCmdletTests(ITestOutputHelper output)
        {
