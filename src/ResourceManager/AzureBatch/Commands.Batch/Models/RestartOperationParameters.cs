...
{
    public class RestartOperationParameters : BatchClientParametersBase
    {
        public RestartOperationParameters(BatchAccountContext context, string jobId, string taskId, PSCloudTask task,
