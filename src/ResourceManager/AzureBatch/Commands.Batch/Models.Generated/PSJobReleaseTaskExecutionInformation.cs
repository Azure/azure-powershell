...
namespace Microsoft.Azure.Commands.Batch.Models
{
    ...
    public class PSJobReleaseTaskExecutionInformation
    {
        ...
        private PSTaskSchedulingError taskSchedulingError;
        ...
        public PSTaskSchedulingError TaskSchedulingError
        {
            get
            {
                if (((this.taskSchedulingError == null) 
                            && (this.omObject.TaskSchedulingError != null)))
                {
                    this.taskSchedulingError = new PSTaskSchedulingError(this.omObject.TaskSchedulingError);
                }
                return this.taskSchedulingError;
            }
        }
    }
}
