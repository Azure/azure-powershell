...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzurePrefix + "BatchComputeNode", DefaultParameterSetName = Constants.IdParameterSet, SupportsShouldProcess = true), OutputType(typeof(void))]
