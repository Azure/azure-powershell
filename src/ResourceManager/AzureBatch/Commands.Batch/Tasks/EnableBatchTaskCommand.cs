...
{
    [Cmdlet(VerbsLifecycle.Enable, Constants.AzureBatchTask, SupportsShouldProcess = true, DefaultParameterSetName = Constants.IdParameterSet), OutputType(typeof(void))]
