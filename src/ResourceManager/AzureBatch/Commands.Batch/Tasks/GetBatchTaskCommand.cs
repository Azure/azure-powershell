...
{
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzurePrefix + "AzureBatchTask", DefaultParameterSetName = Constants.ODataFilterParameterSet),OutputType(typeof(PSCloudTask))]
#if NETSTANDARD
    [Alias("Get-AzureBatchTask")]
#endif
