    ...
    public class FileTests : WindowsAzure.Commands.Test.Utilities.Common.RMTestBase
    {
        ...
        public void TestGetNodeFileByTaskByName()
        {
            ...
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-GetNodeFileByTaskByName '{0}' '{1}' '{2}' '{3}'", BatchController.BatchAccount, jobId, taskId, nodeFileName) }; },
                () =>
                {
        ...
        public void TestListNodeFilesByTaskByFilter()
        {
            ...
            BatchAccountContext context = null;
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-ListNodeFilesByTaskByFilter '{0}' '{1}' '{2}' '{3}' '{4}'", BatchController.BatchAccount, jobId, taskId, nodeFilePrefix, matches) }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                    ScenarioTestHelpers.CreateTestJob(controller, context, jobId);
        ...
        public void TestListNodeFilesByTaskWithMaxCount()
        {
            ...
            BatchAccountContext context = null;
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-ListNodeFilesByTaskWithMaxCount '{0}' '{1}' '{2}' '{3}'", BatchController.BatchAccount, jobId, taskId, maxCount) }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                    ScenarioTestHelpers.CreateTestJob(controller, context, jobId);
        ...
        public void TestListAllNodeFilesByTask()
        {
            ...
            BatchAccountContext context = null;
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-ListAllNodeFilesByTask '{0}' '{1}' '{2}' '{3}'", BatchController.BatchAccount, jobId, taskId, count) }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                    ScenarioTestHelpers.CreateTestJob(controller, context, jobId);
        ...
        public void TestListNodeFilesByTaskRecursive()
        {
            ...
            BatchAccountContext context = null;
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-ListNodeFilesByTaskRecursive '{0}' '{1}' '{2}' '{3}'", BatchController.BatchAccount, jobId, taskId, newFile) }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                    ScenarioTestHelpers.CreateTestJob(controller, context, jobId);
        ...
        public void TestListNodeFileByTaskPipeline()
        {
            ...
            BatchAccountContext context = null;
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-ListNodeFileByTaskPipeline '{0}' '{1}' '{2}' '{3}'", BatchController.BatchAccount, jobId, taskId, count) }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                    ScenarioTestHelpers.CreateTestJob(controller, context, jobId);
        ...
        public void TestGetNodeFileContentByTaskByName()
        {
            ...
            BatchAccountContext context = null;
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-GetNodeFileContentByTaskByName '{0}' '{1}' '{2}' '{3}' '{4}'", BatchController.BatchAccount, jobId, taskId, nodeFileName, fileContents) }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                    ScenarioTestHelpers.CreateTestJob(controller, context, jobId);
        ...
        public void TestGetNodeFileContentByTaskPipeline()
        {
            ...
            BatchAccountContext context = null;
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-GetNodeFileContentByTaskPipeline '{0}' '{1}' '{2}' '{3}' '{4}'", BatchController.BatchAccount, jobId, taskId, nodeFileName, fileContents) }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                    ScenarioTestHelpers.CreateTestJob(controller, context, jobId);
        ...
        public void TestGetNodeFileByComputeNodeByName()
        {
            ...
            controller.RunPsTestWorkflow(
            () => { return new string[] { string.Format("Test-GetNodeFileByComputeNodeByName '{0}' '{1}' '{2}' '{3}'", BatchController.BatchAccount, poolId, computeNodeId, nodeFileName) }; },
            () =>
            {
                context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
        ...
        public void TestListNodeFilesByComputeNodeByFilter()
        {
            ...
            int matches = 2;
            controller.RunPsTestWorkflow(
            () => { return new string[] { string.Format("Test-ListNodeFilesByComputeNodeByFilter '{0}' '{1}' '{2}' '{3}' '{4}'", BatchController.BatchAccount, poolId, computeNodeId, nodeFilePrefix, matches) }; },
            () =>
            {
                context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                computeNodeId = ScenarioTestHelpers.GetComputeNodeId(controller, context, poolId);
        ...
        public void TestListNodeFilesByComputeNodeWithMaxCount()
        {
            ...
            int maxCount = 1;
            controller.RunPsTestWorkflow(
            () => { return new string[] { string.Format("Test-ListNodeFilesByComputeNodeWithMaxCount '{0}' '{1}' '{2}' '{3}'", BatchController.BatchAccount, poolId, computeNodeId, maxCount) }; },
            () =>
            {
                context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                computeNodeId = ScenarioTestHelpers.GetComputeNodeId(controller, context, poolId);
        ...
        public void TestListAllNodeFilesByComputeNode()
        {
            ...
            controller.RunPsTestWorkflow(
            () => { return new string[] { string.Format("Test-ListAllNodeFilesByComputeNode '{0}' '{1}' '{2}' '{3}'", BatchController.BatchAccount, poolId, computeNodeId, count) }; },
            () =>
            {
                context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                computeNodeId = ScenarioTestHelpers.GetComputeNodeId(controller, context, poolId);
        ...
        public void TestListNodeFilesByComputeNodeRecursive()
        {
            ...
            controller.RunPsTestWorkflow(
            () => { return new string[] { string.Format("Test-ListNodeFilesByComputeNodeRecursive '{0}' '{1}' '{2}' '{3}' '{4}'", BatchController.BatchAccount, poolId, computeNodeId, startupFolder, recursiveCount) }; },
            () =>
            {
                context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                computeNodeId = ScenarioTestHelpers.GetComputeNodeId(controller, context, poolId);
        ...
        public void TestListNodeFileByComputeNodePipeline()
        {
            ...
            int count = 4; // shared, startup, workitems, applications
            controller.RunPsTestWorkflow(
            () => { return new string[] { string.Format("Test-ListNodeFileByComputeNodePipeline '{0}' '{1}' '{2}' '{3}'", BatchController.BatchAccount, poolId, computeNodeId, count) }; },
            () =>
            {
                context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                computeNodeId = ScenarioTestHelpers.GetComputeNodeId(controller, context, poolId);
        ...
        public void TestGetNodeFileContentByComputeNodeByName()
        {
            ...
            string computeNodeId = null;
            controller.RunPsTestWorkflow(
            () => { return new string[] { string.Format("Test-GetNodeFileContentByComputeNodeByName '{0}' '{1}' '{2}' '{3}' '{4}'", BatchController.BatchAccount, poolId, computeNodeId, startTaskStdOutName, startTaskStdOutContent) }; },
            () =>
            {
                context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                computeNodeId = ScenarioTestHelpers.GetComputeNodeId(controller, context, poolId);
        ...
        public void TestGetNodeFileContentByComputeNodeByPipeline()
        {
            ...
            string computeNodeId = null;
            controller.RunPsTestWorkflow(
            () => { return new string[] { string.Format("Test-GetNodeFileContentByComputeNodePipeline '{0}' '{1}' '{2}' '{3}' '{4}'", BatchController.BatchAccount, poolId, computeNodeId, startTaskStdOutName, startTaskStdOutContent) }; },
            () =>
            {
                context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                computeNodeId = ScenarioTestHelpers.GetComputeNodeId(controller, context, poolId);
        ...
        public void TestGetRemoteDesktopProtocolFileById()
        {
            ...
            string computeNodeId = null;
            controller.RunPsTestWorkflow(
            () => { return new string[] { string.Format("Test-GetRDPFileById '{0}' '{1}' '{2}'", BatchController.BatchAccount, poolId, computeNodeId) }; },
            () =>
            {
                context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                computeNodeId = ScenarioTestHelpers.GetComputeNodeId(controller, context, poolId);
        ...
        public void TestGetRemoteDesktopProtocolFilePipeline()
        {
            ...
            string computeNodeId = null;
            controller.RunPsTestWorkflow(
            () => { return new string[] { string.Format("Test-GetRDPFilePipeline '{0}' '{1}' '{2}'", BatchController.BatchAccount, poolId, computeNodeId) }; },
            () =>
            {
                context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                computeNodeId = ScenarioTestHelpers.GetComputeNodeId(controller, context, poolId);
        ...
        private void TestDeleteNodeFileByTask(bool usePipeline, string testMethodName)
        {
            ...
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-DeleteNodeFileByTask '{0}' '{1}' '{2}' '{3}' '{4}'", BatchController.BatchAccount, jobId, taskId, filePath, usePipeline ? "1" : "0") }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                    ScenarioTestHelpers.CreateTestJob(controller, context, jobId);
        ...
        private void TestDeleteNodeFileByComputeNode(bool usePipeline, string testMethodName)
        {
            ...
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-DeleteNodeFileByComputeNode '{0}' '{1}' '{2}' '{3}' '{4}'", BatchController.BatchAccount, poolId, computeNodeId, filePath, usePipeline ? "1" : "0") }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                    ScenarioTestHelpers.CreateTestJob(controller, context, jobId);
