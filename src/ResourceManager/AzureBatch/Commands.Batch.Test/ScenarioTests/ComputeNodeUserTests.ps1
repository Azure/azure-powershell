...
function Test-CreateComputeNodeUser
{
    ...
    Remove-AzureBatchComputeNodeUser -PoolId $poolId -ComputeNodeId $computeNodeId -Name $userName -Confirm:$false -BatchContext $context
}
...
function Test-DeleteComputeNodeUser
{
    ...
    Assert-Throws { Remove-AzureBatchComputeNodeUser -PoolId $poolId -ComputeNodeId $computeNodeId -Name $userName -Confirm:$false -BatchContext $context }
}