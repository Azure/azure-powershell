...
namespace Microsoft.Azure.Commands.Batch.Test.ScenarioTests
{
    public class JobTests : WindowsAzure.Commands.Test.Utilities.Common.RMTestBase
    {
        ...
        public void TestNewJob()
        {
            ...
            controller.RunPsTest(string.Format("Test-NewJob '{0}'", BatchController.BatchAccount));
        }
        ...
        public void TestGetJobById()
        {
            ...
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-GetJobById '{0}' '{1}'", BatchController.BatchAccount, jobId) }; },
                () =>
                {
        ...
        public void TestListJobsByFilter()
        {
            ...
            BatchAccountContext context = null;
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-ListJobsByFilter '{0}' '{1}' '{2}'", BatchController.BatchAccount, prefix, matches) }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
        ...
        public void TestGetAndListJobsWithSelect()
        {
            ...
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-GetAndListJobsWithSelect '{0}' '{1}'", BatchController.BatchAccount, jobId) }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                    ScenarioTestHelpers.CreateTestJob(controller, context, jobId);
        ...
        public void TestListJobsWithMaxCount()
        {
            ...
            BatchAccountContext context = null;
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-ListJobsWithMaxCount '{0}' '{1}'", BatchController.BatchAccount, maxCount) }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                    ScenarioTestHelpers.CreateTestJob(controller, context, jobId1);
        ...
        public void TestListAllJobs()
        {
            ...
            BatchAccountContext context = null;
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-ListAllJobs '{0}' '{1}'", BatchController.BatchAccount, count) }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                    ScenarioTestHelpers.CreateTestJob(controller, context, jobId1);
        ...
        public void TestListJobsUnderSchedule()
        {
            ...
            BatchAccountContext context = null;
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-ListJobsUnderSchedule '{0}' '{1}' '{2}' '{3}'", BatchController.BatchAccount, jobScheduleId, jobId, 2) }; },
                () =>
                {
        ...
        public void TestUpdateJob()
        {
            ...
            controller.RunPsTest(string.Format("Test-UpdateJob '{0}' '{1}'", BatchController.BatchAccount, jobId));
        }
        ...
        public void TestDeleteJob()
        {
            ...
            BatchAccountContext context = null;
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-DeleteJob '{0}' '{1}' '0'", BatchController.BatchAccount, jobId) }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                    ScenarioTestHelpers.CreateTestJob(controller, context, jobId);
        ...
        public void TestDeleteJobPipeline()
        {
            ...
            BatchAccountContext context = null;
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-DeleteJob '{0}' '{1}' '1'", BatchController.BatchAccount, jobId) }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                    ScenarioTestHelpers.CreateTestJob(controller, context, jobId);
        ...
        public void TestDisableAndEnableJob()
        {
            ...
            BatchAccountContext context = null;
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-DisableAndEnableJob '{0}' '{1}' '1'", BatchController.BatchAccount, jobId) }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                    ScenarioTestHelpers.CreateTestJob(controller, context, jobId);
        ...
        private void TestTerminateJob(bool usePipeline)
        {
            ...
            controller.RunPsTestWorkflow(
                () => { return new string[] { string.Format("Test-TerminateJob '{0}' '{1}' '{2}'", BatchController.BatchAccount, jobId, usePipeline ? 1 : 0) }; },
                () =>
                {
                    context = ScenarioTestHelpers.GetBatchAccountContextWithKeys(controller, BatchController.BatchAccount);
                    ScenarioTestHelpers.CreateTestJob(controller, context, jobId);
