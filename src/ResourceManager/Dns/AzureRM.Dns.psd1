#
# Module manifest for module 'PSGet_AzureRM.Dns'
#
...
NestedModules = @('.\Microsoft.Azure.Commands.Dns.dll')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fix bug in the piping scenario for Get-AzureRmDnsZone
