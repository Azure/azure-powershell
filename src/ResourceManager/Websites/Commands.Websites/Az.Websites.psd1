...
CmdletsToExport = 'Get-AppServicePlan', 'Set-AppServicePlan', 'New-AppServicePlan', 
               'Remove-AppServicePlan', 'Get-WebAppSlot', 'Get-WebAppSlotConfigName', 
               'Get-WebAppSlotMetrics', 'Get-WebAppSlotPublishingProfile', 
               'New-WebAppSlot', 'Remove-WebAppSlot', 
               'Reset-WebAppSlotPublishingProfile', 'Restart-WebAppSlot', 
               'Set-WebAppSlot', 'Set-WebAppSlotConfigName', 'Start-WebAppSlot', 
               'Stop-WebAppSlot', 'Switch-WebAppSlot', 
               'New-WebAppDatabaseBackupSetting', 'Restore-WebAppBackup', 
               'Get-AppServicePlanMetrics', 'Get-WebAppCertificate', 
               'Get-WebAppSSLBinding', 'New-WebAppSSLBinding', 
               'Remove-WebAppSSLBinding', 'Edit-WebAppBackupConfiguration', 
               'Get-WebAppBackup', 'Get-WebAppBackupConfiguration', 
               'Get-WebAppBackupList', 'Get-WebAppMetrics', 
               'Get-WebAppPublishingProfile', 'Get-WebApp', 'New-WebAppBackup', 
               'Remove-WebApp', 'New-WebApp', 'Remove-WebAppBackup', 
               'Reset-WebAppPublishingProfile', 'Restart-WebApp', 'Set-WebApp', 
               'Start-WebApp', 'Stop-WebApp', 'Get-WebAppSnapshot', 
               'Restore-WebAppSnapshot'

# Variables to export from this module
# VariablesToExport = @()

# Aliases to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no aliases to export.
AliasesToExport = 'Get-AzureRmAppServicePlan', 'Set-AzureRmAppServicePlan', 
