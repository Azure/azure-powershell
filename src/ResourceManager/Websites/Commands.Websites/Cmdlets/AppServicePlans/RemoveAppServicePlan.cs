...
namespace Microsoft.Azure.Commands.WebApps.Cmdlets.AppServicePlans
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Remove, "AzureRmAppServicePlan", SupportsShouldProcess = true, DefaultParameterSetName = ParameterSet1Name), OutputType(typeof(AzureOperationResponse))]
