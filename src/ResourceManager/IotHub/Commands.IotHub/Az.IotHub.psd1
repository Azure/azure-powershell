...
CmdletsToExport = 'Add-IotHubKey', 'Get-IotHubEventHubConsumerGroup', 
               'Get-IotHubConnectionString', 'Get-IotHubJob', 'Get-IotHubKey', 
               'Get-IotHubQuotaMetric', 'Get-IotHub', 'Get-IotHubRegistryStatistic', 
               'Get-IotHubValidSku', 'Add-IotHubEventHubConsumerGroup', 'New-IotHub', 
               'New-IotHubExportDevices', 'New-IotHubImportDevices', 'Remove-IotHub', 
               'Remove-IotHubEventHubConsumerGroup', 'Remove-IotHubKey', 
               'Set-IotHub', 'Update-IotHub', 'Add-IotHubCertificate', 
               'Get-IotHubCertificate', 'Get-IotHubCertificateVerificationCode', 
               'Set-IotHubVerifiedCertificate', 'Remove-IotHubCertificate'

# Variables to export from this module
# VariablesToExport = @()

# Aliases to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no aliases to export.
AliasesToExport = 'Add-AzureRmIotHubKey', 'Get-AzureRmIotHubEventHubConsumerGroup', 
               ...
               'Remove-AzureRmIotHubCertificate', 'Get-AzureRmIotHubEHCG', 
               'Add-AzureRmIotHubEHCG', 'Remove-AzureRmIotHubEHCG', 
               'Set-AzureRmIotHubVC', 'Get-AzureRmIotHubCVC'
