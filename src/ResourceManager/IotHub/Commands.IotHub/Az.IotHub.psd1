...
For more information on IoT Hub, please visit the following: https://docs.microsoft.com/en-us/azure/iot-hub/'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'General availability for Az.IotHub module.'
