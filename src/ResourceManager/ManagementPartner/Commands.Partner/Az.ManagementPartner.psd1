#
# Module manifest for module 'AzureRM.ManagementPartner'
#
...
Description = 'Microsoft Azure PowerShell - Management Partner cmdlets for Azure Resource Manager in PowerShell and PowerShell Core.'
