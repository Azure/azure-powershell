...
Description = '[PowerShell .Net Core] Microsoft Azure PowerShell - Management Partner cmdlets for Azure Resource Manager.'
...
CmdletsToExport = 'Get-ManagementPartner', 'New-ManagementPartner', 
               'Update-ManagementPartner', 'Remove-ManagementPartner'

# Variables to export from this module
# VariablesToExport = @()

# Aliases to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no aliases to export.
AliasesToExport = 'Get-AzureRmManagementPartner', 'New-AzureRmManagementPartner', 
