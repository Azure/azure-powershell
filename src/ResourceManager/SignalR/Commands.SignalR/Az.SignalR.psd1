...
Description = 'Microsoft Azure PowerShell - Azure SignalR service commands for PowerShell and PowerShell Core'
...
NestedModules = @('.\Microsoft.Azure.Commands.SignalR.dll')
