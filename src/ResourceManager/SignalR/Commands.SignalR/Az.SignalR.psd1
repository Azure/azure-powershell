...
For more information on SignalR, please visit the following: https://docs.microsoft.com/en-us/azure/azure-signalr/'
...
RequiredAssemblies = '.\Microsoft.Azure.PowerShell.Strategies.dll', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'General availability for Az.SignalR module.'
