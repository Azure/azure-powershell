...
Description = '[PowerShell .Net Core] Microsoft Azure PowerShell - Consumption service cmdlets for Azure Resource Manager'
...
CmdletsToExport = 'Get-AzConsumptionBudget', 'Get-AzConsumptionMarketplace', 
