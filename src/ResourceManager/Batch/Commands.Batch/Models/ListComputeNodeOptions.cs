...
{
    public class ListComputeNodeOptions : PoolOperationParameters
    {
        public ListComputeNodeOptions(BatchAccountContext context, string poolId, PSCloudPool pool, IEnumerable<BatchClientBehavior> additionalBehaviors = null)
