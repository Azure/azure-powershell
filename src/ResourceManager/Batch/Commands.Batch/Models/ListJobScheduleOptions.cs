...
{
    public class ListJobScheduleOptions : BatchClientParametersBase
    {
        ...
        /// <summary>
        /// If specified, the single job schedule with this identifier will be returned.
        /// </summary>
        public string JobScheduleId { get; set; }

        /// <summary>
        /// The OData filter to use when querying for job schedules.
        /// </summary>
