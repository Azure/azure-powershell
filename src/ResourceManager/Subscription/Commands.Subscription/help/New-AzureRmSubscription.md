...
### Create subscription
```
New-AzureRmSubscription [[-Name] <String>] -OfferType <String> -EnrollmentAccountObjectId <String> [-OwnerObjectId <String[]>] [-OwnerSignInName <String[]>] [-OwnerApplicationId <String[]>] [-AsJob]
```
