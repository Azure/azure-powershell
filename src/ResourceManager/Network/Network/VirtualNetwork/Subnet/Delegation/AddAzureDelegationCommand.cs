...
{
    [Cmdlet(VerbsCommon.Add, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "Delegation", SupportsShouldProcess = false, DefaultParameterSetName = "SetByResource"), OutputType(typeof(PSSubnet))]
    public class AddAzureSubnetDelegation : NetworkBaseCmdlet
    {
        [Parameter(
            Mandatory = true,
