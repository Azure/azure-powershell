...
### System.String
Parameters: NetworkWatcherName (ByValue), ResourceGroupName (ByPropertyName), StorageId (ByPropertyName), StoragePath (ByPropertyName), TargetResourceId (ByPropertyName)
