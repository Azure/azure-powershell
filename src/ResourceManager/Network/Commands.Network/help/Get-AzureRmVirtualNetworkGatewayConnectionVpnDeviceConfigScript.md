...
### System.String
Parameters: DeviceFamily (ByPropertyName), DeviceVendor (ByPropertyName), FirmwareVersion (ByPropertyName), Name (ByPropertyName), ResourceGroupName (ByPropertyName)
