...
```
Get-AzureRmVirtualNetworkGatewayLearnedRoutes -VirtualNetworkGatewayName <String> -ResourceGroupName <String>
 [<CommonParameters>]
```
...
### Example 1
```
PS C:\> Get-AzureRmVirtualNetworkGatewayLearnedRoutes -ResourceGroupName "resourceGroup" -VirtualNetworkGatewayName "gatewayName"
```
