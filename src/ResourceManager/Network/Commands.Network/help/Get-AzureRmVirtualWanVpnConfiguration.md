...
### ByVirtualWanObjectByVpnSiteObject (Default)
```
...
```yaml
Type: PSVpnSite[]
Parameter Sets: ByVirtualWanObjectByVpnSiteObject, ByVirtualWanNameByVpnSiteObject, ByVirtualWanResourceIdByVpnSiteObject
Aliases:
