...
{
    public class PSSecureGatewayApplicationRuleCollection : PSChildResource
    {
        ...
        public void AddRule(PSSecureGatewayApplicationRule rule)
        {
            // Validate
            if (this.Rules != null)
            {
            ...
            {
                this.Rules = new List<PSSecureGatewayApplicationRule>();
            }
