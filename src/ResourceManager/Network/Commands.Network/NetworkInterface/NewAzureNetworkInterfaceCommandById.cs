...
{
    [Cmdlet(VerbsCommon.New, "AzureRmNetworkInterface", SupportsShouldProcess = true), OutputType(typeof(PSNetworkInterface))]
    public class NewAzureNetworkInterfaceCommandById : NetworkInterfaceBaseCmdlet
    {
        [Alias("ResourceName")]
        [Parameter(
            Mandatory = true,
