...
{
    [Cmdlet(VerbsCommon.Set, "AzureRmNetworkInterfaceIpConfiguration"), OutputType(typeof(PSNetworkInterface))]
    public class SetAzureNetworkInterfaceIpConfiguration : NetworkInterfaceBaseCmdlet
    {
        [Alias("ResourceName")]
        [Parameter(
            Mandatory = true,
