...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public partial class RemoveAzureNetworkProfileContainerNetworkInterfaceConfigCommand : NetworkBaseCmdlet
    {
        ...
        public override void Execute()
        {
            ...
            {
                this.NetworkProfile.ContainerNetworkInterfaceConfigurations.Remove(vContainerNetworkInterfaceConfigurations);
            }

            if (this.NetworkProfile.ContainerNetworkInterfaceConfigurations.Count == 0)
            {
                this.NetworkProfile.ContainerNetworkInterfaceConfigurations = null;
            }
