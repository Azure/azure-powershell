...
{
    [Cmdlet("Set", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "ApplicationGatewayAutoscaleConfiguration", SupportsShouldProcess = true), OutputType(typeof(PSApplicationGateway))]
