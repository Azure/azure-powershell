...
{
    [Cmdlet("Get","ApplicationGatewayBackendHttpSettings"),OutputType(typeof(PSApplicationGatewayBackendHttpSettings))]
#if NETSTANDARD
    [Alias("Get-AzureRmApplicationGatewayBackendHttpSettings")]
#endif
