...
{
    [Cmdlet("Get","ApplicationGatewayAuthenticationCertificate"),OutputType(typeof(PSApplicationGatewayAuthenticationCertificate))]
#if NETSTANDARD
    [Alias("Get-AzureRmApplicationGatewayAuthenticationCertificate")]
#endif
