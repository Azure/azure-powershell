...
{
    [Cmdlet("Add","ApplicationGatewayAuthenticationCertificate", SupportsShouldProcess = true), OutputType(typeof(PSApplicationGateway))]
...
#if NETSTANDARD
    [Alias("Add-AzureRmApplicationGatewayAuthenticationCertificate")]
#endif
    {
        [Parameter(
             Mandatory = true,
