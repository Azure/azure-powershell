...
{
    [Cmdlet(VerbsDiagnostic.Test, "AzureRmPrivateIPAddressAvailability", DefaultParameterSetName = "TestByResourceId"), OutputType(typeof(PSIPAddressAvailabilityResult))]
