...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "Delegation"), OutputType(typeof(PSSubnet))]
    public class RemoveAzureSubnetDelegation : AzureSubnetDelegationBase
    {
        [Parameter(
            Mandatory = true,
