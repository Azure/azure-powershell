...
{
    [Cmdlet(VerbsCommon.Set, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "LoadBalancerFrontendIpConfig", SupportsShouldProcess = true), OutputType(typeof(PSLoadBalancer))]
