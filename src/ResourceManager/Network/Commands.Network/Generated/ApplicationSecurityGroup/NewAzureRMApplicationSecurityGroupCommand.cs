...
{
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "ApplicationSecurityGroup", SupportsShouldProcess = true), OutputType(typeof(PSApplicationSecurityGroup))]
