...
{
    [Cmdlet(VerbsCommon.Set, "AzureRmExpressRouteCrossConnection", SupportsShouldProcess = true, DefaultParameterSetName = "ModifyByParameterValues"), OutputType(typeof(PSExpressRouteCrossConnection))]
