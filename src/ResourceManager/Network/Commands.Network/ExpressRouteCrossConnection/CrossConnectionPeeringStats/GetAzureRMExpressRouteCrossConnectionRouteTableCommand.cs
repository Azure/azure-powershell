...
{
    [Cmdlet(VerbsCommon.Get, "AzureRMExpressRouteCrossConnectionRouteTable", DefaultParameterSetName = "SpecifyByParameterValues"), OutputType(typeof(PSExpressRouteCircuitRoutesTable))]
