...
{
    [Cmdlet(VerbsCommon.Get, "AzureRMExpressRouteCrossConnectionArpTable", DefaultParameterSetName = "SpecifyByParameterValues"), OutputType(typeof(PSExpressRouteCircuitArpTable))]
