...
{
    [Cmdlet(VerbsCommon.Get, "AzureRMExpressRouteCrossConnectionRouteTableSummary", DefaultParameterSetName = "SpecifyByParameterValues"), OutputType(typeof(PSExpressRouteCrossConnection))]
