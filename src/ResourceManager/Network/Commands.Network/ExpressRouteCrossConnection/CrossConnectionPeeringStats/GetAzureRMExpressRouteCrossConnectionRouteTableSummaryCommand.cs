...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public class GetAzureRMExpressRouteCrossConnectionRouteTableSummaryCommand : ExpressRouteCrossConnectionBaseCmdlet
    {
        ...
        {
            base.Execute();
            var routeTableSummaries = this.ExpressRouteCrossConnectionClient.ListRouteTableSummary(ResourceGroupName, CrossConnectionName, PeeringType, DevicePath.ToString()).Value.Cast<object>().ToList();
