...
CmdletsToExport = 'Add-AzureRmApplicationGatewayAuthenticationCertificate', 
               ...
               'New-AzureRmFirewallNetworkRule', 'Get-AzureRmInterfaceEndpoint', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Update cmdlet Test-AzureRmNetworkWatcherConnectivity, pass the protocol value to backend.
