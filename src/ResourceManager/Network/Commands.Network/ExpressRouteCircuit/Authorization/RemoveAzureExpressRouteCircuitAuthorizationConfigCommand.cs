...
{
    [Cmdlet(VerbsCommon.Remove, "AzureRmExpressRouteCircuitAuthorizationConfig"), OutputType(typeof(PSExpressRouteCircuit))]
    public class RemoveAzureExpressRouteCircuitAuthorizationConfigCommand : NetworkBaseCmdlet
    {
        [Parameter(
            Mandatory = false,
        ...
        protected override void ProcessRecord()
        {
            ...
            if (auth != null)
            {
                this.Circuit.Authorizations.Remove(auth);
            }
