...
{
    [Cmdlet(VerbsCommon.Get, "AzureRmExpressRouteCircuitAuthorizationConfig"), OutputType(typeof(PSExpressRouteCircuitAuthorization))]
    public class GetAzureExpressRouteCircuitAuthorizationConfigCommand : NetworkBaseCmdlet
    {
        [Parameter(
            Mandatory = false,
