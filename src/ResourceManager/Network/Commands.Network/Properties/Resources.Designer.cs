...
namespace Microsoft.Azure.Commands.Network.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The Nic {0} with multiple IPConfigurations can have one and only one Primary IPConfiguration.
        /// </summary>
        public static string InvalidPrimaryIPConfigurationCount {
            get {
                return ResourceManager.GetString("InvalidPrimaryIPConfigurationCount", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to No IPConfigurations are specified for Nic {0}.
        /// </summary>
        public static string IPConfigurationsNullOrEmpty {
            get {
                return ResourceManager.GetString("IPConfigurationsNullOrEmpty", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to UseIPConfigurations.
        /// </summary>
        public static string UseIPConfigurations {
            get {
                return ResourceManager.GetString("UseIPConfigurations", resourceCulture);
            }
        }
