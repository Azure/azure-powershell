...
{
    [Cmdlet(VerbsCommon.Remove, "AzureRmSecureGatewayNetworkRuleConfig"), OutputType(typeof(PSSecureGatewayNetworkRule))]
    public class RemoveAzureSecureGatewayNetworkRuleConfigCommand : NetworkBaseCmdlet
    {
        [Parameter(
            Mandatory = false,
        ...
        public override void Execute()
        {
            ...
            // Verify if the network rule exists in the SecureGatewayNetworkRuleCollection
            ...
            if (networkRule != null)
            {
                this.SecureGatewayNetworkRuleCollection.Rules.Remove(networkRule);
            }
