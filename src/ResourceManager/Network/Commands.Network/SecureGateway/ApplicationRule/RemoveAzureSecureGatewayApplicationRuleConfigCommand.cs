...
{
    [Cmdlet(VerbsCommon.Remove, "AzureRmSecureGatewayApplicationRuleConfig"), OutputType(typeof(PSSecureGatewayApplicationRule))]
    public class RemoveAzureSecureGatewayApplicationRuleConfigCommand : NetworkBaseCmdlet
    {
        [Parameter(
            Mandatory = false,
        ...
        public override void Execute()
        {
            ...
            // Verify if the application rule exists in the SecureGatewayApplicationRuleCollection
            ...
            {
                this.SecureGatewayApplicationRuleCollection.Rules.Remove(applicationRule);
            }
