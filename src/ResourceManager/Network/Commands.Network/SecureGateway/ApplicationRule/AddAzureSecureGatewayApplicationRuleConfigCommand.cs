...
{
    [Cmdlet(VerbsCommon.Add, "AzureRmSecureGatewayApplicationRuleConfig", SupportsShouldProcess = true), OutputType(typeof(PSSecureGatewayApplicationRuleCollection))]
    public class AddAzureSecureGatewayApplicationRuleConfigCommand : AzureSecureGatewayApplicationRuleConfigBase
    {
        [Parameter(
            Mandatory = true,
        ...
        public override void Execute()
        {
            ...
            this.SecureGatewayApplicationRuleCollection.Rules.Add(applicationRule);
