...
{
    [Cmdlet("Add", "AzureRmNetworkSecurityRuleConfig", SupportsShouldProcess = true), OutputType(typeof(PSNetworkSecurityGroup))]
     public class AddAzureRmNetworkSecurityRuleConfigCommand : NetworkBaseCmdlet
    {
        [Parameter(
            Mandatory = true,
