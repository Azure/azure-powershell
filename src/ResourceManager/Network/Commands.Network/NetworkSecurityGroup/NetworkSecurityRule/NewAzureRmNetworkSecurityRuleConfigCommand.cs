...
{
    [Cmdlet("New", "AzureRmNetworkSecurityRuleConfig", SupportsShouldProcess = true), OutputType(typeof(PSSecurityRule))]
     public class NewAzureRmNetworkSecurityRuleConfigCommand : NetworkBaseCmdlet
    {
        [Parameter(
            Mandatory = false,
        ...
        public override void Execute()
        {
            ...
            WriteObject(vSecurityRules, true);
        }
    }
}
