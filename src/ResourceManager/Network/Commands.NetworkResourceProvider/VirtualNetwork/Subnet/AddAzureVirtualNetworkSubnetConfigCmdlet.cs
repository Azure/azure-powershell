...
{
    [Cmdlet(VerbsCommon.Add, "AzureVirtualNetworkSubnetConfig"), OutputType(typeof(PSVirtualNetwork))]
    public class AddAzureVirtualNetworkSubnetConfigCmdlet : CommonAzureVirtualNetworkSubnetConfigCmdlet
    {
        [Parameter(
            Mandatory = true,
