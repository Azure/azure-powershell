...
{
    [Cmdlet(VerbsCommon.Get, "AzureLoadBalancerRuleConfig"), OutputType(typeof(PSLoadBalancingRule))]
    public class GetAzureLoadBalancerRuleConfigCmdlet : NetworkBaseClient
    {
        [Parameter(
            Mandatory = false,
