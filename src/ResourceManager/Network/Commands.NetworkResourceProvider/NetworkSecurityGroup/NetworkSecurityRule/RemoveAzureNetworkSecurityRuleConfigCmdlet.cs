...
{
    [Cmdlet(VerbsCommon.Remove, "AzureNetworkSecurityRuleConfig"), OutputType(typeof(PSNetworkSecurityRule))]
    public class RemoveAzureNetworkSecurityRuleConfigCmdlet : NetworkBaseClient
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (rule != null)
            {
                this.NetworkSecurityGroup.Properties.Rules.Remove(rule);
            }
