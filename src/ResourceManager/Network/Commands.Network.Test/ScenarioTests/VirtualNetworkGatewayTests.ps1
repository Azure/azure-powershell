    ...
    try 
     {
      ...
      Set-AzureRmVirtualNetworkGatewayVpnClientConfig -VirtualNetworkGateway $expected -VpnClientAddressPool 200.168.0.0/16 -RadiusServerAddress "TestRadiusServer" -RadiusServerSecret "TestRadiusSecret" 
      $expected = Get-AzureRmVirtualNetworkGateway -ResourceGroupName $rgname -name $rname
