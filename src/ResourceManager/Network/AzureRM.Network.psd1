...
CmdletsToExport = 'Add-AzureRmApplicationGatewayAuthenticationCertificate', 
               ...
               'New-AzureRmSecureGatewayIpConfiguration',
               'New-AzureRmSecureGatewayApplicationRuleCollection',
               'New-AzureRmSecureGatewayApplicationRule',
               'New-AzureRmSecureGatewayApplicationRuleAction',
               'New-AzureRmSecureGatewayApplicationRuleProtocol'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added -AsJob support for long-running Network cmdlets. Allows selected cmdlets to run in the background and return a job to track and control progress.
