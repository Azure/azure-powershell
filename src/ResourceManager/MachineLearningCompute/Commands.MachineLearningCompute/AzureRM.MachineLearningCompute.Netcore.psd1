#
# Module manifest for module 'AzureRM.MachineLearningCompute'
#
...
Description = '[PowerShell .Net Core] Microsoft Azure PowerShell - Machine Learning Compute cmdlets for Azure Resource Manager'
...
NestedModules = @('.\Microsoft.Azure.Commands.MachineLearningCompute.dll')
