...
namespace Microsoft.Azure.Commands.LogicApp.Cmdlets
{
    ...
    /// </summary>
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "LogicAppTrigger"), OutputType(typeof(WorkflowTrigger))]
    public class GetAzureLogicAppTriggerCommand : LogicAppBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            {
                var enumerator = this.LogicAppClient.GetWorkflowTriggers(this.ResourceGroupName, this.Name).GetEnumerator();
                this.WriteObject(enumerator.ToIEnumerable(), true);
            }
            else
            {
                this.WriteObject(this.LogicAppClient.GetWorkflowTrigger(this.ResourceGroupName, this.Name, this.TriggerName), true);
            }
        }
    }
}
