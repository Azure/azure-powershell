...
namespace Microsoft.Azure.Commands.LogicApp.Cmdlets
{
    ...
    /// <summary>
    /// Gets the integration account generated Edifact interchange control number by agreement name
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AzureRmIntegrationAccountGeneratedEdifactIcn")]
    [OutputType(typeof(IntegrationAccountControlNumber), typeof(IList<QualifiedIntegrationAccountControlNumber>))]
    public class GetAzureIntegrationAccountGeneratedEdifactIcnCommand : LogicAppBaseCmdlet
    {
        ...
        /// <summary>
        /// Executes the get integration account Edifact control number command.
        /// </summary>
            ...
            this.WriteObject(
                sendToPipeline: string.IsNullOrEmpty(this.AgreementName) ?
                    this.IntegrationAccountClient.ListIntegrationAccountGeneratedIcns(
                        ...
                        agreementType: Management.Logic.Models.AgreementType.Edifact) as object :
