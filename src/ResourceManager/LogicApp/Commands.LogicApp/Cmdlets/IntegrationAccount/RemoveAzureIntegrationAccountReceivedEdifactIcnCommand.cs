...
namespace Microsoft.Azure.Commands.LogicApp.Cmdlets
{
    ...
    /// <summary>
    /// Removes the integration account Edifact received interchange control number.
    /// </summary>
    ...
    [Cmdlet(VerbsCommon.Remove, "AzureRmIntegrationAccountReceivedEdifactIcn", SupportsShouldProcess = true)]
    public class RemoveAzureIntegrationAccountReceivedEdifactIcnCommand : LogicAppBaseCmdlet
    {
        ...
        /// <summary>
        /// Executes the command to remove integration account Edifact control number
        /// </summary>
