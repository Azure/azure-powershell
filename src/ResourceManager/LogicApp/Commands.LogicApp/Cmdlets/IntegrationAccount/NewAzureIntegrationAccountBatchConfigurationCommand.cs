...
namespace Microsoft.Azure.Commands.LogicApp.Cmdlets
{
    ...
    /// </summary>
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "IntegrationAccountBatchConfiguration", SupportsShouldProcess = true)]
    ...
    public class NewAzureIntegrationAccountBatchConfigurationCommand : LogicAppBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            this.WriteObject(this.IntegrationAccountClient.CreateIntegrationAccountBatchConfiguration(this.ResourceGroupName, integrationAccount.Name, this.BatchConfigurationName,
