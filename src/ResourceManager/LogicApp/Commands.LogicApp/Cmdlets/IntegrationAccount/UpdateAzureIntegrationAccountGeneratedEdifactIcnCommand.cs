...
namespace Microsoft.Azure.Commands.LogicApp.Cmdlets
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "AzureRmIntegrationAccountGeneratedEdifactIcn", SupportsShouldProcess = true)]
    [OutputType(typeof(IntegrationAccountControlNumber))]
    public class UpdateAzureIntegrationAccountGeneratedEdifactIcnCommand : LogicAppBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            integrationAccountGeneratedIcn.MessageType = MessageType.Edifact;
