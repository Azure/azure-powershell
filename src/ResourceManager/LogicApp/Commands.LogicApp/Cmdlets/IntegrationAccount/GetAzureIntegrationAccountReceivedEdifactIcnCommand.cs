...
namespace Microsoft.Azure.Commands.LogicApp.Cmdlets
{
    ...
    /// <summary>
    /// Gets the integration account received Edifact interchange control number by agreement name and control number value.
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AzureRmIntegrationAccountReceivedEdifactIcn")]
    [OutputType(typeof(IntegrationAccountControlNumber))]
    public class GetAzureIntegrationAccountReceivedEdifactIcnCommand : LogicAppBaseCmdlet
    {
