...
namespace Microsoft.Azure.Commands.LogicApp.Cmdlets
{
    ...
    /// <summary>
    /// Updates the integration account received Edifact interchange control number.
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "AzureRmIntegrationAccountReceivedEdifactIcn", SupportsShouldProcess = true)]
    [OutputType(typeof(IntegrationAccountControlNumber))]
    public class UpdateAzureIntegrationAccountReceivedEdifactIcnCommand : LogicAppBaseCmdlet
    {
        ...
        /// <summary>
        /// Executes the integration account received Edifact control number update command.
        /// </summary>
        public override void ExecuteCmdlet()
        {
            ...
            var integrationAccountReceivedIcn = this.IntegrationAccountClient.GetIntegrationAccountReceivedControlNumber(
                ...
                agreementType: Management.Logic.Models.AgreementType.Edifact,
                controlNumber: this.ControlNumberValue);

            integrationAccountReceivedIcn.MessageType = MessageType.Edifact;
