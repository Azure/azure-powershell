...
namespace Microsoft.Azure.Commands.LogicApp.Cmdlets
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "AzureRmIntegrationAccountGeneratedX12Icn", SupportsShouldProcess = true)]
    [OutputType(typeof(IntegrationAccountControlNumber))]
    public class UpdateAzureIntegrationAccountGeneratedX12IcnCommand : LogicAppBaseCmdlet
    {
