...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'Microsoft Azure PowerShell - LogicApp service cmdlets.
...
* Az.LogicApp takes advantage of greater security with token cache encryption and improved authentication.
