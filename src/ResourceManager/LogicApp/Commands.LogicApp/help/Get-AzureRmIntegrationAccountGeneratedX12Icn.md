...
```
Get-AzureRmIntegrationAccountGeneratedX12Icn -ResourceGroupName <String> -Name <String> [-AgreementName <String>]
 [<CommonParameters>]
```

## DESCRIPTION
This cmdlet is meant to be used in disaster recovery scenarios to retrieve the current value of the generated X12 interchange control number so to write back an increased value with Set-AzureRmIntegrationAccountGeneratedX12Icn.
...
### Example 1
```
PS C:\> Get-AzureRmIntegrationAccountGeneratedX12Icn -ResourceGroupName "ResourceGroup1" -Name "IntegrationAccount1" -AgreementName "IntegrationAccountAgreement1"
ControlNumber            : 1000
...
### Example 2
```
PS C:\> Get-AzureRmIntegrationAccountGeneratedX12Icn -ResourceGroupName "ResourceGroup1" -Name "IntegrationAccount1"
ControlNumber            : 1000
