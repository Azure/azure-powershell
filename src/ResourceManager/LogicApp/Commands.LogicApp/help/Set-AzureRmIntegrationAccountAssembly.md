...
```
Set-AzureRmIntegrationAccountAssembly -ResourceGroupName <String> -Name <String> -AssemblyName <String>
 [-AssemblyFilePath <String>] [-AssemblyDefinition <Byte[]>] [-Metadata <Object>] [-Force]
...
### -AssemblyDefinition
The integration account assembly definition.
