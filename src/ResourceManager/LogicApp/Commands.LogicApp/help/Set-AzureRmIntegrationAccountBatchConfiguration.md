...
```
Set-AzureRmIntegrationAccountBatchConfiguration -ResourceGroupName <String> -Name <String>
 -BatchConfigurationName <String> [-BatchConfigurationFilePath <String>]
 [-BatchConfigurationDefinition <String>] [-Metadata <Object>] [-Force]
