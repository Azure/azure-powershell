...
<#
.SYNOPSIS
Test Get-AzureRmIntegrationAccountReceivedX12Icn command
#>
function Test-GetIntegrationAccountReceivedX12Icn
{
	...
	Assert-ThrowsContains { Get-AzureRmIntegrationAccountReceivedX12Icn -ResourceGroupName "Random83da135" -Name "DoesNotMatter" -AgreementName "DoesNotMatter" -controlNumberValue "DoesNotMatter" } "Operation returned an invalid status code 'NotFound'"
	...
	Assert-ThrowsContains { Get-AzureRmIntegrationAccountReceivedX12Icn -ResourceGroupName $resourceGroup.ResourceGroupName -Name "Random83da135" -AgreementName "DoesNotMatter" -ControlNumberValue "DoesNotMatter" } "Operation returned an invalid status code 'NotFound'"
	...
	Assert-ThrowsContains { Get-AzureRmIntegrationAccountReceivedX12Icn -ResourceGroupName $resourceGroup.ResourceGroupName -Name $integrationAccountName -AgreementName $integrationAccountX12AgreementName -ControlNumberValue "1000" } "Operation returned an invalid status code 'NotFound'"
	...
	Assert-ThrowsContains { Get-AzureRmIntegrationAccountReceivedX12Icn -ResourceGroupName $resourceGroup.ResourceGroupName -Name $integrationAccountName -AgreementName $integrationAccountX12AgreementName -ControlNumberValue "1000" } "is not in a valid format."
	...
	$result =  Get-AzureRmIntegrationAccountReceivedX12Icn -ResourceGroupName $resourceGroup.ResourceGroupName -Name $integrationAccountName -AgreementName $integrationAccountX12AgreementName -ControlNumberValue "1000"
...
<#
.SYNOPSIS
Test Remove-AzureRmIntegrationAccountReceivedX12Icn command
#>
function Test-RemoveIntegrationAccountReceivedX12Icn
{
	$agreementX12FilePath = "$TestOutputRoot\Resources\IntegrationAccountX12AgreementContent.json"
	$agreementX12Content = [IO.File]::ReadAllText($agreementX12FilePath)
	...
	Assert-ThrowsContains { Get-AzureRmIntegrationAccountReceivedX12Icn -ResourceGroupName $resourceGroup.ResourceGroupName -Name $integrationAccountName -AgreementName $integrationAccountAgreementName -ControlNumberValue "1000" } "Operation returned an invalid status code 'NotFound'"

	# Verify removing non-existing control number records is allowed.
	Remove-AzureRmIntegrationAccountReceivedX12Icn -ResourceGroupName $resourceGroup.ResourceGroupName -Name $integrationAccountName -AgreementName $integrationAccountAgreementName -ControlNumberValue "1000"
	...
	$initialControlNumber = Get-AzureRmIntegrationAccountReceivedX12Icn -ResourceGroupName $resourceGroup.ResourceGroupName -Name $integrationAccountName -AgreementName $integrationAccountAgreementName -ControlNumberValue "1000"
	...
	Assert-ThrowsContains { Remove-AzureRmIntegrationAccountReceivedX12Icn -ResourceGroupName $resourceGroup.ResourceGroupName -Name $integrationAccountName -AgreementName $integrationAccountAgreementName } "Cannot process command because of one or more missing mandatory parameters: ControlNumberValue."
...
<#
.SYNOPSIS
Test Set-AzureRmIntegrationAccountReceivedX12Icn command
#>
function Test-UpdateIntegrationAccountReceivedX12Icn
{
	$agreementX12FilePath = "$TestOutputRoot\Resources\IntegrationAccountX12AgreementContent.json"
	$agreementX12Content = [IO.File]::ReadAllText($agreementX12FilePath)
	...
	Set-AzureRmIntegrationAccountReceivedX12Icn -ResourceGroupName $resourceGroup.ResourceGroupName -Name $integrationAccountName -AgreementName $integrationAccountAgreementName -ControlNumberValue "1000" -IsMessageProcessingFailed $true

	$updatedControlNumber = Get-AzureRmIntegrationAccountReceivedX12Icn -ResourceGroupName $resourceGroup.ResourceGroupName -Name $integrationAccountName -AgreementName $integrationAccountAgreementName -ControlNumberValue "1000"
	...
	Set-AzureRmIntegrationAccountReceivedX12Icn -ResourceGroupName $resourceGroup.ResourceGroupName -Name $integrationAccountName -AgreementName $integrationAccountAgreementName -ControlNumberValue "1000" -IsMessageProcessingFailed $false
