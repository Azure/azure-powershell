...
namespace Microsoft.Azure.Commands.LogicApp.Test.ScenarioTests
{
    ...
    public class WorkflowTests : RMTestBase
    {
        ...
        {
            WorkflowController.NewInstance.RunPowerShellTest(this._logger, "Test-CreateAndRemoveLogicApp");
        }
        ...
        {
            WorkflowController.NewInstance.RunPowerShellTest(this._logger, "Test-CreateLogicAppWithDuplicateName");
        }
        ...
        {
            WorkflowController.NewInstance.RunPowerShellTest(this._logger, "Test-CreateLogicAppUsingInputfromWorkflowObject");
        }
        ...
        {
            WorkflowController.NewInstance.RunPowerShellTest(this._logger, "Test-CreateLogicAppUsingInputParameterAsHashTable");
        }
        ...
        {
            WorkflowController.NewInstance.RunPowerShellTest(this._logger, "Test-CreateLogicAppUsingDefinitionWithTriggers");
        }
        ...
        {
            WorkflowController.NewInstance.RunPowerShellTest(this._logger, "Test-CreateAndGetLogicAppUsingDefinitionWithActions");
        }
        ...
        {
            WorkflowController.NewInstance.RunPowerShellTest(this._logger, "Test-RemoveNonExistingLogicApp");
        }

        /// <summary>
        ///Test Set-AzureLogicApp command to update workflow definition without parameters.
        ///Test Set-AzureLogicApp command to update workflow definition and state to Disabled.
        ...
        {
            WorkflowController.NewInstance.RunPowerShellTest(this._logger, "Test-UpdateLogicApp");
        }
        ...
        {
            WorkflowController.NewInstance.RunPowerShellTest(this._logger, "Test-GetUpgradedDefinitionForLogicApp");
        }
        ...
        {
            WorkflowController.NewInstance.RunPowerShellTest(this._logger, "Test-UpdateLogicAppWithIntegrationAccount");
        }
    }
}