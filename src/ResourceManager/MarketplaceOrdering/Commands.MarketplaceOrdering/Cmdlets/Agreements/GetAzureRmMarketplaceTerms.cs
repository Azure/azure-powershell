...
{
    [Cmdlet(VerbsCommon.Get, "AzureRmMarketplaceTerms", DefaultParameterSetName = Constants.ParameterSetNames.AgreementParameterSet), OutputType(typeof(AgreementTerms), typeof(AgreementTerms))]
    public class GetAzureRmMarketplaceTerms : AzureMarketplaceOrderingCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            try
            {
                ...
                {
                    WriteObject(MarketplaceOrderingAgreementsClient.MarketplaceAgreements.Get(Publisher, Product, Name));
                }
