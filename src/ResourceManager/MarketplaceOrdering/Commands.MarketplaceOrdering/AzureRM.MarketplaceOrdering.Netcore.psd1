#
# Module manifest for module 'AzureRM.MarketplaceOrdering'
#
...
Description = '[PowerShell .Net Core] Microsoft Azure PowerShell - MarketplaceOrdering agreements service cmdlets for Azure Resource Manager'
