...
```
New-AzureToAzureDiskReplicationConfiguration -VhdUri <String> -LogStorageAccountId <String>
...
### Example 1
```powershell
PS C:\> New-AzureToAzureDiskReplicationConfiguration -VhdUri  $vhdUri -RecoveryAzureStorageAccountId $recoveryStorageAccountId -LogStorageAccountId $logStorageAccountId 
```
...
### Microsoft.Azure.Commands.RecoveryServices.SiteRecovery.ASRAzureToAzureDiskReplicationConfiguration
