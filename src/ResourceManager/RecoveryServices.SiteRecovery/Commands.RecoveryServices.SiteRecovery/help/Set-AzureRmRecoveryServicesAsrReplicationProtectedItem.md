...
Set-AzureRmRecoveryServicesAsrReplicationProtectedItem -InputObject <ASRReplicationProtectedItem>
 ...
 [-RecoveryResourceGroupId <String>] [-LicenseType <String>] [-AvailabilitySet <String>]
 [-UseManagedDisks <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
