...
namespace Microsoft.Azure.Commands.RecoveryServices.SiteRecovery
{
    ...
    public class ASRvCenter
    {
        ...
        public ASRvCenter(VCenter vServer)
        {
            this.ID = vServer.Id;
            this.Name = vServer.Name;
            this.FriendlyName = vServer.Properties.FriendlyName;
            this.Server = vServer.Properties.IpAddress;
            this.Port = vServer.Properties.Port;
            this.FabricArmResourceName = vServer.Properties.FabricArmResourceName;
            this.ProcessServerId = vServer.Properties.ProcessServerId;
            this.AccountId = vServer.Properties.RunAsAccountId;
            this.DiscoveryStatus = vServer.Properties.DiscoveryStatus;
            this.LastHeartbeat = vServer.Properties.LastHeartbeat;
        }
