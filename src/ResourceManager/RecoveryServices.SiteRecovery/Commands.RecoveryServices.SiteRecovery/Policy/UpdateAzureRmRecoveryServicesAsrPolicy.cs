...
namespace Microsoft.Azure.Commands.RecoveryServices.SiteRecovery
{
    ...
    public class UpdateAzureRmRecoveryServicesAsrPolicy : SiteRecoveryCmdletBase
    {
        ...
        public override void ExecuteSiteRecoveryCmdlet()
        {
            ...
            if (policy.ReplicationProvider.Equals(this.InputObject.ReplicationProvider))
            {
        ...
        private void UpdateV2APolicyObject()
        {
            ...
            this.multiVmSyncStatus = this.EnableMultiVmSync == null
                ? replicationProviderSettings.MultiVmSyncStatus
                : this.EnableMultiVmSync == true
                        ? Constants.Enable
                        : Constants.Disable;
