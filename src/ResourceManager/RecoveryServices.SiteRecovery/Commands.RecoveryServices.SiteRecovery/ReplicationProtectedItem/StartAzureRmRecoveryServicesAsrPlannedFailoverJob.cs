...
namespace Microsoft.Azure.Commands.RecoveryServices.SiteRecovery
{
    ...
    /// </summary>
    [Cmdlet(VerbsLifecycle.Start, "AzureRmRecoveryServicesAsrPlannedFailoverJob", DefaultParameterSetName = ASRParameterSets.ByRPIObject)]
    [Alias("Start-ASRPFO", "Start-ASRPlannedFailoverJob")]
