...
@{
    ...
    "Start-ASRResync" = "Start-AzureRmRecoveryServicesAsrResynchronizeReplication";
    "Start-ASRResynchronizeReplication" = "Start-AzureRmRecoveryServicesAsrResynchronizeReplication";
    "Start-ASRSwitchProcessServer" = "Start-AzureRmRecoveryServicesAsrSwitchProcessServer";
