...
namespace Microsoft.Azure.Commands.RecoveryServices.SiteRecovery
{
    ...
    [Cmdlet(
        ...
        "AzureRmRecoveryServicesAsrSwitchProcessServer",
        DefaultParameterSetName = ASRParameterSets.Default,
        SupportsShouldProcess = true)]
    [Alias("Start-ASRSwitchProcessServer")]
    [OutputType(typeof(ASRJob))]
    public class StartAzureRmRecoveryServicesAsrSwitchProcessServer : SiteRecoveryCmdletBase
    {
        /// <summary>
        ...
        public override void ExecuteSiteRecoveryCmdlet()
        {
                ...
                "Switch the process server"))
            {
                ...
                if (this.ReplicationProtectedItem!= null)
                {
                    ...
                    failoverPSRequestProperties.VmsToMigrate = this.rpiList;
        ...
        /// <summary>
        ///     Gets or sets List of Names of the Replicated Protected Item.
        /// </summary>
        private IList<string> rpiList;
