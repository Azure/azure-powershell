...
CmdletsToExport = 'Get-CognitiveServicesAccount', 
               'Get-CognitiveServicesAccountKey', 
               'Get-CognitiveServicesAccountSkus', 
               'Get-CognitiveServicesAccountUsage', 
               'New-CognitiveServicesAccount', 
               'New-CognitiveServicesAccountKey', 
               'Remove-CognitiveServicesAccount', 
               'Set-CognitiveServicesAccount'
