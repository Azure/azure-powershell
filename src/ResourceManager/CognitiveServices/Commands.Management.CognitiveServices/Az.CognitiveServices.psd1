...
Description = 'Microsoft Azure PowerShell - Cognitive Services management cmdlets for Azure Resource Manager in PowerShell and PowerShell Core. Creates and manages cognitive services accounts in Azure Resource Manager.'
...
NestedModules = @('.\Microsoft.Azure.PowerShell.Cmdlets.Management.CognitiveServices.dll')
