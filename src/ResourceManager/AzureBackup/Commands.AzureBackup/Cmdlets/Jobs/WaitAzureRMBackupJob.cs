        ...
        public override void ExecuteCmdlet()
        {
            ...
            ExecutionBlock(() =>
            {
                ...
                while (true)
                {
                    ...
                    {
                        Mgmt.CSMJobDetailsResponse retrievedJob = AzureBackupClient.BackupGetJobDetails(Vault.ResourceGroupName, Vault.Name, pendingJobs[i]);
                ...
                {
                    Mgmt.CSMJobDetailsResponse retrievedJob = AzureBackupClient.BackupGetJobDetails(Vault.ResourceGroupName, Vault.Name, jobId);
