    ...
    public class RestoreAzureRMBackupItem : AzureBackupRestoreBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            ExecutionBlock(() =>
            {
                ...
                Guid operationId = CommonHydraHelper.BackupTriggerRestore(RecoveryPoint.ResourceGroupName, RecoveryPoint.ResourceName, RecoveryPoint.ContainerUniqueName, RecoveryPoint.ItemName, RecoveryPoint.RecoveryPointName, csmRestoreRequest);
