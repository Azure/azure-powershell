    ...
    public class GetAzureRMBackupRecoveryPoint : AzureRMBackupDSCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            ExecutionBlock(() =>
            {
                ...
                {
                    CSMRecoveryPointResponse recoveryPointObject = CommonHydraHelper.BackupGetRecoveryPoint(Item.ResourceGroupName, Item.ResourceName, Item.ContainerUniqueName, Item.ItemName, RecoveryPointId);
                ...
                {
                    IEnumerable<CSMRecoveryPointResponse> recoveryPointListResponse = CommonHydraHelper.BackupListRecoveryPoints(Item.ResourceGroupName, Item.ResourceName, Item.ContainerUniqueName, Item.ItemName);
