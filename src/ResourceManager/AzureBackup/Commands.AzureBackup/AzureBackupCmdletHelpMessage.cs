...
namespace Microsoft.Azure.Commands.AzureBackup.Cmdlets
{
    internal static class AzureBackupCmdletHelpMessage
    {
        ...
        /* Enable-AzBackupContainerReregistration */
        public const string AzureBackupContainerToReregister = "The Azure Backup container to be unregistered. For this commandlet, the container cannot be of type AzureVM. Use the Get-AzBackupContainer to get a list of containers.";

        /* Disable-AzBackupProtection */
        ...
        /* Unregister-AzBackupContainer */
        public const string AzureBackupContainerToUnregister = "The Azure Backup container to be unregistered. This can be a Windows Server, an Azure IaaS VM, or a Data Protection Manager server. Use the Get-AzBackupContainer to get a list of containers.";
        ...
        /* New-AzBackupRetentionPolicyObject */
        ...
        public const string AzureBackUpRecoveryPoint = "The PowerShell object that refers to the recovery point. Use Get-AzBackupRecoveryPoint to get the PowerShell object to be used as input to this commandlet.";
