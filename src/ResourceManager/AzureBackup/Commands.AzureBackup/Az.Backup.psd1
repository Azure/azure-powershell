...
CmdletsToExport = 'Backup-AzBackupItem', 'Enable-AzBackupContainerReregistration', 
               'Get-AzBackupContainer', 'Register-AzBackupContainer', 
               'Unregister-AzBackupContainer', 'Enable-AzBackupProtection', 
               'Get-AzBackupItem', 'Get-AzBackupJob', 'Get-AzBackupJobDetails', 
               'Stop-AzBackupJob', 'Wait-AzBackupJob', 
               'Get-AzBackupProtectionPolicy', 'New-AzBackupProtectionPolicy', 
               'New-AzBackupRetentionPolicyObject', 
               'Remove-AzBackupProtectionPolicy', 'Set-AzBackupProtectionPolicy', 
               'Get-AzBackupRecoveryPoint', 'Restore-AzBackupItem', 
               'Get-AzBackupVaultCredentials', 'Get-AzBackupVault', 
               'New-AzBackupVault', 'Remove-AzBackupVault', 'Set-AzBackupVault', 
