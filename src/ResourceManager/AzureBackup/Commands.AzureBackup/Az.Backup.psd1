...
CmdletsToExport = 'Backup-BackupItem', 'Enable-BackupContainerReregistration', 
               'Get-BackupContainer', 'Register-BackupContainer', 
               'Unregister-BackupContainer', 'Enable-BackupProtection', 
               'Get-BackupItem', 'Get-BackupJob', 'Get-BackupJobDetails', 
               'Stop-BackupJob', 'Wait-BackupJob', 'Get-BackupProtectionPolicy', 
               'New-BackupProtectionPolicy', 'New-BackupRetentionPolicyObject', 
               'Remove-BackupProtectionPolicy', 'Set-BackupProtectionPolicy', 
               'Get-BackupRecoveryPoint', 'Restore-BackupItem', 
               'Get-BackupVaultCredentials', 'Get-BackupVault', 'New-BackupVault', 
               'Remove-BackupVault', 'Set-BackupVault', 'Disable-BackupProtection'

# Variables to export from this module
# VariablesToExport = @()

# Aliases to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no aliases to export.
AliasesToExport = 'Backup-AzureRmBackupItem', 
