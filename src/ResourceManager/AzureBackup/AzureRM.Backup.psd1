...
RequiredModules = @(@{ModuleName = 'AzureRM.Profile'; ModuleVersion = '5.0.1'; })
...
FormatsToProcess = '.\Microsoft.Azure.Commands.AzureBackup.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('.\Microsoft.Azure.Commands.AzureBackup.dll')
