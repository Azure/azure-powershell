...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* ''Add-AzureRmAccount'' has been renamed as ''Connect-AzureRmAccount''; an alias has been added for the old cmdlet name, and other aliases (''Login-AzAccount'' and ''Login-AzureRmAccount'') have been redirected to the new cmdlet name.
