...
>>>>>>> 4008978a4fe1b102a910cf37caaa640aba569be2
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fix issue where running ''Clear-AzureRmContext'' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name'
