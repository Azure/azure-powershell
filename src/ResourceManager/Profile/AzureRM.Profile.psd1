...
CmdletsToExport = 'Disable-AzureRmDataCollection', 'Disable-AzureRmContextAutosave', 
               ...
               'Disconnect-AzureRmAccount', 'Get-AzureRmContextAutosaveSetting',
...
AliasesToExport = 'Add-AzureRmAccount', 'Login-AzAccount', 'Login-AzureRmAccount',
               ...
               'Select-AzureRmSubscription', 'Resolve-Error'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* LocationCompleterAttribute added and available for cmdlets which use the -Location parameter
