...
namespace Microsoft.Azure.Management.PowerBIEmbedded
{
    ...
    public static partial class WorkspaceCollectionsOperationsExtensions
    {
            ...
            {
                return operations.CreateAsync(resourceGroupName, workspaceCollectionName, body).GetAwaiter().GetResult();
            }
            ...
            {
                return operations.UpdateAsync(resourceGroupName, workspaceCollectionName, body).GetAwaiter().GetResult();
            }
            ...
            {
                return operations.CheckNameAvailabilityAsync(location, body).GetAwaiter().GetResult();
            }
            ...
            {
                return operations.RegenerateKeyAsync(resourceGroupName, workspaceCollectionName, body).GetAwaiter().GetResult();
            }
            ...
            {
                operations.MigrateAsync(resourceGroupName, body).GetAwaiter().GetResult();
            }
