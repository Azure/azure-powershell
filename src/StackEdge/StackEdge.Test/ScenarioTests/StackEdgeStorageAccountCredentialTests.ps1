...
{	
	...
	# Test
	Assert-ThrowsContains { Get-AzStackEdgeStorageAccountCredential $rgname $dfname $staname  } "not find"
}
...
{	
	...
	try
	{
		$expected = New-AzStackEdgeStorageAccountCredential $rgname $dfname $staname -StorageAccountType $storageAccountType -StorageAccountAccessKey $storageAccountKey -EncryptionKey $encryptionKey
...
{	
	...
	try
	{
		New-AzStackEdgeStorageAccountCredential $rgname $dfname $staname -StorageAccountType $storageAccountType -StorageAccountAccessKey $storageAccountKey -EncryptionKey $encryptionKey
		Remove-AzStackEdgeStorageAccountCredential $rgname $dfname $staname
	}
	finally
	{
