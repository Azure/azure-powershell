...
{
    public class StackEdgeStorageAccountCredentialTests : StackEdgeScenarioTestBase
    {
        ...
        {
            StackEdgeScenarioTestBase.NewInstance.RunPowerShellTest(_logger,
        ...
        {
            StackEdgeScenarioTestBase.NewInstance.RunPowerShellTest(_logger, "Test-CreateStorageAccountCredential");
        }
        ...
        {
            StackEdgeScenarioTestBase.NewInstance.RunPowerShellTest(_logger, "Test-RemoveStorageAccountCredential");
        }
    }
}