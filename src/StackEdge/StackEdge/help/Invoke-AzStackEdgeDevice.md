...
### -FetchUpdate
Downloads the updates on a Stack edge/gateway device
...
### -InstallUpdate
Installs the updates on the Stack edge/gateway device
...
### -ScanForUpdate
Scans for updates on a Stack edge/gateway device.
