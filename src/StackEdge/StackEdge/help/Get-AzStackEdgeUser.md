...
## DESCRIPTION
The **Get-AzStackEdgeUser** cmdlet lists the users configured for a Stack Edge device. You can mention the Name in parameters to get details about a specific user.
