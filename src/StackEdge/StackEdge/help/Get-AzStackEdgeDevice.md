...
## DESCRIPTION
The **Get-AzStackEdgeDevice** cmdlet gets the information about the available Stack Edge Devices. You can specify the Name of the device along with the Resource Group Name to get the information on a specific device. 
...
### -Alert
Fetch the alerts on the Stack edge/gateway device
...
### -ExtendedInfo
Gets additional information for the specified Stack Edge/Stack Gateway device
...
### -NetworkSetting
Gets the network settings of the specified Stack Edge/Stack Gateway device
