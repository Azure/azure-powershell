...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackEdge.Common.Cmdlets.EdgeStorageAccounts
{
    ...
    public class StackEdgeStorageAccountRemoveCmdlet : AzureStackEdgeCmdletBase
    {
        ...
        public PSStackEdgeStorageAccount InputObject { get; set; }
        ...
        private bool Remove()
        {
            this.StackEdgeManagementClient.StorageAccounts.Delete(
                this.DeviceName,
                this.Name,
