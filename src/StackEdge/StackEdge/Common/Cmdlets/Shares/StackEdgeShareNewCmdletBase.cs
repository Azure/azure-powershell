...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackEdge.Common.Cmdlets.Shares
{
    ...
    public class StackEdgeShareNewCmdletBase : AzureStackEdgeCmdletBase
    {
        ...
        private PSStackEdgeShare CreateResourceModel()
        {
            return new PSStackEdgeShare(
                StackEdgeManagementClient.Shares.CreateOrUpdate(
                    this.DeviceName,
                    this.Name,
                    _share,
                    this.ResourceGroupName));
        ...
        private Share AddAzureContainer(Share resourceModel)
        {
