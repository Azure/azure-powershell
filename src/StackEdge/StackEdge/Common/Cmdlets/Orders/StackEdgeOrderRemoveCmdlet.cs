...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackEdge.Common.Cmdlets.Orders
{
    ...
    public class StackEdgeOrderRemoveCmdlet : AzureStackEdgeCmdletBase
    {
        ...
        [ValidateNotNull]
        public PSStackEdgeOrder InputObject { get; set; }
        ...
        private bool Remove()
        {
            this.StackEdgeManagementClient.Orders.Delete(
                this.DeviceName,
