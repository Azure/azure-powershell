...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackEdge.Common.Cmdlets.EdgeStorageContainers
{
    ...
    public class StackEdgeStorageContainerNewCmdlet : AzureStackEdgeCmdletBase
    {
        ...
        private PSStackEdgeStorageContainer CreateResource()
        {
            ...
            return new PSStackEdgeStorageContainer(
                this.StackEdgeManagementClient.Containers.CreateOrUpdate(
                    DeviceName,
