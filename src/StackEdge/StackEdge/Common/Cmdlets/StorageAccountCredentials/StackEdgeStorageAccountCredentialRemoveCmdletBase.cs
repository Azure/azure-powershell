...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackEdge.Common.Cmdlets.StorageAccountCredentials
{
    ...
    public class StackEdgeStorageAccountCredentialRemoveCmdletBase : AzureStackEdgeCmdletBase
    {
        ...
        public PSStackEdgeStorageAccountCredential InputObject { get; set; }
        ...
        private bool Remove()
        {
            this.StackEdgeManagementClient.StorageAccountCredentials.Delete(
                this.DeviceName,
                this.Name,
