...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackEdge.Common.Cmdlets.Triggers
{
    ...
    public class StackEdgeTriggerRemoveCmdlet : AzureStackEdgeCmdletBase
    {
        ...
        [ValidateNotNull]
        [Alias(HelpMessageTrigger.InputObjectAlias)]
        public PSStackEdgeTrigger InputObject { get; set; }
        ...
        private bool Remove()
        {
            this.StackEdgeManagementClient.Triggers.Delete(
                this.DeviceName,
                this.Name,
