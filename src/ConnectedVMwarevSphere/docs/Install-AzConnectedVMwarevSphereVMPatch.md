...
online version: https://docs.microsoft.com/powershell/module/az.connectedvmwarevsphere/install-azconnectedvmwarevspherevmpatch
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConnectedVMwarevSphere.Support.VMGuestPatchClassificationLinux[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConnectedVMwarevSphere.Support.VMGuestPatchRebootSetting
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConnectedVMwarevSphere.Support.VMGuestPatchClassificationWindows[]
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.ConnectedVMwarevSphere.Models.Api20220110Preview.IVirtualMachineInstallPatchesResult
