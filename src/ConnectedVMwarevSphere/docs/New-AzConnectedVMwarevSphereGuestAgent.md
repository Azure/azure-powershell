...
online version: https://docs.microsoft.com/powershell/module/az.connectedvmwarevsphere/new-azconnectedvmwarevsphereguestagent
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConnectedVMwarevSphere.Support.ProvisioningAction
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.ConnectedVMwarevSphere.Models.Api20220110Preview.IGuestAgent
