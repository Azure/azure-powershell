namespace Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.Api202001
{
    ...
    public partial class DomainSecuritySettings
    {
        ...
        internal DomainSecuritySettings(Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonObject json)
        {
            ...
            {_ntlmV1 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("ntlmV1"), out var __jsonNtlmV1) ? (string)__jsonNtlmV1 : (string)NtlmV1;}
            {_tlsV1 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("tlsV1"), out var __jsonTlsV1) ? (string)__jsonTlsV1 : (string)TlsV1;}
            {_syncNtlmPassword = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("syncNtlmPasswords"), out var __jsonSyncNtlmPasswords) ? (string)__jsonSyncNtlmPasswords : (string)SyncNtlmPassword;}
            {_syncKerberosPassword = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("syncKerberosPasswords"), out var __jsonSyncKerberosPasswords) ? (string)__jsonSyncKerberosPasswords : (string)SyncKerberosPassword;}
            {_syncOnPremPassword = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("syncOnPremPasswords"), out var __jsonSyncOnPremPasswords) ? (string)__jsonSyncOnPremPasswords : (string)SyncOnPremPassword;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.Api202001.IDomainSecuritySettings.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.Api202001.IDomainSecuritySettings.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.Api202001.IDomainSecuritySettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonNode node)
        {
