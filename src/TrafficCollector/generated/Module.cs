...
namespace Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector
{
    ...
    public partial class Module
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Runtime.HttpPipeline _pipeline;

        /// <summary>the ISendAsync pipeline instance (when proxy is enabled)</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Runtime.HttpPipeline _pipelineWithProxy;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.AzureTrafficCollector ClientAPI { get; set; }
        ...
        /// <summary>Backing field for <see cref="Instance" /> property.</summary>
        private static Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Module _instance;

        /// <summary>the singleton of this module class</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Module Instance => Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Module._instance?? (Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Module._instance = new Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Module());

        /// <summary>The Name of this module</summary>
        public string Name => @"AzureTrafficCollector";
        ...
        public string ResourceId => @"AzureTrafficCollector";

        /// <param name="invocationInfo">The <see cref="System.Management.Automation.InvocationInfo" /> from the cmdlet</param>
        /// <param name="pipeline">The HttpPipeline for the request</param>

        partial void AfterCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Runtime.HttpPipeline pipeline);

        /// <param name="invocationInfo">The <see cref="System.Management.Automation.InvocationInfo" /> from the cmdlet</param>
        /// <param name="pipeline">The HttpPipeline for the request</param>

        partial void BeforeCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Runtime.HttpPipeline pipeline);
        ...
        /// <returns>An instance of Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Runtime.HttpPipeline for the remote call.</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Runtime.HttpPipeline CreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, string correlationId, string processRecordId, string parameterSetName = null, global::System.Collections.Generic.IDictionary<string,object> extensibleParameters = null)
        {
            Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Runtime.HttpPipeline pipeline = null;
        ...
        {
            /// constructor
            ClientAPI = new Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.AzureTrafficCollector();
            _handler.Proxy = _webProxy;
            _pipeline = new Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Runtime.HttpPipeline(new Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient()));
            _pipelineWithProxy = new Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Runtime.HttpPipeline(new Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient(_handler)));
        }
