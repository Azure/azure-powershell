...
namespace Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.AzureTrafficCollector.Support";
