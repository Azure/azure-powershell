namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <summary>
    /// The Set VpnclientIpsecParameters operation sets the vpnclient ipsec policy for P2S client of virtual network gateway in
    /// the specified resource group through Network resource provider.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] VirtualNetworkGateways_SetVpnclientIpsecParameters=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/setvpnclientipsecparameters"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/virtualNetworkGateway.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1virtualNetworkGateways~1{virtualNetworkGatewayName}~1setvpnclientipsecparameters
    /// profiles:
    ...
    /// variant: SetExpanded
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzVnetGatewayVpnClientIPsecPolicy_SetExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.Alias("Set-AzVpnClientIpsecParameter", "Set-AzVirtualNetworkGatewayVpnClientIPsecParameter")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"The Set VpnclientIpsecParameters operation sets the vpnclient ipsec policy for P2S client of virtual network gateway in the specified resource group through Network resource provider.")]
    ...
    public partial class SetAzVnetGatewayVpnClientIPsecPolicy_SetExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The DH Group used in IKE Phase 1 for initial SA.")]
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Support.DhGroup))]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.DhGroup DHGroup { get => VpnclientIpsecParamsBody.DhGroup; set => VpnclientIpsecParamsBody.DhGroup = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The IPSec encryption algorithm (IKE phase 1).")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Support.IpsecEncryption))]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.IpsecEncryption IPsecEncryption { get => VpnclientIpsecParamsBody.IpsecEncryption; set => VpnclientIpsecParamsBody.IpsecEncryption = value; }

        /// <summary>The IPSec integrity algorithm (IKE phase 1).</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The IPSec integrity algorithm (IKE phase 1).")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Support.IpsecIntegrity))]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.IpsecIntegrity IPsecIntegrity { get => VpnclientIpsecParamsBody.IpsecIntegrity; set => VpnclientIpsecParamsBody.IpsecIntegrity = value; }

        /// <summary>The IKE encryption algorithm (IKE phase 2).</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The IKE encryption algorithm (IKE phase 2).")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Support.IkeEncryption))]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.IkeEncryption IkeEncryption { get => VpnclientIpsecParamsBody.IkeEncryption; set => VpnclientIpsecParamsBody.IkeEncryption = value; }

        /// <summary>The IKE integrity algorithm (IKE phase 2).</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The IKE integrity algorithm (IKE phase 2).")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Support.IkeIntegrity))]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.IkeIntegrity IkeIntegrity { get => VpnclientIpsecParamsBody.IkeIntegrity; set => VpnclientIpsecParamsBody.IkeIntegrity = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The Pfs Group used in IKE Phase 2 for new child SA.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Support.PfsGroup))]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.PfsGroup PfsGroup { get => VpnclientIpsecParamsBody.PfsGroup; set => VpnclientIpsecParamsBody.PfsGroup = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The IPSec Security Association (also called Quick Mode or Phase 2 SA) payload size in KB for P2S client..")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public int SADataSizeInKilobytes { get => VpnclientIpsecParamsBody.SaDataSizeKilobyte; set => VpnclientIpsecParamsBody.SaDataSizeKilobyte = value; }

        /// <summary>
        /// The IPSec Security Association (also called Quick Mode or Phase 2 SA) lifetime in seconds for P2S client.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The IPSec Security Association (also called Quick Mode or Phase 2 SA) lifetime in seconds for P2S client.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int SALifetimeInSeconds { get => VpnclientIpsecParamsBody.SaLifeTimeSecond; set => VpnclientIpsecParamsBody.SaLifeTimeSecond = value; }
        ...
        /// <summary>Backing field for <see cref="VpnclientIpsecParamsBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnClientIPsecParameters _vpnclientIpsecParamsBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.VpnClientIPsecParameters();

        /// <summary>An IPSec parameters for a virtual network gateway P2S connection.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnClientIPsecParameters VpnclientIpsecParamsBody { get => this._vpnclientIpsecParamsBody; set => this._vpnclientIpsecParamsBody = value; }
        ...
        /// <returns>a duplicate instance of SetAzVnetGatewayVpnClientIPsecPolicy_SetExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.SetAzVnetGatewayVpnClientIPsecPolicy_SetExpanded Clone()
        {
            var clone = new SetAzVnetGatewayVpnClientIPsecPolicy_SetExpanded();
            ...
            clone.VpnclientIpsecParamsBody = this.VpnclientIpsecParamsBody;
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkGatewaysSetVpnclientIpsecParameters' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VirtualNetworkGatewaysSetVpnclientIpsecParameters(ResourceGroupName, VnetGatewayName, SubscriptionId, VpnclientIpsecParamsBody, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,VnetGatewayName=VnetGatewayName,SubscriptionId=SubscriptionId,body=VpnclientIpsecParamsBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzVnetGatewayVpnClientIPsecPolicy_SetExpanded" /> cmdlet class.
        /// </summary>
        public SetAzVnetGatewayVpnClientIPsecPolicy_SetExpanded()
        {
