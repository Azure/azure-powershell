namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: DownloadExpanded
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVpnSiteConfiguration_DownloadExpanded", SupportsShouldProcess = true)]
    ...
    public partial class GetAzVpnSiteConfiguration_DownloadExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetAzVpnSiteConfiguration_DownloadExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzVpnSiteConfiguration_DownloadExpanded Clone()
        {
            var clone = new GetAzVpnSiteConfiguration_DownloadExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVpnSiteConfiguration_DownloadExpanded" /> cmdlet class.
        /// </summary>
        public GetAzVpnSiteConfiguration_DownloadExpanded()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VpnSitesConfigurationDownload(SubscriptionId, ResourceGroupName, VirtualWanName, RequestBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,VirtualWanName=VirtualWanName,body=RequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, VirtualWanName=VirtualWanName, body=RequestBody })
                    {
