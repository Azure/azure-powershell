namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: DownloadViaIdentity
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVpnSiteConfiguration_DownloadViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class GetAzVpnSiteConfiguration_DownloadViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetAzVpnSiteConfiguration_DownloadViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzVpnSiteConfiguration_DownloadViaIdentity Clone()
        {
            var clone = new GetAzVpnSiteConfiguration_DownloadViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVpnSiteConfiguration_DownloadViaIdentity" /> cmdlet class.
        /// </summary>
        public GetAzVpnSiteConfiguration_DownloadViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VpnSitesConfigurationDownloadViaIdentity(InputObject.Id, Request, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VpnSitesConfigurationDownload(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VirtualWanName ?? null, Request, onOk, onDefault, this, Pipeline);
                    }
