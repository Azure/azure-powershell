namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzVnetPeering_CreateExpanded1", SupportsShouldProcess = true)]
    ...
    public partial class NewAzVnetPeering_CreateExpanded1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Whether the forwarded traffic from the VMs in the remote virtual network will be allowed/disallowed.")]
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Whether the VMs in the linked virtual network space would be able to access all the VMs in local Virtual network space.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IVirtualNetworkPeering _virtualNetworkPeeringParametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.VirtualNetworkPeering();

        /// <summary>Peerings in a virtual network resource.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IVirtualNetworkPeering VirtualNetworkPeeringParametersBody { get => this._virtualNetworkPeeringParametersBody; set => this._virtualNetworkPeeringParametersBody = value; }
        ...
        /// <returns>a duplicate instance of NewAzVnetPeering_CreateExpanded1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzVnetPeering_CreateExpanded1 Clone()
        {
            var clone = new NewAzVnetPeering_CreateExpanded1();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzVnetPeering_CreateExpanded1" /> cmdlet class.
        /// </summary>
        public NewAzVnetPeering_CreateExpanded1()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkPeeringsCreateOrUpdate1' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VirtualNetworkPeeringsCreateOrUpdate1(ResourceGroupName, VnetName, Name, SubscriptionId, VirtualNetworkPeeringParametersBody, onOk, this, Pipeline);
