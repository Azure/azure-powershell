namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] NetworkWatchers_GetFlowLogStatus=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/queryFlowLogStatus"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/networkWatcher.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1networkWatchers~1{networkWatcherName}~1queryFlowLogStatus
    /// profiles:
    ...
    /// variant: GetExpanded
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzNetworkWatcherFlowLogInformation_GetExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.Alias("Get-AzNetworkWatcherFlowLogStatus")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Queries status of flow log and traffic analytics (optional) on a specified resource.")]
    ...
    public partial class GetAzNetworkWatcherFlowLogInformation_GetExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IFlowLogStatusParameters _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.FlowLogStatusParameters();

        /// <summary>
        /// Parameters that define a resource to query flow log and traffic analytics (optional) status.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IFlowLogStatusParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The target resource where getting the flow log and traffic analytics (optional) status.")]
        ...
        /// <returns>a duplicate instance of GetAzNetworkWatcherFlowLogInformation_GetExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzNetworkWatcherFlowLogInformation_GetExpanded Clone()
        {
            var clone = new GetAzNetworkWatcherFlowLogInformation_GetExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzNetworkWatcherFlowLogInformation_GetExpanded" /> cmdlet class.
        /// </summary>
        public GetAzNetworkWatcherFlowLogInformation_GetExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NetworkWatchersGetFlowLogStatus' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.NetworkWatchersGetFlowLogStatus(ResourceGroupName, NetworkWatcherName, SubscriptionId, ParametersBody, onOk, onDefault, this, Pipeline);
