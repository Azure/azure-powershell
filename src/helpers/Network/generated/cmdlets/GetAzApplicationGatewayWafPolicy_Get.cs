namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Get
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzApplicationGatewayWafPolicy_Get")]
    ...
    public partial class GetAzApplicationGatewayWafPolicy_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzApplicationGatewayWafPolicy_Get" /> cmdlet class.
        /// </summary>
        public GetAzApplicationGatewayWafPolicy_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.WebApplicationFirewallPoliciesGet(ResourceGroupName, Name, SubscriptionId, onOk, this, Pipeline);
