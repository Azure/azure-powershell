namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzNetworkWatcherConnectionMonitor_CreateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class NewAzNetworkWatcherConnectionMonitor_CreateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        public global::System.Management.Automation.SwitchParameter AutoStart { get => ParametersBody.AutoStart ?? default(global::System.Management.Automation.SwitchParameter); set => ParametersBody.AutoStart = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int MonitoringIntervalInSeconds { get => ParametersBody.MonitoringIntervalInSeconds ?? default(int); set => ParametersBody.MonitoringIntervalInSeconds = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IConnectionMonitor _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ConnectionMonitor();

        /// <summary>Parameters that define the operation to create a connection monitor.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IConnectionMonitor ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The ID of the resource used as the source by connection monitor.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IConnectionMonitorTags Tag { get => ParametersBody.Tag ?? null /* object */; set => ParametersBody.Tag = value; }
        ...
        /// <returns>
        /// a duplicate instance of NewAzNetworkWatcherConnectionMonitor_CreateViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzNetworkWatcherConnectionMonitor_CreateViaIdentityExpanded Clone()
        {
            var clone = new NewAzNetworkWatcherConnectionMonitor_CreateViaIdentityExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzNetworkWatcherConnectionMonitor_CreateViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public NewAzNetworkWatcherConnectionMonitor_CreateViaIdentityExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ConnectionMonitorsCreateOrUpdateViaIdentity(InputObject.Id, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ConnectionMonitorsCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.NetworkWatcherName ?? null, InputObject.ConnectionMonitorName ?? null, InputObject.SubscriptionId ?? null, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
