namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzNetworkWatcherTopology_GetViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class GetAzNetworkWatcherTopology_GetViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ITopologyParameters _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.TopologyParameters();

        /// <summary>Parameters that define the representation of topology.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ITopologyParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The name of the target resource group to perform topology on.")]
        ...
        public string TargetResourceGroupName { get => ParametersBody.TargetResourceGroupName ?? null; set => ParametersBody.TargetResourceGroupName = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string TargetSubnetId { get => ParametersBody.TargetSubnetId ?? null; set => ParametersBody.TargetSubnetId = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("TargetVirtualNetworkId")]
        public string TargetVnetId { get => ParametersBody.TargetVnetId ?? null; set => ParametersBody.TargetVnetId = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzNetworkWatcherTopology_GetViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public GetAzNetworkWatcherTopology_GetViaIdentityExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.NetworkWatchersGetTopologyViaIdentity(InputObject.Id, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NetworkWatchersGetTopology(InputObject.ResourceGroupName ?? null, InputObject.NetworkWatcherName ?? null, InputObject.SubscriptionId ?? null, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
