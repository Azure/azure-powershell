namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/virtualNetworkGateway.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1virtualNetworkGateways~1{virtualNetworkGatewayName}~1generatevpnprofile
    /// profiles:
    ...
    /// variant: GenerateViaIdentity
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzVnetGatewayVpnProfile_GenerateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzVnetGatewayVpnProfile_GenerateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnClientParameters _vpnProfile;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnClientParameters VpnProfile { get => this._vpnProfile; set => this._vpnProfile = value; }
        ...
        /// <returns>a duplicate instance of NewAzVnetGatewayVpnProfile_GenerateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzVnetGatewayVpnProfile_GenerateViaIdentity Clone()
        {
            var clone = new NewAzVnetGatewayVpnProfile_GenerateViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzVnetGatewayVpnProfile_GenerateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzVnetGatewayVpnProfile_GenerateViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkGatewaysGenerateVpnProfile' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualNetworkGatewaysGenerateVpnProfileViaIdentity(InputObject.Id, VpnProfile, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysGenerateVpnProfile(InputObject.ResourceGroupName ?? null, InputObject.VnetGatewayName ?? null, InputObject.SubscriptionId ?? null, VpnProfile, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=VpnProfile})
                    {
