namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Create
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzLoadBalancerInboundNatRule_Create", SupportsShouldProcess = true)]
    ...
    public partial class NewAzLoadBalancerInboundNatRule_Create : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IInboundNatRule _inboundNatRule;

        /// <summary>Inbound NAT rule of the load balancer.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Inbound NAT rule of the load balancer.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Inbound NAT rule of the load balancer.",
        SerializedName = @"inboundNatRuleParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IInboundNatRule) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IInboundNatRule InboundNatRule { get => this._inboundNatRule; set => this._inboundNatRule = value; }
        ...
        /// <returns>a duplicate instance of NewAzLoadBalancerInboundNatRule_Create</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzLoadBalancerInboundNatRule_Create Clone()
        {
            var clone = new NewAzLoadBalancerInboundNatRule_Create();
            ...
            clone.InboundNatRule = this.InboundNatRule;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzLoadBalancerInboundNatRule_Create" /> cmdlet class.
        /// </summary>
        public NewAzLoadBalancerInboundNatRule_Create()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.InboundNatRulesCreateOrUpdate(ResourceGroupName, LoadBalancerName, Name, SubscriptionId, InboundNatRule, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,LoadBalancerName=LoadBalancerName,Name=Name,SubscriptionId=SubscriptionId,body=InboundNatRule})
                    {
