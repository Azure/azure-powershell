namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzNetworkSecurityRule_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzNetworkSecurityRule_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of NewAzNetworkSecurityRule_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzNetworkSecurityRule_CreateViaIdentity Clone()
        {
            var clone = new NewAzNetworkSecurityRule_CreateViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzNetworkSecurityRule_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzNetworkSecurityRule_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.SecurityRulesCreateOrUpdateViaIdentity(InputObject.Id, SecurityRule, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.SecurityRulesCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.NsgName ?? null, InputObject.SecurityRuleName ?? null, InputObject.SubscriptionId ?? null, SecurityRule, onOk, this, Pipeline);
                    }
