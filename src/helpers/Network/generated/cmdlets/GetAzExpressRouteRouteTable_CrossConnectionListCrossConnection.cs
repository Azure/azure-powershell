namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ExpressRouteCrossConnections_ListRoutesTable=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCrossConnections/{crossConnectionName}/peerings/{peeringName}/routeTables/{devicePath}"
    /// [METADATA]
    ...
    /// variant: CrossConnectionListCrossConnection
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzExpressRouteRouteTable_CrossConnectionListCrossConnection", SupportsShouldProcess = true)]
    [global::System.Management.Automation.Alias("Get-AzExpressRouteCrossConnectionRouteTable")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Gets the currently advertised routes table associated with the express route cross connection in a resource group.")]
    ...
    public partial class GetAzExpressRouteRouteTable_CrossConnectionListCrossConnection : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of GetAzExpressRouteRouteTable_CrossConnectionListCrossConnection
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzExpressRouteRouteTable_CrossConnectionListCrossConnection Clone()
        {
            var clone = new GetAzExpressRouteRouteTable_CrossConnectionListCrossConnection();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzExpressRouteRouteTable_CrossConnectionListCrossConnection" /> cmdlet
        /// class.
        /// </summary>
        public GetAzExpressRouteRouteTable_CrossConnectionListCrossConnection()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ExpressRouteCrossConnectionsListRoutesTable' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ExpressRouteCrossConnectionsListRoutesTable(ResourceGroupName, CrossConnectionName, PeeringName, DevicePath, SubscriptionId, onOk, this, Pipeline);
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.ExpressRouteCrossConnectionsListRoutesTable_Call(requestMessage, onOk, this, Pipeline);
                    }
                }
            }
        }
