namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzRouteTableRoute_DeleteViaIdentity1", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzRouteTableRoute_DeleteViaIdentity1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzRouteTableRoute_DeleteViaIdentity1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.RemoveAzRouteTableRoute_DeleteViaIdentity1 Clone()
        {
            var clone = new RemoveAzRouteTableRoute_DeleteViaIdentity1();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'RoutesDelete1' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.RoutesDelete1ViaIdentity(InputObject.Id, onOk, onNoContent, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.RoutesDelete1(InputObject.ResourceGroupName ?? null, InputObject.RouteTableName ?? null, InputObject.RouteName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzRouteTableRoute_DeleteViaIdentity1" /> cmdlet class.
        /// </summary>
        public RemoveAzRouteTableRoute_DeleteViaIdentity1()
        {
