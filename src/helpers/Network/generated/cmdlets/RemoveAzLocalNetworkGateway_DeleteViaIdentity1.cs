namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzLocalNetworkGateway_DeleteViaIdentity1", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzLocalNetworkGateway_DeleteViaIdentity1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzLocalNetworkGateway_DeleteViaIdentity1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.RemoveAzLocalNetworkGateway_DeleteViaIdentity1 Clone()
        {
            var clone = new RemoveAzLocalNetworkGateway_DeleteViaIdentity1();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.LocalNetworkGatewaysDelete1ViaIdentity(InputObject.Id, onOk, onNoContent, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.LocalNetworkGatewaysDelete1(InputObject.ResourceGroupName ?? null, InputObject.LocalNetworkGatewayName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzLocalNetworkGateway_DeleteViaIdentity1" /> cmdlet class.
        /// </summary>
        public RemoveAzLocalNetworkGateway_DeleteViaIdentity1()
        {
