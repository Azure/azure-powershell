namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] AvailableEndpointServices_List=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/virtualNetworkAvailableEndpointServices"
    /// [METADATA]
    /// path: '/subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/virtualNetworkAvailableEndpointServices'
    /// apiVersions:
    /// - '2017-10-01'
    /// filename:
    /// - 'mem:///1000?oai3.shaken.json'
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2017-10-01/endpointService.json#/paths/~1subscriptions~1{subscriptionId}~1providers~1Microsoft.Network~1locations~1{location}~1virtualNetworkAvailableEndpointServices
    /// profiles:
    /// hybrid-2019-03-01: '2017-10-01'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: VnetAvailableEndpointService
    /// variant: List
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVnetAvailableEndpointService_List")]
    [global::System.Management.Automation.Alias("Get-AzVirtualNetworkAvailableEndpointService")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IEndpointServiceResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"List what values of endpoint services are available for use.")]
    ...
    public partial class GetAzVnetAvailableEndpointService_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>The location to check available endpoint services.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The location to check available endpoint services.")]
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IEndpointServicesListResult"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IEndpointServicesListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVnetAvailableEndpointService_List" /> cmdlet class.
        /// </summary>
        public GetAzVnetAvailableEndpointService_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AvailableEndpointServicesList(Location, SubscriptionId, onOk, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IEndpointServicesListResult> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.AvailableEndpointServicesList_Call(requestMessage, onOk, this, Pipeline);
                    }
                }
            }
        }
