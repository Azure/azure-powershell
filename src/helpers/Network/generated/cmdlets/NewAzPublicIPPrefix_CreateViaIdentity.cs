namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzPublicIPPrefix_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzPublicIPPrefix_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPublicIPPrefix _publicIPPrefix;

        /// <summary>Public IP prefix resource.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Public IP prefix resource.", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPublicIPPrefix PublicIPPrefix { get => this._publicIPPrefix; set => this._publicIPPrefix = value; }
        ...
        /// <returns>a duplicate instance of NewAzPublicIPPrefix_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzPublicIPPrefix_CreateViaIdentity Clone()
        {
            var clone = new NewAzPublicIPPrefix_CreateViaIdentity();
            ...
            clone.PublicIPPrefix = this.PublicIPPrefix;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzPublicIPPrefix_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzPublicIPPrefix_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PublicIPPrefixesCreateOrUpdateViaIdentity(InputObject.Id, PublicIPPrefix, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PublicIPPrefixesCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.PublicIPPrefixName ?? null, InputObject.SubscriptionId ?? null, PublicIPPrefix, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=PublicIPPrefix})
                    {
