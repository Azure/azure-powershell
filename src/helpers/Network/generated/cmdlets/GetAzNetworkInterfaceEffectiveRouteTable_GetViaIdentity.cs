namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] NetworkInterfaces_GetEffectiveRouteTable=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}/effectiveRouteTable"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/networkInterface.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1networkInterfaces~1{networkInterfaceName}~1effectiveRouteTable
    /// profiles:
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzNetworkInterfaceEffectiveRouteTable_GetViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.Alias("Get-AzEffectiveRouteTable")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IEffectiveRouteListResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Gets all route tables applied to a network interface.")]
    ...
    public partial class GetAzNetworkInterfaceEffectiveRouteTable_GetViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IEffectiveRouteListResult"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IEffectiveRouteListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of GetAzNetworkInterfaceEffectiveRouteTable_GetViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzNetworkInterfaceEffectiveRouteTable_GetViaIdentity Clone()
        {
            var clone = new GetAzNetworkInterfaceEffectiveRouteTable_GetViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzNetworkInterfaceEffectiveRouteTable_GetViaIdentity" /> cmdlet class.
        /// </summary>
        public GetAzNetworkInterfaceEffectiveRouteTable_GetViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NetworkInterfacesGetEffectiveRouteTable' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.NetworkInterfacesGetEffectiveRouteTableViaIdentity(InputObject.Id, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NetworkInterfacesGetEffectiveRouteTable(InputObject.ResourceGroupName ?? null, InputObject.NetworkInterfaceName ?? null, InputObject.SubscriptionId ?? null, onOk, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IEffectiveRouteListResult> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.NetworkInterfacesGetEffectiveRouteTable_Call(requestMessage, onOk, this, Pipeline);
                    }
                }
            }
        }
