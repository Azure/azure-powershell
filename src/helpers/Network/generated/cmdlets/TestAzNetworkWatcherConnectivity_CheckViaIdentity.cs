namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzNetworkWatcherConnectivity_CheckViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class TestAzNetworkWatcherConnectivity_CheckViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IConnectivityParameters _connectivity;
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IConnectivityParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IConnectivityParameters Connectivity { get => this._connectivity; set => this._connectivity = value; }
        ...
        /// <returns>a duplicate instance of TestAzNetworkWatcherConnectivity_CheckViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.TestAzNetworkWatcherConnectivity_CheckViaIdentity Clone()
        {
            var clone = new TestAzNetworkWatcherConnectivity_CheckViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.NetworkWatchersCheckConnectivityViaIdentity(InputObject.Id, Connectivity, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NetworkWatchersCheckConnectivity(InputObject.ResourceGroupName ?? null, InputObject.NetworkWatcherName ?? null, InputObject.SubscriptionId ?? null, Connectivity, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=Connectivity})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzNetworkWatcherConnectivity_CheckViaIdentity" /> cmdlet class.
        /// </summary>
        public TestAzNetworkWatcherConnectivity_CheckViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=Connectivity })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=Connectivity })
                    {
