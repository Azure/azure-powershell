namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Create
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzExpressRouteConnection_Create", SupportsShouldProcess = true)]
    ...
    public partial class NewAzExpressRouteConnection_Create : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ExpressRouteConnection resource.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"ExpressRouteConnection resource.",
        SerializedName = @"putExpressRouteConnectionParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteConnection) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteConnection ExpressRouteConnection { get => this._expressRouteConnection; set => this._expressRouteConnection = value; }
        ...
        /// <returns>a duplicate instance of NewAzExpressRouteConnection_Create</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzExpressRouteConnection_Create Clone()
        {
            var clone = new NewAzExpressRouteConnection_Create();
            ...
            clone.ExpressRouteConnection = this.ExpressRouteConnection;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzExpressRouteConnection_Create" /> cmdlet class.
        /// </summary>
        public NewAzExpressRouteConnection_Create()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ExpressRouteConnectionsCreateOrUpdate(ResourceGroupName, ExpressRouteGatewayName, Name, SubscriptionId, ExpressRouteConnection, onOk, this, Pipeline);
