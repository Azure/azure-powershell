namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: SetExpanded1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzVnetGatewayConnectionSharedKey_SetExpanded1", SupportsShouldProcess = true)]
    ...
    public partial class SetAzVnetGatewayConnectionSharedKey_SetExpanded1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IConnectionSharedKey _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.ConnectionSharedKey();

        /// <summary>Response for GetConnectionSharedKey API service call</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IConnectionSharedKey ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IConnectionSharedKey"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IConnectionSharedKey> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of SetAzVnetGatewayConnectionSharedKey_SetExpanded1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.SetAzVnetGatewayConnectionSharedKey_SetExpanded1 Clone()
        {
            var clone = new SetAzVnetGatewayConnectionSharedKey_SetExpanded1();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkGatewayConnectionsSetSharedKey1' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VirtualNetworkGatewayConnectionsSetSharedKey1(ResourceGroupName, Name, SubscriptionId, ParametersBody, onOk, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzVnetGatewayConnectionSharedKey_SetExpanded1" /> cmdlet class.
        /// </summary>
        public SetAzVnetGatewayConnectionSharedKey_SetExpanded1()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IConnectionSharedKey> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IConnectionSharedKey
                WriteObject((await response).Value);
            }
        }
    }
}