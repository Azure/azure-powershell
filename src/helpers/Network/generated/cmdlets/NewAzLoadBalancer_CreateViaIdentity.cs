namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzLoadBalancer_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzLoadBalancer_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of NewAzLoadBalancer_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzLoadBalancer_CreateViaIdentity Clone()
        {
            var clone = new NewAzLoadBalancer_CreateViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzLoadBalancer_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzLoadBalancer_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.LoadBalancersCreateOrUpdateViaIdentity(InputObject.Id, LoadBalancer, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.LoadBalancersCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.LoadBalancerName ?? null, InputObject.SubscriptionId ?? null, LoadBalancer, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=LoadBalancer})
                    {
