namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: DownloadViaIdentityExpanded
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVpnSiteConfiguration_DownloadViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class GetAzVpnSiteConfiguration_DownloadViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The sas-url to download the configurations for vpn-sites")]
        ...
        public string OutputBlobSasUrl { get => RequestBody.OutputBlobSasUrl ?? null; set => RequestBody.OutputBlobSasUrl = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IGetVpnSitesConfigurationRequest _requestBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.GetVpnSitesConfigurationRequest();

        /// <summary>List of Vpn-Sites</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IGetVpnSitesConfigurationRequest RequestBody { get => this._requestBody; set => this._requestBody = value; }

        /// <summary>List of resource-ids of the vpn-sites for which config is to be downloaded.</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of resource-ids of the vpn-sites for which config is to be downloaded.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] VpnSite { get => RequestBody.VpnSite ?? null /* arrayOf */; set => RequestBody.VpnSite = value; }
        ...
        /// <returns>a duplicate instance of GetAzVpnSiteConfiguration_DownloadViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzVpnSiteConfiguration_DownloadViaIdentityExpanded Clone()
        {
            var clone = new GetAzVpnSiteConfiguration_DownloadViaIdentityExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVpnSiteConfiguration_DownloadViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public GetAzVpnSiteConfiguration_DownloadViaIdentityExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VpnSitesConfigurationDownloadViaIdentity(InputObject.Id, RequestBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VpnSitesConfigurationDownload(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VirtualWanName ?? null, RequestBody, onOk, onDefault, this, Pipeline);
                    }
