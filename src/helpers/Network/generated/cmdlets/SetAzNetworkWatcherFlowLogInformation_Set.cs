namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Set
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzNetworkWatcherFlowLogInformation_Set", SupportsShouldProcess = true)]
    ...
    public partial class SetAzNetworkWatcherFlowLogInformation_Set : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="FlowLogConfiguration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IFlowLogInformation _flowLogConfiguration;
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IFlowLogInformation) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IFlowLogInformation FlowLogConfiguration { get => this._flowLogConfiguration; set => this._flowLogConfiguration = value; }
        ...
        /// <returns>a duplicate instance of SetAzNetworkWatcherFlowLogInformation_Set</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.SetAzNetworkWatcherFlowLogInformation_Set Clone()
        {
            var clone = new SetAzNetworkWatcherFlowLogInformation_Set();
            ...
            clone.FlowLogConfiguration = this.FlowLogConfiguration;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.NetworkWatchersSetFlowLogConfiguration(ResourceGroupName, NetworkWatcherName, SubscriptionId, FlowLogConfiguration, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,NetworkWatcherName=NetworkWatcherName,SubscriptionId=SubscriptionId,body=FlowLogConfiguration})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzNetworkWatcherFlowLogInformation_Set" /> cmdlet class.
        /// </summary>
        public SetAzNetworkWatcherFlowLogInformation_Set()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, NetworkWatcherName=NetworkWatcherName, SubscriptionId=SubscriptionId, body=FlowLogConfiguration })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, NetworkWatcherName=NetworkWatcherName, SubscriptionId=SubscriptionId, body=FlowLogConfiguration })
                    {
