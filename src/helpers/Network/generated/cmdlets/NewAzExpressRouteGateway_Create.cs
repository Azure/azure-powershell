namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Create
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzExpressRouteGateway_Create", SupportsShouldProcess = true)]
    ...
    public partial class NewAzExpressRouteGateway_Create : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteGateway _expressRouteGateway;

        /// <summary>ExpressRoute gateway resource.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ExpressRoute gateway resource.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"ExpressRoute gateway resource.",
        SerializedName = @"putExpressRouteGatewayParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteGateway) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteGateway ExpressRouteGateway { get => this._expressRouteGateway; set => this._expressRouteGateway = value; }
        ...
        /// <returns>a duplicate instance of NewAzExpressRouteGateway_Create</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzExpressRouteGateway_Create Clone()
        {
            var clone = new NewAzExpressRouteGateway_Create();
            ...
            clone.ExpressRouteGateway = this.ExpressRouteGateway;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzExpressRouteGateway_Create" /> cmdlet class.
        /// </summary>
        public NewAzExpressRouteGateway_Create()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ExpressRouteGatewaysCreateOrUpdate(ResourceGroupName, Name, SubscriptionId, ExpressRouteGateway, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,SubscriptionId=SubscriptionId,body=ExpressRouteGateway})
                    {
