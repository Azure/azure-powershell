namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Get
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzNetworkWatcherFlowLogInformation_Get", SupportsShouldProcess = true)]
    ...
    public partial class GetAzNetworkWatcherFlowLogInformation_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="FlowLogStatus" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IFlowLogStatusParameters _flowLogStatus;

        /// <summary>
        /// Parameters that define a resource to query flow log and traffic analytics (optional) status.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters that define a resource to query flow log and traffic analytics (optional) status.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Parameters that define a resource to query flow log and traffic analytics (optional) status.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IFlowLogStatusParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IFlowLogStatusParameters FlowLogStatus { get => this._flowLogStatus; set => this._flowLogStatus = value; }
        ...
        /// <returns>a duplicate instance of GetAzNetworkWatcherFlowLogInformation_Get</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzNetworkWatcherFlowLogInformation_Get Clone()
        {
            var clone = new GetAzNetworkWatcherFlowLogInformation_Get();
            ...
            clone.FlowLogStatus = this.FlowLogStatus;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzNetworkWatcherFlowLogInformation_Get" /> cmdlet class.
        /// </summary>
        public GetAzNetworkWatcherFlowLogInformation_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.NetworkWatchersGetFlowLogStatus(ResourceGroupName, NetworkWatcherName, SubscriptionId, FlowLogStatus, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,NetworkWatcherName=NetworkWatcherName,SubscriptionId=SubscriptionId,body=FlowLogStatus})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, NetworkWatcherName=NetworkWatcherName, SubscriptionId=SubscriptionId, body=FlowLogStatus })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, NetworkWatcherName=NetworkWatcherName, SubscriptionId=SubscriptionId, body=FlowLogStatus })
                    {
