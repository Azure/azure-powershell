namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzVnetSubnetNetworkPolicy_PrepareExpanded", SupportsShouldProcess = true)]
    ...
    public partial class SetAzVnetSubnetNetworkPolicy_PrepareExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The name of the resource group where the Network Intent Policy will be stored.")]
        ...
        public string IntentPolicyResourceGroupName { get => PrepareNetworkPoliciesRequestParametersBody.ResourceGroupName ?? null; set => PrepareNetworkPoliciesRequestParametersBody.ResourceGroupName = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "A list of NetworkIntentPolicyConfiguration.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.INetworkIntentPolicyConfiguration[] NetworkIntentPolicyConfiguration { get => PrepareNetworkPoliciesRequestParametersBody.NetworkIntentPolicyConfiguration ?? null /* arrayOf */; set => PrepareNetworkPoliciesRequestParametersBody.NetworkIntentPolicyConfiguration = value; }
        ...
        /// <summary>
        /// Backing field for <see cref="PrepareNetworkPoliciesRequestParametersBody" /> property.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPrepareNetworkPoliciesRequest _prepareNetworkPoliciesRequestParametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.PrepareNetworkPoliciesRequest();

        /// <summary>Details of PrepareNetworkPolicies for Subnet.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPrepareNetworkPoliciesRequest PrepareNetworkPoliciesRequestParametersBody { get => this._prepareNetworkPoliciesRequestParametersBody; set => this._prepareNetworkPoliciesRequestParametersBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The name of the service for which subnet is being prepared for.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ServiceName { get => PrepareNetworkPoliciesRequestParametersBody.ServiceName ?? null; set => PrepareNetworkPoliciesRequestParametersBody.ServiceName = value; }
        ...
        /// <returns>a duplicate instance of SetAzVnetSubnetNetworkPolicy_PrepareExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.SetAzVnetSubnetNetworkPolicy_PrepareExpanded Clone()
        {
            var clone = new SetAzVnetSubnetNetworkPolicy_PrepareExpanded();
            ...
            clone.PrepareNetworkPoliciesRequestParametersBody = this.PrepareNetworkPoliciesRequestParametersBody;
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SubnetsPrepareNetworkPolicies(ResourceGroupName, VnetName, SubnetName, SubscriptionId, PrepareNetworkPoliciesRequestParametersBody, onOk, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzVnetSubnetNetworkPolicy_PrepareExpanded" /> cmdlet class.
        /// </summary>
        public SetAzVnetSubnetNetworkPolicy_PrepareExpanded()
        {
