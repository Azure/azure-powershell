namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Update
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzVpnConnection_Update", SupportsShouldProcess = true)]
    ...
    public partial class SetAzVpnConnection_Update : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="VpnConnection" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnConnection _vpnConnection;

        /// <summary>VpnConnection Resource.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "VpnConnection Resource.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"VpnConnection Resource.",
        SerializedName = @"VpnConnectionParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnConnection) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnConnection VpnConnection { get => this._vpnConnection; set => this._vpnConnection = value; }
        ...
        /// <returns>a duplicate instance of SetAzVpnConnection_Update</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.SetAzVpnConnection_Update Clone()
        {
            var clone = new SetAzVpnConnection_Update();
            ...
            clone.VpnConnection = this.VpnConnection;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VpnConnectionsCreateOrUpdate(SubscriptionId, ResourceGroupName, GatewayName, Name, VpnConnection, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,GatewayName=GatewayName,Name=Name,body=VpnConnection})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzVpnConnection_Update" /> cmdlet class.
        /// </summary>
        public SetAzVpnConnection_Update()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, GatewayName=GatewayName, Name=Name, body=VpnConnection })
                    {
