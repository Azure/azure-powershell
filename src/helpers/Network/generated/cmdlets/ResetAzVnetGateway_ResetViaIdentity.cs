namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Reset, @"AzVnetGateway_ResetViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class ResetAzVnetGateway_ResetViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of ResetAzVnetGateway_ResetViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.ResetAzVnetGateway_ResetViaIdentity Clone()
        {
            var clone = new ResetAzVnetGateway_ResetViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualNetworkGatewaysResetViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("GatewayVip") ? GatewayVip : null, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysReset(InputObject.ResourceGroupName ?? null, InputObject.VnetGatewayName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("GatewayVip") ? GatewayVip : null, InputObject.SubscriptionId ?? null, onOk, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ResetAzVnetGateway_ResetViaIdentity" /> cmdlet class.
        /// </summary>
        public ResetAzVnetGateway_ResetViaIdentity()
        {
