namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzP2SVpnServerConfiguration_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzP2SVpnServerConfiguration_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "P2SVpnServerConfiguration Resource.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"P2SVpnServerConfiguration Resource.",
        SerializedName = @"p2SVpnServerConfigurationParameters",
        ...
        /// <returns>a duplicate instance of NewAzP2SVpnServerConfiguration_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzP2SVpnServerConfiguration_CreateViaIdentity Clone()
        {
            var clone = new NewAzP2SVpnServerConfiguration_CreateViaIdentity();
            ...
            clone.P2SVpnServerConfiguration = this.P2SVpnServerConfiguration;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzP2SVpnServerConfiguration_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzP2SVpnServerConfiguration_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.P2SVpnServerConfigurationsCreateOrUpdateViaIdentity(InputObject.Id, P2SVpnServerConfiguration, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.P2SVpnServerConfigurationsCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VirtualWanName ?? null, InputObject.P2SVpnServerConfigurationName ?? null, P2SVpnServerConfiguration, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=P2SVpnServerConfiguration})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=P2SVpnServerConfiguration })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=P2SVpnServerConfiguration })
                    {
