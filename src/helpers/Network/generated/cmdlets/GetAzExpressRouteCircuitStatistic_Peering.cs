namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ExpressRouteCircuits_GetPeeringStats=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}/stats"
    /// [METADATA]
    ...
    /// variant: Peering
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzExpressRouteCircuitStatistic_Peering")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Gets all stats from an express route circuit in a resource group.")]
    ...
    public partial class GetAzExpressRouteCircuitStatistic_Peering : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzExpressRouteCircuitStatistic_Peering" /> cmdlet class.
        /// </summary>
        public GetAzExpressRouteCircuitStatistic_Peering()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ExpressRouteCircuitsGetPeeringStats(ResourceGroupName, CircuitName, PeeringName, SubscriptionId, onOk, this, Pipeline);
