namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Reset1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Reset, @"AzVnetGatewayConnectionSharedKey_Reset1", SupportsShouldProcess = true)]
    ...
    public partial class ResetAzVnetGatewayConnectionSharedKey_Reset1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ConnectionSharedKey" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IConnectionResetSharedKey _connectionSharedKey;

        /// <summary>The virtual network connection reset shared key</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The virtual network connection reset shared key", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The virtual network connection reset shared key",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IConnectionResetSharedKey) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IConnectionResetSharedKey ConnectionSharedKey { get => this._connectionSharedKey; set => this._connectionSharedKey = value; }
        ...
        /// <returns>a duplicate instance of ResetAzVnetGatewayConnectionSharedKey_Reset1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.ResetAzVnetGatewayConnectionSharedKey_Reset1 Clone()
        {
            var clone = new ResetAzVnetGatewayConnectionSharedKey_Reset1();
            ...
            clone.ConnectionSharedKey = this.ConnectionSharedKey;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VirtualNetworkGatewayConnectionsResetSharedKey1(ResourceGroupName, Name, SubscriptionId, ConnectionSharedKey, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,SubscriptionId=SubscriptionId,body=ConnectionSharedKey})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ResetAzVnetGatewayConnectionSharedKey_Reset1" /> cmdlet class.
        /// </summary>
        public ResetAzVnetGatewayConnectionSharedKey_Reset1()
        {
