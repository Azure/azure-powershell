namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Get1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzLocalNetworkGateway_Get1")]
    ...
    public partial class GetAzLocalNetworkGateway_Get1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzLocalNetworkGateway_Get1" /> cmdlet class.
        /// </summary>
        public GetAzLocalNetworkGateway_Get1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.LocalNetworkGatewaysGet1(ResourceGroupName, Name, SubscriptionId, onOk, this, Pipeline);
