namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] NetworkInterfaces_ListVirtualMachineScaleSetNetworkInterfaces=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/microsoft.Compute/virtualMachineScaleSets/{virtualMachineScaleSetName}/networkInterfaces"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/vmssNetworkInterface.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1microsoft.Compute~1virtualMachineScaleSets~1{virtualMachineScaleSetName}~1networkInterfaces
    /// profiles:
    ...
    /// variant: ListVmss
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzNetworkInterface_ListVmss")]
    [global::System.Management.Automation.Alias("Get-AzNetworkInterfaceVirtualMachineScaleSetNetworkInterface")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Gets all network interfaces in a virtual machine scale set.")]
    ...
    public partial class GetAzNetworkInterface_ListVmss : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzNetworkInterface_ListVmss" /> cmdlet class.
        /// </summary>
        public GetAzNetworkInterface_ListVmss()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.NetworkInterfacesListVirtualMachineScaleSetNetworkInterfaces(ResourceGroupName, VmssName, SubscriptionId, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,VmssName=VmssName,SubscriptionId=SubscriptionId})
                    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.NetworkInterfacesListVirtualMachineScaleSetNetworkInterfaces_Call(requestMessage, onOk, this, Pipeline);
                    }
                }
            }
        }
