namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzNetworkWatcherAvailableProvider_ListExpanded", SupportsShouldProcess = true)]
    ...
    public partial class GetAzNetworkWatcherAvailableProvider_ListExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        public string City { get => ParametersBody.City ?? null; set => ParametersBody.City = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Country { get => ParametersBody.Country ?? null; set => ParametersBody.Country = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IAvailableProvidersListParameters _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.AvailableProvidersListParameters();

        /// <summary>Constraints that determine the list of available Internet service providers.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IAvailableProvidersListParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string State { get => ParametersBody.State ?? null; set => ParametersBody.State = value; }
        ...
        /// <returns>a duplicate instance of GetAzNetworkWatcherAvailableProvider_ListExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzNetworkWatcherAvailableProvider_ListExpanded Clone()
        {
            var clone = new GetAzNetworkWatcherAvailableProvider_ListExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzNetworkWatcherAvailableProvider_ListExpanded" /> cmdlet class.
        /// </summary>
        public GetAzNetworkWatcherAvailableProvider_ListExpanded()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.NetworkWatchersListAvailableProviders(ResourceGroupName, NetworkWatcherName, SubscriptionId, ParametersBody, onOk, onDefault, this, Pipeline);
