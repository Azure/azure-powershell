namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: VerifyViaIdentityExpanded
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzNetworkWatcherIPFlow_VerifyViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class TestAzNetworkWatcherIPFlow_VerifyViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Support.Direction))]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.Direction Direction { get => ParametersBody.Direction; set => ParametersBody.Direction = value; }
        ...
        public string LocalIPAddress { get => ParametersBody.LocalIPAddress ?? null; set => ParametersBody.LocalIPAddress = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string LocalPort { get => ParametersBody.LocalPort ?? null; set => ParametersBody.LocalPort = value; }
        ...
        public string NetworkInterfaceResourceId { get => ParametersBody.TargetNicResourceId ?? null; set => ParametersBody.TargetNicResourceId = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVerificationIPFlowParameters _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.VerificationIPFlowParameters();

        /// <summary>Parameters that define the IP flow to be verified.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVerificationIPFlowParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Support.IPFlowProtocol))]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.IPFlowProtocol Protocol { get => ParametersBody.Protocol; set => ParametersBody.Protocol = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string RemoteIPAddress { get => ParametersBody.RemoteIPAddress ?? null; set => ParametersBody.RemoteIPAddress = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string RemotePort { get => ParametersBody.RemotePort ?? null; set => ParametersBody.RemotePort = value; }
        ...
        /// <returns>a duplicate instance of TestAzNetworkWatcherIPFlow_VerifyViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.TestAzNetworkWatcherIPFlow_VerifyViaIdentityExpanded Clone()
        {
            var clone = new TestAzNetworkWatcherIPFlow_VerifyViaIdentityExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.NetworkWatchersVerifyIPFlowViaIdentity(InputObject.Id, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NetworkWatchersVerifyIPFlow(InputObject.ResourceGroupName ?? null, InputObject.NetworkWatcherName ?? null, InputObject.SubscriptionId ?? null, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzNetworkWatcherIPFlow_VerifyViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public TestAzNetworkWatcherIPFlow_VerifyViaIdentityExpanded()
        {
