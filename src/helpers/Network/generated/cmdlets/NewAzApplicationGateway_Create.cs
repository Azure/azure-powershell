namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Create
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzApplicationGateway_Create", SupportsShouldProcess = true)]
    ...
    public partial class NewAzApplicationGateway_Create : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Application gateway resource", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IApplicationGateway ApplicationGateway { get => this._applicationGateway; set => this._applicationGateway = value; }
        ...
        /// <returns>a duplicate instance of NewAzApplicationGateway_Create</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzApplicationGateway_Create Clone()
        {
            var clone = new NewAzApplicationGateway_Create();
            ...
            clone.ApplicationGateway = this.ApplicationGateway;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzApplicationGateway_Create" /> cmdlet class.
        /// </summary>
        public NewAzApplicationGateway_Create()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ApplicationGatewaysCreateOrUpdate(ResourceGroupName, Name, SubscriptionId, ApplicationGateway, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,SubscriptionId=SubscriptionId,body=ApplicationGateway})
                    {
