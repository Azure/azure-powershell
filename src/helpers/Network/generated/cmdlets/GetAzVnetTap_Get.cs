namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Get
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVnetTap_Get")]
    ...
    public partial class GetAzVnetTap_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>The name of virtual network tap.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of virtual network tap.")]
        ...
        /// <summary>Intializes a new instance of the <see cref="GetAzVnetTap_Get" /> cmdlet class.</summary>
        public GetAzVnetTap_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VirtualNetworkTapsGet(ResourceGroupName, Name, SubscriptionId, onOk, this, Pipeline);
