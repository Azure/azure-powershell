namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzApplicationGateway_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzApplicationGateway_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of NewAzApplicationGateway_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzApplicationGateway_CreateViaIdentity Clone()
        {
            var clone = new NewAzApplicationGateway_CreateViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzApplicationGateway_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzApplicationGateway_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ApplicationGatewaysCreateOrUpdateViaIdentity(InputObject.Id, ApplicationGateway, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ApplicationGatewaysCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.ApplicationGatewayName ?? null, InputObject.SubscriptionId ?? null, ApplicationGateway, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ApplicationGateway})
                    {
