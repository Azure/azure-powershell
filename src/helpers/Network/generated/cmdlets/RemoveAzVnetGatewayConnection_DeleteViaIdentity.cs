namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzVnetGatewayConnection_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzVnetGatewayConnection_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzVnetGatewayConnection_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.RemoveAzVnetGatewayConnection_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzVnetGatewayConnection_DeleteViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualNetworkGatewayConnectionsDeleteViaIdentity(InputObject.Id, onOk, onNoContent, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualNetworkGatewayConnectionsDelete(InputObject.ResourceGroupName ?? null, InputObject.VnetGatewayConnectionName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzVnetGatewayConnection_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzVnetGatewayConnection_DeleteViaIdentity()
        {
