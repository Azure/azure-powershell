namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzNetworkSecurityRule_CreateExpanded", SupportsShouldProcess = true)]
    ...
    public partial class NewAzNetworkSecurityRule_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The network traffic is allowed or denied.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IApplicationSecurityGroup[] DestinationApplicationSecurityGroup { get => SecurityRuleParametersBody.DestinationApplicationSecurityGroup ?? null /* arrayOf */; set => SecurityRuleParametersBody.DestinationApplicationSecurityGroup = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The direction of the rule. The direction specifies if rule will be evaluated on incoming or outgoing traffic.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Network protocol this rule applies to. Possible values are 'Tcp', 'Udp', 'Icmp', 'Esp', and '*'.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ISecurityRule _securityRuleParametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.SecurityRule();

        /// <summary>Network security rule.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ISecurityRule SecurityRuleParametersBody { get => this._securityRuleParametersBody; set => this._securityRuleParametersBody = value; }
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IApplicationSecurityGroup) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IApplicationSecurityGroup[] SourceApplicationSecurityGroup { get => SecurityRuleParametersBody.SourceApplicationSecurityGroup ?? null /* arrayOf */; set => SecurityRuleParametersBody.SourceApplicationSecurityGroup = value; }
        ...
        /// <returns>a duplicate instance of NewAzNetworkSecurityRule_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzNetworkSecurityRule_CreateExpanded Clone()
        {
            var clone = new NewAzNetworkSecurityRule_CreateExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzNetworkSecurityRule_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzNetworkSecurityRule_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SecurityRulesCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SecurityRulesCreateOrUpdate(ResourceGroupName, NsgName, Name, SubscriptionId, SecurityRuleParametersBody, onOk, this, Pipeline);
