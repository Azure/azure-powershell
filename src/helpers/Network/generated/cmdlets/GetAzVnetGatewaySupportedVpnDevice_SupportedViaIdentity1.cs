namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] VirtualNetworkGateways_SupportedVpnDevices=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/supportedvpndevices"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2017-10-01/virtualNetworkGateway.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1virtualNetworkGateways~1{virtualNetworkGatewayName}~1supportedvpndevices
    /// profiles:
    /// hybrid-2019-03-01: '2017-10-01'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: VnetGatewaySupportedVpnDevice
    /// variant: SupportedViaIdentity1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVnetGatewaySupportedVpnDevice_SupportedViaIdentity1", SupportsShouldProcess = true)]
    [global::System.Management.Automation.Alias("Get-AzVirtualNetworkGatewaySupportedVpnDevice")]
    [global::System.Management.Automation.OutputType(typeof(string))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Gets a xml format representation for supported vpn devices.")]
    ...
    public partial class GetAzVnetGatewaySupportedVpnDevice_SupportedViaIdentity1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVnetGatewaySupportedVpnDevice_SupportedViaIdentity1" /> cmdlet class.
        /// </summary>
        public GetAzVnetGatewaySupportedVpnDevice_SupportedViaIdentity1()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkGatewaysSupportedVpnDevices1' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualNetworkGatewaysSupportedVpnDevices1ViaIdentity(InputObject.Id, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysSupportedVpnDevices1(InputObject.ResourceGroupName ?? null, InputObject.VnetGatewayName ?? null, InputObject.SubscriptionId ?? null, onOk, this, Pipeline);
                    }
