namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2017-10-01/virtualNetworkGateway.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1virtualNetworkGateways~1{virtualNetworkGatewayName}~1getvpnprofilepackageurl
    /// profiles:
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVnetGatewayVpnProfilePackageUrl_GetViaIdentity1", SupportsShouldProcess = true)]
    ...
    public partial class GetAzVnetGatewayVpnProfilePackageUrl_GetViaIdentity1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetAzVnetGatewayVpnProfilePackageUrl_GetViaIdentity1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzVnetGatewayVpnProfilePackageUrl_GetViaIdentity1 Clone()
        {
            var clone = new GetAzVnetGatewayVpnProfilePackageUrl_GetViaIdentity1();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVnetGatewayVpnProfilePackageUrl_GetViaIdentity1" /> cmdlet class.
        /// </summary>
        public GetAzVnetGatewayVpnProfilePackageUrl_GetViaIdentity1()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkGatewaysGetVpnProfilePackageUrl1' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualNetworkGatewaysGetVpnProfilePackageUrl1ViaIdentity(InputObject.Id, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysGetVpnProfilePackageUrl1(InputObject.ResourceGroupName ?? null, InputObject.VnetGatewayName ?? null, InputObject.SubscriptionId ?? null, onOk, this, Pipeline);
                    }
