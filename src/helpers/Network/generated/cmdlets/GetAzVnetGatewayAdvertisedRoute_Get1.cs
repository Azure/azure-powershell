namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2017-10-01/virtualNetworkGateway.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1virtualNetworkGateways~1{virtualNetworkGatewayName}~1getAdvertisedRoutes
    /// profiles:
    ...
    /// variant: Get1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVnetGatewayAdvertisedRoute_Get1", SupportsShouldProcess = true)]
    ...
    public partial class GetAzVnetGatewayAdvertisedRoute_Get1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetAzVnetGatewayAdvertisedRoute_Get1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzVnetGatewayAdvertisedRoute_Get1 Clone()
        {
            var clone = new GetAzVnetGatewayAdvertisedRoute_Get1();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVnetGatewayAdvertisedRoute_Get1" /> cmdlet class.
        /// </summary>
        public GetAzVnetGatewayAdvertisedRoute_Get1()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkGatewaysGetAdvertisedRoutes1' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysGetAdvertisedRoutes1(ResourceGroupName, VnetGatewayName, Peer, SubscriptionId, onOk, this, Pipeline);
