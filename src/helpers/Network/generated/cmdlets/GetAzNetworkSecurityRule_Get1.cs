namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Get1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzNetworkSecurityRule_Get1")]
    ...
    public partial class GetAzNetworkSecurityRule_Get1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzNetworkSecurityRule_Get1" /> cmdlet class.
        /// </summary>
        public GetAzNetworkSecurityRule_Get1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SecurityRulesGet1(ResourceGroupName, NsgName, Name, SubscriptionId, onOk, this, Pipeline);
