namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: ScriptViaIdentityExpanded
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVnetGatewayVpnDeviceConfigurationScript_ScriptViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class GetAzVnetGatewayVpnDeviceConfigurationScript_ScriptViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnDeviceScriptParameters _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.VpnDeviceScriptParameters();

        /// <summary>Vpn device configuration script generation parameters</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnDeviceScriptParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVnetGatewayVpnDeviceConfigurationScript_ScriptViaIdentityExpanded" />
        /// cmdlet class.
        /// </summary>
        public GetAzVnetGatewayVpnDeviceConfigurationScript_ScriptViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkGatewaysVpnDeviceConfigurationScript' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualNetworkGatewaysVpnDeviceConfigurationScriptViaIdentity(InputObject.Id, ParametersBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysVpnDeviceConfigurationScript(InputObject.ResourceGroupName ?? null, InputObject.VnetGatewayConnectionName ?? null, InputObject.SubscriptionId ?? null, ParametersBody, onOk, this, Pipeline);
                    }
