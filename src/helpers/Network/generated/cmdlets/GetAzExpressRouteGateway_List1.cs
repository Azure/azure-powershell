namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ExpressRouteGateways_ListByResourceGroup=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteGateways"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/expressRouteGateway.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1expressRouteGateways
    /// profiles:
    ...
    /// variant: List1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzExpressRouteGateway_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Lists ExpressRoute gateways in a given resource group.")]
    ...
    public partial class GetAzExpressRouteGateway_List1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzExpressRouteGateway_List1" /> cmdlet class.
        /// </summary>
        public GetAzExpressRouteGateway_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ExpressRouteGatewaysListByResourceGroup(ResourceGroupName, SubscriptionId, onOk, this, Pipeline);
