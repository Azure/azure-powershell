namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Update1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzVnetGateway_Update1", SupportsShouldProcess = true)]
    ...
    public partial class SetAzVnetGateway_Update1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="VnetGateway" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IVirtualNetworkGateway _vnetGateway;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IVirtualNetworkGateway VnetGateway { get => this._vnetGateway; set => this._vnetGateway = value; }
        ...
        /// <returns>a duplicate instance of SetAzVnetGateway_Update1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.SetAzVnetGateway_Update1 Clone()
        {
            var clone = new SetAzVnetGateway_Update1();
            ...
            clone.VnetGateway = this.VnetGateway;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VirtualNetworkGatewaysCreateOrUpdate1(ResourceGroupName, Name, SubscriptionId, VnetGateway, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,SubscriptionId=SubscriptionId,body=VnetGateway})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzVnetGateway_Update1" /> cmdlet class.
        /// </summary>
        public SetAzVnetGateway_Update1()
        {
