namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] PublicIPAddresses_CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/publicIPAddresses/{publicIpAddressName}"
    /// [METADATA]
    ...
    /// - '2019-02-01'
    /// filename:
    /// - 'mem:///985?oai3.shaken.json'
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/publicIpAddress.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1publicIPAddresses~1{publicIpAddressName}
    /// profiles:
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzPublicIPAddress_CreateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPublicIPAddress))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Creates or updates a static or dynamic public IP address.")]
    ...
    public partial class NewAzPublicIPAddress_CreateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The public IP address allocation method.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.IPAllocationMethod AllocationMethod { get => ParametersBody.AllocationMethod ?? ((Microsoft.Azure.PowerShell.Cmdlets.Network.Support.IPAllocationMethod)""); set => ParametersBody.AllocationMethod = value; }
        ...
        public string DdosCustomPolicyId { get => ParametersBody.DdosCustomPolicyId ?? null; set => ParametersBody.DdosCustomPolicyId = value; }

        /// <summary>
        /// The DDoS protection policy customizability of the public IP. Only standard coverage will have the ability to be customized.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The DDoS protection policy customizability of the public IP. Only standard coverage will have the ability to be customized.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Support.DdosSettingsProtectionCoverage))]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.DdosSettingsProtectionCoverage DdosProtectionCoverage { get => ParametersBody.DdosProtectionCoverage ?? ((Microsoft.Azure.PowerShell.Cmdlets.Network.Support.DdosSettingsProtectionCoverage)""); set => ParametersBody.DdosProtectionCoverage = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string DomainNameLabel { get => ParametersBody.DnsSettingDomainNameLabel ?? null; set => ParametersBody.DnsSettingDomainNameLabel = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Gets the FQDN, Fully qualified domain name of the A DNS record associated with the public IP. This is the concatenation of the domainNameLabel and the regionalized DNS zone.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"fqdn",
        PossibleTypes = new [] { typeof(string) })]
        public string Fqdn { get => ParametersBody.DnsSettingFqdn ?? null; set => ParametersBody.DnsSettingFqdn = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The IP address associated with the public IP address resource.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string IPAddress { get => ParametersBody.IPAddress ?? null; set => ParametersBody.IPAddress = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.IPVersion IPAddressVersion { get => ParametersBody.IPAddressVersion ?? ((Microsoft.Azure.PowerShell.Cmdlets.Network.Support.IPVersion)""); set => ParametersBody.IPAddressVersion = value; }

        /// <summary>The list of tags associated with the public IP address.</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The list of tags associated with the public IP address.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The idle timeout of the public IP address.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPublicIPAddress _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.PublicIPAddress();

        /// <summary>Public IP address resource.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPublicIPAddress ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string PrefixId { get => ParametersBody.PrefixId ?? null; set => ParametersBody.PrefixId = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The resource GUID property of the public IP resource.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ReverseFqdn { get => ParametersBody.DnsSettingReverseFqdn ?? null; set => ParametersBody.DnsSettingReverseFqdn = value; }

        /// <summary>Name of a public IP address SKU.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of a public IP address SKU.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Support.PublicIPAddressSkuName))]
        [global::System.Management.Automation.Alias("Sku")]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.PublicIPAddressSkuName SkuName { get => ParametersBody.SkuName ?? ((Microsoft.Azure.PowerShell.Cmdlets.Network.Support.PublicIPAddressSkuName)""); set => ParametersBody.SkuName = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPublicIPAddress"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPublicIPAddress> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzPublicIPAddress_CreateViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzPublicIPAddress_CreateViaIdentityExpanded Clone()
        {
            var clone = new NewAzPublicIPAddress_CreateViaIdentityExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzPublicIPAddress_CreateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public NewAzPublicIPAddress_CreateViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PublicIPAddressesCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PublicIPAddressesCreateOrUpdateViaIdentity(InputObject.Id, ParametersBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PublicIPAddressesCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.PublicIPAddressName ?? null, InputObject.SubscriptionId ?? null, ParametersBody, onOk, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPublicIPAddress> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPublicIPAddress
