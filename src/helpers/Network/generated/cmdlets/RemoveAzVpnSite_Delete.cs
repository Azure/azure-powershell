namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] VpnSites_Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnSites/{vpnSiteName}"
    /// [METADATA]
    ...
    /// variant: Delete
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzVpnSite_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Deletes a VpnSite.")]
    ...
    public partial class RemoveAzVpnSite_Delete : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>The name of the VpnSite being deleted.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the VpnSite being deleted.")]
        ...
        /// <returns>a duplicate instance of RemoveAzVpnSite_Delete</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.RemoveAzVpnSite_Delete Clone()
        {
            var clone = new RemoveAzVpnSite_Delete();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VpnSitesDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VpnSitesDelete(SubscriptionId, ResourceGroupName, Name, onOk, onNoContent, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzVpnSite_Delete" /> cmdlet class.
        /// </summary>
        public RemoveAzVpnSite_Delete()
        {
