namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Supported
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVnetGatewaySupportedVpnDevice_Supported", SupportsShouldProcess = true)]
    ...
    public partial class GetAzVnetGatewaySupportedVpnDevice_Supported : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVnetGatewaySupportedVpnDevice_Supported" /> cmdlet class.
        /// </summary>
        public GetAzVnetGatewaySupportedVpnDevice_Supported()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysSupportedVpnDevices(ResourceGroupName, Name, SubscriptionId, onOk, this, Pipeline);
