namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2017-10-01/virtualNetworkGateway.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1virtualNetworkGateways~1{virtualNetworkGatewayName}~1reset
    /// profiles:
    ...
    /// subjectPrefix:
    /// subject: VnetGateway
    /// variant: ResetViaIdentity1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Reset, @"AzVnetGateway_ResetViaIdentity1", SupportsShouldProcess = true)]
    ...
    public partial class ResetAzVnetGateway_ResetViaIdentity1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of ResetAzVnetGateway_ResetViaIdentity1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.ResetAzVnetGateway_ResetViaIdentity1 Clone()
        {
            var clone = new ResetAzVnetGateway_ResetViaIdentity1();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkGatewaysReset1' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualNetworkGatewaysReset1ViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("GatewayVip") ? GatewayVip : null, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysReset1(InputObject.ResourceGroupName ?? null, InputObject.VnetGatewayName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("GatewayVip") ? GatewayVip : null, InputObject.SubscriptionId ?? null, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  GatewayVip=this.InvocationInformation.BoundParameters.ContainsKey("GatewayVip") ? GatewayVip : null})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ResetAzVnetGateway_ResetViaIdentity1" /> cmdlet class.
        /// </summary>
        public ResetAzVnetGateway_ResetViaIdentity1()
        {
