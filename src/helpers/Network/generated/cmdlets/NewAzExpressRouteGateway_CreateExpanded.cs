namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ExpressRouteGateways_CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteGateways/{expressRouteGatewayName}"
    /// [METADATA]
    ...
    /// - '2019-02-01'
    /// filename:
    /// - 'mem:///975?oai3.shaken.json'
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/expressRouteGateway.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1expressRouteGateways~1{expressRouteGatewayName}
    /// profiles:
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzExpressRouteGateway_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteGateway))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Creates or updates a ExpressRoute gateway in a specified resource group.")]
    ...
    public partial class NewAzExpressRouteGateway_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        public string Id { get => PutExpressRouteGatewayParametersBody.Id ?? null; set => PutExpressRouteGatewayParametersBody.Id = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => PutExpressRouteGatewayParametersBody.Location ?? null; set => PutExpressRouteGatewayParametersBody.Location = value; }

        /// <summary>Maximum number of scale units deployed for ExpressRoute gateway.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of scale units deployed for ExpressRoute gateway.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Alias("MaxScaleUnits")]
        public int MaximumScaleUnit { get => PutExpressRouteGatewayParametersBody.MaximumScaleUnit ?? default(int); set => PutExpressRouteGatewayParametersBody.MaximumScaleUnit = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Minimum number of scale units deployed for ExpressRoute gateway.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"min",
        PossibleTypes = new [] { typeof(int) })]
        [global::System.Management.Automation.Alias("MinScaleUnits")]
        public int MinimumScaleUnit { get => PutExpressRouteGatewayParametersBody.MinimumScaleUnit ?? default(int); set => PutExpressRouteGatewayParametersBody.MinimumScaleUnit = value; }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private string _name;

        /// <summary>The name of the ExpressRoute gateway.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the ExpressRoute gateway.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("ExpressRouteGatewayName")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.ProvisioningState ProvisioningState { get => PutExpressRouteGatewayParametersBody.ProvisioningState ?? ((Microsoft.Azure.PowerShell.Cmdlets.Network.Support.ProvisioningState)""); set => PutExpressRouteGatewayParametersBody.ProvisioningState = value; }
        ...
        /// <summary>Backing field for <see cref="PutExpressRouteGatewayParametersBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteGateway _putExpressRouteGatewayParametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ExpressRouteGateway();

        /// <summary>ExpressRoute gateway resource.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteGateway PutExpressRouteGatewayParametersBody { get => this._putExpressRouteGatewayParametersBody; set => this._putExpressRouteGatewayParametersBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("VirtualHub", "VirtualHubName")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Path)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IResourceTags Tag { get => PutExpressRouteGatewayParametersBody.Tag ?? null /* object */; set => PutExpressRouteGatewayParametersBody.Tag = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The resource URI for the Virtual Hub where the ExpressRoute gateway is or will be deployed. The Virtual Hub resource and the ExpressRoute gateway resource reside in the same subscription.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string VirtualHubId { get => PutExpressRouteGatewayParametersBody.VirtualHubId ?? null; set => PutExpressRouteGatewayParametersBody.VirtualHubId = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteGateway"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteGateway> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzExpressRouteGateway_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzExpressRouteGateway_CreateExpanded Clone()
        {
            var clone = new NewAzExpressRouteGateway_CreateExpanded();
            ...
            clone.PutExpressRouteGatewayParametersBody = this.PutExpressRouteGatewayParametersBody;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzExpressRouteGateway_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzExpressRouteGateway_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ExpressRouteGatewaysCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ExpressRouteGatewaysCreateOrUpdate(ResourceGroupName, Name, SubscriptionId, PutExpressRouteGatewayParametersBody, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,SubscriptionId=SubscriptionId,body=PutExpressRouteGatewayParametersBody})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteGateway> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteGateway
