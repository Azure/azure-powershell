namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzPublicIPAddress_CreateViaIdentityExpanded1", SupportsShouldProcess = true)]
    ...
    public partial class NewAzPublicIPAddress_CreateViaIdentityExpanded1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The public IP allocation method. Possible values are: 'Static' and 'Dynamic'.")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The public IP address version. Possible values are: 'IPv4' and 'IPv6'.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IPublicIPAddress _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.PublicIPAddress();

        /// <summary>Public IP address resource.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IPublicIPAddress ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        /// <returns>a duplicate instance of NewAzPublicIPAddress_CreateViaIdentityExpanded1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzPublicIPAddress_CreateViaIdentityExpanded1 Clone()
        {
            var clone = new NewAzPublicIPAddress_CreateViaIdentityExpanded1();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzPublicIPAddress_CreateViaIdentityExpanded1" /> cmdlet class.
        /// </summary>
        public NewAzPublicIPAddress_CreateViaIdentityExpanded1()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PublicIPAddressesCreateOrUpdate1' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PublicIPAddressesCreateOrUpdate1ViaIdentity(InputObject.Id, ParametersBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PublicIPAddressesCreateOrUpdate1(InputObject.ResourceGroupName ?? null, InputObject.PublicIPAddressName ?? null, InputObject.SubscriptionId ?? null, ParametersBody, onOk, this, Pipeline);
                    }
