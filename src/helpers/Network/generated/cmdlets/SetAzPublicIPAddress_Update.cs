namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Update
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzPublicIPAddress_Update", SupportsShouldProcess = true)]
    ...
    public partial class SetAzPublicIPAddress_Update : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Public IP address resource.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPublicIPAddress PublicIPAddress { get => this._publicIPAddress; set => this._publicIPAddress = value; }
        ...
        /// <returns>a duplicate instance of SetAzPublicIPAddress_Update</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.SetAzPublicIPAddress_Update Clone()
        {
            var clone = new SetAzPublicIPAddress_Update();
            ...
            clone.PublicIPAddress = this.PublicIPAddress;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PublicIPAddressesCreateOrUpdate(ResourceGroupName, Name, SubscriptionId, PublicIPAddress, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,SubscriptionId=SubscriptionId,body=PublicIPAddress})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzPublicIPAddress_Update" /> cmdlet class.
        /// </summary>
        public SetAzPublicIPAddress_Update()
        {
