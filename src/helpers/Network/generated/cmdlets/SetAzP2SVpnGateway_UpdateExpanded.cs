namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzP2SVpnGateway_UpdateExpanded", SupportsShouldProcess = true)]
    ...
    public partial class SetAzP2SVpnGateway_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        public string[] CustomRouteAddressPrefix { get => P2SVpnGatewayParametersBody.CustomRouteAddressPrefix ?? null /* arrayOf */; set => P2SVpnGatewayParametersBody.CustomRouteAddressPrefix = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string Id { get => P2SVpnGatewayParametersBody.Id ?? null; set => P2SVpnGatewayParametersBody.Id = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => P2SVpnGatewayParametersBody.Location ?? null; set => P2SVpnGatewayParametersBody.Location = value; }
        ...
        /// <summary>Backing field for <see cref="P2SVpnGatewayParametersBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IP2SVpnGateway _p2SVpnGatewayParametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.P2SVpnGateway();

        /// <summary>P2SVpnGateway Resource.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IP2SVpnGateway P2SVpnGatewayParametersBody { get => this._p2SVpnGatewayParametersBody; set => this._p2SVpnGatewayParametersBody = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string P2SVpnServerConfigurationId { get => P2SVpnGatewayParametersBody.P2SVpnServerConfigurationId ?? null; set => P2SVpnGatewayParametersBody.P2SVpnServerConfigurationId = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.ProvisioningState ProvisioningState { get => P2SVpnGatewayParametersBody.ProvisioningState ?? ((Microsoft.Azure.PowerShell.Cmdlets.Network.Support.ProvisioningState)""); set => P2SVpnGatewayParametersBody.ProvisioningState = value; }
        ...
        /// <summary>The resource group name of the P2SVpnGateway.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The resource group name of the P2SVpnGateway.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The scale unit for this p2s vpn gateway.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public int ScaleUnit { get => P2SVpnGatewayParametersBody.ScaleUnit ?? default(int); set => P2SVpnGatewayParametersBody.ScaleUnit = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IResourceTags Tag { get => P2SVpnGatewayParametersBody.Tag ?? null /* object */; set => P2SVpnGatewayParametersBody.Tag = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string VirtualHubId { get => P2SVpnGatewayParametersBody.VirtualHubId ?? null; set => P2SVpnGatewayParametersBody.VirtualHubId = value; }
        ...
        SerializedName = @"addressPrefixes",
        PossibleTypes = new [] { typeof(string) })]
        public string[] VpnClientAddressPrefix { get => P2SVpnGatewayParametersBody.VpnClientAddressPrefix ?? null /* arrayOf */; set => P2SVpnGatewayParametersBody.VpnClientAddressPrefix = value; }

        /// <summary>List of allocated ip addresses to the connected p2s vpn clients.</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of allocated ip addresses to the connected p2s vpn clients.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] VpnClientAllocatedIPAddress { get => P2SVpnGatewayParametersBody.VpnClientAllocatedIPAddress ?? null /* arrayOf */; set => P2SVpnGatewayParametersBody.VpnClientAllocatedIPAddress = value; }

        /// <summary>The total of p2s vpn clients connected at this time to this P2SVpnGateway.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The total of p2s vpn clients connected at this time to this P2SVpnGateway.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int VpnClientConnectionCount { get => P2SVpnGatewayParametersBody.VpnClientConnectionCount ?? default(int); set => P2SVpnGatewayParametersBody.VpnClientConnectionCount = value; }
        ...
        /// <returns>a duplicate instance of SetAzP2SVpnGateway_UpdateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.SetAzP2SVpnGateway_UpdateExpanded Clone()
        {
            var clone = new SetAzP2SVpnGateway_UpdateExpanded();
            ...
            clone.P2SVpnGatewayParametersBody = this.P2SVpnGatewayParametersBody;
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.P2SVpnGatewaysCreateOrUpdate(SubscriptionId, ResourceGroupName, Name, P2SVpnGatewayParametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Name=Name,body=P2SVpnGatewayParametersBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzP2SVpnGateway_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public SetAzP2SVpnGateway_UpdateExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=P2SVpnGatewayParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=P2SVpnGatewayParametersBody })
                    {
