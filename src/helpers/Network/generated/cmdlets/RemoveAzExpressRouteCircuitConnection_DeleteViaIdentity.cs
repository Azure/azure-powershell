namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzExpressRouteCircuitConnection_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzExpressRouteCircuitConnection_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzExpressRouteCircuitConnection_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.RemoveAzExpressRouteCircuitConnection_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzExpressRouteCircuitConnection_DeleteViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ExpressRouteCircuitConnectionsDeleteViaIdentity(InputObject.Id, onOk, onNoContent, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ExpressRouteCircuitConnectionsDelete(InputObject.ResourceGroupName ?? null, InputObject.CircuitName ?? null, InputObject.PeeringName ?? null, InputObject.ConnectionName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzExpressRouteCircuitConnection_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzExpressRouteCircuitConnection_DeleteViaIdentity()
        {
