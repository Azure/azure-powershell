namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Get
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzNetworkWatcherPacketCaptureStatus_Get", SupportsShouldProcess = true)]
    ...
    public partial class GetAzNetworkWatcherPacketCaptureStatus_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name given to the packet capture session.")]
        ...
        /// <returns>a duplicate instance of GetAzNetworkWatcherPacketCaptureStatus_Get</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzNetworkWatcherPacketCaptureStatus_Get Clone()
        {
            var clone = new GetAzNetworkWatcherPacketCaptureStatus_Get();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzNetworkWatcherPacketCaptureStatus_Get" /> cmdlet class.
        /// </summary>
        public GetAzNetworkWatcherPacketCaptureStatus_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.PacketCapturesGetStatus(ResourceGroupName, NetworkWatcherName, Name, SubscriptionId, onOk, onDefault, this, Pipeline);
