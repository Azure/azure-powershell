namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] VirtualNetworkGateways_Generatevpnclientpackage=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/generatevpnclientpackage"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2017-10-01/virtualNetworkGateway.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1virtualNetworkGateways~1{virtualNetworkGatewayName}~1generatevpnclientpackage
    /// profiles:
    ...
    /// variant: GeneratevpnclientpackageViaIdentity1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzVnetGatewayVpnClientPackage_GeneratevpnclientpackageViaIdentity1", SupportsShouldProcess = true)]
    [global::System.Management.Automation.Alias("Get-AzVpnClientPackage", "New-AzVirtualNetworkGatewayVpnClientPackage")]
    [global::System.Management.Automation.OutputType(typeof(string))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Generates VPN client package for P2S client of the virtual network gateway in the specified resource group.")]
    ...
    public partial class NewAzVnetGatewayVpnClientPackage_GeneratevpnclientpackageViaIdentity1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="VpnClientPackage" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IVpnClientParameters _vpnClientPackage;

        /// <summary>Vpn Client Parameters for package generation</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Vpn Client Parameters for package generation", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Vpn Client Parameters for package generation",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IVpnClientParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IVpnClientParameters VpnClientPackage { get => this._vpnClientPackage; set => this._vpnClientPackage = value; }
        ...
        /// <returns>
        /// a duplicate instance of NewAzVnetGatewayVpnClientPackage_GeneratevpnclientpackageViaIdentity1
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzVnetGatewayVpnClientPackage_GeneratevpnclientpackageViaIdentity1 Clone()
        {
            var clone = new NewAzVnetGatewayVpnClientPackage_GeneratevpnclientpackageViaIdentity1();
            ...
            clone.VpnClientPackage = this.VpnClientPackage;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzVnetGatewayVpnClientPackage_GeneratevpnclientpackageViaIdentity1" />
        /// cmdlet class.
        /// </summary>
        public NewAzVnetGatewayVpnClientPackage_GeneratevpnclientpackageViaIdentity1()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkGatewaysGeneratevpnclientpackage1' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualNetworkGatewaysGeneratevpnclientpackage1ViaIdentity(InputObject.Id, VpnClientPackage, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysGeneratevpnclientpackage1(InputObject.ResourceGroupName ?? null, InputObject.VnetGatewayName ?? null, InputObject.SubscriptionId ?? null, VpnClientPackage, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=VpnClientPackage})
                    {
