namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ExpressRouteCircuitAuthorizations_Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/authorizations/{authorizationName}"
    /// [METADATA]
    ...
    /// variant: Delete
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzExpressRouteCircuitAuthorization_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Deletes the specified authorization from the specified express route circuit.")]
    ...
    public partial class RemoveAzExpressRouteCircuitAuthorization_Delete : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzExpressRouteCircuitAuthorization_Delete</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.RemoveAzExpressRouteCircuitAuthorization_Delete Clone()
        {
            var clone = new RemoveAzExpressRouteCircuitAuthorization_Delete();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ExpressRouteCircuitAuthorizationsDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ExpressRouteCircuitAuthorizationsDelete(ResourceGroupName, CircuitName, Name, SubscriptionId, onOk, onNoContent, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,CircuitName=CircuitName,Name=Name,SubscriptionId=SubscriptionId})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzExpressRouteCircuitAuthorization_Delete" /> cmdlet class.
        /// </summary>
        public RemoveAzExpressRouteCircuitAuthorization_Delete()
        {
