namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzLocalNetworkGateway_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzLocalNetworkGateway_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzLocalNetworkGateway_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.RemoveAzLocalNetworkGateway_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzLocalNetworkGateway_DeleteViaIdentity();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'LocalNetworkGatewaysDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.LocalNetworkGatewaysDeleteViaIdentity(InputObject.Id, onOk, onNoContent, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.LocalNetworkGatewaysDelete(InputObject.ResourceGroupName ?? null, InputObject.LocalNetworkGatewayName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzLocalNetworkGateway_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzLocalNetworkGateway_DeleteViaIdentity()
        {
