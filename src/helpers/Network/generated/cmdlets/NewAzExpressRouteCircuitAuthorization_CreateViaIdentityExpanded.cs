namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ExpressRouteCircuitAuthorizations_CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/authorizations/{authorizationName}"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/expressRouteCircuit.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1expressRouteCircuits~1{circuitName}~1authorizations~1{authorizationName}
    /// profiles:
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzExpressRouteCircuitAuthorization_CreateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteCircuitAuthorization))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Creates or updates an authorization in the specified express route circuit.")]
    ...
    public partial class NewAzExpressRouteCircuitAuthorization_CreateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="AuthorizationParametersBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteCircuitAuthorization _authorizationParametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ExpressRouteCircuitAuthorization();

        /// <summary>Authorization in an ExpressRouteCircuit resource.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteCircuitAuthorization AuthorizationParametersBody { get => this._authorizationParametersBody; set => this._authorizationParametersBody = value; }
        ...
        public string Id { get => AuthorizationParametersBody.Id ?? null; set => AuthorizationParametersBody.Id = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Key { get => AuthorizationParametersBody.AuthorizationKey ?? null; set => AuthorizationParametersBody.AuthorizationKey = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ProvisioningState { get => AuthorizationParametersBody.ProvisioningState ?? null; set => AuthorizationParametersBody.ProvisioningState = value; }
        ...
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(string) })]
        public string ResourceName { get => AuthorizationParametersBody.Name ?? null; set => AuthorizationParametersBody.Name = value; }

        /// <summary>AuthorizationUseStatus. Possible values are: 'Available' and 'InUse'.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "AuthorizationUseStatus. Possible values are: 'Available' and 'InUse'.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Support.AuthorizationUseStatus))]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.AuthorizationUseStatus UseStatus { get => AuthorizationParametersBody.AuthorizationUseStatus ?? ((Microsoft.Azure.PowerShell.Cmdlets.Network.Support.AuthorizationUseStatus)""); set => AuthorizationParametersBody.AuthorizationUseStatus = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteCircuitAuthorization"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteCircuitAuthorization> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of NewAzExpressRouteCircuitAuthorization_CreateViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzExpressRouteCircuitAuthorization_CreateViaIdentityExpanded Clone()
        {
            var clone = new NewAzExpressRouteCircuitAuthorization_CreateViaIdentityExpanded();
            ...
            clone.AuthorizationParametersBody = this.AuthorizationParametersBody;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzExpressRouteCircuitAuthorization_CreateViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public NewAzExpressRouteCircuitAuthorization_CreateViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ExpressRouteCircuitAuthorizationsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ExpressRouteCircuitAuthorizationsCreateOrUpdateViaIdentity(InputObject.Id, AuthorizationParametersBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ExpressRouteCircuitAuthorizationsCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.CircuitName ?? null, InputObject.AuthorizationName ?? null, InputObject.SubscriptionId ?? null, AuthorizationParametersBody, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=AuthorizationParametersBody})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteCircuitAuthorization> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteCircuitAuthorization
