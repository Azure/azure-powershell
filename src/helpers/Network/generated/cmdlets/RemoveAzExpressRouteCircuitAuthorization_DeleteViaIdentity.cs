namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzExpressRouteCircuitAuthorization_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzExpressRouteCircuitAuthorization_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of RemoveAzExpressRouteCircuitAuthorization_DeleteViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.RemoveAzExpressRouteCircuitAuthorization_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzExpressRouteCircuitAuthorization_DeleteViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ExpressRouteCircuitAuthorizationsDeleteViaIdentity(InputObject.Id, onOk, onNoContent, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ExpressRouteCircuitAuthorizationsDelete(InputObject.ResourceGroupName ?? null, InputObject.CircuitName ?? null, InputObject.AuthorizationName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzExpressRouteCircuitAuthorization_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzExpressRouteCircuitAuthorization_DeleteViaIdentity()
        {
