namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzExpressRouteCircuit_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzExpressRouteCircuit_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteCircuit _expressRouteCircuit;

        /// <summary>ExpressRouteCircuit resource</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ExpressRouteCircuit resource", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteCircuit ExpressRouteCircuit { get => this._expressRouteCircuit; set => this._expressRouteCircuit = value; }
        ...
        /// <returns>a duplicate instance of NewAzExpressRouteCircuit_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzExpressRouteCircuit_CreateViaIdentity Clone()
        {
            var clone = new NewAzExpressRouteCircuit_CreateViaIdentity();
            ...
            clone.ExpressRouteCircuit = this.ExpressRouteCircuit;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzExpressRouteCircuit_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzExpressRouteCircuit_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ExpressRouteCircuitsCreateOrUpdateViaIdentity(InputObject.Id, ExpressRouteCircuit, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ExpressRouteCircuitsCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.CircuitName ?? null, InputObject.SubscriptionId ?? null, ExpressRouteCircuit, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ExpressRouteCircuit})
                    {
