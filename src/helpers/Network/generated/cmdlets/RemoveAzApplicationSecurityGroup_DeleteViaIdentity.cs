namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzApplicationSecurityGroup_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzApplicationSecurityGroup_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzApplicationSecurityGroup_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.RemoveAzApplicationSecurityGroup_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzApplicationSecurityGroup_DeleteViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ApplicationSecurityGroupsDeleteViaIdentity(InputObject.Id, onOk, onNoContent, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ApplicationSecurityGroupsDelete(InputObject.ResourceGroupName ?? null, InputObject.ApplicationSecurityGroupName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzApplicationSecurityGroup_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzApplicationSecurityGroup_DeleteViaIdentity()
        {
