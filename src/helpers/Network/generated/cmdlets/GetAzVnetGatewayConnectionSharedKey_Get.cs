namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <summary>
    /// The Get VirtualNetworkGatewayConnectionSharedKey operation retrieves information about the specified virtual network gateway
    /// connection shared key through Network resource provider.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] VirtualNetworkGatewayConnections_GetSharedKey=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/connections/{virtualNetworkGatewayConnectionName}/sharedkey"
    /// [METADATA]
    ...
    /// variant: Get
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVnetGatewayConnectionSharedKey_Get")]
    [global::System.Management.Automation.Alias("Get-AzVirtualNetworkGatewayConnectionSharedKey")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"The Get VirtualNetworkGatewayConnectionSharedKey operation retrieves information about the specified virtual network gateway connection shared key through Network resource provider.")]
    ...
    public partial class GetAzVnetGatewayConnectionSharedKey_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The virtual network gateway connection shared key name.")]
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVnetGatewayConnectionSharedKey_Get" /> cmdlet class.
        /// </summary>
        public GetAzVnetGatewayConnectionSharedKey_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VirtualNetworkGatewayConnectionsGetSharedKey(ResourceGroupName, Name, SubscriptionId, onOk, this, Pipeline);
