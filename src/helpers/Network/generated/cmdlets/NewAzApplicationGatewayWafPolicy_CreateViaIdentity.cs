namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzApplicationGatewayWafPolicy_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzApplicationGatewayWafPolicy_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IWebApplicationFirewallPolicy _wafPolicy;

        /// <summary>Defines web application firewall policy.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Defines web application firewall policy.", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IWebApplicationFirewallPolicy WafPolicy { get => this._wafPolicy; set => this._wafPolicy = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzApplicationGatewayWafPolicy_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzApplicationGatewayWafPolicy_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.WebApplicationFirewallPoliciesCreateOrUpdateViaIdentity(InputObject.Id, WafPolicy, onOk, onCreated, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.WebApplicationFirewallPoliciesCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.PolicyName ?? null, InputObject.SubscriptionId ?? null, WafPolicy, onOk, onCreated, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=WafPolicy})
                    {
