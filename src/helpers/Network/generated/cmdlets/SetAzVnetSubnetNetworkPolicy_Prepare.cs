namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Subnets_PrepareNetworkPolicies=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}/PrepareNetworkPolicies"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/virtualNetwork.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1virtualNetworks~1{virtualNetworkName}~1subnets~1{subnetName}~1PrepareNetworkPolicies
    /// profiles:
    ...
    /// variant: Prepare
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzVnetSubnetNetworkPolicy_Prepare", SupportsShouldProcess = true)]
    [global::System.Management.Automation.Alias("Set-AzVirtualNetworkSubnetNetworkPolicy")]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Prepares a subnet by applying network intent policies.")]
    ...
    public partial class SetAzVnetSubnetNetworkPolicy_Prepare : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="NetworkPolicyRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPrepareNetworkPoliciesRequest _networkPolicyRequest;

        /// <summary>Details of PrepareNetworkPolicies for Subnet.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Details of PrepareNetworkPolicies for Subnet.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Details of PrepareNetworkPolicies for Subnet.",
        SerializedName = @"prepareNetworkPoliciesRequestParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPrepareNetworkPoliciesRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPrepareNetworkPoliciesRequest NetworkPolicyRequest { get => this._networkPolicyRequest; set => this._networkPolicyRequest = value; }
        ...
        /// <returns>a duplicate instance of SetAzVnetSubnetNetworkPolicy_Prepare</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.SetAzVnetSubnetNetworkPolicy_Prepare Clone()
        {
            var clone = new SetAzVnetSubnetNetworkPolicy_Prepare();
            ...
            clone.SubnetName = this.SubnetName;
            clone.SubscriptionId = this.SubscriptionId;
            clone.NetworkPolicyRequest = this.NetworkPolicyRequest;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SubnetsPrepareNetworkPolicies' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SubnetsPrepareNetworkPolicies(ResourceGroupName, VnetName, SubnetName, SubscriptionId, NetworkPolicyRequest, onOk, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzVnetSubnetNetworkPolicy_Prepare" /> cmdlet class.
        /// </summary>
        public SetAzVnetSubnetNetworkPolicy_Prepare()
        {
