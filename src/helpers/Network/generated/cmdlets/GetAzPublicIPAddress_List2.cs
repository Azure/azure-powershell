namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] PublicIPAddresses_ListAll=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Network/publicIPAddresses"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2017-10-01/publicIpAddress.json#/paths/~1subscriptions~1{subscriptionId}~1providers~1Microsoft.Network~1publicIPAddresses
    /// profiles:
    ...
    /// variant: List2
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPublicIPAddress_List2")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Gets all the public IP addresses in a subscription.")]
    ...
    public partial class GetAzPublicIPAddress_List2 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzPublicIPAddress_List2" /> cmdlet class.
        /// </summary>
        public GetAzPublicIPAddress_List2()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.PublicIPAddressesListAll1(SubscriptionId, onOk, this, Pipeline);
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.PublicIPAddressesListAll1_Call(requestMessage, onOk, this, Pipeline);
                    }
                }
            }
        }
