namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Create1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzNetworkSecurityRule_Create1", SupportsShouldProcess = true)]
    ...
    public partial class NewAzNetworkSecurityRule_Create1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the security rule.")]
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.ISecurityRule _securityRule;

        /// <summary>Network security rule.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Network security rule.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Network security rule.",
        SerializedName = @"securityRuleParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.ISecurityRule) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.ISecurityRule SecurityRule { get => this._securityRule; set => this._securityRule = value; }
        ...
        /// <returns>a duplicate instance of NewAzNetworkSecurityRule_Create1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzNetworkSecurityRule_Create1 Clone()
        {
            var clone = new NewAzNetworkSecurityRule_Create1();
            ...
            clone.NsgName = this.NsgName;
            clone.Name = this.Name;
            clone.SubscriptionId = this.SubscriptionId;
            clone.SecurityRule = this.SecurityRule;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzNetworkSecurityRule_Create1" /> cmdlet class.
        /// </summary>
        public NewAzNetworkSecurityRule_Create1()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SecurityRulesCreateOrUpdate1(ResourceGroupName, NsgName, Name, SubscriptionId, SecurityRule, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,NsgName=NsgName,Name=Name,SubscriptionId=SubscriptionId,body=SecurityRule})
                    {
