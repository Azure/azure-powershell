namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RouteTables_ListAll=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Network/routeTables"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/routeTable.json#/paths/~1subscriptions~1{subscriptionId}~1providers~1Microsoft.Network~1routeTables
    /// profiles:
    ...
    /// variant: List1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRouteTable_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Gets all route tables in a subscription.")]
    ...
    public partial class GetAzRouteTable_List1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRouteTable_List1" /> cmdlet class.
        /// </summary>
        public GetAzRouteTable_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.RouteTablesListAll(SubscriptionId, onOk, this, Pipeline);
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.RouteTablesListAll_Call(requestMessage, onOk, this, Pipeline);
                    }
                }
            }
        }
