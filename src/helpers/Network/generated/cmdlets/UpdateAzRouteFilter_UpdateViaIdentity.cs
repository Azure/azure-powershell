namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RouteFilters_Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeFilters/{routeFilterName}"
    /// [METADATA]
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzRouteFilter_UpdateViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Updates a route filter in a specified resource group.")]
    ...
    public partial class UpdateAzRouteFilter_UpdateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPatchRouteFilter _routeFilter;
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPatchRouteFilter) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPatchRouteFilter RouteFilter { get => this._routeFilter; set => this._routeFilter = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzRouteFilter_UpdateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.UpdateAzRouteFilter_UpdateViaIdentity Clone()
        {
            var clone = new UpdateAzRouteFilter_UpdateViaIdentity();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'RouteFiltersUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.RouteFiltersUpdateViaIdentity(InputObject.Id, RouteFilter, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.RouteFiltersUpdate(InputObject.ResourceGroupName ?? null, InputObject.RouteFilterName ?? null, InputObject.SubscriptionId ?? null, RouteFilter, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=RouteFilter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzRouteFilter_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzRouteFilter_UpdateViaIdentity()
        {
