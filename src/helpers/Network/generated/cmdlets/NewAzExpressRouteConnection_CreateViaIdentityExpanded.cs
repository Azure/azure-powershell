namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ExpressRouteConnections_CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteGateways/{expressRouteGatewayName}/expressRouteConnections/{connectionName}"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/expressRouteGateway.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1expressRouteGateways~1{expressRouteGatewayName}~1expressRouteConnections~1{connectionName}
    /// profiles:
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzExpressRouteConnection_CreateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteConnection))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Creates a connection between an ExpressRoute gateway and an ExpressRoute circuit.")]
    ...
    public partial class NewAzExpressRouteConnection_CreateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Authorization key to establish the connection.")]
        ...
        public string AuthorizationKey { get => PutExpressRouteConnectionParametersBody.AuthorizationKey ?? null; set => PutExpressRouteConnectionParametersBody.AuthorizationKey = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The ID of the ExpressRoute circuit peering.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string ExpressRouteCircuitPeeringId { get => PutExpressRouteConnectionParametersBody.ExpressRouteCircuitPeeringId ?? null; set => PutExpressRouteConnectionParametersBody.ExpressRouteCircuitPeeringId = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string Id { get => PutExpressRouteConnectionParametersBody.Id ?? null; set => PutExpressRouteConnectionParametersBody.Id = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.ProvisioningState ProvisioningState { get => PutExpressRouteConnectionParametersBody.ProvisioningState ?? ((Microsoft.Azure.PowerShell.Cmdlets.Network.Support.ProvisioningState)""); set => PutExpressRouteConnectionParametersBody.ProvisioningState = value; }
        ...
        /// <summary>
        /// Backing field for <see cref="PutExpressRouteConnectionParametersBody" /> property.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteConnection _putExpressRouteConnectionParametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ExpressRouteConnection();

        /// <summary>ExpressRouteConnection resource.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteConnection PutExpressRouteConnectionParametersBody { get => this._putExpressRouteConnectionParametersBody; set => this._putExpressRouteConnectionParametersBody = value; }
        ...
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(string) })]
        public string ResourceName { get => PutExpressRouteConnectionParametersBody.Name ?? null; set => PutExpressRouteConnectionParametersBody.Name = value; }

        /// <summary>The routing weight associated to the connection.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The routing weight associated to the connection.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public int RoutingWeight { get => PutExpressRouteConnectionParametersBody.RoutingWeight ?? default(int); set => PutExpressRouteConnectionParametersBody.RoutingWeight = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteConnection"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteConnection> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzExpressRouteConnection_CreateViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzExpressRouteConnection_CreateViaIdentityExpanded Clone()
        {
            var clone = new NewAzExpressRouteConnection_CreateViaIdentityExpanded();
            ...
            clone.PutExpressRouteConnectionParametersBody = this.PutExpressRouteConnectionParametersBody;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzExpressRouteConnection_CreateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public NewAzExpressRouteConnection_CreateViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ExpressRouteConnectionsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ExpressRouteConnectionsCreateOrUpdateViaIdentity(InputObject.Id, PutExpressRouteConnectionParametersBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.ExpressRouteGatewayName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.ExpressRouteGatewayName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        ...
                        await this.Client.ExpressRouteConnectionsCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.ExpressRouteGatewayName ?? null, InputObject.ConnectionName ?? null, InputObject.SubscriptionId ?? null, PutExpressRouteConnectionParametersBody, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=PutExpressRouteConnectionParametersBody})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteConnection> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteConnection
