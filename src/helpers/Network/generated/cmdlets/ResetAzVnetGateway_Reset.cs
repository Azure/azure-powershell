namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] VirtualNetworkGateways_Reset=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/reset"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/virtualNetworkGateway.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1virtualNetworkGateways~1{virtualNetworkGatewayName}~1reset
    /// profiles:
    ...
    /// variant: Reset
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Reset, @"AzVnetGateway_Reset", SupportsShouldProcess = true)]
    [global::System.Management.Automation.Alias("Reset-AzVirtualNetworkGateway")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Resets the primary of the virtual network gateway in the specified resource group.")]
    ...
    public partial class ResetAzVnetGateway_Reset : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="GatewayVip" /> property.</summary>
        private string _gatewayVip;

        /// <summary>
        /// Virtual network gateway vip address supplied to the begin reset of the active-active feature enabled gateway.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Virtual network gateway vip address supplied to the begin reset of the active-active feature enabled gateway.")]
        ...
        public string GatewayVip { get => this._gatewayVip; set => this._gatewayVip = value; }
        ...
        /// <returns>a duplicate instance of ResetAzVnetGateway_Reset</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.ResetAzVnetGateway_Reset Clone()
        {
            var clone = new ResetAzVnetGateway_Reset();
            ...
            clone.GatewayVip = this.GatewayVip;
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkGatewaysReset' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VirtualNetworkGatewaysReset(ResourceGroupName, Name, this.InvocationInformation.BoundParameters.ContainsKey("GatewayVip") ? GatewayVip : null, SubscriptionId, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,GatewayVip=this.InvocationInformation.BoundParameters.ContainsKey("GatewayVip") ? GatewayVip : null,SubscriptionId=SubscriptionId})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ResetAzVnetGateway_Reset" /> cmdlet class.
        /// </summary>
        public ResetAzVnetGateway_Reset()
        {
