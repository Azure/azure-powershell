namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Get
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVnetGatewayVpnProfilePackageUrl_Get", SupportsShouldProcess = true)]
    ...
    public partial class GetAzVnetGatewayVpnProfilePackageUrl_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetAzVnetGatewayVpnProfilePackageUrl_Get</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzVnetGatewayVpnProfilePackageUrl_Get Clone()
        {
            var clone = new GetAzVnetGatewayVpnProfilePackageUrl_Get();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVnetGatewayVpnProfilePackageUrl_Get" /> cmdlet class.
        /// </summary>
        public GetAzVnetGatewayVpnProfilePackageUrl_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysGetVpnProfilePackageUrl(ResourceGroupName, VnetGatewayName, SubscriptionId, onOk, this, Pipeline);
