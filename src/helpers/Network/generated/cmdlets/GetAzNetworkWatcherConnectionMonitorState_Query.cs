namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Query
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzNetworkWatcherConnectionMonitorState_Query", SupportsShouldProcess = true)]
    ...
    public partial class GetAzNetworkWatcherConnectionMonitorState_Query : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>The name given to the connection monitor.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name given to the connection monitor.")]
        ...
        /// <returns>a duplicate instance of GetAzNetworkWatcherConnectionMonitorState_Query</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzNetworkWatcherConnectionMonitorState_Query Clone()
        {
            var clone = new GetAzNetworkWatcherConnectionMonitorState_Query();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzNetworkWatcherConnectionMonitorState_Query" /> cmdlet class.
        /// </summary>
        public GetAzNetworkWatcherConnectionMonitorState_Query()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ConnectionMonitorsQuery(ResourceGroupName, NetworkWatcherName, ConnectionMonitorName, SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,NetworkWatcherName=NetworkWatcherName,ConnectionMonitorName=ConnectionMonitorName,SubscriptionId=SubscriptionId})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, NetworkWatcherName=NetworkWatcherName, ConnectionMonitorName=ConnectionMonitorName, SubscriptionId=SubscriptionId })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, NetworkWatcherName=NetworkWatcherName, ConnectionMonitorName=ConnectionMonitorName, SubscriptionId=SubscriptionId })
                    {
