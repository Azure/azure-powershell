namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Supported1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVnetGatewaySupportedVpnDevice_Supported1", SupportsShouldProcess = true)]
    ...
    public partial class GetAzVnetGatewaySupportedVpnDevice_Supported1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVnetGatewaySupportedVpnDevice_Supported1" /> cmdlet class.
        /// </summary>
        public GetAzVnetGatewaySupportedVpnDevice_Supported1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysSupportedVpnDevices1(ResourceGroupName, Name, SubscriptionId, onOk, this, Pipeline);
