namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Reset, @"AzVnetGatewayVpnClientSharedKey_ResetViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class ResetAzVnetGatewayVpnClientSharedKey_ResetViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of ResetAzVnetGatewayVpnClientSharedKey_ResetViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.ResetAzVnetGatewayVpnClientSharedKey_ResetViaIdentity Clone()
        {
            var clone = new ResetAzVnetGatewayVpnClientSharedKey_ResetViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualNetworkGatewaysResetVpnClientSharedKeyViaIdentity(InputObject.Id, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysResetVpnClientSharedKey(InputObject.ResourceGroupName ?? null, InputObject.VnetGatewayName ?? null, InputObject.SubscriptionId ?? null, onOk, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ResetAzVnetGatewayVpnClientSharedKey_ResetViaIdentity" /> cmdlet class.
        /// </summary>
        public ResetAzVnetGatewayVpnClientSharedKey_ResetViaIdentity()
        {
