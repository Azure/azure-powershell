namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzExpressRouteCircuit_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzExpressRouteCircuit_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzExpressRouteCircuit_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.RemoveAzExpressRouteCircuit_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzExpressRouteCircuit_DeleteViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ExpressRouteCircuitsDeleteViaIdentity(InputObject.Id, onOk, onNoContent, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ExpressRouteCircuitsDelete(InputObject.ResourceGroupName ?? null, InputObject.CircuitName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzExpressRouteCircuit_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzExpressRouteCircuit_DeleteViaIdentity()
        {
