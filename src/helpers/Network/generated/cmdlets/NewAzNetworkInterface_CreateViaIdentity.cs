namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzNetworkInterface_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzNetworkInterface_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "A network interface in a resource group.", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.INetworkInterface NetworkInterface { get => this._networkInterface; set => this._networkInterface = value; }
        ...
        /// <returns>a duplicate instance of NewAzNetworkInterface_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzNetworkInterface_CreateViaIdentity Clone()
        {
            var clone = new NewAzNetworkInterface_CreateViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzNetworkInterface_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzNetworkInterface_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.NetworkInterfacesCreateOrUpdateViaIdentity(InputObject.Id, NetworkInterface, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NetworkInterfacesCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.NetworkInterfaceName ?? null, InputObject.SubscriptionId ?? null, NetworkInterface, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=NetworkInterface})
                    {
