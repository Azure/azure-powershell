namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ApplicationGateways_ListAvailableRequestHeaders=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Network/applicationGatewayAvailableRequestHeaders"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/applicationGateway.json#/paths/~1subscriptions~1{subscriptionId}~1providers~1Microsoft.Network~1applicationGatewayAvailableRequestHeaders
    /// profiles:
    /// latest-2019-04-30: '2019-02-01'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: ApplicationGatewayAvailableRequestHeader
    /// variant: List
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzApplicationGatewayAvailableRequestHeader_List")]
    [global::System.Management.Automation.OutputType(typeof(string))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Lists all available request headers.")]
    ...
    public partial class GetAzApplicationGatewayAvailableRequestHeader_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzApplicationGatewayAvailableRequestHeader_List" /> cmdlet class.
        /// </summary>
        public GetAzApplicationGatewayAvailableRequestHeader_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ApplicationGatewaysListAvailableRequestHeaders(SubscriptionId, onOk, onDefault, this, Pipeline);
