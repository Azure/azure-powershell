namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Supported
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVirtualWanSupportedSecurityProvider_Supported")]
    ...
    public partial class GetAzVirtualWanSupportedSecurityProvider_Supported : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the VirtualWAN for which supported security providers are needed.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVirtualWanSupportedSecurityProvider_Supported" /> cmdlet class.
        /// </summary>
        public GetAzVirtualWanSupportedSecurityProvider_Supported()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SupportedSecurityProviders(SubscriptionId, ResourceGroupName, VirtualWanName, onOk, onDefault, this, Pipeline);
