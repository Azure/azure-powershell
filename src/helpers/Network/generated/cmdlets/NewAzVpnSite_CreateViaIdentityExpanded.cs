namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] VpnSites_CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnSites/{vpnSiteName}"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/virtualWan.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1vpnSites~1{vpnSiteName}
    /// profiles:
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzVpnSite_CreateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Creates a VpnSite resource if it doesn't exist else updates the existing VpnSite.")]
    ...
    public partial class NewAzVpnSite_CreateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Alias("AddressSpace")]
        public string[] AddressPrefix { get => VpnSiteParametersBody.AddressPrefix ?? null /* arrayOf */; set => VpnSiteParametersBody.AddressPrefix = value; }
        ...
        public long BgpAsn { get => VpnSiteParametersBody.BgpAsn ?? default(long); set => VpnSiteParametersBody.BgpAsn = value; }
        ...
        public int BgpPeerWeight { get => VpnSiteParametersBody.BgpPeerWeight ?? default(int); set => VpnSiteParametersBody.BgpPeerWeight = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string BgpPeeringAddress { get => VpnSiteParametersBody.BgpPeeringAddress ?? null; set => VpnSiteParametersBody.BgpPeeringAddress = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Model of the device.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string DeviceModel { get => VpnSiteParametersBody.DeviceModel ?? null; set => VpnSiteParametersBody.DeviceModel = value; }

        /// <summary>Name of the device Vendor.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of the device Vendor.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string DeviceVendor { get => VpnSiteParametersBody.DeviceVendor ?? null; set => VpnSiteParametersBody.DeviceVendor = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The ip-address for the vpn-site.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string IPAddress { get => VpnSiteParametersBody.IPAddress ?? null; set => VpnSiteParametersBody.IPAddress = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string Id { get => VpnSiteParametersBody.Id ?? null; set => VpnSiteParametersBody.Id = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Link speed.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int LinkSpeedInMbps { get => VpnSiteParametersBody.LinkSpeedInMbps ?? default(int); set => VpnSiteParametersBody.LinkSpeedInMbps = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => VpnSiteParametersBody.Location ?? null; set => VpnSiteParametersBody.Location = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.ProvisioningState ProvisioningState { get => VpnSiteParametersBody.ProvisioningState ?? ((Microsoft.Azure.PowerShell.Cmdlets.Network.Support.ProvisioningState)""); set => VpnSiteParametersBody.ProvisioningState = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "IsSecuritySite flag")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public global::System.Management.Automation.SwitchParameter SecuritySite { get => VpnSiteParametersBody.SecuritySite ?? default(global::System.Management.Automation.SwitchParameter); set => VpnSiteParametersBody.SecuritySite = value; }

        /// <summary>The key for vpn-site that can be used for connections.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The key for vpn-site that can be used for connections.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SiteKey { get => VpnSiteParametersBody.SiteKey ?? null; set => VpnSiteParametersBody.SiteKey = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IResourceTags Tag { get => VpnSiteParametersBody.Tag ?? null /* object */; set => VpnSiteParametersBody.Tag = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string VirtualWanId { get => VpnSiteParametersBody.VirtualWanId ?? null; set => VpnSiteParametersBody.VirtualWanId = value; }

        /// <summary>Backing field for <see cref="VpnSiteParametersBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnSite _vpnSiteParametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.VpnSite();

        /// <summary>VpnSite Resource.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnSite VpnSiteParametersBody { get => this._vpnSiteParametersBody; set => this._vpnSiteParametersBody = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnSite"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnSite> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzVpnSite_CreateViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzVpnSite_CreateViaIdentityExpanded Clone()
        {
            var clone = new NewAzVpnSite_CreateViaIdentityExpanded();
            ...
            clone.VpnSiteParametersBody = this.VpnSiteParametersBody;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzVpnSite_CreateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public NewAzVpnSite_CreateViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VpnSitesCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VpnSitesCreateOrUpdateViaIdentity(InputObject.Id, VpnSiteParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.VpnSiteName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.VpnSiteName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.VpnSitesCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VpnSiteName ?? null, VpnSiteParametersBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=VpnSiteParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=VpnSiteParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=VpnSiteParametersBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnSite> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnSite
