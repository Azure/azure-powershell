namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] LoadBalancerNetworkInterfaces_List=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/networkInterfaces"
    /// [METADATA]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Gets associated load balancer network interfaces.")]
    ...
    public partial class GetAzLoadBalancerNetworkInterface_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzLoadBalancerNetworkInterface_List" /> cmdlet class.
        /// </summary>
        public GetAzLoadBalancerNetworkInterface_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.LoadBalancerNetworkInterfacesList(ResourceGroupName, LoadBalancerName, SubscriptionId, onOk, this, Pipeline);
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.LoadBalancerNetworkInterfacesList_Call(requestMessage, onOk, this, Pipeline);
                    }
                }
            }
        }
