namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: ScriptViaIdentity1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVnetGatewayVpnDeviceConfigurationScript_ScriptViaIdentity1", SupportsShouldProcess = true)]
    ...
    public partial class GetAzVnetGatewayVpnDeviceConfigurationScript_ScriptViaIdentity1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="VpnDeviceConfigurationScript" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IVpnDeviceScriptParameters _vpnDeviceConfigurationScript;

        /// <summary>Vpn device configuration script generation parameters</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Vpn device configuration script generation parameters", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Vpn device configuration script generation parameters",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IVpnDeviceScriptParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IVpnDeviceScriptParameters VpnDeviceConfigurationScript { get => this._vpnDeviceConfigurationScript; set => this._vpnDeviceConfigurationScript = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVnetGatewayVpnDeviceConfigurationScript_ScriptViaIdentity1" /> cmdlet
        /// class.
        /// </summary>
        public GetAzVnetGatewayVpnDeviceConfigurationScript_ScriptViaIdentity1()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualNetworkGatewaysVpnDeviceConfigurationScript1ViaIdentity(InputObject.Id, VpnDeviceConfigurationScript, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysVpnDeviceConfigurationScript1(InputObject.ResourceGroupName ?? null, InputObject.VnetGatewayConnectionName ?? null, InputObject.SubscriptionId ?? null, VpnDeviceConfigurationScript, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=VpnDeviceConfigurationScript})
                    {
