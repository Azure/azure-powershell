namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Update
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzExpressRouteCrossConnectionPeering_Update", SupportsShouldProcess = true)]
    ...
    public partial class SetAzExpressRouteCrossConnectionPeering_Update : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="CrossConnectionPeering" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteCrossConnectionPeering _crossConnectionPeering;

        /// <summary>Peering in an ExpressRoute Cross Connection resource.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Peering in an ExpressRoute Cross Connection resource.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Peering in an ExpressRoute Cross Connection resource.",
        SerializedName = @"peeringParameters",
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteCrossConnectionPeering CrossConnectionPeering { get => this._crossConnectionPeering; set => this._crossConnectionPeering = value; }
        ...
        /// <returns>a duplicate instance of SetAzExpressRouteCrossConnectionPeering_Update</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.SetAzExpressRouteCrossConnectionPeering_Update Clone()
        {
            var clone = new SetAzExpressRouteCrossConnectionPeering_Update();
            ...
            clone.CrossConnectionPeering = this.CrossConnectionPeering;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ExpressRouteCrossConnectionPeeringsCreateOrUpdate(ResourceGroupName, CrossConnectionName, Name, SubscriptionId, CrossConnectionPeering, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,CrossConnectionName=CrossConnectionName,Name=Name,SubscriptionId=SubscriptionId,body=CrossConnectionPeering})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzExpressRouteCrossConnectionPeering_Update" /> cmdlet class.
        /// </summary>
        public SetAzExpressRouteCrossConnectionPeering_Update()
        {
