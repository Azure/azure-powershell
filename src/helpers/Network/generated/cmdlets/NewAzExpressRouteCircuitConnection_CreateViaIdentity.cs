namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzExpressRouteCircuitConnection_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzExpressRouteCircuitConnection_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of NewAzExpressRouteCircuitConnection_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzExpressRouteCircuitConnection_CreateViaIdentity Clone()
        {
            var clone = new NewAzExpressRouteCircuitConnection_CreateViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzExpressRouteCircuitConnection_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzExpressRouteCircuitConnection_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ExpressRouteCircuitConnectionsCreateOrUpdateViaIdentity(InputObject.Id, ExpressRouteCircuitConnection, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ExpressRouteCircuitConnectionsCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.CircuitName ?? null, InputObject.PeeringName ?? null, InputObject.ConnectionName ?? null, InputObject.SubscriptionId ?? null, ExpressRouteCircuitConnection, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ExpressRouteCircuitConnection})
                    {
