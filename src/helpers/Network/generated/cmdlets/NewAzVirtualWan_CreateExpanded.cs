namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] VirtualWans_CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{VirtualWANName}"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/virtualWan.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1virtualWans~1{VirtualWANName}
    /// profiles:
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzVirtualWan_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVirtualWan))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Creates a VirtualWAN resource if it doesn't exist else updates the existing VirtualWAN.")]
    ...
    public partial class NewAzVirtualWan_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "True if branch to branch traffic is allowed.")]
        ...
        public global::System.Management.Automation.SwitchParameter AllowBranchToBranchTraffic { get => WanParametersBody.AllowBranchToBranchTraffic ?? default(global::System.Management.Automation.SwitchParameter); set => WanParametersBody.AllowBranchToBranchTraffic = value; }

        /// <summary>True if Vnet to Vnet traffic is allowed.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "True if Vnet to Vnet traffic is allowed.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter AllowVnetToVnetTraffic { get => WanParametersBody.AllowVnetToVnetTraffic ?? default(global::System.Management.Automation.SwitchParameter); set => WanParametersBody.AllowVnetToVnetTraffic = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Vpn encryption to be disabled or not.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter DisableVpnEncryption { get => WanParametersBody.DisableVpnEncryption ?? default(global::System.Management.Automation.SwitchParameter); set => WanParametersBody.DisableVpnEncryption = value; }
        ...
        public string Id { get => WanParametersBody.Id ?? null; set => WanParametersBody.Id = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => WanParametersBody.Location ?? null; set => WanParametersBody.Location = value; }
        ...
        /// <summary>The name of the VirtualWAN being created or updated.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the VirtualWAN being created or updated.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("VirtualWanName")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of all P2SVpnServerConfigurations associated with the virtual wan.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IP2SVpnServerConfiguration[] P2SVpnServerConfiguration { get => WanParametersBody.P2SVpnServerConfiguration ?? null /* arrayOf */; set => WanParametersBody.P2SVpnServerConfiguration = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.ProvisioningState ProvisioningState { get => WanParametersBody.ProvisioningState ?? ((Microsoft.Azure.PowerShell.Cmdlets.Network.Support.ProvisioningState)""); set => WanParametersBody.ProvisioningState = value; }
        ...
        /// <summary>The resource group name of the VirtualWan.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The resource group name of the VirtualWan.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The Security Provider name.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SecurityProviderName { get => WanParametersBody.SecurityProviderName ?? null; set => WanParametersBody.SecurityProviderName = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IResourceTags Tag { get => WanParametersBody.Tag ?? null /* object */; set => WanParametersBody.Tag = value; }

        /// <summary>Backing field for <see cref="WanParametersBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVirtualWan _wanParametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.VirtualWan();

        /// <summary>VirtualWAN Resource.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVirtualWan WanParametersBody { get => this._wanParametersBody; set => this._wanParametersBody = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVirtualWan"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVirtualWan> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzVirtualWan_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzVirtualWan_CreateExpanded Clone()
        {
            var clone = new NewAzVirtualWan_CreateExpanded();
            ...
            clone.WanParametersBody = this.WanParametersBody;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzVirtualWan_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzVirtualWan_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualWansCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VirtualWansCreateOrUpdate(SubscriptionId, ResourceGroupName, Name, WanParametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Name=Name,body=WanParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=WanParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=WanParametersBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVirtualWan> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVirtualWan
