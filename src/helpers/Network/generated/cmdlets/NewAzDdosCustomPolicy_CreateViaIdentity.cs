namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzDdosCustomPolicy_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzDdosCustomPolicy_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IDdosCustomPolicy _ddosCustomPolicy;

        /// <summary>A DDoS custom policy in a resource group.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "A DDoS custom policy in a resource group.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"A DDoS custom policy in a resource group.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IDdosCustomPolicy) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IDdosCustomPolicy DdosCustomPolicy { get => this._ddosCustomPolicy; set => this._ddosCustomPolicy = value; }
        ...
        /// <returns>a duplicate instance of NewAzDdosCustomPolicy_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzDdosCustomPolicy_CreateViaIdentity Clone()
        {
            var clone = new NewAzDdosCustomPolicy_CreateViaIdentity();
            ...
            clone.DdosCustomPolicy = this.DdosCustomPolicy;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzDdosCustomPolicy_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzDdosCustomPolicy_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DdosCustomPoliciesCreateOrUpdateViaIdentity(InputObject.Id, DdosCustomPolicy, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.DdosCustomPoliciesCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.DdosCustomPolicyName ?? null, InputObject.SubscriptionId ?? null, DdosCustomPolicy, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=DdosCustomPolicy})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=DdosCustomPolicy })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=DdosCustomPolicy })
                    {
