namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ExpressRouteCrossConnections_ListArpTable=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCrossConnections/{crossConnectionName}/peerings/{peeringName}/arpTables/{devicePath}"
    /// [METADATA]
    ...
    /// verb: Get
    /// subjectPrefix:
    /// subject: ExpressRouteCrossConnectionArpTable
    /// variant: List
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzExpressRouteCrossConnectionArpTable_List", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Gets the currently advertised ARP table associated with the express route cross connection in a resource group.")]
    ...
    public partial class GetAzExpressRouteCrossConnectionArpTable_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetAzExpressRouteCrossConnectionArpTable_List</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzExpressRouteCrossConnectionArpTable_List Clone()
        {
            var clone = new GetAzExpressRouteCrossConnectionArpTable_List();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzExpressRouteCrossConnectionArpTable_List" /> cmdlet class.
        /// </summary>
        public GetAzExpressRouteCrossConnectionArpTable_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ExpressRouteCrossConnectionsListArpTable' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ExpressRouteCrossConnectionsListArpTable(ResourceGroupName, CrossConnectionName, PeeringName, DevicePath, SubscriptionId, onOk, this, Pipeline);
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.ExpressRouteCrossConnectionsListArpTable_Call(requestMessage, onOk, this, Pipeline);
                    }
                }
            }
        }
