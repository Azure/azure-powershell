namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: GetExpanded
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzNetworkWatcherNextHop_GetExpanded", SupportsShouldProcess = true)]
    ...
    public partial class GetAzNetworkWatcherNextHop_GetExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        public string DestinationIPAddress { get => ParametersBody.DestinationIPAddress ?? null; set => ParametersBody.DestinationIPAddress = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.INextHopParameters _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.NextHopParameters();

        /// <summary>Parameters that define the source and destination endpoint.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.INextHopParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SourceIPAddress { get => ParametersBody.SourceIPAddress ?? null; set => ParametersBody.SourceIPAddress = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("TargetNetworkInterfaceId")]
        public string TargetNetworkInterfaceResourceId { get => ParametersBody.TargetNicResourceId ?? null; set => ParametersBody.TargetNicResourceId = value; }
        ...
        public string TargetVMResourceId { get => ParametersBody.TargetResourceId ?? null; set => ParametersBody.TargetResourceId = value; }
        ...
        /// <returns>a duplicate instance of GetAzNetworkWatcherNextHop_GetExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzNetworkWatcherNextHop_GetExpanded Clone()
        {
            var clone = new GetAzNetworkWatcherNextHop_GetExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzNetworkWatcherNextHop_GetExpanded" /> cmdlet class.
        /// </summary>
        public GetAzNetworkWatcherNextHop_GetExpanded()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.NetworkWatchersGetNextHop(ResourceGroupName, NetworkWatcherName, SubscriptionId, ParametersBody, onOk, onDefault, this, Pipeline);
