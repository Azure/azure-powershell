namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzExpressRouteGateway_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzExpressRouteGateway_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of NewAzExpressRouteGateway_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzExpressRouteGateway_CreateViaIdentity Clone()
        {
            var clone = new NewAzExpressRouteGateway_CreateViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzExpressRouteGateway_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzExpressRouteGateway_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ExpressRouteGatewaysCreateOrUpdateViaIdentity(InputObject.Id, ExpressRouteGateway, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ExpressRouteGatewaysCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.ExpressRouteGatewayName ?? null, InputObject.SubscriptionId ?? null, ExpressRouteGateway, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ExpressRouteGateway})
                    {
