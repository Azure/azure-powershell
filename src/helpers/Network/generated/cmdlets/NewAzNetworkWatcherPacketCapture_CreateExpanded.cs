namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] PacketCaptures_Create=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/packetCaptures/{packetCaptureName}"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/networkWatcher.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1networkWatchers~1{networkWatcherName}~1packetCaptures~1{packetCaptureName}
    /// profiles:
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzNetworkWatcherPacketCapture_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Create and start a packet capture on the specified VM.")]
    ...
    public partial class NewAzNetworkWatcherPacketCapture_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        public int BytesToCapturePerPacket { get => ParametersBody.BytesToCapturePerPacket ?? default(int); set => ParametersBody.BytesToCapturePerPacket = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPacketCaptureFilter[] Filter { get => ParametersBody.Filter ?? null /* arrayOf */; set => ParametersBody.Filter = value; }
        ...
        [global::System.Management.Automation.Alias("PacketCaptureName")]
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPacketCapture _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.PacketCapture();

        /// <summary>Parameters that define the create packet capture operation.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPacketCapture ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The ID of the storage account to save the packet capture session. Required if no local file path is provided.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string StorageAccountId { get => ParametersBody.StorageLocationStorageId ?? null; set => ParametersBody.StorageLocationStorageId = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "A valid local path on the targeting VM. Must include the name of the capture file (*.cap). For linux virtual machine it must start with /var/captures. Required if no storage ID is provided, otherwise optional.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("LocalFilePath")]
        public string StorageFilePath { get => ParametersBody.StorageLocationFilePath ?? null; set => ParametersBody.StorageLocationFilePath = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("StoragePath")]
        public string StoragePathUri { get => ParametersBody.StorageLocationStoragePath ?? null; set => ParametersBody.StorageLocationStoragePath = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The ID of the targeted resource, only VM is currently supported.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("TargetVirtualMachineId")]
        public string TargetResourceId { get => ParametersBody.Target ?? null; set => ParametersBody.Target = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int TimeLimitInSeconds { get => ParametersBody.TimeLimitInSeconds ?? default(int); set => ParametersBody.TimeLimitInSeconds = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int TotalBytesPerSession { get => ParametersBody.TotalBytesPerSession ?? default(int); set => ParametersBody.TotalBytesPerSession = value; }
        ...
        /// <returns>a duplicate instance of NewAzNetworkWatcherPacketCapture_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzNetworkWatcherPacketCapture_CreateExpanded Clone()
        {
            var clone = new NewAzNetworkWatcherPacketCapture_CreateExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzNetworkWatcherPacketCapture_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzNetworkWatcherPacketCapture_CreateExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PacketCapturesCreate(ResourceGroupName, NetworkWatcherName, Name, SubscriptionId, ParametersBody, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,NetworkWatcherName=NetworkWatcherName,Name=Name,SubscriptionId=SubscriptionId,body=ParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, NetworkWatcherName=NetworkWatcherName, Name=Name, SubscriptionId=SubscriptionId, body=ParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, NetworkWatcherName=NetworkWatcherName, Name=Name, SubscriptionId=SubscriptionId, body=ParametersBody })
                    {
