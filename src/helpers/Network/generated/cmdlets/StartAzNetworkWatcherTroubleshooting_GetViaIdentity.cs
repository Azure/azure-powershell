namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzNetworkWatcherTroubleshooting_GetViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class StartAzNetworkWatcherTroubleshooting_GetViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ITroubleshootingParameters _troubleshooting;

        /// <summary>Parameters that define the resource to troubleshoot.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters that define the resource to troubleshoot.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Parameters that define the resource to troubleshoot.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ITroubleshootingParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ITroubleshootingParameters Troubleshooting { get => this._troubleshooting; set => this._troubleshooting = value; }
        ...
        /// <returns>a duplicate instance of StartAzNetworkWatcherTroubleshooting_GetViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.StartAzNetworkWatcherTroubleshooting_GetViaIdentity Clone()
        {
            var clone = new StartAzNetworkWatcherTroubleshooting_GetViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.NetworkWatchersGetTroubleshootingViaIdentity(InputObject.Id, Troubleshooting, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NetworkWatchersGetTroubleshooting(InputObject.ResourceGroupName ?? null, InputObject.NetworkWatcherName ?? null, InputObject.SubscriptionId ?? null, Troubleshooting, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=Troubleshooting})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzNetworkWatcherTroubleshooting_GetViaIdentity" /> cmdlet class.
        /// </summary>
        public StartAzNetworkWatcherTroubleshooting_GetViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=Troubleshooting })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=Troubleshooting })
                    {
