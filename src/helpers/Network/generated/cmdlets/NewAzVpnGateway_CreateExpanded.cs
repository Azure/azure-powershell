namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzVpnGateway_CreateExpanded", SupportsShouldProcess = true)]
    ...
    public partial class NewAzVpnGateway_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        public long BgpAsn { get => VpnGatewayParametersBody.BgpAsn ?? default(long); set => VpnGatewayParametersBody.BgpAsn = value; }
        ...
        public int BgpPeerWeight { get => VpnGatewayParametersBody.BgpPeerWeight ?? default(int); set => VpnGatewayParametersBody.BgpPeerWeight = value; }
        ...
        public string BgpPeeringAddress { get => VpnGatewayParametersBody.BgpPeeringAddress ?? null; set => VpnGatewayParametersBody.BgpPeeringAddress = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of all vpn connections to the gateway.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Alias("VpnConnection")]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnConnection[] Connection { get => VpnGatewayParametersBody.Connection ?? null /* arrayOf */; set => VpnGatewayParametersBody.Connection = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string Id { get => VpnGatewayParametersBody.Id ?? null; set => VpnGatewayParametersBody.Id = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => VpnGatewayParametersBody.Location ?? null; set => VpnGatewayParametersBody.Location = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.ProvisioningState ProvisioningState { get => VpnGatewayParametersBody.ProvisioningState ?? ((Microsoft.Azure.PowerShell.Cmdlets.Network.Support.ProvisioningState)""); set => VpnGatewayParametersBody.ProvisioningState = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The scale unit for this vpn gateway.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        [global::System.Management.Automation.Alias("VpnGatewayScaleUnit")]
        public int ScaleUnit { get => VpnGatewayParametersBody.ScaleUnit ?? default(int); set => VpnGatewayParametersBody.ScaleUnit = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IResourceTags Tag { get => VpnGatewayParametersBody.Tag ?? null /* object */; set => VpnGatewayParametersBody.Tag = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string VirtualHubId { get => VpnGatewayParametersBody.VirtualHubId ?? null; set => VpnGatewayParametersBody.VirtualHubId = value; }

        /// <summary>Backing field for <see cref="VpnGatewayParametersBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnGateway _vpnGatewayParametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.VpnGateway();

        /// <summary>VpnGateway Resource.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVpnGateway VpnGatewayParametersBody { get => this._vpnGatewayParametersBody; set => this._vpnGatewayParametersBody = value; }
        ...
        /// <returns>a duplicate instance of NewAzVpnGateway_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzVpnGateway_CreateExpanded Clone()
        {
            var clone = new NewAzVpnGateway_CreateExpanded();
            ...
            clone.VpnGatewayParametersBody = this.VpnGatewayParametersBody;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzVpnGateway_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzVpnGateway_CreateExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VpnGatewaysCreateOrUpdate(SubscriptionId, ResourceGroupName, Name, VpnGatewayParametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Name=Name,body=VpnGatewayParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=VpnGatewayParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=VpnGatewayParametersBody })
                    {
