namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] P2sVpnGateways_Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/p2svpnGateways/{gatewayName}"
    /// [METADATA]
    ...
    /// variant: Get
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzP2SVpnGateway_Get")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Retrieves the details of a virtual wan p2s vpn gateway.")]
    ...
    public partial class GetAzP2SVpnGateway_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzP2SVpnGateway_Get" /> cmdlet class.
        /// </summary>
        public GetAzP2SVpnGateway_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.P2SVpnGatewaysGet(SubscriptionId, ResourceGroupName, Name, onOk, onDefault, this, Pipeline);
