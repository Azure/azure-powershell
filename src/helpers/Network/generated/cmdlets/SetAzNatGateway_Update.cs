namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Update
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzNatGateway_Update", SupportsShouldProcess = true)]
    ...
    public partial class SetAzNatGateway_Update : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.INatGateway _natGateway;

        /// <summary>Nat Gateway resource.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Nat Gateway resource.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.INatGateway NatGateway { get => this._natGateway; set => this._natGateway = value; }
        ...
        /// <returns>a duplicate instance of SetAzNatGateway_Update</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.SetAzNatGateway_Update Clone()
        {
            var clone = new SetAzNatGateway_Update();
            ...
            clone.NatGateway = this.NatGateway;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.NatGatewaysCreateOrUpdate(ResourceGroupName, Name, SubscriptionId, NatGateway, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,SubscriptionId=SubscriptionId,body=NatGateway})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzNatGateway_Update" /> cmdlet class.
        /// </summary>
        public SetAzNatGateway_Update()
        {
