namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <summary>Updates service Endpoint Policies.</summary>
    /// <remarks>
    /// [OpenAPI] ServiceEndpointPolicies_Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/serviceEndpointPolicies/{serviceEndpointPolicyName}"
    /// [METADATA]
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzServiceEndpointPolicy_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Updates service Endpoint Policies.")]
    ...
    public partial class UpdateAzServiceEndpointPolicy_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ITagsObject _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.TagsObject();

        /// <summary>Tags object for patch operations.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ITagsObject ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ITagsObjectTags) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ITagsObjectTags Tag { get => ParametersBody.Tag ?? null /* object */; set => ParametersBody.Tag = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzServiceEndpointPolicy_UpdateViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.UpdateAzServiceEndpointPolicy_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzServiceEndpointPolicy_UpdateViaIdentityExpanded();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ServiceEndpointPoliciesUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServiceEndpointPoliciesUpdateViaIdentity(InputObject.Id, ParametersBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServiceEndpointPoliciesUpdate(InputObject.ResourceGroupName ?? null, InputObject.ServiceEndpointPolicyName ?? null, InputObject.SubscriptionId ?? null, ParametersBody, onOk, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzServiceEndpointPolicy_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzServiceEndpointPolicy_UpdateViaIdentityExpanded()
        {
