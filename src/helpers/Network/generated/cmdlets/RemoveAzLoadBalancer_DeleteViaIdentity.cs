namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzLoadBalancer_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzLoadBalancer_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzLoadBalancer_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.RemoveAzLoadBalancer_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzLoadBalancer_DeleteViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.LoadBalancersDeleteViaIdentity(InputObject.Id, onOk, onNoContent, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.LoadBalancersDelete(InputObject.ResourceGroupName ?? null, InputObject.LoadBalancerName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzLoadBalancer_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzLoadBalancer_DeleteViaIdentity()
        {
