namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <summary>Gets all interface endpoints in a subscription.</summary>
    /// <remarks>
    /// [OpenAPI] InterfaceEndpoints_ListBySubscription=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Network/interfaceEndpoints"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/interfaceEndpoint.json#/paths/~1subscriptions~1{subscriptionId}~1providers~1Microsoft.Network~1interfaceEndpoints
    /// profiles:
    ...
    /// variant: List1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzInterfaceEndpoint_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Gets all interface endpoints in a subscription.")]
    ...
    public partial class GetAzInterfaceEndpoint_List1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzInterfaceEndpoint_List1" /> cmdlet class.
        /// </summary>
        public GetAzInterfaceEndpoint_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.InterfaceEndpointsListBySubscription(SubscriptionId, onOk, this, Pipeline);
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.InterfaceEndpointsListBySubscription_Call(requestMessage, onOk, this, Pipeline);
                    }
                }
            }
        }
