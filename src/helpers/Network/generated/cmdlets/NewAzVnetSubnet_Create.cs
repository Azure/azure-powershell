namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Create
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzVnetSubnet_Create", SupportsShouldProcess = true)]
    ...
    public partial class NewAzVnetSubnet_Create : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Subnet in a virtual network resource.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Subnet in a virtual network resource.",
        SerializedName = @"subnetParameters",
        ...
        /// <returns>a duplicate instance of NewAzVnetSubnet_Create</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzVnetSubnet_Create Clone()
        {
            var clone = new NewAzVnetSubnet_Create();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzVnetSubnet_Create" /> cmdlet class.
        /// </summary>
        public NewAzVnetSubnet_Create()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SubnetsCreateOrUpdate(ResourceGroupName, VnetName, Name, SubscriptionId, Subnet, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,VnetName=VnetName,Name=Name,SubscriptionId=SubscriptionId,body=Subnet})
                    {
