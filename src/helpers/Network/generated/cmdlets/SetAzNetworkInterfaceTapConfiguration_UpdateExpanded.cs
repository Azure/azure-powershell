namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] NetworkInterfaceTapConfigurations_CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}/tapConfigurations/{tapConfigurationName}"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/networkInterface.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1networkInterfaces~1{networkInterfaceName}~1tapConfigurations~1{tapConfigurationName}
    /// profiles:
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzNetworkInterfaceTapConfiguration_UpdateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.Alias("Set-AzNetworkInterfaceTapConfig")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.INetworkInterfaceTapConfiguration))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Creates or updates a Tap configuration in the specified NetworkInterface.")]
    ...
    public partial class SetAzNetworkInterfaceTapConfiguration_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        public string Etag { get => TapConfigurationParametersBody.Etag ?? null; set => TapConfigurationParametersBody.Etag = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string Id { get => TapConfigurationParametersBody.Id ?? null; set => TapConfigurationParametersBody.Id = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the tap configuration.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("TapConfigurationName")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the network interface.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(string) })]
        public string ResourceName { get => TapConfigurationParametersBody.Name ?? null; set => TapConfigurationParametersBody.Name = value; }
        ...
        /// <summary>Backing field for <see cref="TapConfigurationParametersBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.INetworkInterfaceTapConfiguration _tapConfigurationParametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.NetworkInterfaceTapConfiguration();

        /// <summary>Tap configuration in a Network Interface</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.INetworkInterfaceTapConfiguration TapConfigurationParametersBody { get => this._tapConfigurationParametersBody; set => this._tapConfigurationParametersBody = value; }

        /// <summary>The reference of the Virtual Network Tap resource.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The reference of the Virtual Network Tap resource.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVirtualNetworkTap VnetTap { get => TapConfigurationParametersBody.VnetTap ?? null /* object */; set => TapConfigurationParametersBody.VnetTap = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.INetworkInterfaceTapConfiguration"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.INetworkInterfaceTapConfiguration> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of SetAzNetworkInterfaceTapConfiguration_UpdateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.SetAzNetworkInterfaceTapConfiguration_UpdateExpanded Clone()
        {
            var clone = new SetAzNetworkInterfaceTapConfiguration_UpdateExpanded();
            ...
            clone.TapConfigurationParametersBody = this.TapConfigurationParametersBody;
            clone.ResourceGroupName = this.ResourceGroupName;
            clone.NetworkInterfaceName = this.NetworkInterfaceName;
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NetworkInterfaceTapConfigurationsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.NetworkInterfaceTapConfigurationsCreateOrUpdate(ResourceGroupName, NetworkInterfaceName, Name, SubscriptionId, TapConfigurationParametersBody, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,NetworkInterfaceName=NetworkInterfaceName,Name=Name,SubscriptionId=SubscriptionId,body=TapConfigurationParametersBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzNetworkInterfaceTapConfiguration_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public SetAzNetworkInterfaceTapConfiguration_UpdateExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.INetworkInterfaceTapConfiguration> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.INetworkInterfaceTapConfiguration
