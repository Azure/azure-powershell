namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ApplicationGateways_ListAvailableServerVariables=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Network/applicationGatewayAvailableServerVariables"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/applicationGateway.json#/paths/~1subscriptions~1{subscriptionId}~1providers~1Microsoft.Network~1applicationGatewayAvailableServerVariables
    /// profiles:
    /// latest-2019-04-30: '2019-02-01'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: ApplicationGatewayAvailableServerVariable
    /// variant: List
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzApplicationGatewayAvailableServerVariable_List")]
    [global::System.Management.Automation.OutputType(typeof(string))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Lists all available server variables.")]
    ...
    public partial class GetAzApplicationGatewayAvailableServerVariable_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzApplicationGatewayAvailableServerVariable_List" /> cmdlet class.
        /// </summary>
        public GetAzApplicationGatewayAvailableServerVariable_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ApplicationGatewaysListAvailableServerVariables(SubscriptionId, onOk, onDefault, this, Pipeline);
