namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] VpnGateways_Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}"
    /// [METADATA]
    ...
    /// variant: Get
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVpnGateway_Get")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Retrieves the details of a virtual wan vpn gateway.")]
    ...
    public partial class GetAzVpnGateway_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVpnGateway_Get" /> cmdlet class.
        /// </summary>
        public GetAzVpnGateway_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VpnGatewaysGet(SubscriptionId, ResourceGroupName, Name, onOk, onDefault, this, Pipeline);
