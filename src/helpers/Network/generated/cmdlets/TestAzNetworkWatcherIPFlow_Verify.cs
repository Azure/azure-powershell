namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Verify
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzNetworkWatcherIPFlow_Verify", SupportsShouldProcess = true)]
    ...
    public partial class TestAzNetworkWatcherIPFlow_Verify : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of TestAzNetworkWatcherIPFlow_Verify</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.TestAzNetworkWatcherIPFlow_Verify Clone()
        {
            var clone = new TestAzNetworkWatcherIPFlow_Verify();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.NetworkWatchersVerifyIPFlow(ResourceGroupName, NetworkWatcherName, SubscriptionId, IPFlow, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,NetworkWatcherName=NetworkWatcherName,SubscriptionId=SubscriptionId,body=IPFlow})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzNetworkWatcherIPFlow_Verify" /> cmdlet class.
        /// </summary>
        public TestAzNetworkWatcherIPFlow_Verify()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, NetworkWatcherName=NetworkWatcherName, SubscriptionId=SubscriptionId, body=IPFlow })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, NetworkWatcherName=NetworkWatcherName, SubscriptionId=SubscriptionId, body=IPFlow })
                    {
