namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Subnets_Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}"
    /// [METADATA]
    ...
    /// subjectPrefix:
    /// subject: VnetSubnet
    /// variant: DeleteViaIdentity1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzVnetSubnet_DeleteViaIdentity1", SupportsShouldProcess = true)]
    [global::System.Management.Automation.Alias("Remove-AzVirtualNetworkSubnet")]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Deletes the specified subnet.")]
    ...
    public partial class RemoveAzVnetSubnet_DeleteViaIdentity1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzVnetSubnet_DeleteViaIdentity1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.RemoveAzVnetSubnet_DeleteViaIdentity1 Clone()
        {
            var clone = new RemoveAzVnetSubnet_DeleteViaIdentity1();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SubnetsDelete1' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.SubnetsDelete1ViaIdentity(InputObject.Id, onOk, onNoContent, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.SubnetsDelete1(InputObject.ResourceGroupName ?? null, InputObject.VnetName ?? null, InputObject.SubnetName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzVnetSubnet_DeleteViaIdentity1" /> cmdlet class.
        /// </summary>
        public RemoveAzVnetSubnet_DeleteViaIdentity1()
        {
