namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzVnet_CreateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.Alias("New-AzVirtualNetwork")]
    ...
    public partial class NewAzVnet_CreateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string DdosProtectionPlanId { get => ParametersBody.DdosProtectionPlanId ?? null; set => ParametersBody.DdosProtectionPlanId = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Indicates if DDoS protection is enabled for all the protected resources in the virtual network. It requires a DDoS protection plan associated with the resource.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Indicates if VM protection is enabled for all the subnets in the virtual network.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVirtualNetwork _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.VirtualNetwork();

        /// <summary>Virtual Network resource.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVirtualNetwork ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ISubnet[] Subnet { get => ParametersBody.Subnet ?? null /* arrayOf */; set => ParametersBody.Subnet = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IVirtualNetworkPeering[] VnetPeering { get => ParametersBody.Peering ?? null /* arrayOf */; set => ParametersBody.Peering = value; }
        ...
        /// <returns>a duplicate instance of NewAzVnet_CreateViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzVnet_CreateViaIdentityExpanded Clone()
        {
            var clone = new NewAzVnet_CreateViaIdentityExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzVnet_CreateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public NewAzVnet_CreateViaIdentityExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualNetworksCreateOrUpdateViaIdentity(InputObject.Id, ParametersBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualNetworksCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.VnetName ?? null, InputObject.SubscriptionId ?? null, ParametersBody, onOk, this, Pipeline);
                    }
