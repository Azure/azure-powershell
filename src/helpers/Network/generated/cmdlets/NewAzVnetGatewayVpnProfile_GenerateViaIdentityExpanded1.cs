namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <summary>
    /// Generates VPN profile for P2S client of the virtual network gateway in the specified resource group. Used for IKEV2 and
    /// radius based authentication.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] VirtualNetworkGateways_GenerateVpnProfile=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/generatevpnprofile"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2017-10-01/virtualNetworkGateway.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1virtualNetworkGateways~1{virtualNetworkGatewayName}~1generatevpnprofile
    /// profiles:
    ...
    /// variant: GenerateViaIdentityExpanded1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzVnetGatewayVpnProfile_GenerateViaIdentityExpanded1", SupportsShouldProcess = true)]
    [global::System.Management.Automation.Alias("New-AzVirtualNetworkGatewayVpnProfile")]
    [global::System.Management.Automation.OutputType(typeof(string))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Generates VPN profile for P2S client of the virtual network gateway in the specified resource group. Used for IKEV2 and radius based authentication.")]
    ...
    public partial class NewAzVnetGatewayVpnProfile_GenerateViaIdentityExpanded1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "VPN client Authentication Method. Possible values are: 'EAPTLS' and 'EAPMSCHAPv2'.")]
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Support.AuthenticationMethod))]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.AuthenticationMethod AuthenticationMethod { get => ParametersBody.AuthenticationMethod ?? ((Microsoft.Azure.PowerShell.Cmdlets.Network.Support.AuthenticationMethod)""); set => ParametersBody.AuthenticationMethod = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "A list of client root certificates public certificate data encoded as Base-64 strings. Optional parameter for external radius based authentication with EAPTLS.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string[] ClientRootCertificate { get => ParametersBody.ClientRootCertificate ?? null /* arrayOf */; set => ParametersBody.ClientRootCertificate = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IVpnClientParameters _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.VpnClientParameters();

        /// <summary>Vpn Client Parameters for package generation</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IVpnClientParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "VPN client Processor Architecture. Possible values are: 'AMD64' and 'X86'.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Support.ProcessorArchitecture))]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.ProcessorArchitecture ProcessorArchitecture { get => ParametersBody.ProcessorArchitecture ?? ((Microsoft.Azure.PowerShell.Cmdlets.Network.Support.ProcessorArchitecture)""); set => ParametersBody.ProcessorArchitecture = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The public certificate data for the radius server authentication certificate as a Base-64 encoded string. Required only if external radius authentication has been configured with EAPTLS authentication.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string RadiusServerAuthenticationCertificate { get => ParametersBody.RadiusServerAuthCertificate ?? null; set => ParametersBody.RadiusServerAuthCertificate = value; }
        ...
        /// <returns>a duplicate instance of NewAzVnetGatewayVpnProfile_GenerateViaIdentityExpanded1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzVnetGatewayVpnProfile_GenerateViaIdentityExpanded1 Clone()
        {
            var clone = new NewAzVnetGatewayVpnProfile_GenerateViaIdentityExpanded1();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzVnetGatewayVpnProfile_GenerateViaIdentityExpanded1" /> cmdlet class.
        /// </summary>
        public NewAzVnetGatewayVpnProfile_GenerateViaIdentityExpanded1()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkGatewaysGenerateVpnProfile1' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualNetworkGatewaysGenerateVpnProfile1ViaIdentity(InputObject.Id, ParametersBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.VnetGatewayName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.VnetGatewayName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        if (null == InputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.VirtualNetworkGatewaysGenerateVpnProfile1(InputObject.ResourceGroupName ?? null, InputObject.VnetGatewayName ?? null, InputObject.SubscriptionId ?? null, ParametersBody, onOk, this, Pipeline);
                    }
