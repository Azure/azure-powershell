namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <summary>
    /// The VirtualNetworkGatewayConnectionResetSharedKey operation resets the virtual network gateway connection shared key for
    /// passed virtual network gateway connection in the specified resource group through Network resource provider.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] VirtualNetworkGatewayConnections_ResetSharedKey=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/connections/{virtualNetworkGatewayConnectionName}/sharedkey/reset"
    /// [METADATA]
    ...
    /// variant: ResetExpanded1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Reset, @"AzVnetGatewayConnectionSharedKey_ResetExpanded1", SupportsShouldProcess = true)]
    [global::System.Management.Automation.Alias("Reset-AzVirtualNetworkGatewayConnectionSharedKey")]
    [global::System.Management.Automation.OutputType(typeof(int))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"The VirtualNetworkGatewayConnectionResetSharedKey operation resets the virtual network gateway connection shared key for passed virtual network gateway connection in the specified resource group through Network resource provider.")]
    ...
    public partial class ResetAzVnetGatewayConnectionSharedKey_ResetExpanded1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The virtual network connection reset shared key length, should between 1 and 128.")]
        ...
        public int KeyLength { get => ParametersBody.KeyLength; set => ParametersBody.KeyLength = value; }
        ...
        /// <summary>The virtual network gateway connection reset shared key Name.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The virtual network gateway connection reset shared key Name.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IConnectionResetSharedKey _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.ConnectionResetSharedKey();

        /// <summary>The virtual network connection reset shared key</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IConnectionResetSharedKey ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IConnectionResetSharedKey"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IConnectionResetSharedKey> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of ResetAzVnetGatewayConnectionSharedKey_ResetExpanded1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.ResetAzVnetGatewayConnectionSharedKey_ResetExpanded1 Clone()
        {
            var clone = new ResetAzVnetGatewayConnectionSharedKey_ResetExpanded1();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkGatewayConnectionsResetSharedKey1' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VirtualNetworkGatewayConnectionsResetSharedKey1(ResourceGroupName, Name, SubscriptionId, ParametersBody, onOk, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ResetAzVnetGatewayConnectionSharedKey_ResetExpanded1" /> cmdlet class.
        /// </summary>
        public ResetAzVnetGatewayConnectionSharedKey_ResetExpanded1()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IConnectionResetSharedKey> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IConnectionResetSharedKey
                WriteObject((await response).KeyLength);
            }
        }
    }
}