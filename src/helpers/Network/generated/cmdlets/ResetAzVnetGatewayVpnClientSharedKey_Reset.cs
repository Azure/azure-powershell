namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] VirtualNetworkGateways_ResetVpnClientSharedKey=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/resetvpnclientsharedkey"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/virtualNetworkGateway.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1virtualNetworkGateways~1{virtualNetworkGatewayName}~1resetvpnclientsharedkey
    /// profiles:
    /// latest-2019-04-30: '2019-02-01'
    /// [DETAILS]
    /// verb: Reset
    /// subjectPrefix:
    /// subject: VnetGatewayVpnClientSharedKey
    /// variant: Reset
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Reset, @"AzVnetGatewayVpnClientSharedKey_Reset", SupportsShouldProcess = true)]
    [global::System.Management.Automation.Alias("Reset-AzVirtualNetworkGatewayVpnClientSharedKey")]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Resets the VPN client shared key of the virtual network gateway in the specified resource group.")]
    ...
    public partial class ResetAzVnetGatewayVpnClientSharedKey_Reset : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of ResetAzVnetGatewayVpnClientSharedKey_Reset</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.ResetAzVnetGatewayVpnClientSharedKey_Reset Clone()
        {
            var clone = new ResetAzVnetGatewayVpnClientSharedKey_Reset();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkGatewaysResetVpnClientSharedKey' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VirtualNetworkGatewaysResetVpnClientSharedKey(ResourceGroupName, VnetGatewayName, SubscriptionId, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,VnetGatewayName=VnetGatewayName,SubscriptionId=SubscriptionId})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ResetAzVnetGatewayVpnClientSharedKey_Reset" /> cmdlet class.
        /// </summary>
        public ResetAzVnetGatewayVpnClientSharedKey_Reset()
        {
