namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ExpressRouteCircuitPeerings_CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}"
    /// [METADATA]
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzExpressRouteCircuitPeering_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Creates or updates a peering in the specified express route circuits.")]
    ...
    public partial class NewAzExpressRouteCircuitPeering_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Peering in an ExpressRouteCircuit resource.", ValueFromPipeline = true)]
        ...
        /// <returns>a duplicate instance of NewAzExpressRouteCircuitPeering_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzExpressRouteCircuitPeering_CreateViaIdentity Clone()
        {
            var clone = new NewAzExpressRouteCircuitPeering_CreateViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzExpressRouteCircuitPeering_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzExpressRouteCircuitPeering_CreateViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ExpressRouteCircuitPeeringsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ExpressRouteCircuitPeeringsCreateOrUpdateViaIdentity(InputObject.Id, Peering, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ExpressRouteCircuitPeeringsCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.CircuitName ?? null, InputObject.PeeringName ?? null, InputObject.SubscriptionId ?? null, Peering, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=Peering})
                    {
