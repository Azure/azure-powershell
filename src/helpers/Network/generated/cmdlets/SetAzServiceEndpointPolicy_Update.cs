namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Update
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzServiceEndpointPolicy_Update", SupportsShouldProcess = true)]
    ...
    public partial class SetAzServiceEndpointPolicy_Update : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the service endpoint policy.")]
        ...
        [global::System.Management.Automation.Alias("ServiceEndpointPolicyName")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Service End point policy resource.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <returns>a duplicate instance of SetAzServiceEndpointPolicy_Update</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.SetAzServiceEndpointPolicy_Update Clone()
        {
            var clone = new SetAzServiceEndpointPolicy_Update();
            ...
            clone.ServiceEndpointPolicy = this.ServiceEndpointPolicy;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ServiceEndpointPoliciesCreateOrUpdate(ResourceGroupName, Name, SubscriptionId, ServiceEndpointPolicy, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,SubscriptionId=SubscriptionId,body=ServiceEndpointPolicy})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzServiceEndpointPolicy_Update" /> cmdlet class.
        /// </summary>
        public SetAzServiceEndpointPolicy_Update()
        {
