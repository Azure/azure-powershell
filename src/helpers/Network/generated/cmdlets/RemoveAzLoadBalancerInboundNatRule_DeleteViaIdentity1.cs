namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzLoadBalancerInboundNatRule_DeleteViaIdentity1", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzLoadBalancerInboundNatRule_DeleteViaIdentity1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzLoadBalancerInboundNatRule_DeleteViaIdentity1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.RemoveAzLoadBalancerInboundNatRule_DeleteViaIdentity1 Clone()
        {
            var clone = new RemoveAzLoadBalancerInboundNatRule_DeleteViaIdentity1();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'InboundNatRulesDelete1' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.InboundNatRulesDelete1ViaIdentity(InputObject.Id, onOk, onNoContent, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.InboundNatRulesDelete1(InputObject.ResourceGroupName ?? null, InputObject.LoadBalancerName ?? null, InputObject.InboundNatRuleName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzLoadBalancerInboundNatRule_DeleteViaIdentity1" /> cmdlet class.
        /// </summary>
        public RemoveAzLoadBalancerInboundNatRule_DeleteViaIdentity1()
        {
