namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DdosProtectionPlans_CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/ddosProtectionPlans/{ddosProtectionPlanName}"
    /// [METADATA]
    ...
    /// variant: Create
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzDdosProtectionPlan_Create", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Creates or updates a DDoS protection plan.")]
    ...
    public partial class NewAzDdosProtectionPlan_Create : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IDdosProtectionPlan _ddosProtectionPlan;

        /// <summary>A DDoS protection plan in a resource group.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "A DDoS protection plan in a resource group.", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IDdosProtectionPlan DdosProtectionPlan { get => this._ddosProtectionPlan; set => this._ddosProtectionPlan = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the DDoS protection plan.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Alias("DdosProtectionPlanName")]
        ...
        /// <returns>a duplicate instance of NewAzDdosProtectionPlan_Create</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzDdosProtectionPlan_Create Clone()
        {
            var clone = new NewAzDdosProtectionPlan_Create();
            ...
            clone.DdosProtectionPlan = this.DdosProtectionPlan;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzDdosProtectionPlan_Create" /> cmdlet class.
        /// </summary>
        public NewAzDdosProtectionPlan_Create()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DdosProtectionPlansCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DdosProtectionPlansCreateOrUpdate(ResourceGroupName, Name, SubscriptionId, DdosProtectionPlan, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,SubscriptionId=SubscriptionId,body=DdosProtectionPlan})
                    {
