namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Get
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzExpressRouteCircuit_Get")]
    ...
    public partial class GetAzExpressRouteCircuit_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of express route circuit.")]
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzExpressRouteCircuit_Get" /> cmdlet class.
        /// </summary>
        public GetAzExpressRouteCircuit_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ExpressRouteCircuitsGet(ResourceGroupName, Name, SubscriptionId, onOk, this, Pipeline);
