namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzNetworkSecurityRule_CreateViaIdentity1", SupportsShouldProcess = true)]
    ...
    public partial class NewAzNetworkSecurityRule_CreateViaIdentity1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of NewAzNetworkSecurityRule_CreateViaIdentity1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzNetworkSecurityRule_CreateViaIdentity1 Clone()
        {
            var clone = new NewAzNetworkSecurityRule_CreateViaIdentity1();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzNetworkSecurityRule_CreateViaIdentity1" /> cmdlet class.
        /// </summary>
        public NewAzNetworkSecurityRule_CreateViaIdentity1()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.SecurityRulesCreateOrUpdate1ViaIdentity(InputObject.Id, SecurityRule, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.SecurityRulesCreateOrUpdate1(InputObject.ResourceGroupName ?? null, InputObject.NsgName ?? null, InputObject.SecurityRuleName ?? null, InputObject.SubscriptionId ?? null, SecurityRule, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=SecurityRule})
                    {
