namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RouteFilterRules_CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeFilters/{routeFilterName}/routeFilterRules/{ruleName}"
    /// [METADATA]
    ...
    /// variant: Create
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzRouteFilterRule_Create", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Creates or updates a route in the specified route filter.")]
    ...
    public partial class NewAzRouteFilterRule_Create : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>The name of the route filter rule.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the route filter rule.")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the route filter.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>Backing field for <see cref="RouteFilterRule" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IRouteFilterRule _routeFilterRule;

        /// <summary>Route Filter Rule Resource</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Route Filter Rule Resource", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Route Filter Rule Resource",
        SerializedName = @"routeFilterRuleParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IRouteFilterRule) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IRouteFilterRule RouteFilterRule { get => this._routeFilterRule; set => this._routeFilterRule = value; }
        ...
        /// <returns>a duplicate instance of NewAzRouteFilterRule_Create</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.NewAzRouteFilterRule_Create Clone()
        {
            var clone = new NewAzRouteFilterRule_Create();
            ...
            clone.RouteFilterName = this.RouteFilterName;
            clone.Name = this.Name;
            clone.SubscriptionId = this.SubscriptionId;
            clone.RouteFilterRule = this.RouteFilterRule;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzRouteFilterRule_Create" /> cmdlet class.
        /// </summary>
        public NewAzRouteFilterRule_Create()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'RouteFilterRulesCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RouteFilterRulesCreateOrUpdate(ResourceGroupName, RouteFilterName, Name, SubscriptionId, RouteFilterRule, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,RouteFilterName=RouteFilterName,Name=Name,SubscriptionId=SubscriptionId,body=RouteFilterRule})
                    {
