namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: ScriptExpanded1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVnetGatewayVpnDeviceConfigurationScript_ScriptExpanded1", SupportsShouldProcess = true)]
    ...
    public partial class GetAzVnetGatewayVpnDeviceConfigurationScript_ScriptExpanded1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the virtual network gateway connection for which the configuration script is generated.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVnetGatewayVpnDeviceConfigurationScript_ScriptExpanded1" /> cmdlet class.
        /// </summary>
        public GetAzVnetGatewayVpnDeviceConfigurationScript_ScriptExpanded1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysVpnDeviceConfigurationScript1(ResourceGroupName, Name, SubscriptionId, ParametersBody, onOk, this, Pipeline);
