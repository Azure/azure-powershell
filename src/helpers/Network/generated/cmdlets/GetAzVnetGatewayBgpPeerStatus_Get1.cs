namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] VirtualNetworkGateways_GetBgpPeerStatus=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/getBgpPeerStatus"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2017-10-01/virtualNetworkGateway.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1virtualNetworkGateways~1{virtualNetworkGatewayName}~1getBgpPeerStatus
    /// profiles:
    /// hybrid-2019-03-01: '2017-10-01'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: VnetGatewayBgpPeerStatus
    /// variant: Get1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVnetGatewayBgpPeerStatus_Get1", SupportsShouldProcess = true)]
    [global::System.Management.Automation.Alias("Get-AzVirtualNetworkGatewayBgpPeerStatus")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IBgpPeerStatus))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"The GetBgpPeerStatus operation retrieves the status of all BGP peers.")]
    ...
    public partial class GetAzVnetGatewayBgpPeerStatus_Get1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>The IP address of the peer to retrieve the status of.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The IP address of the peer to retrieve the status of.")]
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IBgpPeerStatusListResult"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IBgpPeerStatusListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of GetAzVnetGatewayBgpPeerStatus_Get1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzVnetGatewayBgpPeerStatus_Get1 Clone()
        {
            var clone = new GetAzVnetGatewayBgpPeerStatus_Get1();
            ...
            clone.VnetGatewayName = this.VnetGatewayName;
            clone.Peer = this.Peer;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVnetGatewayBgpPeerStatus_Get1" /> cmdlet class.
        /// </summary>
        public GetAzVnetGatewayBgpPeerStatus_Get1()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkGatewaysGetBgpPeerStatus1' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysGetBgpPeerStatus1(ResourceGroupName, VnetGatewayName, this.InvocationInformation.BoundParameters.ContainsKey("Peer") ? Peer : null, SubscriptionId, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,VnetGatewayName=VnetGatewayName,Peer=this.InvocationInformation.BoundParameters.ContainsKey("Peer") ? Peer : null,SubscriptionId=SubscriptionId})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IBgpPeerStatusListResult> response)
        {
            using( NoSynchronizationContext )
            {
