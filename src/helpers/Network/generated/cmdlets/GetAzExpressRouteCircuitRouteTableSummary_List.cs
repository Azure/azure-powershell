namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ExpressRouteCircuits_ListRoutesTableSummary=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}/routeTablesSummary/{devicePath}"
    /// [METADATA]
    ...
    /// verb: Get
    /// subjectPrefix:
    /// subject: ExpressRouteCircuitRouteTableSummary
    /// variant: List
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzExpressRouteCircuitRouteTableSummary_List", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteCircuitsRoutesTableSummaryListResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Gets the currently advertised routes table summary associated with the express route circuit in a resource group.")]
    ...
    public partial class GetAzExpressRouteCircuitRouteTableSummary_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteCircuitsRoutesTableSummaryListResult"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteCircuitsRoutesTableSummaryListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of GetAzExpressRouteCircuitRouteTableSummary_List</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzExpressRouteCircuitRouteTableSummary_List Clone()
        {
            var clone = new GetAzExpressRouteCircuitRouteTableSummary_List();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzExpressRouteCircuitRouteTableSummary_List" /> cmdlet class.
        /// </summary>
        public GetAzExpressRouteCircuitRouteTableSummary_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ExpressRouteCircuitsListRoutesTableSummary' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ExpressRouteCircuitsListRoutesTableSummary(ResourceGroupName, CircuitName, PeeringName, DevicePath, SubscriptionId, onOk, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IExpressRouteCircuitsRoutesTableSummaryListResult> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.ExpressRouteCircuitsListRoutesTableSummary_Call(requestMessage, onOk, this, Pipeline);
                    }
                }
            }
        }
