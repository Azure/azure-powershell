namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// - '2019-02-01'
    /// filename:
    /// - 'mem:///969?oai3.shaken.json'
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/checkDnsAvailability.json#/paths/~1subscriptions~1{subscriptionId}~1providers~1Microsoft.Network~1locations~1{location}~1CheckDnsNameAvailability
    /// profiles:
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzDnsNameAvailability_CheckViaIdentity")]
    ...
    public partial class TestAzDnsNameAvailability_CheckViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.CheckDnsNameAvailabilityViaIdentity(InputObject.Id, DomainNameLabel, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.CheckDnsNameAvailability(InputObject.Location ?? null, DomainNameLabel, InputObject.SubscriptionId ?? null, onOk, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzDnsNameAvailability_CheckViaIdentity" /> cmdlet class.
        /// </summary>
        public TestAzDnsNameAvailability_CheckViaIdentity()
        {
