namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Get
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzExpressRoutePort_Get")]
    ...
    public partial class GetAzExpressRoutePort_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>The name of ExpressRoutePort.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of ExpressRoutePort.")]
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzExpressRoutePort_Get" /> cmdlet class.
        /// </summary>
        public GetAzExpressRoutePort_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ExpressRoutePortsGet(SubscriptionId, ResourceGroupName, Name, onOk, this, Pipeline);
