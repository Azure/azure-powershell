namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// - '2015-06-15'
    /// filename:
    /// - 'mem:///1011?oai3.shaken.json'
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2015-06-15/expressRouteCircuit.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1expressRouteCircuits~1{circuitName}~1routesTable
    /// profiles:
    /// latest-2019-04-30: '2015-06-15'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: ExpressRouteRouteTable
    /// variant: CircuitList1Circuit
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzExpressRouteRouteTable_CircuitList1Circuit")]
    [global::System.Management.Automation.Alias("Get-AzExpressRouteCircuitRouteTable")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20150615.IExpressRouteCircuitRoutesTable))]
    ...
    public partial class GetAzExpressRouteRouteTable_CircuitList1Circuit : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20150615.IExpressRouteCircuitsRoutesTableListResult"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20150615.IExpressRouteCircuitsRoutesTableListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzExpressRouteRouteTable_CircuitList1Circuit" /> cmdlet class.
        /// </summary>
        public GetAzExpressRouteRouteTable_CircuitList1Circuit()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ExpressRouteCircuitsListRoutesTable1(ResourceGroupName, CircuitName, SubscriptionId, onOk, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20150615.IExpressRouteCircuitsRoutesTableListResult> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.ExpressRouteCircuitsListRoutesTable1_Call(requestMessage, onOk, this, Pipeline);
                    }
                }
            }
        }
