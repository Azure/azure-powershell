namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] InboundNatRules_Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/inboundNatRules/{inboundNatRuleName}"
    /// [METADATA]
    ...
    /// variant: Get1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzLoadBalancerInboundNatRule_Get1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Gets the specified load balancer inbound nat rule.")]
    ...
    public partial class GetAzLoadBalancerInboundNatRule_Get1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzLoadBalancerInboundNatRule_Get1" /> cmdlet class.
        /// </summary>
        public GetAzLoadBalancerInboundNatRule_Get1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.InboundNatRulesGet1(ResourceGroupName, LoadBalancerName, Name, SubscriptionId, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,LoadBalancerName=LoadBalancerName,Name=Name,SubscriptionId=SubscriptionId,Expand=this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null})
                    {
