namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/virtualNetworkGateway.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1virtualNetworkGateways~1{virtualNetworkGatewayName}~1getLearnedRoutes
    /// profiles:
    ...
    /// variant: Get
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVnetGatewayLearnedRoute_Get", SupportsShouldProcess = true)]
    ...
    public partial class GetAzVnetGatewayLearnedRoute_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetAzVnetGatewayLearnedRoute_Get</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzVnetGatewayLearnedRoute_Get Clone()
        {
            var clone = new GetAzVnetGatewayLearnedRoute_Get();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVnetGatewayLearnedRoute_Get" /> cmdlet class.
        /// </summary>
        public GetAzVnetGatewayLearnedRoute_Get()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualNetworkGatewaysGetLearnedRoutes' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysGetLearnedRoutes(ResourceGroupName, VnetGatewayName, SubscriptionId, onOk, this, Pipeline);
