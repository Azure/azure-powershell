namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// <summary>Updates a route in the specified route filter.</summary>
    /// <remarks>
    /// [OpenAPI] RouteFilterRules_Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeFilters/{routeFilterName}/routeFilterRules/{ruleName}"
    /// [METADATA]
    ...
    /// - '2019-02-01'
    /// filename:
    /// - 'mem:///987?oai3.shaken.json'
    /// originalLocations:
    /// - >-
    /// https://github.com/Azure/azure-rest-api-specs/blob/resource-hybrid-profile-fix/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/routeFilter.json#/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1routeFilters~1{routeFilterName}~1routeFilterRules~1{ruleName}
    /// profiles:
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzRouteFilterRule_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IRouteFilterRule))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Description(@"Updates a route in the specified route filter.")]
    ...
    public partial class UpdateAzRouteFilterRule_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The access type of the rule.")]
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Support.Access))]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Support.Access Access { get => RouteFilterRuleParametersBody.Access; set => RouteFilterRuleParametersBody.Access = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The collection for bgp community values to filter on. e.g. ['12076:5010','12076:5020']")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Network.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Network.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string[] Community { get => RouteFilterRuleParametersBody.Community ?? null /* arrayOf */; set => RouteFilterRuleParametersBody.Community = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string Id { get => RouteFilterRuleParametersBody.Id ?? null; set => RouteFilterRuleParametersBody.Id = value; }
        ...
        /// <summary>Backing field for <see cref="RouteFilterRuleParametersBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPatchRouteFilterRule _routeFilterRuleParametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.PatchRouteFilterRule();

        /// <summary>Route Filter Rule Resource</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IPatchRouteFilterRule RouteFilterRuleParametersBody { get => this._routeFilterRuleParametersBody; set => this._routeFilterRuleParametersBody = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IRouteFilterRule"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IRouteFilterRule> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of UpdateAzRouteFilterRule_UpdateViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.UpdateAzRouteFilterRule_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzRouteFilterRule_UpdateViaIdentityExpanded();
            ...
            clone.RouteFilterRuleParametersBody = this.RouteFilterRuleParametersBody;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'RouteFilterRulesUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.RouteFilterRulesUpdateViaIdentity(InputObject.Id, RouteFilterRuleParametersBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.RouteFilterName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.RouteFilterName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        ...
                        await this.Client.RouteFilterRulesUpdate(InputObject.ResourceGroupName ?? null, InputObject.RouteFilterName ?? null, InputObject.RuleName ?? null, InputObject.SubscriptionId ?? null, RouteFilterRuleParametersBody, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=RouteFilterRuleParametersBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzRouteFilterRule_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzRouteFilterRule_UpdateViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IRouteFilterRule> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IRouteFilterRule
