namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzExpressRouteConnection_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzExpressRouteConnection_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzExpressRouteConnection_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.RemoveAzExpressRouteConnection_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzExpressRouteConnection_DeleteViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ExpressRouteConnectionsDeleteViaIdentity(InputObject.Id, onOk, onNoContent, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ExpressRouteConnectionsDelete(InputObject.ResourceGroupName ?? null, InputObject.ExpressRouteGatewayName ?? null, InputObject.ConnectionName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzExpressRouteConnection_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzExpressRouteConnection_DeleteViaIdentity()
        {
