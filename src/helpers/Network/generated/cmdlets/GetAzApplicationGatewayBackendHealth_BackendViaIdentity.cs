namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: BackendViaIdentity
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzApplicationGatewayBackendHealth_BackendViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class GetAzApplicationGatewayBackendHealth_BackendViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetAzApplicationGatewayBackendHealth_BackendViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzApplicationGatewayBackendHealth_BackendViaIdentity Clone()
        {
            var clone = new GetAzApplicationGatewayBackendHealth_BackendViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzApplicationGatewayBackendHealth_BackendViaIdentity" /> cmdlet class.
        /// </summary>
        public GetAzApplicationGatewayBackendHealth_BackendViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ApplicationGatewaysBackendHealthViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ApplicationGatewaysBackendHealth(InputObject.ResourceGroupName ?? null, InputObject.ApplicationGatewayName ?? null, InputObject.SubscriptionId ?? null, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, onOk, this, Pipeline);
                    }
