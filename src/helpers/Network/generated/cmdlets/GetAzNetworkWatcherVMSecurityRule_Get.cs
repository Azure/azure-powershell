namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Get
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzNetworkWatcherVMSecurityRule_Get", SupportsShouldProcess = true)]
    ...
    public partial class GetAzNetworkWatcherVMSecurityRule_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetAzNetworkWatcherVMSecurityRule_Get</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.GetAzNetworkWatcherVMSecurityRule_Get Clone()
        {
            var clone = new GetAzNetworkWatcherVMSecurityRule_Get();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzNetworkWatcherVMSecurityRule_Get" /> cmdlet class.
        /// </summary>
        public GetAzNetworkWatcherVMSecurityRule_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.NetworkWatchersGetVMSecurityRules(ResourceGroupName, NetworkWatcherName, SubscriptionId, SecurityGroupView, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,NetworkWatcherName=NetworkWatcherName,SubscriptionId=SubscriptionId,body=SecurityGroupView})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, NetworkWatcherName=NetworkWatcherName, SubscriptionId=SubscriptionId, body=SecurityGroupView })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, NetworkWatcherName=NetworkWatcherName, SubscriptionId=SubscriptionId, body=SecurityGroupView })
                    {
