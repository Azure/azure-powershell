namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: ScriptExpanded
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVnetGatewayVpnDeviceConfigurationScript_ScriptExpanded", SupportsShouldProcess = true)]
    ...
    public partial class GetAzVnetGatewayVpnDeviceConfigurationScript_ScriptExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVnetGatewayVpnDeviceConfigurationScript_ScriptExpanded" /> cmdlet class.
        /// </summary>
        public GetAzVnetGatewayVpnDeviceConfigurationScript_ScriptExpanded()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysVpnDeviceConfigurationScript(ResourceGroupName, Name, SubscriptionId, ParametersBody, onOk, this, Pipeline);
