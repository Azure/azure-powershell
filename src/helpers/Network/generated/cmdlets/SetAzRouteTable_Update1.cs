namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Update1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzRouteTable_Update1", SupportsShouldProcess = true)]
    ...
    public partial class SetAzRouteTable_Update1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Route table resource.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Route table resource.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IRouteTable) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IRouteTable RouteTable { get => this._routeTable; set => this._routeTable = value; }
        ...
        /// <returns>a duplicate instance of SetAzRouteTable_Update1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets.SetAzRouteTable_Update1 Clone()
        {
            var clone = new SetAzRouteTable_Update1();
            ...
            clone.RouteTable = this.RouteTable;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'RouteTablesCreateOrUpdate1' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RouteTablesCreateOrUpdate1(ResourceGroupName, Name, SubscriptionId, RouteTable, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,SubscriptionId=SubscriptionId,body=RouteTable})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzRouteTable_Update1" /> cmdlet class.
        /// </summary>
        public SetAzRouteTable_Update1()
        {
