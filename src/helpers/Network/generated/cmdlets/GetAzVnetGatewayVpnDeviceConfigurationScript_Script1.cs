namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Cmdlets
{
    ...
    /// variant: Script1
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVnetGatewayVpnDeviceConfigurationScript_Script1", SupportsShouldProcess = true)]
    ...
    public partial class GetAzVnetGatewayVpnDeviceConfigurationScript_Script1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzVnetGatewayVpnDeviceConfigurationScript_Script1" /> cmdlet class.
        /// </summary>
        public GetAzVnetGatewayVpnDeviceConfigurationScript_Script1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VirtualNetworkGatewaysVpnDeviceConfigurationScript1(ResourceGroupName, Name, SubscriptionId, VpnDeviceConfigurationScript, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,SubscriptionId=SubscriptionId,body=VpnDeviceConfigurationScript})
                    {
