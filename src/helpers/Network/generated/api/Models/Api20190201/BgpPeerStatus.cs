namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201
{
    ...
    public partial class BgpPeerStatus :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IBgpPeerStatusInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IBgpPeerStatusInternal.Asn { get => this._asn; set { {_asn = value;} } }

        /// <summary>Internal Acessors for ConnectedDuration</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IBgpPeerStatusInternal.ConnectedDuration { get => this._connectedDuration; set { {_connectedDuration = value;} } }

        /// <summary>Internal Acessors for LocalAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IBgpPeerStatusInternal.LocalAddress { get => this._localAddress; set { {_localAddress = value;} } }

        /// <summary>Internal Acessors for MessagesReceived</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IBgpPeerStatusInternal.MessagesReceived { get => this._messagesReceived; set { {_messagesReceived = value;} } }

        /// <summary>Internal Acessors for MessagesSent</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IBgpPeerStatusInternal.MessagesSent { get => this._messagesSent; set { {_messagesSent = value;} } }

        /// <summary>Internal Acessors for Neighbor</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IBgpPeerStatusInternal.Neighbor { get => this._neighbor; set { {_neighbor = value;} } }

        /// <summary>Internal Acessors for RoutesReceived</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IBgpPeerStatusInternal.RoutesReceived { get => this._routesReceived; set { {_routesReceived = value;} } }

        /// <summary>Internal Acessors for State</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Network.Support.BgpPeerState? Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IBgpPeerStatusInternal.State { get => this._state; set { {_state = value;} } }
