namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201
{
    ...
    public partial class TunnelConnectionHealth :
        Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ITunnelConnectionHealth,
        Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ITunnelConnectionHealthInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Network.Support.VirtualNetworkGatewayConnectionStatus? Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ITunnelConnectionHealthInternal.ConnectionStatus { get => this._connectionStatus; set { {_connectionStatus = value;} } }

        /// <summary>Internal Acessors for EgressBytesTransferred</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ITunnelConnectionHealthInternal.EgressBytesTransferred { get => this._egressBytesTransferred; set { {_egressBytesTransferred = value;} } }

        /// <summary>Internal Acessors for IngressBytesTransferred</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ITunnelConnectionHealthInternal.IngressBytesTransferred { get => this._ingressBytesTransferred; set { {_ingressBytesTransferred = value;} } }

        /// <summary>Internal Acessors for LastConnectionEstablishedUtcTime</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ITunnelConnectionHealthInternal.LastConnectionEstablishedUtcTime { get => this._lastConnectionEstablishedUtcTime; set { {_lastConnectionEstablishedUtcTime = value;} } }

        /// <summary>Internal Acessors for Tunnel</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.ITunnelConnectionHealthInternal.Tunnel { get => this._tunnel; set { {_tunnel = value;} } }
