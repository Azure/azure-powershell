namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201
{
    ...
    public partial class GatewayRoute :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IGatewayRouteInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IGatewayRouteInternal.AsPath { get => this._asPath; set { {_asPath = value;} } }

        /// <summary>Internal Acessors for LocalAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IGatewayRouteInternal.LocalAddress { get => this._localAddress; set { {_localAddress = value;} } }

        /// <summary>Internal Acessors for Network</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IGatewayRouteInternal.Network { get => this._network; set { {_network = value;} } }

        /// <summary>Internal Acessors for NextHop</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IGatewayRouteInternal.NextHop { get => this._nextHop; set { {_nextHop = value;} } }

        /// <summary>Internal Acessors for Origin</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IGatewayRouteInternal.Origin { get => this._origin; set { {_origin = value;} } }

        /// <summary>Internal Acessors for SourcePeer</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IGatewayRouteInternal.SourcePeer { get => this._sourcePeer; set { {_sourcePeer = value;} } }

        /// <summary>Internal Acessors for Weight</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20190201.IGatewayRouteInternal.Weight { get => this._weight; set { {_weight = value;} } }
