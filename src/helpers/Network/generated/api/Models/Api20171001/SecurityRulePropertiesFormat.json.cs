namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001
{
    ...
    public partial class SecurityRulePropertiesFormat
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.ISecurityRulePropertiesFormat.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.ISecurityRulePropertiesFormat.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.ISecurityRulePropertiesFormat FromJson(Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonObject json ? new SecurityRulePropertiesFormat(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonObject into a new instance of <see cref="SecurityRulePropertiesFormat" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SecurityRulePropertiesFormat(Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonObject json)
        {
            ...
            {_destinationApplicationSecurityGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonArray>("destinationApplicationSecurityGroups"), out var __jsonDestinationApplicationSecurityGroups) ? If( __jsonDestinationApplicationSecurityGroups as Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IApplicationSecurityGroup[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IApplicationSecurityGroup) (Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.ApplicationSecurityGroup.FromJson(__p) )) ))() : null : DestinationApplicationSecurityGroup;}
            ...
            {_destinationPortRanges = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonArray>("destinationPortRanges"), out var __jsonDestinationPortRanges) ? If( __jsonDestinationPortRanges as Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(string) (__k is Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonString __j ? (string)(__j.ToString()) : null)) ))() : null : DestinationPortRanges;}
            ...
            {_sourceAddressPrefixes = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonArray>("sourceAddressPrefixes"), out var __jsonSourceAddressPrefixes) ? If( __jsonSourceAddressPrefixes as Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__g, (__f)=>(string) (__f is Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonString __e ? (string)(__e.ToString()) : null)) ))() : null : SourceAddressPrefixes;}
            {_sourceApplicationSecurityGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonArray>("sourceApplicationSecurityGroups"), out var __jsonSourceApplicationSecurityGroups) ? If( __jsonSourceApplicationSecurityGroups as Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonArray, out var __b) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IApplicationSecurityGroup[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__b, (__a)=>(Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IApplicationSecurityGroup) (Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.ApplicationSecurityGroup.FromJson(__a) )) ))() : null : SourceApplicationSecurityGroup;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SecurityRulePropertiesFormat" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SecurityRulePropertiesFormat" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.SerializationMode serializationMode)
        {
            ...
            if (null != this._destinationApplicationSecurityGroup)
            {
                ...
                foreach( var __s in this._destinationApplicationSecurityGroup )
                {
                    AddIf(__s?.ToJson(null, serializationMode) ,__r.Add);
                }
                container.Add("destinationApplicationSecurityGroups",__r);
            }
            ...
            if (null != this._destinationPortRanges)
            {
                ...
                foreach( var __n in this._destinationPortRanges )
                {
                ...
                container.Add("destinationPortRanges",__m);
            }
            ...
            if (null != this._sourceAddressPrefixes)
            {
                ...
                foreach( var __i in this._sourceAddressPrefixes )
                {
                ...
                container.Add("sourceAddressPrefixes",__h);
            }
            if (null != this._sourceApplicationSecurityGroup)
            {
                ...
                foreach( var __d in this._sourceApplicationSecurityGroup )
                {
                    AddIf(__d?.ToJson(null, serializationMode) ,__c.Add);
                }
                container.Add("sourceApplicationSecurityGroups",__c);
            }
