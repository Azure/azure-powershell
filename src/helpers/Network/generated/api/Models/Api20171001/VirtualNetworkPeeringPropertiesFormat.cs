namespace Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001
{
    ...
    public partial class VirtualNetworkPeeringPropertiesFormat :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IVirtualNetworkPeeringPropertiesFormatInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IAddressSpace Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IVirtualNetworkPeeringPropertiesFormatInternal.RemoteAddressSpace { get => (this._remoteAddressSpace = this._remoteAddressSpace ?? new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.AddressSpace()); set { {_remoteAddressSpace = value;} } }

        /// <summary>Internal Acessors for RemoteVnet</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.ISubResource Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IVirtualNetworkPeeringPropertiesFormatInternal.RemoteVnet { get => (this._remoteVnet = this._remoteVnet ?? new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.SubResource()); set { {_remoteVnet = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IAddressSpace _remoteAddressSpace;

        /// <summary>The reference of the remote virtual network address space.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Origin(Microsoft.Azure.PowerShell.Cmdlets.Network.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IAddressSpace RemoteAddressSpace { get => (this._remoteAddressSpace = this._remoteAddressSpace ?? new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.AddressSpace()); set => this._remoteAddressSpace = value; }

        /// <summary>A list of address blocks reserved for this virtual network in CIDR notation.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Origin(Microsoft.Azure.PowerShell.Cmdlets.Network.PropertyOrigin.Inlined)]
        public string[] RemoteAddressSpaceAddressPrefix { get => ((Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IAddressSpaceInternal)RemoteAddressSpace).AddressPrefix; set => ((Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.IAddressSpaceInternal)RemoteAddressSpace).AddressPrefix = value; }

        /// <summary>Backing field for <see cref="RemoteVnet" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.ISubResource _remoteVnet;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Origin(Microsoft.Azure.PowerShell.Cmdlets.Network.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.ISubResource RemoteVnet { get => (this._remoteVnet = this._remoteVnet ?? new Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.SubResource()); set => this._remoteVnet = value; }

        /// <summary>Resource ID.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Network.Origin(Microsoft.Azure.PowerShell.Cmdlets.Network.PropertyOrigin.Inlined)]
        public string RemoteVnetId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.ISubResourceInternal)RemoteVnet).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.Network.Models.Api20171001.ISubResourceInternal)RemoteVnet).Id = value; }
