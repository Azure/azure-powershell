namespace Microsoft.Azure.PowerShell.Cmdlets.Network
{
    ...
    public partial class Module
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.HttpPipeline _pipeline;

        /// <summary>the ISendAsync pipeline instance (when proxy is enabled)</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.HttpPipeline _pipelineWithProxy;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Network ClientAPI { get; set; }
        ...
        private static Microsoft.Azure.PowerShell.Cmdlets.Network.Module _instance;

        /// <summary>the singleton of this module class</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Network.Module Instance => Microsoft.Azure.PowerShell.Cmdlets.Network.Module._instance?? (Microsoft.Azure.PowerShell.Cmdlets.Network.Module._instance = new Microsoft.Azure.PowerShell.Cmdlets.Network.Module());
        ...
        partial void AfterCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.HttpPipeline pipeline);

        /// <summary>FIXME: Method BeforeCreatePipeline is MISSING DESCRIPTION</summary>
        /// <param name="invocationInfo">The <see cref="System.Management.Automation.InvocationInfo" /> from the cmdlet</param>
        /// <param name="pipeline">The HttpPipeline for the request</param>

        partial void BeforeCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.HttpPipeline pipeline);
        ...
        /// <returns>An instance of Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.HttpPipeline for the remote call.</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.HttpPipeline CreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, string correlationId, string processRecordId)
        {
            Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.HttpPipeline pipeline = null;
        ...
        {
            /// constructor
            ClientAPI = new Microsoft.Azure.PowerShell.Cmdlets.Network.Network();
            _handler.Proxy = _webProxy;
            _pipeline = new Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.HttpPipeline(new Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient()));
            _pipelineWithProxy = new Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.HttpPipeline(new Microsoft.Azure.PowerShell.Cmdlets.Network.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient(_handler)));
        }
