if(($null -eq $TestName) -or ($TestName -contains 'New-AzSecurityAwsOrganizationalDataMasterObject'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-AzSecurityAwsOrganizationalDataMasterObject.Recording.json'
