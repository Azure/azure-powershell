...
namespace Microsoft.Azure.PowerShell.Cmdlets.Security.Models
{
    ...
    public partial class DefenderForServersAwsOfferingVaAutoProvisioning :
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderForServersAwsOfferingVaAutoProvisioning,
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderForServersAwsOfferingVaAutoProvisioningInternal
    {

        /// <summary>Backing field for <see cref="Configuration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderForServersAwsOfferingVaAutoProvisioningConfiguration _configuration;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderForServersAwsOfferingVaAutoProvisioningConfiguration Configuration { get => (this._configuration = this._configuration ?? new Microsoft.Azure.PowerShell.Cmdlets.Security.Models.DefenderForServersAwsOfferingVaAutoProvisioningConfiguration()); set => this._configuration = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderForServersAwsOfferingVaAutoProvisioningConfiguration Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderForServersAwsOfferingVaAutoProvisioningInternal.Configuration { get => (this._configuration = this._configuration ?? new Microsoft.Azure.PowerShell.Cmdlets.Security.Models.DefenderForServersAwsOfferingVaAutoProvisioningConfiguration()); set { {_configuration = value;} } }

        /// <summary>
        /// Creates an new <see cref="DefenderForServersAwsOfferingVaAutoProvisioning" /> instance.
        /// </summary>
    ...
    /// The Vulnerability Assessment autoprovisioning configuration
    internal partial interface IDefenderForServersAwsOfferingVaAutoProvisioningInternal

    {
        /// <summary>configuration for Vulnerability Assessment autoprovisioning</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderForServersAwsOfferingVaAutoProvisioningConfiguration Configuration { get; set; }
        /// <summary>
        /// The Vulnerability Assessment solution to be provisioned. Can be either 'TVM' or 'Qualys'
        /// </summary>
        [global::Microsoft.Azure.PowerShell.Cmdlets.Security.PSArgumentCompleterAttribute("Qualys", "TVM")]
