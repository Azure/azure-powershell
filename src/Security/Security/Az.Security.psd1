#
<<<<<<< HEAD
# Module manifest for module 'PSGet_Az.Security'
#
...
<<<<<<< HEAD
        ReleaseNotes = '* Deprecate ResourceGroupName parameter in commands: Get-AzSecurityPricing and Set-AzSecurityPricing'
=======
        ReleaseNotes = '* Added breaking change notification in AzSecurityAlert:
                    ''Get-AzSecurityAlert''
                    ''Set-AzSecurityAlert''
* Added new cmdlets: 
