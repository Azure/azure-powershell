        ...
        public override void ExecuteCmdlet()
        {
            switch (ParameterSetName)
            {
                case ParameterSetNames.SubscriptionScope:
                    var tors = SecurityCenterClient.Topology.ListWithHttpMessagesAsync().GetAwaiter().GetResult().Body;
                ...
                case ParameterSetNames.ResourceGroupLevelResource:
                    ...
                    var tor = SecurityCenterClient.Topology.GetWithHttpMessagesAsync(ResourceGroupName, Name).GetAwaiter().GetResult().Body;
                ...
                case ParameterSetNames.ResourceId:
                    ...
                    tor = SecurityCenterClient.Topology.GetWithHttpMessagesAsync(AzureIdUtilities.GetResourceGroup(ResourceId), AzureIdUtilities.GetResourceName(ResourceId)).GetAwaiter().GetResult().Body;
                    WriteObject(tor.ConvertToPSType(), enumerateCollection: false);
                    break;
                default:
