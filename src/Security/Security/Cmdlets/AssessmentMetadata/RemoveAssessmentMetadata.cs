...
{
    [Cmdlet(VerbsCommon.Remove, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "SecurityAssessmentMetadata", DefaultParameterSetName = ParameterSetNames.SubscriptionLevelResource, SupportsShouldProcess = true), OutputType(typeof(bool))]
    public class RemoveSecurityAssessmentMetadata : SecurityCenterCmdletBase
    {
        ...
        [ValidateNotNullOrEmpty]
        public PSSecurityAssessmentMetadata InputObject { get; set; }
        ...
        public override void ExecuteCmdlet()
        {
            ...
            {
                SecurityCenterClient.AssessmentsMetadata.DeleteInSubscriptionWithHttpMessagesAsync(name).GetAwaiter().GetResult();
            }
