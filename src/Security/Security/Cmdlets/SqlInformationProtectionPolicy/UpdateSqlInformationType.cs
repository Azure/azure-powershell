...
namespace Microsoft.Azure.Commands.SecurityCenter.Cmdlets.SqlInformationProtectionPolicy
{
    ...
    public class UpdateSqlInformationType : SqlInformationTypeCreateOrUpdateCmdlet
    {
        [Parameter(
            Mandatory = false,
        ...
        private const string NewDisplayNameHelpMessage = "The new name of the information type";
    }
}
