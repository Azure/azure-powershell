...
namespace Microsoft.Azure.Commands.SecurityCenter.Cmdlets.SqlInformationProtectionPolicy
{
    ...
    public class UpdateSqlSensitivityLabel : SqlSensitivityLabelCreateOrUpdateCmdlet
    {
        [Parameter(
            Mandatory = false,
            ParameterSetName = SqlSensitivityLabelParameterSet,
            HelpMessage = NewDisplayNameHelpMessage,
            ValueFromPipelineByPropertyName = true)]
        [ValidateNotNullOrEmpty]
        public string NewDisplayName { get; set; }

        private const string NewDisplayNameHelpMessage = "The new name of the sensitivity label";
    }
}
