...
```
New-AzDeviceSecurityGroupDenylistCustomAlertRuleObject -DisplayName <String> -Description <String>
 -Enabled <Boolean> -Type <String> -ValueType <String> -DenylistValues <String[]>
