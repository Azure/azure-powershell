...
online version: https://docs.microsoft.com/en-us/powershell/module/az.security/New-AzSqlSensitivityLabel
schema: 2.0.0
---
...
## SYNOPSIS
Adds a sensitivity label into the SQL information protection policy.
...
### Example
```powershell
New-AzSqlSensitivityLabel -DisplayName Restricted -Description "Restricted material would cause undesirable effects if publicly available." -State Enabled -Rank Critical -Order 100
```
