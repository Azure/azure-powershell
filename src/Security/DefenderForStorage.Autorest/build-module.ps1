...
$dll = Join-Path $PSScriptRoot 'bin\Az.DefenderForStorage.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.DefenderForStorage.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.DefenderForStorage.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.DefenderForStorage'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: DefenderForStorage cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.DefenderForStorage.format.ps1xml'
