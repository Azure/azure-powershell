...
namespace Microsoft.Azure.Management.Security
{
    ...
    /// </summary>
    internal partial class HealthReportsOperations : Microsoft.Rest.IServiceOperations<SecurityCenterClient>, IHealthReportsOperations
    {
        /// <summary>
        /// Initializes a new instance of the HealthReportsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal HealthReportsOperations (SecurityCenterClient client)
        {
            if (client == null) 
            {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<HealthReport>>> ListWithHttpMessagesAsync(string scope, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (scope != null)
            {
                if (scope.Length > 90)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.MaxLength, "scope", 90);
                }
                if (scope.Length < 1)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.MinLength, "scope", 1);
                }
            }
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{scope}/providers/Microsoft.Security/healthReports").ToString();
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<HealthReport>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<HealthReport>>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<HealthReport>> GetWithHttpMessagesAsync(string resourceId, string healthReportName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "healthReportName");
            }
            if (healthReportName != null)
            {
                if (!System.Text.RegularExpressions.Regex.IsMatch(healthReportName, "[{]?[0-9a-fA-F]{8}-(?:[0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}[}]?$"))
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.Pattern, "healthReportName", "[{]?[0-9a-fA-F]{8}-(?:[0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}[}]?$");
                }
            }
            string apiVersion = "2023-05-01-preview";
            // Tracing
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("healthReportName", healthReportName);
            ...
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{resourceId}/providers/Microsoft.Security/healthReports/{healthReportName}").ToString();
            _url = _url.Replace("{resourceId}", resourceId);
            _url = _url.Replace("{healthReportName}", System.Uri.EscapeDataString(healthReportName));
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<HealthReport>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<HealthReport>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (Newtonsoft.Json.JsonException ex)
                {
                    _httpRequest.Dispose();
