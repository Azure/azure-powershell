...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the DefenderForServersGcpOfferingVmScannersConfiguration class.
        /// </summary>
        ...
        /// <param name="exclusionTags">VM tags that indicate that VM should not be scanned
        /// </param>
        public DefenderForServersGcpOfferingVmScannersConfiguration(string scanningMode = default(string), System.Collections.Generic.IDictionary<string, string> exclusionTags = default(System.Collections.Generic.IDictionary<string, string>))
        ...
        /// <summary>
        /// Gets or sets vM tags that indicate that VM should not be scanned
        /// </summary>
