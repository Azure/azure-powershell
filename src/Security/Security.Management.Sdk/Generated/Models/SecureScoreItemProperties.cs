...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class SecureScoreItemProperties
    {
        /// <summary>
        ...
        /// </param>
        public SecureScoreItemProperties(string displayName = default(string), long? weight = default(long?), int? max = default(int?), double? current = default(double?), double? percentage = default(double?))
