...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class SecureScoreControlDetails : Resource
    {
        ...
        /// </param>
        public SecureScoreControlDetails(string id = default(string), string name = default(string), string type = default(string), string displayName = default(string), int? healthyResourceCount = default(int?), int? unhealthyResourceCount = default(int?), int? notApplicableResourceCount = default(int?), long? weight = default(long?), SecureScoreControlDefinitionItem definition = default(SecureScoreControlDefinitionItem), int? max = default(int?), double? current = default(double?), double? percentage = default(double?))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.notApplicableResourceCount")]
