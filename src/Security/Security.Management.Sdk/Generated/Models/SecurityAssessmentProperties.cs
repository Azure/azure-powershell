...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    /// </summary>
    public partial class SecurityAssessmentProperties : SecurityAssessmentPropertiesBase
    {
        /// <summary>
        ...
        /// </param>
        public SecurityAssessmentProperties(ResourceDetails resourceDetails, AssessmentStatus status, string displayName = default(string), System.Collections.Generic.IDictionary<string, string> additionalData = default(System.Collections.Generic.IDictionary<string, string>), AssessmentLinks links = default(AssessmentLinks), SecurityAssessmentMetadataProperties metadata = default(SecurityAssessmentMetadataProperties), SecurityAssessmentPartnerData partnersData = default(SecurityAssessmentPartnerData))
