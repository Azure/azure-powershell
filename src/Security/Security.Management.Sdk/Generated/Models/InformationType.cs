...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class InformationType
    {
        ...
        /// <param name="displayName">The name of the information type.
        /// </param>

        /// <param name="description">The description of the information type.
        /// </param>

        /// <param name="order">The order of the information type.
        /// </param>

        /// <param name="recommendedLabelId">The recommended label id to be associated with this information type.
        /// </param>

        /// <param name="enabled">Indicates whether the information type is enabled or not.
        /// </param>

        /// <param name="custom">Indicates whether the information type is custom or not.
        /// </param>

        /// <param name="keywords">The information type keywords.
        /// </param>
        public InformationType(string displayName = default(string), string description = default(string), int? order = default(int?), System.Guid? recommendedLabelId = default(System.Guid?), bool? enabled = default(bool?), bool? custom = default(bool?), System.Collections.Generic.IList<InformationProtectionKeyword> keywords = default(System.Collections.Generic.IList<InformationProtectionKeyword>))
        ...
        public System.Collections.Generic.IList<InformationProtectionKeyword> Keywords {get; set; }
    }
}