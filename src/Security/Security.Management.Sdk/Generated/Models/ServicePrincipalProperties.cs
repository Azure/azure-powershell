...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class ServicePrincipalProperties
    {
        ...
        /// <param name="applicationId">Application ID of service principal.
        /// </param>

        /// <param name="secret">A secret string that the application uses to prove its identity, also can
        /// be referred to as application password (write only).
        /// </param>
