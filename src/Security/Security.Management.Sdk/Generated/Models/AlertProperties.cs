...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class AlertProperties
    {
        ...
        /// </param>
        public AlertProperties(string version = default(string), string alertType = default(string), string systemAlertId = default(string), string productComponentName = default(string), string alertDisplayName = default(string), string description = default(string), string severity = default(string), string intent = default(string), System.DateTime? startTimeUtc = default(System.DateTime?), System.DateTime? endTimeUtc = default(System.DateTime?), System.Collections.Generic.IList<ResourceIdentifier> resourceIdentifiers = default(System.Collections.Generic.IList<ResourceIdentifier>), System.Collections.Generic.IList<string> remediationSteps = default(System.Collections.Generic.IList<string>), string vendorName = default(string), string status = default(string), System.Collections.Generic.IList<System.Collections.Generic.IDictionary<string, string>> extendedLinks = default(System.Collections.Generic.IList<System.Collections.Generic.IDictionary<string, string>>), string alertUri = default(string), System.DateTime? timeGeneratedUtc = default(System.DateTime?), string productName = default(string), System.DateTime? processingEndTimeUtc = default(System.DateTime?), System.Collections.Generic.IList<AlertEntity> entities = default(System.Collections.Generic.IList<AlertEntity>), bool? isIncident = default(bool?), string correlationKey = default(string), System.Collections.Generic.IDictionary<string, string> extendedProperties = default(System.Collections.Generic.IDictionary<string, string>), string compromisedEntity = default(string), System.Collections.Generic.IList<string> techniques = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<string> subTechniques = default(System.Collections.Generic.IList<string>), AlertPropertiesSupportingEvidence supportingEvidence = default(AlertPropertiesSupportingEvidence))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "systemAlertId")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "resourceIdentifiers")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "timeGeneratedUtc")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "processingEndTimeUtc")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "isIncident")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "correlationKey")]
        ...
        /// type.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "supportingEvidence")]
