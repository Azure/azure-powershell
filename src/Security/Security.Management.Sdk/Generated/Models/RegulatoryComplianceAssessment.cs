...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class RegulatoryComplianceAssessment : Resource
    {
        ...
        /// </param>
        public RegulatoryComplianceAssessment(string id = default(string), string name = default(string), string type = default(string), string state = default(string), string description = default(string), string assessmentType = default(string), string assessmentDetailsLink = default(string), int? passedResources = default(int?), int? failedResources = default(int?), int? skippedResources = default(int?), int? unsupportedResources = default(int?))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.assessmentDetailsLink")]
        public string AssessmentDetailsLink {get; private set; }

        /// <summary>
        /// Gets the given assessment&#39;s related resources count with passed state.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.passedResources")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.skippedResources")]
        public int? SkippedResources {get; private set; }

        /// <summary>
        /// Gets the given assessment&#39;s related resources count with unsupported state.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.unsupportedResources")]
