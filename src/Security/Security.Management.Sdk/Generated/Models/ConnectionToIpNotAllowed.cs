...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class ConnectionToIpNotAllowed : AllowlistCustomAlertRule
    {
        ...
        /// </param>
        public ConnectionToIpNotAllowed(bool isEnabled, System.Collections.Generic.IList<string> allowlistValues, string displayName = default(string), string description = default(string), string valueType = default(string))
