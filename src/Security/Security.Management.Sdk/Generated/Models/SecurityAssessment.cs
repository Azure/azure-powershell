...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class SecurityAssessment : Resource
    {
        ...
        /// </param>
        public SecurityAssessment(string id = default(string), string name = default(string), string type = default(string), ResourceDetails resourceDetails = default(ResourceDetails), string displayName = default(string), System.Collections.Generic.IDictionary<string, string> additionalData = default(System.Collections.Generic.IDictionary<string, string>), AssessmentLinks links = default(AssessmentLinks), SecurityAssessmentMetadataProperties metadata = default(SecurityAssessmentMetadataProperties), SecurityAssessmentPartnerData partnersData = default(SecurityAssessmentPartnerData), AssessmentStatus status = default(AssessmentStatus))
