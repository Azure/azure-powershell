...
namespace Microsoft.Azure.Management.Security
{
    ...
    /// </summary>
    internal partial class AdaptiveApplicationControlsOperations : Microsoft.Rest.IServiceOperations<SecurityCenterClient>, IAdaptiveApplicationControlsOperations
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<AdaptiveApplicationControlGroups>> ListWithHttpMessagesAsync(bool? includePathRecommendations = default(bool?), bool? summary = default(bool?), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                _queryParameters.Add(string.Format("includePathRecommendations={0}", System.Uri.EscapeDataString(Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(includePathRecommendations, this.Client.SerializationSettings).Trim('"'))));
            }
            if (summary != null)
            {
                _queryParameters.Add(string.Format("summary={0}", System.Uri.EscapeDataString(Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(summary, this.Client.SerializationSettings).Trim('"'))));
            }
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<AdaptiveApplicationControlGroups>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<AdaptiveApplicationControlGroups>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<AdaptiveApplicationControlGroup>> GetWithHttpMessagesAsync(string groupName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<AdaptiveApplicationControlGroup>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<AdaptiveApplicationControlGroup>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (Newtonsoft.Json.JsonException ex)
                {
                    _httpRequest.Dispose();
