...
{
    public class SecuritySecureScoreControlTests : SecurityTestRunner
    {
        public SecuritySecureScoreControlTests(Xunit.Abstractions.ITestOutputHelper output) : base(output)
        {
        }
