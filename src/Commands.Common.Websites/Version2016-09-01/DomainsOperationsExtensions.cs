...
namespace Microsoft.Azure.Management.WebSites.Version2016_09_01
{
    ...
    public static partial class DomainsOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<DomainAvailablilityCheckResult> CheckAvailabilityAsync(this IDomainsOperations operations, string name = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<NameIdentifier>> ListRecommendationsAsync(this IDomainsOperations operations, string keywords = default(string), int? maxDomainRecommendations = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListRecommendationsWithHttpMessagesAsync(keywords, maxDomainRecommendations, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// Ownership Id.
            /// </param>
            public static DomainOwnershipIdentifier CreateOrUpdateOwnershipIdentifier(this IDomainsOperations operations, string resourceGroupName, string domainName, string name, string kind = default(string), string ownershipId = default(string))
            {
                return operations.CreateOrUpdateOwnershipIdentifierAsync(resourceGroupName, domainName, name, kind, ownershipId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DomainOwnershipIdentifier> CreateOrUpdateOwnershipIdentifierAsync(this IDomainsOperations operations, string resourceGroupName, string domainName, string name, string kind = default(string), string ownershipId = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateOrUpdateOwnershipIdentifierWithHttpMessagesAsync(resourceGroupName, domainName, name, kind, ownershipId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// Ownership Id.
            /// </param>
            public static DomainOwnershipIdentifier UpdateOwnershipIdentifier(this IDomainsOperations operations, string resourceGroupName, string domainName, string name, string kind = default(string), string ownershipId = default(string))
            {
                return operations.UpdateOwnershipIdentifierAsync(resourceGroupName, domainName, name, kind, ownershipId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DomainOwnershipIdentifier> UpdateOwnershipIdentifierAsync(this IDomainsOperations operations, string resourceGroupName, string domainName, string name, string kind = default(string), string ownershipId = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.UpdateOwnershipIdentifierWithHttpMessagesAsync(resourceGroupName, domainName, name, kind, ownershipId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
