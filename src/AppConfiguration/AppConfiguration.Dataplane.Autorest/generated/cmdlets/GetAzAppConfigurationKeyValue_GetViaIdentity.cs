...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetKeyValue=>GET:"/kv/{key}"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Description(@"Gets a single key-value.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The label of the key-value to retrieve.")]
        [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Info(
        Required = false,
        ReadOnly = false,
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.GetKeyValue(Endpoint, InputObject.Key ?? null, this.InvocationInformation.BoundParameters.ContainsKey("Label") ? Label : null, this.InvocationInformation.BoundParameters.ContainsKey("SyncToken") ? SyncToken : null, this.InvocationInformation.BoundParameters.ContainsKey("AcceptDatetime") ? AcceptDatetime : null, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, this.InvocationInformation.BoundParameters.ContainsKey("IfNoneMatch") ? IfNoneMatch : null, this.InvocationInformation.BoundParameters.ContainsKey("Select") ? Select : null /* arrayOf */, onOk, onDefault, this, Pipeline);
                    }
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api10.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Endpoint=Endpoint, Label=this.InvocationInformation.BoundParameters.ContainsKey("Label") ? Label : null, SyncToken=this.InvocationInformation.BoundParameters.ContainsKey("SyncToken") ? SyncToken : null, AcceptDatetime=this.InvocationInformation.BoundParameters.ContainsKey("AcceptDatetime") ? AcceptDatetime : null, IfMatch=this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, IfNoneMatch=this.InvocationInformation.BoundParameters.ContainsKey("IfNoneMatch") ? IfNoneMatch : null, Select=this.InvocationInformation.BoundParameters.ContainsKey("Select") ? Select : null /* arrayOf */ })
                {
