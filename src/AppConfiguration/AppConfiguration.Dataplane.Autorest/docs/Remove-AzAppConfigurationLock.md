...
online version: https://docs.microsoft.com/powershell/module/az.appconfiguration/remove-azappconfigurationlock
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzAppConfigurationLock -Endpoint <String> -InputObject <IAppConfigurationIdentity> [-Label <String>]
