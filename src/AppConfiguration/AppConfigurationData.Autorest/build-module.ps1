...
$dll = Join-Path $PSScriptRoot 'bin\Az.AppConfigurationdata.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.AppConfigurationdata.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.AppConfigurationdata.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.AppConfigurationdata'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: AppConfigurationdata cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.AppConfigurationdata.format.ps1xml'
