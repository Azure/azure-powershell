...
```
Get-AzAppConfigurationLabel -Endpoint <String> [-After <String>] [-Name <String>] [-Select <List<String>>]
 [-AcceptDatetime <String>] [-SyncToken <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
