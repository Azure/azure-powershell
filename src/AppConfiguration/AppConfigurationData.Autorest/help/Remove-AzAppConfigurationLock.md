...
### DeleteViaIdentity
```
Remove-AzAppConfigurationLock -Endpoint <String> -InputObject <IAppConfigurationdataIdentity>
 [-Label <String>] [-IfMatch <String>] [-IfNoneMatch <String>] [-SyncToken <String>]
