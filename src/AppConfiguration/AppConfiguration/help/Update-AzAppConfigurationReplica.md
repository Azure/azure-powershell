...
```
Update-AzAppConfigurationReplica -Name <String> -ConfigurationStoreInputObject <IAppConfigurationIdentity>
...
```
Update-AzAppConfigurationReplica -InputObject <IAppConfigurationIdentity> [-DefaultProfile <PSObject>] [-AsJob]
