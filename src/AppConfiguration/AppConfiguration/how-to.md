...
- `build-module.ps1`
  - Builds the module DLL (`./bin/Az.AppConfiguration.private.dll`), creates the exported cmdlets, generates custom cmdlet test stubs, and updates `./Az.AppConfiguration.psd1` with Azure profile information.
