...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzAppConfigurationStore_UpdateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzAppConfigurationStore_UpdateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ConfigStoreUpdateParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20190201Preview.IConfigurationStoreUpdateParameters _configStoreUpdateParameter;

        /// <summary>The parameters for updating a configuration store.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The parameters for updating a configuration store.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The parameters for updating a configuration store.",
        SerializedName = @"configStoreUpdateParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20190201Preview.IConfigurationStoreUpdateParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20190201Preview.IConfigurationStoreUpdateParameters ConfigStoreUpdateParameter { get => this._configStoreUpdateParameter; set => this._configStoreUpdateParameter = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzAppConfigurationStore_UpdateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.UpdateAzAppConfigurationStore_UpdateViaIdentity Clone()
        {
            var clone = new UpdateAzAppConfigurationStore_UpdateViaIdentity();
            ...
            clone.ConfigStoreUpdateParameter = this.ConfigStoreUpdateParameter;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ConfigurationStoresUpdateViaIdentity(InputObject.Id, ConfigStoreUpdateParameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ConfigurationStoresUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ConfigStoreName ?? null, ConfigStoreUpdateParameter, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ConfigStoreUpdateParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzAppConfigurationStore_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzAppConfigurationStore_UpdateViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20190201Preview.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ConfigStoreUpdateParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ConfigStoreUpdateParameter })
                    {
