...
online version: https://learn.microsoft.com/powershell/module/az.purestorageblock/disable-azpurestorageblockstoragepoolavconnection
schema: 2.0.0
---
...
### Disable (Default)
```
Disable-AzPureStorageBlockStoragePoolAvConnection -ResourceGroupName <String> -StoragePoolName <String>
...
### DisableViaIdentity
```
Disable-AzPureStorageBlockStoragePoolAvConnection -InputObject <IPureStorageBlockIdentity>
