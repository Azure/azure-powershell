...
```
Invoke-AzPureStorageBlockFinalizeStoragePoolAvConnection -ResourceGroupName <String> -StoragePoolName <String>
 -Property <IStoragePoolFinalizeAvsConnectionPost> [-SubscriptionId <String>] [-DefaultProfile <PSObject>]
...
Parameter Sets: FinalizeViaIdentity, FinalizeViaIdentityExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Finalize, FinalizeExpanded, FinalizeViaJsonFilePath, FinalizeViaJsonString
Aliases:
