...
Enable-AzPureStorageBlockStoragePoolAvConnection -ResourceGroupName <String> -StoragePoolName <String>
 -SddcResourceId <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```
Enable-AzPureStorageBlockStoragePoolAvConnection -ResourceGroupName <String> -StoragePoolName <String>
 -Property <IStoragePoolEnableAvsConnectionPost> [-SubscriptionId <String>] [-DefaultProfile <PSObject>]
...
```
Enable-AzPureStorageBlockStoragePoolAvConnection -InputObject <IPureStorageBlockIdentity>
 -SddcResourceId <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
