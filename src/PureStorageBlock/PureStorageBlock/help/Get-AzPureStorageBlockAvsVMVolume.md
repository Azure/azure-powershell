...
```
Get-AzPureStorageBlockAvsVMVolume -AvsVMId <String> -VolumeId <String>
...
### GetViaIdentityAvsVM
```
Get-AzPureStorageBlockAvsVMVolume -VolumeId <String> -AvsVMInputObject <IPureStorageBlockIdentity>
...
```yaml
Type: System.String
Parameter Sets: List, GetViaIdentityStoragePool, Get
Aliases:
...
```yaml
Type: System.String
Parameter Sets: GetViaIdentityStoragePool, Get, GetViaIdentityAvsVM
Aliases:
