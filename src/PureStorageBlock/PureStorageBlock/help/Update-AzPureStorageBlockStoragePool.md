...
online version: https://learn.microsoft.com/powershell/module/az.purestorageblock/update-azpurestorageblockstoragepool
schema: 2.0.0
---
...
```
Update-AzPureStorageBlockStoragePool -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-EnableSystemAssignedIdentity <Boolean>] [-ProvisionedBandwidthMbPerSec <Int64>] [-Tag <Hashtable>]
...
```
Update-AzPureStorageBlockStoragePool -InputObject <IPureStorageBlockIdentity>
 [-EnableSystemAssignedIdentity <Boolean>] [-ProvisionedBandwidthMbPerSec <Int64>] [-Tag <Hashtable>]
 [-UserAssignedIdentity <String[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
