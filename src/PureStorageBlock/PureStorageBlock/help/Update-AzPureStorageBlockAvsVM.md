...
Update-AzPureStorageBlockAvsVM -Id <String> -ResourceGroupName <String> -StoragePoolName <String>
 [-SubscriptionId <String>] [-SoftDeletionDestroyed] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf]
...
```yaml
Type: System.Management.Automation.SwitchParameter
Parameter Sets: UpdateExpanded, UpdateViaIdentityStoragePoolExpanded, UpdateViaIdentityExpanded
Aliases:
