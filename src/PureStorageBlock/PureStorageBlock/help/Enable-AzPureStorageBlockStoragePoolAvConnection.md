...
online version: https://learn.microsoft.com/powershell/module/az.purestorageblock/enable-azpurestorageblockstoragepoolavconnection
schema: 2.0.0
---

# Enable-AzPureStorageBlockStoragePoolAvConnection
...
```
Enable-AzPureStorageBlockStoragePoolAvConnection -ResourceGroupName <String> -StoragePoolName <String>
 [-SubscriptionId <String>] -SddcResourceId <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```
Enable-AzPureStorageBlockStoragePoolAvConnection -ResourceGroupName <String> -StoragePoolName <String>
 [-SubscriptionId <String>] -Property <IStoragePoolEnableAvsConnectionPost> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### EnableViaIdentityExpanded
```
Enable-AzPureStorageBlockStoragePoolAvConnection -InputObject <IPureStorageBlockIdentity>
 -SddcResourceId <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Enable-AzPureStorageBlockStoragePoolAvConnection -InputObject <IPureStorageBlockIdentity>
 -Property <IStoragePoolEnableAvsConnectionPost> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.PureStorageBlock.Models.IStoragePoolEnableAvsConnectionPost
...
### Microsoft.Azure.PowerShell.Cmdlets.PureStorageBlock.Models.IStoragePoolEnableAvsConnectionPost
