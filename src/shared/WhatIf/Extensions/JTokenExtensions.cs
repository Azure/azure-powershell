...
namespace Microsoft.Azure.PowerShell.Cmdlets.Shared.WhatIf.Extensions
{
    ...
    public static class JTokenExtensions
    {
        ...
        private static readonly JsonSerializer JsonObjectTypeSerializer = new JsonSerializer();
        ...
        public static object ConvertPropertyValueForPsObject(JToken propertyValue)
        {
            ...
            if (JTokenExtensions.PrimitiveTypeMap.TryGetValue(propertyValue.Type, out primitiveType))
            {
                try
                {
                    return propertyValue.ToObject(primitiveType, JsonObjectTypeSerializer);
                }
        ...
        public static bool IsLeaf(this JToken value)
        {
            return value == null ||
                   value is JValue ||
        ...
        /// </summary>
        /// <param name="value">The <see cref="JToken"/> value to check.</param>
        public static bool IsNonEmptyArray(this JToken value)
        {
        ...
        /// </summary>
        /// <param name="value">The <see cref="JToken"/> value to check.</param>
        public static bool IsNonEmptyObject(this JToken value)
        {
