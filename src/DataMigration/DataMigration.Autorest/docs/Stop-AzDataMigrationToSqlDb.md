...
```
Stop-AzDataMigrationToSqlDb -ServerInputObject <IDataMigrationIdentity> -TargetDbName <String>
...
Parameter Sets: CancelViaIdentityServer, CancelViaIdentityServerExpanded
Aliases:
