...
```
Remove-AzDataMigrationToSqlManagedInstance -ManagedInstanceInputObject <IDataMigrationIdentity>
 -TargetDbName <String> [-Force] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm]
