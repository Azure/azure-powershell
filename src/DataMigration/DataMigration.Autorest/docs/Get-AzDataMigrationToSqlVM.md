...
### GetViaIdentitySqlVirtualMachine
```
Get-AzDataMigrationToSqlVM -SqlVirtualMachineInputObject <IDataMigrationIdentity> -TargetDbName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.IDataMigrationIdentity
Parameter Sets: GetViaIdentitySqlVirtualMachine
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Get, GetViaIdentitySqlVirtualMachine
Aliases:
