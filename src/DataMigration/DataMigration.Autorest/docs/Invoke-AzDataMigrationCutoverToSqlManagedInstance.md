...
```
Invoke-AzDataMigrationCutoverToSqlManagedInstance -ManagedInstanceInputObject <IDataMigrationIdentity>
...
Parameter Sets: CutoverViaIdentityManagedInstance, CutoverViaIdentityManagedInstanceExpanded
Aliases:
