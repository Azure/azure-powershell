...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class AvailableServiceSku
    {
        ...
        /// <param name="resourceType">The resource type, including the provider namespace
        /// </param>

        /// <param name="sku">SKU name, tier, etc.
        /// </param>

        /// <param name="capacity">A description of the scaling capacities of the SKU
        /// </param>
