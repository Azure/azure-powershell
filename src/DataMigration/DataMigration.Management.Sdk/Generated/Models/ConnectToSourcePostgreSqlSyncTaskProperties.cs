...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class ConnectToSourcePostgreSqlSyncTaskProperties : ProjectTaskProperties
    {
        ...
        /// </param>
        public ConnectToSourcePostgreSqlSyncTaskProperties(System.Collections.Generic.IList<ODataError> errors = default(System.Collections.Generic.IList<ODataError>), string state = default(string), System.Collections.Generic.IList<CommandProperties> commands = default(System.Collections.Generic.IList<CommandProperties>), System.Collections.Generic.IDictionary<string, string> clientData = default(System.Collections.Generic.IDictionary<string, string>), ConnectToSourcePostgreSqlSyncTaskInput input = default(ConnectToSourcePostgreSqlSyncTaskInput), System.Collections.Generic.IList<ConnectToSourcePostgreSqlSyncTaskOutput> output = default(System.Collections.Generic.IList<ConnectToSourcePostgreSqlSyncTaskOutput>))
        ...
        public System.Collections.Generic.IList<ConnectToSourcePostgreSqlSyncTaskOutput> Output {get; private set; }
        /// <summary>
        /// Validate the object.
        /// </summary>
