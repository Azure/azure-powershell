...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class MigrateSchemaSqlServerSqlDbDatabaseInput
    {
        ...
        /// <param name="name">Name of source database
        /// </param>

        /// <param name="targetDatabaseName">Name of target database
        /// </param>

        /// <param name="schemaSetting">Database schema migration settings
        /// </param>
