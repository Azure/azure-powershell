...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class MongoDbObjectInfo
    {
        ...
        /// <summary>
        /// Gets or sets the average document size, or -1 if the average size is
        /// unknown
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "averageDocumentSize")]
        public long AverageDocumentSize {get; set; }

        /// <summary>
        /// Gets or sets the estimated total data size, in bytes, or -1 if the size is
        /// unknown.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the estimated total number of documents, or -1 if the document
        /// count is unknown
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the qualified name of the database or collection. For a
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "QualifiedName");
            }
