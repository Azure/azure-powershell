...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    /// databases
    /// </summary>
    [Newtonsoft.Json.JsonObject("GetUserTables.AzureSqlDb.Sync")]
    public partial class GetUserTablesSqlSyncTaskProperties : ProjectTaskProperties
    {
        ...
        /// </param>
        public GetUserTablesSqlSyncTaskProperties(System.Collections.Generic.IList<ODataError> errors = default(System.Collections.Generic.IList<ODataError>), string state = default(string), System.Collections.Generic.IList<CommandProperties> commands = default(System.Collections.Generic.IList<CommandProperties>), System.Collections.Generic.IDictionary<string, string> clientData = default(System.Collections.Generic.IDictionary<string, string>), GetUserTablesSqlSyncTaskInput input = default(GetUserTablesSqlSyncTaskInput), System.Collections.Generic.IList<GetUserTablesSqlSyncTaskOutput> output = default(System.Collections.Generic.IList<GetUserTablesSqlSyncTaskOutput>))
        ...
        public GetUserTablesSqlSyncTaskInput Input {get; set; }

        /// <summary>
        /// Gets task output. This is ignored if submitted.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "output")]
        public System.Collections.Generic.IList<GetUserTablesSqlSyncTaskOutput> Output {get; private set; }
        /// <summary>
        /// Validate the object.
        /// </summary>
