...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class MigrateMISyncCompleteCommandProperties : CommandProperties
    {
        ...
        /// </param>
        public MigrateMISyncCompleteCommandProperties(System.Collections.Generic.IList<ODataError> errors = default(System.Collections.Generic.IList<ODataError>), string state = default(string), MigrateMISyncCompleteCommandInput input = default(MigrateMISyncCompleteCommandInput), MigrateMISyncCompleteCommandOutput output = default(MigrateMISyncCompleteCommandOutput))
