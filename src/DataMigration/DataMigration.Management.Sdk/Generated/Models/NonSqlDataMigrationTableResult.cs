...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class NonSqlDataMigrationTableResult
    {
        ...
        /// &#39;ObjectNotExistsInTarget&#39;, &#39;TargetObjectIsInaccessible&#39;, &#39;FatalError&#39;</param>

        /// <param name="sourceName">Name of the source table
        /// </param>

        /// <param name="targetName">Name of the target table
        /// </param>

        /// <param name="sourceRowCount">Number of rows in the source table
        /// </param>

        /// <param name="targetRowCount">Number of rows in the target table
        /// </param>

        /// <param name="elapsedTimeInMiliseconds">Time taken to migrate the data
        /// </param>

        /// <param name="errors">List of errors, if any, during migration
        /// </param>
        public NonSqlDataMigrationTableResult(string resultCode = default(string), string sourceName = default(string), string targetName = default(string), long? sourceRowCount = default(long?), long? targetRowCount = default(long?), double? elapsedTimeInMiliseconds = default(double?), System.Collections.Generic.IList<DataMigrationError> errors = default(System.Collections.Generic.IList<DataMigrationError>))

        {
            ...
            this.ElapsedTimeInMiliseconds = elapsedTimeInMiliseconds;
            this.Errors = errors;
            CustomInit();
        }
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "sourceRowCount")]
        public long? SourceRowCount {get; private set; }

        /// <summary>
        /// Gets number of rows in the target table
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "targetRowCount")]
        public long? TargetRowCount {get; private set; }

        /// <summary>
        /// Gets time taken to migrate the data
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "elapsedTimeInMiliseconds")]
        ...
        public System.Collections.Generic.IList<DataMigrationError> Errors {get; private set; }
    }
}