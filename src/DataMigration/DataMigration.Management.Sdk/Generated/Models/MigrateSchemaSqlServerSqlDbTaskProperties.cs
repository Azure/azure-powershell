...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class MigrateSchemaSqlServerSqlDbTaskProperties : ProjectTaskProperties
    {
        ...
        /// </param>
        public MigrateSchemaSqlServerSqlDbTaskProperties(System.Collections.Generic.IList<ODataError> errors = default(System.Collections.Generic.IList<ODataError>), string state = default(string), System.Collections.Generic.IList<CommandProperties> commands = default(System.Collections.Generic.IList<CommandProperties>), System.Collections.Generic.IDictionary<string, string> clientData = default(System.Collections.Generic.IDictionary<string, string>), MigrateSchemaSqlServerSqlDbTaskInput input = default(MigrateSchemaSqlServerSqlDbTaskInput), System.Collections.Generic.IList<MigrateSchemaSqlServerSqlDbTaskOutput> output = default(System.Collections.Generic.IList<MigrateSchemaSqlServerSqlDbTaskOutput>))
        ...
        public System.Collections.Generic.IList<MigrateSchemaSqlServerSqlDbTaskOutput> Output {get; private set; }
        /// <summary>
        /// Validate the object.
        /// </summary>
