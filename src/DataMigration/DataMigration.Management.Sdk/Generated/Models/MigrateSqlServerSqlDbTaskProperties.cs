...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlDbTaskProperties : ProjectTaskProperties
    {
        ...
        /// </param>
        public MigrateSqlServerSqlDbTaskProperties(System.Collections.Generic.IList<ODataError> errors = default(System.Collections.Generic.IList<ODataError>), string state = default(string), System.Collections.Generic.IList<CommandProperties> commands = default(System.Collections.Generic.IList<CommandProperties>), System.Collections.Generic.IDictionary<string, string> clientData = default(System.Collections.Generic.IDictionary<string, string>), MigrateSqlServerSqlDbTaskInput input = default(MigrateSqlServerSqlDbTaskInput), System.Collections.Generic.IList<MigrateSqlServerSqlDbTaskOutput> output = default(System.Collections.Generic.IList<MigrateSqlServerSqlDbTaskOutput>))
        ...
        public System.Collections.Generic.IList<MigrateSqlServerSqlDbTaskOutput> Output {get; private set; }
        /// <summary>
        /// Validate the object.
        /// </summary>
