...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class ReportableException
    {
        ...
        /// <param name="actionableMessage">Actionable steps for this exception
        /// </param>

        /// <param name="filePath">The path to the file where exception occurred
        /// </param>

        /// <param name="lineNumber">The line number where exception occurred
        /// </param>

        /// <param name="hResult">Coded numerical value that is assigned to a specific exception
        /// </param>

        /// <param name="stackTrace">Stack trace
        /// </param>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "actionableMessage")]
