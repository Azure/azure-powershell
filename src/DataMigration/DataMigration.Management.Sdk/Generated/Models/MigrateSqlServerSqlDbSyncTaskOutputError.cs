...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlDbSyncTaskOutputError : MigrateSqlServerSqlDbSyncTaskOutput
    {
        ...
        /// <param name="error">Migration error
        /// </param>
        public MigrateSqlServerSqlDbSyncTaskOutputError(string id = default(string), ReportableException error = default(ReportableException))
