...
Describe 'New-AzDataMigrationToSqlVM' {
    It 'CreateExpanded'  {
        $instance = New-AzDataMigrationToSqlVM -ResourceGroupName $env.TestNewDatabaseMigrationVm.ResourceGroupName -SqlVirtualMachineName $env.TestNewDatabaseMigrationVm.SqlVirtualMachineName -TargetDbName $env.TestNewDatabaseMigrationVm.TargetDbName -Kind $env.TestNewDatabaseMigrationVm.Kind -Scope $env.TestNewDatabaseMigrationVm.Scope -MigrationService $env.TestNewDatabaseMigrationVm.MigrationService -TargetLocationStorageAccountResourceId $env.TestNewDatabaseMigrationVm.TargetLocationStorageAccountResourceId -TargetLocationAccountKey $env.TestNewDatabaseMigrationVm.TargetLocationAccountKey -FileSharePath $env.TestNewDatabaseMigrationVm.FileSharePath  -FileShareUsername $env.TestNewDatabaseMigrationVm.FileShareUsername -FileSharePassword $env.TestNewDatabaseMigrationVm.FileSharePassword -SourceSqlConnectionAuthentication $env.TestNewDatabaseMigrationVm.SourceSqlConnectionAuthentication -SourceSqlConnectionDataSource $env.TestNewDatabaseMigrationVm.SourceSqlConnectionDataSource -SourceSqlConnectionUserName $env.TestNewDatabaseMigrationVm.SourceSqlConnectionUsername -SourceSqlConnectionPassword $env.TestNewDatabaseMigrationVm.SourceSqlConnectionPassword -SourceDatabaseName $env.TestNewDatabaseMigrationVm.SourceDatabaseName
