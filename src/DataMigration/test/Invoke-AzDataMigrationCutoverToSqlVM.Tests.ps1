...
Describe 'Invoke-AzDataMigrationCutoverToSqlVM' {
    It 'CutoverExpanded'  -skip{
        $instance =  New-AzDataMigrationToSqlVM -ResourceGroupName $env.TestCutDatabaseMigrationVm.ResourceGroupName -SqlVirtualMachineName $env.TestCutDatabaseMigrationVm.SqlVirtualMachineName -TargetDbName $env.TestCutDatabaseMigrationVm.TargetDbName -Kind $env.TestCutDatabaseMigrationVm.Kind -Scope $env.TestCutDatabaseMigrationVm.Scope -MigrationService $env.TestCutDatabaseMigrationVm.MigrationService -StorageAccountResourceId $env.TestCutDatabaseMigrationVm.TargetLocationStorageAccountResourceId -StorageAccountKey $env.TestCutDatabaseMigrationVm.TargetLocationAccountKey -FileSharePath $env.TestCutDatabaseMigrationVm.FileSharePath  -FileShareUsername $env.TestCutDatabaseMigrationVm.FileShareUsername -FileSharePassword $env.TestCutDatabaseMigrationVm.FileSharePassword -SourceSqlConnectionAuthentication $env.TestCutDatabaseMigrationVm.SourceSqlConnectionAuthentication -SourceSqlConnectionDataSource $env.TestCutDatabaseMigrationVm.SourceSqlConnectionDataSource -SourceSqlConnectionUserName $env.TestCutDatabaseMigrationVm.SourceSqlConnectionUsername -SourceSqlConnectionPassword $env.TestCutDatabaseMigrationVm.SourceSqlConnectionPassword -SourceDatabaseName $env.TestCutDatabaseMigrationVm.SourceDatabaseName       
