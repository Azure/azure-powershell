...
{
    public class ValidateOracleAzureDbPostgreSqlSyncTaskCmdlet : TaskCmdlet<ConnectionInfo>
    {
        private readonly string SelectedDatabases = "SelectedDatabases";

        public ValidateOracleAzureDbPostgreSqlSyncTaskCmdlet(InvocationInfo myInvocation) : base(myInvocation)
        {
        }
        ...
        public override ProjectTaskProperties ProcessTaskCmdlet()
        {
            ...
            {
                selectedDatabases = ((MigrateOracleAzureDbPostgreSqlSyncDatabaseInput[])MyInvocation.BoundParameters[SelectedDatabases]).ToList();
            }

            var properties = new ValidateOracleAzureDbForPostgreSqlSyncTaskProperties
            {
