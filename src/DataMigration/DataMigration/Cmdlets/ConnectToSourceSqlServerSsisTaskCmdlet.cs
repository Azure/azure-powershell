...
{
    public class ConnectToSourceSqlServerSsisTaskCmdlet : TaskCmdlet<ConnectionInfo>
    {
        ...
        public override ProjectTaskProperties ProcessTaskCmdlet()
        {
            ...
            properties.Input.CollectDatabases = false;
            properties.Input.CollectLogins = false;
            properties.Input.CollectAgentJobs = false;
            properties.Input.ValidateSsisCatalogOnly = true;
