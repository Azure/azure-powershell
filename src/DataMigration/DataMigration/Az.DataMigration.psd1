...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added an optional ''Time'' parameter to ''Get-AzDataMigrationPerformanceDataCollection'' to stop the perf collection after the given time '
