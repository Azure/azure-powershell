...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated the description of command ''New-AzDataMigrationToSqlDb'' to inform the customers that they can use ''New-AzDataMigrationSqlServerSchema'' to do schema migration.'
