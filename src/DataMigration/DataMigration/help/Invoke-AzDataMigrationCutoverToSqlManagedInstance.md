...
```
Invoke-AzDataMigrationCutoverToSqlManagedInstance -TargetDbName <String> -ManagedInstanceName <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] -MigrationOperationId <String>
...
### CutoverViaIdentityManagedInstanceExpanded
```
Invoke-AzDataMigrationCutoverToSqlManagedInstance -TargetDbName <String>
 -ManagedInstanceInputObject <IDataMigrationIdentity> -MigrationOperationId <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### CutoverViaIdentityManagedInstance
```
Invoke-AzDataMigrationCutoverToSqlManagedInstance -TargetDbName <String>
 -ManagedInstanceInputObject <IDataMigrationIdentity> -Parameter <IMigrationOperationInput>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
Parameter Sets: CutoverViaIdentityManagedInstanceExpanded, CutoverViaIdentityManagedInstance
Aliases:
...
```yaml
Type: System.String
Parameter Sets: CutoverExpanded, CutoverViaIdentityManagedInstanceExpanded
Aliases:
...
Parameter Sets: CutoverViaIdentityManagedInstance
Aliases:
