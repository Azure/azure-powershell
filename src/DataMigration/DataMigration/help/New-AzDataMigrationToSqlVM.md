...
```powershell
$sourcePassword = ConvertTo-SecureString -String $passwordString -AsPlainText -Force
$filesharePassword = ConvertTo-SecureString -String $passwordString -AsPlainText -Force
