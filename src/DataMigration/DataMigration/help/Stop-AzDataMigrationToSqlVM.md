...
```
Stop-AzDataMigrationToSqlVM -TargetDbName <String> -ResourceGroupName <String> -SqlVirtualMachineName <String>
...
```
Stop-AzDataMigrationToSqlVM -TargetDbName <String> -SqlVirtualMachineInputObject <IDataMigrationIdentity>
...
Parameter Sets: CancelViaIdentitySqlVirtualMachineExpanded, CancelViaIdentitySqlVirtualMachine
Aliases:
