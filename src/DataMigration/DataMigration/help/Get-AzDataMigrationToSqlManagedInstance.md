...
```
Get-AzDataMigrationToSqlManagedInstance -TargetDbName <String>
 -ManagedInstanceInputObject <IDataMigrationIdentity> [-Expand <String>] [-MigrationOperationId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```
