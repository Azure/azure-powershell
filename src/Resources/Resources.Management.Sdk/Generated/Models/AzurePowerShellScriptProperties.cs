...
namespace Microsoft.Azure.Management.Resources.Models
{
    ...
    /// </summary>
    public partial class AzurePowerShellScriptProperties
    {
        /// <summary>
        /// Initializes a new instance of the AzurePowerShellScriptProperties class.
        /// </summary>
        ...
        /// </param>
        public AzurePowerShellScriptProperties(System.TimeSpan retentionInterval, string azPowerShellVersion, ContainerConfiguration containerSettings = default(ContainerConfiguration), StorageAccountConfiguration storageAccountSettings = default(StorageAccountConfiguration), string cleanupPreference = default(string), string provisioningState = default(string), ScriptStatus status = default(ScriptStatus), System.Collections.Generic.IDictionary<string, object> outputs = default(System.Collections.Generic.IDictionary<string, object>), string primaryScriptUri = default(string), System.Collections.Generic.IList<string> supportingScriptUris = default(System.Collections.Generic.IList<string>), string scriptContent = default(string), string arguments = default(string), System.Collections.Generic.IList<EnvironmentVariable> environmentVariables = default(System.Collections.Generic.IList<EnvironmentVariable>), string forceUpdateTag = default(string), System.TimeSpan? timeout = default(System.TimeSpan?))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "azPowerShellVersion")]
