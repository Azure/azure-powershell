...
namespace Microsoft.Azure.Management.Resources
{
    ...
    public static partial class ResourceGroupsOperationsExtensions
    {
            ...
            /// The IDs of the resources to filter the export by. To export all resources,
            /// supply an array with single entry '*'.
            /// </param>
            /// <param name='options'>
            /// The export template options. A CSV-formatted list containing zero or more
            /// of the following: 'IncludeParameterDefaultValue', 'IncludeComments',
            /// 'SkipResourceNameParameterization', 'SkipAllParameterization'
            /// </param>
            public static ResourceGroupExportResult ExportTemplate(this IResourceGroupsOperations operations, string resourceGroupName, IList<string> resources = default(IList<string>), string options = default(string))
            {
                return operations.ExportTemplateAsync(resourceGroupName, resources, options).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ResourceGroupExportResult> ExportTemplateAsync(this IResourceGroupsOperations operations, string resourceGroupName, IList<string> resources = default(IList<string>), string options = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ExportTemplateWithHttpMessagesAsync(resourceGroupName, resources, options, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// 'SkipResourceNameParameterization', 'SkipAllParameterization'
            /// </param>
            public static ResourceGroupExportResult BeginExportTemplate(this IResourceGroupsOperations operations, string resourceGroupName, IList<string> resources = default(IList<string>), string options = default(string))
            {
                return operations.BeginExportTemplateAsync(resourceGroupName, resources, options).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ResourceGroupExportResult> BeginExportTemplateAsync(this IResourceGroupsOperations operations, string resourceGroupName, IList<string> resources = default(IList<string>), string options = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginExportTemplateWithHttpMessagesAsync(resourceGroupName, resources, options, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
