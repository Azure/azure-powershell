function Remove-AzADServicePrincipal_DeleteByApplicationObject {
    ...
    param(
        ...
        [Parameter(Mandatory, HelpMessage='The object representation of the application of the service principal.')]
    ...
    process {
        $ServicePrincipal = Az.Resources\Get-AzADServicePrincipal -TenantId $TenantId -ApplicationObject $ApplicationObject
