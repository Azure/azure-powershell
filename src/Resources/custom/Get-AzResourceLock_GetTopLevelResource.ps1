function Get-AzResourceLock_GetTopLevelResource {
    ...
    param(
        [Parameter(Mandatory, HelpMessage='The name of lock.')]
        ...
        [Parameter(Mandatory, HelpMessage='The name of the resource.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.Category('Path')]
        ...
        [Parameter(Mandatory, HelpMessage='The type of the resource.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.Category('Path')]
