function Remove-AzADServicePrincipal_DeleteBySPN {
    ...
    process {
        $ServicePrincipal = Az.Resources\Get-AzADServicePrincipal -TenantId $TenantId -ServicePrincipalName $ServicePrincipalName
