function Update-AzResource_UpdateTopLevelResource {
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Resources.Description('Updates a resource.')]
    param(
        [Parameter(Mandatory, HelpMessage='The name of the resource to update.')]
        [Alias('ResourceName')]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.Category('Path')]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.Runtime.Info(SerializedName='resourceName', Required, PossibleTypes=([System.String]), Description='The name of the resource to update.')]
        [System.String]
        ...
        [Parameter(Mandatory, HelpMessage='The resource type of the resource to update.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.Category('Path')]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.Runtime.Info(SerializedName='resourceType', Required, PossibleTypes=([System.String]), Description='The resource type of the resource to update.')]
        [System.String]
    ...
    process {
        ...
        Az.Resources\Update-AzResource @PSBoundParameters
    }
}