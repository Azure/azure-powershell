function Get-AzPolicyDefinition_WithBuiltIn {
    ...
    param(
        [Parameter(Mandatory, HelpMessage='Signals to retrieve built-in policy definitions.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.Category('Query')]
        [System.Management.Automation.SwitchParameter]
        ${BuiltIn},

        [Parameter(HelpMessage='The name of the built-in policy definition to get.')]
    ...
    process {
        ...
        {
            $PSBoundParameters.Add("PolicyDefinitionName", $Name) | Out-Null
            $PSBoundParameters.Remove("Name") | Out-Null
        }

        $PSBoundParameters.Remove("BuiltIn") | Out-Null
        Az.Resources.internal\Get-AzPolicyDefinitionBuilt @PSBoundParameters
    }
}