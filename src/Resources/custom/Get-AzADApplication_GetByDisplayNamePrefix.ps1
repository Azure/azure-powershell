function Get-AzADApplication_GetByDisplayNamePrefix {
    ...
    process {
        $PSBoundParameters.Add("Filter", "startsWith(displayname, '$DisplayNameStartWith')") | Out-Null
        $PSBoundParameters.Remove("DisplayNameStartWith") | Out-Null
