function Set-AzResourceGroup_UpdateById {
    ...
    param(
        ...
        [Parameter(Mandatory, HelpMessage='The location of the resource group. It cannot be changed after the resource group has been created. It must be one of the supported Azure locations.')]
