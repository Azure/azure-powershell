function New-AzADServicePrincipalKeyCredential {
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Resources.Description('Adds a new key credential to a service principal.')]
    param(
        ...
        [Parameter(HelpMessage='The base-64 encoded value for the AsymmetricX509Cert associated with the service principal.')]
        [System.String]
    ...
    process {
        ...
        $ExistingCredentials = Az.Resources\Get-AzADServicePrincipalKeyCredential -TenantId $TenantId -ObjectId $ObjectId
