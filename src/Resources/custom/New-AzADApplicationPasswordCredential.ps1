function New-AzADApplicationPasswordCredential {
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Resources.Description('Adds a new password credential to an application.')]
    param(
        ...
        [Parameter(HelpMessage='The value for the password credential to be associated with the given application.')]
    ...
    process {
        ...
        $ExistingCredentials = Az.Resources\Get-AzADApplicationPasswordCredential -TenantId $TenantId -ObjectId $ObjectId
        ...
        Az.Resources.internal\Update-AzADApplicationPasswordCredential @PSBoundParameters
    }
}