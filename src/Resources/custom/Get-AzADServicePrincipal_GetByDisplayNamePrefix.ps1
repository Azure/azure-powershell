function Get-AzADServicePrincipal_GetByDisplayNamePrefix {
    ...
    process {
        $PSBoundParameters.Add("Filter", "startsWith(displayname, '$DisplayNameBeginsWith')") | Out-Null
        $PSBoundParameters.Remove("DisplayNameBeginsWith") | Out-Null
