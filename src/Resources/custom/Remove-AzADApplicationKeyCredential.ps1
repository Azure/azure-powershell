function Remove-AzADApplicationKeyCredential {
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Resources.Description('Removes a key credential associated with an application.')]
    param(
    ...
    process {
        ...
        $Credentials = Get-AzADApplicationKeyCredential @PSBoundParameters
