...
#>
function ManagementGroupLevelDeploymentEndToEnd
{
    try
	{
	    # Setup
		...
		# Test
		$deployment = New-AzDeployment -ManagementGroup "tiano-mgtest01" -Name $deploymentName -Location $location -TemplateFile management_group_level_template.json -TemplateParameterFile management_group_level_parameters.json
