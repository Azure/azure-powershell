...
function Test-PolicyDefinitionCRUDAtManagementGroup
{
    ...
    Assert-ThrowsContains { Get-AzPolicyDefinition -Name $policyName } "PolicyDefinitionNotFound : The policy definition '$policyName' could not be found."
...
function Test-PolicySetDefinitionCRUDAtManagementGroup
{
    ...
    # make sure it can't be retrieved at default subscription level
    Assert-ThrowsContains { Get-AzPolicySetDefinition -Name $policySetDefName } "PolicySetDefinitionNotFound : The policy set definition '$policySetDefName' could not be found."
...
function Test-SetPolicyAssignmentParameters
{
    ...
    # validate remaining parameter combinations starting with -Scope
    Assert-ThrowsContains { Set-AzPolicyAssignment -Scope $someScope } $missingParameters
    Assert-ThrowsContains { Set-AzPolicyAssignment -Scope $someScope -Id $someId } $parameterSetError
