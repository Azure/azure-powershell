...
function Test-RoleDefinitionCreateTests
{
    ...
    New-AzRoleDefinition -InputFile .\Resources\NewRoleDefinition.json
...
function Test-RdNegativeScenarios
{
    ...
    Assert-Throws { Set-AzRoleDefinition -InputFile .\Resources\RoleDefinition.json } $badIdException

    # Role Defintion not provided.
    $roleDefNotProvided = "Parameter set cannot be resolved using the specified named parameters. One or more parameters issued cannot be used together or an insufficient number of parameters were provided."
    ...
    Assert-Throws { Set-AzRoleDefinition -InputFile .\Resources\RoleDefinition.json -Role $rd } $roleDefNotProvided
...
function Test-RDPositiveScenarios
{
    ...
    [Microsoft.Azure.Commands.Resources.Models.Authorization.AuthorizationClient]::RoleDefinitionNames.Enqueue("032F61D2-ED09-40C9-8657-26A273DA7BAE")
    $rd = New-AzRoleDefinition -InputFile .\Resources\RoleDefinition.json
    $rd = Get-AzRoleDefinition -Name $rdName
...
function Test-RDCreateFromFile
{
    ...
    Assert-Throws { $rd = New-AzRoleDefinition -InputFile .\Resources\InvalidRoleDefinition.json } $badScopeException
}
<#
.SYNOPSIS
...
function Test-RDRemove
{
    ...
    $Rd = New-AzRoleDefinition -Role $roleDef
    Assert-NotNull $Rd
...
function Test-RDGet
{
    ...
    $roleDefSubScope = New-AzRoleDefinition -Role $roleDef1
    ...
    $roleDefRGScope = New-AzRoleDefinition -Role $roleDef1
    ...
    $roleDefResourceScope = New-AzRoleDefinition -Role $roleDef1
