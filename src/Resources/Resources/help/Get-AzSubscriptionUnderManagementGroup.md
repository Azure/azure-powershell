...
```
Get-AzSubscriptionUnderManagementGroup[-GroupName] <String> [-PassThru] [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

## DESCRIPTION
The **Get-AzSubscriptionUnderManagementGroup** cmdlet gets all the subscriptions under the provided Management Group.

## EXAMPLES

### Example 1: Get all Subscriptions under a Management Group
```powershell
Get-AzSubscriptionUnderManagementGroup-GroupName "TestGroup"
```
