...
online version: https://learn.microsoft.com/powershell/module/az.resources/Remove-AzManagementGroupDeploymentStackWhatIfResultschema: 2.0.0
---
...
```
Remove-AzManagementGroupDeploymentStackWhatIfResult [-Name] <String> [-ManagementGroupId] <String> [-PassThru]
...
### RemoveByResourceId
```
Remove-AzManagementGroupDeploymentStackWhatIfResult -ResourceId <String> [-PassThru] [-Force] [-Pre]
...
### RemoveByInputObject
```
Remove-AzManagementGroupDeploymentStackWhatIfResult [-InputObject] <PSDeploymentStackWhatIfResult> [-PassThru]
 [-Force] [-Pre] [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [-AcquirePolicyToken]
 [-ChangeReference <String>] [<CommonParameters>]
```
