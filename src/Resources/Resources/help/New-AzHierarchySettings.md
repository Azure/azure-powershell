...
### GetOperation
```
New-AzHierarchySettings  [-GroupName] <String> [-DefaultProfile <IAzureContextContainer>] 
[-RequireAuthorizationForGroupCreation] <String> 
[-DefaultManagementGroup] <String> 
```

## DESCRIPTION
The New-AzHierarchySettings cmdlet creates new hierarchy settings under the current tenant.
...
```powershell
New-AzHierarchySettings -GroupName c7a87cda-9a66-4920-b0f8-869baa04efe0 -DefaultManagementGroup TestGroup
```
...
```powershell
New-AzHierarchySettings -GroupName c7a87cda-9a66-4920-b0f8-869baa04efe0 -RequireAuthorizationForGroupCreation True -DefaultManagementGroup TestGroup
```
