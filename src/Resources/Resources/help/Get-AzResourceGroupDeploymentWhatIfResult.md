...
Gets an ARM template What-If result for a deployment at resource group scope. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Get-AzResourceGroupDeploymentWhatIfResult -ResourceGroupName 'myRG1' -TemplateFile 'D:\Azure\Templates\ServiceTemplate.json' -TemplateParameterFile 'D:\Azure\Templates\ServiceParameters.json'
```
