...
```powershell
Get-AzPolicyDefinition | Where-Object {$_.Properties.metadata.category -eq "Tag"}
```
...
```powershell
Get-AzPolicyDefinition | Select-Object -ExpandProperty properties | Select-Object DisplayName, Description, PolicyType, Metadata | Format-List
```
