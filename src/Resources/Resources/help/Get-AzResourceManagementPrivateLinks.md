...
# Get-AzResourceManagementPrivateLinks

## SYNOPSIS
Gets Azure Resource Management Private Links

## SYNTAX

```
Get-AzResourceManagementPrivateLinks [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

## DESCRIPTION
The Get-AzResourceManagementPrivateLink cmdlet gets all of resource management private link at the scope.
...
### Microsoft.Azure.Commands.Resources.Models.PrivateLinks.PSResourceManagementPrivateLinkList
