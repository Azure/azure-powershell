...
```
Update-AzADGroup -GroupId <String> [-AdditionalProperties <Hashtable>]
...
```
Update-AzADGroup -GroupId <String> -JsonFilePath <String> [-DefaultProfile <PSObject>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaJsonString
```
Update-AzADGroup -GroupId <String> -JsonString <String> [-DefaultProfile <PSObject>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
