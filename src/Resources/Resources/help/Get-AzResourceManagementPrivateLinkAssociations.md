...
# Get-AzResourceManagementPrivateLinkAssociations

## SYNOPSIS
Gets all the Azure Resource Management Private Link Associations.

## SYNTAX

```
Get-AzResourceManagementPrivateLinkAssociations [-ManagementGroupId] <String>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

## DESCRIPTION
The Get-AzResourceManagementPrivateLinkAssociations cmdlet gets all of resource management private link at the scope.

## EXAMPLES

### Example 1
```powershell
PS C:\>  Get-AzResourceManagementPrivateLinkAssociations -ManagementGroupId fc096d27-0434-4460-a3ea-110df0422a2d | fl
...
### Microsoft.Azure.Commands.Resources.Models.PrivateLinks.PSResourceManagementPrivateLinkAssociationList
