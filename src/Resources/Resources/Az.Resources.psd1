...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added a notice to template deployment what-if output pointing users to Deployment Stacks What-If, which is now generally available and removes noise from results.'
