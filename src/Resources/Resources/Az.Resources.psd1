...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed issue where the PowerShell console would close when using Resources module cmdlets without being logged in. Github Issue [link](https://github.com/Azure/azure-powershell/issues/28774).
