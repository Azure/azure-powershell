...
NestedModules = @('MSGraph\MSGraph.psm1')
...
FunctionsToExport = 'Get-AzADUser', 'New-AzADUser', 'Remove-AzADUser', 'Update-AzADUser',
               ...
               'Get-AzADApplication', 'New-AzADApplication',
               'Remove-AzADApplication', 'Update-AzADApplication',
               'Get-AzADServicePrincipal', 'New-AzADServicePrincipal',
               'Remove-AzADServicePrincipal', 'Update-AzADServicePrincipal',
               'Get-AzADAppCredential', 'New-AzADAppCredential',
               'Remove-AzADAppCredential', 'Get-AzADSpCredential',
               'New-AzADSpCredential', 'Remove-AzADSpCredential',
               'Get-AzADGroupMember', 'Add-AzADGroupMember',
               'Remove-AzADGroupMember', 'Add-AzADAppPermission',
               'Get-AzADAppPermission', 'Remove-AzADAppPermission'
...
CmdletsToExport = 'Get-AzProviderOperation', 'Remove-AzRoleAssignment',
               ...
               'Get-AzEntities', 'Get-AzManagementGroupNameAvailability',
	       ...
	       'New-AzHierarchySettings', 'Update-AzHierarchySettings',
               'Get-AzHierarchySettings', 'Remove-AzHierarchySettings'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added ''Get-AzProviderPreviewFeature'', ''Register-AzProviderPreviewFeature'' and ''Unregister-AzProviderPreviewFeature'' cmdlets.
