...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed ''Remove-AzRoleDefinition'' displaying incorrect confirmation message (unformatted placeholder) and empty GUID as target when using ''-Confirm'' or ''-WhatIf'' with the ''-Name'' parameter [#29075]
