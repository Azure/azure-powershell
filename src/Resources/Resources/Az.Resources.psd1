...
CmdletsToExport = 'Get-AzProviderOperation', 'Remove-AzRoleAssignment', 
               ...
               'Get-AzDeploymentOperation', 'New-AzDeploymentWhatIf', 'Get-AzPolicyAlias', 'Remove-AzTag', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Add support for new api version 2019-05-10 for Microsoft.Resource
