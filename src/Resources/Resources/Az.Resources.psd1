...
CmdletsToExport = 'Get-AzProviderOperation', 'Remove-AzRoleAssignment', 
               ...
               'Remove-AzTenantDeployment', 'Get-AzDeploymentWhatIfResult', 
               'Get-AzResourceGroupDeploymentWhatIfResult', 'Get-AzPolicyAlias', 
               'Remove-AzTag', 'Get-AzTag', 'New-AzTag', 'Get-AzDenyAssignment', 
               'Update-AzTag'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Add Get-AzDeploymentWhatIfResult cmdlet for getting ARM template What-If at subscription scope.
