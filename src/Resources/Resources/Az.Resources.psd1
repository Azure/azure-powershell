...
FunctionsToExport = 'Add-AzADAppPermission', 'Add-AzADGroupMember', 
               ...
               'New-AzPolicyDefinitionVersion', 'New-AzPolicyExemption', 
               'New-AzPolicySetDefinition', 'New-AzPolicySetDefinitionVersion', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Removed unavailable variant Get-AzRoleEligibleChildResource cmdlet for InputObject parameter.
