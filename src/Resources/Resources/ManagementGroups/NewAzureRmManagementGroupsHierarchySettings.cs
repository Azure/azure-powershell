...
{
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "HierarchySettings", DefaultParameterSetName = Constants.ParameterSetNames.GroupOperationsParameterSet, SupportsShouldProcess = true), OutputType(typeof(PSHierarchySettings))]
        ...
        public override void ExecuteCmdlet()
        {
            try
            {
                       ...
                       string.Format(Resource.NewManagementGroupShouldProcessAction, GroupName)))
                {
                    ...
                    var response = ManagementGroupsApiClient.HierarchySettings.CreateOrUpdate(GroupName, new CreateOrUpdateSettingsRequest(RequireAuthorizationForGroupCreation, DefaultManagementGroup));
