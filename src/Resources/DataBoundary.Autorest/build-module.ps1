...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.DataBoundary.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.DataBoundary.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: DataBoundary cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.DataBoundary.format.ps1xml'
