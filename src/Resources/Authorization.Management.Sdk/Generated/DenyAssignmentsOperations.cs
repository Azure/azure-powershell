...
namespace Microsoft.Azure.Management.Authorization
{
    ...
    internal partial class DenyAssignmentsOperations : Microsoft.Rest.IServiceOperations<AuthorizationManagementClient>, IDenyAssignmentsOperations
    {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<DenyAssignment>>> ListForResourceWithHttpMessagesAsync(string resourceGroupName, string resourceProviderNamespace, string parentResourcePath, string resourceType, string resourceName, Microsoft.Rest.Azure.OData.ODataQuery<DenyAssignmentFilter> odataQuery = default(Microsoft.Rest.Azure.OData.ODataQuery<DenyAssignmentFilter>), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (resourceName != null)
            {
                if (!System.Text.RegularExpressions.Regex.IsMatch(resourceName, "^[a-zA-Z0-9._-]+$"))
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.Pattern, "resourceName", "^[a-zA-Z0-9._-]+$");
                }
            }
