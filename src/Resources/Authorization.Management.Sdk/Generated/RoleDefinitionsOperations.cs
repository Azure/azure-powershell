...
namespace Microsoft.Azure.Management.Authorization
{
    ...
    internal partial class RoleDefinitionsOperations : Microsoft.Rest.IServiceOperations<AuthorizationManagementClient>, IRoleDefinitionsOperations
    {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<RoleDefinition>> CreateOrUpdateWithHttpMessagesAsync(string scope, string roleDefinitionId, RoleDefinition roleDefinition, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "roleDefinition");
            }
            ...
            if(roleDefinition != null)
            {
                _requestContent = Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(roleDefinition, this.Client.SerializationSettings);
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<RoleDefinition>>> ListWithHttpMessagesAsync(string scope, Microsoft.Rest.Azure.OData.ODataQuery<RoleDefinitionFilter> odataQuery = default(Microsoft.Rest.Azure.OData.ODataQuery<RoleDefinitionFilter>), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (odataQuery != null)
            {
                var _roleDefinitionFilter = odataQuery.ToString();
                if (!string.IsNullOrEmpty(_roleDefinitionFilter))
                {
                    _queryParameters.Add(_roleDefinitionFilter);
                }
            }
            if (apiVersion != null)
            {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<RoleDefinition>>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<RoleDefinition>>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (Newtonsoft.Json.JsonException ex)
                {
                    _httpRequest.Dispose();
