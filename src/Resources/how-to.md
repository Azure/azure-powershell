...
- `build-module.ps1`
  - Builds the module DLL (`./bin/Az.Resources.private.dll`), creates the exported cmdlets, generates custom cmdlet test stubs, and updates `./Az.Resources.psd1` with Azure profile information.
