...
namespace Microsoft.Azure.Management.Resources.Models
{
    ...
    public partial class DeploymentScriptUpdateParameter : AzureResourceBase
    {
        ...
        public DeploymentScriptUpdateParameter(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
            : base(id, name, type)
        {
            Tags = tags;
            CustomInit();
