namespace Microsoft.Azure.Commands.ResourceManager.Cmdlets.SdkModels.Deployments
{
    ...
    public class PSDeploymentWhatIfCmdletParameters
    {
        ...
        public void Validate()
        {
            ...
            {
                case DeploymentWhatIfScopeType.Subscription when this.Mode == DeploymentMode.Complete:
                    throw new ArgumentException(Resources.InvalidDeploymentMode);

                case DeploymentWhatIfScopeType.Subscription when !string.IsNullOrEmpty(this.ResourceGroupName):
                    throw new ArgumentException(Resources.InvalidParameterForSubscriptionScope);

                case DeploymentWhatIfScopeType.ResourceGroup when string.IsNullOrEmpty(this.ResourceGroupName):
                    throw new ArgumentException(Resources.InvalidParameterForResourceGroupScope);
            }
        }
