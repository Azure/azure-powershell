namespace Microsoft.Azure.Commands.ResourceManager.Cmdlets.SdkModels.Deployments
{
    ...
    public class PSDeploymentWhatIfCmdletParameters
    {
        ...
        public DeploymentWhatIf ToDeploymentWhatIf()
        {
            ...
            {
                properties.TemplateLink = new Microsoft.Azure.Management.Resources.Models.TemplateLink
                {
                    Id = this.TemplateSpecId
                };
            }
            ...
            {
                properties.ParametersLink = new Microsoft.Azure.Management.Resources.Models.ParametersLink
                {
                    Uri = this.TemplateParametersUri
                };
            }
            else
            {
