...
namespace Microsoft.Azure.Commands.ResourceManager.Cmdlets.Implementation
{
    ...
    public class NewAzSubscriptionDeploymentStack : DeploymentStacksCreateCmdletBase
    {
        ...
        [Alias("StackName")]
        [Parameter(Position = 0, Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = "The name of the deploymentStack to create")]
        ...
        protected override void OnProcessRecord()
        {
            try
            {
                ...
                {
                    var whatIfResult = DeploymentStacksWhatIfSdkClient.ExecuteSubscriptionDeploymentStackWhatIf(
