                ...
                switch (ParameterSetName)
                {
                    case GetByResourceIdParameterSetName:
                        ...
                        WriteObject(WithPropertyChanges.IsPresent
                            ? DeploymentStacksSdkClient.GetResourceGroupDeploymentStackWhatIfResultWithPropertyChanges(rg, name)
                            : DeploymentStacksSdkClient.GetResourceGroupDeploymentStackWhatIfResult(rg, name));
                        break;
                    case GetByNameParameterSetName:
                        WriteObject(WithPropertyChanges.IsPresent
                            ? DeploymentStacksSdkClient.GetResourceGroupDeploymentStackWhatIfResultWithPropertyChanges(ResourceGroupName, Name)
                            : DeploymentStacksSdkClient.GetResourceGroupDeploymentStackWhatIfResult(ResourceGroupName, Name));
                        break;
                    case ListParameterSetName:
                        WriteObject(DeploymentStacksSdkClient.ListResourceGroupDeploymentStackWhatIfResults(ResourceGroupName), true);
                        break;
                    default:
