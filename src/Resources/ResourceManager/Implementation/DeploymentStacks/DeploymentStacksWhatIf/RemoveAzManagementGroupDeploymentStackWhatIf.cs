...
namespace Microsoft.Azure.Commands.ResourceManager.Cmdlets.Implementation.DeploymentStacks
{
    ...
    /// </summary>
    [Cmdlet("Remove", AzureRMConstants.AzureRMPrefix + "ManagementGroupDeploymentStackWhatIf",
        ...
        protected override void OnProcessRecord()
        {
            try
            {
                ConfirmAction(
                    ...
                    "Delete",
                    Name,
                    () => DeploymentStacksSdkClient.DeleteManagementGroupDeploymentStackWhatIfResult(ManagementGroupId, Name));
            }
            catch (Exception ex)
            {
