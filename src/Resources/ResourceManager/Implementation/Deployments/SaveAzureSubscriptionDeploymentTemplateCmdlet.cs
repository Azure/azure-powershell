...
namespace Microsoft.Azure.Commands.ResourceManager.Cmdlets.Implementation
{
    ...
    /// </summary>
    [Cmdlet(VerbsData.Save, AzureRMConstants.AzureRMPrefix + "DeploymentTemplate", SupportsShouldProcess = true,
        DefaultParameterSetName = SaveAzureSubscriptionDeploymentTemplateCmdlet.DeploymentNameParameterSet), OutputType(typeof(PSTemplatePath))]
    [Alias("Save-AzSubscriptionDeploymentTemplate")]
    public class SaveAzureSubscriptionDeploymentTemplateCmdlet : ResourceManagerCmdletBase
    {
        /// <summary>
        ...
        /// </summary>
        [Alias("Name")]
        [Parameter(ParameterSetName = SaveAzureSubscriptionDeploymentTemplateCmdlet.DeploymentNameParameterSet, Mandatory = true, HelpMessage = "The deployment name.")]
        [ValidateNotNullOrEmpty]
        public string DeploymentName { get; set; }

        [Parameter(ParameterSetName = SaveAzureSubscriptionDeploymentTemplateCmdlet.DeploymentObjectParameterSet, Mandatory = true,
        ...
        protected override void OnProcessRecord()
        {
            ...
            {
                var template = NewResourceManagerSdkClient.GetDeploymentTemplateAtSubscrpitionScope(deploymentName);
