...
namespace Microsoft.Azure.Commands.ResourceManager.Cmdlets.Implementation
{
    ...
    [Cmdlet(VerbsCommon.Remove, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "Deployment", SupportsShouldProcess = true,
        DefaultParameterSetName = RemoveAzureSubscriptionDeploymentCmdlet.DeploymentNameParameterSet), OutputType(typeof(bool))]
    [Alias("Remove-AzSubscriptionDeployment")]
    public class RemoveAzureSubscriptionDeploymentCmdlet : ResourceManagerCmdletBase
    {
        /// <summary>
        ...
        [Parameter(Position = 0, ParameterSetName = RemoveAzureSubscriptionDeploymentCmdlet.DeploymentNameParameterSet, Mandatory = true, HelpMessage = "The name of the deployment.")]
        [ValidateNotNullOrEmpty]
        public string Name { get; set; }

        [Alias("DeploymentId", "ResourceId")]
        [Parameter(ParameterSetName = RemoveAzureSubscriptionDeploymentCmdlet.DeploymentIdParameterSet, Mandatory = true,
        ...
        [Parameter(ParameterSetName = RemoveAzureSubscriptionDeploymentCmdlet.InputObjectParameterSet, Mandatory = true, 
        ...
        protected override void OnProcessRecord()
        {
            ConfirmAction(
                ...
                () =>
                {
                    ...
                    NewResourceManagerSdkClient.DeleteDeploymentAtSubscriptionScope(deploymentName);
