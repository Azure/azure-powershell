...
namespace Microsoft.Azure.Commands.ResourceManager.Cmdlets.Implementation
{
    ...
    /// </summary>
    [Cmdlet(VerbsData.Save, AzureRMConstants.AzureRMPrefix + "ManagementGroupDeploymentTemplate", SupportsShouldProcess = true,
        DefaultParameterSetName = SaveAzureManagementGroupDeploymentTemplateCmdlet.DeploymentNameParameterSet), OutputType(typeof(PSTemplatePath))]
    public class SaveAzureManagementGroupDeploymentTemplateCmdlet : ResourceManagerCmdletBase
    {
        /// <summary>
        ...
        /// </summary>
        [Parameter(ParameterSetName = SaveAzureManagementGroupDeploymentTemplateCmdlet.DeploymentNameParameterSet,
        ...
        [Parameter(ParameterSetName = SaveAzureManagementGroupDeploymentTemplateCmdlet.DeploymentObjectParameterSet,
