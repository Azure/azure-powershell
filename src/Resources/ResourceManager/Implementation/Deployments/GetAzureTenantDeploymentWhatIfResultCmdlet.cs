...
namespace Microsoft.Azure.Commands.ResourceManager.Cmdlets.Implementation
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, AzureRMConstants.AzureRMPrefix + "TenantDeploymentWhatIfResult",
         DefaultParameterSetName = ParameterlessTemplateFileParameterSetName),
     OutputType(typeof(PSWhatIfOperationResult))]
    public class GetAzureTenantDeploymentWhatIfResultCmdlet : ResourceWithParameterCmdletBase, IDynamicParameters
    {
