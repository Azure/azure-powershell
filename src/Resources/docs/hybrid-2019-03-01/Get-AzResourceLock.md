...
### List2 (Default)
```
Get-AzResourceLock [-SubscriptionId <String[]>] [-Filter <String>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### Get
```
Get-AzResourceLock -LockName <String> -Scope <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get1
```
Get-AzResourceLock -LockName <String> -ParentResourcePath <String> -ResourceGroupName <String>
...
### Get2
```
Get-AzResourceLock -LockName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### Get3
```
Get-AzResourceLock -LockName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzResourceLock -InputObject <IResourcesIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### List
```
Get-AzResourceLock -ResourceGroupName <String> [-SubscriptionId <String[]>] [-Filter <String>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### List1
```
Get-AzResourceLock -ParentResourcePath <String> -ResourceGroupName <String> -ResourceName <String>
...
### List3
```
Get-AzResourceLock -Scope <String> [-Filter <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
