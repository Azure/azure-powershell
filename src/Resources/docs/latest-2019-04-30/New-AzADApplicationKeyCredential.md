...
online version: https://docs.microsoft.com/en-us/powershell/module/az.resources/new-azadapplicationkeycredential
schema: 2.0.0
---

# New-AzADApplicationKeyCredential
...
```
New-AzADApplicationKeyCredential -ObjectId <String> -TenantId <String> [-CertValue <String>]
