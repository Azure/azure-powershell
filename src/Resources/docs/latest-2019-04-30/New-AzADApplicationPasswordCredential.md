...
online version: https://docs.microsoft.com/powershell/module/az.resources/new-azadapplicationpasswordcredential
schema: 2.0.0
---
...
```
New-AzADApplicationPasswordCredential -ObjectId <String> -TenantId <String> [-EndDate <DateTime>]
