...
online version: https://docs.microsoft.com/en-us/powershell/module/az.resources/new-azadserviceprincipalpasswordcredential
schema: 2.0.0
---

# New-AzADServicePrincipalPasswordCredential
...
```
New-AzADServicePrincipalPasswordCredential -ObjectId <String> -TenantId <String> [-EndDate <DateTime>]
 [-Password <SecureString>] [-StartDate <DateTime>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
