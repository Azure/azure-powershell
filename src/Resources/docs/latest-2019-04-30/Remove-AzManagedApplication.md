...
### Delete1 (Default)
```
Remove-AzManagedApplication -Id <String> [-PassThru] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
### DeleteViaIdentity1
```
Remove-AzManagedApplication -InputObject <IResourcesIdentity> [-PassThru] [-DefaultProfile <PSObject>]
