...
### Delete2 (Default)
```
Remove-AzResourceLock -LockName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Delete
```
Remove-AzResourceLock -LockName <String> -Scope <String> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Delete1
```
Remove-AzResourceLock -LockName <String> -ParentResourcePath <String> -ResourceGroupName <String>
...
### Delete3
```
Remove-AzResourceLock -LockName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteTopLevelResource
```
Remove-AzResourceLock -LockName <String> -ResourceGroupName <String> -ResourceName <String>
...
### DeleteViaIdentity
```
Remove-AzResourceLock -InputObject <IResourcesIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Delete, Delete1, Delete2, Delete3, DeleteTopLevelResource
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Delete1, Delete3, DeleteTopLevelResource
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Delete1, DeleteTopLevelResource
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Delete1, Delete2, Delete3, DeleteTopLevelResource
Aliases:
