# region Generated 
  ...
  $null = Import-Module -Name (Join-Path $PSScriptRoot './bin/Az.AD.private.dll')

  # Get the private module's instance
  $instance = [Microsoft.Azure.PowerShell.Cmdlets.AD.Module]::Instance
  ...
  $customModulePath = Join-Path $PSScriptRoot './custom/Az.AD.custom.psm1'
