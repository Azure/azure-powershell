...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/remove-azadserviceprincipal
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzADServicePrincipal -InputObject <IAdIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
