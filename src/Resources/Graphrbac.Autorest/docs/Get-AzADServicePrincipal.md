...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/get-azadserviceprincipal
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzADServicePrincipal -InputObject <IAdIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
