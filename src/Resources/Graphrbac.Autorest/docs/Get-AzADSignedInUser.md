...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/get-azadsignedinuser
schema: 2.0.0
---

# Get-AzADSignedInUser
...
### Get (Default)
```
Get-AzADSignedInUser -TenantId <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzADSignedInUser -InputObject <IAdIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
