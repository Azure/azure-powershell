...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/update-azadapplicationpasswordcredentials
schema: 2.0.0
---

# Update-AzADApplicationPasswordCredentials
...
```
Update-AzADApplicationPasswordCredentials -InputObject <IAdIdentity> -Value <IPasswordCredential[]>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateExpanded
```
Update-AzADApplicationPasswordCredentials -ApplicationObjectId <String> -TenantId <String>
