...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/remove-azadapplicationowner
schema: 2.0.0
---
...
### Remove (Default)
```
Remove-AzADApplicationOwner -ApplicationObjectId <String> -OwnerObjectId <String> -TenantId <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-AzADApplicationOwner -InputObject <IAdIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
