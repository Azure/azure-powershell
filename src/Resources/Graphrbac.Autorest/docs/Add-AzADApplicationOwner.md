...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/add-azadapplicationowner
schema: 2.0.0
---
...
### AddExpanded (Default)
```
Add-AzADApplicationOwner -ApplicationObjectId <String> -TenantId <String> -Url <String>
...
### Add
```
Add-AzADApplicationOwner -ApplicationObjectId <String> -TenantId <String> -Parameter <IAddOwnerParameters>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AddViaIdentity
```
Add-AzADApplicationOwner -InputObject <IAdIdentity> -Parameter <IAddOwnerParameters>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AddViaIdentityExpanded
```
Add-AzADApplicationOwner -InputObject <IAdIdentity> -Url <String> [-AdditionalProperties <Hashtable>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
