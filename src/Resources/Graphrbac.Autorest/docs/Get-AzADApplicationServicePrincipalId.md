...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/get-azadapplicationserviceprincipalid
schema: 2.0.0
---

# Get-AzADApplicationServicePrincipalId
...
### Get (Default)
```
Get-AzADApplicationServicePrincipalId -ApplicationId <String> -TenantId <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzADApplicationServicePrincipalId -InputObject <IAdIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
