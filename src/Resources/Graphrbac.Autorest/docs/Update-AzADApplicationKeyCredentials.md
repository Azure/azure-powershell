...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/update-azadapplicationkeycredentials
schema: 2.0.0
---

# Update-AzADApplicationKeyCredentials
...
```
Update-AzADApplicationKeyCredentials -InputObject <IAdIdentity> -Value <IKeyCredential[]>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateExpanded
```
Update-AzADApplicationKeyCredentials -ApplicationObjectId <String> -TenantId <String>
 -Value <IKeyCredential[]> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
