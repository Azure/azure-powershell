...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/remove-azaddeletedapplicationhard
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzADDeletedApplicationHard -ApplicationObjectId <String> -TenantId <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzADDeletedApplicationHard -InputObject <IAdIdentity> [-DefaultProfile <PSObject>] [-PassThru]
