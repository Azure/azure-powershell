...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/remove-azadgroupmember
schema: 2.0.0
---
...
### RemoveViaIdentity
```
Remove-AzADGroupMember -InputObject <IAdIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
