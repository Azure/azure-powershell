...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/restore-azaddeletedapplication
schema: 2.0.0
---
...
### RestoreViaIdentity
```
Restore-AzADDeletedApplication -InputObject <IAdIdentity> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
