...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/get-azadusermembergroup
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzADUserMemberGroup -InputObject <IAdIdentity> -Parameter <IUserGetMemberGroupsParameters>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentityExpanded
```
Get-AzADUserMemberGroup -InputObject <IAdIdentity> -SecurityEnabledOnly [-AdditionalProperties <Hashtable>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IUserGetMemberGroupsParameters
