...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/get-azadserviceprincipalapproleassignment
schema: 2.0.0
---
...
```
Get-AzADServicePrincipalAppRoleAssignment -ObjectId <String> -TenantId <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
