...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/update-azadserviceprincipalkeycredentials
schema: 2.0.0
---
...
```
Update-AzADServicePrincipalKeyCredentials -InputObject <IAdIdentity> -Value <IKeyCredential[]>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateExpanded
```
Update-AzADServicePrincipalKeyCredentials -ObjectId <String> -TenantId <String> -Value <IKeyCredential[]>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
