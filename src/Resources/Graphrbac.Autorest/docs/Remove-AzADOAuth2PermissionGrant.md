...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/remove-azadoauth2permissiongrant
schema: 2.0.0
---

# Remove-AzADOAuth2PermissionGrant
...
### Delete (Default)
```
Remove-AzADOAuth2PermissionGrant -ObjectId <String> -TenantId <String> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzADOAuth2PermissionGrant -InputObject <IAdIdentity> [-DefaultProfile <PSObject>] [-PassThru]
