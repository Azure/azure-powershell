...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/get-azadapplication
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzADApplication -InputObject <IAdIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
