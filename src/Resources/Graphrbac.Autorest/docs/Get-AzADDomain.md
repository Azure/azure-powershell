...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/get-azaddomain
schema: 2.0.0
---
...
### List (Default)
```
Get-AzADDomain -TenantId <String> [-Filter <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzADDomain -Name <String> -TenantId <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzADDomain -InputObject <IAdIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
