...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/get-azadgroupmember
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzADGroupMember -InputObject <IAdIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
