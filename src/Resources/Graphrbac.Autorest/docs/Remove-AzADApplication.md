...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/remove-azadapplication
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzADApplication -InputObject <IAdIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
