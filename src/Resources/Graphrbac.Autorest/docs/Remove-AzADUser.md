...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/remove-azaduser
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzADUser -InputObject <IAdIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
