...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/get-azadgroupmembernext
schema: 2.0.0
---

# Get-AzADGroupMemberNext
...
### Get (Default)
```
Get-AzADGroupMemberNext -NextLink <String> -TenantId <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzADGroupMemberNext -InputObject <IAdIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
