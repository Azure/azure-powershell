...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/add-azadserviceprincipalowner
schema: 2.0.0
---

# Add-AzADServicePrincipalOwner
...
### AddExpanded (Default)
```
Add-AzADServicePrincipalOwner -ObjectId <String> -TenantId <String> -Url <String>
...
### Add
```
Add-AzADServicePrincipalOwner -ObjectId <String> -TenantId <String> -Parameter <IAddOwnerParameters>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AddViaIdentity
```
Add-AzADServicePrincipalOwner -InputObject <IAdIdentity> -Parameter <IAddOwnerParameters>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AddViaIdentityExpanded
```
Add-AzADServicePrincipalOwner -InputObject <IAdIdentity> -Url <String> [-AdditionalProperties <Hashtable>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
