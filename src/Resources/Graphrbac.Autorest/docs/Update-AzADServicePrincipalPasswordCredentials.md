...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/update-azadserviceprincipalpasswordcredentials
schema: 2.0.0
---
...
```
Update-AzADServicePrincipalPasswordCredentials -InputObject <IAdIdentity> -Value <IPasswordCredential[]>
...
Update-AzADServicePrincipalPasswordCredentials -ObjectId <String> -TenantId <String>
 -Value <IPasswordCredential[]> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
