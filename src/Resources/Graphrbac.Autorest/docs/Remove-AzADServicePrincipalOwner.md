...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/remove-azadserviceprincipalowner
schema: 2.0.0
---

# Remove-AzADServicePrincipalOwner
...
### Remove (Default)
```
Remove-AzADServicePrincipalOwner -ObjectId <String> -OwnerObjectId <String> -TenantId <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-AzADServicePrincipalOwner -InputObject <IAdIdentity> [-DefaultProfile <PSObject>] [-PassThru]
