...
external help file:
Module Name: Az.AD
online version: https://docs.microsoft.com/en-us/powershell/module/az.ad/get-azadobject
schema: 2.0.0
---
...
### Get1
```
Get-AzADObject -NextLink <String> -TenantId <String> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzADObject -InputObject <IAdIdentity> -Parameter <IGetObjectsParameters> [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-AzADObject -InputObject <IAdIdentity> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### GetViaIdentityExpanded
```
Get-AzADObject -InputObject <IAdIdentity> [-AdditionalProperties <Hashtable>]
...
Parameter Sets: GetViaIdentity, GetViaIdentity1, GetViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IGetObjectsParameters
...
```yaml
Type: System.String
Parameter Sets: Get, Get1, GetExpanded
Aliases:
