namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16
{
    ...
    public partial class ApplicationBase
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonObject into a new instance of <see cref="ApplicationBase" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ApplicationBase(Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonObject json)
        {
            ...
            {_knownClientApplication = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonArray>("knownClientApplications"), out var __jsonKnownClientApplications) ? If( __jsonKnownClientApplications as Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__g, (__f)=>(string) (__f is Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonString __e ? (string)(__e.ToString()) : null)) ))() : null : KnownClientApplication;}
            ...
            {_oauth2Permission = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonArray>("oauth2Permissions"), out var __jsonOauth2Permissions) ? If( __jsonOauth2Permissions as Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonArray, out var __b) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IOAuth2Permission[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__b, (__a)=>(Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IOAuth2Permission) (Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.OAuth2Permission.FromJson(__a) )) ))() : null : Oauth2Permission;}
            ...
            {_orgRestriction = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonArray>("orgRestrictions"), out var __jsonOrgRestrictions) ? If( __jsonOrgRestrictions as Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonArray, out var ___w) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(___w, (___v)=>(string) (___v is Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonString ___u ? (string)(___u.ToString()) : null)) ))() : null : OrgRestriction;}
            {_passwordCredentials = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonArray>("passwordCredentials"), out var __jsonPasswordCredentials) ? If( __jsonPasswordCredentials as Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonArray, out var ___r) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IPasswordCredential[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(___r, (___q)=>(Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IPasswordCredential) (Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.PasswordCredential.FromJson(___q) )) ))() : null : PasswordCredentials;}
            {_preAuthorizedApplication = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonArray>("preAuthorizedApplications"), out var __jsonPreAuthorizedApplications) ? If( __jsonPreAuthorizedApplications as Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonArray, out var ___m) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IPreAuthorizedApplication[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(___m, (___l)=>(Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IPreAuthorizedApplication) (Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.PreAuthorizedApplication.FromJson(___l) )) ))() : null : PreAuthorizedApplication;}
            ...
            {_replyUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonArray>("replyUrls"), out var __jsonReplyUrls) ? If( __jsonReplyUrls as Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonArray, out var ___h) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(___h, (___g)=>(string) (___g is Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonString ___f ? (string)(___f.ToString()) : null)) ))() : null : ReplyUrl;}
            {_requiredResourceAccess = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonArray>("requiredResourceAccess"), out var __jsonRequiredResourceAccess) ? If( __jsonRequiredResourceAccess as Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonArray, out var ___c) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IRequiredResourceAccess[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(___c, (___b)=>(Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IRequiredResourceAccess) (Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.RequiredResourceAccess.FromJson(___b) )) ))() : null : RequiredResourceAccess;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IApplicationBase.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IApplicationBase.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IApplicationBase FromJson(Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonObject json ? new ApplicationBase(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ApplicationBase" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ApplicationBase" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.SerializationMode serializationMode)
        {
            ...
            if (null != this._knownClientApplication)
            {
                ...
                foreach( var __i in this._knownClientApplication )
                {
                    AddIf(null != (((object)__i)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonString(__i.ToString()) : null ,__h.Add);
                }
                container.Add("knownClientApplications",__h);
            }
            ...
            if (null != this._oauth2Permission)
            {
                ...
                foreach( var __d in this._oauth2Permission )
                {
                    AddIf(__d?.ToJson(null, serializationMode) ,__c.Add);
                }
                container.Add("oauth2Permissions",__c);
            }
            ...
            if (null != this._orgRestriction)
            {
                ...
                foreach( var ___y in this._orgRestriction )
                {
                ...
                container.Add("orgRestrictions",___x);
            }
            ...
            if (null != this._preAuthorizedApplication)
            {
                ...
                foreach( var ___o in this._preAuthorizedApplication )
                {
                    AddIf(___o?.ToJson(null, serializationMode) ,___n.Add);
                }
                container.Add("preAuthorizedApplications",___n);
            }
            ...
            if (null != this._replyUrl)
            {
                ...
                foreach( var ___j in this._replyUrl )
                {
                    AddIf(null != (((object)___j)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.JsonString(___j.ToString()) : null ,___i.Add);
                }
                container.Add("replyUrls",___i);
            }
            if (null != this._requiredResourceAccess)
            {
                var ___d = new Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Json.XNodeArray();
                foreach( var ___e in this._requiredResourceAccess )
                {
                    AddIf(___e?.ToJson(null, serializationMode) ,___d.Add);
                }
                container.Add("requiredResourceAccess",___d);
            }
