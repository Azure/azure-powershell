...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzADApplicationOwner_Remove", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzADApplicationOwner_Remove : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        /// <summary>The object ID of the application from which to remove the owner.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The object ID of the application from which to remove the owner.")]
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ApplicationsRemoveOwner(ApplicationObjectId, OwnerObjectId, TenantId, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ApplicationObjectId=ApplicationObjectId,OwnerObjectId=OwnerObjectId,TenantId=TenantId})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzADApplicationOwner_Remove" /> cmdlet class.
        /// </summary>
        public RemoveAzADApplicationOwner_Remove()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IGraphError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ApplicationObjectId=ApplicationObjectId, OwnerObjectId=OwnerObjectId, TenantId=TenantId })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ApplicationObjectId=ApplicationObjectId, OwnerObjectId=OwnerObjectId, TenantId=TenantId })
                    {
