...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Applications_ListNext=>GET:"/{tenantID}/{nextLink}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzADApplicationNext_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IApplication))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Description(@"Gets a list of applications from the current tenant.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Generated]
    public partial class GetAzADApplicationNext_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzADApplicationNext_List" /> cmdlet class.
        /// </summary>
        public GetAzADApplicationNext_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ApplicationsListNext(NextLink, TenantId, onOk, onDefault, this, Pipeline);
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.OdataNextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.ApplicationsListNext_Call(requestMessage, onOk, onDefault, this, Pipeline);
                    }
                }
            }
        }
