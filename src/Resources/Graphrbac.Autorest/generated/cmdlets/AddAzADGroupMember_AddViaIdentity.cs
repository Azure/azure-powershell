...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Groups_AddMember=>POST:"/{tenantID}/groups/{groupObjectId}/$links/members"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Add, @"AzADGroupMember_AddViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Description(@"Add a member to a group.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Generated]
    public partial class AddAzADGroupMember_AddViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IGroupAddMemberParameters _parameter;

        /// <summary>Request parameters for adding a member to a group.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Request parameters for adding a member to a group.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Request parameters for adding a member to a group.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IGroupAddMemberParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IGroupAddMemberParameters Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="AddAzADGroupMember_AddViaIdentity" /> cmdlet class.
        /// </summary>
        public AddAzADGroupMember_AddViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'GroupsAddMember' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.GroupsAddMemberViaIdentity(InputObject.Id, Parameter, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == InputObject.GroupObjectId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.GroupObjectId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        ...
                        await this.Client.GroupsAddMember(InputObject.GroupObjectId ?? null, InputObject.TenantId ?? null, Parameter, onNoContent, onDefault, this, Pipeline);
                    }
