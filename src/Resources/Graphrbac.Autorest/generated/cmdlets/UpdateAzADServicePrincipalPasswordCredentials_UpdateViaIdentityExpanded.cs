...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ServicePrincipals_UpdatePasswordCredentials=>PATCH:"/{tenantID}/servicePrincipals/{objectId}/passwordCredentials"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzADServicePrincipalPasswordCredentials_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Description(@"Updates the passwordCredentials associated with a service principal.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Generated]
    public partial class UpdateAzADServicePrincipalPasswordCredentials_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IPasswordCredentialsUpdateParameters _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.PasswordCredentialsUpdateParameters();

        /// <summary>Request parameters for a PasswordCredentials update operation.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IPasswordCredentialsUpdateParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "A collection of PasswordCredentials.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IPasswordCredential[] Value { get => ParametersBody.Value ?? null /* arrayOf */; set => ParametersBody.Value = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ServicePrincipalsUpdatePasswordCredentials' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServicePrincipalsUpdatePasswordCredentialsViaIdentity(InputObject.Id, ParametersBody, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == InputObject.ObjectId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.ObjectId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        ...
                        await this.Client.ServicePrincipalsUpdatePasswordCredentials(InputObject.ObjectId ?? null, InputObject.TenantId ?? null, ParametersBody, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzADServicePrincipalPasswordCredentials_UpdateViaIdentityExpanded" />
        /// cmdlet class.
        /// </summary>
        public UpdateAzADServicePrincipalPasswordCredentials_UpdateViaIdentityExpanded()
        {
