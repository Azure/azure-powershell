...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Groups_GetGroupMembers=>GET:"/{tenantID}/groups/{objectId}/members"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzADGroupMember_Get")]
    ...
    public partial class GetAzADGroupMember_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The object ID of the group whose members should be retrieved.")]
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzADGroupMember_Get" /> cmdlet class.
        /// </summary>
        public GetAzADGroupMember_Get()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GroupsGetGroupMembers(ObjectId, TenantId, onOk, onDefault, this, Pipeline);
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.OdataNextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.GroupsGetGroupMembers_Call(requestMessage, onOk, onDefault, this, Pipeline);
                    }
                }
            }
        }
