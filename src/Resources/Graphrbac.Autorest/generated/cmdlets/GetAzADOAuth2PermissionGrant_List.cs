...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] OAuth2PermissionGrant_List=>GET:"/{tenantID}/oauth2PermissionGrants"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzADOAuth2PermissionGrant_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Description(@"Queries OAuth2 permissions grants for the relevant SP ObjectId of an app.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Generated]
    public partial class GetAzADOAuth2PermissionGrant_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        /// <summary>This is the Service Principal ObjectId associated with the app</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "This is the Service Principal ObjectId associated with the app")]
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzADOAuth2PermissionGrant_List" /> cmdlet class.
        /// </summary>
        public GetAzADOAuth2PermissionGrant_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.OAuth2PermissionGrantList(this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, TenantId, onOk, this, Pipeline);
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.OdataNextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.OAuth2PermissionGrantList_Call(requestMessage, onOk, this, Pipeline);
                    }
                }
            }
        }
