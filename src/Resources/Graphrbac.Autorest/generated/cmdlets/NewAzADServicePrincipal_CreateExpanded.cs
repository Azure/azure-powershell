...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ServicePrincipals_Create=>POST:"/{tenantID}/servicePrincipals"
    /// </remarks>
    ...
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IServicePrincipal))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Description(@"Creates a service principal in the directory.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "whether or not the service principal account is enabled")]
        ...
        public global::System.Management.Automation.SwitchParameter AccountEnabled { get => ParametersBody.AccountEnabled ?? default(global::System.Management.Automation.SwitchParameter); set => ParametersBody.AccountEnabled = value; }

        /// <summary>The application ID.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The application ID.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AD.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// to the application.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Specifies whether an AppRoleAssignment to a user or group is required before Azure AD will issue a user or access token to the application.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AD.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter AppRoleAssignmentRequired { get => ParametersBody.AppRoleAssignmentRequired ?? default(global::System.Management.Automation.SwitchParameter); set => ParametersBody.AppRoleAssignmentRequired = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The collection of key credentials associated with the service principal.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AD.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IServicePrincipalCreateParameters _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.ServicePrincipalCreateParameters();

        /// <summary>Request parameters for creating a new service principal.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IServicePrincipalCreateParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }

        /// <summary>The collection of password credentials associated with the service principal.</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The collection of password credentials associated with the service principal.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AD.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "the type of the service principal")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AD.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ServicePrincipalType { get => ParametersBody.ServicePrincipalType ?? null; set => ParametersBody.ServicePrincipalType = value; }

        /// <summary>
        /// Optional list of tags that you can apply to your service principals. Not nullable.
        /// </summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Optional list of tags that you can apply to your service principals. Not nullable.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AD.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(string) })]
        public string[] Tag { get => ParametersBody.Tag ?? null /* arrayOf */; set => ParametersBody.Tag = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IServicePrincipal"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IServicePrincipal> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ServicePrincipalsCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ServicePrincipalsCreate(TenantId, ParametersBody, onCreated, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IServicePrincipal> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IServicePrincipal
