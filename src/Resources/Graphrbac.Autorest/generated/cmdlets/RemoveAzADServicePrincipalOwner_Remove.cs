...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ServicePrincipals_RemoveOwner=>DELETE:"/{tenantID}/servicePrincipals/{objectId}/$links/owners/{ownerObjectId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzADServicePrincipalOwner_Remove", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzADServicePrincipalOwner_Remove : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        /// <summary>The object ID of the service principal from which to remove the owner.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The object ID of the service principal from which to remove the owner.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ServicePrincipalsRemoveOwner' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ServicePrincipalsRemoveOwner(ObjectId, OwnerObjectId, TenantId, onNoContent, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzADServicePrincipalOwner_Remove" /> cmdlet class.
        /// </summary>
        public RemoveAzADServicePrincipalOwner_Remove()
        {
