...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Objects_GetObjectsByObjectIds=>POST:"/{tenantID}/getObjectsByObjectIds"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzADObject_GetViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IDirectoryObject))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Description(@"Gets the directory objects specified in a list of object IDs. You can also specify which resource collections (users, groups, etc.) should be searched by specifying the optional types parameter.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Generated]
    public partial class GetAzADObject_GetViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "If true, also searches for object IDs in the partner tenant.")]
        ...
        public global::System.Management.Automation.SwitchParameter IncludeDirectoryObjectReference { get => ParametersBody.IncludeDirectoryObjectReference ?? default(global::System.Management.Automation.SwitchParameter); set => ParametersBody.IncludeDirectoryObjectReference = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The requested object IDs.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AD.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string[] ObjectId { get => ParametersBody.ObjectId ?? null /* arrayOf */; set => ParametersBody.ObjectId = value; }

        /// <summary>Backing field for <see cref="ParametersBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IGetObjectsParameters _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.GetObjectsParameters();

        /// <summary>Request parameters for the GetObjectsByObjectIds API.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IGetObjectsParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The requested object types.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AD.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] Type { get => ParametersBody.Type ?? null /* arrayOf */; set => ParametersBody.Type = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IDirectoryObjectListResult"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IDirectoryObjectListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzADObject_GetViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public GetAzADObject_GetViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ObjectsGetObjectsByObjectIds' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ObjectsGetObjectsByObjectIdsViaIdentity(InputObject.Id, ParametersBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ObjectsGetObjectsByObjectIds(InputObject.TenantId ?? null, ParametersBody, onOk, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IDirectoryObjectListResult> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if (result.OdataNextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.ObjectsGetObjectsByObjectIds_Call(requestMessage, onOk, this, Pipeline);
                    }
                }
            }
        }
