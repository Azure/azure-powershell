...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Objects_GetObjectsByObjectIdsNext=>POST:"/{tenantID}/{nextLink}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzADObject_GetViaIdentity1", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Description(@"Gets AD group membership for the specified AD object IDs.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Generated]
    public partial class GetAzADObject_GetViaIdentity1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzADObject_GetViaIdentity1" /> cmdlet class.
        /// </summary>
        public GetAzADObject_GetViaIdentity1()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ObjectsGetObjectsByObjectIdsNext' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ObjectsGetObjectsByObjectIdsNextViaIdentity(InputObject.Id, onOk, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == InputObject.NextLink)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.NextLink"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        ...
                        await this.Client.ObjectsGetObjectsByObjectIdsNext(InputObject.NextLink ?? null, InputObject.TenantId ?? null, onOk, this, Pipeline);
                    }
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.OdataNextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.ObjectsGetObjectsByObjectIdsNext_Call(requestMessage, onOk, this, Pipeline);
                    }
                }
            }
        }
