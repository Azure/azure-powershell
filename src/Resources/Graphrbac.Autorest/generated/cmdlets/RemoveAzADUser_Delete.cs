...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        /// <summary>The object ID or principal name of the user to delete.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The object ID or principal name of the user to delete.")]
        [Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UsersDelete(UpnOrObjectId, TenantId, onNoContent, onDefault, this, Pipeline);
