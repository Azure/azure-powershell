...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Add, @"AzADServicePrincipalOwner_AddViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class AddAzADServicePrincipalOwner_AddViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IAddOwnerParameters _parameter;

        /// <summary>Request parameters for adding a owner to an application.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Request parameters for adding a owner to an application.", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IAddOwnerParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IAddOwnerParameters Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="AddAzADServicePrincipalOwner_AddViaIdentity" /> cmdlet class.
        /// </summary>
        public AddAzADServicePrincipalOwner_AddViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServicePrincipalsAddOwnerViaIdentity(InputObject.Id, Parameter, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServicePrincipalsAddOwner(InputObject.ObjectId ?? null, InputObject.TenantId ?? null, Parameter, onNoContent, onDefault, this, Pipeline);
                    }
