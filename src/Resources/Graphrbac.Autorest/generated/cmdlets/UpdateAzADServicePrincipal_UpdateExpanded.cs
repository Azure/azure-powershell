...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ServicePrincipals_Update=>PATCH:"/{tenantID}/servicePrincipals/{objectId}"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Description(@"Updates a service principal in the directory.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        /// <summary>The object ID of the service principal to delete.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The object ID of the service principal to delete.")]
        [Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IServicePrincipalUpdateParameters _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.ServicePrincipalUpdateParameters();

        /// <summary>Request parameters for update an existing service principal.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IServicePrincipalUpdateParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ServicePrincipalsUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ServicePrincipalsUpdate(ObjectId, TenantId, ParametersBody, onNoContent, onDefault, this, Pipeline);
