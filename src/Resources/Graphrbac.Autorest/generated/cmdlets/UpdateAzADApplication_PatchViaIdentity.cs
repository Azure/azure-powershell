...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzADApplication_PatchViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzADApplication_PatchViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IApplicationUpdateParameters _parameter;

        /// <summary>Request parameters for updating a new application.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Request parameters for updating a new application.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Request parameters for updating a new application.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IApplicationUpdateParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IApplicationUpdateParameters Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ApplicationsPatchViaIdentity(InputObject.Id, Parameter, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ApplicationsPatch(InputObject.ApplicationObjectId ?? null, InputObject.TenantId ?? null, Parameter, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzADApplication_PatchViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzADApplication_PatchViaIdentity()
        {
