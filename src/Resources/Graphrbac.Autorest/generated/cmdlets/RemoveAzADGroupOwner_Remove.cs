...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Groups_RemoveOwner=>DELETE:"/{tenantID}/groups/{objectId}/$links/owners/{ownerObjectId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzADGroupOwner_Remove", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzADGroupOwner_Remove : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        /// <summary>The object ID of the group from which to remove the owner.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The object ID of the group from which to remove the owner.")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Owner object id")]
        [Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'GroupsRemoveOwner' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GroupsRemoveOwner(ObjectId, OwnerObjectId, TenantId, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ObjectId=ObjectId,OwnerObjectId=OwnerObjectId,TenantId=TenantId})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzADGroupOwner_Remove" /> cmdlet class.
        /// </summary>
        public RemoveAzADGroupOwner_Remove()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.IGraphError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ObjectId=ObjectId, OwnerObjectId=OwnerObjectId, TenantId=TenantId })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ObjectId=ObjectId, OwnerObjectId=OwnerObjectId, TenantId=TenantId })
                    {
