...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzADGroupMember_IsViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class TestAzADGroupMember_IsViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The object ID of the group to check.")]
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The object ID of the contact, group, user, or service principal to check for membership in the specified group.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AD.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string MemberId { get => ParametersBody.MemberId ?? null; set => ParametersBody.MemberId = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.ICheckGroupMembershipParameters _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.CheckGroupMembershipParameters();

        /// <summary>Request parameters for IsMemberOf API call.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AD.Models.Api16.ICheckGroupMembershipParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.GroupsIsMemberOfViaIdentity(InputObject.Id, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.GroupsIsMemberOf(InputObject.TenantId ?? null, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzADGroupMember_IsViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public TestAzADGroupMember_IsViaIdentityExpanded()
        {
