...
namespace Microsoft.Azure.PowerShell.Cmdlets.AD.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Groups_Delete=>DELETE:"/{tenantID}/groups/{objectId}"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AD.Description(@"Delete a group from the directory.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AD.Runtime.IEventListener
    {
        ...
        /// <summary>The object ID of the group to delete.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The object ID of the group to delete.")]
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GroupsDelete(ObjectId, TenantId, onNoContent, onDefault, this, Pipeline);
