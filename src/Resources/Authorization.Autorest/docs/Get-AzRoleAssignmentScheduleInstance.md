...
Returns all `roleAssignmentScheduleInstances` for the `scope`.
...
Returns all `roleAssignmentScheduleInstances` for the `scope` which are assigned to the calling user.
