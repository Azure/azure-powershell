...
# Changes may cause incorrect behavior and will be lost if the code is regenerated.
  ...
  $null = Import-Module -Name (Join-Path $PSScriptRoot './bin/Az.Resources.Authorization.private.dll')
  ...
  $customModulePath = Join-Path $PSScriptRoot 'custom/Authorization.custom.psm1'
