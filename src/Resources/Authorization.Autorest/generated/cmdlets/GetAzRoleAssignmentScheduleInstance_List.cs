...
namespace Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListForScope=>GET:"/{scope}/providers/Microsoft.Authorization/roleAssignmentScheduleInstances"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRoleAssignmentScheduleInstance_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Description(@"Gets role assignment schedule instances of a role assignment schedule.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.HttpPath(Path = "/{scope}/providers/Microsoft.Authorization/roleAssignmentScheduleInstances", ApiVersion = "2020-10-01-preview")]
    public partial class GetAzRoleAssignmentScheduleInstance_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Runtime.IEventListener
    {
        ...
        /// principal. Use $filter=assignedTo('{userId}') to return all role assignment schedule instances for the user. Use $filter=asTarget()
        /// to return all role assignment schedule instances created for the current user.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The filter to apply on the operation. Use $filter=atScope() to return all role assignment schedules at or above the scope. Use $filter=principalId eq {id} to return all role assignment schedules at, above or below the scope for the specified principal. Use $filter=assignedTo('{userId}') to return all role assignment schedule instances for the user. Use $filter=asTarget() to return all role assignment schedule instances created for the current user.")]
        ...
        /// <summary>The scope of the role assignment schedule.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The scope of the role assignment schedule.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRoleAssignmentScheduleInstance_List" /> cmdlet class.
        /// </summary>
        public GetAzRoleAssignmentScheduleInstance_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RoleAssignmentScheduleInstancesListForScope(Scope, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Models.Api20201001Preview.IRoleAssignmentScheduleInstanceListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.RoleAssignmentScheduleInstancesListForScope_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
