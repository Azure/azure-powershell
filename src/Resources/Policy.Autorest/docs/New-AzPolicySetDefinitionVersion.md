...
```
New-AzPolicySetDefinitionVersion -Name <String> -PolicyDefinition <String> -Version <String>
...
### ManagementGroupName
```
New-AzPolicySetDefinitionVersion -ManagementGroupName <String> -Name <String> -PolicyDefinition <String>
 -Version <String> [-Description <String>] [-DisplayName <String>] [-Metadata <String>] [-Parameter <String>]
 [-PolicyDefinitionGroup <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SubscriptionId
```
New-AzPolicySetDefinitionVersion -Name <String> -SubscriptionId <String> -PolicyDefinition <String>
 -Version <String> [-Description <String>] [-DisplayName <String>] [-Metadata <String>] [-Parameter <String>]
 [-PolicyDefinitionGroup <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
