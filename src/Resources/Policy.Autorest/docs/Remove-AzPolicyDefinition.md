...
### Delete1
```
Remove-AzPolicyDefinition -Name <String> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzPolicyDefinition -InputObject <IPolicyIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
...
Parameter Sets: Id, InputObject, ManagementGroupName, Name, SubscriptionId
Aliases:
...
Parameter Sets: DeleteViaIdentity, DeleteViaIdentity1, InputObject
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Delete, Delete1, ManagementGroupName, Name, SubscriptionId
...
```yaml
Type: System.String
Parameter Sets: Delete, SubscriptionId
Aliases:
