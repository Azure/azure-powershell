...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Support
{
        ...
        System.IEquatable<ResourceIdentityType>
    {
        ...
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Policy.Support.ResourceIdentityType None = @"None";

        /// <summary>Indicates that a system assigned identity is associated with the resource.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Policy.Support.ResourceIdentityType SystemAssigned = @"SystemAssigned";

        /// <summary>Indicates that a system assigned identity is associated with the resource.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Policy.Support.ResourceIdentityType UserAssigned = @"UserAssigned";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Policy.Support.ResourceIdentityType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Policy.Support.ResourceIdentityType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Policy.Support.ResourceIdentityType e1, Microsoft.Azure.PowerShell.Cmdlets.Policy.Support.ResourceIdentityType e2)
        {
            return !e2.Equals(e1);
        }
