...
namespace Sample.API.Support
{
    ...
    {
        public static Sample.API.Support.PolicyType BuiltIn = @"BuiltIn";

        public static Sample.API.Support.PolicyType Custom = @"Custom";

        public static Sample.API.Support.PolicyType NotSpecified = @"NotSpecified";

        public static Sample.API.Support.PolicyType Static = @"Static";
        ...
        public bool Equals(Sample.API.Support.PolicyType e)
        {
        ...
        public static implicit operator string(Sample.API.Support.PolicyType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Sample.API.Support.PolicyType e1, Sample.API.Support.PolicyType e2)
        {
            return !e2.Equals(e1);
        }
