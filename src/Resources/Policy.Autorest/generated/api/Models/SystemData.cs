...
namespace Sample.API.Models
{
        ...
        Sample.API.Models.ISystemDataInternal
    {
        ...
        private Sample.API.Support.CreatedByType? _createdByType;

        /// <summary>The type of identity that created the resource.</summary>
        [Sample.API.Origin(Sample.API.PropertyOrigin.Owned)]
        public Sample.API.Support.CreatedByType? CreatedByType { get => this._createdByType; set => this._createdByType = value; }
        ...
        private Sample.API.Support.CreatedByType? _lastModifiedByType;

        /// <summary>The type of identity that last modified the resource.</summary>
        [Sample.API.Origin(Sample.API.PropertyOrigin.Owned)]
        public Sample.API.Support.CreatedByType? LastModifiedByType { get => this._lastModifiedByType; set => this._lastModifiedByType = value; }
        ...
        Sample.API.Runtime.IJsonSerializable
    {
        ...
        Sample.API.Support.CreatedByType? CreatedByType { get; set; }
        /// <summary>The timestamp of resource last modification (UTC)</summary>
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Sample.API.Support.CreatedByType) })]
        Sample.API.Support.CreatedByType? LastModifiedByType { get; set; }
