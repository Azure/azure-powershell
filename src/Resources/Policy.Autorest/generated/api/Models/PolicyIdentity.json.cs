...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Models
{
    ...
    public partial class PolicyIdentity
    {
        ...
        internal PolicyIdentity(Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonObject json)
        {
            ...
            {_policyDefinitionName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString>("policyDefinitionName"), out var __jsonPolicyDefinitionName) ? (string)__jsonPolicyDefinitionName : (string)PolicyDefinitionName;}
            {_subscriptionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString>("subscriptionId"), out var __jsonSubscriptionId) ? (string)__jsonSubscriptionId : (string)SubscriptionId;}
            {_managementGroupId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString>("managementGroupId"), out var __jsonManagementGroupId) ? (string)__jsonManagementGroupId : (string)ManagementGroupId;}
            {_policySetDefinitionName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString>("policySetDefinitionName"), out var __jsonPolicySetDefinitionName) ? (string)__jsonPolicySetDefinitionName : (string)PolicySetDefinitionName;}
            ...
            {_policyAssignmentName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString>("policyAssignmentName"), out var __jsonPolicyAssignmentName) ? (string)__jsonPolicyAssignmentName : (string)PolicyAssignmentName;}
            {_resourceGroupName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString>("resourceGroupName"), out var __jsonResourceGroupName) ? (string)__jsonResourceGroupName : (string)ResourceGroupName;}
            {_resourceProviderNamespace = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString>("resourceProviderNamespace"), out var __jsonResourceProviderNamespace) ? (string)__jsonResourceProviderNamespace : (string)ResourceProviderNamespace;}
            {_parentResourcePath = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString>("parentResourcePath"), out var __jsonParentResourcePath) ? (string)__jsonParentResourcePath : (string)ParentResourcePath;}
            {_resourceType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString>("resourceType"), out var __jsonResourceType) ? (string)__jsonResourceType : (string)ResourceType;}
            {_resourceName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString>("resourceName"), out var __jsonResourceName) ? (string)__jsonResourceName : (string)ResourceName;}
            {_policyAssignmentId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString>("policyAssignmentId"), out var __jsonPolicyAssignmentId) ? (string)__jsonPolicyAssignmentId : (string)PolicyAssignmentId;}
            {_policyExemptionName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString>("policyExemptionName"), out var __jsonPolicyExemptionName) ? (string)__jsonPolicyExemptionName : (string)PolicyExemptionName;}
