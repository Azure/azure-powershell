...
namespace Sample.API.Models
{
    ...
    public partial class PolicyAssignment
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Sample.API.Runtime.Json.JsonNode"/> into an instance of Sample.API.Models.IPolicyAssignment.
        /// </summary>
        /// <param name="node">a <see cref="Sample.API.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IPolicyAssignment.</returns>
        public static Sample.API.Models.IPolicyAssignment FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new PolicyAssignment(json) : null;
        }

        /// <summary>
        /// Deserializes a Sample.API.Runtime.Json.JsonObject into a new instance of <see cref="PolicyAssignment" />.
        /// </summary>
        /// <param name="json">A Sample.API.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PolicyAssignment(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_properties = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Sample.API.Models.PolicyAssignmentProperties.FromJson(__jsonProperties) : Properties;}
            {_identity = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("identity"), out var __jsonIdentity) ? Sample.API.Models.Identity.FromJson(__jsonIdentity) : Identity;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="PolicyAssignment" /> into a <see cref="Sample.API.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Sample.API.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Sample.API.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="PolicyAssignment" /> as a <see cref="Sample.API.Runtime.Json.JsonNode" />.
        /// </returns>
