...
namespace Sample.API.Models
{
    ...
    public partial class PolicySetDefinition
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Sample.API.Runtime.Json.JsonNode"/> into an instance of Sample.API.Models.IPolicySetDefinition.
        /// </summary>
        /// <param name="node">a <see cref="Sample.API.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IPolicySetDefinition.</returns>
        public static Sample.API.Models.IPolicySetDefinition FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new PolicySetDefinition(json) : null;
        }

        /// <summary>
        /// Deserializes a Sample.API.Runtime.Json.JsonObject into a new instance of <see cref="PolicySetDefinition" />.
        /// </summary>
        /// <param name="json">A Sample.API.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PolicySetDefinition(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_properties = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Sample.API.Models.PolicySetDefinitionProperties.FromJson(__jsonProperties) : Properties;}
            {_systemData = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("systemData"), out var __jsonSystemData) ? Sample.API.Models.SystemData.FromJson(__jsonSystemData) : SystemData;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="PolicySetDefinition" /> into a <see cref="Sample.API.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Sample.API.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Sample.API.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="PolicySetDefinition" /> as a <see cref="Sample.API.Runtime.Json.JsonNode" />.
        /// </returns>
        public Sample.API.Runtime.Json.JsonNode ToJson(Sample.API.Runtime.Json.JsonObject container, Sample.API.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != this._systemData ? (Sample.API.Runtime.Json.JsonNode) this._systemData.ToJson(null,serializationMode) : null, "systemData" ,container.Add );
            }
            if (serializationMode.HasFlag(Sample.API.Runtime.SerializationMode.IncludeReadOnly))
            {
