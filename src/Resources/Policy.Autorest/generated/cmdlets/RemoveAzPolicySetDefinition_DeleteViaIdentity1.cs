...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IEventListener
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.PolicySetDefinitionsDeleteAtManagementGroup(InputObject.PolicySetDefinitionName ?? null, InputObject.ManagementGroupId ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzPolicySetDefinition_DeleteViaIdentity1" /> cmdlet class.
        /// </summary>
