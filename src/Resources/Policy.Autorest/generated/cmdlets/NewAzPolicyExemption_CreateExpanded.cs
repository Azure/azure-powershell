...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyExemption _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.PolicyExemption();
        ...
        public string ExemptionCategory { get => _parametersBody.ExemptionCategory ?? null; set => _parametersBody.ExemptionCategory = value; }
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.DoNotExport]
        public Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyExemptionPropertiesMetadata MetadataTable { get => _parametersBody.Metadata ?? null /* object */; set => _parametersBody.Metadata = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The ID of the policy assignment that is being exempted.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Policy.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] PolicyDefinitionReferenceId { get => _parametersBody.PolicyDefinitionReferenceId?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.PolicyDefinitionReferenceId = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzPolicyExemption_CreateExpanded" /> cmdlet class.
        /// </summary>
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("PolicyAssignmentId"))
                {
                    PolicyAssignmentId = (string)this.MyInvocation.BoundParameters["PolicyAssignmentId"];
                }
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("ExpiresOnInternal"))
                {
                    ExpiresOnInternal = (global::System.DateTime)this.MyInvocation.BoundParameters["ExpiresOnInternal"];
                }
                ...
                try
                {
                    ...
                    await this.Client.PolicyExemptionsCreateOrUpdate(Scope, Name, _parametersBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.SerializationMode.IncludeCreate);
