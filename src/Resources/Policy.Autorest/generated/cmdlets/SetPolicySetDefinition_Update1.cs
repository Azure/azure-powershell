...
namespace Sample.API.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"PolicySetDefinition_Update1", SupportsShouldProcess = true)]
    ...
    public partial class SetPolicySetDefinition_Update1 : global::System.Management.Automation.PSCmdlet,
        Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.IPolicySetDefinition _parameters;

        /// <summary>The policy set definition.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The policy set definition.", ValueFromPipeline = true)]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Sample.API.Models.IPolicySetDefinition Parameters { get => this._parameters; set => this._parameters = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PolicySetDefinitionsCreateOrUpdateAtManagementGroup(PolicySetDefinitionName, ManagementGroupId, Parameters, onOk, onCreated, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  PolicySetDefinitionName=PolicySetDefinitionName,ManagementGroupId=ManagementGroupId,body=Parameters})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetPolicySetDefinition_Update1" /> cmdlet class.
        /// </summary>
        public SetPolicySetDefinition_Update1()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { PolicySetDefinitionName=PolicySetDefinitionName, ManagementGroupId=ManagementGroupId, body=Parameters })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { PolicySetDefinitionName=PolicySetDefinitionName, ManagementGroupId=ManagementGroupId, body=Parameters })
                    {
