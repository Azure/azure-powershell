...
namespace Sample.API.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"PolicyAssignment_CreateViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IPolicyAssignment))]
    [global::Sample.API.Description(@" This operation creates or updates a policy assignment with the given scope and name. Policy assignments apply to all resources contained within their scope. For example, when you assign a policy at resource group scope, that policy applies to all resources in the group.")]
    [global::Sample.API.Generated]
    public partial class NewPolicyAssignment_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.IPolicyAssignment _parameters;

        /// <summary>The policy assignment.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The policy assignment.", ValueFromPipeline = true)]
        ...
        public Sample.API.Models.IPolicyAssignment Parameters { get => this._parameters; set => this._parameters = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewPolicyAssignment_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewPolicyAssignment_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (null == InputObject.PolicyAssignmentName)
                    {
                        ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.PolicyAssignmentName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                    }
                    await this.Client.PolicyAssignmentsCreate(InputObject.Scope ?? null, InputObject.PolicyAssignmentName ?? null, Parameters, onCreated, onDefault, this, Pipeline);
