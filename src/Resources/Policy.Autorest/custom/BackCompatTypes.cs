...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Models
{
    ...
    /// <summary>
    /// Pre-migration name for the resource selector (renamed to IResourceSelector). It carries
    /// no members of its own: it is simply the old public name for the current IResourceSelector.
    /// </summary>
