...
if ($isAzure -And 'Properties/AssemblyInfo.cs') {
...
$psd1 = Join-Path $PSScriptRoot './Az.Policy.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.Policy'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: Policy cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.Policy.format.ps1xml'
