...
AUTHENTICATION <IMicrosoftGraphAuthenticationAutoGenerated>: authentication
  ...
  [MicrosoftAuthenticatorMethod <IMicrosoftGraphMicrosoftAuthenticatorAuthenticationMethodAutoGenerated[]>]: 
    ...
    [Device <IMicrosoftGraphDeviceAutoGenerated>]: Represents an Azure Active Directory object. The directoryObject type is the base type for many other directory entity types.
      ...
      [MemberOf <MicrosoftGraphDirectoryObject[]>]: Groups that this device is a member of. Read-only. Nullable. Supports $expand.
        [DeletedDateTime <DateTime?>]: 
      ...
      [RegisteredOwner <MicrosoftGraphDirectoryObject[]>]: The user that cloud joined the device or registered their personal device. The registered owner is set at the time of registration. Currently, there can be only one owner. Read-only. Nullable. Supports $expand.
      [RegisteredUser <MicrosoftGraphDirectoryObject[]>]: Collection of registered users of the device. For cloud joined devices and registered personal devices, registered users are set to the same value as registered owners at the time of registration. Read-only. Nullable. Supports $expand.
      [SystemLabel <String[]>]: List of labels applied to the device by the system.
      [TransitiveMemberOf <MicrosoftGraphDirectoryObject[]>]: Groups that this device is a member of. This operation is transitive. Supports $expand.
...
CALENDAR <IMicrosoftGraphCalendarAutoGenerated>: calendar
  ...
  [CalendarView <IMicrosoftGraphEventAutoGenerated[]>]: The calendar view for the calendar. Navigation property. Read-only.
    ...
    [Calendar <IMicrosoftGraphCalendarAutoGenerated>]: calendar
    [End <IMicrosoftGraphDateTimeZone>]: dateTimeTimeZone
    [Extension <IMicrosoftGraphExtension[]>]: The collection of open extensions defined for the event. Nullable.
...
DRIVE <IMicrosoftGraphDriveAutoGenerated>: drive
  ...
  [CreatedByUser <IMicrosoftGraphUserAutoGenerated>]: Represents an Azure Active Directory user object.
    ...
    [Extension <IMicrosoftGraphExtension[]>]: The collection of open extensions defined for the user. Nullable.
    ...
    [Manager <MicrosoftGraphDirectoryObject>]: Represents an Azure Active Directory object. The directoryObject type is the base type for many other directory entity types.
    ...
    [Todo <IMicrosoftGraphTodoAutoGenerated>]: todo
      ...
      [List <IMicrosoftGraphTodoTaskListAutoGenerated[]>]: The task lists in the users mailbox.
        ...
        [Extension <IMicrosoftGraphExtension[]>]: The collection of open extensions defined for the task list. Nullable.
        ...
        [Task <IMicrosoftGraphTodoTaskAutoGenerated[]>]: The tasks in this task list. Read-only. Nullable.
          ...
          [Extension <IMicrosoftGraphExtension[]>]: The collection of open extensions defined for the task. Nullable.
          [Importance <String>]: 
...
TRANSITIVEMEMBEROF <MicrosoftGraphDirectoryObject[]>: .
  [DeletedDateTime <DateTime?>]: 
.Link
https://docs.microsoft.com/powershell/module/az.resources/update-azmguser
#>
function Update-AzMgUser {
  ...
  param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10.MicrosoftGraphDirectoryObject]
  ...
  begin {
    try {
      ...
      $mapping = @{
        UpdateExpanded = 'Az.Resources.MSGraph.private\Update-AzMgUser_UpdateExpanded';
      }
