...
PASSWORDCREDENTIAL <IMicrosoftGraphPasswordCredential1>: passwordCredential
  ...
  [StartDateTime <DateTime?>]: The date and time at which the password becomes valid. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Optional.
.Link
https://docs.microsoft.com/powershell/module/az.resources/add-azmgserviceprincipalpassword
#>
function Add-AzMgServicePrincipalPassword {
...
begin {
    try {
        ...
        $mapping = @{
            Add = 'Az.Resources.MSGraph.private\Add-AzMgServicePrincipalPassword_Add';
            AddExpanded = 'Az.Resources.MSGraph.private\Add-AzMgServicePrincipalPassword_AddExpanded';
        }
