...
### DefaultSet (Default)
```
New-AzMgUser -DisplayName <String> -MailNickname <String> -Password <SecureString> -UserPrincipalName <String>
...
### CreateExpanded
```
New-AzMgUser [-AboutMe <String>] [-AccountEnabled] [-AgeGroup <String>] [-Birthday <DateTime>]
...
### SimpleSet
```
New-AzMgUser [-ForceChangePasswordNextLogin] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
