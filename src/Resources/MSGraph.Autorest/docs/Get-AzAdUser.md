...
### List (Default)
```
Get-AzAdUser [-ConsistencyLevel <String>] [-Count] [-DefaultProfile <PSObject>] [-Expand <String[]>]
...
```
Get-AzAdUser -DisplayName <String> [-DefaultProfile <PSObject>] [-Expand <String[]>] [-First <UInt64>]
 [-IncludeTotalCount] [-Select <String[]>] [-Skip <UInt64>] [<CommonParameters>]
```

### MailParameterSet
```
Get-AzAdUser -Mail <String> [-DefaultProfile <PSObject>] [-Expand <String[]>] [-First <UInt64>]
 [-IncludeTotalCount] [-Select <String[]>] [-Skip <UInt64>] [<CommonParameters>]
```

### ObjectIdParameterSet
```
Get-AzAdUser -ObjectId <String> [-DefaultProfile <PSObject>] [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### SignedInUser
```
Get-AzAdUser -SignedIn [-DefaultProfile <PSObject>] [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### StartsWithParameterSet
```
Get-AzAdUser -StartsWith <String> [-DefaultProfile <PSObject>] [-Expand <String[]>] [-First <UInt64>]
 [-IncludeTotalCount] [-Select <String[]>] [-Skip <UInt64>] [<CommonParameters>]
```

### UPNParameterSet
```
Get-AzAdUser -UserPrincipalName <String> [-DefaultProfile <PSObject>] [-Expand <String[]>]
