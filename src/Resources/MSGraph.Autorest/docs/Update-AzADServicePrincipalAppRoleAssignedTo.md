...
online version: https://learn.microsoft.com/powershell/module/az.resources/update-azadserviceprincipalapproleassignedto
schema: 2.0.0
---

# Update-AzADServicePrincipalAppRoleAssignedTo
...
```
Update-AzADServicePrincipalAppRoleAssignedTo -AppRoleAssignmentId <String> -ServicePrincipalId <String>
 [-AdditionalProperties <Hashtable>] [-AppRoleId <String>] [-DeletedDateTime <DateTime>]
 [-DisplayName <String>] [-PrincipalId <String>] [-ResourceDisplayName <String>] [-ResourceId <String>]
