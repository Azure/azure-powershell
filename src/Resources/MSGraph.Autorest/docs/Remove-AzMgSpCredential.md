...
online version: https://docs.microsoft.com/powershell/module/az.resources/remove-azmgspcredential
schema: 2.0.0
---

# Remove-AzMgSpCredential
...
```
Remove-AzMgSpCredential -ObjectId <String> [-KeyId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DisplayNameWithKeyIdParameterSet
```
Remove-AzMgSpCredential -DisplayName <String> [-KeyId <String>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ServicePrincipalObjectParameterSet
```
Remove-AzMgSpCredential -ServicePrincipalObject <IMicrosoftGraphServicePrincipal> [-KeyId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SPNWithKeyIdParameterSet
```
Remove-AzMgSpCredential -ServicePrincipalName <String> [-KeyId <String>] [-DefaultProfile <PSObject>]
