...
Update-AzAdUser -UPNOrObjectId <String> [-AgeGroup <String>] [-City <String>] [-CompanyName <String>]
 ...
 [-Surname <String>] [-UsageLocation <String>] [-UserPrincipalName <String>] [-UserType <String>]
...
Update-AzAdUser -InputObject <IMicrosoftGraphUser> [-AgeGroup <String>] [-City <String>]
 ...
 [-UsageLocation <String>] [-UserPrincipalName <String>] [-UserType <String>] [-DefaultProfile <PSObject>]
