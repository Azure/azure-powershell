...
online version: https://docs.microsoft.com/powershell/module/az.resources/new-azmggroup
schema: 2.0.0
---
...
```
New-AzMgGroup -DisplayName <String> -MailNickname <String>
 ...
 [-PreferredLanguage <String>] [-SecurityEnabled] [-SecurityIdentifier <String>]
 [-Setting <IMicrosoftGraphGroupSetting[]>] [-Theme <String>]
...
### Create
```
New-AzMgGroup -Body <IMicrosoftGraphGroup> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10.IMicrosoftGraphGroupSetting[]
Parameter Sets: CreateExpanded
Aliases:
