...
online version: https://docs.microsoft.com/powershell/module/az.resources/update-azmgserviceprincipal
schema: 2.0.0
---

# Update-AzMgServicePrincipal
...
```
Update-AzMgServicePrincipal -ObjectId <String> [-AccountEnabled] [-AddIn <IMicrosoftGraphAddIn[]>]
...
```
Update-AzMgServicePrincipal -InputObject <IMicrosoftGraphServicePrincipal> [-AccountEnabled]
...
```
Update-AzMgServicePrincipal -ApplicationId <Guid> [-AccountEnabled] [-AddIn <IMicrosoftGraphAddIn[]>]
 [-AlternativeName <String[]>] [-AppDescription <String>] [-AppOwnerOrganizationId <String>]
 [-AppRole <IMicrosoftGraphAppRole[]>] [-AppRoleAssignedTo <IMicrosoftGraphAppRoleAssignment[]>]
 [-AppRoleAssignment <IMicrosoftGraphAppRoleAssignment[]>] [-AppRoleAssignmentRequired]
 [-ClaimsMappingPolicy <IMicrosoftGraphClaimsMappingPolicy[]>]
...
```
Update-AzMgServicePrincipal -ServicePrincipalName <String> [-AccountEnabled] [-AddIn <IMicrosoftGraphAddIn[]>]
 [-AlternativeName <String[]>] [-AppDescription <String>] [-AppOwnerOrganizationId <String>]
 [-AppRole <IMicrosoftGraphAppRole[]>] [-AppRoleAssignedTo <IMicrosoftGraphAppRoleAssignment[]>]
 [-AppRoleAssignment <IMicrosoftGraphAppRoleAssignment[]>] [-AppRoleAssignmentRequired]
 [-ClaimsMappingPolicy <IMicrosoftGraphClaimsMappingPolicy[]>]
