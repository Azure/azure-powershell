...
online version: https://docs.microsoft.com/powershell/module/az.resources/remove-azmgappcredential
schema: 2.0.0
---
...
```
Remove-AzMgAppCredential -ObjectId <String> [-KeyId <String>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ApplicationDisplayNameParameterSet
```
Remove-AzMgAppCredential -DisplayName <String> [-KeyId <String>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ApplicationIdWithKeyIdParameterSet
```
Remove-AzMgAppCredential -ApplicationId <Guid> [-KeyId <String>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ApplicationObjectWithKeyIdParameterSet
```
Remove-AzMgAppCredential -ApplicationObject <IMicrosoftGraphApplication> [-KeyId <String>]
