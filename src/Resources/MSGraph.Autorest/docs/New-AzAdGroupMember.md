...
```
New-AzAdGroupMember -MemberObjectId <String[]> -TargetGroupObjectId <String> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### MemberObjectIdWithGroupDisplayName
```
New-AzAdGroupMember -MemberObjectId <String[]> -TargetGroupDisplayName <String> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### MemberObjectIdWithGroupObject
```
New-AzAdGroupMember -MemberObjectId <String[]> -TargetGroupObject <MicrosoftGraphGroup>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### MemberUPNWithGroupDisplayName
```
New-AzAdGroupMember -MemberUserPrincipalName <String[]> -TargetGroupDisplayName <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### MemberUPNWithGroupObject
```
New-AzAdGroupMember -MemberUserPrincipalName <String[]> -TargetGroupObject <MicrosoftGraphGroup>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### MemberUPNWithGroupObjectId
```
New-AzAdGroupMember -MemberUserPrincipalName <String[]> -TargetGroupObjectId <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
TARGETGROUPOBJECT <MicrosoftGraphGroup>: 
  ...
  - `[CreatedOnBehalfOf <IMicrosoftGraphDirectoryObjectAutoGenerated>]`: Represents an Azure Active Directory object. The directoryObject type is the base type for many other directory entity types.
    - `[DeletedDateTime <DateTime?>]`: 
    - `[DisplayName <String>]`: The name displayed in directory
    - `[OdataId <String>]`: The full id of object in directory
    - `[OdataType <String>]`: The type of object in directory
