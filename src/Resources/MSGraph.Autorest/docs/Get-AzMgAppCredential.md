...
online version: https://docs.microsoft.com/powershell/module/az.resources/get-azmgappcredential
schema: 2.0.0
---

# Get-AzMgAppCredential
...
```
Get-AzMgAppCredential -ObjectId <String> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ApplicationIdParameterSet
```
Get-AzMgAppCredential -ApplicationId <Guid> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ApplicationObjectParameterSet
```
Get-AzMgAppCredential -ApplicationObject <IMicrosoftGraphApplication> [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DisplayNameParameterSet
```
Get-AzMgAppCredential -DisplayName <String> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
