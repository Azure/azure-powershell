...
APPLICATIONOBJECT <IMicrosoftGraphApplication>: application object
  [(Any) <Object>]: This indicates any property can be added to this object.
  [DeletedDateTime <DateTime?>]: 
  [DisplayName <String>]: The name displayed in directory
  [OdataId <String>]: The full id of object in directory
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            MemberObjectIdWithGroupObjectId = 'MSGraph.custom\New-AzAdGroupMember';
            MemberUPNWithGroupObjectId = 'MSGraph.custom\New-AzAdGroupMember';
            MemberUPNWithGroupDisplayName = 'MSGraph.custom\New-AzAdGroupMember';
            MemberObjectIdWithGroupDisplayName = 'MSGraph.custom\New-AzAdGroupMember';
            MemberUPNWithGroupObject = 'MSGraph.custom\New-AzAdGroupMember';
            MemberObjectIdWithGroupObject = 'MSGraph.custom\New-AzAdGroupMember';
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
...
param(
    ...
    [Parameter(ParameterSetName='ServicePrincipalObjectWithCredentialParameterSet', Mandatory)]
...
INPUTOBJECT <IMicrosoftGraphApplication>: key: display name of application
  [(Any) <Object>]: This indicates any property can be added to this object.
  [DeletedDateTime <DateTime?>]: 
  [DisplayName <String>]: The name displayed in directory
  [OdataId <String>]: The full id of object in directory
