...
System.Boolean
.Link
https://docs.microsoft.com/powershell/module/az.resources/remove-azadapplicationfederatedidentitycredential
#>
function Remove-AzADapplicationfederatedidentitycredential {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.MSGraph.private\Remove-AzADapplicationfederatedidentitycredential_Delete';
        }
...
System.Boolean
.Link
https://docs.microsoft.com/powershell/module/az.resources/update-azadapplicationfederatedidentitycredential
#>
function Update-AzADapplicationfederatedidentitycredential {
[OutputType([System.Boolean])]
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            UpdateExpanded = 'Az.MSGraph.private\Update-AzADapplicationfederatedidentitycredential_UpdateExpanded';
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            ListByApplicationObjectId = 'Az.MSGraph.custom\Get-AzADApplicationFederatedIdentityCredential';
            GetByApplicationObjectId = 'Az.MSGraph.custom\Get-AzADApplicationFederatedIdentityCredential';
            GetByApplicationObject = 'Az.MSGraph.custom\Get-AzADApplicationFederatedIdentityCredential';
            ListByApplicationObject = 'Az.MSGraph.custom\Get-AzADApplicationFederatedIdentityCredential';
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
...
Create federatedIdentityCredential for applications.
.Example
PS C:\> New-AzADapplicationfederatedidentitycredential -ApplicationObjectId $appObjectId -Audience api://AzureADTokenExchange -Issuer https://login.microsoftonline.com/3d1e2be9-a10a-4a0c-8380-7ce190f98ed9/v2.0 -name 'test-cred' -Subject 'subject'
...
#>
function New-AzADapplicationfederatedidentitycredential {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10Beta.IMicrosoftGraphFederatedIdentityCredential])]
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            CreateExpanded = 'Az.MSGraph.custom\New-AzADapplicationfederatedidentitycredential';
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
