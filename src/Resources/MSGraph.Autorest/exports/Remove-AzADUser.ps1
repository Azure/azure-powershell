...
INPUTOBJECT <IMicrosoftGraphUser>: user input object
  ...
  [Manager <IMicrosoftGraphDirectoryObject>]: Represents an Azure Active Directory object. The directoryObject type is the base type for many other directory entity types.
    ...
    [OtherMail <List<String>>]: A list of additional email addresses for the user; for example: ['bob@contoso.com', 'Robert@fabrikam.com'].NOTE: While this property can contain accent characters, they can cause access issues to first-party applications for the user.Supports $filter (eq, NOT, ge, le, in, startsWith).
    ...
    [PhysicalId <List<String>>]: For internal use only. Not nullable. Supports $filter (eq, not, ge, le, startsWith).
