...
namespace Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10
{
    ...
    public partial class MicrosoftGraphTimeOffRequest
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10.IMicrosoftGraphTimeOffRequest.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10.IMicrosoftGraphTimeOffRequest.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10.IMicrosoftGraphTimeOffRequest FromJson(Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonObject json ? new MicrosoftGraphTimeOffRequest(json, new global::System.Collections.Generic.HashSet<string>(){ @"id",@"createdDateTime",@"lastModifiedBy",@"lastModifiedDateTime",@"assignedTo",@"managerActionDateTime",@"managerActionMessage",@"managerUserId",@"senderDateTime",@"senderMessage",@"senderUserId",@"state",@"endDateTime",@"startDateTime",@"timeOffReasonId" }) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonObject into a new instance of <see cref="MicrosoftGraphTimeOffRequest" />.
        /// </summary>
        ...
        internal MicrosoftGraphTimeOffRequest(Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonObject json, global::System.Collections.Generic.HashSet<string> exclusions = null)
        {
            ...
            __microsoftGraphScheduleChangeRequest = new Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10.MicrosoftGraphScheduleChangeRequest(json,new global::System.Collections.Generic.HashSet<string>(){ @"id",@"createdDateTime",@"lastModifiedBy",@"lastModifiedDateTime",@"assignedTo",@"managerActionDateTime",@"managerActionMessage",@"managerUserId",@"senderDateTime",@"senderMessage",@"senderUserId",@"state",@"endDateTime",@"startDateTime",@"timeOffReasonId" });
            ...
            {_timeOffReasonId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString>("timeOffReasonId"), out var __jsonTimeOffReasonId) ? (string)__jsonTimeOffReasonId : (string)TimeOffReasonId;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="MicrosoftGraphTimeOffRequest" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MicrosoftGraphTimeOffRequest" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.SerializationMode serializationMode)
        {
            ...
            __microsoftGraphScheduleChangeRequest?.ToJson(container, serializationMode);
            ...
            AddIf( null != (((object)this._timeOffReasonId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString(this._timeOffReasonId.ToString()) : null, "timeOffReasonId" ,container.Add );
