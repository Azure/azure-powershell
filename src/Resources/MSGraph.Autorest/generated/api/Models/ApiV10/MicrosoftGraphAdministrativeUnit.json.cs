...
namespace Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10
{
    ...
    public partial class MicrosoftGraphAdministrativeUnit
    {
        ...
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonObject json ? new MicrosoftGraphAdministrativeUnit(json, new global::System.Collections.Generic.HashSet<string>(){ @"ResourceGroupName",@"deletedDateTime",@"displayName",@"@odata.type",@"@odata.id",@"description",@"visibility",@"members",@"scopedRoleMembers",@"extensions" }) : null;
        }
