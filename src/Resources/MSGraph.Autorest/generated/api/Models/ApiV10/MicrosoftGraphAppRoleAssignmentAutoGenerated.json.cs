...
namespace Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10
{
    ...
    public partial class MicrosoftGraphAppRoleAssignmentAutoGenerated
    {
        ...
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonObject json ? new MicrosoftGraphAppRoleAssignmentAutoGenerated(json, new global::System.Collections.Generic.HashSet<string>(){ @"id",@"deletedDateTime",@"displayName",@"@odata.type",@"@odata.id",@"appRoleId",@"createdDateTime",@"principalDisplayName",@"principalId",@"principalType",@"resourceDisplayName",@"resourceId" }) : null;
        }
