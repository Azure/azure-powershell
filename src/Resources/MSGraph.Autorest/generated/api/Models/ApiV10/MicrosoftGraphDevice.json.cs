...
namespace Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10
{
    ...
    public partial class MicrosoftGraphDevice
    {
        ...
        internal MicrosoftGraphDevice(Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonObject json, global::System.Collections.Generic.HashSet<string> exclusions = null)
        {
            ...
            {_deviceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString>("deviceId"), out var __jsonDeviceId) ? (string)__jsonDeviceId : (string)_deviceId;}
            {_deviceMetadata = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString>("deviceMetadata"), out var __jsonDeviceMetadata) ? (string)__jsonDeviceMetadata : (string)_deviceMetadata;}
            ...
            {_isCompliant = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonBoolean>("isCompliant"), out var __jsonIsCompliant) ? (bool?)__jsonIsCompliant : _isCompliant;}
            {_isManaged = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonBoolean>("isManaged"), out var __jsonIsManaged) ? (bool?)__jsonIsManaged : _isManaged;}
            {_mdmAppId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString>("mdmAppId"), out var __jsonMdmAppId) ? (string)__jsonMdmAppId : (string)_mdmAppId;}
