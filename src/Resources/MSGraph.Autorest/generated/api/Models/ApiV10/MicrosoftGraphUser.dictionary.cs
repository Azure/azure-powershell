...
namespace Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.IAssociativeArray<global::System.Object>
    {
        ...
        public void CopyFrom(global::System.Collections.IDictionary source)
        {
            if (null != source)
            {
                foreach( var property in  Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.PowerShell.TypeConverterExtensions.GetFilteredProperties(source, new global::System.Collections.Generic.HashSet<global::System.String>() { "AccountEnabled","AgeGroup","BusinessPhone","City","CompanyName","ConsentProvidedForMinor","Country","CreatedDateTime","CreationType","Department","EmployeeHireDate","EmployeeId","EmployeeType","ExternalUserState","ExternalUserStateChangeDateTime","FaxNumber","GivenName","Identity","ImAddress","IsResourceAccount","JobTitle","LastPasswordChangeDateTime","LegalAgeGroupClassification","Mail","MailNickname","MobilePhone","OfficeLocation","OtherMail","OnPremisesImmutableId","PasswordPolicy","PasswordProfile","PostalCode","PreferredLanguage","ProxyAddress","ShowInAddressList","SignInSessionsValidFromDateTime","State","StreetAddress","Surname","UsageLocation","UserPrincipalName","UserType","Id","DeletedDateTime","DisplayName","OdataType","OdataId" } ) )
                {
