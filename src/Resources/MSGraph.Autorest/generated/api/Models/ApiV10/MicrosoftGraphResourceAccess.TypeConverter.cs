...
namespace Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="MicrosoftGraphResourceAccess" />
    /// </summary>
    public partial class MicrosoftGraphResourceAccessTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="MicrosoftGraphResourceAccess" /> type, otherwise <c>false</c>
        /// </returns>
        ...
        /// <returns>
        /// an instance of <see cref="MicrosoftGraphResourceAccess" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        ...
        /// /> and <see cref="ignoreCase" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="MicrosoftGraphResourceAccess" />.</param>
        /// <returns>
        /// an instance of <see cref="MicrosoftGraphResourceAccess" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10.IMicrosoftGraphResourceAccess ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10.IMicrosoftGraphResourceAccess).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
            {
                return MicrosoftGraphResourceAccess.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());;
            }
            catch
            {
            ...
            if (typeof(global::System.Management.Automation.PSObject).IsAssignableFrom(type))
            {
                return MicrosoftGraphResourceAccess.DeserializeFromPSObject(sourceValue);
            }
            if (typeof(global::System.Collections.IDictionary).IsAssignableFrom(type))
            {
                return MicrosoftGraphResourceAccess.DeserializeFromDictionary(sourceValue);
            }
            return null;
        }
