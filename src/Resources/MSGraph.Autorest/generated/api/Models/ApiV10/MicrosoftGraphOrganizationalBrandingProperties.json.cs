...
namespace Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10
{
    ...
    public partial class MicrosoftGraphOrganizationalBrandingProperties
    {
        ...
        internal MicrosoftGraphOrganizationalBrandingProperties(Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonObject json, global::System.Collections.Generic.HashSet<string> exclusions = null)
        {
            ...
            {_backgroundColor = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString>("backgroundColor"), out var __jsonBackgroundColor) ? (string)__jsonBackgroundColor : (string)_backgroundColor;}
            ...
            {_backgroundImageRelativeUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString>("backgroundImageRelativeUrl"), out var __jsonBackgroundImageRelativeUrl) ? (string)__jsonBackgroundImageRelativeUrl : (string)_backgroundImageRelativeUrl;}
            ...
            {_bannerLogoRelativeUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString>("bannerLogoRelativeUrl"), out var __jsonBannerLogoRelativeUrl) ? (string)__jsonBannerLogoRelativeUrl : (string)_bannerLogoRelativeUrl;}
            {_cdnList = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonArray>("cdnList"), out var __jsonCdnList) ? If( __jsonCdnList as Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonArray, out var __r) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__r, (__q)=>(string) (__q is Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString __p ? (string)(__p.ToString()) : null)) ))() : null : _cdnList;}
            {_signInPageText = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString>("signInPageText"), out var __jsonSignInPageText) ? (string)__jsonSignInPageText : (string)_signInPageText;}
            ...
            {_squareLogoRelativeUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString>("squareLogoRelativeUrl"), out var __jsonSquareLogoRelativeUrl) ? (string)__jsonSquareLogoRelativeUrl : (string)_squareLogoRelativeUrl;}
            {_usernameHintText = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString>("usernameHintText"), out var __jsonUsernameHintText) ? (string)__jsonUsernameHintText : (string)_usernameHintText;}
            AfterFromJson(json);
        }
