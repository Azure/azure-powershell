...
namespace Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.IContext
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] IdentifierUri { get => _body.IdentifierUri?.ToArray() ?? null /* fixedArrayOf */; set => _body.IdentifierUri = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10.IMicrosoftGraphRequiredResourceAccess[] RequiredResourceAccess { get => _body.RequiredResourceAccess?.ToArray() ?? null /* fixedArrayOf */; set => _body.RequiredResourceAccess = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10.IMicrosoftGraphRequiredResourceAccess>(value) : null); }
