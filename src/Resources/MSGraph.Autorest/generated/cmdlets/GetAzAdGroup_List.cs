...
namespace Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListGroup=>GET:"/groups"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzADGroup_List", SupportsPaging = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Description(@"Get entities from groups")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.HttpPath(Path = "/groups", ApiVersion = "v1.0")]
    public partial class GetAzADGroup_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.IContext
    {
        ...
        private System.Collections.Generic.List<string> _orderby;
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.ParameterCategory.Query)]
        public System.Collections.Generic.List<string> Orderby { get => this._orderby; set => this._orderby = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10.ICollectionOfGroup">Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10.ICollectionOfGroup</see>
        /// from the remote call</param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzADGroup_List" /> cmdlet class.
        /// </summary>
        public GetAzADGroup_List()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10.ICollectionOfGroup> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                else
                {
                    ...
                    var outputObjects = requiredResult;
                    if (null != outputObjects)
                    {
                        if (0 == _responseSize && 1 == outputObjects.Count)
                        {
                            _firstResponse = outputObjects[0];
                            _responseSize = 1;
                        }
                        else
                        {
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null && this.PagingParameters.First > 0)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.GroupsGroupListGroup_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
