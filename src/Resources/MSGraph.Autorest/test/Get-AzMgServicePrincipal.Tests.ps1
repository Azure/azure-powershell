if(($null -eq $TestName) -or ($TestName -contains 'Get-AzMgServicePrincipal'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Get-AzMgServicePrincipal.Recording.json'
...
Describe 'Get-AzMgServicePrincipal' {
