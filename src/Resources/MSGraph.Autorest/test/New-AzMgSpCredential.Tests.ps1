if(($null -eq $TestName) -or ($TestName -contains 'New-AzMgSpCredential'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-AzMgSpCredential.Recording.json'
