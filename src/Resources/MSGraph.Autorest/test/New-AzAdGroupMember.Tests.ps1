if(($null -eq $TestName) -or ($TestName -contains 'New-AzAdGroupMember'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-AzAdGroupMember.Recording.json'
