if(($null -eq $TestName) -or ($TestName -contains 'New-AzMgGroupMember'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-AzMgGroupMember.Recording.json'
