if(($null -eq $TestName) -or ($TestName -contains 'Remove-AzMgAppCredential'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Remove-AzMgAppCredential.Recording.json'
...
Describe 'Remove-AzMgAppCredential' {
