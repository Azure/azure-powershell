if(($null -eq $TestName) -or ($TestName -contains 'New-AzMgAppCredential'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-AzMgAppCredential.Recording.json'
...
Describe 'New-AzMgAppCredential' {
