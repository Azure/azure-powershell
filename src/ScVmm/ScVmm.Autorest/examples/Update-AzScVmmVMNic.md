...
It might take some time to sync the MacAddress and Ipv4Address in the response. Use `Get-AzScVmmVM` command to fetch the latest configuration of the virtual machine.
