...
Updates HardwareProfile properties for Virtual Machine. For Disk and NIC related updates on the given Virtual Machine use `Update-AzScVmmVMVirtualDisk` and `Update-AzScVmmVMNetworkInterface` respectively.