...
```
New-AzScVmmVMExtension -ExtensionName <String> -ResourceGroupName <String> -vmName <String> -Location <String>
...
```
New-AzScVmmVMExtension -ExtensionName <String> -ResourceGroupName <String> -vmName <String>
