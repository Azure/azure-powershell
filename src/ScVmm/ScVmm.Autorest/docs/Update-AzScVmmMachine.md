...
online version: https://learn.microsoft.com/powershell/module/az.scvmm/update-azscvmmmachine
schema: 2.0.0
---

# Update-AzScVmmMachine
...
```
Update-AzScVmmMachine -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-AgentUpgradeCorrelationId <String>] [-AgentUpgradeDesiredVersion <String>]
 [-AgentUpgradeEnableAutomaticUpgrade] [-IdentityType <String>] [-Kind <String>]
...
```
Update-AzScVmmMachine -InputObject <IScVmmIdentity> [-AgentUpgradeCorrelationId <String>]
 [-AgentUpgradeDesiredVersion <String>] [-AgentUpgradeEnableAutomaticUpgrade] [-IdentityType <String>]
...
```
Update-AzScVmmMachine -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaJsonString
```
Update-AzScVmmMachine -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
