...
```
Add-AzScVmmVMDisk -DiskName <String> -diskSizeGB <Int32> -ResourceGroupName <String> -vmName <String>
 [-bus <Int32>] [-busType <String>] [-lun <Int32>] [-QosId <String>] [-QosName <String>]
 [-SubscriptionId <String>] [-vhdType <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
