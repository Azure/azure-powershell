...
online version: https://learn.microsoft.com/powershell/module/az.scvmm/remove-azscvmmvirtualnetwork
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzScVmmVirtualNetwork -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzScVmmVirtualNetwork -InputObject <IScVmmIdentity> [-Force <String>] [-DefaultProfile <PSObject>]
