...
online version: https://learn.microsoft.com/powershell/module/az.scvmm/add-azscvmmvirtualdisk
schema: 2.0.0
---

# Add-AzScVmmVirtualDisk
...
```
Add-AzScVmmVirtualDisk -MachineId <String> -StorageProfileDisk <IVirtualDiskUpdate[]> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
