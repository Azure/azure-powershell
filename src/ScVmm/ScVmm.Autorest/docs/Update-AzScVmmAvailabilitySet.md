...
online version: https://learn.microsoft.com/powershell/module/az.scvmm/update-azscvmmavailabilityset
schema: 2.0.0
---
...
```
Update-AzScVmmAvailabilitySet -InputObject <IScVmmIdentity> [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
