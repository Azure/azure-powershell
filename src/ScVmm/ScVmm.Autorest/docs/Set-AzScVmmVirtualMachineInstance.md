...
online version: https://learn.microsoft.com/powershell/module/az.scvmm/set-azscvmmvirtualmachineinstance
schema: 2.0.0
---

# Set-AzScVmmVirtualMachineInstance
...
```
Set-AzScVmmVirtualMachineInstance -ResourceUri <String> [-AvailabilitySet <IAvailabilitySetListItem[]>]
...
```
Set-AzScVmmVirtualMachineInstance -ResourceUri <String> -JsonFilePath <String> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaJsonString
```
Set-AzScVmmVirtualMachineInstance -ResourceUri <String> -JsonString <String> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
