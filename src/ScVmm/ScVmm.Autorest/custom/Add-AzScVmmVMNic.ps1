...
function Add-AzScVmmVMNic {
    ...
    begin {
        try {
            ...
            if (-not $PSBoundParameters.ContainsKey('macAddressType')) {
              $macAddressType = "Dynamic"
            }
            if (-not $PSBoundParameters.ContainsKey('ipv4AddressType')) {
              $ipv4AddressType = "Dynamic"
            }
            if (-not $PSBoundParameters.ContainsKey('ipv6AddressType')) {
