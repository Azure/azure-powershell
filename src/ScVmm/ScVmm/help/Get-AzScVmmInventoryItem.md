...
### Get
```
Get-AzScVmmInventoryItem -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String[]>]
 -VmmServerName <String> [-DefaultProfile <PSObject>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-AzScVmmInventoryItem -InputObject <IScVmmIdentity> [-DefaultProfile <PSObject>]
