...
online version: https://learn.microsoft.com/powershell/module/az.scvmm/set-azscvmmvirtualnetwork
schema: 2.0.0
---

# Set-AzScVmmVirtualNetwork
...
```
Set-AzScVmmVirtualNetwork -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Location <String> [-ExtendedLocationName <String>] [-ExtendedLocationType <String>]
