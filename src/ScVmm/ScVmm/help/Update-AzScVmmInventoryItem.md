...
```
Update-AzScVmmInventoryItem -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
 -VmmServerName <String> [-InventoryType <String>] [-Kind <String>] [-DefaultProfile <PSObject>]
...
Update-AzScVmmInventoryItem -ResourceName <String> -VmmServerInputObject <IScVmmIdentity>
 [-InventoryType <String>] [-Kind <String>] [-DefaultProfile <PSObject>] [-ProgressAction <ActionPreference>]
