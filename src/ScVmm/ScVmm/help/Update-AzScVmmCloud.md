...
### UpdateViaJsonString
```
Update-AzScVmmCloud -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] -JsonString <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaJsonFilePath
```
Update-AzScVmmCloud -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
