...
### Delete (Default)
```
Remove-AzScVmmInventoryItem -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
 -VmmServerName <String> [-DefaultProfile <PSObject>] [-PassThru] [-ProgressAction <ActionPreference>]
...
### DeleteViaIdentity
```
Remove-AzScVmmInventoryItem -InputObject <IScVmmIdentity> [-DefaultProfile <PSObject>] [-PassThru]
