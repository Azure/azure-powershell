...
online version: https://learn.microsoft.com/powershell/module/az.scvmm/update-azscvmmguestagent
schema: 2.0.0
---

# Update-AzScVmmGuestAgent
...
```
Update-AzScVmmGuestAgent -ResourceUri <String> [-CredentialsPassword <SecureString>]
