...
online version: https://learn.microsoft.com/powershell/module/az.scvmm/set-azscvmmvirtualmachinetemplate
schema: 2.0.0
---

# Set-AzScVmmVirtualMachineTemplate
...
```
Set-AzScVmmVirtualMachineTemplate -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
