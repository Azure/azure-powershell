...
```
Set-AzScVmmAvailabilitySet -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
 -Location <String> [-AvailabilitySetName <String>] [-ExtendedLocationName <String>]
