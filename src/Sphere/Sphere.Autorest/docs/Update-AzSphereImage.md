...
Update-AzSphereImage -CatalogName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-ImageId <String>] [-ImageInputFile <String>] [-RegionalDataBoundary <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityCatalogExpanded
```
Update-AzSphereImage -CatalogInputObject <ISphereIdentity> -Name <String> [-ImageId <String>]
...
```
Update-AzSphereImage -InputObject <ISphereIdentity> [-ImageId <String>] [-ImageInputFile <String>]
