...
online version: https://learn.microsoft.com/powershell/module/az.sphere/invoke-azsphereuploadcatalogimage
schema: 2.0.0
---

# Invoke-AzSphereUploadCatalogImage
...
```
Invoke-AzSphereUploadCatalogImage -CatalogName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### Upload
```
Invoke-AzSphereUploadCatalogImage -CatalogName <String> -ResourceGroupName <String>
 -UploadImageRequest <IImage> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UploadViaIdentity
```
Invoke-AzSphereUploadCatalogImage -InputObject <ISphereIdentity> -UploadImageRequest <IImage>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UploadViaIdentityExpanded
```
Invoke-AzSphereUploadCatalogImage -InputObject <ISphereIdentity> [-ImageId <String>]
...
```
Invoke-AzSphereUploadCatalogImage -CatalogName <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### UploadViaJsonString
```
Invoke-AzSphereUploadCatalogImage -CatalogName <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
To construct, see NOTES section for UPLOADIMAGEREQUEST properties and create a hash table.
