...
param(
    ...
    [Parameter(ParameterSetName='CreateViaIdentityProductExpanded', Mandatory)]
    ...
    [Parameter(ParameterSetName='CreateViaIdentityProductExpanded', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.Sphere.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.Sphere.Models.ISphereIdentity]
    # Identity Parameter
...
begin {
    try {
        ...
        $mapping = @{
            ...
            CreateViaIdentityCatalogExpanded = 'Az.Sphere.private\New-AzSphereDeviceGroup_CreateViaIdentityCatalogExpanded';
            CreateViaIdentityExpanded = 'Az.Sphere.private\New-AzSphereDeviceGroup_CreateViaIdentityExpanded';
            CreateViaIdentityProductExpanded = 'Az.Sphere.private\New-AzSphereDeviceGroup_CreateViaIdentityProductExpanded';
        }
