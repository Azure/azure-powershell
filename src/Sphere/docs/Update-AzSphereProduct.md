...
```powershell
Update-AzSphereProduct -CatalogName newCatalog -Name MyProd815 -ResourceGroupName ps1-test -Description "test"
```

```output
Description                  : test
Id                           : /subscriptions/9e2d1cd48f9-b94b-4645-9632-634b440db393/resourceGroups/ps1-test/providers/Microsoft.AzureSphere/catalogs/newCatalog/products/MyProd815
Name                         : MyProd815
