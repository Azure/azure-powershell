...
```powershell
Update-AzSphereDeviceGroup -CatalogName NewCatalog -Name Marketing -ProductName MyProd815 -ResourceGroupName ps1-test -Description test -AllowCrashDumpsCollection Enabled
```
