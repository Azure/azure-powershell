...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.FirmwareAnalysis.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.FirmwareAnalysis.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: FirmwareAnalysis cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.FirmwareAnalysis.format.ps1xml'
