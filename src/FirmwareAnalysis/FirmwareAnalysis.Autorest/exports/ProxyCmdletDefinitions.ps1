...
begin {
    try {
        ...
        $mapping = @{
            ...
            List = 'Az.FirmwareAnalysis.private\Get-AzFirmwareAnalysisSummary_List';
        }
        if (('Get', 'List') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId') ) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
...
WORKSPACEINPUTOBJECT <IFirmwareAnalysisIdentity>: Identity Parameter
  ...
  [WorkspaceName <String>]: The name of the firmware analysis workspace.
.Link
https://learn.microsoft.com/powershell/module/az.firmwareanalysis/new-azfirmwareanalysisfirmwaredownloadurl
#>
function New-AzFirmwareAnalysisFirmwareDownloadUrl {
...
param(
    ...
    [Parameter(ParameterSetName='GenerateViaIdentityWorkspace', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.FirmwareAnalysis.Category('Path')]
    [System.String]
    # The id of the firmware.
    ${FirmwareId},
    ...
    [Parameter(ParameterSetName='GenerateViaIdentityWorkspace', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.FirmwareAnalysis.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.FirmwareAnalysis.Models.IFirmwareAnalysisIdentity]
    # Identity Parameter
    # .
...
begin {
    try {
        ...
        $mapping = @{
            Generate = 'Az.FirmwareAnalysis.private\New-AzFirmwareAnalysisFirmwareDownloadUrl_Generate';
            GenerateViaIdentity = 'Az.FirmwareAnalysis.private\New-AzFirmwareAnalysisFirmwareDownloadUrl_GenerateViaIdentity';
            GenerateViaIdentityWorkspace = 'Az.FirmwareAnalysis.private\New-AzFirmwareAnalysisFirmwareDownloadUrl_GenerateViaIdentityWorkspace';
        }
...
WORKSPACEINPUTOBJECT <IFirmwareAnalysisIdentity>: Identity Parameter
  ...
  [WorkspaceName <String>]: The name of the firmware analysis workspace.
.Link
https://learn.microsoft.com/powershell/module/az.firmwareanalysis/new-azfirmwareanalysisfirmwarefilesystemdownloadurl
#>
function New-AzFirmwareAnalysisFirmwareFilesystemDownloadUrl {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.FirmwareAnalysis.Models.IUrlToken])]
[CmdletBinding(DefaultParameterSetName='Generate', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Generate', Mandatory)]
...
begin {
    try {
        ...
        $mapping = @{
            Generate = 'Az.FirmwareAnalysis.private\New-AzFirmwareAnalysisFirmwareFilesystemDownloadUrl_Generate';
            GenerateViaIdentity = 'Az.FirmwareAnalysis.private\New-AzFirmwareAnalysisFirmwareFilesystemDownloadUrl_GenerateViaIdentity';
            GenerateViaIdentityWorkspace = 'Az.FirmwareAnalysis.private\New-AzFirmwareAnalysisFirmwareFilesystemDownloadUrl_GenerateViaIdentityWorkspace';
        }
        if (('Generate') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId') ) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
