...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/get-azcertificate
schema: 2.0.0
---
...
### List (Default)
```
Get-AzCertificate -ManagedEnvironmentName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzCertificate -ManagedEnvironmentName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzCertificate -InputObject <IContainerAppIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.ContainerApp.Models.Api20220301.ICertificate
