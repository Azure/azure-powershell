...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/remove-azcontainerappssourcecontrol
schema: 2.0.0
---

# Remove-AzContainerAppsSourceControl
...
### Delete (Default)
```
Remove-AzContainerAppsSourceControl -ContainerAppName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzContainerAppsSourceControl -InputObject <IContainerAppIdentity> [-DefaultProfile <PSObject>] [-AsJob]
