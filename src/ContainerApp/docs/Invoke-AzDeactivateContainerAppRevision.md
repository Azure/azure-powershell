...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/invoke-azdeactivatecontainerapprevision
schema: 2.0.0
---

# Invoke-AzDeactivateContainerAppRevision
...
### Deactivate (Default)
```
Invoke-AzDeactivateContainerAppRevision -ContainerAppName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeactivateViaIdentity
```
Invoke-AzDeactivateContainerAppRevision -InputObject <IContainerAppIdentity> [-DefaultProfile <PSObject>]
