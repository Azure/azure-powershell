...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/get-azcontainerapp
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzContainerApp -InputObject <IContainerAppIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
