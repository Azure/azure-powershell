...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/remove-azcontainerappsauthconfig
schema: 2.0.0
---

# Remove-AzContainerAppsAuthConfig
...
### Delete (Default)
```
Remove-AzContainerAppsAuthConfig -ContainerAppName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzContainerAppsAuthConfig -InputObject <IContainerAppIdentity> [-DefaultProfile <PSObject>] [-PassThru]
