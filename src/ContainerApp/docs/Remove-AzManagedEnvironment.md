...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/remove-azmanagedenvironment
schema: 2.0.0
---

# Remove-AzManagedEnvironment
...
### Delete (Default)
```
Remove-AzManagedEnvironment -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzManagedEnvironment -InputObject <IContainerAppIdentity> [-DefaultProfile <PSObject>] [-AsJob]
