...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/update-azcertificate
schema: 2.0.0
---
...
```
Update-AzCertificate -ManagedEnvironmentName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzCertificate -InputObject <IContainerAppIdentity> [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
