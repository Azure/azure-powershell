...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/new-azcontainerappauthconfig
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerApp.Support.CookieExpirationConvention
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerApp.Support.ForwardProxyConvention
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerApp.Support.UnauthenticatedClientActionV2
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerApp.Models.Api20220301.IIdentityProviders
Parameter Sets: (All)
Aliases:
