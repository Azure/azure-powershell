...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/new-azdaprcomponent
schema: 2.0.0
---
...
```
New-AzDaprComponent -EnvironmentName <String> -Name <String> -ResourceGroupName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerApp.Models.Api20220301.IDaprMetadata[]
Parameter Sets: (All)
Aliases:
