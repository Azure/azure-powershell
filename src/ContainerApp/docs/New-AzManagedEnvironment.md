...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/new-azmanagedenvironment
schema: 2.0.0
---

# New-AzManagedEnvironment
...
```
New-AzManagedEnvironment -Name <String> -ResourceGroupName <String> -Location <String>
...
### Microsoft.Azure.PowerShell.Cmdlets.ContainerApp.Models.Api20220301.IManagedEnvironment
