...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/get-azcontainerapprevision
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzContainerAppRevision -InputObject <IContainerAppIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.ContainerApp.Models.Api20220301.IRevision
