...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/restart-azcontainerapprevision
schema: 2.0.0
---
...
### RestartViaIdentity
```
Restart-AzContainerAppRevision -InputObject <IContainerAppIdentity> [-DefaultProfile <PSObject>] [-PassThru]
