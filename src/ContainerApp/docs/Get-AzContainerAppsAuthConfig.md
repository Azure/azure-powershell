...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/get-azcontainerappsauthconfig
schema: 2.0.0
---

# Get-AzContainerAppsAuthConfig
...
### Get (Default)
```
Get-AzContainerAppsAuthConfig -ContainerAppName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzContainerAppsAuthConfig -InputObject <IContainerAppIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.ContainerApp.Models.Api20220301.IAuthConfig
