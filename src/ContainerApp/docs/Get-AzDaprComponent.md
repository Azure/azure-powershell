...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/get-azdaprcomponent
schema: 2.0.0
---
...
### List (Default)
```
Get-AzDaprComponent -EnvironmentName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzDaprComponent -EnvironmentName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDaprComponent -InputObject <IContainerAppIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.ContainerApp.Models.Api20220301.IDaprComponent
