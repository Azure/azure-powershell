...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/remove-azdaprcomponent
schema: 2.0.0
---

# Remove-AzDaprComponent
...
### Delete (Default)
```
Remove-AzDaprComponent -EnvironmentName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDaprComponent -InputObject <IContainerAppIdentity> [-DefaultProfile <PSObject>] [-PassThru]
