...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/remove-azcontainerapp
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzContainerApp -InputObject <IContainerAppIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
