...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/get-azcontainerappssourcecontrol
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzContainerAppsSourceControl -ContainerAppName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzContainerAppsSourceControl -InputObject <IContainerAppIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
