...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/remove-azcertificate
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzCertificate -ManagedEnvironmentName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzCertificate -InputObject <IContainerAppIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
