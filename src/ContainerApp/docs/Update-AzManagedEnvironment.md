...
online version: https://docs.microsoft.com/powershell/module/az.containerapp/update-azmanagedenvironment
schema: 2.0.0
---

# Update-AzManagedEnvironment
...
```
Update-AzManagedEnvironment -Name <String> -ResourceGroupName <String> -Location <String>
...
```
Update-AzManagedEnvironment -InputObject <IContainerAppIdentity> -Location <String>
