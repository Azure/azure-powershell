...
online version: https://learn.microsoft.com/powershell/module/az.elastic/remove-azelasticopenai
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzElasticOpenAi -IntegrationName <String> -MonitorName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzElasticOpenAi -InputObject <IElasticIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
