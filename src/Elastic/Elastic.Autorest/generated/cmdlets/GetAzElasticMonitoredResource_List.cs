...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20200701.IMonitoredResourceListResponse"
        /// /> from the remote call</param>
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzElasticMonitoredResource_List" /> cmdlet class.
        /// </summary>
        public GetAzElasticMonitoredResource_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'MonitoredResourcesList' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.MonitoredResourcesList(SubscriptionId, ResourceGroupName, Name, onOk, onDefault, this, Pipeline);
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.MonitoredResourcesList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                    }
                }
            }
        }
