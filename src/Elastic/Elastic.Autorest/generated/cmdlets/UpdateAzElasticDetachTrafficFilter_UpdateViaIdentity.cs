...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Update=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Elastic/monitors/{monitorName}/detachTrafficFilter"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzElasticDetachTrafficFilter_UpdateViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Description(@"Detach traffic filter for the given deployment.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Elastic/monitors/{monitorName}/detachTrafficFilter", ApiVersion = "2024-03-01")]
    public partial class UpdateAzElasticDetachTrafficFilter_UpdateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.IEventListener
    {
        ...
        /// <summary>Ruleset Id of the filter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Ruleset Id of the filter")]
        ...
        public string RulesetId { get => this._rulesetId; set => this._rulesetId = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzElasticDetachTrafficFilter_UpdateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Elastic.Cmdlets.UpdateAzElasticDetachTrafficFilter_UpdateViaIdentity Clone()
        {
            var clone = new UpdateAzElasticDetachTrafficFilter_UpdateViaIdentity();
            ...
            clone.RulesetId = this.RulesetId;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DetachTrafficFilterUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DetachTrafficFilterUpdateViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("RulesetId") ? RulesetId : null, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.DetachTrafficFilterUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.MonitorName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("RulesetId") ? RulesetId : null, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  RulesetId=this.InvocationInformation.BoundParameters.ContainsKey("RulesetId") ? RulesetId : null})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzElasticDetachTrafficFilter_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzElasticDetachTrafficFilter_UpdateViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240301.IResourceProviderDefaultErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { RulesetId=this.InvocationInformation.BoundParameters.ContainsKey("RulesetId") ? RulesetId : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { RulesetId=this.InvocationInformation.BoundParameters.ContainsKey("RulesetId") ? RulesetId : null })
                    {
