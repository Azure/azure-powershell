...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.Type AzurePrivateEndpoint = @"azure_private_endpoint";

        public static Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.Type IP = @"ip";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.Type e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.Type e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.Type e1, Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.Type e2)
        {
            return !e2.Equals(e1);
        }
