...
Describe 'Get-AzElasticDetailUpgradableVersion' {
    It 'Details' {
        {
            Get-AzElasticDetailUpgradableVersion -ResourceGroupName $env.resourceGroup -MonitorName $env.monitorName01
        } | Should -Not -Throw
    }
    ...
    It 'DetailsViaIdentity' {
        {
            ...
            Get-AzElasticDetailUpgradableVersion -InputObject $monitor
        } | Should -Not -Throw
    }
}
