...
online version: https://learn.microsoft.com/powershell/module/az.elastic/remove-azelasticunassociatedtrafficfilter
schema: 2.0.0
---

# Remove-AzElasticUnassociatedTrafficFilter
...
### Delete (Default)
```
Remove-AzElasticUnassociatedTrafficFilter -MonitorName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-RulesetId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzElasticUnassociatedTrafficFilter -InputObject <IElasticIdentity> [-RulesetId <String>]
