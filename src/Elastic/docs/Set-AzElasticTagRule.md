...
online version: https://docs.microsoft.com/powershell/module/az.elastic/set-azelastictagrule
schema: 2.0.0
---

# Set-AzElasticTagRule
...
```
Set-AzElasticTagRule -MonitorName <String> -Name <String> -ResourceGroupName <String>
