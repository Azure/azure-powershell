...
online version: https://learn.microsoft.com/powershell/module/az.fabric/remove-azfabriccapacity
schema: 2.0.0
---

# Remove-AzFabricCapacity
...
### Delete (Default)
```
Remove-AzFabricCapacity -CapacityName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzFabricCapacity -InputObject <IFabricIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
