...
$dll = Join-Path $PSScriptRoot 'bin\Az.Fabric.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.Fabric.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.Fabric.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.Fabric'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: Fabric cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.Fabric.format.ps1xml'
