...
Describe 'Update-AzMariaDbVirtualNetworkRule' {
    It 'UpdateExpanded' {
        Update-AzMariaDbVirtualNetworkRule -ServerName $serverName -ResourceGroupName $env.ResourceGroup -Name $vnetRuleName01 -SubnetId $vnetobj.Subnets[2].id -IgnoreMissingVnetServiceEndpoint
