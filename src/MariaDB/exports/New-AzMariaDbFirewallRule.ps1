...
begin {
    try {
        ...
        $mapping = @{
            ...
            CreateViaIdentity = 'Az.MariaDb.private\New-AzMariaDbFirewallRule_CreateViaIdentity';
            CreateViaIdentityExpanded = 'Az.MariaDb.private\New-AzMariaDbFirewallRule_CreateViaIdentityExpanded';
        }
