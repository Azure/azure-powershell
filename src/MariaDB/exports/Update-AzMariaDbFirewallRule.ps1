...
Creates a new firewall rule or updates an existing firewall rule.
.Example
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/az.mariadb/update-azmariadbfirewallrule
.Inputs
...
begin {
    try {
        ...
        $mapping = @{
            Update = 'Az.MariaDb.private\Update-AzMariaDbFirewallRule_Update';
            UpdateExpanded = 'Az.MariaDb.private\Update-AzMariaDbFirewallRule_UpdateExpanded';
            UpdateViaIdentity = 'Az.MariaDb.private\Update-AzMariaDbFirewallRule_UpdateViaIdentity';
