...
namespace Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzMariaDbFirewallRule_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzMariaDbFirewallRule_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of NewAzMariaDbFirewallRule_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Cmdlets.NewAzMariaDbFirewallRule_CreateViaIdentity Clone()
        {
            var clone = new NewAzMariaDbFirewallRule_CreateViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzMariaDbFirewallRule_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzMariaDbFirewallRule_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.FirewallRulesCreateOrUpdateViaIdentity(InputObject.Id, FirewallRule, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.FirewallRulesCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServerName ?? null, InputObject.FirewallRuleName ?? null, FirewallRule, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=FirewallRule})
                    {
