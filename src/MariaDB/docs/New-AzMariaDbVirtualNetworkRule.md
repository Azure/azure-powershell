...
### CreateViaIdentity
```
New-AzMariaDbVirtualNetworkRule -InputObject <IMariaDbIdentity> -VNetRule <IVirtualNetworkRule>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzMariaDbVirtualNetworkRule -InputObject <IMariaDbIdentity> [-IgnoreMissingVnetServiceEndpoint]
