...
### ServerName (Default)
```
Restore-AzMariaDbServer -Name <String> -ResourceGroupName <String> -RestorePointInTime <DateTime>
...
### ServerObject
```
Restore-AzMariaDbServer -InputObject <IServer> -RestorePointInTime <DateTime> [-SubscriptionId <String>]
