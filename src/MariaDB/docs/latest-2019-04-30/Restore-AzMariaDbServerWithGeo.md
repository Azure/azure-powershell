...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mariadb/restore-azmariadbserverwithgeo
schema: 2.0.0
---

# Restore-AzMariaDbServerWithGeo
...
### ServerName (Default)
```
Restore-AzMariaDbServerWithGeo -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### ServerObject
```
Restore-AzMariaDbServerWithGeo -InputObject <IServer> [-SubscriptionId <String>] [-Location <String>]
