...
```
Restore-AzMariaDbServer -Name <String> -RestorePointInTime <DateTime> -UsePointInTimeRestore
 [-InputObject <IServer>] [-ResourceGroupName <String>] [-ServerName <String>] [-SubscriptionId <String>]
...
### GeoRestore
```
Restore-AzMariaDbServer -Name <String> -UseGeoRetore [-InputObject <IServer>] [-ResourceGroupName <String>]
 [-ServerName <String>] [-SubscriptionId <String>] [-Location <String>] [-Tag <Hashtable>]
