...
### ListViaJsonFilePath
```
Get-AzDataTransferAzureDataTransferFlowProfile -JsonFilePath <String> [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ListViaJsonString
```
Get-AzDataTransferAzureDataTransferFlowProfile -JsonString <String> [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
