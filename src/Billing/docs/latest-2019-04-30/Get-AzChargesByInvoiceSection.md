...
online version: https://docs.microsoft.com/en-us/powershell/module/az.billing/get-azchargesbyinvoicesection
schema: 2.0.0
---

# Get-AzChargesByInvoiceSection
...
```
Get-AzChargesByInvoiceSection -BillingAccountId <String> -InvoiceSectionId <String> -EndDate <String>
