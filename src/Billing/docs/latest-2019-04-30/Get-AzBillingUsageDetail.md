...
online version: https://docs.microsoft.com/en-us/powershell/module/az.billing/get-azbillingusagedetail
schema: 2.0.0
---

# Get-AzBillingUsageDetail
...
```
Get-AzBillingUsageDetail -Scope <String> [-Apply <String>] [-Expand <String>] [-Filter <String>]
