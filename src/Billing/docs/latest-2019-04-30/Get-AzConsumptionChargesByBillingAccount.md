...
online version: https://docs.microsoft.com/en-us/powershell/module/az.billing/get-azconsumptionchargesbybillingaccount
schema: 2.0.0
---
...
```
Get-AzConsumptionChargesByBillingAccount -BillingAccountId <String> -EndDate <String> -StartDate <String>
