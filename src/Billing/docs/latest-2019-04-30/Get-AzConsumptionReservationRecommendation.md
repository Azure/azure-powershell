...
online version: https://docs.microsoft.com/en-us/powershell/module/az.billing/get-azconsumptionreservationrecommendation
schema: 2.0.0
---
...
```
Get-AzConsumptionReservationRecommendation -SubscriptionId <String[]> [-Filter <String>]
