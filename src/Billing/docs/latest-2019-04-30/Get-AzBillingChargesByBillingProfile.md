...
online version: https://docs.microsoft.com/en-us/powershell/module/az.billing/get-azbillingchargesbybillingprofile
schema: 2.0.0
---

# Get-AzBillingChargesByBillingProfile
...
```
Get-AzBillingChargesByBillingProfile -BillingAccountId <String> -BillingProfileId <String> -EndDate <String>
