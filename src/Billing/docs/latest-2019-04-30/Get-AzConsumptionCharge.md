...
online version: https://docs.microsoft.com/en-us/powershell/module/az.billing/get-azconsumptioncharge
schema: 2.0.0
---
...
```
Get-AzConsumptionCharge -Scope <String> [-Filter <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
