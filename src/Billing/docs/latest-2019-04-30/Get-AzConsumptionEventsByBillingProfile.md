...
online version: https://docs.microsoft.com/en-us/powershell/module/az.billing/get-azconsumptioneventsbybillingprofile
schema: 2.0.0
---

# Get-AzConsumptionEventsByBillingProfile
...
```
Get-AzConsumptionEventsByBillingProfile -BillingAccountId <String> -BillingProfileId <String>
