...
online version: https://docs.microsoft.com/en-us/powershell/module/az.billing/get-azbillingcharge
schema: 2.0.0
---
...
```
Get-AzBillingCharge -Scope <String> [-Filter <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
