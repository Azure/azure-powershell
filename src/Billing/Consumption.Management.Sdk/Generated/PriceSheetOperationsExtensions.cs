...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    public static partial class PriceSheetOperationsExtensions
    {
        ...
        {
                return ((IPriceSheetOperations)operations).GetAsync(expand, skiptoken, top).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<PriceSheetResult> GetAsync(this IPriceSheetOperations operations, string expand = default(string), string skiptoken = default(string), int? top = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
                return ((IPriceSheetOperations)operations).GetByBillingPeriodAsync(billingPeriodName, expand, skiptoken, top).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<PriceSheetResult> GetByBillingPeriodAsync(this IPriceSheetOperations operations, string billingPeriodName, string expand = default(string), string skiptoken = default(string), int? top = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
