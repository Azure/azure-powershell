...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public partial interface IPoliciesOperations
    {
        ...
        /// The policy that controls whether the users in customer's
        /// organization can view charges at pay-as-you-go prices. Possible
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<CustomerPolicy>> UpdateCustomerWithHttpMessagesAsync(string billingAccountName, string customerName, string viewCharges = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
