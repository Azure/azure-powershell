...
namespace Microsoft.Azure.Management.Billing
{
    ...
    internal partial class PoliciesOperations : IServiceOperations<BillingManagementClient>, IPoliciesOperations
    {
        ...
        /// view charges at pay-as-you-go prices. Possible values include: 'Allowed',
        /// 'NotAllowed'
        /// </param>
        /// <param name='customHeaders'>
        /// Headers that will be added to request.
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<CustomerPolicy>> UpdateCustomerWithHttpMessagesAsync(string billingAccountName, string customerName, string viewCharges = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
