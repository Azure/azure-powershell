...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public static partial class BillingPropertyOperationsExtensions
    {
            ...
            {
                return operations.UpdateAsync(costCenter).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BillingProperty> UpdateAsync(this IBillingPropertyOperations operations, string costCenter = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
