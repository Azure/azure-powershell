...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public static partial class ProductsOperationsExtensions
    {
            ...
            {
                return operations.MoveAsync(billingAccountName, productName, destinationInvoiceSectionId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Product> MoveAsync(this IProductsOperations operations, string billingAccountName, string productName, string destinationInvoiceSectionId = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.ValidateMoveAsync(billingAccountName, productName, destinationInvoiceSectionId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ValidateProductTransferEligibilityResult> ValidateMoveAsync(this IProductsOperations operations, string billingAccountName, string productName, string destinationInvoiceSectionId = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
