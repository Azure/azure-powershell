...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public static partial class InvoiceSectionsOperationsExtensions
    {
        ...
        /// </param>
        public static Microsoft.Rest.Azure.IPage<InvoiceSection> ListByBillingProfile(this IInvoiceSectionsOperations operations, string billingAccountName, string billingProfileName)
        {
                return ((IInvoiceSectionsOperations)operations).ListByBillingProfileAsync(billingAccountName, billingProfileName).GetAwaiter().GetResult();
        }
        ...
        {
                return ((IInvoiceSectionsOperations)operations).GetAsync(billingAccountName, billingProfileName, invoiceSectionName).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<InvoiceSection> GetAsync(this IInvoiceSectionsOperations operations, string billingAccountName, string billingProfileName, string invoiceSectionName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// </param>
        public static Microsoft.Rest.Azure.IPage<InvoiceSection> ListByBillingProfileNext(this IInvoiceSectionsOperations operations, string nextPageLink)
        {
                return ((IInvoiceSectionsOperations)operations).ListByBillingProfileNextAsync(nextPageLink).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<InvoiceSection>> ListByBillingProfileNextAsync(this IInvoiceSectionsOperations operations, string nextPageLink, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
