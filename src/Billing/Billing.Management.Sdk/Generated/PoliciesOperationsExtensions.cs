...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public static partial class PoliciesOperationsExtensions
    {
            ...
            {
                return operations.UpdateCustomerAsync(billingAccountName, customerName, viewCharges).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<CustomerPolicy> UpdateCustomerAsync(this IPoliciesOperations operations, string billingAccountName, string customerName, string viewCharges = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
