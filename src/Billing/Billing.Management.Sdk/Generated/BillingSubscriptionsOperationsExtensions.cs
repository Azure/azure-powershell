...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public static partial class BillingSubscriptionsOperationsExtensions
    {
            ...
            {
                return operations.MoveAsync(billingAccountName, destinationInvoiceSectionId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BillingSubscription> MoveAsync(this IBillingSubscriptionsOperations operations, string billingAccountName, string destinationInvoiceSectionId, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.ValidateMoveAsync(billingAccountName, destinationInvoiceSectionId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ValidateSubscriptionTransferEligibilityResult> ValidateMoveAsync(this IBillingSubscriptionsOperations operations, string billingAccountName, string destinationInvoiceSectionId, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.BeginMoveAsync(billingAccountName, destinationInvoiceSectionId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BillingSubscription> BeginMoveAsync(this IBillingSubscriptionsOperations operations, string billingAccountName, string destinationInvoiceSectionId, CancellationToken cancellationToken = default(CancellationToken))
            {
