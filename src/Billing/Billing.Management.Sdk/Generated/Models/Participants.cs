...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    public partial class Participants
    {
        ...
        /// <param name="status">The acceptance status of the participant.
        /// </param>

        /// <param name="statusDate">The date when the status got changed.
        /// </param>

        /// <param name="email">The email address of the participant.
        /// </param>
