...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    public partial class Invoice : Resource
    {
        ...
        /// </param>
        public Invoice(string id = default(string), string name = default(string), string type = default(string), Amount amountDue = default(Amount), string invoiceType = default(string), System.DateTime? dueDate = default(System.DateTime?), System.DateTime? invoiceDate = default(System.DateTime?), string status = default(string), Amount azurePrepaymentApplied = default(Amount), Amount billedAmount = default(Amount), Amount creditAmount = default(Amount), Amount freeAzureCreditApplied = default(Amount), Amount subTotal = default(Amount), Amount taxAmount = default(Amount), Amount totalAmount = default(Amount), System.DateTime? invoicePeriodStartDate = default(System.DateTime?), System.DateTime? invoicePeriodEndDate = default(System.DateTime?), bool? isMonthlyInvoice = default(bool?), string billingProfileId = default(string), string billingProfileDisplayName = default(string), string purchaseOrderNumber = default(string), System.Collections.Generic.IList<Document> documents = default(System.Collections.Generic.IList<Document>), System.Collections.Generic.IList<PaymentProperties> payments = default(System.Collections.Generic.IList<PaymentProperties>), string subscriptionId = default(string))
        ...
        /// Agreement.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.freeAzureCreditApplied")]
