...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    public partial class BillingAccountUpdateRequest
    {
        ...
        /// </param>
        public BillingAccountUpdateRequest(string agreementType = default(string), string accountType = default(string), string accountStatus = default(string), Enrollment enrollmentDetails = default(Enrollment), string displayName = default(string), AddressDetails soldTo = default(AddressDetails), BillingProfilesOnExpand billingProfiles = default(BillingProfilesOnExpand), System.Collections.Generic.IList<Department> departments = default(System.Collections.Generic.IList<Department>), System.Collections.Generic.IList<EnrollmentAccount> enrollmentAccounts = default(System.Collections.Generic.IList<EnrollmentAccount>), bool? hasReadAccess = default(bool?))
