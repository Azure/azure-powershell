...
namespace Microsoft.Azure.Management.Billing
{
    ...
    internal partial class BillingPropertyOperations : IServiceOperations<BillingManagementClient>, IBillingPropertyOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<BillingProperty>> UpdateWithHttpMessagesAsync(string costCenter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
