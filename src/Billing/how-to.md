...
- `build-module.ps1`
  - Builds the module DLL (`./bin/Az.Billing.private.dll`), creates the exported cmdlets, generates custom cmdlet test stubs, and updates `./Az.Billing.psd1` with Azure profile information.
