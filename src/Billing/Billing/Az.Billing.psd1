...
RequiredAssemblies = 'Microsoft.Azure.Commerce.UsageAggregates.dll', 
               ...
               'Microsoft.Azure.PowerShell.Consumption.Management.Sdk.dll'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Renamed ''Get-UsageAggregates'' to ''Get-AzUsageAggregate'' and added ''Get-UsageAggregates'' as the alias to avoid breaking change.'
