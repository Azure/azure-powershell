...
Gets Cloud HSMs.
.Description
The Get-AzCloudHsm cmdlet gets information about the Cloud HSMs in a subscription. You can view all Cloud HSMs instances in a subscription, or filter your results by a resource group or a particular Cloud HSM. Note that although specifying the resource group is optional for this cmdlet when you get a single Cloud HSM, you should do so for better performance.
.Example
{{ Add code here }}
.Example
{{ Add code here }}
