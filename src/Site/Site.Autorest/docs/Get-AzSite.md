...
```
Get-AzSite [-InputObject <ISiteIdentity>] [-Name <String>] [-ResourceGroupName <String>]
 [-ServicegroupName <String>] [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
