...
function Update-AzDatabricksVNetPeering {
    ...
    process {
        try {
            ...
            $hasDatabrickAddressSpaceAddressPrefix = $PSBoundParameters.Remove('DatabrickAddressSpaceAddressPrefix')
            $hasDatabrickVirtualNetworkId = $PSBoundParameters.Remove('DatabrickVirtualNetworkId')
            $hasRemoteAddressSpaceAddressPrefix = $PSBoundParameters.Remove('RemoteAddressSpaceAddressPrefix')
            ...
            if ($hasDatabrickAddressSpaceAddressPrefix) {
                $vnetPeering.DatabrickAddressSpaceAddressPrefix = $DatabrickAddressSpaceAddressPrefix
            }
            if ($hasDatabrickVirtualNetworkId) {
                $vnetPeering.DatabrickVirtualNetworkId = $DatabrickVirtualNetworkId
            }
            if ($hasRemoteAddressSpaceAddressPrefix) {
                $vnetPeering.RemoteAddressSpaceAddressPrefix = $RemoteAddressSpaceAddressPrefix
            }
