...
namespace Microsoft.Azure.PowerShell.Cmdlets.Databricks.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzDatabricksVNetPeering_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzDatabricksVNetPeering_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="VirtualNetworkPeeringParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20220401Preview.IVirtualNetworkPeering _virtualNetworkPeeringParameter;

        /// <summary>Peerings in a VirtualNetwork resource</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Peerings in a VirtualNetwork resource", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Peerings in a VirtualNetwork resource",
        SerializedName = @"virtualNetworkPeeringParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20220401Preview.IVirtualNetworkPeering) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20220401Preview.IVirtualNetworkPeering VirtualNetworkPeeringParameter { get => this._virtualNetworkPeeringParameter; set => this._virtualNetworkPeeringParameter = value; }
        ...
        /// <returns>a duplicate instance of NewAzDatabricksVNetPeering_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Databricks.Cmdlets.NewAzDatabricksVNetPeering_CreateViaIdentity Clone()
        {
            var clone = new NewAzDatabricksVNetPeering_CreateViaIdentity();
            ...
            clone.VirtualNetworkPeeringParameter = this.VirtualNetworkPeeringParameter;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzDatabricksVNetPeering_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzDatabricksVNetPeering_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VNetPeeringCreateOrUpdateViaIdentity(InputObject.Id, VirtualNetworkPeeringParameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VNetPeeringCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.WorkspaceName ?? null, InputObject.SubscriptionId ?? null, InputObject.PeeringName ?? null, VirtualNetworkPeeringParameter, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=VirtualNetworkPeeringParameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20220401Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=VirtualNetworkPeeringParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=VirtualNetworkPeeringParameter })
                    {
