...
Describe 'Update-AzDatabricksWorkspace' {
    ...
    It 'UpdateViaIdentityForEncryption' {
        ...
        ## Update EncryptionKeyVersion to empty
        $dbr = Update-AzDatabricksWorkspace -InputObject $dbr -EncryptionKeySource 'Microsoft.KeyVault' -EncryptionKeyVaultUri $env.keyVaultUri -EncryptionKeyName $env.keyVaultKeyName
        $dbr.EncryptionKeyName | Should -Be $env.keyVaultKeyName
        $dbr.EncryptionKeySource | Should -Be 'Microsoft.KeyVault'
        $dbr.EncryptionKeyVaultUri | Should -Be $env.keyVaultUri
        $dbr.EncryptionKeyVersion | Should -Be ''
