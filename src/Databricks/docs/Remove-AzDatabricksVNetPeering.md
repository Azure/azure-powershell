...
```powershell
Remove-AzDatabricksVNetPeering -Name vnet-peering-t1 -WorkspaceName azps-databricks-t1 -ResourceGroupName azps_test_gp_db 
```
...
```powershell
Get-AzDatabricksVNetPeering -Name vnet-peering-t1 -WorkspaceName azps-databricks-t1 -ResourceGroupName azps_test_gp_db  | Remove-AzDatabricksVNetPeering
```
