...
```powershell
Get-AzDatabricksVNetPeering -WorkspaceName azps-databricks-t1 -ResourceGroupName azps_test_gp_db
```
...
```powershell
Get-AzDatabricksVNetPeering -WorkspaceName azps-databricks-t1 -ResourceGroupName azps_test_gp_db -Name vnet-peering-t1
```
