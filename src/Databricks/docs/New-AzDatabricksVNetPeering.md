...
```powershell
New-AzDatabricksVNetPeering -Name vnet-peering-t1 -WorkspaceName azps-databricks-t1 -ResourceGroupName azps_test_gp_db -RemoteVirtualNetworkId '/subscriptions/{subId}/resourceGroups/azps_test_gp_db/providers/Microsoft.Network/virtualNetworks/azps-VNnet-t1'
```
