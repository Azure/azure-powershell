...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added breaking change announcement for ''Update-AzDatabricksVNetPeering'': parameters ''AllowForwardedTraffic'', ''AllowGatewayTransit'', ''AllowVirtualNetworkAccess'' and ''UseRemoteGateway'' will change from Boolean to SwitchParameter'
