...
Update-AzDatabricksWorkspace -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-AccessConnectorId <String>] [-AccessConnectorId <String>] [-AccessConnectorIdentityType <IdentityType>]
 [-AccessConnectorUserAssignedIdentityId <String>] [AutomaticClusterUpdateValue <AutomaticClusterUpdateValue>]
 [-DefaultStorageFirewall <DefaultStorageFirewall>] [-EnhancedSecurityMonitoringValue <EnhancedSecurityMonitoringValue>]
