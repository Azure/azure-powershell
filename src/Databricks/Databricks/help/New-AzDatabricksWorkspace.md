...
New-AzDatabricksWorkspace -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Location <String> [-ManagedResourceGroupName <String>] [-AccessConnectorId <String>]
 [-AccessConnectorIdentityType <IdentityType>] [-AccessConnectorUserAssignedIdentityId <String>]
 [-AmlWorkspaceId <String>] [AutomaticClusterUpdateValue <AutomaticClusterUpdateValue>] 
 [-Authorization <IWorkspaceProviderAuthorization[]>] [-ComplianceSecurityProfileComplianceStandard <ComplianceStandard>] [-ComplianceSecurityProfileValue <ComplianceSecurityProfileValue>] [-DefaultStorageFirewall <DefaultStorageFirewall>][-EnableNoPublicIP] [-EncryptionKeyName <String>] [-EncryptionKeySource <KeySource>] [-EncryptionKeyVaultUri <String>] [-EncryptionKeyVersion <String>] [-EnhancedSecurityMonitoringValue <EnhancedSecurityMonitoringValue>]
