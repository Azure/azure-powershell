...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzContainerRegistry_Create", SupportsShouldProcess = true)]
    ...
    public partial class NewAzContainerRegistry_Create : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.IRegistry _registry;

        /// <summary>An object that represents a container registry.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "An object that represents a container registry.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"An object that represents a container registry.",
        SerializedName = @"registry",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.IRegistry) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.IRegistry Registry { get => this._registry; set => this._registry = value; }
        ...
        /// <returns>a duplicate instance of NewAzContainerRegistry_Create</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets.NewAzContainerRegistry_Create Clone()
        {
            var clone = new NewAzContainerRegistry_Create();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzContainerRegistry_Create" /> cmdlet class.
        /// </summary>
        public NewAzContainerRegistry_Create()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RegistriesCreate(SubscriptionId, ResourceGroupName, Name, Registry, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Name=Name,body=Registry})
                    {
