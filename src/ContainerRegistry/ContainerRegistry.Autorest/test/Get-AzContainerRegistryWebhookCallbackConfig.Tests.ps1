if(($null -eq $TestName) -or ($TestName -contains 'Get-AzContainerRegistryWebhookCallbackConfig'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Get-AzContainerRegistryWebhookCallbackConfig.Recording.json'
