...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzContainerRegistryPrivateEndpointConnection_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzContainerRegistryPrivateEndpointConnection_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "An object that represents a private endpoint connection for a container registry.", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.IPrivateEndpointConnection PrivateEndpointConnection { get => this._privateEndpointConnection; set => this._privateEndpointConnection = value; }
        ...
        /// <returns>
        /// a duplicate instance of NewAzContainerRegistryPrivateEndpointConnection_CreateViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets.NewAzContainerRegistryPrivateEndpointConnection_CreateViaIdentity Clone()
        {
            var clone = new NewAzContainerRegistryPrivateEndpointConnection_CreateViaIdentity();
            ...
            clone.PrivateEndpointConnection = this.PrivateEndpointConnection;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzContainerRegistryPrivateEndpointConnection_CreateViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public NewAzContainerRegistryPrivateEndpointConnection_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PrivateEndpointConnectionsCreateOrUpdateViaIdentity(InputObject.Id, PrivateEndpointConnection, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PrivateEndpointConnectionsCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.RegistryName ?? null, InputObject.PrivateEndpointConnectionName ?? null, PrivateEndpointConnection, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=PrivateEndpointConnection})
                    {
