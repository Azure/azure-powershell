...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzContainerRegistryReplication_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzContainerRegistryReplication_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.IReplication _replication;

        /// <summary>An object that represents a replication for a container registry.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "An object that represents a replication for a container registry.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"An object that represents a replication for a container registry.",
        SerializedName = @"replication",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.IReplication) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.IReplication Replication { get => this._replication; set => this._replication = value; }
        ...
        /// <returns>a duplicate instance of NewAzContainerRegistryReplication_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets.NewAzContainerRegistryReplication_CreateViaIdentity Clone()
        {
            var clone = new NewAzContainerRegistryReplication_CreateViaIdentity();
            ...
            clone.Replication = this.Replication;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzContainerRegistryReplication_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzContainerRegistryReplication_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ReplicationsCreateViaIdentity(InputObject.Id, Replication, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ReplicationsCreate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.RegistryName ?? null, InputObject.ReplicationName ?? null, Replication, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=Replication})
                    {
