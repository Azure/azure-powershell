...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzContainerRegistryConnectedRegistry_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzContainerRegistryConnectedRegistry_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ConnectedRegistryCreateParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.IConnectedRegistry _connectedRegistryCreateParameter;

        /// <summary>An object that represents a connected registry for a container registry.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "An object that represents a connected registry for a container registry.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"An object that represents a connected registry for a container registry.",
        SerializedName = @"connectedRegistryCreateParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.IConnectedRegistry) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.IConnectedRegistry ConnectedRegistryCreateParameter { get => this._connectedRegistryCreateParameter; set => this._connectedRegistryCreateParameter = value; }
        ...
        /// <returns>
        /// a duplicate instance of NewAzContainerRegistryConnectedRegistry_CreateViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets.NewAzContainerRegistryConnectedRegistry_CreateViaIdentity Clone()
        {
            var clone = new NewAzContainerRegistryConnectedRegistry_CreateViaIdentity();
            ...
            clone.ConnectedRegistryCreateParameter = this.ConnectedRegistryCreateParameter;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzContainerRegistryConnectedRegistry_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzContainerRegistryConnectedRegistry_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ConnectedRegistriesCreateViaIdentity(InputObject.Id, ConnectedRegistryCreateParameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ConnectedRegistriesCreate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.RegistryName ?? null, InputObject.ConnectedRegistryName ?? null, ConnectedRegistryCreateParameter, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ConnectedRegistryCreateParameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20190601Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ConnectedRegistryCreateParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ConnectedRegistryCreateParameter })
                    {
