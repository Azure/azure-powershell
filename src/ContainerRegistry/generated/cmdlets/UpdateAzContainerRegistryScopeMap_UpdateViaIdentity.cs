...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzContainerRegistryScopeMap_UpdateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzContainerRegistryScopeMap_UpdateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ScopeMapUpdateParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.IScopeMapUpdateParameters _scopeMapUpdateParameter;

        /// <summary>The properties for updating the scope map.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The properties for updating the scope map.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The properties for updating the scope map.",
        SerializedName = @"scopeMapUpdateParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.IScopeMapUpdateParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.IScopeMapUpdateParameters ScopeMapUpdateParameter { get => this._scopeMapUpdateParameter; set => this._scopeMapUpdateParameter = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzContainerRegistryScopeMap_UpdateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets.UpdateAzContainerRegistryScopeMap_UpdateViaIdentity Clone()
        {
            var clone = new UpdateAzContainerRegistryScopeMap_UpdateViaIdentity();
            ...
            clone.ScopeMapUpdateParameter = this.ScopeMapUpdateParameter;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ScopeMapsUpdateViaIdentity(InputObject.Id, ScopeMapUpdateParameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ScopeMapsUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.RegistryName ?? null, InputObject.ScopeMapName ?? null, ScopeMapUpdateParameter, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ScopeMapUpdateParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzContainerRegistryScopeMap_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzContainerRegistryScopeMap_UpdateViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20190601Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ScopeMapUpdateParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ScopeMapUpdateParameter })
                    {
