...
Update-AzContainerRegistryCredential -RegistryName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -Name <PasswordName> [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Update-AzContainerRegistryCredential -InputObject <IContainerRegistryIdentity>
 -RegenerateCredentialParameter <IRegenerateCredentialParameters> [-DefaultProfile <PSObject>] [-WhatIf]
