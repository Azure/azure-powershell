...
```
Update-AzContainerRegistryScopeMap -Name <String> -RegistryInputObject <IContainerRegistryIdentity>
 [-Action <String[]>] [-Description <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
