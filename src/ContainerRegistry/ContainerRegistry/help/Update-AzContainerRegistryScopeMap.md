...
```
Update-AzContainerRegistryScopeMap -Name <String> -RegistryName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -ScopeMapUpdateParameter <IScopeMapUpdateParameters> [-DefaultProfile <PSObject>]
...
Update-AzContainerRegistryScopeMap -InputObject <IContainerRegistryIdentity> [-Action <String[]>]
 [-Description <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Update-AzContainerRegistryScopeMap -InputObject <IContainerRegistryIdentity>
 -ScopeMapUpdateParameter <IScopeMapUpdateParameters> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf]
