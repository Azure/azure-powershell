...
```
New-AzContainerRegistryExportPipeline -Name <String> -RegistryName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -ExportPipelineCreateParameter <IExportPipeline> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzContainerRegistryExportPipeline -InputObject <IContainerRegistryIdentity> [-IdentityPrincipalId <String>]
...
New-AzContainerRegistryExportPipeline -InputObject <IContainerRegistryIdentity>
 -ExportPipelineCreateParameter <IExportPipeline> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf]
