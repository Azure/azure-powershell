...
### Get (Default)
```
Get-AzContainerRegistryTaskDetail -RegistryName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] -TaskName <String> [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
