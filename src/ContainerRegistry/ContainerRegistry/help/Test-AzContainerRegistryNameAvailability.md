...
### Check
```
Test-AzContainerRegistryNameAvailability [-SubscriptionId <String>]
 -RegistryNameCheckRequest <IRegistryNameCheckRequest> [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
