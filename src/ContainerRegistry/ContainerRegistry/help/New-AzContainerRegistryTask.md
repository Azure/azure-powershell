...
New-AzContainerRegistryTask -Name <String> -RegistryName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -Location <String> [-AgentConfigurationCpu <Int32>] [-AgentPoolName <String>]
 ...
 [-LogTemplate <String>] [-PlatformArchitecture <Architecture>] [-PlatformOS <OS>] [-PlatformVariant <Variant>]
 ...
 [-TriggerSourceTrigger <ISourceTrigger[]>] [-TriggerTimerTrigger <ITimerTrigger[]>]
...
```
New-AzContainerRegistryTask -Name <String> -RegistryName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -TaskCreateParameter <ITask> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
