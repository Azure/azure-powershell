...
Import-AzContainerRegistryImage -RegistryName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -SourceImage <String> [-CredentialsPassword <String>] [-CredentialsUsername <String>] [-Mode <ImportMode>]
 [-SourceRegistryUri <String>] [-SourceResourceId <String>] [-TargetTag <String[]>]
 [-UntaggedTargetRepository <String[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-WhatIf]
