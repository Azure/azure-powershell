...
```
Update-AzContainerRegistryToken -Name <String> -RegistryName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -TokenUpdateParameter <ITokenUpdateParameters> [-DefaultProfile <PSObject>]
...
```
Update-AzContainerRegistryToken -InputObject <IContainerRegistryIdentity>
 -TokenUpdateParameter <ITokenUpdateParameters> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
