...
- `build-module.ps1`
  - Builds the module DLL (`./bin/Az.ContainerRegistry.private.dll`), creates the exported cmdlets, generates custom cmdlet test stubs, and updates `./Az.ContainerRegistry.psd1` with Azure profile information.
