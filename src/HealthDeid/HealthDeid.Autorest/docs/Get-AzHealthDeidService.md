...
### List (Default)
```
Get-AzHealthDeidService [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-AzHealthDeidService -InputObject <IHealthDeidIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
