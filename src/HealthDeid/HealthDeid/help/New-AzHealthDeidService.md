...
```
New-AzHealthDeidService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Location <String> [-EnableSystemAssignedIdentity] [-PublicNetworkAccess <String>] [-Tag <Hashtable>]
