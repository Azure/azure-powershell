---
external help file: Az.HealthDeid-help.xml
Module Name: Az.HealthDeid
online version: https://learn.microsoft.com/powershell/module/az.healthdeid/remove-azhealthdeidservice
schema: 2.0.0
---

# Remove-AzHealthDeidService
...
### Delete (Default)
```
Remove-AzHealthDeidService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzHealthDeidService -InputObject <IHealthDeidIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
