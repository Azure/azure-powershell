...
function New-AzStorageAccount {
    ...
    param(
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1StorageEncryption', Mandatory, ValueFromPipeline, HelpMessage='Identity Parameter')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', Mandatory, ValueFromPipeline, HelpMessage='Identity Parameter')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Path')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.IStorageIdentity]
        # Identity Parameter
        ${InputObject},
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1StorageEncryption', HelpMessage='Specify IdentityType as ''SystemAssigned''')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', HelpMessage='Specify IdentityType as ''SystemAssigned''')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1StorageEncryption', HelpMessage='Required for storage accounts where kind = BlobStorage. The access tier used for billing.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', HelpMessage='Required for storage accounts where kind = BlobStorage. The access tier used for billing.')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1StorageEncryption', HelpMessage='A boolean indicating whether or not the service encrypts the data as it is stored.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', HelpMessage='A boolean indicating whether or not the service encrypts the data as it is stored.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.Management.Automation.SwitchParameter]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1StorageEncryption', Mandatory, HelpMessage='Gets or sets the custom domain name assigned to the storage account. Name is the CNAME source.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', Mandatory, HelpMessage='Gets or sets the custom domain name assigned to the storage account. Name is the CNAME source.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.String]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1StorageEncryption', HelpMessage='Allows https traffic only to storage service if sets to true.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', HelpMessage='Allows https traffic only to storage service if sets to true.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.Management.Automation.SwitchParameter]
        # Allows https traffic only to storage service if sets to true.
        ${EnableHttpsTrafficOnly},
    
        #[Parameter(ParameterSetName='CreateExpanded1', Mandatory, HelpMessage='The encryption keySource (provider). Possible values (case-insensitive): Microsoft.Storage, Microsoft.Keyvault')]
        #[Parameter(ParameterSetName='CreateViaIdentityExpanded1', Mandatory, HelpMessage='The encryption keySource (provider). Possible values (case-insensitive): Microsoft.Storage, Microsoft.Keyvault')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1StorageEncryption')]
        [System.Management.Automation.SwitchParameter]
        ${StorageEncryption},

        [Parameter(ParameterSetName='CreateExpanded1KeyVaultEncryption')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption')]
        [System.Management.Automation.SwitchParameter]
        ${KeyVaultEncryption},
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', HelpMessage='The Uri of KeyVault.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.String]
        # The Uri of KeyVault.
        ${KeyVaultUri},
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', HelpMessage='The version of KeyVault key.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.String]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1StorageEncryption', Mandatory, HelpMessage='Required. Indicates the type of storage account.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', Mandatory, HelpMessage='Required. Indicates the type of storage account.')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1StorageEncryption', HelpMessage='Specifies whether traffic is bypassed for Logging/Metrics/AzureServices. Possible values are any combination of Logging|Metrics|AzureServices (For example, "Logging, Metrics"), or None to bypass none of those traffics.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', HelpMessage='Specifies whether traffic is bypassed for Logging/Metrics/AzureServices. Possible values are any combination of Logging|Metrics|AzureServices (For example, "Logging, Metrics"), or None to bypass none of those traffics.')]
        ...
        [Parameter(ParameterSetName='CreateExpanded1StorageEncryption', Mandatory, HelpMessage='Specifies the default action of allow or deny when no other rules match.')]
        [Parameter(ParameterSetName='CreateExpanded1KeyVaultEncryption', Mandatory, HelpMessage='Specifies the default action of allow or deny when no other rules match.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1StorageEncryption', Mandatory, HelpMessage='Specifies the default action of allow or deny when no other rules match.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', Mandatory, HelpMessage='Specifies the default action of allow or deny when no other rules match.')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1StorageEncryption', HelpMessage='Sets the IP ACL rules')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', HelpMessage='Sets the IP ACL rules')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1StorageEncryption', HelpMessage='Sets the virtual network rules')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', HelpMessage='Sets the virtual network rules')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1StorageEncryption', HelpMessage='Indicates the type of storage account.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', HelpMessage='Indicates the type of storage account.')]
        [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.Kind])]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.Kind]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1StorageEncryption', Mandatory, HelpMessage='Gets or sets the SKU name. Required for account creation; optional for update. Note that in older versions, SKU name was called accountType.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', Mandatory, HelpMessage='Gets or sets the SKU name. Required for account creation; optional for update. Note that in older versions, SKU name was called accountType.')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1StorageEncryption', HelpMessage='The restrictions because of which SKU cannot be used. This is empty if there are no restrictions.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', HelpMessage='The restrictions because of which SKU cannot be used. This is empty if there are no restrictions.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        ...
        [Parameter(ParameterSetName='CreateExpanded1StorageEncryption', HelpMessage='Indicates whether indirect CName validation is enabled. Default value is false. This should only be set on updates.')]
        [Parameter(ParameterSetName='CreateExpanded1KeyVaultEncryption', HelpMessage='Indicates whether indirect CName validation is enabled. Default value is false. This should only be set on updates.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1StorageEncryption', HelpMessage='Indicates whether indirect CName validation is enabled. Default value is false. This should only be set on updates.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpanded1KeyVaultEncryption', HelpMessage='Indicates whether indirect CName validation is enabled. Default value is false. This should only be set on updates.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.Management.Automation.SwitchParameter]
