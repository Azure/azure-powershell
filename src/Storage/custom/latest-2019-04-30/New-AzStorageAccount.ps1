...
function New-AzStorageAccount {
    ...
    param(
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', Mandatory, ValueFromPipeline, HelpMessage='Identity Parameter')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', Mandatory, ValueFromPipeline, HelpMessage='Identity Parameter')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Path')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.IStorageIdentity]
        # Identity Parameter
        ${InputObject},
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', HelpMessage='Required for storage accounts where kind = BlobStorage. The access tier used for billing.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', HelpMessage='Required for storage accounts where kind = BlobStorage. The access tier used for billing.')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', HelpMessage='A boolean indicating whether or not the service encrypts the data as it is stored.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', HelpMessage='A boolean indicating whether or not the service encrypts the data as it is stored.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.Management.Automation.SwitchParameter]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', Mandatory, HelpMessage='Gets or sets the custom domain name assigned to the storage account. Name is the CNAME source.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', Mandatory, HelpMessage='Gets or sets the custom domain name assigned to the storage account. Name is the CNAME source.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.String]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', HelpMessage='Enables Azure Files AAD Integration for SMB if sets to true.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', HelpMessage='Enables Azure Files AAD Integration for SMB if sets to true.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.Management.Automation.SwitchParameter]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', HelpMessage='Allows https traffic only to storage service if sets to true.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', HelpMessage='Allows https traffic only to storage service if sets to true.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.Management.Automation.SwitchParameter]
        # Allows https traffic only to storage service if sets to true.
        ${EnableHttpsTrafficOnly},
    
        #[Parameter(ParameterSetName='CreateExpanded', Mandatory, HelpMessage='The encryption keySource (provider). Possible values (case-insensitive): Microsoft.Storage, Microsoft.Keyvault')]
        #[Parameter(ParameterSetName='CreateViaIdentityExpanded', Mandatory, HelpMessage='The encryption keySource (provider). Possible values (case-insensitive): Microsoft.Storage, Microsoft.Keyvault')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption')]
        [System.Management.Automation.SwitchParameter]
        ${StorageEncryption},

        [Parameter(ParameterSetName='CreateExpandedKeyVaultEncryption')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption')]
        [System.Management.Automation.SwitchParameter]
        ${KeyVaultEncryption},
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', HelpMessage='Account HierarchicalNamespace enabled if sets to true.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', HelpMessage='Account HierarchicalNamespace enabled if sets to true.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.Management.Automation.SwitchParameter]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', HelpMessage='The name of KeyVault key.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.String]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', HelpMessage='The Uri of KeyVault.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.String]
        # The Uri of KeyVault.
        ${KeyVaultUri},
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', HelpMessage='The version of KeyVault key.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.String]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', Mandatory, HelpMessage='Required. Indicates the type of storage account.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', Mandatory, HelpMessage='Required. Indicates the type of storage account.')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', Mandatory, HelpMessage='Required. Gets or sets the location of the resource. This will be one of the supported and registered Azure Geo Regions (e.g. West US, East US, Southeast Asia, etc.). The geo region of a resource cannot be changed once it is created, but if an identical geo region is specified on update, the request will succeed.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', Mandatory, HelpMessage='Required. Gets or sets the location of the resource. This will be one of the supported and registered Azure Geo Regions (e.g. West US, East US, Southeast Asia, etc.). The geo region of a resource cannot be changed once it is created, but if an identical geo region is specified on update, the request will succeed.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.String]
        # Required. Gets or sets the location of the resource. This will be one of the supported and registered Azure Geo Regions (e.g. West US, East US, Southeast Asia, etc.). The geo region of a resource cannot be changed once it is created, but if an identical geo region is specified on update, the request will succeed.
        ${Location},
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', HelpMessage='Specifies whether traffic is bypassed for Logging/Metrics/AzureServices. Possible values are any combination of Logging|Metrics|AzureServices (For example, "Logging, Metrics"), or None to bypass none of those traffics.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', HelpMessage='Specifies whether traffic is bypassed for Logging/Metrics/AzureServices. Possible values are any combination of Logging|Metrics|AzureServices (For example, "Logging, Metrics"), or None to bypass none of those traffics.')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', Mandatory, HelpMessage='Specifies the default action of allow or deny when no other rules match.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', Mandatory, HelpMessage='Specifies the default action of allow or deny when no other rules match.')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', HelpMessage='Sets the IP ACL rules')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', HelpMessage='Sets the IP ACL rules')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', HelpMessage='Sets the virtual network rules')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', HelpMessage='Sets the virtual network rules')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', HelpMessage='Indicates the type of storage account.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', HelpMessage='Indicates the type of storage account.')]
        [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.Kind])]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.Kind]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', Mandatory, HelpMessage='Gets or sets the SKU name. Required for account creation; optional for update. Note that in older versions, SKU name was called accountType.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', Mandatory, HelpMessage='Gets or sets the SKU name. Required for account creation; optional for update. Note that in older versions, SKU name was called accountType.')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', HelpMessage='The restrictions because of which SKU cannot be used. This is empty if there are no restrictions.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', HelpMessage='The restrictions because of which SKU cannot be used. This is empty if there are no restrictions.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        ...
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', HelpMessage='Gets or sets a list of key value pairs that describe the resource. These tags can be used for viewing and grouping this resource (across resource groups). A maximum of 15 tags can be provided for a resource. Each tag must have a key with a length no greater than 128 characters and a value with a length no greater than 256 characters.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', HelpMessage='Gets or sets a list of key value pairs that describe the resource. These tags can be used for viewing and grouping this resource (across resource groups). A maximum of 15 tags can be provided for a resource. Each tag must have a key with a length no greater than 128 characters and a value with a length no greater than 256 characters.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.Collections.Hashtable]
        # Gets or sets a list of key value pairs that describe the resource. These tags can be used for viewing and grouping this resource (across resource groups). A maximum of 15 tags can be provided for a resource. Each tag must have a key with a length no greater than 128 characters and a value with a length no greater than 256 characters.
        ${Tag},
    
        [Parameter(ParameterSetName='CreateExpandedStorageEncryption', HelpMessage='Indicates whether indirect CName validation is enabled. Default value is false. This should only be set on updates.')]
        [Parameter(ParameterSetName='CreateExpandedKeyVaultEncryption', HelpMessage='Indicates whether indirect CName validation is enabled. Default value is false. This should only be set on updates.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedStorageEncryption', HelpMessage='Indicates whether indirect CName validation is enabled. Default value is false. This should only be set on updates.')]
        [Parameter(ParameterSetName='CreateViaIdentityExpandedKeyVaultEncryption', HelpMessage='Indicates whether indirect CName validation is enabled. Default value is false. This should only be set on updates.')]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
        [System.Management.Automation.SwitchParameter]
