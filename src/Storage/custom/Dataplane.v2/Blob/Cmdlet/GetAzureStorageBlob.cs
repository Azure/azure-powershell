...
namespace Microsoft.Azure.Commands.Storage.Blob.Cmdlet
{
    ...
    [Cmdlet("Get", Azure.Commands.ResourceManager.Common.AzureRMConstants.AzurePrefix + "StorageBlob!V2", DefaultParameterSetName = NameParameterSet),OutputType(typeof(AzureStorageBlob))]
    public class GetAzureStorageBlobCommand : StorageCloudBlobCmdletBase
    {
        ...
        internal async Task<CloudBlobContainer> GetCloudBlobContainerByName(IStorageBlobManagement localChannel, string containerName, bool skipCheckExists = false)
        {
            ...
            {
                throw new ArgumentException(String.Format(ResourceV2.ContainerNotFound, containerName));
            }
