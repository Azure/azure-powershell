...
namespace Microsoft.Azure.Commands.Storage.Blob.Cmdlet
{
    using Adapters;
    ...
    [Cmdlet("Start", Azure.Commands.ResourceManager.Common.AzureRMConstants.AzurePrefix + "StorageBlobIncrementalCopy!V2", SupportsShouldProcess = true, DefaultParameterSetName = ContainerParameterSet),OutputType(typeof(AzureStorageBlob))]
