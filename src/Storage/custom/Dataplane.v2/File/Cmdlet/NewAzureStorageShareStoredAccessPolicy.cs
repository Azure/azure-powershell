...
namespace Microsoft.Azure.Commands.Storage.File.Cmdlet
{
    ...
    [Cmdlet("New", Azure.Commands.ResourceManager.Common.AzureRMConstants.AzurePrefix + "StorageShareStoredAccessPolicy!V2", DefaultParameterSetName = Constants.ShareNameParameterSetName), OutputType(typeof(String))]
    public class NewAzureStorageShareStoredAccessPolicy : AzureStorageFileCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            {
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, ResourceV2.InvalidAccessPolicyName, this.Policy));
            }
            ...
            {
                throw new ResourceAlreadyExistException(String.Format(CultureInfo.CurrentCulture, ResourceV2.PolicyAlreadyExists, this.Policy));
            }
