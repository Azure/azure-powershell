...
namespace Microsoft.Azure.Commands.Storage.Common.Cmdlet
{
    ...
    [Cmdlet("New", Azure.Commands.ResourceManager.Common.AzureRMConstants.AzurePrefix + "StorageAccountSASToken!V2"), OutputType(typeof(String))]
            ...
            foreach (char op in permission)
            {
                switch (op)
                {
                    ...
                    case StorageNouns.Permission.List:
                        ...
                        break;
                    default:
                        throw new ArgumentException(string.Format(ResourceV2.InvalidAccessPermission, op));
                }
            }
