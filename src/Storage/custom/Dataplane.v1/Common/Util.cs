...
namespace Microsoft.WindowsAzure.Commands.Storage.Common
{
    ...
    internal static class Util
    {
        ...
        {
            ResourceV1.HumanReadableSizeFormat_Bytes,
            ResourceV1.HumanReadableSizeFormat_KiloBytes,
            ResourceV1.HumanReadableSizeFormat_MegaBytes,
            ResourceV1.HumanReadableSizeFormat_GigaBytes,
            ResourceV1.HumanReadableSizeFormat_TeraBytes,
            ResourceV1.HumanReadableSizeFormat_PetaBytes,
            ResourceV1.HumanReadableSizeFormat_ExaBytes
        };
