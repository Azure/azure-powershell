...
namespace Microsoft.WindowsAzure.Commands.Storage.Common
{
    ...
    internal class BlobUploadRequestQueue
    {
        ...
        public bool EnqueueRequest(string absoluteFilePath, BlobType type, string blobName)
        {
            ...
            {
                throw new ArgumentException(ResourceV1.BlobNameShouldBeEmptyWhenUploading);
            }
            else
            {
                BlobName = blobName;
            ...
            if (!System.IO.File.Exists(absoluteFilePath))
            {
                ...
                {
                    throw new ArgumentException(String.Format(ResourceV1.FileNotFound, absoluteFilePath));
                }
            }
        ...
        private string GetCommonDirectory(string dir1, string dir2)
        {
            ...
            {
                throw new ArgumentException(ResourceV1.InvalidFileName);
            }
