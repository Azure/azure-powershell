...
namespace Microsoft.WindowsAzure.Commands.Storage.Blob
{
    ...
    public class StorageDataMovementCmdletBase : StorageCloudBlobCmdletBase, IDisposable
    {
        ...
        {
            string overwriteMessage = string.Format(CultureInfo.CurrentCulture, ResourceV1.OverwriteConfirmation, Util.ConvertToString(destination));
            ...
            transferContext.ProgressHandler = new TransferProgressHandler((transferProgress) =>
                {
                    if (userData.Record != null)
                    {
                        ...
                        userData.Record.StatusDescription = string.Format(CultureInfo.CurrentCulture, ResourceV1.FileTransmitStatus, userData.Record.PercentComplete);
