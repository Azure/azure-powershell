...
namespace Microsoft.WindowsAzure.Commands.Storage.Blob.Cmdlet
{
    ...
    [Cmdlet("Get", Azure.Commands.ResourceManager.Common.AzureRMConstants.AzurePrefix + "StorageBlobCopyState!V1", DefaultParameterSetName = NameParameterSet),OutputType(typeof(AzureStorageBlob))]
    public class GetAzureStorageBlobCopyState : StorageCloudBlobCmdletBase
    {
        ...
        protected override void WriteTransmitSummaryStatus()
        {
            ...
            string summary = String.Format(ResourceV1.TransmitActiveSummary, localTotal,
        ...
        internal void WriteCopyProgress(CloudBlob blob, ProgressRecord progress)
        {
            ...
            string activity = String.Format(ResourceV1.CopyBlobStatus, blob.CopyState.Status.ToString(), blob.Name, blob.Container.Name, blob.CopyState.Source.ToString());
            progress.Activity = activity;
            string message = String.Format(ResourceV1.CopyPendingStatus, percent, blob.CopyState.BytesCopied, blob.CopyState.TotalBytes);
        ...
        {
            ProgressRecord records = new ProgressRecord(OutputStream.GetProgressId(taskId), ResourceV1.CopyBlobActivity, ResourceV1.CopyBlobActivity);
