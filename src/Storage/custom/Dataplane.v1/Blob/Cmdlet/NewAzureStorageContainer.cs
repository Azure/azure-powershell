...
namespace Microsoft.WindowsAzure.Commands.Storage.Blob.Cmdlet
{
    ...
    [Cmdlet("New", Azure.Commands.ResourceManager.Common.AzureRMConstants.AzurePrefix + "StorageContainer!V1"),OutputType(typeof(AzureStorageContainer))]
    public class NewAzureStorageContainerCommand : StorageCloudBlobCmdletBase
    {
        ...
        internal async Task CreateAzureContainer(long taskId, IStorageBlobManagement localChannel, string name, BlobContainerPublicAccessType accesslevel)
        {
            ...
            if (!created)
            {
                throw new ResourceAlreadyExistException(String.Format(ResourceV1.ContainerAlreadyExists, name));
            }
