...
namespace Microsoft.WindowsAzure.Commands.Storage.File.Cmdlet
{
    ...
    [Cmdlet("Set", Azure.Commands.ResourceManager.Common.AzureRMConstants.AzurePrefix + "StorageShareStoredAccessPolicy!V1", SupportsShouldProcess = true), OutputType(typeof(String))]
    public class SetAzureStorageShareStoredAccessPolicy : AzureStorageFileCmdletBase
    {
        ...
        internal string SetAzureShareStoredAccessPolicy(IStorageFileManagement localChannel, string shareName, string policyName, DateTime? startTime, DateTime? expiryTime, string permission, bool noStartTime, bool noExpiryTime)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, ResourceV1.PolicyNotFound, policyName));
            }
        ...
        public override void ExecuteCmdlet()
        {
            ...
            {
                throw new ArgumentException(ResourceV1.StartTimeParameterConflict);
            }

            if (NoExpiryTime && ExpiryTime != null)
            {
                throw new ArgumentException(ResourceV1.ExpiryTimeParameterConflict);
            }
