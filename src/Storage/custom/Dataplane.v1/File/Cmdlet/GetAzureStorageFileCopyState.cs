...
namespace Microsoft.WindowsAzure.Commands.Storage.File.Cmdlet
{
    ...
    [Cmdlet("Get", Azure.Commands.ResourceManager.Common.AzureRMConstants.AzurePrefix + "StorageFileCopyState!V1")]
    ...
    public class GetAzureStorageFileCopyStateCommand : AzureStorageFileCmdletBase
    {
        ...
        internal void WriteCopyProgress(CloudFile file, ProgressRecord progress)
        {
            ...
            string activity = String.Format(ResourceV1.CopyFileStatus, file.CopyState.Status.ToString(), file.GetFullPath(), file.Share.Name, file.CopyState.Source.ToString());
            progress.Activity = activity;
            string message = String.Format(ResourceV1.CopyPendingStatus, percent, file.CopyState.BytesCopied, file.CopyState.TotalBytes);
        ...
        {
            ProgressRecord records = new ProgressRecord(OutputStream.GetProgressId(taskId), ResourceV1.CopyFileActivity, ResourceV1.CopyFileActivity);
