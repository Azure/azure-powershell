        ...
        private CloudBlobClient BlobClient
        {
            get
            {
                if (this.blobClient == null)
                {
                    ...
                    {
                        throw new ArgumentException(ResourceV1.DefaultStorageCredentialsNotFound);
                    }
                    else
                    {
            ...
            try
            {
                switch (type)
                {
                    ...
                    case StorageServiceType.File:
                        ...
                        return sp;
                    default:
                        throw new ArgumentException(ResourceV1.InvalidStorageServiceType, "type");
                }
            }
            catch (AggregateException e) when (e.InnerException is StorageException)
            {
            ...
            try
            {
                switch (type)
                {
                    ...
                    case StorageServiceType.File:
                        ...
                        {
                            throw new InvalidOperationException(ResourceV1.FileNotSupportLogging);
                        }
