...
namespace Microsoft.Azure.Management.Storage
{
    ...
    public static partial class StorageTaskAssignmentsOperationsExtensions
    {
        ...
        /// </param>
        public static Microsoft.Rest.Azure.IPage<StorageTaskAssignment> List(this IStorageTaskAssignmentsOperations operations, string resourceGroupName, string accountName, int? maxpagesize = default(int?))
        {
                return ((IStorageTaskAssignmentsOperations)operations).ListAsync(resourceGroupName, accountName, maxpagesize).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<StorageTaskAssignment>> ListAsync(this IStorageTaskAssignmentsOperations operations, string resourceGroupName, string accountName, int? maxpagesize = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.ListWithHttpMessagesAsync(resourceGroupName, accountName, maxpagesize, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
            }
        }
