...
namespace Microsoft.Azure.Management.Storage.Models
{
    ...
    public partial class BlobInventoryPolicyRule
    {
        ...
        /// <param name="enabled">Rule is enabled when set to true.
        /// </param>
        ...
        /// <param name="destination">Container name where blob inventory files are stored. Must be pre-created.
        /// </param>

        /// <param name="definition">An object that defines the blob inventory policy rule.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets container name where blob inventory files are stored. Must be
        /// pre-created.
        /// </summary>
