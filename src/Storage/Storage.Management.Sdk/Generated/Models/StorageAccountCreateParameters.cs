...
namespace Microsoft.Azure.Management.Storage.Models
{
    ...
    public partial class StorageAccountCreateParameters
    {
        ...
        /// <param name="sku">Required. Gets or sets the SKU name.
        /// </param>
        ...
        /// <param name="extendedLocation">Optional. Set the extended location of the resource. If not set, the
        /// storage account will be created in Azure main region. Otherwise it will be
        /// created in the specified extended location
        /// </param>
        ...
        /// have a key with a length no greater than 128 characters and a value with a
        ...
        /// <param name="customDomain">User domain assigned to the storage account. Name is the CNAME source. Only
        ...
        /// <param name="enableHttpsTrafficOnly">Allows https traffic only to storage service if sets to true. The default
        ...
        /// <summary>
        /// Gets or sets required. Gets or sets the location of the resource. This will
        /// be one of the supported and registered Azure Geo Regions (e.g. West US,
        ...
        /// <summary>
        /// Gets or sets optional. Set the extended location of the resource. If not
        /// set, the storage account will be created in Azure main region. Otherwise it
        ...
        /// <summary>
        /// Gets or sets user domain assigned to the storage account. Name is the CNAME
        ...
        /// <summary>
        /// Gets or sets encryption settings to be used for server-side encryption for
        /// the storage account.
        /// </summary>
        ...
        /// for the premium block blobs storage account type. Possible values include: &#39;Hot&#39;, &#39;Cool&#39;, &#39;Premium&#39;, &#39;Cold&#39;, &#39;Smart&#39;
        /// </summary>
        ...
        /// immutability for all the new containers in the account by default.
        /// </summary>
