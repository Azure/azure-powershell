    ...
    internal partial class StorageTaskAssignmentsOperations : Microsoft.Rest.IServiceOperations<StorageManagementClient>, IStorageTaskAssignmentsOperations
    {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<StorageTaskAssignment>> GetWithHttpMessagesAsync(string resourceGroupName, string accountName, string storageTaskAssignmentName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (storageTaskAssignmentName != null)
            {
                ...
                if (!System.Text.RegularExpressions.Regex.IsMatch(storageTaskAssignmentName, "^[a-z0-9]{3,24}$"))
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.Pattern, "storageTaskAssignmentName", "^[a-z0-9]{3,24}$");
                }
            }
            // Tracing
            bool _shouldTrace = Microsoft.Rest.ServiceClientTracing.IsEnabled;
