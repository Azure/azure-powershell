...
AliasesToExport = 'Disable-AzStorageSoftDelete', 'Enable-AzStorageSoftDelete', 
               ...
               'Stop-CopyAzureStorageBlob', 'Enable-AzureStorageStaticWebsite',
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed parser logic when downloading blob from managed disk account with Sas Uri and bearer token on Linux and MacOS
