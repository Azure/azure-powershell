...
namespace Microsoft.Azure.Commands.Management.Storage
{
    ...
    /// </summary>
    [Cmdlet("Enable", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + StorageContainerDeleteRetentionPolicy, DefaultParameterSetName = AccountNameParameterSet, SupportsShouldProcess = true), OutputType(typeof(PSBlobServiceProperties))]
    public class EnableAzStorageContainerDeleteRetentionPolicyCommand : StorageBlobBaseCmdlet
    {
        ...
        {
            base.ExecuteCmdlet();
            if (ShouldProcess("ContainerDeleteRetentionPolicy", "Enable"))
            {
