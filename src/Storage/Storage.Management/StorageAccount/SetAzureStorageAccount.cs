...
namespace Microsoft.Azure.Commands.Management.Storage
{
    ...
    public class SetAzureStorageAccountCommand : StorageAccountBaseCmdlet
    {
        ...
        [CmdletParameterBreakingChange("EnableLargeFileShare", "11.0.0", "6.0.0", ChangeDescription = "EnableLargeFileShare parameter will be deprecated in a future release.")]
