...
{
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "StorageLocalUser", DefaultParameterSetName = AccountNameParameterSet), OutputType(typeof(PSLocalUser))]
    public class GetAzureStorageLocalUserCommand : StorageFileBaseCmdlet
    {
        /// <summary>
