...
{
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "StorageBlobInventoryPolicy", DefaultParameterSetName = AccountNameParameterSet), OutputType(typeof(PSBlobInventoryPolicy))]
    public class GetAzureStorageBlobInventoryPolicyCommand : StorageAccountBaseCmdlet
    {
        /// <summary>
