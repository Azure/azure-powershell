...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "StorageBlobInventoryPolicy", SupportsShouldProcess = true, DefaultParameterSetName = AccountNameParameterSet), OutputType(typeof(bool))]
    public class RemoveAzureStorageBlobInventoryPolicyCommand : StorageAccountBaseCmdlet
    {
        /// <summary>
        ...
        [Parameter(Position = 0,
            Mandatory = true,
            HelpMessage = "BlobInventoryPolicy Object to Remove",
            ValueFromPipeline = true,
            ParameterSetName = PolicyObjectParameterSet)]
        [ValidateNotNullOrEmpty]
        public PSBlobInventoryPolicy InputObject { get; set; }
        ...
        {
            base.ExecuteCmdlet();
            if (ShouldProcess(this.StorageAccountName, "Remove Storage Account Blob Inventory Policy"))
            {
