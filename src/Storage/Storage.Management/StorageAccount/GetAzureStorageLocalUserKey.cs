...
namespace Microsoft.Azure.Commands.Management.Storage
{
    ...
    public class GetAzureStorageLocalUserKeyCommand : StorageAccountBaseCmdlet
    {
        ...
        [Parameter(Position = 0,
            Mandatory = true,
            HelpMessage = "Local User Object to get Keys.",
            ValueFromPipeline = true,
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(this.UserName, "List Keys of Storage Account LocalUser:"))
            {

                LocalUserKeys keys = this.StorageClient.LocalUsers.ListKeys(
                            this.ResourceGroupName,
                            this.StorageAccountName,
                            this.UserName);

                WriteObject(new PSLocalUserKeys(keys));
            }
        }
    }
}
