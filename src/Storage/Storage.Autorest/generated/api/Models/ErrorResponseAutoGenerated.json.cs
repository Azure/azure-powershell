...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models
{
    ...
    public partial class ErrorResponseAutoGenerated
    {
        ...
        internal ErrorResponseAutoGenerated(Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject json)
        {
            ...
            {_error = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject>("error"), out var __jsonError) ? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ErrorDetail.FromJson(__jsonError) : Error;}
            AfterFromJson(json);
        }
