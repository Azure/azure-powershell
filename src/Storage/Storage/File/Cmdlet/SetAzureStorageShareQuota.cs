...
namespace Microsoft.WindowsAzure.Commands.Storage.File.Cmdlet
{
    ...
    public class SetAzureStorageShareQuota : AzureStorageFileCmdletBase
    {
        ...
        [CmdletParameterBreakingChangeWithVersion("Share", "13.0.0", "8.0.0", ChangeDescription = "The parameter Share will be deprecated, and a new mandatory parameter ShareClient will be added.")]
        [Parameter(
            Position = 0,
            Mandatory = true,
            ValueFromPipeline = true,
