...
namespace Microsoft.WindowsAzure.Commands.Storage.File.Cmdlet
{
    ...
    public class CloseAzureStorageFileHandle : AzureStorageFileCmdletBase
    {
        ...
        [Parameter(Mandatory = false, HelpMessage = "Disallow trailing dot (.) to suffex directory and file names.", ParameterSetName = ShareNameCloseAllParameterSetName)]
        [Parameter(Mandatory = false, HelpMessage = "Disallow trailing dot (.) to suffex directory and file names.", ParameterSetName = ShareNameCloseSingleParameterSetName)]
