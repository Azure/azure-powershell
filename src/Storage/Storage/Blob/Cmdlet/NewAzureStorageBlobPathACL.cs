...
{
    [Cmdlet("New", Azure.Commands.ResourceManager.Common.AzureRMConstants.AzurePrefix + "StorageBlobPathACL"), OutputType(typeof(PSPathAccessControlEntry))]
    public class NewAzStorageBlobPathACLCommand : AzureDataCmdlet
    {
