...
namespace Microsoft.WindowsAzure.Commands.Storage.Blob.Cmdlet
{
    ...
    public class NewAzureStorageContainerSasTokenCommand : StorageCloudBlobCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            //Create SAS builder
            BlobSasBuilder sasBuilder = SasTokenHelper.SetBlobSasBuilder_FromContainer(container, identifier, this.Permission, this.StartTime, this.ExpiryTime, this.IPAddressOrRange, this.Protocol, this.EncryptionScope, this.DelegatedUserObjectId, this.DelegatedUserTenantId);

            //Create SAS and output it
            string sasToken = SasTokenHelper.GetBlobSharedAccessSignature(Channel.StorageContext, sasBuilder, generateUserDelegationSas, ClientOptions, CmdletCancellationToken, this.DelegatedUserTenantId);
