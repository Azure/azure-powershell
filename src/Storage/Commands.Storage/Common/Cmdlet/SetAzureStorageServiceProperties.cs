...
namespace Microsoft.WindowsAzure.Commands.Storage.Common.Cmdlet
{
    ...
    /// </summary>
    [Cmdlet("Update", ResourceManager.Common.AzureRMConstants.AzurePrefix + "StorageServiceProperty", SupportsShouldProcess = true), OutputType(typeof(PSSeriviceProperties))]
