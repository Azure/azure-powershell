...
namespace Microsoft.WindowsAzure.Commands.Storage.Common.Cmdlet
{
    ...
    /// </summary>
    [Cmdlet("Enable", ResourceManager.Common.AzureRMConstants.AzurePrefix + "StorageDeleteRetentionPolicy", SupportsShouldProcess = true),OutputType(typeof(PSDeleteRetentionPolicy))]
