...
{
    [Cmdlet(VerbsLifecycle.Start, Constants.FileCopyCmdletName, SupportsShouldProcess = true, DefaultParameterSetName = ContainerNameParameterSet), OutputType(typeof(void))]
