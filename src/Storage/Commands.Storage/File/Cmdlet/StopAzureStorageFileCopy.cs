...
{
    [Cmdlet(VerbsLifecycle.Stop, Constants.FileCopyCmdletName, SupportsShouldProcess = true, DefaultParameterSetName = Constants.ShareNameParameterSetName), OutputType(typeof(void))]
