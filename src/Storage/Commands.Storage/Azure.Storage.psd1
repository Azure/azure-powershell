...
RequiredModules = @(@{ModuleName = 'AzureRM.Profile'; ModuleVersion = '5.6.1'; })
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Upgrade to Azure Storage Client Library 9.3.0 and Azure Storage DataMovement Library 0.8.1
