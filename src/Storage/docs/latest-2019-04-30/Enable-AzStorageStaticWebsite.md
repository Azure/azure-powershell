...
```
Enable-AzStorageStaticWebsite [[-IndexDocument] <String>] [[-ErrorDocument404Path] <String>]
 [-Context <IStorageContext>] [-DefaultProfile <IAzureContextContainer>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
