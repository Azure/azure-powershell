...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storage/get-azfileshare
schema: 2.0.0
---
...
### List (Default)
```
Get-AzFileShare -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
...
### Get
```
Get-AzFileShare -AccountName <String> -ResourceGroupName <String> -ShareName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzFileShare -InputObject <IStorageIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
