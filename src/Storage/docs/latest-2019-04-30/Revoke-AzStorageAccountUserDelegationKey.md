...
online version: https://docs.microsoft.com/powershell/module/az.storage/revoke-azstorageaccountuserdelegationkey
schema: 2.0.0
---
...
### Revoke (Default)
```
Revoke-AzStorageAccountUserDelegationKey -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
