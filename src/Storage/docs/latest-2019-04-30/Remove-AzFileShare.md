...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storage/remove-azfileshare
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzFileShare -AccountName <String> -ResourceGroupName <String> -ShareName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzFileShare -InputObject <IStorageIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
