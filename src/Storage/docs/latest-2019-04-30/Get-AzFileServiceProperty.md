...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storage/get-azfileserviceproperty
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzFileServiceProperty -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzFileServiceProperty -InputObject <IStorageIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
