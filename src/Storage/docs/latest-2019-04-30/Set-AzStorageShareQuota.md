...
### ShareName (Default)
```
Set-AzStorageShareQuota [-ShareName] <String> [-Quota] <Int32> [-ClientTimeoutPerRequest <Int32?>]
...
### Share
```
Set-AzStorageShareQuota [-Share] <CloudFileShare> [-Quota] <Int32> [-ClientTimeoutPerRequest <Int32?>]
