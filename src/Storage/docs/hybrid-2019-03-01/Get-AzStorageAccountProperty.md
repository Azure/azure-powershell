...
### Get (Default)
```
Get-AzStorageAccountProperty -AccountName <String> -ResourceGroupName <String> -SubscriptionId <String[]>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzStorageAccountProperty -InputObject <IStorageIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
