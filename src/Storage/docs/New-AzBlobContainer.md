...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storage/new-azblobcontainer
schema: 2.0.0
---
...
### Create (Default)
```
New-AzBlobContainer -AccountName <String> -ContainerName <String> -ResourceGroupName <String>
...
```
New-AzBlobContainer -InputObject <IStorageIdentity> -ImmutabilityPeriodSinceCreationInDay <Int32>
...
### CreateViaIdentity
```
New-AzBlobContainer -InputObject <IStorageIdentity> [-BlobContainer <IBlobContainer>]
 [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/az.storage/new-azblobcontainer](https://docs.microsoft.com/en-us/powershell/module/az.storage/new-azblobcontainer)
