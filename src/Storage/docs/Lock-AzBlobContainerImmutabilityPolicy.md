...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storage/lock-azblobcontainerimmutabilitypolicy
schema: 2.0.0
---
...
### Lock (Default)
```
Lock-AzBlobContainerImmutabilityPolicy -AccountName <String> -ContainerName <String>
...
### LockViaIdentity
```
Lock-AzBlobContainerImmutabilityPolicy -InputObject <IStorageIdentity> [-DefaultProfile <PSObject>] [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/az.storage/lock-azblobcontainerimmutabilitypolicy](https://docs.microsoft.com/en-us/powershell/module/az.storage/lock-azblobcontainerimmutabilitypolicy)
