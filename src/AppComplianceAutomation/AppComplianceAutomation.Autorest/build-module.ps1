...
$dll = Join-Path $PSScriptRoot 'bin\Az.AppComplianceAutomation.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.AppComplianceAutomation.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.AppComplianceAutomation.psd1'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.AppComplianceAutomation.format.ps1xml'
