...
Parameter Sets: Approve, Approve1, ApproveViaIdentity, ApproveViaIdentity1
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Approve, Approve1, ApproveExpanded, ApproveExpanded1, ApproveViaJsonFilePath, ApproveViaJsonFilePath1, ApproveViaJsonString, ApproveViaJsonString1
Aliases:
