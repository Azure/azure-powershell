...
namespace Microsoft.Azure.Commands.Management.DeviceProvisioningServices
{
    ...
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "IoTDeviceProvisioningServiceEnrollmentGroup", DefaultParameterSetName = ResourceParameterSet, SupportsShouldProcess = true)]
    [Alias("Remove-" + ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "IoTDpsEnrollmentGroup")]
    [OutputType(typeof(bool))]
    public class RemoveAzIotDeviceProvisioningServiceEnrollmentGroup : IotDpsBaseCmdlet
    {
