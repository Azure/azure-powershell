...
namespace Microsoft.Azure.Commands.Management.DeviceProvisioningServices
{
    ...
    [Cmdlet("Add", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "IoTDeviceProvisioningServiceEnrollment", DefaultParameterSetName = ResourceParameterSet, SupportsShouldProcess = true)]
    [Alias("Add-" + ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "IoTDpsEnrollment")]
    [OutputType(typeof(PSIndividualEnrollment))]
    public class AddAzIotDeviceProvisioningServiceEnrollment : IotDpsBaseCmdlet
    {
