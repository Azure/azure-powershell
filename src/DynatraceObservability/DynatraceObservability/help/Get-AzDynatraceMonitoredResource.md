...
```
Get-AzDynatraceMonitoredResource -MonitorName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
...
```
Get-AzDynatraceMonitoredResource -MonitorName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 -Request <ILogStatusRequest> [-DefaultProfile <PSObject>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
