...
namespace Microsoft.Azure.Management.DataBoxEdge
{
    ...
    public static partial class JobsOperationsExtensions
    {
        ...
        {
                return ((IJobsOperations)operations).GetAsync(deviceName, name, resourceGroupName).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<Job> GetAsync(this IJobsOperations operations, string deviceName, string name, string resourceGroupName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
