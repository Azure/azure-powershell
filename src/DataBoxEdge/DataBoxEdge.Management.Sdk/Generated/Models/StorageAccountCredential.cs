...
namespace Microsoft.Azure.Management.DataBoxEdge.Models
{
    ...
    public partial class StorageAccountCredential : ARMBaseModel
    {
        ...
        /// </param>
        public StorageAccountCredential(string sslStatus, string accountType, string alias, string id = default(string), string name = default(string), string type = default(string), string userName = default(string), AsymmetricEncryptedSecret accountKey = default(AsymmetricEncryptedSecret), string connectionString = default(string), string blobDomainName = default(string), string storageAccountId = default(string))
