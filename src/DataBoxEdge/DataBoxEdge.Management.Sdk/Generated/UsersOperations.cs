...
namespace Microsoft.Azure.Management.DataBoxEdge
{
    ...
    /// </summary>
    internal partial class UsersOperations : Microsoft.Rest.IServiceOperations<DataBoxEdgeManagementClient>, IUsersOperations
    {
        /// <summary>
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<User> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(deviceName, name, resourceGroupName, user, customHeaders, cancellationToken).ConfigureAwait(false);
