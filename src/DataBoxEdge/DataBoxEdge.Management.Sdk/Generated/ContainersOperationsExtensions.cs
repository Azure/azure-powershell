...
namespace Microsoft.Azure.Management.DataBoxEdge
{
    ...
    public static partial class ContainersOperationsExtensions
    {
            ...
            {
                return operations.CreateOrUpdateAsync(deviceName, storageAccountName, containerName, resourceGroupName, dataFormat).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Container> CreateOrUpdateAsync(this IContainersOperations operations, string deviceName, string storageAccountName, string containerName, string resourceGroupName, string dataFormat, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.BeginCreateOrUpdateAsync(deviceName, storageAccountName, containerName, resourceGroupName, dataFormat).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Container> BeginCreateOrUpdateAsync(this IContainersOperations operations, string deviceName, string storageAccountName, string containerName, string resourceGroupName, string dataFormat, CancellationToken cancellationToken = default(CancellationToken))
            {
