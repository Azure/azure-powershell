...
namespace Microsoft.Azure.Management.DataBoxEdge
{
    ...
    public partial interface IContainersOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<Container>> CreateOrUpdateWithHttpMessagesAsync(string deviceName, string storageAccountName, string containerName, string resourceGroupName, string dataFormat, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<Container>> BeginCreateOrUpdateWithHttpMessagesAsync(string deviceName, string storageAccountName, string containerName, string resourceGroupName, string dataFormat, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Deletes the container on the Data Box Edge/Data Box Gateway device.
        /// </summary>
        /// <param name='deviceName'>
