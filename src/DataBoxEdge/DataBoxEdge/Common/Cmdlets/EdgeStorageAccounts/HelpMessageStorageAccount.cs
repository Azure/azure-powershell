...
{
    internal class HelpMessageEdgeStorageAccount
    {
        internal const string StorageAccountCredentialHelpMessage =
            "Provide existing StorageAccountCredential's Resource Name";

        internal const string CloudDataPolicyHelpMessage = "Will use a CloudStorageAccount for tiering";

        internal const string NameHelpMessage = "Name of the EdgeStorageAccount";
