...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Common.Cmdlets.EdgeStorageContainers
{
    ...
    public class DataBoxEdgeStorageContainerRemoveCmdlet : AzureDataBoxEdgeCmdletBase
    {
        ...
        [ValidateNotNull]
        public PSDataBoxEdgeStorageContainer InputObject { get; set; }
        ...
        private bool Remove()
        {
            this.DataBoxEdgeManagementClient.Containers.Delete(
                this.DeviceName,
