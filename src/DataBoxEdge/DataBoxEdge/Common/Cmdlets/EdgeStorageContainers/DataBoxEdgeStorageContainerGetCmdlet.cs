...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Common.Cmdlets.EdgeStorageContainers
{
    ...
    public class DataBoxEdgeStorageContainerGetCmdlet : AzureDataBoxEdgeCmdletBase
    {
        ...
        [ValidateNotNull]
        public PSDataBoxEdgeStorageAccount EdgeStorageAccountObject;
        ...
        private List<PSDataBoxEdgeStorageContainer> GetResourceByName()
        {
            var resource = GetResource();
            return new List<PSDataBoxEdgeStorageContainer>()
            {
                new PSDataBoxEdgeStorageContainer(resource)
            };
        }

        private IPage<Container> ListResource()
        {
            return this.DataBoxEdgeManagementClient.Containers.ListByStorageAccount(
                this.DeviceName,
                this.EdgeStorageAccountName,
                this.ResourceGroupName);
        }
        ...
        {
            return this.DataBoxEdgeManagementClient.Containers.ListByStorageAccountNext(
                nextPageLink
            );
        }

        private List<PSDataBoxEdgeStorageContainer> ListPSResource()
        {
            ...
            return paginatedResult.Select(t => new PSDataBoxEdgeStorageContainer(t)).ToList();
        }
