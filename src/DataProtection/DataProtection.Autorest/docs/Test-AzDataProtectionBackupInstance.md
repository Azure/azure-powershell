...
```
Test-AzDataProtectionBackupInstance -BackupVault1InputObject <IDataProtectionIdentity> -Name <String>
...
```
Test-AzDataProtectionBackupInstance -ResourceGroupName <String> -VaultName <String> -JsonFilePath <String>
...
```
Test-AzDataProtectionBackupInstance -ResourceGroupName <String> -VaultName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDataProtectionIdentity
Parameter Sets: ValidateViaIdentityBackupVault, ValidateViaIdentityBackupVaultExpanded, ValidateViaIdentityBackupVaultExpanded1
Aliases:
...
```yaml
Type: System.String
Parameter Sets: ValidateViaJsonFilePath, ValidateViaJsonFilePath1, ValidateViaJsonFilePath2
Aliases:
...
```yaml
Type: System.String
Parameter Sets: ValidateViaJsonString, ValidateViaJsonString1, ValidateViaJsonString2
Aliases:
...
```yaml
Type: System.String
Parameter Sets: ValidateViaIdentityBackupVault, ValidateViaIdentityBackupVault1, ValidateViaIdentityBackupVaultExpanded, ValidateViaIdentityBackupVaultExpanded1, ValidateViaJsonFilePath1, ValidateViaJsonFilePath2, ValidateViaJsonString1, ValidateViaJsonString2
...
```yaml
Type: System.String
Parameter Sets: ValidateViaJsonFilePath, ValidateViaJsonFilePath1, ValidateViaJsonFilePath2, ValidateViaJsonString, ValidateViaJsonString1, ValidateViaJsonString2
Aliases:
