...
```yaml
Type: System.String
Parameter Sets: BackupExpanded, BackupViaIdentityBackupVaultExpanded, BackupViaJsonFilePath, BackupViaJsonString
Aliases:
...
Parameter Sets: BackupViaIdentityBackupVaultExpanded
Aliases:
