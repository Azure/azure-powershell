...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401
{
    ...
    public partial class ItemLevelRestoreCriteria
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IItemLevelRestoreCriteria.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IItemLevelRestoreCriteria interface is
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IItemLevelRestoreCriteria.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IItemLevelRestoreCriteria FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("objectType") )
            {
                ...
                {
                    return new KubernetesStorageClassRestoreCriteria(json);
                }
                case "KubernetesPVRestoreCriteria":
                {
                    return new KubernetesPvRestoreCriteria(json);
                }
                case "KubernetesClusterRestoreCriteria":
                {
                    return new KubernetesClusterRestoreCriteria(json);
                }
                case "KubernetesClusterVaultTierRestoreCriteria":
                {
                    return new KubernetesClusterVaultTierRestoreCriteria(json);
                }
            }
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject into a new instance of <see cref="ItemLevelRestoreCriteria" />.
        /// </summary>
        ...
        internal ItemLevelRestoreCriteria(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="ItemLevelRestoreCriteria" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ItemLevelRestoreCriteria" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode" />.
        /// </returns>
