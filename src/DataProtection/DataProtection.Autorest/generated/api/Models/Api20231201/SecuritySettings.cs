...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231201
{
    ...
    public partial class SecuritySettings :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231201.ISecuritySettings,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231201.ISecuritySettingsInternal
    {

        /// <summary>Backing field for <see cref="ImmutabilitySetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231201.IImmutabilitySettings _immutabilitySetting;

        /// <summary>Immutability Settings at vault level</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231201.IImmutabilitySettings ImmutabilitySetting { get => (this._immutabilitySetting = this._immutabilitySetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231201.ImmutabilitySettings()); set => this._immutabilitySetting = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Inlined)]
        public double? SoftDeleteRetentionDurationInDay { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231201.ISoftDeleteSettingsInternal)SoftDeleteSetting).RetentionDurationInDay; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231201.ISoftDeleteSettingsInternal)SoftDeleteSetting).RetentionDurationInDay = value ?? default(double); }

        /// <summary>Backing field for <see cref="SoftDeleteSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231201.ISoftDeleteSettings _softDeleteSetting;

        /// <summary>Soft delete related settings</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231201.ISoftDeleteSettings SoftDeleteSetting { get => (this._softDeleteSetting = this._softDeleteSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231201.SoftDeleteSettings()); set => this._softDeleteSetting = value; }
    ...
    {
        /// <summary>Immutability Settings at vault level</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231201.IImmutabilitySettings ImmutabilitySetting { get; set; }
        /// <summary>Immutability state</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support.ImmutabilityState? ImmutabilityState { get; set; }
        /// <summary>Soft delete retention duration</summary>
        double? SoftDeleteRetentionDurationInDay { get; set; }
