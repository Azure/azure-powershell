...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101
{
    ...
    public partial class Datasource :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.IDatasourceInternal
    {

        /// <summary>Internal Acessors for ResourceProperty</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.IBaseResourceProperties Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.IDatasourceInternal.ResourceProperty { get => (this._resourceProperty = this._resourceProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.BaseResourceProperties()); set { {_resourceProperty = value;} } }

        /// <summary>Internal Acessors for ResourcePropertyObjectType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.IDatasourceInternal.ResourcePropertyObjectType { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.IBaseResourcePropertiesInternal)ResourceProperty).ObjectType; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.IBaseResourcePropertiesInternal)ResourceProperty).ObjectType = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.IBaseResourceProperties _resourceProperty;

        /// <summary>Properties specific to data source</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.IBaseResourceProperties ResourceProperty { get => (this._resourceProperty = this._resourceProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.BaseResourceProperties()); set => this._resourceProperty = value; }

        /// <summary>Type of the specific object - used for deserializing</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Inlined)]
        public string ResourcePropertyObjectType { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.IBaseResourcePropertiesInternal)ResourceProperty).ObjectType; }
...

    {
        ...
        string ResourceName { get; set; }
        /// <summary>Properties specific to data source</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.IBaseResourceProperties ResourceProperty { get; set; }
        /// <summary>Type of the specific object - used for deserializing</summary>
