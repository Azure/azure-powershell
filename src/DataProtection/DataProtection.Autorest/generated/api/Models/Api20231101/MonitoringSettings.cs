...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101
{
    ...
    public partial class MonitoringSettings :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.IMonitoringSettings,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.IMonitoringSettingsInternal
    {
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.IAzureMonitorAlertSettings AzureMonitorAlertSetting { get => (this._azureMonitorAlertSetting = this._azureMonitorAlertSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.AzureMonitorAlertSettings()); set => this._azureMonitorAlertSetting = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.IAzureMonitorAlertSettings Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.IMonitoringSettingsInternal.AzureMonitorAlertSetting { get => (this._azureMonitorAlertSetting = this._azureMonitorAlertSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.AzureMonitorAlertSettings()); set { {_azureMonitorAlertSetting = value;} } }
    ...
    {
        /// <summary>Settings for Azure Monitor based alerts</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20231101.IAzureMonitorAlertSettings AzureMonitorAlertSetting { get; set; }
