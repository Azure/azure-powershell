...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501
{
    ...
    public partial class DppWorkerRequest
    {
        ...
        internal DppWorkerRequest(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject json)
        {
            ...
            {_header = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("headers"), out var __jsonHeaders) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.DppWorkerRequestHeaders.FromJson(__jsonHeaders) : Header;}
            ...
            {_parameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("parameters"), out var __jsonParameters) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.DppWorkerRequestParameters.FromJson(__jsonParameters) : Parameter;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.IDppWorkerRequest.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.IDppWorkerRequest.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.IDppWorkerRequest FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode node)
        {
