...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501
{
    ...
    public partial class RestoreTargetInfo
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.IRestoreTargetInfo.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.IRestoreTargetInfo.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.IRestoreTargetInfo FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode node)
        {
        ...
        internal RestoreTargetInfo(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject json)
        {
            ...
            __restoreTargetInfoBase = new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.RestoreTargetInfoBase(json);
            {_datasourceInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("datasourceInfo"), out var __jsonDatasourceInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.Datasource.FromJson(__jsonDatasourceInfo) : DatasourceInfo;}
            {_datasourceSetInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("datasourceSetInfo"), out var __jsonDatasourceSetInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.DatasourceSet.FromJson(__jsonDatasourceSetInfo) : DatasourceSetInfo;}
            {_datasourceAuthCredentials = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("datasourceAuthCredentials"), out var __jsonDatasourceAuthCredentials) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.AuthCredentials.FromJson(__jsonDatasourceAuthCredentials) : DatasourceAuthCredentials;}
            AfterFromJson(json);
        }
