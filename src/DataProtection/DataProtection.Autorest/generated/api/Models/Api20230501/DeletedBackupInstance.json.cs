...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501
{
    ...
    public partial class DeletedBackupInstance
    {
        ...
        internal DeletedBackupInstance(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject json)
        {
            ...
            __backupInstance = new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.BackupInstance(json);
            {_deletionInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("deletionInfo"), out var __jsonDeletionInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.DeletionInfo.FromJson(__jsonDeletionInfo) : DeletionInfo;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.IDeletedBackupInstance.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.IDeletedBackupInstance.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.IDeletedBackupInstance FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode node)
        {
