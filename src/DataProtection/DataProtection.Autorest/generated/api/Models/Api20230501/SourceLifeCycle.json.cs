...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501
{
    ...
    public partial class SourceLifeCycle
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.ISourceLifeCycle.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.ISourceLifeCycle.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.ISourceLifeCycle FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode node)
        {
        ...
        internal SourceLifeCycle(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject json)
        {
            ...
            {_deleteAfter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("deleteAfter"), out var __jsonDeleteAfter) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.DeleteOption.FromJson(__jsonDeleteAfter) : DeleteAfter;}
            {_sourceDataStore = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("sourceDataStore"), out var __jsonSourceDataStore) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.DataStoreInfoBase.FromJson(__jsonSourceDataStore) : SourceDataStore;}
            {_targetDataStoreCopySetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonArray>("targetDataStoreCopySettings"), out var __jsonTargetDataStoreCopySettings) ? If( __jsonTargetDataStoreCopySettings as Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.ITargetCopySetting[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.ITargetCopySetting) (Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.TargetCopySetting.FromJson(__u) )) ))() : null : TargetDataStoreCopySetting;}
            AfterFromJson(json);
        }
