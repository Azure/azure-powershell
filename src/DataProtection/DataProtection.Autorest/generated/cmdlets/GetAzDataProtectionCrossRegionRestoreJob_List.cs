...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDataProtectionCrossRegionRestoreJob_List", SupportsShouldProcess = true)]
    ...
    public partial class GetAzDataProtectionCrossRegionRestoreJob_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.ICrossRegionRestoreJobsRequest _parameter;

        /// <summary>Details of Backup Vault for which CRR Jobs are to be fetched</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Details of Backup Vault for which CRR Jobs are to be fetched", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Details of Backup Vault for which CRR Jobs are to be fetched",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.ICrossRegionRestoreJobsRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.ICrossRegionRestoreJobsRequest Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzDataProtectionCrossRegionRestoreJob_List" /> cmdlet class.
        /// </summary>
        public GetAzDataProtectionCrossRegionRestoreJob_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.FetchCrossRegionRestoreJobsList(ResourceGroupName, SubscriptionId, Location, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, Parameter, onOk, onDefault, this, Pipeline);
