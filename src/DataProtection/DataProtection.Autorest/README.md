...
directive:
  ...
  - where:
      verb: Unlock
      variant: ^UnlockViaIdentityExpanded$|^UnlockViaIdentity$
    remove: true
  ...
  - where:
      variant: ^CreateViaIdentity$|^PatchViaIdentity$|^BackupViaIdentity$|^TriggerViaIdentity|^CreateViaIdentityExpanded$|^CreateViaIdentityJsonFilePath$|^CreateViaIdentityJsonString$|^UpdateViaIdentity$|^Backup$
    remove: true

  - where:
      variant: ^(Patch|Update)(?!.*?(Expanded|JsonFilePath|JsonString))
    remove: true
  ...
  - where:
      verb: Sync
      variant: ^SyncViaIdentity$|^SyncViaIdentityExpanded$
    remove: true

  - where:
      verb: Sync
      variant: ^(Sync)(?!.*?(Expanded|JsonFilePath|JsonString))
    remove: true
  ...
  - where:
      verb: Invoke
      variant: ^PostViaIdentity$|^PostViaIdentityExpanded$
    remove: true
  
  - where:
      verb: Invoke
      variant: ^(Post)(?!.*?(Expanded|JsonFilePath|JsonString))
    remove: true
  
  - where:
      verb: Find
      variant: ^FindViaIdentity$|^FindViaIdentityExpanded$
    remove: true
  
  - where:
      verb: Find
      variant: ^(Find)(?!.*?(Expanded|JsonFilePath|JsonString))
    remove: true
