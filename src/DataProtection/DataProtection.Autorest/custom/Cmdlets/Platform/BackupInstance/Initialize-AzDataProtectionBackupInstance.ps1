function Initialize-AzDataProtectionBackupInstance {
    ...
    process {
        ...
        $backupInstance = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.BackupInstance]::new()
        ...
        if ($hasUseSystemAssignedIdentity -or $hasUserAssignedIdentityArmId) {
            ...
            $backupInstance.IdentityDetail = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.IdentityDetails]::new()
        ...
        {            
            if($manifest.supportSecretStoreAuthentication -eq $true){
                ...
                $backupInstance.DatasourceAuthCredentials = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.SecretStoreBasedAuthCredentials]::new()
                $backupInstance.DatasourceAuthCredentials.ObjectType = "SecretStoreBasedAuthCredentials"
                $backupInstance.DatasourceAuthCredentials.SecretStoreResource =  [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.SecretStoreResource]::new()
        ...
        $backupInstanceResource = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.BackupInstanceResource]::new()
        ...
        {
            $operationalParam = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.AzureOperationalStoreParameters]::new()
