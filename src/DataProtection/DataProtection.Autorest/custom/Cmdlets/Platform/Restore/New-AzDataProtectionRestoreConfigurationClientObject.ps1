...
function New-AzDataProtectionRestoreConfigurationClientObject{
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.KubernetesClusterRestoreCriteriaNamespaceMappings]
        ${NamespaceMapping},
    ...
    process {
        ...
        if($hasStagingResourceGroupId -and $hasStagingStorageAccountId){
            $restoreCriteria =  [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.KubernetesClusterVaultTierRestoreCriteria]::new()
        ...
        elseif($hasStagingResourceGroupId -or $hasStagingStorageAccountId) {
            ...
            $restoreCriteria =  [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.KubernetesClusterRestoreCriteria]::new()
