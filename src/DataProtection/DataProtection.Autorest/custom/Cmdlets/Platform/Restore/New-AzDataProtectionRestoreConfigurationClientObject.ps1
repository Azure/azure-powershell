...
function New-AzDataProtectionRestoreConfigurationClientObject{
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240301.KubernetesClusterRestoreCriteriaNamespaceMappings]
        ${NamespaceMapping},
    ...
    process {
        $restoreCriteria =  [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240301.KubernetesClusterRestoreCriteria]::new()
