...
{   
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250701.IRestoreTargetInfoBase]
        ${RestoreTargetInfo},
    ...
    process
    {
        ...
        if($hasRestoreToSecondaryRegion){
            ...
            $crossRegionRestoreDetail = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250701.CrossRegionRestoreDetails]::new()
            ...
            if($hasParameter){                
                ...
                $restoreRequestObject = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250701.AzureBackupRestoreRequest]::new()
