...
{   
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240301.IRestoreTargetInfoBase]
        ${RestoreTargetInfo},
    ...
    process
    {
        ...
        if($hasRestoreToSecondaryRegion){
            ...
            $crossRegionRestoreDetail = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240301.CrossRegionRestoreDetails]::new()
            ...
            if($hasParameter){                
                ...
                $restoreRequestObject = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240301.AzureBackupRestoreRequest]::new()
