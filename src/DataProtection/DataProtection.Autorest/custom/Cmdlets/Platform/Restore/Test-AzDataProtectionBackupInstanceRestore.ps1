...
{   
	[OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240301.IOperationJobExtendedInfo')]
    ...
    process
    {
        ...
        if($hasRestoreToSecondaryRegion){
            ...
            $Parameter = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240301.ValidateCrossRegionRestoreRequestObject]::new()
            $Parameter.RestoreRequestObject = $RestoreRequest

            $Parameter.CrossRegionRestoreDetail = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240301.CrossRegionRestoreDetails]::new()
            ...
            $Parameter = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240301.ValidateRestoreRequestObject]::new()
            $Parameter.RestoreRequestObject = $RestoreRequest            
