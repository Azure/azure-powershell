...
{   
    ...
    process
    {
        ...
        if($hasRestoreToSecondaryRegion){
            ...
            $Parameter = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.ValidateCrossRegionRestoreRequestObject]::new()
            $Parameter.RestoreRequestObject = $RestoreRequest

            $Parameter.CrossRegionRestoreDetail = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.CrossRegionRestoreDetails]::new()
            ...
            $Parameter = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.ValidateRestoreRequestObject]::new()
            $Parameter.RestoreRequestObject = $RestoreRequest            
