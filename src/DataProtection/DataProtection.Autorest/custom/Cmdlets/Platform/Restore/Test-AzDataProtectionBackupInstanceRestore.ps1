...
{   
	[OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250701.IOperationJobExtendedInfo')]
    ...
    process
    {
        ...
        if($hasRestoreToSecondaryRegion){
            ...
            $Parameter = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250701.ValidateCrossRegionRestoreRequestObject]::new()
            $Parameter.RestoreRequestObject = $RestoreRequest

            $Parameter.CrossRegionRestoreDetail = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250701.CrossRegionRestoreDetails]::new()
            ...
            $Parameter = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250701.ValidateRestoreRequestObject]::new()
            $Parameter.RestoreRequestObject = $RestoreRequest            
