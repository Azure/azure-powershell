function Edit-AzDataProtectionPolicyTagClientObject{
	[OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250701.IBackupPolicy')]
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250701.IScheduleBasedBackupCriteria[]]
        ${Criteria}
    )
    ...
    process{
        ...
        if($backupRuleIndex -ne -1)
        {
            ...
            if($parameterSetName -eq "updateTag")
            {
                ...
                if($tagIndex -eq -1)
                {
                    $tagCriteria = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250701.TaggingCriteria]::new()
