function Edit-AzDataProtectionPolicyTagClientObject{
	[OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240301.IBackupPolicy')]
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240301.IBackupPolicy]
        ${Policy},
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240301.IScheduleBasedBackupCriteria[]]
        ${Criteria}
    )
    ...
    process{
        ...
        if($backupRuleIndex -ne -1)
        {
            ...
            if($parameterSetName -eq "updateTag")
            {
                ...
                if($tagIndex -eq -1)
                {
                    $tagCriteria = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240301.TaggingCriteria]::new()
