function New-AzDataProtectionBackupPolicy
{
    ...
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250701.IBaseBackupPolicyResource')]
    ...
    process
    {
        ...
        $policyObject = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250701.BaseBackupPolicyResource]::new()
