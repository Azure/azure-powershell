function New-AzDataProtectionBackupPolicy
{
    ...
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240301.IBaseBackupPolicyResource')]
    ...
    process
    {
        ...
        $policyObject = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240301.BaseBackupPolicyResource]::new()
