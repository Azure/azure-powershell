function New-AzDataProtectionPolicyTagCriteriaClientObject{
	[OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250701.IScheduleBasedBackupCriteria')]
    ...
    process {
        $criteria = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250701.ScheduleBasedBackupCriteria]::new()
        ...
        if($DaysOfMonth -ne $null){
            ...
            Foreach($dayOfMonth in $DaysOfMonth)
            {
                if($dayOfMonth -match "^[\d]+$")
                {
                    ...
                    $day = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250701.Day]::new()
