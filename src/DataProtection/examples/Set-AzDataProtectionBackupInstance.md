...
The third command gets the policy with which disk will be backed up. The fourth stores the backup vault object in $vault variable.
The fifth command initializes the backup instance request. The last command configures backup of the given azure disk in the backup vault.
