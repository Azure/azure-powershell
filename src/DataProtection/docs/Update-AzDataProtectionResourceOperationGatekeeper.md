...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dataprotection/update-azdataprotectionresourceoperationgatekeeper
schema: 2.0.0
---
...
```
Update-AzDataProtectionResourceOperationGatekeeper -ResourceGroupName <String> -SName <String>
...
### PatchViaIdentity
```
Update-AzDataProtectionResourceOperationGatekeeper -InputObject <IDataProtectionIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202001Alpha.IPatchResourceRequestInput
