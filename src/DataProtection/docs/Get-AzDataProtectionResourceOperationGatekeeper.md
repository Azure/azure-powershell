...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dataprotection/get-azdataprotectionresourceoperationgatekeeper
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzDataProtectionResourceOperationGatekeeper -ResourceGroupName <String> -SName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDataProtectionResourceOperationGatekeeper -InputObject <IDataProtectionIdentity>
