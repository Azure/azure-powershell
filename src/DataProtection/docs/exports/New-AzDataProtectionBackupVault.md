...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dataprotection/new-azdataprotectionbackupvault
schema: 2.0.0
---
...
### Create
```
New-AzDataProtectionBackupVault -ResourceGroupName <String> -VaultName <String>
