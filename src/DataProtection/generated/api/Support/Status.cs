...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support.Status ConfiguringProtection = @"ConfiguringProtection";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support.Status ConfiguringProtectionFailed = @"ConfiguringProtectionFailed";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support.Status ProtectionConfigured = @"ProtectionConfigured";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support.Status ProtectionStopped = @"ProtectionStopped";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support.Status SoftDeleted = @"SoftDeleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support.Status SoftDeleting = @"SoftDeleting";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
