...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220501
{
    ...
    public partial class TriggerBackupRequest :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220501.ITriggerBackupRequest,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220501.ITriggerBackupRequestInternal
    {

        /// <summary>Backing field for <see cref="BackupRuleOption" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220501.IAdHocBackupRuleOptions _backupRuleOption;

        /// <summary>Name for the Rule of the Policy which needs to be applied for this backup</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220501.IAdHocBackupRuleOptions BackupRuleOption { get => (this._backupRuleOption = this._backupRuleOption ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220501.AdHocBackupRuleOptions()); set => this._backupRuleOption = value; }
    ...
    {
        /// <summary>Name for the Rule of the Policy which needs to be applied for this backup</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220501.IAdHocBackupRuleOptions BackupRuleOption { get; set; }

        string BackupRuleOptionRuleName { get; set; }
        /// <summary>Adhoc backup trigger option</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220501.IAdhocBackupTriggerOption BackupRuleOptionTriggerOption { get; set; }
