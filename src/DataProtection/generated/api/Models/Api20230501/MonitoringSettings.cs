...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501
{
    ...
    public partial class MonitoringSettings :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.IMonitoringSettingsInternal
    {

        /// <summary>Backing field for <see cref="AzureMonitorAlertSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.IAzureMonitorAlertSettings _azureMonitorAlertSetting;

        /// <summary>Settings for Azure Monitor based alerts</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.IAzureMonitorAlertSettings AzureMonitorAlertSetting { get => (this._azureMonitorAlertSetting = this._azureMonitorAlertSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.AzureMonitorAlertSettings()); set => this._azureMonitorAlertSetting = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.IAzureMonitorAlertSettings Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.IMonitoringSettingsInternal.AzureMonitorAlertSetting { get => (this._azureMonitorAlertSetting = this._azureMonitorAlertSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.AzureMonitorAlertSettings()); set { {_azureMonitorAlertSetting = value;} } }
    ...
    {
        /// <summary>Settings for Azure Monitor based alerts</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.IAzureMonitorAlertSettings AzureMonitorAlertSetting { get; set; }
