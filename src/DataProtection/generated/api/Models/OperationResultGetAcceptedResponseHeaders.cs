...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models
{
    ...
    public partial class OperationResultGetAcceptedResponseHeaders :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IOperationResultGetAcceptedResponseHeaders,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IHeaderSerializable
    {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IOperationResultGetAcceptedResponseHeadersInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader0) is string __headerLocationHeader0 ? __headerLocationHeader0 : (string)null;
            }
            if (headers.TryGetValues("Azure-AsyncOperation", out var __azureAsyncOperationHeader1))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IOperationResultGetAcceptedResponseHeadersInternal)this).AzureAsyncOperation = System.Linq.Enumerable.FirstOrDefault(__azureAsyncOperationHeader1) is string __headerAzureAsyncOperationHeader1 ? __headerAzureAsyncOperationHeader1 : (string)null;
            }
        ...
        /// <summary>
        /// Creates an new <see cref="OperationResultGetAcceptedResponseHeaders" /> instance.
        /// </summary>
        public OperationResultGetAcceptedResponseHeaders()
        {
    ...
    internal partial interface IOperationResultGetAcceptedResponseHeadersInternal
