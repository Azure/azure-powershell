...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220401
{
    ...
    public partial class ExportJobsResult :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220401.IExportJobsResult,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220401.IExportJobsResultInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220401.IExportJobsResultInternal.BlobSasKey { get => this._blobSasKey; set { {_blobSasKey = value;} } }

        /// <summary>Internal Acessors for BlobUrl</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220401.IExportJobsResultInternal.BlobUrl { get => this._blobUrl; set { {_blobUrl = value;} } }

        /// <summary>Internal Acessors for ExcelFileBlobSasKey</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220401.IExportJobsResultInternal.ExcelFileBlobSasKey { get => this._excelFileBlobSasKey; set { {_excelFileBlobSasKey = value;} } }

        /// <summary>Internal Acessors for ExcelFileBlobUrl</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220401.IExportJobsResultInternal.ExcelFileBlobUrl { get => this._excelFileBlobUrl; set { {_excelFileBlobUrl = value;} } }
