...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202301
{
    ...
    public partial class BackupInstance
    {
        ...
        internal BackupInstance(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject json)
        {
            ...
            {_dataSourceInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("dataSourceInfo"), out var __jsonDataSourceInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202301.Datasource.FromJson(__jsonDataSourceInfo) : DataSourceInfo;}
            {_dataSourceSetInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("dataSourceSetInfo"), out var __jsonDataSourceSetInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202301.DatasourceSet.FromJson(__jsonDataSourceSetInfo) : DataSourceSetInfo;}
            {_policyInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("policyInfo"), out var __jsonPolicyInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202301.PolicyInfo.FromJson(__jsonPolicyInfo) : PolicyInfo;}
            {_protectionStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("protectionStatus"), out var __jsonProtectionStatus) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202301.ProtectionStatusDetails.FromJson(__jsonProtectionStatus) : ProtectionStatus;}
            ...
            {_protectionErrorDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("protectionErrorDetails"), out var __jsonProtectionErrorDetails) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202301.UserFacingError.FromJson(__jsonProtectionErrorDetails) : ProtectionErrorDetail;}
            ...
            {_datasourceAuthCredentials = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("datasourceAuthCredentials"), out var __jsonDatasourceAuthCredentials) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202301.AuthCredentials.FromJson(__jsonDatasourceAuthCredentials) : DatasourceAuthCredentials;}
            {_validationType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("validationType"), out var __jsonValidationType) ? (string)__jsonValidationType : (string)ValidationType;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202301.IBackupInstance.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202301.IBackupInstance.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202301.IBackupInstance FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._validationType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString(this._validationType.ToString()) : null, "validationType" ,container.Add );
