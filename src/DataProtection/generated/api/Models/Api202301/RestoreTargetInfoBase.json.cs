...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202301
{
    ...
    public partial class RestoreTargetInfoBase
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202301.IRestoreTargetInfoBase.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202301.IRestoreTargetInfoBase interface is polymorphic,
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202301.IRestoreTargetInfoBase.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202301.IRestoreTargetInfoBase FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("objectType") )
            {
                ...
                {
                    return new ItemLevelRestoreTargetInfo(json);
                }
                case "RestoreFilesTargetInfo":
                {
                    return new RestoreFilesTargetInfo(json);
                }
                case "RestoreTargetInfo":
                {
                    return new RestoreTargetInfo(json);
                }
            }
            return new RestoreTargetInfoBase(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject into a new instance of <see cref="RestoreTargetInfoBase" />.
        /// </summary>
        ...
        internal RestoreTargetInfoBase(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject json)
        {
            ...
            {_recoveryOption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("recoveryOption"), out var __jsonRecoveryOption) ? (string)__jsonRecoveryOption : (string)RecoveryOption;}
            {_restoreLocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("restoreLocation"), out var __jsonRestoreLocation) ? (string)__jsonRestoreLocation : (string)RestoreLocation;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="RestoreTargetInfoBase" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="RestoreTargetInfoBase" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._recoveryOption)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString(this._recoveryOption.ToString()) : null, "recoveryOption" ,container.Add );
            AddIf( null != (((object)this._restoreLocation)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString(this._restoreLocation.ToString()) : null, "restoreLocation" ,container.Add );
