...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20210701
{
    ...
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20210701.IBackupCriteria"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20210701.IBackupCriteria __backupCriteria = new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20210701.BackupCriteria();
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20210701.IDay[] _daysOfMonth;

        /// <summary>This is day of the month from 1 to 28 other wise last of month</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20210701.IDay[] DaysOfMonth { get => this._daysOfMonth; set => this._daysOfMonth = value; }
        ...
        public string ObjectType { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20210701.IBackupCriteriaInternal)__backupCriteria).ObjectType; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20210701.IBackupCriteriaInternal)__backupCriteria).ObjectType = value ; }
    ...
    public partial interface IScheduleBasedBackupCriteria :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20210701.IBackupCriteria
    {
        /// <summary>
        /// it contains absolute values like "AllBackup" / "FirstOfDay" / "FirstOfWeek" / "FirstOfMonth"
        /// and should be part of AbsoluteMarker enum
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20210701.IDay) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20210701.IDay[] DaysOfMonth { get; set; }
        /// <summary>It should be Sunday/Monday/T..../Saturday</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    internal partial interface IScheduleBasedBackupCriteriaInternal :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20210701.IBackupCriteriaInternal
    {
        /// <summary>
        /// it contains absolute values like "AllBackup" / "FirstOfDay" / "FirstOfWeek" / "FirstOfMonth"
        /// and should be part of AbsoluteMarker enum
