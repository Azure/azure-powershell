...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201
{
    ...
    public partial class CopyOption
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject into a new instance of <see cref="CopyOption" />.
        /// </summary>
        ...
        internal CopyOption(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.ICopyOption.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.ICopyOption interface is polymorphic, and
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.ICopyOption.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.ICopyOption FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("objectType") )
            {
                ...
                {
                    return new CopyOnExpiryOption(json);
                }
                case "CustomCopyOption":
                {
                    return new CustomCopyOption(json);
                }
                case "ImmediateCopyOption":
                {
                    return new ImmediateCopyOption(json);
                }
            }
            return new CopyOption(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="CopyOption" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CopyOption" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode" />.
        /// </returns>
