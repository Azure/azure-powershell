...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201
{
    ...
    public partial class SecuritySettings :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.ISecuritySettings,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.ISecuritySettingsInternal
    {

        /// <summary>Backing field for <see cref="ImmutabilitySetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.IImmutabilitySettings _immutabilitySetting;

        /// <summary>Immutability Settings at vault level</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.IImmutabilitySettings ImmutabilitySetting { get => (this._immutabilitySetting = this._immutabilitySetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.ImmutabilitySettings()); set => this._immutabilitySetting = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.ISoftDeleteSettings Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.ISecuritySettingsInternal.SoftDeleteSetting { get => (this._softDeleteSetting = this._softDeleteSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.SoftDeleteSettings()); set { {_softDeleteSetting = value;} } }

        /// <summary>Soft delete retention duration</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Inlined)]
        public double? SoftDeleteRetentionDurationInDay { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.ISoftDeleteSettingsInternal)SoftDeleteSetting).RetentionDurationInDay; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.ISoftDeleteSettingsInternal)SoftDeleteSetting).RetentionDurationInDay = value ?? default(double); }

        /// <summary>Backing field for <see cref="SoftDeleteSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.ISoftDeleteSettings _softDeleteSetting;

        /// <summary>Soft delete related settings</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.ISoftDeleteSettings SoftDeleteSetting { get => (this._softDeleteSetting = this._softDeleteSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.SoftDeleteSettings()); set => this._softDeleteSetting = value; }
    ...
    {
        /// <summary>Immutability Settings at vault level</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20221201.IImmutabilitySettings ImmutabilitySetting { get; set; }
        /// <summary>Immutability state</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support.ImmutabilityState? ImmutabilityState { get; set; }
        /// <summary>Soft delete retention duration</summary>
        double? SoftDeleteRetentionDurationInDay { get; set; }
