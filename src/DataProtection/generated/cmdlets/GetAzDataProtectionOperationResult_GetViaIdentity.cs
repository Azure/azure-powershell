        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.OperationResultGetViaIdentity(InputObject.Id, onAccepted, onNoContent, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.OperationResultGet(InputObject.SubscriptionId ?? null, InputObject.OperationId ?? null, InputObject.Location ?? null, onAccepted, onNoContent, this, Pipeline);
                    }
