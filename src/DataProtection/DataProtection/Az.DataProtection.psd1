...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Upgraded the DataProtection API version to ''2026-06-01'' (general availability), which natively models the Azure Elastic SAN (Storage Area Network) backup and restore types
