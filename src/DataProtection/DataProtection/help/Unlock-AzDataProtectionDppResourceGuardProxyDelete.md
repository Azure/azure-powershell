...
### UnlockViaJsonString
```
Unlock-AzDataProtectionDppResourceGuardProxyDelete -ResourceGroupName <String> [-SubscriptionId <String>]
 -VaultName <String> [-Token <String>] -JsonString <String> [-DefaultProfile <PSObject>]
...
```
Unlock-AzDataProtectionDppResourceGuardProxyDelete -ResourceGroupName <String> [-SubscriptionId <String>]
 -VaultName <String> [-Token <String>] -JsonFilePath <String> [-DefaultProfile <PSObject>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: UnlockViaJsonString, UnlockViaJsonFilePath
Aliases:
