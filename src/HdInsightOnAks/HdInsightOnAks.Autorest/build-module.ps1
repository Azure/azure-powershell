...
$psd1 = Join-Path $PSScriptRoot './Az.HdInsightOnAks.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: HdInsightOnAks cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.HdInsightOnAks.format.ps1xml'
