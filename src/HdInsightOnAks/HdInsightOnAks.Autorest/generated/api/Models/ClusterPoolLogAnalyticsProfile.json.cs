...
namespace Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Models
{
    ...
    public partial class ClusterPoolLogAnalyticsProfile
    {
        ...
        internal ClusterPoolLogAnalyticsProfile(Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Runtime.Json.JsonObject json)
        {
            ...
            {_workspaceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Runtime.Json.JsonString>("workspaceId"), out var __jsonWorkspaceId) ? (string)__jsonWorkspaceId : (string)WorkspaceId;}
            AfterFromJson(json);
        }
