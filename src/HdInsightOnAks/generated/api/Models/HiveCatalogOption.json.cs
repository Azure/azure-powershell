...
namespace Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Models
{
    ...
    public partial class HiveCatalogOption
    {
        ...
        internal HiveCatalogOption(Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Runtime.Json.JsonObject json)
        {
            ...
            {_catalogName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Runtime.Json.JsonString>("catalogName"), out var __jsonCatalogName) ? (string)__jsonCatalogName : (string)CatalogName;}
            ...
            {_metastoreWarehouseDir = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Runtime.Json.JsonString>("metastoreWarehouseDir"), out var __jsonMetastoreWarehouseDir) ? (string)__jsonMetastoreWarehouseDir : (string)MetastoreWarehouseDir;}
            AfterFromJson(json);
        }
