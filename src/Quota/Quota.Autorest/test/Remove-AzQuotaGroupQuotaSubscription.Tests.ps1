...
Describe 'Remove-AzQuotaGroupQuotaSubscription' {
    It 'Delete' {
        { 
            ...
            Remove-AzQuotaGroupQuotaSubscription -GroupQuotaName $groupQuotaName -ManagementGroupId $mgId -SubscriptionId $subscriptionId -Confirm:$false } | Should -Not -Throw
    }
