...
Describe 'Get-AzQuotaGroupQuotaLimit' {
    It 'List' {
        { Get-AzQuotaGroupQuotaLimit -ManagementGroupId "admintest" -GroupQuotaName "ComputeGroupQuota01" -Location "eastus" -ResourceProviderName "Microsoft.Compute" } | Should -Not -Throw
    }
}
