...
namespace Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview
{
    ...
    public partial class UsagesProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IUsagesPropertiesInternal
    {
        ...
        bool? Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IUsagesPropertiesInternal.IsQuotaApplicable { get => this._isQuotaApplicable; set { {_isQuotaApplicable = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IResourceName Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IUsagesPropertiesInternal.Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.ResourceName()); set { {_name = value;} } }

        /// <summary>Internal Acessors for NameLocalizedValue</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IUsagesPropertiesInternal.NameLocalizedValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IResourceNameInternal)Name).LocalizedValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IResourceNameInternal)Name).LocalizedValue = value; }

        /// <summary>Internal Acessors for QuotaPeriod</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IUsagesPropertiesInternal.QuotaPeriod { get => this._quotaPeriod; set { {_quotaPeriod = value;} } }

        /// <summary>Internal Acessors for Unit</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IUsagesPropertiesInternal.Unit { get => this._unit; set { {_unit = value;} } }

        /// <summary>Internal Acessors for Usage</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IUsagesObject Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IUsagesPropertiesInternal.Usage { get => (this._usage = this._usage ?? new Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.UsagesObject()); set { {_usage = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IUsagesObject _usage;

        /// <summary>The quota limit properties for this resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Quota.Origin(Microsoft.Azure.PowerShell.Cmdlets.Quota.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IUsagesObject Usage { get => (this._usage = this._usage ?? new Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.UsagesObject()); set => this._usage = value; }

        /// <summary>The quota or usages limit types.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Quota.Origin(Microsoft.Azure.PowerShell.Cmdlets.Quota.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Quota.Support.UsagesTypes? UsageUsagesType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IUsagesObjectInternal)Usage).UsagesType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IUsagesObjectInternal)Usage).UsagesType = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Quota.Support.UsagesTypes)""); }

        /// <summary>The usages value.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Quota.Origin(Microsoft.Azure.PowerShell.Cmdlets.Quota.PropertyOrigin.Inlined)]
        public int? UsageValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IUsagesObjectInternal)Usage).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.Api20210315Preview.IUsagesObjectInternal)Usage).Value = value ?? default(int); }
