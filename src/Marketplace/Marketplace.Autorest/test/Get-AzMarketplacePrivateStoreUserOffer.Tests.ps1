...
Describe 'Get-AzMarketplacePrivateStoreUserOffer' {
    It 'QueryExpanded' {
        $response = Get-AzMarketplacePrivateStoreUserOffer -PrivateStoreId a260d38c-96cf-492d-a340-404d0c4b3ad6 -OfferId sendgrid.tsg-saas-offer,kali-linux.kali -SubscriptionId 1f58b5dd-313c-42ed-84fc-f1e351bba7fb
