...
Describe 'Set-AzMarketplacePrivateStoreCollection' {
    It 'UpdateExpanded'  {
	    Set-AzMarketplacePrivateStoreCollection -CollectionId 8c7a91db-cd41-43b6-af47-2e869654126d -CollectionName PWSHTest1 -PrivateStoreId a260d38c-96cf-492d-a340-404d0c4b3ad6 -Enabled 
	    ...
	    $res.collectionName | Should -be PWSHTest1
    }
}
