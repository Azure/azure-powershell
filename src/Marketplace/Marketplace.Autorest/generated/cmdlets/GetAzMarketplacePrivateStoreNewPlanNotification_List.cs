...
namespace Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMarketplacePrivateStoreNewPlanNotification_List", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.INewPlansNotificationsList))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Description(@"List new plans notifications")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Marketplace.HttpPath(Path = "/providers/Microsoft.Marketplace/privateStores/{privateStoreId}/listNewPlansNotifications", ApiVersion = "2023-01-01")]
    public partial class GetAzMarketplacePrivateStoreNewPlanNotification_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.INewPlansNotificationsList">Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.INewPlansNotificationsList</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.INewPlansNotificationsList> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMarketplacePrivateStoreNewPlanNotification_List" /> cmdlet class.
        /// </summary>
        public GetAzMarketplacePrivateStoreNewPlanNotification_List()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.INewPlansNotificationsList> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.INewPlansNotificationsList
                var result = (await response);
                // response should be returning an array of some kind. +Pageable
                // nested-array / newPlansNotifications / <none>
                if (null != result.NewPlansNotification)
                {
                    if (0 == _responseSize && 1 == result.NewPlansNotification.Count)
                    {
                        _firstResponse = result.NewPlansNotification[0];
                        _responseSize = 1;
                    }
                    else
                    {
                        ...
                        foreach( var value in result.NewPlansNotification )
                        {
