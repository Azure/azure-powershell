...
namespace Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListByContexts=>POST:"/providers/Microsoft.Marketplace/privateStores/{privateStoreId}/collections/{collectionId}/mapOffersToContexts"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMarketplacePrivateStoreCollectionMapOffersToContext_ListExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.ICollectionOffersByContext))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Description(@"Get a list of all offers in the given collection according to the required contexts.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Marketplace.HttpPath(Path = "/providers/Microsoft.Marketplace/privateStores/{privateStoreId}/collections/{collectionId}/mapOffersToContexts", ApiVersion = "2023-01-01")]
    public partial class GetAzMarketplacePrivateStoreCollectionMapOffersToContext_ListExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.ICollectionOffersByAllContextsPayload _payloadBody = new Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.CollectionOffersByAllContextsPayload();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Subscription ids list")]
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.ICollectionOffersByContextList">Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.ICollectionOffersByContextList</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.ICollectionOffersByContextList> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMarketplacePrivateStoreCollectionMapOffersToContext_ListExpanded" />
        /// cmdlet class.
        /// </summary>
        public GetAzMarketplacePrivateStoreCollectionMapOffersToContext_ListExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PrivateStoreCollectionOfferListByContexts' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PrivateStoreCollectionOfferListByContexts(PrivateStoreId, CollectionId, _payloadBody, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.ICollectionOffersByContextList> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.ICollectionOffersByContextList
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.PrivateStoreCollectionOfferListByContexts_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
