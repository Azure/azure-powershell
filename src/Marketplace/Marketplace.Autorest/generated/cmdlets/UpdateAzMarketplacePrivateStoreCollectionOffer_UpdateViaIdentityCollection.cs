...
namespace Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMarketplacePrivateStoreCollectionOffer_UpdateViaIdentityCollection", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzMarketplacePrivateStoreCollectionOffer_UpdateViaIdentityCollection : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IOffer _payload;

        /// <summary>The privateStore offer data structure.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The privateStore offer data structure.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IOffer Payload { get => this._payload; set => this._payload = value; }
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (CollectionInputObject?.Id != null)
                    {
                        ...
                        Payload = await this.Client.PrivateStoreCollectionOfferGetViaIdentityWithResult(CollectionInputObject.Id, this, Pipeline);
                        this.UpdatePayload();
                        await this.Client.PrivateStoreCollectionOfferCreateOrUpdateViaIdentity(CollectionInputObject.Id, Payload, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        Payload = await this.Client.PrivateStoreCollectionOfferGetWithResult(CollectionInputObject.PrivateStoreId ?? null, CollectionInputObject.CollectionId ?? null, OfferId, this, Pipeline);
                        this.UpdatePayload();
                        await this.Client.PrivateStoreCollectionOfferCreateOrUpdate(CollectionInputObject.PrivateStoreId ?? null, CollectionInputObject.CollectionId ?? null, OfferId, Payload, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzMarketplacePrivateStoreCollectionOffer_UpdateViaIdentityCollection"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzMarketplacePrivateStoreCollectionOffer_UpdateViaIdentityCollection()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Payload")))
            {
                this.Payload = (Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IOffer)(this.MyInvocation?.BoundParameters["Payload"]);
            }
        }
