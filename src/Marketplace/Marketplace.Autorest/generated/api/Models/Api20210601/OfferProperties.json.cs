...
namespace Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.Api20210601
{
    ...
    public partial class OfferProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.Api20210601.IOfferProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.Api20210601.IOfferProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.Api20210601.IOfferProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonNode node)
        {
        ...
        internal OfferProperties(Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonObject json)
        {
            ...
            {_offerDisplayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonString>("offerDisplayName"), out var __jsonOfferDisplayName) ? (string)__jsonOfferDisplayName : (string)OfferDisplayName;}
            {_publisherDisplayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonString>("publisherDisplayName"), out var __jsonPublisherDisplayName) ? (string)__jsonPublisherDisplayName : (string)PublisherDisplayName;}
            ...
            {_createdAt = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonString>("createdAt"), out var __jsonCreatedAt) ? (string)__jsonCreatedAt : (string)CreatedAt;}
            {_modifiedAt = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonString>("modifiedAt"), out var __jsonModifiedAt) ? (string)__jsonModifiedAt : (string)ModifiedAt;}
            {_specificPlanIdsLimitation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonArray>("specificPlanIdsLimitation"), out var __jsonSpecificPlanIdsLimitation) ? If( __jsonSpecificPlanIdsLimitation as Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : SpecificPlanIdsLimitation;}
            {_updateSuppressedDueIdempotence = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonBoolean>("updateSuppressedDueIdempotence"), out var __jsonUpdateSuppressedDueIdempotence) ? (bool?)__jsonUpdateSuppressedDueIdempotence : UpdateSuppressedDueIdempotence;}
            {_iconFileUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonObject>("iconFileUris"), out var __jsonIconFileUris) ? Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.Api20210601.OfferPropertiesIconFileUris.FromJson(__jsonIconFileUris) : IconFileUri;}
            {_plan = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonArray>("plans"), out var __jsonPlans) ? If( __jsonPlans as Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.Api20210601.IPlan[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.Api20210601.IPlan) (Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.Api20210601.Plan.FromJson(__p) )) ))() : null : Plan;}
            AfterFromJson(json);
        }
