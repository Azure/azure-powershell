...
namespace Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.Api20210601
{
    ...
    public partial class SingleOperationDisplay :
        Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.Api20210601.ISingleOperationDisplay,
        Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.Api20210601.ISingleOperationDisplayInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.Api20210601.ISingleOperationDisplayInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for Operation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.Api20210601.ISingleOperationDisplayInternal.Operation { get => this._operation; set { {_operation = value;} } }

        /// <summary>Internal Acessors for Provider</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.Api20210601.ISingleOperationDisplayInternal.Provider { get => this._provider; set { {_provider = value;} } }

        /// <summary>Internal Acessors for Resource</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.Api20210601.ISingleOperationDisplayInternal.Resource { get => this._resource; set { {_resource = value;} } }
