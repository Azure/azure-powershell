...
INPUTOBJECT <IMarketplaceIdentity>: Identity Parameter
  ...
  [RequestApprovalId <String>]: The request approval ID to get create or update
.Link
https://docs.microsoft.com/powershell/module/az.marketplace/get-azmarketplaceprivatestore
#>
function Get-AzMarketplacePrivateStore {
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Get = 'Az.Marketplace.private\Get-AzMarketplacePrivateStore_Get';
            GetViaIdentity = 'Az.Marketplace.private\Get-AzMarketplacePrivateStore_GetViaIdentity';
            List = 'Az.Marketplace.private\Get-AzMarketplacePrivateStore_List';
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
