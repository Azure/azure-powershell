...
namespace Microsoft.Azure.Management.Marketplace.Models
{
    ...
    public partial class Offer : Resource
    {
        ...
        /// </param>
        public Offer(string id = default(string), string name = default(string), string type = default(string), string uniqueOfferId = default(string), string offerDisplayName = default(string), string publisherDisplayName = default(string), string eTag = default(string), string privateStoreId = default(string), string createdBy = default(string), string createdDate = default(string), System.Collections.Generic.IList<string> specificPlanIdsLimitation = default(System.Collections.Generic.IList<string>))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.offerDisplayName")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.specificPlanIdsLimitation")]
