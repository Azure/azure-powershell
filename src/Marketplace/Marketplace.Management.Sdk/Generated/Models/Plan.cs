...
namespace Microsoft.Azure.Management.Marketplace.Models
{
    ...
    public partial class Plan
    {
        ...
        /// <param name="skuId">Identifier for this plan
        /// </param>

        /// <param name="planId">Text identifier for this plan
        /// </param>

        /// <param name="planDisplayName">Friendly name for the plan for display in the marketplace
        /// </param>
