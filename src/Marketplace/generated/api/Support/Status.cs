...
namespace Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Support.Status Approved = @"Approved";

        public static Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Support.Status None = @"None";

        public static Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Support.Status Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Support.Status Rejected = @"Rejected";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
