...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.DeliveryRuleRemoteAddressCondition])]
...
begin {
    try {
        ...
        $mapping = @{
            __AllParameterSets = 'Az.Cdn.custom\New-AzCdnDeliveryRuleRemoteAddressConditionObject';
        }
