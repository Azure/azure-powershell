...
Describe 'Test-AzFrontDoorCdnProfileMigration'{
    It 'CanExpanded' {
        ...
        $canMigrate = Test-AzFrontDoorCdnProfileMigration -SubscriptionId $subId -ResourceGroupName $env.ResourceGroupName -ClassicResourceReferenceId $classicResourceReferenceId
