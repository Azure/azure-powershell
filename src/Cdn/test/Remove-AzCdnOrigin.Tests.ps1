...
Describe 'Remove-AzCdnOrigin'  {
    ...
    It 'DeleteViaIdentity' {
        ...
        Get-AzCdnOrigin -Name "origin2" -EndpointName $endpointName -ProfileName $env.ClassicCdnProfileName -ResourceGroupName $env.ResourceGroupName | Remove-AzCdnOrigin
    }
}
