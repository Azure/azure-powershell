...
Describe 'Remove-AzFrontDoorCdnRoute'  {
    ...
    It 'Delete'  {
        Remove-AzFrontDoorCdnRoute -ResourceGroupName $env.ResourceGroupName -ProfileName $env.FrontDoorCdnProfileName -EndpointName $env.FrontDoorEndpointName -Name $routeName
    }
