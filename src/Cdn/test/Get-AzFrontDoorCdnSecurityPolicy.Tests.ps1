...
Describe 'Get-AzFrontDoorCdnSecurityPolicy'  {
    It 'List' {
        ...
        try
        {
            ...
            $frontDoorCdnProfile = New-AzFrontDoorCdnProfile -SkuName $profileSku -Name $frontDoorCdnProfileName -ResourceGroupName $ResourceGroupName -Location Global -SubscriptionId $subId
            ...
            $policies = Get-AzFrontDoorCdnSecurityPolicy -ProfileName $frontDoorCdnProfileName -ResourceGroupName $ResourceGroupName -SubscriptionId $subId
