...
### GetViaIdentity
```
Get-AzCdnLogAnalyticWafLogAnalyticRanking -InputObject <ICdnIdentity> -DateTimeBegin <DateTime>
 -DateTimeEnd <DateTime> -MaxRanking <Int32> -Metric <WafMetric[]> -Ranking <WafRankingType[]>
 [-Action <WafAction[]>] [-RuleType <WafRuleType[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
