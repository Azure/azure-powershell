...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IRuleUpdateParametersInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IRuleUpdatePropertiesParameters Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IRuleUpdateParametersInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.RuleUpdatePropertiesParameters()); set { {_property = value;} } }

        /// <summary>Internal Acessors for RuleSetName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IRuleUpdateParametersInternal.RuleSetName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IRuleUpdatePropertiesParametersInternal)Property).RuleSetName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IRuleUpdatePropertiesParametersInternal)Property).RuleSetName = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IRuleUpdatePropertiesParameters _property;

        /// <summary>The JSON object that contains the properties of the rule to update.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IRuleUpdatePropertiesParameters Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.RuleUpdatePropertiesParameters()); set => this._property = value; }

        /// <summary>The name of the rule set containing the rule.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public string RuleSetName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IRuleUpdatePropertiesParametersInternal)Property).RuleSetName; }
...

    {
        ...
        int? Order { get; set; }
        /// <summary>The JSON object that contains the properties of the rule to update.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IRuleUpdatePropertiesParameters Property { get; set; }
        /// <summary>The name of the rule set containing the rule.</summary>
