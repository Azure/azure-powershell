...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601
{
    ...
    public partial class AfdDomainUpdatePropertiesParameters
    {
        ...
        internal AfdDomainUpdatePropertiesParameters(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject json)
        {
            ...
            {_azureDnsZone = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject>("azureDnsZone"), out var __jsonAzureDnsZone) ? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ResourceReference.FromJson(__jsonAzureDnsZone) : AzureDnsZone;}
            {_afdDomainUpdatePropertiesParametersPreValidatedCustomDomainResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject>("preValidatedCustomDomainResourceId"), out var __jsonPreValidatedCustomDomainResourceId) ? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ResourceReference.FromJson(__jsonPreValidatedCustomDomainResourceId) : AfdDomainUpdatePropertiesParametersPreValidatedCustomDomainResourceId;}
            ...
            {_tlsSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject>("tlsSettings"), out var __jsonTlsSettings) ? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.AfdDomainHttpsParameters.FromJson(__jsonTlsSettings) : TlsSetting;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IAfdDomainUpdatePropertiesParameters.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IAfdDomainUpdatePropertiesParameters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IAfdDomainUpdatePropertiesParameters FromJson(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode node)
        {
