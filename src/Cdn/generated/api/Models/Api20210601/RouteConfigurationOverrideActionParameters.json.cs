...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601
{
    ...
    public partial class RouteConfigurationOverrideActionParameters
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IRouteConfigurationOverrideActionParameters.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IRouteConfigurationOverrideActionParameters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IRouteConfigurationOverrideActionParameters FromJson(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode node)
        {
        ...
        internal RouteConfigurationOverrideActionParameters(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject json)
        {
            ...
            {_originGroupOverride = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject>("originGroupOverride"), out var __jsonOriginGroupOverride) ? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.OriginGroupOverride.FromJson(__jsonOriginGroupOverride) : OriginGroupOverride;}
            {_cacheConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject>("cacheConfiguration"), out var __jsonCacheConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.CacheConfiguration.FromJson(__jsonCacheConfiguration) : CacheConfiguration;}
