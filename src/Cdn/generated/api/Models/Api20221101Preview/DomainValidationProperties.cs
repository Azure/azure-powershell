...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview
{
    ...
    public partial class DomainValidationProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IDomainValidationProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IDomainValidationPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IDomainValidationPropertiesInternal.ExpirationDate { get => this._expirationDate; set { {_expirationDate = value;} } }

        /// <summary>Internal Acessors for ValidationToken</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IDomainValidationPropertiesInternal.ValidationToken { get => this._validationToken; set { {_validationToken = value;} } }
