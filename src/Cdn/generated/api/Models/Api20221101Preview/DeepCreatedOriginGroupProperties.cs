...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview
{
    ...
    public partial class DeepCreatedOriginGroupProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IDeepCreatedOriginGroupProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IDeepCreatedOriginGroupPropertiesInternal
    {

        /// <summary>Backing field for <see cref="HealthProbeSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IHealthProbeParameters _healthProbeSetting;

        /// <summary>
        /// Health probe settings to the origin that is used to determine the health of the origin.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IHealthProbeParameters HealthProbeSetting { get => (this._healthProbeSetting = this._healthProbeSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.HealthProbeParameters()); set => this._healthProbeSetting = value; }

        /// <summary>Backing field for <see cref="Origin" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IResourceReference[] _origin;

        /// <summary>The source of the content being delivered via CDN within given origin group.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IResourceReference[] Origin { get => this._origin; set => this._origin = value; }

        /// <summary>
        /// Backing field for <see cref="ResponseBasedOriginErrorDetectionSetting" /> property.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IResponseBasedOriginErrorDetectionParameters _responseBasedOriginErrorDetectionSetting;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IResponseBasedOriginErrorDetectionParameters ResponseBasedOriginErrorDetectionSetting { get => (this._responseBasedOriginErrorDetectionSetting = this._responseBasedOriginErrorDetectionSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.ResponseBasedOriginErrorDetectionParameters()); set => this._responseBasedOriginErrorDetectionSetting = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IHealthProbeParameters) })]
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IHealthProbeParameters HealthProbeSetting { get; set; }
        /// <summary>The source of the content being delivered via CDN within given origin group.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IResourceReference[] Origin { get; set; }
        /// <summary>
        /// The JSON object that contains the properties to determine origin health using real requests/responses.This property is
        /// currently not supported.
        /// </summary>
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IResponseBasedOriginErrorDetectionParameters) })]
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20221101Preview.IResponseBasedOriginErrorDetectionParameters ResponseBasedOriginErrorDetectionSetting { get; set; }
        /// <summary>
        /// Time in minutes to shift the traffic to the endpoint gradually when an unhealthy endpoint comes healthy or a new endpoint
        /// is added. Default is 10 mins. This property is currently not supported.
        /// </summary>
