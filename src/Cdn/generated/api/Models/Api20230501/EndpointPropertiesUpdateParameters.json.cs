...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501
{
    ...
    public partial class EndpointPropertiesUpdateParameters
    {
        ...
        internal EndpointPropertiesUpdateParameters(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject json)
        {
            ...
            {_defaultOriginGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject>("defaultOriginGroup"), out var __jsonDefaultOriginGroup) ? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ResourceReference.FromJson(__jsonDefaultOriginGroup) : DefaultOriginGroup;}
            {_deliveryPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject>("deliveryPolicy"), out var __jsonDeliveryPolicy) ? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.EndpointPropertiesUpdateParametersDeliveryPolicy.FromJson(__jsonDeliveryPolicy) : DeliveryPolicy;}
            {_webApplicationFirewallPolicyLink = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject>("webApplicationFirewallPolicyLink"), out var __jsonWebApplicationFirewallPolicyLink) ? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLink.FromJson(__jsonWebApplicationFirewallPolicyLink) : WebApplicationFirewallPolicyLink;}
            ...
            {_geoFilter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonArray>("geoFilters"), out var __jsonGeoFilters) ? If( __jsonGeoFilters as Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IGeoFilter[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IGeoFilter) (Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.GeoFilter.FromJson(__p) )) ))() : null : GeoFilter;}
            {_urlSigningKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonArray>("urlSigningKeys"), out var __jsonUrlSigningKeys) ? If( __jsonUrlSigningKeys as Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IUrlSigningKey[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IUrlSigningKey) (Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.UrlSigningKey.FromJson(__k) )) ))() : null : UrlSigningKey;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IEndpointPropertiesUpdateParameters.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IEndpointPropertiesUpdateParameters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IEndpointPropertiesUpdateParameters FromJson(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode node)
        {
