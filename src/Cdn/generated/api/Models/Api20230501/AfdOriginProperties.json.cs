...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501
{
    ...
    public partial class AfdOriginProperties
    {
        ...
        internal AfdOriginProperties(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject json)
        {
            ...
            __afdOriginUpdatePropertiesParameters = new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.AfdOriginUpdatePropertiesParameters(json);
            __afdStateProperties = new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.AfdStateProperties(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IAfdOriginProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IAfdOriginProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IAfdOriginProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode node)
        {
