...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501
{
    ...
    public partial class KeyVaultCertificateSourceParameters :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IKeyVaultCertificateSourceParameters,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IKeyVaultCertificateSourceParametersInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IKeyVaultCertificateSourceParametersInternal.DeleteRule { get => this._deleteRule; set { {_deleteRule = value;} } }

        /// <summary>Internal Acessors for TypeName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IKeyVaultCertificateSourceParametersInternal.TypeName { get => this._typeName; set { {_typeName = value;} } }

        /// <summary>Internal Acessors for UpdateRule</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IKeyVaultCertificateSourceParametersInternal.UpdateRule { get => this._updateRule; set { {_updateRule = value;} } }
