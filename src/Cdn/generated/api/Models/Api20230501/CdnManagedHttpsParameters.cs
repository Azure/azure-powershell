...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501
{
    ...
    public partial class CdnManagedHttpsParameters :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICdnManagedHttpsParameters,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IValidates
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICdnCertificateSourceParameters _certificateSourceParameter;

        /// <summary>
        /// Defines the certificate source parameters using CDN managed certificate for enabling SSL.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICdnCertificateSourceParameters CertificateSourceParameter { get => (this._certificateSourceParameter = this._certificateSourceParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.CdnCertificateSourceParameters()); set => this._certificateSourceParameter = value; }

        /// <summary>Type of certificate used</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.CertificateType CertificateSourceParameterCertificateType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICdnCertificateSourceParametersInternal)CertificateSourceParameter).CertificateType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICdnCertificateSourceParametersInternal)CertificateSourceParameter).CertificateType = value ; }

        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public string CertificateSourceParameterTypeName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICdnCertificateSourceParametersInternal)CertificateSourceParameter).TypeName; }

        /// <summary>Internal Acessors for CertificateSourceParameter</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICdnCertificateSourceParameters Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICdnManagedHttpsParametersInternal.CertificateSourceParameter { get => (this._certificateSourceParameter = this._certificateSourceParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.CdnCertificateSourceParameters()); set { {_certificateSourceParameter = value;} } }

        /// <summary>Internal Acessors for CertificateSourceParameterTypeName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICdnManagedHttpsParametersInternal.CertificateSourceParameterTypeName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICdnCertificateSourceParametersInternal)CertificateSourceParameter).TypeName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICdnCertificateSourceParametersInternal)CertificateSourceParameter).TypeName = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICustomDomainHttpsParametersInternal
    {
        ...
        /// Defines the certificate source parameters using CDN managed certificate for enabling SSL.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICdnCertificateSourceParameters CertificateSourceParameter { get; set; }
        /// <summary>Type of certificate used</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.CertificateType CertificateSourceParameterCertificateType { get; set; }
