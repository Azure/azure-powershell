...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501
{
    ...
    public partial class MigrationErrorType :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IMigrationErrorType,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IMigrationErrorTypeInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IMigrationErrorTypeInternal.Code { get => this._code; set { {_code = value;} } }

        /// <summary>Internal Acessors for ErrorMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IMigrationErrorTypeInternal.ErrorMessage { get => this._errorMessage; set { {_errorMessage = value;} } }

        /// <summary>Internal Acessors for NextStep</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IMigrationErrorTypeInternal.NextStep { get => this._nextStep; set { {_nextStep = value;} } }

        /// <summary>Internal Acessors for ResourceName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IMigrationErrorTypeInternal.ResourceName { get => this._resourceName; set { {_resourceName = value;} } }
