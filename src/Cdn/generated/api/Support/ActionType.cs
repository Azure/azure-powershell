...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ActionType Allow = @"Allow";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ActionType Block = @"Block";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ActionType Log = @"Log";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ActionType Redirect = @"Redirect";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ActionType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ActionType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ActionType e1, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ActionType e2)
        {
            return !e2.Equals(e1);
        }
