...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.Status AccessDenied = @"AccessDenied";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.Status CertificateExpired = @"CertificateExpired";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.Status Invalid = @"Invalid";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.Status Valid = @"Valid";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.Status e)
        {
            return e._value;
        }
