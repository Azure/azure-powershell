...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        public int HealthProbeSettingProbeIntervalInSecond { get => OriginGroupBody.HealthProbeSettingProbeIntervalInSecond ?? default(int); set => OriginGroupBody.HealthProbeSettingProbeIntervalInSecond = value; }
        ...
        public string HealthProbeSettingProbePath { get => OriginGroupBody.HealthProbeSettingProbePath ?? null; set => OriginGroupBody.HealthProbeSettingProbePath = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ProbeProtocol HealthProbeSettingProbeProtocol { get => OriginGroupBody.HealthProbeSettingProbeProtocol ?? ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ProbeProtocol)""); set => OriginGroupBody.HealthProbeSettingProbeProtocol = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.HealthProbeRequestType HealthProbeSettingProbeRequestType { get => OriginGroupBody.HealthProbeSettingProbeRequestType ?? ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.HealthProbeRequestType)""); set => OriginGroupBody.HealthProbeSettingProbeRequestType = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The additional latency in milliseconds for probes to fall into the lowest latency bucket")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int LoadBalancingSettingAdditionalLatencyInMillisecond { get => OriginGroupBody.LoadBalancingSettingAdditionalLatencyInMillisecond ?? default(int); set => OriginGroupBody.LoadBalancingSettingAdditionalLatencyInMillisecond = value; }

        /// <summary>The number of samples to consider for load balancing decisions</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The number of samples to consider for load balancing decisions")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int LoadBalancingSettingSampleSize { get => OriginGroupBody.LoadBalancingSettingSampleSize ?? default(int); set => OriginGroupBody.LoadBalancingSettingSampleSize = value; }

        /// <summary>The number of samples within the sample period that must succeed</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The number of samples within the sample period that must succeed")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int LoadBalancingSettingSuccessfulSamplesRequired { get => OriginGroupBody.LoadBalancingSettingSuccessfulSamplesRequired ?? default(int); set => OriginGroupBody.LoadBalancingSettingSuccessfulSamplesRequired = value; }
        ...
        /// <summary>Backing field for <see cref="OriginGroupBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IAfdOriginGroup _originGroupBody= new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.AfdOriginGroup();

        /// <summary>
        /// AFDOrigin group comprising of origins is used for load balancing to origins when the content cannot be served from CDN.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IAfdOriginGroup OriginGroupBody { get => this._originGroupBody; set => this._originGroupBody = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.EnabledState SessionAffinityState { get => OriginGroupBody.SessionAffinityState ?? ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.EnabledState)""); set => OriginGroupBody.SessionAffinityState = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int TrafficRestorationTimeToHealedOrNewEndpointsInMinute { get => OriginGroupBody.TrafficRestorationTimeToHealedOrNewEndpointsInMinute ?? default(int); set => OriginGroupBody.TrafficRestorationTimeToHealedOrNewEndpointsInMinute = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.NewAzFrontDoorCdnOriginGroup_CreateExpanded Clone()
        {
            ...
            clone.OriginGroupBody = this.OriginGroupBody;
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AfdOriginGroupsCreate(ResourceGroupName, ProfileName, OriginGroupName, SubscriptionId, OriginGroupBody, onOk, onDefault, this, Pipeline);
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IAfdErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, OriginGroupName=OriginGroupName, SubscriptionId=SubscriptionId, body=OriginGroupBody })
                    {
