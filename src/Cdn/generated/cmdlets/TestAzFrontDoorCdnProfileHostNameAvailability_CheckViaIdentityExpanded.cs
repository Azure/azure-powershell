...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="CheckHostNameAvailabilityInputBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICheckHostNameAvailabilityInput _checkHostNameAvailabilityInputBody= new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.CheckHostNameAvailabilityInput();

        /// <summary>Input of CheckHostNameAvailability API.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICheckHostNameAvailabilityInput CheckHostNameAvailabilityInputBody { get => this._checkHostNameAvailabilityInputBody; set => this._checkHostNameAvailabilityInputBody = value; }
        ...
        public string HostName { get => CheckHostNameAvailabilityInputBody.HostName ?? null; set => CheckHostNameAvailabilityInputBody.HostName = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.AfdProfilesCheckHostNameAvailabilityViaIdentity(InputObject.Id, CheckHostNameAvailabilityInputBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.AfdProfilesCheckHostNameAvailability(InputObject.ResourceGroupName ?? null, InputObject.ProfileName ?? null, InputObject.SubscriptionId ?? null, CheckHostNameAvailabilityInputBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=CheckHostNameAvailabilityInputBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IAfdErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=CheckHostNameAvailabilityInputBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=CheckHostNameAvailabilityInputBody })
                    {
