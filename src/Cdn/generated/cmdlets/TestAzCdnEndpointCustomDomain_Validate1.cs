...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzCdnEndpointCustomDomain_Validate1", SupportsShouldProcess = true)]
    ...
    public partial class TestAzCdnEndpointCustomDomain_Validate1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IValidateCustomDomainInput _customDomainProperty;

        /// <summary>Input of the custom domain to be validated for DNS mapping.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Input of the custom domain to be validated for DNS mapping.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Input of the custom domain to be validated for DNS mapping.",
        SerializedName = @"customDomainProperties",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IValidateCustomDomainInput) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IValidateCustomDomainInput CustomDomainProperty { get => this._customDomainProperty; set => this._customDomainProperty = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.EndpointsValidateCustomDomain(ResourceGroupName, ProfileName, EndpointName, SubscriptionId, CustomDomainProperty, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,ProfileName=ProfileName,EndpointName=EndpointName,SubscriptionId=SubscriptionId,body=CustomDomainProperty})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzCdnEndpointCustomDomain_Validate1" /> cmdlet class.
        /// </summary>
        public TestAzCdnEndpointCustomDomain_Validate1()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, EndpointName=EndpointName, SubscriptionId=SubscriptionId, body=CustomDomainProperty })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, EndpointName=EndpointName, SubscriptionId=SubscriptionId, body=CustomDomainProperty })
                    {
