...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzFrontDoorCdnProfileHostNameAvailability_Check", SupportsShouldProcess = true)]
    ...
    public partial class TestAzFrontDoorCdnProfileHostNameAvailability_Check : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="CheckHostNameAvailabilityInput" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICheckHostNameAvailabilityInput _checkHostNameAvailabilityInput;

        /// <summary>Input of CheckHostNameAvailability API.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Input of CheckHostNameAvailability API.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Input of CheckHostNameAvailability API.",
        SerializedName = @"checkHostNameAvailabilityInput",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICheckHostNameAvailabilityInput) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICheckHostNameAvailabilityInput CheckHostNameAvailabilityInput { get => this._checkHostNameAvailabilityInput; set => this._checkHostNameAvailabilityInput = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AfdProfilesCheckHostNameAvailability(ResourceGroupName, ProfileName, SubscriptionId, CheckHostNameAvailabilityInput, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,ProfileName=ProfileName,SubscriptionId=SubscriptionId,body=CheckHostNameAvailabilityInput})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzFrontDoorCdnProfileHostNameAvailability_Check" /> cmdlet class.
        /// </summary>
        public TestAzFrontDoorCdnProfileHostNameAvailability_Check()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IAfdErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, SubscriptionId=SubscriptionId, body=CheckHostNameAvailabilityInput })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, SubscriptionId=SubscriptionId, body=CheckHostNameAvailabilityInput })
                    {
