...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzFrontDoorCdnSecurityPolicy_PatchViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzFrontDoorCdnSecurityPolicy_PatchViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="SecurityPolicyUpdateProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ISecurityPolicyUpdateParameters _securityPolicyUpdateProperty;

        /// <summary>The JSON object containing security policy update parameters.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The JSON object containing security policy update parameters.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The JSON object containing security policy update parameters.",
        SerializedName = @"securityPolicyUpdateProperties",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ISecurityPolicyUpdateParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ISecurityPolicyUpdateParameters SecurityPolicyUpdateProperty { get => this._securityPolicyUpdateProperty; set => this._securityPolicyUpdateProperty = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzFrontDoorCdnSecurityPolicy_PatchViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.UpdateAzFrontDoorCdnSecurityPolicy_PatchViaIdentity Clone()
        {
            var clone = new UpdateAzFrontDoorCdnSecurityPolicy_PatchViaIdentity();
            ...
            clone.SecurityPolicyUpdateProperty = this.SecurityPolicyUpdateProperty;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.SecurityPoliciesPatchViaIdentity(InputObject.Id, SecurityPolicyUpdateProperty, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.SecurityPoliciesPatch(InputObject.ResourceGroupName ?? null, InputObject.ProfileName ?? null, InputObject.SecurityPolicyName ?? null, InputObject.SubscriptionId ?? null, SecurityPolicyUpdateProperty, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=SecurityPolicyUpdateProperty})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzFrontDoorCdnSecurityPolicy_PatchViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzFrontDoorCdnSecurityPolicy_PatchViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IAfdErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=SecurityPolicyUpdateProperty })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=SecurityPolicyUpdateProperty })
                    {
