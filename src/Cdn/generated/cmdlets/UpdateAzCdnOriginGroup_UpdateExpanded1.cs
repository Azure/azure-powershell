...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzCdnOriginGroup_UpdateExpanded1", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzCdnOriginGroup_UpdateExpanded1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The number of seconds between health probes.Default is 240sec.")]
        ...
        public int HealthProbeSettingProbeIntervalInSecond { get => OriginGroupUpdatePropertiesBody.HealthProbeSettingProbeIntervalInSecond ?? default(int); set => OriginGroupUpdatePropertiesBody.HealthProbeSettingProbeIntervalInSecond = value; }

        /// <summary>
        /// The path relative to the origin that is used to determine the health of the origin.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The path relative to the origin that is used to determine the health of the origin.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string HealthProbeSettingProbePath { get => OriginGroupUpdatePropertiesBody.HealthProbeSettingProbePath ?? null; set => OriginGroupUpdatePropertiesBody.HealthProbeSettingProbePath = value; }

        /// <summary>Protocol to use for health probe.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Protocol to use for health probe.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ProbeProtocol))]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ProbeProtocol HealthProbeSettingProbeProtocol { get => OriginGroupUpdatePropertiesBody.HealthProbeSettingProbeProtocol ?? ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ProbeProtocol)""); set => OriginGroupUpdatePropertiesBody.HealthProbeSettingProbeProtocol = value; }

        /// <summary>The type of health probe request that is made.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The type of health probe request that is made.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.HealthProbeRequestType))]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.HealthProbeRequestType HealthProbeSettingProbeRequestType { get => OriginGroupUpdatePropertiesBody.HealthProbeSettingProbeRequestType ?? ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.HealthProbeRequestType)""); set => OriginGroupUpdatePropertiesBody.HealthProbeSettingProbeRequestType = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The list of Http status code ranges that are considered as server errors for origin and it is marked as unhealthy.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IHttpErrorRangeParameters[] ResponseBasedOriginErrorDetectionSettingHttpErrorRange { get => OriginGroupUpdatePropertiesBody.ResponseBasedOriginErrorDetectionSettingHttpErrorRange ?? null /* arrayOf */; set => OriginGroupUpdatePropertiesBody.ResponseBasedOriginErrorDetectionSettingHttpErrorRange = value; }

        /// <summary>
        /// Type of response errors for real user requests for which origin will be deemed unhealthy
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Type of response errors for real user requests for which origin will be deemed unhealthy")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ResponseBasedDetectedErrorTypes))]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ResponseBasedDetectedErrorTypes ResponseBasedOriginErrorDetectionSettingResponseBasedDetectedErrorType { get => OriginGroupUpdatePropertiesBody.ResponseBasedOriginErrorDetectionSettingResponseBasedDetectedErrorType ?? ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ResponseBasedDetectedErrorTypes)""); set => OriginGroupUpdatePropertiesBody.ResponseBasedOriginErrorDetectionSettingResponseBasedDetectedErrorType = value; }

        /// <summary>The percentage of failed requests in the sample where failover should trigger.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The percentage of failed requests in the sample where failover should trigger.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <returns>a duplicate instance of UpdateAzCdnOriginGroup_UpdateExpanded1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.UpdateAzCdnOriginGroup_UpdateExpanded1 Clone()
        {
            var clone = new UpdateAzCdnOriginGroup_UpdateExpanded1();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.OriginGroupsUpdate(ResourceGroupName, ProfileName, EndpointName, Name, SubscriptionId, OriginGroupUpdatePropertiesBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,ProfileName=ProfileName,EndpointName=EndpointName,Name=Name,SubscriptionId=SubscriptionId,body=OriginGroupUpdatePropertiesBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzCdnOriginGroup_UpdateExpanded1" /> cmdlet class.
        /// </summary>
        public UpdateAzCdnOriginGroup_UpdateExpanded1()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, EndpointName=EndpointName, Name=Name, SubscriptionId=SubscriptionId, body=OriginGroupUpdatePropertiesBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, EndpointName=EndpointName, Name=Name, SubscriptionId=SubscriptionId, body=OriginGroupUpdatePropertiesBody })
                    {
