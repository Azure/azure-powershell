...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Import, @"AzCdnEndpointContent_LoadExpanded", SupportsShouldProcess = true)]
    ...
    public partial class ImportAzCdnEndpointContent_LoadExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ContentFilePathsBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ILoadParameters _contentFilePathsBody= new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.LoadParameters();

        /// <summary>Parameters required for content load.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ILoadParameters ContentFilePathsBody { get => this._contentFilePathsBody; set => this._contentFilePathsBody = value; }

        /// <summary>
        /// The path to the content to be loaded. Path should be a relative file URL of the origin.
        /// </summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The path to the content to be loaded. Path should be a relative file URL of the origin.")]
        ...
        public string[] ContentPath { get => ContentFilePathsBody.ContentPath ?? null /* arrayOf */; set => ContentFilePathsBody.ContentPath = value; }
        ...
        /// <returns>a duplicate instance of ImportAzCdnEndpointContent_LoadExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.ImportAzCdnEndpointContent_LoadExpanded Clone()
        {
            var clone = new ImportAzCdnEndpointContent_LoadExpanded();
            ...
            clone.ContentFilePathsBody = this.ContentFilePathsBody;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ImportAzCdnEndpointContent_LoadExpanded" /> cmdlet class.
        /// </summary>
        public ImportAzCdnEndpointContent_LoadExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.EndpointsLoadContent(ResourceGroupName, ProfileName, EndpointName, SubscriptionId, ContentFilePathsBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,ProfileName=ProfileName,EndpointName=EndpointName,SubscriptionId=SubscriptionId,body=ContentFilePathsBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, EndpointName=EndpointName, SubscriptionId=SubscriptionId, body=ContentFilePathsBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, EndpointName=EndpointName, SubscriptionId=SubscriptionId, body=ContentFilePathsBody })
                    {
