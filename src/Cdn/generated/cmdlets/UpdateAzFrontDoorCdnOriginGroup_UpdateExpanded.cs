...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int LoadBalancingSettingAdditionalLatencyInMillisecond { get => OriginGroupUpdatePropertiesBody.LoadBalancingSettingAdditionalLatencyInMillisecond ?? default(int); set => OriginGroupUpdatePropertiesBody.LoadBalancingSettingAdditionalLatencyInMillisecond = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int LoadBalancingSettingSampleSize { get => OriginGroupUpdatePropertiesBody.LoadBalancingSettingSampleSize ?? default(int); set => OriginGroupUpdatePropertiesBody.LoadBalancingSettingSampleSize = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int LoadBalancingSettingSuccessfulSamplesRequired { get => OriginGroupUpdatePropertiesBody.LoadBalancingSettingSuccessfulSamplesRequired ?? default(int); set => OriginGroupUpdatePropertiesBody.LoadBalancingSettingSuccessfulSamplesRequired = value; }
