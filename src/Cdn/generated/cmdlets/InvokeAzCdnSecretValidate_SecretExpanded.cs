...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzCdnSecretValidate_SecretExpanded", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzCdnSecretValidate_SecretExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        public string SecretSourceId { get => ValidateSecretInputBody.SecretSourceId ?? null; set => ValidateSecretInputBody.SecretSourceId = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.SecretType SecretType { get => ValidateSecretInputBody.SecretType; set => ValidateSecretInputBody.SecretType = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SecretVersion { get => ValidateSecretInputBody.SecretVersion ?? null; set => ValidateSecretInputBody.SecretVersion = value; }
        ...
        /// <summary>Backing field for <see cref="ValidateSecretInputBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IValidateSecretInput _validateSecretInputBody= new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ValidateSecretInput();

        /// <summary>Input of the secret to be validated.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IValidateSecretInput ValidateSecretInputBody { get => this._validateSecretInputBody; set => this._validateSecretInputBody = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzCdnSecretValidate_SecretExpanded" /> cmdlet class.
        /// </summary>
        public InvokeAzCdnSecretValidate_SecretExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ValidateSecret(SubscriptionId, ValidateSecretInputBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,body=ValidateSecretInputBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IAfdErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, body=ValidateSecretInputBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, body=ValidateSecretInputBody })
                    {
