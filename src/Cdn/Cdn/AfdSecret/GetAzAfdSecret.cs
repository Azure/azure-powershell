...
{
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "AfdSecret", DefaultParameterSetName = FieldsParameterSet), OutputType(typeof(PSAfdSecret))]
    public class GetAzAfdSecret : AzureCdnCmdletBase
    {
