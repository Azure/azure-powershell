...
namespace Microsoft.Azure.Commands.Cdn.WebApplicationFirewall
{
    ...
    /// </summary>
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CdnWafCustomRule", SupportsShouldProcess = false), OutputType(typeof(PSCustomRule))]
    public class NewAzCdnWafCustomRule : AzureCdnCmdletBase
    {
        /// <summary>
        ...
        [Parameter(Mandatory = false, HelpMessage = "Disables the custom rule.")]
        public SwitchParameter Disabled { get; set; }

        [Parameter(Mandatory = true, HelpMessage = "The priority of the custom rule.")]
