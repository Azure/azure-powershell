...
{
    [Cmdlet("Set", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "AfdOrigin", DefaultParameterSetName = FieldsParameterSet, SupportsShouldProcess = true), OutputType(typeof(PSAfdOrigin))]
    public class SetAzAfdOrigin : AzureCdnCmdletBase
    {
