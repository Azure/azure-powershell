...
{
    [Cmdlet("Set", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "AfdOriginGroup", DefaultParameterSetName = FieldsParameterSet, SupportsShouldProcess = true), OutputType(typeof(PSAfdOriginGroup))]
    public class SetAzAfdOriginGroup : AzureCdnCmdletBase
    {
        ...
        private LoadBalancingSettingsParameters CreateLoadBalancingSettingsByFields(PSAfdOriginGroup currentPsAfdOriginGroup, bool isSampleSize, bool isSuccessfulSampleRequired, bool isAdditionalLatencyInMilliseconds)
        {
            ...
            {
                loadBalancingSettings.AdditionalLatencyInMilliseconds = this.AdditionalLatencyInMilliseconds;
            }
