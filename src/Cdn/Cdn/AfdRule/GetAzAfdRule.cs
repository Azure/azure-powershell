...
{
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "AfdRule", DefaultParameterSetName = FieldsParameterSet), OutputType(typeof(PSAfdRule))]
    public class GetAzAfdRule : AzureCdnCmdletBase
    {
