...
{
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "FrontDoorCdnRuleCacheExpirationAction", DefaultParameterSetName = AfdParameterSet.AfdRuleBypassCache), OutputType(typeof(PSAfdRuleCacheExpirationAction))]
    public class NewAzFrontDoorCdnRuleCacheExpirationAction : AzureCdnCmdletBase
    {
