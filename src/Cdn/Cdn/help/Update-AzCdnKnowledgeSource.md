...
```
Update-AzCdnKnowledgeSource -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -WebAgentName <String> [-Description <String>] [-UpdateFrequency <String>] [-Url <String>]
...
```
Update-AzCdnKnowledgeSource -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -WebAgentName <String> -JsonString <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```
Update-AzCdnKnowledgeSource -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -WebAgentName <String> -JsonFilePath <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Update-AzCdnKnowledgeSource -Name <String> -WebAgentInputObject <ICdnIdentity> [-Description <String>]
 [-UpdateFrequency <String>] [-Url <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Update-AzCdnKnowledgeSource -InputObject <ICdnIdentity> [-Description <String>] [-UpdateFrequency <String>]
 [-Url <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf]
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityWebAgentExpanded, UpdateViaIdentityExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaJsonString, UpdateViaJsonFilePath, UpdateViaIdentityWebAgentExpanded, UpdateViaIdentityWebAgent
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnIdentity
Parameter Sets: UpdateViaIdentityWebAgentExpanded, UpdateViaIdentityWebAgent
Aliases:
