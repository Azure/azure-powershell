...
```
New-AzCdnEdgeAction -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### CreateViaJsonString
```
New-AzCdnEdgeAction -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] -JsonString <String>
