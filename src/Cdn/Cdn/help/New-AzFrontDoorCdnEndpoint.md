...
New-AzFrontDoorCdnEndpoint -EndpointName <String> -ProfileName <String> -ResourceGroupName <String>
 ...
 [-EnabledState <String>] [-EnforceMtl <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob]
...
New-AzFrontDoorCdnEndpoint -EndpointName <String> -ProfileInputObject <ICdnIdentity> -Location <String>
 [-AutoGeneratedDomainNameLabelScope <String>] [-EnabledState <String>] [-EnforceMtl <String>]
