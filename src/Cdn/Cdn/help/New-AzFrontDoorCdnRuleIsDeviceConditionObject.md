...
Module Name: Az.Cdn
online version: https://learn.microsoft.com/powershell/module/Az.Cdn/new-azfrontdoorcdnruleisdeviceconditionobject
schema: 2.0.0
---
...
```
New-AzFrontDoorCdnRuleIsDeviceConditionObject -ParameterTypeName <String> [-ParameterMatchValue <String[]>]
