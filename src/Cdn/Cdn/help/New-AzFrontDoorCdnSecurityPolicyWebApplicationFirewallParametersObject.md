...
New-AzFrontDoorCdnSecurityPolicyWebApplicationFirewallParametersObject
 ...
 [-WafPolicyId <String>] [-Type <String>] [-WafPolicy <Object>] [-EmbeddedWafPolicySkuName <String>]
 [-EmbeddedWafPolicySetting <Object>] [-EmbeddedWafPolicySettingEnabledState <String>]
 ...
 [-EmbeddedWafPolicySettingRequestBodyCheck <String>]
 [-EmbeddedWafPolicySettingJavascriptChallengeExpirationInMinutes <Int32>]
 [-EmbeddedWafPolicySettingCaptchaExpirationInMinutes <Int32>] [-EmbeddedWafLogScrubbing <Object>]
 [-EmbeddedWafLogScrubbingState <String>] [-EmbeddedWafLogScrubbingRule <Object[]>]
 [-EmbeddedWafCustomRule <Object[]>] [-EmbeddedWafCustomRuleName <String>]
 [-EmbeddedWafCustomRulePriority <Int32>] [-EmbeddedWafCustomRuleEnabledState <String>]
 [-EmbeddedWafCustomRuleType <String>] [-EmbeddedWafCustomRuleRateLimitDurationInMinutes <Int32>]
 [-EmbeddedWafCustomRuleRateLimitThreshold <Int32>] [-EmbeddedWafCustomRuleGroupBy <Object[]>]
 [-EmbeddedWafCustomRuleMatchCondition <Object[]>] [-EmbeddedWafCustomRuleAction <String>]
 [-EmbeddedWafMatchVariable <String>] [-EmbeddedWafMatchSelector <String>] [-EmbeddedWafMatchOperator <String>]
 [-EmbeddedWafNegateCondition <Boolean>] [-EmbeddedWafMatchValue <String[]>] [-EmbeddedWafTransform <String[]>]
 [-EmbeddedWafManagedRuleSet <Object[]>] [-EmbeddedWafManagedRuleSetType <String>]
 [-EmbeddedWafManagedRuleSetVersion <String>] [-EmbeddedWafManagedRuleSetAction <String>]
 [-EmbeddedWafManagedRuleExclusion <Object[]>] [-EmbeddedWafManagedRuleGroupOverride <Object[]>]
 [-EmbeddedWafManagedRuleGroupName <String>] [-EmbeddedWafManagedRuleOverride <Object[]>]
 [-EmbeddedWafManagedRuleId <String>] [-EmbeddedWafManagedRuleEnabledState <String>]
 [-EmbeddedWafManagedRuleAction <String>] [-EmbeddedWafExclusionSelectorMatchOperator <String>]
 [-EmbeddedWafExclusionSelector <String>] [<CommonParameters>]
```
