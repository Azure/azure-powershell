...
Module Name: Az.Cdn
online version: https://learn.microsoft.com/powershell/module/az.cdn/get-azcdndeploymentversion
schema: 2.0.0
---

# Get-AzCdnDeploymentVersion
...
### List (Default)
```
Get-AzCdnDeploymentVersion -ProfileName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
...
```
Get-AzCdnDeploymentVersion -VersionName <String> -ProfileInputObject <ICdnIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzCdnDeploymentVersion -InputObject <ICdnIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
