...
```
New-AzAfdRoute -CustomDomainId <System.Collections.Generic.List`1[System.String]> -EndpointName <String>
 -OriginGroupId <String> -ProfileName <String> -ResourceGroupName <String> -RouteName <String>
