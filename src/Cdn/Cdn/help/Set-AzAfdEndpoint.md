...
```
Set-AzAfdEndpoint -EndpointName <String> [-OriginResponseTimeoutSeconds <Int32>] -ProfileName <String>
...
```
Set-AzAfdEndpoint -Endpoint <PSAfdEndpoint> [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
