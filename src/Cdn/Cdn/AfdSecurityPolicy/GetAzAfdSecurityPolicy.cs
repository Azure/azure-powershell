...
{
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "AfdSecurityPolicy", DefaultParameterSetName = FieldsParameterSet), OutputType(typeof(PSAfdSecurityPolicy))]
