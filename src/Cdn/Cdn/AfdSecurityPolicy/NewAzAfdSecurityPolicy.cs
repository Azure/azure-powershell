...
{
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "AfdSecurityPolicy", DefaultParameterSetName = FieldsParameterSet, SupportsShouldProcess = true), OutputType(typeof(PSAfdSecurityPolicy))]
    public class NewAzAfdSecurityPolicy : AzureCdnCmdletBase
    {
