...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.IDeepCreatedOrigin[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.IDeepCreatedOriginGroup[]
Parameter Sets: (All)
Aliases:
