...
external help file:
Module Name: Az.Cdn
online version: https://learn.microsoft.com/powershell/module/az.cdn/move-azcdnprofile
schema: 2.0.0
---
...
```
Move-AzCdnProfile -ResourceGroupName <String> -ProfileName <String> [-SubscriptionId <String>]
...
```
Move-AzCdnProfile -InputObject <ICdnIdentity> -ProfileName <String> [-ClassicResourceReferenceId <String>]
 [-MigrationWebApplicationFirewallMapping <IMigrationWebApplicationFirewallMapping[]>] [-SkuName <SkuName>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.IMigrationParameters
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.IMigrationWebApplicationFirewallMapping[]
Parameter Sets: MigrateExpanded, MigrateViaIdentityExpanded
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.IMigrationParameters

### Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnIdentity

## OUTPUTS

### Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.IMigrateResult
