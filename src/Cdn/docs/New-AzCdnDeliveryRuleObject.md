...
```
New-AzCdnDeliveryRuleObject -Action <IDeliveryRuleActionAutoGenerated[]> -Order <Int32>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IDeliveryRuleActionAutoGenerated[]
Parameter Sets: (All)
Aliases:
...
ACTION <IDeliveryRuleActionAutoGenerated[]>: A list of actions that are executed when all the conditions of a rule are satisfied.
