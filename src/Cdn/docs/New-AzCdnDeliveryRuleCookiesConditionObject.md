...
```
New-AzCdnDeliveryRuleCookiesConditionObject -ParameterOperator <String> [-ParameterMatchValue <String[]>]
 [-ParameterNegateCondition <Boolean>] [-ParameterSelector <String>] [-ParameterTransform <String[]>]
 [<CommonParameters>]
```
