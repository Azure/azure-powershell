...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.SecurityPolicyWebApplicationFirewallParameters
.Link
...
function New-AzFrontDoorCdnSecurityPolicyWebApplicationFirewallParametersObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.SecurityPolicyWebApplicationFirewallParameters')]
    [CmdletBinding(PositionalBinding=$false)]
    Param(

        [Parameter(HelpMessage="Waf associations.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.ISecurityPolicyWebApplicationFirewallAssociation[]]
        $Association,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.SecurityPolicyWebApplicationFirewallParameters]::New()
