...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.SecurityPolicyWebApplicationFirewallParameters
.Link
...
function New-AzFrontDoorCdnSecurityPolicyWebApplicationFirewallParametersObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.SecurityPolicyWebApplicationFirewallParameters')]
    [CmdletBinding(PositionalBinding=$false)]
    Param(

        [Parameter(HelpMessage="Waf associations.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.ISecurityPolicyWebApplicationFirewallAssociation[]]
        $Association,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.SecurityPolicyWebApplicationFirewallParameters]::New()
