...
function New-AzFrontDoorCdnRuleUrlRewriteActionObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.UrlRewriteAction')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.UrlRewriteAction]::New()
