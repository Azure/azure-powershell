...
function New-AzFrontDoorCdnRuleRequestMethodConditionObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.DeliveryRuleRequestMethodCondition')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.DeliveryRuleRequestMethodCondition]::New()
