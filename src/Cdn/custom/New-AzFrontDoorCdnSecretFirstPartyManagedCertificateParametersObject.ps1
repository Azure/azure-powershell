...
function New-AzFrontDoorCdnSecretFirstPartyManagedCertificateParametersObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.AzureFirstPartyManagedCertificateParameters')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.AzureFirstPartyManagedCertificateParameters]::New()
