...
function New-AzFrontDoorCdnSecretFirstPartyManagedCertificateParametersObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.AzureFirstPartyManagedCertificateParameters')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.AzureFirstPartyManagedCertificateParameters]::New()
