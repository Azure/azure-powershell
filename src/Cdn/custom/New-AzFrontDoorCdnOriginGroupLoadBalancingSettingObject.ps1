...
function New-AzFrontDoorCdnOriginGroupLoadBalancingSettingObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.LoadBalancingSettingsParameters')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.LoadBalancingSettingsParameters]::New()
