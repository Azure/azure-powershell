...
function New-AzFrontDoorCdnOriginGroupLoadBalancingSettingObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.LoadBalancingSettingsParameters')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.LoadBalancingSettingsParameters]::New()
