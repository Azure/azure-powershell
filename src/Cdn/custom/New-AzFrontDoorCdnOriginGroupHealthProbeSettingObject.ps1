...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.HealthProbeParameters
.Link
...
function New-AzFrontDoorCdnOriginGroupHealthProbeSettingObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.HealthProbeParameters')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.HealthProbeParameters]::New()
