...
function New-AzFrontDoorCdnRuleQueryStringConditionObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.DeliveryRuleQueryStringCondition')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.DeliveryRuleQueryStringCondition]::New()
