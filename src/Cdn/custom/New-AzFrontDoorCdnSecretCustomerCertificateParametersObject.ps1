...
function New-AzFrontDoorCdnSecretCustomerCertificateParametersObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.CustomerCertificateParameters')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.CustomerCertificateParameters]::New()
