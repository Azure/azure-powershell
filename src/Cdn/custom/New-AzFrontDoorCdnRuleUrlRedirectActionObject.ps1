...
function New-AzFrontDoorCdnRuleUrlRedirectActionObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.UrlRedirectAction')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.UrlRedirectAction]::New()
