...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.UrlSigningAction
.Link
...
function New-AzFrontDoorCdnRuleUrlSigningActionObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.UrlSigningAction')]
    ...
    Param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.IUrlSigningParamIdentifier[]]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.UrlSigningAction]::New()
