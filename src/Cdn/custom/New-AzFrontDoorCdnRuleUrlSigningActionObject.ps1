...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.UrlSigningAction
.Link
...
function New-AzFrontDoorCdnRuleUrlSigningActionObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.UrlSigningAction')]
    ...
    Param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.IUrlSigningParamIdentifier[]]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.UrlSigningAction]::New()
