...
function New-AzFrontDoorCdnRuleRequestHeaderActionObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.DeliveryRuleRequestHeaderAction')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.DeliveryRuleRequestHeaderAction]::New()
