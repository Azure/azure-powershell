...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.UrlSigningKeyParameters
.Link
...
function New-AzFrontDoorCdnSecretUrlSigningKeyParametersObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.UrlSigningKeyParameters')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.UrlSigningKeyParameters]::New()
