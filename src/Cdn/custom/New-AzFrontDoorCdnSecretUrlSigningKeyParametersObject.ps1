...
function New-AzFrontDoorCdnSecretUrlSigningKeyParametersObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.UrlSigningKeyParameters')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.UrlSigningKeyParameters]::New()
