...
function New-AzFrontDoorCdnRuleRouteConfigurationOverrideActionObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.DeliveryRuleRouteConfigurationOverrideAction')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.DeliveryRuleRouteConfigurationOverrideAction]::New()
