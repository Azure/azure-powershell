...
function New-AzFrontDoorCdnRuleRouteConfigurationOverrideActionObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.DeliveryRuleRouteConfigurationOverrideAction')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.DeliveryRuleRouteConfigurationOverrideAction]::New()
