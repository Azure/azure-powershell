...
function New-AzFrontDoorCdnRuleUrlFileExtensionConditionObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.DeliveryRuleUrlFileExtensionCondition')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20220501Preview.DeliveryRuleUrlFileExtensionCondition]::New()
