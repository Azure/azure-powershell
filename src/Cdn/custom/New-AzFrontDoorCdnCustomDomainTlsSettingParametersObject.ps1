...
function New-AzFrontDoorCdnCustomDomainTlsSettingParametersObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.AFDDomainHttpsParameters')]
    ...
    Param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.IResourceReference]
        $Secret
    )

    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.AFDDomainHttpsParameters]::New()
