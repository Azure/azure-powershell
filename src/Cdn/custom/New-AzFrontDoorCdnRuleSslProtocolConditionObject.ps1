...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.DeliveryRuleSslProtocolCondition
.Link
...
function New-AzFrontDoorCdnRuleSslProtocolConditionObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.DeliveryRuleSslProtocolCondition')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230201Preview.DeliveryRuleSslProtocolCondition]::New()
