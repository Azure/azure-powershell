...
Describe 'Test-AzCdnEndpointCustomDomain'  {
    It 'ValidateExpanded' {
        ...
        $endpointName = 'ps-20240501-domain050'
        $customDomainHostName = 'ps-20240501-domain050.ps.cdne2e.azfdtest.xyz'
        $customDomainInvalidHostName = 'ps-20240501-domain050e.ps.cdne2e.azfdtest.xyz'
        $origin = @{
            Name = "origin1"
    ...
    It 'ValidateViaIdentityExpanded' {  
        # Hard-coding host and endpoint names due to requirement for DNS CNAME
        $endpointName = 'ps-20240501-domain051'
        $customDomainHostName = 'ps-20240501-domain051.ps.cdne2e.azfdtest.xyz'
        $customDomainInvalidHostName = 'ps-20240501-domain051e.ps.cdne2e.azfdtest.xyz'
        $origin = @{
            Name = "origin1"
            HostName = "host1.hello.com"
        };
