if(($null -eq $TestName) -or ($TestName -contains 'Remove-AzCdnEdgeActionAttachment'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Remove-AzCdnEdgeActionAttachment.Recording.json'
...
Describe 'Remove-AzCdnEdgeActionAttachment' {
    ...
    It 'Delete' {
        $script:EdgeActionName = "eaaremove"
