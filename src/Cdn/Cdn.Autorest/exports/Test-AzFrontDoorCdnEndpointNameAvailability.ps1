...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICheckEndpointNameAvailabilityOutput
.Link
...
begin {
    try {
        ...
        $mapping = @{
            CheckExpanded = 'Az.Cdn.private\Test-AzFrontDoorCdnEndpointNameAvailability_CheckExpanded';
        }
