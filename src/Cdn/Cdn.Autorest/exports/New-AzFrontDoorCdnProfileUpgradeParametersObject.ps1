...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ProfileUpgradeParameters])]
...
begin {
    try {
        ...
        $mapping = @{
            __AllParameterSets = 'Az.Cdn.custom\New-AzFrontDoorCdnProfileUpgradeParametersObject';
        }
