...
```
Update-AzCdnDeploymentVersion -ProfileName <String> -ResourceGroupName <String> -VersionName <String>
...
```
Update-AzCdnDeploymentVersion -ProfileInputObject <ICdnIdentity> -VersionName <String>
 -DeploymentVersionUpdateProperty <IDeploymentVersionUpdate> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityProfileExpanded
```
Update-AzCdnDeploymentVersion -ProfileInputObject <ICdnIdentity> -VersionName <String> [-Description <String>]
