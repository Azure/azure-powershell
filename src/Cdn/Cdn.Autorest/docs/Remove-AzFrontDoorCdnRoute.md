...
```
Remove-AzFrontDoorCdnRoute -AfdEndpointInputObject <ICdnIdentity> -Name <String> [-DefaultProfile <PSObject>]
...
```yaml
Type: System.String
Parameter Sets: Delete, DeleteViaIdentityAfdEndpoint, DeleteViaIdentityProfile
Aliases: RouteName
