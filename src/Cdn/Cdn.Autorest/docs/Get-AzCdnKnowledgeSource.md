...
### List (Default)
```
Get-AzCdnKnowledgeSource -ResourceGroupName <String> -WebAgentName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzCdnKnowledgeSource -Name <String> -ResourceGroupName <String> -WebAgentName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzCdnKnowledgeSource -InputObject <ICdnIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Get, GetViaIdentityWebAgent
