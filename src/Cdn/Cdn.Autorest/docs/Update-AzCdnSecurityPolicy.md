...
external help file:
Module Name: Az.Cdn
online version: https://docs.microsoft.com/powershell/module/az.cdn/update-azcdnsecuritypolicy
schema: 2.0.0
---

# Update-AzCdnSecurityPolicy
...
```
Update-AzCdnSecurityPolicy -Name <String> -ProfileName <String> -ResourceGroupName <String>
...
### PatchViaIdentity
```
Update-AzCdnSecurityPolicy -InputObject <ICdnIdentity>
...
```
Update-AzCdnSecurityPolicy -InputObject <ICdnIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
