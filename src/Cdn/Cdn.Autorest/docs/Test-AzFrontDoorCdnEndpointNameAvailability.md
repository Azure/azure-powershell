...
```
Test-AzFrontDoorCdnEndpointNameAvailability -ResourceGroupName <String> -Name <String> -Type <String>
 [-SubscriptionId <String>] [-AutoGeneratedDomainNameLabelScope <String>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaJsonFilePath
```
Test-AzFrontDoorCdnEndpointNameAvailability -ResourceGroupName <String> -JsonFilePath <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaJsonString
```
Test-AzFrontDoorCdnEndpointNameAvailability -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
