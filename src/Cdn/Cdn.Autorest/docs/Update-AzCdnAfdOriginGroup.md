...
external help file:
Module Name: Az.Cdn
online version: https://docs.microsoft.com/powershell/module/az.cdn/update-azcdnafdorigingroup
schema: 2.0.0
---

# Update-AzCdnAfdOriginGroup
...
```
Update-AzCdnAfdOriginGroup -OriginGroupName <String> -ProfileName <String> -ResourceGroupName <String>
...
```
Update-AzCdnAfdOriginGroup -InputObject <ICdnIdentity> [-HealthProbeSettingProbeIntervalInSecond <Int32>]
 [-HealthProbeSettingProbePath <String>] [-HealthProbeSettingProbeProtocol <ProbeProtocol>]
 [-HealthProbeSettingProbeRequestType <HealthProbeRequestType>]
 [-LoadBalancingSettingAdditionalLatencyInMillisecond <Int32>] [-LoadBalancingSettingSampleSize <Int32>]
 [-LoadBalancingSettingSuccessfulSamplesRequired <Int32>]
