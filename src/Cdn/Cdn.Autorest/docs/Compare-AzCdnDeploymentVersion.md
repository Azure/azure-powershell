...
```
Compare-AzCdnDeploymentVersion -ProfileName <String> -ResourceGroupName <String> -VersionName <String>
 -CompareTo <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Compare-AzCdnDeploymentVersion -ProfileName <String> -ResourceGroupName <String> -VersionName <String>
 -CompareDeploymentVersionsParameter <ICompareDeploymentVersionsParameter> [-SubscriptionId <String>]
...
```
Compare-AzCdnDeploymentVersion -ProfileInputObject <ICdnIdentity> -VersionName <String>
 -CompareDeploymentVersionsParameter <ICompareDeploymentVersionsParameter> [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Compare-AzCdnDeploymentVersion -ProfileInputObject <ICdnIdentity> -VersionName <String> -CompareTo <String>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Parameter Sets: Compare, CompareViaIdentity, CompareViaIdentityProfile
Aliases:
...
```yaml
Type: System.String
Parameter Sets: CompareExpanded, CompareViaIdentityExpanded, CompareViaIdentityProfileExpanded
Aliases:
...
Parameter Sets: CompareViaIdentity, CompareViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnIdentity
Parameter Sets: CompareViaIdentityProfile, CompareViaIdentityProfileExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Compare, CompareExpanded, CompareViaJsonFilePath, CompareViaJsonString
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Compare, CompareExpanded, CompareViaIdentityProfile, CompareViaIdentityProfileExpanded, CompareViaJsonFilePath, CompareViaJsonString
Aliases:
