...
external help file:
Module Name: Az.Cdn
online version: https://docs.microsoft.com/powershell/module/az.cdn/update-azcdnprofile
schema: 2.0.0
---
...
```
Update-AzCdnProfile -InputObject <ICdnIdentity> [-IdentityType <ManagedServiceIdentityType>]
