...
external help file:
Module Name: Az.Cdn
online version: https://docs.microsoft.com/powershell/module/az.cdn/test-azcdnafdendpointcustomdomain
schema: 2.0.0
---

# Test-AzCdnAfdEndpointCustomDomain
...
```
Test-AzCdnAfdEndpointCustomDomain -EndpointName <String> -ProfileName <String> -ResourceGroupName <String>
...
### ValidateViaIdentity
```
Test-AzCdnAfdEndpointCustomDomain -InputObject <ICdnIdentity>
...
```
Test-AzCdnAfdEndpointCustomDomain -InputObject <ICdnIdentity> -HostName <String> [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
