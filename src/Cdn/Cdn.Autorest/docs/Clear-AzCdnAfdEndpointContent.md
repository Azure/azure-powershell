...
external help file:
Module Name: Az.Cdn
online version: https://docs.microsoft.com/powershell/module/az.cdn/clear-azcdnafdendpointcontent
schema: 2.0.0
---

# Clear-AzCdnAfdEndpointContent
...
```
Clear-AzCdnAfdEndpointContent -EndpointName <String> -ProfileName <String> -ResourceGroupName <String>
...
### PurgeViaIdentity
```
Clear-AzCdnAfdEndpointContent -InputObject <ICdnIdentity> -Content <IAfdPurgeParameters>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PurgeViaIdentityExpanded
```
Clear-AzCdnAfdEndpointContent -InputObject <ICdnIdentity> -ContentPath <String[]> [-Domain <String[]>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
