...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.IHealthProbeParameters
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.IResponseBasedOriginErrorDetectionParameters
Parameter Sets: (All)
Aliases:
