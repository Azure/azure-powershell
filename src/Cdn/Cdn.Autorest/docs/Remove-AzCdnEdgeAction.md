...
external help file:
Module Name: Az.Cdn
online version: https://learn.microsoft.com/powershell/module/az.cdn/remove-azcdnedgeaction
schema: 2.0.0
---
...
```
Remove-AzCdnEdgeAction -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
