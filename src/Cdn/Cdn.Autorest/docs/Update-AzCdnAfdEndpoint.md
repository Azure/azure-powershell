...
external help file:
Module Name: Az.Cdn
online version: https://docs.microsoft.com/powershell/module/az.cdn/update-azcdnafdendpoint
schema: 2.0.0
---

# Update-AzCdnAfdEndpoint
...
```
Update-AzCdnAfdEndpoint -EndpointName <String> -ProfileName <String> -ResourceGroupName <String>
...
```
Update-AzCdnAfdEndpoint -InputObject <ICdnIdentity> [-EnabledState <EnabledState>] [-Tag <Hashtable>]
