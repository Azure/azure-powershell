...
```
New-AzCdnDeliveryRuleRequestMethodConditionObject -Name <MatchVariable>
 -ParameterTypeName <DeliveryRuleConditionParametersType> [-ParameterMatchValue <RequestMethodMatchValue[]>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.RequestMethodMatchValue[]
Parameter Sets: (All)
Aliases:
