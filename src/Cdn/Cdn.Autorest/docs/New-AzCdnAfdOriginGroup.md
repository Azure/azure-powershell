...
external help file:
Module Name: Az.Cdn
online version: https://docs.microsoft.com/powershell/module/az.cdn/new-azcdnafdorigingroup
schema: 2.0.0
---

# New-AzCdnAfdOriginGroup
...
```
New-AzCdnAfdOriginGroup -OriginGroupName <String> -ProfileName <String> -ResourceGroupName <String>
