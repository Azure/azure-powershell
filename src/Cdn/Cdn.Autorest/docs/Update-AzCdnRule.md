...
external help file:
Module Name: Az.Cdn
online version: https://docs.microsoft.com/powershell/module/az.cdn/update-azcdnrule
schema: 2.0.0
---
...
```
Update-AzCdnRule -Name <String> -ProfileName <String> -ResourceGroupName <String> -SetName <String>
...
```
Update-AzCdnRule -InputObject <ICdnIdentity> [-Action <IDeliveryRuleAction1[]>]
