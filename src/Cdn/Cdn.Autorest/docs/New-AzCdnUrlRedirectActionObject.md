...
```
New-AzCdnUrlRedirectActionObject -Name <DeliveryRuleActionName> -ParameterRedirectType <RedirectType>
 -ParameterTypeName <DeliveryRuleActionParametersType> [-ParameterCustomFragment <String>]
 [-ParameterCustomHostname <String>] [-ParameterCustomPath <String>] [-ParameterCustomQueryString <String>]
 [-ParameterDestinationProtocol <DestinationProtocol>] [<CommonParameters>]
```
