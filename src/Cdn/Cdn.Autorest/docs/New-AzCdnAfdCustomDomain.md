...
external help file:
Module Name: Az.Cdn
online version: https://docs.microsoft.com/powershell/module/az.cdn/new-azcdnafdcustomdomain
schema: 2.0.0
---

# New-AzCdnAfdCustomDomain
...
```
New-AzCdnAfdCustomDomain -CustomDomainName <String> -ProfileName <String> -ResourceGroupName <String>
