...
external help file:
Module Name: Az.Cdn
online version: https://docs.microsoft.com/powershell/module/az.cdn/new-azcdnafdendpoint
schema: 2.0.0
---

# New-AzCdnAfdEndpoint
...
```
New-AzCdnAfdEndpoint -EndpointName <String> -ProfileName <String> -ResourceGroupName <String>
