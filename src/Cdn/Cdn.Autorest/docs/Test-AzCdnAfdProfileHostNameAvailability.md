...
external help file:
Module Name: Az.Cdn
online version: https://docs.microsoft.com/powershell/module/az.cdn/test-azcdnafdprofilehostnameavailability
schema: 2.0.0
---

# Test-AzCdnAfdProfileHostNameAvailability
...
```
Test-AzCdnAfdProfileHostNameAvailability -ProfileName <String> -ResourceGroupName <String> -HostName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Check
```
Test-AzCdnAfdProfileHostNameAvailability -ProfileName <String> -ResourceGroupName <String>
...
### CheckViaIdentity
```
Test-AzCdnAfdProfileHostNameAvailability -InputObject <ICdnIdentity>
...
```
Test-AzCdnAfdProfileHostNameAvailability -InputObject <ICdnIdentity> -HostName <String>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
