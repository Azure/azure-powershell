...
```
Remove-AzFrontDoorCdnRule -Name <String> -ProfileInputObject <ICdnIdentity> -SetName <String>
...
```yaml
Type: System.String
Parameter Sets: Delete, DeleteViaIdentityProfile, DeleteViaIdentityRuleSet
Aliases: RuleName
