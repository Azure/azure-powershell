...
```
Remove-AzFrontDoorCdnOrigin -OriginGroupInputObject <ICdnIdentity> -OriginName <String>
...
```yaml
Type: System.String
Parameter Sets: Delete, DeleteViaIdentityOriginGroup, DeleteViaIdentityProfile
Aliases:
