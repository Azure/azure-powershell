...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IKeyGroup])]
...
param(
    ...
    # To construct, see NOTES section for KEYREFERENCE properties and create a hash table.
    ${KeyReference},
