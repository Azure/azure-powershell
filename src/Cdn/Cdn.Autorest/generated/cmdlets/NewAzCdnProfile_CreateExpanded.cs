...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        public string Location { get => ProfileBody.Location ?? null; set => ProfileBody.Location = value; }
        ...
        public int OriginResponseTimeoutSecond { get => ProfileBody.OriginResponseTimeoutSecond ?? default(int); set => ProfileBody.OriginResponseTimeoutSecond = value; }
        ...
        /// <summary>Backing field for <see cref="ProfileBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IProfile _profileBody= new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.Profile();

        /// <summary>A profile is a logical grouping of endpoints that share the same settings.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IProfile ProfileBody { get => this._profileBody; set => this._profileBody = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.SkuName SkuName { get => ProfileBody.SkuName ?? ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.SkuName)""); set => ProfileBody.SkuName = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ITrackedResourceTags Tag { get => ProfileBody.Tag ?? null /* object */; set => ProfileBody.Tag = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.NewAzCdnProfile_CreateExpanded Clone()
        {
            ...
            clone.ProfileBody = this.ProfileBody;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzCdnProfile_CreateExpanded" /> cmdlet class.
        /// </summary>
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ProfilesCreate(ResourceGroupName, Name, SubscriptionId, ProfileBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,SubscriptionId=SubscriptionId,body=ProfileBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, Name=Name, SubscriptionId=SubscriptionId, body=ProfileBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, Name=Name, SubscriptionId=SubscriptionId, body=ProfileBody })
                    {
