...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="EnableAzCdnCustomDomainCustomHttps_EnableViaIdentity" /> cmdlet class.
        /// </summary>
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.CustomDomainsEnableCustomHttpsViaIdentity(InputObject.Id, CustomDomainHttpsParameter, onOk, onAccepted, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.CustomDomainsEnableCustomHttps(InputObject.ResourceGroupName ?? null, InputObject.ProfileName ?? null, InputObject.EndpointName ?? null, InputObject.CustomDomainName ?? null, InputObject.SubscriptionId ?? null, CustomDomainHttpsParameter, onOk, onAccepted, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=CustomDomainHttpsParameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=CustomDomainHttpsParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=CustomDomainHttpsParameter })
                    {
