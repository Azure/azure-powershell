...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Import, @"AzCdnEndpointContent_LoadViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/endpoints/{endpointName}/load", ApiVersion = "2024-05-01-preview")]
    public partial class ImportAzCdnEndpointContent_LoadViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ContentFilePath" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ILoadParameters _contentFilePath;

        /// <summary>Parameters required for content load.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters required for content load.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Parameters required for content load.",
        SerializedName = @"contentFilePaths",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ILoadParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ILoadParameters ContentFilePath { get => this._contentFilePath; set => this._contentFilePath = value; }
        ...
        /// <returns>a duplicate instance of ImportAzCdnEndpointContent_LoadViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.ImportAzCdnEndpointContent_LoadViaIdentity Clone()
        {
            var clone = new ImportAzCdnEndpointContent_LoadViaIdentity();
            ...
            clone.ContentFilePath = this.ContentFilePath;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ImportAzCdnEndpointContent_LoadViaIdentity" /> cmdlet class.
        /// </summary>
        public ImportAzCdnEndpointContent_LoadViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'EndpointsLoadContent' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.EndpointsLoadContentViaIdentity(InputObject.Id, ContentFilePath, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.EndpointsLoadContent(InputObject.ResourceGroupName ?? null, InputObject.ProfileName ?? null, InputObject.EndpointName ?? null, InputObject.SubscriptionId ?? null, ContentFilePath, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ContentFilePath})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IErrorResponseAutoGenerated> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ContentFilePath })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ContentFilePath })
                    {
