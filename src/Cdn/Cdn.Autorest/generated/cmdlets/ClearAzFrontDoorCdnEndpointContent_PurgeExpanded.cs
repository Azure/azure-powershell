...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        public string[] ContentPath { get => ContentsBody.ContentPath ?? null /* arrayOf */; set => ContentsBody.ContentPath = value; }

        /// <summary>Backing field for <see cref="ContentsBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IAfdPurgeParameters _contentsBody= new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.AfdPurgeParameters();

        /// <summary>Parameters required for content purge.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IAfdPurgeParameters ContentsBody { get => this._contentsBody; set => this._contentsBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] Domain { get => ContentsBody.Domain ?? null /* arrayOf */; set => ContentsBody.Domain = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.ClearAzFrontDoorCdnEndpointContent_PurgeExpanded Clone()
        {
            ...
            clone.ContentsBody = this.ContentsBody;
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AfdEndpointsPurgeContent(ResourceGroupName, ProfileName, EndpointName, SubscriptionId, ContentsBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,ProfileName=ProfileName,EndpointName=EndpointName,SubscriptionId=SubscriptionId,body=ContentsBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IAfdErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, EndpointName=EndpointName, SubscriptionId=SubscriptionId, body=ContentsBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, EndpointName=EndpointName, SubscriptionId=SubscriptionId, body=ContentsBody })
                    {
