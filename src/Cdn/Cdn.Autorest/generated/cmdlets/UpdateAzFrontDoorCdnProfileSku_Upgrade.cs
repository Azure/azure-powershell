...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzFrontDoorCdnProfileSku_Upgrade", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/upgrade", ApiVersion = "2024-05-01-preview")]
    public partial class UpdateAzFrontDoorCdnProfileSku_Upgrade : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ProfileUpgradeParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IProfileUpgradeParameters _profileUpgradeParameter;

        /// <summary>Parameters required for profile upgrade.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters required for profile upgrade.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Parameters required for profile upgrade.",
        SerializedName = @"profileUpgradeParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IProfileUpgradeParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IProfileUpgradeParameters ProfileUpgradeParameter { get => this._profileUpgradeParameter; set => this._profileUpgradeParameter = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzFrontDoorCdnProfileSku_Upgrade</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.UpdateAzFrontDoorCdnProfileSku_Upgrade Clone()
        {
            var clone = new UpdateAzFrontDoorCdnProfileSku_Upgrade();
            ...
            clone.ProfileUpgradeParameter = this.ProfileUpgradeParameter;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'AfdProfileSkuUpgrade' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AfdProfileSkuUpgrade(ResourceGroupName, ProfileName, SubscriptionId, ProfileUpgradeParameter, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,ProfileName=ProfileName,SubscriptionId=SubscriptionId,body=ProfileUpgradeParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzFrontDoorCdnProfileSku_Upgrade" /> cmdlet class.
        /// </summary>
        public UpdateAzFrontDoorCdnProfileSku_Upgrade()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IAfdErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, SubscriptionId=SubscriptionId, body=ProfileUpgradeParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, SubscriptionId=SubscriptionId, body=ProfileUpgradeParameter })
                    {
