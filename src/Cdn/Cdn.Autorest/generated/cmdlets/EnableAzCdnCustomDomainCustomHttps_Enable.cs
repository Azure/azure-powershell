...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] EnableCustomHttps=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/endpoints/{endpointName}/customDomains/{customDomainName}/enableCustomHttps"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Enable, @"AzCdnCustomDomainCustomHttps_Enable", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICustomDomain))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Description(@"Enable https delivery of the custom domain.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/endpoints/{endpointName}/customDomains/{customDomainName}/enableCustomHttps", ApiVersion = "2024-05-01-preview")]
    public partial class EnableAzCdnCustomDomainCustomHttps_Enable : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="CustomDomainHttpsParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICustomDomainHttpsParameters _customDomainHttpsParameter;

        /// <summary>The JSON object that contains the properties to secure a custom domain.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The JSON object that contains the properties to secure a custom domain.", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICustomDomainHttpsParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICustomDomainHttpsParameters CustomDomainHttpsParameter { get => this._customDomainHttpsParameter; set => this._customDomainHttpsParameter = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of the custom domain within an endpoint.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICustomDomain">Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICustomDomain</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICustomDomain> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of EnableAzCdnCustomDomainCustomHttps_Enable</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.EnableAzCdnCustomDomainCustomHttps_Enable Clone()
        {
            var clone = new EnableAzCdnCustomDomainCustomHttps_Enable();
            ...
            clone.CustomDomainHttpsParameter = this.CustomDomainHttpsParameter;
            return clone;
        }

        /// <summary>
        /// Intializes a new instance of the <see cref="EnableAzCdnCustomDomainCustomHttps_Enable" /> cmdlet class.
        /// </summary>
        public EnableAzCdnCustomDomainCustomHttps_Enable()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CustomDomainsEnableCustomHttps' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CustomDomainsEnableCustomHttps(ResourceGroupName, ProfileName, EndpointName, CustomDomainName, SubscriptionId, CustomDomainHttpsParameter, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,ProfileName=ProfileName,EndpointName=EndpointName,CustomDomainName=CustomDomainName,SubscriptionId=SubscriptionId,body=CustomDomainHttpsParameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IErrorResponseAutoGenerated> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, EndpointName=EndpointName, CustomDomainName=CustomDomainName, SubscriptionId=SubscriptionId, body=CustomDomainHttpsParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, EndpointName=EndpointName, CustomDomainName=CustomDomainName, SubscriptionId=SubscriptionId, body=CustomDomainHttpsParameter })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICustomDomain> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICustomDomain
