...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.IdentityType Application = @"application";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.IdentityType Key = @"key";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.IdentityType ManagedIdentity = @"managedIdentity";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.IdentityType User = @"user";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.IdentityType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.IdentityType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.IdentityType e1, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.IdentityType e2)
        {
            return !e2.Equals(e1);
        }
