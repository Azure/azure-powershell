...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.EndpointProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.EndpointProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.EndpointProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.EndpointProvisioningState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.EndpointProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.EndpointProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.EndpointProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.EndpointProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.EndpointProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
