...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501
{
    ...
    public partial class ResourceUsage :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IResourceUsageInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IResourceUsageInternal.CurrentValue { get => this._currentValue; set { {_currentValue = value;} } }

        /// <summary>Internal Acessors for Limit</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IResourceUsageInternal.Limit { get => this._limit; set { {_limit = value;} } }

        /// <summary>Internal Acessors for ResourceType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IResourceUsageInternal.ResourceType { get => this._resourceType; set { {_resourceType = value;} } }

        /// <summary>Internal Acessors for Unit</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ResourceUsageUnit? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IResourceUsageInternal.Unit { get => this._unit; set { {_unit = value;} } }
