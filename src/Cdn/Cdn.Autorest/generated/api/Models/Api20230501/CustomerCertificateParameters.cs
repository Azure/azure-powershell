...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501
{
    ...
    public partial class CustomerCertificateParameters :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICustomerCertificateParameters,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICustomerCertificateParametersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICustomerCertificateParametersInternal.CertificateAuthority { get => this._certificateAuthority; set { {_certificateAuthority = value;} } }

        /// <summary>Internal Acessors for ExpirationDate</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICustomerCertificateParametersInternal.ExpirationDate { get => this._expirationDate; set { {_expirationDate = value;} } }

        /// <summary>Internal Acessors for SecretSource</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IResourceReference Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICustomerCertificateParametersInternal.SecretSource { get => (this._secretSource = this._secretSource ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ResourceReference()); set { {_secretSource = value;} } }

        /// <summary>Internal Acessors for Subject</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICustomerCertificateParametersInternal.Subject { get => this._subject; set { {_subject = value;} } }

        /// <summary>Internal Acessors for Thumbprint</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICustomerCertificateParametersInternal.Thumbprint { get => this._thumbprint; set { {_thumbprint = value;} } }
