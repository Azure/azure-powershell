...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501
{
    ...
    public partial class IPAddressGroup :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IIPAddressGroup,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IIPAddressGroupInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICidrIPAddress[] _ipv4Address;

        /// <summary>The list of ip v4 addresses.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICidrIPAddress[] Ipv4Address { get => this._ipv4Address; set => this._ipv4Address = value; }

        /// <summary>Backing field for <see cref="Ipv6Address" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICidrIPAddress[] _ipv6Address;

        /// <summary>The list of ip v6 addresses.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICidrIPAddress[] Ipv6Address { get => this._ipv6Address; set => this._ipv6Address = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICidrIPAddress) })]
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICidrIPAddress[] Ipv4Address { get; set; }
        /// <summary>The list of ip v6 addresses.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICidrIPAddress) })]
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICidrIPAddress[] Ipv6Address { get; set; }
