...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501
{
    ...
    public partial class AfdRouteCacheConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IAfdRouteCacheConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IAfdRouteCacheConfigurationInternal
    {

        /// <summary>Backing field for <see cref="CompressionSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICompressionSettings _compressionSetting;

        /// <summary>compression settings.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICompressionSettings CompressionSetting { get => (this._compressionSetting = this._compressionSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.CompressionSettings()); set => this._compressionSetting = value; }

        /// <summary>
        /// List of content types on which compression applies. The value should be a valid MIME type.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public string[] CompressionSettingContentTypesToCompress { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICompressionSettingsInternal)CompressionSetting).ContentTypesToCompress; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICompressionSettingsInternal)CompressionSetting).ContentTypesToCompress = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICompressionSettings Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IAfdRouteCacheConfigurationInternal.CompressionSetting { get => (this._compressionSetting = this._compressionSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.CompressionSettings()); set { {_compressionSetting = value;} } }
    ...
    {
        /// <summary>compression settings.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ICompressionSettings CompressionSetting { get; set; }
        /// <summary>
        /// List of content types on which compression applies. The value should be a valid MIME type.
        /// </summary>
        string[] CompressionSettingContentTypesToCompress { get; set; }
