...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501
{
    ...
    public partial class AzureFirstPartyManagedCertificateParameters :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IAzureFirstPartyManagedCertificateParameters,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IAzureFirstPartyManagedCertificateParametersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IAzureFirstPartyManagedCertificateParametersInternal.CertificateAuthority { get => this._certificateAuthority; set { {_certificateAuthority = value;} } }

        /// <summary>Internal Acessors for ExpirationDate</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IAzureFirstPartyManagedCertificateParametersInternal.ExpirationDate { get => this._expirationDate; set { {_expirationDate = value;} } }

        /// <summary>Internal Acessors for SecretSource</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IResourceReference Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IAzureFirstPartyManagedCertificateParametersInternal.SecretSource { get => (this._secretSource = this._secretSource ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ResourceReference()); set { {_secretSource = value;} } }

        /// <summary>Internal Acessors for Subject</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IAzureFirstPartyManagedCertificateParametersInternal.Subject { get => this._subject; set { {_subject = value;} } }

        /// <summary>Internal Acessors for Thumbprint</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IAzureFirstPartyManagedCertificateParametersInternal.Thumbprint { get => this._thumbprint; set { {_thumbprint = value;} } }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.IResourceReference SecretSource { get => (this._secretSource = this._secretSource ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20230501.ResourceReference()); }
