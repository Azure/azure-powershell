...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview
{
    ...
    public partial class ResourceUsage :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IResourceUsageInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IResourceUsageInternal.CurrentValue { get => this._currentValue; set { {_currentValue = value;} } }

        /// <summary>Internal Acessors for Limit</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IResourceUsageInternal.Limit { get => this._limit; set { {_limit = value;} } }

        /// <summary>Internal Acessors for ResourceType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IResourceUsageInternal.ResourceType { get => this._resourceType; set { {_resourceType = value;} } }

        /// <summary>Internal Acessors for Unit</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ResourceUsageUnit? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IResourceUsageInternal.Unit { get => this._unit; set { {_unit = value;} } }
