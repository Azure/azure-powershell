...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview
{
    ...
    public partial class AfdOriginGroupUpdatePropertiesParameters
    {
        ...
        internal AfdOriginGroupUpdatePropertiesParameters(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject json)
        {
            ...
            {_loadBalancingSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject>("loadBalancingSettings"), out var __jsonLoadBalancingSettings) ? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.LoadBalancingSettingsParameters.FromJson(__jsonLoadBalancingSettings) : LoadBalancingSetting;}
            {_healthProbeSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject>("healthProbeSettings"), out var __jsonHealthProbeSettings) ? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.HealthProbeParameters.FromJson(__jsonHealthProbeSettings) : HealthProbeSetting;}
            {_trafficRestorationTimeToHealedOrNewEndpointsInMinute = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNumber>("trafficRestorationTimeToHealedOrNewEndpointsInMinutes"), out var __jsonTrafficRestorationTimeToHealedOrNewEndpointsInMinutes) ? (int?)__jsonTrafficRestorationTimeToHealedOrNewEndpointsInMinutes : TrafficRestorationTimeToHealedOrNewEndpointsInMinute;}
            {_sessionAffinityState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonString>("sessionAffinityState"), out var __jsonSessionAffinityState) ? (string)__jsonSessionAffinityState : (string)SessionAffinityState;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IAfdOriginGroupUpdatePropertiesParameters.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IAfdOriginGroupUpdatePropertiesParameters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IAfdOriginGroupUpdatePropertiesParameters FromJson(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode node)
        {
