...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview
{
    ...
    public partial class RequestHeaderMatchConditionParameters :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IRequestHeaderMatchConditionParameters,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IRequestHeaderMatchConditionParametersInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IRequestHeaderMatchConditionParametersInternal.TypeName { get => this._typeName; set { {_typeName = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.RequestHeaderOperator _operator;

        /// <summary>Describes operator to be matched</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.RequestHeaderOperator Operator { get => this._operator; set => this._operator = value; }
        ...
        private string _typeName= @"DeliveryRuleRequestHeaderConditionParameters";

        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        public string TypeName { get => this._typeName; }

        /// <summary>Creates an new <see cref="RequestHeaderMatchConditionParameters" /> instance.</summary>
    ...
    public partial interface IRequestHeaderMatchConditionParameters :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.RequestHeaderOperator Operator { get; set; }
        /// <summary>Name of Header to be matched</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    /// Defines the parameters for RequestHeader match conditions
    internal partial interface IRequestHeaderMatchConditionParametersInternal
