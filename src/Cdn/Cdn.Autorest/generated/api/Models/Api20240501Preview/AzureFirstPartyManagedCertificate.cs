...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview
{
    ...
    public partial class AzureFirstPartyManagedCertificate :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IAzureFirstPartyManagedCertificate,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IAzureFirstPartyManagedCertificateInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICertificate"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICertificate __certificate = new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.Certificate();

        /// <summary>Certificate expiration date.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inherited)]
        public string ExpirationDate { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICertificateInternal)__certificate).ExpirationDate; }

        /// <summary>Internal Acessors for ExpirationDate</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICertificateInternal.ExpirationDate { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICertificateInternal)__certificate).ExpirationDate; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICertificateInternal)__certificate).ExpirationDate = value; }

        /// <summary>Internal Acessors for Subject</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICertificateInternal.Subject { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICertificateInternal)__certificate).Subject; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICertificateInternal)__certificate).Subject = value; }

        /// <summary>Subject name in the certificate.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inherited)]
        public string Subject { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICertificateInternal)__certificate).Subject; }
    ...
    public partial interface IAzureFirstPartyManagedCertificate :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICertificate
    {

    }
    /// Azure FirstParty Managed Certificate provided by other first party resource providers to enable HTTPS.
    internal partial interface IAzureFirstPartyManagedCertificateInternal :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICertificateInternal
    {
