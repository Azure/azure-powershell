...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview
{
    ...
    public partial class RouteConfigurationOverrideActionParameters :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IRouteConfigurationOverrideActionParametersInternal
    {

        /// <summary>Backing field for <see cref="CacheConfiguration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICacheConfiguration _cacheConfiguration;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICacheConfiguration CacheConfiguration { get => (this._cacheConfiguration = this._cacheConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.CacheConfiguration()); set => this._cacheConfiguration = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICacheConfiguration Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IRouteConfigurationOverrideActionParametersInternal.CacheConfiguration { get => (this._cacheConfiguration = this._cacheConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.CacheConfiguration()); set { {_cacheConfiguration = value;} } }

        /// <summary>Internal Acessors for OriginGroupOverride</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IOriginGroupOverride Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IRouteConfigurationOverrideActionParametersInternal.OriginGroupOverride { get => (this._originGroupOverride = this._originGroupOverride ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.OriginGroupOverride()); set { {_originGroupOverride = value;} } }

        /// <summary>Internal Acessors for OriginGroupOverrideOriginGroup</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IResourceReference Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IRouteConfigurationOverrideActionParametersInternal.OriginGroupOverrideOriginGroup { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IOriginGroupOverrideInternal)OriginGroupOverride).OriginGroup; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IOriginGroupOverrideInternal)OriginGroupOverride).OriginGroup = value; }

        /// <summary>Internal Acessors for TypeName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IRouteConfigurationOverrideActionParametersInternal.TypeName { get => this._typeName; set { {_typeName = value;} } }

        /// <summary>Resource ID.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public string OriginGroupId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IOriginGroupOverrideInternal)OriginGroupOverride).OriginGroupId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IOriginGroupOverrideInternal)OriginGroupOverride).OriginGroupId = value ?? null; }

        /// <summary>Backing field for <see cref="OriginGroupOverride" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IOriginGroupOverride _originGroupOverride;

        /// <summary>
        /// A reference to the origin group override configuration. Leave empty to use the default origin group on route.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IOriginGroupOverride OriginGroupOverride { get => (this._originGroupOverride = this._originGroupOverride ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.OriginGroupOverride()); set => this._originGroupOverride = value; }
...

    {
        ...
        /// The caching configuration associated with this rule. To disable caching, do not provide a cacheConfiguration object.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICacheConfiguration CacheConfiguration { get; set; }
        /// <summary>Caching behavior for the requests</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.RuleCacheBehavior? CacheConfigurationCacheBehavior { get; set; }
        /// <summary>
        /// The duration for which the content needs to be cached. Allowed format is [d.]hh:mm:ss
        ...
        /// A reference to the origin group override configuration. Leave empty to use the default origin group on route.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IOriginGroupOverride OriginGroupOverride { get; set; }
        /// <summary>Protocol this rule will use when forwarding traffic to backends.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ForwardingProtocol? OriginGroupOverrideForwardingProtocol { get; set; }
        /// <summary>defines the OriginGroup that would override the DefaultOriginGroup on route.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IResourceReference OriginGroupOverrideOriginGroup { get; set; }
