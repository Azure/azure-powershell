...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview
{
    ...
    public partial class ProfileProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IProfileProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IProfilePropertiesInternal
    {

        /// <summary>Backing field for <see cref="ExtendedProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IProfilePropertiesExtendedProperties _extendedProperty;

        /// <summary>Key-Value pair representing additional properties for profiles.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IProfilePropertiesExtendedProperties ExtendedProperty { get => (this._extendedProperty = this._extendedProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ProfilePropertiesExtendedProperties()); }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IProfileLogScrubbing _logScrubbing;

        /// <summary>Defines rules that scrub sensitive fields in the Azure Front Door profile logs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IProfileLogScrubbing LogScrubbing { get => (this._logScrubbing = this._logScrubbing ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ProfileLogScrubbing()); set => this._logScrubbing = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IProfilePropertiesExtendedProperties Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IProfilePropertiesInternal.ExtendedProperty { get => (this._extendedProperty = this._extendedProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ProfilePropertiesExtendedProperties()); set { {_extendedProperty = value;} } }

        /// <summary>Internal Acessors for FrontDoorId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IProfilePropertiesInternal.FrontDoorId { get => this._frontDoorId; set { {_frontDoorId = value;} } }

        /// <summary>Internal Acessors for LogScrubbing</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IProfileLogScrubbing Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IProfilePropertiesInternal.LogScrubbing { get => (this._logScrubbing = this._logScrubbing ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ProfileLogScrubbing()); set { {_logScrubbing = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ProfileProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IProfilePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for ResourceState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ProfileResourceState? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IProfilePropertiesInternal.ResourceState { get => this._resourceState; set { {_resourceState = value;} } }
