...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview
{
    ...
    public partial class SharedPrivateLinkResourceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ISharedPrivateLinkResourceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ISharedPrivateLinkResourcePropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IResourceReference _privateLink;

        /// <summary>The resource id of the resource the shared private link resource is for.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IResourceReference PrivateLink { get => (this._privateLink = this._privateLink ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ResourceReference()); set => this._privateLink = value; }

        /// <summary>Resource ID.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public string PrivateLinkId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IResourceReferenceInternal)PrivateLink).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IResourceReferenceInternal)PrivateLink).Id = value ?? null; }
...

    {
        ...
        string GroupId { get; set; }
        /// <summary>The resource id of the resource the shared private link resource is for.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.IResourceReference PrivateLink { get; set; }
        /// <summary>Resource ID.</summary>
        string PrivateLinkId { get; set; }
        /// <summary>The location of the shared private link resource</summary>
        string PrivateLinkLocation { get; set; }
