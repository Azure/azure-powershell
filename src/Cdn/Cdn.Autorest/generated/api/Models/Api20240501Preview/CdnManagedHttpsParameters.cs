...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview
{
    ...
    public partial class CdnManagedHttpsParameters :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICdnManagedHttpsParameters,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICdnManagedHttpsParametersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IValidates
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICdnCertificateSourceParameters _certificateSourceParameter;

        /// <summary>
        /// Defines the certificate source parameters using CDN managed certificate for enabling SSL.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICdnCertificateSourceParameters CertificateSourceParameter { get => (this._certificateSourceParameter = this._certificateSourceParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.CdnCertificateSourceParameters()); set => this._certificateSourceParameter = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public string CertificateSourceParameterTypeName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICdnCertificateSourceParametersInternal)CertificateSourceParameter).TypeName; }

        /// <summary>Internal Acessors for CertificateSourceParameter</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICdnCertificateSourceParameters Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICdnManagedHttpsParametersInternal.CertificateSourceParameter { get => (this._certificateSourceParameter = this._certificateSourceParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.CdnCertificateSourceParameters()); set { {_certificateSourceParameter = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICustomDomainHttpsParametersInternal
    {
        ...
        /// Defines the certificate source parameters using CDN managed certificate for enabling SSL.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.ICdnCertificateSourceParameters CertificateSourceParameter { get; set; }
        /// <summary>Type of certificate used</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.CertificateType CertificateSourceParameterCertificateType { get; set; }
