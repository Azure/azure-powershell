...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601
{
    ...
    public partial class DeliveryRuleRequestHeaderAction :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IDeliveryRuleRequestHeaderAction,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IDeliveryRuleRequestHeaderActionInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IValidates
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IHeaderActionParameters Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IDeliveryRuleRequestHeaderActionInternal.Parameter { get => (this._parameter = this._parameter ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.HeaderActionParameters()); set { {_parameter = value;} } }

        /// <summary>Internal Acessors for ParameterTypeName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IDeliveryRuleRequestHeaderActionInternal.ParameterTypeName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IHeaderActionParametersInternal)Parameter).TypeName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IHeaderActionParametersInternal)Parameter).TypeName = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IHeaderActionParameters _parameter;

        /// <summary>Defines the parameters for the action.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IHeaderActionParameters Parameter { get => (this._parameter = this._parameter ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.HeaderActionParameters()); set => this._parameter = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public string ParameterHeaderName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IHeaderActionParametersInternal)Parameter).HeaderName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IHeaderActionParametersInternal)Parameter).HeaderName = value ; }

        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public string ParameterTypeName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IHeaderActionParametersInternal)Parameter).TypeName; }

        /// <summary>Value for the specified action</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public string ParameterValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IHeaderActionParametersInternal)Parameter).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IHeaderActionParametersInternal)Parameter).Value = value ?? null; }
    ...
    {
        /// <summary>Defines the parameters for the action.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IHeaderActionParameters Parameter { get; set; }
        /// <summary>Action to perform</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.HeaderAction ParameterHeaderAction { get; set; }
        /// <summary>Name of the header to modify</summary>
        string ParameterHeaderName { get; set; }
