...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IValidates
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICacheExpirationActionParameters Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IDeliveryRuleCacheExpirationActionInternal.Parameter { get => (this._parameter = this._parameter ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.CacheExpirationActionParameters()); set { {_parameter = value;} } }

        /// <summary>Internal Acessors for ParameterCacheType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.IDeliveryRuleCacheExpirationActionInternal.ParameterCacheType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICacheExpirationActionParametersInternal)Parameter).CacheType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICacheExpirationActionParametersInternal)Parameter).CacheType = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICacheExpirationActionParameters _parameter;

        /// <summary>Defines the parameters for the action.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICacheExpirationActionParameters Parameter { get => (this._parameter = this._parameter ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.CacheExpirationActionParameters()); set => this._parameter = value; }

        /// <summary>Caching behavior for the requests</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.CacheBehavior ParameterCacheBehavior { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICacheExpirationActionParametersInternal)Parameter).CacheBehavior; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICacheExpirationActionParametersInternal)Parameter).CacheBehavior = value ; }

        /// <summary>
        /// The duration for which the content needs to be cached. Allowed format is [d.]hh:mm:ss
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public string ParameterCacheDuration { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICacheExpirationActionParametersInternal)Parameter).CacheDuration; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICacheExpirationActionParametersInternal)Parameter).CacheDuration = value ?? null; }

        /// <summary>The level at which the content needs to be cached.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public string ParameterCacheType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICacheExpirationActionParametersInternal)Parameter).CacheType; }

        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public string ParameterTypeName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICacheExpirationActionParametersInternal)Parameter).TypeName; }
    ...
    {
        /// <summary>Defines the parameters for the action.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20210601.ICacheExpirationActionParameters Parameter { get; set; }
        /// <summary>Caching behavior for the requests</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.CacheBehavior ParameterCacheBehavior { get; set; }
        /// <summary>
        /// The duration for which the content needs to be cached. Allowed format is [d.]hh:mm:ss
