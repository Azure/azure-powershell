...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201
{
    ...
    public partial class PostArgsMatchConditionParameters :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.IPostArgsMatchConditionParameters,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.IPostArgsMatchConditionParametersInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.IPostArgsMatchConditionParametersInternal.TypeName { get => this._typeName; set { {_typeName = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.PostArgsOperator _operator;

        /// <summary>Describes operator to be matched</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.PostArgsOperator Operator { get => this._operator; set => this._operator = value; }
        ...
        private string _typeName= @"DeliveryRulePostArgsConditionParameters";

        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        public string TypeName { get => this._typeName; }

        /// <summary>Creates an new <see cref="PostArgsMatchConditionParameters" /> instance.</summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.PostArgsOperator Operator { get; set; }
        /// <summary>Name of PostArg to be matched</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    /// Defines the parameters for PostArgs match conditions
    internal partial interface IPostArgsMatchConditionParametersInternal
