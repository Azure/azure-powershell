...
function New-AzFrontDoorCdnProfileUpgradeParametersObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.ProfileUpgradeParameters')]
    [CmdletBinding(PositionalBinding=$false)]
    Param(

        [Parameter(Mandatory, HelpMessage="Web Application Firewall (WAF) and security policy mapping for the profile upgrade.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.IProfileChangeSkuWafMapping[]]
        $WafMappingList
    )

    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.ProfileUpgradeParameters]::New()
