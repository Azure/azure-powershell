...
{{ Add output here }}
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.ICanMigrateResult
.Link
...
function Test-AzFrontDoorCdnProfileMigration {
    ...
    [OutputType([Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.ICanMigrateResult])]
