...
function New-AzFrontDoorCdnRuleClientPortConditionObject {
    ...
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.DeliveryRuleClientPortCondition')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.DeliveryRuleClientPortCondition]::New()
