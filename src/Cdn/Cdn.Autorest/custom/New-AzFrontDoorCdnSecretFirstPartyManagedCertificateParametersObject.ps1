...
function New-AzFrontDoorCdnSecretFirstPartyManagedCertificateParametersObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.AzureFirstPartyManagedCertificateParameters')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.AzureFirstPartyManagedCertificateParameters]::New()
