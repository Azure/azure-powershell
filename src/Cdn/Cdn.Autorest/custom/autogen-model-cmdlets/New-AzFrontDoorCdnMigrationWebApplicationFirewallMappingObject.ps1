...
function New-AzFrontDoorCdnMigrationWebApplicationFirewallMappingObject {
    ...
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.MigrationWebApplicationFirewallMapping')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.MigrationWebApplicationFirewallMapping]::New()
