...
function New-AzCdnResponseBasedOriginErrorDetectionParametersObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.ResponseBasedOriginErrorDetectionParameters')]
    ...
    Param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.IHttpErrorRangeParameters[]]
        $HttpErrorRange,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.ResponseBasedOriginErrorDetectionParameters]::New()
