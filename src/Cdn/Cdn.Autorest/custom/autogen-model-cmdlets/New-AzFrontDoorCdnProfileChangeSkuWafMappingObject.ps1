...
function New-AzFrontDoorCdnProfileChangeSkuWafMappingObject {
    ...
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ProfileChangeSkuWafMapping')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ProfileChangeSkuWafMapping]::New()
