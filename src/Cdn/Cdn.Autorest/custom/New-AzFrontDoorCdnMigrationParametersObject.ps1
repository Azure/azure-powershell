...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.MigrationParameters
.Link
...
function New-AzFrontDoorCdnMigrationParametersObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.MigrationParameters')]
    ...
    Param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.IMigrationWebApplicationFirewallMapping[]]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.MigrationParameters]::New()
