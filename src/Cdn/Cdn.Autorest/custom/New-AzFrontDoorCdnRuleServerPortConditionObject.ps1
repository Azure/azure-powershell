...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.DeliveryRuleServerPortCondition
.Link
...
function New-AzFrontDoorCdnRuleServerPortConditionObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.DeliveryRuleServerPortCondition')]
    ...
    Param(
        ...
        [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ServerPortOperator])]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Support.ServerPortOperator]
        $ParameterOperator,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240501Preview.DeliveryRuleServerPortCondition]::New()
