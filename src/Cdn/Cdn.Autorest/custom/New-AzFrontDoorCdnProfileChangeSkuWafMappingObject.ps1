...
function New-AzFrontDoorCdnProfileChangeSkuWafMappingObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.ProfileChangeSkuWafMapping')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.ProfileChangeSkuWafMapping]::New()
