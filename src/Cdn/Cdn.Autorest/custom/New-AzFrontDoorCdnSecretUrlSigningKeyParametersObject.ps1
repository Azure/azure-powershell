...
function New-AzFrontDoorCdnSecretUrlSigningKeyParametersObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.UrlSigningKeyParameters')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240901.UrlSigningKeyParameters]::New()
