...
$dll = Join-Path $PSScriptRoot 'bin/Az.Cdn.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom/Az.Cdn.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.Cdn.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: Cdn cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.Cdn.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Cdn","ModuleRootName":"$(root-module-name)"}' -AsHashtable
