...
{
    public class PipelineTests : DataFactoryV2TestRunner
    {
        public PipelineTests(Xunit.Abstractions.ITestOutputHelper output) : base(output)
        {
        }
        ...
        {
            TestRunner.RunTestScript("Test-Pipeline");
        }
