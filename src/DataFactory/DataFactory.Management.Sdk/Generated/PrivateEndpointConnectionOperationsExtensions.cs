...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    public static partial class PrivateEndpointConnectionOperationsExtensions
    {
            ...
            /// </param>
            public static PrivateEndpointConnectionResource CreateOrUpdate(this IPrivateEndpointConnectionOperations operations, string resourceGroupName, string factoryName, string privateEndpointConnectionName, string ifMatch = default(string), PrivateLinkConnectionApprovalRequest properties = default(PrivateLinkConnectionApprovalRequest))
            {
                return operations.CreateOrUpdateAsync(resourceGroupName, factoryName, privateEndpointConnectionName, ifMatch, properties).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<PrivateEndpointConnectionResource> CreateOrUpdateAsync(this IPrivateEndpointConnectionOperations operations, string resourceGroupName, string factoryName, string privateEndpointConnectionName, string ifMatch = default(string), PrivateLinkConnectionApprovalRequest properties = default(PrivateLinkConnectionApprovalRequest), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateOrUpdateWithHttpMessagesAsync(resourceGroupName, factoryName, privateEndpointConnectionName, ifMatch, properties, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
