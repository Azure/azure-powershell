...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    public static partial class ManagedPrivateEndpointsOperationsExtensions
    {
            ...
            {
                return operations.CreateOrUpdateAsync(resourceGroupName, factoryName, managedVirtualNetworkName, managedPrivateEndpointName, properties, ifMatch).GetAwaiter().GetResult();
            }
