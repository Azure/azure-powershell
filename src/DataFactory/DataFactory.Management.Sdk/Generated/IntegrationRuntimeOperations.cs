...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    /// </summary>
    internal partial class IntegrationRuntimeOperations : Microsoft.Rest.IServiceOperations<DataFactoryManagementClient>, IIntegrationRuntimeOperations
    {
        /// <summary>
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<IntegrationRuntimeResource,IntegrationRuntimeEnableInteractiveQueryHeaders> _response = await BeginEnableInteractiveQueryWithHttpMessagesAsync(resourceGroupName, factoryName, integrationRuntimeName, autoTerminationMinutes, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<IntegrationRuntimeResource,IntegrationRuntimeDisableInteractiveQueryHeaders> _response = await BeginDisableInteractiveQueryWithHttpMessagesAsync(resourceGroupName, factoryName, integrationRuntimeName, customHeaders, cancellationToken).ConfigureAwait(false);
                return await this.Client.GetPostOrDeleteOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<IntegrationRuntimeResource,IntegrationRuntimeEnableInteractiveQueryHeaders>> BeginEnableInteractiveQueryWithHttpMessagesAsync(string resourceGroupName, string factoryName, string integrationRuntimeName, int? autoTerminationMinutes = default(int?), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<IntegrationRuntimeResource,IntegrationRuntimeEnableInteractiveQueryHeaders>();
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<IntegrationRuntimeEnableInteractiveQueryHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
            catch (Newtonsoft.Json.JsonException ex)
            {
                _httpRequest.Dispose();
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<IntegrationRuntimeResource,IntegrationRuntimeDisableInteractiveQueryHeaders>> BeginDisableInteractiveQueryWithHttpMessagesAsync(string resourceGroupName, string factoryName, string integrationRuntimeName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<IntegrationRuntimeResource,IntegrationRuntimeDisableInteractiveQueryHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<IntegrationRuntimeDisableInteractiveQueryHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
            catch (Newtonsoft.Json.JsonException ex)
            {
                _httpRequest.Dispose();
