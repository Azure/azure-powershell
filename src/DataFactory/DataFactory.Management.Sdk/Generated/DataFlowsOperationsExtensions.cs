...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    public static partial class DataFlowsOperationsExtensions
    {
            ...
            {
                return operations.CreateOrUpdateAsync(resourceGroupName, factoryName, dataFlowName, properties, ifMatch).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<DataFlowResource> CreateOrUpdateAsync(this IDataFlowsOperations operations, string resourceGroupName, string factoryName, string dataFlowName, DataFlow properties, string ifMatch = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
