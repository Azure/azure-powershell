...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    public static partial class IntegrationRuntimeObjectMetadataOperationsExtensions
    {
            ...
            {
                return operations.GetAsync(resourceGroupName, factoryName, integrationRuntimeName, metadataPath).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SsisObjectMetadataListResponse> GetAsync(this IIntegrationRuntimeObjectMetadataOperations operations, string resourceGroupName, string factoryName, string integrationRuntimeName, string metadataPath = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
