...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    public static partial class DataFlowDebugSessionOperationsExtensions
    {
            ...
            {
                operations.DeleteAsync(resourceGroupName, factoryName, sessionId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task DeleteAsync(this IDataFlowDebugSessionOperations operations, string resourceGroupName, string factoryName, string sessionId = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
