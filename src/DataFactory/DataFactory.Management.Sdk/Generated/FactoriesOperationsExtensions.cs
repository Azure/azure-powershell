...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    public static partial class FactoriesOperationsExtensions
    {
            ...
            {
                return operations.ConfigureFactoryRepoAsync(locationId, factoryResourceId, repoConfiguration).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Factory> ConfigureFactoryRepoAsync(this IFactoriesOperations operations, string locationId, string factoryResourceId = default(string), FactoryRepoConfiguration repoConfiguration = default(FactoryRepoConfiguration), CancellationToken cancellationToken = default(CancellationToken))
            {
