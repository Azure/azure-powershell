...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("AzureTable")]
    ...
    public partial class AzureTableDataset : Dataset
    {
        ...
        /// <param name="tableName">The table name of the Azure Table storage. Type: string (or Expression with
        /// resultType string).
        /// </param>
        public AzureTableDataset(LinkedServiceReference linkedServiceName, object tableName, System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), System.Collections.Generic.IDictionary<string, ParameterSpecification> parameters = default(System.Collections.Generic.IDictionary<string, ParameterSpecification>), System.Collections.Generic.IList<object> annotations = default(System.Collections.Generic.IList<object>), DatasetFolder folder = default(DatasetFolder))
        ...
        /// <summary>
        /// Gets or sets the table name of the Azure Table storage. Type: string (or
