...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class TeradataSource : TabularSource
    {
        ...
        /// <param name="query">Teradata query. Type: string (or Expression with resultType string).
        /// </param>

        /// <param name="partitionOption">The partition mechanism that will be used for teradata read in parallel.
        /// Possible values include: &#34;None&#34;, &#34;Hash&#34;, &#34;DynamicRange&#34;.
        /// </param>

        /// <param name="partitionSettings">The settings that will be leveraged for teradata source partitioning.
        /// </param>
        public TeradataSource(System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), object sourceRetryCount = default(object), object sourceRetryWait = default(object), object maxConcurrentConnections = default(object), object disableMetricsCollection = default(object), object queryTimeout = default(object), object additionalColumns = default(object), object query = default(object), object partitionOption = default(object), TeradataPartitionSettings partitionSettings = default(TeradataPartitionSettings))
        ...
        /// <summary>
        /// Gets or sets teradata query. Type: string (or Expression with resultType
        /// string).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the partition mechanism that will be used for teradata read in
        ...
        /// <summary>
        /// Gets or sets the settings that will be leveraged for teradata source
        /// partitioning.
        /// </summary>
