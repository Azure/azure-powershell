...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class AzureDatabricksDeltaLakeImportCommand : ImportSettings
    {
        ...
        /// <param name="dateFormat">Specify the date format for csv in Azure
        /// Databricks Delta Lake Copy. Type: string (or Expression with
        /// resultType string).</param>
        /// <param name="timestampFormat">Specify the timestamp format for csv
        /// in Azure Databricks Delta Lake Copy. Type: string (or Expression
        /// with resultType string).</param>
        public AzureDatabricksDeltaLakeImportCommand(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), object dateFormat = default(object), object timestampFormat = default(object))
