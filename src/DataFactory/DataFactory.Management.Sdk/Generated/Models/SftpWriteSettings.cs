...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class SftpWriteSettings : StoreWriteSettings
    {
        ...
        /// <param name="operationTimeout">Specifies the timeout for writing each chunk to SFTP server. Default value:
        /// 01:00:00 (one hour). Type: string (or Expression with resultType string).
        /// </param>

        /// <param name="useTempFileRename">Upload to temporary file(s) and rename. Disable this option if your SFTP
        ...
        /// <summary>
        /// Gets or sets specifies the timeout for writing each chunk to SFTP server.
        ...
        /// <summary>
        /// Gets or sets upload to temporary file(s) and rename. Disable this option if
        /// your SFTP server doesn&#39;t support rename operation. Type: boolean (or
        /// Expression with resultType boolean).
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "useTempFileRename")]
