...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class TriggerResource : SubResource
    {
        ...
        /// <param name="properties">Properties of the trigger.
        /// </param>
        public TriggerResource(Trigger properties, string id = default(string), string name = default(string), string type = default(string), string etag = default(string))
