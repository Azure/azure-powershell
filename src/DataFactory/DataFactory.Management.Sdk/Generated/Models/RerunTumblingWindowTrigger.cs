...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class RerunTumblingWindowTrigger : Trigger
    {
        ...
        /// <param name="parentTrigger">The parent trigger reference.
        /// </param>

        /// <param name="requestedStartTime">The start time for the time period for which restatement is initiated. Only
        /// UTC time is currently supported.
        /// </param>

        /// <param name="requestedEndTime">The end time for the time period for which restatement is initiated. Only
        /// UTC time is currently supported.
        /// </param>

        /// <param name="rerunConcurrency">The max number of parallel time windows (ready for execution) for which a
        /// rerun is triggered.
        /// </param>
        public RerunTumblingWindowTrigger(object parentTrigger, System.DateTime requestedStartTime, System.DateTime requestedEndTime, int rerunConcurrency, System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), string description = default(string), string runtimeState = default(string), System.Collections.Generic.IList<object> annotations = default(System.Collections.Generic.IList<object>))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "typeProperties.parentTrigger")]
        public object ParentTrigger {get; set; }

        /// <summary>
        /// Gets or sets the start time for the time period for which restatement is
        ...
        /// <summary>
        /// Gets or sets the end time for the time period for which restatement is
        /// initiated. Only UTC time is currently supported.
        /// </summary>
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "ParentTrigger");
            }

            if (this.RerunConcurrency > 50)
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.InclusiveMaximum, "RerunConcurrency", 50);
            }
            if (this.RerunConcurrency < 1)
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.InclusiveMinimum, "RerunConcurrency", 1);
            }
        }
    }
}