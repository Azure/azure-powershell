...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class HDInsightPigActivity : ExecutionActivity
    {
        ...
        /// <param name="arguments">User specified arguments to HDInsightActivity. Type: array (or Expression
        ...
        /// <param name="defines">Allows user to specify defines for Pig job request.
        /// </param>
        public HDInsightPigActivity(string name, System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), string description = default(string), string state = default(string), string onInactiveMarkAs = default(string), System.Collections.Generic.IList<ActivityDependency> dependsOn = default(System.Collections.Generic.IList<ActivityDependency>), System.Collections.Generic.IList<UserProperty> userProperties = default(System.Collections.Generic.IList<UserProperty>), LinkedServiceReference linkedServiceName = default(LinkedServiceReference), ActivityPolicy policy = default(ActivityPolicy), System.Collections.Generic.IList<LinkedServiceReference> storageLinkedServices = default(System.Collections.Generic.IList<LinkedServiceReference>), object arguments = default(object), string getDebugInfo = default(string), object scriptPath = default(object), LinkedServiceReference scriptLinkedService = default(LinkedServiceReference), System.Collections.Generic.IDictionary<string, object> defines = default(System.Collections.Generic.IDictionary<string, object>))
        ...
        /// <summary>
        /// Gets or sets user specified arguments to HDInsightActivity. Type: array (or
