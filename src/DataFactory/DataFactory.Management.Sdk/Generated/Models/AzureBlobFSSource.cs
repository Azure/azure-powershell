...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the AzureBlobFSSource class.
        /// </summary>
        ...
        /// <param name="treatEmptyAsNull">Treat empty as null. Type: boolean (or Expression with resultType boolean).
        /// </param>

        /// <param name="skipHeaderLineCount">Number of header lines to skip from each blob. Type: integer (or Expression
        ...
        /// </param>
        public AzureBlobFSSource(System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), object sourceRetryCount = default(object), object sourceRetryWait = default(object), object maxConcurrentConnections = default(object), object disableMetricsCollection = default(object), object treatEmptyAsNull = default(object), object skipHeaderLineCount = default(object), object recursive = default(object))
        ...
        /// <summary>
        /// Gets or sets number of header lines to skip from each blob. Type: integer
