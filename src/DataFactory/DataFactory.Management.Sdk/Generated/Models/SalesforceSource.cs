...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class SalesforceSource : TabularSource
    {
        ...
        /// Default is Query. Allowed values: Query/QueryAll. Type: string (or
        /// Expression with resultType string).</param>
        public SalesforceSource(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), object sourceRetryCount = default(object), object sourceRetryWait = default(object), object maxConcurrentConnections = default(object), object disableMetricsCollection = default(object), object queryTimeout = default(object), object additionalColumns = default(object), object query = default(object), object readBehavior = default(object))
        ...
        /// Allowed values: Query/QueryAll. Type: string (or Expression with
        /// resultType string).
        /// </summary>
