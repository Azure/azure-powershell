...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class LakeHouseTableSink : CopySink
    {
        ...
        /// <param name="tableActionOption">The type of table action for
        /// LakeHouse Table sink. Possible values include: "None", "Append",
        /// "Overwrite".</param>
        /// <param name="partitionOption">Create partitions in folder structure
        /// based on one or multiple columns. Each distinct column value (pair)
        /// will be a new partition. Possible values include: "None",
        /// "PartitionByKey".</param>
        /// <param name="partitionNameList">Specify the partition column names
        /// from sink columns. Type: array of objects (or Expression with
        ...
        /// <summary>
        /// Gets or sets the type of table action for LakeHouse Table sink.
        /// Possible values include: "None", "Append", "Overwrite".
        /// </summary>
        [JsonProperty(PropertyName = "tableActionOption")]
        public object TableActionOption { get; set; }

        /// <summary>
        /// Gets or sets create partitions in folder structure based on one or
        /// multiple columns. Each distinct column value (pair) will be a new
        ...
        /// <summary>
        /// Gets or sets specify the partition column names from sink columns.
        /// Type: array of objects (or Expression with resultType array of
        /// objects).
        /// </summary>
        [JsonProperty(PropertyName = "partitionNameList")]
