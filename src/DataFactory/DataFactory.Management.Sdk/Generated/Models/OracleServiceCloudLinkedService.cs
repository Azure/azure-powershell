...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the OracleServiceCloudLinkedService
        /// class.
        /// </summary>
        ...
        /// class.
        /// </summary>
        /// <param name="host">The URL of the Oracle Service Cloud
        /// instance.</param>
        /// <param name="username">The user name that you use to access Oracle
        /// Service Cloud server.</param>
        /// <param name="password">The password corresponding to the user name
        /// that you provided in the username key.</param>
        ...
        public OracleServiceCloudLinkedService(object host, object username, SecretBase password, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), IntegrationRuntimeReference connectVia = default(IntegrationRuntimeReference), string description = default(string), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), object useEncryptedEndpoints = default(object), object useHostVerification = default(object), object usePeerVerification = default(object), string encryptedCredential = default(string))
