...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class AppendVariableActivity : ControlActivity
    {
        ...
        /// <param name="value">Value to be appended. Type: could be a static
        /// value matching type of the variable item or Expression with
        /// resultType matching type of the variable item</param>
        public AppendVariableActivity(string name, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), string state = default(string), string onInactiveMarkAs = default(string), IList<ActivityDependency> dependsOn = default(IList<ActivityDependency>), IList<UserProperty> userProperties = default(IList<UserProperty>), string variableName = default(string), object value = default(object))
        ...
        /// <summary>
        /// Gets or sets value to be appended. Type: could be a static value
        /// matching type of the variable item or Expression with resultType
        /// matching type of the variable item
        /// </summary>
