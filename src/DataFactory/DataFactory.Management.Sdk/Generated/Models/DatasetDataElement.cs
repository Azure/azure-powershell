...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class DatasetDataElement
    {
        ...
        /// <param name="name">Name of the column. Type: string (or Expression with resultType string).
        /// </param>

        /// <param name="type">Type of the column. Type: string (or Expression with resultType string).
        /// </param>
        public DatasetDataElement(object name = default(object), object type = default(object))
