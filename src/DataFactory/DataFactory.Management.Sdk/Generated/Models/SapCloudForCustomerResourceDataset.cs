...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class SapCloudForCustomerResourceDataset : Dataset
    {
        ...
        /// <param name="path">The path of the SAP Cloud for Customer OData entity. Type: string (or
        /// Expression with resultType string).
        /// </param>
        public SapCloudForCustomerResourceDataset(LinkedServiceReference linkedServiceName, object path, System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), System.Collections.Generic.IDictionary<string, ParameterSpecification> parameters = default(System.Collections.Generic.IDictionary<string, ParameterSpecification>), System.Collections.Generic.IList<object> annotations = default(System.Collections.Generic.IList<object>), DatasetFolder folder = default(DatasetFolder))
        ...
        /// <summary>
        /// Gets or sets the path of the SAP Cloud for Customer OData entity. Type:
