...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class NetezzaTableDataset : Dataset
    {
        ...
        /// <param name="typePropertiesSchema">The schema name of the Netezza. Type: string (or Expression with resultType
        /// string).
        /// </param>
        public NetezzaTableDataset(LinkedServiceReference linkedServiceName, System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), System.Collections.Generic.IDictionary<string, ParameterSpecification> parameters = default(System.Collections.Generic.IDictionary<string, ParameterSpecification>), System.Collections.Generic.IList<object> annotations = default(System.Collections.Generic.IList<object>), DatasetFolder folder = default(DatasetFolder), object tableName = default(object), object table = default(object), object typePropertiesSchema = default(object))
