...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class AzureDataLakeStoreReadSettings : StoreReadSettings
    {
        ...
        /// <param name="wildcardFolderPath">ADLS wildcardFolderPath. Type: string (or Expression with resultType
        /// string).
        /// </param>

        /// <param name="wildcardFileName">ADLS wildcardFileName. Type: string (or Expression with resultType string).
        /// </param>
        ...
        /// <param name="listAfter">Lists files after the value (exclusive) based on file/folder names’
        /// lexicographical order. Applies under the folderPath in data set, and filter
        /// files/sub-folders under the folderPath. Type: string (or Expression with
        /// resultType string).
        /// </param>

        /// <param name="listBefore">Lists files before the value (inclusive) based on file/folder names’
        /// lexicographical order. Applies under the folderPath in data set, and filter
        /// files/sub-folders under the folderPath. Type: string (or Expression with
        /// resultType string).
        /// </param>
        ...
        /// <summary>
        /// Gets or sets aDLS wildcardFolderPath. Type: string (or Expression with
        /// resultType string).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets aDLS wildcardFileName. Type: string (or Expression with
        /// resultType string).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets lists files after the value (exclusive) based on file/folder
        /// names’ lexicographical order. Applies under the folderPath in data set, and
        /// filter files/sub-folders under the folderPath. Type: string (or Expression
        ...
        /// <summary>
        /// Gets or sets lists files before the value (inclusive) based on file/folder
        /// names’ lexicographical order. Applies under the folderPath in data set, and
        /// filter files/sub-folders under the folderPath. Type: string (or Expression
        /// with resultType string).
        /// </summary>
