...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class DrillTableDataset : Dataset
    {
        ...
        /// <param name="table">The table name of the Drill. Type: string (or Expression with resultType
        /// string).
        /// </param>

        /// <param name="typePropertiesSchema">The schema name of the Drill. Type: string (or Expression with resultType
        /// string).
        /// </param>
        ...
        /// <summary>
        /// Gets or sets the table name of the Drill. Type: string (or Expression with
        /// resultType string).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the schema name of the Drill. Type: string (or Expression with
        /// resultType string).
        /// </summary>
