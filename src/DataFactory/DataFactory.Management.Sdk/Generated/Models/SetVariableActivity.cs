...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class SetVariableActivity : ControlActivity
    {
        ...
        /// Expression.</param>
        /// <param name="setSystemVariable">If set to true, it sets the
        /// pipeline run return value.</param>
        /// <param name="policy">Activity policy.</param>
        public SetVariableActivity(string name, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), string state = default(string), string onInactiveMarkAs = default(string), IList<ActivityDependency> dependsOn = default(IList<ActivityDependency>), IList<UserProperty> userProperties = default(IList<UserProperty>), string variableName = default(string), object value = default(object), bool? setSystemVariable = default(bool?), SecureInputOutputPolicy policy = default(SecureInputOutputPolicy))
        ...
        /// <summary>
        /// Gets or sets value to be set. Could be a static value or
        /// Expression.
        /// </summary>
        ...
        /// </summary>
        [JsonProperty(PropertyName = "typeProperties.setSystemVariable")]
