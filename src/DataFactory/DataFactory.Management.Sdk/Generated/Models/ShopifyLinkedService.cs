...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class ShopifyLinkedService : LinkedService
    {
        ...
        /// <param name="host">The endpoint of the Shopify server. (i.e. mystore.myshopify.com)
        /// </param>

        /// <param name="accessToken">The API access token that can be used to access Shopify’s data. The token
        ...
        /// <summary>
        /// Gets or sets the endpoint of the Shopify server. (i.e.
        ...
        /// <summary>
        /// Gets or sets the API access token that can be used to access Shopify’s
        /// data. The token won&#39;t expire if it is offline mode.
        /// </summary>
