...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("WarehouseSource")]
    public partial class WarehouseSource : TabularSource
    {
        /// <summary>
        /// Initializes a new instance of the WarehouseSource class.
        /// </summary>
        ...
        /// <param name="sqlReaderQuery">Microsoft Fabric Warehouse reader query. Type: string (or Expression with
        /// resultType string).
        /// </param>

        /// <param name="sqlReaderStoredProcedureName">Name of the stored procedure for a Microsoft Fabric Warehouse source. This
        ...
        /// <param name="isolationLevel">Specifies the transaction locking behavior for the Microsoft Fabric
        ...
        /// </param>
        public WarehouseSource(System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), object sourceRetryCount = default(object), object sourceRetryWait = default(object), object maxConcurrentConnections = default(object), object disableMetricsCollection = default(object), object queryTimeout = default(object), object additionalColumns = default(object), object sqlReaderQuery = default(object), object sqlReaderStoredProcedureName = default(object), object storedProcedureParameters = default(object), object isolationLevel = default(object), object partitionOption = default(object), SqlPartitionSettings partitionSettings = default(SqlPartitionSettings))
        ...
        /// <summary>
        /// Gets or sets microsoft Fabric Warehouse reader query. Type: string (or
        /// Expression with resultType string).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets name of the stored procedure for a Microsoft Fabric Warehouse
        ...
        /// <summary>
        /// Gets or sets specifies the transaction locking behavior for the Microsoft
        /// Fabric Warehouse source. Allowed values:
        /// ReadCommitted/ReadUncommitted/RepeatableRead/Serializable/Snapshot. The
        /// default value is ReadCommitted. Type: string (or Expression with resultType
        /// string).
        /// </summary>
