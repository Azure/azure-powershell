...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class WranglingDataFlow : DataFlow
    {
        ...
        /// </param>
        public WranglingDataFlow(string description = default(string), System.Collections.Generic.IList<object> annotations = default(System.Collections.Generic.IList<object>), DataFlowFolder folder = default(DataFlowFolder), System.Collections.Generic.IList<PowerQuerySource> sources = default(System.Collections.Generic.IList<PowerQuerySource>), string script = default(string), string documentLocale = default(string))
