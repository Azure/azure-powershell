...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the GoogleCloudStorageReadSettings class.
        /// </summary>
        ...
        /// <param name="wildcardFolderPath">Google Cloud Storage wildcardFolderPath. Type: string (or Expression with
        /// resultType string).
        /// </param>

        /// <param name="wildcardFileName">Google Cloud Storage wildcardFileName. Type: string (or Expression with
        /// resultType string).
        /// </param>

        /// <param name="prefix">The prefix filter for the Google Cloud Storage object name. Type: string
        ...
        /// resultType string).
        /// </param>
        public GoogleCloudStorageReadSettings(System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), object maxConcurrentConnections = default(object), object disableMetricsCollection = default(object), object recursive = default(object), object wildcardFolderPath = default(object), object wildcardFileName = default(object), object prefix = default(object), object fileListPath = default(object), object enablePartitionDiscovery = default(object), object partitionRootPath = default(object), object deleteFilesAfterCompletion = default(object), object modifiedDatetimeStart = default(object), object modifiedDatetimeEnd = default(object))
        ...
        /// <summary>
        /// Gets or sets google Cloud Storage wildcardFolderPath. Type: string (or
        /// Expression with resultType string).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets google Cloud Storage wildcardFileName. Type: string (or
        /// Expression with resultType string).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the prefix filter for the Google Cloud Storage object name.
