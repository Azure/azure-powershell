...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class HttpDataset : Dataset
    {
        ...
        /// <param name="relativeUrl">The relative URL based on the URL in the HttpLinkedService refers to an
        /// HTTP file Type: string (or Expression with resultType string).
        /// </param>

        /// <param name="requestMethod">The HTTP method for the HTTP request. Type: string (or Expression with
        /// resultType string).
        /// </param>

        /// <param name="requestBody">The body for the HTTP request. Type: string (or Expression with resultType
        /// string).
        /// </param>

        /// <param name="additionalHeaders">The headers for the HTTP Request. e.g.
        ...
        /// <summary>
        /// Gets or sets the relative URL based on the URL in the HttpLinkedService
        /// refers to an HTTP file Type: string (or Expression with resultType string).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the body for the HTTP request. Type: string (or Expression
        /// with resultType string).
        /// </summary>
