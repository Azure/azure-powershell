...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class DynamicsCrmSource : CopySource
    {
        ...
        /// <param name="query">FetchXML is a proprietary query language that is used in Microsoft Dynamics
        /// CRM (online &amp; on-premises). Type: string (or Expression with resultType
        /// string).
        /// </param>
        ...
        /// objects).
        /// </param>
        public DynamicsCrmSource(System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), object sourceRetryCount = default(object), object sourceRetryWait = default(object), object maxConcurrentConnections = default(object), object disableMetricsCollection = default(object), object query = default(object), object additionalColumns = default(object))
