...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class SwitchActivity : ControlActivity
    {
        ...
        public SwitchActivity(string name, Expression on, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), string state = default(string), string onInactiveMarkAs = default(string), IList<ActivityDependency> dependsOn = default(IList<ActivityDependency>), IList<UserProperty> userProperties = default(IList<UserProperty>), IList<SwitchCase> cases = default(IList<SwitchCase>), IList<Activity> defaultActivities = default(IList<Activity>))
