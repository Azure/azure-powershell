...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the LakeHouseTableDataset class.
        /// </summary>
        ...
        /// <param name="table">The name of Microsoft Fabric LakeHouse Table.
        /// Type: string (or Expression with resultType string).</param>
        public LakeHouseTableDataset(LinkedServiceReference linkedServiceName, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), DatasetFolder folder = default(DatasetFolder), object table = default(object))
        ...
        /// <summary>
        /// Gets or sets the name of Microsoft Fabric LakeHouse Table. Type:
