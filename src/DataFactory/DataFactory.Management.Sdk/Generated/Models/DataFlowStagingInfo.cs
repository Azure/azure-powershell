...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class DataFlowStagingInfo
    {
        ...
        /// <param name="linkedService">Staging linked service reference.
        /// </param>

        /// <param name="folderPath">Folder path for staging blob. Type: string (or Expression with resultType
        /// string)
        /// </param>
        ...
        /// <summary>
        /// Gets or sets folder path for staging blob. Type: string (or Expression with
        /// resultType string)
        /// </summary>
