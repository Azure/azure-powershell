...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class DocumentDbCollectionSink : CopySink
    {
        ...
        /// <param name="nestingSeparator">Nested properties separator. Default is . (dot). Type: string (or
        ...
        /// <summary>
        /// Gets or sets nested properties separator. Default is . (dot). Type: string
        ...
        /// <summary>
        /// Gets or sets describes how to write data to Azure Cosmos DB. Type: string
        /// (or Expression with resultType string). Allowed values: insert and upsert.
        /// </summary>
