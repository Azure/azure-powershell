...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class SsisPackage : SsisObjectMetadata
    {
        ...
        /// <param name="folderId">Folder id which contains package.
        /// </param>

        /// <param name="projectVersion">Project version which contains package.
        /// </param>

        /// <param name="projectId">Project id which contains package.
        /// </param>

        /// <param name="parameters">Parameters in package
        /// </param>
        public SsisPackage(long? id = default(long?), string name = default(string), string description = default(string), long? folderId = default(long?), long? projectVersion = default(long?), long? projectId = default(long?), System.Collections.Generic.IList<SsisParameter> parameters = default(System.Collections.Generic.IList<SsisParameter>))
