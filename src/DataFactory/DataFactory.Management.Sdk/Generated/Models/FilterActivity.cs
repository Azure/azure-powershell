...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class FilterActivity : ControlActivity
    {
        ...
        public FilterActivity(string name, Expression items, Expression condition, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), string state = default(string), string onInactiveMarkAs = default(string), IList<ActivityDependency> dependsOn = default(IList<ActivityDependency>), IList<UserProperty> userProperties = default(IList<UserProperty>))
