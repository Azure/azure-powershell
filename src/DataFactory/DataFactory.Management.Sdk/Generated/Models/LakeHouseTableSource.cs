...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class LakeHouseTableSource : CopySource
    {
        ...
        /// <param name="timestampAsOf">Query an older snapshot by timestamp.
        /// Type: string (or Expression with resultType string).</param>
        /// <param name="versionAsOf">Query an older snapshot by version. Type:
        ...
        public LakeHouseTableSource(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), object sourceRetryCount = default(object), object sourceRetryWait = default(object), object maxConcurrentConnections = default(object), object disableMetricsCollection = default(object), object timestampAsOf = default(object), object versionAsOf = default(object), object additionalColumns = default(object))
        ...
        /// <summary>
        /// Gets or sets query an older snapshot by timestamp. Type: string (or
        /// Expression with resultType string).
        /// </summary>
        [JsonProperty(PropertyName = "timestampAsOf")]
        public object TimestampAsOf { get; set; }

        /// <summary>
        /// Gets or sets query an older snapshot by version. Type: integer (or
        /// Expression with resultType integer).
        /// </summary>
        [JsonProperty(PropertyName = "versionAsOf")]
