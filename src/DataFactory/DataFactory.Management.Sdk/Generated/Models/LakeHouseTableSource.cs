...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class LakeHouseTableSource : CopySource
    {
        ...
        /// <param name="timestampAsOf">Query an older snapshot by timestamp. Type: string (or Expression with
        /// resultType string).
        /// </param>

        /// <param name="versionAsOf">Query an older snapshot by version. Type: integer (or Expression with
        /// resultType integer).
        /// </param>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "timestampAsOf")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "versionAsOf")]
