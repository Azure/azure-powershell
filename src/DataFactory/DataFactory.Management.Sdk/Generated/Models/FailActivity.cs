...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class FailActivity : ControlActivity
    {
        ...
        public FailActivity(string name, object message, object errorCode, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), string state = default(string), string onInactiveMarkAs = default(string), IList<ActivityDependency> dependsOn = default(IList<ActivityDependency>), IList<UserProperty> userProperties = default(IList<UserProperty>))
