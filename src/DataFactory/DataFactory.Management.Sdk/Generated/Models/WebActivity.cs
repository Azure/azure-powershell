...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class WebActivity : ExecutionActivity
    {
        ...
        /// </param>
        public WebActivity(string name, string method, object url, System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), string description = default(string), string state = default(string), string onInactiveMarkAs = default(string), System.Collections.Generic.IList<ActivityDependency> dependsOn = default(System.Collections.Generic.IList<ActivityDependency>), System.Collections.Generic.IList<UserProperty> userProperties = default(System.Collections.Generic.IList<UserProperty>), LinkedServiceReference linkedServiceName = default(LinkedServiceReference), ActivityPolicy policy = default(ActivityPolicy), object headers = default(object), object body = default(object), WebActivityAuthentication authentication = default(WebActivityAuthentication), bool? disableCertValidation = default(bool?), System.Collections.Generic.IList<DatasetReference> datasets = default(System.Collections.Generic.IList<DatasetReference>), System.Collections.Generic.IList<LinkedServiceReference> linkedServices = default(System.Collections.Generic.IList<LinkedServiceReference>), IntegrationRuntimeReference connectVia = default(IntegrationRuntimeReference))
