...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the TeradataTableDataset class.
        /// </summary>
        ...
        /// <param name="database">The database name of Teradata. Type: string (or Expression with resultType
        /// string).
        /// </param>

        /// <param name="table">The table name of Teradata. Type: string (or Expression with resultType
        /// string).
        /// </param>
        public TeradataTableDataset(LinkedServiceReference linkedServiceName, System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), System.Collections.Generic.IDictionary<string, ParameterSpecification> parameters = default(System.Collections.Generic.IDictionary<string, ParameterSpecification>), System.Collections.Generic.IList<object> annotations = default(System.Collections.Generic.IList<object>), DatasetFolder folder = default(DatasetFolder), object database = default(object), object table = default(object))
        ...
        /// <summary>
        /// Gets or sets the database name of Teradata. Type: string (or Expression
        ...
        /// <summary>
        /// Gets or sets the table name of Teradata. Type: string (or Expression with
        /// resultType string).
        /// </summary>
