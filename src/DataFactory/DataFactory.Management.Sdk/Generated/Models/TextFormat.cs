...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class TextFormat : DatasetStorageFormat
    {
        ...
        /// ΓÇ£utf-8ΓÇ¥, unless BOM denotes another Unicode encoding. Refer to the
        /// ΓÇ£NameΓÇ¥ column of the table in the following link to set supported
        /// values: https://msdn.microsoft.com/library/system.text.encoding.aspx. Type:
        /// string (or Expression with resultType string).
        /// </param>

        /// <param name="treatEmptyAsNull">Treat empty column values in the text file as null. The default value is
        /// true. Type: boolean (or Expression with resultType boolean).
        /// </param>

        /// <param name="skipLineCount">The number of lines/rows to be skipped when parsing text files. The default
        ...
        /// default value is ΓÇ£utf-8ΓÇ¥, unless BOM denotes another Unicode encoding.
        /// Refer to the ΓÇ£NameΓÇ¥ column of the table in the following link to set
        /// supported values:
        ...
        /// <summary>
        /// Gets or sets treat empty column values in the text file as null. The
        ...
        /// <summary>
        /// Gets or sets the number of lines/rows to be skipped when parsing text
        /// files. The default value is 0. Type: integer (or Expression with resultType
        /// integer).
        /// </summary>
