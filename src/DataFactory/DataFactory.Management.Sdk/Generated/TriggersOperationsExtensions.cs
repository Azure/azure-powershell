...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    public static partial class TriggersOperationsExtensions
    {
            ...
            {
                return operations.QueryByFactoryAsync(resourceGroupName, factoryName, continuationToken, parentTriggerName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<TriggerQueryResponse> QueryByFactoryAsync(this ITriggersOperations operations, string resourceGroupName, string factoryName, string continuationToken = default(string), string parentTriggerName = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.CreateOrUpdateAsync(resourceGroupName, factoryName, triggerName, properties, ifMatch).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<TriggerResource> CreateOrUpdateAsync(this ITriggersOperations operations, string resourceGroupName, string factoryName, string triggerName, Trigger properties, string ifMatch = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
