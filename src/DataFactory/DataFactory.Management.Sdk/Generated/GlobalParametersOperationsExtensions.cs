...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    public static partial class GlobalParametersOperationsExtensions
    {
            ...
            /// </param>
            public static GlobalParameterResource CreateOrUpdate(this IGlobalParametersOperations operations, string resourceGroupName, string factoryName, string globalParameterName, IDictionary<string, GlobalParameterSpecification> properties)
            {
                return operations.CreateOrUpdateAsync(resourceGroupName, factoryName, globalParameterName, properties).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<GlobalParameterResource> CreateOrUpdateAsync(this IGlobalParametersOperations operations, string resourceGroupName, string factoryName, string globalParameterName, IDictionary<string, GlobalParameterSpecification> properties, CancellationToken cancellationToken = default(CancellationToken))
            {
