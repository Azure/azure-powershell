...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    public static partial class DatasetsOperationsExtensions
    {
            ...
            {
                return operations.CreateOrUpdateAsync(resourceGroupName, factoryName, datasetName, properties, ifMatch).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DatasetResource> CreateOrUpdateAsync(this IDatasetsOperations operations, string resourceGroupName, string factoryName, string datasetName, Dataset properties, string ifMatch = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
