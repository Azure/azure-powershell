...
{
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "DataFactoryV2TriggerRun", DefaultParameterSetName = ParameterSetNames.ByFactoryName),OutputType(typeof(PSTriggerRun))]
