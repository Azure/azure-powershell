...
{
    public class PSTriggerSubscriptionStatus
    {
        private TriggerSubscriptionOperationStatus triggerSubscriptionOperationStatus;
        ...
        public string TriggerName
        {
            get
            {
                return this.triggerSubscriptionOperationStatus.TriggerName;
            }
        }
        ...
        public string Status
        {
            get
            {
                return this.triggerSubscriptionOperationStatus.Status;
            }
        }
    }
}
