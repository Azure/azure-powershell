...
{
    public class PSDataFlowDebugSession
    {
        private CreateDataFlowDebugSessionResponse _debugSession;
        ...
        public string SessionId
        {
            get
            {
                return this._debugSession.SessionId;
            }
        }
        public string Status
        {
            get
            {
                return this._debugSession.Status;
            }
        }
    }
}
