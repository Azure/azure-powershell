...
## DESCRIPTION
The Get-AzIntegrationRuntimeOutboundNetworkDependenciesEndpoints cmdlet gets information about integration runtimes in a data factory.
...
```
PS C:\> Get-AzIntegrationRuntimeOutboundNetworkDependenciesEndpoints -ResourceGroupName rg-test-dfv2 -DataFactoryName test-df-eu2
