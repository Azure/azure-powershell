...
```
Set-AzDataFactoryV2LinkedService [-Name] <String> [-DefinitionFile] <String> [-Force]
...
### ByResourceId
```
Set-AzDataFactoryV2LinkedService [-DefinitionFile] <String> [-Force] [-ResourceId] <String>
