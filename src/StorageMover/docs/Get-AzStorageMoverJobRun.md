...
online version: https://docs.microsoft.com/powershell/module/az.storagemover/get-azstoragemoverjobrun
schema: 2.0.0
---
...
```powershell
Get-AzStorageMoverJobRun -JobDefinitionName myJobDefinitionName -ResourceGroupName myResourceGroupName -StorageMoverName myStorageMoverName -ProjectName myProjectName
```
...
```powershell
Get-AzStorageMoverJobRun -Name myJobRunName -JobDefinitionName myJobDefinitionName -ResourceGroupName myResourceGroupName -StorageMoverName myStorageMoverName -ProjectName myProjectName
```
