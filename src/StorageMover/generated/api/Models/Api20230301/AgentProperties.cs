...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301
{
    ...
    public partial class AgentProperties :
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentProperties,
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesErrorDetails _errorDetail;

        [Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesErrorDetails ErrorDetail { get => (this._errorDetail = this._errorDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.AgentPropertiesErrorDetails()); }
        ...
        public string ErrorDetailCode { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesErrorDetailsInternal)ErrorDetail).Code; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesErrorDetailsInternal)ErrorDetail).Code = value ?? null; }

        /// <summary>Expanded description of reported error code</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.PropertyOrigin.Inlined)]
        public string ErrorDetailMessage { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesErrorDetailsInternal)ErrorDetail).Message; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesErrorDetailsInternal)ErrorDetail).Message = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Support.AgentStatus? Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesInternal.AgentStatus { get => this._agentStatus; set { {_agentStatus = value;} } }

        /// <summary>Internal Acessors for AgentVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesInternal.AgentVersion { get => this._agentVersion; set { {_agentVersion = value;} } }

        /// <summary>Internal Acessors for ErrorDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesErrorDetails Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesInternal.ErrorDetail { get => (this._errorDetail = this._errorDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.AgentPropertiesErrorDetails()); set { {_errorDetail = value;} } }

        /// <summary>Internal Acessors for LastStatusUpdate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesInternal.LastStatusUpdate { get => this._lastStatusUpdate; set { {_lastStatusUpdate = value;} } }

        /// <summary>Internal Acessors for LocalIPAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesInternal.LocalIPAddress { get => this._localIPAddress; set { {_localIPAddress = value;} } }

        /// <summary>Internal Acessors for MemoryInMb</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesInternal.MemoryInMb { get => this._memoryInMb; set { {_memoryInMb = value;} } }

        /// <summary>Internal Acessors for NumberOfCore</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesInternal.NumberOfCore { get => this._numberOfCore; set { {_numberOfCore = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for UptimeInSecond</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesInternal.UptimeInSecond { get => this._uptimeInSecond; set { {_uptimeInSecond = value;} } }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230301.IAgentPropertiesErrorDetails ErrorDetail { get; set; }
        /// <summary>Error code reported by Agent</summary>
        string ErrorDetailCode { get; set; }
        /// <summary>Expanded description of reported error code</summary>
        string ErrorDetailMessage { get; set; }
