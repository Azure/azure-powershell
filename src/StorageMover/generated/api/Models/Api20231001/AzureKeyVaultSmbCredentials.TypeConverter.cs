...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20231001
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="AzureKeyVaultSmbCredentials" />
    /// </summary>
    public partial class AzureKeyVaultSmbCredentialsTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <paramref name="sourceValue"/> parameter to the <see cref="AzureKeyVaultSmbCredentials"/>
        /// type.
        /// </summary>
        /// <param name="sourceValue">the <see cref="System.Object" /> instance to check if it can be converted to the <see cref="AzureKeyVaultSmbCredentials"
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="AzureKeyVaultSmbCredentials" /> type, otherwise <c>false</c>
        /// </returns>
        ...
        /// <returns>
        /// an instance of <see cref="AzureKeyVaultSmbCredentials" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public override object ConvertFrom(object sourceValue, global::System.Type destinationType, global::System.IFormatProvider formatProvider, bool ignoreCase) => ConvertFrom(sourceValue);

        /// <summary>
        /// Converts the <paramref name="sourceValue" /> parameter into an instance of <see cref="AzureKeyVaultSmbCredentials" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="AzureKeyVaultSmbCredentials" />.</param>
        /// <returns>
        /// an instance of <see cref="AzureKeyVaultSmbCredentials" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20231001.IAzureKeyVaultSmbCredentials ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                return AzureKeyVaultSmbCredentials.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());;
            }
            catch
            {
            ...
            if (typeof(global::System.Management.Automation.PSObject).IsAssignableFrom(type))
            {
                return AzureKeyVaultSmbCredentials.DeserializeFromPSObject(sourceValue);
            }
            if (typeof(global::System.Collections.IDictionary).IsAssignableFrom(type))
            {
                return AzureKeyVaultSmbCredentials.DeserializeFromDictionary(sourceValue);
            }
            return null;
        }
