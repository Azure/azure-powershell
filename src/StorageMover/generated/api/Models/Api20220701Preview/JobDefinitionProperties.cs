...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20220701Preview
{
    ...
    public partial class JobDefinitionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20220701Preview.IJobDefinitionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20220701Preview.IJobDefinitionPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20220701Preview.IJobDefinitionPropertiesInternal.AgentResourceId { get => this._agentResourceId; set { {_agentResourceId = value;} } }

        /// <summary>Internal Acessors for LatestJobRunName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20220701Preview.IJobDefinitionPropertiesInternal.LatestJobRunName { get => this._latestJobRunName; set { {_latestJobRunName = value;} } }

        /// <summary>Internal Acessors for LatestJobRunResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20220701Preview.IJobDefinitionPropertiesInternal.LatestJobRunResourceId { get => this._latestJobRunResourceId; set { {_latestJobRunResourceId = value;} } }

        /// <summary>Internal Acessors for LatestJobRunStatus</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Support.JobRunStatus? Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20220701Preview.IJobDefinitionPropertiesInternal.LatestJobRunStatus { get => this._latestJobRunStatus; set { {_latestJobRunStatus = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20220701Preview.IJobDefinitionPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for SourceResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20220701Preview.IJobDefinitionPropertiesInternal.SourceResourceId { get => this._sourceResourceId; set { {_sourceResourceId = value;} } }

        /// <summary>Internal Acessors for TargetResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20220701Preview.IJobDefinitionPropertiesInternal.TargetResourceId { get => this._targetResourceId; set { {_targetResourceId = value;} } }
