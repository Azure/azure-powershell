...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230701Preview
{
    ...
    public partial class AzureKeyVaultSmbCredentials :
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230701Preview.IAzureKeyVaultSmbCredentials,
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230701Preview.IAzureKeyVaultSmbCredentialsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230701Preview.ICredentials"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230701Preview.ICredentials __credentials = new Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230701Preview.Credentials();

        /// <summary>Internal Acessors for Type</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230701Preview.ICredentialsInternal.Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230701Preview.ICredentialsInternal)__credentials).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230701Preview.ICredentialsInternal)__credentials).Type = value; }
        ...
        public string Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230701Preview.ICredentialsInternal)__credentials).Type; }
    ...
    public partial interface IAzureKeyVaultSmbCredentials :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230701Preview.ICredentials
    {
        /// <summary>
        /// The Azure Key Vault secret URI which stores the password. Use empty string to clean-up existing value.
        /// </summary>
    ...
    internal partial interface IAzureKeyVaultSmbCredentialsInternal :
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20230701Preview.ICredentialsInternal
    {
        /// <summary>
        /// The Azure Key Vault secret URI which stores the password. Use empty string to clean-up existing value.
        /// </summary>
