...
function Remove-AzStorageMover {
    ...
    process {
        Write-Warning("Deleting a storage mover will cascade delete all contained resources. This will stop all ongoing migrations and break all trust relationships with registered agents.")
        if ($PSCmdlet.ShouldProcess("Call remote \'StorageMoversDelete\' operation\") -and ($Force -or $PSCmdlet.ShouldContinue("Delete this storage mover and all its contained resources?", "Confirm")))
        {
            if ($PSBoundParameters.ContainsKey("Force")) {
                $null = $PSBoundParameters.Remove("Force")
            }
             Az.StorageMover.internal\Remove-AzStorageMover @PSBoundParameters
        }
    }
}