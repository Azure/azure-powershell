...
function New-AzStorageMoverMultiCloudConnectorEndpoint {
    ...
    param(
        ...
        [Parameter(Mandatory, HelpMessage="The Azure Resource ID of the multi-cloud connector.")]
        [string]
        ${MultiCloudConnectorId},

        [Parameter(ParameterSetName = 'CreateExpanded')]
        [Parameter(Mandatory, HelpMessage="The Azure Resource ID of the AWS S3 bucket listed in the multi cloud connector.")]
        [string]
        ${AWSS3BucketId},
    ...
    process {
        ...
        if ($PSBoundParameters.ContainsKey('MultiCloudConnectorId')) {
            ...
            $null = $PSBoundParameters.Remove("MultiCloudConnectorId")
        }
        if ($PSBoundParameters.ContainsKey('AWSS3BucketId')) {
            $Properties.AwsS3BucketId = $AwsS3BucketId
            $null = $PSBoundParameters.Remove("AWSS3BucketId")
        }
