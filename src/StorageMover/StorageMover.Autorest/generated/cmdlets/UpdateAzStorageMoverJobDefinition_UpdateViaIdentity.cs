...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzStorageMoverJobDefinition_UpdateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzStorageMoverJobDefinition_UpdateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20240701.IJobDefinitionUpdateParameters _jobDefinition;

        /// <summary>The Job Definition resource.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The Job Definition resource.", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20240701.IJobDefinitionUpdateParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20240701.IJobDefinitionUpdateParameters JobDefinition { get => this._jobDefinition; set => this._jobDefinition = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.JobDefinitionsUpdateViaIdentity(InputObject.Id, JobDefinition, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.JobDefinitionsUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.StorageMoverName ?? null, InputObject.ProjectName ?? null, InputObject.JobDefinitionName ?? null, JobDefinition, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=JobDefinition})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzStorageMoverJobDefinition_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzStorageMoverJobDefinition_UpdateViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=JobDefinition })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=JobDefinition })
                    {
