...
## SYNOPSIS
Updates properties for an S3WithHMAC endpoint resource.
...
Update-AzStorageMoverS3WithHmacEndpoint -Name <String> -ResourceGroupName <String>
 ...
 [-CredentialsSecretKeyUri <String>] [-Description <String>] [-DefaultProfile <PSObject>] [-Confirm]
...
### Example 1: Update an S3WithHMAC endpoint
```powershell
Update-AzStorageMoverS3WithHmacEndpoint -Name "myS3Endpoint" -ResourceGroupName "myResourceGroup" -StorageMoverName "myStorageMover" -CredentialsAccessKeyUri "https://myKeyVault.vault.azure.net/secrets/accessKey2" -CredentialsSecretKeyUri "https://myKeyVault.vault.azure.net/secrets/secretKey2" -Description "Updated S3 endpoint"
```
...
Property                     : {
                                 ...
                                 "credentials": {
                                   ...
                                   "accessKeyUri": "https://myKeyVault.vault.azure.net/secrets/accessKey2",
                                   "secretKeyUri": "https://myKeyVault.vault.azure.net/secrets/secretKey2"
                                 },
...
This command updates the credentials and description of an S3WithHMAC endpoint.
