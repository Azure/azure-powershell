...
online version: https://learn.microsoft.com/powershell/module/az.storagemover/update-azstoragemovermulticloudconnectorendpoint
schema: 2.0.0
---
...
```
Update-AzStorageMoverMultiCloudConnectorEndpoint -Name <String> -ResourceGroupName <String>
...
```
Update-AzStorageMoverMultiCloudConnectorEndpoint -InputObject <IStorageMoverIdentity> [-Description <String>]
