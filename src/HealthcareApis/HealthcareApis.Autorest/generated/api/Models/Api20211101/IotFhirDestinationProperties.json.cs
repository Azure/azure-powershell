...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.Api20211101
{
    ...
    public partial class IotFhirDestinationProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.Api20211101.IIotFhirDestinationProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.Api20211101.IIotFhirDestinationProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.Api20211101.IIotFhirDestinationProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNode node)
        {
        ...
        internal IotFhirDestinationProperties(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonObject json)
        {
            ...
            __iotDestinationProperties = new Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.Api20211101.IotDestinationProperties(json);
            {_fhirMapping = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonObject>("fhirMapping"), out var __jsonFhirMapping) ? Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.Api20211101.IotMappingProperties.FromJson(__jsonFhirMapping) : FhirMapping;}
            {_resourceIdentityResolutionType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonString>("resourceIdentityResolutionType"), out var __jsonResourceIdentityResolutionType) ? (string)__jsonResourceIdentityResolutionType : (string)ResourceIdentityResolutionType;}
            {_fhirServiceResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonString>("fhirServiceResourceId"), out var __jsonFhirServiceResourceId) ? (string)__jsonFhirServiceResourceId : (string)FhirServiceResourceId;}
            AfterFromJson(json);
        }
