...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.Api20211101
{
    ...
    public partial class IotEventHubIngestionEndpointConfiguration
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.Api20211101.IIotEventHubIngestionEndpointConfiguration.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.Api20211101.IIotEventHubIngestionEndpointConfiguration.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.Api20211101.IIotEventHubIngestionEndpointConfiguration FromJson(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNode node)
        {
        ...
        internal IotEventHubIngestionEndpointConfiguration(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonObject json)
        {
            ...
            {_eventHubName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonString>("eventHubName"), out var __jsonEventHubName) ? (string)__jsonEventHubName : (string)EventHubName;}
            {_consumerGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonString>("consumerGroup"), out var __jsonConsumerGroup) ? (string)__jsonConsumerGroup : (string)ConsumerGroup;}
            {_fullyQualifiedEventHubNamespace = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonString>("fullyQualifiedEventHubNamespace"), out var __jsonFullyQualifiedEventHubNamespace) ? (string)__jsonFullyQualifiedEventHubNamespace : (string)FullyQualifiedEventHubNamespace;}
            AfterFromJson(json);
        }
