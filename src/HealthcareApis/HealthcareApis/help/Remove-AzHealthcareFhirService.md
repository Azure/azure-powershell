...
online version: https://learn.microsoft.com/powershell/module/az.healthcareapis/remove-azhealthcarefhirservice
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzHealthcareFhirService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
