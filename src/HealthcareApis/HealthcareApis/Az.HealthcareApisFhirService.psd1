...
For more information on Hea, please visit the following: https://docs.microsoft.com/azure/azure-maps/'
...
NestedModules = @('.\Microsoft.Azure.PowerShell.Cmdlets.HealthcareApisFhirService.dll')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = @()

# Cmdlets to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no cmdlets to export.
CmdletsToExport = 'New-AzRmHealthcareApisFhirService', 'Remove-AzHealthcareApisFhirService', 'Set-AzHealthcareApisAccountFhirService', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Azure','ResourceManager','ARM','HealthcareApis','FhirService'
