...
namespace Microsoft.Azure.Management.NetApp.Models
{
    ...
    public partial class BackupsUnderVolumeMigrateBackupsHeaders
    {
        /// <summary>
        ...
        /// </param>
        public BackupsUnderVolumeMigrateBackupsHeaders(string location = default(string), int? retryAfter = default(int?))
