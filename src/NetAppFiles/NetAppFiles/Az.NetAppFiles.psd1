...
RequiredAssemblies = 'Microsoft.Azure.Management.NetApp.dll','Microsoft.Azure.PowerShell.NetAppFiles.Management.Sdk.dll'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added cmdlet ''New/Remove/Get/Update-AzNetAppFilesSubvolume'' and ''Get-AzNetAppFilesSubvolumeMetadata''
