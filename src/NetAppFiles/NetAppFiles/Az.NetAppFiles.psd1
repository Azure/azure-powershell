...
CmdletsToExport = 'Get-AzNetAppFilesAccount', 'New-AzNetAppFilesAccount', 
               ...
               'Update-AzNetAppFilesAccountCredential', 'New-AzNetAppFilesPool', 
               'Update-AzNetAppFilesPool', 'Set-AzNetAppFilesPool', 
               ...
               'Get-AzNetAppFilesQuotaLimit', 'New-AzNetAppFilesSubvolume', 
               'Get-AzNetAppFilesSubvolume', 'Get-AzNetAppFilesSubvolumeMetadata', 
               'Update-AzNetAppFilesSubvolume', 'Remove-AzNetAppFilesSubvolume', 
...
AliasesToExport = 'Get-AnfAccount', 'New-AnfAccount', 'Remove-AnfAccount', 
               ...
               'Get-AnfPool', 'New-AnfPool', 'Set-AnfPool', 'Update-AnfPool', 
               'Remove-AnfPool', 'Get-AnfVolume', 'New-AnfVolume', 'Remove-AnfVolume', 
               'Update-AnfVolume', 'Get-AnfSnapshot', 'New-AnfSnapshot', 
               'Remove-AnfSnapshot', 'Restore-AnfSnapshotFile', 
               ...
               'Unlock-AnfVolumeFileLock', 'Get-AnfSnapshotPolicy', 
               'New-AnfSnapshotPolicy', 'Set-AnfSnapshotPolicy', 
               ...
               'Restore-AnfBackupFile', 'Get-AnfActiveDirectory', 
               'New-AnfActiveDirectory', 'Remove-AnfActiveDirectory', 
               'Update-AnfActiveDirectory', 'Get-AnfQuotaLimit', 'Get-AnfSubvolume', 
               'Get-AnfSubvolumeMetadata', 'New-AnfSubvolume', 'Set-AnfSubvolume', 
               'Remove-AnfSubvolume', 'Update-AnfSubvolume', 'Get-AnfVolumeGroup', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated Azure.Core to 1.34.0.'
