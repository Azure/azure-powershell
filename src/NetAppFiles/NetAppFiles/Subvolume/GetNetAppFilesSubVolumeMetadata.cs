...
namespace Microsoft.Azure.Commands.NetAppFiles.Volume
{
    [Cmdlet(
        "Get",
        ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "NetAppFilesSubvolumeMetadata",
        DefaultParameterSetName = FieldsParameterSet), OutputType(typeof(PSNetAppFilesVolume))]
    [Alias("Get-AnfSubvolume")]
    public class QueryAzureRmNetAppFilesSubvolume : AzureNetAppFilesCmdletBase
    {
        [Parameter(
            Mandatory = true,
        ...
        [Parameter(
            ...
            HelpMessage = "The volume object containing the Subvolume Metadata to return")]
        [ValidateNotNullOrEmpty]
