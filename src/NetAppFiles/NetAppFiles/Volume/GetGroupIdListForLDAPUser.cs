...
namespace Microsoft.Azure.Commands.NetAppFiles.Volume
{
    [Cmdlet(
        "Get",
        ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "NetAppFilesVolumeGroupIdListForLDAPUser",
        DefaultParameterSetName = FieldsParameterSet), OutputType(typeof(PSNetAppFilesVolumeBackupStatus))]
    [Alias("Get-AnfVolumeGroupIdListForLDAPUser")]
    public class GetAzureRmNetAppFilesVolumeGroupIdListForLDAPUser: AzureNetAppFilesCmdletBase
    {
        [Parameter(
            Mandatory = true,
        ...
        [Parameter(
            ParameterSetName = FieldsParameterSet,
            Mandatory = true,
            HelpMessage = "Username is required to fetch the group to which user is part of")]
        [ValidateNotNullOrEmpty]
        ...
        [Parameter(
            ...
            HelpMessage = "The pool object containing the volume to return LDAPUser GroupIdList for")]
        [ValidateNotNullOrEmpty]
        ...
        [Parameter(
            ...
            Mandatory = true,
            ValueFromPipeline = true,
            HelpMessage = "The volume object to get to return LDAPUser GroupIdList for")]
        [ValidateNotNullOrEmpty]
