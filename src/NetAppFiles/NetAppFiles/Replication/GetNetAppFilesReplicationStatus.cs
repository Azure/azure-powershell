...
namespace Microsoft.Azure.Commands.NetAppFiles.Replication
{
    [Cmdlet(
        "Get",
        ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "NetAppFilesReplicationStatus",
        DefaultParameterSetName = FieldsParameterSet), OutputType(typeof(PSNetAppFilesReplicationStatus))]
    [Alias("Get-AnfReplicationStatus")]
    public class GetAzureRmNetAppFilesReplicationStatus : AzureNetAppFilesCmdletBase
    {
        [Parameter(
            Mandatory = true,
        ...
        [Parameter(
            Mandatory = true,
            ParameterSetName = FieldsParameterSet,
            HelpMessage = "The name of the ANF account of the replication destination volume")]
        [ValidateNotNullOrEmpty]
        ...
        [Parameter(
            Mandatory = true,
            ParameterSetName = FieldsParameterSet,
            HelpMessage = "The name of the ANF pool of the replication destination volume")]
        [ValidateNotNullOrEmpty]
        [ResourceNameCompleter(
