...
namespace Microsoft.Azure.Commands.NetAppFiles.Replication
{
    ...
    [Alias("Resume-AnfReplication")]
    public class ResyncAzureRmNetAppFilesReplication : AzureNetAppFilesCmdletBase
    {
        [Parameter(
            Mandatory = true,
        ...
        [Parameter(
            ...
            HelpMessage = "The ANF replication destination volume object to resync")]
        [ValidateNotNullOrEmpty]
        public PSNetAppFilesVolume InputObject { get; set; }

        [Parameter(
            Mandatory = false,
            HelpMessage = "Return whether resync of the specified replication volume was performed")]
