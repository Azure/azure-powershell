...
namespace Microsoft.Azure.Commands.NetAppFiles.Replication
{
    ...
    [Alias("Restore-AnfReplication")]
    public class ReestablishAzureRmNetAppFilesReplication : AzureNetAppFilesCmdletBase
    {
        [Parameter(
            Mandatory = true,
        ...
        [Parameter(
            Mandatory = true,
            HelpMessage = "Resource id of the source volume for the replication")]
        [ValidateNotNullOrEmpty]
        ...
        [Parameter(
            ...
            HelpMessage = "The ANF replication destination volume object to restore/reestablish replication")]
        [ValidateNotNullOrEmpty]
        public PSNetAppFilesVolume InputObject { get; set; }

        [Parameter(
            Mandatory = false,
            HelpMessage = "Return whether Reestablish of the specified replication volume was performed")]
