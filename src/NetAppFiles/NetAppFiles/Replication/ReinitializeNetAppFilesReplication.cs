...
namespace Microsoft.Azure.Commands.NetAppFiles.Replication
{
    ...
    public class ReinitializeAzureRmNetAppFilesReplication : AzureNetAppFilesCmdletBase
    {
        ...
        [Parameter(
            ...
            HelpMessage = "The ANF replication destination volume object to reinitialize")]
        [ValidateNotNullOrEmpty]
        public PSNetAppFilesVolume InputObject { get; set; }

        [Parameter(
            Mandatory = false,
            HelpMessage = "Return whether reinitialization of the specified replication volume was performed")]
