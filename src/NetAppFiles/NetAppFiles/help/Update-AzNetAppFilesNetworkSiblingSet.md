...
Update-AzNetAppFilesNetworkSiblingSet -Location <String> -SubnetId <String> -NetworkSiblingSetId <String>
 -NetworkSiblingSetStateId <String> -NetworkFeatures <String> [-DefaultProfile <IAzureContextContainer>]
...
PS C:\> Update-AzNetAppFilesNetworkSiblingSet -Location $resourceLocation -NetworkSiblingSetId $retrievedVolume.NetworkSiblingSetId -SubnetId $subnetId -NetworkSiblingSetStateId $networkSiblingSet.NetworkSiblingSetStateId -NetworkFeatures "Standard"
```
