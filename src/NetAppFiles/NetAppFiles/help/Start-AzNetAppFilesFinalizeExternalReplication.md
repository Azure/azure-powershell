...
```
Start-AzNetAppFilesFinalizeExternalReplication -ResourceGroupName <String> -AccountName <String>
...
```
Start-AzNetAppFilesFinalizeExternalReplication -ResourceId <String> [-PassThru]
...
```
Start-AzNetAppFilesFinalizeExternalReplication -InputObject <PSNetAppFilesVolume> [-PassThru]
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Finalizes the migration of an external volume to "MyDestinationAnfVolume"
