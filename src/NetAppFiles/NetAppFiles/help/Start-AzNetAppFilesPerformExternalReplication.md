...
online version: https://learn.microsoft.com/powershell/module/az.netappfiles/start-aznetappfilesperformexternalreplication
schema: 2.0.0
---
...
```
Start-AzNetAppFilesPerformExternalReplication -ResourceGroupName <String> -AccountName <String>
...
```
Start-AzNetAppFilesPerformExternalReplication -ResourceId <String> [-PassThru]
...
```
Start-AzNetAppFilesPerformExternalReplication -InputObject <PSNetAppFilesVolume> [-PassThru]
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### Example 1
```powershell
Start-AzNetAppFilesPerformExternalReplication -ResourceGroupName "MyRG" -AccountName "MyAnfAccount" -PoolName "MyAnfPool" -VolumeName "MyDestinationAnfVolume"
```

Performs an adhoc replication transfer on ANF volume "MyDestinationAnfVolume"
