...
Test Volume CRUD operations
#>
function Test-OracleVolumeGroupCrud
{	
    $currentSub = (Get-AzureRmContext).Subscription
    $subsid = $currentSub.SubscriptionId
...
Test Volume CRUD operations
#>
function Test-OracleVolumeGroupDRCrud
{	
    $currentSub = (Get-AzureRmContext).Subscription
    $subsid = $currentSub.SubscriptionId
...
Test Volume CRUD operations
#>
function Test-OracleVolumeGroupToManyVolumes
{	
    $currentSub = (Get-AzureRmContext).Subscription
    $subsid = $currentSub.SubscriptionId
