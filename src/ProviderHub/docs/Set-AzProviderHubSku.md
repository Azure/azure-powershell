...
online version: https://docs.microsoft.com/en-us/powershell/module/az.providerhub/set-azproviderhubsku
schema: 2.0.0
---

# Set-AzProviderHubSku
...
### Update (Default)
```
Set-AzProviderHubSku -ProviderNamespace <String> -ResourceType <String> -Sku <String>
