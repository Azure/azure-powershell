...
online version: https://docs.microsoft.com/en-us/powershell/module/az.providerhub/set-azproviderhubskunestedresourcetypethird
schema: 2.0.0
---
...
### Update (Default)
```
Set-AzProviderHubSkuNestedResourceTypeThird -NestedResourceTypeFirst <String>
