...
### CreateViaIdentity
```
New-AzProviderHubResourceTypeRegistration -InputObject <IProviderHubIdentity>
 -Property <IResourceTypeRegistration> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
