...
# Get-AzProviderHubSkuNestedResourceTypeFirst
...
### Get (Default)
```
Get-AzProviderHubSkuNestedResourceTypeFirst -NestedResourceTypeFirst <String> -ProviderNamespace <String>
 -ResourceType <String> -Sku <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
