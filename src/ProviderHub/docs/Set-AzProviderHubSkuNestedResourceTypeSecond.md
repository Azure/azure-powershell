...
online version: https://docs.microsoft.com/en-us/powershell/module/az.providerhub/set-azproviderhubskunestedresourcetypesecond
schema: 2.0.0
---

# Set-AzProviderHubSkuNestedResourceTypeSecond
...
### Update (Default)
```
Set-AzProviderHubSkuNestedResourceTypeSecond -NestedResourceTypeFirst <String>
