...
- `build-module.ps1`
  - Builds the module DLL (`./bin/ProviderHub.private.dll`), creates the exported cmdlets and documentation, generates custom cmdlet test stubs and exported cmdlet example stubs, and updates `./Az.ProviderHub.psd1` with Azure profile information.
