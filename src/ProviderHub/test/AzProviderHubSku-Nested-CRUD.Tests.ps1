...
Describe 'AzProviderHubSku-NestedResourceType-CRUD' {
    It 'Create, get, and delete a nested resource type registration' {
        # New-AzProviderHubSku -ProviderNamespace "microsoft.contoso" -ResourceType "employees/nestedresourcetype" -Sku "default" -SkuSetting @{Name = "freeSku"; Tier = "Tier1"; Kind = "Standard"; Capacity = @{Minimum = 1; Maximum = 1; Default = 1; ScaleType = None }}
        ...
        $resourceTypeSku = New-AzProviderHubSku -ProviderNamespace "microsoft.contoso" -ResourceType "employees/nestedresourcetype" -Sku "default" -SkuSetting $skuSetting1, $skuSetting2
        ...
        $resourceTypeSku = Remove-AzProviderHubSku -ProviderNamespace "Microsoft.Contoso" -ResourceType "employees/nestedresourcetype" -Sku "default"
