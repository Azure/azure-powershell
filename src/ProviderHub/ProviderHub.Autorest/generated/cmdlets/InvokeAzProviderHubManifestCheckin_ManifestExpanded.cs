...
namespace Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.IEventListener
    {
        ...
        public string BaselineArmManifestLocation { get => CheckinManifestParamsBody.BaselineArmManifestLocation ?? null; set => CheckinManifestParamsBody.BaselineArmManifestLocation = value; }
        ...
        /// <summary>Backing field for <see cref="CheckinManifestParamsBody" /> property.</summary>
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.Api20201120.ICheckinManifestParams CheckinManifestParamsBody { get => this._checkinManifestParamsBody; set => this._checkinManifestParamsBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Environment { get => CheckinManifestParamsBody.Environment ?? null; set => CheckinManifestParamsBody.Environment = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CheckinManifest(SubscriptionId, ProviderNamespace, CheckinManifestParamsBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ProviderNamespace=ProviderNamespace,body=CheckinManifestParamsBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.Api20201120.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ProviderNamespace=ProviderNamespace, body=CheckinManifestParamsBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ProviderNamespace=ProviderNamespace, body=CheckinManifestParamsBody })
                    {
