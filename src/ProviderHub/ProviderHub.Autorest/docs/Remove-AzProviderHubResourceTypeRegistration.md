...
```
Remove-AzProviderHubResourceTypeRegistration -ProviderRegistrationInputObject <IProviderHubIdentity>
 -ResourceType <String> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
