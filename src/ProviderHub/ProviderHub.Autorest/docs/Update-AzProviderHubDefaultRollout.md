...
```
Update-AzProviderHubDefaultRollout -ProviderNamespace <String> -RolloutName <String>
 [-SubscriptionId <String>] [-ProvisioningState <String>] [-SpecificationCanaryRegion <String[]>]
...
```
Update-AzProviderHubDefaultRollout -ProviderRegistrationInputObject <IProviderHubIdentity>
