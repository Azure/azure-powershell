...
```
Remove-AzProviderHubDefaultRollout -ProviderRegistrationInputObject <IProviderHubIdentity>
 -RolloutName <String> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
