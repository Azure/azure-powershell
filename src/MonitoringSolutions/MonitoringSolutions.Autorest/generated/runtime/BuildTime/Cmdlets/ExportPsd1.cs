...
using static Microsoft.Azure.PowerShell.Cmdlets.MonitoringSolutions.Runtime.PowerShell.PsHelpers;
  ...
  public class ExportPsd1 : PSCmdlet
  {
    ...
    protected override void ProcessRecord()
    {
      try
      {
        ...
        sb.AppendLine($@"{Indent}RootModule = '{"./Az.MonitoringSolutions.psm1"}'");
        ...
        sb.AppendLine($@"{Indent}Description = '{"Microsoft Azure PowerShell: MonitoringSolutions cmdlets"}'");
        sb.AppendLine($@"{Indent}PowerShellVersion = '5.1'");
        sb.AppendLine($@"{Indent}DotNetFrameworkVersion = '4.7.2'");
        sb.AppendLine($@"{Indent}RequiredAssemblies = '{"./bin/Az.MonitoringSolutions.private.dll"}'");
        ...
        var formatList = customFormatPs1xmlFiles.Prepend("./Az.MonitoringSolutions.format.ps1xml").ToPsList();
        ...
        sb.AppendLine($@"{Indent}{Indent}{Indent}Tags = {"Azure ResourceManager ARM PSModule MonitoringSolutions".Split(' ').ToPsList().NullIfEmpty() ?? "''"}");
