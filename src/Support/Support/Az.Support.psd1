...
CmdletsToExport = 'Get-AzSupportProblemClassification', 'Get-AzSupportService', 
               'Get-AzSupportTicket', 'Get-AzSupportTicketCommunication', 
               'New-AzSupportContactProfileObject', 'New-AzSupportTicket', 
               'New-AzSupportTicketCommunication', 'Update-AzSupportTicket'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added breaking change warning messages for cmdlet deprecation
