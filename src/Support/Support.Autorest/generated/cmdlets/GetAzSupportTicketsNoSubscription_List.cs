...
namespace Microsoft.Azure.PowerShell.Cmdlets.Support.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List=>GET:"/providers/Microsoft.Support/supportTickets"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Support.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzSupportTicketsNoSubscription_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Support.Description(@"Lists all the support tickets. <br/><br/>You can also filter the support tickets by <i>Status</i>, <i>CreatedDate</i>, , <i>ServiceId</i>, and <i>ProblemClassificationId</i> using the $filter parameter. Output will be a paged result with <i>nextLink</i>, using which you can retrieve the next set of support tickets. <br/><br/>Support ticket data is available for 18 months after ticket creation. If a ticket was created more than 18 months ago, a request for data might cause an error.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Support.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Support.HttpPath(Path = "/providers/Microsoft.Support/supportTickets", ApiVersion = "2024-04-01")]
    public partial class GetAzSupportTicketsNoSubscription_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.IContext
    {
        ...
        /// more</a> <br/><i>Status</i> , <i>ServiceId</i>, and <i>ProblemClassificationId</i> filters can only be used with 'eq'
        /// operator. For <i>CreatedDate</i> filter, the supported operators are 'gt' and 'ge'. When using both filters, combine them
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzSupportTicketsNoSubscription_List" /> cmdlet class.
        /// </summary>
        public GetAzSupportTicketsNoSubscription_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SupportTicketsNoSubscriptionList(this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink) && this._top <= 0)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.SupportTicketsNoSubscriptionList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
