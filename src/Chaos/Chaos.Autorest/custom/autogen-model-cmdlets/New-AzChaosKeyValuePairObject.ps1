...
function New-AzChaosKeyValuePairObject {
    ...
    Param(
        ...
        [Parameter(Mandatory, HelpMessage="The name of the setting for the action.")]
        [string]
        $Key,
        [Parameter(Mandatory, HelpMessage="The value of the setting for the action.")]
        [string]
        $Value
    )

    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.KeyValuePair]::New()
