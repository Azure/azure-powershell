...
online version: https://learn.microsoft.com/powershell/module/az.chaos/update-azchaostarget
schema: 2.0.0
---
...
```
Update-AzChaosTarget -Name <String> -ParentProviderNamespace <String> -ParentResourceName <String>
...
```
Update-AzChaosTarget -InputObject <IChaosIdentity> [-Location <String>] [-Property <Hashtable>]
