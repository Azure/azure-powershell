...
online version: https://learn.microsoft.com/powershell/module/az.chaos/new-azchaosworkspace
schema: 2.0.0
---

# New-AzChaosWorkspace
...
```
New-AzChaosWorkspace -Name <String> -ResourceGroupName <String> -Location <String> -Scope <String[]>
...
```
New-AzChaosWorkspace -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### CreateViaJsonString
```
New-AzChaosWorkspace -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Always supply an identity: if the service accepts a workspace create request without one, it can fail asynchronously with `IdentityUrl cannot be null or empty` instead of returning a clean validation error.
Use `Initialize-AzChaosWorkspace` when you want the setup path that creates the workspace with a system-assigned identity for you.
