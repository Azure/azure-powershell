...
Use the expanded parameter set when you want PowerShell to build the request body for you; `-Action` and `-Description` are required for this form.
...
Use `-JsonFilePath` when the full scenario body, including its description and actions, already exists in a file.
