...
Pass `-ScenarioId` so the configuration explicitly references the scenario resource it configures.
...
Use filters and exclusions when the workspace scope is broader than the resources this configuration should affect.
