...
namespace Microsoft.Azure.Management.ContainerService.Models
{
    ...
    public partial class Identity
    {
        ...
        public Identity(string principalId = default(string), string tenantId = default(string), ResourceIdentityTypeForCommonTypes? type = default(ResourceIdentityTypeForCommonTypes?))
        {
        ...
        public ResourceIdentityTypeForCommonTypes? Type { get; set; }
