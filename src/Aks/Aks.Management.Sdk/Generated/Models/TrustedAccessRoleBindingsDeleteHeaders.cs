...
namespace Microsoft.Azure.Management.ContainerService.Models
{
    ...
    public partial class TrustedAccessRoleBindingsDeleteHeaders
    {
        /// <summary>
        ...
        /// </param>
        public TrustedAccessRoleBindingsDeleteHeaders(string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?))
