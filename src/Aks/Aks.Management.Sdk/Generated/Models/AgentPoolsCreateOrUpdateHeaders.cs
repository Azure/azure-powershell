...
namespace Microsoft.Azure.Management.ContainerService.Models
{
    ...
    public partial class AgentPoolsCreateOrUpdateHeaders
    {
        /// <summary>
        ...
        /// </param>
        public AgentPoolsCreateOrUpdateHeaders(string azureAsyncOperation = default(string), int? retryAfter = default(int?))
