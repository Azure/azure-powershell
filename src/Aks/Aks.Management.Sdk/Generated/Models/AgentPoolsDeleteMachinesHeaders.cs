...
namespace Microsoft.Azure.Management.ContainerService.Models
{
    ...
    public partial class AgentPoolsDeleteMachinesHeaders
    {
        /// <summary>
        ...
        /// </param>
        public AgentPoolsDeleteMachinesHeaders(string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?))
