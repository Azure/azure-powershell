...
namespace Microsoft.Azure.Management.ContainerService.Models
{
    ...
    public partial class ManagedNamespacesDeleteHeaders
    {
        /// <summary>
        ...
        /// </param>
        public ManagedNamespacesDeleteHeaders(string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?))
