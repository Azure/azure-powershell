...
namespace Microsoft.Azure.PowerShell.Cmdlets.Aks.Cmdlets
{
    ...
    /// <remarks>
    ///     [OpenAPI]
    ///     ManagedClusters_List=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.ContainerService/managedClusters"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, @"AzAks_List")]
    [OutputType(typeof(IManagedCluster))]
    [Description(@"List Kubernetes managed clusters.")]
    [Generated]
    public partial class GetAzAks_List : KubeCmdletBase, IEventListener
    {
        ...
        /// <summary>Intializes a new instance of the <see cref="GetAzAks_List" /> cmdlet class.</summary>
        public GetAzAks_List()
        {
        }
        ...
        /// </param>
        partial void overrideOnOk(HttpResponseMessage responseMessage, Task<IManagedClusterListResult> response,
            ref Task<bool> returnNow);
            ...
            using (NoSynchronizationContext)
            {
                ...
                try
                {
                    foreach (var SubscriptionId in this.SubscriptionId)
                    {
                        ...
                        await Client.ManagedClustersList(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                catch (UndeclaredResponseException urexception)
                {
                    WriteError(new ErrorRecord(urexception, urexception.StatusCode.ToString(),
                        ErrorCategory.InvalidOperation, new {SubscriptionId = SubscriptionId})
                    {
        ...
        ///     completed.
        /// </returns>
        private async Task onOk(HttpResponseMessage responseMessage, Task<IManagedClusterListResult> response)
        {
            using (NoSynchronizationContext)
            {
                var _returnNow = Task.FromResult(false);
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is HttpRequestMessage requestMessage)
                    {
                        ...
                        await Client.ManagedClustersList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                    }
                }
            }
        }
