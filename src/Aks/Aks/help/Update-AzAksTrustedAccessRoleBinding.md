...
Module Name: Az.Aks
online version: https://learn.microsoft.com/powershell/module/az.aks/update-azakstrustedaccessrolebinding
schema: 2.0.0
---
...
```
Update-AzAksTrustedAccessRoleBinding -Name <String> -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String>] [-Role <String[]>] [-SourceResourceId <String>] [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAksTrustedAccessRoleBinding -InputObject <IAksIdentity> [-Role <String[]>]
 [-SourceResourceId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
