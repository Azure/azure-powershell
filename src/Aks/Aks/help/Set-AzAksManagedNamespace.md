...
Set-AzAksManagedNamespace -Name <String> -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String>] -Location <String> [-AdoptionPolicy <String>] [-Annotation <Hashtable>]
...
```
Set-AzAksManagedNamespace -Name <String> -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String>] -Parameter <IManagedNamespace> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
