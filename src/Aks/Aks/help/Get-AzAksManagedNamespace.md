...
```
Get-AzAksManagedNamespace -Name <String> -ManagedClusterInputObject <IAksIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-AzAksManagedNamespace -InputObject <IAksIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
