...
```
New-AzAksManagedNamespace -Name <String> -ManagedClusterInputObject <IAksIdentity> -Location <String>
 ...
 [-DefaultResourceQuotaMemoryRequest <String>] [-DeletePolicy <String>] [-Label <Hashtable>] [-Tag <Hashtable>]
...
```
New-AzAksManagedNamespace -Name <String> -ManagedClusterInputObject <IAksIdentity>
 -Parameter <IManagedNamespace> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded, CreateViaIdentityManagedClusterExpanded, CreateViaIdentityExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded, CreateViaJsonString, CreateViaJsonFilePath, CreateViaIdentityManagedClusterExpanded, CreateViaIdentityManagedCluster, Create
...
Parameter Sets: CreateViaIdentityManagedCluster, Create, CreateViaIdentity
Aliases:
