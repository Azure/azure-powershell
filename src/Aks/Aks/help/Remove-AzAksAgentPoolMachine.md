...
Remove-AzAksAgentPoolMachine -AgentPoolName <String> -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String>] -MachineName <String[]> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
Remove-AzAksAgentPoolMachine -AgentPoolName <String> -ManagedClusterInputObject <IAksIdentity>
 -MachineName <String[]> [-DefaultProfile <PSObject>] [-AsJob] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
...
```
Remove-AzAksAgentPoolMachine -AgentPoolName <String> -ManagedClusterInputObject <IAksIdentity>
 -Machine <IAgentPoolDeleteMachinesParameter> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-NoWait] [-PassThru]
 [-Proxy <Uri>] [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
Remove-AzAksAgentPoolMachine -AgentPoolName <String> -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String>] -Machine <IAgentPoolDeleteMachinesParameter> [-DefaultProfile <PSObject>] [-AsJob]
...
```yaml
Type: System.String
Parameter Sets: DeleteExpanded, DeleteViaJsonString, DeleteViaJsonFilePath, DeleteViaIdentityManagedClusterExpanded, DeleteViaIdentityManagedCluster, Delete
Aliases:
...
Parameter Sets: DeleteViaIdentityManagedCluster, Delete, DeleteViaIdentity
Aliases:
