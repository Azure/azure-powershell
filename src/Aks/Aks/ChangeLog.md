...
-->
## Upcoming Release
* Added support for new parameters `NetworkPolicy`, `PodCidr`, `ServiceCidr`, `DnsServiceIP`, `DockerBridgeCidr`, `NodePoolLabels`, `AksCustomHeader` in `New-AzAksCluster`. [#13795]
