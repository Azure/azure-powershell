...
FunctionsToExport = 'Get-AzAksMachine', 'Get-AzAksMaintenanceConfiguration', 
               ...
               'Get-AzAksManagedNamespace', 'Get-AzAksManagedNamespaceCredential', 
               ...
               'New-AzAksMaintenanceConfiguration', 'New-AzAksManagedNamespace', 
               'New-AzAksSnapshot', 'New-AzAksTimeInWeekObject', 
               'New-AzAksTimeSpanObject', 'New-AzAksTrustedAccessRoleBinding', 
               'Remove-AzAksAgentPoolMachine', 
               'Remove-AzAksMaintenanceConfiguration', 
               'Remove-AzAksManagedNamespace', 'Remove-AzAksSnapshot', 
               'Remove-AzAksTrustedAccessRoleBinding', 'Set-AzAksManagedNamespace', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Set ''useAADAuth'' to ''true'' by default in the omsagent addon profile when enabling the Monitoring addon via ''Enable-AzAksAddOn'' and ''New-AzAksCluster''
