...
### List (Default)
```
Get-AzAksAgentPool -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzAksAgentPool -Name <String> -ResourceGroupName <String> -ResourceName <String>
