...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerservice/update-azopenshiftmanagedclustertag
schema: 2.0.0
---

# Update-AzOpenShiftManagedClusterTag
...
```
Update-AzOpenShiftManagedClusterTag -ResourceGroupName <String> -ResourceName <String>
...
```
Update-AzOpenShiftManagedClusterTag -ResourceGroupName <String> -ResourceName <String>
 -SubscriptionId <String> -Parameter <ITagsObject> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-AzOpenShiftManagedClusterTag -InputObject <IContainerServiceIdentity> -Parameter <ITagsObject>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzOpenShiftManagedClusterTag -InputObject <IContainerServiceIdentity> [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/az.containerservice/update-azopenshiftmanagedclustertag
```
