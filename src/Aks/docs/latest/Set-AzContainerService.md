...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerservice/set-azcontainerservice
schema: 2.0.0
---

# Set-AzContainerService
...
```
Set-AzContainerService -Name <String> -ResourceGroupName <String> -SubscriptionId <String> -Location <String>
...
### Update
```
Set-AzContainerService -Name <String> -ResourceGroupName <String> -SubscriptionId <String>
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/az.containerservice/set-azcontainerservice
```
