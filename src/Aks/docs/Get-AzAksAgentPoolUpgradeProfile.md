...
### Get (Default)
```
Get-AzAksAgentPoolUpgradeProfile -AgentPoolName <String> -ResourceGroupName <String> -ResourceName <String>
...
### Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.Api20190801.IAgentPoolUpgradeProfile
