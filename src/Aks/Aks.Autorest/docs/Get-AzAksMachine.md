...
### GetViaIdentity
```
Get-AzAksMachine -InputObject <IAksIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityAgentPool
```
Get-AzAksMachine -AgentPoolInputObject <IAksIdentity> -Name <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentityManagedCluster
```
Get-AzAksMachine -AgentPoolName <String> -ManagedClusterInputObject <IAksIdentity> -Name <String>
...
```yaml
Type: System.String
Parameter Sets: Get, GetViaIdentityAgentPool, GetViaIdentityManagedCluster
Aliases: MachineName
