...
Describe 'New-AzAksMaintenanceConfiguration' {
    It 'CreateExpanded' {
        ...
        $MaintenanceConfig.NotAllowedTime.Start.ToShortDateString() | Should -Be '03/01/2023'
        $MaintenanceConfig.NotAllowedTime.End.ToShortDateString() | Should -Be '03/02/2023'
