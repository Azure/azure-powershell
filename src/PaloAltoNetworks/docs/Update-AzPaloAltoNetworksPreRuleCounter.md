...
online version: https://learn.microsoft.com/powershell/module/az.paloaltonetworks/update-azpaloaltonetworksprerulecounter
schema: 2.0.0
---

# Update-AzPaloAltoNetworksPreRuleCounter
...
### Refresh (Default)
```
Update-AzPaloAltoNetworksPreRuleCounter -GlobalRulestackName <String> -Priority <String>
 [-FirewallName <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RefreshViaIdentity
```
Update-AzPaloAltoNetworksPreRuleCounter -InputObject <IPaloAltoNetworksIdentity> [-FirewallName <String>]
