...
online version: https://learn.microsoft.com/powershell/module/az.paloaltonetworks/new-azpaloaltonetworksprerule
schema: 2.0.0
---

# New-AzPaloAltoNetworksPreRule
...
```
New-AzPaloAltoNetworksPreRule -GlobalRulestackName <String> -Priority <String> -RuleName <String>
 [-ActionType <ActionEnum>] [-Application <String[]>] [-AuditComment <String>] [-CategoryFeed <String[]>]
 [-CategoryUrlCustom <String[]>] [-DecryptionRuleType <DecryptionRuleTypeEnum>] [-Description <String>]
 [-DestinationCidr <String[]>] [-DestinationCountry <String[]>] [-DestinationFeed <String[]>]
 [-DestinationFqdnList <String[]>] [-DestinationPrefixList <String[]>] [-EnableLogging <StateEnum>]
 [-Etag <String>] [-InboundInspectionCertificate <String>] [-NegateDestination <BooleanEnum>]
 [-NegateSource <BooleanEnum>] [-Protocol <String>] [-ProtocolPortList <String[]>] [-RuleState <StateEnum>]
 [-SourceCidr <String[]>] [-SourceCountry <String[]>] [-SourceFeed <String[]>] [-SourcePrefixList <String[]>]
 [-Tag <ITagInfo[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
