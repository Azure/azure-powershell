...
online version: https://learn.microsoft.com/powershell/module/az.paloaltonetworks/reset-azpaloaltonetworkspostrulecounter
schema: 2.0.0
---

# Reset-AzPaloAltoNetworksPostRuleCounter
...
### Reset (Default)
```
Reset-AzPaloAltoNetworksPostRuleCounter -GlobalRulestackName <String> -Priority <String>
 [-FirewallName <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-AzPaloAltoNetworksPostRuleCounter -InputObject <IPaloAltoNetworksIdentity> [-FirewallName <String>]
