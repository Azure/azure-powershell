...
online version: https://learn.microsoft.com/powershell/module/az.paloaltonetworks/get-azpaloaltonetworksfirewallsupportinfo
schema: 2.0.0
---

# Get-AzPaloAltoNetworksFirewallSupportInfo
...
### Get (Default)
```
Get-AzPaloAltoNetworksFirewallSupportInfo -FirewallName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzPaloAltoNetworksFirewallSupportInfo -InputObject <IPaloAltoNetworksIdentity> [-Email <String>]
