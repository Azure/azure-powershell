...
online version: https://learn.microsoft.com/powershell/module/az.paloaltonetworks/update-azpaloaltonetworkspostrulecounter
schema: 2.0.0
---

# Update-AzPaloAltoNetworksPostRuleCounter
...
### Refresh (Default)
```
Update-AzPaloAltoNetworksPostRuleCounter -GlobalRulestackName <String> -Priority <String>
 [-FirewallName <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RefreshViaIdentity
```
Update-AzPaloAltoNetworksPostRuleCounter -InputObject <IPaloAltoNetworksIdentity> [-FirewallName <String>]
