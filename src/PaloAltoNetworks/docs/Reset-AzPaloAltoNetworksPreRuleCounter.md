...
online version: https://learn.microsoft.com/powershell/module/az.paloaltonetworks/reset-azpaloaltonetworksprerulecounter
schema: 2.0.0
---

# Reset-AzPaloAltoNetworksPreRuleCounter
...
### Reset (Default)
```
Reset-AzPaloAltoNetworksPreRuleCounter -GlobalRulestackName <String> -Priority <String>
 [-FirewallName <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-AzPaloAltoNetworksPreRuleCounter -InputObject <IPaloAltoNetworksIdentity> [-FirewallName <String>]
