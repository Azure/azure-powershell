...
online version: https://learn.microsoft.com/powershell/module/az.paloaltonetworks/remove-azpaloaltonetworksmetricsobjectfirewall
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzPaloAltoNetworksMetricsObjectFirewall -FirewallName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzPaloAltoNetworksMetricsObjectFirewall -InputObject <IPaloAltoNetworksIdentity>
...
### Example 1: Delete metrics configurations object of a firewall
```powershell
