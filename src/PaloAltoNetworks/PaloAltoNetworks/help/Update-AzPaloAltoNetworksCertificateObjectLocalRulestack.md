...
Update-AzPaloAltoNetworksCertificateObjectLocalRulestack -LocalRulestackName <String> -Name <String>
 ...
 [-Etag <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityLocalRulestackExpanded
```
Update-AzPaloAltoNetworksCertificateObjectLocalRulestack -Name <String>
 -LocalRulestackInputObject <IPaloAltoNetworksIdentity> [-AuditComment <String>]
 [-CertificateSelfSigned <String>] [-CertificateSignerResourceId <String>] [-Description <String>]
 [-Etag <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/az.paloaltonetworks/update-azpaloaltonetworkscertificateobjectlocalrulestack](https://learn.microsoft.com/powershell/module/az.paloaltonetworks/update-azpaloaltonetworkscertificateobjectlocalrulestack)
