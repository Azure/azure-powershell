...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.PaloAltoNetworks.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.PaloAltoNetworks.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: PaloAltoNetworks cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.PaloAltoNetworks.format.ps1xml'
