...
```
Update-AzPaloAltoNetworksLocalRule -LocalRulestackInputObject <IPaloAltoNetworksIdentity> -Priority <String>
 ...
 [-SourcePrefixList <String[]>] [-Tag <ITagInfo[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
