...
namespace Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ResetCounters=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PaloAltoNetworks.Cloudngfw/localRulestacks/{localRulestackName}/localRules/{priority}/resetCounters"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Reset, @"AzPaloAltoNetworksLocalRuleCounter_ResetViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Models.Api20220829.IRuleCounterReset))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Description(@"Reset counters")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Generated]
    public partial class ResetAzPaloAltoNetworksLocalRuleCounter_ResetViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Models.Api20220829.IRuleCounterReset">Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Models.Api20220829.IRuleCounterReset</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Models.Api20220829.IRuleCounterReset> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'LocalRulesResetCounters' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.LocalRulesResetCountersViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("FirewallName") ? FirewallName : null, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.LocalRulesResetCounters(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.LocalRulestackName ?? null, InputObject.Priority ?? null, this.InvocationInformation.BoundParameters.ContainsKey("FirewallName") ? FirewallName : null, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ResetAzPaloAltoNetworksLocalRuleCounter_ResetViaIdentity" /> cmdlet class.
        /// </summary>
        public ResetAzPaloAltoNetworksLocalRuleCounter_ResetViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { FirewallName=this.InvocationInformation.BoundParameters.ContainsKey("FirewallName") ? FirewallName : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { FirewallName=this.InvocationInformation.BoundParameters.ContainsKey("FirewallName") ? FirewallName : null })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Models.Api20220829.IRuleCounterReset> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Models.Api20220829.IRuleCounterReset
