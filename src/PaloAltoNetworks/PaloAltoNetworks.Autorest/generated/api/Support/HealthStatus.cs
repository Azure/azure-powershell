...
namespace Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Support.HealthStatus Green = @"GREEN";

        public static Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Support.HealthStatus Initializing = @"INITIALIZING";

        public static Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Support.HealthStatus Red = @"RED";

        public static Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Support.HealthStatus Yellow = @"YELLOW";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Support.HealthStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Support.HealthStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Support.HealthStatus e1, Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Support.HealthStatus e2)
        {
            return !e2.Equals(e1);
        }
