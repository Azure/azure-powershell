...
Update-AzPaloAltoNetworksFqdnListLocalRulestack -LocalRulestackName <String> -Name <String>
 ...
 [-Etag <String>] [-FqdnList <String[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-AzPaloAltoNetworksFqdnListLocalRulestack -LocalRulestackInputObject <IPaloAltoNetworksIdentity>
 -Name <String> [-AuditComment <String>] [-Description <String>] [-Etag <String>] [-FqdnList <String[]>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
