...
Update-AzPaloAltoNetworksPrefixListLocalRulestack -LocalRulestackName <String> -Name <String>
 ...
 [-Etag <String>] [-PrefixList <String[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
...
```
Update-AzPaloAltoNetworksPrefixListLocalRulestack -LocalRulestackInputObject <IPaloAltoNetworksIdentity>
 -Name <String> [-AuditComment <String>] [-Description <String>] [-Etag <String>] [-PrefixList <String[]>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
