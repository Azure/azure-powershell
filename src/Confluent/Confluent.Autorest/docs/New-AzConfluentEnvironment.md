...
```
New-AzConfluentEnvironment -EnvironmentId <String> -OrganizationName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-Id <String>] [-Kind <String>] [-MetadataCreatedTimestamp <String>]
 [-MetadataDeletedTimestamp <String>] [-MetadataResourceName <String>] [-MetadataSelf <String>]
 [-MetadataUpdatedTimestamp <String>] [-Name <String>] [-StreamGovernanceConfigPackage <Package>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Confluent.Support.Package
Parameter Sets: (All)
Aliases:
