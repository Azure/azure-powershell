...
online version: https://learn.microsoft.com/powershell/module/az.confluent/update-azconfluenttopic
schema: 2.0.0
---
...
```
Update-AzConfluentTopic -ClusterId <String> -EnvironmentId <String> -Name <String> -OrganizationName <String>
...
```
Update-AzConfluentTopic -ClusterInputObject <IConfluentIdentity> -Name <String> [-ConfigRelated <String>]
 [-InputConfig <ITopicsInputConfig[]>] [-Kind <String>] [-MetadataResourceName <String>]
 [-MetadataSelf <String>] [-PartitionReassignmentRelated <String>] [-PartitionRelated <String>]
 [-PartitionsCount <String>] [-ReplicationFactor <String>] [-TopicId <String>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
...
```
Update-AzConfluentTopic -ClusterId <String> -EnvironmentInputObject <IConfluentIdentity> -Name <String>
...
```
Update-AzConfluentTopic -InputObject <IConfluentIdentity> [-ConfigRelated <String>]
 [-InputConfig <ITopicsInputConfig[]>] [-Kind <String>] [-MetadataResourceName <String>]
 [-MetadataSelf <String>] [-PartitionReassignmentRelated <String>] [-PartitionRelated <String>]
 [-PartitionsCount <String>] [-ReplicationFactor <String>] [-TopicId <String>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
...
```
Update-AzConfluentTopic -ClusterId <String> -EnvironmentId <String> -Name <String>
 ...
 [-ReplicationFactor <String>] [-TopicId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityEnvironmentExpanded, UpdateViaIdentityOrganizationExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityClusterExpanded, UpdateViaIdentityEnvironmentExpanded, UpdateViaIdentityOrganizationExpanded
Aliases: TopicName
