...
### ListViaJsonString
```
Get-AzConfluentOrganizationRegion -OrganizationName <String> -ResourceGroupName <String> -JsonString <String>
...
### Example 1: Get available regions for creating schema registry clusters
```powershell
