...
```
Remove-AzConfluentConnector -ClusterInputObject <IConfluentIdentity> -Name <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentityEnvironment
```
Remove-AzConfluentConnector -ClusterId <String> -EnvironmentInputObject <IConfluentIdentity> -Name <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
