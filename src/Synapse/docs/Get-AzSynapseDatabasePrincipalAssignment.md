...
online version: https://docs.microsoft.com/powershell/module/az.synapse/get-azsynapsedatabaseprincipalassignment
schema: 2.0.0
---

# Get-AzSynapseDatabasePrincipalAssignment
...
### List (Default)
```
Get-AzSynapseDatabasePrincipalAssignment -DatabaseName <String> -KustoPoolName <String>
...
### GetViaIdentity
```
Get-AzSynapseDatabasePrincipalAssignment -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
