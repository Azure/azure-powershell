...
online version: https://docs.microsoft.com/powershell/module/az.synapse/update-azsynapsedataconnection
schema: 2.0.0
---

# Update-AzSynapseDataConnection
...
```
Update-AzSynapseDataConnection -DatabaseName <String> -KustoPoolName <String> -Name <String>
...
### UpdateViaIdentity
```
Update-AzSynapseDataConnection -InputObject <ISynapseIdentity> -Parameter <IDataConnection>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzSynapseDataConnection -InputObject <ISynapseIdentity> -Kind <DataConnectionKind> [-Location <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
