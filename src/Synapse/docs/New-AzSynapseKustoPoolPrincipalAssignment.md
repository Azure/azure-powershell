...
```
New-AzSynapseKustoPoolPrincipalAssignment -KustoPoolName <String> -PrincipalAssignmentName <String>
 -ResourceGroupName <String> -WorkspaceName <String> -Parameter <IClusterPrincipalAssignment>
...
### CreateViaIdentity
```
New-AzSynapseKustoPoolPrincipalAssignment -InputObject <ISynapseIdentity>
 -Parameter <IClusterPrincipalAssignment> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzSynapseKustoPoolPrincipalAssignment -InputObject <ISynapseIdentity> [-PrincipalId <String>]
 [-PrincipalType <PrincipalType>] [-Role <ClusterPrincipalRole>] [-TenantId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210601Preview.IClusterPrincipalAssignment
