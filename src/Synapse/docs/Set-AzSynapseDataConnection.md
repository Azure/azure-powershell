...
online version: https://docs.microsoft.com/powershell/module/az.synapse/set-azsynapsedataconnection
schema: 2.0.0
---

# Set-AzSynapseDataConnection
...
```
Set-AzSynapseDataConnection -DatabaseName <String> -KustoPoolName <String> -Name <String>
