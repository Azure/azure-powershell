...
online version: https://docs.microsoft.com/powershell/module/az.synapse/new-azsynapseattacheddatabaseconfiguration
schema: 2.0.0
---
...
```
New-AzSynapseAttachedDatabaseConfiguration -KustoPoolName <String> -Name <String> -ResourceGroupName <String>
...
### CreateViaIdentity
```
New-AzSynapseAttachedDatabaseConfiguration -InputObject <ISynapseIdentity>
...
```
New-AzSynapseAttachedDatabaseConfiguration -InputObject <ISynapseIdentity> [-ClusterResourceId <String>]
