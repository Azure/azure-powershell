...
online version: https://docs.microsoft.com/powershell/module/az.synapse/set-azsynapsedatabaseprincipalassignment
schema: 2.0.0
---

# Set-AzSynapseDatabasePrincipalAssignment
...
```
Set-AzSynapseDatabasePrincipalAssignment -DatabaseName <String> -KustoPoolName <String>
...
Set-AzSynapseDatabasePrincipalAssignment -DatabaseName <String> -KustoPoolName <String>
 -PrincipalAssignmentName <String> -ResourceGroupName <String> -WorkspaceName <String>
 -Parameter <IDatabasePrincipalAssignment> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210601Preview.IDatabasePrincipalAssignment
...
PARAMETER <IDatabasePrincipalAssignment>: Class representing a database principal assignment.
