...
```
Invoke-AzSynapseDetachKustoPoolFollowerDatabase -KustoPoolName <String> -ResourceGroupName <String>
 -WorkspaceName <String> -FollowerDatabaseToRemove <IFollowerDatabaseDefinition> [-SubscriptionId <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210601Preview.IFollowerDatabaseDefinition
