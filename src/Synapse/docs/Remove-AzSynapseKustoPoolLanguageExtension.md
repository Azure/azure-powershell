...
```
Remove-AzSynapseKustoPoolLanguageExtension -KustoPoolName <String> -ResourceGroupName <String>
 -WorkspaceName <String> -LanguageExtensionsToRemove <ILanguageExtensionsList> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-AzSynapseKustoPoolLanguageExtension -InputObject <ISynapseIdentity>
