...
namespace Microsoft.Azure.Management.Synapse
{
    ...
    public static partial class IntegrationRuntimeConnectionInfosOperationsExtensions
    {
        ...
        {
                return ((IIntegrationRuntimeConnectionInfosOperations)operations).GetAsync(resourceGroupName, workspaceName, integrationRuntimeName).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<IntegrationRuntimeConnectionInfo> GetAsync(this IIntegrationRuntimeConnectionInfosOperations operations, string resourceGroupName, string workspaceName, string integrationRuntimeName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
