...
namespace Microsoft.Azure.Management.Synapse
{
    ...
    public static partial class SparkConfigurationOperationsExtensions
    {
        ...
        {
                return ((ISparkConfigurationOperations)operations).GetAsync(resourceGroupName, sparkConfigurationName, workspaceName).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<SparkConfigurationResource> GetAsync(this ISparkConfigurationOperations operations, string resourceGroupName, string sparkConfigurationName, string workspaceName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
