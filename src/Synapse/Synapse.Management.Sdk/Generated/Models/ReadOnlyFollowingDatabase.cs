...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class ReadOnlyFollowingDatabase : Database
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.leaderClusterResourceId")]
        public string LeaderClusterResourceId {get; private set; }

        /// <summary>
        /// Gets the name of the attached database configuration cluster
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.attachedDatabaseConfigurationName")]
