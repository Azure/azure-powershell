...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class UpdateIntegrationRuntimeNodeRequest
    {
        ...
        /// <param name="concurrentJobsLimit">The number of concurrent jobs permitted to run on the integration runtime
        ...
        /// integration runtime node. Values between 1 and maxConcurrentJobs(inclusive)
        /// are allowed.
        /// </summary>
        ...
        {
            if (this.ConcurrentJobsLimit != null)
            {
                if (this.ConcurrentJobsLimit < 1)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.InclusiveMinimum, "ConcurrentJobsLimit", 1);
                }
            }
        }
    }
