...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class SqlPoolPatchInfo
    {
        ...
        /// </param>
        public SqlPoolPatchInfo(System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string location = default(string), Sku sku = default(Sku), string createMode = default(string), long? maxSizeBytes = default(long?), string collation = default(string), string sourceDatabaseId = default(string), string recoverableDatabaseId = default(string), string provisioningState = default(string), string status = default(string), System.DateTime? restorePointInTime = default(System.DateTime?), System.DateTime? creationDate = default(System.DateTime?), string storageAccountType = default(string), System.DateTime? sourceDatabaseDeletionDate = default(System.DateTime?))
