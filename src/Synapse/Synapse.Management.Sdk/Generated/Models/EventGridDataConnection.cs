...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class EventGridDataConnection : DataConnection
    {
        ...
        public EventGridDataConnection(string id = default(string), string name = default(string), string type = default(string), string location = default(string), SystemData systemData = default(SystemData), string storageAccountResourceId = default(string), string eventHubResourceId = default(string), string consumerGroup = default(string), string tableName = default(string), string mappingRuleName = default(string), string dataFormat = default(string), bool? ignoreFirstRecord = default(bool?), string blobStorageEventType = default(string), string provisioningState = default(string))
