...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the EventGridConnectionProperties class.
        /// </summary>
        ...
        /// <param name="storageAccountResourceId">The resource ID of the storage account where the data resides.
        /// </param>

        /// <param name="eventHubResourceId">The resource ID where the event grid is configured to send events.
        /// </param>
        ...
        /// <param name="ignoreFirstRecord">A Boolean value that, if set to true, indicates that ingestion should
        /// ignore the first record of every file
        /// </param>

        /// <param name="blobStorageEventType">The name of blob storage event type to process.
        ...
        public EventGridConnectionProperties(string storageAccountResourceId, string eventHubResourceId, string consumerGroup, string tableName = default(string), string mappingRuleName = default(string), string dataFormat = default(string), bool? ignoreFirstRecord = default(bool?), string blobStorageEventType = default(string), string provisioningState = default(string))
        ...
        /// <summary>
        /// Gets or sets the resource ID where the event grid is configured to send
        /// events.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a Boolean value that, if set to true, indicates that ingestion
        /// should ignore the first record of every file
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "ignoreFirstRecord")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "blobStorageEventType")]
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "StorageAccountResourceId");
            }
