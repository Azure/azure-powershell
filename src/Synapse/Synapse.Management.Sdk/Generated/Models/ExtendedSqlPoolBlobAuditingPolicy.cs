...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class ExtendedSqlPoolBlobAuditingPolicy : ProxyResource
    {
        /// <summary>
        /// Initializes a new instance of the ExtendedSqlPoolBlobAuditingPolicy class.
        /// </summary>
        ...
        /// <param name="predicateExpression">Specifies condition of where clause when creating an audit.
        /// </param>
        ...
        /// </param>
        public ExtendedSqlPoolBlobAuditingPolicy(string id = default(string), string name = default(string), string type = default(string), string predicateExpression = default(string), BlobAuditingPolicyState? state = default(BlobAuditingPolicyState?), string storageEndpoint = default(string), string storageAccountAccessKey = default(string), int? retentionDays = default(int?), System.Collections.Generic.IList<string> auditActionsAndGroups = default(System.Collections.Generic.IList<string>), System.Guid? storageAccountSubscriptionId = default(System.Guid?), bool? isStorageSecondaryKeyInUse = default(bool?), bool? isAzureMonitorTargetEnabled = default(bool?), int? queueDelayMS = default(int?))
