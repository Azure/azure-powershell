...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class SqlPoolUsage
    {
        ...
        /// <param name="name">The name of the usage metric.
        /// </param>

        /// <param name="resourceName">The name of the resource.
        /// </param>

        /// <param name="displayName">The usage metric display name.
        /// </param>

        /// <param name="currentValue">The current value of the usage metric.
        /// </param>

        /// <param name="limit">The current limit of the usage metric.
        /// </param>

        /// <param name="unit">The units of the usage metric.
        /// </param>

        /// <param name="nextResetTime">The next reset time for the usage metric (ISO8601 format).
        /// </param>
