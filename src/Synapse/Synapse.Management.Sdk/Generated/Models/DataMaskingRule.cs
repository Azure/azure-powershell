...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class DataMaskingRule : ProxyResource
    {
        ...
        /// </param>
        public DataMaskingRule(string id = default(string), string name = default(string), string type = default(string), string location = default(string), string kind = default(string), string propertiesId = default(string), string aliasName = default(string), DataMaskingRuleState? ruleState = default(DataMaskingRuleState?), string schemaName = default(string), string tableName = default(string), string columnName = default(string), DataMaskingFunction? maskingFunction = default(DataMaskingFunction?), string numberFrom = default(string), string numberTo = default(string), string prefixSize = default(string), string suffixSize = default(string), string replacementString = default(string))
