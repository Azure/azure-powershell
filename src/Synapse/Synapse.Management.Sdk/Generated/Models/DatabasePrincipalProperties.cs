...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the DatabasePrincipalProperties class.
        /// </summary>
        ...
        /// <param name="principalId">The principal ID assigned to the database principal. It can be a user
        /// email, application ID, or security group name.
        /// </param>

        /// <param name="role">Database principal role.
        /// Possible values include: &#39;Admin&#39;, &#39;Ingestor&#39;, &#39;Monitor&#39;, &#39;User&#39;,
        ...
        public DatabasePrincipalProperties(string principalId, string role, string principalType, string tenantId = default(string), string tenantName = default(string), string principalName = default(string), string provisioningState = default(string))
        ...
        /// <summary>
        /// Gets or sets the principal ID assigned to the database principal. It can be
