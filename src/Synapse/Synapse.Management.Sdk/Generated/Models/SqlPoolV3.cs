...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class SqlPoolV3 : TrackedResource
    {
        ...
        /// <param name="sku">The sql pool SKU. The list of SKUs may vary by region and support offer.
        /// </param>

        /// <param name="kind">Kind of SqlPool.
        /// </param>

        /// <param name="systemData">SystemData of SqlPool.
        /// </param>
        ...
        /// attempts are made.
        /// </param>
        public SqlPoolV3(string location, string id = default(string), string name = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), SkuV3 sku = default(SkuV3), string kind = default(string), SystemData systemData = default(SystemData), string status = default(string), System.Guid? sqlPoolGuid = default(System.Guid?), string currentServiceObjectiveName = default(string), string requestedServiceObjectiveName = default(string), string maxServiceObjectiveName = default(string), int? autoPauseTimer = default(int?), bool? autoResume = default(bool?))
        ...
        /// <summary>
        /// Gets or sets the sql pool SKU. The list of SKUs may vary by region and
        /// support offer.
        /// </summary>
