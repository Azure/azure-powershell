...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class ReplicationLink : ProxyResource
    {
        ...
        /// <param name="location">Location of the workspace that contains this firewall rule.
        /// </param>
        ...
        /// </param>
        public ReplicationLink(string id = default(string), string name = default(string), string type = default(string), string location = default(string), string replicationState = default(string), bool? isTerminationAllowed = default(bool?), string replicationMode = default(string), string partnerServer = default(string), string partnerDatabase = default(string), string partnerLocation = default(string), ReplicationRole? role = default(ReplicationRole?), ReplicationRole? partnerRole = default(ReplicationRole?), System.DateTime? startTime = default(System.DateTime?), int? percentComplete = default(int?))
