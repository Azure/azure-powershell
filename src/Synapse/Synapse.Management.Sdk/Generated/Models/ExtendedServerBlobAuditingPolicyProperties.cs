...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ExtendedServerBlobAuditingPolicyProperties class.
        /// </summary>
        ...
        /// PowerShell](https://go.microsoft.com/fwlink/?linkid=2033043)
        /// </param>
        public ExtendedServerBlobAuditingPolicyProperties(BlobAuditingPolicyState state, string predicateExpression = default(string), string storageEndpoint = default(string), string storageAccountAccessKey = default(string), int? retentionDays = default(int?), System.Collections.Generic.IList<string> auditActionsAndGroups = default(System.Collections.Generic.IList<string>), System.Guid? storageAccountSubscriptionId = default(System.Guid?), bool? isStorageSecondaryKeyInUse = default(bool?), bool? isAzureMonitorTargetEnabled = default(bool?), int? queueDelayMS = default(int?), bool? isDevopsAuditEnabled = default(bool?))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "predicateExpression")]
        ...
        /// <summary>
        /// Gets or sets specifies the state of devops audit. If state is Enabled,
        ...
        /// PowerShell](https://go.microsoft.com/fwlink/?linkid=2033043)
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "isDevopsAuditEnabled")]
