...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class LinkedIntegrationRuntime
    {
        ...
        /// <param name="name">The name of the linked integration runtime.
        /// </param>

        /// <param name="subscriptionId">The subscription ID for which the linked integration runtime belong to.
        /// </param>

        /// <param name="dataFactoryName">The name of the workspace for which the linked integration runtime belong
        /// to.
        /// </param>

        /// <param name="dataFactoryLocation">The location of the workspace for which the linked integration runtime
        /// belong to.
        /// </param>

        /// <param name="createTime">The creating time of the linked integration runtime.
        /// </param>
        ...
        /// <summary>
        /// Gets the subscription ID for which the linked integration runtime belong
        /// to.
        /// </summary>
        ...
        /// <summary>
        /// Gets the name of the workspace for which the linked integration runtime
        /// belong to.
        /// </summary>
        ...
        /// <summary>
        /// Gets the location of the workspace for which the linked integration runtime
        /// belong to.
        /// </summary>
