...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class ClusterPrincipalAssignment : ProxyResource
    {
        ...
        public ClusterPrincipalAssignment(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string principalType = default(string), string principalId = default(string), string role = default(string), string tenantId = default(string), string tenantName = default(string), string principalName = default(string), string provisioningState = default(string))
