...
namespace Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210601Preview
{
    ...
    public partial class IotHubConnectionProperties
    {
        ...
        /// <summary>
        /// <c>AfterToJson</c> will be called after the json erialization has finished, allowing customization of the <see cref="Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonObject"
        /// /> before it is returned. Implement this method in a partial class to enable this behavior
        /// </summary>
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210601Preview.IIotHubConnectionProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210601Preview.IIotHubConnectionProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210601Preview.IIotHubConnectionProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonObject json ? new IotHubConnectionProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonObject into a new instance of <see cref="IotHubConnectionProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal IotHubConnectionProperties(Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonObject json)
        {
            ...
            {_iotHubResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonString>("iotHubResourceId"), out var __jsonIotHubResourceId) ? (string)__jsonIotHubResourceId : (string)IotHubResourceId;}
            {_consumerGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonString>("consumerGroup"), out var __jsonConsumerGroup) ? (string)__jsonConsumerGroup : (string)ConsumerGroup;}
            {_tableName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonString>("tableName"), out var __jsonTableName) ? (string)__jsonTableName : (string)TableName;}
            {_mappingRuleName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonString>("mappingRuleName"), out var __jsonMappingRuleName) ? (string)__jsonMappingRuleName : (string)MappingRuleName;}
            {_dataFormat = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonString>("dataFormat"), out var __jsonDataFormat) ? (string)__jsonDataFormat : (string)DataFormat;}
            {_eventSystemProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonArray>("eventSystemProperties"), out var __jsonEventSystemProperties) ? If( __jsonEventSystemProperties as Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : EventSystemProperty;}
            {_sharedAccessPolicyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonString>("sharedAccessPolicyName"), out var __jsonSharedAccessPolicyName) ? (string)__jsonSharedAccessPolicyName : (string)SharedAccessPolicyName;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="IotHubConnectionProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="IotHubConnectionProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._iotHubResourceId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonString(this._iotHubResourceId.ToString()) : null, "iotHubResourceId" ,container.Add );
            ...
            AddIf( null != (((object)this._sharedAccessPolicyName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonString(this._sharedAccessPolicyName.ToString()) : null, "sharedAccessPolicyName" ,container.Add );
