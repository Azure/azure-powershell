...
### Stop (Default)
```
Stop-AzSynapseKustoPool -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
...
### StopViaIdentity
```
Stop-AzSynapseKustoPool -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
