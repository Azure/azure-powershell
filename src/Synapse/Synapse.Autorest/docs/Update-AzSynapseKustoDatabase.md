...
online version: https://docs.microsoft.com/powershell/module/az.synapse/update-azsynapsekustodatabase
schema: 2.0.0
---

# Update-AzSynapseKustoDatabase
...
```
Update-AzSynapseKustoDatabase -DatabaseName <String> -KustoPoolName <String> -ResourceGroupName <String>
...
```
Update-AzSynapseKustoDatabase -InputObject <ISynapseIdentity> -Kind <Kind> [-HotCachePeriod <TimeSpan>]
 [-Location <String>] [-SoftDeletePeriod <TimeSpan>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
