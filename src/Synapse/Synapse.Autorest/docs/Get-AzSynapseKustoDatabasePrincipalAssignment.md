...
online version: https://docs.microsoft.com/powershell/module/az.synapse/get-azsynapsekustodatabaseprincipalassignment
schema: 2.0.0
---

# Get-AzSynapseKustoDatabasePrincipalAssignment
...
### List (Default)
```
Get-AzSynapseKustoDatabasePrincipalAssignment -DatabaseName <String> -KustoPoolName <String>
...
### GetViaIdentity
```
Get-AzSynapseKustoDatabasePrincipalAssignment -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
