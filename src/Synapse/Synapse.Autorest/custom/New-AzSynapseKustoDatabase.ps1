...
.Link
https://docs.microsoft.com/powershell/module/az.synapse/new-azsynapsekustodatabase
#>
function New-AzSynapseKustoDatabase {
    ...
    process {
        try {
            ...
            Az.Synapse.internal\New-AzSynapseKustoDatabase @PSBoundParameters
        }
        catch {
            throw
        }
