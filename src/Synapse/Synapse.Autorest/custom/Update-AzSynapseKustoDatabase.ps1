...
.Link
https://docs.microsoft.com/powershell/module/az.synapse/update-azsynapsekustodatabase
#>
function Update-AzSynapseKustoDatabase {
    ...
    process {
        try {
            ...
            Az.Synapse.internal\Update-AzSynapseKustoDatabase @PSBoundParameters
        }
        catch {
            throw
        }
