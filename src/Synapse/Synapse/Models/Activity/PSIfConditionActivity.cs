...
namespace Microsoft.Azure.Commands.Synapse.Models
{
    ...
    public partial class PSIfConditionActivity : PSControlActivity
    {
        ...
        public override Activity ToSdkObject()
        {
            ...
            foreach (var item in this.IfTrueActivities)
            {
                activity.IfTrueActivities.Add(item.ToSdkObject());
            }
            foreach (var item in this.IfFalseActivities)
            {
                activity.IfFalseActivities.Add(item.ToSdkObject());
            }
