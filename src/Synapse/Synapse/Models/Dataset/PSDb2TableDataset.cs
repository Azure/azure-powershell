...
namespace Microsoft.Azure.Commands.Synapse.Models
{
    ...
    public partial class PSDb2TableDataset : PSDataset
    {
        /// <summary>
        /// Initializes a new instance of the PSDb2TableDataset class.
        /// </summary>
        public PSDb2TableDataset()
        {
            CustomInit();
        }
        ...
        {
            var dataset = new Db2TableDataset(this.LinkedServiceName);
            dataset.TableName = this.TableName;
            dataset.SchemaTypePropertiesSchema = this.Db2TableDatasetSchema;
