...
namespace Microsoft.Azure.Commands.Synapse.Models
{
    ...
    public partial class PSEloquaObjectDataset : PSDataset
    {
        /// <summary>
        /// Initializes a new instance of the PSEloquaObjectDataset class.
        /// </summary>
        public PSEloquaObjectDataset()
        {
            CustomInit();
        }
        ...
        {
            var dataset = new EloquaObjectDataset(this.LinkedServiceName);
