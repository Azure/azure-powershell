...
namespace Microsoft.Azure.Commands.Synapse.Models
{
    ...
    public partial class PSOracleTableDataset : PSDataset
    {
        /// <summary>
        /// Initializes a new instance of the PSOracleTableDataset class.
        /// </summary>
        public PSOracleTableDataset()
        {
            CustomInit();
        }
        ...
        /// <summary>
        /// Gets or sets the schema name of the on-premises Oracle database.
        ...
        {
            var dataset = new OracleTableDataset(this.LinkedServiceName);
            dataset.TableName = this.TableName;
            dataset.SchemaTypePropertiesSchema = this.OracleTableDatasetSchema;
