...
namespace Microsoft.Azure.Commands.Synapse.Models
{
    ...
    public partial class PSRelationalTableDataset : PSDataset
    {
        /// <summary>
        /// Initializes a new instance of the PSRelationalTableDataset class.
        /// </summary>
        public PSRelationalTableDataset()
        {
            CustomInit();
        }
        ...
        {
            var dataset = new RelationalTableDataset(this.LinkedServiceName);
