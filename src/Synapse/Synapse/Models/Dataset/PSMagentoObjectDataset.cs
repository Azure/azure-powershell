...
namespace Microsoft.Azure.Commands.Synapse.Models
{
    ...
    public partial class PSMagentoObjectDataset : PSDataset
    {
        /// <summary>
        /// Initializes a new instance of the PSMagentoObjectDataset class.
        /// </summary>
        public PSMagentoObjectDataset()
        {
            CustomInit();
        }
        ...
        {
            var dataset = new MagentoObjectDataset(this.LinkedServiceName);
