...
namespace Microsoft.Azure.Commands.Synapse.Models
{
    ...
    public partial class PSSqlServerTableDataset : PSDataset
    {
        /// <summary>
        /// Initializes a new instance of the PSSqlServerTableDataset class.
        /// </summary>
        public PSSqlServerTableDataset()
        {
            CustomInit();
        }
        ...
        {
            var dataset = new SqlServerTableDataset(this.LinkedServiceName);
