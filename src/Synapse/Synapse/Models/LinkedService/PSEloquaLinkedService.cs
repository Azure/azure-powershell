...
namespace Microsoft.Azure.Commands.Synapse.Models
{
    ...
    public partial class PSEloquaLinkedService : PSLinkedService
    {
        /// <summary>
        /// Initializes a new instance of the PSEloquaLinkedService class.
        /// </summary>
        public PSEloquaLinkedService()
        {
            CustomInit();
        }
        ...
        {
            var linkedService = new EloquaLinkedService(this.Endpoint, this.Username);
