...
namespace Microsoft.Azure.Commands.Synapse.Models
{
    ...
    public partial class PSInformixLinkedService : PSLinkedService
    {
        /// <summary>
        /// Initializes a new instance of the PSInformixLinkedService class.
        /// </summary>
        public PSInformixLinkedService()
        {
            CustomInit();
        }
        ...
        {
            var linkedService = new InformixLinkedService(this.ConnectionString);
