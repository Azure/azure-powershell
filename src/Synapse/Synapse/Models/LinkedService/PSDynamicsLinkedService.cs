...
namespace Microsoft.Azure.Commands.Synapse.Models
{
    ...
    public partial class PSDynamicsLinkedService : PSLinkedService
    {
        /// <summary>
        /// Initializes a new instance of the PSDynamicsLinkedService class.
        /// </summary>
        public PSDynamicsLinkedService()
        {
            CustomInit();
        }
        ...
        {
            var linkedService = new DynamicsLinkedService(this.DeploymentType, this.AuthenticationType);
