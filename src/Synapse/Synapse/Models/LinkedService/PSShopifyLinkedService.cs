...
namespace Microsoft.Azure.Commands.Synapse.Models
{
    ...
    public partial class PSShopifyLinkedService : PSLinkedService
    {
        /// <summary>
        /// Initializes a new instance of the PSShopifyLinkedService class.
        /// </summary>
        public PSShopifyLinkedService()
        {
            CustomInit();
        }
        ...
        {
            var linkedService = new ShopifyLinkedService(this.Host);
