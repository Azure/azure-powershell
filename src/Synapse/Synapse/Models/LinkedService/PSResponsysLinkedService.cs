...
namespace Microsoft.Azure.Commands.Synapse.Models
{
    ...
    public partial class PSResponsysLinkedService : PSLinkedService
    {
        /// <summary>
        /// Initializes a new instance of the PSResponsysLinkedService class.
        /// </summary>
        public PSResponsysLinkedService()
        {
            CustomInit();
        }
        ...
        {
            var linkedService = new ResponsysLinkedService(this.Endpoint, this.ClientId);
