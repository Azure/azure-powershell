...
namespace Microsoft.Azure.Commands.Synapse.Models
{
    ...
    public partial class PSImpalaLinkedService : PSLinkedService
    {
        /// <summary>
        /// Initializes a new instance of the PSImpalaLinkedService class.
        /// </summary>
        public PSImpalaLinkedService()
        {
            CustomInit();
        }
        ...
        {
            var linkedService = new ImpalaLinkedService(this.Host, this.AuthenticationType);
