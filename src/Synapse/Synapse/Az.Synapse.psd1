...
CmdletsToExport = 'Get-AzSynapseSparkJob', 'Stop-AzSynapseSparkJob', 
               ...
               'Get-AzSynapseSqlPoolGeoBackup', 'Get-AzSynapseSqlDeletedDatabaseBackup',
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added support for operation of Advanced Threat Protection settings in SqlPool-level
