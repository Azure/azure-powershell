...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated ''New-AzSynapseSparkPool'' and ''Update-AzSynapseSparkPool'' to support for setting spark pool dynamic executor allocation by ''-EnableDynamicExecutorAllocation'''
