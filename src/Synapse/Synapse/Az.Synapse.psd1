...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Removed the unnecessary breaking change of parameter ''-SparkConfigFilePath'' for ''New-AzSynapseSparkPool'' and ''Update-AzSynapseSparkPool'' cmdlets'
