...
online version: https://learn.microsoft.com/powershell/module/az.synapse/remove-azsynapsetrigger
schema: 2.0.0
---
...
## DESCRIPTION
The **Remove-AzSynapseTrigger** cmdlet removes a trigger from a workspace.
