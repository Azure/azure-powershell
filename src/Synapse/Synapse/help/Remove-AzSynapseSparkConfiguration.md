...
online version: https://learn.microsoft.com/powershell/module/az.synapse/remove-azsynapsesparkconfiguration
schema: 2.0.0
---
...
## DESCRIPTION
The **Remove-AzSynapseSparkConfiguration** cmdlet removes a spark configuration from a workspace.
