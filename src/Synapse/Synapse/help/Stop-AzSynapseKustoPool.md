...
### Stop (Default)
```
Stop-AzSynapseKustoPool -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### StopViaIdentity
```
Stop-AzSynapseKustoPool -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
