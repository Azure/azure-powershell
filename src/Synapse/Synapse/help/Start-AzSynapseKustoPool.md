...
### Start (Default)
```
Start-AzSynapseKustoPool -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### StartViaIdentity
```
Start-AzSynapseKustoPool -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
