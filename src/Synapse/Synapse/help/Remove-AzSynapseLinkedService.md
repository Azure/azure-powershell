...
online version: https://learn.microsoft.com/powershell/module/az.synapse/remove-azsynapselinkedservice
schema: 2.0.0
---
...
## DESCRIPTION
The **Remove-AzSynapseLinkedService** cmdlet removes a linked service from workspace.
