...
### Example 1
```powershell
PS C:\> Add-AzSynapseFirewallRule -WorkspaceName ContosoWorkspace -Name ContosoFirewallRule -StartIpAddress "0.0.0.0" -EndIpAssdress "255.255.255.255"
```
...
PS C:\> $ws | Add-AzSynapseFirewallRule -Name ContosoFirewallRule -StartIpAddress "0.0.0.0" -EndIpAssdress "255.255.255.255"
```
...
### Example 3
```powershell
PS C:\> Add-AzSynapseFirewallRule -WorkspaceName ContosoWorkspace -AllowAllAzureIPs
```
