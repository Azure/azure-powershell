...
online version: https://learn.microsoft.com/powershell/module/az.synapse/set-azsynapsepipeline
schema: 2.0.0
---
...
## DESCRIPTION
The **Set-AzSynapsePipeline** cmdlet creates a pipeline in workspace.
...
The command bases the pipeline on information in the pipeline.json file.
This file includes information about activities.
