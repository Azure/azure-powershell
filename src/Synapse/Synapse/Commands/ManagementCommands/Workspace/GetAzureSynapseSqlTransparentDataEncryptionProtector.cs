...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + SynapseConstants.SynapsePrefix + SynapseConstants.Sql + SynapseConstants.TransparentDataEncryptionProtector, DefaultParameterSetName = GetByNameParameterSet)]
    [OutputType(typeof(PSEncryptionProtector))]
    public class GetAzureSynapseSqlTransparentDataEncryptionProtector : SynapseManagementCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            var result = new PSEncryptionProtector(SynapseAnalyticsClient.GetWorkspaceTransparentDataEncryptionProtector(this.ResourceGroupName, this.WorkspaceName),
