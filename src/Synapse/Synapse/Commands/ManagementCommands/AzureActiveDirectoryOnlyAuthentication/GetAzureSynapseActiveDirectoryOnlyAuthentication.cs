...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + SynapseConstants.SynapsePrefix + SynapseConstants.ActiveDirectoryOnlyAuthentication,
        DefaultParameterSetName = GetByNameParameterSet)]
    [OutputType(typeof(PSAzureADOnlyAuthentication))]
    public class GetAzureSynapseActiveDirectoryOnlyAuthentication : SynapseManagementCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            var result = this.SynapseAnalyticsClient.ListAzureADOnlyAuthentications(this.ResourceGroupName, this.WorkspaceName)
                .Select(element => new PSAzureADOnlyAuthentication(element, this.WorkspaceName));
