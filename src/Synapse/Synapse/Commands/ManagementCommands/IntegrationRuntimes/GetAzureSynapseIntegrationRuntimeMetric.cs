...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + SynapseConstants.SynapsePrefix + SynapseConstants.IntegrationRuntime + SynapseConstants.Metric,
        DefaultParameterSetName = GetByNameParameterSet)]
    [OutputType(typeof(PSIntegrationRuntimeMetrics))]
    public class GetAzureSynapseIntegrationRuntimeMetric : SynapseManagementCmdletBase
    {
