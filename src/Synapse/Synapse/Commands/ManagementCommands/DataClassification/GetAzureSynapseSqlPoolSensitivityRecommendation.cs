...
namespace Microsoft.Azure.Commands.Synapse
{
    ...
    public class GetAzureSynapseSqlPoolSensitivityRecommendation : AzureSynapseSqlPoolManagementCmdletBase<SqlPoolSensitivityClassificationModel, DataClassificationAdapter>
    {
        [Parameter(
        ...
        protected override SqlPoolSensitivityClassificationModel GetEntity()
        {
            ...
            return new SqlPoolSensitivityClassificationModel()
            {
                ...
                SensitivityLabels = ModelAdapter.GetRecommendedSensitivityLabels(ResourceGroupName, WorkspaceName, SqlPoolName)
            };
        }
