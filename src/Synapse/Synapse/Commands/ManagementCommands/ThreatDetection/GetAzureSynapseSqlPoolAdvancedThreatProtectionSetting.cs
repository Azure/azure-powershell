...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + SynapseConstants.SynapsePrefix + SynapseConstants.SqlPool + SynapseConstants.AdvancedThreatProtectionSetting, DefaultParameterSetName = GetByNameParameterSet)]
    [OutputType(typeof(PSSqlPoolSecurityAlertPolicy))]
    public class GetAzureSynapseSqlPoolAdvancedThreatProtectionSetting : SynapseManagementCmdletBase
    {
