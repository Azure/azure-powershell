...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + SynapseConstants.SynapsePrefix + SynapseConstants.KqlScript,
        DefaultParameterSetName = GetByName)]
    [OutputType(typeof(PSKqlScriptResource))]
    public class GetAzureSynapseKqlScript : SynapseArtifactsCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            {
                WriteObject(new PSKqlScriptResource(SynapseAnalyticsClient.GetKqlScript(this.Name), this.WorkspaceName));
            }
            else
            {
