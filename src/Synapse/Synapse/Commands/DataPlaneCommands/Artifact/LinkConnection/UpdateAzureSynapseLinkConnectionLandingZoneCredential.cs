...
namespace Microsoft.Azure.Commands.Synapse
{
    ...
    public class UpdateAzureSynapseLinkConnectionLandingZoneCredential : SynapseArtifactsCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            updateLandingZoneCredential.SasToken = new SecureString(this.SasToken);

            SynapseAnalyticsClient.UpdateLandingZoneCredential(LinkConnectionName, updateLandingZoneCredential);
        }
    }
}
