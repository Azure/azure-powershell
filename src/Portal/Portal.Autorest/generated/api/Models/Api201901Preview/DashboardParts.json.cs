...
namespace Microsoft.Azure.PowerShell.Cmdlets.Portal.Models.Api201901Preview
{
    ...
    public partial class DashboardParts
    {
        ...
        internal DashboardParts(Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonObject json)
        {
            ...
            {_metadata = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonObject>("metadata"), out var __jsonMetadata) ? Microsoft.Azure.PowerShell.Cmdlets.Portal.Models.Api201901Preview.DashboardPartMetadata.FromJson(__jsonMetadata) : Metadata;}
            AfterFromJson(json);
        }
