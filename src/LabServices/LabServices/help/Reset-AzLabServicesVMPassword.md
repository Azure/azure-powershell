...
Reset-AzLabServicesVMPassword [-SubscriptionId <String>] -Password <SecureString> -Username <String>
 -ResourceId <String> [-DefaultProfile <PSObject>] [-PassThru] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Reset-AzLabServicesVMPassword [-SubscriptionId <String>] -Password <SecureString> -Username <String>
 -VM <VirtualMachine> [-DefaultProfile <PSObject>] [-PassThru] [-AsJob] [-NoWait] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
