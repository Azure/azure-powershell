...
```
Get-AzLabServicesLab [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### ResourceId
```
Get-AzLabServicesLab [-SubscriptionId <String[]>] -ResourceId <String> [-DefaultProfile <PSObject>] [-WhatIf]
