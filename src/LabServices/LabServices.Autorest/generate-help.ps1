...
$modulePsd1 = Get-Item -Path (Join-Path $PSScriptRoot './Az.LabServices.psd1')
$modulePath = $modulePsd1.FullName
$moduleName = $modulePsd1.BaseName

# Load DLL to use build-time cmdlets
Import-Module -Name $modulePath
Import-Module -Name (Join-Path $PSScriptRoot './bin/Az.LabServices.private.dll')
$instance = [Microsoft.Azure.PowerShell.Cmdlets.LabServices.Module]::Instance
