...
### SaveViaJsonFilePath
```
Save-AzLabServicesLabPlanImage -LabPlanName <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### SaveViaJsonString
```
Save-AzLabServicesLabPlanImage -LabPlanName <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: SaveExpanded, SaveViaJsonFilePath, SaveViaJsonString
Aliases:
