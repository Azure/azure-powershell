...
### GetViaIdentity
```
Get-AzLabServicesUser -InputObject <ILabServicesIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentityLab
```
Get-AzLabServicesUser -LabInputObject <ILabServicesIdentity> -Name <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
