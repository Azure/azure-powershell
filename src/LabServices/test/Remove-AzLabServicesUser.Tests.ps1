...
Describe 'Remove-AzLabServicesUser' {
    It 'Delete' {
        $user = Get-AzLabServicesUser -ResourceGroupName $ENV:ResourceGroupName -LabName $ENV:LabName -Name $ENV:UserName
        {Remove-AzLabServicesUser -User $user} | Should -Not -Throw
