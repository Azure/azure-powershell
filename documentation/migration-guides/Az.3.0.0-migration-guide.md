...
- [Migration Guide for Az 3.0.0](#migration-guide-for-az-300)
  - [Batch](#batch)
    ...
    - [Incompatibility with previous versions of `Az.Resources`](#previous-version-incompatibility-with-az.resources-module)
  - [Compute](#compute)
  ...
  - [HDInsight](#hdinsight)
    ...
    - [`AzHDInsightGatewayCredential`](#azhdinsightgatewaycredential)
  - [IotHub](#iothub)
  ...
  - [Resources](#resources)
    - [Incompatibility with previous versions of `Az.Batch`](#previous-version-incompatibility-with-az.batch-module)
