...
- Each attribute has two additional constructors that take the following params in addition to the ones the attribute mentions:
  ...
  - The "changeInEffectByDate" is the date the breaking change is going to go in effect on. The string formati is "mm/dd/yyyy", as an example : "02/25/2018"
#### Properties by name
...
The properties "deprecatedByVersion" and "changeInEffectByDate" are infotmation only (for the end user) as of now.
