...
For more information on piping, see the article [_Understanding pipelines_](https://docs.microsoft.com/powershell/scripting/learn/understanding-the-powershell-pipeline).
