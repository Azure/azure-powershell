...
Powershell allows to configure cmdlets output view with the [format.ps1xml](https://msdn.microsoft.com/library/gg580992) files.

To provide a better PowerShell Azure cmdlets output experience we worked out a mechanism to quickly generate a [format.ps1xml](https://docs.microsoft.com/powershell/module/microsoft.powershell.core/about/about_format.ps1xml?view=powershell-6) file:
