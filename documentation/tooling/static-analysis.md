...
- `HelpAnalyzer`
    - The implementation of the `IStaticAnalyzer` interface; determines which modules to analyze and checks to see which cmdlets within those modules don't have a corresponding markdown help file. It also checks the content structure of markdown help conforms to the schema enforced by the [`Microsoft.PowerShell.PlatyPS`](https://github.com/PowerShell/platyPS) module (schema version `2024-05-01`)
- `HelpIssues`
