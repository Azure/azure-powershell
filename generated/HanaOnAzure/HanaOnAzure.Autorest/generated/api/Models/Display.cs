...
namespace Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models
{
    ...
    public partial class Display :
        Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.IDisplay,
        Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.IDisplayInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.IDisplayInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for Operation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.IDisplayInternal.Operation { get => this._operation; set { {_operation = value;} } }

        /// <summary>Internal Acessors for Origin</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.IDisplayInternal.Origin { get => this._origin; set { {_origin = value;} } }

        /// <summary>Internal Acessors for Provider</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.IDisplayInternal.Provider { get => this._provider; set { {_provider = value;} } }

        /// <summary>Internal Acessors for Resource</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.IDisplayInternal.Resource { get => this._resource; set { {_resource = value;} } }
