...
namespace Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.IResourceAutoGeneratedInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.IResourceAutoGeneratedInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.IResourceAutoGeneratedInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Type</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.IResourceAutoGeneratedInternal.Type { get => this._type; set { {_type = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.IResourceTags _tag;

        /// <summary>The tags that will be assigned to the key vault.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Origin(Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.IResourceTags Tag { get => (this._tag = this._tag ?? new Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.ResourceTags()); set => this._tag = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.IResourceTags) })]
        Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.IResourceTags Tag { get; set; }
        /// <summary>The resource type of the key vault.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Runtime.Info(
        Required = false,
        ReadOnly = true,
