...
namespace Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models
{
    ...
    public partial class SapMonitorProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.ISapMonitorProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.ISapMonitorProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Models.ISapMonitorProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Runtime.Json.JsonNode node)
        {
        ...
        internal SapMonitorProperties(Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Runtime.Json.JsonObject json)
        {
            ...
            {_provisioningState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Runtime.Json.JsonString>("provisioningState"), out var __jsonProvisioningState) ? (string)__jsonProvisioningState : (string)_provisioningState;}
            {_managedResourceGroupName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Runtime.Json.JsonString>("managedResourceGroupName"), out var __jsonManagedResourceGroupName) ? (string)__jsonManagedResourceGroupName : (string)_managedResourceGroupName;}
            {_logAnalyticsWorkspaceArmId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Runtime.Json.JsonString>("logAnalyticsWorkspaceArmId"), out var __jsonLogAnalyticsWorkspaceArmId) ? (string)__jsonLogAnalyticsWorkspaceArmId : (string)_logAnalyticsWorkspaceArmId;}
            {_enableCustomerAnalytic = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Runtime.Json.JsonBoolean>("enableCustomerAnalytics"), out var __jsonEnableCustomerAnalytics) ? (bool?)__jsonEnableCustomerAnalytics : _enableCustomerAnalytic;}
            {_logAnalyticsWorkspaceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Runtime.Json.JsonString>("logAnalyticsWorkspaceId"), out var __jsonLogAnalyticsWorkspaceId) ? (string)__jsonLogAnalyticsWorkspaceId : (string)_logAnalyticsWorkspaceId;}
            {_logAnalyticsWorkspaceSharedKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Runtime.Json.JsonString>("logAnalyticsWorkspaceSharedKey"), out var __jsonLogAnalyticsWorkspaceSharedKey) ? (string)__jsonLogAnalyticsWorkspaceSharedKey : (string)_logAnalyticsWorkspaceSharedKey;}
            {_sapMonitorCollectorVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Runtime.Json.JsonString>("sapMonitorCollectorVersion"), out var __jsonSapMonitorCollectorVersion) ? (string)__jsonSapMonitorCollectorVersion : (string)_sapMonitorCollectorVersion;}
            {_monitorSubnet = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HanaOnAzure.Runtime.Json.JsonString>("monitorSubnet"), out var __jsonMonitorSubnet) ? (string)__jsonMonitorSubnet : (string)_monitorSubnet;}
            AfterFromJson(json);
        }
