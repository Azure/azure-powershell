...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzNetworkFunctionCollectorPolicy_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.CollectorPoliciesGet(SubscriptionId, ResourceGroupName, AzureTrafficCollectorName, Name, onOk, onDefault, this, Pipeline);
