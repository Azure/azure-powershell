...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkFunction.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzNetworkFunctionTrafficCollector_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AzureTrafficCollectorsGet(ResourceGroupName, SubscriptionId, Name, onOk, onDefault, this, Pipeline);
