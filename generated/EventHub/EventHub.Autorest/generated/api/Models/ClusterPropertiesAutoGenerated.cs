...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models
{
    ...
    public partial class ClusterPropertiesAutoGenerated :
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.IClusterPropertiesAutoGenerated,
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.IClusterPropertiesAutoGeneratedInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.IClusterPropertiesAutoGeneratedInternal.CreatedAt { get => this._createdAt; set { {_createdAt = value;} } }

        /// <summary>Internal Acessors for MetricId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.IClusterPropertiesAutoGeneratedInternal.MetricId { get => this._metricId; set { {_metricId = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.IClusterPropertiesAutoGeneratedInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.IClusterPropertiesAutoGeneratedInternal.Status { get => this._status; set { {_status = value;} } }

        /// <summary>Internal Acessors for UpdatedAt</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.IClusterPropertiesAutoGeneratedInternal.UpdatedAt { get => this._updatedAt; set { {_updatedAt = value;} } }
        ...
        /// <summary>Creates an new <see cref="ClusterPropertiesAutoGenerated" /> instance.</summary>
        public ClusterPropertiesAutoGenerated()
        {
    ...
    /// Event Hubs Cluster properties supplied in responses in List or Get operations.
    internal partial interface IClusterPropertiesAutoGeneratedInternal
