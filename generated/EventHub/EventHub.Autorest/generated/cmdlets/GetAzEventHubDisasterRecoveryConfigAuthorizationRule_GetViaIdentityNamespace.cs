...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzEventHubDisasterRecoveryConfigAuthorizationRule_GetViaIdentityNamespace")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventHub.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventHub/namespaces/{namespaceName}/disasterRecoveryConfigs/{alias}/authorizationRules/{authorizationRuleName}", ApiVersion = "2023-01-01-preview")]
    public partial class GetAzEventHubDisasterRecoveryConfigAuthorizationRule_GetViaIdentityNamespace : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzEventHubDisasterRecoveryConfigAuthorizationRule_GetViaIdentityNamespace"
        /// /> cmdlet class.
        /// </summary>
        public GetAzEventHubDisasterRecoveryConfigAuthorizationRule_GetViaIdentityNamespace()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.NamespaceInputObject.Id += $"/disasterRecoveryConfigs/{(global::System.Uri.EscapeDataString(this.Alias.ToString()))}/authorizationRules/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.DisasterRecoveryConfigsGetAuthorizationRuleViaIdentity(NamespaceInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.DisasterRecoveryConfigsGetAuthorizationRule(NamespaceInputObject.SubscriptionId ?? null, NamespaceInputObject.ResourceGroupName ?? null, NamespaceInputObject.NamespaceName ?? null, Alias, Name, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Alias=Alias,Name=Name})
                    {
