...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventHub/namespaces/{namespaceName}/privateEndpointConnections/{privateEndpointConnectionName}"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventHub.Description(@"Gets a description for the specified Private Endpoint Connection name.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventHub.ExternalDocs(@"https://msdn.microsoft.com/en-us/library/azure/mt639379.aspx", @"")]
    ...
    public partial class GetAzEventHubPrivateEndpointConnection_GetViaIdentityNamespace : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzEventHubPrivateEndpointConnection_GetViaIdentityNamespace" /> cmdlet
        /// class.
        /// </summary>
        public GetAzEventHubPrivateEndpointConnection_GetViaIdentityNamespace()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (NamespaceInputObject?.Id != null)
                    {
                        ...
                        await this.Client.PrivateEndpointConnectionsGetViaIdentity(NamespaceInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PrivateEndpointConnectionsGet(NamespaceInputObject.SubscriptionId ?? null, NamespaceInputObject.ResourceGroupName ?? null, NamespaceInputObject.NamespaceName ?? null, Name, onOk, onDefault, this, Pipeline);
                    }
