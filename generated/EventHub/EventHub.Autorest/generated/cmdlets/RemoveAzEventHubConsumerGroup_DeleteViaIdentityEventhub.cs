...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzEventHubConsumerGroup_DeleteViaIdentityEventhub", SupportsShouldProcess = true)]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (EventhubInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ConsumerGroupsDeleteViaIdentity(EventhubInputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ConsumerGroupsDelete(EventhubInputObject.SubscriptionId ?? null, EventhubInputObject.ResourceGroupName ?? null, EventhubInputObject.NamespaceName ?? null, EventhubInputObject.EventHubName ?? null, Name, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzEventHubConsumerGroup_DeleteViaIdentityEventhub" /> cmdlet class.
        /// </summary>
        public RemoveAzEventHubConsumerGroup_DeleteViaIdentityEventhub()
        {
