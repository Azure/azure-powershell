...
namespace Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of the Monitor resource")]
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzDynatraceMonitorMetricStatus_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.MonitorsGetMetricStatus(SubscriptionId, ResourceGroupName, MonitorName, onOk, onDefault, this, Pipeline);
