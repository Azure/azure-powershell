...
namespace Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListMonitoredResources=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Dynatrace.Observability/monitors/{monitorName}/listMonitoredResources"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDynatraceMonitoredResource_ListExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.IMonitoredResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Description(@"List the resources currently being monitored by the Dynatrace monitor resource.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Dynatrace.Observability/monitors/{monitorName}/listMonitoredResources", ApiVersion = "2024-04-24")]
    public partial class GetAzDynatraceMonitoredResource_ListExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.ILogStatusRequest _requestBody = new Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.LogStatusRequest();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of azure resource Id of monitored resources for which we get the log status")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] MonitoredResourceId { get => _requestBody.MonitoredResourceId?.ToArray() ?? null /* fixedArrayOf */; set => _requestBody.MonitoredResourceId = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.IMonitoredResourceListResponse">Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.IMonitoredResourceListResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.IMonitoredResourceListResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzDynatraceMonitoredResource_ListExpanded" /> cmdlet class.
        /// </summary>
        public GetAzDynatraceMonitoredResource_ListExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'MonitorsListMonitoredResources' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.MonitorsListMonitoredResources(SubscriptionId, ResourceGroupName, MonitorName, _requestBody, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.IMonitoredResourceListResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.IMonitoredResourceListResponse
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.MonitorsListMonitoredResources_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
