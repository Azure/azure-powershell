...
namespace Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models
{
    ...
    public partial class ConnectedResourcesCountResponse
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonObject into a new instance of <see cref="ConnectedResourcesCountResponse" />.
        /// </summary>
        ...
        internal ConnectedResourcesCountResponse(Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonObject json)
        {
            ...
            {_connectedResourcesCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonNumber>("connectedResourcesCount"), out var __jsonConnectedResourcesCount) ? (long?)__jsonConnectedResourcesCount : _connectedResourcesCount;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.IConnectedResourcesCountResponse.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.IConnectedResourcesCountResponse.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.IConnectedResourcesCountResponse FromJson(Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonObject json ? new ConnectedResourcesCountResponse(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ConnectedResourcesCountResponse" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ConnectedResourcesCountResponse" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._connectedResourcesCount ? (Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonNumber((long)this._connectedResourcesCount) : null, "connectedResourcesCount" ,container.Add );
