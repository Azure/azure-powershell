...
namespace Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.Api20230427
{
    ...
    public partial class MarketplaceSaaSResourceDetailsResponse
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.Api20230427.IMarketplaceSaaSResourceDetailsResponse.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.Api20230427.IMarketplaceSaaSResourceDetailsResponse.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.Api20230427.IMarketplaceSaaSResourceDetailsResponse FromJson(Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonObject json ? new MarketplaceSaaSResourceDetailsResponse(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonObject into a new instance of <see cref="MarketplaceSaaSResourceDetailsResponse" />.
        /// </summary>
        ...
        internal MarketplaceSaaSResourceDetailsResponse(Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonObject json)
        {
            ...
            {_marketplaceSaaSResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonString>("marketplaceSaaSResourceId"), out var __jsonMarketplaceSaaSResourceId) ? (string)__jsonMarketplaceSaaSResourceId : (string)MarketplaceSaaSResourceId;}
            {_planId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonString>("planId"), out var __jsonPlanId) ? (string)__jsonPlanId : (string)PlanId;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="MarketplaceSaaSResourceDetailsResponse" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MarketplaceSaaSResourceDetailsResponse" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonNode" />.
        /// </returns>
