...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeAction.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.EdgeAction.Models";
