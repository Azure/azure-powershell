...
namespace Microsoft.Azure.PowerShell.Cmdlets.Discovery.Models
{
    ...
    public partial class AzureNetAppFilesStore :
        Microsoft.Azure.PowerShell.Cmdlets.Discovery.Models.IAzureNetAppFilesStore,
        Microsoft.Azure.PowerShell.Cmdlets.Discovery.Models.IAzureNetAppFilesStoreInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Discovery.Runtime.IValidates
    {
        ...
        public string Kind { get => "AzureNetAppFiles"; set => ((Microsoft.Azure.PowerShell.Cmdlets.Discovery.Models.IStorageStoreInternal)__storageStore).Kind = "AzureNetAppFiles"; }
        ...
        /// <summary>Backing field for <see cref="NetAppVolumeId" /> property.</summary>
        private string _netAppVolumeId;

        /// <summary>The associated Azure NetApp Files volume ID.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Discovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.Discovery.PropertyOrigin.Owned)]
        public string NetAppVolumeId { get => this._netAppVolumeId; set => this._netAppVolumeId = value; }

        /// <summary>Creates an new <see cref="AzureNetAppFilesStore" /> instance.</summary>
        public AzureNetAppFilesStore()
        {
            this.__storageStore.Kind = "AzureNetAppFiles";
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Discovery.Models.IStorageStore
    {
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.Discovery.PSArgumentCompleterAttribute("NFS")]
        ...
        Create = true,
        Update = false,
        Description = @"The associated Azure NetApp Files volume ID.",
        SerializedName = @"netAppVolumeId",
        PossibleTypes = new [] { typeof(string) })]
        string NetAppVolumeId { get; set; }

    }
    /// The Azure NetApp Files properties.
    internal partial interface IAzureNetAppFilesStoreInternal :
