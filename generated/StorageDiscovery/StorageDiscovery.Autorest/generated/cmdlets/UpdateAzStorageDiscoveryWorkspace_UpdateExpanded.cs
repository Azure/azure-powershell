...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageDiscovery/storageDiscoveryWorkspaces/{storageDiscoveryWorkspaceName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzStorageDiscoveryWorkspace_UpdateExpanded", SupportsShouldProcess = true)]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IStorageDiscoveryWorkspaceUpdate _propertiesBody = new Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.StorageDiscoveryWorkspaceUpdate();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IStorageDiscoveryScope[] Scope { get => _propertiesBody.Scope?.ToArray() ?? null /* fixedArrayOf */; set => _propertiesBody.Scope = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IStorageDiscoveryScope>(value) : null); }
        ...
        public string Sku { get => _propertiesBody.Sku ?? null; set => _propertiesBody.Sku = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] WorkspaceRoot { get => _propertiesBody.WorkspaceRoot?.ToArray() ?? null /* fixedArrayOf */; set => _propertiesBody.WorkspaceRoot = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'StorageDiscoveryWorkspacesUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.StorageDiscoveryWorkspacesUpdate(SubscriptionId, ResourceGroupName, Name, _propertiesBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Runtime.SerializationMode.IncludeUpdate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzStorageDiscoveryWorkspace_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzStorageDiscoveryWorkspace_UpdateExpanded()
        {
