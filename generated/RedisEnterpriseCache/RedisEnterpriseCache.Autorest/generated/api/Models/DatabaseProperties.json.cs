...
namespace Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Models
{
    ...
    public partial class DatabaseProperties
    {
        ...
        internal DatabaseProperties(Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.Json.JsonObject json)
        {
            ...
            {_persistence = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.Json.JsonObject>("persistence"), out var __jsonPersistence) ? Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Models.Persistence.FromJson(__jsonPersistence) : _persistence;}
            {_geoReplication = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.Json.JsonObject>("geoReplication"), out var __jsonGeoReplication) ? Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Models.DatabasePropertiesGeoReplication.FromJson(__jsonGeoReplication) : _geoReplication;}
            {_clientProtocol = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.Json.JsonString>("clientProtocol"), out var __jsonClientProtocol) ? (string)__jsonClientProtocol : (string)_clientProtocol;}
            {_port = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.Json.JsonNumber>("port"), out var __jsonPort) ? (int?)__jsonPort : _port;}
            ...
            {_clusteringPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.Json.JsonString>("clusteringPolicy"), out var __jsonClusteringPolicy) ? (string)__jsonClusteringPolicy : (string)_clusteringPolicy;}
            {_evictionPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.Json.JsonString>("evictionPolicy"), out var __jsonEvictionPolicy) ? (string)__jsonEvictionPolicy : (string)_evictionPolicy;}
            {_module = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.Json.JsonArray>("modules"), out var __jsonModules) ? If( __jsonModules as Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Models.IModule>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Models.IModule) (Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Models.Module.FromJson(__u) )) ))() : null : _module;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Models.IDatabaseProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Models.IDatabaseProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Models.IDatabaseProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.Json.JsonNode node)
        {
