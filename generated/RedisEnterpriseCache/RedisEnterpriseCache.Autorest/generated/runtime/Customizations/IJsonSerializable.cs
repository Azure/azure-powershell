...
using Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Runtime.JsonSerializable.ToJson(dict, null);
            }
