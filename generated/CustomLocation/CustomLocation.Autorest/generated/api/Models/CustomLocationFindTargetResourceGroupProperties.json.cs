...
namespace Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Models
{
    ...
    public partial class CustomLocationFindTargetResourceGroupProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Json.JsonObject into a new instance of <see cref="CustomLocationFindTargetResourceGroupProperties"
        /// />.
        /// </summary>
        ...
        internal CustomLocationFindTargetResourceGroupProperties(Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Json.JsonObject json)
        {
            ...
            {_label = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Json.JsonObject>("labels"), out var __jsonLabels) ? Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Models.CustomLocationFindTargetResourceGroupPropertiesLabels.FromJson(__jsonLabels) : _label;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Models.ICustomLocationFindTargetResourceGroupProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Models.ICustomLocationFindTargetResourceGroupProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Models.ICustomLocationFindTargetResourceGroupProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Json.JsonObject json ? new CustomLocationFindTargetResourceGroupProperties(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CustomLocationFindTargetResourceGroupProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CustomLocationFindTargetResourceGroupProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._label ? (Microsoft.Azure.PowerShell.Cmdlets.CustomLocation.Runtime.Json.JsonNode) this._label.ToJson(null,serializationMode) : null, "labels" ,container.Add );
