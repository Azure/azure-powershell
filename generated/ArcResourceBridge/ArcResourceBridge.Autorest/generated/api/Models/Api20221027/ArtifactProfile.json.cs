...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.Api20221027
{
    ...
    public partial class ArtifactProfile
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonObject into a new instance of <see cref="ArtifactProfile" />.
        /// </summary>
        ...
        internal ArtifactProfile(Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonObject json)
        {
            ...
            {_endpoint = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonString>("endpoint"), out var __jsonEndpoint) ? (string)__jsonEndpoint : (string)Endpoint;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.Api20221027.IArtifactProfile.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.Api20221027.IArtifactProfile.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.Api20221027.IArtifactProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonObject json ? new ArtifactProfile(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ArtifactProfile" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ArtifactProfile" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != (((object)this._endpoint)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonString(this._endpoint.ToString()) : null, "endpoint" ,container.Add );
            }
