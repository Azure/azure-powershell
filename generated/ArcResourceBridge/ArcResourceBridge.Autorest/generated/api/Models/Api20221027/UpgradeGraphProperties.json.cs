...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.Api20221027
{
    ...
    public partial class UpgradeGraphProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.Api20221027.IUpgradeGraphProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.Api20221027.IUpgradeGraphProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.Api20221027.IUpgradeGraphProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonObject json ? new UpgradeGraphProperties(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UpgradeGraphProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UpgradeGraphProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != (((object)this._applianceVersion)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonString(this._applianceVersion.ToString()) : null, "applianceVersion" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.SerializationMode.IncludeReadOnly))
            {
                if (null != this._supportedVersion)
                {
                    var __w = new Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.XNodeArray();
                    foreach( var __x in this._supportedVersion )
                    {
                        AddIf(__x?.ToJson(null, serializationMode) ,__w.Add);
                    }
                    container.Add("supportedVersions",__w);
                }
            }
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonObject into a new instance of <see cref="UpgradeGraphProperties" />.
        /// </summary>
        ...
        internal UpgradeGraphProperties(Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_applianceVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonString>("applianceVersion"), out var __jsonApplianceVersion) ? (string)__jsonApplianceVersion : (string)ApplianceVersion;}
            {_supportedVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonArray>("supportedVersions"), out var __jsonSupportedVersions) ? If( __jsonSupportedVersions as Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.Api20221027.ISupportedVersion[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.Api20221027.ISupportedVersion) (Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.Api20221027.SupportedVersion.FromJson(__u) )) ))() : null : SupportedVersion;}
            AfterFromJson(json);
        }
    }
}