...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models
{
    ...
    public partial class SupportedVersionCatalogVersionTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="SupportedVersionCatalogVersion" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.ISupportedVersionCatalogVersion ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.ISupportedVersionCatalogVersion).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
