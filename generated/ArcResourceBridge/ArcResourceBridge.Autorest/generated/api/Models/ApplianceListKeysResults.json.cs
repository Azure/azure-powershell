...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models
{
    ...
    public partial class ApplianceListKeysResults
    {
        ...
        internal ApplianceListKeysResults(Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonObject json)
        {
            ...
            {_artifactProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonObject>("artifactProfiles"), out var __jsonArtifactProfiles) ? Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.ApplianceListKeysResultsArtifactProfiles.FromJson(__jsonArtifactProfiles) : _artifactProfile;}
            {_kubeconfig = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonArray>("kubeconfigs"), out var __jsonKubeconfigs) ? If( __jsonKubeconfigs as Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.IApplianceCredentialKubeconfig>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.IApplianceCredentialKubeconfig) (Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.ApplianceCredentialKubeconfig.FromJson(__u) )) ))() : null : _kubeconfig;}
            {_sshKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonObject>("sshKeys"), out var __jsonSshKeys) ? Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.ApplianceListKeysResultsSshKeys.FromJson(__jsonSshKeys) : _sshKey;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.IApplianceListKeysResults.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.IApplianceListKeysResults.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.IApplianceListKeysResults FromJson(Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode node)
        {
