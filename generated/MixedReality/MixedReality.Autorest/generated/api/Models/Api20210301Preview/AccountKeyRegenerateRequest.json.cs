...
namespace Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Models.Api20210301Preview
{
    ...
    public partial class AccountKeyRegenerateRequest
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Runtime.Json.JsonObject into a new instance of <see cref="AccountKeyRegenerateRequest" />.
        /// </summary>
        ...
        internal AccountKeyRegenerateRequest(Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Runtime.Json.JsonObject json)
        {
            ...
            {_serial = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Runtime.Json.JsonNumber>("serial"), out var __jsonSerial) ? (int?)__jsonSerial : Serial;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Models.Api20210301Preview.IAccountKeyRegenerateRequest.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Models.Api20210301Preview.IAccountKeyRegenerateRequest.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Models.Api20210301Preview.IAccountKeyRegenerateRequest FromJson(Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Runtime.Json.JsonObject json ? new AccountKeyRegenerateRequest(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AccountKeyRegenerateRequest" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AccountKeyRegenerateRequest" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._serial ? (Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.MixedReality.Runtime.Json.JsonNumber((int)this._serial) : null, "serial" ,container.Add );
