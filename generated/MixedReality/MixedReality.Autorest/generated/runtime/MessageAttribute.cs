...
{
    using Microsoft.Azure.PowerShell.Cmdlets.MixedReality.generated.runtime.Properties;
    using System;
    ...
    public class GenericBreakingChangeAttribute : Attribute
    {
        ...
        public string moduleName { get; set; } = String.IsNullOrEmpty(@"") ? @"Az.MixedReality" : @"";
