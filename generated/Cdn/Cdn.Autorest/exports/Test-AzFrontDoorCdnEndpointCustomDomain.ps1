...
begin {
    try {
        ...
        $mapping = @{
            ...
            ValidateViaIdentityProfile = 'Az.Cdn.private\Test-AzFrontDoorCdnEndpointCustomDomain_ValidateViaIdentityProfile';
            ValidateViaIdentityProfileExpanded = 'Az.Cdn.private\Test-AzFrontDoorCdnEndpointCustomDomain_ValidateViaIdentityProfileExpanded';
            ValidateViaJsonFilePath = 'Az.Cdn.private\Test-AzFrontDoorCdnEndpointCustomDomain_ValidateViaJsonFilePath';
            ValidateViaJsonString = 'Az.Cdn.private\Test-AzFrontDoorCdnEndpointCustomDomain_ValidateViaJsonString';
        }
