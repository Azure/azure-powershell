...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdEndpoint])]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            GetViaIdentityProfile = 'Az.Cdn.private\Get-AzFrontDoorCdnEndpoint_GetViaIdentityProfile';
