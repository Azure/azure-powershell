...
.Link
https://learn.microsoft.com/powershell/module/az.cdn/get-azcdnmanagedruleset
#>
function Get-AzCdnManagedRuleSet {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IManagedRuleSetDefinition])]
