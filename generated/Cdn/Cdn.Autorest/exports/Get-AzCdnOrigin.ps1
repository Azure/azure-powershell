...
param(
    ...
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='GetViaIdentityEndpoint', Mandatory)]
    [Parameter(ParameterSetName='GetViaIdentityProfile', Mandatory)]
    [Alias('OriginName')]
    [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category('Path')]
    [System.String]
    ...
    [Parameter(ParameterSetName='GetViaIdentityEndpoint', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnIdentity]
    # Identity Parameter
    ${EndpointInputObject},
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Cdn.private\Get-AzCdnOrigin_Get';
            GetViaIdentity = 'Az.Cdn.private\Get-AzCdnOrigin_GetViaIdentity';
            GetViaIdentityEndpoint = 'Az.Cdn.private\Get-AzCdnOrigin_GetViaIdentityEndpoint';
            GetViaIdentityProfile = 'Az.Cdn.private\Get-AzCdnOrigin_GetViaIdentityProfile';
            List = 'Az.Cdn.private\Get-AzCdnOrigin_List';
        }
