...
param(
    ...
    [Parameter(ParameterSetName='PatchViaIdentityProfile', Mandatory)]
    [Parameter(ParameterSetName='PatchViaIdentityProfileExpanded', Mandatory)]
    ...
    [Parameter(ParameterSetName='PatchViaIdentityProfile', Mandatory, ValueFromPipeline)]
    [Parameter(ParameterSetName='PatchViaIdentityProfileExpanded', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnIdentity]
    # Identity Parameter
    ${ProfileInputObject},
    ...
    [Parameter(ParameterSetName='PatchViaIdentityProfileExpanded')]
