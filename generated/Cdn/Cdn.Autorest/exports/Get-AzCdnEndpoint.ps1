...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Cdn.private\Get-AzCdnEndpoint_Get';
            GetViaIdentity = 'Az.Cdn.private\Get-AzCdnEndpoint_GetViaIdentity';
            GetViaIdentityProfile = 'Az.Cdn.private\Get-AzCdnEndpoint_GetViaIdentityProfile';
            List = 'Az.Cdn.private\Get-AzCdnEndpoint_List';
        }
