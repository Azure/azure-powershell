...
param(
    ...
    [Parameter(ParameterSetName='LoadViaIdentityProfile', Mandatory)]
    [Parameter(ParameterSetName='LoadViaIdentityProfileExpanded', Mandatory)]
    [Parameter(ParameterSetName='LoadViaJsonFilePath', Mandatory)]
    ...
    [Parameter(ParameterSetName='LoadViaJsonFilePath')]
    [Parameter(ParameterSetName='LoadViaJsonString')]
    [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category('Path')]
    ...
    [Parameter(ParameterSetName='LoadViaIdentityProfile', Mandatory, ValueFromPipeline)]
    [Parameter(ParameterSetName='LoadViaIdentityProfileExpanded', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnIdentity]
    # Identity Parameter
    ${ProfileInputObject},
...
begin {
    try {
        ...
        if (('Load', 'LoadExpanded', 'LoadViaJsonFilePath', 'LoadViaJsonString') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId') ) {
            if ($testPlayback) {
