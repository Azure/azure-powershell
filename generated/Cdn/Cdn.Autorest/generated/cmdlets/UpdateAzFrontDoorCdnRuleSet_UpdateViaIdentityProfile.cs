...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzFrontDoorCdnRuleSet_UpdateViaIdentityProfile", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzFrontDoorCdnRuleSet_UpdateViaIdentityProfile : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IContext
    {
        ...
        /// <returns>a duplicate instance of UpdateAzFrontDoorCdnRuleSet_UpdateViaIdentityProfile</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.UpdateAzFrontDoorCdnRuleSet_UpdateViaIdentityProfile Clone()
        {
            var clone = new UpdateAzFrontDoorCdnRuleSet_UpdateViaIdentityProfile();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ProfileInputObject?.Id != null)
                    {
                        ...
                        Resource = await this.Client.RuleSetsGetViaIdentityWithResult(ProfileInputObject.Id, this, Pipeline);
                        this.UpdateResource();
                        await this.Client.RuleSetsCreateViaIdentity(ProfileInputObject.Id, Resource, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        Resource = await this.Client.RuleSetsGetWithResult(ProfileInputObject.SubscriptionId ?? null, ProfileInputObject.ResourceGroupName ?? null, ProfileInputObject.ProfileName ?? null, Name, this, Pipeline);
                        this.UpdateResource();
                        await this.Client.RuleSetsCreate(ProfileInputObject.SubscriptionId ?? null, ProfileInputObject.ResourceGroupName ?? null, ProfileInputObject.ProfileName ?? null, Name, Resource, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzFrontDoorCdnRuleSet_UpdateViaIdentityProfile" /> cmdlet class.
        /// </summary>
        public UpdateAzFrontDoorCdnRuleSet_UpdateViaIdentityProfile()
        {
        ...
        private void UpdateResource()
        {
            ...
            {
                this.Resource = (Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRuleSet)(this.MyInvocation?.BoundParameters["Resource"]);
            }
        }
