...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzFrontDoorCdnRoute_UpdateViaIdentityProfile", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRoute))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Description(@"update an existing route with the specified route name under the specified subscription, resource group, profile, and AzureFrontDoor endpoint.")]
    ...
    public partial class UpdateAzFrontDoorCdnRoute_UpdateViaIdentityProfile : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="RouteUpdateProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRouteUpdateParameters _routeUpdateProperty;

        /// <summary>The domain JSON object required for domain creation or update.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The domain JSON object required for domain creation or update.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The domain JSON object required for domain creation or update.",
        SerializedName = @"routeUpdateProperties",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRouteUpdateParameters) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRouteUpdateParameters RouteUpdateProperty { get => this._routeUpdateProperty; set => this._routeUpdateProperty = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzFrontDoorCdnRoute_UpdateViaIdentityProfile</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.UpdateAzFrontDoorCdnRoute_UpdateViaIdentityProfile Clone()
        {
            var clone = new UpdateAzFrontDoorCdnRoute_UpdateViaIdentityProfile();
            ...
            clone.RouteUpdateProperty = this.RouteUpdateProperty;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.ProfileInputObject.Id += $"/afdEndpoints/{(global::System.Uri.EscapeDataString(this.EndpointName.ToString()))}/routes/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.RoutesUpdateViaIdentity(ProfileInputObject.Id, RouteUpdateProperty, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        await this.Client.RoutesUpdate(ProfileInputObject.SubscriptionId ?? null, ProfileInputObject.ResourceGroupName ?? null, ProfileInputObject.ProfileName ?? null, EndpointName, Name, RouteUpdateProperty, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzFrontDoorCdnRoute_UpdateViaIdentityProfile" /> cmdlet class.
        /// </summary>
        public UpdateAzFrontDoorCdnRoute_UpdateViaIdentityProfile()
        {
