...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzFrontDoorCdnEndpoint_CreateViaIdentityProfile", SupportsShouldProcess = true)]
    ...
    public partial class NewAzFrontDoorCdnEndpoint_CreateViaIdentityProfile : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdEndpoint _endpoint;
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Azure Front Door endpoint is the entity within a Azure Front Door profile containing configuration information such as origin, protocol, content caching and delivery behavior. The AzureFrontDoor endpoint uses the URL format <endpointname>.azureedge.net.", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdEndpoint Endpoint { get => this._endpoint; set => this._endpoint = value; }
        ...
        /// <returns>a duplicate instance of NewAzFrontDoorCdnEndpoint_CreateViaIdentityProfile</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.NewAzFrontDoorCdnEndpoint_CreateViaIdentityProfile Clone()
        {
            var clone = new NewAzFrontDoorCdnEndpoint_CreateViaIdentityProfile();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzFrontDoorCdnEndpoint_CreateViaIdentityProfile" /> cmdlet class.
        /// </summary>
        public NewAzFrontDoorCdnEndpoint_CreateViaIdentityProfile()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ProfileInputObject?.Id != null)
                    {
                        ...
                        await this.Client.AfdEndpointsCreateViaIdentity(ProfileInputObject.Id, Endpoint, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        ...
                        await this.Client.AfdEndpointsCreate(ProfileInputObject.SubscriptionId ?? null, ProfileInputObject.ResourceGroupName ?? null, ProfileInputObject.ProfileName ?? null, EndpointName, Endpoint, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeCreate);
                    }
