...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzFrontDoorCdnOrigin_CreateViaIdentityOriginGroup", SupportsShouldProcess = true)]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdOrigin _origin;
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Azure Front Door origin is the source of the content being delivered via Azure Front Door. When the edge nodes represented by an endpoint do not have the requested content cached, they attempt to fetch it from one or more of the configured origins.", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdOrigin Origin { get => this._origin; set => this._origin = value; }
        ...
        /// <returns>a duplicate instance of NewAzFrontDoorCdnOrigin_CreateViaIdentityOriginGroup</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.NewAzFrontDoorCdnOrigin_CreateViaIdentityOriginGroup Clone()
        {
            var clone = new NewAzFrontDoorCdnOrigin_CreateViaIdentityOriginGroup();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzFrontDoorCdnOrigin_CreateViaIdentityOriginGroup" /> cmdlet class.
        /// </summary>
        public NewAzFrontDoorCdnOrigin_CreateViaIdentityOriginGroup()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (OriginGroupInputObject?.Id != null)
                    {
                        ...
                        await this.Client.AfdOriginsCreateViaIdentity(OriginGroupInputObject.Id, Origin, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        ...
                        await this.Client.AfdOriginsCreate(OriginGroupInputObject.SubscriptionId ?? null, OriginGroupInputObject.ResourceGroupName ?? null, OriginGroupInputObject.ProfileName ?? null, OriginGroupInputObject.OriginGroupName ?? null, OriginName, Origin, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeCreate);
                    }
