...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/ruleSets/{ruleSetName}"
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzFrontDoorCdnRuleSet_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRuleSet))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Description(@"update or update a batch rule set within the specified profile along with the rules associate to it.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Generated]
    public partial class UpdateAzFrontDoorCdnRuleSet_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRuleSet _resourceBody = new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.RuleSet();
        ...
        /// <summary>
        /// A list of rules that are part of this rule set provided the rule set is in batch mode.This property will be ignored if
        /// the rule set is not in batch mode.
        /// </summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "A list of rules that are part of this rule set provided the rule set is in batch mode.This property will be ignored if the rule set is not in batch mode.")]
        ...
        Required = false,
        ReadOnly = false,
        Description = @"A list of rules that are part of this rule set provided the rule set is in batch mode.This property will be ignored if the rule set is not in batch mode.",
        SerializedName = @"rules",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IBatchRuleProperties) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IBatchRuleProperties[] Rule { get => _resourceBody.Rule?.ToArray() ?? null /* fixedArrayOf */; set => _resourceBody.Rule = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IBatchRuleProperties>(value) : null); }
        ...
        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRuleSet> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of UpdateAzFrontDoorCdnRuleSet_UpdateViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.UpdateAzFrontDoorCdnRuleSet_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzFrontDoorCdnRuleSet_UpdateViaIdentityExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _resourceBody = await this.Client.RuleSetsGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_resourceBody();
                        await this.Client.RuleSetsCreateViaIdentity(InputObject.Id, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _resourceBody = await this.Client.RuleSetsGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ProfileName ?? null, InputObject.RuleSetName ?? null, this, Pipeline);
                        this.Update_resourceBody();
                        await this.Client.RuleSetsCreate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ProfileName ?? null, InputObject.RuleSetName ?? null, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzFrontDoorCdnRuleSet_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzFrontDoorCdnRuleSet_UpdateViaIdentityExpanded()
        {
        ...
        private void Update_resourceBody()
        {
            ...
            {
                this.Rule = (Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IBatchRuleProperties[])(this.MyInvocation?.BoundParameters["Rule"]);
            }
        }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRuleSet> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
