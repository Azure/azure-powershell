...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/endpoints/{endpointName}/originGroups/{originGroupName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzCdnOriginGroup_UpdateViaIdentityEndpoint", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IOriginGroup))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Description(@"update an existing origin group within an endpoint.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/endpoints/{endpointName}/originGroups/{originGroupName}", ApiVersion = "2026-04-01-preview")]
    public partial class UpdateAzCdnOriginGroup_UpdateViaIdentityEndpoint : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="EndpointInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnIdentity _endpointInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnIdentity EndpointInputObject { get => this._endpointInputObject; set => this._endpointInputObject = value; }
        ...
        [global::System.Management.Automation.Alias("OriginGroupName")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.ParameterCategory.Path)]
        ...
        /// <summary>Backing field for <see cref="OriginGroupUpdateProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IOriginGroupUpdateParameters _originGroupUpdateProperty;

        /// <summary>Origin group properties needed for origin group creation or update.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Origin group properties needed for origin group creation or update.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Origin group properties needed for origin group creation or update.",
        SerializedName = @"originGroupUpdateProperties",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IOriginGroupUpdateParameters) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IOriginGroupUpdateParameters OriginGroupUpdateProperty { get => this._originGroupUpdateProperty; set => this._originGroupUpdateProperty = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IOriginGroup">Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IOriginGroup</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IOriginGroup> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of UpdateAzCdnOriginGroup_UpdateViaIdentityEndpoint</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.UpdateAzCdnOriginGroup_UpdateViaIdentityEndpoint Clone()
        {
            var clone = new UpdateAzCdnOriginGroup_UpdateViaIdentityEndpoint();
            ...
            clone.OriginGroupUpdateProperty = this.OriginGroupUpdateProperty;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'OriginGroupsUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (EndpointInputObject?.Id != null)
                    {
                        this.EndpointInputObject.Id += $"/originGroups/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.OriginGroupsUpdateViaIdentity(EndpointInputObject.Id, OriginGroupUpdateProperty, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == EndpointInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("EndpointInputObject has null value for EndpointInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, EndpointInputObject) );
                        }
                        if (null == EndpointInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("EndpointInputObject has null value for EndpointInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, EndpointInputObject) );
                        }
                        if (null == EndpointInputObject.ProfileName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("EndpointInputObject has null value for EndpointInputObject.ProfileName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, EndpointInputObject) );
                        }
                        if (null == EndpointInputObject.EndpointName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("EndpointInputObject has null value for EndpointInputObject.EndpointName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, EndpointInputObject) );
                        }
                        await this.Client.OriginGroupsUpdate(EndpointInputObject.SubscriptionId ?? null, EndpointInputObject.ResourceGroupName ?? null, EndpointInputObject.ProfileName ?? null, EndpointInputObject.EndpointName ?? null, Name, OriginGroupUpdateProperty, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzCdnOriginGroup_UpdateViaIdentityEndpoint" /> cmdlet class.
        /// </summary>
        public UpdateAzCdnOriginGroup_UpdateViaIdentityEndpoint()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IOriginGroup> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IOriginGroup
