...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    public partial class ClearAzFrontDoorCdnEndpointContent_PurgeViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.IAfdPurgeParameters _content;

        /// <summary>Parameters required for content purge.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters required for content purge.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Parameters required for content purge.",
        SerializedName = @"contents",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.IAfdPurgeParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.IAfdPurgeParameters Content { get => this._content; set => this._content = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ClearAzFrontDoorCdnEndpointContent_PurgeViaIdentity" /> cmdlet class.
        /// </summary>
        public ClearAzFrontDoorCdnEndpointContent_PurgeViaIdentity()
        {

        }

        /// <summary>Creates a duplicate instance of this cmdlet (via JSON serialization).</summary>
        /// <returns>a duplicate instance of ClearAzFrontDoorCdnEndpointContent_PurgeViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.ClearAzFrontDoorCdnEndpointContent_PurgeViaIdentity Clone()
        {
            var clone = new ClearAzFrontDoorCdnEndpointContent_PurgeViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.AfdEndpointsPurgeContentViaIdentity(InputObject.Id, Content, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.AfdEndpointsPurgeContent(InputObject.ResourceGroupName ?? null, InputObject.ProfileName ?? null, InputObject.EndpointName ?? null, InputObject.SubscriptionId ?? null, Content, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=Content})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.IAfdErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=Content })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=Content })
                    {
