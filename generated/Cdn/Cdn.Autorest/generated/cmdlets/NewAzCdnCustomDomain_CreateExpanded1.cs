...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Create=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/endpoints/{endpointName}/customDomains/{customDomainName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzCdnCustomDomain_CreateExpanded1", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Description(@"Creates a new custom domain within an endpoint.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/endpoints/{endpointName}/customDomains/{customDomainName}", ApiVersion = "2024-02-01")]
    public partial class NewAzCdnCustomDomain_CreateExpanded1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.ICustomDomainParameters _customDomainPropertiesBody = new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.CustomDomainParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The host name of the custom domain. Must be a domain name.")]
        ...
        /// <returns>a duplicate instance of NewAzCdnCustomDomain_CreateExpanded1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.NewAzCdnCustomDomain_CreateExpanded1 Clone()
        {
            var clone = new NewAzCdnCustomDomain_CreateExpanded1();
            ...
            clone._customDomainPropertiesBody = this._customDomainPropertiesBody;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzCdnCustomDomain_CreateExpanded1" /> cmdlet class.
        /// </summary>
        public NewAzCdnCustomDomain_CreateExpanded1()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CustomDomainsCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CustomDomainsCreate(ResourceGroupName, ProfileName, EndpointName, Name, SubscriptionId, _customDomainPropertiesBody, onOk, onDefault, this, Pipeline);
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, EndpointName=EndpointName, Name=Name, SubscriptionId=SubscriptionId, body=_customDomainPropertiesBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ProfileName=ProfileName, EndpointName=EndpointName, Name=Name, SubscriptionId=SubscriptionId, body=_customDomainPropertiesBody })
                    {
