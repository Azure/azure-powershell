...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    public partial class ImportAzCdnEndpointContent_LoadViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.ILoadParameters _contentFilePathsBody = new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.LoadParameters();
        ...
        /// <returns>a duplicate instance of ImportAzCdnEndpointContent_LoadViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.ImportAzCdnEndpointContent_LoadViaIdentityExpanded Clone()
        {
            var clone = new ImportAzCdnEndpointContent_LoadViaIdentityExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ImportAzCdnEndpointContent_LoadViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public ImportAzCdnEndpointContent_LoadViaIdentityExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.EndpointsLoadContentViaIdentity(InputObject.Id, _contentFilePathsBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.EndpointsLoadContent(InputObject.ResourceGroupName ?? null, InputObject.ProfileName ?? null, InputObject.EndpointName ?? null, InputObject.SubscriptionId ?? null, _contentFilePathsBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_contentFilePathsBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_contentFilePathsBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_contentFilePathsBody })
                    {
