...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// <summary>update an existing KeyGroup within the specified profile.</summary>
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/keyGroups/{keyGroupName}"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzCdnKeyGroup_UpdateViaIdentityProfile", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IKeyGroup))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Description(@"update an existing KeyGroup within the specified profile.")]
    ...
    public partial class UpdateAzCdnKeyGroup_UpdateViaIdentityProfile : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="KeyGroupUpdateProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IKeyGroupUpdatePropertiesParameters _keyGroupUpdateProperty;

        /// <summary>The JSON object containing properties of key group to create or update.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The JSON object containing properties of key group to create or update.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The JSON object containing properties of key group to create or update.",
        SerializedName = @"keyGroupUpdateProperties",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IKeyGroupUpdatePropertiesParameters) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IKeyGroupUpdatePropertiesParameters KeyGroupUpdateProperty { get => this._keyGroupUpdateProperty; set => this._keyGroupUpdateProperty = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzCdnKeyGroup_UpdateViaIdentityProfile</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.UpdateAzCdnKeyGroup_UpdateViaIdentityProfile Clone()
        {
            var clone = new UpdateAzCdnKeyGroup_UpdateViaIdentityProfile();
            ...
            clone.KeyGroupUpdateProperty = this.KeyGroupUpdateProperty;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'KeyGroupsUpdate' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ProfileInputObject?.Id != null)
                    {
                        ...
                        await this.Client.KeyGroupsUpdateViaIdentity(ProfileInputObject.Id, KeyGroupUpdateProperty, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        await this.Client.KeyGroupsUpdate(ProfileInputObject.SubscriptionId ?? null, ProfileInputObject.ResourceGroupName ?? null, ProfileInputObject.ProfileName ?? null, Name, KeyGroupUpdateProperty, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzCdnKeyGroup_UpdateViaIdentityProfile" /> cmdlet class.
        /// </summary>
        public UpdateAzCdnKeyGroup_UpdateViaIdentityProfile()
        {
