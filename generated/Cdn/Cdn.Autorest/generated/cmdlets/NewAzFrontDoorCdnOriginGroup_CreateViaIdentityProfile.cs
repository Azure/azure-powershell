...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzFrontDoorCdnOriginGroup_CreateViaIdentityProfile", SupportsShouldProcess = true)]
    ...
    public partial class NewAzFrontDoorCdnOriginGroup_CreateViaIdentityProfile : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdOriginGroup _originGroup;

        /// <summary>
        /// AFDOrigin group comprising of origins is used for load balancing to origins when the content cannot be served from Azure
        /// Front Door.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "AFDOrigin group comprising of origins is used for load balancing to origins when the content cannot be served from Azure Front Door.", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdOriginGroup OriginGroup { get => this._originGroup; set => this._originGroup = value; }
        ...
        /// <returns>a duplicate instance of NewAzFrontDoorCdnOriginGroup_CreateViaIdentityProfile</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.NewAzFrontDoorCdnOriginGroup_CreateViaIdentityProfile Clone()
        {
            var clone = new NewAzFrontDoorCdnOriginGroup_CreateViaIdentityProfile();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzFrontDoorCdnOriginGroup_CreateViaIdentityProfile" /> cmdlet class.
        /// </summary>
        public NewAzFrontDoorCdnOriginGroup_CreateViaIdentityProfile()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ProfileInputObject?.Id != null)
                    {
                        ...
                        await this.Client.AfdOriginGroupsCreateViaIdentity(ProfileInputObject.Id, OriginGroup, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        ...
                        await this.Client.AfdOriginGroupsCreate(ProfileInputObject.SubscriptionId ?? null, ProfileInputObject.ResourceGroupName ?? null, ProfileInputObject.ProfileName ?? null, OriginGroupName, OriginGroup, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeCreate);
                    }
