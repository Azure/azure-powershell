...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Create=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/customDomains/{customDomainName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzFrontDoorCdnCustomDomain_CreateViaIdentityProfile", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/customDomains/{customDomainName}", ApiVersion = "2025-09-01-preview")]
    public partial class NewAzFrontDoorCdnCustomDomain_CreateViaIdentityProfile : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdDomain _customDomain;

        /// <summary>
        /// Friendly domain name mapping to the endpoint hostname that the customer provides for branding purposes, e.g. www.contoso.com.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Friendly domain name mapping to the endpoint hostname that the customer provides for branding purposes, e.g. www.contoso.com.", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdDomain CustomDomain { get => this._customDomain; set => this._customDomain = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdDomain">Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdDomain</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdDomain> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzFrontDoorCdnCustomDomain_CreateViaIdentityProfile</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.NewAzFrontDoorCdnCustomDomain_CreateViaIdentityProfile Clone()
        {
            var clone = new NewAzFrontDoorCdnCustomDomain_CreateViaIdentityProfile();
            ...
            clone.CustomDomainName = this.CustomDomainName;
            clone.CustomDomain = this.CustomDomain;
            return clone;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzFrontDoorCdnCustomDomain_CreateViaIdentityProfile" /> cmdlet class.
        /// </summary>
        public NewAzFrontDoorCdnCustomDomain_CreateViaIdentityProfile()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'AfdCustomDomainsCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.ProfileInputObject.Id += $"/customDomains/{(global::System.Uri.EscapeDataString(this.CustomDomainName.ToString()))}";
                        await this.Client.AfdCustomDomainsCreateViaIdentity(ProfileInputObject.Id, CustomDomain, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        ...
                        await this.Client.AfdCustomDomainsCreate(ProfileInputObject.SubscriptionId ?? null, ProfileInputObject.ResourceGroupName ?? null, ProfileInputObject.ProfileName ?? null, CustomDomainName, CustomDomain, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeCreate);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { CustomDomainName=CustomDomainName})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdDomain> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdDomain
