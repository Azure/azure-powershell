...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzFrontDoorCdnOrigin_UpdateViaIdentityOriginGroup", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/originGroups/{originGroupName}/origins/{originName}", ApiVersion = "2025-04-15")]
    public partial class UpdateAzFrontDoorCdnOrigin_UpdateViaIdentityOriginGroup : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="OriginGroupInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnIdentity _originGroupInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnIdentity OriginGroupInputObject { get => this._originGroupInputObject; set => this._originGroupInputObject = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdOriginUpdateParameters _originUpdateProperty;

        /// <summary>AFDOrigin properties needed for origin update.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "AFDOrigin properties needed for origin update.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"AFDOrigin properties needed for origin update.",
        SerializedName = @"originUpdateProperties",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdOriginUpdateParameters) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdOriginUpdateParameters OriginUpdateProperty { get => this._originUpdateProperty; set => this._originUpdateProperty = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdOrigin">Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdOrigin</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdOrigin> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of UpdateAzFrontDoorCdnOrigin_UpdateViaIdentityOriginGroup</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets.UpdateAzFrontDoorCdnOrigin_UpdateViaIdentityOriginGroup Clone()
        {
            var clone = new UpdateAzFrontDoorCdnOrigin_UpdateViaIdentityOriginGroup();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (OriginGroupInputObject?.Id != null)
                    {
                        this.OriginGroupInputObject.Id += $"/origins/{(global::System.Uri.EscapeDataString(this.OriginName.ToString()))}";
                        await this.Client.AfdOriginsUpdateViaIdentity(OriginGroupInputObject.Id, OriginUpdateProperty, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == OriginGroupInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("OriginGroupInputObject has null value for OriginGroupInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, OriginGroupInputObject) );
                        }
                        if (null == OriginGroupInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("OriginGroupInputObject has null value for OriginGroupInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, OriginGroupInputObject) );
                        }
                        if (null == OriginGroupInputObject.ProfileName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("OriginGroupInputObject has null value for OriginGroupInputObject.ProfileName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, OriginGroupInputObject) );
                        }
                        if (null == OriginGroupInputObject.OriginGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("OriginGroupInputObject has null value for OriginGroupInputObject.OriginGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, OriginGroupInputObject) );
                        }
                        await this.Client.AfdOriginsUpdate(OriginGroupInputObject.SubscriptionId ?? null, OriginGroupInputObject.ResourceGroupName ?? null, OriginGroupInputObject.ProfileName ?? null, OriginGroupInputObject.OriginGroupName ?? null, OriginName, OriginUpdateProperty, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode.IncludeUpdate);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { OriginName=OriginName})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzFrontDoorCdnOrigin_UpdateViaIdentityOriginGroup" /> cmdlet class.
        /// </summary>
        public UpdateAzFrontDoorCdnOrigin_UpdateViaIdentityOriginGroup()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdOrigin> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdOrigin
