...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/afdEndpoints/{endpointName}/routes/{routeName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzFrontDoorCdnRoute_GetViaIdentityAfdEndpoint")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRoute))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Description(@"Gets an existing route with the specified route name under the specified subscription, resource group, profile, and AzureFrontDoor endpoint.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cdn.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/afdEndpoints/{endpointName}/routes/{routeName}", ApiVersion = "2025-04-15")]
    public partial class GetAzFrontDoorCdnRoute_GetViaIdentityAfdEndpoint : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="AfdEndpointInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnIdentity _afdEndpointInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnIdentity AfdEndpointInputObject { get => this._afdEndpointInputObject; set => this._afdEndpointInputObject = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRoute">Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRoute</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRoute> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzFrontDoorCdnRoute_GetViaIdentityAfdEndpoint" /> cmdlet class.
        /// </summary>
        public GetAzFrontDoorCdnRoute_GetViaIdentityAfdEndpoint()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (AfdEndpointInputObject?.Id != null)
                    {
                        this.AfdEndpointInputObject.Id += $"/routes/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.RoutesGetViaIdentity(AfdEndpointInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == AfdEndpointInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("AfdEndpointInputObject has null value for AfdEndpointInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, AfdEndpointInputObject) );
                        }
                        if (null == AfdEndpointInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("AfdEndpointInputObject has null value for AfdEndpointInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, AfdEndpointInputObject) );
                        }
                        if (null == AfdEndpointInputObject.ProfileName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("AfdEndpointInputObject has null value for AfdEndpointInputObject.ProfileName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, AfdEndpointInputObject) );
                        }
                        if (null == AfdEndpointInputObject.EndpointName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("AfdEndpointInputObject has null value for AfdEndpointInputObject.EndpointName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, AfdEndpointInputObject) );
                        }
                        await this.Client.RoutesGet(AfdEndpointInputObject.SubscriptionId ?? null, AfdEndpointInputObject.ResourceGroupName ?? null, AfdEndpointInputObject.ProfileName ?? null, AfdEndpointInputObject.EndpointName ?? null, Name, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRoute> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRoute
