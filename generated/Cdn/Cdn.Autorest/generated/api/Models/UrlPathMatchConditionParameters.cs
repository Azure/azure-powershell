...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models
{
    ...
    public partial class UrlPathMatchConditionParameters :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IUrlPathMatchConditionParameters,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IUrlPathMatchConditionParametersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IValidates
    {
        ...
        public string TypeName { get => "DeliveryRuleUrlPathMatchConditionParameters"; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IDeliveryRuleConditionParametersInternal)__deliveryRuleConditionParameters).TypeName = "DeliveryRuleUrlPathMatchConditionParameters"; }

        /// <summary>Creates an new <see cref="UrlPathMatchConditionParameters" /> instance.</summary>
        public UrlPathMatchConditionParameters()
        {
            this.__deliveryRuleConditionParameters.TypeName = "DeliveryRuleUrlPathMatchConditionParameters";
        }
    ...
    /// Defines the parameters for UrlPath match conditions
    internal partial interface IUrlPathMatchConditionParametersInternal :
