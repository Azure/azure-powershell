...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models
{
    ...
    public partial class AfdRouteCacheConfiguration :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdRouteCacheConfigurationInternal
    {

        /// <summary>Backing field for <see cref="CompressionSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICompressionSettings _compressionSetting;

        /// <summary>compression settings.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICompressionSettings CompressionSetting { get => (this._compressionSetting = this._compressionSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.CompressionSettings()); set => this._compressionSetting = value; }

        /// <summary>
        /// List of content types on which compression applies. The value should be a valid MIME type.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> CompressionSettingContentTypesToCompress { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICompressionSettingsInternal)CompressionSetting).ContentTypesToCompress; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICompressionSettingsInternal)CompressionSetting).ContentTypesToCompress = value ?? null /* arrayOf */; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public bool? CompressionSettingIsCompressionEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICompressionSettingsInternal)CompressionSetting).IsCompressionEnabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICompressionSettingsInternal)CompressionSetting).IsCompressionEnabled = value ?? default(bool); }

        /// <summary>Internal Acessors for CompressionSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICompressionSettings Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IAfdRouteCacheConfigurationInternal.CompressionSetting { get => (this._compressionSetting = this._compressionSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.CompressionSettings()); set { {_compressionSetting = value;} } }
    ...
    {
        /// <summary>compression settings.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICompressionSettings CompressionSetting { get; set; }
        /// <summary>
        /// List of content types on which compression applies. The value should be a valid MIME type.
        /// </summary>
        System.Collections.Generic.List<string> CompressionSettingContentTypesToCompress { get; set; }
