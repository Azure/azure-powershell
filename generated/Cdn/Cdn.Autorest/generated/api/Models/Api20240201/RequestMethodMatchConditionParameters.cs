...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201
{
    ...
    public partial class RequestMethodMatchConditionParameters :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.IRequestMethodMatchConditionParameters,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.IRequestMethodMatchConditionParametersInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.IRequestMethodMatchConditionParametersInternal.Operator { get => this._operator; set { {_operator = value;} } }

        /// <summary>Internal Acessors for TypeName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.IRequestMethodMatchConditionParametersInternal.TypeName { get => this._typeName; set { {_typeName = value;} } }
        ...
        private string _typeName= @"DeliveryRuleRequestMethodConditionParameters";

        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        public string TypeName { get => this._typeName; }

        /// <summary>Creates an new <see cref="RequestMethodMatchConditionParameters" /> instance.</summary>
    ...
    /// Defines the parameters for RequestMethod match conditions
    internal partial interface IRequestMethodMatchConditionParametersInternal
