...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201
{
    ...
    public partial class AfdDomainUpdatePropertiesParameters
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject into a new instance of <see cref="AfdDomainUpdatePropertiesParameters" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal AfdDomainUpdatePropertiesParameters(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject json)
        {
            ...
            {_azureDnsZone = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject>("azureDnsZone"), out var __jsonAzureDnsZone) ? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.ResourceReference.FromJson(__jsonAzureDnsZone) : AzureDnsZone;}
            {_afdDomainUpdatePropertiesParametersPreValidatedCustomDomainResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject>("preValidatedCustomDomainResourceId"), out var __jsonPreValidatedCustomDomainResourceId) ? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.ResourceReference.FromJson(__jsonPreValidatedCustomDomainResourceId) : AfdDomainUpdatePropertiesParametersPreValidatedCustomDomainResourceId;}
            ...
            {_tlsSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject>("tlsSettings"), out var __jsonTlsSettings) ? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.AfdDomainHttpsParameters.FromJson(__jsonTlsSettings) : TlsSetting;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.IAfdDomainUpdatePropertiesParameters.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.IAfdDomainUpdatePropertiesParameters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.Api20240201.IAfdDomainUpdatePropertiesParameters FromJson(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject json ? new AfdDomainUpdatePropertiesParameters(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AfdDomainUpdatePropertiesParameters" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AfdDomainUpdatePropertiesParameters" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._afdDomainUpdatePropertiesParametersPreValidatedCustomDomainResourceId ? (Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode) this._afdDomainUpdatePropertiesParametersPreValidatedCustomDomainResourceId.ToJson(null,serializationMode) : null, "preValidatedCustomDomainResourceId" ,container.Add );
