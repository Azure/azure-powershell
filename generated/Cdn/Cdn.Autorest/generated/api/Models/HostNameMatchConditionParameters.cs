...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models
{
    ...
    public partial class HostNameMatchConditionParameters :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IHostNameMatchConditionParameters,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IHostNameMatchConditionParametersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IValidates
    {
        ...
        public string TypeName { get => "DeliveryRuleHostNameConditionParameters"; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IDeliveryRuleConditionParametersInternal)__deliveryRuleConditionParameters).TypeName = "DeliveryRuleHostNameConditionParameters"; }

        /// <summary>Creates an new <see cref="HostNameMatchConditionParameters" /> instance.</summary>
        public HostNameMatchConditionParameters()
        {
            this.__deliveryRuleConditionParameters.TypeName = "DeliveryRuleHostNameConditionParameters";
        }
    ...
    public partial interface IHostNameMatchConditionParameters :
    ...
    /// Defines the parameters for HostName match conditions
    internal partial interface IHostNameMatchConditionParametersInternal :
