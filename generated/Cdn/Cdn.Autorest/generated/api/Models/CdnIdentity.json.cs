...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models
{
    ...
    public partial class CdnIdentity
    {
        ...
        internal CdnIdentity(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject json)
        {
            ...
            {_webAgentName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonString>("webAgentName"), out var __jsonWebAgentName) ? (string)__jsonWebAgentName : (string)_webAgentName;}
            {_policyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonString>("policyName"), out var __jsonPolicyName) ? (string)__jsonPolicyName : (string)_policyName;}
            ...
            {_agentName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonString>("agentName"), out var __jsonAgentName) ? (string)__jsonAgentName : (string)_agentName;}
            ...
            {_versionName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonString>("versionName"), out var __jsonVersionName) ? (string)__jsonVersionName : (string)_versionName;}
            ...
            {_keyGroupName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonString>("keyGroupName"), out var __jsonKeyGroupName) ? (string)__jsonKeyGroupName : (string)_keyGroupName;}
            ...
            {_knowledgeSourceName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonString>("knowledgeSourceName"), out var __jsonKnowledgeSourceName) ? (string)__jsonKnowledgeSourceName : (string)_knowledgeSourceName;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._webAgentName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonString(this._webAgentName.ToString()) : null, "webAgentName" ,container.Add );
            ...
            AddIf( null != (((object)this._agentName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonString(this._agentName.ToString()) : null, "agentName" ,container.Add );
            ...
            AddIf( null != (((object)this._versionName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonString(this._versionName.ToString()) : null, "versionName" ,container.Add );
            ...
            AddIf( null != (((object)this._knowledgeSourceName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonString(this._knowledgeSourceName.ToString()) : null, "knowledgeSourceName" ,container.Add );
