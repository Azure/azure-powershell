...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models
{
    ...
    public partial class SocketAddrMatchConditionParameters :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ISocketAddrMatchConditionParametersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IValidates
    {
        ...
        public string TypeName { get => "DeliveryRuleSocketAddrConditionParameters"; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IDeliveryRuleConditionParametersInternal)__deliveryRuleConditionParameters).TypeName = "DeliveryRuleSocketAddrConditionParameters"; }

        /// <summary>Creates an new <see cref="SocketAddrMatchConditionParameters" /> instance.</summary>
        public SocketAddrMatchConditionParameters()
        {
            this.__deliveryRuleConditionParameters.TypeName = "DeliveryRuleSocketAddrConditionParameters";
        }
    ...
    /// Defines the parameters for SocketAddress match conditions
    internal partial interface ISocketAddrMatchConditionParametersInternal :
