...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models
{
    ...
    public partial class RuleUpdateParameters :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRuleUpdateParametersInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRuleUpdatePropertiesParameters _property;

        /// <summary>The JSON object that contains the properties of the rule to update.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRuleUpdatePropertiesParameters Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.RuleUpdatePropertiesParameters()); set => this._property = value; }

        /// <summary>The name of the rule set containing the rule.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cdn.PropertyOrigin.Inlined)]
        public string RuleSetName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRuleUpdatePropertiesParametersInternal)Property).RuleSetName; }
...

    {
        ...
        int? Order { get; set; }
        /// <summary>The JSON object that contains the properties of the rule to update.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRuleUpdatePropertiesParameters Property { get; set; }
        /// <summary>The name of the rule set containing the rule.</summary>
