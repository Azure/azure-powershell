...
Properties not specified in the request body will be unchanged.
.Example
Update-AzStorageMoverS3WithHmacEndpoint -Name "myendpoint" -ResourceGroupName "myresourcegroup" -StorageMoverName "mystoragemover" -CredentialsAccessKeyUri "https://examples-azureKeyVault.vault.azure.net/secrets/accesskey2" -CredentialsSecretKeyUri "https://examples-azureKeyVault.vault.azure.net/secrets/secretkey2" -Description "update endpoint"
...
.Link
https://learn.microsoft.com/powershell/module/az.storagemover/update-azstoragemovers3withhmacendpoint
#>
function Update-AzStorageMoverS3WithHmacEndpoint {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.StorageMover.custom\Update-AzStorageMoverS3WithHmacEndpoint';
            UpdateViaIdentityExpanded = 'Az.StorageMover.custom\Update-AzStorageMoverS3WithHmacEndpoint';
        }
