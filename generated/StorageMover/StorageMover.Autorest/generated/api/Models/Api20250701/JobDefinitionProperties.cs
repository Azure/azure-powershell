...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701
{
    ...
    public partial class JobDefinitionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.IJobDefinitionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.IJobDefinitionPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Support.JobType? _jobType;

        /// <summary>The type of the Job.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Support.JobType? JobType { get => this._jobType; set => this._jobType = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.IJobDefinitionPropertiesInternal.AgentResourceId { get => this._agentResourceId; set { {_agentResourceId = value;} } }

        /// <summary>Internal Acessors for LatestJobRunName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.IJobDefinitionPropertiesInternal.LatestJobRunName { get => this._latestJobRunName; set { {_latestJobRunName = value;} } }

        /// <summary>Internal Acessors for LatestJobRunResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.IJobDefinitionPropertiesInternal.LatestJobRunResourceId { get => this._latestJobRunResourceId; set { {_latestJobRunResourceId = value;} } }

        /// <summary>Internal Acessors for LatestJobRunStatus</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Support.JobRunStatus? Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.IJobDefinitionPropertiesInternal.LatestJobRunStatus { get => this._latestJobRunStatus; set { {_latestJobRunStatus = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.IJobDefinitionPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for SourceResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.IJobDefinitionPropertiesInternal.SourceResourceId { get => this._sourceResourceId; set { {_sourceResourceId = value;} } }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.IJobDefinitionPropertiesInternal.TargetResourceId { get => this._targetResourceId; set { {_targetResourceId = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.IJobDefinitionPropertiesSourceTargetMap _sourceTargetMap;

        /// <summary>The list of cloud endpoints to migrate.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.IJobDefinitionPropertiesSourceTargetMap SourceTargetMap { get => (this._sourceTargetMap = this._sourceTargetMap ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.JobDefinitionPropertiesSourceTargetMap()); set => this._sourceTargetMap = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.ISourceTargetMap[] SourceTargetMapValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.IJobDefinitionPropertiesSourceTargetMapInternal)SourceTargetMap).Value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Support.JobType? JobType { get; set; }
        /// <summary>The name of the Job Run in a non-terminal state, if exists.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.ISourceTargetMap[] SourceTargetMapValue { get;  }
        /// <summary>The name of the target Endpoint.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Info(
        Required = true,
        ReadOnly = false,
...

    {
        ...
        string SourceSubpath { get; set; }
        /// <summary>The list of cloud endpoints to migrate.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.IJobDefinitionPropertiesSourceTargetMap SourceTargetMap { get; set; }

        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Api20250701.ISourceTargetMap[] SourceTargetMapValue { get; set; }
        /// <summary>The name of the target Endpoint.</summary>
        string TargetName { get; set; }
        /// <summary>Fully qualified resource ID of the target Endpoint.</summary>
