...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models
{
    ...
    public partial class UploadLimitWeeklyRecurrence :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IUploadLimitWeeklyRecurrenceInternal,
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IWeeklyRecurrence"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IWeeklyRecurrence __weeklyRecurrence = new Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.WeeklyRecurrence();
        ...
        public System.Collections.Generic.List<string> Day { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IWeeklyRecurrenceInternal)__weeklyRecurrence).Day; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IWeeklyRecurrenceInternal)__weeklyRecurrence).Day = value ; }

        /// <summary>
        /// The end time of the schedule recurrence. Full hour and 30-minute intervals are supported.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.PropertyOrigin.Inherited)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.ITime EndTime { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IRecurrenceInternal)__weeklyRecurrence).EndTime; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IRecurrenceInternal)__weeklyRecurrence).EndTime = value ?? null /* model class */; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.PropertyOrigin.Inherited)]
        public int EndTimeHour { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IRecurrenceInternal)__weeklyRecurrence).EndTimeHour; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IRecurrenceInternal)__weeklyRecurrence).EndTimeHour = value ; }

        /// <summary>
        /// The minute element of the time. Allowed values are 0 and 30. If not specified, its value defaults to 0.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.PropertyOrigin.Inherited)]
        public int? EndTimeMinute { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IRecurrenceInternal)__weeklyRecurrence).EndTimeMinute; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IRecurrenceInternal)__weeklyRecurrence).EndTimeMinute = value ?? default(int); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.PropertyOrigin.Inherited)]
        public int StartTimeHour { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IRecurrenceInternal)__weeklyRecurrence).StartTimeHour; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IRecurrenceInternal)__weeklyRecurrence).StartTimeHour = value ; }

        /// <summary>
        /// The minute element of the time. Allowed values are 0 and 30. If not specified, its value defaults to 0.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.PropertyOrigin.Inherited)]
        public int? StartTimeMinute { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IRecurrenceInternal)__weeklyRecurrence).StartTimeMinute; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IRecurrenceInternal)__weeklyRecurrence).StartTimeMinute = value ?? default(int); }
