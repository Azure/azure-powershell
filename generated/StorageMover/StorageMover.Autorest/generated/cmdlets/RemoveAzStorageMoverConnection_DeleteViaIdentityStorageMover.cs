...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageMover/storageMovers/{storageMoverName}/connections/{connectionName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzStorageMoverConnection_DeleteViaIdentityStorageMover", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Description(@"Deletes a Connection resource.\nReturns 409 if there are active jobs using this connection.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StorageMover.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageMover/storageMovers/{storageMoverName}/connections/{connectionName}", ApiVersion = "2025-12-01")]
    public partial class RemoveAzStorageMoverConnection_DeleteViaIdentityStorageMover : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the Connection resource.")]
        ...
        /// <returns>
        /// a duplicate instance of RemoveAzStorageMoverConnection_DeleteViaIdentityStorageMover
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Cmdlets.RemoveAzStorageMoverConnection_DeleteViaIdentityStorageMover Clone()
        {
            var clone = new RemoveAzStorageMoverConnection_DeleteViaIdentityStorageMover();
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Events.DelayBeforePolling:
                    {
                        var data = messageData();
                        if (true == MyInvocation?.BoundParameters?.ContainsKey("NoWait"))
                        {
                            if (data.ResponseMessage is System.Net.Http.HttpResponseMessage response)
                            {
                                ...
                                WriteObject(new Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.PowerShell.AsyncOperationResponse { Target = uri });
                                // do nothing more.
                                data.Cancel();
                                return;
                            }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ConnectionsDelete' operation"))
                {
                    if (true == MyInvocation?.BoundParameters?.ContainsKey("AsJob"))
                    {
                        var instance = this.Clone();
                        var job = new Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.PowerShell.AsyncJob(instance, this.MyInvocation.Line, this.MyInvocation.MyCommand.Name, this._cancellationTokenSource.Token, this._cancellationTokenSource.Cancel);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.StorageMoverInputObject.Id += $"/connections/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.ConnectionsDeleteViaIdentity(StorageMoverInputObject.Id, onNoContent, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ConnectionsDelete(StorageMoverInputObject.SubscriptionId ?? null, StorageMoverInputObject.ResourceGroupName ?? null, StorageMoverInputObject.StorageMoverName ?? null, Name, onNoContent, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzStorageMoverConnection_DeleteViaIdentityStorageMover" /> cmdlet class.
        /// </summary>
        public RemoveAzStorageMoverConnection_DeleteViaIdentityStorageMover()
        {
