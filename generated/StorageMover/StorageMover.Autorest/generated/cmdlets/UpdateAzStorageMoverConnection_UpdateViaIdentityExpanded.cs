...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzStorageMoverConnection_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IConnection))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Description(@"update a Connection resource.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Generated]
    public partial class UpdateAzStorageMoverConnection_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The PrivateLinkServiceId for the connection.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Category(global::Microsoft.Azure.PowerShell.Cmdlets.StorageMover.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _connectionBody = await this.Client.ConnectionsGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_connectionBody();
                        await this.Client.ConnectionsCreateOrUpdateViaIdentity(InputObject.Id, _connectionBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _connectionBody = await this.Client.ConnectionsGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.StorageMoverName ?? null, InputObject.ConnectionName ?? null, this, Pipeline);
                        this.Update_connectionBody();
                        await this.Client.ConnectionsCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.StorageMoverName ?? null, InputObject.ConnectionName ?? null, _connectionBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzStorageMoverConnection_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzStorageMoverConnection_UpdateViaIdentityExpanded()
        {

        }

        private void Update_connectionBody()
        {
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("PrivateLinkServiceId")))
            {
                this.PrivateLinkServiceId = (string)(this.MyInvocation?.BoundParameters["PrivateLinkServiceId"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("JobList")))
            {
                this.JobList = (string[])(this.MyInvocation?.BoundParameters["JobList"]);
            }
        }
