...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Cmdlets
{
    ...
    /// <summary>
    /// update properties for an Endpoint resource. Properties not specified in the request body will be unchanged.
    /// </summary>
    /// <remarks>
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzStorageMoverEndpoint_UpdateViaIdentityStorageMoverExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IEndpoint))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Description(@"update properties for an Endpoint resource. Properties not specified in the request body will be unchanged.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StorageMover.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageMover/storageMovers/{storageMoverName}/endpoints/{endpointName}", ApiVersion = "2025-12-01")]
    public partial class UpdateAzStorageMoverEndpoint_UpdateViaIdentityStorageMoverExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IEndpointBaseUpdateParameters _endpointBody = new Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.EndpointBaseUpdateParameters();
        ...
        public string IdentityType { get => _endpointBody.IdentityType ?? null; set => _endpointBody.IdentityType = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the Endpoint resource.")]
        [Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IEndpointBaseUpdateProperties Property { get => _endpointBody.Property ?? null /* object */; set => _endpointBody.Property = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IEndpoint">Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IEndpoint</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IEndpoint> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.StorageMoverInputObject.Id += $"/endpoints/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        if (this.UserAssignedIdentity?.Length > 0)
                        {
                            // calculate UserAssignedIdentity
                            _endpointBody.IdentityUserAssignedIdentity.Clear();
                            foreach( var id in this.UserAssignedIdentity )
                            {
                                _endpointBody.IdentityUserAssignedIdentity.Add(id, new Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.UserAssignedIdentity());
                            }
                        }
                        await this.Client.EndpointsUpdateViaIdentity(StorageMoverInputObject.Id, _endpointBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        await this.Client.EndpointsUpdate(StorageMoverInputObject.SubscriptionId ?? null, StorageMoverInputObject.ResourceGroupName ?? null, StorageMoverInputObject.StorageMoverName ?? null, Name, _endpointBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzStorageMoverEndpoint_UpdateViaIdentityStorageMoverExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzStorageMoverEndpoint_UpdateViaIdentityStorageMoverExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IEndpoint> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IEndpoint
