...
namespace Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListByFluidRelayServers=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.FluidRelay/fluidRelayServers/{fluidRelayServerName}/fluidRelayContainers"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzFluidRelayContainer_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Description(@"List all Fluid Relay containers which are children of a given Fluid Relay server.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.FluidRelay/fluidRelayServers/{fluidRelayServerName}/fluidRelayContainers", ApiVersion = "2022-06-01")]
    public partial class GetAzFluidRelayContainer_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.IFluidRelayContainerList">Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.IFluidRelayContainerList</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.IFluidRelayContainerList> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzFluidRelayContainer_List" /> cmdlet class.
        /// </summary>
        public GetAzFluidRelayContainer_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.FluidRelayContainersListByFluidRelayServers(SubscriptionId, ResourceGroup, FluidRelayServerName, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.IFluidRelayContainerList> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.IFluidRelayContainerList
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.FluidRelayContainersListByFluidRelayServers_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
