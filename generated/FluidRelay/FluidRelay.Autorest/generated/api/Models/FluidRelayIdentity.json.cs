...
namespace Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models
{
    ...
    public partial class FluidRelayIdentity
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject into a new instance of <see cref="FluidRelayIdentity" />.
        /// </summary>
        ...
        internal FluidRelayIdentity(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.IFluidRelayIdentity.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.IFluidRelayIdentity.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.IFluidRelayIdentity FromJson(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject json ? new FluidRelayIdentity(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="FluidRelayIdentity" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="FluidRelayIdentity" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._subscriptionId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonString(this._subscriptionId.ToString()) : null, "subscriptionId" ,container.Add );
            AddIf( null != (((object)this._resourceGroup)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonString(this._resourceGroup.ToString()) : null, "resourceGroup" ,container.Add );
            AddIf( null != (((object)this._fluidRelayServerName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonString(this._fluidRelayServerName.ToString()) : null, "fluidRelayServerName" ,container.Add );
            AddIf( null != (((object)this._fluidRelayContainerName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonString(this._fluidRelayContainerName.ToString()) : null, "fluidRelayContainerName" ,container.Add );
            AddIf( null != (((object)this._id)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonString(this._id.ToString()) : null, "id" ,container.Add );
