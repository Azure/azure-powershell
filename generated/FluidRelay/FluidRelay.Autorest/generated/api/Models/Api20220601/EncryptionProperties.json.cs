...
namespace Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220601
{
    ...
    public partial class EncryptionProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject into a new instance of <see cref="EncryptionProperties" />.
        /// </summary>
        ...
        internal EncryptionProperties(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject json)
        {
            ...
            {_customerManagedKeyEncryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject>("customerManagedKeyEncryption"), out var __jsonCustomerManagedKeyEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220601.CustomerManagedKeyEncryptionProperties.FromJson(__jsonCustomerManagedKeyEncryption) : CustomerManagedKeyEncryption;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220601.IEncryptionProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220601.IEncryptionProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220601.IEncryptionProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject json ? new EncryptionProperties(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="EncryptionProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="EncryptionProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._customerManagedKeyEncryption ? (Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode) this._customerManagedKeyEncryption.ToJson(null,serializationMode) : null, "customerManagedKeyEncryption" ,container.Add );
