...
namespace Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models
{
    ...
    public partial class OperationResult :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IOperationResultInternal
    {

        /// <summary>Backing field for <see cref="Display" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IOperationDisplay _display;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IOperationDisplay Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.OperationDisplay()); set => this._display = value; }
        ...
        public string DisplayDescription { get => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IOperationDisplayInternal)Display).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IOperationDisplayInternal)Display).Description = value ?? null; }

        /// <summary>Operation type, e.g., read, write, delete, etc.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Datadog.Origin(Microsoft.Azure.PowerShell.Cmdlets.Datadog.PropertyOrigin.Inlined)]
        public string DisplayOperation { get => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IOperationDisplayInternal)Display).Operation; set => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IOperationDisplayInternal)Display).Operation = value ?? null; }

        /// <summary>Service provider, i.e., Microsoft.Datadog.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Datadog.Origin(Microsoft.Azure.PowerShell.Cmdlets.Datadog.PropertyOrigin.Inlined)]
        public string DisplayProvider { get => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IOperationDisplayInternal)Display).Provider; set => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IOperationDisplayInternal)Display).Provider = value ?? null; }

        /// <summary>Type on which the operation is performed, e.g., 'monitors'.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Datadog.Origin(Microsoft.Azure.PowerShell.Cmdlets.Datadog.PropertyOrigin.Inlined)]
        public string DisplayResource { get => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IOperationDisplayInternal)Display).Resource; set => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IOperationDisplayInternal)Display).Resource = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IOperationDisplay Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IOperationResultInternal.Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.OperationDisplay()); set { {_display = value;} } }
    ...
    {
        /// <summary>The object that represents the operation.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IOperationDisplay Display { get; set; }
        /// <summary>Description of the operation, e.g., 'Write monitors'.</summary>
        string DisplayDescription { get; set; }
        /// <summary>Operation type, e.g., read, write, delete, etc.</summary>
        string DisplayOperation { get; set; }
