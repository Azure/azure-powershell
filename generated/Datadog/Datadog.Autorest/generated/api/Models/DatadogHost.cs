...
namespace Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models
{
    ...
    public partial class DatadogHost :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogHostInternal
    {
        ...
        private System.Collections.Generic.List<string> _app;

        /// <summary>The Datadog integrations reporting metrics for the host.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Datadog.Origin(Microsoft.Azure.PowerShell.Cmdlets.Datadog.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> App { get => this._app; set => this._app = value; }
        ...
        public string InstallMethodInstallerVersion { get => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogHostMetadataInternal)Meta).InstallMethodInstallerVersion; set => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogHostMetadataInternal)Meta).InstallMethodInstallerVersion = value ?? null; }

        /// <summary>The tool.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Datadog.Origin(Microsoft.Azure.PowerShell.Cmdlets.Datadog.PropertyOrigin.Inlined)]
        public string InstallMethodTool { get => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogHostMetadataInternal)Meta).InstallMethodTool; set => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogHostMetadataInternal)Meta).InstallMethodTool = value ?? null; }

        /// <summary>The tool version.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Datadog.Origin(Microsoft.Azure.PowerShell.Cmdlets.Datadog.PropertyOrigin.Inlined)]
        public string InstallMethodToolVersion { get => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogHostMetadataInternal)Meta).InstallMethodToolVersion; set => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogHostMetadataInternal)Meta).InstallMethodToolVersion = value ?? null; }

        /// <summary>The transport.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Datadog.Origin(Microsoft.Azure.PowerShell.Cmdlets.Datadog.PropertyOrigin.Inlined)]
        public string LogAgentTransport { get => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogHostMetadataInternal)Meta).LogAgentTransport; set => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogHostMetadataInternal)Meta).LogAgentTransport = value ?? null; }

        /// <summary>Backing field for <see cref="Meta" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogHostMetadata _meta;

        [Microsoft.Azure.PowerShell.Cmdlets.Datadog.Origin(Microsoft.Azure.PowerShell.Cmdlets.Datadog.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogHostMetadata Meta { get => (this._meta = this._meta ?? new Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.DatadogHostMetadata()); set => this._meta = value; }

        /// <summary>The agent version.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Datadog.Origin(Microsoft.Azure.PowerShell.Cmdlets.Datadog.PropertyOrigin.Inlined)]
        public string MetaAgentVersion { get => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogHostMetadataInternal)Meta).AgentVersion; set => ((Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogHostMetadataInternal)Meta).AgentVersion = value ?? null; }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogHostMetadata Meta { get; set; }
        /// <summary>The agent version.</summary>
        string MetaAgentVersion { get; set; }

        Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogInstallMethod MetaInstallMethod { get; set; }

        Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogLogsAgent MetaLogsAgent { get; set; }
        /// <summary>The name of the host.</summary>
        string Name { get; set; }
