...
namespace Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models
{
    ...
    public partial class DatadogInstallMethod
    {
        ...
        internal DatadogInstallMethod(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonObject json)
        {
            ...
            {_tool = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonString>("tool"), out var __jsonTool) ? (string)__jsonTool : (string)_tool;}
            {_toolVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonString>("toolVersion"), out var __jsonToolVersion) ? (string)__jsonToolVersion : (string)_toolVersion;}
            {_installerVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonString>("installerVersion"), out var __jsonInstallerVersion) ? (string)__jsonInstallerVersion : (string)_installerVersion;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogInstallMethod.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogInstallMethod.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IDatadogInstallMethod FromJson(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode node)
        {
