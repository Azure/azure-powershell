...
namespace Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzGuestConfigurationAssignment_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Description(@"update an association between a ARC machine and guest configuration")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Generated]
    public partial class UpdateAzGuestConfigurationAssignment_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _parametersBody = await this.Client.GuestConfigurationAssignmentsGetByHcrpViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.GuestConfigurationAssignmentsCreateOrUpdateByHcrpViaIdentity(InputObject.Id, _parametersBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _parametersBody = await this.Client.GuestConfigurationAssignmentsGetByHcrpWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.GuestConfigurationAssignmentName ?? null, InputObject.MachineName ?? null, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.GuestConfigurationAssignmentsCreateOrUpdateByHcrp(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.GuestConfigurationAssignmentName ?? null, InputObject.MachineName ?? null, _parametersBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzGuestConfigurationAssignment_UpdateViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzGuestConfigurationAssignment_UpdateViaIdentityExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Name")))
            {
                this.Name = (string)(this.MyInvocation?.BoundParameters["Name"]);
            }
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Context")))
            {
                this.Context = (string)(this.MyInvocation?.BoundParameters["Context"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("VmssVMList")))
            {
                this.VmssVMList = (Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IVmssvmInfo[])(this.MyInvocation?.BoundParameters["VmssVMList"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("GuestConfigurationKind")))
            {
                this.GuestConfigurationKind = (string)(this.MyInvocation?.BoundParameters["GuestConfigurationKind"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("GuestConfigurationAssignmentType")))
            {
                this.GuestConfigurationAssignmentType = (string)(this.MyInvocation?.BoundParameters["GuestConfigurationAssignmentType"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("GuestConfigurationName")))
            {
                this.GuestConfigurationName = (string)(this.MyInvocation?.BoundParameters["GuestConfigurationName"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("GuestConfigurationVersion")))
            {
                this.GuestConfigurationVersion = (string)(this.MyInvocation?.BoundParameters["GuestConfigurationVersion"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("GuestConfigurationContentUri")))
            {
                this.GuestConfigurationContentUri = (string)(this.MyInvocation?.BoundParameters["GuestConfigurationContentUri"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("GuestConfigurationContentHash")))
            {
                this.GuestConfigurationContentHash = (string)(this.MyInvocation?.BoundParameters["GuestConfigurationContentHash"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("GuestConfigurationParameter")))
            {
                this.GuestConfigurationParameter = (Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IConfigurationParameter[])(this.MyInvocation?.BoundParameters["GuestConfigurationParameter"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("GuestConfigurationProtectedParameter")))
            {
                this.GuestConfigurationProtectedParameter = (Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IConfigurationParameter[])(this.MyInvocation?.BoundParameters["GuestConfigurationProtectedParameter"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("LatestAssignmentReportResource")))
            {
                this.LatestAssignmentReportResource = (Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IAssignmentReportResource[])(this.MyInvocation?.BoundParameters["LatestAssignmentReportResource"]);
            }
        }
