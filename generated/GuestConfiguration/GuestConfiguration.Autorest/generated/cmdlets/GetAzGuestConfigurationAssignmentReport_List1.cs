...
namespace Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzGuestConfigurationAssignmentReport_List1" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.GuestConfigurationAssignmentReportsListByHcrp(ResourceGroupName, GuestConfigurationAssignmentName, SubscriptionId, MachineName, onOk, onDefault, this, Pipeline);
