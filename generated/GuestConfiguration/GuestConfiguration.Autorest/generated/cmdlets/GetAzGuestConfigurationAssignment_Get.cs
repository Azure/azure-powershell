...
namespace Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzGuestConfigurationAssignment_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.GuestConfigurationAssignmentsGet(SubscriptionId, ResourceGroupName, Name, VMName, onOk, onDefault, this, Pipeline);
