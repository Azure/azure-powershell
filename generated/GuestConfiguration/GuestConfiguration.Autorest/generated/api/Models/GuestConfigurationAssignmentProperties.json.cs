...
namespace Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models
{
    ...
    public partial class GuestConfigurationAssignmentProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IGuestConfigurationAssignmentProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IGuestConfigurationAssignmentProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IGuestConfigurationAssignmentProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonNode node)
        {
        ...
        internal GuestConfigurationAssignmentProperties(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            {_guestConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonObject>("guestConfiguration"), out var __jsonGuestConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.GuestConfigurationNavigation.FromJson(__jsonGuestConfiguration) : _guestConfiguration;}
            {_latestAssignmentReport = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonObject>("latestAssignmentReport"), out var __jsonLatestAssignmentReport) ? Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.AssignmentReport.FromJson(__jsonLatestAssignmentReport) : _latestAssignmentReport;}
            {_targetResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("targetResourceId"), out var __jsonTargetResourceId) ? (string)__jsonTargetResourceId : (string)_targetResourceId;}
            ...
            {_lastComplianceStatusChecked = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("lastComplianceStatusChecked"), out var __jsonLastComplianceStatusChecked) ? global::System.DateTime.TryParse((string)__jsonLastComplianceStatusChecked, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonLastComplianceStatusCheckedValue) ? __jsonLastComplianceStatusCheckedValue : _lastComplianceStatusChecked : _lastComplianceStatusChecked;}
            {_latestReportId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("latestReportId"), out var __jsonLatestReportId) ? (string)__jsonLatestReportId : (string)_latestReportId;}
            {_parameterHash = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("parameterHash"), out var __jsonParameterHash) ? (string)__jsonParameterHash : (string)_parameterHash;}
            {_context = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("context"), out var __jsonContext) ? (string)__jsonContext : (string)_context;}
            {_assignmentHash = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("assignmentHash"), out var __jsonAssignmentHash) ? (string)__jsonAssignmentHash : (string)_assignmentHash;}
            {_provisioningState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("provisioningState"), out var __jsonProvisioningState) ? (string)__jsonProvisioningState : (string)_provisioningState;}
            {_resourceType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("resourceType"), out var __jsonResourceType) ? (string)__jsonResourceType : (string)_resourceType;}
            {_vmssVMList = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonArray>("vmssVMList"), out var __jsonVmssVMList) ? If( __jsonVmssVMList as Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IVmssvmInfo>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IVmssvmInfo) (Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.VmssvmInfo.FromJson(__u) )) ))() : null : _vmssVMList;}
            AfterFromJson(json);
        }
