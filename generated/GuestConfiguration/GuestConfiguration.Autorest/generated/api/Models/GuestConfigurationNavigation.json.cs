...
namespace Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models
{
    ...
    public partial class GuestConfigurationNavigation
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IGuestConfigurationNavigation.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IGuestConfigurationNavigation.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IGuestConfigurationNavigation FromJson(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonNode node)
        {
        ...
        internal GuestConfigurationNavigation(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            {_configurationSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonObject>("configurationSetting"), out var __jsonConfigurationSetting) ? Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.ConfigurationSetting.FromJson(__jsonConfigurationSetting) : _configurationSetting;}
            {_kind = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("kind"), out var __jsonKind) ? (string)__jsonKind : (string)_kind;}
            ...
            {_contentUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("contentUri"), out var __jsonContentUri) ? (string)__jsonContentUri : (string)_contentUri;}
            {_contentHash = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("contentHash"), out var __jsonContentHash) ? (string)__jsonContentHash : (string)_contentHash;}
            {_assignmentType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("assignmentType"), out var __jsonAssignmentType) ? (string)__jsonAssignmentType : (string)_assignmentType;}
            {_assignmentSource = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("assignmentSource"), out var __jsonAssignmentSource) ? (string)__jsonAssignmentSource : (string)_assignmentSource;}
            {_contentType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("contentType"), out var __jsonContentType) ? (string)__jsonContentType : (string)_contentType;}
            {_configurationParameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonArray>("configurationParameter"), out var __jsonConfigurationParameter) ? If( __jsonConfigurationParameter as Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IConfigurationParameter>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IConfigurationParameter) (Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.ConfigurationParameter.FromJson(__u) )) ))() : null : _configurationParameter;}
            {_configurationProtectedParameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonArray>("configurationProtectedParameter"), out var __jsonConfigurationProtectedParameter) ? If( __jsonConfigurationProtectedParameter as Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IConfigurationParameter>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IConfigurationParameter) (Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.ConfigurationParameter.FromJson(__p) )) ))() : null : _configurationProtectedParameter;}
            AfterFromJson(json);
        }
