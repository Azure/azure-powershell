...
namespace Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models
{
    ...
    public partial class ConfigurationSetting
    {
        ...
        internal ConfigurationSetting(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            {_configurationMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("configurationMode"), out var __jsonConfigurationMode) ? (string)__jsonConfigurationMode : (string)_configurationMode;}
            {_allowModuleOverwrite = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonBoolean>("allowModuleOverwrite"), out var __jsonAllowModuleOverwrite) ? (bool?)__jsonAllowModuleOverwrite : _allowModuleOverwrite;}
            {_actionAfterReboot = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("actionAfterReboot"), out var __jsonActionAfterReboot) ? (string)__jsonActionAfterReboot : (string)_actionAfterReboot;}
            {_refreshFrequencyMin = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonNumber>("refreshFrequencyMins"), out var __jsonRefreshFrequencyMins) ? (float?)__jsonRefreshFrequencyMins : _refreshFrequencyMin;}
            {_rebootIfNeeded = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonBoolean>("rebootIfNeeded"), out var __jsonRebootIfNeeded) ? (bool?)__jsonRebootIfNeeded : _rebootIfNeeded;}
            {_configurationModeFrequencyMin = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonNumber>("configurationModeFrequencyMins"), out var __jsonConfigurationModeFrequencyMins) ? (float?)__jsonConfigurationModeFrequencyMins : _configurationModeFrequencyMin;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IConfigurationSetting.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IConfigurationSetting.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IConfigurationSetting FromJson(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonNode node)
        {
