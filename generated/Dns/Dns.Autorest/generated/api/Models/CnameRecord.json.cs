...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dns.Models
{
    ...
    public partial class CnameRecord
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject into a new instance of <see cref="CnameRecord" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal CnameRecord(Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject json)
        {
            ...
            {_cname = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonString>("cname"), out var __jsonCname) ? (string)__jsonCname : (string)_cname;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.ICnameRecord.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.ICnameRecord.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.ICnameRecord FromJson(Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject json ? new CnameRecord(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CnameRecord" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CnameRecord" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._cname)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonString(this._cname.ToString()) : null, "cname" ,container.Add );
