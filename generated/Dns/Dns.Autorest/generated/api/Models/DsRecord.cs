...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dns.Models
{
    ...
    public partial class DsRecord :
        Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IDsRecord,
        Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IDsRecordInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IDigest _digest;

        /// <summary>The digest entity.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Dns.Origin(Microsoft.Azure.PowerShell.Cmdlets.Dns.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IDigest Digest { get => (this._digest = this._digest ?? new Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.Digest()); set => this._digest = value; }
        ...
        public int? DigestAlgorithmType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IDigestInternal)Digest).AlgorithmType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IDigestInternal)Digest).AlgorithmType = value ?? default(int); }

        /// <summary>
        /// The digest value is a cryptographic hash value of the referenced DNSKEY Resource Record.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Dns.Origin(Microsoft.Azure.PowerShell.Cmdlets.Dns.PropertyOrigin.Inlined)]
        public string DigestValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IDigestInternal)Digest).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IDigestInternal)Digest).Value = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IDigest Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IDsRecordInternal.Digest { get => (this._digest = this._digest ?? new Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.Digest()); set { {_digest = value;} } }
...

    {
        ...
        int? Algorithm { get; set; }
        /// <summary>The digest entity.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IDigest Digest { get; set; }
        /// <summary>
        /// The digest algorithm type represents the standard digest algorithm number used to construct the digest. See: https://www.iana.org/assignments/ds-rr-types/ds-rr-types.xhtml
        /// </summary>
        int? DigestAlgorithmType { get; set; }
