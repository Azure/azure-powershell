...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dns.Models
{
    ...
    public partial class PtrRecord
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IPtrRecord.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IPtrRecord.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IPtrRecord FromJson(Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject json ? new PtrRecord(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject into a new instance of <see cref="PtrRecord" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PtrRecord(Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject json)
        {
            ...
            {_ptrdname = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonString>("ptrdname"), out var __jsonPtrdname) ? (string)__jsonPtrdname : (string)_ptrdname;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PtrRecord" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PtrRecord" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._ptrdname)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonString(this._ptrdname.ToString()) : null, "ptrdname" ,container.Add );
