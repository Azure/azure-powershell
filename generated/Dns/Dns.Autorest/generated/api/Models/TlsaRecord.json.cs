...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dns.Models
{
    ...
    public partial class TlsaRecord
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.ITlsaRecord.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.ITlsaRecord.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.ITlsaRecord FromJson(Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode node)
        {
        ...
        internal TlsaRecord(Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject json)
        {
            ...
            {_usage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNumber>("usage"), out var __jsonUsage) ? (int?)__jsonUsage : _usage;}
            {_selector = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNumber>("selector"), out var __jsonSelector) ? (int?)__jsonSelector : _selector;}
            {_matchingType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNumber>("matchingType"), out var __jsonMatchingType) ? (int?)__jsonMatchingType : _matchingType;}
            {_certAssociationData = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonString>("certAssociationData"), out var __jsonCertAssociationData) ? (string)__jsonCertAssociationData : (string)_certAssociationData;}
            AfterFromJson(json);
        }
