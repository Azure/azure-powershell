...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.Api20230701Preview
{
    ...
    public partial class DnsResourceReferenceResultProperties
    {
        ...
        internal DnsResourceReferenceResultProperties(Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject json)
        {
            ...
            {_dnsResourceReference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonArray>("dnsResourceReferences"), out var __jsonDnsResourceReferences) ? If( __jsonDnsResourceReferences as Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.Api20230701Preview.IDnsResourceReference[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.Api20230701Preview.IDnsResourceReference) (Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.Api20230701Preview.DnsResourceReference.FromJson(__u) )) ))() : null : DnsResourceReference;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.Api20230701Preview.IDnsResourceReferenceResultProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.Api20230701Preview.IDnsResourceReferenceResultProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.Api20230701Preview.IDnsResourceReferenceResultProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode node)
        {
