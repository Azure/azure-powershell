...
namespace Microsoft.Azure.PowerShell.Cmdlets.Carbon.Models
{
    ...
    public partial class CarbonIdentity
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonObject into a new instance of <see cref="CarbonIdentity" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal CarbonIdentity(Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonObject json)
        {
            ...
            {_id = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonString>("id"), out var __jsonId) ? (string)__jsonId : (string)_id;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Carbon.Models.ICarbonIdentity.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Carbon.Models.ICarbonIdentity.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Carbon.Models.ICarbonIdentity FromJson(Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonObject json ? new CarbonIdentity(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CarbonIdentity" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CarbonIdentity" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._id)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonString(this._id.ToString()) : null, "id" ,container.Add );
