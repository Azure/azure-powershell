...
namespace Microsoft.Azure.PowerShell.Cmdlets.Carbon.Models
{
    ...
    public partial class TopItemsSummaryReportQueryFilter
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Carbon.Models.ITopItemsSummaryReportQueryFilter.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Carbon.Models.ITopItemsSummaryReportQueryFilter.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Carbon.Models.ITopItemsSummaryReportQueryFilter FromJson(Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonObject json ? new TopItemsSummaryReportQueryFilter(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="TopItemsSummaryReportQueryFilter" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="TopItemsSummaryReportQueryFilter" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( (Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonNumber(this._topItem), "topItems" ,container.Add );
            AfterToJson(ref container);
            return container;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonObject into a new instance of <see cref="TopItemsSummaryReportQueryFilter" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal TopItemsSummaryReportQueryFilter(Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_topItem = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Carbon.Runtime.Json.JsonNumber>("topItems"), out var __jsonTopItems) ? (int)__jsonTopItems : _topItem;}
            AfterFromJson(json);
        }
    }
}