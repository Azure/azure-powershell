...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Carbon.Models.IOperation
.Link
https://learn.microsoft.com/powershell/module/az.carbon/get-azcarbonoperation
#>
function Get-AzCarbonOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Carbon.Models.IOperation])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.Carbon.private\Get-AzCarbonOperation_List';
        }
