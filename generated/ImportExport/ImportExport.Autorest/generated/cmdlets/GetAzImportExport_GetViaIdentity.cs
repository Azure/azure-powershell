...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzImportExport_GetViaIdentity" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.JobsGet(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.JobName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("AcceptLanguage") ? AcceptLanguage : null, onOk, onDefault, this, Pipeline);
                    }
