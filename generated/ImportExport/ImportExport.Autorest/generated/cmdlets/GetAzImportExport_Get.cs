...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzImportExport_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.JobsGet(SubscriptionId, ResourceGroupName, Name, this.InvocationInformation.BoundParameters.ContainsKey("AcceptLanguage") ? AcceptLanguage : null, onOk, onDefault, this, Pipeline);
