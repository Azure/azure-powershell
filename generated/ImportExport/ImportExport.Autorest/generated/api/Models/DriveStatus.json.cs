...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models
{
    ...
    public partial class DriveStatus
    {
        ...
        internal DriveStatus(Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonObject json)
        {
            ...
            {_driveId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonString>("driveId"), out var __jsonDriveId) ? (string)__jsonDriveId : (string)_driveId;}
            {_bitLockerKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonString>("bitLockerKey"), out var __jsonBitLockerKey) ? (string)__jsonBitLockerKey : (string)_bitLockerKey;}
            {_manifestFile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonString>("manifestFile"), out var __jsonManifestFile) ? (string)__jsonManifestFile : (string)_manifestFile;}
            {_manifestHash = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonString>("manifestHash"), out var __jsonManifestHash) ? (string)__jsonManifestHash : (string)_manifestHash;}
            {_driveHeaderHash = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonString>("driveHeaderHash"), out var __jsonDriveHeaderHash) ? (string)__jsonDriveHeaderHash : (string)_driveHeaderHash;}
            {_state = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonString>("state"), out var __jsonState) ? (string)__jsonState : (string)_state;}
            {_copyStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonString>("copyStatus"), out var __jsonCopyStatus) ? (string)__jsonCopyStatus : (string)_copyStatus;}
            {_percentComplete = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonNumber>("percentComplete"), out var __jsonPercentComplete) ? (long?)__jsonPercentComplete : _percentComplete;}
            {_verboseLogUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonString>("verboseLogUri"), out var __jsonVerboseLogUri) ? (string)__jsonVerboseLogUri : (string)_verboseLogUri;}
            {_errorLogUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonString>("errorLogUri"), out var __jsonErrorLogUri) ? (string)__jsonErrorLogUri : (string)_errorLogUri;}
            {_manifestUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonString>("manifestUri"), out var __jsonManifestUri) ? (string)__jsonManifestUri : (string)_manifestUri;}
            {_bytesSucceeded = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonNumber>("bytesSucceeded"), out var __jsonBytesSucceeded) ? (long?)__jsonBytesSucceeded : _bytesSucceeded;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IDriveStatus.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IDriveStatus.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IDriveStatus FromJson(Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonNode node)
        {
