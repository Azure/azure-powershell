...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models
{
    ...
    public partial class JobDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IJobDetails.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IJobDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IJobDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonNode node)
        {
        ...
        internal JobDetails(Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonObject json)
        {
            ...
            {_shippingInformation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonObject>("shippingInformation"), out var __jsonShippingInformation) ? Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.ShippingInformation.FromJson(__jsonShippingInformation) : _shippingInformation;}
            ...
            {_returnPackage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonObject>("returnPackage"), out var __jsonReturnPackage) ? Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.PackageInformation.FromJson(__jsonReturnPackage) : _returnPackage;}
            {_export = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonObject>("export"), out var __jsonExport) ? Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.Export.FromJson(__jsonExport) : _export;}
            {_encryptionKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonObject>("encryptionKey"), out var __jsonEncryptionKey) ? Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.EncryptionKeyDetails.FromJson(__jsonEncryptionKey) : _encryptionKey;}
            {_storageAccountId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonString>("storageAccountId"), out var __jsonStorageAccountId) ? (string)__jsonStorageAccountId : (string)_storageAccountId;}
            {_jobType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonString>("jobType"), out var __jsonJobType) ? (string)__jsonJobType : (string)_jobType;}
            {_diagnosticsPath = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonString>("diagnosticsPath"), out var __jsonDiagnosticsPath) ? (string)__jsonDiagnosticsPath : (string)_diagnosticsPath;}
            ...
            {_incompleteBlobListUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonString>("incompleteBlobListUri"), out var __jsonIncompleteBlobListUri) ? (string)__jsonIncompleteBlobListUri : (string)_incompleteBlobListUri;}
            ...
            {_provisioningState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonString>("provisioningState"), out var __jsonProvisioningState) ? (string)__jsonProvisioningState : (string)_provisioningState;}
            AfterFromJson(json);
        }
