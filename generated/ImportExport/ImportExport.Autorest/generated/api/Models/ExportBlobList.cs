...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models
{
    ...
    public partial class ExportBlobList :
        Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IExportBlobList,
        Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IExportBlobListInternal
    {

        /// <summary>Backing field for <see cref="BlobPath" /> property.</summary>
        private System.Collections.Generic.List<string> _blobPath;
        ...
        public System.Collections.Generic.List<string> BlobPath { get => this._blobPath; set => this._blobPath = value; }

        /// <summary>Backing field for <see cref="BlobPathPrefix" /> property.</summary>
        private System.Collections.Generic.List<string> _blobPathPrefix;

        /// <summary>A collection of blob-prefix strings.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImportExport.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> BlobPathPrefix { get => this._blobPathPrefix; set => this._blobPathPrefix = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> BlobPathPrefix { get; set; }
