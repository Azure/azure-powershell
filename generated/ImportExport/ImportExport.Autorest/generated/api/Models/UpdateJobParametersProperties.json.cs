...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models
{
    ...
    public partial class UpdateJobParametersProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IUpdateJobParametersProperties.
        /// </summary>
        ...
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IUpdateJobParametersProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonNode node)
        {
        ...
        internal UpdateJobParametersProperties(Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonObject json)
        {
            ...
            {_returnAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonObject>("returnAddress"), out var __jsonReturnAddress) ? Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.ReturnAddress.FromJson(__jsonReturnAddress) : _returnAddress;}
            {_returnShipping = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonObject>("returnShipping"), out var __jsonReturnShipping) ? Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.ReturnShipping.FromJson(__jsonReturnShipping) : _returnShipping;}
            {_deliveryPackage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonObject>("deliveryPackage"), out var __jsonDeliveryPackage) ? Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.DeliveryPackageInformation.FromJson(__jsonDeliveryPackage) : _deliveryPackage;}
            {_cancelRequested = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonBoolean>("cancelRequested"), out var __jsonCancelRequested) ? (bool?)__jsonCancelRequested : _cancelRequested;}
            ...
            {_logLevel = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonString>("logLevel"), out var __jsonLogLevel) ? (string)__jsonLogLevel : (string)_logLevel;}
            {_backupDriveManifest = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonBoolean>("backupDriveManifest"), out var __jsonBackupDriveManifest) ? (bool?)__jsonBackupDriveManifest : _backupDriveManifest;}
            {_driveList = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonArray>("driveList"), out var __jsonDriveList) ? If( __jsonDriveList as Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IDriveStatus>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IDriveStatus) (Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.DriveStatus.FromJson(__u) )) ))() : null : _driveList;}
            AfterFromJson(json);
        }
    }
}