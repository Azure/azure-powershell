...
namespace Microsoft.Azure.PowerShell.Cmdlets.Sphere.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListDeviceGroups=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureSphere/catalogs/{catalogName}/listDeviceGroups"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzSphereCatalogDeviceGroup_ListExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Sphere.Models.IDeviceGroup))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sphere.Description(@"List the device groups for the catalog.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sphere.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sphere.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureSphere/catalogs/{catalogName}/listDeviceGroups", ApiVersion = "2024-04-01")]
    public partial class GetAzSphereCatalogDeviceGroup_ListExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Sphere.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Device Group name.")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzSphereCatalogDeviceGroup_ListExpanded" /> cmdlet class.
        /// </summary>
        public GetAzSphereCatalogDeviceGroup_ListExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CatalogsListDeviceGroups' operation"))
                {
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.CatalogsListDeviceGroups_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
