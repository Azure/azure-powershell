...
namespace Microsoft.Azure.PowerShell.Cmdlets.Sphere.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListBySubscription=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.AzureSphere/catalogs"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzSphereCatalog_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Sphere.Models.ICatalog))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sphere.Description(@"List Catalog resources by subscription ID")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sphere.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sphere.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.AzureSphere/catalogs", ApiVersion = "2024-04-01")]
    public partial class GetAzSphereCatalog_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Sphere.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzSphereCatalog_List" /> cmdlet class.
        /// </summary>
        public GetAzSphereCatalog_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.CatalogsListBySubscription(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.CatalogsListBySubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
