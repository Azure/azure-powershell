...
namespace Microsoft.Azure.PowerShell.Cmdlets.Sphere.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureSphere/catalogs/{catalogName}/products/{productName}/deviceGroups/{deviceGroupName}/devices/{deviceName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzSphereDevice_Get")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Sphere.Models.IDevice))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sphere.Description(@"Get a Device. Use '.unassigned' or '.default' for the device group and product names when a device does not belong to a device group and product.")]
    ...
    public partial class GetAzSphereDevice_Get : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Sphere.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzSphereDevice_Get" /> cmdlet class.
        /// </summary>
        public GetAzSphereDevice_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.DevicesGet(SubscriptionId, ResourceGroupName, CatalogName, ProductName, GroupName, Name, onOk, onDefault, this, Pipeline);
