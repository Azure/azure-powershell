...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/vmGroups/{vmGroupId}", ApiVersion = "2024-09-01")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IContext
    {
        ...
        public string DisplayName { get => _workloadNetworkVMGroupBody.DisplayName ?? null; set => _workloadNetworkVMGroupBody.DisplayName = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] Member { get => _workloadNetworkVMGroupBody.Member?.ToArray() ?? null /* fixedArrayOf */; set => _workloadNetworkVMGroupBody.Member = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        public long Revision { get => _workloadNetworkVMGroupBody.Revision ?? default(long); set => _workloadNetworkVMGroupBody.Revision = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IWorkloadNetworkVMGroup">Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IWorkloadNetworkVMGroup</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IWorkloadNetworkVMGroup> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzVMwareWorkloadNetworkVMGroup_UpdateViaIdentityPrivateCloudExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets.UpdateAzVMwareWorkloadNetworkVMGroup_UpdateViaIdentityPrivateCloudExpanded Clone()
        {
            var clone = new UpdateAzVMwareWorkloadNetworkVMGroup_UpdateViaIdentityPrivateCloudExpanded();
            ...
            clone._workloadNetworkVMGroupBody = this._workloadNetworkVMGroupBody;
            clone.VMGroupName = this.VMGroupName;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.PrivateCloudInputObject.Id += $"/vmGroups/{(global::System.Uri.EscapeDataString(this.VMGroupName.ToString()))}";
                        await this.Client.WorkloadNetworksUpdateVMGroupViaIdentity(PrivateCloudInputObject.Id, _workloadNetworkVMGroupBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        await this.Client.WorkloadNetworksUpdateVMGroup(PrivateCloudInputObject.SubscriptionId ?? null, PrivateCloudInputObject.ResourceGroupName ?? null, PrivateCloudInputObject.PrivateCloudName ?? null, VMGroupName, _workloadNetworkVMGroupBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.SerializationMode.IncludeUpdate);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { VMGroupName=VMGroupName})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzVMwareWorkloadNetworkVMGroup_UpdateViaIdentityPrivateCloudExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzVMwareWorkloadNetworkVMGroup_UpdateViaIdentityPrivateCloudExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IWorkloadNetworkVMGroup> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IWorkloadNetworkVMGroup
