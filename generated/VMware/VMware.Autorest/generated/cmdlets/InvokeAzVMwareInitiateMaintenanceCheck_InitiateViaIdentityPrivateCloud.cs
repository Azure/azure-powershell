...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzVMwareInitiateMaintenanceCheck_InitiateViaIdentityPrivateCloud", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzVMwareInitiateMaintenanceCheck_InitiateViaIdentityPrivateCloud : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzVMwareInitiateMaintenanceCheck_InitiateViaIdentityPrivateCloud" />
        /// cmdlet class.
        /// </summary>
        public InvokeAzVMwareInitiateMaintenanceCheck_InitiateViaIdentityPrivateCloud()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (PrivateCloudInputObject?.Id != null)
                    {
                        ...
                        await this.Client.MaintenancesInitiateChecksViaIdentity(PrivateCloudInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.MaintenancesInitiateChecks(PrivateCloudInputObject.SubscriptionId ?? null, PrivateCloudInputObject.ResourceGroupName ?? null, PrivateCloudInputObject.PrivateCloudName ?? null, MaintenanceName, onOk, onDefault, this, Pipeline);
                    }
