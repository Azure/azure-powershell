...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Models
{
    ...
    public partial class ScheduleOperationConstraint
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IScheduleOperationConstraint.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IScheduleOperationConstraint interface is polymorphic, and
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IScheduleOperationConstraint.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IScheduleOperationConstraint FromJson(Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("kind") )
            {
                ...
                {
                    return new AvailableWindowForMaintenanceWhileScheduleOperation(json);
                }
                case "Blocked":
                {
                    return new BlockedWhileScheduleOperation(json);
                }
                case "SchedulingWindow":
                {
                    return new SchedulingWindow(json);
                }
            }
            return new ScheduleOperationConstraint(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject into a new instance of <see cref="ScheduleOperationConstraint" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ScheduleOperationConstraint(Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="ScheduleOperationConstraint" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ScheduleOperationConstraint" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode" />.
        /// </returns>
