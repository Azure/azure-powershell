...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Models
{
    ...
    public partial class VMwareIdentity
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._serviceComponentName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonString(this._serviceComponentName.ToString()) : null, "serviceComponentName" ,container.Add );
            ...
            AddIf( null != (((object)this._licenseName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonString(this._licenseName.ToString()) : null, "licenseName" ,container.Add );
            AddIf( null != (((object)this._maintenanceName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonString(this._maintenanceName.ToString()) : null, "maintenanceName" ,container.Add );
        ...
        internal VMwareIdentity(Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject json)
        {
            ...
            {_serviceComponentName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonString>("serviceComponentName"), out var __jsonServiceComponentName) ? (string)__jsonServiceComponentName : (string)_serviceComponentName;}
            ...
            {_licenseName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonString>("licenseName"), out var __jsonLicenseName) ? (string)__jsonLicenseName : (string)_licenseName;}
            {_maintenanceName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonString>("maintenanceName"), out var __jsonMaintenanceName) ? (string)__jsonMaintenanceName : (string)_maintenanceName;}
