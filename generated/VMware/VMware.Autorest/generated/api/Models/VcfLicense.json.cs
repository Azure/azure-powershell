...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Models
{
    ...
    public partial class VcfLicense
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IVcfLicense.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IVcfLicense interface is polymorphic, and the precise model
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IVcfLicense.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IVcfLicense FromJson(Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("kind") )
            {
                case "vcf5":
                {
                    return new Vcf5License(json);
                }
            }
            return new VcfLicense(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="VcfLicense" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="VcfLicense" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode" />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject into a new instance of <see cref="VcfLicense" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal VcfLicense(Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
