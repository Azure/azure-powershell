...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Models
{
    ...
    public partial class RescheduleOperationConstraint
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IRescheduleOperationConstraint.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IRescheduleOperationConstraint interface is polymorphic, and
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IRescheduleOperationConstraint.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IRescheduleOperationConstraint FromJson(Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("kind") )
            {
                ...
                {
                    return new AvailableWindowForMaintenanceWhileRescheduleOperation(json);
                }
                case "Blocked":
                {
                    return new BlockedWhileRescheduleOperation(json);
                }
            }
            return new RescheduleOperationConstraint(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject into a new instance of <see cref="RescheduleOperationConstraint" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal RescheduleOperationConstraint(Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="RescheduleOperationConstraint" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="RescheduleOperationConstraint" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode" />.
        /// </returns>
