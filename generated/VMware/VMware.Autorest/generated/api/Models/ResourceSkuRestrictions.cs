...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Models
{
    ...
    public partial class ResourceSkuRestrictions :
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IResourceSkuRestrictions,
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IResourceSkuRestrictionsInternal
    {

        /// <summary>Internal Acessors for RestrictionInfo</summary>
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IResourceSkuRestrictionInfo Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IResourceSkuRestrictionsInternal.RestrictionInfo { get => (this._restrictionInfo = this._restrictionInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.ResourceSkuRestrictionInfo()); set { {_restrictionInfo = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IResourceSkuRestrictionInfo _restrictionInfo;

        /// <summary>The information about the restriction where the SKU cannot be used.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.VMware.Origin(Microsoft.Azure.PowerShell.Cmdlets.VMware.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IResourceSkuRestrictionInfo RestrictionInfo { get => (this._restrictionInfo = this._restrictionInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.ResourceSkuRestrictionInfo()); set => this._restrictionInfo = value; }

        /// <summary>Locations where the SKU is restricted</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.VMware.Origin(Microsoft.Azure.PowerShell.Cmdlets.VMware.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> RestrictionInfoLocation { get => ((Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IResourceSkuRestrictionInfoInternal)RestrictionInfo).Location; set => ((Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IResourceSkuRestrictionInfoInternal)RestrictionInfo).Location = value ?? null /* arrayOf */; }

        /// <summary>List of availability zones where the SKU is restricted.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.VMware.Origin(Microsoft.Azure.PowerShell.Cmdlets.VMware.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> RestrictionInfoZone { get => ((Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IResourceSkuRestrictionInfoInternal)RestrictionInfo).Zone; set => ((Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IResourceSkuRestrictionInfoInternal)RestrictionInfo).Zone = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IJsonSerializable
    {
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.PSArgumentCompleterAttribute("QuotaId", "NotAvailableForSubscription")]
        ...
        SerializedName = @"type",
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.PSArgumentCompleterAttribute("Location", "Zone")]
        string Type { get; set; }
        /// <summary>
        /// The value of restrictions. If the restriction type is set to location. This would be different locations where the SKU
        /// is restricted.
...

    {
        ...
        string ReasonCode { get; set; }
        /// <summary>The information about the restriction where the SKU cannot be used.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IResourceSkuRestrictionInfo RestrictionInfo { get; set; }
        /// <summary>Locations where the SKU is restricted</summary>
        System.Collections.Generic.List<string> RestrictionInfoLocation { get; set; }
        /// <summary>List of availability zones where the SKU is restricted.</summary>
        System.Collections.Generic.List<string> RestrictionInfoZone { get; set; }
