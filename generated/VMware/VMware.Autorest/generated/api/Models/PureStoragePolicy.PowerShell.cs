...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Models
{
    ...
    [System.ComponentModel.TypeConverter(typeof(PureStoragePolicyTypeConverter))]
    public partial class PureStoragePolicy
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="global::System.Collections.IDictionary" /> into an instance of <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.PureStoragePolicy"
        /// />.
        /// </summary>
        /// <param name="content">The global::System.Collections.IDictionary content that should be used.</param>
        /// <returns>
        /// an instance of <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPureStoragePolicy" />.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPureStoragePolicy DeserializeFromDictionary(global::System.Collections.IDictionary content)
        {
            return new PureStoragePolicy(content);
        }

        /// <summary>
        /// Deserializes a <see cref="global::System.Management.Automation.PSObject" /> into an instance of <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.PureStoragePolicy"
        /// />.
        /// </summary>
        /// <param name="content">The global::System.Management.Automation.PSObject content that should be used.</param>
        /// <returns>
        /// an instance of <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPureStoragePolicy" />.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPureStoragePolicy DeserializeFromPSObject(global::System.Management.Automation.PSObject content)
        {
            return new PureStoragePolicy(content);
        }

        /// <summary>
        /// Creates a new instance of <see cref="PureStoragePolicy" />, deserializing the content from a json string.
        /// </summary>
        /// <param name="jsonText">a string containing a JSON serialized instance of this model.</param>
        /// <returns>an instance of the <see cref="PureStoragePolicy" /> model class.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPureStoragePolicy FromJsonString(string jsonText) => FromJson(Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode.Parse(jsonText));

        /// <summary>
        /// Deserializes a <see cref="global::System.Collections.IDictionary" /> into a new instance of <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.PureStoragePolicy"
        /// />.
        /// </summary>
        /// <param name="content">The global::System.Collections.IDictionary content that should be used.</param>
        internal PureStoragePolicy(global::System.Collections.IDictionary content)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPureStoragePolicyInternal)this).Property = (Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPureStoragePolicyProperties) content.GetValueForProperty("Property",((Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPureStoragePolicyInternal)this).Property, Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.PureStoragePolicyPropertiesTypeConverter.ConvertFrom);
            }
            ...
            if (content.Contains("StoragePolicyDefinition"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPureStoragePolicyInternal)this).StoragePolicyDefinition = (string) content.GetValueForProperty("StoragePolicyDefinition",((Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPureStoragePolicyInternal)this).StoragePolicyDefinition, global::System.Convert.ToString);
            }
            if (content.Contains("StoragePoolId"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPureStoragePolicyInternal)this).StoragePoolId = (string) content.GetValueForProperty("StoragePoolId",((Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPureStoragePolicyInternal)this).StoragePoolId, global::System.Convert.ToString);
            }
            if (content.Contains("ProvisioningState"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPureStoragePolicyInternal)this).ProvisioningState = (string) content.GetValueForProperty("ProvisioningState",((Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPureStoragePolicyInternal)this).ProvisioningState, global::System.Convert.ToString);
            }
            AfterDeserializeDictionary(content);
        }

        /// <summary>
        /// Deserializes a <see cref="global::System.Management.Automation.PSObject" /> into a new instance of <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.PureStoragePolicy"
        /// />.
        /// </summary>
        /// <param name="content">The global::System.Management.Automation.PSObject content that should be used.</param>
        internal PureStoragePolicy(global::System.Management.Automation.PSObject content)
        {
            bool returnNow = false;
