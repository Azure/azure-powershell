...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models
{
    ...
    public partial class HybridComputePrivateLinkScope :
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IHybridComputePrivateLinkScope,
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IHybridComputePrivateLinkScopeInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateLinkScopesResource"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateLinkScopesResource __privateLinkScopesResource = new Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.PrivateLinkScopesResource();
        ...
        public string Id { get => ((Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateLinkScopesResourceInternal)__privateLinkScopesResource).Id; }
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateEndpointConnectionDataModel> Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IHybridComputePrivateLinkScopeInternal.PrivateEndpointConnection { get => ((Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IHybridComputePrivateLinkScopePropertiesInternal)Property).PrivateEndpointConnection; set => ((Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IHybridComputePrivateLinkScopePropertiesInternal)Property).PrivateEndpointConnection = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Origin(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.PropertyOrigin.Inherited)]
        public string Name { get => ((Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateLinkScopesResourceInternal)__privateLinkScopesResource).Name; }
        ...
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateEndpointConnectionDataModel> PrivateEndpointConnection { get => ((Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IHybridComputePrivateLinkScopePropertiesInternal)Property).PrivateEndpointConnection; }

        /// <summary>The Guid id of the private link scope.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Origin(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.PropertyOrigin.Inlined)]
        public string PrivateLinkScopeId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IHybridComputePrivateLinkScopePropertiesInternal)Property).PrivateLinkScopeId; }

        /// <summary>Backing field for <see cref="Property" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IHybridComputePrivateLinkScopeProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IHybridComputePrivateLinkScopeProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.HybridComputePrivateLinkScopeProperties()); set => this._property = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Origin(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.PropertyOrigin.Inlined)]
        public string ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IHybridComputePrivateLinkScopePropertiesInternal)Property).ProvisioningState; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.ISystemData _systemData;

        /// <summary>The system meta data relating to this resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Origin(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.ISystemData SystemData { get => (this._systemData = this._systemData ?? new Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.SystemData()); }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Origin(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.PropertyOrigin.Inherited)]
        public Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateLinkScopesResourceTags Tag { get => ((Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateLinkScopesResourceInternal)__privateLinkScopesResource).Tag; set => ((Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateLinkScopesResourceInternal)__privateLinkScopesResource).Tag = value ?? null /* model class */; }

        /// <summary>Azure resource type</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Origin(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.PropertyOrigin.Inherited)]
        public string Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateLinkScopesResourceInternal)__privateLinkScopesResource).Type; }
    ...
    public partial interface IHybridComputePrivateLinkScope :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateLinkScopesResource
    {
        /// <summary>The collection of associated Private Endpoint Connections.</summary>
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateEndpointConnectionDataModel) })]
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateEndpointConnectionDataModel> PrivateEndpointConnection { get;  }
        /// <summary>The Guid id of the private link scope.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.PSArgumentCompleterAttribute("Enabled", "Disabled", "SecuredByPerimeter")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.PSArgumentCompleterAttribute("User", "Application", "ManagedIdentity", "Key")]
    ...
    internal partial interface IHybridComputePrivateLinkScopeInternal :
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateLinkScopesResourceInternal
    {
        /// <summary>The collection of associated Private Endpoint Connections.</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IPrivateEndpointConnectionDataModel> PrivateEndpointConnection { get; set; }
        /// <summary>The Guid id of the private link scope.</summary>
        string PrivateLinkScopeId { get; set; }
        /// <summary>Properties that define a Azure Arc PrivateLinkScope resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IHybridComputePrivateLinkScopeProperties Property { get; set; }
        /// <summary>
        /// Current state of this PrivateLinkScope: whether or not is has been provisioned within the resource group it is defined.
        /// Users cannot change this value but are able to read from it. Values will include Provisioning ,Succeeded, Canceled and
        /// Failed.
        ...
        string PublicNetworkAccess { get; set; }
        /// <summary>The system meta data relating to this resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.ISystemData SystemData { get; set; }
        /// <summary>The timestamp of resource creation (UTC).</summary>
