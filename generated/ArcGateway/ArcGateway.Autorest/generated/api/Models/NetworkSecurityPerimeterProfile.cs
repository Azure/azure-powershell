...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models
{
    ...
    public partial class NetworkSecurityPerimeterProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.INetworkSecurityPerimeterProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.INetworkSecurityPerimeterProfileInternal
    {

        /// <summary>Backing field for <see cref="AccessRule" /> property.</summary>
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IAccessRule> _accessRule;
        ...
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IAccessRule> AccessRule { get => this._accessRule; }
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IAccessRule> Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.INetworkSecurityPerimeterProfileInternal.AccessRule { get => this._accessRule; set { {_accessRule = value;} } }

        /// <summary>Internal Acessors for AccessRulesVersion</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.INetworkSecurityPerimeterProfileInternal.AccessRulesVersion { get => this._accessRulesVersion; set { {_accessRulesVersion = value;} } }

        /// <summary>Internal Acessors for DiagnosticSettingsVersion</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.INetworkSecurityPerimeterProfileInternal.DiagnosticSettingsVersion { get => this._diagnosticSettingsVersion; set { {_diagnosticSettingsVersion = value;} } }

        /// <summary>Internal Acessors for EnabledLogCategory</summary>
        System.Collections.Generic.List<string> Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.INetworkSecurityPerimeterProfileInternal.EnabledLogCategory { get => this._enabledLogCategory; set { {_enabledLogCategory = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.INetworkSecurityPerimeterProfileInternal.Name { get => this._name; set { {_name = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IAccessRule> AccessRule { get;  }
        /// <summary>Access rules version number</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Info(
        Required = false,
        ReadOnly = true,
    ...
    {
        /// <summary>Collection of access rules for the profile</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IAccessRule> AccessRule { get; set; }
        /// <summary>Access rules version number</summary>
