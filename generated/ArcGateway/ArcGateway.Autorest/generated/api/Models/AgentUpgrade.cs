...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models
{
    ...
    public partial class AgentUpgrade :
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IAgentUpgrade,
        Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IAgentUpgradeInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IAgentUpgradeInternal.LastAttemptDesiredVersion { get => this._lastAttemptDesiredVersion; set { {_lastAttemptDesiredVersion = value;} } }

        /// <summary>Internal Acessors for LastAttemptMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IAgentUpgradeInternal.LastAttemptMessage { get => this._lastAttemptMessage; set { {_lastAttemptMessage = value;} } }

        /// <summary>Internal Acessors for LastAttemptStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IAgentUpgradeInternal.LastAttemptStatus { get => this._lastAttemptStatus; set { {_lastAttemptStatus = value;} } }

        /// <summary>Internal Acessors for LastAttemptTimestamp</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IAgentUpgradeInternal.LastAttemptTimestamp { get => this._lastAttemptTimestamp; set { {_lastAttemptTimestamp = value;} } }
