...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoDB.Models
{
    ...
    public partial class AzureResourceManagerCommonTypesTrackedResourceUpdateTagsTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MongoDB.Models.IAzureResourceManagerCommonTypesTrackedResourceUpdateTags ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.MongoDB.Models.IAzureResourceManagerCommonTypesTrackedResourceUpdateTags).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
