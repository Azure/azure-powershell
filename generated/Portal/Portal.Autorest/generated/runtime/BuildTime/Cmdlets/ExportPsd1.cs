    ...
    public class ExportPsd1 : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                sb.AppendLine($@"{Indent}Description = '{"Microsoft Azure PowerShell: Portal Dashboard cmdlets"}'");
                ...
                sb.AppendLine($@"{Indent}{Indent}{Indent}Tags = {"Azure ResourceManager ARM PSModule Portal Dashboard".Split(' ').ToPsList().NullIfEmpty() ?? "''"}");
