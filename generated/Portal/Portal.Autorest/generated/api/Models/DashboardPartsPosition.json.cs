...
namespace Microsoft.Azure.PowerShell.Cmdlets.Portal.Models
{
    ...
    public partial class DashboardPartsPosition
    {
        ...
        internal DashboardPartsPosition(Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonObject json)
        {
            ...
            {_x = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonNumber>("x"), out var __jsonX) ? (int)__jsonX : _x;}
            {_y = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonNumber>("y"), out var __jsonY) ? (int)__jsonY : _y;}
            {_rowSpan = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonNumber>("rowSpan"), out var __jsonRowSpan) ? (int)__jsonRowSpan : _rowSpan;}
            {_colSpan = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonNumber>("colSpan"), out var __jsonColSpan) ? (int)__jsonColSpan : _colSpan;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Portal.Models.IDashboardPartsPosition.
        /// </summary>
