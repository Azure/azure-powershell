...
namespace Microsoft.Azure.PowerShell.Cmdlets.Relay.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzRelayAuthorizationRule_Get2" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AuthorizationRuleGet2(SubscriptionId, ResourceGroupName, Namespace, WcfRelay, Name, onOk, onDefault, this, Pipeline);
