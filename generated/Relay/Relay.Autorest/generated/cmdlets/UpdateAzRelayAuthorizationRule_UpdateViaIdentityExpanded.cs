...
namespace Microsoft.Azure.PowerShell.Cmdlets.Relay.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzRelayAuthorizationRule_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzRelayAuthorizationRule_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _parametersBody = await this.Client.AuthorizationRuleGet2ViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.AuthorizationRuleCreateOrUpdate2ViaIdentity(InputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _parametersBody = await this.Client.AuthorizationRuleGet2WithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.NamespaceName ?? null, InputObject.RelayName ?? null, InputObject.AuthorizationRuleName ?? null, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.AuthorizationRuleCreateOrUpdate2(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.NamespaceName ?? null, InputObject.RelayName ?? null, InputObject.AuthorizationRuleName ?? null, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzRelayAuthorizationRule_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzRelayAuthorizationRule_UpdateViaIdentityExpanded()
        {
