...
namespace Microsoft.Azure.PowerShell.Cmdlets.Relay.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRelayAuthorizationRule_Get1" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AuthorizationRuleGet1(ResourceGroupName, Namespace, HybridConnection, Name, SubscriptionId, onOk, onDefault, this, Pipeline);
