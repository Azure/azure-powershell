...
namespace Microsoft.Azure.PowerShell.Cmdlets.Relay.Cmdlets
{
    ...
    /// <summary>create a service hybrid connection. This operation is idempotent.</summary>
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Relay/namespaces/{namespaceName}/hybridConnections/{hybridConnectionName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzRelayHybridConnection_CreateViaIdentityNamespaceExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IHybridConnection))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Relay.Description(@"create a service hybrid connection. This operation is idempotent.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Relay.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Relay.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Relay/namespaces/{namespaceName}/hybridConnections/{hybridConnectionName}", ApiVersion = "2021-11-01")]
    public partial class NewAzRelayHybridConnection_CreateViaIdentityNamespaceExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IHybridConnection _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.HybridConnection();
        ...
        [global::System.Management.Automation.Alias("HybridConnectionName")]
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IRelayIdentity _namespaceInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Relay.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Relay.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IRelayIdentity NamespaceInputObject { get => this._namespaceInputObject; set => this._namespaceInputObject = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Returns true if client authorization is needed for this hybrid connection; otherwise, false.")]
        ...
        public global::System.Management.Automation.SwitchParameter RequiresClientAuthorization { get => _parametersBody.RequiresClientAuthorization ?? default(global::System.Management.Automation.SwitchParameter); set => _parametersBody.RequiresClientAuthorization = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The usermetadata is a placeholder to store user-defined string data for the hybrid connection endpoint. For example, it can be used to store descriptive data, such as a list of teams and their contact information. Also, user-defined configuration settings can be stored.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Relay.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Relay.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IHybridConnection">Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IHybridConnection</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IHybridConnection> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzRelayHybridConnection_CreateViaIdentityNamespaceExpanded" /> cmdlet
        /// class.
        /// </summary>
        public NewAzRelayHybridConnection_CreateViaIdentityNamespaceExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'HybridConnectionsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.NamespaceInputObject.Id += $"/hybridConnections/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.HybridConnectionsCreateOrUpdateViaIdentity(NamespaceInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        ...
                        await this.Client.HybridConnectionsCreateOrUpdate(NamespaceInputObject.SubscriptionId ?? null, NamespaceInputObject.ResourceGroupName ?? null, NamespaceInputObject.NamespaceName ?? null, Name, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.SerializationMode.IncludeCreate);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IHybridConnection> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IHybridConnection
