...
namespace Microsoft.Azure.PowerShell.Cmdlets.Relay.Cmdlets
{
    ...
    using Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.Cmdlets;
    using System;

    /// <summary>update an authorization rule for a WCF relay.</summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Relay/namespaces/{namespaceName}/wcfRelays/{relayName}/authorizationRules/{authorizationRuleName}"
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzRelayAuthorizationRule_UpdateViaIdentityWcfRelay", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IAuthorizationRule))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Relay.Description(@"update an authorization rule for a WCF relay.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Relay.Generated]
    public partial class UpdateAzRelayAuthorizationRule_UpdateViaIdentityWcfRelay : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.IEventListener,
        Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IAuthorizationRule _parameter;
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IAuthorizationRule) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Relay.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Relay.ParameterCategory.Body)]
        public Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IAuthorizationRule Parameter { get => this._parameter; set => this._parameter = value; }

        /// <summary>
        /// The instance of the <see cref="Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.HttpPipeline" /> that the remote call will use.
        /// </summary>
        public Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.HttpPipeline Pipeline { get; set; }
        ...
        /// <summary>Backing field for <see cref="WcfRelayInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IRelayIdentity _wcfRelayInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Relay.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Relay.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IRelayIdentity WcfRelayInputObject { get => this._wcfRelayInputObject; set => this._wcfRelayInputObject = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IErrorResponse">Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IErrorResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IErrorResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IAuthorizationRule">Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IAuthorizationRule</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IAuthorizationRule> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void EndProcessing()
        {
            ...
            var telemetryInfo = Microsoft.Azure.PowerShell.Cmdlets.Relay.Module.Instance.GetTelemetryInfo?.Invoke(__correlationId);
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.Events.Progress:
                    {
                        var data = messageData();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                Pipeline = Microsoft.Azure.PowerShell.Cmdlets.Relay.Module.Instance.CreatePipeline(InvocationInformation, __correlationId, __processRecordId, this.ParameterSetName, this.ExtensibleParameters);
                ...
                try
                {
                    ...
                    if (WcfRelayInputObject?.Id != null)
                    {
                        this.WcfRelayInputObject.Id += $"/authorizationRules/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        Parameter = await this.Client.AuthorizationRuleGet2ViaIdentityWithResult(WcfRelayInputObject.Id, this, Pipeline);
                        this.UpdateParameter();
                        await this.Client.AuthorizationRuleCreateOrUpdate2ViaIdentity(WcfRelayInputObject.Id, Parameter, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == WcfRelayInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("WcfRelayInputObject has null value for WcfRelayInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, WcfRelayInputObject) );
                        }
                        if (null == WcfRelayInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("WcfRelayInputObject has null value for WcfRelayInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, WcfRelayInputObject) );
                        }
                        if (null == WcfRelayInputObject.NamespaceName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("WcfRelayInputObject has null value for WcfRelayInputObject.NamespaceName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, WcfRelayInputObject) );
                        }
                        if (null == WcfRelayInputObject.RelayName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("WcfRelayInputObject has null value for WcfRelayInputObject.RelayName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, WcfRelayInputObject) );
                        }
                        Parameter = await this.Client.AuthorizationRuleGet2WithResult(WcfRelayInputObject.SubscriptionId ?? null, WcfRelayInputObject.ResourceGroupName ?? null, WcfRelayInputObject.NamespaceName ?? null, WcfRelayInputObject.RelayName ?? null, Name, this, Pipeline);
                        this.UpdateParameter();
                        await this.Client.AuthorizationRuleCreateOrUpdate2(WcfRelayInputObject.SubscriptionId ?? null, WcfRelayInputObject.ResourceGroupName ?? null, WcfRelayInputObject.NamespaceName ?? null, WcfRelayInputObject.RelayName ?? null, Name, Parameter, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzRelayAuthorizationRule_UpdateViaIdentityWcfRelay" /> cmdlet class.
        /// </summary>
        public UpdateAzRelayAuthorizationRule_UpdateViaIdentityWcfRelay()
        {
        ...
        private void UpdateParameter()
        {
            ...
            {
                this.Parameter = (Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IAuthorizationRule)(this.MyInvocation?.BoundParameters["Parameter"]);
            }
        }
        ...
        {
            Microsoft.Azure.PowerShell.Cmdlets.Relay.Module.Instance.SanitizeOutput?.Invoke(sendToPipeline, __correlationId);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IErrorResponse>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IAuthorizationRule> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Relay.Models.IAuthorizationRule
