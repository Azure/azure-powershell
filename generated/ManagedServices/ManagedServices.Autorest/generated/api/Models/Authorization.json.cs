...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models
{
    ...
    public partial class Authorization
    {
        ...
        internal Authorization(Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonObject json)
        {
            ...
            {_principalId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonString>("principalId"), out var __jsonPrincipalId) ? (string)__jsonPrincipalId : (string)_principalId;}
            {_principalIdDisplayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonString>("principalIdDisplayName"), out var __jsonPrincipalIdDisplayName) ? (string)__jsonPrincipalIdDisplayName : (string)_principalIdDisplayName;}
            {_roleDefinitionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonString>("roleDefinitionId"), out var __jsonRoleDefinitionId) ? (string)__jsonRoleDefinitionId : (string)_roleDefinitionId;}
            {_delegatedRoleDefinitionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonArray>("delegatedRoleDefinitionIds"), out var __jsonDelegatedRoleDefinitionIds) ? If( __jsonDelegatedRoleDefinitionIds as Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _delegatedRoleDefinitionId;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.IAuthorization.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.IAuthorization.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.IAuthorization FromJson(Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonNode node)
        {
