...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models
{
    ...
    public partial class JustInTimeAccessPolicy
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.IJustInTimeAccessPolicy.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.IJustInTimeAccessPolicy.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.IJustInTimeAccessPolicy FromJson(Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonNode node)
        {
        ...
        internal JustInTimeAccessPolicy(Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonObject json)
        {
            ...
            {_multiFactorAuthProvider = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonString>("multiFactorAuthProvider"), out var __jsonMultiFactorAuthProvider) ? (string)__jsonMultiFactorAuthProvider : (string)_multiFactorAuthProvider;}
            {_maximumActivationDuration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonString>("maximumActivationDuration"), out var __jsonMaximumActivationDuration) ? global::System.Xml.XmlConvert.ToTimeSpan( __jsonMaximumActivationDuration ) : _maximumActivationDuration;}
            {_managedByTenantApprover = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonArray>("managedByTenantApprovers"), out var __jsonManagedByTenantApprovers) ? If( __jsonManagedByTenantApprovers as Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.IEligibleApprover>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.IEligibleApprover) (Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.EligibleApprover.FromJson(__u) )) ))() : null : _managedByTenantApprover;}
            AfterFromJson(json);
        }
