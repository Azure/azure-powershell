...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models
{
    ...
    public partial class MarketplaceRegistrationDefinitionProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.IMarketplaceRegistrationDefinitionProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.IMarketplaceRegistrationDefinitionProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.IMarketplaceRegistrationDefinitionProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonNode node)
        {
        ...
        internal MarketplaceRegistrationDefinitionProperties(Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonObject json)
        {
            ...
            {_offerDisplayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonString>("offerDisplayName"), out var __jsonOfferDisplayName) ? (string)__jsonOfferDisplayName : (string)_offerDisplayName;}
            {_publisherDisplayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonString>("publisherDisplayName"), out var __jsonPublisherDisplayName) ? (string)__jsonPublisherDisplayName : (string)_publisherDisplayName;}
            {_planDisplayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Json.JsonString>("planDisplayName"), out var __jsonPlanDisplayName) ? (string)__jsonPlanDisplayName : (string)_planDisplayName;}
            AfterFromJson(json);
        }
