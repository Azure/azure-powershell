...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzManagedServicesDefinition_UpdateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Description(@"update a registration definition.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Generated]
    public partial class UpdateAzManagedServicesDefinition_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.IContext
    {
        ...
        /// <returns>a duplicate instance of UpdateAzManagedServicesDefinition_UpdateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Cmdlets.UpdateAzManagedServicesDefinition_UpdateExpanded Clone()
        {
            var clone = new UpdateAzManagedServicesDefinition_UpdateExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    _requestBody = await this.Client.RegistrationDefinitionsGetWithResult(Scope, Name, this, Pipeline);
                    this.Update_requestBody();
                    await this.Client.RegistrationDefinitionsCreateOrUpdate(Scope, Name, _requestBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.SerializationMode.IncludeUpdate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzManagedServicesDefinition_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzManagedServicesDefinition_UpdateExpanded()
        {

        }

        private void Update_requestBody()
        {
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Authorization")))
            {
                this.Authorization = (Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.IAuthorization[])(this.MyInvocation?.BoundParameters["Authorization"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("EligibleAuthorization")))
            {
                this.EligibleAuthorization = (Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.IEligibleAuthorization[])(this.MyInvocation?.BoundParameters["EligibleAuthorization"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("RegistrationDefinitionName")))
            {
                this.RegistrationDefinitionName = (string)(this.MyInvocation?.BoundParameters["RegistrationDefinitionName"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ManagedByTenantId")))
            {
                this.ManagedByTenantId = (string)(this.MyInvocation?.BoundParameters["ManagedByTenantId"]);
            }
        }
