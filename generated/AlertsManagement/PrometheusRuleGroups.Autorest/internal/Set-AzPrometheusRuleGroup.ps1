...
begin {
    try {
        ...
        $mapping = @{
            ...
            UpdateViaJsonFilePath = 'Az.PrometheusRuleGroups.private\Set-AzPrometheusRuleGroup_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.PrometheusRuleGroups.private\Set-AzPrometheusRuleGroup_UpdateViaJsonString';
        }
