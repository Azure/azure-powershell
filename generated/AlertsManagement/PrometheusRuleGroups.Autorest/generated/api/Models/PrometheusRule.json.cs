...
namespace Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Models
{
    ...
    public partial class PrometheusRule
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Models.IPrometheusRule.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Models.IPrometheusRule.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Models.IPrometheusRule FromJson(Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Runtime.Json.JsonNode node)
        {
        ...
        internal PrometheusRule(Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Runtime.Json.JsonObject json)
        {
            ...
            {_resolveConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Runtime.Json.JsonObject>("resolveConfiguration"), out var __jsonResolveConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Models.PrometheusRuleResolveConfiguration.FromJson(__jsonResolveConfiguration) : _resolveConfiguration;}
            {_record = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Runtime.Json.JsonString>("record"), out var __jsonRecord) ? (string)__jsonRecord : (string)_record;}
            {_alert = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Runtime.Json.JsonString>("alert"), out var __jsonAlert) ? (string)__jsonAlert : (string)_alert;}
            {_enabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Runtime.Json.JsonBoolean>("enabled"), out var __jsonEnabled) ? (bool?)__jsonEnabled : _enabled;}
            {_expression = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Runtime.Json.JsonString>("expression"), out var __jsonExpression) ? (string)__jsonExpression : (string)_expression;}
            {_label = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Runtime.Json.JsonObject>("labels"), out var __jsonLabels) ? Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Models.PrometheusRuleLabels.FromJson(__jsonLabels) : _label;}
            {_severity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Runtime.Json.JsonNumber>("severity"), out var __jsonSeverity) ? (int?)__jsonSeverity : _severity;}
            {_for = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Runtime.Json.JsonString>("for"), out var __jsonFor) ? global::System.Xml.XmlConvert.ToTimeSpan( __jsonFor ) : _for;}
            {_annotation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Runtime.Json.JsonObject>("annotations"), out var __jsonAnnotations) ? Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Models.PrometheusRuleAnnotations.FromJson(__jsonAnnotations) : _annotation;}
            {_action = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Runtime.Json.JsonArray>("actions"), out var __jsonActions) ? If( __jsonActions as Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Models.IPrometheusRuleGroupAction>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Models.IPrometheusRuleGroupAction) (Microsoft.Azure.PowerShell.Cmdlets.PrometheusRuleGroups.Models.PrometheusRuleGroupAction.FromJson(__u) )) ))() : null : _action;}
            AfterFromJson(json);
        }
