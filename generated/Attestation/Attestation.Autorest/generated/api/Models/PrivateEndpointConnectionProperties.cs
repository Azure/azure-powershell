...
namespace Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models
{
    ...
    public partial class PrivateEndpointConnectionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.IPrivateEndpointConnectionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.IPrivateEndpointConnectionPropertiesInternal
    {

        /// <summary>Internal Acessors for PrivateEndpoint</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.IPrivateEndpoint Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.IPrivateEndpointConnectionPropertiesInternal.PrivateEndpoint { get => (this._privateEndpoint = this._privateEndpoint ?? new Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.PrivateEndpoint()); set { {_privateEndpoint = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.IPrivateLinkServiceConnectionState Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.IPrivateEndpointConnectionPropertiesInternal.PrivateLinkServiceConnectionState { get => (this._privateLinkServiceConnectionState = this._privateLinkServiceConnectionState ?? new Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.PrivateLinkServiceConnectionState()); set { {_privateLinkServiceConnectionState = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.IPrivateEndpointConnectionPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Backing field for <see cref="PrivateEndpoint" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.IPrivateEndpoint _privateEndpoint;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.IPrivateEndpoint PrivateEndpoint { get => (this._privateEndpoint = this._privateEndpoint ?? new Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.PrivateEndpoint()); set => this._privateEndpoint = value; }
        ...
        public string PrivateEndpointId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.IPrivateEndpointInternal)PrivateEndpoint).Id; }

        /// <summary>Backing field for <see cref="PrivateLinkServiceConnectionState" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.IPrivateLinkServiceConnectionState _privateLinkServiceConnectionState;
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Attestation.PSArgumentCompleterAttribute("Succeeded", "Creating", "Deleting", "Failed")]
    ...
    {
        /// <summary>The resource of private end point.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.IPrivateEndpoint PrivateEndpoint { get; set; }
        /// <summary>The ARM identifier for Private Endpoint</summary>
        string PrivateEndpointId { get; set; }
        /// <summary>
        /// A collection of information about the state of the connection between service consumer and provider.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.IPrivateLinkServiceConnectionState PrivateLinkServiceConnectionState { get; set; }
        /// <summary>
        /// A message indicating if changes on the service provider require any updates on the consumer.
        /// </summary>
        string PrivateLinkServiceConnectionStateActionsRequired { get; set; }
