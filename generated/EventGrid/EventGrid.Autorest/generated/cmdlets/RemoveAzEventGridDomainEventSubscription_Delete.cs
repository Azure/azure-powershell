...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/domains/{domainName}/eventSubscriptions/{eventSubscriptionName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzEventGridDomainEventSubscription_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Description(@"Delete an existing event subscription for a domain.")]
    ...
    public partial class RemoveAzEventGridDomainEventSubscription_Delete : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IContext
    {
        ...
        /// <summary>
        /// Name of the event subscription to be deleted. Event subscription names must be between 3 and 100 characters in length
        /// and use alphanumeric letters only.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of the event subscription to be deleted. Event subscription names must be between 3 and 100 characters in length and use alphanumeric letters only.")]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <returns>a duplicate instance of RemoveAzEventGridDomainEventSubscription_Delete</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets.RemoveAzEventGridDomainEventSubscription_Delete Clone()
        {
            var clone = new RemoveAzEventGridDomainEventSubscription_Delete();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DomainEventSubscriptionsDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DomainEventSubscriptionsDelete(SubscriptionId, ResourceGroupName, DomainName, EventSubscriptionName, onOk, onNoContent, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzEventGridDomainEventSubscription_Delete" /> cmdlet class.
        /// </summary>
        public RemoveAzEventGridDomainEventSubscription_Delete()
        {
