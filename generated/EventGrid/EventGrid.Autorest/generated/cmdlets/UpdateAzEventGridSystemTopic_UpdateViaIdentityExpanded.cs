...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/systemTopics/{systemTopicName}"
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzEventGridSystemTopic_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.ISystemTopic))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Description(@"Asynchronously creates a new system topic with the specified parameters.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Generated]
    public partial class UpdateAzEventGridSystemTopic_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.ISystemTopic _systemTopicInfoBody = new Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.SystemTopic();
        ...
        public string IdentityPrincipalId { get => _systemTopicInfoBody.IdentityPrincipalId ?? null; set => _systemTopicInfoBody.IdentityPrincipalId = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string IdentityTenantId { get => _systemTopicInfoBody.IdentityTenantId ?? null; set => _systemTopicInfoBody.IdentityTenantId = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => _systemTopicInfoBody.Location ?? null; set => _systemTopicInfoBody.Location = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Source for the system topic.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Source { get => _systemTopicInfoBody.Source ?? null; set => _systemTopicInfoBody.Source = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.ITrackedResourceTags Tag { get => _systemTopicInfoBody.Tag ?? null /* object */; set => _systemTopicInfoBody.Tag = value; }

        /// <summary>TopicType for the system topic.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "TopicType for the system topic.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string TopicType { get => _systemTopicInfoBody.TopicType ?? null; set => _systemTopicInfoBody.TopicType = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.ISystemTopic">Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.ISystemTopic</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.ISystemTopic> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of UpdateAzEventGridSystemTopic_UpdateViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets.UpdateAzEventGridSystemTopic_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzEventGridSystemTopic_UpdateViaIdentityExpanded();
            ...
            clone._systemTopicInfoBody = this._systemTopicInfoBody;
            return clone;
        }
        ...
        {
            bool supportsSystemAssignedIdentity = (true == this.EnableSystemAssignedIdentity || null == this.EnableSystemAssignedIdentity && true == _systemTopicInfoBody?.IdentityType?.Contains("SystemAssigned"));
            bool supportsUserAssignedIdentity = false;
            if (this.UserAssignedIdentity?.Length > 0)
            {
                // calculate UserAssignedIdentity
                _systemTopicInfoBody.IdentityUserAssignedIdentity.Clear();
                foreach( var id in this.UserAssignedIdentity )
                {
                    _systemTopicInfoBody.IdentityUserAssignedIdentity.Add(id, new Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.UserIdentityProperties());
                }
            }
            supportsUserAssignedIdentity = true == this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && this.UserAssignedIdentity?.Length > 0 ||
                    true != this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && true == _systemTopicInfoBody.IdentityType?.Contains("UserAssigned");
            if (!supportsUserAssignedIdentity)
            {
                _systemTopicInfoBody.IdentityUserAssignedIdentity = null;
            }
            // calculate IdentityType
            if ((supportsUserAssignedIdentity && supportsSystemAssignedIdentity))
            {
                _systemTopicInfoBody.IdentityType = "SystemAssigned,UserAssigned";
            }
            else if ((supportsUserAssignedIdentity && !supportsSystemAssignedIdentity))
            {
                _systemTopicInfoBody.IdentityType = "UserAssigned";
            }
            else if ((!supportsUserAssignedIdentity && supportsSystemAssignedIdentity))
            {
                _systemTopicInfoBody.IdentityType = "SystemAssigned";
            }
            else
            {
                _systemTopicInfoBody.IdentityType = "None";
            }
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SystemTopicsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _systemTopicInfoBody = await this.Client.SystemTopicsGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_systemTopicInfoBody();
                        await this.Client.SystemTopicsCreateOrUpdateViaIdentity(InputObject.Id, _systemTopicInfoBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _systemTopicInfoBody = await this.Client.SystemTopicsGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.SystemTopicName ?? null, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_systemTopicInfoBody();
                        await this.Client.SystemTopicsCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.SystemTopicName ?? null, _systemTopicInfoBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzEventGridSystemTopic_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzEventGridSystemTopic_UpdateViaIdentityExpanded()
        {

        }

        private void Update_systemTopicInfoBody()
        {
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("TopicType")))
            {
                this.TopicType = (string)(this.MyInvocation?.BoundParameters["TopicType"]);
            }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.ISystemTopic> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.ISystemTopic
