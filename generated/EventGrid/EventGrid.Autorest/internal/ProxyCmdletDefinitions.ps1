...
.Link
https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridoperation
#>
function Get-AzEventGridOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.IOperation])]
