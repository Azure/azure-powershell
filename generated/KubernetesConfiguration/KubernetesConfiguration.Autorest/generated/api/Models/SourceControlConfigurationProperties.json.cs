...
namespace Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models
{
    ...
    public partial class SourceControlConfigurationProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.ISourceControlConfigurationProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.ISourceControlConfigurationProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.ISourceControlConfigurationProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonNode node)
        {
        ...
        internal SourceControlConfigurationProperties(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            {_helmOperatorProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject>("helmOperatorProperties"), out var __jsonHelmOperatorProperties) ? Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.HelmOperatorProperties.FromJson(__jsonHelmOperatorProperties) : _helmOperatorProperty;}
            {_complianceStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject>("complianceStatus"), out var __jsonComplianceStatus) ? Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.ComplianceStatus.FromJson(__jsonComplianceStatus) : _complianceStatus;}
            {_repositoryUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonString>("repositoryUrl"), out var __jsonRepositoryUrl) ? (string)__jsonRepositoryUrl : (string)_repositoryUrl;}
            {_operatorNamespace = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonString>("operatorNamespace"), out var __jsonOperatorNamespace) ? (string)__jsonOperatorNamespace : (string)_operatorNamespace;}
            {_operatorInstanceName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonString>("operatorInstanceName"), out var __jsonOperatorInstanceName) ? (string)__jsonOperatorInstanceName : (string)_operatorInstanceName;}
            {_operatorType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonString>("operatorType"), out var __jsonOperatorType) ? (string)__jsonOperatorType : (string)_operatorType;}
            {_operatorParam = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonString>("operatorParams"), out var __jsonOperatorParams) ? (string)__jsonOperatorParams : (string)_operatorParam;}
            ...
            {_operatorScope = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonString>("operatorScope"), out var __jsonOperatorScope) ? (string)__jsonOperatorScope : (string)_operatorScope;}
            ...
            {_sshKnownHostsContent = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonString>("sshKnownHostsContents"), out var __jsonSshKnownHostsContents) ? (string)__jsonSshKnownHostsContents : (string)_sshKnownHostsContent;}
            {_enableHelmOperator = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonBoolean>("enableHelmOperator"), out var __jsonEnableHelmOperator) ? (bool?)__jsonEnableHelmOperator : _enableHelmOperator;}
