...
namespace Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models
{
    ...
    public partial class Scope :
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IScope,
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IScopeInternal
    {

        /// <summary>Backing field for <see cref="Cluster" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IScopeCluster _cluster;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IScopeCluster Cluster { get => (this._cluster = this._cluster ?? new Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.ScopeCluster()); set => this._cluster = value; }
        ...
        public string ClusterReleaseNamespace { get => ((Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IScopeClusterInternal)Cluster).ReleaseNamespace; set => ((Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IScopeClusterInternal)Cluster).ReleaseNamespace = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IScopeNamespace Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IScopeInternal.Namespace { get => (this._namespace = this._namespace ?? new Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.ScopeNamespace()); set { {_namespace = value;} } }

        /// <summary>Backing field for <see cref="Namespace" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IScopeNamespace _namespace;

        /// <summary>Specifies that the scope of the extension is Namespace</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IScopeNamespace Namespace { get => (this._namespace = this._namespace ?? new Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.ScopeNamespace()); set => this._namespace = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.PropertyOrigin.Inlined)]
        public string NamespaceTargetNamespace { get => ((Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IScopeNamespaceInternal)Namespace).TargetNamespace; set => ((Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IScopeNamespaceInternal)Namespace).TargetNamespace = value ?? null; }
    ...
    {
        /// <summary>Specifies that the scope of the extension is Cluster</summary>
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IScopeCluster Cluster { get; set; }
        /// <summary>
        /// Namespace where the extension Release must be placed, for a Cluster scoped extension. If this namespace does not exist,
        /// it will be created
        /// </summary>
        string ClusterReleaseNamespace { get; set; }
        /// <summary>Specifies that the scope of the extension is Namespace</summary>
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IScopeNamespace Namespace { get; set; }
        /// <summary>
        /// Namespace where the extension will be created for an Namespace scoped extension. If this namespace does not exist, it
        /// will be created
        /// </summary>
