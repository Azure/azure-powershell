...
namespace Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101
{
    ...
    public partial class HelmReleasePropertiesDefinition :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IHelmReleasePropertiesDefinitionInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectReferenceDefinition _helmChartRef;

        /// <summary>The reference to the HelmChart object used as the source to this HelmRelease</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectReferenceDefinition HelmChartRef { get => (this._helmChartRef = this._helmChartRef ?? new Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.ObjectReferenceDefinition()); set => this._helmChartRef = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectReferenceDefinition Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IHelmReleasePropertiesDefinitionInternal.HelmChartRef { get => (this._helmChartRef = this._helmChartRef ?? new Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.ObjectReferenceDefinition()); set { {_helmChartRef = value;} } }
...

    {
        ...
        long? FailureCount { get; set; }
        /// <summary>The reference to the HelmChart object used as the source to this HelmRelease</summary>
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectReferenceDefinition HelmChartRef { get; set; }
        /// <summary>Name of the object</summary>
        string HelmChartRefName { get; set; }
        /// <summary>Namespace of the object</summary>
        string HelmChartRefNamespace { get; set; }
