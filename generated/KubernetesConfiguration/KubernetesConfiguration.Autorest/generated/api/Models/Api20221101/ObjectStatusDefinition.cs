...
namespace Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101
{
    ...
    public partial class ObjectStatusDefinition :
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectStatusDefinition,
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectStatusDefinitionInternal
    {

        /// <summary>Backing field for <see cref="AppliedBy" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectReferenceDefinition _appliedBy;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectReferenceDefinition AppliedBy { get => (this._appliedBy = this._appliedBy ?? new Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.ObjectReferenceDefinition()); set => this._appliedBy = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectReferenceDefinition Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectStatusDefinitionInternal.AppliedBy { get => (this._appliedBy = this._appliedBy ?? new Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.ObjectReferenceDefinition()); set { {_appliedBy = value;} } }

        /// <summary>Internal Acessors for HelmReleaseProperty</summary>
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IHelmReleasePropertiesDefinition Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectStatusDefinitionInternal.HelmReleaseProperty { get => (this._helmReleaseProperty = this._helmReleaseProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.HelmReleasePropertiesDefinition()); set { {_helmReleaseProperty = value;} } }

        /// <summary>Internal Acessors for HelmReleasePropertyHelmChartRef</summary>
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectReferenceDefinition Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectStatusDefinitionInternal.HelmReleasePropertyHelmChartRef { get => ((Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IHelmReleasePropertiesDefinitionInternal)HelmReleaseProperty).HelmChartRef; set => ((Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IHelmReleasePropertiesDefinitionInternal)HelmReleaseProperty).HelmChartRef = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectStatusConditionDefinition[] _statusCondition;

        /// <summary>List of Kubernetes object status conditions present on the cluster</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectStatusConditionDefinition[] StatusCondition { get => this._statusCondition; set => this._statusCondition = value; }
    ...
    {
        /// <summary>Object reference to the Kustomization that applied this object</summary>
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectReferenceDefinition AppliedBy { get; set; }
        /// <summary>Name of the object</summary>
        string AppliedByName { get; set; }
        /// <summary>Namespace of the object</summary>
        string AppliedByNamespace { get; set; }
        ...
        string HelmChartRefNamespace { get; set; }
        /// <summary>Additional properties that are provided from objects of the HelmRelease kind</summary>
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IHelmReleasePropertiesDefinition HelmReleaseProperty { get; set; }
        /// <summary>Total number of times that the HelmRelease failed to install or upgrade</summary>
        long? HelmReleasePropertyFailureCount { get; set; }
        /// <summary>The reference to the HelmChart object used as the source to this HelmRelease</summary>
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.Api20221101.IObjectReferenceDefinition HelmReleasePropertyHelmChartRef { get; set; }
        /// <summary>Number of times that the HelmRelease failed to install</summary>
        long? HelmReleasePropertyInstallFailureCount { get; set; }
        /// <summary>The revision number of the last released object change</summary>
        long? HelmReleasePropertyLastRevisionApplied { get; set; }
