...
namespace Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models
{
    ...
    public partial class FluxConfigurationProperties
    {
        ...
        internal FluxConfigurationProperties(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            {_gitRepository = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject>("gitRepository"), out var __jsonGitRepository) ? Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.GitRepositoryDefinition.FromJson(__jsonGitRepository) : _gitRepository;}
            {_bucket = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject>("bucket"), out var __jsonBucket) ? Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.BucketDefinition.FromJson(__jsonBucket) : _bucket;}
            {_azureBlob = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject>("azureBlob"), out var __jsonAzureBlob) ? Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.AzureBlobDefinition.FromJson(__jsonAzureBlob) : _azureBlob;}
            {_scope = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonString>("scope"), out var __jsonScope) ? (string)__jsonScope : (string)_scope;}
            ...
            {_sourceKind = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonString>("sourceKind"), out var __jsonSourceKind) ? (string)__jsonSourceKind : (string)_sourceKind;}
            {_suspend = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonBoolean>("suspend"), out var __jsonSuspend) ? (bool?)__jsonSuspend : _suspend;}
            {_kustomization = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject>("kustomizations"), out var __jsonKustomizations) ? Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.FluxConfigurationPropertiesKustomizations.FromJson(__jsonKustomizations) : _kustomization;}
            ...
            {_statuses = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonArray>("statuses"), out var __jsonStatuses) ? If( __jsonStatuses as Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IObjectStatusDefinition>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IObjectStatusDefinition) (Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.ObjectStatusDefinition.FromJson(__u) )) ))() : null : _statuses;}
            {_repositoryPublicKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonString>("repositoryPublicKey"), out var __jsonRepositoryPublicKey) ? (string)__jsonRepositoryPublicKey : (string)_repositoryPublicKey;}
            {_sourceSyncedCommitId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonString>("sourceSyncedCommitId"), out var __jsonSourceSyncedCommitId) ? (string)__jsonSourceSyncedCommitId : (string)_sourceSyncedCommitId;}
            {_sourceUpdatedAt = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonString>("sourceUpdatedAt"), out var __jsonSourceUpdatedAt) ? global::System.DateTime.TryParse((string)__jsonSourceUpdatedAt, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonSourceUpdatedAtValue) ? __jsonSourceUpdatedAtValue : _sourceUpdatedAt : _sourceUpdatedAt;}
            {_statusUpdatedAt = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonString>("statusUpdatedAt"), out var __jsonStatusUpdatedAt) ? global::System.DateTime.TryParse((string)__jsonStatusUpdatedAt, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonStatusUpdatedAtValue) ? __jsonStatusUpdatedAtValue : _statusUpdatedAt : _statusUpdatedAt;}
            ...
            {_errorMessage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonString>("errorMessage"), out var __jsonErrorMessage) ? (string)__jsonErrorMessage : (string)_errorMessage;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IFluxConfigurationProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IFluxConfigurationProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IFluxConfigurationProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._azureBlob ? (Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonNode) this._azureBlob.ToJson(null,serializationMode) : null, "azureBlob" ,container.Add );
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.SerializationMode.IncludeRead)||serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.SerializationMode.IncludeCreate))
            {
