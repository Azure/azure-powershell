...
namespace Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models
{
    ...
    public partial class CustomRpResourceTypeRouteDefinition :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpResourceTypeRouteDefinitionInternal,
        Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpRouteDefinition"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpRouteDefinition __customRpRouteDefinition = new Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.CustomRpRouteDefinition();
        ...
        public string Endpoint { get => ((Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpRouteDefinitionInternal)__customRpRouteDefinition).Endpoint; set => ((Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpRouteDefinitionInternal)__customRpRouteDefinition).Endpoint = value ; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Origin(Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.PropertyOrigin.Inherited)]
        public string Name { get => ((Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpRouteDefinitionInternal)__customRpRouteDefinition).Name; set => ((Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpRouteDefinitionInternal)__customRpRouteDefinition).Name = value ; }
    ...
    public partial interface ICustomRpResourceTypeRouteDefinition :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpRouteDefinition
    {
        /// <summary>The routing types that are supported for resource requests.</summary>
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.PSArgumentCompleterAttribute("Proxy", "Proxy,Cache")]
        string RoutingType { get; set; }

    }
    /// The route definition for a resource implemented by the custom resource provider.
    internal partial interface ICustomRpResourceTypeRouteDefinitionInternal :
        Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpRouteDefinitionInternal
    {
        /// <summary>The routing types that are supported for resource requests.</summary>
        [global::Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.PSArgumentCompleterAttribute("Proxy", "Proxy,Cache")]
        string RoutingType { get; set; }
