...
namespace Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzSelfHelpWarmSolutionUp_WarmViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzSelfHelpWarmSolutionUp_WarmViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="SolutionWarmUpRequestBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api20240301Preview.ISolutionWarmUpRequestBody _solutionWarmUpRequestBody;

        /// <summary>Solution WarmUpRequest body</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Solution WarmUpRequest body", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Solution WarmUpRequest body",
        SerializedName = @"solutionWarmUpRequestBody",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api20240301Preview.ISolutionWarmUpRequestBody) })]
        public Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api20240301Preview.ISolutionWarmUpRequestBody SolutionWarmUpRequestBody { get => this._solutionWarmUpRequestBody; set => this._solutionWarmUpRequestBody = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzSelfHelpWarmSolutionUp_WarmViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeAzSelfHelpWarmSolutionUp_WarmViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.SolutionWarmUpViaIdentity(InputObject.Id, SolutionWarmUpRequestBody, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.SolutionWarmUp(InputObject.Scope ?? null, InputObject.SolutionResourceName ?? null, SolutionWarmUpRequestBody, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=SolutionWarmUpRequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api40.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=SolutionWarmUpRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=SolutionWarmUpRequestBody })
                    {
