...
namespace Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Cmdlets
{
    ...
    /// <summary>
    /// create a diagnostic for the specific resource using solutionId and requiredInputs* from discovery solutions. <br/>Diagnostics
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzSelfHelpDiagnostic_CreateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IDiagnosticResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Description(@"create a diagnostic for the specific resource using solutionId and requiredInputs* from discovery solutions. <br/>Diagnostics are powerful solutions that access product resources or other relevant data and provide the root cause of the issue and the steps to address the issue.<br/><br/> <b>Note: </b> ‘requiredInputs’ from Discovery solutions response must be passed via ‘additionalParameters’ as an input to Diagnostics API.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.HttpPath(Path = "/{scope}/providers/Microsoft.Help/diagnostics/{diagnosticsResourceName}", ApiVersion = "2024-03-01-preview")]
    public partial class NewAzSelfHelpDiagnostic_CreateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IDiagnosticResource _diagnosticResourceRequestBody = new Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.DiagnosticResource();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Global parameters is an optional map which can be used to add key and value to request body to improve the diagnostics results")]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IDiagnosticResourcePropertiesGlobalParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IDiagnosticResourcePropertiesGlobalParameters GlobalParameter { get => _diagnosticResourceRequestBody.GlobalParameter ?? null /* object */; set => _diagnosticResourceRequestBody.GlobalParameter = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "SolutionIds that are needed to be invoked.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Category(global::Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IDiagnosticInvocation) })]
        public Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IDiagnosticInvocation[] Insight { get => _diagnosticResourceRequestBody.Insight?.ToArray() ?? null /* fixedArrayOf */; set => _diagnosticResourceRequestBody.Insight = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IDiagnosticInvocation>(value) : null); }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IDiagnosticResource">Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IDiagnosticResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IDiagnosticResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzSelfHelpDiagnostic_CreateViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Cmdlets.NewAzSelfHelpDiagnostic_CreateViaIdentityExpanded Clone()
        {
            var clone = new NewAzSelfHelpDiagnostic_CreateViaIdentityExpanded();
            ...
            clone._diagnosticResourceRequestBody = this._diagnosticResourceRequestBody;
            return clone;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzSelfHelpDiagnostic_CreateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public NewAzSelfHelpDiagnostic_CreateViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DiagnosticsCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DiagnosticsCreateViaIdentity(InputObject.Id, _diagnosticResourceRequestBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.DiagnosticsResourceName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.DiagnosticsResourceName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.DiagnosticsCreate(InputObject.Scope ?? null, InputObject.DiagnosticsResourceName ?? null, _diagnosticResourceRequestBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.SerializationMode.IncludeCreate);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IDiagnosticResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IDiagnosticResource
