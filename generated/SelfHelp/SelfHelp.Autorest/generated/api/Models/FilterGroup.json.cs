...
namespace Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models
{
    ...
    public partial class FilterGroup
    {
        ...
        internal FilterGroup(Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonObject json)
        {
            ...
            {_filter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonArray>("filter"), out var __jsonFilter) ? If( __jsonFilter as Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IFilter>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IFilter) (Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Filter.FromJson(__u) )) ))() : null : _filter;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IFilterGroup.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IFilterGroup.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IFilterGroup FromJson(Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonNode node)
        {
