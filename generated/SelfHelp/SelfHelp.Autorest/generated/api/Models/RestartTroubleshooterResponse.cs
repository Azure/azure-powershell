...
namespace Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.IHeaderSerializable
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IRestartTroubleshooterResponseInternal.TroubleshooterResourceName { get => this._troubleshooterResourceName; set { {_troubleshooterResourceName = value;} } }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IRestartTroubleshooterResponseInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader0) is string __headerLocationHeader0 ? __headerLocationHeader0 : (string)null;
            }
        }
