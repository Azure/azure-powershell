...
namespace Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models
{
    ...
    public partial class MetricsBasedChart :
        Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IMetricsBasedChart,
        Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IMetricsBasedChartInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IFilterGroup _filterGroup;

        /// <summary>Filter group</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Origin(Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IFilterGroup FilterGroup { get => (this._filterGroup = this._filterGroup ?? new Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.FilterGroup()); set => this._filterGroup = value; }
        ...
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IFilter> FilterGroupFilter { get => ((Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IFilterGroupInternal)FilterGroup).Filter; set => ((Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IFilterGroupInternal)FilterGroup).Filter = value ?? null /* arrayOf */; }

        /// <summary>Internal Acessors for FilterGroup</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IFilterGroup Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IMetricsBasedChartInternal.FilterGroup { get => (this._filterGroup = this._filterGroup ?? new Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.FilterGroup()); set { {_filterGroup = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.IJsonSerializable
    {
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.PSArgumentCompleterAttribute("Sum", "Avg", "Count", "Min", "Max")]
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IFilter> FilterGroupFilter { get; set; }
        /// <summary>Chart name</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        string AggregationType { get; set; }
        /// <summary>Filter group</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IFilterGroup FilterGroup { get; set; }
        /// <summary>List of filters</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IFilter> FilterGroupFilter { get; set; }
        /// <summary>Chart name</summary>
        string Name { get; set; }
