...
namespace Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api20240301Preview
{
    ...
    public partial class SolutionWarmUpRequestBody
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api20240301Preview.ISolutionWarmUpRequestBody.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api20240301Preview.ISolutionWarmUpRequestBody.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api20240301Preview.ISolutionWarmUpRequestBody FromJson(Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonObject json ? new SolutionWarmUpRequestBody(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonObject into a new instance of <see cref="SolutionWarmUpRequestBody" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SolutionWarmUpRequestBody(Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonObject json)
        {
            ...
            {_parameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonObject>("parameters"), out var __jsonParameters) ? Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.Api20240301Preview.SolutionWarmUpRequestBodyParameters.FromJson(__jsonParameters) : Parameter;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SolutionWarmUpRequestBody" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SolutionWarmUpRequestBody" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonNode" />.
        /// </returns>
