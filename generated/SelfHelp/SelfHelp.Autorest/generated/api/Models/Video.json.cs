...
namespace Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models
{
    ...
    public partial class Video
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IVideo.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IVideo.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.IVideo FromJson(Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonObject json ? new Video(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="Video" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Video" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.SerializationMode serializationMode)
        {
            ...
            __videoGroupVideo?.ToJson(container, serializationMode);
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonObject into a new instance of <see cref="Video" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Video(Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            __videoGroupVideo = new Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Models.VideoGroupVideo(json);
            {_replacementKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SelfHelp.Runtime.Json.JsonString>("replacementKey"), out var __jsonReplacementKey) ? (string)__jsonReplacementKey : (string)_replacementKey;}
            AfterFromJson(json);
        }
    }
}