...
begin {
    try {
        ...
        $mapping = @{
            ...
            CreateViaJsonFilePath = 'Az.Databricks.private\New-AzDatabricksAccessConnector_CreateViaJsonFilePath';
            CreateViaJsonString = 'Az.Databricks.private\New-AzDatabricksAccessConnector_CreateViaJsonString';
        }
