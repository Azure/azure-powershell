...
namespace Microsoft.Azure.PowerShell.Cmdlets.Databricks.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzDatabricksAccessConnector_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AccessConnectorsGet(SubscriptionId, ResourceGroupName, Name, onOk, onDefault, this, Pipeline);
