...
namespace Microsoft.Azure.PowerShell.Cmdlets.Databricks.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230501.IAccessConnector _parameter;

        /// <summary>Information about azure databricks accessConnector.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Information about azure databricks accessConnector.", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230501.IAccessConnector Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzDatabricksAccessConnector_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.AccessConnectorsCreateOrUpdateViaIdentity(InputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.AccessConnectorsCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.ConnectorName ?? null, InputObject.SubscriptionId ?? null, Parameter, onOk, onDefault, this, Pipeline);
                    }
