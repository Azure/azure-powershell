...
namespace Microsoft.Azure.PowerShell.Cmdlets.Databricks.Cmdlets
{
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.OutputBreakingChange("Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api202601.IWorkspace", "16.0.0", "2.0.0", "May 2026", DeprecatedOutputProperties=new string[] {"PrivateEndpointConnection","Authorization","ComplianceSecurityProfileComplianceStandard"}, NewOutputProperties=new string[] {"PrivateEndpointConnection","Authorization","ComplianceSecurityProfileComplianceStandard"}, ChangeDescription="The types of the properties 'PrivateEndpointConnection', 'Authorization' and 'ComplianceSecurityProfileComplianceStandard' will be changed from object to 'List'.")]
