...
namespace Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api202601
{
    ...
    public partial class WorkspaceEncryptionParameterTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <paramref name="sourceValue"/> parameter to the <see cref="WorkspaceEncryptionParameter"/>
        /// type.
        /// </summary>
        ...
        /// <summary>
        /// Converts the <paramref name="sourceValue" /> parameter into an instance of <see cref="WorkspaceEncryptionParameter" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="WorkspaceEncryptionParameter" />.</param>
        /// <returns>
        /// an instance of <see cref="WorkspaceEncryptionParameter" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api202601.IWorkspaceEncryptionParameter ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api202601.IWorkspaceEncryptionParameter).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
