...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BackupAzFunctionApp_BackupViaIdentity" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.WebAppsBackup(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.Name ?? null, Request, onOk, onDefault, this, Pipeline);
                    }
