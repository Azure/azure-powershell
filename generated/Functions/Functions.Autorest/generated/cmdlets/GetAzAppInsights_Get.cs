...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzAppInsights_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ComponentsGet(ResourceGroupName, SubscriptionId, ResourceName, onOk, this, Pipeline);
