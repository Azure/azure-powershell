...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IRestoreRequest _requestBody = new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.RestoreRequest();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDatabaseBackupSetting[] Database { get => _requestBody.Database?.ToArray() ?? null /* fixedArrayOf */; set => _requestBody.Database = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDatabaseBackupSetting>(value) : null); }
        ...
        public string OperationType { get => _requestBody.OperationType ?? null; set => _requestBody.OperationType = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.WebAppsRestore(SubscriptionId, ResourceGroupName, Name, BackupId, _requestBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Name=Name,BackupId=BackupId})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RestoreAzFunctionApp_RestoreExpanded" /> cmdlet class.
        /// </summary>
