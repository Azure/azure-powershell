...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UpdateApplicationSettingsSlot=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/config/appsettings"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzWebAppApplicationSettingSlot_UpdateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/config/appsettings", ApiVersion = "2023-12-01")]
    public partial class SetAzWebAppApplicationSettingSlot_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.IStringDictionary _appSettingsBody = new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.StringDictionary();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.IStringDictionaryProperties Property { get => _appSettingsBody.Property ?? null /* object */; set => _appSettingsBody.Property = value; }
        ...
        /// <summary>
        /// Name of the deployment slot. If a slot is not specified, the API will update the application settings for the production
        /// slot.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of the deployment slot. If a slot is not specified, the API will update the application settings for the production slot.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'WebAppsUpdateApplicationSettingsSlot' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.WebAppsUpdateApplicationSettingsSlot(ResourceGroupName, Name, Slot, SubscriptionId, _appSettingsBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,Slot=Slot,SubscriptionId=SubscriptionId,body=_appSettingsBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzWebAppApplicationSettingSlot_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public SetAzWebAppApplicationSettingSlot_UpdateExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.IDefaultErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, Name=Name, Slot=Slot, SubscriptionId=SubscriptionId, body=_appSettingsBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, Name=Name, Slot=Slot, SubscriptionId=SubscriptionId, body=_appSettingsBody })
                    {
