...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzWebAppScmAllowedSlot_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.WebAppsGetScmAllowedSlot(SubscriptionId, ResourceGroupName, Name, Slot, onOk, onDefault, this, Pipeline);
