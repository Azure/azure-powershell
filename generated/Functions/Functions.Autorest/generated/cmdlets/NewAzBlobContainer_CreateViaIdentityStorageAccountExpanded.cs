...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets
{
    ...
    using Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Cmdlets;
    using System;

    /// <summary>
    /// create a new container under the specified account as described by request body. The container resource includes metadata
    /// and properties for that container. It does not include a list of the blobs contained by the container.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Create=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/blobServices/default/containers/{containerName}"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzBlobContainer_CreateViaIdentityStorageAccountExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IBlobContainer))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Description(@"create a new container under the specified account as described by request body. The container resource includes metadata and properties for that container. It does not include a list of the blobs contained by the container. ")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/blobServices/default/containers/{containerName}", ApiVersion = "2019-04-01")]
    public partial class NewAzBlobContainer_CreateViaIdentityStorageAccountExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IEventListener,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IContext
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IBlobContainer _blobContainerBody = new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.BlobContainer();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the blob container within the specified storage account. Blob container names must be between 3 and 63 characters in length and use numbers, lower-case letters and dash (-) only. Every dash (-) character must be immediately preceded and followed by a letter or number.")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "A name-value pair to associate with the container as metadata.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IContainerPropertiesMetadata ContainerPropertyMetadata { get => _blobContainerBody.ContainerPropertyMetadata ?? null /* object */; set => _blobContainerBody.ContainerPropertyMetadata = value; }

        /// <summary>
        /// Specifies whether data in the container may be accessed publicly and the level of access.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Specifies whether data in the container may be accessed publicly and the level of access.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Functions.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string ContainerPropertyPublicAccess { get => _blobContainerBody.ContainerPropertyPublicAccess ?? null; set => _blobContainerBody.ContainerPropertyPublicAccess = value; }
        ...
        /// </summary>
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.HttpPipeline Pipeline { get; set; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IFunctionsIdentity _storageAccountInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Functions.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IFunctionsIdentity StorageAccountInputObject { get => this._storageAccountInputObject; set => this._storageAccountInputObject = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IBlobContainer">Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IBlobContainer</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IBlobContainer> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IBlobContainer> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Events.Progress:
                    {
                        var data = messageData();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzBlobContainer_CreateViaIdentityStorageAccountExpanded" /> cmdlet class.
        /// </summary>
        public NewAzBlobContainer_CreateViaIdentityStorageAccountExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BlobContainersCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                Pipeline = Microsoft.Azure.PowerShell.Cmdlets.Functions.Module.Instance.CreatePipeline(InvocationInformation, __correlationId, __processRecordId, this.ParameterSetName, this.ExtensibleParameters);
                ...
                try
                {
                    ...
                    {
                        this.StorageAccountInputObject.Id += $"/containers/{(global::System.Uri.EscapeDataString(this.ContainerName.ToString()))}";
                        await this.Client.BlobContainersCreateViaIdentity(StorageAccountInputObject.Id, _blobContainerBody, onOk, onCreated, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        ...
                        await this.Client.BlobContainersCreate(StorageAccountInputObject.SubscriptionId ?? null, StorageAccountInputObject.ResourceGroupName ?? null, StorageAccountInputObject.AccountName ?? null, ContainerName, _blobContainerBody, onOk, onCreated, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.SerializationMode.IncludeCreate);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ContainerName=ContainerName})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IBlobContainer> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IBlobContainer
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IBlobContainer> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
