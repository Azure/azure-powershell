...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzWebAppSettingKeyVaultReference_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.WebAppsGetAppSettingsKeyVaultReferences(SubscriptionId, ResourceGroupName, Name, onOk, onDefault, this, Pipeline);
