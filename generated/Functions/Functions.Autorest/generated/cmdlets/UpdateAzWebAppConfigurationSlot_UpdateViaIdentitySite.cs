...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Cmdlets
{
    ...
    /// <summary>Description for update the configuration of an app.</summary>
    /// <remarks>
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzWebAppConfigurationSlot_UpdateViaIdentitySite", SupportsShouldProcess = true)]
    ...
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISiteConfigResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Description(@"Description for update the configuration of an app.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Functions.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/config/web", ApiVersion = "2023-12-01")]
    public partial class UpdateAzWebAppConfigurationSlot_UpdateViaIdentitySite : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISiteConfigResource _siteConfig;

        /// <summary>Web app configuration ARM resource.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Web app configuration ARM resource.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Web app configuration ARM resource.",
        SerializedName = @"siteConfig",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISiteConfigResource) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISiteConfigResource SiteConfig { get => this._siteConfig; set => this._siteConfig = value; }

        /// <summary>Backing field for <see cref="SiteInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IFunctionsIdentity _siteInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IFunctionsIdentity SiteInputObject { get => this._siteInputObject; set => this._siteInputObject = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDefaultErrorResponse">Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDefaultErrorResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDefaultErrorResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISiteConfigResource">Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISiteConfigResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISiteConfigResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'WebAppsUpdateConfigurationSlot' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (SiteInputObject?.Id != null)
                    {
                        this.SiteInputObject.Id += $"/slots/{(global::System.Uri.EscapeDataString(this.Slot.ToString()))}";
                        await this.Client.WebAppsUpdateConfigurationSlotViaIdentity(SiteInputObject.Id, SiteConfig, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == SiteInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("SiteInputObject has null value for SiteInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, SiteInputObject) );
                        }
                        if (null == SiteInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("SiteInputObject has null value for SiteInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, SiteInputObject) );
                        }
                        if (null == SiteInputObject.Name)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("SiteInputObject has null value for SiteInputObject.Name"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, SiteInputObject) );
                        }
                        await this.Client.WebAppsUpdateConfigurationSlot(SiteInputObject.SubscriptionId ?? null, SiteInputObject.ResourceGroupName ?? null, SiteInputObject.Name ?? null, Slot, SiteConfig, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.SerializationMode.IncludeUpdate);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Slot=Slot})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzWebAppConfigurationSlot_UpdateViaIdentitySite" /> cmdlet class.
        /// </summary>
        public UpdateAzWebAppConfigurationSlot_UpdateViaIdentitySite()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDefaultErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDefaultErrorResponse>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISiteConfigResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISiteConfigResource
