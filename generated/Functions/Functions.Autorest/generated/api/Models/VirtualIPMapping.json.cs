...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class VirtualIPMapping
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IVirtualIPMapping.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IVirtualIPMapping.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IVirtualIPMapping FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal VirtualIPMapping(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_internalHttpPort = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("internalHttpPort"), out var __jsonInternalHttpPort) ? (int?)__jsonInternalHttpPort : _internalHttpPort;}
            {_internalHttpsPort = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("internalHttpsPort"), out var __jsonInternalHttpsPort) ? (int?)__jsonInternalHttpsPort : _internalHttpsPort;}
            {_inUse = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("inUse"), out var __jsonInUse) ? (bool?)__jsonInUse : _inUse;}
            {_serviceName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("serviceName"), out var __jsonServiceName) ? (string)__jsonServiceName : (string)_serviceName;}
            AfterFromJson(json);
        }
    }
}