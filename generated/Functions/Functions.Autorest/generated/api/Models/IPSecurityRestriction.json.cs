...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class IPSecurityRestriction
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IIPSecurityRestriction.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IIPSecurityRestriction.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IIPSecurityRestriction FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal IPSecurityRestriction(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_subnetMask = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("subnetMask"), out var __jsonSubnetMask) ? (string)__jsonSubnetMask : (string)_subnetMask;}
            {_vnetSubnetResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("vnetSubnetResourceId"), out var __jsonVnetSubnetResourceId) ? (string)__jsonVnetSubnetResourceId : (string)_vnetSubnetResourceId;}
            {_vnetTrafficTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("vnetTrafficTag"), out var __jsonVnetTrafficTag) ? (int?)__jsonVnetTrafficTag : _vnetTrafficTag;}
            {_subnetTrafficTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("subnetTrafficTag"), out var __jsonSubnetTrafficTag) ? (int?)__jsonSubnetTrafficTag : _subnetTrafficTag;}
            ...
            {_priority = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("priority"), out var __jsonPriority) ? (int?)__jsonPriority : _priority;}
            ...
            {_header = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("headers"), out var __jsonHeaders) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IPSecurityRestrictionHeaders.FromJson(__jsonHeaders) : _header;}
            AfterFromJson(json);
        }
