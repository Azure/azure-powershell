...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class ProcessThreadInfoProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IProcessThreadInfoProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IProcessThreadInfoProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IProcessThreadInfoProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal ProcessThreadInfoProperties(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_process = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("process"), out var __jsonProcess) ? (string)__jsonProcess : (string)_process;}
            {_startAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("start_address"), out var __jsonStartAddress) ? (string)__jsonStartAddress : (string)_startAddress;}
            {_currentPriority = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("current_priority"), out var __jsonCurrentPriority) ? (int?)__jsonCurrentPriority : _currentPriority;}
            {_priorityLevel = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("priority_level"), out var __jsonPriorityLevel) ? (string)__jsonPriorityLevel : (string)_priorityLevel;}
            {_basePriority = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("base_priority"), out var __jsonBasePriority) ? (int?)__jsonBasePriority : _basePriority;}
            ...
            {_totalProcessorTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("total_processor_time"), out var __jsonTotalProcessorTime) ? (string)__jsonTotalProcessorTime : (string)_totalProcessorTime;}
            {_userProcessorTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("user_processor_time"), out var __jsonUserProcessorTime) ? (string)__jsonUserProcessorTime : (string)_userProcessorTime;}
            ...
            {_waitReason = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("wait_reason"), out var __jsonWaitReason) ? (string)__jsonWaitReason : (string)_waitReason;}
            AfterFromJson(json);
        }
