...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class StaticSiteBuildArmResourceProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteBuildArmResourceProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteBuildArmResourceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteBuildArmResourceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal StaticSiteBuildArmResourceProperties(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_buildId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("buildId"), out var __jsonBuildId) ? (string)__jsonBuildId : (string)_buildId;}
            {_sourceBranch = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("sourceBranch"), out var __jsonSourceBranch) ? (string)__jsonSourceBranch : (string)_sourceBranch;}
            {_pullRequestTitle = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("pullRequestTitle"), out var __jsonPullRequestTitle) ? (string)__jsonPullRequestTitle : (string)_pullRequestTitle;}
            ...
            {_userProvidedFunctionApp = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("userProvidedFunctionApps"), out var __jsonUserProvidedFunctionApps) ? If( __jsonUserProvidedFunctionApps as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteUserProvidedFunctionApp>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteUserProvidedFunctionApp) (Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.StaticSiteUserProvidedFunctionApp.FromJson(__u) )) ))() : null : _userProvidedFunctionApp;}
            {_linkedBackend = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("linkedBackends"), out var __jsonLinkedBackends) ? If( __jsonLinkedBackends as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteLinkedBackend>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteLinkedBackend) (Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.StaticSiteLinkedBackend.FromJson(__p) )) ))() : null : _linkedBackend;}
            {_databaseConnection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("databaseConnections"), out var __jsonDatabaseConnections) ? If( __jsonDatabaseConnections as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDatabaseConnectionOverview>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDatabaseConnectionOverview) (Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.DatabaseConnectionOverview.FromJson(__k) )) ))() : null : _databaseConnection;}
            AfterFromJson(json);
        }
