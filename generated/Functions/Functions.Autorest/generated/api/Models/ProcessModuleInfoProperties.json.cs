...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class ProcessModuleInfoProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IProcessModuleInfoProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IProcessModuleInfoProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IProcessModuleInfoProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal ProcessModuleInfoProperties(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_baseAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("base_address"), out var __jsonBaseAddress) ? (string)__jsonBaseAddress : (string)_baseAddress;}
            ...
            {_filePath = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("file_path"), out var __jsonFilePath) ? (string)__jsonFilePath : (string)_filePath;}
            {_moduleMemorySize = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("module_memory_size"), out var __jsonModuleMemorySize) ? (int?)__jsonModuleMemorySize : _moduleMemorySize;}
            {_fileVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("file_version"), out var __jsonFileVersion) ? (string)__jsonFileVersion : (string)_fileVersion;}
            {_fileDescription = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("file_description"), out var __jsonFileDescription) ? (string)__jsonFileDescription : (string)_fileDescription;}
            ...
            {_productVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("product_version"), out var __jsonProductVersion) ? (string)__jsonProductVersion : (string)_productVersion;}
            {_isDebug = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("is_debug"), out var __jsonIsDebug) ? (bool?)__jsonIsDebug : _isDebug;}
            {_language = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("language"), out var __jsonLanguage) ? (string)__jsonLanguage : (string)_language;}
            AfterFromJson(json);
        }
