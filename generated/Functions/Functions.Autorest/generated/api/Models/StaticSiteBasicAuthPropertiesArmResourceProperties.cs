...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class StaticSiteBasicAuthPropertiesArmResourceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteBasicAuthPropertiesArmResourceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteBasicAuthPropertiesArmResourcePropertiesInternal
    {
        ...
        private System.Collections.Generic.List<string> _environment;

        /// <summary>
        /// The list of enabled environments for Basic Auth if ApplicableEnvironmentsMode is set to SpecifiedEnvironments.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> Environment { get => this._environment; set => this._environment = value; }

        /// <summary>Internal Acessors for SecretState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteBasicAuthPropertiesArmResourcePropertiesInternal.SecretState { get => this._secretState; set { {_secretState = value;} } }
