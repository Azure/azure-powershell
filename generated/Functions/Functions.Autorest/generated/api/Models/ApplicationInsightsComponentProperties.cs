...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class ApplicationInsightsComponentProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IApplicationInsightsComponentProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IApplicationInsightsComponentPropertiesInternal
    {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        public string IngestionMode { get => this._ingestionMode; set => this._ingestionMode = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IApplicationInsightsComponentPropertiesInternal.AppId { get => this._appId; set { {_appId = value;} } }

        /// <summary>Internal Acessors for ApplicationId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IApplicationInsightsComponentPropertiesInternal.ApplicationId { get => this._applicationId; set { {_applicationId = value;} } }

        /// <summary>Internal Acessors for ConnectionString</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IApplicationInsightsComponentPropertiesInternal.ConnectionString { get => this._connectionString; set { {_connectionString = value;} } }

        /// <summary>Internal Acessors for CreationDate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IApplicationInsightsComponentPropertiesInternal.CreationDate { get => this._creationDate; set { {_creationDate = value;} } }

        /// <summary>Internal Acessors for HockeyAppToken</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IApplicationInsightsComponentPropertiesInternal.HockeyAppToken { get => this._hockeyAppToken; set { {_hockeyAppToken = value;} } }

        /// <summary>Internal Acessors for InstrumentationKey</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IApplicationInsightsComponentPropertiesInternal.InstrumentationKey { get => this._instrumentationKey; set { {_instrumentationKey = value;} } }

        /// <summary>Internal Acessors for PrivateLinkScopedResource</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IPrivateLinkScopedResource> Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IApplicationInsightsComponentPropertiesInternal.PrivateLinkScopedResource { get => this._privateLinkScopedResource; set { {_privateLinkScopedResource = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IApplicationInsightsComponentPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for TenantId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IApplicationInsightsComponentPropertiesInternal.TenantId { get => this._tenantId; set { {_tenantId = value;} } }

        /// <summary>Backing field for <see cref="PrivateLinkScopedResource" /> property.</summary>
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IPrivateLinkScopedResource> _privateLinkScopedResource;

        /// <summary>List of linked private link scope resources.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IPrivateLinkScopedResource> PrivateLinkScopedResource { get => this._privateLinkScopedResource; }
