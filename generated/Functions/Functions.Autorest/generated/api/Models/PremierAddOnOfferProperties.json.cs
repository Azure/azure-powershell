...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class PremierAddOnOfferProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IPremierAddOnOfferProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IPremierAddOnOfferProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IPremierAddOnOfferProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal PremierAddOnOfferProperties(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_sku = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("sku"), out var __jsonSku) ? (string)__jsonSku : (string)_sku;}
            {_product = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("product"), out var __jsonProduct) ? (string)__jsonProduct : (string)_product;}
            {_vendor = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("vendor"), out var __jsonVendor) ? (string)__jsonVendor : (string)_vendor;}
            {_promoCodeRequired = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("promoCodeRequired"), out var __jsonPromoCodeRequired) ? (bool?)__jsonPromoCodeRequired : _promoCodeRequired;}
            {_quota = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("quota"), out var __jsonQuota) ? (int?)__jsonQuota : _quota;}
            {_webHostingPlanRestriction = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("webHostingPlanRestrictions"), out var __jsonWebHostingPlanRestrictions) ? (string)__jsonWebHostingPlanRestrictions : (string)_webHostingPlanRestriction;}
            {_privacyPolicyUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("privacyPolicyUrl"), out var __jsonPrivacyPolicyUrl) ? (string)__jsonPrivacyPolicyUrl : (string)_privacyPolicyUrl;}
            {_legalTermsUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("legalTermsUrl"), out var __jsonLegalTermsUrl) ? (string)__jsonLegalTermsUrl : (string)_legalTermsUrl;}
            {_marketplacePublisher = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("marketplacePublisher"), out var __jsonMarketplacePublisher) ? (string)__jsonMarketplacePublisher : (string)_marketplacePublisher;}
            {_marketplaceOffer = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("marketplaceOffer"), out var __jsonMarketplaceOffer) ? (string)__jsonMarketplaceOffer : (string)_marketplaceOffer;}
            AfterFromJson(json);
        }
