...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class SiteLimits
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISiteLimits.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISiteLimits.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISiteLimits FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal SiteLimits(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_maxPercentageCpu = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("maxPercentageCpu"), out var __jsonMaxPercentageCpu) ? (double?)__jsonMaxPercentageCpu : _maxPercentageCpu;}
            {_maxMemoryInMb = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("maxMemoryInMb"), out var __jsonMaxMemoryInMb) ? (long?)__jsonMaxMemoryInMb : _maxMemoryInMb;}
            {_maxDiskSizeInMb = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("maxDiskSizeInMb"), out var __jsonMaxDiskSizeInMb) ? (long?)__jsonMaxDiskSizeInMb : _maxDiskSizeInMb;}
            AfterFromJson(json);
        }
