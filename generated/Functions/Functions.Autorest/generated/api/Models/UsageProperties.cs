...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class UsageProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IUsageProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IUsagePropertiesInternal
    {
        ...
        public string ComputeMode { get => this._computeMode; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IUsagePropertiesInternal.ComputeMode { get => this._computeMode; set { {_computeMode = value;} } }

        /// <summary>Internal Acessors for CurrentValue</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IUsagePropertiesInternal.CurrentValue { get => this._currentValue; set { {_currentValue = value;} } }

        /// <summary>Internal Acessors for DisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IUsagePropertiesInternal.DisplayName { get => this._displayName; set { {_displayName = value;} } }

        /// <summary>Internal Acessors for Limit</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IUsagePropertiesInternal.Limit { get => this._limit; set { {_limit = value;} } }

        /// <summary>Internal Acessors for NextResetTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IUsagePropertiesInternal.NextResetTime { get => this._nextResetTime; set { {_nextResetTime = value;} } }

        /// <summary>Internal Acessors for ResourceName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IUsagePropertiesInternal.ResourceName { get => this._resourceName; set { {_resourceName = value;} } }

        /// <summary>Internal Acessors for SiteMode</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IUsagePropertiesInternal.SiteMode { get => this._siteMode; set { {_siteMode = value;} } }

        /// <summary>Internal Acessors for Unit</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IUsagePropertiesInternal.Unit { get => this._unit; set { {_unit = value;} } }
