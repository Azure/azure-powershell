...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class MSDeployCore
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IMSDeployCore.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IMSDeployCore.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IMSDeployCore FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal MSDeployCore(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_packageUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("packageUri"), out var __jsonPackageUri) ? (string)__jsonPackageUri : (string)_packageUri;}
            ...
            {_dbType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("dbType"), out var __jsonDbType) ? (string)__jsonDbType : (string)_dbType;}
            {_setParametersXmlFileUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("setParametersXmlFileUri"), out var __jsonSetParametersXmlFileUri) ? (string)__jsonSetParametersXmlFileUri : (string)_setParametersXmlFileUri;}
            {_setParameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("setParameters"), out var __jsonSetParameters) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.MSDeployCoreSetParameters.FromJson(__jsonSetParameters) : _setParameter;}
            {_skipAppData = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("skipAppData"), out var __jsonSkipAppData) ? (bool?)__jsonSkipAppData : _skipAppData;}
            {_appOffline = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("appOffline"), out var __jsonAppOffline) ? (bool?)__jsonAppOffline : _appOffline;}
            AfterFromJson(json);
        }
