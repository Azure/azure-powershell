...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class EncryptionServices
    {
        ...
        internal EncryptionServices(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_blob = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("blob"), out var __jsonBlob) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.EncryptionService.FromJson(__jsonBlob) : _blob;}
            {_file = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("file"), out var __jsonFile) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.EncryptionService.FromJson(__jsonFile) : _file;}
            {_table = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("table"), out var __jsonTable) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.EncryptionService.FromJson(__jsonTable) : _table;}
            {_queue = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("queue"), out var __jsonQueue) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.EncryptionService.FromJson(__jsonQueue) : _queue;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IEncryptionServices.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IEncryptionServices.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IEncryptionServices FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
