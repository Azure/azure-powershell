...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class SystemAssignedIdentityProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISystemAssignedIdentityPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISystemAssignedIdentityPropertiesInternal.ClientId { get => this._clientId; set { {_clientId = value;} } }

        /// <summary>Internal Acessors for ClientSecretUrl</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISystemAssignedIdentityPropertiesInternal.ClientSecretUrl { get => this._clientSecretUrl; set { {_clientSecretUrl = value;} } }

        /// <summary>Internal Acessors for PrincipalId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISystemAssignedIdentityPropertiesInternal.PrincipalId { get => this._principalId; set { {_principalId = value;} } }

        /// <summary>Internal Acessors for TenantId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISystemAssignedIdentityPropertiesInternal.TenantId { get => this._tenantId; set { {_tenantId = value;} } }
