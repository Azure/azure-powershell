...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class ContainerNetworkInterfaceStatistics
    {
        ...
        internal ContainerNetworkInterfaceStatistics(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_rxByte = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("rxBytes"), out var __jsonRxBytes) ? (long?)__jsonRxBytes : _rxByte;}
            {_rxPacket = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("rxPackets"), out var __jsonRxPackets) ? (long?)__jsonRxPackets : _rxPacket;}
            {_rxError = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("rxErrors"), out var __jsonRxErrors) ? (long?)__jsonRxErrors : _rxError;}
            {_rxDropped = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("rxDropped"), out var __jsonRxDropped) ? (long?)__jsonRxDropped : _rxDropped;}
            {_txByte = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("txBytes"), out var __jsonTxBytes) ? (long?)__jsonTxBytes : _txByte;}
            {_txPacket = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("txPackets"), out var __jsonTxPackets) ? (long?)__jsonTxPackets : _txPacket;}
            {_txError = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("txErrors"), out var __jsonTxErrors) ? (long?)__jsonTxErrors : _txError;}
            {_txDropped = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("txDropped"), out var __jsonTxDropped) ? (long?)__jsonTxDropped : _txDropped;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IContainerNetworkInterfaceStatistics.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IContainerNetworkInterfaceStatistics.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IContainerNetworkInterfaceStatistics FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
