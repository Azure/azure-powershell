...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class DomainControlCenterSsoRequest :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDomainControlCenterSsoRequest,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDomainControlCenterSsoRequestInternal
    {

        /// <summary>Internal Acessors for PostParameterKey</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDomainControlCenterSsoRequestInternal.PostParameterKey { get => this._postParameterKey; set { {_postParameterKey = value;} } }

        /// <summary>Internal Acessors for PostParameterValue</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDomainControlCenterSsoRequestInternal.PostParameterValue { get => this._postParameterValue; set { {_postParameterValue = value;} } }

        /// <summary>Internal Acessors for Url</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDomainControlCenterSsoRequestInternal.Url { get => this._url; set { {_url = value;} } }
