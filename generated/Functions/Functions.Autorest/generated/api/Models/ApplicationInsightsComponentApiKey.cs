...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class ApplicationInsightsComponentApiKey :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IApplicationInsightsComponentApiKey,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IApplicationInsightsComponentApiKeyInternal
    {
        ...
        private System.Collections.Generic.List<string> _linkedReadProperty;

        /// <summary>The read access rights of this API Key.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> LinkedReadProperty { get => this._linkedReadProperty; set => this._linkedReadProperty = value; }

        /// <summary>Backing field for <see cref="LinkedWriteProperty" /> property.</summary>
        private System.Collections.Generic.List<string> _linkedWriteProperty;

        /// <summary>The write access rights of this API Key.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> LinkedWriteProperty { get => this._linkedWriteProperty; set => this._linkedWriteProperty = value; }

        /// <summary>Internal Acessors for ApiKey</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IApplicationInsightsComponentApiKeyInternal.ApiKey { get => this._apiKey; set { {_apiKey = value;} } }

        /// <summary>Internal Acessors for Id</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IApplicationInsightsComponentApiKeyInternal.Id { get => this._id; set { {_id = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> LinkedReadProperty { get; set; }
        /// <summary>The write access rights of this API Key.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> LinkedWriteProperty { get; set; }
        /// <summary>The name of the API key.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = false,
        ReadOnly = false,
