...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class AppServicePlanPatchResourceProperties
    {
        ...
        internal AppServicePlanPatchResourceProperties(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_kubeEnvironmentProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("kubeEnvironmentProfile"), out var __jsonKubeEnvironmentProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.KubeEnvironmentProfile.FromJson(__jsonKubeEnvironmentProfile) : _kubeEnvironmentProfile;}
            {_workerTierName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("workerTierName"), out var __jsonWorkerTierName) ? (string)__jsonWorkerTierName : (string)_workerTierName;}
            ...
            {_subscription = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("subscription"), out var __jsonSubscription) ? (string)__jsonSubscription : (string)_subscription;}
            {_maximumNumberOfWorker = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("maximumNumberOfWorkers"), out var __jsonMaximumNumberOfWorkers) ? (int?)__jsonMaximumNumberOfWorkers : _maximumNumberOfWorker;}
            ...
            {_geoRegion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("geoRegion"), out var __jsonGeoRegion) ? (string)__jsonGeoRegion : (string)_geoRegion;}
            {_perSiteScaling = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("perSiteScaling"), out var __jsonPerSiteScaling) ? (bool?)__jsonPerSiteScaling : _perSiteScaling;}
            {_elasticScaleEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("elasticScaleEnabled"), out var __jsonElasticScaleEnabled) ? (bool?)__jsonElasticScaleEnabled : _elasticScaleEnabled;}
            {_maximumElasticWorkerCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("maximumElasticWorkerCount"), out var __jsonMaximumElasticWorkerCount) ? (int?)__jsonMaximumElasticWorkerCount : _maximumElasticWorkerCount;}
            {_numberOfSite = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("numberOfSites"), out var __jsonNumberOfSites) ? (int?)__jsonNumberOfSites : _numberOfSite;}
            ...
            {_targetWorkerCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("targetWorkerCount"), out var __jsonTargetWorkerCount) ? (int?)__jsonTargetWorkerCount : _targetWorkerCount;}
            {_targetWorkerSizeId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("targetWorkerSizeId"), out var __jsonTargetWorkerSizeId) ? (int?)__jsonTargetWorkerSizeId : _targetWorkerSizeId;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAppServicePlanPatchResourceProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAppServicePlanPatchResourceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAppServicePlanPatchResourceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
