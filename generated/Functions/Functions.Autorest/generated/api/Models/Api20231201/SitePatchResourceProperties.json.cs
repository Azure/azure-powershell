...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201
{
    ...
    public partial class SitePatchResourceProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISitePatchResourceProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISitePatchResourceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISitePatchResourceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json ? new SitePatchResourceProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject into a new instance of <see cref="SitePatchResourceProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SitePatchResourceProperties(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_dnsConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("dnsConfiguration"), out var __jsonDnsConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.SiteDnsConfig.FromJson(__jsonDnsConfiguration) : DnsConfiguration;}
            ...
            {_cloningInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("cloningInfo"), out var __jsonCloningInfo) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.CloningInfo.FromJson(__jsonCloningInfo) : CloningInfo;}
            {_slotSwapStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("slotSwapStatus"), out var __jsonSlotSwapStatus) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.SlotSwapStatus.FromJson(__jsonSlotSwapStatus) : SlotSwapStatus;}
            ...
            {_hostNameSslState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("hostNameSslStates"), out var __jsonHostNameSslStates) ? If( __jsonHostNameSslStates as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.IHostNameSslState[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.IHostNameSslState) (Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.HostNameSslState.FromJson(__k) )) ))() : null : HostNameSslState;}
            ...
            {_clientCertMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("clientCertMode"), out var __jsonClientCertMode) ? (string)__jsonClientCertMode : (string)ClientCertMode;}
            ...
            {_customDomainVerificationId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("customDomainVerificationId"), out var __jsonCustomDomainVerificationId) ? (string)__jsonCustomDomainVerificationId : (string)CustomDomainVerificationId;}
            ...
            {_virtualNetworkSubnetId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("virtualNetworkSubnetId"), out var __jsonVirtualNetworkSubnetId) ? (string)__jsonVirtualNetworkSubnetId : (string)VirtualNetworkSubnetId;}
            {_siteConfig = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("siteConfig"), out var __jsonSiteConfig) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.SiteConfig.FromJson(__jsonSiteConfig) : SiteConfig;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SitePatchResourceProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="SitePatchResourceProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._dnsConfiguration ? (Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode) this._dnsConfiguration.ToJson(null,serializationMode) : null, "dnsConfiguration" ,container.Add );
            ...
            AddIf( null != (((object)this._clientCertMode)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString(this._clientCertMode.ToString()) : null, "clientCertMode" ,container.Add );
            ...
            AddIf( null != (((object)this._customDomainVerificationId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString(this._customDomainVerificationId.ToString()) : null, "customDomainVerificationId" ,container.Add );
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            AddIf( null != (((object)this._virtualNetworkSubnetId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString(this._virtualNetworkSubnetId.ToString()) : null, "virtualNetworkSubnetId" ,container.Add );
