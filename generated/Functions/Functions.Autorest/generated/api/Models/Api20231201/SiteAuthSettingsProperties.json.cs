...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201
{
    ...
    public partial class SiteAuthSettingsProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISiteAuthSettingsProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISiteAuthSettingsProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISiteAuthSettingsProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal SiteAuthSettingsProperties(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_allowedExternalRedirectUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("allowedExternalRedirectUrls"), out var __jsonAllowedExternalRedirectUrls) ? If( __jsonAllowedExternalRedirectUrls as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : AllowedExternalRedirectUrl;}
            ...
            {_additionalLoginParam = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("additionalLoginParams"), out var __jsonAdditionalLoginParams) ? If( __jsonAdditionalLoginParams as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(string) (__k is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString __j ? (string)(__j.ToString()) : null)) ))() : null : AdditionalLoginParam;}
            {_aadClaimsAuthorization = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("aadClaimsAuthorization"), out var __jsonAadClaimsAuthorization) ? (string)__jsonAadClaimsAuthorization : (string)AadClaimsAuthorization;}
            ...
            {_googleClientSecretSettingName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("googleClientSecretSettingName"), out var __jsonGoogleClientSecretSettingName) ? (string)__jsonGoogleClientSecretSettingName : (string)GoogleClientSecretSettingName;}
            {_googleOAuthScope = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("googleOAuthScopes"), out var __jsonGoogleOAuthScopes) ? If( __jsonGoogleOAuthScopes as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__g, (__f)=>(string) (__f is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString __e ? (string)(__e.ToString()) : null)) ))() : null : GoogleOAuthScope;}
            ...
            {_facebookAppSecretSettingName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("facebookAppSecretSettingName"), out var __jsonFacebookAppSecretSettingName) ? (string)__jsonFacebookAppSecretSettingName : (string)FacebookAppSecretSettingName;}
            {_facebookOAuthScope = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("facebookOAuthScopes"), out var __jsonFacebookOAuthScopes) ? If( __jsonFacebookOAuthScopes as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __b) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__b, (__a)=>(string) (__a is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString ___z ? (string)(___z.ToString()) : null)) ))() : null : FacebookOAuthScope;}
            {_gitHubClientId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("gitHubClientId"), out var __jsonGitHubClientId) ? (string)__jsonGitHubClientId : (string)GitHubClientId;}
            {_gitHubClientSecret = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("gitHubClientSecret"), out var __jsonGitHubClientSecret) ? (string)__jsonGitHubClientSecret : (string)GitHubClientSecret;}
            {_gitHubClientSecretSettingName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("gitHubClientSecretSettingName"), out var __jsonGitHubClientSecretSettingName) ? (string)__jsonGitHubClientSecretSettingName : (string)GitHubClientSecretSettingName;}
            {_gitHubOAuthScope = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("gitHubOAuthScopes"), out var __jsonGitHubOAuthScopes) ? If( __jsonGitHubOAuthScopes as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var ___w) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(___w, (___v)=>(string) (___v is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString ___u ? (string)(___u.ToString()) : null)) ))() : null : GitHubOAuthScope;}
            ...
            {_twitterConsumerSecretSettingName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("twitterConsumerSecretSettingName"), out var __jsonTwitterConsumerSecretSettingName) ? (string)__jsonTwitterConsumerSecretSettingName : (string)TwitterConsumerSecretSettingName;}
            ...
            {_microsoftAccountOAuthScope = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("microsoftAccountOAuthScopes"), out var __jsonMicrosoftAccountOAuthScopes) ? If( __jsonMicrosoftAccountOAuthScopes as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var ___r) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(___r, (___q)=>(string) (___q is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString ___p ? (string)(___p.ToString()) : null)) ))() : null : MicrosoftAccountOAuthScope;}
            {_isAuthFromFile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("isAuthFromFile"), out var __jsonIsAuthFromFile) ? (string)__jsonIsAuthFromFile : (string)IsAuthFromFile;}
            {_authFilePath = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("authFilePath"), out var __jsonAuthFilePath) ? (string)__jsonAuthFilePath : (string)AuthFilePath;}
            {_configVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("configVersion"), out var __jsonConfigVersion) ? (string)__jsonConfigVersion : (string)ConfigVersion;}
            AfterFromJson(json);
        }
