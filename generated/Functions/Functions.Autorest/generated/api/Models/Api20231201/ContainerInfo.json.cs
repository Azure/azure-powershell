...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201
{
    ...
    public partial class ContainerInfo
    {
        ...
        internal ContainerInfo(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_currentCpuStat = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("currentCpuStats"), out var __jsonCurrentCpuStats) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ContainerCpuStatistics.FromJson(__jsonCurrentCpuStats) : CurrentCpuStat;}
            {_previousCpuStat = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("previousCpuStats"), out var __jsonPreviousCpuStats) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ContainerCpuStatistics.FromJson(__jsonPreviousCpuStats) : PreviousCpuStat;}
            {_memoryStat = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("memoryStats"), out var __jsonMemoryStats) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ContainerMemoryStatistics.FromJson(__jsonMemoryStats) : MemoryStat;}
            {_eth0 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("eth0"), out var __jsonEth0) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ContainerNetworkInterfaceStatistics.FromJson(__jsonEth0) : Eth0;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.IContainerInfo.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.IContainerInfo.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.IContainerInfo FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
