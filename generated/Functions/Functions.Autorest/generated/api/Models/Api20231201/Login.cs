...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201
{
    ...
    public partial class Login :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ILogin,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ILoginInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ICookieExpiration _cookieExpiration;

        /// <summary>The configuration settings of the session cookie's expiration.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ICookieExpiration CookieExpiration { get => (this._cookieExpiration = this._cookieExpiration ?? new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.CookieExpiration()); set => this._cookieExpiration = value; }

        /// <summary>The convention used when determining the session cookie's expiration.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.CookieExpirationConvention? CookieExpirationConvention { get => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ICookieExpirationInternal)CookieExpiration).Convention; set => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ICookieExpirationInternal)CookieExpiration).Convention = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.CookieExpirationConvention)""); }

        /// <summary>The time after the request is made when the session cookie should expire.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Inlined)]
        public string CookieExpirationTimeToExpiration { get => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ICookieExpirationInternal)CookieExpiration).TimeToExpiration; set => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ICookieExpirationInternal)CookieExpiration).TimeToExpiration = value ?? null; }

        /// <summary>The directory in which the tokens will be stored.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Inlined)]
        public string FileSystemDirectory { get => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ITokenStoreInternal)TokenStore).FileSystemDirectory; set => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ITokenStoreInternal)TokenStore).FileSystemDirectory = value ?? null; }

        /// <summary>Internal Acessors for CookieExpiration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ICookieExpiration Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ILoginInternal.CookieExpiration { get => (this._cookieExpiration = this._cookieExpiration ?? new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.CookieExpiration()); set { {_cookieExpiration = value;} } }

        /// <summary>Internal Acessors for Nonce</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.INonce Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ILoginInternal.Nonce { get => (this._nonce = this._nonce ?? new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.Nonce()); set { {_nonce = value;} } }

        /// <summary>Internal Acessors for Route</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ILoginRoutes Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ILoginInternal.Route { get => (this._route = this._route ?? new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.LoginRoutes()); set { {_route = value;} } }

        /// <summary>Internal Acessors for TokenStore</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ITokenStore Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ILoginInternal.TokenStore { get => (this._tokenStore = this._tokenStore ?? new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.TokenStore()); set { {_tokenStore = value;} } }

        /// <summary>Internal Acessors for TokenStoreAzureBlobStorage</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.IBlobStorageTokenStore Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ILoginInternal.TokenStoreAzureBlobStorage { get => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ITokenStoreInternal)TokenStore).AzureBlobStorage; set => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ITokenStoreInternal)TokenStore).AzureBlobStorage = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.INonce _nonce;

        /// <summary>The configuration settings of the nonce used in the login flow.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.INonce Nonce { get => (this._nonce = this._nonce ?? new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.Nonce()); set => this._nonce = value; }

        /// <summary>The time after the request is made when the nonce should expire.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Inlined)]
        public string NonceExpirationInterval { get => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.INonceInternal)Nonce).ExpirationInterval; set => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.INonceInternal)Nonce).ExpirationInterval = value ?? null; }

        /// <summary>
        /// <code>false</code> if the nonce should not be validated while completing the login flow; otherwise, <code>true</code>.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Inlined)]
        public bool? NonceValidateNonce { get => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.INonceInternal)Nonce).ValidateNonce; set => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.INonceInternal)Nonce).ValidateNonce = value ?? default(bool); }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ILoginRoutes _route;

        /// <summary>The routes that specify the endpoints used for login and logout requests.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ILoginRoutes Route { get => (this._route = this._route ?? new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.LoginRoutes()); set => this._route = value; }

        /// <summary>The endpoint at which a logout request should be made.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Inlined)]
        public string RouteLogoutEndpoint { get => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ILoginRoutesInternal)Route).LogoutEndpoint; set => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ILoginRoutesInternal)Route).LogoutEndpoint = value ?? null; }

        /// <summary>Backing field for <see cref="TokenStore" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ITokenStore _tokenStore;

        /// <summary>The configuration settings of the token store.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ITokenStore TokenStore { get => (this._tokenStore = this._tokenStore ?? new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.TokenStore()); set => this._tokenStore = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Inlined)]
        public bool? TokenStoreEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ITokenStoreInternal)TokenStore).Enabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ITokenStoreInternal)TokenStore).Enabled = value ?? default(bool); }
...

    {
        ...
        string AzureBlobStorageSasUrlSettingName { get; set; }
        /// <summary>The configuration settings of the session cookie's expiration.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ICookieExpiration CookieExpiration { get; set; }
        /// <summary>The convention used when determining the session cookie's expiration.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.CookieExpirationConvention? CookieExpirationConvention { get; set; }
        /// <summary>The time after the request is made when the session cookie should expire.</summary>
        string CookieExpirationTimeToExpiration { get; set; }
        ...
        string FileSystemDirectory { get; set; }
        /// <summary>The configuration settings of the nonce used in the login flow.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.INonce Nonce { get; set; }
        /// <summary>The time after the request is made when the nonce should expire.</summary>
        string NonceExpirationInterval { get; set; }
        /// <summary>
        /// <code>false</code> if the nonce should not be validated while completing the login flow; otherwise, <code>true</code>.
        ...
        bool? PreserveUrlFragmentsForLogin { get; set; }
        /// <summary>The routes that specify the endpoints used for login and logout requests.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ILoginRoutes Route { get; set; }
        /// <summary>The endpoint at which a logout request should be made.</summary>
        string RouteLogoutEndpoint { get; set; }
        /// <summary>The configuration settings of the token store.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ITokenStore TokenStore { get; set; }
        /// <summary>
