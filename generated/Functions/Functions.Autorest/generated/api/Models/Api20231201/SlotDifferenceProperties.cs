...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201
{
    ...
    public partial class SlotDifferenceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISlotDifferenceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISlotDifferencePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISlotDifferencePropertiesInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for DiffRule</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISlotDifferencePropertiesInternal.DiffRule { get => this._diffRule; set { {_diffRule = value;} } }

        /// <summary>Internal Acessors for Level</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISlotDifferencePropertiesInternal.Level { get => this._level; set { {_level = value;} } }

        /// <summary>Internal Acessors for SettingName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISlotDifferencePropertiesInternal.SettingName { get => this._settingName; set { {_settingName = value;} } }

        /// <summary>Internal Acessors for SettingType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISlotDifferencePropertiesInternal.SettingType { get => this._settingType; set { {_settingType = value;} } }

        /// <summary>Internal Acessors for ValueInCurrentSlot</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISlotDifferencePropertiesInternal.ValueInCurrentSlot { get => this._valueInCurrentSlot; set { {_valueInCurrentSlot = value;} } }

        /// <summary>Internal Acessors for ValueInTargetSlot</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISlotDifferencePropertiesInternal.ValueInTargetSlot { get => this._valueInTargetSlot; set { {_valueInTargetSlot = value;} } }
