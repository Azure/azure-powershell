...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class CsmUsageQuota :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICsmUsageQuota,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICsmUsageQuotaInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILocalizableString Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICsmUsageQuotaInternal.Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.LocalizableString()); set { {_name = value;} } }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILocalizableString _name;

        /// <summary>Quota name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILocalizableString Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.LocalizableString()); set => this._name = value; }

        /// <summary>Localized name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Inlined)]
        public string NameLocalizedValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILocalizableStringInternal)Name).LocalizedValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILocalizableStringInternal)Name).LocalizedValue = value ?? null; }

        /// <summary>Non-localized name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Inlined)]
        public string NameValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILocalizableStringInternal)Name).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILocalizableStringInternal)Name).Value = value ?? null; }
...

    {
        ...
        long? Limit { get; set; }
        /// <summary>Quota name.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILocalizableString Name { get; set; }
        /// <summary>Localized name.</summary>
        string NameLocalizedValue { get; set; }
        /// <summary>Non-localized name.</summary>
        string NameValue { get; set; }
