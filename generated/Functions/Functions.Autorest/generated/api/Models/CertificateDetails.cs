...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class CertificateDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICertificateDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICertificateDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICertificateDetailsInternal.Issuer { get => this._issuer; set { {_issuer = value;} } }

        /// <summary>Internal Acessors for NotAfter</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICertificateDetailsInternal.NotAfter { get => this._notAfter; set { {_notAfter = value;} } }

        /// <summary>Internal Acessors for NotBefore</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICertificateDetailsInternal.NotBefore { get => this._notBefore; set { {_notBefore = value;} } }

        /// <summary>Internal Acessors for RawData</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICertificateDetailsInternal.RawData { get => this._rawData; set { {_rawData = value;} } }

        /// <summary>Internal Acessors for SerialNumber</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICertificateDetailsInternal.SerialNumber { get => this._serialNumber; set { {_serialNumber = value;} } }

        /// <summary>Internal Acessors for SignatureAlgorithm</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICertificateDetailsInternal.SignatureAlgorithm { get => this._signatureAlgorithm; set { {_signatureAlgorithm = value;} } }

        /// <summary>Internal Acessors for Subject</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICertificateDetailsInternal.Subject { get => this._subject; set { {_subject = value;} } }

        /// <summary>Internal Acessors for Thumbprint</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICertificateDetailsInternal.Thumbprint { get => this._thumbprint; set { {_thumbprint = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICertificateDetailsInternal.Version { get => this._version; set { {_version = value;} } }
