...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class StackMajorVersion
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStackMajorVersion.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStackMajorVersion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStackMajorVersion FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal StackMajorVersion(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_displayVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("displayVersion"), out var __jsonDisplayVersion) ? (string)__jsonDisplayVersion : (string)_displayVersion;}
            {_runtimeVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("runtimeVersion"), out var __jsonRuntimeVersion) ? (string)__jsonRuntimeVersion : (string)_runtimeVersion;}
            {_isDefault = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("isDefault"), out var __jsonIsDefault) ? (bool?)__jsonIsDefault : _isDefault;}
            {_minorVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("minorVersions"), out var __jsonMinorVersions) ? If( __jsonMinorVersions as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStackMinorVersion>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStackMinorVersion) (Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.StackMinorVersion.FromJson(__u) )) ))() : null : _minorVersion;}
            {_applicationInsight = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("applicationInsights"), out var __jsonApplicationInsights) ? (bool?)__jsonApplicationInsights : _applicationInsight;}
            {_isPreview = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("isPreview"), out var __jsonIsPreview) ? (bool?)__jsonIsPreview : _isPreview;}
            {_isDeprecated = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("isDeprecated"), out var __jsonIsDeprecated) ? (bool?)__jsonIsDeprecated : _isDeprecated;}
            {_isHidden = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("isHidden"), out var __jsonIsHidden) ? (bool?)__jsonIsHidden : _isHidden;}
            {_appSettingsDictionary = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("appSettingsDictionary"), out var __jsonAppSettingsDictionary) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.StackMajorVersionAppSettingsDictionary.FromJson(__jsonAppSettingsDictionary) : _appSettingsDictionary;}
            {_siteConfigPropertiesDictionary = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("siteConfigPropertiesDictionary"), out var __jsonSiteConfigPropertiesDictionary) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.StackMajorVersionSiteConfigPropertiesDictionary.FromJson(__jsonSiteConfigPropertiesDictionary) : _siteConfigPropertiesDictionary;}
            AfterFromJson(json);
        }
