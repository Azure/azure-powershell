...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class SiteExtensionInfoProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISiteExtensionInfoProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISiteExtensionInfoProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISiteExtensionInfoProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal SiteExtensionInfoProperties(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_extensionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("extension_id"), out var __jsonExtensionId) ? (string)__jsonExtensionId : (string)_extensionId;}
            ...
            {_extensionType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("extension_type"), out var __jsonExtensionType) ? (string)__jsonExtensionType : (string)_extensionType;}
            {_summary = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("summary"), out var __jsonSummary) ? (string)__jsonSummary : (string)_summary;}
            ...
            {_extensionUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("extension_url"), out var __jsonExtensionUrl) ? (string)__jsonExtensionUrl : (string)_extensionUrl;}
            {_projectUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("project_url"), out var __jsonProjectUrl) ? (string)__jsonProjectUrl : (string)_projectUrl;}
            {_iconUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("icon_url"), out var __jsonIconUrl) ? (string)__jsonIconUrl : (string)_iconUrl;}
            {_licenseUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("license_url"), out var __jsonLicenseUrl) ? (string)__jsonLicenseUrl : (string)_licenseUrl;}
            {_feedUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("feed_url"), out var __jsonFeedUrl) ? (string)__jsonFeedUrl : (string)_feedUrl;}
            {_author = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("authors"), out var __jsonAuthors) ? If( __jsonAuthors as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _author;}
            {_installerCommandLineParam = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("installer_command_line_params"), out var __jsonInstallerCommandLineParams) ? (string)__jsonInstallerCommandLineParams : (string)_installerCommandLineParam;}
            ...
            {_downloadCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("download_count"), out var __jsonDownloadCount) ? (int?)__jsonDownloadCount : _downloadCount;}
            {_localIsLatestVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("local_is_latest_version"), out var __jsonLocalIsLatestVersion) ? (bool?)__jsonLocalIsLatestVersion : _localIsLatestVersion;}
            {_localPath = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("local_path"), out var __jsonLocalPath) ? (string)__jsonLocalPath : (string)_localPath;}
            ...
            {_comment = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("comment"), out var __jsonComment) ? (string)__jsonComment : (string)_comment;}
            AfterFromJson(json);
        }
