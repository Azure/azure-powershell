...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class StaticSiteCustomDomainOverviewArmResourceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteCustomDomainOverviewArmResourceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteCustomDomainOverviewArmResourcePropertiesInternal
    {
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteCustomDomainOverviewArmResourcePropertiesInternal.CreatedOn { get => this._createdOn; set { {_createdOn = value;} } }

        /// <summary>Internal Acessors for DomainName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteCustomDomainOverviewArmResourcePropertiesInternal.DomainName { get => this._domainName; set { {_domainName = value;} } }

        /// <summary>Internal Acessors for ErrorMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteCustomDomainOverviewArmResourcePropertiesInternal.ErrorMessage { get => this._errorMessage; set { {_errorMessage = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteCustomDomainOverviewArmResourcePropertiesInternal.Status { get => this._status; set { {_status = value;} } }

        /// <summary>Internal Acessors for ValidationToken</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStaticSiteCustomDomainOverviewArmResourcePropertiesInternal.ValidationToken { get => this._validationToken; set { {_validationToken = value;} } }
