...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class AseRegionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAseRegionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAseRegionPropertiesInternal
    {

        /// <summary>Backing field for <see cref="AvailableOS" /> property.</summary>
        private System.Collections.Generic.List<string> _availableOS;

        /// <summary>Available OSs in region.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> AvailableOS { get => this._availableOS; set => this._availableOS = value; }

        /// <summary>Backing field for <see cref="AvailableSku" /> property.</summary>
        private System.Collections.Generic.List<string> _availableSku;

        /// <summary>Available Skus in region.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> AvailableSku { get => this._availableSku; set => this._availableSku = value; }
        ...
        bool? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAseRegionPropertiesInternal.DedicatedHost { get => this._dedicatedHost; set { {_dedicatedHost = value;} } }

        /// <summary>Internal Acessors for DisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAseRegionPropertiesInternal.DisplayName { get => this._displayName; set { {_displayName = value;} } }

        /// <summary>Internal Acessors for Standard</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAseRegionPropertiesInternal.Standard { get => this._standard; set { {_standard = value;} } }

        /// <summary>Internal Acessors for ZoneRedundant</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAseRegionPropertiesInternal.ZoneRedundant { get => this._zoneRedundant; set { {_zoneRedundant = value;} } }
