...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class GeoRegionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IGeoRegionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IGeoRegionPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IGeoRegionPropertiesInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for DisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IGeoRegionPropertiesInternal.DisplayName { get => this._displayName; set { {_displayName = value;} } }

        /// <summary>Internal Acessors for OrgDomain</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IGeoRegionPropertiesInternal.OrgDomain { get => this._orgDomain; set { {_orgDomain = value;} } }
