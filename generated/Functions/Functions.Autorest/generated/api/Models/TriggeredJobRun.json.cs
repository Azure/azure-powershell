...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class TriggeredJobRun
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ITriggeredJobRun.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ITriggeredJobRun.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ITriggeredJobRun FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal TriggeredJobRun(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_webJobId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("web_job_id"), out var __jsonWebJobId) ? (string)__jsonWebJobId : (string)_webJobId;}
            {_webJobName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("web_job_name"), out var __jsonWebJobName) ? (string)__jsonWebJobName : (string)_webJobName;}
            ...
            {_duration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("duration"), out var __jsonDuration) ? (string)__jsonDuration : (string)_duration;}
            {_outputUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("output_url"), out var __jsonOutputUrl) ? (string)__jsonOutputUrl : (string)_outputUrl;}
            {_errorUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("error_url"), out var __jsonErrorUrl) ? (string)__jsonErrorUrl : (string)_errorUrl;}
            ...
            {_jobName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("job_name"), out var __jsonJobName) ? (string)__jsonJobName : (string)_jobName;}
            {_trigger = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("trigger"), out var __jsonTrigger) ? (string)__jsonTrigger : (string)_trigger;}
            AfterFromJson(json);
        }
    }
}