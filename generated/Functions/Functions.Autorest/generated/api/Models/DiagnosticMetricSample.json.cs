...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class DiagnosticMetricSample
    {
        ...
        internal DiagnosticMetricSample(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_roleInstance = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("roleInstance"), out var __jsonRoleInstance) ? (string)__jsonRoleInstance : (string)_roleInstance;}
            {_total = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("total"), out var __jsonTotal) ? (double?)__jsonTotal : _total;}
            {_maximum = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("maximum"), out var __jsonMaximum) ? (double?)__jsonMaximum : _maximum;}
            {_minimum = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("minimum"), out var __jsonMinimum) ? (double?)__jsonMinimum : _minimum;}
            {_isAggregated = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("isAggregated"), out var __jsonIsAggregated) ? (bool?)__jsonIsAggregated : _isAggregated;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDiagnosticMetricSample.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDiagnosticMetricSample.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDiagnosticMetricSample FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
