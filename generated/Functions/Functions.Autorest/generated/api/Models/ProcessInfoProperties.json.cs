...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class ProcessInfoProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IProcessInfoProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IProcessInfoProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IProcessInfoProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal ProcessInfoProperties(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_identifier = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("identifier"), out var __jsonIdentifier) ? (int?)__jsonIdentifier : _identifier;}
            {_deploymentName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("deployment_name"), out var __jsonDeploymentName) ? (string)__jsonDeploymentName : (string)_deploymentName;}
            {_href = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("href"), out var __jsonHref) ? (string)__jsonHref : (string)_href;}
            {_minidump = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("minidump"), out var __jsonMinidump) ? (string)__jsonMinidump : (string)_minidump;}
            {_isProfileRunning = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("is_profile_running"), out var __jsonIsProfileRunning) ? (bool?)__jsonIsProfileRunning : _isProfileRunning;}
            {_isIisProfileRunning = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("is_iis_profile_running"), out var __jsonIsIisProfileRunning) ? (bool?)__jsonIsIisProfileRunning : _isIisProfileRunning;}
            {_iisProfileTimeoutInSecond = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("iis_profile_timeout_in_seconds"), out var __jsonIisProfileTimeoutInSeconds) ? (double?)__jsonIisProfileTimeoutInSeconds : _iisProfileTimeoutInSecond;}
            {_parent = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("parent"), out var __jsonParent) ? (string)__jsonParent : (string)_parent;}
            {_child = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("children"), out var __jsonChildren) ? If( __jsonChildren as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _child;}
            {_thread = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("threads"), out var __jsonThreads) ? If( __jsonThreads as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IProcessThreadInfo>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IProcessThreadInfo) (Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ProcessThreadInfo.FromJson(__p) )) ))() : null : _thread;}
            {_openFileHandle = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("open_file_handles"), out var __jsonOpenFileHandles) ? If( __jsonOpenFileHandles as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(string) (__k is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString __j ? (string)(__j.ToString()) : null)) ))() : null : _openFileHandle;}
            {_module = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("modules"), out var __jsonModules) ? If( __jsonModules as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IProcessModuleInfo>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__g, (__f)=>(Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IProcessModuleInfo) (Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ProcessModuleInfo.FromJson(__f) )) ))() : null : _module;}
            {_fileName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("file_name"), out var __jsonFileName) ? (string)__jsonFileName : (string)_fileName;}
            {_commandLine = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("command_line"), out var __jsonCommandLine) ? (string)__jsonCommandLine : (string)_commandLine;}
            {_userName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("user_name"), out var __jsonUserName) ? (string)__jsonUserName : (string)_userName;}
            {_handleCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("handle_count"), out var __jsonHandleCount) ? (int?)__jsonHandleCount : _handleCount;}
            {_moduleCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("module_count"), out var __jsonModuleCount) ? (int?)__jsonModuleCount : _moduleCount;}
            {_threadCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("thread_count"), out var __jsonThreadCount) ? (int?)__jsonThreadCount : _threadCount;}
            ...
            {_totalCpuTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("total_cpu_time"), out var __jsonTotalCpuTime) ? (string)__jsonTotalCpuTime : (string)_totalCpuTime;}
            {_userCpuTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("user_cpu_time"), out var __jsonUserCpuTime) ? (string)__jsonUserCpuTime : (string)_userCpuTime;}
            {_privilegedCpuTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("privileged_cpu_time"), out var __jsonPrivilegedCpuTime) ? (string)__jsonPrivilegedCpuTime : (string)_privilegedCpuTime;}
            {_workingSet = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("working_set"), out var __jsonWorkingSet) ? (long?)__jsonWorkingSet : _workingSet;}
            {_peakWorkingSet = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("peak_working_set"), out var __jsonPeakWorkingSet) ? (long?)__jsonPeakWorkingSet : _peakWorkingSet;}
            {_privateMemory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("private_memory"), out var __jsonPrivateMemory) ? (long?)__jsonPrivateMemory : _privateMemory;}
            {_virtualMemory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("virtual_memory"), out var __jsonVirtualMemory) ? (long?)__jsonVirtualMemory : _virtualMemory;}
            {_peakVirtualMemory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("peak_virtual_memory"), out var __jsonPeakVirtualMemory) ? (long?)__jsonPeakVirtualMemory : _peakVirtualMemory;}
            {_pagedSystemMemory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("paged_system_memory"), out var __jsonPagedSystemMemory) ? (long?)__jsonPagedSystemMemory : _pagedSystemMemory;}
            {_nonPagedSystemMemory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("non_paged_system_memory"), out var __jsonNonPagedSystemMemory) ? (long?)__jsonNonPagedSystemMemory : _nonPagedSystemMemory;}
            {_pagedMemory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("paged_memory"), out var __jsonPagedMemory) ? (long?)__jsonPagedMemory : _pagedMemory;}
            {_peakPagedMemory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("peak_paged_memory"), out var __jsonPeakPagedMemory) ? (long?)__jsonPeakPagedMemory : _peakPagedMemory;}
            ...
            {_environmentVariable = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("environment_variables"), out var __jsonEnvironmentVariables) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ProcessInfoPropertiesEnvironmentVariables.FromJson(__jsonEnvironmentVariables) : _environmentVariable;}
            {_isScmSite = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("is_scm_site"), out var __jsonIsScmSite) ? (bool?)__jsonIsScmSite : _isScmSite;}
            {_isWebjob = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("is_webjob"), out var __jsonIsWebjob) ? (bool?)__jsonIsWebjob : _isWebjob;}
