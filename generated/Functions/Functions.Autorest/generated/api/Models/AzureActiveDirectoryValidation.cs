...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class AzureActiveDirectoryValidation :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAzureActiveDirectoryValidation,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAzureActiveDirectoryValidationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDefaultAuthorizationPolicy _defaultAuthorizationPolicy;

        /// <summary>The configuration settings of the default authorization policy.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDefaultAuthorizationPolicy DefaultAuthorizationPolicy { get => (this._defaultAuthorizationPolicy = this._defaultAuthorizationPolicy ?? new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.DefaultAuthorizationPolicy()); set => this._defaultAuthorizationPolicy = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IJwtClaimChecks _jwtClaimCheck;

        /// <summary>
        /// The configuration settings of the checks that should be made while validating the JWT Claims.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IJwtClaimChecks JwtClaimCheck { get => (this._jwtClaimCheck = this._jwtClaimCheck ?? new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.JwtClaimChecks()); set => this._jwtClaimCheck = value; }

        /// <summary>The list of the allowed client applications.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> JwtClaimCheckAllowedClientApplication { get => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IJwtClaimChecksInternal)JwtClaimCheck).AllowedClientApplication; set => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IJwtClaimChecksInternal)JwtClaimCheck).AllowedClientApplication = value ?? null /* arrayOf */; }

        /// <summary>The list of the allowed groups.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> JwtClaimCheckAllowedGroup { get => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IJwtClaimChecksInternal)JwtClaimCheck).AllowedGroup; set => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IJwtClaimChecksInternal)JwtClaimCheck).AllowedGroup = value ?? null /* arrayOf */; }

        /// <summary>Internal Acessors for DefaultAuthorizationPolicy</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDefaultAuthorizationPolicy Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAzureActiveDirectoryValidationInternal.DefaultAuthorizationPolicy { get => (this._defaultAuthorizationPolicy = this._defaultAuthorizationPolicy ?? new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.DefaultAuthorizationPolicy()); set { {_defaultAuthorizationPolicy = value;} } }

        /// <summary>Internal Acessors for DefaultAuthorizationPolicyAllowedPrincipal</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAllowedPrincipals Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAzureActiveDirectoryValidationInternal.DefaultAuthorizationPolicyAllowedPrincipal { get => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDefaultAuthorizationPolicyInternal)DefaultAuthorizationPolicy).AllowedPrincipal; set => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDefaultAuthorizationPolicyInternal)DefaultAuthorizationPolicy).AllowedPrincipal = value ?? null /* model class */; }

        /// <summary>Internal Acessors for JwtClaimCheck</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IJwtClaimChecks Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAzureActiveDirectoryValidationInternal.JwtClaimCheck { get => (this._jwtClaimCheck = this._jwtClaimCheck ?? new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.JwtClaimChecks()); set { {_jwtClaimCheck = value;} } }
...

    {
        ...
        System.Collections.Generic.List<string> AllowedPrincipalIdentity { get; set; }
        /// <summary>The configuration settings of the default authorization policy.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDefaultAuthorizationPolicy DefaultAuthorizationPolicy { get; set; }
        /// <summary>The configuration settings of the Azure Active Directory allowed applications.</summary>
        System.Collections.Generic.List<string> DefaultAuthorizationPolicyAllowedApplication { get; set; }
        ...
        /// The configuration settings of the checks that should be made while validating the JWT Claims.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IJwtClaimChecks JwtClaimCheck { get; set; }
        /// <summary>The list of the allowed client applications.</summary>
        System.Collections.Generic.List<string> JwtClaimCheckAllowedClientApplication { get; set; }
        /// <summary>The list of the allowed groups.</summary>
        System.Collections.Generic.List<string> JwtClaimCheckAllowedGroup { get; set; }
