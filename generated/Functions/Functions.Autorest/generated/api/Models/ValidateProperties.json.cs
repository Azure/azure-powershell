...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class ValidateProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IValidateProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IValidateProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IValidateProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal ValidateProperties(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_skuName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("skuName"), out var __jsonSkuName) ? (string)__jsonSkuName : (string)_skuName;}
            {_needLinuxWorker = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("needLinuxWorkers"), out var __jsonNeedLinuxWorkers) ? (bool?)__jsonNeedLinuxWorkers : _needLinuxWorker;}
            {_isSpot = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("isSpot"), out var __jsonIsSpot) ? (bool?)__jsonIsSpot : _isSpot;}
            {_capacity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("capacity"), out var __jsonCapacity) ? (int?)__jsonCapacity : _capacity;}
            {_hostingEnvironment = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("hostingEnvironment"), out var __jsonHostingEnvironment) ? (string)__jsonHostingEnvironment : (string)_hostingEnvironment;}
            {_isXenon = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("isXenon"), out var __jsonIsXenon) ? (bool?)__jsonIsXenon : _isXenon;}
            {_containerRegistryBaseUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("containerRegistryBaseUrl"), out var __jsonContainerRegistryBaseUrl) ? (string)__jsonContainerRegistryBaseUrl : (string)_containerRegistryBaseUrl;}
            {_containerRegistryUsername = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("containerRegistryUsername"), out var __jsonContainerRegistryUsername) ? (string)__jsonContainerRegistryUsername : (string)_containerRegistryUsername;}
            {_containerRegistryPassword = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("containerRegistryPassword"), out var __jsonContainerRegistryPassword) ? (string)__jsonContainerRegistryPassword : (string)_containerRegistryPassword;}
            {_containerImageRepository = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("containerImageRepository"), out var __jsonContainerImageRepository) ? (string)__jsonContainerImageRepository : (string)_containerImageRepository;}
            {_containerImageTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("containerImageTag"), out var __jsonContainerImageTag) ? (string)__jsonContainerImageTag : (string)_containerImageTag;}
            {_containerImagePlatform = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("containerImagePlatform"), out var __jsonContainerImagePlatform) ? (string)__jsonContainerImagePlatform : (string)_containerImagePlatform;}
            {_appServiceEnvironment = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("appServiceEnvironment"), out var __jsonAppServiceEnvironment) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.AppServiceEnvironment.FromJson(__jsonAppServiceEnvironment) : _appServiceEnvironment;}
            AfterFromJson(json);
        }
    }
}