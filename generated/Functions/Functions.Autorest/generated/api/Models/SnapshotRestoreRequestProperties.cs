...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class SnapshotRestoreRequestProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISnapshotRestoreRequestProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISnapshotRestoreRequestPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISnapshotRecoverySource Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISnapshotRestoreRequestPropertiesInternal.RecoverySource { get => (this._recoverySource = this._recoverySource ?? new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.SnapshotRecoverySource()); set { {_recoverySource = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISnapshotRecoverySource _recoverySource;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISnapshotRecoverySource RecoverySource { get => (this._recoverySource = this._recoverySource ?? new Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.SnapshotRecoverySource()); set => this._recoverySource = value; }
        ...
        public string RecoverySourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISnapshotRecoverySourceInternal)RecoverySource).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISnapshotRecoverySourceInternal)RecoverySource).Id = value ?? null; }

        /// <summary>Geographical location of the source web app, e.g. SouthEastAsia, SouthCentralUS</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Inlined)]
        public string RecoverySourceLocation { get => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISnapshotRecoverySourceInternal)RecoverySource).Location; set => ((Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ISnapshotRecoverySourceInternal)RecoverySource).Location = value ?? null; }
