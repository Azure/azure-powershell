...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20150501
{
    ...
    public partial class ComponentPurgeBodyTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="ComponentPurgeBody" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20150501.IComponentPurgeBody ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20150501.IComponentPurgeBody).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
