...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class ContainerInfo
    {
        ...
        internal ContainerInfo(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_currentCpuStat = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("currentCpuStats"), out var __jsonCurrentCpuStats) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ContainerCpuStatistics.FromJson(__jsonCurrentCpuStats) : _currentCpuStat;}
            {_previousCpuStat = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("previousCpuStats"), out var __jsonPreviousCpuStats) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ContainerCpuStatistics.FromJson(__jsonPreviousCpuStats) : _previousCpuStat;}
            {_memoryStat = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("memoryStats"), out var __jsonMemoryStats) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ContainerMemoryStatistics.FromJson(__jsonMemoryStats) : _memoryStat;}
            {_eth0 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("eth0"), out var __jsonEth0) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ContainerNetworkInterfaceStatistics.FromJson(__jsonEth0) : _eth0;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IContainerInfo.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IContainerInfo.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IContainerInfo FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
