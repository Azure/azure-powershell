...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class DeletedSiteProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDeletedSiteProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDeletedSitePropertiesInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDeletedSitePropertiesInternal.DeletedSiteId { get => this._deletedSiteId; set { {_deletedSiteId = value;} } }

        /// <summary>Internal Acessors for DeletedSiteName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDeletedSitePropertiesInternal.DeletedSiteName { get => this._deletedSiteName; set { {_deletedSiteName = value;} } }

        /// <summary>Internal Acessors for DeletedTimestamp</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDeletedSitePropertiesInternal.DeletedTimestamp { get => this._deletedTimestamp; set { {_deletedTimestamp = value;} } }

        /// <summary>Internal Acessors for GeoRegionName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDeletedSitePropertiesInternal.GeoRegionName { get => this._geoRegionName; set { {_geoRegionName = value;} } }

        /// <summary>Internal Acessors for Kind</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDeletedSitePropertiesInternal.Kind { get => this._kind; set { {_kind = value;} } }

        /// <summary>Internal Acessors for ResourceGroup</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDeletedSitePropertiesInternal.ResourceGroup { get => this._resourceGroup; set { {_resourceGroup = value;} } }

        /// <summary>Internal Acessors for Slot</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDeletedSitePropertiesInternal.Slot { get => this._slot; set { {_slot = value;} } }

        /// <summary>Internal Acessors for Subscription</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IDeletedSitePropertiesInternal.Subscription { get => this._subscription; set { {_subscription = value;} } }
