...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class PublicCertificateProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IPublicCertificateProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IPublicCertificatePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IPublicCertificatePropertiesInternal.Thumbprint { get => this._thumbprint; set { {_thumbprint = value;} } }

        /// <summary>Backing field for <see cref="PublicCertificateLocation" /> property.</summary>
        private string _publicCertificateLocation;

        /// <summary>Public Certificate Location</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        public string PublicCertificateLocation { get => this._publicCertificateLocation; set => this._publicCertificateLocation = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.IJsonSerializable
    {
        ...
        string PublicCertificateLocation { get; set; }
        /// <summary>Certificate Thumbprint</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Info(
        Required = false,
        ReadOnly = true,
