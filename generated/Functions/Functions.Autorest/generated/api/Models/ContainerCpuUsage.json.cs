...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class ContainerCpuUsage
    {
        ...
        internal ContainerCpuUsage(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_totalUsage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("totalUsage"), out var __jsonTotalUsage) ? (long?)__jsonTotalUsage : _totalUsage;}
            {_perCpuUsage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("perCpuUsage"), out var __jsonPerCpuUsage) ? If( __jsonPerCpuUsage as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<long>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(long) (__u is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber __t ? (long)__t : default(long))) ))() : null : _perCpuUsage;}
            {_kernelModeUsage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("kernelModeUsage"), out var __jsonKernelModeUsage) ? (long?)__jsonKernelModeUsage : _kernelModeUsage;}
            {_userModeUsage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("userModeUsage"), out var __jsonUserModeUsage) ? (long?)__jsonUserModeUsage : _userModeUsage;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IContainerCpuUsage.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IContainerCpuUsage.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IContainerCpuUsage FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
