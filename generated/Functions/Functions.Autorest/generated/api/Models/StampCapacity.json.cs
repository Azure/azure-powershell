...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class StampCapacity
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStampCapacity.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStampCapacity.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IStampCapacity FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal StampCapacity(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_availableCapacity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("availableCapacity"), out var __jsonAvailableCapacity) ? (long?)__jsonAvailableCapacity : _availableCapacity;}
            {_totalCapacity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("totalCapacity"), out var __jsonTotalCapacity) ? (long?)__jsonTotalCapacity : _totalCapacity;}
            {_unit = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("unit"), out var __jsonUnit) ? (string)__jsonUnit : (string)_unit;}
            {_computeMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("computeMode"), out var __jsonComputeMode) ? (string)__jsonComputeMode : (string)_computeMode;}
            {_workerSize = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("workerSize"), out var __jsonWorkerSize) ? (string)__jsonWorkerSize : (string)_workerSize;}
            {_workerSizeId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("workerSizeId"), out var __jsonWorkerSizeId) ? (int?)__jsonWorkerSizeId : _workerSizeId;}
            {_excludeFromCapacityAllocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("excludeFromCapacityAllocation"), out var __jsonExcludeFromCapacityAllocation) ? (bool?)__jsonExcludeFromCapacityAllocation : _excludeFromCapacityAllocation;}
            {_isApplicableForAllComputeMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("isApplicableForAllComputeModes"), out var __jsonIsApplicableForAllComputeModes) ? (bool?)__jsonIsApplicableForAllComputeModes : _isApplicableForAllComputeMode;}
            {_siteMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("siteMode"), out var __jsonSiteMode) ? (string)__jsonSiteMode : (string)_siteMode;}
            {_isLinux = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("isLinux"), out var __jsonIsLinux) ? (bool?)__jsonIsLinux : _isLinux;}
            AfterFromJson(json);
        }
