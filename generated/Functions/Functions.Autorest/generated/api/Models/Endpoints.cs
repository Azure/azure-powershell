...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class Endpoints :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IEndpoints,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IEndpointsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IEndpointsInternal.Blob { get => this._blob; set { {_blob = value;} } }

        /// <summary>Internal Acessors for Df</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IEndpointsInternal.Df { get => this._df; set { {_df = value;} } }

        /// <summary>Internal Acessors for File</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IEndpointsInternal.File { get => this._file; set { {_file = value;} } }

        /// <summary>Internal Acessors for Queue</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IEndpointsInternal.Queue { get => this._queue; set { {_queue = value;} } }

        /// <summary>Internal Acessors for Table</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IEndpointsInternal.Table { get => this._table; set { {_table = value;} } }

        /// <summary>Internal Acessors for Web</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IEndpointsInternal.Web { get => this._web; set { {_web = value;} } }
