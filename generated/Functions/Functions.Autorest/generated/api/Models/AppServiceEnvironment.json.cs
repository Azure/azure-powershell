...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class AppServiceEnvironment
    {
        ...
        internal AppServiceEnvironment(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_virtualNetwork = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("virtualNetwork"), out var __jsonVirtualNetwork) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.VirtualNetworkProfile.FromJson(__jsonVirtualNetwork) : _virtualNetwork;}
            {_customDnsSuffixConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("customDnsSuffixConfiguration"), out var __jsonCustomDnsSuffixConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.CustomDnsSuffixConfiguration.FromJson(__jsonCustomDnsSuffixConfiguration) : _customDnsSuffixConfiguration;}
            {_networkingConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("networkingConfiguration"), out var __jsonNetworkingConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.AseV3NetworkingConfiguration.FromJson(__jsonNetworkingConfiguration) : _networkingConfiguration;}
            ...
            {_internalLoadBalancingMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("internalLoadBalancingMode"), out var __jsonInternalLoadBalancingMode) ? (string)__jsonInternalLoadBalancingMode : (string)_internalLoadBalancingMode;}
            {_multiSize = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("multiSize"), out var __jsonMultiSize) ? (string)__jsonMultiSize : (string)_multiSize;}
            {_multiRoleCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("multiRoleCount"), out var __jsonMultiRoleCount) ? (int?)__jsonMultiRoleCount : _multiRoleCount;}
            {_ipsslAddressCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("ipsslAddressCount"), out var __jsonIpsslAddressCount) ? (int?)__jsonIpsslAddressCount : _ipsslAddressCount;}
            {_dnsSuffix = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("dnsSuffix"), out var __jsonDnsSuffix) ? (string)__jsonDnsSuffix : (string)_dnsSuffix;}
            {_maximumNumberOfMachine = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("maximumNumberOfMachines"), out var __jsonMaximumNumberOfMachines) ? (int?)__jsonMaximumNumberOfMachines : _maximumNumberOfMachine;}
            {_frontEndScaleFactor = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("frontEndScaleFactor"), out var __jsonFrontEndScaleFactor) ? (int?)__jsonFrontEndScaleFactor : _frontEndScaleFactor;}
            {_suspended = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("suspended"), out var __jsonSuspended) ? (bool?)__jsonSuspended : _suspended;}
            {_clusterSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("clusterSettings"), out var __jsonClusterSettings) ? If( __jsonClusterSettings as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.INameValuePair>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.INameValuePair) (Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.NameValuePair.FromJson(__u) )) ))() : null : _clusterSetting;}
            {_userWhitelistedIPRange = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("userWhitelistedIpRanges"), out var __jsonUserWhitelistedIPRanges) ? If( __jsonUserWhitelistedIPRanges as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : _userWhitelistedIPRange;}
            {_hasLinuxWorker = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("hasLinuxWorkers"), out var __jsonHasLinuxWorkers) ? (bool?)__jsonHasLinuxWorkers : _hasLinuxWorker;}
            {_upgradePreference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("upgradePreference"), out var __jsonUpgradePreference) ? (string)__jsonUpgradePreference : (string)_upgradePreference;}
            {_dedicatedHostCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("dedicatedHostCount"), out var __jsonDedicatedHostCount) ? (int?)__jsonDedicatedHostCount : _dedicatedHostCount;}
            ...
            {_upgradeAvailability = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("upgradeAvailability"), out var __jsonUpgradeAvailability) ? (string)__jsonUpgradeAvailability : (string)_upgradeAvailability;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAppServiceEnvironment.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAppServiceEnvironment.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAppServiceEnvironment FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
