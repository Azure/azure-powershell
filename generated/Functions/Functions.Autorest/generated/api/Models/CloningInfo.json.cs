...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class CloningInfo
    {
        ...
        internal CloningInfo(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_cloneCustomHostName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("cloneCustomHostNames"), out var __jsonCloneCustomHostNames) ? (bool?)__jsonCloneCustomHostNames : _cloneCustomHostName;}
            {_cloneSourceControl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("cloneSourceControl"), out var __jsonCloneSourceControl) ? (bool?)__jsonCloneSourceControl : _cloneSourceControl;}
            {_sourceWebAppId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("sourceWebAppId"), out var __jsonSourceWebAppId) ? (string)__jsonSourceWebAppId : (string)_sourceWebAppId;}
            {_sourceWebAppLocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("sourceWebAppLocation"), out var __jsonSourceWebAppLocation) ? (string)__jsonSourceWebAppLocation : (string)_sourceWebAppLocation;}
            ...
            {_appSettingsOverride = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("appSettingsOverrides"), out var __jsonAppSettingsOverrides) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.CloningInfoAppSettingsOverrides.FromJson(__jsonAppSettingsOverrides) : _appSettingsOverride;}
            {_configureLoadBalancing = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("configureLoadBalancing"), out var __jsonConfigureLoadBalancing) ? (bool?)__jsonConfigureLoadBalancing : _configureLoadBalancing;}
            {_trafficManagerProfileId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("trafficManagerProfileId"), out var __jsonTrafficManagerProfileId) ? (string)__jsonTrafficManagerProfileId : (string)_trafficManagerProfileId;}
            {_trafficManagerProfileName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("trafficManagerProfileName"), out var __jsonTrafficManagerProfileName) ? (string)__jsonTrafficManagerProfileName : (string)_trafficManagerProfileName;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICloningInfo.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICloningInfo.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICloningInfo FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
