...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class LinuxJavaContainerSettings :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILinuxJavaContainerSettingsInternal
    {
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILinuxJavaContainerSettingsInternal.EndOfLifeDate { get => this._endOfLifeDate; set { {_endOfLifeDate = value;} } }

        /// <summary>Internal Acessors for IsAutoUpdate</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILinuxJavaContainerSettingsInternal.IsAutoUpdate { get => this._isAutoUpdate; set { {_isAutoUpdate = value;} } }

        /// <summary>Internal Acessors for IsDeprecated</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILinuxJavaContainerSettingsInternal.IsDeprecated { get => this._isDeprecated; set { {_isDeprecated = value;} } }

        /// <summary>Internal Acessors for IsEarlyAccess</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILinuxJavaContainerSettingsInternal.IsEarlyAccess { get => this._isEarlyAccess; set { {_isEarlyAccess = value;} } }

        /// <summary>Internal Acessors for IsHidden</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILinuxJavaContainerSettingsInternal.IsHidden { get => this._isHidden; set { {_isHidden = value;} } }

        /// <summary>Internal Acessors for IsPreview</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILinuxJavaContainerSettingsInternal.IsPreview { get => this._isPreview; set { {_isPreview = value;} } }

        /// <summary>Internal Acessors for Java11Runtime</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILinuxJavaContainerSettingsInternal.Java11Runtime { get => this._java11Runtime; set { {_java11Runtime = value;} } }

        /// <summary>Internal Acessors for Java8Runtime</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ILinuxJavaContainerSettingsInternal.Java8Runtime { get => this._java8Runtime; set { {_java8Runtime = value;} } }
