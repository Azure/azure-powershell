...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class AppServiceCertificateOrderProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject into a new instance of <see cref="AppServiceCertificateOrderProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal AppServiceCertificateOrderProperties(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_signedCertificate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("signedCertificate"), out var __jsonSignedCertificate) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.CertificateDetails.FromJson(__jsonSignedCertificate) : _signedCertificate;}
            {_intermediate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("intermediate"), out var __jsonIntermediate) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.CertificateDetails.FromJson(__jsonIntermediate) : _intermediate;}
            {_root = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("root"), out var __jsonRoot) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.CertificateDetails.FromJson(__jsonRoot) : _root;}
            {_contact = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("contact"), out var __jsonContact) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.CertificateOrderContact.FromJson(__jsonContact) : _contact;}
            {_certificate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("certificates"), out var __jsonCertificates) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.AppServiceCertificateOrderPropertiesCertificates.FromJson(__jsonCertificates) : _certificate;}
            {_distinguishedName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("distinguishedName"), out var __jsonDistinguishedName) ? (string)__jsonDistinguishedName : (string)_distinguishedName;}
            {_domainVerificationToken = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("domainVerificationToken"), out var __jsonDomainVerificationToken) ? (string)__jsonDomainVerificationToken : (string)_domainVerificationToken;}
            {_validityInYear = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("validityInYears"), out var __jsonValidityInYears) ? (int?)__jsonValidityInYears : _validityInYear;}
            ...
            {_productType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("productType"), out var __jsonProductType) ? (string)__jsonProductType : (string)_productType;}
            {_autoRenew = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("autoRenew"), out var __jsonAutoRenew) ? (bool?)__jsonAutoRenew : _autoRenew;}
            ...
            {_serialNumber = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("serialNumber"), out var __jsonSerialNumber) ? (string)__jsonSerialNumber : (string)_serialNumber;}
            {_lastCertificateIssuanceTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("lastCertificateIssuanceTime"), out var __jsonLastCertificateIssuanceTime) ? global::System.DateTime.TryParse((string)__jsonLastCertificateIssuanceTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonLastCertificateIssuanceTimeValue) ? __jsonLastCertificateIssuanceTimeValue : _lastCertificateIssuanceTime : _lastCertificateIssuanceTime;}
            ...
            {_appServiceCertificateNotRenewableReason = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("appServiceCertificateNotRenewableReasons"), out var __jsonAppServiceCertificateNotRenewableReasons) ? If( __jsonAppServiceCertificateNotRenewableReasons as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _appServiceCertificateNotRenewableReason;}
            {_nextAutoRenewalTimeStamp = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("nextAutoRenewalTimeStamp"), out var __jsonNextAutoRenewalTimeStamp) ? global::System.DateTime.TryParse((string)__jsonNextAutoRenewalTimeStamp, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonNextAutoRenewalTimeStampValue) ? __jsonNextAutoRenewalTimeStampValue : _nextAutoRenewalTimeStamp : _nextAutoRenewalTimeStamp;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAppServiceCertificateOrderProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAppServiceCertificateOrderProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IAppServiceCertificateOrderProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json ? new AppServiceCertificateOrderProperties(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AppServiceCertificateOrderProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AppServiceCertificateOrderProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.SerializationMode.IncludeRead))
            {
                AddIf( null != this._contact ? (Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode) this._contact.ToJson(null,serializationMode) : null, "contact" ,container.Add );
            }
