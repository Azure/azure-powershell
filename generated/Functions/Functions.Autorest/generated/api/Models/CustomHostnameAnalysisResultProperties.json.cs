...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class CustomHostnameAnalysisResultProperties
    {
        ...
        internal CustomHostnameAnalysisResultProperties(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_customDomainVerificationFailureInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("customDomainVerificationFailureInfo"), out var __jsonCustomDomainVerificationFailureInfo) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ErrorEntity.FromJson(__jsonCustomDomainVerificationFailureInfo) : _customDomainVerificationFailureInfo;}
            {_isHostnameAlreadyVerified = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("isHostnameAlreadyVerified"), out var __jsonIsHostnameAlreadyVerified) ? (bool?)__jsonIsHostnameAlreadyVerified : _isHostnameAlreadyVerified;}
            {_customDomainVerificationTest = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("customDomainVerificationTest"), out var __jsonCustomDomainVerificationTest) ? (string)__jsonCustomDomainVerificationTest : (string)_customDomainVerificationTest;}
            {_hasConflictOnScaleUnit = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("hasConflictOnScaleUnit"), out var __jsonHasConflictOnScaleUnit) ? (bool?)__jsonHasConflictOnScaleUnit : _hasConflictOnScaleUnit;}
            {_hasConflictAcrossSubscription = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("hasConflictAcrossSubscription"), out var __jsonHasConflictAcrossSubscription) ? (bool?)__jsonHasConflictAcrossSubscription : _hasConflictAcrossSubscription;}
            {_conflictingAppResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("conflictingAppResourceId"), out var __jsonConflictingAppResourceId) ? (string)__jsonConflictingAppResourceId : (string)_conflictingAppResourceId;}
            {_cNameRecord = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("cNameRecords"), out var __jsonCNameRecords) ? If( __jsonCNameRecords as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _cNameRecord;}
            {_txtRecord = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("txtRecords"), out var __jsonTxtRecords) ? If( __jsonTxtRecords as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : _txtRecord;}
            {_aRecord = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("aRecords"), out var __jsonARecords) ? If( __jsonARecords as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(string) (__k is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString __j ? (string)(__j.ToString()) : null)) ))() : null : _aRecord;}
            {_alternateCNameRecord = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("alternateCNameRecords"), out var __jsonAlternateCNameRecords) ? If( __jsonAlternateCNameRecords as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__g, (__f)=>(string) (__f is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString __e ? (string)(__e.ToString()) : null)) ))() : null : _alternateCNameRecord;}
            {_alternateTxtRecord = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray>("alternateTxtRecords"), out var __jsonAlternateTxtRecords) ? If( __jsonAlternateTxtRecords as Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonArray, out var __b) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__b, (__a)=>(string) (__a is Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString ___z ? (string)(___z.ToString()) : null)) ))() : null : _alternateTxtRecord;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICustomHostnameAnalysisResultProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICustomHostnameAnalysisResultProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.ICustomHostnameAnalysisResultProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
