...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class ServiceSasParameters
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IServiceSasParameters.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IServiceSasParameters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IServiceSasParameters FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal ServiceSasParameters(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_canonicalizedResource = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("canonicalizedResource"), out var __jsonCanonicalizedResource) ? (string)__jsonCanonicalizedResource : (string)_canonicalizedResource;}
            {_resource = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("signedResource"), out var __jsonSignedResource) ? (string)__jsonSignedResource : (string)_resource;}
            {_permission = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("signedPermission"), out var __jsonSignedPermission) ? (string)__jsonSignedPermission : (string)_permission;}
            {_iPAddressOrRange = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("signedIp"), out var __jsonSignedIP) ? (string)__jsonSignedIP : (string)_iPAddressOrRange;}
            {_protocol = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("signedProtocol"), out var __jsonSignedProtocol) ? (string)__jsonSignedProtocol : (string)_protocol;}
            ...
            {_identifier = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("signedIdentifier"), out var __jsonSignedIdentifier) ? (string)__jsonSignedIdentifier : (string)_identifier;}
            {_partitionKeyStart = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("startPk"), out var __jsonStartPk) ? (string)__jsonStartPk : (string)_partitionKeyStart;}
            {_partitionKeyEnd = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("endPk"), out var __jsonEndPk) ? (string)__jsonEndPk : (string)_partitionKeyEnd;}
            {_rowKeyStart = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("startRk"), out var __jsonStartRk) ? (string)__jsonStartRk : (string)_rowKeyStart;}
            {_rowKeyEnd = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("endRk"), out var __jsonEndRk) ? (string)__jsonEndRk : (string)_rowKeyEnd;}
            {_keyToSign = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("keyToSign"), out var __jsonKeyToSign) ? (string)__jsonKeyToSign : (string)_keyToSign;}
            {_cacheControl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("rscc"), out var __jsonRscc) ? (string)__jsonRscc : (string)_cacheControl;}
            {_contentDisposition = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("rscd"), out var __jsonRscd) ? (string)__jsonRscd : (string)_contentDisposition;}
            {_contentEncoding = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("rsce"), out var __jsonRsce) ? (string)__jsonRsce : (string)_contentEncoding;}
            {_contentLanguage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("rscl"), out var __jsonRscl) ? (string)__jsonRscl : (string)_contentLanguage;}
            {_contentType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("rsct"), out var __jsonRsct) ? (string)__jsonRsct : (string)_contentType;}
            AfterFromJson(json);
        }
