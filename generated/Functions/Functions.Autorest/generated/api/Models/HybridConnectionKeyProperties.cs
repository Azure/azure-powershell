...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class HybridConnectionKeyProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IHybridConnectionKeyProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IHybridConnectionKeyPropertiesInternal
    {

        /// <summary>Internal Acessors for SendKeyName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IHybridConnectionKeyPropertiesInternal.SendKeyName { get => this._sendKeyName; set { {_sendKeyName = value;} } }

        /// <summary>Internal Acessors for SendKeyValue</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IHybridConnectionKeyPropertiesInternal.SendKeyValue { get => this._sendKeyValue; set { {_sendKeyValue = value;} } }
