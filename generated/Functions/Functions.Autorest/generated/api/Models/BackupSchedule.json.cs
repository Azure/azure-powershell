...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class BackupSchedule
    {
        ...
        internal BackupSchedule(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_frequencyInterval = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("frequencyInterval"), out var __jsonFrequencyInterval) ? (int)__jsonFrequencyInterval : _frequencyInterval;}
            {_frequencyUnit = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("frequencyUnit"), out var __jsonFrequencyUnit) ? (string)__jsonFrequencyUnit : (string)_frequencyUnit;}
            {_keepAtLeastOneBackup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("keepAtLeastOneBackup"), out var __jsonKeepAtLeastOneBackup) ? (bool)__jsonKeepAtLeastOneBackup : _keepAtLeastOneBackup;}
            {_retentionPeriodInDay = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNumber>("retentionPeriodInDays"), out var __jsonRetentionPeriodInDays) ? (int)__jsonRetentionPeriodInDays : _retentionPeriodInDay;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IBackupSchedule.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IBackupSchedule.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IBackupSchedule FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
