...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class ResourceMetricAvailability :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IResourceMetricAvailability,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IResourceMetricAvailabilityInternal
    {

        /// <summary>Internal Acessors for Retention</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IResourceMetricAvailabilityInternal.Retention { get => this._retention; set { {_retention = value;} } }

        /// <summary>Internal Acessors for TimeGrain</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IResourceMetricAvailabilityInternal.TimeGrain { get => this._timeGrain; set { {_timeGrain = value;} } }
