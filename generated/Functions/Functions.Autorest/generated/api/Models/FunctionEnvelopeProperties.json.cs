...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class FunctionEnvelopeProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IFunctionEnvelopeProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IFunctionEnvelopeProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IFunctionEnvelopeProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal FunctionEnvelopeProperties(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_functionAppId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("function_app_id"), out var __jsonFunctionAppId) ? (string)__jsonFunctionAppId : (string)_functionAppId;}
            {_scriptRootPathHref = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("script_root_path_href"), out var __jsonScriptRootPathHref) ? (string)__jsonScriptRootPathHref : (string)_scriptRootPathHref;}
            {_scriptHref = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("script_href"), out var __jsonScriptHref) ? (string)__jsonScriptHref : (string)_scriptHref;}
            {_configHref = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("config_href"), out var __jsonConfigHref) ? (string)__jsonConfigHref : (string)_configHref;}
            {_testDataHref = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("test_data_href"), out var __jsonTestDataHref) ? (string)__jsonTestDataHref : (string)_testDataHref;}
            {_secretsFileHref = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("secrets_file_href"), out var __jsonSecretsFileHref) ? (string)__jsonSecretsFileHref : (string)_secretsFileHref;}
            ...
            {_config = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("config"), out var __jsonConfig) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Any.FromJson(__jsonConfig) : _config;}
            {_file = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("files"), out var __jsonFiles) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.FunctionEnvelopePropertiesFiles.FromJson(__jsonFiles) : _file;}
            {_testData = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("test_data"), out var __jsonTestData) ? (string)__jsonTestData : (string)_testData;}
            {_invokeUrlTemplate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("invoke_url_template"), out var __jsonInvokeUrlTemplate) ? (string)__jsonInvokeUrlTemplate : (string)_invokeUrlTemplate;}
            ...
            {_isDisabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("isDisabled"), out var __jsonIsDisabled) ? (bool?)__jsonIsDisabled : _isDisabled;}
            AfterFromJson(json);
        }
