...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models
{
    ...
    public partial class MigrateMySqlStatusProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IMigrateMySqlStatusProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IMigrateMySqlStatusPropertiesInternal
    {
        ...
        bool? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IMigrateMySqlStatusPropertiesInternal.LocalMySqlEnabled { get => this._localMySqlEnabled; set { {_localMySqlEnabled = value;} } }

        /// <summary>Internal Acessors for MigrationOperationStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IMigrateMySqlStatusPropertiesInternal.MigrationOperationStatus { get => this._migrationOperationStatus; set { {_migrationOperationStatus = value;} } }

        /// <summary>Internal Acessors for OperationId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.IMigrateMySqlStatusPropertiesInternal.OperationId { get => this._operationId; set { {_operationId = value;} } }

        /// <summary>Backing field for <see cref="MigrationOperationStatus" /> property.</summary>
        private string _migrationOperationStatus;

        /// <summary>Status of the migration task.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Functions.Origin(Microsoft.Azure.PowerShell.Cmdlets.Functions.PropertyOrigin.Owned)]
        public string MigrationOperationStatus { get => this._migrationOperationStatus; }
