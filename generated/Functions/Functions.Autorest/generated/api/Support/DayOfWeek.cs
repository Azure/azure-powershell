...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.DayOfWeek Friday = @"Friday";

        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.DayOfWeek Monday = @"Monday";

        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.DayOfWeek Saturday = @"Saturday";

        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.DayOfWeek Sunday = @"Sunday";

        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.DayOfWeek Thursday = @"Thursday";

        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.DayOfWeek Tuesday = @"Tuesday";

        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.DayOfWeek Wednesday = @"Wednesday";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.DayOfWeek e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Functions.Support.DayOfWeek e)
        {
            return e._value;
        }
