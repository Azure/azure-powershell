...
namespace Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models
{
    ...
    public partial class FileShareLimitsOutput
    {
        ...
        internal FileShareLimitsOutput(global::System.Collections.IDictionary content)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.IFileShareLimitsOutputInternal)this).ProvisioningConstantGuardrailIoPerSecScalar = (double) content.GetValueForProperty("ProvisioningConstantGuardrailIoPerSecScalar",((Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.IFileShareLimitsOutputInternal)this).ProvisioningConstantGuardrailIoPerSecScalar, (__y)=> (double) global::System.Convert.ChangeType(__y, typeof(double)));
            }
            if (content.Contains("ProvisioningConstantGuardrailThroughputScalar"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.IFileShareLimitsOutputInternal)this).ProvisioningConstantGuardrailThroughputScalar = (double) content.GetValueForProperty("ProvisioningConstantGuardrailThroughputScalar",((Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.IFileShareLimitsOutputInternal)this).ProvisioningConstantGuardrailThroughputScalar, (__y)=> (double) global::System.Convert.ChangeType(__y, typeof(double)));
            }
