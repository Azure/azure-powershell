...
namespace Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.IFileShareLimitsResponseInternal
    {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.FileShare.Origin(Microsoft.Azure.PowerShell.Cmdlets.FileShare.PropertyOrigin.Inlined)]
        public double ProvisioningConstantGuardrailIoPerSecScalar { get => ((Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.IFileShareLimitsOutputInternal)Property).ProvisioningConstantGuardrailIoPerSecScalar; set => ((Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.IFileShareLimitsOutputInternal)Property).ProvisioningConstantGuardrailIoPerSecScalar = value ; }

        /// <summary>Guardrail scalar throughput in MiB per second.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FileShare.Origin(Microsoft.Azure.PowerShell.Cmdlets.FileShare.PropertyOrigin.Inlined)]
        public double ProvisioningConstantGuardrailThroughputScalar { get => ((Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.IFileShareLimitsOutputInternal)Property).ProvisioningConstantGuardrailThroughputScalar; set => ((Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.IFileShareLimitsOutputInternal)Property).ProvisioningConstantGuardrailThroughputScalar = value ; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.IJsonSerializable
    {
        ...
        Create = true,
        Update = true,
        Description = @"Guardrail scalar IO per second.",
        SerializedName = @"guardrailIOPerSecScalar",
        PossibleTypes = new [] { typeof(double) })]
        double ProvisioningConstantGuardrailIoPerSecScalar { get; set; }
        /// <summary>Guardrail scalar throughput in MiB per second.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        Create = true,
        Update = true,
        Description = @"Guardrail scalar throughput in MiB per second.",
        SerializedName = @"guardrailThroughputScalar",
        PossibleTypes = new [] { typeof(double) })]
        double ProvisioningConstantGuardrailThroughputScalar { get; set; }
        /// <summary>Scalar IO per second.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Info(
        Required = true,
        ReadOnly = false,
