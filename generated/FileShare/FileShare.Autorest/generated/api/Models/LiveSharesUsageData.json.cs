...
namespace Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models
{
    ...
    public partial class LiveSharesUsageData
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.ILiveSharesUsageData.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.ILiveSharesUsageData.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.ILiveSharesUsageData FromJson(Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Json.JsonObject json ? new LiveSharesUsageData(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Json.JsonObject into a new instance of <see cref="LiveSharesUsageData" />.
        /// </summary>
        ...
        internal LiveSharesUsageData(Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Json.JsonObject json)
        {
            ...
            {_fileShareCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Json.JsonNumber>("fileShareCount"), out var __jsonFileShareCount) ? (int)__jsonFileShareCount : _fileShareCount;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="LiveSharesUsageData" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="LiveSharesUsageData" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( (Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Json.JsonNumber(this._fileShareCount), "fileShareCount" ,container.Add );
