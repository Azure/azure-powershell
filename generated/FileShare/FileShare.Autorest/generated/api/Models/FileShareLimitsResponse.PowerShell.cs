...
namespace Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models
{
    ...
    public partial class FileShareLimitsResponse
    {
        ...
        internal FileShareLimitsResponse(global::System.Collections.IDictionary content)
        {
            ...
            if (content.Contains("ProvisioningConstantGuardrailIoPerSecScalar"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.IFileShareLimitsResponseInternal)this).ProvisioningConstantGuardrailIoPerSecScalar = (double) content.GetValueForProperty("ProvisioningConstantGuardrailIoPerSecScalar",((Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.IFileShareLimitsResponseInternal)this).ProvisioningConstantGuardrailIoPerSecScalar, (__y)=> (double) global::System.Convert.ChangeType(__y, typeof(double)));
            }
            if (content.Contains("ProvisioningConstantGuardrailThroughputScalar"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.IFileShareLimitsResponseInternal)this).ProvisioningConstantGuardrailThroughputScalar = (double) content.GetValueForProperty("ProvisioningConstantGuardrailThroughputScalar",((Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.IFileShareLimitsResponseInternal)this).ProvisioningConstantGuardrailThroughputScalar, (__y)=> (double) global::System.Convert.ChangeType(__y, typeof(double)));
            }
