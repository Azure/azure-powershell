...
namespace Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FileShare.Models.IFileShareProvisioningConstantsInternal
    {
        ...
        /// <summary>Backing field for <see cref="GuardrailIoPerSecScalar" /> property.</summary>
        private double _guardrailIoPerSecScalar;

        /// <summary>Guardrail scalar IO per second.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FileShare.Origin(Microsoft.Azure.PowerShell.Cmdlets.FileShare.PropertyOrigin.Owned)]
        public double GuardrailIoPerSecScalar { get => this._guardrailIoPerSecScalar; set => this._guardrailIoPerSecScalar = value; }

        /// <summary>Backing field for <see cref="GuardrailThroughputScalar" /> property.</summary>
        private double _guardrailThroughputScalar;

        /// <summary>Guardrail scalar throughput in MiB per second.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FileShare.Origin(Microsoft.Azure.PowerShell.Cmdlets.FileShare.PropertyOrigin.Owned)]
        public double GuardrailThroughputScalar { get => this._guardrailThroughputScalar; set => this._guardrailThroughputScalar = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.IJsonSerializable
    {
        ...
        double GuardrailIoPerSecScalar { get; set; }
        /// <summary>Guardrail scalar throughput in MiB per second.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(double) })]
        double GuardrailThroughputScalar { get; set; }
        /// <summary>Scalar IO per second.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FileShare.Runtime.Info(
        Required = true,
        ReadOnly = false,
