...
namespace Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models
{
    ...
    public partial class AutomanageIdentity
    {
        ...
        internal AutomanageIdentity(Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonObject json)
        {
            ...
            {_bestPracticeName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonString>("bestPracticeName"), out var __jsonBestPracticeName) ? (string)__jsonBestPracticeName : (string)_bestPracticeName;}
            {_versionName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonString>("versionName"), out var __jsonVersionName) ? (string)__jsonVersionName : (string)_versionName;}
            {_subscriptionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonString>("subscriptionId"), out var __jsonSubscriptionId) ? (string)__jsonSubscriptionId : (string)_subscriptionId;}
            {_resourceGroupName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonString>("resourceGroupName"), out var __jsonResourceGroupName) ? (string)__jsonResourceGroupName : (string)_resourceGroupName;}
            {_configurationProfileName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonString>("configurationProfileName"), out var __jsonConfigurationProfileName) ? (string)__jsonConfigurationProfileName : (string)_configurationProfileName;}
            {_configurationProfileAssignmentName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonString>("configurationProfileAssignmentName"), out var __jsonConfigurationProfileAssignmentName) ? (string)__jsonConfigurationProfileAssignmentName : (string)_configurationProfileAssignmentName;}
            {_vMName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonString>("vmName"), out var __jsonVMName) ? (string)__jsonVMName : (string)_vMName;}
            {_machineName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonString>("machineName"), out var __jsonMachineName) ? (string)__jsonMachineName : (string)_machineName;}
            {_clusterName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonString>("clusterName"), out var __jsonClusterName) ? (string)__jsonClusterName : (string)_clusterName;}
            {_reportName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonString>("reportName"), out var __jsonReportName) ? (string)__jsonReportName : (string)_reportName;}
            {_id = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonString>("id"), out var __jsonId) ? (string)__jsonId : (string)_id;}
            AfterFromJson(json);
        }
