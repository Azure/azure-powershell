            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ReportsListByConfigurationProfileAssignments(SubscriptionId, ResourceGroupName, ConfigProfileAssignmentName, VMName, onOk, onDefault, this, Pipeline);
