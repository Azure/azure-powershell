...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models
{
    ...
    public partial class ConfidentialLedger
    {
        ...
        internal ConfidentialLedger(Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Runtime.Json.JsonObject json)
        {
            ...
            __resource = new Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Resource(json);
            __resourceLocation = new Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.ResourceLocation(json);
            __tags1 = new Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Tags1(json);
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.LedgerProperties.FromJson(__jsonProperties) : _property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.IConfidentialLedger.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.IConfidentialLedger.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.IConfidentialLedger FromJson(Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Runtime.Json.JsonNode node)
        {
