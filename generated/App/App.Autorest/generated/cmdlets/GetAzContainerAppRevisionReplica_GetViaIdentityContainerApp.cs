...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetReplica=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/containerApps/{containerAppName}/revisions/{revisionName}/replicas/{replicaName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzContainerAppRevisionReplica_GetViaIdentityContainerApp")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.App.Models.IReplica))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.App.Description(@"Get a replica for a Container App Revision.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.App.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.App.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/containerApps/{containerAppName}/revisions/{revisionName}/replicas/{replicaName}", ApiVersion = "2023-05-01")]
    public partial class GetAzContainerAppRevisionReplica_GetViaIdentityContainerApp : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="ContainerAppInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppIdentity _containerAppInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppIdentity ContainerAppInputObject { get => this._containerAppInputObject; set => this._containerAppInputObject = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of the Container App Revision Replica.")]
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Models.IReplica">Microsoft.Azure.PowerShell.Cmdlets.App.Models.IReplica</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.App.Models.IReplica> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzContainerAppRevisionReplica_GetViaIdentityContainerApp" /> cmdlet class.
        /// </summary>
        public GetAzContainerAppRevisionReplica_GetViaIdentityContainerApp()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ContainerAppInputObject?.Id != null)
                    {
                        this.ContainerAppInputObject.Id += $"/revisions/{(global::System.Uri.EscapeDataString(this.RevisionName.ToString()))}/replicas/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.ContainerAppsRevisionReplicasGetReplicaViaIdentity(ContainerAppInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == ContainerAppInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ContainerAppInputObject has null value for ContainerAppInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ContainerAppInputObject) );
                        }
                        if (null == ContainerAppInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ContainerAppInputObject has null value for ContainerAppInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ContainerAppInputObject) );
                        }
                        if (null == ContainerAppInputObject.ContainerAppName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ContainerAppInputObject has null value for ContainerAppInputObject.ContainerAppName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ContainerAppInputObject) );
                        }
                        await this.Client.ContainerAppsRevisionReplicasGetReplica(ContainerAppInputObject.SubscriptionId ?? null, ContainerAppInputObject.ResourceGroupName ?? null, ContainerAppInputObject.ContainerAppName ?? null, RevisionName, Name, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { RevisionName=RevisionName,Name=Name})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.App.Models.IReplica> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.App.Models.IReplica
