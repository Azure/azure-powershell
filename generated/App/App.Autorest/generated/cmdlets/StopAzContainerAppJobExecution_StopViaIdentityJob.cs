...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] StopExecution=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/jobs/{jobName}/executions/{jobExecutionName}/stop"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Stop, @"AzContainerAppJobExecution_StopViaIdentityJob", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.App.Description(@"Terminates execution of a running container apps job")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.App.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.App.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/jobs/{jobName}/executions/{jobExecutionName}/stop", ApiVersion = "2023-05-01")]
    public partial class StopAzContainerAppJobExecution_StopViaIdentityJob : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="JobInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppIdentity _jobInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppIdentity JobInputObject { get => this._jobInputObject; set => this._jobInputObject = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Job execution name.")]
        ...
        [global::System.Management.Automation.Alias("JobExecutionName")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.App.Category(global::Microsoft.Azure.PowerShell.Cmdlets.App.ParameterCategory.Path)]
        ...
        /// <returns>a duplicate instance of StopAzContainerAppJobExecution_StopViaIdentityJob</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.App.Cmdlets.StopAzContainerAppJobExecution_StopViaIdentityJob Clone()
        {
            var clone = new StopAzContainerAppJobExecution_StopViaIdentityJob();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'JobsStopExecution' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (JobInputObject?.Id != null)
                    {
                        this.JobInputObject.Id += $"/executions/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.JobsStopExecutionViaIdentity(JobInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == JobInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("JobInputObject has null value for JobInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, JobInputObject) );
                        }
                        if (null == JobInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("JobInputObject has null value for JobInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, JobInputObject) );
                        }
                        if (null == JobInputObject.JobName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("JobInputObject has null value for JobInputObject.JobName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, JobInputObject) );
                        }
                        await this.Client.JobsStopExecution(JobInputObject.SubscriptionId ?? null, JobInputObject.ResourceGroupName ?? null, JobInputObject.JobName ?? null, Name, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StopAzContainerAppJobExecution_StopViaIdentityJob" /> cmdlet class.
        /// </summary>
        public StopAzContainerAppJobExecution_StopViaIdentityJob()
        {
