...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{environmentName}/certificates/{certificateName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzContainerAppManagedEnvCert_CreateViaIdentityManagedEnvironmentExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.App.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{environmentName}/certificates/{certificateName}", ApiVersion = "2023-05-01")]
    public partial class NewAzContainerAppManagedEnvCert_CreateViaIdentityManagedEnvironmentExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.IContext
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.App.Models.ICertificate _certificateEnvelopeBody = new Microsoft.Azure.PowerShell.Cmdlets.App.Models.Certificate();
        ...
        /// <summary>Backing field for <see cref="ManagedEnvironmentInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppIdentity _managedEnvironmentInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppIdentity ManagedEnvironmentInputObject { get => this._managedEnvironmentInputObject; set => this._managedEnvironmentInputObject = value; }
        ...
        public System.Security.SecureString Password { get => _certificateEnvelopeBody.Password ?? null; set => _certificateEnvelopeBody.Password = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.App.Models.ITrackedResourceTags Tag { get => _certificateEnvelopeBody.Tag ?? null /* object */; set => _certificateEnvelopeBody.Tag = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Models.ICertificate">Microsoft.Azure.PowerShell.Cmdlets.App.Models.ICertificate</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.App.Models.ICertificate> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzContainerAppManagedEnvCert_CreateViaIdentityManagedEnvironmentExpanded"
        /// /> cmdlet class.
        /// </summary>
        public NewAzContainerAppManagedEnvCert_CreateViaIdentityManagedEnvironmentExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ManagedEnvironmentInputObject?.Id != null)
                    {
                        this.ManagedEnvironmentInputObject.Id += $"/certificates/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.CertificatesCreateOrUpdateViaIdentity(ManagedEnvironmentInputObject.Id, _certificateEnvelopeBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == ManagedEnvironmentInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ManagedEnvironmentInputObject has null value for ManagedEnvironmentInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ManagedEnvironmentInputObject) );
                        }
                        if (null == ManagedEnvironmentInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ManagedEnvironmentInputObject has null value for ManagedEnvironmentInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ManagedEnvironmentInputObject) );
                        }
                        if (null == ManagedEnvironmentInputObject.EnvironmentName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ManagedEnvironmentInputObject has null value for ManagedEnvironmentInputObject.EnvironmentName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ManagedEnvironmentInputObject) );
                        }
                        await this.Client.CertificatesCreateOrUpdate(ManagedEnvironmentInputObject.SubscriptionId ?? null, ManagedEnvironmentInputObject.ResourceGroupName ?? null, ManagedEnvironmentInputObject.EnvironmentName ?? null, Name, _certificateEnvelopeBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeCreate);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.App.Models.ICertificate> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.App.Models.ICertificate
