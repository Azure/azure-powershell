...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models
{
    ...
    public partial class CustomOpenIdConnectProvider :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.ICustomOpenIdConnectProviderInternal
    {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Inlined)]
        public string ClientCredentialMethod { get => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectRegistrationInternal)Registration).ClientCredentialMethod; set => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectRegistrationInternal)Registration).ClientCredentialMethod = value ?? null; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectLogin _login;

        /// <summary>
        /// The configuration settings of the login flow of the custom Open ID Connect provider.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectLogin Login { get => (this._login = this._login ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.OpenIdConnectLogin()); set => this._login = value; }

        /// <summary>The name of the claim that contains the users name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Inlined)]
        public string LoginNameClaimType { get => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectLoginInternal)Login).NameClaimType; set => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectLoginInternal)Login).NameClaimType = value ?? null; }

        /// <summary>A list of the scopes that should be requested while authenticating.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> LoginScope { get => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectLoginInternal)Login).Scope; set => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectLoginInternal)Login).Scope = value ?? null /* arrayOf */; }

        /// <summary>Internal Acessors for Login</summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectLogin Microsoft.Azure.PowerShell.Cmdlets.App.Models.ICustomOpenIdConnectProviderInternal.Login { get => (this._login = this._login ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.OpenIdConnectLogin()); set { {_login = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectRegistration _registration;

        /// <summary>
        /// The configuration settings of the app registration for the custom Open ID Connect provider.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectRegistration Registration { get => (this._registration = this._registration ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.OpenIdConnectRegistration()); set => this._registration = value; }

        /// <summary>The client id of the custom Open ID Connect provider.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Inlined)]
        public string RegistrationClientId { get => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectRegistrationInternal)Registration).ClientId; set => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectRegistrationInternal)Registration).ClientId = value ?? null; }
...

    {
        ...
        /// The configuration settings of the login flow of the custom Open ID Connect provider.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectLogin Login { get; set; }
        /// <summary>The name of the claim that contains the users name.</summary>
        string LoginNameClaimType { get; set; }
        /// <summary>A list of the scopes that should be requested while authenticating.</summary>
        System.Collections.Generic.List<string> LoginScope { get; set; }
        ...
        /// The configuration settings of the app registration for the custom Open ID Connect provider.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectRegistration Registration { get; set; }
        /// <summary>The authentication credentials of the custom Open ID Connect provider.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectClientCredential RegistrationClientCredential { get; set; }
        /// <summary>The client id of the custom Open ID Connect provider.</summary>
        string RegistrationClientId { get; set; }
        /// <summary>
        /// The configuration settings of the endpoints used for the custom Open ID Connect provider.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.IOpenIdConnectConfig RegistrationOpenIdConnectConfiguration { get; set; }
