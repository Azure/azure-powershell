...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models
{
    ...
    public partial class CustomHostnameAnalysisResult
    {
        ...
        internal CustomHostnameAnalysisResult(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject json)
        {
            ...
            {_customDomainVerificationFailureInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("customDomainVerificationFailureInfo"), out var __jsonCustomDomainVerificationFailureInfo) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.CustomHostnameAnalysisResultCustomDomainVerificationFailureInfo.FromJson(__jsonCustomDomainVerificationFailureInfo) : _customDomainVerificationFailureInfo;}
            {_hostName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("hostName"), out var __jsonHostName) ? (string)__jsonHostName : (string)_hostName;}
            {_isHostnameAlreadyVerified = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonBoolean>("isHostnameAlreadyVerified"), out var __jsonIsHostnameAlreadyVerified) ? (bool?)__jsonIsHostnameAlreadyVerified : _isHostnameAlreadyVerified;}
            {_customDomainVerificationTest = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("customDomainVerificationTest"), out var __jsonCustomDomainVerificationTest) ? (string)__jsonCustomDomainVerificationTest : (string)_customDomainVerificationTest;}
            {_hasConflictOnManagedEnvironment = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonBoolean>("hasConflictOnManagedEnvironment"), out var __jsonHasConflictOnManagedEnvironment) ? (bool?)__jsonHasConflictOnManagedEnvironment : _hasConflictOnManagedEnvironment;}
            {_conflictWithEnvironmentCustomDomain = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonBoolean>("conflictWithEnvironmentCustomDomain"), out var __jsonConflictWithEnvironmentCustomDomain) ? (bool?)__jsonConflictWithEnvironmentCustomDomain : _conflictWithEnvironmentCustomDomain;}
            {_conflictingContainerAppResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("conflictingContainerAppResourceId"), out var __jsonConflictingContainerAppResourceId) ? (string)__jsonConflictingContainerAppResourceId : (string)_conflictingContainerAppResourceId;}
            {_cNameRecord = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray>("cNameRecords"), out var __jsonCNameRecords) ? If( __jsonCNameRecords as Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _cNameRecord;}
            {_txtRecord = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray>("txtRecords"), out var __jsonTxtRecords) ? If( __jsonTxtRecords as Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : _txtRecord;}
            {_aRecord = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray>("aRecords"), out var __jsonARecords) ? If( __jsonARecords as Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(string) (__k is Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString __j ? (string)(__j.ToString()) : null)) ))() : null : _aRecord;}
            {_alternateCNameRecord = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray>("alternateCNameRecords"), out var __jsonAlternateCNameRecords) ? If( __jsonAlternateCNameRecords as Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__g, (__f)=>(string) (__f is Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString __e ? (string)(__e.ToString()) : null)) ))() : null : _alternateCNameRecord;}
            {_alternateTxtRecord = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray>("alternateTxtRecords"), out var __jsonAlternateTxtRecords) ? If( __jsonAlternateTxtRecords as Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray, out var __b) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__b, (__a)=>(string) (__a is Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString ___z ? (string)(___z.ToString()) : null)) ))() : null : _alternateTxtRecord;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.ICustomHostnameAnalysisResult.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.ICustomHostnameAnalysisResult.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.App.Models.ICustomHostnameAnalysisResult FromJson(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeRead))
            {
                AddIf( null != this._conflictWithEnvironmentCustomDomain ? (Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonBoolean((bool)this._conflictWithEnvironmentCustomDomain) : null, "conflictWithEnvironmentCustomDomain" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode.IncludeRead))
            {
