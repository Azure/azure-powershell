...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.App.custom\Update-AzContainerAppJob';
            UpdateViaJsonString = 'Az.App.custom\Update-AzContainerAppJob';
            UpdateViaJsonFilePath = 'Az.App.custom\Update-AzContainerAppJob';
