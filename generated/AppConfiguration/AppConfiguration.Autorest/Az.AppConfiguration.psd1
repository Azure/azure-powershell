@{
  ...
  FunctionsToExport = 'Clear-AzAppConfigurationDeletedStore', 'Get-AzAppConfigurationDeletedStore', 'Get-AzAppConfigurationReplica', 'Get-AzAppConfigurationStore', 'Get-AzAppConfigurationStoreKey', 'New-AzAppConfigurationReplica', 'New-AzAppConfigurationStore', 'New-AzAppConfigurationStoreKey', 'Remove-AzAppConfigurationReplica', 'Remove-AzAppConfigurationStore', 'Test-AzAppConfigurationStoreNameAvailability', 'Update-AzAppConfigurationStore'
  PrivateData = @{
    PSData = @{
