...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    using Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Cmdlets;
    using System;
    ...
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IConfigurationStore))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Description(@"update a configuration store with the specified parameters.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IContext
    {
        ...
        public global::System.Management.Automation.SwitchParameter DisableLocalAuth { get => _configStoreCreationParametersBody.DisableLocalAuth ?? default(global::System.Management.Automation.SwitchParameter); set => _configStoreCreationParametersBody.DisableLocalAuth = value; }
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter EnablePurgeProtection { get => _configStoreCreationParametersBody.EnablePurgeProtection ?? default(global::System.Management.Automation.SwitchParameter); set => _configStoreCreationParametersBody.EnablePurgeProtection = value; }
        ...
        public string EncryptionKeyIdentifier { get => _configStoreCreationParametersBody.KeyVaultPropertyKeyIdentifier ?? null; set => _configStoreCreationParametersBody.KeyVaultPropertyKeyIdentifier = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string KeyVaultIdentityClientId { get => _configStoreCreationParametersBody.KeyVaultPropertyIdentityClientId ?? null; set => _configStoreCreationParametersBody.KeyVaultPropertyIdentityClientId = value; }
        ...
        /// </summary>
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.HttpPipeline Pipeline { get; set; }
        ...
        public string PublicNetworkAccess { get => _configStoreCreationParametersBody.PublicNetworkAccess ?? null; set => _configStoreCreationParametersBody.PublicNetworkAccess = value; }
        ...
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(string) })]
        public string Sku { get => _configStoreCreationParametersBody.SkuName ?? null; set => _configStoreCreationParametersBody.SkuName = value; }

        /// <summary>
        /// The amount of time in days that the configuration store will be retained when it is soft deleted.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The amount of time in days that the configuration store will be retained when it is soft deleted.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public int SoftDeleteRetentionInDay { get => _configStoreCreationParametersBody.SoftDeleteRetentionInDay ?? default(int); set => _configStoreCreationParametersBody.SoftDeleteRetentionInDay = value; }
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.ITrackedResourceTags) })]
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.ITrackedResourceTags Tag { get => _configStoreCreationParametersBody.Tag ?? null /* object */; set => _configStoreCreationParametersBody.Tag = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IErrorResponse">Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IErrorResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IErrorResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IConfigurationStore">Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IConfigurationStore</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IConfigurationStore> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.UpdateAzAppConfigurationStore_UpdateViaIdentityExpanded Clone()
        {
            ...
            clone._configStoreCreationParametersBody = this._configStoreCreationParametersBody;
            return clone;
        }
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Events.Progress:
                    {
        ...
        {
            bool supportsSystemAssignedIdentity = (true == this.EnableSystemAssignedIdentity || null == this.EnableSystemAssignedIdentity && true == _configStoreCreationParametersBody?.IdentityType?.Contains("SystemAssigned"));
            bool supportsUserAssignedIdentity = false;
            if (this.UserAssignedIdentity?.Length > 0)
            {
                // calculate UserAssignedIdentity
                _configStoreCreationParametersBody.IdentityUserAssignedIdentity.Clear();
                foreach( var id in this.UserAssignedIdentity )
                {
                    _configStoreCreationParametersBody.IdentityUserAssignedIdentity.Add(id, new Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.UserIdentity());
                }
            }
            supportsUserAssignedIdentity = true == this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && this.UserAssignedIdentity?.Length > 0 ||
                    true != this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && true == _configStoreCreationParametersBody.IdentityType?.Contains("UserAssigned");
            if (!supportsUserAssignedIdentity)
            {
                _configStoreCreationParametersBody.IdentityUserAssignedIdentity = null;
            }
            // calculate IdentityType
            if ((supportsUserAssignedIdentity && supportsSystemAssignedIdentity))
            {
                _configStoreCreationParametersBody.IdentityType = "SystemAssigned,UserAssigned";
            }
            else if ((supportsUserAssignedIdentity && !supportsSystemAssignedIdentity))
            {
                _configStoreCreationParametersBody.IdentityType = "UserAssigned";
            }
            else if ((!supportsUserAssignedIdentity && supportsSystemAssignedIdentity))
            {
                _configStoreCreationParametersBody.IdentityType = "SystemAssigned";
            }
            else
            {
                _configStoreCreationParametersBody.IdentityType = "None";
            }
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                Pipeline = Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Module.Instance.CreatePipeline(InvocationInformation, __correlationId, __processRecordId, this.ParameterSetName, this.ExtensibleParameters);
                ...
                try
                {
                    ...
                    {
                        _configStoreCreationParametersBody = await this.Client.ConfigurationStoresGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_configStoreCreationParametersBody();
                        await this.Client.ConfigurationStoresCreateViaIdentity(InputObject.Id, _configStoreCreationParametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _configStoreCreationParametersBody = await this.Client.ConfigurationStoresGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ConfigStoreName ?? null, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_configStoreCreationParametersBody();
                        await this.Client.ConfigurationStoresCreate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ConfigStoreName ?? null, _configStoreCreationParametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzAppConfigurationStore_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        ...
        private void Update_configStoreCreationParametersBody()
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Tag")))
            {
                this.Tag = (Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.ITrackedResourceTags)(this.MyInvocation?.BoundParameters["Tag"]);
            }
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SoftDeleteRetentionInDay")))
            {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IErrorResponse>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IConfigurationStore> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
