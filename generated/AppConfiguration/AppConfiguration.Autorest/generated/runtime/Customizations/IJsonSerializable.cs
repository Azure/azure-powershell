...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.JsonSerializable.ToJson(dict, null);
            }
