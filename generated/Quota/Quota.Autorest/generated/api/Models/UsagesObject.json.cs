...
namespace Microsoft.Azure.PowerShell.Cmdlets.Quota.Models
{
    ...
    public partial class UsagesObject
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.IUsagesObject.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.IUsagesObject.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.IUsagesObject FromJson(Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonObject json ? new UsagesObject(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UsagesObject" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UsagesObject" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._usagesType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonString(this._usagesType.ToString()) : null, "usagesType" ,container.Add );
        ...
        internal UsagesObject(Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonObject json)
        {
            ...
            {_value = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNumber>("value"), out var __jsonValue) ? (int)__jsonValue : _value;}
            {_usagesType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonString>("usagesType"), out var __jsonUsagesType) ? (string)__jsonUsagesType : (string)_usagesType;}
            AfterFromJson(json);
        }
    }
}