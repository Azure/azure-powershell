...
namespace Microsoft.Azure.PowerShell.Cmdlets.Quota.Models
{
    ...
    public partial class QuotaAllocationRequestStatusProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.IQuotaAllocationRequestStatusProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.IQuotaAllocationRequestStatusProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.IQuotaAllocationRequestStatusProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonObject json ? new QuotaAllocationRequestStatusProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonObject into a new instance of <see cref="QuotaAllocationRequestStatusProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal QuotaAllocationRequestStatusProperties(Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonObject json)
        {
            ...
            {_requestedResource = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonObject>("requestedResource"), out var __jsonRequestedResource) ? Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.QuotaAllocationRequestBase.FromJson(__jsonRequestedResource) : _requestedResource;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="QuotaAllocationRequestStatusProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="QuotaAllocationRequestStatusProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._requestedResource ? (Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode) this._requestedResource.ToJson(null,serializationMode) : null, "requestedResource" ,container.Add );
