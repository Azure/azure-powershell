...
namespace Microsoft.Azure.PowerShell.Cmdlets.Quota.Models
{
    ...
    public partial class GroupQuotaRequestBasePropertiesName :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.IGroupQuotaRequestBasePropertiesNameInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.IGroupQuotaRequestBasePropertiesNameInternal.LocalizedValue { get => this._localizedValue; set { {_localizedValue = value;} } }

        /// <summary>Internal Acessors for Value</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.IGroupQuotaRequestBasePropertiesNameInternal.Value { get => this._value; set { {_value = value;} } }
        ...
        /// <summary>Creates an new <see cref="GroupQuotaRequestBasePropertiesName" /> instance.</summary>
        public GroupQuotaRequestBasePropertiesName()
        {
    ...
    /// Name of the resource provided by the resource provider. This property is already included in the request URI, so it is
    /// a readonly property returned in the response.
    internal partial interface IGroupQuotaRequestBasePropertiesNameInternal
