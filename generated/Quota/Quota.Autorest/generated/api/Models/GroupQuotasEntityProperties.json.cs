...
namespace Microsoft.Azure.PowerShell.Cmdlets.Quota.Models
{
    ...
    public partial class GroupQuotasEntityProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.IGroupQuotasEntityProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.IGroupQuotasEntityProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.IGroupQuotasEntityProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonObject json ? new GroupQuotasEntityProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonObject into a new instance of <see cref="GroupQuotasEntityProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal GroupQuotasEntityProperties(Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonObject json)
        {
            ...
            __groupQuotasEntityBase = new Microsoft.Azure.PowerShell.Cmdlets.Quota.Models.GroupQuotasEntityBase(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="GroupQuotasEntityProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="GroupQuotasEntityProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Quota.Runtime.SerializationMode serializationMode)
        {
            ...
            __groupQuotasEntityBase?.ToJson(container, serializationMode);
