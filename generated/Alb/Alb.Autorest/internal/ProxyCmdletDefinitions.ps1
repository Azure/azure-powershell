...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.Alb.private\Get-AzAlbOperation_List';
        }
...
#>
function New-AzAlbSecurityPolicy {
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.Alb.private\New-AzAlbSecurityPolicy_CreateExpanded';
        }
...
#>
function Update-AzAlbSecurityPolicy {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Alb.Models.ISecurityPolicy])]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.Alb.private\Update-AzAlbSecurityPolicy_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.Alb.private\Update-AzAlbSecurityPolicy_UpdateViaIdentityExpanded';
            UpdateViaIdentityTrafficControllerExpanded = 'Az.Alb.private\Update-AzAlbSecurityPolicy_UpdateViaIdentityTrafficControllerExpanded';
        }
