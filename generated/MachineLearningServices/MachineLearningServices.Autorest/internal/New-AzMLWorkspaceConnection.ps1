...
PROPERTY <IWorkspaceConnectionPropertiesV2>: .
  AuthType <String>: Authentication type of the connection target
  ...
  [ValueFormat <String>]: format for the workspace connection value
...
begin {
    try {
        ...
        $mapping = @{
            ...
            CreateViaIdentityWorkspaceExpanded = 'Az.MachineLearningServices.private\New-AzMLWorkspaceConnection_CreateViaIdentityWorkspaceExpanded';
            CreateViaJsonFilePath = 'Az.MachineLearningServices.private\New-AzMLWorkspaceConnection_CreateViaJsonFilePath';
            CreateViaJsonString = 'Az.MachineLearningServices.private\New-AzMLWorkspaceConnection_CreateViaJsonString';
        }
