...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models
{
    ...
    public partial class NodeStateCounts :
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INodeStateCounts,
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INodeStateCountsInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INodeStateCountsInternal.IdleNodeCount { get => this._idleNodeCount; set { {_idleNodeCount = value;} } }

        /// <summary>Internal Acessors for LeavingNodeCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INodeStateCountsInternal.LeavingNodeCount { get => this._leavingNodeCount; set { {_leavingNodeCount = value;} } }

        /// <summary>Internal Acessors for PreemptedNodeCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INodeStateCountsInternal.PreemptedNodeCount { get => this._preemptedNodeCount; set { {_preemptedNodeCount = value;} } }

        /// <summary>Internal Acessors for PreparingNodeCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INodeStateCountsInternal.PreparingNodeCount { get => this._preparingNodeCount; set { {_preparingNodeCount = value;} } }

        /// <summary>Internal Acessors for RunningNodeCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INodeStateCountsInternal.RunningNodeCount { get => this._runningNodeCount; set { {_runningNodeCount = value;} } }

        /// <summary>Internal Acessors for UnusableNodeCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INodeStateCountsInternal.UnusableNodeCount { get => this._unusableNodeCount; set { {_unusableNodeCount = value;} } }
