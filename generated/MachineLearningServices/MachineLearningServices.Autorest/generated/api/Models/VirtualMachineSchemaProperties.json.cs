...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models
{
    ...
    public partial class VirtualMachineSchemaProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IVirtualMachineSchemaProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IVirtualMachineSchemaProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IVirtualMachineSchemaProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNode node)
        {
        ...
        internal VirtualMachineSchemaProperties(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonObject json)
        {
            ...
            {_virtualMachineSize = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonString>("virtualMachineSize"), out var __jsonVirtualMachineSize) ? (string)__jsonVirtualMachineSize : (string)_virtualMachineSize;}
            ...
            {_notebookServerPort = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNumber>("notebookServerPort"), out var __jsonNotebookServerPort) ? (int?)__jsonNotebookServerPort : _notebookServerPort;}
            ...
            {_isNotebookInstanceCompute = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonBoolean>("isNotebookInstanceCompute"), out var __jsonIsNotebookInstanceCompute) ? (bool?)__jsonIsNotebookInstanceCompute : _isNotebookInstanceCompute;}
            AfterFromJson(json);
        }
    }
}