...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models
{
    ...
    public partial class ForecastingSettings
    {
        ...
        internal ForecastingSettings(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonObject json)
        {
            ...
            {_forecastHorizon = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonObject>("forecastHorizon"), out var __jsonForecastHorizon) ? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.ForecastHorizon.FromJson(__jsonForecastHorizon) : _forecastHorizon;}
            {_seasonality = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonObject>("seasonality"), out var __jsonSeasonality) ? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Seasonality.FromJson(__jsonSeasonality) : _seasonality;}
            {_targetLag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonObject>("targetLags"), out var __jsonTargetLags) ? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.TargetLags.FromJson(__jsonTargetLags) : _targetLag;}
            {_targetRollingWindowSize = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonObject>("targetRollingWindowSize"), out var __jsonTargetRollingWindowSize) ? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.TargetRollingWindowSize.FromJson(__jsonTargetRollingWindowSize) : _targetRollingWindowSize;}
            {_countryOrRegionForHoliday = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonString>("countryOrRegionForHolidays"), out var __jsonCountryOrRegionForHolidays) ? (string)__jsonCountryOrRegionForHolidays : (string)_countryOrRegionForHoliday;}
            {_cvStepSize = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNumber>("cvStepSize"), out var __jsonCvStepSize) ? (int?)__jsonCvStepSize : _cvStepSize;}
            {_featureLag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonString>("featureLags"), out var __jsonFeatureLags) ? (string)__jsonFeatureLags : (string)_featureLag;}
            ...
            {_shortSeriesHandlingConfig = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonString>("shortSeriesHandlingConfig"), out var __jsonShortSeriesHandlingConfig) ? (string)__jsonShortSeriesHandlingConfig : (string)_shortSeriesHandlingConfig;}
            {_targetAggregateFunction = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonString>("targetAggregateFunction"), out var __jsonTargetAggregateFunction) ? (string)__jsonTargetAggregateFunction : (string)_targetAggregateFunction;}
            {_timeColumnName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonString>("timeColumnName"), out var __jsonTimeColumnName) ? (string)__jsonTimeColumnName : (string)_timeColumnName;}
            {_timeSeriesIdColumnName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonArray>("timeSeriesIdColumnNames"), out var __jsonTimeSeriesIdColumnNames) ? If( __jsonTimeSeriesIdColumnNames as Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _timeSeriesIdColumnName;}
            {_useStl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonString>("useStl"), out var __jsonUseStl) ? (string)__jsonUseStl : (string)_useStl;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IForecastingSettings.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IForecastingSettings.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IForecastingSettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNode node)
        {
