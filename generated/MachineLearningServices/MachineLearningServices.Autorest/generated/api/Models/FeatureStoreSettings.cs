...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models
{
    ...
    public partial class FeatureStoreSettings :
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IFeatureStoreSettings,
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IFeatureStoreSettingsInternal
    {

        /// <summary>Backing field for <see cref="ComputeRuntime" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IComputeRuntimeDto _computeRuntime;

        /// <summary>Compute runtime config for feature store type workspace.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IComputeRuntimeDto ComputeRuntime { get => (this._computeRuntime = this._computeRuntime ?? new Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.ComputeRuntimeDto()); set => this._computeRuntime = value; }

        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.PropertyOrigin.Inlined)]
        public string ComputeRuntimeSparkRuntimeVersion { get => ((Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IComputeRuntimeDtoInternal)ComputeRuntime).SparkRuntimeVersion; set => ((Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IComputeRuntimeDtoInternal)ComputeRuntime).SparkRuntimeVersion = value ?? null; }

        /// <summary>Internal Acessors for ComputeRuntime</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IComputeRuntimeDto Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IFeatureStoreSettingsInternal.ComputeRuntime { get => (this._computeRuntime = this._computeRuntime ?? new Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.ComputeRuntimeDto()); set { {_computeRuntime = value;} } }
    ...
    {
        /// <summary>Compute runtime config for feature store type workspace.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IComputeRuntimeDto ComputeRuntime { get; set; }
