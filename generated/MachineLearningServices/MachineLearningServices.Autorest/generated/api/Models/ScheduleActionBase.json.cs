...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models
{
    ...
    public partial class ScheduleActionBase
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IScheduleActionBase.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IScheduleActionBase interface is polymorphic,
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IScheduleActionBase.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IScheduleActionBase FromJson(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("actionType") )
            {
                case "CreateMonitor":
                {
                    return new CreateMonitorAction(json);
                }
                case "InvokeBatchEndpoint":
                {
                    return new EndpointScheduleAction(json);
                }
                case "CreateJob":
                {
                    return new JobScheduleAction(json);
                }
            }
            return new ScheduleActionBase(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonObject into a new instance of <see cref="ScheduleActionBase" />.
        /// </summary>
        ...
        internal ScheduleActionBase(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="ScheduleActionBase" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ScheduleActionBase" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNode" />.
        /// </returns>
