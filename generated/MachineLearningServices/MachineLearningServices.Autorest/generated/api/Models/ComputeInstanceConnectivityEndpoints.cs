...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models
{
    ...
    public partial class ComputeInstanceConnectivityEndpoints :
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IComputeInstanceConnectivityEndpoints,
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IComputeInstanceConnectivityEndpointsInternal
    {

        /// <summary>Internal Acessors for PrivateIPAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IComputeInstanceConnectivityEndpointsInternal.PrivateIPAddress { get => this._privateIPAddress; set { {_privateIPAddress = value;} } }

        /// <summary>Internal Acessors for PublicIPAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IComputeInstanceConnectivityEndpointsInternal.PublicIPAddress { get => this._publicIPAddress; set { {_publicIPAddress = value;} } }
