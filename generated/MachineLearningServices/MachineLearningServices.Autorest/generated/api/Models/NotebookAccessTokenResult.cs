...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models
{
    ...
    public partial class NotebookAccessTokenResult :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INotebookAccessTokenResultInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INotebookAccessTokenResultInternal.AccessToken { get => this._accessToken; set { {_accessToken = value;} } }

        /// <summary>Internal Acessors for ExpiresIn</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INotebookAccessTokenResultInternal.ExpiresIn { get => this._expiresIn; set { {_expiresIn = value;} } }

        /// <summary>Internal Acessors for HostName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INotebookAccessTokenResultInternal.HostName { get => this._hostName; set { {_hostName = value;} } }

        /// <summary>Internal Acessors for NotebookResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INotebookAccessTokenResultInternal.NotebookResourceId { get => this._notebookResourceId; set { {_notebookResourceId = value;} } }

        /// <summary>Internal Acessors for PublicDns</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INotebookAccessTokenResultInternal.PublicDns { get => this._publicDns; set { {_publicDns = value;} } }

        /// <summary>Internal Acessors for RefreshToken</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INotebookAccessTokenResultInternal.RefreshToken { get => this._refreshToken; set { {_refreshToken = value;} } }

        /// <summary>Internal Acessors for Scope</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INotebookAccessTokenResultInternal.Scope { get => this._scope; set { {_scope = value;} } }

        /// <summary>Internal Acessors for TokenType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.INotebookAccessTokenResultInternal.TokenType { get => this._tokenType; set { {_tokenType = value;} } }
