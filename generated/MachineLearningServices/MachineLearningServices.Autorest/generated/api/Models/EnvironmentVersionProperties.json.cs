...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models
{
    ...
    public partial class EnvironmentVersionProperties
    {
        ...
        internal EnvironmentVersionProperties(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonObject json)
        {
            ...
            {_build = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonObject>("build"), out var __jsonBuild) ? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.BuildContext.FromJson(__jsonBuild) : _build;}
            {_inferenceConfig = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonObject>("inferenceConfig"), out var __jsonInferenceConfig) ? Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.InferenceContainerProperties.FromJson(__jsonInferenceConfig) : _inferenceConfig;}
            {_autoRebuild = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonString>("autoRebuild"), out var __jsonAutoRebuild) ? (string)__jsonAutoRebuild : (string)_autoRebuild;}
            {_condaFile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonString>("condaFile"), out var __jsonCondaFile) ? (string)__jsonCondaFile : (string)_condaFile;}
            {_environmentType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonString>("environmentType"), out var __jsonEnvironmentType) ? (string)__jsonEnvironmentType : (string)_environmentType;}
            {_image = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonString>("image"), out var __jsonImage) ? (string)__jsonImage : (string)_image;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IEnvironmentVersionProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IEnvironmentVersionProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IEnvironmentVersionProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNode node)
        {
