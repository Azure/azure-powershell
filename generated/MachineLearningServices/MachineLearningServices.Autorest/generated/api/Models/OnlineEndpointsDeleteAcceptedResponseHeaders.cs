...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models
{
    ...
    public partial class OnlineEndpointsDeleteAcceptedResponseHeaders :
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IOnlineEndpointsDeleteAcceptedResponseHeaders,
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IOnlineEndpointsDeleteAcceptedResponseHeadersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IHeaderSerializable
    {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IOnlineEndpointsDeleteAcceptedResponseHeadersInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader1) is string __headerLocationHeader1 ? __headerLocationHeader1 : (string)null;
            }
            if (headers.TryGetValues("Retry-After", out var __retryAfterHeader2))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IOnlineEndpointsDeleteAcceptedResponseHeadersInternal)this).RetryAfter = System.Linq.Enumerable.FirstOrDefault(__retryAfterHeader2) is string __headerRetryAfterHeader2 ? int.TryParse( __headerRetryAfterHeader2, out int __headerRetryAfterHeader2Value ) ? __headerRetryAfterHeader2Value : default(int?) : default(int?);
            }
        }

        /// <summary>
        /// Creates an new <see cref="OnlineEndpointsDeleteAcceptedResponseHeaders" /> instance.
        /// </summary>
        public OnlineEndpointsDeleteAcceptedResponseHeaders()
        {
    ...
    internal partial interface IOnlineEndpointsDeleteAcceptedResponseHeadersInternal
