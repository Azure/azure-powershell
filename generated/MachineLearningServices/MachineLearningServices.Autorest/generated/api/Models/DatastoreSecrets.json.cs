...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models
{
    ...
    public partial class DatastoreSecrets
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonObject into a new instance of <see cref="DatastoreSecrets" />.
        /// </summary>
        ...
        internal DatastoreSecrets(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonObject json)
        {
            ...
            {_secretsType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonString>("secretsType"), out var __jsonSecretsType) ? (string)__jsonSecretsType : (string)_secretsType;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IDatastoreSecrets.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IDatastoreSecrets interface is polymorphic,
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IDatastoreSecrets.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IDatastoreSecrets FromJson(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("secretsType") )
            {
                case "AccountKey":
                {
                    return new AccountKeyDatastoreSecrets(json);
                }
                case "Certificate":
                {
                    return new CertificateDatastoreSecrets(json);
                }
                case "Sas":
                {
                    return new SasDatastoreSecrets(json);
                }
                case "ServicePrincipal":
                {
                    return new ServicePrincipalDatastoreSecrets(json);
                }
            }
            return new DatastoreSecrets(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="DatastoreSecrets" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="DatastoreSecrets" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._secretsType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Json.JsonString(this._secretsType.ToString()) : null, "secretsType" ,container.Add );
