...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMLWorkspaceJob_UpdateViaIdentityWorkspaceExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzMLWorkspaceJob_UpdateViaIdentityWorkspaceExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (WorkspaceInputObject?.Id != null)
                    {
                        ...
                        _body = await this.Client.JobsGetViaIdentityWithResult(WorkspaceInputObject.Id, this, Pipeline);
                        this.Update_body();
                        await this.Client.JobsCreateOrUpdateViaIdentity(WorkspaceInputObject.Id, _body, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _body = await this.Client.JobsGetWithResult(WorkspaceInputObject.SubscriptionId ?? null, WorkspaceInputObject.ResourceGroupName ?? null, WorkspaceInputObject.WorkspaceName ?? null, Name, this, Pipeline);
                        this.Update_body();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzMLWorkspaceJob_UpdateViaIdentityWorkspaceExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzMLWorkspaceJob_UpdateViaIdentityWorkspaceExpanded()
        {
