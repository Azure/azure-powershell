...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMLWorkspaceDataContainer_UpdateViaIdentityWorkspaceExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzMLWorkspaceDataContainer_UpdateViaIdentityWorkspaceExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (WorkspaceInputObject?.Id != null)
                    {
                        ...
                        _body = await this.Client.DataContainersGetViaIdentityWithResult(WorkspaceInputObject.Id, this, Pipeline);
                        this.Update_body();
                        await this.Client.DataContainersCreateOrUpdateViaIdentity(WorkspaceInputObject.Id, _body, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _body = await this.Client.DataContainersGetWithResult(WorkspaceInputObject.SubscriptionId ?? null, WorkspaceInputObject.ResourceGroupName ?? null, WorkspaceInputObject.WorkspaceName ?? null, Name, this, Pipeline);
                        this.Update_body();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzMLWorkspaceDataContainer_UpdateViaIdentityWorkspaceExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzMLWorkspaceDataContainer_UpdateViaIdentityWorkspaceExpanded()
        {
