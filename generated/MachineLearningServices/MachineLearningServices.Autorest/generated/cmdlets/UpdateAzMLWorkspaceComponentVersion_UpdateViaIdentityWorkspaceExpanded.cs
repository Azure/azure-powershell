...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMLWorkspaceComponentVersion_UpdateViaIdentityWorkspaceExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzMLWorkspaceComponentVersion_UpdateViaIdentityWorkspaceExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (WorkspaceInputObject?.Id != null)
                    {
                        ...
                        _body = await this.Client.ComponentVersionsGetViaIdentityWithResult(WorkspaceInputObject.Id, this, Pipeline);
                        this.Update_body();
                        await this.Client.ComponentVersionsCreateOrUpdateViaIdentity(WorkspaceInputObject.Id, _body, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _body = await this.Client.ComponentVersionsGetWithResult(WorkspaceInputObject.SubscriptionId ?? null, WorkspaceInputObject.ResourceGroupName ?? null, WorkspaceInputObject.WorkspaceName ?? null, Name, Version, this, Pipeline);
                        this.Update_body();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzMLWorkspaceComponentVersion_UpdateViaIdentityWorkspaceExpanded" />
        /// cmdlet class.
        /// </summary>
        public UpdateAzMLWorkspaceComponentVersion_UpdateViaIdentityWorkspaceExpanded()
        {
