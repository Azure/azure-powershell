...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// <summary>
    /// create and execute a Job.For update case, the Tags in the definition passed in will replace Tags in the existing
    /// job.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzMLWorkspaceJob_CreateViaIdentityWorkspaceExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Description(@"create and execute a Job.For update case, the Tags in the definition passed in will replace Tags in the existing job.")]
    ...
    public partial class NewAzMLWorkspaceJob_CreateViaIdentityWorkspaceExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "[Required] Additional attributes of the entity.")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzMLWorkspaceJob_CreateViaIdentityWorkspaceExpanded" /> cmdlet class.
        /// </summary>
        public NewAzMLWorkspaceJob_CreateViaIdentityWorkspaceExpanded()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (WorkspaceInputObject?.Id != null)
                    {
                        ...
                        await this.Client.JobsCreateOrUpdateViaIdentity(WorkspaceInputObject.Id, _body, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
