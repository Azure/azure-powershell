...
WORKSPACEINPUTOBJECT <IMachineLearningServicesIdentity>: Identity Parameter
  ...
  [WorkspaceName <String>]: Name of Azure Machine Learning workspace.
.Link
https://learn.microsoft.com/powershell/module/az.machinelearningservices/update-azmlworkspacedataversion
#>
function Update-AzMLWorkspaceDataVersion {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IDataVersionBase])]
...
param(
    ...
    [Parameter(ParameterSetName='UpdateExpanded', Mandatory)]
    [Parameter(ParameterSetName='UpdateViaIdentityDataExpanded', Mandatory)]
    [Parameter(ParameterSetName='UpdateViaIdentityWorkspaceExpanded', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [System.String]
    # Version identifier.
    ...
    [Parameter(ParameterSetName='UpdateViaIdentityDataExpanded', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IMachineLearningServicesIdentity]
    # Identity Parameter
    ${DataInputObject},
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceDataVersion_UpdateExpanded';
            UpdateViaIdentityDataExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceDataVersion_UpdateViaIdentityDataExpanded';
            UpdateViaIdentityExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceDataVersion_UpdateViaIdentityExpanded';
            UpdateViaIdentityWorkspaceExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceDataVersion_UpdateViaIdentityWorkspaceExpanded';
        }
