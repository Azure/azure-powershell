...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceDataContainer_Get';
            GetViaIdentity = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceDataContainer_GetViaIdentity';
            GetViaIdentityWorkspace = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceDataContainer_GetViaIdentityWorkspace';
            List = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceDataContainer_List';
        }
