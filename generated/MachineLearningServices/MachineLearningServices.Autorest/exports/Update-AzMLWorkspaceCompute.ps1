...
begin {
    try {
        ...
        $mapping = @{
            ...
            UpdateViaIdentityWorkspaceExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceCompute_UpdateViaIdentityWorkspaceExpanded';
            UpdateViaJsonFilePath = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceCompute_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceCompute_UpdateViaJsonString';
        }
