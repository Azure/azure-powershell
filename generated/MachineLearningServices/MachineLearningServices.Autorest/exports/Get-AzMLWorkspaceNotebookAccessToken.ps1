...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20240401.INotebookAccessTokenResult])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceNotebookAccessToken_List';
        }
