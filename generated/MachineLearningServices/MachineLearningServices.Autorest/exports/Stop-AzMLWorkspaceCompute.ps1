...
param(
    ...
    [Parameter(ParameterSetName='StopViaIdentityWorkspace', Mandatory)]
    [Alias('ComputeName')]
    ...
    [Parameter(ParameterSetName='StopViaIdentityWorkspace', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IMachineLearningServicesIdentity]
    # Identity Parameter
...
begin {
    try {
        ...
        $mapping = @{
            ...
            StopViaIdentityWorkspace = 'Az.MachineLearningServices.private\Stop-AzMLWorkspaceCompute_StopViaIdentityWorkspace';
        }
