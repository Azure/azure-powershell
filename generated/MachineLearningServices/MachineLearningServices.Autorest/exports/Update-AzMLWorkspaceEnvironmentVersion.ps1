...
WORKSPACEINPUTOBJECT <IMachineLearningServicesIdentity>: Identity Parameter
  ...
  [WorkspaceName <String>]: Name of Azure Machine Learning workspace.
.Link
https://learn.microsoft.com/powershell/module/az.machinelearningservices/update-azmlworkspaceenvironmentversion
#>
function Update-AzMLWorkspaceEnvironmentVersion {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceEnvironmentVersion_UpdateExpanded';
            UpdateViaIdentityEnvironmentExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceEnvironmentVersion_UpdateViaIdentityEnvironmentExpanded';
            UpdateViaIdentityExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceEnvironmentVersion_UpdateViaIdentityExpanded';
            UpdateViaIdentityWorkspaceExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceEnvironmentVersion_UpdateViaIdentityWorkspaceExpanded';
        }
