...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceDatastore_Delete';
            DeleteViaIdentity = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceDatastore_DeleteViaIdentity';
            DeleteViaIdentityWorkspace = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceDatastore_DeleteViaIdentityWorkspace';
        }
