...
begin {
    try {
        ...
        $mapping = @{
            ...
            CreateViaIdentityWorkspaceExpanded = 'Az.MachineLearningServices.private\New-AzMLWorkspaceCodeVersion_CreateViaIdentityWorkspaceExpanded';
            CreateViaJsonFilePath = 'Az.MachineLearningServices.private\New-AzMLWorkspaceCodeVersion_CreateViaJsonFilePath';
            CreateViaJsonString = 'Az.MachineLearningServices.private\New-AzMLWorkspaceCodeVersion_CreateViaJsonString';
        }
