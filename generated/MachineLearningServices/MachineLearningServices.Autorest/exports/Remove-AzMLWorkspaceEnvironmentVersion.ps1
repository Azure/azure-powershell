...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceEnvironmentVersion_Delete';
            DeleteViaIdentity = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceEnvironmentVersion_DeleteViaIdentity';
            DeleteViaIdentityEnvironment = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceEnvironmentVersion_DeleteViaIdentityEnvironment';
            DeleteViaIdentityWorkspace = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceEnvironmentVersion_DeleteViaIdentityWorkspace';
        }
