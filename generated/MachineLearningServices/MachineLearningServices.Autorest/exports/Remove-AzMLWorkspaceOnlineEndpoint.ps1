...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceOnlineEndpoint_Delete';
            DeleteViaIdentity = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceOnlineEndpoint_DeleteViaIdentity';
            DeleteViaIdentityWorkspace = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceOnlineEndpoint_DeleteViaIdentityWorkspace';
        }
