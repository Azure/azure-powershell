...
WORKSPACEINPUTOBJECT <IMachineLearningServicesIdentity>: Identity Parameter
  ...
  [WorkspaceName <String>]: Name of Azure Machine Learning workspace.
.Link
https://learn.microsoft.com/powershell/module/az.machinelearningservices/update-azmlworkspacemodelversion
#>
function Update-AzMLWorkspaceModelVersion {
...
param(
    ...
    [Parameter(ParameterSetName='UpdateExpanded', Mandatory)]
    [Parameter(ParameterSetName='UpdateViaIdentityModelExpanded', Mandatory)]
    [Parameter(ParameterSetName='UpdateViaIdentityWorkspaceExpanded', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [System.String]
    # Version identifier.
    ...
    [Parameter(ParameterSetName='UpdateViaIdentityModelExpanded', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IMachineLearningServicesIdentity]
    # Identity Parameter
    ${ModelInputObject},
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceModelVersion_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceModelVersion_UpdateViaIdentityExpanded';
            UpdateViaIdentityModelExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceModelVersion_UpdateViaIdentityModelExpanded';
            UpdateViaIdentityWorkspaceExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceModelVersion_UpdateViaIdentityWorkspaceExpanded';
        }
