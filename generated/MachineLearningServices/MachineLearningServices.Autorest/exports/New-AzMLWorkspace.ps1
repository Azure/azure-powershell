...
begin {
    try {
        ...
        $mapping = @{
            ...
            CreateViaJsonFilePath = 'Az.MachineLearningServices.private\New-AzMLWorkspace_CreateViaJsonFilePath';
            CreateViaJsonString = 'Az.MachineLearningServices.private\New-AzMLWorkspace_CreateViaJsonString';
        }
