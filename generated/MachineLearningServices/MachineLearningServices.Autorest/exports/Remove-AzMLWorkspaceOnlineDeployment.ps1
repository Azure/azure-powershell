...
param(
    ...
    [Parameter(ParameterSetName='Delete', Mandatory)]
    [Parameter(ParameterSetName='DeleteViaIdentityOnlineEndpoint', Mandatory)]
    [Parameter(ParameterSetName='DeleteViaIdentityWorkspace', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [System.String]
    ...
    [Parameter(ParameterSetName='DeleteViaIdentityOnlineEndpoint', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IMachineLearningServicesIdentity]
    # Identity Parameter
...
begin {
    try {
        ...
        $mapping = @{
            ...
            DeleteViaIdentityOnlineEndpoint = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceOnlineDeployment_DeleteViaIdentityOnlineEndpoint';
            DeleteViaIdentityWorkspace = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceOnlineDeployment_DeleteViaIdentityWorkspace';
        }
