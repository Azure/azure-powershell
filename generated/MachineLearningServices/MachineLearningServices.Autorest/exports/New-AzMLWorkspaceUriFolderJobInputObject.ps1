...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.UriFolderJobInput])]
...
begin {
    try {
        ...
        $mapping = @{
            __AllParameterSets = 'Az.MachineLearningServices.custom\New-AzMLWorkspaceUriFolderJobInputObject';
        }
