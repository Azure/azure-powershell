...
param(
    ...
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='GetViaIdentityData', Mandatory)]
    [Parameter(ParameterSetName='GetViaIdentityWorkspace', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [System.String]
    # Version identifier.
    ...
    [Parameter(ParameterSetName='GetViaIdentityData', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IMachineLearningServicesIdentity]
    # Identity Parameter
    ${DataInputObject},
...
begin {
    try {
        ...
        $mapping = @{
            ...
            GetViaIdentityData = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceDataVersion_GetViaIdentityData';
            GetViaIdentityWorkspace = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceDataVersion_GetViaIdentityWorkspace';
