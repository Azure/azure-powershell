...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Query')]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Info(PossibleTypes=([System.String]))]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            GetViaIdentityWorkspace = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceDatastore_GetViaIdentityWorkspace';
