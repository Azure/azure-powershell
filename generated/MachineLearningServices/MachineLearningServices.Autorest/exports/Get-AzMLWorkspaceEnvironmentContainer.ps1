...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IEnvironmentContainer])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceEnvironmentContainer_Get';
            GetViaIdentity = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceEnvironmentContainer_GetViaIdentity';
            GetViaIdentityWorkspace = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceEnvironmentContainer_GetViaIdentityWorkspace';
            List = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceEnvironmentContainer_List';
        }
