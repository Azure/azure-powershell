...
WORKSPACEINPUTOBJECT <IMachineLearningServicesIdentity>: Identity Parameter
  ...
  [WorkspaceName <String>]: Name of Azure Machine Learning workspace.
.Link
https://learn.microsoft.com/powershell/module/az.machinelearningservices/update-azmlworkspacecomponentversion
#>
function Update-AzMLWorkspaceComponentVersion {
...
param(
    ...
    [Parameter(ParameterSetName='UpdateExpanded', Mandatory)]
    [Parameter(ParameterSetName='UpdateViaIdentityComponentExpanded', Mandatory)]
    [Parameter(ParameterSetName='UpdateViaIdentityWorkspaceExpanded', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [System.String]
    # Version identifier.
    ...
    [Parameter(ParameterSetName='UpdateViaIdentityComponentExpanded', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IMachineLearningServicesIdentity]
    # Identity Parameter
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceComponentVersion_UpdateExpanded';
            UpdateViaIdentityComponentExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceComponentVersion_UpdateViaIdentityComponentExpanded';
            UpdateViaIdentityExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceComponentVersion_UpdateViaIdentityExpanded';
            UpdateViaIdentityWorkspaceExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceComponentVersion_UpdateViaIdentityWorkspaceExpanded';
        }
