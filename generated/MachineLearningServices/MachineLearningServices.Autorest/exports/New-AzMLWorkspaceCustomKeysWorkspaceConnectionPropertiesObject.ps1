...
CREDENTIALSKEY <ICustomKeys>: Dictionary of <string>.
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.CustomKeysWorkspaceConnectionProperties])]
[CmdletBinding(PositionalBinding=$false)]
param(
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.ICustomKeys]
...
begin {
    try {
        ...
        $mapping = @{
            __AllParameterSets = 'Az.MachineLearningServices.custom\New-AzMLWorkspaceCustomKeysWorkspaceConnectionPropertiesObject';
        }
