...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20240401.IFqdnEndpoints])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceOutboundNetworkDependencyEndpoint_List';
        }
