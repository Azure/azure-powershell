...
CODEINPUTOBJECT <IMachineLearningServicesIdentity>: Identity Parameter
...
param(
    ...
    [Parameter(ParameterSetName='Delete', Mandatory)]
    [Parameter(ParameterSetName='DeleteViaIdentityCode', Mandatory)]
    [Parameter(ParameterSetName='DeleteViaIdentityWorkspace', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [System.String]
    # Version identifier.
    ...
    [Parameter(ParameterSetName='DeleteViaIdentityCode', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IMachineLearningServicesIdentity]
    # Identity Parameter
    ${CodeInputObject},
...
begin {
    try {
        ...
        $mapping = @{
            ...
            DeleteViaIdentityCode = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceCodeVersion_DeleteViaIdentityCode';
            DeleteViaIdentityWorkspace = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceCodeVersion_DeleteViaIdentityWorkspace';
        }
