...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IEndpointAuthToken
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IEndpointAuthToken])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceOnlineEndpointToken_Get';
            GetViaIdentity = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceOnlineEndpointToken_GetViaIdentity';
            GetViaIdentityWorkspace = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceOnlineEndpointToken_GetViaIdentityWorkspace';
        }
