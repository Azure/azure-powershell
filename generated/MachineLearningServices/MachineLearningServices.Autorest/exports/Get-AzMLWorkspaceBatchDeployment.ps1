...
param(
    ...
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='GetViaIdentityBatchEndpoint', Mandatory)]
    [Parameter(ParameterSetName='GetViaIdentityWorkspace', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [System.String]
    ...
    [Parameter(ParameterSetName='GetViaIdentityBatchEndpoint', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IMachineLearningServicesIdentity]
    # Identity Parameter
...
begin {
    try {
        ...
        $mapping = @{
            ...
            GetViaIdentityBatchEndpoint = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceBatchDeployment_GetViaIdentityBatchEndpoint';
            GetViaIdentityWorkspace = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceBatchDeployment_GetViaIdentityWorkspace';
