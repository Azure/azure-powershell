...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20240401.IResourceQuota])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.MachineLearningServices.private\Get-AzMLServiceQuota_List';
        }
