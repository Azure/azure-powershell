...
WORKSPACEINPUTOBJECT <IMachineLearningServicesIdentity>: Identity Parameter
  ...
  [WorkspaceName <String>]: Name of Azure Machine Learning workspace.
.Link
https://learn.microsoft.com/powershell/module/az.machinelearningservices/update-azmlworkspacemodelcontainer
#>
function Update-AzMLWorkspaceModelContainer {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IModelContainer])]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceModelContainer_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceModelContainer_UpdateViaIdentityExpanded';
            UpdateViaIdentityWorkspaceExpanded = 'Az.MachineLearningServices.private\Update-AzMLWorkspaceModelContainer_UpdateViaIdentityWorkspaceExpanded';
        }
