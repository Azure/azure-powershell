...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceModelContainer_Delete';
            DeleteViaIdentity = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceModelContainer_DeleteViaIdentity';
            DeleteViaIdentityWorkspace = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceModelContainer_DeleteViaIdentityWorkspace';
        }
