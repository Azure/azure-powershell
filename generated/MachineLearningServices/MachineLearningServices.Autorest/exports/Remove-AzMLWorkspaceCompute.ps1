...
param(
    ...
    [Parameter(Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.PSArgumentCompleterAttribute("Delete", "Detach")]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            DeleteViaIdentityWorkspace = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceCompute_DeleteViaIdentityWorkspace';
        }
