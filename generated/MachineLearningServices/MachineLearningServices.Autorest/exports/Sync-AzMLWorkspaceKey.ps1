...
begin {
    try {
        ...
        $mapping = @{
            Resync = 'Az.MachineLearningServices.private\Sync-AzMLWorkspaceKey_Resync';
            ResyncViaIdentity = 'Az.MachineLearningServices.private\Sync-AzMLWorkspaceKey_ResyncViaIdentity';
        }
