...
param(
    ...
    [Parameter(ParameterSetName='StartViaIdentityWorkspace', Mandatory)]
    [Alias('ComputeName')]
    ...
    [Parameter(ParameterSetName='StartViaIdentityWorkspace', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IMachineLearningServicesIdentity]
    # Identity Parameter
...
begin {
    try {
        ...
        $mapping = @{
            ...
            StartViaIdentityWorkspace = 'Az.MachineLearningServices.private\Start-AzMLWorkspaceCompute_StartViaIdentityWorkspace';
        }
