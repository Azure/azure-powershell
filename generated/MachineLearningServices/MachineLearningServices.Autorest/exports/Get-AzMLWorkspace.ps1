...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MachineLearningServices.private\Get-AzMLWorkspace_Get';
            GetViaIdentity = 'Az.MachineLearningServices.private\Get-AzMLWorkspace_GetViaIdentity';
            List = 'Az.MachineLearningServices.private\Get-AzMLWorkspace_List';
            List1 = 'Az.MachineLearningServices.private\Get-AzMLWorkspace_List1';
        }
