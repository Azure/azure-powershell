...
param(
    ...
    [Parameter(ParameterSetName='RestartViaIdentityWorkspace', Mandatory)]
    [Alias('ComputeName')]
    ...
    [Parameter(ParameterSetName='RestartViaIdentityWorkspace', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IMachineLearningServicesIdentity]
    # Identity Parameter
...
begin {
    try {
        ...
        $mapping = @{
            Restart = 'Az.MachineLearningServices.private\Restart-AzMLWorkspaceCompute_Restart';
            RestartViaIdentity = 'Az.MachineLearningServices.private\Restart-AzMLWorkspaceCompute_RestartViaIdentity';
            RestartViaIdentityWorkspace = 'Az.MachineLearningServices.private\Restart-AzMLWorkspaceCompute_RestartViaIdentityWorkspace';
        }
