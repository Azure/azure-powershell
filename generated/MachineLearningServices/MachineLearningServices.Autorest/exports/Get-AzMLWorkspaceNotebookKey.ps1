...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20240401.IListNotebookKeysResult])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceNotebookKey_List';
        }
