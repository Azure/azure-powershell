...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.MachineLearningServices.private\New-AzMLWorkspaceModelContainer_CreateExpanded';
            CreateViaIdentityWorkspaceExpanded = 'Az.MachineLearningServices.private\New-AzMLWorkspaceModelContainer_CreateViaIdentityWorkspaceExpanded';
            CreateViaJsonFilePath = 'Az.MachineLearningServices.private\New-AzMLWorkspaceModelContainer_CreateViaJsonFilePath';
            CreateViaJsonString = 'Az.MachineLearningServices.private\New-AzMLWorkspaceModelContainer_CreateViaJsonString';
        }
