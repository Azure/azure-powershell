...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IComponentContainer])]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.MachineLearningServices.private\New-AzMLWorkspaceComponentContainer_CreateExpanded';
            CreateViaIdentityWorkspaceExpanded = 'Az.MachineLearningServices.private\New-AzMLWorkspaceComponentContainer_CreateViaIdentityWorkspaceExpanded';
            CreateViaJsonFilePath = 'Az.MachineLearningServices.private\New-AzMLWorkspaceComponentContainer_CreateViaJsonFilePath';
            CreateViaJsonString = 'Az.MachineLearningServices.private\New-AzMLWorkspaceComponentContainer_CreateViaJsonString';
        }
