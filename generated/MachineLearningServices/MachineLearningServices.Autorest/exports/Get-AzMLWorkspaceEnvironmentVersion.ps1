...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceEnvironmentVersion_Get';
            GetViaIdentity = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceEnvironmentVersion_GetViaIdentity';
            GetViaIdentityEnvironment = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceEnvironmentVersion_GetViaIdentityEnvironment';
            GetViaIdentityWorkspace = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceEnvironmentVersion_GetViaIdentityWorkspace';
            List = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceEnvironmentVersion_List';
        }
