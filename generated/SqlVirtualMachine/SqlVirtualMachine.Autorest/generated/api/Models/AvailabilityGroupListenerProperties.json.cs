...
namespace Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models
{
    ...
    public partial class AvailabilityGroupListenerProperties
    {
        ...
        internal AvailabilityGroupListenerProperties(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonObject json)
        {
            ...
            {_availabilityGroupConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonObject>("availabilityGroupConfiguration"), out var __jsonAvailabilityGroupConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.AgConfiguration.FromJson(__jsonAvailabilityGroupConfiguration) : _availabilityGroupConfiguration;}
            ...
            {_availabilityGroupName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonString>("availabilityGroupName"), out var __jsonAvailabilityGroupName) ? (string)__jsonAvailabilityGroupName : (string)_availabilityGroupName;}
            {_loadBalancerConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonArray>("loadBalancerConfigurations"), out var __jsonLoadBalancerConfigurations) ? If( __jsonLoadBalancerConfigurations as Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.ILoadBalancerConfiguration>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.ILoadBalancerConfiguration) (Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.LoadBalancerConfiguration.FromJson(__u) )) ))() : null : _loadBalancerConfiguration;}
            {_multiSubnetIPConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonArray>("multiSubnetIpConfigurations"), out var __jsonMultiSubnetIPConfigurations) ? If( __jsonMultiSubnetIPConfigurations as Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.IMultiSubnetIPConfiguration>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.IMultiSubnetIPConfiguration) (Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.MultiSubnetIPConfiguration.FromJson(__p) )) ))() : null : _multiSubnetIPConfiguration;}
            {_createDefaultAvailabilityGroupIfNotExist = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonBoolean>("createDefaultAvailabilityGroupIfNotExist"), out var __jsonCreateDefaultAvailabilityGroupIfNotExist) ? (bool?)__jsonCreateDefaultAvailabilityGroupIfNotExist : _createDefaultAvailabilityGroupIfNotExist;}
            {_port = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonNumber>("port"), out var __jsonPort) ? (int?)__jsonPort : _port;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.IAvailabilityGroupListenerProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.IAvailabilityGroupListenerProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.IAvailabilityGroupListenerProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonNode node)
        {
