...
namespace Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models
{
    ...
    public partial class AgReplica
    {
        ...
        internal AgReplica(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonObject json)
        {
            ...
            {_sqlVirtualMachineInstanceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonString>("sqlVirtualMachineInstanceId"), out var __jsonSqlVirtualMachineInstanceId) ? (string)__jsonSqlVirtualMachineInstanceId : (string)_sqlVirtualMachineInstanceId;}
            {_role = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonString>("role"), out var __jsonRole) ? (string)__jsonRole : (string)_role;}
            {_commit = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonString>("commit"), out var __jsonCommit) ? (string)__jsonCommit : (string)_commit;}
            {_failover = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonString>("failover"), out var __jsonFailover) ? (string)__jsonFailover : (string)_failover;}
            {_readableSecondary = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonString>("readableSecondary"), out var __jsonReadableSecondary) ? (string)__jsonReadableSecondary : (string)_readableSecondary;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.IAgReplica.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.IAgReplica.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.IAgReplica FromJson(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonNode node)
        {
