...
namespace Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models
{
    ...
    public partial class AutoBackupSettings :
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.IAutoBackupSettings,
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.IAutoBackupSettingsInternal
    {

        /// <summary>Backing field for <see cref="BackupScheduleType" /> property.</summary>
        private string _backupScheduleType;
        ...
        public string BackupScheduleType { get => this._backupScheduleType; set => this._backupScheduleType = value; }
        ...
        private string _fullBackupFrequency;

        /// <summary>
        /// Frequency of full backups. In both cases, full backups begin during the next scheduled time window.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Origin(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.PropertyOrigin.Owned)]
        public string FullBackupFrequency { get => this._fullBackupFrequency; set => this._fullBackupFrequency = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.IJsonSerializable
    {
        ...
        string BackupScheduleType { get; set; }
        /// <summary>Include or exclude system databases from auto backup.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        string FullBackupFrequency { get; set; }
        /// <summary>Start time of a given day during which full backups can take place. 0-23 hours.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Info(
        Required = false,
        ReadOnly = false,
