...
namespace Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzSqlVM_GetViaIdentity" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.SqlVirtualMachinesGet(InputObject.ResourceGroupName ?? null, InputObject.SqlVirtualMachineName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, InputObject.SubscriptionId ?? null, onOk, onDefault, this, Pipeline);
                    }
