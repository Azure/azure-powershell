...
namespace Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.IContext
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="GetAzSqlVM_List" /> cmdlet class.</summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SqlVirtualMachinesListBySqlVMGroup(SubscriptionId, ResourceGroupName, GroupName, onOk, onDefault, this, Pipeline);
