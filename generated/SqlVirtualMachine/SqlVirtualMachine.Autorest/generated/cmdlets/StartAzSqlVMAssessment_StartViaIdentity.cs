...
namespace Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.SqlVirtualMachinesStartAssessment(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.SqlVirtualMachineName ?? null, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartAzSqlVMAssessment_StartViaIdentity" /> cmdlet class.
        /// </summary>
