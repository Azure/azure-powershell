...
namespace Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.IContext
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="GetAzSqlVM_Get" /> cmdlet class.</summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SqlVirtualMachinesGet(SubscriptionId, ResourceGroupName, Name, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, onOk, onDefault, this, Pipeline);
