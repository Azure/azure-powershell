...
namespace Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzSqlVMGroup_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Description(@"Gets all SQL virtual machine groups in a subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups", ApiVersion = "2022-08-01-preview")]
    public partial class GetAzSqlVMGroup_List1 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzSqlVMGroup_List1" /> cmdlet class.
        /// </summary>
        public GetAzSqlVMGroup_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SqlVirtualMachineGroupsList(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.SqlVirtualMachineGroupsList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
