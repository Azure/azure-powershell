...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Cmdlets
{
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.OutputBreakingChange("Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20210301.IPublicIPAddress", "16.0.0", "9.0.0", "May 2026", DeprecatedOutputProperties=new string[] {"Zone","IPTag","PublicIPAddress","PublicIPPrefix","Subnet"}, NewOutputProperties=new string[] {"Zone","IPTag","PublicIPAddress","PublicIPPrefix","Subnet"}, ChangeDescription="The types of the properties 'Zone', 'IPTag', 'PublicIPAddress', 'PublicIPPrefix', and 'Subnet' will be changed from object to 'List'.")]
