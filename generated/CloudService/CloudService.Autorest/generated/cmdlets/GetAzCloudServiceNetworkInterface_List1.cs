...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzCloudServiceNetworkInterface_List1" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.NetworkInterfacesListByCloudService(SubscriptionId, ResourceGroupName, CloudServiceName, onOk, onDefault, this, Pipeline);
