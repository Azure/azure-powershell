...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzCloudServiceRoleInstance_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.CloudServiceRoleInstancesGet(SubscriptionId, ResourceGroupName, RoleInstanceName, CloudServiceName, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, onOk, onDefault, this, Pipeline);
