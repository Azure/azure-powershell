...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzCloudServicePublicIPAddress_GetViaIdentityRoleInstance")]
    [Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.OutputBreakingChange("Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IPublicIPAddress", "16.0.0", "9.0.0", "May 2026", DeprecatedOutputProperties = new string[] {"Zone","IPTag","PublicIPAddress","PublicIPPrefix","Subnet"}, NewOutputProperties = new string[] {"Zone","IPTag","PublicIPAddress","PublicIPPrefix","Subnet" } , ChangeDescription = "The types of the properties 'Zone', 'IPTag', 'PublicIPAddress', 'PublicIPPrefix', and 'Subnet' will be changed from object to 'List'.")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IPublicIPAddress))]
    ...
    public partial class GetAzCloudServicePublicIPAddress_GetViaIdentityRoleInstance : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IPublicIPAddress">Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IPublicIPAddress</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IPublicIPAddress> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzCloudServicePublicIPAddress_GetViaIdentityRoleInstance" /> cmdlet class.
        /// </summary>
        public GetAzCloudServicePublicIPAddress_GetViaIdentityRoleInstance()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.RoleInstanceInputObject.Id += $"/networkInterfaces/{(global::System.Uri.EscapeDataString(this.NetworkInterfaceName.ToString()))}/ipconfigurations/{(global::System.Uri.EscapeDataString(this.IPConfigurationName.ToString()))}/publicipaddresses/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.PublicIPAddressesGetByCloudServiceViaIdentity(RoleInstanceInputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == RoleInstanceInputObject.CloudServiceName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("RoleInstanceInputObject has null value for RoleInstanceInputObject.CloudServiceName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, RoleInstanceInputObject) );
                        }
                        ...
                        await this.Client.PublicIPAddressesGetByCloudService(RoleInstanceInputObject.SubscriptionId ?? null, RoleInstanceInputObject.ResourceGroupName ?? null, RoleInstanceInputObject.CloudServiceName ?? null, RoleInstanceInputObject.RoleInstanceName ?? null, NetworkInterfaceName, IPConfigurationName, Name, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { NetworkInterfaceName=NetworkInterfaceName,IPConfigurationName=IPConfigurationName,Name=Name,Expand=this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IPublicIPAddress> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IPublicIPAddress
