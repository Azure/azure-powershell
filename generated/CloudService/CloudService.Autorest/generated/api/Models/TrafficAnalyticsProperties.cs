...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models
{
    ...
    public partial class TrafficAnalyticsProperties :
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ITrafficAnalyticsProperties,
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ITrafficAnalyticsPropertiesInternal
    {

        /// <summary>Internal Acessors for NetworkWatcherFlowAnalyticsConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ITrafficAnalyticsConfigurationProperties Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ITrafficAnalyticsPropertiesInternal.NetworkWatcherFlowAnalyticsConfiguration { get => (this._networkWatcherFlowAnalyticsConfiguration = this._networkWatcherFlowAnalyticsConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.TrafficAnalyticsConfigurationProperties()); set { {_networkWatcherFlowAnalyticsConfiguration = value;} } }

        /// <summary>Flag to enable/disable traffic analytics.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CloudService.Origin(Microsoft.Azure.PowerShell.Cmdlets.CloudService.PropertyOrigin.Inlined)]
        public bool? NetworkWatcherFlowAnalyticConfigurationEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ITrafficAnalyticsConfigurationPropertiesInternal)NetworkWatcherFlowAnalyticsConfiguration).Enabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ITrafficAnalyticsConfigurationPropertiesInternal)NetworkWatcherFlowAnalyticsConfiguration).Enabled = value ?? default(bool); }
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ITrafficAnalyticsConfigurationProperties _networkWatcherFlowAnalyticsConfiguration;

        /// <summary>Parameters that define the configuration of traffic analytics.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CloudService.Origin(Microsoft.Azure.PowerShell.Cmdlets.CloudService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ITrafficAnalyticsConfigurationProperties NetworkWatcherFlowAnalyticsConfiguration { get => (this._networkWatcherFlowAnalyticsConfiguration = this._networkWatcherFlowAnalyticsConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.TrafficAnalyticsConfigurationProperties()); set => this._networkWatcherFlowAnalyticsConfiguration = value; }
...

    {
        ...
        string NetworkWatcherFlowAnalyticConfigurationWorkspaceResourceId { get; set; }
        /// <summary>Parameters that define the configuration of traffic analytics.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ITrafficAnalyticsConfigurationProperties NetworkWatcherFlowAnalyticsConfiguration { get; set; }
