...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models
{
    ...
    public partial class OSVersionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IOSVersionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IOSVersionPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IOSVersionPropertiesInternal.Family { get => this._family; set { {_family = value;} } }

        /// <summary>Internal Acessors for FamilyLabel</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IOSVersionPropertiesInternal.FamilyLabel { get => this._familyLabel; set { {_familyLabel = value;} } }

        /// <summary>Internal Acessors for IsActive</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IOSVersionPropertiesInternal.IsActive { get => this._isActive; set { {_isActive = value;} } }

        /// <summary>Internal Acessors for IsDefault</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IOSVersionPropertiesInternal.IsDefault { get => this._isDefault; set { {_isDefault = value;} } }

        /// <summary>Internal Acessors for Label</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IOSVersionPropertiesInternal.Label { get => this._label; set { {_label = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IOSVersionPropertiesInternal.Version { get => this._version; set { {_version = value;} } }
