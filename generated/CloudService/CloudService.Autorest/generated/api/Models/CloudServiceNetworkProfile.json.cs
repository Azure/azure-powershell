...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models
{
    ...
    public partial class CloudServiceNetworkProfile
    {
        ...
        internal CloudServiceNetworkProfile(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject json)
        {
            ...
            {_loadBalancerConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonArray>("loadBalancerConfigurations"), out var __jsonLoadBalancerConfigurations) ? If( __jsonLoadBalancerConfigurations as Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ILoadBalancerConfiguration>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ILoadBalancerConfiguration) (Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.LoadBalancerConfiguration.FromJson(__u) )) ))() : null : _loadBalancerConfiguration;}
            {_slotType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("slotType"), out var __jsonSlotType) ? (string)__jsonSlotType : (string)_slotType;}
            {_swappableCloudService = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject>("swappableCloudService"), out var __jsonSwappableCloudService) ? Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.SubResource.FromJson(__jsonSwappableCloudService) : _swappableCloudService;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceNetworkProfile.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceNetworkProfile.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceNetworkProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode node)
        {
