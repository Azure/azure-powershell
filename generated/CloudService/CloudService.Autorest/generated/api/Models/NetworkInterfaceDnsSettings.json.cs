...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models
{
    ...
    public partial class NetworkInterfaceDnsSettings
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.INetworkInterfaceDnsSettings.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.INetworkInterfaceDnsSettings.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.INetworkInterfaceDnsSettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode node)
        {
        ...
        internal NetworkInterfaceDnsSettings(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject json)
        {
            ...
            {_dnsServer = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonArray>("dnsServers"), out var __jsonDnsServers) ? If( __jsonDnsServers as Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _dnsServer;}
            {_appliedDnsServer = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonArray>("appliedDnsServers"), out var __jsonAppliedDnsServers) ? If( __jsonAppliedDnsServers as Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : _appliedDnsServer;}
            {_internalDnsNameLabel = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("internalDnsNameLabel"), out var __jsonInternalDnsNameLabel) ? (string)__jsonInternalDnsNameLabel : (string)_internalDnsNameLabel;}
            {_internalFqdn = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("internalFqdn"), out var __jsonInternalFqdn) ? (string)__jsonInternalFqdn : (string)_internalFqdn;}
            {_internalDomainNameSuffix = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("internalDomainNameSuffix"), out var __jsonInternalDomainNameSuffix) ? (string)__jsonInternalDomainNameSuffix : (string)_internalDomainNameSuffix;}
            AfterFromJson(json);
        }
