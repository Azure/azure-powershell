...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models
{
    ...
    public partial class RoleInstanceView :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IRoleInstanceViewInternal
    {

        /// <summary>Internal Acessors for PlatformFaultDomain</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IRoleInstanceViewInternal.PlatformFaultDomain { get => this._platformFaultDomain; set { {_platformFaultDomain = value;} } }

        /// <summary>Internal Acessors for PlatformUpdateDomain</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IRoleInstanceViewInternal.PlatformUpdateDomain { get => this._platformUpdateDomain; set { {_platformUpdateDomain = value;} } }

        /// <summary>Internal Acessors for PrivateId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IRoleInstanceViewInternal.PrivateId { get => this._privateId; set { {_privateId = value;} } }

        /// <summary>Internal Acessors for Statuses</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IResourceInstanceViewStatus> Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IRoleInstanceViewInternal.Statuses { get => this._statuses; set { {_statuses = value;} } }
