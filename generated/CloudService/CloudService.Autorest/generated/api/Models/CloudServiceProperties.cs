...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models
{
    ...
    public partial class CloudServiceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServicePropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceExtensionProfile _extensionProfile;

        /// <summary>Describes a cloud service extension profile.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CloudService.Origin(Microsoft.Azure.PowerShell.Cmdlets.CloudService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceExtensionProfile ExtensionProfile { get => (this._extensionProfile = this._extensionProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.CloudServiceExtensionProfile()); set => this._extensionProfile = value; }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServicePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for UniqueId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServicePropertiesInternal.UniqueId { get => this._uniqueId; set { {_uniqueId = value;} } }

        /// <summary>Backing field for <see cref="NetworkProfile" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceNetworkProfile _networkProfile;

        /// <summary>Network Profile for the cloud service.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CloudService.Origin(Microsoft.Azure.PowerShell.Cmdlets.CloudService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceNetworkProfile NetworkProfile { get => (this._networkProfile = this._networkProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.CloudServiceNetworkProfile()); set => this._networkProfile = value; }

        /// <summary>Backing field for <see cref="OSProfile" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceOSProfile _oSProfile;

        /// <summary>Describes the OS profile for the cloud service.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CloudService.Origin(Microsoft.Azure.PowerShell.Cmdlets.CloudService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceOSProfile OSProfile { get => (this._oSProfile = this._oSProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.CloudServiceOSProfile()); set => this._oSProfile = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceRoleProfile _roleProfile;

        /// <summary>Describes the role profile for the cloud service.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CloudService.Origin(Microsoft.Azure.PowerShell.Cmdlets.CloudService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceRoleProfile RoleProfile { get => (this._roleProfile = this._roleProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.CloudServiceRoleProfile()); set => this._roleProfile = value; }
