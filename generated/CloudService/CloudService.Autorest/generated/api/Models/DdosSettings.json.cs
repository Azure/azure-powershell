...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models
{
    ...
    public partial class DdosSettings
    {
        ...
        internal DdosSettings(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject json)
        {
            ...
            {_ddosCustomPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject>("ddosCustomPolicy"), out var __jsonDdosCustomPolicy) ? Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.SubResourceAutoGenerated.FromJson(__jsonDdosCustomPolicy) : _ddosCustomPolicy;}
            {_protectionCoverage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("protectionCoverage"), out var __jsonProtectionCoverage) ? (string)__jsonProtectionCoverage : (string)_protectionCoverage;}
            {_protectedIP = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonBoolean>("protectedIP"), out var __jsonProtectedIP) ? (bool?)__jsonProtectedIP : _protectedIP;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IDdosSettings.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IDdosSettings.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IDdosSettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode node)
        {
