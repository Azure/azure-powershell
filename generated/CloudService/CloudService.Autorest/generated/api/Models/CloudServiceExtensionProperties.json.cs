...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models
{
    ...
    public partial class CloudServiceExtensionProperties
    {
        ...
        internal CloudServiceExtensionProperties(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject json)
        {
            ...
            {_protectedSettingsFromKeyVault = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject>("protectedSettingsFromKeyVault"), out var __jsonProtectedSettingsFromKeyVault) ? Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.CloudServiceVaultAndSecretReference.FromJson(__jsonProtectedSettingsFromKeyVault) : _protectedSettingsFromKeyVault;}
            {_publisher = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("publisher"), out var __jsonPublisher) ? (string)__jsonPublisher : (string)_publisher;}
            ...
            {_typeHandlerVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("typeHandlerVersion"), out var __jsonTypeHandlerVersion) ? (string)__jsonTypeHandlerVersion : (string)_typeHandlerVersion;}
            {_autoUpgradeMinorVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonBoolean>("autoUpgradeMinorVersion"), out var __jsonAutoUpgradeMinorVersion) ? (bool?)__jsonAutoUpgradeMinorVersion : _autoUpgradeMinorVersion;}
            {_setting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("settings"), out var __jsonSettings) ? (string)__jsonSettings : (string)_setting;}
            {_protectedSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("protectedSettings"), out var __jsonProtectedSettings) ? (string)__jsonProtectedSettings : (string)_protectedSetting;}
            {_forceUpdateTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("forceUpdateTag"), out var __jsonForceUpdateTag) ? (string)__jsonForceUpdateTag : (string)_forceUpdateTag;}
            ...
            {_rolesAppliedTo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonArray>("rolesAppliedTo"), out var __jsonRolesAppliedTo) ? If( __jsonRolesAppliedTo as Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _rolesAppliedTo;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceExtensionProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceExtensionProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceExtensionProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode node)
        {
