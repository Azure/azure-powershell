...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models
{
    ...
    public partial class CloudServiceProperties
    {
        ...
        internal CloudServiceProperties(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject json)
        {
            ...
            {_packageUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("packageUrl"), out var __jsonPackageUrl) ? (string)__jsonPackageUrl : (string)_packageUrl;}
            {_configuration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("configuration"), out var __jsonConfiguration) ? (string)__jsonConfiguration : (string)_configuration;}
            {_configurationUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("configurationUrl"), out var __jsonConfigurationUrl) ? (string)__jsonConfigurationUrl : (string)_configurationUrl;}
            {_startCloudService = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonBoolean>("startCloudService"), out var __jsonStartCloudService) ? (bool?)__jsonStartCloudService : _startCloudService;}
            {_allowModelOverride = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonBoolean>("allowModelOverride"), out var __jsonAllowModelOverride) ? (bool?)__jsonAllowModelOverride : _allowModelOverride;}
            {_upgradeMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("upgradeMode"), out var __jsonUpgradeMode) ? (string)__jsonUpgradeMode : (string)_upgradeMode;}
            {_roleProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject>("roleProfile"), out var __jsonRoleProfile) ? Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.CloudServiceRoleProfile.FromJson(__jsonRoleProfile) : _roleProfile;}
            {_oSProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject>("osProfile"), out var __jsonOSProfile) ? Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.CloudServiceOSProfile.FromJson(__jsonOSProfile) : _oSProfile;}
            {_networkProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject>("networkProfile"), out var __jsonNetworkProfile) ? Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.CloudServiceNetworkProfile.FromJson(__jsonNetworkProfile) : _networkProfile;}
            {_extensionProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject>("extensionProfile"), out var __jsonExtensionProfile) ? Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.CloudServiceExtensionProfile.FromJson(__jsonExtensionProfile) : _extensionProfile;}
            ...
            {_uniqueId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("uniqueId"), out var __jsonUniqueId) ? (string)__jsonUniqueId : (string)_uniqueId;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode node)
        {
