...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="CloudServiceIdentity" />
    /// </summary>
    public partial class CloudServiceIdentityTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="CloudServiceIdentity" /> type, otherwise <c>false</c>
        /// </returns>
        ...
        /// <returns>
        /// an instance of <see cref="CloudServiceIdentity" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        ...
        /// an instance of <see cref="CloudServiceIdentity" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceIdentity ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            if (type == typeof(global::System.String))
            {
                return new CloudServiceIdentity { Id = sourceValue };
            }
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceIdentity).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
            {
                return CloudServiceIdentity.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());;
            }
            catch
            {
            ...
            if (typeof(global::System.Management.Automation.PSObject).IsAssignableFrom(type))
            {
                return CloudServiceIdentity.DeserializeFromPSObject(sourceValue);
            }
            if (typeof(global::System.Collections.IDictionary).IsAssignableFrom(type))
            {
                return CloudServiceIdentity.DeserializeFromDictionary(sourceValue);
            }
            return null;
        }
