...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models
{
    ...
    public partial class CloudServiceInstanceView
    {
        ...
        internal CloudServiceInstanceView(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject json)
        {
            ...
            {_roleInstance = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonObject>("roleInstance"), out var __jsonRoleInstance) ? Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.InstanceViewStatusesSummary.FromJson(__jsonRoleInstance) : _roleInstance;}
            {_sdkVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString>("sdkVersion"), out var __jsonSdkVersion) ? (string)__jsonSdkVersion : (string)_sdkVersion;}
            {_privateId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonArray>("privateIds"), out var __jsonPrivateIds) ? If( __jsonPrivateIds as Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _privateId;}
            {_statuses = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonArray>("statuses"), out var __jsonStatuses) ? If( __jsonStatuses as Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IResourceInstanceViewStatus>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IResourceInstanceViewStatus) (Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ResourceInstanceViewStatus.FromJson(__p) )) ))() : null : _statuses;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceInstanceView.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceInstanceView.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.ICloudServiceInstanceView FromJson(Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.Json.JsonNode node)
        {
