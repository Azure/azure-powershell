...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.IOSVersion])]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            GetViaIdentityLocation = 'Az.CloudService.private\Get-AzCloudServiceOSVersion_GetViaIdentityLocation';
