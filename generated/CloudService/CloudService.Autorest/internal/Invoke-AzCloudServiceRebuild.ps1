...
begin {
    try {
        ...
        $mapping = @{
            ...
            RebuildViaJsonFilePath = 'Az.CloudService.private\Invoke-AzCloudServiceRebuild_RebuildViaJsonFilePath';
            RebuildViaJsonString = 'Az.CloudService.private\Invoke-AzCloudServiceRebuild_RebuildViaJsonString';
        }
        if (('RebuildExpanded', 'RebuildViaJsonFilePath', 'RebuildViaJsonString') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId') ) {
            if ($testPlayback) {
