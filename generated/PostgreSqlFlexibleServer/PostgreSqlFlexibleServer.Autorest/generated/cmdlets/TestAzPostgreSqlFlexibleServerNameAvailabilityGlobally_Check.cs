...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Cmdlets
{
    ...
    /// <summary>
    /// Checks the validity and availability of the given name, to assign it to a new server or to use it as the base name of
    /// a new pair of virtual endpoints.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CheckGlobally=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.DBforPostgreSQL/checkNameAvailability"
    /// [DETAILS]
    /// verb: Test
    /// subjectPrefix: PostgreSqlFlexibleServer
    /// subject: NameAvailabilityGlobally
    /// variant: Check
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzPostgreSqlFlexibleServerNameAvailabilityGlobally_Check", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Description(@"Checks the validity and availability of the given name, to assign it to a new server or to use it as the base name of a new pair of virtual endpoints.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.DBforPostgreSQL/checkNameAvailability", ApiVersion = "2026-01-01-preview")]
    public partial class TestAzPostgreSqlFlexibleServerNameAvailabilityGlobally_Check : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Models.ICheckNameAvailabilityRequest _parameter;
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Models.ICheckNameAvailabilityRequest) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Models.ICheckNameAvailabilityRequest Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NameAvailabilityCheckGlobally' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.NameAvailabilityCheckGlobally(SubscriptionId, Parameter, onOk, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestAzPostgreSqlFlexibleServerNameAvailabilityGlobally_Check" /> cmdlet class.
        /// </summary>
        public TestAzPostgreSqlFlexibleServerNameAvailabilityGlobally_Check()
        {
