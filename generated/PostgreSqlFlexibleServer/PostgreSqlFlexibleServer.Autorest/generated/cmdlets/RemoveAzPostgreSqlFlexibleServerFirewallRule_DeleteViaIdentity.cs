...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Runtime.IContext
    {
        ...
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Cmdlets.RemoveAzPostgreSqlFlexibleServerFirewallRule_DeleteViaIdentity Clone()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.FirewallRulesDelete(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServerName ?? null, InputObject.FirewallRuleName ?? null, onNoContent, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzPostgreSqlFlexibleServerFirewallRule_DeleteViaIdentity" /> cmdlet
        /// class.
        /// </summary>
