...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Description(@"create a new server.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Runtime.IContext
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of the login designated as the first password based administrator assigned to your instance of PostgreSQL. Must be specified the first time that you enable password based authentication on a server. Once set to a given value, it cannot be changed for the rest of the life of a server. If you disable password based authentication on a server which had it enabled, this password based role isn't deleted.")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Availability zone of a server.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Category(global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Indicates if the server is configured to create geographically redundant backups.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Category(global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Creation time (in ISO8601 format) of the backup which you want to restore in the new server. It's required when 'createMode' is 'PointInTimeRestore', 'GeoRestore', or 'ReviveDropped'.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Category(global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Identifier of the server to be used as the source of the new server. Required when 'createMode' is 'PointInTimeRestore', 'GeoRestore', 'Replica', or 'ReviveDropped'. This property is returned only when the target server is a read replica.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Category(global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Cmdlets.NewAzPostgreSqlFlexibleServer_CreateExpanded Clone()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzPostgreSqlFlexibleServer_CreateExpanded" /> cmdlet class.
        /// </summary>
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ServersCreateOrUpdate(SubscriptionId, ResourceGroupName, Name, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Runtime.SerializationMode.IncludeCreate);
