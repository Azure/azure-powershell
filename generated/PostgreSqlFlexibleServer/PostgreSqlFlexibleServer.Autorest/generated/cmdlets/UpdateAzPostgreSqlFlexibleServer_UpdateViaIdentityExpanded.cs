...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Runtime.IContext
    {
        ...
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Cmdlets.UpdateAzPostgreSqlFlexibleServer_UpdateViaIdentityExpanded Clone()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _parametersBody = await this.Client.ServersGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_parametersBody();
                        await this.Client.ServersCreateOrUpdateViaIdentity(InputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _parametersBody = await this.Client.ServersGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServerName ?? null, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_parametersBody();
                        await this.Client.ServersCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServerName ?? null, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzPostgreSqlFlexibleServer_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
