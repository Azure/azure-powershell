...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Cmdlets
{
    ...
    /// <summary>Deletes a pair of virtual endpoints.</summary>
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{serverName}/virtualendpoints/{virtualEndpointName}"
    /// [DETAILS]
    /// verb: Remove
    /// subjectPrefix: PostgreSqlFlexibleServer
    /// subject: VirtualEndpoint
    /// variant: DeleteViaIdentityFlexibleServer
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzPostgreSqlFlexibleServerVirtualEndpoint_DeleteViaIdentityFlexibleServer", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Description(@"Deletes a pair of virtual endpoints.")]
    ...
    public partial class RemoveAzPostgreSqlFlexibleServerVirtualEndpoint_DeleteViaIdentityFlexibleServer : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of RemoveAzPostgreSqlFlexibleServerVirtualEndpoint_DeleteViaIdentityFlexibleServer
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Cmdlets.RemoveAzPostgreSqlFlexibleServerVirtualEndpoint_DeleteViaIdentityFlexibleServer Clone()
        {
            var clone = new RemoveAzPostgreSqlFlexibleServerVirtualEndpoint_DeleteViaIdentityFlexibleServer();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualEndpointsDelete' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (FlexibleServerInputObject?.Id != null)
                    {
                        ...
                        await this.Client.VirtualEndpointsDeleteViaIdentity(FlexibleServerInputObject.Id, onNoContent, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualEndpointsDelete(FlexibleServerInputObject.SubscriptionId ?? null, FlexibleServerInputObject.ResourceGroupName ?? null, FlexibleServerInputObject.ServerName ?? null, Name, onNoContent, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzPostgreSqlFlexibleServerVirtualEndpoint_DeleteViaIdentityFlexibleServer"
        /// /> cmdlet class.
        /// </summary>
        public RemoveAzPostgreSqlFlexibleServerVirtualEndpoint_DeleteViaIdentityFlexibleServer()
        {
