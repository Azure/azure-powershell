 ...
 *--------------------------------------------------------------------------------------------*/
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.Runtime
{
    using Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlFlexibleServer.generated.runtime.Properties;
    using System;
    ...
    public class GenericBreakingChangeAttribute : Attribute
    {
        ...
        public string moduleName { get; set; } = String.IsNullOrEmpty(@"") ? @"Az.PostgreSqlFlexibleServer" : @"";
