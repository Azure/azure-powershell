...
namespace Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StreamAnalytics/streamingjobs/{jobName}/outputs/{outputName}"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzStreamAnalyticsOutput_UpdateViaIdentityStreamingjob", SupportsShouldProcess = true)]
    ...
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IOutput))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Description(@"update an existing output under an existing streaming job. This can be used to partially update (ie. update one or two properties) an output without affecting the rest the job or output definition.")]
    ...
    public partial class UpdateAzStreamAnalyticsOutput_UpdateViaIdentityStreamingjob : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IOutput _output;

        /// <summary>
        /// An output object, containing all information associated with the named output. All outputs are contained under a streaming
        /// job.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "An output object, containing all information associated with the named output. All outputs are contained under a streaming job.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IOutput Output { get => this._output; set => this._output = value; }
        ...
        /// <summary>Backing field for <see cref="StreamingjobInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IStreamAnalyticsIdentity _streamingjobInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Category(global::Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IStreamAnalyticsIdentity StreamingjobInputObject { get => this._streamingjobInputObject; set => this._streamingjobInputObject = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IOutput">Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IOutput</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IOutput> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'OutputsUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (StreamingjobInputObject?.Id != null)
                    {
                        this.StreamingjobInputObject.Id += $"/outputs/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.OutputsUpdateViaIdentity(StreamingjobInputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, Output, onOk, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == StreamingjobInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("StreamingjobInputObject has null value for StreamingjobInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, StreamingjobInputObject) );
                        }
                        if (null == StreamingjobInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("StreamingjobInputObject has null value for StreamingjobInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, StreamingjobInputObject) );
                        }
                        if (null == StreamingjobInputObject.JobName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("StreamingjobInputObject has null value for StreamingjobInputObject.JobName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, StreamingjobInputObject) );
                        }
                        await this.Client.OutputsUpdate(StreamingjobInputObject.SubscriptionId ?? null, StreamingjobInputObject.ResourceGroupName ?? null, StreamingjobInputObject.JobName ?? null, Name, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, Output, onOk, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzStreamAnalyticsOutput_UpdateViaIdentityStreamingjob" /> cmdlet class.
        /// </summary>
        public UpdateAzStreamAnalyticsOutput_UpdateViaIdentityStreamingjob()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IOutput> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IOutput
