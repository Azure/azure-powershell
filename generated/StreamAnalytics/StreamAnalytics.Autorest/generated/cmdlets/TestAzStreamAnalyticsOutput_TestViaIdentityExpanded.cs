...
namespace Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Test=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StreamAnalytics/streamingjobs/{jobName}/outputs/{outputName}/test"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzStreamAnalyticsOutput_TestViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Description(@"Tests whether an output’s datasource is reachable and usable by the Azure Stream Analytics service.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StreamAnalytics/streamingjobs/{jobName}/outputs/{outputName}/test", ApiVersion = "2017-04-01-preview")]
    public partial class TestAzStreamAnalyticsOutput_TestViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.IContext
    {
        ...
        /// job.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IOutput _outputBody = new Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.Output();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IOutputDataSource Datasource { get => _outputBody.Datasource ?? null /* object */; set => _outputBody.Datasource = value; }
        ...
        public string SerializationType { get => _outputBody.SerializationType ?? null; set => _outputBody.SerializationType = value; }
        ...
        /// <returns>a duplicate instance of TestAzStreamAnalyticsOutput_TestViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Cmdlets.TestAzStreamAnalyticsOutput_TestViaIdentityExpanded Clone()
        {
            var clone = new TestAzStreamAnalyticsOutput_TestViaIdentityExpanded();
            ...
            clone._outputBody = this._outputBody;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'OutputsTest' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.OutputsTestViaIdentity(InputObject.Id, _outputBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.OutputName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.OutputName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.OutputsTest(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.JobName ?? null, InputObject.OutputName ?? null, _outputBody, onOk, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestAzStreamAnalyticsOutput_TestViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public TestAzStreamAnalyticsOutput_TestViaIdentityExpanded()
        {
