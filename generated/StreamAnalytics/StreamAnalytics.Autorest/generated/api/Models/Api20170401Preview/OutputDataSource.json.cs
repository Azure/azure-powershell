...
namespace Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.Api20170401Preview
{
    ...
    public partial class OutputDataSource
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.Api20170401Preview.IOutputDataSource.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.Api20170401Preview.IOutputDataSource interface is
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.Api20170401Preview.IOutputDataSource.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.Api20170401Preview.IOutputDataSource FromJson(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("type") )
            {
                ...
                {
                    return new BlobOutputDataSource(json);
                }
                case "Microsoft.Storage/Table":
                {
                    return new AzureTableOutputDataSource(json);
                }
                case "Microsoft.ServiceBus/EventHub":
                {
                    return new EventHubOutputDataSource(json);
                }
                case "Microsoft.EventHub/EventHub":
                {
                    return new EventHubV2OutputDataSource(json);
                }
                case "Microsoft.Sql/Server/Database":
                {
                    return new AzureSqlDatabaseOutputDataSource(json);
                }
                case "Microsoft.Sql/Server/DataWarehouse":
                {
                    return new AzureSynapseOutputDataSource(json);
                }
                case "Microsoft.Storage/DocumentDB":
                {
                    return new DocumentDbOutputDataSource(json);
                }
                case "Microsoft.AzureFunction":
                {
                    return new AzureFunctionOutputDataSource(json);
                }
                case "Microsoft.ServiceBus/Queue":
                {
                    return new ServiceBusQueueOutputDataSource(json);
                }
                case "Microsoft.ServiceBus/Topic":
                {
                    return new ServiceBusTopicOutputDataSource(json);
                }
                case "PowerBI":
                {
                    return new PowerBiOutputDataSource(json);
                }
                case "Microsoft.DataLake/Accounts":
                {
                    return new AzureDataLakeStoreOutputDataSource(json);
                }
            }
            return new OutputDataSource(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonObject into a new instance of <see cref="OutputDataSource" />.
        /// </summary>
        ...
        internal OutputDataSource(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="OutputDataSource" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="OutputDataSource" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode" />.
        /// </returns>
