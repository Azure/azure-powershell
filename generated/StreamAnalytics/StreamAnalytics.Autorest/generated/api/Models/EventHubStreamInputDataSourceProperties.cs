...
namespace Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models
{
    ...
    public partial class EventHubStreamInputDataSourceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IEventHubStreamInputDataSourceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IEventHubStreamInputDataSourcePropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IEventHubDataSourceProperties"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IEventHubDataSourceProperties __eventHubDataSourceProperties = new Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.EventHubDataSourceProperties();
    ...
    public partial interface IEventHubStreamInputDataSourceProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IEventHubDataSourceProperties
    {
        /// <summary>
        /// The name of an Event Hub Consumer Group that should be used to read events from the Event Hub. Specifying distinct consumer
        /// group names for multiple inputs allows each of those inputs to receive the same events from the Event Hub. If not specified,
    ...
    internal partial interface IEventHubStreamInputDataSourcePropertiesInternal :
        Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IEventHubDataSourcePropertiesInternal
    {
        /// <summary>
        /// The name of an Event Hub Consumer Group that should be used to read events from the Event Hub. Specifying distinct consumer
        /// group names for multiple inputs allows each of those inputs to receive the same events from the Event Hub. If not specified,
