...
namespace Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models
{
    ...
    public partial class StreamingJobProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IStreamingJobProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IStreamingJobProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IStreamingJobProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode node)
        {
        ...
        internal StreamingJobProperties(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonObject json)
        {
            ...
            {_sku = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonObject>("sku"), out var __jsonSku) ? Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.StreamingJobSku.FromJson(__jsonSku) : _sku;}
            {_transformation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonObject>("transformation"), out var __jsonTransformation) ? Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.Transformation.FromJson(__jsonTransformation) : _transformation;}
            {_jobStorageAccount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonObject>("jobStorageAccount"), out var __jsonJobStorageAccount) ? Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.JobStorageAccount.FromJson(__jsonJobStorageAccount) : _jobStorageAccount;}
            {_external = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonObject>("externals"), out var __jsonExternals) ? Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.External.FromJson(__jsonExternals) : _external;}
            {_cluster = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonObject>("cluster"), out var __jsonCluster) ? Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.ClusterInfo.FromJson(__jsonCluster) : _cluster;}
            {_jobId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("jobId"), out var __jsonJobId) ? (string)__jsonJobId : (string)_jobId;}
            {_provisioningState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("provisioningState"), out var __jsonProvisioningState) ? (string)__jsonProvisioningState : (string)_provisioningState;}
            {_jobState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("jobState"), out var __jsonJobState) ? (string)__jsonJobState : (string)_jobState;}
            {_jobType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("jobType"), out var __jsonJobType) ? (string)__jsonJobType : (string)_jobType;}
            {_outputStartMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("outputStartMode"), out var __jsonOutputStartMode) ? (string)__jsonOutputStartMode : (string)_outputStartMode;}
            {_outputStartTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("outputStartTime"), out var __jsonOutputStartTime) ? global::System.DateTime.TryParse((string)__jsonOutputStartTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonOutputStartTimeValue) ? __jsonOutputStartTimeValue : _outputStartTime : _outputStartTime;}
            {_lastOutputEventTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("lastOutputEventTime"), out var __jsonLastOutputEventTime) ? global::System.DateTime.TryParse((string)__jsonLastOutputEventTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonLastOutputEventTimeValue) ? __jsonLastOutputEventTimeValue : _lastOutputEventTime : _lastOutputEventTime;}
            {_eventsOutOfOrderPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("eventsOutOfOrderPolicy"), out var __jsonEventsOutOfOrderPolicy) ? (string)__jsonEventsOutOfOrderPolicy : (string)_eventsOutOfOrderPolicy;}
            {_outputErrorPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("outputErrorPolicy"), out var __jsonOutputErrorPolicy) ? (string)__jsonOutputErrorPolicy : (string)_outputErrorPolicy;}
            {_eventsOutOfOrderMaxDelayInSecond = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNumber>("eventsOutOfOrderMaxDelayInSeconds"), out var __jsonEventsOutOfOrderMaxDelayInSeconds) ? (int?)__jsonEventsOutOfOrderMaxDelayInSeconds : _eventsOutOfOrderMaxDelayInSecond;}
            {_eventsLateArrivalMaxDelayInSecond = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNumber>("eventsLateArrivalMaxDelayInSeconds"), out var __jsonEventsLateArrivalMaxDelayInSeconds) ? (int?)__jsonEventsLateArrivalMaxDelayInSeconds : _eventsLateArrivalMaxDelayInSecond;}
            {_dataLocale = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("dataLocale"), out var __jsonDataLocale) ? (string)__jsonDataLocale : (string)_dataLocale;}
            {_compatibilityLevel = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("compatibilityLevel"), out var __jsonCompatibilityLevel) ? (string)__jsonCompatibilityLevel : (string)_compatibilityLevel;}
            ...
            {_input = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonArray>("inputs"), out var __jsonInputs) ? If( __jsonInputs as Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IInput>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IInput) (Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.Input.FromJson(__u) )) ))() : null : _input;}
            {_output = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonArray>("outputs"), out var __jsonOutputs) ? If( __jsonOutputs as Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IOutput>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IOutput) (Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.Output.FromJson(__p) )) ))() : null : _output;}
            {_function = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonArray>("functions"), out var __jsonFunctions) ? If( __jsonFunctions as Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IFunction>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IFunction) (Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.Function.FromJson(__k) )) ))() : null : _function;}
            {_contentStoragePolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("contentStoragePolicy"), out var __jsonContentStoragePolicy) ? (string)__jsonContentStoragePolicy : (string)_contentStoragePolicy;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.SerializationMode.IncludeRead))
            {
