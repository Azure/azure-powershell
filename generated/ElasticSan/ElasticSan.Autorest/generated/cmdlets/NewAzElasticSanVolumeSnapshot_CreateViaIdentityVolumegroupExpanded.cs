...
namespace Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Create=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ElasticSan/elasticSans/{elasticSanName}/volumegroups/{volumeGroupName}/snapshots/{snapshotName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzElasticSanVolumeSnapshot_CreateViaIdentityVolumegroupExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.ISnapshot))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Description(@"create a Volume Snapshot.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ElasticSan/elasticSans/{elasticSanName}/volumegroups/{volumeGroupName}/snapshots/{snapshotName}", ApiVersion = "2024-07-01-preview")]
    public partial class NewAzElasticSanVolumeSnapshot_CreateViaIdentityVolumegroupExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.ISnapshot _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.Snapshot();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Fully qualified resource ID of the volume. E.g. \"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ElasticSan/elasticSans/{elasticSanName}/volumegroups/{volumeGroupName}/volumes/{volumeName}\"")]
        ...
        public string CreationDataSourceId { get => _parametersBody.CreationDataSourceId ?? null; set => _parametersBody.CreationDataSourceId = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the volume snapshot within the given volume group.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>Backing field for <see cref="VolumegroupInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.IElasticSanIdentity _volumegroupInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.IElasticSanIdentity VolumegroupInputObject { get => this._volumegroupInputObject; set => this._volumegroupInputObject = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.ISnapshot">Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.ISnapshot</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.ISnapshot> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of NewAzElasticSanVolumeSnapshot_CreateViaIdentityVolumegroupExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Cmdlets.NewAzElasticSanVolumeSnapshot_CreateViaIdentityVolumegroupExpanded Clone()
        {
            var clone = new NewAzElasticSanVolumeSnapshot_CreateViaIdentityVolumegroupExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzElasticSanVolumeSnapshot_CreateViaIdentityVolumegroupExpanded" /> cmdlet
        /// class.
        /// </summary>
        public NewAzElasticSanVolumeSnapshot_CreateViaIdentityVolumegroupExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VolumeSnapshotsCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.VolumegroupInputObject.Id += $"/snapshots/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.VolumeSnapshotsCreateViaIdentity(VolumegroupInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == VolumegroupInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("VolumegroupInputObject has null value for VolumegroupInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, VolumegroupInputObject) );
                        }
                        if (null == VolumegroupInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("VolumegroupInputObject has null value for VolumegroupInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, VolumegroupInputObject) );
                        }
                        if (null == VolumegroupInputObject.ElasticSanName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("VolumegroupInputObject has null value for VolumegroupInputObject.ElasticSanName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, VolumegroupInputObject) );
                        }
                        if (null == VolumegroupInputObject.VolumeGroupName)
                        {
                        ...
                        await this.Client.VolumeSnapshotsCreate(VolumegroupInputObject.SubscriptionId ?? null, VolumegroupInputObject.ResourceGroupName ?? null, VolumegroupInputObject.ElasticSanName ?? null, VolumegroupInputObject.VolumeGroupName ?? null, Name, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.SerializationMode.IncludeCreate);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.ISnapshot> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.ISnapshot
