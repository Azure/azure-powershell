            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VolumeGroupsListByElasticSan(SubscriptionId, ResourceGroupName, ElasticSanName, this.InvocationInformation.BoundParameters.ContainsKey("AccessSoftDeletedResource") ? AccessSoftDeletedResource : null, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ElasticSanName=ElasticSanName,AccessSoftDeletedResource=this.InvocationInformation.BoundParameters.ContainsKey("AccessSoftDeletedResource") ? AccessSoftDeletedResource : null})
                    {
