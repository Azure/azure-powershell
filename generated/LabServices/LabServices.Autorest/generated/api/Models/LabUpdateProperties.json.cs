...
namespace Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models
{
    ...
    public partial class LabUpdateProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.ILabUpdateProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.ILabUpdateProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.ILabUpdateProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonNode node)
        {
        ...
        internal LabUpdateProperties(Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject json)
        {
            ...
            {_autoShutdownProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject>("autoShutdownProfile"), out var __jsonAutoShutdownProfile) ? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.AutoShutdownProfile.FromJson(__jsonAutoShutdownProfile) : _autoShutdownProfile;}
            {_connectionProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject>("connectionProfile"), out var __jsonConnectionProfile) ? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.ConnectionProfile.FromJson(__jsonConnectionProfile) : _connectionProfile;}
            {_virtualMachineProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject>("virtualMachineProfile"), out var __jsonVirtualMachineProfile) ? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.VirtualMachineProfile.FromJson(__jsonVirtualMachineProfile) : _virtualMachineProfile;}
            {_securityProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject>("securityProfile"), out var __jsonSecurityProfile) ? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.SecurityProfile.FromJson(__jsonSecurityProfile) : _securityProfile;}
            {_rosterProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject>("rosterProfile"), out var __jsonRosterProfile) ? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.RosterProfile.FromJson(__jsonRosterProfile) : _rosterProfile;}
            {_labPlanId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonString>("labPlanId"), out var __jsonLabPlanId) ? (string)__jsonLabPlanId : (string)_labPlanId;}
            {_title = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonString>("title"), out var __jsonTitle) ? (string)__jsonTitle : (string)_title;}
