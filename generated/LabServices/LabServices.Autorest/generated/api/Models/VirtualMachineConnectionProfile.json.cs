...
namespace Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models
{
    ...
    public partial class VirtualMachineConnectionProfile
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.IVirtualMachineConnectionProfile.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.IVirtualMachineConnectionProfile.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.IVirtualMachineConnectionProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonNode node)
        {
        ...
        internal VirtualMachineConnectionProfile(Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject json)
        {
            ...
            {_privateIPAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonString>("privateIpAddress"), out var __jsonPrivateIPAddress) ? (string)__jsonPrivateIPAddress : (string)_privateIPAddress;}
            {_sshAuthority = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonString>("sshAuthority"), out var __jsonSshAuthority) ? (string)__jsonSshAuthority : (string)_sshAuthority;}
            {_sshInBrowserUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonString>("sshInBrowserUrl"), out var __jsonSshInBrowserUrl) ? (string)__jsonSshInBrowserUrl : (string)_sshInBrowserUrl;}
            {_rdpAuthority = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonString>("rdpAuthority"), out var __jsonRdpAuthority) ? (string)__jsonRdpAuthority : (string)_rdpAuthority;}
            {_rdpInBrowserUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonString>("rdpInBrowserUrl"), out var __jsonRdpInBrowserUrl) ? (string)__jsonRdpInBrowserUrl : (string)_rdpInBrowserUrl;}
            {_adminUsername = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonString>("adminUsername"), out var __jsonAdminUsername) ? (string)__jsonAdminUsername : (string)_adminUsername;}
            {_nonAdminUsername = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonString>("nonAdminUsername"), out var __jsonNonAdminUsername) ? (string)__jsonNonAdminUsername : (string)_nonAdminUsername;}
            AfterFromJson(json);
        }
    }
}