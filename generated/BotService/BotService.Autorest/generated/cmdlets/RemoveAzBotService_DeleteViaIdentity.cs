...
namespace Microsoft.Azure.PowerShell.Cmdlets.BotService.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.IEventListener
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.BotsDelete(InputObject.ResourceGroupName ?? null, InputObject.ResourceName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzBotService_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
