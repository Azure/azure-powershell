...
namespace Microsoft.Azure.PowerShell.Cmdlets.BotService.Models
{
    ...
    public partial class MSTeamsChannelProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.IMSTeamsChannelProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.IMSTeamsChannelProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.IMSTeamsChannelProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode node)
        {
        ...
        internal MSTeamsChannelProperties(Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonObject json)
        {
            ...
            {_enableCalling = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("enableCalling"), out var __jsonEnableCalling) ? (bool?)__jsonEnableCalling : _enableCalling;}
            {_callingWebhook = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("callingWebhook"), out var __jsonCallingWebhook) ? (string)__jsonCallingWebhook : (string)_callingWebhook;}
            ...
            {_incomingCallRoute = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("incomingCallRoute"), out var __jsonIncomingCallRoute) ? (string)__jsonIncomingCallRoute : (string)_incomingCallRoute;}
            {_deploymentEnvironment = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("deploymentEnvironment"), out var __jsonDeploymentEnvironment) ? (string)__jsonDeploymentEnvironment : (string)_deploymentEnvironment;}
            {_acceptedTerm = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("acceptedTerms"), out var __jsonAcceptedTerms) ? (bool?)__jsonAcceptedTerms : _acceptedTerm;}
            AfterFromJson(json);
        }
