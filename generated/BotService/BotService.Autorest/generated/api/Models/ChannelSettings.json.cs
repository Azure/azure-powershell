...
namespace Microsoft.Azure.PowerShell.Cmdlets.BotService.Models
{
    ...
    public partial class ChannelSettings
    {
        ...
        internal ChannelSettings(Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonObject json)
        {
            ...
            {_channelId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("channelId"), out var __jsonChannelId) ? (string)__jsonChannelId : (string)_channelId;}
            {_channelDisplayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("channelDisplayName"), out var __jsonChannelDisplayName) ? (string)__jsonChannelDisplayName : (string)_channelDisplayName;}
            {_botId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("botId"), out var __jsonBotId) ? (string)__jsonBotId : (string)_botId;}
            {_botIconUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("botIconUrl"), out var __jsonBotIconUrl) ? (string)__jsonBotIconUrl : (string)_botIconUrl;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.IChannelSettings.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.IChannelSettings.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.IChannelSettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode node)
        {
