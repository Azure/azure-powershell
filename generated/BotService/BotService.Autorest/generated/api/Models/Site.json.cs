...
namespace Microsoft.Azure.PowerShell.Cmdlets.BotService.Models
{
    ...
    public partial class Site
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.ISite.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.ISite.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.ISite FromJson(Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode node)
        {
        ...
        internal Site(Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonObject json)
        {
            ...
            {_id = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("siteId"), out var __jsonSiteId) ? (string)__jsonSiteId : (string)_id;}
            {_name = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("siteName"), out var __jsonSiteName) ? (string)__jsonSiteName : (string)_name;}
            {_key = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("key"), out var __jsonKey) ? (string)__jsonKey : (string)_key;}
            {_key2 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("key2"), out var __jsonKey2) ? (string)__jsonKey2 : (string)_key2;}
            {_isEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("isEnabled"), out var __jsonIsEnabled) ? (bool)__jsonIsEnabled : _isEnabled;}
            {_isTokenEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("isTokenEnabled"), out var __jsonIsTokenEnabled) ? (bool?)__jsonIsTokenEnabled : _isTokenEnabled;}
            {_isEndpointParametersEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("isEndpointParametersEnabled"), out var __jsonIsEndpointParametersEnabled) ? (bool?)__jsonIsEndpointParametersEnabled : _isEndpointParametersEnabled;}
            {_isDetailedLoggingEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("isDetailedLoggingEnabled"), out var __jsonIsDetailedLoggingEnabled) ? (bool?)__jsonIsDetailedLoggingEnabled : _isDetailedLoggingEnabled;}
            {_isBlockUserUploadEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("isBlockUserUploadEnabled"), out var __jsonIsBlockUserUploadEnabled) ? (bool?)__jsonIsBlockUserUploadEnabled : _isBlockUserUploadEnabled;}
            {_isNoStorageEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("isNoStorageEnabled"), out var __jsonIsNoStorageEnabled) ? (bool?)__jsonIsNoStorageEnabled : _isNoStorageEnabled;}
            {_eTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("eTag"), out var __jsonETag) ? (string)__jsonETag : (string)_eTag;}
            {_appId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("appId"), out var __jsonAppId) ? (string)__jsonAppId : (string)_appId;}
            {_isV1Enabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("isV1Enabled"), out var __jsonIsV1Enabled) ? (bool?)__jsonIsV1Enabled : _isV1Enabled;}
            {_isV3Enabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("isV3Enabled"), out var __jsonIsV3Enabled) ? (bool?)__jsonIsV3Enabled : _isV3Enabled;}
            {_isSecureSiteEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("isSecureSiteEnabled"), out var __jsonIsSecureSiteEnabled) ? (bool?)__jsonIsSecureSiteEnabled : _isSecureSiteEnabled;}
            {_trustedOrigin = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonArray>("trustedOrigins"), out var __jsonTrustedOrigins) ? If( __jsonTrustedOrigins as Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _trustedOrigin;}
            {_isWebchatPreviewEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("isWebchatPreviewEnabled"), out var __jsonIsWebchatPreviewEnabled) ? (bool?)__jsonIsWebchatPreviewEnabled : _isWebchatPreviewEnabled;}
            AfterFromJson(json);
        }
