...
namespace Microsoft.Azure.PowerShell.Cmdlets.BotService.Models
{
    ...
    public partial class SlackChannelProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.ISlackChannelProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.ISlackChannelProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.ISlackChannelProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode node)
        {
        ...
        internal SlackChannelProperties(Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonObject json)
        {
            ...
            {_clientId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("clientId"), out var __jsonClientId) ? (string)__jsonClientId : (string)_clientId;}
            {_clientSecret = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("clientSecret"), out var __jsonClientSecret) ? (string)__jsonClientSecret : (string)_clientSecret;}
            {_verificationToken = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("verificationToken"), out var __jsonVerificationToken) ? (string)__jsonVerificationToken : (string)_verificationToken;}
            {_scope = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("scopes"), out var __jsonScopes) ? (string)__jsonScopes : (string)_scope;}
            {_landingPageUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("landingPageUrl"), out var __jsonLandingPageUrl) ? (string)__jsonLandingPageUrl : (string)_landingPageUrl;}
            {_redirectAction = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("redirectAction"), out var __jsonRedirectAction) ? (string)__jsonRedirectAction : (string)_redirectAction;}
            {_lastSubmissionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("lastSubmissionId"), out var __jsonLastSubmissionId) ? (string)__jsonLastSubmissionId : (string)_lastSubmissionId;}
            {_registerBeforeOAuthFlow = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("registerBeforeOAuthFlow"), out var __jsonRegisterBeforeOAuthFlow) ? (bool?)__jsonRegisterBeforeOAuthFlow : _registerBeforeOAuthFlow;}
            {_isValidated = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("IsValidated"), out var __jsonIsValidated) ? (bool?)__jsonIsValidated : _isValidated;}
            {_signingSecret = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("signingSecret"), out var __jsonSigningSecret) ? (string)__jsonSigningSecret : (string)_signingSecret;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._signingSecret)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString(this._signingSecret.ToString()) : null, "signingSecret" ,container.Add );
