...
namespace Microsoft.Azure.PowerShell.Cmdlets.BotService.Models
{
    ...
    public partial class Channel
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonObject into a new instance of <see cref="Channel" />.
        /// </summary>
        ...
        internal Channel(Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonObject json)
        {
            ...
            {_name = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("channelName"), out var __jsonChannelName) ? (string)__jsonChannelName : (string)_name;}
            ...
            {_location = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("location"), out var __jsonLocation) ? (string)__jsonLocation : (string)_location;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.IChannel.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.IChannel interface is polymorphic, and the precise model
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.IChannel.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.IChannel FromJson(Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode node)
        {
            if (!(node is Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonObject json))
            {
                return null;
            }
            // Polymorphic type -- select the appropriate constructor using the discriminator

            switch ( json.StringProperty("channelName") )
            {
                case "AlexaChannel":
                {
                    return new AlexaChannel(json);
                }
                case "FacebookChannel":
                {
                    return new FacebookChannel(json);
                }
                case "EmailChannel":
                {
                    return new EmailChannel(json);
                }
                case "OutlookChannel":
                {
                    return new OutlookChannel(json);
                }
                case "MsTeamsChannel":
                {
                    return new MSTeamsChannel(json);
                }
                case "SkypeChannel":
                {
                    return new SkypeChannel(json);
                }
                case "KikChannel":
                {
                    return new KikChannel(json);
                }
                case "WebChatChannel":
                {
                    return new WebChatChannel(json);
                }
                case "DirectLineChannel":
                {
                    return new DirectLineChannel(json);
                }
                case "TelegramChannel":
                {
                    return new TelegramChannel(json);
                }
                case "SmsChannel":
                {
                    return new SmsChannel(json);
                }
                case "SlackChannel":
                {
                    return new SlackChannel(json);
                }
                case "LineChannel":
                {
                    return new LineChannel(json);
                }
                case "DirectLineSpeechChannel":
                {
                    return new DirectLineSpeechChannel(json);
                }
            }
        ...
        /// <summary>
        /// Serializes this instance of <see cref="Channel" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Channel" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._name)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString(this._name.ToString()) : null, "channelName" ,container.Add );
            ...
            AddIf( null != (((object)this._location)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString(this._location.ToString()) : null, "location" ,container.Add );
