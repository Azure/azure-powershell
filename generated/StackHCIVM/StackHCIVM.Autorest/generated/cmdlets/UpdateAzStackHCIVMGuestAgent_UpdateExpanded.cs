...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Models.IGuestAgent _body = new Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Models.GuestAgent();
        ...
        public string ProvisioningAction { get => _body.ProvisioningAction ?? null; set => _body.ProvisioningAction = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzStackHCIVMGuestAgent_UpdateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Cmdlets.UpdateAzStackHCIVMGuestAgent_UpdateExpanded Clone()
        {
            var clone = new UpdateAzStackHCIVMGuestAgent_UpdateExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzStackHCIVMGuestAgent_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzStackHCIVMGuestAgent_UpdateExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ProvisioningAction")))
            {
                this.ProvisioningAction = (string)(this.MyInvocation?.BoundParameters["ProvisioningAction"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("CredentialsUsername")))
            {
                this.CredentialsUsername = (string)(this.MyInvocation?.BoundParameters["CredentialsUsername"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("CredentialsPassword")))
            {
                this.CredentialsPassword = (string)(this.MyInvocation?.BoundParameters["CredentialsPassword"]);
            }
        }
