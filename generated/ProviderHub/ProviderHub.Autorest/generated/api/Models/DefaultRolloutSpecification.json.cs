...
namespace Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models
{
    ...
    public partial class DefaultRolloutSpecification
    {
        ...
        internal DefaultRolloutSpecification(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject json)
        {
            ...
            {_canary = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("canary"), out var __jsonCanary) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.DefaultRolloutSpecificationCanary.FromJson(__jsonCanary) : _canary;}
            {_lowTraffic = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("lowTraffic"), out var __jsonLowTraffic) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.DefaultRolloutSpecificationLowTraffic.FromJson(__jsonLowTraffic) : _lowTraffic;}
            {_mediumTraffic = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("mediumTraffic"), out var __jsonMediumTraffic) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.DefaultRolloutSpecificationMediumTraffic.FromJson(__jsonMediumTraffic) : _mediumTraffic;}
            {_highTraffic = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("highTraffic"), out var __jsonHighTraffic) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.DefaultRolloutSpecificationHighTraffic.FromJson(__jsonHighTraffic) : _highTraffic;}
            {_restOfTheWorldGroupOne = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("restOfTheWorldGroupOne"), out var __jsonRestOfTheWorldGroupOne) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.DefaultRolloutSpecificationRestOfTheWorldGroupOne.FromJson(__jsonRestOfTheWorldGroupOne) : _restOfTheWorldGroupOne;}
            {_restOfTheWorldGroupTwo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("restOfTheWorldGroupTwo"), out var __jsonRestOfTheWorldGroupTwo) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.DefaultRolloutSpecificationRestOfTheWorldGroupTwo.FromJson(__jsonRestOfTheWorldGroupTwo) : _restOfTheWorldGroupTwo;}
            {_resourceTypeRegistration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray>("resourceTypeRegistrations"), out var __jsonResourceTypeRegistrations) ? If( __jsonResourceTypeRegistrations as Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceTypeRegistration>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceTypeRegistration) (Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ResourceTypeRegistration.FromJson(__u) )) ))() : null : _resourceTypeRegistration;}
            {_providerRegistration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("providerRegistration"), out var __jsonProviderRegistration) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.DefaultRolloutSpecificationProviderRegistration.FromJson(__jsonProviderRegistration) : _providerRegistration;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IDefaultRolloutSpecification.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IDefaultRolloutSpecification.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IDefaultRolloutSpecification FromJson(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonNode node)
        {
