...
namespace Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models
{
    ...
    public partial class ResourceProviderManifest
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderManifest.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderManifest.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderManifest FromJson(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonNode node)
        {
        ...
        internal ResourceProviderManifest(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject json)
        {
            ...
            {_providerAuthentication = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("providerAuthentication"), out var __jsonProviderAuthentication) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ResourceProviderManifestProviderAuthentication.FromJson(__jsonProviderAuthentication) : _providerAuthentication;}
            {_featuresRule = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("featuresRule"), out var __jsonFeaturesRule) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ResourceProviderManifestFeaturesRule.FromJson(__jsonFeaturesRule) : _featuresRule;}
            {_requestHeaderOption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("requestHeaderOptions"), out var __jsonRequestHeaderOptions) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ResourceProviderManifestRequestHeaderOptions.FromJson(__jsonRequestHeaderOptions) : _requestHeaderOption;}
            {_management = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("management"), out var __jsonManagement) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ResourceProviderManifestManagement.FromJson(__jsonManagement) : _management;}
            {_reRegisterSubscriptionMetadata = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("reRegisterSubscriptionMetadata"), out var __jsonReRegisterSubscriptionMetadata) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ResourceProviderManifestReRegisterSubscriptionMetadata.FromJson(__jsonReRegisterSubscriptionMetadata) : _reRegisterSubscriptionMetadata;}
            {_providerAuthorization = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray>("providerAuthorizations"), out var __jsonProviderAuthorizations) ? If( __jsonProviderAuthorizations as Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderAuthorization>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderAuthorization) (Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ResourceProviderAuthorization.FromJson(__u) )) ))() : null : _providerAuthorization;}
            {_namespace = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonString>("namespace"), out var __jsonNamespace) ? (string)__jsonNamespace : (string)_namespace;}
            {_providerVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonString>("providerVersion"), out var __jsonProviderVersion) ? (string)__jsonProviderVersion : (string)_providerVersion;}
            {_providerType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonString>("providerType"), out var __jsonProviderType) ? (string)__jsonProviderType : (string)_providerType;}
            ...
            {_resourceType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray>("resourceTypes"), out var __jsonResourceTypes) ? If( __jsonResourceTypes as Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceType>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceType) (Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ResourceType.FromJson(__k) )) ))() : null : _resourceType;}
            {_capability = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray>("capabilities"), out var __jsonCapabilities) ? If( __jsonCapabilities as Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderCapabilities>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__g, (__f)=>(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderCapabilities) (Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ResourceProviderCapabilities.FromJson(__f) )) ))() : null : _capability;}
            ...
            {_globalNotificationEndpoint = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray>("globalNotificationEndpoints"), out var __jsonGlobalNotificationEndpoints) ? If( __jsonGlobalNotificationEndpoints as Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray, out var __b) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderEndpoint>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__b, (__a)=>(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderEndpoint) (Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ResourceProviderEndpoint.FromJson(__a) )) ))() : null : _globalNotificationEndpoint;}
            AfterFromJson(json);
        }
