...
namespace Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models
{
    ...
    public partial class ResourceProviderManifestProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderManifestProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderManifestProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderManifestProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonNode node)
        {
        ...
        internal ResourceProviderManifestProperties(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject json)
        {
            ...
            {_providerAuthentication = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("providerAuthentication"), out var __jsonProviderAuthentication) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ResourceProviderManifestPropertiesProviderAuthentication.FromJson(__jsonProviderAuthentication) : _providerAuthentication;}
            {_featuresRule = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("featuresRule"), out var __jsonFeaturesRule) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ResourceProviderManifestPropertiesFeaturesRule.FromJson(__jsonFeaturesRule) : _featuresRule;}
            {_requestHeaderOption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("requestHeaderOptions"), out var __jsonRequestHeaderOptions) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ResourceProviderManifestPropertiesRequestHeaderOptions.FromJson(__jsonRequestHeaderOptions) : _requestHeaderOption;}
            {_management = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("management"), out var __jsonManagement) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ResourceProviderManifestPropertiesManagement.FromJson(__jsonManagement) : _management;}
            {_templateDeploymentOption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject>("templateDeploymentOptions"), out var __jsonTemplateDeploymentOptions) ? Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ResourceProviderManifestPropertiesTemplateDeploymentOptions.FromJson(__jsonTemplateDeploymentOptions) : _templateDeploymentOption;}
            ...
            {_capability = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray>("capabilities"), out var __jsonCapabilities) ? If( __jsonCapabilities as Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderCapabilities>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderCapabilities) (Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ResourceProviderCapabilities.FromJson(__k) )) ))() : null : _capability;}
