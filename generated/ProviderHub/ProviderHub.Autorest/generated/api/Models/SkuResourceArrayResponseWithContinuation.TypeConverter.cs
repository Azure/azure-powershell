...
namespace Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models
{
    ...
    public partial class SkuResourceArrayResponseWithContinuationTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <paramref name="sourceValue"/> parameter to the <see cref="SkuResourceArrayResponseWithContinuation"/>
        /// type.
        /// </summary>
        ...
        /// <summary>
        /// Converts the <paramref name="sourceValue" /> parameter into an instance of <see cref="SkuResourceArrayResponseWithContinuation"
        /// />
        /// </summary>
        ...
        /// an instance of <see cref="SkuResourceArrayResponseWithContinuation" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ISkuResourceArrayResponseWithContinuation ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ISkuResourceArrayResponseWithContinuation).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
