...
namespace Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models
{
    ...
    public partial class ResourceProviderManagement
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderManagement.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderManagement.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IResourceProviderManagement FromJson(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonNode node)
        {
        ...
        internal ResourceProviderManagement(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonObject json)
        {
            ...
            {_schemaOwner = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray>("schemaOwners"), out var __jsonSchemaOwners) ? If( __jsonSchemaOwners as Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _schemaOwner;}
            {_manifestOwner = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray>("manifestOwners"), out var __jsonManifestOwners) ? If( __jsonManifestOwners as Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : _manifestOwner;}
            {_incidentRoutingService = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonString>("incidentRoutingService"), out var __jsonIncidentRoutingService) ? (string)__jsonIncidentRoutingService : (string)_incidentRoutingService;}
            {_incidentRoutingTeam = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonString>("incidentRoutingTeam"), out var __jsonIncidentRoutingTeam) ? (string)__jsonIncidentRoutingTeam : (string)_incidentRoutingTeam;}
            {_incidentContactEmail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonString>("incidentContactEmail"), out var __jsonIncidentContactEmail) ? (string)__jsonIncidentContactEmail : (string)_incidentContactEmail;}
            {_serviceTreeInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray>("serviceTreeInfos"), out var __jsonServiceTreeInfos) ? If( __jsonServiceTreeInfos as Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IServiceTreeInfo>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IServiceTreeInfo) (Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.ServiceTreeInfo.FromJson(__k) )) ))() : null : _serviceTreeInfo;}
            {_resourceAccessPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonString>("resourceAccessPolicy"), out var __jsonResourceAccessPolicy) ? (string)__jsonResourceAccessPolicy : (string)_resourceAccessPolicy;}
            {_resourceAccessRole = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray>("resourceAccessRoles"), out var __jsonResourceAccessRoles) ? If( __jsonResourceAccessRoles as Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IAny>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__g, (__f)=>(Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.IAny) (Microsoft.Azure.PowerShell.Cmdlets.ProviderHub.Models.Any.FromJson(__f) )) ))() : null : _resourceAccessRole;}
            AfterFromJson(json);
        }
