...
begin {
    try {
        ...
        $mapping = @{
            ...
            CreateViaJsonFilePath = 'Az.Orbital.private\New-AzOrbitalSpacecraft_CreateViaJsonFilePath';
            CreateViaJsonString = 'Az.Orbital.private\New-AzOrbitalSpacecraft_CreateViaJsonString';
        }
