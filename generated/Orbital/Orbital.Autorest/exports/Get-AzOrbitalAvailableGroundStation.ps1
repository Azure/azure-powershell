...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IAvailableGroundStation])]
...
param(
    ...
    [Parameter(Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.Orbital.PSArgumentCompleterAttribute("EarthObservation", "Communication")]
