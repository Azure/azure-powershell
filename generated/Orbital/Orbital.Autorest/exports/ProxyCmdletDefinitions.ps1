...
begin {
    try {
        ...
        $mapping = @{
            ...
            UpdateViaJsonFilePath = 'Az.Orbital.private\Update-AzOrbitalContactProfile_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.Orbital.private\Update-AzOrbitalContactProfile_UpdateViaJsonString';
        }
