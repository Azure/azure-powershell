...
namespace Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models
{
    ...
    public partial class ContactProfileLinkChannel :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IContactProfileLinkChannelInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IEndPoint _endPoint;

        /// <summary>
        /// Customer end point to store and retrieve data during a contact with the spacecraft.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Orbital.Origin(Microsoft.Azure.PowerShell.Cmdlets.Orbital.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IEndPoint EndPoint { get => (this._endPoint = this._endPoint ?? new Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.EndPoint()); set => this._endPoint = value; }
        ...
        public string EndPointIPAddress { get => ((Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IEndPointInternal)EndPoint).IPAddress; set => ((Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IEndPointInternal)EndPoint).IPAddress = value ; }

        /// <summary>Name of an end point.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Orbital.Origin(Microsoft.Azure.PowerShell.Cmdlets.Orbital.PropertyOrigin.Inlined)]
        public string EndPointName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IEndPointInternal)EndPoint).Name; set => ((Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IEndPointInternal)EndPoint).Name = value ; }

        /// <summary>TCP port to listen on to receive data.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Orbital.Origin(Microsoft.Azure.PowerShell.Cmdlets.Orbital.PropertyOrigin.Inlined)]
        public string EndPointPort { get => ((Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IEndPointInternal)EndPoint).Port; set => ((Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IEndPointInternal)EndPoint).Port = value ; }

        /// <summary>Protocol either UDP or TCP.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Orbital.Origin(Microsoft.Azure.PowerShell.Cmdlets.Orbital.PropertyOrigin.Inlined)]
        public string EndPointProtocol { get => ((Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IEndPointInternal)EndPoint).Protocol; set => ((Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IEndPointInternal)EndPoint).Protocol = value ; }

        /// <summary>Internal Acessors for EndPoint</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IEndPoint Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IContactProfileLinkChannelInternal.EndPoint { get => (this._endPoint = this._endPoint ?? new Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.EndPoint()); set { {_endPoint = value;} } }
...

    {
        ...
        /// Customer end point to store and retrieve data during a contact with the spacecraft.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IEndPoint EndPoint { get; set; }
        /// <summary>IP Address (IPv4).</summary>
        string EndPointIPAddress { get; set; }
        /// <summary>Name of an end point.</summary>
        string EndPointName { get; set; }
