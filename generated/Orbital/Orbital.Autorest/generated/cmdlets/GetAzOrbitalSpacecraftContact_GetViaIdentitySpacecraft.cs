...
namespace Microsoft.Azure.PowerShell.Cmdlets.Orbital.Cmdlets
{
    ...
    using Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Cmdlets;
    using System;

    /// <summary>Gets the specified contact in a specified resource group.</summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Orbital/spacecrafts/{spacecraftName}/contacts/{contactName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzOrbitalSpacecraftContact_GetViaIdentitySpacecraft")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IContact))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Description(@"Gets the specified contact in a specified resource group.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Orbital/spacecrafts/{spacecraftName}/contacts/{contactName}", ApiVersion = "2022-11-01")]
    public partial class GetAzOrbitalSpacecraftContact_GetViaIdentitySpacecraft : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.IEventListener,
        Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Contact name.")]
        ...
        [global::System.Management.Automation.Alias("ContactName")]
        ...
        /// </summary>
        public Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.HttpPipeline Pipeline { get; set; }
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IOrbitalIdentity SpacecraftInputObject { get => this._spacecraftInputObject; set => this._spacecraftInputObject = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IErrorResponse">Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IErrorResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IErrorResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IContact">Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IContact</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IContact> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzOrbitalSpacecraftContact_GetViaIdentitySpacecraft" /> cmdlet class.
        /// </summary>
        public GetAzOrbitalSpacecraftContact_GetViaIdentitySpacecraft()
        {
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Events.Progress:
                    {
                        var data = messageData();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                Pipeline = Microsoft.Azure.PowerShell.Cmdlets.Orbital.Module.Instance.CreatePipeline(InvocationInformation, __correlationId, __processRecordId, this.ParameterSetName, this.ExtensibleParameters);
                ...
                try
                {
                    ...
                    if (SpacecraftInputObject?.Id != null)
                    {
                        this.SpacecraftInputObject.Id += $"/contacts/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.ContactsGetViaIdentity(SpacecraftInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == SpacecraftInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("SpacecraftInputObject has null value for SpacecraftInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, SpacecraftInputObject) );
                        }
                        if (null == SpacecraftInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("SpacecraftInputObject has null value for SpacecraftInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, SpacecraftInputObject) );
                        }
                        if (null == SpacecraftInputObject.SpacecraftName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("SpacecraftInputObject has null value for SpacecraftInputObject.SpacecraftName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, SpacecraftInputObject) );
                        }
                        await this.Client.ContactsGet(SpacecraftInputObject.SubscriptionId ?? null, SpacecraftInputObject.ResourceGroupName ?? null, SpacecraftInputObject.SpacecraftName ?? null, Name, onOk, onDefault, this, Pipeline);
                    }
        ...
        {
            Microsoft.Azure.PowerShell.Cmdlets.Orbital.Module.Instance.SanitizeOutput?.Invoke(sendToPipeline, __correlationId);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IErrorResponse>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IContact> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IContact
