...
namespace Microsoft.Azure.PowerShell.Cmdlets.Orbital.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzOrbitalSpacecraftContact_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ContactsGet(ResourceGroupName, SubscriptionId, SpacecraftName, Name, onOk, onDefault, this, Pipeline);
