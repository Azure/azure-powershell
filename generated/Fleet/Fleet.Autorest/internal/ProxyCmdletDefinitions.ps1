...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IOperation
.Link
https://learn.microsoft.com/powershell/module/az.fleet/get-azfleetoperation
#>
function Get-AzFleetOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IOperation])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.Fleet.private\Get-AzFleetOperation_List';
        }
