...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.FleetsDelete(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.FleetName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzFleet_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
