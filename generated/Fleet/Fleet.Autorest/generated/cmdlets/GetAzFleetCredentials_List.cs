...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListCredentials=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/fleets/{fleetName}/listCredentials"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzFleetCredentials_List", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IFleetCredentialResults))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Fleet.Description(@"Lists the user credentials of a Fleet.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Fleet.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Fleet.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/fleets/{fleetName}/listCredentials", ApiVersion = "2023-10-15")]
    public partial class GetAzFleetCredentials_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IFleetCredentialResults">Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IFleetCredentialResults</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IFleetCredentialResults> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzFleetCredentials_List" /> cmdlet class.
        /// </summary>
        public GetAzFleetCredentials_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'FleetsListCredentials' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.FleetsListCredentials(SubscriptionId, ResourceGroupName, FleetName, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IFleetCredentialResults> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.IFleetCredentialResults
                var result = (await response);
                // response should be returning an array of some kind. +Pageable
                // nested-array / kubeconfigs / <none>
                if (null != result.Kubeconfig)
                {
                    if (0 == _responseSize && 1 == result.Kubeconfig.Count)
                    {
                        _firstResponse = result.Kubeconfig[0];
                        _responseSize = 1;
                    }
                    else
                    {
                        ...
                        foreach( var value in result.Kubeconfig )
                        {
