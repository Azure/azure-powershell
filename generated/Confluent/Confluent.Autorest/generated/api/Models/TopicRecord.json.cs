...
namespace Microsoft.Azure.PowerShell.Cmdlets.confluent.Models
{
    ...
    public partial class TopicRecord
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.confluent.Models.ITopicRecord.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.confluent.Models.ITopicRecord.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.confluent.Models.ITopicRecord FromJson(Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonObject json ? new TopicRecord(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="TopicRecord" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="TopicRecord" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonNode" />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonObject into a new instance of <see cref="TopicRecord" />.
        /// </summary>
        ...
        internal TopicRecord(Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.confluent.Models.TopicProperties.FromJson(__jsonProperties) : _property;}
            AfterFromJson(json);
        }
    }
}