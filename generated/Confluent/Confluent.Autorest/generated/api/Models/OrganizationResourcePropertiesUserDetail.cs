...
namespace Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models
{
    ...
    public partial class OrganizationResourcePropertiesUserDetail :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IOrganizationResourcePropertiesUserDetailInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IUserDetail" />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IUserDetail __userDetail = new Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.UserDetail();
        ...
        public string EmailAddress { get => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IUserDetailInternal)__userDetail).EmailAddress; set => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IUserDetailInternal)__userDetail).EmailAddress = value ?? null; }

        /// <summary>First name</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Origin(Microsoft.Azure.PowerShell.Cmdlets.Confluent.PropertyOrigin.Inherited)]
        public string FirstName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IUserDetailInternal)__userDetail).FirstName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IUserDetailInternal)__userDetail).FirstName = value ?? null; }

        /// <summary>Last name</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Origin(Microsoft.Azure.PowerShell.Cmdlets.Confluent.PropertyOrigin.Inherited)]
        public string LastName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IUserDetailInternal)__userDetail).LastName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IUserDetailInternal)__userDetail).LastName = value ?? null; }
