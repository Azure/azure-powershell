...
namespace Microsoft.Azure.PowerShell.Cmdlets.confluent.Models
{
    ...
    public partial class ListAccessRequestModel
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.confluent.Models.IListAccessRequestModel.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.confluent.Models.IListAccessRequestModel.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.confluent.Models.IListAccessRequestModel FromJson(Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonNode node)
        {
        ...
        internal ListAccessRequestModel(Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonObject json)
        {
            ...
            {_searchFilter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonObject>("searchFilters"), out var __jsonSearchFilters) ? Microsoft.Azure.PowerShell.Cmdlets.confluent.Models.ListAccessRequestModelSearchFilters.FromJson(__jsonSearchFilters) : _searchFilter;}
            AfterFromJson(json);
        }
