...
namespace Microsoft.Azure.PowerShell.Cmdlets.confluent.Models
{
    ...
    public partial class ListConnectorsSuccessResponse
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.confluent.Models.IListConnectorsSuccessResponse.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.confluent.Models.IListConnectorsSuccessResponse.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.confluent.Models.IListConnectorsSuccessResponse FromJson(Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonObject json ? new ListConnectorsSuccessResponse(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonObject into a new instance of <see cref="ListConnectorsSuccessResponse" />.
        /// </summary>
        ...
        internal ListConnectorsSuccessResponse(Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonObject json)
        {
            ...
            {_value = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonArray>("value"), out var __jsonValue) ? If( __jsonValue as Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.confluent.Models.IConnectorResource>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.confluent.Models.IConnectorResource) (Microsoft.Azure.PowerShell.Cmdlets.confluent.Models.ConnectorResource.FromJson(__u) )) ))() : null : _value;}
            {_nextLink = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonString>("nextLink"), out var __jsonNextLink) ? (string)__jsonNextLink : (string)_nextLink;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="ListConnectorsSuccessResponse" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ListConnectorsSuccessResponse" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.confluent.Runtime.Json.JsonNode" />.
        /// </returns>
