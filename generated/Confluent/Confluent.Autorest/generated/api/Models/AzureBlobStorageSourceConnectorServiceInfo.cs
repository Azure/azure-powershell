...
namespace Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models
{
    ...
    public partial class AzureBlobStorageSourceConnectorServiceInfo :
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IAzureBlobStorageSourceConnectorServiceInfo,
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IAzureBlobStorageSourceConnectorServiceInfoInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.IValidates
    {
        ...
        public string ConnectorServiceType { get => "AzureBlobStorageSourceConnector"; set => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IConnectorServiceTypeInfoBaseInternal)__connectorServiceTypeInfoBase).ConnectorServiceType = "AzureBlobStorageSourceConnector"; }

        /// <summary>Backing field for <see cref="StorageAccountKey" /> property.</summary>
        private System.Security.SecureString _storageAccountKey;
        ...
        public System.Security.SecureString StorageAccountKey { get => this._storageAccountKey; set => this._storageAccountKey = value; }
        ...
        {
            this.__connectorServiceTypeInfoBase.ConnectorServiceType = "AzureBlobStorageSourceConnector";
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IConnectorServiceTypeInfoBase
    {
        ...
        System.Security.SecureString StorageAccountKey { get; set; }
        /// <summary>Azure Blob Storage Account Name</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Info(
        Required = false,
        ReadOnly = false,
