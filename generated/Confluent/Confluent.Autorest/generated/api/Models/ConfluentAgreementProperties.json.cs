...
namespace Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models
{
    ...
    public partial class ConfluentAgreementProperties
    {
        ...
        internal ConfluentAgreementProperties(Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonObject json)
        {
            ...
            {_publisher = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonString>("publisher"), out var __jsonPublisher) ? (string)__jsonPublisher : (string)_publisher;}
            {_product = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonString>("product"), out var __jsonProduct) ? (string)__jsonProduct : (string)_product;}
            {_plan = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonString>("plan"), out var __jsonPlan) ? (string)__jsonPlan : (string)_plan;}
            {_licenseTextLink = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonString>("licenseTextLink"), out var __jsonLicenseTextLink) ? (string)__jsonLicenseTextLink : (string)_licenseTextLink;}
            {_privacyPolicyLink = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonString>("privacyPolicyLink"), out var __jsonPrivacyPolicyLink) ? (string)__jsonPrivacyPolicyLink : (string)_privacyPolicyLink;}
            ...
            {_signature = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonString>("signature"), out var __jsonSignature) ? (string)__jsonSignature : (string)_signature;}
            {_accepted = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonBoolean>("accepted"), out var __jsonAccepted) ? (bool?)__jsonAccepted : _accepted;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IConfluentAgreementProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IConfluentAgreementProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IConfluentAgreementProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode node)
        {
