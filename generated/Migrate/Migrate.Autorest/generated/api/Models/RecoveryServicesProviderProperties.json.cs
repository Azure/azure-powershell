...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class RecoveryServicesProviderProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IRecoveryServicesProviderProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IRecoveryServicesProviderProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IRecoveryServicesProviderProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
        ...
        internal RecoveryServicesProviderProperties(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_authenticationIdentityDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("authenticationIdentityDetails"), out var __jsonAuthenticationIdentityDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IdentityProviderDetails.FromJson(__jsonAuthenticationIdentityDetails) : _authenticationIdentityDetail;}
            {_resourceAccessIdentityDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("resourceAccessIdentityDetails"), out var __jsonResourceAccessIdentityDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IdentityProviderDetails.FromJson(__jsonResourceAccessIdentityDetails) : _resourceAccessIdentityDetail;}
            {_dataPlaneAuthenticationIdentityDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("dataPlaneAuthenticationIdentityDetails"), out var __jsonDataPlaneAuthenticationIdentityDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IdentityProviderDetails.FromJson(__jsonDataPlaneAuthenticationIdentityDetails) : _dataPlaneAuthenticationIdentityDetail;}
            {_providerVersionDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("providerVersionDetails"), out var __jsonProviderVersionDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.VersionDetails.FromJson(__jsonProviderVersionDetails) : _providerVersionDetail;}
            ...
            {_providerVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("providerVersion"), out var __jsonProviderVersion) ? (string)__jsonProviderVersion : (string)_providerVersion;}
            {_serverVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("serverVersion"), out var __jsonServerVersion) ? (string)__jsonServerVersion : (string)_serverVersion;}
            {_providerVersionState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("providerVersionState"), out var __jsonProviderVersionState) ? (string)__jsonProviderVersionState : (string)_providerVersionState;}
            {_providerVersionExpiryDate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("providerVersionExpiryDate"), out var __jsonProviderVersionExpiryDate) ? global::System.DateTime.TryParse((string)__jsonProviderVersionExpiryDate, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonProviderVersionExpiryDateValue) ? __jsonProviderVersionExpiryDateValue : _providerVersionExpiryDate : _providerVersionExpiryDate;}
            ...
            {_connectionStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("connectionStatus"), out var __jsonConnectionStatus) ? (string)__jsonConnectionStatus : (string)_connectionStatus;}
            ...
            {_allowedScenario = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("allowedScenarios"), out var __jsonAllowedScenarios) ? If( __jsonAllowedScenarios as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _allowedScenario;}
            {_healthErrorDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("healthErrorDetails"), out var __jsonHealthErrorDetails) ? If( __jsonHealthErrorDetails as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthError>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthError) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.HealthError.FromJson(__p) )) ))() : null : _healthErrorDetail;}
            {_draIdentifier = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("draIdentifier"), out var __jsonDraIdentifier) ? (string)__jsonDraIdentifier : (string)_draIdentifier;}
