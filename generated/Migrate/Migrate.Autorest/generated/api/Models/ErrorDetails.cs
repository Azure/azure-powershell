...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class ErrorDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorDetailsInternal.AgentErrorCode { get => this._agentErrorCode; set { {_agentErrorCode = value;} } }

        /// <summary>Internal Acessors for AgentErrorMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorDetailsInternal.AgentErrorMessage { get => this._agentErrorMessage; set { {_agentErrorMessage = value;} } }

        /// <summary>Internal Acessors for AgentErrorPossibleCaus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorDetailsInternal.AgentErrorPossibleCaus { get => this._agentErrorPossibleCaus; set { {_agentErrorPossibleCaus = value;} } }

        /// <summary>Internal Acessors for AgentErrorRecommendedAction</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorDetailsInternal.AgentErrorRecommendedAction { get => this._agentErrorRecommendedAction; set { {_agentErrorRecommendedAction = value;} } }

        /// <summary>Internal Acessors for Code</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorDetailsInternal.Code { get => this._code; set { {_code = value;} } }

        /// <summary>Internal Acessors for IsAgentReportedError</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorDetailsInternal.IsAgentReportedError { get => this._isAgentReportedError; set { {_isAgentReportedError = value;} } }

        /// <summary>Internal Acessors for Message</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorDetailsInternal.Message { get => this._message; set { {_message = value;} } }

        /// <summary>Internal Acessors for PossibleCaus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorDetailsInternal.PossibleCaus { get => this._possibleCaus; set { {_possibleCaus = value;} } }

        /// <summary>Internal Acessors for RecommendedAction</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorDetailsInternal.RecommendedAction { get => this._recommendedAction; set { {_recommendedAction = value;} } }

        /// <summary>Internal Acessors for Severity</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorDetailsInternal.Severity { get => this._severity; set { {_severity = value;} } }
