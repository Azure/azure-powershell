...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class SiteHealthSummary :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISiteHealthSummaryInternal
    {
        ...
        private System.Collections.Generic.List<string> _affectedResource;

        /// <summary>Affected resources.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> AffectedResource { get => this._affectedResource; set => this._affectedResource = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISiteHealthSummaryInternal.AffectedResourceType { get => this._affectedResourceType; set { {_affectedResourceType = value;} } }

        /// <summary>Internal Acessors for ApplianceName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISiteHealthSummaryInternal.ApplianceName { get => this._applianceName; set { {_applianceName = value;} } }

        /// <summary>Internal Acessors for ErrorCode</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISiteHealthSummaryInternal.ErrorCode { get => this._errorCode; set { {_errorCode = value;} } }

        /// <summary>Internal Acessors for ErrorId</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISiteHealthSummaryInternal.ErrorId { get => this._errorId; set { {_errorId = value;} } }

        /// <summary>Internal Acessors for ErrorMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISiteHealthSummaryInternal.ErrorMessage { get => this._errorMessage; set { {_errorMessage = value;} } }

        /// <summary>Internal Acessors for RemediationGuidance</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISiteHealthSummaryInternal.RemediationGuidance { get => this._remediationGuidance; set { {_remediationGuidance = value;} } }

        /// <summary>Internal Acessors for Severity</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISiteHealthSummaryInternal.Severity { get => this._severity; set { {_severity = value;} } }

        /// <summary>Internal Acessors for SummaryMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISiteHealthSummaryInternal.SummaryMessage { get => this._summaryMessage; set { {_summaryMessage = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<string> AffectedResource { get; set; }
        /// <summary>Affected resource type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = true,
