...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class InMageRcmDiscoveredProtectedVMDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmDiscoveredProtectedVMDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmDiscoveredProtectedVMDetailsInternal
    {
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmDiscoveredProtectedVMDetailsInternal.CreatedTimestamp { get => this._createdTimestamp; set { {_createdTimestamp = value;} } }

        /// <summary>Internal Acessors for Datastore</summary>
        System.Collections.Generic.List<string> Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmDiscoveredProtectedVMDetailsInternal.Datastore { get => this._datastore; set { {_datastore = value;} } }

        /// <summary>Internal Acessors for IPAddress</summary>
        System.Collections.Generic.List<string> Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmDiscoveredProtectedVMDetailsInternal.IPAddress { get => this._iPAddress; set { {_iPAddress = value;} } }

        /// <summary>Internal Acessors for IsDeleted</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmDiscoveredProtectedVMDetailsInternal.IsDeleted { get => this._isDeleted; set { {_isDeleted = value;} } }

        /// <summary>Internal Acessors for LastDiscoveryTimeInUtc</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmDiscoveredProtectedVMDetailsInternal.LastDiscoveryTimeInUtc { get => this._lastDiscoveryTimeInUtc; set { {_lastDiscoveryTimeInUtc = value;} } }

        /// <summary>Internal Acessors for OSName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmDiscoveredProtectedVMDetailsInternal.OSName { get => this._oSName; set { {_oSName = value;} } }

        /// <summary>Internal Acessors for PowerStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmDiscoveredProtectedVMDetailsInternal.PowerStatus { get => this._powerStatus; set { {_powerStatus = value;} } }

        /// <summary>Internal Acessors for UpdatedTimestamp</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmDiscoveredProtectedVMDetailsInternal.UpdatedTimestamp { get => this._updatedTimestamp; set { {_updatedTimestamp = value;} } }

        /// <summary>Internal Acessors for VCenterFqdn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmDiscoveredProtectedVMDetailsInternal.VCenterFqdn { get => this._vCenterFqdn; set { {_vCenterFqdn = value;} } }

        /// <summary>Internal Acessors for VCenterId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmDiscoveredProtectedVMDetailsInternal.VCenterId { get => this._vCenterId; set { {_vCenterId = value;} } }

        /// <summary>Internal Acessors for VMFqdn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmDiscoveredProtectedVMDetailsInternal.VMFqdn { get => this._vMFqdn; set { {_vMFqdn = value;} } }

        /// <summary>Internal Acessors for VmwareToolsStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmDiscoveredProtectedVMDetailsInternal.VmwareToolsStatus { get => this._vmwareToolsStatus; set { {_vmwareToolsStatus = value;} } }
