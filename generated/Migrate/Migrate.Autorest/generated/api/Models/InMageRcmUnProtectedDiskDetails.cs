...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class InMageRcmUnProtectedDiskDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmUnProtectedDiskDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmUnProtectedDiskDetailsInternal
    {
        ...
        long? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmUnProtectedDiskDetailsInternal.CapacityInByte { get => this._capacityInByte; set { {_capacityInByte = value;} } }

        /// <summary>Internal Acessors for DiskId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmUnProtectedDiskDetailsInternal.DiskId { get => this._diskId; set { {_diskId = value;} } }

        /// <summary>Internal Acessors for DiskName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmUnProtectedDiskDetailsInternal.DiskName { get => this._diskName; set { {_diskName = value;} } }
