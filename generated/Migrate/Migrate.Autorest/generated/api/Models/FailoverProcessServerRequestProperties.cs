...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class FailoverProcessServerRequestProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFailoverProcessServerRequestProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFailoverProcessServerRequestPropertiesInternal
    {
        ...
        private System.Collections.Generic.List<string> _vmsToMigrate;

        /// <summary>The VMS to migrate.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> VmsToMigrate { get => this._vmsToMigrate; set => this._vmsToMigrate = value; }
