...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class HyperVMigrateFabricModelCustomProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVMigrateFabricModelCustomProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVMigrateFabricModelCustomPropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IValidates
    {
        ...
        public string InstanceType { get => "HyperVMigrate"; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFabricModelCustomPropertiesInternal)__fabricModelCustomProperties).InstanceType = "HyperVMigrate"; }

        /// <summary>Internal Acessors for FabricContainerId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVMigrateFabricModelCustomPropertiesInternal.FabricContainerId { get => this._fabricContainerId; set { {_fabricContainerId = value;} } }

        /// <summary>Internal Acessors for FabricResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVMigrateFabricModelCustomPropertiesInternal.FabricResourceId { get => this._fabricResourceId; set { {_fabricResourceId = value;} } }

        /// <summary>Internal Acessors for MigrationHubUri</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVMigrateFabricModelCustomPropertiesInternal.MigrationHubUri { get => this._migrationHubUri; set { {_migrationHubUri = value;} } }
        ...
        {
            this.__fabricModelCustomProperties.InstanceType = "HyperVMigrate";
        }
