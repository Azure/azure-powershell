...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class AgentConfiguration
    {
        ...
        internal AgentConfiguration(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_dependencyAgentId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("dependencyAgentId"), out var __jsonDependencyAgentId) ? (string)__jsonDependencyAgentId : (string)_dependencyAgentId;}
            {_dependencyAgentVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("dependencyAgentVersion"), out var __jsonDependencyAgentVersion) ? (string)__jsonDependencyAgentVersion : (string)_dependencyAgentVersion;}
            {_dependencyAgentRevision = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("dependencyAgentRevision"), out var __jsonDependencyAgentRevision) ? (string)__jsonDependencyAgentRevision : (string)_dependencyAgentRevision;}
            ...
            {_clockGranularity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("clockGranularity"), out var __jsonClockGranularity) ? (int?)__jsonClockGranularity : _clockGranularity;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAgentConfiguration.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAgentConfiguration.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAgentConfiguration FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
