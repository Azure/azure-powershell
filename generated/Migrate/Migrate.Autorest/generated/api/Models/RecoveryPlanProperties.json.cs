...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class RecoveryPlanProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IRecoveryPlanProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IRecoveryPlanProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IRecoveryPlanProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
        ...
        internal RecoveryPlanProperties(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_replicationProvider = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("replicationProviders"), out var __jsonReplicationProviders) ? If( __jsonReplicationProviders as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _replicationProvider;}
            ...
            {_lastPlannedFailoverTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("lastPlannedFailoverTime"), out var __jsonLastPlannedFailoverTime) ? global::System.DateTime.TryParse((string)__jsonLastPlannedFailoverTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonLastPlannedFailoverTimeValue) ? __jsonLastPlannedFailoverTimeValue : _lastPlannedFailoverTime : _lastPlannedFailoverTime;}
            {_lastUnplannedFailoverTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("lastUnplannedFailoverTime"), out var __jsonLastUnplannedFailoverTime) ? global::System.DateTime.TryParse((string)__jsonLastUnplannedFailoverTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonLastUnplannedFailoverTimeValue) ? __jsonLastUnplannedFailoverTimeValue : _lastUnplannedFailoverTime : _lastUnplannedFailoverTime;}
            {_lastTestFailoverTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("lastTestFailoverTime"), out var __jsonLastTestFailoverTime) ? global::System.DateTime.TryParse((string)__jsonLastTestFailoverTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonLastTestFailoverTimeValue) ? __jsonLastTestFailoverTimeValue : _lastTestFailoverTime : _lastTestFailoverTime;}
            {_currentScenarioStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("currentScenarioStatus"), out var __jsonCurrentScenarioStatus) ? (string)__jsonCurrentScenarioStatus : (string)_currentScenarioStatus;}
            {_currentScenarioStatusDescription = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("currentScenarioStatusDescription"), out var __jsonCurrentScenarioStatusDescription) ? (string)__jsonCurrentScenarioStatusDescription : (string)_currentScenarioStatusDescription;}
            {_group = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("groups"), out var __jsonGroups) ? If( __jsonGroups as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IRecoveryPlanGroup>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IRecoveryPlanGroup) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.RecoveryPlanGroup.FromJson(__k) )) ))() : null : _group;}
            {_providerSpecificDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("providerSpecificDetails"), out var __jsonProviderSpecificDetails) ? If( __jsonProviderSpecificDetails as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IRecoveryPlanProviderSpecificDetails>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__g, (__f)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IRecoveryPlanProviderSpecificDetails) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.RecoveryPlanProviderSpecificDetails.FromJson(__f) )) ))() : null : _providerSpecificDetail;}
            AfterFromJson(json);
        }
