...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class InMageRcmFailbackEventDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackEventDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackEventDetailsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IValidates
    {
        ...
        public string InstanceType { get => "InMageRcmFailback"; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IEventProviderSpecificDetailsInternal)__eventProviderSpecificDetails).InstanceType = "InMageRcmFailback"; }

        /// <summary>Internal Acessors for ApplianceName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackEventDetailsInternal.ApplianceName { get => this._applianceName; set { {_applianceName = value;} } }

        /// <summary>Internal Acessors for ComponentDisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackEventDetailsInternal.ComponentDisplayName { get => this._componentDisplayName; set { {_componentDisplayName = value;} } }

        /// <summary>Internal Acessors for ProtectedItemName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackEventDetailsInternal.ProtectedItemName { get => this._protectedItemName; set { {_protectedItemName = value;} } }

        /// <summary>Internal Acessors for ServerType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackEventDetailsInternal.ServerType { get => this._serverType; set { {_serverType = value;} } }

        /// <summary>Internal Acessors for VMName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackEventDetailsInternal.VMName { get => this._vMName; set { {_vMName = value;} } }
        ...
        {
            this.__eventProviderSpecificDetails.InstanceType = "InMageRcmFailback";
        }
