...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class NetworkMappingProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.INetworkMappingProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.INetworkMappingProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.INetworkMappingProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
        ...
        internal NetworkMappingProperties(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_fabricSpecificSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("fabricSpecificSettings"), out var __jsonFabricSpecificSettings) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.NetworkMappingFabricSpecificSettings.FromJson(__jsonFabricSpecificSettings) : _fabricSpecificSetting;}
            {_state = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("state"), out var __jsonState) ? (string)__jsonState : (string)_state;}
            {_primaryNetworkFriendlyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("primaryNetworkFriendlyName"), out var __jsonPrimaryNetworkFriendlyName) ? (string)__jsonPrimaryNetworkFriendlyName : (string)_primaryNetworkFriendlyName;}
            {_primaryNetworkId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("primaryNetworkId"), out var __jsonPrimaryNetworkId) ? (string)__jsonPrimaryNetworkId : (string)_primaryNetworkId;}
            {_primaryFabricFriendlyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("primaryFabricFriendlyName"), out var __jsonPrimaryFabricFriendlyName) ? (string)__jsonPrimaryFabricFriendlyName : (string)_primaryFabricFriendlyName;}
            {_recoveryNetworkFriendlyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("recoveryNetworkFriendlyName"), out var __jsonRecoveryNetworkFriendlyName) ? (string)__jsonRecoveryNetworkFriendlyName : (string)_recoveryNetworkFriendlyName;}
            {_recoveryNetworkId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("recoveryNetworkId"), out var __jsonRecoveryNetworkId) ? (string)__jsonRecoveryNetworkId : (string)_recoveryNetworkId;}
            {_recoveryFabricArmId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("recoveryFabricArmId"), out var __jsonRecoveryFabricArmId) ? (string)__jsonRecoveryFabricArmId : (string)_recoveryFabricArmId;}
            {_recoveryFabricFriendlyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("recoveryFabricFriendlyName"), out var __jsonRecoveryFabricFriendlyName) ? (string)__jsonRecoveryFabricFriendlyName : (string)_recoveryFabricFriendlyName;}
            AfterFromJson(json);
        }
