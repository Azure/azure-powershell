...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class MigrateProjectProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateProjectPropertiesInternal
    {
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateProjectPropertiesInternal.LastSummaryRefreshedTime { get => this._lastSummaryRefreshedTime; set { {_lastSummaryRefreshedTime = value;} } }

        /// <summary>Internal Acessors for RefreshSummaryState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateProjectPropertiesInternal.RefreshSummaryState { get => this._refreshSummaryState; set { {_refreshSummaryState = value;} } }

        /// <summary>Internal Acessors for Summary</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateProjectPropertiesSummary Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateProjectPropertiesInternal.Summary { get => (this._summary = this._summary ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.MigrateProjectPropertiesSummary()); set { {_summary = value;} } }
        ...
        private System.Collections.Generic.List<string> _registeredTool;

        /// <summary>Gets or sets the list of tools registered with the migrate project.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> RegisteredTool { get => this._registeredTool; set => this._registeredTool = value; }

        /// <summary>Backing field for <see cref="Summary" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateProjectPropertiesSummary _summary;

        /// <summary>Gets the summary of the migrate project.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateProjectPropertiesSummary Summary { get => (this._summary = this._summary ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.MigrateProjectPropertiesSummary()); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> RegisteredTool { get; set; }
        /// <summary>Gets the summary of the migrate project.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateProjectPropertiesSummary) })]
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateProjectPropertiesSummary Summary { get;  }
...

    {
        ...
        System.Collections.Generic.List<string> RegisteredTool { get; set; }
        /// <summary>Gets the summary of the migrate project.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateProjectPropertiesSummary Summary { get; set; }
