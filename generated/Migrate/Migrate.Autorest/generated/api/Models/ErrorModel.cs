...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class ErrorModel :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorModel,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorModelInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorModelInternal.Caus { get => this._caus; set { {_caus = value;} } }

        /// <summary>Internal Acessors for Code</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorModelInternal.Code { get => this._code; set { {_code = value;} } }

        /// <summary>Internal Acessors for CreationTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorModelInternal.CreationTime { get => this._creationTime; set { {_creationTime = value;} } }

        /// <summary>Internal Acessors for Message</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorModelInternal.Message { get => this._message; set { {_message = value;} } }

        /// <summary>Internal Acessors for Recommendation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorModelInternal.Recommendation { get => this._recommendation; set { {_recommendation = value;} } }

        /// <summary>Internal Acessors for Severity</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorModelInternal.Severity { get => this._severity; set { {_severity = value;} } }

        /// <summary>Internal Acessors for Type</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorModelInternal.Type { get => this._type; set { {_type = value;} } }
