...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901
{
    ...
    public partial class HyperVToAzStackHciprotectedNicProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHyperVToAzStackHciprotectedNicProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHyperVToAzStackHciprotectedNicPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHyperVToAzStackHciprotectedNicPropertiesInternal.MacAddress { get => this._macAddress; set { {_macAddress = value;} } }

        /// <summary>Internal Acessors for NetworkName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHyperVToAzStackHciprotectedNicPropertiesInternal.NetworkName { get => this._networkName; set { {_networkName = value;} } }

        /// <summary>Internal Acessors for NicId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHyperVToAzStackHciprotectedNicPropertiesInternal.NicId { get => this._nicId; set { {_nicId = value;} } }

        /// <summary>Internal Acessors for SelectionTypeForFailover</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.VMNicSelection? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHyperVToAzStackHciprotectedNicPropertiesInternal.SelectionTypeForFailover { get => this._selectionTypeForFailover; set { {_selectionTypeForFailover = value;} } }

        /// <summary>Internal Acessors for TargetNetworkId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHyperVToAzStackHciprotectedNicPropertiesInternal.TargetNetworkId { get => this._targetNetworkId; set { {_targetNetworkId = value;} } }

        /// <summary>Internal Acessors for TestNetworkId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHyperVToAzStackHciprotectedNicPropertiesInternal.TestNetworkId { get => this._testNetworkId; set { {_testNetworkId = value;} } }
