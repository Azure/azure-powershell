...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901
{
    ...
    public partial class HealthErrorModel :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHealthErrorModel,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHealthErrorModelInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IInnerHealthErrorModel[] _childError;

        /// <summary>Gets or sets a list of child health errors associated with this error.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IInnerHealthErrorModel[] ChildError { get => this._childError; set => this._childError = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHealthErrorModelInternal.Category { get => this._category; set { {_category = value;} } }

        /// <summary>Internal Acessors for Caus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHealthErrorModelInternal.Caus { get => this._caus; set { {_caus = value;} } }

        /// <summary>Internal Acessors for Code</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHealthErrorModelInternal.Code { get => this._code; set { {_code = value;} } }

        /// <summary>Internal Acessors for CreationTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHealthErrorModelInternal.CreationTime { get => this._creationTime; set { {_creationTime = value;} } }

        /// <summary>Internal Acessors for HealthCategory</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHealthErrorModelInternal.HealthCategory { get => this._healthCategory; set { {_healthCategory = value;} } }

        /// <summary>Internal Acessors for IsCustomerResolvable</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHealthErrorModelInternal.IsCustomerResolvable { get => this._isCustomerResolvable; set { {_isCustomerResolvable = value;} } }

        /// <summary>Internal Acessors for Message</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHealthErrorModelInternal.Message { get => this._message; set { {_message = value;} } }

        /// <summary>Internal Acessors for Recommendation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHealthErrorModelInternal.Recommendation { get => this._recommendation; set { {_recommendation = value;} } }

        /// <summary>Internal Acessors for Severity</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHealthErrorModelInternal.Severity { get => this._severity; set { {_severity = value;} } }

        /// <summary>Internal Acessors for Source</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHealthErrorModelInternal.Source { get => this._source; set { {_source = value;} } }

        /// <summary>Internal Acessors for Summary</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IHealthErrorModelInternal.Summary { get => this._summary; set { {_summary = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IInnerHealthErrorModel) })]
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IInnerHealthErrorModel[] ChildError { get; set; }
        /// <summary>Gets or sets the error code.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = true,
