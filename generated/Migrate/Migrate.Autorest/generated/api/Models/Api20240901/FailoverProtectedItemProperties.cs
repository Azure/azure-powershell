...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901
{
    ...
    public partial class FailoverProtectedItemProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IFailoverProtectedItemProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IFailoverProtectedItemPropertiesInternal
    {

        /// <summary>Internal Acessors for NetworkName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IFailoverProtectedItemPropertiesInternal.NetworkName { get => this._networkName; set { {_networkName = value;} } }

        /// <summary>Internal Acessors for ProtectedItemName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IFailoverProtectedItemPropertiesInternal.ProtectedItemName { get => this._protectedItemName; set { {_protectedItemName = value;} } }

        /// <summary>Internal Acessors for RecoveryPointId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IFailoverProtectedItemPropertiesInternal.RecoveryPointId { get => this._recoveryPointId; set { {_recoveryPointId = value;} } }

        /// <summary>Internal Acessors for RecoveryPointTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IFailoverProtectedItemPropertiesInternal.RecoveryPointTime { get => this._recoveryPointTime; set { {_recoveryPointTime = value;} } }

        /// <summary>Internal Acessors for Subnet</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IFailoverProtectedItemPropertiesInternal.Subnet { get => this._subnet; set { {_subnet = value;} } }

        /// <summary>Internal Acessors for TestVMName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IFailoverProtectedItemPropertiesInternal.TestVMName { get => this._testVMName; set { {_testVMName = value;} } }

        /// <summary>Internal Acessors for VMName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IFailoverProtectedItemPropertiesInternal.VMName { get => this._vMName; set { {_vMName = value;} } }
