...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class JobQueryParameter :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IJobQueryParameter,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IJobQueryParameterInternal
    {
        ...
        private string _jobOutputType;

        /// <summary>The output type of the jobs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public string JobOutputType { get => this._jobOutputType; set => this._jobOutputType = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.PSArgumentCompleterAttribute("Json", "Xml", "Excel")]
        string JobOutputType { get; set; }
        /// <summary>The states of the job to be filtered can be in.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = false,
