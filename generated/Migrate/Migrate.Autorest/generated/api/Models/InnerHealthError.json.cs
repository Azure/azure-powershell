...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class InnerHealthError
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInnerHealthError.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInnerHealthError.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInnerHealthError FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
        ...
        internal InnerHealthError(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_errorSource = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("errorSource"), out var __jsonErrorSource) ? (string)__jsonErrorSource : (string)_errorSource;}
            {_errorType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("errorType"), out var __jsonErrorType) ? (string)__jsonErrorType : (string)_errorType;}
            ...
            {_errorCategory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("errorCategory"), out var __jsonErrorCategory) ? (string)__jsonErrorCategory : (string)_errorCategory;}
            ...
            {_creationTimeUtc = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("creationTimeUtc"), out var __jsonCreationTimeUtc) ? global::System.DateTime.TryParse((string)__jsonCreationTimeUtc, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonCreationTimeUtcValue) ? __jsonCreationTimeUtcValue : _creationTimeUtc : _creationTimeUtc;}
            {_recoveryProviderErrorMessage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("recoveryProviderErrorMessage"), out var __jsonRecoveryProviderErrorMessage) ? (string)__jsonRecoveryProviderErrorMessage : (string)_recoveryProviderErrorMessage;}
            {_entityId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("entityId"), out var __jsonEntityId) ? (string)__jsonEntityId : (string)_entityId;}
            {_errorId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("errorId"), out var __jsonErrorId) ? (string)__jsonErrorId : (string)_errorId;}
            {_customerResolvability = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("customerResolvability"), out var __jsonCustomerResolvability) ? (string)__jsonCustomerResolvability : (string)_customerResolvability;}
            AfterFromJson(json);
        }
