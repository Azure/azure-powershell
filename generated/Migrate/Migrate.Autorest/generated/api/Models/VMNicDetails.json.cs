...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class VMNicDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMNicDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMNicDetails.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMNicDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
        ...
        internal VMNicDetails(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_replicaNicId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("replicaNicId"), out var __jsonReplicaNicId) ? (string)__jsonReplicaNicId : (string)_replicaNicId;}
            {_sourceNicArmId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("sourceNicArmId"), out var __jsonSourceNicArmId) ? (string)__jsonSourceNicArmId : (string)_sourceNicArmId;}
            {_vMNetworkName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("vMNetworkName"), out var __jsonVMNetworkName) ? (string)__jsonVMNetworkName : (string)_vMNetworkName;}
            {_recoveryVMNetworkId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("recoveryVMNetworkId"), out var __jsonRecoveryVMNetworkId) ? (string)__jsonRecoveryVMNetworkId : (string)_recoveryVMNetworkId;}
            {_iPConfig = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("ipConfigs"), out var __jsonIPConfigs) ? If( __jsonIPConfigs as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IIPConfigDetails>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IIPConfigDetails) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IPConfigDetails.FromJson(__u) )) ))() : null : _iPConfig;}
            {_selectionType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("selectionType"), out var __jsonSelectionType) ? (string)__jsonSelectionType : (string)_selectionType;}
            {_recoveryNetworkSecurityGroupId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("recoveryNetworkSecurityGroupId"), out var __jsonRecoveryNetworkSecurityGroupId) ? (string)__jsonRecoveryNetworkSecurityGroupId : (string)_recoveryNetworkSecurityGroupId;}
            {_enableAcceleratedNetworkingOnRecovery = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonBoolean>("enableAcceleratedNetworkingOnRecovery"), out var __jsonEnableAcceleratedNetworkingOnRecovery) ? (bool?)__jsonEnableAcceleratedNetworkingOnRecovery : _enableAcceleratedNetworkingOnRecovery;}
            {_tfoVMNetworkId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("tfoVMNetworkId"), out var __jsonTfoVMNetworkId) ? (string)__jsonTfoVMNetworkId : (string)_tfoVMNetworkId;}
            {_tfoNetworkSecurityGroupId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("tfoNetworkSecurityGroupId"), out var __jsonTfoNetworkSecurityGroupId) ? (string)__jsonTfoNetworkSecurityGroupId : (string)_tfoNetworkSecurityGroupId;}
            {_enableAcceleratedNetworkingOnTfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonBoolean>("enableAcceleratedNetworkingOnTfo"), out var __jsonEnableAcceleratedNetworkingOnTfo) ? (bool?)__jsonEnableAcceleratedNetworkingOnTfo : _enableAcceleratedNetworkingOnTfo;}
            {_recoveryNicName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("recoveryNicName"), out var __jsonRecoveryNicName) ? (string)__jsonRecoveryNicName : (string)_recoveryNicName;}
            {_recoveryNicResourceGroupName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("recoveryNicResourceGroupName"), out var __jsonRecoveryNicResourceGroupName) ? (string)__jsonRecoveryNicResourceGroupName : (string)_recoveryNicResourceGroupName;}
            {_reuseExistingNic = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonBoolean>("reuseExistingNic"), out var __jsonReuseExistingNic) ? (bool?)__jsonReuseExistingNic : _reuseExistingNic;}
            {_tfoRecoveryNicName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("tfoRecoveryNicName"), out var __jsonTfoRecoveryNicName) ? (string)__jsonTfoRecoveryNicName : (string)_tfoRecoveryNicName;}
            {_tfoRecoveryNicResourceGroupName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("tfoRecoveryNicResourceGroupName"), out var __jsonTfoRecoveryNicResourceGroupName) ? (string)__jsonTfoRecoveryNicResourceGroupName : (string)_tfoRecoveryNicResourceGroupName;}
            {_tfoReuseExistingNic = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonBoolean>("tfoReuseExistingNic"), out var __jsonTfoReuseExistingNic) ? (bool?)__jsonTfoReuseExistingNic : _tfoReuseExistingNic;}
            {_targetNicName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("targetNicName"), out var __jsonTargetNicName) ? (string)__jsonTargetNicName : (string)_targetNicName;}
            AfterFromJson(json);
        }
    }
}