...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class WebApplication :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IWebApplication,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IWebApplicationInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IWebApplicationInternal.ApplicationPool { get => this._applicationPool; set { {_applicationPool = value;} } }

        /// <summary>Internal Acessors for GroupName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IWebApplicationInternal.GroupName { get => this._groupName; set { {_groupName = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IWebApplicationInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Platform</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IWebApplicationInternal.Platform { get => this._platform; set { {_platform = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IWebApplicationInternal.Status { get => this._status; set { {_status = value;} } }

        /// <summary>Internal Acessors for WebServer</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IWebApplicationInternal.WebServer { get => this._webServer; set { {_webServer = value;} } }
