...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class HyperVClusterProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVClusterProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVClusterPropertiesInternal
    {
        ...
        private System.Collections.Generic.List<string> _hostFqdnList;

        /// <summary>List of hosts (FQDN) currently being tracked by the cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> HostFqdnList { get => this._hostFqdnList; set => this._hostFqdnList = value; }

        /// <summary>Internal Acessors for CreatedTimestamp</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVClusterPropertiesInternal.CreatedTimestamp { get => this._createdTimestamp; set { {_createdTimestamp = value;} } }

        /// <summary>Internal Acessors for Error</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthErrorDetails> Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVClusterPropertiesInternal.Error { get => this._error; set { {_error = value;} } }

        /// <summary>Internal Acessors for FunctionalLevel</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVClusterPropertiesInternal.FunctionalLevel { get => this._functionalLevel; set { {_functionalLevel = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVClusterPropertiesInternal.Status { get => this._status; set { {_status = value;} } }

        /// <summary>Internal Acessors for UpdatedTimestamp</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVClusterPropertiesInternal.UpdatedTimestamp { get => this._updatedTimestamp; set { {_updatedTimestamp = value;} } }
