...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class ProtectionContainerMappingProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IProtectionContainerMappingProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IProtectionContainerMappingProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IProtectionContainerMappingProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
        ...
        internal ProtectionContainerMappingProperties(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_targetProtectionContainerFriendlyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("targetProtectionContainerFriendlyName"), out var __jsonTargetProtectionContainerFriendlyName) ? (string)__jsonTargetProtectionContainerFriendlyName : (string)_targetProtectionContainerFriendlyName;}
            {_providerSpecificDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("providerSpecificDetails"), out var __jsonProviderSpecificDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ProtectionContainerMappingProviderSpecificDetails.FromJson(__jsonProviderSpecificDetails) : _providerSpecificDetail;}
            ...
            {_sourceProtectionContainerFriendlyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("sourceProtectionContainerFriendlyName"), out var __jsonSourceProtectionContainerFriendlyName) ? (string)__jsonSourceProtectionContainerFriendlyName : (string)_sourceProtectionContainerFriendlyName;}
            {_sourceFabricFriendlyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("sourceFabricFriendlyName"), out var __jsonSourceFabricFriendlyName) ? (string)__jsonSourceFabricFriendlyName : (string)_sourceFabricFriendlyName;}
            {_targetFabricFriendlyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("targetFabricFriendlyName"), out var __jsonTargetFabricFriendlyName) ? (string)__jsonTargetFabricFriendlyName : (string)_targetFabricFriendlyName;}
