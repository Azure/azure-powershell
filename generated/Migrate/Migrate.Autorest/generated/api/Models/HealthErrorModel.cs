...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class HealthErrorModel :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthErrorModel,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthErrorModelInternal
    {

        /// <summary>Backing field for <see cref="AffectedResourceCorrelationId" /> property.</summary>
        private System.Collections.Generic.List<string> _affectedResourceCorrelationId;
        ...
        public System.Collections.Generic.List<string> AffectedResourceCorrelationId { get => this._affectedResourceCorrelationId; set => this._affectedResourceCorrelationId = value; }
        ...
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInnerHealthErrorModel> _childError;

        /// <summary>Gets or sets a list of child health errors associated with this error.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInnerHealthErrorModel> ChildError { get => this._childError; set => this._childError = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthErrorModelInternal.Category { get => this._category; set { {_category = value;} } }

        /// <summary>Internal Acessors for Caus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthErrorModelInternal.Caus { get => this._caus; set { {_caus = value;} } }

        /// <summary>Internal Acessors for Code</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthErrorModelInternal.Code { get => this._code; set { {_code = value;} } }

        /// <summary>Internal Acessors for CreationTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthErrorModelInternal.CreationTime { get => this._creationTime; set { {_creationTime = value;} } }

        /// <summary>Internal Acessors for HealthCategory</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthErrorModelInternal.HealthCategory { get => this._healthCategory; set { {_healthCategory = value;} } }

        /// <summary>Internal Acessors for IsCustomerResolvable</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthErrorModelInternal.IsCustomerResolvable { get => this._isCustomerResolvable; set { {_isCustomerResolvable = value;} } }

        /// <summary>Internal Acessors for Message</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthErrorModelInternal.Message { get => this._message; set { {_message = value;} } }

        /// <summary>Internal Acessors for Recommendation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthErrorModelInternal.Recommendation { get => this._recommendation; set { {_recommendation = value;} } }

        /// <summary>Internal Acessors for Severity</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthErrorModelInternal.Severity { get => this._severity; set { {_severity = value;} } }

        /// <summary>Internal Acessors for Source</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthErrorModelInternal.Source { get => this._source; set { {_source = value;} } }

        /// <summary>Internal Acessors for Summary</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthErrorModelInternal.Summary { get => this._summary; set { {_summary = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<string> AffectedResourceCorrelationId { get; set; }
        /// <summary>Gets or sets the type of affected resource type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInnerHealthErrorModel) })]
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInnerHealthErrorModel> ChildError { get; set; }
        /// <summary>Gets or sets the error code.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = true,
