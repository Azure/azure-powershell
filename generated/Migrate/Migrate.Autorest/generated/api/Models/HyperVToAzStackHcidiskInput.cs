...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class HyperVToAzStackHcidiskInput :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHcidiskInput,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHcidiskInputInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDiskControllerInputs _diskController;

        /// <summary>Disk controller.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDiskControllerInputs DiskController { get => (this._diskController = this._diskController ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.DiskControllerInputs()); set => this._diskController = value; }

        /// <summary>Gets or sets the controller ID.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public int? DiskControllerId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDiskControllerInputsInternal)DiskController).ControllerId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDiskControllerInputsInternal)DiskController).ControllerId = value ?? default(int); }

        /// <summary>Gets or sets the controller Location.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public int? DiskControllerLocation { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDiskControllerInputsInternal)DiskController).ControllerLocation; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDiskControllerInputsInternal)DiskController).ControllerLocation = value ?? default(int); }

        /// <summary>Gets or sets the controller name (IDE,SCSI).</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public string DiskControllerName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDiskControllerInputsInternal)DiskController).ControllerName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDiskControllerInputsInternal)DiskController).ControllerName = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDiskControllerInputs Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHcidiskInputInternal.DiskController { get => (this._diskController = this._diskController ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.DiskControllerInputs()); set { {_diskController = value;} } }
...

    {
        ...
        long? DiskBlockSize { get; set; }
        /// <summary>Disk controller.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDiskControllerInputs DiskController { get; set; }
        /// <summary>Gets or sets the controller ID.</summary>
        int? DiskControllerId { get; set; }
        /// <summary>Gets or sets the controller Location.</summary>
        int? DiskControllerLocation { get; set; }
