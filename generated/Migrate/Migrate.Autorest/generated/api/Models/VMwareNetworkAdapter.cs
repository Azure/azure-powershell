...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class VMwareNetworkAdapter :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareNetworkAdapter,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareNetworkAdapterInternal
    {
        ...
        public System.Collections.Generic.List<string> IPAddressList { get => this._iPAddressList; }
        ...
        System.Collections.Generic.List<string> Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareNetworkAdapterInternal.IPAddressList { get => this._iPAddressList; set { {_iPAddressList = value;} } }

        /// <summary>Internal Acessors for IPAddressType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareNetworkAdapterInternal.IPAddressType { get => this._iPAddressType; set { {_iPAddressType = value;} } }

        /// <summary>Internal Acessors for Label</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareNetworkAdapterInternal.Label { get => this._label; set { {_label = value;} } }

        /// <summary>Internal Acessors for MacAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareNetworkAdapterInternal.MacAddress { get => this._macAddress; set { {_macAddress = value;} } }

        /// <summary>Internal Acessors for NetworkName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareNetworkAdapterInternal.NetworkName { get => this._networkName; set { {_networkName = value;} } }

        /// <summary>Internal Acessors for NicId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareNetworkAdapterInternal.NicId { get => this._nicId; set { {_nicId = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<string> IPAddressList { get;  }
        /// <summary>Type of the IP address.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = true,
    ...
    {
        /// <summary>IP addresses for the machine.</summary>
        System.Collections.Generic.List<string> IPAddressList { get; set; }
        /// <summary>Type of the IP address.</summary>
