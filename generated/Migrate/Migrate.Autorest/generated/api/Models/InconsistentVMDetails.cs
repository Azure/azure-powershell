...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class InconsistentVMDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInconsistentVMDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInconsistentVMDetailsInternal
    {
        ...
        private System.Collections.Generic.List<string> _detail;

        /// <summary>The list of details regarding state of the Protected Entity in SRS and On prem.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> Detail { get => this._detail; set => this._detail = value; }

        /// <summary>Backing field for <see cref="ErrorId" /> property.</summary>
        private System.Collections.Generic.List<string> _errorId;

        /// <summary>The list of error ids.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> ErrorId { get => this._errorId; set => this._errorId = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> Detail { get; set; }
        /// <summary>The list of error ids.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> ErrorId { get; set; }
        /// <summary>The Vm name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = false,
