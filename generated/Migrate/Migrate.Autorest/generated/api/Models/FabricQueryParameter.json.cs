...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class FabricQueryParameter
    {
        ...
        internal FabricQueryParameter(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_zoneToZoneMapping = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("zoneToZoneMappings"), out var __jsonZoneToZoneMappings) ? (string)__jsonZoneToZoneMappings : (string)_zoneToZoneMapping;}
            {_extendedLocationMapping = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("extendedLocationMappings"), out var __jsonExtendedLocationMappings) ? (string)__jsonExtendedLocationMappings : (string)_extendedLocationMapping;}
            {_locationDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("locationDetails"), out var __jsonLocationDetails) ? (string)__jsonLocationDetails : (string)_locationDetail;}
            {_fetchAgentDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("fetchAgentDetails"), out var __jsonFetchAgentDetails) ? (string)__jsonFetchAgentDetails : (string)_fetchAgentDetail;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFabricQueryParameter.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFabricQueryParameter.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFabricQueryParameter FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
