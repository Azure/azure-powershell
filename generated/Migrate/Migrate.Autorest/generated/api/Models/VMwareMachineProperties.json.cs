...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class VMwareMachineProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareMachineProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareMachineProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareMachineProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
        ...
        internal VMwareMachineProperties(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_appsAndRole = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("appsAndRoles"), out var __jsonAppsAndRoles) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.AppsAndRoles.FromJson(__jsonAppsAndRoles) : _appsAndRole;}
            {_operatingSystemDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("operatingSystemDetails"), out var __jsonOperatingSystemDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.OperatingSystem.FromJson(__jsonOperatingSystemDetails) : _operatingSystemDetail;}
            {_guestOSDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("guestOSDetails"), out var __jsonGuestOSDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.GuestOSDetails.FromJson(__jsonGuestOSDetails) : _guestOSDetail;}
            {_dataCenterScope = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("dataCenterScope"), out var __jsonDataCenterScope) ? (string)__jsonDataCenterScope : (string)_dataCenterScope;}
            {_firmware = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("firmware"), out var __jsonFirmware) ? (string)__jsonFirmware : (string)_firmware;}
            ...
            {_changeTrackingSupported = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonBoolean>("changeTrackingSupported"), out var __jsonChangeTrackingSupported) ? (bool?)__jsonChangeTrackingSupported : _changeTrackingSupported;}
            {_changeTrackingEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonBoolean>("changeTrackingEnabled"), out var __jsonChangeTrackingEnabled) ? (bool?)__jsonChangeTrackingEnabled : _changeTrackingEnabled;}
            {_maxSnapshot = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("maxSnapshots"), out var __jsonMaxSnapshots) ? (int?)__jsonMaxSnapshots : _maxSnapshot;}
            {_disk = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("disks"), out var __jsonDisks) ? If( __jsonDisks as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareDisk>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareDisk) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.VMwareDisk.FromJson(__u) )) ))() : null : _disk;}
            {_hostInMaintenanceMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonBoolean>("hostInMaintenanceMode"), out var __jsonHostInMaintenanceMode) ? (bool?)__jsonHostInMaintenanceMode : _hostInMaintenanceMode;}
            ...
            {_hostPowerState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("hostPowerState"), out var __jsonHostPowerState) ? (string)__jsonHostPowerState : (string)_hostPowerState;}
            {_hostVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("hostVersion"), out var __jsonHostVersion) ? (string)__jsonHostVersion : (string)_hostVersion;}
            {_networkAdapter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("networkAdapters"), out var __jsonNetworkAdapters) ? If( __jsonNetworkAdapters as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareNetworkAdapter>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareNetworkAdapter) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.VMwareNetworkAdapter.FromJson(__p) )) ))() : null : _networkAdapter;}
            {_dependencyMapping = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("dependencyMapping"), out var __jsonDependencyMapping) ? (string)__jsonDependencyMapping : (string)_dependencyMapping;}
            {_dependencyMappingStartTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("dependencyMappingStartTime"), out var __jsonDependencyMappingStartTime) ? global::System.DateTime.TryParse((string)__jsonDependencyMappingStartTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonDependencyMappingStartTimeValue) ? __jsonDependencyMappingStartTimeValue : _dependencyMappingStartTime : _dependencyMappingStartTime;}
            ...
            {_numberOfProcessorCore = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("numberOfProcessorCore"), out var __jsonNumberOfProcessorCore) ? (int?)__jsonNumberOfProcessorCore : _numberOfProcessorCore;}
            ...
            {_vMConfigurationFileLocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("vmConfigurationFileLocation"), out var __jsonVMConfigurationFileLocation) ? (string)__jsonVMConfigurationFileLocation : (string)_vMConfigurationFileLocation;}
            {_numberOfApplication = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("numberOfApplications"), out var __jsonNumberOfApplications) ? (int?)__jsonNumberOfApplications : _numberOfApplication;}
            {_guestDetailsDiscoveryTimestamp = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("guestDetailsDiscoveryTimestamp"), out var __jsonGuestDetailsDiscoveryTimestamp) ? global::System.DateTime.TryParse((string)__jsonGuestDetailsDiscoveryTimestamp, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonGuestDetailsDiscoveryTimestampValue) ? __jsonGuestDetailsDiscoveryTimestampValue : _guestDetailsDiscoveryTimestamp : _guestDetailsDiscoveryTimestamp;}
            {_isGuestDetailsDiscoveryInProgress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonBoolean>("isGuestDetailsDiscoveryInProgress"), out var __jsonIsGuestDetailsDiscoveryInProgress) ? (bool?)__jsonIsGuestDetailsDiscoveryInProgress : _isGuestDetailsDiscoveryInProgress;}
            ...
            {_biosSerialNumber = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("biosSerialNumber"), out var __jsonBiosSerialNumber) ? (string)__jsonBiosSerialNumber : (string)_biosSerialNumber;}
            {_biosGuid = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("biosGuid"), out var __jsonBiosGuid) ? (string)__jsonBiosGuid : (string)_biosGuid;}
            ...
            {_error = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("errors"), out var __jsonErrors) ? If( __jsonErrors as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthErrorDetails>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthErrorDetails) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.HealthErrorDetails.FromJson(__k) )) ))() : null : _error;}
            AfterFromJson(json);
        }
    }
}