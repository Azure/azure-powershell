...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class HyperVDisk :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVDisk,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVDiskInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVDiskInternal.DiskType { get => this._diskType; set { {_diskType = value;} } }

        /// <summary>Internal Acessors for InstanceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVDiskInternal.InstanceId { get => this._instanceId; set { {_instanceId = value;} } }

        /// <summary>Internal Acessors for Lun</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVDiskInternal.Lun { get => this._lun; set { {_lun = value;} } }

        /// <summary>Internal Acessors for MaxSizeInByte</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVDiskInternal.MaxSizeInByte { get => this._maxSizeInByte; set { {_maxSizeInByte = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVDiskInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Path</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVDiskInternal.Path { get => this._path; set { {_path = value;} } }

        /// <summary>Internal Acessors for VhdId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVDiskInternal.VhdId { get => this._vhdId; set { {_vhdId = value;} } }
