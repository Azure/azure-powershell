...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class AgentDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAgentDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAgentDetailsInternal
    {
        ...
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAgentDiskDetails> _disk;

        /// <summary>The disks.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAgentDiskDetails> Disk { get => this._disk; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAgentDetailsInternal.AgentId { get => this._agentId; set { {_agentId = value;} } }

        /// <summary>Internal Acessors for BiosId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAgentDetailsInternal.BiosId { get => this._biosId; set { {_biosId = value;} } }

        /// <summary>Internal Acessors for Disk</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAgentDiskDetails> Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAgentDetailsInternal.Disk { get => this._disk; set { {_disk = value;} } }

        /// <summary>Internal Acessors for Fqdn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAgentDetailsInternal.Fqdn { get => this._fqdn; set { {_fqdn = value;} } }

        /// <summary>Internal Acessors for MachineId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAgentDetailsInternal.MachineId { get => this._machineId; set { {_machineId = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAgentDiskDetails) })]
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAgentDiskDetails> Disk { get;  }
        /// <summary>The machine FQDN.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        /// <summary>The disks.</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAgentDiskDetails> Disk { get; set; }
        /// <summary>The machine FQDN.</summary>
        string Fqdn { get; set; }
        /// <summary>The Id of the machine to which the agent is registered.</summary>
