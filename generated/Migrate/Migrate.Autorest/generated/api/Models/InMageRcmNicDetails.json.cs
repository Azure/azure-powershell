...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class InMageRcmNicDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmNicDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmNicDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmNicDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
        ...
        internal InMageRcmNicDetails(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_sourceIPAddressType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("sourceIPAddressType"), out var __jsonSourceIPAddressType) ? (string)__jsonSourceIPAddressType : (string)_sourceIPAddressType;}
            {_sourceNetworkId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("sourceNetworkId"), out var __jsonSourceNetworkId) ? (string)__jsonSourceNetworkId : (string)_sourceNetworkId;}
            {_sourceSubnetName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("sourceSubnetName"), out var __jsonSourceSubnetName) ? (string)__jsonSourceSubnetName : (string)_sourceSubnetName;}
            {_targetIPAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("targetIPAddress"), out var __jsonTargetIPAddress) ? (string)__jsonTargetIPAddress : (string)_targetIPAddress;}
            {_targetIPAddressType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("targetIPAddressType"), out var __jsonTargetIPAddressType) ? (string)__jsonTargetIPAddressType : (string)_targetIPAddressType;}
            ...
            {_testIPAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("testIPAddress"), out var __jsonTestIPAddress) ? (string)__jsonTestIPAddress : (string)_testIPAddress;}
            {_testIPAddressType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("testIPAddressType"), out var __jsonTestIPAddressType) ? (string)__jsonTestIPAddressType : (string)_testIPAddressType;}
