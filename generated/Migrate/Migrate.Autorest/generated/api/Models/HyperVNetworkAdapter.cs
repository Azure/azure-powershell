...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class HyperVNetworkAdapter :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVNetworkAdapter,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVNetworkAdapterInternal
    {
        ...
        System.Collections.Generic.List<string> Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVNetworkAdapterInternal.IPAddressList { get => this._iPAddressList; set { {_iPAddressList = value;} } }

        /// <summary>Internal Acessors for IPAddressType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVNetworkAdapterInternal.IPAddressType { get => this._iPAddressType; set { {_iPAddressType = value;} } }

        /// <summary>Internal Acessors for MacAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVNetworkAdapterInternal.MacAddress { get => this._macAddress; set { {_macAddress = value;} } }

        /// <summary>Internal Acessors for NetworkId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVNetworkAdapterInternal.NetworkId { get => this._networkId; set { {_networkId = value;} } }

        /// <summary>Internal Acessors for NetworkName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVNetworkAdapterInternal.NetworkName { get => this._networkName; set { {_networkName = value;} } }

        /// <summary>Internal Acessors for NicId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVNetworkAdapterInternal.NicId { get => this._nicId; set { {_nicId = value;} } }

        /// <summary>Internal Acessors for NicType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVNetworkAdapterInternal.NicType { get => this._nicType; set { {_nicType = value;} } }

        /// <summary>Internal Acessors for StaticIPAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVNetworkAdapterInternal.StaticIPAddress { get => this._staticIPAddress; set { {_staticIPAddress = value;} } }

        /// <summary>Internal Acessors for SubnetName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVNetworkAdapterInternal.SubnetName { get => this._subnetName; set { {_subnetName = value;} } }
