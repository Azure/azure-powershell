...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801
{
    ...
    public partial class ExistingRecoveryAvailabilitySet :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IExistingRecoveryAvailabilitySet,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IExistingRecoveryAvailabilitySetInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IRecoveryAvailabilitySetCustomDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IRecoveryAvailabilitySetCustomDetails __recoveryAvailabilitySetCustomDetails = new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.RecoveryAvailabilitySetCustomDetails();
        ...
        public string ResourceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IRecoveryAvailabilitySetCustomDetailsInternal)__recoveryAvailabilitySetCustomDetails).ResourceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IRecoveryAvailabilitySetCustomDetailsInternal)__recoveryAvailabilitySetCustomDetails).ResourceType = value ; }
    ...
    public partial interface IExistingRecoveryAvailabilitySet :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IRecoveryAvailabilitySetCustomDetails
    {
        /// <summary>The recovery availability set Id. Will throw error, if resource does not exist.</summary>
    ...
    internal partial interface IExistingRecoveryAvailabilitySetInternal :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IRecoveryAvailabilitySetCustomDetailsInternal
    {
        /// <summary>The recovery availability set Id. Will throw error, if resource does not exist.</summary>
        string RecoveryAvailabilitySetId { get; set; }
