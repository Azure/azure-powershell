...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801
{
    ...
    public partial class JobDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IJobDetails.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IJobDetails interface is polymorphic, and the
        /// precise model class that will get deserialized is determined at runtime based on the payload.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IJobDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IJobDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("instanceType") )
            {
                ...
                {
                    return new ClusterFailoverJobDetails(json);
                }
                case "ClusterSwitchProtectionJobDetails":
                {
                    return new ClusterSwitchProtectionJobDetails(json);
                }
                case "ClusterTestFailoverJobDetails":
                {
                    return new ClusterTestFailoverJobDetails(json);
                }
        ...
        internal JobDetails(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_affectedObjectDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("affectedObjectDetails"), out var __jsonAffectedObjectDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.JobDetailsAffectedObjectDetails.FromJson(__jsonAffectedObjectDetails) : AffectedObjectDetail;}
            AfterFromJson(json);
        }
