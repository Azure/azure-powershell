...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801
{
    ...
    public partial class FabricQueryParameter :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IFabricQueryParameter,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IFabricQueryParameterInternal
    {
        ...
        /// <summary>Backing field for <see cref="ExtendedLocationMapping" /> property.</summary>
        private string _extendedLocationMapping;

        /// <summary>A value indicating whether the Extended Location mappings are to be returned.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public string ExtendedLocationMapping { get => this._extendedLocationMapping; set => this._extendedLocationMapping = value; }
        ...
        /// <summary>A value indicating whether the location details are to be returned.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public string LocationDetail { get => this._locationDetail; set => this._locationDetail = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string ExtendedLocationMapping { get; set; }
        /// <summary>A value indicating whether the agent details are to be fetched.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = false,
