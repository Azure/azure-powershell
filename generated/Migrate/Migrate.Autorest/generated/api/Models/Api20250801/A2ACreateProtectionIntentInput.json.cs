...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801
{
    ...
    public partial class A2ACreateProtectionIntentInput
    {
        ...
        internal A2ACreateProtectionIntentInput(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            __createProtectionIntentProviderSpecificDetails = new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.CreateProtectionIntentProviderSpecificDetails(json);
            {_protectionProfileCustomInput = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("protectionProfileCustomInput"), out var __jsonProtectionProfileCustomInput) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.ProtectionProfileCustomDetails.FromJson(__jsonProtectionProfileCustomInput) : ProtectionProfileCustomInput;}
            ...
            {_recoveryAvailabilitySetCustomInput = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("recoveryAvailabilitySetCustomInput"), out var __jsonRecoveryAvailabilitySetCustomInput) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.RecoveryAvailabilitySetCustomDetails.FromJson(__jsonRecoveryAvailabilitySetCustomInput) : RecoveryAvailabilitySetCustomInput;}
            {_recoveryVirtualNetworkCustomInput = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("recoveryVirtualNetworkCustomInput"), out var __jsonRecoveryVirtualNetworkCustomInput) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.RecoveryVirtualNetworkCustomDetails.FromJson(__jsonRecoveryVirtualNetworkCustomInput) : RecoveryVirtualNetworkCustomInput;}
            {_recoveryProximityPlacementGroupCustomInput = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("recoveryProximityPlacementGroupCustomInput"), out var __jsonRecoveryProximityPlacementGroupCustomInput) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.RecoveryProximityPlacementGroupCustomDetails.FromJson(__jsonRecoveryProximityPlacementGroupCustomInput) : RecoveryProximityPlacementGroupCustomInput;}
            {_recoveryBootDiagStorageAccount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("recoveryBootDiagStorageAccount"), out var __jsonRecoveryBootDiagStorageAccount) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.StorageAccountCustomDetails.FromJson(__jsonRecoveryBootDiagStorageAccount) : RecoveryBootDiagStorageAccount;}
            ...
            {_vMDisk = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("vmDisks"), out var __jsonVMDisks) ? If( __jsonVMDisks as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IA2AProtectionIntentDiskInputDetails[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IA2AProtectionIntentDiskInputDetails) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.A2AProtectionIntentDiskInputDetails.FromJson(__u) )) ))() : null : VMDisk;}
            {_vMManagedDisk = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("vmManagedDisks"), out var __jsonVMManagedDisks) ? If( __jsonVMManagedDisks as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IA2AProtectionIntentManagedDiskInputDetails[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IA2AProtectionIntentManagedDiskInputDetails) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.A2AProtectionIntentManagedDiskInputDetails.FromJson(__p) )) ))() : null : VMManagedDisk;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IA2ACreateProtectionIntentInput.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IA2ACreateProtectionIntentInput.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IA2ACreateProtectionIntentInput FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
