...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class ExchangeServer :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IExchangeServer,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IExchangeServerInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IExchangeServerInternal.Edition { get => this._edition; set { {_edition = value;} } }

        /// <summary>Internal Acessors for ProductName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IExchangeServerInternal.ProductName { get => this._productName; set { {_productName = value;} } }

        /// <summary>Internal Acessors for Role</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IExchangeServerInternal.Role { get => this._role; set { {_role = value;} } }

        /// <summary>Internal Acessors for ServicePack</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IExchangeServerInternal.ServicePack { get => this._servicePack; set { {_servicePack = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IExchangeServerInternal.Version { get => this._version; set { {_version = value;} } }
