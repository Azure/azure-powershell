...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class ReplicationProtectedItemProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IReplicationProtectedItemProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IReplicationProtectedItemProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IReplicationProtectedItemProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
        ...
        internal ReplicationProtectedItemProperties(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_providerSpecificDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("providerSpecificDetails"), out var __jsonProviderSpecificDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ReplicationProviderSpecificSettings.FromJson(__jsonProviderSpecificDetails) : _providerSpecificDetail;}
            ...
            {_protectedItemType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("protectedItemType"), out var __jsonProtectedItemType) ? (string)__jsonProtectedItemType : (string)_protectedItemType;}
            {_protectableItemId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("protectableItemId"), out var __jsonProtectableItemId) ? (string)__jsonProtectableItemId : (string)_protectableItemId;}
            {_recoveryServicesProviderId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("recoveryServicesProviderId"), out var __jsonRecoveryServicesProviderId) ? (string)__jsonRecoveryServicesProviderId : (string)_recoveryServicesProviderId;}
            ...
            {_switchProviderState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("switchProviderState"), out var __jsonSwitchProviderState) ? (string)__jsonSwitchProviderState : (string)_switchProviderState;}
            {_switchProviderStateDescription = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("switchProviderStateDescription"), out var __jsonSwitchProviderStateDescription) ? (string)__jsonSwitchProviderStateDescription : (string)_switchProviderStateDescription;}
            ...
            {_failoverHealth = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("failoverHealth"), out var __jsonFailoverHealth) ? (string)__jsonFailoverHealth : (string)_failoverHealth;}
            ...
            {_eventCorrelationId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("eventCorrelationId"), out var __jsonEventCorrelationId) ? (string)__jsonEventCorrelationId : (string)_eventCorrelationId;}
            AfterFromJson(json);
        }
