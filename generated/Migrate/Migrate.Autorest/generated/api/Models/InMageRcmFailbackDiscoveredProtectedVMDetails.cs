...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class InMageRcmFailbackDiscoveredProtectedVMDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackDiscoveredProtectedVMDetailsInternal
    {
        ...
        private System.Collections.Generic.List<string> _datastore;

        /// <summary>The list of datastores.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> Datastore { get => this._datastore; }
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackDiscoveredProtectedVMDetailsInternal.CreatedTimestamp { get => this._createdTimestamp; set { {_createdTimestamp = value;} } }

        /// <summary>Internal Acessors for Datastore</summary>
        System.Collections.Generic.List<string> Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackDiscoveredProtectedVMDetailsInternal.Datastore { get => this._datastore; set { {_datastore = value;} } }

        /// <summary>Internal Acessors for IPAddress</summary>
        System.Collections.Generic.List<string> Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackDiscoveredProtectedVMDetailsInternal.IPAddress { get => this._iPAddress; set { {_iPAddress = value;} } }

        /// <summary>Internal Acessors for IsDeleted</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackDiscoveredProtectedVMDetailsInternal.IsDeleted { get => this._isDeleted; set { {_isDeleted = value;} } }

        /// <summary>Internal Acessors for LastDiscoveryTimeInUtc</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackDiscoveredProtectedVMDetailsInternal.LastDiscoveryTimeInUtc { get => this._lastDiscoveryTimeInUtc; set { {_lastDiscoveryTimeInUtc = value;} } }

        /// <summary>Internal Acessors for OSName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackDiscoveredProtectedVMDetailsInternal.OSName { get => this._oSName; set { {_oSName = value;} } }

        /// <summary>Internal Acessors for PowerStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackDiscoveredProtectedVMDetailsInternal.PowerStatus { get => this._powerStatus; set { {_powerStatus = value;} } }

        /// <summary>Internal Acessors for UpdatedTimestamp</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackDiscoveredProtectedVMDetailsInternal.UpdatedTimestamp { get => this._updatedTimestamp; set { {_updatedTimestamp = value;} } }

        /// <summary>Internal Acessors for VCenterFqdn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackDiscoveredProtectedVMDetailsInternal.VCenterFqdn { get => this._vCenterFqdn; set { {_vCenterFqdn = value;} } }

        /// <summary>Internal Acessors for VCenterId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackDiscoveredProtectedVMDetailsInternal.VCenterId { get => this._vCenterId; set { {_vCenterId = value;} } }

        /// <summary>Internal Acessors for VMFqdn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackDiscoveredProtectedVMDetailsInternal.VMFqdn { get => this._vMFqdn; set { {_vMFqdn = value;} } }

        /// <summary>Internal Acessors for VmwareToolsStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmFailbackDiscoveredProtectedVMDetailsInternal.VmwareToolsStatus { get => this._vmwareToolsStatus; set { {_vmwareToolsStatus = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<string> Datastore { get;  }
        /// <summary>The list of IP addresses.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        /// <summary>The list of datastores.</summary>
        System.Collections.Generic.List<string> Datastore { get; set; }
        /// <summary>The list of IP addresses.</summary>
