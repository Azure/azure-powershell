...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class DraDetails
    {
        ...
        internal DraDetails(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_forwardProtectedItemCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("forwardProtectedItemCount"), out var __jsonForwardProtectedItemCount) ? (int?)__jsonForwardProtectedItemCount : _forwardProtectedItemCount;}
            {_reverseProtectedItemCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("reverseProtectedItemCount"), out var __jsonReverseProtectedItemCount) ? (int?)__jsonReverseProtectedItemCount : _reverseProtectedItemCount;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDraDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDraDetails.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDraDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
