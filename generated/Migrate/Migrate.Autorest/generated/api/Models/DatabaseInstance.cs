...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class DatabaseInstance :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseInstance,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseInstanceInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseInstanceProperties Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseInstanceInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.DatabaseInstanceProperties()); set { {_property = value;} } }

        /// <summary>Internal Acessors for Type</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseInstanceInternal.Type { get => this._type; set { {_type = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseInstanceProperties _property;

        /// <summary>Gets or sets the properties of the machine.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseInstanceProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.DatabaseInstanceProperties()); set => this._property = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseInstancePropertiesSummary Summary { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseInstancePropertiesInternal)Property).Summary; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseInstancePropertiesInternal)Property).Summary = value ?? null /* model class */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseInstanceDiscoveryDetails) })]
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseInstanceDiscoveryDetails> DiscoveryData { get; set; }
        /// <summary>Gets or sets the relative URL to get to this REST resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseInstancePropertiesSummary) })]
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseInstancePropertiesSummary Summary { get; set; }
        /// <summary>Gets the type of this REST resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        string Name { get; set; }
        /// <summary>Gets or sets the properties of the machine.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseInstanceProperties Property { get; set; }
        /// <summary>
        /// Gets or sets the database instances summary per solution. The key of dictionary is the solution name and value is the
        /// corresponding database instance summary object.
        /// </summary>
