...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class ProcessServerDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IProcessServerDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IProcessServerDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IProcessServerDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
        ...
        internal ProcessServerDetails(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_biosId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("biosId"), out var __jsonBiosId) ? (string)__jsonBiosId : (string)_biosId;}
            ...
            {_fqdn = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("fqdn"), out var __jsonFqdn) ? (string)__jsonFqdn : (string)_fqdn;}
            {_iPAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("ipAddresses"), out var __jsonIPAddresses) ? If( __jsonIPAddresses as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _iPAddress;}
            ...
            {_usedMemoryInByte = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("usedMemoryInBytes"), out var __jsonUsedMemoryInBytes) ? (long?)__jsonUsedMemoryInBytes : _usedMemoryInByte;}
            {_memoryUsagePercentage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("memoryUsagePercentage"), out var __jsonMemoryUsagePercentage) ? (double?)__jsonMemoryUsagePercentage : _memoryUsagePercentage;}
            ...
            {_usedSpaceInByte = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("usedSpaceInBytes"), out var __jsonUsedSpaceInBytes) ? (long?)__jsonUsedSpaceInBytes : _usedSpaceInByte;}
            {_freeSpacePercentage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("freeSpacePercentage"), out var __jsonFreeSpacePercentage) ? (double?)__jsonFreeSpacePercentage : _freeSpacePercentage;}
            {_throughputUploadPendingDataInByte = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("throughputUploadPendingDataInBytes"), out var __jsonThroughputUploadPendingDataInBytes) ? (long?)__jsonThroughputUploadPendingDataInBytes : _throughputUploadPendingDataInByte;}
            {_throughputInByte = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("throughputInBytes"), out var __jsonThroughputInBytes) ? (long?)__jsonThroughputInBytes : _throughputInByte;}
            {_processorUsagePercentage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("processorUsagePercentage"), out var __jsonProcessorUsagePercentage) ? (double?)__jsonProcessorUsagePercentage : _processorUsagePercentage;}
            {_throughputStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("throughputStatus"), out var __jsonThroughputStatus) ? (string)__jsonThroughputStatus : (string)_throughputStatus;}
            {_systemLoad = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("systemLoad"), out var __jsonSystemLoad) ? (long?)__jsonSystemLoad : _systemLoad;}
            ...
            {_diskUsageStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("diskUsageStatus"), out var __jsonDiskUsageStatus) ? (string)__jsonDiskUsageStatus : (string)_diskUsageStatus;}
            ...
            {_processorUsageStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("processorUsageStatus"), out var __jsonProcessorUsageStatus) ? (string)__jsonProcessorUsageStatus : (string)_processorUsageStatus;}
            {_health = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("health"), out var __jsonHealth) ? (string)__jsonHealth : (string)_health;}
            {_healthError = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("healthErrors"), out var __jsonHealthErrors) ? If( __jsonHealthErrors as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthError>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthError) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.HealthError.FromJson(__p) )) ))() : null : _healthError;}
            {_protectedItemCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("protectedItemCount"), out var __jsonProtectedItemCount) ? (int?)__jsonProtectedItemCount : _protectedItemCount;}
            {_historicHealth = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("historicHealth"), out var __jsonHistoricHealth) ? (string)__jsonHistoricHealth : (string)_historicHealth;}
            AfterFromJson(json);
        }
