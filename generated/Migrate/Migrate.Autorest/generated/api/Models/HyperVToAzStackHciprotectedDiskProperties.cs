...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class HyperVToAzStackHciprotectedDiskProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHciprotectedDiskProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHciprotectedDiskPropertiesInternal
    {
        ...
        long? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHciprotectedDiskPropertiesInternal.CapacityInByte { get => this._capacityInByte; set { {_capacityInByte = value;} } }

        /// <summary>Internal Acessors for DiskBlockSize</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHciprotectedDiskPropertiesInternal.DiskBlockSize { get => this._diskBlockSize; set { {_diskBlockSize = value;} } }

        /// <summary>Internal Acessors for DiskLogicalSectorSize</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHciprotectedDiskPropertiesInternal.DiskLogicalSectorSize { get => this._diskLogicalSectorSize; set { {_diskLogicalSectorSize = value;} } }

        /// <summary>Internal Acessors for DiskPhysicalSectorSize</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHciprotectedDiskPropertiesInternal.DiskPhysicalSectorSize { get => this._diskPhysicalSectorSize; set { {_diskPhysicalSectorSize = value;} } }

        /// <summary>Internal Acessors for DiskType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHciprotectedDiskPropertiesInternal.DiskType { get => this._diskType; set { {_diskType = value;} } }

        /// <summary>Internal Acessors for IsDynamic</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHciprotectedDiskPropertiesInternal.IsDynamic { get => this._isDynamic; set { {_isDynamic = value;} } }

        /// <summary>Internal Acessors for IsOSDisk</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHciprotectedDiskPropertiesInternal.IsOSDisk { get => this._isOSDisk; set { {_isOSDisk = value;} } }

        /// <summary>Internal Acessors for MigrateDiskName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHciprotectedDiskPropertiesInternal.MigrateDiskName { get => this._migrateDiskName; set { {_migrateDiskName = value;} } }

        /// <summary>Internal Acessors for SeedDiskName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHciprotectedDiskPropertiesInternal.SeedDiskName { get => this._seedDiskName; set { {_seedDiskName = value;} } }

        /// <summary>Internal Acessors for SourceDiskId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHciprotectedDiskPropertiesInternal.SourceDiskId { get => this._sourceDiskId; set { {_sourceDiskId = value;} } }

        /// <summary>Internal Acessors for SourceDiskName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHciprotectedDiskPropertiesInternal.SourceDiskName { get => this._sourceDiskName; set { {_sourceDiskName = value;} } }

        /// <summary>Internal Acessors for StorageContainerId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHciprotectedDiskPropertiesInternal.StorageContainerId { get => this._storageContainerId; set { {_storageContainerId = value;} } }

        /// <summary>Internal Acessors for StorageContainerLocalPath</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHciprotectedDiskPropertiesInternal.StorageContainerLocalPath { get => this._storageContainerLocalPath; set { {_storageContainerLocalPath = value;} } }

        /// <summary>Internal Acessors for TestMigrateDiskName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVToAzStackHciprotectedDiskPropertiesInternal.TestMigrateDiskName { get => this._testMigrateDiskName; set { {_testMigrateDiskName = value;} } }
