...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class AzStackHciFabricModelCustomProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAzStackHciFabricModelCustomProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAzStackHciFabricModelCustomPropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IValidates
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAzStackHciClusterProperties _cluster;

        /// <summary>AzStackHCI cluster properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAzStackHciClusterProperties Cluster { get => (this._cluster = this._cluster ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.AzStackHciClusterProperties()); set => this._cluster = value; }
        ...
        public string InstanceType { get => "AzStackHCI"; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFabricModelCustomPropertiesInternal)__fabricModelCustomProperties).InstanceType = "AzStackHCI"; }

        /// <summary>Internal Acessors for ApplianceName</summary>
        System.Collections.Generic.List<string> Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAzStackHciFabricModelCustomPropertiesInternal.ApplianceName { get => this._applianceName; set { {_applianceName = value;} } }

        /// <summary>Internal Acessors for FabricContainerId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAzStackHciFabricModelCustomPropertiesInternal.FabricContainerId { get => this._fabricContainerId; set { {_fabricContainerId = value;} } }

        /// <summary>Internal Acessors for FabricResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAzStackHciFabricModelCustomPropertiesInternal.FabricResourceId { get => this._fabricResourceId; set { {_fabricResourceId = value;} } }

        /// <summary>Internal Acessors for MigrationHubUri</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAzStackHciFabricModelCustomPropertiesInternal.MigrationHubUri { get => this._migrationHubUri; set { {_migrationHubUri = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFabricModelCustomProperties
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAzStackHciClusterProperties) })]
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAzStackHciClusterProperties Cluster { get; set; }
        /// <summary>Gets or sets the fabric container Id.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = true,
