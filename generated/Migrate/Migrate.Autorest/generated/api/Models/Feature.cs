...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class Feature :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFeature,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFeatureInternal
    {

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFeatureInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Parent</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFeatureInternal.Parent { get => this._parent; set { {_parent = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFeatureInternal.Status { get => this._status; set { {_status = value;} } }

        /// <summary>Internal Acessors for Type</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFeatureInternal.Type { get => this._type; set { {_type = value;} } }
