...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401
{
    ...
    public partial class A2AProtectionIntentDiskInputDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IA2AProtectionIntentDiskInputDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IA2AProtectionIntentDiskInputDetailsInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IStorageAccountCustomDetails Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IA2AProtectionIntentDiskInputDetailsInternal.PrimaryStagingStorageAccountCustomInput { get => (this._primaryStagingStorageAccountCustomInput = this._primaryStagingStorageAccountCustomInput ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.StorageAccountCustomDetails()); set { {_primaryStagingStorageAccountCustomInput = value;} } }

        /// <summary>Internal Acessors for RecoveryAzureStorageAccountCustomInput</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IStorageAccountCustomDetails Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IA2AProtectionIntentDiskInputDetailsInternal.RecoveryAzureStorageAccountCustomInput { get => (this._recoveryAzureStorageAccountCustomInput = this._recoveryAzureStorageAccountCustomInput ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.StorageAccountCustomDetails()); set { {_recoveryAzureStorageAccountCustomInput = value;} } }
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IStorageAccountCustomDetails _recoveryAzureStorageAccountCustomInput;

        /// <summary>The recovery VHD storage account input.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IStorageAccountCustomDetails RecoveryAzureStorageAccountCustomInput { get => (this._recoveryAzureStorageAccountCustomInput = this._recoveryAzureStorageAccountCustomInput ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.StorageAccountCustomDetails()); set => this._recoveryAzureStorageAccountCustomInput = value; }

        /// <summary>The class type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public string RecoveryAzureStorageAccountCustomInputResourceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IStorageAccountCustomDetailsInternal)RecoveryAzureStorageAccountCustomInput).ResourceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IStorageAccountCustomDetailsInternal)RecoveryAzureStorageAccountCustomInput).ResourceType = value ?? null; }
...

    {
        ...
        string PrimaryStagingStorageAccountCustomInputResourceType { get; set; }
        /// <summary>The recovery VHD storage account input.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IStorageAccountCustomDetails RecoveryAzureStorageAccountCustomInput { get; set; }
        /// <summary>The class type.</summary>
        string RecoveryAzureStorageAccountCustomInputResourceType { get; set; }
