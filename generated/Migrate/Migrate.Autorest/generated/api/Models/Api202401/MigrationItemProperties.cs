...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401
{
    ...
    public partial class MigrationItemProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ICriticalJobHistoryDetails[] _criticalJobHistory;

        /// <summary>The critical past job details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ICriticalJobHistoryDetails[] CriticalJobHistory { get => this._criticalJobHistory; }

        /// <summary>Backing field for <see cref="CurrentJob" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ICurrentJobDetails _currentJob;

        /// <summary>The current job details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ICurrentJobDetails CurrentJob { get => (this._currentJob = this._currentJob ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.CurrentJobDetails()); }

        /// <summary>The ARM Id of the job being executed.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public string CurrentJobId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ICurrentJobDetailsInternal)CurrentJob).JobId; }

        /// <summary>The job name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public string CurrentJobName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ICurrentJobDetailsInternal)CurrentJob).JobName; }

        /// <summary>The start time of the job.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inlined)]
        public global::System.DateTime? CurrentJobStartTime { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ICurrentJobDetailsInternal)CurrentJob).StartTime; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.MigrationItemOperation[] Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.AllowedOperation { get => this._allowedOperation; set { {_allowedOperation = value;} } }

        /// <summary>Internal Acessors for CriticalJobHistory</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ICriticalJobHistoryDetails[] Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.CriticalJobHistory { get => this._criticalJobHistory; set { {_criticalJobHistory = value;} } }

        /// <summary>Internal Acessors for CurrentJob</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ICurrentJobDetails Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.CurrentJob { get => (this._currentJob = this._currentJob ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.CurrentJobDetails()); set { {_currentJob = value;} } }

        /// <summary>Internal Acessors for CurrentJobId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.CurrentJobId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ICurrentJobDetailsInternal)CurrentJob).JobId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ICurrentJobDetailsInternal)CurrentJob).JobId = value; }
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.CurrentJobStartTime { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ICurrentJobDetailsInternal)CurrentJob).StartTime; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ICurrentJobDetailsInternal)CurrentJob).StartTime = value; }

        /// <summary>Internal Acessors for EventCorrelationId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.EventCorrelationId { get => this._eventCorrelationId; set { {_eventCorrelationId = value;} } }

        /// <summary>Internal Acessors for Health</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.ProtectionHealth? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.Health { get => this._health; set { {_health = value;} } }

        /// <summary>Internal Acessors for HealthError</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IHealthError[] Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.HealthError { get => this._healthError; set { {_healthError = value;} } }

        /// <summary>Internal Acessors for LastMigrationStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.LastMigrationStatus { get => this._lastMigrationStatus; set { {_lastMigrationStatus = value;} } }

        /// <summary>Internal Acessors for LastMigrationTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.LastMigrationTime { get => this._lastMigrationTime; set { {_lastMigrationTime = value;} } }

        /// <summary>Internal Acessors for LastTestMigrationStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.LastTestMigrationStatus { get => this._lastTestMigrationStatus; set { {_lastTestMigrationStatus = value;} } }

        /// <summary>Internal Acessors for LastTestMigrationTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.LastTestMigrationTime { get => this._lastTestMigrationTime; set { {_lastTestMigrationTime = value;} } }

        /// <summary>Internal Acessors for MachineName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.MachineName { get => this._machineName; set { {_machineName = value;} } }

        /// <summary>Internal Acessors for MigrationState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.MigrationState? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.MigrationState { get => this._migrationState; set { {_migrationState = value;} } }

        /// <summary>Internal Acessors for MigrationStateDescription</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.MigrationStateDescription { get => this._migrationStateDescription; set { {_migrationStateDescription = value;} } }

        /// <summary>Internal Acessors for PolicyFriendlyName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.PolicyFriendlyName { get => this._policyFriendlyName; set { {_policyFriendlyName = value;} } }

        /// <summary>Internal Acessors for PolicyId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.PolicyId { get => this._policyId; set { {_policyId = value;} } }

        /// <summary>Internal Acessors for RecoveryServicesProviderId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.RecoveryServicesProviderId { get => this._recoveryServicesProviderId; set { {_recoveryServicesProviderId = value;} } }

        /// <summary>Internal Acessors for ReplicationStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.ReplicationStatus { get => this._replicationStatus; set { {_replicationStatus = value;} } }

        /// <summary>Internal Acessors for TestMigrateState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.TestMigrationState? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.TestMigrateState { get => this._testMigrateState; set { {_testMigrateState = value;} } }

        /// <summary>Internal Acessors for TestMigrateStateDescription</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationItemPropertiesInternal.TestMigrateStateDescription { get => this._testMigrateStateDescription; set { {_testMigrateStateDescription = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationProviderSpecificSettings _providerSpecificDetail;

        /// <summary>The migration provider custom settings.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IMigrationProviderSpecificSettings ProviderSpecificDetail { get => (this._providerSpecificDetail = this._providerSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.MigrationProviderSpecificSettings()); set => this._providerSpecificDetail = value; }
