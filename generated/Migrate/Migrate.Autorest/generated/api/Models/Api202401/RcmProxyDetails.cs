...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401
{
    ...
    public partial class RcmProxyDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRcmProxyDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRcmProxyDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRcmProxyDetailsInternal.BiosId { get => this._biosId; set { {_biosId = value;} } }

        /// <summary>Internal Acessors for ClientAuthenticationType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRcmProxyDetailsInternal.ClientAuthenticationType { get => this._clientAuthenticationType; set { {_clientAuthenticationType = value;} } }

        /// <summary>Internal Acessors for FabricObjectId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRcmProxyDetailsInternal.FabricObjectId { get => this._fabricObjectId; set { {_fabricObjectId = value;} } }

        /// <summary>Internal Acessors for Fqdn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRcmProxyDetailsInternal.Fqdn { get => this._fqdn; set { {_fqdn = value;} } }

        /// <summary>Internal Acessors for Health</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.ProtectionHealth? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRcmProxyDetailsInternal.Health { get => this._health; set { {_health = value;} } }

        /// <summary>Internal Acessors for HealthError</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IHealthError[] Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRcmProxyDetailsInternal.HealthError { get => this._healthError; set { {_healthError = value;} } }

        /// <summary>Internal Acessors for Id</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRcmProxyDetailsInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for LastHeartbeatUtc</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRcmProxyDetailsInternal.LastHeartbeatUtc { get => this._lastHeartbeatUtc; set { {_lastHeartbeatUtc = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRcmProxyDetailsInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IRcmProxyDetailsInternal.Version { get => this._version; set { {_version = value;} } }
