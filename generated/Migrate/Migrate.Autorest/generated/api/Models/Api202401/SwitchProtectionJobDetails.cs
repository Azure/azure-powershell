...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401
{
    ...
    public partial class SwitchProtectionJobDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ISwitchProtectionJobDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ISwitchProtectionJobDetailsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IJobDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IJobDetails __jobDetails = new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.JobDetails();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IJobDetailsAffectedObjectDetails AffectedObjectDetail { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IJobDetailsInternal)__jobDetails).AffectedObjectDetail; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IJobDetailsInternal)__jobDetails).AffectedObjectDetail = value ?? null /* model class */; }

        /// <summary>Gets the type of job details (see JobDetailsTypes enum for possible values).</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Inherited)]
        public string InstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IJobDetailsInternal)__jobDetails).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IJobDetailsInternal)__jobDetails).InstanceType = value ; }
    ...
    public partial interface ISwitchProtectionJobDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IJobDetails
    {
        /// <summary>ARM Id of the new replication protected item.</summary>
    ...
    internal partial interface ISwitchProtectionJobDetailsInternal :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IJobDetailsInternal
    {
        /// <summary>ARM Id of the new replication protected item.</summary>
        string NewReplicationProtectedItemId { get; set; }
