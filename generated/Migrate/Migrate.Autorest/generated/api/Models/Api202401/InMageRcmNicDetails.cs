...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401
{
    ...
    public partial class InMageRcmNicDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IInMageRcmNicDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IInMageRcmNicDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IInMageRcmNicDetailsInternal.NicId { get => this._nicId; set { {_nicId = value;} } }

        /// <summary>Internal Acessors for SourceIPAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IInMageRcmNicDetailsInternal.SourceIPAddress { get => this._sourceIPAddress; set { {_sourceIPAddress = value;} } }

        /// <summary>Internal Acessors for SourceIPAddressType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.EthernetAddressType? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IInMageRcmNicDetailsInternal.SourceIPAddressType { get => this._sourceIPAddressType; set { {_sourceIPAddressType = value;} } }

        /// <summary>Internal Acessors for SourceNetworkId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IInMageRcmNicDetailsInternal.SourceNetworkId { get => this._sourceNetworkId; set { {_sourceNetworkId = value;} } }

        /// <summary>Internal Acessors for SourceSubnetName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IInMageRcmNicDetailsInternal.SourceSubnetName { get => this._sourceSubnetName; set { {_sourceSubnetName = value;} } }
