...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401
{
    ...
    public partial class A2AReplicationIntentDetails
    {
        ...
        internal A2AReplicationIntentDetails(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            __replicationProtectionIntentProviderSpecificSettings = new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ReplicationProtectionIntentProviderSpecificSettings(json);
            {_protectionProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("protectionProfile"), out var __jsonProtectionProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.ProtectionProfileCustomDetails.FromJson(__jsonProtectionProfile) : ProtectionProfile;}
            {_primaryStagingStorageAccount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("primaryStagingStorageAccount"), out var __jsonPrimaryStagingStorageAccount) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.StorageAccountCustomDetails.FromJson(__jsonPrimaryStagingStorageAccount) : PrimaryStagingStorageAccount;}
            {_recoveryAvailabilitySet = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("recoveryAvailabilitySet"), out var __jsonRecoveryAvailabilitySet) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.RecoveryAvailabilitySetCustomDetails.FromJson(__jsonRecoveryAvailabilitySet) : RecoveryAvailabilitySet;}
            {_recoveryVirtualNetwork = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("recoveryVirtualNetwork"), out var __jsonRecoveryVirtualNetwork) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.RecoveryVirtualNetworkCustomDetails.FromJson(__jsonRecoveryVirtualNetwork) : RecoveryVirtualNetwork;}
            {_recoveryProximityPlacementGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("recoveryProximityPlacementGroup"), out var __jsonRecoveryProximityPlacementGroup) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.RecoveryProximityPlacementGroupCustomDetails.FromJson(__jsonRecoveryProximityPlacementGroup) : RecoveryProximityPlacementGroup;}
            {_recoveryBootDiagStorageAccount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("recoveryBootDiagStorageAccount"), out var __jsonRecoveryBootDiagStorageAccount) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.StorageAccountCustomDetails.FromJson(__jsonRecoveryBootDiagStorageAccount) : RecoveryBootDiagStorageAccount;}
            ...
            {_vMDisk = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("vmDisks"), out var __jsonVMDisks) ? If( __jsonVMDisks as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IA2AProtectionIntentDiskInputDetails[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IA2AProtectionIntentDiskInputDetails) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.A2AProtectionIntentDiskInputDetails.FromJson(__u) )) ))() : null : VMDisk;}
            {_vMManagedDisk = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("vmManagedDisks"), out var __jsonVMManagedDisks) ? If( __jsonVMManagedDisks as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IA2AProtectionIntentManagedDiskInputDetails[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IA2AProtectionIntentManagedDiskInputDetails) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.A2AProtectionIntentManagedDiskInputDetails.FromJson(__p) )) ))() : null : VMManagedDisk;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IA2AReplicationIntentDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IA2AReplicationIntentDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.IA2AReplicationIntentDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
