...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class VaultHealthProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVaultHealthProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVaultHealthProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVaultHealthProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
        ...
        internal VaultHealthProperties(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_protectedItemsHealth = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("protectedItemsHealth"), out var __jsonProtectedItemsHealth) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ResourceHealthSummary.FromJson(__jsonProtectedItemsHealth) : _protectedItemsHealth;}
            {_fabricsHealth = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("fabricsHealth"), out var __jsonFabricsHealth) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ResourceHealthSummary.FromJson(__jsonFabricsHealth) : _fabricsHealth;}
            {_containersHealth = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("containersHealth"), out var __jsonContainersHealth) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ResourceHealthSummary.FromJson(__jsonContainersHealth) : _containersHealth;}
            {_vaultError = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("vaultErrors"), out var __jsonVaultErrors) ? If( __jsonVaultErrors as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthError>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHealthError) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.HealthError.FromJson(__u) )) ))() : null : _vaultError;}
            AfterFromJson(json);
        }
    }
}