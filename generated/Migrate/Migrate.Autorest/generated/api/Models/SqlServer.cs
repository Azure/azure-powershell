...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class SqlServer :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISqlServer,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISqlServerInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISqlServerInternal.ClusterName { get => this._clusterName; set { {_clusterName = value;} } }

        /// <summary>Internal Acessors for Clustered</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISqlServerInternal.Clustered { get => this._clustered; set { {_clustered = value;} } }

        /// <summary>Internal Acessors for Edition</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISqlServerInternal.Edition { get => this._edition; set { {_edition = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISqlServerInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for ServicePack</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISqlServerInternal.ServicePack { get => this._servicePack; set { {_servicePack = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISqlServerInternal.Version { get => this._version; set { {_version = value;} } }
