...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class InMageRcmNicDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmNicDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmNicDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmNicDetailsInternal.NicId { get => this._nicId; set { {_nicId = value;} } }

        /// <summary>Internal Acessors for SourceIPAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmNicDetailsInternal.SourceIPAddress { get => this._sourceIPAddress; set { {_sourceIPAddress = value;} } }

        /// <summary>Internal Acessors for SourceIPAddressType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmNicDetailsInternal.SourceIPAddressType { get => this._sourceIPAddressType; set { {_sourceIPAddressType = value;} } }

        /// <summary>Internal Acessors for SourceNetworkId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmNicDetailsInternal.SourceNetworkId { get => this._sourceNetworkId; set { {_sourceNetworkId = value;} } }

        /// <summary>Internal Acessors for SourceSubnetName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IInMageRcmNicDetailsInternal.SourceSubnetName { get => this._sourceSubnetName; set { {_sourceSubnetName = value;} } }
