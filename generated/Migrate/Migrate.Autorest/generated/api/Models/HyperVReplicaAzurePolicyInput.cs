...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class HyperVReplicaAzurePolicyInput :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVReplicaAzurePolicyInput,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVReplicaAzurePolicyInputInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IPolicyProviderSpecificInput"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IPolicyProviderSpecificInput __policyProviderSpecificInput = new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.PolicyProviderSpecificInput();
        ...
        public string InstanceType { get => "HyperVReplicaAzure"; set => ((Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IPolicyProviderSpecificInputInternal)__policyProviderSpecificInput).InstanceType = "HyperVReplicaAzure"; }
        ...
        private System.Collections.Generic.List<string> _storageAccount;

        /// <summary>
        /// The list of storage accounts to which the VMs in the primary cloud can replicate to.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> StorageAccount { get => this._storageAccount; set => this._storageAccount = value; }

        /// <summary>Creates an new <see cref="HyperVReplicaAzurePolicyInput" /> instance.</summary>
        public HyperVReplicaAzurePolicyInput()
        {
            this.__policyProviderSpecificInput.InstanceType = "HyperVReplicaAzure";
        }
    ...
    public partial interface IHyperVReplicaAzurePolicyInput :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IPolicyProviderSpecificInput
    {
        /// <summary>
        /// The interval (in hours) at which Hyper-V Replica should create an application consistent snapshot within the VM.
        /// </summary>
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> StorageAccount { get; set; }

    }
    /// Hyper-V Replica Azure specific input for creating a protection profile.
    internal partial interface IHyperVReplicaAzurePolicyInputInternal :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IPolicyProviderSpecificInputInternal
    {
        /// <summary>
        /// The interval (in hours) at which Hyper-V Replica should create an application consistent snapshot within the VM.
        /// </summary>
