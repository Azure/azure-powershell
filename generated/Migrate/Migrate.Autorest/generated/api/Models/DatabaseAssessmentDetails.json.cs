...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class DatabaseAssessmentDetails
    {
        ...
        internal DatabaseAssessmentDetails(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_assessmentId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("assessmentId"), out var __jsonAssessmentId) ? (string)__jsonAssessmentId : (string)_assessmentId;}
            {_migrationBlockersCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("migrationBlockersCount"), out var __jsonMigrationBlockersCount) ? (int?)__jsonMigrationBlockersCount : _migrationBlockersCount;}
            {_breakingChangesCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("breakingChangesCount"), out var __jsonBreakingChangesCount) ? (int?)__jsonBreakingChangesCount : _breakingChangesCount;}
            {_isReadyForMigration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonBoolean>("isReadyForMigration"), out var __jsonIsReadyForMigration) ? (bool?)__jsonIsReadyForMigration : _isReadyForMigration;}
            {_assessmentTargetType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("assessmentTargetType"), out var __jsonAssessmentTargetType) ? (string)__jsonAssessmentTargetType : (string)_assessmentTargetType;}
            {_lastAssessedTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("lastAssessedTime"), out var __jsonLastAssessedTime) ? global::System.DateTime.TryParse((string)__jsonLastAssessedTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonLastAssessedTimeValue) ? __jsonLastAssessedTimeValue : _lastAssessedTime : _lastAssessedTime;}
            {_compatibilityLevel = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("compatibilityLevel"), out var __jsonCompatibilityLevel) ? (string)__jsonCompatibilityLevel : (string)_compatibilityLevel;}
            {_databaseSizeInMb = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("databaseSizeInMB"), out var __jsonDatabaseSizeInMb) ? (string)__jsonDatabaseSizeInMb : (string)_databaseSizeInMb;}
            ...
            {_extendedInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("extendedInfo"), out var __jsonExtendedInfo) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.DatabaseAssessmentDetailsExtendedInfo.FromJson(__jsonExtendedInfo) : _extendedInfo;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseAssessmentDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseAssessmentDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IDatabaseAssessmentDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
