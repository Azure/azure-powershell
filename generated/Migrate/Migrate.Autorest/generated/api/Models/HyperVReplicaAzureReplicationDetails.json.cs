...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class HyperVReplicaAzureReplicationDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVReplicaAzureReplicationDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVReplicaAzureReplicationDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVReplicaAzureReplicationDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
        ...
        internal HyperVReplicaAzureReplicationDetails(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_initialReplicationDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("initialReplicationDetails"), out var __jsonInitialReplicationDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.InitialReplicationDetails.FromJson(__jsonInitialReplicationDetails) : _initialReplicationDetail;}
            {_oSDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("oSDetails"), out var __jsonOSDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.OSDetails.FromJson(__jsonOSDetails) : _oSDetail;}
            ...
            {_azureVMDiskDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("azureVmDiskDetails"), out var __jsonAzureVMDiskDetails) ? If( __jsonAzureVMDiskDetails as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAzureVMDiskDetails>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IAzureVMDiskDetails) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.AzureVMDiskDetails.FromJson(__u) )) ))() : null : _azureVMDiskDetail;}
            ...
            {_recoveryAzureStorageAccount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("recoveryAzureStorageAccount"), out var __jsonRecoveryAzureStorageAccount) ? (string)__jsonRecoveryAzureStorageAccount : (string)_recoveryAzureStorageAccount;}
            {_recoveryAzureLogStorageAccountId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("recoveryAzureLogStorageAccountId"), out var __jsonRecoveryAzureLogStorageAccountId) ? (string)__jsonRecoveryAzureLogStorageAccountId : (string)_recoveryAzureLogStorageAccountId;}
            {_lastReplicatedTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("lastReplicatedTime"), out var __jsonLastReplicatedTime) ? global::System.DateTime.TryParse((string)__jsonLastReplicatedTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonLastReplicatedTimeValue) ? __jsonLastReplicatedTimeValue : _lastReplicatedTime : _lastReplicatedTime;}
            ...
            {_vMId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("vmId"), out var __jsonVMId) ? (string)__jsonVMId : (string)_vMId;}
            ...
            {_vMNic = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("vmNics"), out var __jsonVMNics) ? If( __jsonVMNics as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMNicDetails>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMNicDetails) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.VMNicDetails.FromJson(__p) )) ))() : null : _vMNic;}
            ...
            {_selectedSourceNicId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("selectedSourceNicId"), out var __jsonSelectedSourceNicId) ? (string)__jsonSelectedSourceNicId : (string)_selectedSourceNicId;}
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("encryption"), out var __jsonEncryption) ? (string)__jsonEncryption : (string)_encryption;}
            {_sourceVMRamSizeInMb = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("sourceVmRamSizeInMB"), out var __jsonSourceVMRamSizeInMb) ? (int?)__jsonSourceVMRamSizeInMb : _sourceVMRamSizeInMb;}
            {_sourceVMCpuCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNumber>("sourceVmCpuCount"), out var __jsonSourceVMCpuCount) ? (int?)__jsonSourceVMCpuCount : _sourceVMCpuCount;}
            {_enableRdpOnTargetOption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("enableRdpOnTargetOption"), out var __jsonEnableRdpOnTargetOption) ? (string)__jsonEnableRdpOnTargetOption : (string)_enableRdpOnTargetOption;}
            ...
            {_useManagedDisk = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("useManagedDisks"), out var __jsonUseManagedDisks) ? (string)__jsonUseManagedDisks : (string)_useManagedDisk;}
            ...
            {_targetVMTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("targetVmTags"), out var __jsonTargetVMTags) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.HyperVReplicaAzureReplicationDetailsTargetVmtags.FromJson(__jsonTargetVMTags) : _targetVMTag;}
            {_seedManagedDiskTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("seedManagedDiskTags"), out var __jsonSeedManagedDiskTags) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.HyperVReplicaAzureReplicationDetailsSeedManagedDiskTags.FromJson(__jsonSeedManagedDiskTags) : _seedManagedDiskTag;}
            {_targetManagedDiskTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("targetManagedDiskTags"), out var __jsonTargetManagedDiskTags) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.HyperVReplicaAzureReplicationDetailsTargetManagedDiskTags.FromJson(__jsonTargetManagedDiskTags) : _targetManagedDiskTag;}
            {_targetNicTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("targetNicTags"), out var __jsonTargetNicTags) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.HyperVReplicaAzureReplicationDetailsTargetNicTags.FromJson(__jsonTargetNicTags) : _targetNicTag;}
            {_protectedManagedDisk = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("protectedManagedDisks"), out var __jsonProtectedManagedDisks) ? If( __jsonProtectedManagedDisks as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVReplicaAzureManagedDiskDetails>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IHyperVReplicaAzureManagedDiskDetails) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.HyperVReplicaAzureManagedDiskDetails.FromJson(__k) )) ))() : null : _protectedManagedDisk;}
            {_allAvailableOSUpgradeConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray>("allAvailableOSUpgradeConfigurations"), out var __jsonAllAvailableOSUpgradeConfigurations) ? If( __jsonAllAvailableOSUpgradeConfigurations as Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IOSUpgradeSupportedVersions>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__g, (__f)=>(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IOSUpgradeSupportedVersions) (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.OSUpgradeSupportedVersions.FromJson(__f) )) ))() : null : _allAvailableOSUpgradeConfiguration;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.SerializationMode serializationMode)
        {
            ...
            if (null != this._allAvailableOSUpgradeConfiguration)
            {
                var __h = new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.XNodeArray();
                foreach( var __i in this._allAvailableOSUpgradeConfiguration )
                {
                    AddIf(__i?.ToJson(null, serializationMode) ,__h.Add);
                }
                container.Add("allAvailableOSUpgradeConfigurations",__h);
            }
