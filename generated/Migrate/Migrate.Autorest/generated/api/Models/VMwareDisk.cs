...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class VMwareDisk :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareDisk,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareDiskInternal
    {
        ...
        public string DiskMode { get => this._diskMode; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareDiskInternal.DiskMode { get => this._diskMode; set { {_diskMode = value;} } }

        /// <summary>Internal Acessors for DiskProvisioningPolicy</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareDiskInternal.DiskProvisioningPolicy { get => this._diskProvisioningPolicy; set { {_diskProvisioningPolicy = value;} } }

        /// <summary>Internal Acessors for DiskScrubbingPolicy</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareDiskInternal.DiskScrubbingPolicy { get => this._diskScrubbingPolicy; set { {_diskScrubbingPolicy = value;} } }

        /// <summary>Internal Acessors for DiskType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareDiskInternal.DiskType { get => this._diskType; set { {_diskType = value;} } }

        /// <summary>Internal Acessors for Label</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareDiskInternal.Label { get => this._label; set { {_label = value;} } }

        /// <summary>Internal Acessors for Lun</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareDiskInternal.Lun { get => this._lun; set { {_lun = value;} } }

        /// <summary>Internal Acessors for MaxSizeInByte</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareDiskInternal.MaxSizeInByte { get => this._maxSizeInByte; set { {_maxSizeInByte = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareDiskInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Path</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareDiskInternal.Path { get => this._path; set { {_path = value;} } }

        /// <summary>Internal Acessors for Uuid</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IVMwareDiskInternal.Uuid { get => this._uuid; set { {_uuid = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IJsonSerializable
    {
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.PSArgumentCompleterAttribute("persistent", "independent_persistent", "independent_nonpersistent", "nonpersistent", "undoable", "append")]
        string DiskMode { get;  }
        /// <summary>
        /// The provisioning policy of the disk. It is Thin or Thick or Unknown for the VMWare.
        /// </summary>
