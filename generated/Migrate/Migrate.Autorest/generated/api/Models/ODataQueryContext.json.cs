...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models
{
    ...
    public partial class ODataQueryContext
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IODataQueryContext.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IODataQueryContext.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IODataQueryContext FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
        ...
        internal ODataQueryContext(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_defaultQuerySetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("defaultQuerySettings"), out var __jsonDefaultQuerySettings) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.DefaultQuerySettings.FromJson(__jsonDefaultQuerySettings) : _defaultQuerySetting;}
            {_model = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("model"), out var __jsonModel) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IedmModel.FromJson(__jsonModel) : _model;}
            {_elementType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("elementType"), out var __jsonElementType) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IedmType.FromJson(__jsonElementType) : _elementType;}
            {_navigationSource = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("navigationSource"), out var __jsonNavigationSource) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IedmNavigationSource.FromJson(__jsonNavigationSource) : _navigationSource;}
            {_path = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("path"), out var __jsonPath) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ODataPath.FromJson(__jsonPath) : _path;}
            {_elementClrType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonString>("elementClrType"), out var __jsonElementClrType) ? (string)__jsonElementClrType : (string)_elementClrType;}
            {_requestContainer = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("requestContainer"), out var __jsonRequestContainer) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Any.FromJson(__jsonRequestContainer) : _requestContainer;}
            AfterFromJson(json);
        }
