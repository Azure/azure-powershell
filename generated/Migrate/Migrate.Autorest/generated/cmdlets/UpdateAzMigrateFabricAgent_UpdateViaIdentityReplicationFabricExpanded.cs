...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataReplication/replicationFabrics/{fabricName}/fabricAgents/{fabricAgentName}"
    /// [OpenAPI] Create=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataReplication/replicationFabrics/{fabricName}/fabricAgents/{fabricAgentName}"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMigrateFabricAgent_UpdateViaIdentityReplicationFabricExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFabricAgentModel))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Description(@"update the fabric agent.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Generated]
    public partial class UpdateAzMigrateFabricAgent_UpdateViaIdentityReplicationFabricExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFabricAgentModel _body = new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.FabricAgentModel();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The fabric agent name.")]
        ...
        [global::System.Management.Automation.Alias("FabricAgentName")]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFabricAgentModelProperties) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFabricAgentModelProperties Property { get => _body.Property ?? null /* object */; set => _body.Property = value; }
        ...
        /// <summary>Backing field for <see cref="ReplicationFabricInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateIdentity _replicationFabricInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateIdentity ReplicationFabricInputObject { get => this._replicationFabricInputObject; set => this._replicationFabricInputObject = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorResponseAutoGenerated">Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorResponseAutoGenerated</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorResponseAutoGenerated> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFabricAgentModel">Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFabricAgentModel</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFabricAgentModel> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzMigrateFabricAgent_UpdateViaIdentityReplicationFabricExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets.UpdateAzMigrateFabricAgent_UpdateViaIdentityReplicationFabricExpanded Clone()
        {
            var clone = new UpdateAzMigrateFabricAgent_UpdateViaIdentityReplicationFabricExpanded();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'FabricAgentCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ReplicationFabricInputObject?.Id != null)
                    {
                        this.ReplicationFabricInputObject.Id += $"/fabricAgents/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        _body = await this.Client.FabricAgentGetViaIdentityWithResult(ReplicationFabricInputObject.Id, this, Pipeline);
                        this.Update_body();
                        await this.Client.FabricAgentCreateViaIdentity(ReplicationFabricInputObject.Id, _body, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == ReplicationFabricInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ReplicationFabricInputObject has null value for ReplicationFabricInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ReplicationFabricInputObject) );
                        }
                        if (null == ReplicationFabricInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ReplicationFabricInputObject has null value for ReplicationFabricInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ReplicationFabricInputObject) );
                        }
                        if (null == ReplicationFabricInputObject.FabricName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ReplicationFabricInputObject has null value for ReplicationFabricInputObject.FabricName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ReplicationFabricInputObject) );
                        }
                        _body = await this.Client.FabricAgentGetWithResult(ReplicationFabricInputObject.SubscriptionId ?? null, ReplicationFabricInputObject.ResourceGroupName ?? null, ReplicationFabricInputObject.FabricName ?? null, Name, this, Pipeline);
                        this.Update_body();
                        await this.Client.FabricAgentCreate(ReplicationFabricInputObject.SubscriptionId ?? null, ReplicationFabricInputObject.ResourceGroupName ?? null, ReplicationFabricInputObject.FabricName ?? null, Name, _body, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzMigrateFabricAgent_UpdateViaIdentityReplicationFabricExpanded" />
        /// cmdlet class.
        /// </summary>
        public UpdateAzMigrateFabricAgent_UpdateViaIdentityReplicationFabricExpanded()
        {
        ...
        private void Update_body()
        {
            ...
            {
                this.Property = (Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFabricAgentModelProperties)(this.MyInvocation?.BoundParameters["Property"]);
            }
        }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorResponseAutoGenerated> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IErrorResponseAutoGenerated>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFabricAgentModel> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IFabricAgentModel
