...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzMigrateReplicationProtectionCluster_List" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ReplicationProtectionClustersListByReplicationProtectionContainers(ResourceGroupName, ResourceName, SubscriptionId, FabricName, ProtectionContainerName, onOk, onDefault, this, Pipeline);
