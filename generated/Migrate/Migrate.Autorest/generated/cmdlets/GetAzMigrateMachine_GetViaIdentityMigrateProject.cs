...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetMachine=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{migrateProjectName}/machines/{machineName}"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMigrateMachine_GetViaIdentityMigrateProject")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMachine))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Description(@"Gets a machine in the migrate project.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{migrateProjectName}/machines/{machineName}", ApiVersion = "2018-09-01-preview")]
    public partial class GetAzMigrateMachine_GetViaIdentityMigrateProject : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="MigrateProjectInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateIdentity _migrateProjectInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateIdentity MigrateProjectInputObject { get => this._migrateProjectInputObject; set => this._migrateProjectInputObject = value; }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private string _name;

        /// <summary>Unique name of a machine in Azure migration hub.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Unique name of a machine in Azure migration hub.")]
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMachine">Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMachine</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMachine> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMigrateMachine_GetViaIdentityMigrateProject" /> cmdlet class.
        /// </summary>
        public GetAzMigrateMachine_GetViaIdentityMigrateProject()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (MigrateProjectInputObject?.Id != null)
                    {
                        this.MigrateProjectInputObject.Id += $"/machines/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.MachinesGetMachineViaIdentity(MigrateProjectInputObject.Id, onOk, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == MigrateProjectInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("MigrateProjectInputObject has null value for MigrateProjectInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, MigrateProjectInputObject) );
                        }
                        if (null == MigrateProjectInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("MigrateProjectInputObject has null value for MigrateProjectInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, MigrateProjectInputObject) );
                        }
                        if (null == MigrateProjectInputObject.MigrateProjectName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("MigrateProjectInputObject has null value for MigrateProjectInputObject.MigrateProjectName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, MigrateProjectInputObject) );
                        }
                        await this.Client.MachinesGetMachine(MigrateProjectInputObject.SubscriptionId ?? null, MigrateProjectInputObject.ResourceGroupName ?? null, MigrateProjectInputObject.MigrateProjectName ?? null, Name, onOk, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMachine> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMachine
