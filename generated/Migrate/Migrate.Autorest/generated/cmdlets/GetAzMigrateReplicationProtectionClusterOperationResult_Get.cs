...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMigrateReplicationProtectionClusterOperationResult_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ReplicationProtectionClustersGetOperationResults(SubscriptionId, ResourceGroupName, ResourceName, FabricName, ProtectionContainerName, ReplicationProtectionClusterName, JobId, onOk, onDefault, this, Pipeline);
