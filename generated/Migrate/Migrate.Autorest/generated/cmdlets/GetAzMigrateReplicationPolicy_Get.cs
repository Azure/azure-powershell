...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMigrateReplicationPolicy_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ReplicationPoliciesGet(SubscriptionId, ResourceGroupName, ResourceName, PolicyName, onOk, this, Pipeline);
