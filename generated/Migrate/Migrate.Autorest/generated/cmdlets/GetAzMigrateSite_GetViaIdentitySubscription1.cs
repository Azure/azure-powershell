...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/VMwareSites/{siteName}/healthSummary"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMigrateSite_GetViaIdentitySubscription1", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/VMwareSites/{siteName}/healthSummary", ApiVersion = "2020-01-01")]
    public partial class GetAzMigrateSite_GetViaIdentitySubscription1 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMigrateSite_GetViaIdentitySubscription1" /> cmdlet class.
        /// </summary>
        public GetAzMigrateSite_GetViaIdentitySubscription1()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SitesGet1' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.Subscription1InputObject.Id += $"/VMwareSites/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.SitesGet1ViaIdentity(Subscription1InputObject.Id, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.SitesGet1(Subscription1InputObject.SubscriptionId ?? null, Subscription1InputObject.ResourceGroupName ?? null, Name, onOk, this, Pipeline);
                    }
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.SitesGet1_Call(requestMessage, onOk, this, Pipeline);
                        }
                    }
                }
            }
