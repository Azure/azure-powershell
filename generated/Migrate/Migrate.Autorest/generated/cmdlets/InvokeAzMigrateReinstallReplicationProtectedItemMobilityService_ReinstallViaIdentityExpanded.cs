...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ReinstallMobilityService=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectedItems/{replicatedProtectedItemName}/reinstallMobilityService"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzMigrateReinstallReplicationProtectedItemMobilityService_ReinstallViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationProtectedItem))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Description(@"The operation to reinstall the installed mobility service software on a replication protected item to the latest available version.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectedItems/{replicatedProtectedItemName}/reinstallMobilityService", ApiVersion = "2025-08-01")]
    public partial class InvokeAzMigrateReinstallReplicationProtectedItemMobilityService_ReinstallViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReinstallMobilityServiceRequest _updateMobilityServiceRequestBody = new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.ReinstallMobilityServiceRequest();
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateIdentity _inputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateIdentity InputObject { get => this._inputObject; set => this._inputObject = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The CS run as account Id.")]
        ...
        public string RunAsAccountId { get => _updateMobilityServiceRequestBody.RunAsAccountId ?? null; set => _updateMobilityServiceRequestBody.RunAsAccountId = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api50.IErrorResponse">Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api50.IErrorResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api50.IErrorResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationProtectedItem">Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationProtectedItem</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationProtectedItem> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzMigrateReinstallReplicationProtectedItemMobilityService_ReinstallViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets.InvokeAzMigrateReinstallReplicationProtectedItemMobilityService_ReinstallViaIdentityExpanded Clone()
        {
            var clone = new InvokeAzMigrateReinstallReplicationProtectedItemMobilityService_ReinstallViaIdentityExpanded();
            ...
            clone._updateMobilityServiceRequestBody = this._updateMobilityServiceRequestBody;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzMigrateReinstallReplicationProtectedItemMobilityService_ReinstallViaIdentityExpanded"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzMigrateReinstallReplicationProtectedItemMobilityService_ReinstallViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ReplicationProtectedItemsReinstallMobilityService' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ReplicationProtectedItemsReinstallMobilityServiceViaIdentity(InputObject.Id, _updateMobilityServiceRequestBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.ProtectionContainerName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.ProtectionContainerName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        if (null == InputObject.ReplicatedProtectedItemName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.ReplicatedProtectedItemName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.ReplicationProtectedItemsReinstallMobilityService(InputObject.ResourceGroupName ?? null, InputObject.ResourceName ?? null, InputObject.SubscriptionId ?? null, InputObject.FabricName ?? null, InputObject.ProtectionContainerName ?? null, InputObject.ReplicatedProtectedItemName ?? null, _updateMobilityServiceRequestBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_updateMobilityServiceRequestBody})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api50.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api50.IErrorResponse>(responseMessage, await response);
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_updateMobilityServiceRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_updateMobilityServiceRequestBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationProtectedItem> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationProtectedItem
