...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Move, @"AzMigrateReplicationMigrationItem_MigrateViaIdentityVault", SupportsShouldProcess = true)]
    ...
    public partial class MoveAzMigrateReplicationMigrationItem_MigrateViaIdentityVault : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="MigrateInput" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateInput _migrateInput;

        /// <summary>Input for migrate.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Input for migrate.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Input for migrate.",
        SerializedName = @"migrateInput",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateInput) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateInput MigrateInput { get => this._migrateInput; set => this._migrateInput = value; }
        ...
        /// <returns>
        /// a duplicate instance of MoveAzMigrateReplicationMigrationItem_MigrateViaIdentityVault
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets.MoveAzMigrateReplicationMigrationItem_MigrateViaIdentityVault Clone()
        {
            var clone = new MoveAzMigrateReplicationMigrationItem_MigrateViaIdentityVault();
            ...
            clone.MigrateInput = this.MigrateInput;
            return clone;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MoveAzMigrateReplicationMigrationItem_MigrateViaIdentityVault" /> cmdlet
        /// class.
        /// </summary>
        public MoveAzMigrateReplicationMigrationItem_MigrateViaIdentityVault()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (VaultInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ReplicationMigrationItemsMigrateViaIdentity(VaultInputObject.Id, MigrateInput, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ReplicationMigrationItemsMigrate(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.ResourceName ?? null, FabricName, ProtectionContainerName, MigrationItemName, MigrateInput, onOk, this, Pipeline);
                    }
