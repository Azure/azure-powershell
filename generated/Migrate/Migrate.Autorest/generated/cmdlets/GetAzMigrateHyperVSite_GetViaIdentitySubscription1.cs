...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMigrateHyperVSite_GetViaIdentitySubscription1", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISiteHealthSummary))]
    ...
    public partial class GetAzMigrateHyperVSite_GetViaIdentitySubscription1 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="Subscription1InputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateIdentity _subscription1InputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.IMigrateIdentity Subscription1InputObject { get => this._subscription1InputObject; set => this._subscription1InputObject = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISiteHealthSummaryCollection">Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISiteHealthSummaryCollection</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISiteHealthSummaryCollection> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMigrateHyperVSite_GetViaIdentitySubscription1" /> cmdlet class.
        /// </summary>
        public GetAzMigrateHyperVSite_GetViaIdentitySubscription1()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (Subscription1InputObject?.Id != null)
                    {
                        this.Subscription1InputObject.Id += $"/HyperVSites/{(global::System.Uri.EscapeDataString(this.SiteName.ToString()))}";
                        await this.Client.HyperVSitesGet1ViaIdentity(Subscription1InputObject.Id, onOk, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == Subscription1InputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("Subscription1InputObject has null value for Subscription1InputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, Subscription1InputObject) );
                        }
                        if (null == Subscription1InputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("Subscription1InputObject has null value for Subscription1InputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, Subscription1InputObject) );
                        }
                        await this.Client.HyperVSitesGet1(Subscription1InputObject.SubscriptionId ?? null, Subscription1InputObject.ResourceGroupName ?? null, SiteName, onOk, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISiteHealthSummaryCollection> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.ISiteHealthSummaryCollection
