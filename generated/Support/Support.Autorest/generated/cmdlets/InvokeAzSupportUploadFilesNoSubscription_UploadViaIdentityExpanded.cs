...
namespace Microsoft.Azure.PowerShell.Cmdlets.Support.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Upload=>POST:"/providers/Microsoft.Support/fileWorkspaces/{fileWorkspaceName}/files/{fileName}/upload"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Support.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzSupportUploadFilesNoSubscription_UploadViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Support.HttpPath(Path = "/providers/Microsoft.Support/fileWorkspaces/{fileWorkspaceName}/files/{fileName}/upload", ApiVersion = "2024-04-01")]
    public partial class InvokeAzSupportUploadFilesNoSubscription_UploadViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Support.Models.IUploadFile _uploadFileBody = new Microsoft.Azure.PowerShell.Cmdlets.Support.Models.UploadFile();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Index of the uploaded chunk (Index starts at 0)")]
        ...
        public int ChunkIndex { get => _uploadFileBody.ChunkIndex ?? default(int); set => _uploadFileBody.ChunkIndex = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "File Content in base64 encoded format")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Support.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Support.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string Content { get => _uploadFileBody.Content ?? null; set => _uploadFileBody.Content = value; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzSupportUploadFilesNoSubscription_UploadViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public InvokeAzSupportUploadFilesNoSubscription_UploadViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'FilesNoSubscriptionUpload' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.FilesNoSubscriptionUploadViaIdentity(InputObject.Id, _uploadFileBody, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == InputObject.FileWorkspaceName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.FileWorkspaceName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        ...
                        await this.Client.FilesNoSubscriptionUpload(InputObject.FileWorkspaceName ?? null, InputObject.FileName ?? null, _uploadFileBody, onNoContent, onDefault, this, Pipeline);
                    }
