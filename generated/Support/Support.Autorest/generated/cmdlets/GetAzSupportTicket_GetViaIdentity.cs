...
namespace Microsoft.Azure.PowerShell.Cmdlets.Support.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzSupportTicket_GetViaIdentity" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.SupportTicketsGet(InputObject.SubscriptionId ?? null, InputObject.SupportTicketName ?? null, onOk, onDefault, this, Pipeline);
                    }
