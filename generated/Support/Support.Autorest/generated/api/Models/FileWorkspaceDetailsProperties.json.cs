...
namespace Microsoft.Azure.PowerShell.Cmdlets.Support.Models
{
    ...
    public partial class FileWorkspaceDetailsProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject into a new instance of <see cref="FileWorkspaceDetailsProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal FileWorkspaceDetailsProperties(Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Support.Models.IFileWorkspaceDetailsProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Support.Models.IFileWorkspaceDetailsProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Support.Models.IFileWorkspaceDetailsProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject json ? new FileWorkspaceDetailsProperties(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="FileWorkspaceDetailsProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="FileWorkspaceDetailsProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != this._createdOn ? (Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.Json.JsonString(this._createdOn?.ToString(@"yyyy'-'MM'-'dd'T'HH':'mm':'ss.fffffffK",global::System.Globalization.CultureInfo.InvariantCulture)) : null, "createdOn" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.SerializationMode.IncludeRead))
            {
