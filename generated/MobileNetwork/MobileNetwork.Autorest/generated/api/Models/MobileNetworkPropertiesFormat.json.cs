...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models
{
    ...
    public partial class MobileNetworkPropertiesFormat
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IMobileNetworkPropertiesFormat.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IMobileNetworkPropertiesFormat.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IMobileNetworkPropertiesFormat FromJson(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonObject json ? new MobileNetworkPropertiesFormat(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonObject into a new instance of <see cref="MobileNetworkPropertiesFormat" />.
        /// </summary>
        ...
        internal MobileNetworkPropertiesFormat(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonObject json)
        {
            ...
            {_publicLandMobileNetworkIdentifier = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonObject>("publicLandMobileNetworkIdentifier"), out var __jsonPublicLandMobileNetworkIdentifier) ? Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.PlmnId.FromJson(__jsonPublicLandMobileNetworkIdentifier) : _publicLandMobileNetworkIdentifier;}
            ...
            {_serviceKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonString>("serviceKey"), out var __jsonServiceKey) ? (string)__jsonServiceKey : (string)_serviceKey;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="MobileNetworkPropertiesFormat" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MobileNetworkPropertiesFormat" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._publicLandMobileNetworkIdentifier ? (Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode) this._publicLandMobileNetworkIdentifier.ToJson(null,serializationMode) : null, "publicLandMobileNetworkIdentifier" ,container.Add );
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.SerializationMode.IncludeRead))
            {
                AddIf( null != (((object)this._serviceKey)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonString(this._serviceKey.ToString()) : null, "serviceKey" ,container.Add );
            }
