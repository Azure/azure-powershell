...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models
{
    ...
    public partial class PlmnId
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IPlmnId.
        /// </summary>
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IPlmnId.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IPlmnId FromJson(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode node)
        {
        ...
        internal PlmnId(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonObject json)
        {
            ...
            {_mcc = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonString>("mcc"), out var __jsonMcc) ? (string)__jsonMcc : (string)_mcc;}
            {_mnc = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonString>("mnc"), out var __jsonMnc) ? (string)__jsonMnc : (string)_mnc;}
            AfterFromJson(json);
        }
