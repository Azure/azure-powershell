...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets
{
    ...
    /// <summary>
    /// create a data network. Must be created in the same location as its parent mobile network.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/mobileNetworks/{mobileNetworkName}/dataNetworks/{dataNetworkName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzMobileNetworkDataNetwork_CreateViaIdentityExpanded", SupportsShouldProcess = true)]
    [Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.CmdletBreakingChange("14.5.0", "0.5.0", "2025/09/30")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IDataNetwork))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Description(@"create a data network. Must be created in the same location as its parent mobile network.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/mobileNetworks/{mobileNetworkName}/dataNetworks/{dataNetworkName}", ApiVersion = "2022-11-01")]
    public partial class NewAzMobileNetworkDataNetwork_CreateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.IContext
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IDataNetwork _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.DataNetwork();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "An optional description for this data network.")]
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IDataNetwork">Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IDataNetwork</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IDataNetwork> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzMobileNetworkDataNetwork_CreateViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets.NewAzMobileNetworkDataNetwork_CreateViaIdentityExpanded Clone()
        {
            var clone = new NewAzMobileNetworkDataNetwork_CreateViaIdentityExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzMobileNetworkDataNetwork_CreateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public NewAzMobileNetworkDataNetwork_CreateViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DataNetworksCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DataNetworksCreateOrUpdateViaIdentity(InputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.MobileNetworkName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.MobileNetworkName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        if (null == InputObject.DataNetworkName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.DataNetworkName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.DataNetworksCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.MobileNetworkName ?? null, InputObject.DataNetworkName ?? null, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.SerializationMode.IncludeCreate);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IDataNetwork> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IDataNetwork
