...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/simGroups/{simGroupName}/sims/{simName}"
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMobileNetworkSim_UpdateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Description(@"update a SIM.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Generated]
    public partial class UpdateAzMobileNetworkSim_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the SIM Group.")]
        [Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("SimGroupName")]
        ...
        /// <returns>a duplicate instance of UpdateAzMobileNetworkSim_UpdateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets.UpdateAzMobileNetworkSim_UpdateExpanded Clone()
        {
            var clone = new UpdateAzMobileNetworkSim_UpdateExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    _parametersBody = await this.Client.SimsGetWithResult(SubscriptionId, ResourceGroupName, GroupName, Name, this, Pipeline);
                    this.Update_parametersBody();
                    await this.Client.SimsCreateOrUpdate(SubscriptionId, ResourceGroupName, GroupName, Name, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.SerializationMode.IncludeUpdate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzMobileNetworkSim_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzMobileNetworkSim_UpdateExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("IntegratedCircuitCardIdentifier")))
            {
                this.IntegratedCircuitCardIdentifier = (string)(this.MyInvocation?.BoundParameters["IntegratedCircuitCardIdentifier"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("DeviceType")))
            {
                this.DeviceType = (string)(this.MyInvocation?.BoundParameters["DeviceType"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("StaticIPConfiguration")))
            {
                this.StaticIPConfiguration = (Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.ISimStaticIPProperties[])(this.MyInvocation?.BoundParameters["StaticIPConfiguration"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("AuthenticationKey")))
            {
                this.AuthenticationKey = (string)(this.MyInvocation?.BoundParameters["AuthenticationKey"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("OperatorKeyCode")))
            {
                this.OperatorKeyCode = (string)(this.MyInvocation?.BoundParameters["OperatorKeyCode"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SimPolicyId")))
            {
                this.SimPolicyId = (string)(this.MyInvocation?.BoundParameters["SimPolicyId"]);
            }
        }
