...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.IEventListener
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.SimsBulkUpload(InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.SimGroupName ?? null, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzMobileNetworkBulkSimUpload_BulkViaIdentityExpanded" /> cmdlet class.
        /// </summary>
