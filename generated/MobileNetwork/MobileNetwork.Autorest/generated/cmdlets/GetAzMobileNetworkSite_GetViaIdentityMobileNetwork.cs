...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/mobileNetworks/{mobileNetworkName}/sites/{siteName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMobileNetworkSite_GetViaIdentityMobileNetwork")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Description(@"Gets information about the specified mobile network site.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/mobileNetworks/{mobileNetworkName}/sites/{siteName}", ApiVersion = "2022-11-01")]
    public partial class GetAzMobileNetworkSite_GetViaIdentityMobileNetwork : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="MobileNetworkInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IMobileNetworkIdentity _mobileNetworkInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IMobileNetworkIdentity MobileNetworkInputObject { get => this._mobileNetworkInputObject; set => this._mobileNetworkInputObject = value; }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private string _name;

        /// <summary>The name of the mobile network site.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the mobile network site.")]
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.ISite">Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.ISite</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.ISite> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMobileNetworkSite_GetViaIdentityMobileNetwork" /> cmdlet class.
        /// </summary>
        public GetAzMobileNetworkSite_GetViaIdentityMobileNetwork()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (MobileNetworkInputObject?.Id != null)
                    {
                        this.MobileNetworkInputObject.Id += $"/sites/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.SitesGetViaIdentity(MobileNetworkInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == MobileNetworkInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("MobileNetworkInputObject has null value for MobileNetworkInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, MobileNetworkInputObject) );
                        }
                        if (null == MobileNetworkInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("MobileNetworkInputObject has null value for MobileNetworkInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, MobileNetworkInputObject) );
                        }
                        if (null == MobileNetworkInputObject.MobileNetworkName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("MobileNetworkInputObject has null value for MobileNetworkInputObject.MobileNetworkName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, MobileNetworkInputObject) );
                        }
                        await this.Client.SitesGet(MobileNetworkInputObject.SubscriptionId ?? null, MobileNetworkInputObject.ResourceGroupName ?? null, MobileNetworkInputObject.MobileNetworkName ?? null, Name, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.ISite> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.ISite
