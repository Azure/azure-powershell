...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview
{
    ...
    public partial class SapDatabaseProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview.ISapDatabaseProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview.ISapDatabasePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview.ISapDatabasePropertiesInternal.DatabaseSid { get => this._databaseSid; set { {_databaseSid = value;} } }

        /// <summary>Internal Acessors for DatabaseType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview.ISapDatabasePropertiesInternal.DatabaseType { get => this._databaseType; set { {_databaseType = value;} } }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview.ISapDatabasePropertiesInternal.IPAddress { get => this._iPAddress; set { {_iPAddress = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support.SapVirtualInstanceProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview.ISapDatabasePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Support.SapVirtualInstanceStatus? Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview.ISapDatabasePropertiesInternal.Status { get => this._status; set { {_status = value;} } }

        /// <summary>Internal Acessors for Subnet</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview.ISapDatabasePropertiesInternal.Subnet { get => this._subnet; set { {_subnet = value;} } }

        /// <summary>Internal Acessors for VMDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview.IDatabaseVMDetails[] Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview.ISapDatabasePropertiesInternal.VMDetail { get => this._vMDetail; set { {_vMDetail = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview.IDatabaseVMDetails[] _vMDetail;

        /// <summary>The list of virtual machines corresponding to the Database resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Workloads.Origin(Microsoft.Azure.PowerShell.Cmdlets.Workloads.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.Models.Api20231001Preview.IDatabaseVMDetails[] VMDetail { get => this._vMDetail; }
