...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models
{
    ...
    public partial class OSSapConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IOSSapConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IOSSapConfigurationInternal
    {

        /// <summary>Backing field for <see cref="DeployerVMPackage" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IDeployerVMPackages _deployerVMPackage;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IDeployerVMPackages DeployerVMPackage { get => (this._deployerVMPackage = this._deployerVMPackage ?? new Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.DeployerVMPackages()); set => this._deployerVMPackage = value; }
        ...
        public string DeployerVMPackageStorageAccountId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IDeployerVMPackagesInternal)DeployerVMPackage).StorageAccountId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IDeployerVMPackagesInternal)DeployerVMPackage).StorageAccountId = value ?? null; }

        /// <summary>The URL to the deployer VM packages file.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.PropertyOrigin.Inlined)]
        public string DeployerVMPackageUrl { get => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IDeployerVMPackagesInternal)DeployerVMPackage).Url; set => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IDeployerVMPackagesInternal)DeployerVMPackage).Url = value ?? null; }

        /// <summary>Internal Acessors for DeployerVMPackage</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IDeployerVMPackages Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IOSSapConfigurationInternal.DeployerVMPackage { get => (this._deployerVMPackage = this._deployerVMPackage ?? new Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.DeployerVMPackages()); set { {_deployerVMPackage = value;} } }
    ...
    {
        /// <summary>The url and storage account ID where deployer VM packages are uploaded</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IDeployerVMPackages DeployerVMPackage { get; set; }
        /// <summary>The deployer VM packages storage account id</summary>
        string DeployerVMPackageStorageAccountId { get; set; }
        /// <summary>The URL to the deployer VM packages file.</summary>
        string DeployerVMPackageUrl { get; set; }
