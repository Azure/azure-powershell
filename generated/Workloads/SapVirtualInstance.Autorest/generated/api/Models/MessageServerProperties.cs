...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models
{
    ...
    public partial class MessageServerProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IMessageServerProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IMessageServerPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IMessageServerPropertiesInternal.Health { get => this._health; set { {_health = value;} } }

        /// <summary>Internal Acessors for Hostname</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IMessageServerPropertiesInternal.Hostname { get => this._hostname; set { {_hostname = value;} } }

        /// <summary>Internal Acessors for HttpPort</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IMessageServerPropertiesInternal.HttpPort { get => this._httpPort; set { {_httpPort = value;} } }

        /// <summary>Internal Acessors for HttpsPort</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IMessageServerPropertiesInternal.HttpsPort { get => this._httpsPort; set { {_httpsPort = value;} } }

        /// <summary>Internal Acessors for IPAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IMessageServerPropertiesInternal.IPAddress { get => this._iPAddress; set { {_iPAddress = value;} } }

        /// <summary>Internal Acessors for InternalMSPort</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IMessageServerPropertiesInternal.InternalMSPort { get => this._internalMSPort; set { {_internalMSPort = value;} } }

        /// <summary>Internal Acessors for MSPort</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IMessageServerPropertiesInternal.MSPort { get => this._mSPort; set { {_mSPort = value;} } }
