...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models
{
    ...
    public partial class SapDiskConfigurationsResult :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.ISapDiskConfigurationsResultInternal
    {

        /// <summary>Backing field for <see cref="VolumeConfiguration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.ISapDiskConfigurationsResultVolumeConfigurations _volumeConfiguration;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.ISapDiskConfigurationsResultVolumeConfigurations VolumeConfiguration { get => (this._volumeConfiguration = this._volumeConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.SapDiskConfigurationsResultVolumeConfigurations()); set => this._volumeConfiguration = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.ISapDiskConfigurationsResultVolumeConfigurations) })]
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.ISapDiskConfigurationsResultVolumeConfigurations VolumeConfiguration { get; set; }
