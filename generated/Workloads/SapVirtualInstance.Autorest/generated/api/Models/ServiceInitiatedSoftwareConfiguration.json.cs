...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models
{
    ...
    public partial class ServiceInitiatedSoftwareConfiguration
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IServiceInitiatedSoftwareConfiguration.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IServiceInitiatedSoftwareConfiguration.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IServiceInitiatedSoftwareConfiguration FromJson(Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode node)
        {
        ...
        internal ServiceInitiatedSoftwareConfiguration(Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonObject json)
        {
            ...
            {_bomUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonString>("bomUrl"), out var __jsonBomUrl) ? (string)__jsonBomUrl : (string)_bomUrl;}
            {_softwareVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonString>("softwareVersion"), out var __jsonSoftwareVersion) ? (string)__jsonSoftwareVersion : (string)_softwareVersion;}
            {_sapBitsStorageAccountId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonString>("sapBitsStorageAccountId"), out var __jsonSapBitsStorageAccountId) ? (string)__jsonSapBitsStorageAccountId : (string)_sapBitsStorageAccountId;}
            {_sapFqdn = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonString>("sapFqdn"), out var __jsonSapFqdn) ? (string)__jsonSapFqdn : (string)_sapFqdn;}
            {_sshPrivateKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonString>("sshPrivateKey"), out var __jsonSshPrivateKey) ? new System.Net.NetworkCredential("",(string)__jsonSshPrivateKey).SecurePassword : _sshPrivateKey;}
            AfterFromJson(json);
        }
