...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901
{
    ...
    public partial class StorageConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901.IStorageConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901.IStorageConfigurationInternal
    {

        /// <summary>Internal Acessors for TransportFileShareConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901.IFileShareConfiguration Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901.IStorageConfigurationInternal.TransportFileShareConfiguration { get => (this._transportFileShareConfiguration = this._transportFileShareConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901.FileShareConfiguration()); set { {_transportFileShareConfiguration = value;} } }

        /// <summary>Backing field for <see cref="TransportFileShareConfiguration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901.IFileShareConfiguration _transportFileShareConfiguration;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901.IFileShareConfiguration TransportFileShareConfiguration { get => (this._transportFileShareConfiguration = this._transportFileShareConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901.FileShareConfiguration()); set => this._transportFileShareConfiguration = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Support.FileShareConfigurationType? TransportFileShareConfigurationType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901.IFileShareConfigurationInternal)TransportFileShareConfiguration).ConfigurationType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901.IFileShareConfigurationInternal)TransportFileShareConfiguration).ConfigurationType = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Support.FileShareConfigurationType)""); }
...

    {
        ...
        /// createAndMount flow if storage configuration is missing.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901.IFileShareConfiguration TransportFileShareConfiguration { get; set; }
        /// <summary>The type of file share config, eg: Mount/CreateAndMount/Skip.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Support.FileShareConfigurationType? TransportFileShareConfigurationType { get; set; }
