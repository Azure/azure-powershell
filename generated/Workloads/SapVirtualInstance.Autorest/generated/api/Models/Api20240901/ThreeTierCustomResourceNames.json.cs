...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901
{
    ...
    public partial class ThreeTierCustomResourceNames
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901.IThreeTierCustomResourceNames.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901.IThreeTierCustomResourceNames
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901.IThreeTierCustomResourceNames.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20240901.IThreeTierCustomResourceNames FromJson(Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("namingPatternType") )
            {
                ...
                {
                    return new ThreeTierFullResourceNames(json);
                }
            }
            return new ThreeTierCustomResourceNames(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonObject into a new instance of <see cref="ThreeTierCustomResourceNames" />.
        /// </summary>
        ...
        internal ThreeTierCustomResourceNames(Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonObject json)
        {
            ...
            {_namingPatternType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonString>("namingPatternType"), out var __jsonNamingPatternType) ? (string)__jsonNamingPatternType : (string)NamingPatternType;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="ThreeTierCustomResourceNames" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ThreeTierCustomResourceNames" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode" />.
        /// </returns>
