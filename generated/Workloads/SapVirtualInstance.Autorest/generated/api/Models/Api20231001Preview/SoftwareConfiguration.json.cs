...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview
{
    ...
    public partial class SoftwareConfiguration
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.ISoftwareConfiguration.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.ISoftwareConfiguration
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.ISoftwareConfiguration.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.ISoftwareConfiguration FromJson(Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("softwareInstallationType") )
            {
                case "ServiceInitiated":
                {
                    return new ServiceInitiatedSoftwareConfiguration(json);
                }
                case "SAPInstallWithoutOSConfig":
                {
                    return new SapInstallWithoutOsconfigSoftwareConfiguration(json);
                }
                case "External":
                {
                    return new ExternalInstallationSoftwareConfiguration(json);
                }
            }
            return new SoftwareConfiguration(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonObject into a new instance of <see cref="SoftwareConfiguration" />.
        /// </summary>
        ...
        internal SoftwareConfiguration(Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonObject json)
        {
            ...
            {_softwareInstallationType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonString>("softwareInstallationType"), out var __jsonSoftwareInstallationType) ? (string)__jsonSoftwareInstallationType : (string)SoftwareInstallationType;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SoftwareConfiguration" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SoftwareConfiguration" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode" />.
        /// </returns>
