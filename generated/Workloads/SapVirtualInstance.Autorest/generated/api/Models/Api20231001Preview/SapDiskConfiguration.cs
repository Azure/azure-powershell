...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview
{
    ...
    public partial class SapDiskConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.ISapDiskConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.ISapDiskConfigurationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.IDiskVolumeConfiguration _recommendedConfiguration;
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.IDiskDetails[] _supportedConfiguration;

        /// <summary>The list of supported disks for a given VM Sku.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.IDiskDetails[] SupportedConfiguration { get => this._supportedConfiguration; set => this._supportedConfiguration = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.IDiskDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.IDiskDetails[] SupportedConfiguration { get; set; }
    ...
    {
        /// <summary>The recommended disk details for a given VM Sku.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.IDiskVolumeConfiguration RecommendedConfiguration { get; set; }
        /// <summary>The total number of disks required for the concerned volume.</summary>
        long? RecommendedConfigurationCount { get; set; }
        /// <summary>The disk size in GB.</summary>
        long? RecommendedConfigurationSizeGb { get; set; }
        /// <summary>The disk SKU details.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.IDiskSku RecommendedConfigurationSku { get; set; }
        /// <summary>Defines the disk sku name.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Support.DiskSkuName? SkuName { get; set; }
        /// <summary>The list of supported disks for a given VM Sku.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.Api20231001Preview.IDiskDetails[] SupportedConfiguration { get; set; }
