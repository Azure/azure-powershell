...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Support";
