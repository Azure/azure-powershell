...
namespace Microsoft.Azure.PowerShell.Cmdlets.Informatica.Models
{
    ...
    public partial class CheckDependenciesResponse
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonObject into a new instance of <see cref="CheckDependenciesResponse" />.
        /// </summary>
        ...
        internal CheckDependenciesResponse(Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonObject json)
        {
            ...
            {_count = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonNumber>("count"), out var __jsonCount) ? (int)__jsonCount : _count;}
            ...
            {_reference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonArray>("references"), out var __jsonReferences) ? If( __jsonReferences as Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Informatica.Models.IServerlessRuntimeDependency>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Informatica.Models.IServerlessRuntimeDependency) (Microsoft.Azure.PowerShell.Cmdlets.Informatica.Models.ServerlessRuntimeDependency.FromJson(__u) )) ))() : null : _reference;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Informatica.Models.ICheckDependenciesResponse.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Informatica.Models.ICheckDependenciesResponse.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Informatica.Models.ICheckDependenciesResponse FromJson(Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonObject json ? new CheckDependenciesResponse(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CheckDependenciesResponse" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CheckDependenciesResponse" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( (Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonNumber(this._count), "count" ,container.Add );
            ...
            if (null != this._reference)
            {
                ...
                foreach( var __x in this._reference )
                {
                    AddIf(__x?.ToJson(null, serializationMode) ,__w.Add);
                }
                container.Add("references",__w);
            }
