...
namespace Microsoft.Azure.PowerShell.Cmdlets.Informatica.Models
{
    ...
    public partial class ServerlessMetadataResponse
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Informatica.Models.IServerlessMetadataResponse.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Informatica.Models.IServerlessMetadataResponse.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Informatica.Models.IServerlessMetadataResponse FromJson(Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonObject json ? new ServerlessMetadataResponse(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonObject into a new instance of <see cref="ServerlessMetadataResponse" />.
        /// </summary>
        ...
        internal ServerlessMetadataResponse(Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonObject json)
        {
            ...
            {_serverlessConfigProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonObject>("serverlessConfigProperties"), out var __jsonServerlessConfigProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Informatica.Models.ServerlessConfigProperties.FromJson(__jsonServerlessConfigProperties) : _serverlessConfigProperty;}
            {_serverlessRuntimeConfigProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonObject>("serverlessRuntimeConfigProperties"), out var __jsonServerlessRuntimeConfigProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Informatica.Models.ServerlessRuntimeConfigProperties.FromJson(__jsonServerlessRuntimeConfigProperties) : _serverlessRuntimeConfigProperty;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="ServerlessMetadataResponse" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ServerlessMetadataResponse" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._serverlessRuntimeConfigProperty ? (Microsoft.Azure.PowerShell.Cmdlets.Informatica.Runtime.Json.JsonNode) this._serverlessRuntimeConfigProperty.ToJson(null,serializationMode) : null, "serverlessRuntimeConfigProperties" ,container.Add );
