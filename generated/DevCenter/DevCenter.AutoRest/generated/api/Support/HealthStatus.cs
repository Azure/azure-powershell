...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.HealthStatus Healthy = @"Healthy";

        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.HealthStatus Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.HealthStatus Unhealthy = @"Unhealthy";

        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.HealthStatus Unknown = @"Unknown";

        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.HealthStatus Warning = @"Warning";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.HealthStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.HealthStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.HealthStatus e1, Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.HealthStatus e2)
        {
            return !e2.Equals(e1);
        }
