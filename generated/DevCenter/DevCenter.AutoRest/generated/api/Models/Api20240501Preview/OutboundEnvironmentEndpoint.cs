...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview
{
    ...
    public partial class OutboundEnvironmentEndpoint :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IOutboundEnvironmentEndpointInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IEndpointDependency[] _endpoint;

        /// <summary>The endpoints for this service for which the agent requires outbound access.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Origin(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IEndpointDependency[] Endpoint { get => this._endpoint; }

        /// <summary>Internal Acessors for Category</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IOutboundEnvironmentEndpointInternal.Category { get => this._category; set { {_category = value;} } }

        /// <summary>Internal Acessors for Endpoint</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IEndpointDependency[] Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IOutboundEnvironmentEndpointInternal.Endpoint { get => this._endpoint; set { {_endpoint = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IEndpointDependency) })]
        Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IEndpointDependency[] Endpoint { get;  }
...

    {
        ...
        /// <summary>The endpoints for this service for which the agent requires outbound access.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IEndpointDependency[] Endpoint { get; set; }
