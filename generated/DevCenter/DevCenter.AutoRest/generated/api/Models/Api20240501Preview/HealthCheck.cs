...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview
{
    ...
    public partial class HealthCheck :
        Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IHealthCheck,
        Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IHealthCheckInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IHealthCheckInternal.AdditionalDetail { get => this._additionalDetail; set { {_additionalDetail = value;} } }

        /// <summary>Internal Acessors for DisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IHealthCheckInternal.DisplayName { get => this._displayName; set { {_displayName = value;} } }

        /// <summary>Internal Acessors for EndDateTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IHealthCheckInternal.EndDateTime { get => this._endDateTime; set { {_endDateTime = value;} } }

        /// <summary>Internal Acessors for ErrorType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IHealthCheckInternal.ErrorType { get => this._errorType; set { {_errorType = value;} } }

        /// <summary>Internal Acessors for RecommendedAction</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IHealthCheckInternal.RecommendedAction { get => this._recommendedAction; set { {_recommendedAction = value;} } }

        /// <summary>Internal Acessors for StartDateTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IHealthCheckInternal.StartDateTime { get => this._startDateTime; set { {_startDateTime = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.HealthCheckStatus? Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20240501Preview.IHealthCheckInternal.Status { get => this._status; set { {_status = value;} } }
