...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models
{
    ...
    public partial class DevCenterIdentity
    {
        ...
        internal DevCenterIdentity(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonObject json)
        {
            ...
            {_planName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonString>("planName"), out var __jsonPlanName) ? (string)__jsonPlanName : (string)PlanName;}
            {_memberName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonString>("memberName"), out var __jsonMemberName) ? (string)__jsonMemberName : (string)MemberName;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._planName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonString(this._planName.ToString()) : null, "planName" ,container.Add );
            AddIf( null != (((object)this._memberName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonString(this._memberName.ToString()) : null, "memberName" ,container.Add );
