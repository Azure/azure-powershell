...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models
{
    ...
    public partial class DevCenterIdentity
    {
        ...
        internal DevCenterIdentity(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonObject json)
        {
            ...
            {_encryptionSetName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonString>("encryptionSetName"), out var __jsonEncryptionSetName) ? (string)__jsonEncryptionSetName : (string)EncryptionSetName;}
            {_projectPolicyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonString>("projectPolicyName"), out var __jsonProjectPolicyName) ? (string)__jsonProjectPolicyName : (string)ProjectPolicyName;}
            ...
            {_imageDefinitionName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonString>("imageDefinitionName"), out var __jsonImageDefinitionName) ? (string)__jsonImageDefinitionName : (string)ImageDefinitionName;}
            {_buildName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonString>("buildName"), out var __jsonBuildName) ? (string)__jsonBuildName : (string)BuildName;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._encryptionSetName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonString(this._encryptionSetName.ToString()) : null, "encryptionSetName" ,container.Add );
            AddIf( null != (((object)this._projectPolicyName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonString(this._projectPolicyName.ToString()) : null, "projectPolicyName" ,container.Add );
            ...
            AddIf( null != (((object)this._imageDefinitionName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonString(this._imageDefinitionName.ToString()) : null, "imageDefinitionName" ,container.Add );
            AddIf( null != (((object)this._buildName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Runtime.Json.JsonString(this._buildName.ToString()) : null, "buildName" ,container.Add );
