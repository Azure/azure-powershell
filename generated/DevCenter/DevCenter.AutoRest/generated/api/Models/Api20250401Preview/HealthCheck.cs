...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20250401Preview
{
    ...
    public partial class HealthCheck :
        Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20250401Preview.IHealthCheck,
        Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20250401Preview.IHealthCheckInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20250401Preview.IHealthCheckInternal.AdditionalDetail { get => this._additionalDetail; set { {_additionalDetail = value;} } }

        /// <summary>Internal Acessors for DisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20250401Preview.IHealthCheckInternal.DisplayName { get => this._displayName; set { {_displayName = value;} } }

        /// <summary>Internal Acessors for EndDateTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20250401Preview.IHealthCheckInternal.EndDateTime { get => this._endDateTime; set { {_endDateTime = value;} } }

        /// <summary>Internal Acessors for ErrorType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20250401Preview.IHealthCheckInternal.ErrorType { get => this._errorType; set { {_errorType = value;} } }

        /// <summary>Internal Acessors for RecommendedAction</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20250401Preview.IHealthCheckInternal.RecommendedAction { get => this._recommendedAction; set { {_recommendedAction = value;} } }

        /// <summary>Internal Acessors for StartDateTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20250401Preview.IHealthCheckInternal.StartDateTime { get => this._startDateTime; set { {_startDateTime = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.HealthCheckStatus? Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Models.Api20250401Preview.IHealthCheckInternal.Status { get => this._status; set { {_status = value;} } }
