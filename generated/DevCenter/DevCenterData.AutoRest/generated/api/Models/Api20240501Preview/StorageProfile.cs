...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IStorageProfileInternal
    {
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IOSDisk OSDisk { get => (this._oSDisk = this._oSDisk ?? new Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.OSDisk()); set => this._oSDisk = value; }
        ...
        public int? OSDiskSizeGb { get => ((Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IOSDiskInternal)OSDisk).DiskSizeGb; }
    ...
    {
        /// <summary>Settings for the operating system disk.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IOSDisk OSDisk { get; set; }
        /// <summary>The size of the OS Disk in gigabytes.</summary>
