...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview
{
    ...
    public partial class EnvironmentDefinition
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonObject into a new instance of <see cref="EnvironmentDefinition" />.
        /// </summary>
        ...
        internal EnvironmentDefinition(Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonObject json)
        {
            ...
            {_parameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonArray>("parameters"), out var __jsonParameters) ? If( __jsonParameters as Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IEnvironmentDefinitionParameter[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IEnvironmentDefinitionParameter) (Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.EnvironmentDefinitionParameter.FromJson(__u) )) ))() : null : Parameter;}
            {_parametersSchema = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonString>("parametersSchema"), out var __jsonParametersSchema) ? (string)__jsonParametersSchema : (string)ParametersSchema;}
            {_templatePath = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonString>("templatePath"), out var __jsonTemplatePath) ? (string)__jsonTemplatePath : (string)TemplatePath;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IEnvironmentDefinition.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IEnvironmentDefinition.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IEnvironmentDefinition FromJson(Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonObject json ? new EnvironmentDefinition(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="EnvironmentDefinition" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="EnvironmentDefinition" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._parametersSchema)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonString(this._parametersSchema.ToString()) : null, "parametersSchema" ,container.Add );
            AddIf( null != (((object)this._templatePath)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonString(this._templatePath.ToString()) : null, "templatePath" ,container.Add );
