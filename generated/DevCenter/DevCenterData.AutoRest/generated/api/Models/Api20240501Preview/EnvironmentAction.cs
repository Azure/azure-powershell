...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview
{
    ...
    public partial class EnvironmentAction :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IEnvironmentActionInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IEnvironmentActionInternal.ActionType { get => this._actionType; set { {_actionType = value;} } }

        /// <summary>Internal Acessors for LastModifiedBy</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IEnvironmentActionInternal.LastModifiedBy { get => this._lastModifiedBy; set { {_lastModifiedBy = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IEnvironmentActionInternal.Name { get => this._name; set { {_name = value;} } }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IEnvironmentActionInternal.Uri { get => this._uri; set { {_uri = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IEnvironmentNextAction _next;

        /// <summary>Details about the next run of this action.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Origin(Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IEnvironmentNextAction Next { get => (this._next = this._next ?? new Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.EnvironmentNextAction()); set => this._next = value; }
...

    {
        ...
        string Name { get; set; }
        /// <summary>Details about the next run of this action.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models.Api20240501Preview.IEnvironmentNextAction Next { get; set; }
        /// <summary>The time the action will be triggered (UTC).</summary>
        global::System.DateTime? NextScheduledTime { get; set; }
        /// <summary>Uri of the action resource.</summary>
        string Uri { get; set; }
