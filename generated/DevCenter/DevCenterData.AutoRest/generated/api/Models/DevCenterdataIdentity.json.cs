...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Models
{
    ...
    public partial class DevCenterdataIdentity
    {
        ...
        internal DevCenterdataIdentity(Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonObject json)
        {
            ...
            {_imageBuildLogId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonString>("imageBuildLogId"), out var __jsonImageBuildLogId) ? (string)__jsonImageBuildLogId : (string)ImageBuildLogId;}
            ...
            {_addOnName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonString>("addOnName"), out var __jsonAddOnName) ? (string)__jsonAddOnName : (string)AddOnName;}
            ...
            {_environmentTypeName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonString>("environmentTypeName"), out var __jsonEnvironmentTypeName) ? (string)__jsonEnvironmentTypeName : (string)EnvironmentTypeName;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._imageBuildLogId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonString(this._imageBuildLogId.ToString()) : null, "imageBuildLogId" ,container.Add );
            ...
            AddIf( null != (((object)this._addOnName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonString(this._addOnName.ToString()) : null, "addOnName" ,container.Add );
            ...
            AddIf( null != (((object)this._environmentTypeName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Runtime.Json.JsonString(this._environmentTypeName.ToString()) : null, "environmentTypeName" ,container.Add );
