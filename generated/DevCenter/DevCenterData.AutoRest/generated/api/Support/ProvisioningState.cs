...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Support
{
    ...
    {
        /// <summary>Resource is creating.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Support.ProvisioningState Creating = @"Creating";

        /// <summary>Resource is being deleted.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Support.ProvisioningState Deleting = @"Deleting";

        /// <summary>Resource failed to provision.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Support.ProvisioningState Failed = @"Failed";

        /// <summary>Resource was successfully provisioned.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Support.ProvisioningState Succeeded = @"Succeeded";

        /// <summary>Resource is being updated.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.DevCenterdata.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
