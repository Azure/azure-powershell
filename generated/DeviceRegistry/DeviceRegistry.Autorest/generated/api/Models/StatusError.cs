...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models
{
    ...
    public partial class StatusError :
        Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IStatusError,
        Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IStatusErrorInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IStatusErrorInternal.Code { get => this._code; set { {_code = value;} } }

        /// <summary>Internal Acessors for Detail</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IErrorDetails> Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IStatusErrorInternal.Detail { get => this._detail; set { {_detail = value;} } }

        /// <summary>Internal Acessors for Message</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IStatusErrorInternal.Message { get => this._message; set { {_message = value;} } }

        /// <summary>Creates an new <see cref="StatusError" /> instance.</summary>
        public StatusError()
        {
    ...
    public partial interface IStatusError :
    ...
    /// Defines the status config error properties.
    internal partial interface IStatusErrorInternal
