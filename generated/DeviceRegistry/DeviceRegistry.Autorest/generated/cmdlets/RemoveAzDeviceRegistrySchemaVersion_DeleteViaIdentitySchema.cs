            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (SchemaInputObject?.Id != null)
                    {
                        ...
                        await this.Client.SchemaVersionsDeleteViaIdentity(SchemaInputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.SchemaVersionsDelete(SchemaInputObject.SubscriptionId ?? null, SchemaInputObject.ResourceGroupName ?? null, SchemaInputObject.SchemaRegistryName ?? null, SchemaInputObject.SchemaName ?? null, Name, onOk, onNoContent, onDefault, this, Pipeline);
                    }
