...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RevokeIssuer=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeviceRegistry/namespaces/{namespaceName}/credentials/default/policies/{policyName}/revokeIssuer"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsSecurity.Revoke, @"AzDeviceRegistryPolicyIssuer_RevokeViaIdentityNamespace", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeviceRegistry/namespaces/{namespaceName}/credentials/default/policies/{policyName}/revokeIssuer", ApiVersion = "2026-03-01-preview")]
    public partial class RevokeAzDeviceRegistryPolicyIssuer_RevokeViaIdentityNamespace : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of RevokeAzDeviceRegistryPolicyIssuer_RevokeViaIdentityNamespace
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Cmdlets.RevokeAzDeviceRegistryPolicyIssuer_RevokeViaIdentityNamespace Clone()
        {
            var clone = new RevokeAzDeviceRegistryPolicyIssuer_RevokeViaIdentityNamespace();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PoliciesRevokeIssuer' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.NamespaceInputObject.Id += $"/policies/{(global::System.Uri.EscapeDataString(this.PolicyName.ToString()))}";
                        await this.Client.PoliciesRevokeIssuerViaIdentity(NamespaceInputObject.Id, onNoContent, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PoliciesRevokeIssuer(NamespaceInputObject.SubscriptionId ?? null, NamespaceInputObject.ResourceGroupName ?? null, NamespaceInputObject.NamespaceName ?? null, PolicyName, onNoContent, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { PolicyName=PolicyName})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RevokeAzDeviceRegistryPolicyIssuer_RevokeViaIdentityNamespace" /> cmdlet
        /// class.
        /// </summary>
        public RevokeAzDeviceRegistryPolicyIssuer_RevokeViaIdentityNamespace()
        {
