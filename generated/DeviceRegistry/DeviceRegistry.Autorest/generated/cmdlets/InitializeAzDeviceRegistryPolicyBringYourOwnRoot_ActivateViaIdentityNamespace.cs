...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Initialize, @"AzDeviceRegistryPolicyBringYourOwnRoot_ActivateViaIdentityNamespace", SupportsShouldProcess = true)]
    ...
    public partial class InitializeAzDeviceRegistryPolicyBringYourOwnRoot_ActivateViaIdentityNamespace : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IActivateBringYourOwnRootRequest _body;

        /// <summary>
        /// Request payload for activating a Bring Your Own Root policy with a customer-provided signed certificate.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Request payload for activating a Bring Your Own Root policy with a customer-provided signed certificate.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Request payload for activating a Bring Your Own Root policy with a customer-provided signed certificate.",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IActivateBringYourOwnRootRequest) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IActivateBringYourOwnRootRequest Body { get => this._body; set => this._body = value; }
        ...
        /// <returns>
        /// a duplicate instance of InitializeAzDeviceRegistryPolicyBringYourOwnRoot_ActivateViaIdentityNamespace
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Cmdlets.InitializeAzDeviceRegistryPolicyBringYourOwnRoot_ActivateViaIdentityNamespace Clone()
        {
            var clone = new InitializeAzDeviceRegistryPolicyBringYourOwnRoot_ActivateViaIdentityNamespace();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InitializeAzDeviceRegistryPolicyBringYourOwnRoot_ActivateViaIdentityNamespace"
        /// /> cmdlet class.
        /// </summary>
        public InitializeAzDeviceRegistryPolicyBringYourOwnRoot_ActivateViaIdentityNamespace()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (NamespaceInputObject?.Id != null)
                    {
                        ...
                        await this.Client.PoliciesActivateBringYourOwnRootViaIdentity(NamespaceInputObject.Id, Body, onNoContent, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PoliciesActivateBringYourOwnRoot(NamespaceInputObject.SubscriptionId ?? null, NamespaceInputObject.ResourceGroupName ?? null, NamespaceInputObject.NamespaceName ?? null, PolicyName, Body, onNoContent, onOk, onDefault, this, Pipeline);
                    }
