...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Migrate=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeviceRegistry/namespaces/{namespaceName}/migrate"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Move, @"AzDeviceRegistryNamespace_MigrateViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeviceRegistry/namespaces/{namespaceName}/migrate", ApiVersion = "2025-07-01-preview")]
    public partial class MoveAzDeviceRegistryNamespace_MigrateViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceMigrateRequest _body;

        /// <summary>Request body for the migrate resources operation in to Namespace resource.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Request body for the migrate resources operation in to Namespace resource.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Request body for the migrate resources operation in to Namespace resource.",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceMigrateRequest) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceMigrateRequest Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceMigrateResponse">Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceMigrateResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceMigrateResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of MoveAzDeviceRegistryNamespace_MigrateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Cmdlets.MoveAzDeviceRegistryNamespace_MigrateViaIdentity Clone()
        {
            var clone = new MoveAzDeviceRegistryNamespace_MigrateViaIdentity();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MoveAzDeviceRegistryNamespace_MigrateViaIdentity" /> cmdlet class.
        /// </summary>
        public MoveAzDeviceRegistryNamespace_MigrateViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NamespacesMigrate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.NamespacesMigrateViaIdentity(InputObject.Id, Body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NamespacesMigrate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.NamespaceName ?? null, Body, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceMigrateResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceMigrateResponse
                var result = (await response);
                // response should be returning an array of some kind. +Pageable
                // nested-array / migrateResults / <none>
                WriteObject(result.MigrateResult, true);
            }
        }
    }
}