...
.Link
https://learn.microsoft.com/powershell/module/az.deviceregistry/get-azdeviceregistryoperation
#>
function Get-AzDeviceRegistryOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IOperation])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.DeviceRegistry.private\Get-AzDeviceRegistryOperation_List';
        }
