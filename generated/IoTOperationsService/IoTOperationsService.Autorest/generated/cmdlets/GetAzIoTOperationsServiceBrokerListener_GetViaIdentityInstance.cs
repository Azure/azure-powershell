...
namespace Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IoTOperations/instances/{instanceName}/brokers/{brokerName}/listeners/{listenerName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzIoTOperationsServiceBrokerListener_GetViaIdentityInstance")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IBrokerListenerResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Description(@"Get a BrokerListenerResource")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IoTOperations/instances/{instanceName}/brokers/{brokerName}/listeners/{listenerName}", ApiVersion = "2024-11-01")]
    public partial class GetAzIoTOperationsServiceBrokerListener_GetViaIdentityInstance : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of Instance broker listener resource")]
        [Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IBrokerListenerResource">Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IBrokerListenerResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IBrokerListenerResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzIoTOperationsServiceBrokerListener_GetViaIdentityInstance" /> cmdlet
        /// class.
        /// </summary>
        public GetAzIoTOperationsServiceBrokerListener_GetViaIdentityInstance()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.InstanceInputObject.Id += $"/brokers/{(global::System.Uri.EscapeDataString(this.BrokerName.ToString()))}/listeners/{(global::System.Uri.EscapeDataString(this.ListenerName.ToString()))}";
                        await this.Client.BrokerListenerGetViaIdentity(InstanceInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BrokerListenerGet(InstanceInputObject.SubscriptionId ?? null, InstanceInputObject.ResourceGroupName ?? null, InstanceInputObject.InstanceName ?? null, BrokerName, ListenerName, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { BrokerName=BrokerName,ListenerName=ListenerName})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IBrokerListenerResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
