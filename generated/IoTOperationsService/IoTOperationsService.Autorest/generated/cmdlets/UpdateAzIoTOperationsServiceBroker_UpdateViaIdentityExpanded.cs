...
namespace Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IoTOperations/instances/{instanceName}/brokers/{brokerName}"
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzIoTOperationsServiceBroker_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzIoTOperationsServiceBroker_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzIoTOperationsServiceBroker_UpdateViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Cmdlets.UpdateAzIoTOperationsServiceBroker_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzIoTOperationsServiceBroker_UpdateViaIdentityExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _resourceBody = await this.Client.BrokerGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_resourceBody();
                        await this.Client.BrokerCreateOrUpdateViaIdentity(InputObject.Id, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _resourceBody = await this.Client.BrokerGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.InstanceName ?? null, InputObject.BrokerName ?? null, this, Pipeline);
                        this.Update_resourceBody();
                        await this.Client.BrokerCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.InstanceName ?? null, InputObject.BrokerName ?? null, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzIoTOperationsServiceBroker_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzIoTOperationsServiceBroker_UpdateViaIdentityExpanded()
        {
        ...
        private void Update_resourceBody()
        {
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SelfCheckIntervalSecond")))
            {
                this.SelfCheckIntervalSecond = (int)(this.MyInvocation?.BoundParameters["SelfCheckIntervalSecond"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SelfCheckTimeoutSecond")))
            {
                this.SelfCheckTimeoutSecond = (int)(this.MyInvocation?.BoundParameters["SelfCheckTimeoutSecond"]);
            }
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SelfCheckMode")))
            {
                this.SelfCheckMode = (string)(this.MyInvocation?.BoundParameters["SelfCheckMode"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("TraceMode")))
            {
                this.TraceMode = (string)(this.MyInvocation?.BoundParameters["TraceMode"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("TraceCacheSizeMegabyte")))
            {
                this.TraceCacheSizeMegabyte = (int)(this.MyInvocation?.BoundParameters["TraceCacheSizeMegabyte"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("TraceSpanChannelCapacity")))
            {
                this.TraceSpanChannelCapacity = (int)(this.MyInvocation?.BoundParameters["TraceSpanChannelCapacity"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SelfTracingIntervalSecond")))
            {
                this.SelfTracingIntervalSecond = (int)(this.MyInvocation?.BoundParameters["SelfTracingIntervalSecond"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SelfTracingMode")))
            {
                this.SelfTracingMode = (string)(this.MyInvocation?.BoundParameters["SelfTracingMode"]);
            }
        }
