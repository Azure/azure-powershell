...
namespace Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Cmdlets
{
    ...
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IoTOperations/instances/{instanceName}/brokers/{brokerName}/authentications/{authenticationName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzIoTOperationsServiceBrokerAuthentication_UpdateViaIdentityInstanceExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Description(@"update a BrokerAuthenticationResource")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Generated]
    public partial class UpdateAzIoTOperationsServiceBrokerAuthentication_UpdateViaIdentityInstanceExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Defines a set of Broker authentication methods to be used on `BrokerListeners`. For each array element one authenticator type supported.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IBrokerAuthenticatorMethods[] AuthenticationMethod { get => _resourceBody.AuthenticationMethod?.ToArray() ?? null /* fixedArrayOf */; set => _resourceBody.AuthenticationMethod = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IBrokerAuthenticatorMethods>(value) : null); }
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzIoTOperationsServiceBrokerAuthentication_UpdateViaIdentityInstanceExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Cmdlets.UpdateAzIoTOperationsServiceBrokerAuthentication_UpdateViaIdentityInstanceExpanded Clone()
        {
            var clone = new UpdateAzIoTOperationsServiceBrokerAuthentication_UpdateViaIdentityInstanceExpanded();
            ...
            clone.AuthenticationName = this.AuthenticationName;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BrokerAuthenticationCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.InstanceInputObject.Id += $"/brokers/{(global::System.Uri.EscapeDataString(this.BrokerName.ToString()))}/authentications/{(global::System.Uri.EscapeDataString(this.AuthenticationName.ToString()))}";
                        _resourceBody = await this.Client.BrokerAuthenticationGetViaIdentityWithResult(InstanceInputObject.Id, this, Pipeline);
                        this.Update_resourceBody();
                        await this.Client.BrokerAuthenticationCreateOrUpdateViaIdentity(InstanceInputObject.Id, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _resourceBody = await this.Client.BrokerAuthenticationGetWithResult(InstanceInputObject.SubscriptionId ?? null, InstanceInputObject.ResourceGroupName ?? null, InstanceInputObject.InstanceName ?? null, BrokerName, AuthenticationName, this, Pipeline);
                        this.Update_resourceBody();
                        await this.Client.BrokerAuthenticationCreateOrUpdate(InstanceInputObject.SubscriptionId ?? null, InstanceInputObject.ResourceGroupName ?? null, InstanceInputObject.InstanceName ?? null, BrokerName, AuthenticationName, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.SerializationMode.IncludeUpdate);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { BrokerName=BrokerName,AuthenticationName=AuthenticationName})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzIoTOperationsServiceBrokerAuthentication_UpdateViaIdentityInstanceExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzIoTOperationsServiceBrokerAuthentication_UpdateViaIdentityInstanceExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("AuthenticationMethod")))
            {
                this.AuthenticationMethod = (Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IBrokerAuthenticatorMethods[])(this.MyInvocation?.BoundParameters["AuthenticationMethod"]);
            }
        }
