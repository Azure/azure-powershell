...
namespace Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IoTOperations/instances/{instanceName}/brokers/{brokerName}/authorizations/{authorizationName}"
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IoTOperations/instances/{instanceName}/brokers/{brokerName}/authorizations/{authorizationName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzIoTOperationsServiceBrokerAuthorization_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IBrokerAuthorizationResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Description(@"update a BrokerAuthorizationResource")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Generated]
    public partial class UpdateAzIoTOperationsServiceBrokerAuthorization_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Enable caching of the authorization rules.")]
        ...
        public string AuthorizationPolicyCache { get => _resourceBody.AuthorizationPolicyCache ?? null; set => _resourceBody.AuthorizationPolicyCache = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The authorization rules to follow. If no rule is set, but Authorization Resource is used that would mean DenyAll.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IAuthorizationRule[] AuthorizationPolicyRule { get => _resourceBody.AuthorizationPolicyRule?.ToArray() ?? null /* fixedArrayOf */; set => _resourceBody.AuthorizationPolicyRule = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IAuthorizationRule>(value) : null); }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IBrokerAuthorizationResource">Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IBrokerAuthorizationResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IBrokerAuthorizationResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzIoTOperationsServiceBrokerAuthorization_UpdateViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Cmdlets.UpdateAzIoTOperationsServiceBrokerAuthorization_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzIoTOperationsServiceBrokerAuthorization_UpdateViaIdentityExpanded();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BrokerAuthorizationCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _resourceBody = await this.Client.BrokerAuthorizationGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_resourceBody();
                        await this.Client.BrokerAuthorizationCreateOrUpdateViaIdentity(InputObject.Id, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _resourceBody = await this.Client.BrokerAuthorizationGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.InstanceName ?? null, InputObject.BrokerName ?? null, InputObject.AuthorizationName ?? null, this, Pipeline);
                        this.Update_resourceBody();
                        await this.Client.BrokerAuthorizationCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.InstanceName ?? null, InputObject.BrokerName ?? null, InputObject.AuthorizationName ?? null, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzIoTOperationsServiceBrokerAuthorization_UpdateViaIdentityExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzIoTOperationsServiceBrokerAuthorization_UpdateViaIdentityExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("AuthorizationPolicyCache")))
            {
                this.AuthorizationPolicyCache = (string)(this.MyInvocation?.BoundParameters["AuthorizationPolicyCache"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("AuthorizationPolicyRule")))
            {
                this.AuthorizationPolicyRule = (Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IAuthorizationRule[])(this.MyInvocation?.BoundParameters["AuthorizationPolicyRule"]);
            }
        }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IBrokerAuthorizationResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
