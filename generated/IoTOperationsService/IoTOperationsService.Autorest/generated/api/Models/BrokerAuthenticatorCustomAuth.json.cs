...
namespace Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models
{
    ...
    public partial class BrokerAuthenticatorCustomAuth
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonObject into a new instance of <see cref="BrokerAuthenticatorCustomAuth" />.
        /// </summary>
        ...
        internal BrokerAuthenticatorCustomAuth(Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonObject json)
        {
            ...
            {_x509 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonObject>("x509"), out var __jsonX509) ? Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.X509ManualCertificate.FromJson(__jsonX509) : _x509;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IBrokerAuthenticatorCustomAuth.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IBrokerAuthenticatorCustomAuth.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IBrokerAuthenticatorCustomAuth FromJson(Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonObject json ? new BrokerAuthenticatorCustomAuth(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="BrokerAuthenticatorCustomAuth" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="BrokerAuthenticatorCustomAuth" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._x509 ? (Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode) this._x509.ToJson(null,serializationMode) : null, "x509" ,container.Add );
