...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IOperation
.Link
https://learn.microsoft.com/powershell/module/az.iotoperationsservice/get-aziotoperationsserviceoperation
#>
function Get-AzIoTOperationsServiceOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IOperation])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.IoTOperationsService.private\Get-AzIoTOperationsServiceOperation_List';
        }
