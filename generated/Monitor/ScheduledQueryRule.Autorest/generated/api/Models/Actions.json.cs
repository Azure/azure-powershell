...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Models
{
    ...
    public partial class Actions
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonObject into a new instance of <see cref="Actions" />.
        /// </summary>
        ...
        internal Actions(Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonObject json)
        {
            ...
            {_actionGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonArray>("actionGroups"), out var __jsonActionGroups) ? If( __jsonActionGroups as Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _actionGroup;}
            {_customProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonObject>("customProperties"), out var __jsonCustomProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Models.ActionsCustomProperties.FromJson(__jsonCustomProperties) : _customProperty;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Models.IActions.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Models.IActions.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Models.IActions FromJson(Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonObject json ? new Actions(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="Actions" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Actions" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.SerializationMode serializationMode)
        {
            ...
            if (null != this._actionGroup)
            {
                ...
                container.Add("actionGroups",__w);
            }
            AddIf( null != this._customProperty ? (Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonNode) this._customProperty.ToJson(null,serializationMode) : null, "customProperties" ,container.Add );
