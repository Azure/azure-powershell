...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Models
{
    ...
    public partial class ScheduledQueryRuleProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Models.IScheduledQueryRuleProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Models.IScheduledQueryRuleProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Models.IScheduledQueryRuleProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonNode node)
        {
        ...
        internal ScheduledQueryRuleProperties(Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonObject json)
        {
            ...
            {_criterion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonObject>("criteria"), out var __jsonCriteria) ? Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Models.ScheduledQueryRuleCriteria.FromJson(__jsonCriteria) : _criterion;}
            {_action = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonObject>("actions"), out var __jsonActions) ? Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Models.Actions.FromJson(__jsonActions) : _action;}
            {_createdWithApiVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonString>("createdWithApiVersion"), out var __jsonCreatedWithApiVersion) ? (string)__jsonCreatedWithApiVersion : (string)_createdWithApiVersion;}
            {_isLegacyLogAnalyticsRule = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonBoolean>("isLegacyLogAnalyticsRule"), out var __jsonIsLegacyLogAnalyticsRule) ? (bool?)__jsonIsLegacyLogAnalyticsRule : _isLegacyLogAnalyticsRule;}
            {_description = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonString>("description"), out var __jsonDescription) ? (string)__jsonDescription : (string)_description;}
            {_displayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonString>("displayName"), out var __jsonDisplayName) ? (string)__jsonDisplayName : (string)_displayName;}
            {_severity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonNumber>("severity"), out var __jsonSeverity) ? (long?)__jsonSeverity : _severity;}
            {_enabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonBoolean>("enabled"), out var __jsonEnabled) ? (bool?)__jsonEnabled : _enabled;}
            {_scope = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonArray>("scopes"), out var __jsonScopes) ? If( __jsonScopes as Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _scope;}
            {_evaluationFrequency = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonString>("evaluationFrequency"), out var __jsonEvaluationFrequency) ? global::System.Xml.XmlConvert.ToTimeSpan( __jsonEvaluationFrequency ) : _evaluationFrequency;}
            {_windowSize = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonString>("windowSize"), out var __jsonWindowSize) ? global::System.Xml.XmlConvert.ToTimeSpan( __jsonWindowSize ) : _windowSize;}
            {_overrideQueryTimeRange = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonString>("overrideQueryTimeRange"), out var __jsonOverrideQueryTimeRange) ? global::System.Xml.XmlConvert.ToTimeSpan( __jsonOverrideQueryTimeRange ) : _overrideQueryTimeRange;}
            {_targetResourceType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonArray>("targetResourceTypes"), out var __jsonTargetResourceTypes) ? If( __jsonTargetResourceTypes as Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : _targetResourceType;}
            {_muteActionsDuration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonString>("muteActionsDuration"), out var __jsonMuteActionsDuration) ? global::System.Xml.XmlConvert.ToTimeSpan( __jsonMuteActionsDuration ) : _muteActionsDuration;}
            {_isWorkspaceAlertsStorageConfigured = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonBoolean>("isWorkspaceAlertsStorageConfigured"), out var __jsonIsWorkspaceAlertsStorageConfigured) ? (bool?)__jsonIsWorkspaceAlertsStorageConfigured : _isWorkspaceAlertsStorageConfigured;}
            {_checkWorkspaceAlertsStorageConfigured = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonBoolean>("checkWorkspaceAlertsStorageConfigured"), out var __jsonCheckWorkspaceAlertsStorageConfigured) ? (bool?)__jsonCheckWorkspaceAlertsStorageConfigured : _checkWorkspaceAlertsStorageConfigured;}
            {_skipQueryValidation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonBoolean>("skipQueryValidation"), out var __jsonSkipQueryValidation) ? (bool?)__jsonSkipQueryValidation : _skipQueryValidation;}
            {_autoMitigate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.ScheduledQueryRule.Runtime.Json.JsonBoolean>("autoMitigate"), out var __jsonAutoMitigate) ? (bool?)__jsonAutoMitigate : _autoMitigate;}
            AfterFromJson(json);
        }
