...
namespace Microsoft.Azure.PowerShell.Cmdlets.Metric.Models
{
    ...
    public partial class Metric
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Metric.Models.IMetric.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Metric.Models.IMetric.</returns>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonObject into a new instance of <see cref="Metric" />.
        /// </summary>
        ...
        internal Metric(Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonObject json)
        {
            ...
            {_type = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonString>("type"), out var __jsonType) ? (string)__jsonType : (string)_type;}
            ...
            {_errorCode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonString>("errorCode"), out var __jsonErrorCode) ? (string)__jsonErrorCode : (string)_errorCode;}
            {_errorMessage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonString>("errorMessage"), out var __jsonErrorMessage) ? (string)__jsonErrorMessage : (string)_errorMessage;}
            ...
            {_timesery = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonArray>("timeseries"), out var __jsonTimeseries) ? If( __jsonTimeseries as Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Metric.Models.ITimeSeriesElement>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Metric.Models.ITimeSeriesElement) (Microsoft.Azure.PowerShell.Cmdlets.Metric.Models.TimeSeriesElement.FromJson(__u) )) ))() : null : _timesery;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Metric" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Metric" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNode" />.
        /// </returns>
