...
{
    using Microsoft.Azure.PowerShell.Cmdlets.Monitor.ActionGroup.generated.runtime.Properties;
    using System;
    ...
    public class GenericBreakingChangeAttribute : Attribute
    {
        ...
        public string moduleName { get; set; } = String.IsNullOrEmpty(@"Az.Monitor") ? @"Az.ActionGroup" : @"Az.Monitor";
