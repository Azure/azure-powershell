...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzDiagnosticSetting_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Description(@"update diagnostic settings for the specified resource.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Generated]
    public partial class UpdateAzDiagnosticSetting_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.IDiagnosticSettingsResource _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.DiagnosticSettingsResource();
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Runtime.ParameterBreakingChange("Log", "15.0.0", "7.0.0", "2025/11/03", OldParamaterType="Array", NewParameterType="List")]
        public Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.ILogSettings[] Log { get => _parametersBody.Log?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.Log = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.ILogSettings>(value) : null); }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.IMetricSettings[] Metric { get => _parametersBody.Metric?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.Metric = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.IMetricSettings>(value) : null); }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _parametersBody = await this.Client.DiagnosticSettingsGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.DiagnosticSettingsCreateOrUpdateViaIdentity(InputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _parametersBody = await this.Client.DiagnosticSettingsGetWithResult(InputObject.ResourceUri ?? null, InputObject.Name ?? null, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.DiagnosticSettingsCreateOrUpdate(InputObject.ResourceUri ?? null, InputObject.Name ?? null, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzDiagnosticSetting_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzDiagnosticSetting_UpdateViaIdentityExpanded()
        {
        ...
        private void Update_parametersBody()
        {
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ServiceBusRuleId")))
            {
                this.ServiceBusRuleId = (string)(this.MyInvocation?.BoundParameters["ServiceBusRuleId"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("EventHubAuthorizationRuleId")))
            {
                this.EventHubAuthorizationRuleId = (string)(this.MyInvocation?.BoundParameters["EventHubAuthorizationRuleId"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("EventHubName")))
            {
                this.EventHubName = (string)(this.MyInvocation?.BoundParameters["EventHubName"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Metric")))
            {
                this.Metric = (Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.IMetricSettings[])(this.MyInvocation?.BoundParameters["Metric"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Log")))
            {
                this.Log = (Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.ILogSettings[])(this.MyInvocation?.BoundParameters["Log"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("WorkspaceId")))
            {
                this.WorkspaceId = (string)(this.MyInvocation?.BoundParameters["WorkspaceId"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("MarketplacePartnerId")))
            {
                this.MarketplacePartnerId = (string)(this.MyInvocation?.BoundParameters["MarketplacePartnerId"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("LogAnalyticsDestinationType")))
            {
                this.LogAnalyticsDestinationType = (string)(this.MyInvocation?.BoundParameters["LogAnalyticsDestinationType"]);
            }
        }
