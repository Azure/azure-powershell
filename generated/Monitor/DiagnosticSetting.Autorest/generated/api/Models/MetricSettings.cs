...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models
{
    ...
    public partial class MetricSettings :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.IMetricSettingsInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.IRetentionPolicy Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.IMetricSettingsInternal.RetentionPolicy { get => (this._retentionPolicy = this._retentionPolicy ?? new Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.RetentionPolicy()); set { {_retentionPolicy = value;} } }

        /// <summary>Backing field for <see cref="RetentionPolicy" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.IRetentionPolicy _retentionPolicy;

        /// <summary>the retention policy for this category.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Origin(Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.IRetentionPolicy RetentionPolicy { get => (this._retentionPolicy = this._retentionPolicy ?? new Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.RetentionPolicy()); set => this._retentionPolicy = value; }
        ...
        public int? RetentionPolicyDay { get => ((Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.IRetentionPolicyInternal)RetentionPolicy).Day; set => ((Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.IRetentionPolicyInternal)RetentionPolicy).Day = value ?? default(int); }

        /// <summary>a value indicating whether the retention policy is enabled.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Origin(Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.PropertyOrigin.Inlined)]
        public bool? RetentionPolicyEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.IRetentionPolicyInternal)RetentionPolicy).Enabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.IRetentionPolicyInternal)RetentionPolicy).Enabled = value ?? default(bool); }
...

    {
        ...
        bool Enabled { get; set; }
        /// <summary>the retention policy for this category.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.Models.IRetentionPolicy RetentionPolicy { get; set; }
        /// <summary>
        /// the number of days for the retention in days. A value of 0 will retain the events indefinitely.
        /// </summary>
        int? RetentionPolicyDay { get; set; }
