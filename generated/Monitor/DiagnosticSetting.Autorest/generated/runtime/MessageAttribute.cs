...
{
    using Microsoft.Azure.PowerShell.Cmdlets.Monitor.DiagnosticSetting.generated.runtime.Properties;
    using System;
    ...
    public class GenericBreakingChangeAttribute : Attribute
    {
        ...
        public string moduleName { get; set; } = String.IsNullOrEmpty(@"Az.Monitor") ? @"Az.DiagnosticSetting" : @"Az.Monitor";
