...
namespace Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models
{
    ...
    public partial class RouteConfiguration
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.IRouteConfiguration.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.IRouteConfiguration interface is polymorphic, and the precise
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.IRouteConfiguration.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.IRouteConfiguration FromJson(Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode node)
        {
            if (!(node is Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonObject json))
            {
                return null;
            }
            ...
            switch ( json.StringProperty("@odata.type") )
            {
                ...
                {
                    return new ForwardingConfiguration(json);
                }
                case "#Microsoft.Azure.FrontDoor.Models.FrontdoorRedirectConfiguration":
                {
                    return new RedirectConfiguration(json);
                }
            }
            return new RouteConfiguration(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonObject into a new instance of <see cref="RouteConfiguration" />.
        /// </summary>
        ...
        internal RouteConfiguration(Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonObject json)
        {
            ...
            {_odataType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonString>("@odata.type"), out var __jsonOdataType) ? (string)__jsonOdataType : (string)_odataType;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="RouteConfiguration" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="RouteConfiguration" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._odataType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonString(this._odataType.ToString()) : null, "@odata.type" ,container.Add );
