...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Models
{
    ...
    public partial class StorageTaskPreviewAction
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Models.IStorageTaskPreviewAction.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Models.IStorageTaskPreviewAction.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Models.IStorageTaskPreviewAction FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonObject json ? new StorageTaskPreviewAction(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonObject into a new instance of <see cref="StorageTaskPreviewAction" />.
        /// </summary>
        ...
        internal StorageTaskPreviewAction(Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Models.StorageTaskPreviewActionProperties.FromJson(__jsonProperties) : _property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="StorageTaskPreviewAction" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="StorageTaskPreviewAction" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonNode" />.
        /// </returns>
