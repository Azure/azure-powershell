...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Models
{
    ...
    public partial class StorageTaskAction
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Models.IStorageTaskAction.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Models.IStorageTaskAction.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Models.IStorageTaskAction FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonObject json ? new StorageTaskAction(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonObject into a new instance of <see cref="StorageTaskAction" />.
        /// </summary>
        ...
        internal StorageTaskAction(Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonObject json)
        {
            ...
            {_if = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonObject>("if"), out var __jsonIf) ? Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Models.IfCondition.FromJson(__jsonIf) : _if;}
            {_else = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonObject>("else"), out var __jsonElse) ? Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Models.ElseCondition.FromJson(__jsonElse) : _else;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="StorageTaskAction" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="StorageTaskAction" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._if ? (Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonNode) this._if.ToJson(null,serializationMode) : null, "if" ,container.Add );
            AddIf( null != this._else ? (Microsoft.Azure.PowerShell.Cmdlets.StorageAction.Runtime.Json.JsonNode) this._else.ToJson(null,serializationMode) : null, "else" ,container.Add );
