...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models
{
    ...
    public partial class SubnetResourceSettings :
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.ISubnetResourceSettings,
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.ISubnetResourceSettingsInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.INsgReference Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.ISubnetResourceSettingsInternal.NetworkSecurityGroup { get => (this._networkSecurityGroup = this._networkSecurityGroup ?? new Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.NsgReference()); set { {_networkSecurityGroup = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.INsgReference _networkSecurityGroup;

        /// <summary>Defines reference to NSG.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Origin(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.INsgReference NetworkSecurityGroup { get => (this._networkSecurityGroup = this._networkSecurityGroup ?? new Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.NsgReference()); set => this._networkSecurityGroup = value; }
...

    {
        ...
        string Name { get; set; }
        /// <summary>Defines reference to NSG.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.INsgReference NetworkSecurityGroup { get; set; }
        /// <summary>Gets the ARM resource ID of the tracked resource being referenced.</summary>
        string NetworkSecurityGroupSourceArmResourceId { get; set; }
