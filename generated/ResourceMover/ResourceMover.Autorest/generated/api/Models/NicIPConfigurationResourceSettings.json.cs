...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models
{
    ...
    public partial class NicIPConfigurationResourceSettings
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.INicIPConfigurationResourceSettings.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.INicIPConfigurationResourceSettings.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.INicIPConfigurationResourceSettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonNode node)
        {
        ...
        internal NicIPConfigurationResourceSettings(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonObject json)
        {
            ...
            {_publicIP = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonObject>("publicIp"), out var __jsonPublicIP) ? Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.PublicIPReference.FromJson(__jsonPublicIP) : _publicIP;}
            ...
            {_primary = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonBoolean>("primary"), out var __jsonPrimary) ? (bool?)__jsonPrimary : _primary;}
            {_loadBalancerBackendAddressPool = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonArray>("loadBalancerBackendAddressPools"), out var __jsonLoadBalancerBackendAddressPools) ? If( __jsonLoadBalancerBackendAddressPools as Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.ILoadBalancerBackendAddressPoolReference>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.ILoadBalancerBackendAddressPoolReference) (Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.LoadBalancerBackendAddressPoolReference.FromJson(__u) )) ))() : null : _loadBalancerBackendAddressPool;}
            {_loadBalancerNatRule = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonArray>("loadBalancerNatRules"), out var __jsonLoadBalancerNatRules) ? If( __jsonLoadBalancerNatRules as Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.ILoadBalancerNatRuleReference>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.ILoadBalancerNatRuleReference) (Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.LoadBalancerNatRuleReference.FromJson(__p) )) ))() : null : _loadBalancerNatRule;}
            AfterFromJson(json);
        }
