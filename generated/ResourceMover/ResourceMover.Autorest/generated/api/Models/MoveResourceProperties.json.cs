...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models
{
    ...
    public partial class MoveResourceProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.IMoveResourceProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.IMoveResourceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.IMoveResourceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonNode node)
        {
        ...
        internal MoveResourceProperties(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonObject json)
        {
            ...
            {_moveStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonObject>("moveStatus"), out var __jsonMoveStatus) ? Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.MoveResourcePropertiesMoveStatus.FromJson(__jsonMoveStatus) : _moveStatus;}
            {_error = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonObject>("errors"), out var __jsonErrors) ? Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.MoveResourcePropertiesErrors.FromJson(__jsonErrors) : _error;}
            ...
            {_existingTargetId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonString>("existingTargetId"), out var __jsonExistingTargetId) ? (string)__jsonExistingTargetId : (string)_existingTargetId;}
            {_resourceSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonObject>("resourceSettings"), out var __jsonResourceSettings) ? Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.ResourceSettings.FromJson(__jsonResourceSettings) : _resourceSetting;}
            {_sourceResourceSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonObject>("sourceResourceSettings"), out var __jsonSourceResourceSettings) ? Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.ResourceSettings.FromJson(__jsonSourceResourceSettings) : _sourceResourceSetting;}
            {_dependsOn = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonArray>("dependsOn"), out var __jsonDependsOn) ? If( __jsonDependsOn as Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.IMoveResourceDependency>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.IMoveResourceDependency) (Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.MoveResourceDependency.FromJson(__u) )) ))() : null : _dependsOn;}
            {_dependsOnOverride = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonArray>("dependsOnOverrides"), out var __jsonDependsOnOverrides) ? If( __jsonDependsOnOverrides as Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.IMoveResourceDependencyOverride>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.IMoveResourceDependencyOverride) (Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.MoveResourceDependencyOverride.FromJson(__p) )) ))() : null : _dependsOnOverride;}
            {_isResolveRequired = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonBoolean>("isResolveRequired"), out var __jsonIsResolveRequired) ? (bool?)__jsonIsResolveRequired : _isResolveRequired;}
            AfterFromJson(json);
        }
