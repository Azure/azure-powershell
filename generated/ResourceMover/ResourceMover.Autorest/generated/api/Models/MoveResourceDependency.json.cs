...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models
{
    ...
    public partial class MoveResourceDependency
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.IMoveResourceDependency.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.IMoveResourceDependency.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.IMoveResourceDependency FromJson(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonNode node)
        {
        ...
        internal MoveResourceDependency(Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonObject json)
        {
            ...
            {_manualResolution = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonObject>("manualResolution"), out var __jsonManualResolution) ? Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.ManualResolutionProperties.FromJson(__jsonManualResolution) : _manualResolution;}
            {_automaticResolution = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonObject>("automaticResolution"), out var __jsonAutomaticResolution) ? Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Models.AutomaticResolutionProperties.FromJson(__jsonAutomaticResolution) : _automaticResolution;}
            ...
            {_resolutionStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonString>("resolutionStatus"), out var __jsonResolutionStatus) ? (string)__jsonResolutionStatus : (string)_resolutionStatus;}
            {_resolutionType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonString>("resolutionType"), out var __jsonResolutionType) ? (string)__jsonResolutionType : (string)_resolutionType;}
            {_dependencyType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonString>("dependencyType"), out var __jsonDependencyType) ? (string)__jsonDependencyType : (string)_dependencyType;}
            {_isOptional = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceMover.Runtime.Json.JsonString>("isOptional"), out var __jsonIsOptional) ? (string)__jsonIsOptional : (string)_isOptional;}
            AfterFromJson(json);
        }
