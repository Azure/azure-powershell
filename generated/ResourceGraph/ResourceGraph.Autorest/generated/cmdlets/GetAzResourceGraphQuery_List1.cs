...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ResourceGraph/queries"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzResourceGraphQuery_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Description(@"Get all graph queries defined within a specified subscription and resource group.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ResourceGraph/queries", ApiVersion = "2024-04-01")]
    public partial class GetAzResourceGraphQuery_List1 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Models.IGraphQueryListResult">Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Models.IGraphQueryListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Models.IGraphQueryListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzResourceGraphQuery_List1" /> cmdlet class.
        /// </summary>
        public GetAzResourceGraphQuery_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.GraphQueryList(SubscriptionId, ResourceGroupName, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Models.IGraphQueryListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Models.IGraphQueryListResult
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        ...
                        {
                            requestMessage = requestMessage.Clone(new global::System.Uri( _nextLink ),Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Runtime.Method.Get );
                            await ((Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Runtime.IEventListener)this).Signal(Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Runtime.Events.FollowingNextLink); if( ((Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Runtime.IEventListener)this).Token.IsCancellationRequested ) { return; }
                            await this.Client.GraphQueryList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
