...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListBySubscription=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.ResourceGraph/queries"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Description(@"Get all graph queries defined within a specified subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.ResourceGraph/queries", ApiVersion = "2024-04-01")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ResourceGraph.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzResourceGraphQuery_List" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.GraphQueryListBySubscription(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.GraphQueryListBySubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
