...
namespace Microsoft.Azure.PowerShell.Cmdlets.DurableTask.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DurableTask.Models";
