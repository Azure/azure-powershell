...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHosts/{sessionHostName}/retryProvisioning", ApiVersion = "2025-03-01-preview")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (HostPoolInputObject?.Id != null)
                    {
                        ...
                        await this.Client.SessionHostRetryProvisioningViaIdentity(HostPoolInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.SessionHostRetryProvisioning(HostPoolInputObject.SubscriptionId ?? null, HostPoolInputObject.ResourceGroupName ?? null, HostPoolInputObject.HostPoolName ?? null, SessionHostName, onOk, onDefault, this, Pipeline);
                    }
