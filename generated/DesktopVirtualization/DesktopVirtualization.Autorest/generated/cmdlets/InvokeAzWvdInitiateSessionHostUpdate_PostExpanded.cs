...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Cmdlets
{
    ...
    /// <summary>Initiates a hostpool post or schedule an post for the future.</summary>
    /// <remarks>
    /// [OpenAPI] Post=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHostManagements/default/initiateSessionHostUpdate"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzWvdInitiateSessionHostUpdate_PostExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHostManagements/default/initiateSessionHostUpdate", ApiVersion = "2025-11-01-preview")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.IContext
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IUpdateSessionHostsRequestBody _updateSessionHostsRequestBody = new Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.UpdateSessionHostsRequestBody();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The timestamp that the update validation is scheduled for. If none is provided, the update will be executed immediately")]
        ...
        public global::System.DateTime ScheduledDateTime { get => _updateSessionHostsRequestBody.ScheduledDateTime ?? default(global::System.DateTime); set => _updateSessionHostsRequestBody.ScheduledDateTime = value; }

        /// <summary>
        /// The timeZone as defined in https://docs.microsoft.com/dotnet/api/system.timezoneinfo.findsystemtimezonebyid.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The timeZone as defined in https://docs.microsoft.com/dotnet/api/system.timezoneinfo.findsystemtimezonebyid.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ScheduledDateTimeZone { get => _updateSessionHostsRequestBody.ScheduledDateTimeZone ?? null; set => _updateSessionHostsRequestBody.ScheduledDateTimeZone = value; }
        ...
        public global::System.Management.Automation.SwitchParameter UpdateDeleteOriginalVM { get => _updateSessionHostsRequestBody.UpdateDeleteOriginalVM ?? default(global::System.Management.Automation.SwitchParameter); set => _updateSessionHostsRequestBody.UpdateDeleteOriginalVM = value; }

        /// <summary>Grace period before logging off users in minutes.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Grace period before logging off users in minutes.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The maximum number of virtual machines to be removed during hostpool update.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int UpdateMaxVmsRemoved { get => _updateSessionHostsRequestBody.UpdateMaxVmsRemoved ?? default(int); set => _updateSessionHostsRequestBody.UpdateMaxVmsRemoved = value; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzWvdInitiateSessionHostUpdate_PostExpanded" /> cmdlet class.
        /// </summary>
        public InvokeAzWvdInitiateSessionHostUpdate_PostExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'InitiateSessionHostUpdatePost' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.InitiateSessionHostUpdatePost(SubscriptionId, ResourceGroupName, HostPoolName, _updateSessionHostsRequestBody, onNoContent, onDefault, this, Pipeline);
