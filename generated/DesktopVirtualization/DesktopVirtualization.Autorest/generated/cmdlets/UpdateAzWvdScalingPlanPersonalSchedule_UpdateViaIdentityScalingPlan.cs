...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/scalingPlans/{scalingPlanName}/personalSchedules/{scalingPlanScheduleName}", ApiVersion = "2025-11-01-preview")]
    public partial class UpdateAzWvdScalingPlanPersonalSchedule_UpdateViaIdentityScalingPlan : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="ScalingPlanInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IDesktopVirtualizationIdentity _scalingPlanInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IDesktopVirtualizationIdentity ScalingPlanInputObject { get => this._scalingPlanInputObject; set => this._scalingPlanInputObject = value; }

        /// <summary>Backing field for <see cref="ScalingPlanSchedule" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IScalingPlanPersonalSchedulePatch _scalingPlanSchedule;

        /// <summary>ScalingPlanPersonalSchedule properties that can be patched.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ScalingPlanPersonalSchedule properties that can be patched.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"ScalingPlanPersonalSchedule properties that can be patched.",
        SerializedName = @"scalingPlanSchedule",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IScalingPlanPersonalSchedulePatch) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IScalingPlanPersonalSchedulePatch ScalingPlanSchedule { get => this._scalingPlanSchedule; set => this._scalingPlanSchedule = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IScalingPlanPersonalSchedule">Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IScalingPlanPersonalSchedule</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IScalingPlanPersonalSchedule> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ScalingPlanPersonalSchedulesUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ScalingPlanInputObject?.Id != null)
                    {
                        this.ScalingPlanInputObject.Id += $"/personalSchedules/{(global::System.Uri.EscapeDataString(this.ScalingPlanScheduleName.ToString()))}";
                        await this.Client.ScalingPlanPersonalSchedulesUpdateViaIdentity(ScalingPlanInputObject.Id, ScalingPlanSchedule, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == ScalingPlanInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ScalingPlanInputObject has null value for ScalingPlanInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ScalingPlanInputObject) );
                        }
                        if (null == ScalingPlanInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ScalingPlanInputObject has null value for ScalingPlanInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ScalingPlanInputObject) );
                        }
                        if (null == ScalingPlanInputObject.ScalingPlanName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ScalingPlanInputObject has null value for ScalingPlanInputObject.ScalingPlanName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ScalingPlanInputObject) );
                        }
                        await this.Client.ScalingPlanPersonalSchedulesUpdate(ScalingPlanInputObject.SubscriptionId ?? null, ScalingPlanInputObject.ResourceGroupName ?? null, ScalingPlanInputObject.ScalingPlanName ?? null, ScalingPlanScheduleName, ScalingPlanSchedule, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.SerializationMode.IncludeUpdate);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ScalingPlanScheduleName=ScalingPlanScheduleName})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzWvdScalingPlanPersonalSchedule_UpdateViaIdentityScalingPlan" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzWvdScalingPlanPersonalSchedule_UpdateViaIdentityScalingPlan()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IScalingPlanPersonalSchedule> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IScalingPlanPersonalSchedule
