...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/workspaces/{workspaceName}", ApiVersion = "2025-09-01-preview")]
    public partial class UpdateAzWvdWorkspace_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IWorkspacePatch _workspaceBody = new Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.WorkspacePatch();
        ...
        public string[] ApplicationGroupReference { get => _workspaceBody.ApplicationGroupReference?.ToArray() ?? null /* fixedArrayOf */; set => _workspaceBody.ApplicationGroupReference = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        public string PublicNetworkAccess { get => _workspaceBody.PublicNetworkAccess ?? null; set => _workspaceBody.PublicNetworkAccess = value; }
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IWorkspacePatchTags) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IWorkspacePatchTags Tag { get => _workspaceBody.Tag ?? null /* object */; set => _workspaceBody.Tag = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IWorkspace">Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IWorkspace</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IWorkspace> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.WorkspacesUpdateViaIdentity(InputObject.Id, _workspaceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        await this.Client.WorkspacesUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.WorkspaceName ?? null, _workspaceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzWvdWorkspace_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzWvdWorkspace_UpdateViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IWorkspace> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IWorkspace
