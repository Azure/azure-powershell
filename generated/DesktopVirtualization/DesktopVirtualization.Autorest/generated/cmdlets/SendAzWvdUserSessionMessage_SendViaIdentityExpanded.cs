...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHosts/{sessionHostName}/userSessions/{userSessionId}/sendMessage", ApiVersion = "2025-03-01-preview")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.ISendMessage _sendMessageBody = new Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.SendMessage();
        ...
        public string MessageBody { get => _sendMessageBody.MessageBody ?? null; set => _sendMessageBody.MessageBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string MessageTitle { get => _sendMessageBody.MessageTitle ?? null; set => _sendMessageBody.MessageTitle = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.UserSessionsSendMessageViaIdentity(InputObject.Id, _sendMessageBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.UserSessionsSendMessage(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.HostPoolName ?? null, InputObject.SessionHostName ?? null, InputObject.UserSessionId ?? null, _sendMessageBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SendAzWvdUserSessionMessage_SendViaIdentityExpanded" /> cmdlet class.
        /// </summary>
