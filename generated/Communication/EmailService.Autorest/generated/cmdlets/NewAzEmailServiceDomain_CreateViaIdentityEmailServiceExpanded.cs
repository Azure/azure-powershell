...
namespace Microsoft.Azure.PowerShell.Cmdlets.EmailService.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzEmailServiceDomain_CreateViaIdentityEmailServiceExpanded", SupportsShouldProcess = true)]
    ...
    public partial class NewAzEmailServiceDomain_CreateViaIdentityEmailServiceExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EmailService.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Describes how a Domains resource is being managed.")]
        ...
        public string DomainManagement { get => _parametersBody.DomainManagement ?? null; set => _parametersBody.DomainManagement = value; }

        /// <summary>Backing field for <see cref="EmailServiceInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.EmailService.Models.IEmailServiceIdentity _emailServiceInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EmailService.Models.IEmailServiceIdentity EmailServiceInputObject { get => this._emailServiceInputObject; set => this._emailServiceInputObject = value; }
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.EmailService.ExportAs(typeof(global::System.Collections.Hashtable))]
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.EmailService.Models.ITrackedResourceTags) })]
        public Microsoft.Azure.PowerShell.Cmdlets.EmailService.Models.ITrackedResourceTags Tag { get => _parametersBody.Tag ?? null /* object */; set => _parametersBody.Tag = value; }

        /// <summary>Describes whether user engagement tracking is enabled or disabled.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Describes whether user engagement tracking is enabled or disabled.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EmailService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EmailService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EmailService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string UserEngagementTracking { get => _parametersBody.UserEngagementTracking ?? null; set => _parametersBody.UserEngagementTracking = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EmailService.Models.IDomainResource">Microsoft.Azure.PowerShell.Cmdlets.EmailService.Models.IDomainResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EmailService.Models.IDomainResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of NewAzEmailServiceDomain_CreateViaIdentityEmailServiceExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.EmailService.Cmdlets.NewAzEmailServiceDomain_CreateViaIdentityEmailServiceExpanded Clone()
        {
            var clone = new NewAzEmailServiceDomain_CreateViaIdentityEmailServiceExpanded();
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.EmailService.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.EmailService.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.EmailService.Runtime.Events.DelayBeforePolling:
                    {
                        var data = messageData();
                        if (true == MyInvocation?.BoundParameters?.ContainsKey("NoWait"))
                        {
                            if (data.ResponseMessage is System.Net.Http.HttpResponseMessage response)
                            {
                                ...
                                WriteObject(new Microsoft.Azure.PowerShell.Cmdlets.EmailService.Runtime.PowerShell.AsyncOperationResponse { Target = uri });
                                // do nothing more.
                                data.Cancel();
                                return;
                            }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzEmailServiceDomain_CreateViaIdentityEmailServiceExpanded" /> cmdlet
        /// class.
        /// </summary>
        public NewAzEmailServiceDomain_CreateViaIdentityEmailServiceExpanded()
        {
            ...
            try
            {
                ...
                if (ShouldProcess($"Call remote 'DomainsCreateOrUpdate' operation"))
                {
                    if (true == MyInvocation?.BoundParameters?.ContainsKey("AsJob"))
                    {
                        ...
                        var job = new Microsoft.Azure.PowerShell.Cmdlets.EmailService.Runtime.PowerShell.AsyncJob(instance, this.MyInvocation.Line, this.MyInvocation.MyCommand.Name, this._cancellationTokenSource.Token, this._cancellationTokenSource.Cancel);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.EmailServiceInputObject.Id += $"/domains/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.DomainsCreateOrUpdateViaIdentity(EmailServiceInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EmailService.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == EmailServiceInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("EmailServiceInputObject has null value for EmailServiceInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, EmailServiceInputObject) );
                        }
                        if (null == EmailServiceInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("EmailServiceInputObject has null value for EmailServiceInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, EmailServiceInputObject) );
                        }
                        if (null == EmailServiceInputObject.EmailServiceName)
                        {
                        ...
                        await this.Client.DomainsCreateOrUpdate(EmailServiceInputObject.SubscriptionId ?? null, EmailServiceInputObject.ResourceGroupName ?? null, EmailServiceInputObject.EmailServiceName ?? null, Name, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EmailService.Runtime.SerializationMode.IncludeCreate);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EmailService.Models.IDomainResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
