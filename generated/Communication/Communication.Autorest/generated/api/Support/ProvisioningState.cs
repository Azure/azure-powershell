...
namespace Microsoft.Azure.PowerShell.Cmdlets.Communication.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.ProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.ProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.ProvisioningState Moving = @"Moving";

        public static Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.ProvisioningState Running = @"Running";

        public static Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.ProvisioningState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.ProvisioningState Unknown = @"Unknown";

        public static Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Communication.Support.ProvisioningState e)
        {
            return e._value;
        }
