...
namespace Microsoft.Azure.PowerShell.Cmdlets.Relationships.Models
{
    ...
    public partial class ResourceTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <paramref name="sourceValue"/> parameter to the <see cref="Resource"/> type.
        /// </summary>
        ...
        public static bool CanConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                ...
                return true == text?.StartsWith("{") && true == text?.EndsWith("}") && Microsoft.Azure.PowerShell.Cmdlets.Relationships.Runtime.Json.JsonNode.Parse(text).Type == Microsoft.Azure.PowerShell.Cmdlets.Relationships.Runtime.Json.JsonType.Object;
            }
            catch
            {
        ...
        /// <summary>
        /// Converts the <paramref name="sourceValue" /> parameter into an instance of <see cref="Resource" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="Resource" />.</param>
        /// <returns>
        /// an instance of <see cref="Resource" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Relationships.Models.IResource ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Relationships.Models.IResource).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
