 ...
 *--------------------------------------------------------------------------------------------*/
namespace Microsoft.Azure.PowerShell.Cmdlets.DefenderForStorage.Runtime
{
    using Microsoft.Azure.PowerShell.Cmdlets.DefenderForStorage.generated.runtime.Properties;
    using System;
    ...
    public class GenericBreakingChangeAttribute : Attribute
    {
        ...
        public string moduleName { get; set; } = String.IsNullOrEmpty(@"Az.Security") ? @"Az.DefenderForStorage" : @"Az.Security";
