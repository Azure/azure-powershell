...
namespace Microsoft.Azure.PowerShell.Cmdlets.Security.Models
{
    ...
    public partial class DefenderCspmAwsOfferingVMScannersConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderCspmAwsOfferingVMScannersConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderCspmAwsOfferingVMScannersConfigurationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderCspmAwsOfferingVMScannersConfigurationExclusionTags _exclusionTag;

        /// <summary>VM tags that indicates that VM should not be scanned</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Security.Origin(Microsoft.Azure.PowerShell.Cmdlets.Security.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderCspmAwsOfferingVMScannersConfigurationExclusionTags ExclusionTag { get => (this._exclusionTag = this._exclusionTag ?? new Microsoft.Azure.PowerShell.Cmdlets.Security.Models.DefenderCspmAwsOfferingVMScannersConfigurationExclusionTags()); set => this._exclusionTag = value; }
        ...
        /// <summary>
        /// Creates an new <see cref="DefenderCspmAwsOfferingVMScannersConfiguration" /> instance.
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderCspmAwsOfferingVMScannersConfigurationExclusionTags ExclusionTag { get; set; }
        /// <summary>The scanning mode for the VM scan.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    /// configuration for Microsoft Defender for Server VM scanning
    internal partial interface IDefenderCspmAwsOfferingVMScannersConfigurationInternal
