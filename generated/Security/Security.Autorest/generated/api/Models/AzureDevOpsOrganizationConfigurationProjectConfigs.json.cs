...
namespace Microsoft.Azure.PowerShell.Cmdlets.Security.Models
{
    ...
    public partial class AzureDevOpsOrganizationConfigurationProjectConfigs
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonObject into a new instance of <see cref="AzureDevOpsOrganizationConfigurationProjectConfigs"
        /// />.
        /// </summary>
        ...
        internal AzureDevOpsOrganizationConfigurationProjectConfigs(Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonObject json, global::System.Collections.Generic.HashSet<string> exclusions = null)
        {
            ...
            Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.JsonSerializable.FromJson( json, ((Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.IAssociativeArray<Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IAzureDevOpsProjectConfiguration>)this).AdditionalProperties, (j) => Microsoft.Azure.PowerShell.Cmdlets.Security.Models.AzureDevOpsProjectConfiguration.FromJson(j) ,exclusions );
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IAzureDevOpsOrganizationConfigurationProjectConfigs.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IAzureDevOpsOrganizationConfigurationProjectConfigs.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IAzureDevOpsOrganizationConfigurationProjectConfigs FromJson(Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonObject json ? new AzureDevOpsOrganizationConfigurationProjectConfigs(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AzureDevOpsOrganizationConfigurationProjectConfigs" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AzureDevOpsOrganizationConfigurationProjectConfigs" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.SerializationMode serializationMode)
        {
            ...
            Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.JsonSerializable.ToJson( ((Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.IAssociativeArray<Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IAzureDevOpsProjectConfiguration>)this).AdditionalProperties, container);
