...
namespace Microsoft.Azure.PowerShell.Cmdlets.Security.Models
{
    ...
    public partial class DefenderCspmAwsOfferingVMScanners :
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderCspmAwsOfferingVMScanners,
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderCspmAwsOfferingVMScannersInternal
    {

        /// <summary>Backing field for <see cref="Configuration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderCspmAwsOfferingVMScannersConfiguration _configuration;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderCspmAwsOfferingVMScannersConfiguration Configuration { get => (this._configuration = this._configuration ?? new Microsoft.Azure.PowerShell.Cmdlets.Security.Models.DefenderCspmAwsOfferingVMScannersConfiguration()); set => this._configuration = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderCspmAwsOfferingVMScannersConfiguration Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderCspmAwsOfferingVMScannersInternal.Configuration { get => (this._configuration = this._configuration ?? new Microsoft.Azure.PowerShell.Cmdlets.Security.Models.DefenderCspmAwsOfferingVMScannersConfiguration()); set { {_configuration = value;} } }

        /// <summary>Creates an new <see cref="DefenderCspmAwsOfferingVMScanners" /> instance.</summary>
    ...
    /// The Microsoft Defender for Server VM scanning configuration
    internal partial interface IDefenderCspmAwsOfferingVMScannersInternal

    {
        /// <summary>configuration for Microsoft Defender for Server VM scanning</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderCspmAwsOfferingVMScannersConfiguration Configuration { get; set; }
        /// <summary>The cloud role ARN in AWS for this feature</summary>
        string ConfigurationCloudRoleArn { get; set; }
        /// <summary>VM tags that indicates that VM should not be scanned</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderCspmAwsOfferingVMScannersConfigurationExclusionTags ConfigurationExclusionTag { get; set; }
