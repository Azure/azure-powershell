...
namespace Microsoft.Azure.PowerShell.Cmdlets.Security.Models
{
    ...
    public partial class CspmMonitorGitLabOffering :
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.ICspmMonitorGitLabOffering,
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.ICspmMonitorGitLabOfferingInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.IValidates
    {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Security.Origin(Microsoft.Azure.PowerShell.Cmdlets.Security.PropertyOrigin.Inherited)]
        public string OfferingType { get => "CspmMonitorGitLab"; set => ((Microsoft.Azure.PowerShell.Cmdlets.Security.Models.ICloudOfferingInternal)__cloudOffering).OfferingType = "CspmMonitorGitLab"; }

        /// <summary>Creates an new <see cref="CspmMonitorGitLabOffering" /> instance.</summary>
        public CspmMonitorGitLabOffering()
        {
            this.__cloudOffering.OfferingType = "CspmMonitorGitLab";
        }
    ...
    public partial interface ICspmMonitorGitLabOffering :
    ...
    /// The CSPM (Cloud security posture management) monitoring for gitlab offering
    internal partial interface ICspmMonitorGitLabOfferingInternal :
