...
param(
    ...
    [Parameter(ParameterSetName='DeleteViaIdentityBackupVault', Mandatory)]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            DeleteViaIdentityBackupVault = 'Az.DataProtection.private\Remove-AzDataProtectionBackupInstance_DeleteViaIdentityBackupVault';
        }
