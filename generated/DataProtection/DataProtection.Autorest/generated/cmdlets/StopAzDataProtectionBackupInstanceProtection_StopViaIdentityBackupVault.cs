...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupInstances/{backupInstanceName}/stopProtection", ApiVersion = "2026-03-01")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IStopProtectionRequest _parameter;

        /// <summary>Request body of Stop protection when MUA is Enabled</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Request body of Stop protection when MUA is Enabled", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Request body of Stop protection when MUA is Enabled",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IStopProtectionRequest) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IStopProtectionRequest Parameter { get => this._parameter; set => this._parameter = value; }
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (BackupVaultInputObject?.Id != null)
                    {
                        ...
                        await this.Client.BackupInstancesStopProtectionViaIdentity(BackupVaultInputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("Token") ? Token : null, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BackupInstancesStopProtection(BackupVaultInputObject.SubscriptionId ?? null, BackupVaultInputObject.ResourceGroupName ?? null, BackupVaultInputObject.VaultName ?? null, BackupInstanceName, this.InvocationInformation.BoundParameters.ContainsKey("Token") ? Token : null, Parameter, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { BackupInstanceName=BackupInstanceName,Token=this.InvocationInformation.BoundParameters.ContainsKey("Token") ? Token : null})
                    {
