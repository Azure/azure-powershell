            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (BackupVaultInputObject?.Id != null)
                    {
                        ...
                        await this.Client.BackupInstancesCreateOrUpdateViaIdentity(BackupVaultInputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("Token") ? Token : null, Parameter, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        ...
                        await this.Client.BackupInstancesCreateOrUpdate(BackupVaultInputObject.SubscriptionId ?? null, BackupVaultInputObject.ResourceGroupName ?? null, BackupVaultInputObject.VaultName ?? null, Name, this.InvocationInformation.BoundParameters.ContainsKey("Token") ? Token : null, Parameter, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.SerializationMode.IncludeCreate);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Name=Name,Token=this.InvocationInformation.BoundParameters.ContainsKey("Token") ? Token : null})
                    {
