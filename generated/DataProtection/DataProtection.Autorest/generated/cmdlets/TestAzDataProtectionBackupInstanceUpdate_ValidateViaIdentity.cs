...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
    ...
    /// <summary>Validate whether validate for backup instance will be successful or not</summary>
    /// <remarks>
    /// [OpenAPI] ValidateForModifyBackup=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupInstances/{backupInstanceName}/validateForModifyBackup"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzDataProtectionBackupInstanceUpdate_ValidateViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IOperationJobExtendedInfo))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Description(@"Validate whether validate for backup instance will be successful or not")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupInstances/{backupInstanceName}/validateForModifyBackup", ApiVersion = "2026-03-01")]
    public partial class TestAzDataProtectionBackupInstanceUpdate_ValidateViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="ValidateForModifyBackupRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IValidateForModifyBackupRequest _validateForModifyBackupRequest;

        /// <summary>Validate for modify backup request</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Validate for modify backup request", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Validate for modify backup request",
        SerializedName = @"validateForModifyBackupRequest",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IValidateForModifyBackupRequest) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IValidateForModifyBackupRequest ValidateForModifyBackupRequest { get => this._validateForModifyBackupRequest; set => this._validateForModifyBackupRequest = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IErrorResponse">Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IErrorResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IErrorResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IOperationJobExtendedInfo">Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IOperationJobExtendedInfo</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IOperationJobExtendedInfo> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of TestAzDataProtectionBackupInstanceUpdate_ValidateViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets.TestAzDataProtectionBackupInstanceUpdate_ValidateViaIdentity Clone()
        {
            var clone = new TestAzDataProtectionBackupInstanceUpdate_ValidateViaIdentity();
            ...
            clone.ValidateForModifyBackupRequest = this.ValidateForModifyBackupRequest;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BackupInstancesValidateForModifyBackup' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BackupInstancesValidateForModifyBackupViaIdentity(InputObject.Id, ValidateForModifyBackupRequest, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.BackupInstanceName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.BackupInstanceName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.BackupInstancesValidateForModifyBackup(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VaultName ?? null, InputObject.BackupInstanceName ?? null, ValidateForModifyBackupRequest, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestAzDataProtectionBackupInstanceUpdate_ValidateViaIdentity" /> cmdlet class.
        /// </summary>
        public TestAzDataProtectionBackupInstanceUpdate_ValidateViaIdentity()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IErrorResponse>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IOperationJobExtendedInfo> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IOperationJobExtendedInfo
