...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
    ...
    /// <summary>
    /// This operation will stop backup for a backup instance and retains the backup data as per the policy (except latest Recovery
    /// point, which will be retained forever)
    /// </summary>
    /// <remarks>
    /// [OpenAPI] SuspendBackups=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupInstances/{backupInstanceName}/suspendBackups"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Suspend, @"AzDataProtectionBackupInstanceBackup_SuspendViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Description(@"This operation will stop backup for a backup instance and retains the backup data as per the policy (except latest Recovery point, which will be retained forever)")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupInstances/{backupInstanceName}/suspendBackups", ApiVersion = "2025-02-01")]
    public partial class SuspendAzDataProtectionBackupInstanceBackup_SuspendViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.ISuspendBackupRequest _parameter;

        /// <summary>Request body of Suspend backup when MUA is Enabled</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Request body of Suspend backup when MUA is Enabled", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Request body of Suspend backup when MUA is Enabled",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.ISuspendBackupRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.ISuspendBackupRequest Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.ICloudError">Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.ICloudError</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.ICloudError> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of SuspendAzDataProtectionBackupInstanceBackup_SuspendViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets.SuspendAzDataProtectionBackupInstanceBackup_SuspendViaIdentity Clone()
        {
            var clone = new SuspendAzDataProtectionBackupInstanceBackup_SuspendViaIdentity();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BackupInstancesSuspendBackups' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BackupInstancesSuspendBackupsViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("Token") ? Token : null, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BackupInstancesSuspendBackups(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VaultName ?? null, InputObject.BackupInstanceName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("Token") ? Token : null, Parameter, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Token=this.InvocationInformation.BoundParameters.ContainsKey("Token") ? Token : null,body=Parameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SuspendAzDataProtectionBackupInstanceBackup_SuspendViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public SuspendAzDataProtectionBackupInstanceBackup_SuspendViaIdentity()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.ICloudError>(responseMessage, await response);
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Token=this.InvocationInformation.BoundParameters.ContainsKey("Token") ? Token : null, body=Parameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Token=this.InvocationInformation.BoundParameters.ContainsKey("Token") ? Token : null, body=Parameter })
                    {
