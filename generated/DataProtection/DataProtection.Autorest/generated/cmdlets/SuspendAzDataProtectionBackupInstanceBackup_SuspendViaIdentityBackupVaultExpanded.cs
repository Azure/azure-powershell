...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Resource guard operation request in the format similar to <ResourceGuard-ARMID>/dppDisableSuspendBackupsRequests/default. Use this parameter when the operation is MUA protected.")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (BackupVaultInputObject?.Id != null)
                    {
                        ...
                        await this.Client.BackupInstancesSuspendBackupsViaIdentity(BackupVaultInputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("Token") ? Token : null, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
