...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models
{
    ...
    public partial class SecretStoreResource :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.ISecretStoreResource,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.ISecretStoreResourceInternal
    {

        /// <summary>Backing field for <see cref="SecretStoreType" /> property.</summary>
        private string _secretStoreType;

        /// <summary>Gets or sets the type of secret store</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        public string SecretStoreType { get => this._secretStoreType; set => this._secretStoreType = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IJsonSerializable
    {
        ...
        string SecretStoreType { get; set; }
        /// <summary>Uri to get to the resource</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Info(
        Required = false,
        ReadOnly = false,
