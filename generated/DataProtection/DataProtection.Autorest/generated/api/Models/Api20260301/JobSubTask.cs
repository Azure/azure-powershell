...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301
{
    ...
    public partial class JobSubTask :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.IJobSubTask,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.IJobSubTaskInternal
    {

        /// <summary>Backing field for <see cref="AdditionalDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.IJobSubTaskAdditionalDetails _additionalDetail;

        /// <summary>Additional details of Sub Tasks</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.IJobSubTaskAdditionalDetails AdditionalDetail { get => (this._additionalDetail = this._additionalDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.JobSubTaskAdditionalDetails()); set => this._additionalDetail = value; }

        /// <summary>Internal Acessors for TaskProgress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.IJobSubTaskInternal.TaskProgress { get => this._taskProgress; set { {_taskProgress = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.IJobSubTaskAdditionalDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20260301.IJobSubTaskAdditionalDetails AdditionalDetail { get; set; }
        /// <summary>Task Id of the Sub Task</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Info(
        Required = true,
        ReadOnly = false,
