...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401
{
    ...
    public partial class UserFacingError :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IUserFacingErrorInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IUserFacingError[] _detail;

        /// <summary>Additional related Errors</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IUserFacingError[] Detail { get => this._detail; set => this._detail = value; }

        /// <summary>Backing field for <see cref="InnerError" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IInnerError _innerError;

        /// <summary>Inner Error</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IInnerError InnerError { get => (this._innerError = this._innerError ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.InnerError()); set => this._innerError = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IUserFacingErrorProperties _property;

        /// <summary>Any key value pairs that can be injected inside error object</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IUserFacingErrorProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.UserFacingErrorProperties()); set => this._property = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IUserFacingError[] Detail { get; set; }
        /// <summary>Inner Error</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IInnerError InnerError { get; set; }
        /// <summary>Whether the operation will be retryable or not</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IUserFacingErrorProperties) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IUserFacingErrorProperties Property { get; set; }
        /// <summary>RecommendedAction � localized.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Info(
        Required = false,
        ReadOnly = false,
