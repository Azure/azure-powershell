...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401
{
    ...
    public partial class SecuritySettings :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.ISecuritySettings,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.ISecuritySettingsInternal
    {

        /// <summary>Backing field for <see cref="EncryptionSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IEncryptionSettings _encryptionSetting;

        /// <summary>Customer Managed Key details of the resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IEncryptionSettings EncryptionSetting { get => (this._encryptionSetting = this._encryptionSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.EncryptionSettings()); set => this._encryptionSetting = value; }

        /// <summary>Backing field for <see cref="ImmutabilitySetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IImmutabilitySettings _immutabilitySetting;

        /// <summary>Immutability Settings at vault level</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IImmutabilitySettings ImmutabilitySetting { get => (this._immutabilitySetting = this._immutabilitySetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.ImmutabilitySettings()); set => this._immutabilitySetting = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.ISoftDeleteSettings Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.ISecuritySettingsInternal.SoftDeleteSetting { get => (this._softDeleteSetting = this._softDeleteSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.SoftDeleteSettings()); set { {_softDeleteSetting = value;} } }

        /// <summary>Soft delete retention duration</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Inlined)]
        public double? SoftDeleteRetentionDurationInDay { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.ISoftDeleteSettingsInternal)SoftDeleteSetting).RetentionDurationInDay; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.ISoftDeleteSettingsInternal)SoftDeleteSetting).RetentionDurationInDay = value ?? default(double); }

        /// <summary>Backing field for <see cref="SoftDeleteSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.ISoftDeleteSettings _softDeleteSetting;

        /// <summary>Soft delete related settings</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.ISoftDeleteSettings SoftDeleteSetting { get => (this._softDeleteSetting = this._softDeleteSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.SoftDeleteSettings()); set => this._softDeleteSetting = value; }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IEncryptionSettings EncryptionSetting { get; set; }
        /// <summary>Immutability Settings at vault level</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20240401.IImmutabilitySettings ImmutabilitySetting { get; set; }
        /// <summary>Immutability state</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support.ImmutabilityState? ImmutabilityState { get; set; }
        /// <summary>Soft delete retention duration</summary>
        double? SoftDeleteRetentionDurationInDay { get; set; }
