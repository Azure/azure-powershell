...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201
{
    ...
    public partial class AzureBackupRestoreRequest :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IAzureBackupRestoreRequestInternal
    {

        /// <summary>Backing field for <see cref="IdentityDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IIdentityDetails _identityDetail;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IIdentityDetails IdentityDetail { get => (this._identityDetail = this._identityDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IdentityDetails()); set => this._identityDetail = value; }

        /// <summary>Specifies if the BI is protected by System Identity.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Inlined)]
        public bool? IdentityDetailUseSystemAssignedIdentity { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IIdentityDetailsInternal)IdentityDetail).UseSystemAssignedIdentity; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IIdentityDetailsInternal)IdentityDetail).UseSystemAssignedIdentity = value ?? default(bool); }

        /// <summary>ARM URL for User Assigned Identity.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Inlined)]
        public string IdentityDetailUserAssignedIdentityArmUrl { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IIdentityDetailsInternal)IdentityDetail).UserAssignedIdentityArmUrl; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IIdentityDetailsInternal)IdentityDetail).UserAssignedIdentityArmUrl = value ?? null; }

        /// <summary>Internal Acessors for IdentityDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IIdentityDetails Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IAzureBackupRestoreRequestInternal.IdentityDetail { get => (this._identityDetail = this._identityDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IdentityDetails()); set { {_identityDetail = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IRestoreTargetInfoBase _restoreTargetInfo;

        /// <summary>Gets or sets the restore target information.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IRestoreTargetInfoBase RestoreTargetInfo { get => (this._restoreTargetInfo = this._restoreTargetInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.RestoreTargetInfoBase()); set => this._restoreTargetInfo = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IRestoreTargetInfoBase RestoreTargetInfo { get; set; }
        /// <summary>Gets or sets the type of the source data store.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Info(
        Required = true,
        ReadOnly = false,
...

    {
        ...
        /// If it is null, default will be considered as System Assigned.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IIdentityDetails IdentityDetail { get; set; }
        /// <summary>Specifies if the BI is protected by System Identity.</summary>
        bool? IdentityDetailUseSystemAssignedIdentity { get; set; }
        /// <summary>ARM URL for User Assigned Identity.</summary>
        string IdentityDetailUserAssignedIdentityArmUrl { get; set; }
