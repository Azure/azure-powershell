...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901
{
    ...
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901.IBackupCriteria"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901.IBackupCriteria __backupCriteria = new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901.BackupCriteria();
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901.IDay[] _daysOfMonth;

        /// <summary>This is day of the month from 1 to 28 other wise last of month</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901.IDay[] DaysOfMonth { get => this._daysOfMonth; set => this._daysOfMonth = value; }
        ...
        public string ObjectType { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901.IBackupCriteriaInternal)__backupCriteria).ObjectType; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901.IBackupCriteriaInternal)__backupCriteria).ObjectType = value ; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901.IBackupCriteria
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901.IDay) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901.IDay[] DaysOfMonth { get; set; }
        /// <summary>It should be Sunday/Monday/T..../Saturday</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Info(
        Required = false,
        ReadOnly = false,
