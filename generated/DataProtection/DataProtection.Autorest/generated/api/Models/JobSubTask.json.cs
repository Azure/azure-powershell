...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models
{
    ...
    public partial class JobSubTask
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IJobSubTask.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IJobSubTask.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IJobSubTask FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode node)
        {
        ...
        internal JobSubTask(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject json)
        {
            ...
            {_additionalDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("additionalDetails"), out var __jsonAdditionalDetails) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.JobSubTaskAdditionalDetails.FromJson(__jsonAdditionalDetails) : _additionalDetail;}
            {_taskId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNumber>("taskId"), out var __jsonTaskId) ? (int)__jsonTaskId : _taskId;}
            {_taskName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("taskName"), out var __jsonTaskName) ? (string)__jsonTaskName : (string)_taskName;}
            {_taskProgress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("taskProgress"), out var __jsonTaskProgress) ? (string)__jsonTaskProgress : (string)_taskProgress;}
            {_taskStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("taskStatus"), out var __jsonTaskStatus) ? (string)__jsonTaskStatus : (string)_taskStatus;}
            AfterFromJson(json);
        }
