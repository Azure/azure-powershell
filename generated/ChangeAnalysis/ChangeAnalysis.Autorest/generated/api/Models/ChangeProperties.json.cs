...
namespace Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Models
{
    ...
    public partial class ChangeProperties
    {
        ...
        internal ChangeProperties(Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Runtime.Json.JsonObject json)
        {
            ...
            {_resourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Runtime.Json.JsonString>("resourceId"), out var __jsonResourceId) ? (string)__jsonResourceId : (string)_resourceId;}
            ...
            {_initiatedByList = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Runtime.Json.JsonArray>("initiatedByList"), out var __jsonInitiatedByList) ? If( __jsonInitiatedByList as Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _initiatedByList;}
            {_changeType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Runtime.Json.JsonString>("changeType"), out var __jsonChangeType) ? (string)__jsonChangeType : (string)_changeType;}
            {_propertyChange = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Runtime.Json.JsonArray>("propertyChanges"), out var __jsonPropertyChanges) ? If( __jsonPropertyChanges as Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Models.IPropertyChange>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Models.IPropertyChange) (Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Models.PropertyChange.FromJson(__p) )) ))() : null : _propertyChange;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Models.IChangeProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Models.IChangeProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Models.IChangeProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Runtime.Json.JsonNode node)
        {
