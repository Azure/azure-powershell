...
namespace Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Models
{
    ...
    public partial class PropertyChangeTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <paramref name="sourceValue"/> parameter to the <see cref="PropertyChange"/>
        /// type.
        /// </summary>
        ...
        /// <summary>
        /// Converts the <paramref name="sourceValue" /> parameter into an instance of <see cref="PropertyChange" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="PropertyChange" />.</param>
        /// <returns>
        /// an instance of <see cref="PropertyChange" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Models.IPropertyChange ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.ChangeAnalysis.Models.IPropertyChange).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
