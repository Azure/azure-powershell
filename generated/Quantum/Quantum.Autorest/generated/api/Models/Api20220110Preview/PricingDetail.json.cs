...
namespace Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.Api20220110Preview
{
    ...
    public partial class PricingDetail
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.Api20220110Preview.IPricingDetail.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.Api20220110Preview.IPricingDetail.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.Api20220110Preview.IPricingDetail FromJson(Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonObject json ? new PricingDetail(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonObject into a new instance of <see cref="PricingDetail" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PricingDetail(Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonObject json)
        {
            ...
            {_value = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonString>("value"), out var __jsonValue) ? (string)__jsonValue : (string)Value;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PricingDetail" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PricingDetail" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._value)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonString(this._value.ToString()) : null, "value" ,container.Add );
