...
namespace Microsoft.Azure.PowerShell.Cmdlets.Quantum.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Quantum.Support.Status Deleted = @"Deleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.Quantum.Support.Status Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.Quantum.Support.Status Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Quantum.Support.Status Launching = @"Launching";

        public static Microsoft.Azure.PowerShell.Cmdlets.Quantum.Support.Status Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.Quantum.Support.Status Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Quantum.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Quantum.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Quantum.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.Quantum.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
