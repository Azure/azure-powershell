...
namespace Microsoft.Azure.PowerShell.Cmdlets.Reservations.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Reservations.Support.OperationStatus Cancelled = @"Cancelled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Reservations.Support.OperationStatus Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Reservations.Support.OperationStatus Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.Reservations.Support.OperationStatus Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Support.OperationStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Support.OperationStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Support.OperationStatus e1, Microsoft.Azure.PowerShell.Cmdlets.Reservations.Support.OperationStatus e2)
        {
            return !e2.Equals(e1);
        }
