...
namespace Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models
{
    ...
    public partial class ChangeDirectoryRequest
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject into a new instance of <see cref="ChangeDirectoryRequest" />.
        /// </summary>
        ...
        internal ChangeDirectoryRequest(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject json)
        {
            ...
            {_destinationTenantId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonString>("destinationTenantId"), out var __jsonDestinationTenantId) ? (string)__jsonDestinationTenantId : (string)_destinationTenantId;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IChangeDirectoryRequest.
        /// </summary>
        ...
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IChangeDirectoryRequest FromJson(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject json ? new ChangeDirectoryRequest(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ChangeDirectoryRequest" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ChangeDirectoryRequest" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._destinationTenantId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonString(this._destinationTenantId.ToString()) : null, "destinationTenantId" ,container.Add );
