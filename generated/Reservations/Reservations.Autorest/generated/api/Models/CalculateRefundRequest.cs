...
namespace Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models
{
    ...
    public partial class CalculateRefundRequest :
        Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateRefundRequest,
        Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateRefundRequestInternal
    {
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Reservations.Origin(Microsoft.Azure.PowerShell.Cmdlets.Reservations.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateRefundRequestProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.CalculateRefundRequestProperties()); set => this._property = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Reservations.Origin(Microsoft.Azure.PowerShell.Cmdlets.Reservations.PropertyOrigin.Inlined)]
        public string ReservationToReturnReservationId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateRefundRequestPropertiesInternal)Property).ReservationToReturnReservationId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateRefundRequestPropertiesInternal)Property).ReservationToReturnReservationId = value ?? null; }

        /// <summary>The scope of the refund, e.g. Reservation</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Reservations.Origin(Microsoft.Azure.PowerShell.Cmdlets.Reservations.PropertyOrigin.Inlined)]
        public string Scope { get => ((Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateRefundRequestPropertiesInternal)Property).Scope; set => ((Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateRefundRequestPropertiesInternal)Property).Scope = value ?? null; }
...

    {
        ...
        /// Properties needed for calculate refund including the scope and the reservation to be returned.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateRefundRequestProperties Property { get; set; }
        /// <summary>Reservation to return</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IReservationToReturn ReservationToReturn { get; set; }
        /// <summary>Quantity to be returned. Must be greater than zero.</summary>
        int? ReservationToReturnQuantity { get; set; }
        /// <summary>Fully qualified identifier of the reservation being returned</summary>
        string ReservationToReturnReservationId { get; set; }
