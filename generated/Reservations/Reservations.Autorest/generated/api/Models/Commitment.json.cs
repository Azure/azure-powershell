...
namespace Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models
{
    ...
    public partial class Commitment
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject into a new instance of <see cref="Commitment" />.
        /// </summary>
        ...
        internal Commitment(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject json)
        {
            ...
            __price = new Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.Price(json);
            {_grain = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonString>("grain"), out var __jsonGrain) ? (string)__jsonGrain : (string)_grain;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICommitment.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICommitment.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICommitment FromJson(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject json ? new Commitment(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="Commitment" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Commitment" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._grain)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Json.JsonString(this._grain.ToString()) : null, "grain" ,container.Add );
