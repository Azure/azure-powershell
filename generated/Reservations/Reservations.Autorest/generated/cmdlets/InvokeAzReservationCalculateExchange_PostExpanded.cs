...
namespace Microsoft.Azure.PowerShell.Cmdlets.Reservations.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Post=>POST:"/providers/Microsoft.Capacity/calculateExchange"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzReservationCalculateExchange_PostExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Reservations.HttpPath(Path = "/providers/Microsoft.Capacity/calculateExchange", ApiVersion = "2022-11-01")]
    public partial class InvokeAzReservationCalculateExchange_PostExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateExchangeRequest _body = new Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.CalculateExchangeRequest();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of reservations that are being returned in this exchange.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IReservationToReturn[] ReservationsToExchange { get => _body.ReservationsToExchange?.ToArray() ?? null /* fixedArrayOf */; set => _body.ReservationsToExchange = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IReservationToReturn>(value) : null); }

        /// <summary>List of reservations that are being purchased in this exchange.</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of reservations that are being purchased in this exchange.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Reservations.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Reservations.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IPurchaseRequest[] ReservationsToPurchase { get => _body.ReservationsToPurchase?.ToArray() ?? null /* fixedArrayOf */; set => _body.ReservationsToPurchase = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IPurchaseRequest>(value) : null); }

        /// <summary>List of savings plans that are being purchased in this exchange.</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of savings plans that are being purchased in this exchange.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Reservations.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Reservations.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ISavingsPlanPurchaseRequest[] SavingsPlansToPurchase { get => _body.SavingsPlansToPurchase?.ToArray() ?? null /* fixedArrayOf */; set => _body.SavingsPlansToPurchase = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ISavingsPlanPurchaseRequest>(value) : null); }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IError">Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IError</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IError> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateExchangeOperationResultResponse">Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateExchangeOperationResultResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateExchangeOperationResultResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of InvokeAzReservationCalculateExchange_PostExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Reservations.Cmdlets.InvokeAzReservationCalculateExchange_PostExpanded Clone()
        {
            var clone = new InvokeAzReservationCalculateExchange_PostExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzReservationCalculateExchange_PostExpanded" /> cmdlet class.
        /// </summary>
        public InvokeAzReservationCalculateExchange_PostExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CalculateExchangePost' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CalculateExchangePost(_body, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.Reservations.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IError>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateExchangeOperationResultResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateExchangeOperationResultResponse
