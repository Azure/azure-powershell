...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models
{
    ...
    public partial class DicomServiceProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonObject into a new instance of <see cref="DicomServiceProperties" />.
        /// </summary>
        ...
        internal DicomServiceProperties(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonObject json)
        {
            ...
            {_authenticationConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonObject>("authenticationConfiguration"), out var __jsonAuthenticationConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.DicomServiceAuthenticationConfiguration.FromJson(__jsonAuthenticationConfiguration) : _authenticationConfiguration;}
            ...
            {_serviceUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonString>("serviceUrl"), out var __jsonServiceUrl) ? (string)__jsonServiceUrl : (string)_serviceUrl;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.IDicomServiceProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.IDicomServiceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.IDicomServiceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonObject json ? new DicomServiceProperties(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="DicomServiceProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="DicomServiceProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.SerializationMode.IncludeRead))
            {
                AddIf( null != (((object)this._serviceUrl)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonString(this._serviceUrl.ToString()) : null, "serviceUrl" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.SerializationMode.IncludeRead))
            {
