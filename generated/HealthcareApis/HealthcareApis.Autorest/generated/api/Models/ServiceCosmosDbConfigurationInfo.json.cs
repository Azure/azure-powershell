...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models
{
    ...
    public partial class ServiceCosmosDbConfigurationInfo
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.IServiceCosmosDbConfigurationInfo.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.IServiceCosmosDbConfigurationInfo.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.IServiceCosmosDbConfigurationInfo FromJson(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNode node)
        {
        ...
        internal ServiceCosmosDbConfigurationInfo(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonObject json)
        {
            ...
            {_offerThroughput = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNumber>("offerThroughput"), out var __jsonOfferThroughput) ? (int?)__jsonOfferThroughput : _offerThroughput;}
            {_keyVaultKeyUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonString>("keyVaultKeyUri"), out var __jsonKeyVaultKeyUri) ? (string)__jsonKeyVaultKeyUri : (string)_keyVaultKeyUri;}
            AfterFromJson(json);
        }
