...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models
{
    ...
    public partial class FhirServiceCorsConfiguration :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.IFhirServiceCorsConfigurationInternal
    {
        ...
        private System.Collections.Generic.List<string> _header;

        /// <summary>The headers to be allowed via CORS.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Origin(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> Header { get => this._header; set => this._header = value; }
        ...
        private System.Collections.Generic.List<string> _method;

        /// <summary>The methods to be allowed via CORS.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Origin(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> Method { get => this._method; set => this._method = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Origin(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> Origin { get => this._origin; set => this._origin = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> Method { get; set; }
        /// <summary>The origins to be allowed via CORS.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> Origin { get; set; }
