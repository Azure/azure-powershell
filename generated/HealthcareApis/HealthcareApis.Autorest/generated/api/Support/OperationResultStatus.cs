...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Support.OperationResultStatus Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Support.OperationResultStatus Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Support.OperationResultStatus Requested = @"Requested";

        public static Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Support.OperationResultStatus Running = @"Running";

        public static Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Support.OperationResultStatus Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Support.OperationResultStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Support.OperationResultStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Support.OperationResultStatus e1, Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Support.OperationResultStatus e2)
        {
            return !e2.Equals(e1);
        }
