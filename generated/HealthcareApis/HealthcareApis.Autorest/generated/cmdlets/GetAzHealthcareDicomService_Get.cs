...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzHealthcareDicomService_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.DicomServicesGet(SubscriptionId, ResourceGroupName, WorkspaceName, Name, onOk, onDefault, this, Pipeline);
