...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzHealthcareIotConnector_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.IotConnectorsGet(ResourceGroupName, SubscriptionId, WorkspaceName, Name, onOk, onDefault, this, Pipeline);
