...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.IContext
    {
        ...
        public global::System.Management.Automation.SwitchParameter EnableSystemAssignedIdentity { set => _fhirserviceBody.IdentityType = value.IsPresent ? "SystemAssigned": null ; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzHealthcareFhirService_CreateExpanded" /> cmdlet class.
        /// </summary>
        ...
        private void PreProcessManagedIdentityParameters()
        {
            ...
            if (this.UserAssignedIdentity?.Length > 0)
            {
                if ("SystemAssigned".Equals(_fhirserviceBody.IdentityType, StringComparison.InvariantCultureIgnoreCase))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FhirServicesCreateOrUpdate(SubscriptionId, ResourceGroupName, WorkspaceName, Name, _fhirserviceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.SerializationMode.IncludeCreate);
