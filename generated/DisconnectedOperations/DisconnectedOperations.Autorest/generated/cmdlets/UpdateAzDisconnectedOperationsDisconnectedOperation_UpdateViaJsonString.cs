...
namespace Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/disconnectedOperations/{name}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzDisconnectedOperationsDisconnectedOperation_UpdateViaJsonString", SupportsShouldProcess = true)]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Runtime.IContext
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DisconnectedOperationsUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DisconnectedOperationsUpdateViaJsonString(SubscriptionId, ResourceGroupName, Name, _jsonString, onOk, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzDisconnectedOperationsDisconnectedOperation_UpdateViaJsonString"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzDisconnectedOperationsDisconnectedOperation_UpdateViaJsonString()
        {
