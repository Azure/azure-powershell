...
namespace Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/disconnectedOperations/{name}/images/{imageName}/artifacts/{artifactName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDisconnectedOperationsArtifact_GetViaIdentityImage")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Models.IArtifact))]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/disconnectedOperations/{name}/images/{imageName}/artifacts/{artifactName}", ApiVersion = "2025-06-01-preview")]
    public partial class GetAzDisconnectedOperationsArtifact_GetViaIdentityImage : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="ImageInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Models.IDisconnectedOperationsIdentity _imageInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Models.IDisconnectedOperationsIdentity ImageInputObject { get => this._imageInputObject; set => this._imageInputObject = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Models.IArtifact">Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Models.IArtifact</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Models.IArtifact> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzDisconnectedOperationsArtifact_GetViaIdentityImage" /> cmdlet class.
        /// </summary>
        public GetAzDisconnectedOperationsArtifact_GetViaIdentityImage()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ImageInputObject?.Id != null)
                    {
                        this.ImageInputObject.Id += $"/artifacts/{(global::System.Uri.EscapeDataString(this.ArtifactName.ToString()))}";
                        await this.Client.ArtifactsGetViaIdentity(ImageInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == ImageInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ImageInputObject has null value for ImageInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ImageInputObject) );
                        }
                        if (null == ImageInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ImageInputObject has null value for ImageInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ImageInputObject) );
                        }
                        if (null == ImageInputObject.Name)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ImageInputObject has null value for ImageInputObject.Name"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ImageInputObject) );
                        }
                        if (null == ImageInputObject.ImageName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ImageInputObject has null value for ImageInputObject.ImageName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ImageInputObject) );
                        }
                        await this.Client.ArtifactsGet(ImageInputObject.SubscriptionId ?? null, ImageInputObject.ResourceGroupName ?? null, ImageInputObject.Name ?? null, ImageInputObject.ImageName ?? null, ArtifactName, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ArtifactName=ArtifactName})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Models.IArtifact> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Models.IArtifact
