...
namespace Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzDisconnectedOperationsHardwareSetting_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Description(@"update hardware settings")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Generated]
    public partial class UpdateAzDisconnectedOperationsHardwareSetting_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzDisconnectedOperationsHardwareSetting_UpdateViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Cmdlets.UpdateAzDisconnectedOperationsHardwareSetting_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzDisconnectedOperationsHardwareSetting_UpdateViaIdentityExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _resourceBody = await this.Client.HardwareSettingsGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_resourceBody();
                        await this.Client.HardwareSettingsCreateOrUpdateViaIdentity(InputObject.Id, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.HardwareSettingName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.HardwareSettingName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        _resourceBody = await this.Client.HardwareSettingsGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.Name ?? null, InputObject.HardwareSettingName ?? null, this, Pipeline);
                        this.Update_resourceBody();
                        await this.Client.HardwareSettingsCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.Name ?? null, InputObject.HardwareSettingName ?? null, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzDisconnectedOperationsHardwareSetting_UpdateViaIdentityExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzDisconnectedOperationsHardwareSetting_UpdateViaIdentityExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Node")))
            {
                this.Node = (int)(this.MyInvocation?.BoundParameters["Node"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("TotalCore")))
            {
                this.TotalCore = (int)(this.MyInvocation?.BoundParameters["TotalCore"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("DiskSpaceInGb")))
            {
                this.DiskSpaceInGb = (int)(this.MyInvocation?.BoundParameters["DiskSpaceInGb"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("MemoryInGb")))
            {
                this.MemoryInGb = (int)(this.MyInvocation?.BoundParameters["MemoryInGb"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Oem")))
            {
                this.Oem = (string)(this.MyInvocation?.BoundParameters["Oem"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("HardwareSku")))
            {
                this.HardwareSku = (string)(this.MyInvocation?.BoundParameters["HardwareSku"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("VersionAtRegistration")))
            {
                this.VersionAtRegistration = (string)(this.MyInvocation?.BoundParameters["VersionAtRegistration"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SolutionBuilderExtension")))
            {
                this.SolutionBuilderExtension = (string)(this.MyInvocation?.BoundParameters["SolutionBuilderExtension"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("DeviceId")))
            {
                this.DeviceId = (string)(this.MyInvocation?.BoundParameters["DeviceId"]);
            }
        }
