...
namespace Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByResourceGroup=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/disconnectedOperations"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDisconnectedOperationsDisconnectedOperation_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Description(@"List DisconnectedOperation resources by resource group")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/disconnectedOperations", ApiVersion = "2025-06-01-preview")]
    public partial class GetAzDisconnectedOperationsDisconnectedOperation_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzDisconnectedOperationsDisconnectedOperation_List" /> cmdlet class.
        /// </summary>
        public GetAzDisconnectedOperationsDisconnectedOperation_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.DisconnectedOperationsListByResourceGroup(SubscriptionId, ResourceGroupName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.DisconnectedOperationsListByResourceGroup_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
