...
begin {
    try {
        ...
        $mapping = @{
            ...
            CreateViaJsonFilePath = 'Az.DeviceUpdate.private\New-AzDeviceUpdateAccount_CreateViaJsonFilePath';
            CreateViaJsonString = 'Az.DeviceUpdate.private\New-AzDeviceUpdateAccount_CreateViaJsonString';
        }
