...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.IContext
    {
        ...
        public global::System.Management.Automation.SwitchParameter EnableSystemAssignedIdentity { set => _accountBody.IdentityType = value.IsPresent ? "SystemAssigned": null ; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzDeviceUpdateAccount_CreateExpanded" /> cmdlet class.
        /// </summary>
        ...
        private void PreProcessManagedIdentityParameters()
        {
            ...
            if (this.UserAssignedIdentity?.Length > 0)
            {
                if ("SystemAssigned".Equals(_accountBody.IdentityType, StringComparison.InvariantCultureIgnoreCase))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AccountsCreate(SubscriptionId, ResourceGroupName, Name, _accountBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.SerializationMode.IncludeCreate);
