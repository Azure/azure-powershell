...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models
{
    ...
    public partial class GroupConnectivityInformation :
        Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IGroupConnectivityInformation,
        Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IGroupConnectivityInformationInternal
    {

        /// <summary>Backing field for <see cref="CustomerVisibleFqdn" /> property.</summary>
        private System.Collections.Generic.List<string> _customerVisibleFqdn;
        ...
        public System.Collections.Generic.List<string> CustomerVisibleFqdn { get => this._customerVisibleFqdn; set => this._customerVisibleFqdn = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IGroupConnectivityInformationInternal.GroupId { get => this._groupId; set { {_groupId = value;} } }

        /// <summary>Internal Acessors for InternalFqdn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IGroupConnectivityInformationInternal.InternalFqdn { get => this._internalFqdn; set { {_internalFqdn = value;} } }

        /// <summary>Internal Acessors for MemberName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IGroupConnectivityInformationInternal.MemberName { get => this._memberName; set { {_memberName = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<string> CustomerVisibleFqdn { get; set; }
        /// <summary>Group ID.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Info(
        Required = false,
        ReadOnly = true,
