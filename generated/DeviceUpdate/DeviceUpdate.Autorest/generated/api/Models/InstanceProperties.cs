...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models
{
    ...
    public partial class InstanceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IInstanceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IInstancePropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IDiagnosticStorageProperties _diagnosticStorageProperty;

        /// <summary>Customer-initiated diagnostic log collection storage properties</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Origin(Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IDiagnosticStorageProperties DiagnosticStorageProperty { get => (this._diagnosticStorageProperty = this._diagnosticStorageProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.DiagnosticStorageProperties()); set => this._diagnosticStorageProperty = value; }
        ...
        public string DiagnosticStoragePropertyAuthenticationType { get => ((Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IDiagnosticStoragePropertiesInternal)DiagnosticStorageProperty).AuthenticationType; }

        /// <summary>ConnectionString of the diagnostic storage account</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Origin(Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.PropertyOrigin.Inlined)]
        public string DiagnosticStoragePropertyConnectionString { get => ((Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IDiagnosticStoragePropertiesInternal)DiagnosticStorageProperty).ConnectionString; set => ((Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IDiagnosticStoragePropertiesInternal)DiagnosticStorageProperty).ConnectionString = value ?? null; }

        /// <summary>ResourceId of the diagnostic storage account</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Origin(Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.PropertyOrigin.Inlined)]
        public string DiagnosticStoragePropertyResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IDiagnosticStoragePropertiesInternal)DiagnosticStorageProperty).ResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IDiagnosticStoragePropertiesInternal)DiagnosticStorageProperty).ResourceId = value ?? null; }
        ...
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IIotHubSettings> _iotHub;

        /// <summary>List of IoT Hubs associated with the account.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Origin(Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IIotHubSettings> IotHub { get => this._iotHub; set => this._iotHub = value; }

        /// <summary>Internal Acessors for AccountName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IInstancePropertiesInternal.AccountName { get => this._accountName; set { {_accountName = value;} } }
