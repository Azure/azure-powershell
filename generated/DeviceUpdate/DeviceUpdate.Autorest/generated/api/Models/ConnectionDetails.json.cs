...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models
{
    ...
    public partial class ConnectionDetails
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Json.JsonObject into a new instance of <see cref="ConnectionDetails" />.
        /// </summary>
        ...
        internal ConnectionDetails(Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Json.JsonObject json)
        {
            ...
            {_privateIPAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Json.JsonString>("privateIpAddress"), out var __jsonPrivateIPAddress) ? (string)__jsonPrivateIPAddress : (string)_privateIPAddress;}
            {_linkIdentifier = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Json.JsonString>("linkIdentifier"), out var __jsonLinkIdentifier) ? (string)__jsonLinkIdentifier : (string)_linkIdentifier;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IConnectionDetails.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IConnectionDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.IConnectionDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Json.JsonObject json ? new ConnectionDetails(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ConnectionDetails" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ConnectionDetails" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.SerializationMode.IncludeRead))
            {
                AddIf( null != (((object)this._privateIPAddress)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Json.JsonString(this._privateIPAddress.ToString()) : null, "privateIpAddress" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.SerializationMode.IncludeRead))
            {
                AddIf( null != (((object)this._linkIdentifier)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Json.JsonString(this._linkIdentifier.ToString()) : null, "linkIdentifier" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.SerializationMode.IncludeRead))
            {
