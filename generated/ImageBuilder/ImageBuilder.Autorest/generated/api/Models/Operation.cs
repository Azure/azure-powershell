...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IOperationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IOperationDisplay _display;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IOperationDisplay Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.OperationDisplay()); set => this._display = value; }
        ...
        public string DisplayDescription { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IOperationDisplayInternal)Display).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IOperationDisplayInternal)Display).Description = value ?? null; }

        /// <summary>For example: read, write, delete, or listKeys/action</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public string DisplayOperation { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IOperationDisplayInternal)Display).Operation; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IOperationDisplayInternal)Display).Operation = value ?? null; }

        /// <summary>Friendly name of the resource provider.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public string DisplayProvider { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IOperationDisplayInternal)Display).Provider; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IOperationDisplayInternal)Display).Provider = value ?? null; }

        /// <summary>The resource type on which the operation is performed.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public string DisplayResource { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IOperationDisplayInternal)Display).Resource; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IOperationDisplayInternal)Display).Resource = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IOperationDisplay Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IOperationInternal.Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.OperationDisplay()); set { {_display = value;} } }
    ...
    {
        /// <summary>The object that describes the operation.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IOperationDisplay Display { get; set; }
        /// <summary>The friendly name of the operation</summary>
        string DisplayDescription { get; set; }
        /// <summary>For example: read, write, delete, or listKeys/action</summary>
        string DisplayOperation { get; set; }
