...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models
{
    ...
    public partial class ImageTemplatePlatformImageSource :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplatePlatformImageSource,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplatePlatformImageSourceInternal.ExactVersion { get => this._exactVersion; set { {_exactVersion = value;} } }

        /// <summary>Internal Acessors for PlanInfo</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IPlatformImagePurchasePlan Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplatePlatformImageSourceInternal.PlanInfo { get => (this._planInfo = this._planInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.PlatformImagePurchasePlan()); set { {_planInfo = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IPlatformImagePurchasePlan _planInfo;

        /// <summary>Optional configuration of purchase plan for platform image.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IPlatformImagePurchasePlan PlanInfo { get => (this._planInfo = this._planInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.PlatformImagePurchasePlan()); set => this._planInfo = value; }
        ...
        public string PlanInfoPlanName { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IPlatformImagePurchasePlanInternal)PlanInfo).PlanName; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IPlatformImagePurchasePlanInternal)PlanInfo).PlanName = value ?? null; }

        /// <summary>Product of the purchase plan.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public string PlanInfoPlanProduct { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IPlatformImagePurchasePlanInternal)PlanInfo).PlanProduct; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IPlatformImagePurchasePlanInternal)PlanInfo).PlanProduct = value ?? null; }

        /// <summary>Publisher of the purchase plan.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public string PlanInfoPlanPublisher { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IPlatformImagePurchasePlanInternal)PlanInfo).PlanPublisher; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IPlatformImagePurchasePlanInternal)PlanInfo).PlanPublisher = value ?? null; }
        ...
        public string Type { get => "PlatformImage"; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplateSourceInternal)__imageTemplateSource).Type = "PlatformImage"; }
        ...
        {
            this.__imageTemplateSource.Type = "PlatformImage";
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplateSourceInternal
    {
        ...
        string Offer { get; set; }
        /// <summary>Optional configuration of purchase plan for platform image.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IPlatformImagePurchasePlan PlanInfo { get; set; }
        /// <summary>Name of the purchase plan.</summary>
        string PlanInfoPlanName { get; set; }
        /// <summary>Product of the purchase plan.</summary>
        string PlanInfoPlanProduct { get; set; }
