...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models
{
    ...
    public partial class ImageTemplateRestartCustomizer :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplateRestartCustomizerInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplateCustomizer"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplateCustomizer __imageTemplateCustomizer = new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.ImageTemplateCustomizer();
        ...
        public string Name { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplateCustomizerInternal)__imageTemplateCustomizer).Name; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplateCustomizerInternal)__imageTemplateCustomizer).Name = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inherited)]
        public string Type { get => "WindowsRestart"; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplateCustomizerInternal)__imageTemplateCustomizer).Type = "WindowsRestart"; }

        /// <summary>Creates an new <see cref="ImageTemplateRestartCustomizer" /> instance.</summary>
        public ImageTemplateRestartCustomizer()
        {
            this.__imageTemplateCustomizer.Type = "WindowsRestart";
        }
    ...
    internal partial interface IImageTemplateRestartCustomizerInternal :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplateCustomizerInternal
    {
        /// <summary>Command to check if restart succeeded [Default: '']</summary>
        string RestartCheckCommand { get; set; }
        /// <summary>
