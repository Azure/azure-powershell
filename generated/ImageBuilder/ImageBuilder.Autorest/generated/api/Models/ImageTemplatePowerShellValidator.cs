...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models
{
    ...
    public partial class ImageTemplatePowerShellValidator :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplatePowerShellValidator,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplatePowerShellValidatorInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.IValidates
    {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inherited)]
        public string Type { get => "PowerShell"; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplateInVMValidatorInternal)__imageTemplateInVMValidator).Type = "PowerShell"; }

        /// <summary>Backing field for <see cref="ValidExitCode" /> property.</summary>
        private System.Collections.Generic.List<int> _validExitCode;

        /// <summary>Valid exit codes for the PowerShell script. [Default: 0]</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<int> ValidExitCode { get => this._validExitCode; set => this._validExitCode = value; }

        /// <summary>Creates an new <see cref="ImageTemplatePowerShellValidator" /> instance.</summary>
        public ImageTemplatePowerShellValidator()
        {
            this.__imageTemplateInVMValidator.Type = "PowerShell";
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplateInVMValidator
    {
        ...
        System.Collections.Generic.List<int> ValidExitCode { get; set; }
