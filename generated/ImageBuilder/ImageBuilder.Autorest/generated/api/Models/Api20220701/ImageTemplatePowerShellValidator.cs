...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20220701
{
    ...
    /// <summary>
    /// Runs the specified PowerShell script during the validation phase (Windows). Corresponds to Packer powershell provisioner.
    /// Exactly one of 'scriptUri' or 'inline' can be specified.
    /// </summary>
    public partial class ImageTemplatePowerShellValidator :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20220701.IImageTemplatePowerShellValidator,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20220701.IImageTemplatePowerShellValidatorInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.IValidates
    {
        ...
        /// <summary>Creates an new <see cref="ImageTemplatePowerShellValidator" /> instance.</summary>
    ...
    /// Runs the specified PowerShell script during the validation phase (Windows). Corresponds to Packer powershell provisioner.
    /// Exactly one of 'scriptUri' or 'inline' can be specified.
    public partial interface IImageTemplatePowerShellValidator :
    ...
    /// Runs the specified PowerShell script during the validation phase (Windows). Corresponds to Packer powershell provisioner.
    /// Exactly one of 'scriptUri' or 'inline' can be specified.
    internal partial interface IImageTemplatePowerShellValidatorInternal :
