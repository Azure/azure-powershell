...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models
{
    ...
    public partial class RunProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.IRunProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.IRunProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.IRunProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonNode node)
        {
        ...
        internal RunProperties(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject json)
        {
            ...
            {_imageUpdateTrigger = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("imageUpdateTrigger"), out var __jsonImageUpdateTrigger) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.ImageUpdateTrigger.FromJson(__jsonImageUpdateTrigger) : _imageUpdateTrigger;}
            {_sourceTrigger = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("sourceTrigger"), out var __jsonSourceTrigger) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.SourceTriggerDescriptor.FromJson(__jsonSourceTrigger) : _sourceTrigger;}
            {_timerTrigger = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("timerTrigger"), out var __jsonTimerTrigger) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.TimerTriggerDescriptor.FromJson(__jsonTimerTrigger) : _timerTrigger;}
            {_platform = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("platform"), out var __jsonPlatform) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.PlatformProperties.FromJson(__jsonPlatform) : _platform;}
            {_agentConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("agentConfiguration"), out var __jsonAgentConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.AgentProperties.FromJson(__jsonAgentConfiguration) : _agentConfiguration;}
            {_logArtifact = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("logArtifact"), out var __jsonLogArtifact) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.ImageDescriptor.FromJson(__jsonLogArtifact) : _logArtifact;}
            {_runId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("runId"), out var __jsonRunId) ? (string)__jsonRunId : (string)_runId;}
            {_status = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("status"), out var __jsonStatus) ? (string)__jsonStatus : (string)_status;}
            ...
            {_runType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("runType"), out var __jsonRunType) ? (string)__jsonRunType : (string)_runType;}
            {_agentPoolName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("agentPoolName"), out var __jsonAgentPoolName) ? (string)__jsonAgentPoolName : (string)_agentPoolName;}
            {_createTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("createTime"), out var __jsonCreateTime) ? global::System.DateTime.TryParse((string)__jsonCreateTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonCreateTimeValue) ? __jsonCreateTimeValue : _createTime : _createTime;}
            ...
            {_finishTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("finishTime"), out var __jsonFinishTime) ? global::System.DateTime.TryParse((string)__jsonFinishTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonFinishTimeValue) ? __jsonFinishTimeValue : _finishTime : _finishTime;}
            {_outputImage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonArray>("outputImages"), out var __jsonOutputImages) ? If( __jsonOutputImages as Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.IImageDescriptor>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.IImageDescriptor) (Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.ImageDescriptor.FromJson(__u) )) ))() : null : _outputImage;}
            {_task = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("task"), out var __jsonTask) ? (string)__jsonTask : (string)_task;}
            {_sourceRegistryAuth = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("sourceRegistryAuth"), out var __jsonSourceRegistryAuth) ? (string)__jsonSourceRegistryAuth : (string)_sourceRegistryAuth;}
            {_customRegistry = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonArray>("customRegistries"), out var __jsonCustomRegistries) ? If( __jsonCustomRegistries as Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : _customRegistry;}
            {_runErrorMessage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("runErrorMessage"), out var __jsonRunErrorMessage) ? (string)__jsonRunErrorMessage : (string)_runErrorMessage;}
            {_updateTriggerToken = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("updateTriggerToken"), out var __jsonUpdateTriggerToken) ? (string)__jsonUpdateTriggerToken : (string)_updateTriggerToken;}
            {_provisioningState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("provisioningState"), out var __jsonProvisioningState) ? (string)__jsonProvisioningState : (string)_provisioningState;}
            {_isArchiveEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonBoolean>("isArchiveEnabled"), out var __jsonIsArchiveEnabled) ? (bool?)__jsonIsArchiveEnabled : _isArchiveEnabled;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.SerializationMode.IncludeRead))
            {
