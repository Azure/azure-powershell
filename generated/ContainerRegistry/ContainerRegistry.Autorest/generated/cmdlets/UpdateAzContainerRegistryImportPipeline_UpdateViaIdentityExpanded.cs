...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzContainerRegistryImportPipeline_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Description(@"update an import pipeline for a container registry with the specified parameters.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Generated]
    public partial class UpdateAzContainerRegistryImportPipeline_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.IImportPipeline _importPipelineCreateParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.ImportPipeline();
        ...
        public string[] Option { get => _importPipelineCreateParametersBody.Option?.ToArray() ?? null /* fixedArrayOf */; set => _importPipelineCreateParametersBody.Option = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        public string SourceTriggerStatus { get => _importPipelineCreateParametersBody.SourceTriggerStatus ?? null; set => _importPipelineCreateParametersBody.SourceTriggerStatus = value; }
        ...
        public string SourceType { get => _importPipelineCreateParametersBody.SourceType ?? null; set => _importPipelineCreateParametersBody.SourceType = value; }
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzContainerRegistryImportPipeline_UpdateViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets.UpdateAzContainerRegistryImportPipeline_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzContainerRegistryImportPipeline_UpdateViaIdentityExpanded();
        ...
        {
            bool supportsSystemAssignedIdentity = (true == this.EnableSystemAssignedIdentity || null == this.EnableSystemAssignedIdentity && true == _importPipelineCreateParametersBody?.IdentityType?.Contains("SystemAssigned"));
            bool supportsUserAssignedIdentity = false;
            if (this.UserAssignedIdentity?.Length > 0)
            {
                // calculate UserAssignedIdentity
                _importPipelineCreateParametersBody.IdentityUserAssignedIdentity.Clear();
                foreach( var id in this.UserAssignedIdentity )
                {
                    _importPipelineCreateParametersBody.IdentityUserAssignedIdentity.Add(id, new Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.UserIdentityProperties());
                }
            }
            supportsUserAssignedIdentity = true == this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && this.UserAssignedIdentity?.Length > 0 ||
                    true != this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && true == _importPipelineCreateParametersBody.IdentityType?.Contains("UserAssigned");
            if (!supportsUserAssignedIdentity)
            {
                _importPipelineCreateParametersBody.IdentityUserAssignedIdentity = null;
            }
            // calculate IdentityType
            if ((supportsUserAssignedIdentity && supportsSystemAssignedIdentity))
            {
                _importPipelineCreateParametersBody.IdentityType = "SystemAssigned,UserAssigned";
            }
            else if ((supportsUserAssignedIdentity && !supportsSystemAssignedIdentity))
            {
                _importPipelineCreateParametersBody.IdentityType = "UserAssigned";
            }
            else if ((!supportsUserAssignedIdentity && supportsSystemAssignedIdentity))
            {
                _importPipelineCreateParametersBody.IdentityType = "SystemAssigned";
            }
            else
            {
                _importPipelineCreateParametersBody.IdentityType = "None";
            }
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _importPipelineCreateParametersBody = await this.Client.ImportPipelinesGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_importPipelineCreateParametersBody();
                        await this.Client.ImportPipelinesCreateViaIdentity(InputObject.Id, _importPipelineCreateParametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _importPipelineCreateParametersBody = await this.Client.ImportPipelinesGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.RegistryName ?? null, InputObject.ImportPipelineName ?? null, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_importPipelineCreateParametersBody();
                        await this.Client.ImportPipelinesCreate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.RegistryName ?? null, InputObject.ImportPipelineName ?? null, _importPipelineCreateParametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzContainerRegistryImportPipeline_UpdateViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzContainerRegistryImportPipeline_UpdateViaIdentityExpanded()
        {

        }

        private void Update_importPipelineCreateParametersBody()
        {
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SourceType")))
            {
                this.SourceType = (string)(this.MyInvocation?.BoundParameters["SourceType"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SourceUri")))
            {
                this.SourceUri = (string)(this.MyInvocation?.BoundParameters["SourceUri"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SourceKeyVaultUri")))
            {
                this.SourceKeyVaultUri = (string)(this.MyInvocation?.BoundParameters["SourceKeyVaultUri"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SourceTriggerStatus")))
            {
                this.SourceTriggerStatus = (string)(this.MyInvocation?.BoundParameters["SourceTriggerStatus"]);
            }
        }
