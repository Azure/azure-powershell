...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Create=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/scopeMaps/{scopeMapName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzContainerRegistryScopeMap_CreateViaIdentityRegistryExpanded", SupportsShouldProcess = true)]
    ...
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.IScopeMap))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Description(@"create a scope map for a container registry with the specified parameters.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/scopeMaps/{scopeMapName}", ApiVersion = "2023-01-01-preview")]
    public partial class NewAzContainerRegistryScopeMap_CreateViaIdentityRegistryExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.IScopeMap _scopeMapCreateParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.ScopeMap();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The list of scoped permissions for registry artifacts.E.g. repositories/repository-name/content/read,repositories/repository-name/metadata/write")]
        ...
        Required = false,
        ReadOnly = false,
        Description = @"The list of scoped permissions for registry artifacts.E.g. repositories/repository-name/content/read,repositories/repository-name/metadata/write",
        SerializedName = @"actions",
        PossibleTypes = new [] { typeof(string) })]
        public string[] Action { get => _scopeMapCreateParametersBody.Action?.ToArray() ?? null /* fixedArrayOf */; set => _scopeMapCreateParametersBody.Action = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The user friendly description of the scope map.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Description { get => _scopeMapCreateParametersBody.Description ?? null; set => _scopeMapCreateParametersBody.Description = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the scope map.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("ScopeMapName")]
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.IScopeMap">Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.IScopeMap</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.IScopeMap> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of NewAzContainerRegistryScopeMap_CreateViaIdentityRegistryExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets.NewAzContainerRegistryScopeMap_CreateViaIdentityRegistryExpanded Clone()
        {
            var clone = new NewAzContainerRegistryScopeMap_CreateViaIdentityRegistryExpanded();
            ...
            clone._scopeMapCreateParametersBody = this._scopeMapCreateParametersBody;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzContainerRegistryScopeMap_CreateViaIdentityRegistryExpanded" /> cmdlet
        /// class.
        /// </summary>
        public NewAzContainerRegistryScopeMap_CreateViaIdentityRegistryExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ScopeMapsCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.RegistryInputObject.Id += $"/scopeMaps/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.ScopeMapsCreateViaIdentity(RegistryInputObject.Id, _scopeMapCreateParametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        ...
                        await this.Client.ScopeMapsCreate(RegistryInputObject.SubscriptionId ?? null, RegistryInputObject.ResourceGroupName ?? null, RegistryInputObject.RegistryName ?? null, Name, _scopeMapCreateParametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.SerializationMode.IncludeCreate);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.IScopeMap> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.IScopeMap
