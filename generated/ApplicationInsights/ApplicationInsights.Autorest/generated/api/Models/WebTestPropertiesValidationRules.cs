...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models
{
    ...
    public partial class WebTestPropertiesValidationRules :
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IWebTestPropertiesValidationRules,
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IWebTestPropertiesValidationRulesInternal
    {

        /// <summary>Backing field for <see cref="ContentValidation" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IWebTestPropertiesValidationRulesContentValidation _contentValidation;
    ...
    {
        /// <summary>The collection of content validation properties</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IWebTestPropertiesValidationRulesContentValidation ContentValidation { get; set; }
        /// <summary>Content to look for in the return of the WebTest. Must not be null or empty.</summary>
        string ContentValidationContentMatch { get; set; }
        /// <summary>When set, this value makes the ContentMatch validation case insensitive.</summary>
        bool? ContentValidationIgnoreCase { get; set; }
