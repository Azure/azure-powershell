...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models
{
    ...
    public partial class ApplicationInsightsComponentFeatureCapabilities :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal
    {
        ...
        bool? Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal.AnalyticsIntegration { get => this._analyticsIntegration; set { {_analyticsIntegration = value;} } }

        /// <summary>Internal Acessors for ApiAccessLevel</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal.ApiAccessLevel { get => this._apiAccessLevel; set { {_apiAccessLevel = value;} } }

        /// <summary>Internal Acessors for ApplicationMap</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal.ApplicationMap { get => this._applicationMap; set { {_applicationMap = value;} } }

        /// <summary>Internal Acessors for BurstThrottlePolicy</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal.BurstThrottlePolicy { get => this._burstThrottlePolicy; set { {_burstThrottlePolicy = value;} } }

        /// <summary>Internal Acessors for DailyCap</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal.DailyCap { get => this._dailyCap; set { {_dailyCap = value;} } }

        /// <summary>Internal Acessors for DailyCapResetTime</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal.DailyCapResetTime { get => this._dailyCapResetTime; set { {_dailyCapResetTime = value;} } }

        /// <summary>Internal Acessors for LiveStreamMetric</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal.LiveStreamMetric { get => this._liveStreamMetric; set { {_liveStreamMetric = value;} } }

        /// <summary>Internal Acessors for MetadataClass</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal.MetadataClass { get => this._metadataClass; set { {_metadataClass = value;} } }

        /// <summary>Internal Acessors for MultipleStepWebTest</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal.MultipleStepWebTest { get => this._multipleStepWebTest; set { {_multipleStepWebTest = value;} } }

        /// <summary>Internal Acessors for OpenSchema</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal.OpenSchema { get => this._openSchema; set { {_openSchema = value;} } }

        /// <summary>Internal Acessors for PowerBiIntegration</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal.PowerBiIntegration { get => this._powerBiIntegration; set { {_powerBiIntegration = value;} } }

        /// <summary>Internal Acessors for ProactiveDetection</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal.ProactiveDetection { get => this._proactiveDetection; set { {_proactiveDetection = value;} } }

        /// <summary>Internal Acessors for SupportExportData</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal.SupportExportData { get => this._supportExportData; set { {_supportExportData = value;} } }

        /// <summary>Internal Acessors for ThrottleRate</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal.ThrottleRate { get => this._throttleRate; set { {_throttleRate = value;} } }

        /// <summary>Internal Acessors for TrackingType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal.TrackingType { get => this._trackingType; set { {_trackingType = value;} } }

        /// <summary>Internal Acessors for WorkItemIntegration</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsComponentFeatureCapabilitiesInternal.WorkItemIntegration { get => this._workItemIntegration; set { {_workItemIntegration = value;} } }
