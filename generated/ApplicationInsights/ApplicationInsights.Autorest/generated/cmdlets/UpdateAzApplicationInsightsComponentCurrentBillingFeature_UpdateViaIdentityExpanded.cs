...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzApplicationInsightsComponentCurrentBillingFeature_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzApplicationInsightsComponentCurrentBillingFeature_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _billingFeaturesPropertiesBody = await this.Client.ComponentCurrentBillingFeaturesGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_billingFeaturesPropertiesBody();
                    ...
                    else
                    {
                        ...
                        _billingFeaturesPropertiesBody = await this.Client.ComponentCurrentBillingFeaturesGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ResourceName ?? null, this, Pipeline);
                        this.Update_billingFeaturesPropertiesBody();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzApplicationInsightsComponentCurrentBillingFeature_UpdateViaIdentityExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzApplicationInsightsComponentCurrentBillingFeature_UpdateViaIdentityExpanded()
        {

        }

        private void Update_billingFeaturesPropertiesBody()
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("CurrentBillingFeature")))
            {
                this.CurrentBillingFeature = (string[])(this.MyInvocation?.BoundParameters["CurrentBillingFeature"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("DataVolumeCap")))
            {
                this.DataVolumeCap = (float)(this.MyInvocation?.BoundParameters["DataVolumeCap"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("DataVolumeCapWarningThreshold")))
            {
                this.DataVolumeCapWarningThreshold = (int)(this.MyInvocation?.BoundParameters["DataVolumeCapWarningThreshold"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("DataVolumeCapStopSendNotificationWhenHitThreshold")))
            {
                this.DataVolumeCapStopSendNotificationWhenHitThreshold = (global::System.Management.Automation.SwitchParameter)(this.MyInvocation?.BoundParameters["DataVolumeCapStopSendNotificationWhenHitThreshold"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("DataVolumeCapStopSendNotificationWhenHitCap")))
            {
                this.DataVolumeCapStopSendNotificationWhenHitCap = (global::System.Management.Automation.SwitchParameter)(this.MyInvocation?.BoundParameters["DataVolumeCapStopSendNotificationWhenHitCap"]);
            }
        }
