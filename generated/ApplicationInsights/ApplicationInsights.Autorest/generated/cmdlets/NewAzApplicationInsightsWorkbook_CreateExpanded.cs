...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IWorkbook _workbookPropertiesBody = new Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Workbook();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.ITrackedResourceTags Tag { get => _workbookPropertiesBody.Tag ?? null /* object */; set => _workbookPropertiesBody.Tag = value; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzApplicationInsightsWorkbook_CreateExpanded" /> cmdlet class.
        /// </summary>
        ...
        private void PreProcessManagedIdentityParameters()
        {
            if (this.UserAssignedIdentity?.Length > 0)
            {
                ...
                _workbookPropertiesBody.IdentityUserAssignedIdentity.Clear();
                foreach( var id in this.UserAssignedIdentity )
                {
                    _workbookPropertiesBody.IdentityUserAssignedIdentity.Add(id, new Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.UserAssignedIdentity());
                }
            }
            // calculate IdentityType
            if (this.UserAssignedIdentity?.Length > 0)
            {
                if ("SystemAssigned".Equals(_workbookPropertiesBody.IdentityType, StringComparison.InvariantCultureIgnoreCase))
                {
                    _workbookPropertiesBody.IdentityType = "SystemAssigned,UserAssigned";
                }
                else
                {
                    _workbookPropertiesBody.IdentityType = "UserAssigned";
                }
            }
        }
