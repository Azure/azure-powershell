...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201
{
    ...
    public partial class DataExportDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IDataExportDetailsInternal
    {

        /// <summary>Backing field for <see cref="AccountDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IDataAccountDetails _accountDetail;

        /// <summary>Account details of the data to be transferred</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IDataAccountDetails AccountDetail { get => (this._accountDetail = this._accountDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.DataAccountDetails()); set => this._accountDetail = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Inlined)]
        public string AccountDetailSharePassword { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IDataAccountDetailsInternal)AccountDetail).SharePassword; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IDataAccountDetailsInternal)AccountDetail).SharePassword = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IDataAccountDetails Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IDataExportDetailsInternal.AccountDetail { get => (this._accountDetail = this._accountDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.DataAccountDetails()); set { {_accountDetail = value;} } }

        /// <summary>Backing field for <see cref="TransferConfiguration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.ITransferConfiguration _transferConfiguration;

        /// <summary>Configuration for the data transfer.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.ITransferConfiguration TransferConfiguration { get => (this._transferConfiguration = this._transferConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.TransferConfiguration()); set => this._transferConfiguration = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.ITransferConfiguration) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.ITransferConfiguration TransferConfiguration { get; set; }
    ...
    {
        /// <summary>Account details of the data to be transferred</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IDataAccountDetails AccountDetail { get; set; }
        /// <summary>Account Type of the data to be transferred.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.DataAccountType AccountDetailDataAccountType { get; set; }
        /// <summary>
        /// Password for all the shares to be created on the device. Should not be passed for TransferType:ExportFromAzure jobs. If
