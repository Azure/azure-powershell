...
{
    using Microsoft.Azure.PowerShell.Cmdlets.ComputeLimit.generated.runtime.Properties;
    using System;
    ...
    public class GenericBreakingChangeAttribute : Attribute
    {
        ...
        public string moduleName { get; set; } = String.IsNullOrEmpty(@"") ? @"Az.ComputeLimit" : @"";
