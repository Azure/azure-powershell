            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ClusterpoolInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ClusterLibrariesManageLibrariesViaIdentity(ClusterpoolInputObject.Id, Operation, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ClusterLibrariesManageLibraries(ClusterpoolInputObject.SubscriptionId ?? null, ClusterpoolInputObject.ResourceGroupName ?? null, ClusterpoolInputObject.ClusterPoolName ?? null, ClusterName, Operation, onDefault, this, Pipeline);
                    }
