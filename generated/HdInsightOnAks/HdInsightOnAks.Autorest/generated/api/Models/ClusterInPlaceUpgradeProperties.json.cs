...
namespace Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Models
{
    ...
    public partial class ClusterInPlaceUpgradeProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Runtime.Json.JsonObject into a new instance of <see cref="ClusterInPlaceUpgradeProperties" />.
        /// </summary>
        ...
        internal ClusterInPlaceUpgradeProperties(Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Models.IClusterInPlaceUpgradeProperties.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Models.IClusterInPlaceUpgradeProperties interface is polymorphic,
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Models.IClusterInPlaceUpgradeProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Models.IClusterInPlaceUpgradeProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("upgradeType") )
            {
                case "HotfixUpgrade":
                {
                    return new ClusterHotfixUpgradeProperties(json);
                }
                case "PatchVersionUpgrade":
                {
                    return new ClusterPatchVersionUpgradeProperties(json);
                }
            }
            return new ClusterInPlaceUpgradeProperties(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="ClusterInPlaceUpgradeProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ClusterInPlaceUpgradeProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HdInsightOnAks.Runtime.Json.JsonNode" />.
        /// </returns>
