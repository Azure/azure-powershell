...
namespace Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models
{
    ...
    public partial class ScheduledOperationsType :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IScheduledOperationsTypeInternal
    {

        /// <summary>Backing field for <see cref="DayOfWeek" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IDayOfWeek _dayOfWeek;

        /// <summary>Day of week</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Oracle.Origin(Microsoft.Azure.PowerShell.Cmdlets.Oracle.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IDayOfWeek DayOfWeek { get => (this._dayOfWeek = this._dayOfWeek ?? new Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.DayOfWeek()); set => this._dayOfWeek = value; }
        ...
        public string DayOfWeekName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IDayOfWeekInternal)DayOfWeek).Name; set => ((Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IDayOfWeekInternal)DayOfWeek).Name = value ; }

        /// <summary>Internal Acessors for DayOfWeek</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IDayOfWeek Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IScheduledOperationsTypeInternal.DayOfWeek { get => (this._dayOfWeek = this._dayOfWeek ?? new Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.DayOfWeek()); set { {_dayOfWeek = value;} } }
    ...
    {
        /// <summary>Day of week</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IDayOfWeek DayOfWeek { get; set; }
        /// <summary>Name of the day of the week.</summary>
        [global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.PSArgumentCompleterAttribute("Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday")]
        string DayOfWeekName { get; set; }
        /// <summary>auto start time. value must be of ISO-8601 format HH:mm</summary>
