...
namespace Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models
{
    ...
    public partial class OracleIdentity
    {
        ...
        internal OracleIdentity(Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Json.JsonObject json)
        {
            ...
            {_dbSystemName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Json.JsonString>("dbSystemName"), out var __jsonDbSystemName) ? (string)__jsonDbSystemName : (string)_dbSystemName;}
            ...
            {_dbversionsname = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Json.JsonString>("dbversionsname"), out var __jsonDbversionsname) ? (string)__jsonDbversionsname : (string)_dbversionsname;}
            ...
            {_networkAnchorName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Json.JsonString>("networkAnchorName"), out var __jsonNetworkAnchorName) ? (string)__jsonNetworkAnchorName : (string)_networkAnchorName;}
            {_resourceAnchorName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Json.JsonString>("resourceAnchorName"), out var __jsonResourceAnchorName) ? (string)__jsonResourceAnchorName : (string)_resourceAnchorName;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._dbSystemName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Json.JsonString(this._dbSystemName.ToString()) : null, "dbSystemName" ,container.Add );
            ...
            AddIf( null != (((object)this._dbversionsname)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Json.JsonString(this._dbversionsname.ToString()) : null, "dbversionsname" ,container.Add );
            ...
            AddIf( null != (((object)this._networkAnchorName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Json.JsonString(this._networkAnchorName.ToString()) : null, "networkAnchorName" ,container.Add );
            AddIf( null != (((object)this._resourceAnchorName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Json.JsonString(this._resourceAnchorName.ToString()) : null, "resourceAnchorName" ,container.Add );
