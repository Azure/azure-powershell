...
namespace Microsoft.Azure.PowerShell.Cmdlets.Oracle.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByParent=>GET:"/subscriptions/{subscriptionId}/providers/Oracle.Database/locations/{location}/flexComponents"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzOracleFlexComponent_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IFlexComponent))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.Description(@"List FlexComponent resources by SubscriptionLocationResource")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Oracle.Database/locations/{location}/flexComponents", ApiVersion = "2025-03-01")]
    public partial class GetAzOracleFlexComponent_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "If provided, filters the results for the given shape")]
        [Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IFlexComponentListResult">Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IFlexComponentListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IFlexComponentListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzOracleFlexComponent_List" /> cmdlet class.
        /// </summary>
        public GetAzOracleFlexComponent_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.FlexComponentsListByParent(SubscriptionId, Location, this.InvocationInformation.BoundParameters.ContainsKey("Shape") ? Shape : null, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IFlexComponentListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IFlexComponentListResult
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.FlexComponentsListByParent_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
