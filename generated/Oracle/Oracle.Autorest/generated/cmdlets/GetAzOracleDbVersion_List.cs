...
namespace Microsoft.Azure.PowerShell.Cmdlets.Oracle.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByLocation=>GET:"/subscriptions/{subscriptionId}/providers/Oracle.Database/locations/{location}/dbSystemDbVersions"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzOracleDbVersion_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IDbVersion))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.Description(@"List DbVersion resources by SubscriptionLocationResource")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Oracle.Database/locations/{location}/dbSystemDbVersions", ApiVersion = "2025-09-01")]
    public partial class GetAzOracleDbVersion_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.IContext
    {
        ...
        /// system.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The DB system AzureId. If provided, filters the results to the set of database versions which are supported for the DB system.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"The DB system AzureId. If provided, filters the results to the set of database versions which are supported for the DB system.",
        ...
        /// <summary>Backing field for <see cref="DbSystemShape" /> property.</summary>
        private string _dbSystemShape;
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "If provided, filters the results to the set of database versions which are supported for the given shape. e.g., VM.Standard.E5.Flex")]
        [Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"If provided, filters the results to the set of database versions which are supported for the given shape. e.g., VM.Standard.E5.Flex",
        SerializedName = @"dbSystemShape",
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.ParameterCategory.Query)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.PSArgumentCompleterAttribute("VM.Standard.x86")]
        public string DbSystemShape { get => this._dbSystemShape; set => this._dbSystemShape = value; }
        ...
        /// <summary>Backing field for <see cref="IsDatabaseSoftwareImageSupported" /> property.</summary>
        private global::System.Management.Automation.SwitchParameter _isDatabaseSoftwareImageSupported;

        /// <summary>
        /// If true, filters the results to the set of Oracle Database versions that are supported for the database software images.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "If true, filters the results to the set of Oracle Database versions that are supported for the database software images.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"If true, filters the results to the set of Oracle Database versions that are supported for the database software images.",
        SerializedName = @"isDatabaseSoftwareImageSupported",
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.ParameterCategory.Query)]
        public global::System.Management.Automation.SwitchParameter IsDatabaseSoftwareImageSupported { get => this._isDatabaseSoftwareImageSupported; set => this._isDatabaseSoftwareImageSupported = value; }

        /// <summary>Backing field for <see cref="IsUpgradeSupported" /> property.</summary>
        private global::System.Management.Automation.SwitchParameter _isUpgradeSupported;

        /// <summary>
        /// If true, filters the results to the set of database versions which are supported for Upgrade.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "If true, filters the results to the set of database versions which are supported for Upgrade.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"If true, filters the results to the set of database versions which are supported for Upgrade.",
        SerializedName = @"isUpgradeSupported",
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.ParameterCategory.Query)]
        public global::System.Management.Automation.SwitchParameter IsUpgradeSupported { get => this._isUpgradeSupported; set => this._isUpgradeSupported = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.ParameterCategory.Query)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Oracle.PSArgumentCompleterAttribute("EXADATA", "EXADB_XS", "SINGLENODE", "VIRTUALMACHINE")]
        ...
        /// are ASM and LVM.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The DB system storage management option. Used to list database versions available for that storage manager. Valid values are ASM and LVM.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IDbVersionListResult">Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IDbVersionListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IDbVersionListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzOracleDbVersion_List" /> cmdlet class.
        /// </summary>
        public GetAzOracleDbVersion_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.DbVersionsListByLocation(SubscriptionId, Location, this.InvocationInformation.BoundParameters.ContainsKey("DbSystemShape") ? DbSystemShape : null, this.InvocationInformation.BoundParameters.ContainsKey("DbSystemId") ? DbSystemId : null, this.InvocationInformation.BoundParameters.ContainsKey("StorageManagement") ? StorageManagement : null, this.InvocationInformation.BoundParameters.ContainsKey("IsUpgradeSupported") ? IsUpgradeSupported : default(global::System.Management.Automation.SwitchParameter?), this.InvocationInformation.BoundParameters.ContainsKey("IsDatabaseSoftwareImageSupported") ? IsDatabaseSoftwareImageSupported : default(global::System.Management.Automation.SwitchParameter?), this.InvocationInformation.BoundParameters.ContainsKey("ShapeFamily") ? ShapeFamily : null, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,Location=Location,DbSystemShape=this.InvocationInformation.BoundParameters.ContainsKey("DbSystemShape") ? DbSystemShape : null,DbSystemId=this.InvocationInformation.BoundParameters.ContainsKey("DbSystemId") ? DbSystemId : null,StorageManagement=this.InvocationInformation.BoundParameters.ContainsKey("StorageManagement") ? StorageManagement : null,IsUpgradeSupported=this.InvocationInformation.BoundParameters.ContainsKey("IsUpgradeSupported") ? IsUpgradeSupported : default(global::System.Management.Automation.SwitchParameter?),IsDatabaseSoftwareImageSupported=this.InvocationInformation.BoundParameters.ContainsKey("IsDatabaseSoftwareImageSupported") ? IsDatabaseSoftwareImageSupported : default(global::System.Management.Automation.SwitchParameter?),ShapeFamily=this.InvocationInformation.BoundParameters.ContainsKey("ShapeFamily") ? ShapeFamily : null})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IDbVersionListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IDbVersionListResult
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.DbVersionsListByLocation_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
