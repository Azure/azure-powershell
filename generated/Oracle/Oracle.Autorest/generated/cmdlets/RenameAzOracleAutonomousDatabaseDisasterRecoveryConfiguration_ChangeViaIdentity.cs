...
namespace Microsoft.Azure.PowerShell.Cmdlets.Oracle.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ChangeDisasterRecoveryConfiguration=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Oracle.Database/autonomousDatabases/{autonomousdatabasename}/changeDisasterRecoveryConfiguration"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Rename, @"AzOracleAutonomousDatabaseDisasterRecoveryConfiguration_ChangeViaIdentity", SupportsShouldProcess = true)]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IDisasterRecoveryConfigurationDetails _body;

        /// <summary>Configurations of a Disaster Recovery Details</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Configurations of a Disaster Recovery Details", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Configurations of a Disaster Recovery Details",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IDisasterRecoveryConfigurationDetails) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Oracle.Models.IDisasterRecoveryConfigurationDetails Body { get => this._body; set => this._body = value; }
        ...
        /// <returns>
        /// a duplicate instance of RenameAzOracleAutonomousDatabaseDisasterRecoveryConfiguration_ChangeViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Oracle.Cmdlets.RenameAzOracleAutonomousDatabaseDisasterRecoveryConfiguration_ChangeViaIdentity Clone()
        {
            var clone = new RenameAzOracleAutonomousDatabaseDisasterRecoveryConfiguration_ChangeViaIdentity();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'AutonomousDatabasesChangeDisasterRecoveryConfiguration' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.AutonomousDatabasesChangeDisasterRecoveryConfigurationViaIdentity(InputObject.Id, Body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.AutonomousDatabasesChangeDisasterRecoveryConfiguration(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.Autonomousdatabasename ?? null, Body, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RenameAzOracleAutonomousDatabaseDisasterRecoveryConfiguration_ChangeViaIdentity"
        /// /> cmdlet class.
        /// </summary>
        public RenameAzOracleAutonomousDatabaseDisasterRecoveryConfiguration_ChangeViaIdentity()
        {
