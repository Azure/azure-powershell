...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.MarketplaceOrdering.Models.IOperation
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MarketplaceOrdering.Models.IOperation])]
