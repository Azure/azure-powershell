...
namespace Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Models
{
    ...
    public partial class DedicatedHsmOperation
    {
        ...
        internal DedicatedHsmOperation(Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Runtime.Json.JsonObject json)
        {
            ...
            {_display = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Runtime.Json.JsonObject>("display"), out var __jsonDisplay) ? Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Models.DedicatedHsmOperationDisplay.FromJson(__jsonDisplay) : _display;}
            ...
            {_isDataAction = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Runtime.Json.JsonString>("isDataAction"), out var __jsonIsDataAction) ? (string)__jsonIsDataAction : (string)_isDataAction;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DedicatedHsm.Models.IDedicatedHsmOperation.
        /// </summary>
