...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Network.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Network.psd1'
...
$formatPs1xml = Join-Path $PSScriptRoot './Network.format.ps1xml'
