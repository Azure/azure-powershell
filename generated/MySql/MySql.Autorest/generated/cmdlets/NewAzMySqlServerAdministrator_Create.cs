...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzMySqlServerAdministrator_Create", SupportsShouldProcess = true)]
    ...
    public partial class NewAzMySqlServerAdministrator_Create : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20171201.IServerAdministratorResource _property;

        /// <summary>Represents a and external administrator to be created.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Represents a and external administrator to be created.", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20171201.IServerAdministratorResource Property { get => this._property; set => this._property = value; }
        ...
        /// <returns>a duplicate instance of NewAzMySqlServerAdministrator_Create</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets.NewAzMySqlServerAdministrator_Create Clone()
        {
            var clone = new NewAzMySqlServerAdministrator_Create();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzMySqlServerAdministrator_Create" /> cmdlet class.
        /// </summary>
        public NewAzMySqlServerAdministrator_Create()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ServerAdministratorsCreateOrUpdate(SubscriptionId, ResourceGroupName, ServerName, Property, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ServerName=ServerName,body=Property})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20171201.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ServerName=ServerName, body=Property })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ServerName=ServerName, body=Property })
                    {
