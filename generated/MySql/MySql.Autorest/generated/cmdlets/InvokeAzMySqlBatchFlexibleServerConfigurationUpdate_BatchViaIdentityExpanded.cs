...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] BatchUpdate=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/flexibleServers/{serverName}/updateConfigurations"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzMySqlBatchFlexibleServerConfigurationUpdate_BatchViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IConfigurationListResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.Description(@"batch a list of configurations in a given server.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/flexibleServers/{serverName}/updateConfigurations", ApiVersion = "2021-05-01")]
    public partial class InvokeAzMySqlBatchFlexibleServerConfigurationUpdate_BatchViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IConfigurationListForBatchUpdate _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.ConfigurationListForBatchUpdate();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IMySqlIdentity InputObject { get => this._inputObject; set => this._inputObject = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The list of server configurations.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IConfigurationForBatchUpdate[] Value { get => _parametersBody.Value?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.Value = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IConfigurationForBatchUpdate>(value) : null); }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.ICloudError">Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.ICloudError</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.ICloudError> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IConfigurationListResult">Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IConfigurationListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IConfigurationListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzMySqlBatchFlexibleServerConfigurationUpdate_BatchViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets.InvokeAzMySqlBatchFlexibleServerConfigurationUpdate_BatchViaIdentityExpanded Clone()
        {
            var clone = new InvokeAzMySqlBatchFlexibleServerConfigurationUpdate_BatchViaIdentityExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzMySqlBatchFlexibleServerConfigurationUpdate_BatchViaIdentityExpanded"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzMySqlBatchFlexibleServerConfigurationUpdate_BatchViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'FlexibleServerConfigurationsBatchUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.FlexibleServerConfigurationsBatchUpdateViaIdentity(InputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.FlexibleServerConfigurationsBatchUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServerName ?? null, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.ICloudError>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IConfigurationListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IConfigurationListResult
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        ...
                        {
                            requestMessage = requestMessage.Clone(new global::System.Uri( _nextLink ),Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Method.Get );
                            await ((Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IEventListener)this).Signal(Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Events.FollowingNextLink); if( ((Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IEventListener)this).Token.IsCancellationRequested ) { return; }
                            await this.Client.FlexibleServerConfigurationsBatchUpdate_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
