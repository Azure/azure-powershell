...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMySqlFlexibleServerFirewallRule_UpdateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.Description(@"update a new firewall rule or update an existing firewall rule.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.Generated]
    public partial class UpdateAzMySqlFlexibleServerFirewallRule_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The end IP address of the server firewall rule. Must be IPv4 format.")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The start IP address of the server firewall rule. Must be IPv4 format.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MySql.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <returns>a duplicate instance of UpdateAzMySqlFlexibleServerFirewallRule_UpdateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets.UpdateAzMySqlFlexibleServerFirewallRule_UpdateExpanded Clone()
        {
            var clone = new UpdateAzMySqlFlexibleServerFirewallRule_UpdateExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    _parametersBody = await this.Client.FlexibleServerFirewallRulesGetWithResult(SubscriptionId, ResourceGroupName, ServerName, Name, this, Pipeline);
                    this.Update_parametersBody();
                    await this.Client.FlexibleServerFirewallRulesCreateOrUpdate(SubscriptionId, ResourceGroupName, ServerName, Name, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.SerializationMode.IncludeUpdate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzMySqlFlexibleServerFirewallRule_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzMySqlFlexibleServerFirewallRule_UpdateExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("StartIPAddress")))
            {
                this.StartIPAddress = (string)(this.MyInvocation?.BoundParameters["StartIPAddress"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("EndIPAddress")))
            {
                this.EndIPAddress = (string)(this.MyInvocation?.BoundParameters["EndIPAddress"]);
            }
        }
