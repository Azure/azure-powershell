...
namespace Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models
{
    ...
    public partial class ConnectionPropertiesPrivateLinkServiceConnectionState :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.IConnectionPropertiesPrivateLinkServiceConnectionStateInternal,
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.IConnectionState"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.IConnectionState __connectionState = new Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.ConnectionState();
        ...
        public string ActionsRequired { get => ((Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.IConnectionStateInternal)__connectionState).ActionsRequired; set => ((Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.IConnectionStateInternal)__connectionState).ActionsRequired = value ?? null; }

        /// <summary>The description for the current state of a private endpoint connection.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Origin(Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.PropertyOrigin.Inherited)]
        public string Description { get => ((Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.IConnectionStateInternal)__connectionState).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.IConnectionStateInternal)__connectionState).Description = value ; }

        /// <summary>The status of a private endpoint connection.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Origin(Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.PropertyOrigin.Inherited)]
        public string Status { get => ((Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.IConnectionStateInternal)__connectionState).Status; set => ((Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.IConnectionStateInternal)__connectionState).Status = value ; }
