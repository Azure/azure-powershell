...
.Link
https://learn.microsoft.com/powershell/module/az.healthdataaiservices/get-azdeidoperation
#>
function Get-AzDeidOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.HealthDataAIServices.Models.IOperation])]
