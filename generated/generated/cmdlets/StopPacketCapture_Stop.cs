...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Stop=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/packetCaptures/{packetCaptureName}/stop"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Stop, @"PacketCapture_Stop", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Sample.API.Description(@"Stops a specified packet capture session.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/packetCaptures/{packetCaptureName}/stop", ApiVersion = "2025-03-01")]
    public partial class StopPacketCapture_Stop : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// <returns>a duplicate instance of StopPacketCapture_Stop</returns>
        public Sample.API.Cmdlets.StopPacketCapture_Stop Clone()
        {
            var clone = new StopPacketCapture_Stop();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PacketCapturesStop(SubscriptionId, ResourceGroupName, NetworkWatcherName, PacketCaptureName, onOk, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StopPacketCapture_Stop" /> cmdlet class.
        /// </summary>
        public StopPacketCapture_Stop()
        {
