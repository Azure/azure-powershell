...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"NetworkWatcher_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Sample.API.Description(@"Deletes the specified network watcher resource.")]
    ...
    public partial class RemoveNetworkWatcher_Delete : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// <returns>a duplicate instance of RemoveNetworkWatcher_Delete</returns>
        public Sample.API.Cmdlets.RemoveNetworkWatcher_Delete Clone()
        {
            var clone = new RemoveNetworkWatcher_Delete();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NetworkWatchersDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.NetworkWatchersDelete(SubscriptionId, ResourceGroupName, NetworkWatcherName, onNoContent, onOk, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveNetworkWatcher_Delete" /> cmdlet class.
        /// </summary>
        public RemoveNetworkWatcher_Delete()
        {
