...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/connectionMonitors/{connectionMonitorName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"ConnectionMonitor_UpdateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IConnectionMonitorResult))]
    [global::Sample.API.Description(@"update a connection monitor.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/connectionMonitors/{connectionMonitorName}", ApiVersion = "2025-03-01")]
    public partial class SetConnectionMonitor_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.IConnectionMonitor _parametersBody = new Sample.API.Models.ConnectionMonitor();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Determines if the connection monitor will start automatically once created.")]
        ...
        public global::System.Management.Automation.SwitchParameter AutoStart { get => _parametersBody.AutoStart ?? default(global::System.Management.Automation.SwitchParameter); set => _parametersBody.AutoStart = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the connection monitor.")]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Address of the connection monitor destination (IP or domain name).")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string DestinationAddress { get => _parametersBody.DestinationAddress ?? null; set => _parametersBody.DestinationAddress = value; }

        /// <summary>The destination port used by connection monitor.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The destination port used by connection monitor.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public int DestinationPort { get => _parametersBody.DestinationPort ?? default(int); set => _parametersBody.DestinationPort = value; }

        /// <summary>The ID of the resource used as the destination by connection monitor.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The ID of the resource used as the destination by connection monitor.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of connection monitor endpoints.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Sample.API.Models.IConnectionMonitorEndpoint[] Endpoints { get => _parametersBody.Endpoints?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.Endpoints = (value != null ? new System.Collections.Generic.List<Sample.API.Models.IConnectionMonitorEndpoint>(value) : null); }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Connection monitor location.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>Backing field for <see cref="Migrate" /> property.</summary>
        private string _migrate;

        /// <summary>Value indicating whether connection monitor V1 should be migrated to V2 format.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Value indicating whether connection monitor V1 should be migrated to V2 format.")]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string Migrate { get => this._migrate; set => this._migrate = value; }

        /// <summary>Monitoring interval in seconds.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Monitoring interval in seconds.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int MonitoringIntervalInSeconds { get => _parametersBody.MonitoringIntervalInSeconds ?? default(int); set => _parametersBody.MonitoringIntervalInSeconds = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the Network Watcher resource.")]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Optional notes to be associated with the connection monitor.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Notes { get => _parametersBody.Notes ?? null; set => _parametersBody.Notes = value; }

        /// <summary>List of connection monitor outputs.</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of connection monitor outputs.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Sample.API.Models.IConnectionMonitorOutput[] Outputs { get => _parametersBody.Outputs?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.Outputs = (value != null ? new System.Collections.Generic.List<Sample.API.Models.IConnectionMonitorOutput>(value) : null); }
        ...
        /// <summary>The name of the resource group containing Network Watcher.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the resource group containing Network Watcher.")]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The source port used by connection monitor.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"port",
        PossibleTypes = new [] { typeof(int) })]
        public int SourcePort { get => _parametersBody.SourcePort ?? default(int); set => _parametersBody.SourcePort = value; }

        /// <summary>The ID of the resource used as the source by connection monitor.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The ID of the resource used as the source by connection monitor.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Connection monitor tags.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Sample.API.Models.IConnectionMonitorTags Tags { get => _parametersBody.Tags ?? null /* object */; set => _parametersBody.Tags = value; }

        /// <summary>List of connection monitor test configurations.</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of connection monitor test configurations.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Sample.API.Models.IConnectionMonitorTestConfiguration[] TestConfigurations { get => _parametersBody.TestConfigurations?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.TestConfigurations = (value != null ? new System.Collections.Generic.List<Sample.API.Models.IConnectionMonitorTestConfiguration>(value) : null); }

        /// <summary>List of connection monitor test groups.</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of connection monitor test groups.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Sample.API.Models.IConnectionMonitorTestGroup[] TestGroups { get => _parametersBody.TestGroups?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.TestGroups = (value != null ? new System.Collections.Generic.List<Sample.API.Models.IConnectionMonitorTestGroup>(value) : null); }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IConnectionMonitorResult">Sample.API.Models.IConnectionMonitorResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IConnectionMonitorResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of SetConnectionMonitor_UpdateExpanded</returns>
        public Sample.API.Cmdlets.SetConnectionMonitor_UpdateExpanded Clone()
        {
            var clone = new SetConnectionMonitor_UpdateExpanded();
            ...
            clone.ConnectionMonitorName = this.ConnectionMonitorName;
            clone.Migrate = this.Migrate;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ConnectionMonitorsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ConnectionMonitorsCreateOrUpdate(SubscriptionId, ResourceGroupName, NetworkWatcherName, ConnectionMonitorName, this.InvocationInformation.BoundParameters.ContainsKey("Migrate") ? Migrate : null, _parametersBody, onOk, onDefault, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeCreate);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,NetworkWatcherName=NetworkWatcherName,ConnectionMonitorName=ConnectionMonitorName,Migrate=this.InvocationInformation.BoundParameters.ContainsKey("Migrate") ? Migrate : null})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetConnectionMonitor_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public SetConnectionMonitor_UpdateExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IConnectionMonitorResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IConnectionMonitorResult
