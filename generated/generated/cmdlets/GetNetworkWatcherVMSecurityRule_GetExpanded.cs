...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetVMSecurityRules=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/securityGroupView"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"NetworkWatcherVMSecurityRule_GetExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.ISecurityGroupViewResult))]
    [global::Sample.API.Description(@"Gets the configured and effective security group rules on the specified VM.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/securityGroupView", ApiVersion = "2025-03-01")]
    public partial class GetNetworkWatcherVMSecurityRule_GetExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.ISecurityGroupViewParameters _parametersBody = new Sample.API.Models.SecurityGroupViewParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ID of the target VM.")]
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.ISecurityGroupViewResult">Sample.API.Models.ISecurityGroupViewResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.ISecurityGroupViewResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of GetNetworkWatcherVMSecurityRule_GetExpanded</returns>
        public Sample.API.Cmdlets.GetNetworkWatcherVMSecurityRule_GetExpanded Clone()
        {
            var clone = new GetNetworkWatcherVMSecurityRule_GetExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetNetworkWatcherVMSecurityRule_GetExpanded" /> cmdlet class.
        /// </summary>
        public GetNetworkWatcherVMSecurityRule_GetExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NetworkWatchersGetVMSecurityRules' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.NetworkWatchersGetVMSecurityRules(SubscriptionId, ResourceGroupName, NetworkWatcherName, _parametersBody, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.ISecurityGroupViewResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.ISecurityGroupViewResult
                var result = (await response);
                // response should be returning an array of some kind. +Pageable
                // nested-array / networkInterfaces / <none>
                WriteObject(result.NetworkInterfaces, true);
            }
        }
    }
}