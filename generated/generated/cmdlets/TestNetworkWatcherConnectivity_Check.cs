...
namespace Sample.API.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CheckConnectivity=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/connectivityCheck"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"NetworkWatcherConnectivity_Check", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IConnectivityInformation))]
    [global::Sample.API.Description(@"Verifies the possibility of establishing a direct TCP connection from a virtual machine to a given endpoint including another VM or an arbitrary remote server.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/connectivityCheck", ApiVersion = "2025-03-01")]
    public partial class TestNetworkWatcherConnectivity_Check : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.IConnectivityParameters _parameters;

        /// <summary>Parameters that determine how the connectivity check will be performed.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters that determine how the connectivity check will be performed.", ValueFromPipeline = true)]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Parameters that determine how the connectivity check will be performed.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Sample.API.Models.IConnectivityParameters) })]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        public Sample.API.Models.IConnectivityParameters Parameters { get => this._parameters; set => this._parameters = value; }
        ...
        /// <summary>The name of the network watcher resource group.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the network watcher resource group.")]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IConnectivityInformation">Sample.API.Models.IConnectivityInformation</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IConnectivityInformation> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of TestNetworkWatcherConnectivity_Check</returns>
        public Sample.API.Cmdlets.TestNetworkWatcherConnectivity_Check Clone()
        {
            var clone = new TestNetworkWatcherConnectivity_Check();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.NetworkWatchersCheckConnectivity(SubscriptionId, ResourceGroupName, NetworkWatcherName, Parameters, onOk, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestNetworkWatcherConnectivity_Check" /> cmdlet class.
        /// </summary>
        public TestNetworkWatcherConnectivity_Check()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IConnectivityInformation> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IConnectivityInformation
