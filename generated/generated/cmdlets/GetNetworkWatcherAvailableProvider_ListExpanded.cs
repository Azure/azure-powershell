...
namespace Sample.API.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListAvailableProviders=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/availableProvidersList"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"NetworkWatcherAvailableProvider_ListExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IAvailableProvidersList))]
    [global::Sample.API.Description(@"NOTE: This feature is currently in preview and still being tested for stability. Lists all available internet service providers for a specified Azure region.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/availableProvidersList", ApiVersion = "2025-03-01")]
    public partial class GetNetworkWatcherAvailableProvider_ListExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.IAvailableProvidersListParameters _parametersBody = new Sample.API.Models.AvailableProvidersListParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "A list of Azure regions.")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The city or town for available providers list.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"city",
        PossibleTypes = new [] { typeof(string) })]
        public string City { get => _parametersBody.City ?? null; set => _parametersBody.City = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The country for available providers list.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Country { get => _parametersBody.Country ?? null; set => _parametersBody.Country = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The state for available providers list.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string State { get => _parametersBody.State ?? null; set => _parametersBody.State = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IAvailableProvidersList">Sample.API.Models.IAvailableProvidersList</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IAvailableProvidersList> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of GetNetworkWatcherAvailableProvider_ListExpanded</returns>
        public Sample.API.Cmdlets.GetNetworkWatcherAvailableProvider_ListExpanded Clone()
        {
            var clone = new GetNetworkWatcherAvailableProvider_ListExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetNetworkWatcherAvailableProvider_ListExpanded" /> cmdlet class.
        /// </summary>
        public GetNetworkWatcherAvailableProvider_ListExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NetworkWatchersListAvailableProviders' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.NetworkWatchersListAvailableProviders(SubscriptionId, ResourceGroupName, NetworkWatcherName, _parametersBody, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IAvailableProvidersList> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IAvailableProvidersList
                var result = (await response);
                // response should be returning an array of some kind. +Pageable
                // nested-array / countries / <none>
                WriteObject(result.Countries, true);
            }
        }
    }
}