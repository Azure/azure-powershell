...
namespace Sample.API.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetNetworkConfigurationDiagnostic=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/networkConfigurationDiagnostic"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"NetworkWatcherNetworkConfigurationDiagnostic_GetExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.INetworkConfigurationDiagnosticResponse))]
    [global::Sample.API.Description(@"Gets Network Configuration Diagnostic data to help customers understand and debug network behavior. It provides detailed information on what security rules were applied to a specified traffic flow and the result of evaluating these rules. Customers must provide details of a flow like source, destination, protocol, etc. The API returns whether traffic was allowed or denied, the rules evaluated for the specified flow and the evaluation results.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/networkConfigurationDiagnostic", ApiVersion = "2025-03-01")]
    public partial class GetNetworkWatcherNetworkConfigurationDiagnostic_GetExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.INetworkConfigurationDiagnosticParameters _parametersBody = new Sample.API.Models.NetworkConfigurationDiagnosticParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "List of network configuration diagnostic profiles.")]
        ...
        public Sample.API.Models.INetworkConfigurationDiagnosticProfile[] Profiles { get => _parametersBody.Profiles?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.Profiles = (value != null ? new System.Collections.Generic.List<Sample.API.Models.INetworkConfigurationDiagnosticProfile>(value) : null); }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The ID of the target resource to perform network configuration diagnostic. Valid options are VM, NetworkInterface, VMSS/NetworkInterface and Application Gateway.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Verbosity level.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string VerbosityLevel { get => _parametersBody.VerbosityLevel ?? null; set => _parametersBody.VerbosityLevel = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.INetworkConfigurationDiagnosticResponse">Sample.API.Models.INetworkConfigurationDiagnosticResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.INetworkConfigurationDiagnosticResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of GetNetworkWatcherNetworkConfigurationDiagnostic_GetExpanded
        /// </returns>
        public Sample.API.Cmdlets.GetNetworkWatcherNetworkConfigurationDiagnostic_GetExpanded Clone()
        {
            var clone = new GetNetworkWatcherNetworkConfigurationDiagnostic_GetExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetNetworkWatcherNetworkConfigurationDiagnostic_GetExpanded" /> cmdlet class.
        /// </summary>
        public GetNetworkWatcherNetworkConfigurationDiagnostic_GetExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NetworkWatchersGetNetworkConfigurationDiagnostic' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.NetworkWatchersGetNetworkConfigurationDiagnostic(SubscriptionId, ResourceGroupName, NetworkWatcherName, _parametersBody, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.INetworkConfigurationDiagnosticResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.INetworkConfigurationDiagnosticResponse
                var result = (await response);
                // response should be returning an array of some kind. +Pageable
                // nested-array / results / <none>
                WriteObject(result.Results, true);
            }
        }
    }
}