...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetNextHop=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/nextHop"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"NetworkWatcherNextHop_GetViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.INextHopResult))]
    [global::Sample.API.Description(@"Gets the next hop from the specified VM.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/nextHop", ApiVersion = "2025-03-01")]
    public partial class GetNetworkWatcherNextHop_GetViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.INextHopParameters _parametersBody = new Sample.API.Models.NextHopParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The destination IP address.")]
        ...
        public string DestinationIPAddress { get => _parametersBody.DestinationIPAddress ?? null; set => _parametersBody.DestinationIPAddress = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The source IP address.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SourceIPAddress { get => _parametersBody.SourceIPAddress ?? null; set => _parametersBody.SourceIPAddress = value; }

        /// <summary>
        /// The NIC ID. (If VM has multiple NICs and IP forwarding is enabled on any of the nics, then this parameter must be specified.
        /// Otherwise optional).
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The NIC ID. (If VM has multiple NICs and IP forwarding is enabled on any of the nics, then this parameter must be specified. Otherwise optional).")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string TargetNicResourceId { get => _parametersBody.TargetNicResourceId ?? null; set => _parametersBody.TargetNicResourceId = value; }

        /// <summary>
        /// The resource identifier of the target resource against which the action is to be performed.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The resource identifier of the target resource against which the action is to be performed.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.INextHopResult">Sample.API.Models.INextHopResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.INextHopResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of GetNetworkWatcherNextHop_GetViaIdentityExpanded</returns>
        public Sample.API.Cmdlets.GetNetworkWatcherNextHop_GetViaIdentityExpanded Clone()
        {
            var clone = new GetNetworkWatcherNextHop_GetViaIdentityExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetNetworkWatcherNextHop_GetViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public GetNetworkWatcherNextHop_GetViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NetworkWatchersGetNextHop' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.NetworkWatchersGetNextHop(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.NetworkWatcherName ?? null, _parametersBody, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.INextHopResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.INextHopResult
