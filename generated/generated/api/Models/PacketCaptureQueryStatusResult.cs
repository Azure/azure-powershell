...
namespace Sample.API.Models
{
    ...
    public partial class PacketCaptureQueryStatusResult :
        Sample.API.Models.IPacketCaptureQueryStatusResult,
        Sample.API.Models.IPacketCaptureQueryStatusResultInternal
    {
        ...
        private System.Collections.Generic.List<string> _packetCaptureError;

        /// <summary>List of errors of packet capture session.</summary>
        [Sample.API.Origin(Sample.API.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> PacketCaptureError { get => this._packetCaptureError; set => this._packetCaptureError = value; }

        /// <summary>Backing field for <see cref="PacketCaptureStatus" /> property.</summary>
        private string _packetCaptureStatus;

        /// <summary>The status of the packet capture session.</summary>
        [Sample.API.Origin(Sample.API.PropertyOrigin.Owned)]
        public string PacketCaptureStatus { get => this._packetCaptureStatus; set => this._packetCaptureStatus = value; }
        ...
        Sample.API.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Sample.API.PSArgumentCompleterAttribute("InternalError", "AgentStopped", "CaptureFailed", "LocalFileFailed", "StorageFailed")]
        System.Collections.Generic.List<string> PacketCaptureError { get; set; }
        /// <summary>The status of the packet capture session.</summary>
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Sample.API.PSArgumentCompleterAttribute("NotStarted", "Running", "Stopped", "Error", "Unknown")]
        string PacketCaptureStatus { get; set; }
        /// <summary>The reason the current packet capture session was stopped.</summary>
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
