...
namespace Sample.API.Models
{
    ...
    public partial class ConnectionMonitorResult
    {
        ...
        /// <summary>
        /// Deserializes a Sample.API.Runtime.Json.JsonObject into a new instance of <see cref="ConnectionMonitorResult" />.
        /// </summary>
        /// <param name="json">A Sample.API.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ConnectionMonitorResult(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_properties = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Sample.API.Models.ConnectionMonitorResultProperties.FromJson(__jsonProperties) : _properties;}
            ...
            {_tags = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? Sample.API.Models.ConnectionMonitorResultTags.FromJson(__jsonTags) : _tags;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Sample.API.Runtime.Json.JsonNode"/> into an instance of Sample.API.Models.IConnectionMonitorResult.
        /// </summary>
        /// <param name="node">a <see cref="Sample.API.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IConnectionMonitorResult.</returns>
        public static Sample.API.Models.IConnectionMonitorResult FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new ConnectionMonitorResult(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ConnectionMonitorResult" /> into a <see cref="Sample.API.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Sample.API.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Sample.API.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="ConnectionMonitorResult" /> as a <see cref="Sample.API.Runtime.Json.JsonNode" />.
        /// </returns>
