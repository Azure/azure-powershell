...
using Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Json;
using System;

namespace Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.JsonSerializable.ToJson(dict, null);
            }
