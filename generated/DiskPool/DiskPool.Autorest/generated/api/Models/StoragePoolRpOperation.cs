...
namespace Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models
{
    ...
    public partial class StoragePoolRpOperation :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IStoragePoolRpOperationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IStoragePoolOperationDisplay _display;

        /// <summary>Additional metadata about RP operation.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Origin(Microsoft.Azure.PowerShell.Cmdlets.DiskPool.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IStoragePoolOperationDisplay Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.StoragePoolOperationDisplay()); set => this._display = value; }
        ...
        public string DisplayDescription { get => ((Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IStoragePoolOperationDisplayInternal)Display).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IStoragePoolOperationDisplayInternal)Display).Description = value ; }

        /// <summary>Localized friendly name for the operation, as it should be shown to the user.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Origin(Microsoft.Azure.PowerShell.Cmdlets.DiskPool.PropertyOrigin.Inlined)]
        public string DisplayOperation { get => ((Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IStoragePoolOperationDisplayInternal)Display).Operation; set => ((Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IStoragePoolOperationDisplayInternal)Display).Operation = value ; }

        /// <summary>Localized friendly form of the resource provider name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Origin(Microsoft.Azure.PowerShell.Cmdlets.DiskPool.PropertyOrigin.Inlined)]
        public string DisplayProvider { get => ((Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IStoragePoolOperationDisplayInternal)Display).Provider; set => ((Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IStoragePoolOperationDisplayInternal)Display).Provider = value ; }

        /// <summary>Localized friendly form of the resource type related to this action/operation.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Origin(Microsoft.Azure.PowerShell.Cmdlets.DiskPool.PropertyOrigin.Inlined)]
        public string DisplayResource { get => ((Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IStoragePoolOperationDisplayInternal)Display).Resource; set => ((Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IStoragePoolOperationDisplayInternal)Display).Resource = value ; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IStoragePoolOperationDisplay Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IStoragePoolRpOperationInternal.Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.StoragePoolOperationDisplay()); set { {_display = value;} } }
...

    {
        ...
        string ActionType { get; set; }
        /// <summary>Additional metadata about RP operation.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IStoragePoolOperationDisplay Display { get; set; }
        /// <summary>
        /// Localized friendly description for the operation, as it should be shown to the user.
        /// </summary>
        string DisplayDescription { get; set; }
