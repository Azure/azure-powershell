...
namespace Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models
{
    ...
    public partial class IscsiLun
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IIscsiLun.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IIscsiLun.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IIscsiLun FromJson(Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Json.JsonNode node)
        {
        ...
        internal IscsiLun(Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Json.JsonObject json)
        {
            ...
            {_managedDiskAzureResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Json.JsonString>("managedDiskAzureResourceId"), out var __jsonManagedDiskAzureResourceId) ? (string)__jsonManagedDiskAzureResourceId : (string)_managedDiskAzureResourceId;}
            {_lun = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Json.JsonNumber>("lun"), out var __jsonLun) ? (int?)__jsonLun : _lun;}
            AfterFromJson(json);
        }
