...
namespace Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IAclInternal
    {
        ...
        private System.Collections.Generic.List<string> _mappedLun;

        /// <summary>List of LUN names mapped to the ACL.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Origin(Microsoft.Azure.PowerShell.Cmdlets.DiskPool.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> MappedLun { get => this._mappedLun; set => this._mappedLun = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> MappedLun { get; set; }
