...
namespace Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.IProjectPropertiesUpdateInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.IDefaultEndpointSettingsUpdate _defaultEndpointSetting;

        /// <summary>Default endpoint settings for the project.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Origin(Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.IDefaultEndpointSettingsUpdate DefaultEndpointSetting { get => (this._defaultEndpointSetting = this._defaultEndpointSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.DefaultEndpointSettingsUpdate()); set => this._defaultEndpointSetting = value; }

        /// <summary>Maximum compute units for autoscaling.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Origin(Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.PropertyOrigin.Inlined)]
        public float? DefaultEndpointSettingAutoscalingLimitMaxCu { get => ((Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.IDefaultEndpointSettingsUpdateInternal)DefaultEndpointSetting).AutoscalingLimitMaxCu; set => ((Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.IDefaultEndpointSettingsUpdateInternal)DefaultEndpointSetting).AutoscalingLimitMaxCu = value ?? default(float); }

        /// <summary>Minimum compute units for autoscaling.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Origin(Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.PropertyOrigin.Inlined)]
        public float? DefaultEndpointSettingAutoscalingLimitMinCu { get => ((Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.IDefaultEndpointSettingsUpdateInternal)DefaultEndpointSetting).AutoscalingLimitMinCu; set => ((Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.IDefaultEndpointSettingsUpdateInternal)DefaultEndpointSetting).AutoscalingLimitMinCu = value ?? default(float); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.IBranchProperties Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.IProjectPropertiesUpdateInternal.Branch { get => (this._branch = this._branch ?? new Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.BranchProperties()); set { {_branch = value;} } }
        ...
        /// <summary>Creates an new <see cref="ProjectPropertiesUpdate" /> instance.</summary>
        public ProjectPropertiesUpdate()
        {
    ...
    /// Properties specific to Project
    internal partial interface IProjectPropertiesUpdateInternal

    {
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.INeonDatabaseProperties> Database { get; set; }
        /// <summary>Default endpoint settings for the project.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.IDefaultEndpointSettingsUpdate DefaultEndpointSetting { get; set; }
        /// <summary>Maximum compute units for autoscaling.</summary>
        float? DefaultEndpointSettingAutoscalingLimitMaxCu { get; set; }
        /// <summary>Minimum compute units for autoscaling.</summary>
        float? DefaultEndpointSettingAutoscalingLimitMinCu { get; set; }
