...
.Link
https://learn.microsoft.com/powershell/module/az.neonpostgres/get-azneonpostgresoperation
#>
function Get-AzNeonPostgresOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.IOperation])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.NeonPostgres.private\Get-AzNeonPostgresOperation_List';
        }
