...
namespace Microsoft.Azure.PowerShell.Cmdlets.Aks.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Aks.Support.ConnectionStatus Approved = @"Approved";

        public static Microsoft.Azure.PowerShell.Cmdlets.Aks.Support.ConnectionStatus Disconnected = @"Disconnected";

        public static Microsoft.Azure.PowerShell.Cmdlets.Aks.Support.ConnectionStatus Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.Aks.Support.ConnectionStatus Rejected = @"Rejected";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Aks.Support.ConnectionStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Aks.Support.ConnectionStatus e)
        {
            return e._value;
        }
