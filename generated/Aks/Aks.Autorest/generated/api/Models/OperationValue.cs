...
namespace Microsoft.Azure.PowerShell.Cmdlets.Aks.Models
{
    ...
    public partial class OperationValue :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IOperationValueInternal
    {

        /// <summary>Backing field for <see cref="Display" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IOperationValueDisplay _display;

        /// <summary>Describes the properties of a Operation Value Display.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Aks.Origin(Microsoft.Azure.PowerShell.Cmdlets.Aks.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IOperationValueDisplay Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.OperationValueDisplay()); set => this._display = value; }

        /// <summary>The description of the operation.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Aks.Origin(Microsoft.Azure.PowerShell.Cmdlets.Aks.PropertyOrigin.Inlined)]
        public string DisplayDescription { get => ((Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IOperationValueDisplayInternal)Display).Description; }

        /// <summary>The display name of the operation.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Aks.Origin(Microsoft.Azure.PowerShell.Cmdlets.Aks.PropertyOrigin.Inlined)]
        public string DisplayOperation { get => ((Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IOperationValueDisplayInternal)Display).Operation; }

        /// <summary>The resource provider for the operation.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Aks.Origin(Microsoft.Azure.PowerShell.Cmdlets.Aks.PropertyOrigin.Inlined)]
        public string DisplayProvider { get => ((Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IOperationValueDisplayInternal)Display).Provider; }

        /// <summary>The display name of the resource the operation applies to.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Aks.Origin(Microsoft.Azure.PowerShell.Cmdlets.Aks.PropertyOrigin.Inlined)]
        public string DisplayResource { get => ((Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IOperationValueDisplayInternal)Display).Resource; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IOperationValueInternal.Origin { get => this._origin; set { {_origin = value;} } }
    ...
    {
        /// <summary>Describes the properties of a Operation Value Display.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IOperationValueDisplay Display { get; set; }
        /// <summary>The description of the operation.</summary>
