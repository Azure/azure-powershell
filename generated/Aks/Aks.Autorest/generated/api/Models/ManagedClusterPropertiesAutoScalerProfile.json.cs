...
namespace Microsoft.Azure.PowerShell.Cmdlets.Aks.Models
{
    ...
    public partial class ManagedClusterPropertiesAutoScalerProfile
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IManagedClusterPropertiesAutoScalerProfile.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IManagedClusterPropertiesAutoScalerProfile.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IManagedClusterPropertiesAutoScalerProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode node)
        {
        ...
        internal ManagedClusterPropertiesAutoScalerProfile(Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject json)
        {
            ...
            {_balanceSimilarNodeGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("balance-similar-node-groups"), out var __jsonBalanceSimilarNodeGroups) ? (string)__jsonBalanceSimilarNodeGroups : (string)_balanceSimilarNodeGroup;}
            {_daemonsetEvictionForEmptyNode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonBoolean>("daemonset-eviction-for-empty-nodes"), out var __jsonDaemonsetEvictionForEmptyNodes) ? (bool?)__jsonDaemonsetEvictionForEmptyNodes : _daemonsetEvictionForEmptyNode;}
            {_daemonsetEvictionForOccupiedNode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonBoolean>("daemonset-eviction-for-occupied-nodes"), out var __jsonDaemonsetEvictionForOccupiedNodes) ? (bool?)__jsonDaemonsetEvictionForOccupiedNodes : _daemonsetEvictionForOccupiedNode;}
            {_ignoreDaemonsetsUtilization = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonBoolean>("ignore-daemonsets-utilization"), out var __jsonIgnoreDaemonsetsUtilization) ? (bool?)__jsonIgnoreDaemonsetsUtilization : _ignoreDaemonsetsUtilization;}
            {_expander = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("expander"), out var __jsonExpander) ? (string)__jsonExpander : (string)_expander;}
            {_maxEmptyBulkDelete = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("max-empty-bulk-delete"), out var __jsonMaxEmptyBulkDelete) ? (string)__jsonMaxEmptyBulkDelete : (string)_maxEmptyBulkDelete;}
            {_maxGracefulTerminationSec = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("max-graceful-termination-sec"), out var __jsonMaxGracefulTerminationSec) ? (string)__jsonMaxGracefulTerminationSec : (string)_maxGracefulTerminationSec;}
            {_maxNodeProvisionTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("max-node-provision-time"), out var __jsonMaxNodeProvisionTime) ? (string)__jsonMaxNodeProvisionTime : (string)_maxNodeProvisionTime;}
            {_maxTotalUnreadyPercentage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("max-total-unready-percentage"), out var __jsonMaxTotalUnreadyPercentage) ? (string)__jsonMaxTotalUnreadyPercentage : (string)_maxTotalUnreadyPercentage;}
            {_newPodScaleUpDelay = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("new-pod-scale-up-delay"), out var __jsonNewPodScaleUpDelay) ? (string)__jsonNewPodScaleUpDelay : (string)_newPodScaleUpDelay;}
            {_okTotalUnreadyCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("ok-total-unready-count"), out var __jsonOkTotalUnreadyCount) ? (string)__jsonOkTotalUnreadyCount : (string)_okTotalUnreadyCount;}
            {_scanInterval = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("scan-interval"), out var __jsonScanInterval) ? (string)__jsonScanInterval : (string)_scanInterval;}
            {_scaleDownDelayAfterAdd = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("scale-down-delay-after-add"), out var __jsonScaleDownDelayAfterAdd) ? (string)__jsonScaleDownDelayAfterAdd : (string)_scaleDownDelayAfterAdd;}
            {_scaleDownDelayAfterDelete = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("scale-down-delay-after-delete"), out var __jsonScaleDownDelayAfterDelete) ? (string)__jsonScaleDownDelayAfterDelete : (string)_scaleDownDelayAfterDelete;}
            {_scaleDownDelayAfterFailure = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("scale-down-delay-after-failure"), out var __jsonScaleDownDelayAfterFailure) ? (string)__jsonScaleDownDelayAfterFailure : (string)_scaleDownDelayAfterFailure;}
            {_scaleDownUnneededTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("scale-down-unneeded-time"), out var __jsonScaleDownUnneededTime) ? (string)__jsonScaleDownUnneededTime : (string)_scaleDownUnneededTime;}
            {_scaleDownUnreadyTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("scale-down-unready-time"), out var __jsonScaleDownUnreadyTime) ? (string)__jsonScaleDownUnreadyTime : (string)_scaleDownUnreadyTime;}
            {_scaleDownUtilizationThreshold = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("scale-down-utilization-threshold"), out var __jsonScaleDownUtilizationThreshold) ? (string)__jsonScaleDownUtilizationThreshold : (string)_scaleDownUtilizationThreshold;}
            {_skipNodesWithLocalStorage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("skip-nodes-with-local-storage"), out var __jsonSkipNodesWithLocalStorage) ? (string)__jsonSkipNodesWithLocalStorage : (string)_skipNodesWithLocalStorage;}
            {_skipNodesWithSystemPod = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("skip-nodes-with-system-pods"), out var __jsonSkipNodesWithSystemPods) ? (string)__jsonSkipNodesWithSystemPods : (string)_skipNodesWithSystemPod;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._daemonsetEvictionForEmptyNode ? (Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonBoolean((bool)this._daemonsetEvictionForEmptyNode) : null, "daemonset-eviction-for-empty-nodes" ,container.Add );
            AddIf( null != this._daemonsetEvictionForOccupiedNode ? (Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonBoolean((bool)this._daemonsetEvictionForOccupiedNode) : null, "daemonset-eviction-for-occupied-nodes" ,container.Add );
            AddIf( null != this._ignoreDaemonsetsUtilization ? (Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonBoolean((bool)this._ignoreDaemonsetsUtilization) : null, "ignore-daemonsets-utilization" ,container.Add );
            ...
            AddIf( null != (((object)this._maxNodeProvisionTime)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString(this._maxNodeProvisionTime.ToString()) : null, "max-node-provision-time" ,container.Add );
