...
namespace Microsoft.Azure.PowerShell.Cmdlets.Aks.Models
{
    ...
    public partial class ContainerServiceNetworkProfile
    {
        ...
        internal ContainerServiceNetworkProfile(Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject json)
        {
            ...
            {_advancedNetworking = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject>("advancedNetworking"), out var __jsonAdvancedNetworking) ? Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.AdvancedNetworking.FromJson(__jsonAdvancedNetworking) : _advancedNetworking;}
            {_loadBalancerProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject>("loadBalancerProfile"), out var __jsonLoadBalancerProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.ManagedClusterLoadBalancerProfile.FromJson(__jsonLoadBalancerProfile) : _loadBalancerProfile;}
            {_natGatewayProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject>("natGatewayProfile"), out var __jsonNatGatewayProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.ManagedClusterNatGatewayProfile.FromJson(__jsonNatGatewayProfile) : _natGatewayProfile;}
            {_staticEgressGatewayProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject>("staticEgressGatewayProfile"), out var __jsonStaticEgressGatewayProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.ManagedClusterStaticEgressGatewayProfile.FromJson(__jsonStaticEgressGatewayProfile) : _staticEgressGatewayProfile;}
            {_networkPlugin = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("networkPlugin"), out var __jsonNetworkPlugin) ? (string)__jsonNetworkPlugin : (string)_networkPlugin;}
            {_networkPluginMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("networkPluginMode"), out var __jsonNetworkPluginMode) ? (string)__jsonNetworkPluginMode : (string)_networkPluginMode;}
            {_networkPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("networkPolicy"), out var __jsonNetworkPolicy) ? (string)__jsonNetworkPolicy : (string)_networkPolicy;}
            {_networkMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("networkMode"), out var __jsonNetworkMode) ? (string)__jsonNetworkMode : (string)_networkMode;}
            {_networkDataplane = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("networkDataplane"), out var __jsonNetworkDataplane) ? (string)__jsonNetworkDataplane : (string)_networkDataplane;}
            {_podCidr = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("podCidr"), out var __jsonPodCidr) ? (string)__jsonPodCidr : (string)_podCidr;}
            {_serviceCidr = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("serviceCidr"), out var __jsonServiceCidr) ? (string)__jsonServiceCidr : (string)_serviceCidr;}
            {_dnsServiceIP = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("dnsServiceIP"), out var __jsonDnsServiceIP) ? (string)__jsonDnsServiceIP : (string)_dnsServiceIP;}
            {_outboundType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("outboundType"), out var __jsonOutboundType) ? (string)__jsonOutboundType : (string)_outboundType;}
            {_loadBalancerSku = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("loadBalancerSku"), out var __jsonLoadBalancerSku) ? (string)__jsonLoadBalancerSku : (string)_loadBalancerSku;}
            {_podCidrs = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonArray>("podCidrs"), out var __jsonPodCidrs) ? If( __jsonPodCidrs as Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _podCidrs;}
            {_serviceCidrs = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonArray>("serviceCidrs"), out var __jsonServiceCidrs) ? If( __jsonServiceCidrs as Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : _serviceCidrs;}
            {_iPFamily = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonArray>("ipFamilies"), out var __jsonIPFamilies) ? If( __jsonIPFamilies as Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(string) (__k is Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString __j ? (string)(__j.ToString()) : null)) ))() : null : _iPFamily;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IContainerServiceNetworkProfile.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IContainerServiceNetworkProfile.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IContainerServiceNetworkProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._advancedNetworking ? (Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode) this._advancedNetworking.ToJson(null,serializationMode) : null, "advancedNetworking" ,container.Add );
            ...
            AddIf( null != this._staticEgressGatewayProfile ? (Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode) this._staticEgressGatewayProfile.ToJson(null,serializationMode) : null, "staticEgressGatewayProfile" ,container.Add );
