...
namespace Microsoft.Azure.PowerShell.Cmdlets.Aks.Models
{
    ...
    public partial class ManagedClusterSecurityProfileDefender
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IManagedClusterSecurityProfileDefender.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IManagedClusterSecurityProfileDefender.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IManagedClusterSecurityProfileDefender FromJson(Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode node)
        {
        ...
        internal ManagedClusterSecurityProfileDefender(Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject json)
        {
            ...
            {_securityMonitoring = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject>("securityMonitoring"), out var __jsonSecurityMonitoring) ? Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.ManagedClusterSecurityProfileDefenderSecurityMonitoring.FromJson(__jsonSecurityMonitoring) : _securityMonitoring;}
            {_logAnalyticsWorkspaceResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("logAnalyticsWorkspaceResourceId"), out var __jsonLogAnalyticsWorkspaceResourceId) ? (string)__jsonLogAnalyticsWorkspaceResourceId : (string)_logAnalyticsWorkspaceResourceId;}
            AfterFromJson(json);
        }
