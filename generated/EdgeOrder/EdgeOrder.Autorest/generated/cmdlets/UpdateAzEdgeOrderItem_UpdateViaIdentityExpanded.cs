...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Cmdlets
{
    ...
    using Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Cmdlets;
    using System;

    /// <summary>update the properties of an existing order item.</summary>
    /// <remarks>
    /// [OpenAPI] UpdateOrderItem=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EdgeOrder/orderItems/{orderItemName}"
    /// </remarks>
    ...
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderItemResource))]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EdgeOrder/orderItems/{orderItemName}", ApiVersion = "2021-12-01")]
    public partial class UpdateAzEdgeOrderItem_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderItemUpdateParameter _orderItemUpdateParameterBody = new Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.OrderItemUpdateParameter();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Contact details for the address")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IContactDetails ForwardAddressContactDetail { get => _orderItemUpdateParameterBody.ForwardAddressContactDetail ?? null /* object */; set => _orderItemUpdateParameterBody.ForwardAddressContactDetail = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IShippingAddress ForwardAddressShippingAddress { get => _orderItemUpdateParameterBody.ForwardAddressShippingAddress ?? null /* object */; set => _orderItemUpdateParameterBody.ForwardAddressShippingAddress = value; }
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.DoNotExport]
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] NotificationEmailList { get => _orderItemUpdateParameterBody.NotificationEmailList?.ToArray() ?? null /* fixedArrayOf */; set => _orderItemUpdateParameterBody.NotificationEmailList = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        /// </summary>
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.HttpPipeline Pipeline { get; set; }

        /// <summary>Customer preference.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Customer preference.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IPreferences Preference { get => _orderItemUpdateParameterBody.Preference ?? null /* object */; set => _orderItemUpdateParameterBody.Preference = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderItemUpdateParameterTags Tag { get => _orderItemUpdateParameterBody.Tag ?? null /* object */; set => _orderItemUpdateParameterBody.Tag = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IErrorResponse">Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IErrorResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IErrorResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderItemResource">Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderItemResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderItemResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Events.Progress:
                    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateOrderItem' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                Pipeline = Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Module.Instance.CreatePipeline(InvocationInformation, __correlationId, __processRecordId, this.ParameterSetName, this.ExtensibleParameters);
                ...
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("IfMatch"))
                {
                    IfMatch = (string)this.MyInvocation.BoundParameters["IfMatch"];
                }
                try
                {
                    ...
                    {
                        await this.Client.UpdateOrderItemViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, _orderItemUpdateParameterBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        await this.Client.UpdateOrderItem(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.OrderItemName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, _orderItemUpdateParameterBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzEdgeOrderItem_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IErrorResponse>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderItemResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderItemResource
