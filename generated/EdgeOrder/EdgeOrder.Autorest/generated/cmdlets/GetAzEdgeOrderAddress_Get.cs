...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzEdgeOrderAddress_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.GetAddressByName(SubscriptionId, ResourceGroupName, Name, onOk, onDefault, this, Pipeline);
