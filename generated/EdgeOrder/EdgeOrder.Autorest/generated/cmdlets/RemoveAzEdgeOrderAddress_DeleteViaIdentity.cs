...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.IEventListener
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.DeleteAddressByName(InputObject.AddressName ?? null, InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzEdgeOrderAddress_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
