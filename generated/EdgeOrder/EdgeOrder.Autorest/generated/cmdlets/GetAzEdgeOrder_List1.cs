...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListOrderAtResourceGroupLevel=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EdgeOrder/orders"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Description(@"Lists order at resource group level.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EdgeOrder/orders", ApiVersion = "2021-12-01")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzEdgeOrder_List1" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ListOrderAtResourceGroupLevel(SubscriptionId, ResourceGroupName, this.InvocationInformation.BoundParameters.ContainsKey("SkipToken") ? SkipToken : null, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ListOrderAtResourceGroupLevel_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
