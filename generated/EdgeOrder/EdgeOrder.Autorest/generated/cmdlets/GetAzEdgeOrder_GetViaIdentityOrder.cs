...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetOrderByName=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EdgeOrder/locations/{location}/orders/{orderName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzEdgeOrder_GetViaIdentityOrder")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Description(@"Gets an order.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EdgeOrder/locations/{location}/orders/{orderName}", ApiVersion = "2021-12-01")]
    public partial class GetAzEdgeOrder_GetViaIdentityOrder : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="OrderInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IEdgeOrderIdentity _orderInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IEdgeOrderIdentity OrderInputObject { get => this._orderInputObject; set => this._orderInputObject = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderResource">Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzEdgeOrder_GetViaIdentityOrder" /> cmdlet class.
        /// </summary>
        public GetAzEdgeOrder_GetViaIdentityOrder()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (OrderInputObject?.Id != null)
                    {
                        this.OrderInputObject.Id += $"/locations/{(global::System.Uri.EscapeDataString(this.Location.ToString()))}";
                        await this.Client.GetOrderByNameViaIdentity(OrderInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == OrderInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("OrderInputObject has null value for OrderInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, OrderInputObject) );
                        }
                        if (null == OrderInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("OrderInputObject has null value for OrderInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, OrderInputObject) );
                        }
                        if (null == OrderInputObject.OrderName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("OrderInputObject has null value for OrderInputObject.OrderName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, OrderInputObject) );
                        }
                        await this.Client.GetOrderByName(OrderInputObject.SubscriptionId ?? null, OrderInputObject.ResourceGroupName ?? null, OrderInputObject.OrderName ?? null, Location, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderResource
