...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models
{
    ...
    public partial class OrderItemDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderItemDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderItemDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IOrderItemDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode node)
        {
        ...
        internal OrderItemDetails(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject json)
        {
            ...
            {_productDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("productDetails"), out var __jsonProductDetails) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.ProductDetails.FromJson(__jsonProductDetails) : _productDetail;}
            {_orderItemType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("orderItemType"), out var __jsonOrderItemType) ? (string)__jsonOrderItemType : (string)_orderItemType;}
            {_currentStage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("currentStage"), out var __jsonCurrentStage) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.StageDetails.FromJson(__jsonCurrentStage) : _currentStage;}
            {_orderItemStageHistory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray>("orderItemStageHistory"), out var __jsonOrderItemStageHistory) ? If( __jsonOrderItemStageHistory as Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IStageDetails>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IStageDetails) (Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.StageDetails.FromJson(__u) )) ))() : null : _orderItemStageHistory;}
            {_preference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("preferences"), out var __jsonPreferences) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Preferences.FromJson(__jsonPreferences) : _preference;}
            {_forwardShippingDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("forwardShippingDetails"), out var __jsonForwardShippingDetails) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.ForwardShippingDetails.FromJson(__jsonForwardShippingDetails) : _forwardShippingDetail;}
            {_reverseShippingDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("reverseShippingDetails"), out var __jsonReverseShippingDetails) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.ReverseShippingDetails.FromJson(__jsonReverseShippingDetails) : _reverseShippingDetail;}
            {_notificationEmailList = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray>("notificationEmailList"), out var __jsonNotificationEmailList) ? If( __jsonNotificationEmailList as Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : _notificationEmailList;}
            {_cancellationReason = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("cancellationReason"), out var __jsonCancellationReason) ? (string)__jsonCancellationReason : (string)_cancellationReason;}
            {_cancellationStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("cancellationStatus"), out var __jsonCancellationStatus) ? (string)__jsonCancellationStatus : (string)_cancellationStatus;}
            {_deletionStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("deletionStatus"), out var __jsonDeletionStatus) ? (string)__jsonDeletionStatus : (string)_deletionStatus;}
            {_returnReason = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("returnReason"), out var __jsonReturnReason) ? (string)__jsonReturnReason : (string)_returnReason;}
            {_returnStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("returnStatus"), out var __jsonReturnStatus) ? (string)__jsonReturnStatus : (string)_returnStatus;}
            {_managementRpDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("managementRpDetails"), out var __jsonManagementRpDetails) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.ResourceProviderDetails.FromJson(__jsonManagementRpDetails) : _managementRpDetail;}
            {_managementRpDetailsList = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray>("managementRpDetailsList"), out var __jsonManagementRpDetailsList) ? If( __jsonManagementRpDetailsList as Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IResourceProviderDetails>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IResourceProviderDetails) (Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.ResourceProviderDetails.FromJson(__k) )) ))() : null : _managementRpDetailsList;}
