...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models
{
    ...
    public partial class Preferences
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IPreferences.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IPreferences.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IPreferences FromJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode node)
        {
        ...
        internal Preferences(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject json)
        {
            ...
            {_notificationPreference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray>("notificationPreferences"), out var __jsonNotificationPreferences) ? If( __jsonNotificationPreferences as Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.INotificationPreference>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.INotificationPreference) (Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.NotificationPreference.FromJson(__u) )) ))() : null : _notificationPreference;}
            {_transportPreference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("transportPreferences"), out var __jsonTransportPreferences) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.TransportPreferences.FromJson(__jsonTransportPreferences) : _transportPreference;}
            {_encryptionPreference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("encryptionPreferences"), out var __jsonEncryptionPreferences) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.EncryptionPreferences.FromJson(__jsonEncryptionPreferences) : _encryptionPreference;}
            {_managementResourcePreference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("managementResourcePreferences"), out var __jsonManagementResourcePreferences) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.ManagementResourcePreferences.FromJson(__jsonManagementResourcePreferences) : _managementResourcePreference;}
            AfterFromJson(json);
        }
