...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models
{
    ...
    public partial class Dimensions
    {
        ...
        internal Dimensions(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject json)
        {
            ...
            {_length = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNumber>("length"), out var __jsonLength) ? (double?)__jsonLength : _length;}
            {_height = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNumber>("height"), out var __jsonHeight) ? (double?)__jsonHeight : _height;}
            {_width = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNumber>("width"), out var __jsonWidth) ? (double?)__jsonWidth : _width;}
            {_lengthHeightUnit = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("lengthHeightUnit"), out var __jsonLengthHeightUnit) ? (string)__jsonLengthHeightUnit : (string)_lengthHeightUnit;}
            {_weight = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNumber>("weight"), out var __jsonWeight) ? (double?)__jsonWeight : _weight;}
            {_depth = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNumber>("depth"), out var __jsonDepth) ? (double?)__jsonDepth : _depth;}
            {_weightUnit = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("weightUnit"), out var __jsonWeightUnit) ? (string)__jsonWeightUnit : (string)_weightUnit;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IDimensions.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IDimensions.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IDimensions FromJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode node)
        {
