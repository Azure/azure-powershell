...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models
{
    ...
    public partial class BasicInformation
    {
        ...
        internal BasicInformation(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject json)
        {
            ...
            {_description = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("description"), out var __jsonDescription) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Description.FromJson(__jsonDescription) : _description;}
            {_costInformation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("costInformation"), out var __jsonCostInformation) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.CostInformation.FromJson(__jsonCostInformation) : _costInformation;}
            {_availabilityInformation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("availabilityInformation"), out var __jsonAvailabilityInformation) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.AvailabilityInformation.FromJson(__jsonAvailabilityInformation) : _availabilityInformation;}
            {_displayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("displayName"), out var __jsonDisplayName) ? (string)__jsonDisplayName : (string)_displayName;}
            {_imageInformation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray>("imageInformation"), out var __jsonImageInformation) ? If( __jsonImageInformation as Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IImageInformation>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IImageInformation) (Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.ImageInformation.FromJson(__u) )) ))() : null : _imageInformation;}
            {_hierarchyInformation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("hierarchyInformation"), out var __jsonHierarchyInformation) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.HierarchyInformation.FromJson(__jsonHierarchyInformation) : _hierarchyInformation;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IBasicInformation.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IBasicInformation.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IBasicInformation FromJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode node)
        {
