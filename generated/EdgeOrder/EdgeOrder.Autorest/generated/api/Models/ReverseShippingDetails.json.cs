...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models
{
    ...
    public partial class ReverseShippingDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IReverseShippingDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IReverseShippingDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IReverseShippingDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode node)
        {
        ...
        internal ReverseShippingDetails(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject json)
        {
            ...
            {_sasKeyForLabel = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("sasKeyForLabel"), out var __jsonSasKeyForLabel) ? (string)__jsonSasKeyForLabel : (string)_sasKeyForLabel;}
            {_carrierName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("carrierName"), out var __jsonCarrierName) ? (string)__jsonCarrierName : (string)_carrierName;}
            {_carrierDisplayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("carrierDisplayName"), out var __jsonCarrierDisplayName) ? (string)__jsonCarrierDisplayName : (string)_carrierDisplayName;}
            {_trackingId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("trackingId"), out var __jsonTrackingId) ? (string)__jsonTrackingId : (string)_trackingId;}
            {_trackingUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("trackingUrl"), out var __jsonTrackingUrl) ? (string)__jsonTrackingUrl : (string)_trackingUrl;}
            AfterFromJson(json);
        }
