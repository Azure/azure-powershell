...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models
{
    ...
    public partial class MeterDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IMeterDetails.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IMeterDetails interface is polymorphic, and the precise
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IMeterDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IMeterDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode node)
        {
        ...
        internal MeterDetails(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject json)
        {
            ...
            {_billingType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("billingType"), out var __jsonBillingType) ? (string)__jsonBillingType : (string)_billingType;}
            {_multiplier = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNumber>("multiplier"), out var __jsonMultiplier) ? (double?)__jsonMultiplier : _multiplier;}
            {_chargingType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonString>("chargingType"), out var __jsonChargingType) ? (string)__jsonChargingType : (string)_chargingType;}
            AfterFromJson(json);
        }
