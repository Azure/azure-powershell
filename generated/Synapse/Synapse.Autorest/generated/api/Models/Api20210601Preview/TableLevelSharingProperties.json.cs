...
namespace Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210601Preview
{
    ...
    public partial class TableLevelSharingProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210601Preview.ITableLevelSharingProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210601Preview.ITableLevelSharingProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210601Preview.ITableLevelSharingProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonObject json ? new TableLevelSharingProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonObject into a new instance of <see cref="TableLevelSharingProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal TableLevelSharingProperties(Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonObject json)
        {
            ...
            {_tablesToInclude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonArray>("tablesToInclude"), out var __jsonTablesToInclude) ? If( __jsonTablesToInclude as Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : TablesToInclude;}
            {_tablesToExclude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonArray>("tablesToExclude"), out var __jsonTablesToExclude) ? If( __jsonTablesToExclude as Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : TablesToExclude;}
            {_externalTablesToInclude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonArray>("externalTablesToInclude"), out var __jsonExternalTablesToInclude) ? If( __jsonExternalTablesToInclude as Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(string) (__k is Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonString __j ? (string)(__j.ToString()) : null)) ))() : null : ExternalTablesToInclude;}
            {_externalTablesToExclude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonArray>("externalTablesToExclude"), out var __jsonExternalTablesToExclude) ? If( __jsonExternalTablesToExclude as Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__g, (__f)=>(string) (__f is Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonString __e ? (string)(__e.ToString()) : null)) ))() : null : ExternalTablesToExclude;}
            {_materializedViewsToInclude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonArray>("materializedViewsToInclude"), out var __jsonMaterializedViewsToInclude) ? If( __jsonMaterializedViewsToInclude as Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonArray, out var __b) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__b, (__a)=>(string) (__a is Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonString ___z ? (string)(___z.ToString()) : null)) ))() : null : MaterializedViewsToInclude;}
            {_materializedViewsToExclude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonArray>("materializedViewsToExclude"), out var __jsonMaterializedViewsToExclude) ? If( __jsonMaterializedViewsToExclude as Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonArray, out var ___w) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(___w, (___v)=>(string) (___v is Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonString ___u ? (string)(___u.ToString()) : null)) ))() : null : MaterializedViewsToExclude;}
            AfterFromJson(json);
        }
