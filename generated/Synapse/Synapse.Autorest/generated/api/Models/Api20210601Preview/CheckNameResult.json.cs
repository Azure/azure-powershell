...
namespace Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210601Preview
{
    ...
    public partial class CheckNameResult
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210601Preview.ICheckNameResult.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210601Preview.ICheckNameResult.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210601Preview.ICheckNameResult FromJson(Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonObject json ? new CheckNameResult(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CheckNameResult" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CheckNameResult" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._nameAvailable ? (Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonBoolean((bool)this._nameAvailable) : null, "nameAvailable" ,container.Add );
            ...
            AddIf( null != (((object)this._reason)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Synapse.Runtime.Json.JsonString(this._reason.ToString()) : null, "reason" ,container.Add );
