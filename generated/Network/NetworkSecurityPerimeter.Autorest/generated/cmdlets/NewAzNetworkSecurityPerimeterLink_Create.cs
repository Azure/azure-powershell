...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzNetworkSecurityPerimeterLink_Create", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityPerimeters/{networkSecurityPerimeterName}/links/{linkName}", ApiVersion = "2024-07-01")]
    public partial class NewAzNetworkSecurityPerimeterLink_Create : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.INspLink _parameter;

        /// <summary>The network security perimeter link resource</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The network security perimeter link resource", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Models.INspLink Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzNetworkSecurityPerimeterLink_Create" /> cmdlet class.
        /// </summary>
        public NewAzNetworkSecurityPerimeterLink_Create()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NetworkSecurityPerimeterLinksCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.NetworkSecurityPerimeterLinksCreateOrUpdate(SubscriptionId, ResourceGroupName, SecurityPerimeterName, Name, Parameter, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.SerializationMode.IncludeCreate);
