...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityPerimeters/{networkSecurityPerimeterName}/resourceAssociations/{associationName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzNetworkSecurityPerimeterAssociation_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityPerimeters/{networkSecurityPerimeterName}/resourceAssociations/{associationName}", ApiVersion = "2025-05-01")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of RemoveAzNetworkSecurityPerimeterAssociation_DeleteViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Cmdlets.RemoveAzNetworkSecurityPerimeterAssociation_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzNetworkSecurityPerimeterAssociation_DeleteViaIdentity();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NetworkSecurityPerimeterAssociationsDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.NetworkSecurityPerimeterAssociationsDeleteViaIdentity(InputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NetworkSecurityPerimeterAssociationsDelete(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.NetworkSecurityPerimeterName ?? null, InputObject.AssociationName ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzNetworkSecurityPerimeterAssociation_DeleteViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public RemoveAzNetworkSecurityPerimeterAssociation_DeleteViaIdentity()
        {
