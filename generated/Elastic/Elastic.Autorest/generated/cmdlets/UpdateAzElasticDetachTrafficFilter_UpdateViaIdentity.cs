...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Description(@"Detach an existing traffic filter from your Elastic monitor resource, removing its network traffic control capabilities.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Elastic/monitors/{monitorName}/detachTrafficFilter", ApiVersion = "2025-06-01")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DetachTrafficFilterUpdateViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("RulesetId") ? RulesetId : null, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.DetachTrafficFilterUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.MonitorName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("RulesetId") ? RulesetId : null, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzElasticDetachTrafficFilter_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
