...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Elastic/monitors/{monitorName}/openAIIntegrations/{integrationName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzElasticOpenAi_DeleteViaIdentityMonitor", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Description(@"Delete an OpenAI integration rule for a given Elastic monitor resource, removing AI-driven observability and monitoring capabilities.")]
    ...
    public partial class RemoveAzElasticOpenAi_DeleteViaIdentityMonitor : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.IContext
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'OpenAiDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.MonitorInputObject.Id += $"/openAIIntegrations/{(global::System.Uri.EscapeDataString(this.IntegrationName.ToString()))}";
                        await this.Client.OpenAiDeleteViaIdentity(MonitorInputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.OpenAiDelete(MonitorInputObject.SubscriptionId ?? null, MonitorInputObject.ResourceGroupName ?? null, MonitorInputObject.MonitorName ?? null, IntegrationName, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { IntegrationName=IntegrationName})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzElasticOpenAi_DeleteViaIdentityMonitor" /> cmdlet class.
        /// </summary>
        public RemoveAzElasticOpenAi_DeleteViaIdentityMonitor()
        {
