...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Create=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Elastic/monitors/{monitorName}/createAndAssociatePLFilter"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzElasticCreateAndAssociatePlFilter_CreateViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Description(@"Create and Associate private link traffic filter for the given deployment.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Elastic/monitors/{monitorName}/createAndAssociatePLFilter", ApiVersion = "2024-03-01")]
    public partial class NewAzElasticCreateAndAssociatePlFilter_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.IEventListener
    {
        ...
        /// <summary>Name of the traffic filter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of the traffic filter")]
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.ParameterCategory.Query)]
        ...
        /// <summary>Backing field for <see cref="PrivateEndpointGuid" /> property.</summary>
        private string _privateEndpointGuid;

        /// <summary>Guid of the private endpoint</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Guid of the private endpoint")]
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.ParameterCategory.Query)]
        public string PrivateEndpointGuid { get => this._privateEndpointGuid; set => this._privateEndpointGuid = value; }

        /// <summary>Backing field for <see cref="PrivateEndpointName" /> property.</summary>
        private string _privateEndpointName;

        /// <summary>Name of the private endpoint</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of the private endpoint")]
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.ParameterCategory.Query)]
        public string PrivateEndpointName { get => this._privateEndpointName; set => this._privateEndpointName = value; }
        ...
        /// <returns>
        /// a duplicate instance of NewAzElasticCreateAndAssociatePlFilter_CreateViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Elastic.Cmdlets.NewAzElasticCreateAndAssociatePlFilter_CreateViaIdentity Clone()
        {
            var clone = new NewAzElasticCreateAndAssociatePlFilter_CreateViaIdentity();
            ...
            clone.PrivateEndpointGuid = this.PrivateEndpointGuid;
            clone.PrivateEndpointName = this.PrivateEndpointName;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzElasticCreateAndAssociatePlFilter_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzElasticCreateAndAssociatePlFilter_CreateViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CreateAndAssociatePlFilterCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.CreateAndAssociatePlFilterCreateViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("Name") ? Name : null, this.InvocationInformation.BoundParameters.ContainsKey("PrivateEndpointGuid") ? PrivateEndpointGuid : null, this.InvocationInformation.BoundParameters.ContainsKey("PrivateEndpointName") ? PrivateEndpointName : null, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Name=this.InvocationInformation.BoundParameters.ContainsKey("Name") ? Name : null,PrivateEndpointGuid=this.InvocationInformation.BoundParameters.ContainsKey("PrivateEndpointGuid") ? PrivateEndpointGuid : null,PrivateEndpointName=this.InvocationInformation.BoundParameters.ContainsKey("PrivateEndpointName") ? PrivateEndpointName : null})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240301.IResourceProviderDefaultErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Name=this.InvocationInformation.BoundParameters.ContainsKey("Name") ? Name : null, PrivateEndpointGuid=this.InvocationInformation.BoundParameters.ContainsKey("PrivateEndpointGuid") ? PrivateEndpointGuid : null, PrivateEndpointName=this.InvocationInformation.BoundParameters.ContainsKey("PrivateEndpointName") ? PrivateEndpointName : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Name=this.InvocationInformation.BoundParameters.ContainsKey("Name") ? Name : null, PrivateEndpointGuid=this.InvocationInformation.BoundParameters.ContainsKey("PrivateEndpointGuid") ? PrivateEndpointGuid : null, PrivateEndpointName=this.InvocationInformation.BoundParameters.ContainsKey("PrivateEndpointName") ? PrivateEndpointName : null })
                    {
