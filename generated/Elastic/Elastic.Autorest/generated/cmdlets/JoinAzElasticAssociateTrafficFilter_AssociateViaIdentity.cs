...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Description(@"Associate a traffic filter with your Elastic monitor resource to control and manage network traffic.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Elastic/monitors/{monitorName}/associateTrafficFilter", ApiVersion = "2025-06-01")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JoinAzElasticAssociateTrafficFilter_AssociateViaIdentity" /> cmdlet class.
        /// </summary>
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.AssociateTrafficFilterAssociateViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("RulesetId") ? RulesetId : null, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.AssociateTrafficFilterAssociate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.MonitorName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("RulesetId") ? RulesetId : null, onOk, onDefault, this, Pipeline);
                    }
