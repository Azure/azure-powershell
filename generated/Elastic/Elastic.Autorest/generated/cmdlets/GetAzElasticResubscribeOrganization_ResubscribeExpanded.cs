...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Resubscribe=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Elastic/monitors/{monitorName}/resubscribe"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzElasticResubscribeOrganization_ResubscribeExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Description(@"Resubscribe the Elasticsearch Organization.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Elastic/monitors/{monitorName}/resubscribe", ApiVersion = "2025-06-01")]
    public partial class GetAzElasticResubscribeOrganization_ResubscribeExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IResubscribeProperties _body = new Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.ResubscribeProperties();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Organization Id of the Elastic Organization that needs to be resubscribed")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string OrganizationId { get => _body.OrganizationId ?? null; set => _body.OrganizationId = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Newly selected plan Id to create the new Marketplace subscription for Resubscribe")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Newly selected Azure resource group in which the new Marketplace subscription will be created for Resubscribe")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ResourceGroup { get => _body.ResourceGroup ?? null; set => _body.ResourceGroup = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Newly selected Azure Subscription Id in which the new Marketplace subscription will be created for Resubscribe")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"subscriptionId",
        PossibleTypes = new [] { typeof(string) })]
        public string TargetSubscriptionId { get => _body.TargetSubscriptionId ?? null; set => _body.TargetSubscriptionId = value; }

        /// <summary>Newly selected term to create the new Marketplace subscription for Resubscribe</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Newly selected term to create the new Marketplace subscription for Resubscribe")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IElasticMonitorResource">Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IElasticMonitorResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IElasticMonitorResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of GetAzElasticResubscribeOrganization_ResubscribeExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Elastic.Cmdlets.GetAzElasticResubscribeOrganization_ResubscribeExpanded Clone()
        {
            var clone = new GetAzElasticResubscribeOrganization_ResubscribeExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzElasticResubscribeOrganization_ResubscribeExpanded" /> cmdlet class.
        /// </summary>
        public GetAzElasticResubscribeOrganization_ResubscribeExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'OrganizationsResubscribe' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.OrganizationsResubscribe(SubscriptionId, ResourceGroupName, MonitorName, _body, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IElasticMonitorResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
