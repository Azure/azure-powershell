...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzElasticOpenAi_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Description(@"update an OpenAI integration rule for a given Elastic monitor resource, enabling advanced AI-driven observability and monitoring.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Generated]
    public partial class UpdateAzElasticOpenAi_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IOpenAiIntegrationRpmodel _body = new Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.OpenAiIntegrationRpmodel();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Value of API key for Open AI resource")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string OpenAiResourceEndpoint { get => _body.OpenAiResourceEndpoint ?? null; set => _body.OpenAiResourceEndpoint = value; }

        /// <summary>The resource name of Open AI resource</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The resource name of Open AI resource")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string OpenAiResourceId { get => _body.OpenAiResourceId ?? null; set => _body.OpenAiResourceId = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IOpenAiIntegrationRpmodel">Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IOpenAiIntegrationRpmodel</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IOpenAiIntegrationRpmodel> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IOpenAiIntegrationRpmodel> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'OpenAiCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _body = await this.Client.OpenAiGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_body();
                        await this.Client.OpenAiCreateOrUpdateViaIdentity(InputObject.Id, _body, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _body = await this.Client.OpenAiGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.MonitorName ?? null, InputObject.IntegrationName ?? null, this, Pipeline);
                        this.Update_body();
                        await this.Client.OpenAiCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.MonitorName ?? null, InputObject.IntegrationName ?? null, _body, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzElasticOpenAi_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzElasticOpenAi_UpdateViaIdentityExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("OpenAiResourceId")))
            {
                this.OpenAiResourceId = (string)(this.MyInvocation?.BoundParameters["OpenAiResourceId"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("OpenAiResourceEndpoint")))
            {
                this.OpenAiResourceEndpoint = (string)(this.MyInvocation?.BoundParameters["OpenAiResourceEndpoint"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("OpenAiConnectorId")))
            {
                this.OpenAiConnectorId = (string)(this.MyInvocation?.BoundParameters["OpenAiConnectorId"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Key")))
            {
                this.Key = (string)(this.MyInvocation?.BoundParameters["Key"]);
            }
        }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IOpenAiIntegrationRpmodel> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IOpenAiIntegrationRpmodel
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IOpenAiIntegrationRpmodel> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
