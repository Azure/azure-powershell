...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models
{
    ...
    public partial class UserInfo :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IUserInfoInternal
    {

        /// <summary>Backing field for <see cref="CompanyInfo" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.ICompanyInfo _companyInfo;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.ICompanyInfo CompanyInfo { get => (this._companyInfo = this._companyInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.CompanyInfo()); set => this._companyInfo = value; }
        ...
        public string CompanyInfoBusiness { get => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.ICompanyInfoInternal)CompanyInfo).Business; set => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.ICompanyInfoInternal)CompanyInfo).Business = value ?? null; }

        /// <summary>Country of the company location.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Origin(Microsoft.Azure.PowerShell.Cmdlets.Elastic.PropertyOrigin.Inlined)]
        public string CompanyInfoCountry { get => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.ICompanyInfoInternal)CompanyInfo).Country; set => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.ICompanyInfoInternal)CompanyInfo).Country = value ?? null; }

        /// <summary>Domain of the company</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Origin(Microsoft.Azure.PowerShell.Cmdlets.Elastic.PropertyOrigin.Inlined)]
        public string CompanyInfoDomain { get => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.ICompanyInfoInternal)CompanyInfo).Domain; set => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.ICompanyInfoInternal)CompanyInfo).Domain = value ?? null; }

        /// <summary>Number of employees in the company</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Origin(Microsoft.Azure.PowerShell.Cmdlets.Elastic.PropertyOrigin.Inlined)]
        public string CompanyInfoEmployeesNumber { get => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.ICompanyInfoInternal)CompanyInfo).EmployeesNumber; set => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.ICompanyInfoInternal)CompanyInfo).EmployeesNumber = value ?? null; }

        /// <summary>State of the company location.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Origin(Microsoft.Azure.PowerShell.Cmdlets.Elastic.PropertyOrigin.Inlined)]
        public string CompanyInfoState { get => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.ICompanyInfoInternal)CompanyInfo).State; set => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.ICompanyInfoInternal)CompanyInfo).State = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.ICompanyInfo Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IUserInfoInternal.CompanyInfo { get => (this._companyInfo = this._companyInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.CompanyInfo()); set { {_companyInfo = value;} } }
    ...
    {
        /// <summary>Company information of the user to be passed to partners.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.ICompanyInfo CompanyInfo { get; set; }
        /// <summary>Business of the company</summary>
        string CompanyInfoBusiness { get; set; }
        /// <summary>Country of the company location.</summary>
        string CompanyInfoCountry { get; set; }
