...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240301
{
    ...
    public partial class ElasticProperties
    {
        ...
        internal ElasticProperties(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject json)
        {
            ...
            {_elasticCloudUser = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject>("elasticCloudUser"), out var __jsonElasticCloudUser) ? Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240301.ElasticCloudUser.FromJson(__jsonElasticCloudUser) : ElasticCloudUser;}
            {_elasticCloudDeployment = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject>("elasticCloudDeployment"), out var __jsonElasticCloudDeployment) ? Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240301.ElasticCloudDeployment.FromJson(__jsonElasticCloudDeployment) : ElasticCloudDeployment;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240301.IElasticProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240301.IElasticProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240301.IElasticProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode node)
        {
