...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Dashboard/grafana/{workspaceName}/integrationFabrics/{integrationFabricName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzGrafanaIntegrationFabric_UpdateViaIdentityGrafanaExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IIntegrationFabric))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Description(@"update a IntegrationFabric")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Dashboard/grafana/{workspaceName}/integrationFabrics/{integrationFabricName}", ApiVersion = "2025-08-01")]
    public partial class UpdateAzGrafanaIntegrationFabric_UpdateViaIdentityGrafanaExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IIntegrationFabricUpdateParameters _requestBodyParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IntegrationFabricUpdateParameters();
        ...
        /// <summary>Backing field for <see cref="GrafanaInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IDashboardIdentity _grafanaInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IDashboardIdentity GrafanaInputObject { get => this._grafanaInputObject; set => this._grafanaInputObject = value; }
        ...
        [global::System.Management.Automation.Alias("IntegrationFabricName")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.ParameterCategory.Path)]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The new integration scenarios covered by this integration fabric.")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] Scenario { get => _requestBodyParametersBody.Scenario?.ToArray() ?? null /* fixedArrayOf */; set => _requestBodyParametersBody.Scenario = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The new tags of the Integration Fabric resource.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IIntegrationFabricUpdateParametersTags Tag { get => _requestBodyParametersBody.Tag ?? null /* object */; set => _requestBodyParametersBody.Tag = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IIntegrationFabric">Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IIntegrationFabric</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IIntegrationFabric> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzGrafanaIntegrationFabric_UpdateViaIdentityGrafanaExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Cmdlets.UpdateAzGrafanaIntegrationFabric_UpdateViaIdentityGrafanaExpanded Clone()
        {
            var clone = new UpdateAzGrafanaIntegrationFabric_UpdateViaIdentityGrafanaExpanded();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'IntegrationFabricsUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (GrafanaInputObject?.Id != null)
                    {
                        this.GrafanaInputObject.Id += $"/integrationFabrics/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.IntegrationFabricsUpdateViaIdentity(GrafanaInputObject.Id, _requestBodyParametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == GrafanaInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("GrafanaInputObject has null value for GrafanaInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, GrafanaInputObject) );
                        }
                        if (null == GrafanaInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("GrafanaInputObject has null value for GrafanaInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, GrafanaInputObject) );
                        }
                        if (null == GrafanaInputObject.WorkspaceName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("GrafanaInputObject has null value for GrafanaInputObject.WorkspaceName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, GrafanaInputObject) );
                        }
                        await this.Client.IntegrationFabricsUpdate(GrafanaInputObject.SubscriptionId ?? null, GrafanaInputObject.ResourceGroupName ?? null, GrafanaInputObject.WorkspaceName ?? null, Name, _requestBodyParametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzGrafanaIntegrationFabric_UpdateViaIdentityGrafanaExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzGrafanaIntegrationFabric_UpdateViaIdentityGrafanaExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IIntegrationFabric> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IIntegrationFabric
