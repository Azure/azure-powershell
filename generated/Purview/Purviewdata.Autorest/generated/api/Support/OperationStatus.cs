...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Support.OperationStatus Accepted = @"Accepted";

        public static Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Support.OperationStatus Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Support.OperationStatus Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Support.OperationStatus InProgress = @"InProgress";

        public static Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Support.OperationStatus Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Support.OperationStatus TransientFailure = @"TransientFailure";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Support.OperationStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Support.OperationStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Support.OperationStatus e1, Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Support.OperationStatus e2)
        {
            return !e2.Equals(e1);
        }
