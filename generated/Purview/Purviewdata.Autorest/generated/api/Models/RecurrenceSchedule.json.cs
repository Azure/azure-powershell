...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models
{
    ...
    public partial class RecurrenceSchedule
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IRecurrenceSchedule.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IRecurrenceSchedule.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IRecurrenceSchedule FromJson(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNode node)
        {
        ...
        internal RecurrenceSchedule(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject json)
        {
            ...
            {_additionalProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("additionalProperties"), out var __jsonAdditionalProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.RecurrenceScheduleAdditionalProperties.FromJson(__jsonAdditionalProperties) : _additionalProperty;}
            {_minute = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonArray>("minutes"), out var __jsonMinutes) ? If( __jsonMinutes as Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<int>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(int) (__u is Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNumber __t ? (int)__t : default(int))) ))() : null : _minute;}
            {_hour = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonArray>("hours"), out var __jsonHours) ? If( __jsonHours as Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<int>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(int) (__p is Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNumber __o ? (int)__o : default(int))) ))() : null : _hour;}
            {_weekDay = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonArray>("weekDays"), out var __jsonWeekDays) ? If( __jsonWeekDays as Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(string) (__k is Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonString __j ? (string)(__j.ToString()) : null)) ))() : null : _weekDay;}
            {_monthDay = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonArray>("monthDays"), out var __jsonMonthDays) ? If( __jsonMonthDays as Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<System.Collections.Generic.List<int>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__g, (__f)=>(int) (__f is Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNumber __e ? (int)__e : default(int))) ))() : null : _monthDay;}
            {_monthlyOccurrence = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonArray>("monthlyOccurrences"), out var __jsonMonthlyOccurrences) ? If( __jsonMonthlyOccurrences as Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonArray, out var __b) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IRecurrenceScheduleOccurrence>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__b, (__a)=>(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IRecurrenceScheduleOccurrence) (Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.RecurrenceScheduleOccurrence.FromJson(__a) )) ))() : null : _monthlyOccurrence;}
            AfterFromJson(json);
        }
