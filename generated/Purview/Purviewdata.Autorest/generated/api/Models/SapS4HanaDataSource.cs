...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models
{
    ...
    public partial class SapS4HanaDataSource :
        Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ISapS4HanaDataSource,
        Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ISapS4HanaDataSourceInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.IValidates
    {
        ...
        public string ApplicationServer { get => ((Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ISapS4HanaPropertiesInternal)Property).ApplicationServer; set => ((Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ISapS4HanaPropertiesInternal)Property).ApplicationServer = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Origin(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.PropertyOrigin.Inherited)]
        public string Kind { get => "SapS4Hana"; set => ((Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IDataSourceInternal)__dataSource).Kind = "SapS4Hana"; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ISapS4HanaDataSourceProperties Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ISapS4HanaDataSourceInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.SapS4HanaDataSourceProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ISapS4HanaDataSourceProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ISapS4HanaDataSourceProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.SapS4HanaDataSourceProperties()); set => this._property = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Origin(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.PropertyOrigin.Inlined)]
        public string SystemNumber { get => ((Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ISapS4HanaPropertiesInternal)Property).SystemNumber; set => ((Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ISapS4HanaPropertiesInternal)Property).SystemNumber = value ?? null; }

        /// <summary>Creates an new <see cref="SapS4HanaDataSource" /> instance.</summary>
        public SapS4HanaDataSource()
        {
            this.__dataSource.Kind = "SapS4Hana";
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IDataSourceInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ISapS4HanaDataSourceProperties Property { get; set; }
