...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models
{
    ...
    public partial class ExpandingResourceScanPropertiesResourceTypes
    {
        ...
        internal ExpandingResourceScanPropertiesResourceTypes(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject json)
        {
            ...
            {_none = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("None"), out var __jsonNone) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonNone) : _none;}
            {_azureSubscription = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AzureSubscription"), out var __jsonAzureSubscription) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAzureSubscription) : _azureSubscription;}
            {_azureResourceGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AzureResourceGroup"), out var __jsonAzureResourceGroup) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAzureResourceGroup) : _azureResourceGroup;}
            {_azureSynapseWorkspace = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AzureSynapseWorkspace"), out var __jsonAzureSynapseWorkspace) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAzureSynapseWorkspace) : _azureSynapseWorkspace;}
            {_azureSynapse = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AzureSynapse"), out var __jsonAzureSynapse) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAzureSynapse) : _azureSynapse;}
            {_adlsGen1 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AdlsGen1"), out var __jsonAdlsGen1) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAdlsGen1) : _adlsGen1;}
            {_adlsGen2 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AdlsGen2"), out var __jsonAdlsGen2) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAdlsGen2) : _adlsGen2;}
            {_amazonAccount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AmazonAccount"), out var __jsonAmazonAccount) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAmazonAccount) : _amazonAccount;}
            {_amazonS3 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AmazonS3"), out var __jsonAmazonS3) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAmazonS3) : _amazonS3;}
            {_amazonSql = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AmazonSql"), out var __jsonAmazonSql) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAmazonSql) : _amazonSql;}
            {_azureCosmosDb = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AzureCosmosDb"), out var __jsonAzureCosmosDb) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAzureCosmosDb) : _azureCosmosDb;}
            {_azureDataExplorer = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AzureDataExplorer"), out var __jsonAzureDataExplorer) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAzureDataExplorer) : _azureDataExplorer;}
            {_azureFileService = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AzureFileService"), out var __jsonAzureFileService) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAzureFileService) : _azureFileService;}
            {_azureSqlDatabase = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AzureSqlDatabase"), out var __jsonAzureSqlDatabase) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAzureSqlDatabase) : _azureSqlDatabase;}
            {_amazonPostgreSql = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AmazonPostgreSql"), out var __jsonAmazonPostgreSql) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAmazonPostgreSql) : _amazonPostgreSql;}
            {_azurePostgreSql = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AzurePostgreSql"), out var __jsonAzurePostgreSql) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAzurePostgreSql) : _azurePostgreSql;}
            {_sqlServerDatabase = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("SqlServerDatabase"), out var __jsonSqlServerDatabase) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonSqlServerDatabase) : _sqlServerDatabase;}
            {_azureSqlDatabaseManagedInstance = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AzureSqlDatabaseManagedInstance"), out var __jsonAzureSqlDatabaseManagedInstance) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAzureSqlDatabaseManagedInstance) : _azureSqlDatabaseManagedInstance;}
            {_azureSqlDataWarehouse = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AzureSqlDataWarehouse"), out var __jsonAzureSqlDataWarehouse) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAzureSqlDataWarehouse) : _azureSqlDataWarehouse;}
            {_azureMySql = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AzureMySql"), out var __jsonAzureMySql) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAzureMySql) : _azureMySql;}
            {_azureStorage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("AzureStorage"), out var __jsonAzureStorage) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonAzureStorage) : _azureStorage;}
            {_teradata = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("Teradata"), out var __jsonTeradata) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonTeradata) : _teradata;}
            {_oracle = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("Oracle"), out var __jsonOracle) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonOracle) : _oracle;}
            {_sapS4Hana = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("SapS4Hana"), out var __jsonSapS4Hana) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonSapS4Hana) : _sapS4Hana;}
            {_sapEcc = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("SapEcc"), out var __jsonSapEcc) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonSapEcc) : _sapEcc;}
            {_powerBi = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("PowerBI"), out var __jsonPowerBi) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ResourceTypeFilter.FromJson(__jsonPowerBi) : _powerBi;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IExpandingResourceScanPropertiesResourceTypes.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IExpandingResourceScanPropertiesResourceTypes.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IExpandingResourceScanPropertiesResourceTypes FromJson(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNode node)
        {
