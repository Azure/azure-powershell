...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models
{
    ...
    public partial class ScanResult
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IScanResult.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IScanResult.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IScanResult FromJson(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNode node)
        {
        ...
        internal ScanResult(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject json)
        {
            ...
            {_diagnostic = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("diagnostics"), out var __jsonDiagnostics) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ScanResultDiagnostics.FromJson(__jsonDiagnostics) : _diagnostic;}
            {_error = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("error"), out var __jsonError) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ScanResultError.FromJson(__jsonError) : _error;}
            {_parentId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonString>("parentId"), out var __jsonParentId) ? (string)__jsonParentId : (string)_parentId;}
            ...
            {_resourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonString>("resourceId"), out var __jsonResourceId) ? (string)__jsonResourceId : (string)_resourceId;}
            ...
            {_assetsDiscovered = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNumber>("assetsDiscovered"), out var __jsonAssetsDiscovered) ? (long?)__jsonAssetsDiscovered : _assetsDiscovered;}
            {_assetsClassified = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNumber>("assetsClassified"), out var __jsonAssetsClassified) ? (long?)__jsonAssetsClassified : _assetsClassified;}
            ...
            {_scanRulesetVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNumber>("scanRulesetVersion"), out var __jsonScanRulesetVersion) ? (int?)__jsonScanRulesetVersion : _scanRulesetVersion;}
            ...
            {_scanLevelType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonString>("scanLevelType"), out var __jsonScanLevelType) ? (string)__jsonScanLevelType : (string)_scanLevelType;}
            {_errorMessage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonString>("errorMessage"), out var __jsonErrorMessage) ? (string)__jsonErrorMessage : (string)_errorMessage;}
            {_runType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonString>("runType"), out var __jsonRunType) ? (string)__jsonRunType : (string)_runType;}
