...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RunScan=>PUT:"/datasources/{dataSourceName}/scans/{scanName}/runs/{runId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzPurviewScanResultScan_Run", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Description(@"Runs the scan")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.HttpPath(Path = "/datasources/{dataSourceName}/scans/{scanName}/runs/{runId}", ApiVersion = "2021-10-01-preview")]
    public partial class StartAzPurviewScanResultScan_Run : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Support.ScanLevelType))]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ScanResultRunScan' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ScanResultRunScan(Endpoint, DataSourceName, ScanName, RunId, this.InvocationInformation.BoundParameters.ContainsKey("ScanLevel") ? ScanLevel : null, onAccepted, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Endpoint=Endpoint,DataSourceName=DataSourceName,ScanName=ScanName,RunId=RunId,ScanLevel=this.InvocationInformation.BoundParameters.ContainsKey("ScanLevel") ? ScanLevel : null})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzPurviewScanResultScan_Run" /> cmdlet class.
        /// </summary>
        public StartAzPurviewScanResultScan_Run()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.Api20211001Preview.IErrorResponseModel> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Endpoint=Endpoint, DataSourceName=DataSourceName, ScanName=ScanName, RunId=RunId, ScanLevel=this.InvocationInformation.BoundParameters.ContainsKey("ScanLevel") ? ScanLevel : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Endpoint=Endpoint, DataSourceName=DataSourceName, ScanName=ScanName, RunId=RunId, ScanLevel=this.InvocationInformation.BoundParameters.ContainsKey("ScanLevel") ? ScanLevel : null })
                    {
