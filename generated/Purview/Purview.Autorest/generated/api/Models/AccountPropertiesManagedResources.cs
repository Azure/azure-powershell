...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purview.Models
{
    ...
    public partial class AccountPropertiesManagedResources :
        Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IAccountPropertiesManagedResources,
        Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IAccountPropertiesManagedResourcesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IManagedResources" />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IManagedResources __managedResources = new Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.ManagedResources();
        ...
        public string EventHubNamespace { get => ((Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IManagedResourcesInternal)__managedResources).EventHubNamespace; }

        /// <summary>Internal Acessors for EventHubNamespace</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IManagedResourcesInternal.EventHubNamespace { get => ((Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IManagedResourcesInternal)__managedResources).EventHubNamespace; set => ((Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IManagedResourcesInternal)__managedResources).EventHubNamespace = value ?? null; }

        /// <summary>Internal Acessors for ResourceGroup</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IManagedResourcesInternal.ResourceGroup { get => ((Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IManagedResourcesInternal)__managedResources).ResourceGroup; set => ((Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IManagedResourcesInternal)__managedResources).ResourceGroup = value ?? null; }

        /// <summary>Internal Acessors for StorageAccount</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IManagedResourcesInternal.StorageAccount { get => ((Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IManagedResourcesInternal)__managedResources).StorageAccount; set => ((Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IManagedResourcesInternal)__managedResources).StorageAccount = value ?? null; }

        /// <summary>
        /// Gets the managed resource group resource identifier. This resource group will host resource dependencies for the account.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Purview.Origin(Microsoft.Azure.PowerShell.Cmdlets.Purview.PropertyOrigin.Inherited)]
        public string ResourceGroup { get => ((Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IManagedResourcesInternal)__managedResources).ResourceGroup; }

        /// <summary>Gets the managed storage account resource identifier.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Purview.Origin(Microsoft.Azure.PowerShell.Cmdlets.Purview.PropertyOrigin.Inherited)]
        public string StorageAccount { get => ((Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IManagedResourcesInternal)__managedResources).StorageAccount; }
