...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purview.Models
{
    ...
    public partial class OperationMetaServiceSpecification
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IOperationMetaServiceSpecification.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IOperationMetaServiceSpecification.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IOperationMetaServiceSpecification FromJson(Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode node)
        {
        ...
        internal OperationMetaServiceSpecification(Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonObject json)
        {
            ...
            {_logSpecification = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonArray>("logSpecifications"), out var __jsonLogSpecifications) ? If( __jsonLogSpecifications as Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IOperationMetaLogSpecification>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IOperationMetaLogSpecification) (Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.OperationMetaLogSpecification.FromJson(__u) )) ))() : null : _logSpecification;}
            {_metricSpecification = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonArray>("metricSpecifications"), out var __jsonMetricSpecifications) ? If( __jsonMetricSpecifications as Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IOperationMetaMetricSpecification>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IOperationMetaMetricSpecification) (Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.OperationMetaMetricSpecification.FromJson(__p) )) ))() : null : _metricSpecification;}
            AfterFromJson(json);
        }
