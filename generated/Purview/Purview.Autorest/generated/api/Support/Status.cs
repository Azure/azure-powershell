...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purview.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.Status Approved = @"Approved";

        public static Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.Status Disconnected = @"Disconnected";

        public static Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.Status Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.Status Rejected = @"Rejected";

        public static Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.Status Unknown = @"Unknown";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
