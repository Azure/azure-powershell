...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purview.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzPurviewDefaultAccount_Remove" /> cmdlet class.
        /// </summary>
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.IErrorResponseModel> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ScopeTenantId=ScopeTenantId, ScopeType=ScopeType, Scope=this.InvocationInformation.BoundParameters.ContainsKey("Scope") ? Scope : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ScopeTenantId=ScopeTenantId, ScopeType=ScopeType, Scope=this.InvocationInformation.BoundParameters.ContainsKey("Scope") ? Scope : null })
                    {
