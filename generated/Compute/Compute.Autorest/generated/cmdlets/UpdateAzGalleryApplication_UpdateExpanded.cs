...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/applications/{galleryApplicationName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzGalleryApplication_UpdateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Compute.Description(@"update a gallery Application Definition.")]
    ...
    public partial class UpdateAzGalleryApplication_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.IContext
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryApplicationUpdate _galleryApplicationBody = new Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.GalleryApplicationUpdate();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the Shared Application Gallery in which the Application Definition is to be updated.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// The name of the gallery Application Definition to be updated. The allowed characters are alphabets and numbers with dots,
        /// dashes, and periods allowed in the middle. The maximum length is 80 characters.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the gallery Application Definition to be updated. The allowed characters are alphabets and numbers with dots, dashes, and periods allowed in the middle. The maximum length is 80 characters.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IUpdateResourceDefinitionTags Tag { get => _galleryApplicationBody.Tag ?? null /* object */; set => _galleryApplicationBody.Tag = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzGalleryApplication_UpdateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Cmdlets.UpdateAzGalleryApplication_UpdateExpanded Clone()
        {
            var clone = new UpdateAzGalleryApplication_UpdateExpanded();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'GalleryApplicationsUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("SupportedOSType"))
                {
                    SupportedOSType = (string)this.MyInvocation.BoundParameters["SupportedOSType"];
                }
                try
                {
                    ...
                    await this.Client.GalleryApplicationsUpdate(SubscriptionId, ResourceGroupName, GalleryName, Name, _galleryApplicationBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.SerializationMode.IncludeUpdate);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,GalleryName=GalleryName,Name=Name})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzGalleryApplication_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzGalleryApplication_UpdateExpanded()
        {
