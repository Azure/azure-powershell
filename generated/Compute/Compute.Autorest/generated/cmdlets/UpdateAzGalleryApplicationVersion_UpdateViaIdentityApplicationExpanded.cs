...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Cmdlets
{
    ...
    using Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Cmdlets;
    using System;
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzGalleryApplicationVersion_UpdateViaIdentityApplicationExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryApplicationVersion))]
    ...
    public partial class UpdateAzGalleryApplicationVersion_UpdateViaIdentityApplicationExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.IEventListener,
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.IContext
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryApplicationVersionUpdate _galleryApplicationVersionBody = new Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.GalleryApplicationVersionUpdate();

        /// <summary>Backing field for <see cref="ApplicationInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IComputeIdentity _applicationInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IComputeIdentity ApplicationInputObject { get => this._applicationInputObject; set => this._applicationInputObject = value; }
        ...
        /// <summary>
        /// The name of the gallery Application Version to be updated. Needs to follow semantic version name pattern: The allowed
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the gallery Application Version to be updated. Needs to follow semantic version name pattern: The allowed characters are digit and period. Digits must be within the range of a 32-bit integer. Format: <MajorVersion>.<MinorVersion>.<Patch>")]
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.HttpPipeline Pipeline { get; set; }
        ...
        public string PublishingProfileReplicationMode { get => _galleryApplicationVersionBody.PublishingProfileReplicationMode ?? null; set => _galleryApplicationVersionBody.PublishingProfileReplicationMode = value; }
        ...
        public string PublishingProfileStorageAccountType { get => _galleryApplicationVersionBody.PublishingProfileStorageAccountType ?? null; set => _galleryApplicationVersionBody.PublishingProfileStorageAccountType = value; }
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.Compute.DoNotExport]
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryTargetExtendedLocation[] PublishingProfileTargetExtendedLocation { get => _galleryApplicationVersionBody.PublishingProfileTargetExtendedLocation?.ToArray() ?? null /* fixedArrayOf */; set => _galleryApplicationVersionBody.PublishingProfileTargetExtendedLocation = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryTargetExtendedLocation>(value) : null); }
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IUpdateResourceDefinitionTags) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IUpdateResourceDefinitionTags Tag { get => _galleryApplicationVersionBody.Tag ?? null /* object */; set => _galleryApplicationVersionBody.Tag = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.ITargetRegion[] TargetRegion { get => _galleryApplicationVersionBody.TargetRegion?.ToArray() ?? null /* fixedArrayOf */; set => _galleryApplicationVersionBody.TargetRegion = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.ITargetRegion>(value) : null); }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.ICloudError">Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.ICloudError</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.ICloudError> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryApplicationVersion">Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryApplicationVersion</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryApplicationVersion> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzGalleryApplicationVersion_UpdateViaIdentityApplicationExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Cmdlets.UpdateAzGalleryApplicationVersion_UpdateViaIdentityApplicationExpanded Clone()
        {
            var clone = new UpdateAzGalleryApplicationVersion_UpdateViaIdentityApplicationExpanded();
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Events.Progress:
                    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                Pipeline = Microsoft.Azure.PowerShell.Cmdlets.Compute.Module.Instance.CreatePipeline(InvocationInformation, __correlationId, __processRecordId, this.ParameterSetName, this.ExtensibleParameters);
                ...
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("PublishingProfileReplicationMode"))
                {
                    PublishingProfileReplicationMode = (string)this.MyInvocation.BoundParameters["PublishingProfileReplicationMode"];
                }
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("PublishingProfileStorageAccountType"))
                {
                    PublishingProfileStorageAccountType = (string)this.MyInvocation.BoundParameters["PublishingProfileStorageAccountType"];
                }
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("PublishingProfileTargetExtendedLocation"))
                {
                    PublishingProfileTargetExtendedLocation = (Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryTargetExtendedLocation[])this.MyInvocation.BoundParameters["PublishingProfileTargetExtendedLocation"];
                }
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("PublishingProfileAdvancedSetting"))
                {
                    PublishingProfileAdvancedSetting = (Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryApplicationVersionPublishingProfileAdvancedSettings)this.MyInvocation.BoundParameters["PublishingProfileAdvancedSetting"];
                }
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("PublishingProfileEnableHealthCheck"))
                {
                    PublishingProfileEnableHealthCheck = (global::System.Management.Automation.SwitchParameter)this.MyInvocation.BoundParameters["PublishingProfileEnableHealthCheck"];
                }
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("Install"))
                {
                    Install = (string)this.MyInvocation.BoundParameters["Install"];
                }
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("Remove"))
                {
                    Remove = (string)this.MyInvocation.BoundParameters["Remove"];
                }
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("Update"))
                {
                    Update = (string)this.MyInvocation.BoundParameters["Update"];
                }
                try
                {
                    ...
                    if (ApplicationInputObject?.Id != null)
                    {
                        this.ApplicationInputObject.Id += $"/versions/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.GalleryApplicationVersionsUpdateViaIdentity(ApplicationInputObject.Id, _galleryApplicationVersionBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == ApplicationInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ApplicationInputObject has null value for ApplicationInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ApplicationInputObject) );
                        }
                        if (null == ApplicationInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ApplicationInputObject has null value for ApplicationInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ApplicationInputObject) );
                        }
                        if (null == ApplicationInputObject.GalleryName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ApplicationInputObject has null value for ApplicationInputObject.GalleryName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ApplicationInputObject) );
                        }
                        if (null == ApplicationInputObject.GalleryApplicationName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ApplicationInputObject has null value for ApplicationInputObject.GalleryApplicationName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ApplicationInputObject) );
                        }
                        await this.Client.GalleryApplicationVersionsUpdate(ApplicationInputObject.SubscriptionId ?? null, ApplicationInputObject.ResourceGroupName ?? null, ApplicationInputObject.GalleryName ?? null, ApplicationInputObject.GalleryApplicationName ?? null, Name, _galleryApplicationVersionBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzGalleryApplicationVersion_UpdateViaIdentityApplicationExpanded" />
        /// cmdlet class.
        /// </summary>
        public UpdateAzGalleryApplicationVersion_UpdateViaIdentityApplicationExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.ICloudError>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryApplicationVersion> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryApplicationVersion
