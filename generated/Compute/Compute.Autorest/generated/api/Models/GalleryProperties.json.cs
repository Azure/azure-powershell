...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models
{
    ...
    public partial class GalleryProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode node)
        {
        ...
        internal GalleryProperties(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject json)
        {
            ...
            {_identifier = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("identifier"), out var __jsonIdentifier) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.GalleryIdentifier.FromJson(__jsonIdentifier) : _identifier;}
            {_sharingProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("sharingProfile"), out var __jsonSharingProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.SharingProfile.FromJson(__jsonSharingProfile) : _sharingProfile;}
            {_softDeletePolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("softDeletePolicy"), out var __jsonSoftDeletePolicy) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.SoftDeletePolicy.FromJson(__jsonSoftDeletePolicy) : _softDeletePolicy;}
            {_sharingStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("sharingStatus"), out var __jsonSharingStatus) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.SharingStatus.FromJson(__jsonSharingStatus) : _sharingStatus;}
