...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models
{
    ...
    public partial class RegionalReplicationStatus :
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IRegionalReplicationStatus,
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IRegionalReplicationStatusInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IRegionalReplicationStatusInternal.Detail { get => this._detail; set { {_detail = value;} } }

        /// <summary>Internal Acessors for Progress</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IRegionalReplicationStatusInternal.Progress { get => this._progress; set { {_progress = value;} } }

        /// <summary>Internal Acessors for Region</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IRegionalReplicationStatusInternal.Region { get => this._region; set { {_region = value;} } }

        /// <summary>Internal Acessors for State</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IRegionalReplicationStatusInternal.State { get => this._state; set { {_state = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Compute.PSArgumentCompleterAttribute("Unknown", "Replicating", "Completed", "Failed")]
        string State { get;  }
