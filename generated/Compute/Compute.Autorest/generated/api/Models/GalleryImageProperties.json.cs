...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models
{
    ...
    public partial class GalleryImageProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryImageProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryImageProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryImageProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode node)
        {
        ...
        internal GalleryImageProperties(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject json)
        {
            ...
            {_identifier = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("identifier"), out var __jsonIdentifier) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.GalleryImageIdentifier.FromJson(__jsonIdentifier) : _identifier;}
            {_recommended = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("recommended"), out var __jsonRecommended) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.RecommendedMachineConfiguration.FromJson(__jsonRecommended) : _recommended;}
            {_disallowed = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("disallowed"), out var __jsonDisallowed) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Disallowed.FromJson(__jsonDisallowed) : _disallowed;}
            {_purchasePlan = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("purchasePlan"), out var __jsonPurchasePlan) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.ImagePurchasePlan.FromJson(__jsonPurchasePlan) : _purchasePlan;}
            {_description = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonString>("description"), out var __jsonDescription) ? (string)__jsonDescription : (string)_description;}
            ...
            {_privacyStatementUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonString>("privacyStatementUri"), out var __jsonPrivacyStatementUri) ? (string)__jsonPrivacyStatementUri : (string)_privacyStatementUri;}
            {_releaseNoteUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonString>("releaseNoteUri"), out var __jsonReleaseNoteUri) ? (string)__jsonReleaseNoteUri : (string)_releaseNoteUri;}
            {_oSType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonString>("osType"), out var __jsonOSType) ? (string)__jsonOSType : (string)_oSType;}
            {_oSState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonString>("osState"), out var __jsonOSState) ? (string)__jsonOSState : (string)_oSState;}
            {_hyperVGeneration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonString>("hyperVGeneration"), out var __jsonHyperVGeneration) ? (string)__jsonHyperVGeneration : (string)_hyperVGeneration;}
            ...
            {_feature = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonArray>("features"), out var __jsonFeatures) ? If( __jsonFeatures as Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryImageFeature>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryImageFeature) (Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.GalleryImageFeature.FromJson(__u) )) ))() : null : _feature;}
            {_architecture = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonString>("architecture"), out var __jsonArchitecture) ? (string)__jsonArchitecture : (string)_architecture;}
            AfterFromJson(json);
        }
