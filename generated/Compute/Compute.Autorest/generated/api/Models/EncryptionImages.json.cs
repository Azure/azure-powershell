...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models
{
    ...
    public partial class EncryptionImages
    {
        ...
        internal EncryptionImages(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject json)
        {
            ...
            {_oSDiskImage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("osDiskImage"), out var __jsonOSDiskImage) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.OSDiskImageEncryption.FromJson(__jsonOSDiskImage) : _oSDiskImage;}
            {_dataDiskImage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonArray>("dataDiskImages"), out var __jsonDataDiskImages) ? If( __jsonDataDiskImages as Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IDataDiskImageEncryption>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IDataDiskImageEncryption) (Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.DataDiskImageEncryption.FromJson(__u) )) ))() : null : _dataDiskImage;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IEncryptionImages.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IEncryptionImages.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IEncryptionImages FromJson(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode node)
        {
