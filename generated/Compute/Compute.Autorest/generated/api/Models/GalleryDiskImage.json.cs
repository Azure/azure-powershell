...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models
{
    ...
    public partial class GalleryDiskImage
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryDiskImage.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryDiskImage.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryDiskImage FromJson(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject json ? new GalleryDiskImage(json) : null;
        }
        ...
        internal GalleryDiskImage(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject json)
        {
            ...
            {_source = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("source"), out var __jsonSource) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.GalleryArtifactVersionSource.FromJson(__jsonSource) : _source;}
            {_sizeInGb = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNumber>("sizeInGB"), out var __jsonSizeInGb) ? (int?)__jsonSizeInGb : _sizeInGb;}
            {_hostCaching = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonString>("hostCaching"), out var __jsonHostCaching) ? (string)__jsonHostCaching : (string)_hostCaching;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="GalleryDiskImage" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="GalleryDiskImage" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != this._sizeInGb ? (Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNumber((int)this._sizeInGb) : null, "sizeInGB" ,container.Add );
            }
            AddIf( null != (((object)this._hostCaching)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonString(this._hostCaching.ToString()) : null, "hostCaching" ,container.Add );
