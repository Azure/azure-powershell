...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220103
{
    ...
    public partial class RecommendedMachineConfiguration
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220103.IRecommendedMachineConfiguration.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220103.IRecommendedMachineConfiguration.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220103.IRecommendedMachineConfiguration FromJson(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode node)
        {
        ...
        internal RecommendedMachineConfiguration(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject json)
        {
            ...
            {_vCpUs = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("vCPUs"), out var __jsonVCpUs) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220103.ResourceRange.FromJson(__jsonVCpUs) : VCpUs;}
            {_memory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("memory"), out var __jsonMemory) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220103.ResourceRange.FromJson(__jsonMemory) : Memory;}
            AfterFromJson(json);
        }
