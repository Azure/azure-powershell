...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models
{
    ...
    public partial class CommunityGalleryInfo :
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.ICommunityGalleryInfo,
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.ICommunityGalleryInfoInternal
    {
        ...
        bool? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.ICommunityGalleryInfoInternal.CommunityGalleryEnabled { get => this._communityGalleryEnabled; set { {_communityGalleryEnabled = value;} } }

        /// <summary>Internal Acessors for PublicName</summary>
        System.Collections.Generic.List<string> Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.ICommunityGalleryInfoInternal.PublicName { get => this._publicName; set { {_publicName = value;} } }

        /// <summary>Backing field for <see cref="PublicName" /> property.</summary>
        private System.Collections.Generic.List<string> _publicName;

        /// <summary>Community gallery public name list.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Origin(Microsoft.Azure.PowerShell.Cmdlets.Compute.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> PublicName { get => this._publicName; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> PublicName { get;  }
        /// <summary>
        /// The prefix of the gallery name that will be displayed publicly. Visible to all users.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Info(
...

    {
        ...
        string Eula { get; set; }
        /// <summary>Community gallery public name list.</summary>
        System.Collections.Generic.List<string> PublicName { get; set; }
        /// <summary>
        /// The prefix of the gallery name that will be displayed publicly. Visible to all users.
        /// </summary>
        string PublicNamePrefix { get; set; }
