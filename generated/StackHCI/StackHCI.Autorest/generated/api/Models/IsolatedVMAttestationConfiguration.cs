...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models
{
    ...
    public partial class IsolatedVMAttestationConfiguration :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IIsolatedVMAttestationConfigurationInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IIsolatedVMAttestationConfigurationInternal.AttestationResourceId { get => this._attestationResourceId; set { {_attestationResourceId = value;} } }

        /// <summary>Internal Acessors for AttestationServiceEndpoint</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IIsolatedVMAttestationConfigurationInternal.AttestationServiceEndpoint { get => this._attestationServiceEndpoint; set { {_attestationServiceEndpoint = value;} } }

        /// <summary>Internal Acessors for RelyingPartyServiceEndpoint</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IIsolatedVMAttestationConfigurationInternal.RelyingPartyServiceEndpoint { get => this._relyingPartyServiceEndpoint; set { {_relyingPartyServiceEndpoint = value;} } }
