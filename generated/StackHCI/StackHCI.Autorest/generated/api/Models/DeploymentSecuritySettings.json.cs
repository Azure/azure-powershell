...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models
{
    ...
    public partial class DeploymentSecuritySettings
    {
        ...
        internal DeploymentSecuritySettings(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonObject json)
        {
            ...
            {_hvciProtection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonBoolean>("hvciProtection"), out var __jsonHvciProtection) ? (bool?)__jsonHvciProtection : _hvciProtection;}
            {_drtmProtection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonBoolean>("drtmProtection"), out var __jsonDrtmProtection) ? (bool?)__jsonDrtmProtection : _drtmProtection;}
            {_driftControlEnforced = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonBoolean>("driftControlEnforced"), out var __jsonDriftControlEnforced) ? (bool?)__jsonDriftControlEnforced : _driftControlEnforced;}
            {_credentialGuardEnforced = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonBoolean>("credentialGuardEnforced"), out var __jsonCredentialGuardEnforced) ? (bool?)__jsonCredentialGuardEnforced : _credentialGuardEnforced;}
            {_smbSigningEnforced = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonBoolean>("smbSigningEnforced"), out var __jsonSmbSigningEnforced) ? (bool?)__jsonSmbSigningEnforced : _smbSigningEnforced;}
            {_smbClusterEncryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonBoolean>("smbClusterEncryption"), out var __jsonSmbClusterEncryption) ? (bool?)__jsonSmbClusterEncryption : _smbClusterEncryption;}
            {_sideChannelMitigationEnforced = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonBoolean>("sideChannelMitigationEnforced"), out var __jsonSideChannelMitigationEnforced) ? (bool?)__jsonSideChannelMitigationEnforced : _sideChannelMitigationEnforced;}
            {_bitlockerBootVolume = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonBoolean>("bitlockerBootVolume"), out var __jsonBitlockerBootVolume) ? (bool?)__jsonBitlockerBootVolume : _bitlockerBootVolume;}
            {_bitlockerDataVolume = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonBoolean>("bitlockerDataVolumes"), out var __jsonBitlockerDataVolumes) ? (bool?)__jsonBitlockerDataVolumes : _bitlockerDataVolume;}
            {_wdacEnforced = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonBoolean>("wdacEnforced"), out var __jsonWdacEnforced) ? (bool?)__jsonWdacEnforced : _wdacEnforced;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IDeploymentSecuritySettings.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IDeploymentSecuritySettings.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IDeploymentSecuritySettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonNode node)
        {
