...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models
{
    ...
    public partial class LogCollectionSession
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.ILogCollectionSession.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.ILogCollectionSession.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.ILogCollectionSession FromJson(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonNode node)
        {
        ...
        internal LogCollectionSession(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonObject json)
        {
            ...
            {_logCollectionError = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonObject>("logCollectionError"), out var __jsonLogCollectionError) ? Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.LogCollectionError.FromJson(__jsonLogCollectionError) : _logCollectionError;}
            {_logStartTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("logStartTime"), out var __jsonLogStartTime) ? global::System.DateTime.TryParse((string)__jsonLogStartTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonLogStartTimeValue) ? __jsonLogStartTimeValue : _logStartTime : _logStartTime;}
            {_logEndTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("logEndTime"), out var __jsonLogEndTime) ? global::System.DateTime.TryParse((string)__jsonLogEndTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonLogEndTimeValue) ? __jsonLogEndTimeValue : _logEndTime : _logEndTime;}
            {_timeCollected = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("timeCollected"), out var __jsonTimeCollected) ? global::System.DateTime.TryParse((string)__jsonTimeCollected, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonTimeCollectedValue) ? __jsonTimeCollectedValue : _timeCollected : _timeCollected;}
            {_logSize = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonNumber>("logSize"), out var __jsonLogSize) ? (long?)__jsonLogSize : _logSize;}
            {_logCollectionStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("logCollectionStatus"), out var __jsonLogCollectionStatus) ? (string)__jsonLogCollectionStatus : (string)_logCollectionStatus;}
            {_correlationId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("correlationId"), out var __jsonCorrelationId) ? (string)__jsonCorrelationId : (string)_correlationId;}
