...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models
{
    ...
    public partial class EdgeDevice
    {
        ...
        internal EdgeDevice(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonObject json)
        {
            ...
            __proxyResource = new Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.ProxyResource(json);
            {_kind = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("kind"), out var __jsonKind) ? (string)__jsonKind : (string)_kind;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IEdgeDevice.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IEdgeDevice interface is polymorphic, and the precise model
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IEdgeDevice.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IEdgeDevice FromJson(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonNode node)
        {
