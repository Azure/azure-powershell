...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models
{
    ...
    public partial class SwitchDetail :
        Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.ISwitchDetail,
        Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.ISwitchDetailInternal
    {

        /// <summary>Backing field for <see cref="Extension" /> property.</summary>
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.ISwitchExtension> _extension;
        ...
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.ISwitchExtension> Extension { get => this._extension; }

        /// <summary>Internal Acessors for Extension</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.ISwitchExtension> Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.ISwitchDetailInternal.Extension { get => this._extension; set { {_extension = value;} } }

        /// <summary>Internal Acessors for SwitchName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.ISwitchDetailInternal.SwitchName { get => this._switchName; set { {_switchName = value;} } }

        /// <summary>Internal Acessors for SwitchType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.ISwitchDetailInternal.SwitchType { get => this._switchType; set { {_switchType = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.ISwitchExtension) })]
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.ISwitchExtension> Extension { get;  }
        /// <summary>The name of the switch.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Info(
        Required = false,
        ReadOnly = true,
    ...
    {
        /// <summary>This represents extensions installed on virtualSwitch.</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.ISwitchExtension> Extension { get; set; }
        /// <summary>The name of the switch.</summary>
