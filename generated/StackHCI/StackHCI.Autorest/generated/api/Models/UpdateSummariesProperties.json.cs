...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models
{
    ...
    public partial class UpdateSummariesProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IUpdateSummariesProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IUpdateSummariesProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IUpdateSummariesProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonNode node)
        {
        ...
        internal UpdateSummariesProperties(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonObject json)
        {
            ...
            {_oemFamily = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("oemFamily"), out var __jsonOemFamily) ? (string)__jsonOemFamily : (string)_oemFamily;}
            {_hardwareModel = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("hardwareModel"), out var __jsonHardwareModel) ? (string)__jsonHardwareModel : (string)_hardwareModel;}
            {_packageVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonArray>("packageVersions"), out var __jsonPackageVersions) ? If( __jsonPackageVersions as Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IPackageVersionInfo>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IPackageVersionInfo) (Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.PackageVersionInfo.FromJson(__u) )) ))() : null : _packageVersion;}
            {_currentVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("currentVersion"), out var __jsonCurrentVersion) ? (string)__jsonCurrentVersion : (string)_currentVersion;}
            {_currentSbeVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("currentSbeVersion"), out var __jsonCurrentSbeVersion) ? (string)__jsonCurrentSbeVersion : (string)_currentSbeVersion;}
            ...
            {_healthCheckResult = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonArray>("healthCheckResult"), out var __jsonHealthCheckResult) ? If( __jsonHealthCheckResult as Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IPrecheckResult>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IPrecheckResult) (Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.PrecheckResult.FromJson(__p) )) ))() : null : _healthCheckResult;}
