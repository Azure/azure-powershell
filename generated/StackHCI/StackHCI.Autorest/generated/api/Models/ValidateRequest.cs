...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IValidateRequestInternal
    {
        ...
        private System.Collections.Generic.List<string> _edgeDeviceId;

        /// <summary>Node Ids against which, current node has to be validated.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> EdgeDeviceId { get => this._edgeDeviceId; set => this._edgeDeviceId = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> EdgeDeviceId { get; set; }
