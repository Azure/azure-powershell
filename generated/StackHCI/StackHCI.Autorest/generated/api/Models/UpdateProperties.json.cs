...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models
{
    ...
    public partial class UpdateProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IUpdateProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IUpdateProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IUpdateProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonNode node)
        {
        ...
        internal UpdateProperties(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonObject json)
        {
            ...
            {_updateStateProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonObject>("updateStateProperties"), out var __jsonUpdateStateProperties) ? Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.UpdateStateProperties.FromJson(__jsonUpdateStateProperties) : _updateStateProperty;}
            ...
            {_minSbeVersionRequired = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("minSbeVersionRequired"), out var __jsonMinSbeVersionRequired) ? (string)__jsonMinSbeVersionRequired : (string)_minSbeVersionRequired;}
            ...
            {_prerequisite = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonArray>("prerequisites"), out var __jsonPrerequisites) ? If( __jsonPrerequisites as Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IUpdatePrerequisite>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IUpdatePrerequisite) (Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.UpdatePrerequisite.FromJson(__u) )) ))() : null : _prerequisite;}
            {_componentVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonArray>("componentVersions"), out var __jsonComponentVersions) ? If( __jsonComponentVersions as Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IPackageVersionInfo>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IPackageVersionInfo) (Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.PackageVersionInfo.FromJson(__p) )) ))() : null : _componentVersion;}
            {_rebootRequired = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("rebootRequired"), out var __jsonRebootRequired) ? (string)__jsonRebootRequired : (string)_rebootRequired;}
            {_healthState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("healthState"), out var __jsonHealthState) ? (string)__jsonHealthState : (string)_healthState;}
            {_healthCheckResult = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonArray>("healthCheckResult"), out var __jsonHealthCheckResult) ? If( __jsonHealthCheckResult as Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IPrecheckResult>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IPrecheckResult) (Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.PrecheckResult.FromJson(__k) )) ))() : null : _healthCheckResult;}
            {_healthCheckDate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("healthCheckDate"), out var __jsonHealthCheckDate) ? global::System.DateTime.TryParse((string)__jsonHealthCheckDate, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonHealthCheckDateValue) ? __jsonHealthCheckDateValue : _healthCheckDate : _healthCheckDate;}
            {_packagePath = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("packagePath"), out var __jsonPackagePath) ? (string)__jsonPackagePath : (string)_packagePath;}
            {_packageSizeInMb = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonNumber>("packageSizeInMb"), out var __jsonPackageSizeInMb) ? (float?)__jsonPackageSizeInMb : _packageSizeInMb;}
            ...
            {_publisher = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("publisher"), out var __jsonPublisher) ? (string)__jsonPublisher : (string)_publisher;}
            {_releaseLink = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("releaseLink"), out var __jsonReleaseLink) ? (string)__jsonReleaseLink : (string)_releaseLink;}
            {_availabilityType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("availabilityType"), out var __jsonAvailabilityType) ? (string)__jsonAvailabilityType : (string)_availabilityType;}
            ...
            {_additionalProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Json.JsonString>("additionalProperties"), out var __jsonAdditionalProperties) ? (string)__jsonAdditionalProperties : (string)_additionalProperty;}
            AfterFromJson(json);
        }
    }
}