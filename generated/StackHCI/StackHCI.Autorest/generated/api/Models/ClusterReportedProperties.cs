...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models
{
    ...
    public partial class ClusterReportedProperties :
        Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterReportedProperties,
        Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterReportedPropertiesInternal
    {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.PropertyOrigin.Owned)]
        public string ClusterType { get => this._clusterType; }
        ...
        private string _imdsAttestation;

        /// <summary>IMDS attestation status of the cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.PropertyOrigin.Owned)]
        public string ImdsAttestation { get => this._imdsAttestation; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterReportedPropertiesInternal.ClusterId { get => this._clusterId; set { {_clusterId = value;} } }

        /// <summary>Internal Acessors for ClusterName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterReportedPropertiesInternal.ClusterName { get => this._clusterName; set { {_clusterName = value;} } }

        /// <summary>Internal Acessors for ClusterType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterReportedPropertiesInternal.ClusterType { get => this._clusterType; set { {_clusterType = value;} } }

        /// <summary>Internal Acessors for ClusterVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterReportedPropertiesInternal.ClusterVersion { get => this._clusterVersion; set { {_clusterVersion = value;} } }

        /// <summary>Internal Acessors for ImdsAttestation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterReportedPropertiesInternal.ImdsAttestation { get => this._imdsAttestation; set { {_imdsAttestation = value;} } }

        /// <summary>Internal Acessors for LastUpdated</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterReportedPropertiesInternal.LastUpdated { get => this._lastUpdated; set { {_lastUpdated = value;} } }

        /// <summary>Internal Acessors for Manufacturer</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterReportedPropertiesInternal.Manufacturer { get => this._manufacturer; set { {_manufacturer = value;} } }

        /// <summary>Internal Acessors for Node</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterNode> Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterReportedPropertiesInternal.Node { get => this._node; set { {_node = value;} } }

        /// <summary>Internal Acessors for OemActivation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterReportedPropertiesInternal.OemActivation { get => this._oemActivation; set { {_oemActivation = value;} } }

        /// <summary>Internal Acessors for SupportedCapability</summary>
        System.Collections.Generic.List<string> Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterReportedPropertiesInternal.SupportedCapability { get => this._supportedCapability; set { {_supportedCapability = value;} } }

        /// <summary>Backing field for <see cref="Node" /> property.</summary>
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterNode> _node;

        /// <summary>List of nodes reported by the cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterNode> Node { get => this._node; }
        ...
        private System.Collections.Generic.List<string> _supportedCapability;

        /// <summary>Capabilities supported by the cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> SupportedCapability { get => this._supportedCapability; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterNode> Node { get;  }
        /// <summary>OEM activation status of the cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> SupportedCapability { get;  }
...

    {
        ...
        /// <summary>IMDS attestation status of the cluster.</summary>
        [global::Microsoft.Azure.PowerShell.Cmdlets.StackHCI.PSArgumentCompleterAttribute("Disabled", "Enabled")]
        string ImdsAttestation { get; set; }
        /// <summary>Last time the cluster reported the data.</summary>
        global::System.DateTime? LastUpdated { get; set; }
        /// <summary>The manufacturer of all the nodes of the cluster.</summary>
        string Manufacturer { get; set; }
        /// <summary>List of nodes reported by the cluster.</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IClusterNode> Node { get; set; }
        /// <summary>OEM activation status of the cluster.</summary>
        [global::Microsoft.Azure.PowerShell.Cmdlets.StackHCI.PSArgumentCompleterAttribute("Disabled", "Enabled")]
        string OemActivation { get; set; }
        /// <summary>Capabilities supported by the cluster.</summary>
        System.Collections.Generic.List<string> SupportedCapability { get; set; }
