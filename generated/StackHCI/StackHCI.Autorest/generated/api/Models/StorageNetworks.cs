...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models
{
    ...
    public partial class StorageNetworks :
        Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IStorageNetworks,
        Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IStorageNetworksInternal
    {
        ...
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IStorageAdapterIPInfo> _storageAdapterIPInfo;

        /// <summary>List of Storage adapter physical nodes config to deploy AzureStackHCI Cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IStorageAdapterIPInfo> StorageAdapterIPInfo { get => this._storageAdapterIPInfo; set => this._storageAdapterIPInfo = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IStorageAdapterIPInfo) })]
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IStorageAdapterIPInfo> StorageAdapterIPInfo { get; set; }
        /// <summary>
        /// ID specified for the VLAN storage network. This setting is applied to the network interfaces that route the storage and
        /// VM migration traffic.
        /// </summary>
