...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzStackHciEdgeDevice_ValidateViaIdentity", SupportsShouldProcess = true)]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.ParameterSetBreakingChange(new string[] {"ValidateViaIdentity"}, "15.0.0", "3.0.0", "2025/11")]
    ...
    public partial class TestAzStackHciEdgeDevice_ValidateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.Api20240401.IValidateRequest _validateRequest;

        /// <summary>The validate request for Edge Device.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The validate request for Edge Device.", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.Api20240401.IValidateRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.Api20240401.IValidateRequest ValidateRequest { get => this._validateRequest; set => this._validateRequest = value; }
        ...
        /// <returns>a duplicate instance of TestAzStackHciEdgeDevice_ValidateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Cmdlets.TestAzStackHciEdgeDevice_ValidateViaIdentity Clone()
        {
            var clone = new TestAzStackHciEdgeDevice_ValidateViaIdentity();
            ...
            clone.ValidateRequest = this.ValidateRequest;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.EdgeDevicesValidateViaIdentity(InputObject.Id, ValidateRequest, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.EdgeDevicesValidate(InputObject.ResourceUri ?? null, InputObject.EdgeDeviceName ?? null, ValidateRequest, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzStackHciEdgeDevice_ValidateViaIdentity" /> cmdlet class.
        /// </summary>
        public TestAzStackHciEdgeDevice_ValidateViaIdentity()
        {
