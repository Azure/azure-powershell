...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Cmdlets
{
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.OutputBreakingChange("string", "16.0.0", "3.0.0", "2026/05", DeprecatedOutputProperties=new string[] {"EdgeDeviceId"}, NewOutputProperties=new string[] {"EdgeDeviceId"}, ChangeDescription="The type of the property EdgeDeviceId will be changed from single object or fixed array to 'List'.")]
