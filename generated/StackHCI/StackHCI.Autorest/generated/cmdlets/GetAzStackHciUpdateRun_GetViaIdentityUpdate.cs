...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Cmdlets
{
    ...
    /// <summary>Get the get run for a specified update</summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/updates/{updateName}/updateRuns/{updateRunName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzStackHciUpdateRun_GetViaIdentityUpdate")]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.OutputBreakingChange("Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IUpdateRun", "16.0.0", "3.0.0", "2026/05", DeprecatedOutputProperties = new string[] {"ProgressStep"}, NewOutputProperties = new string[] {"ProgressStep" } , ChangeDescription = "The type of the property ProgressStep will be changed from single object or fixed array to 'List'.")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IUpdateRun))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Description(@"Get the Update run for a specified update")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHCI.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/updates/{updateName}/updateRuns/{updateRunName}", ApiVersion = "2024-04-01")]
    public partial class GetAzStackHciUpdateRun_GetViaIdentityUpdate : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the Update Run")]
        ...
        /// <summary>Backing field for <see cref="UpdateInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IStackHciIdentity _updateInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Category(global::Microsoft.Azure.PowerShell.Cmdlets.StackHCI.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IStackHciIdentity UpdateInputObject { get => this._updateInputObject; set => this._updateInputObject = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IErrorResponseAutoGenerated">Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IErrorResponseAutoGenerated</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IErrorResponseAutoGenerated> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IUpdateRun">Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IUpdateRun</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IUpdateRun> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzStackHciUpdateRun_GetViaIdentityUpdate" /> cmdlet class.
        /// </summary>
        public GetAzStackHciUpdateRun_GetViaIdentityUpdate()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (UpdateInputObject?.Id != null)
                    {
                        this.UpdateInputObject.Id += $"/updateRuns/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.UpdateRunsGetViaIdentity(UpdateInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == UpdateInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("UpdateInputObject has null value for UpdateInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, UpdateInputObject) );
                        }
                        if (null == UpdateInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("UpdateInputObject has null value for UpdateInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, UpdateInputObject) );
                        }
                        if (null == UpdateInputObject.ClusterName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("UpdateInputObject has null value for UpdateInputObject.ClusterName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, UpdateInputObject) );
                        }
                        if (null == UpdateInputObject.UpdateName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("UpdateInputObject has null value for UpdateInputObject.UpdateName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, UpdateInputObject) );
                        }
                        await this.Client.UpdateRunsGet(UpdateInputObject.SubscriptionId ?? null, UpdateInputObject.ResourceGroupName ?? null, UpdateInputObject.ClusterName ?? null, UpdateInputObject.UpdateName ?? null, Name, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IErrorResponseAutoGenerated> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IErrorResponseAutoGenerated>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IUpdateRun> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IUpdateRun
