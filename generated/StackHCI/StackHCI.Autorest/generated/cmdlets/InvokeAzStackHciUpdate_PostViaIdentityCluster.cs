...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzStackHciUpdate_PostViaIdentityCluster", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzStackHciUpdate_PostViaIdentityCluster : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.IContext
    {
        ...
        /// <returns>a duplicate instance of InvokeAzStackHciUpdate_PostViaIdentityCluster</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Cmdlets.InvokeAzStackHciUpdate_PostViaIdentityCluster Clone()
        {
            var clone = new InvokeAzStackHciUpdate_PostViaIdentityCluster();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzStackHciUpdate_PostViaIdentityCluster" /> cmdlet class.
        /// </summary>
        public InvokeAzStackHciUpdate_PostViaIdentityCluster()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ClusterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.UpdatesPostViaIdentity(ClusterInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.UpdatesPost(ClusterInputObject.SubscriptionId ?? null, ClusterInputObject.ResourceGroupName ?? null, ClusterInputObject.ClusterName ?? null, Name, onOk, onDefault, this, Pipeline);
                    }
