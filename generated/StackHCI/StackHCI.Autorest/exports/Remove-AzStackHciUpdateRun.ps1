...
param(
    ...
    [Parameter(ParameterSetName='DeleteViaIdentityUpdate', Mandatory)]
    [Alias('UpdateRunName')]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Category('Path')]
    [System.String]
    ...
    [Parameter(ParameterSetName='DeleteViaIdentityUpdate', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IStackHciIdentity]
    # Identity Parameter
    ${UpdateInputObject},
...
begin {
    try {
        ...
        $mapping = @{
            ...
            DeleteViaIdentityCluster = 'Az.StackHCI.private\Remove-AzStackHciUpdateRun_DeleteViaIdentityCluster';
            DeleteViaIdentityUpdate = 'Az.StackHCI.private\Remove-AzStackHciUpdateRun_DeleteViaIdentityUpdate';
        }
