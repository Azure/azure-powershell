...
param(
    ...
    [Parameter(ParameterSetName='Post', Mandatory)]
    [Parameter(ParameterSetName='PostViaIdentityCluster', Mandatory)]
    [Alias('UpdateName')]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Category('Path')]
    [System.String]
    ...
    [Parameter(ParameterSetName='PostViaIdentityCluster', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IStackHciIdentity]
    # Identity Parameter
    ${ClusterInputObject},
...
begin {
    try {
        ...
        $mapping = @{
            ...
            PostViaIdentityCluster = 'Az.StackHCI.private\Invoke-AzStackHciUpdate_PostViaIdentityCluster';
        }
