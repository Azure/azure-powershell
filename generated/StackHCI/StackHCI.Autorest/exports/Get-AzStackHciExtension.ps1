...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IExtension])]
...
param(
    ...
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='GetViaIdentityArcSetting', Mandatory)]
    [Parameter(ParameterSetName='GetViaIdentityCluster', Mandatory)]
    [Alias('ExtensionName')]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Category('Path')]
    [System.String]
    ...
    [Parameter(ParameterSetName='GetViaIdentityArcSetting', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IStackHciIdentity]
    # Identity Parameter
...
begin {
    try {
        ...
        $mapping = @{
            ...
            GetViaIdentityArcSetting = 'Az.StackHCI.private\Get-AzStackHciExtension_GetViaIdentityArcSetting';
            GetViaIdentityCluster = 'Az.StackHCI.private\Get-AzStackHciExtension_GetViaIdentityCluster';
