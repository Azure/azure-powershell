...
begin {
    try {
        ...
        $mapping = @{
            ...
            GetViaIdentityCluster = 'Az.StackHCI.private\Get-AzStackHciArcSetting_GetViaIdentityCluster';
...
begin {
    try {
        ...
        $mapping = @{
            ...
            GetViaIdentityCluster = 'Az.StackHCI.private\Get-AzStackHciUpdate_GetViaIdentityCluster';
...
param(
    ...
    [Parameter(ParameterSetName='CreateViaIdentityArcSettingExpanded', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IStackHciIdentity]
    # Identity Parameter
    ${ArcSettingInputObject},
    ...
    [Parameter(ParameterSetName='CreateExpanded')]
    [Parameter(ParameterSetName='CreateViaIdentityArcSettingExpanded')]
    [Parameter(ParameterSetName='CreateViaIdentityClusterExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Category('Body')]
    [System.Management.Automation.SwitchParameter]
    ...
    [Parameter(ParameterSetName='CreateViaIdentityClusterExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IExtensionParametersProtectedSettings]))]
    [System.Collections.Hashtable]
    ...
    [Parameter(ParameterSetName='CreateViaIdentityClusterExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IExtensionParametersSettings]))]
    [System.Collections.Hashtable]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            CreateViaIdentityArcSettingExpanded = 'Az.StackHCI.private\New-AzStackHciExtension_CreateViaIdentityArcSettingExpanded';
            CreateViaIdentityClusterExpanded = 'Az.StackHCI.private\New-AzStackHciExtension_CreateViaIdentityClusterExpanded';
            CreateViaJsonFilePath = 'Az.StackHCI.private\New-AzStackHciExtension_CreateViaJsonFilePath';
            CreateViaJsonString = 'Az.StackHCI.private\New-AzStackHciExtension_CreateViaJsonString';
        }
        if (('CreateExpanded', 'CreateViaJsonFilePath', 'CreateViaJsonString') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId') ) {
            if ($testPlayback) {
                $PSBoundParameters['SubscriptionId'] = . (Join-Path $PSScriptRoot '..' 'utils' 'Get-SubscriptionIdTestSafe.ps1')
...
begin {
    try {
        ...
        $mapping = @{
            ...
            CreateViaIdentityClusterExpanded = 'Az.StackHCI.private\New-AzStackHciSecuritySetting_CreateViaIdentityClusterExpanded';
            CreateViaJsonFilePath = 'Az.StackHCI.private\New-AzStackHciSecuritySetting_CreateViaJsonFilePath';
            CreateViaJsonString = 'Az.StackHCI.private\New-AzStackHciSecuritySetting_CreateViaJsonString';
        }
        if (('CreateExpanded', 'CreateViaJsonFilePath', 'CreateViaJsonString') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId') ) {
            if ($testPlayback) {
                $PSBoundParameters['SubscriptionId'] = . (Join-Path $PSScriptRoot '..' 'utils' 'Get-SubscriptionIdTestSafe.ps1')
        ...
        if (('CreateExpanded', 'CreateViaIdentityClusterExpanded', 'CreateViaJsonFilePath', 'CreateViaJsonString') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SName') ) {
...
begin {
    try {
        ...
        $mapping = @{
            ...
            DeleteViaIdentityCluster = 'Az.StackHCI.private\Remove-AzStackHciSecuritySetting_DeleteViaIdentityCluster';
        }
        if (('Delete') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId') ) {
            if ($testPlayback) {
                $PSBoundParameters['SubscriptionId'] = . (Join-Path $PSScriptRoot '..' 'utils' 'Get-SubscriptionIdTestSafe.ps1')
...
begin {
    try {
        ...
        $mapping = @{
            ...
            UpdateViaJsonFilePath = 'Az.StackHCI.private\Set-AzStackHciEdgeDevice_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.StackHCI.private\Set-AzStackHciEdgeDevice_UpdateViaJsonString';
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
        if ($null -ne $MyInvocation.MyCommand -and [Microsoft.WindowsAzure.Commands.Utilities.Common.AzurePSCmdlet]::PromptedPreviewMessageCmdlets -notcontains $MyInvocation.MyCommand.Name -and [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.MessageAttributeHelper]::ContainsPreviewAttribute($cmdInfo, $MyInvocation)){
...
UPDATELOCATIONPROPERTY <IUpdateSummaries>: Get the update summaries for the cluster
  ...
  [HealthCheckResult <List<IPrecheckResult>>]: An array of pre-check result objects.
    [AdditionalData <String>]: Property bag of key value pairs for additional information.
    [Description <String>]: Detailed overview of the issue and what impact the issue has on the stamp.
    [DisplayName <String>]: The health check DisplayName localized of the individual test executed.
    [HealthCheckSource <String>]: The name of the services called for the HealthCheck (I.E. Test-AzureStack, Test-Cluster).
  ...
  [PackageVersion <List<IPackageVersionInfo>>]: Current version of each updatable component.
    [LastUpdated <DateTime?>]: Last time this component was updated.
    [PackageType <String>]: Package type
    [Version <String>]: Package version
  [State <String>]: Overall update state of the stamp.
.Link
...
param(
    ...
    [Parameter(ParameterSetName='PutExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.PSArgumentCompleterAttribute("Unknown", "AppliedSuccessfully", "UpdateAvailable", "UpdateInProgress", "UpdateFailed", "NeedsAttention", "PreparationInProgress", "PreparationFailed")]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Category('Body')]
    [System.String]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            PutViaJsonFilePath = 'Az.StackHCI.private\Set-AzStackHciUpdateSummary_PutViaJsonFilePath';
            PutViaJsonString = 'Az.StackHCI.private\Set-AzStackHciUpdateSummary_PutViaJsonString';
        }
        if (('Put', 'PutExpanded', 'PutViaJsonFilePath', 'PutViaJsonString') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId') ) {
            if ($testPlayback) {
                $PSBoundParameters['SubscriptionId'] = . (Join-Path $PSScriptRoot '..' 'utils' 'Get-SubscriptionIdTestSafe.ps1')
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IValidateResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            ValidateViaJsonFilePath = 'Az.StackHCI.private\Test-AzStackHciEdgeDevice_ValidateViaJsonFilePath';
            ValidateViaJsonString = 'Az.StackHCI.private\Test-AzStackHciEdgeDevice_ValidateViaJsonString';
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
        if ($null -ne $MyInvocation.MyCommand -and [Microsoft.WindowsAzure.Commands.Utilities.Common.AzurePSCmdlet]::PromptedPreviewMessageCmdlets -notcontains $MyInvocation.MyCommand.Name -and [Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Runtime.MessageAttributeHelper]::ContainsPreviewAttribute($cmdInfo, $MyInvocation)){
