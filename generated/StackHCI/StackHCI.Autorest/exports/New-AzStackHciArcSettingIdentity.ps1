...
INPUTOBJECT <IStackHciIdentity>: Identity Parameter
  ...
  [UpdateRunName <String>]: The name of the Update Run
.Link
https://learn.microsoft.com/powershell/module/az.stackhci/new-azstackhciarcsettingidentity
#>
function New-AzStackHciArcSettingIdentity {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.IArcIdentityResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'Az.StackHCI.private\New-AzStackHciArcSettingIdentity_Create';
            CreateViaIdentity = 'Az.StackHCI.private\New-AzStackHciArcSettingIdentity_CreateViaIdentity';
            CreateViaIdentityCluster = 'Az.StackHCI.private\New-AzStackHciArcSettingIdentity_CreateViaIdentityCluster';
        }
