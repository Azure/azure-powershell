...
begin {
    try {
        ...
        $mapping = @{
            ...
            UpdateViaJsonFilePath = 'Az.StackHCI.private\Set-AzStackHciDeploymentSetting_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.StackHCI.private\Set-AzStackHciDeploymentSetting_UpdateViaJsonString';
        }
