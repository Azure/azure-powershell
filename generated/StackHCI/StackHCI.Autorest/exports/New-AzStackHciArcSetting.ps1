...
begin {
    try {
        ...
        $mapping = @{
            ...
            CreateViaIdentityClusterExpanded = 'Az.StackHCI.private\New-AzStackHciArcSetting_CreateViaIdentityClusterExpanded';
            CreateViaJsonFilePath = 'Az.StackHCI.private\New-AzStackHciArcSetting_CreateViaJsonFilePath';
            CreateViaJsonString = 'Az.StackHCI.private\New-AzStackHciArcSetting_CreateViaJsonString';
        }
