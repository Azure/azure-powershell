...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.StackHCI.Models.ISecuritySetting])]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            GetViaIdentityCluster = 'Az.StackHCI.private\Get-AzStackHciSecuritySetting_GetViaIdentityCluster';
