...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.IOperation
.Link
https://learn.microsoft.com/powershell/module/az.agricultureplatform/get-azagricultureplatformoperation
#>
function Get-AzAgriculturePlatformOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.IOperation])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AgriculturePlatform.private\Get-AzAgriculturePlatformOperation_List';
        }
