...
namespace Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListAvailableSolutions=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AgriculturePlatform/agriServices/{agriServiceResourceName}/listAvailableSolutions"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzAgriculturePlatformAgriServiceAvailableSolution_List", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.IAvailableAgriSolutionListResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Description(@"Returns the list of available agri solutions.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AgriculturePlatform/agriServices/{agriServiceResourceName}/listAvailableSolutions", ApiVersion = "2024-06-01-preview")]
    public partial class GetAzAgriculturePlatformAgriServiceAvailableSolution_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.IAvailableAgriSolutionListResult">Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.IAvailableAgriSolutionListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.IAvailableAgriSolutionListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzAgriculturePlatformAgriServiceAvailableSolution_List" /> cmdlet class.
        /// </summary>
        public GetAzAgriculturePlatformAgriServiceAvailableSolution_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'AgriServiceListAvailableSolutions' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AgriServiceListAvailableSolutions(SubscriptionId, ResourceGroupName, AgriServiceResourceName, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,AgriServiceResourceName=AgriServiceResourceName})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.IAvailableAgriSolutionListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.IAvailableAgriSolutionListResult
                var result = (await response);
                // response should be returning an array of some kind. +Pageable
                // nested-array / solutions / <none>
                if (null != result.Solution)
                {
                    if (0 == _responseSize && 1 == result.Solution.Count)
                    {
                        _firstResponse = result.Solution[0];
                        _responseSize = 1;
                    }
                    else
                    {
