...
namespace Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Support
{
        ...
        System.IEquatable<ProvisioningState>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Support.ProvisioningState Accepted = @"Accepted";

        /// <summary>File system resource creation canceled</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Support.ProvisioningState Canceled = @"Canceled";

        /// <summary>File system resource creation started</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Support.ProvisioningState Creating = @"Creating";

        /// <summary>File system resource is deleted</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Support.ProvisioningState Deleted = @"Deleted";

        /// <summary>File system resource deletion started</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Support.ProvisioningState Deleting = @"Deleting";

        /// <summary>File system resource creation failed</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Support.ProvisioningState Failed = @"Failed";

        /// <summary>File system resource state is unknown</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Support.ProvisioningState NotSpecified = @"NotSpecified";

        /// <summary>File system resource creation successful</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Support.ProvisioningState Succeeded = @"Succeeded";

        /// <summary>File system resource is being updated</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
