...
namespace Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Models.Api20221012Preview
{
    ...
    public partial class MarketplaceDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Models.Api20221012Preview.IMarketplaceDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Models.Api20221012Preview.IMarketplaceDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Models.Api20221012Preview.IMarketplaceDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Runtime.Json.JsonNode node)
        {
        ...
        internal MarketplaceDetails(Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Runtime.Json.JsonObject json)
        {
            ...
            {_marketplaceSubscriptionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Runtime.Json.JsonString>("marketplaceSubscriptionId"), out var __jsonMarketplaceSubscriptionId) ? (string)__jsonMarketplaceSubscriptionId : (string)MarketplaceSubscriptionId;}
            {_planId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Runtime.Json.JsonString>("planId"), out var __jsonPlanId) ? (string)__jsonPlanId : (string)PlanId;}
            {_offerId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Runtime.Json.JsonString>("offerId"), out var __jsonOfferId) ? (string)__jsonOfferId : (string)OfferId;}
            {_publisherId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Runtime.Json.JsonString>("publisherId"), out var __jsonPublisherId) ? (string)__jsonPublisherId : (string)PublisherId;}
            {_marketplaceSubscriptionStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Runtime.Json.JsonString>("marketplaceSubscriptionStatus"), out var __jsonMarketplaceSubscriptionStatus) ? (string)__jsonMarketplaceSubscriptionStatus : (string)MarketplaceSubscriptionStatus;}
            AfterFromJson(json);
        }
