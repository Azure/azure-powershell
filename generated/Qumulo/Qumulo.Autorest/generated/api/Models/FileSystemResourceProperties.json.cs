...
namespace Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Models
{
    ...
    public partial class FileSystemResourceProperties
    {
        ...
        internal FileSystemResourceProperties(Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Runtime.Json.JsonObject json)
        {
            ...
            {_adminPassword = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Qumulo.Runtime.Json.JsonString>("adminPassword"), out var __jsonAdminPassword) ? new System.Net.NetworkCredential("",(string)__jsonAdminPassword).SecurePassword : _adminPassword;}
