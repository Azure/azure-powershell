...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzWebPubSubHub_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.WebPubSubHubsGet(SubscriptionId, ResourceGroupName, Name, ResourceName, onOk, onDefault, this, Pipeline);
