...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzWebPubSubHub_DeleteViaIdentityHub", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzWebPubSubHub_DeleteViaIdentityHub : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.IContext
    {
        ...
        /// <returns>a duplicate instance of RemoveAzWebPubSubHub_DeleteViaIdentityHub</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Cmdlets.RemoveAzWebPubSubHub_DeleteViaIdentityHub Clone()
        {
            var clone = new RemoveAzWebPubSubHub_DeleteViaIdentityHub();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (HubInputObject?.Id != null)
                    {
                        ...
                        await this.Client.WebPubSubHubsDeleteViaIdentity(HubInputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.WebPubSubHubsDelete(HubInputObject.SubscriptionId ?? null, HubInputObject.ResourceGroupName ?? null, HubInputObject.HubName ?? null, ResourceName, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzWebPubSubHub_DeleteViaIdentityHub" /> cmdlet class.
        /// </summary>
        public RemoveAzWebPubSubHub_DeleteViaIdentityHub()
        {
