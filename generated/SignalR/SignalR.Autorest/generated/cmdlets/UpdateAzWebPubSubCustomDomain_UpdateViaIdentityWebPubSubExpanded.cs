...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Cmdlets
{
    ...
    /// <summary>update a custom domain.</summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/WebPubSub/{resourceName}/customDomains/{name}"
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/WebPubSub/{resourceName}/customDomains/{name}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzWebPubSubCustomDomain_UpdateViaIdentityWebPubSubExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.ICustomDomain))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Description(@"update a custom domain.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Generated]
    public partial class UpdateAzWebPubSubCustomDomain_UpdateViaIdentityWebPubSubExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.ICustomDomain _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.CustomDomain();
        ...
        public string CustomCertificateId { get => _parametersBody.CustomCertificateId ?? null; set => _parametersBody.CustomCertificateId = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The custom domain name.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Category(global::Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string DomainName { get => _parametersBody.DomainName ?? null; set => _parametersBody.DomainName = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Custom domain name.")]
        [Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>Backing field for <see cref="WebPubSubInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.IWebPubSubIdentity _webPubSubInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Category(global::Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.IWebPubSubIdentity WebPubSubInputObject { get => this._webPubSubInputObject; set => this._webPubSubInputObject = value; }
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzWebPubSubCustomDomain_UpdateViaIdentityWebPubSubExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Cmdlets.UpdateAzWebPubSubCustomDomain_UpdateViaIdentityWebPubSubExpanded Clone()
        {
            var clone = new UpdateAzWebPubSubCustomDomain_UpdateViaIdentityWebPubSubExpanded();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'WebPubSubCustomDomainsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (WebPubSubInputObject?.Id != null)
                    {
                        this.WebPubSubInputObject.Id += $"/customDomains/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        _parametersBody = await this.Client.WebPubSubCustomDomainsGetViaIdentityWithResult(WebPubSubInputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.WebPubSubCustomDomainsCreateOrUpdateViaIdentity(WebPubSubInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == WebPubSubInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("WebPubSubInputObject has null value for WebPubSubInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, WebPubSubInputObject) );
                        }
                        if (null == WebPubSubInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("WebPubSubInputObject has null value for WebPubSubInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, WebPubSubInputObject) );
                        }
                        if (null == WebPubSubInputObject.ResourceName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("WebPubSubInputObject has null value for WebPubSubInputObject.ResourceName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, WebPubSubInputObject) );
                        }
                        _parametersBody = await this.Client.WebPubSubCustomDomainsGetWithResult(WebPubSubInputObject.SubscriptionId ?? null, WebPubSubInputObject.ResourceGroupName ?? null, WebPubSubInputObject.ResourceName ?? null, Name, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.WebPubSubCustomDomainsCreateOrUpdate(WebPubSubInputObject.SubscriptionId ?? null, WebPubSubInputObject.ResourceGroupName ?? null, WebPubSubInputObject.ResourceName ?? null, Name, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzWebPubSubCustomDomain_UpdateViaIdentityWebPubSubExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzWebPubSubCustomDomain_UpdateViaIdentityWebPubSubExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("DomainName")))
            {
                this.DomainName = (string)(this.MyInvocation?.BoundParameters["DomainName"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("CustomCertificateId")))
            {
                this.CustomCertificateId = (string)(this.MyInvocation?.BoundParameters["CustomCertificateId"]);
            }
        }
