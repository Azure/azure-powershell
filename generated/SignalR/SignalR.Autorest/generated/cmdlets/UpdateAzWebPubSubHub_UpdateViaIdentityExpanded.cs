...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzWebPubSubHub_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzWebPubSubHub_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.IContext
    {
        ...
        /// <returns>a duplicate instance of UpdateAzWebPubSubHub_UpdateViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Cmdlets.UpdateAzWebPubSubHub_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzWebPubSubHub_UpdateViaIdentityExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _parametersBody = await this.Client.WebPubSubHubsGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.WebPubSubHubsCreateOrUpdateViaIdentity(InputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _parametersBody = await this.Client.WebPubSubHubsGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.HubName ?? null, InputObject.ResourceName ?? null, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.WebPubSubHubsCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.HubName ?? null, InputObject.ResourceName ?? null, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzWebPubSubHub_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzWebPubSubHub_UpdateViaIdentityExpanded()
        {
