...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models
{
    ...
    public partial class SignalRServiceUsage :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.ISignalRServiceUsageInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.ISignalRServiceUsageName Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.ISignalRServiceUsageInternal.Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.SignalRServiceUsageName()); set { {_name = value;} } }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.ISignalRServiceUsageName _name;

        /// <summary>Localizable String object containing the name and a localized value.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Origin(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.PropertyOrigin.Owned)]
        [Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.DoNotFormat]
        internal Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.ISignalRServiceUsageName Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.SignalRServiceUsageName()); set => this._name = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.DoNotFormat]
        public string NameLocalizedValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.ISignalRServiceUsageNameInternal)Name).LocalizedValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.ISignalRServiceUsageNameInternal)Name).LocalizedValue = value ?? null; }

        /// <summary>The identifier of the usage.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Origin(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.PropertyOrigin.Inlined)]
        [Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.FormatTable(Index = 0)]
        public string NameValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.ISignalRServiceUsageNameInternal)Name).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.ISignalRServiceUsageNameInternal)Name).Value = value ?? null; }
...

    {
        ...
        long? Limit { get; set; }
        /// <summary>Localizable String object containing the name and a localized value.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.ISignalRServiceUsageName Name { get; set; }
        /// <summary>Localized name of the usage.</summary>
        string NameLocalizedValue { get; set; }
        /// <summary>The identifier of the usage.</summary>
        string NameValue { get; set; }
