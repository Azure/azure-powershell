...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models
{
    ...
    public partial class EventNameFilter :
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.IEventNameFilter,
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.IEventNameFilterInternal,
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.IEventListenerFilter"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.IEventListenerFilter __eventListenerFilter = new Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.EventListenerFilter();

        /// <summary>Internal Acessors for Type</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.IEventListenerFilterInternal.Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.IEventListenerFilterInternal)__eventListenerFilter).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.IEventListenerFilterInternal)__eventListenerFilter).Type = value ; }
        ...
        public string Type { get => "EventName"; }
    ...
    public partial interface IEventNameFilter :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.IEventListenerFilter
    {
        /// <summary>
        /// Gets or sets a list of system events. Supported events: "connected" and "disconnected". Blocking event "connect" is not
        /// supported because it requires a response.
    ...
    internal partial interface IEventNameFilterInternal :
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.IEventListenerFilterInternal
    {
        /// <summary>
        /// Gets or sets a list of system events. Supported events: "connected" and "disconnected". Blocking event "connect" is not
        /// supported because it requires a response.
