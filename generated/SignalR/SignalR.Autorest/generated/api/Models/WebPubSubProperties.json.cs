...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models
{
    ...
    public partial class WebPubSubProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.IWebPubSubProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.IWebPubSubProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.IWebPubSubProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode node)
        {
        ...
        internal WebPubSubProperties(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject json)
        {
            ...
            {_tl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject>("tls"), out var __jsonTls) ? Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.WebPubSubTlsSettings.FromJson(__jsonTls) : _tl;}
            {_liveTraceConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject>("liveTraceConfiguration"), out var __jsonLiveTraceConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.LiveTraceConfiguration.FromJson(__jsonLiveTraceConfiguration) : _liveTraceConfiguration;}
            {_resourceLogConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject>("resourceLogConfiguration"), out var __jsonResourceLogConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.ResourceLogConfiguration.FromJson(__jsonResourceLogConfiguration) : _resourceLogConfiguration;}
            {_networkAcL = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject>("networkACLs"), out var __jsonNetworkAcLs) ? Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.WebPubSubNetworkAcLs.FromJson(__jsonNetworkAcLs) : _networkAcL;}
            ...
            {_externalIP = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonString>("externalIP"), out var __jsonExternalIP) ? (string)__jsonExternalIP : (string)_externalIP;}
            {_hostName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonString>("hostName"), out var __jsonHostName) ? (string)__jsonHostName : (string)_hostName;}
            {_publicPort = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNumber>("publicPort"), out var __jsonPublicPort) ? (int?)__jsonPublicPort : _publicPort;}
            {_serverPort = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNumber>("serverPort"), out var __jsonServerPort) ? (int?)__jsonServerPort : _serverPort;}
            {_version = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonString>("version"), out var __jsonVersion) ? (string)__jsonVersion : (string)_version;}
            {_privateEndpointConnection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonArray>("privateEndpointConnections"), out var __jsonPrivateEndpointConnections) ? If( __jsonPrivateEndpointConnections as Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.IPrivateEndpointConnection>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.IPrivateEndpointConnection) (Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.PrivateEndpointConnection.FromJson(__u) )) ))() : null : _privateEndpointConnection;}
            {_sharedPrivateLinkResource = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonArray>("sharedPrivateLinkResources"), out var __jsonSharedPrivateLinkResources) ? If( __jsonSharedPrivateLinkResources as Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.ISharedPrivateLinkResource>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.ISharedPrivateLinkResource) (Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.SharedPrivateLinkResource.FromJson(__p) )) ))() : null : _sharedPrivateLinkResource;}
            {_hostNamePrefix = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonString>("hostNamePrefix"), out var __jsonHostNamePrefix) ? (string)__jsonHostNamePrefix : (string)_hostNamePrefix;}
            {_publicNetworkAccess = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonString>("publicNetworkAccess"), out var __jsonPublicNetworkAccess) ? (string)__jsonPublicNetworkAccess : (string)_publicNetworkAccess;}
            {_disableLocalAuth = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonBoolean>("disableLocalAuth"), out var __jsonDisableLocalAuth) ? (bool?)__jsonDisableLocalAuth : _disableLocalAuth;}
            {_disableAadAuth = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonBoolean>("disableAadAuth"), out var __jsonDisableAadAuth) ? (bool?)__jsonDisableAadAuth : _disableAadAuth;}
            AfterFromJson(json);
        }
    }
}