...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Models
{
    ...
    public partial class RestoreResult
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Models.IRestoreResult.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Models.IRestoreResult.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Models.IRestoreResult FromJson(Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonObject json ? new RestoreResult(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonObject into a new instance of <see cref="RestoreResult" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal RestoreResult(Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Models.BackupRestoreBaseResultProperties.FromJson(__jsonProperties) : _property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="RestoreResult" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="RestoreResult" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonNode" />.
        /// </returns>
