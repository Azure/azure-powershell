...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.CloudHsm.private\Get-AzCloudHsm_Get';
            List = 'Az.CloudHsm.private\Get-AzCloudHsm_List';
            List1 = 'Az.CloudHsm.private\Get-AzCloudHsm_List1';
        }
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.CloudHsm.private\Update-AzCloudHsm_UpdateExpanded';
        }
