...
namespace Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models
{
    ...
    public partial class MachineInstallPatchesParameters :
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IMachineInstallPatchesParameters,
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IMachineInstallPatchesParametersInternal
    {

        /// <summary>Backing field for <see cref="LinuxParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILinuxParameters _linuxParameter;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILinuxParameters LinuxParameter { get => (this._linuxParameter = this._linuxParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.LinuxParameters()); set => this._linuxParameter = value; }
        ...
        public System.Collections.Generic.List<string> LinuxParameterClassificationsToInclude { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILinuxParametersInternal)LinuxParameter).ClassificationsToInclude; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILinuxParametersInternal)LinuxParameter).ClassificationsToInclude = value ?? null /* arrayOf */; }

        /// <summary>packages to exclude in the patch operation. Format: packageName_packageVersion</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> LinuxParameterPackageNameMasksToExclude { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILinuxParametersInternal)LinuxParameter).PackageNameMasksToExclude; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILinuxParametersInternal)LinuxParameter).PackageNameMasksToExclude = value ?? null /* arrayOf */; }

        /// <summary>packages to include in the patch operation. Format: packageName_packageVersion</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> LinuxParameterPackageNameMasksToInclude { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILinuxParametersInternal)LinuxParameter).PackageNameMasksToInclude; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILinuxParametersInternal)LinuxParameter).PackageNameMasksToInclude = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILinuxParameters Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IMachineInstallPatchesParametersInternal.LinuxParameter { get => (this._linuxParameter = this._linuxParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.LinuxParameters()); set { {_linuxParameter = value;} } }

        /// <summary>Internal Acessors for WindowsParameter</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IWindowsParameters Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IMachineInstallPatchesParametersInternal.WindowsParameter { get => (this._windowsParameter = this._windowsParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.WindowsParameters()); set { {_windowsParameter = value;} } }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> WindowParameterClassificationsToInclude { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IWindowsParametersInternal)WindowsParameter).ClassificationsToInclude; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IWindowsParametersInternal)WindowsParameter).ClassificationsToInclude = value ?? null /* arrayOf */; }

        /// <summary>
        /// Filters out Kbs that don't have an InstallationRebootBehavior of 'NeverReboots' when this is set to true.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public bool? WindowParameterExcludeKbsRequiringReboot { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IWindowsParametersInternal)WindowsParameter).ExcludeKbsRequiringReboot; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IWindowsParametersInternal)WindowsParameter).ExcludeKbsRequiringReboot = value ?? default(bool); }

        /// <summary>Kbs to exclude in the patch operation</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> WindowParameterKbNumbersToExclude { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IWindowsParametersInternal)WindowsParameter).KbNumbersToExclude; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IWindowsParametersInternal)WindowsParameter).KbNumbersToExclude = value ?? null /* arrayOf */; }

        /// <summary>Kbs to include in the patch operation</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> WindowParameterKbNumbersToInclude { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IWindowsParametersInternal)WindowsParameter).KbNumbersToInclude; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IWindowsParametersInternal)WindowsParameter).KbNumbersToInclude = value ?? null /* arrayOf */; }

        /// <summary>
        /// This is used to install patches that were published on or before this given max published date.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public global::System.DateTime? WindowParameterMaxPatchPublishDate { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IWindowsParametersInternal)WindowsParameter).MaxPatchPublishDate; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IWindowsParametersInternal)WindowsParameter).MaxPatchPublishDate = value ?? default(global::System.DateTime); }

        /// <summary>Backing field for <see cref="WindowsParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IWindowsParameters _windowsParameter;

        /// <summary>Input for InstallPatches on a Windows VM, as directly received by the API</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IWindowsParameters WindowsParameter { get => (this._windowsParameter = this._windowsParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.WindowsParameters()); set => this._windowsParameter = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PSArgumentCompleterAttribute("IfRequired", "Never", "Always")]
        ...
        SerializedName = @"classificationsToInclude",
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PSArgumentCompleterAttribute("Critical", "Security", "UpdateRollUp", "FeaturePack", "ServicePack", "Definition", "Tools", "Updates")]
    ...
    {
        /// <summary>Input for InstallPatches on a Linux VM, as directly received by the API</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILinuxParameters LinuxParameter { get; set; }
        /// <summary>The update classifications to select when installing patches for Linux.</summary>
        [global::Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PSArgumentCompleterAttribute("Critical", "Security", "Other")]
        System.Collections.Generic.List<string> LinuxParameterClassificationsToInclude { get; set; }
        /// <summary>packages to exclude in the patch operation. Format: packageName_packageVersion</summary>
        ...
        global::System.DateTime? WindowParameterMaxPatchPublishDate { get; set; }
        /// <summary>Input for InstallPatches on a Windows VM, as directly received by the API</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IWindowsParameters WindowsParameter { get; set; }
