...
namespace Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models
{
    ...
    public partial class ProductProfileUpdateProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IProductProfileUpdateProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IProductProfileUpdatePropertiesInternal
    {

        /// <summary>Backing field for <see cref="ProductFeature" /> property.</summary>
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IProductFeatureUpdate> _productFeature;
        ...
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IProductFeatureUpdate> ProductFeature { get => this._productFeature; set => this._productFeature = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IProductFeatureUpdate) })]
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IProductFeatureUpdate> ProductFeature { get; set; }
        /// <summary>Indicates the product type of the license.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PSArgumentCompleterAttribute("Enable", "Disable")]
