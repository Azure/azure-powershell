...
namespace Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models
{
    ...
    public partial class LicenseProfileArmEsuPropertiesWithoutAssignedLicense :
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileArmEsuPropertiesWithoutAssignedLicense,
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileArmEsuPropertiesWithoutAssignedLicenseInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileStorageModelEsuProperties"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileStorageModelEsuProperties __licenseProfileStorageModelEsuProperties = new Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.LicenseProfileStorageModelEsuProperties();
        ...
        public string AssignedLicenseImmutableId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileStorageModelEsuPropertiesInternal)__licenseProfileStorageModelEsuProperties).AssignedLicenseImmutableId; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inherited)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IEsuKey> EsuKey { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileStorageModelEsuPropertiesInternal)__licenseProfileStorageModelEsuProperties).EsuKey; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileArmEsuPropertiesWithoutAssignedLicenseInternal.EsuEligibility { get => this._esuEligibility; set { {_esuEligibility = value;} } }

        /// <summary>Internal Acessors for EsuKeyState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileArmEsuPropertiesWithoutAssignedLicenseInternal.EsuKeyState { get => this._esuKeyState; set { {_esuKeyState = value;} } }

        /// <summary>Internal Acessors for ServerType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileArmEsuPropertiesWithoutAssignedLicenseInternal.ServerType { get => this._serverType; set { {_serverType = value;} } }

        /// <summary>Internal Acessors for AssignedLicenseImmutableId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileStorageModelEsuPropertiesInternal.AssignedLicenseImmutableId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileStorageModelEsuPropertiesInternal)__licenseProfileStorageModelEsuProperties).AssignedLicenseImmutableId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileStorageModelEsuPropertiesInternal)__licenseProfileStorageModelEsuProperties).AssignedLicenseImmutableId = value ?? null; }

        /// <summary>Internal Acessors for EsuKey</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IEsuKey> Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileStorageModelEsuPropertiesInternal.EsuKey { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileStorageModelEsuPropertiesInternal)__licenseProfileStorageModelEsuProperties).EsuKey; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileStorageModelEsuPropertiesInternal)__licenseProfileStorageModelEsuProperties).EsuKey = value ?? null /* arrayOf */; }
    ...
    public partial interface ILicenseProfileArmEsuPropertiesWithoutAssignedLicense :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileStorageModelEsuProperties
    {
        /// <summary>Indicates the eligibility state of Esu.</summary>
    ...
    internal partial interface ILicenseProfileArmEsuPropertiesWithoutAssignedLicenseInternal :
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseProfileStorageModelEsuPropertiesInternal
    {
        /// <summary>Indicates the eligibility state of Esu.</summary>
        [global::Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PSArgumentCompleterAttribute("Eligible", "Ineligible", "Unknown")]
