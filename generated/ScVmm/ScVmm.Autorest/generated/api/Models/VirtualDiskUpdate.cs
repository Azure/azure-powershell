...
namespace Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualDiskUpdateInternal
    {
        ...
        public string StorageQoPolicyId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IStorageQosPolicyDetailsInternal)StorageQosPolicy).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IStorageQosPolicyDetailsInternal)StorageQosPolicy).Id = value ?? null; }

        /// <summary>The name of the policy.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public string StorageQoPolicyName { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IStorageQosPolicyDetailsInternal)StorageQosPolicy).Name; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IStorageQosPolicyDetailsInternal)StorageQosPolicy).Name = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        string StorageQoPolicyId { get; set; }
        /// <summary>The name of the policy.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(string) })]
        string StorageQoPolicyName { get; set; }
        /// <summary>Gets or sets the disk vhd type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Runtime.Info(
        Required = false,
        ReadOnly = false,
