...
namespace Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstancePropertiesInternal
    {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public string OSProfileDomainName { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IOSProfileForVminstanceInternal)OSProfile).DomainName; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IOSProfileForVminstanceInternal)OSProfile).DomainName = value ?? null; }

        /// <summary>Password of the domain the VM has to join.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public System.Security.SecureString OSProfileDomainPassword { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IOSProfileForVminstanceInternal)OSProfile).DomainPassword; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IOSProfileForVminstanceInternal)OSProfile).DomainPassword = value ?? null; }

        /// <summary>Gets or sets the domain username.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public string OSProfileDomainUsername { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IOSProfileForVminstanceInternal)OSProfile).DomainUsername; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IOSProfileForVminstanceInternal)OSProfile).DomainUsername = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public System.Security.SecureString OSProfileProductKey { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IOSProfileForVminstanceInternal)OSProfile).ProductKey; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IOSProfileForVminstanceInternal)OSProfile).ProductKey = value ?? null; }

        /// <summary>
        /// Get or sets the commands to be run once at the time of creation separated by semicolons.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public string OSProfileRunOnceCommand { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IOSProfileForVminstanceInternal)OSProfile).RunOnceCommand; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IOSProfileForVminstanceInternal)OSProfile).RunOnceCommand = value ?? null; }

        /// <summary>Gets or sets the index value of the timezone.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public int? OSProfileTimezone { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IOSProfileForVminstanceInternal)OSProfile).Timezone; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IOSProfileForVminstanceInternal)OSProfile).Timezone = value ?? default(int); }

        /// <summary>Gets or sets the workgroup.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public string OSProfileWorkgroup { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IOSProfileForVminstanceInternal)OSProfile).Workgroup; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IOSProfileForVminstanceInternal)OSProfile).Workgroup = value ?? null; }
