...
namespace Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models
{
    ...
    public partial class LicenseUpdateProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdateProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdatePropertiesInternal
    {

        /// <summary>Backing field for <see cref="LicenseDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdatePropertiesLicenseDetails _licenseDetail;

        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdatePropertiesLicenseDetails LicenseDetail { get => (this._licenseDetail = this._licenseDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.LicenseUpdatePropertiesLicenseDetails()); set => this._licenseDetail = value; }
        ...
        public string LicenseDetailEdition { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdatePropertiesLicenseDetailsInternal)LicenseDetail).Edition; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdatePropertiesLicenseDetailsInternal)LicenseDetail).Edition = value ?? null; }

        /// <summary>Describes the number of processors.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public int? LicenseDetailProcessor { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdatePropertiesLicenseDetailsInternal)LicenseDetail).Processor; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdatePropertiesLicenseDetailsInternal)LicenseDetail).Processor = value ?? default(int); }

        /// <summary>Describes the state of the license.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public string LicenseDetailState { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdatePropertiesLicenseDetailsInternal)LicenseDetail).State; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdatePropertiesLicenseDetailsInternal)LicenseDetail).State = value ?? null; }

        /// <summary>Describes the license target server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public string LicenseDetailTarget { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdatePropertiesLicenseDetailsInternal)LicenseDetail).Target; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdatePropertiesLicenseDetailsInternal)LicenseDetail).Target = value ?? null; }

        /// <summary>Describes the license core type (pCore or vCore).</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Origin(Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PropertyOrigin.Inlined)]
        public string LicenseDetailType { get => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdatePropertiesLicenseDetailsInternal)LicenseDetail).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdatePropertiesLicenseDetailsInternal)LicenseDetail).Type = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdatePropertiesLicenseDetails Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdatePropertiesInternal.LicenseDetail { get => (this._licenseDetail = this._licenseDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.LicenseUpdatePropertiesLicenseDetails()); set { {_licenseDetail = value;} } }
    ...
    {
        Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.ILicenseUpdatePropertiesLicenseDetails LicenseDetail { get; set; }
        /// <summary>
        /// Describes the edition of the license. The values are either Standard or Datacenter.
        /// </summary>
        [global::Microsoft.Azure.PowerShell.Cmdlets.ScVmm.PSArgumentCompleterAttribute("Standard", "Datacenter")]
