...
namespace Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models
{
    ...
    public partial class VirtualMachineInstance
    {
        ...
        internal VirtualMachineInstance(global::System.Collections.IDictionary content)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstanceInternal)this).RetryAfter = (int?) content.GetValueForProperty("RetryAfter",((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstanceInternal)this).RetryAfter, (__y)=> (int) global::System.Convert.ChangeType(__y, typeof(int)));
            }
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstanceInternal)this).OSProfileDomainName = (string) content.GetValueForProperty("OSProfileDomainName",((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstanceInternal)this).OSProfileDomainName, global::System.Convert.ToString);
            }
            if (content.Contains("OSProfileDomainUsername"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstanceInternal)this).OSProfileDomainUsername = (string) content.GetValueForProperty("OSProfileDomainUsername",((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstanceInternal)this).OSProfileDomainUsername, global::System.Convert.ToString);
            }
            if (content.Contains("OSProfileDomainPassword"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstanceInternal)this).OSProfileDomainPassword = (System.Security.SecureString) content.GetValueForProperty("OSProfileDomainPassword",((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstanceInternal)this).OSProfileDomainPassword, (object ss) => (System.Security.SecureString)ss);
            }
            if (content.Contains("OSProfileWorkgroup"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstanceInternal)this).OSProfileWorkgroup = (string) content.GetValueForProperty("OSProfileWorkgroup",((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstanceInternal)this).OSProfileWorkgroup, global::System.Convert.ToString);
            }
            if (content.Contains("OSProfileProductKey"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstanceInternal)this).OSProfileProductKey = (System.Security.SecureString) content.GetValueForProperty("OSProfileProductKey",((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstanceInternal)this).OSProfileProductKey, (object ss) => (System.Security.SecureString)ss);
            }
            if (content.Contains("OSProfileTimezone"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstanceInternal)this).OSProfileTimezone = (int?) content.GetValueForProperty("OSProfileTimezone",((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstanceInternal)this).OSProfileTimezone, (__y)=> (int) global::System.Convert.ChangeType(__y, typeof(int)));
            }
            if (content.Contains("OSProfileRunOnceCommand"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstanceInternal)this).OSProfileRunOnceCommand = (string) content.GetValueForProperty("OSProfileRunOnceCommand",((Microsoft.Azure.PowerShell.Cmdlets.ScVmm.Models.IVirtualMachineInstanceInternal)this).OSProfileRunOnceCommand, global::System.Convert.ToString);
            }
