...
namespace ADT.Models
{
    ...
    public partial class ArmConnectionResponse
    {
        ...
        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="ArmConnectionResponse" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ArmConnectionResponse(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_body = If( json?.PropertyT<ADT.Runtime.Json.JsonObject>("body"), out var __jsonBody) ? ADT.Models.Connection.FromJson(__jsonBody) : _body;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IArmConnectionResponse.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IArmConnectionResponse.</returns>
        public static ADT.Models.IArmConnectionResponse FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new ArmConnectionResponse(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ArmConnectionResponse" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ArmConnectionResponse" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
