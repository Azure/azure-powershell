...
namespace ADT.Models
{
    ...
    public partial class ReadOperationStatusProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IReadOperationStatusProperties.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IReadOperationStatusProperties.</returns>
        public static ADT.Models.IReadOperationStatusProperties FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new ReadOperationStatusProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="ReadOperationStatusProperties" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ReadOperationStatusProperties(ADT.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="ReadOperationStatusProperties" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ReadOperationStatusProperties" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
