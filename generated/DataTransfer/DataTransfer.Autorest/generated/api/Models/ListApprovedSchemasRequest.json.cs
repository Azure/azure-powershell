...
namespace ADT.Models
{
    ...
    public partial class ListApprovedSchemasRequest
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IListApprovedSchemasRequest.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IListApprovedSchemasRequest.</returns>
        public static ADT.Models.IListApprovedSchemasRequest FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new ListApprovedSchemasRequest(json) : null;
        }

        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="ListApprovedSchemasRequest" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ListApprovedSchemasRequest(ADT.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="ListApprovedSchemasRequest" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ListApprovedSchemasRequest" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
