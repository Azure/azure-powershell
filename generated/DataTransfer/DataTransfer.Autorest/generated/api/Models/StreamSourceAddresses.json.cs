...
namespace ADT.Models
{
    ...
    public partial class StreamSourceAddresses
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IStreamSourceAddresses.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IStreamSourceAddresses.</returns>
        public static ADT.Models.IStreamSourceAddresses FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new StreamSourceAddresses(json) : null;
        }

        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="StreamSourceAddresses" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal StreamSourceAddresses(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_sourceAddress = If( json?.PropertyT<ADT.Runtime.Json.JsonArray>("sourceAddresses"), out var __jsonSourceAddresses) ? If( __jsonSourceAddresses as ADT.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is ADT.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _sourceAddress;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="StreamSourceAddresses" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="StreamSourceAddresses" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
