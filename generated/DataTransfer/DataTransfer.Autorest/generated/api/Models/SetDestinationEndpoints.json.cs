...
namespace ADT.Models
{
    ...
    public partial class SetDestinationEndpoints
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.ISetDestinationEndpoints.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.ISetDestinationEndpoints.</returns>
        public static ADT.Models.ISetDestinationEndpoints FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new SetDestinationEndpoints(json) : null;
        }

        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="SetDestinationEndpoints" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SetDestinationEndpoints(ADT.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SetDestinationEndpoints" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SetDestinationEndpoints" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
