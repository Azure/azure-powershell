...
namespace ADT.Models
{
    ...
    public partial class RemoteEndpointSettings
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IRemoteEndpointSettings.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IRemoteEndpointSettings.</returns>
        public static ADT.Models.IRemoteEndpointSettings FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new RemoteEndpointSettings(json) : null;
        }

        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="RemoteEndpointSettings" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal RemoteEndpointSettings(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_endpoint = If( json?.PropertyT<ADT.Runtime.Json.JsonString>("endpoint"), out var __jsonEndpoint) ? (string)__jsonEndpoint : (string)_endpoint;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="RemoteEndpointSettings" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="RemoteEndpointSettings" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
        public ADT.Runtime.Json.JsonNode ToJson(ADT.Runtime.Json.JsonObject container, ADT.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._endpoint)?.ToString()) ? (ADT.Runtime.Json.JsonNode) new ADT.Runtime.Json.JsonString(this._endpoint.ToString()) : null, "endpoint" ,container.Add );
