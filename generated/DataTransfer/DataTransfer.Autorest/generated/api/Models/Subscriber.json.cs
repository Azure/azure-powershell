...
namespace ADT.Models
{
    ...
    public partial class Subscriber
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.ISubscriber.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.ISubscriber.</returns>
        public static ADT.Models.ISubscriber FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new Subscriber(json) : null;
        }

        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="Subscriber" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Subscriber(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_email = If( json?.PropertyT<ADT.Runtime.Json.JsonString>("email"), out var __jsonEmail) ? (string)__jsonEmail : (string)_email;}
            {_notification = If( json?.PropertyT<ADT.Runtime.Json.JsonNumber>("notifications"), out var __jsonNotifications) ? (long?)__jsonNotifications : _notification;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Subscriber" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Subscriber" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
        public ADT.Runtime.Json.JsonNode ToJson(ADT.Runtime.Json.JsonObject container, ADT.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._email)?.ToString()) ? (ADT.Runtime.Json.JsonNode) new ADT.Runtime.Json.JsonString(this._email.ToString()) : null, "email" ,container.Add );
            AddIf( null != this._notification ? (ADT.Runtime.Json.JsonNode)new ADT.Runtime.Json.JsonNumber((long)this._notification) : null, "notifications" ,container.Add );
