...
namespace ADT.Models
{
    ...
    public partial class ListFlowsByPipelineConnection
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IListFlowsByPipelineConnection.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IListFlowsByPipelineConnection.</returns>
        public static ADT.Models.IListFlowsByPipelineConnection FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new ListFlowsByPipelineConnection(json) : null;
        }

        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="ListFlowsByPipelineConnection" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ListFlowsByPipelineConnection(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_flow = If( json?.PropertyT<ADT.Runtime.Json.JsonArray>("flows"), out var __jsonFlows) ? If( __jsonFlows as ADT.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<ADT.Models.IFlow>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(ADT.Models.IFlow) (ADT.Models.Flow.FromJson(__u) )) ))() : null : _flow;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="ListFlowsByPipelineConnection" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ListFlowsByPipelineConnection" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
        public ADT.Runtime.Json.JsonNode ToJson(ADT.Runtime.Json.JsonObject container, ADT.Runtime.SerializationMode serializationMode)
        {
            ...
            if (null != this._flow)
            {
                ...
                foreach( var __x in this._flow )
                {
                    AddIf(__x?.ToJson(null, serializationMode) ,__w.Add);
                }
                container.Add("flows",__w);
            }
