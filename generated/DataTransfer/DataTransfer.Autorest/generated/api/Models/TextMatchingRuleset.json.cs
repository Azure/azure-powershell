...
namespace ADT.Models
{
    ...
    public partial class TextMatchingRuleset
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.ITextMatchingRuleset.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.ITextMatchingRuleset.</returns>
        public static ADT.Models.ITextMatchingRuleset FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new TextMatchingRuleset(json) : null;
        }

        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="TextMatchingRuleset" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal TextMatchingRuleset(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_deny = If( json?.PropertyT<ADT.Runtime.Json.JsonArray>("deny"), out var __jsonDeny) ? If( __jsonDeny as ADT.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<ADT.Models.ITextMatch>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(ADT.Models.ITextMatch) (ADT.Models.TextMatch.FromJson(__u) )) ))() : null : _deny;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="TextMatchingRuleset" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="TextMatchingRuleset" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
        public ADT.Runtime.Json.JsonNode ToJson(ADT.Runtime.Json.JsonObject container, ADT.Runtime.SerializationMode serializationMode)
        {
            ...
            if (null != this._deny)
            {
                ...
                foreach( var __x in this._deny )
                {
                    AddIf(__x?.ToJson(null, serializationMode) ,__w.Add);
                }
                container.Add("deny",__w);
            }
