...
namespace ADT.Models
{
    ...
    public partial class FlowProfilesListResult
    {
        ...
        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="FlowProfilesListResult" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal FlowProfilesListResult(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_value = If( json?.PropertyT<ADT.Runtime.Json.JsonArray>("value"), out var __jsonValue) ? If( __jsonValue as ADT.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<ADT.Models.IFlowProfileMetadata>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(ADT.Models.IFlowProfileMetadata) (ADT.Models.FlowProfileMetadata.FromJson(__u) )) ))() : null : _value;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IFlowProfilesListResult.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IFlowProfilesListResult.</returns>
        public static ADT.Models.IFlowProfilesListResult FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new FlowProfilesListResult(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="FlowProfilesListResult" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="FlowProfilesListResult" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
