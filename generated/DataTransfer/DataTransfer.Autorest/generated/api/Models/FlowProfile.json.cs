...
namespace ADT.Models
{
    ...
    public partial class FlowProfile
    {
        ...
        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="FlowProfile" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal FlowProfile(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<ADT.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? ADT.Models.FlowProfileProperties.FromJson(__jsonProperties) : _property;}
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IFlowProfile.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IFlowProfile.</returns>
        public static ADT.Models.IFlowProfile FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new FlowProfile(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="FlowProfile" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="FlowProfile" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
