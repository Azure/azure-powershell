...
namespace ADT.Models
{
    ...
    public partial class ConnectionIdList
    {
        ...
        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="ConnectionIdList" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ConnectionIdList(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_value = If( json?.PropertyT<ADT.Runtime.Json.JsonArray>("value"), out var __jsonValue) ? If( __jsonValue as ADT.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is ADT.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _value;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IConnectionIdList.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IConnectionIdList.</returns>
        public static ADT.Models.IConnectionIdList FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new ConnectionIdList(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ConnectionIdList" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ConnectionIdList" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
