...
namespace ADT.Models
{
    ...
    public partial class AntivirusRuleset
    {
        ...
        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="AntivirusRuleset" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal AntivirusRuleset(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_avSolution = If( json?.PropertyT<ADT.Runtime.Json.JsonArray>("avSolutions"), out var __jsonAvSolutions) ? If( __jsonAvSolutions as ADT.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is ADT.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _avSolution;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IAntivirusRuleset.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IAntivirusRuleset.</returns>
        public static ADT.Models.IAntivirusRuleset FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new AntivirusRuleset(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AntivirusRuleset" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AntivirusRuleset" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
