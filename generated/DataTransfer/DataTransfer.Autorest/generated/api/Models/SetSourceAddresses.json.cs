...
namespace ADT.Models
{
    ...
    public partial class SetSourceAddresses
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.ISetSourceAddresses.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.ISetSourceAddresses.</returns>
        public static ADT.Models.ISetSourceAddresses FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new SetSourceAddresses(json) : null;
        }

        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="SetSourceAddresses" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SetSourceAddresses(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_value = If( json?.PropertyT<ADT.Runtime.Json.JsonArray>("values"), out var __jsonValues) ? If( __jsonValues as ADT.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is ADT.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _value;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SetSourceAddresses" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SetSourceAddresses" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
