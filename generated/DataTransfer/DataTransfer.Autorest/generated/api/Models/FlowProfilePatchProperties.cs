...
namespace ADT.Models
{
    ...
    public partial class FlowProfilePatchProperties :
        ADT.Models.IFlowProfilePatchProperties,
        ADT.Models.IFlowProfilePatchPropertiesInternal
    {

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string ADT.Models.IFlowProfilePatchPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for Ruleset</summary>
        ADT.Models.IFlowProfileRulesets ADT.Models.IFlowProfilePatchPropertiesInternal.Ruleset { get => (this._ruleset = this._ruleset ?? new ADT.Models.FlowProfileRulesets()); set { {_ruleset = value;} } }

        /// <summary>Internal Acessors for RulesetAntiviru</summary>
        ADT.Models.IAntivirusRuleset ADT.Models.IFlowProfilePatchPropertiesInternal.RulesetAntiviru { get => ((ADT.Models.IFlowProfileRulesetsInternal)Ruleset).Antiviru; set => ((ADT.Models.IFlowProfileRulesetsInternal)Ruleset).Antiviru = value ?? null /* model class */; }

        /// <summary>Internal Acessors for RulesetArchive</summary>
        ADT.Models.IArchiveRuleset ADT.Models.IFlowProfilePatchPropertiesInternal.RulesetArchive { get => ((ADT.Models.IFlowProfileRulesetsInternal)Ruleset).Archive; set => ((ADT.Models.IFlowProfileRulesetsInternal)Ruleset).Archive = value ?? null /* model class */; }

        /// <summary>Internal Acessors for RulesetDataSize</summary>
        ADT.Models.IDataSizeRuleset ADT.Models.IFlowProfilePatchPropertiesInternal.RulesetDataSize { get => ((ADT.Models.IFlowProfileRulesetsInternal)Ruleset).DataSize; set => ((ADT.Models.IFlowProfileRulesetsInternal)Ruleset).DataSize = value ?? null /* model class */; }

        /// <summary>Internal Acessors for RulesetMimeFilter</summary>
        ADT.Models.IMimeFilterRuleset ADT.Models.IFlowProfilePatchPropertiesInternal.RulesetMimeFilter { get => ((ADT.Models.IFlowProfileRulesetsInternal)Ruleset).MimeFilter; set => ((ADT.Models.IFlowProfileRulesetsInternal)Ruleset).MimeFilter = value ?? null /* model class */; }

        /// <summary>Internal Acessors for RulesetTextMatching</summary>
        ADT.Models.ITextMatchingRuleset ADT.Models.IFlowProfilePatchPropertiesInternal.RulesetTextMatching { get => ((ADT.Models.IFlowProfileRulesetsInternal)Ruleset).TextMatching; set => ((ADT.Models.IFlowProfileRulesetsInternal)Ruleset).TextMatching = value ?? null /* model class */; }

        /// <summary>Internal Acessors for RulesetXmlFilter</summary>
        ADT.Models.IXmlFilterRuleset ADT.Models.IFlowProfilePatchPropertiesInternal.RulesetXmlFilter { get => ((ADT.Models.IFlowProfileRulesetsInternal)Ruleset).XmlFilter; set => ((ADT.Models.IFlowProfileRulesetsInternal)Ruleset).XmlFilter = value ?? null /* model class */; }
        ...
        /// <summary>Creates an new <see cref="FlowProfilePatchProperties" /> instance.</summary>
        public FlowProfilePatchProperties()
        {
    ...
    /// Represents the updatable properties of a FlowProfile.
    internal partial interface IFlowProfilePatchPropertiesInternal
