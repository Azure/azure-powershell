...
namespace ADT.Models
{
    ...
    public partial class MimeFilterRuleset
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IMimeFilterRuleset.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IMimeFilterRuleset.</returns>
        public static ADT.Models.IMimeFilterRuleset FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new MimeFilterRuleset(json) : null;
        }

        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="MimeFilterRuleset" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal MimeFilterRuleset(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_filter = If( json?.PropertyT<ADT.Runtime.Json.JsonArray>("filters"), out var __jsonFilters) ? If( __jsonFilters as ADT.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<ADT.Models.IMimeTypeFilter>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(ADT.Models.IMimeTypeFilter) (ADT.Models.MimeTypeFilter.FromJson(__u) )) ))() : null : _filter;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="MimeFilterRuleset" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MimeFilterRuleset" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
