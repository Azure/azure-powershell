...
namespace ADT.Models
{
    ...
    public partial class SetDestinationEndpointPorts
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.ISetDestinationEndpointPorts.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.ISetDestinationEndpointPorts.</returns>
        public static ADT.Models.ISetDestinationEndpointPorts FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new SetDestinationEndpointPorts(json) : null;
        }

        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="SetDestinationEndpointPorts" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SetDestinationEndpointPorts(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_port = If( json?.PropertyT<ADT.Runtime.Json.JsonArray>("ports"), out var __jsonPorts) ? If( __jsonPorts as ADT.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<long>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(long) (__u is ADT.Runtime.Json.JsonNumber __t ? (long)__t : default(long))) ))() : null : _port;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SetDestinationEndpointPorts" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SetDestinationEndpointPorts" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
        public ADT.Runtime.Json.JsonNode ToJson(ADT.Runtime.Json.JsonObject container, ADT.Runtime.SerializationMode serializationMode)
        {
            ...
            if (null != this._port)
            {
                ...
                {
                    AddIf((ADT.Runtime.Json.JsonNode)new ADT.Runtime.Json.JsonNumber(__x) ,__w.Add);
                }
