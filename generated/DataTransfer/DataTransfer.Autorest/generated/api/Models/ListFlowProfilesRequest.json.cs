...
namespace ADT.Models
{
    ...
    public partial class ListFlowProfilesRequest
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IListFlowProfilesRequest.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IListFlowProfilesRequest.</returns>
        public static ADT.Models.IListFlowProfilesRequest FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new ListFlowProfilesRequest(json) : null;
        }

        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="ListFlowProfilesRequest" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ListFlowProfilesRequest(ADT.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="ListFlowProfilesRequest" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ListFlowProfilesRequest" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
