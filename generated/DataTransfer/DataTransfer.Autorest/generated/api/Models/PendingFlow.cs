...
namespace ADT.Models
{
    ...
    public partial class PendingFlow :
        ...
        ADT.Models.IPendingFlowInternal
    {

        /// <summary>Internal Acessors for ApiFlowOption</summary>
        ADT.Models.IApiFlowOptions ADT.Models.IPendingFlowInternal.ApiFlowOption { get => (this._apiFlowOption = this._apiFlowOption ?? new ADT.Models.ApiFlowOptions()); set { {_apiFlowOption = value;} } }

        /// <summary>Internal Acessors for ApiFlowOptionRemoteEndpointSetting</summary>
        ADT.Models.IRemoteEndpointSettings ADT.Models.IPendingFlowInternal.ApiFlowOptionRemoteEndpointSetting { get => ((ADT.Models.IApiFlowOptionsInternal)ApiFlowOption).RemoteEndpointSetting; set => ((ADT.Models.IApiFlowOptionsInternal)ApiFlowOption).RemoteEndpointSetting = value ?? null /* model class */; }

        /// <summary>Internal Acessors for Connection</summary>
        ADT.Models.ISelectedResource ADT.Models.IPendingFlowInternal.Connection { get => (this._connection = this._connection ?? new ADT.Models.SelectedResource()); set { {_connection = value;} } }

        /// <summary>Internal Acessors for ConnectionId</summary>
        string ADT.Models.IPendingFlowInternal.ConnectionId { get => this._connectionId; set { {_connectionId = value;} } }

        /// <summary>Internal Acessors for FlowId</summary>
        string ADT.Models.IPendingFlowInternal.FlowId { get => this._flowId; set { {_flowId = value;} } }

        /// <summary>Internal Acessors for FlowProfile</summary>
        ADT.Models.IFlowProfileMetadata ADT.Models.IPendingFlowInternal.FlowProfile { get => (this._flowProfile = this._flowProfile ?? new ADT.Models.FlowProfileMetadata()); set { {_flowProfile = value;} } }

        /// <summary>Internal Acessors for ForceDisabledStatus</summary>
        System.Collections.Generic.List<string> ADT.Models.IPendingFlowInternal.ForceDisabledStatus { get => this._forceDisabledStatus; set { {_forceDisabledStatus = value;} } }

        /// <summary>Internal Acessors for Id</summary>
        string ADT.Models.IPendingFlowInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for LinkStatus</summary>
        string ADT.Models.IPendingFlowInternal.LinkStatus { get => this._linkStatus; set { {_linkStatus = value;} } }

        /// <summary>Internal Acessors for LinkedFlowId</summary>
        string ADT.Models.IPendingFlowInternal.LinkedFlowId { get => this._linkedFlowId; set { {_linkedFlowId = value;} } }

        /// <summary>Internal Acessors for MessagingOption</summary>
        ADT.Models.IMessagingOptions ADT.Models.IPendingFlowInternal.MessagingOption { get => (this._messagingOption = this._messagingOption ?? new ADT.Models.MessagingOptions()); set { {_messagingOption = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string ADT.Models.IPendingFlowInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string ADT.Models.IPendingFlowInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for Schema</summary>
        ADT.Models.ISchema ADT.Models.IPendingFlowInternal.Schema { get => (this._schema = this._schema ?? new ADT.Models.Schema()); set { {_schema = value;} } }

        /// <summary>Internal Acessors for SourceAddress</summary>
        ADT.Models.IStreamSourceAddresses ADT.Models.IPendingFlowInternal.SourceAddress { get => (this._sourceAddress = this._sourceAddress ?? new ADT.Models.StreamSourceAddresses()); set { {_sourceAddress = value;} } }

        /// <summary>Internal Acessors for SubscriptionId</summary>
        string ADT.Models.IPendingFlowInternal.SubscriptionId { get => this._subscriptionId; set { {_subscriptionId = value;} } }

        /// <summary>Internal Acessors for SystemData</summary>
        ADT.Models.ISystemData ADT.Models.IPendingFlowInternal.SystemData { get => (this._systemData = this._systemData ?? new ADT.Models.SystemData()); set { {_systemData = value;} } }

        /// <summary>Internal Acessors for SystemDataCreatedAt</summary>
        global::System.DateTime? ADT.Models.IPendingFlowInternal.SystemDataCreatedAt { get => ((ADT.Models.ISystemDataInternal)SystemData).CreatedAt; set => ((ADT.Models.ISystemDataInternal)SystemData).CreatedAt = value ?? default(global::System.DateTime); }

        /// <summary>Internal Acessors for SystemDataCreatedBy</summary>
        string ADT.Models.IPendingFlowInternal.SystemDataCreatedBy { get => ((ADT.Models.ISystemDataInternal)SystemData).CreatedBy; set => ((ADT.Models.ISystemDataInternal)SystemData).CreatedBy = value ?? null; }

        /// <summary>Internal Acessors for SystemDataCreatedByType</summary>
        string ADT.Models.IPendingFlowInternal.SystemDataCreatedByType { get => ((ADT.Models.ISystemDataInternal)SystemData).CreatedByType; set => ((ADT.Models.ISystemDataInternal)SystemData).CreatedByType = value ?? null; }

        /// <summary>Internal Acessors for SystemDataLastModifiedAt</summary>
        global::System.DateTime? ADT.Models.IPendingFlowInternal.SystemDataLastModifiedAt { get => ((ADT.Models.ISystemDataInternal)SystemData).LastModifiedAt; set => ((ADT.Models.ISystemDataInternal)SystemData).LastModifiedAt = value ?? default(global::System.DateTime); }

        /// <summary>Internal Acessors for SystemDataLastModifiedBy</summary>
        string ADT.Models.IPendingFlowInternal.SystemDataLastModifiedBy { get => ((ADT.Models.ISystemDataInternal)SystemData).LastModifiedBy; set => ((ADT.Models.ISystemDataInternal)SystemData).LastModifiedBy = value ?? null; }

        /// <summary>Internal Acessors for SystemDataLastModifiedByType</summary>
        string ADT.Models.IPendingFlowInternal.SystemDataLastModifiedByType { get => ((ADT.Models.ISystemDataInternal)SystemData).LastModifiedByType; set => ((ADT.Models.ISystemDataInternal)SystemData).LastModifiedByType = value ?? null; }

        /// <summary>Internal Acessors for Type</summary>
        string ADT.Models.IPendingFlowInternal.Type { get => this._type; set { {_type = value;} } }
        ...
        /// <summary>Connection ID of the pending flow.</summary>
        [ADT.Origin(ADT.PropertyOrigin.Owned)]
        public string ConnectionId { get => this._connectionId; }
        ...
        [ADT.Origin(ADT.PropertyOrigin.Inlined)]
        public string SelectedResourceId { get => ((ADT.Models.ISelectedResourceInternal)Connection).Id; set => ((ADT.Models.ISelectedResourceInternal)Connection).Id = value ?? null; }
        ...
        /// <summary>Subscription ID of the pending flow.</summary>
        [ADT.Origin(ADT.PropertyOrigin.Owned)]
        ...
        private ADT.Models.IPendingFlowTags _tag;

        /// <summary>Resource tags.</summary>
        [ADT.Origin(ADT.PropertyOrigin.Owned)]
        public ADT.Models.IPendingFlowTags Tag { get => (this._tag = this._tag ?? new ADT.Models.PendingFlowTags()); set => this._tag = value; }
        ...
        /// <summary>Creates an new <see cref="PendingFlow" /> instance.</summary>
        public PendingFlow()
        {
        ...
        ADT.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        string SelectedResourceId { get; set; }
        /// <summary>Service Bus Queue ID</summary>
        [ADT.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(ADT.Models.IPendingFlowTags) })]
        ADT.Models.IPendingFlowTags Tag { get; set; }
        /// <summary>
        /// The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
        /// </summary>
        [ADT.Runtime.Info(
    ...
    /// Pending flow object
    internal partial interface IPendingFlowInternal
