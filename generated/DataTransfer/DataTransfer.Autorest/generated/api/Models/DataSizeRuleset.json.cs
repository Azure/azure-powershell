...
namespace ADT.Models
{
    ...
    public partial class DataSizeRuleset
    {
        ...
        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="DataSizeRuleset" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal DataSizeRuleset(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_maximum = If( json?.PropertyT<ADT.Runtime.Json.JsonNumber>("maximum"), out var __jsonMaximum) ? (long?)__jsonMaximum : _maximum;}
            {_minimum = If( json?.PropertyT<ADT.Runtime.Json.JsonNumber>("minimum"), out var __jsonMinimum) ? (long?)__jsonMinimum : _minimum;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IDataSizeRuleset.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IDataSizeRuleset.</returns>
        public static ADT.Models.IDataSizeRuleset FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new DataSizeRuleset(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="DataSizeRuleset" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="DataSizeRuleset" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
        public ADT.Runtime.Json.JsonNode ToJson(ADT.Runtime.Json.JsonObject container, ADT.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._maximum ? (ADT.Runtime.Json.JsonNode)new ADT.Runtime.Json.JsonNumber((long)this._maximum) : null, "maximum" ,container.Add );
            AddIf( null != this._minimum ? (ADT.Runtime.Json.JsonNode)new ADT.Runtime.Json.JsonNumber((long)this._minimum) : null, "minimum" ,container.Add );
