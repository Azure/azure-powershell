...
namespace ADT.Models
{
    ...
    public partial class UserAssignedIdentity :
        ADT.Models.IUserAssignedIdentity,
        ADT.Models.IUserAssignedIdentityInternal
    {

        /// <summary>Internal Acessors for ClientId</summary>
        string ADT.Models.IUserAssignedIdentityInternal.ClientId { get => this._clientId; set { {_clientId = value;} } }

        /// <summary>Internal Acessors for PrincipalId</summary>
        string ADT.Models.IUserAssignedIdentityInternal.PrincipalId { get => this._principalId; set { {_principalId = value;} } }
