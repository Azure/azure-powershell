...
namespace ADT.Models
{
    ...
    public partial class MimeTypeFilter
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IMimeTypeFilter.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IMimeTypeFilter.</returns>
        public static ADT.Models.IMimeTypeFilter FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new MimeTypeFilter(json) : null;
        }

        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="MimeTypeFilter" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal MimeTypeFilter(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_media = If( json?.PropertyT<ADT.Runtime.Json.JsonString>("media"), out var __jsonMedia) ? (string)__jsonMedia : (string)_media;}
            {_extension = If( json?.PropertyT<ADT.Runtime.Json.JsonArray>("extensions"), out var __jsonExtensions) ? If( __jsonExtensions as ADT.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is ADT.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _extension;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="MimeTypeFilter" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MimeTypeFilter" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
        public ADT.Runtime.Json.JsonNode ToJson(ADT.Runtime.Json.JsonObject container, ADT.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._media)?.ToString()) ? (ADT.Runtime.Json.JsonNode) new ADT.Runtime.Json.JsonString(this._media.ToString()) : null, "media" ,container.Add );
