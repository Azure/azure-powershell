...
namespace ADT.Models
{
    ...
    public partial class SchemasListResult
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.ISchemasListResult.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.ISchemasListResult.</returns>
        public static ADT.Models.ISchemasListResult FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new SchemasListResult(json) : null;
        }

        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="SchemasListResult" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SchemasListResult(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_value = If( json?.PropertyT<ADT.Runtime.Json.JsonArray>("value"), out var __jsonValue) ? If( __jsonValue as ADT.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<ADT.Models.ISchema>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(ADT.Models.ISchema) (ADT.Models.Schema.FromJson(__u) )) ))() : null : _value;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SchemasListResult" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SchemasListResult" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
