...
namespace ADT.Models
{
    ...
    public partial class PipelinesPatchProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IPipelinesPatchProperties.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IPipelinesPatchProperties.</returns>
        public static ADT.Models.IPipelinesPatchProperties FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new PipelinesPatchProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="PipelinesPatchProperties" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PipelinesPatchProperties(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_flowType = If( json?.PropertyT<ADT.Runtime.Json.JsonArray>("flowTypes"), out var __jsonFlowTypes) ? If( __jsonFlowTypes as ADT.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is ADT.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _flowType;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PipelinesPatchProperties" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PipelinesPatchProperties" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
