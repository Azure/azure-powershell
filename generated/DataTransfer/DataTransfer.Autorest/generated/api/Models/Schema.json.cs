...
namespace ADT.Models
{
    ...
    public partial class Schema
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.ISchema.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.ISchema.</returns>
        public static ADT.Models.ISchema FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new Schema(json) : null;
        }

        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="Schema" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Schema(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_content = If( json?.PropertyT<ADT.Runtime.Json.JsonString>("content"), out var __jsonContent) ? (string)__jsonContent : (string)_content;}
            ...
            {_uri = If( json?.PropertyT<ADT.Runtime.Json.JsonString>("schemaUri"), out var __jsonSchemaUri) ? (string)__jsonSchemaUri : (string)_uri;}
            {_type = If( json?.PropertyT<ADT.Runtime.Json.JsonString>("schemaType"), out var __jsonSchemaType) ? (string)__jsonSchemaType : (string)_type;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Schema" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Schema" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
        public ADT.Runtime.Json.JsonNode ToJson(ADT.Runtime.Json.JsonObject container, ADT.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._content)?.ToString()) ? (ADT.Runtime.Json.JsonNode) new ADT.Runtime.Json.JsonString(this._content.ToString()) : null, "content" ,container.Add );
            ...
            AddIf( null != (((object)this._uri)?.ToString()) ? (ADT.Runtime.Json.JsonNode) new ADT.Runtime.Json.JsonString(this._uri.ToString()) : null, "schemaUri" ,container.Add );
            AddIf( null != (((object)this._type)?.ToString()) ? (ADT.Runtime.Json.JsonNode) new ADT.Runtime.Json.JsonString(this._type.ToString()) : null, "schemaType" ,container.Add );
