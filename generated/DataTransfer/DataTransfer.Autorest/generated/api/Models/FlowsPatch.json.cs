...
namespace ADT.Models
{
    ...
    public partial class FlowsPatch
    {
        ...
        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="FlowsPatch" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal FlowsPatch(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_tag = If( json?.PropertyT<ADT.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? ADT.Models.FlowsPatchTags.FromJson(__jsonTags) : _tag;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IFlowsPatch.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IFlowsPatch.</returns>
        public static ADT.Models.IFlowsPatch FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new FlowsPatch(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="FlowsPatch" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="FlowsPatch" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
