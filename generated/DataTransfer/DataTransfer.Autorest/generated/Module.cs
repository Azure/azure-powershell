...
namespace ADT
{
    ...
    public partial class Module
    {
        ...
        private static ADT.Module _instance;

        /// <summary>the ISendAsync pipeline instance</summary>
        private ADT.Runtime.HttpPipeline _pipeline;

        /// <summary>the ISendAsync pipeline instance (when proxy is enabled)</summary>
        private ADT.Runtime.HttpPipeline _pipelineWithProxy;
        ...
        public ADT.DataTransfer ClientAPI { get; set; }
        ...
        public static ADT.Module Instance { get { if (_instance == null) { lock (_singletonLock) { if (_instance == null) { _instance = new Module(); }}} return _instance; } }

        /// <summary>The Name of this module</summary>
        public string Name => @"Az.DataTransfer";
        ...
        public string ResourceId => @"Az.DataTransfer";
        ...
        partial void AfterCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref ADT.Runtime.HttpPipeline pipeline);

        /// <param name="invocationInfo">The <see cref="System.Management.Automation.InvocationInfo" /> from the cmdlet</param>
        /// <param name="pipeline">The HttpPipeline for the request</param>

        partial void BeforeCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref ADT.Runtime.HttpPipeline pipeline);
        ...
        /// <returns>An instance of ADT.Runtime.HttpPipeline for the remote call.</returns>
        public ADT.Runtime.HttpPipeline CreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, string correlationId, string processRecordId, string parameterSetName = null, global::System.Collections.Generic.IDictionary<string,object> extensibleParameters = null)
        {
            ADT.Runtime.HttpPipeline pipeline = null;
        ...
        {
            // constructor
            ClientAPI = new ADT.DataTransfer();
            _handler.Proxy = _webProxy;
            _pipeline = new ADT.Runtime.HttpPipeline(new ADT.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient()));
            _pipelineWithProxy = new ADT.Runtime.HttpPipeline(new ADT.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient(_handler)));
        }
