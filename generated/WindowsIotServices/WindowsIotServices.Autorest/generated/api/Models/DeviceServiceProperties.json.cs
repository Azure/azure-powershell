...
namespace Microsoft.Azure.PowerShell.Cmdlets.WindowsIotServices.Models
{
    ...
    public partial class DeviceServiceProperties
    {
        ...
        internal DeviceServiceProperties(Microsoft.Azure.PowerShell.Cmdlets.WindowsIotServices.Runtime.Json.JsonObject json)
        {
            ...
            {_note = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WindowsIotServices.Runtime.Json.JsonString>("notes"), out var __jsonNotes) ? (string)__jsonNotes : (string)_note;}
            ...
            {_quantity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WindowsIotServices.Runtime.Json.JsonNumber>("quantity"), out var __jsonQuantity) ? (long?)__jsonQuantity : _quantity;}
            {_billingDomainName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WindowsIotServices.Runtime.Json.JsonString>("billingDomainName"), out var __jsonBillingDomainName) ? (string)__jsonBillingDomainName : (string)_billingDomainName;}
            {_adminDomainName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WindowsIotServices.Runtime.Json.JsonString>("adminDomainName"), out var __jsonAdminDomainName) ? (string)__jsonAdminDomainName : (string)_adminDomainName;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WindowsIotServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.WindowsIotServices.Models.IDeviceServiceProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.WindowsIotServices.Models.IDeviceServiceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.WindowsIotServices.Models.IDeviceServiceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.WindowsIotServices.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.WindowsIotServices.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.WindowsIotServices.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.WindowsIotServices.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.WindowsIotServices.Runtime.SerializationMode.IncludeRead))
            {
