...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetAuthorizationRule=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/queues/{queueName}/authorizationRules/{authorizationRuleName}"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzServiceBusQueueAuthorizationRule_Get")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Description(@"Gets an authorization rule for a queue by rule name.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.ExternalDocs(@"https://msdn.microsoft.com/en-us/library/azure/mt705611.aspx", @"")]
    ...
    public partial class GetAzServiceBusQueueAuthorizationRule_Get : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzServiceBusQueueAuthorizationRule_Get" /> cmdlet class.
        /// </summary>
        public GetAzServiceBusQueueAuthorizationRule_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.QueuesGetAuthorizationRule(SubscriptionId, ResourceGroupName, NamespaceName, QueueName, Name, onOk, onDefault, this, Pipeline);
