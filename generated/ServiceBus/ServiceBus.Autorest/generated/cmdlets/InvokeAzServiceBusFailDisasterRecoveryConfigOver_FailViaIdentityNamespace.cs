...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzServiceBusFailDisasterRecoveryConfigOver_FailViaIdentityNamespace", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzServiceBusFailDisasterRecoveryConfigOver_FailViaIdentityNamespace : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.INamespaceFailoverProperties _parameter;

        /// <summary>
        /// Safe failover is to indicate the service should wait for pending replication to finish before switching to the secondary.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Safe failover is to indicate the service should wait for pending replication to finish before switching to the secondary.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.INamespaceFailoverProperties) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.INamespaceFailoverProperties Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzServiceBusFailDisasterRecoveryConfigOver_FailViaIdentityNamespace"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzServiceBusFailDisasterRecoveryConfigOver_FailViaIdentityNamespace()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (NamespaceInputObject?.Id != null)
                    {
                        ...
                        await this.Client.DisasterRecoveryConfigsFailOverViaIdentity(NamespaceInputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.DisasterRecoveryConfigsFailOver(NamespaceInputObject.SubscriptionId ?? null, NamespaceInputObject.ResourceGroupName ?? null, NamespaceInputObject.NamespaceName ?? null, Name, Parameter, onOk, onDefault, this, Pipeline);
                    }
