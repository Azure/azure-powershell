...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models
{
    ...
    public partial class ServiceBusIdentity
    {
        ...
        internal ServiceBusIdentity(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonObject json)
        {
            ...
            {_resourceAssociationName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonString>("resourceAssociationName"), out var __jsonResourceAssociationName) ? (string)__jsonResourceAssociationName : (string)_resourceAssociationName;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._resourceAssociationName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonString(this._resourceAssociationName.ToString()) : null, "resourceAssociationName" ,container.Add );
