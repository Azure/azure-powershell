...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models
{
    ...
    public partial class PrivateLinkResource :
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IPrivateLinkResource,
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IPrivateLinkResourceInternal
    {
        ...
        public string GroupId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IPrivateLinkResourcePropertiesInternal)Property).GroupId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IPrivateLinkResourcePropertiesInternal)Property).GroupId = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IPrivateLinkResourceProperties Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IPrivateLinkResourceInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.PrivateLinkResourceProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IPrivateLinkResourceProperties _property;

        /// <summary>Properties of the private link resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IPrivateLinkResourceProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.PrivateLinkResourceProperties()); set => this._property = value; }

        /// <summary>Required Members</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> RequiredMember { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IPrivateLinkResourcePropertiesInternal)Property).RequiredMember; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IPrivateLinkResourcePropertiesInternal)Property).RequiredMember = value ?? null /* arrayOf */; }
...

    {
        ...
        string Name { get; set; }
        /// <summary>Properties of the private link resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IPrivateLinkResourceProperties Property { get; set; }
        /// <summary>Required Members</summary>
        System.Collections.Generic.List<string> RequiredMember { get; set; }
        /// <summary>Required Zone Names</summary>
        System.Collections.Generic.List<string> RequiredZoneName { get; set; }
