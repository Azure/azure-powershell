...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models
{
    ...
    public partial class GeoDataReplicationProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IGeoDataReplicationProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IGeoDataReplicationPropertiesInternal
    {

        /// <summary>Backing field for <see cref="Location" /> property.</summary>
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.INamespaceReplicaLocation> _location;
        ...
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.INamespaceReplicaLocation> Location { get => this._location; set => this._location = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.INamespaceReplicaLocation> Location { get; set; }
        /// <summary>
        /// The maximum acceptable lag for data replication operations from the primary replica to a quorum of secondary replicas.
        /// When the lag exceeds the configured amount, operations on the primary replica will be failed. The allowed values are 0
        /// and 5 minutes to 1 day.
