...
namespace Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models
{
    ...
    public partial class MonitoringSettingProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.IMonitoringSettingProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.IMonitoringSettingProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.IMonitoringSettingProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonNode node)
        {
        ...
        internal MonitoringSettingProperties(Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonObject json)
        {
            ...
            {_error = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonObject>("error"), out var __jsonError) ? Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.Error.FromJson(__jsonError) : _error;}
            {_appInsightsAgentVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonObject>("appInsightsAgentVersions"), out var __jsonAppInsightsAgentVersions) ? Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.ApplicationInsightsAgentVersions.FromJson(__jsonAppInsightsAgentVersions) : _appInsightsAgentVersion;}
            ...
            {_traceEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonBoolean>("traceEnabled"), out var __jsonTraceEnabled) ? (bool?)__jsonTraceEnabled : _traceEnabled;}
            {_appInsightsInstrumentationKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonString>("appInsightsInstrumentationKey"), out var __jsonAppInsightsInstrumentationKey) ? (string)__jsonAppInsightsInstrumentationKey : (string)_appInsightsInstrumentationKey;}
            {_appInsightsSamplingRate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonNumber>("appInsightsSamplingRate"), out var __jsonAppInsightsSamplingRate) ? (double?)__jsonAppInsightsSamplingRate : _appInsightsSamplingRate;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._appInsightsAgentVersion ? (Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonNode) this._appInsightsAgentVersion.ToJson(null,serializationMode) : null, "appInsightsAgentVersions" ,container.Add );
            ...
            AddIf( null != this._appInsightsSamplingRate ? (Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonNumber((double)this._appInsightsSamplingRate) : null, "appInsightsSamplingRate" ,container.Add );
