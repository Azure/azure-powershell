...
namespace Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models
{
    ...
    public partial class NetworkProfile
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.INetworkProfile.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.INetworkProfile.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.INetworkProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonNode node)
        {
        ...
        internal NetworkProfile(Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonObject json)
        {
            ...
            {_outboundIP = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonObject>("outboundIPs"), out var __jsonOutboundIPs) ? Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.NetworkProfileOutboundIPs.FromJson(__jsonOutboundIPs) : _outboundIP;}
            {_serviceRuntimeSubnetId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonString>("serviceRuntimeSubnetId"), out var __jsonServiceRuntimeSubnetId) ? (string)__jsonServiceRuntimeSubnetId : (string)_serviceRuntimeSubnetId;}
            {_appSubnetId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonString>("appSubnetId"), out var __jsonAppSubnetId) ? (string)__jsonAppSubnetId : (string)_appSubnetId;}
            {_serviceCidr = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonString>("serviceCidr"), out var __jsonServiceCidr) ? (string)__jsonServiceCidr : (string)_serviceCidr;}
            {_serviceRuntimeNetworkResourceGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonString>("serviceRuntimeNetworkResourceGroup"), out var __jsonServiceRuntimeNetworkResourceGroup) ? (string)__jsonServiceRuntimeNetworkResourceGroup : (string)_serviceRuntimeNetworkResourceGroup;}
            {_appNetworkResourceGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonString>("appNetworkResourceGroup"), out var __jsonAppNetworkResourceGroup) ? (string)__jsonAppNetworkResourceGroup : (string)_appNetworkResourceGroup;}
            {_requiredTraffic = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonArray>("requiredTraffics"), out var __jsonRequiredTraffics) ? If( __jsonRequiredTraffics as Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.IRequiredTraffic>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.IRequiredTraffic) (Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.RequiredTraffic.FromJson(__u) )) ))() : null : _requiredTraffic;}
            AfterFromJson(json);
        }
