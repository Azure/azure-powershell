...
namespace Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.Api20220401
{
    ...
    public partial class DeploymentSettings
    {
        ...
        internal DeploymentSettings(Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonObject json)
        {
            ...
            {_resourceRequest = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonObject>("resourceRequests"), out var __jsonResourceRequests) ? Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.Api20220401.ResourceRequests.FromJson(__jsonResourceRequests) : ResourceRequest;}
            {_environmentVariable = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonObject>("environmentVariables"), out var __jsonEnvironmentVariables) ? Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.Api20220401.DeploymentSettingsEnvironmentVariables.FromJson(__jsonEnvironmentVariables) : EnvironmentVariable;}
            {_addonConfig = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonObject>("addonConfigs"), out var __jsonAddonConfigs) ? Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.Api20220401.DeploymentSettingsAddonConfigs.FromJson(__jsonAddonConfigs) : AddonConfig;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.Api20220401.IDeploymentSettings.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.Api20220401.IDeploymentSettings.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.Api20220401.IDeploymentSettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Runtime.Json.JsonNode node)
        {
