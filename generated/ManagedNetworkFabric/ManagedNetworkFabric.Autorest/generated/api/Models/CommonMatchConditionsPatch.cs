...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.ICommonMatchConditionsPatchInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IIPMatchConditionPatch _iPCondition;

        /// <summary>IP condition that needs to be matched.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IIPMatchConditionPatch IPCondition { get => (this._iPCondition = this._iPCondition ?? new Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IPMatchConditionPatch()); set => this._iPCondition = value; }
        ...
        public System.Collections.Generic.List<string> IPConditionIpgroupName { get => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IIPMatchConditionPatchInternal)IPCondition).IPGroupName; set => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IIPMatchConditionPatchInternal)IPCondition).IPGroupName = value ?? null /* arrayOf */; }

        /// <summary>The list of IP Prefixes that need to be matched.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> IPConditionIpprefixValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IIPMatchConditionPatchInternal)IPCondition).IPPrefixValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IIPMatchConditionPatchInternal)IPCondition).IPPrefixValue = value ?? null /* arrayOf */; }

        /// <summary>IP Prefix Type that needs to be matched.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.PropertyOrigin.Inlined)]
        public string IPConditionPrefixType { get => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IIPMatchConditionPatchInternal)IPCondition).PrefixType; set => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IIPMatchConditionPatchInternal)IPCondition).PrefixType = value ?? null; }

        /// <summary>IP Address type that needs to be matched.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.PropertyOrigin.Inlined)]
        public string IPConditionType { get => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IIPMatchConditionPatchInternal)IPCondition).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IIPMatchConditionPatchInternal)IPCondition).Type = value ?? null; }

        /// <summary>Internal Acessors for IPCondition</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IIPMatchConditionPatch Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.ICommonMatchConditionsPatchInternal.IPCondition { get => (this._iPCondition = this._iPCondition ?? new Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IPMatchConditionPatch()); set { {_iPCondition = value;} } }

        /// <summary>Internal Acessors for VlanMatchCondition</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IVlanMatchConditionPatch Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.ICommonMatchConditionsPatchInternal.VlanMatchCondition { get => (this._vlanMatchCondition = this._vlanMatchCondition ?? new Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.VlanMatchConditionPatch()); set { {_vlanMatchCondition = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IVlanMatchConditionPatch _vlanMatchCondition;

        /// <summary>Vlan match condition that needs to be matched.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IVlanMatchConditionPatch VlanMatchCondition { get => (this._vlanMatchCondition = this._vlanMatchCondition ?? new Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.VlanMatchConditionPatch()); set => this._vlanMatchCondition = value; }

        /// <summary>
        /// List of inner vlans that need to be matched.Inputs can be single vlan or the range of vlans.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> VlanMatchConditionInnerVlan { get => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IVlanMatchConditionPatchInternal)VlanMatchCondition).InnerVlan; set => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IVlanMatchConditionPatchInternal)VlanMatchCondition).InnerVlan = value ?? null /* arrayOf */; }

        /// <summary>
        /// List of vlans that need to be matched. Inputs can be single vlan or the range of vlans.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> VlanMatchConditionVlan { get => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IVlanMatchConditionPatchInternal)VlanMatchCondition).Vlan; set => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IVlanMatchConditionPatchInternal)VlanMatchCondition).Vlan = value ?? null /* arrayOf */; }

        /// <summary>List of vlan group names that need to be matched.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> VlanMatchConditionVlanGroupName { get => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IVlanMatchConditionPatchInternal)VlanMatchCondition).VlanGroupName; set => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IVlanMatchConditionPatchInternal)VlanMatchCondition).VlanGroupName = value ?? null /* arrayOf */; }

        /// <summary>Creates an new <see cref="CommonMatchConditionsPatch" /> instance.</summary>
    ...
    /// Defines the common match conditions of the ACL and Network Tap Rule.
    internal partial interface ICommonMatchConditionsPatchInternal

    {
        /// <summary>IP condition that needs to be matched.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IIPMatchConditionPatch IPCondition { get; set; }
        /// <summary>The List of IP Group Names that need to be matched.</summary>
        System.Collections.Generic.List<string> IPConditionIpgroupName { get; set; }
        /// <summary>The list of IP Prefixes that need to be matched.</summary>
        System.Collections.Generic.List<string> IPConditionIpprefixValue { get; set; }
        ...
        System.Collections.Generic.List<string> ProtocolType { get; set; }
        /// <summary>Vlan match condition that needs to be matched.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IVlanMatchConditionPatch VlanMatchCondition { get; set; }
        /// <summary>
        /// List of inner vlans that need to be matched.Inputs can be single vlan or the range of vlans.
        /// </summary>
        System.Collections.Generic.List<string> VlanMatchConditionInnerVlan { get; set; }
