...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models
{
    ...
    public partial class CommonPostActionResponseForDeviceRoCommands :
        Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.ICommonPostActionResponseForDeviceRoCommands,
        Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.ICommonPostActionResponseForDeviceRoCommandsInternal
    {
        ...
        /// <summary>Backing field for <see cref="DeviceConfigurationPreview" /> property.</summary>
        private string _deviceConfigurationPreview;

        /// <summary>Device RO command Response limited to 4000 characters.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.PropertyOrigin.Owned)]
        public string DeviceConfigurationPreview { get => this._deviceConfigurationPreview; set => this._deviceConfigurationPreview = value; }

        /// <summary>Internal Acessors for ConfigurationState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.ICommonPostActionResponseForDeviceRoCommandsInternal.ConfigurationState { get => this._configurationState; set { {_configurationState = value;} } }
        ...
        /// <summary>
        /// Creates an new <see cref="CommonPostActionResponseForDeviceRoCommands" /> instance.
        /// </summary>
        public CommonPostActionResponseForDeviceRoCommands()
        {

        }
    }
    /// Common response for device Ro Commands.
    public partial interface ICommonPostActionResponseForDeviceRoCommands :
    ...
    /// Common response for device Ro Commands.
    internal partial interface ICommonPostActionResponseForDeviceRoCommandsInternal
