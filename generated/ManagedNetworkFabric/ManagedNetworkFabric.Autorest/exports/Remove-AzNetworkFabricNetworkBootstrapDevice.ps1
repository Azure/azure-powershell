...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/remove-aznetworkfabricnetworkbootstrapdevice
#>
function Remove-AzNetworkFabricNetworkBootstrapDevice {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ManagedNetworkFabric.private\Remove-AzNetworkFabricNetworkBootstrapDevice_Delete';
            DeleteViaIdentity = 'Az.ManagedNetworkFabric.private\Remove-AzNetworkFabricNetworkBootstrapDevice_DeleteViaIdentity';
        }
