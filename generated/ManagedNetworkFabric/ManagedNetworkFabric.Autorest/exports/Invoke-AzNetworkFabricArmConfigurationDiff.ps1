...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricarmconfigurationdiff
#>
function Invoke-AzNetworkFabricArmConfigurationDiff {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IArmConfigurationDiffOperationResponse])]
[CmdletBinding(DefaultParameterSetName='Arm', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Arm', Mandatory)]
    ...
    [Parameter(ParameterSetName='ArmViaIdentity', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IManagedNetworkFabricIdentity]
    # Identity Parameter
    ${InputObject},
...
begin {
    try {
        ...
        $mapping = @{
            Arm = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricArmConfigurationDiff_Arm';
            ArmViaIdentity = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricArmConfigurationDiff_ArmViaIdentity';
        }
        if (('Arm') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId') ) {
            if ($testPlayback) {
