...
BODY <IDeviceRoCommand>: Provide the RO command
...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/start-aznetworkfabricnetworkdevicerocommand
#>
function Start-AzNetworkFabricNetworkDeviceRoCommand {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.ICommonPostActionResponseForDeviceRoCommandsOperationStatusResult])]
...
begin {
    try {
        ...
        $mapping = @{
            Run = 'Az.ManagedNetworkFabric.private\Start-AzNetworkFabricNetworkDeviceRoCommand_Run';
            RunExpanded = 'Az.ManagedNetworkFabric.private\Start-AzNetworkFabricNetworkDeviceRoCommand_RunExpanded';
            RunViaIdentity = 'Az.ManagedNetworkFabric.private\Start-AzNetworkFabricNetworkDeviceRoCommand_RunViaIdentity';
            RunViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Start-AzNetworkFabricNetworkDeviceRoCommand_RunViaIdentityExpanded';
            RunViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Start-AzNetworkFabricNetworkDeviceRoCommand_RunViaJsonFilePath';
            RunViaJsonString = 'Az.ManagedNetworkFabric.private\Start-AzNetworkFabricNetworkDeviceRoCommand_RunViaJsonString';
        }
