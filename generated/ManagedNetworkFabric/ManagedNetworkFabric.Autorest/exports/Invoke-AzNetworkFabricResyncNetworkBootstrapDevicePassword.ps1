...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricresyncnetworkbootstrapdevicepassword
#>
function Invoke-AzNetworkFabricResyncNetworkBootstrapDevicePassword {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkBootstrapDeviceResyncPasswordsResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            Resync = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricResyncNetworkBootstrapDevicePassword_Resync';
            ResyncViaIdentity = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricResyncNetworkBootstrapDevicePassword_ResyncViaIdentity';
        }
