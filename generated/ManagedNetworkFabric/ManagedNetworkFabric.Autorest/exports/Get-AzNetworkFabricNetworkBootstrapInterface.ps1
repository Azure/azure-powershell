...
NETWORKBOOTSTRAPDEVICEINPUTOBJECT <IManagedNetworkFabricIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/get-aznetworkfabricnetworkbootstrapinterface
#>
function Get-AzNetworkFabricNetworkBootstrapInterface {
...
param(
    ...
    [Parameter(ParameterSetName='GetViaIdentityNetworkBootstrapDevice', Mandatory)]
    ...
    [Parameter(ParameterSetName='GetViaIdentityNetworkBootstrapDevice', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IManagedNetworkFabricIdentity]
    # Identity Parameter
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ManagedNetworkFabric.private\Get-AzNetworkFabricNetworkBootstrapInterface_Get';
            GetViaIdentity = 'Az.ManagedNetworkFabric.private\Get-AzNetworkFabricNetworkBootstrapInterface_GetViaIdentity';
            GetViaIdentityNetworkBootstrapDevice = 'Az.ManagedNetworkFabric.private\Get-AzNetworkFabricNetworkBootstrapInterface_GetViaIdentityNetworkBootstrapDevice';
            List = 'Az.ManagedNetworkFabric.private\Get-AzNetworkFabricNetworkBootstrapInterface_List';
        }
