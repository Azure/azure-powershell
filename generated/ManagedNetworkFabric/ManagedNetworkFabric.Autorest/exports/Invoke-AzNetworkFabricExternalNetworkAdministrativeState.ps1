...
L3ISOLATIONDOMAININPUTOBJECT <IManagedNetworkFabricIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricexternalnetworkadministrativestate
#>
function Invoke-AzNetworkFabricExternalNetworkAdministrativeState {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricExternalNetworkAdministrativeState_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricExternalNetworkAdministrativeState_UpdateViaIdentityExpanded';
            UpdateViaIdentityL3IsolationDomain = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricExternalNetworkAdministrativeState_UpdateViaIdentityL3IsolationDomain';
            UpdateViaIdentityL3IsolationDomainExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricExternalNetworkAdministrativeState_UpdateViaIdentityL3IsolationDomainExpanded';
            UpdateViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricExternalNetworkAdministrativeState_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricExternalNetworkAdministrativeState_UpdateViaJsonString';
        }
