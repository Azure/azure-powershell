...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkFabricRotateCertificatesResponse
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricrotatenetworkfabriccertificate
#>
function Invoke-AzNetworkFabricRotateNetworkFabricCertificate {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkFabricRotateCertificatesResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            Rotate = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricRotateNetworkFabricCertificate_Rotate';
            RotateViaIdentity = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricRotateNetworkFabricCertificate_RotateViaIdentity';
        }
