...
BODY <IDeviceRwCommand>: Provide the Rw command
...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/start-aznetworkfabricnetworkdevicerwcommand
#>
function Start-AzNetworkFabricNetworkDeviceRwCommand {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkDeviceRunRwCommandResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            Run = 'Az.ManagedNetworkFabric.private\Start-AzNetworkFabricNetworkDeviceRwCommand_Run';
            RunExpanded = 'Az.ManagedNetworkFabric.private\Start-AzNetworkFabricNetworkDeviceRwCommand_RunExpanded';
            RunViaIdentity = 'Az.ManagedNetworkFabric.private\Start-AzNetworkFabricNetworkDeviceRwCommand_RunViaIdentity';
            RunViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Start-AzNetworkFabricNetworkDeviceRwCommand_RunViaIdentityExpanded';
            RunViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Start-AzNetworkFabricNetworkDeviceRwCommand_RunViaJsonFilePath';
            RunViaJsonString = 'Az.ManagedNetworkFabric.private\Start-AzNetworkFabricNetworkDeviceRwCommand_RunViaJsonString';
        }
