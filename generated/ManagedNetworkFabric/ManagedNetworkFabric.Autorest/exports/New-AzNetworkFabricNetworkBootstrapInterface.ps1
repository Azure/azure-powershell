...
BODY <INetworkBootstrapInterface>: Defines the NetworkBootstrapInterface resource.
...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/new-aznetworkfabricnetworkbootstrapinterface
#>
function New-AzNetworkFabricNetworkBootstrapInterface {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkBootstrapInterface])]
...
param(
    ...
    [Parameter(ParameterSetName='CreateViaIdentityNetworkBootstrapDevice', Mandatory, ValueFromPipeline)]
    [Parameter(ParameterSetName='CreateViaIdentityNetworkBootstrapDeviceExpanded', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IManagedNetworkFabricIdentity]
    # Identity Parameter
    ...
    [Parameter(ParameterSetName='CreateExpanded')]
    [Parameter(ParameterSetName='CreateViaIdentityNetworkBootstrapDeviceExpanded')]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.ManagedNetworkFabric.private\New-AzNetworkFabricNetworkBootstrapInterface_CreateExpanded';
            CreateViaIdentityNetworkBootstrapDevice = 'Az.ManagedNetworkFabric.private\New-AzNetworkFabricNetworkBootstrapInterface_CreateViaIdentityNetworkBootstrapDevice';
            CreateViaIdentityNetworkBootstrapDeviceExpanded = 'Az.ManagedNetworkFabric.private\New-AzNetworkFabricNetworkBootstrapInterface_CreateViaIdentityNetworkBootstrapDeviceExpanded';
            CreateViaJsonFilePath = 'Az.ManagedNetworkFabric.private\New-AzNetworkFabricNetworkBootstrapInterface_CreateViaJsonFilePath';
            CreateViaJsonString = 'Az.ManagedNetworkFabric.private\New-AzNetworkFabricNetworkBootstrapInterface_CreateViaJsonString';
        }
