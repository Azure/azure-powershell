...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkDeviceUpdateAdministrativeStateResponse
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/update-aznetworkfabricnetworkdeviceadministrativestate
#>
function Update-AzNetworkFabricNetworkDeviceAdministrativeState {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkDeviceUpdateAdministrativeStateResponse])]
...
param(
    ...
    [Parameter(ParameterSetName='UpdateExpanded')]
    [Parameter(ParameterSetName='UpdateViaIdentityExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.PSArgumentCompleterAttribute("RMA", "UngracefulRMA", "Resync", "GracefulQuarantine", "UngracefulQuarantine", "Quarantine", "UnderMaintenance", "Enable", "Disable")]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Category('Body')]
    [System.String]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkDeviceAdministrativeState_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkDeviceAdministrativeState_UpdateViaIdentityExpanded';
            UpdateViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkDeviceAdministrativeState_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkDeviceAdministrativeState_UpdateViaJsonString';
        }
