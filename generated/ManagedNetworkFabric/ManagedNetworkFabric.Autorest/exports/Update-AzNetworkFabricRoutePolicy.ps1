...
STATEMENT <IRoutePolicyStatementPatchProperties[]>: Route Policy statements.
...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/update-aznetworkfabricroutepolicy
#>
function Update-AzNetworkFabricRoutePolicy {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricRoutePolicy_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricRoutePolicy_UpdateViaIdentityExpanded';
            UpdateViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricRoutePolicy_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricRoutePolicy_UpdateViaJsonString';
        }
