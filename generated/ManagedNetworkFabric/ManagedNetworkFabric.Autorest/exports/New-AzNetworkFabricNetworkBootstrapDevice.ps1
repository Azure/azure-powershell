...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/new-aznetworkfabricnetworkbootstrapdevice
#>
function New-AzNetworkFabricNetworkBootstrapDevice {
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.ManagedNetworkFabric.private\New-AzNetworkFabricNetworkBootstrapDevice_CreateExpanded';
            CreateViaJsonFilePath = 'Az.ManagedNetworkFabric.private\New-AzNetworkFabricNetworkBootstrapDevice_CreateViaJsonFilePath';
            CreateViaJsonString = 'Az.ManagedNetworkFabric.private\New-AzNetworkFabricNetworkBootstrapDevice_CreateViaJsonString';
        }
