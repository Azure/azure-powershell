...
BODY <INetworkBootstrapInterfacePatch>: The NetworkBootstrapInterfacePatch resource definition.
...
NETWORKBOOTSTRAPDEVICEINPUTOBJECT <IManagedNetworkFabricIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/update-aznetworkfabricnetworkbootstrapinterface
#>
function Update-AzNetworkFabricNetworkBootstrapInterface {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkBootstrapInterface_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkBootstrapInterface_UpdateViaIdentityExpanded';
            UpdateViaIdentityNetworkBootstrapDevice = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkBootstrapInterface_UpdateViaIdentityNetworkBootstrapDevice';
            UpdateViaIdentityNetworkBootstrapDeviceExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkBootstrapInterface_UpdateViaIdentityNetworkBootstrapDeviceExpanded';
            UpdateViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkBootstrapInterface_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkBootstrapInterface_UpdateViaJsonString';
        }
