...
BODY <IUpgradeNetworkFabricProperties>: Model used for Upgrade Network Fabric Properties
  [Version <String>]: Specify the version.
  [Action <String>]: Action to be performed while upgrading the fabric.
...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricupgrade
#>
function Invoke-AzNetworkFabricUpgrade {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.PSArgumentCompleterAttribute("Start", "Complete")]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Category('Body')]
    [System.String]
...
begin {
    try {
        ...
        $mapping = @{
            Upgrade = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricUpgrade_Upgrade';
            UpgradeExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricUpgrade_UpgradeExpanded';
            UpgradeViaIdentity = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricUpgrade_UpgradeViaIdentity';
            UpgradeViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricUpgrade_UpgradeViaIdentityExpanded';
            UpgradeViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricUpgrade_UpgradeViaJsonFilePath';
            UpgradeViaJsonString = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricUpgrade_UpgradeViaJsonString';
        }
