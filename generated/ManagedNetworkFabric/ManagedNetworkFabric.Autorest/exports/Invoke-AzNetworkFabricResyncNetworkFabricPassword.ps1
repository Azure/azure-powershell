...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkFabricResyncPasswordsResponse
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricresyncnetworkfabricpassword
#>
function Invoke-AzNetworkFabricResyncNetworkFabricPassword {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkFabricResyncPasswordsResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            Resync = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricResyncNetworkFabricPassword_Resync';
            ResyncViaIdentity = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricResyncNetworkFabricPassword_ResyncViaIdentity';
        }
