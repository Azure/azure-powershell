...
BODY <INetworkFabricLockRequest>: Network Fabric Lock Request.
  [Action <String>]: Action to be performed on the lock
  [LockType <String>]: Type of lock to be applied
...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/lock-aznetworkfabric
#>
function Lock-AzNetworkFabric {
...
param(
    ...
    [Parameter(ParameterSetName='LockViaJsonFilePath', Mandatory)]
    [Parameter(ParameterSetName='LockViaJsonString', Mandatory)]
    ...
    [Parameter(ParameterSetName='LockViaJsonFilePath')]
    [Parameter(ParameterSetName='LockViaJsonString')]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Category('Path')]
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.PSArgumentCompleterAttribute("Lock", "Unlock")]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Category('Body')]
    [System.String]
    ...
    [Parameter(ParameterSetName='LockExpanded')]
    [Parameter(ParameterSetName='LockViaIdentityExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.PSArgumentCompleterAttribute("Administrative", "Configuration")]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Category('Body')]
    [System.String]
...
begin {
    try {
        ...
        $mapping = @{
            Lock = 'Az.ManagedNetworkFabric.private\Lock-AzNetworkFabric_Lock';
            LockExpanded = 'Az.ManagedNetworkFabric.private\Lock-AzNetworkFabric_LockExpanded';
            LockViaIdentity = 'Az.ManagedNetworkFabric.private\Lock-AzNetworkFabric_LockViaIdentity';
            LockViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Lock-AzNetworkFabric_LockViaIdentityExpanded';
            LockViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Lock-AzNetworkFabric_LockViaJsonFilePath';
            LockViaJsonString = 'Az.ManagedNetworkFabric.private\Lock-AzNetworkFabric_LockViaJsonString';
        }
        if (('Lock', 'LockExpanded', 'LockViaJsonFilePath', 'LockViaJsonString') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId') ) {
            if ($testPlayback) {
