...
Upgrades the version of the Network Bootstrap Device.
.Example
Invoke-AzNetworkFabricNetworkBootstrapDeviceUpgrade -Name $name -ResourceGroupName $resourceGroupName -Version $version
...
BODY <IUpdateVersion>: Update version properties.
...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricnetworkbootstrapdeviceupgrade
#>
function Invoke-AzNetworkFabricNetworkBootstrapDeviceUpgrade {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkBootstrapDeviceUpgradeResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            Upgrade = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricNetworkBootstrapDeviceUpgrade_Upgrade';
            UpgradeExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricNetworkBootstrapDeviceUpgrade_UpgradeExpanded';
            UpgradeViaIdentity = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricNetworkBootstrapDeviceUpgrade_UpgradeViaIdentity';
            UpgradeViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricNetworkBootstrapDeviceUpgrade_UpgradeViaIdentityExpanded';
            UpgradeViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricNetworkBootstrapDeviceUpgrade_UpgradeViaJsonFilePath';
            UpgradeViaJsonString = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricNetworkBootstrapDeviceUpgrade_UpgradeViaJsonString';
        }
