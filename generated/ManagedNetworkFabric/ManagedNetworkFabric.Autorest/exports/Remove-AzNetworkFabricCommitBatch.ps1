...
Post action: Discards a Batch operation in progress.
.Example
Remove-AzNetworkFabricCommitBatch -NetworkFabricName $networkFabricName -ResourceGroupName $resourceGroupName -CommitBatchId $commitBatchId
...
BODY <IDiscardCommitBatchRequest>: Discard Commit Batch Request.
...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/remove-aznetworkfabriccommitbatch
#>
function Remove-AzNetworkFabricCommitBatch {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IDiscardCommitBatchOperationResponse])]
...
param(
    ...
    [Parameter(ParameterSetName='DiscardViaJsonFilePath')]
    [Parameter(ParameterSetName='DiscardViaJsonString')]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Category('Path')]
...
begin {
    try {
        ...
        $mapping = @{
            Discard = 'Az.ManagedNetworkFabric.private\Remove-AzNetworkFabricCommitBatch_Discard';
            DiscardExpanded = 'Az.ManagedNetworkFabric.private\Remove-AzNetworkFabricCommitBatch_DiscardExpanded';
            DiscardViaIdentity = 'Az.ManagedNetworkFabric.private\Remove-AzNetworkFabricCommitBatch_DiscardViaIdentity';
            DiscardViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Remove-AzNetworkFabricCommitBatch_DiscardViaIdentityExpanded';
            DiscardViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Remove-AzNetworkFabricCommitBatch_DiscardViaJsonFilePath';
            DiscardViaJsonString = 'Az.ManagedNetworkFabric.private\Remove-AzNetworkFabricCommitBatch_DiscardViaJsonString';
        }
        if (('Discard', 'DiscardExpanded', 'DiscardViaJsonFilePath', 'DiscardViaJsonString') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId') ) {
            if ($testPlayback) {
