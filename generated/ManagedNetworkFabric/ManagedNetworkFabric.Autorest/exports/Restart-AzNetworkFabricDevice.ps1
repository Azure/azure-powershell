...
BODY <IRebootProperties>: Reboot properties.
  [RebootType <String>]: Type of reboot to be performed. Example: GracefulRebootWithZTP
...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/restart-aznetworkfabricdevice
#>
function Restart-AzNetworkFabricDevice {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IOperationStatusResult])]
[CmdletBinding(DefaultParameterSetName='RebootExpanded', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Reboot', Mandatory)]
    [Parameter(ParameterSetName='RebootExpanded', Mandatory)]
    [Parameter(ParameterSetName='RebootViaJsonFilePath', Mandatory)]
    [Parameter(ParameterSetName='RebootViaJsonString', Mandatory)]
    ...
    [Parameter(ParameterSetName='RebootExpanded')]
    [Parameter(ParameterSetName='RebootViaJsonFilePath')]
    [Parameter(ParameterSetName='RebootViaJsonString')]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Category('Path')]
    ...
    [Parameter(ParameterSetName='RebootViaIdentityExpanded', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IManagedNetworkFabricIdentity]
    # Identity Parameter
    ${InputObject},

    [Parameter(ParameterSetName='Reboot', Mandatory, ValueFromPipeline)]
    [Parameter(ParameterSetName='RebootViaIdentity', Mandatory, ValueFromPipeline)]
    ...
    [Parameter(ParameterSetName='RebootExpanded')]
    [Parameter(ParameterSetName='RebootViaIdentityExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.PSArgumentCompleterAttribute("GracefulRebootWithZTP", "GracefulRebootWithoutZTP", "UngracefulRebootWithZTP", "UngracefulRebootWithoutZTP")]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Category('Body')]
    [System.String]
...
begin {
    try {
        ...
        $mapping = @{
            Reboot = 'Az.ManagedNetworkFabric.private\Restart-AzNetworkFabricDevice_Reboot';
            RebootExpanded = 'Az.ManagedNetworkFabric.private\Restart-AzNetworkFabricDevice_RebootExpanded';
            RebootViaIdentity = 'Az.ManagedNetworkFabric.private\Restart-AzNetworkFabricDevice_RebootViaIdentity';
            RebootViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Restart-AzNetworkFabricDevice_RebootViaIdentityExpanded';
            RebootViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Restart-AzNetworkFabricDevice_RebootViaJsonFilePath';
            RebootViaJsonString = 'Az.ManagedNetworkFabric.private\Restart-AzNetworkFabricDevice_RebootViaJsonString';
        }
        if (('Reboot', 'RebootExpanded', 'RebootViaJsonFilePath', 'RebootViaJsonString') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId') ) {
            if ($testPlayback) {
