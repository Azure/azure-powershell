...
DESTINATION <IDestinationProperties[]>: List of destinations to send the filter traffic.
...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/update-aznetworkfabricnetworktap
#>
function Update-AzNetworkFabricNetworkTap {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkTap_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkTap_UpdateViaIdentityExpanded';
        }
