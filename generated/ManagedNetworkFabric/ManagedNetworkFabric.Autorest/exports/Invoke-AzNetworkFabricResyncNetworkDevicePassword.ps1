...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricresyncnetworkdevicepassword
#>
function Invoke-AzNetworkFabricResyncNetworkDevicePassword {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkDeviceResyncPasswordsResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            Resync = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricResyncNetworkDevicePassword_Resync';
            ResyncViaIdentity = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricResyncNetworkDevicePassword_ResyncViaIdentity';
        }
