...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/update-aznetworkfabricnetworkbootstrapdeviceadministrativestate
#>
function Update-AzNetworkFabricNetworkBootstrapDeviceAdministrativeState {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkBootstrapDeviceUpdateAdministrativeStateResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkBootstrapDeviceAdministrativeState_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkBootstrapDeviceAdministrativeState_UpdateViaIdentityExpanded';
            UpdateViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkBootstrapDeviceAdministrativeState_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkBootstrapDeviceAdministrativeState_UpdateViaJsonString';
        }
