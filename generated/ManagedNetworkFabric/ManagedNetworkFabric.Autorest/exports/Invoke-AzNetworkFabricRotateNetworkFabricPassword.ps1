...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricrotatenetworkfabricpassword
#>
function Invoke-AzNetworkFabricRotateNetworkFabricPassword {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkFabricRotatePasswordsResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            Rotate = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricRotateNetworkFabricPassword_Rotate';
            RotateViaIdentity = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricRotateNetworkFabricPassword_RotateViaIdentity';
        }
