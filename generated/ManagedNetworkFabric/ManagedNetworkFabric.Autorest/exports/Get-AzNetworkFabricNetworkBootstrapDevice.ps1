...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/get-aznetworkfabricnetworkbootstrapdevice
#>
function Get-AzNetworkFabricNetworkBootstrapDevice {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ManagedNetworkFabric.private\Get-AzNetworkFabricNetworkBootstrapDevice_Get';
            GetViaIdentity = 'Az.ManagedNetworkFabric.private\Get-AzNetworkFabricNetworkBootstrapDevice_GetViaIdentity';
            List = 'Az.ManagedNetworkFabric.private\Get-AzNetworkFabricNetworkBootstrapDevice_List';
            List1 = 'Az.ManagedNetworkFabric.private\Get-AzNetworkFabricNetworkBootstrapDevice_List1';
        }
