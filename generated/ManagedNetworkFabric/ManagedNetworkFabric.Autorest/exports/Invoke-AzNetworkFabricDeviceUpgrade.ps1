...
BODY <INetworkDeviceUpgradeRequest>: NetworkDevice Upgrade Request Properties.
  Version <String>: Version to which the device needs to be upgraded.
...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricdeviceupgrade
#>
function Invoke-AzNetworkFabricDeviceUpgrade {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkDeviceUpgradeResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            Upgrade = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricDeviceUpgrade_Upgrade';
            UpgradeExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricDeviceUpgrade_UpgradeExpanded';
            UpgradeViaIdentity = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricDeviceUpgrade_UpgradeViaIdentity';
            UpgradeViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricDeviceUpgrade_UpgradeViaIdentityExpanded';
            UpgradeViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricDeviceUpgrade_UpgradeViaJsonFilePath';
            UpgradeViaJsonString = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricDeviceUpgrade_UpgradeViaJsonString';
        }
