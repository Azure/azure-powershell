...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/update-aznetworkfabricipextendedcommunity
#>
function Update-AzNetworkFabricIPExtendedCommunity {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricIPExtendedCommunity_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricIPExtendedCommunity_UpdateViaIdentityExpanded';
            UpdateViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricIPExtendedCommunity_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricIPExtendedCommunity_UpdateViaJsonString';
        }
