...
BODY <IExternalNetworkUpdateBfdAdministrativeStateRequest>: External Network Update Administrative State request
  [AdministrativeState <String>]: Administrative state.
  [RouteType <String>]: Route Type that helps to know which bfd we are updating.
...
L3ISOLATIONDOMAININPUTOBJECT <IManagedNetworkFabricIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricexternalnetworkbfdadministrativestate
#>
function Invoke-AzNetworkFabricExternalNetworkBfdAdministrativeState {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IExternalNetworkUpdateBfdAdministrativeStateResponse])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.PSArgumentCompleterAttribute("Enabled", "Disabled", "MAT", "RMA")]
    ...
    [Parameter(ParameterSetName='UpdateViaIdentityExpanded')]
    [Parameter(ParameterSetName='UpdateViaIdentityL3IsolationDomainExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.PSArgumentCompleterAttribute("Static", "OptionA")]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Category('Body')]
    [System.String]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricExternalNetworkBfdAdministrativeState_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricExternalNetworkBfdAdministrativeState_UpdateViaIdentityExpanded';
            UpdateViaIdentityL3IsolationDomain = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricExternalNetworkBfdAdministrativeState_UpdateViaIdentityL3IsolationDomain';
            UpdateViaIdentityL3IsolationDomainExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricExternalNetworkBfdAdministrativeState_UpdateViaIdentityL3IsolationDomainExpanded';
            UpdateViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricExternalNetworkBfdAdministrativeState_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricExternalNetworkBfdAdministrativeState_UpdateViaJsonString';
        }
