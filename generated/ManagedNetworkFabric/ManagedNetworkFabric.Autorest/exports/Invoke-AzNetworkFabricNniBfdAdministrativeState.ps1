...
BODY <INniUpdateBfdAdministrativeStateRequest>: NNI Bidirectional Forwarding Detection (BFD) Administrative State request.
  [AdministrativeState <String>]: State. Select either enable or disable.
  [RouteType <String>]: Route Type. Choose either Static or OptionA.
...
NETWORKFABRICINPUTOBJECT <IManagedNetworkFabricIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricnnibfdadministrativestate
#>
function Invoke-AzNetworkFabricNniBfdAdministrativeState {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INniUpdateBfdAdministrativeStateResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricNniBfdAdministrativeState_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricNniBfdAdministrativeState_UpdateViaIdentityExpanded';
            UpdateViaIdentityNetworkFabric = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricNniBfdAdministrativeState_UpdateViaIdentityNetworkFabric';
            UpdateViaIdentityNetworkFabricExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricNniBfdAdministrativeState_UpdateViaIdentityNetworkFabricExpanded';
            UpdateViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricNniBfdAdministrativeState_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricNniBfdAdministrativeState_UpdateViaJsonString';
        }
