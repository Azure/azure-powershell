...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricresyncnetworkfabriccertificate
#>
function Invoke-AzNetworkFabricResyncNetworkFabricCertificate {
...
begin {
    try {
        ...
        $mapping = @{
            Resync = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricResyncNetworkFabricCertificate_Resync';
            ResyncViaIdentity = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricResyncNetworkFabricCertificate_ResyncViaIdentity';
        }
