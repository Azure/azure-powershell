...
RULEPROPERTY <IRuleProperties>: Rules for the InternetGateways
  ...
  [Condition <String>]: Specify rule condition.
  [DestinationAddressList <List<String>>]: List of Addresses to be allowed or denied.
  [HeaderAddressList <List<IHeaderAddressProperties>>]: List of header Name and source addresses associated with the header.
    [AddressList <List<String>>]: List of source remote IP to be allowed or denied.
    [HeaderName <String>]: Name of the header.
  [SourceAddressList <List<String>>]: List of source IPv4 and IPv6 address to be allowed or denied.
.Link
