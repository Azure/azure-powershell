...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/update-aznetworkfabricnetworktaprule
#>
function Update-AzNetworkFabricNetworkTapRule {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkTapRule_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkTapRule_UpdateViaIdentityExpanded';
        }
