...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/update-aznetworkfabricnetworkbootstrapdeviceconfiguration
#>
function Update-AzNetworkFabricNetworkBootstrapDeviceConfiguration {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkBootstrapDeviceRefreshConfigurationResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            Refresh = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkBootstrapDeviceConfiguration_Refresh';
            RefreshViaIdentity = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricNetworkBootstrapDeviceConfiguration_RefreshViaIdentity';
        }
