...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/restart-aznetworkfabricnetworkbootstrapdevice
#>
function Restart-AzNetworkFabricNetworkBootstrapDevice {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkBootstrapDeviceRebootResponse])]
...
param(
    ...
    [Alias('NetworkBootstrapDeviceName')]
...
begin {
    try {
        ...
        $mapping = @{
            Reboot = 'Az.ManagedNetworkFabric.private\Restart-AzNetworkFabricNetworkBootstrapDevice_Reboot';
            RebootViaIdentity = 'Az.ManagedNetworkFabric.private\Restart-AzNetworkFabricNetworkBootstrapDevice_RebootViaIdentity';
        }
