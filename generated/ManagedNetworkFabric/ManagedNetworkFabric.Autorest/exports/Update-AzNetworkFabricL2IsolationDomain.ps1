...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/update-aznetworkfabricl2isolationdomain
#>
function Update-AzNetworkFabricL2IsolationDomain {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricL2IsolationDomain_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricL2IsolationDomain_UpdateViaIdentityExpanded';
        }
