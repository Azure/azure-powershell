...
Delete the Network Bootstrap Interface resource.
.Example
Remove-AzNetworkFabricNetworkBootstrapInterface -Name $name -NetworkBootstrapDeviceName $networkBootstrapDeviceName -ResourceGroupName $resourceGroupName
...
NETWORKBOOTSTRAPDEVICEINPUTOBJECT <IManagedNetworkFabricIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/remove-aznetworkfabricnetworkbootstrapinterface
#>
function Remove-AzNetworkFabricNetworkBootstrapInterface {
[OutputType([System.Boolean])]
[CmdletBinding(DefaultParameterSetName='Delete', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Delete', Mandatory)]
    [Parameter(ParameterSetName='DeleteViaIdentityNetworkBootstrapDevice', Mandatory)]
    [Alias('NetworkBootstrapInterfaceName')]
    ...
    [Parameter(ParameterSetName='DeleteViaIdentityNetworkBootstrapDevice', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IManagedNetworkFabricIdentity]
    # Identity Parameter
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ManagedNetworkFabric.private\Remove-AzNetworkFabricNetworkBootstrapInterface_Delete';
            DeleteViaIdentity = 'Az.ManagedNetworkFabric.private\Remove-AzNetworkFabricNetworkBootstrapInterface_DeleteViaIdentity';
            DeleteViaIdentityNetworkBootstrapDevice = 'Az.ManagedNetworkFabric.private\Remove-AzNetworkFabricNetworkBootstrapInterface_DeleteViaIdentityNetworkBootstrapDevice';
        }
