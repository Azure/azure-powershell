...
L3ISOLATIONDOMAININPUTOBJECT <IManagedNetworkFabricIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/update-aznetworkfabricinternalnetworkstaticroutebfdadministrativestate
#>
function Update-AzNetworkFabricInternalNetworkStaticRouteBfdAdministrativeState {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricInternalNetworkStaticRouteBfdAdministrativeState_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricInternalNetworkStaticRouteBfdAdministrativeState_UpdateViaIdentityExpanded';
            UpdateViaIdentityL3IsolationDomain = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricInternalNetworkStaticRouteBfdAdministrativeState_UpdateViaIdentityL3IsolationDomain';
            UpdateViaIdentityL3IsolationDomainExpanded = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricInternalNetworkStaticRouteBfdAdministrativeState_UpdateViaIdentityL3IsolationDomainExpanded';
            UpdateViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricInternalNetworkStaticRouteBfdAdministrativeState_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.ManagedNetworkFabric.private\Update-AzNetworkFabricInternalNetworkStaticRouteBfdAdministrativeState_UpdateViaJsonString';
        }
