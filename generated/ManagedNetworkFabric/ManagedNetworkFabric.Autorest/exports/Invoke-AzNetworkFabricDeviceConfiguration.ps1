...
Post action: Triggers view of network fabric configuration.
.Example
Invoke-AzNetworkFabricDeviceConfiguration -NetworkFabricName $name -ResourceGroupName $resourceGroupName

.Inputs
Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IManagedNetworkFabricIdentity
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IViewDeviceConfigurationOperationResponse
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricdeviceconfiguration
#>
function Invoke-AzNetworkFabricDeviceConfiguration {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IViewDeviceConfigurationOperationResponse])]
[CmdletBinding(DefaultParameterSetName='View', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
...
begin {
    try {
        ...
        $mapping = @{
            View = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricDeviceConfiguration_View';
            ViewViaIdentity = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricDeviceConfiguration_ViewViaIdentity';
        }
