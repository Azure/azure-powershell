...
BODY <ICommitBatchStatusRequest>: Commit Batch Status Request.
...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabriccommitbatchstatus
#>
function Invoke-AzNetworkFabricCommitBatchStatus {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.ICommitBatchStatusOperationResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            Commit = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricCommitBatchStatus_Commit';
            CommitExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricCommitBatchStatus_CommitExpanded';
            CommitViaIdentity = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricCommitBatchStatus_CommitViaIdentity';
            CommitViaIdentityExpanded = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricCommitBatchStatus_CommitViaIdentityExpanded';
            CommitViaJsonFilePath = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricCommitBatchStatus_CommitViaJsonFilePath';
            CommitViaJsonString = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricCommitBatchStatus_CommitViaJsonString';
        }
