...
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/invoke-aznetworkfabricresyncnetworkdevicecertificate
#>
function Invoke-AzNetworkFabricResyncNetworkDeviceCertificate {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.INetworkFabricResyncCertificatesResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            Resync = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricResyncNetworkDeviceCertificate_Resync';
            ResyncViaIdentity = 'Az.ManagedNetworkFabric.private\Invoke-AzNetworkFabricResyncNetworkDeviceCertificate_ResyncViaIdentity';
        }
