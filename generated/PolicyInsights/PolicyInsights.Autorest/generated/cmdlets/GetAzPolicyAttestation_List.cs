...
namespace Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListForSubscription=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.PolicyInsights/attestations"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPolicyAttestation_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Description(@"Gets all attestations for the subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.PolicyInsights/attestations", ApiVersion = "2024-10-01")]
    public partial class GetAzPolicyAttestation_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzPolicyAttestation_List" /> cmdlet class.
        /// </summary>
        public GetAzPolicyAttestation_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AttestationsListForSubscription(SubscriptionId, this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.AttestationsListForSubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
