...
namespace Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListQueryResultsForPolicySetDefinition=>POST:"/subscriptions/{subscriptionId}/providers/{authorizationNamespace}/policySetDefinitions/{policySetDefinitionName}/providers/Microsoft.PolicyInsights/policyStates/{policyStatesResource}/queryResults"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPolicyStateQueryResult_List4", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Description(@"Queries policy states for the subscription level policy set definition.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/{authorizationNamespace}/policySetDefinitions/{policySetDefinitionName}/providers/Microsoft.PolicyInsights/policyStates/{policyStatesResource}/queryResults", ApiVersion = "2024-10-01")]
    public partial class GetAzPolicyStateQueryResult_List4 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Policy set definition name.")]
        [Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzPolicyStateQueryResult_List4" /> cmdlet class.
        /// </summary>
        public GetAzPolicyStateQueryResult_List4()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PolicyStatesListQueryResultsForPolicySetDefinition' operation"))
                {
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.PolicyStatesListQueryResultsForPolicySetDefinition_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
