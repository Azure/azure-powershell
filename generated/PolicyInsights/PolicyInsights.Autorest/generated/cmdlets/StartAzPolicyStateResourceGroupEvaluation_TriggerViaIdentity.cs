...
namespace Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] TriggerResourceGroupEvaluation=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.PolicyInsights/policyStates/latest/triggerEvaluation"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzPolicyStateResourceGroupEvaluation_TriggerViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Description(@"Triggers a policy evaluation scan for all the resources under the resource group.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.PolicyInsights/policyStates/latest/triggerEvaluation", ApiVersion = "2024-10-01")]
    public partial class StartAzPolicyStateResourceGroupEvaluation_TriggerViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of StartAzPolicyStateResourceGroupEvaluation_TriggerViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Cmdlets.StartAzPolicyStateResourceGroupEvaluation_TriggerViaIdentity Clone()
        {
            var clone = new StartAzPolicyStateResourceGroupEvaluation_TriggerViaIdentity();
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.Events.DelayBeforePolling:
                    {
                        var data = messageData();
                        if (true == MyInvocation?.BoundParameters?.ContainsKey("NoWait"))
                        {
                            if (data.ResponseMessage is System.Net.Http.HttpResponseMessage response)
                            {
                                ...
                                WriteObject(new Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.PowerShell.AsyncOperationResponse { Target = uri });
                                // do nothing more.
                                data.Cancel();
                                return;
                            }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PolicyStatesTriggerResourceGroupEvaluation' operation"))
                {
                    if (true == MyInvocation?.BoundParameters?.ContainsKey("AsJob"))
                    {
                        var instance = this.Clone();
                        var job = new Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.PowerShell.AsyncJob(instance, this.MyInvocation.Line, this.MyInvocation.MyCommand.Name, this._cancellationTokenSource.Token, this._cancellationTokenSource.Cancel);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PolicyStatesTriggerResourceGroupEvaluationViaIdentity(InputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PolicyStatesTriggerResourceGroupEvaluation(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartAzPolicyStateResourceGroupEvaluation_TriggerViaIdentity" /> cmdlet class.
        /// </summary>
        public StartAzPolicyStateResourceGroupEvaluation_TriggerViaIdentity()
        {
