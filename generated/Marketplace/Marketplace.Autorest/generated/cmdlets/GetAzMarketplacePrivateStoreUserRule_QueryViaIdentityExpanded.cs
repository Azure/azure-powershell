...
namespace Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] QueryUserRules=>POST:"/providers/Microsoft.Marketplace/privateStores/{privateStoreId}/queryUserRules"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMarketplacePrivateStoreUserRule_QueryViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IRuleListResponse))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Description(@"All rules approved in the private store that are relevant for user subscriptions")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Marketplace.HttpPath(Path = "/providers/Microsoft.Marketplace/privateStores/{privateStoreId}/queryUserRules", ApiVersion = "2023-01-01")]
    public partial class GetAzMarketplacePrivateStoreUserRule_QueryViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IQueryUserRulesProperties _payloadBody = new Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.QueryUserRulesProperties();
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.DefaultInfo(
        Name = @"",
        Description =@"",
        Script = @"(Get-AzContext).Subscription.Id",
        SetCondition = @"")]
        public string[] SubscriptionId { get => _payloadBody.SubscriptionId?.ToArray() ?? null /* fixedArrayOf */; set => _payloadBody.SubscriptionId = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IRuleListResponse">Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IRuleListResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IRuleListResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMarketplacePrivateStoreUserRule_QueryViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public GetAzMarketplacePrivateStoreUserRule_QueryViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'QueryUserRules' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.QueryUserRulesViaIdentity(InputObject.Id, _payloadBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.QueryUserRules(InputObject.PrivateStoreId ?? null, _payloadBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IRuleListResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IRuleListResponse
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        ...
                        {
                            requestMessage = requestMessage.Clone(new global::System.Uri( _nextLink ),Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Method.Get );
                            await ((Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.IEventListener)this).Signal(Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Events.FollowingNextLink); if( ((Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.IEventListener)this).Token.IsCancellationRequested ) { return; }
                            await this.Client.QueryUserRules_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
