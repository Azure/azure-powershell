...
namespace Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] BillingAccounts=>POST:"/providers/Microsoft.Marketplace/privateStores/{privateStoreId}/billingAccounts"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMarketplaceBillingPrivateStoreAccount_BillingViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Description(@"Tenant billing accounts names")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Marketplace.HttpPath(Path = "/providers/Microsoft.Marketplace/privateStores/{privateStoreId}/billingAccounts", ApiVersion = "2023-01-01")]
    public partial class GetAzMarketplaceBillingPrivateStoreAccount_BillingViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IBillingAccountsResponse">Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IBillingAccountsResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IBillingAccountsResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMarketplaceBillingPrivateStoreAccount_BillingViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public GetAzMarketplaceBillingPrivateStoreAccount_BillingViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PrivateStoreBillingAccounts' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PrivateStoreBillingAccountsViaIdentity(InputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PrivateStoreBillingAccounts(InputObject.PrivateStoreId ?? null, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IBillingAccountsResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IBillingAccountsResponse
                var result = (await response);
                // response should be returning an array of some kind. +Pageable
                // nested-array / billingAccounts / <none>
                if (null != result.BillingAccount)
                {
                    if (0 == _responseSize && 1 == result.BillingAccount.Count)
                    {
                        _firstResponse = result.BillingAccount[0];
                        _responseSize = 1;
                    }
                    else
                    {
                        ...
                        foreach( var value in result.BillingAccount )
                        {
