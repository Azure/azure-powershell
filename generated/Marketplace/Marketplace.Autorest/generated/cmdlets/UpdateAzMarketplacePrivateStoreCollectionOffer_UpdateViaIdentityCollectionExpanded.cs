...
namespace Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMarketplacePrivateStoreCollectionOffer_UpdateViaIdentityCollectionExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzMarketplacePrivateStoreCollectionOffer_UpdateViaIdentityCollectionExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="CollectionInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IMarketplaceIdentity _collectionInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IMarketplaceIdentity CollectionInputObject { get => this._collectionInputObject; set => this._collectionInputObject = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (CollectionInputObject?.Id != null)
                    {
                        this.CollectionInputObject.Id += $"/offers/{(global::System.Uri.EscapeDataString(this.OfferId.ToString()))}";
                        _payloadBody = await this.Client.PrivateStoreCollectionOfferGetViaIdentityWithResult(CollectionInputObject.Id, this, Pipeline);
                        this.Update_payloadBody();
                        await this.Client.PrivateStoreCollectionOfferCreateOrUpdateViaIdentity(CollectionInputObject.Id, _payloadBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == CollectionInputObject.PrivateStoreId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("CollectionInputObject has null value for CollectionInputObject.PrivateStoreId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, CollectionInputObject) );
                        }
                        if (null == CollectionInputObject.CollectionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("CollectionInputObject has null value for CollectionInputObject.CollectionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, CollectionInputObject) );
                        }
                        _payloadBody = await this.Client.PrivateStoreCollectionOfferGetWithResult(CollectionInputObject.PrivateStoreId ?? null, CollectionInputObject.CollectionId ?? null, OfferId, this, Pipeline);
                        this.Update_payloadBody();
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { OfferId=OfferId})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzMarketplacePrivateStoreCollectionOffer_UpdateViaIdentityCollectionExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzMarketplacePrivateStoreCollectionOffer_UpdateViaIdentityCollectionExpanded()
        {
        ...
        private void Update_payloadBody()
        {
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SpecificPlanIdLimitation")))
            {
                this.SpecificPlanIdLimitation = (string[])(this.MyInvocation?.BoundParameters["SpecificPlanIdLimitation"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("UpdateSuppressedDueIdempotence")))
            {
                this.UpdateSuppressedDueIdempotence = (global::System.Management.Automation.SwitchParameter)(this.MyInvocation?.BoundParameters["UpdateSuppressedDueIdempotence"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("IconFileUri")))
            {
                this.IconFileUri = (Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IOfferPropertiesIconFileUris)(this.MyInvocation?.BoundParameters["IconFileUri"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Plan")))
            {
                this.Plan = (Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IPlan[])(this.MyInvocation?.BoundParameters["Plan"]);
            }
        }
