...
namespace Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models
{
    ...
    public partial class PrivateStoreProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IPrivateStoreProperties.
        /// </summary>
        ...
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IPrivateStoreProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonObject json ? new PrivateStoreProperties(json) : null;
        }
        ...
        internal PrivateStoreProperties(Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonObject json)
        {
            ...
            {_notificationsSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonObject>("notificationsSettings"), out var __jsonNotificationsSettings) ? Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.NotificationsSettingsProperties.FromJson(__jsonNotificationsSettings) : _notificationsSetting;}
            {_availability = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonString>("availability"), out var __jsonAvailability) ? (string)__jsonAvailability : (string)_availability;}
            ...
            {_privateStoreName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonString>("privateStoreName"), out var __jsonPrivateStoreName) ? (string)__jsonPrivateStoreName : (string)_privateStoreName;}
            {_tenantId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonString>("tenantId"), out var __jsonTenantId) ? (string)__jsonTenantId : (string)_tenantId;}
            {_isGov = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonBoolean>("isGov"), out var __jsonIsGov) ? (bool?)__jsonIsGov : _isGov;}
            {_collectionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonArray>("collectionIds"), out var __jsonCollectionIds) ? If( __jsonCollectionIds as Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _collectionId;}
            {_branding = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonObject>("branding"), out var __jsonBranding) ? Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.PrivateStorePropertiesBranding.FromJson(__jsonBranding) : _branding;}
            AfterFromJson(json);
        }
