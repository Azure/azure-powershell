...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models
{
    ...
    public partial class FleetProperties
    {
        ...
        internal FleetProperties(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_zoneAllocationPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("zoneAllocationPolicy"), out var __jsonZoneAllocationPolicy) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.ZoneAllocationPolicy.FromJson(__jsonZoneAllocationPolicy) : _zoneAllocationPolicy;}
            ...
            {_vMNamePrefix = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("vmNamePrefix"), out var __jsonVMNamePrefix) ? (string)__jsonVMNamePrefix : (string)_vMNamePrefix;}
            {_capacityType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString>("capacityType"), out var __jsonCapacityType) ? (string)__jsonCapacityType : (string)_capacityType;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._zoneAllocationPolicy ? (Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode) this._zoneAllocationPolicy.ToJson(null,serializationMode) : null, "zoneAllocationPolicy" ,container.Add );
            ...
            AddIf( null != (((object)this._vMNamePrefix)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString(this._vMNamePrefix.ToString()) : null, "vmNamePrefix" ,container.Add );
            AddIf( null != (((object)this._capacityType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonString(this._capacityType.ToString()) : null, "capacityType" ,container.Add );
