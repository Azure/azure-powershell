...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models
{
    ...
    public partial class VirtualMachine :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IVirtualMachineInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IVirtualMachineInternal.Code { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IApiErrorInternal)Error).Code; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IApiErrorInternal)Error).Code = value ?? null; }

        /// <summary>Internal Acessors for Detail</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IApiErrorBase> Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IVirtualMachineInternal.Detail { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IApiErrorInternal)Error).Detail; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IApiErrorInternal)Error).Detail = value ?? null /* arrayOf */; }

        /// <summary>Internal Acessors for Error</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IApiError Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IVirtualMachineInternal.Error { get => (this._error = this._error ?? new Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.ApiError()); set { {_error = value;} } }

        /// <summary>Internal Acessors for Id</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IVirtualMachineInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for Innererror</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IInnerError Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IVirtualMachineInternal.Innererror { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IApiErrorInternal)Error).Innererror; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IApiErrorInternal)Error).Innererror = value ?? null /* model class */; }

        /// <summary>Internal Acessors for InnererrorErrorDetail</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IVirtualMachineInternal.InnererrorErrorDetail { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IApiErrorInternal)Error).InnererrorErrorDetail; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IApiErrorInternal)Error).InnererrorErrorDetail = value ?? null; }

        /// <summary>Internal Acessors for InnererrorExceptionType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IVirtualMachineInternal.InnererrorExceptionType { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IApiErrorInternal)Error).InnererrorExceptionType; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IApiErrorInternal)Error).InnererrorExceptionType = value ?? null; }

        /// <summary>Internal Acessors for Message</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IVirtualMachineInternal.Message { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IApiErrorInternal)Error).Message; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IApiErrorInternal)Error).Message = value ?? null; }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IVirtualMachineInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for OperationStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IVirtualMachineInternal.OperationStatus { get => this._operationStatus; set { {_operationStatus = value;} } }

        /// <summary>Internal Acessors for Target</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IVirtualMachineInternal.Target { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IApiErrorInternal)Error).Target; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IApiErrorInternal)Error).Target = value ?? null; }

        /// <summary>Internal Acessors for Type</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IVirtualMachineInternal.Type { get => this._type; set { {_type = value;} } }
        ...
        /// <summary>
        /// This represents the operationStatus of the virtual machine in response to the last operation that was performed on it
        /// by Azure Fleet resource.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.PropertyOrigin.Owned)]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.IJsonSerializable
    {
        ...
        Create = false,
        Update = false,
        Description = @"The compute RP resource id of the virtual machine. subscriptions/{subId}/resourceGroups/{rgName}/providers/Microsoft.Compute/virtualMachines/{vmName}",
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        string Id { get;  }
        /// <summary>The internal error message or exception dump.</summary>
        ...
        Create = false,
        Update = false,
        Description = @"This represents the operationStatus of the virtual machine in response to the last operation that was performed on it by Azure Fleet resource.",
        SerializedName = @"operationStatus",
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.PSArgumentCompleterAttribute("Launching", "Creating", "Failed", "Succeeded")]
