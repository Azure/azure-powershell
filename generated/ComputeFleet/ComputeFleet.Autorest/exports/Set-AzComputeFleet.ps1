...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ComputeFleet.private\Set-AzComputeFleet_UpdateExpanded';
            UpdateViaJsonFilePath = 'Az.ComputeFleet.private\Set-AzComputeFleet_UpdateViaJsonFilePath';
            UpdateViaJsonString = 'Az.ComputeFleet.private\Set-AzComputeFleet_UpdateViaJsonString';
        }
