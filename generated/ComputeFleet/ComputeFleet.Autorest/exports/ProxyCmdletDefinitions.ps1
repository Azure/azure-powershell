...
.Link
https://learn.microsoft.com/powershell/module/az.computefleet/get-azcomputefleetvirtualmachinescaleset
#>
function Get-AzComputeFleetVirtualMachineScaleSet {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.ComputeFleet.private\Get-AzComputeFleetVirtualMachineScaleSet_List';
        }
...
.Link
https://learn.microsoft.com/powershell/module/az.computefleet/get-azcomputefleetvirtualmachine
#>
function Get-AzComputeFleetVirtualMachine {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.IVirtualMachine])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Category('Path')]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Category('Query')]
    [System.String]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.ComputeFleet.private\Get-AzComputeFleetVirtualMachine_List';
        }
        if (('List') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId') ) {
            if ($testPlayback) {
                $PSBoundParameters['SubscriptionId'] = . (Join-Path $PSScriptRoot '..' 'utils' 'Get-SubscriptionIdTestSafe.ps1')
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.ComputeFleet.private\New-AzComputeFleet_CreateExpanded';
            CreateViaJsonFilePath = 'Az.ComputeFleet.private\New-AzComputeFleet_CreateViaJsonFilePath';
            CreateViaJsonString = 'Az.ComputeFleet.private\New-AzComputeFleet_CreateViaJsonString';
        }
