...
ADDITIONALLOCATIONPROFILE <ILocationProfile[]>: The list of location profiles.
  ...
  [VirtualMachineProfileOverride <IBaseVirtualMachineProfile>]: An override for computeProfile.baseVirtualMachineProfile specific to this region.         This override is merged with the base virtual machine profile to define the final virtual machine profile for the resources deployed in this location.
    ...
    [LicenseType <String>]: Specifies that the image or disk that is being used was licensed on-premises.            Possible values for Windows Server operating system are:            Windows_Client    Windows_Server    Possible values for Linux         Server operating system are:    RHEL_BYOS (for RHEL)    SLES_BYOS         (for SUSE)    For more information, see [Azure Hybrid Use Benefit for         Windows         Server](https://learn.microsoft.com/azure/virtual-machines/windows/hybrid-use-benefit-licensing)            [Azure Hybrid Use Benefit for Linux         Server](https://learn.microsoft.com/azure/virtual-machines/linux/azure-hybrid-benefit-linux)            Minimum api-version: 2015-06-15
    ...
    [OSProfile <IVirtualMachineScaleSetOSProfile>]: Specifies the operating system settings for the virtual machines in the scale         set.
      [AdminPassword <SecureString>]: Specifies the password of the administrator account.    **Minimum-length         (Windows):** 8 characters    **Minimum-length (Linux):** 6 characters            **Max-length (Windows):** 123 characters    **Max-length         (Linux):** 72 characters    **Complexity requirements:** 3 out of 4         conditions below need to be fulfilled   Has lower characters  Has upper         characters   Has a digit   Has a special character (Regex match [\W_])            **Disallowed values:** "abc@123", "P@$$w0rd", "P@ssw0rd",         "P@ssword123", "Pa$$word", "pass@word1", "Password!", "Password1",         "Password22", "iloveyou!"    For resetting the password, see [How to         reset the Remote Desktop service or its login password in a Windows         VM](https://learn.microsoft.com/troubleshoot/azure/virtual-machines/reset-rdp)            For resetting root password, see [Manage users, SSH, and check or         repair disks on Azure Linux VMs using the VMAccess         Extension](https://learn.microsoft.com/troubleshoot/azure/virtual-machines/troubleshoot-ssh-connection)
      [AdminUsername <String>]: Specifies the name of the administrator account.    **Windows-only         restriction:** Cannot end in "."    **Disallowed values:**         "administrator", "admin", "user", "user1", "test", "user2", "test1", "user3",         "admin1", "1", "123", "a", "actuser", "adm", "admin2", "aspnet", "backup",         "console", "david", "guest", "john", "owner", "root", "server", "sql",         "support", "support_388945a0", "sys", "test2", "test3", "user4", "user5".            **Minimum-length (Linux):** 1  character    **Max-length         (Linux):** 64 characters    **Max-length (Windows):** 20 characters
      [AllowExtensionOperation <Boolean?>]: Specifies whether extension operations should be allowed on the virtual machine         scale set. This may only be set to False when no extensions are present on the         virtual machine scale set.
      ...
      [Secret <List<IVaultSecretGroup>>]: Specifies set of certificates that should be installed onto the virtual         machines in the scale set. To install certificates on a virtual machine it is         recommended to use the [Azure Key Vault virtual machine extension for         Linux](https://learn.microsoft.com/azure/virtual-machines/extensions/key-vault-linux)         or the [Azure Key Vault virtual machine extension for         Windows](https://learn.microsoft.com/azure/virtual-machines/extensions/key-vault-windows).
        ...
        [VaultCertificate <List<IVaultCertificate>>]: The list of key vault references in SourceVault which contain certificates.
          ...
          [CertificateUrl <String>]: This is the URL of a certificate that has been uploaded to Key Vault as a         secret. For adding a secret to the Key Vault, see [Add a key or secret to the         key         vault](https://learn.microsoft.com/azure/key-vault/key-vault-get-started/#add).         In this case, your certificate needs to be It is the Base64 encoding of the         following JSON Object which is encoded in UTF-8:    {          "data":"<Base64-encoded-certificate>",   "dataType":"pfx",          "password":"<pfx-file-password>" }   To install certificates on a virtual         machine it is recommended to use the [Azure Key Vault virtual machine extension         for         Linux](https://learn.microsoft.com/azure/virtual-machines/extensions/key-vault-linux)         or the [Azure Key Vault virtual machine extension for         Windows](https://learn.microsoft.com/azure/virtual-machines/extensions/key-vault-windows).
    ...
    [StorageProfile <IVirtualMachineScaleSetStorageProfile>]: Specifies the storage settings for the virtual machine disks.
      [DataDisk <List<IVirtualMachineScaleSetDataDisk>>]: Specifies the parameters that are used to add data disks to the virtual         machines in the scale set. For more information about disks, see [About disks         and VHDs for Azure virtual         machines](https://learn.microsoft.com/azure/virtual-machines/managed-disks-overview).
...
VMATTRIBUTE <IVMAttributes>: Attribute based Fleet.
  ...
  [AcceleratorManufacturer <List<String>>]: The accelerator manufacturers specified as a list.         acceleratorSupport should be set to "Included" or "Required" to use this VMAttribute.         If acceleratorSupport is "Excluded", this VMAttribute can not be used.
  ...
  [AcceleratorType <List<String>>]: The accelerator types specified as a list. acceleratorSupport should be set to "Included" or "Required" to use this VMAttribute.         If acceleratorSupport is "Excluded", this VMAttribute can not be used.
  [ArchitectureType <List<String>>]: The VM architecture types specified as a list. Optional parameter.
  ...
  [CpuManufacturer <List<String>>]: The VM CPU manufacturers specified as a list. Optional parameter.
  ...
  [ExcludedVMSize <List<String>>]: Specifies which VMSizes should be excluded while building Fleet. Optional parameter.
  [LocalStorageDiskType <List<String>>]: The local storage disk types specified as a list. LocalStorageSupport should be set to "Included" or "Required" to use this VMAttribute.         If localStorageSupport is "Excluded", this VMAttribute can not be used.
  ...
  [VMCategory <List<String>>]: The VM category specified as a list. Optional parameter.
...
ZONEALLOCATIONPOLICYZONEPREFERENCE <IZonePreference[]>: Zone preferences, required when zone distribution strategy is Prioritized.
  Zone <String>: Name of the zone.
  [Rank <Int32?>]: The rank of the zone. This is used with 'Prioritized' ZoneDistributionStrategy.         The lower the number, the higher the priority, starting with 0.         0 is the highest rank. If not specified, defaults to lowest rank.
.Link
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.PSArgumentCompleterAttribute("VM", "VCpu")]
    [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Category('Body')]
    [System.String]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.PSArgumentCompleterAttribute("Managed", "Launch")]
    [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Category('Body')]
    [System.String]
    # Mode of the Fleet.
    ${Mode},
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.ITrackedResourceTags]))]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.PSArgumentCompleterAttribute("BestEffortSingleZone", "Prioritized")]
    [Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Category('Body')]
    [System.String]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ComputeFleet.private\Update-AzComputeFleet_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ComputeFleet.private\Update-AzComputeFleet_UpdateViaIdentityExpanded';
        }
