...
namespace Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models
{
    ...
    public partial class OrganizationResourceUpdate
    {
        ...
        internal OrganizationResourceUpdate(Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject json)
        {
            ...
            {_identity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject>("identity"), out var __jsonIdentity) ? Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models.AzureResourceManagerCommonTypesManagedServiceIdentityUpdate.FromJson(__jsonIdentity) : _identity;}
            {_tag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models.OrganizationResourceUpdateTags.FromJson(__jsonTags) : _tag;}
            AfterFromJson(json);
        }
