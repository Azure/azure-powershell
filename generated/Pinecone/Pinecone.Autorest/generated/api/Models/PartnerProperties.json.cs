...
namespace Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models
{
    ...
    public partial class PartnerProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models.IPartnerProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models.IPartnerProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models.IPartnerProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject json ? new PartnerProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject into a new instance of <see cref="PartnerProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PartnerProperties(Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject json)
        {
            ...
            {_displayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonString>("displayName"), out var __jsonDisplayName) ? (string)__jsonDisplayName : (string)_displayName;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PartnerProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PartnerProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._displayName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonString(this._displayName.ToString()) : null, "displayName" ,container.Add );
