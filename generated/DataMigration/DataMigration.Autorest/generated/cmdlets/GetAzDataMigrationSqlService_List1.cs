...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListBySubscription=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.DataMigration/sqlMigrationServices"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDataMigrationSqlService_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Description(@"Retrieve all SQL migration services in the subscriptions.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.DataMigration/sqlMigrationServices", ApiVersion = "2025-03-15-preview")]
    public partial class GetAzDataMigrationSqlService_List1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzDataMigrationSqlService_List1" /> cmdlet class.
        /// </summary>
        public GetAzDataMigrationSqlService_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SqlMigrationServicesListBySubscription(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.SqlMigrationServicesListBySubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
