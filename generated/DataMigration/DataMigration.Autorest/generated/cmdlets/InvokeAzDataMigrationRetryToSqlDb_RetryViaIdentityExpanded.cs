...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Retry=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{sqlDbInstanceName}/providers/Microsoft.DataMigration/databaseMigrations/{targetDbName}/retry"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzDataMigrationRetryToSqlDb_RetryViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Description(@"Retry on going migration for the database.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{sqlDbInstanceName}/providers/Microsoft.DataMigration/databaseMigrations/{targetDbName}/retry", ApiVersion = "2025-06-30")]
    public partial class InvokeAzDataMigrationRetryToSqlDb_RetryViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250630.IMigrationOperationInput _migrationOperationInputBody = new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250630.MigrationOperationInput();
        ...
        public string MigrationOperationId { get => _migrationOperationInputBody.MigrationOperationId ?? null; set => _migrationOperationInputBody.MigrationOperationId = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzDataMigrationRetryToSqlDb_RetryViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets.InvokeAzDataMigrationRetryToSqlDb_RetryViaIdentityExpanded Clone()
        {
            var clone = new InvokeAzDataMigrationRetryToSqlDb_RetryViaIdentityExpanded();
            ...
            clone._migrationOperationInputBody = this._migrationOperationInputBody;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzDataMigrationRetryToSqlDb_RetryViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public InvokeAzDataMigrationRetryToSqlDb_RetryViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DatabaseMigrationsSqlDbRetry' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DatabaseMigrationsSqlDbRetryViaIdentity(InputObject.Id, _migrationOperationInputBody, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.SqlDbInstanceName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.SqlDbInstanceName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        ...
                        await this.Client.DatabaseMigrationsSqlDbRetry(InputObject.ResourceGroupName ?? null, InputObject.SqlDbInstanceName ?? null, InputObject.TargetDbName ?? null, InputObject.SubscriptionId ?? null, _migrationOperationInputBody, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_migrationOperationInputBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage)
        {
            using( NoSynchronizationContext )
            {
                ...
                WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_migrationOperationInputBody })
                {
