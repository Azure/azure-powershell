...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.ProvisioningState Provisioning = @"Provisioning";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.ProvisioningState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
