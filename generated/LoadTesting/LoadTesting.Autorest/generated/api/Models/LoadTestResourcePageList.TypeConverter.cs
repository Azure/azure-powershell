...
namespace Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models
{
    ...
    public partial class LoadTestResourcePageListTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <paramref name="sourceValue"/> parameter to the <see cref="LoadTestResourcePageList"/>
        /// type.
        /// </summary>
        ...
        /// <summary>
        /// Converts the <paramref name="sourceValue" /> parameter into an instance of <see cref="LoadTestResourcePageList" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="LoadTestResourcePageList" />.</param>
        /// <returns>
        /// an instance of <see cref="LoadTestResourcePageList" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.ILoadTestResourcePageList ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.ILoadTestResourcePageList).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
