...
namespace Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models
{
    ...
    public partial class OutboundEnvironmentEndpoint :
        Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IOutboundEnvironmentEndpoint,
        Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IOutboundEnvironmentEndpointInternal
    {
        ...
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IEndpointDependency> _endpoint;

        /// <summary>The endpoints for this service to which the Batch service makes outbound calls.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Origin(Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IEndpointDependency> Endpoint { get => this._endpoint; }

        /// <summary>Internal Acessors for Category</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IOutboundEnvironmentEndpointInternal.Category { get => this._category; set { {_category = value;} } }

        /// <summary>Internal Acessors for Endpoint</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IEndpointDependency> Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IOutboundEnvironmentEndpointInternal.Endpoint { get => this._endpoint; set { {_endpoint = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IEndpointDependency) })]
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IEndpointDependency> Endpoint { get;  }
...

    {
        ...
        /// <summary>The endpoints for this service to which the Batch service makes outbound calls.</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IEndpointDependency> Endpoint { get; set; }
