...
namespace Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.Api20221201
{
    ...
    public partial class LoadTestProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.Api20221201.ILoadTestProperties.
        /// </summary>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.Json.JsonObject into a new instance of <see cref="LoadTestProperties" />.
        /// </summary>
        ...
        internal LoadTestProperties(Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.Json.JsonObject json)
        {
            ...
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.Json.JsonObject>("encryption"), out var __jsonEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.Api20221201.EncryptionProperties.FromJson(__jsonEncryption) : Encryption;}
            {_provisioningState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.Json.JsonString>("provisioningState"), out var __jsonProvisioningState) ? (string)__jsonProvisioningState : (string)ProvisioningState;}
            {_dataPlaneUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.Json.JsonString>("dataPlaneURI"), out var __jsonDataPlaneUri) ? (string)__jsonDataPlaneUri : (string)DataPlaneUri;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="LoadTestProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="LoadTestProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.Json.JsonNode" />.
        /// </returns>
