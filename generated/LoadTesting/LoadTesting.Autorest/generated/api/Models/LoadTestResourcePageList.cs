...
namespace Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models
{
    ...
    public partial class LoadTestResourcePageList :
        Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.ILoadTestResourcePageList,
        Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.ILoadTestResourcePageListInternal
    {
        ...
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.ILoadTestResource> _value;

        /// <summary>List of resources in current page.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Origin(Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.ILoadTestResource> Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.ILoadTestResource) })]
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.ILoadTestResource> Value { get; set; }
