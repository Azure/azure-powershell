...
namespace Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models
{
    ...
    public partial class QuotaBucketRequestProperties :
        Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IQuotaBucketRequestProperties,
        Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IQuotaBucketRequestPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IQuotaBucketRequestPropertiesDimensions _dimension;

        /// <summary>Dimensions for new quota request.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Origin(Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IQuotaBucketRequestPropertiesDimensions Dimension { get => (this._dimension = this._dimension ?? new Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.QuotaBucketRequestPropertiesDimensions()); set => this._dimension = value; }
        ...
        public string DimensionLocation { get => ((Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IQuotaBucketRequestPropertiesDimensionsInternal)Dimension).Location; set => ((Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IQuotaBucketRequestPropertiesDimensionsInternal)Dimension).Location = value ?? null; }

        /// <summary>Subscription Id dimension for new quota request of the quota bucket.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Origin(Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.PropertyOrigin.Inlined)]
        public string DimensionSubscriptionId { get => ((Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IQuotaBucketRequestPropertiesDimensionsInternal)Dimension).SubscriptionId; set => ((Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IQuotaBucketRequestPropertiesDimensionsInternal)Dimension).SubscriptionId = value ?? null; }

        /// <summary>Internal Acessors for Dimension</summary>
        Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IQuotaBucketRequestPropertiesDimensions Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.IQuotaBucketRequestPropertiesInternal.Dimension { get => (this._dimension = this._dimension ?? new Microsoft.Azure.PowerShell.Cmdlets.LoadTesting.Models.QuotaBucketRequestPropertiesDimensions()); set { {_dimension = value;} } }
