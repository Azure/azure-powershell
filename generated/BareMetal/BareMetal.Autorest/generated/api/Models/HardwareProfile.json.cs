...
namespace Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models
{
    ...
    public partial class HardwareProfile
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IHardwareProfile.
        /// </summary>
        ...
        internal HardwareProfile(Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonObject json)
        {
            ...
            {_hardwareType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonString>("hardwareType"), out var __jsonHardwareType) ? (string)__jsonHardwareType : (string)_hardwareType;}
            {_azureBareMetalInstanceSize = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonString>("azureBareMetalInstanceSize"), out var __jsonAzureBareMetalInstanceSize) ? (string)__jsonAzureBareMetalInstanceSize : (string)_azureBareMetalInstanceSize;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="HardwareProfile" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="HardwareProfile" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonNode" />.
        /// </returns>
