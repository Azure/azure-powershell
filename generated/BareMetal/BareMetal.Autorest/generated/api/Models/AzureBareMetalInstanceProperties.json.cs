...
namespace Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models
{
    ...
    public partial class AzureBareMetalInstanceProperties
    {
        ...
        internal AzureBareMetalInstanceProperties(Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonObject json)
        {
            ...
            {_hardwareProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonObject>("hardwareProfile"), out var __jsonHardwareProfile) ? Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.HardwareProfile.FromJson(__jsonHardwareProfile) : _hardwareProfile;}
            {_storageProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonObject>("storageProfile"), out var __jsonStorageProfile) ? Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.StorageProfile.FromJson(__jsonStorageProfile) : _storageProfile;}
            {_oSProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonObject>("osProfile"), out var __jsonOSProfile) ? Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.OSProfile.FromJson(__jsonOSProfile) : _oSProfile;}
            {_networkProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonObject>("networkProfile"), out var __jsonNetworkProfile) ? Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.NetworkProfile.FromJson(__jsonNetworkProfile) : _networkProfile;}
            {_azureBareMetalInstanceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonString>("azureBareMetalInstanceId"), out var __jsonAzureBareMetalInstanceId) ? (string)__jsonAzureBareMetalInstanceId : (string)_azureBareMetalInstanceId;}
            {_powerState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonString>("powerState"), out var __jsonPowerState) ? (string)__jsonPowerState : (string)_powerState;}
            {_proximityPlacementGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonString>("proximityPlacementGroup"), out var __jsonProximityPlacementGroup) ? (string)__jsonProximityPlacementGroup : (string)_proximityPlacementGroup;}
            {_hwRevision = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonString>("hwRevision"), out var __jsonHwRevision) ? (string)__jsonHwRevision : (string)_hwRevision;}
            {_partnerNodeId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonString>("partnerNodeId"), out var __jsonPartnerNodeId) ? (string)__jsonPartnerNodeId : (string)_partnerNodeId;}
            {_provisioningState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonString>("provisioningState"), out var __jsonProvisioningState) ? (string)__jsonProvisioningState : (string)_provisioningState;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IAzureBareMetalInstanceProperties.
        /// </summary>
