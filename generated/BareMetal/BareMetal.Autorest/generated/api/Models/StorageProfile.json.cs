...
namespace Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models
{
    ...
    public partial class StorageProfile
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IStorageProfile.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IStorageProfile.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IStorageProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonNode node)
        {
        ...
        internal StorageProfile(Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonObject json)
        {
            ...
            {_nfsIPAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonString>("nfsIpAddress"), out var __jsonNfsIPAddress) ? (string)__jsonNfsIPAddress : (string)_nfsIPAddress;}
            {_oSDisk = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonArray>("osDisks"), out var __jsonOSDisks) ? If( __jsonOSDisks as Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IDisk>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IDisk) (Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.Disk.FromJson(__u) )) ))() : null : _oSDisk;}
            AfterFromJson(json);
        }
