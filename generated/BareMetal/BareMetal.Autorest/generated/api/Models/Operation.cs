...
namespace Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IOperationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IDisplay _display;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IDisplay Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.Display()); set => this._display = value; }
        ...
        public string DisplayDescription { get => ((Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IDisplayInternal)Display).Description; }

        /// <summary>The localized friendly name for the operation as shown to the user.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Origin(Microsoft.Azure.PowerShell.Cmdlets.BareMetal.PropertyOrigin.Inlined)]
        public string DisplayOperation { get => ((Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IDisplayInternal)Display).Operation; }

        /// <summary>The localized friendly form of the resource provider name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Origin(Microsoft.Azure.PowerShell.Cmdlets.BareMetal.PropertyOrigin.Inlined)]
        public string DisplayProvider { get => ((Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IDisplayInternal)Display).Provider; }

        /// <summary>
        /// The localized friendly form of the resource type related to this action/operation.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Origin(Microsoft.Azure.PowerShell.Cmdlets.BareMetal.PropertyOrigin.Inlined)]
        public string DisplayResource { get => ((Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IDisplayInternal)Display).Resource; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IOperationInternal.Name { get => this._name; set { {_name = value;} } }
    ...
    {
        /// <summary>Displayed AzureBareMetal operation information</summary>
        Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IDisplay Display { get; set; }
        /// <summary>The localized friendly description for the operation as shown to the user.</summary>
