...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20230501
{
    ...
    public partial class AmlFilesystemContainerStorageInterface
    {
        ...
        internal AmlFilesystemContainerStorageInterface(Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonObject json)
        {
            ...
            {_persistentVolumeClaim = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonString>("persistentVolumeClaim"), out var __jsonPersistentVolumeClaim) ? (string)__jsonPersistentVolumeClaim : (string)PersistentVolumeClaim;}
            {_persistentVolume = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonString>("persistentVolume"), out var __jsonPersistentVolume) ? (string)__jsonPersistentVolume : (string)PersistentVolume;}
            {_storageClass = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonString>("storageClass"), out var __jsonStorageClass) ? (string)__jsonStorageClass : (string)StorageClass;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20230501.IAmlFilesystemContainerStorageInterface.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20230501.IAmlFilesystemContainerStorageInterface.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20230501.IAmlFilesystemContainerStorageInterface FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonNode node)
        {
