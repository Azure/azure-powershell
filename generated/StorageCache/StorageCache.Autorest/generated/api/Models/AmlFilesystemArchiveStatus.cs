...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models
{
    ...
    public partial class AmlFilesystemArchiveStatus :
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.IAmlFilesystemArchiveStatus,
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.IAmlFilesystemArchiveStatusInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.IAmlFilesystemArchiveStatusInternal.ErrorCode { get => this._errorCode; set { {_errorCode = value;} } }

        /// <summary>Internal Acessors for ErrorMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.IAmlFilesystemArchiveStatusInternal.ErrorMessage { get => this._errorMessage; set { {_errorMessage = value;} } }

        /// <summary>Internal Acessors for LastCompletionTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.IAmlFilesystemArchiveStatusInternal.LastCompletionTime { get => this._lastCompletionTime; set { {_lastCompletionTime = value;} } }

        /// <summary>Internal Acessors for LastStartedTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.IAmlFilesystemArchiveStatusInternal.LastStartedTime { get => this._lastStartedTime; set { {_lastStartedTime = value;} } }

        /// <summary>Internal Acessors for PercentComplete</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.IAmlFilesystemArchiveStatusInternal.PercentComplete { get => this._percentComplete; set { {_percentComplete = value;} } }

        /// <summary>Internal Acessors for State</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.IAmlFilesystemArchiveStatusInternal.State { get => this._state; set { {_state = value;} } }
