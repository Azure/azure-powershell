...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models
{
    ...
    public partial class GeoLocation :
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IGeoLocation,
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IGeoLocationInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IGeoLocationInternal.Asn { get => this._asn; set { {_asn = value;} } }

        /// <summary>Internal Acessors for City</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IGeoLocationInternal.City { get => this._city; set { {_city = value;} } }

        /// <summary>Internal Acessors for CountryCode</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IGeoLocationInternal.CountryCode { get => this._countryCode; set { {_countryCode = value;} } }

        /// <summary>Internal Acessors for CountryName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IGeoLocationInternal.CountryName { get => this._countryName; set { {_countryName = value;} } }

        /// <summary>Internal Acessors for Latitude</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IGeoLocationInternal.Latitude { get => this._latitude; set { {_latitude = value;} } }

        /// <summary>Internal Acessors for Longitude</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IGeoLocationInternal.Longitude { get => this._longitude; set { {_longitude = value;} } }

        /// <summary>Internal Acessors for State</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IGeoLocationInternal.State { get => this._state; set { {_state = value;} } }
