...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models
{
    ...
    public partial class SubmissionMailEntityProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISubmissionMailEntityProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISubmissionMailEntityProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISubmissionMailEntityProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonNode node)
        {
        ...
        internal SubmissionMailEntityProperties(Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonObject json)
        {
            ...
            {_networkMessageId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonString>("networkMessageId"), out var __jsonNetworkMessageId) ? (string)__jsonNetworkMessageId : (string)_networkMessageId;}
            {_submissionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonString>("submissionId"), out var __jsonSubmissionId) ? (string)__jsonSubmissionId : (string)_submissionId;}
            {_submitter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonString>("submitter"), out var __jsonSubmitter) ? (string)__jsonSubmitter : (string)_submitter;}
            {_submissionDate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonString>("submissionDate"), out var __jsonSubmissionDate) ? global::System.DateTime.TryParse((string)__jsonSubmissionDate, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonSubmissionDateValue) ? __jsonSubmissionDateValue : _submissionDate : _submissionDate;}
            ...
            {_recipient = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonString>("recipient"), out var __jsonRecipient) ? (string)__jsonRecipient : (string)_recipient;}
            {_sender = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonString>("sender"), out var __jsonSender) ? (string)__jsonSender : (string)_sender;}
            {_senderIP = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonString>("senderIp"), out var __jsonSenderIP) ? (string)__jsonSenderIP : (string)_senderIP;}
            {_subject = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonString>("subject"), out var __jsonSubject) ? (string)__jsonSubject : (string)_subject;}
            {_reportType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonString>("reportType"), out var __jsonReportType) ? (string)__jsonReportType : (string)_reportType;}
            AfterFromJson(json);
        }
