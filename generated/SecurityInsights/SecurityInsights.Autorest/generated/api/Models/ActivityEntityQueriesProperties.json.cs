...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models
{
    ...
    public partial class ActivityEntityQueriesProperties
    {
        ...
        internal ActivityEntityQueriesProperties(Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonObject json)
        {
            ...
            {_queryDefinition = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonObject>("queryDefinitions"), out var __jsonQueryDefinitions) ? Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ActivityEntityQueriesPropertiesQueryDefinitions.FromJson(__jsonQueryDefinitions) : _queryDefinition;}
            ...
            {_content = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonString>("content"), out var __jsonContent) ? (string)__jsonContent : (string)_content;}
            ...
            {_requiredInputFieldsSet = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonArray>("requiredInputFieldsSets"), out var __jsonRequiredInputFieldsSets) ? If( __jsonRequiredInputFieldsSets as Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonArray, out var __u) ? new global::System.Func<System.Collections.Generic.List<System.Collections.Generic.List<string>>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__u, (__t)=>(System.Collections.Generic.List<string>) (If( __t as Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonArray, out var __s) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__s, (__r)=>(string) (__r is Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonString __q ? (string)(__q.ToString()) : null)) ))() : null /* arrayOf */)) ))() : null : _requiredInputFieldsSet;}
            {_entitiesFilter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonObject>("entitiesFilter"), out var __jsonEntitiesFilter) ? Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ActivityEntityQueriesPropertiesEntitiesFilter.FromJson(__jsonEntitiesFilter) : _entitiesFilter;}
            {_templateName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonString>("templateName"), out var __jsonTemplateName) ? (string)__jsonTemplateName : (string)_templateName;}
            {_enabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonBoolean>("enabled"), out var __jsonEnabled) ? (bool?)__jsonEnabled : _enabled;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IActivityEntityQueriesProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IActivityEntityQueriesProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IActivityEntityQueriesProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonNode node)
        {
