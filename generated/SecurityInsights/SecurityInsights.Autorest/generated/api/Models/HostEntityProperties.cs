...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models
{
    ...
    public partial class HostEntityProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IHostEntityProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IHostEntityPropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IHostEntityPropertiesInternal.AzureId { get => this._azureId; set { {_azureId = value;} } }

        /// <summary>Internal Acessors for DnsDomain</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IHostEntityPropertiesInternal.DnsDomain { get => this._dnsDomain; set { {_dnsDomain = value;} } }

        /// <summary>Internal Acessors for HostName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IHostEntityPropertiesInternal.HostName { get => this._hostName; set { {_hostName = value;} } }

        /// <summary>Internal Acessors for IsDomainJoined</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IHostEntityPropertiesInternal.IsDomainJoined { get => this._isDomainJoined; set { {_isDomainJoined = value;} } }

        /// <summary>Internal Acessors for NetBiosName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IHostEntityPropertiesInternal.NetBiosName { get => this._netBiosName; set { {_netBiosName = value;} } }

        /// <summary>Internal Acessors for NtDomain</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IHostEntityPropertiesInternal.NtDomain { get => this._ntDomain; set { {_ntDomain = value;} } }

        /// <summary>Internal Acessors for OSVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IHostEntityPropertiesInternal.OSVersion { get => this._oSVersion; set { {_oSVersion = value;} } }

        /// <summary>Internal Acessors for OmsAgentId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IHostEntityPropertiesInternal.OmsAgentId { get => this._omsAgentId; set { {_omsAgentId = value;} } }
