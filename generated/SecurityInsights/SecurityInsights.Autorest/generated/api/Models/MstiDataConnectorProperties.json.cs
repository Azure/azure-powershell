...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models
{
    ...
    public partial class MstiDataConnectorProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IMstiDataConnectorProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IMstiDataConnectorProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IMstiDataConnectorProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonObject json ? new MstiDataConnectorProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonObject into a new instance of <see cref="MstiDataConnectorProperties" />.
        /// </summary>
        ...
        internal MstiDataConnectorProperties(Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonObject json)
        {
            ...
            __dataConnectorTenantId = new Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.DataConnectorTenantId(json);
            {_dataType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonObject>("dataTypes"), out var __jsonDataTypes) ? Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.MstiDataConnectorDataTypes.FromJson(__jsonDataTypes) : _dataType;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="MstiDataConnectorProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MstiDataConnectorProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Json.JsonNode" />.
        /// </returns>
