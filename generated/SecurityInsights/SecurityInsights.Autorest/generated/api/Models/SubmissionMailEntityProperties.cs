...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models
{
    ...
    public partial class SubmissionMailEntityProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISubmissionMailEntityProperties,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISubmissionMailEntityPropertiesInternal.NetworkMessageId { get => this._networkMessageId; set { {_networkMessageId = value;} } }

        /// <summary>Internal Acessors for Recipient</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISubmissionMailEntityPropertiesInternal.Recipient { get => this._recipient; set { {_recipient = value;} } }

        /// <summary>Internal Acessors for ReportType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISubmissionMailEntityPropertiesInternal.ReportType { get => this._reportType; set { {_reportType = value;} } }

        /// <summary>Internal Acessors for Sender</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISubmissionMailEntityPropertiesInternal.Sender { get => this._sender; set { {_sender = value;} } }

        /// <summary>Internal Acessors for SenderIP</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISubmissionMailEntityPropertiesInternal.SenderIP { get => this._senderIP; set { {_senderIP = value;} } }

        /// <summary>Internal Acessors for Subject</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISubmissionMailEntityPropertiesInternal.Subject { get => this._subject; set { {_subject = value;} } }

        /// <summary>Internal Acessors for SubmissionDate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISubmissionMailEntityPropertiesInternal.SubmissionDate { get => this._submissionDate; set { {_submissionDate = value;} } }

        /// <summary>Internal Acessors for SubmissionId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISubmissionMailEntityPropertiesInternal.SubmissionId { get => this._submissionId; set { {_submissionId = value;} } }

        /// <summary>Internal Acessors for Submitter</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISubmissionMailEntityPropertiesInternal.Submitter { get => this._submitter; set { {_submitter = value;} } }

        /// <summary>Internal Acessors for Timestamp</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISubmissionMailEntityPropertiesInternal.Timestamp { get => this._timestamp; set { {_timestamp = value;} } }
