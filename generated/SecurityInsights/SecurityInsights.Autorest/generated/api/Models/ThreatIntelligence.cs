...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models
{
    ...
    public partial class ThreatIntelligence :
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IThreatIntelligence,
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IThreatIntelligenceInternal
    {
        ...
        double? Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IThreatIntelligenceInternal.Confidence { get => this._confidence; set { {_confidence = value;} } }

        /// <summary>Internal Acessors for ProviderName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IThreatIntelligenceInternal.ProviderName { get => this._providerName; set { {_providerName = value;} } }

        /// <summary>Internal Acessors for ReportLink</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IThreatIntelligenceInternal.ReportLink { get => this._reportLink; set { {_reportLink = value;} } }

        /// <summary>Internal Acessors for ThreatDescription</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IThreatIntelligenceInternal.ThreatDescription { get => this._threatDescription; set { {_threatDescription = value;} } }

        /// <summary>Internal Acessors for ThreatName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IThreatIntelligenceInternal.ThreatName { get => this._threatName; set { {_threatName = value;} } }

        /// <summary>Internal Acessors for ThreatType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IThreatIntelligenceInternal.ThreatType { get => this._threatType; set { {_threatType = value;} } }
