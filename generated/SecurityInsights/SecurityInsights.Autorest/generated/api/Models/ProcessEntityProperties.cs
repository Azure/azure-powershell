...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models
{
    ...
    public partial class ProcessEntityProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IProcessEntityProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IProcessEntityPropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.IValidates
    {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Origin(Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.PropertyOrigin.Owned)]
        public string ElevationToken { get => this._elevationToken; set => this._elevationToken = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IProcessEntityPropertiesInternal.AccountEntityId { get => this._accountEntityId; set { {_accountEntityId = value;} } }

        /// <summary>Internal Acessors for CommandLine</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IProcessEntityPropertiesInternal.CommandLine { get => this._commandLine; set { {_commandLine = value;} } }

        /// <summary>Internal Acessors for CreationTimeUtc</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IProcessEntityPropertiesInternal.CreationTimeUtc { get => this._creationTimeUtc; set { {_creationTimeUtc = value;} } }

        /// <summary>Internal Acessors for HostEntityId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IProcessEntityPropertiesInternal.HostEntityId { get => this._hostEntityId; set { {_hostEntityId = value;} } }

        /// <summary>Internal Acessors for HostLogonSessionEntityId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IProcessEntityPropertiesInternal.HostLogonSessionEntityId { get => this._hostLogonSessionEntityId; set { {_hostLogonSessionEntityId = value;} } }

        /// <summary>Internal Acessors for ImageFileEntityId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IProcessEntityPropertiesInternal.ImageFileEntityId { get => this._imageFileEntityId; set { {_imageFileEntityId = value;} } }

        /// <summary>Internal Acessors for ParentProcessEntityId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IProcessEntityPropertiesInternal.ParentProcessEntityId { get => this._parentProcessEntityId; set { {_parentProcessEntityId = value;} } }

        /// <summary>Internal Acessors for ProcessId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IProcessEntityPropertiesInternal.ProcessId { get => this._processId; set { {_processId = value;} } }
