...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Cmdlets
{
    ...
    /// <summary>update the data connector.</summary>
    /// <remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Description(@"update the data connector.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    DataConnector = await this.Client.DataConnectorsGetWithResult(SubscriptionId, ResourceGroupName, WorkspaceName, Id, this, Pipeline);
                    this.UpdateDataConnector();
                    await this.Client.DataConnectorsCreateOrUpdate(SubscriptionId, ResourceGroupName, WorkspaceName, Id, DataConnector, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeUpdate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzSentinelDataConnector_Update" /> cmdlet class.
        /// </summary>
        ...
        private void UpdateDataConnector()
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("DataConnector")))
            {
                this.DataConnector = (Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IDataConnector)(this.MyInvocation?.BoundParameters["DataConnector"]);
            }
        }
