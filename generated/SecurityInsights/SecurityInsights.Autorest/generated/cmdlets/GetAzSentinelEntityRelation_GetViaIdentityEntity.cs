...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetRelation=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/entities/{entityId}/relations/{relationName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzSentinelEntityRelation_GetViaIdentityEntity")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Description(@"Gets an entity relation.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/entities/{entityId}/relations/{relationName}", ApiVersion = "2021-09-01-preview")]
    public partial class GetAzSentinelEntityRelation_GetViaIdentityEntity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="EntityInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISecurityInsightsIdentity _entityInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISecurityInsightsIdentity EntityInputObject { get => this._entityInputObject; set => this._entityInputObject = value; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzSentinelEntityRelation_GetViaIdentityEntity" /> cmdlet class.
        /// </summary>
        public GetAzSentinelEntityRelation_GetViaIdentityEntity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (EntityInputObject?.Id != null)
                    {
                        this.EntityInputObject.Id += $"/relations/{(global::System.Uri.EscapeDataString(this.RelationName.ToString()))}";
                        await this.Client.EntityRelationsGetRelationViaIdentity(EntityInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == EntityInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("EntityInputObject has null value for EntityInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, EntityInputObject) );
                        }
                        if (null == EntityInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("EntityInputObject has null value for EntityInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, EntityInputObject) );
                        }
                        if (null == EntityInputObject.WorkspaceName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("EntityInputObject has null value for EntityInputObject.WorkspaceName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, EntityInputObject) );
                        }
                        if (null == EntityInputObject.EntityId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("EntityInputObject has null value for EntityInputObject.EntityId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, EntityInputObject) );
                        }
                        await this.Client.EntityRelationsGetRelation(EntityInputObject.SubscriptionId ?? null, EntityInputObject.ResourceGroupName ?? null, EntityInputObject.WorkspaceName ?? null, EntityInputObject.EntityId ?? null, RelationName, onOk, onDefault, this, Pipeline);
                    }
