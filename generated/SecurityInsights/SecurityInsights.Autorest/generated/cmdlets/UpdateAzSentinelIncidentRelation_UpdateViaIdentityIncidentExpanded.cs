...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Cmdlets
{
    ...
    /// <summary>update the incident relation.</summary>
    /// <remarks>
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzSentinelIncidentRelation_UpdateViaIdentityIncidentExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Description(@"update the incident relation.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Generated]
    public partial class UpdateAzSentinelIncidentRelation_UpdateViaIdentityIncidentExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (IncidentInputObject?.Id != null)
                    {
                        ...
                        _relationBody = await this.Client.IncidentRelationsGetViaIdentityWithResult(IncidentInputObject.Id, this, Pipeline);
                        this.Update_relationBody();
                        await this.Client.IncidentRelationsCreateOrUpdateViaIdentity(IncidentInputObject.Id, _relationBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _relationBody = await this.Client.IncidentRelationsGetWithResult(IncidentInputObject.SubscriptionId ?? null, IncidentInputObject.ResourceGroupName ?? null, IncidentInputObject.WorkspaceName ?? null, IncidentInputObject.IncidentId ?? null, RelationName, this, Pipeline);
                        this.Update_relationBody();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzSentinelIncidentRelation_UpdateViaIdentityIncidentExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzSentinelIncidentRelation_UpdateViaIdentityIncidentExpanded()
        {
