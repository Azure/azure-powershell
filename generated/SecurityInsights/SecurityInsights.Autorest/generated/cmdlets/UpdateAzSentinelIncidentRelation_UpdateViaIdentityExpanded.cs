...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _relationBody = await this.Client.IncidentRelationsGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_relationBody();
                        await this.Client.IncidentRelationsCreateOrUpdateViaIdentity(InputObject.Id, _relationBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _relationBody = await this.Client.IncidentRelationsGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.WorkspaceName ?? null, InputObject.IncidentId ?? null, InputObject.RelationName ?? null, this, Pipeline);
                        this.Update_relationBody();
                        await this.Client.IncidentRelationsCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.WorkspaceName ?? null, InputObject.IncidentId ?? null, InputObject.RelationName ?? null, _relationBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzSentinelIncidentRelation_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
