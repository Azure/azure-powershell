...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Cmdlets
{
    ...
    /// <summary>update the incident comment.</summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/incidents/{incidentId}/comments/{incidentCommentId}"
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/incidents/{incidentId}/comments/{incidentCommentId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzSentinelIncidentComment_UpdateViaIdentityIncidentExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IIncidentComment))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Description(@"update the incident comment.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Generated]
    public partial class UpdateAzSentinelIncidentComment_UpdateViaIdentityIncidentExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IIncidentComment _incidentCommentBody = new Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IncidentComment();
        ...
        public string Etag { get => _incidentCommentBody.Etag ?? null; set => _incidentCommentBody.Etag = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Incident comment ID")]
        [Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("IncidentCommentId")]
        ...
        /// <summary>Backing field for <see cref="IncidentInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISecurityInsightsIdentity _incidentInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISecurityInsightsIdentity IncidentInputObject { get => this._incidentInputObject; set => this._incidentInputObject = value; }

        /// <summary>Accessor for our copy of the InvocationInfo.</summary>
        public global::System.Management.Automation.InvocationInfo InvocationInformation { get => __invocationInfo = __invocationInfo ?? this.MyInvocation ; set { __invocationInfo = value; } }

        /// <summary>The comment message</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The comment message")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Message { get => _incidentCommentBody.Message ?? null; set => _incidentCommentBody.Message = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IIncidentComment">Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IIncidentComment</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IIncidentComment> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IIncidentComment> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'IncidentCommentsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (IncidentInputObject?.Id != null)
                    {
                        this.IncidentInputObject.Id += $"/comments/{(global::System.Uri.EscapeDataString(this.Id.ToString()))}";
                        _incidentCommentBody = await this.Client.IncidentCommentsGetViaIdentityWithResult(IncidentInputObject.Id, this, Pipeline);
                        this.Update_incidentCommentBody();
                        await this.Client.IncidentCommentsCreateOrUpdateViaIdentity(IncidentInputObject.Id, _incidentCommentBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == IncidentInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("IncidentInputObject has null value for IncidentInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, IncidentInputObject) );
                        }
                        if (null == IncidentInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("IncidentInputObject has null value for IncidentInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, IncidentInputObject) );
                        }
                        if (null == IncidentInputObject.WorkspaceName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("IncidentInputObject has null value for IncidentInputObject.WorkspaceName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, IncidentInputObject) );
                        }
                        if (null == IncidentInputObject.IncidentId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("IncidentInputObject has null value for IncidentInputObject.IncidentId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, IncidentInputObject) );
                        }
                        _incidentCommentBody = await this.Client.IncidentCommentsGetWithResult(IncidentInputObject.SubscriptionId ?? null, IncidentInputObject.ResourceGroupName ?? null, IncidentInputObject.WorkspaceName ?? null, IncidentInputObject.IncidentId ?? null, Id, this, Pipeline);
                        this.Update_incidentCommentBody();
                        await this.Client.IncidentCommentsCreateOrUpdate(IncidentInputObject.SubscriptionId ?? null, IncidentInputObject.ResourceGroupName ?? null, IncidentInputObject.WorkspaceName ?? null, IncidentInputObject.IncidentId ?? null, Id, _incidentCommentBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzSentinelIncidentComment_UpdateViaIdentityIncidentExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzSentinelIncidentComment_UpdateViaIdentityIncidentExpanded()
        {

        }

        private void Update_incidentCommentBody()
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Etag")))
            {
                this.Etag = (string)(this.MyInvocation?.BoundParameters["Etag"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Message")))
            {
                this.Message = (string)(this.MyInvocation?.BoundParameters["Message"]);
            }
        }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IIncidentComment> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IIncidentComment
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.IIncidentComment> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
