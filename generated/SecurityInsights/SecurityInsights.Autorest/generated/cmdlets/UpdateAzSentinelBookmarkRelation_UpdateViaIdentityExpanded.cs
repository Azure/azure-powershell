...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Cmdlets
{
    ...
    /// <summary>update the bookmark relation.</summary>
    /// <remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Description(@"update the bookmark relation.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _relationBody = await this.Client.BookmarkRelationsGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_relationBody();
                        await this.Client.BookmarkRelationsCreateOrUpdateViaIdentity(InputObject.Id, _relationBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _relationBody = await this.Client.BookmarkRelationsGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.WorkspaceName ?? null, InputObject.BookmarkId ?? null, InputObject.RelationName ?? null, this, Pipeline);
                        this.Update_relationBody();
                        await this.Client.BookmarkRelationsCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.WorkspaceName ?? null, InputObject.BookmarkId ?? null, InputObject.RelationName ?? null, _relationBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzSentinelBookmarkRelation_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        ...
        private void Update_relationBody()
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Etag")))
            {
                this.Etag = (string)(this.MyInvocation?.BoundParameters["Etag"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("RelatedResourceId")))
            {
                this.RelatedResourceId = (string)(this.MyInvocation?.BoundParameters["RelatedResourceId"]);
            }
        }
