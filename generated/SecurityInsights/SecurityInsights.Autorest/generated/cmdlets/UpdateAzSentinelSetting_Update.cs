...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzSentinelSetting_Update", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzSentinelSetting_Update : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISettings _setting;

        /// <summary>The Setting.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The Setting.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISettings Setting { get => this._setting; set => this._setting = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    Setting = await this.Client.ProductSettingsGetWithResult(SubscriptionId, ResourceGroupName, WorkspaceName, SettingsName, this, Pipeline);
                    this.UpdateSetting();
                    await this.Client.ProductSettingsUpdate(SubscriptionId, ResourceGroupName, WorkspaceName, SettingsName, Setting, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.SerializationMode.IncludeUpdate);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,WorkspaceName=WorkspaceName,SettingsName=SettingsName})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzSentinelSetting_Update" /> cmdlet class.
        /// </summary>
        public UpdateAzSentinelSetting_Update()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Setting")))
            {
                this.Setting = (Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.ISettings)(this.MyInvocation?.BoundParameters["Setting"]);
            }
        }
