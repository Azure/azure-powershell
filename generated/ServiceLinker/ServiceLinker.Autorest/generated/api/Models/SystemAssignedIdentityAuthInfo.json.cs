...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models
{
    ...
    public partial class SystemAssignedIdentityAuthInfo
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.ISystemAssignedIdentityAuthInfo.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.ISystemAssignedIdentityAuthInfo.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.ISystemAssignedIdentityAuthInfo FromJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode node)
        {
        ...
        internal SystemAssignedIdentityAuthInfo(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject json)
        {
            ...
            __authInfoBase = new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.AuthInfoBase(json);
            __databaseAadAuthInfo = new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.DatabaseAadAuthInfo(json);
            {_deleteOrUpdateBehavior = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonString>("deleteOrUpdateBehavior"), out var __jsonDeleteOrUpdateBehavior) ? (string)__jsonDeleteOrUpdateBehavior : (string)_deleteOrUpdateBehavior;}
            {_role = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonArray>("roles"), out var __jsonRoles) ? If( __jsonRoles as Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _role;}
            AfterFromJson(json);
        }
