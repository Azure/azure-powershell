...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.IConfigurationInfoInternal
    {
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.IConfigurationInfoAdditionalConfigurations AdditionalConfiguration { get => (this._additionalConfiguration = this._additionalConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.ConfigurationInfoAdditionalConfigurations()); set => this._additionalConfiguration = value; }

        /// <summary>Backing field for <see cref="CustomizedKey" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.IConfigurationInfoCustomizedKeys _customizedKey;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.IConfigurationInfoCustomizedKeys CustomizedKey { get => (this._customizedKey = this._customizedKey ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.ConfigurationInfoCustomizedKeys()); set => this._customizedKey = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.IConfigurationInfoAdditionalConfigurations AdditionalConfiguration { get; set; }
        /// <summary>
        /// Optional. A dictionary of default key name and customized key name mapping. If not specified, default key name will be
        /// used for generate configurations
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.IConfigurationInfoCustomizedKeys CustomizedKey { get; set; }
        /// <summary>
        /// Indicates whether to clean up previous operation when Linker is updating or deleting
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Info(
