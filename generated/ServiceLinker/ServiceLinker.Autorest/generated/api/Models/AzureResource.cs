...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models
{
    ...
    public partial class AzureResource :
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.IAzureResource,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.IValidates
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.IAzureResourcePropertiesBase _resourceProperty;

        /// <summary>The azure resource connection related properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.IAzureResourcePropertiesBase ResourceProperty { get => (this._resourceProperty = this._resourceProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.AzureResourcePropertiesBase()); set => this._resourceProperty = value; }
        ...
        public string Type { get => "AzureResource"; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.ITargetServiceBaseInternal)__targetServiceBase).Type = "AzureResource"; }

        /// <summary>Creates an new <see cref="AzureResource" /> instance.</summary>
        public AzureResource()
        {
            this.__targetServiceBase.Type = "AzureResource";
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.ITargetServiceBase
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.IAzureResourcePropertiesBase) })]
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.IAzureResourcePropertiesBase ResourceProperty { get; set; }
