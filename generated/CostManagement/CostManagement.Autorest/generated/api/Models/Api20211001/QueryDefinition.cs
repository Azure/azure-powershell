...
namespace Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001
{
    ...
    public partial class QueryDefinition :
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IQueryDefinition,
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IQueryDefinitionInternal
    {
        ...
        public string[] ConfigurationColumn { get => ((Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IQueryDatasetInternal)Dataset).ConfigurationColumn; set => ((Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IQueryDatasetInternal)Dataset).ConfigurationColumn = value ?? null /* arrayOf */; }

        /// <summary>Backing field for <see cref="Dataset" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IQueryDataset _dataset;

        /// <summary>Has definition for data in this query.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Origin(Microsoft.Azure.PowerShell.Cmdlets.CostManagement.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IQueryDataset Dataset { get => (this._dataset = this._dataset ?? new Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.QueryDataset()); set => this._dataset = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IQueryDatasetAggregation DatasetAggregation { get; set; }
        /// <summary>
        /// The filter expression to use in the query. Please reference our Query API REST documentation for how to properly format
        /// the filter.
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IQueryFilter DatasetFilter { get; set; }
        /// <summary>The granularity of rows in the query.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IQueryGrouping[] DatasetGrouping { get; set; }
        /// <summary>The start date to pull data from.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        string[] ConfigurationColumn { get; set; }
        /// <summary>Has definition for data in this query.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IQueryDataset Dataset { get; set; }
        /// <summary>
        /// Dictionary of aggregation expression to use in the query. The key of each item in the dictionary is the alias for the
        /// aggregated column. Query can have up to 2 aggregation clauses.
        /// </summary>
        ...
        /// are provided.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IQueryDatasetConfiguration DatasetConfiguration { get; set; }
        /// <summary>
        /// The filter expression to use in the query. Please reference our Query API REST documentation for how to properly format
        /// the filter.
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IQueryGrouping[] DatasetGrouping { get; set; }
        /// <summary>Has time period for pulling data for the query.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IQueryTimePeriod TimePeriod { get; set; }
        /// <summary>The start date to pull data from.</summary>
        global::System.DateTime? TimePeriodFrom { get; set; }
        /// <summary>The end date to pull data to.</summary>
        global::System.DateTime? TimePeriodTo { get; set; }
