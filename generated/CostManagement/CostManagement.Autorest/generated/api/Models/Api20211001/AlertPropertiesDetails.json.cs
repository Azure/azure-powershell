...
namespace Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001
{
    ...
    public partial class AlertPropertiesDetails
    {
        ...
        internal AlertPropertiesDetails(Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonObject json)
        {
            ...
            {_departmentName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonString>("departmentName"), out var __jsonDepartmentName) ? (string)__jsonDepartmentName : (string)DepartmentName;}
            {_companyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonString>("companyName"), out var __jsonCompanyName) ? (string)__jsonCompanyName : (string)CompanyName;}
            {_enrollmentNumber = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonString>("enrollmentNumber"), out var __jsonEnrollmentNumber) ? (string)__jsonEnrollmentNumber : (string)EnrollmentNumber;}
            {_enrollmentStartDate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonString>("enrollmentStartDate"), out var __jsonEnrollmentStartDate) ? (string)__jsonEnrollmentStartDate : (string)EnrollmentStartDate;}
            {_enrollmentEndDate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonString>("enrollmentEndDate"), out var __jsonEnrollmentEndDate) ? (string)__jsonEnrollmentEndDate : (string)EnrollmentEndDate;}
            {_invoicingThreshold = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonNumber>("invoicingThreshold"), out var __jsonInvoicingThreshold) ? (decimal?)__jsonInvoicingThreshold : InvoicingThreshold;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IAlertPropertiesDetails.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IAlertPropertiesDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IAlertPropertiesDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonNode node)
        {
