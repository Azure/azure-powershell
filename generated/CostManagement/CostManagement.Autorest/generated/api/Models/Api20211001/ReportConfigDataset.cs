...
namespace Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001
{
    ...
    public partial class ReportConfigDataset :
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigDataset,
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigDatasetInternal
    {

        /// <summary>Backing field for <see cref="Aggregation" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigDatasetAggregation _aggregation;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigDatasetAggregation Aggregation { get => (this._aggregation = this._aggregation ?? new Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.ReportConfigDatasetAggregation()); set => this._aggregation = value; }

        /// <summary>Backing field for <see cref="Configuration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigDatasetConfiguration _configuration;
        ...
        public string[] ConfigurationColumn { get => ((Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigDatasetConfigurationInternal)Configuration).Column; set => ((Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigDatasetConfigurationInternal)Configuration).Column = value ?? null /* arrayOf */; }

        /// <summary>Backing field for <see cref="Filter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigFilter _filter;

        /// <summary>Has filter expression to use in the report.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Origin(Microsoft.Azure.PowerShell.Cmdlets.CostManagement.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigFilter Filter { get => (this._filter = this._filter ?? new Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.ReportConfigFilter()); set => this._filter = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigGrouping[] _grouping;

        /// <summary>
        /// Array of group by expression to use in the report. Report can have up to 2 group by clauses.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Origin(Microsoft.Azure.PowerShell.Cmdlets.CostManagement.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigGrouping[] Grouping { get => this._grouping; set => this._grouping = value; }

        /// <summary>Internal Acessors for Configuration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigDatasetConfiguration Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigDatasetInternal.Configuration { get => (this._configuration = this._configuration ?? new Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.ReportConfigDatasetConfiguration()); set { {_configuration = value;} } }

        /// <summary>Backing field for <see cref="Sorting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigSorting[] _sorting;

        /// <summary>Array of order by expression to use in the report.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Origin(Microsoft.Azure.PowerShell.Cmdlets.CostManagement.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigSorting[] Sorting { get => this._sorting; set => this._sorting = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigDatasetAggregation Aggregation { get; set; }
        /// <summary>
        /// Array of column names to be included in the report. Any valid report column name is allowed. If not provided, then report
        /// includes all columns.
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigFilter Filter { get; set; }
        /// <summary>The granularity of rows in the report.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigGrouping[] Grouping { get; set; }
        /// <summary>Array of order by expression to use in the report.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigSorting[] Sorting { get; set; }
...

    {
        ...
        /// are provided.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20211001.IReportConfigDatasetConfiguration Configuration { get; set; }
        /// <summary>
        /// Array of column names to be included in the report. Any valid report column name is allowed. If not provided, then report
        /// includes all columns.
        /// </summary>
