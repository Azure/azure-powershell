...
namespace Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateOperation=>POST:"/{scope}/providers/Microsoft.CostManagement/generateCostDetailsReport"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzCostManagementDetailReport_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20220501.ICostDetailsOperationResults))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Description(@"This API is the replacement for all previously release Usage Details APIs. Request to generate a cost details report for the provided date range, billing period (Only enterprise customers) or Invoice Id asynchronously at a certain scope. The initial call to request a report will return a 202 with a 'Location' and 'Retry-After' header. The 'Location' header will provide the endpoint to poll to get the result of the report generation. The 'Retry-After' provides the duration to wait before polling for the generated report. A call to poll the report operation will provide a 202 response with a 'Location' header if the operation is still in progress. Once the report generation operation completes, the polling endpoint will provide a 200 response along with details on the report blob(s) that are available for download. The details on the file(s) available for download will be available in the polling response body.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.CostManagement.HttpPath(Path = "/{scope}/providers/Microsoft.CostManagement/generateCostDetailsReport", ApiVersion = "2022-05-01")]
    public partial class NewAzCostManagementDetailReport_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20220501.IGenerateCostDetailsReportRequestDefinition _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20220501.GenerateCostDetailsReportRequestDefinition();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "This parameter can be used only by Enterprise Agreement customers. Use the YearMonth(e.g. 202008) format. This parameter cannot be used alongside either the invoiceId or timePeriod parameters. If a timePeriod, invoiceId or billingPeriod parameter is not provided in the request body the API will return the current month's cost.")]
        ...
        public string BillingPeriod { get => _parametersBody.BillingPeriod ?? null; set => _parametersBody.BillingPeriod = value; }
        ...
        /// month's cost.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "This parameter can only be used by Microsoft Customer Agreement customers. Additionally, it can only be used at the Billing Profile or Customer scope. This parameter cannot be used alongside either the billingPeriod or timePeriod parameters. If a timePeriod, invoiceId or billingPeriod parameter is not provided in the request body the API will return the current month's cost.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Category(global::Microsoft.Azure.PowerShell.Cmdlets.CostManagement.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string InvoiceId { get => _parametersBody.InvoiceId ?? null; set => _parametersBody.InvoiceId = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Support.CostDetailsMetricType Metric { get => _parametersBody.Metric ?? ((Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Support.CostDetailsMetricType)""); set => _parametersBody.Metric = value; }
        ...
        SerializedName = @"end",
        PossibleTypes = new [] { typeof(string) })]
        public string TimePeriodEnd { get => _parametersBody.TimePeriodEnd ?? null; set => _parametersBody.TimePeriodEnd = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string TimePeriodStart { get => _parametersBody.TimePeriodStart ?? null; set => _parametersBody.TimePeriodStart = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20220501.IGenerateCostDetailsReportErrorResponse">Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20220501.IGenerateCostDetailsReportErrorResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20220501.IGenerateCostDetailsReportErrorResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20220501.ICostDetailsOperationResults">Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20220501.ICostDetailsOperationResults</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20220501.ICostDetailsOperationResults> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzCostManagementDetailReport_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Cmdlets.NewAzCostManagementDetailReport_CreateExpanded Clone()
        {
            var clone = new NewAzCostManagementDetailReport_CreateExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzCostManagementDetailReport_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzCostManagementDetailReport_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'GenerateCostDetailsReportCreateOperation' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GenerateCostDetailsReportCreateOperation(Scope, _parametersBody, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20220501.IGenerateCostDetailsReportErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20220501.IGenerateCostDetailsReportErrorResponse>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20220501.ICostDetailsOperationResults> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.Api20220501.ICostDetailsOperationResults
