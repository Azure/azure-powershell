...
namespace Microsoft.Azure.PowerShell.Cmdlets.Astro.Models
{
    ...
    public partial class OrganizationResourceUpdatePropertiesTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="OrganizationResourceUpdateProperties" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Astro.Models.IOrganizationResourceUpdateProperties ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Astro.Models.IOrganizationResourceUpdateProperties).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
