...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.Astro.custom\Update-AzAstroOrganization';
            UpdateViaJsonString = 'Az.Astro.custom\Update-AzAstroOrganization';
            UpdateViaJsonFilePath = 'Az.Astro.custom\Update-AzAstroOrganization';
