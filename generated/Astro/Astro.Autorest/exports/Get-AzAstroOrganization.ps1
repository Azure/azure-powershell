...
.Link
https://learn.microsoft.com/powershell/module/az.astro/get-azastroorganization
#>
function Get-AzAstroOrganization {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Astro.private\Get-AzAstroOrganization_Get';
            GetViaIdentity = 'Az.Astro.private\Get-AzAstroOrganization_GetViaIdentity';
            List = 'Az.Astro.private\Get-AzAstroOrganization_List';
