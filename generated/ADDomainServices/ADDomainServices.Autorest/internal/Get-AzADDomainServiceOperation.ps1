...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IOperationEntity
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IOperationEntity])]
