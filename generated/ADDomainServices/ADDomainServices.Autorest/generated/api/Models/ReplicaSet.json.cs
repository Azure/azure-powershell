...
namespace Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models
{
    ...
    public partial class ReplicaSet
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IReplicaSet.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IReplicaSet.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IReplicaSet FromJson(Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonNode node)
        {
        ...
        internal ReplicaSet(Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonObject json)
        {
            ...
            {_id = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("replicaSetId"), out var __jsonReplicaSetId) ? (string)__jsonReplicaSetId : (string)_id;}
            ...
            {_vnetSiteId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("vnetSiteId"), out var __jsonVnetSiteId) ? (string)__jsonVnetSiteId : (string)_vnetSiteId;}
            {_subnetId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("subnetId"), out var __jsonSubnetId) ? (string)__jsonSubnetId : (string)_subnetId;}
            {_domainControllerIPAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonArray>("domainControllerIpAddress"), out var __jsonDomainControllerIPAddress) ? If( __jsonDomainControllerIPAddress as Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _domainControllerIPAddress;}
            {_externalAccessIPAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("externalAccessIpAddress"), out var __jsonExternalAccessIPAddress) ? (string)__jsonExternalAccessIPAddress : (string)_externalAccessIPAddress;}
            {_serviceStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("serviceStatus"), out var __jsonServiceStatus) ? (string)__jsonServiceStatus : (string)_serviceStatus;}
            {_healthLastEvaluated = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("healthLastEvaluated"), out var __jsonHealthLastEvaluated) ? global::System.DateTime.TryParse((string)__jsonHealthLastEvaluated, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonHealthLastEvaluatedValue) ? __jsonHealthLastEvaluatedValue : _healthLastEvaluated : _healthLastEvaluated;}
            {_healthMonitor = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonArray>("healthMonitors"), out var __jsonHealthMonitors) ? If( __jsonHealthMonitors as Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IHealthMonitor>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IHealthMonitor) (Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.HealthMonitor.FromJson(__p) )) ))() : null : _healthMonitor;}
            {_healthAlert = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonArray>("healthAlerts"), out var __jsonHealthAlerts) ? If( __jsonHealthAlerts as Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IHealthAlert>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IHealthAlert) (Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.HealthAlert.FromJson(__k) )) ))() : null : _healthAlert;}
            AfterFromJson(json);
        }
