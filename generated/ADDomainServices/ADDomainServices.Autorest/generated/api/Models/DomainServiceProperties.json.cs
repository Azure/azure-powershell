...
namespace Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models
{
    ...
    public partial class DomainServiceProperties
    {
        ...
        internal DomainServiceProperties(Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonObject json)
        {
            ...
            {_ldapsSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonObject>("ldapsSettings"), out var __jsonLdapsSettings) ? Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.LdapsSettings.FromJson(__jsonLdapsSettings) : _ldapsSetting;}
            {_resourceForestSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonObject>("resourceForestSettings"), out var __jsonResourceForestSettings) ? Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.ResourceForestSettings.FromJson(__jsonResourceForestSettings) : _resourceForestSetting;}
            {_domainSecuritySetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonObject>("domainSecuritySettings"), out var __jsonDomainSecuritySettings) ? Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.DomainSecuritySettings.FromJson(__jsonDomainSecuritySettings) : _domainSecuritySetting;}
            {_notificationSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonObject>("notificationSettings"), out var __jsonNotificationSettings) ? Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.NotificationSettings.FromJson(__jsonNotificationSettings) : _notificationSetting;}
            {_migrationProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonObject>("migrationProperties"), out var __jsonMigrationProperties) ? Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.MigrationProperties.FromJson(__jsonMigrationProperties) : _migrationProperty;}
            {_version = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonNumber>("version"), out var __jsonVersion) ? (int?)__jsonVersion : _version;}
            {_tenantId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("tenantId"), out var __jsonTenantId) ? (string)__jsonTenantId : (string)_tenantId;}
            {_domainName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("domainName"), out var __jsonDomainName) ? (string)__jsonDomainName : (string)_domainName;}
            {_deploymentId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("deploymentId"), out var __jsonDeploymentId) ? (string)__jsonDeploymentId : (string)_deploymentId;}
            {_syncOwner = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("syncOwner"), out var __jsonSyncOwner) ? (string)__jsonSyncOwner : (string)_syncOwner;}
            {_replicaSet = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonArray>("replicaSets"), out var __jsonReplicaSets) ? If( __jsonReplicaSets as Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IReplicaSet>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IReplicaSet) (Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.ReplicaSet.FromJson(__u) )) ))() : null : _replicaSet;}
            {_domainConfigurationType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("domainConfigurationType"), out var __jsonDomainConfigurationType) ? (string)__jsonDomainConfigurationType : (string)_domainConfigurationType;}
            {_sku = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("sku"), out var __jsonSku) ? (string)__jsonSku : (string)_sku;}
            {_filteredSync = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("filteredSync"), out var __jsonFilteredSync) ? (string)__jsonFilteredSync : (string)_filteredSync;}
            {_provisioningState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("provisioningState"), out var __jsonProvisioningState) ? (string)__jsonProvisioningState : (string)_provisioningState;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IDomainServiceProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IDomainServiceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IDomainServiceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonNode node)
        {
