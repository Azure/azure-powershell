...
namespace Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models
{
    ...
    public partial class LdapsSettings
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.ILdapsSettings.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.ILdapsSettings.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.ILdapsSettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonNode node)
        {
        ...
        internal LdapsSettings(Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonObject json)
        {
            ...
            {_ldap = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("ldaps"), out var __jsonLdaps) ? (string)__jsonLdaps : (string)_ldap;}
            ...
            {_pfxCertificatePassword = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("pfxCertificatePassword"), out var __jsonPfxCertificatePassword) ? new System.Net.NetworkCredential("",(string)__jsonPfxCertificatePassword).SecurePassword : _pfxCertificatePassword;}
            {_publicCertificate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("publicCertificate"), out var __jsonPublicCertificate) ? (string)__jsonPublicCertificate : (string)_publicCertificate;}
            {_certificateThumbprint = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("certificateThumbprint"), out var __jsonCertificateThumbprint) ? (string)__jsonCertificateThumbprint : (string)_certificateThumbprint;}
            {_certificateNotAfter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("certificateNotAfter"), out var __jsonCertificateNotAfter) ? global::System.DateTime.TryParse((string)__jsonCertificateNotAfter, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonCertificateNotAfterValue) ? __jsonCertificateNotAfterValue : _certificateNotAfter : _certificateNotAfter;}
            {_externalAccess = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("externalAccess"), out var __jsonExternalAccess) ? (string)__jsonExternalAccess : (string)_externalAccess;}
            AfterFromJson(json);
        }
