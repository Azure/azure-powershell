...
using Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.JsonSerializable.ToJson(dict, null);
            }
