...
namespace Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview
{
    ...
    public partial class InboundEndpointProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IInboundEndpointProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IInboundEndpointPropertiesInternal
    {

        /// <summary>Backing field for <see cref="IPConfiguration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IIPConfiguration[] _iPConfiguration;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IIPConfiguration[] IPConfiguration { get => this._iPConfiguration; set => this._iPConfiguration = value; }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IInboundEndpointPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for ResourceGuid</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IInboundEndpointPropertiesInternal.ResourceGuid { get => this._resourceGuid; set { {_resourceGuid = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IIPConfiguration) })]
        Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IIPConfiguration[] IPConfiguration { get; set; }
        /// <summary>
        /// The current provisioning state of the inbound endpoint. This is a read-only property and any attempt to set this value
        /// will be ignored.
        /// </summary>
