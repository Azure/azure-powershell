...
namespace Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview
{
    ...
    public partial class DnsResolverDomainListBulk :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IDnsResolverDomainListBulkInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IDnsResolverDomainListBulkProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IDnsResolverDomainListBulkProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.DnsResolverDomainListBulkProperties()); set => this._property = value; }

        /// <summary>
        /// The storage account blob file URL to be used in the bulk upload or download request of DNS resolver domain list.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Origin(Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.PropertyOrigin.Inlined)]
        public string StorageUrl { get => ((Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IDnsResolverDomainListBulkPropertiesInternal)Property).StorageUrl; set => ((Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IDnsResolverDomainListBulkPropertiesInternal)Property).StorageUrl = value ; }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Support.Action Action { get; set; }
        /// <summary>Properties of the DNS resolver domain list upload or download request.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IDnsResolverDomainListBulkProperties Property { get; set; }
        /// <summary>
        /// The storage account blob file URL to be used in the bulk upload or download request of DNS resolver domain list.
        /// </summary>
        string StorageUrl { get; set; }
