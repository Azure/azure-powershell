...
namespace Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview
{
    ...
    public partial class OutboundEndpointProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IOutboundEndpointProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IOutboundEndpointPropertiesInternal
    {

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IOutboundEndpointPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for ResourceGuid</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.IOutboundEndpointPropertiesInternal.ResourceGuid { get => this._resourceGuid; set { {_resourceGuid = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.ISubResource _subnet;

        /// <summary>The reference to the subnet used for the outbound endpoint.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Origin(Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.ISubResource Subnet { get => (this._subnet = this._subnet ?? new Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.SubResource()); set => this._subnet = value; }
        ...
        public string SubnetId { get => ((Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.ISubResourceInternal)Subnet).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models.Api20251001Preview.ISubResourceInternal)Subnet).Id = value ; }
