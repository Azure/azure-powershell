...
namespace Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Models
{
    ...
    public partial class DnsResolverIdentity
    {
        ...
        internal DnsResolverIdentity(Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonObject json)
        {
            ...
            {_subscriptionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("subscriptionId"), out var __jsonSubscriptionId) ? (string)__jsonSubscriptionId : (string)_subscriptionId;}
            {_resourceGroupName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("resourceGroupName"), out var __jsonResourceGroupName) ? (string)__jsonResourceGroupName : (string)_resourceGroupName;}
            {_dnsForwardingRulesetName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("dnsForwardingRulesetName"), out var __jsonDnsForwardingRulesetName) ? (string)__jsonDnsForwardingRulesetName : (string)_dnsForwardingRulesetName;}
            {_virtualNetworkName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("virtualNetworkName"), out var __jsonVirtualNetworkName) ? (string)__jsonVirtualNetworkName : (string)_virtualNetworkName;}
            {_dnsResolverDomainListName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("dnsResolverDomainListName"), out var __jsonDnsResolverDomainListName) ? (string)__jsonDnsResolverDomainListName : (string)_dnsResolverDomainListName;}
            {_dnsResolverPolicyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("dnsResolverPolicyName"), out var __jsonDnsResolverPolicyName) ? (string)__jsonDnsResolverPolicyName : (string)_dnsResolverPolicyName;}
            {_dnsResolverName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("dnsResolverName"), out var __jsonDnsResolverName) ? (string)__jsonDnsResolverName : (string)_dnsResolverName;}
            {_forwardingRuleName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("forwardingRuleName"), out var __jsonForwardingRuleName) ? (string)__jsonForwardingRuleName : (string)_forwardingRuleName;}
            {_virtualNetworkLinkName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("virtualNetworkLinkName"), out var __jsonVirtualNetworkLinkName) ? (string)__jsonVirtualNetworkLinkName : (string)_virtualNetworkLinkName;}
            {_dnsSecurityRuleName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("dnsSecurityRuleName"), out var __jsonDnsSecurityRuleName) ? (string)__jsonDnsSecurityRuleName : (string)_dnsSecurityRuleName;}
            {_dnsResolverPolicyVirtualNetworkLinkName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("dnsResolverPolicyVirtualNetworkLinkName"), out var __jsonDnsResolverPolicyVirtualNetworkLinkName) ? (string)__jsonDnsResolverPolicyVirtualNetworkLinkName : (string)_dnsResolverPolicyVirtualNetworkLinkName;}
            {_inboundEndpointName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("inboundEndpointName"), out var __jsonInboundEndpointName) ? (string)__jsonInboundEndpointName : (string)_inboundEndpointName;}
            {_outboundEndpointName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DnsResolver.Runtime.Json.JsonString>("outboundEndpointName"), out var __jsonOutboundEndpointName) ? (string)__jsonOutboundEndpointName : (string)_outboundEndpointName;}
