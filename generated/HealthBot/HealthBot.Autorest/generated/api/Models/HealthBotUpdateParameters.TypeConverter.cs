...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Models
{
    ...
    public partial class HealthBotUpdateParametersTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="HealthBotUpdateParameters" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Models.IHealthBotUpdateParameters ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Models.IHealthBotUpdateParameters).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
