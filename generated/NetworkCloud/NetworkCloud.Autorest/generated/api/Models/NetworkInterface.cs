...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models
{
    ...
    public partial class NetworkInterface :
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.INetworkInterface,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.INetworkInterfaceInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.INetworkInterfaceInternal.Address { get => this._address; set { {_address = value;} } }

        /// <summary>Internal Acessors for DeviceConnectionType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.INetworkInterfaceInternal.DeviceConnectionType { get => this._deviceConnectionType; set { {_deviceConnectionType = value;} } }

        /// <summary>Internal Acessors for Model</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.INetworkInterfaceInternal.Model { get => this._model; set { {_model = value;} } }

        /// <summary>Internal Acessors for PhysicalSlot</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.INetworkInterfaceInternal.PhysicalSlot { get => this._physicalSlot; set { {_physicalSlot = value;} } }

        /// <summary>Internal Acessors for PortCount</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.INetworkInterfaceInternal.PortCount { get => this._portCount; set { {_portCount = value;} } }

        /// <summary>Internal Acessors for PortSpeed</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.INetworkInterfaceInternal.PortSpeed { get => this._portSpeed; set { {_portSpeed = value;} } }

        /// <summary>Internal Acessors for Vendor</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.INetworkInterfaceInternal.Vendor { get => this._vendor; set { {_vendor = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PSArgumentCompleterAttribute("PCI")]
        string DeviceConnectionType { get;  }
        /// <summary>The model name of the device.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = false,
        ReadOnly = true,
