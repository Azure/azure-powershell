...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models
{
    ...
    public partial class KubernetesClusterProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IKubernetesClusterProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IKubernetesClusterProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IKubernetesClusterProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode node)
        {
        ...
        internal KubernetesClusterProperties(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonObject json)
        {
            ...
            {_aadConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonObject>("aadConfiguration"), out var __jsonAadConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.AadConfiguration.FromJson(__jsonAadConfiguration) : _aadConfiguration;}
            ...
            {_controlPlaneNodeConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonObject>("controlPlaneNodeConfiguration"), out var __jsonControlPlaneNodeConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ControlPlaneNodeConfiguration.FromJson(__jsonControlPlaneNodeConfiguration) : _controlPlaneNodeConfiguration;}
            ...
            {_networkConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonObject>("networkConfiguration"), out var __jsonNetworkConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.NetworkConfiguration.FromJson(__jsonNetworkConfiguration) : _networkConfiguration;}
            {_attachedNetworkId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonArray>("attachedNetworkIds"), out var __jsonAttachedNetworkIds) ? If( __jsonAttachedNetworkIds as Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _attachedNetworkId;}
            {_availableUpgrade = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonArray>("availableUpgrades"), out var __jsonAvailableUpgrades) ? If( __jsonAvailableUpgrades as Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAvailableUpgrade>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAvailableUpgrade) (Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.AvailableUpgrade.FromJson(__p) )) ))() : null : _availableUpgrade;}
            ...
            {_connectedClusterId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("connectedClusterId"), out var __jsonConnectedClusterId) ? (string)__jsonConnectedClusterId : (string)_connectedClusterId;}
            {_controlPlaneKubernetesVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("controlPlaneKubernetesVersion"), out var __jsonControlPlaneKubernetesVersion) ? (string)__jsonControlPlaneKubernetesVersion : (string)_controlPlaneKubernetesVersion;}
            ...
            {_featureStatuses = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonArray>("featureStatuses"), out var __jsonFeatureStatuses) ? If( __jsonFeatureStatuses as Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IFeatureStatus>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IFeatureStatus) (Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.FeatureStatus.FromJson(__k) )) ))() : null : _featureStatuses;}
            {_initialAgentPoolConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonArray>("initialAgentPoolConfigurations"), out var __jsonInitialAgentPoolConfigurations) ? If( __jsonInitialAgentPoolConfigurations as Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IInitialAgentPoolConfiguration>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__g, (__f)=>(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IInitialAgentPoolConfiguration) (Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.InitialAgentPoolConfiguration.FromJson(__f) )) ))() : null : _initialAgentPoolConfiguration;}
            ...
            {_node = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonArray>("nodes"), out var __jsonNodes) ? If( __jsonNodes as Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonArray, out var __b) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IKubernetesClusterNode>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__b, (__a)=>(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IKubernetesClusterNode) (Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.KubernetesClusterNode.FromJson(__a) )) ))() : null : _node;}
