...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201
{
    ...
    public partial class AgentPoolConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IAgentPoolConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IAgentPoolConfigurationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IAgentOptions _agentOption;

        /// <summary>The configurations that will be applied to each agent in this agent pool.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IAgentOptions AgentOption { get => (this._agentOption = this._agentOption ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.AgentOptions()); set => this._agentOption = value; }

        /// <summary>The number of hugepages to allocate.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Inlined)]
        public long? AgentOptionHugepagesCount { get => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IAgentOptionsInternal)AgentOption).HugepagesCount; set => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IAgentOptionsInternal)AgentOption).HugepagesCount = value ?? default(long); }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IKubernetesLabel[] Taint { get => this._taint; set => this._taint = value; }

        /// <summary>Backing field for <see cref="UpgradeSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IAgentPoolUpgradeSettings _upgradeSetting;

        /// <summary>The configuration of the agent pool.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IAgentPoolUpgradeSettings UpgradeSetting { get => (this._upgradeSetting = this._upgradeSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.AgentPoolUpgradeSettings()); set => this._upgradeSetting = value; }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.ISshPublicKey[] AdministratorConfigurationSshPublicKey { get; set; }
        /// <summary>The configurations that will be applied to each agent in this agent pool.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IAgentOptions AgentOption { get; set; }
        /// <summary>The number of hugepages to allocate.</summary>
        long? AgentOptionHugepagesCount { get; set; }
        /// <summary>The size of the hugepages to allocate.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Support.HugepagesSize? AgentOptionHugepagesSize { get; set; }
        ...
        /// The configuration of networks being attached to the agent pool for use by the workloads that run on this Kubernetes cluster.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IAttachedNetworkConfiguration AttachedNetworkConfiguration { get; set; }
        /// <summary>The list of Layer 2 Networks and related configuration for attachment.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IL2NetworkAttachmentConfiguration[] AttachedNetworkConfigurationL2Network { get; set; }
        /// <summary>The list of Layer 3 Networks and related configuration for attachment.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IL3NetworkAttachmentConfiguration[] AttachedNetworkConfigurationL3Network { get; set; }
