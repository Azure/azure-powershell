...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201
{
    ...
    public partial class VirtualMachinePatchProperties :
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IVirtualMachinePatchProperties,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IVirtualMachinePatchPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IImageRepositoryCredentials Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IVirtualMachinePatchPropertiesInternal.VMImageRepositoryCredentials { get => (this._vMImageRepositoryCredentials = this._vMImageRepositoryCredentials ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.ImageRepositoryCredentials()); set { {_vMImageRepositoryCredentials = value;} } }

        /// <summary>Backing field for <see cref="VMImageRepositoryCredentials" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IImageRepositoryCredentials _vMImageRepositoryCredentials;

        /// <summary>
        /// The credentials used to login to the image repository that has access to the specified image.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IImageRepositoryCredentials VMImageRepositoryCredentials { get => (this._vMImageRepositoryCredentials = this._vMImageRepositoryCredentials ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.ImageRepositoryCredentials()); set => this._vMImageRepositoryCredentials = value; }
...

    {
        ...
        /// The credentials used to login to the image repository that has access to the specified image.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IImageRepositoryCredentials VMImageRepositoryCredentials { get; set; }
        /// <summary>The password or token used to access an image in the target repository.</summary>
        System.Security.SecureString VMImageRepositoryCredentialsPassword { get; set; }
        /// <summary>
        /// The URL of the authentication server used to validate the repository credentials.
