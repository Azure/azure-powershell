...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201
{
    ...
    public partial class SecretArchiveReference :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.ISecretArchiveReferenceInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.ISecretArchiveReferenceInternal.KeyVaultId { get => this._keyVaultId; set { {_keyVaultId = value;} } }

        /// <summary>Internal Acessors for SecretName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.ISecretArchiveReferenceInternal.SecretName { get => this._secretName; set { {_secretName = value;} } }

        /// <summary>Internal Acessors for SecretVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.ISecretArchiveReferenceInternal.SecretVersion { get => this._secretVersion; set { {_secretVersion = value;} } }
