...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201
{
    ...
    public partial class StorageProfile :
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IStorageProfile,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IStorageProfileInternal
    {

        /// <summary>Internal Acessors for OSDisk</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IOSDisk Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IStorageProfileInternal.OSDisk { get => (this._oSDisk = this._oSDisk ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.OSDisk()); set { {_oSDisk = value;} } }

        /// <summary>Backing field for <see cref="OSDisk" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IOSDisk _oSDisk;

        /// <summary>The disk to use with this virtual machine.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IOSDisk OSDisk { get => (this._oSDisk = this._oSDisk ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.OSDisk()); set => this._oSDisk = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Inlined)]
        public long OSDiskSizeGb { get => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IOSDiskInternal)OSDisk).DiskSizeGb; set => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IOSDiskInternal)OSDisk).DiskSizeGb = value ; }
    ...
    {
        /// <summary>The disk to use with this virtual machine.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IOSDisk OSDisk { get; set; }
        /// <summary>The strategy for creating the OS disk.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Support.OSDiskCreateOption? OSDiskCreateOption { get; set; }
        /// <summary>The strategy for deleting the OS disk.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Support.OSDiskDeleteOption? OSDiskDeleteOption { get; set; }
