...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models
{
    ...
    public partial class ConsoleProperties :
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IConsoleProperties,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IConsolePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IConsolePropertiesInternal.DetailedStatus { get => this._detailedStatus; set { {_detailedStatus = value;} } }

        /// <summary>Internal Acessors for DetailedStatusMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IConsolePropertiesInternal.DetailedStatusMessage { get => this._detailedStatusMessage; set { {_detailedStatusMessage = value;} } }

        /// <summary>Internal Acessors for PrivateLinkServiceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IConsolePropertiesInternal.PrivateLinkServiceId { get => this._privateLinkServiceId; set { {_privateLinkServiceId = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IConsolePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for SshPublicKey</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISshPublicKey Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IConsolePropertiesInternal.SshPublicKey { get => (this._sshPublicKey = this._sshPublicKey ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.SshPublicKey()); set { {_sshPublicKey = value;} } }

        /// <summary>Internal Acessors for VirtualMachineAccessId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IConsolePropertiesInternal.VirtualMachineAccessId { get => this._virtualMachineAccessId; set { {_virtualMachineAccessId = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISshPublicKey _sshPublicKey;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISshPublicKey SshPublicKey { get => (this._sshPublicKey = this._sshPublicKey ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.SshPublicKey()); set => this._sshPublicKey = value; }
        ...
        public string SshPublicKeyData { get => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISshPublicKeyInternal)SshPublicKey).KeyData; set => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISshPublicKeyInternal)SshPublicKey).KeyData = value ; }
