...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models
{
    ...
    public partial class StorageApplianceProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IStorageApplianceProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IStorageApplianceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IStorageApplianceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode node)
        {
        ...
        internal StorageApplianceProperties(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonObject json)
        {
            ...
            {_managementIpv4Address = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("managementIpv4Address"), out var __jsonManagementIpv4Address) ? (string)__jsonManagementIpv4Address : (string)_managementIpv4Address;}
            {_manufacturer = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("manufacturer"), out var __jsonManufacturer) ? (string)__jsonManufacturer : (string)_manufacturer;}
            ...
            {_remoteVendorManagementFeature = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("remoteVendorManagementFeature"), out var __jsonRemoteVendorManagementFeature) ? (string)__jsonRemoteVendorManagementFeature : (string)_remoteVendorManagementFeature;}
            {_remoteVendorManagementStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("remoteVendorManagementStatus"), out var __jsonRemoteVendorManagementStatus) ? (string)__jsonRemoteVendorManagementStatus : (string)_remoteVendorManagementStatus;}
            {_secretRotationStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonArray>("secretRotationStatus"), out var __jsonSecretRotationStatus) ? If( __jsonSecretRotationStatus as Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretRotationStatus>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretRotationStatus) (Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.SecretRotationStatus.FromJson(__u) )) ))() : null : _secretRotationStatus;}
            ...
            {_storageApplianceSkuId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("storageApplianceSkuId"), out var __jsonStorageApplianceSkuId) ? (string)__jsonStorageApplianceSkuId : (string)_storageApplianceSkuId;}
