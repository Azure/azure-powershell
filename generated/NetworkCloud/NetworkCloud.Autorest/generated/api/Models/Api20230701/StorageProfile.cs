...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701
{
    ...
    public partial class StorageProfile :
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IStorageProfile,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IStorageProfileInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IOSDisk Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IStorageProfileInternal.OSDisk { get => (this._oSDisk = this._oSDisk ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.OSDisk()); set { {_oSDisk = value;} } }

        /// <summary>Backing field for <see cref="OSDisk" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IOSDisk _oSDisk;

        /// <summary>The disk to use with this virtual machine.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IOSDisk OSDisk { get => (this._oSDisk = this._oSDisk ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.OSDisk()); set => this._oSDisk = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Support.OSDiskCreateOption? OSDiskCreateOption { get => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IOSDiskInternal)OSDisk).CreateOption; set => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IOSDiskInternal)OSDisk).CreateOption = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Support.OSDiskCreateOption)""); }

        /// <summary>The strategy for deleting the OS disk.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Support.OSDiskDeleteOption? OSDiskDeleteOption { get => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IOSDiskInternal)OSDisk).DeleteOption; set => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IOSDiskInternal)OSDisk).DeleteOption = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Support.OSDiskDeleteOption)""); }

        /// <summary>The size of the disk in gigabytes. Required if the createOption is Ephemeral.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Inlined)]
        public long OSDiskSizeGb { get => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IOSDiskInternal)OSDisk).DiskSizeGb; set => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IOSDiskInternal)OSDisk).DiskSizeGb = value ; }
    ...
    {
        /// <summary>The disk to use with this virtual machine.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IOSDisk OSDisk { get; set; }
        /// <summary>The strategy for creating the OS disk.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Support.OSDiskCreateOption? OSDiskCreateOption { get; set; }
        /// <summary>The strategy for deleting the OS disk.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Support.OSDiskDeleteOption? OSDiskDeleteOption { get; set; }
