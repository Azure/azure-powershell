...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models
{
    ...
    public partial class SecretRotationStatus :
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretRotationStatus,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretRotationStatusInternal
    {
        ...
        long? Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretRotationStatusInternal.ExpirePeriodDay { get => this._expirePeriodDay; set { {_expirePeriodDay = value;} } }

        /// <summary>Internal Acessors for LastRotationTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretRotationStatusInternal.LastRotationTime { get => this._lastRotationTime; set { {_lastRotationTime = value;} } }

        /// <summary>Internal Acessors for RotationPeriodDay</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretRotationStatusInternal.RotationPeriodDay { get => this._rotationPeriodDay; set { {_rotationPeriodDay = value;} } }

        /// <summary>Internal Acessors for SecretArchiveReference</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretArchiveReference Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretRotationStatusInternal.SecretArchiveReference { get => (this._secretArchiveReference = this._secretArchiveReference ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.SecretArchiveReference()); set { {_secretArchiveReference = value;} } }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretRotationStatusInternal.SecretArchiveReferenceSecretVersion { get => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretArchiveReferenceInternal)SecretArchiveReference).SecretVersion; set => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretArchiveReferenceInternal)SecretArchiveReference).SecretVersion = value ?? null; }

        /// <summary>Internal Acessors for SecretType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretRotationStatusInternal.SecretType { get => this._secretType; set { {_secretType = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretArchiveReference _secretArchiveReference;

        /// <summary>The reference to the secret in a key vault.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretArchiveReference SecretArchiveReference { get => (this._secretArchiveReference = this._secretArchiveReference ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.SecretArchiveReference()); }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Inlined)]
        public string SecretArchiveReferenceSecretName { get => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretArchiveReferenceInternal)SecretArchiveReference).SecretName; }

        /// <summary>The version of the secret in the key vault.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Inlined)]
        public string SecretArchiveReferenceSecretVersion { get => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISecretArchiveReferenceInternal)SecretArchiveReference).SecretVersion; }
