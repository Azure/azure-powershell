...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models
{
    ...
    public partial class HardwareInventoryNetworkInterface :
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IHardwareInventoryNetworkInterface,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IHardwareInventoryNetworkInterfaceInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IHardwareInventoryNetworkInterfaceInternal.LinkStatus { get => this._linkStatus; set { {_linkStatus = value;} } }

        /// <summary>Internal Acessors for MacAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IHardwareInventoryNetworkInterfaceInternal.MacAddress { get => this._macAddress; set { {_macAddress = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IHardwareInventoryNetworkInterfaceInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for NetworkInterfaceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IHardwareInventoryNetworkInterfaceInternal.NetworkInterfaceId { get => this._networkInterfaceId; set { {_networkInterfaceId = value;} } }
