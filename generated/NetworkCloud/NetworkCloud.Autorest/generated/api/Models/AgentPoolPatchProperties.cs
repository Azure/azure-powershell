...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models
{
    ...
    public partial class AgentPoolPatchProperties :
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolPatchProperties,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolPatchPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.INodePoolAdministratorConfigurationPatch _administratorConfiguration;

        /// <summary>The configuration of administrator credentials for the control plane nodes.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.INodePoolAdministratorConfigurationPatch AdministratorConfiguration { get => (this._administratorConfiguration = this._administratorConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.NodePoolAdministratorConfigurationPatch()); set => this._administratorConfiguration = value; }
        ...
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISshPublicKey> AdministratorConfigurationSshPublicKey { get => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.INodePoolAdministratorConfigurationPatchInternal)AdministratorConfiguration).SshPublicKey; set => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.INodePoolAdministratorConfigurationPatchInternal)AdministratorConfiguration).SshPublicKey = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.INodePoolAdministratorConfigurationPatch Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolPatchPropertiesInternal.AdministratorConfiguration { get => (this._administratorConfiguration = this._administratorConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.NodePoolAdministratorConfigurationPatch()); set { {_administratorConfiguration = value;} } }

        /// <summary>Internal Acessors for UpgradeSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolUpgradeSettings Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolPatchPropertiesInternal.UpgradeSetting { get => (this._upgradeSetting = this._upgradeSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.AgentPoolUpgradeSettings()); set { {_upgradeSetting = value;} } }

        /// <summary>Backing field for <see cref="UpgradeSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolUpgradeSettings _upgradeSetting;

        /// <summary>The configuration of the agent pool.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolUpgradeSettings UpgradeSetting { get => (this._upgradeSetting = this._upgradeSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.AgentPoolUpgradeSettings()); set => this._upgradeSetting = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Inlined)]
        public long? UpgradeSettingDrainTimeout { get => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolUpgradeSettingsInternal)UpgradeSetting).DrainTimeout; set => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolUpgradeSettingsInternal)UpgradeSetting).DrainTimeout = value ?? default(long); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Inlined)]
        public string UpgradeSettingMaxSurge { get => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolUpgradeSettingsInternal)UpgradeSetting).MaxSurge; set => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolUpgradeSettingsInternal)UpgradeSetting).MaxSurge = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Inlined)]
        public string UpgradeSettingMaxUnavailable { get => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolUpgradeSettingsInternal)UpgradeSetting).MaxUnavailable; set => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolUpgradeSettingsInternal)UpgradeSetting).MaxUnavailable = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISshPublicKey> AdministratorConfigurationSshPublicKey { get; set; }
        /// <summary>The number of virtual machines that use this configuration.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    {
        /// <summary>The configuration of administrator credentials for the control plane nodes.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.INodePoolAdministratorConfigurationPatch AdministratorConfiguration { get; set; }
        /// <summary>
        /// SshPublicKey represents the public key used to authenticate with a resource through SSH.
        /// </summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISshPublicKey> AdministratorConfigurationSshPublicKey { get; set; }
        ...
        long? Count { get; set; }
        /// <summary>The configuration of the agent pool.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolUpgradeSettings UpgradeSetting { get; set; }
        /// <summary>
        /// The maximum time in seconds that is allowed for a node drain to complete before proceeding with the upgrade of the agent
        /// pool. If not specified during creation, a value of 1800 seconds is used.
        /// </summary>
