...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Support";
