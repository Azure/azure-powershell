...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RunReadCommands=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/storageAppliances/{storageApplianceName}/runReadCommands"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzNetworkCloudStorageApplianceReadCommand_RunExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Description(@"Run one or more read-only commands on the provided storage appliance.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/storageAppliances/{storageApplianceName}/runReadCommands", ApiVersion = "2025-09-01")]
    public partial class InvokeAzNetworkCloudStorageApplianceReadCommand_RunExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IContext
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IStorageApplianceRunReadCommandsParameters _storageApplianceRunReadCommandsParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.StorageApplianceRunReadCommandsParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The list of read-only commands to be executed directly against the target storage appliance.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IStorageApplianceCommandSpecification[] Command { get => _storageApplianceRunReadCommandsParametersBody.Command?.ToArray() ?? null /* fixedArrayOf */; set => _storageApplianceRunReadCommandsParametersBody.Command = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IStorageApplianceCommandSpecification>(value) : null); }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The maximum time the commands are allowed to run.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public long LimitTimeSecond { get => _storageApplianceRunReadCommandsParametersBody.LimitTimeSecond; set => _storageApplianceRunReadCommandsParametersBody.LimitTimeSecond = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzNetworkCloudStorageApplianceReadCommand_RunExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.InvokeAzNetworkCloudStorageApplianceReadCommand_RunExpanded Clone()
        {
            var clone = new InvokeAzNetworkCloudStorageApplianceReadCommand_RunExpanded();
            ...
            clone._storageApplianceRunReadCommandsParametersBody = this._storageApplianceRunReadCommandsParametersBody;
            clone.SubscriptionId = this.SubscriptionId;
            clone.ResourceGroupName = this.ResourceGroupName;
            clone.StorageApplianceName = this.StorageApplianceName;
            return clone;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzNetworkCloudStorageApplianceReadCommand_RunExpanded" /> cmdlet class.
        /// </summary>
        public InvokeAzNetworkCloudStorageApplianceReadCommand_RunExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'StorageAppliancesRunReadCommands' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.StorageAppliancesRunReadCommands(SubscriptionId, ResourceGroupName, StorageApplianceName, _storageApplianceRunReadCommandsParametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,StorageApplianceName=StorageApplianceName})
                    {
