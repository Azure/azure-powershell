...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzNetworkCloudScanClusterRuntime_ScanViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/clusters/{clusterName}/scanRuntime", ApiVersion = "2024-07-01")]
    public partial class InvokeAzNetworkCloudScanClusterRuntime_ScanViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ClusterScanRuntimeParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20240701.IClusterScanRuntimeParameters _clusterScanRuntimeParameter;

        /// <summary>
        /// ClusterScanRuntimeParameters defines the parameters for the cluster scan runtime operation.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ClusterScanRuntimeParameters defines the parameters for the cluster scan runtime operation.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"ClusterScanRuntimeParameters defines the parameters for the cluster scan runtime operation.",
        SerializedName = @"clusterScanRuntimeParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20240701.IClusterScanRuntimeParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20240701.IClusterScanRuntimeParameters ClusterScanRuntimeParameter { get => this._clusterScanRuntimeParameter; set => this._clusterScanRuntimeParameter = value; }
        ...
        /// <returns>a duplicate instance of InvokeAzNetworkCloudScanClusterRuntime_ScanViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.InvokeAzNetworkCloudScanClusterRuntime_ScanViaIdentity Clone()
        {
            var clone = new InvokeAzNetworkCloudScanClusterRuntime_ScanViaIdentity();
            ...
            clone.ClusterScanRuntimeParameter = this.ClusterScanRuntimeParameter;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzNetworkCloudScanClusterRuntime_ScanViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeAzNetworkCloudScanClusterRuntime_ScanViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ClustersScanRuntimeViaIdentity(InputObject.Id, ClusterScanRuntimeParameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ClustersScanRuntime(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, ClusterScanRuntimeParameter, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ClusterScanRuntimeParameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api50.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ClusterScanRuntimeParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ClusterScanRuntimeParameter })
                    {
