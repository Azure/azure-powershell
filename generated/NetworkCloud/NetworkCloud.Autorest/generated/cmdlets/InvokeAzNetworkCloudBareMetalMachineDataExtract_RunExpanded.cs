...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.OutputBreakingChange("bool", "15.0.0", "2.0.0", "2025/11/03", DeprecatedOutputProperties=new string[] {"Argument"}, NewOutputProperties=new string[] {"Argument"}, ChangeDescription="The type of property will be changed from fixed array to 'List'.")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/bareMetalMachines/{bareMetalMachineName}/runDataExtracts", ApiVersion = "2025-02-01")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IBareMetalMachineRunDataExtractsParameters _bareMetalMachineRunDataExtractsParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.BareMetalMachineRunDataExtractsParameters();
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IBareMetalMachineCommandSpecification) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20250201.IBareMetalMachineCommandSpecification[] Command { get => _bareMetalMachineRunDataExtractsParametersBody.Command ?? null /* arrayOf */; set => _bareMetalMachineRunDataExtractsParametersBody.Command = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BareMetalMachinesRunDataExtracts(SubscriptionId, ResourceGroupName, BareMetalMachineName, _bareMetalMachineRunDataExtractsParametersBody, onOk, onDefault, this, Pipeline);
