...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzNetworkCloudAgentPool_DeleteViaIdentityKubernetesCluster", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzNetworkCloudAgentPool_DeleteViaIdentityKubernetesCluster : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of RemoveAzNetworkCloudAgentPool_DeleteViaIdentityKubernetesCluster
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.RemoveAzNetworkCloudAgentPool_DeleteViaIdentityKubernetesCluster Clone()
        {
            var clone = new RemoveAzNetworkCloudAgentPool_DeleteViaIdentityKubernetesCluster();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (KubernetesClusterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.AgentPoolsDeleteViaIdentity(KubernetesClusterInputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, this.InvocationInformation.BoundParameters.ContainsKey("IfNoneMatch") ? IfNoneMatch : null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.AgentPoolsDelete(KubernetesClusterInputObject.SubscriptionId ?? null, KubernetesClusterInputObject.ResourceGroupName ?? null, KubernetesClusterInputObject.KubernetesClusterName ?? null, Name, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, this.InvocationInformation.BoundParameters.ContainsKey("IfNoneMatch") ? IfNoneMatch : null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzNetworkCloudAgentPool_DeleteViaIdentityKubernetesCluster" /> cmdlet
        /// class.
        /// </summary>
        public RemoveAzNetworkCloudAgentPool_DeleteViaIdentityKubernetesCluster()
        {
