...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RestartNode=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/kubernetesClusters/{kubernetesClusterName}/restartNode"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Restart, @"AzNetworkCloudKubernetesClusterNode_Restart", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Description(@"Restart a targeted node of a Kubernetes cluster.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/kubernetesClusters/{kubernetesClusterName}/restartNode", ApiVersion = "2025-02-01")]
    public partial class RestartAzNetworkCloudKubernetesClusterNode_Restart : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IContext
    {
        ...
        /// <summary>
        /// Backing field for <see cref="KubernetesClusterRestartNodeParameter" /> property.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IKubernetesClusterRestartNodeParameters _kubernetesClusterRestartNodeParameter;

        /// <summary>
        /// KubernetesClusterRestartNodeParameters represents the body of the request to restart the node of a Kubernetes cluster.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "KubernetesClusterRestartNodeParameters represents the body of the request to restart the node of a Kubernetes cluster.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"KubernetesClusterRestartNodeParameters represents the body of the request to restart the node of a Kubernetes cluster.",
        SerializedName = @"kubernetesClusterRestartNodeParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IKubernetesClusterRestartNodeParameters) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IKubernetesClusterRestartNodeParameters KubernetesClusterRestartNodeParameter { get => this._kubernetesClusterRestartNodeParameter; set => this._kubernetesClusterRestartNodeParameter = value; }
        ...
        /// <returns>a duplicate instance of RestartAzNetworkCloudKubernetesClusterNode_Restart</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.RestartAzNetworkCloudKubernetesClusterNode_Restart Clone()
        {
            var clone = new RestartAzNetworkCloudKubernetesClusterNode_Restart();
            ...
            clone.KubernetesClusterRestartNodeParameter = this.KubernetesClusterRestartNodeParameter;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'KubernetesClustersRestartNode' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.KubernetesClustersRestartNode(SubscriptionId, ResourceGroupName, KubernetesClusterName, KubernetesClusterRestartNodeParameter, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,KubernetesClusterName=KubernetesClusterName})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RestartAzNetworkCloudKubernetesClusterNode_Restart" /> cmdlet class.
        /// </summary>
        public RestartAzNetworkCloudKubernetesClusterNode_Restart()
        {
