...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// <summary>
    /// Patch the properties of the provided Kubernetes cluster agent pool, or update the tags associated with the Kubernetes
    /// cluster agent pool. Properties and tag update can be done independently.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/kubernetesClusters/{kubernetesClusterName}/agentPools/{agentPoolName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzNetworkCloudAgentPool_UpdateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Description(@"Patch the properties of the provided Kubernetes cluster agent pool, or update the tags associated with the Kubernetes cluster agent pool. Properties and tag update can be done independently.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/kubernetesClusters/{kubernetesClusterName}/agentPools/{agentPoolName}", ApiVersion = "2025-02-01")]
    public partial class UpdateAzNetworkCloudAgentPool_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IContext
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolPatchParameters _agentPoolUpdateParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.AgentPoolPatchParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "SshPublicKey represents the public key used to authenticate with a resource through SSH.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISshPublicKey[] AdministratorConfigurationSshPublicKey { get => _agentPoolUpdateParametersBody.AdministratorConfigurationSshPublicKey?.ToArray() ?? null /* fixedArrayOf */; set => _agentPoolUpdateParametersBody.AdministratorConfigurationSshPublicKey = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.ISshPublicKey>(value) : null); }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The number of virtual machines that use this configuration.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public long Count { get => _agentPoolUpdateParametersBody.Count ?? default(long); set => _agentPoolUpdateParametersBody.Count = value; }
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolPatchParametersTags) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPoolPatchParametersTags Tag { get => _agentPoolUpdateParametersBody.Tag ?? null /* object */; set => _agentPoolUpdateParametersBody.Tag = value; }
        ...
        PossibleTypes = new [] { typeof(long) })]
        public long UpgradeSettingDrainTimeout { get => _agentPoolUpdateParametersBody.UpgradeSettingDrainTimeout ?? default(long); set => _agentPoolUpdateParametersBody.UpgradeSettingDrainTimeout = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string UpgradeSettingMaxSurge { get => _agentPoolUpdateParametersBody.UpgradeSettingMaxSurge ?? null; set => _agentPoolUpdateParametersBody.UpgradeSettingMaxSurge = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string UpgradeSettingMaxUnavailable { get => _agentPoolUpdateParametersBody.UpgradeSettingMaxUnavailable ?? null; set => _agentPoolUpdateParametersBody.UpgradeSettingMaxUnavailable = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPool">Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPool</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPool> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of UpdateAzNetworkCloudAgentPool_UpdateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.UpdateAzNetworkCloudAgentPool_UpdateExpanded Clone()
        {
            var clone = new UpdateAzNetworkCloudAgentPool_UpdateExpanded();
            ...
            clone._agentPoolUpdateParametersBody = this._agentPoolUpdateParametersBody;
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AgentPoolsUpdate(SubscriptionId, ResourceGroupName, KubernetesClusterName, Name, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, this.InvocationInformation.BoundParameters.ContainsKey("IfNoneMatch") ? IfNoneMatch : null, _agentPoolUpdateParametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.SerializationMode.IncludeUpdate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzNetworkCloudAgentPool_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzNetworkCloudAgentPool_UpdateExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPool> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAgentPool
