...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// <summary>Deploy the cluster to the provided rack.</summary>
    /// <remarks>
    /// [OpenAPI] Deploy=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/clusters/{clusterName}/deploy"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet("Deploy", @"AzNetworkCloudCluster_DeployViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Description(@"Deploy the cluster to the provided rack.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/clusters/{clusterName}/deploy", ApiVersion = "2023-07-01")]
    public partial class DeployAzNetworkCloudCluster_DeployViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.IClusterDeployParameters _clusterDeployParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api20230701.ClusterDeployParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The names of bare metal machines in the cluster that should be skipped during environment validation.")]
        ...
        public string[] SkipValidationsForMachine { get => _clusterDeployParametersBody.SkipValidationsForMachine ?? null /* arrayOf */; set => _clusterDeployParametersBody.SkipValidationsForMachine = value; }
        ...
        /// <returns>a duplicate instance of DeployAzNetworkCloudCluster_DeployViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.DeployAzNetworkCloudCluster_DeployViaIdentityExpanded Clone()
        {
            var clone = new DeployAzNetworkCloudCluster_DeployViaIdentityExpanded();
            ...
            clone._clusterDeployParametersBody = this._clusterDeployParametersBody;
            return clone;
        }

        /// <summary>
        /// Intializes a new instance of the <see cref="DeployAzNetworkCloudCluster_DeployViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public DeployAzNetworkCloudCluster_DeployViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ClustersDeploy' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ClustersDeployViaIdentity(InputObject.Id, _clusterDeployParametersBody, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ClustersDeploy(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, _clusterDeployParametersBody, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_clusterDeployParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api40.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_clusterDeployParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_clusterDeployParametersBody })
                    {
