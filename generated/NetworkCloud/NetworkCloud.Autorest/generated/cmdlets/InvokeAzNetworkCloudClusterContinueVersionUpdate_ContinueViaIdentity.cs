...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzNetworkCloudClusterContinueVersionUpdate_ContinueViaIdentity", SupportsShouldProcess = true)]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ClusterContinueUpdateVersionParameters represents the body of the request to continue the update of a cluster version.", ValueFromPipeline = true)]
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzNetworkCloudClusterContinueVersionUpdate_ContinueViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets.InvokeAzNetworkCloudClusterContinueVersionUpdate_ContinueViaIdentity Clone()
        {
            var clone = new InvokeAzNetworkCloudClusterContinueVersionUpdate_ContinueViaIdentity();
            ...
            clone.ClusterContinueUpdateVersionParameter = this.ClusterContinueUpdateVersionParameter;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzNetworkCloudClusterContinueVersionUpdate_ContinueViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public InvokeAzNetworkCloudClusterContinueVersionUpdate_ContinueViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ClustersContinueUpdateVersionViaIdentity(InputObject.Id, ClusterContinueUpdateVersionParameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ClustersContinueUpdateVersion(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, ClusterContinueUpdateVersionParameter, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ClusterContinueUpdateVersionParameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.Api50.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ClusterContinueUpdateVersionParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ClusterContinueUpdateVersionParameter })
                    {
