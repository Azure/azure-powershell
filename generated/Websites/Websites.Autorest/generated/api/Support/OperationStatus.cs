...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Websites.Support.OperationStatus Created = @"Created";

        public static Microsoft.Azure.PowerShell.Cmdlets.Websites.Support.OperationStatus Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Websites.Support.OperationStatus InProgress = @"InProgress";

        public static Microsoft.Azure.PowerShell.Cmdlets.Websites.Support.OperationStatus Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.Websites.Support.OperationStatus TimedOut = @"TimedOut";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Websites.Support.OperationStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Websites.Support.OperationStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Websites.Support.OperationStatus e1, Microsoft.Azure.PowerShell.Cmdlets.Websites.Support.OperationStatus e2)
        {
            return !e2.Equals(e1);
        }
