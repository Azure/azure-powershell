...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Models
{
    ...
    public partial class AutoHealTriggers
    {
        ...
        internal AutoHealTriggers(Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonObject json)
        {
            ...
            {_request = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonObject>("requests"), out var __jsonRequests) ? Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.RequestsBasedTrigger.FromJson(__jsonRequests) : _request;}
            {_slowRequest = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonObject>("slowRequests"), out var __jsonSlowRequests) ? Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.SlowRequestsBasedTrigger.FromJson(__jsonSlowRequests) : _slowRequest;}
            {_privateBytesInKb = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonNumber>("privateBytesInKB"), out var __jsonPrivateBytesInKb) ? (int?)__jsonPrivateBytesInKb : _privateBytesInKb;}
            {_statusCode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonArray>("statusCodes"), out var __jsonStatusCodes) ? If( __jsonStatusCodes as Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IStatusCodesBasedTrigger>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IStatusCodesBasedTrigger) (Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.StatusCodesBasedTrigger.FromJson(__u) )) ))() : null : _statusCode;}
            {_slowRequestsWithPath = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonArray>("slowRequestsWithPath"), out var __jsonSlowRequestsWithPath) ? If( __jsonSlowRequestsWithPath as Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.ISlowRequestsBasedTrigger>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.ISlowRequestsBasedTrigger) (Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.SlowRequestsBasedTrigger.FromJson(__p) )) ))() : null : _slowRequestsWithPath;}
            {_statusCodesRange = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonArray>("statusCodesRange"), out var __jsonStatusCodesRange) ? If( __jsonStatusCodesRange as Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IStatusCodesRangeBasedTrigger>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IStatusCodesRangeBasedTrigger) (Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.StatusCodesRangeBasedTrigger.FromJson(__k) )) ))() : null : _statusCodesRange;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IAutoHealTriggers.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IAutoHealTriggers.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IAutoHealTriggers FromJson(Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonNode node)
        {
