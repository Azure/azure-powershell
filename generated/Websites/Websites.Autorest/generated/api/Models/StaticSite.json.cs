...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Models
{
    ...
    public partial class StaticSite
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IStaticSite.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IStaticSite.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IStaticSite FromJson(Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonNode node)
        {
        ...
        internal StaticSite(Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonObject json)
        {
            ...
            {_buildProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonObject>("buildProperties"), out var __jsonBuildProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.StaticSiteBuildProperties.FromJson(__jsonBuildProperties) : _buildProperty;}
            {_templateProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonObject>("templateProperties"), out var __jsonTemplateProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.StaticSiteTemplateOptions.FromJson(__jsonTemplateProperties) : _templateProperty;}
            {_defaultHostname = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("defaultHostname"), out var __jsonDefaultHostname) ? (string)__jsonDefaultHostname : (string)_defaultHostname;}
            {_repositoryUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("repositoryUrl"), out var __jsonRepositoryUrl) ? (string)__jsonRepositoryUrl : (string)_repositoryUrl;}
            {_branch = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("branch"), out var __jsonBranch) ? (string)__jsonBranch : (string)_branch;}
            {_customDomain = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonArray>("customDomains"), out var __jsonCustomDomains) ? If( __jsonCustomDomains as Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _customDomain;}
            {_repositoryToken = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("repositoryToken"), out var __jsonRepositoryToken) ? (string)__jsonRepositoryToken : (string)_repositoryToken;}
            {_privateEndpointConnection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonArray>("privateEndpointConnections"), out var __jsonPrivateEndpointConnections) ? If( __jsonPrivateEndpointConnections as Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IResponseMessageEnvelopeRemotePrivateEndpointConnection>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IResponseMessageEnvelopeRemotePrivateEndpointConnection) (Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.ResponseMessageEnvelopeRemotePrivateEndpointConnection.FromJson(__p) )) ))() : null : _privateEndpointConnection;}
            {_stagingEnvironmentPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("stagingEnvironmentPolicy"), out var __jsonStagingEnvironmentPolicy) ? (string)__jsonStagingEnvironmentPolicy : (string)_stagingEnvironmentPolicy;}
            {_allowConfigFileUpdate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonBoolean>("allowConfigFileUpdates"), out var __jsonAllowConfigFileUpdates) ? (bool?)__jsonAllowConfigFileUpdates : _allowConfigFileUpdate;}
            {_contentDistributionEndpoint = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("contentDistributionEndpoint"), out var __jsonContentDistributionEndpoint) ? (string)__jsonContentDistributionEndpoint : (string)_contentDistributionEndpoint;}
            ...
            {_userProvidedFunctionApp = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonArray>("userProvidedFunctionApps"), out var __jsonUserProvidedFunctionApps) ? If( __jsonUserProvidedFunctionApps as Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IStaticSiteUserProvidedFunctionApp>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IStaticSiteUserProvidedFunctionApp) (Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.StaticSiteUserProvidedFunctionApp.FromJson(__k) )) ))() : null : _userProvidedFunctionApp;}
            {_provider = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("provider"), out var __jsonProvider) ? (string)__jsonProvider : (string)_provider;}
            AfterFromJson(json);
        }
