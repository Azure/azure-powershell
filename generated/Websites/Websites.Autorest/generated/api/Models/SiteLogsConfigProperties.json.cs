...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Models
{
    ...
    public partial class SiteLogsConfigProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.ISiteLogsConfigProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.ISiteLogsConfigProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.ISiteLogsConfigProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonNode node)
        {
        ...
        internal SiteLogsConfigProperties(Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonObject json)
        {
            ...
            {_applicationLog = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonObject>("applicationLogs"), out var __jsonApplicationLogs) ? Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.ApplicationLogsConfig.FromJson(__jsonApplicationLogs) : _applicationLog;}
            {_httpLog = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonObject>("httpLogs"), out var __jsonHttpLogs) ? Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.HttpLogsConfig.FromJson(__jsonHttpLogs) : _httpLog;}
            {_failedRequestsTracing = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonObject>("failedRequestsTracing"), out var __jsonFailedRequestsTracing) ? Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.EnabledConfig.FromJson(__jsonFailedRequestsTracing) : _failedRequestsTracing;}
            {_detailedErrorMessage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonObject>("detailedErrorMessages"), out var __jsonDetailedErrorMessages) ? Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.EnabledConfig.FromJson(__jsonDetailedErrorMessages) : _detailedErrorMessage;}
            AfterFromJson(json);
        }
