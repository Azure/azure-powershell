...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Models
{
    ...
    public partial class WebSiteInstanceStatusProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IWebSiteInstanceStatusProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IWebSiteInstanceStatusProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IWebSiteInstanceStatusProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonNode node)
        {
        ...
        internal WebSiteInstanceStatusProperties(Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonObject json)
        {
            ...
            {_statusUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("statusUrl"), out var __jsonStatusUrl) ? (string)__jsonStatusUrl : (string)_statusUrl;}
            {_detectorUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("detectorUrl"), out var __jsonDetectorUrl) ? (string)__jsonDetectorUrl : (string)_detectorUrl;}
            {_consoleUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("consoleUrl"), out var __jsonConsoleUrl) ? (string)__jsonConsoleUrl : (string)_consoleUrl;}
            {_healthCheckUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("healthCheckUrl"), out var __jsonHealthCheckUrl) ? (string)__jsonHealthCheckUrl : (string)_healthCheckUrl;}
            {_container = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonObject>("containers"), out var __jsonContainers) ? Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.WebSiteInstanceStatusPropertiesContainers.FromJson(__jsonContainers) : _container;}
            AfterFromJson(json);
        }
    }
}