...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IAzureActiveDirectoryValidationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IDefaultAuthorizationPolicy _defaultAuthorizationPolicy;

        /// <summary>The configuration settings of the default authorization policy.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Origin(Microsoft.Azure.PowerShell.Cmdlets.Websites.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IDefaultAuthorizationPolicy DefaultAuthorizationPolicy { get => (this._defaultAuthorizationPolicy = this._defaultAuthorizationPolicy ?? new Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.DefaultAuthorizationPolicy()); set => this._defaultAuthorizationPolicy = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IJwtClaimChecks _jwtClaimCheck;

        /// <summary>
        /// The configuration settings of the checks that should be made while validating the JWT Claims.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Origin(Microsoft.Azure.PowerShell.Cmdlets.Websites.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IJwtClaimChecks JwtClaimCheck { get => (this._jwtClaimCheck = this._jwtClaimCheck ?? new Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.JwtClaimChecks()); set => this._jwtClaimCheck = value; }

        /// <summary>The list of the allowed client applications.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Origin(Microsoft.Azure.PowerShell.Cmdlets.Websites.PropertyOrigin.Inlined)]
        public string[] JwtClaimCheckAllowedClientApplication { get => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IJwtClaimChecksInternal)JwtClaimCheck).AllowedClientApplication; set => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IJwtClaimChecksInternal)JwtClaimCheck).AllowedClientApplication = value ?? null /* arrayOf */; }

        /// <summary>The list of the allowed groups.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Origin(Microsoft.Azure.PowerShell.Cmdlets.Websites.PropertyOrigin.Inlined)]
        public string[] JwtClaimCheckAllowedGroup { get => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IJwtClaimChecksInternal)JwtClaimCheck).AllowedGroup; set => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IJwtClaimChecksInternal)JwtClaimCheck).AllowedGroup = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IJwtClaimChecks Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IAzureActiveDirectoryValidationInternal.JwtClaimCheck { get => (this._jwtClaimCheck = this._jwtClaimCheck ?? new Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.JwtClaimChecks()); set { {_jwtClaimCheck = value;} } }
...

    {
        ...
        string[] AllowedPrincipalIdentity { get; set; }
        /// <summary>The configuration settings of the default authorization policy.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IDefaultAuthorizationPolicy DefaultAuthorizationPolicy { get; set; }
        /// <summary>The configuration settings of the Azure Active Directory allowed applications.</summary>
        string[] DefaultAuthorizationPolicyAllowedApplication { get; set; }
        ...
        /// The configuration settings of the checks that should be made while validating the JWT Claims.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IJwtClaimChecks JwtClaimCheck { get; set; }
        /// <summary>The list of the allowed client applications.</summary>
        string[] JwtClaimCheckAllowedClientApplication { get; set; }
        /// <summary>The list of the allowed groups.</summary>
        string[] JwtClaimCheckAllowedGroup { get; set; }
