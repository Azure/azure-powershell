...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201
{
    ...
    public partial class VnetInfo :
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IVnetInfo,
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IVnetInfoInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IVnetInfoInternal.CertThumbprint { get => this._certThumbprint; set { {_certThumbprint = value;} } }

        /// <summary>Internal Acessors for ResyncRequired</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IVnetInfoInternal.ResyncRequired { get => this._resyncRequired; set { {_resyncRequired = value;} } }

        /// <summary>Internal Acessors for Route</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IVnetRoute[] Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IVnetInfoInternal.Route { get => this._route; set { {_route = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IVnetRoute[] _route;

        /// <summary>The routes that this Virtual Network connection uses.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Origin(Microsoft.Azure.PowerShell.Cmdlets.Websites.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IVnetRoute[] Route { get => this._route; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IVnetRoute[] Route { get;  }
        /// <summary>The Virtual Network's resource ID.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        /// <summary>The routes that this Virtual Network connection uses.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.IVnetRoute[] Route { get; set; }
        /// <summary>The Virtual Network's resource ID.</summary>
        string VnetResourceId { get; set; }
