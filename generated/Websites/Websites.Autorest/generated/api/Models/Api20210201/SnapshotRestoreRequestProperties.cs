...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201
{
    ...
    public partial class SnapshotRestoreRequestProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.ISnapshotRestoreRequestProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.ISnapshotRestoreRequestPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.ISnapshotRecoverySource Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.ISnapshotRestoreRequestPropertiesInternal.RecoverySource { get => (this._recoverySource = this._recoverySource ?? new Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.SnapshotRecoverySource()); set { {_recoverySource = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.ISnapshotRecoverySource _recoverySource;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Origin(Microsoft.Azure.PowerShell.Cmdlets.Websites.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.ISnapshotRecoverySource RecoverySource { get => (this._recoverySource = this._recoverySource ?? new Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.SnapshotRecoverySource()); set => this._recoverySource = value; }
        ...
        public string RecoverySourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.ISnapshotRecoverySourceInternal)RecoverySource).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.ISnapshotRecoverySourceInternal)RecoverySource).Id = value ?? null; }

        /// <summary>Geographical location of the source web app, e.g. SouthEastAsia, SouthCentralUS</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Origin(Microsoft.Azure.PowerShell.Cmdlets.Websites.PropertyOrigin.Inlined)]
        public string RecoverySourceLocation { get => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.ISnapshotRecoverySourceInternal)RecoverySource).Location; set => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20210201.ISnapshotRecoverySourceInternal)RecoverySource).Location = value ?? null; }
