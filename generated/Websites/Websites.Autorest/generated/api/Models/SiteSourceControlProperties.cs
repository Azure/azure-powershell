...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Models
{
    ...
    public partial class SiteSourceControlProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.ISiteSourceControlProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.ISiteSourceControlPropertiesInternal
    {
        ...
        public string CodeConfigurationRuntimeStack { get => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).CodeConfigurationRuntimeStack; set => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).CodeConfigurationRuntimeStack = value ?? null; }

        /// <summary>
        /// Runtime version is used to determine what build version to set in the workflow file.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Origin(Microsoft.Azure.PowerShell.Cmdlets.Websites.PropertyOrigin.Inlined)]
        public string CodeConfigurationRuntimeVersion { get => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).CodeConfigurationRuntimeVersion; set => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).CodeConfigurationRuntimeVersion = value ?? null; }

        /// <summary>The image name for the build.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Origin(Microsoft.Azure.PowerShell.Cmdlets.Websites.PropertyOrigin.Inlined)]
        public string ContainerConfigurationImageName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).ContainerConfigurationImageName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).ContainerConfigurationImageName = value ?? null; }

        /// <summary>The password used to upload the image to the container registry.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Origin(Microsoft.Azure.PowerShell.Cmdlets.Websites.PropertyOrigin.Inlined)]
        public string ContainerConfigurationPassword { get => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).ContainerConfigurationPassword; set => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).ContainerConfigurationPassword = value ?? null; }

        /// <summary>The server URL for the container registry where the build will be hosted.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Origin(Microsoft.Azure.PowerShell.Cmdlets.Websites.PropertyOrigin.Inlined)]
        public string ContainerConfigurationServerUrl { get => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).ContainerConfigurationServerUrl; set => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).ContainerConfigurationServerUrl = value ?? null; }

        /// <summary>The username used to upload the image to the container registry.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Origin(Microsoft.Azure.PowerShell.Cmdlets.Websites.PropertyOrigin.Inlined)]
        public string ContainerConfigurationUsername { get => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).ContainerConfigurationUsername; set => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).ContainerConfigurationUsername = value ?? null; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfiguration _gitHubActionConfiguration;

        /// <summary>If GitHub Action is selected, than the associated configuration.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Origin(Microsoft.Azure.PowerShell.Cmdlets.Websites.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfiguration GitHubActionConfiguration { get => (this._gitHubActionConfiguration = this._gitHubActionConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.GitHubActionConfiguration()); set => this._gitHubActionConfiguration = value; }

        /// <summary>
        /// Workflow option to determine whether the workflow file should be generated and written to the repository.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Origin(Microsoft.Azure.PowerShell.Cmdlets.Websites.PropertyOrigin.Inlined)]
        public bool? GitHubActionConfigurationGenerateWorkflowFile { get => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).GenerateWorkflowFile; set => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).GenerateWorkflowFile = value ?? default(bool); }

        /// <summary>This will help determine the workflow configuration to select.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Origin(Microsoft.Azure.PowerShell.Cmdlets.Websites.PropertyOrigin.Inlined)]
        public bool? GitHubActionConfigurationIsLinux { get => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).IsLinux; set => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).IsLinux = value ?? default(bool); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfiguration Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.ISiteSourceControlPropertiesInternal.GitHubActionConfiguration { get => (this._gitHubActionConfiguration = this._gitHubActionConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.GitHubActionConfiguration()); set { {_gitHubActionConfiguration = value;} } }

        /// <summary>Internal Acessors for GitHubActionConfigurationCodeConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionCodeConfiguration Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.ISiteSourceControlPropertiesInternal.GitHubActionConfigurationCodeConfiguration { get => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).CodeConfiguration; set => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).CodeConfiguration = value ?? null /* model class */; }

        /// <summary>Internal Acessors for GitHubActionConfigurationContainerConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionContainerConfiguration Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.ISiteSourceControlPropertiesInternal.GitHubActionConfigurationContainerConfiguration { get => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).ContainerConfiguration; set => ((Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IGitHubActionConfigurationInternal)GitHubActionConfiguration).ContainerConfiguration = value ?? null /* model class */; }
