...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Models
{
    ...
    public partial class StaticSiteBuildProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IStaticSiteBuildProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IStaticSiteBuildProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.IStaticSiteBuildProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonNode node)
        {
        ...
        internal StaticSiteBuildProperties(Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonObject json)
        {
            ...
            {_appLocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("appLocation"), out var __jsonAppLocation) ? (string)__jsonAppLocation : (string)_appLocation;}
            {_apiLocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("apiLocation"), out var __jsonApiLocation) ? (string)__jsonApiLocation : (string)_apiLocation;}
            {_appArtifactLocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("appArtifactLocation"), out var __jsonAppArtifactLocation) ? (string)__jsonAppArtifactLocation : (string)_appArtifactLocation;}
            {_outputLocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("outputLocation"), out var __jsonOutputLocation) ? (string)__jsonOutputLocation : (string)_outputLocation;}
            {_appBuildCommand = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("appBuildCommand"), out var __jsonAppBuildCommand) ? (string)__jsonAppBuildCommand : (string)_appBuildCommand;}
            {_apiBuildCommand = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("apiBuildCommand"), out var __jsonApiBuildCommand) ? (string)__jsonApiBuildCommand : (string)_apiBuildCommand;}
            {_skipGithubActionWorkflowGeneration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonBoolean>("skipGithubActionWorkflowGeneration"), out var __jsonSkipGithubActionWorkflowGeneration) ? (bool?)__jsonSkipGithubActionWorkflowGeneration : _skipGithubActionWorkflowGeneration;}
            {_githubActionSecretNameOverride = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Json.JsonString>("githubActionSecretNameOverride"), out var __jsonGithubActionSecretNameOverride) ? (string)__jsonGithubActionSecretNameOverride : (string)_githubActionSecretNameOverride;}
            AfterFromJson(json);
        }
