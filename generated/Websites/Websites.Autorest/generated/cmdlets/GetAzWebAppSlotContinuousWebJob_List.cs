...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Websites.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/continuouswebjobs", ApiVersion = "2021-02-01")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzWebAppSlotContinuousWebJob_List" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.WebAppsListContinuousWebJobsSlot(SubscriptionId, ResourceGroupName, AppName, SlotName, onOk, onDefault, this, Pipeline);
