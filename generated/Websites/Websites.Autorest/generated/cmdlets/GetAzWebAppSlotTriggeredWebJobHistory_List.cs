...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzWebAppSlotTriggeredWebJobHistory_List" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.WebAppsListTriggeredWebJobHistorySlot(SubscriptionId, ResourceGroupName, AppName, Name, SlotName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.WebAppsListTriggeredWebJobHistorySlot_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
