...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzStaticWebAppBuild_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.StaticSitesGetStaticSiteBuild(SubscriptionId, ResourceGroupName, Name, EnvironmentName, onOk, onDefault, this, Pipeline);
