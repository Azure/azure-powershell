...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Cmdlets
{
    ...
    /// <summary>Stop a continuous web job for a deployment slot.</summary>
    /// <remarks>
    /// [OpenAPI] StopContinuousWebJobSlot=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/continuouswebjobs/{webJobName}/stop"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Stop, @"AzWebAppSlotContinuousWebJob_Stop", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Websites.Description(@"Stop a continuous web job for a deployment slot.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Websites.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Websites.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/continuouswebjobs/{webJobName}/stop", ApiVersion = "2021-02-01")]
    public partial class StopAzWebAppSlotContinuousWebJob_Stop : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of Web Job.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>Backing field for <see cref="SlotName" /> property.</summary>
        private string _slotName;

        /// <summary>
        /// Name of the deployment slot. If a slot is not specified, the API deletes a deployment for the production slot.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of the deployment slot. If a slot is not specified, the API deletes a deployment for the production slot.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Websites.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Websites.ParameterCategory.Path)]
        public string SlotName { get => this._slotName; set => this._slotName = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'WebAppsStopContinuousWebJobSlot' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.WebAppsStopContinuousWebJobSlot(ResourceGroupName, AppName, Name, SlotName, SubscriptionId, onOk, onNotFound, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,AppName=AppName,Name=Name,SlotName=SlotName,SubscriptionId=SubscriptionId})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StopAzWebAppSlotContinuousWebJob_Stop" /> cmdlet class.
        /// </summary>
        public StopAzWebAppSlotContinuousWebJob_Stop()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Websites.Models.Api20201201.IDefaultErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, AppName=AppName, Name=Name, SlotName=SlotName, SubscriptionId=SubscriptionId })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, AppName=AppName, Name=Name, SlotName=SlotName, SubscriptionId=SubscriptionId })
                    {
