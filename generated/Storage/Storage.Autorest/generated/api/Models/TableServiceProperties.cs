...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models
{
    ...
    public partial class TableServiceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ITableServiceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ITableServicePropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IValidates
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ITableServiceProperties1 Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ITableServicePropertiesInternal.TableServiceProperty { get => (this._tableServiceProperty = this._tableServiceProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.TableServiceProperties1()); set { {_tableServiceProperty = value;} } }

        /// <summary>Internal Acessors for TableServicePropertyCor</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ICorsRules Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ITableServicePropertiesInternal.TableServicePropertyCor { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ITableServiceProperties1Internal)TableServiceProperty).Cor; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ITableServiceProperties1Internal)TableServiceProperty).Cor = value ?? null /* model class */; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ITableServiceProperties1 _tableServiceProperty;

        /// <summary>The properties of a storage account’s Table service.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ITableServiceProperties1 TableServiceProperty { get => (this._tableServiceProperty = this._tableServiceProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.TableServiceProperties1()); set => this._tableServiceProperty = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.IProxyResourceInternal
    {
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ICorsRule> CorCorsRule { get; set; }
        /// <summary>The properties of a storage account’s Table service.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ITableServiceProperties1 TableServiceProperty { get; set; }
        /// <summary>
        ...
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ICorsRules TableServicePropertyCor { get; set; }
