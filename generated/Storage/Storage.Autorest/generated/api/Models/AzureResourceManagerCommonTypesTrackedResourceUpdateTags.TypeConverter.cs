...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models
{
    ...
    public partial class AzureResourceManagerCommonTypesTrackedResourceUpdateTagsTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.IAzureResourceManagerCommonTypesTrackedResourceUpdateTags ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.IAzureResourceManagerCommonTypesTrackedResourceUpdateTags).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
