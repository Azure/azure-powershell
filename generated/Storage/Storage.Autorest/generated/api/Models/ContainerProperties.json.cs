...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models
{
    ...
    public partial class ContainerProperties
    {
        ...
        internal ContainerProperties(Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject json)
        {
            ...
            {_immutabilityPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject>("immutabilityPolicy"), out var __jsonImmutabilityPolicy) ? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ImmutabilityPolicyProperties.FromJson(__jsonImmutabilityPolicy) : _immutabilityPolicy;}
            {_legalHold = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject>("legalHold"), out var __jsonLegalHold) ? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.LegalHoldProperties.FromJson(__jsonLegalHold) : _legalHold;}
            {_immutableStorageWithVersioning = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject>("immutableStorageWithVersioning"), out var __jsonImmutableStorageWithVersioning) ? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ImmutableStorageWithVersioning.FromJson(__jsonImmutableStorageWithVersioning) : _immutableStorageWithVersioning;}
            ...
            {_defaultEncryptionScope = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("defaultEncryptionScope"), out var __jsonDefaultEncryptionScope) ? (string)__jsonDefaultEncryptionScope : (string)_defaultEncryptionScope;}
            {_denyEncryptionScopeOverride = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonBoolean>("denyEncryptionScopeOverride"), out var __jsonDenyEncryptionScopeOverride) ? (bool?)__jsonDenyEncryptionScopeOverride : _denyEncryptionScopeOverride;}
            {_publicAccess = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("publicAccess"), out var __jsonPublicAccess) ? (string)__jsonPublicAccess : (string)_publicAccess;}
            ...
            {_metadata = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject>("metadata"), out var __jsonMetadata) ? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.ContainerPropertiesMetadata.FromJson(__jsonMetadata) : _metadata;}
            ...
            {_hasImmutabilityPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonBoolean>("hasImmutabilityPolicy"), out var __jsonHasImmutabilityPolicy) ? (bool?)__jsonHasImmutabilityPolicy : _hasImmutabilityPolicy;}
            {_enableNfsV3RootSquash = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonBoolean>("enableNfsV3RootSquash"), out var __jsonEnableNfsV3RootSquash) ? (bool?)__jsonEnableNfsV3RootSquash : _enableNfsV3RootSquash;}
            {_enableNfsV3AllSquash = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonBoolean>("enableNfsV3AllSquash"), out var __jsonEnableNfsV3AllSquash) ? (bool?)__jsonEnableNfsV3AllSquash : _enableNfsV3AllSquash;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.IContainerProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.IContainerProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.IContainerProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode node)
        {
