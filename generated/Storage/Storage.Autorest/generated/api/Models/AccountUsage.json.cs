...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models
{
    ...
    public partial class AccountUsage
    {
        ...
        internal AccountUsage(Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject json)
        {
            ...
            {_liveShare = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject>("liveShares"), out var __jsonLiveShares) ? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.AccountUsageElements.FromJson(__jsonLiveShares) : _liveShare;}
            {_softDeletedShare = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject>("softDeletedShares"), out var __jsonSoftDeletedShares) ? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.AccountUsageElements.FromJson(__jsonSoftDeletedShares) : _softDeletedShare;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.IAccountUsage.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.IAccountUsage.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.IAccountUsage FromJson(Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode node)
        {
