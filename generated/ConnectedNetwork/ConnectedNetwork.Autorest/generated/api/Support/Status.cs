...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Support.Status Deleted = @"Deleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Support.Status NotRegistered = @"NotRegistered";

        public static Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Support.Status Registered = @"Registered";

        public static Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Support.Status Unknown = @"Unknown";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
