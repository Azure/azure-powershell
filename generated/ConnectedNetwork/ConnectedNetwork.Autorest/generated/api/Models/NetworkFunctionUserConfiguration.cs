...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models
{
    ...
    public partial class NetworkFunctionUserConfiguration :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkFunctionUserConfigurationInternal
    {

        /// <summary>Internal Acessors for OSProfile</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkFunctionUserConfigurationOSProfile Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkFunctionUserConfigurationInternal.OSProfile { get => (this._oSProfile = this._oSProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.NetworkFunctionUserConfigurationOSProfile()); set { {_oSProfile = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkFunctionUserConfigurationOSProfile _oSProfile;

        /// <summary>Specifies the operating system settings for the role instance.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Origin(Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkFunctionUserConfigurationOSProfile OSProfile { get => (this._oSProfile = this._oSProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.NetworkFunctionUserConfigurationOSProfile()); set => this._oSProfile = value; }
        ...
        public string OSProfileCustomData { get => ((Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkFunctionUserConfigurationOSProfileInternal)OSProfile).CustomData; set => ((Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkFunctionUserConfigurationOSProfileInternal)OSProfile).CustomData = value ?? null; }
...

    {
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkInterface> NetworkInterface { get; set; }
        /// <summary>Specifies the operating system settings for the role instance.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkFunctionUserConfigurationOSProfile OSProfile { get; set; }
        /// <summary>
        /// Specifies a base-64 encoded string of custom data. The base-64 encoded string is decoded to a binary array that is saved
        /// as a file on the virtual machine. The maximum length of the binary array is 65535 bytes. <br><br> **Note: Do not pass
        /// any secrets or passwords in customData property** <br><br> This property cannot be updated after the VM is created. <br><br>
