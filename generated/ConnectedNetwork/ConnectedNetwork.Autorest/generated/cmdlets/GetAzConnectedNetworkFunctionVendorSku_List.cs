...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByVendor=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.HybridNetwork/networkFunctionVendors/{vendorName}/vendorSkus"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzConnectedNetworkFunctionVendorSku_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.ISkuOverview))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Description(@"Lists all network function vendor sku details in a vendor.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.HybridNetwork/networkFunctionVendors/{vendorName}/vendorSkus", ApiVersion = "2021-05-01")]
    public partial class GetAzConnectedNetworkFunctionVendorSku_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.IContext
    {
        ...
        /// <summary>The name of the network function vendor.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the network function vendor.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkFunctionSkuListResult">Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkFunctionSkuListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkFunctionSkuListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzConnectedNetworkFunctionVendorSku_List" /> cmdlet class.
        /// </summary>
        public GetAzConnectedNetworkFunctionVendorSku_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.NetworkFunctionVendorSkusListByVendor(SubscriptionId, VendorName, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,VendorName=VendorName})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkFunctionSkuListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkFunctionSkuListResult
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.NetworkFunctionVendorSkusListByVendor_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
