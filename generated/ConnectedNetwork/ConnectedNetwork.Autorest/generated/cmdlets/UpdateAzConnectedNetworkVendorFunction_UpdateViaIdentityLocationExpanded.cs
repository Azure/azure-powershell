...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.HybridNetwork/locations/{locationName}/vendors/{vendorName}/networkFunctions/{serviceKey}"
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/providers/Microsoft.HybridNetwork/locations/{locationName}/vendors/{vendorName}/networkFunctions/{serviceKey}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzConnectedNetworkVendorFunction_UpdateViaIdentityLocationExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.IVendorNetworkFunction))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Description(@"update a vendor network function. This operation can take up to 6 hours to complete. This is expected service behavior.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Generated]
    public partial class UpdateAzConnectedNetworkVendorFunction_UpdateViaIdentityLocationExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.IVendorNetworkFunction _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.VendorNetworkFunction();
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.IConnectedNetworkIdentity _locationInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.IConnectedNetworkIdentity LocationInputObject { get => this._locationInputObject; set => this._locationInputObject = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "An array of network function vendor configurations.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkFunctionVendorConfiguration[] VendorConfiguration { get => _parametersBody.NetworkFunctionVendorConfiguration?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.NetworkFunctionVendorConfiguration = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkFunctionVendorConfiguration>(value) : null); }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The vendor controlled provisioning state of the vendor network function.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string VendorProvisioningState { get => _parametersBody.VendorProvisioningState ?? null; set => _parametersBody.VendorProvisioningState = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.IVendorNetworkFunction">Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.IVendorNetworkFunction</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.IVendorNetworkFunction> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzConnectedNetworkVendorFunction_UpdateViaIdentityLocationExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Cmdlets.UpdateAzConnectedNetworkVendorFunction_UpdateViaIdentityLocationExpanded Clone()
        {
            var clone = new UpdateAzConnectedNetworkVendorFunction_UpdateViaIdentityLocationExpanded();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VendorNetworkFunctionsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.LocationInputObject.Id += $"/vendors/{(global::System.Uri.EscapeDataString(this.VendorName.ToString()))}/networkFunctions/{(global::System.Uri.EscapeDataString(this.ServiceKey.ToString()))}";
                        _parametersBody = await this.Client.VendorNetworkFunctionsGetViaIdentityWithResult(LocationInputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.VendorNetworkFunctionsCreateOrUpdateViaIdentity(LocationInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        if (null == LocationInputObject.LocationName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("LocationInputObject has null value for LocationInputObject.LocationName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, LocationInputObject) );
                        }
                        _parametersBody = await this.Client.VendorNetworkFunctionsGetWithResult(LocationInputObject.SubscriptionId ?? null, LocationInputObject.LocationName ?? null, VendorName, ServiceKey, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.VendorNetworkFunctionsCreateOrUpdate(LocationInputObject.SubscriptionId ?? null, LocationInputObject.LocationName ?? null, VendorName, ServiceKey, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.SerializationMode.IncludeUpdate);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { VendorName=VendorName,ServiceKey=ServiceKey})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzConnectedNetworkVendorFunction_UpdateViaIdentityLocationExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzConnectedNetworkVendorFunction_UpdateViaIdentityLocationExpanded()
        {
        ...
        private void Update_parametersBody()
        {
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("VendorProvisioningState")))
            {
                this.VendorProvisioningState = (string)(this.MyInvocation?.BoundParameters["VendorProvisioningState"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("VendorConfiguration")))
            {
                this.VendorConfiguration = (Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.INetworkFunctionVendorConfiguration[])(this.MyInvocation?.BoundParameters["VendorConfiguration"]);
            }
        }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.IVendorNetworkFunction> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.IVendorNetworkFunction
