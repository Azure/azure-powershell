...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzConnectedNetworkVendorFunction_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VendorNetworkFunctionsGet(LocationName, VendorName, ServiceKey, SubscriptionId, onOk, onDefault, this, Pipeline);
