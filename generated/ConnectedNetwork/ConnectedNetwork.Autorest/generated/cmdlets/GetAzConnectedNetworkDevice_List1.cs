...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzConnectedNetworkDevice_List1" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.DevicesListByResourceGroup(SubscriptionId, ResourceGroupName, onOk, onDefault, this, Pipeline);
