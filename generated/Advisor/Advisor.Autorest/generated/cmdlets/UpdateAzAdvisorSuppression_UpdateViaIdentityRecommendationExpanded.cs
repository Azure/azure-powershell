...
namespace Microsoft.Azure.PowerShell.Cmdlets.Advisor.Cmdlets
{
    ...
    /// suppression. Use this API to update the snoozed or dismissed status of a recommendation.
    /// </summary>
    /// <remarks>
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzAdvisorSuppression_UpdateViaIdentityRecommendationExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Advisor.Description(@"Enables the snoozed or dismissed attribute of a recommendation. The snoozed or dismissed attribute is referred to as a suppression. Use this API to update the snoozed or dismissed status of a recommendation.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Advisor.Generated]
    public partial class UpdateAzAdvisorSuppression_UpdateViaIdentityRecommendationExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (RecommendationInputObject?.Id != null)
                    {
                        ...
                        _suppressionContractBody = await this.Client.SuppressionsGetViaIdentityWithResult(RecommendationInputObject.Id, this, Pipeline);
                        this.Update_suppressionContractBody();
                        await this.Client.SuppressionsCreateViaIdentity(RecommendationInputObject.Id, _suppressionContractBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _suppressionContractBody = await this.Client.SuppressionsGetWithResult(RecommendationInputObject.ResourceUri ?? null, RecommendationInputObject.RecommendationId ?? null, Name, this, Pipeline);
                        this.Update_suppressionContractBody();
                        await this.Client.SuppressionsCreate(RecommendationInputObject.ResourceUri ?? null, RecommendationInputObject.RecommendationId ?? null, Name, _suppressionContractBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzAdvisorSuppression_UpdateViaIdentityRecommendationExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzAdvisorSuppression_UpdateViaIdentityRecommendationExpanded()
        {

        }

        private void Update_suppressionContractBody()
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SuppressionId")))
            {
                this.SuppressionId = (string)(this.MyInvocation?.BoundParameters["SuppressionId"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Ttl")))
            {
                this.Ttl = (string)(this.MyInvocation?.BoundParameters["Ttl"]);
            }
        }
