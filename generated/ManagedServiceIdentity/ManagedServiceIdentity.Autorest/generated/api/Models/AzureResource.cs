...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models
{
    ...
    public partial class AzureResource :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.IAzureResourceInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.IAzureResourceInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.IAzureResourceInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for ResourceGroup</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.IAzureResourceInternal.ResourceGroup { get => this._resourceGroup; set { {_resourceGroup = value;} } }

        /// <summary>Internal Acessors for SubscriptionDisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.IAzureResourceInternal.SubscriptionDisplayName { get => this._subscriptionDisplayName; set { {_subscriptionDisplayName = value;} } }

        /// <summary>Internal Acessors for SubscriptionId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.IAzureResourceInternal.SubscriptionId { get => this._subscriptionId; set { {_subscriptionId = value;} } }

        /// <summary>Internal Acessors for Type</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.IAzureResourceInternal.Type { get => this._type; set { {_type = value;} } }
