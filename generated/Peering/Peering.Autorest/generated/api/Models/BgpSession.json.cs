...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models
{
    ...
    public partial class BgpSession
    {
        ...
        internal BgpSession(Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonObject json)
        {
            ...
            {_sessionPrefixV4 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonString>("sessionPrefixV4"), out var __jsonSessionPrefixV4) ? (string)__jsonSessionPrefixV4 : (string)_sessionPrefixV4;}
            {_sessionPrefixV6 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonString>("sessionPrefixV6"), out var __jsonSessionPrefixV6) ? (string)__jsonSessionPrefixV6 : (string)_sessionPrefixV6;}
            {_microsoftSessionIPv4Address = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonString>("microsoftSessionIPv4Address"), out var __jsonMicrosoftSessionIPv4Address) ? (string)__jsonMicrosoftSessionIPv4Address : (string)_microsoftSessionIPv4Address;}
            {_microsoftSessionIPv6Address = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonString>("microsoftSessionIPv6Address"), out var __jsonMicrosoftSessionIPv6Address) ? (string)__jsonMicrosoftSessionIPv6Address : (string)_microsoftSessionIPv6Address;}
            {_peerSessionIPv4Address = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonString>("peerSessionIPv4Address"), out var __jsonPeerSessionIPv4Address) ? (string)__jsonPeerSessionIPv4Address : (string)_peerSessionIPv4Address;}
            {_peerSessionIPv6Address = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonString>("peerSessionIPv6Address"), out var __jsonPeerSessionIPv6Address) ? (string)__jsonPeerSessionIPv6Address : (string)_peerSessionIPv6Address;}
            {_sessionStateV4 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonString>("sessionStateV4"), out var __jsonSessionStateV4) ? (string)__jsonSessionStateV4 : (string)_sessionStateV4;}
            {_sessionStateV6 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonString>("sessionStateV6"), out var __jsonSessionStateV6) ? (string)__jsonSessionStateV6 : (string)_sessionStateV6;}
            {_maxPrefixesAdvertisedV4 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNumber>("maxPrefixesAdvertisedV4"), out var __jsonMaxPrefixesAdvertisedV4) ? (int?)__jsonMaxPrefixesAdvertisedV4 : _maxPrefixesAdvertisedV4;}
            {_maxPrefixesAdvertisedV6 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNumber>("maxPrefixesAdvertisedV6"), out var __jsonMaxPrefixesAdvertisedV6) ? (int?)__jsonMaxPrefixesAdvertisedV6 : _maxPrefixesAdvertisedV6;}
            {_md5AuthenticationKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonString>("md5AuthenticationKey"), out var __jsonMd5AuthenticationKey) ? (string)__jsonMd5AuthenticationKey : (string)_md5AuthenticationKey;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IBgpSession.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IBgpSession.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IBgpSession FromJson(Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode node)
        {
