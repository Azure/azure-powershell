...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models
{
    ...
    public partial class PeeringProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringPropertiesInternal
    {

        /// <summary>Backing field for <see cref="Direct" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringPropertiesDirect _direct;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringPropertiesDirect Direct { get => (this._direct = this._direct ?? new Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.PeeringPropertiesDirect()); set => this._direct = value; }
        ...
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IDirectConnection> DirectConnection { get => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringPropertiesDirectInternal)Direct).Connection; set => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringPropertiesDirectInternal)Direct).Connection = value ?? null /* arrayOf */; }

        /// <summary>The identifier of the referenced resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Peering.Origin(Microsoft.Azure.PowerShell.Cmdlets.Peering.PropertyOrigin.Inlined)]
        public string DirectPeerAsnId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringPropertiesDirectInternal)Direct).PeerAsnId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringPropertiesDirectInternal)Direct).PeerAsnId = value ?? null; }

        /// <summary>The type of direct peering.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Peering.Origin(Microsoft.Azure.PowerShell.Cmdlets.Peering.PropertyOrigin.Inlined)]
        public string DirectPeeringType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringPropertiesDirectInternal)Direct).DirectPeeringType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringPropertiesDirectInternal)Direct).DirectPeeringType = value ?? null; }

        /// <summary>The flag that indicates whether or not the peering is used for peering service.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Peering.Origin(Microsoft.Azure.PowerShell.Cmdlets.Peering.PropertyOrigin.Inlined)]
        public bool? DirectUseForPeeringService { get => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringPropertiesDirectInternal)Direct).UseForPeeringService; }

        /// <summary>Backing field for <see cref="Exchange" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringPropertiesExchange _exchange;

        /// <summary>The properties that define an exchange peering.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Peering.Origin(Microsoft.Azure.PowerShell.Cmdlets.Peering.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringPropertiesExchange Exchange { get => (this._exchange = this._exchange ?? new Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.PeeringPropertiesExchange()); set => this._exchange = value; }

        /// <summary>The set of connections that constitute an exchange peering.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Peering.Origin(Microsoft.Azure.PowerShell.Cmdlets.Peering.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IExchangeConnection> ExchangeConnection { get => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringPropertiesExchangeInternal)Exchange).Connection; set => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringPropertiesExchangeInternal)Exchange).Connection = value ?? null /* arrayOf */; }

        /// <summary>The identifier of the referenced resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Peering.Origin(Microsoft.Azure.PowerShell.Cmdlets.Peering.PropertyOrigin.Inlined)]
        public string ExchangePeerAsnId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringPropertiesExchangeInternal)Exchange).PeerAsnId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringPropertiesExchangeInternal)Exchange).PeerAsnId = value ?? null; }
