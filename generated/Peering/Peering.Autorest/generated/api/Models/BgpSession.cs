...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models
{
    ...
    public partial class BgpSession :
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IBgpSession,
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IBgpSessionInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IBgpSessionInternal.SessionStateV4 { get => this._sessionStateV4; set { {_sessionStateV4 = value;} } }

        /// <summary>Internal Acessors for SessionStateV6</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IBgpSessionInternal.SessionStateV6 { get => this._sessionStateV6; set { {_sessionStateV6 = value;} } }
        ...
        private string _sessionStateV4;

        /// <summary>The state of the IPv4 session.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Peering.Origin(Microsoft.Azure.PowerShell.Cmdlets.Peering.PropertyOrigin.Owned)]
        public string SessionStateV4 { get => this._sessionStateV4; }

        /// <summary>Backing field for <see cref="SessionStateV6" /> property.</summary>
        private string _sessionStateV6;

        /// <summary>The state of the IPv6 session.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Peering.Origin(Microsoft.Azure.PowerShell.Cmdlets.Peering.PropertyOrigin.Owned)]
        public string SessionStateV6 { get => this._sessionStateV6; }
...

    {
        ...
        /// <summary>The state of the IPv4 session.</summary>
        [global::Microsoft.Azure.PowerShell.Cmdlets.Peering.PSArgumentCompleterAttribute("None", "Idle", "Connect", "Active", "OpenSent", "OpenConfirm", "OpenReceived", "Established", "PendingAdd", "PendingUpdate", "PendingRemove")]
        string SessionStateV4 { get; set; }
        /// <summary>The state of the IPv6 session.</summary>
        [global::Microsoft.Azure.PowerShell.Cmdlets.Peering.PSArgumentCompleterAttribute("None", "Idle", "Connect", "Active", "OpenSent", "OpenConfirm", "OpenReceived", "Established", "PendingAdd", "PendingUpdate", "PendingRemove")]
        string SessionStateV6 { get; set; }
