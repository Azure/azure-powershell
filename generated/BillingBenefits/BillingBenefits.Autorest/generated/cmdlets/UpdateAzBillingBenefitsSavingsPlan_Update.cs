...
namespace Microsoft.Azure.PowerShell.Cmdlets.BillingBenefits.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzBillingBenefitsSavingsPlan_Update", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzBillingBenefitsSavingsPlan_Update : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.BillingBenefits.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.BillingBenefits.Models.Api20221101.ISavingsPlanUpdateRequest _body;

        /// <summary>Savings plan patch request</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Savings plan patch request", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.BillingBenefits.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Savings plan patch request",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.BillingBenefits.Models.Api20221101.ISavingsPlanUpdateRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.BillingBenefits.Models.Api20221101.ISavingsPlanUpdateRequest Body { get => this._body; set => this._body = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SavingsPlanUpdate(OrderId, Id, Body, onOk, onAccepted, onNotFound, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  OrderId=OrderId,Id=Id,body=Body})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzBillingBenefitsSavingsPlan_Update" /> cmdlet class.
        /// </summary>
        public UpdateAzBillingBenefitsSavingsPlan_Update()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.BillingBenefits.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { OrderId=OrderId, Id=Id, body=Body })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { OrderId=OrderId, Id=Id, body=Body })
                    {
