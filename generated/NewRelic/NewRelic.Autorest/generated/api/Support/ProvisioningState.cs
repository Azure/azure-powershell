...
namespace Microsoft.Azure.PowerShell.Cmdlets.NewRelic.Support
{
        ...
        System.IEquatable<ProvisioningState>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.NewRelic.Support.ProvisioningState Accepted = @"Accepted";

        /// <summary>Monitor resource creation canceled</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.NewRelic.Support.ProvisioningState Canceled = @"Canceled";

        /// <summary>Monitor resource creation started</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.NewRelic.Support.ProvisioningState Creating = @"Creating";

        /// <summary>Monitor resource is deleted</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.NewRelic.Support.ProvisioningState Deleted = @"Deleted";

        /// <summary>Monitor resource deletion started</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.NewRelic.Support.ProvisioningState Deleting = @"Deleting";

        /// <summary>Monitor resource creation failed</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.NewRelic.Support.ProvisioningState Failed = @"Failed";

        /// <summary>Monitor resource state is unknown</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.NewRelic.Support.ProvisioningState NotSpecified = @"NotSpecified";

        /// <summary>Monitor resource creation successful</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.NewRelic.Support.ProvisioningState Succeeded = @"Succeeded";

        /// <summary>Monitor resource is being updated</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.NewRelic.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.NewRelic.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.NewRelic.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.NewRelic.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.NewRelic.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
