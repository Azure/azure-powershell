...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Models
{
    ...
    public partial class MapsKeySpecification
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.IMapsKeySpecification.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.IMapsKeySpecification.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.IMapsKeySpecification FromJson(Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonObject json ? new MapsKeySpecification(json) : null;
        }
        ...
        internal MapsKeySpecification(Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonObject json)
        {
            ...
            {_keyType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonString>("keyType"), out var __jsonKeyType) ? (string)__jsonKeyType : (string)_keyType;}
            AfterFromJson(json);
        }
