...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Models
{
    ...
    public partial class MapsAccountKeys
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.IMapsAccountKeys.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.IMapsAccountKeys.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.IMapsAccountKeys FromJson(Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode node)
        {
        ...
        internal MapsAccountKeys(Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonObject json)
        {
            ...
            {_primaryKeyLastUpdated = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonString>("primaryKeyLastUpdated"), out var __jsonPrimaryKeyLastUpdated) ? (string)__jsonPrimaryKeyLastUpdated : (string)_primaryKeyLastUpdated;}
            {_primaryKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonString>("primaryKey"), out var __jsonPrimaryKey) ? (string)__jsonPrimaryKey : (string)_primaryKey;}
            {_secondaryKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonString>("secondaryKey"), out var __jsonSecondaryKey) ? (string)__jsonSecondaryKey : (string)_secondaryKey;}
            {_secondaryKeyLastUpdated = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonString>("secondaryKeyLastUpdated"), out var __jsonSecondaryKeyLastUpdated) ? (string)__jsonSecondaryKeyLastUpdated : (string)_secondaryKeyLastUpdated;}
            AfterFromJson(json);
        }
