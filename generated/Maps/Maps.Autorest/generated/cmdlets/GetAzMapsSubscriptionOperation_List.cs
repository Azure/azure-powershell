...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListSubscriptionOperations=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Maps/operations"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMapsSubscriptionOperation_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.IOperationDetail))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Maps.Description(@"List operations available for the Maps Resource Provider")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Maps.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Maps.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Maps/operations", ApiVersion = "2021-02-01")]
    public partial class GetAzMapsSubscriptionOperation_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.IMapsOperations">Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.IMapsOperations</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.IMapsOperations> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMapsSubscriptionOperation_List" /> cmdlet class.
        /// </summary>
        public GetAzMapsSubscriptionOperation_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.MapsListSubscriptionOperations(SubscriptionId, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.IMapsOperations> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.IMapsOperations
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        ...
                        {
                            requestMessage = requestMessage.Clone(new global::System.Uri( _nextLink ),Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Method.Get );
                            await ((Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.IEventListener)this).Signal(Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Events.FollowingNextLink); if( ((Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.IEventListener)this).Token.IsCancellationRequested ) { return; }
                            await this.Client.MapsListSubscriptionOperations_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
