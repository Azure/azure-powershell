...
namespace Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Cmdlets
{
    ...
    /// <summary>update a role eligibility schedule request.</summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/{scope}/providers/Microsoft.Authorization/roleEligibilityScheduleRequests/{roleEligibilityScheduleRequestName}"
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzRoleEligibilityScheduleRequest_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Models.IRoleEligibilityScheduleRequest))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Description(@"update a role eligibility schedule request.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Generated]
    public partial class UpdateAzRoleEligibilityScheduleRequest_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Models.IRoleEligibilityScheduleRequest _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Models.RoleEligibilityScheduleRequest();
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Models.IRoleEligibilityScheduleRequest">Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Models.IRoleEligibilityScheduleRequest</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Models.IRoleEligibilityScheduleRequest> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _parametersBody = await this.Client.RoleEligibilityScheduleRequestsGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.RoleEligibilityScheduleRequestsCreateViaIdentity(InputObject.Id, _parametersBody, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.RoleEligibilityScheduleRequestName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.RoleEligibilityScheduleRequestName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        _parametersBody = await this.Client.RoleEligibilityScheduleRequestsGetWithResult(InputObject.Scope ?? null, InputObject.RoleEligibilityScheduleRequestName ?? null, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.RoleEligibilityScheduleRequestsCreate(InputObject.Scope ?? null, InputObject.RoleEligibilityScheduleRequestName ?? null, _parametersBody, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzRoleEligibilityScheduleRequest_UpdateViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzRoleEligibilityScheduleRequest_UpdateViaIdentityExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("RequestType")))
            {
                this.RequestType = (string)(this.MyInvocation?.BoundParameters["RequestType"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("RoleDefinitionId")))
            {
                this.RoleDefinitionId = (string)(this.MyInvocation?.BoundParameters["RoleDefinitionId"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("PrincipalId")))
            {
                this.PrincipalId = (string)(this.MyInvocation?.BoundParameters["PrincipalId"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("TargetRoleEligibilityScheduleId")))
            {
                this.TargetRoleEligibilityScheduleId = (string)(this.MyInvocation?.BoundParameters["TargetRoleEligibilityScheduleId"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("TargetRoleEligibilityScheduleInstanceId")))
            {
                this.TargetRoleEligibilityScheduleInstanceId = (string)(this.MyInvocation?.BoundParameters["TargetRoleEligibilityScheduleInstanceId"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Justification")))
            {
                this.Justification = (string)(this.MyInvocation?.BoundParameters["Justification"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Condition")))
            {
                this.Condition = (string)(this.MyInvocation?.BoundParameters["Condition"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ConditionVersion")))
            {
                this.ConditionVersion = (string)(this.MyInvocation?.BoundParameters["ConditionVersion"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ScheduleInfoStartDateTime")))
            {
                this.ScheduleInfoStartDateTime = (global::System.DateTime)(this.MyInvocation?.BoundParameters["ScheduleInfoStartDateTime"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ExpirationType")))
            {
                this.ExpirationType = (string)(this.MyInvocation?.BoundParameters["ExpirationType"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("TicketNumber")))
            {
                this.TicketNumber = (string)(this.MyInvocation?.BoundParameters["TicketNumber"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("TicketSystem")))
            {
                this.TicketSystem = (string)(this.MyInvocation?.BoundParameters["TicketSystem"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ExpirationEndDateTime")))
            {
                this.ExpirationEndDateTime = (global::System.DateTime)(this.MyInvocation?.BoundParameters["ExpirationEndDateTime"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ExpirationDuration")))
            {
                this.ExpirationDuration = (string)(this.MyInvocation?.BoundParameters["ExpirationDuration"]);
            }
        }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Models.IRoleEligibilityScheduleRequest> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Resources.Authorization.Models.IRoleEligibilityScheduleRequest
