...
{
    using Microsoft.Azure.PowerShell.Cmdlets.DataBoundary.generated.runtime.Properties;
    using System;
    ...
    public class GenericBreakingChangeAttribute : Attribute
    {
        ...
        public string moduleName { get; set; } = String.IsNullOrEmpty(@"Az.Resources") ? @"Az.DataBoundary" : @"Az.Resources";
