...
namespace Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10
{
    ...
    public partial class MicrosoftGraphOrgContact
    {
        ...
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonObject json ? new MicrosoftGraphOrgContact(json, new global::System.Collections.Generic.HashSet<string>(){ @"ResourceGroupName",@"deletedDateTime",@"displayName",@"@odata.type",@"@odata.id",@"addresses",@"companyName",@"department",@"givenName",@"jobTitle",@"mail",@"mailNickname",@"onPremisesLastSyncDateTime",@"onPremisesProvisioningErrors",@"onPremisesSyncEnabled",@"phones",@"proxyAddresses",@"surname",@"directReports",@"manager",@"memberOf",@"transitiveMemberOf" }) : null;
        }
