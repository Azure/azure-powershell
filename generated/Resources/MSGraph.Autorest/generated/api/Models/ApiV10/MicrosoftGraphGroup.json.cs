...
namespace Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10
{
    ...
    public partial class MicrosoftGraphGroup
    {
        ...
        internal MicrosoftGraphGroup(Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonObject json, global::System.Collections.Generic.HashSet<string> exclusions = null)
        {
            ...
            {_classification = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString>("classification"), out var __jsonClassification) ? (string)__jsonClassification : (string)_classification;}
            ...
            {_mailEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonBoolean>("mailEnabled"), out var __jsonMailEnabled) ? (bool?)__jsonMailEnabled : _mailEnabled;}
            ...
            {_membershipRule = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString>("membershipRule"), out var __jsonMembershipRule) ? (string)__jsonMembershipRule : (string)_membershipRule;}
            {_membershipRuleProcessingState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString>("membershipRuleProcessingState"), out var __jsonMembershipRuleProcessingState) ? (string)__jsonMembershipRuleProcessingState : (string)_membershipRuleProcessingState;}
            {_preferredDataLocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString>("preferredDataLocation"), out var __jsonPreferredDataLocation) ? (string)__jsonPreferredDataLocation : (string)_preferredDataLocation;}
            ...
            {_securityEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonBoolean>("securityEnabled"), out var __jsonSecurityEnabled) ? (bool?)__jsonSecurityEnabled : _securityEnabled;}
            {_securityIdentifier = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString>("securityIdentifier"), out var __jsonSecurityIdentifier) ? (string)__jsonSecurityIdentifier : (string)_securityIdentifier;}
            {_theme = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Json.JsonString>("theme"), out var __jsonTheme) ? (string)__jsonTheme : (string)_theme;}
