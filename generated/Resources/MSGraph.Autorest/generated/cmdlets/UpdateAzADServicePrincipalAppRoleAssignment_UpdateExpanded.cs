...
namespace Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UpdateAppRoleAssignments=>PATCH:"/servicePrincipals/{servicePrincipal-id}/appRoleAssignments/{appRoleAssignment-id}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzADServicePrincipalAppRoleAssignment_UpdateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Description(@"update the navigation property appRoleAssignments in servicePrincipals")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.HttpPath(Path = "/servicePrincipals/{servicePrincipal-id}/appRoleAssignments/{appRoleAssignment-id}", ApiVersion = "v1.0")]
    public partial class UpdateAzADServicePrincipalAppRoleAssignment_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.IContext
    {
        ...
        /// types.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10.IMicrosoftGraphAppRoleAssignment _body = new Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Models.ApiV10.MicrosoftGraphAppRoleAssignment();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "key: id of appRoleAssignment")]
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The identifier (id) for the app role which is assigned to the principal. This app role must be exposed in the appRoles property on the resource application's service principal (resourceId). If the resource application has not declared any app roles, a default app role ID of 00000000-0000-0000-0000-000000000000 can be specified to signal that the principal is assigned to the resource app without any specific app roles. Required on create.")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AppRoleId { get => _body.AppRoleId ?? null; set => _body.AppRoleId = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The unique identifier (id) for the user, group or service principal being granted the app role. Required on create.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The display name of the resource app's service principal to which the assignment is made.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.DoNotExport]
        public string ResourceDisplayName { get => _body.ResourceDisplayName ?? null; set => _body.ResourceDisplayName = value; }

        /// <summary>
        /// The unique identifier (id) for the resource service principal for which the assignment is made. Required on create. Supports
        /// $filter (eq only).
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The unique identifier (id) for the resource service principal for which the assignment is made. Required on create. Supports $filter (eq only).")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.DoNotExport]
        public string ResourceId { get => _body.ResourceId ?? null; set => _body.ResourceId = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ServicePrincipalsUpdateAppRoleAssignments' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("DeletedDateTime"))
                {
                    DeletedDateTime = (global::System.DateTime)this.MyInvocation.BoundParameters["DeletedDateTime"];
                }
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("DisplayName"))
                {
                    DisplayName = (string)this.MyInvocation.BoundParameters["DisplayName"];
                }
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("PrincipalId"))
                {
                    PrincipalId = (string)this.MyInvocation.BoundParameters["PrincipalId"];
                }
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("ResourceDisplayName"))
                {
                    ResourceDisplayName = (string)this.MyInvocation.BoundParameters["ResourceDisplayName"];
                }
                if (true == this.MyInvocation?.BoundParameters?.ContainsKey("ResourceId"))
                {
                    ResourceId = (string)this.MyInvocation.BoundParameters["ResourceId"];
                }
                try
                {
                    await ((Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.IEventListener)this).Signal(Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.Events.CmdletBeforeAPICall); if( ((Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.IEventListener)this).Token.IsCancellationRequested ) { return; }
                    await this.Client.ServicePrincipalsUpdateAppRoleAssignments(ServicePrincipalId, AppRoleAssignmentId, _body, onNoContent, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Runtime.SerializationMode.IncludeUpdate);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ServicePrincipalId=ServicePrincipalId,AppRoleAssignmentId=AppRoleAssignmentId})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzADServicePrincipalAppRoleAssignment_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzADServicePrincipalAppRoleAssignment_UpdateExpanded()
        {
