...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListBuiltIn=>GET:"/providers/Microsoft.Authorization/policyDefinitions/{policyDefinitionName}/versions"
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPolicyDefinitionVersionBuilt_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Description(@"This operation retrieves a list of all the built-in policy definition versions for the given policy definition.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.HttpPath(Path = "/providers/Microsoft.Authorization/policyDefinitions/{policyDefinitionName}/versions", ApiVersion = "2026-01-01-preview")]
    public partial class GetAzPolicyDefinitionVersionBuilt_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzPolicyDefinitionVersionBuilt_List" /> cmdlet class.
        /// </summary>
        public GetAzPolicyDefinitionVersionBuilt_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PolicyDefinitionVersionsListBuiltIn(PolicyDefinitionName, this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { PolicyDefinitionName=PolicyDefinitionName,Top=this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?)})
                    {
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.PolicyDefinitionVersionsListBuiltIn_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
