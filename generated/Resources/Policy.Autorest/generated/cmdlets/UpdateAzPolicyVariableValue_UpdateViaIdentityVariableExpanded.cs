...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
    ...
    /// <summary>
    /// This operation update a variable value with the given management group and name for a given variable. Variable values
    /// are scoped to the variable for which they are created for.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetAtManagementGroup=>GET:"/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Authorization/variables/{variableName}/values/{variableValueName}"
    /// [DETAILS]
    /// verb: Update
    /// subjectPrefix: Policy
    /// subject: VariableValue
    /// variant: UpdateViaIdentityVariableExpanded
    /// [OpenAPI] CreateOrUpdateAtManagementGroup=>PUT:"/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Authorization/variables/{variableName}/values/{variableValueName}"
    /// [DETAILS]
    /// verb: Update
    /// subjectPrefix: Policy
    /// subject: VariableValue
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzPolicyVariableValue_UpdateViaIdentityVariableExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IVariableValue))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Description(@"This operation update a variable value with the given management group and name for a given variable. Variable values are scoped to the variable for which they are created for.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Generated]
    public partial class UpdateAzPolicyVariableValue_UpdateViaIdentityVariableExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IVariableValue _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.VariableValue();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Policy.PolicyClient Client => Microsoft.Azure.PowerShell.Cmdlets.Policy.Module.Instance.ClientAPI;
        ...
        /// <summary>The name of the variable value to operate on.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the variable value to operate on.")]
        ...
        [global::System.Management.Automation.Alias("VariableValueName")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Variable value column value array.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyVariableValueColumnValue[] Value { get => _parametersBody.Value?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.Value = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyVariableValueColumnValue>(value) : null); }

        /// <summary>Backing field for <see cref="VariableInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyIdentity _variableInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Policy.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyIdentity VariableInputObject { get => this._variableInputObject; set => this._variableInputObject = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IVariableValue">Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IVariableValue</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IVariableValue> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IVariableValue> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VariableValuesCreateOrUpdateAtManagementGroup' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (VariableInputObject?.Id != null)
                    {
                        this.VariableInputObject.Id += $"/values/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        _parametersBody = await this.Client.VariableValuesGetAtManagementGroupViaIdentityWithResult(VariableInputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.VariableValuesCreateOrUpdateAtManagementGroupViaIdentity(VariableInputObject.Id, _parametersBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == VariableInputObject.ManagementGroupId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("VariableInputObject has null value for VariableInputObject.ManagementGroupId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, VariableInputObject) );
                        }
                        if (null == VariableInputObject.VariableName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("VariableInputObject has null value for VariableInputObject.VariableName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, VariableInputObject) );
                        }
                        _parametersBody = await this.Client.VariableValuesGetAtManagementGroupWithResult(VariableInputObject.ManagementGroupId ?? null, VariableInputObject.VariableName ?? null, Name, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.VariableValuesCreateOrUpdateAtManagementGroup(VariableInputObject.ManagementGroupId ?? null, VariableInputObject.VariableName ?? null, Name, _parametersBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzPolicyVariableValue_UpdateViaIdentityVariableExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzPolicyVariableValue_UpdateViaIdentityVariableExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Value")))
            {
                this.Value = (Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyVariableValueColumnValue[])(this.MyInvocation?.BoundParameters["Value"]);
            }
        }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IVariableValue> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IVariableValue
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IVariableValue> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
