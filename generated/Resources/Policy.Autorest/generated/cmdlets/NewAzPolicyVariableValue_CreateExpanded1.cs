...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
    ...
    /// <summary>
    /// This operation create a variable value with the given management group and name for a given variable. Variable values
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzPolicyVariableValue_CreateExpanded1", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IVariableValue))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Description(@"This operation create a variable value with the given management group and name for a given variable. Variable values are scoped to the variable for which they are created for.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.HttpPath(Path = "/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Authorization/variables/{variableName}/values/{variableValueName}", ApiVersion = "2026-01-01-preview")]
    public partial class NewAzPolicyVariableValue_CreateExpanded1 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IContext
    {
        ...
        /// <summary>The name of the variable to operate on.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the variable to operate on.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzPolicyVariableValue_CreateExpanded1" /> cmdlet class.
        /// </summary>
        public NewAzPolicyVariableValue_CreateExpanded1()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VariableValuesCreateOrUpdateAtManagementGroup(ManagementGroupId, VariableName, Name, _parametersBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.SerializationMode.IncludeCreate);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ManagementGroupId=ManagementGroupId,VariableName=VariableName,Name=Name})
                    {
