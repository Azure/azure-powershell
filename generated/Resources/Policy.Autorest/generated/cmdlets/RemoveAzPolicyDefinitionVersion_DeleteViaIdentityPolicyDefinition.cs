...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/policyDefinitions/{policyDefinitionName}/versions/{policyDefinitionVersion}"
    /// [DETAILS]
    /// verb: Remove
    /// subjectPrefix:
    /// subject: PolicyDefinitionVersion
    /// variant: DeleteViaIdentityPolicyDefinition
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzPolicyDefinitionVersion_DeleteViaIdentityPolicyDefinition", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Description(@"This operation deletes the policy definition version in the given subscription with the given name.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/policyDefinitions/{policyDefinitionName}/versions/{policyDefinitionVersion}", ApiVersion = "2026-01-01-preview")]
    public partial class RemoveAzPolicyDefinitionVersion_DeleteViaIdentityPolicyDefinition : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="PolicyDefinitionInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyIdentity _policyDefinitionInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyIdentity PolicyDefinitionInputObject { get => this._policyDefinitionInputObject; set => this._policyDefinitionInputObject = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PolicyDefinitionVersionsDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (PolicyDefinitionInputObject?.Id != null)
                    {
                        this.PolicyDefinitionInputObject.Id += $"/versions/{(global::System.Uri.EscapeDataString(this.PolicyDefinitionVersion.ToString()))}";
                        await this.Client.PolicyDefinitionVersionsDeleteViaIdentity(PolicyDefinitionInputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == PolicyDefinitionInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("PolicyDefinitionInputObject has null value for PolicyDefinitionInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, PolicyDefinitionInputObject) );
                        }
                        if (null == PolicyDefinitionInputObject.PolicyDefinitionName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("PolicyDefinitionInputObject has null value for PolicyDefinitionInputObject.PolicyDefinitionName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, PolicyDefinitionInputObject) );
                        }
                        await this.Client.PolicyDefinitionVersionsDelete(PolicyDefinitionInputObject.SubscriptionId ?? null, PolicyDefinitionInputObject.PolicyDefinitionName ?? null, PolicyDefinitionVersion, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzPolicyDefinitionVersion_DeleteViaIdentityPolicyDefinition" /> cmdlet
        /// class.
        /// </summary>
        public RemoveAzPolicyDefinitionVersion_DeleteViaIdentityPolicyDefinition()
        {
