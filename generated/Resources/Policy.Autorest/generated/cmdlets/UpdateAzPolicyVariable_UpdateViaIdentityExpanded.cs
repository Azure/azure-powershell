...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
    ...
    /// <summary>
    /// This operation update a variable with the given management group and name. Policy variables can only be used by a policy
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzPolicyVariable_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IVariable))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Description(@"This operation update a variable with the given  management group and name. Policy variables can only be used by a policy definition at the scope they are created or below.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Generated]
    public partial class UpdateAzPolicyVariable_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        _parametersBody = await this.Client.VariablesGetAtManagementGroupWithResult(InputObject.ManagementGroupId ?? null, InputObject.VariableName ?? null, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.VariablesCreateOrUpdateAtManagementGroup(InputObject.ManagementGroupId ?? null, InputObject.VariableName ?? null, _parametersBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzPolicyVariable_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzPolicyVariable_UpdateViaIdentityExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Column")))
            {
                this.Column = (Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyVariableColumn[])(this.MyInvocation?.BoundParameters["Column"]);
            }
        }
