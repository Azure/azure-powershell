...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyExemptionUpdate _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.PolicyExemptionUpdate();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The option whether validate the exemption is at or under the assignment scope.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IResourceSelector[] ResourceSelector { get => _parametersBody.ResourceSelectorRaw?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.ResourceSelectorRaw = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IResourceSelector>(value) : null); }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PolicyExemptionsUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PolicyExemptionsUpdateViaIdentity(InputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        await this.Client.PolicyExemptionsUpdate(InputObject.Scope ?? null, InputObject.PolicyExemptionName ?? null, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzPolicyExemption_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzPolicyExemption_UpdateViaIdentityExpanded()
        {
