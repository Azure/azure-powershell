...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Acquire=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/acquirePolicyToken"
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: PolicyToken
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPolicyToken_Acquire", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Description(@"This operation acquires a policy token in the given subscription for the given request body.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/acquirePolicyToken", ApiVersion = "2026-01-01-preview")]
    public partial class GetAzPolicyToken_Acquire : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="ParameterTable" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyTokenRequest _parameterTable;

        /// <summary>The policy token request properties.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The policy token request properties.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The policy token request properties.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyTokenRequest) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyTokenRequest ParameterTable { get => this._parameterTable; set => this._parameterTable = value; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzPolicyToken_Acquire" /> cmdlet class.
        /// </summary>
        public GetAzPolicyToken_Acquire()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PolicyTokensAcquire' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.PolicyTokensAcquire(SubscriptionId, ParameterTable, onOk, onDefault, this, Pipeline);
