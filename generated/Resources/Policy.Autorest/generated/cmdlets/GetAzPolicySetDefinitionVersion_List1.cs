...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListAll=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/listPolicySetDefinitionVersions"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPolicySetDefinitionVersion_List1", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Description(@"This operation lists all the policy set definition versions for all policy set definitions within a subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/listPolicySetDefinitionVersions", ApiVersion = "2023-04-01")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IContext
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PolicySetDefinitionVersionsListAll' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.PolicySetDefinitionVersionsListAll(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.PolicySetDefinitionVersionsListAll_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
