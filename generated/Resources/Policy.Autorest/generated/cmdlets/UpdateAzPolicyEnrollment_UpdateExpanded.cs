...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
    ...
    /// <summary>This operation update a policy enrollment with the given scope and name.</summary>
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/{scope}/providers/Microsoft.Authorization/policyEnrollments/{policyEnrollmentName}"
    /// [DETAILS]
    /// verb: Update
    /// subjectPrefix:
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzPolicyEnrollment_UpdateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyEnrollment))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Description(@"This operation update a policy enrollment with the given scope and name.")]
    ...
    public partial class UpdateAzPolicyEnrollment_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyEnrollmentUpdate _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.PolicyEnrollmentUpdate();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The option whether to validate the enrollment is at or under the assignment scope.")]
        ...
        public string AssignmentScopeValidation { get => _parametersBody.AssignmentScopeValidation ?? null; set => _parametersBody.AssignmentScopeValidation = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PolicyEnrollmentsUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PolicyEnrollmentsUpdate(Scope, Name, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.SerializationMode.IncludeUpdate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzPolicyEnrollment_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzPolicyEnrollment_UpdateExpanded()
        {
