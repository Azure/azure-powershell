        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PolicySetDefinitionsGetAtManagementGroupViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PolicySetDefinitionsGetAtManagementGroup(InputObject.ManagementGroupId ?? null, InputObject.PolicySetDefinitionName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, onOk, onDefault, this, Pipeline);
                    }
