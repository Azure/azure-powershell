...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IContext
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IAny EndpointSettingDetail { get => _parametersBody.EndpointSettingDetail ?? null /* object */; set => _parametersBody.EndpointSettingDetail = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the management group. The name is case insensitive.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyDefinitionVersionPropertiesParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyDefinitionVersionPropertiesParameters ParameterTable { get => _parametersBody.Parameter ?? null /* object */; set => _parametersBody.Parameter = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the policy definition.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    _parametersBody = await this.Client.PolicyDefinitionVersionsGetAtManagementGroupWithResult(ManagementGroupId, PolicyDefinitionName, PolicyDefinitionVersion, this, Pipeline);
                    this.Update_parametersBody();
                    await this.Client.PolicyDefinitionVersionsCreateOrUpdateAtManagementGroup(ManagementGroupId, PolicyDefinitionName, PolicyDefinitionVersion, _parametersBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.SerializationMode.IncludeUpdate);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ManagementGroupId=ManagementGroupId,PolicyDefinitionName=PolicyDefinitionName,PolicyDefinitionVersion=PolicyDefinitionVersion})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzPolicyDefinitionVersion_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzPolicyDefinitionVersion_UpdateExpanded()
        {
        ...
        private void Update_parametersBody()
        {
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Metadata")))
            {
                this.Metadata = (Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IAny)(this.MyInvocation?.BoundParameters["Metadata"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ParameterTable")))
            {
                this.ParameterTable = (Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyDefinitionVersionPropertiesParameters)(this.MyInvocation?.BoundParameters["ParameterTable"]);
            }
            ...
            {
                this.EndpointSettingDetail = (Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IAny)(this.MyInvocation?.BoundParameters["EndpointSettingDetail"]);
            }
        }
