...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListAllBuiltins=>POST:"/providers/Microsoft.Authorization/listPolicySetDefinitionVersions"
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: PolicySetDefinitionVersionBuiltin
    /// variant: List
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPolicySetDefinitionVersionBuiltin_List", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Description(@"This operation lists all the built-in policy set definition versions for all built-in policy set definitions.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.HttpPath(Path = "/providers/Microsoft.Authorization/listPolicySetDefinitionVersions", ApiVersion = "2026-01-01-preview")]
    public partial class GetAzPolicySetDefinitionVersionBuiltin_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzPolicySetDefinitionVersionBuiltin_List" /> cmdlet class.
        /// </summary>
        public GetAzPolicySetDefinitionVersionBuiltin_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PolicySetDefinitionVersionsListAllBuiltins' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PolicySetDefinitionVersionsListAllBuiltins(onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.PolicySetDefinitionVersionsListAllBuiltins_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
