...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.HttpPath(Path = "/providers/Microsoft.Authorization/policySetDefinitions/{policySetDefinitionName}", ApiVersion = "2026-01-01-preview")]
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PolicySetDefinitionsGetBuiltIn(PolicySetDefinitionName, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { PolicySetDefinitionName=PolicySetDefinitionName,Expand=this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null})
                    {
