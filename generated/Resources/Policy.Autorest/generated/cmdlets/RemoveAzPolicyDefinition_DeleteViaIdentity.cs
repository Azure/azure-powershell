...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.PolicyDefinitionsDelete(InputObject.SubscriptionId ?? null, InputObject.PolicyDefinitionName ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzPolicyDefinition_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
