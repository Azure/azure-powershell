...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Models
{
    ...
    public partial class PolicyIdentity
    {
        ...
        internal PolicyIdentity(Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonObject json)
        {
            ...
            {_policyEnrollmentName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString>("policyEnrollmentName"), out var __jsonPolicyEnrollmentName) ? (string)__jsonPolicyEnrollmentName : (string)_policyEnrollmentName;}
            ...
            {_variableName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString>("variableName"), out var __jsonVariableName) ? (string)__jsonVariableName : (string)_variableName;}
            {_variableValueName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString>("variableValueName"), out var __jsonVariableValueName) ? (string)__jsonVariableValueName : (string)_variableValueName;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._policyEnrollmentName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString(this._policyEnrollmentName.ToString()) : null, "policyEnrollmentName" ,container.Add );
            ...
            AddIf( null != (((object)this._variableName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString(this._variableName.ToString()) : null, "variableName" ,container.Add );
            AddIf( null != (((object)this._variableValueName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonString(this._variableValueName.ToString()) : null, "variableValueName" ,container.Add );
