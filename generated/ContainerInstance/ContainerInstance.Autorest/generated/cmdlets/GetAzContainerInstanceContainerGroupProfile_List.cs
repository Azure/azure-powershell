...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Cmdlets
{
    ...
    /// <summary>
    /// Get a list of container group profiles in the specified subscription. This operation returns properties of each container
    /// group profile including containers, image registry credentials, restart policy, IP address type, OS type,volumes,current
    /// revision number, etc.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.ContainerInstance/containerGroupProfiles"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzContainerInstanceContainerGroupProfile_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Description(@"Get a list of container group profiles in the specified subscription. This operation returns properties of each container group profile including containers, image registry credentials, restart policy, IP address type, OS type,volumes,current revision number, etc.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.ContainerInstance/containerGroupProfiles", ApiVersion = "2024-05-01-preview")]
    public partial class GetAzContainerInstanceContainerGroupProfile_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzContainerInstanceContainerGroupProfile_List" /> cmdlet class.
        /// </summary>
        public GetAzContainerInstanceContainerGroupProfile_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ContainerGroupProfilesList(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ContainerGroupProfilesList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
