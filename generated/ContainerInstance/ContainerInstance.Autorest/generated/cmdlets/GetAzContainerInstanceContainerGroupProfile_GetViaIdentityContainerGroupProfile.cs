...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Cmdlets
{
    ...
    using Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Cmdlets;
    using System;

    /// <summary>
    /// Gets the properties of the specified revision of the container group profile in the given subscription and resource group.
    /// The operation returns the properties of container group profile including containers, image registry credentials, restart
    /// policy, IP address type, OS type, volumes, current revision number, etc.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetByRevisionNumber=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerInstance/containerGroupProfiles/{containerGroupProfileName}/revisions/{revisionNumber}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzContainerInstanceContainerGroupProfile_GetViaIdentityContainerGroupProfile")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.IContainerGroupProfile))]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerInstance/containerGroupProfiles/{containerGroupProfileName}/revisions/{revisionNumber}", ApiVersion = "2024-05-01-preview")]
    public partial class GetAzContainerInstanceContainerGroupProfile_GetViaIdentityContainerGroupProfile : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.IEventListener,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="ContainerGroupProfileInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.IContainerInstanceIdentity _containerGroupProfileInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.IContainerInstanceIdentity ContainerGroupProfileInputObject { get => this._containerGroupProfileInputObject; set => this._containerGroupProfileInputObject = value; }
        ...
        /// </summary>
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.HttpPipeline Pipeline { get; set; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The revision number of the container group profile.")]
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICloudError">Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICloudError</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICloudError> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.IContainerGroupProfile">Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.IContainerGroupProfile</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.IContainerGroupProfile> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzContainerInstanceContainerGroupProfile_GetViaIdentityContainerGroupProfile"
        /// /> cmdlet class.
        /// </summary>
        public GetAzContainerInstanceContainerGroupProfile_GetViaIdentityContainerGroupProfile()
        {
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Events.Progress:
                    {
                        var data = messageData();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                Pipeline = Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Module.Instance.CreatePipeline(InvocationInformation, __correlationId, __processRecordId, this.ParameterSetName, this.ExtensibleParameters);
                ...
                try
                {
                    ...
                    if (ContainerGroupProfileInputObject?.Id != null)
                    {
                        this.ContainerGroupProfileInputObject.Id += $"/revisions/{(global::System.Uri.EscapeDataString(this.RevisionNumber.ToString()))}";
                        await this.Client.ContainerGroupProfileGetByRevisionNumberViaIdentity(ContainerGroupProfileInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == ContainerGroupProfileInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ContainerGroupProfileInputObject has null value for ContainerGroupProfileInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ContainerGroupProfileInputObject) );
                        }
                        if (null == ContainerGroupProfileInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ContainerGroupProfileInputObject has null value for ContainerGroupProfileInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ContainerGroupProfileInputObject) );
                        }
                        if (null == ContainerGroupProfileInputObject.ContainerGroupProfileName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ContainerGroupProfileInputObject has null value for ContainerGroupProfileInputObject.ContainerGroupProfileName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ContainerGroupProfileInputObject) );
                        }
                        await this.Client.ContainerGroupProfileGetByRevisionNumber(ContainerGroupProfileInputObject.SubscriptionId ?? null, ContainerGroupProfileInputObject.ResourceGroupName ?? null, ContainerGroupProfileInputObject.ContainerGroupProfileName ?? null, RevisionNumber, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { RevisionNumber=RevisionNumber})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICloudError>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.IContainerGroupProfile> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.IContainerGroupProfile
