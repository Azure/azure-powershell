...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models
{
    ...
    public partial class SecurityContextDefinition :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ISecurityContextDefinition,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ISecurityContextDefinitionInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ISecurityContextCapabilitiesDefinition _capability;

        /// <summary>The capabilities to add or drop from a container.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ISecurityContextCapabilitiesDefinition Capability { get => (this._capability = this._capability ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.SecurityContextCapabilitiesDefinition()); set => this._capability = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ISecurityContextCapabilitiesDefinition Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ISecurityContextDefinitionInternal.Capability { get => (this._capability = this._capability ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.SecurityContextCapabilitiesDefinition()); set { {_capability = value;} } }
...

    {
        ...
        bool? AllowPrivilegeEscalation { get; set; }
        /// <summary>The capabilities to add or drop from a container.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ISecurityContextCapabilitiesDefinition Capability { get; set; }
        /// <summary>The capabilities to add to the container.</summary>
        System.Collections.Generic.List<string> CapabilityAdd { get; set; }
        /// <summary>The capabilities to drop from the container.</summary>
        System.Collections.Generic.List<string> CapabilityDrop { get; set; }
