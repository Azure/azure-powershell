...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20221001Preview
{
    ...
    public partial class ContainerExecRequest :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20221001Preview.IContainerExecRequestInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20221001Preview.IContainerExecRequestTerminalSize Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20221001Preview.IContainerExecRequestInternal.TerminalSize { get => (this._terminalSize = this._terminalSize ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20221001Preview.ContainerExecRequestTerminalSize()); set { {_terminalSize = value;} } }

        /// <summary>Backing field for <see cref="TerminalSize" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20221001Preview.IContainerExecRequestTerminalSize _terminalSize;

        /// <summary>The size of the terminal.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20221001Preview.IContainerExecRequestTerminalSize TerminalSize { get => (this._terminalSize = this._terminalSize ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20221001Preview.ContainerExecRequestTerminalSize()); set => this._terminalSize = value; }
...

    {
        ...
        string Command { get; set; }
        /// <summary>The size of the terminal.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20221001Preview.IContainerExecRequestTerminalSize TerminalSize { get; set; }
        /// <summary>The column size of the terminal</summary>
        int? TerminalSizeCol { get; set; }
        /// <summary>The row size of the terminal</summary>
        int? TerminalSizeRow { get; set; }
