...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models
{
    ...
    public partial class ContainerProbe
    {
        ...
        internal ContainerProbe(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject json)
        {
            ...
            {_exec = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("exec"), out var __jsonExec) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ContainerExec.FromJson(__jsonExec) : _exec;}
            {_httpGet = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("httpGet"), out var __jsonHttpGet) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ContainerHttpGet.FromJson(__jsonHttpGet) : _httpGet;}
            {_initialDelaySecond = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNumber>("initialDelaySeconds"), out var __jsonInitialDelaySeconds) ? (int?)__jsonInitialDelaySeconds : _initialDelaySecond;}
            {_periodSecond = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNumber>("periodSeconds"), out var __jsonPeriodSeconds) ? (int?)__jsonPeriodSeconds : _periodSecond;}
            {_failureThreshold = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNumber>("failureThreshold"), out var __jsonFailureThreshold) ? (int?)__jsonFailureThreshold : _failureThreshold;}
            {_successThreshold = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNumber>("successThreshold"), out var __jsonSuccessThreshold) ? (int?)__jsonSuccessThreshold : _successThreshold;}
            {_timeoutSecond = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNumber>("timeoutSeconds"), out var __jsonTimeoutSeconds) ? (int?)__jsonTimeoutSeconds : _timeoutSecond;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.IContainerProbe.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.IContainerProbe.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.IContainerProbe FromJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNode node)
        {
