...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models
{
    ...
    public partial class Capabilities1 :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1Internal
    {
        ...
        float? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1Internal.MaxCpu { get => this._maxCpu; set { {_maxCpu = value;} } }

        /// <summary>Internal Acessors for MaxGpuCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1Internal.MaxGpuCount { get => this._maxGpuCount; set { {_maxGpuCount = value;} } }

        /// <summary>Internal Acessors for MaxMemoryInGb</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1Internal.MaxMemoryInGb { get => this._maxMemoryInGb; set { {_maxMemoryInGb = value;} } }

        /// <summary>Creates an new <see cref="Capabilities1" /> instance.</summary>
    ...
    /// The supported capabilities.
    internal partial interface ICapabilities1Internal
