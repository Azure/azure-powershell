...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models
{
    ...
    public partial class Capabilities :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilitiesInternal
    {

        /// <summary>Backing field for <see cref="Capability" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1 _capability;

        /// <summary>The supported capabilities.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1 Capability { get => (this._capability = this._capability ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Capabilities1()); }
        ...
        public float? CapabilityMaxCpu { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1Internal)Capability).MaxCpu; }

        /// <summary>The maximum allowed GPU count.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.PropertyOrigin.Inlined)]
        public float? CapabilityMaxGpuCount { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1Internal)Capability).MaxGpuCount; }

        /// <summary>The maximum allowed memory request in GB.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.PropertyOrigin.Inlined)]
        public float? CapabilityMaxMemoryInGb { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1Internal)Capability).MaxMemoryInGb; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1 Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilitiesInternal.Capability { get => (this._capability = this._capability ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Capabilities1()); set { {_capability = value;} } }

        /// <summary>Internal Acessors for CapabilityMaxCpu</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilitiesInternal.CapabilityMaxCpu { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1Internal)Capability).MaxCpu; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1Internal)Capability).MaxCpu = value ?? default(float); }

        /// <summary>Internal Acessors for CapabilityMaxGpuCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilitiesInternal.CapabilityMaxGpuCount { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1Internal)Capability).MaxGpuCount; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1Internal)Capability).MaxGpuCount = value ?? default(float); }

        /// <summary>Internal Acessors for CapabilityMaxMemoryInGb</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilitiesInternal.CapabilityMaxMemoryInGb { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1Internal)Capability).MaxMemoryInGb; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1Internal)Capability).MaxMemoryInGb = value ?? default(float); }

        /// <summary>Internal Acessors for Gpu</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilitiesInternal.Gpu { get => this._gpu; set { {_gpu = value;} } }

        /// <summary>Internal Acessors for IPAddressType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilitiesInternal.IPAddressType { get => this._iPAddressType; set { {_iPAddressType = value;} } }

        /// <summary>Internal Acessors for Location</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilitiesInternal.Location { get => this._location; set { {_location = value;} } }

        /// <summary>Internal Acessors for OSType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilitiesInternal.OSType { get => this._oSType; set { {_oSType = value;} } }

        /// <summary>Internal Acessors for ResourceType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilitiesInternal.ResourceType { get => this._resourceType; set { {_resourceType = value;} } }
    ...
    {
        /// <summary>The supported capabilities.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.ICapabilities1 Capability { get; set; }
        /// <summary>The maximum allowed CPU request in cores.</summary>
