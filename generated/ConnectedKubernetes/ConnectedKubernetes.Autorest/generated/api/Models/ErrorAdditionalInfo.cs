...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models
{
    ...
    public partial class ErrorAdditionalInfo :
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.IErrorAdditionalInfo,
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.IErrorAdditionalInfoInternal
    {

        /// <summary>Backing field for <see cref="Info" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.IAny _info;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.IAny Info { get => (this._info = this._info ?? new Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Any()); }

        /// <summary>Internal Acessors for Info</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.IAny Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.IErrorAdditionalInfoInternal.Info { get => (this._info = this._info ?? new Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Any()); set { {_info = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.IAny Info { get;  }
        /// <summary>The additional info type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Info(
        Required = false,
        ReadOnly = true,
    ...
    {
        /// <summary>The additional info.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.IAny Info { get; set; }
        /// <summary>The additional info type.</summary>
        string Type { get; set; }
