...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models
{
    ...
    public partial class ConnectedClusterProperties
    {
        ...
        internal ConnectedClusterProperties(Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonObject json)
        {
            ...
            {_aadProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonObject>("aadProfile"), out var __jsonAadProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.AadProfile.FromJson(__jsonAadProfile) : _aadProfile;}
            {_arcAgentProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonObject>("arcAgentProfile"), out var __jsonArcAgentProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.ArcAgentProfile.FromJson(__jsonArcAgentProfile) : _arcAgentProfile;}
            {_securityProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonObject>("securityProfile"), out var __jsonSecurityProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.SecurityProfile.FromJson(__jsonSecurityProfile) : _securityProfile;}
            {_oidcIssuerProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonObject>("oidcIssuerProfile"), out var __jsonOidcIssuerProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.OidcIssuerProfile.FromJson(__jsonOidcIssuerProfile) : _oidcIssuerProfile;}
            {_gateway = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonObject>("gateway"), out var __jsonGateway) ? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Gateway.FromJson(__jsonGateway) : _gateway;}
            {_agentPublicKeyCertificate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonString>("agentPublicKeyCertificate"), out var __jsonAgentPublicKeyCertificate) ? (string)__jsonAgentPublicKeyCertificate : (string)_agentPublicKeyCertificate;}
            {_kubernetesVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonString>("kubernetesVersion"), out var __jsonKubernetesVersion) ? (string)__jsonKubernetesVersion : (string)_kubernetesVersion;}
            {_totalNodeCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonNumber>("totalNodeCount"), out var __jsonTotalNodeCount) ? (int?)__jsonTotalNodeCount : _totalNodeCount;}
            {_totalCoreCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonNumber>("totalCoreCount"), out var __jsonTotalCoreCount) ? (int?)__jsonTotalCoreCount : _totalCoreCount;}
            {_agentVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonString>("agentVersion"), out var __jsonAgentVersion) ? (string)__jsonAgentVersion : (string)_agentVersion;}
            {_provisioningState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonString>("provisioningState"), out var __jsonProvisioningState) ? (string)__jsonProvisioningState : (string)_provisioningState;}
            {_distribution = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonString>("distribution"), out var __jsonDistribution) ? (string)__jsonDistribution : (string)_distribution;}
            {_distributionVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonString>("distributionVersion"), out var __jsonDistributionVersion) ? (string)__jsonDistributionVersion : (string)_distributionVersion;}
            {_infrastructure = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonString>("infrastructure"), out var __jsonInfrastructure) ? (string)__jsonInfrastructure : (string)_infrastructure;}
            {_offering = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonString>("offering"), out var __jsonOffering) ? (string)__jsonOffering : (string)_offering;}
            {_managedIdentityCertificateExpirationTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonString>("managedIdentityCertificateExpirationTime"), out var __jsonManagedIdentityCertificateExpirationTime) ? global::System.DateTime.TryParse((string)__jsonManagedIdentityCertificateExpirationTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonManagedIdentityCertificateExpirationTimeValue) ? __jsonManagedIdentityCertificateExpirationTimeValue : _managedIdentityCertificateExpirationTime : _managedIdentityCertificateExpirationTime;}
            {_lastConnectivityTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonString>("lastConnectivityTime"), out var __jsonLastConnectivityTime) ? global::System.DateTime.TryParse((string)__jsonLastConnectivityTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonLastConnectivityTimeValue) ? __jsonLastConnectivityTimeValue : _lastConnectivityTime : _lastConnectivityTime;}
            {_connectivityStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonString>("connectivityStatus"), out var __jsonConnectivityStatus) ? (string)__jsonConnectivityStatus : (string)_connectivityStatus;}
            {_privateLinkState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonString>("privateLinkState"), out var __jsonPrivateLinkState) ? (string)__jsonPrivateLinkState : (string)_privateLinkState;}
            {_privateLinkScopeResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonString>("privateLinkScopeResourceId"), out var __jsonPrivateLinkScopeResourceId) ? (string)__jsonPrivateLinkScopeResourceId : (string)_privateLinkScopeResourceId;}
            {_azureHybridBenefit = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonString>("azureHybridBenefit"), out var __jsonAzureHybridBenefit) ? (string)__jsonAzureHybridBenefit : (string)_azureHybridBenefit;}
            {_arcAgentryConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonArray>("arcAgentryConfigurations"), out var __jsonArcAgentryConfigurations) ? If( __jsonArcAgentryConfigurations as Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.IArcAgentryConfigurations>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.IArcAgentryConfigurations) (Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.ArcAgentryConfigurations.FromJson(__u) )) ))() : null : _arcAgentryConfiguration;}
            {_miscellaneousProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonObject>("miscellaneousProperties"), out var __jsonMiscellaneousProperties) ? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.ConnectedClusterPropertiesMiscellaneousProperties.FromJson(__jsonMiscellaneousProperties) : _miscellaneousProperty;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.IConnectedClusterProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.IConnectedClusterProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.IConnectedClusterProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.SerializationMode.IncludeRead))
            {
