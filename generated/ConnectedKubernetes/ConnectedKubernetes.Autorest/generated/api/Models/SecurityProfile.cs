...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models
{
    ...
    public partial class SecurityProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.ISecurityProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.ISecurityProfileInternal
    {

        /// <summary>Internal Acessors for WorkloadIdentity</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.ISecurityProfileWorkloadIdentity Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.ISecurityProfileInternal.WorkloadIdentity { get => (this._workloadIdentity = this._workloadIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.SecurityProfileWorkloadIdentity()); set { {_workloadIdentity = value;} } }

        /// <summary>Backing field for <see cref="WorkloadIdentity" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.ISecurityProfileWorkloadIdentity _workloadIdentity;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.ISecurityProfileWorkloadIdentity WorkloadIdentity { get => (this._workloadIdentity = this._workloadIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.SecurityProfileWorkloadIdentity()); set => this._workloadIdentity = value; }
    ...
    {
        /// <summary>The workload identity feature webhook.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.ISecurityProfileWorkloadIdentity WorkloadIdentity { get; set; }
        /// <summary>Whether to enable or disable the workload identity Webhook</summary>
        bool? WorkloadIdentityEnabled { get; set; }
