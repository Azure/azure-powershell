...
namespace Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Models
{
    ...
    public partial class Tags
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Models.ITags.
        /// </summary>
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Models.ITags.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Models.ITags FromJson(Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonObject json ? new Tags(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonObject into a new instance of <see cref="Tags" />.
        /// </summary>
        ...
        internal Tags(Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonObject json, global::System.Collections.Generic.HashSet<string> exclusions = null)
        {
            ...
            Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.JsonSerializable.FromJson( json, ((Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.IAssociativeArray<string>)this).AdditionalProperties, null ,exclusions );
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Tags" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Tags" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.SerializationMode serializationMode)
        {
            ...
            Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.JsonSerializable.ToJson( ((Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.IAssociativeArray<string>)this).AdditionalProperties, container);
