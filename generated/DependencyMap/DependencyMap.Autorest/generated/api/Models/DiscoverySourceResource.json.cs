...
namespace Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Models
{
    ...
    public partial class DiscoverySourceResource
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonObject into a new instance of <see cref="DiscoverySourceResource" />.
        /// </summary>
        ...
        internal DiscoverySourceResource(Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Models.DiscoverySourceResourceProperties.FromJson(__jsonProperties) : _property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Models.IDiscoverySourceResource.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Models.IDiscoverySourceResource.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Models.IDiscoverySourceResource FromJson(Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonObject json ? new DiscoverySourceResource(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="DiscoverySourceResource" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="DiscoverySourceResource" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonNode" />.
        /// </returns>
