...
namespace Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Models
{
    ...
    public partial class OffAzureDiscoverySourceResourceProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Models.IOffAzureDiscoverySourceResourceProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Models.IOffAzureDiscoverySourceResourceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Models.IOffAzureDiscoverySourceResourceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonObject json ? new OffAzureDiscoverySourceResourceProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonObject into a new instance of <see cref="OffAzureDiscoverySourceResourceProperties" />.
        /// </summary>
        ...
        internal OffAzureDiscoverySourceResourceProperties(Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonObject json)
        {
            ...
            __discoverySourceResourceProperties = new Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Models.DiscoverySourceResourceProperties(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="OffAzureDiscoverySourceResourceProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="OffAzureDiscoverySourceResourceProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DependencyMap.Runtime.SerializationMode serializationMode)
        {
            ...
            __discoverySourceResourceProperties?.ToJson(container, serializationMode);
