...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.State Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.State Deleted = @"Deleted";
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.State Stopped = @"Stopped";

        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.State Stopping = @"Stopping";

        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.State Unavailable = @"Unavailable";

        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.State Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.State e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.State e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.State e1, Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.State e2)
        {
            return !e2.Equals(e1);
        }
