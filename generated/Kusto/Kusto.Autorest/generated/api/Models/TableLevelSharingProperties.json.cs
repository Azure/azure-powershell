...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models
{
    ...
    public partial class TableLevelSharingProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.ITableLevelSharingProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.ITableLevelSharingProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.ITableLevelSharingProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode node)
        {
        ...
        internal TableLevelSharingProperties(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject json)
        {
            ...
            {_tablesToInclude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray>("tablesToInclude"), out var __jsonTablesToInclude) ? If( __jsonTablesToInclude as Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _tablesToInclude;}
            {_tablesToExclude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray>("tablesToExclude"), out var __jsonTablesToExclude) ? If( __jsonTablesToExclude as Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : _tablesToExclude;}
            {_externalTablesToInclude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray>("externalTablesToInclude"), out var __jsonExternalTablesToInclude) ? If( __jsonExternalTablesToInclude as Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(string) (__k is Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString __j ? (string)(__j.ToString()) : null)) ))() : null : _externalTablesToInclude;}
            {_externalTablesToExclude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray>("externalTablesToExclude"), out var __jsonExternalTablesToExclude) ? If( __jsonExternalTablesToExclude as Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__g, (__f)=>(string) (__f is Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString __e ? (string)(__e.ToString()) : null)) ))() : null : _externalTablesToExclude;}
            {_materializedViewsToInclude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray>("materializedViewsToInclude"), out var __jsonMaterializedViewsToInclude) ? If( __jsonMaterializedViewsToInclude as Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray, out var __b) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__b, (__a)=>(string) (__a is Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString ___z ? (string)(___z.ToString()) : null)) ))() : null : _materializedViewsToInclude;}
            {_materializedViewsToExclude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray>("materializedViewsToExclude"), out var __jsonMaterializedViewsToExclude) ? If( __jsonMaterializedViewsToExclude as Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray, out var ___w) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(___w, (___v)=>(string) (___v is Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString ___u ? (string)(___u.ToString()) : null)) ))() : null : _materializedViewsToExclude;}
            {_functionsToInclude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray>("functionsToInclude"), out var __jsonFunctionsToInclude) ? If( __jsonFunctionsToInclude as Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray, out var ___r) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(___r, (___q)=>(string) (___q is Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString ___p ? (string)(___p.ToString()) : null)) ))() : null : _functionsToInclude;}
            {_functionsToExclude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray>("functionsToExclude"), out var __jsonFunctionsToExclude) ? If( __jsonFunctionsToExclude as Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray, out var ___m) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(___m, (___l)=>(string) (___l is Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString ___k ? (string)(___k.ToString()) : null)) ))() : null : _functionsToExclude;}
            AfterFromJson(json);
        }
