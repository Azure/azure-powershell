...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models
{
    ...
    public partial class DataConnection
    {
        ...
        internal DataConnection(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject json)
        {
            ...
            __proxyResource = new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.ProxyResource(json);
            ...
            {_kind = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString>("kind"), out var __jsonKind) ? (string)__jsonKind : (string)_kind;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IDataConnection.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IDataConnection interface is polymorphic, and the precise model
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IDataConnection.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IDataConnection FromJson(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("kind") )
            {
                ...
                case "CosmosDb":
                {
                    return new CosmosDbDataConnection(json);
                }
            }
