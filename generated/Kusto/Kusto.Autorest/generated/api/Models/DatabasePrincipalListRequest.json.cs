...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models
{
    ...
    public partial class DatabasePrincipalListRequest
    {
        ...
        internal DatabasePrincipalListRequest(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject json)
        {
            ...
            {_value = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray>("value"), out var __jsonValue) ? If( __jsonValue as Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IDatabasePrincipal>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IDatabasePrincipal) (Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.DatabasePrincipal.FromJson(__u) )) ))() : null : _value;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IDatabasePrincipalListRequest.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IDatabasePrincipalListRequest.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IDatabasePrincipalListRequest FromJson(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode node)
        {
