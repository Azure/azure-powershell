...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models
{
    ...
    public partial class CosmosDbDataConnectionProperties
    {
        ...
        internal CosmosDbDataConnectionProperties(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject json)
        {
            ...
            {_tableName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString>("tableName"), out var __jsonTableName) ? (string)__jsonTableName : (string)_tableName;}
            {_mappingRuleName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString>("mappingRuleName"), out var __jsonMappingRuleName) ? (string)__jsonMappingRuleName : (string)_mappingRuleName;}
            {_managedIdentityResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString>("managedIdentityResourceId"), out var __jsonManagedIdentityResourceId) ? (string)__jsonManagedIdentityResourceId : (string)_managedIdentityResourceId;}
            {_managedIdentityObjectId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString>("managedIdentityObjectId"), out var __jsonManagedIdentityObjectId) ? (string)__jsonManagedIdentityObjectId : (string)_managedIdentityObjectId;}
            {_cosmosDbAccountResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString>("cosmosDbAccountResourceId"), out var __jsonCosmosDbAccountResourceId) ? (string)__jsonCosmosDbAccountResourceId : (string)_cosmosDbAccountResourceId;}
            {_cosmosDbDatabase = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString>("cosmosDbDatabase"), out var __jsonCosmosDbDatabase) ? (string)__jsonCosmosDbDatabase : (string)_cosmosDbDatabase;}
            {_cosmosDbContainer = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString>("cosmosDbContainer"), out var __jsonCosmosDbContainer) ? (string)__jsonCosmosDbContainer : (string)_cosmosDbContainer;}
            {_retrievalStartDate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString>("retrievalStartDate"), out var __jsonRetrievalStartDate) ? global::System.DateTime.TryParse((string)__jsonRetrievalStartDate, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonRetrievalStartDateValue) ? __jsonRetrievalStartDateValue : _retrievalStartDate : _retrievalStartDate;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.ICosmosDbDataConnectionProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.ICosmosDbDataConnectionProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.ICosmosDbDataConnectionProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode node)
        {
