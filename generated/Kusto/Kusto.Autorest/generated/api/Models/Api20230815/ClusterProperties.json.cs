...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815
{
    ...
    public partial class ClusterProperties
    {
        ...
        internal ClusterProperties(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject json)
        {
            ...
            {_optimizedAutoscale = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject>("optimizedAutoscale"), out var __jsonOptimizedAutoscale) ? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.OptimizedAutoscale.FromJson(__jsonOptimizedAutoscale) : OptimizedAutoscale;}
            {_virtualNetworkConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject>("virtualNetworkConfiguration"), out var __jsonVirtualNetworkConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.VirtualNetworkConfiguration.FromJson(__jsonVirtualNetworkConfiguration) : VirtualNetworkConfiguration;}
            {_keyVaultProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject>("keyVaultProperties"), out var __jsonKeyVaultProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.KeyVaultProperties.FromJson(__jsonKeyVaultProperties) : KeyVaultProperty;}
            {_languageExtension = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject>("languageExtensions"), out var __jsonLanguageExtensions) ? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.LanguageExtensionsList.FromJson(__jsonLanguageExtensions) : LanguageExtension;}
            {_migrationCluster = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject>("migrationCluster"), out var __jsonMigrationCluster) ? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.MigrationClusterProperties.FromJson(__jsonMigrationCluster) : MigrationCluster;}
            ...
            {_acceptedAudience = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray>("acceptedAudiences"), out var __jsonAcceptedAudiences) ? If( __jsonAcceptedAudiences as Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.IAcceptedAudiences[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.IAcceptedAudiences) (Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.AcceptedAudiences.FromJson(__k) )) ))() : null : AcceptedAudience;}
