...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models
{
    ...
    public partial class EventGridConnectionProperties
    {
        ...
        internal EventGridConnectionProperties(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonObject json)
        {
            ...
            {_storageAccountResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString>("storageAccountResourceId"), out var __jsonStorageAccountResourceId) ? (string)__jsonStorageAccountResourceId : (string)_storageAccountResourceId;}
            {_eventGridResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString>("eventGridResourceId"), out var __jsonEventGridResourceId) ? (string)__jsonEventGridResourceId : (string)_eventGridResourceId;}
            {_eventHubResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString>("eventHubResourceId"), out var __jsonEventHubResourceId) ? (string)__jsonEventHubResourceId : (string)_eventHubResourceId;}
            {_consumerGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString>("consumerGroup"), out var __jsonConsumerGroup) ? (string)__jsonConsumerGroup : (string)_consumerGroup;}
            ...
            {_dataFormat = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString>("dataFormat"), out var __jsonDataFormat) ? (string)__jsonDataFormat : (string)_dataFormat;}
            {_ignoreFirstRecord = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonBoolean>("ignoreFirstRecord"), out var __jsonIgnoreFirstRecord) ? (bool?)__jsonIgnoreFirstRecord : _ignoreFirstRecord;}
            {_blobStorageEventType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString>("blobStorageEventType"), out var __jsonBlobStorageEventType) ? (string)__jsonBlobStorageEventType : (string)_blobStorageEventType;}
            ...
            {_databaseRouting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonString>("databaseRouting"), out var __jsonDatabaseRouting) ? (string)__jsonDatabaseRouting : (string)_databaseRouting;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IEventGridConnectionProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IEventGridConnectionProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IEventGridConnectionProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Json.JsonNode node)
        {
