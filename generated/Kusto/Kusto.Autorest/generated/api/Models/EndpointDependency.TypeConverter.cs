...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models
{
    ...
    public partial class EndpointDependencyTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="EndpointDependency" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IEndpointDependency ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IEndpointDependency).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
