...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RemoveCalloutPolicy=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/Clusters/{clusterName}/removeCalloutPolicy"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzKustoClusterCalloutPolicy_Remove", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Kusto.Description(@"Removes callout policy for engine services.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Kusto.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Kusto.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/Clusters/{clusterName}/removeCalloutPolicy", ApiVersion = "2024-04-13")]
    public partial class RemoveAzKustoClusterCalloutPolicy_Remove : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20240413.ICalloutPolicyToRemove _calloutPolicy;

        /// <summary>Configuration for an external callout policy to remove.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Configuration for an external callout policy to remove.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Configuration for an external callout policy to remove.",
        SerializedName = @"calloutPolicy",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20240413.ICalloutPolicyToRemove) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20240413.ICalloutPolicyToRemove CalloutPolicy { get => this._calloutPolicy; set => this._calloutPolicy = value; }
        ...
        /// <returns>a duplicate instance of RemoveAzKustoClusterCalloutPolicy_Remove</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets.RemoveAzKustoClusterCalloutPolicy_Remove Clone()
        {
            var clone = new RemoveAzKustoClusterCalloutPolicy_Remove();
            ...
            clone.CalloutPolicy = this.CalloutPolicy;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ClustersRemoveCalloutPolicy' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ClustersRemoveCalloutPolicy(SubscriptionId, ResourceGroupName, ClusterName, CalloutPolicy, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ClusterName=ClusterName,body=CalloutPolicy})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzKustoClusterCalloutPolicy_Remove" /> cmdlet class.
        /// </summary>
        public RemoveAzKustoClusterCalloutPolicy_Remove()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, body=CalloutPolicy })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, body=CalloutPolicy })
                    {
