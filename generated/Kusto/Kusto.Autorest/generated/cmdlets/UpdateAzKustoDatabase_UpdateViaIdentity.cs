...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DatabasesUpdateViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("CallerRole") ? CallerRole : null, Parameter, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        await this.Client.DatabasesUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, InputObject.DatabaseName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("CallerRole") ? CallerRole : null, Parameter, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.SerializationMode.IncludeUpdate);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { CallerRole=this.InvocationInformation.BoundParameters.ContainsKey("CallerRole") ? CallerRole : null})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzKustoDatabase_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
