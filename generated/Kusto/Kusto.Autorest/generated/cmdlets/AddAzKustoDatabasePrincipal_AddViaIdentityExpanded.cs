...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddAzKustoDatabasePrincipal_AddViaIdentityExpanded" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.DatabasesAddPrincipals(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, InputObject.DatabaseName ?? null, _databasePrincipalsToAddBody, onOk, onDefault, this, Pipeline);
                    }
