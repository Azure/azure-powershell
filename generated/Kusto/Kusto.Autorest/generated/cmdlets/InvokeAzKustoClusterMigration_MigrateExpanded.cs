...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzKustoClusterMigration_MigrateExpanded", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzKustoClusterMigration_MigrateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20240413.IClusterMigrateRequest _clusterMigrateRequestBody = new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20240413.ClusterMigrateRequest();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Resource ID of the destination cluster or kusto pool.")]
        ...
        public string ClusterResourceId { get => _clusterMigrateRequestBody.ClusterResourceId ?? null; set => _clusterMigrateRequestBody.ClusterResourceId = value; }
        ...
        /// <returns>a duplicate instance of InvokeAzKustoClusterMigration_MigrateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets.InvokeAzKustoClusterMigration_MigrateExpanded Clone()
        {
            var clone = new InvokeAzKustoClusterMigration_MigrateExpanded();
            ...
            clone._clusterMigrateRequestBody = this._clusterMigrateRequestBody;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzKustoClusterMigration_MigrateExpanded" /> cmdlet class.
        /// </summary>
        public InvokeAzKustoClusterMigration_MigrateExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ClustersMigrate(ResourceGroupName, Name, SubscriptionId, _clusterMigrateRequestBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,SubscriptionId=SubscriptionId,body=_clusterMigrateRequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, Name=Name, SubscriptionId=SubscriptionId, body=_clusterMigrateRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, Name=Name, SubscriptionId=SubscriptionId, body=_clusterMigrateRequestBody })
                    {
