...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzKustoDatabase_Update", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.IDatabase))]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Kusto.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/Clusters/{clusterName}/Databases/{databaseName}", ApiVersion = "2023-08-15")]
    public partial class UpdateAzKustoDatabase_Update : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="CallerRole" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.CallerRole _callerRole;
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "By default, any user who run operation on a database become an Admin on it. This property allows the caller to exclude the caller from Admins list.")]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.CallerRole) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Kusto.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Kusto.ParameterCategory.Query)]
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.CallerRole))]
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.CallerRole CallerRole { get => this._callerRole; set => this._callerRole = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.IDatabase _parameter;

        /// <summary>Class representing a Kusto database.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Class representing a Kusto database.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Class representing a Kusto database.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.IDatabase) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.IDatabase Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.IDatabase">Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.IDatabase</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.IDatabase> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of UpdateAzKustoDatabase_Update</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets.UpdateAzKustoDatabase_Update Clone()
        {
            var clone = new UpdateAzKustoDatabase_Update();
            ...
            clone.CallerRole = this.CallerRole;
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DatabasesUpdate(ResourceGroupName, ClusterName, Name, SubscriptionId, this.InvocationInformation.BoundParameters.ContainsKey("CallerRole") ? CallerRole : null, Parameter, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,ClusterName=ClusterName,Name=Name,SubscriptionId=SubscriptionId,CallerRole=this.InvocationInformation.BoundParameters.ContainsKey("CallerRole") ? CallerRole : null,body=Parameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzKustoDatabase_Update" /> cmdlet class.
        /// </summary>
        public UpdateAzKustoDatabase_Update()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, Name=Name, SubscriptionId=SubscriptionId, CallerRole=this.InvocationInformation.BoundParameters.ContainsKey("CallerRole") ? CallerRole : null, body=Parameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, Name=Name, SubscriptionId=SubscriptionId, CallerRole=this.InvocationInformation.BoundParameters.ContainsKey("CallerRole") ? CallerRole : null, body=Parameter })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.IDatabase> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20230815.IDatabase
