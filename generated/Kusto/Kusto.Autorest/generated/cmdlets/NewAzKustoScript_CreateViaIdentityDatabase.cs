...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    /// <summary>create a Kusto database script.</summary>
    /// <remarks>
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzKustoScript_CreateViaIdentityDatabase", SupportsShouldProcess = true)]
    ...
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IScript))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Kusto.Description(@"create a Kusto database script.")]
    ...
    public partial class NewAzKustoScript_CreateViaIdentityDatabase : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="DatabaseInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IKustoIdentity _databaseInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IKustoIdentity DatabaseInputObject { get => this._databaseInputObject; set => this._databaseInputObject = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IScript _parameter;

        /// <summary>Class representing a database script.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Class representing a database script.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IScript Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IScript">Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IScript</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IScript> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzKustoScript_CreateViaIdentityDatabase</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets.NewAzKustoScript_CreateViaIdentityDatabase Clone()
        {
            var clone = new NewAzKustoScript_CreateViaIdentityDatabase();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzKustoScript_CreateViaIdentityDatabase" /> cmdlet class.
        /// </summary>
        public NewAzKustoScript_CreateViaIdentityDatabase()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (DatabaseInputObject?.Id != null)
                    {
                        this.DatabaseInputObject.Id += $"/scripts/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.ScriptsCreateOrUpdateViaIdentity(DatabaseInputObject.Id, Parameter, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == DatabaseInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("DatabaseInputObject has null value for DatabaseInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, DatabaseInputObject) );
                        }
                        if (null == DatabaseInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("DatabaseInputObject has null value for DatabaseInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, DatabaseInputObject) );
                        }
                        if (null == DatabaseInputObject.ClusterName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("DatabaseInputObject has null value for DatabaseInputObject.ClusterName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, DatabaseInputObject) );
                        }
                        if (null == DatabaseInputObject.DatabaseName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("DatabaseInputObject has null value for DatabaseInputObject.DatabaseName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, DatabaseInputObject) );
                        }
                        await this.Client.ScriptsCreateOrUpdate(DatabaseInputObject.SubscriptionId ?? null, DatabaseInputObject.ResourceGroupName ?? null, DatabaseInputObject.ClusterName ?? null, DatabaseInputObject.DatabaseName ?? null, Name, Parameter, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.SerializationMode.IncludeCreate);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IScript> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.IScript
