...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzKustoDatabase_DeleteViaIdentityCluster", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzKustoDatabase_DeleteViaIdentityCluster : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IContext
    {
        ...
        /// <returns>a duplicate instance of RemoveAzKustoDatabase_DeleteViaIdentityCluster</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets.RemoveAzKustoDatabase_DeleteViaIdentityCluster Clone()
        {
            var clone = new RemoveAzKustoDatabase_DeleteViaIdentityCluster();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ClusterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.DatabasesDeleteViaIdentity(ClusterInputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.DatabasesDelete(ClusterInputObject.SubscriptionId ?? null, ClusterInputObject.ResourceGroupName ?? null, ClusterInputObject.ClusterName ?? null, Name, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzKustoDatabase_DeleteViaIdentityCluster" /> cmdlet class.
        /// </summary>
        public RemoveAzKustoDatabase_DeleteViaIdentityCluster()
        {
