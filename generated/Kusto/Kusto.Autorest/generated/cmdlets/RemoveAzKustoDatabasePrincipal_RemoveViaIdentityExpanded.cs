...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.DatabasesRemovePrincipals(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, InputObject.DatabaseName ?? null, _databasePrincipalsToRemoveBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzKustoDatabasePrincipal_RemoveViaIdentityExpanded" /> cmdlet class.
        /// </summary>
