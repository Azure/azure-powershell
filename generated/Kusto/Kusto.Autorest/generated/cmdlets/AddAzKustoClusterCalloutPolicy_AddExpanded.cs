...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    /// <summary>Adds a list of callout policies for engine services.</summary>
    /// <remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Kusto.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/Clusters/{clusterName}/addCalloutPolicies", ApiVersion = "2024-04-13")]
    public partial class AddAzKustoClusterCalloutPolicy_AddExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20240413.ICalloutPoliciesList _calloutPoliciesBody = new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20240413.CalloutPoliciesList();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The URL to get the next set of callout policies list results if there are any.")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string NextLink { get => _calloutPoliciesBody.NextLink ?? null; set => _calloutPoliciesBody.NextLink = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "A list of the service's callout policies.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Kusto.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Kusto.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20240413.ICalloutPolicy[] Value { get => _calloutPoliciesBody.Value ?? null /* arrayOf */; set => _calloutPoliciesBody.Value = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="AddAzKustoClusterCalloutPolicy_AddExpanded" /> cmdlet class.
        /// </summary>
        public AddAzKustoClusterCalloutPolicy_AddExpanded()
        {
        ...
        /// <returns>a duplicate instance of AddAzKustoClusterCalloutPolicy_AddExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets.AddAzKustoClusterCalloutPolicy_AddExpanded Clone()
        {
            var clone = new AddAzKustoClusterCalloutPolicy_AddExpanded();
            ...
            clone._calloutPoliciesBody = this._calloutPoliciesBody;
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ClustersAddCalloutPolicies' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ClustersAddCalloutPolicies(SubscriptionId, ResourceGroupName, ClusterName, _calloutPoliciesBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ClusterName=ClusterName,body=_calloutPoliciesBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, body=_calloutPoliciesBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, body=_calloutPoliciesBody })
                    {
