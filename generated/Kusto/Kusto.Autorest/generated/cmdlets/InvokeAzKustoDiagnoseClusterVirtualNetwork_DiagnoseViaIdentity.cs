...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzKustoDiagnoseClusterVirtualNetwork_DiagnoseViaIdentity" /> cmdlet
        /// class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.ClustersDiagnoseVirtualNetwork(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, onOk, onDefault, this, Pipeline);
                    }
