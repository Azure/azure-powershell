...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzKustoDetachClusterFollowerDatabase_DetachViaIdentityExpanded" />
        /// cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.ClustersDetachFollowerDatabases(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, _followerDatabaseToRemoveBody, onOk, onDefault, this, Pipeline);
                    }
