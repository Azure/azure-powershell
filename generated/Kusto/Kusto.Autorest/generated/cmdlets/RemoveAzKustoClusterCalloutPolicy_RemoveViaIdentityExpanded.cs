...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzKustoClusterCalloutPolicy_RemoveViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzKustoClusterCalloutPolicy_RemoveViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20240413.ICalloutPolicyToRemove _calloutPolicyBody = new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20240413.CalloutPolicyToRemove();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Unique identifier for the callout configuration.")]
        ...
        public string CalloutId { get => _calloutPolicyBody.CalloutId ?? null; set => _calloutPolicyBody.CalloutId = value; }
        ...
        /// <returns>
        /// a duplicate instance of RemoveAzKustoClusterCalloutPolicy_RemoveViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets.RemoveAzKustoClusterCalloutPolicy_RemoveViaIdentityExpanded Clone()
        {
            var clone = new RemoveAzKustoClusterCalloutPolicy_RemoveViaIdentityExpanded();
            ...
            clone._calloutPolicyBody = this._calloutPolicyBody;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ClustersRemoveCalloutPolicyViaIdentity(InputObject.Id, _calloutPolicyBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ClustersRemoveCalloutPolicy(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, _calloutPolicyBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_calloutPolicyBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzKustoClusterCalloutPolicy_RemoveViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public RemoveAzKustoClusterCalloutPolicy_RemoveViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_calloutPolicyBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_calloutPolicyBody })
                    {
