...
RequiredModules = @(@{ModuleName = 'Az.Accounts'; ModuleVersion = '1.8.0'; }, 
               ...
               @{ModuleName = 'Az.KeyVault'; RequiredVersion = '1.7.0'; }, 
               ...
               @{ModuleName = 'Az.Monitor'; RequiredVersion = '1.8.0'; }, 
               @{ModuleName = 'Az.Network'; RequiredVersion = '2.6.0'; }, 
               @{ModuleName = 'Az.NotificationHubs'; RequiredVersion = '1.1.1'; }, 
               @{ModuleName = 'Az.OperationalInsights'; RequiredVersion = '1.4.0'; }, 
...
#               @{ModuleName = 'Az.Storage'; RequiredVersion = '1.13.0'; },  # Storage removed to support preview
