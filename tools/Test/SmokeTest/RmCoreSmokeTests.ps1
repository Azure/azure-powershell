...
$resourceTestCommands = @(
    ...
    @{Name = "Az.Batch"; Test = "MngmPlane"                 Command = {Get-AzBatchAccount -ErrorAction Stop}},
    @{Name = "Az.Batch"; Test = "DataPlane"                 Command = {Get-Command Get-AzBatchAccount -ErrorAction Stop}},
    ...
    @{Name = "Az.ContainerRegistry"; Test = "MngmPlane"     Command = {Get-AzContainerRegistry -ErrorAction Stop}},
    @{Name = "Az.ContainerRegistry"; Test = "DataPlane"     Command = {Get-Command Get-AzContainerRegistry -ErrorAction Stop}},
    ...
    @{Name = "Az.DataLakeStore"; Test = "MngmPlane"         Command = {Get-AzDataLakeStoreAccount -ErrorAction Stop}},
    @{Name = "Az.DataLakeStore"; Test = "DataPlane"         Command = {Get-Command Get-AzDataLakeStoreAccount -ErrorAction Stop}},
    ...
    @{Name = "Az.IotHub"; Test = "MngmPlane"                Command = {Get-AzIotHub -ErrorAction Stop}},
    @{Name = "Az.IotHub"; Test = "DataPlane"                Command = {Get-Command Get-AzIotHub -ErrorAction Stop}},

    @{Name = "Az.KeyVault"; Test = "MngmPlane"              Command = {Get-AzKeyVault -ErrorAction Stop}},
    @{Name = "Az.KeyVault"; Test = "DataPlane"              Command = {Get-Command Get-AzKeyVault -ErrorAction Stop}},
    ...
    @{Name = "Az.OperationalInsights"; Test = "MngmPlane"   Command = {Get-AzOperationalInsightsWorkspace -ErrorAction Stop}},
    @{Name = "Az.OperationalInsights"; Test = "DataPlane"   Command = {Get-Command Get-AzOperationalInsightsWorkspace -ErrorAction Stop}},
    ...
    @{Name = "Az.ServiceFabric"; Test = "MngmPlane"         Command = {Get-AzServiceFabricCluster -ErrorAction Stop}},
    @{Name = "Az.ServiceFabric"; Test = "DataPlane"         Command = {Get-Command Get-AzServiceFabricCluster -ErrorAction Stop}},
