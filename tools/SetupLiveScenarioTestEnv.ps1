...
if (!$serviceManagementVariables -AND !$resourceManagerVariables -AND !$oldRdfeTestVariables) {
  ...
  $env:TEST_CSM_ORGID_AUTHENTICATION = "SubscriptionId=$subscription;BaseUri=https://pt-test04:30005;AADAuthEndpoint=https://login.windows.net/;;AADTenant=waptestad.onmicrosoft.com;AADResource=https://pt-test04.api.waptestad.onmicrosoft.com"
