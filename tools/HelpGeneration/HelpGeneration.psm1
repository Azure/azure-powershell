...
function New-AzMamlHelp
{
    ...
    # Export-MamlCommandHelp writes the MAML into a '<ModuleName>' subfolder under -OutputFolder.
    # Targeting the module folder's parent therefore lands the help at '<parent>/<ModuleName>/',
    # i.e. the module folder itself (e.g. artifacts/<Config>/<Module>/*.dll-Help.xml).
...
Import-Module -Name Microsoft.PowerShell.PlatyPS -MinimumVersion 1.0.2 -Scope Global
