...
namespace Microsoft.Azure.PowerShell.Tools.AzPredictor
{
    ...
    internal sealed class CommandLinePredictor
    {
        ...
        /// <returns>The collections of suggestions and related information.</returns>
        public Tuple<CommandLineSuggestion, IDictionary<string, int>> GetSuggestion(Ast input, IDictionary<string, int> presentCommands, int suggestionCount, int maxAllowedCommandDuplicate, CancellationToken cancellationToken)
        {
            Validation.CheckArgument(input, $"{nameof(input)} cannot but null.");
