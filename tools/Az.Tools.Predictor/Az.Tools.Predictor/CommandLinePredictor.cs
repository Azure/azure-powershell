...
namespace Microsoft.Azure.PowerShell.Tools.AzPredictor
{
    ...
    internal sealed class CommandLinePredictor
    {
        ...
        public CommandLineSuggestion GetSuggestion(Ast input, IDictionary<string, int> presentCommands, int suggestionCount, int maxAllowedCommandDuplicate, CancellationToken cancellationToken)
        {
