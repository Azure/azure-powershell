...
namespace Microsoft.Azure.PowerShell.Tools.AzPredictor
{
    ...
    struct Parameter : IEquatable<Parameter>
    {
        ...
        {
            Validation.CheckArgument(!string.IsNullOrWhiteSpace(name) || string.Equals(name, string.Empty, StringComparison.Ordinal), $"{nameof(name)} cannot be null or whitespace");
