...
namespace Tools.Common.Models
{
    ...
    public class CmdletMetadata
    {
        ...
        public override bool Equals(Object obj)
        {
            ...
            flag &= string.Equals(this.Name, other.Name, StringComparison.OrdinalIgnoreCase);
            flag &= this.SupportsShouldProcess == other.SupportsShouldProcess;
            flag &= this.ConfirmImpact == other.ConfirmImpact;
            flag &= this.SupportsPaging == other.SupportsPaging;
            ...
            flag &= thisDefaultSet.Equals(otherDefaultSet);
            ...
            foreach (var thisParameterSet in this.ParameterSets)
            {
                ...
                flag &= thisParameterSet.Equals(otherParameterSet);
            }

            flag &= this.ParameterSets.Count == other.ParameterSets.Count;
