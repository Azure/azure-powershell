...
namespace Tools.Common.Models
{
    ...
    public class ParameterMetadata
    {
        ...
        public override bool Equals(Object obj)
        {
            ...
            flag &= thisNames.Count == otherNames.Count;

            flag &= this.ValidateRangeMin == other.ValidateRangeMin;
            flag &= this.ValidateRangeMax == other.ValidateRangeMax;
            flag &= this.ValidateNotNullOrEmpty == other.ValidateNotNullOrEmpty;
            flag &= this.ValidateSet.Count == other.ValidateSet.Count;

            flag &= this.Type.Equals(other.Type);
