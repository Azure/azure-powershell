...
namespace Tools.Common.Models
{
    ...
    public class ParameterSetMetadata
    {
        ...
        public override bool Equals(Object obj)
        {
            ...
            foreach (var thisParameter in this.Parameters)
            {
                ...
                flag &= thisParameter.Equals(otherParameter);
            }

            flag &= this.Parameters.Count == other.Parameters.Count;
    ...
    public class Parameter
    {
        ...
        public override bool Equals(Object obj)
        {
            ...
            flag &= this.Mandatory == other.Mandatory;
            flag &= this.Position == other.Position;
            flag &= this.ValueFromPipeline == other.ValueFromPipeline;
            flag &= this.ValueFromPipelineByPropertyName == other.ValueFromPipelineByPropertyName;
            flag &= this.ParameterMetadata.Equals(other.ParameterMetadata);
