...
namespace Microsoft.Azure.Management.ResourceManager.Version2021_01_01
{
    ...
    public partial class SubscriptionClient : ServiceClient<SubscriptionClient>, ISubscriptionClient, IAzureClient
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<CheckResourceNameResult>> CheckResourceNameWithHttpMessagesAsync(string name, string type, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (ApiVersion == null)
            {
            ...
            ResourceName resourceNameDefinition = default(ResourceName);
            if (name != null || type != null)
            {
                resourceNameDefinition = new ResourceName();
                resourceNameDefinition.Name = name;
                resourceNameDefinition.Type = type;
            }
            // Tracing
