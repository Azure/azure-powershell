...
namespace Microsoft.Azure.Commands.Common.Compute.Version_2018_04.Models
{
    ...
    public partial class SnapshotUpdate : ResourceUpdate
    {
        /// <summary>
        ...
        /// snapshot</param>
        public SnapshotUpdate(IDictionary<string, string> tags = default(IDictionary<string, string>), DiskSku sku = default(DiskSku), OperatingSystemTypes? osType = default(OperatingSystemTypes?), int? diskSizeGB = default(int?), EncryptionSettings encryptionSettings = default(EncryptionSettings))
            : base(tags, sku)
        {
            OsType = osType;
