...
namespace Microsoft.Azure.Management.Monitor.Version2018_09_01
{
    ...
    /// </summary>
    internal partial class EventCategoriesOperations : IServiceOperations<MonitorManagementClient>, IEventCategoriesOperations
    {
        /// <summary>
        ...
        public async Task<AzureOperationResponse<IEnumerable<LocalizableString>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page1<LocalizableString>>(_responseContent, Client.DeserializationSettings);
                }
