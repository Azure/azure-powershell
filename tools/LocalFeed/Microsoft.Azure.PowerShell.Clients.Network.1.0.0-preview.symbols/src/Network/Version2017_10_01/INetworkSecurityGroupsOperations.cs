...
namespace Microsoft.Azure.Management.Internal.Network.Version2017_10_01
{
    ...
    public partial interface INetworkSecurityGroupsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<NetworkSecurityGroup>> BeginUpdateTagsWithHttpMessagesAsync(string resourceGroupName, string networkSecurityGroupName, TagsObject parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets all network security groups in a subscription.
        /// </summary>
