...
{
    /// <summary>
    /// Representive of Exception in Azure PowerShell.
    /// </summary>
    public class AzPSException : Exception, IContainsAzPSErrorData
    {
        /// <summary>
