...
RequiredModules = @(@{ModuleName = 'AzureRM.Profile'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'Azure.Storage'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.AnalysisServices'; RequiredVersion = '0.4.5'; }, 
               @{ModuleName = 'Azure.AnalysisServices'; RequiredVersion = '0.4.5'; }, 
               @{ModuleName = 'AzureRM.ApiManagement'; RequiredVersion = '4.3.2'; }, 
               @{ModuleName = 'AzureRM.Automation'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.Backup'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.Batch'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.Billing'; RequiredVersion = '0.13.5'; }, 
               @{ModuleName = 'AzureRM.Cdn'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.CognitiveServices'; RequiredVersion = '0.8.5'; }, 
               @{ModuleName = 'AzureRM.Compute'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.Consumption'; RequiredVersion = '0.2.5'; }, 
               @{ModuleName = 'AzureRM.ContainerRegistry'; RequiredVersion = '0.2.5'; }, 
               @{ModuleName = 'AzureRM.DataFactories'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.DataLakeAnalytics'; RequiredVersion = '3.3.2'; }, 
               ...
               @{ModuleName = 'AzureRM.IoTHub'; RequiredVersion = '2.3.2'; }, 
               ...
               @{ModuleName = 'AzureRM.OperationalInsights'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.PowerBIEmbedded'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.RecoveryServices'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.RecoveryServices.Backup'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.RedisCache'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.Relay'; RequiredVersion = '0.2.5'; }, 
               @{ModuleName = 'AzureRM.Resources'; RequiredVersion = '4.3.2'; }, 
               @{ModuleName = 'AzureRM.Scheduler'; RequiredVersion = '0.15.5'; }, 
               @{ModuleName = 'AzureRM.ServerManagement'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.ServiceBus'; RequiredVersion = '0.4.5'; }, 
               @{ModuleName = 'AzureRM.ServiceFabric'; RequiredVersion = '0.2.5'; }, 
               @{ModuleName = 'AzureRM.SiteRecovery'; RequiredVersion = '4.3.2'; }, 
               @{ModuleName = 'AzureRM.Sql'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.Storage'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.StreamAnalytics'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.Tags'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.TrafficManager'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.UsageAggregates'; RequiredVersion = '3.3.2'; }, 
               @{ModuleName = 'AzureRM.Websites'; RequiredVersion = '3.3.2'; })
