...
function Get-GeneratedModuleMetadata
{
    [CmdletBinding()]
    param (
        [Parameter()]
...
function Get-ModuleMetadata
{
    ...
    {
        return Get-GeneratedModuleMetadata -Psd1Path $Psd1Path -ModuleName $ModuleName
    }
    else
    {
        ...
        $NestedModules = $ModuleMetadata.NestedModules | Where-Object { $_.EndsWith('.dll') }
